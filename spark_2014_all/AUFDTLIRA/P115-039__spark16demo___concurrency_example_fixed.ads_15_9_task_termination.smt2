...
(define-fun bool_eq4 ((a (Array Int integer)) (a__first Int) (a__last Int) (b (Array Int integer)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_198 Int)) (=> (and (<= a__first temp___idx_198) (<= temp___idx_198 a__last)) (= (to_rep1 (select a temp___idx_198)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_198))))))) true false))
...
(assert (forall ((a (Array Int integer)) (b (Array Int integer))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq4 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int integer)) (b (Array Int integer))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq4 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep1 (select a (+ i 1))) (to_rep1 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int integer)) (b (Array Int integer))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq4 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep1 (select b (+ i 1))) (to_rep1 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((temp___200 Int)) (forall ((temp___201 Int)) (= (select (concurrency_example_fixed__all_zeroes__aggregate_def temp___200) temp___201) (of_rep1 temp___200)))))
...
(assert (forall ((temp___203 Int)) (forall ((temp___204 Int)) (= (select (concurrency_example_fixed__all_ones__aggregate_def temp___203) temp___204) (of_rep1 temp___203)))))
...
(define-fun default_initial_assumption ((temp___expr_1737 us_rep2) (temp___skip_top_level_1738 Bool)) Bool (= (rec__concurrency_example_fixed__dataT__value (us_split_fields1 temp___expr_1737)) all_zeroes))
...
(declare-fun temp___String_Literal_1767 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1767 us_void_param) 1)) 97) (= (to_rep (select (temp___String_Literal_1767 us_void_param) 2)) 108)) (= (to_rep (select (temp___String_Literal_1767 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_1767 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1767 us_void_param) 5)) 122)) (= (to_rep (select (temp___String_Literal_1767 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_1767 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_1767 us_void_param) 8)) 111)) (= (to_rep (select (temp___String_Literal_1767 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_1767 us_void_param) 10)) 115)) :pattern ((temp___String_Literal_1767 us_void_param)))))
(declare-fun temp___String_Literal_1768 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1768 us_void_param) 1)) 97) (= (to_rep (select (temp___String_Literal_1768 us_void_param) 2)) 108)) (= (to_rep (select (temp___String_Literal_1768 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_1768 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1768 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1768 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1768 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_1768 us_void_param) 8)) 115)) :pattern ((temp___String_Literal_1768 us_void_param)))))
(declare-fun temp___String_Literal_1769 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1769 us_void_param) 1)) 100) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 2)) 97)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 4)) 97)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 11)) 100)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 16)) 116)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1769 us_void_param) 18)) 100)) :pattern ((temp___String_Literal_1769 us_void_param)))))
...
(define-fun dynamic_invariant4 ((temp___expr_232 Int) (temp___is_init_229 Bool) (temp___skip_constant_230 Bool) (temp___do_toplevel_231 Bool)) Bool (=> (or (= temp___is_init_229 true) (<= 0 97)) (in_range4 temp___expr_232)))
(declare-const value (Array Int integer))
(declare-const deadline us_rep)
(declare-const o us_rep)
(declare-const temp___1771 us_rep)
(declare-const temp___1770 (Array Int integer))
...
(declare-const value2 (Array Int integer))
(declare-const deadline2 us_rep)
(declare-const data__split_fields1 (Array Int integer))
(declare-const value3 (Array Int integer))
(declare-const deadline3 time__ref)
(declare-const data__split_fields2 us_split_fields)
(declare-const value4 (Array Int integer))
(declare-const deadline4 us_rep)
(declare-const data__split_fields3 us_split_fields__ref)
(declare-const value5 map__ref1)
(declare-const deadline5 time__ref)
(declare-const data__split_fields4 us_split_fields)
(declare-const value6 (Array Int integer))
(declare-const deadline6 us_rep)
...
(assert (= deadline1 o))
(assert (= temp___1771 deadline1))
(assert (= temp___1770 value))
(assert (= o1 data__split_fields))
(assert (and (= o2 (get (mk___rep (mk___split_fields o1)))) (= o2 o1)))
(assert (= value1 result1))
(assert (= value2 o2))
(assert (=> (= (bool_eq4 value2 1 1000 all_zeroes 1 1000) true) (= (temp___String_Literal_1767 Tuple0) o3)))
(assert (=> (= (bool_eq4 value2 1 1000 all_zeroes 1 1000) true) (= (mk 1 10) o4)))
(assert (=> (not (= (bool_eq4 value2 1 1000 all_zeroes 1 1000) true)) (=> (= (bool_eq4 value2 1 1000 all_ones 1 1000) true) (= (temp___String_Literal_1768 Tuple0) o3))))
(assert (=> (not (= (bool_eq4 value2 1 1000 all_zeroes 1 1000) true)) (=> (= (bool_eq4 value2 1 1000 all_ones 1 1000) true) (= (mk 1 8) o4))))
(assert (=> (not (= (bool_eq4 value2 1 1000 all_zeroes 1 1000) true)) (=> (not (= (bool_eq4 value2 1 1000 all_ones 1 1000) true)) (= (temp___String_Literal_1769 Tuple0) o3))))
(assert (=> (not (= (bool_eq4 value2 1 1000 all_zeroes 1 1000) true)) (=> (not (= (bool_eq4 value2 1 1000 all_ones 1 1000) true)) (= (mk 1 18) o4))))
(assert (or (= (bool_eq4 value2 1 1000 all_zeroes 1 1000) true) (= (bool_eq4 value2 1 1000 all_ones 1 1000) true)))
(assert false)
(assert (= deadline3 (mk_time__ref deadline2)))
(assert (= value2 value3))
(assert (= data__split_fields1 data__split_fields))
(assert (= deadline4 deadline2))
(assert (= value4 value2))
(assert (= data__split_fields2 (mk___split_fields data__split_fields)))
(assert (= deadline5 deadline3))
(assert (= value5 (mk_map__ref1 value3)))
(assert (= data__split_fields3 (mk___split_fields__ref (mk___split_fields data__split_fields1))))
(assert (= deadline6 deadline4))
(assert (= value6 value4))
(assert (= data__split_fields4 data__split_fields2))
(assert (not false))
(check-sat)
(exit)
