...
(assert (and (and (= (length source) 10) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50)) (forall ((index3 Int)) (=> (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index3))) true)))))
...
(assert (and (and (forall ((temp___1648 Int)) (=> (and (<= (to_rep1 n__first) temp___1648) (<= temp___1648 (to_rep1 n__last))) (=> (or (< temp___1645 temp___1648) (or (< temp___1648 (to_rep1 (first (rt source)))) (< index2 temp___1648))) (= (select n3 temp___1648) (select n1 temp___1648))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9)))))
