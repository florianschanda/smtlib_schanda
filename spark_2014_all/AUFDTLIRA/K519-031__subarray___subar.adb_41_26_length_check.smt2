...
(assert (forall ((x tone_twentyB)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x tone_twentyB)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant ((temp___expr_138 Int) (temp___is_init_135 Bool) (temp___skip_constant_136 Bool) (temp___do_toplevel_137 Bool)) Bool (=> (or (= temp___is_init_135 true) (<= 1 20)) (in_range3 temp___expr_138)))
...
(define-fun bool_eq1 ((x1 us_t) (y us_t)) Bool (bool_eq (elts x1) (to_rep1 (first (rt x1))) (to_rep1 (last (rt x1))) (elts y) (to_rep1 (first (rt y))) (to_rep1 (last (rt y)))))
...
(define-fun dynamic_invariant1 ((temp___expr_221 us_t) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool)) Bool (=> (not (= temp___skip_constant_219 true)) (and (dynamic_property1 (- x 1) (+ x 1) (first1 temp___expr_221) (last1 temp___expr_221)) (and (= (first1 temp___expr_221) (- x 1)) (= (last1 temp___expr_221) (+ x 1))))))
...
(assert (forall ((temp___241 Int) (temp___242 Int) (temp___243 Int)) (let ((temp___240 (temp___239 temp___241 temp___242 temp___243))) (and (=> (dynamic_property4 1 10 temp___242 temp___243) (and (= (first3 temp___240) temp___242) (= (last3 temp___240) temp___243))) (forall ((temp___244 Int)) (= (select (to_array1 temp___240) temp___244) (of_rep temp___241)))))))
...
(define-fun dynamic_invariant3 ((temp___expr_144 Int) (temp___is_init_141 Bool) (temp___skip_constant_142 Bool) (temp___do_toplevel_143 Bool)) Bool (=> (or (= temp___is_init_141 true) (<= 1 10)) (in_range4 temp___expr_144)))
(declare-const temp___246 (Array Int integer))
(declare-const temp___2461 t1)
(assert (in_range3 x))
(assert (and (< 1 x) (< x 10)))
(assert (and (dynamic_property1 (- x 1) (+ x 1) (to_rep1 z__first) (to_rep1 z__last)) (and (= (to_rep1 z__first) (- x 1)) (= (to_rep1 z__last) (+ x 1)))))
(assert (= (to_rep1 (first2 (rt1 (temp___239 0 (- x 1) (+ x 1))))) (- x 1)))
(assert (= (to_rep1 (last2 (rt1 (temp___239 0 (- x 1) (+ x 1))))) (+ x 1)))
(assert (= (mk___t1 temp___246 temp___2461) (temp___239 0 (- x 1) (+ x 1))))
(assert (not (= (ite (<= (to_rep1 (first2 temp___2461)) (to_rep1 (last2 temp___2461))) (+ (- (to_rep1 (last2 temp___2461)) (to_rep1 (first2 temp___2461))) 1) 0) (ite (<= (- x 1) (+ x 1)) (+ (- (+ x 1) (- x 1)) 1) 0))))
(check-sat)
(exit)
