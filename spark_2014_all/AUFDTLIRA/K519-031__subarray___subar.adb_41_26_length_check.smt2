...
(declare-fun temp___274 (Int Int Int) us_t1)
...
(assert (forall ((temp___276 Int) (temp___277 Int) (temp___278 Int)) (let ((temp___275 (temp___274 temp___276 temp___277 temp___278))) (=> (dynamic_invariant2 temp___276 true true true true) (and (=> (dynamic_property4 1 10 temp___277 temp___278) (and (= (first3 temp___275) temp___277) (= (last3 temp___275) temp___278))) (forall ((temp___279 Int)) (= (to_rep (select (to_array1 temp___275) temp___279)) temp___276)))))))
...
(assert (= (to_rep1 (first2 (rt1 (temp___274 0 (- x 1) (+ x 1))))) (- x 1)))
(assert (= (to_rep1 (last2 (rt1 (temp___274 0 (- x 1) (+ x 1))))) (+ x 1)))
(assert (= (mk___t1 temp___281 temp___2811) (temp___274 0 (- x 1) (+ x 1))))
(assert (not (= (ite (<= (to_rep1 (first2 temp___2811)) (to_rep1 (last2 temp___2811))) (+ (- (to_rep1 (last2 temp___2811)) (to_rep1 (first2 temp___2811))) 1) 0) (ite (<= (- x 1) (+ x 1)) (+ (- (+ x 1) (- x 1)) 1) 0))))
(check-sat)
(exit)
