...
(assert (forall ((i t28b)) (and (<= 1 (t28bqtint i)) (<= (t28bqtint i) 3))))
(define-fun in_range3 ((x Int)) Bool (and (<= 1 x) (<= x 3)))
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun user_eq4 (t28b t28b) Bool)
(declare-const dummy4 t28b)
...
(declare-sort t30b 0)
(declare-fun t30bqtint (t30b) Int)
(assert (forall ((i t30b)) (and (<= 1 (t30bqtint i)) (<= (t30bqtint i) 3))))
(define-fun in_range4 ((x Int)) Bool (and (<= 1 x) (<= x 3)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq5 (t30b t30b) Bool)
(declare-const dummy5 t30b)
...
(assert (dynamic_property 1 2147483647 (to_rep1 b__first) (to_rep1 b__last)))
(assert (<= 1 3))
(assert (not (<= (to_rep1 a__first) 1)))
(check-sat)
(exit)
