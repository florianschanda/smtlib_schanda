...
(assert (=> (= (length1 (mk___t1 temp___997 temp___9971)) 0) (= (to_rep o) right)))
(assert (=> (= (length1 (mk___t1 temp___997 temp___9971)) 0) (= o1 (singleton1 o 1))))
(assert (=> (= (length1 (mk___t1 temp___997 temp___9971)) 0) (= o1 temp___998)))
(assert (=> (= (length1 (mk___t1 temp___997 temp___9971)) 0) (= (mk 1 1) temp___9981)))
(assert (=> (not (= (length1 (mk___t1 temp___997 temp___9971)) 0)) (=> (<= (to_rep1 (first2 temp___9971)) (to_rep1 (last2 temp___9971))) (= o4 (+ (- (to_rep1 (last2 temp___9971)) (to_rep1 (first2 temp___9971))) 1)))))
(assert (=> (not (= (length1 (mk___t1 temp___997 temp___9971)) 0)) (=> (not (<= (to_rep1 (first2 temp___9971)) (to_rep1 (last2 temp___9971)))) (= o4 0))))
(assert (=> (not (= (length1 (mk___t1 temp___997 temp___9971)) 0)) (= o5 (+ o4 1))))
(assert (=> (not (= (length1 (mk___t1 temp___997 temp___9971)) 0)) (= o6 (+ (to_rep1 (first2 temp___9971)) o5))))
(assert (=> (not (= (length1 (mk___t1 temp___997 temp___9971)) 0)) (= o7 (- o6 1))))
(assert (=> (not (= (length1 (mk___t1 temp___997 temp___9971)) 0)) (and (= o8 o7) (in_range2 o7))))
(assert (=> (not (= (length1 (mk___t1 temp___997 temp___9971)) 0)) (= (to_rep o2) right)))
(assert (=> (not (= (length1 (mk___t1 temp___997 temp___9971)) 0)) (= o3 (singleton1 o2 1))))
(assert (=> (not (= (length1 (mk___t1 temp___997 temp___9971)) 0)) (= o9 (concat1 temp___997 (to_rep1 (first2 temp___9971)) (to_rep1 (last2 temp___9971)) o3 1 1))))
(assert (=> (not (= (length1 (mk___t1 temp___997 temp___9971)) 0)) (= o9 temp___998)))
(assert (=> (not (= (length1 (mk___t1 temp___997 temp___9971)) 0)) (= (mk (to_rep1 (first2 temp___9971)) o8) temp___9981)))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first temp___9981)) (to_rep1 (last temp___9981))))
(assert (= temp___998 o10))
(assert (= (mk1 (to_rep1 (first temp___9981)) (to_rep1 (last temp___9981))) o11))
(assert (not (<= (length1 (mk___t1 o10 o11)) (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) 1))))
(check-sat)
(exit)
