...
(assert (not (= (ite (<= (to_rep1 (first8 temp___21331)) (to_rep1 (last8 temp___21331))) (+ (- (to_rep1 (last8 temp___21331)) (to_rep1 (first8 temp___21331))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 4)) 1) 0))))
(check-sat)
(exit)
