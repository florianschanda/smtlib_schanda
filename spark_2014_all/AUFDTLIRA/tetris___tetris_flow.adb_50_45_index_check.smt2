...
(define-fun dynamic_invariant ((temp___expr_537 Int) (temp___is_init_533 Bool) (temp___skip_constant_534 Bool) (temp___do_toplevel_535 Bool) (temp___do_typ_inv_536 Bool)) Bool (=> (or (= temp___is_init_533 true) (<= 0 7)) (in_range1 temp___expr_537)))
(define-fun dynamic_invariant1 ((temp___expr_544 Int) (temp___is_init_540 Bool) (temp___skip_constant_541 Bool) (temp___do_toplevel_542 Bool) (temp___do_typ_inv_543 Bool)) Bool (=> (or (= temp___is_init_540 true) (<= 1 7)) (in_range2 temp___expr_544)))
(define-fun dynamic_invariant2 ((temp___expr_551 Int) (temp___is_init_547 Bool) (temp___skip_constant_548 Bool) (temp___do_toplevel_549 Bool) (temp___do_typ_inv_550 Bool)) Bool (=> (or (= temp___is_init_547 true) (<= 3 7)) (in_range3 temp___expr_551)))
(define-fun dynamic_invariant3 ((temp___expr_558 Int) (temp___is_init_554 Bool) (temp___skip_constant_555 Bool) (temp___do_toplevel_556 Bool) (temp___do_typ_inv_557 Bool)) Bool (=> (or (= temp___is_init_554 true) (<= 1 10)) (in_range4 temp___expr_558)))
(define-fun dynamic_invariant4 ((temp___expr_565 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool) (temp___do_typ_inv_564 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 1 50)) (in_range5 temp___expr_565)))
(define-fun dynamic_invariant5 ((temp___expr_595 Int) (temp___is_init_591 Bool) (temp___skip_constant_592 Bool) (temp___do_toplevel_593 Bool) (temp___do_typ_inv_594 Bool)) Bool (=> (or (= temp___is_init_591 true) (<= (- 1) 9)) (in_range6 temp___expr_595)))
(define-fun dynamic_invariant6 ((temp___expr_602 Int) (temp___is_init_598 Bool) (temp___skip_constant_599 Bool) (temp___do_toplevel_600 Bool) (temp___do_typ_inv_601 Bool)) Bool (=> (or (= temp___is_init_598 true) (<= (- 1) 49)) (in_range7 temp___expr_602)))
(define-fun dynamic_invariant7 ((temp___expr_609 Int) (temp___is_init_605 Bool) (temp___skip_constant_606 Bool) (temp___do_toplevel_607 Bool) (temp___do_typ_inv_608 Bool)) Bool (=> (or (= temp___is_init_605 true) (<= 0 3)) (in_range8 temp___expr_609)))
...
(assert (<= 0 x1))
(assert (<= x1 3))
(assert (and (forall ((temp___763 Int)) (=> (and (<= 1 temp___763) (<= temp___763 50)) (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y2) temp___763)) (= (select cur_board1 temp___763) (select cur_board temp___763))))) (and (<= 0 x2) (<= x2 3))))
