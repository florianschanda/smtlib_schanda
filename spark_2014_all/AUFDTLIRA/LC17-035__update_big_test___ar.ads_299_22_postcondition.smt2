...
(declare-fun temp___792 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___794 (Array Int (Array Int et1)))) (forall ((temp___795 Int)) (forall ((temp___796 (Array Int et1))) (let ((temp___793 (temp___792 temp___794 temp___795 temp___796))) (forall ((temp___797 Int)) (ite (= temp___797 temp___795) (= (select temp___793 temp___797) temp___796) (= (select temp___793 temp___797) (select temp___794 temp___797)))))))))
(declare-fun temp___798 ((Array Int et1) Int Int Int Int) (Array Int et1))
(assert (forall ((temp___800 (Array Int et1))) (forall ((temp___801 Int) (temp___802 Int) (temp___803 Int) (temp___804 Int)) (let ((temp___799 (temp___798 temp___800 temp___801 temp___802 temp___803 temp___804))) (forall ((temp___805 Int)) (ite (= temp___805 temp___803) (= (select temp___799 temp___805) (of_rep temp___804)) (ite (= temp___805 temp___801) (= (select temp___799 temp___805) (of_rep temp___802)) (= (select temp___799 temp___805) (select temp___800 temp___805)))))))))
(declare-fun temp___808 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___810 (Array Int (Array Int et1)))) (forall ((temp___811 Int) (temp___813 Int)) (forall ((temp___812 (Array Int et1)) (temp___814 (Array Int et1))) (let ((temp___809 (temp___808 temp___810 temp___811 temp___812 temp___813 temp___814))) (forall ((temp___815 Int)) (ite (= temp___815 temp___813) (= (select temp___809 temp___815) temp___814) (ite (= temp___815 temp___811) (= (select temp___809 temp___815) temp___812) (= (select temp___809 temp___815) (select temp___810 temp___815))))))))))
(declare-fun temp___816 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___818 (Array Int et1))) (forall ((temp___819 Int) (temp___820 Int)) (let ((temp___817 (temp___816 temp___818 temp___819 temp___820))) (forall ((temp___821 Int)) (ite (= temp___821 temp___819) (= (select temp___817 temp___821) (of_rep temp___820)) (= (select temp___817 temp___821) (select temp___818 temp___821))))))))
(declare-fun temp___823 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___825 (Array Int et1))) (forall ((temp___826 Int) (temp___827 Int)) (let ((temp___824 (temp___823 temp___825 temp___826 temp___827))) (forall ((temp___828 Int)) (ite (= temp___828 temp___826) (= (select temp___824 temp___828) (of_rep temp___827)) (= (select temp___824 temp___828) (select temp___825 temp___828))))))))
...
(assert (= a4 a2))
(assert (not (= j1 j2)))
(assert (not (= (bool_eq1 a3 5 50 (temp___808 a j1 (temp___816 (select a j1) i1 e) j2 (temp___823 (select a j2) i2 f)) 5 50) true)))
(check-sat)
(exit)
