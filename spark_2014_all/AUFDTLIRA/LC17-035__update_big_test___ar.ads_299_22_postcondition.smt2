...
(assert (= a4 a2))
(assert (not (= j1 j2)))
(assert (not (= (bool_eq1 a3 5 50 (temp___867 a j1 (temp___875 (select a j1) i1 e) j2 (temp___882 (select a j2) i2 f)) 5 50) true)))
(check-sat)
(exit)
