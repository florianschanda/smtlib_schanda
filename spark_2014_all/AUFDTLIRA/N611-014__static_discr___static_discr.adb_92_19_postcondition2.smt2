...
(assert (not (= (let ((temp___451 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields__content2 current__split_fields6)))))) (bool_eq (elts1 temp___451) (to_rep1 (first2 (rt1 temp___451))) (to_rep1 (last2 (rt1 temp___451))) current__split_fields2 (to_rep1 (first2 current__split_fields3)) (to_rep1 (last2 current__split_fields3)))) true)))
(check-sat)
(exit)
