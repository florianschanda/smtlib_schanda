...
(assert (= (mk___rep (mk___split_fields types_with_invariants__get__result6 types_with_invariants__get__result7)) (mk___rep (mk___split_fields types_with_invariants__get__result2 types_with_invariants__get__result3))))
...
(assert (= o i))
(assert (= (mk___rep (mk___split_fields o1 o2)) (select (elts (rec__types_with_invariants__container__content (us_split_fields3 c))) o)))
(assert (= result types_with_invariants__get__result))
(assert (= result1 types_with_invariants__get__result1))
(assert (= (mk___rep (mk___split_fields types_with_invariants__get__result2 types_with_invariants__get__result3)) (mk___rep (mk___split_fields o1 o2))))
