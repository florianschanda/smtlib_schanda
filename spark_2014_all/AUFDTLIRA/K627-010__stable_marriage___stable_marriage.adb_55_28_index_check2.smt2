...
(assert (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (=> (exists ((prev1 Int)) (and (and (<= 1 prev1) (<= prev1 (- rank2 1))) (= (to_rep (select r1 prev1)) g1))) (= (to_rep (select r1 (to_rep1 (select result__2 g1)))) g1)))))
