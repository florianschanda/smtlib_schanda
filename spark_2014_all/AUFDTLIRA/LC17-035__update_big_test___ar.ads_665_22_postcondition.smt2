...
(declare-fun temp___2624 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(declare-fun temp___2630 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp___2636 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (= a3 a4))
(assert (= a5 a3))
(assert (not (= (bool_eq3 a4 90 99 (temp___2624 a i (temp___2630 b j (temp___2636 c k d))) 90 99) true)))
(check-sat)
(exit)
