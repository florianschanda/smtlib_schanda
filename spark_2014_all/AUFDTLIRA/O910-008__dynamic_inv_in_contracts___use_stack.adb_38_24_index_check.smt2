...
(define-fun dynamic_invariant1 ((temp___expr_186 Int) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool)) Bool (=> (or (= temp___is_init_183 true) (<= 0 last)) (dynamic_property 0 last temp___expr_186)))
(assert (= last max))
(assert true)
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range2 f) (=> (in_range2 l) (and (= (to_rep1 (first (mk f l))) f) (= (to_rep1 (last1 (mk f l))) l)))) :pattern ((mk f l)))))
...
(define-fun bool_eq1 ((x us_t) (y us_t)) Bool (bool_eq (elts x) (to_rep1 (first (rt x))) (to_rep1 (last1 (rt x))) (elts y) (to_rep1 (first (rt y))) (to_rep1 (last1 (rt y)))))
...
(assert (forall ((use_stack__stacks__top Int)) (forall ((use_stack__stacks__content (Array Int positive))) (! (=> (and (dynamic_invariant1 use_stack__stacks__top true true true) (not (= (is_empty use_stack__stacks__top) true))) (dynamic_invariant (peek use_stack__stacks__top use_stack__stacks__content) true false true)) :pattern ((peek use_stack__stacks__top use_stack__stacks__content))))))
(assert (forall ((use_stack__stacks__top Int)) (forall ((use_stack__stacks__content (Array Int positive))) (! (=> (dynamic_invariant1 use_stack__stacks__top true true true) (= (peek use_stack__stacks__top use_stack__stacks__content) (to_rep (select use_stack__stacks__content use_stack__stacks__top)))) :pattern ((peek use_stack__stacks__top use_stack__stacks__content))))))
...
(define-fun dynamic_invariant3 ((temp___expr_192 us_t) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool)) Bool (=> (not (= temp___skip_constant_190 true)) (and (dynamic_property2 1 max (first1 temp___expr_192) (last2 temp___expr_192)) (and (= (first1 temp___expr_192) 1) (= (last2 temp___expr_192) max)))))
(declare-const e Int)
(declare-const top Int)
(assert (in_range1 max))
(assert (=> (<= 1 2147483647) (in_range1 e)))
(assert (dynamic_property 0 last top))
(assert (and (dynamic_property2 1 max (to_rep1 content__first) (to_rep1 content__last)) (and (= (to_rep1 content__first) 1) (= (to_rep1 content__last) max))))
(assert (not (= (is_empty top) true)))
(assert (not (<= (to_rep1 content__first) top)))
(check-sat)
(exit)
