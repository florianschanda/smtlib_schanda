...
(assert (in_range7 v))
(assert (and (= (valid_root f_old root) true) (and (= (valid_root f root) true) (and (= (valid_root f_old v) true) (and (not (= (valid_root f v) true)) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) v))) true) (and (= (ordered_leafs f_old root values) true) (and (= (ordered_leafs f_old v values) true) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old root) i2))) true) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i2))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) v)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) v))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i2)))) 1)) 0) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old v) j))) true) (< (to_rep (select values j)) (to_rep (select values i2)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old v) j))) true) (< (to_rep (select values i2)) (to_rep (select values j)))))))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) i2))) true) (ite (= (ole (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) v))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i2)))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old v) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old root) i2))) true))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old root) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) i2))) true)))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (and (not (= v 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old v) i2))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) i2))) true)))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old root) i2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i2))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i2)))) true)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (and (not (= v 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f_old v) i2))) true)) (= (is_concat (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) v))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old v) i2))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i2)))) true)))))))))))))))))
...
(assert (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) k)))) 1)) 0))
