...
(declare-const dest10 (Array Int integer))
(declare-const src10 (Array Int integer))
(declare-const index9 Int)
(declare-const dest11 (Array Int integer))
(declare-const src11 (Array Int integer))
(declare-const index10 Int)
(declare-const dest12 (Array Int integer))
(declare-const src12 (Array Int integer))
...
(assert (= src2 o3))
(assert (and (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 index2)) (= (to_rep (select dest3 j2)) (to_rep (select src j2))))) (forall ((j2 Int)) (=> (and (<= (+ index2 1) j2) (<= j2 10)) (= (to_rep (select src3 j2)) (to_rep (select src j2)))))))
(assert (and (and (and (forall ((temp___171 Int)) (=> (and (<= 1 temp___171) (<= temp___171 10)) (=> (< index2 temp___171) (= (select dest3 temp___171) (select dest temp___171))))) (forall ((temp___173 Int)) (=> (and (<= 1 temp___173) (<= temp___173 10)) (=> (< index2 temp___173) (= (select src3 temp___173) (select src temp___173)))))) (=> (<= 1 10) (in_range3 index2))) (and (<= 1 index2) (<= index2 10))))
(assert (not (= index2 10)))
(assert (= result3 index2))
(assert (= index3 (+ index2 1)))
(assert (= (to_rep o11) (to_rep (select src3 index3))))
(assert (= o12 (store dest3 index3 o11)))
(assert (= result4 dest3))
(assert (= dest4 o12))
(assert (= (to_rep o13) 0))
(assert (= o14 (store src3 index3 o13)))
(assert (= result5 src3))
(assert (= src4 o14))
(declare-const j2 Int)
(assert (<= 1 j2))
(assert (<= j2 index3))
(assert (not (= (to_rep (select dest4 j2)) (to_rep (select src j2)))))
(check-sat)
(exit)
