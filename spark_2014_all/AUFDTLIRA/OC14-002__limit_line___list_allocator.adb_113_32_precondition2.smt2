...
(assert (and (= o56 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 o56)))
(assert (= result13 (ite (in_range7 o56) true false)))
(assert (=> (= result13 true) (and (= o52 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o52))))
(assert (=> (= result13 true) (= result14 (ite (< j o52) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o53 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o54 (get (rec__list_allocator__m__t__available model____split_fields3) o53)) (in_range4 o54)))))
...
(assert (=> (= result13 true) (= o48 temp___431)))
...
(assert (=> (= result12 true) (=> (< 1 j) (and (= o46 (get (rec__list_allocator__m__t__available model____split_fields3) o45)) (in_range4 o46)))))
...
(assert (=> (= result12 true) (= o41 temp___432)))
...
(assert (not (= j k)))
(assert (and (= o40 (get (rec__list_allocator__m__t__available model____split_fields3) k)) (in_range4 o40)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
