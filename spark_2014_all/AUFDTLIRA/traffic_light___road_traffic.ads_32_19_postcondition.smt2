...
(define-fun dynamic_invariant ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 3)) (in_range1 temp___expr_141)))
...
(declare-fun concat1 ((Array Int light) Int Int (Array Int light) Int Int) (Array Int light))
(assert (forall ((a (Array Int light)) (b (Array Int light))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (forall ((i Int)) (! (and (=> (and (<= a_first i) (<= i a_last)) (= (select (concat1 a a_first a_last b b_first b_last) i) (select a i))) (=> (< a_last i) (= (select (concat1 a a_first a_last b b_first b_last) i) (select b (+ (- i a_last) (- b_first 1)))))) :pattern ((select (concat1 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton1 (light Int) (Array Int light))
(assert (forall ((v light)) (forall ((i Int)) (! (= (select (singleton1 v i) i) v) :pattern ((select (singleton1 v i) i))))))
(define-fun bool_eq ((a (Array Int light)) (a__first Int) (a__last Int) (b (Array Int light)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep1 (select a temp___idx_132)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(declare-fun compare ((Array Int light) Int Int (Array Int light) Int Int) Int)
(assert (forall ((a (Array Int light)) (b (Array Int light))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int light)) (b (Array Int light))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep1 (select a (+ i 1))) (to_rep1 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int light)) (b (Array Int light))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep1 (select b (+ i 1))) (to_rep1 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq2 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_137 Int)) (=> (and (<= a__first temp___idx_137) (<= temp___idx_137 a__last)) (= (bool_eq1 (select a temp___idx_137) (select b (+ (- b__first a__first) temp___idx_137))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_137 Int)) (=> (and (<= a__first temp___idx_137) (<= temp___idx_137 a__last)) (= (bool_eq1 (select a temp___idx_137) (select b (+ (- b__first a__first) temp___idx_137))) true))))))))
...
(assert true)
(assert (forall ((l (Array Int light))) (forall ((road_traffic__conflicts (Array Int us_rep))) (! (= (= (safety_property l road_traffic__conflicts) true) (forall ((temp___188 Int)) (=> (and (<= 1 temp___188) (<= temp___188 8)) (let ((c (select road_traffic__conflicts temp___188))) (or (= (to_rep1 (select l (to_rep (rec__road_traffic__conflict__left (us_split_fields1 c))))) 0) (= (to_rep1 (select l (to_rep (rec__road_traffic__conflict__right (us_split_fields1 c))))) 0)))))) :pattern ((safety_property l road_traffic__conflicts))))))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const p Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(define-fun dynamic_invariant1 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 0 2)) (in_range2 temp___expr_147)))
...
(assert (in_range1 p))
(assert (and (and (= (safety_property l conflicts) true) (= (to_rep1 (select l p)) 0)) (forall ((temp___223 Int)) (=> (and (<= 1 temp___223) (<= temp___223 8)) (let ((c (select conflicts temp___223))) (and (and (not (= (to_rep (rec__road_traffic__conflict__left (us_split_fields1 c))) (to_rep (rec__road_traffic__conflict__right (us_split_fields1 c))))) (=> (= (to_rep (rec__road_traffic__conflict__left (us_split_fields1 c))) p) (= (to_rep1 (select l (to_rep (rec__road_traffic__conflict__right (us_split_fields1 c))))) 0))) (=> (= (to_rep (rec__road_traffic__conflict__right (us_split_fields1 c))) p) (= (to_rep1 (select l (to_rep (rec__road_traffic__conflict__left (us_split_fields1 c))))) 0))))))))
(assert (= (to_rep1 o) 2))
