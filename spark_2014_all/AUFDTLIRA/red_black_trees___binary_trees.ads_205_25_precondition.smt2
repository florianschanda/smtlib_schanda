...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o60 (size (mk___rep2 (us_split_fields__content2 f__split_fields7)))) (and (in_range2 o60) (= o60 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))))))
(assert (= result6 (ite (= o60 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) true false)))
(assert (= result6 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o59 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o59) (and (= o59 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o59 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o59) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o59) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)) (= o59 j)))))))))
(assert (= result8 (ite (= o59 0) true false)))
(assert (= result8 true))
...
(assert (=> (not (= (int__content v2) 0)) (and (= o57 (int__content v2)) (in_range1 (int__content v2)))))
(assert (=> (not (= (int__content v2) 0)) (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true)))
(assert (=> (not (= (int__content v2) 0)) (and (= o58 (int__content v2)) (in_range1 (int__content v2)))))
(assert (=> (not (= (int__content v2) 0)) (and (= result14 (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) o58)) (and (= (= result14 true) (and (<= o58 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) o58)))) 2))) (=> (< (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) o58) (not (= result14 true)))))))
...
(assert (and (= temp___795 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) o53)) (and (dynamic_invariant3 temp___795 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___795 o53))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___795 o53)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 o53)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___795 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___795 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___795 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___795 i2))) true) (not (= i2 o53))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___795 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___795 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___795 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___795 i2))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___795 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___795 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___795 j)))) true)) (= j i2))))))))))))))
(assert (= o54 (select temp___795 i1)))
...
(assert (= o48 (int__content v2)))
(assert (= o49 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) o48)))
(assert (= o50 (us_split_fields1 o49)))
(assert (= o51 (rec__tree_model__path_type__a o50)))
(assert (not (<= (length o51) 100)))
(check-sat)
(exit)
