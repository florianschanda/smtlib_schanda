...
(assert (and (= temp___749 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) o53)) (and (dynamic_invariant3 temp___749 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___749 o53))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___749 o53)))) 0) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (not (= i8 o53)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i8) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___749 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i8)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___749 i8))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___749 i8))) true)))))) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___749 i8))) true) (not (= i8 o53))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___749 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i8)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i8) (rec__tree_model__path_type__a (us_split_fields1 (select temp___749 i8)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___749 i8)))) 0)))) (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___749 i8))) true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___749 j3))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___749 i8))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___749 j3)))) true)) (= j3 i8))))))))))))))
(assert (= o54 (select temp___749 i3)))
