...
(assert (forall ((temp___219 map1)) (forall ((temp___220 Int)) (= (select (p_bad__x__aggregate_def temp___219) temp___220) temp___219))))
...
(declare-const temp___2572 (Array Int map1))
(declare-const temp___2573 t1)
...
(declare-const temp___2574 (Array Int map1))
(declare-const temp___2575 t1)
