...
(assert (forall ((temp___427 Int)) (=> (dynamic_invariant4 temp___427 true true true true) (forall ((temp___428 Int)) (= (select (size_attr__ca__aggregate_def temp___427) temp___428) rliteral)))))
(assert (forall ((temp___430 Int)) (=> (dynamic_invariant4 temp___430 true true true true) (forall ((temp___431 Int)) (= (select (size_attr__ua__aggregate_def temp___430) temp___431) rliteral)))))
(assert (forall ((temp___433 Int)) (=> (dynamic_invariant4 temp___433 true true true true) (forall ((temp___434 Int)) (= (select (size_attr__ca2__aggregate_def temp___433) temp___434) rliteral)))))
(assert (forall ((temp___436 Int)) (=> (dynamic_invariant4 temp___436 true true true true) (forall ((temp___437 Int)) (= (select (size_attr__ca3__aggregate_def temp___436) temp___437) rliteral)))))
(assert (forall ((temp___439 Int)) (=> (dynamic_invariant4 temp___439 true true true true) (forall ((temp___440 Int)) (= (select (size_attr__ca4__aggregate_def temp___439) temp___440) rliteral)))))
(assert (forall ((temp___442 Int)) (=> (dynamic_invariant4 temp___442 true true true true) (forall ((temp___443 Int) (temp___444 Int)) (= (get (size_attr__ua2__aggregate_def temp___442) temp___443 temp___444) rliteral)))))
(assert (forall ((temp___446 Int)) (=> (dynamic_invariant4 temp___446 true true true true) (forall ((temp___447 Int) (temp___448 Int) (temp___449 Int)) (= (get1 (size_attr__ua3__aggregate_def temp___446) temp___447 temp___448 temp___449) rliteral)))))
(assert (forall ((temp___451 Int)) (=> (dynamic_invariant4 temp___451 true true true true) (forall ((temp___452 Int) (temp___453 Int) (temp___454 Int) (temp___455 Int)) (= (get2 (size_attr__ua4__aggregate_def temp___451) temp___452 temp___453 temp___454 temp___455) rliteral)))))
...
(assert (= v4__split_fields1 (mk___split_fields1 rliteral1)))
