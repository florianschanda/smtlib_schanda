...
(define-fun dynamic_invariant1 ((temp___expr_181 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (=> (or (= temp___is_init_178 true) (<= 1 10)) (in_range4 temp___expr_181)))
(declare-sort r 0)
...
(define-fun size_attr__r1__x__pred ((a us_rep)) Bool (= (to_int1 (rec__size_attr__r1__a (us_split_discrs1 a))) 1))
...
(define-fun default_initial_assumption ((temp___expr_195 us_rep) (temp___skip_top_level_196 Bool)) Bool (and (= (attr__constrained temp___expr_195) false) (= (rec__size_attr__r1__a (us_split_discrs1 temp___expr_195)) (of_int 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_202 us_rep) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (and (=> (not (= temp___skip_constant_200 true)) (in_range5 (of_int 0) temp___expr_202)) (= (attr__constrained temp___expr_202) true)))
(define-fun default_initial_assumption1 ((temp___expr_204 us_rep) (temp___skip_top_level_205 Bool)) Bool (and (= (attr__constrained temp___expr_204) true) (= (rec__size_attr__r1__a (us_split_discrs1 temp___expr_204)) (of_int 0))))
...
(define-fun default_initial_assumption2 ((temp___expr_219 us_rep2) (temp___skip_top_level_220 Bool)) Bool (= (attr__tag temp___expr_219) us_tag))
...
(define-fun default_initial_assumption3 ((temp___expr_230 us_rep3) (temp___skip_top_level_231 Bool)) Bool (= (attr__tag1 temp___expr_230) us_tag1))
...
(define-fun bool_eq6 ((a (Array Int natural)) (a__first Int) (a__last Int) (b (Array Int natural)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep2 (select a temp___idx_132)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep2 (select a temp___idx_132)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_132)))))))))))
(declare-fun compare1 ((Array Int natural) Int Int (Array Int natural) Int Int) Int)
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq6 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq6 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq6 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant3 ((temp___expr_315 us_rep) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (and (=> (not (= temp___skip_constant_313 true)) (in_range7 (of_int 0) temp___expr_315)) (= (attr__constrained temp___expr_315) true)))
(define-fun default_initial_assumption4 ((temp___expr_317 us_rep) (temp___skip_top_level_318 Bool)) Bool (and (= (attr__constrained temp___expr_317) true) (= (rec__size_attr__r1__a (us_split_discrs1 temp___expr_317)) (of_int 0))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_370 us_void_param) 1)) 97) (= (to_rep (select (temp___String_Literal_370 us_void_param) 2)) 98)) (= (to_rep (select (temp___String_Literal_370 us_void_param) 3)) 99)) :pattern ((temp___String_Literal_370 us_void_param)))))
(declare-fun size_attr__ca__aggregate_def (Int) (Array Int natural))
(assert (forall ((temp___387 Int)) (forall ((temp___388 Int)) (= (select (size_attr__ca__aggregate_def temp___387) temp___388) (of_rep2 temp___387)))))
(declare-fun size_attr__ua__aggregate_def (Int) (Array Int natural))
(assert (forall ((temp___390 Int)) (forall ((temp___391 Int)) (= (select (size_attr__ua__aggregate_def temp___390) temp___391) (of_rep2 temp___390)))))
(declare-fun size_attr__ca2__aggregate_def (Int) (Array Int natural))
(assert (forall ((temp___393 Int)) (forall ((temp___394 Int)) (= (select (size_attr__ca2__aggregate_def temp___393) temp___394) (of_rep2 temp___393)))))
(declare-fun size_attr__ca3__aggregate_def (Int) (Array Int natural))
(assert (forall ((temp___396 Int)) (forall ((temp___397 Int)) (= (select (size_attr__ca3__aggregate_def temp___396) temp___397) (of_rep2 temp___396)))))
(declare-fun size_attr__ca4__aggregate_def (Int) (Array Int natural))
(assert (forall ((temp___399 Int)) (forall ((temp___400 Int)) (= (select (size_attr__ca4__aggregate_def temp___399) temp___400) (of_rep2 temp___399)))))
(declare-fun size_attr__ua2__aggregate_def (Int) map1)
(assert (forall ((temp___402 Int)) (forall ((temp___403 Int) (temp___404 Int)) (= (get (size_attr__ua2__aggregate_def temp___402) temp___403 temp___404) (of_rep2 temp___402)))))
(declare-fun size_attr__ua3__aggregate_def (Int) map2)
(assert (forall ((temp___406 Int)) (forall ((temp___407 Int) (temp___408 Int) (temp___409 Int)) (= (get1 (size_attr__ua3__aggregate_def temp___406) temp___407 temp___408 temp___409) (of_rep2 temp___406)))))
(declare-fun size_attr__ua4__aggregate_def (Int) map3)
(assert (forall ((temp___411 Int)) (forall ((temp___412 Int) (temp___413 Int) (temp___414 Int) (temp___415 Int)) (= (get2 (size_attr__ua4__aggregate_def temp___411) temp___412 temp___413 temp___414 temp___415) (of_rep2 temp___411)))))
...
(define-fun dynamic_invariant8 ((temp___expr_250 us_t1) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool)) Bool (=> (not (= temp___skip_constant_248 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_250) (last3 temp___expr_250))))
(define-fun dynamic_invariant9 ((temp___expr_266 us_t2) (temp___is_init_263 Bool) (temp___skip_constant_264 Bool) (temp___do_toplevel_265 Bool)) Bool (=> (not (= temp___skip_constant_264 true)) (dynamic_property4 1 2147483647 (first6 temp___expr_266) (last6 temp___expr_266) 1 2147483647 (first_2 temp___expr_266) (last_2 temp___expr_266))))
(define-fun dynamic_invariant10 ((temp___expr_285 us_t3) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool)) Bool (=> (not (= temp___skip_constant_283 true)) (dynamic_property8 1 2147483647 (first10 temp___expr_285) (last10 temp___expr_285) 1 2147483647 (first_21 temp___expr_285) (last_21 temp___expr_285) 1 2147483647 (first_3 temp___expr_285) (last_3 temp___expr_285))))
(define-fun dynamic_invariant11 ((temp___expr_307 us_t4) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool)) Bool (=> (not (= temp___skip_constant_305 true)) (dynamic_property13 1 2147483647 (first15 temp___expr_307) (last15 temp___expr_307) 1 2147483647 (first_22 temp___expr_307) (last_22 temp___expr_307) 1 2147483647 (first_31 temp___expr_307) (last_31 temp___expr_307) 1 2147483647 (first_4 temp___expr_307) (last_4 temp___expr_307))))
...
(declare-const v5__split_fields integer)
(declare-const v5__split_fields1 us_private)
(declare-const v6__split_fields integer)
(declare-const v6__split_fields1 integer)
(declare-const v6__split_fields2 us_private)
...
(assert (and (= v1__attr__constrained true) (= (rec__size_attr__r1__a v1__split_discrs) (of_int 0))))
(assert (and (= (of_int 0) (rec__size_attr__r1__a v1__split_discrs)) (= v1__attr__constrained true)))
(assert (and (= v2__attr__constrained false) (= v2__split_discrs (of_int 0))))
(assert (and (= v3__attr__constrained true) (= (rec__size_attr__r1__a v3__split_discrs) (of_int 0))))
(assert (and (= (of_int 0) (rec__size_attr__r1__a v3__split_discrs)) (= v3__attr__constrained true)))
(assert (= (to_rep1 o) 1))
...
(assert (<= 0 (object__size15 (mk___rep v1__split_discrs (mk___split_fields v1__split_fields) v1__attr__constrained))))
(assert (<= 0 (object__size2 (mk___rep (mk___split_discrs v2__split_discrs) (mk___split_fields v2__split_fields) v2__attr__constrained))))
(assert (<= 0 (object__size3 (mk___rep v3__split_discrs (mk___split_fields v3__split_fields) v3__attr__constrained))))
(assert (not (<= 0 (object__size4 (mk___rep1 v4__split_fields1)))))
(check-sat)
(exit)
