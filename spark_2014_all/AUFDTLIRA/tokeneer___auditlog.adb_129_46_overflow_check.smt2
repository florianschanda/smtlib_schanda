...
(define-fun dynamic_invariant4 ((temp___expr_499 Int) (temp___is_init_496 Bool) (temp___skip_constant_497 Bool) (temp___do_toplevel_498 Bool)) Bool (=> (or (= temp___is_init_496 true) (<= 1 150)) (in_range4 temp___expr_499)))
...
(assert (= temp___1577 (- o 1)))
(assert (= result1 i))
(assert (= i2 0))
(assert (<= 0 i2))
(assert (<= i2 temp___1577))
