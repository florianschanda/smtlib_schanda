...
(define-fun dynamic_invariant4 ((temp___expr_455 Int) (temp___is_init_452 Bool) (temp___skip_constant_453 Bool) (temp___do_toplevel_454 Bool)) Bool (=> (or (= temp___is_init_452 true) (<= 1 150)) (in_range4 temp___expr_455)))
...
(declare-const temp___1517 Int)
(declare-const temp___1516 Int)
...
(assert (= temp___1521 (- o 1)))
(assert (= result1 i))
(assert (= i2 0))
(assert (<= 0 i2))
(assert (<= i2 temp___1521))
(assert (and (<= 0 i3) (<= i3 (- (length description) 1))))
(assert (not (in_range1 (+ (to_rep1 (first (rt description))) i3))))
(check-sat)
(exit)
