...
(define-fun dynamic_invariant4 ((temp___expr_556 Int) (temp___is_init_552 Bool) (temp___skip_constant_553 Bool) (temp___do_toplevel_554 Bool) (temp___do_typ_inv_555 Bool)) Bool (=> (or (= temp___is_init_552 true) (<= 1 150)) (in_range4 temp___expr_556)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___156 Int)) (=> (dynamic_invariant2 temp___156 true true true true) (forall ((temp___157 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___156) temp___157)) temp___156)))))
(declare-const localdesc (Array Int character))
(declare-const i Int)
(declare-const o Int)
(declare-const temp___1731 Int)
(declare-const result (Array Int character))
(declare-const localdesc1 (Array Int character))
...
(assert (= result localdesc))
(assert (= localdesc1 nodescription))
(assert (< (length description) 150))
(assert (and (= o (length description)) (in_range1 (length description))))
(assert (= temp___1731 (- o 1)))
(assert (= result1 i))
(assert (= i1 0))
(assert (<= 0 i1))
(assert (<= i1 temp___1731))
(assert (and (<= 0 i2) (<= i2 (- (length description) 1))))
(assert (not (in_range1 (+ (to_rep1 (first (rt description))) i2))))
(check-sat)
(exit)
