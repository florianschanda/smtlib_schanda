...
(assert (= o47 train))
(assert (= (mk___rep (mk___split_fields o48 o49 o50)) (select trains o47)))
(assert (= o48 o51))
(assert (= o49 o52))
(assert (= o50 o53))
(assert (= o54 o51))
...
(assert (=> (= result2 true) (= (mk___rep (mk___split_fields o37 o38 o39)) (select trains o36))))
...
(assert (=> (= result2 true) (= (mk___rep (mk___split_fields o29 o30 o31)) (select trains o28))))
...
(assert (=> (= result2 true) (= result1 (ite (not (= o46 true)) true false))))
...
(assert (=> (= result1 true) (= (mk___rep (mk___split_fields o18 o19 o20)) (select trains o17))))
...
(assert (=> (= result1 true) (= (mk___rep (mk___split_fields o10 o11 o12)) (select trains o9))))
...
(assert (=> (= result1 true) (= result (ite (not (= o27 true)) true false))))
