...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (let ((temp___389 (temp___214 (mk___t a (mk (to_rep a__first) (to_rep a__last))) i new_val))) (bool_eq a2 (to_rep a__first) (to_rep a__last) (elts temp___389) (to_rep (first (rt temp___389))) (to_rep (last (rt temp___389))))) true)))
(check-sat)
(exit)
