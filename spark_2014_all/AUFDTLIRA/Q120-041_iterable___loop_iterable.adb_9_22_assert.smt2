...
(define-fun dynamic_invariant ((temp___expr_150 us_rep) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (=> (= temp___do_toplevel_149 true) (=> (= temp___is_init_147 true) (<= (to_rep (rec__composite_cursors__cont1__length (us_split_fields1 temp___expr_150))) 100))))
(define-fun dynamic_predicate ((temp___159 us_rep)) Bool (<= (to_rep (rec__composite_cursors__cont1__length (us_split_fields1 temp___159))) 100))
...
(assert (forall ((temp___166 Int)) (= (select (temp___164 temp___166) 1) (of_rep temp___166))))
(assert true)
(assert (forall ((c us_rep)) (! (=> (dynamic_invariant c true true true) (= (first c) (temp___164 1))) :pattern ((first c)))))
...
(assert (forall ((temp___178 Int)) (= (select (temp___176 temp___178) 1) (of_rep temp___178))))
(assert true)
(assert (forall ((c us_rep)) (forall ((p (Array Int natural))) (! (=> (dynamic_invariant c true true true) (= (next c p) (temp___176 (+ (to_rep (select p 1)) 1)))) :pattern ((next c p))))))
...
(assert (forall ((c us_rep)) (forall ((p (Array Int natural))) (! (=> (and (dynamic_invariant c true true true) (= (has_element c p) true)) (dynamic_invariant1 (element c p) true false true)) :pattern ((element c p))))))
(assert (forall ((c us_rep)) (forall ((p (Array Int natural))) (! (=> (dynamic_invariant c true true true) (= (element c p) (to_rep (let ((temp___190 (rec__composite_cursors__cont1__content (us_split_fields1 c)))) (select temp___190 (to_rep (select p 1))))))) :pattern ((element c p))))))
...
(define-fun dynamic_invariant2 ((temp___expr_201 us_rep2) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (= temp___do_toplevel_200 true) (=> (= temp___is_init_198 true) (<= (to_rep (rec__composite_cursors__cont2__length (us_split_fields5 temp___expr_201))) 100))))
(define-fun dynamic_predicate1 ((temp___210 us_rep2)) Bool (<= (to_rep (rec__composite_cursors__cont2__length (us_split_fields5 temp___210))) 100))
(declare-fun first__2 (us_rep2) us_rep1)
(declare-fun first__2__function_guard (us_rep1 us_rep2) Bool)
(assert true)
(assert (forall ((c us_rep2)) (! (=> (dynamic_invariant2 c true true true) (= (first__2 c) (mk___rep1 (mk___split_fields1 (of_rep 1))))) :pattern ((first__2 c)))))
...
(assert true)
(assert (forall ((c us_rep2)) (forall ((p us_rep1)) (! (=> (dynamic_invariant2 c true true true) (= (next__2 c p) (mk___rep1 (mk___split_fields1 (of_rep (+ (to_rep (rec__composite_cursors__rec_cursor__content (us_split_fields3 p))) 1)))))) :pattern ((next__2 c p))))))
(declare-fun element__2 (us_rep2 us_rep1) Int)
(declare-fun element__2__function_guard (Int us_rep2 us_rep1) Bool)
(assert (forall ((c us_rep2)) (forall ((p us_rep1)) (! (=> (and (dynamic_invariant2 c true true true) (= (has_element__2 c p) true)) (dynamic_invariant1 (element__2 c p) true false true)) :pattern ((element__2 c p))))))
(assert (forall ((c us_rep2)) (forall ((p us_rep1)) (! (=> (dynamic_invariant2 c true true true) (= (element__2 c p) (to_rep (let ((temp___223 (rec__composite_cursors__cont2__content (us_split_fields5 c)))) (select temp___223 (to_rep (rec__composite_cursors__rec_cursor__content (us_split_fields3 p)))))))) :pattern ((element__2 c p))))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-fun temp___260 (Int Int) (Array Int natural))
(assert (forall ((temp___262 Int) (temp___263 Int)) (let ((temp___261 (temp___260 temp___262 temp___263))) (forall ((temp___264 Int)) (ite (and (<= 1 temp___264) (<= temp___264 10)) (= (select temp___261 temp___264) (of_rep temp___262)) (= (select temp___261 temp___264) (of_rep temp___263)))))))
(declare-fun temp___266 (Int Int) (Array Int natural))
(assert (forall ((temp___268 Int) (temp___269 Int)) (let ((temp___267 (temp___266 temp___268 temp___269))) (forall ((temp___270 Int)) (ite (and (<= 1 temp___270) (<= temp___270 10)) (= (select temp___267 temp___270) (of_rep temp___268)) (= (select temp___267 temp___270) (of_rep temp___269)))))))
...
(declare-const temp___2743 (Array Int natural))
(declare-const result7 Bool)
(declare-const e6 int__ref)
(declare-const temp___2744 map__ref)
(declare-const e7 Int)
(declare-const temp___2745 (Array Int natural))
(declare-const e8 int__ref)
(declare-const temp___2746 map__ref)
(declare-const e9 Int)
(declare-const temp___2747 (Array Int natural))
...
(declare-const temp___2771 us_rep1)
(declare-const result11 Bool)
(declare-const result12 rec_cursor__ref)
(declare-const temp___2772 us_rep1)
...
(assert (= (mk___rep (mk___split_fields loop_iterable__c1__assume loop_iterable__c1__assume1)) (mk___rep (mk___split_fields temp___265 temp___2651))))
...
(assert (= (mk___rep2 (mk___split_fields2 loop_iterable__c2__assume loop_iterable__c2__assume1)) (mk___rep2 (mk___split_fields2 temp___271 temp___2711))))
...
(assert (and (= o6 (first (mk___rep c1__split_fields2))) (= o6 (temp___164 1))))
(assert (= o6 temp___274))
(assert (and (= result2 (has_element (mk___rep c1__split_fields2) temp___274)) (= (= result2 true) (and (<= 1 (to_rep (select temp___274 1))) (<= (to_rep (select temp___274 1)) (to_rep (rec__composite_cursors__cont1__length c1__split_fields2)))))))
(assert (=> (= result2 true) (and (= o7 (element (mk___rep c1__split_fields2) temp___274)) (and (in_range1 o7) (= o7 (to_rep (select (rec__composite_cursors__cont1__content c1__split_fields2) (to_rep (select temp___274 1)))))))))
(assert (=> (= result2 true) (= result3 (mk_int__ref e))))
(assert (=> (= result2 true) (= e4 o7)))
(assert (=> (not (= result2 true)) (= e4 e)))
(assert (=> (not (= result2 true)) (= e4 e2)))
(assert (and (= result4 (has_element (mk___rep c1__split_fields2) temp___274)) (= (= result4 true) (and (<= 1 (to_rep (select temp___274 1))) (<= (to_rep (select temp___274 1)) (to_rep (rec__composite_cursors__cont1__length c1__split_fields2)))))))
(assert (= result4 true))
(assert (and (= (has_element (mk___rep c1__split_fields2) temp___2742) true) (= e5 (element (mk___rep c1__split_fields2) temp___2742))))
(assert (not (= e5 1)))
(check-sat)
(exit)
