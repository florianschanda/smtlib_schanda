...
(define-fun dynamic_invariant ((temp___expr_585 Int) (temp___is_init_582 Bool) (temp___skip_constant_583 Bool) (temp___do_toplevel_584 Bool)) Bool (=> (or (= temp___is_init_582 true) (<= 0 3)) (in_range5 temp___expr_585)))
...
(define-fun dynamic_invariant2 ((temp___expr_851 Int) (temp___is_init_848 Bool) (temp___skip_constant_849 Bool) (temp___do_toplevel_850 Bool)) Bool (=> (or (= temp___is_init_848 true) (<= 1901 2099)) (in_range7 temp___expr_851)))
(define-fun dynamic_invariant3 ((temp___expr_857 Int) (temp___is_init_854 Bool) (temp___skip_constant_855 Bool) (temp___do_toplevel_856 Bool)) Bool (=> (or (= temp___is_init_854 true) (<= 1 12)) (in_range8 temp___expr_857)))
(define-fun dynamic_invariant4 ((temp___expr_863 Int) (temp___is_init_860 Bool) (temp___skip_constant_861 Bool) (temp___do_toplevel_862 Bool)) Bool (=> (or (= temp___is_init_860 true) (<= 1 31)) (in_range9 temp___expr_863)))
(define-fun dynamic_invariant5 ((temp___expr_891 Int) (temp___is_init_888 Bool) (temp___skip_constant_889 Bool) (temp___do_toplevel_890 Bool)) Bool (=> (or (= temp___is_init_888 true) (<= 0 86399999)) (in_range10 temp___expr_891)))
(assert (= zerotime (mk___rep3 (mk___split_fields3 (of_rep7 1901) (of_rep8 1) (of_rep9 1) (of_rep10 0)))))
(define-fun dynamic_invariant6 ((temp___expr_359 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 40)) (in_range1 temp___expr_359)))
...
(define-fun dynamic_invariant7 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 4294967295)) (in_range3 temp___expr_380)))
(declare-const nullissuer us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(assert (= nullissuer (mk___rep (mk___split_fields (of_rep3 0) (of_rep1 0) blankname))))
(define-fun dynamic_invariant8 ((temp___expr_402 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 10)) (in_range temp___expr_402)))
(define-fun dynamic_invariant9 ((temp___expr_597 Int) (temp___is_init_594 Bool) (temp___skip_constant_595 Bool) (temp___do_toplevel_596 Bool)) Bool (=> (or (= temp___is_init_594 true) (<= 0 5)) (in_range6 temp___expr_597)))
(define-fun dynamic_invariant10 ((temp___expr_493 Int) (temp___is_init_490 Bool) (temp___skip_constant_491 Bool) (temp___do_toplevel_492 Bool)) Bool (=> (or (= temp___is_init_490 true) (<= 0 4294967295)) (in_range4 temp___expr_493)))
...
(declare-const temp___1955 us_rep4)
...
(assert (= temp___1955 (mk___rep4 o5)))
(assert (= temp___1955 nullcontents))
