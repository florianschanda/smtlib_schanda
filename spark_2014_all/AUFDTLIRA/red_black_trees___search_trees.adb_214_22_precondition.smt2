...
(declare-const temp___1345 (Array Int us_rep1))
(declare-const o10 us_rep1)
(declare-const o11 us_split_fields)
(declare-const o12 us_rep)
(declare-const temp___1346 (Array Int us_rep1))
...
(assert (and (= temp___1346 (model__ f root)) (and (dynamic_invariant5 temp___1346 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1346 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1346 root)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 root)) (ite (and (not (= (parent f i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1346 (parent f i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1346 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1346 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1346 i3))) true) (not (= i3 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1346 (parent f i3)))) (position f i3) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1346 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1346 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1346 i3))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1346 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1346 i3))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1346 j2)))) true)) (= j2 i3))))))))))))))
(assert (= o13 (select temp___1346 i2)))
(assert (= o14 (us_split_fields1 o13)))
(assert (= o15 (rec__tree_model__path_type__a o14)))
(assert (and (= o16 (length o15)) (and (in_range4 o16) (<= (+ 0 o16) 2147483647))))
(assert (= o17 (+ o16 1)))
(assert (and (= o18 o17) (in_range2 o17)))
(assert (and (= temp___1345 (model__ f root)) (and (dynamic_invariant5 temp___1345 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1345 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1345 root)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 root)) (ite (and (not (= (parent f i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1345 (parent f i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1345 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1345 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1345 i3))) true) (not (= i3 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1345 (parent f i3)))) (position f i3) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1345 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1345 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1345 i3))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1345 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1345 i3))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1345 j2)))) true)) (= j2 i3))))))))))))))
(assert (= o10 (select temp___1345 j1)))
