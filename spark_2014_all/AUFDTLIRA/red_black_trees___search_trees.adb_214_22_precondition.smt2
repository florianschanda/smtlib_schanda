...
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) i9))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) j11)))) true))
(assert (and (= temp___1302 (model__ f root)) (and (dynamic_invariant5 temp___1302 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1302 root)))) 0) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (not (= i34 root)) (ite (and (not (= (parent f i34) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 (parent f i34)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 i34))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 i34))) true)))))) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 i34))) true) (not (= i34 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1302 (parent f i34)))) (position f i34) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1302 i34)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1302 i34)))) 0)))) (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 i34))) true) (forall ((j52 Int)) (=> (and (<= 1 j52) (<= j52 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 j52))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1302 i34))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1302 j52)))) true)) (= j52 i34))))))))))))))
(assert (= o81 (select temp___1302 i9)))
(assert (= o82 (us_split_fields1 o81)))
(assert (= o83 (rec__tree_model__path_type__a o82)))
(assert (and (= o84 (length o83)) (and (in_range4 o84) (<= (+ 0 o84) 2147483647))))
(assert (= o85 (+ o84 1)))
(assert (and (= o86 o85) (in_range2 o85)))
(assert (and (= temp___1301 (model__ f root)) (and (dynamic_invariant5 temp___1301 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1301 root)))) 0) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (not (= i34 root)) (ite (and (not (= (parent f i34) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 (parent f i34)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 i34))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 i34))) true)))))) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 i34))) true) (not (= i34 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1301 (parent f i34)))) (position f i34) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1301 i34)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1301 i34)))) 0)))) (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 i34))) true) (forall ((j52 Int)) (=> (and (<= 1 j52) (<= j52 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 j52))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1301 i34))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1301 j52)))) true)) (= j52 i34))))))))))))))
(assert (= o78 (select temp___1301 j11)))
(assert (= o79 (us_split_fields1 o78)))
(assert (= o80 (rec__tree_model__path_type__a o79)))
(assert (not (<= 1 o86)))
(check-sat)
(exit)
