...
(define-fun dynamic_invariant2 ((temp___expr_164 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 2)) (in_range6 temp___expr_164)))
...
(assert true)
(define-fun dynamic_invariant8 ((temp___expr_170 Int) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (<= 1 150)) (in_range7 temp___expr_170)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_135 Tuple0)))
(define-fun dynamic_invariant9 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 1901 2099)) (in_range8 temp___expr_236)))
(define-fun dynamic_invariant10 ((temp___expr_242 Int) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool)) Bool (=> (or (= temp___is_init_239 true) (<= 1 12)) (in_range9 temp___expr_242)))
(define-fun dynamic_invariant11 ((temp___expr_248 Int) (temp___is_init_245 Bool) (temp___skip_constant_246 Bool) (temp___do_toplevel_247 Bool)) Bool (=> (or (= temp___is_init_245 true) (<= 1 31)) (in_range10 temp___expr_248)))
(define-fun dynamic_invariant12 ((temp___expr_272 Int) (temp___is_init_269 Bool) (temp___skip_constant_270 Bool) (temp___do_toplevel_271 Bool)) Bool (=> (or (= temp___is_init_269 true) (<= 0 86399999)) (in_range11 temp___expr_272)))
...
(assert (= o5 (greaterthanorequal o7 (mk___rep (mk___split_fields alarmtimeout__split_fields alarmtimeout__split_fields1 alarmtimeout__split_fields2 alarmtimeout__split_fields3)))))
(assert (= o (islocked state1)))
(assert (= o6 (ite (= currentdoor 0) o false)))
(assert (= result (ite (= o6 true) o5 false)))
(assert (=> (= result true) (= (mk_int__ref result1) localalarm5)))
(assert (=> (= result true) (= localalarm1 0)))
(assert (=> (= result true) (= (mk_int__ref result2) severity5)))
(assert (=> (= result true) (= severity1 2)))
(assert (=> (= result true) (= (mk_int__ref result3) id5)))
(assert (=> (= result true) (= id1 10)))
(assert (=> (not (= result true)) (= (mk_int__ref result4) localalarm5)))
(assert (=> (not (= result true)) (= localalarm2 1)))
(assert (=> (not (= result true)) (= (mk_int__ref result5) severity5)))
(assert (=> (not (= result true)) (= severity2 0)))
(assert (=> (not (= result true)) (= (mk_int__ref result6) id5)))
...
(assert (=> (not (= dooralarm localalarm1)) (= (valid_numberlogentries state3) true)))
(assert (=> (not (not (= dooralarm localalarm1))) (= filestate2 filestate)))
(assert (=> (not (not (= dooralarm localalarm1))) (= state3 state)))
(assert (=> (not (not (= dooralarm localalarm1))) (= filestate2 filestate1)))
(assert (=> (not (not (= dooralarm localalarm1))) (= state3 state2)))
(assert (= result7 dooralarm))
