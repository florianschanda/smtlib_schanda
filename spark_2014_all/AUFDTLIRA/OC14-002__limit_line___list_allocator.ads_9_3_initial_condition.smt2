...
(assert (= r8 1))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= temp___398 r8)))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= temp___397 (mk___rep1 (mk___split_fields1 model____split_fields model____split_fields1)))))
(assert (=> (and (<= 1 r8) (<= r8 3)) (and (= o27 (add model____split_fields r8)) (= (is_add model____split_fields r8 o27) true))))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= o28 (mk___split_fields1 o27 model____split_fields1))))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= temp___396 (mk___rep1 o28))))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= result7 model____split_fields9)))
(assert (=> (and (<= 1 r8) (<= r8 3)) (= model____split_fields3 (us_split_fields3 temp___396))))
...
(assert (=> (and (<= 1 r8) (<= r8 3)) (and (and (= (rec__list_allocator__m__t__allocated model____split_fields4) (rec__list_allocator__m__t__allocated (us_split_fields3 temp___397))) (=> (<= 1 3) (in_range3 r9))) (and (<= 1 r9) (<= r9 3)))))
