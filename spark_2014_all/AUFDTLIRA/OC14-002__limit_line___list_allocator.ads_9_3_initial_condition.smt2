...
(assert (=> (and (<= 1 r8) (<= r8 3)) (= temp___364 (mk___rep1 (mk___split_fields1 model____split_fields model____split_fields1)))))
...
(assert (=> (and (<= 1 r8) (<= r8 3)) (= model____split_fields3 (us_split_fields3 temp___363))))
...
(assert (=> (and (<= 1 r8) (<= r8 3)) (and (and (= (rec__list_allocator__m__t__allocated model____split_fields4) (rec__list_allocator__m__t__allocated (us_split_fields3 temp___364))) (=> (<= 1 3) (in_range3 r9))) (and (<= 1 r9) (<= r9 3)))))
