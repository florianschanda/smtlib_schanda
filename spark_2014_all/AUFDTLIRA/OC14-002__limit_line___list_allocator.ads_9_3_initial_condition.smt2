...
(assert (= r9 1))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= temp___365 r9)))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= temp___364 (mk___rep1 (mk___split_fields1 model____split_fields model____split_fields1)))))
(assert (=> (and (<= 1 r9) (<= r9 3)) (and (= o46 (add model____split_fields r9)) (= (is_add model____split_fields r9 o46) true))))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= o47 (mk___split_fields1 o46 model____split_fields1))))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= temp___363 (mk___rep1 o47))))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= result10 (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1)))))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= model____split_fields3 (us_split_fields3 temp___363))))
(assert (=> (and (<= 1 r9) (<= r9 3)) (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 r10)) (= (mem (rec__list_allocator__m__t__available model____split_fields4) rr3) true)))))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= (length (rec__list_allocator__m__t__allocated model____split_fields4)) 0)))
(assert (=> (and (<= 1 r9) (<= r9 3)) (and (and (= (rec__list_allocator__m__t__allocated model____split_fields4) (rec__list_allocator__m__t__allocated (us_split_fields3 temp___364))) (=> (<= 1 3) (in_range3 r10))) (and (<= 1 r10) (<= r10 3)))))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= r10 3)))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= r14 (mk_int__ref r10))))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= model____split_fields8 (mk___split_fields__ref1 model____split_fields4))))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= r15 r10)))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= model____split_fields9 model____split_fields4)))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= r16 r14)))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= model____split_fields10 model____split_fields8)))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= r17 r15)))
(assert (=> (and (<= 1 r9) (<= r9 3)) (= model____split_fields11 model____split_fields9)))
(assert (=> (not (and (<= 1 r9) (<= r9 3))) (= r16 (mk_int__ref r9))))
(assert (=> (not (and (<= 1 r9) (<= r9 3))) (= model____split_fields10 (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1)))))
(assert (=> (not (and (<= 1 r9) (<= r9 3))) (= r17 r9)))
(assert (=> (not (and (<= 1 r9) (<= r9 3))) (= model____split_fields11 model____split_fields2)))
(assert (and (= result13 (all_available (map__content data9))) (= (= result13 true) (forall ((r18 Int)) (=> (and (<= 1 r18) (<= r18 3)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select (map__content data9) r18)))) 0))))))
(assert (not (= (all_available (map__content data9)) true)))
(check-sat)
(exit)
