...
(declare-const temp___2961 Bool)
(declare-const temp___2952 Int)
(declare-const o15 Int)
(declare-const o16 character)
(declare-const o17 Int)
(declare-const o18 Bool)
(declare-const o19 Bool)
(declare-const temp___2953 Int)
...
(assert (= o31 (ite (<= (int__content string_search__brute_force__result18) o30) true false)))
(assert (= result15 (ite (<= 0 (int__content string_search__brute_force__result18)) o31 false)))
(assert (= result15 true))
(assert (< 0 (int__content string_search__brute_force__result18)))
(assert (not (in_range3 (int__content string_search__brute_force__result18))))
(check-sat)
(exit)
