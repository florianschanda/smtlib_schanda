...
(assert (= cur_state1 0))
(assert (and (= o (+ outstanding (to_rep2 cur_pump__split_fields2))) (in_range (+ outstanding (to_rep2 cur_pump__split_fields2)))))
(assert (= (mk_int__ref result2) (mk_int__ref outstanding)))
(assert (= outstanding1 o))
