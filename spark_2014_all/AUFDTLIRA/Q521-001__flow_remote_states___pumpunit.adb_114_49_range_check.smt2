...
(assert (= result1 true))
(assert (= (mk_int__ref result2) (mk_int__ref cur_state)))
(assert (= cur_state2 0))
(assert (and (= o3 (+ outstanding (to_rep2 cur_pump__split_fields2))) (in_range (+ outstanding (to_rep2 cur_pump__split_fields2)))))
(assert (= (mk_int__ref result3) (mk_int__ref outstanding)))
(assert (= outstanding2 o3))
(assert (not (in_range4 (- (to_rep2 cur_pump__split_fields1) 1))))
(check-sat)
(exit)
