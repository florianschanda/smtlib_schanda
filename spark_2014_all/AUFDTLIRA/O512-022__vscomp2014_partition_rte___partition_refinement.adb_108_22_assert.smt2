...
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (forall ((c us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c) true) (=> (and (not (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c))))))
(assert (forall ((c us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep (select a1 i))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c))))))
(assert (forall ((c us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep (select a1 j))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c))))))
