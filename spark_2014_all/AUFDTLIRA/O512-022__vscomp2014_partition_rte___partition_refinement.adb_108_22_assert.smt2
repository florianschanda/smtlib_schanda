...
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (forall ((c9 us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c9) true) (=> (and (not (= (key (mk___rep d__split_discrs d__split_fields2) c9) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs d__split_fields2) c9) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c9))) (key (mk___rep d__split_discrs d__split_fields2) c9))))))
(assert (forall ((c9 us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c9) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c9) (to_rep (select a1 i))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c9))) (key (mk___rep d__split_discrs d__split_fields2) c9))))))
(assert (forall ((c9 us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c9) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c9) (to_rep (select a1 j))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c9))) (key (mk___rep d__split_discrs d__split_fields2) c9))))))
(declare-const c9 us_rep1)
(assert (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c9) true))
(assert (not (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c9))) (key (mk___rep d__split_discrs d__split_fields2) c9))))
(check-sat)
(exit)
