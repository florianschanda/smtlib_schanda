...
(assert (or (and (and (and (= search_trees__values__result6 (mk_value_set__ref search_trees__values__result2)) (and (= j9 (mk_int__ref j)) (= s9 (mk_value_set__ref s)))) (and (= search_trees__values__result7 search_trees__values__result2) (and (= j10 j1) (= s10 s1)))) (and (= (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) 0) (and (= (mk_value_set__ref result) (mk_value_set__ref search_trees__values__result)) (= search_trees__values__result2 s)))) (and (and (not (= (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) 0)) (and (= search_trees__values__result2 search_trees__values__result) (= search_trees__values__result2 search_trees__values__result1))) (and (and (and (= search_trees__values__result6 search_trees__values__result4) (and (= j9 j7) (= s9 s7))) (and (= search_trees__values__result7 search_trees__values__result5) (and (= j10 j8) (= s10 s8)))) (and (and (and (= (mk_int__ref result1) (mk_int__ref j)) (= j2 1)) (ite (and (<= 1 j2) (<= j2 100)) (and (and (and (= temp___629 s) (and (= temp___628 j2) (and (and (and (and (and (and (and (and (= o1 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range2 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))) (and (= temp___625 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (and (dynamic_invariant5 temp___625 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___625 o1))) true) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___625 o1)))) 0) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (not (= i4 o1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___625 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___625 i4))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___625 i4))) true)))))) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___625 i4))) true) (not (= i4 o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___625 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4) (rec__tree_model__path_type__a (us_split_fields1 (select temp___625 i4)))) true) (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___625 i4)))) 0)))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___625 i4))) true) (forall ((j13 Int)) (=> (and (<= 1 j13) (<= j13 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___625 j13))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___625 i4))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___625 j13)))) true)) (= j13 i4)))))))))))))) (= (mk___rep (mk___split_fields o2 o3)) (select temp___625 j2))) (and (= o2 o4) (= o3 o5))) (= result3 o5)) (ite (= result3 true) (and (and (= o (contains s (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2)))) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains s e) true)) (= e (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2))))) (= o true)))) (= result2 (ite (not (= o true)) true false))) (= result2 false))) (ite (= result2 true) (and (and (and (= o6 (add s (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2)))) (and (and (and (= (length o6) (+ (length s) 1)) (= (contains o6 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2))) true)) (= (ole s o6) true)) (= (included_except o6 s (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2))) true))) (= o7 o6)) (and (= (mk_value_set__ref result4) (mk_value_set__ref s)) (= s2 o7))) (and (= s2 s) (= s2 s1)))) (and (and (<= (length s3) j3) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 j3)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i4))) true) (= (contains s3 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i4))) true)))) (forall ((v2 Int)) (=> (and (<= 0 v2) (<= v2 2147483647)) (=> (= (contains s3 v2) true) (exists ((i4 Int)) (and (and (<= 1 i4) (<= i4 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i4))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i4)) v2))))))))) (and (and (=> (<= 1 100) (in_range2 j3)) (and (<= 1 j3) (<= j3 100))) (= j3 100)))))) (and (and (= j3 j5) (= s3 s5)) (and (= j6 j3) (= s6 s3)))) (and (and (= j7 (mk_int__ref j5)) (= s7 (mk_value_set__ref s5))) (and (= j8 j6) (= s8 s6)))) (and (and (= j7 (mk_int__ref j2)) (= s7 (mk_value_set__ref s))) (and (= j8 j2) (= s8 s1))))) (and (and (= search_trees__values__result4 (mk_value_set__ref search_trees__values__result3)) (= search_trees__values__result5 search_trees__values__result3)) (and (= result11 (mk_value_set__ref search_trees__values__result2)) (= search_trees__values__result3 (value_set__content s7)))))))))
...
(assert (= j12 j10))
(assert (= s12 s10))
(assert (and (= o23 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range3 o23)))
(assert (= result12 (ite (= o23 0) true false)))
(assert (not (= result12 true)))
(assert (<= 1 i3))
(assert (<= i3 100))
(assert (and (= o25 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range2 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o25) true)))
(check-sat)
(exit)
