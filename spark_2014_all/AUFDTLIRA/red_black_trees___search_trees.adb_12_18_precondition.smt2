...
(define-fun dynamic_invariant ((temp___expr_268 Int) (temp___is_init_264 Bool) (temp___skip_constant_265 Bool) (temp___do_toplevel_266 Bool) (temp___do_typ_inv_267 Bool)) Bool (=> (or (= temp___is_init_264 true) (<= 0 2147483647)) (in_range4 temp___expr_268)))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(assert (forall ((container us_rep2)) (! (dynamic_invariant1 (length container) true false true true) :pattern ((length container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_315 us_rep4) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (=> (= temp___do_typ_inv_314 true) (= (tree_structure temp___expr_315) true)))
...
(assert (forall ((f us_rep4)) (! (=> (dynamic_invariant3 f true true true true) (dynamic_invariant2 (size f) true false true true)) :pattern ((size f)))))
(declare-fun model__ (us_rep4 Int) (Array Int us_rep1))
(declare-fun model____function_guard ((Array Int us_rep1) us_rep4 Int) Bool)
(define-fun dynamic_invariant4 ((temp___expr_175 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 100)) (in_range2 temp___expr_175)))
...
(assert (forall ((temp___433 Int)) (=> (dynamic_invariant7 temp___433 true true true true) (forall ((temp___434 Int)) (= (to_rep (select (temp___431 temp___433) temp___434)) temp___433)))))
...
(assert true)
(assert (forall ((f us_rep4)) (forall ((root Int)) (forall ((values (Array Int natural))) (! (= (= (ordered_leafs f root values) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___526 (model__ f root))) (select temp___526 i)))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___527 (model__ f root))) (select temp___527 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___528 (model__ f root))) (select temp___528 i)))) (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___529 (model__ f root))) (select temp___529 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___524 (model__ f root))) (select temp___524 j)))) (+ (length1 (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___525 (model__ f root))) (select temp___525 i))))) 1)) 0) (< (to_rep (select values j)) (to_rep (select values i))) (< (to_rep (select values i)) (to_rep (select values j)))))))))) :pattern ((ordered_leafs f root values)))))))
...
(define-fun dynamic_invariant10 ((temp___expr_239 us_rep1) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (= temp___do_toplevel_237 true) (=> (= temp___is_init_235 true) (< (length1 (rec__tree_model__path_type__a (us_split_fields1 temp___expr_239))) 100))))
(define-fun default_initial_assumption5 ((temp___expr_241 us_rep1) (temp___skip_top_level_242 Bool)) Bool (and (= (length1 (rec__tree_model__path_type__a (us_split_fields1 temp___expr_241))) 0) (= (rec__tree_model__path_type__k (us_split_fields1 temp___expr_241)) (distinct 0 0))))
(define-fun dynamic_predicate ((temp___245 us_rep1)) Bool (< (length1 (rec__tree_model__path_type__a (us_split_fields1 temp___245))) 100))
(assert (forall ((a us_rep) (b us_rep)) (! (= (user_eq3 a b) (oeq a b)) :pattern ((user_eq3 a b)))))
(define-fun default_initial_assumption6 ((temp___expr_232 us_rep) (temp___skip_top_level_233 Bool)) Bool (=> (not (= temp___skip_top_level_233 true)) (= (length1 temp___expr_232) 0)))
(assert true)
...
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant3 f true true true true) (dynamic_invariant4 i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant3 f true true true true) (dynamic_invariant4 i true true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant2 result true false true true)))) :pattern ((parent f i))))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant3 f true true true true) (dynamic_invariant4 i true true true true)) (not (= (parent f i) 0))) (dynamic_invariant9 (position f i) true false true true)) :pattern ((position f i))))))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant1 result true false true true))) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant11 position1 true true true true) (and (<= 1 position1) (<= position1 (last container)))) (dynamic_invariant12 (get container position1) true false true true)) :pattern ((get container position1))))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range4 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
(declare-const s us_rep2)
(declare-const j Int)
(declare-const search_trees__values__result us_rep2)
(declare-const temp___673 us_rep2)
(declare-const temp___672 Int)
(declare-const o Bool)
(declare-const o1 Int)
(declare-const temp___669 (Array Int us_rep1))
...
(declare-const s6 value_set__ref)
(declare-const j6 int__ref)
(declare-const s7 us_rep2)
(declare-const j7 Int)
(declare-const result5 value_set__ref)
...
(assert (or (and (and (and (= search_trees__values__result6 (mk_value_set__ref search_trees__values__result2)) (and (= j8 j12) (= s8 s12))) (and (= search_trees__values__result7 search_trees__values__result2) (and (= j9 j1) (= s9 s1)))) (and (= (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) 0) (and (= (mk_value_set__ref result) (mk_value_set__ref search_trees__values__result)) (= search_trees__values__result2 s)))) (and (and (not (= (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) 0)) (and (= search_trees__values__result2 search_trees__values__result) (= search_trees__values__result2 search_trees__values__result1))) (and (and (and (= search_trees__values__result6 search_trees__values__result4) (and (= j8 j6) (= s8 s6))) (and (= search_trees__values__result7 search_trees__values__result5) (and (= j9 j7) (= s9 s7)))) (and (and (and (= (mk_int__ref result1) j12) (= j2 1)) (ite (and (<= 1 j2) (<= j2 100)) (and (and (and (= temp___673 s) (and (= temp___672 j2) (and (and (and (and (and (and (and (and (= o1 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range2 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))) (and (= temp___669 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (and (dynamic_invariant5 temp___669 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 o1))) true) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 o1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i1))) true) (not (= i1 o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 i1)))) true) (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i1))) true) (forall ((j13 Int)) (=> (and (<= 1 j13) (<= j13 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 j13))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 j13)))) true)) (= j13 i1)))))))))))))) (= (mk___rep (mk___split_fields o2 o3)) (select temp___669 j2))) (and (= o2 o4) (= o3 o5))) (= result3 o5)) (ite (= result3 true) (and (and (= o (contains s (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2)))) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains s e) true)) (= e (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2))))) (= o true)))) (= result2 (ite (not (= o true)) true false))) (= result2 false))) (ite (= result2 true) (and (and (and (= o6 (add s (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2)))) (and (and (and (= (length o6) (+ (length s) 1)) (= (contains o6 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2))) true)) (= (ole s o6) true)) (= (included_except o6 s (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2))) true))) (= o7 o6)) (and (= (mk_value_set__ref result4) s12) (= s2 o7))) (and (= s2 s) (= s2 s1)))) (and (and (<= (length s3) j3) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 j3)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true) (= (contains s3 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1))) true)))) (forall ((v Int)) (=> (and (<= 0 v) (<= v 2147483647)) (=> (= (contains s3 v) true) (exists ((i1 Int)) (and (and (<= 1 i1) (<= i1 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1)) v))))))))) (and (and (=> (<= 1 100) (in_range2 j3)) (and (<= 1 j3) (<= j3 100))) (= j3 100)))))) (and (and (= j3 j4) (= s3 s4)) (and (= j5 j3) (= s5 s3)))) (and (and (= j6 (mk_int__ref j4)) (= s6 (mk_value_set__ref s4))) (and (= j7 j5) (= s7 s5)))) (and (and (= j6 (mk_int__ref j2)) (= s6 s12)) (and (= j7 j2) (= s7 s1))))) (and (and (= search_trees__values__result4 (mk_value_set__ref search_trees__values__result3)) (= search_trees__values__result5 search_trees__values__result3)) (and (= result5 (mk_value_set__ref search_trees__values__result2)) (= search_trees__values__result3 (value_set__content s6)))))))))
(assert (= search_trees__values__result8 search_trees__values__result6))
(assert (= j10 j8))
(assert (= s10 s8))
(assert (= search_trees__values__result9 search_trees__values__result7))
(assert (= j11 j9))
(assert (= s11 s9))
(assert (and (= o8 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range3 o8)))
(assert (= result6 (ite (= o8 0) true false)))
(assert (not (= result6 true)))
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= o9 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range2 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o9) true)))
(check-sat)
(exit)
