...
(declare-fun temp___1068 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___1070 (Array Int (Array Int et1)))) (forall ((temp___1071 Int) (temp___1073 Int)) (forall ((temp___1072 (Array Int et1)) (temp___1074 (Array Int et1))) (let ((temp___1069 (temp___1068 temp___1070 temp___1071 temp___1072 temp___1073 temp___1074))) (forall ((temp___1075 Int)) (ite (= temp___1075 temp___1073) (= (select temp___1069 temp___1075) temp___1074) (ite (= temp___1075 temp___1071) (= (select temp___1069 temp___1075) temp___1072) (= (select temp___1069 temp___1075) (select temp___1070 temp___1075))))))))))
(declare-fun temp___1076 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1078 (Array Int et1))) (forall ((temp___1079 Int) (temp___1080 Int)) (let ((temp___1077 (temp___1076 temp___1078 temp___1079 temp___1080))) (forall ((temp___1081 Int)) (ite (= temp___1081 temp___1079) (= (select temp___1077 temp___1081) (of_rep temp___1080)) (= (select temp___1077 temp___1081) (select temp___1078 temp___1081))))))))
(declare-fun temp___1083 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1085 (Array Int et1))) (forall ((temp___1086 Int) (temp___1087 Int)) (let ((temp___1084 (temp___1083 temp___1085 temp___1086 temp___1087))) (forall ((temp___1088 Int)) (ite (= temp___1088 temp___1086) (= (select temp___1084 temp___1088) (of_rep temp___1087)) (= (select temp___1084 temp___1088) (select temp___1085 temp___1088))))))))
(declare-fun temp___1091 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___1093 (Array Int (Array Int et1)))) (forall ((temp___1094 Int) (temp___1096 Int)) (forall ((temp___1095 (Array Int et1)) (temp___1097 (Array Int et1))) (let ((temp___1092 (temp___1091 temp___1093 temp___1094 temp___1095 temp___1096 temp___1097))) (forall ((temp___1098 Int)) (ite (= temp___1098 temp___1096) (= (select temp___1092 temp___1098) temp___1097) (ite (= temp___1098 temp___1094) (= (select temp___1092 temp___1098) temp___1095) (= (select temp___1092 temp___1098) (select temp___1093 temp___1098))))))))))
(declare-fun temp___1099 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1101 (Array Int et1))) (forall ((temp___1102 Int) (temp___1103 Int)) (let ((temp___1100 (temp___1099 temp___1101 temp___1102 temp___1103))) (forall ((temp___1104 Int)) (ite (= temp___1104 temp___1102) (= (select temp___1100 temp___1104) (of_rep temp___1103)) (= (select temp___1100 temp___1104) (select temp___1101 temp___1104))))))))
(declare-fun temp___1106 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1108 (Array Int et1))) (forall ((temp___1109 Int) (temp___1110 Int)) (let ((temp___1107 (temp___1106 temp___1108 temp___1109 temp___1110))) (forall ((temp___1111 Int)) (ite (= temp___1111 temp___1109) (= (select temp___1107 temp___1111) (of_rep temp___1110)) (= (select temp___1107 temp___1111) (select temp___1108 temp___1111))))))))
(declare-fun temp___1114 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___1116 (Array Int (Array Int et1)))) (forall ((temp___1117 Int) (temp___1119 Int)) (forall ((temp___1118 (Array Int et1)) (temp___1120 (Array Int et1))) (let ((temp___1115 (temp___1114 temp___1116 temp___1117 temp___1118 temp___1119 temp___1120))) (forall ((temp___1121 Int)) (ite (= temp___1121 temp___1119) (= (select temp___1115 temp___1121) temp___1120) (ite (= temp___1121 temp___1117) (= (select temp___1115 temp___1121) temp___1118) (= (select temp___1115 temp___1121) (select temp___1116 temp___1121))))))))))
(declare-fun temp___1122 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1124 (Array Int et1))) (forall ((temp___1125 Int) (temp___1126 Int)) (let ((temp___1123 (temp___1122 temp___1124 temp___1125 temp___1126))) (forall ((temp___1127 Int)) (ite (= temp___1127 temp___1125) (= (select temp___1123 temp___1127) (of_rep temp___1126)) (= (select temp___1123 temp___1127) (select temp___1124 temp___1127))))))))
(declare-fun temp___1129 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1131 (Array Int et1))) (forall ((temp___1132 Int) (temp___1133 Int)) (let ((temp___1130 (temp___1129 temp___1131 temp___1132 temp___1133))) (forall ((temp___1134 Int)) (ite (= temp___1134 temp___1132) (= (select temp___1130 temp___1134) (of_rep temp___1133)) (= (select temp___1130 temp___1134) (select temp___1131 temp___1134))))))))
(declare-fun temp___1137 ((Array Int (Array Int et1)) Int (Array Int et1) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___1139 (Array Int (Array Int et1)))) (forall ((temp___1140 Int) (temp___1142 Int)) (forall ((temp___1141 (Array Int et1)) (temp___1143 (Array Int et1))) (let ((temp___1138 (temp___1137 temp___1139 temp___1140 temp___1141 temp___1142 temp___1143))) (forall ((temp___1144 Int)) (ite (= temp___1144 temp___1142) (= (select temp___1138 temp___1144) temp___1143) (ite (= temp___1144 temp___1140) (= (select temp___1138 temp___1144) temp___1141) (= (select temp___1138 temp___1144) (select temp___1139 temp___1144))))))))))
(declare-fun temp___1145 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1147 (Array Int et1))) (forall ((temp___1148 Int) (temp___1149 Int)) (let ((temp___1146 (temp___1145 temp___1147 temp___1148 temp___1149))) (forall ((temp___1150 Int)) (ite (= temp___1150 temp___1148) (= (select temp___1146 temp___1150) (of_rep temp___1149)) (= (select temp___1146 temp___1150) (select temp___1147 temp___1150))))))))
(declare-fun temp___1152 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___1154 (Array Int et1))) (forall ((temp___1155 Int) (temp___1156 Int)) (let ((temp___1153 (temp___1152 temp___1154 temp___1155 temp___1156))) (forall ((temp___1157 Int)) (ite (= temp___1157 temp___1155) (= (select temp___1153 temp___1157) (of_rep temp___1156)) (= (select temp___1153 temp___1157) (select temp___1154 temp___1157))))))))
(declare-fun temp___4717 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___4719 (Array Int (Array Int et1)))) (forall ((temp___4720 Int)) (forall ((temp___4721 (Array Int et1))) (let ((temp___4718 (temp___4717 temp___4719 temp___4720 temp___4721))) (forall ((temp___4722 Int)) (ite (= temp___4722 temp___4720) (= (select temp___4718 temp___4722) temp___4721) (= (select temp___4718 temp___4722) (select temp___4719 temp___4722)))))))))
(declare-fun temp___4723 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___4725 (Array Int et1))) (forall ((temp___4726 Int) (temp___4727 Int)) (let ((temp___4724 (temp___4723 temp___4725 temp___4726 temp___4727))) (forall ((temp___4728 Int)) (ite (= temp___4728 temp___4726) (= (select temp___4724 temp___4728) (of_rep temp___4727)) (= (select temp___4724 temp___4728) (select temp___4725 temp___4728))))))))
...
(declare-const temp___4745 (Array Int (Array Int et1)))
...
(assert (in_range2 j))
(assert (in_range3 e))
(assert (and (and (=> (<= 5 50) (in_range2 j_next)) (and (=> (<= 0 99) (in_range3 f)) (and (and (and (= (bool_eq1 a1 5 50 (temp___4717 t1 j (temp___4723 (select t1 j) i e)) 5 50) true) (or (and (= j 50) (= j_next1 5)) (and (< j 50) (= j_next1 (+ j 1))))) (in_range2 j_next1)) (and (=> (<= 5 50) (in_range2 j_next1)) (and (ite (= e 0) (and (= (mk_int__ref result4) (mk_int__ref f)) (= f1 99)) (and (and (and (= o4 (- e 1)) (in_range3 (- e 1))) (and (= (mk_int__ref result5) (mk_int__ref f)) (= f2 o4))) (= f1 f2))) (and (and (and (= (to_rep o5) f1) (= o6 (store (select a1 j_next1) i o5))) (= o7 (store a1 j_next1 o6))) (and (= a1 result6) (= a2 o7)))))))) (and (and (= t1 t2) (and (= f1 f3) (and (= j_next1 j_next3) (= a2 a3)))) (and (= t3 t1) (and (= f4 f1) (and (= j_next4 j_next1) (= a4 a2)))))))
(assert (not (or (and (< j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp___1068 a j (temp___1076 (select a j) i e) (+ j 1) (temp___1083 (select a (+ j 1)) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp___1091 a j (temp___1099 (select a j) i e) (+ j 1) (temp___1106 (select a (+ j 1)) i 99)) 5 50) true)))) (and (= j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp___1114 a j (temp___1122 (select a j) i e) 5 (temp___1129 (select a 5) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp___1137 a j (temp___1145 (select a j) i e) 5 (temp___1152 (select a 5) i 99)) 5 50) true)))))))
(check-sat)
(exit)
