...
(assert (= a4 a2))
(assert (not (or (and (< j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp___1127 a j (temp___1135 (select a j) i e) (+ j 1) (temp___1142 (select a (+ j 1)) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp___1150 a j (temp___1158 (select a j) i e) (+ j 1) (temp___1165 (select a (+ j 1)) i 99)) 5 50) true)))) (and (= j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp___1173 a j (temp___1181 (select a j) i e) 5 (temp___1188 (select a 5) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp___1196 a j (temp___1204 (select a j) i e) 5 (temp___1211 (select a 5) i 99)) 5 50) true)))))))
(check-sat)
(exit)
