...
(assert (and (<= 0 topstacki2) (<= topstacki2 99)))
(assert (= o13 topstacki2))
(assert (= o14 (select s__split_fields5 o13)))
(assert (= o15 (to_rep o14)))
(assert (= result6 (ite (<= 0 o15) true false)))
...
(assert (=> (= result6 true) (= result5 (ite (< o12 (to_rep s__split_fields2)) true false))))
