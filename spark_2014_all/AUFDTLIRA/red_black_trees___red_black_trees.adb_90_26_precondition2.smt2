...
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0) (= o18 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) i)) 0)) (= o18 0)))
(assert (= o19 (+ o18 o17)))
(assert (and (= o20 o19) (in_range7 o19)))
(assert (= o21 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i)))) o20) true false)))
