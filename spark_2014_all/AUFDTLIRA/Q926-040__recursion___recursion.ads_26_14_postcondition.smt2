...
(define-fun count10 () int__ref (mk_int__ref count6))
...
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= temp___186 count1)))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= temp___185 index1)))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (< count2 (+ (- index2 (to_rep (first (rt arr)))) 1))))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (and (and (=> (<= (to_rep (first (rt arr))) (to_rep (last (rt arr)))) (dynamic_property1 (to_rep (first (rt arr))) (to_rep (last (rt arr))) index2)) (=> (<= 0 2147483647) (in_range2 count2))) (and (<= (to_rep (first (rt arr))) index2) (<= index2 (to_rep (last (rt arr))))))))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (=> (= (select (elts arr) index2) true) (and (= o (+ count2 1)) (in_range1 (+ count2 1))))))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (=> (= (select (elts arr) index2) true) (= count2 result2))))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (=> (= (select (elts arr) index2) true) (= count3 o))))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (=> (not (= (select (elts arr) index2) true)) (= count3 count2))))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= index2 (to_rep (last (rt arr))))))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= index2 index3)))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= count3 count4)))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= index4 index2)))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= count5 count3)))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= index9 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= count10 (mk_int__ref count4))))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= index6 index4)))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= count7 count5)))
(assert (=> (not (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr)))))) (= index1 index5)))
(assert (=> (not (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr)))))) (= count1 count6)))
(assert (=> (not (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr)))))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr)))))) (= count7 count1)))
(assert (= recursion__count_true_loop__result1 recursion__count_true_loop__result2))
(assert (= recursion__count_true_loop__result3 recursion__count_true_loop__result1))
(assert (= (mk_int__ref result3) (mk_int__ref recursion__count_true_loop__result)))
(assert (= recursion__count_true_loop__result1 count6))
(assert (= (mk_int__ref recursion__count_true_loop__result4) (mk_int__ref recursion__count_true_loop__result2)))
(assert (= (mk_int__ref index7) index9))
(assert (= (mk_int__ref count8) count10))
(assert (= recursion__count_true_loop__result5 recursion__count_true_loop__result3))
(assert (= index8 index6))
(assert (= count9 count7))
(assert (= result4 recursion__count_true_loop__result4))
(assert (not (<= recursion__count_true_loop__result4 (length arr))))
(check-sat)
(exit)
