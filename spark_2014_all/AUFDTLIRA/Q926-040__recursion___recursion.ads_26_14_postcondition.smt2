...
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (and (and (= temp___161 count1) (and (= temp___160 index1) (and (< count2 (+ (- index2 (to_rep (first (rt arr)))) 1)) (and (and (and (=> (<= (to_rep (first (rt arr))) (to_rep (last (rt arr)))) (dynamic_property1 (to_rep (first (rt arr))) (to_rep (last (rt arr))) index2)) (=> (<= 0 2147483647) (in_range2 count2))) (and (<= (to_rep (first (rt arr))) index2) (<= index2 (to_rep (last (rt arr)))))) (and (ite (= (select (elts arr) index2) true) (and (and (= o3 (+ count2 1)) (in_range1 (+ count2 1))) (and (= count2 result2) (= count3 o3))) (= count3 count2)) (= index2 (to_rep (last (rt arr))))))))) (and (and (= index2 index6) (= count3 count6)) (and (= index7 index2) (= count7 count3))))))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= (mk_int__ref index8) (mk_int__ref index6))))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= (mk_int__ref count8) (mk_int__ref count6))))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= index9 index7)))
(assert (=> (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr))))) (= count9 count7)))
(assert (=> (not (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr)))))) (= index1 index8)))
(assert (=> (not (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr)))))) (= count1 count8)))
(assert (=> (not (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr)))))) (= index9 index1)))
(assert (=> (not (and (<= (to_rep (first (rt arr))) index1) (<= index1 (to_rep (last (rt arr)))))) (= count9 count1)))
...
(assert (= (mk_int__ref result4) (mk_int__ref recursion__count_true_loop__result)))
(assert (= recursion__count_true_loop__result1 count8))
