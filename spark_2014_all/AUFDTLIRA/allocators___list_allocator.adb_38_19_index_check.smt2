...
(assert (= result8 true))
(assert (and (= o11 (length model____split_fields)) (and (in_range6 o11) (<= (+ 0 o11) 2147483647))))
(assert (= result9 (ite (< j o11) true false)))
(assert (=> (= result9 true) (and (= o12 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (= result9 true) (and (= o13 (get model____split_fields o12)) (in_range7 o13))))
(assert (=> (not (= result9 true)) (= o13 0)))
(assert (and (= temp___276 (get model____split_fields j)) (in_range7 temp___276)))
(assert (not (<= 1 temp___276)))
(check-sat)
(exit)
