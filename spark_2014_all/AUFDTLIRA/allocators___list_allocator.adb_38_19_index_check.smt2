...
(assert (and (= o14 (length model____split_fields)) (and (in_range2 o14) (<= (+ 0 o14) 2147483647))))
(assert (= result3 (ite (<= o14 10000) true false)))
(assert (=> (= result3 true) (and (= o13 (length1 model____split_fields1)) (in_range2 o13))))
(assert (=> (= result3 true) (= result2 (ite (<= o13 10000) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o9 (length1 model____split_fields1)) (in_range2 o9))))
(assert (=> (= result2 true) (and (= o10 (length model____split_fields)) (and (in_range2 o10) (<= (+ 0 o10) 2147483647)))))
(assert (=> (= result2 true) (= o11 (+ o10 o9))))
(assert (=> (= result2 true) (and (= o12 o11) (in_range7 o11))))
(assert (=> (= result2 true) (= result1 (ite (= o12 10000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o7 (length model____split_fields)) (and (in_range2 o7) (<= (+ 0 o7) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result4 (ite (< 0 o7) true false)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result4 true) (and (= o6 (get model____split_fields 1)) (in_range3 o6))))))
...
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (and (= o8 (length model____split_fields)) (and (in_range2 o8) (<= (+ 0 o8) 2147483647))))))
...
(assert (= result5 true))
(assert (and (= o5 (get model____split_fields j)) (in_range3 o5)))
(assert (= result6 (ite (in_range8 o5) true false)))
(assert (= result6 true))
(assert (and (= o2 (length model____split_fields)) (and (in_range2 o2) (<= (+ 0 o2) 2147483647))))
(assert (= result7 (ite (< j o2) true false)))
(assert (=> (= result7 true) (and (= o3 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (= result7 true) (and (= o4 (get model____split_fields o3)) (in_range3 o4))))
(assert (=> (not (= result7 true)) (= o4 0)))
(assert (and (= temp___313 (get model____split_fields j)) (in_range3 temp___313)))
(assert (not (<= temp___313 10000)))
(check-sat)
(exit)
