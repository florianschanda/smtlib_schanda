...
(assert (and (= o28 (remove (mk___t interm1 (mk 1 100)) o24)) (and (dynamic_invariant4 o28 true false true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last o26)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o24 1))) (= (to_rep (select interm1 k)) (to_rep (select o25 k))))) (and (forall ((k Int)) (=> (and (<= (+ o24 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select o25 (- k 1)))))) (forall ((k Int)) (=> (and (<= o24 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select o25 k))))))))))))
(assert (and (= temp___2462 (remove o28 o27)) (and (dynamic_invariant4 temp___2462 true false true) (and (= (invariant__ temp___2462) true) (and (= (to_rep1 (last temp___2461)) (- (to_rep1 (last o26)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select o25 k)) (to_rep (select temp___246 k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last o26)))) (= (to_rep (select o25 k)) (to_rep (select temp___246 (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last o26)) 1))) (= (to_rep (select o25 (+ k 1))) (to_rep (select temp___246 k))))))))))))
