...
(assert (<= (to_rep (first (rt b))) (to_rep (last (rt b)))))
(assert (and (= o (- (to_rep (last (rt b))) (to_rep (first (rt b))))) (in_range (- (to_rep (last (rt b))) (to_rep (first (rt b)))))))
(assert (= o1 (+ (to_rep (last (rt a))) o)))
