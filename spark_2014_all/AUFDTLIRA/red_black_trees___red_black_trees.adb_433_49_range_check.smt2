...
(assert (and (= o124 (int__content x5)) (in_range2 (int__content x5))))
(assert (and (= o125 (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields12)) o124)) (and (in_range3 o125) (and (= o125 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields12)))) o124)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields12))) 0) (= o125 0))))))
(assert (not (in_range2 o125)))
(check-sat)
(exit)
