...
(assert (or (and (and (= perm__perm_reflexive__induction_hypothesis__result2 perm__perm_reflexive__induction_hypothesis__result6) (= perm__perm_reflexive__induction_hypothesis__result7 perm__perm_reflexive__induction_hypothesis__result2)) (and (= (length a) 0) (and (= (mk_int__ref result) (mk_int__ref perm__perm_reflexive__induction_hypothesis__result)) (= perm__perm_reflexive__induction_hypothesis__result2 1)))) (and (and (not (= (length a) 0)) (and (= perm__perm_reflexive__induction_hypothesis__result2 perm__perm_reflexive__induction_hypothesis__result) (= perm__perm_reflexive__induction_hypothesis__result2 perm__perm_reflexive__induction_hypothesis__result1))) (and (and (= (mk_int__ref perm__perm_reflexive__induction_hypothesis__result6) (mk_int__ref perm__perm_reflexive__induction_hypothesis__result4)) (= perm__perm_reflexive__induction_hypothesis__result7 perm__perm_reflexive__induction_hypothesis__result5)) (and (and (= perm__perm_reflexive__induction_hypothesis__result3 perm__perm_reflexive__induction_hypothesis__result4) (= perm__perm_reflexive__induction_hypothesis__result5 perm__perm_reflexive__induction_hypothesis__result3)) (and (and (and (and (and (= o3 (to_rep1 (first (rt b)))) (in_range2 (to_rep1 (first (rt b))))) (and (= (mk___t o4 o5) (remove b o3)) (and (dynamic_invariant1 (mk___t o4 o5) true false true) (and (= (invariant__ (mk___t o4 o5)) true) (and (= (to_rep1 (last o5)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o3 1))) (= (to_rep (select (elts b) k)) (to_rep (select o4 k))))) (and (forall ((k Int)) (=> (and (<= (+ o3 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o4 (- k 1)))))) (forall ((k Int)) (=> (and (<= o3 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o4 k)))))))))))) (and (and (and (= o (to_rep1 (first (rt a)))) (in_range2 (to_rep1 (first (rt a))))) (and (= (mk___t o1 o2) (remove a o)) (and (dynamic_invariant1 (mk___t o1 o2) true false true) (and (= (invariant__ (mk___t o1 o2)) true) (and (= (to_rep1 (last o2)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o 1))) (= (to_rep (select (elts a) k)) (to_rep (select o1 k))))) (and (forall ((k Int)) (=> (and (<= (+ o 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o1 (- k 1)))))) (forall ((k Int)) (=> (and (<= o k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o1 k)))))))))))) (and (= perm__perm_reflexive__induction_hypothesis__B_3__ih__assume (induction_hypothesis (mk___t o1 o2) (mk___t o4 o5))) (and (in_range1 perm__perm_reflexive__induction_hypothesis__B_3__ih__assume) (=> (= (of_int perm__perm_reflexive__induction_hypothesis__B_3__ih__assume) true) (= (is_perm (mk___t o1 o2) (mk___t o4 o5)) true)))))) (= perm__perm_reflexive__induction_hypothesis__B_3__ih__assume ih)) (and (in_range1 ih) (and (= (of_int ih) true) (and (= perm__perm_reflexive__induction_hypothesis__result2 result1) (= perm__perm_reflexive__induction_hypothesis__result3 ih))))))))))
(assert (= (mk_int__ref perm__perm_reflexive__induction_hypothesis__result8) (mk_int__ref perm__perm_reflexive__induction_hypothesis__result6)))
...
(assert (= (of_int perm__perm_reflexive__induction_hypothesis__result8) true))
