...
(declare-const dummy small_index_t)
...
(declare-fun random_array__function_guard ((Array Int unsigned_byte) Int) Bool)
...
(declare-fun temp___357 (Int) (Array Int unsigned_byte))
(define-fun dynamic_invariant1 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 0 255)) (in_range1 temp___expr_167)))
(define-fun dynamic_invariant2 ((temp___expr_244 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool) (temp___do_typ_inv_243 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 1 1000)) (in_range temp___expr_244)))
(assert (forall ((temp___359 Int)) (=> (dynamic_invariant1 temp___359 true true true true) (forall ((temp___360 Int)) (= (to_rep (select (temp___357 temp___359) temp___360)) temp___359)))))
...
(assert (= result a))
(assert (= a1 (temp___357 0)))
(assert (not (= (bool_eq a1 1 1000 (random_array 5) 1 1000) true)))
(check-sat)
(exit)
