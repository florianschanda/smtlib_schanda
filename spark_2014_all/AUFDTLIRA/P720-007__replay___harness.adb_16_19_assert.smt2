...
(assert (and (and (= (to_rep1 r__split_fields17) (- (to_rep1 r__split_fields14) 1)) (= (head (mk___rep (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14))) h2)) (in_range h2)))
(assert (not (= h2 y)))
(check-sat)
(exit)
