...
(assert (not (= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a26) i11)))) (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a i11)))))))
(check-sat)
(exit)
