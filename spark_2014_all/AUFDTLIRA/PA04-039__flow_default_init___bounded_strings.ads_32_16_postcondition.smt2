...
(assert (= (ite (<= (to_rep3 (first2 temp___2051)) (to_rep3 (last2 temp___2051))) (+ (- (to_rep3 (last2 temp___2051)) (to_rep3 (first2 temp___2051))) 1) 0) (ite (<= (to_rep3 (first target__split_fields1)) (to_rep3 (last target__split_fields1))) (+ (- (to_rep3 (last target__split_fields1)) (to_rep3 (first target__split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___207 temp___2071) (mk___t1 temp___205 temp___2051)))
(assert (= temp___207 o))
(assert (= (mk (to_rep3 (first2 temp___2071)) (to_rep3 (last2 temp___2071))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (= target__split_fields3 (mk___split_fields (mk___t temp___2091 temp___2092) temp___2093)))
(assert (= target__split_discrs (mk___split_discrs temp___209)))
(assert (= (to_rep1 o5) 0))
(assert (= (rec__bounded_strings__bounded_string__text target__split_fields3) (mk___t o6 o7)))
(assert (= o5 o8))
...
(assert (= target__split_fields4 (mk___split_fields (mk___t temp___2111 temp___2112) temp___2113)))
(assert (= target__split_discrs (mk___split_discrs temp___211)))
(assert (= target__split_fields5 (mk___split_fields__ref target__split_fields4)))
(assert (= target__split_fields6 target__split_fields4))
(assert (not (= (length1 (mk___rep target__split_discrs (us_split_fields__content target__split_fields5))) 0)))
(check-sat)
(exit)
