...
(declare-const temp___237 index_type)
(declare-const temp___2371 (Array Int character))
(declare-const temp___2372 t)
(declare-const temp___2373 length_type)
...
(assert (= target__split_fields3 (mk___split_fields (mk___t temp___2351 temp___2352) temp___2353)))
(assert (= target__split_discrs (mk___split_discrs temp___235)))
(assert (= (to_rep1 o5) 0))
(assert (= (rec__bounded_strings__bounded_string__text target__split_fields3) (mk___t o6 o7)))
(assert (= o5 o8))
(assert (= target__split_discrs (mk___split_discrs temp___237)))
(assert (= temp___2371 o6))
(assert (= temp___2372 o7))
(assert (= temp___2373 o8))
(assert (= result3 (mk___split_fields__ref target__split_fields3)))
(assert (= target__split_fields4 (mk___split_fields (mk___t temp___2371 temp___2372) temp___2373)))
(assert (= target__split_discrs (mk___split_discrs temp___237)))
