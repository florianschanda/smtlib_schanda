...
(assert (=> (not (= first_available1 0)) (and (= o54 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o54))))
(assert (=> (not (= first_available1 0)) (= result13 (ite (< 0 o54) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (and (= o53 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o53)))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (= result12 (ite (= o53 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result13 true)) (= result12 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o55 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o55))))
(assert (=> (not (not (= first_available1 0))) (= result12 (ite (= o55 0) true false))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (and (= o51 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o51)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (= result14 (ite (< 0 o51) true false)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (and (= o50 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range7 o50))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (= result11 (ite (= o50 first_allocated1) true false))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (not (= result14 true)) (= result11 false)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (and (= o52 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o52)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (= result11 (ite (= o52 0) true false)))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o48 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o48))))
