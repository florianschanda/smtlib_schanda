...
(assert (and (= o39 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o39)))
(assert (= result11 (ite (< j o39) true false)))
(assert (=> (= result11 true) (and (= o40 (+ j 2)) (in_range1 (+ j 2)))))
(assert (=> (= result11 true) (and (= o41 (get ma1 o40)) (in_range4 o41))))
(assert (=> (not (= result11 true)) (= o41 0)))
(assert (and (= o38 (+ j 1)) (in_range1 (+ j 1))))
(assert (not (<= 1 o38)))
(check-sat)
(exit)
