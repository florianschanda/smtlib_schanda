...
(declare-const o21 pointer_range)
...
(define-fun o29 () us_rep (mk___rep (mk___split_fields o20 o21)))
(define-fun o30 () us_rep (mk___rep (mk___split_fields o16 o17)))
...
(assert (and (= o24 (state__2 (us_split_fields__content my_stack__split_fields4))) (= o24 (mk___rep (us_split_fields__content my_stack__split_fields4)))))
(assert (and (= o25 (count o24)) (and (in_range2 o25) (= o25 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 o24)))))))
(assert (= o26 (- o25 2)))
(assert (= o27 (ite (<= i o26) true false)))
(assert (= result3 (ite (<= 1 i) o27 false)))
(assert (= (= o28 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (- (count (state__2 (us_split_fields__content my_stack__split_fields4))) 2))) (= (stack_entry (state__2 (us_split_fields__content my_stack__split_fields4)) i1) (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i1))))))
(assert (and (= o29 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o20 o21))))
(assert (and (= o22 (count o29)) (and (in_range2 o22) (= o22 (to_rep1 o21)))))
(assert (and (= o23 (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) o22)) (and (in_range1 o23) (= o23 (to_rep (select (rec__stack_functional_spec__stack_type__s (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) o22))))))
(assert (and (= o30 (state__2 (us_split_fields__content my_stack__split_fields4))) (= (us_split_fields__content my_stack__split_fields4) (mk___split_fields o16 o17))))
(assert (and (= o18 (count o30)) (and (in_range2 o18) (= o18 (to_rep1 o17)))))
(assert (= o19 (- o18 1)))
