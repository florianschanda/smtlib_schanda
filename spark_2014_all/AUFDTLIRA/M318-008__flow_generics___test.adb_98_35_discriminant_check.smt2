...
(assert (= dummy1 o4))
(assert (= dummy1 o5))
(assert (= (temp___402 1 1 1 1 1) o6))
(assert (= true o7))
(assert (= (mk___rep (mk___split_discrs o8) (mk___split_fields o9 o10 o11 o12) o13) (mk___rep (mk___split_discrs o2) (mk___split_fields o3 o4 o5 o6) o7)))
(assert (not (= 0 (to_rep o8))))
(check-sat)
(exit)
