...
(assert (= c d))
(assert (in_range1 d))
(assert (and (= (mk___t add_field__x__assume add_field__x__assume1) (init_array Tuple0)) (dynamic_invariant1 (mk___t add_field__x__assume add_field__x__assume1) true false true)))
(assert (= result x))
...
(assert (and (dynamic_property1 1 2147483647 (to_rep x__first) (to_rep x__last)) (forall ((temp___164 Int)) (=> (and (<= (to_rep x__first) temp___164) (<= temp___164 (to_rep x__last))) (dynamic_property d 2147483647 (to_rep (select x1 temp___164)))))))
(declare-const i1 Int)
(assert (<= (to_rep x__first) i1))
(assert (<= i1 (to_rep x__last)))
(assert (not (<= 0 (to_rep (select x1 i1)))))
(check-sat)
(exit)
