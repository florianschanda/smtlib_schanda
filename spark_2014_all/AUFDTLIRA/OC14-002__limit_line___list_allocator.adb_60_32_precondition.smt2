...
(assert (=> (not (= first_available 0)) (and (= o35 (length model____split_fields)) (in_range6 o35))))
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o35) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o34 (get model____split_fields 1)) (in_range7 o34)))))
...
(assert (=> (not (not (= first_available 0))) (and (= o36 (length model____split_fields)) (in_range6 o36))))
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o36 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o32 (length model____split_fields1)) (in_range6 o32)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o32) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o31 (get model____split_fields1 1)) (in_range7 o31))))))
...
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o33 (length model____split_fields1)) (in_range6 o33)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o33 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o29 (length model____split_fields)) (in_range6 o29))))
...
(assert (=> (= result9 true) (and (= o24 (length model____split_fields1)) (in_range6 o24))))
(assert (=> (= result9 true) (= result10 (ite (< j o24) true false))))
(assert (=> (= result9 true) (=> (= result10 true) (and (= o25 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result9 true) (=> (= result10 true) (and (= o26 (get model____split_fields1 o25)) (in_range7 o26)))))
...
(assert (=> (= result8 true) (=> (< 1 j) (and (= o14 (get model____split_fields1 o13)) (in_range7 o14)))))
