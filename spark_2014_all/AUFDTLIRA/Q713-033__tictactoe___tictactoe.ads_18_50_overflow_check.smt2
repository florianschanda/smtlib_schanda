...
(define-fun dynamic_invariant ((temp___expr_525 Int) (temp___is_init_522 Bool) (temp___skip_constant_523 Bool) (temp___do_toplevel_524 Bool)) Bool (=> (or (= temp___is_init_522 true) (<= 1 3)) (in_range1 temp___expr_525)))
(declare-sort slot 0)
...
(assert (=> (<= 2 x) (=> (<= 3 y) (and (= o9 (one_free_slot 2 3 my_board)) (and (in_range o9) (= o9 (ite (= (to_rep (select (select my_board 2) 3)) 0) 1 0)))))))
(assert (=> (<= 2 x) (=> (not (<= 3 y)) (= o9 0))))
(assert (=> (<= 2 x) (=> (<= 2 y) (and (= o6 (one_free_slot 2 2 my_board)) (and (in_range o6) (= o6 (ite (= (to_rep (select (select my_board 2) 2)) 0) 1 0)))))))
(assert (=> (<= 2 x) (=> (not (<= 2 y)) (= o6 0))))
(assert (=> (<= 2 x) (and (= o7 (one_free_slot 2 1 my_board)) (and (in_range o7) (= o7 (ite (= (to_rep (select (select my_board 2) 1)) 0) 1 0))))))
(assert (=> (<= 2 x) (= o8 (+ o7 o6))))
(assert (=> (<= 2 x) (and (= o10 o8) (in_range o8))))
(assert (=> (<= 2 x) (= o11 (+ o10 o9))))
(assert (=> (<= 2 x) (and (= o12 o11) (in_range o11))))
(assert (=> (not (<= 2 x)) (= o12 0)))
(assert (=> (<= 3 y) (and (= o3 (one_free_slot 1 3 my_board)) (and (in_range o3) (= o3 (ite (= (to_rep (select (select my_board 1) 3)) 0) 1 0))))))
(assert (=> (not (<= 3 y)) (= o3 0)))
(assert (=> (<= 2 y) (and (= o (one_free_slot 1 2 my_board)) (and (in_range o) (= o (ite (= (to_rep (select (select my_board 1) 2)) 0) 1 0))))))
(assert (=> (not (<= 2 y)) (= o 0)))
(assert (and (= o1 (one_free_slot 1 1 my_board)) (and (in_range o1) (= o1 (ite (= (to_rep (select (select my_board 1) 1)) 0) 1 0)))))
(assert (= o2 (+ o1 o)))
(assert (and (= o4 o2) (in_range o2)))
(assert (= o5 (+ o4 o3)))
(assert (and (= o13 o5) (in_range o5)))
(assert (= o14 (+ o13 o12)))
