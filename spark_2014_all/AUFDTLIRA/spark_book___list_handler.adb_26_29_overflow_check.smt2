...
(define-fun dynamic_invariant2 ((temp___expr_164 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 128)) (in_range3 temp___expr_164)))
...
(define-fun dynamic_invariant3 ((temp___expr_153 Int) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (<= 0 128)) (in_range5 temp___expr_153)))
(declare-fun back (tuple0) Int)
(declare-fun back__function_guard (Int tuple0) Bool)
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant3 (back us_void_param) true false true) :pattern ((back us_void_param)))))
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(define-fun dynamic_invariant4 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_141)))
...
(assert (and (and (and (and (in_range3 free1) (=> (<= (- 2147483648) 2147483647) (in_range1 current2))) (=> (<= 0 3) (in_range4 status1))) (in_range3 count1)) (<= current2 upper)))
(assert (and (= o (back Tuple0)) (in_range5 o)))
(assert (and (and (in_range4 status2) (in_range3 free2)) (in_range3 count2)))
(assert (= status2 0))
