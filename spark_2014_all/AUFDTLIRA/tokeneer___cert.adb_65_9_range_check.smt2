...
(assert (not (= (length (mk___t temp___1896 temp___18961)) 0)))
(assert (=> (<= (to_rep1 (first6 temp___18971)) (to_rep1 (last6 temp___18971))) (= o12 (+ (- (to_rep1 (last6 temp___18971)) (to_rep1 (first6 temp___18971))) 1))))
(assert (=> (not (<= (to_rep1 (first6 temp___18971)) (to_rep1 (last6 temp___18971)))) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___18961)) (to_rep1 (last temp___18961))) (= o13 (+ (- (to_rep1 (last temp___18961)) (to_rep1 (first temp___18961))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___18961)) (to_rep1 (last temp___18961)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___18961)) o14)))
(assert (= o16 (- o15 1)))
