...
(assert (not (= (length (mk___t temp___1733 temp___17331)) 0)))
(assert (=> (<= (to_rep1 (first4 temp___17341)) (to_rep1 (last4 temp___17341))) (= o12 (+ (- (to_rep1 (last4 temp___17341)) (to_rep1 (first4 temp___17341))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___17341)) (to_rep1 (last4 temp___17341)))) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___17331)) (to_rep1 (last temp___17331))) (= o13 (+ (- (to_rep1 (last temp___17331)) (to_rep1 (first temp___17331))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___17331)) (to_rep1 (last temp___17331)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___17331)) o14)))
(assert (= o16 (- o15 1)))
