...
(assert (not (= (length (mk___t temp___1903 temp___19031)) 0)))
(assert (=> (<= (to_rep1 (first4 temp___19041)) (to_rep1 (last4 temp___19041))) (= o12 (+ (- (to_rep1 (last4 temp___19041)) (to_rep1 (first4 temp___19041))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___19041)) (to_rep1 (last4 temp___19041)))) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___19031)) (to_rep1 (last temp___19031))) (= o13 (+ (- (to_rep1 (last temp___19031)) (to_rep1 (first temp___19031))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___19031)) (to_rep1 (last temp___19031)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___19031)) o14)))
(assert (= o16 (- o15 1)))
