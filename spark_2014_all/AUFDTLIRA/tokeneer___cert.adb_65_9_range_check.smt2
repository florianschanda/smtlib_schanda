...
(assert (not (= (length (mk___t temp___1677 temp___16771)) 0)))
(assert (=> (<= (to_rep1 (first2 temp___16781)) (to_rep1 (last2 temp___16781))) (= o12 (+ (- (to_rep1 (last2 temp___16781)) (to_rep1 (first2 temp___16781))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___16781)) (to_rep1 (last2 temp___16781)))) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___16771)) (to_rep1 (last temp___16771))) (= o13 (+ (- (to_rep1 (last temp___16771)) (to_rep1 (first temp___16771))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___16771)) (to_rep1 (last temp___16771)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___16771)) o14)))
(assert (= o16 (- o15 1)))
