...
(assert (= (concat1 (temp___String_Literal_1220 Tuple0) 1 8 (elts (to_string (attr__ATTRIBUTE_IMAGE3 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents)))))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents)))))))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))))))))) temp___1224))
(assert (= (mk 1 o5) temp___12241))
(assert (=> (= (length (mk___t temp___1224 temp___12241)) 0) (= (temp___String_Literal_1223 Tuple0) temp___1226)))
(assert (=> (= (length (mk___t temp___1224 temp___12241)) 0) (= (mk 1 12) temp___12261)))
(assert (=> (not (= (length (mk___t temp___1224 temp___12241)) 0)) (=> (<= 1 12) (= o6 (+ (- 12 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1224 temp___12241)) 0)) (=> (not (<= 1 12)) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___1224 temp___12241)) 0)) (=> (<= (to_rep1 (first temp___12241)) (to_rep1 (last temp___12241))) (= o7 (+ (- (to_rep1 (last temp___12241)) (to_rep1 (first temp___12241))) 1)))))
(assert (=> (not (= (length (mk___t temp___1224 temp___12241)) 0)) (=> (not (<= (to_rep1 (first temp___12241)) (to_rep1 (last temp___12241)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___1224 temp___12241)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___1224 temp___12241)) 0)) (= o9 (+ (to_rep1 (first temp___12241)) o8))))
(assert (=> (not (= (length (mk___t temp___1224 temp___12241)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___1224 temp___12241)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___1224 temp___12241)) 0)) (= (concat1 temp___1224 (to_rep1 (first temp___12241)) (to_rep1 (last temp___12241)) (temp___String_Literal_1223 Tuple0) 1 12) temp___1226)))
(assert (=> (not (= (length (mk___t temp___1224 temp___12241)) 0)) (= (mk (to_rep1 (first temp___12241)) o11) temp___12261)))
(assert (not (= (length (mk___t temp___1226 temp___12261)) 0)))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents)))))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))))))) (= o12 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents)))))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents))))))))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents)))))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__contentst__id (us_split_fields7 contents)))))))))))) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___12261)) (to_rep1 (last temp___12261))) (= o13 (+ (- (to_rep1 (last temp___12261)) (to_rep1 (first temp___12261))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___12261)) (to_rep1 (last temp___12261)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
