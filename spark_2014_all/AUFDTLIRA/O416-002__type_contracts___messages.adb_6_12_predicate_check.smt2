...
(define-fun dynamic_invariant ((temp___expr_144 us_rep) (temp___is_init_141 Bool) (temp___skip_constant_142 Bool) (temp___do_toplevel_143 Bool)) Bool (=> (= temp___do_toplevel_143 true) (=> (= temp___is_init_141 true) (<= (let ((temp___147 (rec__messages__message__received (us_split_fields1 temp___expr_144)))) (let ((temp___146 (rec__messages__message__sent (us_split_fields1 temp___expr_144)))) (compare temp___146 1 10 temp___147 1 10))) 0))))
(define-fun dynamic_predicate ((temp___158 us_rep)) Bool (<= (let ((temp___161 (rec__messages__message__received (us_split_fields1 temp___158)))) (let ((temp___160 (rec__messages__message__sent (us_split_fields1 temp___158)))) (compare temp___160 1 10 temp___161 1 10))) 0))
(declare-const i1s us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant1 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range temp___expr_63)))
(declare-const m__split_fields (Array Int character))
(declare-const m__split_fields1 (Array Int character))
(assert (let ((temp___145 i1s)) (<= (compare (rec__messages__message__sent (us_split_fields1 temp___145)) 1 10 (rec__messages__message__received (us_split_fields1 temp___145)) 1 10) 0)))
