...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_579 us_void_param) 1)) 72) (= (to_rep (select (temp___String_Literal_579 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 3)) 44)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 5)) 73)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 8)) 109)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 10)) 97)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 12)) 110)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 13)) 101)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 14)) 119)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 16)) 116)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 18)) 115)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 19)) 107)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 21)) 84)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 22)) 50)) (= (to_rep (select (temp___String_Literal_579 us_void_param) 23)) 33)) :pattern ((temp___String_Literal_579 us_void_param)))))
