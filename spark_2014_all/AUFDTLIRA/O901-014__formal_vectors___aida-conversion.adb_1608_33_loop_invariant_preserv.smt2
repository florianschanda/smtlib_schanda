...
(assert (<= temp___2099 index1))
(assert (<= index1 temp___2100))
...
(assert (and (and (forall ((temp___2097 Int)) (=> (and (<= (to_rep1 n__first) temp___2097) (<= temp___2097 (to_rep1 n__last))) (=> (< index2 temp___2097) (= (select n3 temp___2097) (select n1 temp___2097))))) (=> (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 5) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
(assert (not (= index2 temp___2100)))
