...
(assert (<= temp___1997 index2))
(assert (<= index2 temp___1998))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o25 index2))
(assert (= o26 (select n1 o25)))
(assert (= o27 (to_rep1 o26)))
(assert (= o27 aida__conversion__convert_character_digit_to_integer__2__target))
...
(assert (= (to_rep1 o31) aida__conversion__convert_character_digit_to_integer__2__target2))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o32 index2))
(assert (= o33 (store n1 o32 o31)))
(assert (= n1 result4))
(assert (= n2 o33))
(assert (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))))
(assert (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1))))))
(assert (and (and (forall ((temp___1995 Int)) (=> (and (<= (to_rep1 n__first) temp___1995) (<= temp___1995 (to_rep1 n__last))) (=> (< index3 temp___1995) (= (select n3 temp___1995) (select n1 temp___1995))))) (=> (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 5) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10)))))
(assert (not (= index3 temp___1998)))
(assert (= index3 result7))
(assert (= index4 (+ index3 1)))
(assert (and (<= (to_rep1 n__first) index4) (<= index4 (to_rep1 n__last))))
(assert (= o45 index4))
(assert (= o46 (select n3 o45)))
(assert (= o47 (to_rep1 o46)))
(assert (= o47 aida__conversion__convert_character_digit_to_integer__2__target1))
...
(assert (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target3) (<= aida__conversion__convert_character_digit_to_integer__2__target3 9)) (= aida__conversion__convert_character_digit_to_integer__2__target3 (convert_character_digit_to_integer o50))) (ite (= (= o50 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 0) (ite (= (= o50 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 1) (ite (= (= o50 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 2) (ite (= (= o50 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 3) (ite (= (= o50 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 4) (ite (= (= o50 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 5) (ite (= (= o50 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 6) (ite (= (= o50 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 7) (ite (= (= o50 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 8) (=> (= (= o50 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target3)))
(assert (= (to_rep1 o51) aida__conversion__convert_character_digit_to_integer__2__target3))
(assert (and (<= (to_rep1 n__first) index4) (<= index4 (to_rep1 n__last))))
(assert (= o52 index4))
(assert (= o53 (store n3 o52 o51)))
(assert (= result8 n3))
(assert (= n4 o53))
(declare-const j1 Int)
(assert (<= (+ (to_rep1 (first (rt source))) 5) j1))
(assert (<= j1 index4))
(assert (not (<= (to_rep1 (select n4 j1)) (to_rep1 (select int_array1 j1)))))
(check-sat)
(exit)
