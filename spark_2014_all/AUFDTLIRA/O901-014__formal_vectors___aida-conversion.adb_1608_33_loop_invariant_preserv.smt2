...
(assert (<= temp___1997 index1))
(assert (<= index1 temp___1998))
...
(assert (and (and (forall ((temp___1995 Int)) (=> (and (<= (to_rep1 n__first) temp___1995) (<= temp___1995 (to_rep1 n__last))) (=> (< index2 temp___1995) (= (select n3 temp___1995) (select n1 temp___1995))))) (=> (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 5) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
(assert (not (= index2 temp___1998)))
