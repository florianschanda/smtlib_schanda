...
(assert (= result6 true))
(assert (and (= o55 (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1)) (and (in_range5 o55) (= o55 (get (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c1))))))
(assert (= o56 (ite (= o55 (to_rep (select a1 j))) true false)))
(assert (= o57 (ite (not (= o56 true)) true false)))
(assert (and (= o53 (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1)) (and (in_range5 o53) (= o53 (get (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c1))))))
...
(assert (= result7 true))
(assert (and (= o60 (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1)) (and (in_range5 o60) (= o60 (get (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c1))))))
