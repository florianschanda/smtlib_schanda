...
(declare-const temp___258 integer)
(declare-const temp___2581 integer)
(declare-const temp___2582 (Array Int integer))
(declare-const temp___2583 integer)
(declare-const temp___2584 (Array Int integer))
(declare-const temp___2585 Bool)
...
(assert (= output__split_discrs temp___258))
(assert (= temp___2581 o5))
(assert (= temp___2582 o6))
(assert (= temp___2583 o7))
(assert (= temp___2584 o8))
(assert (= output__attr__constrained temp___2585))
...
(assert (= output__split_fields4 (mk___split_fields2 (mk___rep (mk___split_fields temp___2581 temp___2582)) (mk___rep1 (mk___split_fields1 temp___2583 temp___2584)))))
(assert (= result1 (mk___split_discrs__ref (mk___split_discrs output__split_discrs))))
(assert (= output__split_discrs1 (mk___split_discrs temp___258)))
(assert (not (= (to_rep (rec__use_unchecked_union__myunion__discr output__split_discrs1)) 0)))
(check-sat)
(exit)
