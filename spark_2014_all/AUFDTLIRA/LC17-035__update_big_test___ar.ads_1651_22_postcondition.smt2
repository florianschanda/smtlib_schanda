...
(declare-fun temp___3620 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
(declare-fun temp___3627 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq2 a2 1 16 (temp___3620 a i (mk___rep (mk___split_fields (temp___3627 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e) (rec__ar__rofa1__t1 (us_split_fields1 (select a i)))))) 1 16) true)))
(check-sat)
(exit)
