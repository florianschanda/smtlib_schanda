...
(define-fun dynamic_invariant1 ((temp___expr_155 us_t) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (=> (not (= temp___skip_constant_153 true)) (dynamic_property 1 2147483647 (first1 temp___expr_155) (last1 temp___expr_155))))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___134 (rec__static_discr__i_holder__content1 (us_split_fields3 a)))) (of_array1 (to_array2 temp___134) (first5 temp___134) (last5 temp___134))))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___133 (rec__static_discr__i_holder__content (us_split_fields1 r)))) (of_array2 (to_array1 temp___133) (first3 temp___133) (last3 temp___133))))))
...
(define-fun to_base1 ((a1 us_rep3)) us_rep (mk___rep (us_split_discrs5 a1) (mk___split_fields (let ((temp___139 (rec__static_discr__i_holder__content2 (us_split_fields7 a1)))) (of_array1 (to_array3 temp___139) (first7 temp___139) (last7 temp___139))))))
(define-fun of_base1 ((r us_rep)) us_rep3 (mk___rep3 (us_split_discrs1 r) (mk___split_fields3 (let ((temp___138 (rec__static_discr__i_holder__content (us_split_fields1 r)))) (of_array3 (to_array1 temp___138) (first3 temp___138) (last3 temp___138))))))
...
(define-fun dynamic_invariant2 ((temp___expr_224 us_rep4) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool)) Bool (and (=> (not (= temp___skip_constant_222 true)) (in_range6 (last1 a) (last1 a) (to_base2 temp___expr_224))) (and (in_range5 (last1 a) (last1 a) (to_base1 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_224)))) (and (dynamic_property6 1 (last1 a) (first7 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_224))))) (last7 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_224)))))) (and (= (first7 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_224))))) 1) (= (last7 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_224))))) (last1 a)))))))
(define-fun default_initial_assumption ((temp___expr_230 us_rep4) (temp___skip_top_level_231 Bool)) Bool (and (and (= (to_rep (rec__static_discr__holder__unused (us_split_discrs6 temp___expr_230))) (last1 a)) (= (to_rep (rec__static_discr__holder__c (us_split_discrs6 temp___expr_230))) (last1 a))) (and (= (to_rep (rec__static_discr__i_holder__unused (us_split_discrs5 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_230))))) (last1 a)) (= (to_rep (rec__static_discr__i_holder__c (us_split_discrs5 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_230))))) (last1 a)))))
...
(define-fun to_base3 ((a1 us_rep5)) us_rep (mk___rep (us_split_discrs7 a1) (mk___split_fields (let ((temp___141 (rec__static_discr__i_holder__content3 (us_split_fields11 a1)))) (of_array1 (to_array4 temp___141) (first9 temp___141) (last9 temp___141))))))
(define-fun of_base3 ((r us_rep)) us_rep5 (mk___rep5 (us_split_discrs1 r) (mk___split_fields5 (let ((temp___140 (rec__static_discr__i_holder__content (us_split_fields1 r)))) (of_array4 (to_array1 temp___140) (first3 temp___140) (last3 temp___140))))))
...
(define-fun bool_eq12 ((a1 us_rep6) (b us_rep6)) Bool (ite (and (and (and (= (to_rep (rec__static_discr__holder__unused (us_split_discrs8 a1))) (to_rep (rec__static_discr__holder__unused (us_split_discrs8 b)))) (= (to_rep (rec__static_discr__holder__c (us_split_discrs8 a1))) (to_rep (rec__static_discr__holder__c (us_split_discrs8 b))))) (= (bool_eq11 (rec__static_discr__holder__content2 (us_split_fields13 a1)) (rec__static_discr__holder__content2 (us_split_fields13 b))) true)) (= (to_rep (rec__static_discr__holder__length2 (us_split_fields13 a1))) (to_rep (rec__static_discr__holder__length2 (us_split_fields13 b))))) true false))
...
(define-fun to_base5 ((a1 us_rep7)) us_rep (mk___rep (us_split_discrs9 a1) (mk___split_fields (let ((temp___143 (rec__static_discr__i_holder__content4 (us_split_fields15 a1)))) (of_array1 (to_array5 temp___143) (first11 temp___143) (last11 temp___143))))))
(define-fun of_base5 ((r us_rep)) us_rep7 (mk___rep7 (us_split_discrs1 r) (mk___split_fields7 (let ((temp___142 (rec__static_discr__i_holder__content (us_split_fields1 r)))) (of_array5 (to_array1 temp___142) (first3 temp___142) (last3 temp___142))))))
...
(define-fun dynamic_invariant5 ((temp___expr_160 us_rep) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool (let ((temp___162 (rec__static_discr__i_holder__c (us_split_discrs1 temp___expr_160)))) (and (dynamic_property2 1 (to_rep temp___162) (first3 (rec__static_discr__i_holder__content (us_split_fields1 temp___expr_160))) (last3 (rec__static_discr__i_holder__content (us_split_fields1 temp___expr_160)))) (and (= (first3 (rec__static_discr__i_holder__content (us_split_fields1 temp___expr_160))) 1) (= (last3 (rec__static_discr__i_holder__content (us_split_fields1 temp___expr_160))) (to_rep temp___162))))))
(define-fun dynamic_invariant6 ((temp___expr_167 us_rep2) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool)) Bool (let ((temp___169 (rec__static_discr__holder__c (us_split_discrs4 temp___expr_167)))) (and (in_range4 (to_rep (rec__static_discr__holder__unused (us_split_discrs4 temp___expr_167))) (to_rep temp___169) (to_base (rec__static_discr__holder__content (us_split_fields5 temp___expr_167)))) (and (dynamic_property4 1 (to_rep temp___169) (first5 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 temp___expr_167))))) (last5 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 temp___expr_167)))))) (and (= (first5 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 temp___expr_167))))) 1) (= (last5 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 temp___expr_167))))) (to_rep temp___169)))))))
...
(declare-const temp___366 Int)
(declare-const temp___365 us_rep4)
...
(assert (dynamic_invariant2 (mk___rep4 current__split_discrs current__split_fields5) true false true))
(assert (= result1 (mk_int__ref result__)))
(assert (= result__1 0))
(assert (in_range2 result__1))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields5)))) (= temp___366 result__1)))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields5)))) (= temp___365 (mk___rep4 current__split_discrs current__split_fields5))))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields5)))) (and (and (and (<= (to_rep1 (first (rt a))) (to_rep (rec__static_discr__holder__length1 current__split_fields6))) (<= (to_rep (rec__static_discr__holder__length1 current__split_fields6)) (to_rep1 (last (rt a))))) (= (let ((temp___368 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields6))))) (bool_eq (elts a) (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) (elts3 temp___368) (to_rep1 (first6 (rt3 temp___368))) (to_rep1 (last6 (rt3 temp___368))))) true)) (forall ((i Int)) (=> (and (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields6)) 1) i) (<= i (to_rep1 (last (rt a))))) (not (= (to_rep (select (elts a) i)) e)))))))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields5)))) (and (and (dynamic_invariant2 (mk___rep4 current__split_discrs current__split_fields6) false true true) (=> (<= 0 2147483647) (in_range2 result__2))) (and (= result__2 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields6)))))))
...
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields5)))) (and (and (= (let ((temp___244 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields6))))) (let ((temp___243 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields7))))) (bool_eq (elts3 temp___243) (to_rep1 (first6 (rt3 temp___243))) (to_rep1 (last6 (rt3 temp___243))) (elts3 temp___244) (to_rep1 (first6 (rt3 temp___244))) (to_rep1 (last6 (rt3 temp___244)))))) true) (and (< (to_rep (rec__static_discr__holder__length1 current__split_fields7)) (to_rep (rec__static_discr__holder__length1 current__split_fields6))) (ite (= result__3 0) (forall ((i Int)) (=> (and (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields7)) 1) i) (<= i (to_rep (rec__static_discr__holder__length1 current__split_fields6)))) (not (= (to_rep (select (elts3 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields7)))) i)) e)))) (and (and (<= (to_rep (rec__static_discr__holder__length1 current__split_fields7)) result__3) (<= result__3 (to_rep (rec__static_discr__holder__length1 current__split_fields6)))) (= (to_rep (select (elts3 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields7)))) result__3)) e))))) (and (dynamic_invariant2 (mk___rep4 current__split_discrs current__split_fields7) true true true) (in_range2 result__3)))))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields5)))) (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) (to_rep1 (last (rt a))))))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields5)))) (= (let ((temp___364 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields7))))) (bool_eq (elts a) (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) (elts3 temp___364) (to_rep1 (first6 (rt3 temp___364))) (to_rep1 (last6 (rt3 temp___364))))) true)))
