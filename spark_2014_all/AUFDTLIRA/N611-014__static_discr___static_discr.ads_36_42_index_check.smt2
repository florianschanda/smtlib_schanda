...
(define-fun tT16bP1__ref___projection ((a tT16bP1__ref)) integer (tT16bP1__content a))
(declare-sort t2 0)
...
(define-fun us_split_fields_Content__8__projection ((a us_split_fields6)) us_t2 (rec__static_discr__i_holder__content2 a))
...
(define-fun us_rep___15__projection ((a us_rep3)) us_split_discrs (us_split_discrs5 a))
(define-fun us_rep___16__projection ((a us_rep3)) us_split_fields6 (us_split_fields7 a))
(define-fun to_base1 ((a us_rep3)) us_rep (mk___rep (us_split_discrs5 a) (mk___split_fields (let ((temp___161 (rec__static_discr__i_holder__content2 (us_split_fields7 a)))) (of_array (to_array2 temp___161) (first5 temp___161) (last5 temp___161))))))
(define-fun of_base1 ((r us_rep)) us_rep3 (mk___rep3 (us_split_discrs1 r) (mk___split_fields3 (let ((temp___160 (rec__static_discr__i_holder__content (us_split_fields1 r)))) (of_array2 (to_array temp___160) (first1 temp___160) (last1 temp___160))))))
(define-fun bool_eq7 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep (rec__static_discr__i_holder__unused (us_split_discrs5 a))) (to_rep (rec__static_discr__i_holder__unused (us_split_discrs5 b)))) (= (to_rep (rec__static_discr__i_holder__c (us_split_discrs5 a))) (to_rep (rec__static_discr__i_holder__c (us_split_discrs5 b))))) (= (bool_eq6 (rec__static_discr__i_holder__content2 (us_split_fields7 a)) (rec__static_discr__i_holder__content2 (us_split_fields7 b))) true)) true false))
...
(define-fun t15b__ref___projection ((a t15b__ref)) us_rep3 (t15b__content a))
...
(define-fun us_split_fields_Content__9__projection ((a us_split_fields8)) us_rep3 (rec__static_discr__holder__content1 a))
(define-fun us_split_fields_Length__4__projection ((a us_split_fields8)) natural (rec__static_discr__holder__length1 a))
...
(define-fun us_rep___17__projection ((a us_rep4)) us_split_discrs3 (us_split_discrs6 a))
...
(define-fun bool_eq8 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (= (to_rep (rec__static_discr__holder__unused (us_split_discrs6 a))) (to_rep (rec__static_discr__holder__unused (us_split_discrs6 b)))) (= (to_rep (rec__static_discr__holder__c (us_split_discrs6 a))) (to_rep (rec__static_discr__holder__c (us_split_discrs6 b))))) (and (= (bool_eq7 (rec__static_discr__holder__content1 (us_split_fields9 a)) (rec__static_discr__holder__content1 (us_split_fields9 b))) true) (= (to_rep (rec__static_discr__holder__length1 (us_split_fields9 a))) (to_rep (rec__static_discr__holder__length1 (us_split_fields9 b)))))) true false))
(define-fun in_range5 ((rec__static_discr__holder__unused1 Int) (rec__static_discr__holder__c1 Int) (a us_rep2)) Bool (and (= rec__static_discr__holder__unused1 (to_rep (rec__static_discr__holder__unused (us_split_discrs4 a)))) (= rec__static_discr__holder__c1 (to_rep (rec__static_discr__holder__c (us_split_discrs4 a))))))
...
(define-fun my_holder__ref___projection ((a my_holder__ref)) us_rep4 (my_holder__content a))
...
(define-fun dynamic_property6 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range1 low) (and (in_range1 high) (=> (<= low high) (and (in_range6 low) (in_range6 high))))))
...
(define-fun bool_eq9 ((x us_t3) (y us_t3)) Bool (bool_eq (elts3 x) (to_rep1 (first6 (rt3 x))) (to_rep1 (last6 (rt3 x))) (elts3 y) (to_rep1 (first6 (rt3 y))) (to_rep1 (last6 (rt3 y)))))
(declare-fun user_eq14 (us_t3 us_t3) Bool)
(declare-const dummy14 us_t3)
(declare-datatypes () ((nat_array__ref (mk_nat_array__ref (nat_array__content us_t3)))))
(define-fun nat_array__ref___projection ((a nat_array__ref)) us_t3 (nat_array__content a))
(declare-const a us_t3)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant1 ((temp___expr_252 us_rep4) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool) (temp___do_typ_inv_251 Bool)) Bool (and (=> (not (= temp___skip_constant_249 true)) (in_range5 (last7 a) (last7 a) (to_base2 temp___expr_252))) (and (in_range4 (last7 a) (last7 a) (to_base1 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_252)))) (and (dynamic_property5 1 (last7 a) (first5 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_252))))) (last5 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_252)))))) (and (= (first5 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_252))))) 1) (= (last5 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_252))))) (last7 a)))))))
(define-fun default_initial_assumption ((temp___expr_258 us_rep4) (temp___skip_top_level_259 Bool)) Bool (and (and (= (to_rep (rec__static_discr__holder__unused (us_split_discrs6 temp___expr_258))) (last7 a)) (= (to_rep (rec__static_discr__holder__c (us_split_discrs6 temp___expr_258))) (last7 a))) (and (= (to_rep (rec__static_discr__i_holder__unused (us_split_discrs5 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_258))))) (last7 a)) (= (to_rep (rec__static_discr__i_holder__c (us_split_discrs5 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_258))))) (last7 a)))))
(define-fun dynamic_invariant2 ((temp___expr_178 us_t3) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool) (temp___do_typ_inv_177 Bool)) Bool (=> (not (= temp___skip_constant_175 true)) (dynamic_property6 1 2147483647 (first7 temp___expr_178) (last7 temp___expr_178))))
...
(define-fun to_base3 ((a1 us_rep5)) us_rep (mk___rep (us_split_discrs7 a1) (mk___split_fields (let ((temp___163 (rec__static_discr__i_holder__content3 (us_split_fields11 a1)))) (of_array (to_array4 temp___163) (first9 temp___163) (last9 temp___163))))))
(define-fun of_base3 ((r us_rep)) us_rep5 (mk___rep5 (us_split_discrs1 r) (mk___split_fields5 (let ((temp___162 (rec__static_discr__i_holder__content (us_split_fields1 r)))) (of_array4 (to_array temp___162) (first1 temp___162) (last1 temp___162))))))
...
(define-fun to_base5 ((a1 us_rep7)) us_rep (mk___rep (us_split_discrs9 a1) (mk___split_fields (let ((temp___165 (rec__static_discr__i_holder__content4 (us_split_fields15 a1)))) (of_array (to_array5 temp___165) (first11 temp___165) (last11 temp___165))))))
(define-fun of_base5 ((r us_rep)) us_rep7 (mk___rep7 (us_split_discrs1 r) (mk___split_fields7 (let ((temp___164 (rec__static_discr__i_holder__content (us_split_fields1 r)))) (of_array5 (to_array temp___164) (first1 temp___164) (last1 temp___164))))))
...
(define-fun dynamic_invariant3 ((temp___expr_46 Int) (temp___is_init_42 Bool) (temp___skip_constant_43 Bool) (temp___do_toplevel_44 Bool) (temp___do_typ_inv_45 Bool)) Bool (=> (or (= temp___is_init_42 true) (<= 1 2147483647)) (in_range6 temp___expr_46)))
...
(declare-const current__split_fields3 t2)
...
(define-fun o34 () us_rep (mk___rep (mk___split_discrs o22 o23) (mk___split_fields (mk___t o24 o25))))
(define-fun o35 () us_rep (mk___rep (mk___split_discrs o18 o19) (mk___split_fields (mk___t o20 o21))))
(assert (dynamic_invariant2 a true false true true))
(assert (in_range2 e))
(assert (and (= (to_rep1 (first6 (rt3 a))) 1) (and (<= 0 (to_rep1 (last6 (rt3 a)))) (<= (to_rep1 (last6 (rt3 a))) 100))))
(assert (and (= us (to_rep1 (last6 (rt3 a)))) (in_range2 (to_rep1 (last6 (rt3 a))))))
(assert (and (= us1 (to_rep1 (last6 (rt3 a)))) (in_range2 (to_rep1 (last6 (rt3 a))))))
(assert (and (= o26 (to_rep1 (last6 (rt3 a)))) (in_range2 (to_rep1 (last6 (rt3 a))))))
(assert (= (to_rep o27) o26))
(assert (= (ite (<= (to_rep1 (first6 (rt3 a))) (to_rep1 (last6 (rt3 a)))) (+ (- (to_rep1 (last6 (rt3 a))) (to_rep1 (first6 (rt3 a)))) 1) 0) (ite (<= 1 (to_rep1 (last6 (rt3 a)))) (+ (- (to_rep1 (last6 (rt3 a))) 1) 1) 0)))
(assert (= (slide (elts3 a) (to_rep1 (first6 (rt3 a))) 1) o8))
(assert (= (mk5 1 (to_rep1 (last6 (rt3 a)))) o9))
(assert (= o10 o8))
(assert (= o11 o9))
(assert (and (= o5 (to_rep1 (last6 (rt3 a)))) (in_range2 (to_rep1 (last6 (rt3 a))))))
(assert (= (to_rep o6) o5))
(assert (and (= o4 (to_rep1 (last6 (rt3 a)))) (in_range2 (to_rep1 (last6 (rt3 a))))))
(assert (= (to_rep o7) o4))
(assert (= o7 o12))
(assert (= o6 o13))
(assert (= o14 o12))
...
(assert (and (= o1 (to_rep1 (last6 (rt3 a)))) (in_range2 (to_rep1 (last6 (rt3 a))))))
(assert (= (to_rep o2) o1))
(assert (and (= o (to_rep1 (last6 (rt3 a)))) (in_range2 (to_rep1 (last6 (rt3 a))))))
(assert (= (to_rep o3) o))
...
(assert (= result (mk___split_fields__ref4 (mk___split_fields4 (mk___rep3 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields3 (mk___t2 current__split_fields2 current__split_fields3))) current__split_fields4))))
...
(assert (dynamic_invariant1 (mk___rep4 current__split_discrs current__split_fields5) true false true true))
...
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields5)))) (and (and (and (<= (to_rep1 (first6 (rt3 a))) (to_rep (rec__static_discr__holder__length1 current__split_fields6))) (<= (to_rep (rec__static_discr__holder__length1 current__split_fields6)) (to_rep1 (last6 (rt3 a))))) (= (let ((temp___400 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields6))))) (bool_eq (elts3 a) (to_rep1 (first6 (rt3 a))) (to_rep1 (last6 (rt3 a))) (elts2 temp___400) (to_rep1 (first4 (rt2 temp___400))) (to_rep1 (last4 (rt2 temp___400))))) true)) (forall ((i Int)) (=> (and (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields6)) 1) i) (<= i (to_rep1 (last6 (rt3 a))))) (not (= (to_rep (select (elts3 a) i)) e)))))))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields5)))) (and (and (dynamic_invariant1 (mk___rep4 current__split_discrs current__split_fields6) false true true true) (=> (<= 0 2147483647) (in_range2 result__2))) (and (= result__2 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields6)))))))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields5)))) (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) (to_rep1 (last6 (rt3 a))))))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields5)))) (and (and (= (let ((temp___272 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields6))))) (let ((temp___271 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields7))))) (bool_eq (elts2 temp___271) (to_rep1 (first4 (rt2 temp___271))) (to_rep1 (last4 (rt2 temp___271))) (elts2 temp___272) (to_rep1 (first4 (rt2 temp___272))) (to_rep1 (last4 (rt2 temp___272)))))) true) (and (< (to_rep (rec__static_discr__holder__length1 current__split_fields7)) (to_rep (rec__static_discr__holder__length1 current__split_fields6))) (ite (= result__3 0) (forall ((i Int)) (=> (and (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields7)) 1) i) (<= i (to_rep (rec__static_discr__holder__length1 current__split_fields6)))) (not (= (to_rep (select (elts2 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields7)))) i)) e)))) (and (and (<= (to_rep (rec__static_discr__holder__length1 current__split_fields7)) result__3) (<= result__3 (to_rep (rec__static_discr__holder__length1 current__split_fields6)))) (= (to_rep (select (elts2 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields7)))) result__3)) e))))) (and (dynamic_invariant1 (mk___rep4 current__split_discrs current__split_fields7) true true true true) (in_range2 result__3)))))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields5)))) (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) (to_rep1 (last6 (rt3 a))))))
(assert (=> (and (= result__1 0) (< 0 (to_rep (rec__static_discr__holder__length1 current__split_fields5)))) (= (let ((temp___396 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields7))))) (bool_eq (elts3 a) (to_rep1 (first6 (rt3 a))) (to_rep1 (last6 (rt3 a))) (elts2 temp___396) (to_rep1 (first4 (rt2 temp___396))) (to_rep1 (last4 (rt2 temp___396))))) true)))
...
(assert (<= (int__content static_discr__search_array__result4) (to_rep1 (last6 (rt3 a)))))
(assert (not (= (int__content static_discr__search_array__result4) 0)))
(assert (not (<= (int__content static_discr__search_array__result4) (to_rep1 (last6 (rt3 a))))))
(check-sat)
(exit)
