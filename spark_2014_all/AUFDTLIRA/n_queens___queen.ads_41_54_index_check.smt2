...
(assert (in_range1 i))
(assert (and (and (not (= done__ true)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 i)) (= (to_rep (select c j3)) (to_rep (select b j3)))))) (=> (< 1 i) (= (consistent b (- i 1)) true))))
(assert (or (and (and (and (= done__2 done__4) (= b2 b3)) (and (= done__5 done__2) (= b4 b2))) (and (and (= result (consistent b i)) (= (= result true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 i)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- i1 1))) (and (and (not (= (to_rep (select b i1)) (to_rep (select b j3)))) (not (= (- i1 j3) (- (to_rep (select b i1)) (to_rep (select b j3)))))) (not (= (- i1 j3) (- (to_rep (select b j3)) (to_rep (select b i1)))))))))))) (and (= result true) (ite (= 8 i) (and (and (= (mk_bool__ref result1) (mk_bool__ref done__)) (= done__2 (of_int 1))) (and (= b2 b) (= b2 b1))) (and (and (and (= o5 (+ i 1)) (in_range1 (+ i 1))) (and (ite (= done__3 true) (= (consistent b2 8) true) (not (= (consistent c 8) true))) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- o5 1))) (= (to_rep (select b2 j3)) (to_rep (select b j3))))))) (= done__2 done__3)))))) (and (and (and (= result (consistent b i)) (= (= result true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 i)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- i1 1))) (and (and (not (= (to_rep (select b i1)) (to_rep (select b j3)))) (not (= (- i1 j3) (- (to_rep (select b i1)) (to_rep (select b j3)))))) (not (= (- i1 j3) (- (to_rep (select b j3)) (to_rep (select b i1)))))))))))) (and (not (= result true)) (and (and (not (= (consistent c i) true)) (not (forall ((j3 Int)) (=> (and (<= i j3) (<= j3 8)) (= (consistent c j3) true))))) (and (and (= done__2 done__) (= b2 b)) (and (= done__2 done__1) (= b2 b1)))))) (and (and (= done__2 done__4) (= b2 b3)) (and (= done__5 done__2) (= b4 b2))))))
