...
(assert (=> (not (= first_available1 0)) (and (= o53 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o53))))
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o53) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o52 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o52)))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (= result11 (ite (= o52 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result12 true)) (= result11 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o54 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o54))))
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o54 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (and (= o50 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o50)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (= result13 (ite (< 0 o50) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (and (= o49 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range7 o49))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (= result10 (ite (= o49 first_allocated1) true false))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (not (= result13 true)) (= result10 false)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (and (= o51 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o51)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (= result10 (ite (= o51 0) true false)))))
...
(assert (and (= o48 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 o48)))
(assert (= result15 (ite (in_range4 o48) true false)))
...
(assert (=> (= result16 true) (and (= o46 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (= result16 true) (and (= o47 (get (rec__list_allocator__m__t__available model____split_fields3) o46)) (in_range7 o47))))
(assert (=> (not (= result16 true)) (= o47 0)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
