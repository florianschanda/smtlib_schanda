...
(assert (=> (= result43 true) (and (= o139 (+ j11 1)) (in_range1 (+ j11 1)))))
(assert (=> (= result43 true) (and (= o140 (get (rec__list_allocator__m__t__available model____split_fields4) o139)) (in_range7 o140))))
(assert (=> (not (= result43 true)) (= o140 0)))
(assert (not (<= 1 j11)))
(check-sat)
(exit)
