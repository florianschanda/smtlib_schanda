...
(assert (forall ((a1 us_t)) (! (=> (and (dynamic_invariant1 a1 true true true true) (< 0 (length a1))) (dynamic_invariant1 (remove_last a1) true false true true)) :pattern ((remove_last a1)))))
(assert (forall ((a1 us_t)) (! (=> (dynamic_invariant1 a1 true true true true) (= (remove_last a1) (let ((temp___189 (let ((temp___188 (- (last1 a1) 1))) (let ((temp___187 (first1 a1))) (of_array1 (to_array a1) temp___187 temp___188))))) (of_array (to_array1 temp___189) (first3 temp___189) (last3 temp___189))))) :pattern ((remove_last a1)))))
