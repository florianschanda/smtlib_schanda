...
(define-fun dynamic_invariant2 ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= 0 2147483647)) (in_range2 temp___expr_152)))
...
(define-fun t17s__ref___projection ((a1 t17s__ref)) integer (t17s__content a1))
(declare-sort t1 0)
...
(define-fun t18s__ref___projection ((a1 t18s__ref)) us_t1 (t18s__content a1))
(assert (forall ((a1 us_t)) (! (=> (and (dynamic_invariant1 a1 true true true) (< 0 (length a1))) (dynamic_invariant1 (remove_last a1) true false true)) :pattern ((remove_last a1)))))
(assert (forall ((a1 us_t)) (! (=> (dynamic_invariant1 a1 true true true) (= (remove_last a1) (let ((temp___164 (let ((temp___163 (- (last1 a1) 1))) (let ((temp___162 (first1 a1))) (of_array1 (to_array a1) temp___162 temp___163))))) (of_array (to_array1 temp___164) (first3 temp___164) (last3 temp___164))))) :pattern ((remove_last a1)))))
(define-fun dynamic_invariant3 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 2147483646)) (in_range1 temp___expr_136)))
(declare-const perm__occ__result Int)
(declare-const o Int)
(declare-const result Int)
(declare-const perm__occ__result1 Int)
(declare-const perm__occ__result2 Int)
(declare-const perm__occ__result3 Int)
(declare-const perm__occ__result4 Int)
(declare-const perm__occ__result5 Int)
(declare-const result1 Int)
(assert (dynamic_invariant1 a true false true))
(assert (in_range e))
(assert (= perm__occ__result1 perm__occ__result2))
(assert (= perm__occ__result3 perm__occ__result1))
(assert (and (= o (occ_def a e)) (and (in_range2 o) (and (= o (ite (= (length a) 0) 0 (ite (= (to_rep (select (elts a) (to_rep (last (rt a))))) e) (+ (occ_def (remove_last a) e) 1) (occ_def (remove_last a) e)))) (<= o (length a))))))
(assert (= (mk_int__ref result) (mk_int__ref perm__occ__result)))
(assert (= perm__occ__result1 o))
(assert (= (mk_int__ref perm__occ__result4) (mk_int__ref perm__occ__result2)))
(assert (= perm__occ__result5 perm__occ__result3))
(assert (= result1 perm__occ__result4))
(assert (not (<= perm__occ__result4 (length a))))
(check-sat)
(exit)
