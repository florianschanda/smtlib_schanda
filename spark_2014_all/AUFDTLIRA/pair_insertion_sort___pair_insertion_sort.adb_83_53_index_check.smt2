...
(assert (and (<= (to_rep a__first) temp___293) (<= temp___293 (to_rep a__last))))
(assert (= o19 temp___293))
(assert (= o20 (select a2 o19)))
...
(assert (and (= temp___292 (+ j2 1)) (in_range1 (+ j2 1))))
(assert (not (<= (to_rep a__first) temp___292)))
(check-sat)
(exit)
