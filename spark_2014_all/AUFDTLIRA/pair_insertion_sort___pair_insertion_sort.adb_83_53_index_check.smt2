...
(assert (= (sorted (mk___t o26 (mk (to_rep a__first) (to_rep a__last))) 0 (- j2 1)) true))
(assert (= (sorted (mk___t o26 (mk (to_rep a__first) (to_rep a__last))) (+ j2 2) (+ i1 1)) true))
(assert (=> (< 0 j2) (<= (to_rep (select o26 (- j2 1))) (to_rep (select o26 (+ j2 2))))))
(assert (< x2 (to_rep (select o26 (+ j2 2)))))
(assert (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o26 (mk (to_rep a__first) (to_rep a__last)))) true))
(assert (or (and (= (to_rep (select o26 j2)) x2) (= (to_rep (select o26 (+ j2 1))) y2)) (and (= (to_rep (select o26 j2)) y2) (= (to_rep (select o26 (+ j2 1))) x2))))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j2)) (= (to_rep a__first) 0)))
(assert (and (= temp___294 (+ j2 1)) (in_range1 (+ j2 1))))
(assert (and (<= (to_rep a__first) temp___294) (<= temp___294 (to_rep a__last))))
(assert (= o19 temp___294))
(assert (= o20 (select o26 o19)))
(assert (= o21 (to_rep o20)))
(assert (= o22 (ite (= o21 x2) true false)))
(assert (and (<= (to_rep a__first) j2) (<= j2 (to_rep a__last))))
(assert (= o16 j2))
(assert (= o17 (select o26 o16)))
(assert (= o18 (to_rep o17)))
(assert (= o23 (ite (= o18 y2) true false)))
(assert (= o24 (ite (= o23 true) o22 false)))
(assert (and (= temp___293 (+ j2 1)) (in_range1 (+ j2 1))))
(assert (not (<= temp___293 (to_rep a__last))))
(check-sat)
(exit)
