...
(assert (and (= temp___263 (+ j3 1)) (in_range1 (+ j3 1))))
(assert (and (<= (to_rep a__first) temp___263) (<= temp___263 (to_rep a__last))))
(assert (= o31 temp___263))
(assert (= o32 (select a3 o31)))
(assert (= o33 (to_rep o32)))
(assert (= o34 (ite (= o33 x3) true false)))
(assert (and (<= (to_rep a__first) j3) (<= j3 (to_rep a__last))))
(assert (= o28 j3))
(assert (= o29 (select a3 o28)))
(assert (= o30 (to_rep o29)))
(assert (= o35 (ite (= o30 y3) true false)))
(assert (= o36 (ite (= o35 true) o34 false)))
(assert (and (= temp___262 (+ j3 1)) (in_range1 (+ j3 1))))
(assert (not (<= (to_rep a__first) temp___262)))
(check-sat)
(exit)
