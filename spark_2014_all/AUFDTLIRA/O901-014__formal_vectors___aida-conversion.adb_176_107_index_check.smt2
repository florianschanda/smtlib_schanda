...
(assert (forall ((j2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j2) (<= j2 i5)) (= (is_digit (to_rep (select (elts source) j2))) true))))
(assert (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (to_rep1 (last (rt source)))) (dynamic_property1 (+ (to_rep1 (first (rt source))) 1) (to_rep1 (last (rt source))) i5)) (=> (<= (- 2147483648) 2147483647) (in_range1 target6))) (and (<= (+ (to_rep1 (first (rt source))) 1) i5) (<= i5 (to_rep1 (last (rt source)))))))
(assert (and (= o7 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (= o8 (ite (<= o7 j) true false)))
(assert (= result11 (ite (= o8 true) (ite (<= j i5) true false) false)))
