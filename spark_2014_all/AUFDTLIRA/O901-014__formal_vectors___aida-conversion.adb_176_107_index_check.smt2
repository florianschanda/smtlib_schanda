...
(assert (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j1) (<= j1 i2)) (= (is_digit (to_rep (select (elts source) j1))) true))))
...
(assert (= result3 (ite (= o8 true) (ite (<= j i2) true false) false)))
(assert (= result3 true))
