...
(define-fun dynamic_invariant2 ((temp___expr_147 us_rep) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (= temp___do_toplevel_146 true) (=> (= temp___is_init_144 true) (< 0 (id (to_rep (rec__dic_pred__t__f (us_split_fields1 temp___expr_147))))))))
(define-fun default_initial_assumption ((temp___expr_149 us_rep) (temp___skip_top_level_150 Bool)) Bool (and (= (to_rep (rec__dic_pred__t__f (us_split_fields1 temp___expr_149))) 0) (=> (not (= temp___skip_top_level_150 true)) (< 0 (get temp___expr_149)))))
(define-fun dynamic_predicate ((temp___152 us_rep)) Bool (< 0 (id (to_rep (rec__dic_pred__t__f (us_split_fields1 temp___152))))))
...
(define-fun default_initial_assumption1 ((temp___expr_158 us_rep1) (temp___skip_top_level_159 Bool)) Bool (and (= (to_rep (rec__dic_pred__s__f (us_split_fields3 temp___expr_158))) c) (=> (not (= temp___skip_top_level_159 true)) (<= 0 c))))
...
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq2 a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep (select a (+ i 1))) (to_rep (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep (select b (+ i 1))) (to_rep (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (to_rep (rec__containers__container__c (us_split_discrs1 a))) (to_rep (rec__containers__container__c (us_split_discrs1 b)))) (= (to_rep (rec__containers__container__l (us_split_fields5 a))) (to_rep (rec__containers__container__l (us_split_fields5 b))))) (= (bool_eq3 (rec__containers__container__v (us_split_fields5 a)) (rec__containers__container__v (us_split_fields5 b))) true)) true false))
...
(define-fun of_base ((r us_rep2)) us_rep3 (mk___rep3 (us_split_discrs1 r) (mk___split_fields3 (rec__containers__container__l (us_split_fields5 r)) (let ((temp___133 (rec__containers__container__v (us_split_fields5 r)))) (to_array temp___133)))))
(define-fun bool_eq5 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep (rec__containers__container__c (us_split_discrs2 a))) (to_rep (rec__containers__container__c (us_split_discrs2 b)))) (= (to_rep (rec__containers__container__l1 (us_split_fields7 a))) (to_rep (rec__containers__container__l1 (us_split_fields7 b))))) (= (bool_eq2 (rec__containers__container__v1 (us_split_fields7 a)) 1 10 (rec__containers__container__v1 (us_split_fields7 b)) 1 10) true)) true false))
...
(assert (= c (id 0)))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant2 x true true true) (dynamic_invariant (get x) true false true)) :pattern ((get x)))))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant2 x true true true) (= (get x) (id (to_rep (rec__dic_pred__t__f (us_split_fields1 x)))))) :pattern ((get x)))))
(define-fun dynamic_invariant3 ((temp___expr_169 us_rep2) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool)) Bool (let ((temp___170 (rec__containers__container__c (us_split_discrs1 temp___expr_169)))) (and (dynamic_property1 1 (to_rep temp___170) (first1 (rec__containers__container__v (us_split_fields5 temp___expr_169))) (last1 (rec__containers__container__v (us_split_fields5 temp___expr_169)))) (and (= (first1 (rec__containers__container__v (us_split_fields5 temp___expr_169))) 1) (= (last1 (rec__containers__container__v (us_split_fields5 temp___expr_169))) (to_rep temp___170))))))
(assert (forall ((x us_rep2)) (! (=> (dynamic_invariant3 x true true true) (dynamic_invariant1 (length1 x) true false true)) :pattern ((length1 x)))))
(assert (forall ((x us_rep2)) (! (=> (dynamic_invariant3 x true true true) (= (length1 x) (to_rep (rec__containers__container__l (us_split_fields5 x))))) :pattern ((length1 x)))))
