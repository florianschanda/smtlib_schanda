...
(assert (and (= o11 v) (in_range1 v)))
(assert (and (= temp___1601 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o11)) (and (dynamic_invariant3 temp___1601 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1601 o11))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1601 o11)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o11)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1601 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1601 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1601 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1601 i1))) true) (not (= i1 o11))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1601 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1601 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1601 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1601 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1601 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1601 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1601 j)))) true)) (= j i1))))))))))))))
(assert (= o12 (select temp___1601 i)))
(assert (= o13 (us_split_fields1 o12)))
(assert (= result2 (rec__tree_model__path_type__k o13)))
(assert (=> (= result2 true) (and (= o4 v) (in_range1 v))))
(assert (=> (= result2 true) (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true)))
(assert (=> (= result2 true) (and (= o5 v) (in_range1 v))))
(assert (=> (= result2 true) (and (= temp___1602 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o5)) (and (dynamic_invariant3 temp___1602 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1602 o5))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1602 o5)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o5)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1602 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1602 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1602 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1602 i1))) true) (not (= i1 o5))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1602 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1602 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1602 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1602 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1602 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1602 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1602 j)))) true)) (= j i1)))))))))))))))
(assert (=> (= result2 true) (= o6 (select temp___1602 i))))
(assert (=> (= result2 true) (= o7 (us_split_fields1 o6))))
(assert (=> (= result2 true) (= o8 (rec__tree_model__path_type__a o7))))
(assert (=> (= result2 true) (and (= o9 (length o8)) (and (in_range5 o9) (<= (+ 0 o9) 2147483647)))))
...
(assert (= temp___1605 (to_rep o3)))
(assert (not (<= 1 temp___1605)))
(check-sat)
(exit)
