...
(assert (= o79 v))
(assert (= o80 (select f__split_fields1 o79)))
(assert (= o81 (us_split_fields3 o80)))
(assert (= o82 (rec__binary_trees__cell__parent o81)))
(assert (= temp___1559 (to_rep o82)))
(assert (not (<= 1 temp___1559)))
(check-sat)
(exit)
