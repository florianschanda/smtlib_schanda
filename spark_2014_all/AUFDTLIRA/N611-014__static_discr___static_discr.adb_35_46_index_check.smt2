...
(assert (and (and (and (<= 1 (to_rep (rec__static_discr__holder__length1 current__split_fields8))) (<= (to_rep (rec__static_discr__holder__length1 current__split_fields8)) (to_rep (rec__static_discr__holder__length1 (us_split_fields9 a))))) (= (bool_eq (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 a)))) 1 100 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields8))) 1 100) true)) (forall ((i1 Int)) (=> (and (<= (+ (to_rep (rec__static_discr__holder__length1 current__split_fields8)) 1) i1) (<= i1 (to_rep (rec__static_discr__holder__length1 (us_split_fields9 a))))) (not (= (to_rep (select (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 a)))) i1)) e))))))
