...
(assert (forall ((temp___173 Int)) (=> (dynamic_invariant temp___173 true true true true) (forall ((temp___174 Int)) (= (to_rep1 (select (pack__an22__my_a__aggregate_def temp___173) temp___174)) temp___173)))))
