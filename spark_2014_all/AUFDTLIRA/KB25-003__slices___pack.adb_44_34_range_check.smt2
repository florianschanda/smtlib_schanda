...
(assert (forall ((temp___151 Int)) (forall ((temp___152 Int)) (= (select (pack__an22__my_a__aggregate_def temp___151) temp___152) (of_rep1 temp___151)))))
...
(declare-const temp___477 (Array Int character))
