...
(assert (forall ((x index_type)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x index_type)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((i size_type)) (and (<= 0 (size_typeqtint i)) (<= (size_typeqtint i) 65536))))
...
(assert (forall ((x size_type)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x size_type)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__bounded_strings__bounded_string__bound (us_split_discrs1 a))) (to_rep2 (rec__bounded_strings__bounded_string__bound (us_split_discrs1 b)))) (and (= (bool_eq2 (rec__bounded_strings__bounded_string__text (us_split_fields1 a)) (rec__bounded_strings__bounded_string__text (us_split_fields1 b))) true) (= (to_rep3 (rec__bounded_strings__bounded_string__size (us_split_fields1 a))) (to_rep3 (rec__bounded_strings__bounded_string__size (us_split_fields1 b)))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 0 65536)) (in_range4 temp___expr_167)))
(define-fun dynamic_invariant2 ((temp___expr_174 us_rep) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool) (temp___do_typ_inv_173 Bool)) Bool (let ((temp___175 (rec__bounded_strings__bounded_string__bound (us_split_discrs1 temp___expr_174)))) (and (dynamic_property2 1 (to_rep2 temp___175) (first3 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_174))) (last3 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_174)))) (and (= (first3 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_174))) 1) (= (last3 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_174))) (to_rep2 temp___175))))))
(assert (forall ((b us_rep)) (! (=> (dynamic_invariant2 b true true true true) (dynamic_invariant1 (size b) true false true true)) :pattern ((size b)))))
(assert (forall ((b us_rep)) (! (=> (dynamic_invariant2 b true true true true) (= (size b) (to_rep3 (rec__bounded_strings__bounded_string__size (us_split_fields1 b))))) :pattern ((size b)))))
(define-fun dynamic_invariant3 ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 1 65536)) (in_range3 temp___expr_160)))
...
(define-fun bool_eq5 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep2 (rec__bounded_strings__bounded_string__bound (us_split_discrs2 a))) (to_rep2 (rec__bounded_strings__bounded_string__bound (us_split_discrs2 b)))) (and (= (bool_eq4 (rec__bounded_strings__bounded_string__text1 (us_split_fields3 a)) (rec__bounded_strings__bounded_string__text1 (us_split_fields3 b))) true) (= (to_rep3 (rec__bounded_strings__bounded_string__size1 (us_split_fields3 a))) (to_rep3 (rec__bounded_strings__bounded_string__size1 (us_split_fields3 b)))))) true false))
(define-fun in_range5 ((rec__bounded_strings__bounded_string__bound1 Int) (a us_rep)) Bool (= rec__bounded_strings__bounded_string__bound1 (to_rep2 (rec__bounded_strings__bounded_string__bound (us_split_discrs1 a)))))
...
(define-fun default_initial_assumption ((temp___expr_204 us_rep1) (temp___skip_top_level_205 Bool)) Bool (= (to_rep2 (rec__bounded_strings__bounded_string__bound (us_split_discrs2 temp___expr_204))) upper_bound))
...
(declare-fun temp_____aggregate_def_219 (Int Int Int) us_t3)
...
(assert (= (to_rep2 (rec__bounded_strings__bounded_string__bound b__split_discrs)) upper_bound))
...
(assert (= (to_rep1 (first6 (rt3 (temp_____aggregate_def_219 0 1 upper_bound)))) 1))
(assert (= (to_rep1 (last6 (rt3 (temp_____aggregate_def_219 0 1 upper_bound)))) upper_bound))
(assert (= (mk___t3 temp___226 temp___2261) (temp_____aggregate_def_219 0 1 upper_bound)))
...
(assert (not (= (ite (<= (to_rep1 (first8 temp___2311)) (to_rep1 (last8 temp___2311))) (+ (- (to_rep1 (last8 temp___2311)) (to_rep1 (first8 temp___2311))) 1) 0) (ite (<= (to_rep1 (first8 temp___2351)) (to_rep1 (last8 temp___2351))) (+ (- (to_rep1 (last8 temp___2351)) (to_rep1 (first8 temp___2351))) 1) 0))))
(check-sat)
(exit)
