...
(assert (= (mk___t2 o1 o2) (mk___t2 temp___200 temp___2001)))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= b__split_fields2 o5))
(assert (= b__split_discrs (mk___split_discrs temp___203)))
(assert (= temp___2031 o3))
(assert (= temp___2032 o4))
(assert (= temp___2033 o5))
...
(assert (= o6 (elts2 (rec__bounded_strings__bounded_string__text1 b__split_fields3))))
(assert (= o6 temp___208))
(assert (= (mk4 1 temp___206) temp___2081))
(assert (not (= (ite (<= (to_rep1 (first8 temp___2041)) (to_rep1 (last8 temp___2041))) (+ (- (to_rep1 (last8 temp___2041)) (to_rep1 (first8 temp___2041))) 1) 0) (ite (<= (to_rep1 (first8 temp___2081)) (to_rep1 (last8 temp___2081))) (+ (- (to_rep1 (last8 temp___2081)) (to_rep1 (first8 temp___2081))) 1) 0))))
(check-sat)
(exit)
