...
(assert (<= 1 r1))
(assert (<= r1 r323b))
(assert (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r1)))) 2) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 r1)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r1) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r1)) true))))
(assert (forall ((p1 Int)) (=> (and (<= 1 p1) (<= p1 r2)) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 p1)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) p1) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) p1)) true)))))
(assert (and (=> (<= 1 r323b) (dynamic_property 1 r323b r2)) (and (<= 1 r2) (<= r2 r323b))))
(assert (<= 1 p))
(assert (<= p r2))
(assert (not (<= 1 p)))
(check-sat)
