...
(assert (forall ((x us_t)) (! (=> (dynamic_invariant x true true true true) (let ((result (count_even x))) (and (and (<= result (length x)) (=> (= (length x) 0) (= result 0))) (dynamic_invariant1 result true false true true)))) :pattern ((count_even x)))))
