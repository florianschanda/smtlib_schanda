...
(assert (forall ((x us_t)) (! (=> (dynamic_invariant1 x true true true true) (let ((result (count_even x))) (and (and (<= result (length x)) (=> (= (length x) 0) (= result 0))) (dynamic_invariant result true false true true)))) :pattern ((count_even x)))))
