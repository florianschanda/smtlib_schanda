...
(assert (=> (= result2 true) (and (= temp___163 (+ y l1)) (in_range1 (+ y l1)))))
(assert (=> (= result2 true) (and (<= (to_rep (first (rt a))) temp___163) (<= temp___163 (to_rep (last (rt a)))))))
(assert (=> (= result2 true) (= o5 temp___163)))
(assert (=> (= result2 true) (= o6 (select (elts a) o5))))
(assert (=> (= result2 true) (= o7 (to_rep o6))))
(assert (=> (= result2 true) (and (= temp___162 (+ x l1)) (in_range1 (+ x l1)))))
(assert (=> (= result2 true) (and (<= (to_rep (first (rt a))) temp___162) (<= temp___162 (to_rep (last (rt a)))))))
(assert (=> (= result2 true) (= o3 temp___162)))
...
(assert (=> (= result1 true) (and (and (= temp___158 l1) (and (= 0 temp___161) (and (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 (- l2 1))) (= (to_rep (select (elts a) (+ x k2))) (to_rep (select (elts a) (+ y k2)))))) (and (and (=> (<= 0 2147483647) (in_range2 l2)) (and (and (<= (+ x l2) (to_rep (last (rt a)))) (<= (+ y l2) (to_rep (last (rt a))))) (= (to_rep (select (elts a) (+ x l2))) (to_rep (select (elts a) (+ y l2)))))) (and (and (= temp___1611 result4) (= temp___1612 l2)) (and (and (and (= o14 (+ l2 1)) (in_range1 (+ l2 1))) (and (= l2 result5) (= l3 o14))) (and (and (and (and (and (and (= o22 (+ x l3)) (in_range1 (+ x l3))) (= result8 (ite (<= o22 (to_rep (last (rt a)))) true false))) (ite (= result8 true) (and (and (= o21 (+ y l3)) (in_range1 (+ y l3))) (= result7 (ite (<= o21 (to_rep (last (rt a)))) true false))) (= result7 false))) (ite (= result7 true) (and (and (and (and (and (= temp___1631 (+ y l3)) (in_range1 (+ y l3))) (and (and (<= (to_rep (first (rt a))) temp___1631) (<= temp___1631 (to_rep (last (rt a))))) (= o17 temp___1631))) (= o18 (select (elts a) o17))) (= o19 (to_rep o18))) (and (and (and (and (and (= temp___1621 (+ x l3)) (in_range1 (+ x l3))) (and (and (<= (to_rep (first (rt a))) temp___1621) (<= temp___1621 (to_rep (last (rt a))))) (= o15 temp___1621))) (= o16 (select (elts a) o15))) (= o20 (to_rep o16))) (= o23 (ite (= o20 o19) true false)))) (= o23 false))) (= result6 (ite (not (= o23 true)) true false))) (= result6 true)))))))) (and (= l3 l6) (= l7 l3)))))
...
(assert (= l11 l9))
(assert (= (= result10 true) (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 (- lcp__result4 1))) (= (to_rep (select (elts a) (+ x k2))) (to_rep (select (elts a) (+ y k2))))))))
...
(assert (= o24 (+ y lcp__result4)))
(assert (= o25 (select (elts a) o24)))
(assert (= o26 (to_rep o25)))
(assert (not (<= (to_rep (first (rt a))) (+ x lcp__result4))))
(check-sat)
(exit)
