...
(assert (and (forall ((temp___178 Int)) (=> (and (<= (to_rep x__first) temp___178) (<= temp___178 (to_rep x__last))) (=> (<= j2 temp___178) (= (select x1 temp___178) (select x temp___178))))) (and (<= (to_rep x__first) j2) (<= j2 (to_rep x__last)))))
