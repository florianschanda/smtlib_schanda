...
(assert (and (forall ((temp___154 Int)) (=> (and (<= (to_rep x__first) temp___154) (<= temp___154 (to_rep x__last))) (=> (<= j2 temp___154) (= (select x1 temp___154) (select x temp___154))))) (and (<= (to_rep x__first) j2) (<= j2 (to_rep x__last)))))
