...
(assert (and (forall ((temp___180 Int)) (=> (and (<= (to_rep x__first) temp___180) (<= temp___180 (to_rep x__last))) (=> (or (< (to_rep x__last) temp___180) (or (< temp___180 (to_rep x__first)) (<= j2 temp___180))) (= (select x1 temp___180) (select x temp___180))))) (and (<= (to_rep x__first) j2) (<= j2 (to_rep x__last)))))
(assert (not (in_range1 (+ (to_rep (select x1 j2)) j2))))
(check-sat)
(exit)
