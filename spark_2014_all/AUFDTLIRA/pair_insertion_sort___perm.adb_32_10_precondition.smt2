...
(assert (and (= o2 (remove_last r)) (and (dynamic_invariant2 o2 true false true) (and (= (elts r) o) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1))))) o1)))))
