...
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 1 65536)) (in_range temp___expr_158)))
...
(define-fun dynamic_invariant1 ((temp___expr_172 us_rep) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (let ((temp___173 (rec__bounded_strings__bounded_string__bound (us_split_discrs1 temp___expr_172)))) (and (dynamic_property1 1 (to_rep temp___173) (first1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_172))) (last1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_172)))) (and (= (first1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_172))) 1) (= (last1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_172))) (to_rep temp___173))))))
(declare-fun length2 (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant2 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 65536)) (in_range1 temp___expr_165)))
(assert (forall ((source us_rep)) (! (=> (dynamic_invariant1 source true true true true) (dynamic_invariant2 (length2 source) true false true true)) :pattern ((length2 source)))))
(assert (forall ((source us_rep)) (! (=> (dynamic_invariant1 source true true true true) (= (length2 source) (to_rep1 (rec__bounded_strings__bounded_string__length (us_split_fields1 source))))) :pattern ((length2 source)))))
(declare-fun temp___198 (Int Int Int) us_t1)
...
(assert (forall ((temp___200 Int) (temp___201 Int) (temp___202 Int)) (let ((temp___199 (temp___198 temp___200 temp___201 temp___202))) (=> (dynamic_invariant4 temp___200 true true true true) (and (=> (dynamic_property4 1 2147483647 temp___201 temp___202) (and (= (first3 temp___199) temp___201) (= (last3 temp___199) temp___202))) (forall ((temp___203 Int)) (= (to_rep2 (select (to_array1 temp___199) temp___203)) temp___200)))))))
(declare-const temp___197 Int)
(declare-const temp___196 index_type)
(declare-const temp___205 (Array Int character))
(declare-const temp___2051 t1)
(assert (in_range temp___197))
(assert (= temp___197 (to_rep temp___196)))
(assert (= (to_rep3 (first2 (rt1 (temp___198 32 1 temp___197)))) 1))
(assert (= (to_rep3 (last2 (rt1 (temp___198 32 1 temp___197)))) temp___197))
(assert (= (mk___t1 temp___205 temp___2051) (temp___198 32 1 temp___197)))
(assert (not (= (ite (<= (to_rep3 (first2 temp___2051)) (to_rep3 (last2 temp___2051))) (+ (- (to_rep3 (last2 temp___2051)) (to_rep3 (first2 temp___2051))) 1) 0) (ite (<= 1 temp___197) (+ (- temp___197 1) 1) 0))))
(check-sat)
(exit)
