...
(define-fun dynamic_invariant ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 0 65536)) (in_range1 temp___expr_165)))
...
(define-fun dynamic_invariant2 ((temp___expr_158 Int) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool) (temp___do_typ_inv_157 Bool)) Bool (=> (or (= temp___is_init_154 true) (<= 1 65536)) (in_range temp___expr_158)))
...
(declare-fun temp_____aggregate_def_198 (Int Int Int) us_t1)
...
(assert (forall ((temp___200 Int) (temp___201 Int) (temp___202 Int)) (let ((temp___199 (temp_____aggregate_def_198 temp___200 temp___201 temp___202))) (=> (dynamic_invariant4 temp___200 true true true true) (and (=> (dynamic_property4 1 2147483647 temp___201 temp___202) (and (= (first3 temp___199) temp___201) (= (last3 temp___199) temp___202))) (forall ((temp___203 Int)) (= (to_rep2 (select (to_array1 temp___199) temp___203)) temp___200)))))))
...
(assert (= (to_rep3 (first2 (rt1 (temp_____aggregate_def_198 32 1 temp___197)))) 1))
(assert (= (to_rep3 (last2 (rt1 (temp_____aggregate_def_198 32 1 temp___197)))) temp___197))
(assert (= (mk___t1 temp___205 temp___2051) (temp_____aggregate_def_198 32 1 temp___197)))
