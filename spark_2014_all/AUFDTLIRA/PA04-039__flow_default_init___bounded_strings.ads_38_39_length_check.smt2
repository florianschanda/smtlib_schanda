...
(define-fun dynamic_invariant ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 1 65536)) (in_range temp___expr_135)))
...
(define-fun dynamic_invariant1 ((temp___expr_147 us_rep) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (let ((temp___148 (rec__bounded_strings__bounded_string__bound (us_split_discrs1 temp___expr_147)))) (and (dynamic_property1 1 (to_rep temp___148) (first1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_147))) (last1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_147)))) (and (= (first1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_147))) 1) (= (last1 (rec__bounded_strings__bounded_string__text (us_split_fields1 temp___expr_147))) (to_rep temp___148))))))
(declare-fun length2 (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(define-fun dynamic_invariant2 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 0 65536)) (in_range1 temp___expr_141)))
(assert (forall ((source us_rep)) (! (=> (dynamic_invariant1 source true true true) (dynamic_invariant2 (length2 source) true false true)) :pattern ((length2 source)))))
(assert (forall ((source us_rep)) (! (=> (dynamic_invariant1 source true true true) (= (length2 source) (to_rep1 (rec__bounded_strings__bounded_string__length (us_split_fields1 source))))) :pattern ((length2 source)))))
...
(declare-fun temp___172 (Int Int Int) us_t1)
(assert (forall ((temp___174 Int) (temp___175 Int) (temp___176 Int)) (let ((temp___173 (temp___172 temp___174 temp___175 temp___176))) (and (=> (dynamic_property4 1 2147483647 temp___175 temp___176) (and (= (first3 temp___173) temp___175) (= (last3 temp___173) temp___176))) (forall ((temp___177 Int)) (= (select (to_array1 temp___173) temp___177) (of_rep2 temp___174)))))))
...
(declare-const temp___170 index_type)
(declare-const temp___179 (Array Int character))
(declare-const temp___1791 t1)
(declare-const temp___180 index_type)
(declare-const temp___1801 (Array Int character))
(declare-const temp___1802 t)
(declare-const temp___1803 length_type)
(assert (in_range temp___171))
(assert (= temp___171 (to_rep temp___170)))
(assert (= (to_rep3 (first2 (rt1 (temp___172 32 1 temp___171)))) 1))
(assert (= (to_rep3 (last2 (rt1 (temp___172 32 1 temp___171)))) temp___171))
(assert (= (mk___t1 temp___179 temp___1791) (temp___172 32 1 temp___171)))
(assert (not (= (ite (<= (to_rep3 (first2 temp___1791)) (to_rep3 (last2 temp___1791))) (+ (- (to_rep3 (last2 temp___1791)) (to_rep3 (first2 temp___1791))) 1) 0) (ite (<= 1 temp___171) (+ (- temp___171 1) 1) 0))))
(check-sat)
(exit)
