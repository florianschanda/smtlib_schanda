...
(assert (= o13 values3))
(assert (= o13 temp___1812))
(assert (= (mk1 current3 (to_rep values__last)) temp___1813))
(assert (= temp___1812 o14))
(assert (= (mk (to_rep (first2 temp___1813)) (to_rep (last2 temp___1813))) o15))
...
(assert (=> (not (= smallest3 current3)) (= (let ((temp___151 (temp___141 (mk___t values3 (mk (to_rep values__first) (to_rep values__last))) o17 (to_rep (select values3 smallest3)) smallest3 (to_rep (select values3 o17))))) (bool_eq values4 (to_rep values__first) (to_rep values__last) (elts temp___151) (to_rep (first (rt temp___151))) (to_rep (last (rt temp___151))))) true)))
(assert (=> (= smallest3 current3) (= values4 values3)))
(declare-const j2 Int)
(assert (<= current3 j2))
(assert (<= j2 (to_rep values__last)))
(assert (not (<= (to_rep (select values4 current3)) (to_rep (select values4 j2)))))
(check-sat)
(exit)
