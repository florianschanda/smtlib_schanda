...
(assert (not (= current2 temp___214)))
...
(assert (= o5 values3))
(assert (= o5 temp___2072))
(assert (= (mk1 current3 (to_rep values__last)) temp___2073))
(assert (= temp___2072 o6))
(assert (= (mk (to_rep (first2 temp___2073)) (to_rep (last2 temp___2073))) o7))
...
(assert (=> (not (= smallest3 current3)) (= (let ((temp___174 (temp___164 (mk___t values3 (mk (to_rep values__first) (to_rep values__last))) o9 (to_rep (select values3 smallest3)) smallest3 (to_rep (select values3 o9))))) (bool_eq values4 (to_rep values__first) (to_rep values__last) (elts temp___174) (to_rep (first (rt temp___174))) (to_rep (last (rt temp___174))))) true)))
