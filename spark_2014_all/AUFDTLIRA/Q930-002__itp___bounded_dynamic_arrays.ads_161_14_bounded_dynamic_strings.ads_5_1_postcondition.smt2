...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true true) (dynamic_invariant1 (length2 this) true false true true)) :pattern ((length2 this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true true) (= (length2 this) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length2 this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true true) (let ((result (value this))) (and (and (and (and (= (length result) (length2 this)) (= (first1 result) 1)) (= (last1 result) (length2 this))) (= (< 0 (length2 this)) (not (= (empty this) true)))) (dynamic_invariant result true false true true)))) :pattern ((value this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true true) (= (= (empty this) true) (= (length2 this) 0))) :pattern ((empty this)))))
...
(declare-const temp___1243 (Array Int character))
(declare-const temp___12431 t4)
(declare-const o3 (Array Int character))
(declare-const temp___1245 (Array Int character))
(declare-const temp___12451 t4)
(declare-const temp___1247 (Array Int character))
(declare-const temp___12471 t4)
(declare-const o4 (Array Int character))
(declare-const o5 t1)
(declare-const o6 natural_index)
(declare-const o7 (Array Int character))
(declare-const o8 t1)
(declare-const temp___1250 natural_index)
(declare-const temp___12501 natural_index)
(declare-const temp___12502 (Array Int character))
(declare-const temp___12503 t1)
(declare-const temp___1251 natural_index)
(declare-const temp___12511 natural_index)
(declare-const temp___12512 (Array Int character))
(declare-const temp___12513 t1)
(declare-const o9 natural_index)
(declare-const o10 natural_index)
(declare-const o11 (Array Int character))
(declare-const o12 t1)
(declare-const temp___1253 natural_index)
(declare-const temp___12531 natural_index)
(declare-const temp___12532 (Array Int character))
(declare-const temp___12533 t1)
(declare-const temp___1254 us_rep)
...
(define-fun temp___12534 () us_rep (mk___rep (mk___split_discrs temp___1253) (mk___split_fields temp___12531 (mk___t1 temp___12532 temp___12533))))
(define-fun temp___12504 () us_rep (mk___rep (mk___split_discrs temp___1250) (mk___split_fields temp___12501 (mk___t1 temp___12502 temp___12503))))
(assert (dynamic_invariant3 i52s true false true true))
(assert (dynamic_invariant3 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))) true false true true))
(assert (dynamic_invariant by__ true false true true))
...
(assert (and (= o (length by__)) (in_range1 (length by__))))
(assert (= o1 (+ start o)))
(assert (= o2 (- o1 1)))
(assert (and (= bounded_dynamic_strings__ammend__2__last__assume o2) (in_range5 o2)))
...
(assert (= (slide (elts by__) (to_rep1 (first (rt by__))) start) temp___1243))
(assert (= (mk4 start last8) temp___12431))
...
(assert (= o3 this__split_fields1))
(assert (= o3 temp___1245))
(assert (= (mk4 start last8) temp___12451))
(assert (= (ite (<= (to_rep1 (first8 temp___12431)) (to_rep1 (last9 temp___12431))) (+ (- (to_rep1 (last9 temp___12431)) (to_rep1 (first8 temp___12431))) 1) 0) (ite (<= (to_rep1 (first8 temp___12451)) (to_rep1 (last9 temp___12451))) (+ (- (to_rep1 (last9 temp___12451)) (to_rep1 (first8 temp___12451))) 1) 0)))
(assert (= (mk___t4 temp___1247 temp___12471) (mk___t4 temp___1243 temp___12431)))
(assert (and (and (= (to_rep1 (first2 this__split_fields2)) (to_rep1 (first2 o5))) (= (to_rep1 (last2 this__split_fields2)) (to_rep1 (last2 o5)))) (forall ((temp___1248 Int)) (ite (and (<= start temp___1248) (<= temp___1248 last8)) (= (select o4 temp___1248) (select temp___1247 temp___1248)) (= (select o4 temp___1248) (select this__split_fields1 temp___1248))))))
(assert (= this__split_fields o6))
(assert (= o7 o4))
(assert (= o8 o5))
(assert (= this__split_discrs (mk___split_discrs temp___1250)))
(assert (= temp___12501 o6))
(assert (= temp___12502 o7))
(assert (= temp___12503 o8))
(assert (dynamic_predicate temp___12504))
(assert (= (mk___rep (mk___split_discrs temp___1251) (mk___split_fields temp___12511 (mk___t1 temp___12512 temp___12513))) temp___12504))
...
(assert (= this__split_fields3 (mk___split_fields temp___12511 (mk___t1 temp___12512 temp___12513))))
(assert (= this__split_discrs (mk___split_discrs temp___1251)))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= (to_rep2 o9) last8)))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= o9 o10)))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= (rec__bounded_dynamic_strings__sequence__content this__split_fields3) (mk___t1 o11 o12))))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= this__split_discrs (mk___split_discrs temp___1253))))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= temp___12531 o10)))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= temp___12532 o11)))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= temp___12533 o12)))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (dynamic_predicate temp___12534)))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= temp___1254 temp___12534)))
...
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= this__split_fields4 (us_split_fields1 temp___1254))))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= this__split_discrs (us_split_discrs1 temp___1254))))
