...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true) (dynamic_invariant1 (length2 this) true false true)) :pattern ((length2 this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true) (= (length2 this) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length2 this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true) (let ((result (value this))) (and (and (and (and (= (length result) (length2 this)) (= (first1 result) 1)) (= (last1 result) (length2 this))) (= (< 0 (length2 this)) (not (= (empty this) true)))) (dynamic_invariant result true false true)))) :pattern ((value this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true) (= (value this) (let ((temp___234 (let ((temp___232 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) (let ((temp___231 1)) (let ((temp___233 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this)))) (of_array2 (to_array1 temp___233) temp___231 temp___232)))))) (of_array (to_array2 temp___234) (first5 temp___234) (last5 temp___234))))) :pattern ((value this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant3 this true true true) (= (= (empty this) true) (= (length2 this) 0))) :pattern ((empty this)))))
...
(assert (= last8 (- (+ start (length by__)) 1)))
...
(declare-const bounded_dynamic_strings__ammend__2__last__assume Int)
...
(declare-const temp___1184 (Array Int character))
(declare-const temp___11841 t4)
...
(declare-const temp___1187 natural_index)
(declare-const temp___11871 natural_index)
(declare-const temp___11872 (Array Int character))
(declare-const temp___11873 t1)
(declare-const temp___1188 natural_index)
(declare-const temp___11881 natural_index)
(declare-const temp___11882 (Array Int character))
(declare-const temp___11883 t1)
(declare-const o14 natural_index)
(declare-const o15 natural_index)
(declare-const o16 (Array Int character))
(declare-const o17 t1)
(declare-const temp___1190 natural_index)
(declare-const temp___11901 natural_index)
(declare-const temp___11902 (Array Int character))
(declare-const temp___11903 t1)
(declare-const temp___1191 us_rep)
(declare-const o18 Int)
(declare-const o19 Int)
(declare-const temp___1194 Int)
(declare-const temp___1195 us_t)
...
(assert (dynamic_invariant3 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))) true false true))
(assert (dynamic_invariant by__ true false true))
(assert (in_range5 start))
(assert (and (<= 1 (- (+ start (length by__)) 1)) (<= (- (+ start (length by__)) 1) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity this__split_discrs)))))
(assert (and (= o5 (length by__)) (in_range1 (length by__))))
(assert (= o6 (+ start o5)))
(assert (= o7 (- o6 1)))
(assert (and (= bounded_dynamic_strings__ammend__2__last__assume o7) (in_range5 o7)))
(assert (= bounded_dynamic_strings__ammend__2__last__assume last8))
(assert (in_range5 last8))
(assert (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity this__split_discrs)) r142b))
(assert (in_range4 r142b))
(assert (= (ite (<= (to_rep1 (first (rt by__))) (to_rep1 (last (rt by__)))) (+ (- (to_rep1 (last (rt by__))) (to_rep1 (first (rt by__)))) 1) 0) (ite (<= start last8) (+ (- last8 start) 1) 0)))
(assert (= (slide (elts by__) (to_rep1 (first (rt by__))) start) temp___1180))
(assert (= (mk4 start last8) temp___11801))
(assert (=> (<= start last8) (and (and (<= (to_rep1 (first2 this__split_fields2)) start) (<= start (to_rep1 (last2 this__split_fields2)))) (and (<= (to_rep1 (first2 this__split_fields2)) last8) (<= last8 (to_rep1 (last2 this__split_fields2)))))))
(assert (= o8 this__split_fields1))
(assert (= o8 temp___1182))
(assert (= (mk4 start last8) temp___11821))
(assert (= (ite (<= (to_rep1 (first8 temp___11801)) (to_rep1 (last9 temp___11801))) (+ (- (to_rep1 (last9 temp___11801)) (to_rep1 (first8 temp___11801))) 1) 0) (ite (<= (to_rep1 (first8 temp___11821)) (to_rep1 (last9 temp___11821))) (+ (- (to_rep1 (last9 temp___11821)) (to_rep1 (first8 temp___11821))) 1) 0)))
(assert (= (mk___t4 temp___1184 temp___11841) (mk___t4 temp___1180 temp___11801)))
(assert (and (and (= (to_rep1 (first2 this__split_fields2)) (to_rep1 (first2 o10))) (= (to_rep1 (last2 this__split_fields2)) (to_rep1 (last2 o10)))) (forall ((temp___1185 Int)) (ite (and (<= start temp___1185) (<= temp___1185 last8)) (= (select o9 temp___1185) (select temp___1184 temp___1185)) (= (select o9 temp___1185) (select this__split_fields1 temp___1185))))))
(assert (= this__split_fields o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= this__split_discrs (mk___split_discrs temp___1187)))
(assert (= temp___11871 o11))
(assert (= temp___11872 o12))
(assert (= temp___11873 o13))
(assert (dynamic_predicate (mk___rep (mk___split_discrs temp___1187) (mk___split_fields temp___11871 (mk___t1 temp___11872 temp___11873)))))
(assert (= (mk___rep (mk___split_discrs temp___1188) (mk___split_fields temp___11881 (mk___t1 temp___11882 temp___11883))) (mk___rep (mk___split_discrs temp___1187) (mk___split_fields temp___11871 (mk___t1 temp___11872 temp___11873)))))
(assert (= result (mk___split_fields__ref (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2)))))
(assert (= this__split_fields3 (mk___split_fields temp___11881 (mk___t1 temp___11882 temp___11883))))
(assert (= this__split_discrs (mk___split_discrs temp___1188)))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= (to_rep2 o14) last8)))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= o14 o15)))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= (rec__bounded_dynamic_strings__sequence__content this__split_fields3) (mk___t1 o16 o17))))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= this__split_discrs (mk___split_discrs temp___1190))))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= temp___11901 o15)))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= temp___11902 o16)))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= temp___11903 o17)))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (dynamic_predicate (mk___rep (mk___split_discrs temp___1190) (mk___split_fields temp___11901 (mk___t1 temp___11902 temp___11903))))))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= temp___1191 (mk___rep (mk___split_discrs temp___1190) (mk___split_fields temp___11901 (mk___t1 temp___11902 temp___11903))))))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= result1 (mk___split_fields__ref this__split_fields3))))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= this__split_fields4 (us_split_fields1 temp___1191))))
(assert (=> (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= this__split_discrs (us_split_discrs1 temp___1191))))
(assert (=> (not (< (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8)) (= this__split_fields4 this__split_fields3)))
(assert (= this__split_fields5 (mk___split_fields__ref this__split_fields4)))
(assert (= this__split_fields6 this__split_fields4))
(assert (not (= (bool_eq (elts (value (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (to_rep1 (first6 (mk3 start (- (+ start (length by__)) 1)))) (to_rep1 (last6 (mk3 start (- (+ start (length by__)) 1)))) (elts by__) (to_rep1 (first (rt by__))) (to_rep1 (last (rt by__)))) true)))
(check-sat)
(exit)
