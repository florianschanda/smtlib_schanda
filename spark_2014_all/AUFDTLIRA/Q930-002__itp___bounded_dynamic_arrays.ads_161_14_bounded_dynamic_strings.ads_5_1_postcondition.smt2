...
(declare-const temp___1249 (Array Int character))
(declare-const temp___12491 t4)
(declare-const o3 (Array Int character))
(declare-const temp___1251 (Array Int character))
(declare-const temp___12511 t4)
(declare-const temp___1253 (Array Int character))
(declare-const temp___12531 t4)
(declare-const o4 (Array Int character))
(declare-const o5 t)
(declare-const o6 natural_index)
(declare-const o7 (Array Int character))
(declare-const o8 t)
(declare-const temp___1256 natural_index)
(declare-const temp___12561 natural_index)
(declare-const temp___12562 (Array Int character))
(declare-const temp___12563 t)
(declare-const temp___1257 natural_index)
(declare-const temp___12571 natural_index)
(declare-const temp___12572 (Array Int character))
(declare-const temp___12573 t)
(declare-const o9 natural_index)
(declare-const o10 natural_index)
(declare-const o11 (Array Int character))
(declare-const o12 t)
(declare-const temp___1259 natural_index)
(declare-const temp___12591 natural_index)
(declare-const temp___12592 (Array Int character))
(declare-const temp___12593 t)
...
(define-fun temp___12594 () us_rep (mk___rep (mk___split_discrs temp___1259) (mk___split_fields temp___12591 (mk___t temp___12592 temp___12593))))
(define-fun temp___12564 () us_rep (mk___rep (mk___split_discrs temp___1256) (mk___split_fields temp___12561 (mk___t temp___12562 temp___12563))))
...
(assert (and (<= 1 (- (+ start (length2 by__)) 1)) (<= (- (+ start (length2 by__)) 1) (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity this__split_discrs)))))
(assert (and (= o (length2 by__)) (in_range1 (length2 by__))))
(assert (= o1 (+ start o)))
(assert (= o2 (- o1 1)))
...
(assert (= (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity this__split_discrs)) r142b))
(assert (in_range3 r142b))
(assert (= (ite (<= (to_rep2 (first2 (rt1 by__))) (to_rep2 (last2 (rt1 by__)))) (+ (- (to_rep2 (last2 (rt1 by__))) (to_rep2 (first2 (rt1 by__)))) 1) 0) (ite (<= start last8) (+ (- last8 start) 1) 0)))
(assert (= (slide (elts1 by__) (to_rep2 (first2 (rt1 by__))) start) temp___1249))
(assert (= (mk4 start last8) temp___12491))
(assert (=> (<= start last8) (and (and (<= (to_rep2 (first this__split_fields2)) start) (<= start (to_rep2 (last this__split_fields2)))) (and (<= (to_rep2 (first this__split_fields2)) last8) (<= last8 (to_rep2 (last this__split_fields2)))))))
(assert (= o3 this__split_fields1))
(assert (= o3 temp___1251))
(assert (= (mk4 start last8) temp___12511))
(assert (= (ite (<= (to_rep2 (first8 temp___12491)) (to_rep2 (last9 temp___12491))) (+ (- (to_rep2 (last9 temp___12491)) (to_rep2 (first8 temp___12491))) 1) 0) (ite (<= (to_rep2 (first8 temp___12511)) (to_rep2 (last9 temp___12511))) (+ (- (to_rep2 (last9 temp___12511)) (to_rep2 (first8 temp___12511))) 1) 0)))
(assert (= (mk___t4 temp___1253 temp___12531) (mk___t4 temp___1249 temp___12491)))
(assert (and (and (= (to_rep2 (first this__split_fields2)) (to_rep2 (first o5))) (= (to_rep2 (last this__split_fields2)) (to_rep2 (last o5)))) (forall ((temp___1254 Int)) (ite (and (<= start temp___1254) (<= temp___1254 last8)) (= (select o4 temp___1254) (select temp___1253 temp___1254)) (= (select o4 temp___1254) (select this__split_fields1 temp___1254))))))
(assert (= this__split_fields o6))
(assert (= o7 o4))
(assert (= o8 o5))
(assert (= this__split_discrs (mk___split_discrs temp___1256)))
(assert (= temp___12561 o6))
(assert (= temp___12562 o7))
(assert (= temp___12563 o8))
(assert (dynamic_predicate temp___12564))
(assert (= (mk___rep (mk___split_discrs temp___1257) (mk___split_fields temp___12571 (mk___t temp___12572 temp___12573))) temp___12564))
(assert (= result (mk___split_fields__ref (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2)))))
(assert (= this__split_fields3 (mk___split_fields temp___12571 (mk___t temp___12572 temp___12573))))
(assert (= this__split_discrs (mk___split_discrs temp___1257)))
(assert (=> (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= (to_rep1 o9) last8)))
(assert (=> (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= o9 o10)))
(assert (=> (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= (rec__bounded_dynamic_strings__sequence__content this__split_fields3) (mk___t o11 o12))))
(assert (=> (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= this__split_discrs (mk___split_discrs temp___1259))))
(assert (=> (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= temp___12591 o10)))
(assert (=> (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= temp___12592 o11)))
(assert (=> (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= temp___12593 o12)))
(assert (=> (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (dynamic_predicate temp___12594)))
(assert (=> (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= temp___1260 temp___12594)))
(assert (=> (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= result1 (mk___split_fields__ref this__split_fields3))))
(assert (=> (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= this__split_fields4 (us_split_fields1 temp___1260))))
(assert (=> (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8) (= this__split_discrs (us_split_discrs1 temp___1260))))
(assert (=> (not (< (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3)) last8)) (= this__split_fields4 this__split_fields3)))
(assert (= this__split_fields5 (mk___split_fields__ref this__split_fields4)))
(assert (= this__split_fields6 this__split_fields4))
(assert (< (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2)))) (- (+ start (length2 by__)) 1)))
(assert (not (= (length1 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5))) (- (+ start (length2 by__)) 1))))
(check-sat)
(exit)
