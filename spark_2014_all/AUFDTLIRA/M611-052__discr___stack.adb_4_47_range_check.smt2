...
(define-fun dynamic_invariant4 ((temp___expr_153 us_t1) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (not (= temp___skip_constant_151 true)) (dynamic_property2 1 2147483647 (first3 temp___expr_153) (last3 temp___expr_153))))
(declare-const o (Array Int integer))
(declare-const temp___231 (Array Int integer))
(declare-const temp___2311 t2)
...
(assert (= o temp___231))
(assert (= (mk2 1 (to_rep (rec__stack__stack__top (us_split_fields1 s)))) temp___2311))
(assert (not (dynamic_property2 1 2147483647 (to_rep1 (first4 temp___2311)) (to_rep1 (last4 temp___2311)))))
(check-sat)
(exit)
