...
(define-fun dynamic_invariant ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 0 1)) (in_range1 temp___expr_160)))
...
(define-fun dynamic_invariant1 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_167)))
...
(assert (and (dynamic_invariant2 (mk___rep s__split_discrs (mk___split_fields s__split_fields4 (mk___t s__split_fields5 s__split_fields6) s__split_fields7) s__attr__tag) true true true true) (in_range1 mystate1)))
