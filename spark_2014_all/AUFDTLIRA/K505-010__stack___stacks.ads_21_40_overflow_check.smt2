...
(define-fun dynamic_invariant ((temp___expr_137 Int) (temp___is_init_134 Bool) (temp___skip_constant_135 Bool) (temp___do_toplevel_136 Bool)) Bool (=> (or (= temp___is_init_134 true) (<= 0 1)) (in_range1 temp___expr_137)))
...
(define-fun dynamic_invariant1 ((temp___expr_143 Int) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (=> (or (= temp___is_init_140 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_143)))
...
(assert (forall ((x element)) (! (in_range2 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun bool_eq ((a (Array Int element)) (a__first Int) (a__last Int) (b (Array Int element)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep3 (select a temp___idx_133)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_133))))))) true false))
(assert (forall ((a (Array Int element)) (b (Array Int element))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep3 (select a temp___idx_133)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_133)))))))))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__stacks__stack__max (us_split_discrs1 a))) (to_rep1 (rec__stacks__stack__max (us_split_discrs1 b)))) (= (to_rep (rec__stacks__stack__top (us_split_fields1 a))) (to_rep (rec__stacks__stack__top (us_split_fields1 b))))) (= (bool_eq1 (rec__stacks__stack__data (us_split_fields1 a)) (rec__stacks__stack__data (us_split_fields1 b))) true)) true false))
...
(assert (and (dynamic_invariant2 (mk___rep s__split_discrs (mk___split_fields s__split_fields4 (mk___t s__split_fields5 s__split_fields6) s__split_fields7) s__attr__tag) true true true) (in_range1 mystate1)))
(assert (not (in_range (+ (size (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2) s__split_fields3) s__attr__tag)) 1))))
(check-sat)
(exit)
