...
(declare-const temp___9425 (Array Int us_rep))
(declare-const temp___94251 Bool)
(declare-const temp___94252 enum1t)
...
(declare-const temp___9432 (Array Int us_rep))
(declare-const temp___94321 Bool)
(declare-const temp___94322 enum1t)
...
(assert (= temp___9425 o6))
(assert (= temp___94251 o7))
(assert (= temp___94252 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= temp___9425 r__split_fields3))
(assert (= temp___94251 r__split_fields4))
(assert (= temp___94252 r__split_fields5))
...
(assert (= temp___9432 o15))
(assert (= temp___94321 o16))
(assert (= temp___94322 o17))
(assert (= result6 r__split_fields6))
(assert (= result7 r__split_fields7))
(assert (= result8 r__split_fields8))
(assert (= r__split_fields9 (mk___split_fields1 temp___9432 temp___94321 temp___94322)))
