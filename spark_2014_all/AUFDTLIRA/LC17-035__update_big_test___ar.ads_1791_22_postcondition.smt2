...
(define-fun dynamic_invariant3 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 6)) (in_range4 temp___expr_200)))
...
(declare-const temp___9366 (Array Int us_rep))
(declare-const temp___93661 Bool)
(declare-const temp___93662 enum1t)
...
(declare-const temp___9373 (Array Int us_rep))
(declare-const temp___93731 Bool)
(declare-const temp___93732 enum1t)
...
(assert (= temp___9366 o6))
(assert (= temp___93661 o7))
(assert (= temp___93662 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= temp___9366 r__split_fields3))
(assert (= temp___93661 r__split_fields4))
(assert (= temp___93662 r__split_fields5))
...
(assert (= temp___93731 o16))
(assert (= temp___93732 o17))
(assert (= result6 r__split_fields6))
(assert (= result7 r__split_fields7))
(assert (= result8 r__split_fields8))
(assert (= r__split_fields9 (mk___split_fields1 temp___9373 temp___93731 temp___93732)))
...
(assert (<= n 10))
(assert (not (= n i)))
(assert (not (= (bool_eq (select (rec__ar__rofaofr1__a1 (us_split_fields__content1 r__split_fields10)) n) (select r__split_fields n)) true)))
(check-sat)
(exit)
