...
(assert (and (= o2 (length3 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) (and (in_range10 o2) (<= o2 (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))))))
...
(assert (= result1 true))
(assert (and (= o (length3 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) (and (in_range10 o) (<= o (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))))))
(assert (= o1 (- o 1)))
