...
(assert (= i6 i))
(assert (= t__split_fields7 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))
(assert (= i6 i5))
(assert (= t__split_fields7 t__split_fields4))
(assert (= result5 (mk_int__ref current)))
(assert (= current2 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))))
(assert (in_range4 current2))
(assert (= result6 (mk_int__ref previous)))
(assert (= previous2 0))
(assert (in_range4 previous2))
(assert (= result7 (mk_int__ref d)))
(assert (= d5 0))
(assert (in_range5 d5))
(assert (=> (not (= current2 0)) (= temp___718 current2)))
(assert (=> (not (= current2 0)) (= temp___717 i6)))
(assert (=> (not (= current2 0)) (= temp___716 d5)))
(assert (=> (not (= current2 0)) (= temp___715 previous2)))
(assert (=> (not (= current2 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) current3))) true)))
(assert (=> (not (= current2 0)) (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) current3)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) current3))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20))) (< (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20)) v))))))))
(assert (=> (not (= current2 0)) (and (and (and (and (=> (<= 0 100) (in_range4 previous3)) (=> (<= 0 1) (in_range5 d6))) (=> (<= 0 100) (in_range4 i7))) (=> (<= 0 100) (in_range4 current3))) (not (= current3 0)))))
(assert (=> (not (= current2 0)) (= result10 (mk_int__ref previous3))))
(assert (=> (not (= current2 0)) (= previous4 current3)))
(assert (=> (not (= current2 0)) (and (<= 1 previous4) (<= previous4 100))))
(assert (=> (not (= current2 0)) (= o38 previous4)))
(assert (=> (not (= current2 0)) (= o39 (select (rec__search_trees__search_tree__values t__split_fields7) o38))))
(assert (=> (not (= current2 0)) (= o40 (to_rep o39))))
(assert (=> (not (= current2 0)) (= result11 (ite (= v o40) true false))))
(assert (=> (not (= current2 0)) (=> (= result11 true) (= result12 (mk_int__ref i7)))))
(assert (=> (not (= current2 0)) (=> (= result11 true) (= i8 0))))
(assert (=> (not (= current2 0)) (=> (= result11 true) (exists ((i20 Int)) (and (and (<= 1 i20) (<= i20 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 t__split_fields7)) i20))) true) (= (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20)) v)))))))
(assert (=> (not (= current2 0)) (=> (= result11 true) (= (contains1 (mk___rep3 t__split_fields7) v) true))))
(assert (=> (not (= current2 0)) (not (= result11 true))))
(assert (=> (not (= current2 0)) (=> (= result11 true) (= d7 d6))))
(assert (=> (not (= current2 0)) (=> (not (= result11 true)) (and (<= 1 previous4) (<= previous4 100)))))
(assert (=> (not (= current2 0)) (=> (not (= result11 true)) (= o41 previous4))))
(assert (=> (not (= current2 0)) (=> (not (= result11 true)) (= o42 (select (rec__search_trees__search_tree__values t__split_fields7) o41)))))
(assert (=> (not (= current2 0)) (=> (not (= result11 true)) (= o43 (to_rep o42)))))
(assert (=> (not (= current2 0)) (=> (not (= result11 true)) (= result13 (ite (< v o43) true false)))))
(assert (=> (not (= current2 0)) (=> (not (= result11 true)) (=> (= result13 true) (= result14 (mk_int__ref d6))))))
(assert (=> (not (= current2 0)) (=> (not (= result11 true)) (=> (= result13 true) (= d7 0)))))
(assert (=> (not (= current2 0)) (=> (not (= result11 true)) (=> (not (= result13 true)) (= result15 (mk_int__ref d6))))))
(assert (=> (not (= current2 0)) (=> (not (= result11 true)) (=> (not (= result13 true)) (= d8 1)))))
(assert (=> (not (= current2 0)) (=> (not (= result11 true)) (=> (not (= result13 true)) (= d7 d8)))))
(assert (=> (not (= current2 0)) (=> (not (= result11 true)) (= i8 i7))))
(assert (=> (not (= current2 0)) (and (= o44 previous4) (in_range3 previous4))))
(assert (=> (not (= current2 0)) (and (= o45 (peek (rec__search_trees__search_tree__struct t__split_fields7) o44 d7)) (and (in_range4 o45) (and (ite (not (= o45 0)) (and (= (position (rec__search_trees__search_tree__struct t__split_fields7) o45) d7) (= (parent (rec__search_trees__search_tree__struct t__split_fields7) o45) o44)) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (= (parent (rec__search_trees__search_tree__struct t__split_fields7) j10) o44) (not (= (position (rec__search_trees__search_tree__struct t__split_fields7) j10) d7)))))) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct t__split_fields7) j10) o44) (= (position (rec__search_trees__search_tree__struct t__split_fields7) j10) d7)) (= o45 j10)))))))))
(assert (=> (not (= current2 0)) (= result16 (mk_int__ref current3))))
(assert (=> (not (= current2 0)) (= current4 o45)))
(assert (=> (not (= current2 0)) (= current4 0)))
(assert (=> (not (= current2 0)) (= d9 (mk_int__ref d7))))
(assert (=> (not (= current2 0)) (= previous5 (mk_int__ref previous4))))
(assert (=> (not (= current2 0)) (= current5 (mk_int__ref current4))))
(assert (=> (not (= current2 0)) (= i9 (mk_int__ref i8))))
(assert (=> (not (= current2 0)) (= d10 d7)))
(assert (=> (not (= current2 0)) (= previous6 previous4)))
(assert (=> (not (= current2 0)) (= current6 current4)))
(assert (=> (not (= current2 0)) (= i10 i8)))
(assert (=> (not (= current2 0)) (= d11 d9)))
(assert (=> (not (= current2 0)) (= previous7 previous5)))
(assert (=> (not (= current2 0)) (= current7 current5)))
(assert (=> (not (= current2 0)) (= i11 i9)))
(assert (=> (not (= current2 0)) (= d12 d10)))
(assert (=> (not (= current2 0)) (= previous8 previous6)))
(assert (=> (not (= current2 0)) (= current8 current6)))
(assert (=> (not (= current2 0)) (= i12 i10)))
(assert (=> (= current2 0) (= d11 (mk_int__ref d5))))
(assert (=> (= current2 0) (= previous7 (mk_int__ref previous2))))
(assert (=> (= current2 0) (= current7 (mk_int__ref current2))))
(assert (=> (= current2 0) (= i11 (mk_int__ref i6))))
(assert (=> (= current2 0) (= d12 d5)))
(assert (=> (= current2 0) (= previous8 previous2)))
(assert (=> (= current2 0) (= current8 current2)))
(assert (=> (= current2 0) (= i12 i6)))
(assert (and (= o46 (int__content previous7)) (in_range3 (int__content previous7))))
(assert (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields7) (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) i20))) true) (not (= (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20)) v))))))
(assert (and (= o48 (int__content previous7)) (in_range3 (int__content previous7))))
(assert (not (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7)))))
(check-sat)
(exit)
