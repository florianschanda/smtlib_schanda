...
(assert (= i2 i))
(assert (= t__split_fields5 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))
(assert (= i2 i1))
...
(assert (= d1 0))
(assert (in_range5 d1))
(assert (=> (not (= current1 0)) (= temp___718 current1)))
(assert (=> (not (= current1 0)) (= temp___717 i2)))
(assert (=> (not (= current1 0)) (= temp___716 d1)))
(assert (=> (not (= current1 0)) (= temp___715 previous1)))
(assert (=> (not (= current1 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) current2))) true)))
(assert (=> (not (= current1 0)) (forall ((i9 Int)) (=> (and (<= 1 i9) (<= i9 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i9))) true) (=> (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i9))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) current2)))) true) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) current2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i9)))) 1)) 0) (< v (to_rep (select (rec__search_trees__search_tree__values t__split_fields5) i9))) (< (to_rep (select (rec__search_trees__search_tree__values t__split_fields5) i9)) v))))))))
(assert (=> (not (= current1 0)) (and (and (and (=> (<= 0 100) (in_range4 previous2)) (=> (<= 0 1) (in_range5 d2))) (=> (<= 0 100) (in_range4 i3))) (=> (<= 0 100) (in_range4 current2)))))
...
(assert (and (= o8 (int__content previous6)) (in_range3 (int__content previous6))))
(assert (forall ((i9 Int)) (=> (and (<= 1 i9) (<= i9 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct t__split_fields5) (to_rep1 (rec__search_trees__search_tree__root t__split_fields5))) i9))) true) (not (= (to_rep (select (rec__search_trees__search_tree__values t__split_fields5) i9)) v))))))
(assert (and (= o9 (int__content previous6)) (in_range3 (int__content previous6))))
(assert (not (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields5)))))
(check-sat)
(exit)
