...
(assert (not (= (int__content i8) (to_rep (rec__patience__state__numstacks s__split_fields10)))))
(assert (and (<= 0 (int__content i8)) (<= (int__content i8) 99)))
(assert (= o45 (int__content i8)))
(assert (= o46 (select (rec__patience__state__stacksizes s__split_fields10) o45)))
(assert (= o47 (to_rep o46)))
(assert (= result11 stackisize6))
(assert (= stackisize8 o47))
(assert (and (= o48 (+ stackisize8 1)) (in_range2 (+ stackisize8 1))))
(assert (= (to_rep o49) o48))
(assert (and (<= 0 (int__content i8)) (<= (int__content i8) 99)))
(assert (= o50 (int__content i8)))
(assert (= o51 (store (rec__patience__state__stacksizes s__split_fields10) o50 o49)))
(assert (= o52 (mk___split_fields (rec__patience__state__numelts s__split_fields10) (rec__patience__state__values s__split_fields10) (rec__patience__state__numstacks s__split_fields10) o51 (rec__patience__state__stacks s__split_fields10) (rec__patience__state__posstack s__split_fields10) (rec__patience__state__posheight s__split_fields10) (rec__patience__state__preds s__split_fields10))))
(assert (= temp___623 (mk___rep o52)))
(assert (= result12 (mk___split_fields__ref s__split_fields10)))
(assert (= s__split_fields11 (us_split_fields1 temp___623)))
(assert (and (= o53 idx1) (in_range2 idx1)))
(assert (= (to_rep o54) o53))
(assert (and (<= 0 stackisize8) (<= stackisize8 99)))
(assert (= o55 stackisize8))
(assert (= o56 (store (select (rec__patience__state__stacks s__split_fields11) (int__content i8)) o55 o54)))
(assert (and (<= 0 (int__content i8)) (<= (int__content i8) 99)))
(assert (= o57 (int__content i8)))
(assert (= o58 (store (rec__patience__state__stacks s__split_fields11) o57 o56)))
(assert (= o59 (mk___split_fields (rec__patience__state__numelts s__split_fields11) (rec__patience__state__values s__split_fields11) (rec__patience__state__numstacks s__split_fields11) (rec__patience__state__stacksizes s__split_fields11) o58 (rec__patience__state__posstack s__split_fields11) (rec__patience__state__posheight s__split_fields11) (rec__patience__state__preds s__split_fields11))))
(assert (= temp___628 (mk___rep o59)))
(assert (= result13 (mk___split_fields__ref s__split_fields11)))
(assert (= s__split_fields12 (us_split_fields1 temp___628)))
(assert (and (= o60 (int__content i8)) (in_range2 (int__content i8))))
(assert (= (to_rep o61) o60))
(assert (not (<= idx1 99)))
(check-sat)
(exit)
