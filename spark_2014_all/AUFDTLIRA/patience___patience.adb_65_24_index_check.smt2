...
(assert (not (= (int__content i14) (to_rep1 (rec__patience__state__numstacks s__split_fields10)))))
(assert (and (<= 0 (int__content i14)) (<= (int__content i14) 99)))
(assert (= o120 (int__content i14)))
(assert (= o121 (select (rec__patience__state__stacksizes s__split_fields10) o120)))
(assert (= o122 (to_rep1 o121)))
(assert (= result25 stackisize6))
(assert (= stackisize8 o122))
(assert (and (= o123 (+ stackisize8 1)) (in_range3 (+ stackisize8 1))))
(assert (= (to_rep1 o124) o123))
(assert (and (<= 0 (int__content i14)) (<= (int__content i14) 99)))
(assert (= o125 (int__content i14)))
(assert (= o126 (store (rec__patience__state__stacksizes s__split_fields10) o125 o124)))
(assert (= o127 (mk___split_fields (rec__patience__state__numelts s__split_fields10) (rec__patience__state__values s__split_fields10) (rec__patience__state__numstacks s__split_fields10) o126 (rec__patience__state__stacks s__split_fields10) (rec__patience__state__posstack s__split_fields10) (rec__patience__state__posheight s__split_fields10) (rec__patience__state__preds s__split_fields10))))
(assert (= temp___593 (mk___rep o127)))
(assert (= result26 (mk___split_fields__ref s__split_fields10)))
(assert (= s__split_fields16 (us_split_fields1 temp___593)))
(assert (and (= o128 idx1) (in_range3 idx1)))
(assert (= (to_rep1 o129) o128))
(assert (and (<= 0 stackisize8) (<= stackisize8 99)))
(assert (= o130 stackisize8))
(assert (= o131 (store (select (rec__patience__state__stacks s__split_fields16) (int__content i14)) o130 o129)))
(assert (and (<= 0 (int__content i14)) (<= (int__content i14) 99)))
(assert (= o132 (int__content i14)))
(assert (= o133 (store (rec__patience__state__stacks s__split_fields16) o132 o131)))
(assert (= o134 (mk___split_fields (rec__patience__state__numelts s__split_fields16) (rec__patience__state__values s__split_fields16) (rec__patience__state__numstacks s__split_fields16) (rec__patience__state__stacksizes s__split_fields16) o133 (rec__patience__state__posstack s__split_fields16) (rec__patience__state__posheight s__split_fields16) (rec__patience__state__preds s__split_fields16))))
(assert (= temp___598 (mk___rep o134)))
(assert (= result27 (mk___split_fields__ref s__split_fields16)))
(assert (= s__split_fields17 (us_split_fields1 temp___598)))
(assert (and (= o135 (int__content i14)) (in_range3 (int__content i14))))
(assert (= (to_rep1 o136) o135))
(assert (not (<= 0 idx1)))
(check-sat)
(exit)
