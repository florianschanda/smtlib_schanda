...
(define-fun o32 () us_t (mk___t o28 o29))
(define-fun o33 () us_t (mk___t o17 o18))
(define-fun o34 () us_t (mk___t o14 o15))
(assert (in_range3 x))
(assert (in_range3 y))
...
(assert (and (= o19 (- x 1)) (in_range4 (- x 1))))
(assert (and (= o16 y) (in_range4 y)))
(assert (and (= o33 (remove (mk___t values2 (mk 1 100)) o16)) (and (dynamic_invariant3 o33 true false true true) (and (= (invariant__ o33) true) (and (= (to_rep1 (last o18)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o16 1))) (= (to_rep (select values2 k)) (to_rep (select o17 k))))) (and (forall ((k Int)) (=> (and (<= (+ o16 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o17 (- k 1)))))) (forall ((k Int)) (=> (and (<= o16 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o17 k))))))))))))
(assert (and (= o13 y) (in_range4 y)))
(assert (and (= o34 (remove (mk___t interm1 (mk 1 100)) o13)) (and (dynamic_invariant3 o34 true false true true) (and (= (invariant__ o34) true) (and (= (to_rep1 (last o15)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select interm1 k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select o14 k))))))))))))
(assert (and (= o20 (remove_eq o34 o33 o19)) (and (in_range5 o20) (=> (= (distinct o20 0) true) (= (let ((temp___188 (remove o33 o19))) (let ((temp___187 (remove o34 o19))) (bool_eq (elts temp___187) (to_rep1 (first (rt temp___187))) (to_rep1 (last (rt temp___187))) (elts temp___188) (to_rep1 (first (rt temp___188))) (to_rep1 (last (rt temp___188)))))) true)))))
(assert (= result4 (mk_int__ref hr1)))
(assert (= hr2 o20))
(assert (and (= o22 x) (in_range4 x)))
(assert (and (= o21 y) (in_range4 y)))
(assert (and (= o23 (remove_swap (mk___t interm1 (mk 1 100)) o21 o22)) (and (in_range5 o23) (=> (= (distinct o23 0) true) (= (let ((temp___182 (remove (remove (mk___t interm1 (mk 1 100)) o22) o21))) (let ((temp___181 (remove (remove (mk___t interm1 (mk 1 100)) o21) (- o22 1)))) (bool_eq (elts temp___181) (to_rep1 (first (rt temp___181))) (to_rep1 (last (rt temp___181))) (elts temp___182) (to_rep1 (first (rt temp___182))) (to_rep1 (last (rt temp___182)))))) true)))))
...
(assert (= (let ((temp___278 (remove (remove (mk___t values2 (mk 1 100)) y) (- x 1)))) (let ((temp___277 (remove (remove (mk___t interm1 (mk 1 100)) x) y))) (bool_eq (elts temp___277) (to_rep1 (first (rt temp___277))) (to_rep1 (last (rt temp___277))) (elts temp___278) (to_rep1 (first (rt temp___278))) (to_rep1 (last (rt temp___278)))))) true))
(assert (and (= o25 x) (in_range4 x)))
(assert (and (= o24 y) (in_range4 y)))
(assert (and (= o26 (remove_swap (mk___t values2 (mk 1 100)) o24 o25)) (and (in_range5 o26) (=> (= (distinct o26 0) true) (= (let ((temp___182 (remove (remove (mk___t values2 (mk 1 100)) o25) o24))) (let ((temp___181 (remove (remove (mk___t values2 (mk 1 100)) o24) (- o25 1)))) (bool_eq (elts temp___181) (to_rep1 (first (rt temp___181))) (to_rep1 (last (rt temp___181))) (elts temp___182) (to_rep1 (first (rt temp___182))) (to_rep1 (last (rt temp___182)))))) true)))))
(assert (= result6 (mk_int__ref hr3)))
(assert (= hr4 o26))
(assert (and (= o30 y) (in_range4 y)))
(assert (and (= o27 x) (in_range4 x)))
(assert (and (= o32 (remove (mk___t values2 (mk 1 100)) o27)) (and (dynamic_invariant3 o32 true false true true) (and (= (invariant__ o32) true) (and (= (to_rep1 (last o29)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select values2 k)) (to_rep (select o28 k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o28 (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o28 k))))))))))))
(assert (and (= temp___280 (remove o32 o30)) (and (dynamic_invariant3 temp___280 true false true true) (and (= (invariant__ temp___280) true) (and (= (to_rep1 (last (rt temp___280))) (- (to_rep1 (last o29)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o30 1))) (= (to_rep (select o28 k)) (to_rep (select (elts temp___280) k))))) (and (forall ((k Int)) (=> (and (<= (+ o30 1) k) (<= k (to_rep1 (last o29)))) (= (to_rep (select o28 k)) (to_rep (select (elts temp___280) (- k 1)))))) (forall ((k Int)) (=> (and (<= o30 k) (<= k (- (to_rep1 (last o29)) 1))) (= (to_rep (select o28 (+ k 1))) (to_rep (select (elts temp___280) k))))))))))))
(assert (and (= o31 y) (in_range4 y)))
