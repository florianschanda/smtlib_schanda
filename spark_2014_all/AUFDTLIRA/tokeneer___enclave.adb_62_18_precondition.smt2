...
(define-fun dynamic_invariant1 ((temp___expr_451 Int) (temp___is_init_448 Bool) (temp___skip_constant_449 Bool) (temp___do_toplevel_450 Bool)) Bool (=> (or (= temp___is_init_448 true) (<= 1 4)) (in_range4 temp___expr_451)))
...
(define-fun dynamic_invariant2 ((temp___expr_1363 Int) (temp___is_init_1360 Bool) (temp___skip_constant_1361 Bool) (temp___do_toplevel_1362 Bool)) Bool (=> (or (= temp___is_init_1360 true) (<= 0 4294967295)) (in_range6 temp___expr_1363)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant3 ((temp___expr_1369 Int) (temp___is_init_1366 Bool) (temp___skip_constant_1367 Bool) (temp___do_toplevel_1368 Bool)) Bool (=> (or (= temp___is_init_1366 true) (<= 0 2)) (in_range7 temp___expr_1369)))
...
(declare-fun to_rep2 (classt) Int)
(declare-fun of_rep2 (Int) classt)
(assert (forall ((x classt)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x classt)) (! (in_range8 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x Int)) (! (=> (in_range8 x) (= (to_rep2 (of_rep2 x)) x)) :pattern ((to_rep2 (of_rep2 x))))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__privtypes__clearancet__class classt)))))
(define-fun us_split_fields_Class__projection ((a us_split_fields2)) classt (rec__privtypes__clearancet__class a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep2 (rec__privtypes__clearancet__class (us_split_fields3 a))) (to_rep2 (rec__privtypes__clearancet__class (us_split_fields3 b)))) true false))
...
(declare-datatypes () ((clearancet__ref (mk_clearancet__ref (clearancet__content us_rep1)))))
(define-fun clearancet__ref___projection ((a clearancet__ref)) us_rep1 (clearancet__content a))
...
(declare-fun to_rep3 (yearst) Int)
(declare-fun of_rep3 (Int) yearst)
(assert (forall ((x yearst)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x yearst)) (! (in_range9 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(declare-fun to_rep4 (monthst) Int)
(declare-fun of_rep4 (Int) monthst)
(assert (forall ((x monthst)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x monthst)) (! (in_range10 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(declare-fun to_rep5 (dayst) Int)
(declare-fun of_rep5 (Int) dayst)
(assert (forall ((x dayst)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x dayst)) (! (in_range11 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(declare-fun to_rep6 (millisecst) Int)
(declare-fun of_rep6 (Int) millisecst)
(assert (forall ((x millisecst)) (! (= (of_rep6 (to_rep6 x)) x) :pattern ((to_rep6 x)))))
(assert (forall ((x millisecst)) (! (in_range12 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(define-fun bool_eq2 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (= (to_rep3 (rec__clock__timet__year (us_split_fields5 a))) (to_rep3 (rec__clock__timet__year (us_split_fields5 b)))) (= (to_rep4 (rec__clock__timet__month (us_split_fields5 a))) (to_rep4 (rec__clock__timet__month (us_split_fields5 b))))) (= (to_rep5 (rec__clock__timet__day (us_split_fields5 a))) (to_rep5 (rec__clock__timet__day (us_split_fields5 b))))) (= (to_rep6 (rec__clock__timet__millisec (us_split_fields5 a))) (to_rep6 (rec__clock__timet__millisec (us_split_fields5 b))))) true false))
...
(assert (forall ((x algorithmt)) (! (in_range13 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x namecountt)) (! (in_range14 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(declare-fun user_eq17 (character character) Bool)
(declare-const dummy17 character)
(declare-datatypes () ((character__ref (mk_character__ref (character__content character)))))
(define-fun character__ref___projection ((a character__ref)) character (character__content a))
(declare-fun to_rep9 (character) Int)
(declare-fun of_rep9 (Int) character)
(assert (forall ((x character)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)))))
(assert (forall ((x character)) (! (in_range15 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun bool_eq3 ((a (Array Int character)) (a__first Int) (a__last Int) (b (Array Int character)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_78 Int)) (=> (and (<= a__first temp___idx_78) (<= temp___idx_78 a__last)) (= (to_rep9 (select a temp___idx_78)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_78))))))) true false))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_78 Int)) (=> (and (<= a__first temp___idx_78) (<= temp___idx_78 a__last)) (= (to_rep9 (select a temp___idx_78)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_78)))))))))))
...
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq3 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep9 (select a (+ i 1))) (to_rep9 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq3 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep9 (select b (+ i 1))) (to_rep9 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(declare-fun to_rep10 (issueridt) Int)
(declare-fun of_rep10 (Int) issueridt)
(assert (forall ((x issueridt)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x issueridt)) (! (in_range16 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep10 (rec__cryptotypes__issuert__id (us_split_fields7 a))) (to_rep10 (rec__cryptotypes__issuert__id (us_split_fields7 b)))) (= (to_rep8 (rec__cryptotypes__issuert__namelength (us_split_fields7 a))) (to_rep8 (rec__cryptotypes__issuert__namelength (us_split_fields7 b))))) (= (bool_eq3 (rec__cryptotypes__issuert__name (us_split_fields7 a)) 1 40 (rec__cryptotypes__issuert__name (us_split_fields7 b)) 1 40) true)) true false))
...
(declare-fun user_eq21 (serialnumbert serialnumbert) Bool)
(declare-const dummy21 serialnumbert)
...
(assert (forall ((x serialnumbert)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x serialnumbert)) (! (in_range17 (to_rep11 x)) :pattern ((to_rep11 x)))))
(assert (forall ((x Int)) (! (=> (in_range17 x) (= (to_rep11 (of_rep11 x)) x)) :pattern ((to_rep11 (of_rep11 x))))))
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__certtypes__idt__issuer us_rep3) (rec__certtypes__idt__serialnumber serialnumbert)))))
(define-fun us_split_fields_Issuer__projection ((a us_split_fields8)) us_rep3 (rec__certtypes__idt__issuer a))
...
(define-fun bool_eq5 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (bool_eq4 (rec__certtypes__idt__issuer (us_split_fields9 a)) (rec__certtypes__idt__issuer (us_split_fields9 b))) true) (= (to_rep11 (rec__certtypes__idt__serialnumber (us_split_fields9 a))) (to_rep11 (rec__certtypes__idt__serialnumber (us_split_fields9 b))))) true false))
...
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__cert__attr__auth__contentst__id us_rep4) (rec__cert__attr__auth__contentst__notbefore us_rep2) (rec__cert__attr__auth__contentst__notafter us_rep2) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep4) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep1)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields10)) us_rep4 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields10)) us_rep2 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields10)) us_rep2 (rec__cert__attr__auth__contentst__notafter a))
(define-fun us_split_fields_Mechanism__3__projection ((a us_split_fields10)) algorithmt (rec__cert__attr__auth__contentst__mechanism a))
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields10)) us_rep4 (rec__cert__attr__auth__contentst__basecertid a))
(define-fun us_split_fields_Role__projection ((a us_split_fields10)) privileget (rec__cert__attr__auth__contentst__role a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields10)) us_rep1 (rec__cert__attr__auth__contentst__clearance a))
...
(define-fun bool_eq6 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (and (and (and (= (bool_eq5 (rec__cert__attr__auth__contentst__id (us_split_fields11 a)) (rec__cert__attr__auth__contentst__id (us_split_fields11 b))) true) (= (bool_eq2 (rec__cert__attr__auth__contentst__notbefore (us_split_fields11 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields11 b))) true)) (= (bool_eq2 (rec__cert__attr__auth__contentst__notafter (us_split_fields11 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields11 b))) true)) (= (to_rep7 (rec__cert__attr__auth__contentst__mechanism (us_split_fields11 a))) (to_rep7 (rec__cert__attr__auth__contentst__mechanism (us_split_fields11 b))))) (= (bool_eq5 (rec__cert__attr__auth__contentst__basecertid (us_split_fields11 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields11 b))) true)) (= (to_rep (rec__cert__attr__auth__contentst__role (us_split_fields11 a))) (to_rep (rec__cert__attr__auth__contentst__role (us_split_fields11 b))))) (= (bool_eq1 (rec__cert__attr__auth__contentst__clearance (us_split_fields11 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields11 b))) true)) true false))
...
(define-fun contentst__ref___3__projection ((a contentst__ref)) us_rep5 (contentst__content a))
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__admintoken__validauthcertt__valid Bool) (rec__admintoken__validauthcertt__contents us_rep5)))))
(define-fun us_split_fields_Valid__projection ((a us_split_fields12)) Bool (rec__admintoken__validauthcertt__valid a))
(define-fun us_split_fields_Contents__projection ((a us_split_fields12)) us_rep5 (rec__admintoken__validauthcertt__contents a))
(declare-datatypes () ((us_split_fields__ref6 (mk___split_fields__ref6 (us_split_fields__content6 us_split_fields12)))))
(define-fun us_split_fields__ref___19__projection ((a us_split_fields__ref6)) us_split_fields12 (us_split_fields__content6 a))
(declare-datatypes () ((us_rep6 (mk___rep6 (us_split_fields13 us_split_fields12)))))
(define-fun us_rep___20__projection ((a us_rep6)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq7 ((a us_rep6) (b us_rep6)) Bool (ite (and (= (rec__admintoken__validauthcertt__valid (us_split_fields13 a)) (rec__admintoken__validauthcertt__valid (us_split_fields13 b))) (= (bool_eq6 (rec__admintoken__validauthcertt__contents (us_split_fields13 a)) (rec__admintoken__validauthcertt__contents (us_split_fields13 b))) true)) true false))
...
(declare-datatypes () ((validauthcertt__ref (mk_validauthcertt__ref (validauthcertt__content us_rep6)))))
(define-fun validauthcertt__ref___projection ((a validauthcertt__ref)) us_rep6 (validauthcertt__content a))
...
(assert (forall ((x keyidt)) (! (in_range18 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(assert (forall ((x keylengtht)) (! (in_range19 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun us_rep___8__projection ((a us_rep7)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq8 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (= (to_rep7 (rec__cryptotypes__keypartt__algorithmid (us_split_fields15 a))) (to_rep7 (rec__cryptotypes__keypartt__algorithmid (us_split_fields15 b)))) (= (to_rep12 (rec__cryptotypes__keypartt__keyid (us_split_fields15 a))) (to_rep12 (rec__cryptotypes__keypartt__keyid (us_split_fields15 b))))) (= (to_rep13 (rec__cryptotypes__keypartt__keylength (us_split_fields15 a))) (to_rep13 (rec__cryptotypes__keypartt__keylength (us_split_fields15 b))))) true false))
...
(define-fun us_split_fields_ID__6__projection ((a us_split_fields16)) us_rep4 (rec__cert__id__contentst__id a))
...
(define-fun us_split_fields_Subject__projection ((a us_split_fields16)) us_rep3 (rec__cert__id__contentst__subject a))
...
(define-fun bool_eq9 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (and (= (bool_eq5 (rec__cert__id__contentst__id (us_split_fields17 a)) (rec__cert__id__contentst__id (us_split_fields17 b))) true) (= (bool_eq2 (rec__cert__id__contentst__notbefore (us_split_fields17 a)) (rec__cert__id__contentst__notbefore (us_split_fields17 b))) true)) (= (bool_eq2 (rec__cert__id__contentst__notafter (us_split_fields17 a)) (rec__cert__id__contentst__notafter (us_split_fields17 b))) true)) (= (to_rep7 (rec__cert__id__contentst__mechanism (us_split_fields17 a))) (to_rep7 (rec__cert__id__contentst__mechanism (us_split_fields17 b))))) (= (bool_eq4 (rec__cert__id__contentst__subject (us_split_fields17 a)) (rec__cert__id__contentst__subject (us_split_fields17 b))) true)) (= (bool_eq8 (rec__cert__id__contentst__subjectpublickey (us_split_fields17 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields17 b))) true)) true false))
...
(declare-datatypes () ((us_split_fields18 (mk___split_fields9 (rec__admintoken__valididcertt__valid Bool) (rec__admintoken__valididcertt__contents us_rep8)))))
(define-fun us_split_fields_Valid__2__projection ((a us_split_fields18)) Bool (rec__admintoken__valididcertt__valid a))
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields18)) us_rep8 (rec__admintoken__valididcertt__contents a))
...
(define-fun us_rep___21__projection ((a us_rep9)) us_split_fields18 (us_split_fields19 a))
(define-fun bool_eq10 ((a us_rep9) (b us_rep9)) Bool (ite (and (= (rec__admintoken__valididcertt__valid (us_split_fields19 a)) (rec__admintoken__valididcertt__valid (us_split_fields19 b))) (= (bool_eq9 (rec__admintoken__valididcertt__contents (us_split_fields19 a)) (rec__admintoken__valididcertt__contents (us_split_fields19 b))) true)) true false))
...
(declare-fun ispresent1 (Int us_private Int Int us_split_fields12 us_split_fields18) Bool)
(declare-fun ispresent__function_guard1 (Bool Int us_private Int Int us_split_fields12 us_split_fields18) Bool)
(assert true)
(declare-const theadmin us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(define-fun dynamic_invariant4 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range15 temp___expr_63)))
(define-fun dynamic_invariant5 ((temp___expr_445 Int) (temp___is_init_442 Bool) (temp___skip_constant_443 Bool) (temp___do_toplevel_444 Bool)) Bool (=> (or (= temp___is_init_442 true) (<= 0 4)) (in_range3 temp___expr_445)))
(define-fun dynamic_invariant6 ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 0 3)) (in_range2 temp___expr_383)))
(define-fun dynamic_invariant7 ((temp___expr_389 Int) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (or (= temp___is_init_386 true) (<= 1 3)) (in_range5 temp___expr_389)))
(define-fun dynamic_invariant8 ((temp___expr_395 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 5)) (in_range8 temp___expr_395)))
(define-fun dynamic_invariant9 ((temp___expr_978 Int) (temp___is_init_975 Bool) (temp___skip_constant_976 Bool) (temp___do_toplevel_977 Bool)) Bool (=> (or (= temp___is_init_975 true) (<= 0 40)) (in_range14 temp___expr_978)))
(define-fun dynamic_invariant10 ((temp___expr_999 Int) (temp___is_init_996 Bool) (temp___skip_constant_997 Bool) (temp___do_toplevel_998 Bool)) Bool (=> (or (= temp___is_init_996 true) (<= 0 4294967295)) (in_range16 temp___expr_999)))
(define-fun dynamic_invariant11 ((temp___expr_1021 Int) (temp___is_init_1018 Bool) (temp___skip_constant_1019 Bool) (temp___do_toplevel_1020 Bool)) Bool (=> (or (= temp___is_init_1018 true) (<= 0 10)) (in_range13 temp___expr_1021)))
(define-fun dynamic_invariant12 ((temp___expr_1033 Int) (temp___is_init_1030 Bool) (temp___skip_constant_1031 Bool) (temp___do_toplevel_1032 Bool)) Bool (=> (or (= temp___is_init_1030 true) (<= 0 4294967295)) (in_range18 temp___expr_1033)))
(define-fun dynamic_invariant13 ((temp___expr_1039 Int) (temp___is_init_1036 Bool) (temp___skip_constant_1037 Bool) (temp___do_toplevel_1038 Bool)) Bool (=> (or (= temp___is_init_1036 true) (<= 0 128)) (in_range19 temp___expr_1039)))
(define-fun dynamic_invariant14 ((temp___expr_560 Int) (temp___is_init_557 Bool) (temp___skip_constant_558 Bool) (temp___do_toplevel_559 Bool)) Bool (=> (or (= temp___is_init_557 true) (<= 1901 2099)) (in_range9 temp___expr_560)))
(define-fun dynamic_invariant15 ((temp___expr_566 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 1 12)) (in_range10 temp___expr_566)))
(define-fun dynamic_invariant16 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 31)) (in_range11 temp___expr_572)))
(define-fun dynamic_invariant17 ((temp___expr_600 Int) (temp___is_init_597 Bool) (temp___skip_constant_598 Bool) (temp___do_toplevel_599 Bool)) Bool (=> (or (= temp___is_init_597 true) (<= 0 86399999)) (in_range12 temp___expr_600)))
(define-fun dynamic_invariant18 ((temp___expr_1433 Int) (temp___is_init_1430 Bool) (temp___skip_constant_1431 Bool) (temp___do_toplevel_1432 Bool)) Bool (=> (or (= temp___is_init_1430 true) (<= 0 4294967295)) (in_range17 temp___expr_1433)))
(declare-const tokenpresence Int)
(declare-const tokentry Int)
(declare-const tokenid Int)
(declare-const authcert__split_fields us_split_fields__ref6)
...
(assert (= o (ispresent1 tokenpresence state tokentry tokenid (us_split_fields__content6 authcert__split_fields) (us_split_fields__content9 idcert__split_fields))))
(assert (= o1 (ite (not (= o true)) true false)))
(assert (and (= o2 (ispresent theadmin)) (= (= o2 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields1 theadmin)))))))
(assert (= result (ite (= o2 true) o1 false)))
(assert (= result true))
(assert (and (= o4 (isdoingop theadmin)) (= (= o4 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields1 theadmin)))))))
