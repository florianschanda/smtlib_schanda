...
(assert (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v res__split_fields4)))) i2) (<= i2 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v res__split_fields4)))))))
(assert (= o i2))
(assert (= o1 (select (elts (rec__simple_unc_arrays__table__v res__split_fields4)) o)))
(assert (= o2 (to_rep2 o1)))
(assert (and (= temp___980 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (not (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v res__split_fields4)))) temp___980)))
(check-sat)
(exit)
