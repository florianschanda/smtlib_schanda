...
(assert (= e1 0))
(assert (=> (and (<= 0 e1) (<= e1 2147483647)) (and (and (= temp___268 e1) (and (and (and (and (and (and (<= (to_rep1 (first2 (rt1 init))) y) (<= y (to_rep1 (last2 (rt1 init))))) (= o9 y)) (= o10 (select (elts1 init) o9))) (= o11 (to_rep o10))) (and (and (= o8 x) (in_range4 x)) (ite (= o11 (to_rep (select (elts1 init) o8))) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e1)) (ite (= o11 e1) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) (+ (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e1) 1)) (ite (= (to_rep (select (elts1 init) o8)) e1) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) (- (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e1) 1)) (= (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) e1))))))) (and (and (and (and (and (and (<= (to_rep1 (first2 (rt1 init))) x) (<= x (to_rep1 (last2 (rt1 init))))) (= o13 x)) (= o14 (select (elts1 init) o13))) (= o15 (to_rep o14))) (and (and (= o12 y) (in_range4 y)) (ite (= o15 (to_rep (select interm o12))) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e1) (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1)) (ite (= o15 e1) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e1) (+ (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) 1)) (ite (= (to_rep (select interm o12)) e1) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e1) (- (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1) 1)) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) e1) (occ (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))) e1))))))) (and (forall ((f Int)) (=> (and (<= 0 f) (<= f e2)) (= (occ (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) f) (occ (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) f)))) (and (and (=> (<= 0 2147483647) (in_range1 e2)) (and (<= 0 e2) (<= e2 2147483647))) (= e2 2147483647)))))) (and (= e2 e6) (= e7 e2)))))
(assert (=> (and (<= 0 e1) (<= e1 2147483647)) (= (mk_int__ref e8) (mk_int__ref e6))))
(assert (=> (and (<= 0 e1) (<= e1 2147483647)) (= e9 e7)))
(assert (=> (not (and (<= 0 e1) (<= e1 2147483647))) (= e1 e8)))
(assert (=> (not (and (<= 0 e1) (<= e1 2147483647))) (= e9 e1)))
(assert (= e10 e8))
(assert (= e11 e9))
