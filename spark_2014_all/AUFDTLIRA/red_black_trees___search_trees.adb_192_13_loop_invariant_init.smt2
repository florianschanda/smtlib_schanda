...
(assert (<= 1 j52))
(assert (<= j52 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) k6))) true))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) j52))) true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) k6))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j52)))) true))
(assert (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j52))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) k6)))) 1)) 0))
