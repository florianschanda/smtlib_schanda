...
(assert (= bull1 true))
(assert (and (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields3) false true true true) (= bull2 true)))
(assert (= result3 (mk_bool__ref bull2)))
(assert (= bull3 (distinct 0 0)))
...
(assert (<= 1 i1))
(assert (<= i1 r56b))
(assert (and (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields4) false true true true) (and (<= 1 i2) (<= i2 r56b))))
...
(assert (and (= temp___985 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) temp___985)))
(check-sat)
(exit)
