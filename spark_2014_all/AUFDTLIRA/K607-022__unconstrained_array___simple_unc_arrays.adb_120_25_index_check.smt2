...
(assert (<= 1 i1))
(assert (<= i1 r56b))
(assert (and (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields4) false true true) (and (<= 1 i2) (<= i2 r56b))))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) i2) (<= i2 (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))))))
(assert (= o i2))
(assert (= o1 (select (elts1 (rec__simple_unc_arrays__table__v res__split_fields4)) o)))
(assert (= o2 (to_rep2 o1)))
(assert (and (= temp___906 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) temp___906)))
(check-sat)
(exit)
