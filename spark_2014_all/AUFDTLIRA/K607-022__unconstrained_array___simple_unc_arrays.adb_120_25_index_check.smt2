...
(assert (= bull1 true))
(assert (and (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields3) false true true) (= bull2 true)))
(assert (= result3 (mk_bool__ref bull2)))
(assert (= bull3 (of_int 0)))
(assert (= (- (to_rep (rec__simple_unc_arrays__table__last res__split_discrs)) 1) r56b))
(assert (in_range1 r56b))
(assert (= result4 (mk_int__ref i2)))
(assert (= i3 1))
(assert (<= 1 i3))
(assert (<= i3 r56b))
(assert (and (dynamic_invariant2 (mk___rep res__split_discrs res__split_fields4) false true true) (and (<= 1 i4) (<= i4 r56b))))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) i4) (<= i4 (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))))))
(assert (= o2 i4))
(assert (= o3 (select (elts1 (rec__simple_unc_arrays__table__v res__split_fields4)) o2)))
(assert (= o4 (to_rep2 o3)))
(assert (and (= temp___900 (+ i4 1)) (in_range1 (+ i4 1))))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) temp___900)))
(check-sat)
(exit)
