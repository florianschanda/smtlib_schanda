...
(declare-fun temp_____aggregate_def_547 (us_t Int Int Int) us_t)
...
(assert (forall ((temp___549 us_t)) (forall ((temp___550 Int) (temp___551 Int) (temp___552 Int)) (let ((temp___548 (temp_____aggregate_def_547 temp___549 temp___550 temp___551 temp___552))) (=> (and (and (and (dynamic_invariant2 temp___549 true true true true) (dynamic_invariant1 temp___550 true true true true)) (dynamic_invariant1 temp___551 true true true true)) (dynamic_invariant temp___552 true true true true)) (and (and (= (first1 temp___548) (first1 temp___549)) (= (last1 temp___548) (last1 temp___549))) (forall ((temp___553 Int)) (ite (and (<= temp___550 temp___553) (<= temp___553 temp___551)) (= (to_rep1 (select (to_array temp___548) temp___553)) temp___552) (= (select (to_array temp___548) temp___553) (select (to_array temp___549) temp___553))))))))))
(assert (dynamic_property 1 8 (to_rep a__first) (to_rep a__last)))
(assert (in_range new_val))
(assert (not (dynamic_property1 (to_rep a__first) (to_rep a__last) 8)))
(check-sat)
(exit)
