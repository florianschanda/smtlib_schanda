...
(define-fun dynamic_invariant ((temp___expr_161 Int) (temp___is_init_158 Bool) (temp___skip_constant_159 Bool) (temp___do_toplevel_160 Bool)) Bool (=> (or (= temp___is_init_158 true) (<= 0 100)) (in_range1 temp___expr_161)))
