...
(assert (= del_line1 1))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___799 to_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___797 cur_board)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= temp___796 has_complete_lines1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (and (and (forall ((temp___798 Int)) (=> (and (<= 1 temp___798) (<= temp___798 50)) (=> (<= del_line2 temp___798) (= (select cur_board2 temp___798) (select temp___797 temp___798))))) (=> (<= 1 50) (in_range3 to_line2))) (and (<= 1 del_line2) (<= del_line2 50)))))
