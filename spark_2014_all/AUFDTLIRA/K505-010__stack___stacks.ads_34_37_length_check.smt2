...
(define-fun bool_eq ((a (Array Int element)) (a__first Int) (a__last Int) (b (Array Int element)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep2 (select a temp___idx_133)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_133))))))) true false))
(assert (forall ((a (Array Int element)) (b (Array Int element))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep2 (select a temp___idx_133)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_133)))))))))))
...
(assert (forall ((temp___197 Int) (temp___198 Int) (temp___199 Int)) (let ((temp___196 (temp___195 temp___197 temp___198 temp___199))) (and (=> (dynamic_property4 (- 2147483648) 2147483647 temp___198 temp___199) (and (= (first3 temp___196) temp___198) (= (last3 temp___196) temp___199))) (forall ((temp___200 Int)) (= (select (to_array1 temp___196) temp___200) (of_rep2 temp___197)))))))
...
(define-fun dynamic_invariant3 ((temp___expr_143 Int) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (=> (or (= temp___is_init_140 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_143)))
(define-fun dynamic_invariant4 ((temp___expr_154 us_rep) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (let ((temp___155 (rec__stacks__stack__max (us_split_discrs1 temp___expr_154)))) (and (dynamic_property1 1 (to_rep temp___155) (first1 (rec__stacks__stack__data (us_split_fields1 temp___expr_154))) (last1 (rec__stacks__stack__data (us_split_fields1 temp___expr_154)))) (and (= (first1 (rec__stacks__stack__data (us_split_fields1 temp___expr_154))) 1) (= (last1 (rec__stacks__stack__data (us_split_fields1 temp___expr_154))) (to_rep temp___155))))))
...
(assert (not (= (ite (<= (to_rep1 (first2 temp___2021)) (to_rep1 (last2 temp___2021))) (+ (- (to_rep1 (last2 temp___2021)) (to_rep1 (first2 temp___2021))) 1) 0) (ite (<= 1 temp___194) (+ (- temp___194 1) 1) 0))))
(check-sat)
(exit)
