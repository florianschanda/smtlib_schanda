...
(assert (= usq_2 o6))
(assert (= false o7))
(assert (= temp___2022 (temp___196 (mk___rep (mk___split_discrs o4) (mk___split_fields o5 o6) o7) 1 c)))
(assert (= (to_rep1 (first6 temp___2021)) 1))
(assert (= (to_rep1 (last7 temp___2021)) c))
(assert (= (mk___t3 temp___203 temp___2031) temp___2022))
(assert (not (= (ite (<= (to_rep1 (first6 temp___2031)) (to_rep1 (last7 temp___2031))) (+ (- (to_rep1 (last7 temp___2031)) (to_rep1 (first6 temp___2031))) 1) 0) (ite (<= 1 c) (+ (- c 1) 1) 0))))
(check-sat)
(exit)
