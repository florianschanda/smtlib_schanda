...
(define-fun to_base1 ((a1 us_rep3)) us_rep (mk___rep (us_split_discrs5 a1) (mk___split_fields (let ((temp___171 (rec__static_discr__i_holder__content2 (us_split_fields7 a1)))) (of_array (to_array2 temp___171) (first5 temp___171) (last5 temp___171))))))
(define-fun of_base1 ((r us_rep)) us_rep3 (mk___rep3 (us_split_discrs1 r) (mk___split_fields3 (let ((temp___170 (rec__static_discr__i_holder__content (us_split_fields1 r)))) (of_array2 (to_array temp___170) (first1 temp___170) (last1 temp___170))))))
...
(define-fun to_base2 ((a1 us_rep4)) us_rep (mk___rep (us_split_discrs6 a1) (mk___split_fields (let ((temp___173 (rec__static_discr__i_holder__content3 (us_split_fields9 a1)))) (of_array (to_array3 temp___173) (first7 temp___173) (last7 temp___173))))))
(define-fun of_base2 ((r us_rep)) us_rep4 (mk___rep4 (us_split_discrs1 r) (mk___split_fields4 (let ((temp___172 (rec__static_discr__i_holder__content (us_split_fields1 r)))) (of_array3 (to_array temp___172) (first1 temp___172) (last1 temp___172))))))
