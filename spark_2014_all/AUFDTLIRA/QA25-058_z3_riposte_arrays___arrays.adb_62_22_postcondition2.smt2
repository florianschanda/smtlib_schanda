...
(declare-const arrays__contains_b__result Bool)
(declare-const result Bool)
(declare-const arrays__contains_b__result1 Bool)
(declare-const arrays__contains_b__result2 Bool)
(declare-const arrays__contains_b__result3 Bool)
(declare-const arrays__contains_b__result4 Bool)
(declare-const arrays__contains_b__result5 Bool)
(declare-const result1 Bool)
(assert (in_range1 c))
(assert (= arrays__contains_b__result1 arrays__contains_b__result2))
(assert (= arrays__contains_b__result3 arrays__contains_b__result1))
(assert (= result arrays__contains_b__result))
(assert (= arrays__contains_b__result1 (select s 97)))
(assert (= (mk_bool__ref arrays__contains_b__result4) (mk_bool__ref arrays__contains_b__result2)))
(assert (= arrays__contains_b__result5 arrays__contains_b__result3))
(assert (= result1 arrays__contains_b__result4))
(assert (= arrays__contains_b__result4 true))
(assert (not (= (select s c) true)))
(check-sat)
(exit)
