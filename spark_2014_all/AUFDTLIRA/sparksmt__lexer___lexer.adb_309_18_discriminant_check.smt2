...
(declare-const temp___941 token_kind)
(declare-const temp___9411 natural)
(declare-const temp___9412 natural)
(declare-const temp___9413 natural)
(declare-const temp___9414 name_id)
(declare-const temp___9415 Bool)
...
(declare-const temp___943 token_kind)
(declare-const temp___9431 natural)
(declare-const temp___9432 natural)
(declare-const temp___9433 natural)
(declare-const temp___9434 name_id)
(declare-const temp___9435 Bool)
...
(declare-const temp___944 us_rep)
(declare-const usq_6 us_rep)
(declare-const temp___946 us_rep)
...
(declare-const temp___950 us_rep)
...
(declare-const temp___955 us_rep)
...
(assert (not (= kind 4)))
(assert (= kind 5))
(assert (= (to_rep4 t__split_discrs) r34b))
(assert (in_range6 r34b))
(assert (= (to_rep3 o19) n1))
(assert (= (to_rep o20) t_length))
(assert (= (to_rep o21) first_col))
(assert (= (to_rep o22) first_line))
(assert (= o23 (mk___split_fields o22 o21 o20 o19)))
(assert (= (to_rep4 o18) 5))
(assert (= o24 (mk___split_discrs o18)))
(assert (= temp___947 (mk___rep o24 o23 true)))
(assert (= t__attr__constrained true))
(assert (not (= (rec__lexer__token__kind (us_split_discrs1 temp___947)) t__split_discrs)))
(check-sat)
(exit)
