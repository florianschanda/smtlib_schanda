...
(declare-fun temp___312 (Int Int Int) us_t1)
...
(assert (forall ((temp___314 Int) (temp___315 Int) (temp___316 Int)) (let ((temp___313 (temp___312 temp___314 temp___315 temp___316))) (=> (dynamic_invariant2 temp___314 true true true true) (and (=> (dynamic_property 1 2147483647 temp___315 temp___316) (and (= (first3 temp___313) temp___315) (= (last3 temp___313) temp___316))) (forall ((temp___317 Int)) (= (to_rep (select (to_array1 temp___313) temp___317)) temp___314)))))))
(declare-const b Int)
...
(assert (= (to_rep1 (first2 (rt1 (temp___312 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___312 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___319 temp___3191) (temp___312 32 (to_rep1 a__first) (to_rep1 a__last))))
