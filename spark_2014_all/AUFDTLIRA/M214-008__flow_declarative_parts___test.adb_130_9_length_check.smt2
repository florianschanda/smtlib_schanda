...
(assert (forall ((temp___278 Int) (temp___279 Int) (temp___280 Int)) (let ((temp___277 (temp___276 temp___278 temp___279 temp___280))) (and (=> (dynamic_property 1 2147483647 temp___279 temp___280) (and (= (first3 temp___277) temp___279) (= (last3 temp___277) temp___280))) (forall ((temp___281 Int)) (= (select (to_array1 temp___277) temp___281) (of_rep temp___278)))))))
...
(assert (= (to_rep1 (first2 (rt1 (temp___276 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___276 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___283 temp___2831) (temp___276 32 (to_rep1 a__first) (to_rep1 a__last))))
(assert (= temp___283 temp___284))
(assert (= (mk (to_rep1 (first2 temp___2831)) (to_rep1 (last2 temp___2831))) temp___2841))
(assert (not (= (ite (<= (to_rep1 (first temp___2841)) (to_rep1 (last temp___2841))) (+ (- (to_rep1 (last temp___2841)) (to_rep1 (first temp___2841))) 1) 0) (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0))))
(check-sat)
(exit)
