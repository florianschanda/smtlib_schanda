...
(assert (<= i11 (int__content k21)))
(declare-const j5 Int)
(assert (<= i11 j5))
(assert (<= j5 (int__content k21)))
(assert (not (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a18) i11)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a18) j5)))))))
(check-sat)
(exit)
