...
(declare-const swap_ranges__swap_ranges_with_error__L_1__R31b Int)
(declare-const swap_ranges__swap_ranges_with_error__L_1__R28b Int)
...
(assert (=> (< l2 (to_rep b__last)) (let ((swap_ranges__swap_ranges_with_error__L_1__R31b1 (+ l2 1))) (let ((swap_ranges__swap_ranges_with_error__L_1__R28b1 (+ l2 1))) (= (bool_eq b (to_rep (first10 (mk5 swap_ranges__swap_ranges_with_error__L_1__R28b1 (to_rep b__last)))) (to_rep (last10 (mk5 swap_ranges__swap_ranges_with_error__L_1__R28b1 (to_rep b__last)))) b2 (to_rep (first12 (mk6 swap_ranges__swap_ranges_with_error__L_1__R31b1 (to_rep b__last)))) (to_rep (last12 (mk6 swap_ranges__swap_ranges_with_error__L_1__R31b1 (to_rep b__last))))) true)))))
...
(assert (< l2 (to_rep b__last)))
(assert (and (= swap_ranges__swap_ranges_with_error__L_1__R31b (+ l2 1)) (in_range1 (+ l2 1))))
(assert (and (= swap_ranges__swap_ranges_with_error__L_1__R28b (+ l2 1)) (in_range1 (+ l2 1))))
(assert (<= swap_ranges__swap_ranges_with_error__L_1__R31b (to_rep b__last)))
(assert (not (<= (to_rep b__first) swap_ranges__swap_ranges_with_error__L_1__R31b)))
(check-sat)
(exit)
