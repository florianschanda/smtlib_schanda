...
(declare-const o3 partition_index)
(declare-const o4 Int)
(declare-const o5 Int)
(declare-const o6 partition_index)
...
(assert (and (= o12 (length1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) (and (in_range5 o12) (<= o12 (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))))))
(assert (= result (ite (< o12 10000) true false)))
(assert (= result true))
...
(assert (= result1 true))
(assert (and (= o7 (length1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) (and (in_range5 o7) (<= o7 (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))))))
(assert (= o8 (- o7 1)))
(assert (and (= o5 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range4 o5) (= o5 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= o6 (select f o5)))
(assert (= o9 (to_rep5 o6)))
(assert (= o10 (ite (<= o9 o8) true false)))
(assert (and (= o2 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range4 o2) (= o2 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= o3 (select f o2)))
(assert (= o4 (to_rep5 o3)))
(assert (= o11 (ite (<= 0 o4) true false)))
(assert (= result2 (ite (= o11 true) o10 false)))
(assert (= result2 true))
(assert (= (= result3 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key1 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (to_rep (select a j1))) true)))))
(assert (= result3 true))
...
(assert (= o1 true))
(assert (= result4 (ite (= o1 true) o false)))
(assert (= result4 true))
