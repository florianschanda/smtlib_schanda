...
(assert (and (= o7 (length fragment)) (in_range1 (length fragment))))
(assert (= o8 (ite (<= o7 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within)))) true false)))
(assert (and (= o6 (length fragment)) (in_range1 (length fragment))))
(assert (= o9 (ite (<= 1 o6) true false)))
(assert (= result (ite (= o9 true) o8 false)))
(assert (= result true))
(assert (and (= o (length fragment)) (in_range1 (length fragment))))
(assert (= o1 (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) o)))
(assert (= o2 (+ o1 1)))
(assert (= o3 (ite (<= k o2) true false)))
(assert (= result1 (ite (<= 1 k) o3 false)))
(assert (= result1 true))
(assert (and (= o4 (length fragment)) (in_range1 (length fragment))))
(assert (= o5 (+ k o4)))
(assert (= temp___1220 (- o5 1)))
(assert (<= k temp___1220))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k)))
(check-sat)
(exit)
