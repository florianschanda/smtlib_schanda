...
(define-fun dynamic_invariant1 ((temp___expr_609 us_rep) (temp___is_init_605 Bool) (temp___skip_constant_606 Bool) (temp___do_toplevel_607 Bool) (temp___do_typ_inv_608 Bool)) Bool (let ((temp___610 (rec__simple_unc_arrays__table__last (us_split_discrs1 temp___expr_609)))) (and (dynamic_property1 1 (to_rep temp___610) (first1 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_609))) (last1 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_609)))) (and (= (first1 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_609))) 1) (= (last1 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_609))) (to_rep temp___610))))))
...
(define-fun dynamic_invariant2 ((temp___expr_733 us_rep1) (temp___is_init_729 Bool) (temp___skip_constant_730 Bool) (temp___do_toplevel_731 Bool) (temp___do_typ_inv_732 Bool)) Bool (and (=> (not (= temp___skip_constant_730 true)) (in_range5 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) (to_base temp___expr_733))) (and (dynamic_property3 1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) (first3 (rec__simple_unc_arrays__table__v1 (us_split_fields3 temp___expr_733))) (last3 (rec__simple_unc_arrays__table__v1 (us_split_fields3 temp___expr_733)))) (and (= (first3 (rec__simple_unc_arrays__table__v1 (us_split_fields3 temp___expr_733))) 1) (= (last3 (rec__simple_unc_arrays__table__v1 (us_split_fields3 temp___expr_733))) (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))))))
(define-fun default_initial_assumption ((temp___expr_736 us_rep1) (temp___skip_top_level_737 Bool)) Bool (= (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs2 temp___expr_736))) (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant3 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_18)))
(define-fun dynamic_invariant4 ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_596)))
...
(declare-const temp___864 natural)
(declare-const temp___8641 (Array Int value))
(declare-const temp___8642 t1)
(declare-const o Int)
...
(declare-const temp___863 natural)
(declare-const temp___8631 (Array Int value))
(declare-const temp___8632 t1)
(declare-const j Int)
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= temp___867 i1)))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (and (= c__split_discrs (mk___split_discrs temp___864)) (and (= c__split_fields temp___8641) (= c__split_fields1 temp___8642)))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (to_rep1 (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) j1)) (+ (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)) (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) j1))))))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (and (and (and (dynamic_invariant2 (mk___rep1 c__split_discrs c__split_fields4) false true true true) (forall ((temp___866 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)))) temp___866) (<= temp___866 (to_rep2 (last2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)))))) (=> (<= i2 temp___866) (= (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) temp___866) (select temp___8641 temp___866)))))) (=> (<= 1 r7b) (dynamic_property4 1 r7b i2))) (and (<= 1 i2) (<= i2 r7b)))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 b))))) i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 b)))))))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= o2 i2)))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= o3 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) o2))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= o4 (to_rep1 o3))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= o i2)))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= o1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= o5 (to_rep1 o1))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= o6 (+ o5 o4))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (and (= o7 o6) (in_range2 o6))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= (to_rep1 o8) o7)))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (and (<= (to_rep2 (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)))) i2) (<= i2 (to_rep2 (last2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4))))))))
...
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= c__split_discrs (mk___split_discrs temp___863))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= temp___8631 o13)))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= temp___8632 o14)))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= result1 (mk___split_fields__ref1 c__split_fields4))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= c__split_fields5 (mk___split_fields1 (mk___t1 temp___8631 temp___8632)))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= c__split_discrs (mk___split_discrs temp___863))))
...
(assert (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 b))))) j) (<= j (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 b))))))))
(assert (= o15 j))
(assert (= o16 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) o15)))
(assert (= o17 (to_rep1 o16)))
(assert (not (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) j)))
(check-sat)
(exit)
