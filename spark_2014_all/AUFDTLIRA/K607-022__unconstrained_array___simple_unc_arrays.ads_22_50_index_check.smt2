...
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (and (= c__split_discrs (mk___split_discrs temp___785)) (and (= c__split_fields temp___7851) (= c__split_fields1 temp___7852)))))
...
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (and (and (and (dynamic_invariant2 (mk___rep1 c__split_discrs c__split_fields4) false true true) (forall ((temp___787 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)))) temp___787) (<= temp___787 (to_rep2 (last2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)))))) (=> (<= i2 temp___787) (= (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) temp___787) (select temp___7851 temp___787)))))) (=> (<= 1 r7b) (dynamic_property4 1 r7b i2))) (and (<= 1 i2) (<= i2 r7b)))))
...
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= c__split_discrs (mk___split_discrs temp___784))))
...
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= c__split_fields5 (mk___split_fields1 (mk___t1 temp___7841 temp___7842)))))
(assert (=> (and (<= 1 i1) (<= i1 r7b)) (= c__split_discrs (mk___split_discrs temp___784))))
