...
(assert (forall ((temp___185 Bool)) (forall ((temp___186 Int)) (= (select (concat__x__aggregate_def temp___185) temp___186) temp___185))))
...
(define-fun dynamic_invariant1 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 1 10)) (in_range1 temp___expr_172)))
(declare-const x (Array Int Bool))
(declare-const temp___192 (Array Int Bool))
(declare-const temp___191 (Array Int Bool))
(declare-const o Int)
...
(declare-const temp___193 (Array Int Bool))
