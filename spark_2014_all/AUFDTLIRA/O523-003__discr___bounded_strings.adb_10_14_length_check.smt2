...
(assert (not (= (ite (<= (to_rep1 (first4 temp___2271)) (to_rep1 (last4 temp___2271))) (+ (- (to_rep1 (last4 temp___2271)) (to_rep1 (first4 temp___2271))) 1) 0) (ite (<= (to_rep1 (first4 b__split_fields1)) (to_rep1 (last4 b__split_fields1))) (+ (- (to_rep1 (last4 b__split_fields1)) (to_rep1 (first4 b__split_fields1))) 1) 0))))
(check-sat)
(exit)
