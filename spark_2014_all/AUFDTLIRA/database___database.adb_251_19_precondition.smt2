...
(assert (and (= result (max_account_reached first_available)) (= (= result true) (not (= (some_available first_available) true)))))
(assert (not (= result true)))
(assert (= account2 account))
(assert (= account2 account1))
(assert (not (= (some_available first_available) true)))
(check-sat)
(exit)
