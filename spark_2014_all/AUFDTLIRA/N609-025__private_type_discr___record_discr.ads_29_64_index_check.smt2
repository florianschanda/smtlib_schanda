...
(define-fun dynamic_invariant2 ((temp___expr_160 us_rep1) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool (let ((temp___161 (rec__record_discr__interm_result__upto (us_split_discrs3 temp___expr_160)))) (and (dynamic_property1 1 (to_rep temp___161) (first1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_160))) (last1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_160)))) (and (= (first1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_160))) 1) (= (last1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_160))) (to_rep temp___161))))))
...
(define-fun dynamic_invariant3 ((temp___expr_202 us_rep) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (=> (not (= temp___skip_constant_200 true)) (in_range4 (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) temp___expr_202)))
(define-fun default_initial_assumption ((temp___expr_204 us_rep) (temp___skip_top_level_205 Bool)) Bool (= (rec__private_record__result_ty__found (us_split_discrs1 temp___expr_204)) (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0))))
...
(define-fun to_base ((a us_rep2)) us_rep1 (mk___rep1 (us_split_discrs4 a) (mk___split_fields1 (let ((temp___137 (rec__record_discr__interm_result__to_search1 (us_split_fields5 a)))) (of_array (to_array1 temp___137) (first3 temp___137) (last3 temp___137))))))
(define-fun of_base ((r1 us_rep1)) us_rep2 (mk___rep2 (us_split_discrs3 r1) (mk___split_fields2 (let ((temp___136 (rec__record_discr__interm_result__to_search (us_split_fields3 r1)))) (of_array1 (to_array temp___136) (first1 temp___136) (last1 temp___136))))))
...
(assert (= us1 (to_int1 (ite (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) true false))))
(assert (= us2 (to_int1 (ite (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) true false))))
(assert (= us3 0))
(assert (= us4 0))
...
(assert (=> (not (= result true)) (= o6 temp___265)))
(assert (=> (not (= result true)) (= (mk2 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) temp___2651)))
(assert (=> (not (= result true)) (= (ite (<= (to_rep1 (first4 temp___2651)) (to_rep1 (last4 temp___2651))) (+ (- (to_rep1 (last4 temp___2651)) (to_rep1 (first4 temp___2651))) 1) 0) (ite (<= 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (+ (- (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1) 1) 1) 0))))
(assert (=> (not (= result true)) (= temp___265 o7)))
(assert (=> (not (= result true)) (= (mk1 (to_rep1 (first4 temp___2651)) (to_rep1 (last4 temp___2651))) o8)))
