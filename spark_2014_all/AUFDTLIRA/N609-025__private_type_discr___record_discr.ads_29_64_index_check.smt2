...
(assert (in_range1 e))
(assert (and (and (and (= us (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r)))) (in_range1 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))))) (and (= us1 (to_int1 (ite (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) true false))) (and (= us2 (to_int1 (ite (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) true false))) (and (= us3 0) (and (= us4 0) (and (and (and (ite (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0) (= o 1) (and (= o (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r)))) (in_range2 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r)))))) (and (= (mk___rep (mk___split_discrs record_discr__search_upto__result__assume) (mk___split_fields record_discr__search_upto__result__assume1)) (mk_result (ite (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) true false) o)) (and (= (= record_discr__search_upto__result__assume true) (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0))) (=> (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) (= (get_content (mk___rep (mk___split_discrs record_discr__search_upto__result__assume) (mk___split_fields record_discr__search_upto__result__assume1))) o))))) (= (mk___rep (mk___split_discrs record_discr__search_upto__result__assume) (mk___split_fields record_discr__search_upto__result__assume1)) result__)) (and (= result__ result1) (and (= (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) (rec__private_record__result_ty__found (us_split_discrs1 result1))) (and (= result1 result1_base) (and (and (= record_discr__search_upto__result6 record_discr__search_upto__result4) (= record_discr__search_upto__result7 record_discr__search_upto__result5)) (and (ite (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0) (= result true) (and (and (and (and (and (<= (to_rep1 (first (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r)))) (<= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) (to_rep1 (last (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))))) (= o1 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))))) (= o2 (select (elts (rec__record_discr__interm_result__to_search (us_split_fields3 r))) o1))) (= o3 (to_rep o2))) (= result (ite (= o3 e) true false)))) (ite (= result true) (and (and (= record_discr__search_upto__result4 (mk_result_ty__ref record_discr__search_upto__result2)) (= record_discr__search_upto__result5 record_discr__search_upto__result2)) (and (= result2 (mk_result_ty__ref (mk___rep (mk___split_discrs record_discr__search_upto__result) (mk___split_fields record_discr__search_upto__result1)))) (= record_discr__search_upto__result2 result1_base))) (and (and (= record_discr__search_upto__result4 (mk_result_ty__ref record_discr__search_upto__result3)) (= record_discr__search_upto__result5 record_discr__search_upto__result3)) (and (and (and (and (and (and (and (and (=> (<= 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (and (and (<= (to_rep1 (first (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) 1) (<= 1 (to_rep1 (last (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))))) (and (<= (to_rep1 (first (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (<= (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1) (to_rep1 (last (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))))))) (= o6 (elts (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) (and (= o6 temp___265) (= (mk2 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) temp___2651))) (and (= (ite (<= (to_rep1 (first4 temp___2651)) (to_rep1 (last4 temp___2651))) (+ (- (to_rep1 (last4 temp___2651)) (to_rep1 (first4 temp___2651))) 1) 0) (ite (<= 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (+ (- (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1) 1) 1) 0)) (and (= temp___265 o7) (= (mk1 (to_rep1 (first4 temp___2651)) (to_rep1 (last4 temp___2651))) o8)))) (and (= o9 o7) (= o10 o8))) (and (and (and (and (= o4 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (in_range1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1))) (= (to_rep o5) o4)) (= o5 o11)) (and (= o12 o11) (and (= o13 o9) (= o14 o10))))) (= (mk___rep1 (mk___split_discrs1 o15) (mk___split_fields1 (mk___t o16 o17))) (to_base (mk___rep2 (mk___split_discrs1 o12) (mk___split_fields2 (mk___t1 o13 o14)))))) (and (= (mk___rep (mk___split_discrs o18) (mk___split_fields o19)) (search_upto (mk___rep1 (mk___split_discrs1 o15) (mk___split_fields1 (mk___t o16 o17))) e)) (ite (= o18 true) (and (<= (get_content (mk___rep (mk___split_discrs o18) (mk___split_fields o19))) (to_rep o15)) (= (to_rep (select o16 (get_content (mk___rep (mk___split_discrs o18) (mk___split_fields o19))))) e)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (to_rep o15))) (not (= (to_rep (select o16 i1)) e))))))) (and (= result3 (mk_result_ty__ref (mk___rep (mk___split_discrs record_discr__search_upto__result) (mk___split_fields record_discr__search_upto__result1)))) (= record_discr__search_upto__result3 (mk___rep (mk___split_discrs o18) (mk___split_fields o19)))))))))))))))))) (and (= record_discr__search_upto__result8 record_discr__search_upto__result6) (= record_discr__search_upto__result9 record_discr__search_upto__result7))))
