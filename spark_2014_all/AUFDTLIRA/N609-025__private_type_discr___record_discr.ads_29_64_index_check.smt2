...
(assert (forall ((found Bool)) (forall ((content Int)) (! (=> (dynamic_invariant1 content true true true true) (let ((result (mk_result found content))) (and (= (= (rec__private_record__result_ty__found (us_split_discrs1 result)) true) (= found true)) (=> (= found true) (= (get_content result) content))))) :pattern ((mk_result found content))))))
...
(define-fun dynamic_invariant2 ((temp___expr_185 us_rep1) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool) (temp___do_typ_inv_184 Bool)) Bool (let ((temp___186 (rec__record_discr__interm_result__upto (us_split_discrs3 temp___expr_185)))) (and (dynamic_property1 1 (to_rep temp___186) (first1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185))) (last1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185)))) (and (= (first1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185))) 1) (= (last1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185))) (to_rep temp___186))))))
...
(define-fun in_range4 ((rec__private_record__result_ty__found1 Bool) (a us_rep)) Bool (= rec__private_record__result_ty__found1 (rec__private_record__result_ty__found (us_split_discrs1 a))))
...
(assert (< private_record__result_ty__found__first__bit1 private_record__result_ty__found__last__bit1))
(assert (<= 0 private_record__result_ty__found__position1))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((my_res__ref (mk_my_res__ref (my_res__content us_rep)))))
(define-fun my_res__ref___projection ((a my_res__ref)) us_rep (my_res__content a))
(define-fun dynamic_invariant3 ((temp___expr_230 us_rep) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool) (temp___do_typ_inv_229 Bool)) Bool (=> (not (= temp___skip_constant_227 true)) (in_range4 (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) temp___expr_230)))
(define-fun default_initial_assumption ((temp___expr_232 us_rep) (temp___skip_top_level_233 Bool)) Bool (= (rec__private_record__result_ty__found (us_split_discrs1 temp___expr_232)) (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0))))
...
(declare-datatypes () ((tT12bP1__ref (mk_tT12bP1__ref (tT12bP1__content integer)))))
(define-fun tT12bP1__ref___projection ((a tT12bP1__ref)) integer (tT12bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__record_discr__interm_result__to_search1 us_t1)))))
(define-fun us_split_fields_To_Search__4__projection ((a us_split_fields4)) us_t1 (rec__record_discr__interm_result__to_search1 a))
...
(define-fun us_rep___9__projection ((a us_rep2)) us_split_discrs2 (us_split_discrs4 a))
(define-fun us_rep___10__projection ((a us_rep2)) us_split_fields4 (us_split_fields5 a))
(define-fun to_base ((a us_rep2)) us_rep1 (mk___rep1 (us_split_discrs4 a) (mk___split_fields1 (let ((temp___159 (rec__record_discr__interm_result__to_search1 (us_split_fields5 a)))) (of_array (to_array1 temp___159) (first3 temp___159) (last3 temp___159))))))
(define-fun of_base ((r1 us_rep1)) us_rep2 (mk___rep2 (us_split_discrs3 r1) (mk___split_fields2 (let ((temp___158 (rec__record_discr__interm_result__to_search (us_split_fields3 r1)))) (of_array1 (to_array temp___158) (first1 temp___158) (last1 temp___158))))))
(define-fun bool_eq5 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs4 a))) (to_rep (rec__record_discr__interm_result__upto (us_split_discrs4 b)))) (= (bool_eq4 (rec__record_discr__interm_result__to_search1 (us_split_fields5 a)) (rec__record_discr__interm_result__to_search1 (us_split_fields5 b))) true)) true false))
...
(define-fun bool_eq6 ((x us_t2) (y us_t2)) Bool (bool_eq1 (elts2 x) (to_rep1 (first4 (rt2 x))) (to_rep1 (last4 (rt2 x))) (elts2 y) (to_rep1 (first4 (rt2 y))) (to_rep1 (last4 (rt2 y)))))
...
(assert (= result__ (mk_result (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) (ite (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0) 1 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r)))))))
(assert (= result1 result__))
(assert (= result1_base result1))
(declare-const record_discr__search_upto__result Bool)
(declare-const record_discr__search_upto__result1 us_main_type)
...
(declare-const temp___297 (Array Int natural))
(declare-const temp___2971 t2)
...
(declare-const o19 us_main_type)
(declare-const i Int)
(declare-const result Bool)
(declare-const result2 result_ty__ref)
(declare-const record_discr__search_upto__result2 us_rep)
(declare-const result3 result_ty__ref)
(declare-const record_discr__search_upto__result3 us_rep)
(declare-const record_discr__search_upto__result4 result_ty__ref)
(declare-const record_discr__search_upto__result5 us_rep)
(declare-const record_discr__search_upto__result6 result_ty__ref)
(declare-const record_discr__search_upto__result7 us_rep)
(declare-const record_discr__search_upto__result8 result_ty__ref)
(declare-const record_discr__search_upto__result9 us_rep)
(define-fun o20 () us_rep (mk___rep (mk___split_discrs o18) (mk___split_fields o19)))
(define-fun o21 () us_rep1 (mk___rep1 (mk___split_discrs1 o15) (mk___split_fields1 (mk___t o16 o17))))
(define-fun record_discr__search_upto__result__assume2 () us_rep (mk___rep (mk___split_discrs record_discr__search_upto__result__assume) (mk___split_fields record_discr__search_upto__result__assume1)))
(define-fun record_discr__search_upto__result10 () result_ty__ref (mk_result_ty__ref (mk___rep (mk___split_discrs record_discr__search_upto__result) (mk___split_fields record_discr__search_upto__result1))))
(assert (dynamic_invariant2 r true false true true))
(assert (in_range1 e))
(assert (and (= us (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r)))) (in_range1 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))))))
(assert (= us1 (ite (ite (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) true false) 1 0)))
(assert (= us2 (ite (ite (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) true false) 1 0)))
(assert (= us3 0))
(assert (= us4 0))
(assert (=> (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0) (= o 1)))
(assert (=> (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) (and (= o (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r)))) (in_range2 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r)))))))
(assert (and (= record_discr__search_upto__result__assume2 (mk_result (ite (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) true false) o)) (and (= (= record_discr__search_upto__result__assume true) (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0))) (=> (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) (= (get_content record_discr__search_upto__result__assume2) o)))))
(assert (= record_discr__search_upto__result__assume2 result__))
(assert (= result__ result1))
(assert (= (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) (rec__private_record__result_ty__found (us_split_discrs1 result1))))
(assert (= result1 result1_base))
(assert (= record_discr__search_upto__result6 record_discr__search_upto__result4))
(assert (= record_discr__search_upto__result7 record_discr__search_upto__result5))
(assert (=> (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0) (= result true)))
(assert (=> (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) (and (<= (to_rep1 (first (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r)))) (<= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) (to_rep1 (last (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r)))))))))
(assert (=> (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) (= o1 (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))))))
(assert (=> (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) (= o2 (select (elts (rec__record_discr__interm_result__to_search (us_split_fields3 r))) o1))))
(assert (=> (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) (= o3 (to_rep o2))))
(assert (=> (not (= (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 0)) (= result (ite (= o3 e) true false))))
(assert (=> (= result true) (= record_discr__search_upto__result4 (mk_result_ty__ref record_discr__search_upto__result2))))
(assert (=> (= result true) (= record_discr__search_upto__result5 record_discr__search_upto__result2)))
(assert (=> (= result true) (= result2 record_discr__search_upto__result10)))
(assert (=> (= result true) (= record_discr__search_upto__result2 result1_base)))
(assert (=> (not (= result true)) (= record_discr__search_upto__result4 (mk_result_ty__ref record_discr__search_upto__result3))))
(assert (=> (not (= result true)) (= record_discr__search_upto__result5 record_discr__search_upto__result3)))
(assert (=> (not (= result true)) (=> (<= 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (and (and (<= (to_rep1 (first (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) 1) (<= 1 (to_rep1 (last (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))))) (and (<= (to_rep1 (first (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (<= (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1) (to_rep1 (last (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r)))))))))))
(assert (=> (not (= result true)) (= o6 (elts (rec__record_discr__interm_result__to_search (us_split_fields3 r))))))
(assert (=> (not (= result true)) (= o6 temp___297)))
(assert (=> (not (= result true)) (= (mk2 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) temp___2971)))
(assert (=> (not (= result true)) (= (ite (<= (to_rep1 (first4 temp___2971)) (to_rep1 (last4 temp___2971))) (+ (- (to_rep1 (last4 temp___2971)) (to_rep1 (first4 temp___2971))) 1) 0) (ite (<= 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (+ (- (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1) 1) 1) 0))))
(assert (=> (not (= result true)) (= temp___297 o7)))
(assert (=> (not (= result true)) (= (mk1 (to_rep1 (first4 temp___2971)) (to_rep1 (last4 temp___2971))) o8)))
(assert (=> (not (= result true)) (= o9 o7)))
(assert (=> (not (= result true)) (= o10 o8)))
(assert (=> (not (= result true)) (and (= o4 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (in_range1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)))))
(assert (=> (not (= result true)) (= (to_rep o5) o4)))
(assert (=> (not (= result true)) (= o5 o11)))
(assert (=> (not (= result true)) (= o12 o11)))
(assert (=> (not (= result true)) (= o13 o9)))
(assert (=> (not (= result true)) (= o14 o10)))
(assert (=> (not (= result true)) (= o21 (to_base (mk___rep2 (mk___split_discrs1 o12) (mk___split_fields2 (mk___t1 o13 o14)))))))
(assert (=> (not (= result true)) (and (= o20 (search_upto o21 e)) (ite (= o18 true) (and (<= (get_content o20) (to_rep o15)) (= (to_rep (select o16 (get_content o20))) e)) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 (to_rep o15))) (not (= (to_rep (select o16 i1)) e))))))))
(assert (=> (not (= result true)) (= result3 record_discr__search_upto__result10)))
(assert (=> (not (= result true)) (= record_discr__search_upto__result3 o20)))
(assert (= record_discr__search_upto__result8 record_discr__search_upto__result6))
(assert (= record_discr__search_upto__result9 record_discr__search_upto__result7))
(assert (not (= (rec__private_record__result_ty__found (us_split_discrs1 (result_ty__content record_discr__search_upto__result8))) true)))
(assert (<= 1 i))
(assert (<= i (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r)))))
(assert (not (<= (to_rep1 (first (rt (rec__record_discr__interm_result__to_search (us_split_fields3 r))))) i)))
(check-sat)
(exit)
