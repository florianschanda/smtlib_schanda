...
(define-fun dynamic_invariant2 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 100)) (in_range1 temp___expr_136)))
(define-fun dynamic_invariant3 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range4 temp___expr_142)))
...
(assert (forall ((s1 us_rep)) (! (dynamic_invariant2 (size s1) true false true) :pattern ((size s1)))))
(assert (forall ((s1 us_rep)) (! (= (size s1) (to_rep (rec__stackp__stack_root__length (us_split_fields1 s1)))) :pattern ((size s1)))))
...
(declare-const temp___478 (Array Int element))
...
(assert (= (mk___t stackp__get_model__2__result6 stackp__get_model__2__result7) (mk___t stackp__get_model__2__result2 stackp__get_model__2__result3)))
(assert (=> (<= 1 (to_rep (rec__stackp__stack_root__length (us_split_fields1 s)))) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 (to_rep (rec__stackp__stack_root__length (us_split_fields1 s)))) (<= (to_rep (rec__stackp__stack_root__length (us_split_fields1 s))) 100)))))
(assert (= o (rec__stackp__stack_root__content (us_split_fields1 s))))
(assert (= o temp___478))
(assert (= (mk1 1 (to_rep (rec__stackp__stack_root__length (us_split_fields1 s)))) temp___4781))
(assert (dynamic_property 1 2147483647 (to_rep1 (first2 temp___4781)) (to_rep1 (last2 temp___4781))))
(assert (= temp___478 o1))
(assert (= (mk (to_rep1 (first2 temp___4781)) (to_rep1 (last2 temp___4781))) o2))
(assert (= result stackp__get_model__2__result))
(assert (= result1 stackp__get_model__2__result1))
(assert (= (mk___t stackp__get_model__2__result2 stackp__get_model__2__result3) (mk___t o1 o2)))
(assert (= (mk_model____ref (mk___t stackp__get_model__2__result8 stackp__get_model__2__result9)) (mk_model____ref (mk___t stackp__get_model__2__result4 stackp__get_model__2__result5))))
...
(assert (not (= (length (mk___t stackp__get_model__2__result8 stackp__get_model__2__result9)) (size s))))
(check-sat)
(exit)
