...
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o111 ist))
(assert (= temp___703 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o111)))
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o112 ip))
(assert (= o113 (select temp___703 o112)))
(assert (= temp___704 (to_rep o113)))
(assert (and (<= 0 temp___704) (<= temp___704 99)))
(assert (= o114 temp___704))
(assert (= o115 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o114)))
...
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o109 ip))
(assert (= o110 (select temp___699 o109)))
(assert (= temp___700 (to_rep o110)))
(assert (not (<= temp___700 99)))
(check-sat)
(exit)
