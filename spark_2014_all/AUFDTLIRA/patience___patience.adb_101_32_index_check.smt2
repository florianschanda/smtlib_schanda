...
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o113 ist))
(assert (= temp___673 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o113)))
...
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o110 ist))
(assert (= temp___669 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o110)))
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o111 ip))
(assert (= o112 (select temp___669 o111)))
(assert (= temp___670 (to_rep1 o112)))
(assert (not (<= 0 temp___670)))
(check-sat)
(exit)
