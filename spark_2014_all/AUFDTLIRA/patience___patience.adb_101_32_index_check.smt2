...
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o230 ist))
(assert (= temp___669 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o230)))
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o231 ip))
(assert (= o232 (select temp___669 o231)))
(assert (= temp___670 (to_rep1 o232)))
