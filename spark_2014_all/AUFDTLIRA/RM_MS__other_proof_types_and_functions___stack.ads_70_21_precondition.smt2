...
(assert (and (= o22 (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (and (in_range2 o22) (= o22 (to_rep1 my_stack__split_fields7)))))
(assert (= o23 (- o22 1)))
(assert (and (= o24 o23) (in_range2 o23)))
(assert (and (= o25 (stack_entry o24 (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (and (in_range1 o25) (= o25 (to_rep (select my_stack__split_fields6 o24))))))
(assert (= o26 (ite (= o25 (stack_entry (count (mk___split_fields my_stack__split_fields my_stack__split_fields1)) (mk___split_fields my_stack__split_fields my_stack__split_fields1))) true false)))
(assert (and (= o20 (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (and (in_range2 o20) (= o20 (to_rep1 my_stack__split_fields7)))))
(assert (not (<= 1 o20)))
(check-sat)
(exit)
