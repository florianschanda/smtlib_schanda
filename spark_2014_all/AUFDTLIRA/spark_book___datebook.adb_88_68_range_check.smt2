...
(assert (= (ite (<= (to_rep1 (first temp___3621)) (to_rep1 (last temp___3621))) (+ (- (to_rep1 (last temp___3621)) (to_rep1 (first temp___3621))) 1) 0) (ite (<= 1 128) (+ (- 128 1) 1) 0)))
(assert (= o8 (slide temp___362 (to_rep1 (first temp___3621)) 1)))
(assert (= o8 o9))
(assert (= (rec__datebook__event_record__description_size (us_split_fields7 (select event_array (int__content available8)))) o10))
(assert (= (rec__datebook__event_record__date (us_split_fields7 (select event_array (int__content available8)))) (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o11 o12 o13)) (mk___rep1 (mk___split_fields1 o14 o15 o16))))))
(assert (= (rec__datebook__event_record__is_used (us_split_fields7 (select event_array (int__content available8)))) o17))
(assert (= o18 o9))
(assert (= o19 o10))
(assert (= o20 o11))
(assert (= o21 o12))
...
(assert (= o25 o16))
(assert (= o26 o17))
(assert (= o27 (store event_array (int__content available8) (mk___rep3 (mk___split_fields3 o18 o19 (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o20 o21 o22)) (mk___rep1 (mk___split_fields1 o23 o24 o25)))) o26)))))
(assert (= result5 (mk_map__ref1 event_array)))
(assert (= event_array1 o27))
