...
(assert (= o6 (elts4 (rec__bounded_dynamic_strings__sequence__content1 result____split_fields3))))
(assert (= temp___890 (mk___t6 o6 (mk6 1 r88b))))
(assert (not (= (ite (<= (to_rep1 (first12 (rt6 temp___887))) (to_rep1 (last12 (rt6 temp___887)))) (+ (- (to_rep1 (last12 (rt6 temp___887))) (to_rep1 (first12 (rt6 temp___887)))) 1) 0) (ite (<= (to_rep1 (first12 (rt6 temp___890))) (to_rep1 (last12 (rt6 temp___890)))) (+ (- (to_rep1 (last12 (rt6 temp___890))) (to_rep1 (first12 (rt6 temp___890)))) 1) 0))))
(check-sat)
(exit)
