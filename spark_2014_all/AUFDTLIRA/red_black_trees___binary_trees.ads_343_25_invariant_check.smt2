...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o62 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j5)) (and (in_range2 o62) (and (= o62 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 j5))))) (and (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j5) true) (= o62 0)) (=> (= (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 0) (= o62 0)))))))
