...
(assert (=> (and (<= 1 i2) (<= i2 64)) (= (mk___split_fields4 temp___362 temp___3621) find_result__split_fields2)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (<= (length description) 128)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (and (=> (<= 1 64) (in_range12 i3)) (and (<= 1 i3) (<= i3 64)))))
...
(assert (= book1 (store book (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9))) (mk___rep3 (mk___split_fields3 (temp___366 32) (rec__datebooks__event_record__description_size (us_split_fields7 (select book (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) (rec__datebooks__event_record__date (us_split_fields7 (select book (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) (rec__datebooks__event_record__is_used (us_split_fields7 (select book (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))))))))
...
(assert (and (and (in_range12 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))) (<= (length description) 128)) (< (- i9 (to_rep1 (first (rt description)))) 128)))
(assert (and (and (forall ((temp___375 Int)) (=> (and (<= 1 temp___375) (<= temp___375 64)) (ite (not (= (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9))) temp___375)) (= (select book2 temp___375) (select book1 temp___375)) (and (and (= (rec__datebooks__event_record__description_size (us_split_fields7 (select book2 temp___375))) (rec__datebooks__event_record__description_size (us_split_fields7 (select book1 temp___375)))) (= (rec__datebooks__event_record__date (us_split_fields7 (select book2 temp___375))) (rec__datebooks__event_record__date (us_split_fields7 (select book1 temp___375))))) (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book2 temp___375))) (rec__datebooks__event_record__is_used (us_split_fields7 (select book1 temp___375)))))))) (=> (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description)))) (dynamic_property1 (to_rep1 (first (rt description))) (to_rep1 (last (rt description))) i9))) (and (<= (to_rep1 (first (rt description))) i9) (<= i9 (to_rep1 (last (rt description)))))))
