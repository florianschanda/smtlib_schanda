...
(declare-fun to_rep8 (event_index_type) Int)
...
(declare-fun to_rep9 (description_count_type) Int)
...
(declare-fun temp___410 (Int) (Array Int character))
...
(assert (forall ((temp___412 Int)) (=> (dynamic_invariant3 temp___412 true true true true) (forall ((temp___413 Int)) (= (to_rep (select (temp___410 temp___412) temp___413)) temp___412)))))
...
(declare-const temp___404 event_index_type)
(declare-const temp___4041 Bool)
(declare-const temp___407 Int)
(declare-const temp___406 event_index_type)
(declare-const temp___4061 Bool)
(declare-const o3 event_index_type)
(declare-const o4 event_index_type)
(declare-const o5 Bool)
(declare-const temp___405 event_index_type)
(declare-const temp___4051 Bool)
...
(assert (and (and (forall ((temp___419 Int)) (=> (and (<= 1 temp___419) (<= temp___419 64)) (ite (not (= (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9))) temp___419)) (= (select book2 temp___419) (select book1 temp___419)) (and (and (= (rec__datebooks__event_record__description_size (us_split_fields7 (select book2 temp___419))) (rec__datebooks__event_record__description_size (us_split_fields7 (select book1 temp___419)))) (= (rec__datebooks__event_record__date (us_split_fields7 (select book2 temp___419))) (rec__datebooks__event_record__date (us_split_fields7 (select book1 temp___419))))) (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book2 temp___419))) (rec__datebooks__event_record__is_used (us_split_fields7 (select book1 temp___419)))))))) (=> (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description)))) (dynamic_property1 (to_rep1 (first (rt description))) (to_rep1 (last (rt description))) i9))) (and (<= (to_rep1 (first (rt description))) i9) (<= i9 (to_rep1 (last (rt description)))))))
(assert (= (to_rep o6) (to_rep (select (elts description) i9))))
