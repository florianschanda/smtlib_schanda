...
(define-fun bool_eq5 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (bool_eq (rec__datebooks__event_record__description_text (us_split_fields7 a)) 1 128 (rec__datebooks__event_record__description_text (us_split_fields7 b)) 1 128) true) (= (to_rep8 (rec__datebooks__event_record__description_size (us_split_fields7 a))) (to_rep8 (rec__datebooks__event_record__description_size (us_split_fields7 b))))) (= (bool_eq4 (rec__datebooks__event_record__date (us_split_fields7 a)) (rec__datebooks__event_record__date (us_split_fields7 b))) true)) (= (rec__datebooks__event_record__is_used (us_split_fields7 a)) (rec__datebooks__event_record__is_used (us_split_fields7 b)))) true false))
...
(assert (forall ((x event_index_type)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)))))
(assert (forall ((x event_index_type)) (! (in_range12 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_294 Int) (temp___is_init_291 Bool) (temp___skip_constant_292 Bool) (temp___do_toplevel_293 Bool)) Bool (=> (or (= temp___is_init_291 true) (<= 0 3)) (in_range13 temp___expr_294)))
...
(define-fun bool_eq7 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields9 a))) (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields9 b)))) (= (rec__datebooks__add_event__find_result_record__found_slot (us_split_fields9 a)) (rec__datebooks__add_event__find_result_record__found_slot (us_split_fields9 b)))) true false))
...
(assert (forall ((temp___368 Int)) (forall ((temp___369 Int)) (= (select (temp___366 temp___368) temp___369) (of_rep temp___368)))))
...
(define-fun dynamic_invariant5 ((temp___expr_216 Int) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool)) Bool (=> (or (= temp___is_init_213 true) (<= 1 128)) (in_range10 temp___expr_216)))
(define-fun dynamic_invariant6 ((temp___expr_231 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 128)) (in_range11 temp___expr_231)))
(define-fun dynamic_invariant7 ((temp___expr_258 Int) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool)) Bool (=> (or (= temp___is_init_255 true) (<= 1 64)) (in_range12 temp___expr_258)))
(define-fun dynamic_invariant8 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 2000 2099)) (in_range4 temp___expr_136)))
(define-fun dynamic_invariant9 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 1 12)) (in_range5 temp___expr_142)))
(define-fun dynamic_invariant10 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 1 31)) (in_range6 temp___expr_148)))
(define-fun dynamic_invariant11 ((temp___expr_154 Int) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (or (= temp___is_init_151 true) (<= 0 23)) (in_range7 temp___expr_154)))
(define-fun dynamic_invariant12 ((temp___expr_160 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 0 59)) (in_range8 temp___expr_160)))
(define-fun dynamic_invariant13 ((temp___expr_166 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 0 59)) (in_range9 temp___expr_166)))
...
(declare-const o13 description_count_type)
(declare-const o14 day_type)
(declare-const o15 month_type)
(declare-const o16 year_type)
(declare-const o17 hour_type)
(declare-const o18 minute_type)
(declare-const o19 second_type)
(declare-const o20 Bool)
(declare-const o21 us_rep3)
(declare-const o22 (Array Int us_rep3))
...
(declare-const find_result__split_fields11 us_split_fields__ref4)
(declare-const i9 int__ref)
(declare-const find_result__split_fields12 us_split_fields8)
...
(declare-const book8 map__ref1)
(declare-const i18 int__ref)
(declare-const book9 (Array Int us_rep3))
(declare-const i19 Int)
(declare-const book10 map__ref1)
(declare-const i20 int__ref)
(declare-const book11 (Array Int us_rep3))
...
(assert (= find_result__split_fields2 (mk___split_fields4 temp___360 temp___3601)))
(assert (not (< 128 (length description))))
(assert (= result1 (mk_int__ref i)))
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 64)) (and (and (= temp___363 i2) (and (= (mk___split_fields4 temp___362 temp___3621) find_result__split_fields2) (and (<= (length description) 128) (and (and (=> (<= 1 64) (in_range12 i3)) (and (<= 1 i3) (<= i3 64))) (or (and (and (= find_result__split_fields5 (mk___split_fields__ref4 find_result__split_fields4)) (= find_result__split_fields6 find_result__split_fields4)) (and (not (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book i3))) true)) (and (and (and (= (to_rep9 o3) i3) (and (= o3 o4) (= (of_int 1) o5))) (and (= temp___361 o4) (= temp___3611 o5))) (and (= result2 (mk___split_fields__ref4 find_result__split_fields3)) (= find_result__split_fields4 (mk___split_fields4 temp___361 temp___3611)))))) (and (and (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book i3))) true) (= find_result__split_fields4 find_result__split_fields3)) (and (and (= find_result__split_fields5 (mk___split_fields__ref4 find_result__split_fields4)) (= find_result__split_fields6 find_result__split_fields4)) (= i3 64)))))))) (and (and (= i7 (mk_int__ref i3)) (= find_result__split_fields9 find_result__split_fields5)) (and (= i8 i3) (= find_result__split_fields10 find_result__split_fields6))))))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= i9 i7)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= find_result__split_fields11 find_result__split_fields9)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= i10 i8)))
(assert (=> (and (<= 1 i2) (<= i2 64)) (= find_result__split_fields12 find_result__split_fields10)))
(assert (=> (not (and (<= 1 i2) (<= i2 64))) (= i9 (mk_int__ref i2))))
(assert (=> (not (and (<= 1 i2) (<= i2 64))) (= find_result__split_fields11 (mk___split_fields__ref4 find_result__split_fields2))))
(assert (=> (not (and (<= 1 i2) (<= i2 64))) (= i10 i2)))
(assert (=> (not (and (<= 1 i2) (<= i2 64))) (= find_result__split_fields12 find_result__split_fields2)))
(assert (= (rec__datebooks__add_event__find_result_record__found_slot (us_split_fields__content4 find_result__split_fields11)) true))
(assert (= result4 (mk_map__ref1 book)))
(assert (= book1 (store book (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11))) (mk___rep3 (mk___split_fields3 (temp___366 32) (rec__datebooks__event_record__description_size (us_split_fields7 (select book (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11)))))) (rec__datebooks__event_record__date (us_split_fields7 (select book (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11)))))) (rec__datebooks__event_record__is_used (us_split_fields7 (select book (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11)))))))))))
(assert (= result5 (mk_int__ref i1)))
(assert (= i11 (to_rep1 (first (rt description)))))
(assert (<= (to_rep1 (first (rt description))) i11))
(assert (<= i11 (to_rep1 (last (rt description)))))
(assert (and (and (in_range12 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11)))) (<= (length description) 128)) (< (- i12 (to_rep1 (first (rt description)))) 128)))
(assert (and (and (forall ((temp___375 Int)) (=> (and (<= 1 temp___375) (<= temp___375 64)) (ite (not (= (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11))) temp___375)) (= (select book2 temp___375) (select book1 temp___375)) (and (and (= (rec__datebooks__event_record__description_size (us_split_fields7 (select book2 temp___375))) (rec__datebooks__event_record__description_size (us_split_fields7 (select book1 temp___375)))) (= (rec__datebooks__event_record__date (us_split_fields7 (select book2 temp___375))) (rec__datebooks__event_record__date (us_split_fields7 (select book1 temp___375))))) (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book2 temp___375))) (rec__datebooks__event_record__is_used (us_split_fields7 (select book1 temp___375)))))))) (=> (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description)))) (dynamic_property1 (to_rep1 (first (rt description))) (to_rep1 (last (rt description))) i12))) (and (<= (to_rep1 (first (rt description))) i12) (<= i12 (to_rep1 (last (rt description)))))))
(assert (= (to_rep o9) (to_rep (select (elts description) i12))))
(assert (not (in_range1 (- i12 (to_rep1 (first (rt description)))))))
(check-sat)
(exit)
