...
(assert (= n1 result4))
(assert (= n2 o29))
(assert (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))))
(assert (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1))))))
(assert (and (and (forall ((temp___2035 Int)) (=> (and (<= (to_rep1 n__first) temp___2035) (<= temp___2035 (to_rep1 n__last))) (=> (< index3 temp___2035) (= (select n3 temp___2035) (select n1 temp___2035))))) (=> (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 4) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= o30 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (= o31 (ite (<= o30 i) true false)))
(assert (= result5 (ite (= o31 true) (ite (<= i index3) true false) false)))
(assert (= result5 true))
