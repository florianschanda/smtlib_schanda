...
(assert (= n1 result3))
(assert (= n2 o8))
(assert (forall ((i1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) i1) (<= i1 index2)) (and (<= 0 (to_rep1 (select n3 i1))) (<= (to_rep1 (select n3 i1)) 9)))))
(assert (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j))))))
(assert (and (and (forall ((temp___2035 Int)) (=> (and (<= (to_rep1 n__first) temp___2035) (<= temp___2035 (to_rep1 n__last))) (=> (< index2 temp___2035) (= (select n3 temp___2035) (select n1 temp___2035))))) (=> (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 4) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= o9 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
