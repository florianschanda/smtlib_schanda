...
(declare-fun user_eq12 (t38s t38s) Bool)
(declare-const dummy12 t38s)
(declare-datatypes () ((t38s__ref (mk_t38s__ref (t38s__content t38s)))))
(define-fun t38s__ref___projection ((a t38s__ref)) t38s (t38s__content a))
(declare-sort t19s 0)
(define-fun in_range6 ((x Int)) Bool (and (<= 1 x) (<= x 1)))
(declare-fun attr__ATTRIBUTE_IMAGE7 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check7 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE7 (us_image) Int)
(declare-fun user_eq13 (t19s t19s) Bool)
(declare-const dummy13 t19s)
...
(assert (forall ((temp___215 Int)) (= (select (temp___213 temp___215) 1) (of_rep temp___215))))
(declare-fun temp___494 (Int) (Array Int element))
(assert (forall ((temp___496 Int)) (= (select (temp___494 temp___496) 1) (of_rep temp___496))))
...
(declare-const e Int)
(declare-const temp___506 (Array Int element))
...
(assert (in_range1 e1))
(assert (in_range1 e2))
(assert (= (bool_eq (let ((temp___503 (temp___213 e2))) (let ((temp___502 (get_model__2 (mk___rep (mk___split_fields s__split_fields6 s__split_fields7 s__split_fields8) s__attr__tag)))) (ite (= (length temp___502) 0) temp___503 (concat1 (elts temp___502) (to_rep1 (first (rt temp___502))) (to_rep1 (last (rt temp___502))) temp___503 1 1)))) (to_rep1 (first (let ((temp___502 (get_model__2 (mk___rep (mk___split_fields s__split_fields6 s__split_fields7 s__split_fields8) s__attr__tag)))) (ite (= (length temp___502) 0) (mk 1 1) (mk (to_rep1 (first (rt temp___502))) (- (+ (to_rep1 (first (rt temp___502))) (+ (ite (<= (to_rep1 (first (rt temp___502))) (to_rep1 (last (rt temp___502)))) (+ (- (to_rep1 (last (rt temp___502))) (to_rep1 (first (rt temp___502)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (to_rep1 (last (let ((temp___502 (get_model__2 (mk___rep (mk___split_fields s__split_fields6 s__split_fields7 s__split_fields8) s__attr__tag)))) (ite (= (length temp___502) 0) (mk 1 1) (mk (to_rep1 (first (rt temp___502))) (- (+ (to_rep1 (first (rt temp___502))) (+ (ite (<= (to_rep1 (first (rt temp___502))) (to_rep1 (last (rt temp___502)))) (+ (- (to_rep1 (last (rt temp___502))) (to_rep1 (first (rt temp___502)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (elts (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))) (to_rep1 (first (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep1 (last (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))))) true))
(assert (not (= (bool_eq (let ((temp___499 (temp___494 e2))) (let ((temp___498 (get_model__2 (mk___rep (mk___split_fields s__split_fields6 s__split_fields7 s__split_fields8) s__attr__tag)))) (ite (= (length temp___498) 0) temp___499 (concat1 (elts temp___498) (to_rep1 (first (rt temp___498))) (to_rep1 (last (rt temp___498))) temp___499 1 1)))) (to_rep1 (first (let ((temp___498 (get_model__2 (mk___rep (mk___split_fields s__split_fields6 s__split_fields7 s__split_fields8) s__attr__tag)))) (ite (= (length temp___498) 0) (mk 1 1) (mk (to_rep1 (first (rt temp___498))) (- (+ (to_rep1 (first (rt temp___498))) (+ (ite (<= (to_rep1 (first (rt temp___498))) (to_rep1 (last (rt temp___498)))) (+ (- (to_rep1 (last (rt temp___498))) (to_rep1 (first (rt temp___498)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (to_rep1 (last (let ((temp___498 (get_model__2 (mk___rep (mk___split_fields s__split_fields6 s__split_fields7 s__split_fields8) s__attr__tag)))) (ite (= (length temp___498) 0) (mk 1 1) (mk (to_rep1 (first (rt temp___498))) (- (+ (to_rep1 (first (rt temp___498))) (+ (ite (<= (to_rep1 (first (rt temp___498))) (to_rep1 (last (rt temp___498)))) (+ (- (to_rep1 (last (rt temp___498))) (to_rep1 (first (rt temp___498)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (elts (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))) (to_rep1 (first (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) (to_rep1 (last (rt (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))))) true)))
(check-sat)
(exit)
