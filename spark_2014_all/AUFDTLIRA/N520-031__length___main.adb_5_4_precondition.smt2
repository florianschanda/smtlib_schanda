...
(declare-sort tTvSP1 0)
(declare-fun tTvSP1qtint (tTvSP1) Int)
(assert (forall ((i tTvSP1)) (and (<= 1 (tTvSP1qtint i)) (<= (tTvSP1qtint i) 100))))
(define-fun in_range2 ((x Int)) Bool (and (<= 1 x) (<= x 100)))
(declare-fun attr__ATTRIBUTE_IMAGE2 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Int)
(declare-fun user_eq3 (tTvSP1 tTvSP1) Bool)
(declare-const dummy3 tTvSP1)
(declare-datatypes () ((tTvSP1__ref (mk_tTvSP1__ref (tTvSP1__content tTvSP1)))))
(define-fun tTvSP1__ref___projection ((a tTvSP1__ref)) tTvSP1 (tTvSP1__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun main__v__aggregate_def (Int) (Array Int integer))
...
(assert (forall ((temp___228 Int)) (=> (dynamic_invariant temp___228 true true true true) (forall ((temp___229 Int)) (= (select (main__v__aggregate_def temp___228) temp___229) rliteral)))))
