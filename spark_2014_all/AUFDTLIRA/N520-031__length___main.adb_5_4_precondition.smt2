...
(assert (forall ((temp___228 Int)) (=> (dynamic_invariant temp___228 true true true true) (forall ((temp___229 Int)) (= (to_rep (select (main__v__aggregate_def temp___228) temp___229)) temp___228)))))
