...
(declare-fun temp_____aggregate_def_242 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___244 (Array Int integer))) (forall ((temp___245 Int) (temp___246 Int)) (let ((temp___243 (temp_____aggregate_def_242 temp___244 temp___245 temp___246))) (=> (and (dynamic_invariant1 temp___245 true true true true) (dynamic_invariant temp___246 true true true true)) (forall ((temp___247 Int)) (ite (= temp___247 temp___245) (= (to_rep (select temp___243 temp___247)) temp___246) (= (select temp___243 temp___247) (select temp___244 temp___247)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq a2 1 8 (temp_____aggregate_def_242 a i new_val) 1 8) true)))
(check-sat)
(exit)
