...
(assert (forall ((temp___215 (Array Int integer))) (forall ((temp___216 Int) (temp___217 Int)) (let ((temp___214 (temp___213 temp___215 temp___216 temp___217))) (forall ((temp___218 Int)) (ite (= temp___218 temp___216) (= (select temp___214 temp___218) (of_rep temp___217)) (= (select temp___214 temp___218) (select temp___215 temp___218))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq a2 1 8 (temp___213 a i new_val) 1 8) true)))
(check-sat)
(exit)
