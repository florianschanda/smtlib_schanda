...
(define-fun o13 () us_t (mk___t o10 o11))
...
(assert (and (= o13 (remove bb o9)) (and (dynamic_invariant2 o13 true false true true) (and (= (invariant__ o13) true) (and (= (to_rep1 (last o11)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o9 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o10 k))))) (and (forall ((k Int)) (=> (and (<= (+ o9 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o10 (- k 1)))))) (forall ((k Int)) (=> (and (<= o9 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o10 k))))))))))))
(assert (and (= o14 (remove aa ia21)) (and (dynamic_invariant2 o14 true false true true) (and (= (invariant__ o14) true) (and (= (to_rep1 (last o8)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia21 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o7 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia21 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o7 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia21 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o7 k))))))))))))
(assert (and (= o15 (remove bb2 ib)) (and (dynamic_invariant2 o15 true false true true) (and (= (invariant__ o15) true) (and (= (to_rep1 (last o6)) (- (to_rep1 (last (rt bb2))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib 1))) (= (to_rep (select (elts bb2) k)) (to_rep (select o5 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib 1) k) (<= k (to_rep1 (last (rt bb2))))) (= (to_rep (select (elts bb2) k)) (to_rep (select o5 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib k) (<= k (- (to_rep1 (last (rt bb2))) 1))) (= (to_rep (select (elts bb2) (+ k 1))) (to_rep (select o5 k))))))))))))
(assert (and (= o12 (shift_perm_l o15 o14 o13)) (and (in_range2 o12) (=> (= (distinct o12 0) true) (= (is_perm o13 o14) true)))))
(assert (= h4 result5))
(assert (= h5 o12))
