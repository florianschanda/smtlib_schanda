...
(define-fun dynamic_invariant1 ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= 0 4294967295)) (in_range4 temp___expr_152)))
...
(assert (forall ((temp___144 Int)) (forall ((temp___145 Int)) (= (select (audittypes__nodescription__aggregate_def temp___144) temp___145) (of_rep temp___144)))))
...
(define-fun dynamic_invariant2 ((temp___expr_835 Int) (temp___is_init_832 Bool) (temp___skip_constant_833 Bool) (temp___do_toplevel_834 Bool)) Bool (=> (or (= temp___is_init_832 true) (<= 0 16)) (in_range6 temp___expr_835)))
...
(define-fun dynamic_invariant3 ((temp___expr_874 Int) (temp___is_init_871 Bool) (temp___skip_constant_872 Bool) (temp___do_toplevel_873 Bool)) Bool (=> (or (= temp___is_init_871 true) (<= 0 16)) (in_range7 temp___expr_874)))
...
(define-fun dynamic_invariant4 ((temp___expr_880 Int) (temp___is_init_877 Bool) (temp___skip_constant_878 Bool) (temp___do_toplevel_879 Bool)) Bool (=> (or (= temp___is_init_877 true) (<= 0 4294967295)) (in_range8 temp___expr_880)))
...
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_912 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_912 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_912 us_void_param)))))
(declare-fun temp___String_Literal_916 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_916 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_916 us_void_param) 2)) 40)) (= (to_rep (select (temp___String_Literal_916 us_void_param) 3)) 32)) :pattern ((temp___String_Literal_916 us_void_param)))))
(declare-fun temp___String_Literal_921 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_921 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_921 us_void_param) 2)) 41)) :pattern ((temp___String_Literal_921 us_void_param)))))
...
(define-fun dynamic_invariant8 ((temp___expr_330 Int) (temp___is_init_327 Bool) (temp___skip_constant_328 Bool) (temp___do_toplevel_329 Bool)) Bool (=> (or (= temp___is_init_327 true) (<= 1 150)) (in_range5 temp___expr_330)))
...
(assert (=> (and (<= 0 code1) (<= code1 16)) (and (and (<= 0 code2) (<= code2 16)) (= result__4 1))))
(assert (=> (and (<= 0 code1) (<= code1 16)) (and (and (=> (<= 0 16) (in_range6 result__4)) (=> (<= 0 16) (in_range6 code2))) (and (<= 0 code2) (<= code2 16)))))
(assert (=> (and (<= 0 code1) (<= code1 16)) (= code2 c29b)))
(assert (=> (and (<= 0 code1) (<= code1 16)) (in_range6 c29b)))
(assert (=> (and (<= 0 code1) (<= code1 16)) (=> (<= 0 4294967295) (in_range4 c30b2))))
(assert (=> (and (<= 0 code1) (<= code1 16)) (and (= o (codetoval c29b)) (in_range8 o))))
(assert (=> (and (<= 0 code1) (<= code1 16)) (= c30b2 result3)))
(assert (=> (and (<= 0 code1) (<= code1 16)) (= c30b3 o)))
(assert (=> (and (<= 0 code1) (<= code1 16)) (or (and (and (= result__5 result__6) (= result__7 result__5)) (and (= c26b c30b3) (and (= result4 result__4) (= result__5 code2)))) (and (and (not (= c26b c30b3)) (= result__5 result__4)) (and (and (= result__5 result__6) (= result__7 result__5)) (= code2 16))))))
(assert (=> (and (<= 0 code1) (<= code1 16)) (= c30b4 (mk_int__ref c30b3))))
(assert (=> (and (<= 0 code1) (<= code1 16)) (= code3 (mk_int__ref code2))))
(assert (=> (and (<= 0 code1) (<= code1 16)) (= result__8 (mk_int__ref result__6))))
...
(assert (=> (not (and (<= 0 code1) (<= code1 16))) (= c30b6 (mk_int__ref c30b))))
(assert (=> (not (and (<= 0 code1) (<= code1 16))) (= code5 (mk_int__ref code1))))
(assert (=> (not (and (<= 0 code1) (<= code1 16))) (= result__10 (mk_int__ref result__3))))
(assert (=> (not (and (<= 0 code1) (<= code1 16))) (= c30b7 c30b1)))
(assert (=> (not (and (<= 0 code1) (<= code1 16))) (= code6 code1)))
(assert (=> (not (and (<= 0 code1) (<= code1 16))) (= result__11 result__3)))
(assert (= result5 (mk_int__ref thecodename)))
(assert (= thecodename1 (int__content result__10)))
(assert (=> (= (length text) 0) (= (temp___String_Literal_912 Tuple0) temp___914)))
(assert (=> (= (length text) 0) (= (mk 1 2) temp___9141)))
(assert (=> (not (= (length text) 0)) (=> (<= 1 2) (= o1 (+ (- 2 1) 1)))))
(assert (=> (not (= (length text) 0)) (=> (not (<= 1 2)) (= o1 0))))
(assert (=> (not (= (length text) 0)) (=> (<= (to_rep1 (first (rt text))) (to_rep1 (last (rt text)))) (= o2 (+ (- (to_rep1 (last (rt text))) (to_rep1 (first (rt text)))) 1)))))
(assert (=> (not (= (length text) 0)) (=> (not (<= (to_rep1 (first (rt text))) (to_rep1 (last (rt text))))) (= o2 0))))
(assert (=> (not (= (length text) 0)) (= o3 (+ o2 o1))))
(assert (=> (not (= (length text) 0)) (= o4 (+ (to_rep1 (first (rt text))) o3))))
(assert (=> (not (= (length text) 0)) (= o5 (- o4 1))))
(assert (=> (not (= (length text) 0)) (and (= o6 o5) (in_range2 o5))))
(assert (=> (not (= (length text) 0)) (= (concat1 (elts text) (to_rep1 (first (rt text))) (to_rep1 (last (rt text))) (temp___String_Literal_912 Tuple0) 1 2) temp___914)))
(assert (=> (not (= (length text) 0)) (= (mk (to_rep1 (first (rt text))) o6) temp___9141)))
(assert (=> (= (length (mk___t temp___914 temp___9141)) 0) (= (elts (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1))) temp___917)))
(assert (=> (= (length (mk___t temp___914 temp___9141)) 0) (= (mk (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1)))))) temp___9171)))
(assert (=> (not (= (length (mk___t temp___914 temp___9141)) 0)) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1)))))) (= o7 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1)))))) 1)))))
(assert (=> (not (= (length (mk___t temp___914 temp___9141)) 0)) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1))))))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___914 temp___9141)) 0)) (=> (<= (to_rep1 (first temp___9141)) (to_rep1 (last temp___9141))) (= o8 (+ (- (to_rep1 (last temp___9141)) (to_rep1 (first temp___9141))) 1)))))
(assert (=> (not (= (length (mk___t temp___914 temp___9141)) 0)) (=> (not (<= (to_rep1 (first temp___9141)) (to_rep1 (last temp___9141)))) (= o8 0))))
(assert (=> (not (= (length (mk___t temp___914 temp___9141)) 0)) (= o9 (+ o8 o7))))
(assert (=> (not (= (length (mk___t temp___914 temp___9141)) 0)) (= o10 (+ (to_rep1 (first temp___9141)) o9))))
(assert (=> (not (= (length (mk___t temp___914 temp___9141)) 0)) (= o11 (- o10 1))))
(assert (=> (not (= (length (mk___t temp___914 temp___9141)) 0)) (and (= o12 o11) (in_range2 o11))))
(assert (=> (not (= (length (mk___t temp___914 temp___9141)) 0)) (= (concat1 temp___914 (to_rep1 (first temp___9141)) (to_rep1 (last temp___9141)) (elts (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 thecodename1)))))) temp___917)))
(assert (=> (not (= (length (mk___t temp___914 temp___9141)) 0)) (= (mk (to_rep1 (first temp___9141)) o12) temp___9171)))
(assert (=> (= (length (mk___t temp___917 temp___9171)) 0) (= (temp___String_Literal_916 Tuple0) temp___919)))
(assert (=> (= (length (mk___t temp___917 temp___9171)) 0) (= (mk 1 3) temp___9191)))
(assert (=> (not (= (length (mk___t temp___917 temp___9171)) 0)) (=> (<= 1 3) (= o13 (+ (- 3 1) 1)))))
(assert (=> (not (= (length (mk___t temp___917 temp___9171)) 0)) (=> (not (<= 1 3)) (= o13 0))))
(assert (=> (not (= (length (mk___t temp___917 temp___9171)) 0)) (=> (<= (to_rep1 (first temp___9171)) (to_rep1 (last temp___9171))) (= o14 (+ (- (to_rep1 (last temp___9171)) (to_rep1 (first temp___9171))) 1)))))
(assert (=> (not (= (length (mk___t temp___917 temp___9171)) 0)) (=> (not (<= (to_rep1 (first temp___9171)) (to_rep1 (last temp___9171)))) (= o14 0))))
(assert (=> (not (= (length (mk___t temp___917 temp___9171)) 0)) (= o15 (+ o14 o13))))
(assert (=> (not (= (length (mk___t temp___917 temp___9171)) 0)) (= o16 (+ (to_rep1 (first temp___9171)) o15))))
(assert (=> (not (= (length (mk___t temp___917 temp___9171)) 0)) (= o17 (- o16 1))))
(assert (=> (not (= (length (mk___t temp___917 temp___9171)) 0)) (and (= o18 o17) (in_range2 o17))))
(assert (=> (not (= (length (mk___t temp___917 temp___9171)) 0)) (= (concat1 temp___917 (to_rep1 (first temp___9171)) (to_rep1 (last temp___9171)) (temp___String_Literal_916 Tuple0) 1 3) temp___919)))
(assert (=> (not (= (length (mk___t temp___917 temp___9171)) 0)) (= (mk (to_rep1 (first temp___9171)) o18) temp___9191)))
(assert (not (= (length (mk___t temp___919 temp___9191)) 0)))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue)))))) (= o19 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 returnvalue))))))) (= o19 0)))
(assert (=> (<= (to_rep1 (first temp___9191)) (to_rep1 (last temp___9191))) (= o20 (+ (- (to_rep1 (last temp___9191)) (to_rep1 (first temp___9191))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___9191)) (to_rep1 (last temp___9191)))) (= o20 0)))
(assert (= o21 (+ o20 o19)))
(assert (= o22 (+ (to_rep1 (first temp___9191)) o21)))
(assert (= o23 (- o22 1)))
(assert (not (in_range2 o23)))
(check-sat)
(exit)
