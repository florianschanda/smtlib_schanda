...
(assert (and (= o6 (remove b o3)) (and (dynamic_invariant1 o6 true false true) (and (= (invariant__ o6) true) (and (= (to_rep1 (last o5)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o3 1))) (= (to_rep (select (elts b) k)) (to_rep (select o4 k))))) (and (forall ((k Int)) (=> (and (<= (+ o3 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o4 (- k 1)))))) (forall ((k Int)) (=> (and (<= o3 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o4 k))))))))))))
(assert (and (= o (to_rep1 (first (rt a)))) (in_range2 (to_rep1 (first (rt a))))))
(assert (and (= o7 (remove a o)) (and (dynamic_invariant1 o7 true false true) (and (= (invariant__ o7) true) (and (= (to_rep1 (last o2)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o 1))) (= (to_rep (select (elts a) k)) (to_rep (select o1 k))))) (and (forall ((k Int)) (=> (and (<= (+ o 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o1 (- k 1)))))) (forall ((k Int)) (=> (and (<= o k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o1 k))))))))))))
(assert (and (= perm__perm_reflexive__induction_hypothesis__B_3__ih__assume (induction_hypothesis o7 o6)) (and (in_range1 perm__perm_reflexive__induction_hypothesis__B_3__ih__assume) (=> (= (of_int perm__perm_reflexive__induction_hypothesis__B_3__ih__assume) true) (= (is_perm o7 o6) true)))))
(assert (= perm__perm_reflexive__induction_hypothesis__B_3__ih__assume ih))
(assert (in_range1 ih))
(assert (not (= (of_int ih) true)))
(check-sat)
(exit)
