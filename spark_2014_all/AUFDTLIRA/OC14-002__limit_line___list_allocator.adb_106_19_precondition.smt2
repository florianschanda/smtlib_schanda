...
(assert (=> (= result14 true) (and (= o61 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (= result14 true) (and (= o62 (get (rec__list_allocator__m__t__available model____split_fields4) o61)) (in_range7 o62))))
(assert (=> (not (= result14 true)) (= o62 0)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
