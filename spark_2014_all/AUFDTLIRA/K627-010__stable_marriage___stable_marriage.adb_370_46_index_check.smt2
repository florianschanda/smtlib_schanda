...
(assert (forall ((g2_id Int)) (=> (and (<= 1 g2_id) (<= g2_id 64)) (=> (not (= (select unmatched_g2_set2 g2_id) true)) (forall ((idx1 Int)) (=> (and (<= 1 idx1) (<= idx1 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (not (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) idx1)) (to_rep (select result__2 g2_id))))))))))
(assert (forall ((g1_id1 Int)) (=> (and (<= 1 g1_id1) (<= g1_id1 64)) (forall ((rank3 Int)) (=> (and (<= 1 rank3) (<= rank3 (to_rep3 (select proposals_made1 g1_id1)))) (and (not (= (select unmatched_g2_set2 (to_rep1 (select (select ranking_1 g1_id1) rank3))) true)) (=> (not (= (to_rep (select result__2 (to_rep1 (select (select ranking_1 g1_id1) rank3)))) g1_id1)) (not (= (is_preferred_1 g1_id1 (to_rep (select result__2 (to_rep1 (select (select ranking_1 g1_id1) rank3)))) (select ranking_2 (to_rep1 (select (select ranking_1 g1_id1) rank3)))) true)))))))))
(assert (forall ((g1_id1 Int)) (=> (and (<= 1 g1_id1) (<= g1_id1 64)) (=> (= (to_rep3 (select proposals_made1 g1_id1)) 0) (exists ((idx1 Int)) (and (and (<= 1 idx1) (<= idx1 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) idx1)) g1_id1)))))))
(assert (<= 1 g1_id))
(assert (<= g1_id 64))
(assert (<= 1 idx))
