...
(assert (= result3 perm__remove_eq__result4))
(assert (= (of_int perm__remove_eq__result4) true))
(assert (not (= (let ((temp___569 (remove b i))) (let ((temp___568 (remove a i))) (bool_eq (elts temp___568) (to_rep1 (first (rt temp___568))) (to_rep1 (last (rt temp___568))) (elts temp___569) (to_rep1 (first (rt temp___569))) (to_rep1 (last (rt temp___569)))))) true)))
(check-sat)
(exit)
