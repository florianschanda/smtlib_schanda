...
(assert (=> (= result true) (= o4 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result true) (= o5 (ite (not (= o4 true)) true false))))
(assert (=> (= result true) (and (= o1 (thecurrentop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (in_range8 o1))))
(assert (=> (= result true) (= o2 (ite (= o1 3) true false))))
(assert (=> (= result true) (= o3 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1))))))
