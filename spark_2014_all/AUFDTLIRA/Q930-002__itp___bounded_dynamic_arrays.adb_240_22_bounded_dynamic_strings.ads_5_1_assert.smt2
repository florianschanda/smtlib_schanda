...
(define-fun bounded_dynamic_strings__location__2__result10 () int__ref (mk_int__ref bounded_dynamic_strings__location__2__result8))
(define-fun k10 () int__ref (mk_int__ref k8))
(define-fun bounded_dynamic_strings__location__2__result11 () int__ref (mk_int__ref bounded_dynamic_strings__location__2__result6))
(define-fun k11 () int__ref (mk_int__ref k6))
(define-fun bounded_dynamic_strings__location__2__result12 () int__ref (mk_int__ref bounded_dynamic_strings__location__2__result))
(define-fun k12 () int__ref (mk_int__ref k))
...
(assert (=> (= result true) (and (= o4 (length fragment)) (in_range1 (length fragment)))))
(assert (=> (= result true) (= o5 (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) o4))))
(assert (=> (= result true) (= temp___1306 (+ o5 1))))
(assert (=> (= result true) (= (mk_int__ref result1) k12)))
(assert (=> (= result true) (= k2 1)))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= temp___1295 k2))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (and (= o6 (length fragment)) (in_range1 (length fragment))))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= o7 (+ k2 o6)))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= temp___1292 (- o7 1)))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (=> (<= k2 temp___1292) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k2) (<= k2 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) temp___1292) (<= temp___1292 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))))))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= o8 (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within)))))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= o8 temp___1294))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= (mk3 k2 temp___1292) temp___12941))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= result2 (bool_eq temp___1294 (to_rep1 (first6 temp___12941)) (to_rep1 (last6 temp___12941)) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment))))))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (not (= result2 true)))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= bounded_dynamic_strings__location__2__result2 bounded_dynamic_strings__location__2__result))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= bounded_dynamic_strings__location__2__result2 bounded_dynamic_strings__location__2__result1))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (forall ((j Int)) (=> (and (<= 1 j) (<= j k3)) (not (= (bool_eq (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) (to_rep1 (first8 (mk4 j (- (+ j (length fragment)) 1)))) (to_rep1 (last8 (mk4 j (- (+ j (length fragment)) 1)))) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))) true)))))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (and (=> (<= 1 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1)) (dynamic_property5 1 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1) k3)) (and (<= 1 k3) (<= k3 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1)))))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= k3 temp___1306))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= bounded_dynamic_strings__location__2__result3 bounded_dynamic_strings__location__2__result4))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= k3 k4))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= bounded_dynamic_strings__location__2__result5 bounded_dynamic_strings__location__2__result3))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= k5 k3))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= bounded_dynamic_strings__location__2__result11 (mk_int__ref bounded_dynamic_strings__location__2__result4)))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= k11 (mk_int__ref k4)))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= bounded_dynamic_strings__location__2__result7 bounded_dynamic_strings__location__2__result5))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1306)) (= k7 k5))))
(assert (=> (= result true) (=> (not (and (<= 1 k2) (<= k2 temp___1306))) (= bounded_dynamic_strings__location__2__result11 bounded_dynamic_strings__location__2__result12))))
(assert (=> (= result true) (=> (not (and (<= 1 k2) (<= k2 temp___1306))) (= k2 k6))))
(assert (=> (= result true) (=> (not (and (<= 1 k2) (<= k2 temp___1306))) (= bounded_dynamic_strings__location__2__result7 bounded_dynamic_strings__location__2__result1))))
(assert (=> (= result true) (=> (not (and (<= 1 k2) (<= k2 temp___1306))) (= k7 k2))))
(assert (=> (= result true) (= bounded_dynamic_strings__location__2__result10 bounded_dynamic_strings__location__2__result11)))
(assert (=> (= result true) (= k10 k11)))
(assert (=> (= result true) (= bounded_dynamic_strings__location__2__result9 bounded_dynamic_strings__location__2__result7)))
(assert (=> (= result true) (= k9 k7)))
(assert (=> (not (= result true)) (= bounded_dynamic_strings__location__2__result10 bounded_dynamic_strings__location__2__result12)))
(assert (=> (not (= result true)) (= k10 k12)))
(assert (=> (not (= result true)) (= bounded_dynamic_strings__location__2__result9 bounded_dynamic_strings__location__2__result1)))
(assert (=> (not (= result true)) (= k9 k1)))
(assert (not (not (= (contains__2 within fragment) true))))
(check-sat)
(exit)
