...
(assert (=> (= result true) (= temp___1243 (+ o5 1))))
(assert (=> (= result true) (= (mk_int__ref result1) (mk_int__ref k))))
(assert (=> (= result true) (= k2 1)))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1243)) (and (and (= temp___1232 k2) (and (and (and (and (and (and (and (= o6 (length fragment)) (in_range1 (length fragment))) (= o7 (+ k2 o6))) (= temp___1229 (- o7 1))) (and (and (=> (<= k2 temp___1229) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k2) (<= k2 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) temp___1229) (<= temp___1229 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))))) (= o8 (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) (and (= o8 temp___1231) (= (mk3 k2 temp___1229) temp___12311)))) (= result2 (bool_eq temp___1231 (to_rep1 (first6 temp___12311)) (to_rep1 (last6 temp___12311)) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))))) (and (not (= result2 true)) (and (= bounded_dynamic_strings__location__2__result2 bounded_dynamic_strings__location__2__result) (= bounded_dynamic_strings__location__2__result2 bounded_dynamic_strings__location__2__result1)))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 k3)) (not (= (bool_eq (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) (to_rep1 (first8 (mk4 j1 (- (+ j1 (length fragment)) 1)))) (to_rep1 (last8 (mk4 j1 (- (+ j1 (length fragment)) 1)))) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))) true)))) (and (and (=> (<= 1 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1)) (dynamic_property5 1 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1) k3)) (and (<= 1 k3) (<= k3 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1)))) (= k3 temp___1243))))) (and (and (= bounded_dynamic_strings__location__2__result3 bounded_dynamic_strings__location__2__result9) (= k3 k9)) (and (= bounded_dynamic_strings__location__2__result10 bounded_dynamic_strings__location__2__result3) (= k10 k3)))))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1243)) (= (mk_int__ref bounded_dynamic_strings__location__2__result11) (mk_int__ref bounded_dynamic_strings__location__2__result9)))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1243)) (= (mk_int__ref k11) (mk_int__ref k9)))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1243)) (= bounded_dynamic_strings__location__2__result12 bounded_dynamic_strings__location__2__result10))))
(assert (=> (= result true) (=> (and (<= 1 k2) (<= k2 temp___1243)) (= k12 k10))))
(assert (=> (= result true) (=> (not (and (<= 1 k2) (<= k2 temp___1243))) (= (mk_int__ref bounded_dynamic_strings__location__2__result11) (mk_int__ref bounded_dynamic_strings__location__2__result)))))
(assert (=> (= result true) (=> (not (and (<= 1 k2) (<= k2 temp___1243))) (= k2 k11))))
(assert (=> (= result true) (=> (not (and (<= 1 k2) (<= k2 temp___1243))) (= bounded_dynamic_strings__location__2__result12 bounded_dynamic_strings__location__2__result1))))
(assert (=> (= result true) (=> (not (and (<= 1 k2) (<= k2 temp___1243))) (= k12 k2))))
(assert (=> (= result true) (= (mk_int__ref bounded_dynamic_strings__location__2__result13) (mk_int__ref bounded_dynamic_strings__location__2__result11))))
(assert (=> (= result true) (= (mk_int__ref k13) (mk_int__ref k11))))
(assert (=> (= result true) (= bounded_dynamic_strings__location__2__result14 bounded_dynamic_strings__location__2__result12)))
(assert (=> (= result true) (= k14 k12)))
(assert (=> (not (= result true)) (= (mk_int__ref bounded_dynamic_strings__location__2__result13) (mk_int__ref bounded_dynamic_strings__location__2__result))))
(assert (=> (not (= result true)) (= (mk_int__ref k13) (mk_int__ref k))))
(assert (=> (not (= result true)) (= bounded_dynamic_strings__location__2__result14 bounded_dynamic_strings__location__2__result1)))
(assert (=> (not (= result true)) (= k14 k1)))
