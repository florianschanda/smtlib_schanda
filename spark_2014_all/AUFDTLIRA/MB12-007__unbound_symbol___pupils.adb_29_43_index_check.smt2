...
(assert (= temp___442 (rec__pupils__pupiltype__scores o56)))
(assert (= o57 (select temp___442 (to_rep1 (rec__pupils__subject_score_pair__subj (us_split_fields7 (select subject_scores1 i1)))))))
