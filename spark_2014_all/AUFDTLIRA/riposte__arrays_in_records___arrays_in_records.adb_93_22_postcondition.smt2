...
(declare-const temp___262 index)
(declare-const temp___2621 (Array Int value))
(declare-const temp___2622 (Array Int value))
...
(declare-const temp___265 index)
(declare-const temp___2651 (Array Int value))
(declare-const temp___2652 (Array Int value))
...
(assert (= temp___262 o2))
(assert (= temp___2621 o3))
(assert (= temp___2622 o4))
(assert (= result a__split_fields))
(assert (= result1 a__split_fields1))
(assert (= result2 a__split_fields2))
(assert (= temp___262 a__split_fields3))
(assert (= temp___2621 a__split_fields4))
(assert (= temp___2622 a__split_fields5))
(assert (= (to_rep o5) 23))
...
(assert (= temp___265 a__split_fields6))
(assert (= temp___2651 a__split_fields7))
(assert (= temp___2652 a__split_fields8))
