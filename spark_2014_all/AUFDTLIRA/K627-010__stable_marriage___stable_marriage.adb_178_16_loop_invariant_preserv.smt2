...
(assert (forall ((g24 Int)) (=> (and (<= 1 g24) (<= g24 64)) (= (is_permutation_1 (select r2 g24)) true))))
...
(assert (and (= o (invert_1 (select r2 g22))) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep1 (select o (to_rep (select (select r2 g22) rank)))) rank))) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (to_rep (select (select r2 g22) (to_rep1 (select o g1)))) g1))))))
...
(assert (<= 1 prev))
(assert (<= prev (- g23 1)))
(assert (not (= (bool_eq2 (select result__3 prev) 1 64 (invert_1 (select r2 prev)) 1 64) true)))
(check-sat)
(exit)
