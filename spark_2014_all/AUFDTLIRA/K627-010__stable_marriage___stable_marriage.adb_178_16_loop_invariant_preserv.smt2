...
(assert (and (= o2 (invert_1 (select r2 g23))) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep1 (select o2 (to_rep (select (select r2 g23) rank)))) rank))) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (to_rep (select (select r2 g23) (to_rep1 (select o2 g1)))) g1))))))
(assert (= o3 (store result__2 g23 o2)))
...
(assert (<= 1 prev1))
(assert (<= prev1 (- g24 1)))
(assert (not (= (bool_eq2 (select result__3 prev1) 1 64 (invert_1 (select r2 prev1)) 1 64) true)))
(check-sat)
(exit)
