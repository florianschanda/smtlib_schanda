...
(assert (and (= o36 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0)) (and (in_range3 o36) (= o36 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 0)))))
(assert (= o37 (select res3 o36)))
(assert (= o38 (us_split_fields11 o37)))
(assert (= o39 (rec__red_black_trees__black_count__count o38)))
(assert (= o40 (to_rep o39)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0) (= o41 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0)) (= o41 0)))
(assert (= o42 (+ o41 o40)))
(assert (and (= o43 o42) (in_range1 o42)))
(assert (= o44 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 j)))) o43) true false)))
(assert (and (= o26 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 1)) (and (in_range3 o26) (= o26 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 1)))))
(assert (= o27 (select res3 o26)))
...
(assert (= o35 (ite (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))) o34) true false)))
