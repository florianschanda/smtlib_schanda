...
(assert (and (= o19 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0)) (and (in_range2 o19) (= o19 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 0)))))
(assert (= o20 (select res3 o19)))
(assert (= o21 (us_split_fields11 o20)))
(assert (= o22 (rec__red_black_trees__black_count__count o21)))
(assert (= o23 (to_rep o22)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0) (= o24 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0)) (= o24 0)))
(assert (= o25 (+ o24 o23)))
(assert (and (= o26 o25) (in_range7 o25)))
(assert (= o27 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 j)))) o26) true false)))
(assert (and (= o9 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 1)) (and (in_range2 o9) (= o9 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 1)))))
(assert (= o10 (select res3 o9)))
(assert (= o11 (us_split_fields11 o10)))
(assert (= o12 (rec__red_black_trees__black_count__depth o11)))
...
(assert (= o8 (rec__red_black_trees__black_count__depth o7)))
(assert (= o14 (to_rep o8)))
(assert (= o15 (ite (< o14 o13) o13 o14)))
(assert (= o16 (+ 1 o15)))
(assert (and (= o17 o16) (in_range7 o16)))
(assert (= o18 (ite (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))) o17) true false)))
