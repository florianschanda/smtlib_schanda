...
(assert (= o107 (ite (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j4)))) o106) true false)))
(assert (and (= o89 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j4 1)) (and (in_range3 o89) (= o89 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j4 1)))))
(assert (= o90 (select res3 o89)))
(assert (= o91 (us_split_fields11 o90)))
(assert (= o92 (rec__red_black_trees__black_count__count o91)))
