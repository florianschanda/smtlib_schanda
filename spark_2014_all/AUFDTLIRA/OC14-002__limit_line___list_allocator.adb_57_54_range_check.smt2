...
(assert (and (= o29 (get model____split_fields1 j)) (in_range7 o29)))
(assert (= result14 (ite (in_range4 o29) true false)))
(assert (=> (= result14 true) (and (= o25 (length model____split_fields1)) (in_range6 o25))))
(assert (=> (= result14 true) (= result15 (ite (< j o25) true false))))
(assert (=> (= result14 true) (=> (= result15 true) (and (= o26 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result14 true) (=> (= result15 true) (and (= o27 (get model____split_fields1 o26)) (in_range7 o27)))))
(assert (=> (= result14 true) (=> (not (= result15 true)) (= o27 0))))
(assert (=> (= result14 true) (and (= temp___387 (get model____split_fields1 j)) (in_range7 temp___387))))
(assert (=> (= result14 true) (and (<= 1 temp___387) (<= temp___387 3))))
(assert (=> (= result14 true) (= o17 temp___387)))
(assert (=> (= result14 true) (= (mk___rep (mk___split_fields o18 o19 o20)) (select data o17))))
(assert (=> (= result14 true) (= o18 o21)))
(assert (=> (= result14 true) (= o19 o22)))
(assert (=> (= result14 true) (= o20 o23)))
(assert (=> (= result14 true) (= o24 o23)))
(assert (=> (= result14 true) (= o28 (to_rep o24))))
(assert (=> (= result14 true) (= result13 (ite (= o28 o27) true false))))
