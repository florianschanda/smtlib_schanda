...
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o21) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o20 (get model____split_fields 1)) (in_range7 o20)))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (= result2 (ite (= o20 first_available) true false)))))
...
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o22 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o18 (length model____split_fields1)) (in_range6 o18)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o18) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o17 (get model____split_fields1 1)) (in_range7 o17))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (= result1 (ite (= o17 first_allocated) true false))))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (not (= result4 true)) (= result1 false)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o19 (length model____split_fields1)) (in_range6 o19)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o19 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o15 (length model____split_fields)) (in_range6 o15))))
...
(assert (= result6 true))
(assert (and (= o14 (get model____split_fields1 j)) (in_range7 o14)))
(assert (= result8 (ite (in_range4 o14) true false)))
(assert (=> (= result8 true) (and (= o10 (length model____split_fields1)) (in_range6 o10))))
(assert (=> (= result8 true) (= result9 (ite (< j o10) true false))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o11 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o12 (get model____split_fields1 o11)) (in_range7 o12)))))
(assert (=> (= result8 true) (=> (not (= result9 true)) (= o12 0))))
(assert (=> (= result8 true) (and (= temp___420 (get model____split_fields1 j)) (in_range7 temp___420))))
(assert (=> (= result8 true) (and (<= 1 temp___420) (<= temp___420 3))))
(assert (=> (= result8 true) (= o2 temp___420)))
(assert (=> (= result8 true) (= (mk___rep (mk___split_fields o3 o4 o5)) (select data o2))))
