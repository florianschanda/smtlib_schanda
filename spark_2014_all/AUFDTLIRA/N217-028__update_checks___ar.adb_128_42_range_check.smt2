...
(declare-fun temp_____aggregate_def_306 ((Array Int et1) Int Int Int) (Array Int et1))
(assert (forall ((temp___308 (Array Int et1))) (forall ((temp___309 Int) (temp___310 Int) (temp___311 Int)) (let ((temp___307 (temp_____aggregate_def_306 temp___308 temp___309 temp___310 temp___311))) (=> (and (and (dynamic_invariant temp___309 true true true true) (dynamic_invariant temp___310 true true true true)) (dynamic_invariant1 temp___311 true true true true)) (forall ((temp___312 Int)) (ite (or (= temp___312 temp___309) (= temp___312 temp___310)) (= (to_rep (select temp___307 temp___312)) temp___311) (= (select temp___307 temp___312) (select temp___308 temp___312)))))))))
(assert (in_range i))
(assert (in_range j))
(assert (in_range1 e))
