...
(assert (= k27 o39))
(assert (= temp___2092 (mk_int__ref temp___2091)))
(assert (= temp___2102 (mk_int__ref temp___2101)))
(assert (= k28 (mk_int__ref k27)))
(assert (= j49 (mk_int__ref j48)))
(assert (= tab41 (mk_map__ref tab40)))
(assert (= temp___2093 temp___2091))
(assert (= temp___2103 temp___2101))
(assert (= k29 k27))
(assert (= j50 j48))
(assert (= tab42 tab40))
(declare-const l Int)
