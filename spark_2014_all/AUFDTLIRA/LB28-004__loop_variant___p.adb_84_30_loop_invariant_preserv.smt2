...
(assert (= k32 o72))
(assert (= j65 (+ a k33)))
(assert (forall ((l8 Int)) (=> (and (<= a l8) (<= l8 (- j65 1))) (= (to_rep (select tab55 l8)) l8))))
(assert (forall ((l8 Int)) (=> (and (<= a l8) (<= l8 (- (+ a k33) 1))) (= (to_rep (select tab55 l8)) l8))))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j65)) (=> (<= (- 2147483648) 2147483647) (in_range1 k33))))
(assert (= result61 (mk_int__ref temp___1861)))
(assert (= temp___1862 j65))
(assert (= result62 (mk_int__ref temp___1871)))
(assert (= temp___1872 k33))
(assert (<= j65 b))
(assert (= (to_rep o80) j65))
(assert (and (<= (to_rep tab__first) j65) (<= j65 (to_rep tab__last))))
(assert (= o81 j65))
(assert (= o82 (store tab55 o81 o80)))
(assert (= result63 (mk_map__ref tab55)))
(assert (= tab56 o82))
(assert (and (= o83 (+ j65 1)) (in_range1 (+ j65 1))))
(assert (= result64 (mk_int__ref j65)))
(assert (= j66 o83))
(assert (and (= o84 (+ k33 1)) (in_range1 (+ k33 1))))
(assert (= result65 (mk_int__ref k33)))
(assert (= k34 o84))
(assert (= temp___1863 (mk_int__ref temp___1862)))
(assert (= temp___1873 (mk_int__ref temp___1872)))
(assert (= k35 (mk_int__ref k34)))
(assert (= j67 (mk_int__ref j66)))
(assert (= tab57 (mk_map__ref tab56)))
(assert (= temp___1864 temp___1862))
(assert (= temp___1874 temp___1872))
(assert (= k36 k34))
(assert (= j68 j66))
(assert (= tab58 tab56))
(declare-const l8 Int)
(assert (<= a l8))
(assert (<= l8 (- (int__content j67) 1)))
(assert (not (= (to_rep (select (map__content tab57) l8)) l8)))
(check-sat)
(exit)
