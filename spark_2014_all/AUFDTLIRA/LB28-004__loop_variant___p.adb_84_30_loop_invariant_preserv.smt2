...
(declare-const temp___1872 int__ref)
(declare-const temp___1862 int__ref)
...
(define-fun tab43 () map__ref (mk_map__ref tab))
(assert (in_range1 a))
(assert (in_range1 b))
...
(assert (=> (<= j1 b) (= (mk_map__ref result1) tab43)))
(assert (=> (<= j1 b) (= tab2 o2)))
...
(assert (= result40 (mk_int__ref temp___186)))
(assert (= temp___1861 j47))
(assert (= result41 (mk_int__ref temp___187)))
(assert (= temp___1871 k26))
(assert (<= j47 b))
(assert (= (to_rep o35) j47))
(assert (and (<= (to_rep tab__first) j47) (<= j47 (to_rep tab__last))))
(assert (= o36 j47))
(assert (= o37 (store tab39 o36 o35)))
(assert (= result42 (mk_map__ref tab39)))
(assert (= tab40 o37))
(assert (and (= o38 (+ j47 1)) (in_range1 (+ j47 1))))
(assert (= result43 (mk_int__ref j47)))
(assert (= j48 o38))
(assert (and (= o39 (+ k26 1)) (in_range1 (+ k26 1))))
(assert (= result44 (mk_int__ref k26)))
(assert (= k27 o39))
(assert (= temp___1862 (mk_int__ref temp___1861)))
(assert (= temp___1872 (mk_int__ref temp___1871)))
(assert (= k28 (mk_int__ref k27)))
(assert (= j49 (mk_int__ref j48)))
(assert (= tab41 (mk_map__ref tab40)))
(assert (= temp___1863 temp___1861))
(assert (= temp___1873 temp___1871))
(assert (= k29 k27))
(assert (= j50 j48))
(assert (= tab42 tab40))
(declare-const l Int)
(assert (<= a l))
(assert (<= l (- (int__content j49) 1)))
(assert (not (= (to_rep (select (map__content tab41) l)) l)))
(check-sat)
(exit)
