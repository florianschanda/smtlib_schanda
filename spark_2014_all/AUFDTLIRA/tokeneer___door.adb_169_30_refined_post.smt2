...
(assert (=> (= systemfault true) (= systemfault1 systemfault)))
(assert (=> (not (= systemfault true)) (=> (not (= currentdoor newdoor1)) (=> (= newdoor1 1) (= (mk_int__ref result) id6)))))
(assert (=> (not (= systemfault true)) (=> (not (= currentdoor newdoor1)) (=> (= newdoor1 1) (= id2 6)))))
(assert (=> (not (= systemfault true)) (=> (not (= currentdoor newdoor1)) (=> (not (= newdoor1 1)) (= (mk_int__ref result1) id6)))))
...
(assert (=> (not (= systemfault true)) (=> (not (= currentdoor newdoor1)) (= (valid_numberlogentries state4) true))))
(assert (=> (not (= systemfault true)) (=> (not (= currentdoor newdoor1)) (= result2 currentdoor))))
(assert (=> (not (= systemfault true)) (=> (not (= currentdoor newdoor1)) (= currentdoor2 newdoor1))))
(assert (=> (not (= systemfault true)) (=> (not (not (= currentdoor newdoor1))) (= filestate3 filestate))))
(assert (=> (not (= systemfault true)) (=> (not (not (= currentdoor newdoor1))) (= state4 state))))
...
(assert (and (= (= (islocked state5) true) (= (greaterthanorequal (thecurrenttime currenttime) (latch_timeout state5)) true)) (= (bool_eq2 (latch_timeout state5) (latch_timeout state1)) true)))
(assert (and (= (and (and (= currentdoor2 0) (= (islocked state5) true)) (= (greaterthanorequal (thecurrenttime currenttime) (mk___rep (mk___split_fields alarmtimeout__split_fields alarmtimeout__split_fields1 alarmtimeout__split_fields2 alarmtimeout__split_fields3))) true)) (= dooralarm1 0)) (in_range4 dooralarm1)))
(assert (= state8 (mk___private__ref state5)))
(assert (= filestate5 (mk___private__ref filestate4)))
(assert (= state7 state6))
(assert (= id4 id2))
(assert (= newdoor2 newdoor1))
...
(assert (= currentdoor3 0))
(assert (= (islocked (us_private__content state8)) true))
(assert (= (greaterthanorequal (thecurrenttime currenttime) (mk___rep (mk___split_fields alarmtimeout__split_fields alarmtimeout__split_fields1 alarmtimeout__split_fields2 alarmtimeout__split_fields3))) true))
(assert (not (= dooralarm2 0)))
(check-sat)
(exit)
