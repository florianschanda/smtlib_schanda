...
(assert (= result2 true))
(assert (and (= o22 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f1)) j1))))) (in_range4 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f1)) j1)))))))
...
(assert (= o19 (select temp___1108 j1)))
...
(assert (= o16 (select temp___1107 j1)))
...
(assert (= o9 (select temp___1101 o8)))
