...
(define-fun default_initial_assumption ((temp___expr_811 us_rep) (temp___skip_top_level_812 Bool)) Bool (and (= (attr__tag temp___expr_811) us_tag1) (=> (not (= temp___skip_top_level_812 true)) (= (length1 temp___expr_811) 0))))
