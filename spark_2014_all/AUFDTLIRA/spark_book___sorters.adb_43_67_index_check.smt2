...
(assert (=> (and (<= (to_rep (first (rt unsorted))) index1) (<= index1 (to_rep (last (rt unsorted))))) (and (and (= temp___219 index1) (and (= temp___218 min1) (and (and (and (<= (to_rep (first (rt unsorted))) min2) (<= min2 (to_rep (last (rt unsorted))))) (forall ((j2 Int)) (=> (and (<= (to_rep (first (rt unsorted))) j2) (<= j2 (- index2 1))) (<= (to_rep (select (elts unsorted) min2)) (to_rep (select (elts unsorted) j2)))))) (and (and (and (=> (<= 1 2147483647) (in_range2 min2)) (=> (<= (to_rep (first (rt unsorted))) (to_rep (last (rt unsorted)))) (dynamic_property1 (to_rep (first (rt unsorted))) (to_rep (last (rt unsorted))) index2))) (and (<= (to_rep (first (rt unsorted))) index2) (<= index2 (to_rep (last (rt unsorted)))))) (and (and (and (and (and (and (and (<= (to_rep (first (rt unsorted))) min2) (<= min2 (to_rep (last (rt unsorted))))) (= o6 min2)) (= o7 (select (elts unsorted) o6))) (= o8 (to_rep o7))) (= result3 (ite (< (to_rep (select (elts unsorted) index2)) o8) true false))) (ite (= result3 true) (and (and (= o9 index2) (in_range2 index2)) (and (= min2 result4) (= min3 o9))) (= min3 min2))) (= index2 (to_rep (last (rt unsorted))))))))) (and (and (= index2 index6) (= min3 min6)) (and (= index7 index2) (= min7 min3))))))
(assert (=> (and (<= (to_rep (first (rt unsorted))) index1) (<= index1 (to_rep (last (rt unsorted))))) (= (mk_int__ref index8) (mk_int__ref index6))))
(assert (=> (and (<= (to_rep (first (rt unsorted))) index1) (<= index1 (to_rep (last (rt unsorted))))) (= (mk_int__ref min8) (mk_int__ref min6))))
(assert (=> (and (<= (to_rep (first (rt unsorted))) index1) (<= index1 (to_rep (last (rt unsorted))))) (= index9 index7)))
(assert (=> (and (<= (to_rep (first (rt unsorted))) index1) (<= index1 (to_rep (last (rt unsorted))))) (= min9 min7)))
(assert (=> (not (and (<= (to_rep (first (rt unsorted))) index1) (<= index1 (to_rep (last (rt unsorted)))))) (= index1 index8)))
(assert (=> (not (and (<= (to_rep (first (rt unsorted))) index1) (<= index1 (to_rep (last (rt unsorted)))))) (= min1 min8)))
(assert (=> (not (and (<= (to_rep (first (rt unsorted))) index1) (<= index1 (to_rep (last (rt unsorted)))))) (= index9 index1)))
(assert (=> (not (and (<= (to_rep (first (rt unsorted))) index1) (<= index1 (to_rep (last (rt unsorted)))))) (= min9 min1)))
...
(assert (not (<= (to_rep (first (rt unsorted))) j1)))
(check-sat)
(exit)
