...
(assert (and (= o10 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range5 o10) (<= o10 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
(assert (= result5 (ite (= o10 o9) true false)))
(assert (=> (= result5 true) (and (= o5 (- last5 i9)) (in_range1 (- last5 i9)))))
(assert (=> (= result5 true) (= o6 (+ o5 1))))
(assert (=> (= result5 true) (and (= o7 o6) (in_range1 o6))))
(assert (=> (= result5 true) (and (= o4 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o4 true false true true) (and (= (to_rep (first (rt o4))) 1) (<= 0 (to_rep (last (rt o4)))))))))
