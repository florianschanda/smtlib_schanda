...
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length (rec__list_allocator__m__t__available model____split_fields3)))) (and (and (and (in_range7 (get (rec__list_allocator__m__t__available model____split_fields3) j2)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j2))))) (ite (< j2 (length (rec__list_allocator__m__t__available model____split_fields3))) (get (rec__list_allocator__m__t__available model____split_fields3) (+ j2 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j2))))) (ite (< 1 j2) (get (rec__list_allocator__m__t__available model____split_fields3) (- j2 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length (rec__list_allocator__m__t__available model____split_fields3)))) (=> (not (= j2 k)) (not (= (get (rec__list_allocator__m__t__available model____split_fields3) j2) (get (rec__list_allocator__m__t__available model____split_fields3) k))))))))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (and (and (and (in_range7 (get (rec__list_allocator__m__t__allocated model____split_fields3) j2)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__allocated model____split_fields3) j2))))) (ite (< j2 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (get (rec__list_allocator__m__t__allocated model____split_fields3) (+ j2 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__allocated model____split_fields3) j2))))) (ite (< 1 j2) (get (rec__list_allocator__m__t__allocated model____split_fields3) (- j2 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (=> (not (= j2 k)) (not (= (get (rec__list_allocator__m__t__allocated model____split_fields3) j2) (get (rec__list_allocator__m__t__allocated model____split_fields3) k))))))))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (bool_eq2 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j2)) (select data3 (get ma1 (+ j2 1)))) true))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- (length ma1) 2))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get ma1 (+ j2 1)))))) (get ma1 (+ j2 2))))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- (length (rec__list_allocator__m__t__available model____split_fields3)) 1))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get ma1 (+ j2 1)))))) (get ma1 (+ j2 2))))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get ma1 (+ j2 1)))))) (ite (< j2 (length (rec__list_allocator__m__t__available model____split_fields3))) (get ma1 (+ j2 2)) 0)))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length (rec__list_allocator__m__t__available model____split_fields3)))) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j2))))) (ite (< j2 (length (rec__list_allocator__m__t__available model____split_fields3))) (get ma1 (+ j2 2)) 0)))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length (rec__list_allocator__m__t__available model____split_fields3)))) (and (in_range7 (get (rec__list_allocator__m__t__available model____split_fields3) j2)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__available model____split_fields3) j2))))) (ite (< j2 (length (rec__list_allocator__m__t__available model____split_fields3))) (get (rec__list_allocator__m__t__available model____split_fields3) (+ j2 1)) 0))))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (in_range7 (get (rec__list_allocator__m__t__allocated model____split_fields3) j2)))))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (and (in_range7 (get (rec__list_allocator__m__t__allocated model____split_fields3) j2)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields3 (select data3 (get (rec__list_allocator__m__t__allocated model____split_fields3) j2))))) (ite (< j2 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (get (rec__list_allocator__m__t__allocated model____split_fields3) (+ j2 1)) 0))))))
...
(assert (=> (not (= first_available1 0)) (and (= o48 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o48))))
(assert (=> (not (= first_available1 0)) (= result13 (ite (< 0 o48) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (and (= o47 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o47)))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (= result12 (ite (= o47 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result13 true)) (= result12 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o49 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o49))))
(assert (=> (not (not (= first_available1 0))) (= result12 (ite (= o49 0) true false))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (and (= o45 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o45)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (= result14 (ite (< 0 o45) true false)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (and (= o44 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o44))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (= result11 (ite (= o44 first_allocated1) true false))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (not (= result14 true)) (= result11 false)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (and (= o46 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o46)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (= result11 (ite (= o46 0) true false)))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o42 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o42))))
(assert (=> (= result11 true) (= o43 (ite (<= j1 o42) true false))))
(assert (=> (= result11 true) (= result15 (ite (<= 1 j1) o43 false))))
...
(assert (and (= o36 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o36)))
(assert (= o37 (ite (<= j o36) true false)))
(assert (= result16 (ite (<= 1 j) o37 false)))
(assert (= result16 true))
(assert (and (= o41 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o41)))
(assert (= result17 (ite (in_range7 o41) true false)))
(assert (= result17 true))
(assert (and (= o38 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o38)))
(assert (= result18 (ite (< j o38) true false)))
(assert (=> (= result18 true) (and (= o39 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (= result18 true) (and (= o40 (get (rec__list_allocator__m__t__allocated model____split_fields3) o39)) (in_range4 o40))))
(assert (=> (not (= result18 true)) (= o40 0)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
