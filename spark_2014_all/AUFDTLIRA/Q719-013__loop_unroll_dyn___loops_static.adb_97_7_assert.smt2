...
(define-fun bad20 () bool__ref (mk_bool__ref bad8))
(define-fun j19 () int__ref (mk_int__ref j6))
(define-fun bad21 () bool__ref (mk_bool__ref bad6))
...
(assert (not (not (and (and (= (mk_int__ref result1) (mk_int__ref i)) (= i1 1)) (and (and (and (= (to_rep o) 0) (and (and (and (<= (to_rep1 a__first) i1) (<= i1 (to_rep1 a__last))) (= o1 i1)) (= o2 (store a o1 o)))) (and (= (mk_map__ref result2) (mk_map__ref a)) (= a1 o2))) (and (ite (< (to_rep1 a__first) i1) (and (and (and (= (mk_int__ref result3) j20) (= j2 (to_rep1 a__first))) (ite (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (and (and (and (= temp___360 bad1) (and (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) j3) (<= j3 (to_rep1 a__last))) (= o3 j3)) (= o4 (select a1 o3))) (= o5 (to_rep o4))) (= o6 (ite (= o5 0) true false))) (= result4 (ite (not (= o6 true)) true false))) (ite (= result4 true) (and (= bad2 result5) (= bad3 (distinct 1 0))) (= bad3 bad2))) (= j3 i1)))) (and (and (= j3 j4) (= bad3 bad4)) (and (= j5 j3) (= bad5 bad3)))) (and (and (= j19 (mk_int__ref j4)) (= bad21 (mk_bool__ref bad4))) (and (= j7 j5) (= bad7 bad5)))) (and (and (= j2 j6) (= bad1 bad6)) (and (= j7 j2) (= bad7 bad1))))) (and (and (= j18 j19) (= bad20 bad21)) (and (= j9 j7) (= bad9 bad7)))) (and (and (= j18 j20) (= bad1 bad8)) (and (= j9 j1) (= bad9 bad1)))) (and (forall ((j21 Int)) (=> (and (<= (to_rep1 a__first) j21) (<= j21 i1)) (= (to_rep (select a1 j21)) 0))) (and (and (= i1 result6) (= i2 2)) (and (and (and (= (to_rep o7) 0) (and (and (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))) (= o8 i2)) (= o9 (store a1 o8 o7)))) (and (= a1 result7) (= a2 o9))) (and (ite (< (to_rep1 a__first) i2) (and (and (and (= (mk_int__ref result8) j18) (= j10 (to_rep1 a__first))) (ite (and (<= (to_rep1 a__first) j10) (<= j10 i2)) (and (and (and (= temp___3601 bad8) (and (and (<= (to_rep1 a__first) j11) (<= j11 i2)) (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) j11) (<= j11 (to_rep1 a__last))) (= o10 j11)) (= o11 (select a2 o10))) (= o12 (to_rep o11))) (= o13 (ite (= o12 0) true false))) (= result9 (ite (not (= o13 true)) true false))) (ite (= result9 true) (and (and (= bad10 result10) (= bad11 (distinct 1 0))) (and (= bad12 (mk_bool__ref bad11)) (= bad13 bad11))) (and (= bad12 (mk_bool__ref bad10)) (= bad13 bad10)))) (= j11 i2)))) (and (and (= j12 (mk_int__ref j11)) (= bad14 bad12)) (and (= j13 j11) (= bad15 bad13)))) (and (and (= j14 j12) (= bad16 bad14)) (and (= j15 j13) (= bad17 bad15)))) (and (and (= j14 (mk_int__ref j10)) (= bad16 bad20)) (and (= j15 j10) (= bad17 bad9))))) (and (and (= j16 j14) (= bad18 bad16)) (and (= j17 j15) (= bad19 bad17)))) (and (and (= j16 j18) (= bad18 bad20)) (and (= j17 j9) (= bad19 bad9)))) (forall ((j21 Int)) (=> (and (<= (to_rep1 a__first) j21) (<= j21 i2)) (= (to_rep (select a2 j21)) 0)))))))))))))
(check-sat)
(exit)
