...
(declare-const temp___186 (Array Int Bool))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___188 i1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___186 x)))
...
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (forall ((temp___187 Int)) (=> (and (<= 1 temp___187) (<= temp___187 10)) (=> (<= i2 temp___187) (= (select x2 temp___187) (select temp___186 temp___187))))) (=> (<= 1 10) (in_range2 i2))) (and (<= 1 i2) (<= i2 10)))))
