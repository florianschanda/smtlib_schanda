...
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (forall ((temp___164 Int)) (=> (and (<= 1 temp___164) (<= temp___164 10)) (=> (<= i2 temp___164) (= (select x2 temp___164) (select temp___163 temp___164))))) (=> (<= 1 10) (in_range2 i2))) (and (<= 1 i2) (<= i2 10)))))
