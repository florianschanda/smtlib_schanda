...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (= temp___165 i1) (and (= temp___163 x) (and (and (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 (- i2 1))) (= (= (select x2 k2) true) (not (= (select x_old k2) true))))) (forall ((k2 Int)) (=> (and (<= i2 k2) (<= k2 10)) (= (= (select x2 k2) true) (= (select x_old k2) true))))) (and (and (and (forall ((temp___164 Int)) (=> (and (<= 1 temp___164) (<= temp___164 10)) (=> (<= i2 temp___164) (= (select x2 temp___164) (select temp___163 temp___164))))) (=> (<= 1 10) (in_range2 i2))) (and (<= 1 i2) (<= i2 10))) (and (and (= x2 result2) (= x3 (store x2 i2 (ite (not (= (select x2 i2) true)) true false)))) (= i2 10)))))) (and (and (= i2 i6) (= x3 x6)) (and (= i7 i2) (= x7 x3))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_map__ref x8) (mk_map__ref x6))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= i9 i7)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= x9 x7)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= i1 i8)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= (mk_map__ref x8) (mk_map__ref x))))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= i9 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= x9 x1)))
(assert (= i10 i8))
(assert (= (mk_map__ref x10) (mk_map__ref x8)))
(assert (= i11 i9))
(assert (= x11 x9))
(declare-const i12 Int)
(assert (<= 1 i12))
(assert (<= i12 10))
(assert (= (select x10 i12) true))
(assert (not (not (= (select x i12) true))))
(check-sat)
(exit)
