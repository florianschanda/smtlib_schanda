...
(assert (forall ((temp___225 Int) (temp___226 Int) (temp___227 Int)) (let ((temp___224 (temp___223 temp___225 temp___226 temp___227))) (=> (dynamic_invariant4 temp___225 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___226 temp___227) (and (= (first5 temp___224) temp___226) (= (last5 temp___224) temp___227))) (forall ((temp___228 Int)) (= (to_rep2 (select (to_array2 temp___224) temp___228)) temp___225)))))))
...
(assert (in_range r2b))
(assert (= (to_rep3 (first4 (rt2 (temp___223 0 1 r2b)))) 1))
(assert (= (to_rep3 (last4 (rt2 (temp___223 0 1 r2b)))) r2b))
(assert (= (mk___t2 temp___230 temp___2301) (temp___223 0 1 r2b)))
