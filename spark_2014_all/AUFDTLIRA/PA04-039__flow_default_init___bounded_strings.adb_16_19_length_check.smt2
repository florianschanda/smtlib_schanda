...
(assert (forall ((source us_rep)) (! (=> (dynamic_invariant1 source true true true) (= (length1 source) (to_rep1 (rec__bounded_strings__bounded_string__length (us_split_fields1 source))))) :pattern ((length1 source)))))
...
(assert (forall ((temp___199 Int) (temp___200 Int) (temp___201 Int)) (let ((temp___198 (temp___197 temp___199 temp___200 temp___201))) (and (=> (dynamic_property6 1 2147483647 temp___200 temp___201) (and (= (first5 temp___198) temp___200) (= (last5 temp___198) temp___201))) (forall ((temp___202 Int)) (= (select (to_array2 temp___198) temp___202) (of_rep2 temp___199)))))))
...
(define-fun dynamic_invariant5 ((temp___expr_163 us_t1) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool)) Bool (=> (not (= temp___skip_constant_161 true)) (and (dynamic_property3 1 r2b (first3 temp___expr_163) (last3 temp___expr_163)) (and (= (first3 temp___expr_163) 1) (= (last3 temp___expr_163) r2b)))))
...
(assert (dynamic_invariant1 (mk___rep target__split_discrs (mk___split_fields (mk___t target__split_fields target__split_fields1) target__split_fields2)) false false true))
...
(assert (= (ite (<= (to_rep3 (first4 temp___2041)) (to_rep3 (last4 temp___2041))) (+ (- (to_rep3 (last4 temp___2041)) (to_rep3 (first4 temp___2041))) 1) 0) (ite (<= 1 r2b) (+ (- r2b 1) 1) 0)))
(assert (= temp___204 temp___205))
(assert (= (mk1 (to_rep3 (first4 temp___2041)) (to_rep3 (last4 temp___2041))) temp___2051))
(assert (not (= (ite (<= (to_rep3 (first2 temp___2051)) (to_rep3 (last2 temp___2051))) (+ (- (to_rep3 (last2 temp___2051)) (to_rep3 (first2 temp___2051))) 1) 0) (ite (<= (to_rep3 (first target__split_fields1)) (to_rep3 (last target__split_fields1))) (+ (- (to_rep3 (last target__split_fields1)) (to_rep3 (first target__split_fields1))) 1) 0))))
(check-sat)
(exit)
