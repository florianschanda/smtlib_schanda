...
(assert (forall ((f Int) (l Int)) (! (=> (in_range2 f) (=> (in_range2 l) (and (= (to_rep3 (first6 (mk3 f l))) f) (= (to_rep3 (last6 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
...
(define-fun bool_eq5 ((x us_t3) (y us_t3)) Bool (bool_eq (elts3 x) (to_rep3 (first6 (rt3 x))) (to_rep3 (last6 (rt3 x))) (elts3 y) (to_rep3 (first6 (rt3 y))) (to_rep3 (last6 (rt3 y)))))
...
(define-fun dynamic_invariant5 ((temp___expr_96 us_t3) (temp___is_init_92 Bool) (temp___skip_constant_93 Bool) (temp___do_toplevel_94 Bool) (temp___do_typ_inv_95 Bool)) Bool (=> (not (= temp___skip_constant_93 true)) (dynamic_property6 1 2147483647 (first7 temp___expr_96) (last7 temp___expr_96))))
...
(assert (forall ((temp___225 Int) (temp___226 Int) (temp___227 Int)) (let ((temp___224 (temp_____aggregate_def_223 temp___225 temp___226 temp___227))) (=> (dynamic_invariant4 temp___225 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___226 temp___227) (and (= (first5 temp___224) temp___226) (= (last5 temp___224) temp___227))) (forall ((temp___228 Int)) (= (to_rep2 (select (to_array2 temp___224) temp___228)) temp___225)))))))
(define-fun dynamic_invariant7 ((temp___expr_189 us_t1) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (not (= temp___skip_constant_186 true)) (and (dynamic_property3 1 r2b (first3 temp___expr_189) (last3 temp___expr_189)) (and (= (first3 temp___expr_189) 1) (= (last3 temp___expr_189) r2b)))))
...
(assert (dynamic_invariant1 (mk___rep target__split_discrs (mk___split_fields (mk___t target__split_fields target__split_fields1) target__split_fields2)) false false true true))
(assert (= (to_rep (rec__bounded_strings__bounded_string__bound target__split_discrs)) r2b))
(assert (in_range r2b))
(assert (= (to_rep3 (first4 (rt2 (temp_____aggregate_def_223 0 1 r2b)))) 1))
(assert (= (to_rep3 (last4 (rt2 (temp_____aggregate_def_223 0 1 r2b)))) r2b))
(assert (= (mk___t2 temp___230 temp___2301) (temp_____aggregate_def_223 0 1 r2b)))
(assert (= (ite (<= (to_rep3 (first4 temp___2301)) (to_rep3 (last4 temp___2301))) (+ (- (to_rep3 (last4 temp___2301)) (to_rep3 (first4 temp___2301))) 1) 0) (ite (<= 1 r2b) (+ (- r2b 1) 1) 0)))
(assert (= temp___230 temp___231))
(assert (= (mk1 (to_rep3 (first4 temp___2301)) (to_rep3 (last4 temp___2301))) temp___2311))
(assert (not (= (ite (<= (to_rep3 (first2 temp___2311)) (to_rep3 (last2 temp___2311))) (+ (- (to_rep3 (last2 temp___2311)) (to_rep3 (first2 temp___2311))) 1) 0) (ite (<= (to_rep3 (first target__split_fields1)) (to_rep3 (last target__split_fields1))) (+ (- (to_rep3 (last target__split_fields1)) (to_rep3 (first target__split_fields1))) 1) 0))))
(check-sat)
(exit)
