...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o) j))) true) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o) l))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o) j)))) true)) (not (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o) l)))) 1)) d))))))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) j))) true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) l))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) j)))) true))
(assert (not (not (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) l)))) 1)) d))))
(check-sat)
(exit)
