...
(declare-const j Int)
(declare-const temp___619 (Array Int component_t))
...
(assert (= j1 first))
(assert (=> (and (<= first j1) (<= j1 last)) (= temp___619 a)))
(assert (=> (and (<= first j1) (<= j1 last)) (= temp___618 j1)))
...
(assert (=> (and (<= first j1) (<= j1 last)) (= (bool_eq a3 1 1000 (temp___621 a_loop_entry1 first j2 0) 1 1000) true)))
(assert (=> (and (<= first j1) (<= j1 last)) (and (and (=> (<= first last) (dynamic_property first last j2)) (forall ((temp___620 Int)) (=> (and (<= 1 temp___620) (<= temp___620 1000)) (=> (< j2 temp___620) (= (select a3 temp___620) (select temp___619 temp___620)))))) (and (<= first j2) (<= j2 last)))))
...
(assert (= a9 a7))
(assert (not (= (bool_eq a8 1 1000 (temp___599 a first last 0) 1 1000) true)))
(check-sat)
(exit)
