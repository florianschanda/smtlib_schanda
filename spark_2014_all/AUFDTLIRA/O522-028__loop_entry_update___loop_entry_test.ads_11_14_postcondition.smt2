...
(assert (= j1 first))
(assert (=> (and (<= first j1) (<= j1 last)) (and (and (= temp___562 a) (and (= temp___561 j1) (and (and (and (= (to_rep o) 0) (= o1 (store a j1 o))) (and (= (mk_map__ref result2) (mk_map__ref a)) (= a2 o1))) (and (= (bool_eq a3 1 1000 (temp___564 a_loop_entry1 first j2 0) 1 1000) true) (and (and (and (=> (<= first last) (dynamic_property first last j2)) (forall ((temp___563 Int)) (=> (and (<= 1 temp___563) (<= temp___563 1000)) (=> (< j2 temp___563) (= (select a3 temp___563) (select temp___562 temp___563)))))) (and (<= first j2) (<= j2 last))) (= j2 last)))))) (and (and (= j2 j6) (= a3 a7)) (and (= j7 j2) (= a8 a3))))))
(assert (=> (and (<= first j1) (<= j1 last)) (= (mk_int__ref j8) (mk_int__ref j6))))
(assert (=> (and (<= first j1) (<= j1 last)) (= (mk_map__ref a9) (mk_map__ref a7))))
(assert (=> (and (<= first j1) (<= j1 last)) (= j9 j7)))
(assert (=> (and (<= first j1) (<= j1 last)) (= a10 a8)))
(assert (=> (not (and (<= first j1) (<= j1 last))) (= j1 j8)))
(assert (=> (not (and (<= first j1) (<= j1 last))) (= (mk_map__ref a9) (mk_map__ref a))))
(assert (=> (not (and (<= first j1) (<= j1 last))) (= j9 j1)))
(assert (=> (not (and (<= first j1) (<= j1 last))) (= a10 a1)))
(assert (= j10 j8))
...
(assert (= a12 a10))
(assert (not (= (bool_eq a11 1 1000 (temp___542 a first last 0) 1 1000) true)))
(check-sat)
(exit)
