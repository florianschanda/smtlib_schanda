...
(declare-const j Int)
(declare-const temp___621 (Array Int component_t))
...
(assert (= j1 first))
(assert (=> (and (<= first j1) (<= j1 last)) (= temp___621 a)))
(assert (=> (and (<= first j1) (<= j1 last)) (= temp___620 j1)))
(assert (=> (and (<= first j1) (<= j1 last)) (= (mk_map__ref result2) a11)))
(assert (=> (and (<= first j1) (<= j1 last)) (= a2 (store a j1 rliteral))))
(assert (=> (and (<= first j1) (<= j1 last)) (= (bool_eq a3 1 1000 (temp_____aggregate_def_623 a_loop_entry1 first j2 0) 1 1000) true)))
(assert (=> (and (<= first j1) (<= j1 last)) (and (and (=> (<= first last) (dynamic_property first last j2)) (forall ((temp___622 Int)) (=> (and (<= 1 temp___622) (<= temp___622 1000)) (=> (or (< last temp___622) (or (< temp___622 first) (< j2 temp___622))) (= (select a3 temp___622) (select temp___621 temp___622)))))) (and (<= first j2) (<= j2 last)))))
...
(assert (= a9 a7))
(assert (not (= (bool_eq a8 1 1000 (temp_____aggregate_def_599 a first last 0) 1 1000) true)))
(check-sat)
(exit)
