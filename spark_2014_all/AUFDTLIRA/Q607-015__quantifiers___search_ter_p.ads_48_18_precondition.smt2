...
(assert (=> (= (rec__types__option__exists (us_split_fields1 (option__content search_ter_p__search__result21))) true) (and (= result16 (equal_subrange a (to_rep (rec__types__option__value (us_split_fields1 (option__content search_ter_p__search__result21)))) b)) (= (= result16 true) (= (bool_eq (elts a) (to_rep (first2 (mk1 (to_rep (rec__types__option__value (us_split_fields1 (option__content search_ter_p__search__result21)))) (+ (- (to_rep (rec__types__option__value (us_split_fields1 (option__content search_ter_p__search__result21)))) 1) (length b))))) (to_rep (last2 (mk1 (to_rep (rec__types__option__value (us_split_fields1 (option__content search_ter_p__search__result21)))) (+ (- (to_rep (rec__types__option__value (us_split_fields1 (option__content search_ter_p__search__result21)))) 1) (length b))))) (elts b) (to_rep (first (rt b))) (to_rep (last (rt b)))) true)))))
(assert (=> (not (= (rec__types__option__exists (us_split_fields1 (option__content search_ter_p__search__result21))) true)) (= result16 false)))
...
(assert (and (= o13 (- (to_rep (rec__types__option__value (us_split_fields1 (option__content search_ter_p__search__result21)))) 1)) (in_range1 (- (to_rep (rec__types__option__value (us_split_fields1 (option__content search_ter_p__search__result21)))) 1))))
