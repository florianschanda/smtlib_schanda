...
(declare-const temp___1685 (Array Int character))
(declare-const temp___16851 t6)
...
(assert (= o7 text1))
(assert (= o7 temp___1685))
(assert (= (mk6 r15b 10) temp___16851))
(assert (not (= (ite (<= (to_rep1 (first12 temp___16831)) (to_rep1 (last12 temp___16831))) (+ (- (to_rep1 (last12 temp___16831)) (to_rep1 (first12 temp___16831))) 1) 0) (ite (<= (to_rep1 (first12 temp___16851)) (to_rep1 (last12 temp___16851))) (+ (- (to_rep1 (last12 temp___16851)) (to_rep1 (first12 temp___16851))) 1) 0))))
(check-sat)
(exit)
