...
(assert (= (ite (<= (to_rep1 (first8 temp___16631)) (to_rep1 (last8 temp___16631))) (+ (- (to_rep1 (last8 temp___16631)) (to_rep1 (first8 temp___16631))) 1) 0) (ite (<= (to_rep1 (first8 temp___16651)) (to_rep1 (last8 temp___16651))) (+ (- (to_rep1 (last8 temp___16651)) (to_rep1 (first8 temp___16651))) 1) 0)))
(assert (= (mk___t4 temp___1666 temp___16661) (mk___t4 temp___1663 temp___16631)))
(assert (forall ((temp___1667 Int)) (ite (and (<= 1 temp___1667) (<= temp___1667 r6b)) (= (select o6 temp___1667) (select temp___1666 temp___1667)) (= (select o6 temp___1667) (select text temp___1667)))))
(assert (= result2 text))
(assert (= text1 o6))
(assert (= (+ length9 1) r15b))
(assert (in_range r15b))
(assert (= (to_rep1 (first14 (rt7 (temp_____aggregate_def_1668 32 r15b 10)))) r15b))
(assert (= (to_rep1 (last14 (rt7 (temp_____aggregate_def_1668 32 r15b 10)))) 10))
(assert (= (mk___t7 temp___1675 temp___16751) (temp_____aggregate_def_1668 32 r15b 10)))
(assert (= (ite (<= (to_rep1 (first14 temp___16751)) (to_rep1 (last14 temp___16751))) (+ (- (to_rep1 (last14 temp___16751)) (to_rep1 (first14 temp___16751))) 1) 0) (ite (<= r15b 10) (+ (- 10 r15b) 1) 0)))
(assert (= (slide temp___1675 (to_rep1 (first14 temp___16751)) r15b) temp___1676))
(assert (= (mk6 r15b 10) temp___16761))
(assert (=> (<= r15b 10) (and (and (<= 1 r15b) (<= r15b 10)) (and (<= 1 10) (<= 10 10)))))
(assert (= o7 text1))
(assert (= o7 temp___1678))
(assert (= (mk6 r15b 10) temp___16781))
(assert (not (= (ite (<= (to_rep1 (first12 temp___16761)) (to_rep1 (last12 temp___16761))) (+ (- (to_rep1 (last12 temp___16761)) (to_rep1 (first12 temp___16761))) 1) 0) (ite (<= (to_rep1 (first12 temp___16781)) (to_rep1 (last12 temp___16781))) (+ (- (to_rep1 (last12 temp___16781)) (to_rep1 (first12 temp___16781))) 1) 0))))
(check-sat)
(exit)
