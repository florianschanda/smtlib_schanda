...
(assert (= result3 true))
(assert (and (= temp___1553 (model__ f_old root)) (and (dynamic_invariant5 temp___1553 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1553 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1553 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f_old i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1553 (parent f_old i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1553 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1553 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1553 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1553 (parent f_old i)))) (position f_old i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1553 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1553 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1553 i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1553 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1553 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1553 j)))) true)) (= j i))))))))))))))
