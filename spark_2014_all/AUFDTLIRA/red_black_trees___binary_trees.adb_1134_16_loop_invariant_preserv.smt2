...
(assert (not (= r3 r323b)))
(assert (= result5 (mk_int__ref r3)))
(assert (= r4 (+ r3 1)))
(assert (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r4)))) 2) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 r4)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r4) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r4)) true))))
