...
(assert (forall ((p Int)) (=> (and (<= 1 p) (<= p r2)) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 p)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) p) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) p)) true)))))
(assert (and (=> (<= 1 r323b) (dynamic_property 1 r323b r2)) (and (<= 1 r2) (<= r2 r323b))))
(assert (not (= r2 r323b)))
(assert (= result2 (mk_int__ref r2)))
(assert (= r3 (+ r2 1)))
(assert (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r3)))) 2) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 r3)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r3) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r3)) true))))
