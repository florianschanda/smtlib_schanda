...
(assert (and (= o4 (mem avail3 e1)) (=> (= e1 0) (not (= o4 true)))))
(assert (= (= o5 true) (in_range3 e1)))
(assert (= result5 (ite (= o5 true) o4 false)))
(assert (= (= result4 true) (forall ((e2 Int)) (=> (and (in_range3 e2) (= (mem avail3 e2) true)) (and (<= 1 e2) (<= e2 r2))))))
(assert (=> (= result4 true) (and (= o2 (mem alloc3 e)) (=> (= e 0) (not (= o2 true))))))
(assert (=> (= result4 true) (= (= o3 true) (in_range3 e))))
(assert (=> (= result4 true) (= result6 (ite (= o3 true) o2 false))))
