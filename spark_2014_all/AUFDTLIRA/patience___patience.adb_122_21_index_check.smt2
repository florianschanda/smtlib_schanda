...
(assert (= o109 (ite (<= o108 (- (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o103 i1))
(assert (= o104 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o103)))
(assert (= o105 (to_rep o104)))
(assert (= o110 (ite (<= (- 1) o105) true false)))
(assert (= result26 (ite (= o110 true) o109 false)))
