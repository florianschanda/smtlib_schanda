...
(assert (= (ite (<= (to_rep (first2 temp___2301)) (to_rep (last2 temp___2301))) (+ (- (to_rep (last2 temp___2301)) (to_rep (first2 temp___2301))) 1) 0) (ite (<= r4b 10) (+ (- 10 r4b) 1) 0)))
(assert (= (slide temp___230 (to_rep (first2 temp___2301)) r4b) p__a__assume))
