...
(assert (= o46 (read1 (mk___t word1 (mk (to_rep1 word__first) (to_rep1 word__last))))))
(assert (= o47 (mk___split_fields1 o46 dummy6 dummy4)))
(assert (= (to_rep4 o45) 0))
(assert (= o48 (mk___split_discrs o45)))
(assert (= temp___241 (mk___rep1 o48 o47 true)))
(assert (= v__attr__constrained true))
(assert (not (= (rec__tokens__token__kind (us_split_discrs1 temp___241)) (rec__tokens__token__kind v__split_discrs))))
(check-sat)
(exit)
