...
(declare-const temp___241 index)
(declare-const temp___2411 (Array Int value))
(declare-const temp___2412 (Array Int value))
...
(declare-const temp___244 index)
(declare-const temp___2441 (Array Int value))
(declare-const temp___2442 (Array Int value))
...
(declare-const temp___247 index)
(declare-const temp___2471 (Array Int value))
(declare-const temp___2472 (Array Int value))
...
(assert (= temp___241 a__split_fields3))
(assert (= temp___2411 a__split_fields4))
(assert (= temp___2412 a__split_fields5))
(assert (= (to_rep1 o4) 42))
(assert (= o5 (store a__split_fields4 i o4)))
(assert (= a__split_fields3 o6))
(assert (= o5 o7))
(assert (= a__split_fields5 o8))
(assert (= temp___244 o6))
(assert (= temp___2441 o7))
(assert (= temp___2442 o8))
(assert (= result3 a__split_fields3))
(assert (= result4 a__split_fields4))
(assert (= result5 a__split_fields5))
(assert (= temp___244 a__split_fields6))
(assert (= temp___2441 a__split_fields7))
(assert (= temp___2442 a__split_fields8))
(assert (= (to_rep1 o9) 23))
(assert (= o10 (store a__split_fields8 i o9)))
(assert (= a__split_fields6 o11))
(assert (= a__split_fields7 o12))
(assert (= o10 o13))
(assert (= temp___247 o11))
(assert (= temp___2471 o12))
(assert (= temp___2472 o13))
(assert (= result6 a__split_fields6))
(assert (= result7 a__split_fields7))
(assert (= result8 a__split_fields8))
(assert (= temp___247 a__split_fields9))
(assert (= temp___2471 a__split_fields10))
(assert (= temp___2472 a__split_fields11))
(assert (not (= (to_rep1 (select a__split_fields11 i)) 23)))
(check-sat)
(exit)
