...
(assert (and (= o (has_value_exc a (int__content location13) val__)) (= (= o true) (exists ((i15 Int)) (and (and (<= (to_rep1 (first (rt a))) i15) (<= i15 (int__content location13))) (and (< i15 (int__content location13)) (= (to_rep (select (elts a) i15)) val__)))))))
