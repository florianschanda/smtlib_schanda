...
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 n)) (and (and (and (and (and (and (= temp___1814 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))) (and (and (<= (to_rep1 (first (rt source))) temp___1814) (<= temp___1814 (to_rep1 (last (rt source))))) (= o45 temp___1814))) (= o46 (select (elts source) o45))) (= o47 (to_rep o46))) (and (and (and (and (<= 0 n1) (<= n1 9)) (= n1 (convert_character_digit_to_integer o47))) (ite (= (= o47 48) true) (= n1 0) (ite (= (= o47 49) true) (= n1 1) (ite (= (= o47 50) true) (= n1 2) (ite (= (= o47 51) true) (= n1 3) (ite (= (= o47 52) true) (= n1 4) (ite (= (= o47 53) true) (= n1 5) (ite (= (= o47 54) true) (= n1 6) (ite (= (= o47 55) true) (= n1 7) (ite (= (= o47 56) true) (= n1 8) (=> (= (= o47 57) true) (= n1 9)))))))))))) (in_range1 n1))) (and (and (and (= o48 (- n1)) (in_range1 (- n1))) (and (= (mk_int__ref result1) (mk_int__ref target)) (= target1 o48))) (and (<= (- 8) target1) (and (and (and (= o49 (- target1 2147483640)) (in_range1 (- target1 2147483640))) (and (= target1 result2) (= target2 o49))) (and (<= (- 2147483648) target2) (and (= result3 has_failed) (= has_failed1 (of_int 0))))))))) (and (and (= n1 n2) (and (= has_failed1 has_failed2) (= target2 target3))) (and (= n3 n1) (and (= has_failed3 has_failed1) (= target4 target2))))))
