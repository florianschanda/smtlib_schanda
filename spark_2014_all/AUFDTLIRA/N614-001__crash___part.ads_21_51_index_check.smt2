...
(assert (forall ((a (Array Int positive)) (b (Array Int positive))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (to_rep (select a temp___idx_174)) (to_rep (select b (+ (- b__first a__first) temp___idx_174)))))))))))
...
(define-fun dynamic_invariant ((temp___expr_594 us_t) (temp___is_init_590 Bool) (temp___skip_constant_591 Bool) (temp___do_toplevel_592 Bool) (temp___do_typ_inv_593 Bool)) Bool (=> (not (= temp___skip_constant_591 true)) (dynamic_property 1 2147483647 (first1 temp___expr_594) (last1 temp___expr_594))))
...
(assert (= result true))
(assert (and (= temp___688 (+ i 1)) (in_range1 (+ i 1))))
(assert (and (<= (to_rep1 (first (rt p))) temp___688) (<= temp___688 (to_rep1 (last (rt p))))))
(assert (= o2 temp___688))
(assert (= o3 (select (elts p) o2)))
(assert (= o4 (to_rep o3)))
(assert (not (<= i (to_rep1 (last (rt p))))))
(check-sat)
(exit)
