...
(define-fun dynamic_invariant ((temp___expr_535 us_t) (temp___is_init_532 Bool) (temp___skip_constant_533 Bool) (temp___do_toplevel_534 Bool)) Bool (=> (not (= temp___skip_constant_533 true)) (dynamic_property 1 2147483647 (first1 temp___expr_535) (last1 temp___expr_535))))
...
(assert (= result true))
(assert (and (= temp___625 (+ i 1)) (in_range1 (+ i 1))))
(assert (and (<= (to_rep1 (first (rt p))) temp___625) (<= temp___625 (to_rep1 (last (rt p))))))
(assert (= o2 temp___625))
