...
(define-fun dynamic_invariant ((temp___expr_601 us_t) (temp___is_init_597 Bool) (temp___skip_constant_598 Bool) (temp___do_toplevel_599 Bool) (temp___do_typ_inv_600 Bool)) Bool (=> (not (= temp___skip_constant_598 true)) (dynamic_property 1 2147483647 (first1 temp___expr_601) (last1 temp___expr_601))))
...
(assert (= result true))
(assert (and (= temp___695 (+ i 1)) (in_range1 (+ i 1))))
(assert (and (<= (to_rep1 (first (rt p))) temp___695) (<= temp___695 (to_rep1 (last (rt p))))))
(assert (= o2 temp___695))
