...
(define-fun bool_eq ((a (Array Int positive)) (a__first Int) (a__last Int) (b (Array Int positive)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_152 Int)) (=> (and (<= a__first temp___idx_152) (<= temp___idx_152 a__last)) (= (to_rep (select a temp___idx_152)) (to_rep (select b (+ (- b__first a__first) temp___idx_152))))))) true false))
(assert (forall ((a (Array Int positive)) (b (Array Int positive))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_152 Int)) (=> (and (<= a__first temp___idx_152) (<= temp___idx_152 a__last)) (= (to_rep (select a temp___idx_152)) (to_rep (select b (+ (- b__first a__first) temp___idx_152)))))))))))
...
(declare-datatypes () ((partition__ref (mk_partition__ref (partition__content us_t)))))
(define-fun partition__ref___projection ((a partition__ref)) us_t (partition__content a))
(define-fun dynamic_invariant ((temp___expr_529 us_t) (temp___is_init_526 Bool) (temp___skip_constant_527 Bool) (temp___do_toplevel_528 Bool)) Bool (=> (not (= temp___skip_constant_527 true)) (dynamic_property 1 2147483647 (first1 temp___expr_529) (last1 temp___expr_529))))
...
(assert (not (< (length p) 2)))
(assert (and (= o (- (to_rep1 (last (rt p))) 1)) (in_range1 (- (to_rep1 (last (rt p))) 1))))
(assert (= o1 (ite (<= i o) true false)))
(assert (= result (ite (<= (to_rep1 (first (rt p))) i) o1 false)))
(assert (= result true))
(assert (and (= temp___619 (+ i 1)) (in_range1 (+ i 1))))
(assert (and (<= (to_rep1 (first (rt p))) temp___619) (<= temp___619 (to_rep1 (last (rt p))))))
(assert (= o2 temp___619))
(assert (= o3 (select (elts p) o2)))
(assert (= o4 (to_rep o3)))
(assert (not (<= (to_rep1 (first (rt p))) i)))
(check-sat)
(exit)
