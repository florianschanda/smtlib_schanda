...
(assert (not (= (length2 (mk___t2 temp___609 temp___6091)) 0)))
(assert (=> (<= (to_rep1 (first6 temp___6101)) (to_rep1 (last6 temp___6101))) (= o2 (+ (- (to_rep1 (last6 temp___6101)) (to_rep1 (first6 temp___6101))) 1))))
(assert (=> (not (<= (to_rep1 (first6 temp___6101)) (to_rep1 (last6 temp___6101)))) (= o2 0)))
(assert (=> (<= (to_rep1 (first4 temp___6091)) (to_rep1 (last4 temp___6091))) (= o3 (+ (- (to_rep1 (last4 temp___6091)) (to_rep1 (first4 temp___6091))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___6091)) (to_rep1 (last4 temp___6091)))) (= o3 0)))
(assert (= o4 (+ o3 o2)))
(assert (= o5 (+ (to_rep1 (first4 temp___6091)) o4)))
(assert (= o6 (- o5 1)))
