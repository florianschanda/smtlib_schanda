...
(assert (=> (<= (to_rep1 (first6 temp___5461)) (to_rep1 (last6 temp___5461))) (= o2 (+ (- (to_rep1 (last6 temp___5461)) (to_rep1 (first6 temp___5461))) 1))))
(assert (=> (not (<= (to_rep1 (first6 temp___5461)) (to_rep1 (last6 temp___5461)))) (= o2 0)))
(assert (=> (<= (to_rep1 (first4 temp___5451)) (to_rep1 (last4 temp___5451))) (= o3 (+ (- (to_rep1 (last4 temp___5451)) (to_rep1 (first4 temp___5451))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___5451)) (to_rep1 (last4 temp___5451)))) (= o3 0)))
(assert (= o4 (+ o3 o2)))
