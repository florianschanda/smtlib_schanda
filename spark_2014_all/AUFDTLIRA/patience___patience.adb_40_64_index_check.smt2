...
(assert (=> (= result10 true) (= o34 (to_rep1 o33))))
(assert (=> (= result10 true) (= result9 (ite (< o34 (to_rep1 s__split_fields2)) true false))))
...
(assert (=> (= result8 true) (= temp___574 (to_rep1 o24))))
...
(assert (=> (= result7 true) (= temp___577 (to_rep1 o14))))
...
(assert (=> (= result7 true) (= temp___580 (to_rep1 o17))))
