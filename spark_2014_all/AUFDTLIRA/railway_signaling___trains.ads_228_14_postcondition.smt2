...
(assert (=> (not (= result true)) (=> (= result3 true) (=> (and (<= 1 id4) (<= id4 3)) (= temp___402 prev)))))
(assert (=> (not (= result true)) (=> (= result3 true) (=> (and (<= 1 id4) (<= id4 3)) (= temp___401 track_signals2)))))
(assert (=> (not (= result true)) (=> (= result3 true) (=> (and (<= 1 id4) (<= id4 3)) (= temp___404 track_signals2)))))
(assert (=> (not (= result true)) (=> (= result3 true) (=> (and (<= 1 id4) (<= id4 3)) (= temp___399 id4)))))
...
(assert (=> (not (= result true)) (=> (= result3 true) (=> (and (<= 1 id4) (<= id4 3)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 8)) (and (=> (= (to_rep5 (select temp___403 j)) 2) (= (to_rep5 (select track_signals4 j)) 2)) (=> (and (= (to_rep5 (select temp___404 j)) 1) (exists ((t Int)) (and (and (<= 1 t) (<= t cur_num_trains)) (= (is_previous_track (select trains3 t) j) true)))) (= (to_rep5 (select track_signals4 j)) 1)))))))))
...
(assert (=> (not (= result true)) (=> (not (= result3 true)) (=> (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 2)) (=> (and (<= 1 id10) (<= id10 3)) (= temp___396 track_signals9))))))
(assert (=> (not (= result true)) (=> (not (= result3 true)) (=> (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 2)) (=> (and (<= 1 id10) (<= id10 3)) (= temp___390 prev))))))
(assert (=> (not (= result true)) (=> (not (= result3 true)) (=> (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 2)) (=> (and (<= 1 id10) (<= id10 3)) (= temp___395 track_signals9))))))
(assert (=> (not (= result true)) (=> (not (= result3 true)) (=> (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 2)) (=> (and (<= 1 id10) (<= id10 3)) (= temp___388 track_signals9))))))
(assert (=> (not (= result true)) (=> (not (= result3 true)) (=> (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 2)) (=> (and (<= 1 id10) (<= id10 3)) (= temp___386 id10))))))
...
(assert (=> (not (= result true)) (=> (not (= result3 true)) (=> (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 2)) (=> (and (<= 1 id10) (<= id10 3)) (forall ((k Int)) (=> (and (<= 1 k) (<= k id11)) (=> (not (= (get_other_previous_track new_position k) 0)) (let ((temp___394 (to_rep5 (select track_signals11 (get_other_previous_track new_position k))))) (or (= temp___394 1) (= temp___394 2)))))))))))
(assert (=> (not (= result true)) (=> (not (= result3 true)) (=> (not (= (to_rep5 (select track_signals (to_rep (rec__trains__train_position__track_begin (us_split_fields3 new_position))))) 2)) (=> (and (<= 1 id10) (<= id10 3)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 8)) (and (=> (= (to_rep5 (select temp___395 j)) 2) (= (to_rep5 (select track_signals11 j)) 2)) (=> (= (to_rep5 (select temp___396 j)) 1) (= (to_rep5 (select track_signals11 j)) 1))))))))))
