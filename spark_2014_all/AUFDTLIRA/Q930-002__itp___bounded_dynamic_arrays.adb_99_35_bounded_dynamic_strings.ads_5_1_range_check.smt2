...
(assert (not (= (length1 temp___10602) 0)))
(assert (=> (<= (to_rep1 (first2 temp___10601)) (to_rep1 (last2 temp___10601))) (= o (+ (- (to_rep1 (last2 temp___10601)) (to_rep1 (first2 temp___10601))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___10601)) (to_rep1 (last2 temp___10601)))) (= o 0)))
(assert (= o1 (+ o 1)))
(assert (= o2 (+ (to_rep1 (first2 temp___10601)) o1)))
(assert (= o3 (- o2 1)))
