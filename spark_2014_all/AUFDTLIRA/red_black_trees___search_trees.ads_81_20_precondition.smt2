...
(assert (=> (not (= (int__content i14) 0)) (and (= o29 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o29) (= o29 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
