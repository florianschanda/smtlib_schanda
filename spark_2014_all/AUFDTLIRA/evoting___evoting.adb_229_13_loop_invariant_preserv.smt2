...
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i2))) (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= temp___706 winners3))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i2))) (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= temp___705 j1))))
...
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i2))) (=> (and (<= 0 j1) (<= j1 (- i2 1))) (and (and (=> (<= 0 (- i2 1)) (dynamic_property1 0 (- i2 1) j2)) (forall ((temp___707 Int)) (=> (and (<= 0 temp___707) (<= temp___707 20)) (=> (<= j2 temp___707) (= (select winners4 temp___707) (select temp___706 temp___707)))))) (and (<= 0 j2) (<= j2 (- i2 1)))))))
...
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i2))) (=> (and (<= 0 j1) (<= j1 (- i2 1))) (= o1 (store winners4 o (of_int 0))))))
...
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i2))) (= winners10 (store winners8 i2 (of_int 1)))))
...
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i2)))) (=> (= (to_rep (select counters i2)) (to_rep (select counters latest_highest_score2))) (= winners11 (store winners3 i2 (of_int 1))))))
...
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i2)))) (=> (not (= (to_rep (select counters i2)) (to_rep (select counters latest_highest_score2)))) (= winners12 (store winners3 i2 (of_int 0))))))
