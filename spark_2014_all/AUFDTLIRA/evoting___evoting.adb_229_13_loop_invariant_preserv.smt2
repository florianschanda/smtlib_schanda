...
(assert (= i4 2))
(assert (<= 2 i4))
(assert (<= i4 last_candidate))
(assert (and (and (and (and (not (= (select winners3 0) true)) (< latest_highest_score2 i5)) (= (select winners3 latest_highest_score2) true)) (forall ((j28 Int)) (=> (and (<= 1 j28) (<= j28 (- i5 1))) (=> (< latest_highest_score2 j28) (< (to_rep (select counters j28)) (to_rep (select counters latest_highest_score2))))))) (forall ((j28 Int)) (=> (and (<= 1 j28) (<= j28 (- i5 1))) (ite (= (select winners3 j28) true) (= (to_rep (select counters latest_highest_score2)) (to_rep (select counters j28))) (< (to_rep (select counters j28)) (to_rep (select counters latest_highest_score2))))))))
(assert (and (and (=> (<= 2 last_candidate) (dynamic_property 2 last_candidate i5)) (=> (<= 0 20) (in_range4 latest_highest_score2))) (and (<= 2 i5) (<= i5 last_candidate))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (= j6 result6)))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (= j7 0)))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (=> (and (<= 0 j7) (<= j7 (- i5 1))) (and (and (= temp___700 winners3) (and (= temp___699 j7) (and (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- j8 1))) (not (= (select winners4 k1) true)))) (and (and (and (=> (<= 0 (- i5 1)) (dynamic_property1 0 (- i5 1) j8)) (forall ((temp___701 Int)) (=> (and (<= 0 temp___701) (<= temp___701 20)) (=> (<= j8 temp___701) (= (select winners4 temp___701) (select temp___700 temp___701)))))) (and (<= 0 j8) (<= j8 (- i5 1)))) (and (and (and (and (and (<= 0 j8) (<= j8 20)) (= o1 j8)) (= o2 (store winners4 o1 (of_int 0)))) (and (= winners4 result7) (= winners5 o2))) (= j8 (- i5 1))))))) (and (and (= j8 j12) (= winners5 winners8)) (and (= j13 j8) (= winners9 winners5)))))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (=> (and (<= 0 j7) (<= j7 (- i5 1))) (= (mk_int__ref j14) (mk_int__ref j12)))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (=> (and (<= 0 j7) (<= j7 (- i5 1))) (= (mk_map__ref1 winners10) (mk_map__ref1 winners8)))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (=> (and (<= 0 j7) (<= j7 (- i5 1))) (= j15 j13))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (=> (and (<= 0 j7) (<= j7 (- i5 1))) (= winners11 winners9))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (=> (not (and (<= 0 j7) (<= j7 (- i5 1)))) (= j7 j14))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (=> (not (and (<= 0 j7) (<= j7 (- i5 1)))) (= winners3 winners10))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (=> (not (and (<= 0 j7) (<= j7 (- i5 1)))) (= j15 j7))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (=> (not (and (<= 0 j7) (<= j7 (- i5 1)))) (= winners11 winners3))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (= (mk_map__ref1 result9) (mk_map__ref1 winners10))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (= winners12 (store winners10 i5 (of_int 1)))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (= latest_highest_score2 result10)))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (= latest_highest_score3 i5)))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (= j16 (mk_int__ref j14))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (= latest_highest_score5 (mk_int__ref latest_highest_score3))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (= winners15 (mk_map__ref1 winners12))))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (= j17 j15)))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (= latest_highest_score6 latest_highest_score3)))
(assert (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5))) (= winners16 winners12)))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (=> (= (to_rep (select counters i5)) (to_rep (select counters latest_highest_score2))) (= winners3 result11))))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (=> (= (to_rep (select counters i5)) (to_rep (select counters latest_highest_score2))) (= winners13 (store winners3 i5 (of_int 1))))))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (=> (= (to_rep (select counters i5)) (to_rep (select counters latest_highest_score2))) (= result12 (mk_int__ref latest_highest_score2)))))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (=> (= (to_rep (select counters i5)) (to_rep (select counters latest_highest_score2))) (= latest_highest_score4 i5))))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (=> (not (= (to_rep (select counters i5)) (to_rep (select counters latest_highest_score2)))) (= result13 (mk_map__ref1 winners3)))))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (=> (not (= (to_rep (select counters i5)) (to_rep (select counters latest_highest_score2)))) (= winners14 (store winners3 i5 (of_int 0))))))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (=> (not (= (to_rep (select counters i5)) (to_rep (select counters latest_highest_score2)))) (= latest_highest_score4 latest_highest_score2))))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (=> (not (= (to_rep (select counters i5)) (to_rep (select counters latest_highest_score2)))) (= winners13 winners14))))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (= j16 (mk_int__ref j6))))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (= latest_highest_score5 (mk_int__ref latest_highest_score4))))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (= winners15 (mk_map__ref1 winners13))))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (= j17 j6)))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (= latest_highest_score6 latest_highest_score4)))
(assert (=> (not (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i5)))) (= winners16 winners13)))
(assert (not (= i5 last_candidate)))
(assert (= result14 (mk_int__ref i5)))
(assert (= i6 (+ i5 1)))
(assert (= j18 j16))
(assert (= i7 (mk_int__ref i6)))
(assert (= latest_highest_score7 latest_highest_score5))
(assert (= winners17 winners15))
(assert (= j19 j17))
(assert (= i8 i6))
(assert (= latest_highest_score8 latest_highest_score6))
(assert (= winners18 winners16))
(assert (not (not (= (select (map__content1 winners17) 0) true))))
(check-sat)
(exit)
