...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_137 Int)) (=> (and (<= a__first temp___idx_137) (<= temp___idx_137 a__last)) (= (select a temp___idx_137) (select b (+ (- b__first a__first) temp___idx_137))))))))))
...
(assert (forall ((temp___420 Bool)) (forall ((temp___421 Int)) (= (select (stable_marriage__is_permutation_2__seen__aggregate_def temp___420) temp___421) temp___420))))
(declare-fun temp___427 (Bool) (Array Int Bool))
(assert (forall ((temp___429 Bool)) (forall ((temp___430 Int)) (= (select (temp___427 temp___429) temp___430) temp___429))))
(declare-fun temp___433 (Bool) (Array Int Bool))
(assert (forall ((temp___435 Bool)) (forall ((temp___436 Int)) (= (select (temp___433 temp___435) temp___436) temp___435))))
...
(declare-const seen10 (Array Int Bool))
(declare-const rank10 Int)
(declare-const stable_marriage__is_permutation_2__result4 Bool)
(declare-const seen11 (Array Int Bool))
(declare-const rank11 Int)
(declare-const stable_marriage__is_permutation_2__result5 Bool)
(declare-const result5 Bool)
(assert (and (and (and (= (mk_map__ref1 result) (mk_map__ref1 seen)) (= seen1 (stable_marriage__is_permutation_2__seen__aggregate_def (of_int 0)))) (and (and (and (= (mk_int__ref result1) (mk_int__ref rank)) (= rank1 1)) (ite (and (<= 1 rank1) (<= rank1 64)) (and (and (and (= temp___423 seen1) (and (= temp___422 rank1) (and (forall ((g21 Int)) (=> (and (<= 1 g21) (<= g21 64)) (= (= (select seen2 g21) true) (exists ((prev1 Int)) (and (and (<= 1 prev1) (<= prev1 (- rank2 1))) (= (to_rep (select r2 prev1)) g21)))))) (and (and (=> (<= 1 64) (in_range2 rank2)) (and (<= 1 rank2) (<= rank2 64))) (and (and (= seen2 result2) (= seen3 (store seen2 (to_rep (select r2 rank2)) (of_int 1)))) (= rank2 64)))))) (and (and (= rank2 rank6) (= seen3 seen6)) (and (= rank7 rank2) (= seen7 seen3)))) (and (and (= (mk_int__ref rank8) (mk_int__ref rank6)) (= (mk_map__ref1 seen8) (mk_map__ref1 seen6))) (and (= rank9 rank7) (= seen9 seen7)))) (and (and (= rank1 rank8) (= seen1 seen8)) (and (= rank9 rank1) (= seen9 seen1))))) (and (= (= (bool_eq1 seen8 1 64 (temp___427 (of_int 1)) 1 64) true) (forall ((g21 Int)) (=> (and (<= 1 g21) (<= g21 64)) (and (= (select seen8 g21) true) (exists ((rank12 Int)) (and (and (<= 1 rank12) (<= rank12 64)) (= (to_rep (select r2 rank12)) g21))))))) (and (and (= stable_marriage__is_permutation_2__result1 stable_marriage__is_permutation_2__result2) (= stable_marriage__is_permutation_2__result3 stable_marriage__is_permutation_2__result1)) (and (= result4 stable_marriage__is_permutation_2__result) (= stable_marriage__is_permutation_2__result1 (bool_eq1 seen8 1 64 (temp___433 (of_int 1)) 1 64))))))) (and (and (= (mk_bool__ref stable_marriage__is_permutation_2__result4) (mk_bool__ref stable_marriage__is_permutation_2__result2)) (and (= (mk_int__ref rank10) (mk_int__ref rank8)) (= (mk_map__ref1 seen10) (mk_map__ref1 seen8)))) (and (= stable_marriage__is_permutation_2__result5 stable_marriage__is_permutation_2__result3) (and (= rank11 rank9) (= seen11 seen9))))))
(assert (= result5 stable_marriage__is_permutation_2__result4))
(assert (= stable_marriage__is_permutation_2__result4 true))
(declare-const g21 Int)
(assert (<= 1 g21))
(assert (<= g21 64))
(assert (not (exists ((rank12 Int)) (and (and (<= 1 rank12) (<= rank12 64)) (= (to_rep (select r2 rank12)) g21)))))
(check-sat)
(exit)
