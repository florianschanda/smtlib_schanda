...
(assert (= seen1 (stable_marriage__is_permutation_2__seen__aggregate_def (of_int 0))))
...
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (= (= (select seen2 g2) true) (exists ((prev Int)) (and (and (<= 1 prev) (<= prev (- rank2 1))) (= (to_rep (select r2 prev)) g2))))))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (and (=> (<= 1 64) (in_range2 rank2)) (and (<= 1 rank2) (<= rank2 64)))))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= seen2 result2)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= seen3 (store seen2 (to_rep (select r2 rank2)) (of_int 1)))))
...
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= seen10 (mk_map__ref1 seen4))))
...
(assert (= (= (bool_eq1 seen6 1 64 (temp___427 (of_int 1)) 1 64) true) (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (and (= (select seen6 g2) true) (exists ((rank10 Int)) (and (and (<= 1 rank10) (<= rank10 64)) (= (to_rep (select r2 rank10)) g2))))))))
(assert (= stable_marriage__is_permutation_2__result1 stable_marriage__is_permutation_2__result2))
(assert (= stable_marriage__is_permutation_2__result3 stable_marriage__is_permutation_2__result1))
(assert (= result3 stable_marriage__is_permutation_2__result))
(assert (= stable_marriage__is_permutation_2__result1 (bool_eq1 seen6 1 64 (temp___433 (of_int 1)) 1 64)))
(assert (= (mk_bool__ref stable_marriage__is_permutation_2__result4) (mk_bool__ref stable_marriage__is_permutation_2__result2)))
(assert (= (mk_int__ref rank7) rank9))
(assert (= (mk_map__ref1 seen8) seen10))
(assert (= stable_marriage__is_permutation_2__result5 stable_marriage__is_permutation_2__result3))
(assert (= rank8 rank6))
(assert (= seen9 seen7))
...
(assert (<= 1 g2))
(assert (<= g2 64))
(assert (not (exists ((rank10 Int)) (and (and (<= 1 rank10) (<= rank10 64)) (= (to_rep (select r2 rank10)) g2)))))
(check-sat)
(exit)
