...
(assert (and (= o123 (root (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields30)))) (and (in_range4 o123) (= o123 (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields30)))))))))
(assert (= o124 (ite (= (int__content x15) o123) true false)))
(assert (= result33 (ite (not (= o124 true)) true false)))
(assert (= result33 true))
(assert (not (in_range4 (int__content x15))))
(check-sat)
(exit)
