...
(define-fun default_initial_assumption ((temp___expr_181 us_rep) (temp___skip_top_level_182 Bool)) Bool (and (= (to_rep (rec__stack__stack__top (us_split_fields1 temp___expr_181))) 0) (= (rec__stack__stack__content (us_split_fields1 temp___expr_181)) (temp___183 0))))
...
(assert (forall ((s us_rep)) (! (dynamic_invariant (to__ s) true false true true) :pattern ((to__ s)))))
(assert (forall ((s us_rep)) (! (= (to__ s) (let ((temp___204 (let ((temp___202 (to_rep (rec__stack__stack__top (us_split_fields1 s))))) (let ((temp___201 1)) (let ((temp___203 (rec__stack__stack__content (us_split_fields1 s)))) (of_array1 temp___203 temp___201 temp___202)))))) (of_array (to_array1 temp___204) (first3 temp___204) (last3 temp___204)))) :pattern ((to__ s)))))
...
(assert (forall ((s us_rep)) (! (dynamic_invariant (to_but_top s) true false true true) :pattern ((to_but_top s)))))
(assert (forall ((s us_rep)) (! (= (to_but_top s) (let ((temp___216 (let ((temp___214 (- (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1))) (let ((temp___213 1)) (let ((temp___215 (rec__stack__stack__content (us_split_fields1 s)))) (of_array2 temp___215 temp___213 temp___214)))))) (of_array (to_array2 temp___216) (first5 temp___216) (last5 temp___216)))) :pattern ((to_but_top s)))))
...
(assert (forall ((temp___185 Int)) (=> (dynamic_invariant1 temp___185 true true true true) (forall ((temp___186 Int)) (= (to_rep1 (select (temp___183 temp___185) temp___186)) temp___185)))))
...
(declare-const temp___261 r1)
(declare-const temp___2611 (Array Int integer))
...
(assert (= temp___261 o2))
(assert (= temp___2611 o3))
(assert (= result s__split_fields))
(assert (= result1 s__split_fields1))
(assert (= temp___261 s__split_fields2))
(assert (= temp___2611 s__split_fields3))
...
(assert (not (= (let ((temp___268 (to__ (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))))) (let ((temp___267 (to_but_top (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (bool_eq (elts temp___267) (to_rep1 (first (rt temp___267))) (to_rep1 (last (rt temp___267))) (elts temp___268) (to_rep1 (first (rt temp___268))) (to_rep1 (last (rt temp___268)))))) true)))
(check-sat)
(exit)
