...
(assert (forall ((x r1)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__stack__stack__top (us_split_fields1 a))) (to_rep (rec__stack__stack__top (us_split_fields1 b)))) (= (bool_eq (rec__stack__stack__content (us_split_fields1 a)) 1 100 (rec__stack__stack__content (us_split_fields1 b)) 1 100) true)) true false))
...
(assert (forall ((temp___159 Int)) (forall ((temp___160 Int)) (= (select (temp___157 temp___159) temp___160) (of_rep1 temp___159)))))
(define-fun default_initial_assumption ((temp___expr_155 us_rep) (temp___skip_top_level_156 Bool)) Bool (and (= (to_rep (rec__stack__stack__top (us_split_fields1 temp___expr_155))) 0) (= (rec__stack__stack__content (us_split_fields1 temp___expr_155)) (temp___157 0))))
...
(define-fun dynamic_invariant ((temp___expr_164 us_t) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (=> (not (= temp___skip_constant_162 true)) (dynamic_property 1 2147483647 (first1 temp___expr_164) (last1 temp___expr_164))))
...
(assert (forall ((s us_rep)) (! (dynamic_invariant (to_but_top s) true false true) :pattern ((to_but_top s)))))
(assert (forall ((s us_rep)) (! (= (to_but_top s) (let ((temp___189 (let ((temp___187 (- (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1))) (let ((temp___186 1)) (let ((temp___188 (rec__stack__stack__content (us_split_fields1 s)))) (of_array2 temp___188 temp___186 temp___187)))))) (of_array (to_array2 temp___189) (first5 temp___189) (last5 temp___189)))) :pattern ((to_but_top s)))))
(declare-fun is_empty (us_rep) Bool)
(declare-fun is_empty__function_guard (Bool us_rep) Bool)
(assert true)
(assert (forall ((s us_rep)) (! (= (= (is_empty s) true) (< (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1)) :pattern ((is_empty s)))))
...
(define-fun dynamic_invariant3 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 100)) (in_range temp___expr_136)))
...
(assert (not (= (let ((temp___241 (to__ (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))))) (let ((temp___240 (to_but_top (mk___rep (mk___split_fields s__split_fields s__split_fields1))))) (bool_eq (elts temp___240) (to_rep1 (first (rt temp___240))) (to_rep1 (last (rt temp___240))) (elts temp___241) (to_rep1 (first (rt temp___241))) (to_rep1 (last (rt temp___241)))))) true)))
(check-sat)
(exit)
