...
(assert (forall ((c us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c) true) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c)))))
