...
(declare-const temp___1752 (Array Int character))
(declare-const temp___17521 t)
...
(assert (= (concat1 (temp___String_Literal_1749 Tuple0) 1 55 firsttime1 1 21) temp___1752))
(assert (= (mk 1 o7) temp___17521))
(assert (not (= (length (mk___t temp___1752 temp___17521)) 0)))
(assert (=> (<= 1 5) (= o8 (+ (- 5 1) 1))))
(assert (=> (not (<= 1 5)) (= o8 0)))
(assert (=> (<= (to_rep1 (first temp___17521)) (to_rep1 (last temp___17521))) (= o9 (+ (- (to_rep1 (last temp___17521)) (to_rep1 (first temp___17521))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___17521)) (to_rep1 (last temp___17521)))) (= o9 0)))
(assert (= o10 (+ o9 o8)))
(assert (= o11 (+ (to_rep1 (first temp___17521)) o10)))
(assert (= o12 (- o11 1)))
