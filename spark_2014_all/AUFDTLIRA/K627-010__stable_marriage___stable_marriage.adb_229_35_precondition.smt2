...
(assert (= (= o19 true) (forall ((g1_id3 Int)) (=> (and (<= 1 g1_id3) (<= g1_id3 64)) (=> (= (to_rep3 (select proposals_made g1_id3)) 0) (exists ((idx3 Int)) (and (and (<= 1 idx3) (<= idx3 (to_rep3 unmatched_g1_set__split_fields1))) (= (to_rep (select unmatched_g1_set__split_fields idx3)) g1_id3))))))))
(assert (<= 1 g1_id))
(assert (<= g1_id 64))
(assert (<= 1 rank))
...
(assert (= o1 rank))
(assert (= o2 (select (select ranking_1 g1_id) o1)))
(assert (= o3 (to_rep1 o2)))
(assert (= o4 (select result__ o3)))
(assert (= o5 (to_rep o4)))
(assert (= o6 (ite (= o5 g1_id) true false)))
(assert (= result2 (ite (not (= o6 true)) true false)))
(assert (= result2 true))
(assert (and (<= 1 rank) (<= rank 64)))
(assert (= o12 rank))
(assert (= o13 (select (select ranking_1 g1_id) o12)))
(assert (= o14 (to_rep1 o13)))
(assert (= o15 (select ranking_2 o14)))
(assert (and (<= 1 rank) (<= rank 64)))
(assert (= o7 rank))
(assert (= o8 (select (select ranking_1 g1_id) o7)))
(assert (= o9 (to_rep1 o8)))
(assert (= o10 (select result__ o9)))
(assert (= o11 (to_rep o10)))
(assert (not (= (is_permutation_1 o15) true)))
(check-sat)
(exit)
