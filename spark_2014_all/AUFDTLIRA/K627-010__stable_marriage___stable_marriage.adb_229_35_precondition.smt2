...
(assert (= result true))
(assert (= (= o16 true) (forall ((g1_id1 Int)) (=> (and (<= 1 g1_id1) (<= g1_id1 64)) (=> (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx (to_rep3 unmatched_g1_set__split_fields1))) (not (= (to_rep (select unmatched_g1_set__split_fields idx)) g1_id1)))) (and (< 0 (to_rep3 (select proposals_made g1_id1))) (= (to_rep (select result__ (to_rep1 (select (select ranking_1 g1_id1) (to_rep3 (select proposals_made g1_id1)))))) g1_id1)))))))
(assert (= (= o15 true) (forall ((g1_id1 Int)) (=> (and (<= 1 g1_id1) (<= g1_id1 64)) (=> (= (to_rep3 (select proposals_made g1_id1)) 0) (exists ((idx Int)) (and (and (<= 1 idx) (<= idx (to_rep3 unmatched_g1_set__split_fields1))) (= (to_rep (select unmatched_g1_set__split_fields idx)) g1_id1))))))))
(assert (<= 1 g1_id))
(assert (<= g1_id 64))
(assert (<= 1 rank))
...
(assert (and (<= 1 rank) (<= rank 64)))
(assert (= o11 rank))
(assert (= o12 (select (select ranking_1 g1_id) o11)))
(assert (= o13 (to_rep1 o12)))
(assert (= o14 (select ranking_2 o13)))
(assert (and (<= 1 rank) (<= rank 64)))
(assert (= o6 rank))
(assert (= o7 (select (select ranking_1 g1_id) o6)))
(assert (= o8 (to_rep1 o7)))
(assert (= o9 (select result__ o8)))
(assert (= o10 (to_rep o9)))
(assert (not (= (is_permutation_1 o14) true)))
(check-sat)
(exit)
