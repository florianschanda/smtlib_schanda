...
(assert (and (and (forall ((temp___1310 Int)) (=> (and (<= (to_rep1 n__first) temp___1310) (<= temp___1310 (to_rep1 n__last))) (=> (< index2 temp___1310) (= (select n3 temp___1310) (select n1 temp___1310))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9)))))
