...
(assert (not (= (to_rep (rec__database__availability__account_link__prev (us_split_fields1 (select links account)))) 0)))
(assert (= (to_rep o) (to_rep (rec__database__availability__account_link__next (us_split_fields1 (select links account))))))
(assert (= (rec__database__availability__account_link__available (us_split_fields1 (select links (to_rep (rec__database__availability__account_link__prev (us_split_fields1 (select links account))))))) o1))
(assert (= (rec__database__availability__account_link__prev (us_split_fields1 (select links (to_rep (rec__database__availability__account_link__prev (us_split_fields1 (select links account))))))) o2))
(assert (= o o3))
(assert (= o4 o1))
(assert (= o5 o2))
(assert (= o6 o3))
(assert (not (<= (to_rep (rec__database__availability__account_link__prev (us_split_fields1 (select links account)))) 200000)))
(check-sat)
(exit)
