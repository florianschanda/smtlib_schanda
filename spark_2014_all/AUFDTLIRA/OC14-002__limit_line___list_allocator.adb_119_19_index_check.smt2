...
(assert (and (= o82 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o82)))
(assert (= result20 (ite (< j1 o82) true false)))
(assert (=> (= result20 true) (and (= o83 (+ j1 1)) (in_range1 (+ j1 1)))))
(assert (=> (= result20 true) (and (= o84 (get (rec__list_allocator__m__t__allocated model____split_fields4) o83)) (in_range7 o84))))
(assert (=> (not (= result20 true)) (= o84 0)))
(assert (and (= temp___400 (get (rec__list_allocator__m__t__allocated model____split_fields4) j1)) (in_range7 temp___400)))
(assert (not (<= 1 temp___400)))
(check-sat)
(exit)
