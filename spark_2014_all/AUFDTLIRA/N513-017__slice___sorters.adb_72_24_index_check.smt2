...
(assert (and (and (and (<= (to_rep values__first) current2) (< current2 (to_rep values__last))) (forall ((j2 Int)) (=> (and (<= (to_rep values__first) j2) (<= j2 (- current2 1))) (<= (to_rep (select values3 j2)) (to_rep (select values3 (+ j2 1))))))) (forall ((j2 Int)) (=> (and (<= current2 j2) (<= j2 (to_rep values__last))) (<= (to_rep (select values3 current2)) (to_rep (select values3 j2)))))))
...
(assert (=> (= result3 true) (= (= result2 true) (forall ((j2 Int)) (=> (and (<= (to_rep values__first) j2) (<= j2 (- current2 1))) (<= (to_rep (select values3 j2)) (to_rep (select values3 (+ j2 1)))))))))
