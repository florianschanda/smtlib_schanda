...
(define-fun bool_eq ((a (Array Int element_type)) (a__first Int) (a__last Int) (b (Array Int element_type)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep3 (select a temp___idx_132)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((a (Array Int element_type)) (b (Array Int element_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep3 (select a (+ i 1))) (to_rep3 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int element_type)) (b (Array Int element_type))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep3 (select b (+ i 1))) (to_rep3 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (= (to_rep1 (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 a))) (to_rep1 (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 b)))) (= (to_rep (rec__bounded_queue_v2__queue_type__count (us_split_fields1 a))) (to_rep (rec__bounded_queue_v2__queue_type__count (us_split_fields1 b))))) (= (to_rep1 (rec__bounded_queue_v2__queue_type__front (us_split_fields1 a))) (to_rep1 (rec__bounded_queue_v2__queue_type__front (us_split_fields1 b))))) (= (to_rep1 (rec__bounded_queue_v2__queue_type__rear (us_split_fields1 a))) (to_rep1 (rec__bounded_queue_v2__queue_type__rear (us_split_fields1 b))))) (= (bool_eq1 (rec__bounded_queue_v2__queue_type__items (us_split_fields1 a)) (rec__bounded_queue_v2__queue_type__items (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant ((temp___expr_157 us_rep) (temp___is_init_154 Bool) (temp___skip_constant_155 Bool) (temp___do_toplevel_156 Bool)) Bool (let ((temp___158 (rec__bounded_queue_v2__queue_type__max_size (us_split_discrs1 temp___expr_157)))) (and (dynamic_property1 1 (to_rep1 temp___158) (first1 (rec__bounded_queue_v2__queue_type__items (us_split_fields1 temp___expr_157))) (last1 (rec__bounded_queue_v2__queue_type__items (us_split_fields1 temp___expr_157)))) (and (= (first1 (rec__bounded_queue_v2__queue_type__items (us_split_fields1 temp___expr_157))) 1) (= (last1 (rec__bounded_queue_v2__queue_type__items (us_split_fields1 temp___expr_157))) (to_rep1 temp___158))))))
...
(assert (forall ((queue us_rep)) (! (=> (dynamic_invariant queue true true true) (dynamic_invariant1 (size queue) true false true)) :pattern ((size queue)))))
...
(define-fun dynamic_invariant4 ((temp___expr_146 Int) (temp___is_init_143 Bool) (temp___skip_constant_144 Bool) (temp___do_toplevel_145 Bool)) Bool (=> (or (= temp___is_init_143 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_146)))
...
(declare-const o3 positive)
(declare-const o4 (Array Int element_type))
(declare-const o5 t)
(declare-const temp___270 positive)
(declare-const temp___2701 natural)
(declare-const temp___2702 positive)
(declare-const temp___2703 positive)
(declare-const temp___2704 (Array Int element_type))
(declare-const temp___2705 t)
(declare-const o6 positive)
(declare-const o7 natural)
(declare-const o8 positive)
(declare-const o9 positive)
(declare-const o10 (Array Int element_type))
(declare-const o11 t)
(declare-const temp___272 positive)
(declare-const temp___2721 natural)
(declare-const temp___2722 positive)
(declare-const temp___2723 positive)
(declare-const temp___2724 (Array Int element_type))
(declare-const temp___2725 t)
...
(declare-const o17 t)
(declare-const temp___274 positive)
(declare-const temp___2741 natural)
(declare-const temp___2742 positive)
(declare-const temp___2743 positive)
(declare-const temp___2744 (Array Int element_type))
...
(assert (dynamic_invariant (mk___rep queue__split_discrs (mk___split_fields queue__split_fields queue__split_fields1 queue__split_fields2 (mk___t queue__split_fields3 queue__split_fields4))) true false true))
(assert (= (to_rep o) 0))
(assert (= o o1))
(assert (= queue__split_fields1 o2))
(assert (= queue__split_fields2 o3))
(assert (= queue__split_fields3 o4))
(assert (= queue__split_fields4 o5))
(assert (= queue__split_discrs (mk___split_discrs temp___270)))
(assert (= temp___2701 o1))
(assert (= temp___2702 o2))
(assert (= temp___2703 o3))
(assert (= temp___2704 o4))
(assert (= temp___2705 o5))
...
(assert (= queue__split_fields5 (mk___split_fields temp___2701 temp___2702 temp___2703 (mk___t temp___2704 temp___2705))))
(assert (= queue__split_discrs (mk___split_discrs temp___270)))
(assert (= (to_rep1 o6) 1))
(assert (= (rec__bounded_queue_v2__queue_type__count queue__split_fields5) o7))
(assert (= o6 o8))
(assert (= (rec__bounded_queue_v2__queue_type__rear queue__split_fields5) o9))
(assert (= (rec__bounded_queue_v2__queue_type__items queue__split_fields5) (mk___t o10 o11)))
(assert (= queue__split_discrs (mk___split_discrs temp___272)))
(assert (= temp___2721 o7))
(assert (= temp___2722 o8))
(assert (= temp___2723 o9))
(assert (= temp___2724 o10))
(assert (= temp___2725 o11))
(assert (= result1 (mk___split_fields__ref queue__split_fields5)))
(assert (= queue__split_fields6 (mk___split_fields temp___2721 temp___2722 temp___2723 (mk___t temp___2724 temp___2725))))
(assert (= queue__split_discrs (mk___split_discrs temp___272)))
(assert (= (to_rep1 o12) (to_rep1 (rec__bounded_queue_v2__queue_type__max_size queue__split_discrs))))
(assert (= (rec__bounded_queue_v2__queue_type__count queue__split_fields6) o13))
(assert (= (rec__bounded_queue_v2__queue_type__front queue__split_fields6) o14))
(assert (= o12 o15))
(assert (= (rec__bounded_queue_v2__queue_type__items queue__split_fields6) (mk___t o16 o17)))
(assert (= queue__split_discrs (mk___split_discrs temp___274)))
(assert (= temp___2741 o13))
(assert (= temp___2742 o14))
(assert (= temp___2743 o15))
(assert (= temp___2744 o16))
(assert (= temp___2745 o17))
(assert (= result2 (mk___split_fields__ref queue__split_fields6)))
(assert (= queue__split_fields7 (mk___split_fields temp___2741 temp___2742 temp___2743 (mk___t temp___2744 temp___2745))))
(assert (= queue__split_discrs (mk___split_discrs temp___274)))
(assert (= queue__split_fields8 (mk___split_fields__ref queue__split_fields7)))
(assert (= queue__split_fields9 queue__split_fields7))
(assert (not (= (empty (mk___rep queue__split_discrs (us_split_fields__content queue__split_fields8))) true)))
(check-sat)
(exit)
