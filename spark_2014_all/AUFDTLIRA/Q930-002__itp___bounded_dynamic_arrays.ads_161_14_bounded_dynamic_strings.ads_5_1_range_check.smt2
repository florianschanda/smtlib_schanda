...
(assert (and (= o18 (length by__)) (in_range1 (length by__))))
(assert (= o19 (+ start o18)))
(assert (= temp___1194 (- o19 1)))
(assert (and (= temp___1195 (value (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (and (dynamic_invariant temp___1195 true false true) (and (= temp___1195 (mk___t (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields__content this__split_fields5))) (mk (to_rep1 (first4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5)))))) (to_rep1 (last4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5))))))))) (and (and (and (= (length temp___1195) (length2 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (= (to_rep1 (first (rt temp___1195))) 1)) (= (to_rep1 (last (rt temp___1195))) (length2 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5))))) (= (< 0 (length2 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (not (= (empty (mk___rep this__split_discrs (us_split_fields__content this__split_fields5))) true))))))))
(assert (<= start temp___1194))
(assert (not (<= (to_rep1 (first (rt temp___1195))) start)))
(check-sat)
(exit)
