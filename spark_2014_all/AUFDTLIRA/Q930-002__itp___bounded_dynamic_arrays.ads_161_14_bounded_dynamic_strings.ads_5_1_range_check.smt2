...
(declare-const temp___1258 us_t)
...
(assert (and (= o17 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))))) (and (in_range4 o17) (= o17 (to_rep2 this__split_fields)))))
(assert (and (= o15 (length by__)) (in_range1 (length by__))))
(assert (= o16 (+ start o15)))
(assert (= o18 (- o16 1)))
(assert (= result2 (ite (< o17 o18) true false)))
(assert (=> (= result2 true) (and (= o19 (length by__)) (in_range1 (length by__)))))
(assert (=> (= result2 true) (= o20 (+ start o19))))
(assert (=> (= result2 true) (= o21 (- o20 1))))
(assert (=> (= result2 true) (and (= o22 (length2 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (and (in_range4 o22) (= o22 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5))))))))
(assert (=> (= result2 true) (= o25 (ite (= o22 o21) true false))))
(assert (=> (not (= result2 true)) (and (= o23 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))))) (and (in_range4 o23) (= o23 (to_rep2 this__split_fields))))))
(assert (=> (not (= result2 true)) (and (= o24 (length2 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (and (in_range4 o24) (= o24 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5))))))))
(assert (=> (not (= result2 true)) (= o25 (ite (= o24 o23) true false))))
(assert (and (= o13 (length by__)) (in_range1 (length by__))))
(assert (= o14 (+ start o13)))
(assert (= temp___1257 (- o14 1)))
(assert (and (= temp___1258 (value (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (and (dynamic_invariant temp___1258 true false true true) (and (= temp___1258 (mk___t (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields__content this__split_fields5))) (mk (to_rep1 (first4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5)))))) (to_rep1 (last4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5))))))))) (and (and (and (= (length temp___1258) (length2 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (= (to_rep1 (first (rt temp___1258))) 1)) (= (to_rep1 (last (rt temp___1258))) (length2 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5))))) (= (< 0 (length2 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (not (= (empty (mk___rep this__split_discrs (us_split_fields__content this__split_fields5))) true))))))))
(assert (<= start temp___1257))
(assert (not (<= (to_rep1 (first (rt temp___1258))) start)))
(check-sat)
(exit)
