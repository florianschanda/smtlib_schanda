...
(define-fun dynamic_invariant1 ((temp___expr_342 Int) (temp___is_init_338 Bool) (temp___skip_constant_339 Bool) (temp___do_toplevel_340 Bool) (temp___do_typ_inv_341 Bool)) Bool (=> (or (= temp___is_init_338 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_342)))
...
(define-fun dynamic_invariant2 ((temp___expr_398 Int) (temp___is_init_394 Bool) (temp___skip_constant_395 Bool) (temp___do_toplevel_396 Bool) (temp___do_typ_inv_397 Bool)) Bool (=> (or (= temp___is_init_394 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_398)))
