...
(assert (and (= o35 (length avail3)) (and (in_range5 o35) (<= (+ 0 o35) 2147483647))))
(assert (= o36 (ite (<= j2 o35) true false)))
(assert (= result13 (ite (<= 2 j2) o36 false)))
(assert (= result13 true))
(assert (and (= temp___298 (get avail3 (- j2 1))) (in_range6 temp___298)))
(assert (and (<= 1 temp___298) (<= temp___298 10000)))
(assert (= o37 temp___298))
(assert (= (mk___rep (mk___split_fields o38 o39)) (select data o37)))
(assert (= o38 o40))
(assert (= o39 o41))
(assert (= o42 o41))
