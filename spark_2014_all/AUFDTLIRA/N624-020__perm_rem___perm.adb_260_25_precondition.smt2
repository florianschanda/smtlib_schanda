...
(assert (and (= o18 (remove b ib1)) (and (dynamic_invariant2 o18 true false true) (and (= (invariant__ o18) true) (and (= (to_rep2 (last (rt o18))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o18) k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o18) (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o18) k))))))))))))
(assert (and (= o20 (remove o18 o19)) (and (dynamic_invariant2 o20 true false true) (and (= (invariant__ o20) true) (and (= (to_rep2 (last (rt o20))) (- (to_rep2 (last (rt o18))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o19 1))) (= (to_rep (select (elts o18) k)) (to_rep (select (elts o20) k))))) (and (forall ((k Int)) (=> (and (<= (+ o19 1) k) (<= k (to_rep2 (last (rt o18))))) (= (to_rep (select (elts o18) k)) (to_rep (select (elts o20) (- k 1)))))) (forall ((k Int)) (=> (and (<= o19 k) (<= k (- (to_rep2 (last (rt o18))) 1))) (= (to_rep (select (elts o18) (+ k 1))) (to_rep (select (elts o20) k))))))))))))
(assert (and (= o17 (remove bb ib1)) (and (dynamic_invariant2 o17 true false true) (and (= (invariant__ o17) true) (and (= (to_rep2 (last (rt o17))) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o17) k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o17) (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o17) k))))))))))))
