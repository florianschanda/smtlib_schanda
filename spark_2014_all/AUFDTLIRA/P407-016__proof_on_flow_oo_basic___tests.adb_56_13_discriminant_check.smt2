...
(define-fun dynamic_invariant ((temp___expr_239 (Array Int us_rep)) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (forall ((temp___240 Int)) (=> (and (<= 1 temp___240) (<= temp___240 1)) (= (attr__constrained (select temp___expr_239 temp___240)) false))))
(define-fun default_initial_assumption ((temp___expr_242 (Array Int us_rep)) (temp___skip_top_level_243 Bool)) Bool (forall ((temp___244 Int)) (=> (and (<= 1 temp___244) (<= temp___244 1)) (and (= (attr__constrained (select temp___expr_242 temp___244)) false) (= (rec__tests__test_14__record_with_mutable_discrs__present (us_split_discrs1 (select temp___expr_242 temp___244))) (distinct 0 0))))))
...
(define-fun default_initial_assumption1 ((temp___expr_224 us_rep) (temp___skip_top_level_225 Bool)) Bool (and (= (attr__constrained temp___expr_224) false) (= (rec__tests__test_14__record_with_mutable_discrs__present (us_split_discrs1 temp___expr_224)) (distinct 0 0))))
(assert (forall ((temp___266 us_rep)) (= (select (tests__test_14__a__aggregate_def temp___266) 1) temp___266)))
