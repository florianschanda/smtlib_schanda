...
(assert (not (= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a19) i)))) (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a i)))))))
(check-sat)
(exit)
