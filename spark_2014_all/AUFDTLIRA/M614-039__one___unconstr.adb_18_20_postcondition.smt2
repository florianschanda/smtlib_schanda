...
(assert (forall ((s1 us_t) (s2 us_t)) (! (=> (and (dynamic_invariant s1 true true true) (dynamic_invariant s2 true true true)) (= (= (equality s1 s2) true) (= (bool_eq (to_array s1) (first1 s1) (last1 s1) (to_array s2) (first1 s2) (last1 s2)) true))) :pattern ((equality s1 s2)))))
...
(assert (forall ((temp___205 Int)) (forall ((temp___206 Int)) (= (select (unconstr__constr_call__s__aggregate_def temp___205) temp___206) (of_rep temp___205)))))
(declare-fun unconstr__constr_call__s2__aggregate_def (Int) (Array Int character))
(assert (forall ((temp___208 Int)) (forall ((temp___209 Int)) (= (select (unconstr__constr_call__s2__aggregate_def temp___208) temp___209) (of_rep temp___208)))))
...
(assert (= unconstr__constr_call__result4 true))
(assert (not true))
(check-sat)
(exit)
