...
(assert (=> (< 0 e) (= o12 (temp___1904 o11 i o10))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o8 (+ k 1))))
(assert (=> (< 0 e) (= o13 (select a o8))))
(assert (=> (< 0 e) (= o14 (temp___1897 o13 j o12))))
(assert (=> (< 0 e) (and (= o15 (+ k 1)) (in_range3 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5571 (temp___1874 a k (temp___1882 (select a k) j (temp___1889 (select (select a k) j) i e)) o15 o14))))
