...
(assert (=> (< 0 e) (= o9 (+ k 1))))
(assert (=> (< 0 e) (= temp___5570 (select a o9))))
(assert (=> (< 0 e) (= o11 (select temp___5570 j))))
(assert (=> (< 0 e) (= o12 (temp_____aggregate_def_1904 o11 i o10))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o8 (+ k 1))))
(assert (=> (< 0 e) (= o13 (select a o8))))
(assert (=> (< 0 e) (= o14 (temp_____aggregate_def_1897 o13 j o12))))
(assert (=> (< 0 e) (and (= o15 (+ k 1)) (in_range3 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5571 (temp_____aggregate_def_1874 a k (temp_____aggregate_def_1882 (select a k) j (temp_____aggregate_def_1889 (select (select a k) j) i e)) o15 o14))))
...
(assert (= o5 (+ k 1)))
(assert (= temp___5580 (select a o5)))
(assert (= o6 (select temp___5580 j)))
(assert (= o7 (temp_____aggregate_def_1943 o6 i 99)))
(assert (not (<= (+ k 1) 16)))
(check-sat)
(exit)
