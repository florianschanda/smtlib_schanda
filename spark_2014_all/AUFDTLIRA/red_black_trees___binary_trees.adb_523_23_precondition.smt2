...
(assert (and (= o56 v) (in_range1 v)))
(assert (and (= temp___1301 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o56)) (and (dynamic_invariant3 temp___1301 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 o56))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1301 o56)))) 0) (and (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (not (= i13 o56)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 i13))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 i13))) true)))))) (and (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 i13))) true) (not (= i13 o56))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1301 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1301 i13)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1301 i13)))) 0)))) (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 i13))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1301 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1301 i13))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1301 j2)))) true)) (= j2 i13))))))))))))))
(assert (= o57 (select temp___1301 i3)))
(assert (= o58 (us_split_fields1 o57)))
(assert (= result13 (rec__tree_model__path_type__k o58)))
(assert (=> (= result13 true) (and (= o49 v) (in_range1 v))))
(assert (=> (= result13 true) (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true)))
(assert (=> (= result13 true) (and (= o50 v) (in_range1 v))))
(assert (=> (= result13 true) (and (= temp___1302 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o50)) (and (dynamic_invariant3 temp___1302 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 o50))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1302 o50)))) 0) (and (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (not (= i13 o50)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 i13))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 i13))) true)))))) (and (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 i13))) true) (not (= i13 o50))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1302 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1302 i13)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1302 i13)))) 0)))) (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 i13))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1302 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1302 i13))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1302 j2)))) true)) (= j2 i13)))))))))))))))
(assert (=> (= result13 true) (= o51 (select temp___1302 i3))))
(assert (=> (= result13 true) (= o52 (us_split_fields1 o51))))
(assert (=> (= result13 true) (= o53 (rec__tree_model__path_type__a o52))))
(assert (=> (= result13 true) (and (= o54 (length o53)) (and (in_range5 o54) (<= (+ 0 o54) 2147483647)))))
(assert (=> (= result13 true) (= result12 (ite (<= o54 (- n2 1)) true false))))
