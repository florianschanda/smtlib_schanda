...
(declare-const temp___1350 (Array Int us_rep1))
...
(declare-const temp___1349 (Array Int us_rep1))
...
(assert (and (= temp___1349 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o7)) (and (dynamic_invariant1 temp___1349 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1349 o7))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1349 o7)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o7)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1349 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1349 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1349 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1349 i1))) true) (not (= i1 o7))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1349 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1349 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1349 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1349 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1349 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1349 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1349 j)))) true)) (= j i1))))))))))))))
(assert (= o8 (select temp___1349 i)))
(assert (= o9 (us_split_fields1 o8)))
(assert (= result2 (rec__tree_model__path_type__k o9)))
(assert (=> (= result2 true) (and (= o v) (in_range2 v))))
(assert (=> (= result2 true) (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true)))
(assert (=> (= result2 true) (and (= o1 v) (in_range2 v))))
(assert (=> (= result2 true) (and (= temp___1350 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o1)) (and (dynamic_invariant1 temp___1350 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1350 o1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1350 o1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o1)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1350 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1350 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1350 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1350 i1))) true) (not (= i1 o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1350 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1350 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1350 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1350 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1350 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1350 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1350 j)))) true)) (= j i1)))))))))))))))
(assert (=> (= result2 true) (= o2 (select temp___1350 i))))
