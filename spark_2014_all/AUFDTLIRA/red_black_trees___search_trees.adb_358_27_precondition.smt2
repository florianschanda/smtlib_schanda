...
(assert true)
(declare-const i Int)
(declare-const temp___1738 (Array Int us_rep1))
...
(declare-const temp___1737 (Array Int us_rep1))
...
(assert (= result2 true))
(assert (and (= o10 (valid_root f v)) (=> (< (size f) v) (not (= o10 true)))))
...
(assert (= o8 (select temp___1760 v)))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___1738 (model__ f root)) (and (dynamic_invariant5 temp___1738 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1738 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1738 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1738 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1738 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1738 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1738 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1738 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1738 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1738 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1738 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1738 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1738 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1738 j)))) true)) (= j i1))))))))))))))
(assert (= o (select temp___1738 i)))
(assert (= o1 (us_split_fields1 o)))
(assert (= result8 (rec__tree_model__path_type__k o1)))
(assert (= result8 true))
(assert (and (= temp___1737 (model__ f root)) (and (dynamic_invariant5 temp___1737 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1737 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1737 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1737 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1737 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1737 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1737 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1737 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1737 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1737 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1737 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1737 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1737 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1737 j)))) true)) (= j i1))))))))))))))
(assert (= o5 (select temp___1737 i)))
(assert (= o6 (us_split_fields1 o5)))
(assert (= o7 (rec__tree_model__path_type__a o6)))
(assert (and (= temp___1736 (model__ f root)) (and (dynamic_invariant5 temp___1736 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1736 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1736 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1736 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1736 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1736 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1736 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1736 j)))) true)) (= j i1))))))))))))))
(assert (= o2 (select temp___1736 v)))
(assert (= o3 (us_split_fields1 o2)))
(assert (= o4 (rec__tree_model__path_type__a o3)))
(assert (and (= result9 (ole o4 o7)) (= (= result9 true) (and (<= (length o4) (length o7)) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o4))) (= (get o4 n) (get o7 n))))))))
