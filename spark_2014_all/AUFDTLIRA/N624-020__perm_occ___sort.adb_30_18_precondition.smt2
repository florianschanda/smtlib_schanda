...
(assert (and (= result (is_set (mk___t (elts1 init) (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))) o4 o7 (mk___t interm (mk (to_rep1 interm__first) (to_rep1 interm__last))))) (= (= result true) (and (and (and (= (to_rep1 (first (mk (to_rep1 interm__first) (to_rep1 interm__last)))) (to_rep1 (first (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init))))))) (= (to_rep1 (last (mk (to_rep1 interm__first) (to_rep1 interm__last)))) (to_rep1 (last (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init)))))))) (= (to_rep (select interm o4)) o7)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init)))))) j) (<= j (to_rep1 (last (mk (to_rep1 (first2 (rt1 init))) (to_rep1 (last2 (rt1 init)))))))) (=> (not (= o4 j)) (= (to_rep (select interm j)) (to_rep (select (elts1 init) j))))))))))
(assert (= result true))
...
(assert (not (<= (to_rep1 (first (mk (to_rep1 interm__first) (to_rep1 interm__last)))) o)))
(check-sat)
(exit)
