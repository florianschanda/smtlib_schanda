...
(assert (= o17 (ite (<= o16 (- (to_rep1 (rec__patience__state__numelts (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o11 i))
(assert (= o12 (select (rec__patience__state__preds (us_split_fields1 s)) o11)))
...
(assert (=> (= result6 true) (= o9 (select (rec__patience__state__preds (us_split_fields1 s)) o8))))
...
(assert (= temp___537 (to_rep1 o4)))
(assert (not (<= 0 temp___537)))
(check-sat)
(exit)
