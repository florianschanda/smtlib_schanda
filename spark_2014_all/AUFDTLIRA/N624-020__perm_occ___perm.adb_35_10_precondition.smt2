...
(assert (= o3 i))
(assert (= o4 (store b1 o3 o2)))
(assert (= b1 result1))
(assert (= b2 o4))
(assert (and (= (mk___t o5 o6) (remove_last r)) (and (dynamic_invariant2 (mk___t o5 o6) true false true) (and (= (elts r) o5) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt r))) (- (to_rep1 (last (rt r))) 1))))) o6)))))
(assert (not (= (bool_eq o5 (to_rep1 (first o6)) (to_rep1 (last o6)) b2 (to_rep1 (first (mk (to_rep1 b__first) (to_rep1 b__last)))) (to_rep1 (last (mk (to_rep1 b__first) (to_rep1 b__last))))) true)))
(check-sat)
(exit)
