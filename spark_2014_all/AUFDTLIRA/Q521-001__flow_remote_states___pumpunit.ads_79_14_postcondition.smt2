...
(declare-fun user_eq2 (nat_type nat_type) Bool)
(declare-const dummy2 nat_type)
...
(define-fun to_rep ((x nat_type)) Int (nat_typeqtint x))
(declare-fun of_rep (Int) nat_type)
(assert (forall ((x nat_type)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x nat_type)) (! (in_range3 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range4 temp___expr_74)))
(define-fun dynamic_invariant3 ((temp___expr_574 Int) (temp___is_init_570 Bool) (temp___skip_constant_571 Bool) (temp___do_toplevel_572 Bool) (temp___do_typ_inv_573 Bool)) Bool (=> (or (= temp___is_init_570 true) (<= 0 1000)) (in_range3 temp___expr_574)))
