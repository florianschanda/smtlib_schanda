...
(define-fun dynamic_invariant1 ((temp___expr_563 Int) (temp___is_init_560 Bool) (temp___skip_constant_561 Bool) (temp___do_toplevel_562 Bool)) Bool (=> (or (= temp___is_init_560 true) (<= 0 3)) (in_range4 temp___expr_563)))
(assert true)
...
(define-fun dynamic_invariant3 ((temp___expr_516 Int) (temp___is_init_513 Bool) (temp___skip_constant_514 Bool) (temp___do_toplevel_515 Bool)) Bool (=> (or (= temp___is_init_513 true) (<= 0 1000)) (in_range2 temp___expr_516)))
