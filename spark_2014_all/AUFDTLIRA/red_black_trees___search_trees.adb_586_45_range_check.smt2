...
(assert (and (= temp___1816 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o)) (and (dynamic_invariant2 temp___1816 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1816 o)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 o)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t2)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t2)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 i2))) true) (not (= i2 o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1816 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t2)) i2)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t2)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1816 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1816 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 i2))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1816 j))) true) (= (oeq1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___1816 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1816 j)))) true)) (= j i2))))))))))))))
(assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___1816 i)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= result6 o4))
(assert (= result6 true))
