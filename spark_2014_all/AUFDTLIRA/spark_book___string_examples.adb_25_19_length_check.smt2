...
(assert (not (= (ite (<= (to_rep1 (first2 temp___6171)) (to_rep1 (last2 temp___6171))) (+ (- (to_rep1 (last2 temp___6171)) (to_rep1 (first2 temp___6171))) 1) 0) (ite (<= (to_rep1 (first2 temp___6191)) (to_rep1 (last2 temp___6191))) (+ (- (to_rep1 (last2 temp___6191)) (to_rep1 (first2 temp___6191))) 1) 0))))
(check-sat)
(exit)
