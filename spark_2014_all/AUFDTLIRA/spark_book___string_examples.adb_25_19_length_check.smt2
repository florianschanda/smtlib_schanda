...
(assert (not (= (ite (<= (to_rep1 (first2 temp___6101)) (to_rep1 (last2 temp___6101))) (+ (- (to_rep1 (last2 temp___6101)) (to_rep1 (first2 temp___6101))) 1) 0) (ite (<= (to_rep1 (first2 temp___6121)) (to_rep1 (last2 temp___6121))) (+ (- (to_rep1 (last2 temp___6121)) (to_rep1 (first2 temp___6121))) 1) 0))))
(check-sat)
(exit)
