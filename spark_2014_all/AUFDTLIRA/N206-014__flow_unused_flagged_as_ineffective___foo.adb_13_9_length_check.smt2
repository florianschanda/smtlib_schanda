...
(declare-fun temp_____aggregate_def_185 (Int Int Int) us_t1)
...
(assert (forall ((temp___187 Int) (temp___188 Int) (temp___189 Int)) (let ((temp___186 (temp_____aggregate_def_185 temp___187 temp___188 temp___189))) (=> (dynamic_invariant1 temp___187 true true true true) (and (=> (dynamic_property 1 2147483647 temp___188 temp___189) (and (= (first3 temp___186) temp___188) (= (last3 temp___186) temp___189))) (forall ((temp___190 Int)) (= (to_rep (select (to_array1 temp___186) temp___190)) temp___187)))))))
(declare-const temp___192 (Array Int character))
...
(assert (= (to_rep1 (first2 (rt1 (temp_____aggregate_def_185 120 (to_rep1 x__first) (to_rep1 x__last))))) (to_rep1 x__first)))
(assert (= (to_rep1 (last2 (rt1 (temp_____aggregate_def_185 120 (to_rep1 x__first) (to_rep1 x__last))))) (to_rep1 x__last)))
(assert (= (mk___t1 temp___192 temp___1921) (temp_____aggregate_def_185 120 (to_rep1 x__first) (to_rep1 x__last))))
(assert (= temp___192 temp___193))
(assert (= (mk (to_rep1 (first2 temp___1921)) (to_rep1 (last2 temp___1921))) temp___1931))
(assert (not (= (ite (<= (to_rep1 (first temp___1931)) (to_rep1 (last temp___1931))) (+ (- (to_rep1 (last temp___1931)) (to_rep1 (first temp___1931))) 1) 0) (ite (<= (to_rep1 x__first) (to_rep1 x__last)) (+ (- (to_rep1 x__last) (to_rep1 x__first)) 1) 0))))
(check-sat)
(exit)
