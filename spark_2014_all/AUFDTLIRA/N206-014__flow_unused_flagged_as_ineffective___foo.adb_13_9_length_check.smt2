...
(assert (= (to_rep1 (first2 (rt1 (temp___185 120 (to_rep1 x__first) (to_rep1 x__last))))) (to_rep1 x__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___185 120 (to_rep1 x__first) (to_rep1 x__last))))) (to_rep1 x__last)))
(assert (= (mk___t1 temp___192 temp___1921) (temp___185 120 (to_rep1 x__first) (to_rep1 x__last))))
