...
(assert (forall ((temp___163 Int) (temp___164 Int) (temp___165 Int)) (let ((temp___162 (temp___161 temp___163 temp___164 temp___165))) (and (=> (dynamic_property 1 2147483647 temp___164 temp___165) (and (= (first3 temp___162) temp___164) (= (last3 temp___162) temp___165))) (forall ((temp___166 Int)) (= (select (to_array1 temp___162) temp___166) (of_rep temp___163)))))))
...
(declare-const temp___1681 t1)
(declare-const temp___169 (Array Int character))
(declare-const temp___1691 t)
(assert (dynamic_property 1 2147483647 (to_rep1 x__first) (to_rep1 x__last)))
(assert (= (to_rep1 (first2 (rt1 (temp___161 120 (to_rep1 x__first) (to_rep1 x__last))))) (to_rep1 x__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___161 120 (to_rep1 x__first) (to_rep1 x__last))))) (to_rep1 x__last)))
(assert (= (mk___t1 temp___168 temp___1681) (temp___161 120 (to_rep1 x__first) (to_rep1 x__last))))
(assert (= temp___168 temp___169))
(assert (= (mk (to_rep1 (first2 temp___1681)) (to_rep1 (last2 temp___1681))) temp___1691))
(assert (not (= (ite (<= (to_rep1 (first temp___1691)) (to_rep1 (last temp___1691))) (+ (- (to_rep1 (last temp___1691)) (to_rep1 (first temp___1691))) 1) 0) (ite (<= (to_rep1 x__first) (to_rep1 x__last)) (+ (- (to_rep1 x__last) (to_rep1 x__first)) 1) 0))))
(check-sat)
(exit)
