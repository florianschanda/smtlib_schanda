...
(declare-const temp___227 integer)
(declare-const temp___2271 Bool)
(declare-const temp___2272 (Array Int integer))
...
(assert (= temp___227 x__split_fields3))
(assert (= temp___2271 x__split_fields4))
(assert (= temp___2272 x__split_fields5))
