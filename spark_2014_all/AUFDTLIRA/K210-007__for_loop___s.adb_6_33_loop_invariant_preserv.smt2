...
(declare-const s__contains__result15 Bool)
(declare-const index13 Int)
(declare-const s__contains__result16 Bool)
...
(assert (= s__contains__result3 s__contains__result2))
...
(assert (<= 1 j1))
(assert (<= j1 (- index3 1)))
(assert (not (not (= (to_rep (select table j1)) value))))
(check-sat)
(exit)
