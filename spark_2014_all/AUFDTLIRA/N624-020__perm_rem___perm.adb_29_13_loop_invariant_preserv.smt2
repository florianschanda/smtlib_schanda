...
(assert (not (= ib3 (to_rep1 (last (rt b))))))
(assert (= ib3 result8))
(assert (= ib4 (+ ib3 1)))
(assert (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))))
(assert (= o36 ia))
(assert (= o37 (select (elts a) o36)))
(assert (= o38 (to_rep o37)))
(assert (= result10 (ite (= o38 (to_rep (select (elts b) ib4))) true false)))
(assert (=> (= result10 true) (and (= o33 ib4) (in_range2 ib4))))
(assert (=> (= result10 true) (and (= (mk___t o34 o35) (remove b o33)) (and (dynamic_invariant1 (mk___t o34 o35) true false true) (and (= (invariant__ (mk___t o34 o35)) true) (and (= (to_rep1 (last o35)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o33 1))) (= (to_rep (select (elts b) k)) (to_rep (select o34 k))))) (and (forall ((k Int)) (=> (and (<= (+ o33 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o34 (- k 1)))))) (forall ((k Int)) (=> (and (<= o33 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o34 k)))))))))))))
(assert (=> (= result10 true) (and (= (mk___t o31 o32) (remove a ia)) (and (dynamic_invariant1 (mk___t o31 o32) true false true) (and (= (invariant__ (mk___t o31 o32)) true) (and (= (to_rep1 (last o32)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o31 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o31 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o31 k)))))))))))))
(assert (=> (= result10 true) (and (= result9 (is_perm (mk___t o31 o32) (mk___t o34 o35))) (= (= result9 true) (or (and (= (length (mk___t o31 o32)) 0) (= (length (mk___t o34 o35)) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o32)) ia1) (<= ia1 (to_rep1 (last o32)))) (exists ((ib17 Int)) (and (and (<= (to_rep1 (first o35)) ib17) (<= ib17 (to_rep1 (last o35)))) (and (= (to_rep (select o31 ia1)) (to_rep (select o34 ib17))) (= (is_perm (remove (mk___t o31 o32) ia1) (remove (mk___t o34 o35) ib17)) true)))))))))))
...
(assert (<= 1 kb1))
(assert (<= kb1 ib4))
(assert (not (not (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) kb1))) (= (is_perm (remove a ia) (remove b kb1)) true)))))
(check-sat)
(exit)
