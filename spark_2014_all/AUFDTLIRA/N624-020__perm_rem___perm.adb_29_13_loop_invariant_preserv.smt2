...
(assert (=> (= result2 true) (and (= o18 (remove b o2)) (and (dynamic_invariant1 o18 true false true true) (and (= (invariant__ o18) true) (and (= (to_rep1 (last o4)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o2 1))) (= (to_rep (select (elts b) k)) (to_rep (select o3 k))))) (and (forall ((k Int)) (=> (and (<= (+ o2 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o3 (- k 1)))))) (forall ((k Int)) (=> (and (<= o2 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o3 k)))))))))))))
(assert (=> (= result2 true) (and (= o19 (remove a ia)) (and (dynamic_invariant1 o19 true false true true) (and (= (invariant__ o19) true) (and (= (to_rep1 (last o1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o k)))))))))))))
(assert (=> (= result2 true) (and (= result1 (is_perm o19 o18)) (= (= result1 true) (or (and (= (length o19) 0) (= (length o18) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o1)) ia1) (<= ia1 (to_rep1 (last o1)))) (exists ((ib4 Int)) (and (and (<= (to_rep1 (first o4)) ib4) (<= ib4 (to_rep1 (last o4)))) (and (= (to_rep (select o ia1)) (to_rep (select o3 ib4))) (= (is_perm (remove o19 ia1) (remove o18 ib4)) true)))))))))))
...
(assert (= result5 (ite (= o15 (to_rep (select (elts b) ib3))) true false)))
(assert (=> (= result5 true) (and (= o10 ib3) (in_range2 ib3))))
(assert (=> (= result5 true) (and (= o16 (remove b o10)) (and (dynamic_invariant1 o16 true false true true) (and (= (invariant__ o16) true) (and (= (to_rep1 (last o12)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o10 1))) (= (to_rep (select (elts b) k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ o10 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= o10 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o11 k)))))))))))))
(assert (=> (= result5 true) (and (= o17 (remove a ia)) (and (dynamic_invariant1 o17 true false true true) (and (= (invariant__ o17) true) (and (= (to_rep1 (last o9)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o8 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o8 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o8 k)))))))))))))
(assert (=> (= result5 true) (and (= result4 (is_perm o17 o16)) (= (= result4 true) (or (and (= (length o17) 0) (= (length o16) 0)) (exists ((ia1 Int)) (and (and (<= (to_rep1 (first o9)) ia1) (<= ia1 (to_rep1 (last o9)))) (exists ((ib4 Int)) (and (and (<= (to_rep1 (first o12)) ib4) (<= ib4 (to_rep1 (last o12)))) (and (= (to_rep (select o8 ia1)) (to_rep (select o11 ib4))) (= (is_perm (remove o17 ia1) (remove o16 ib4)) true)))))))))))
