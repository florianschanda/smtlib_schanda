...
(define-fun bool_eq ((a (Array Int integer)) (a__first Int) (a__last Int) (b (Array Int integer)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep2 (select a temp___idx_132)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((a (Array Int integer)) (b (Array Int integer))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int integer)) (b (Array Int integer))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(declare-sort t1 0)
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__proc__r__length (us_split_discrs1 a))) (to_rep1 (rec__proc__r__length (us_split_discrs1 b)))) (= (bool_eq2 (rec__proc__r__contents (us_split_fields1 a)) (rec__proc__r__contents (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant ((temp___expr_185 us_rep) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool)) Bool (let ((temp___186 (rec__proc__r__length (us_split_discrs1 temp___expr_185)))) (and (dynamic_property2 1 (to_rep1 temp___186) (first3 (rec__proc__r__contents (us_split_fields1 temp___expr_185))) (last3 (rec__proc__r__contents (us_split_fields1 temp___expr_185)))) (and (= (first3 (rec__proc__r__contents (us_split_fields1 temp___expr_185))) 1) (= (last3 (rec__proc__r__contents (us_split_fields1 temp___expr_185))) (to_rep1 temp___186))))))
...
(define-fun dynamic_invariant2 ((temp___expr_180 us_t) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (not (= temp___skip_constant_178 true)) (dynamic_property 1 10 (first1 temp___expr_180) (last1 temp___expr_180))))
(declare-fun f (Int) us_t)
(declare-fun f__function_guard (us_t Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (dynamic_invariant2 (f x) true false true)) :pattern ((f x)))))
...
(assert (forall ((f1 Int) (l Int)) (! (=> (in_range f1) (=> (in_range l) (and (= (to_rep (first4 (mk2 f1 l))) f1) (= (to_rep (last4 (mk2 f1 l))) l)))) :pattern ((mk2 f1 l)))))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___134 (rec__proc__r__contents1 (us_split_fields3 a)))) (of_array1 (to_array2 temp___134) (first5 temp___134) (last5 temp___134))))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___133 (rec__proc__r__contents (us_split_fields1 r)))) (of_array2 (to_array1 temp___133) (first3 temp___133) (last3 temp___133))))))
(define-fun bool_eq5 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep1 (rec__proc__r__length (us_split_discrs2 a))) (to_rep1 (rec__proc__r__length (us_split_discrs2 b)))) (= (bool_eq4 (rec__proc__r__contents1 (us_split_fields3 a)) (rec__proc__r__contents1 (us_split_fields3 b))) true)) true false))
(define-fun in_range3 ((rec__proc__r__length1 Int) (a us_rep)) Bool (= rec__proc__r__length1 (to_rep1 (rec__proc__r__length (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant3 ((temp___expr_174 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 10)) (in_range1 temp___expr_174)))
...
(assert (and (= (mk___t proc__p__item__assume proc__p__item__assume1) (f 3)) (dynamic_invariant2 (mk___t proc__p__item__assume proc__p__item__assume1) true false true)))
(assert (= result item))
...
(assert (=> (<= (to_rep item__first) (to_rep item__last)) (= o2 (+ (- (to_rep item__last) (to_rep item__first)) 1))))
(assert (=> (not (<= (to_rep item__first) (to_rep item__last))) (= o2 0)))
(assert (= (slide item1 (to_rep item__first) 1) o3))
(assert (= (mk2 1 o2) o4))
(assert (= o5 o3))
(assert (= o6 o4))
