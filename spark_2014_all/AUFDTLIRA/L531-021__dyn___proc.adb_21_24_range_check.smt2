...
(define-fun dynamic_invariant ((temp___expr_216 us_rep) (temp___is_init_212 Bool) (temp___skip_constant_213 Bool) (temp___do_toplevel_214 Bool) (temp___do_typ_inv_215 Bool)) Bool (let ((temp___217 (rec__proc__r__length (us_split_discrs1 temp___expr_216)))) (and (dynamic_property2 1 (to_rep1 temp___217) (first3 (rec__proc__r__contents (us_split_fields1 temp___expr_216))) (last3 (rec__proc__r__contents (us_split_fields1 temp___expr_216)))) (and (= (first3 (rec__proc__r__contents (us_split_fields1 temp___expr_216))) 1) (= (last3 (rec__proc__r__contents (us_split_fields1 temp___expr_216))) (to_rep1 temp___217))))))
...
(define-fun dynamic_invariant2 ((temp___expr_210 us_t) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (not (= temp___skip_constant_207 true)) (dynamic_property 1 10 (first1 temp___expr_210) (last1 temp___expr_210))))
(declare-fun f (Int) us_t)
(declare-fun f__function_guard (us_t Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true true) (dynamic_invariant2 (f x) true false true true)) :pattern ((f x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_203 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool) (temp___do_typ_inv_202 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 1 10)) (in_range1 temp___expr_203)))
...
(assert (and (= proc__p__item__assume2 (f 3)) (dynamic_invariant2 proc__p__item__assume2 true false true true)))
(assert (= result item))
