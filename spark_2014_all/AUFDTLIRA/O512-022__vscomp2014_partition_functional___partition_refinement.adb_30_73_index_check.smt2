...
(declare-const temp___1259 us_rep5)
(declare-const k Int)
...
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (forall ((c us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c) true) (=> (and (not (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep (select a1 i)))) (not (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep (select a1 j))))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c))))))
(assert (forall ((c us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep (select a1 i))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c))))))
(assert (forall ((c us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c) (to_rep (select a1 j))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c))))))
(assert (forall ((c us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c) true) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c))) (key (mk___rep d__split_discrs d__split_fields2) c)))))
...
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 5)) (= (to_rep (select a1 k1)) (ite (= k1 i) (to_rep (select a_old j)) (ite (= k1 j) (to_rep (select a_old i)) (to_rep (select a_old k1))))))))
