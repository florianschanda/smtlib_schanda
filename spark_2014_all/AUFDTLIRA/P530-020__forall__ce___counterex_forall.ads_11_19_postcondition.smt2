...
(declare-const r10 (Array Int Bool))
...
(assert (= x1 1))
(assert (=> (and (<= 1 x1) (<= x1 100)) (and (and (= temp___157 x1) (and (= temp___155 r) (and (and (= (mk_map__ref result1) (mk_map__ref r)) (= r2 (store r x1 (ite (= x1 c) true false)))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 x2)) (= (= (select r3 i1) true) (= i1 (+ c 1))))) (and (and (and (forall ((temp___156 Int)) (=> (and (<= (- 2147483648) temp___156) (<= temp___156 2147483647)) (=> (< x2 temp___156) (= (select r3 temp___156) (select temp___155 temp___156))))) (=> (<= 1 100) (in_range2 x2))) (and (<= 1 x2) (<= x2 100))) (= x2 100)))))) (and (and (= x2 x6) (= r3 r7)) (and (= x7 x2) (= r8 r3))))))
(assert (=> (and (<= 1 x1) (<= x1 100)) (= (mk_int__ref x8) (mk_int__ref x6))))
(assert (=> (and (<= 1 x1) (<= x1 100)) (= (mk_map__ref r9) (mk_map__ref r7))))
(assert (=> (and (<= 1 x1) (<= x1 100)) (= x9 x7)))
(assert (=> (and (<= 1 x1) (<= x1 100)) (= r10 r8)))
(assert (=> (not (and (<= 1 x1) (<= x1 100))) (= x1 x8)))
(assert (=> (not (and (<= 1 x1) (<= x1 100))) (= (mk_map__ref r9) (mk_map__ref r))))
(assert (=> (not (and (<= 1 x1) (<= x1 100))) (= x9 x1)))
(assert (=> (not (and (<= 1 x1) (<= x1 100))) (= r10 r1)))
...
(assert (= result4 counterex_forall__single_char_set_broken__result))
(assert (= counterex_forall__single_char_set_broken__result1 r9))
...
(assert (= x11 x9))
(assert (= r12 r10))
(assert (= result5 counterex_forall__single_char_set_broken__result4))
(declare-const i1 Int)
(assert (<= (- 2147483648) i1))
(assert (<= i1 2147483647))
(assert (= (select counterex_forall__single_char_set_broken__result4 i1) true))
(assert (not (< c i1)))
(check-sat)
(exit)
