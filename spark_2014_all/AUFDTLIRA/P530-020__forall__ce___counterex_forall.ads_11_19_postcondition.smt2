...
(assert (= x1 1))
(assert (=> (and (<= 1 x1) (<= x1 100)) (= temp___181 x1)))
(assert (=> (and (<= 1 x1) (<= x1 100)) (= temp___179 r)))
...
(assert (=> (and (<= 1 x1) (<= x1 100)) (and (and (forall ((temp___180 Int)) (=> (and (<= (- 2147483648) temp___180) (<= temp___180 2147483647)) (=> (< x2 temp___180) (= (select r3 temp___180) (select temp___179 temp___180))))) (=> (<= 1 100) (in_range2 x2))) (and (<= 1 x2) (<= x2 100)))))
