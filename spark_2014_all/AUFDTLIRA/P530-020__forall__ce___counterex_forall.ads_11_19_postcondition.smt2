...
(assert (=> (and (<= 1 x1) (<= x1 100)) (and (and (forall ((temp___156 Int)) (=> (and (<= (- 2147483648) temp___156) (<= temp___156 2147483647)) (=> (< x2 temp___156) (= (select r3 temp___156) (select temp___155 temp___156))))) (=> (<= 1 100) (in_range2 x2))) (and (<= 1 x2) (<= x2 100)))))
