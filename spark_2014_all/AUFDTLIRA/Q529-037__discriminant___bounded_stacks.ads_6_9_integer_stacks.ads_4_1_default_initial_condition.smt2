...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 a))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 b)))) (and (= (bool_eq1 (rec__integer_stacks__stack__values (us_split_fields1 a)) (rec__integer_stacks__stack__values (us_split_fields1 b))) true) (= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 a))) (to_rep (rec__integer_stacks__stack__top (us_split_fields1 b)))))) true false))
...
(define-fun bool_eq5 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs2 a))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs2 b)))) (and (= (bool_eq4 (rec__integer_stacks__stack__values1 (us_split_fields3 a)) (rec__integer_stacks__stack__values1 (us_split_fields3 b))) true) (= (to_rep (rec__integer_stacks__stack__top1 (us_split_fields3 a))) (to_rep (rec__integer_stacks__stack__top1 (us_split_fields3 b)))))) true false))
...
(assert (and (dynamic_invariant1 (mk___rep (mk___split_discrs temp___242) (mk___split_fields (mk___t temp___2421 temp___2422) temp___2423 temp___2424) temp___2425) true false true) (and (= temp___2425 us_tag) (and (let ((temp___244 (temp___218 0 1 (to_rep1 temp___242)))) (and (= temp___2421 (elts1 temp___244)) (= temp___2422 (mk (to_rep2 (first2 (rt1 temp___244))) (to_rep2 (last2 (rt1 temp___244))))))) (= (to_rep temp___2423) 0)))))
(assert (not (= (empty (mk___rep (mk___split_discrs temp___242) (mk___split_fields (mk___t temp___2421 temp___2422) temp___2423 temp___2424) temp___2425)) true)))
(check-sat)
(exit)
