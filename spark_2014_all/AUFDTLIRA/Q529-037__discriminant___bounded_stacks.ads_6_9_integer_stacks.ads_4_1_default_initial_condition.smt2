...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___156 (rec__integer_stacks__stack__values1 (us_split_fields3 a)))) (of_array (to_array2 temp___156) (first5 temp___156) (last5 temp___156))) (rec__integer_stacks__stack__top1 (us_split_fields3 a)) (hide_ext__ (rec__ext__1 (us_split_fields3 a)))) (attr__tag1 a)))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___155 (rec__integer_stacks__stack__values (us_split_fields1 r)))) (of_array2 (to_array temp___155) (first1 temp___155) (last1 temp___155))) (rec__integer_stacks__stack__top (us_split_fields1 r)) (extract__ext__ (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
...
(declare-fun temp___245 (Int Int Int) us_t1)
...
(assert (forall ((temp___247 Int) (temp___248 Int) (temp___249 Int)) (let ((temp___246 (temp___245 temp___247 temp___248 temp___249))) (=> (dynamic_invariant5 temp___247 true true true true) (and (=> (dynamic_property10 1 2147483647 temp___248 temp___249) (and (= (first3 temp___246) temp___248) (= (last3 temp___246) temp___249))) (forall ((temp___250 Int)) (= (to_rep3 (select (to_array1 temp___246) temp___250)) temp___247)))))))
...
(define-fun temp___2706 () us_rep (mk___rep (mk___split_discrs temp___270) (mk___split_fields (mk___t temp___2701 temp___2702) temp___2703 temp___2704) temp___2705))
(assert (in_range1 temp___267))
(assert (= temp___267 (to_rep1 temp___266)))
(assert (and (dynamic_invariant1 temp___2706 true false true true) (and (= temp___2705 us_tag) (and (let ((temp___272 (temp___245 0 1 (to_rep1 temp___270)))) (and (= temp___2701 (elts1 temp___272)) (= temp___2702 (mk (to_rep2 (first2 (rt1 temp___272))) (to_rep2 (last2 (rt1 temp___272))))))) (= (to_rep temp___2703) 0)))))
(assert (not (= (empty temp___2706) true)))
(check-sat)
(exit)
