...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 a))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 b)))) (= (bool_eq1 (rec__integer_stacks__stack__values (us_split_fields1 a)) (rec__integer_stacks__stack__values (us_split_fields1 b))) true)) (= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 a))) (to_rep (rec__integer_stacks__stack__top (us_split_fields1 b))))) true false))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__integer_stacks__stack__values1 us_t2) (rec__integer_stacks__stack__top1 natural) (rec__ext__1 us_private)))))
(define-fun us_split_fields_Values__2__projection ((a us_split_fields2)) us_t2 (rec__integer_stacks__stack__values1 a))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___134 (rec__integer_stacks__stack__values1 (us_split_fields3 a)))) (of_array (to_array2 temp___134) (first5 temp___134) (last5 temp___134))) (rec__integer_stacks__stack__top1 (us_split_fields3 a)) (hide_ext__ (rec__ext__1 (us_split_fields3 a)))) (attr__tag1 a)))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___133 (rec__integer_stacks__stack__values (us_split_fields1 r)))) (of_array2 (to_array temp___133) (first1 temp___133) (last1 temp___133))) (rec__integer_stacks__stack__top (us_split_fields1 r)) (extract__ext__ (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
(define-fun bool_eq5 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs2 a))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs2 b)))) (= (bool_eq4 (rec__integer_stacks__stack__values1 (us_split_fields3 a)) (rec__integer_stacks__stack__values1 (us_split_fields3 b))) true)) (= (to_rep (rec__integer_stacks__stack__top1 (us_split_fields3 a))) (to_rep (rec__integer_stacks__stack__top1 (us_split_fields3 b))))) true false))
...
(define-fun to_base2 ((a us_rep3)) us_rep (mk___rep (us_split_discrs4 a) (mk___split_fields (let ((temp___138 (rec__integer_stacks__stack__values3 (us_split_fields7 a)))) (of_array (to_array4 temp___138) (first9 temp___138) (last9 temp___138))) (rec__integer_stacks__stack__top3 (us_split_fields7 a)) (hide_ext__2 (rec__ext__3 (us_split_fields7 a)))) (attr__tag3 a)))
(define-fun of_base2 ((r us_rep)) us_rep3 (mk___rep3 (us_split_discrs1 r) (mk___split_fields3 (let ((temp___137 (rec__integer_stacks__stack__values (us_split_fields1 r)))) (of_array4 (to_array temp___137) (first1 temp___137) (last1 temp___137))) (rec__integer_stacks__stack__top (us_split_fields1 r)) (extract__ext__2 (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
(define-fun bool_eq9 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 a))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 b)))) (= (bool_eq8 (rec__integer_stacks__stack__values3 (us_split_fields7 a)) (rec__integer_stacks__stack__values3 (us_split_fields7 b))) true)) (= (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 a))) (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 b))))) true false))
...
(assert (forall ((temp___220 Int) (temp___221 Int) (temp___222 Int)) (let ((temp___219 (temp___218 temp___220 temp___221 temp___222))) (and (=> (dynamic_property10 1 2147483647 temp___221 temp___222) (and (= (first3 temp___219) temp___221) (= (last3 temp___219) temp___222))) (forall ((temp___223 Int)) (= (select (to_array1 temp___219) temp___223) (of_rep3 temp___220)))))))
...
(assert (forall ((a us_rep1) (b us_rep1)) (! (= (user_eq11 a b) (oeq (to_base a) (to_base b))) :pattern ((user_eq11 a b)))))
...
(define-fun dynamic_invariant5 ((temp___expr_229 us_rep3) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (and (=> (not (= temp___skip_constant_227 true)) (in_range7 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (to_base2 temp___expr_229))) (and (dynamic_property9 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (first9 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) (last9 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229)))) (and (= (first9 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) 1) (= (last9 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))))
(define-fun default_initial_assumption ((temp___expr_232 us_rep3) (temp___skip_top_level_233 Bool)) Bool (and (and (= (attr__tag3 temp___expr_232) us_tag3) (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_232))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (= (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_232)) (let ((temp___235 (temp___218 0 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_232)))))) (of_array4 (to_array1 temp___235) (first3 temp___235) (last3 temp___235))))) (= (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 temp___expr_232))) 0))) (=> (not (= temp___skip_top_level_233 true)) (= (empty (to_base2 temp___expr_232)) true))))
...
(define-fun temp___2426 () us_rep (mk___rep (mk___split_discrs temp___242) (mk___split_fields (mk___t temp___2421 temp___2422) temp___2423 temp___2424) temp___2425))
(assert (in_range1 temp___239))
(assert (= temp___239 (to_rep1 temp___238)))
(assert (and (dynamic_invariant1 temp___2426 true false true) (and (= temp___2425 us_tag) (and (let ((temp___244 (temp___218 0 1 (to_rep1 temp___242)))) (and (= temp___2421 (elts1 temp___244)) (= temp___2422 (mk (to_rep2 (first2 (rt1 temp___244))) (to_rep2 (last2 (rt1 temp___244))))))) (= (to_rep temp___2423) 0)))))
(assert (not (= (empty temp___2426) true)))
(check-sat)
(exit)
