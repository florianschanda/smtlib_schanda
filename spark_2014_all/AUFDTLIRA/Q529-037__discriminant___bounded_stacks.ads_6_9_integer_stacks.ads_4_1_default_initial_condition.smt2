...
(declare-fun temp_____aggregate_def_245 (Int Int Int) us_t4)
...
(assert (forall ((temp___247 Int) (temp___248 Int) (temp___249 Int)) (let ((temp___246 (temp_____aggregate_def_245 temp___247 temp___248 temp___249))) (=> (dynamic_invariant5 temp___247 true true true true) (and (=> (dynamic_property10 1 2147483647 temp___248 temp___249) (and (= (first9 temp___246) temp___248) (= (last9 temp___246) temp___249))) (forall ((temp___250 Int)) (= (select (to_array4 temp___246) temp___250) rliteral)))))))
...
(assert (and (dynamic_invariant1 temp___2706 true false true true) (and (= temp___2705 us_tag) (and (let ((temp___272 (temp_____aggregate_def_245 0 1 (to_rep1 temp___270)))) (and (= temp___2701 (elts4 temp___272)) (= temp___2702 (mk (to_rep2 (first8 (rt4 temp___272))) (to_rep2 (last8 (rt4 temp___272))))))) (= (to_rep temp___2703) 0)))))
