...
(assert (= o42 v))
(assert (= o43 (select temp___1531 o42)))
...
(assert (= o39 (select temp___1530 ki1)))
...
(assert (and (= temp___1529 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) o35)) (and (dynamic_invariant3 temp___1529 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1529 o35))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1529 o35)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i o35)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1529 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1529 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1529 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1529 i))) true) (not (= i o35))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1529 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1529 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1529 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1529 i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1529 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1529 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1529 j)))) true)) (= j i))))))))))))))
(assert (= o36 (select temp___1529 ki1)))
