...
(assert (not (= (length1 temp___10172) 0)))
(assert (=> (<= (to_rep1 (first2 temp___10181)) (to_rep1 (last2 temp___10181))) (= o (+ (- (to_rep1 (last2 temp___10181)) (to_rep1 (first2 temp___10181))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___10181)) (to_rep1 (last2 temp___10181)))) (= o 0)))
(assert (=> (<= (to_rep1 (first2 temp___10171)) (to_rep1 (last2 temp___10171))) (= o1 (+ (- (to_rep1 (last2 temp___10171)) (to_rep1 (first2 temp___10171))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___10171)) (to_rep1 (last2 temp___10171)))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first2 temp___10171)) o2)))
(assert (= o4 (- o3 1)))
