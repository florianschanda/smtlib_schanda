...
(assert (forall ((x classt)) (! (in_range7 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep5 (rec__privtypes__clearancet__class (us_split_fields5 a))) (to_rep5 (rec__privtypes__clearancet__class (us_split_fields5 b)))) true false))
...
(define-fun bool_eq5 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (to_rep6 (rec__clock__timet__year (us_split_fields7 a))) (to_rep6 (rec__clock__timet__year (us_split_fields7 b)))) (= (to_rep7 (rec__clock__timet__month (us_split_fields7 a))) (to_rep7 (rec__clock__timet__month (us_split_fields7 b))))) (= (to_rep8 (rec__clock__timet__day (us_split_fields7 a))) (to_rep8 (rec__clock__timet__day (us_split_fields7 b))))) (= (to_rep9 (rec__clock__timet__millisec (us_split_fields7 a))) (to_rep9 (rec__clock__timet__millisec (us_split_fields7 b))))) true false))
...
(assert true)
(define-fun dynamic_invariant ((temp___expr_353 Int) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool)) Bool (=> (or (= temp___is_init_350 true) (<= 0 5)) (in_range7 temp___expr_353)))
(declare-fun theenclaveclearance (us_private) Int)
(declare-fun theenclaveclearance__function_guard (Int us_private) Bool)
(assert (forall ((configdata__state us_private)) (! (dynamic_invariant (theenclaveclearance configdata__state) true false true) :pattern ((theenclaveclearance configdata__state)))))
...
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__cert__contentst__id us_rep1) (rec__cert__contentst__notbefore us_rep3) (rec__cert__contentst__notafter us_rep3) (rec__cert__contentst__mechanism algorithmt)))))
(define-fun us_split_fields_ID__3__projection ((a us_split_fields8)) us_rep1 (rec__cert__contentst__id a))
(define-fun us_split_fields_NotBefore__projection ((a us_split_fields8)) us_rep3 (rec__cert__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__projection ((a us_split_fields8)) us_rep3 (rec__cert__contentst__notafter a))
(define-fun us_split_fields_Mechanism__projection ((a us_split_fields8)) algorithmt (rec__cert__contentst__mechanism a))
...
(define-fun bool_eq6 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (= (bool_eq3 (rec__cert__contentst__id (us_split_fields9 a)) (rec__cert__contentst__id (us_split_fields9 b))) true) (= (bool_eq5 (rec__cert__contentst__notbefore (us_split_fields9 a)) (rec__cert__contentst__notbefore (us_split_fields9 b))) true)) (= (bool_eq5 (rec__cert__contentst__notafter (us_split_fields9 a)) (rec__cert__contentst__notafter (us_split_fields9 b))) true)) (= (to_rep10 (rec__cert__contentst__mechanism (us_split_fields9 a))) (to_rep10 (rec__cert__contentst__mechanism (us_split_fields9 b))))) true false))
...
(define-fun contentst__ref___projection ((a contentst__ref)) us_rep4 (contentst__content a))
...
(assert (forall ((x keyidt)) (! (in_range13 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(assert (forall ((x keylengtht)) (! (in_range14 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__id__contentst__id us_rep1) (rec__cert__id__contentst__notbefore us_rep3) (rec__cert__id__contentst__notafter us_rep3) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep) (rec__cert__id__contentst__subjectpublickey us_rep5)))))
(define-fun us_split_fields_ID__4__projection ((a us_split_fields12)) us_rep1 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__2__projection ((a us_split_fields12)) us_rep3 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__2__projection ((a us_split_fields12)) us_rep3 (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__2__projection ((a us_split_fields12)) algorithmt (rec__cert__id__contentst__mechanism a))
...
(define-fun bool_eq8 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__id__contentst__id (us_split_fields13 a)) (rec__cert__id__contentst__id (us_split_fields13 b))) true) (= (bool_eq5 (rec__cert__id__contentst__notbefore (us_split_fields13 a)) (rec__cert__id__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq5 (rec__cert__id__contentst__notafter (us_split_fields13 a)) (rec__cert__id__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep10 (rec__cert__id__contentst__mechanism (us_split_fields13 a))) (to_rep10 (rec__cert__id__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq2 (rec__cert__id__contentst__subject (us_split_fields13 a)) (rec__cert__id__contentst__subject (us_split_fields13 b))) true)) (= (bool_eq7 (rec__cert__id__contentst__subjectpublickey (us_split_fields13 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields13 b))) true)) true false))
...
(define-fun contentst__ref___2__projection ((a contentst__ref1)) us_rep6 (contentst__content1 a))
...
(declare-const dummy23 privileget)
...
(assert (forall ((x privileget)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x privileget)) (! (in_range15 (to_rep13 x)) :pattern ((to_rep13 x)))))
(assert (forall ((x Int)) (! (=> (in_range15 x) (= (to_rep13 (of_rep13 x)) x)) :pattern ((to_rep13 (of_rep13 x))))))
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__cert__attr__priv__contentst__id us_rep1) (rec__cert__attr__priv__contentst__notbefore us_rep3) (rec__cert__attr__priv__contentst__notafter us_rep3) (rec__cert__attr__priv__contentst__mechanism algorithmt) (rec__cert__attr__priv__contentst__basecertid us_rep1) (rec__cert__attr__priv__contentst__role privileget) (rec__cert__attr__priv__contentst__clearance us_rep2)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields14)) us_rep1 (rec__cert__attr__priv__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields14)) us_rep3 (rec__cert__attr__priv__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields14)) us_rep3 (rec__cert__attr__priv__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields14)) algorithmt (rec__cert__attr__priv__contentst__mechanism a))
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields14)) us_rep1 (rec__cert__attr__priv__contentst__basecertid a))
(define-fun us_split_fields_Role__projection ((a us_split_fields14)) privileget (rec__cert__attr__priv__contentst__role a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields14)) us_rep2 (rec__cert__attr__priv__contentst__clearance a))
...
(define-fun us_rep___14__projection ((a us_rep7)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq9 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (and (and (= (bool_eq3 (rec__cert__attr__priv__contentst__id (us_split_fields15 a)) (rec__cert__attr__priv__contentst__id (us_split_fields15 b))) true) (= (bool_eq5 (rec__cert__attr__priv__contentst__notbefore (us_split_fields15 a)) (rec__cert__attr__priv__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq5 (rec__cert__attr__priv__contentst__notafter (us_split_fields15 a)) (rec__cert__attr__priv__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep10 (rec__cert__attr__priv__contentst__mechanism (us_split_fields15 a))) (to_rep10 (rec__cert__attr__priv__contentst__mechanism (us_split_fields15 b))))) (= (bool_eq3 (rec__cert__attr__priv__contentst__basecertid (us_split_fields15 a)) (rec__cert__attr__priv__contentst__basecertid (us_split_fields15 b))) true)) (= (to_rep13 (rec__cert__attr__priv__contentst__role (us_split_fields15 a))) (to_rep13 (rec__cert__attr__priv__contentst__role (us_split_fields15 b))))) (= (bool_eq4 (rec__cert__attr__priv__contentst__clearance (us_split_fields15 a)) (rec__cert__attr__priv__contentst__clearance (us_split_fields15 b))) true)) true false))
...
(declare-datatypes () ((contentst__ref2 (mk_contentst__ref2 (contentst__content2 us_rep7)))))
(define-fun contentst__ref___4__projection ((a contentst__ref2)) us_rep7 (contentst__content2 a))
(define-fun dynamic_invariant1 ((temp___expr_341 Int) (temp___is_init_338 Bool) (temp___skip_constant_339 Bool) (temp___do_toplevel_340 Bool)) Bool (=> (or (= temp___is_init_338 true) (<= 0 3)) (in_range15 temp___expr_341)))
(declare-fun therole (us_rep7) Int)
(declare-fun therole__function_guard (Int us_rep7) Bool)
(assert (forall ((contents us_rep7)) (! (dynamic_invariant1 (therole contents) true false true) :pattern ((therole contents)))))
(declare-fun theclearance (us_rep7) us_rep2)
(declare-fun theclearance__function_guard (us_rep2 us_rep7) Bool)
(assert true)
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__cert__attr__auth__contentst__id us_rep1) (rec__cert__attr__auth__contentst__notbefore us_rep3) (rec__cert__attr__auth__contentst__notafter us_rep3) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep1) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep2)))))
(define-fun us_split_fields_ID__7__projection ((a us_split_fields16)) us_rep1 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__5__projection ((a us_split_fields16)) us_rep3 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__5__projection ((a us_split_fields16)) us_rep3 (rec__cert__attr__auth__contentst__notafter a))
(define-fun us_split_fields_Mechanism__5__projection ((a us_split_fields16)) algorithmt (rec__cert__attr__auth__contentst__mechanism a))
(define-fun us_split_fields_BaseCertID__3__projection ((a us_split_fields16)) us_rep1 (rec__cert__attr__auth__contentst__basecertid a))
(define-fun us_split_fields_Role__2__projection ((a us_split_fields16)) privileget (rec__cert__attr__auth__contentst__role a))
(define-fun us_split_fields_Clearance__2__projection ((a us_split_fields16)) us_rep2 (rec__cert__attr__auth__contentst__clearance a))
...
(define-fun us_rep___15__projection ((a us_rep8)) us_split_fields16 (us_split_fields17 a))
(define-fun bool_eq10 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (and (and (= (bool_eq3 (rec__cert__attr__auth__contentst__id (us_split_fields17 a)) (rec__cert__attr__auth__contentst__id (us_split_fields17 b))) true) (= (bool_eq5 (rec__cert__attr__auth__contentst__notbefore (us_split_fields17 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields17 b))) true)) (= (bool_eq5 (rec__cert__attr__auth__contentst__notafter (us_split_fields17 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields17 b))) true)) (= (to_rep10 (rec__cert__attr__auth__contentst__mechanism (us_split_fields17 a))) (to_rep10 (rec__cert__attr__auth__contentst__mechanism (us_split_fields17 b))))) (= (bool_eq3 (rec__cert__attr__auth__contentst__basecertid (us_split_fields17 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields17 b))) true)) (= (to_rep13 (rec__cert__attr__auth__contentst__role (us_split_fields17 a))) (to_rep13 (rec__cert__attr__auth__contentst__role (us_split_fields17 b))))) (= (bool_eq4 (rec__cert__attr__auth__contentst__clearance (us_split_fields17 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields17 b))) true)) true false))
...
(define-fun contentst__ref___5__projection ((a contentst__ref3)) us_rep8 (contentst__content3 a))
...
(assert true)
(define-fun dynamic_invariant2 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 0 4294967295)) (in_range6 temp___expr_321)))
(declare-fun serialnumber (us_private) Int)
(declare-fun serialnumber__function_guard (Int us_private) Bool)
(assert (forall ((certificatestore__state us_private)) (! (=> (not (= (serialnumberhasoverflowed certificatestore__state) true)) (dynamic_invariant2 (serialnumber certificatestore__state) true false true)) :pattern ((serialnumber certificatestore__state)))))
...
(declare-const dummy26 certificatestatus)
...
(declare-datatypes () ((us_split_fields18 (mk___split_fields9 (rec__usertoken__valididcertt__valid Bool) (rec__usertoken__valididcertt__idstatus certificatestatus) (rec__usertoken__valididcertt__contents us_rep6)))))
...
(define-fun us_split_fields_Contents__projection ((a us_split_fields18)) us_rep6 (rec__usertoken__valididcertt__contents a))
...
(declare-datatypes () ((us_split_fields20 (mk___split_fields10 (rec__usertoken__validauthcertt__valid Bool) (rec__usertoken__validauthcertt__contents us_rep8)))))
(define-fun us_split_fields_Valid__3__projection ((a us_split_fields20)) Bool (rec__usertoken__validauthcertt__valid a))
(define-fun us_split_fields_Contents__3__projection ((a us_split_fields20)) us_rep8 (rec__usertoken__validauthcertt__contents a))
(declare-datatypes () ((us_split_fields__ref10 (mk___split_fields__ref10 (us_split_fields__content10 us_split_fields20)))))
(define-fun us_split_fields__ref___26__projection ((a us_split_fields__ref10)) us_split_fields20 (us_split_fields__content10 a))
(declare-datatypes () ((us_rep10 (mk___rep10 (us_split_fields21 us_split_fields20)))))
(define-fun us_rep___27__projection ((a us_rep10)) us_split_fields20 (us_split_fields21 a))
(define-fun bool_eq12 ((a us_rep10) (b us_rep10)) Bool (ite (and (= (rec__usertoken__validauthcertt__valid (us_split_fields21 a)) (rec__usertoken__validauthcertt__valid (us_split_fields21 b))) (= (bool_eq10 (rec__usertoken__validauthcertt__contents (us_split_fields21 a)) (rec__usertoken__validauthcertt__contents (us_split_fields21 b))) true)) true false))
...
(declare-datatypes () ((us_split_fields22 (mk___split_fields11 (rec__usertoken__validprivcertt__valid Bool) (rec__usertoken__validprivcertt__contents us_rep7)))))
(define-fun us_split_fields_Valid__2__projection ((a us_split_fields22)) Bool (rec__usertoken__validprivcertt__valid a))
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields22)) us_rep7 (rec__usertoken__validprivcertt__contents a))
(declare-datatypes () ((us_split_fields__ref11 (mk___split_fields__ref11 (us_split_fields__content11 us_split_fields22)))))
(define-fun us_split_fields__ref___25__projection ((a us_split_fields__ref11)) us_split_fields22 (us_split_fields__content11 a))
(declare-datatypes () ((us_rep11 (mk___rep11 (us_split_fields23 us_split_fields22)))))
(define-fun us_rep___26__projection ((a us_rep11)) us_split_fields22 (us_split_fields23 a))
(define-fun bool_eq13 ((a us_rep11) (b us_rep11)) Bool (ite (and (= (rec__usertoken__validprivcertt__valid (us_split_fields23 a)) (rec__usertoken__validprivcertt__valid (us_split_fields23 b))) (= (bool_eq9 (rec__usertoken__validprivcertt__contents (us_split_fields23 a)) (rec__usertoken__validprivcertt__contents (us_split_fields23 b))) true)) true false))
...
(declare-datatypes () ((validprivcertt__ref (mk_validprivcertt__ref (validprivcertt__content us_rep11)))))
(define-fun validprivcertt__ref___projection ((a validprivcertt__ref)) us_rep11 (validprivcertt__content a))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1943 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 4)) 83)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 8)) 97)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 9)) 108)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 11)) 78)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 12)) 117)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 13)) 109)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 14)) 98)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 17)) 115)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 20)) 118)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 21)) 97)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 24)) 98)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 25)) 108)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 28)) 102)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 29)) 111)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 30)) 114)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 32)) 105)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 33)) 115)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 34)) 115)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 35)) 117)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 36)) 101)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 38)) 111)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 39)) 102)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 41)) 65)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 42)) 117)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 43)) 116)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 44)) 104)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 45)) 111)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 46)) 114)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 47)) 105)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 48)) 115)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 49)) 97)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 50)) 116)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 51)) 105)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 52)) 111)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 53)) 110)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 54)) 32)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 55)) 67)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 56)) 101)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 57)) 114)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 58)) 116)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 59)) 105)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 60)) 102)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 61)) 105)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 62)) 99)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 63)) 97)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 64)) 116)) (= (to_rep (select (temp___String_Literal_1943 us_void_param) 65)) 101)) :pattern ((temp___String_Literal_1943 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1638 Int) (temp___is_init_1635 Bool) (temp___skip_constant_1636 Bool) (temp___do_toplevel_1637 Bool)) Bool (=> (or (= temp___is_init_1635 true) (<= 0 3)) (in_range16 temp___expr_1638)))
(assert true)
(assert (= nouser (temp___String_Literal_141 Tuple0)))
(define-fun dynamic_invariant8 ((temp___expr_426 Int) (temp___is_init_423 Bool) (temp___skip_constant_424 Bool) (temp___do_toplevel_425 Bool)) Bool (=> (or (= temp___is_init_423 true) (<= 1901 2099)) (in_range8 temp___expr_426)))
(define-fun dynamic_invariant9 ((temp___expr_432 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 12)) (in_range9 temp___expr_432)))
(define-fun dynamic_invariant10 ((temp___expr_438 Int) (temp___is_init_435 Bool) (temp___skip_constant_436 Bool) (temp___do_toplevel_437 Bool)) Bool (=> (or (= temp___is_init_435 true) (<= 1 31)) (in_range10 temp___expr_438)))
(define-fun dynamic_invariant11 ((temp___expr_462 Int) (temp___is_init_459 Bool) (temp___skip_constant_460 Bool) (temp___do_toplevel_461 Bool)) Bool (=> (or (= temp___is_init_459 true) (<= 0 86399999)) (in_range11 temp___expr_462)))
(assert (= zerotime (mk___rep3 (mk___split_fields3 (of_rep6 1901) (of_rep7 1) (of_rep8 1) (of_rep9 0)))))
(define-fun dynamic_invariant12 ((temp___expr_179 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 40)) (in_range4 temp___expr_179)))
(define-fun dynamic_invariant13 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 4294967295)) (in_range5 temp___expr_200)))
(define-fun dynamic_invariant14 ((temp___expr_218 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 0 10)) (in_range12 temp___expr_218)))
(define-fun dynamic_invariant15 ((temp___expr_230 Int) (temp___is_init_227 Bool) (temp___skip_constant_228 Bool) (temp___do_toplevel_229 Bool)) Bool (=> (or (= temp___is_init_227 true) (<= 0 4294967295)) (in_range13 temp___expr_230)))
(define-fun dynamic_invariant16 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 0 128)) (in_range14 temp___expr_236)))
(declare-const privcert__split_fields us_split_fields__ref11)
...
(declare-const clearance__split_fields classt)
...
(declare-const temp___1955 yearst)
(declare-const temp___19551 monthst)
(declare-const temp___19552 dayst)
(declare-const temp___19553 millisecst)
(declare-const o8 classt)
(declare-const o9 classt)
(declare-const o10 classt)
(declare-const o11 Int)
(declare-const o12 classt)
(declare-const o13 us_split_fields4)
(declare-const temp___1935 us_rep2)
(declare-const o14 Int)
(declare-const o15 Int)
(declare-const o16 classt)
(declare-const o17 us_split_fields4)
(declare-const temp___1937 us_rep2)
(declare-const temp___1938 us_rep3)
(declare-const o18 us_rep3)
(declare-const o19 us_rep)
(declare-const o20 us_split_fields2)
(declare-const temp___1940 us_rep1)
(declare-const o21 Bool)
(declare-const result us_split_fields__ref2)
(declare-const clearance__split_fields1 us_split_fields4)
(declare-const result1 Bool)
(declare-const result2 us_split_fields__ref2)
(declare-const clearance__split_fields2 us_split_fields4)
(declare-const result3 Bool)
(declare-const result4 us_split_fields__ref3)
(declare-const notbefore__split_fields4 us_split_fields6)
(declare-const result5 us_split_fields__ref3)
(declare-const notafter__split_fields4 us_split_fields6)
(declare-const notbefore__split_fields5 us_split_fields6)
(declare-const notafter__split_fields5 us_split_fields6)
(declare-const result6 us_split_fields__ref1)
(declare-const id__split_fields4 us_split_fields2)
...
(assert (= o1 o6))
(assert (= o o7))
(assert (= temp___1955 o4))
(assert (= temp___19551 o5))
(assert (= temp___19552 o6))
(assert (= temp___19553 o7))
(assert (= (mk___rep3 (mk___split_fields3 temp___1955 temp___19551 temp___19552 temp___19553)) zerotime))
(assert (= (privatekeypresent state1) true))
(assert (= (mk___rep2 (mk___split_fields2 o8)) (theclearance (rec__usertoken__validprivcertt__contents (us_split_fields__content11 privcert__split_fields)))))
(assert (= o8 o9))
(assert (= o10 o9))
(assert (= o11 (to_rep5 o10)))
(assert (= (to_rep5 o12) o11))
(assert (= o13 (mk___split_fields2 o12)))
(assert (= temp___1935 (mk___rep2 o13)))
(assert (= result (mk___split_fields__ref2 (mk___split_fields2 clearance__split_fields))))
(assert (= clearance__split_fields1 (us_split_fields5 temp___1935)))
(assert (and (= o14 (theenclaveclearance state)) (in_range7 o14)))
(assert (= result1 (ite (< o14 (to_rep5 (rec__privtypes__clearancet__class clearance__split_fields1))) true false)))
(assert (=> (= result1 true) (and (= o15 (theenclaveclearance state)) (in_range7 o15))))
(assert (=> (= result1 true) (= (to_rep5 o16) o15)))
(assert (=> (= result1 true) (= o17 (mk___split_fields2 o16))))
(assert (=> (= result1 true) (= temp___1937 (mk___rep2 o17))))
(assert (=> (= result1 true) (= result2 (mk___split_fields__ref2 clearance__split_fields1))))
(assert (=> (= result1 true) (= clearance__split_fields2 (us_split_fields5 temp___1937))))
(assert (=> (not (= result1 true)) (= clearance__split_fields2 clearance__split_fields1)))
(assert (= result3 (authperiodisempty state)))
(assert (=> (= result3 true) (= temp___1938 (thecurrenttime currenttime))))
(assert (=> (= result3 true) (= result4 (mk___split_fields__ref3 (mk___split_fields3 notbefore__split_fields notbefore__split_fields1 notbefore__split_fields2 notbefore__split_fields3)))))
(assert (=> (= result3 true) (= notbefore__split_fields4 (us_split_fields7 temp___1938))))
(assert (=> (= result3 true) (= result5 (mk___split_fields__ref3 (mk___split_fields3 notafter__split_fields notafter__split_fields1 notafter__split_fields2 notafter__split_fields3)))))
(assert (=> (= result3 true) (= notafter__split_fields4 (us_split_fields7 zerotime))))
(assert (=> (not (= result3 true)) (= o18 (thecurrenttime currenttime))))
...
(assert (= o19 (thistis state1)))
(assert (= o20 (mk___split_fields1 o19 id__split_fields3)))
(assert (= temp___1940 (mk___rep1 o20)))
(assert (= result6 (mk___split_fields__ref1 (mk___split_fields1 (mk___rep (mk___split_fields id__split_fields id__split_fields1 id__split_fields2)) id__split_fields3))))
(assert (= id__split_fields4 (us_split_fields3 temp___1940)))
(assert (= o21 (serialnumberhasoverflowed state2)))
(assert (= result7 (ite (not (= o21 true)) true false)))
(assert (= result7 true))
(assert (not (not (= (serialnumberhasoverflowed state2) true))))
(check-sat)
(exit)
