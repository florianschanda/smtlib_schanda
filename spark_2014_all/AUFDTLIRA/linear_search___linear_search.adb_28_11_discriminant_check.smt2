...
(assert (=> (<= pos1 10) (and (and (and (= res__split_discrs temp___181) (and (= res__split_fields temp___1811) (= res__attr__constrained temp___1812))) (and (= temp___180 pos1) (and (= 0 temp___182) (and (and (and (and (and (and (and (<= 1 pos1) (<= pos1 10)) (= o pos1)) (= o1 (select a o))) (= o2 (to_rep1 o1))) (= result1 (ite (= o2 val__) true false))) (and (not (= result1 true)) (and (and (= linear_search__search__result4 (mk___rep (mk___split_discrs linear_search__search__result) (mk___split_fields linear_search__search__result1) linear_search__search__result2)) (and (= res__split_discrs2 (mk___split_discrs res__split_discrs)) (= res__split_fields2 (mk___split_fields res__split_fields)))) (and (= linear_search__search__result4 linear_search__search__result3) (and (= res__split_discrs2 res__split_discrs1) (= res__split_fields2 res__split_fields1)))))) (and (and (and (<= 1 pos2) (<= pos2 10)) (not (= (value_found_in_range a val__ 1 pos2) true))) (and (=> (<= (- 128) 127) (in_range1 pos2)) (and (and (= result5 (mk_int__ref temp___1822)) (= temp___1823 pos2)) (and (and (and (= o7 (+ pos2 1)) (in_range1 (+ pos2 1))) (and (= result6 (mk_int__ref pos2)) (= pos3 o7))) (not (<= pos3 10)))))))))) (and (and (= linear_search__search__result11 (mk_search_result__ref linear_search__search__result5)) (and (= res__split_discrs9 (mk___split_discrs__ref res__split_discrs3)) (and (= res__split_fields9 (mk___split_fields__ref res__split_fields3)) (= pos8 (mk_int__ref pos3))))) (and (= linear_search__search__result12 linear_search__search__result5) (and (= res__split_discrs10 res__split_discrs3) (and (= res__split_fields10 res__split_fields3) (= pos9 pos3))))))))
(assert (=> (<= pos1 10) (= linear_search__search__result13 linear_search__search__result11)))
(assert (=> (<= pos1 10) (= res__split_discrs11 res__split_discrs9)))
(assert (=> (<= pos1 10) (= res__split_fields11 res__split_fields9)))
(assert (=> (<= pos1 10) (= pos10 pos8)))
(assert (=> (<= pos1 10) (= linear_search__search__result14 linear_search__search__result12)))
(assert (=> (<= pos1 10) (= res__split_discrs12 res__split_discrs10)))
(assert (=> (<= pos1 10) (= res__split_fields12 res__split_fields10)))
(assert (=> (<= pos1 10) (= pos11 pos9)))
(assert (=> (not (<= pos1 10)) (= linear_search__search__result13 (mk_search_result__ref (mk___rep (mk___split_discrs linear_search__search__result) (mk___split_fields linear_search__search__result1) linear_search__search__result2)))))
(assert (=> (not (<= pos1 10)) (= res__split_discrs11 (mk___split_discrs__ref (mk___split_discrs res__split_discrs)))))
(assert (=> (not (<= pos1 10)) (= res__split_fields11 (mk___split_fields__ref (mk___split_fields res__split_fields)))))
(assert (=> (not (<= pos1 10)) (= pos10 (mk_int__ref pos1))))
(assert (=> (not (<= pos1 10)) (= linear_search__search__result14 linear_search__search__result3)))
(assert (=> (not (<= pos1 10)) (= res__split_discrs12 res__split_discrs1)))
(assert (=> (not (<= pos1 10)) (= res__split_fields12 res__split_fields1)))
(assert (=> (not (<= pos1 10)) (= pos11 pos1)))
(assert (= res__attr__constrained true))
(assert (not (= (of_int 0) (rec__linear_search__search_result__found (us_split_discrs__content res__split_discrs11)))))
(check-sat)
(exit)
