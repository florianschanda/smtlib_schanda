...
(assert (=> (<= pos1 10) (and (= res__split_discrs temp___181) (and (= res__split_fields temp___1811) (= res__attr__constrained temp___1812)))))
...
(assert (not (= (of_int 0) (rec__linear_search__search_result__found (us_split_discrs__content res__split_discrs6)))))
(check-sat)
(exit)
