...
(define-fun dynamic_invariant ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 1 100)) (in_range2 temp___expr_167)))
...
(define-fun dynamic_invariant1 ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 0 100)) (in_range1 temp___expr_160)))
...
(assert (forall ((sel1 (Array Int Bool))) (forall ((from1 Int)) (! (=> (dynamic_invariant from1 true true true true) (= (partial_count_selected_locations sel1 from1) (+ (ite (= (select sel1 from1) true) 1 0) (ite (< from1 100) (partial_count_selected_locations sel1 (+ from1 1)) 0)))) :pattern ((partial_count_selected_locations sel1 from1))))))
