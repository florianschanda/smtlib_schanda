...
(assert (<= (- 2147483648) m2))
(assert (<= m2 2147483647))
(assert (forall ((n6 Int)) (=> (and (<= 1 n6) (<= n6 i)) (<= (to_rep (select a n6)) m2))))
(assert (exists ((n6 Int)) (and (and (<= 1 n6) (<= n6 i)) (= (to_rep (select a n6)) m2))))
(assert (not (= m2 max2)))
(check-sat)
(exit)
