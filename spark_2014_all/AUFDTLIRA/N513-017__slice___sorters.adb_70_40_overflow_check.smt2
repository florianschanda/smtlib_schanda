...
(assert (and (= o3 (index_of_minimum (mk___t o1 o2))) (and (in_range2 o3) (and (and (<= (to_rep (first o2)) o3) (<= o3 (to_rep (last o2)))) (forall ((j3 Int)) (=> (and (<= (to_rep (first o2)) j3) (<= j3 (to_rep (last o2)))) (<= (to_rep (select o1 o3)) (to_rep (select o1 j3)))))))))
(assert (= (mk_int__ref result1) (mk_int__ref smallest)))
(assert (= smallest2 o3))
(assert (=> (not (= smallest2 current1)) (and (= o4 current1) (in_range2 current1))))
(assert (=> (not (= smallest2 current1)) (and (= (to_rep (select values2 o4)) (to_rep (select values smallest2))) (and (= (to_rep (select values2 smallest2)) (to_rep (select values o4))) (forall ((j3 Int)) (=> (and (<= (to_rep values__first) j3) (<= j3 (to_rep values__last))) (=> (and (not (= j3 o4)) (not (= j3 smallest2))) (= (to_rep (select values2 j3)) (to_rep (select values j3))))))))))
(assert (=> (= smallest2 current1) (= values2 values)))
(assert (=> (= smallest2 current1) (= values2 values1)))
(assert (and (and (and (<= (to_rep values__first) current2) (< current2 (to_rep values__last))) (forall ((j3 Int)) (=> (and (<= (to_rep values__first) j3) (<= j3 (- current2 1))) (<= (to_rep (select values3 j3)) (to_rep (select values3 (+ j3 1))))))) (forall ((j3 Int)) (=> (and (<= current2 j3) (<= j3 (to_rep values__last))) (<= (to_rep (select values3 current2)) (to_rep (select values3 j3)))))))
(assert (and (and (=> (<= 1 2147483647) (in_range2 smallest3)) (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property1 (to_rep values__first) (- (to_rep values__last) 1) current2))) (and (<= (to_rep values__first) current2) (<= current2 (- (to_rep values__last) 1)))))
...
(assert (= result3 true))
(assert (and (= o8 (- current2 1)) (in_range1 (- current2 1))))
(assert (= o9 (ite (<= j1 o8) true false)))
(assert (= result4 (ite (<= (to_rep values__first) j1) o9 false)))
(assert (= result4 true))
