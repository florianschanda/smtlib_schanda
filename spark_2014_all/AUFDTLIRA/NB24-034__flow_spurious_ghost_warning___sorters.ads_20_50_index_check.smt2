...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= temp___225 smallest)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= temp___224 values_last)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= temp___226 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= temp___222 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (= temp___220 current1)))
...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___229)) (and (and (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property3 (to_rep values__first) (- (to_rep values__last) 1) current2)) (=> (<= 1 2147483647) (in_range2 smallest3))) (and (<= (to_rep values__first) current2) (<= current2 (- (to_rep values__last) 1))))))
...
(assert (= result3 (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t (map__content values8) (mk (to_rep values__first) (to_rep values__last))))))
(assert (= result3 true))
...
(assert (not (<= (to_rep values__first) temp___231)))
(check-sat)
(exit)
