...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= temp___198 smallest)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= temp___197 values_last)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= temp___199 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= temp___195 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (= temp___193 current1)))
...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___202)) (and (and (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property3 (to_rep values__first) (- (to_rep values__last) 1) current2)) (=> (<= 1 2147483647) (in_range2 smallest3))) (and (<= (to_rep values__first) current2) (<= current2 (- (to_rep values__last) 1))))))
...
(assert (= result6 (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t (map__content values9) (mk (to_rep values__first) (to_rep values__last))))))
(assert (= result6 true))
(assert (and (= o22 (- (to_rep values__last) 1)) (in_range1 (- (to_rep values__last) 1))))
(assert (= o23 (ite (<= j2 o22) true false)))
(assert (= result7 (ite (<= (to_rep values__first) j2) o23 false)))
(assert (= result7 true))
(assert (and (= temp___204 (+ j2 1)) (in_range1 (+ j2 1))))
(assert (not (<= (to_rep values__first) temp___204)))
(check-sat)
(exit)
