...
(declare-const ai__split_fields10 integer)
...
(assert (< (to_rep1 ai__split_fields8) (to_rep1 ai__split_fields11)))
(assert (not (< (to_rep1 ai__split_fields11) (- (to_rep1 ai__split_fields10) 10))))
(check-sat)
(exit)
