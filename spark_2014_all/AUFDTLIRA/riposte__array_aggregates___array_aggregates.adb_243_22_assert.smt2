...
(declare-fun temp___569 ((Array Int unsigned_byte)) (Array Int (Array Int unsigned_byte)))
(declare-fun temp___573 (Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___571 (Array Int unsigned_byte))) (forall ((temp___572 Int)) (= (select (temp___569 temp___571) temp___572) temp___571))))
(assert (forall ((temp___575 Int) (temp___576 Int)) (let ((temp___574 (temp___573 temp___575 temp___576))) (=> (and (dynamic_invariant temp___575 true true true true) (dynamic_invariant temp___576 true true true true)) (forall ((temp___577 Int)) (ite (= temp___577 5) (= (to_rep (select temp___574 temp___577)) temp___575) (= (to_rep (select temp___574 temp___577)) temp___576)))))))
...
(assert (= result x))
(assert (= x1 (temp___569 (temp___573 10 12))))
