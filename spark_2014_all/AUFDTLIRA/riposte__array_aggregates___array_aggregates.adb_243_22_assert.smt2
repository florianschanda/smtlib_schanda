...
(declare-fun temp_____aggregate_def_569 ((Array Int unsigned_byte)) (Array Int (Array Int unsigned_byte)))
(declare-fun temp_____aggregate_def_573 (Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___571 (Array Int unsigned_byte))) (forall ((temp___572 Int)) (= (select (temp_____aggregate_def_569 temp___571) temp___572) temp___571))))
...
(assert (forall ((temp___575 Int) (temp___576 Int)) (let ((temp___574 (temp_____aggregate_def_573 temp___575 temp___576))) (=> (and (dynamic_invariant temp___575 true true true true) (dynamic_invariant temp___576 true true true true)) (forall ((temp___577 Int)) (ite (= temp___577 5) (= (select temp___574 temp___577) rliteral) (= (select temp___574 temp___577) rliteral1)))))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_569 (temp_____aggregate_def_573 10 12))))
