...
(assert (not (= (ite (<= (to_rep1 (first temp___2501)) (to_rep1 (last temp___2501))) (+ (- (to_rep1 (last temp___2501)) (to_rep1 (first temp___2501))) 1) 0) (ite (<= (to_rep1 change__first) (to_rep1 change__last)) (+ (- (to_rep1 change__last) (to_rep1 change__first)) 1) 0))))
(check-sat)
(exit)
