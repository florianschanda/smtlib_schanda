...
(assert (<= (to_rep1 n__first) i1))
(assert (<= i1 (to_rep1 n__last)))
(assert (and (<= (to_rep1 int_array__first) i1) (<= i1 (to_rep1 int_array__last))))
(assert (= o60 i1))
(assert (= o61 (select int_array1 o60)))
(assert (= o62 (to_rep1 o61)))
(assert (and (<= (to_rep1 n__first) i1) (<= i1 (to_rep1 n__last))))
(assert (= o58 i1))
(assert (= o59 (select (map__content1 n7) o58)))
(assert (= o63 (to_rep1 o59)))
(assert (= o64 (ite (<= o63 o62) true false)))
(assert (not (<= (to_rep1 n__first) i1)))
(check-sat)
(exit)
