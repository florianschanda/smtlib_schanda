...
(assert (<= 1 i1))
(assert (<= i1 10))
(assert (and (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 (- i2 1))) (= (= (select x2 k2) true) (not (= (select x_old k2) true))))) (forall ((k2 Int)) (=> (and (<= i2 k2) (<= k2 10)) (= (= (select x2 k2) true) (= (select x_old k2) true))))))
(assert (and (and (forall ((temp___164 Int)) (=> (and (<= 1 temp___164) (<= temp___164 10)) (=> (<= i2 temp___164) (= (select x2 temp___164) (select x temp___164))))) (=> (<= 1 10) (in_range2 i2))) (and (<= 1 i2) (<= i2 10))))
(assert (= (= result1 true) (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 (- i2 1))) (= (= (select x2 k2) true) (not (= (select x_old k2) true)))))))
(assert (= result1 true))
(assert (<= i2 k))
(assert (<= k 10))
(assert (and (<= 1 k) (<= k 10)))
