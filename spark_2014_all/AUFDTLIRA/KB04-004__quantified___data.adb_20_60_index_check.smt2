...
(assert (and (and (forall ((temp___164 Int)) (=> (and (<= 1 temp___164) (<= temp___164 10)) (=> (<= i2 temp___164) (= (select x1 temp___164) (select x temp___164))))) (=> (<= 1 10) (in_range2 i2))) (and (<= 1 i2) (<= i2 10))))
(assert (= (= result1 true) (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- i2 1))) (= (= (select x1 k1) true) (not (= (select x_old k1) true)))))))
(assert (= result1 true))
(assert (<= i2 k))
(assert (<= k 10))
(assert (and (<= 1 k) (<= k 10)))
