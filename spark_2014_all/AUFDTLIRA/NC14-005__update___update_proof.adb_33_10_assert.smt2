...
(assert (= (bool_eq (select b2 2) 1 2 (temp_____aggregate_def_241 0) 1 2) true))
(assert (= (bool_eq2 b2 1 2 (temp_____aggregate_def_249 o_b 2 (temp_____aggregate_def_255 0)) 1 2) true))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i 2))
(assert (not (= (bool_eq (select b2 i) 1 2 (ite (= i 2) (temp_____aggregate_def_261 0) (select o_b i)) (to_rep (first (mk 1 2))) (to_rep (last (mk 1 2)))) true)))
(check-sat)
(exit)
