...
(assert (and (= o49 y) (in_range4 y)))
(assert (and (= o50 (remove (mk___t values2 (mk 1 100)) o49)) (and (dynamic_invariant3 o50 true false true true) (and (= (invariant__ o50) true) (and (= (to_rep1 (last (rt o50))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o49 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o50) k))))) (and (forall ((k Int)) (=> (and (<= (+ o49 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o50) (- k 1)))))) (forall ((k Int)) (=> (and (<= o49 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o50) k))))))))))))
(assert (and (= o47 x) (in_range4 x)))
(assert (and (= o48 (remove (mk___t init (mk 1 100)) o47)) (and (dynamic_invariant3 o48 true false true true) (and (= (invariant__ o48) true) (and (= (to_rep1 (last (rt o48))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o47 1))) (= (to_rep (select init k)) (to_rep (select (elts o48) k))))) (and (forall ((k Int)) (=> (and (<= (+ o47 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o48) (- k 1)))))) (forall ((k Int)) (=> (and (<= o47 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o48) k))))))))))))
(assert (not (= (invariant__ o48) true)))
(check-sat)
(exit)
