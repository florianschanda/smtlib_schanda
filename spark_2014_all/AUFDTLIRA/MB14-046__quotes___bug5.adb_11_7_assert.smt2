...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_143 us_void_param) 1)) 97) (= (to_rep (select (temp___String_Literal_143 us_void_param) 2)) 98)) (= (to_rep (select (temp___String_Literal_143 us_void_param) 3)) 99)) (= (to_rep (select (temp___String_Literal_143 us_void_param) 4)) 100)) :pattern ((temp___String_Literal_143 us_void_param)))))
...
(assert (not (= (p (mk___t (temp___String_Literal_143 Tuple0) (mk 1 4))) true)))
(check-sat)
(exit)
