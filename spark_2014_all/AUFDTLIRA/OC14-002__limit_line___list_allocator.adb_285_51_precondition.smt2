...
(assert (forall ((s us_rep1)) (forall ((r Int)) (! (=> (dynamic_invariant r true true true true) (let ((result (find s r))) (and (ite (= (mem s r) true) (and (and (<= 1 result) (<= result (length s))) (= (get s result) r)) (= result 0)) (dynamic_invariant1 result true false true true)))) :pattern ((find s r))))))
...
(declare-const temp___457 us_rep2)
...
(assert (= temp___457 (mk___rep1 o57)))
(assert (= result9 (mk___split_fields__ref1 model____split_fields2)))
(assert (= model____split_fields3 (us_split_fields3 temp___457)))
...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)))))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__allocated model____split_fields3)))) (and (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 (get (rec__list_allocator__m__t__allocated model____split_fields3) j))))) (ite (< j (length (rec__list_allocator__m__t__allocated model____split_fields3))) (get (rec__list_allocator__m__t__allocated model____split_fields3) (+ j 1)) 0))))))
...
(assert (=> (not (= first_available1 0)) (and (= o60 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o60))))
(assert (=> (not (= first_available1 0)) (= result11 (ite (< 0 o60) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result11 true) (and (= o59 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o59)))))
(assert (=> (not (= first_available1 0)) (=> (= result11 true) (= result10 (ite (= o59 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result11 true)) (= result10 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o61 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o61))))
(assert (=> (not (not (= first_available1 0))) (= result10 (ite (= o61 0) true false))))
...
(assert (= result12 (ite (< 0 o58) true false)))
