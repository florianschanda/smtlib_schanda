...
(assert (=> (not (= first_available1 0)) (and (= o59 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o59))))
(assert (=> (not (= first_available1 0)) (= result11 (ite (< 0 o59) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result11 true) (and (= o58 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o58)))))
(assert (=> (not (= first_available1 0)) (=> (= result11 true) (= result10 (ite (= o58 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result11 true)) (= result10 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o60 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o60))))
(assert (=> (not (not (= first_available1 0))) (= result10 (ite (= o60 0) true false))))
(assert (= result10 true))
(assert (not (= first_allocated2 0)))
(assert (and (= o57 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o57)))
(assert (= result12 (ite (< 0 o57) true false)))
(assert (= result12 true))
(assert (not (<= 1 (length (rec__list_allocator__m__t__allocated model____split_fields3)))))
(check-sat)
(exit)
