...
(assert (forall ((temp___341 Int)) (forall ((temp___342 Int) (temp___343 Int)) (= (get (pack__matrix__aggregate_def temp___341) temp___342 temp___343) (of_rep1 temp___341)))))
(declare-fun temp___String_Literal_349 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_349 us_void_param) 1)) 113) (= (to_rep (select (temp___String_Literal_349 us_void_param) 2)) 119)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 4)) 114)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 6)) 121)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 7)) 117)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 9)) 111)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 10)) 112)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 11)) 97)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 12)) 115)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 13)) 100)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 14)) 102)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 15)) 103)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 16)) 104)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 17)) 106)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 18)) 107)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 19)) 108)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 20)) 122)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 21)) 120)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 23)) 118)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 24)) 98)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 25)) 110)) (= (to_rep (select (temp___String_Literal_349 us_void_param) 26)) 109)) :pattern ((temp___String_Literal_349 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_174 us_t1) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool)) Bool (=> (not (= temp___skip_constant_172 true)) (dynamic_property3 0 2147483647 (first4 temp___expr_174) (last4 temp___expr_174) 0 2147483647 (first_2 temp___expr_174) (last_2 temp___expr_174))))
