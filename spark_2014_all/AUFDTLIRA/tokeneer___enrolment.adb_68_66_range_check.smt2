...
(assert (not (= (length (mk___t temp___1605 temp___16051)) 0)))
(assert (=> (<= 1 3) (= o6 (+ (- 3 1) 1))))
(assert (=> (not (<= 1 3)) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___16051)) (to_rep1 (last temp___16051))) (= o7 (+ (- (to_rep1 (last temp___16051)) (to_rep1 (first temp___16051))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___16051)) (to_rep1 (last temp___16051)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___16051)) o8)))
(assert (= o10 (- o9 1)))
