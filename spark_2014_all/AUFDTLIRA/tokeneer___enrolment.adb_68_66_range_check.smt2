...
(assert (not (= (length (mk___t temp___1549 temp___15491)) 0)))
(assert (=> (<= 1 3) (= o6 (+ (- 3 1) 1))))
(assert (=> (not (<= 1 3)) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___15491)) (to_rep1 (last temp___15491))) (= o7 (+ (- (to_rep1 (last temp___15491)) (to_rep1 (first temp___15491))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___15491)) (to_rep1 (last temp___15491)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___15491)) o8)))
(assert (= o10 (- o9 1)))
