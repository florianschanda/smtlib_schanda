...
(assert (forall ((temp___213 (Array Int integer))) (forall ((temp___214 Int) (temp___215 Int)) (let ((temp___212 (temp___211 temp___213 temp___214 temp___215))) (forall ((temp___216 Int)) (ite (= temp___216 temp___214) (= (select temp___212 temp___216) (of_rep temp___215)) (= (select temp___212 temp___216) (select temp___213 temp___216))))))))
(declare-fun temp___218 ((Array Int integer) Int Int Int Int) (Array Int integer))
(assert (forall ((temp___220 (Array Int integer))) (forall ((temp___221 Int) (temp___222 Int) (temp___223 Int) (temp___224 Int)) (let ((temp___219 (temp___218 temp___220 temp___221 temp___222 temp___223 temp___224))) (forall ((temp___225 Int)) (ite (= temp___225 temp___223) (= (select temp___219 temp___225) (of_rep temp___224)) (ite (= temp___225 temp___221) (= (select temp___219 temp___225) (of_rep temp___222)) (= (select temp___219 temp___225) (select temp___220 temp___225)))))))))
