...
(declare-fun temp___238 ((Array Int integer) Int Int) (Array Int integer))
(declare-fun temp___245 ((Array Int integer) Int Int Int Int) (Array Int integer))
(define-fun dynamic_invariant ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_18)))
(assert (forall ((temp___240 (Array Int integer))) (forall ((temp___241 Int) (temp___242 Int)) (let ((temp___239 (temp___238 temp___240 temp___241 temp___242))) (=> (and (dynamic_invariant temp___241 true true true true) (dynamic_invariant temp___242 true true true true)) (forall ((temp___243 Int)) (ite (= temp___243 temp___241) (= (to_rep (select temp___239 temp___243)) temp___242) (= (select temp___239 temp___243) (select temp___240 temp___243)))))))))
(assert (forall ((temp___247 (Array Int integer))) (forall ((temp___248 Int) (temp___249 Int) (temp___250 Int) (temp___251 Int)) (let ((temp___246 (temp___245 temp___247 temp___248 temp___249 temp___250 temp___251))) (=> (and (and (and (dynamic_invariant temp___248 true true true true) (dynamic_invariant temp___249 true true true true)) (dynamic_invariant temp___250 true true true true)) (dynamic_invariant temp___251 true true true true)) (forall ((temp___252 Int)) (ite (= temp___252 temp___250) (= (to_rep (select temp___246 temp___252)) temp___251) (ite (= temp___252 temp___248) (= (to_rep (select temp___246 temp___252)) temp___249) (= (select temp___246 temp___252) (select temp___247 temp___252))))))))))
