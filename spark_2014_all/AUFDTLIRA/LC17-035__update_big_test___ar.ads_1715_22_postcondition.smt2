...
(declare-fun temp___3804 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
(declare-fun temp___3810 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (= a4 a5))
(assert (= a6 a4))
(assert (not (= (bool_eq2 a5 1 16 (temp___3804 b i (mk___rep (mk___split_fields (temp___3810 d j e) (rec__ar__rofa1__t1 (us_split_fields1 c))))) 1 16) true)))
(check-sat)
(exit)
