...
(assert (forall ((temp___3747 (Array Int us_rep))) (forall ((temp___3748 Int)) (forall ((temp___3749 us_rep)) (let ((temp___3746 (temp___3745 temp___3747 temp___3748 temp___3749))) (forall ((temp___3750 Int)) (ite (= temp___3750 temp___3748) (= (select temp___3746 temp___3750) temp___3749) (= (select temp___3746 temp___3750) (select temp___3747 temp___3750)))))))))
(declare-fun temp___3751 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3753 (Array Int et1))) (forall ((temp___3754 Int) (temp___3755 Int)) (let ((temp___3752 (temp___3751 temp___3753 temp___3754 temp___3755))) (forall ((temp___3756 Int)) (ite (= temp___3756 temp___3754) (= (select temp___3752 temp___3756) (of_rep temp___3755)) (= (select temp___3752 temp___3756) (select temp___3753 temp___3756))))))))
...
(assert (= a4 a5))
(assert (= a6 a4))
(assert (not (= (bool_eq2 a5 1 16 (temp___3745 b i (mk___rep (mk___split_fields (temp___3751 d j e) (rec__ar__rofa1__t1 (us_split_fields1 c))))) 1 16) true)))
(check-sat)
(exit)
