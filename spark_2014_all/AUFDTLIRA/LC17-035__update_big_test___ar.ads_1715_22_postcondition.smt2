...
(declare-fun temp_____aggregate_def_3804 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
(declare-fun temp_____aggregate_def_3810 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (forall ((temp___3806 (Array Int us_rep))) (forall ((temp___3807 Int)) (forall ((temp___3808 us_rep)) (let ((temp___3805 (temp_____aggregate_def_3804 temp___3806 temp___3807 temp___3808))) (=> (dynamic_invariant1 temp___3807 true true true true) (forall ((temp___3809 Int)) (ite (= temp___3809 temp___3807) (= (select temp___3805 temp___3809) temp___3808) (= (select temp___3805 temp___3809) (select temp___3806 temp___3809))))))))))
(assert (forall ((temp___3812 (Array Int et1))) (forall ((temp___3813 Int) (temp___3814 Int)) (let ((temp___3811 (temp_____aggregate_def_3810 temp___3812 temp___3813 temp___3814))) (=> (and (dynamic_invariant temp___3813 true true true true) (dynamic_invariant2 temp___3814 true true true true)) (forall ((temp___3815 Int)) (ite (= temp___3815 temp___3813) (= (to_rep (select temp___3811 temp___3815)) temp___3814) (= (select temp___3811 temp___3815) (select temp___3812 temp___3815)))))))))
...
(assert (= a4 a5))
(assert (= a6 a4))
(assert (not (= (bool_eq2 a5 1 16 (temp_____aggregate_def_3804 b i (mk___rep (mk___split_fields (temp_____aggregate_def_3810 d j e) (rec__ar__rofa1__t1 (us_split_fields1 c))))) 1 16) true)))
(check-sat)
(exit)
