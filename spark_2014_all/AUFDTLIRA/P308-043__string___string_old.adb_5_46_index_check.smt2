...
(assert (and (<= (to_rep1 (first2 (mk1 (to_rep1 s__first) (to_rep1 s__last)))) idx) (<= idx (to_rep1 (last2 (mk1 (to_rep1 s__first) (to_rep1 s__last)))))))
(assert (= o idx))
(assert (= o1 (select s o)))
(assert (= o2 (to_rep o1)))
(assert (not (<= (to_rep1 s__first) idx)))
(check-sat)
(exit)
