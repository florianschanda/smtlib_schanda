...
(assert (or (and (and (and (= perm__extended_perm__result6 (mk_int__ref perm__extended_perm__result2)) (and (= ib25 (mk_int__ref ib)) (and (= ia14 (mk_int__ref ia)) (= ih36 (mk_int__ref ih))))) (and (= perm__extended_perm__result7 perm__extended_perm__result2) (and (= ib26 ib5) (and (= ia15 ia2) (= ih37 ih1))))) (and (= (length a) 0) (and (= result2 (mk_int__ref perm__extended_perm__result)) (= perm__extended_perm__result2 1)))) (and (and (not (= (length a) 0)) (and (= perm__extended_perm__result2 perm__extended_perm__result) (= perm__extended_perm__result2 perm__extended_perm__result1))) (and (and (and (= perm__extended_perm__result6 perm__extended_perm__result4) (and (= ib25 ib23) (and (= ia14 ia12) (= ih36 ih34)))) (and (= perm__extended_perm__result7 perm__extended_perm__result5) (and (= ib26 ib24) (and (= ia15 ia13) (= ih37 ih35))))) (and (and (and (= perm__extended_perm__result4 (mk_int__ref perm__extended_perm__result3)) (and (= ib23 ib21) (and (= ia12 ia10) (= ih34 ih32)))) (and (= perm__extended_perm__result5 perm__extended_perm__result3) (and (= ib24 ib22) (and (= ia13 ia11) (= ih35 ih33))))) (and (and (and (= (mk___rep (mk___split_fields perm__extended_perm__B_6__w__assume perm__extended_perm__B_6__w__assume1)) (get_witnesses a b)) (and (and (<= (to_rep2 (first (rt a))) (to_rep1 perm__extended_perm__B_6__w__assume)) (<= (to_rep1 perm__extended_perm__B_6__w__assume) (to_rep2 (last (rt a))))) (and (and (<= (to_rep2 (first (rt b))) (to_rep1 perm__extended_perm__B_6__w__assume1)) (<= (to_rep1 perm__extended_perm__B_6__w__assume1) (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) (to_rep1 perm__extended_perm__B_6__w__assume))) (to_rep (select (elts b) (to_rep1 perm__extended_perm__B_6__w__assume1)))) (= (is_perm (remove a (to_rep1 perm__extended_perm__B_6__w__assume)) (remove b (to_rep1 perm__extended_perm__B_6__w__assume1))) true))))) (= (mk___rep (mk___split_fields perm__extended_perm__B_6__w__assume perm__extended_perm__B_6__w__assume1)) w)) (and (and (and (= (mk___t perm__extended_perm__B_6__aa__assume perm__extended_perm__B_6__aa__assume1) (remove a (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant2 (mk___t perm__extended_perm__B_6__aa__assume perm__extended_perm__B_6__aa__assume1) true false true) (and (= (invariant__ (mk___t perm__extended_perm__B_6__aa__assume perm__extended_perm__B_6__aa__assume1)) true) (and (= (to_rep2 (last perm__extended_perm__B_6__aa__assume1)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts a) k1)) (to_rep (select perm__extended_perm__B_6__aa__assume k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select perm__extended_perm__B_6__aa__assume (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select perm__extended_perm__B_6__aa__assume k1))))))))))) (= (mk___t perm__extended_perm__B_6__aa__assume perm__extended_perm__B_6__aa__assume1) aa)) (and (dynamic_invariant2 aa true false true) (and (and (and (= (mk___t perm__extended_perm__B_6__bb__assume perm__extended_perm__B_6__bb__assume1) (remove b (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (dynamic_invariant2 (mk___t perm__extended_perm__B_6__bb__assume perm__extended_perm__B_6__bb__assume1) true false true) (and (= (invariant__ (mk___t perm__extended_perm__B_6__bb__assume perm__extended_perm__B_6__bb__assume1)) true) (and (= (to_rep2 (last perm__extended_perm__B_6__bb__assume1)) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) (= (to_rep (select (elts b) k1)) (to_rep (select perm__extended_perm__B_6__bb__assume k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select perm__extended_perm__B_6__bb__assume (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select perm__extended_perm__B_6__bb__assume k1))))))))))) (= (mk___t perm__extended_perm__B_6__bb__assume perm__extended_perm__B_6__bb__assume1) bb)) (and (dynamic_invariant2 bb true false true) (and (and (and (= o (extended_perm aa bb)) (and (in_range3 o) (=> (= (of_int o) true) (forall ((ia18 Int)) (=> (and (<= (to_rep2 (first (rt aa))) ia18) (<= ia18 (to_rep2 (last (rt aa))))) (exists ((ib29 Int)) (and (and (<= (to_rep2 (first (rt bb))) ib29) (<= ib29 (to_rep2 (last (rt bb))))) (and (= (to_rep (select (elts aa) ia18)) (to_rep (select (elts bb) ib29))) (= (is_perm (remove aa ia18) (remove bb ib29)) true))))))))) (and (= result3 (mk_int__ref ih)) (= ih2 o))) (and (in_range3 ih2) (and (= (of_int ih2) true) (and (and (and (= result4 (mk_int__ref ia)) (= ia3 (to_rep2 (first (rt a))))) (ite (and (<= (to_rep2 (first (rt a))) ia3) (<= ia3 (to_rep2 (last (rt a))))) (and (and (and (= temp___595 ib) (and (= temp___594 ia3) (and (= temp___593 ih2) (and (exists ((ib29 Int)) (and (and (<= (to_rep2 (first (rt b))) ib29) (<= ib29 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia3)) (to_rep (select (elts b) ib29))) (= (is_perm (remove a ia3) (remove b ib29)) true)))) (and (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia3)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 ia4)) (exists ((ib29 Int)) (and (and (<= (to_rep2 (first (rt b))) ib29) (<= ib29 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) k1)) (to_rep (select (elts b) ib29))) (= (is_perm (remove a k1) (remove b ib29)) true)))))) (and (and (and (and (=> (<= 1 1) (in_range3 ih15)) (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia4))) (=> (<= 1 100) (in_range4 ib11))) (and (<= (to_rep2 (first (rt a))) ia4) (<= ia4 (to_rep2 (last (rt a)))))) (= ia4 (to_rep2 (last (rt a))))))))))) (and (and (= ib19 (mk_int__ref ib11)) (and (= ia8 (mk_int__ref ia4)) (= ih30 (mk_int__ref ih15)))) (and (= ib20 ib11) (and (= ia9 ia4) (= ih31 ih15))))) (and (and (= ib21 ib19) (and (= ia10 ia8) (= ih32 ih30))) (and (= ib22 ib20) (and (= ia11 ia9) (= ih33 ih31))))) (and (and (= ib21 (mk_int__ref ib)) (and (= ia10 (mk_int__ref ia3)) (= ih32 (mk_int__ref ih2)))) (and (= ib22 ib5) (and (= ia11 ia3) (= ih33 ih2)))))) (and (= result43 (mk_int__ref perm__extended_perm__result2)) (= perm__extended_perm__result3 (int__content ih32)))))))))))))))))
...
(assert (<= (to_rep2 (first (rt b))) ib4))
(assert (<= ib4 (to_rep2 (last (rt b)))))
(assert (and (<= (to_rep2 (first (rt b))) ib4) (<= ib4 (to_rep2 (last (rt b))))))
(assert (= o252 ib4))
(assert (= o253 (select (elts b) o252)))
(assert (= o254 (to_rep o253)))
(assert (and (<= (to_rep2 (first (rt a))) ia1) (<= ia1 (to_rep2 (last (rt a))))))
(assert (= o250 ia1))
(assert (= o251 (select (elts a) o250)))
(assert (= o255 (to_rep o251)))
(assert (= result44 (ite (= o255 o254) true false)))
(assert (= result44 true))
(assert (and (= o248 ib4) (in_range4 ib4)))
(assert (and (= o249 (remove b o248)) (and (dynamic_invariant2 o249 true false true) (and (= (invariant__ o249) true) (and (= (to_rep2 (last (rt o249))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o248 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o249) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o248 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o249) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o248 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o249) k1))))))))))))
(assert (and (= o246 ia1) (in_range4 ia1)))
(assert (and (= o247 (remove a o246)) (and (dynamic_invariant2 o247 true false true) (and (= (invariant__ o247) true) (and (= (to_rep2 (last (rt o247))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o246 1))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o247) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o246 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o247) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o246 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select (elts o247) k1))))))))))))
(assert (not (= (invariant__ o247) true)))
(check-sat)
(exit)
