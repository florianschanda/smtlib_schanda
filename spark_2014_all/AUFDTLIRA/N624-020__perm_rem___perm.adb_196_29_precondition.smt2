...
(assert (and (= o4 (remove b o3)) (and (dynamic_invariant2 o4 true false true) (and (= (invariant__ o4) true) (and (= (to_rep2 (last (rt o4))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o3 1))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o4) k))))) (and (forall ((k Int)) (=> (and (<= (+ o3 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o4) (- k 1)))))) (forall ((k Int)) (=> (and (<= o3 k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o4) k))))))))))))
(assert (and (= o1 ia1) (in_range4 ia1)))
(assert (and (= o2 (remove a o1)) (and (dynamic_invariant2 o2 true false true) (and (= (invariant__ o2) true) (and (= (to_rep2 (last (rt o2))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o1 1))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o2) k))))) (and (forall ((k Int)) (=> (and (<= (+ o1 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o2) (- k 1)))))) (forall ((k Int)) (=> (and (<= o1 k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o2) k))))))))))))
