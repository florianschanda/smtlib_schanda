...
(assert (= o2 (store links o1 (mk___rep (mk___split_fields (of_int 0) (rec__database__availability__account_link__prev (us_split_fields1 (select links first_available))) (rec__database__availability__account_link__next (us_split_fields1 (select links first_available))))))))
...
(assert (not (not (= (is_available account2 links2) true))))
(check-sat)
(exit)
