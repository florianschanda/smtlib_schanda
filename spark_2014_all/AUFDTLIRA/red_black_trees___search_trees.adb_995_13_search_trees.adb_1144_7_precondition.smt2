...
(assert (and (= o23 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7)))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct t__split_fields7) o23) true)))
(check-sat)
(exit)
