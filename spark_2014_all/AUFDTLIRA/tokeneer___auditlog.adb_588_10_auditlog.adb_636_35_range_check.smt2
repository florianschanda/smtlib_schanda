...
(assert (= (ite (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid)))))) (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid)))))) 1) 0) (ite (<= 1 (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid)))))) (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))) 1) 1) 0)))
(assert (= (slide (elts (to_string (attr__ATTRIBUTE_IMAGE9 elementid))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))) 1) temp___1376))
(assert (= (mk1 1 (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid)))))) temp___13761))
(assert (<= 1 (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid)))))))
(assert (not (<= (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))) 20)))
(check-sat)
(exit)
