...
(assert (=> (= i2 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))) (= branch__split_discrs (mk___split_discrs temp___207))))
(assert (=> (= i2 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))) (= temp___2071 o9)))
(assert (=> (= i2 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))) (= temp___2072 o10)))
...
(assert (=> (= i2 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))) (= branch__split_fields4 (mk___split_fields (mk___t temp___2071 temp___2072)))))
(assert (=> (= i2 (to_rep (last (rt (rec__main__branch_type__m_nodes branch__split_fields3))))) (= branch__split_discrs (mk___split_discrs temp___207))))
