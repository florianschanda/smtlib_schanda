...
(assert (= o57 i))
(assert (= o58 (select (map__content a19) o57)))
(assert (= o59 (us_split_fields1 o58)))
(assert (= o60 (rec__frame_condition__cell__max_right o59)))
(assert (= o61 (to_rep o60)))
(assert (and (<= (to_rep1 a__first) j) (<= j (to_rep1 a__last))))
(assert (= o53 j))
(assert (= o54 (select (map__content a19) o53)))
(assert (= o55 (us_split_fields1 o54)))
(assert (= o56 (rec__frame_condition__cell__value o55)))
(assert (= o62 (to_rep o56)))
(assert (= o63 (ite (<= o62 o61) true false)))
(assert (and (<= (to_rep1 a__first) j) (<= j (to_rep1 a__last))))
(assert (= o48 j))
(assert (= o49 (select (map__content a19) o48)))
(assert (= o50 (us_split_fields1 o49)))
(assert (= o51 (rec__frame_condition__cell__max_left o50)))
