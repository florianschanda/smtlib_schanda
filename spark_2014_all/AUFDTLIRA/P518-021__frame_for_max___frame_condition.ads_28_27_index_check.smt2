...
(assert (or (and (and (and (= c205b11 (mk_int__ref c205b)) (and (= c204b11 (mk_int__ref c204b)) (and (= max27 (mk_int__ref max1)) (and (= k28 (mk_int__ref k1)) (and (= c168b9 (mk_int__ref c168b)) (and (= c167b9 (mk_int__ref c167b)) (and (= max26 (mk_int__ref max)) (and (= k27 (mk_int__ref k)) (= a24 (mk_map__ref a)))))))))) (and (= c205b12 c205b1) (and (= c204b12 c204b1) (and (= max29 max3) (and (= k30 k3) (and (= c168b10 c168b1) (and (= c167b10 c167b1) (and (= max28 max2) (and (= k29 k2) (= a25 a1)))))))))) (and (and (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (= o (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (= result true))) (and (and (and (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (= o (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (not (= result true))) (and (and (and (= c205b11 c205b9) (and (= c204b11 c204b9) (and (= max27 max24) (and (= k28 k25) (and (= c168b9 c168b7) (and (= c167b9 c167b7) (and (= max26 max10) (and (= k27 k11) (= a24 a22))))))))) (and (= c205b12 c205b10) (and (= c204b12 c204b10) (and (= max29 max25) (and (= k30 k26) (and (= c168b10 c168b8) (and (= c167b10 c167b8) (and (= max28 max11) (and (= k29 k12) (= a25 a23)))))))))) (and (in_range4 c164b) (and (and (in_range4 not_kind) (and (and (and (= frame_condition__update_max_3__B165b__first__assume (to_rep1 a__first)) (in_range3 (to_rep1 a__first))) (= frame_condition__update_max_3__B165b__first__assume first2)) (and (in_range3 first2) (and (and (and (= frame_condition__update_max_3__B165b__last__assume (to_rep1 a__last)) (in_range3 (to_rep1 a__last))) (= frame_condition__update_max_3__B165b__last__assume last2)) (and (in_range3 last2) (and (and (= result1 (mk_int__ref k)) (= k4 first2)) (and (in_range3 k4) (and (and (= result2 (mk_int__ref max)) (= max4 0)) (and (in_range2 max4) (and (and (and (= temp___254 a) (and (= temp___252 a) (and (= temp___250 max4) (and (= temp___249 k4) (and (= temp___248 c168b) (and (= temp___247 c167b) (and (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) k4) (<= k4 (to_rep1 a__last))) (= o1 k4)) (= (mk___rep (mk___split_fields o2 o3 o4)) (select a o1))) (and (= o2 o5) (and (= o3 o6) (= o4 o7)))) (= o8 o5)) (= o9 (to_rep o8))) (= result3 (ite (< max4 o9) true false))) (ite (= result3 true) (and (and (and (and (and (and (and (<= (to_rep1 a__first) k4) (<= k4 (to_rep1 a__last))) (= o10 k4)) (= (mk___rep (mk___split_fields o11 o12 o13)) (select a o10))) (and (= o11 o14) (and (= o12 o15) (= o13 o16)))) (= o17 o14)) (= o18 (to_rep o17))) (and (= result4 (mk_int__ref max4)) (= max5 o18))) (= max5 max4))) (and (in_range4 c166b) (and (and (and (= result5 (mk_int__ref c167b)) (= c167b2 k4)) (in_range3 c167b2)) (and (and (and (= result6 (mk_int__ref c168b)) (= c168b2 max5)) (in_range2 c168b2)) (and (and (and (and (and (= (to_rep o19) c168b2) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a c167b2))) o20) (and (= o19 o21) (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a c167b2))) o22)))) (and (= o23 o20) (and (= o24 o21) (= o25 o22)))) (and (and (and (<= (to_rep1 a__first) c167b2) (<= c167b2 (to_rep1 a__last))) (= o26 c167b2)) (= o27 (store a o26 (mk___rep (mk___split_fields o23 o24 o25)))))) (and (= result7 (mk_map__ref a)) (= a2 o27))) (and (and (and (<= (to_rep1 a__first) k5) (<= k5 (to_rep1 a__last))) (and (and (forall ((i11 Int)) (=> (and (<= first2 i11) (<= i11 k5)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a3 i11)))) max6))) (forall ((i11 Int)) (=> (and (<= k5 i11) (<= i11 first2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a3 i11)))) max6)))) (forall ((i11 Int)) (=> (and (<= (to_rep1 a__first) i11) (<= i11 k5)) (forall ((j5 Int)) (=> (and (<= i11 j5) (<= j5 k5)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a3 i11)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a3 j5))))))))))) (and (and (and (and (and (=> (<= 1 2147483647) (in_range3 c167b3)) (=> (<= 0 2147483647) (in_range2 c168b3))) (=> (<= 1 2147483647) (in_range3 k5))) (=> (<= 0 2147483647) (in_range2 max6))) (forall ((temp___253 Int)) (=> (and (<= (to_rep1 a__first) temp___253) (<= temp___253 (to_rep1 a__last))) (= (rec__frame_condition__cell__value (us_split_fields1 (select a3 temp___253))) (rec__frame_condition__cell__value (us_split_fields1 (select temp___252 temp___253))))))) (and (and (= k7 (mk_int__ref k5)) (= k8 k5)) (= k5 last2))))))))))))))) (and (and (= c168b5 (mk_int__ref c168b3)) (and (= c167b5 (mk_int__ref c167b3)) (and (= max8 (mk_int__ref max6)) (and (= k9 k7) (= a5 (mk_map__ref a3)))))) (and (= c168b6 c168b3) (and (= c167b6 c167b3) (and (= max9 max6) (and (= k10 k8) (= a6 a3))))))) (and (and (= c168b7 c168b5) (and (= c167b7 c167b5) (and (= max10 max8) (and (= k11 k9) (= a7 a5))))) (and (= c168b8 c168b6) (and (= c167b8 c167b6) (and (= max11 max9) (and (= k12 k10) (= a8 a6)))))))))))))))) (and (in_range4 c201b) (and (in_range4 not_kind1) (and (and (ite (= 1 0) (and (= frame_condition__update_max_3__B202b__first__assume (to_rep1 a__first)) (in_range3 (to_rep1 a__first))) (and (= frame_condition__update_max_3__B202b__first__assume (to_rep1 a__last)) (in_range3 (to_rep1 a__last)))) (= frame_condition__update_max_3__B202b__first__assume first3)) (and (in_range3 first3) (and (and (ite (= 1 0) (and (= frame_condition__update_max_3__B202b__last__assume (to_rep1 a__last)) (in_range3 (to_rep1 a__last))) (and (= frame_condition__update_max_3__B202b__last__assume (to_rep1 a__first)) (in_range3 (to_rep1 a__first)))) (= frame_condition__update_max_3__B202b__last__assume last3)) (and (in_range3 last3) (and (and (= result14 (mk_int__ref k1)) (= k13 first3)) (and (in_range3 k13) (and (and (= result15 (mk_int__ref max1)) (= max12 0)) (and (in_range2 max12) (and (and (and (= temp___263 max12) (and (= temp___261 (map__content a7)) (and (= temp___259 k13) (and (= temp___258 c205b) (and (= temp___257 c204b) (and (= temp___264 (map__content a7)) (and (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) k13) (<= k13 (to_rep1 a__last))) (= o60 k13)) (= o61 (select (map__content a7) o60))) (= o62 (us_split_fields1 o61))) (= o63 (rec__frame_condition__cell__value o62))) (= o64 (to_rep o63))) (= result16 (ite (< max12 o64) true false))) (ite (= result16 true) (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) k13) (<= k13 (to_rep1 a__last))) (= o65 k13)) (= o66 (select (map__content a7) o65))) (= o67 (us_split_fields1 o66))) (= o68 (rec__frame_condition__cell__value o67))) (= o69 (to_rep o68))) (and (= result17 (mk_int__ref max12)) (= max13 o69))) (and (= max14 (mk_int__ref max13)) (= max15 max13))) (and (= max14 (mk_int__ref max12)) (= max15 max12)))) (and (in_range4 c203b) (and (and (and (= result18 (mk_int__ref c204b)) (= c204b2 k13)) (in_range3 c204b2)) (and (and (and (= result19 (mk_int__ref c205b)) (= c205b2 (int__content max14))) (in_range2 c205b2)) (and (ite (= 1 0) (and (and (and (and (and (= (to_rep o70) c205b2) (= o71 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) c204b2))) o70 (rec__frame_condition__cell__max_right (us_split_fields1 (select (map__content a7) c204b2)))))) (= o72 (mk___rep o71))) (and (and (and (<= (to_rep1 a__first) c204b2) (<= c204b2 (to_rep1 a__last))) (= o73 c204b2)) (= o74 (store (map__content a7) o73 o72)))) (and (= result20 a7) (= a9 o74))) (and (= a11 (mk_map__ref a9)) (= a12 a9))) (and (and (and (and (and (= (to_rep o75) c205b2) (= o76 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) c204b2))) (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a7) c204b2))) o75))) (= o77 (mk___rep o76))) (and (and (and (<= (to_rep1 a__first) c204b2) (<= c204b2 (to_rep1 a__last))) (= o78 c204b2)) (= o79 (store (map__content a7) o78 o77)))) (and (= result21 a7) (= a10 o79))) (and (= a11 (mk_map__ref a10)) (= a12 a10)))) (and (and (and (<= (to_rep1 a__first) k14) (<= k14 (to_rep1 a__last))) (and (and (forall ((i11 Int)) (=> (and (<= first3 i11) (<= i11 k14)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a13 i11)))) max16))) (forall ((i11 Int)) (=> (and (<= k14 i11) (<= i11 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a13 i11)))) max16)))) (and (forall ((i11 Int)) (=> (and (<= k14 i11) (<= i11 (to_rep1 a__last))) (forall ((j5 Int)) (=> (and (<= i11 j5) (<= j5 (to_rep1 a__last))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a13 j5)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select a13 i11))))))))) (forall ((i11 Int)) (=> (and (<= (to_rep1 a__first) i11) (<= i11 (to_rep1 a__last))) (= (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a13 i11)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select temp___264 i11)))))))))) (and (and (and (and (and (=> (<= 1 2147483647) (in_range3 c204b3)) (=> (<= 0 2147483647) (in_range2 c205b3))) (=> (<= 1 2147483647) (in_range3 k14))) (forall ((temp___262 Int)) (=> (and (<= (to_rep1 a__first) temp___262) (<= temp___262 (to_rep1 a__last))) (= (rec__frame_condition__cell__value (us_split_fields1 (select a13 temp___262))) (rec__frame_condition__cell__value (us_split_fields1 (select temp___261 temp___262))))))) (=> (<= 0 2147483647) (in_range2 max16))) (and (and (= k19 (mk_int__ref k14)) (= k20 k14)) (= k14 last3))))))))))))))) (and (and (= c205b7 (mk_int__ref c205b3)) (and (= c204b7 (mk_int__ref c204b3)) (and (= max22 (mk_int__ref max16)) (and (= k23 k19) (= a20 (mk_map__ref a13)))))) (and (= c205b8 c205b3) (and (= c204b8 c204b3) (and (= max23 max16) (and (= k24 k20) (= a21 a13))))))) (and (and (= c205b9 c205b7) (and (= c204b9 c204b7) (and (= max24 max22) (and (= k25 k23) (= a22 a20))))) (and (= c205b10 c205b8) (and (= c204b10 c204b8) (and (= max25 max23) (and (= k26 k24) (= a23 a21)))))))))))))))))))))))
(assert (= c205b13 c205b11))
(assert (= c204b13 c204b11))
(assert (= max31 max27))
(assert (= k32 k28))
...
(assert (= k31 k27))
(assert (= a26 a24))
(assert (= c205b14 c205b12))
(assert (= c204b14 c204b12))
(assert (= max33 max29))
(assert (= k34 k30))
(assert (= c168b12 c168b10))
(assert (= c167b12 c167b10))
(assert (= max32 max28))
(assert (= k33 k29))
(assert (= a27 a25))
(assert (<= (to_rep1 a__first) i10))
(assert (<= i10 (to_rep1 a__last)))
(assert (<= i10 j4))
(assert (<= j4 (to_rep1 a__last)))
(assert (and (<= (to_rep1 a__first) i10) (<= i10 (to_rep1 a__last))))
(assert (= o132 i10))
(assert (= o133 (select (map__content a26) o132)))
(assert (= o134 (us_split_fields1 o133)))
(assert (= o135 (rec__frame_condition__cell__max_right o134)))
(assert (= o136 (to_rep o135)))
(assert (and (<= (to_rep1 a__first) j4) (<= j4 (to_rep1 a__last))))
(assert (= o128 j4))
(assert (= o129 (select (map__content a26) o128)))
(assert (= o130 (us_split_fields1 o129)))
(assert (= o131 (rec__frame_condition__cell__value o130)))
(assert (= o137 (to_rep o131)))
(assert (= o138 (ite (<= o137 o136) true false)))
(assert (and (<= (to_rep1 a__first) j4) (<= j4 (to_rep1 a__last))))
(assert (= o123 j4))
(assert (= o124 (select (map__content a26) o123)))
(assert (= o125 (us_split_fields1 o124)))
(assert (= o126 (rec__frame_condition__cell__max_left o125)))
(assert (= o127 (to_rep o126)))
(assert (not (<= (to_rep1 a__first) i10)))
(check-sat)
(exit)
