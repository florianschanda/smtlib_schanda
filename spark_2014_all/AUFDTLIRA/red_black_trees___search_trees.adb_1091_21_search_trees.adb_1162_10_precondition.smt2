...
(assert (and (= temp___1097 (model__ (mk___rep2 f_1__split_fields3) o76)) (and (dynamic_invariant6 temp___1097 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1097 o76))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1097 o76)))) 0) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (not (= i6 o76)) (ite (and (not (= (parent (mk___rep2 f_1__split_fields3) i6) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1097 (parent (mk___rep2 f_1__split_fields3) i6)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1097 i6))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1097 i6))) true)))))) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1097 i6))) true) (not (= i6 o76))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1097 (parent (mk___rep2 f_1__split_fields3) i6)))) (position (mk___rep2 f_1__split_fields3) i6) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1097 i6)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1097 i6)))) 0)))) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1097 i6))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1097 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1097 i6))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1097 j15)))) true)) (= j15 i6))))))))))))))
(assert (= o77 (select temp___1097 i2)))
(assert (= o78 (us_split_fields1 o77)))
(assert (= o79 (rec__tree_model__path_type__a o78)))
(assert (and (= o84 (olt o79 o83)) (= (= o84 true) (and (< (length o79) (length o83)) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o79))) (= (get o79 n) (get o83 n))))))))
