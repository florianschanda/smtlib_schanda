...
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o65) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o64 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o64)))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (= result11 (ite (= o64 first_available1) true false)))))
...
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o66 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (and (= o62 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o62)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (= result13 (ite (< 0 o62) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (and (= o61 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o61))))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (= result10 (ite (= o61 first_allocated2) true false))))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (not (= result13 true)) (= result10 false)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (and (= o63 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o63)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (= result10 (ite (= o63 0) true false)))))
...
(assert (and (= o60 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 o60)))
(assert (= result15 (ite (in_range7 o60) true false)))
