...
(assert (and (= o123 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o123)))
(assert (= o124 (ite (<= j6 o123) true false)))
(assert (= result34 (ite (<= 1 j6) o124 false)))
(assert (= result34 true))
(assert (and (= o128 (get (rec__list_allocator__m__t__available model____split_fields4) j6)) (in_range7 o128)))
(assert (= result35 (ite (in_range4 o128) true false)))
(assert (= result35 true))
(assert (and (= o125 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o125)))
(assert (= result36 (ite (< j6 o125) true false)))
(assert (= result36 true))
(assert (not (in_range1 (+ j6 1))))
(check-sat)
(exit)
