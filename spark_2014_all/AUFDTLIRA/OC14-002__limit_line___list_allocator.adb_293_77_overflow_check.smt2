...
(assert (=> (not (= first_available1 0)) (and (= o66 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o66))))
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o66) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o65 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o65)))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (= result11 (ite (= o65 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result12 true)) (= result11 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o67 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o67))))
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o67 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (and (= o63 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o63)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (= result13 (ite (< 0 o63) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (and (= o62 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range7 o62))))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (= result10 (ite (= o62 first_allocated2) true false))))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (not (= result13 true)) (= result10 false)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (and (= o64 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o64)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (= result10 (ite (= o64 0) true false)))))
(assert (=> (not (= result11 true)) (= result10 false)))
(assert (= result10 true))
(assert (and (= o58 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o58)))
(assert (= o59 (ite (<= j o58) true false)))
(assert (= result14 (ite (<= 1 j) o59 false)))
(assert (= result14 true))
(assert (and (= o61 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 o61)))
(assert (= result15 (ite (in_range4 o61) true false)))
(assert (= result15 true))
(assert (and (= o60 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o60)))
(assert (= result16 (ite (< j o60) true false)))
