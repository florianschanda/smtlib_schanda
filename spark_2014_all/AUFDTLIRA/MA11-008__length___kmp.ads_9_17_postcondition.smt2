...
(assert (forall ((temp___161 Int) (temp___162 Int) (temp___163 Int)) (let ((temp___160 (kmp__init_next__next__aggregate_def temp___161 temp___162 temp___163))) (and (=> (dynamic_property (- 2147483648) 2147483647 temp___162 temp___163) (and (= (first5 temp___160) temp___162) (= (last5 temp___160) temp___163))) (forall ((temp___164 Int)) (= (select (to_array2 temp___160) temp___164) (of_rep temp___161)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_154 us_t1) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (not (= temp___skip_constant_152 true)) (and (dynamic_property2 (first1 p) (last1 p) (first3 temp___expr_154) (last3 temp___expr_154)) (and (= (first3 temp___expr_154) (first1 p)) (= (last3 temp___expr_154) (last1 p))))))
...
(assert (= (mk___t2 temp___166 temp___1661) (kmp__init_next__next__aggregate_def 0 (to_rep (first (rt p))) (to_rep (last (rt p))))))
(assert (= (ite (<= (to_rep (first4 temp___1661)) (to_rep (last4 temp___1661))) (+ (- (to_rep (last4 temp___1661)) (to_rep (first4 temp___1661))) 1) 0) (ite (<= (to_rep (first (rt p))) (to_rep (last (rt p)))) (+ (- (to_rep (last (rt p))) (to_rep (first (rt p)))) 1) 0)))
(assert (= (slide temp___166 (to_rep (first4 temp___1661)) (to_rep (first (rt p)))) kmp__init_next__next__assume))
...
(assert (= (mk___t kmp__init_next__result6 kmp__init_next__result7) (mk___t kmp__init_next__result2 kmp__init_next__result3)))
(assert (= result1 kmp__init_next__result))
(assert (= result2 kmp__init_next__result1))
(assert (= next1 kmp__init_next__result2))
(assert (= (mk (to_rep next__first) (to_rep next__last)) kmp__init_next__result3))
(assert (= (mk_a__ref (mk___t kmp__init_next__result8 kmp__init_next__result9)) (mk_a__ref (mk___t kmp__init_next__result4 kmp__init_next__result5))))
(assert (= next2 next1))
...
(assert (not (= (length (mk___t kmp__init_next__result8 kmp__init_next__result9)) (length p))))
(check-sat)
(exit)
