...
(assert (forall ((temp___186 Int) (temp___187 Int) (temp___188 Int)) (let ((temp___185 (kmp__init_next__next__aggregate_def temp___186 temp___187 temp___188))) (=> (dynamic_invariant1 temp___186 true true true true) (and (=> (dynamic_property (- 2147483648) 2147483647 temp___187 temp___188) (and (= (first5 temp___185) temp___187) (= (last5 temp___185) temp___188))) (forall ((temp___189 Int)) (= (to_rep (select (to_array2 temp___185) temp___189)) temp___186)))))))
(define-fun dynamic_invariant2 ((temp___expr_179 us_t1) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (not (= temp___skip_constant_176 true)) (and (dynamic_property2 (first1 p) (last1 p) (first3 temp___expr_179) (last3 temp___expr_179)) (and (= (first3 temp___expr_179) (first1 p)) (= (last3 temp___expr_179) (last1 p))))))
...
(assert (= (mk___t2 temp___191 temp___1911) (kmp__init_next__next__aggregate_def 0 (to_rep (first (rt p))) (to_rep (last (rt p))))))
(assert (= (ite (<= (to_rep (first4 temp___1911)) (to_rep (last4 temp___1911))) (+ (- (to_rep (last4 temp___1911)) (to_rep (first4 temp___1911))) 1) 0) (ite (<= (to_rep (first (rt p))) (to_rep (last (rt p)))) (+ (- (to_rep (last (rt p))) (to_rep (first (rt p)))) 1) 0)))
(assert (= (slide temp___191 (to_rep (first4 temp___1911)) (to_rep (first (rt p)))) kmp__init_next__next__assume))
