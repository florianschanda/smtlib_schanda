...
(assert (= o4 (+ o3 1)))
(assert (and (= temp___304 o4) (in_range1 o4)))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 temp___304))
...
(assert (and (= temp___295 (+ j1 (- i1 1))) (in_range1 (+ j1 (- i1 1)))))
(assert (and (<= (to_rep1 (first (rt haystack))) temp___295) (<= temp___295 (to_rep1 (last (rt haystack))))))
(assert (= o5 temp___295))
...
(assert (= (= diff3 true) (not (= (to_rep (select (elts needle) j2)) (to_rep (select (elts haystack) (+ j2 (- i1 1))))))))
(assert (and (=> (<= (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle)))) (dynamic_property2 (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) j2)) (and (<= (to_rep1 (first (rt needle))) j2) (<= j2 (to_rep1 (last (rt needle)))))))
(assert (not (in_range1 (+ j2 (- i1 1)))))
(check-sat)
(exit)
