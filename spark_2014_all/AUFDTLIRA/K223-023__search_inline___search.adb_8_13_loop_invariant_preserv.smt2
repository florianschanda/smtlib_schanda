...
(assert (<= 1 i1))
(assert (<= i1 10))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (not (= (to_rep (select t j1)) v)))))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 pos3)) (=> (<= 1 10) (in_range3 i2))) (and (<= 1 i2) (<= i2 10))))
...
(assert (<= 1 j1))
(assert (<= j1 (- i3 1)))
(assert (not (not (= (to_rep (select t j1)) v))))
(check-sat)
(exit)
