...
(assert (=> (= result7 true) (and (= temp___385 (get model____split_fields j)) (in_range7 temp___385))))
(assert (=> (= result7 true) (and (<= 1 temp___385) (<= temp___385 3))))
(assert (=> (= result7 true) (= o16 temp___385)))
...
(assert (=> (= result6 true) (and (= temp___386 (get model____split_fields j)) (in_range7 temp___386))))
(assert (=> (= result6 true) (and (<= 1 temp___386) (<= temp___386 3))))
(assert (=> (= result6 true) (= o5 temp___386)))
