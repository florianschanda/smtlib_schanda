...
(assert (=> (not (= first_available 0)) (and (= o33 (length model____split_fields)) (in_range6 o33))))
(assert (=> (not (= first_available 0)) (= result2 (ite (< 0 o33) true false))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (and (= o32 (get model____split_fields 1)) (in_range7 o32)))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (= result1 (ite (= o32 first_available) true false)))))
(assert (=> (not (= first_available 0)) (=> (not (= result2 true)) (= result1 false))))
(assert (=> (not (not (= first_available 0))) (and (= o34 (length model____split_fields)) (in_range6 o34))))
(assert (=> (not (not (= first_available 0))) (= result1 (ite (= o34 0) true false))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (and (= o30 (length model____split_fields1)) (in_range6 o30)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o30) true false)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (and (= o29 (get model____split_fields1 1)) (in_range7 o29))))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (= result (ite (= o29 first_allocated) true false))))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (not (= result3 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (and (= o31 (length model____split_fields1)) (in_range6 o31)))))
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (= result (ite (= o31 0) true false)))))
...
(assert (= result4 true))
(assert (and (= o28 (get model____split_fields j)) (in_range7 o28)))
(assert (= result7 (ite (in_range4 o28) true false)))
(assert (=> (= result7 true) (and (= o24 (length model____split_fields)) (in_range6 o24))))
(assert (=> (= result7 true) (= result8 (ite (< j o24) true false))))
(assert (=> (= result7 true) (=> (= result8 true) (and (= o25 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result7 true) (=> (= result8 true) (and (= o26 (get model____split_fields o25)) (in_range7 o26)))))
(assert (=> (= result7 true) (=> (not (= result8 true)) (= o26 0))))
(assert (=> (= result7 true) (and (= temp___418 (get model____split_fields j)) (in_range7 temp___418))))
(assert (=> (= result7 true) (and (<= 1 temp___418) (<= temp___418 3))))
(assert (=> (= result7 true) (= o16 temp___418)))
(assert (=> (= result7 true) (= (mk___rep (mk___split_fields o17 o18 o19)) (select data o16))))
(assert (=> (= result7 true) (= o17 o20)))
(assert (=> (= result7 true) (= o18 o21)))
(assert (=> (= result7 true) (= o19 o22)))
(assert (=> (= result7 true) (= o23 o22)))
(assert (=> (= result7 true) (= o27 (to_rep o23))))
(assert (=> (= result7 true) (= result6 (ite (= o27 o26) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (=> (< 1 j) (and (= o13 (- j 1)) (in_range2 (- j 1))))))
(assert (=> (= result6 true) (=> (< 1 j) (and (= o14 (get model____split_fields o13)) (in_range7 o14)))))
(assert (=> (= result6 true) (=> (not (< 1 j)) (= o14 0))))
(assert (=> (= result6 true) (and (= temp___419 (get model____split_fields j)) (in_range7 temp___419))))
(assert (=> (= result6 true) (and (<= 1 temp___419) (<= temp___419 3))))
(assert (=> (= result6 true) (= o5 temp___419)))
(assert (=> (= result6 true) (= (mk___rep (mk___split_fields o6 o7 o8)) (select data o5))))
(assert (=> (= result6 true) (= o6 o9)))
(assert (=> (= result6 true) (= o7 o10)))
(assert (=> (= result6 true) (= o8 o11)))
(assert (=> (= result6 true) (= o12 o10)))
(assert (=> (= result6 true) (= o15 (to_rep o12))))
...
(assert (= result9 true))
(assert (not (= j k)))
(assert (and (= o4 (get model____split_fields k)) (in_range7 o4)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
