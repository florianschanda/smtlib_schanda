...
(assert (=> (= result7 true) (=> (< 1 j1) (and (= o44 (- j1 1)) (in_range2 (- j1 1))))))
(assert (=> (= result7 true) (=> (< 1 j1) (and (= o45 (get model____split_fields o44)) (in_range7 o45)))))
(assert (=> (= result7 true) (=> (not (< 1 j1)) (= o45 0))))
(assert (=> (= result7 true) (and (= temp___386 (get model____split_fields j1)) (in_range7 temp___386))))
(assert (=> (= result7 true) (and (<= 1 temp___386) (<= temp___386 3))))
(assert (=> (= result7 true) (= o36 temp___386)))
(assert (=> (= result7 true) (= (mk___rep (mk___split_fields o37 o38 o39)) (select data o36))))
(assert (=> (= result7 true) (= o37 o40)))
(assert (=> (= result7 true) (= o38 o41)))
(assert (=> (= result7 true) (= o39 o42)))
(assert (=> (= result7 true) (= o43 o41)))
(assert (=> (= result7 true) (= o46 (to_rep o43))))
(assert (=> (= result7 true) (= result6 (ite (= o46 o45) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (= result6 true))
(assert (and (= o32 (length model____split_fields)) (in_range6 o32)))
(assert (= o33 (ite (<= k1 o32) true false)))
(assert (= result10 (ite (<= 1 k1) o33 false)))
(assert (= result10 true))
(assert (not (= j1 k1)))
(assert (and (= o34 (get model____split_fields k1)) (in_range7 o34)))
(assert (not (<= 1 j1)))
(check-sat)
(exit)
