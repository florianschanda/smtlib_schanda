...
(assert (forall ((temp___319 Int)) (=> (and (<= 1 temp___319) (<= temp___319 3)) (default_initial_assumption (to_rep (select temp___318 temp___319)) false))))
