...
(declare-fun temp___227 (Int) (Array Int integer_32))
...
(assert (forall ((temp___229 Int)) (=> (dynamic_invariant temp___229 true true true true) (forall ((temp___230 Int)) (= (to_rep (select (temp___227 temp___229) temp___230)) temp___229)))))
...
(assert (= quantifiers__previous_seen__all_zero__result1 (temp___227 0)))
