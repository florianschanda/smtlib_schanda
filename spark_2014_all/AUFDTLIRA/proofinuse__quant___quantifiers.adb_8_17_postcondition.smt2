...
(declare-fun temp_____aggregate_def_227 (Int) (Array Int integer_32))
...
(assert (forall ((temp___229 Int)) (=> (dynamic_invariant temp___229 true true true true) (forall ((temp___230 Int)) (= (select (temp_____aggregate_def_227 temp___229) temp___230) rliteral)))))
...
(assert (= quantifiers__previous_seen__all_zero__result1 (temp_____aggregate_def_227 0)))
