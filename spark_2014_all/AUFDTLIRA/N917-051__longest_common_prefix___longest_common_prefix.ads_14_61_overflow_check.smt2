...
(assert (=> (= result1 true) (=> (= result7 true) (and (= temp___1691 (+ y l3)) (in_range1 (+ y l3))))))
(assert (=> (= result1 true) (=> (= result7 true) (and (<= 1 temp___1691) (<= temp___1691 1000)))))
...
(assert (=> (= result1 true) (=> (= result7 true) (and (= temp___1681 (+ x l3)) (in_range1 (+ x l3))))))
(assert (=> (= result1 true) (=> (= result7 true) (and (<= 1 temp___1681) (<= temp___1681 1000)))))
