...
(declare-fun temp___2973 ((Array Int us_rep1) Int us_rep1) (Array Int us_rep1))
(assert (forall ((temp___2975 (Array Int us_rep1))) (forall ((temp___2976 Int)) (forall ((temp___2977 us_rep1)) (let ((temp___2974 (temp___2973 temp___2975 temp___2976 temp___2977))) (=> (dynamic_invariant temp___2976 true true true true) (forall ((temp___2978 Int)) (ite (= temp___2978 temp___2976) (= (select temp___2974 temp___2978) temp___2977) (= (select temp___2974 temp___2978) (select temp___2975 temp___2978))))))))))
...
(assert (= a6 a4))
(assert (not (= (bool_eq2 (map__content a5) 5 50 (temp___2973 a i (mk___rep1 (mk___split_fields1 (of_rep2 e) (mk___rep (mk___split_fields (of_rep f) (of_rep1 g))) (of_rep3 h)))) 5 50) true)))
(check-sat)
(exit)
