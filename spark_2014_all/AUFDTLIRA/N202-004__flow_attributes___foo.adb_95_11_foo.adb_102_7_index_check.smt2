...
(declare-fun temp___319 (Int Int Int) us_t1)
...
(assert (forall ((temp___321 Int) (temp___322 Int) (temp___323 Int)) (let ((temp___320 (temp___319 temp___321 temp___322 temp___323))) (=> (dynamic_invariant1 temp___321 true true true true) (and (=> (dynamic_property 1 2147483647 temp___322 temp___323) (and (= (first3 temp___320) temp___322) (= (last3 temp___320) temp___323))) (forall ((temp___324 Int)) (= (to_rep (select (to_array1 temp___320) temp___324)) temp___321)))))))
(declare-const a (Array Int character))
(declare-const temp___326 (Array Int character))
(declare-const temp___3261 t1)
(declare-const temp___327 (Array Int character))
(declare-const temp___3271 t)
(declare-const temp___328 (Array Int character))
(declare-const temp___3281 t)
...
(assert (= (to_rep1 (first2 (rt1 (temp___319 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___319 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___326 temp___3261) (temp___319 32 (to_rep1 a__first) (to_rep1 a__last))))
(assert (= temp___326 temp___327))
(assert (= (mk (to_rep1 (first2 temp___3261)) (to_rep1 (last2 temp___3261))) temp___3271))
(assert (= (ite (<= (to_rep1 (first temp___3271)) (to_rep1 (last temp___3271))) (+ (- (to_rep1 (last temp___3271)) (to_rep1 (first temp___3271))) 1) 0) (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0)))
(assert (= (mk___t temp___328 temp___3281) (mk___t temp___327 temp___3271)))
(assert (= o (slide temp___328 (to_rep1 (first temp___3281)) (to_rep1 a__first))))
(assert (= result a))
(assert (= a1 o))
