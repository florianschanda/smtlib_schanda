...
(assert (= (to_rep1 (first2 (rt1 (temp___284 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___284 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___291 temp___2911) (temp___284 32 (to_rep1 a__first) (to_rep1 a__last))))
(assert (= temp___291 temp___292))
(assert (= (mk (to_rep1 (first2 temp___2911)) (to_rep1 (last2 temp___2911))) temp___2921))
(assert (= (ite (<= (to_rep1 (first temp___2921)) (to_rep1 (last temp___2921))) (+ (- (to_rep1 (last temp___2921)) (to_rep1 (first temp___2921))) 1) 0) (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0)))
(assert (= (mk___t temp___293 temp___2931) (mk___t temp___292 temp___2921)))
(assert (= o (slide temp___293 (to_rep1 (first temp___2931)) (to_rep1 a__first))))
(assert (= result a))
(assert (= a1 o))
