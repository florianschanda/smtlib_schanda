...
(define-fun dynamic_invariant ((temp___expr_268 Int) (temp___is_init_264 Bool) (temp___skip_constant_265 Bool) (temp___do_toplevel_266 Bool) (temp___do_typ_inv_267 Bool)) Bool (=> (or (= temp___is_init_264 true) (<= 0 2147483647)) (in_range2 temp___expr_268)))
...
(assert (forall ((container us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant1 ((temp___expr_168 Int) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool) (temp___do_typ_inv_167 Bool)) Bool (=> (or (= temp___is_init_164 true) (<= 0 2147483647)) (in_range3 temp___expr_168)))
...
(assert (forall ((x position_type)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_315 us_rep2) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (=> (= temp___do_typ_inv_314 true) (= (tree_structure temp___expr_315) true)))
...
(assert (forall ((f us_rep2)) (! (=> (dynamic_invariant3 f true true true true) (dynamic_invariant2 (size f) true false true true)) :pattern ((size f)))))
...
(define-fun bool_eq5 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (user_eq10 (rec__tree_model__path_type__a (us_split_fields5 a)) (rec__tree_model__path_type__a (us_split_fields5 b))) true) (= (rec__tree_model__path_type__k (us_split_fields5 a)) (rec__tree_model__path_type__k (us_split_fields5 b)))) true false))
...
(define-fun oeq ((left us_rep3) (right us_rep3)) Bool (and (= (length1 left) (length1 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
...
(define-fun dynamic_invariant4 ((temp___expr_175 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 100)) (in_range6 temp___expr_175)))
(define-fun dynamic_invariant5 ((temp___expr_251 (Array Int us_rep4)) (temp___is_init_247 Bool) (temp___skip_constant_248 Bool) (temp___do_toplevel_249 Bool) (temp___do_typ_inv_250 Bool)) Bool (forall ((temp___252 Int)) (=> (and (<= 1 temp___252) (<= temp___252 100)) (=> (= temp___is_init_247 true) (< (length1 (rec__tree_model__path_type__a (us_split_fields5 (select temp___expr_251 temp___252)))) 100)))))
(define-fun default_initial_assumption2 ((temp___expr_254 (Array Int us_rep4)) (temp___skip_top_level_255 Bool)) Bool (forall ((temp___256 Int)) (=> (and (<= 1 temp___256) (<= temp___256 100)) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields5 (select temp___expr_254 temp___256)))) 0) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___expr_254 temp___256))) (distinct 0 0))))))
(assert (forall ((f us_rep2)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant3 f true true true true) (dynamic_invariant4 root true true true true)) (= (valid_root f root) true)) (let ((result (model__ f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields5 (select result root))) true) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields5 (select result root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select result (parent f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select result i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select result i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select result i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select result (parent f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields5 (select result i)))) true) (= (length1 (rec__tree_model__path_type__a (us_split_fields5 (select result i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select result i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select result i))) (rec__tree_model__path_type__a (us_split_fields5 (select result j)))) true)) (= j i))))))))))) (dynamic_invariant5 result true false true true)))) :pattern ((model__ f root))))))
...
(define-fun bool_eq8 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (= (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 a))) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 b)))) (= (bool_eq3 (rec__search_trees__search_tree__struct (us_split_fields7 a)) (rec__search_trees__search_tree__struct (us_split_fields7 b))) true)) (= (bool_eq7 (rec__search_trees__search_tree__values (us_split_fields7 a)) 1 100 (rec__search_trees__search_tree__values (us_split_fields7 b)) 1 100) true)) true false))
...
(assert (forall ((t us_rep5)) (! (=> (and (dynamic_invariant6 t true true true true) (type_invariant1 t)) (dynamic_invariant2 (size1 t) true false true true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep5)) (! (=> (dynamic_invariant6 t true true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))) :pattern ((size1 t)))))
...
(define-fun dynamic_invariant9 ((temp___expr_196 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool) (temp___do_typ_inv_195 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 1)) (in_range7 temp___expr_196)))
(define-fun dynamic_invariant10 ((temp___expr_239 us_rep4) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (= temp___do_toplevel_237 true) (=> (= temp___is_init_235 true) (< (length1 (rec__tree_model__path_type__a (us_split_fields5 temp___expr_239))) 100))))
(define-fun default_initial_assumption5 ((temp___expr_241 us_rep4) (temp___skip_top_level_242 Bool)) Bool (and (= (length1 (rec__tree_model__path_type__a (us_split_fields5 temp___expr_241))) 0) (= (rec__tree_model__path_type__k (us_split_fields5 temp___expr_241)) (distinct 0 0))))
(define-fun dynamic_predicate ((temp___245 us_rep4)) Bool (< (length1 (rec__tree_model__path_type__a (us_split_fields5 temp___245))) 100))
(assert (forall ((a us_rep3) (b us_rep3)) (! (= (user_eq10 a b) (oeq a b)) :pattern ((user_eq10 a b)))))
(define-fun default_initial_assumption6 ((temp___expr_232 us_rep3) (temp___skip_top_level_233 Bool)) Bool (=> (not (= temp___skip_top_level_233 true)) (= (length1 temp___expr_232) 0)))
(assert true)
(assert (forall ((s1 us_rep3) (s2 us_rep3)) (forall ((d Int)) (! (= (= (is_add s1 d s2) true) (and (and (= (- (length1 s2) 1) (length1 s1)) (= (olt s1 s2) true)) (= (get s2 (length1 s2)) d))) :pattern ((is_add s1 d s2))))))
(assert (forall ((f us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant3 f true true true true) (dynamic_invariant4 i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep2)) (forall ((i Int)) (! (=> (and (dynamic_invariant3 f true true true true) (dynamic_invariant4 i true true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant2 result true false true true)))) :pattern ((parent f i))))))
(assert (forall ((f us_rep2)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant3 f true true true true) (dynamic_invariant4 i true true true true)) (not (= (parent f i) 0))) (dynamic_invariant9 (position f i) true false true true)) :pattern ((position f i))))))
...
(define-fun dynamic_invariant11 ((temp___expr_224 Int) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool) (temp___do_typ_inv_223 Bool)) Bool (=> (or (= temp___is_init_220 true) (<= 0 2147483647)) (in_range8 temp___expr_224)))
...
(define-fun dynamic_invariant12 ((temp___expr_217 Int) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool (=> (or (= temp___is_init_213 true) (<= 0 1)) (in_range9 temp___expr_217)))
(assert (forall ((container us_rep3)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant11 position1 true true true true) (and (<= 1 position1) (<= position1 (last container)))) (dynamic_invariant12 (get container position1) true false true true)) :pattern ((get container position1))))))
...
(assert (forall ((left us_rep) (right us_rep)) (forall ((item Int)) (! (=> (dynamic_invariant item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range2 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
(declare-const s us_rep)
(declare-const j Int)
(declare-const search_trees__values__result us_rep)
(declare-const o Bool)
(declare-const o1 Int)
(declare-const temp___671 (Array Int us_rep4))
...
(declare-const search_trees__values__result1 us_rep)
(declare-const search_trees__values__result2 us_rep)
...
(assert (<= 1 j1))
(assert (<= j1 100))
(assert (and (= o1 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range6 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (and (= temp___671 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (and (dynamic_invariant5 temp___671 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 o1))) true) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields5 (select temp___671 o1)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i o1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 i))) true) (not (= i o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___671 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) (rec__tree_model__path_type__a (us_split_fields5 (select temp___671 i)))) true) (= (length1 (rec__tree_model__path_type__a (us_split_fields5 (select temp___671 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 i))) true) (forall ((j4 Int)) (=> (and (<= 1 j4) (<= j4 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___671 j4))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___671 i))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___671 j4)))) true)) (= j4 i))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o2 o3)) (select temp___671 j1)))
(assert (= o2 o4))
(assert (= o3 o5))
(assert (= result2 o5))
(assert (=> (= result2 true) (and (= o (contains s (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j1)))) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range2 e) (= (contains s e) true)) (= e (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j1))))) (= o true))))))
(assert (=> (= result2 true) (= result1 (ite (not (= o true)) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o6 (add s (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j1)))) (and (and (and (= (length o6) (+ (length s) 1)) (= (contains o6 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j1))) true)) (= (ole s o6) true)) (= (included_except o6 s (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j1))) true)))))
(assert (=> (= result1 true) (= o7 o6)))
(assert (=> (= result1 true) (= (mk_value_set__ref result3) (mk_value_set__ref s))))
(assert (=> (= result1 true) (= s2 o7)))
(assert (=> (not (= result1 true)) (= s2 s)))
(assert (=> (not (= result1 true)) (= s2 s1)))
(assert (<= (length s3) j2))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i j2)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true) (= (contains s3 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i))) true)))))
(assert (forall ((v Int)) (=> (and (<= 0 v) (<= v 2147483647)) (=> (= (contains s3 v) true) (exists ((i Int)) (and (and (<= 1 i) (<= i 100)) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) v))))))))
(assert (and (=> (<= 1 100) (in_range6 j2)) (and (<= 1 j2) (<= j2 100))))
(assert (not (= j2 100)))
(assert (= j2 result4))
(assert (= j3 (+ j2 1)))
(assert (and (= o8 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range6 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8) true)))
(check-sat)
(exit)
