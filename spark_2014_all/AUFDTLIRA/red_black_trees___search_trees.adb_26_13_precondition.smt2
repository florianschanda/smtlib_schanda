...
(assert (<= 1 j1))
(assert (<= j1 100))
(assert (and (= o (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range2 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
