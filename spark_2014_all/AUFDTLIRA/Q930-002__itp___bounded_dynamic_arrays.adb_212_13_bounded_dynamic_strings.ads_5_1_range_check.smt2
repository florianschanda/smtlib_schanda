...
(assert (forall ((x natural_index)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_181 us_t) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (=> (not (= temp___skip_constant_179 true)) (dynamic_property 1 2147483647 (first1 temp___expr_181) (last1 temp___expr_181))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true) (let ((result (value this))) (and (and (and (and (= (length result) (length2 this)) (= (first1 result) 1)) (= (last1 result) (length2 this))) (= (< 0 (length2 this)) (not (= (empty this) true)))) (dynamic_invariant1 result true false true)))) :pattern ((value this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true) (= (value this) (let ((temp___234 (let ((temp___232 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) (let ((temp___231 1)) (let ((temp___233 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this)))) (of_array2 (to_array1 temp___233) temp___231 temp___232)))))) (of_array (to_array2 temp___234) (first5 temp___234) (last5 temp___234))))) :pattern ((value this)))))
(declare-const fragment us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const within us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant2 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 2147483647)) (in_range3 temp___expr_195)))
(declare-fun contains__2 (us_rep us_t) Bool)
(declare-fun contains__2__function_guard (Bool us_rep us_t) Bool)
(declare-fun location__2 (us_t us_rep) Int)
(declare-fun location__2__function_guard (Int us_t us_rep) Bool)
(assert (forall ((fragment1 us_t)) (forall ((within1 us_rep)) (! (=> (and (dynamic_invariant1 fragment1 true true true) (dynamic_invariant within1 true true true)) (let ((result (location__2 fragment1 within1))) (and (and (and (<= 0 result) (<= result (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 within1))))) (ite (not (= (contains__2 within1 fragment1) true)) (= result 0) (< 0 result))) (dynamic_invariant2 result true false true)))) :pattern ((location__2 fragment1 within1))))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true) (= (= (empty this) true) (= (length2 this) 0))) :pattern ((empty this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true) (dynamic_invariant2 (length2 this) true false true)) :pattern ((length2 this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true) (= (length2 this) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length2 this)))))
