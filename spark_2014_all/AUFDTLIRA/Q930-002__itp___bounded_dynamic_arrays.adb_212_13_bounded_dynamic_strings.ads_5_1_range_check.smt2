...
(define-fun dynamic_invariant1 ((temp___expr_206 us_t) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (dynamic_property 1 2147483647 (first1 temp___expr_206) (last1 temp___expr_206))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true true) (let ((result (value this))) (and (and (and (and (= (length result) (length2 this)) (= (first1 result) 1)) (= (last1 result) (length2 this))) (= (< 0 (length2 this)) (not (= (empty this) true)))) (dynamic_invariant1 result true false true true)))) :pattern ((value this)))))
...
(assert (forall ((fragment1 us_t)) (forall ((within1 us_rep)) (! (=> (and (dynamic_invariant1 fragment1 true true true true) (dynamic_invariant within1 true true true true)) (let ((result (location__2 fragment1 within1))) (and (and (and (<= 0 result) (<= result (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 within1))))) (ite (not (= (contains__2 within1 fragment1) true)) (= result 0) (< 0 result))) (dynamic_invariant2 result true false true true)))) :pattern ((location__2 fragment1 within1))))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true true) (= (= (empty this) true) (= (length2 this) 0))) :pattern ((empty this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true true) (dynamic_invariant2 (length2 this) true false true true)) :pattern ((length2 this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true true) (= (length2 this) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length2 this)))))
