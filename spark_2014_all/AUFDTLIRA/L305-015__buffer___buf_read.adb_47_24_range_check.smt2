...
(define-fun dynamic_invariant1 ((temp___expr_144 Int) (temp___is_init_141 Bool) (temp___skip_constant_142 Bool) (temp___do_toplevel_143 Bool)) Bool (=> (or (= temp___is_init_141 true) (<= 1 1000)) (in_range2 temp___expr_144)))
...
(define-fun dynamic_invariant2 ((temp___expr_138 Int) (temp___is_init_135 Bool) (temp___skip_constant_136 Bool) (temp___do_toplevel_137 Bool)) Bool (=> (or (= temp___is_init_135 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_138)))
(define-fun dynamic_invariant3 ((temp___expr_150 us_t) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (=> (not (= temp___skip_constant_148 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_150) (last1 temp___expr_150))))
(declare-const c Int)
...
(assert (= (to_rep1 o) 1))
(assert (and (and (and (<= (to_rep1 o) buf_read__read__count) (<= buf_read__read__count (to_rep1 o1))) (forall ((index Int)) (=> (and (<= (to_rep1 o) index) (<= index (- (+ (to_rep1 o) buf_read__read__count) 1))) (= (valid (to_rep (select buf_read__read__b index))) true)))) (in_range3 buf_read__read__count)))
(assert (= (mk_map__ref result1) (mk_map__ref buffer)))
(assert (= buffer1 (slide buf_read__read__b (to_rep1 (first (mk 1 1000))) 1)))
(assert (not (in_range2 buf_read__read__count)))
(check-sat)
(exit)
