...
(declare-fun user_eq4 (set_index set_index) Bool)
(declare-const dummy4 set_index)
...
(declare-const dummy5 (Array Int element_t))
...
(declare-fun user_eq5 ((Array Int element_t) (Array Int element_t)) Bool)
...
(assert true)
(assert (forall ((s us_rep)) (forall ((value Int)) (! (= (= (contains s value) true) (exists ((i Int)) (and (and (<= 1 i) (<= i (members s))) (= (to_rep1 (let ((temp___185 (rec__natural_set__t__m (us_split_fields1 s)))) (select temp___185 i))) value)))) :pattern ((contains s value))))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const value Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const old_length Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(assert (forall ((s us_rep)) (! (let ((result (members s))) (and (and (<= 0 result) (<= result 10)) (dynamic_invariant1 result true false true))) :pattern ((members s)))))
...
(define-fun dynamic_invariant3 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 10)) (in_range2 temp___expr_136)))
(define-fun dynamic_invariant4 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 1 10)) (in_range4 temp___expr_148)))
...
(assert (= result true))
(assert (not (in_range2 (+ (to_rep s__split_fields) 1))))
(check-sat)
(exit)
