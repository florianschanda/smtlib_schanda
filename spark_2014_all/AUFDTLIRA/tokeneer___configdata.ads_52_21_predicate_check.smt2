...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___1507))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___15071))
(assert (not (dynamic_predicate (mk___t1 temp___1507 temp___15071))))
(check-sat)
(exit)
