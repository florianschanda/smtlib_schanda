...
(assert (forall ((temp___177 Int)) (=> (dynamic_invariant temp___177 true true true true) (forall ((temp___178 Int)) (= (to_rep (select (actions__a__aggregate_def temp___177) temp___178)) temp___177)))))
(declare-const x Int)
(declare-const y Int)
