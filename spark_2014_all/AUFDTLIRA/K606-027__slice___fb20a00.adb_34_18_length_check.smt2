...
(assert (not (= (ite (<= (to_rep1 (first temp___2041)) (to_rep1 (last temp___2041))) (+ (- (to_rep1 (last temp___2041)) (to_rep1 (first temp___2041))) 1) 0) (ite (<= (to_rep1 (first (rt str))) (to_rep1 (last (rt str)))) (+ (- (to_rep1 (last (rt str))) (to_rep1 (first (rt str)))) 1) 0))))
(check-sat)
(exit)
