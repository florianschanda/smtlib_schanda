...
(assert (= (= o26 true) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z x)) (not (= z y))) (= (to_rep (select values3 z)) (to_rep (select values z))))))))
(assert (and (<= (to_rep1 values__first) x) (<= x (to_rep1 values__last))))
(assert (= o21 x))
(assert (= o22 (select values o21)))
(assert (= o23 (to_rep o22)))
(assert (and (<= (to_rep1 values__first) y) (<= y (to_rep1 values__last))))
(assert (= o19 y))
(assert (= o20 (select values3 o19)))
(assert (= o24 (to_rep o20)))
