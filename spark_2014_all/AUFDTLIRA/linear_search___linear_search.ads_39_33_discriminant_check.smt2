...
(assert (or (and (and (and (= linear_search__search__result18 linear_search__search__result9) (and (= res__split_discrs14 res__split_discrs7) (and (= res__split_fields14 res__split_fields7) (= pos12 pos6)))) (and (= linear_search__search__result19 linear_search__search__result10) (and (= res__split_discrs15 res__split_discrs8) (and (= res__split_fields15 res__split_fields8) (= pos13 pos7))))) (and (<= pos1 10) (and (and (= res__split_discrs temp___181) (and (= res__split_fields temp___1811) (= res__attr__constrained temp___1812))) (and (= temp___180 pos1) (and (= 0 temp___182) (or (and (and (and (= temp___1826 (mk_int__ref temp___182)) (and (= linear_search__search__result9 (mk_search_result__ref linear_search__search__result4)) (and (= res__split_discrs7 (mk___split_discrs__ref res__split_discrs2)) (and (= res__split_fields7 (mk___split_fields__ref res__split_fields2)) (= pos6 (mk_int__ref pos1)))))) (and (= temp___1827 temp___1821) (and (= linear_search__search__result10 linear_search__search__result4) (and (= res__split_discrs8 res__split_discrs2) (and (= res__split_fields8 res__split_fields2) (= pos7 pos1)))))) (and (and (and (and (and (and (<= 1 pos1) (<= pos1 10)) (= o pos1)) (= o1 (select a o))) (= o2 (to_rep1 o1))) (= result1 (ite (= o2 val__) true false))) (and (= result1 true) (and (and (and (and (and (and (and (and (= o3 pos1) (in_range2 pos1)) (= (to_rep o4) o3)) (= o4 o5)) (and (= (of_int 1) temp___177) (and (= temp___1771 o5) (= true temp___1772)))) (and (=> (= res__attr__constrained true) (= temp___177 res__split_discrs)) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1) usq_2) (mk___rep (mk___split_discrs temp___177) (mk___split_fields temp___1771) temp___1772)))) (and (= usq_ temp___179) (and (= usq_1 temp___1791) (= res__attr__constrained temp___1792)))) (and (and (= result2 (mk___split_fields__ref (mk___split_fields res__split_fields))) (= res__split_fields2 (mk___split_fields temp___1791))) (and (= result3 (mk___split_discrs__ref (mk___split_discrs res__split_discrs))) (= res__split_discrs2 (mk___split_discrs temp___179))))) (and (= result4 (mk_search_result__ref (mk___rep (mk___split_discrs linear_search__search__result) (mk___split_fields linear_search__search__result1) linear_search__search__result2))) (= linear_search__search__result4 (mk___rep res__split_discrs2 res__split_fields2 res__attr__constrained))))))) (and (and (and (and (and (and (and (<= 1 pos1) (<= pos1 10)) (= o pos1)) (= o1 (select a o))) (= o2 (to_rep1 o1))) (= result1 (ite (= o2 val__) true false))) (and (not (= result1 true)) (and (and (= linear_search__search__result4 (mk___rep (mk___split_discrs linear_search__search__result) (mk___split_fields linear_search__search__result1) linear_search__search__result2)) (and (= res__split_discrs2 (mk___split_discrs res__split_discrs)) (= res__split_fields2 (mk___split_fields res__split_fields)))) (and (= linear_search__search__result4 linear_search__search__result3) (and (= res__split_discrs2 res__split_discrs1) (= res__split_fields2 res__split_fields1)))))) (and (and (and (= temp___1826 (mk_int__ref temp___1823)) (and (= linear_search__search__result9 (mk_search_result__ref linear_search__search__result6)) (and (= res__split_discrs7 (mk___split_discrs__ref res__split_discrs4)) (and (= res__split_fields7 (mk___split_fields__ref res__split_fields4)) (= pos6 (mk_int__ref pos3)))))) (and (= temp___1827 temp___1823) (and (= linear_search__search__result10 linear_search__search__result6) (and (= res__split_discrs8 res__split_discrs4) (and (= res__split_fields8 res__split_fields4) (= pos7 pos3)))))) (and (and (and (<= 1 pos2) (<= pos2 10)) (not (= (value_found_in_range a val__ 1 pos2) true))) (and (=> (<= (- 128) 127) (in_range1 pos2)) (and (and (= result5 (mk_int__ref temp___1822)) (= temp___1823 pos2)) (and (and (and (= o7 (+ pos2 1)) (in_range1 (+ pos2 1))) (and (= result6 (mk_int__ref pos2)) (= pos3 o7))) (and (<= pos3 10) (and (and (and (and (and (and (<= 1 pos3) (<= pos3 10)) (= o8 pos3)) (= o9 (select a o8))) (= o10 (to_rep1 o9))) (= result7 (ite (= o10 val__) true false))) (and (= result7 true) (and (and (and (and (and (and (and (and (= o11 pos3) (in_range2 pos3)) (= (to_rep o12) o11)) (= o13 (mk___split_fields o12))) (= temp___1773 (mk___rep (mk___split_discrs (of_int 1)) o13 true))) (and (=> (= res__attr__constrained true) (= (rec__linear_search__search_result__found (us_split_discrs1 temp___1773)) (rec__linear_search__search_result__found res__split_discrs3))) (= usq_3 temp___1773))) (= temp___1793 (mk___rep (us_split_discrs1 usq_3) (us_split_fields1 usq_3) res__attr__constrained))) (and (and (= result8 (mk___split_fields__ref res__split_fields3)) (= res__split_fields4 (us_split_fields1 temp___1793))) (and (= result9 (mk___split_discrs__ref res__split_discrs3)) (= res__split_discrs4 (us_split_discrs1 temp___1793))))) (and (= result10 (mk_search_result__ref linear_search__search__result5)) (= linear_search__search__result6 (mk___rep res__split_discrs4 res__split_fields4 res__attr__constrained))))))))))))))))))) (and (ite (<= pos1 10) (and (and (and (and (= res__split_discrs temp___181) (and (= res__split_fields temp___1811) (= res__attr__constrained temp___1812))) (and (= temp___180 pos1) (and (= 0 temp___182) (and (and (and (and (and (and (and (<= 1 pos1) (<= pos1 10)) (= o pos1)) (= o1 (select a o))) (= o2 (to_rep1 o1))) (= result1 (ite (= o2 val__) true false))) (and (not (= result1 true)) (and (and (= linear_search__search__result4 (mk___rep (mk___split_discrs linear_search__search__result) (mk___split_fields linear_search__search__result1) linear_search__search__result2)) (and (= res__split_discrs2 (mk___split_discrs res__split_discrs)) (= res__split_fields2 (mk___split_fields res__split_fields)))) (and (= linear_search__search__result4 linear_search__search__result3) (and (= res__split_discrs2 res__split_discrs1) (= res__split_fields2 res__split_fields1)))))) (and (and (and (<= 1 pos2) (<= pos2 10)) (not (= (value_found_in_range a val__ 1 pos2) true))) (and (=> (<= (- 128) 127) (in_range1 pos2)) (and (and (= result5 (mk_int__ref temp___1822)) (= temp___1823 pos2)) (and (and (and (= o7 (+ pos2 1)) (in_range1 (+ pos2 1))) (and (= result6 (mk_int__ref pos2)) (= pos3 o7))) (not (<= pos3 10)))))))))) (and (and (= linear_search__search__result11 (mk_search_result__ref linear_search__search__result5)) (and (= res__split_discrs9 (mk___split_discrs__ref res__split_discrs3)) (and (= res__split_fields9 (mk___split_fields__ref res__split_fields3)) (= pos8 (mk_int__ref pos3))))) (and (= linear_search__search__result12 linear_search__search__result5) (and (= res__split_discrs10 res__split_discrs3) (and (= res__split_fields10 res__split_fields3) (= pos9 pos3)))))) (and (and (= linear_search__search__result13 linear_search__search__result11) (and (= res__split_discrs11 res__split_discrs9) (and (= res__split_fields11 res__split_fields9) (= pos10 pos8)))) (and (= linear_search__search__result14 linear_search__search__result12) (and (= res__split_discrs12 res__split_discrs10) (and (= res__split_fields12 res__split_fields10) (= pos11 pos9)))))) (and (and (= linear_search__search__result13 (mk_search_result__ref (mk___rep (mk___split_discrs linear_search__search__result) (mk___split_fields linear_search__search__result1) linear_search__search__result2))) (and (= res__split_discrs11 (mk___split_discrs__ref (mk___split_discrs res__split_discrs))) (and (= res__split_fields11 (mk___split_fields__ref (mk___split_fields res__split_fields))) (= pos10 (mk_int__ref pos1))))) (and (= linear_search__search__result14 linear_search__search__result3) (and (= res__split_discrs12 res__split_discrs1) (and (= res__split_fields12 res__split_fields1) (= pos11 pos1)))))) (and (and (and (= linear_search__search__result18 linear_search__search__result16) (and (= res__split_discrs14 (mk___split_discrs__ref res__split_discrs13)) (and (= res__split_fields14 (mk___split_fields__ref res__split_fields13)) (= pos12 pos10)))) (and (= linear_search__search__result19 linear_search__search__result17) (and (= res__split_discrs15 res__split_discrs13) (and (= res__split_fields15 res__split_fields13) (= pos13 pos11))))) (and (and (and (and (=> (= res__attr__constrained true) (= (of_int 0) (rec__linear_search__search_result__found (us_split_discrs__content res__split_discrs11)))) (= usq_4 (mk___rep (mk___split_discrs (of_int 0)) (mk___split_fields dummy1) true))) (= temp___185 (mk___rep (us_split_discrs1 usq_4) (us_split_fields1 usq_4) res__attr__constrained))) (and (and (= result11 res__split_fields11) (= res__split_fields13 (us_split_fields1 temp___185))) (and (= result12 res__split_discrs11) (= res__split_discrs13 (us_split_discrs1 temp___185))))) (and (and (= linear_search__search__result16 (mk_search_result__ref linear_search__search__result15)) (= linear_search__search__result17 linear_search__search__result15)) (and (= result13 linear_search__search__result13) (= linear_search__search__result15 (mk___rep res__split_discrs13 res__split_fields13 res__attr__constrained)))))))))
(assert (= linear_search__search__result20 linear_search__search__result18))
(assert (= res__split_discrs16 res__split_discrs14))
(assert (= res__split_fields16 res__split_fields14))
(assert (= pos14 pos12))
(assert (= linear_search__search__result21 linear_search__search__result19))
(assert (= res__split_discrs17 res__split_discrs15))
(assert (= res__split_fields17 res__split_fields15))
(assert (= pos15 pos13))
(assert (= (rec__linear_search__search_result__found (us_split_discrs1 (search_result__content linear_search__search__result20))) true))
(assert (not (= (to_int1 (rec__linear_search__search_result__found (us_split_discrs1 (search_result__content linear_search__search__result20)))) 1)))
(check-sat)
(exit)
