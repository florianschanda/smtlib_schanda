...
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 i))) o17))
(assert (= o16 o18))
(assert (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a2 i))) o19))
(assert (= o20 o17))
(assert (= o21 o18))
(assert (= o22 o19))
...
(assert (= a3 o23))
(assert (= a3 result3))
(assert (= a4 (store a3 i (mk___rep (mk___split_fields (of_int 0) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a3 i))) (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a3 i))))))))
(assert (= (to_rep (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a4 i)))) 69))
(assert (= a4 a5))
(assert (= a6 a4))
