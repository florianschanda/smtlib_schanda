...
(assert (= result1 (mk___split_fields__ref2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))))
...
(assert (=> (not (= v1 0)) (=> (= d 0) (= temp___708 o11))))
(assert (=> (not (= v1 0)) (=> (= d 0) (= temp___7081 o12))))
(assert (=> (not (= v1 0)) (=> (= d 0) (= result3 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1))))))
(assert (=> (not (= v1 0)) (=> (= d 0) (= f__split_fields3 (mk___split_fields2 temp___708 temp___7081)))))
...
(assert (=> (not (= v1 0)) (=> (not (= d 0)) (= temp___703 o23))))
(assert (=> (not (= v1 0)) (=> (not (= d 0)) (= temp___7031 o24))))
(assert (=> (not (= v1 0)) (=> (not (= d 0)) (= result4 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1))))))
(assert (=> (not (= v1 0)) (=> (not (= d 0)) (= f__split_fields4 (mk___split_fields2 temp___703 temp___7031)))))
...
(assert (=> (not (= v1 0)) (= temp___715 (mk___rep2 (mk___split_fields2 o36 o37)))))
(assert (=> (not (= v1 0)) (= result5 (mk___split_fields__ref2 f__split_fields3))))
(assert (=> (not (= v1 0)) (= f__split_fields5 (us_split_fields5 temp___715))))
...
(assert (=> (not (= v1 0)) (= temp___720 (mk___rep2 o43))))
(assert (=> (not (= v1 0)) (= result6 (mk___split_fields__ref2 f__split_fields5))))
(assert (=> (not (= v1 0)) (= f__split_fields6 (us_split_fields5 temp___720))))
(assert (=> (= v1 0) (= f__split_fields6 (mk___split_fields2 f__split_fields f__split_fields1))))
(assert (=> (= v1 0) (= f__split_fields6 f__split_fields2)))
(assert (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i8)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i8)))) 0)) (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i8)))))))) i8)))))
(declare-const i8 Int)
(assert (<= 1 i8))
(assert (<= i8 100))
(assert (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i8)))) 0)))
(assert (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i8)))) 1))
(assert (not (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i8)))))))) i8)))
(check-sat)
(exit)
