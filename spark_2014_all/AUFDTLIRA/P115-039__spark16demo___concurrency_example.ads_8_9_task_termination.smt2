...
(assert (forall ((temp___222 Int)) (=> (dynamic_invariant temp___222 true true true true) (forall ((temp___223 Int)) (= (to_rep (select (concurrency_example__all_zeroes__aggregate_def temp___222) temp___223)) temp___222)))))
(assert (= all_ones (concurrency_example__all_ones__aggregate_def (- 2147483648))))
(assert (forall ((temp___225 Int)) (=> (dynamic_invariant temp___225 true true true true) (forall ((temp___226 Int)) (= (to_rep (select (concurrency_example__all_ones__aggregate_def temp___225) temp___226)) temp___225)))))
(assert (not true))
(check-sat)
(exit)
