...
(declare-const temp___2743 map__ref)
(declare-const e7 Int)
(declare-const temp___2744 (Array Int natural))
(declare-const e8 int__ref)
(declare-const temp___2745 map__ref)
(declare-const e9 Int)
(declare-const temp___2746 (Array Int natural))
...
(assert (=> (= result4 true) (= temp___2743 (mk_map__ref temp___2742))))
(assert (=> (= result4 true) (= e6 (mk_int__ref e5))))
(assert (=> (= result4 true) (= temp___2744 temp___2742)))
(assert (=> (= result4 true) (= e7 e5)))
(assert (=> (= result4 true) (= temp___2745 temp___2743)))
(assert (=> (= result4 true) (= e8 e6)))
(assert (=> (= result4 true) (= temp___2746 temp___2744)))
(assert (=> (= result4 true) (= e9 e7)))
(assert (=> (not (= result4 true)) (= temp___2745 (mk_map__ref temp___274))))
(assert (=> (not (= result4 true)) (= e8 (mk_int__ref e4))))
(assert (=> (not (= result4 true)) (= temp___2746 temp___2741)))
(assert (=> (not (= result4 true)) (= e9 e4)))
(assert (and (= (mk___rep1 (mk___split_fields1 o10)) (first__2 (mk___rep2 c2__split_fields2))) (= (of_rep 1) o10)))
(assert (= temp___277 o10))
(assert (and (= result6 (has_element__2 (mk___rep2 c2__split_fields2) (mk___rep1 (mk___split_fields1 temp___277)))) (= (= result6 true) (and (<= 1 (to_rep temp___277)) (<= (to_rep temp___277) (to_rep (rec__composite_cursors__cont2__length c2__split_fields2)))))))
(assert (=> (= result6 true) (and (= o11 (element__2 (mk___rep2 c2__split_fields2) (mk___rep1 (mk___split_fields1 temp___277)))) (and (in_range1 o11) (= o11 (to_rep (select (rec__composite_cursors__cont2__content c2__split_fields2) (to_rep temp___277))))))))
(assert (=> (= result6 true) (= result7 e14)))
(assert (=> (= result6 true) (= e10 o11)))
