...
(assert (=> (not (or (= mode 0) (= mode 2))) (= right_is_out12 (of_int 1))))
...
(assert (=> (or (= mode 1) (= mode 2)) (and (= o7 value) (not (= value (- 2147483648))))))
...
(assert (=> (or (= mode 1) (= mode 2)) (= left_is_out1 (ite (< left2 0) true false))))
(assert (=> (or (= mode 1) (= mode 2)) (or (and (and (and (= left_is_out6 (mk_bool__ref left_is_out1)) (= left5 (mk_int__ref left2))) (and (= left_is_out7 left_is_out1) (= left6 left2))) (and (ite (= left_is_out1 true) (= result12 true) (and (and (and (<= 0 left2) (<= left2 100000)) (= o9 left2)) (= result12 (select number_list o9)))) (= result12 true))) (and (and (ite (= left_is_out1 true) (= result12 true) (and (and (and (<= 0 left2) (<= left2 100000)) (= o9 left2)) (= result12 (select number_list o9)))) (not (= result12 true))) (and (and (and (= left_is_out6 left_is_out4) (= left5 (mk_int__ref left4))) (and (= left_is_out7 left_is_out5) (= left6 left4))) (and (and (and (<= 0 left3) (<= left3 (- value 1))) (forall ((v Int)) (=> (and (<= left3 v) (<= v value)) (not (= (select number_list v) true))))) (and (=> (<= (- 2147483648) 2147483647) (in_range1 left3)) (and (and (and (and (= o10 left3) (not (= left3 (- 2147483648)))) (= o11 (- o10 1))) (and (= result13 (mk_int__ref left3)) (= left4 o11))) (and (and (= left_is_out4 (mk_bool__ref left_is_out3)) (= left_is_out5 left_is_out3)) (and (and (= result14 (mk_bool__ref left_is_out2)) (= left_is_out3 (ite (< left4 0) true false))) (and (ite (= left_is_out3 true) (= result15 true) (and (and (and (<= 0 left4) (<= left4 100000)) (= o12 left4)) (= result15 (select number_list o12)))) (= result15 true))))))))))))
...
(assert (=> (not (or (= mode 1) (= mode 2))) (= left_is_out13 (mk_bool__ref left_is_out12))))
(assert (=> (not (or (= mode 1) (= mode 2))) (= left11 (mk_int__ref left1))))
(assert (=> (not (or (= mode 1) (= mode 2))) (= left_is_out14 left_is_out12)))
...
(assert (and (= o13 (- (int__content right11) value)) (in_range1 (- (int__content right11) value))))
(assert (= o14 (abs o13)))
