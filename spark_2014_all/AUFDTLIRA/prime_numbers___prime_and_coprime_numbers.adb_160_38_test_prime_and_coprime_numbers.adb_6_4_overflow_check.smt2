...
(assert (=> (or (= mode 0) (= mode 2)) (= (mk_bool__ref result5) (mk_bool__ref right_is_out))))
(assert (=> (or (= mode 0) (= mode 2)) (= right_is_out2 (ite (< 100000 right2) true false))))
(assert (=> (or (= mode 0) (= mode 2)) (or (and (and (and (= right_is_out2 right_is_out7) (= right2 right5)) (and (= right_is_out8 right_is_out2) (= right6 right2))) (and (ite (= right_is_out2 true) (= result6 true) (and (and (and (<= 0 right2) (<= right2 100000)) (= o3 right2)) (= result6 (select number_list o3)))) (= result6 true))) (and (and (ite (= right_is_out2 true) (= result6 true) (and (and (and (<= 0 right2) (<= right2 100000)) (= o3 right2)) (= result6 (select number_list o3)))) (not (= result6 true))) (and (and (and (= (mk_bool__ref right_is_out7) (mk_bool__ref right_is_out5)) (= right4 right5)) (and (= right_is_out8 right_is_out6) (= right6 right4))) (and (and (and (<= (+ value 1) right3) (<= right3 100000)) (forall ((v6 Int)) (=> (and (<= value v6) (<= v6 right3)) (not (= (select number_list v6) true))))) (and (=> (<= (- 2147483648) 2147483647) (in_range1 right3)) (and (and (and (and (= o5 right3) (not (= right3 2147483647))) (= o6 (+ o5 1))) (and (= right3 result7) (= right4 o6))) (and (and (= right_is_out4 right_is_out5) (= right_is_out6 right_is_out4)) (and (and (= right_is_out3 result8) (= right_is_out4 (ite (< 100000 right4) true false))) (and (ite (= right_is_out4 true) (= result9 true) (and (and (and (<= 0 right4) (<= right4 100000)) (= o7 right4)) (= result9 (select number_list o7)))) (= result9 true))))))))))))
(assert (=> (or (= mode 0) (= mode 2)) (= (mk_bool__ref right_is_out9) (mk_bool__ref right_is_out7))))
(assert (=> (or (= mode 0) (= mode 2)) (= (mk_int__ref right7) (mk_int__ref right5))))
(assert (=> (or (= mode 0) (= mode 2)) (= right_is_out10 right_is_out8)))
(assert (=> (or (= mode 0) (= mode 2)) (= right8 right6)))
(assert (=> (or (= mode 0) (= mode 2)) (= (mk_bool__ref right_is_out11) (mk_bool__ref right_is_out9))))
(assert (=> (or (= mode 0) (= mode 2)) (= (mk_int__ref right9) (mk_int__ref right7))))
(assert (=> (or (= mode 0) (= mode 2)) (= right_is_out12 right_is_out10)))
(assert (=> (or (= mode 0) (= mode 2)) (= right10 right8)))
(assert (=> (or (= mode 0) (= mode 2)) (= right_is_out14 (mk_bool__ref right_is_out11))))
(assert (=> (or (= mode 0) (= mode 2)) (= right11 (mk_int__ref right9))))
(assert (=> (or (= mode 0) (= mode 2)) (= right_is_out15 right_is_out12)))
(assert (=> (or (= mode 0) (= mode 2)) (= right12 right10)))
(assert (=> (not (or (= mode 0) (= mode 2))) (= result10 (mk_bool__ref right_is_out))))
(assert (=> (not (or (= mode 0) (= mode 2))) (= right_is_out13 (of_int 1))))
(assert (=> (not (or (= mode 0) (= mode 2))) (= right_is_out14 (mk_bool__ref right_is_out13))))
(assert (=> (not (or (= mode 0) (= mode 2))) (= right11 (mk_int__ref right1))))
(assert (=> (not (or (= mode 0) (= mode 2))) (= right_is_out15 right_is_out13)))
(assert (=> (not (or (= mode 0) (= mode 2))) (= right12 right1)))
(assert (=> (or (= mode 1) (= mode 2)) (and (= o8 value) (not (= value (- 2147483648))))))
(assert (=> (or (= mode 1) (= mode 2)) (= o9 (- o8 1))))
(assert (=> (or (= mode 1) (= mode 2)) (= result11 (mk_int__ref left1))))
(assert (=> (or (= mode 1) (= mode 2)) (= left2 o9)))
(assert (=> (or (= mode 1) (= mode 2)) (= temp___238 left_is_out)))
(assert (=> (or (= mode 1) (= mode 2)) (= temp___237 left2)))
(assert (=> (or (= mode 1) (= mode 2)) (= result12 (mk_bool__ref left_is_out))))
(assert (=> (or (= mode 1) (= mode 2)) (= left_is_out2 (ite (< left2 0) true false))))
(assert (=> (or (= mode 1) (= mode 2)) (or (and (and (and (= left_is_out9 (mk_bool__ref left_is_out2)) (= left7 (mk_int__ref left2))) (and (= left_is_out10 left_is_out2) (= left8 left2))) (and (ite (= left_is_out2 true) (= result13 true) (and (and (and (<= 0 left2) (<= left2 100000)) (= o10 left2)) (= result13 (select number_list o10)))) (= result13 true))) (and (and (ite (= left_is_out2 true) (= result13 true) (and (and (and (<= 0 left2) (<= left2 100000)) (= o10 left2)) (= result13 (select number_list o10)))) (not (= result13 true))) (and (and (and (= left_is_out9 left_is_out5) (= left7 (mk_int__ref left4))) (and (= left_is_out10 left_is_out6) (= left8 left4))) (and (and (and (<= 0 left3) (<= left3 (- value 1))) (forall ((v6 Int)) (=> (and (<= left3 v6) (<= v6 value)) (not (= (select number_list v6) true))))) (and (=> (<= (- 2147483648) 2147483647) (in_range1 left3)) (and (and (and (and (= o11 left3) (not (= left3 (- 2147483648)))) (= o12 (- o11 1))) (and (= result14 (mk_int__ref left3)) (= left4 o12))) (and (and (= left_is_out5 (mk_bool__ref left_is_out4)) (= left_is_out6 left_is_out4)) (and (and (= result15 (mk_bool__ref left_is_out3)) (= left_is_out4 (ite (< left4 0) true false))) (and (ite (= left_is_out4 true) (= result16 true) (and (and (and (<= 0 left4) (<= left4 100000)) (= o13 left4)) (= result16 (select number_list o13)))) (= result16 true))))))))))))
(assert (=> (or (= mode 1) (= mode 2)) (= left_is_out11 left_is_out9)))
(assert (=> (or (= mode 1) (= mode 2)) (= left9 left7)))
(assert (=> (or (= mode 1) (= mode 2)) (= left_is_out12 left_is_out10)))
(assert (=> (or (= mode 1) (= mode 2)) (= left10 left8)))
(assert (=> (or (= mode 1) (= mode 2)) (= left_is_out13 left_is_out11)))
(assert (=> (or (= mode 1) (= mode 2)) (= left11 left9)))
(assert (=> (or (= mode 1) (= mode 2)) (= left_is_out14 left_is_out12)))
(assert (=> (or (= mode 1) (= mode 2)) (= left12 left10)))
(assert (=> (or (= mode 1) (= mode 2)) (= left_is_out16 left_is_out13)))
(assert (=> (or (= mode 1) (= mode 2)) (= left13 left11)))
(assert (=> (or (= mode 1) (= mode 2)) (= left_is_out17 left_is_out14)))
(assert (=> (or (= mode 1) (= mode 2)) (= left14 left12)))
(assert (=> (not (or (= mode 1) (= mode 2))) (= result17 (mk_bool__ref left_is_out))))
(assert (=> (not (or (= mode 1) (= mode 2))) (= left_is_out15 (of_int 1))))
(assert (=> (not (or (= mode 1) (= mode 2))) (= left_is_out16 (mk_bool__ref left_is_out15))))
(assert (=> (not (or (= mode 1) (= mode 2))) (= left13 (mk_int__ref left1))))
(assert (=> (not (or (= mode 1) (= mode 2))) (= left_is_out17 left_is_out15)))
(assert (=> (not (or (= mode 1) (= mode 2))) (= left14 left1)))
(assert (not (= (bool__content right_is_out14) true)))
(assert (not (= (bool__content left_is_out16) true)))
(assert (and (= o16 (- (int__content right11) value)) (in_range1 (- (int__content right11) value))))
(assert (= o17 (abs o16)))
