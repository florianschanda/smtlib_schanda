...
(declare-const temp___724 (Array Int cardindex))
...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o115 i1))
(assert (= temp___724 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o115)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o116 k))
(assert (= o117 (select temp___724 o116)))
