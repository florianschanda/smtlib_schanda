...
(assert (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c9) true))
(assert (not (= (key (mk___rep d__split_discrs d__split_fields1) c9) (to_rep (select a1 i)))))
(assert (not (= (key (mk___rep d__split_discrs d__split_fields1) c9) (to_rep (select a1 j)))))
(assert (not (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields1) c9))) (key (mk___rep d__split_discrs d__split_fields1) c9))))
(check-sat)
(exit)
