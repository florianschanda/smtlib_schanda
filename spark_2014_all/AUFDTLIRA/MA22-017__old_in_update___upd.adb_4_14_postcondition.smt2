...
(declare-fun temp_____aggregate_def_207 ((Array Int Bool) Bool Bool) (Array Int Bool))
(assert (forall ((temp___209 (Array Int Bool))) (forall ((temp___210 Bool) (temp___211 Bool)) (let ((temp___208 (temp_____aggregate_def_207 temp___209 temp___210 temp___211))) (forall ((temp___212 Int)) (ite (= temp___212 (ite temp___210 1 0)) (= (select temp___208 temp___212) temp___211) (= (select temp___208 temp___212) (select temp___209 temp___212))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq a2 0 1 (temp_____aggregate_def_207 a2 b (ite (= (select a (ite b 1 0)) false) true false)) 0 1) true)))
(check-sat)
(exit)
