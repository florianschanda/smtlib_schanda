...
(declare-fun temp___178 ((Array Int Bool) Bool Bool) (Array Int Bool))
(assert (forall ((temp___180 (Array Int Bool))) (forall ((temp___181 Bool) (temp___182 Bool)) (let ((temp___179 (temp___178 temp___180 temp___181 temp___182))) (forall ((temp___183 Int)) (ite (= temp___183 (to_int1 temp___181)) (= (select temp___179 temp___183) temp___182) (= (select temp___179 temp___183) (select temp___180 temp___183))))))))
...
(assert (= result a))
(assert (= a1 (store a (to_int1 b) (ite (not (= (select a (to_int1 b)) true)) true false))))
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq a2 0 1 (temp___178 a2 b (ite (= (select a (to_int1 b)) false) true false)) 0 1) true)))
(check-sat)
(exit)
