...
(assert (= (is_perm (remove (remove a ia1) (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))) (remove (remove b ib1) (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) true))
