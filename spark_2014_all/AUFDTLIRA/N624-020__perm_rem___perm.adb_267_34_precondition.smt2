...
(assert (= (is_perm (remove (remove a ia3) (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))) (remove (remove b ib9) (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) true))
(assert (and (= o96 (remove b ib9)) (and (dynamic_invariant2 o96 true false true) (and (= (invariant__ o96) true) (and (= (to_rep2 (last (rt o96))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- ib9 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o96) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ ib9 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o96) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= ib9 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o96) k1))))))))))))
(assert (and (= o94 ia3) (in_range4 ia3)))
