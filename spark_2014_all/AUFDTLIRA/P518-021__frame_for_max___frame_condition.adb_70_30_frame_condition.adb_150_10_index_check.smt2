...
(declare-const temp___298 (Array Int us_rep))
(declare-const o Int)
...
(assert (= temp___301 c267b))
(assert (= temp___304 a))
(assert (= temp___300 k1))
(assert (= temp___298 a))
...
(assert (and (forall ((i6 Int)) (=> (and (<= first3 i6) (<= i6 k2)) (forall ((j4 Int)) (=> (and (<= i6 j4) (<= j4 k2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i6)))) (get_max_right j4 a2)))))) (forall ((i6 Int)) (=> (and (<= k2 i6) (<= i6 first3)) (forall ((j4 Int)) (=> (and (<= i6 j4) (<= j4 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 j4)))) (get_max_right i6 a2))))))))
(assert (= (frame_right (mk___t temp___304 (mk (to_rep1 a__first) (to_rep1 a__last))) a2) true))
(assert (and (and (and (and (forall ((temp___299 Int)) (=> (and (<= (to_rep1 a__first) temp___299) (<= temp___299 (to_rep1 a__last))) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a2 temp___299))) (rec__frame_condition__cell__value (us_split_fields1 (select temp___298 temp___299)))) (= (rec__frame_condition__cell__max_left (us_split_fields1 (select a2 temp___299))) (rec__frame_condition__cell__max_left (us_split_fields1 (select temp___298 temp___299))))))) (=> (<= 1 2147483647) (in_range2 k2))) (=> (<= 1 2147483647) (in_range2 c267b2))) (=> (<= 0 2147483647) (in_range1 max3))) (=> (<= 0 2147483647) (in_range1 c268b2))))
(assert (= k4 (mk_int__ref k2)))
(assert (= k5 k2))
(assert (= k2 last3))
(assert (= c268b4 (mk_int__ref c268b2)))
(assert (= c267b4 (mk_int__ref c267b2)))
(assert (= max5 (mk_int__ref max3)))
(assert (= k6 k4))
(assert (= a4 (mk_map__ref a2)))
(assert (= c268b5 c268b2))
(assert (= c267b5 c267b2))
(assert (= max6 max3))
(assert (= k7 k5))
(assert (= a5 a2))
...
(assert (= k10 k8))
(assert (= a8 a6))
(assert (= c268b9 c268b7))
(assert (= c267b9 c267b7))
(assert (= max10 max8))
(assert (= k11 k9))
(assert (= a9 a7))
(assert (and (= o64 (frame_right (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) (map__content a8))) (= (= o64 true) (forall ((i6 Int)) (=> (and (<= (to_rep1 a__first) i6) (<= i6 (to_rep1 a__last))) (and (= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a8) i6)))) (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a i6))))) (= (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a8) i6)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a i6)))))))))))
(assert (= (= o63 true) (forall ((i6 Int)) (=> (and (<= last3 i6) (<= i6 first3)) (forall ((j4 Int)) (=> (and (<= i6 j4) (<= j4 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a8) j4)))) (get_max_right i6 (map__content a8)))))))))
(assert (<= first3 i4))
(assert (<= i4 last3))
(assert (<= i4 j2))
(assert (<= j2 last3))
(assert (and (= o59 j2) (in_range2 j2)))
(assert (and (= o60 (get_max_right o59 (map__content a8))) (and (in_range1 o60) (= o60 (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select (map__content a8) o59))))))))
(assert (not (<= (to_rep1 a__first) i4)))
(check-sat)
(exit)
