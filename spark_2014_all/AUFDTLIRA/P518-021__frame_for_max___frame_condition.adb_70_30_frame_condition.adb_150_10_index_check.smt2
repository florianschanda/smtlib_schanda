...
(declare-const temp___326 (Array Int us_rep))
(declare-const o Int)
...
(assert (= temp___331 c268b))
(assert (= temp___330 max1))
(assert (= temp___329 c267b))
(assert (= temp___332 a))
(assert (= temp___328 k1))
(assert (= temp___326 a))
