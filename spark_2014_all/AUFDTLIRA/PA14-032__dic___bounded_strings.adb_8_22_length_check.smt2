...
(assert (not (= (ite (<= (to_rep3 (first8 temp___2001)) (to_rep3 (last8 temp___2001))) (+ (- (to_rep3 (last8 temp___2001)) (to_rep3 (first8 temp___2001))) 1) 0) (ite (<= 1 upper_bound) (+ (- upper_bound 1) 1) 0))))
(check-sat)
(exit)
