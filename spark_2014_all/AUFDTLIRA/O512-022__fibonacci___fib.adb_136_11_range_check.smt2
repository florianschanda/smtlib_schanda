...
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= temp___200 a16)))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (and (forall ((temp___201 Int)) (=> (and (<= 0 temp___201) (<= temp___201 100)) (=> (<= i9 temp___201) (= (select a18 temp___201) (select temp___200 temp___201))))) (and (<= (+ k1 1) i9) (<= i9 0)))))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (and (= temp___199 (- i9 k1)) (in_range1 (- i9 k1)))))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (and (<= 0 temp___199) (<= temp___199 100))))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= o6 temp___199)))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= o7 (select c1 o6))))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= o8 (to_rep o7))))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= (to_rep o9) o8)))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (and (<= 0 i9) (<= i9 100))))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= o10 i9)))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= o11 (store a18 o10 o9))))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= a18 result3)))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= a19 o11)))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= i9 0)))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= i9 i10)))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= a19 a110)))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= i11 i9)))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= a111 a19)))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= i12 (mk_int__ref i10))))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= a114 (mk_map__ref a110))))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= i13 i11)))
(assert (=> (and (<= temp___202 i8) (<= i8 0)) (= a113 a111)))
(assert (=> (not (and (<= temp___202 i8) (<= i8 0))) (= i12 (mk_int__ref i8))))
(assert (=> (not (and (<= temp___202 i8) (<= i8 0))) (= a114 a115)))
(assert (=> (not (and (<= temp___202 i8) (<= i8 0))) (= i13 i8)))
(assert (=> (not (and (<= temp___202 i8) (<= i8 0))) (= a113 a17)))
(assert (<= 0 k2))
(assert (not (<= 0 0)))
(check-sat)
(exit)
