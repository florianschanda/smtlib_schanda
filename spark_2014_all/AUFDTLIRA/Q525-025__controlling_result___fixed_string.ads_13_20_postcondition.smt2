...
(declare-const temp___215 natural)
(declare-const temp___2151 (Array Int character))
(declare-const temp___2152 us_private)
...
(assert (and (= this__attr__tag us_tag) (and (= (to_rep2 this__split_fields) 0) (= this__split_fields1 (temp___139 0)))))
