...
(define-fun dynamic_invariant1 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 0 100)) (in_range4 temp___expr_572)))
...
(define-fun dynamic_invariant2 ((temp___expr_584 us_t) (temp___is_init_581 Bool) (temp___skip_constant_582 Bool) (temp___do_toplevel_583 Bool)) Bool (=> (not (= temp___skip_constant_582 true)) (dynamic_property 0 255 (first1 temp___expr_584) (last1 temp___expr_584))))
...
(define-fun dynamic_invariant5 ((temp___expr_561 Int) (temp___is_init_558 Bool) (temp___skip_constant_559 Bool) (temp___do_toplevel_560 Bool)) Bool (=> (or (= temp___is_init_558 true) (<= 0 100)) (in_range3 temp___expr_561)))
