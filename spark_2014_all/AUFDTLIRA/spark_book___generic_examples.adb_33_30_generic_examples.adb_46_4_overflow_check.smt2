...
(define-fun dynamic_invariant1 ((temp___expr_645 Int) (temp___is_init_641 Bool) (temp___skip_constant_642 Bool) (temp___do_toplevel_643 Bool) (temp___do_typ_inv_644 Bool)) Bool (=> (or (= temp___is_init_641 true) (<= 0 100)) (in_range4 temp___expr_645)))
...
(define-fun dynamic_invariant2 ((temp___expr_659 us_t) (temp___is_init_655 Bool) (temp___skip_constant_656 Bool) (temp___do_toplevel_657 Bool) (temp___do_typ_inv_658 Bool)) Bool (=> (not (= temp___skip_constant_656 true)) (dynamic_property 0 255 (first1 temp___expr_659) (last1 temp___expr_659))))
...
(define-fun dynamic_invariant5 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 0 100)) (in_range3 temp___expr_632)))
