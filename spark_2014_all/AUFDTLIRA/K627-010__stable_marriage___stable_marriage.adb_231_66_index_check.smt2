...
(assert (= result true))
(assert (= (= o7 true) (forall ((g1_id1 Int)) (=> (and (<= 1 g1_id1) (<= g1_id1 64)) (=> (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx (to_rep3 unmatched_g1_set__split_fields1))) (not (= (to_rep (select unmatched_g1_set__split_fields idx)) g1_id1)))) (and (< 0 (to_rep3 (select proposals_made g1_id1))) (= (to_rep (select result__ (to_rep1 (select (select ranking_1 g1_id1) (to_rep3 (select proposals_made g1_id1)))))) g1_id1)))))))
(assert (= (= o6 true) (forall ((g1_id1 Int)) (=> (and (<= 1 g1_id1) (<= g1_id1 64)) (=> (= (to_rep3 (select proposals_made g1_id1)) 0) (exists ((idx Int)) (and (and (<= 1 idx) (<= idx (to_rep3 unmatched_g1_set__split_fields1))) (= (to_rep (select unmatched_g1_set__split_fields idx)) g1_id1))))))))
(assert (<= 1 g1_id))
(assert (<= g1_id 64))
(assert (<= 1 rank))
