...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE x))) temp___298))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE x)))))) temp___2981))
(assert (not (dynamic_predicate (mk___t1 temp___298 temp___2981))))
(check-sat)
(exit)
