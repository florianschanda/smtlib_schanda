...
(assert (=> (= (length (mk___t temp___1526 temp___15261)) 0) (= (temp___String_Literal_1525 Tuple0) bio__makedescription__setresultstring__fullstring__assume)))
(assert (=> (= (length (mk___t temp___1526 temp___15261)) 0) (= (mk 1 2) bio__makedescription__setresultstring__fullstring__assume1)))
(assert (=> (not (= (length (mk___t temp___1526 temp___15261)) 0)) (=> (<= 1 2) (= o24 (+ (- 2 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1526 temp___15261)) 0)) (=> (not (<= 1 2)) (= o24 0))))
(assert (=> (not (= (length (mk___t temp___1526 temp___15261)) 0)) (=> (<= (to_rep1 (first temp___15261)) (to_rep1 (last temp___15261))) (= o25 (+ (- (to_rep1 (last temp___15261)) (to_rep1 (first temp___15261))) 1)))))
(assert (=> (not (= (length (mk___t temp___1526 temp___15261)) 0)) (=> (not (<= (to_rep1 (first temp___15261)) (to_rep1 (last temp___15261)))) (= o25 0))))
(assert (=> (not (= (length (mk___t temp___1526 temp___15261)) 0)) (= o26 (+ o25 o24))))
(assert (=> (not (= (length (mk___t temp___1526 temp___15261)) 0)) (= o27 (+ (to_rep1 (first temp___15261)) o26))))
(assert (=> (not (= (length (mk___t temp___1526 temp___15261)) 0)) (= o28 (- o27 1))))
(assert (=> (not (= (length (mk___t temp___1526 temp___15261)) 0)) (and (= o29 o28) (in_range2 o28))))
(assert (=> (not (= (length (mk___t temp___1526 temp___15261)) 0)) (= (concat1 temp___1526 (to_rep1 (first temp___15261)) (to_rep1 (last temp___15261)) (temp___String_Literal_1525 Tuple0) 1 2) bio__makedescription__setresultstring__fullstring__assume)))
(assert (=> (not (= (length (mk___t temp___1526 temp___15261)) 0)) (= (mk (to_rep1 (first temp___15261)) o29) bio__makedescription__setresultstring__fullstring__assume1)))
