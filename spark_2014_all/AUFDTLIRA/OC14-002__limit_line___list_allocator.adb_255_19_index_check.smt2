...
(assert (=> (< 1 j3) (and (= o83 (- j3 1)) (in_range2 (- j3 1)))))
(assert (=> (< 1 j3) (and (= o84 (get (rec__list_allocator__m__t__available model____split_fields4) o83)) (in_range7 o84))))
(assert (=> (not (< 1 j3)) (= o84 0)))
(assert (and (= temp___428 (get (rec__list_allocator__m__t__available model____split_fields4) j3)) (in_range7 temp___428)))
