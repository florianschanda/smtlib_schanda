...
(assert (forall ((stack__my_stack__fields us_split_fields)) (! (dynamic_invariant (count stack__my_stack__fields) true false true) :pattern ((count stack__my_stack__fields)))))
