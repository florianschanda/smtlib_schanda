...
(assert (< (to_rep1 (select (select ranking_2_inverted g21) g11)) (to_rep1 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))))
...
(assert (and (<= 1 (to_rep2 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3))) (<= (to_rep2 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 64)))
(assert (= o18 (to_rep2 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3))))
