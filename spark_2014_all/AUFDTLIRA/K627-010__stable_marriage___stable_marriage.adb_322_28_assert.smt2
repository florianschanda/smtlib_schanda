...
(assert (= o14 o16))
(assert (= temp___645 o15))
(assert (= temp___6451 o16))
(assert (= result8 (mk___split_fields__ref unmatched_g1_set__split_fields2)))
(assert (= unmatched_g1_set__split_fields3 (mk___split_fields temp___645 temp___6451)))
...
(assert (= o18 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3))))
(assert (= o19 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) o18 o17)))
(assert (= o19 o20))
(assert (= (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3) o21))
(assert (= temp___649 o20))
(assert (= temp___6491 o21))
(assert (= result9 (mk___split_fields__ref unmatched_g1_set__split_fields3)))
(assert (= unmatched_g1_set__split_fields4 (mk___split_fields temp___649 temp___6491)))
