...
(assert (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))))
(assert (= result10 (mk_bool__ref accepted)))
(assert (= accepted2 (of_int 1)))
(assert (= (to_rep (select result__ g21)) c132b))
(assert (in_range1 c132b))
(assert (and (= o23 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1))))
(assert (= (to_rep3 o24) o23))
(assert (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields2) o25))
(assert (= o24 o26))
(assert (= temp___603 o25))
(assert (= temp___6031 o26))
(assert (= result11 (mk___split_fields__ref unmatched_g1_set__split_fields2)))
(assert (= unmatched_g1_set__split_fields3 (mk___split_fields temp___603 temp___6031)))
(assert (= (to_rep o27) c132b))
(assert (and (<= 1 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3))) (<= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 64)))
(assert (= o28 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3))))
(assert (= o29 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) o28 o27)))
(assert (= o29 o30))
(assert (= (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3) o31))
(assert (= temp___607 o30))
(assert (= temp___6071 o31))
(assert (= result12 (mk___split_fields__ref unmatched_g1_set__split_fields3)))
(assert (= unmatched_g1_set__split_fields4 (mk___split_fields temp___607 temp___6071)))
(assert (not (= (is_preferred_1 g11 (to_rep (select result__ g21)) (select ranking_2 g21)) true)))
(check-sat)
(exit)
