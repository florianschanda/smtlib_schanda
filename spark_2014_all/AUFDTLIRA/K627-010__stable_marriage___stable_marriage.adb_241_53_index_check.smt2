...
(assert (forall ((a (Array Int count)) (b (Array Int count))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare4 a a_first a_last b b_first b_last) 0) (= (bool_eq6 a a_first a_last b b_first b_last) true)) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int count)) (b (Array Int count))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare4 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq6 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep3 (select a (+ i 1))) (to_rep3 (select b (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int count)) (b (Array Int count))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare4 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq6 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep3 (select b (+ i 1))) (to_rep3 (select a (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant1 ((temp___expr_306 Int) (temp___is_init_303 Bool) (temp___skip_constant_304 Bool) (temp___do_toplevel_305 Bool)) Bool (=> (or (= temp___is_init_303 true) (<= 0 64)) (in_range4 temp___expr_306)))
(define-fun dynamic_invariant2 ((temp___expr_312 Int) (temp___is_init_309 Bool) (temp___skip_constant_310 Bool) (temp___do_toplevel_311 Bool)) Bool (=> (or (= temp___is_init_309 true) (<= 1 64)) (in_range5 temp___expr_312)))
(define-fun dynamic_invariant3 ((temp___expr_149 Int) (temp___is_init_146 Bool) (temp___skip_constant_147 Bool) (temp___do_toplevel_148 Bool)) Bool (=> (or (= temp___is_init_146 true) (<= 1 64)) (in_range2 temp___expr_149)))
...
(declare-const o2 group2_id)
(declare-const o3 Int)
(declare-const o4 group1_id)
(declare-const o5 Int)
(declare-const o6 Bool)
(declare-const o7 Int)
(declare-const o8 group2_id)
(declare-const o9 Int)
(declare-const o10 group1_id)
...
(assert (= result true))
(assert (= (= o21 true) (forall ((g1_id3 Int)) (=> (and (<= 1 g1_id3) (<= g1_id3 64)) (=> (forall ((idx3 Int)) (=> (and (<= 1 idx3) (<= idx3 (to_rep3 unmatched_g1_set__split_fields1))) (not (= (to_rep (select unmatched_g1_set__split_fields idx3)) g1_id3)))) (and (< 0 (to_rep3 (select proposals_made g1_id3))) (= (to_rep (select result__ (to_rep1 (select (select ranking_1 g1_id3) (to_rep3 (select proposals_made g1_id3)))))) g1_id3)))))))
(assert (<= 1 g1_id1))
(assert (<= g1_id1 64))
(assert (= (to_rep3 (select proposals_made g1_id1)) 0))
(assert (<= 1 idx1))
(assert (<= idx1 (to_rep3 unmatched_g1_set__split_fields1)))
(assert (not (<= 1 idx1)))
(check-sat)
(exit)
