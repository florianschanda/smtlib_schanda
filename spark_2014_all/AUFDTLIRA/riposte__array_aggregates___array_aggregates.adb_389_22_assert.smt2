...
(declare-fun temp_____aggregate_def_673 (Int Int) (Array Int unsigned_byte))
...
(assert (= (unsigned_byteqtint rliteral1) 0))
(assert (forall ((temp___675 Int) (temp___676 Int)) (let ((temp___674 (temp_____aggregate_def_673 temp___675 temp___676))) (=> (and (dynamic_invariant temp___675 true true true true) (dynamic_invariant temp___676 true true true true)) (forall ((temp___677 Int)) (ite (and (<= 2 temp___677) (<= temp___677 5)) (= (select temp___674 temp___677) rliteral) (= (select temp___674 temp___677) rliteral1)))))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_673 2 0)))
