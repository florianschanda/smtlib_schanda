...
(declare-fun temp___673 (Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___675 Int) (temp___676 Int)) (let ((temp___674 (temp___673 temp___675 temp___676))) (=> (and (dynamic_invariant temp___675 true true true true) (dynamic_invariant temp___676 true true true true)) (forall ((temp___677 Int)) (ite (and (<= 2 temp___677) (<= temp___677 5)) (= (to_rep (select temp___674 temp___677)) temp___675) (= (to_rep (select temp___674 temp___677)) temp___676)))))))
