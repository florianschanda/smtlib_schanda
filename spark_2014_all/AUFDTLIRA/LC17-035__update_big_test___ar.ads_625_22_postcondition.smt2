...
(declare-fun temp___2477 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(declare-fun temp___2483 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp___2489 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (forall ((temp___2479 (Array Int (Array Int (Array Int (Array Int et1)))))) (forall ((temp___2480 Int)) (forall ((temp___2481 (Array Int (Array Int (Array Int et1))))) (let ((temp___2478 (temp___2477 temp___2479 temp___2480 temp___2481))) (=> (dynamic_invariant2 temp___2480 true true true true) (forall ((temp___2482 Int)) (ite (= temp___2482 temp___2480) (= (select temp___2478 temp___2482) temp___2481) (= (select temp___2478 temp___2482) (select temp___2479 temp___2482))))))))))
(assert (forall ((temp___2485 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2486 Int)) (forall ((temp___2487 (Array Int (Array Int et1)))) (let ((temp___2484 (temp___2483 temp___2485 temp___2486 temp___2487))) (=> (dynamic_invariant1 temp___2486 true true true true) (forall ((temp___2488 Int)) (ite (= temp___2488 temp___2486) (= (select temp___2484 temp___2488) temp___2487) (= (select temp___2484 temp___2488) (select temp___2485 temp___2488))))))))))
(assert (forall ((temp___2491 (Array Int (Array Int et1)))) (forall ((temp___2492 Int)) (forall ((temp___2493 (Array Int et1))) (let ((temp___2490 (temp___2489 temp___2491 temp___2492 temp___2493))) (=> (dynamic_invariant temp___2492 true true true true) (forall ((temp___2494 Int)) (ite (= temp___2494 temp___2492) (= (select temp___2490 temp___2494) temp___2493) (= (select temp___2490 temp___2494) (select temp___2491 temp___2494))))))))))
...
(assert (= a3 a4))
(assert (= a5 a3))
(assert (not (= (bool_eq3 a4 90 99 (temp___2477 a i (temp___2483 b j (temp___2489 c k d))) 90 99) true)))
(check-sat)
(exit)
