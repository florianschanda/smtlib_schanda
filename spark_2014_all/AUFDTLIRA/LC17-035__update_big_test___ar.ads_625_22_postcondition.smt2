...
(declare-fun temp___2418 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(assert (forall ((temp___2420 (Array Int (Array Int (Array Int (Array Int et1)))))) (forall ((temp___2421 Int)) (forall ((temp___2422 (Array Int (Array Int (Array Int et1))))) (let ((temp___2419 (temp___2418 temp___2420 temp___2421 temp___2422))) (forall ((temp___2423 Int)) (ite (= temp___2423 temp___2421) (= (select temp___2419 temp___2423) temp___2422) (= (select temp___2419 temp___2423) (select temp___2420 temp___2423)))))))))
(declare-fun temp___2424 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___2426 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2427 Int)) (forall ((temp___2428 (Array Int (Array Int et1)))) (let ((temp___2425 (temp___2424 temp___2426 temp___2427 temp___2428))) (forall ((temp___2429 Int)) (ite (= temp___2429 temp___2427) (= (select temp___2425 temp___2429) temp___2428) (= (select temp___2425 temp___2429) (select temp___2426 temp___2429)))))))))
(declare-fun temp___2430 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___2432 (Array Int (Array Int et1)))) (forall ((temp___2433 Int)) (forall ((temp___2434 (Array Int et1))) (let ((temp___2431 (temp___2430 temp___2432 temp___2433 temp___2434))) (forall ((temp___2435 Int)) (ite (= temp___2435 temp___2433) (= (select temp___2431 temp___2435) temp___2434) (= (select temp___2431 temp___2435) (select temp___2432 temp___2435)))))))))
...
(assert (= a3 a4))
(assert (= a5 a3))
(assert (not (= (bool_eq3 a4 90 99 (temp___2418 a i (temp___2424 b j (temp___2430 c k d))) 90 99) true)))
(check-sat)
(exit)
