...
(assert (and (=> (<= 1 64) (in_range12 i3)) (and (<= 1 i3) (<= i3 64))))
(assert (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book i3))) true))
(assert (= find_result__split_fields4 find_result__split_fields3))
(assert (not (= i3 64)))
(assert (= result3 (mk_int__ref i3)))
(assert (= i4 (+ i3 1)))
