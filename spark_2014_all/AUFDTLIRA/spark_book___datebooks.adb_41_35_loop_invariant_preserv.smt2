...
(assert (<= 1 i1))
(assert (<= i1 64))
(assert (<= (length description) 128))
(assert (and (=> (<= 1 64) (in_range10 i2)) (and (<= 1 i2) (<= i2 64))))
(assert (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book i2))) true))
(assert (= find_result__split_fields4 find_result__split_fields3))
(assert (not (= i2 64)))
