...
(assert (= h1 x))
(assert (= (to_rep1 r__split_fields14) (+ (to_rep1 r__split_fields11) 1)))
(assert (not (not (= (is_empty (mk___rep (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14))) true))))
(check-sat)
(exit)
