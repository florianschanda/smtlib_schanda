...
(define-fun to_rep4 ((x it4)) Int (it4qtint x))
(declare-fun of_rep4 (Int) it4)
(assert (forall ((x it4)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x it4)) (! (in_range (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep4 (rec__ar__rofaofr2__a2 (us_split_fields7 a))) (to_rep4 (rec__ar__rofaofr2__a2 (us_split_fields7 b)))) (= (bool_eq3 (rec__ar__rofaofr2__b2 (us_split_fields7 a)) 90 99 (rec__ar__rofaofr2__b2 (us_split_fields7 b)) 90 99) true)) true false))
...
(declare-fun temp_____aggregate_def_4127 ((Array Int us_rep2) Int us_rep2) (Array Int us_rep2))
...
(assert (forall ((temp___4129 (Array Int us_rep2))) (forall ((temp___4130 Int)) (forall ((temp___4131 us_rep2)) (let ((temp___4128 (temp_____aggregate_def_4127 temp___4129 temp___4130 temp___4131))) (=> (dynamic_invariant temp___4130 true true true true) (forall ((temp___4132 Int)) (ite (= temp___4132 temp___4130) (= (select temp___4128 temp___4132) temp___4131) (= (select temp___4128 temp___4132) (select temp___4129 temp___4132))))))))))
...
(declare-const temp___9593 us_rep3)
(declare-const result us_split_fields__ref3)
(declare-const r__split_fields2 us_split_fields6)
(declare-const r__split_fields3 us_split_fields__ref3)
(declare-const r__split_fields4 us_split_fields6)
(assert (in_range i))
(assert (in_range1 e))
(assert (= (to_rep o) e))
(assert (= o o1))
(assert (= (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select r__split_fields1 i))))))) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= (rec__ar__rec2t__f2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select r__split_fields1 i))))) o5))
(assert (= o6 o3))
(assert (= o7 o4))
(assert (= (rec__ar__rec2t__h2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select r__split_fields1 i))))) o8))
(assert (= o9 o5))
(assert (= o10 o6))
(assert (= o11 o7))
(assert (= o12 o8))
...
(assert (= o15 o11))
(assert (= o16 o12))
(assert (= (rec__ar__rec5t__g5 (us_split_fields5 (select r__split_fields1 i))) o17))
(assert (= (rec__ar__rec5t__h5 (us_split_fields5 (select r__split_fields1 i))) (mk___rep (mk___split_fields o18 o19))))
(assert (= o20 o13))
(assert (= o21 o14))
(assert (= o22 o15))
(assert (= o23 o16))
...
(assert (= o25 o18))
(assert (= o26 o19))
(assert (= o27 (store r__split_fields1 i (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 o20 (mk___rep (mk___split_fields o21 o22)) o23)) o24 (mk___rep (mk___split_fields o25 o26)))))))
(assert (= o28 (mk___split_fields3 r__split_fields o27)))
(assert (= temp___9593 (mk___rep3 o28)))
(assert (= result (mk___split_fields__ref3 (mk___split_fields3 r__split_fields r__split_fields1))))
(assert (= r__split_fields2 (us_split_fields7 temp___9593)))
(assert (= r__split_fields3 (mk___split_fields__ref3 r__split_fields2)))
(assert (= r__split_fields4 r__split_fields2))
(assert (not (= (bool_eq4 (mk___rep3 (us_split_fields__content3 r__split_fields3)) (mk___rep3 (mk___split_fields3 r__split_fields (temp_____aggregate_def_4127 r__split_fields1 i (mk___rep2 (let ((usq_ (us_split_fields5 (select r__split_fields1 i)))) (mk___split_fields2 (mk___rep1 (let ((usq_1 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select r__split_fields1 i)))))) (mk___split_fields1 (rec__ar__rec2t__f2 usq_1) (mk___rep (mk___split_fields (of_rep e) (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select r__split_fields1 i))))))))) (rec__ar__rec2t__h2 usq_1)))) (rec__ar__rec5t__g5 usq_) (rec__ar__rec5t__h5 usq_)))))))) true)))
(check-sat)
(exit)
