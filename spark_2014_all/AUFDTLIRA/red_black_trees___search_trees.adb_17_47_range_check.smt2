...
(assert (= (= result7 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i1))) true) (= (contains (value_set__content search_trees__values__result8) (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1))) true))))))
(assert (= result7 true))
(assert (<= 0 v))
(assert (<= v 2147483647))
(assert (and (= result8 (contains (value_set__content search_trees__values__result8) v)) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains (value_set__content search_trees__values__result8) e) true)) (= e v))) (= result8 true)))))
(assert (= result8 true))
(assert (<= 1 i))
(assert (<= i 100))
