...
(assert (= (= result13 true) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i4))) true) (= (contains (value_set__content search_trees__values__result8) (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i4))) true))))))
(assert (= result13 true))
(assert (<= 0 v1))
(assert (<= v1 2147483647))
(assert (and (= result14 (contains (value_set__content search_trees__values__result8) v1)) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains (value_set__content search_trees__values__result8) e) true)) (= e v1))) (= result14 true)))))
