...
(assert (<= 0 i5))
(assert (<= i5 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)))
(assert (and (<= 0 i5) (<= i5 99)))
(assert (= o208 i5))
(assert (= o209 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o208)))
(assert (= o210 (to_rep1 o209)))
(assert (= o211 (- o210 2)))
(assert (= o212 (ite (<= j2 o211) true false)))
(assert (= result38 (ite (<= 0 j2) o212 false)))
(assert (= result38 true))
(assert (and (<= 0 i5) (<= i5 99)))
(assert (= o214 i5))
(assert (= o215 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o214)))
(assert (= o216 (to_rep1 o215)))
(assert (= o217 (- o216 1)))
(assert (= o218 (ite (<= k1 o217) true false)))
