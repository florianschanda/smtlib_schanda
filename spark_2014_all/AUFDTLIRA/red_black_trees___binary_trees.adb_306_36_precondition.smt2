...
(assert (= n1 1))
(assert (=> (and (<= 1 n1) (<= n1 100)) (= temp___1125 n1)))
...
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (= temp___1110 j3))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (= (tree_structure f1) true))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (and (= temp___1100 (model__ f1 root)) (and (dynamic_invariant2 temp___1100 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1100 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1100 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f1 i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1100 (parent f1 i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1100 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1100 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1100 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1100 (parent f1 i)))) (position f1 i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1100 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1100 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1100 i))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1100 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1100 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1100 j15)))) true)) (= j15 i))))))))))))))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (= o2 (select temp___1100 j3)))))
...
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (and (= o5 (length o4)) (and (in_range5 o5) (<= (+ 0 o5) 2147483647))))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (= o6 (ite (= o5 n2) true false)))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (= (tree_structure f1) true))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (and (= temp___1099 (model__ f1 root)) (and (dynamic_invariant2 temp___1099 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1099 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1099 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f1 i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1099 (parent f1 i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1099 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1099 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1099 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1099 (parent f1 i)))) (position f1 i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1099 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1099 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1099 i))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1099 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1099 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1099 j15)))) true)) (= j15 i))))))))))))))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (= o (select temp___1099 j3)))))
...
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= result2 true) (and (= temp___1107 (model__ f1 root)) (and (dynamic_invariant2 temp___1107 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1107 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1107 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f1 i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1107 (parent f1 i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1107 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1107 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1107 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1107 (parent f1 i)))) (position f1 i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1107 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1107 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1107 i))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1107 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1107 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1107 j15)))) true)) (= j15 i)))))))))))))))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= result2 true) (= o16 (select temp___1107 j3))))))
...
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= result2 true) (= (tree_structure f2) true)))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= result2 true) (and (= temp___1104 (model__ f2 root)) (and (dynamic_invariant2 temp___1104 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1104 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f2 i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 (parent f2 i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1104 (parent f2 i)))) (position f2 i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1104 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1104 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 i))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1104 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1104 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1104 j15)))) true)) (= j15 i)))))))))))))))))
...
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= result2 true) (= o13 (select temp___1104 o12))))))
...
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= result2 true) (= (tree_structure f1) true)))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= result2 true) (and (= temp___1101 (model__ f1 root)) (and (dynamic_invariant2 temp___1101 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1101 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1101 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f1 i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1101 (parent f1 i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1101 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1101 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1101 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1101 (parent f1 i)))) (position f1 i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1101 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1101 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1101 i))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1101 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1101 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1101 j15)))) true)) (= j15 i)))))))))))))))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= result2 true) (and (<= 1 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f1)) j3))))) (<= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f1)) j3)))) 100))))))
...
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= result2 true) (= o9 (select temp___1101 o8))))))
...
(assert (=> (and (<= 1 n1) (<= n1 100)) (=> (and (<= 1 j3) (<= j3 100)) (and (=> (<= 1 100) (in_range1 j4)) (and (<= 1 j4) (<= j4 100))))))
