...
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o10 (length o9)) (and (in_range4 o10) (<= (+ 0 o10) 2147483647))))))
...
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= temp___338 (get o4 o10)) (in_range5 temp___338)))))
