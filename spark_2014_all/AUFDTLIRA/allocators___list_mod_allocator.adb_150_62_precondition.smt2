...
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= temp___301 (get o4 o10)) (in_range5 temp___301)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (<= 1 temp___301) (<= temp___301 10000)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o11 temp___301))))
...
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (= result (of_int 1)))))
