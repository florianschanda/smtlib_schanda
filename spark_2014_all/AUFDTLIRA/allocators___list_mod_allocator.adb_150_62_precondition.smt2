...
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= (mk___rep1 (mk___split_fields1 o7 o8)) (model__ data first_available)) (= (model_is_well_formed (mk___rep1 (mk___split_fields1 o7 o8)) data first_available) true)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o7 o9))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o8 o10))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o11 o9))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o12 (length o11)) (and (in_range4 o12) (<= (+ 0 o12) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= (mk___rep1 (mk___split_fields1 o2 o3)) (model__ data first_available)) (= (model_is_well_formed (mk___rep1 (mk___split_fields1 o2 o3)) data first_available) true)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o2 o4))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o3 o5))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o6 o4))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= temp___301 (get o6 o12)) (in_range5 temp___301)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (<= 1 temp___301) (<= temp___301 10000)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o13 temp___301))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= (mk___rep (mk___split_fields o14 o15)) (select data o13)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o14 o16))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o15 o17))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o18 o17))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o19 (to_rep o18)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result (ite (= o19 0) true false)))))
(assert (=> (= result1 true) (=> (= first_available 0) (= result (of_int 1)))))
