...
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o18 (model__ data first_available)) (= (model_is_well_formed o18 data first_available) true)))))
...
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o10 (length o9)) (and (in_range1 o10) (<= (+ 0 o10) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o19 (model__ data first_available)) (= (model_is_well_formed o19 data first_available) true)))))
...
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= temp___338 (get o4 o10)) (in_range2 temp___338)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (<= 1 temp___338) (<= temp___338 10000)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o11 temp___338))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= (mk___rep (mk___split_fields o12 o13)) (select data o11)))))
...
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= o17 (to_rep o16)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result (ite (= o17 0) true false)))))
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (= result (distinct 1 0)))))
