...
(assert (and (= o2 (elementt_image elementid)) (and (dynamic_invariant1 o2 true false true true) (= o2 (let ((temp___542 (to_string (attr__ATTRIBUTE_IMAGE4 elementid)))) (mk___t (elts1 temp___542) (mk (to_rep1 (first2 (rt1 temp___542))) (to_rep1 (last2 (rt1 temp___542))))))))))
