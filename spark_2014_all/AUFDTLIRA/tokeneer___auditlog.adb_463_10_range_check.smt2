...
(assert (= (ite (<= (to_rep1 (first temp___17801)) (to_rep1 (last temp___17801))) (+ (- (to_rep1 (last temp___17801)) (to_rep1 (first temp___17801))) 1) 0) (ite (<= 1 r46b) (+ (- r46b 1) 1) 0)))
(assert (= (slide temp___1780 (to_rep1 (first temp___17801)) 1) temp___1781))
(assert (= (mk3 1 r46b) temp___17811))
(assert (<= 1 r46b))
(assert (not (<= 1 1)))
(check-sat)
(exit)
