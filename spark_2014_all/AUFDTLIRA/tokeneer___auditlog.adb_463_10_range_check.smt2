...
(define-fun dynamic_invariant1 ((temp___expr_483 Int) (temp___is_init_480 Bool) (temp___skip_constant_481 Bool) (temp___do_toplevel_482 Bool)) Bool (=> (or (= temp___is_init_480 true) (<= 0 43)) (in_range4 temp___expr_483)))
(declare-sort t1 0)
...
(define-fun dynamic_invariant2 ((temp___expr_307 us_t) (temp___is_init_304 Bool) (temp___skip_constant_305 Bool) (temp___do_toplevel_306 Bool)) Bool (and (=> (not (= temp___skip_constant_305 true)) (dynamic_property 1 2147483647 (first1 temp___expr_307) (last1 temp___expr_307))) (=> (= temp___do_toplevel_306 true) (=> (= temp___is_init_304 true) (and (let ((temp___309 (of_array2 (to_array temp___expr_307) (first1 temp___expr_307) (last1 temp___expr_307)))) (and (= (first5 temp___309) 1) (<= 0 (last5 temp___309)))) (<= (last1 temp___expr_307) 20))))))
(define-fun dynamic_predicate ((temp___311 us_t)) Bool (and (let ((temp___313 (of_array2 (to_array temp___311) (first1 temp___311) (last1 temp___311)))) (and (= (first5 temp___313) 1) (<= 0 (last5 temp___313)))) (<= (last1 temp___311) 20)))
(declare-fun elementt_image (Int) us_t)
(declare-fun elementt_image__function_guard (us_t Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (dynamic_invariant2 (elementt_image x) true false true)) :pattern ((elementt_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (= (elementt_image x) (let ((temp___489 (to_string (attr__ATTRIBUTE_IMAGE4 x)))) (of_array (to_array1 temp___489) (first3 temp___489) (last3 temp___489))))) :pattern ((elementt_image x)))))
...
(assert (forall ((temp___162 Int)) (forall ((temp___163 Int)) (= (select (auditlog__noelement__aggregate_def temp___162) temp___163) (of_rep temp___162)))))
...
(define-fun dynamic_invariant5 ((temp___expr_82 us_t1) (temp___is_init_79 Bool) (temp___skip_constant_80 Bool) (temp___do_toplevel_81 Bool)) Bool (=> (not (= temp___skip_constant_80 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_82) (last3 temp___expr_82))))
(define-fun dynamic_invariant6 ((temp___expr_1265 Int) (temp___is_init_1262 Bool) (temp___skip_constant_1263 Bool) (temp___do_toplevel_1264 Bool)) Bool (=> (or (= temp___is_init_1262 true) (<= 1 20)) (in_range5 temp___expr_1265)))
(assert (= noelement (auditlog__noelement__aggregate_def 32)))
(define-fun dynamic_invariant7 ((temp___expr_297 us_t2) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool)) Bool (and (=> (not (= temp___skip_constant_295 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_297) (last5 temp___expr_297))) (=> (= temp___do_toplevel_296 true) (=> (= temp___is_init_294 true) (and (= (first5 temp___expr_297) 1) (<= 0 (last5 temp___expr_297)))))))
(define-fun dynamic_predicate1 ((temp___300 us_t2)) Bool (and (= (first5 temp___300) 1) (<= 0 (last5 temp___300))))
...
(declare-const temp___1626 (Array Int character))
(declare-const temp___16261 t)
(declare-const temp___1627 (Array Int character))
(declare-const temp___16271 t3)
(declare-const o2 (Array Int character))
(declare-const temp___1629 (Array Int character))
(declare-const temp___16291 t3)
...
(assert (and (= (mk___t o o1) (elementt_image elementid)) (and (dynamic_invariant2 (mk___t o o1) true false true) (= (mk___t o o1) (let ((temp___487 (to_string (attr__ATTRIBUTE_IMAGE4 elementid)))) (mk___t (elts1 temp___487) (mk (to_rep1 (first2 (rt1 temp___487))) (to_rep1 (last2 (rt1 temp___487))))))))))
...
(assert (and (= (mk___t temp___1626 temp___16261) (elementt_image elementid)) (and (dynamic_invariant2 (mk___t temp___1626 temp___16261) true false true) (= (mk___t temp___1626 temp___16261) (let ((temp___487 (to_string (attr__ATTRIBUTE_IMAGE4 elementid)))) (mk___t (elts1 temp___487) (mk (to_rep1 (first2 (rt1 temp___487))) (to_rep1 (last2 (rt1 temp___487))))))))))
(assert (= (ite (<= (to_rep1 (first temp___16261)) (to_rep1 (last temp___16261))) (+ (- (to_rep1 (last temp___16261)) (to_rep1 (first temp___16261))) 1) 0) (ite (<= 1 r46b) (+ (- r46b 1) 1) 0)))
(assert (= (slide temp___1626 (to_rep1 (first temp___16261)) 1) temp___1627))
(assert (= (mk3 1 r46b) temp___16271))
(assert (<= 1 r46b))
(assert (not (<= 1 1)))
(check-sat)
(exit)
