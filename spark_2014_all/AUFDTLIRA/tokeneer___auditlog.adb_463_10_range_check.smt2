...
(define-fun dynamic_invariant1 ((temp___expr_439 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 43)) (in_range4 temp___expr_439)))
(declare-sort t1 0)
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (= (elementt_image x) (let ((temp___445 (to_string (attr__ATTRIBUTE_IMAGE4 x)))) (of_array (to_array1 temp___445) (first3 temp___445) (last3 temp___445))))) :pattern ((elementt_image x)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1209 Int) (temp___is_init_1206 Bool) (temp___skip_constant_1207 Bool) (temp___do_toplevel_1208 Bool)) Bool (=> (or (= temp___is_init_1206 true) (<= 1 20)) (in_range5 temp___expr_1209)))
(assert (= noelement (auditlog__noelement__aggregate_def 32)))
(define-fun dynamic_invariant7 ((temp___expr_297 us_t2) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool)) Bool (and (=> (not (= temp___skip_constant_295 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_297) (last5 temp___expr_297))) (=> (= temp___do_toplevel_296 true) (=> (= temp___is_init_294 true) (= (first5 temp___expr_297) 1)))))
(define-fun dynamic_predicate1 ((temp___300 us_t2)) Bool (= (first5 temp___300) 1))
...
(declare-const temp___1570 (Array Int character))
(declare-const temp___15701 t)
(declare-const temp___1571 (Array Int character))
(declare-const temp___15711 t3)
(declare-const o2 (Array Int character))
(declare-const temp___1573 (Array Int character))
(declare-const temp___15731 t3)
...
(assert (and (= (mk___t o o1) (elementt_image elementid)) (and (dynamic_invariant2 (mk___t o o1) true false true) (= (mk___t o o1) (let ((temp___443 (to_string (attr__ATTRIBUTE_IMAGE4 elementid)))) (mk___t (elts1 temp___443) (mk (to_rep1 (first2 (rt1 temp___443))) (to_rep1 (last2 (rt1 temp___443))))))))))
...
(assert (and (= (mk___t temp___1570 temp___15701) (elementt_image elementid)) (and (dynamic_invariant2 (mk___t temp___1570 temp___15701) true false true) (= (mk___t temp___1570 temp___15701) (let ((temp___443 (to_string (attr__ATTRIBUTE_IMAGE4 elementid)))) (mk___t (elts1 temp___443) (mk (to_rep1 (first2 (rt1 temp___443))) (to_rep1 (last2 (rt1 temp___443))))))))))
(assert (= (ite (<= (to_rep1 (first temp___15701)) (to_rep1 (last temp___15701))) (+ (- (to_rep1 (last temp___15701)) (to_rep1 (first temp___15701))) 1) 0) (ite (<= 1 r46b) (+ (- r46b 1) 1) 0)))
(assert (= (slide temp___1570 (to_rep1 (first temp___15701)) 1) temp___1571))
(assert (= (mk3 1 r46b) temp___15711))
(assert (<= 1 r46b))
(assert (not (<= 1 1)))
(check-sat)
(exit)
