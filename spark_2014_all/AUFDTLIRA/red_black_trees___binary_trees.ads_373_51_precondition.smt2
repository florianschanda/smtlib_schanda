...
(define-fun dynamic_invariant1 ((temp___expr_196 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool) (temp___do_typ_inv_195 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 1)) (in_range4 temp___expr_196)))
...
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant i true true true true) (type_invariant f)) (not (= (parent f i) 0))) (dynamic_invariant1 (position f i) true false true true)) :pattern ((position f i))))))
...
(assert (forall ((f us_rep3)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant i true true true true) (dynamic_invariant1 d true true true true)) (type_invariant f)) (let ((result (peek f i d))) (and (and (ite (not (= result 0)) (and (= (position f result) d) (= (parent f result) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent f j) i) (not (= (position f j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent f j) i) (= (position f j) d)) (= result j))))) (dynamic_invariant3 result true false true true)))) :pattern ((peek f i d))))))
(assert (forall ((f us_rep3)) (forall ((i Int) (d Int)) (! (=> (and (dynamic_invariant i true true true true) (dynamic_invariant1 d true true true true)) (= (peek f i d) (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___343 (rec__binary_trees__forest__c (us_split_fields5 f)))) (select temp___343 i))))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___344 (rec__binary_trees__forest__c (us_split_fields5 f)))) (select temp___344 i)))))))) :pattern ((peek f i d))))))
...
(assert (and (= o38 (+ (to_rep (rec__binary_trees__forest__s f__split_fields4)) 1)) (in_range2 (+ (to_rep (rec__binary_trees__forest__s f__split_fields4)) 1))))
...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o46 (size (mk___rep2 (us_split_fields__content2 f__split_fields7)))) (and (in_range2 o46) (= o46 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))))))
(assert (= result7 (ite (= o46 (+ (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 1)) true false)))
(assert (= result7 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= temp___1003 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root)) (and (dynamic_invariant2 temp___1003 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1003 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1003 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1003 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1003 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1003 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1003 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1003 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1003 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1003 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1003 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1003 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1003 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1003 j)))) true)) (= j i1))))))))))))))
(assert (= o44 (select temp___1003 i)))
(assert (= o45 (us_split_fields1 o44)))
(assert (= result8 (rec__tree_model__path_type__k o45)))
(assert (= result8 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o43 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o43) (and (= o43 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o43 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o43) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o43) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)) (= o43 j)))))))))
(assert (= result9 (ite (= o43 (int__content v2)) true false)))
(assert (= result9 true))
