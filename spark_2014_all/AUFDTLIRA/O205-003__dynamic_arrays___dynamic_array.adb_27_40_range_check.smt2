...
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs3 r) (mk___split_fields2 (let ((temp___133 (rec__dynamic_array__holder__content (us_split_fields3 r)))) (to_array temp___133)))))
...
(define-fun to_base1 ((a us_rep3)) us_rep1 (mk___rep1 (us_split_discrs5 a) (mk___split_fields1 (let ((temp___135 (rec__dynamic_array__holder__content2 (us_split_fields7 a)))) (of_array (to_array1 temp___135) (first3 temp___135) (last4 temp___135))))))
(define-fun of_base1 ((r us_rep1)) us_rep3 (mk___rep3 (us_split_discrs3 r) (mk___split_fields3 (let ((temp___134 (rec__dynamic_array__holder__content (us_split_fields3 r)))) (of_array1 (to_array temp___134) (first1 temp___134) (last2 temp___134))))))
...
(declare-fun temp___230 (us_rep Int Int) us_t2)
(assert (forall ((temp___232 us_rep)) (forall ((temp___233 Int) (temp___234 Int)) (let ((temp___231 (temp___230 temp___232 temp___233 temp___234))) (and (=> (dynamic_property7 1 2147483647 temp___233 temp___234) (and (= (first5 temp___231) temp___233) (= (last6 temp___231) temp___234))) (forall ((temp___235 Int)) (= (select (to_array2 temp___231) temp___235) temp___232)))))))
(declare-fun temp___238 (us_rep) (Array Int us_rep))
(assert (forall ((temp___240 us_rep)) (forall ((temp___241 Int)) (= (select (temp___238 temp___240) temp___241) temp___240))))
...
(define-fun dynamic_invariant3 ((temp___expr_144 Int) (temp___is_init_141 Bool) (temp___skip_constant_142 Bool) (temp___do_toplevel_143 Bool)) Bool (=> (or (= temp___is_init_141 true) (<= 0 last)) (dynamic_property 0 last temp___expr_144)))
(assert (= last c))
(define-fun dynamic_invariant4 ((temp___expr_150 us_rep) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (and (=> (dynamic_array__rec__f1__pred temp___expr_150) (=> (or (= temp___is_init_147 true) (<= 0 last)) (dynamic_property 0 last (to_rep1 (rec__dynamic_array__rec__f1 (us_split_fields1 temp___expr_150)))))) (=> (dynamic_array__rec__f2__pred temp___expr_150) (=> (or (= temp___is_init_147 true) (<= 0 last)) (dynamic_property 0 last (to_rep1 (rec__dynamic_array__rec__f2 (us_split_fields1 temp___expr_150))))))))
...
(declare-const temp___236 us_t2)
(declare-const temp___237 us_t2)
(declare-const o22 us_t1)
(declare-const o23 us_split_fields6)
(declare-const o24 us_split_discrs2)
