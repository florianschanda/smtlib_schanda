...
(assert (and (= o41 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 o41)))
...
(assert (=> (= result12 true) (and (= o40 (get (rec__list_allocator__m__t__available model____split_fields3) o39)) (in_range4 o40))))
(assert (=> (not (= result12 true)) (= o40 0)))
(assert (and (= temp___431 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 temp___431)))
