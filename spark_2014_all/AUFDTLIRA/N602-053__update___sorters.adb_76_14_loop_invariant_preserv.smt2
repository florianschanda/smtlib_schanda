...
(declare-const temp___2092 (Array Int integer))
(declare-const temp___2093 t1)
...
(assert (not (= current2 temp___207)))
...
(assert (= o5 values2))
(assert (= o5 temp___2092))
(assert (= (mk1 current3 (to_rep values__last)) temp___2093))
(assert (= temp___2092 o6))
(assert (= (mk (to_rep (first2 temp___2093)) (to_rep (last2 temp___2093))) o7))
...
(assert (=> (not (= smallest3 current3)) (= (let ((temp___174 (temp_____aggregate_def_164 (mk___t values2 (mk (to_rep values__first) (to_rep values__last))) o9 (to_rep (select values2 smallest3)) smallest3 (to_rep (select values2 o9))))) (bool_eq o11 (to_rep values__first) (to_rep values__last) (elts temp___174) (to_rep (first (rt temp___174))) (to_rep (last (rt temp___174))))) true)))
