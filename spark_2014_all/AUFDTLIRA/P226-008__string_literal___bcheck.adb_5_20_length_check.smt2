...
(assert (not (= (ite (<= (to_rep1 (first temp___1791)) (to_rep1 (last temp___1791))) (+ (- (to_rep1 (last temp___1791)) (to_rep1 (first temp___1791))) 1) 0) (ite (<= (to_rep1 (first temp___1801)) (to_rep1 (last temp___1801))) (+ (- (to_rep1 (last temp___1801)) (to_rep1 (first temp___1801))) 1) 0))))
(check-sat)
(exit)
