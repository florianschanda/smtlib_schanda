...
(define-fun dynamic_invariant1 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 0 10000)) (in_range3 temp___expr_148)))
...
(define-fun dynamic_invariant2 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range6 temp___expr_142)))
...
(define-fun dynamic_invariant3 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 10000)) (in_range7 temp___expr_172)))
...
(define-fun dynamic_invariant4 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 2147483647)) (in_range8 temp___expr_178)))
...
(define-fun default_initial_assumption1 ((temp___expr_211 us_rep3) (temp___skip_top_level_212 Bool)) Bool (and (= (length (rec__list_mod_allocator__m__t__available (us_split_fields3 temp___expr_211))) 0) (= (is_empty (rec__list_mod_allocator__m__t__allocated (us_split_fields3 temp___expr_211))) true)))
...
(assert (forall ((temp___267 us_rep)) (forall ((temp___268 Int)) (= (select (list_mod_allocator__data__aggregate_def temp___267) temp___268) temp___267))))
(define-fun dynamic_invariant5 ((temp___expr_234 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 0 1)) (in_range5 temp___expr_234)))
(define-fun dynamic_invariant6 ((temp___expr_154 Int) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (or (= temp___is_init_151 true) (<= 1 10000)) (in_range4 temp___expr_154)))
...
(define-fun dynamic_invariant7 ((temp___expr_191 Int) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool)) Bool (=> (or (= temp___is_init_188 true) (<= 0 10000)) (in_range9 temp___expr_191)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant7 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range9 e) (= (contains1 container e) true)) (= e item))) (= (contains1 container item) true)))) :pattern ((contains1 container item))))))
...
(declare-const temp___257 (Array Int us_rep))
...
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___259 r1)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___257 data1)))
...
(assert (=> (and (<= 1 r1) (<= r1 10000)) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data3 rr1)))) (ite (= rr1 10000) 0 (+ rr1 1)))))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data3 10000)))) 0)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 10000)) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data3 rr1)))) 0)))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (and (and (forall ((temp___258 Int)) (=> (and (<= 1 temp___258) (<= temp___258 10000)) (ite (< r2 temp___258) (= (select data3 temp___258) (select temp___257 temp___258)) (= (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data3 temp___258))) (rec__list_mod_allocator__cell__stat (us_split_fields1 (select temp___257 temp___258))))))) (=> (<= 1 10000) (in_range4 r2))) (and (<= 1 r2) (<= r2 10000)))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= r2 10000)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= r4 (mk_int__ref r2))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= data5 (mk_map__ref data3))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= r5 r2)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= data6 data3)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= r6 r4)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= data7 data5)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= r7 r5)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= data8 data6)))
(assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= r6 (mk_int__ref r1))))
(assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= data7 (mk_map__ref data1))))
(assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= r7 r1)))
(assert (=> (not (and (<= 1 r1) (<= r1 10000))) (= data8 data1)))
(assert (and (= (mk___rep1 (mk___split_fields1 o22 o23)) (model__ (map__content data7) first_available1)) (= (model_is_well_formed (mk___rep1 (mk___split_fields1 o22 o23)) (map__content data7) first_available1) true)))
(assert (= o22 o24))
(assert (= o23 o25))
(assert (= list_mod_allocator__C143b__assume o24))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 r145b)) (and (and (= temp___262 i1) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i2)) (= (get c143b j1) j1))) (and (and (=> (<= 1 r145b) (dynamic_property 1 r145b i2)) (and (<= 1 i2) (<= i2 r145b))) (= i2 r145b)))) (and (= i8 (mk_int__ref i2)) (= i9 i2)))))
(assert (=> (and (<= 1 i1) (<= i1 r145b)) (= i10 i8)))
(assert (=> (and (<= 1 i1) (<= i1 r145b)) (= i11 i9)))
(assert (=> (not (and (<= 1 i1) (<= i1 r145b))) (= i10 (mk_int__ref i1))))
(assert (=> (not (and (<= 1 i1) (<= i1 r145b))) (= i11 i1)))
(assert (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select (map__content data7) (get (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data7) first_available1))) (length (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data7) first_available1))))))))) 0))
(assert (and (= o38 (is_valid (map__content data7) first_available1)) (= (= o38 true) (and (and (= (is_well_formed (map__content data7) first_available1) true) (=> (not (= first_available1 0)) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select (map__content data7) (get (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data7) first_available1))) (length (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data7) first_available1))))))))) 0))) (forall ((r8 Int)) (=> (and (<= 1 r8) (<= r8 10000)) (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select (map__content data7) r8)))) 0) (= (contains (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data7) first_available1))) r8) true))))))))
(assert (and (= o39 (all_available (map__content data7))) (= (= o39 true) (forall ((r8 Int)) (=> (and (<= 1 r8) (<= r8 10000)) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select (map__content data7) r8)))) 0))))))
(assert (= result8 (ite (= o39 true) o38 false)))
(assert (not (= (all_available (map__content data7)) true)))
(check-sat)
(exit)
