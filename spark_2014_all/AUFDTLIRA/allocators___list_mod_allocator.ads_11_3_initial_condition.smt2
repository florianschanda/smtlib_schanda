...
(assert (forall ((x status)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range4 temp___expr_166)))
...
(define-fun dynamic_invariant2 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 0 10000)) (in_range5 temp___expr_200)))
...
(define-fun dynamic_invariant3 ((temp___expr_207 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 2147483647)) (in_range6 temp___expr_207)))
...
(define-fun dynamic_invariant4 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 10000)) (in_range2 temp___expr_173)))
...
(declare-fun user_eq10 (tresourceB tresourceB) Bool)
(declare-const dummy10 tresourceB)
...
(define-fun dynamic_invariant5 ((temp___expr_269 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool (=> (or (= temp___is_init_265 true) (<= 0 1)) (in_range3 temp___expr_269)))
...
(define-fun dynamic_invariant6 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 1 10000)) (in_range8 temp___expr_180)))
...
(declare-const temp___296 (Array Int us_rep))
...
(define-fun o19 () us_rep3 (mk___rep1 (mk___split_fields1 o13 o14)))
...
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= o5 (list_mod_allocator__data__aggregate_def (mk___rep (mk___split_fields o3 o4)))))
...
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___298 r1)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___296 data1)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (and (= o6 (+ r1 1)) (in_range2 (+ r1 1))))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= (to_rep o7) o6))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data1 r1))) o8))))
...
(assert (=> (and (<= 1 r1) (<= r1 10000)) (and (and (forall ((temp___297 Int)) (=> (and (<= 1 temp___297) (<= temp___297 10000)) (ite (or (< 10000 temp___297) (or (< temp___297 1) (< r2 temp___297))) (= (select data3 temp___297) (select temp___296 temp___297)) (= (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data3 temp___297))) (rec__list_mod_allocator__cell__stat (us_split_fields1 (select temp___296 temp___297))))))) (=> (<= 1 10000) (in_range8 r2))) (and (<= 1 r2) (<= r2 10000)))))
...
(assert (and (= o19 (model__ (map__content data6) first_available1)) (= (model_is_well_formed o19 (map__content data6) first_available1) true)))
(assert (= o13 o15))
(assert (= o14 o16))
(assert (= list_mod_allocator__C143b__assume o15))
(assert (= list_mod_allocator__C143b__assume c143b))
(assert (and (= list_mod_allocator__B144b__L_5__R145b__assume (length c143b)) (and (in_range4 list_mod_allocator__B144b__L_5__R145b__assume) (<= (+ 0 list_mod_allocator__B144b__L_5__R145b__assume) 2147483647))))
(assert (= list_mod_allocator__B144b__L_5__R145b__assume r145b))
(assert (in_range1 r145b))
(assert (= result4 (mk_int__ref i)))
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 r145b)) (= temp___301 i1)))
...
(assert (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select (map__content data6) (get (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data6) first_available1))) (length (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data6) first_available1))))))))) 0))
(assert (and (= o17 (is_valid (map__content data6) first_available1)) (= (= o17 true) (and (and (= (is_well_formed (map__content data6) first_available1) true) (=> (not (= first_available1 0)) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select (map__content data6) (get (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data6) first_available1))) (length (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data6) first_available1))))))))) 0))) (forall ((r7 Int)) (=> (and (<= 1 r7) (<= r7 10000)) (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select (map__content data6) r7)))) 0) (= (contains (rec__list_mod_allocator__m__t__available (us_split_fields3 (model__ (map__content data6) first_available1))) r7) true))))))))
(assert (and (= o18 (all_available (map__content data6))) (= (= o18 true) (forall ((r7 Int)) (=> (and (<= 1 r7) (<= r7 10000)) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select (map__content data6) r7)))) 0))))))
(assert (= result5 (ite (= o18 true) o17 false)))
(assert (not (= (is_valid (map__content data6) first_available1) true)))
(check-sat)
(exit)
