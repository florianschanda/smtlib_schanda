...
(define-fun o20 () us_rep3 (mk___rep1 (mk___split_fields1 o14 o15)))
...
(assert (and (= o20 (model__ (map__content data6) first_available1)) (= (model_is_well_formed o20 (map__content data6) first_available1) true)))
(assert (= o14 o16))
(assert (= o15 o17))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 r145b)) (= temp___262 i1)))
