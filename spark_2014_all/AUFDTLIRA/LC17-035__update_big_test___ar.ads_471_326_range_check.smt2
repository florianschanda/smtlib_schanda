...
(assert (=> (< 0 e) (= o17 (+ k 1))))
(assert (=> (< 0 e) (= temp___5270 (select a o17))))
(assert (=> (< 0 e) (= o19 (select temp___5270 j))))
(assert (=> (< 0 e) (= o20 (temp___1564 o19 i o18))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o16 (+ k 1))))
(assert (=> (< 0 e) (= o21 (select a o16))))
(assert (=> (< 0 e) (= o22 (temp___1557 o21 j o20))))
(assert (=> (< 0 e) (and (= o23 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5271 (temp___1534 a k (temp___1542 (select a k) j (temp___1549 (select (select a k) j) i e)) o23 o22))))
(assert (=> (< 0 e) (= result6 (bool_eq2 a3 1 16 temp___5271 1 16))))
(assert (=> (not (< 0 e)) (= result6 false)))
(assert (not (= result6 true)))
(assert (= e 0))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o11 (+ k 1)))
(assert (= temp___5280 (select a o11)))
(assert (= o12 (select temp___5280 j)))
(assert (= o13 (temp___1603 o12 i 99)))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o10 (+ k 1)))
(assert (= o14 (select a o10)))
(assert (= o15 (temp___1596 o14 j o13)))
