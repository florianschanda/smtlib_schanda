...
(assert (= a4 a2))
(assert (< k 16))
(assert (=> (< 0 e) (and (= o20 (- e 1)) (in_range3 (- e 1)))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o19 (+ k 1))))
(assert (=> (< 0 e) (= temp___5211 (select a o19))))
(assert (=> (< 0 e) (= o21 (select temp___5211 j))))
(assert (=> (< 0 e) (= o22 (temp___1505 o21 i o20))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o18 (+ k 1))))
(assert (=> (< 0 e) (= o23 (select a o18))))
(assert (=> (< 0 e) (= o24 (temp___1498 o23 j o22))))
(assert (=> (< 0 e) (and (= o25 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5212 (temp___1475 a k (temp___1483 (select a k) j (temp___1490 (select (select a k) j) i e)) o25 o24))))
(assert (=> (< 0 e) (= result7 (bool_eq2 a3 1 16 temp___5212 1 16))))
(assert (=> (not (< 0 e)) (= result7 false)))
(assert (not (= result7 true)))
(assert (= e 0))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o12 (+ k 1)))
(assert (= temp___5221 (select a o12)))
(assert (= o13 (select temp___5221 j)))
(assert (= o14 (temp___1544 o13 i 99)))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o11 (+ k 1)))
(assert (= o15 (select a o11)))
(assert (= o16 (temp___1537 o15 j o14)))
(assert (not (in_range2 (+ k 1))))
(check-sat)
(exit)
