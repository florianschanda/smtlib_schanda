...
(declare-const o21 (Array Int (Array Int et1)))
...
(assert (= a4 a2))
(assert (< k 16))
(assert (=> (< 0 e) (and (= o18 (- e 1)) (in_range3 (- e 1)))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o17 (+ k 1))))
(assert (=> (< 0 e) (= temp___5211 (select a o17))))
(assert (=> (< 0 e) (= o19 (select temp___5211 j))))
(assert (=> (< 0 e) (= o20 (temp___1505 o19 i o18))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o16 (+ k 1))))
(assert (=> (< 0 e) (= o21 (select a o16))))
(assert (=> (< 0 e) (= o22 (temp___1498 o21 j o20))))
(assert (=> (< 0 e) (and (= o23 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5212 (temp___1475 a k (temp___1483 (select a k) j (temp___1490 (select (select a k) j) i e)) o23 o22))))
(assert (=> (< 0 e) (= result6 (bool_eq2 a3 1 16 temp___5212 1 16))))
(assert (=> (not (< 0 e)) (= result6 false)))
(assert (not (= result6 true)))
(assert (= e 0))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o11 (+ k 1)))
(assert (= temp___5221 (select a o11)))
(assert (= o12 (select temp___5221 j)))
(assert (= o13 (temp___1544 o12 i 99)))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o10 (+ k 1)))
(assert (= o14 (select a o10)))
(assert (= o15 (temp___1537 o14 j o13)))
