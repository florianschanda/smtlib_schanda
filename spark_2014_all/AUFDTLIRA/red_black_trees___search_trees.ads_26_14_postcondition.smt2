...
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 f true true true) (dynamic_invariant i true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant1 result true false true)))) :pattern ((parent f i))))))
...
(assert (forall ((a (Array Int us_rep4)) (b (Array Int us_rep4))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (forall ((i1 Int)) (! (and (=> (and (<= a_first i1) (<= i1 a_last)) (= (select (concat3 a a_first a_last b b_first b_last) i1) (select a i1))) (=> (< a_last i1) (= (select (concat3 a a_first a_last b b_first b_last) i1) (select b (+ (- i1 a_last) (- b_first 1)))))) :pattern ((select (concat3 a a_first a_last b b_first b_last) i1)))))))
(declare-fun singleton3 (us_rep4 Int) (Array Int us_rep4))
(assert (forall ((v us_rep4)) (forall ((i1 Int)) (! (= (select (singleton3 v i1) i1) v) :pattern ((select (singleton3 v i1) i1))))))
...
(assert true)
(assert (forall ((f us_rep1)) (forall ((root Int)) (forall ((values (Array Int natural))) (! (= (= (ordered_leafs f root values) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___482 (model__ f root))) (select temp___482 i1)))) true) (= (rec__tree_model__path_type__k (us_split_fields7 (let ((temp___483 (model__ f root))) (select temp___483 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___484 (model__ f root))) (select temp___484 i1)))) (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___485 (model__ f root))) (select temp___485 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___480 (model__ f root))) (select temp___480 j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields7 (let ((temp___481 (model__ f root))) (select temp___481 i1))))) 1)) 0) (< (to_rep2 (select values j)) (to_rep2 (select values i1))) (< (to_rep2 (select values i1)) (to_rep2 (select values j)))))))))) :pattern ((ordered_leafs f root values)))))))
...
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant2 f true true true) (dynamic_invariant1 (size f) true false true)) :pattern ((size f)))))
(assert (forall ((f us_rep1)) (forall ((i1 Int)) (! (=> (and (dynamic_invariant2 f true true true) (dynamic_invariant i1 true true true)) (=> (< (size f) i1) (not (= (valid_root f i1) true)))) :pattern ((valid_root f i1))))))
(declare-fun position (us_rep1 Int) Int)
(declare-fun position__function_guard (Int us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((i1 Int)) (! (=> (and (and (dynamic_invariant2 f true true true) (dynamic_invariant i1 true true true)) (not (= (parent f i1) 0))) (dynamic_invariant6 (position f i1) true false true)) :pattern ((position f i1))))))
(assert (forall ((f us_rep1)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant2 f true true true) (dynamic_invariant root true true true)) (= (valid_root f root) true)) (let ((result (model__ f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields7 (select result (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields7 (select result i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields7 (select result i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select result i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields7 (select result i1))) (rec__tree_model__path_type__a (us_split_fields7 (select result j)))) true)) (= j i1))))))))))) (dynamic_invariant8 result true false true)))) :pattern ((model__ f root))))))
...
(assert (and (= o (parent (rec__search_trees__search_tree__struct (us_split_fields5 t)) i)) (and (in_range2 o) (and (=> (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields5 t)) i) true) (= o 0)) (=> (= (size (rec__search_trees__search_tree__struct (us_split_fields5 t))) 0) (= o 0))))))
