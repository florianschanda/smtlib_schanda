...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= temp___948 i1)))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (= temp___947 res1)))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (<= (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)) res2)))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (and (and (=> (<= (- 2147483648) 2147483647) (in_range2 res2)) (=> (<= 2 r35b) (dynamic_property2 2 r35b i2))) (and (<= 2 i2) (<= i2 r35b)))))
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))))
...
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (=> (= result2 true) (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))))))
...
(assert (=> (and (<= 2 i1) (<= i1 r35b)) (=> (= result2 true) (= o8 (to_rep1 o7)))))
