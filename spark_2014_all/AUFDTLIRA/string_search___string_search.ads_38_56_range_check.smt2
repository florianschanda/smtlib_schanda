...
(assert (or (and (and (and (= string_search__brute_force_slice__result18 (mk_int__ref string_search__brute_force_slice__result5)) (= i14 (mk_int__ref i4))) (and (= string_search__brute_force_slice__result15 string_search__brute_force_slice__result6) (= i11 i5))) (and (= temp___279 1) (and (and (and (and (and (and (= o (length needle)) (in_range1 (length needle))) (and (and (= o1 (length haystack)) (in_range1 (length haystack))) (= o2 (- o1 o)))) (and (= o3 o2) (in_range1 o2))) (= o4 (+ o3 1))) (and (= temp___280 o4) (in_range1 o4))) (and (and (= result8 i16) (= i1 temp___279)) (and (and (<= temp___279 i1) (<= i1 temp___280)) (and (= temp___278 i1) (or (and (and (and (= string_search__brute_force_slice__result2 string_search__brute_force_slice__result5) (= i1 i4)) (and (= string_search__brute_force_slice__result6 string_search__brute_force_slice__result2) (= i5 i1))) (and (and (and (and (and (and (= o5 (- (to_rep1 (last (rt needle))) 1)) (in_range1 (- (to_rep1 (last (rt needle))) 1))) (= o6 (+ i1 o5))) (and (= temp___276 o6) (in_range1 o6))) (and (and (=> (<= i1 temp___276) (and (and (<= (to_rep1 (first (rt haystack))) i1) (<= i1 (to_rep1 (last (rt haystack))))) (and (<= (to_rep1 (first (rt haystack))) temp___276) (<= temp___276 (to_rep1 (last (rt haystack))))))) (= o7 (elts haystack))) (and (= o7 temp___277) (= (mk1 i1 temp___276) temp___2771)))) (= result1 (bool_eq (elts needle) (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) temp___277 (to_rep1 (first2 temp___2771)) (to_rep1 (last2 temp___2771))))) (and (= result1 true) (and (= (mk_int__ref result2) string_search__brute_force_slice__result20) (= string_search__brute_force_slice__result2 i1))))) (and (and (and (and (and (and (and (= o5 (- (to_rep1 (last (rt needle))) 1)) (in_range1 (- (to_rep1 (last (rt needle))) 1))) (= o6 (+ i1 o5))) (and (= temp___276 o6) (in_range1 o6))) (and (and (=> (<= i1 temp___276) (and (and (<= (to_rep1 (first (rt haystack))) i1) (<= i1 (to_rep1 (last (rt haystack))))) (and (<= (to_rep1 (first (rt haystack))) temp___276) (<= temp___276 (to_rep1 (last (rt haystack))))))) (= o7 (elts haystack))) (and (= o7 temp___277) (= (mk1 i1 temp___276) temp___2771)))) (= result1 (bool_eq (elts needle) (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) temp___277 (to_rep1 (first2 temp___2771)) (to_rep1 (last2 temp___2771))))) (and (not (= result1 true)) (and (= string_search__brute_force_slice__result2 string_search__brute_force_slice__result) (= string_search__brute_force_slice__result2 string_search__brute_force_slice__result1)))) (and (and (and (= string_search__brute_force_slice__result4 string_search__brute_force_slice__result5) (= i3 i4)) (and (= string_search__brute_force_slice__result6 string_search__brute_force_slice__result4) (= i5 i3))) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k i2)) (not (= (match_at needle haystack k) true)))) (and (and (=> (<= 1 (+ (- (length haystack) (length needle)) 1)) (dynamic_property1 1 (+ (- (length haystack) (length needle)) 1) i2)) (and (<= 1 i2) (<= i2 (+ (- (length haystack) (length needle)) 1)))) (and (not (= i2 temp___280)) (and (and (= i2 result3) (= i3 (+ i2 1))) (and (and (and (and (and (and (= o8 (- (to_rep1 (last (rt needle))) 1)) (in_range1 (- (to_rep1 (last (rt needle))) 1))) (= o9 (+ i3 o8))) (and (= temp___2761 o9) (in_range1 o9))) (and (and (=> (<= i3 temp___2761) (and (and (<= (to_rep1 (first (rt haystack))) i3) (<= i3 (to_rep1 (last (rt haystack))))) (and (<= (to_rep1 (first (rt haystack))) temp___2761) (<= temp___2761 (to_rep1 (last (rt haystack))))))) (= o10 (elts haystack))) (and (= o10 temp___2772) (= (mk1 i3 temp___2761) temp___2773)))) (= result4 (bool_eq (elts needle) (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) temp___2772 (to_rep1 (first2 temp___2773)) (to_rep1 (last2 temp___2773))))) (and (= result4 true) (and (= string_search__brute_force_slice__result3 result5) (= string_search__brute_force_slice__result4 i3))))))))))))))))) (and (and (and (and (and (and (and (= o (length needle)) (in_range1 (length needle))) (and (and (= o1 (length haystack)) (in_range1 (length haystack))) (= o2 (- o1 o)))) (and (= o3 o2) (in_range1 o2))) (= o4 (+ o3 1))) (and (= temp___280 o4) (in_range1 o4))) (and (and (= result8 i16) (= i1 1)) (ite (and (<= 1 i1) (<= i1 temp___280)) (and (and (and (= temp___278 i1) (and (and (and (and (and (and (and (= o5 (- (to_rep1 (last (rt needle))) 1)) (in_range1 (- (to_rep1 (last (rt needle))) 1))) (= o6 (+ i1 o5))) (and (= temp___276 o6) (in_range1 o6))) (and (and (=> (<= i1 temp___276) (and (and (<= (to_rep1 (first (rt haystack))) i1) (<= i1 (to_rep1 (last (rt haystack))))) (and (<= (to_rep1 (first (rt haystack))) temp___276) (<= temp___276 (to_rep1 (last (rt haystack))))))) (= o7 (elts haystack))) (and (= o7 temp___277) (= (mk1 i1 temp___276) temp___2771)))) (= result1 (bool_eq (elts needle) (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) temp___277 (to_rep1 (first2 temp___2771)) (to_rep1 (last2 temp___2771))))) (and (not (= result1 true)) (and (= string_search__brute_force_slice__result2 string_search__brute_force_slice__result) (= string_search__brute_force_slice__result2 string_search__brute_force_slice__result1)))) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k i2)) (not (= (match_at needle haystack k) true)))) (and (and (=> (<= 1 (+ (- (length haystack) (length needle)) 1)) (dynamic_property1 1 (+ (- (length haystack) (length needle)) 1) i2)) (and (<= 1 i2) (<= i2 (+ (- (length haystack) (length needle)) 1)))) (= i2 temp___280))))) (and (and (= string_search__brute_force_slice__result3 string_search__brute_force_slice__result7) (= i2 i6)) (and (= string_search__brute_force_slice__result8 string_search__brute_force_slice__result3) (= i7 i2)))) (and (and (= string_search__brute_force_slice__result19 (mk_int__ref string_search__brute_force_slice__result7)) (= i15 (mk_int__ref i6))) (and (= string_search__brute_force_slice__result10 string_search__brute_force_slice__result8) (= i9 i7)))) (and (and (= string_search__brute_force_slice__result19 string_search__brute_force_slice__result20) (= i1 i8)) (and (= string_search__brute_force_slice__result10 string_search__brute_force_slice__result1) (= i9 i1)))))) (and (and (and (= string_search__brute_force_slice__result18 (mk_int__ref string_search__brute_force_slice__result12)) (= i14 i15)) (and (= string_search__brute_force_slice__result15 string_search__brute_force_slice__result13) (= i11 i9))) (and (and (= string_search__brute_force_slice__result11 string_search__brute_force_slice__result12) (= string_search__brute_force_slice__result13 string_search__brute_force_slice__result11)) (and (= (mk_int__ref result6) string_search__brute_force_slice__result19) (= string_search__brute_force_slice__result11 0)))))))
...
(assert (and (= o12 (length haystack)) (in_range1 (length haystack))))
(assert (= o13 (- o12 o11)))
(assert (and (= o14 o13) (in_range1 o13)))
(assert (= o15 (+ o14 1)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (= o17 (ite (<= (int__content string_search__brute_force_slice__result16) o16) true false)))
(assert (= result7 (ite (<= 0 (int__content string_search__brute_force_slice__result16)) o17 false)))
(assert (= result7 true))
(assert (< 0 (int__content string_search__brute_force_slice__result16)))
(assert (not (in_range2 (int__content string_search__brute_force_slice__result16))))
(check-sat)
(exit)
