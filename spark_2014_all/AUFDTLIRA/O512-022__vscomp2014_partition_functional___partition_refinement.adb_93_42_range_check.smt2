...
(assert (not (in_range7 (+ (to_rep4 (rec__partition_refinement__interval__first p_elem__split_fields3)) (to_rep3 (rec__partition_refinement__interval__count p_elem__split_fields3))))))
(check-sat)
(exit)
