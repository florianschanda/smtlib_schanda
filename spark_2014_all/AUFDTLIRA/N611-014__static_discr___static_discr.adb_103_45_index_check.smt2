...
(assert (not (<= (to_rep1 (first4 (rt2 (rec__static_discr__i_holder__content2 (us_split_fields7 (of_base1 (to_base (mk___rep1 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields1 (mk___t1 current__split_fields2 current__split_fields3)))))))))) (to_rep current__split_fields4))))
(check-sat)
(exit)
