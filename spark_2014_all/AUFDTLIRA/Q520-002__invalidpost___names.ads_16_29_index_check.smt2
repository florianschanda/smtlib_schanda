...
(assert (and (and (and (= names__is_domain_name__result40 names__is_domain_name__result38) (and (= i18 i16) (and (= ch16 ch14) (and (= label_length21 label_length19) (= state19 state17))))) (and (= names__is_domain_name__result41 names__is_domain_name__result39) (and (= i19 i17) (and (= ch17 ch15) (and (= label_length22 label_length20) (= state20 state18)))))) (ite (=> (not (< (length name) 1)) (< 255 (length name))) (and (and (and (= names__is_domain_name__result38 (mk_bool__ref names__is_domain_name__result2)) (and (= i16 (mk_int__ref i)) (and (= ch14 (mk_int__ref ch)) (and (= label_length19 (mk_int__ref label_length1)) (= state17 (mk_int__ref state1)))))) (and (= names__is_domain_name__result39 names__is_domain_name__result2) (and (= i17 i2) (and (= ch15 ch1) (and (= label_length20 label_length1) (= state18 state1)))))) (and (= (mk_bool__ref result2) (mk_bool__ref names__is_domain_name__result)) (= names__is_domain_name__result2 (of_int 0)))) (and (and (and (= names__is_domain_name__result38 names__is_domain_name__result34) (and (= i16 i12) (and (= ch14 ch10) (and (= label_length19 label_length15) (= state17 state13))))) (and (= names__is_domain_name__result39 names__is_domain_name__result35) (and (= i17 i13) (and (= ch15 ch11) (and (= label_length20 label_length16) (= state18 state14)))))) (or (and (and (and (= names__is_domain_name__result34 names__is_domain_name__result15) (and (= i12 (mk_int__ref i4)) (and (= ch10 (mk_int__ref ch3)) (and (= label_length15 (mk_int__ref label_length2)) (= state13 (mk_int__ref state2)))))) (and (= names__is_domain_name__result35 names__is_domain_name__result16) (and (= i13 i4) (and (= ch11 ch3) (and (= label_length16 label_length2) (= state14 state2)))))) (and (= temp___204 (to_rep1 (first (rt name)))) (and (= temp___205 (to_rep1 (last (rt name)))) (and (and (= (mk_int__ref result3) (mk_int__ref i)) (= i3 temp___204)) (and (and (<= temp___204 i3) (<= i3 temp___205)) (and (= temp___203 ch) (and (= temp___202 label_length1) (and (= temp___201 state1) (and (= temp___200 i3) (and (< label_length2 (+ (- i4 (to_rep1 (first (rt name)))) 1)) (and (and (and (and (and (=> (<= (to_rep1 (first (rt name))) (to_rep1 (last (rt name)))) (dynamic_property1 (to_rep1 (first (rt name))) (to_rep1 (last (rt name))) i4)) (=> (<= 0 2) (in_range5 state2))) (=> (<= 0 255) (in_range6 label_length2))) (=> (<= 0 255) (in_range3 ch2))) (and (<= (to_rep1 (first (rt name))) i4) (<= i4 (to_rep1 (last (rt name)))))) (and (and (= ch2 result4) (= ch3 (to_rep (select (elts name) i4)))) (or (and (and (= names__is_domain_name__result15 (mk_bool__ref names__is_domain_name__result4)) (= names__is_domain_name__result16 names__is_domain_name__result4)) (and (not (in_range4 ch3)) (and (= names__is_domain_name__result3 result5) (= names__is_domain_name__result4 (of_int 0))))) (and (and (in_range4 ch3) (= names__is_domain_name__result4 names__is_domain_name__result3)) (and (and (= names__is_domain_name__result15 names__is_domain_name__result13) (= names__is_domain_name__result16 names__is_domain_name__result14)) (ite (= state2 0) (and (and (= names__is_domain_name__result13 (mk_bool__ref names__is_domain_name__result5)) (= names__is_domain_name__result14 names__is_domain_name__result5)) (and (and (= o3 (is_letter ch3)) (= result6 (ite (not (= o3 true)) true false))) (and (= result6 true) (and (= names__is_domain_name__result4 result7) (= names__is_domain_name__result5 (of_int 0)))))) (and (and (= names__is_domain_name__result13 names__is_domain_name__result11) (= names__is_domain_name__result14 names__is_domain_name__result12)) (ite (= state2 1) (and (and (= names__is_domain_name__result11 names__is_domain_name__result8) (= names__is_domain_name__result12 names__is_domain_name__result9)) (ite (= ch3 46) (and (and (= names__is_domain_name__result8 (mk_bool__ref names__is_domain_name__result6)) (= names__is_domain_name__result9 names__is_domain_name__result6)) (and (< 63 label_length2) (and (= names__is_domain_name__result4 result10) (= names__is_domain_name__result6 (of_int 0))))) (and (and (= names__is_domain_name__result8 (mk_bool__ref names__is_domain_name__result7)) (= names__is_domain_name__result9 names__is_domain_name__result7)) (and (not (= ch3 45)) (and (and (and (= o6 (is_digit ch3)) (and (= o7 (is_letter ch3)) (= o8 (ite (= o7 false) o6 true)))) (= result15 (ite (not (= o8 true)) true false))) (and (= result15 true) (and (= names__is_domain_name__result4 result16) (= names__is_domain_name__result7 (of_int 0))))))))) (and (and (= names__is_domain_name__result11 (mk_bool__ref names__is_domain_name__result10)) (= names__is_domain_name__result12 names__is_domain_name__result10)) (and (not (= ch3 45)) (and (and (and (= o11 (is_digit ch3)) (and (= o12 (is_letter ch3)) (= o13 (ite (= o12 false) o11 true)))) (= result19 (ite (not (= o13 true)) true false))) (and (= result19 true) (and (= result20 (mk_bool__ref names__is_domain_name__result4)) (= names__is_domain_name__result10 (of_int 0))))))))))))))))))))))))) (and (and (and (= (mk_int__ref result3) (mk_int__ref i)) (= i3 (to_rep1 (first (rt name))))) (ite (and (<= (to_rep1 (first (rt name))) i3) (<= i3 (to_rep1 (last (rt name))))) (and (and (and (= temp___203 ch) (and (= temp___202 label_length1) (and (= temp___201 state1) (and (= temp___200 i3) (and (< label_length2 (+ (- i4 (to_rep1 (first (rt name)))) 1)) (and (and (and (and (and (=> (<= (to_rep1 (first (rt name))) (to_rep1 (last (rt name)))) (dynamic_property1 (to_rep1 (first (rt name))) (to_rep1 (last (rt name))) i4)) (=> (<= 0 2) (in_range5 state2))) (=> (<= 0 255) (in_range6 label_length2))) (=> (<= 0 255) (in_range3 ch2))) (and (<= (to_rep1 (first (rt name))) i4) (<= i4 (to_rep1 (last (rt name)))))) (and (and (= ch2 result4) (= ch3 (to_rep (select (elts name) i4)))) (and (and (in_range4 ch3) (= names__is_domain_name__result4 names__is_domain_name__result3)) (and (ite (= state2 0) (and (and (= o3 (is_letter ch3)) (= result6 (ite (not (= o3 true)) true false))) (and (not (= result6 true)) (and (and (and (= state2 result8) (= state3 1)) (and (and (= o4 (+ label_length2 1)) (in_range6 (+ label_length2 1))) (and (= label_length2 result9) (= label_length3 o4)))) (= names__is_domain_name__result5 names__is_domain_name__result4)))) (and (ite (= state2 1) (ite (= ch3 46) (and (and (not (< 63 label_length2)) (= names__is_domain_name__result6 names__is_domain_name__result4)) (and (and (= state2 result11) (= state4 0)) (and (= label_length2 result12) (= label_length4 0)))) (and (ite (= ch3 45) (and (and (and (= state2 result13) (= state5 2)) (and (and (= o5 (+ label_length2 1)) (in_range6 (+ label_length2 1))) (and (= label_length2 result14) (= label_length5 o5)))) (= names__is_domain_name__result7 names__is_domain_name__result4)) (and (and (and (and (= o6 (is_digit ch3)) (and (= o7 (is_letter ch3)) (= o8 (ite (= o7 false) o6 true)))) (= result15 (ite (not (= o8 true)) true false))) (and (not (= result15 true)) (and (and (and (= o9 (+ label_length2 1)) (in_range6 (+ label_length2 1))) (and (= label_length2 result17) (= label_length6 o9))) (= names__is_domain_name__result7 names__is_domain_name__result4)))) (and (= label_length5 label_length6) (= state5 state2)))) (and (= names__is_domain_name__result6 names__is_domain_name__result7) (and (= label_length4 label_length5) (= state4 state5))))) (and (ite (= ch3 45) (and (and (and (= o10 (+ label_length2 1)) (in_range6 (+ label_length2 1))) (and (= result18 (mk_int__ref label_length2)) (= label_length7 o10))) (and (= names__is_domain_name__result10 names__is_domain_name__result4) (= state6 state2))) (and (and (and (and (= o11 (is_digit ch3)) (and (= o12 (is_letter ch3)) (= o13 (ite (= o12 false) o11 true)))) (= result19 (ite (not (= o13 true)) true false))) (and (not (= result19 true)) (and (and (and (= result21 (mk_int__ref state2)) (= state6 1)) (and (and (= o14 (+ label_length2 1)) (in_range6 (+ label_length2 1))) (and (= result22 (mk_int__ref label_length2)) (= label_length8 o14)))) (= names__is_domain_name__result10 names__is_domain_name__result4)))) (= label_length7 label_length8))) (and (= names__is_domain_name__result6 names__is_domain_name__result10) (and (= label_length4 label_length7) (= state4 state6))))) (and (= names__is_domain_name__result5 names__is_domain_name__result6) (and (= label_length3 label_length4) (= state3 state4))))) (= i4 (to_rep1 (last (rt name))))))))))))) (and (and (= names__is_domain_name__result19 (mk_bool__ref names__is_domain_name__result5)) (and (= i8 (mk_int__ref i4)) (and (= ch6 (mk_int__ref ch3)) (and (= label_length11 (mk_int__ref label_length3)) (= state9 (mk_int__ref state3)))))) (and (= names__is_domain_name__result20 names__is_domain_name__result5) (and (= i9 i4) (and (= ch7 ch3) (and (= label_length12 label_length3) (= state10 state3))))))) (and (and (= names__is_domain_name__result21 names__is_domain_name__result19) (and (= i10 i8) (and (= ch8 ch6) (and (= label_length13 label_length11) (= state11 state9))))) (and (= names__is_domain_name__result22 names__is_domain_name__result20) (and (= i11 i9) (and (= ch9 ch7) (and (= label_length14 label_length12) (= state12 state10))))))) (and (and (= names__is_domain_name__result21 (mk_bool__ref names__is_domain_name__result)) (and (= i10 (mk_int__ref i3)) (and (= ch8 (mk_int__ref ch)) (and (= label_length13 (mk_int__ref label_length1)) (= state11 (mk_int__ref state1)))))) (and (= names__is_domain_name__result22 names__is_domain_name__result1) (and (= i11 i3) (and (= ch9 ch1) (and (= label_length14 label_length1) (= state12 state1)))))))) (and (and (and (= names__is_domain_name__result34 names__is_domain_name__result32) (and (= i12 i10) (and (= ch10 ch8) (and (= label_length15 label_length13) (= state13 state11))))) (and (= names__is_domain_name__result35 names__is_domain_name__result33) (and (= i13 i11) (and (= ch11 ch9) (and (= label_length16 label_length14) (= state14 state12)))))) (or (and (and (= names__is_domain_name__result32 names__is_domain_name__result29) (= names__is_domain_name__result33 names__is_domain_name__result30)) (ite (= (int__content state11) 0) (and (and (= names__is_domain_name__result29 (mk_bool__ref names__is_domain_name__result23)) (= names__is_domain_name__result30 names__is_domain_name__result23)) (and (= result24 names__is_domain_name__result21) (= names__is_domain_name__result23 (of_int 0)))) (and (and (= names__is_domain_name__result29 (mk_bool__ref names__is_domain_name__result24)) (= names__is_domain_name__result30 names__is_domain_name__result24)) (and (not (= (int__content state11) 1)) (and (= result25 names__is_domain_name__result21) (= names__is_domain_name__result24 (of_int 0))))))) (and (and (not (= (int__content state11) 0)) (and (and (= (int__content state11) 1) (and (= names__is_domain_name__result25 names__is_domain_name__result21) (= names__is_domain_name__result26 names__is_domain_name__result22))) (and (= names__is_domain_name__result27 names__is_domain_name__result25) (= names__is_domain_name__result28 names__is_domain_name__result26)))) (and (and (= names__is_domain_name__result32 (mk_bool__ref names__is_domain_name__result31)) (= names__is_domain_name__result33 names__is_domain_name__result31)) (and (= result26 names__is_domain_name__result27) (= names__is_domain_name__result31 (of_int 1)))))))))))))
(assert (= names__is_domain_name__result42 names__is_domain_name__result40))
(assert (= i20 i18))
(assert (= ch18 ch16))
(assert (= label_length23 label_length21))
(assert (= state21 state19))
(assert (= names__is_domain_name__result43 names__is_domain_name__result41))
(assert (= i21 i19))
(assert (= ch19 ch17))
(assert (= label_length24 label_length22))
(assert (= state22 state20))
(assert (= (bool__content names__is_domain_name__result42) true))
(assert (<= (to_rep1 (first (rt name))) i1))
(assert (<= i1 (to_rep1 (last (rt name)))))
(assert (and (<= (to_rep1 (first (rt name))) i1) (<= i1 (to_rep1 (last (rt name))))))
(assert (= o19 i1))
(assert (= o20 (select (elts name) o19)))
(assert (= o21 (to_rep o20)))
(assert (= o22 (ite (= o21 45) true false)))
(assert (and (<= (to_rep1 (first (rt name))) i1) (<= i1 (to_rep1 (last (rt name))))))
(assert (= o15 i1))
(assert (= o16 (select (elts name) o15)))
(assert (= o17 (to_rep o16)))
(assert (= o18 (is_digit o17)))
(assert (not (<= (to_rep1 (first (rt name))) i1)))
(check-sat)
(exit)
