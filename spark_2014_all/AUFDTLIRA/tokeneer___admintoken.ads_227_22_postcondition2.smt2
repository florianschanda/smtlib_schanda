...
(declare-fun user_eq17 (keyidt keyidt) Bool)
(declare-const dummy17 keyidt)
...
(declare-fun user_eq18 (keylengtht keylengtht) Bool)
(declare-const dummy18 keylengtht)
...
(define-fun bool_eq6 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (= (to_rep9 (rec__cryptotypes__keypartt__algorithmid (us_split_fields11 a))) (to_rep9 (rec__cryptotypes__keypartt__algorithmid (us_split_fields11 b)))) (= (to_rep11 (rec__cryptotypes__keypartt__keyid (us_split_fields11 a))) (to_rep11 (rec__cryptotypes__keypartt__keyid (us_split_fields11 b))))) (= (to_rep12 (rec__cryptotypes__keypartt__keylength (us_split_fields11 a))) (to_rep12 (rec__cryptotypes__keypartt__keylength (us_split_fields11 b))))) true false))
...
(define-fun bool_eq7 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__id__contentst__id (us_split_fields13 a)) (rec__cert__id__contentst__id (us_split_fields13 b))) true) (= (bool_eq (rec__cert__id__contentst__notbefore (us_split_fields13 a)) (rec__cert__id__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq (rec__cert__id__contentst__notafter (us_split_fields13 a)) (rec__cert__id__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep9 (rec__cert__id__contentst__mechanism (us_split_fields13 a))) (to_rep9 (rec__cert__id__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq2 (rec__cert__id__contentst__subject (us_split_fields13 a)) (rec__cert__id__contentst__subject (us_split_fields13 b))) true)) (= (bool_eq6 (rec__cert__id__contentst__subjectpublickey (us_split_fields13 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields13 b))) true)) true false))
