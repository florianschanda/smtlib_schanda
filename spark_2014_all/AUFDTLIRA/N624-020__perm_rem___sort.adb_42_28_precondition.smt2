...
(assert (and (= (mk___t o41 o42) (remove (mk___t interm1 (mk 1 100)) o40)) (and (dynamic_invariant4 (mk___t o41 o42) true false true) (and (= (invariant__ (mk___t o41 o42)) true) (and (= (to_rep1 (last o42)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o40 1))) (= (to_rep (select interm1 k)) (to_rep (select o41 k))))) (and (forall ((k Int)) (=> (and (<= (+ o40 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select o41 (- k 1)))))) (forall ((k Int)) (=> (and (<= o40 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select o41 k))))))))))))
(assert (not (= (invariant__ (mk___t o41 o42)) true)))
(check-sat)
(exit)
