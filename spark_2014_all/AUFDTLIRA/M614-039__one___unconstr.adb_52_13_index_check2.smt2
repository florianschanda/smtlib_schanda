...
(assert (forall ((i tsP1)) (and (<= 1 (tsP1qtint i)) (<= (tsP1qtint i) 10))))
...
(declare-datatypes () ((tsP1__ref (mk_tsP1__ref (tsP1__content tsP1)))))
(define-fun tsP1__ref___projection ((a tsP1__ref)) tsP1 (tsP1__content a))
(declare-const x Int)
...
(assert (forall ((temp___241 Int)) (=> (dynamic_invariant2 temp___241 true true true true) (forall ((temp___242 Int)) (= (to_rep (select (unconstr__constr_return_call__s__aggregate_def temp___241) temp___242)) temp___241)))))
...
(assert (in_range1 x))
(assert (= x c22b))
(assert (in_range1 c22b))
(assert (= result s))
(assert (= s1 (unconstr__constr_return_call__s__aggregate_def 32)))
(assert (= (to_rep1 s__first) (to_rep1 (first (mk 1 10)))))
(assert (= (to_rep1 s__last) (to_rep1 (last (mk 1 10)))))
...
(assert (and (forall ((temp___248 Int)) (=> (and (<= (to_rep1 s__first) temp___248) (<= temp___248 (to_rep1 s__last))) (=> (or (< (to_rep1 s__last) temp___248) (or (< temp___248 (to_rep1 s__first)) (<= i2 temp___248))) (= (select s2 temp___248) (select s1 temp___248))))) (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last)))))
(assert (= (to_rep o) 32))
