...
(define-fun values11 () map__ref (mk_map__ref values7))
(define-fun current12 () int__ref (mk_int__ref current6))
(define-fun smallest12 () int__ref (mk_int__ref smallest6))
(define-fun values12 () map__ref (mk_map__ref values5))
(define-fun current13 () int__ref (mk_int__ref current))
(define-fun smallest13 () int__ref (mk_int__ref smallest))
(define-fun values13 () map__ref (mk_map__ref values))
(assert (dynamic_property 1 100 (to_rep values__first) (to_rep values__last)))
(assert (=> (<= 1 2147483647) (in_range2 smallest)))
(assert (or (and (and (and (= current8 current13) (and (= smallest8 smallest13) (= values11 values13))) (and (= current9 current1) (and (= smallest9 smallest1) (= values8 values1)))) (and (and (ite (<= (to_rep values__first) (to_rep values__last)) (= o (+ (- (to_rep values__last) (to_rep values__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (= result true))) (and (and (and (ite (<= (to_rep values__first) (to_rep values__last)) (= o (+ (- (to_rep values__last) (to_rep values__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (not (= result true))) (and (and (and (= current8 current12) (and (= smallest8 smallest12) (= values11 values12))) (and (= current9 current7) (and (= smallest9 smallest7) (= values8 values6)))) (and (and (= temp___190 (- (to_rep values__last) 1)) (in_range1 (- (to_rep values__last) 1))) (and (and (= (mk_int__ref result1) current13) (= current2 (to_rep values__first))) (ite (and (<= (to_rep values__first) current2) (<= current2 temp___190)) (and (and (and (= temp___196 current2) (and (= temp___195 values) (and (= temp___197 values) (and (= temp___193 smallest) (and (and (and (and (and (and (=> (<= current2 (to_rep values__last)) (and (and (<= (to_rep values__first) current2) (<= current2 (to_rep values__last))) (and (<= (to_rep values__first) (to_rep values__last)) (<= (to_rep values__last) (to_rep values__last))))) (= o1 values)) (and (= o1 temp___192) (= (mk1 current2 (to_rep values__last)) temp___1921))) (and (= temp___192 o2) (= (mk (to_rep (first2 temp___1921)) (to_rep (last2 temp___1921))) o3))) (and (= o4 (index_of_minimum (mk___t o2 o3))) (and (in_range4 o4) (and (<= (to_rep (first o3)) o4) (<= o4 (to_rep (last o3))))))) (and (= (mk_int__ref result2) smallest13) (= smallest2 o4))) (and (ite (not (= smallest2 current2)) (and (and (= o6 smallest2) (in_range4 smallest2)) (and (and (= o5 current2) (in_range4 current2)) (= (is_perm__logic (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t o7 (mk (to_rep values__first) (to_rep values__last)))) true))) (and (= o7 values) (= o7 values1))) (and (= (is_perm__logic (mk___t temp___197 (mk (to_rep values__first) (to_rep values__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true) (and (and (and (=> (<= 1 2147483647) (in_range2 smallest3)) (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property1 (to_rep values__first) (- (to_rep values__last) 1) current3))) (and (<= (to_rep values__first) current3) (<= current3 (- (to_rep values__last) 1)))) (= current3 temp___190))))))))) (and (and (= current3 current4) (and (= smallest3 smallest4) (= values2 values3))) (and (= current5 current3) (and (= smallest5 smallest3) (= values4 values2))))) (and (and (= current12 (mk_int__ref current4)) (and (= smallest12 (mk_int__ref smallest4)) (= values12 (mk_map__ref values3)))) (and (= current7 current5) (and (= smallest7 smallest5) (= values6 values4))))) (and (and (= current2 current6) (and (= smallest12 smallest13) (= values12 values13))) (and (= current7 current2) (and (= smallest7 smallest1) (= values6 values1)))))))))))
(assert (= current10 current8))
(assert (= smallest10 smallest8))
(assert (= values9 values11))
(assert (= current11 current9))
(assert (= smallest11 smallest9))
(assert (= values10 values8))
(assert (not (= (is_perm__logic (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t (map__content values9) (mk (to_rep values__first) (to_rep values__last)))) true)))
(check-sat)
(exit)
