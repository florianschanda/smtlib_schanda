...
(assert (or (and (and (and (= current11 (mk_int__ref current)) (and (= smallest11 (mk_int__ref smallest)) (= (mk_map__ref values11) (mk_map__ref values)))) (and (= current12 current1) (and (= smallest12 smallest1) (= values12 values1)))) (and (and (ite (<= (to_rep values__first) (to_rep values__last)) (= o (+ (- (to_rep values__last) (to_rep values__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (= result true))) (and (and (and (ite (<= (to_rep values__first) (to_rep values__last)) (= o (+ (- (to_rep values__last) (to_rep values__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (not (= result true))) (and (and (and (= current11 (mk_int__ref current9)) (and (= smallest11 (mk_int__ref smallest9)) (= (mk_map__ref values11) (mk_map__ref values9)))) (and (= current12 current10) (and (= smallest12 smallest10) (= values12 values10)))) (and (and (= temp___172 (- (to_rep values__last) 1)) (in_range1 (- (to_rep values__last) 1))) (and (and (= (mk_int__ref result1) (mk_int__ref current)) (= current2 (to_rep values__first))) (ite (and (<= (to_rep values__first) current2) (<= current2 temp___172)) (and (and (and (= temp___169 current2) (and (= temp___168 values) (and (= temp___170 values) (and (= temp___166 smallest) (and (and (and (and (and (and (=> (<= current2 (to_rep values__last)) (and (and (<= (to_rep values__first) current2) (<= current2 (to_rep values__last))) (and (<= (to_rep values__first) (to_rep values__last)) (<= (to_rep values__last) (to_rep values__last))))) (= o1 values)) (and (= o1 temp___165) (= (mk1 current2 (to_rep values__last)) temp___1651))) (and (= temp___165 o2) (= (mk (to_rep (first2 temp___1651)) (to_rep (last2 temp___1651))) o3))) (and (= o4 (index_of_minimum (mk___t o2 o3))) (and (in_range4 o4) (and (<= (to_rep (first o3)) o4) (<= o4 (to_rep (last o3))))))) (and (= (mk_int__ref result2) (mk_int__ref smallest)) (= smallest2 o4))) (and (ite (not (= smallest2 current2)) (and (and (= o6 smallest2) (in_range4 smallest2)) (and (and (= o5 current2) (in_range4 current2)) (= (is_perm__logic (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true))) (and (= values2 values) (= values2 values1))) (and (= (is_perm__logic (mk___t temp___170 (mk (to_rep values__first) (to_rep values__last))) (mk___t values3 (mk (to_rep values__first) (to_rep values__last)))) true) (and (and (and (=> (<= 1 2147483647) (in_range2 smallest3)) (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property1 (to_rep values__first) (- (to_rep values__last) 1) current3))) (and (<= (to_rep values__first) current3) (<= current3 (- (to_rep values__last) 1)))) (= current3 temp___172))))))))) (and (and (= current3 current7) (and (= smallest3 smallest7) (= values3 values7))) (and (= current8 current3) (and (= smallest8 smallest3) (= values8 values3))))) (and (and (= (mk_int__ref current9) (mk_int__ref current7)) (and (= (mk_int__ref smallest9) (mk_int__ref smallest7)) (= (mk_map__ref values9) (mk_map__ref values7)))) (and (= current10 current8) (and (= smallest10 smallest8) (= values10 values8))))) (and (and (= current2 current9) (and (= (mk_int__ref smallest9) (mk_int__ref smallest)) (= (mk_map__ref values9) (mk_map__ref values)))) (and (= current10 current2) (and (= smallest10 smallest1) (= values10 values1)))))))))))
(assert (= current13 current11))
(assert (= smallest13 smallest11))
(assert (= values13 (mk_map__ref values11)))
(assert (= current14 current12))
(assert (= smallest14 smallest12))
(assert (= values14 values12))
(assert (not (= (is_perm__logic (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t (map__content values13) (mk (to_rep values__first) (to_rep values__last)))) true)))
(check-sat)
(exit)
