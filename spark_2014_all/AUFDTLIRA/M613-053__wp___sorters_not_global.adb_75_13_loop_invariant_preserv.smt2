...
(assert (and (= o7 (index_of_minimum current3 limit values3)) (and (in_range2 o7) (and (and (<= current3 o7) (<= o7 limit)) (forall ((j3 Int)) (=> (and (<= current3 j3) (<= j3 limit)) (<= (to_rep (select values3 o7)) (to_rep (select values3 j3)))))))))
(assert (= smallest3 result4))
(assert (= smallest4 o7))
(assert (=> (not (= smallest4 current3)) (and (and (= (to_rep (select values4 current3)) (to_rep (select values3 smallest4))) (= (to_rep (select values4 smallest4)) (to_rep (select values3 current3)))) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 64)) (=> (and (not (= j3 current3)) (not (= j3 smallest4))) (= (to_rep (select values4 j3)) (to_rep (select values3 j3)))))))))
(assert (=> (= smallest4 current3) (= values4 values3)))
(declare-const j3 Int)
(assert (<= 1 j3))
(assert (<= j3 (- current3 1)))
