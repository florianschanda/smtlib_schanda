...
(assert (forall ((unsorted us_t)) (! (=> (and (dynamic_invariant1 unsorted true true true) (and (<= (first1 unsorted) (last1 unsorted)) (< (last1 unsorted) 2147483647))) (let ((result (index_of_minimum unsorted))) (and (and (and (<= (first1 unsorted) result) (<= result (last1 unsorted))) (forall ((j Int)) (=> (and (<= (first1 unsorted) j) (<= j (last1 unsorted))) (<= (to_rep (select (to_array unsorted) result)) (to_rep (select (to_array unsorted) j)))))) (dynamic_invariant result true false true)))) :pattern ((index_of_minimum unsorted)))))
...
(declare-datatypes () ((t26b__ref (mk_t26b__ref (t26b__content us_t1)))))
(define-fun t26b__ref___projection ((a t26b__ref)) us_t1 (t26b__content a))
...
(assert (<= 1 (ite (<= (to_rep values__first) (to_rep values__last)) (+ (- (to_rep values__last) (to_rep values__first)) 1) 0)))
(assert (=> (<= 1 2147483647) (in_range2 smallest)))
(assert (and (= temp___180 (- (to_rep values__last) 1)) (in_range1 (- (to_rep values__last) 1))))
(assert (= (mk_int__ref result) (mk_int__ref current)))
(assert (= current1 (to_rep values__first)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= temp___177 values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= temp___175 current1)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= temp___174 smallest)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (=> (<= current1 (to_rep values__last)) (and (and (<= (to_rep values__first) current1) (<= current1 (to_rep values__last))) (and (<= (to_rep values__first) (to_rep values__last)) (<= (to_rep values__last) (to_rep values__last)))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= o values)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= o temp___173)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= (mk1 current1 (to_rep values__last)) temp___1731)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= temp___173 o1)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= (mk (to_rep (first2 temp___1731)) (to_rep (last2 temp___1731))) o2)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (and (= o3 (index_of_minimum (mk___t o1 o2))) (and (in_range2 o3) (and (and (<= (to_rep (first o2)) o3) (<= o3 (to_rep (last o2)))) (forall ((j1 Int)) (=> (and (<= (to_rep (first o2)) j1) (<= j1 (to_rep (last o2)))) (<= (to_rep (select o1 o3)) (to_rep (select o1 j1))))))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= (mk_int__ref result1) smallest11)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= smallest2 o3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (=> (not (= smallest2 current1)) (and (= o4 current1) (in_range2 current1)))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (=> (not (= smallest2 current1)) (and (= (to_rep (select values2 o4)) (to_rep (select values smallest2))) (and (= (to_rep (select values2 smallest2)) (to_rep (select values o4))) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 (to_rep values__last))) (=> (and (not (= j1 o4)) (not (= j1 smallest2))) (= (to_rep (select values2 j1)) (to_rep (select values j1)))))))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (=> (not (not (= smallest2 current1))) (= values2 values))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (=> (not (not (= smallest2 current1))) (= values2 values1))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (and (and (and (<= (to_rep values__first) current2) (< current2 (to_rep values__last))) (forall ((j1 Int)) (=> (and (<= (to_rep values__first) j1) (<= j1 (- current2 1))) (<= (to_rep (select values3 j1)) (to_rep (select values3 (+ j1 1))))))) (forall ((j1 Int)) (=> (and (<= current2 j1) (<= j1 (to_rep values__last))) (<= (to_rep (select values3 current2)) (to_rep (select values3 j1))))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (and (and (=> (<= 1 2147483647) (in_range2 smallest3)) (=> (<= (to_rep values__first) (- (to_rep values__last) 1)) (dynamic_property1 (to_rep values__first) (- (to_rep values__last) 1) current2))) (and (<= (to_rep values__first) current2) (<= current2 (- (to_rep values__last) 1))))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= current2 temp___180)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= current2 current3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= smallest3 smallest4)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= values3 values4)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= current4 current2)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= smallest5 smallest3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= values5 values3)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= current9 (mk_int__ref current3))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= smallest10 (mk_int__ref smallest4))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= values10 (mk_map__ref values4))))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= current6 current4)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= smallest7 smallest5)))
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (= values7 values5)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___180))) (= current1 current5)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___180))) (= smallest10 smallest11)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___180))) (= values10 (mk_map__ref values))))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___180))) (= current6 current1)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___180))) (= smallest7 smallest1)))
(assert (=> (not (and (<= (to_rep values__first) current1) (<= current1 temp___180))) (= values7 values1)))
(assert (= current7 current9))
(assert (= smallest8 smallest10))
(assert (= (mk_map__ref values8) values10))
(assert (= current8 current6))
(assert (= smallest9 smallest7))
(assert (= values9 values7))
(assert (and (= o5 (- (to_rep values__last) 1)) (in_range1 (- (to_rep values__last) 1))))
(assert (= o6 (ite (<= j o5) true false)))
(assert (= result2 (ite (<= (to_rep values__first) j) o6 false)))
(assert (= result2 true))
(assert (and (= temp___182 (+ j 1)) (in_range1 (+ j 1))))
(assert (and (<= (to_rep values__first) temp___182) (<= temp___182 (to_rep values__last))))
(assert (= o7 temp___182))
(assert (= o8 (select values8 o7)))
(assert (= o9 (to_rep o8)))
(assert (not (<= (to_rep values__first) j)))
(check-sat)
(exit)
