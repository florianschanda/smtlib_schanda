...
(assert (forall ((temp___187 Int)) (forall ((temp___188 Int)) (= (select (temp___185 temp___187) temp___188) (of_rep2 temp___187)))))
...
(define-fun dynamic_invariant1 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 9999)) (in_range temp___expr_136)))
(define-fun dynamic_invariant2 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 10000)) (in_range1 temp___expr_142)))
