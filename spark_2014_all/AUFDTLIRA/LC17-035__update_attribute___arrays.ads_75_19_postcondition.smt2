...
(define-fun dynamic_invariant1 ((temp___expr_164 Int) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool) (temp___do_typ_inv_163 Bool)) Bool (=> (or (= temp___is_init_160 true) (<= 1 8)) (in_range3 temp___expr_164)))
...
(declare-fun temp___382 (us_t Int Int) us_t)
(define-fun dynamic_invariant2 ((temp___expr_207 us_t) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool) (temp___do_typ_inv_206 Bool)) Bool (=> (not (= temp___skip_constant_204 true)) (dynamic_property 1 8 (first1 temp___expr_207) (last1 temp___expr_207))))
(assert (forall ((temp___384 us_t)) (forall ((temp___385 Int) (temp___386 Int)) (let ((temp___383 (temp___382 temp___384 temp___385 temp___386))) (=> (and (and (dynamic_invariant2 temp___384 true true true true) (dynamic_invariant1 temp___385 true true true true)) (dynamic_invariant temp___386 true true true true)) (and (and (= (first1 temp___383) (first1 temp___384)) (= (last1 temp___383) (last1 temp___384))) (forall ((temp___387 Int)) (ite (= temp___387 temp___385) (= (to_rep (select (to_array temp___383) temp___387)) temp___386) (= (select (to_array temp___383) temp___387) (select (to_array temp___384) temp___387))))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (let ((temp___511 (temp___382 (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) i new_val))) (bool_eq a2 (to_rep1 a__first) (to_rep1 a__last) (elts temp___511) (to_rep1 (first (rt temp___511))) (to_rep1 (last (rt temp___511))))) true)))
(check-sat)
(exit)
