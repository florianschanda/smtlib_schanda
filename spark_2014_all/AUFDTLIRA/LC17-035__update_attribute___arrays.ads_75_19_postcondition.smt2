...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (let ((temp___511 (temp_____aggregate_def_382 (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) i new_val))) (bool_eq a2 (to_rep1 a__first) (to_rep1 a__last) (elts temp___511) (to_rep1 (first (rt temp___511))) (to_rep1 (last (rt temp___511))))) true)))
(check-sat)
(exit)
