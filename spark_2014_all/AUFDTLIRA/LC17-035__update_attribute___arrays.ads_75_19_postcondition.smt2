...
(define-fun dynamic_invariant1 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 1 8)) (in_range3 temp___expr_141)))
...
(declare-fun temp___353 (us_t Int Int) us_t)
(assert (forall ((temp___355 us_t)) (forall ((temp___356 Int) (temp___357 Int)) (let ((temp___354 (temp___353 temp___355 temp___356 temp___357))) (and (and (= (first1 temp___354) (first1 temp___355)) (= (last1 temp___354) (last1 temp___355))) (forall ((temp___358 Int)) (ite (= temp___358 temp___356) (= (select (to_array temp___354) temp___358) (of_rep temp___357)) (= (select (to_array temp___354) temp___358) (select (to_array temp___355) temp___358)))))))))
(define-fun dynamic_invariant2 ((temp___expr_180 us_t) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (not (= temp___skip_constant_178 true)) (dynamic_property 1 8 (first1 temp___expr_180) (last1 temp___expr_180))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (let ((temp___481 (temp___353 (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) i new_val))) (bool_eq a2 (to_rep1 a__first) (to_rep1 a__last) (elts temp___481) (to_rep1 (first (rt temp___481))) (to_rep1 (last (rt temp___481))))) true)))
(check-sat)
(exit)
