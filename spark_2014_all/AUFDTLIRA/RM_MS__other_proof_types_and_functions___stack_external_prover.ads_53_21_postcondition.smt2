...
(assert (forall ((n Int)) (forall ((stack_external_prover__my_stack__fields us_split_fields)) (! (=> (dynamic_invariant1 n true true true) (dynamic_invariant (stack_entry n stack_external_prover__my_stack__fields) true false true)) :pattern ((stack_entry n stack_external_prover__my_stack__fields))))))
...
(define-fun dynamic_invariant2 ((temp___expr_154 Int) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (or (= temp___is_init_151 true) (<= 0 100)) (in_range3 temp___expr_154)))
(define-fun dynamic_invariant3 ((temp___expr_160 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 1 100)) (in_range4 temp___expr_160)))
...
(declare-const result4 pointer_range)
...
(assert (<= 2 (count (mk___split_fields my_stack__split_fields my_stack__split_fields1))))
...
(assert (= o3 (to_rep1 my_stack__split_fields1)))
...
(assert (= o6 (- (to_rep1 my_stack__split_fields1) 1)))
(assert (= o7 (select my_stack__split_fields o6)))
(assert (= o8 (to_rep o7)))
(assert (= (to_rep o9) o8))
(assert (and (<= 1 (to_rep1 my_stack__split_fields1)) (<= (to_rep1 my_stack__split_fields1) 100)))
(assert (= o10 (to_rep1 my_stack__split_fields1)))
(assert (= o11 (store my_stack__split_fields o10 o9)))
(assert (= o11 o12))
(assert (= my_stack__split_fields1 o13))
(assert (= temp___213 o12))
(assert (= temp___2131 o13))
...
(assert (= (to_rep o14) temp1))
(assert (and (<= 1 (- (to_rep1 my_stack__split_fields3) 1)) (<= (- (to_rep1 my_stack__split_fields3) 1) 100)))
(assert (= o15 (- (to_rep1 my_stack__split_fields3) 1)))
(assert (= o16 (store my_stack__split_fields2 o15 o14)))
(assert (= o16 o17))
(assert (= my_stack__split_fields3 o18))
(assert (= temp___217 o17))
(assert (= temp___2171 o18))
(assert (= result3 my_stack__split_fields2))
(assert (= result4 my_stack__split_fields3))
(assert (= temp___217 my_stack__split_fields4))
(assert (= temp___2171 my_stack__split_fields5))
(assert (= temp1 temp2))
...
(assert (not (= (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7)) (count (mk___split_fields my_stack__split_fields my_stack__split_fields1)))))
(check-sat)
(exit)
