...
(assert (=> (and (<= 2 i2) (<= i2 last_candidate)) (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i3))) (=> (and (<= 0 j5) (<= j5 (- i3 1))) (= temp___706 winners3)))))
(assert (=> (and (<= 2 i2) (<= i2 last_candidate)) (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i3))) (=> (and (<= 0 j5) (<= j5 (- i3 1))) (= temp___705 j5)))))
...
(assert (=> (and (<= 2 i2) (<= i2 last_candidate)) (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i3))) (=> (and (<= 0 j5) (<= j5 (- i3 1))) (and (and (=> (<= 0 (- i3 1)) (dynamic_property1 0 (- i3 1) j6)) (forall ((temp___707 Int)) (=> (and (<= 0 temp___707) (<= temp___707 20)) (=> (<= j6 temp___707) (= (select winners4 temp___707) (select temp___706 temp___707)))))) (and (<= 0 j6) (<= j6 (- i3 1))))))))
...
(assert (=> (and (<= 2 i2) (<= i2 last_candidate)) (=> (< (to_rep (select counters latest_highest_score2)) (to_rep (select counters i3))) (=> (and (<= 0 j5) (<= j5 (- i3 1))) (= o1 (store winners4 o (of_int 0)))))))
...
(assert (and (and (=> (<= (+ last_candidate 1) 20) (dynamic_property2 (+ last_candidate 1) 20 i9)) (forall ((temp___718 Int)) (=> (and (<= 0 temp___718) (<= temp___718 20)) (=> (<= i9 temp___718) (= (select winners19 temp___718) (select (map__content1 winners17) temp___718)))))) (and (<= (+ last_candidate 1) i9) (<= i9 20))))
