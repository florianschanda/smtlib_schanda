...
(define-fun dynamic_invariant1 ((temp___expr_178 us_t) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (and (=> (not (= temp___skip_constant_176 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_178) (last1 temp___expr_178))) (forall ((temp___179 Int)) (=> (and (<= (first1 temp___expr_178) temp___179) (<= temp___179 (last1 temp___expr_178))) (=> (= temp___is_init_175 true) (let ((temp___180 (select (to_array temp___expr_178) temp___179))) (<= (let ((temp___182 (rec__messages__message__received (us_split_fields1 temp___180)))) (let ((temp___181 (rec__messages__message__sent (us_split_fields1 temp___180)))) (compare temp___181 1 10 temp___182 1 10))) 0)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_188 us_rep1) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool)) Bool (let ((temp___189 (rec__communications__communication__num (us_split_discrs1 temp___expr_188)))) (and (and (dynamic_property2 1 (to_rep2 temp___189) (first3 (rec__communications__communication__msgs (us_split_fields3 temp___expr_188))) (last3 (rec__communications__communication__msgs (us_split_fields3 temp___expr_188)))) (and (= (first3 (rec__communications__communication__msgs (us_split_fields3 temp___expr_188))) 1) (= (last3 (rec__communications__communication__msgs (us_split_fields3 temp___expr_188))) (to_rep2 temp___189)))) (forall ((temp___190 Int)) (=> (and (<= (first3 (rec__communications__communication__msgs (us_split_fields3 temp___expr_188))) temp___190) (<= temp___190 (last3 (rec__communications__communication__msgs (us_split_fields3 temp___expr_188))))) (=> (= temp___is_init_185 true) (let ((temp___191 (select (to_array1 (rec__communications__communication__msgs (us_split_fields3 temp___expr_188))) temp___190))) (<= (let ((temp___193 (rec__messages__message__received (us_split_fields1 temp___191)))) (let ((temp___192 (rec__messages__message__sent (us_split_fields1 temp___191)))) (compare temp___192 1 10 temp___193 1 10))) 0))))))))
(define-fun type_invariant ((temp___196 us_rep1)) Bool (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx (- (to_rep2 (rec__communications__communication__num (us_split_discrs1 temp___196))) 1))) (<= (let ((temp___201 (rec__messages__message__received (us_split_fields1 (let ((temp___199 (rec__communications__communication__msgs (us_split_fields3 temp___196)))) (select (to_array1 temp___199) (+ idx 1))))))) (let ((temp___200 (rec__messages__message__received (us_split_fields1 (let ((temp___198 (rec__communications__communication__msgs (us_split_fields3 temp___196)))) (select (to_array1 temp___198) idx)))))) (compare temp___200 1 10 temp___201 1 10))) 0))))
...
(define-fun to_base ((a1 us_rep2)) us_rep1 (mk___rep1 (us_split_discrs2 a1) (mk___split_fields1 (let ((temp___136 (rec__communications__communication__msgs1 (us_split_fields5 a1)))) (of_array1 (to_array2 temp___136) (first5 temp___136) (last5 temp___136))))))
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs1 r) (mk___split_fields2 (let ((temp___135 (rec__communications__communication__msgs (us_split_fields3 r)))) (of_array2 (to_array1 temp___135) (first3 temp___135) (last3 temp___135))))))
...
(define-fun dynamic_invariant3 ((temp___expr_267 us_rep2) (temp___is_init_264 Bool) (temp___skip_constant_265 Bool) (temp___do_toplevel_266 Bool)) Bool (and (=> (not (= temp___skip_constant_265 true)) (in_range4 (length a) (to_base temp___expr_267))) (and (and (dynamic_property4 1 (length a) (first5 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_267))) (last5 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_267)))) (and (= (first5 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_267))) 1) (= (last5 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_267))) (length a)))) (forall ((temp___269 Int)) (=> (and (<= (first5 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_267))) temp___269) (<= temp___269 (last5 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_267))))) (=> (= temp___is_init_264 true) (let ((temp___270 (select (to_array2 (rec__communications__communication__msgs1 (us_split_fields5 temp___expr_267))) temp___269))) (<= (let ((temp___272 (rec__messages__message__received (us_split_fields1 temp___270)))) (let ((temp___271 (rec__messages__message__sent (us_split_fields1 temp___270)))) (compare temp___271 1 10 temp___272 1 10))) 0))))))))
(define-fun default_initial_assumption ((temp___expr_275 us_rep2) (temp___skip_top_level_276 Bool)) Bool (= (to_rep2 (rec__communications__communication__num (us_split_discrs2 temp___expr_275))) (length a)))
...
(declare-const communications__create__result positive)
(declare-const communications__create__result1 (Array Int us_rep))
(declare-const communications__create__result2 t1)
(declare-const o Int)
...
(declare-const temp___3162 t2)
(declare-const result (Array Int us_rep))
(declare-const result1 t2)
(declare-const coms__split_fields2 (Array Int us_rep))
(declare-const coms__split_fields3 t2)
(declare-const result2 communication__ref)
(declare-const communications__create__result3 us_rep1)
(declare-const communications__create__result4 communication__ref)
(declare-const communications__create__result5 us_rep1)
(declare-const coms__split_fields4 us_split_fields__ref2)
(declare-const communications__create__result6 communication__ref)
(declare-const coms__split_fields5 us_split_fields4)
(declare-const communications__create__result7 us_rep1)
...
(assert (dynamic_invariant3 (mk___rep2 coms__split_discrs (mk___split_fields2 (mk___t2 coms__split_fields coms__split_fields1))) false false true))
