...
(assert (or (and (and (and (= search_trees__values__result6 (mk_value_set__ref search_trees__values__result2)) (and (= j8 j12) (= s8 s12))) (and (= search_trees__values__result7 search_trees__values__result2) (and (= j9 j1) (= s9 s1)))) (and (= (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) 0) (and (= (mk_value_set__ref result) (mk_value_set__ref search_trees__values__result)) (= search_trees__values__result2 s)))) (and (and (not (= (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) 0)) (and (= search_trees__values__result2 search_trees__values__result) (= search_trees__values__result2 search_trees__values__result1))) (and (and (and (= search_trees__values__result6 search_trees__values__result4) (and (= j8 j6) (= s8 s6))) (and (= search_trees__values__result7 search_trees__values__result5) (and (= j9 j7) (= s9 s7)))) (and (and (and (= (mk_int__ref result1) j12) (= j2 1)) (ite (and (<= 1 j2) (<= j2 100)) (and (and (and (= temp___673 s) (and (= temp___672 j2) (and (and (and (and (and (and (and (and (= o1 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range2 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))) (and (= temp___669 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (and (dynamic_invariant5 temp___669 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 o1))) true) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 o1)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i o1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i))) true) (not (= i o1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 i)))) true) (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 i))) true) (forall ((j13 Int)) (=> (and (<= 1 j13) (<= j13 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___669 j13))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___669 j13)))) true)) (= j13 i)))))))))))))) (= (mk___rep (mk___split_fields o2 o3)) (select temp___669 j2))) (and (= o2 o4) (= o3 o5))) (= result3 o5)) (ite (= result3 true) (and (and (= o (contains s (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2)))) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains s e) true)) (= e (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2))))) (= o true)))) (= result2 (ite (not (= o true)) true false))) (= result2 false))) (ite (= result2 true) (and (and (and (= o6 (add s (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2)))) (and (and (and (= (length o6) (+ (length s) 1)) (= (contains o6 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2))) true)) (= (ole s o6) true)) (= (included_except o6 s (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j2))) true))) (= o7 o6)) (and (= (mk_value_set__ref result4) s12) (= s2 o7))) (and (= s2 s) (= s2 s1)))) (and (and (<= (length s3) j3) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i j3)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true) (= (contains s3 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i))) true)))) (forall ((v Int)) (=> (and (<= 0 v) (<= v 2147483647)) (=> (= (contains s3 v) true) (exists ((i Int)) (and (and (<= 1 i) (<= i 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i)) v))))))))) (and (and (=> (<= 1 100) (in_range2 j3)) (and (<= 1 j3) (<= j3 100))) (= j3 100)))))) (and (and (= j3 j4) (= s3 s4)) (and (= j5 j3) (= s5 s3)))) (and (and (= j6 (mk_int__ref j4)) (= s6 (mk_value_set__ref s4))) (and (= j7 j5) (= s7 s5)))) (and (and (= j6 (mk_int__ref j2)) (= s6 s12)) (and (= j7 j2) (= s7 s1))))) (and (and (= search_trees__values__result4 (mk_value_set__ref search_trees__values__result3)) (= search_trees__values__result5 search_trees__values__result3)) (and (= result5 (mk_value_set__ref search_trees__values__result2)) (= search_trees__values__result3 (value_set__content s6)))))))))
...
(assert (= j11 j9))
(assert (= s11 s9))
(assert (= (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) 0))
(assert (not (= (is_empty (value_set__content search_trees__values__result8)) true)))
(check-sat)
(exit)
