...
(define-fun o24 () us_rep3 (mk___rep1 (mk___split_fields1 o19 o20)))
(define-fun o25 () us_rep3 (mk___rep1 (mk___split_fields1 o o1)))
...
(assert (and (= o23 (get c112b o22)) (in_range6 o23)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
