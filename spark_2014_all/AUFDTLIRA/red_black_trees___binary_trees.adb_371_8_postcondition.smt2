...
(assert (<= 1 i2))
(assert (<= i2 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) i2))) true))
(declare-const d2 Int)
(assert (<= 0 d2))
(assert (<= d2 1))
(assert (= (peek f i2 d2) 0))
(declare-const j2 Int)
(assert (<= 1 j2))
(assert (<= j2 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) j2))) true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j2)))) true))
(assert (not (not (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i2)))) 1)) d2))))
(check-sat)
(exit)
