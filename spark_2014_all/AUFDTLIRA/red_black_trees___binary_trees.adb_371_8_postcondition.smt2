...
(assert (=> (and (<= 1 n1) (<= n1 100)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) i))) true) (forall ((d Int)) (=> (and (<= 0 d) (<= d 1)) (=> (= (peek f i d) 0) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) j))) true) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j)))) true)) (<= (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i)))) n2))) (not (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i)))) 1)) d)))))))))))))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) i))) true))
(declare-const d Int)
(assert (<= 0 d))
(assert (<= d 1))
(assert (= (peek f i d) 0))
...
(assert (<= 1 j))
(assert (<= j 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) j))) true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j)))) true))
(assert (not (not (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i)))) 1)) d))))
(check-sat)
(exit)
