...
(assert (not (= (ite (<= (to_rep (first temp___1591)) (to_rep (last temp___1591))) (+ (- (to_rep (last temp___1591)) (to_rep (first temp___1591))) 1) 0) (ite (<= (to_rep x__first) (to_rep x__last)) (+ (- (to_rep x__last) (to_rep x__first)) 1) 0))))
(check-sat)
(exit)
