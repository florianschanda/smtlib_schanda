...
(assert (and (= temp___2541 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2541) (<= temp___2541 (to_rep1 (last (rt source))))))
(assert (= o temp___2541))
