...
(assert (and (= (length source) 2) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index1) (<= index1 (+ (to_rep1 (first (rt source))) 1))) (= (is_digit (to_rep (select (elts source) index1))) true))))))
(assert (and (and (and (and (and (and (and (= temp___2439 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (<= (to_rep1 (first (rt source))) temp___2439) (<= temp___2439 (to_rep1 (last (rt source))))) (= o5 temp___2439))) (= o6 (select (elts source) o5))) (= o7 (to_rep o6))) (and (and (and (and (<= 0 target1) (<= target1 9)) (= target1 (convert_character_digit_to_integer o7))) (ite (= (= o7 48) true) (= target1 0) (ite (= (= o7 49) true) (= target1 1) (ite (= (= o7 50) true) (= target1 2) (ite (= (= o7 51) true) (= target1 3) (ite (= (= o7 52) true) (= target1 4) (ite (= (= o7 53) true) (= target1 5) (ite (= (= o7 54) true) (= target1 6) (ite (= (= o7 55) true) (= target1 7) (ite (= (= o7 56) true) (= target1 8) (=> (= (= o7 57) true) (= target1 9)))))))))))) (in_range1 target1))) (and (and (and (= o8 (- target1)) (in_range1 (- target1))) (and (= target1 result1) (= target2 o8))) (and (<= (- 9) target2) (and (= result2 has_failed) (= has_failed1 (of_int 0)))))) (and (and (= has_failed1 has_failed2) (= target2 target3)) (and (= has_failed3 has_failed1) (= target4 target2)))))
(assert (= has_failed2 true))
(assert (not false))
(check-sat)
(exit)
