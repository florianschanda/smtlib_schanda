...
(define-fun us_rep___15__projection ((a us_rep)) Bool (attr__constrained a))
(define-fun tests__test_14__record_with_mutable_discrs__field__pred ((a us_rep)) Bool (= (ite (rec__tests__test_14__record_with_mutable_discrs__present (us_split_discrs1 a)) 1 0) 1))
...
(define-fun dynamic_invariant ((temp___expr_266 (Array Int us_rep)) (temp___is_init_262 Bool) (temp___skip_constant_263 Bool) (temp___do_toplevel_264 Bool) (temp___do_typ_inv_265 Bool)) Bool (forall ((temp___267 Int)) (=> (and (<= 1 temp___267) (<= temp___267 1)) (= (attr__constrained (select temp___expr_266 temp___267)) false))))
(define-fun default_initial_assumption ((temp___expr_269 (Array Int us_rep)) (temp___skip_top_level_270 Bool)) Bool (forall ((temp___271 Int)) (=> (and (<= 1 temp___271) (<= temp___271 1)) (and (= (attr__constrained (select temp___expr_269 temp___271)) false) (= (rec__tests__test_14__record_with_mutable_discrs__present (us_split_discrs1 (select temp___expr_269 temp___271))) (distinct 0 0))))))
...
(define-fun default_initial_assumption1 ((temp___expr_251 us_rep) (temp___skip_top_level_252 Bool)) Bool (and (= (attr__constrained temp___expr_251) false) (= (rec__tests__test_14__record_with_mutable_discrs__present (us_split_discrs1 temp___expr_251)) (distinct 0 0))))
(assert (forall ((temp___420 us_rep)) (= (select (tests__test_14__a__aggregate_def temp___420) 1) temp___420)))
(declare-const a (Array Int us_rep))
(declare-const result (Array Int us_rep))
(declare-const a1 (Array Int us_rep))
(assert (= result a))
(assert (= a1 (tests__test_14__a__aggregate_def (mk___rep (mk___split_discrs (distinct 0 0)) (mk___split_fields dummy) false))))
(assert (dynamic_invariant a1 true false true true))
(assert (= (attr__constrained (select a1 1)) true))
(assert (not (= (distinct 0 0) (rec__tests__test_14__record_with_mutable_discrs__present (us_split_discrs1 (select a1 1))))))
(check-sat)
(exit)
