...
(assert (and (= o13 (length model____split_fields)) (and (in_range2 o13) (<= (+ 0 o13) 2147483647))))
(assert (= result3 (ite (<= o13 10000) true false)))
(assert (=> (= result3 true) (and (= o12 (length1 model____split_fields1)) (in_range2 o12))))
(assert (=> (= result3 true) (= result2 (ite (<= o12 10000) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o8 (length1 model____split_fields1)) (in_range2 o8))))
(assert (=> (= result2 true) (and (= o9 (length model____split_fields)) (and (in_range2 o9) (<= (+ 0 o9) 2147483647)))))
(assert (=> (= result2 true) (= o10 (+ o9 o8))))
(assert (=> (= result2 true) (and (= o11 o10) (in_range7 o10))))
(assert (=> (= result2 true) (= result1 (ite (= o11 10000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o6 (length model____split_fields)) (and (in_range2 o6) (<= (+ 0 o6) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result4 (ite (< 0 o6) true false)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result4 true) (and (= o5 (get model____split_fields 1)) (in_range3 o5))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result4 true) (= result (ite (= o5 first_available) true false))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (not (= result4 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (and (= o7 (length model____split_fields)) (and (in_range2 o7) (<= (+ 0 o7) 2147483647))))))
...
(assert (= result5 true))
(assert (and (= o4 (get model____split_fields j)) (in_range3 o4)))
(assert (= result6 (ite (in_range8 o4) true false)))
(assert (= result6 true))
