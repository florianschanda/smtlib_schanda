...
(define-fun o10 () us_rep (mk___rep (mk___split_discrs o6) (mk___split_fields o7 o8) o9))
...
(assert (= dummy o4))
(assert (= true o5))
(assert (= o10 (mk___rep (mk___split_discrs o2) (mk___split_fields o3 o4) o5)))
(assert (= temp___2684 o10))
