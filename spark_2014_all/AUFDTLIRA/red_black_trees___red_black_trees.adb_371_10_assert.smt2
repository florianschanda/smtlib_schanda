...
(assert (<= i14 100))
(assert (not (= i14 x1)))
(assert (or (= (parent (rec__red_black_trees__rbt__struct t__split_fields6) i14) 0) (= (to_rep3 (select (rec__red_black_trees__rbt__color t__split_fields6) (parent (rec__red_black_trees__rbt__struct t__split_fields6) i14))) 1)))
(assert (not (= (to_rep3 (select (rec__red_black_trees__rbt__color t__split_fields6) i14)) 0)))
(check-sat)
(exit)
