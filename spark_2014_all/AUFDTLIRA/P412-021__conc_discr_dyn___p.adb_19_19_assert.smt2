...
(assert (= c true))
(assert (dynamic_invariant2 (mk___rep3 x__split_discrs x__split_fields5) true true true true))
...
(assert (= d true))
(assert (dynamic_invariant2 (mk___rep3 x__split_discrs x__split_fields6) true true true true))
