...
(assert (dynamic_invariant2 (mk___rep3 x__split_discrs (mk___split_fields3 x__split_fields (mk___rep1 (mk___split_discrs x__split_fields1) (mk___split_fields1 (mk___t1 x__split_fields2 x__split_fields3))))) false false true))
(assert (dynamic_invariant2 (mk___rep3 x__split_discrs x__split_fields4) true true true))
...
(assert (= c true))
(assert (dynamic_invariant2 (mk___rep3 x__split_discrs x__split_fields5) true true true))
(assert (= x__split_discrs (mk___split_discrs1 o8 o9)))
(assert (= x__split_fields5 (mk___split_fields3 o10 (mk___rep1 (mk___split_discrs o11) (mk___split_fields1 (mk___t1 o12 o13))))))
(assert (= o14 (mk___rep2 (mk___split_discrs1 o8 o9) (mk___split_fields2 o10 (mk___rep1 (mk___split_discrs o11) (mk___split_fields1 (mk___t1 o12 o13)))))))
(assert (and (= p__d__assume (prot o14)) (= (= p__d__assume true) (and (= (rec__p__pp__b (us_split_discrs4 o14)) true) (= (rec__p__pp__dummy (us_split_fields5 o14)) true)))))
(assert (= p__d__assume d))
(assert (= d true))
(assert (dynamic_invariant2 (mk___rep3 x__split_discrs x__split_fields6) true true true))
(assert (= o15 (mk___rep3 x__split_discrs x__split_fields6)))
(assert (= o16 (mk___rep2 (us_split_discrs5 o15) (mk___split_fields2 (rec__p__pp__dummy1 (us_split_fields7 o15)) (rec__p__pp__r1 (us_split_fields7 o15))))))
(assert (and (= p__e__assume (prot o16)) (= (= p__e__assume true) (and (= (rec__p__pp__b (us_split_discrs4 o16)) true) (= (rec__p__pp__dummy (us_split_fields5 o16)) true)))))
