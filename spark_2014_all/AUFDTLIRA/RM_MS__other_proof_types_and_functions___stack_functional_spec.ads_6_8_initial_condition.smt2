...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (= (bool_eq (rec__stack_functional_spec__stack_type__s (us_split_fields1 a)) 1 100 (rec__stack_functional_spec__stack_type__s (us_split_fields1 b)) 1 100) true) (= (to_rep (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 a))) (to_rep (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 b))))) true false))
...
(assert (forall ((temp___135 Int)) (forall ((temp___136 Int)) (= (select (temp___133 temp___135) temp___136) (of_rep1 temp___135)))))
...
(assert (= initial_stack (mk___rep (mk___split_fields (temp___133 0) (of_rep 0)))))
(assert true)
...
(assert (forall ((s us_rep)) (! (= (count s) (to_rep (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 s)))) :pattern ((count s)))))
(define-fun dynamic_invariant2 ((temp___expr_155 Int) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (=> (or (= temp___is_init_152 true) (<= 0 100)) (in_range temp___expr_155)))
...
(assert (= (mk___rep (mk___split_fields stack_functional_spec__initial_stack__assume stack_functional_spec__initial_stack__assume1)) initial_stack))
(assert (= result my_stack__split_fields))
(assert (= result1 my_stack__split_fields1))
(assert (= (mk___split_fields my_stack__split_fields2 my_stack__split_fields3) (us_split_fields1 initial_stack)))
(assert (and (= result2 (is_empty (mk___split_fields my_stack__split_fields2 my_stack__split_fields3))) (= (= result2 true) (= (count (state__2 (mk___split_fields my_stack__split_fields2 my_stack__split_fields3))) 0))))
(assert (not (= (is_empty (mk___split_fields my_stack__split_fields2 my_stack__split_fields3)) true)))
(check-sat)
(exit)
