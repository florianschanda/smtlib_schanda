...
(declare-fun temp___155 (Int) (Array Int integer))
...
(assert (= initial_stack (mk___rep (mk___split_fields (temp___155 0) (of_rep 0)))))
(assert (forall ((temp___157 Int)) (=> (dynamic_invariant temp___157 true true true true) (forall ((temp___158 Int)) (= (to_rep1 (select (temp___155 temp___157) temp___158)) temp___157)))))
(assert true)
...
(define-fun dynamic_invariant2 ((temp___expr_163 Int) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool) (temp___do_typ_inv_162 Bool)) Bool (=> (or (= temp___is_init_159 true) (<= 0 100)) (in_range temp___expr_163)))
...
(assert (and (= result2 (is_empty my_stack__split_fields4)) (= (= result2 true) (= (count (state__2 my_stack__split_fields4)) 0))))
