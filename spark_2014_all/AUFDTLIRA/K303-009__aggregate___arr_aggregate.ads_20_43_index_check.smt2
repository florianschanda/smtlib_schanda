...
(assert (forall ((temp___320 Int) (temp___321 Int)) (let ((temp___319 (temp___318 temp___320 temp___321))) (and (= (select temp___319 1) (of_rep temp___320)) (= (select temp___319 2) (of_rep temp___321))))))
(declare-fun temp___323 (Int) (Array Int integer))
(assert (forall ((temp___325 Int)) (forall ((temp___326 Int)) (= (select (temp___323 temp___325) temp___326) (of_rep temp___325)))))
(declare-fun temp___327 (Int Int) (Array Int integer))
(assert (forall ((temp___329 Int) (temp___330 Int)) (let ((temp___328 (temp___327 temp___329 temp___330))) (forall ((temp___331 Int)) (ite (= temp___331 1) (= (select temp___328 temp___331) (of_rep temp___329)) (= (select temp___328 temp___331) (of_rep temp___330)))))))
(declare-fun temp___332 (Int Int) (Array Int integer))
(assert (forall ((temp___334 Int) (temp___335 Int)) (let ((temp___333 (temp___332 temp___334 temp___335))) (forall ((temp___336 Int)) (ite (= temp___336 1) (= (select temp___333 temp___336) (of_rep temp___334)) (= (select temp___333 temp___336) (of_rep temp___335)))))))
(declare-fun temp___337 (Int Int) (Array Int integer))
(assert (forall ((temp___339 Int) (temp___340 Int)) (let ((temp___338 (temp___337 temp___339 temp___340))) (forall ((temp___341 Int)) (ite (= temp___341 2) (= (select temp___338 temp___341) (of_rep temp___339)) (= (select temp___338 temp___341) (of_rep temp___340)))))))
...
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (= b 3) (= a3 (temp___327 one one))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= (mk_map__ref result3) a8))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (= b 4) (= a4 (temp___332 2 one)))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= (mk_map__ref result4) a8))))))
(assert (=> (not (= b 1)) (=> (not (= b 2)) (=> (not (= b 3)) (=> (not (= b 4)) (= a5 (temp___337 2 one)))))))
