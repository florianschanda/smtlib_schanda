...
(define-fun default_initial_assumption ((temp___expr_159 us_rep) (temp___skip_top_level_160 Bool)) Bool (and (= (to_rep (rec__default_init__rec__f (us_split_fields1 temp___expr_159))) 0) (=> (not (= temp___skip_top_level_160 true)) (= (rec_ok temp___expr_159) true))))
...
(define-fun default_initial_assumption1 ((temp___expr_167 (Array Int natural)) (temp___skip_top_level_168 Bool)) Bool (and (forall ((temp___169 Int)) (=> (and (<= 1 temp___169) (<= temp___169 3)) (= (to_rep (select temp___expr_167 temp___169)) 0))) (=> (not (= temp___skip_top_level_168 true)) (= (arr_ok temp___expr_167) true))))
(declare-sort nat 0)
...
(define-fun dynamic_invariant ((temp___expr_174 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 0 2147483647)) (in_range2 temp___expr_174)))
(define-fun default_initial_assumption2 ((temp___expr_175 Int) (temp___skip_top_level_176 Bool)) Bool (and (= temp___expr_175 0) (=> (not (= temp___skip_top_level_176 true)) (= (nat_ok temp___expr_175) true))))
