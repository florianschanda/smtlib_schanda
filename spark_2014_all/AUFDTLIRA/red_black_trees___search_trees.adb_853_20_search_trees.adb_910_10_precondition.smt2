...
(assert (and (= temp___926 (model__ (rec__search_trees__search_tree__struct t__split_fields11) o128)) (and (dynamic_invariant6 temp___926 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___926 o128))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___926 o128)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 o128)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct t__split_fields11) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___926 (parent (rec__search_trees__search_tree__struct t__split_fields11) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___926 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___926 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___926 i5))) true) (not (= i5 o128))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___926 (parent (rec__search_trees__search_tree__struct t__split_fields11) i5)))) (position (rec__search_trees__search_tree__struct t__split_fields11) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___926 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___926 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___926 i5))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___926 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___926 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___926 j15)))) true)) (= j15 i5))))))))))))))
(assert (= o129 (select temp___926 y1)))
(assert (= o130 (us_split_fields1 o129)))
(assert (= o131 (rec__tree_model__path_type__a o130)))
(assert (and (= o124 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (not (= (valid_root (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) o124) true)))
(check-sat)
(exit)
