...
(assert (and (= o14 (size (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)))) (and (in_range3 o14) (= o14 (size1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)))))))))
(assert (= result9 (ite (< 0 o14) true false)))
(assert (=> (= result9 true) (= result10 (mk_int__ref n1))))
(assert (=> (= result9 true) (= n31 1)))
(assert (=> (= result9 true) (=> (and (<= 1 n31) (<= n31 100)) (and (and (= temp___605 n31) (and (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))) i14))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c67b) i14)))) n32)) (not (= i14 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c68b)))))) (= (eq (select (nb_blacks c68b) i14) (select (nb_blacks c67b) i14)) true)))) (and (and (=> (<= 1 100) (in_range2 n32)) (and (<= 1 n32) (<= n32 100))) (= n32 100)))) (and (= n38 (mk_int__ref n32)) (= n39 n32))))))
(assert (=> (= result9 true) (=> (and (<= 1 n31) (<= n31 100)) (= n40 n38))))
(assert (=> (= result9 true) (=> (and (<= 1 n31) (<= n31 100)) (= n41 n39))))
(assert (=> (= result9 true) (=> (not (and (<= 1 n31) (<= n31 100))) (= n40 (mk_int__ref n31)))))
(assert (=> (= result9 true) (=> (not (and (<= 1 n31) (<= n31 100))) (= n41 n31))))
(assert (=> (= result9 true) (= (same_nb_blacks c68b) true)))
(assert (=> (= result9 true) (= n42 n40)))
(assert (=> (= result9 true) (= n43 n41)))
(assert (=> (not (= result9 true)) (= n42 (mk_int__ref n1))))
(assert (=> (not (= result9 true)) (= n43 n10)))
(assert (not (= (same_nb_blacks c68b) true)))
(check-sat)
(exit)
