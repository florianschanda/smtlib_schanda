...
(declare-const n12 int__ref)
(declare-const n13 Int)
(define-fun n14 () int__ref (mk_int__ref n1))
...
(assert (and (= o4 (size (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)))) (and (in_range3 o4) (= o4 (size1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c67b)))))))))
(assert (= result3 (ite (< 0 o4) true false)))
(assert (=> (= result3 true) (= result4 n14)))
(assert (=> (= result3 true) (= n6 1)))
(assert (=> (= result3 true) (=> (and (<= 1 n6) (<= n6 100)) (= temp___654 n6))))
(assert (=> (= result3 true) (=> (and (<= 1 n6) (<= n6 100)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c67b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c67b) i)))) n7)) (not (= i (root (rec__red_black_trees__rbt__struct (us_split_fields9 c68b)))))) (= (eq (select (nb_blacks c68b) i) (select (nb_blacks c67b) i)) true)))))))
(assert (=> (= result3 true) (=> (and (<= 1 n6) (<= n6 100)) (and (=> (<= 1 100) (in_range2 n7)) (and (<= 1 n7) (<= n7 100))))))
(assert (=> (= result3 true) (=> (and (<= 1 n6) (<= n6 100)) (= n7 100))))
(assert (=> (= result3 true) (=> (and (<= 1 n6) (<= n6 100)) (= n8 (mk_int__ref n7)))))
(assert (=> (= result3 true) (=> (and (<= 1 n6) (<= n6 100)) (= n9 n7))))
(assert (=> (= result3 true) (=> (and (<= 1 n6) (<= n6 100)) (= n10 n8))))
(assert (=> (= result3 true) (=> (and (<= 1 n6) (<= n6 100)) (= n11 n9))))
(assert (=> (= result3 true) (=> (not (and (<= 1 n6) (<= n6 100))) (= n10 (mk_int__ref n6)))))
(assert (=> (= result3 true) (=> (not (and (<= 1 n6) (<= n6 100))) (= n11 n6))))
(assert (=> (= result3 true) (= (same_nb_blacks c68b) true)))
(assert (=> (= result3 true) (= n12 n10)))
(assert (=> (= result3 true) (= n13 n11)))
(assert (=> (not (= result3 true)) (= n12 n14)))
(assert (=> (not (= result3 true)) (= n13 n3)))
