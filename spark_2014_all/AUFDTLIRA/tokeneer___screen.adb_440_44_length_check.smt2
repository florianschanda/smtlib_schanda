...
(assert (not (= (ite (<= (to_rep1 (first10 temp___18121)) (to_rep1 (last10 temp___18121))) (+ (- (to_rep1 (last10 temp___18121)) (to_rep1 (first10 temp___18121))) 1) 0) (ite (<= (- 6 (to_rep1 valuestr__last)) 3) (+ (- 3 (- 6 (to_rep1 valuestr__last))) 1) 0))))
(check-sat)
(exit)
