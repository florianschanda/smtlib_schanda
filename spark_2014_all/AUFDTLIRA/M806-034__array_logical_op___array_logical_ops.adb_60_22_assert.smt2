...
(assert (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 10)) (= (of_int (to_rep (select (elts r5) i4))) true))))
(assert (forall ((i4 Int)) (=> (and (<= 31 i4) (<= i4 40)) (= (of_int (to_rep (select (elts r5) i4))) true))))
(assert (forall ((i4 Int)) (=> (and (<= (to_rep1 (first (rt r5))) i4) (<= i4 (to_rep1 (last (rt r5))))) (=> (not (and (<= 11 i4) (<= i4 30))) (= (of_int (to_rep (select (elts r5) i4))) true)))))
(declare-const i4 Int)
(assert (<= 11 i4))
(assert (<= i4 30))
(assert (not (not (= (of_int (to_rep (select (elts r5) i4))) true))))
(check-sat)
(exit)
