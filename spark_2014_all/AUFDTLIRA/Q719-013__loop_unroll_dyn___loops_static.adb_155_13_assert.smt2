...
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= temp___396 bad1))))
...
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o3 j3))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o4 (select a1 o3)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o5 (to_rep o4)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= o6 (ite (= o5 0) true false)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= result5 (ite (not (= o6 true)) true false)))))
...
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= j11 (mk_int__ref j4)))))
(assert (=> (not (= i1 1)) (=> (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (= bad11 (mk_bool__ref bad5)))))
