...
(assert (forall ((temp___399 Bool)) (forall ((temp___400 Int)) (= (select (stable_marriage__is_permutation_1__seen__aggregate_def temp___399) temp___400) temp___399))))
(declare-fun temp___406 (Bool) (Array Int Bool))
(assert (forall ((temp___408 Bool)) (forall ((temp___409 Int)) (= (select (temp___406 temp___408) temp___409) temp___408))))
(declare-fun temp___412 (Bool) (Array Int Bool))
(assert (forall ((temp___414 Bool)) (forall ((temp___415 Int)) (= (select (temp___412 temp___414) temp___415) temp___414))))
...
(assert (= seen1 (stable_marriage__is_permutation_1__seen__aggregate_def (of_int 0))))
(assert (= (mk_int__ref result1) (mk_int__ref rank)))
(assert (= rank1 1))
(assert (<= 1 rank1))
(assert (<= rank1 64))
(assert (forall ((g11 Int)) (=> (and (<= 1 g11) (<= g11 64)) (= (= (select seen2 g11) true) (exists ((prev1 Int)) (and (and (<= 1 prev1) (<= prev1 (- rank2 1))) (= (to_rep (select r1 prev1)) g11)))))))
