...
(declare-fun temp___448 (Bool) (Array Int Bool))
(declare-fun temp___454 (Bool) (Array Int Bool))
...
(assert (forall ((temp___450 Bool)) (forall ((temp___451 Int)) (= (select (temp___448 temp___450) temp___451) temp___450))))
(assert (forall ((temp___456 Bool)) (forall ((temp___457 Int)) (= (select (temp___454 temp___456) temp___457) temp___456))))
