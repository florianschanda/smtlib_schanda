...
(assert (= temp___281 k1))
(assert (= temp___280 c239b))
(assert (= temp___279 max1))
(assert (= temp___282 a))
(assert (= temp___277 a))
(assert (= temp___275 c238b))
...
(assert (and (forall ((i1 Int)) (=> (and (<= first3 i1) (<= i1 k2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i1)))) max3))) (forall ((i1 Int)) (=> (and (<= k2 i1) (<= i1 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i1)))) max3)))))
(assert (and (forall ((i1 Int)) (=> (and (<= first3 i1) (<= i1 k2)) (forall ((j1 Int)) (=> (and (<= i1 j1) (<= j1 k2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i1)))) (get_max_left j1 a2)))))) (forall ((i1 Int)) (=> (and (<= k2 i1) (<= i1 first3)) (forall ((j1 Int)) (=> (and (<= i1 j1) (<= j1 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 j1)))) (get_max_left i1 a2))))))))
(assert (= (frame_left (mk___t temp___282 (mk (to_rep1 a__first) (to_rep1 a__last))) a2) true))
(assert (and (and (and (and (=> (<= 1 2147483647) (in_range3 c238b2)) (forall ((temp___278 Int)) (=> (and (<= (to_rep1 a__first) temp___278) (<= temp___278 (to_rep1 a__last))) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a2 temp___278))) (rec__frame_condition__cell__value (us_split_fields1 (select temp___277 temp___278)))) (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a2 temp___278))) (rec__frame_condition__cell__max_right (us_split_fields1 (select temp___277 temp___278)))))))) (=> (<= 0 2147483647) (in_range2 max3))) (=> (<= 0 2147483647) (in_range2 c239b2))) (=> (<= 1 2147483647) (in_range3 k2))))
(assert (= k3 (mk_int__ref k2)))
(assert (= k4 k2))
(assert (= k2 last3))
(assert (= c239b3 (mk_int__ref c239b2)))
(assert (= c238b3 (mk_int__ref c238b2)))
(assert (= max4 (mk_int__ref max3)))
(assert (= k5 k3))
(assert (= a3 (mk_map__ref a2)))
(assert (= c239b4 c239b2))
(assert (= c238b4 c238b2))
(assert (= max5 max3))
(assert (= k6 k4))
(assert (= a4 a2))
(assert (= c239b5 c239b3))
(assert (= c238b5 c238b3))
(assert (= max6 max4))
(assert (= k7 k5))
(assert (= a5 a3))
...
(assert (= k10 k8))
(assert (= a8 a6))
(assert (and (= o28 (frame_left (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) (map__content a7))) (= (= o28 true) (forall ((i1 Int)) (=> (and (<= (to_rep1 a__first) i1) (<= i1 (to_rep1 a__last))) (= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) i1)))) (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a i1))))))))))
(assert (<= last3 i))
(assert (<= i first3))
(assert (<= i j))
(assert (<= j first3))
(assert (and (= o27 i) (in_range3 i)))
(assert (not (<= (to_rep1 a__first) o27)))
(check-sat)
(exit)
