...
(assert (forall ((index Int)) (forall ((frame_condition__update_max_2__a (Array Int us_rep))) (! (=> (and (dynamic_invariant1 index true true true) (and (<= (to_rep1 a__first) index) (<= index (to_rep1 a__last)))) (dynamic_invariant (get_max_left index frame_condition__update_max_2__a) true false true)) :pattern ((get_max_left index frame_condition__update_max_2__a))))))
(assert (forall ((index Int)) (forall ((frame_condition__update_max_2__a (Array Int us_rep))) (! (=> (dynamic_invariant1 index true true true) (= (get_max_left index frame_condition__update_max_2__a) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select frame_condition__update_max_2__a index)))))) :pattern ((get_max_left index frame_condition__update_max_2__a))))))
(declare-fun frame_left (us_t (Array Int us_rep)) Bool)
(declare-fun frame_left__function_guard (Bool us_t (Array Int us_rep)) Bool)
(define-fun dynamic_invariant2 ((temp___expr_145 us_t) (temp___is_init_142 Bool) (temp___skip_constant_143 Bool) (temp___do_toplevel_144 Bool)) Bool (=> (not (= temp___skip_constant_143 true)) (dynamic_property 1 2147483647 (first1 temp___expr_145) (last1 temp___expr_145))))
(assert true)
...
(declare-const temp___277 (Array Int us_rep))
...
(assert (= temp___281 max1))
(assert (= temp___280 c238b))
(assert (= temp___282 a))
(assert (= temp___279 k1))
(assert (= temp___277 a))
(assert (= temp___275 c239b))
...
(assert (= result4 (mk_int__ref c238b)))
(assert (= c238b1 k1))
(assert (in_range3 c238b1))
(assert (= result5 (mk_int__ref c239b)))
(assert (= c239b1 max2))
(assert (in_range2 c239b1))
(assert (= (to_rep o18) c239b1))
(assert (= (rec__frame_condition__cell__value (us_split_fields1 (select a c238b1))) o19))
(assert (= o18 o20))
(assert (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a c238b1))) o21))
(assert (= o22 o19))
(assert (= o23 o20))
(assert (= o24 o21))
(assert (and (<= (to_rep1 a__first) c238b1) (<= c238b1 (to_rep1 a__last))))
(assert (= o25 c238b1))
...
(assert (and (forall ((i6 Int)) (=> (and (<= first3 i6) (<= i6 k2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i6)))) max3))) (forall ((i6 Int)) (=> (and (<= k2 i6) (<= i6 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i6)))) max3)))))
(assert (and (forall ((i6 Int)) (=> (and (<= first3 i6) (<= i6 k2)) (forall ((j4 Int)) (=> (and (<= i6 j4) (<= j4 k2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i6)))) (get_max_left j4 a2)))))) (forall ((i6 Int)) (=> (and (<= k2 i6) (<= i6 first3)) (forall ((j4 Int)) (=> (and (<= i6 j4) (<= j4 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 j4)))) (get_max_left i6 a2))))))))
(assert (= (frame_left (mk___t temp___282 (mk (to_rep1 a__first) (to_rep1 a__last))) a2) true))
(assert (and (and (and (and (=> (<= 0 2147483647) (in_range2 c239b2)) (forall ((temp___278 Int)) (=> (and (<= (to_rep1 a__first) temp___278) (<= temp___278 (to_rep1 a__last))) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a2 temp___278))) (rec__frame_condition__cell__value (us_split_fields1 (select temp___277 temp___278)))) (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a2 temp___278))) (rec__frame_condition__cell__max_right (us_split_fields1 (select temp___277 temp___278)))))))) (=> (<= 1 2147483647) (in_range3 k2))) (=> (<= 1 2147483647) (in_range3 c238b2))) (=> (<= 0 2147483647) (in_range2 max3))))
(assert (= k4 (mk_int__ref k2)))
(assert (= k5 k2))
(assert (= k2 last3))
(assert (= c239b4 (mk_int__ref c239b2)))
(assert (= c238b4 (mk_int__ref c238b2)))
(assert (= max5 (mk_int__ref max3)))
(assert (= k6 k4))
(assert (= a4 (mk_map__ref a2)))
(assert (= c239b5 c239b2))
(assert (= c238b5 c238b2))
(assert (= max6 max3))
(assert (= k7 k5))
(assert (= a5 a2))
(assert (= c239b6 c239b4))
(assert (= c238b6 c238b4))
(assert (= max7 max5))
(assert (= k8 k6))
(assert (= a6 a4))
(assert (= c239b7 c239b5))
(assert (= c238b7 c238b5))
(assert (= max8 max6))
(assert (= k9 k7))
(assert (= a7 a5))
(assert (= c239b8 c239b6))
(assert (= c238b8 c238b6))
(assert (= max9 max7))
(assert (= k10 k8))
(assert (= a8 a6))
(assert (= c239b9 c239b7))
(assert (= c238b9 c238b7))
(assert (= max10 max8))
(assert (= k11 k9))
(assert (= a9 a7))
(assert (and (= o64 (frame_left (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) (map__content a8))) (= (= o64 true) (forall ((i6 Int)) (=> (and (<= (to_rep1 a__first) i6) (<= i6 (to_rep1 a__last))) (= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a8) i6)))) (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a i6))))))))))
(assert (<= last3 i5))
(assert (<= i5 first3))
(assert (<= i5 j3))
(assert (<= j3 first3))
(assert (and (= o61 i5) (in_range3 i5)))
(assert (not (<= (to_rep1 a__first) o61)))
(check-sat)
(exit)
