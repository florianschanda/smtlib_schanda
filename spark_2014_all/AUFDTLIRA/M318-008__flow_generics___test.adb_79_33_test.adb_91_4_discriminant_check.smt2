...
(define-fun dynamic_invariant1 ((temp___expr_239 Int) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (=> (or (= temp___is_init_236 true) (<= 0 9)) (in_range1 temp___expr_239)))
(declare-const rec2__split_fields item_t)
(declare-const rec2__split_fields1 item_t)
(declare-const rec2__split_fields2 item_t)
(declare-const rec2__split_fields3 (Array Int item_t))
(declare-const rec2__split_discrs natural)
(declare-const us Int)
(assert (= (to_rep (rec__test__fruit_rec__record_t__d (us_split_discrs1 rec1))) (to_rep rec2__split_discrs)))
(assert (and (= us (to_rep (rec__test__fruit_rec__record_t__d (us_split_discrs1 rec1)))) (in_range (to_rep (rec__test__fruit_rec__record_t__d (us_split_discrs1 rec1))))))
(assert (not (= (to_rep (rec__test__fruit_rec__record_t__d (us_split_discrs1 rec1))) 1)))
(assert (not (= (to_rep (rec__test__fruit_rec__record_t__d (us_split_discrs1 rec1))) 2)))
(assert (not (test__fruit_rec__record_t__arr__pred rec1)))
(check-sat)
(exit)
