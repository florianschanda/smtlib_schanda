...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (select todo3 j1) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j1))) true)))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (select todo3 j1) true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 k))) true) (not (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select r2 j1))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 k)))) true)))))))))
...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j1))) true) (not (= j1 root))) (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j1)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j1))))))) true))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j1))) true) (not (= j1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j1))))))) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j1)))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 j1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j1)))) 0)))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (not (= j1 root)) (ite (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j1)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j1))))))) true)) (or (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j1))) true) (= (select todo3 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j1))))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j1))) true)))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j1))) true) (not (= j1 root))) (not (= (select todo3 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j1))))) true))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j1))) true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 k))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select r2 k))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 j1)))) true)) (= j1 k))))))))
(assert (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 root))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 root)))) 0)))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (<= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j1)))) (- 100 (length1 unseen2))))))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (= (= (contains unseen2 j1) true) (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j1))) true)) (= (select todo3 j1) true))))))
(assert (and (dynamic_invariant5 r2 false true true) (=> (<= 0 100) (in_range2 i2))))
(assert (<= 1 j))
(assert (<= j 100))
(assert (ite (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j))) true) (not (= j root)) true))
(assert (ite (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j))) true) true false))
(assert (and (= o5 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j))))) (in_range4 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j)))))))
(assert (not (<= 1 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j)))))))
(check-sat)
(exit)
