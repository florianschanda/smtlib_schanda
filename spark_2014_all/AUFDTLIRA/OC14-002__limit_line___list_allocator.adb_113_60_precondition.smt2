...
(assert (=> (= result12 true) (=> (< 1 j) (and (= o53 (- j 1)) (in_range2 (- j 1))))))
(assert (=> (= result12 true) (=> (< 1 j) (and (= o54 (get (rec__list_allocator__m__t__available model____split_fields4) o53)) (in_range7 o54)))))
(assert (=> (= result12 true) (=> (not (< 1 j)) (= o54 0))))
(assert (=> (= result12 true) (and (= temp___399 (get (rec__list_allocator__m__t__available model____split_fields4) j)) (in_range7 temp___399))))
(assert (=> (= result12 true) (and (<= 1 temp___399) (<= temp___399 3))))
(assert (=> (= result12 true) (= o49 temp___399)))
(assert (=> (= result12 true) (= o50 (select data4 o49))))
(assert (=> (= result12 true) (= o51 (us_split_fields1 o50))))
(assert (=> (= result12 true) (= o52 (rec__list_allocator__cell__prev o51))))
(assert (=> (= result12 true) (= o55 (to_rep o52))))
(assert (=> (= result12 true) (= result11 (ite (= o55 o54) true false))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (= result11 true))
(assert (and (= o45 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o45)))
