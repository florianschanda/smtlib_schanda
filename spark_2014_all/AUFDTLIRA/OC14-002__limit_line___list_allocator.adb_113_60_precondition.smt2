...
(assert (=> (= result13 true) (and (= temp___431 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___431))))
(assert (=> (= result13 true) (and (<= 1 temp___431) (<= temp___431 3))))
(assert (=> (= result13 true) (= o54 temp___431)))
...
(assert (=> (= result12 true) (and (= temp___432 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___432))))
(assert (=> (= result12 true) (and (<= 1 temp___432) (<= temp___432 3))))
(assert (=> (= result12 true) (= o47 temp___432)))
