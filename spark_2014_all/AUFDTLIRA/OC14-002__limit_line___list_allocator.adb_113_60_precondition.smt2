...
(assert (and (= o62 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 o62)))
(assert (= result13 (ite (in_range4 o62) true false)))
(assert (=> (= result13 true) (and (= o58 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o58))))
(assert (=> (= result13 true) (= result14 (ite (< j o58) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o59 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o60 (get (rec__list_allocator__m__t__available model____split_fields3) o59)) (in_range7 o60)))))
(assert (=> (= result13 true) (=> (not (= result14 true)) (= o60 0))))
(assert (=> (= result13 true) (and (= temp___398 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___398))))
(assert (=> (= result13 true) (and (<= 1 temp___398) (<= temp___398 3))))
(assert (=> (= result13 true) (= o54 temp___398)))
(assert (=> (= result13 true) (= o55 (select data3 o54))))
(assert (=> (= result13 true) (= o56 (us_split_fields1 o55))))
(assert (=> (= result13 true) (= o57 (rec__list_allocator__cell__next o56))))
...
(assert (=> (= result12 true) (=> (< 1 j) (and (= o51 (- j 1)) (in_range2 (- j 1))))))
(assert (=> (= result12 true) (=> (< 1 j) (and (= o52 (get (rec__list_allocator__m__t__available model____split_fields3) o51)) (in_range7 o52)))))
(assert (=> (= result12 true) (=> (not (< 1 j)) (= o52 0))))
(assert (=> (= result12 true) (and (= temp___399 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___399))))
(assert (=> (= result12 true) (and (<= 1 temp___399) (<= temp___399 3))))
(assert (=> (= result12 true) (= o47 temp___399)))
(assert (=> (= result12 true) (= o48 (select data3 o47))))
(assert (=> (= result12 true) (= o49 (us_split_fields1 o48))))
(assert (=> (= result12 true) (= o50 (rec__list_allocator__cell__prev o49))))
