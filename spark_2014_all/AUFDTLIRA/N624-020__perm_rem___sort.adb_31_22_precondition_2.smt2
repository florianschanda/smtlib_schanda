...
(declare-const temp___243 (Array Int natural))
(declare-const temp___2431 t)
...
(define-fun temp___2432 () us_t (mk___t temp___243 temp___2431))
(assert (in_range3 x))
(assert (in_range3 y))
...
(assert (and (= temp___2432 (remove (mk___t values2 (mk 1 100)) o13)) (and (dynamic_invariant3 temp___2432 true false true true) (and (= (invariant__ temp___2432) true) (and (= (to_rep1 (last temp___2431)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select values2 k)) (to_rep (select temp___243 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select temp___243 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select temp___243 k))))))))))))
(assert (and (= o14 y) (in_range4 y)))
(assert (not (<= (to_rep1 (first (mk 1 100))) o14)))
(check-sat)
(exit)
