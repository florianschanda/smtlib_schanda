...
(assert (forall ((x element)) (! (in_range3 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x less_than_max)) (! (in_range1 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep1 (first2 (mk1 f l))) f) (= (to_rep1 (last2 (mk1 f l))) l)))) :pattern ((mk1 f l)))))
(define-fun dynamic_property1 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range4 low) (and (in_range4 high) (=> (<= low high) (and (in_range low) (in_range high))))))
...
(assert (forall ((s1 us_rep1)) (! (dynamic_invariant (last4 s1) true false true true) :pattern ((last4 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep1)) (! (dynamic_invariant (last5 attr__tag2 s1) true false true true) :pattern ((last5 attr__tag2 s1))))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep1 (first4 (mk2 f l))) f) (= (to_rep1 (last6 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep1 (first6 (mk3 f l))) f) (= (to_rep1 (last8 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep1 (first8 (mk4 f l))) f) (= (to_rep1 (last10 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
...
(define-fun dynamic_invariant4 ((temp___expr_196 us_t1) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool) (temp___do_typ_inv_195 Bool)) Bool (=> (not (= temp___skip_constant_193 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_196) (last3 temp___expr_196))))
(define-fun default_initial_assumption1 ((temp___expr_185 us_rep) (temp___skip_top_level_186 Bool)) Bool (and (and (= (attr__tag temp___expr_185) us_tag) (and (= (rec__stacks__stack_root__content (us_split_fields1 temp___expr_185)) (temp___187 0)) (= (to_rep2 (rec__stacks__stack_root__length (us_split_fields1 temp___expr_185))) 0))) (=> (not (= temp___skip_top_level_186 true)) (= (size temp___expr_185) 0))))
...
(assert (and (= result (wraps_around s)) (= (= result true) (< 100 (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1)))))
(assert (not (= result true)))
(assert (and (= stacks__get_model__3__R89s (last4 s)) (and (in_range1 stacks__get_model__3__R89s) (= stacks__get_model__3__R89s (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep2 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100))))))
(assert (<= (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) stacks__get_model__3__R89s))
