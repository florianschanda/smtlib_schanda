...
(assert (and (= stacks__get_model__3__R89s (last2 s)) (and (in_range1 stacks__get_model__3__R89s) (= stacks__get_model__3__R89s (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100))))))
(assert (=> (<= (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) stacks__get_model__3__R89s) (and (and (<= 1 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s)))) (<= (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) 100)) (and (<= 1 stacks__get_model__3__R89s) (<= stacks__get_model__3__R89s 100)))))
(assert (= o (rec__stacks__stack_root__content1 (us_split_fields3 s))))
(assert (= o temp___564))
(assert (= (mk4 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) stacks__get_model__3__R89s) temp___5641))
(assert (not (dynamic_property 1 2147483647 (to_rep2 (first8 temp___5641)) (to_rep2 (last10 temp___5641)))))
(check-sat)
(exit)
