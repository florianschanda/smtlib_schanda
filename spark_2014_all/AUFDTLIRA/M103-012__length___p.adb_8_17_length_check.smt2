...
(define-fun dynamic_invariant ((temp___expr_172 us_t) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (not (= temp___skip_constant_170 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_172) (last1 temp___expr_172))))
(declare-sort tbP1 0)
