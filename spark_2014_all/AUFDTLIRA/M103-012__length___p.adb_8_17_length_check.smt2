...
(define-fun dynamic_invariant ((temp___expr_201 us_t) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (not (= temp___skip_constant_198 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_201) (last1 temp___expr_201))))
(declare-sort tbP1 0)
(declare-fun tbP1qtint (tbP1) Int)
(assert (forall ((i tbP1)) (and (<= 1 (tbP1qtint i)) (<= (tbP1qtint i) 10))))
...
(declare-datatypes () ((tbP1__ref (mk_tbP1__ref (tbP1__content tbP1)))))
(define-fun tbP1__ref___projection ((a tbP1__ref)) tbP1 (tbP1__content a))
...
(assert (not (= (ite (<= (to_rep (first (rt x))) (to_rep (last (rt x)))) (+ (- (to_rep (last (rt x))) (to_rep (first (rt x)))) 1) 0) (ite (<= 1 10) (+ (- 10 1) 1) 0))))
(check-sat)
(exit)
