...
(define-fun dynamic_invariant ((temp___expr_2874 Int) (temp___is_init_2870 Bool) (temp___skip_constant_2871 Bool) (temp___do_toplevel_2872 Bool) (temp___do_typ_inv_2873 Bool)) Bool (=> (or (= temp___is_init_2870 true) (<= 0 8)) (in_range4 temp___expr_2874)))
...
(define-fun dynamic_invariant2 ((temp___expr_2961 Int) (temp___is_init_2957 Bool) (temp___skip_constant_2958 Bool) (temp___do_toplevel_2959 Bool) (temp___do_typ_inv_2960 Bool)) Bool (=> (or (= temp___is_init_2957 true) (<= 0 2)) (in_range5 temp___expr_2961)))
(define-fun dynamic_invariant3 ((temp___expr_1099 Int) (temp___is_init_1095 Bool) (temp___skip_constant_1096 Bool) (temp___do_toplevel_1097 Bool) (temp___do_typ_inv_1098 Bool)) Bool (=> (or (= temp___is_init_1095 true) (<= 0 40)) (in_range1 temp___expr_1099)))
(define-fun dynamic_invariant4 ((temp___expr_1123 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool) (temp___do_typ_inv_1122 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 4294967295)) (in_range3 temp___expr_1123)))
