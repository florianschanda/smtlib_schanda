...
(define-fun dynamic_invariant ((temp___expr_2670 Int) (temp___is_init_2667 Bool) (temp___skip_constant_2668 Bool) (temp___do_toplevel_2669 Bool)) Bool (=> (or (= temp___is_init_2667 true) (<= 0 8)) (in_range4 temp___expr_2670)))
...
(define-fun dynamic_invariant2 ((temp___expr_2756 Int) (temp___is_init_2753 Bool) (temp___skip_constant_2754 Bool) (temp___do_toplevel_2755 Bool)) Bool (=> (or (= temp___is_init_2753 true) (<= 0 2)) (in_range5 temp___expr_2756)))
(define-fun dynamic_invariant3 ((temp___expr_978 Int) (temp___is_init_975 Bool) (temp___skip_constant_976 Bool) (temp___do_toplevel_977 Bool)) Bool (=> (or (= temp___is_init_975 true) (<= 0 40)) (in_range1 temp___expr_978)))
(define-fun dynamic_invariant4 ((temp___expr_999 Int) (temp___is_init_996 Bool) (temp___skip_constant_997 Bool) (temp___do_toplevel_998 Bool)) Bool (=> (or (= temp___is_init_996 true) (<= 0 4294967295)) (in_range3 temp___expr_999)))
