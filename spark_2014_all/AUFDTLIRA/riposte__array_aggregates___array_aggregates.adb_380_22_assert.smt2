...
(declare-fun temp_____aggregate_def_668 (Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___670 Int) (temp___671 Int)) (let ((temp___669 (temp_____aggregate_def_668 temp___670 temp___671))) (=> (and (dynamic_invariant temp___670 true true true true) (dynamic_invariant temp___671 true true true true)) (forall ((temp___672 Int)) (ite (= temp___672 2) (= (select temp___669 temp___672) rliteral) (= (select temp___669 temp___672) rliteral1)))))))
...
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_668 2 0)))
