...
(declare-const temp___512 (Array Int element))
(declare-const temp___5121 less_than_max)
(declare-const temp___5122 us_private)
(declare-const temp___5123 Int)
...
(assert (= temp___5121 o2))
(assert (= temp___5122 o3))
(assert (= s__attr__tag temp___5123))
(assert (= result s__split_fields))
(assert (= result1 s__split_fields1))
(assert (= result2 s__split_fields2))
(assert (= temp___512 s__split_fields3))
(assert (= temp___5121 s__split_fields4))
(assert (= temp___5122 s__split_fields5))
