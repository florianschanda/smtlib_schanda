...
(declare-datatypes () ((array_b__ref (mk_array_b__ref (array_b__content us_t)))))
(define-fun array_b__ref___projection ((a array_b__ref)) us_t (array_b__content a))
...
(declare-fun user_eq4 (index_a index_a) Bool)
(declare-const dummy4 index_a)
...
(define-fun dynamic_property1 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range2 low) (and (in_range2 high) (=> (<= low high) (and (in_range4 low) (in_range4 high))))))
...
(declare-datatypes () ((array_a__ref (mk_array_a__ref (array_a__content us_t1)))))
(define-fun array_a__ref___projection ((a array_a__ref)) us_t1 (array_a__content a))
(define-fun dynamic_invariant ((temp___expr_215 us_t1) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (not (= temp___skip_constant_212 true)) (dynamic_property1 (- 3) 15 (first3 temp___expr_215) (last3 temp___expr_215))))
(declare-const v us_t1)
...
(define-fun dynamic_invariant2 ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= (- 3) 15)) (in_range4 temp___expr_201)))
(define-fun dynamic_invariant3 ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 3 15)) (in_range3 temp___expr_208)))
(define-fun dynamic_invariant4 ((temp___expr_221 us_t) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (not (= temp___skip_constant_218 true)) (dynamic_property 3 15 (first1 temp___expr_221) (last1 temp___expr_221))))
(declare-const rliteral integer)
(assert (= (integerqtint rliteral) 0))
(assert (forall ((temp___297 Int) (temp___298 Int) (temp___299 Int)) (let ((temp___296 (essai05__conv2__r__aggregate_def temp___297 temp___298 temp___299))) (=> (dynamic_invariant1 temp___297 true true true true) (and (=> (dynamic_property 3 15 temp___298 temp___299) (and (= (first7 temp___296) temp___298) (= (last7 temp___296) temp___299))) (forall ((temp___300 Int)) (= (select (to_array3 temp___296) temp___300) rliteral)))))))
(define-fun dynamic_invariant5 ((temp___expr_261 us_t2) (temp___is_init_257 Bool) (temp___skip_constant_258 Bool) (temp___do_toplevel_259 Bool) (temp___do_typ_inv_260 Bool)) Bool (=> (not (= temp___skip_constant_258 true)) (and (dynamic_property3 (first3 v) (last3 v) (first5 temp___expr_261) (last5 temp___expr_261)) (and (= (first5 temp___expr_261) (first3 v)) (= (last5 temp___expr_261) (last3 v))))))
(assert (dynamic_invariant v true false true true))
(assert (<= (to_rep1 (first2 (rt1 v))) (to_rep1 (last2 (rt1 v)))))
(assert (not (<= 3 (to_rep1 (first2 (rt1 v))))))
(check-sat)
(exit)
