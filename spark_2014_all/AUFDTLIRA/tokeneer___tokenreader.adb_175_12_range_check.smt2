...
(assert (not (= (length (mk___t temp___1653 temp___16531)) 0)))
(assert (=> (<= (to_rep1 (first2 temp___16541)) (to_rep1 (last2 temp___16541))) (= o6 (+ (- (to_rep1 (last2 temp___16541)) (to_rep1 (first2 temp___16541))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___16541)) (to_rep1 (last2 temp___16541)))) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___16531)) (to_rep1 (last temp___16531))) (= o7 (+ (- (to_rep1 (last temp___16531)) (to_rep1 (first temp___16531))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___16531)) (to_rep1 (last temp___16531)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___16531)) o8)))
(assert (= o10 (- o9 1)))
