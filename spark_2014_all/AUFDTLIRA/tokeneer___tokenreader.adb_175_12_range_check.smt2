...
(assert (not (= (length (mk___t temp___1829 temp___18291)) 0)))
(assert (=> (<= (to_rep1 (first2 temp___18301)) (to_rep1 (last2 temp___18301))) (= o6 (+ (- (to_rep1 (last2 temp___18301)) (to_rep1 (first2 temp___18301))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___18301)) (to_rep1 (last2 temp___18301)))) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___18291)) (to_rep1 (last temp___18291))) (= o7 (+ (- (to_rep1 (last temp___18291)) (to_rep1 (first temp___18291))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___18291)) (to_rep1 (last temp___18291)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___18291)) o8)))
(assert (= o10 (- o9 1)))
