...
(define-fun dynamic_invariant ((temp___expr_1683 Int) (temp___is_init_1680 Bool) (temp___skip_constant_1681 Bool) (temp___do_toplevel_1682 Bool)) Bool (=> (or (= temp___is_init_1680 true) (<= 0 7)) (in_range5 temp___expr_1683)))
...
(assert true)
(define-fun dynamic_invariant5 ((temp___expr_334 Int) (temp___is_init_331 Bool) (temp___skip_constant_332 Bool) (temp___do_toplevel_333 Bool)) Bool (=> (or (= temp___is_init_331 true) (<= 1 150)) (in_range3 temp___expr_334)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant6 ((temp___expr_1028 Int) (temp___is_init_1025 Bool) (temp___skip_constant_1026 Bool) (temp___do_toplevel_1027 Bool)) Bool (=> (or (= temp___is_init_1025 true) (<= 0 2147483647)) (in_range4 temp___expr_1028)))
...
(assert (=> (not (= updateok true)) (= status4 status1)))
...
(assert (=> (not (= updateok true)) (= state4 state2)))
(assert (=> (not (= updateok true)) (= updateok1 updateok)))
(assert (not (= updateok1 true)))
(assert (= o1 (extractuser state3)))
(assert (not (= (valid_numberlogentries state4) true)))
(check-sat)
(exit)
