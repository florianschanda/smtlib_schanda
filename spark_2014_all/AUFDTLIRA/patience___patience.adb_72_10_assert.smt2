...
(assert (not (<= (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) (to_rep (rec__patience__state__numelts (us_split_fields__content s__split_fields20))))))
(check-sat)
(exit)
