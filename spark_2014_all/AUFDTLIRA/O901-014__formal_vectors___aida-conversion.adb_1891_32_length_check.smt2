...
(assert (and (= (length source) 10) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index) (<= index (+ (to_rep1 (first (rt source))) 9))) (= (is_digit (to_rep (select (elts source) index))) true))))))
...
(assert (not (= (ite (<= (to_rep1 (first8 temp___22991)) (to_rep1 (last8 temp___22991))) (+ (- (to_rep1 (last8 temp___22991)) (to_rep1 (first8 temp___22991))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 1)) 1) 0))))
(check-sat)
(exit)
