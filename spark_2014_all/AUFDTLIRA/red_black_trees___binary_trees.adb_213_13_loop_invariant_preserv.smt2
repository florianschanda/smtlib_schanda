...
(assert (and (dynamic_invariant5 r2 false true true) (=> (<= 0 100) (in_range2 i2))))
...
(assert (=> (not (= j1 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___601))) 100)))
...
(assert (=> (not (= j2 0)) (= o45 (mk___rep (mk___split_fields (rec__tree_model__path_type__a (us_split_fields1 (select r4 j2))) (of_int 1))))))
...
(assert (=> (not (= j2 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___608))) 100)))
