...
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= (select todo3 j3) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j3))) true)))))
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= (select todo3 j3) true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 k))) true) (not (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select r2 j3))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 k)))) true)))))))))
...
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j3))) true) (not (= j3 root))) (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j3)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j3))))))) true))))))
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j3))) true) (not (= j3 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j3))))))) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j3)))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 j3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j3)))) 0)))))
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (not (= j3 root)) (ite (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j3)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j3))))))) true)) (or (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j3))) true) (= (select todo3 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j3))))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j3))) true)))))))
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j3))) true) (not (= j3 root))) (not (= (select todo3 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j3))))) true))))))
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j3))) true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 k))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select r2 k))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 j3)))) true)) (= j3 k))))))))
(assert (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 root))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 root)))) 0)))
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (<= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j3)))) (- 100 (length1 unseen2))))))
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (= (= (contains unseen2 j3) true) (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j3))) true)) (= (select todo3 j3) true))))))
(assert (and (dynamic_invariant5 r2 false true true true) (=> (<= 0 100) (in_range2 i2))))
...
(assert (= o7 i2))
(assert (= (mk___rep1 (mk___split_fields1 o8 o9 o10 o11)) (select (rec__binary_trees__forest__c (us_split_fields5 f)) o7)))
(assert (= o8 o12))
(assert (= o9 o13))
(assert (= o10 o14))
(assert (= o11 o15))
...
(assert (=> (not (= j1 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j1)))) 100)))
(assert (=> (not (= j1 0)) (= (rec__tree_model__path_type__a (us_split_fields1 (select r2 j1))) o18)))
(assert (=> (not (= j1 0)) (= (distinct 1 0) o19)))
(assert (=> (not (= j1 0)) (and (<= 1 j1) (<= j1 100))))
(assert (=> (not (= j1 0)) (= o20 j1)))
(assert (=> (not (= j1 0)) (= o21 (store r2 o20 (mk___rep (mk___split_fields o18 o19))))))
(assert (=> (not (= j1 0)) (= result8 (mk_map__ref r2))))
(assert (=> (not (= j1 0)) (= r3 o21)))
(assert (=> (not (= j1 0)) (and (<= 1 j1) (<= j1 100))))
(assert (=> (not (= j1 0)) (= o22 j1)))
(assert (=> (not (= j1 0)) (= (mk___rep1 (mk___split_fields1 o23 o24 o25 o26)) (select (rec__binary_trees__forest__c (us_split_fields5 f)) o22))))
...
(assert (=> (not (= j1 0)) (= o34 (mk___split_fields o33 (rec__tree_model__path_type__k (us_split_fields1 (select r3 j1)))))))
(assert (=> (not (= j1 0)) (= temp___647 (mk___rep o34))))
(assert (=> (not (= j1 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___647))) 100)))
...
(assert (and (<= 1 i2) (<= i2 100)))
(assert (= o40 i2))
(assert (= o41 (select (rec__binary_trees__forest__c (us_split_fields5 f)) o40)))
...
(assert (=> (not (= j2 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 (select r4 j2)))) 100)))
(assert (=> (not (= j2 0)) (= o45 (mk___rep (mk___split_fields (rec__tree_model__path_type__a (us_split_fields1 (select r4 j2))) (distinct 1 0))))))
...
(assert (=> (not (= j2 0)) (= o49 (select (rec__binary_trees__forest__c (us_split_fields5 f)) o48))))
...
(assert (=> (not (= j2 0)) (= o57 (mk___split_fields o56 (rec__tree_model__path_type__k (us_split_fields1 (select r5 j2)))))))
(assert (=> (not (= j2 0)) (= temp___654 (mk___rep o57))))
(assert (=> (not (= j2 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___654))) 100)))
...
(assert (= todo6 o64))
(assert (and (= o65 (next todo6)) (and (in_range2 o65) (ite (= o65 0) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (not (= (select todo6 i4) true)))) (= (select todo6 o65) true)))))
...
(assert (<= 1 j3))
(assert (<= j3 100))
(assert (= (contains unseen3 j3) true))
(assert (not (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r6 j3))) true)) (= (select todo6 j3) true))))
(check-sat)
(exit)
