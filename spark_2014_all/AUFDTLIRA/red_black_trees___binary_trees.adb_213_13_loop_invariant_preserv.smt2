...
(assert (= result7 (mk_int__ref temp___6441)))
(assert (= temp___6442 (length1 unseen2)))
(assert (and (= o12 i4) (in_range7 i4)))
(assert (and (= o13 (remove unseen2 o12)) (and (and (and (= (length1 o13) (- (length1 unseen2) 1)) (not (= (contains o13 o12) true))) (= (ole1 o13 unseen2) true)) (= (included_except unseen2 o13 o12) true))))
(assert (= result8 (mk_set__ref unseen2)))
(assert (= unseen3 o13))
(assert (=> (<= 0 100) (in_range2 j7)))
(assert (and (<= 1 i4) (<= i4 100)))
(assert (= o14 i4))
(assert (= (mk___rep1 (mk___split_fields1 o15 o16 o17 o18)) (select (rec__binary_trees__forest__c (us_split_fields5 f)) o14)))
(assert (= o15 o19))
(assert (= o16 o20))
(assert (= o17 o21))
(assert (= o18 o22))
...
(assert (= result9 (mk_int__ref j7)))
(assert (= j8 o24))
(assert (=> (not (= j8 0)) (< 0 (length1 unseen3))))
(assert (=> (not (= j8 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j8)))) 100)))
(assert (=> (not (= j8 0)) (= (rec__tree_model__path_type__a (us_split_fields1 (select r2 j8))) o25)))
(assert (=> (not (= j8 0)) (= (of_int 1) o26)))
(assert (=> (not (= j8 0)) (and (<= 1 j8) (<= j8 100))))
(assert (=> (not (= j8 0)) (= o27 j8)))
(assert (=> (not (= j8 0)) (= o28 (store r2 o27 (mk___rep (mk___split_fields o25 o26))))))
(assert (=> (not (= j8 0)) (= result10 (mk_map__ref r2))))
(assert (=> (not (= j8 0)) (= r3 o28)))
(assert (=> (not (= j8 0)) (and (<= 1 j8) (<= j8 100))))
(assert (=> (not (= j8 0)) (= o29 j8)))
(assert (=> (not (= j8 0)) (= (mk___rep1 (mk___split_fields1 o30 o31 o32 o33)) (select (rec__binary_trees__forest__c (us_split_fields5 f)) o29))))
(assert (=> (not (= j8 0)) (= o34 (mk___split_fields1 o30 o31 o32 o33))))
(assert (=> (not (= j8 0)) (= o35 (rec__binary_trees__cell__parent o34))))
(assert (=> (not (= j8 0)) (= temp___599 (to_rep o35))))
(assert (=> (not (= j8 0)) (and (<= 1 temp___599) (<= temp___599 100))))
(assert (=> (not (= j8 0)) (= o36 temp___599)))
(assert (=> (not (= j8 0)) (= o37 (select r3 o36))))
(assert (=> (not (= j8 0)) (= o38 (us_split_fields1 o37))))
(assert (=> (not (= j8 0)) (= o39 (rec__tree_model__path_type__a o38))))
(assert (=> (not (= j8 0)) (and (= o40 (add o39 0)) (and (= (length o40) (+ (length o39) 1)) (and (= (get o40 (last o40)) 0) (= (ole o39 o40) true))))))
(assert (=> (not (= j8 0)) (= o41 (mk___split_fields o40 (rec__tree_model__path_type__k (us_split_fields1 (select r3 j8)))))))
(assert (=> (not (= j8 0)) (= temp___601 (mk___rep o41))))
(assert (=> (not (= j8 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___601))) 100)))
(assert (=> (not (= j8 0)) (= o42 temp___601)))
(assert (=> (not (= j8 0)) (and (<= 1 j8) (<= j8 100))))
(assert (=> (not (= j8 0)) (= o43 j8)))
(assert (=> (not (= j8 0)) (= o44 (store r3 o43 o42))))
(assert (=> (not (= j8 0)) (= result11 (mk_map__ref r3))))
(assert (=> (not (= j8 0)) (= r4 o44)))
(assert (=> (not (= j8 0)) (and (<= 1 j8) (<= j8 100))))
(assert (=> (not (= j8 0)) (= o45 j8)))
(assert (=> (not (= j8 0)) (= o46 (store todo3 o45 (of_int 1)))))
(assert (=> (not (= j8 0)) (= result12 (mk_map__ref2 todo3))))
(assert (=> (not (= j8 0)) (= todo4 o46)))
(assert (=> (= j8 0) (= r4 r2)))
(assert (=> (= j8 0) (= todo4 todo3)))
(assert (and (<= 1 i4) (<= i4 100)))
(assert (= o47 i4))
(assert (= o48 (select (rec__binary_trees__forest__c (us_split_fields5 f)) o47)))
(assert (= o49 (us_split_fields3 o48)))
(assert (= o50 (rec__binary_trees__cell__right o49)))
(assert (= o51 (to_rep o50)))
(assert (= result13 (mk_int__ref j8)))
(assert (= j9 o51))
(assert (=> (not (= j9 0)) (< 0 (length1 unseen3))))
(assert (=> (not (= j9 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 (select r4 j9)))) 100)))
(assert (=> (not (= j9 0)) (= o52 (mk___rep (mk___split_fields (rec__tree_model__path_type__a (us_split_fields1 (select r4 j9))) (of_int 1))))))
(assert (=> (not (= j9 0)) (and (<= 1 j9) (<= j9 100))))
(assert (=> (not (= j9 0)) (= o53 j9)))
(assert (=> (not (= j9 0)) (= o54 (store r4 o53 o52))))
(assert (=> (not (= j9 0)) (= result14 (mk_map__ref r4))))
(assert (=> (not (= j9 0)) (= r5 o54)))
(assert (=> (not (= j9 0)) (and (<= 1 j9) (<= j9 100))))
(assert (=> (not (= j9 0)) (= o55 j9)))
(assert (=> (not (= j9 0)) (= o56 (select (rec__binary_trees__forest__c (us_split_fields5 f)) o55))))
(assert (=> (not (= j9 0)) (= o57 (us_split_fields3 o56))))
(assert (=> (not (= j9 0)) (= o58 (rec__binary_trees__cell__parent o57))))
(assert (=> (not (= j9 0)) (= temp___606 (to_rep o58))))
(assert (=> (not (= j9 0)) (and (<= 1 temp___606) (<= temp___606 100))))
(assert (=> (not (= j9 0)) (= o59 temp___606)))
(assert (=> (not (= j9 0)) (= o60 (select r5 o59))))
(assert (=> (not (= j9 0)) (= o61 (us_split_fields1 o60))))
(assert (=> (not (= j9 0)) (= o62 (rec__tree_model__path_type__a o61))))
(assert (=> (not (= j9 0)) (and (= o63 (add o62 1)) (and (= (length o63) (+ (length o62) 1)) (and (= (get o63 (last o63)) 1) (= (ole o62 o63) true))))))
(assert (=> (not (= j9 0)) (= o64 (mk___split_fields o63 (rec__tree_model__path_type__k (us_split_fields1 (select r5 j9)))))))
(assert (=> (not (= j9 0)) (= temp___608 (mk___rep o64))))
(assert (=> (not (= j9 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___608))) 100)))
(assert (=> (not (= j9 0)) (= o65 temp___608)))
(assert (=> (not (= j9 0)) (and (<= 1 j9) (<= j9 100))))
(assert (=> (not (= j9 0)) (= o66 j9)))
(assert (=> (not (= j9 0)) (= o67 (store r5 o66 o65))))
(assert (=> (not (= j9 0)) (= result15 (mk_map__ref r5))))
(assert (=> (not (= j9 0)) (= r6 o67)))
(assert (=> (not (= j9 0)) (and (<= 1 j9) (<= j9 100))))
(assert (=> (not (= j9 0)) (= o68 j9)))
(assert (=> (not (= j9 0)) (= o69 (store todo4 o68 (of_int 1)))))
(assert (=> (not (= j9 0)) (= result16 (mk_map__ref2 todo4))))
(assert (=> (not (= j9 0)) (= todo5 o69)))
(assert (=> (= j9 0) (= r6 r4)))
(assert (=> (= j9 0) (= todo5 todo4)))
(assert (and (<= 1 i4) (<= i4 100)))
(assert (= o70 i4))
(assert (= o71 (store todo5 o70 (of_int 0))))
(assert (= result17 (mk_map__ref2 todo5)))
(assert (= todo6 o71))
(assert (and (= o72 (next todo6)) (and (in_range2 o72) (ite (= o72 0) (forall ((i12 Int)) (=> (and (<= 1 i12) (<= i12 100)) (not (= (select todo6 i12) true)))) (= (select todo6 o72) true)))))
(assert (= result18 (mk_int__ref i4)))
(assert (= i5 o72))
(assert (not (= i5 0)))
(declare-const j16 Int)
(assert (<= 1 j16))
(assert (<= j16 100))
(assert (= (contains unseen3 j16) true))
(assert (not (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r6 j16))) true)) (= (select todo6 j16) true))))
(check-sat)
(exit)
