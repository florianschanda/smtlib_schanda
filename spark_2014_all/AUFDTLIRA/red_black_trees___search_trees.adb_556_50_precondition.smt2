...
(declare-const i Int)
(declare-const j Int)
(declare-const temp___1836 (Array Int us_rep1))
(declare-const o us_rep1)
(declare-const o1 us_split_fields)
(declare-const temp___1835 (Array Int us_rep1))
...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) j1))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j1)))) true)) (and (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f2 root) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f2 root) j1))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) j1)))) true)) (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j1))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i1)))) 1)) (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) j1))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) i1)))) 1))))))))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (<= 1 j))
(assert (<= j 100))
(assert (and (= temp___1835 (model__ f1 root)) (and (dynamic_invariant4 temp___1835 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1835 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1835 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f1 i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1835 (parent f1 i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1835 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1835 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1835 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1835 (parent f1 i1)))) (position f1 i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1835 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1835 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1835 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1835 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1835 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1835 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o2 (select temp___1835 i)))
(assert (= o3 (us_split_fields1 o2)))
(assert (= result1 (rec__tree_model__path_type__k o3)))
(assert (=> (= result1 true) (and (= temp___1836 (model__ f1 root)) (and (dynamic_invariant4 temp___1836 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1836 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1836 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f1 i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1836 (parent f1 i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1836 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1836 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1836 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1836 (parent f1 i1)))) (position f1 i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1836 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1836 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1836 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1836 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1836 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1836 j1)))) true)) (= j1 i1)))))))))))))))
(assert (=> (= result1 true) (= o (select temp___1836 j))))
(assert (=> (= result1 true) (= o1 (us_split_fields1 o))))
(assert (=> (= result1 true) (= result (rec__tree_model__path_type__k o1))))
