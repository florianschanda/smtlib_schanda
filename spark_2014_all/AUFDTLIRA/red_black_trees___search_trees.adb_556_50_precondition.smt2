...
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) j2))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j2)))) true)) (and (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f2 root) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f2 root) j2))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) j2)))) true)) (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i2)))) 1)) (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) j2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f2 root) i2)))) 1))))))))))
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (<= 1 j1))
(assert (<= j1 100))
(assert (and (= temp___1791 (model__ f1 root)) (and (dynamic_invariant4 temp___1791 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1791 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1791 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent f1 i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1791 (parent f1 i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1791 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1791 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1791 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1791 (parent f1 i2)))) (position f1 i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1791 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1791 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1791 i2))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1791 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1791 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1791 j2)))) true)) (= j2 i2))))))))))))))
(assert (= o64 (select temp___1791 i1)))
(assert (= o65 (us_split_fields1 o64)))
(assert (= result11 (rec__tree_model__path_type__k o65)))
(assert (=> (= result11 true) (and (= temp___1792 (model__ f1 root)) (and (dynamic_invariant4 temp___1792 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1792 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1792 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent f1 i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1792 (parent f1 i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1792 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1792 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1792 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1792 (parent f1 i2)))) (position f1 i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1792 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1792 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1792 i2))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1792 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1792 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1792 j2)))) true)) (= j2 i2)))))))))))))))
(assert (=> (= result11 true) (= o62 (select temp___1792 j1))))
(assert (=> (= result11 true) (= o63 (us_split_fields1 o62))))
(assert (=> (= result11 true) (= result10 (rec__tree_model__path_type__k o63))))
