...
(assert (<= 1 i20))
(assert (<= i20 100))
(assert (not (<= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i20)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i20)))))))
(check-sat)
(exit)
