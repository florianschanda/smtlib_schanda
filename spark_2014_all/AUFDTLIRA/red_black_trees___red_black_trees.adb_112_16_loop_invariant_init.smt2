...
(assert (<= 1 i2))
(assert (<= i2 100))
(assert (not (<= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res2 i2)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res2 i2)))))))
(check-sat)
(exit)
