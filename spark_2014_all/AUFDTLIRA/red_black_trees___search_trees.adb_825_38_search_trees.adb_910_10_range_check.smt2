...
(assert (and (= o41 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (and (= o42 (model__ (mk___rep2 f_1__split_fields3) o41)) (and (dynamic_invariant6 o42 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o42 o41))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o42 o41)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 o41)) (ite (and (not (= (parent (mk___rep2 f_1__split_fields3) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o42 (parent (mk___rep2 f_1__split_fields3) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o42 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o42 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o42 i5))) true) (not (= i5 o41))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o42 (parent (mk___rep2 f_1__split_fields3) i5)))) (position (mk___rep2 f_1__split_fields3) i5) (rec__tree_model__path_type__a (us_split_fields1 (select o42 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o42 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o42 i5))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o42 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o42 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select o42 j15)))) true)) (= j15 i5))))))))))))))
