...
(assert (and (= o55 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 o55)))
(assert (= result12 (ite (in_range4 o55) true false)))
(assert (=> (= result12 true) (and (= o51 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o51))))
(assert (=> (= result12 true) (= result13 (ite (< j o51) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o52 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o53 (get (rec__list_allocator__m__t__allocated model____split_fields3) o52)) (in_range7 o53)))))
(assert (=> (= result12 true) (=> (not (= result13 true)) (= o53 0))))
(assert (=> (= result12 true) (and (= temp___433 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___433))))
(assert (=> (= result12 true) (and (<= 1 temp___433) (<= temp___433 3))))
(assert (=> (= result12 true) (= o47 temp___433)))
(assert (=> (= result12 true) (= o48 (select data3 o47))))
(assert (=> (= result12 true) (= o49 (us_split_fields1 o48))))
(assert (=> (= result12 true) (= o50 (rec__list_allocator__cell__next o49))))
...
(assert (=> (< 1 j) (and (= o46 (get (rec__list_allocator__m__t__allocated model____split_fields3) o45)) (in_range7 o46))))
(assert (=> (not (< 1 j)) (= o46 0)))
(assert (and (= temp___434 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___434)))
(assert (not (<= 1 temp___434)))
(check-sat)
(exit)
