...
(assert (and (= o65 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o65)))
(assert (= o66 (ite (<= j1 o65) true false)))
(assert (= result16 (ite (<= 1 j1) o66 false)))
(assert (= result16 true))
(assert (and (= o86 (get (rec__list_allocator__m__t__allocated model____split_fields4) j1)) (in_range7 o86)))
(assert (= result19 (ite (in_range4 o86) true false)))
(assert (=> (= result19 true) (and (= o82 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o82))))
(assert (=> (= result19 true) (= result20 (ite (< j1 o82) true false))))
(assert (=> (= result19 true) (=> (= result20 true) (and (= o83 (+ j1 1)) (in_range1 (+ j1 1))))))
(assert (=> (= result19 true) (=> (= result20 true) (and (= o84 (get (rec__list_allocator__m__t__allocated model____split_fields4) o83)) (in_range7 o84)))))
(assert (=> (= result19 true) (=> (not (= result20 true)) (= o84 0))))
(assert (=> (= result19 true) (and (= temp___400 (get (rec__list_allocator__m__t__allocated model____split_fields4) j1)) (in_range7 temp___400))))
(assert (=> (= result19 true) (and (<= 1 temp___400) (<= temp___400 3))))
(assert (=> (= result19 true) (= o78 temp___400)))
(assert (=> (= result19 true) (= o79 (select data4 o78))))
(assert (=> (= result19 true) (= o80 (us_split_fields1 o79))))
(assert (=> (= result19 true) (= o81 (rec__list_allocator__cell__next o80))))
(assert (=> (= result19 true) (= o85 (to_rep o81))))
(assert (=> (= result19 true) (= result18 (ite (= o85 o84) true false))))
(assert (=> (not (= result19 true)) (= result18 false)))
(assert (= result18 true))
(assert (=> (< 1 j1) (and (= o75 (- j1 1)) (in_range2 (- j1 1)))))
(assert (=> (< 1 j1) (and (= o76 (get (rec__list_allocator__m__t__allocated model____split_fields4) o75)) (in_range7 o76))))
(assert (=> (not (< 1 j1)) (= o76 0)))
(assert (and (= temp___401 (get (rec__list_allocator__m__t__allocated model____split_fields4) j1)) (in_range7 temp___401)))
(assert (not (<= 1 temp___401)))
(check-sat)
(exit)
