...
(assert (and (= o48 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o48)))
(assert (= result12 (ite (in_range7 o48) true false)))
(assert (=> (= result12 true) (and (= o44 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o44))))
(assert (=> (= result12 true) (= result13 (ite (< j o44) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o45 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o46 (get (rec__list_allocator__m__t__allocated model____split_fields3) o45)) (in_range4 o46)))))
(assert (=> (= result12 true) (=> (not (= result13 true)) (= o46 0))))
(assert (=> (= result12 true) (and (= temp___433 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 temp___433))))
(assert (=> (= result12 true) (and (<= 1 temp___433) (<= temp___433 3))))
(assert (=> (= result12 true) (= o40 temp___433)))
(assert (=> (= result12 true) (= o41 (select data3 o40))))
(assert (=> (= result12 true) (= o42 (us_split_fields3 o41))))
(assert (=> (= result12 true) (= o43 (rec__list_allocator__cell__next o42))))
(assert (=> (= result12 true) (= o47 (to_rep o43))))
(assert (=> (= result12 true) (= result11 (ite (= o47 o46) true false))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (= result11 true))
(assert (=> (< 1 j) (and (= o38 (- j 1)) (in_range2 (- j 1)))))
(assert (=> (< 1 j) (and (= o39 (get (rec__list_allocator__m__t__allocated model____split_fields3) o38)) (in_range4 o39))))
(assert (=> (not (< 1 j)) (= o39 0)))
(assert (and (= temp___434 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 temp___434)))
(assert (not (<= temp___434 3)))
(check-sat)
(exit)
