...
(assert (=> (= result7 true) (and (= temp___276 (get model____split_fields j)) (in_range7 temp___276))))
(assert (=> (= result7 true) (and (<= 1 temp___276) (<= temp___276 10000))))
(assert (=> (= result7 true) (= o3 temp___276)))
