...
(assert (and (= o22 (length model____split_fields)) (and (in_range6 o22) (<= (+ 0 o22) 2147483647))))
(assert (= result3 (ite (<= o22 10000) true false)))
(assert (=> (= result3 true) (and (= o21 (length1 model____split_fields1)) (in_range6 o21))))
(assert (=> (= result3 true) (= result2 (ite (<= o21 10000) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o17 (length1 model____split_fields1)) (in_range6 o17))))
(assert (=> (= result2 true) (and (= o18 (length model____split_fields)) (and (in_range6 o18) (<= (+ 0 o18) 2147483647)))))
(assert (=> (= result2 true) (= o19 (+ o18 o17))))
(assert (=> (= result2 true) (and (= o20 o19) (in_range2 o19))))
(assert (=> (= result2 true) (= result1 (ite (= o20 10000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o15 (length model____split_fields)) (and (in_range6 o15) (<= (+ 0 o15) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result4 (ite (< 0 o15) true false)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result4 true) (and (= o14 (get model____split_fields 1)) (in_range7 o14))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result4 true) (= result (ite (= o14 first_available) true false))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (not (= result4 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (and (= o16 (length model____split_fields)) (and (in_range6 o16) (<= (+ 0 o16) 2147483647))))))
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (= result (ite (= o16 0) true false)))))
...
(assert (= result5 true))
(assert (and (= o13 (get model____split_fields j)) (in_range7 o13)))
(assert (= result7 (ite (in_range4 o13) true false)))
(assert (=> (= result7 true) (and (= o9 (length model____split_fields)) (and (in_range6 o9) (<= (+ 0 o9) 2147483647)))))
(assert (=> (= result7 true) (= result8 (ite (< j o9) true false))))
(assert (=> (= result7 true) (=> (= result8 true) (and (= o10 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result7 true) (=> (= result8 true) (and (= o11 (get model____split_fields o10)) (in_range7 o11)))))
(assert (=> (= result7 true) (=> (not (= result8 true)) (= o11 0))))
(assert (=> (= result7 true) (and (= temp___313 (get model____split_fields j)) (in_range7 temp___313))))
(assert (=> (= result7 true) (and (<= 1 temp___313) (<= temp___313 10000))))
(assert (=> (= result7 true) (= o3 temp___313)))
(assert (=> (= result7 true) (= (mk___rep (mk___split_fields o4 o5)) (select data o3))))
(assert (=> (= result7 true) (= o4 o6)))
(assert (=> (= result7 true) (= o5 o7)))
(assert (=> (= result7 true) (= o8 o7)))
(assert (=> (= result7 true) (= o12 (to_rep o8))))
(assert (=> (= result7 true) (= result6 (ite (= o12 o11) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (= result6 true))
(assert (<= 1 k))
(assert (<= k (- j 1)))
(assert (and (= o2 (get model____split_fields k)) (in_range7 o2)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
