...
(define-fun dynamic_invariant ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 0 10000)) (in_range3 temp___expr_148)))
...
(define-fun dynamic_invariant2 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 10000)) (in_range7 temp___expr_172)))
...
(define-fun dynamic_invariant3 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 2147483647)) (in_range8 temp___expr_178)))
...
(define-fun dynamic_invariant4 ((temp___expr_191 Int) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool)) Bool (=> (or (= temp___is_init_188 true) (<= 0 10000)) (in_range9 temp___expr_191)))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant4 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range9 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
...
(define-fun dynamic_invariant6 ((temp___expr_228 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 0 1)) (in_range5 temp___expr_228)))
(define-fun dynamic_invariant7 ((temp___expr_154 Int) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (or (= temp___is_init_151 true) (<= 1 10000)) (in_range4 temp___expr_154)))
...
(assert (and (= o24 (length model____split_fields)) (and (in_range6 o24) (<= (+ 0 o24) 2147483647))))
(assert (= result4 (ite (<= o24 10000) true false)))
(assert (=> (= result4 true) (and (= o23 (length1 model____split_fields1)) (in_range6 o23))))
(assert (=> (= result4 true) (= result3 (ite (<= o23 10000) true false))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (=> (= result3 true) (and (= o19 (length1 model____split_fields1)) (in_range6 o19))))
(assert (=> (= result3 true) (and (= o20 (length model____split_fields)) (and (in_range6 o20) (<= (+ 0 o20) 2147483647)))))
(assert (=> (= result3 true) (= o21 (+ o20 o19))))
(assert (=> (= result3 true) (and (= o22 o21) (in_range2 o21))))
(assert (=> (= result3 true) (= result2 (ite (= o22 10000) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (and (= o17 (length model____split_fields)) (and (in_range6 o17) (<= (+ 0 o17) 2147483647))))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (= result5 (ite (< 0 o17) true false)))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (=> (= result5 true) (and (= o16 (get model____split_fields 1)) (in_range7 o16))))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (=> (= result5 true) (= result1 (ite (= o16 first_available) true false))))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (=> (not (= result5 true)) (= result1 false)))))
(assert (=> (= result2 true) (=> (= first_available 0) (and (= o18 (length model____split_fields)) (and (in_range6 o18) (<= (+ 0 o18) 2147483647))))))
(assert (=> (= result2 true) (=> (= first_available 0) (= result1 (ite (= o18 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (= result1 true))
(assert (and (= o1 (length model____split_fields)) (and (in_range6 o1) (<= (+ 0 o1) 2147483647))))
(assert (= o2 (ite (<= j o1) true false)))
(assert (= result6 (ite (<= 1 j) o2 false)))
(assert (= result6 true))
(assert (and (= o15 (get model____split_fields j)) (in_range7 o15)))
(assert (= result8 (ite (in_range4 o15) true false)))
(assert (=> (= result8 true) (and (= o11 (length model____split_fields)) (and (in_range6 o11) (<= (+ 0 o11) 2147483647)))))
(assert (=> (= result8 true) (= result9 (ite (< j o11) true false))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o12 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o13 (get model____split_fields o12)) (in_range7 o13)))))
(assert (=> (= result8 true) (=> (not (= result9 true)) (= o13 0))))
(assert (=> (= result8 true) (and (= temp___276 (get model____split_fields j)) (in_range7 temp___276))))
(assert (=> (= result8 true) (and (<= 1 temp___276) (<= temp___276 10000))))
(assert (=> (= result8 true) (= o5 temp___276)))
(assert (=> (= result8 true) (= (mk___rep (mk___split_fields o6 o7)) (select data o5))))
(assert (=> (= result8 true) (= o6 o8)))
(assert (=> (= result8 true) (= o7 o9)))
(assert (=> (= result8 true) (= o10 o9)))
(assert (=> (= result8 true) (= o14 (to_rep o10))))
(assert (=> (= result8 true) (= result7 (ite (= o14 o13) true false))))
(assert (=> (not (= result8 true)) (= result7 false)))
(assert (= result7 true))
(assert (<= 1 k))
(assert (<= k (- j 1)))
(assert (and (= o3 (get model____split_fields k)) (in_range7 o3)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
