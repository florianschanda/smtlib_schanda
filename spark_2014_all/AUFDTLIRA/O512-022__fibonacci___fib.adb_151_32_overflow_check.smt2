...
(assert (=> (and (<= 0 i1) (<= i1 k)) (and (forall ((temp___222 Int)) (=> (and (<= 0 temp___222) (<= temp___222 100)) (=> (<= i2 temp___222) (= (select a12 temp___222) (select temp___221 temp___222))))) (and (<= 0 i2) (<= i2 k)))))
