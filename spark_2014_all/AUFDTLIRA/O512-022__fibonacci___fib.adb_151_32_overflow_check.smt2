...
(assert (= i1 0))
(assert (=> (and (<= 0 i1) (<= i1 k)) (= temp___244 a1)))
(assert (=> (and (<= 0 i1) (<= i1 k)) (and (forall ((temp___245 Int)) (=> (and (<= 0 temp___245) (<= temp___245 100)) (=> (<= i2 temp___245) (= (select a12 temp___245) (select temp___244 temp___245))))) (and (<= 0 i2) (<= i2 k)))))
