...
(assert (forall ((i1 Int)) (=> (and (<= 31 i1) (<= i1 40)) (= (distinct (to_rep (select (elts r5) i1)) 0) true))))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt r5))) i1) (<= i1 (to_rep1 (last (rt r5))))) (=> (not (and (<= 11 i1) (<= i1 30))) (= (distinct (to_rep (select (elts r5) i1)) 0) true)))))
(assert (<= 11 i))
(assert (<= i 30))
(assert (not (<= i (to_rep1 (last (rt r5))))))
(check-sat)
(exit)
