...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 10)) (= (of_int (to_rep (select (elts r5) i1))) true))))
(assert (forall ((i1 Int)) (=> (and (<= 31 i1) (<= i1 40)) (= (of_int (to_rep (select (elts r5) i1))) true))))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt r5))) i1) (<= i1 (to_rep1 (last (rt r5))))) (=> (not (and (<= 11 i1) (<= i1 30))) (= (of_int (to_rep (select (elts r5) i1))) true)))))
(assert (<= 11 i))
(assert (<= i 30))
