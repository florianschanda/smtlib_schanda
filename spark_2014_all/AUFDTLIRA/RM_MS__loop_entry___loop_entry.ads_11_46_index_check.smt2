...
(assert (=> (and (<= l i1) (<= i1 u)) (and (forall ((n1 Int)) (=> (and (<= l n1) (<= n1 i2)) (= (to_rep (select a3 n1)) 0))) (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 100)) (=> (or (< n1 l) (< i2 n1)) (= (to_rep (select a3 n1)) (to_rep (select temp___185 n1)))))))))
