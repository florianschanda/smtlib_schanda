...
(assert (=> (and (<= l i1) (<= i1 u)) (and (forall ((n1 Int)) (=> (and (<= l n1) (<= n1 i2)) (= (to_rep (select a3 n1)) 0))) (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 100)) (=> (or (< n1 l) (< i2 n1)) (= (to_rep (select a3 n1)) (to_rep (select temp___160 n1)))))))))
...
(assert (= i8 i6))
(assert (= a9 a7))
(assert (= (= o2 true) (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 100)) (=> (or (< n1 l) (< u n1)) (= (to_rep (select a8 n1)) (to_rep (select a n1))))))))
(assert (<= l n))
(assert (<= n u))
(assert (not (<= 1 n)))
(check-sat)
