...
(assert (= result2 true))
(assert (and (= o18 (valid_root f v)) (=> (< (size f) v) (not (= o18 true)))))
(assert (= result3 (ite (not (= o18 true)) true false)))
(assert (= result3 true))
...
(assert (= o16 (select temp___1760 v)))
(assert (= o17 (us_split_fields1 o16)))
(assert (= result4 (rec__tree_model__path_type__k o17)))
(assert (= result4 true))
