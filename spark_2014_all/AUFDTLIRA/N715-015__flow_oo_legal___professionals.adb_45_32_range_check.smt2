...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_922 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_922 us_void_param) 2)) 97)) (= (to_rep (select (temp___String_Literal_922 us_void_param) 3)) 109)) (= (to_rep (select (temp___String_Literal_922 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_922 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_922 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_922 us_void_param) 7)) 115)) (= (to_rep (select (temp___String_Literal_922 us_void_param) 8)) 115)) :pattern ((temp___String_Literal_922 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_1052 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1052 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1052 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_1052 us_void_param) 4)) 32)) :pattern ((temp___String_Literal_1052 us_void_param)))))
(declare-fun temp___String_Literal_1055 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_1055 us_void_param) 1)) 100) (= (to_rep (select (temp___String_Literal_1055 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1055 us_void_param) 3)) 97)) (= (to_rep (select (temp___String_Literal_1055 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_1055 us_void_param) 5)) 46)) :pattern ((temp___String_Literal_1055 us_void_param)))))
(declare-fun temp___String_Literal_1056 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1056 us_void_param) 1)) 97) (= (to_rep (select (temp___String_Literal_1056 us_void_param) 2)) 108)) (= (to_rep (select (temp___String_Literal_1056 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_1056 us_void_param) 4)) 118)) (= (to_rep (select (temp___String_Literal_1056 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1056 us_void_param) 6)) 46)) :pattern ((temp___String_Literal_1056 us_void_param)))))
(declare-fun temp___String_Literal_1057 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1057 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_1057 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1057 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_1057 us_void_param) 4)) 102)) (= (to_rep (select (temp___String_Literal_1057 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1057 us_void_param) 6)) 115)) (= (to_rep (select (temp___String_Literal_1057 us_void_param) 7)) 115)) (= (to_rep (select (temp___String_Literal_1057 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1057 us_void_param) 9)) 111)) (= (to_rep (select (temp___String_Literal_1057 us_void_param) 10)) 110)) (= (to_rep (select (temp___String_Literal_1057 us_void_param) 11)) 58)) (= (to_rep (select (temp___String_Literal_1057 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_1057 us_void_param)))))
(declare-fun temp___String_Literal_1060 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1060 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_1060 us_void_param) 2)) 107)) (= (to_rep (select (temp___String_Literal_1060 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_1060 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_1060 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_1060 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_1060 us_void_param) 7)) 100)) (= (to_rep (select (temp___String_Literal_1060 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_1060 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1060 us_void_param) 10)) 110)) (= (to_rep (select (temp___String_Literal_1060 us_void_param) 11)) 32)) :pattern ((temp___String_Literal_1060 us_void_param)))))
...
(assert (and (= (mk___t temp___1053 temp___10531) (to_string1 o)) (dynamic_invariant (mk___t temp___1053 temp___10531) true false true)))
(assert (=> (= (length (mk___t temp___1053 temp___10531)) 0) (= (temp___String_Literal_1052 Tuple0) o7)))
(assert (=> (= (length (mk___t temp___1053 temp___10531)) 0) (= (mk 1 4) o8)))
(assert (=> (not (= (length (mk___t temp___1053 temp___10531)) 0)) (=> (<= 1 4) (= o1 (+ (- 4 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1053 temp___10531)) 0)) (=> (not (<= 1 4)) (= o1 0))))
(assert (=> (not (= (length (mk___t temp___1053 temp___10531)) 0)) (=> (<= (to_rep1 (first temp___10531)) (to_rep1 (last temp___10531))) (= o2 (+ (- (to_rep1 (last temp___10531)) (to_rep1 (first temp___10531))) 1)))))
(assert (=> (not (= (length (mk___t temp___1053 temp___10531)) 0)) (=> (not (<= (to_rep1 (first temp___10531)) (to_rep1 (last temp___10531)))) (= o2 0))))
(assert (=> (not (= (length (mk___t temp___1053 temp___10531)) 0)) (= o3 (+ o2 o1))))
(assert (=> (not (= (length (mk___t temp___1053 temp___10531)) 0)) (= o4 (+ (to_rep1 (first temp___10531)) o3))))
(assert (=> (not (= (length (mk___t temp___1053 temp___10531)) 0)) (= o5 (- o4 1))))
(assert (=> (not (= (length (mk___t temp___1053 temp___10531)) 0)) (and (= o6 o5) (in_range1 o5))))
(assert (=> (not (= (length (mk___t temp___1053 temp___10531)) 0)) (= (concat1 temp___1053 (to_rep1 (first temp___10531)) (to_rep1 (last temp___10531)) (temp___String_Literal_1052 Tuple0) 1 4) o7)))
(assert (=> (not (= (length (mk___t temp___1053 temp___10531)) 0)) (= (mk (to_rep1 (first temp___10531)) o6) o8)))
