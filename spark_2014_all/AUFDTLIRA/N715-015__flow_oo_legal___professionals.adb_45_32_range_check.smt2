...
(assert (forall ((source us_rep)) (! (dynamic_invariant (to_string1 source) true false true) :pattern ((to_string1 source)))))
(assert (forall ((attr__tag Int)) (forall ((source us_rep)) (! (dynamic_invariant (to_string2 attr__tag source) true false true) :pattern ((to_string2 attr__tag source))))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_928 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_928 us_void_param) 2)) 97)) (= (to_rep (select (temp___String_Literal_928 us_void_param) 3)) 109)) (= (to_rep (select (temp___String_Literal_928 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_928 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_928 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_928 us_void_param) 7)) 115)) (= (to_rep (select (temp___String_Literal_928 us_void_param) 8)) 115)) :pattern ((temp___String_Literal_928 us_void_param)))))
(define-fun default_initial_assumption ((temp___expr_926 us_rep1) (temp___skip_top_level_927 Bool)) Bool (and (= (attr__tag temp___expr_926) us_tag) (and (and (= (rec__people__person__name (us_split_fields1 temp___expr_926)) (to_unbounded_string (of_array (temp___String_Literal_928 Tuple0) 1 8))) (= (to_rep1 (rec__people__person__dob (us_split_fields1 temp___expr_926))) (- 1))) (= (rec__people__person__alive (us_split_fields1 temp___expr_926)) (of_int 0)))))
...
(define-fun default_initial_assumption1 ((temp___expr_980 us_rep2) (temp___skip_top_level_981 Bool)) Bool (and (= (attr__tag1 temp___expr_980) us_tag1) (and (and (= (rec__people__person__name1 (us_split_fields3 temp___expr_980)) (to_unbounded_string (of_array (temp___String_Literal_928 Tuple0) 1 8))) (= (to_rep1 (rec__people__person__dob1 (us_split_fields3 temp___expr_980))) (- 1))) (= (rec__people__person__alive1 (us_split_fields3 temp___expr_980)) (of_int 0)))))
(declare-const this us_rep2)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun temp___String_Literal_1058 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_1058 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1058 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1058 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_1058 us_void_param) 4)) 32)) :pattern ((temp___String_Literal_1058 us_void_param)))))
(declare-fun temp___String_Literal_1061 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_1061 us_void_param) 1)) 100) (= (to_rep (select (temp___String_Literal_1061 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1061 us_void_param) 3)) 97)) (= (to_rep (select (temp___String_Literal_1061 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_1061 us_void_param) 5)) 46)) :pattern ((temp___String_Literal_1061 us_void_param)))))
(declare-fun temp___String_Literal_1062 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1062 us_void_param) 1)) 97) (= (to_rep (select (temp___String_Literal_1062 us_void_param) 2)) 108)) (= (to_rep (select (temp___String_Literal_1062 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_1062 us_void_param) 4)) 118)) (= (to_rep (select (temp___String_Literal_1062 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1062 us_void_param) 6)) 46)) :pattern ((temp___String_Literal_1062 us_void_param)))))
(declare-fun temp___String_Literal_1063 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1063 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_1063 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1063 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_1063 us_void_param) 4)) 102)) (= (to_rep (select (temp___String_Literal_1063 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1063 us_void_param) 6)) 115)) (= (to_rep (select (temp___String_Literal_1063 us_void_param) 7)) 115)) (= (to_rep (select (temp___String_Literal_1063 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1063 us_void_param) 9)) 111)) (= (to_rep (select (temp___String_Literal_1063 us_void_param) 10)) 110)) (= (to_rep (select (temp___String_Literal_1063 us_void_param) 11)) 58)) (= (to_rep (select (temp___String_Literal_1063 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_1063 us_void_param)))))
(declare-fun temp___String_Literal_1066 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1066 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_1066 us_void_param) 2)) 107)) (= (to_rep (select (temp___String_Literal_1066 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_1066 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_1066 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_1066 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_1066 us_void_param) 7)) 100)) (= (to_rep (select (temp___String_Literal_1066 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_1066 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1066 us_void_param) 10)) 110)) (= (to_rep (select (temp___String_Literal_1066 us_void_param) 11)) 32)) :pattern ((temp___String_Literal_1066 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_951 Int) (temp___is_init_948 Bool) (temp___skip_constant_949 Bool) (temp___do_toplevel_950 Bool)) Bool (=> (or (= temp___is_init_948 true) (<= 0 3)) (in_range5 temp___expr_951)))
(define-fun dynamic_invariant6 ((temp___expr_957 Int) (temp___is_init_954 Bool) (temp___skip_constant_955 Bool) (temp___do_toplevel_956 Bool)) Bool (=> (or (= temp___is_init_954 true) (<= 0 12)) (in_range6 temp___expr_957)))
(assert true)
(assert true)
(declare-const o us_rep)
(declare-const temp___1059 (Array Int character))
(declare-const temp___10591 t)
...
(assert (and (= temp___10592 (to_string1 o)) (dynamic_invariant temp___10592 true false true)))
(assert (=> (= (length temp___10592) 0) (= (temp___String_Literal_1058 Tuple0) o7)))
(assert (=> (= (length temp___10592) 0) (= (mk 1 4) o8)))
(assert (=> (not (= (length temp___10592) 0)) (=> (<= 1 4) (= o1 (+ (- 4 1) 1)))))
(assert (=> (not (= (length temp___10592) 0)) (=> (not (<= 1 4)) (= o1 0))))
(assert (=> (not (= (length temp___10592) 0)) (=> (<= (to_rep1 (first temp___10591)) (to_rep1 (last temp___10591))) (= o2 (+ (- (to_rep1 (last temp___10591)) (to_rep1 (first temp___10591))) 1)))))
(assert (=> (not (= (length temp___10592) 0)) (=> (not (<= (to_rep1 (first temp___10591)) (to_rep1 (last temp___10591)))) (= o2 0))))
(assert (=> (not (= (length temp___10592) 0)) (= o3 (+ o2 o1))))
(assert (=> (not (= (length temp___10592) 0)) (= o4 (+ (to_rep1 (first temp___10591)) o3))))
(assert (=> (not (= (length temp___10592) 0)) (= o5 (- o4 1))))
(assert (=> (not (= (length temp___10592) 0)) (and (= o6 o5) (in_range1 o5))))
(assert (=> (not (= (length temp___10592) 0)) (= (concat1 temp___1059 (to_rep1 (first temp___10591)) (to_rep1 (last temp___10591)) (temp___String_Literal_1058 Tuple0) 1 4) o7)))
(assert (=> (not (= (length temp___10592) 0)) (= (mk (to_rep1 (first temp___10591)) o6) o8)))
