...
(assert (forall ((attr__tag Int)) (forall ((source us_rep)) (! (dynamic_invariant (to_string2 attr__tag source) true false true true) :pattern ((to_string2 attr__tag source))))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1012 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_1012 us_void_param) 2)) 97)) (= (to_rep (select (temp___String_Literal_1012 us_void_param) 3)) 109)) (= (to_rep (select (temp___String_Literal_1012 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1012 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_1012 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_1012 us_void_param) 7)) 115)) (= (to_rep (select (temp___String_Literal_1012 us_void_param) 8)) 115)) :pattern ((temp___String_Literal_1012 us_void_param)))))
(define-fun default_initial_assumption ((temp___expr_1010 us_rep1) (temp___skip_top_level_1011 Bool)) Bool (and (= (attr__tag temp___expr_1010) us_tag) (and (and (= (rec__people__person__name (us_split_fields1 temp___expr_1010)) (to_unbounded_string (of_array (temp___String_Literal_1012 Tuple0) 1 8))) (= (to_rep1 (rec__people__person__dob (us_split_fields1 temp___expr_1010))) (- 1))) (= (rec__people__person__alive (us_split_fields1 temp___expr_1010)) (distinct 0 0)))))
...
(define-fun default_initial_assumption1 ((temp___expr_1062 us_rep2) (temp___skip_top_level_1063 Bool)) Bool (and (= (attr__tag1 temp___expr_1062) us_tag1) (and (and (= (rec__people__person__name1 (us_split_fields3 temp___expr_1062)) (to_unbounded_string (of_array (temp___String_Literal_1012 Tuple0) 1 8))) (= (to_rep1 (rec__people__person__dob1 (us_split_fields3 temp___expr_1062))) (- 1))) (= (rec__people__person__alive1 (us_split_fields3 temp___expr_1062)) (distinct 0 0)))))
(declare-const this us_rep2)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun temp___String_Literal_1150 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_1150 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1150 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1150 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_1150 us_void_param) 4)) 32)) :pattern ((temp___String_Literal_1150 us_void_param)))))
(declare-fun temp___String_Literal_1153 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_1153 us_void_param) 1)) 100) (= (to_rep (select (temp___String_Literal_1153 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1153 us_void_param) 3)) 97)) (= (to_rep (select (temp___String_Literal_1153 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_1153 us_void_param) 5)) 46)) :pattern ((temp___String_Literal_1153 us_void_param)))))
(declare-fun temp___String_Literal_1154 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1154 us_void_param) 1)) 97) (= (to_rep (select (temp___String_Literal_1154 us_void_param) 2)) 108)) (= (to_rep (select (temp___String_Literal_1154 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_1154 us_void_param) 4)) 118)) (= (to_rep (select (temp___String_Literal_1154 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1154 us_void_param) 6)) 46)) :pattern ((temp___String_Literal_1154 us_void_param)))))
(declare-fun temp___String_Literal_1155 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1155 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_1155 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1155 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_1155 us_void_param) 4)) 102)) (= (to_rep (select (temp___String_Literal_1155 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1155 us_void_param) 6)) 115)) (= (to_rep (select (temp___String_Literal_1155 us_void_param) 7)) 115)) (= (to_rep (select (temp___String_Literal_1155 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1155 us_void_param) 9)) 111)) (= (to_rep (select (temp___String_Literal_1155 us_void_param) 10)) 110)) (= (to_rep (select (temp___String_Literal_1155 us_void_param) 11)) 58)) (= (to_rep (select (temp___String_Literal_1155 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_1155 us_void_param)))))
(declare-fun temp___String_Literal_1158 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1158 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_1158 us_void_param) 2)) 107)) (= (to_rep (select (temp___String_Literal_1158 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_1158 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_1158 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_1158 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_1158 us_void_param) 7)) 100)) (= (to_rep (select (temp___String_Literal_1158 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_1158 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1158 us_void_param) 10)) 110)) (= (to_rep (select (temp___String_Literal_1158 us_void_param) 11)) 32)) :pattern ((temp___String_Literal_1158 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_1029 Int) (temp___is_init_1025 Bool) (temp___skip_constant_1026 Bool) (temp___do_toplevel_1027 Bool) (temp___do_typ_inv_1028 Bool)) Bool (=> (or (= temp___is_init_1025 true) (<= 0 3)) (in_range5 temp___expr_1029)))
(define-fun dynamic_invariant6 ((temp___expr_1036 Int) (temp___is_init_1032 Bool) (temp___skip_constant_1033 Bool) (temp___do_toplevel_1034 Bool) (temp___do_typ_inv_1035 Bool)) Bool (=> (or (= temp___is_init_1032 true) (<= 0 12)) (in_range6 temp___expr_1036)))
(assert true)
(assert true)
(declare-const o us_rep)
(declare-const temp___1151 (Array Int character))
(declare-const temp___11511 t)
...
(define-fun temp___11512 () us_t (mk___t temp___1151 temp___11511))
...
(assert (and (= temp___11512 (to_string1 o)) (dynamic_invariant temp___11512 true false true true)))
(assert (=> (= (length temp___11512) 0) (= (temp___String_Literal_1150 Tuple0) o7)))
(assert (=> (= (length temp___11512) 0) (= (mk 1 4) o8)))
(assert (=> (not (= (length temp___11512) 0)) (=> (<= 1 4) (= o1 (+ (- 4 1) 1)))))
(assert (=> (not (= (length temp___11512) 0)) (=> (not (<= 1 4)) (= o1 0))))
(assert (=> (not (= (length temp___11512) 0)) (=> (<= (to_rep1 (first temp___11511)) (to_rep1 (last temp___11511))) (= o2 (+ (- (to_rep1 (last temp___11511)) (to_rep1 (first temp___11511))) 1)))))
(assert (=> (not (= (length temp___11512) 0)) (=> (not (<= (to_rep1 (first temp___11511)) (to_rep1 (last temp___11511)))) (= o2 0))))
(assert (=> (not (= (length temp___11512) 0)) (= o3 (+ o2 o1))))
(assert (=> (not (= (length temp___11512) 0)) (= o4 (+ (to_rep1 (first temp___11511)) o3))))
(assert (=> (not (= (length temp___11512) 0)) (= o5 (- o4 1))))
(assert (=> (not (= (length temp___11512) 0)) (and (= o6 o5) (in_range1 o5))))
(assert (=> (not (= (length temp___11512) 0)) (= (concat1 temp___1151 (to_rep1 (first temp___11511)) (to_rep1 (last temp___11511)) (temp___String_Literal_1150 Tuple0) 1 4) o7)))
(assert (=> (not (= (length temp___11512) 0)) (= (mk (to_rep1 (first temp___11511)) o6) o8)))
(assert (= result (is_alive (mk___rep (mk___split_fields (rec__people__person__name1 (us_split_fields3 this)) (rec__people__person__dob1 (us_split_fields3 this)) (rec__people__person__alive1 (us_split_fields3 this)) (hide_ext__ (rec__professionals__professional__profession (us_split_fields3 this)) (rec__professionals__professional__skilled_in (us_split_fields3 this)) (rec__professionals__professional__number_of_people_killed (us_split_fields3 this)) (rec__ext__1 (us_split_fields3 this)))) (attr__tag1 this)))))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this))))))))) (= o9 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this))))))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))))))) (= o9 0)))
