...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (dynamic_invariant (length3 this) true false true true)) :pattern ((length3 this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (let ((result (value this))) (and (and (and (and (= (length result) (length3 this)) (= (first1 result) 1)) (= (last1 result) (length3 this))) (= (< 0 (length3 this)) (not (= (empty this) true)))) (dynamic_invariant2 result true false true true)))) :pattern ((value this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (= (value this) (let ((temp___263 (let ((temp___261 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) (let ((temp___260 1)) (let ((temp___262 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this)))) (of_array3 (to_array2 temp___262) temp___260 temp___261)))))) (of_array (to_array3 temp___263) (first7 temp___263) (last7 temp___263))))) :pattern ((value this)))))
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 r)) (let ((temp___157 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 r)))) (to_array2 temp___157)))))
...
(declare-fun temp___526 (Int Int Int) us_t1)
(define-fun dynamic_invariant3 ((temp___expr_519 us_rep1) (temp___is_init_515 Bool) (temp___skip_constant_516 Bool) (temp___do_toplevel_517 Bool) (temp___do_typ_inv_518 Bool)) Bool (and (=> (not (= temp___skip_constant_516 true)) (in_range5 0 (to_base temp___expr_519))) (=> (= temp___do_toplevel_517 true) (=> (= temp___is_init_515 true) (and (<= 0 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___expr_519))))) (<= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___expr_519)))) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (to_base temp___expr_519))))))))))
(define-fun default_initial_assumption ((temp___expr_523 us_rep1) (temp___skip_top_level_524 Bool)) Bool (and (and (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs2 temp___expr_523))) 0) (= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length1 (us_split_fields3 temp___expr_523))) 0)) (= (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 temp___expr_523)) (let ((temp___532 (temp___526 32 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs2 temp___expr_523)))))) (to_array1 temp___532)))))
(define-fun dynamic_predicate1 ((temp___533 us_rep1)) Bool (and (<= 0 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___533))))) (<= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___533)))) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (to_base temp___533)))))))
...
(define-fun dynamic_invariant6 ((temp___expr_96 us_t4) (temp___is_init_92 Bool) (temp___skip_constant_93 Bool) (temp___do_toplevel_94 Bool) (temp___do_typ_inv_95 Bool)) Bool (=> (not (= temp___skip_constant_93 true)) (dynamic_property7 1 2147483647 (first9 temp___expr_96) (last9 temp___expr_96))))
(define-fun dynamic_invariant7 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_18)))
(assert (= null_list (bounded_dynamic_strings__null_list__aggregate_def 32)))
(assert (forall ((temp___155 Int)) (=> (dynamic_invariant5 temp___155 true true true true) (forall ((temp___156 Int)) (= (to_rep (select (bounded_dynamic_strings__null_list__aggregate_def temp___155) temp___156)) temp___155)))))
...
(assert (forall ((temp___528 Int) (temp___529 Int) (temp___530 Int)) (let ((temp___527 (temp___526 temp___528 temp___529 temp___530))) (=> (dynamic_invariant5 temp___528 true true true true) (and (=> (dynamic_property7 1 2147483647 temp___529 temp___530) (and (= (first3 temp___527) temp___529) (= (last3 temp___527) temp___530))) (forall ((temp___531 Int)) (= (to_rep (select (to_array1 temp___527) temp___531)) temp___528)))))))
...
(declare-const temp___928 natural_index)
(declare-const temp___9281 natural_index)
(declare-const temp___9282 (Array Int character))
(declare-const temp___929 natural_index)
(declare-const temp___9291 natural_index)
(declare-const temp___9292 (Array Int character))
(declare-const o3 (Array Int character))
(declare-const o4 us_split_fields2)
(declare-const temp___934 us_rep1)
(declare-const result us_split_fields__ref1)
(declare-const result____split_fields2 us_split_fields2)
(define-fun temp___9283 () us_rep1 (mk___rep1 (mk___split_discrs temp___928) (mk___split_fields1 temp___9281 temp___9282)))
...
(assert (dynamic_invariant3 (mk___rep1 result____split_discrs (mk___split_fields1 result____split_fields result____split_fields1)) false false true true))
(assert (= (to_rep2 o) 0))
(assert (= o o1))
(assert (= result____split_fields1 o2))
(assert (= result____split_discrs (mk___split_discrs temp___928)))
(assert (= temp___9281 o1))
(assert (= temp___9282 o2))
(assert (dynamic_predicate1 temp___9283))
(assert (= (mk___rep1 (mk___split_discrs temp___929) (mk___split_fields1 temp___9291 temp___9292)) temp___9283))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 result____split_fields result____split_fields1))))
(assert (= result____split_fields2 (mk___split_fields1 temp___9291 temp___9292)))
(assert (= result____split_discrs (mk___split_discrs temp___929)))
(assert (forall ((temp___932 Int)) (ite (and (<= 1 temp___932) (<= temp___932 0)) (= (select o3 temp___932) (select null_list temp___932)) (= (select o3 temp___932) (select (rec__bounded_dynamic_strings__sequence__content1 result____split_fields2) temp___932)))))
(assert (= o4 (mk___split_fields1 (rec__bounded_dynamic_strings__sequence__current_length1 result____split_fields2) o3)))
(assert (= temp___934 (mk___rep1 result____split_discrs o4)))
(assert (not (dynamic_predicate1 temp___934)))
(check-sat)
(exit)
