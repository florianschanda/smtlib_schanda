...
(assert (forall ((temp___133 Int)) (forall ((temp___134 Int)) (= (select (bounded_dynamic_strings__null_list__aggregate_def temp___133) temp___134) (of_rep temp___133)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (dynamic_invariant (length3 this) true false true)) :pattern ((length3 this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (let ((result (value this))) (and (and (and (and (= (length result) (length3 this)) (= (first1 result) 1)) (= (last1 result) (length3 this))) (= (< 0 (length3 this)) (not (= (empty this) true)))) (dynamic_invariant2 result true false true)))) :pattern ((value this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (= (value this) (let ((temp___234 (let ((temp___232 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) (let ((temp___231 1)) (let ((temp___233 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this)))) (of_array3 (to_array2 temp___233) temp___231 temp___232)))))) (of_array (to_array3 temp___234) (first7 temp___234) (last7 temp___234))))) :pattern ((value this)))))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__bounded_dynamic_strings__sequence__current_length1 natural_index) (rec__bounded_dynamic_strings__sequence__content1 (Array Int character))))))
(define-fun us_split_fields_Current_Length__2__projection ((a us_split_fields2)) natural_index (rec__bounded_dynamic_strings__sequence__current_length1 a))
(define-fun us_split_fields_Content__2__projection ((a us_split_fields2)) (Array Int character) (rec__bounded_dynamic_strings__sequence__content1 a))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (rec__bounded_dynamic_strings__sequence__current_length1 (us_split_fields3 a)) (of_array2 (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 a)) 1 0))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 r)) (let ((temp___135 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 r)))) (to_array2 temp___135)))))
(define-fun bool_eq6 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs2 a))) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs2 b)))) (and (= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length1 (us_split_fields3 a))) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length1 (us_split_fields3 b)))) (= (bool_eq (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 a)) 1 0 (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 b)) 1 0) true))) true false))
...
(define-fun dynamic_property7 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range2 low) (and (in_range2 high) (=> (<= low high) (and (in_range3 low) (in_range3 high))))))
...
(assert (forall ((temp___496 Int) (temp___497 Int) (temp___498 Int)) (let ((temp___495 (temp___494 temp___496 temp___497 temp___498))) (and (=> (dynamic_property7 1 2147483647 temp___497 temp___498) (and (= (first3 temp___495) temp___497) (= (last3 temp___495) temp___498))) (forall ((temp___499 Int)) (= (select (to_array1 temp___495) temp___499) (of_rep temp___496)))))))
(define-fun dynamic_invariant3 ((temp___expr_487 us_rep1) (temp___is_init_484 Bool) (temp___skip_constant_485 Bool) (temp___do_toplevel_486 Bool)) Bool (and (=> (not (= temp___skip_constant_485 true)) (in_range5 0 (to_base temp___expr_487))) (=> (= temp___do_toplevel_486 true) (=> (= temp___is_init_484 true) (and (<= 0 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___expr_487))))) (<= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___expr_487)))) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (to_base temp___expr_487))))))))))
(define-fun default_initial_assumption ((temp___expr_491 us_rep1) (temp___skip_top_level_492 Bool)) Bool (and (and (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs2 temp___expr_491))) 0) (= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length1 (us_split_fields3 temp___expr_491))) 0)) (= (rec__bounded_dynamic_strings__sequence__content1 (us_split_fields3 temp___expr_491)) (let ((temp___500 (temp___494 32 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs2 temp___expr_491)))))) (to_array1 temp___500)))))
(define-fun dynamic_predicate1 ((temp___501 us_rep1)) Bool (and (<= 0 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___501))))) (<= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (to_base temp___501)))) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (to_base temp___501)))))))
...
(define-fun dynamic_invariant6 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_15)))
...
(declare-const bounded_dynamic_strings__null_sequence__result natural_index)
(declare-const bounded_dynamic_strings__null_sequence__result1 natural_index)
(declare-const bounded_dynamic_strings__null_sequence__result2 (Array Int character))
(declare-const bounded_dynamic_strings__null_sequence__result3 t2)
(declare-const us Int)
(declare-const temp___858 natural_index)
(declare-const temp___861 (Array Int character))
(declare-const temp___8611 t1)
(declare-const temp___862 natural_index)
(declare-const temp___8621 natural_index)
(declare-const temp___8622 (Array Int character))
(declare-const o natural_index)
(declare-const o1 natural_index)
(declare-const o2 (Array Int character))
(declare-const temp___865 natural_index)
(declare-const temp___8651 natural_index)
(declare-const temp___8652 (Array Int character))
(declare-const temp___866 natural_index)
(declare-const temp___8661 natural_index)
(declare-const temp___8662 (Array Int character))
(declare-const o3 (Array Int character))
(declare-const o4 us_split_fields2)
(declare-const temp___871 us_rep1)
(declare-const temp___872 us_rep1)
...
(declare-const bounded_dynamic_strings__null_sequence__result4 us_rep)
(declare-const bounded_dynamic_strings__null_sequence__result5 sequence__ref)
(declare-const bounded_dynamic_strings__null_sequence__result6 us_rep)
(declare-const result____split_fields4 us_split_fields__ref1)
(declare-const bounded_dynamic_strings__null_sequence__result7 sequence__ref)
(declare-const result____split_fields5 us_split_fields2)
(declare-const bounded_dynamic_strings__null_sequence__result8 us_rep)
(assert (= (bounded_dynamic_strings__null_list__aggregate_def 32) null_list))
(assert (and (= us 0) (in_range4 0)))
(assert (default_initial_assumption (mk___rep1 result____split_discrs (mk___split_fields1 result____split_fields result____split_fields1)) false))
(assert (dynamic_invariant3 (mk___rep1 result____split_discrs (mk___split_fields1 result____split_fields result____split_fields1)) false false true))
(assert (= (to_rep2 o) 0))
(assert (= o o1))
(assert (= result____split_fields1 o2))
(assert (= result____split_discrs (mk___split_discrs temp___865)))
(assert (= temp___8651 o1))
(assert (= temp___8652 o2))
(assert (dynamic_predicate1 (mk___rep1 (mk___split_discrs temp___865) (mk___split_fields1 temp___8651 temp___8652))))
(assert (= (mk___rep1 (mk___split_discrs temp___866) (mk___split_fields1 temp___8661 temp___8662)) (mk___rep1 (mk___split_discrs temp___865) (mk___split_fields1 temp___8651 temp___8652))))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 result____split_fields result____split_fields1))))
(assert (= result____split_fields2 (mk___split_fields1 temp___8661 temp___8662)))
(assert (= result____split_discrs (mk___split_discrs temp___866)))
(assert (forall ((temp___869 Int)) (ite (and (<= 1 temp___869) (<= temp___869 0)) (= (select o3 temp___869) (select null_list temp___869)) (= (select o3 temp___869) (select (rec__bounded_dynamic_strings__sequence__content1 result____split_fields2) temp___869)))))
(assert (= o4 (mk___split_fields1 (rec__bounded_dynamic_strings__sequence__current_length1 result____split_fields2) o3)))
(assert (= temp___871 (mk___rep1 result____split_discrs o4)))
(assert (not (dynamic_predicate1 temp___871)))
(check-sat)
(exit)
