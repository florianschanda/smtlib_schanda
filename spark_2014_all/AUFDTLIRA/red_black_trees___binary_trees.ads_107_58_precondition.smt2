...
(define-fun dynamic_invariant1 ((temp___expr_196 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool) (temp___do_typ_inv_195 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 1)) (in_range3 temp___expr_196)))
...
(define-fun dynamic_invariant2 ((temp___expr_168 Int) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool) (temp___do_typ_inv_167 Bool)) Bool (=> (or (= temp___is_init_164 true) (<= 0 2147483647)) (in_range4 temp___expr_168)))
...
(define-fun dynamic_invariant3 ((temp___expr_217 Int) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool (=> (or (= temp___is_init_213 true) (<= 0 1)) (in_range5 temp___expr_217)))
...
(define-fun dynamic_invariant4 ((temp___expr_224 Int) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool) (temp___do_typ_inv_223 Bool)) Bool (=> (or (= temp___is_init_220 true) (<= 0 2147483647)) (in_range6 temp___expr_224)))
...
(assert (forall ((x extended_index_type)) (! (in_range7 (to_rep x)) :pattern ((to_rep x)))))
(assert (forall ((x Int)) (! (=> (in_range7 x) (= (to_rep (of_rep x)) x)) :pattern ((to_rep (of_rep x))))))
...
(assert (forall ((x position_type)) (! (in_range8 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant5 ((temp___expr_182 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (=> (or (= temp___is_init_178 true) (<= 0 100)) (in_range7 temp___expr_182)))
...
(assert (forall ((f1 us_rep3)) (! (=> (type_invariant f1) (dynamic_invariant5 (size f1) true false true true)) :pattern ((size f1)))))
(assert (forall ((f1 us_rep3)) (! (= (size f1) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1)))) :pattern ((size f1)))))
(assert (forall ((f1 us_rep3)) (forall ((i1 Int)) (! (=> (and (dynamic_invariant i1 true true true true) (type_invariant f1)) (let ((result (parent f1 i1))) (and (and (=> (= (valid_root f1 i1) true) (= result 0)) (=> (= (size f1) 0) (= result 0))) (dynamic_invariant5 result true false true true)))) :pattern ((parent f1 i1))))))
(assert (forall ((f1 us_rep3)) (forall ((i1 Int)) (! (=> (dynamic_invariant i1 true true true true) (= (parent f1 i1) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___334 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___334 i1))))))) :pattern ((parent f1 i1))))))
(assert (forall ((f1 us_rep3)) (forall ((i1 Int)) (! (=> (and (and (dynamic_invariant i1 true true true true) (type_invariant f1)) (not (= (parent f1 i1) 0))) (dynamic_invariant1 (position f1 i1) true false true true)) :pattern ((position f1 i1))))))
(assert (forall ((f1 us_rep3)) (forall ((i1 Int)) (! (=> (dynamic_invariant i1 true true true true) (= (position f1 i1) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (let ((temp___338 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___338 i1))))))) :pattern ((position f1 i1))))))
...
(assert true)
(assert (forall ((f1 us_rep3)) (! (= (= (tree_structure f1) true) (and (and (and (and (and (and (and (and (forall ((i1 Int)) (=> (and (<= (+ (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1))) 1) i1) (<= i1 100)) (= (bool_eq3 (let ((temp___439 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___439 i1)) (mk___rep1 (mk___split_fields1 (of_rep 0) (of_rep 0) (of_rep 0) (of_rep1 2)))) true))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___440 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___440 i1)))))) (<= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___440 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___440 i1))))) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1)))))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___441 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___441 i1)))))) (<= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___441 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___441 i1))))) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1)))))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___442 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___442 i1)))))) (<= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___442 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___442 i1))))) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1)))))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (let ((temp___444 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___444 i1))))) 2) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___443 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___443 i1))))) 0))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___449 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___449 i1))))) 0)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (let ((temp___445 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___445 (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___446 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___446 i1)))))))))) 0) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___447 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___447 (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___448 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___448 i1)))))))))) i1)))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___454 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___454 i1))))) 0)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (let ((temp___450 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___450 (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___451 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___451 i1)))))))))) 1) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___452 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___452 (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___453 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___453 i1)))))))))) i1)))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___457 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___457 i1))))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (let ((temp___458 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___458 i1))))) 0)) (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___455 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___455 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___456 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___456 i1)))))))))) i1))))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___461 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___461 i1))))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (let ((temp___462 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___462 i1))))) 1)) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___459 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___459 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___460 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___460 i1)))))))))) i1)))))) :pattern ((tree_structure f1)))))
(define-fun dynamic_invariant7 ((temp___expr_189 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 0 2)) (in_range8 temp___expr_189)))
...
(assert (and (= (valid_root f root) true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) i))) true) (= (peek f i d) 0))))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) i1))) true) (forall ((d1 Int)) (=> (and (<= 0 d1) (<= d1 1)) (=> (= (peek f i1 d1) 0) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) j1))) true) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j1)))) true)) (not (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j1))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i1)))) 1)) d1))))))))))))
(assert (<= 1 j))
(assert (<= j 100))
(assert (= (tree_structure f) true))
(assert (and (= temp___708 (model__ f root)) (and (dynamic_invariant6 temp___708 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___708 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___708 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___708 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___708 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___708 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___708 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___708 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___708 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___708 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___708 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___708 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___708 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___708 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o10 o11)) (select temp___708 j)))
(assert (= o10 o12))
(assert (= o11 o13))
(assert (= result1 o13))
(assert (=> (= result1 true) (= (tree_structure f) true)))
(assert (=> (= result1 true) (and (= temp___710 (model__ f root)) (and (dynamic_invariant6 temp___710 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___710 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___710 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___710 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___710 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___710 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___710 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___710 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___710 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___710 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___710 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___710 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___710 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___710 j1)))) true)) (= j1 i1)))))))))))))))
(assert (=> (= result1 true) (= (mk___rep (mk___split_fields o5 o6)) (select temp___710 j))))
(assert (=> (= result1 true) (= o5 o7)))
(assert (=> (= result1 true) (= o6 o8)))
(assert (=> (= result1 true) (= o9 o7)))
(assert (=> (= result1 true) (= (tree_structure f) true)))
(assert (=> (= result1 true) (and (= temp___709 (model__ f root)) (and (dynamic_invariant6 temp___709 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___709 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___709 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___709 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___709 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___709 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___709 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___709 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___709 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___709 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___709 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___709 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___709 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___709 j1)))) true)) (= j1 i1)))))))))))))))
(assert (=> (= result1 true) (= (mk___rep (mk___split_fields o o1)) (select temp___709 i))))
