...
(assert (= b1 o13))
(assert (< (+ (to_rep b__first) j1) (to_rep b__last)))
(assert (not (= (bool_eq b (to_rep (first10 (mk5 (+ (+ (to_rep b__first) j1) 1) (to_rep b__last)))) (to_rep (last10 (mk5 (+ (+ (to_rep b__first) j1) 1) (to_rep b__last)))) b1 (to_rep (first12 (mk6 (+ (+ (to_rep b__first) j1) 1) (to_rep b__last)))) (to_rep (last12 (mk6 (+ (+ (to_rep b__first) j1) 1) (to_rep b__last))))) true)))
(check-sat)
(exit)
