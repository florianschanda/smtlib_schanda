...
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___402 prev)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___401 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___404 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___399 id1)))
...
(assert (=> (and (<= 1 id1) (<= id1 3)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 8)) (and (=> (= (to_rep5 (select temp___403 j)) 2) (= (to_rep5 (select track_signals3 j)) 2)) (=> (and (= (to_rep5 (select temp___404 j)) 1) (exists ((t Int)) (and (and (<= 1 t) (<= t cur_num_trains)) (= (is_previous_track (select trains1 t) j) true)))) (= (to_rep5 (select track_signals3 j)) 1)))))))
