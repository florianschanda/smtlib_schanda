...
(assert (<= 1 id7))
(assert (<= id7 3))
(assert (not (= (get_other_previous_track (select trains1 train1) id7) 0)))
(define-fun temp___416 () Int (to_rep5 (select (map__content4 track_signals6) (get_other_previous_track (select trains1 train1) id7))))
(assert (not (or (= temp___416 1) (= temp___416 2))))
(check-sat)
(exit)
