...
(assert (= id1 1))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___371 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___370 prev)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___369 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___372 track_signals1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (= temp___367 id1)))
(assert (=> (and (<= 1 id1) (<= id1 3)) (and (= o2 (get_previous_track cur_position id1)) (and (in_range1 o2) (= o2 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_end (us_split_fields3 cur_position)))))))) id1)))))))
...
(assert (=> (and (<= 1 id1) (<= id1 3)) (=> (= result7 true) (and (= o6 prev2) (in_range2 prev2)))))
...
(assert (=> (and (<= 1 id1) (<= id1 3)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 8)) (and (=> (= (to_rep5 (select temp___371 j)) 2) (= (to_rep5 (select track_signals3 j)) 2)) (=> (and (= (to_rep5 (select temp___372 j)) 1) (exists ((t Int)) (and (and (<= 1 t) (<= t cur_num_trains)) (= (is_previous_track (select trains1 t) j) true)))) (= (to_rep5 (select track_signals3 j)) 1)))))))
...
(define-fun temp___383 () Int (to_rep5 (select (map__content4 track_signals6) (get_previous_track (select trains1 train1) id7))))
(assert (not (or (= temp___383 1) (= temp___383 2))))
(check-sat)
(exit)
