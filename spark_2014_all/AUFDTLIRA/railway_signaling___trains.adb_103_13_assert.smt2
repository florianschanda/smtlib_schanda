...
(assert (<= 1 train2))
(assert (<= train2 cur_num_trains))
(declare-const id35 Int)
(assert (<= 1 id35))
(assert (<= id35 3))
(assert (not (= (get_previous_track (select trains3 train2) id35) 0)))
(assert (not (or (= (to_rep5 (select (map__content4 track_signals10) (get_previous_track (select trains3 train2) id35))) 1) (= (to_rep5 (select (map__content4 track_signals10) (get_previous_track (select trains3 train2) id35))) 2))))
(check-sat)
(exit)
