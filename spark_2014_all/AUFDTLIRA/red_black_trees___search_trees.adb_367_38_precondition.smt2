...
(assert true)
(declare-const i Int)
(declare-const temp___1715 (Array Int us_rep1))
...
(declare-const temp___1714 (Array Int us_rep1))
...
(assert (= result2 true))
(assert (and (= o16 (valid_root f v)) (=> (< (size f) v) (not (= o16 true)))))
(assert (= result3 (ite (not (= o16 true)) true false)))
(assert (= result3 true))
(assert (and (= temp___1760 (model__ f root)) (and (dynamic_invariant5 temp___1760 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 j)))) true)) (= j i1))))))))))))))
(assert (= o14 (select temp___1760 v)))
(assert (= o15 (us_split_fields1 o14)))
(assert (= result4 (rec__tree_model__path_type__k o15)))
(assert (= result4 true))
(assert (and (= result5 (ordered_leafs f_old root values)) (= (= result5 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old root) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old root) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) i1)))) 1)) 0) (< (to_rep (select values j)) (to_rep (select values i1))) (< (to_rep (select values i1)) (to_rep (select values j))))))))))))
(assert (= result5 true))
(assert (and (= result6 (ordered_leafs f_old v values)) (= (= result6 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old v) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old v) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old v) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old v) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old v) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old v) i1)))) 1)) 0) (< (to_rep (select values j)) (to_rep (select values i1))) (< (to_rep (select values i1)) (to_rep (select values j))))))))))))
(assert (= result6 true))
(assert (= (= result7 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old root) i1))) true) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) v)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) v))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) i1)))) 1)) 0) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old v) j))) true) (< (to_rep (select values j)) (to_rep (select values i1)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old v) j))) true) (< (to_rep (select values i1)) (to_rep (select values j))))))))))))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) i1))) true) (ite (= (ole (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) v))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i1)))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old v) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old root) i1))) true)))))))
(assert (= result8 true))
(assert (= (= result9 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old root) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) i1))) true))))))
(assert (= result9 true))
(assert (= (= result10 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (not (= v 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old v) i1))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) i1))) true))))))
(assert (= result10 true))
(assert (= (= result11 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old root) i1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i1)))) true))))))
(assert (= result11 true))
(assert (<= 1 i))
(assert (<= i 100))
(assert (=> (not (= v 0)) (and (= temp___1715 (model__ f_old v)) (and (dynamic_invariant5 temp___1715 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1715 v))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1715 v)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 v)) (ite (and (not (= (parent f_old i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1715 (parent f_old i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1715 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1715 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1715 i1))) true) (not (= i1 v))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1715 (parent f_old i1)))) (position f_old i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1715 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1715 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1715 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1715 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1715 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1715 j)))) true)) (= j i1)))))))))))))))
(assert (=> (not (= v 0)) (= (mk___rep (mk___split_fields o o1)) (select temp___1715 i))))
(assert (=> (not (= v 0)) (= o o2)))
(assert (=> (not (= v 0)) (= o1 o3)))
(assert (=> (not (= v 0)) (= result12 o3)))
(assert (=> (not (not (= v 0))) (= result12 false)))
(assert (= result12 true))
(assert (and (= temp___1714 (model__ f root)) (and (dynamic_invariant5 temp___1714 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1714 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1714 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1714 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1714 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1714 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1714 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1714 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1714 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1714 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1714 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1714 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1714 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1714 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o9 o10)) (select temp___1714 i)))
(assert (= o9 o11))
(assert (= o10 o12))
(assert (= o13 o11))
(assert (and (= temp___1713 (model__ f_old v)) (and (dynamic_invariant5 temp___1713 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1713 v))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1713 v)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 v)) (ite (and (not (= (parent f_old i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1713 (parent f_old i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1713 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1713 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1713 i1))) true) (not (= i1 v))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1713 (parent f_old i1)))) (position f_old i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1713 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1713 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1713 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1713 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1713 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1713 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o4 o5)) (select temp___1713 i)))
(assert (= o4 o6))
(assert (= o5 o7))
(assert (= o8 o6))
