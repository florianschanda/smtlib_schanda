...
(assert (forall ((temp___226 us_t)) (forall ((temp___227 Int) (temp___228 Int)) (let ((temp___225 (temp___224 temp___226 temp___227 temp___228))) (and (and (= (first1 temp___225) (first1 temp___226)) (= (last1 temp___225) (last1 temp___226))) (forall ((temp___229 Int)) (ite (= temp___229 temp___227) (= (select (to_array temp___225) temp___229) (of_rep1 temp___228)) (= (select (to_array temp___225) temp___229) (select (to_array temp___226) temp___229)))))))))
(declare-fun temp___390 (us_t Int Int) us_t)
(assert (forall ((temp___392 us_t)) (forall ((temp___393 Int) (temp___394 Int)) (let ((temp___391 (temp___390 temp___392 temp___393 temp___394))) (and (and (= (first1 temp___391) (first1 temp___392)) (= (last1 temp___391) (last1 temp___392))) (forall ((temp___395 Int)) (ite (= temp___395 temp___393) (= (select (to_array temp___391) temp___395) (of_rep1 temp___394)) (= (select (to_array temp___391) temp___395) (select (to_array temp___392) temp___395)))))))))
...
(assert (= o (+ i 1)))
(assert (= (mk___t temp___397 temp___3971) (temp___390 (mk___t a (mk (to_rep a__first) (to_rep a__last))) o new_val)))
(assert (= (ite (<= (to_rep (first temp___3971)) (to_rep (last temp___3971))) (+ (- (to_rep (last temp___3971)) (to_rep (first temp___3971))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0)))
(assert (= (mk___t temp___398 temp___3981) (mk___t temp___397 temp___3971)))
(assert (= o1 (slide temp___398 (to_rep (first temp___3981)) (to_rep a__first))))
