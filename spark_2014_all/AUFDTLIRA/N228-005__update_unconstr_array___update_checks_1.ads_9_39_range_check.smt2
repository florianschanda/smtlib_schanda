...
(declare-datatypes () ((tS2bP1__ref (mk_tS2bP1__ref (tS2bP1__content tindexB)))))
(define-fun tS2bP1__ref___projection ((a tS2bP1__ref)) tindexB (tS2bP1__content a))
(declare-fun temp___258 (us_t Int Int) us_t)
(declare-fun temp___432 (us_t Int Int) us_t)
...
(assert (forall ((temp___434 us_t)) (forall ((temp___435 Int) (temp___436 Int)) (let ((temp___433 (temp___432 temp___434 temp___435 temp___436))) (=> (and (and (dynamic_invariant2 temp___434 true true true true) (dynamic_invariant1 temp___435 true true true true)) (dynamic_invariant temp___436 true true true true)) (and (and (= (first1 temp___433) (first1 temp___434)) (= (last1 temp___433) (last1 temp___434))) (forall ((temp___437 Int)) (ite (= temp___437 temp___435) (= (to_rep1 (select (to_array temp___433) temp___437)) temp___436) (= (select (to_array temp___433) temp___437) (select (to_array temp___434) temp___437))))))))))
(assert (forall ((temp___260 us_t)) (forall ((temp___261 Int) (temp___262 Int)) (let ((temp___259 (temp___258 temp___260 temp___261 temp___262))) (=> (and (and (dynamic_invariant2 temp___260 true true true true) (dynamic_invariant1 temp___261 true true true true)) (dynamic_invariant temp___262 true true true true)) (and (and (= (first1 temp___259) (first1 temp___260)) (= (last1 temp___259) (last1 temp___260))) (forall ((temp___263 Int)) (ite (= temp___263 temp___261) (= (to_rep1 (select (to_array temp___259) temp___263)) temp___262) (= (select (to_array temp___259) temp___263) (select (to_array temp___260) temp___263))))))))))
(declare-const a (Array Int integer))
(declare-const us Int)
(declare-const o Int)
(declare-const temp___439 (Array Int integer))
(declare-const temp___4391 t)
(declare-const temp___440 (Array Int integer))
(declare-const temp___4401 t)
...
(define-fun temp___4392 () us_t (mk___t temp___439 temp___4391))
(assert (dynamic_property 1 8 (to_rep a__first) (to_rep a__last)))
(assert (in_range2 i))
(assert (in_range new_val))
(assert (and (= us (+ i 1)) (dynamic_property1 (to_rep a__first) (to_rep a__last) (+ i 1))))
(assert (= o (+ i 1)))
(assert (= temp___4392 (temp___432 (mk___t a (mk (to_rep a__first) (to_rep a__last))) o new_val)))
(assert (= (ite (<= (to_rep (first temp___4391)) (to_rep (last temp___4391))) (+ (- (to_rep (last temp___4391)) (to_rep (first temp___4391))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0)))
(assert (= (mk___t temp___440 temp___4401) temp___4392))
(assert (= o1 (slide temp___440 (to_rep (first temp___4401)) (to_rep a__first))))
(assert (= (mk_map__ref result) (mk_map__ref a)))
(assert (= a1 o1))
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (in_range2 (+ i 1))))
(check-sat)
(exit)
