...
(assert (forall ((container us_rep)) (forall ((new_item Int)) (! (=> (and (dynamic_invariant3 new_item true true true true) (and (< (length container) 2147483647) (< (last container) 2147483647))) (let ((result (add container new_item))) (and (= (length result) (+ (length container) 1)) (and (= (get result (last result)) new_item) (= (ole container result) true))))) :pattern ((add container new_item))))))
...
(define-fun dynamic_invariant4 ((temp___expr_239 us_rep1) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (= temp___do_toplevel_237 true) (=> (= temp___is_init_235 true) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___expr_239))) 100))))
(define-fun default_initial_assumption1 ((temp___expr_241 us_rep1) (temp___skip_top_level_242 Bool)) Bool (and (= (length (rec__tree_model__path_type__a (us_split_fields1 temp___expr_241))) 0) (= (rec__tree_model__path_type__k (us_split_fields1 temp___expr_241)) (distinct 0 0))))
...
(define-fun dynamic_invariant6 ((temp___expr_196 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool) (temp___do_typ_inv_195 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 1)) (in_range4 temp___expr_196)))
(assert true)
...
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant i true true true true) (type_invariant f)) (not (= (parent f i) 0))) (dynamic_invariant6 (position f i) true false true true)) :pattern ((position f i))))))
...
(define-fun default_initial_assumption4 ((temp___expr_475 us_rep4) (temp___skip_top_level_476 Bool)) Bool (=> (not (= temp___skip_top_level_476 true)) (= (is_empty temp___expr_475) true)))
(declare-fun contains (us_rep4 Int) Bool)
(declare-fun contains__function_guard (Bool us_rep4 Int) Bool)
(define-fun dynamic_invariant7 ((temp___expr_467 Int) (temp___is_init_463 Bool) (temp___skip_constant_464 Bool) (temp___do_toplevel_465 Bool) (temp___do_typ_inv_466 Bool)) Bool (=> (or (= temp___is_init_463 true) (<= 1 100)) (in_range7 temp___expr_467)))
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant7 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range7 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
(declare-fun length1 (us_rep4) Int)
(declare-fun length__function_guard1 (Int us_rep4) Bool)
(assert (forall ((container us_rep4)) (! (dynamic_invariant2 (length1 container) true false true true) :pattern ((length1 container)))))
...
(assert (forall ((container us_rep4)) (forall ((item Int)) (! (=> (and (dynamic_invariant7 item true true true true) (= (contains container item) true)) (let ((result (remove container item))) (and (and (and (= (length1 result) (- (length1 container) 1)) (not (= (contains result item) true))) (= (ole1 result container) true)) (= (included_except container result item) true)))) :pattern ((remove container item))))))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (select a temp___idx_156) (select b (+ (- b__first a__first) temp___idx_156))))))))))
(declare-fun next ((Array Int Bool)) Int)
(declare-fun next__function_guard (Int (Array Int Bool)) Bool)
(assert (forall ((todo (Array Int Bool))) (! (let ((result (next todo))) (and (ite (= result 0) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (not (= (select todo i) true)))) (= (select todo result) true)) (dynamic_invariant1 result true false true true))) :pattern ((next todo)))))
...
(assert (forall ((f1 us_rep3)) (! (=> (type_invariant f1) (dynamic_invariant1 (size f1) true false true true)) :pattern ((size f1)))))
...
(assert true)
(assert (forall ((f1 us_rep3)) (! (= (= (tree_structure f1) true) (and (and (and (and (and (and (and (and (forall ((i Int)) (=> (and (<= (+ (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1))) 1) i) (<= i 100)) (= (bool_eq3 (let ((temp___439 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___439 i)) (mk___rep1 (mk___split_fields1 (of_rep 0) (of_rep 0) (of_rep 0) (of_rep1 2)))) true))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___440 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___440 i)))))) (<= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___440 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___440 i))))) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1)))))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___441 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___441 i)))))) (<= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___441 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___441 i))))) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1)))))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___442 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___442 i)))))) (<= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___442 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___442 i))))) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1)))))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (let ((temp___444 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___444 i))))) 2) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___443 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___443 i))))) 0))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___449 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___449 i))))) 0)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (let ((temp___445 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___445 (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___446 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___446 i)))))))))) 0) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___447 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___447 (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___448 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___448 i)))))))))) i)))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___454 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___454 i))))) 0)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (let ((temp___450 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___450 (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___451 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___451 i)))))))))) 1) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___452 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___452 (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___453 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___453 i)))))))))) i)))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___457 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___457 i))))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (let ((temp___458 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___458 i))))) 0)) (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___455 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___455 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___456 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___456 i)))))))))) i))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___461 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___461 i))))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (let ((temp___462 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___462 i))))) 1)) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___459 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___459 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___460 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___460 i)))))))))) i)))))) :pattern ((tree_structure f1)))))
(define-fun dynamic_invariant8 ((temp___expr_189 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 0 2)) (in_range3 temp___expr_189)))
...
(assert (forall ((container us_rep)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant9 position1 true true true true) (and (<= 1 position1) (<= position1 (last container)))) (dynamic_invariant3 (get container position1) true false true true)) :pattern ((get container position1))))))
...
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((item Int)) (! (=> (dynamic_invariant7 item true true true true) (= (= (included_except left right item) true) (forall ((e Int)) (=> (and (in_range7 e) (= (contains left e) true)) (or (= (contains right e) true) (= e item)))))) :pattern ((included_except left right item))))))
...
(declare-const o4 (Array Int us_rep1))
(declare-const temp___660 Int)
(declare-const temp___658 (Array Int us_rep1))
(declare-const temp___657 us_rep4)
(declare-const temp___655 (Array Int Bool))
(declare-const temp___690 Int)
(declare-const o5 Int)
(declare-const o6 us_rep4)
...
(declare-const o21 (Array Int us_rep1))
...
(declare-const temp___647 us_rep1)
(declare-const o35 us_rep1)
(declare-const o36 Int)
(declare-const o37 (Array Int us_rep1))
...
(declare-const temp___654 us_rep1)
...
(declare-const result15 map__ref2)
...
(assert (dynamic_invariant5 r false false true true))
...
(assert (= (rec__tree_model__path_type__a (us_split_fields1 (select r root))) o2))
...
(assert (=> (not (= i2 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (=> (= (select todo3 j11) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j11))) true))))))
(assert (=> (not (= i2 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (=> (= (select todo3 j11) true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 k))) true) (not (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select r2 j11))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 k)))) true))))))))))
(assert (=> (not (= i2 0)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 root))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 root)))) 0))))
(assert (=> (not (= i2 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j11))) true) (not (= j11 root))) (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j11)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j11))))))) true)))))))
(assert (=> (not (= i2 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j11))) true) (not (= j11 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j11))))))) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j11)))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 j11)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j11)))) 0))))))
(assert (=> (not (= i2 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (=> (not (= j11 root)) (ite (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j11)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j11))))))) true)) (or (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j11))) true) (= (select todo3 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j11))))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j11))) true))))))))
(assert (=> (not (= i2 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j11))) true) (not (= j11 root))) (not (= (select todo3 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j11))))) true)))))))
(assert (=> (not (= i2 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j11))) true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 k))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select r2 k))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 j11)))) true)) (= j11 k)))))))))
(assert (=> (not (= i2 0)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 root))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 root)))) 0))))
(assert (=> (not (= i2 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (<= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j11)))) (- 100 (length1 unseen2)))))))
(assert (=> (not (= i2 0)) (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (= (= (contains unseen2 j11) true) (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j11))) true)) (= (select todo3 j11) true)))))))
(assert (=> (not (= i2 0)) (and (dynamic_invariant5 r2 false true true true) (=> (<= 0 100) (in_range2 i3)))))
...
(assert (=> (not (= i2 0)) (= (mk___rep1 (mk___split_fields1 o8 o9 o10 o11)) (select (rec__binary_trees__forest__c (us_split_fields5 f)) o7))))
...
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j3)))) 100))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= (rec__tree_model__path_type__a (us_split_fields1 (select r2 j3))) o18))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= (distinct 1 0) o19))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (and (<= 1 j3) (<= j3 100)))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= o20 j3))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= o21 (store r2 o20 (mk___rep (mk___split_fields o18 o19)))))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= result8 (mk_map__ref r2)))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= r3 o21))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (and (<= 1 j3) (<= j3 100)))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= o22 j3))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= (mk___rep1 (mk___split_fields1 o23 o24 o25 o26)) (select (rec__binary_trees__forest__c (us_split_fields5 f)) o22)))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= o27 (mk___split_fields1 o23 o24 o25 o26)))))
...
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= o31 (us_split_fields1 o30)))))
...
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= o34 (mk___split_fields o33 (rec__tree_model__path_type__k (us_split_fields1 (select r3 j3))))))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= temp___647 (mk___rep o34)))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___647))) 100))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= o35 temp___647))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (and (<= 1 j3) (<= j3 100)))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= o36 j3))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= o37 (store r3 o36 o35)))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= result9 (mk_map__ref r3)))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= r4 o37))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (and (<= 1 j3) (<= j3 100)))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= o38 j3))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= o39 (store todo3 o38 (distinct 1 0))))))
(assert (=> (not (= i2 0)) (=> (not (= j3 0)) (= result10 (mk_map__ref2 todo3)))))
...
(assert (=> (not (= i2 0)) (= o41 (select (rec__binary_trees__forest__c (us_split_fields5 f)) o40))))
(assert (=> (not (= i2 0)) (= o42 (us_split_fields3 o41))))
...
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 (select r4 j4)))) 100))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= o45 (mk___rep (mk___split_fields (rec__tree_model__path_type__a (us_split_fields1 (select r4 j4))) (distinct 1 0)))))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (and (<= 1 j4) (<= j4 100)))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= o46 j4))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= o47 (store r4 o46 o45)))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= result12 (mk_map__ref r4)))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= r5 o47))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (and (<= 1 j4) (<= j4 100)))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= o48 j4))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= o49 (select (rec__binary_trees__forest__c (us_split_fields5 f)) o48)))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= o50 (us_split_fields3 o49)))))
...
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= o54 (us_split_fields1 o53)))))
...
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= o57 (mk___split_fields o56 (rec__tree_model__path_type__k (us_split_fields1 (select r5 j4))))))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= temp___654 (mk___rep o57)))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___654))) 100))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= o58 temp___654))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (and (<= 1 j4) (<= j4 100)))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= o59 j4))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= o60 (store r5 o59 o58)))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= result13 (mk_map__ref r5)))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= r6 o60))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (and (<= 1 j4) (<= j4 100)))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= o61 j4))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= o62 (store todo4 o61 (distinct 1 0))))))
(assert (=> (not (= i2 0)) (=> (not (= j4 0)) (= result14 (mk_map__ref2 todo4)))))
...
(assert (=> (not (= i2 0)) (and (= o65 (next todo6)) (and (in_range2 o65) (ite (= o65 0) (forall ((i11 Int)) (=> (and (<= 1 i11) (<= i11 100)) (not (= (select todo6 i11) true)))) (= (select todo6 o65) true))))))
...
(assert (forall ((j11 Int)) (=> (and (<= 1 j11) (<= j11 100)) (=> (not (= j11 root)) (ite (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j11)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content r9) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j11))))))) true)) (or (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content r9) j11))) true) (= (select (map__content2 todo9) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j11))))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content r9) j11))) true)))))))
(assert (= binary_trees__model__result2 (mk_map__ref binary_trees__model__result1)))
...
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content binary_trees__model__result4) root))) true))
(assert (and (= o68 (length (rec__tree_model__path_type__a (us_split_fields1 (select (map__content binary_trees__model__result4) root))))) (and (in_range5 o68) (<= (+ 0 o68) 2147483647))))
...
(assert (not (= i1 root)))
(assert (= (tree_structure f) true))
(assert (and (= o66 (parent f i1)) (and (in_range2 o66) (and (= o66 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i1))))) (and (=> (= (valid_root f i1) true) (= o66 0)) (=> (= (size f) 0) (= o66 0)))))))
