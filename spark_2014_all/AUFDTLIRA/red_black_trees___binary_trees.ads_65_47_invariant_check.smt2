...
(assert (and (and (and (= result (mk_map__ref2 todo)) (= todo1 (binary_trees__model__todo__aggregate_def (of_int 0)))) (and (and (and (= o (all_indexes Tuple0)) (and (forall ((i12 Int)) (=> (and (<= 1 i12) (<= i12 100)) (= (contains o i12) true))) (= (length1 o) 100))) (and (= result1 (mk_set__ref unseen)) (= unseen1 o))) (and (default_initial_assumption2 r false) (and (dynamic_invariant5 r false false true) (and (and (and (= o2 root) (in_range2 root)) (and (= result3 (mk_int__ref i)) (= i3 o2))) (and (in_range2 i3) (and (and (= result4 (mk_map__ref2 todo1)) (= todo2 (store todo1 root (of_int 1)))) (and (and (and (and (< (length (rec__tree_model__path_type__a (us_split_fields1 (select r root)))) 100) (and (= (rec__tree_model__path_type__a (us_split_fields1 (select r root))) o3) (= (of_int 1) o4))) (= o5 (store r root (mk___rep (mk___split_fields o3 o4))))) (and (= result5 (mk_map__ref r)) (= r1 o5))) (and (ite (not (= i3 0)) (and (and (and (= temp___614 i3) (and (= temp___612 r1) (and (= temp___611 unseen1) (and (= temp___609 todo2) (and (= 0 temp___644) (and (and (= (select todo3 i4) true) (and (forall ((j16 Int)) (=> (and (<= 1 j16) (<= j16 100)) (=> (= (select todo3 j16) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j16))) true)))) (and (forall ((j16 Int)) (=> (and (<= 1 j16) (<= j16 100)) (=> (= (select todo3 j16) true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 k))) true) (not (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select r2 j16))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 k)))) true)))))))) (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 root))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 root)))) 0)) (and (forall ((j16 Int)) (=> (and (<= 1 j16) (<= j16 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j16))) true) (not (= j16 root))) (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j16)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j16))))))) true))))) (and (forall ((j16 Int)) (=> (and (<= 1 j16) (<= j16 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j16))) true) (not (= j16 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j16))))))) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j16)))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 j16)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j16)))) 0)))) (and (forall ((j16 Int)) (=> (and (<= 1 j16) (<= j16 100)) (=> (not (= j16 root)) (ite (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j16)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j16))))))) true)) (or (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j16))) true) (= (select todo3 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j16))))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j16))) true)))))) (and (forall ((j16 Int)) (=> (and (<= 1 j16) (<= j16 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j16))) true) (not (= j16 root))) (not (= (select todo3 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j16))))) true))))) (and (forall ((j16 Int)) (=> (and (<= 1 j16) (<= j16 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j16))) true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 k))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select r2 k))) (rec__tree_model__path_type__a (us_split_fields1 (select r2 j16)))) true)) (= j16 k))))))) (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 root))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 root)))) 0)) (and (forall ((j16 Int)) (=> (and (<= 1 j16) (<= j16 100)) (<= (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j16)))) (- 100 (length1 unseen2))))) (forall ((j16 Int)) (=> (and (<= 1 j16) (<= j16 100)) (= (= (contains unseen2 j16) true) (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select r2 j16))) true)) (= (select todo3 j16) true)))))))))))))))) (and (and (dynamic_invariant5 r2 false true true) (=> (<= 0 100) (in_range2 i4))) (and (and (= result7 (mk_int__ref temp___6441)) (= temp___6442 (length1 unseen2))) (and (and (and (and (= o12 i4) (in_range7 i4)) (and (= o13 (remove unseen2 o12)) (and (and (and (= (length1 o13) (- (length1 unseen2) 1)) (not (= (contains o13 o12) true))) (= (ole1 o13 unseen2) true)) (= (included_except unseen2 o13 o12) true)))) (and (= result8 (mk_set__ref unseen2)) (= unseen3 o13))) (and (=> (<= 0 100) (in_range2 j7)) (and (and (and (and (and (and (and (and (<= 1 i4) (<= i4 100)) (= o14 i4)) (= (mk___rep1 (mk___split_fields1 o15 o16 o17 o18)) (select (rec__binary_trees__forest__c (us_split_fields5 f)) o14))) (and (= o15 o19) (and (= o16 o20) (and (= o17 o21) (= o18 o22))))) (= o23 o19)) (= o24 (to_rep o23))) (and (= result9 (mk_int__ref j7)) (= j8 o24))) (and (ite (not (= j8 0)) (and (< 0 (length1 unseen3)) (and (and (and (and (< (length (rec__tree_model__path_type__a (us_split_fields1 (select r2 j8)))) 100) (and (= (rec__tree_model__path_type__a (us_split_fields1 (select r2 j8))) o25) (= (of_int 1) o26))) (and (and (and (<= 1 j8) (<= j8 100)) (= o27 j8)) (= o28 (store r2 o27 (mk___rep (mk___split_fields o25 o26)))))) (and (= result10 (mk_map__ref r2)) (= r3 o28))) (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (<= 1 j8) (<= j8 100)) (= o29 j8)) (= (mk___rep1 (mk___split_fields1 o30 o31 o32 o33)) (select (rec__binary_trees__forest__c (us_split_fields5 f)) o29))) (= o34 (mk___split_fields1 o30 o31 o32 o33))) (= o35 (rec__binary_trees__cell__parent o34))) (= temp___599 (to_rep o35))) (and (and (<= 1 temp___599) (<= temp___599 100)) (= o36 temp___599))) (= o37 (select r3 o36))) (= o38 (us_split_fields1 o37))) (= o39 (rec__tree_model__path_type__a o38))) (and (= o40 (add o39 0)) (and (= (length o40) (+ (length o39) 1)) (and (= (get o40 (last o40)) 0) (= (ole o39 o40) true))))) (= o41 (mk___split_fields o40 (rec__tree_model__path_type__k (us_split_fields1 (select r3 j8)))))) (= temp___601 (mk___rep o41))) (and (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___601))) 100) (= o42 temp___601))) (and (and (and (<= 1 j8) (<= j8 100)) (= o43 j8)) (= o44 (store r3 o43 o42)))) (and (= result11 (mk_map__ref r3)) (= r4 o44))) (and (and (and (and (<= 1 j8) (<= j8 100)) (= o45 j8)) (= o46 (store todo3 o45 (of_int 1)))) (and (= result12 (mk_map__ref2 todo3)) (= todo4 o46)))))) (and (= r4 r2) (= todo4 todo3))) (and (and (and (and (and (and (and (and (<= 1 i4) (<= i4 100)) (= o47 i4)) (= o48 (select (rec__binary_trees__forest__c (us_split_fields5 f)) o47))) (= o49 (us_split_fields3 o48))) (= o50 (rec__binary_trees__cell__right o49))) (= o51 (to_rep o50))) (and (= result13 (mk_int__ref j8)) (= j9 o51))) (and (ite (not (= j9 0)) (and (< 0 (length1 unseen3)) (and (and (and (and (< (length (rec__tree_model__path_type__a (us_split_fields1 (select r4 j9)))) 100) (= o52 (mk___rep (mk___split_fields (rec__tree_model__path_type__a (us_split_fields1 (select r4 j9))) (of_int 1))))) (and (and (and (<= 1 j9) (<= j9 100)) (= o53 j9)) (= o54 (store r4 o53 o52)))) (and (= result14 (mk_map__ref r4)) (= r5 o54))) (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (<= 1 j9) (<= j9 100)) (= o55 j9)) (= o56 (select (rec__binary_trees__forest__c (us_split_fields5 f)) o55))) (= o57 (us_split_fields3 o56))) (= o58 (rec__binary_trees__cell__parent o57))) (= temp___606 (to_rep o58))) (and (and (<= 1 temp___606) (<= temp___606 100)) (= o59 temp___606))) (= o60 (select r5 o59))) (= o61 (us_split_fields1 o60))) (= o62 (rec__tree_model__path_type__a o61))) (and (= o63 (add o62 1)) (and (= (length o63) (+ (length o62) 1)) (and (= (get o63 (last o63)) 1) (= (ole o62 o63) true))))) (= o64 (mk___split_fields o63 (rec__tree_model__path_type__k (us_split_fields1 (select r5 j9)))))) (= temp___608 (mk___rep o64))) (and (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___608))) 100) (= o65 temp___608))) (and (and (and (<= 1 j9) (<= j9 100)) (= o66 j9)) (= o67 (store r5 o66 o65)))) (and (= result15 (mk_map__ref r5)) (= r6 o67))) (and (and (and (and (<= 1 j9) (<= j9 100)) (= o68 j9)) (= o69 (store todo4 o68 (of_int 1)))) (and (= result16 (mk_map__ref2 todo4)) (= todo5 o69)))))) (and (= r6 r4) (= todo5 todo4))) (and (and (and (and (and (<= 1 i4) (<= i4 100)) (= o70 i4)) (= o71 (store todo5 o70 (of_int 0)))) (and (= result17 (mk_map__ref2 todo5)) (= todo6 o71))) (and (and (and (= o72 (next todo6)) (and (in_range2 o72) (ite (= o72 0) (forall ((i12 Int)) (=> (and (<= 1 i12) (<= i12 100)) (not (= (select todo6 i12) true)))) (= (select todo6 o72) true)))) (and (= result18 (mk_int__ref i4)) (= i5 o72))) (= i5 0))))))))))))))))) (and (and (= j10 (mk_int__ref j9)) (and (= i6 (mk_int__ref i5)) (and (= r7 (mk_map__ref r6)) (and (= unseen4 (mk_set__ref unseen3)) (= todo7 (mk_map__ref2 todo6)))))) (and (= j11 j9) (and (= i7 i5) (and (= r8 r6) (and (= unseen5 unseen3) (= todo8 todo6))))))) (and (and (= j12 j10) (and (= i8 i6) (and (= r9 r7) (and (= unseen6 unseen4) (= todo9 todo7))))) (and (= j13 j11) (and (= i9 i7) (and (= r10 r8) (and (= unseen7 unseen5) (= todo10 todo8))))))) (and (and (= j12 (mk_int__ref j)) (and (= i8 (mk_int__ref i3)) (and (= r9 (mk_map__ref r1)) (and (= unseen6 (mk_set__ref unseen1)) (= todo9 (mk_map__ref2 todo2)))))) (and (= j13 j6) (and (= i9 i3) (and (= r10 r1) (and (= unseen7 unseen1) (= todo10 todo2))))))) (and (forall ((j16 Int)) (=> (and (<= 1 j16) (<= j16 100)) (=> (not (= j16 root)) (ite (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j16)))) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content r9) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j16))))))) true)) (or (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content r9) j16))) true) (= (select (map__content2 todo9) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) j16))))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content r9) j16))) true)))))) (and (and (= binary_trees__model__result2 (mk_map__ref binary_trees__model__result1)) (= binary_trees__model__result3 binary_trees__model__result1)) (and (= result20 (mk_map__ref binary_trees__model__result)) (= binary_trees__model__result1 (map__content r9)))))))))))))) (and (and (= binary_trees__model__result4 binary_trees__model__result2) (and (= j14 j12) (and (= i10 i8) (and (= r11 r9) (and (= unseen8 unseen6) (= todo11 todo9)))))) (and (= binary_trees__model__result5 binary_trees__model__result3) (and (= j15 j13) (and (= i11 i9) (and (= r12 r10) (and (= unseen9 unseen7) (= todo12 todo10)))))))))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content binary_trees__model__result4) root))) true))
(assert (and (= o79 (length (rec__tree_model__path_type__a (us_split_fields1 (select (map__content binary_trees__model__result4) root))))) (and (in_range5 o79) (<= (+ 0 o79) 2147483647))))
(assert (= result21 (ite (= o79 0) true false)))
(assert (= result21 true))
(assert (<= 1 i2))
(assert (<= i2 100))
(assert (not (= i2 root)))
(assert (= (tree_structure f) true))
(assert (and (= o77 (parent f i2)) (and (in_range2 o77) (and (= o77 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2))))) (and (=> (= (valid_root f i2) true) (= o77 0)) (=> (= (size f) 0) (= o77 0)))))))
(assert (= o78 (ite (= o77 0) true false)))
(assert (= result23 (ite (not (= o78 true)) true false)))
