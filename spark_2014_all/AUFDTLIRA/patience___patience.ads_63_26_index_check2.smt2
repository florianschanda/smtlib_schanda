...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o4 i))
(assert (= o5 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (- o6 1)))
(assert (= o8 (ite (<= j o7) true false)))
(assert (= result (ite (<= 0 j) o8 false)))
(assert (= (= o9 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i)) 1))) (and (<= 0 (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i) j1))) (< (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i) j1)) (to_rep (rec__patience__state__numelts (us_split_fields1 s)))))))))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o i))
(assert (= o1 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (<= o2 (to_rep (rec__patience__state__numelts (us_split_fields1 s)))) true false)))
(assert (not (<= 0 i)))
(check-sat)
(exit)
