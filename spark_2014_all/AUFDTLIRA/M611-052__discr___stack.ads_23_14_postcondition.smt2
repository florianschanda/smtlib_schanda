...
(define-fun dynamic_invariant1 ((temp___expr_147 us_rep) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (let ((temp___148 (rec__stack__stack__n (us_split_discrs1 temp___expr_147)))) (and (dynamic_property1 1 (to_rep1 temp___148) (first1 (rec__stack__stack__content (us_split_fields1 temp___expr_147))) (last1 (rec__stack__stack__content (us_split_fields1 temp___expr_147)))) (and (= (first1 (rec__stack__stack__content (us_split_fields1 temp___expr_147))) 1) (= (last1 (rec__stack__stack__content (us_split_fields1 temp___expr_147))) (to_rep1 temp___148))))))
...
(define-fun dynamic_invariant2 ((temp___expr_153 us_t1) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (not (= temp___skip_constant_151 true)) (dynamic_property2 1 2147483647 (first3 temp___expr_153) (last3 temp___expr_153))))
...
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant1 s true true true) (dynamic_invariant2 (to__ s) true false true)) :pattern ((to__ s)))))
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant1 s true true true) (= (to__ s) (let ((temp___168 (let ((temp___166 (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))) (let ((temp___165 1)) (let ((temp___167 (rec__stack__stack__content (us_split_fields1 s)))) (of_array2 (to_array temp___167) temp___165 temp___166)))))) (of_array1 (to_array2 temp___168) (first5 temp___168) (last5 temp___168))))) :pattern ((to__ s)))))
...
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant1 s true true true) (dynamic_invariant2 (to_but_top s) true false true)) :pattern ((to_but_top s)))))
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant1 s true true true) (= (to_but_top s) (let ((temp___182 (let ((temp___180 (- (to_rep1 (rec__stack__stack__top (us_split_fields1 s))) 1))) (let ((temp___179 1)) (let ((temp___181 (rec__stack__stack__content (us_split_fields1 s)))) (of_array3 (to_array temp___181) temp___179 temp___180)))))) (of_array1 (to_array3 temp___182) (first7 temp___182) (last7 temp___182))))) :pattern ((to_but_top s)))))
(declare-fun is_full (us_rep) Bool)
(declare-fun is_full__function_guard (Bool us_rep) Bool)
(assert true)
(assert (forall ((s us_rep)) (! (= (= (is_full s) true) (<= (last1 (rec__stack__stack__content (us_split_fields1 s))) (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))) :pattern ((is_full s)))))
(declare-fun top (us_rep) Int)
(declare-fun top__function_guard (Int us_rep) Bool)
(declare-fun is_empty (us_rep) Bool)
(declare-fun is_empty__function_guard (Bool us_rep) Bool)
(assert (forall ((s us_rep)) (! (=> (and (dynamic_invariant1 s true true true) (not (= (is_empty s) true))) (dynamic_invariant (top s) true false true)) :pattern ((top s)))))
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant1 s true true true) (= (top s) (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))) :pattern ((top s)))))
...
(declare-const temp___2491 index)
(declare-const temp___2492 (Array Int integer))
(declare-const temp___2493 t)
...
(declare-const o12 t)
(declare-const temp___253 index)
(declare-const temp___2531 index)
(declare-const temp___2532 (Array Int integer))
(declare-const temp___2533 t)
...
(assert (dynamic_invariant1 (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2))) true false true))
(assert (in_range1 x))
(assert (not (= (is_full (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2)))) true)))
...
(assert (= (mk___split_fields__ref (mk___split_fields result (mk___t result1 result2))) (mk___split_fields__ref (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2)))))
(assert (= s__split_fields3 (mk___split_fields temp___2491 (mk___t temp___2492 temp___2493))))
(assert (= s__split_discrs (mk___split_discrs temp___249)))
(assert (= (to_rep o5) x))
(assert (and (<= (to_rep (first (rt (rec__stack__stack__content s__split_fields3)))) (to_rep1 (rec__stack__stack__top s__split_fields3))) (<= (to_rep1 (rec__stack__stack__top s__split_fields3)) (to_rep (last (rt (rec__stack__stack__content s__split_fields3)))))))
(assert (= o6 (to_rep1 (rec__stack__stack__top s__split_fields3))))
(assert (= o7 (store (elts (rec__stack__stack__content s__split_fields3)) o6 o5)))
(assert (= o7 o8))
...
(assert (= s__split_fields4 (mk___split_fields temp___2531 (mk___t temp___2532 temp___2533))))
(assert (= s__split_discrs (mk___split_discrs temp___253)))
