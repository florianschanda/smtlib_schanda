...
(assert (= o32 (select temp___797 i)))
(assert (= o33 (us_split_fields1 o32)))
(assert (= result14 (rec__tree_model__path_type__k o33)))
(assert (=> (= result14 true) (and (= temp___798 (nb_blacks c81b)) (and (= (bool_eq11 (select temp___798 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___798 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___798 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c81b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 0)))))))))))))))
(assert (=> (= result14 true) (= o28 (select temp___798 i))))
