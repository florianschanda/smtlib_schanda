...
(assert (<= 1 i5))
(assert (<= i5 100))
(assert (and (= temp___797 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)))) (and (dynamic_invariant5 temp___797 true false true) (= temp___797 (model__1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))))))))))
(assert (= o100 (select temp___797 i5)))
(assert (= o101 (us_split_fields1 o100)))
(assert (= result38 (rec__tree_model__path_type__k o101)))
(assert (=> (= result38 true) (and (= temp___798 (nb_blacks c81b)) (and (= (bool_eq11 (select temp___798 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___798 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___798 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c81b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___798 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 0)))))))))))))))
(assert (=> (= result38 true) (= o96 (select temp___798 i5))))
(assert (=> (= result38 true) (= o97 (us_split_fields11 o96))))
(assert (=> (= result38 true) (= o98 (rec__red_black_trees__black_count__depth o97))))
(assert (=> (= result38 true) (= o99 (to_rep o98))))
(assert (=> (= result38 true) (= o102 (ite (< o99 n62) true false))))
(assert (=> (not (= result38 true)) (= o102 false)))
(assert (= result37 (ite (and (= o102 true) (not (= i5 y))) true false)))
