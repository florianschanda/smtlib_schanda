...
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___848 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)))) (and (dynamic_invariant5 temp___848 true false true true) (= temp___848 (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))))))))))
(assert (= o32 (select temp___848 i)))
(assert (= o33 (us_split_fields7 o32)))
(assert (= result14 (rec__tree_model__path_type__k o33)))
(assert (=> (= result14 true) (and (= temp___849 (nb_blacks c81b)) (and (= (bool_eq11 (select temp___849 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___849 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___849 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___849 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___849 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___849 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___849 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___849 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___849 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___849 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c81b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___849 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i1 0)))))))))))))))
(assert (=> (= result14 true) (= o28 (select temp___849 i))))
(assert (=> (= result14 true) (= o29 (us_split_fields11 o28))))
(assert (=> (= result14 true) (= o30 (rec__red_black_trees__black_count__depth o29))))
(assert (=> (= result14 true) (= o31 (to_rep o30))))
(assert (=> (= result14 true) (= o34 (ite (< o31 n6) true false))))
(assert (=> (not (= result14 true)) (= o34 false)))
(assert (= result13 (ite (and (= o34 true) (not (= i y))) true false)))
