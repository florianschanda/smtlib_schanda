...
(declare-const temp___1662 (Array Int us_rep1))
...
(assert (and (<= 1 k) (<= k 100)))
(assert (= o15 k))
(assert (= o16 (select temp___1663 o15)))
...
(assert (and (= temp___1662 (model__ f root)) (and (dynamic_invariant5 temp___1662 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1662 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1662 root)))) 0) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (not (= i3 root)) (ite (and (not (= (parent f i3) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1662 (parent f i3)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1662 i3))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1662 i3))) true)))))) (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1662 i3))) true) (not (= i3 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1662 (parent f i3)))) (position f i3) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1662 i3)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1662 i3)))) 0)))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1662 i3))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1662 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1662 i3))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1662 j1)))) true)) (= j1 i3))))))))))))))
(assert (= o12 (select temp___1662 j)))
(assert (= o13 (us_split_fields1 o12)))
(assert (= o14 (rec__tree_model__path_type__a o13)))
(assert (and (= o22 (get o14 o21)) (in_range5 o22)))
