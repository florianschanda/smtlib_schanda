...
(assert (and (= temp___1618 (model__ f root)) (and (dynamic_invariant5 temp___1618 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1618 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1618 root)))) 0) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (not (= i21 root)) (ite (and (not (= (parent f i21) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1618 (parent f i21)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1618 i21))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1618 i21))) true)))))) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1618 i21))) true) (not (= i21 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1618 (parent f i21)))) (position f i21) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1618 i21)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1618 i21)))) 0)))) (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1618 i21))) true) (forall ((j26 Int)) (=> (and (<= 1 j26) (<= j26 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1618 j26))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1618 i21))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1618 j26)))) true)) (= j26 i21))))))))))))))
(assert (= o76 (select temp___1618 j3)))
(assert (= o77 (us_split_fields1 o76)))
(assert (= o78 (rec__tree_model__path_type__a o77)))
(assert (and (= o86 (get o78 o85)) (in_range5 o86)))
(assert (= result24 (ite (= o86 0) true false)))
