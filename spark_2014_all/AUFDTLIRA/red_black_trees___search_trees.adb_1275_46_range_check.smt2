...
(assert (= o10 (+ o9 1)))
(assert (and (= o11 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range4 o11)))
...
(assert (= o1 i))
(assert (= (mk___rep (mk___split_fields o2 o3)) (select temp___2106 o1)))
(assert (= o2 o4))
(assert (= o3 o5))
(assert (= o6 o4))
