...
(define-fun o33 () us_rep (mk___rep (mk___split_discrs o22 o23) (mk___split_fields (mk___t1 o24 o25))))
(define-fun o34 () us_rep (mk___rep (mk___split_discrs o18 o19) (mk___split_fields (mk___t1 o20 o21))))
...
(assert (not (= (to_rep1 (last (rt a))) (to_rep (rec__static_discr__holder__unused (us_split_discrs4 o32))))))
(check-sat)
(exit)
