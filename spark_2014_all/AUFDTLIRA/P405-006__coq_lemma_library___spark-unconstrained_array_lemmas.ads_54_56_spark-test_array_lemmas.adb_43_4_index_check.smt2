...
(define-fun dynamic_invariant ((temp___expr_187 us_t) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool)) Bool (=> (not (= temp___skip_constant_185 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_187) (last1 temp___expr_187))))
