...
(assert (and (= o8 (remove o7 (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant2 o8 true false true true) (and (= (invariant__ o8) true) (and (= (to_rep2 (last (rt o8))) (- (to_rep2 (last (rt o7))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts o7) k)) (to_rep (select (elts o8) k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep2 (last (rt o7))))) (= (to_rep (select (elts o7) k)) (to_rep (select (elts o8) (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep2 (last (rt o7))) 1))) (= (to_rep (select (elts o7) (+ k 1))) (to_rep (select (elts o8) k))))))))))))
