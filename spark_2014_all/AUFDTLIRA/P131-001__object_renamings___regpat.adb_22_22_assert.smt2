...
(assert (forall ((temp___146 Int)) (forall ((temp___147 Int)) (= (select (temp___144 temp___146) temp___147) (of_rep temp___146)))))
(define-fun default_initial_assumption ((temp___expr_142 us_rep) (temp___skip_top_level_143 Bool)) Bool (= (rec__regpat__pattern_matcher__program (us_split_fields1 temp___expr_142)) (temp___144 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= 0 0)) (in_range1 temp___expr_152)))
(assert true)
