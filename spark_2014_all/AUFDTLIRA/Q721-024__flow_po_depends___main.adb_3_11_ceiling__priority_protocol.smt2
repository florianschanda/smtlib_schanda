...
(define-fun default_initial_assumption ((temp___expr_173 us_rep) (temp___skip_top_level_174 Bool)) Bool (and (= (rec__fake_socket_package__fake_socket__ready (us_split_fields1 temp___expr_173)) (of_int 0)) (= (to_rep (rec__fake_socket_package__fake_socket__buffer (us_split_fields1 temp___expr_173))) 0)))
...
(define-fun dynamic_invariant1 ((temp___expr_160 Int) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool (=> (or (= temp___is_init_157 true) (<= 0 97)) (in_range2 temp___expr_160)))
(assert (not (<= 48 97)))
(check-sat)
(exit)
