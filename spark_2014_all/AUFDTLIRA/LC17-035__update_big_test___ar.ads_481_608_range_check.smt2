...
(assert (=> (< k 16) (=> (< 0 e) (= o17 (temp___1734 o16 i o15)))))
(assert (=> (< k 16) (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))))
(assert (=> (< k 16) (=> (< 0 e) (= o13 (+ k 1)))))
(assert (=> (< k 16) (=> (< 0 e) (= o18 (select a o13)))))
(assert (=> (< k 16) (=> (< 0 e) (= o19 (temp___1727 o18 j o17)))))
(assert (=> (< k 16) (=> (< 0 e) (and (= o20 (+ k 1)) (in_range2 (+ k 1))))))
(assert (=> (< k 16) (=> (< 0 e) (= temp___5421 (temp___1704 a k (temp___1712 (select a k) j (temp___1719 (select (select a k) j) i e)) o20 o19)))))
...
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o9 (temp___1773 o8 i 99))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o6 (+ k 1))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o10 (select a o6))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o11 (temp___1766 o10 j o9))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (and (= o12 (+ k 1)) (in_range2 (+ k 1)))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= temp___5431 (temp___1743 a k (temp___1751 (select a k) j (temp___1758 (select (select a k) j) i e)) o12 o11))))))
