...
(assert (=> (< k 16) (=> (< 0 e) (= temp___5362 (temp___1645 a k (temp___1653 (select a k) j (temp___1660 (select (select a k) j) i e)) o20 o19)))))
(assert (=> (< k 16) (=> (< 0 e) (= result6 (bool_eq2 a3 1 16 temp___5362 1 16)))))
...
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= temp___5371 (select a o7))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o8 (select temp___5371 j))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o9 (temp___1714 o8 i 99))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o6 (+ k 1))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o10 (select a o6))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= o11 (temp___1707 o10 j o9))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (and (= o12 (+ k 1)) (in_range2 (+ k 1)))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= temp___5372 (temp___1684 a k (temp___1692 (select a k) j (temp___1699 (select (select a k) j) i e)) o12 o11))))))
(assert (=> (< k 16) (=> (not (= result6 true)) (=> (= e 0) (= result5 (bool_eq2 a3 1 16 temp___5372 1 16))))))
