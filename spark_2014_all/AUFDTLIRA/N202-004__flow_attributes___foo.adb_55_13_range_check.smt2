...
(declare-fun temp___289 (Int Int Int) us_t1)
...
(assert (= (to_rep1 (first2 (rt1 (temp___289 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___289 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___296 temp___2961) (temp___289 32 (to_rep1 a__first) (to_rep1 a__last))))
