...
(declare-fun temp_____aggregate_def_289 (Int Int Int) us_t1)
...
(assert (forall ((temp___291 Int) (temp___292 Int) (temp___293 Int)) (let ((temp___290 (temp_____aggregate_def_289 temp___291 temp___292 temp___293))) (=> (dynamic_invariant2 temp___291 true true true true) (and (=> (dynamic_property 1 2147483647 temp___292 temp___293) (and (= (first3 temp___290) temp___292) (= (last3 temp___290) temp___293))) (forall ((temp___294 Int)) (= (to_rep (select (to_array1 temp___290) temp___294)) temp___291)))))))
(declare-const a (Array Int character))
(declare-const b Int)
(declare-const temp___296 (Array Int character))
(declare-const temp___2961 t1)
(declare-const temp___297 (Array Int character))
(declare-const temp___2971 t)
(declare-const temp___298 (Array Int character))
(declare-const temp___2981 t)
...
(assert (= (to_rep1 (first2 (rt1 (temp_____aggregate_def_289 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp_____aggregate_def_289 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___296 temp___2961) (temp_____aggregate_def_289 32 (to_rep1 a__first) (to_rep1 a__last))))
(assert (= temp___296 temp___297))
(assert (= (mk (to_rep1 (first2 temp___2961)) (to_rep1 (last2 temp___2961))) temp___2971))
(assert (= (ite (<= (to_rep1 (first temp___2971)) (to_rep1 (last temp___2971))) (+ (- (to_rep1 (last temp___2971)) (to_rep1 (first temp___2971))) 1) 0) (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0)))
(assert (= (mk___t temp___298 temp___2981) (mk___t temp___297 temp___2971)))
(assert (= o (slide temp___298 (to_rep1 (first temp___2981)) (to_rep1 a__first))))
(assert (= result a))
(assert (= a1 o))
(assert (=> (<= (to_rep1 a__first) (to_rep1 a__last)) (= o1 (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1))))
