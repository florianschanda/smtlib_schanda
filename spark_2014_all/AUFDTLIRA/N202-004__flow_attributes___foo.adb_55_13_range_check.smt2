...
(assert (forall ((temp___256 Int) (temp___257 Int) (temp___258 Int)) (let ((temp___255 (temp___254 temp___256 temp___257 temp___258))) (and (=> (dynamic_property 1 2147483647 temp___257 temp___258) (and (= (first3 temp___255) temp___257) (= (last3 temp___255) temp___258))) (forall ((temp___259 Int)) (= (select (to_array1 temp___255) temp___259) (of_rep temp___256)))))))
...
(assert (= (to_rep1 (first2 (rt1 (temp___254 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___254 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___261 temp___2611) (temp___254 32 (to_rep1 a__first) (to_rep1 a__last))))
(assert (= temp___261 temp___262))
(assert (= (mk (to_rep1 (first2 temp___2611)) (to_rep1 (last2 temp___2611))) temp___2621))
(assert (= (ite (<= (to_rep1 (first temp___2621)) (to_rep1 (last temp___2621))) (+ (- (to_rep1 (last temp___2621)) (to_rep1 (first temp___2621))) 1) 0) (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0)))
(assert (= (mk___t temp___263 temp___2631) (mk___t temp___262 temp___2621)))
(assert (= o (slide temp___263 (to_rep1 (first temp___2631)) (to_rep1 a__first))))
(assert (= result a))
(assert (= a1 o))
