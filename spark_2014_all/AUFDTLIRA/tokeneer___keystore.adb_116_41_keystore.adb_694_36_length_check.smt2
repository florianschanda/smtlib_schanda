...
(assert (= (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) temp___1142))
(assert (= (mk1 1 (length thestring)) temp___11421))
(assert (and (= temp___1144 (length thestring)) (in_range1 (length thestring))))
(assert (=> (<= 1 temp___1144) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1144) (<= temp___1144 150)))))
(assert (= o7 result__1))
(assert (= o7 temp___1145))
(assert (= (mk1 1 temp___1144) temp___11451))
(assert (not (= (ite (<= (to_rep1 (first2 temp___11421)) (to_rep1 (last2 temp___11421))) (+ (- (to_rep1 (last2 temp___11421)) (to_rep1 (first2 temp___11421))) 1) 0) (ite (<= (to_rep1 (first2 temp___11451)) (to_rep1 (last2 temp___11451))) (+ (- (to_rep1 (last2 temp___11451)) (to_rep1 (first2 temp___11451))) 1) 0))))
(check-sat)
(exit)
