...
(assert (=> (= result7 true) (and (ite (exists ((t Int)) (and (and (<= 1 t) (<= t cur_num_trains)) (= (is_previous_track (select trains1 t) o6) true))) (= (to_rep5 (select track_signals2 o6)) 1) (= (to_rep5 (select track_signals2 o6)) 0)) (forall ((other_track Int)) (=> (and (<= 1 other_track) (<= other_track 8)) (=> (not (= other_track o6)) (= (to_rep5 (select track_signals2 other_track)) (to_rep5 (select track_signals1 other_track)))))))))
(assert (=> (not (= result7 true)) (= track_signals2 track_signals1)))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j 8))
(assert (= (to_rep5 (select track_signals1 j)) 2))
(assert (not (= (to_rep5 (select track_signals2 j)) 2)))
(check-sat)
(exit)
