...
(assert (= hr3 o23))
(assert (not (= (let ((temp___274 (remove (remove (mk___t interm1 (mk 1 100)) y) (- x 1)))) (let ((temp___273 (remove (remove (mk___t interm1 (mk 1 100)) x) y))) (bool_eq (elts temp___273) (to_rep1 (first (rt temp___273))) (to_rep1 (last (rt temp___273))) (elts temp___274) (to_rep1 (first (rt temp___274))) (to_rep1 (last (rt temp___274)))))) true)))
(check-sat)
(exit)
