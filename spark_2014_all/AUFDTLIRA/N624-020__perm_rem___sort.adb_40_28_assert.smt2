...
(assert (= hr3 o23))
(assert (not (= (let ((temp___248 (remove (remove (mk___t interm1 (mk 1 100)) y) (- x 1)))) (let ((temp___247 (remove (remove (mk___t interm1 (mk 1 100)) x) y))) (bool_eq (elts temp___247) (to_rep1 (first (rt temp___247))) (to_rep1 (last (rt temp___247))) (elts temp___248) (to_rep1 (first (rt temp___248))) (to_rep1 (last (rt temp___248)))))) true)))
(check-sat)
(exit)
