...
(assert (and (= o43 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o43)))
(assert (= o44 (ite (<= j o43) true false)))
(assert (= result10 (ite (<= 1 j) o44 false)))
(assert (= result10 true))
(assert (and (= o64 (get (rec__list_allocator__m__t__available model____split_fields4) j)) (in_range7 o64)))
(assert (= result13 (ite (in_range4 o64) true false)))
(assert (= result13 true))
(assert (and (= o60 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o60)))
(assert (= result14 (ite (< j o60) true false)))
