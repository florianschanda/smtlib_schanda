...
(assert (not (= k2 last3)))
(assert (and (= o33 (- k2 1)) (in_range2 (- k2 1))))
(assert (= result7 (mk_int__ref k2)))
(assert (= k3 o33))
(assert (and (<= (to_rep1 a__first) k3) (<= k3 (to_rep1 a__last))))
(assert (= o34 k3))
(assert (= (mk___rep (mk___split_fields o35 o36 o37)) (select a2 o34)))
(assert (= o35 o38))
(assert (= o36 o39))
(assert (= o37 o40))
(assert (= o41 o38))
(assert (= o42 (to_rep o41)))
(assert (= result8 (ite (< max3 o42) true false)))
(assert (=> (= result8 true) (and (<= (to_rep1 a__first) k3) (<= k3 (to_rep1 a__last)))))
(assert (=> (= result8 true) (= o43 k3)))
(assert (=> (= result8 true) (= (mk___rep (mk___split_fields o44 o45 o46)) (select a2 o43))))
(assert (=> (= result8 true) (= o44 o47)))
(assert (=> (= result8 true) (= o45 o48)))
(assert (=> (= result8 true) (= o46 o49)))
(assert (=> (= result8 true) (= o50 o47)))
(assert (=> (= result8 true) (= o51 (to_rep o50))))
(assert (=> (= result8 true) (= result9 (mk_int__ref max3))))
(assert (=> (= result8 true) (= max4 o51)))
...
(assert (= (to_rep o52) c268b3))
(assert (= (rec__frame_condition__cell__value (us_split_fields1 (select a2 c267b3))) o53))
(assert (= (rec__frame_condition__cell__max_left (us_split_fields1 (select a2 c267b3))) o54))
(assert (= o52 o55))
(assert (= o56 (mk___rep (mk___split_fields o53 o54 o55))))
(assert (and (<= (to_rep1 a__first) c267b3) (<= c267b3 (to_rep1 a__last))))
(assert (= o57 c267b3))
(assert (= o58 (store a2 o57 o56)))
...
(assert (<= i6 j4))
(assert (<= j4 k3))
(assert (not (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a3 i6)))) (get_max_right j4 a3))))
(check-sat)
(exit)
