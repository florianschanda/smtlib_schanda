...
(assert (<= j7 100))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= result13 (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j7)) (and (= (= result13 true) (and (<= j7 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) j7)))) 2))) (=> (< (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) j7) (not (= result13 true))))))
