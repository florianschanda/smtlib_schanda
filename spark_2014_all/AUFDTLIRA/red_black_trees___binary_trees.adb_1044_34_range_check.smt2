...
(assert (<= 1 r2))
(assert (<= r2 r299b))
(assert (=> (and (not (= r2 root)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r2)))) 2) (not (= r2 v)))) (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true)))
(assert (=> (and (not (= r2 root)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r2)))) 2) (not (= r2 v)))) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root) i7))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r2) i7))) true)))))))
(assert (=> (and (not (= r2 root)) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r2)))) 2) (not (= r2 v)))) (and (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 r2)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r2) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r2)) true))))
(assert (forall ((p1 Int)) (=> (and (<= 1 p1) (<= p1 r3)) (=> (and (and (not (= p1 root)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 p1)))) 2)) (not (= p1 v))) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) p1) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) p1)) true)))))
(assert (and (=> (<= 1 r299b) (dynamic_property 1 r299b r3)) (and (<= 1 r3) (<= r3 r299b))))
(assert (<= 1 p))
(assert (<= p r3))
(assert (and (<= 1 p) (<= p 100)))
(assert (= o91 p))
(assert (= o92 (select f_old__split_fields1 o91)))
(assert (= o93 (us_split_fields3 o92)))
(assert (= o94 (rec__binary_trees__cell__position o93)))
(assert (= o95 (to_rep1 o94)))
(assert (= o96 (ite (= o95 2) true false)))
(assert (= o97 (ite (not (= p root)) o96 false)))
(assert (= result22 (ite (= o97 true) (ite (not (= p v)) true false) false)))
(assert (= result22 true))
(assert (and (= o100 p) (in_range1 p)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o101 p) (in_range1 p)))
(assert (and (= o102 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o101)) (and (dynamic_invariant3 o102 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o102 o101))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o102 o101)))) 0) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (not (= i7 o101)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o102 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o102 i7))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o102 i7))) true)))))) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o102 i7))) true) (not (= i7 o101))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o102 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7) (rec__tree_model__path_type__a (us_split_fields1 (select o102 i7)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o102 i7)))) 0)))) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o102 i7))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o102 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o102 i7))) (rec__tree_model__path_type__a (us_split_fields1 (select o102 j2)))) true)) (= j2 i7))))))))))))))
