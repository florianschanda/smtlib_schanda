...
(assert (and (= o12 (length3 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) (and (in_range10 o12) (<= o12 (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))))))
...
(assert (= result1 true))
(assert (and (= o7 (length3 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) (and (in_range10 o7) (<= o7 (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))))))
(assert (= o8 (- o7 1)))
(assert (and (= o5 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range8 o5) (= o5 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= o6 (select f o5)))
(assert (= o9 (to_rep4 o6)))
(assert (= o10 (ite (<= o9 o8) true false)))
(assert (and (= o2 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range8 o2) (= o2 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
