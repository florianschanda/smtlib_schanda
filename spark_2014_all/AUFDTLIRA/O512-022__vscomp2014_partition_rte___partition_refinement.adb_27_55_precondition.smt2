...
(assert (= result3 true))
(assert (and (= o (has_key1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (mk___rep1 (mk___split_fields1 c)))) (= (= o true) (= (has_key1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (mk___rep1 (mk___split_fields1 c))) true))))
(assert (= o1 true))
(assert (= result4 (ite (= o1 true) o false)))
(assert (= result4 true))
(assert (not (= (has_key1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (mk___rep1 (mk___split_fields1 c))) true)))
(check-sat)
(exit)
