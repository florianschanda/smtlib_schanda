...
(define-fun dynamic_invariant ((temp___expr_254 us_t1) (temp___is_init_251 Bool) (temp___skip_constant_252 Bool) (temp___do_toplevel_253 Bool)) Bool (and (=> (not (= temp___skip_constant_252 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_254) (last3 temp___expr_254))) (=> (= temp___do_toplevel_253 true) (=> (= temp___is_init_251 true) (and (= (first5 (of_array2 (to_array1 temp___expr_254) (first3 temp___expr_254) (last3 temp___expr_254))) 1) (<= (last3 temp___expr_254) 1000))))))
(define-fun dynamic_predicate ((temp___258 us_t1)) Bool (and (= (first5 (of_array2 (to_array1 temp___258) (first3 temp___258) (last3 temp___258))) 1) (<= (last3 temp___258) 1000)))
...
(define-fun dynamic_invariant1 ((temp___expr_309 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 4294967295)) (in_range3 temp___expr_309)))
(declare-const x Int)
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___362))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___3621))
(assert (not (dynamic_predicate (mk___t1 temp___362 temp___3621))))
(check-sat)
(exit)
