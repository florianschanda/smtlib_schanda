...
(define-fun dynamic_invariant ((temp___expr_305 us_t1) (temp___is_init_301 Bool) (temp___skip_constant_302 Bool) (temp___do_toplevel_303 Bool) (temp___do_typ_inv_304 Bool)) Bool (and (=> (not (= temp___skip_constant_302 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_305) (last3 temp___expr_305))) (=> (= temp___do_toplevel_303 true) (=> (= temp___is_init_301 true) (and (let ((temp___307 (of_array2 (to_array1 temp___expr_305) (first3 temp___expr_305) (last3 temp___expr_305)))) (and (= (first5 temp___307) 1) (<= 0 (last5 temp___307)))) (<= (last3 temp___expr_305) 1000))))))
(define-fun dynamic_predicate ((temp___309 us_t1)) Bool (and (let ((temp___311 (of_array2 (to_array1 temp___309) (first3 temp___309) (last3 temp___309)))) (and (= (first5 temp___311) 1) (<= 0 (last5 temp___311)))) (<= (last3 temp___309) 1000)))
...
(define-fun dynamic_invariant1 ((temp___expr_395 Int) (temp___is_init_391 Bool) (temp___skip_constant_392 Bool) (temp___do_toplevel_393 Bool) (temp___do_typ_inv_394 Bool)) Bool (=> (or (= temp___is_init_391 true) (<= 0 4294967295)) (in_range3 temp___expr_395)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_268 us_t2) (temp___is_init_264 Bool) (temp___skip_constant_265 Bool) (temp___do_toplevel_266 Bool) (temp___do_typ_inv_267 Bool)) Bool (and (=> (not (= temp___skip_constant_265 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_268) (last5 temp___expr_268))) (=> (= temp___do_toplevel_266 true) (=> (= temp___is_init_264 true) (and (= (first5 temp___expr_268) 1) (<= 0 (last5 temp___expr_268)))))))
(define-fun dynamic_predicate1 ((temp___271 us_t2)) Bool (and (= (first5 temp___271) 1) (<= 0 (last5 temp___271))))
(declare-const temp___454 (Array Int character))
(declare-const temp___4541 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___454))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___4541))
(assert (not (dynamic_predicate (mk___t1 temp___454 temp___4541))))
(check-sat)
(exit)
