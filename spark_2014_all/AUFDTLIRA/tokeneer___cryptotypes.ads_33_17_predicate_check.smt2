...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___402))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___4021))
(assert (not (dynamic_predicate (mk___t1 temp___402 temp___4021))))
(check-sat)
(exit)
