...
(declare-const temp___475 (Array Int character))
...
(declare-const temp___483 (Array Int character))
(declare-const test__op_string_char__x__compl3 (Array Int character))
(declare-const o27 integer)
(declare-const o28 integer)
(declare-const o29 (Array Int character))
(declare-const temp___491 (Array Int character))
(declare-const temp___492 (Array Int character))
(declare-const test__op_string_char__x__compl4 (Array Int character))
...
(declare-const test__op_string_char__y6 Int)
...
(declare-const a6 (Array Int character))
(declare-const tmp2 Int)
(declare-const test__op_string_char__x3 (Array Int character))
(declare-const result7 (Array Int character))
(declare-const a7 (Array Int character))
(declare-const test__op_string_char__y7 Int)
(declare-const test__op_string_char__x4 (Array Int character))
(declare-const result8 (Array Int character))
(declare-const a8 (Array Int character))
...
(assert (forall ((temp___462 Int)) (ite (and (<= 3 temp___462) (<= temp___462 12)) (= (select o5 temp___462) (select (slide test__op_string_char__x (to_rep1 (first (mk 3 12))) 3) temp___462)) (= (select o5 temp___462) (select a temp___462)))))
(assert (= (mk_map__ref result1) (mk_map__ref a)))
(assert (= a1 o5))
(assert (= (to_rep o6) test__op_string_char__y4))
(assert (and (<= (to_rep1 a__first) 2) (<= 2 (to_rep1 a__last))))
(assert (= o7 2))
...
(assert (forall ((temp___470 Int)) (ite (and (<= 3 temp___470) (<= temp___470 12)) (= (select o14 temp___470) (select (slide test__op_string_char__x1 (to_rep1 (first (mk 3 12))) 3) temp___470)) (= (select o14 temp___470) (select a2 temp___470)))))
(assert (= a2 result3))
(assert (= a3 o14))
(assert (= (to_rep o15) test__op_string_char__y5))
(assert (and (<= (to_rep1 a__first) 5) (<= 5 (to_rep1 a__last))))
(assert (= o16 5))
...
(assert (= a4 o17))
(assert (=> (<= 3 12) (and (and (<= (to_rep1 a__first) 3) (<= 3 (to_rep1 a__last))) (and (<= (to_rep1 a__first) 12) (<= 12 (to_rep1 a__last))))))
(assert (= temp___475 a4))
(assert (= test__op_string_char__x__compl2 temp___475))
...
(assert (in_range2 test__op_string_char__y6))
(assert (forall ((temp___478 Int)) (ite (and (<= 3 temp___478) (<= temp___478 12)) (= (select o23 temp___478) (select (slide test__op_string_char__x2 (to_rep1 (first (mk 3 12))) 3) temp___478)) (= (select o23 temp___478) (select a4 temp___478)))))
(assert (= a4 result5))
(assert (= a5 o23))
(assert (= (to_rep o24) test__op_string_char__y6))
(assert (and (<= (to_rep1 a__first) 20) (<= 20 (to_rep1 a__last))))
(assert (= o25 20))
(assert (= o26 (store a5 o25 o24)))
(assert (= result6 a5))
(assert (= a6 o26))
(assert (=> (<= 3 12) (and (and (<= (to_rep1 a__first) 3) (<= 3 (to_rep1 a__last))) (and (<= (to_rep1 a__first) 12) (<= 12 (to_rep1 a__last))))))
(assert (= temp___483 a6))
(assert (= test__op_string_char__x__compl3 temp___483))
(assert (= (to_rep1 o28) 12))
(assert (= (to_rep1 o27) 3))
(assert (in_range2 tmp2))
(assert (forall ((temp___486 Int)) (ite (and (<= 3 temp___486) (<= temp___486 12)) (= (select o29 temp___486) (select (slide test__op_string_char__x3 (to_rep1 (first (mk 3 12))) 3) temp___486)) (= (select o29 temp___486) (select a6 temp___486)))))
(assert (= result7 a6))
(assert (= a7 o29))
(assert (=> (<= 3 12) (and (and (<= (to_rep1 a__first) 3) (<= 3 (to_rep1 a__last))) (and (<= (to_rep1 a__first) 12) (<= 12 (to_rep1 a__last))))))
(assert (= temp___491 a7))
(assert (= temp___492 temp___491))
(assert (<= 8 10))
(assert (not (<= 3 8)))
(check-sat)
(exit)
