...
(assert (<= 1 i))
(assert (<= i 100))
(assert (not (<= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res1 i)))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res1 i)))))))
(check-sat)
(exit)
