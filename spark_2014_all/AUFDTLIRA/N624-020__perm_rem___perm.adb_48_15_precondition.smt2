...
(assert (= o20 (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11))))))
...
(assert (= o18 (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result11))))))
(assert (= o19 (select (elts a) o18)))
(assert (= o23 (to_rep o19)))
(assert (= result6 (ite (= o23 o22) true false)))
(assert (= result6 true))
(assert (not (<= (to_rep1 (first (rt b))) (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))))))
(check-sat)
(exit)
