...
(assert (and (= (invariant__ a) true) (and (= (invariant__ b) true) (and (= (invariant__ c) true) (and (= (bool_eq (elts a) (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) (elts c) (to_rep1 (first (rt c))) (to_rep1 (last (rt c)))) true) (= (is_perm a b) true))))))
...
(assert (and (= o (induction_hypothesis a b c)) (and (in_range4 o) (=> (= (of_int o) true) (= (is_perm c b) true)))))
(assert (= (mk_int__ref result3) (mk_int__ref perm__shift_perm_l__result)))
...
(assert (= (of_int perm__shift_perm_l__result4) true))
