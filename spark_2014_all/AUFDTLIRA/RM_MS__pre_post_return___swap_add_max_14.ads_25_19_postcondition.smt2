...
(declare-fun temp___148 ((Array Int integer) Int Int Int Int) (Array Int integer))
(assert (forall ((temp___150 (Array Int integer))) (forall ((temp___151 Int) (temp___152 Int) (temp___153 Int) (temp___154 Int)) (let ((temp___149 (temp___148 temp___150 temp___151 temp___152 temp___153 temp___154))) (forall ((temp___155 Int)) (ite (= temp___155 temp___153) (= (select temp___149 temp___155) (of_rep temp___154)) (ite (= temp___155 temp___151) (= (select temp___149 temp___155) (of_rep temp___152)) (= (select temp___149 temp___155) (select temp___150 temp___155)))))))))
...
(assert (= a4 a2))
(assert (not (= (bool_eq a3 1 100 (temp___148 a i (to_rep (select a j)) j (to_rep (select a i))) 1 100) true)))
(check-sat)
(exit)
