...
(define-fun dynamic_invariant1 ((temp___expr_1524 Int) (temp___is_init_1520 Bool) (temp___skip_constant_1521 Bool) (temp___do_toplevel_1522 Bool) (temp___do_typ_inv_1523 Bool)) Bool (=> (or (= temp___is_init_1520 true) (<= 0 4294967295)) (in_range2 temp___expr_1524)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant2 ((temp___expr_1531 Int) (temp___is_init_1527 Bool) (temp___skip_constant_1528 Bool) (temp___do_toplevel_1529 Bool) (temp___do_typ_inv_1530 Bool)) Bool (=> (or (= temp___is_init_1527 true) (<= 0 2)) (in_range3 temp___expr_1531)))
...
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep8 (select a temp___idx_91)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_91)))))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_2874 Int) (temp___is_init_2870 Bool) (temp___skip_constant_2871 Bool) (temp___do_toplevel_2872 Bool) (temp___do_typ_inv_2873 Bool)) Bool (=> (or (= temp___is_init_2870 true) (<= 0 8)) (in_range17 temp___expr_2874)))
...
(define-fun dynamic_invariant4 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range12 temp___expr_74)))
(define-fun dynamic_invariant5 ((temp___expr_2968 Int) (temp___is_init_2964 Bool) (temp___skip_constant_2965 Bool) (temp___do_toplevel_2966 Bool) (temp___do_typ_inv_2967 Bool)) Bool (=> (or (= temp___is_init_2964 true) (<= 5 8)) (in_range19 temp___expr_2968)))
(define-fun dynamic_invariant6 ((temp___expr_2975 Int) (temp___is_init_2971 Bool) (temp___skip_constant_2972 Bool) (temp___do_toplevel_2973 Bool) (temp___do_typ_inv_2974 Bool)) Bool (=> (or (= temp___is_init_2971 true) (<= 4 8)) (in_range18 temp___expr_2975)))
(define-fun dynamic_invariant7 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 3)) (in_range4 temp___expr_426)))
(define-fun dynamic_invariant8 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range5 temp___expr_440)))
(assert true)
(define-fun dynamic_invariant9 ((temp___expr_1099 Int) (temp___is_init_1095 Bool) (temp___skip_constant_1096 Bool) (temp___do_toplevel_1097 Bool) (temp___do_typ_inv_1098 Bool)) Bool (=> (or (= temp___is_init_1095 true) (<= 0 40)) (in_range11 temp___expr_1099)))
(define-fun dynamic_invariant10 ((temp___expr_1123 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool) (temp___do_typ_inv_1122 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 4294967295)) (in_range13 temp___expr_1123)))
(define-fun dynamic_invariant11 ((temp___expr_1147 Int) (temp___is_init_1143 Bool) (temp___skip_constant_1144 Bool) (temp___do_toplevel_1145 Bool) (temp___do_typ_inv_1146 Bool)) Bool (=> (or (= temp___is_init_1143 true) (<= 0 10)) (in_range10 temp___expr_1147)))
(define-fun dynamic_invariant12 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 4294967295)) (in_range15 temp___expr_1161)))
(define-fun dynamic_invariant13 ((temp___expr_1168 Int) (temp___is_init_1164 Bool) (temp___skip_constant_1165 Bool) (temp___do_toplevel_1166 Bool) (temp___do_typ_inv_1167 Bool)) Bool (=> (or (= temp___is_init_1164 true) (<= 0 128)) (in_range16 temp___expr_1168)))
(define-fun dynamic_invariant14 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range6 temp___expr_625)))
(define-fun dynamic_invariant15 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range7 temp___expr_632)))
(define-fun dynamic_invariant16 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range8 temp___expr_639)))
(define-fun dynamic_invariant17 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range9 temp___expr_671)))
(define-fun dynamic_invariant18 ((temp___expr_1603 Int) (temp___is_init_1599 Bool) (temp___skip_constant_1600 Bool) (temp___do_toplevel_1601 Bool) (temp___do_typ_inv_1602 Bool)) Bool (=> (or (= temp___is_init_1599 true) (<= 0 4294967295)) (in_range14 temp___expr_1603)))
