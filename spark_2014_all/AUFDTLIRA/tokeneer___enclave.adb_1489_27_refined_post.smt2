...
(define-fun dynamic_invariant1 ((temp___expr_1363 Int) (temp___is_init_1360 Bool) (temp___skip_constant_1361 Bool) (temp___do_toplevel_1362 Bool)) Bool (=> (or (= temp___is_init_1360 true) (<= 0 4294967295)) (in_range2 temp___expr_1363)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant2 ((temp___expr_1369 Int) (temp___is_init_1366 Bool) (temp___skip_constant_1367 Bool) (temp___do_toplevel_1368 Bool)) Bool (=> (or (= temp___is_init_1366 true) (<= 0 2)) (in_range3 temp___expr_1369)))
...
(declare-fun user_eq3 (privileget privileget) Bool)
(declare-const dummy3 privileget)
...
(assert (forall ((x privileget)) (! (in_range4 (to_rep x)) :pattern ((to_rep x)))))
...
(declare-fun user_eq4 (classt classt) Bool)
(declare-const dummy4 classt)
...
(declare-fun to_rep1 (classt) Int)
(declare-fun of_rep1 (Int) classt)
(assert (forall ((x classt)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x classt)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)))))
(assert (forall ((x Int)) (! (=> (in_range5 x) (= (to_rep1 (of_rep1 x)) x)) :pattern ((to_rep1 (of_rep1 x))))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__privtypes__clearancet__class classt)))))
(define-fun us_split_fields_Class__projection ((a us_split_fields)) classt (rec__privtypes__clearancet__class a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__privtypes__clearancet__class (us_split_fields1 a))) (to_rep1 (rec__privtypes__clearancet__class (us_split_fields1 b)))) true false))
...
(declare-datatypes () ((clearancet__ref (mk_clearancet__ref (clearancet__content us_rep)))))
(define-fun clearancet__ref___projection ((a clearancet__ref)) us_rep (clearancet__content a))
...
(declare-fun to_rep6 (algorithmt) Int)
(declare-fun of_rep6 (Int) algorithmt)
(assert (forall ((x algorithmt)) (! (= (of_rep6 (to_rep6 x)) x) :pattern ((to_rep6 x)))))
(assert (forall ((x algorithmt)) (! (in_range10 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x character)) (! (in_range12 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(define-fun bool_eq2 ((a (Array Int character)) (a__first Int) (a__last Int) (b (Array Int character)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_78 Int)) (=> (and (<= a__first temp___idx_78) (<= temp___idx_78 a__last)) (= (to_rep8 (select a temp___idx_78)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_78))))))) true false))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_78 Int)) (=> (and (<= a__first temp___idx_78) (<= temp___idx_78 a__last)) (= (to_rep8 (select a temp___idx_78)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_78)))))))))))
...
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep8 (select a (+ i 1))) (to_rep8 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep8 (select b (+ i 1))) (to_rep8 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq3 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (to_rep9 (rec__cryptotypes__issuert__id (us_split_fields5 a))) (to_rep9 (rec__cryptotypes__issuert__id (us_split_fields5 b)))) (= (to_rep7 (rec__cryptotypes__issuert__namelength (us_split_fields5 a))) (to_rep7 (rec__cryptotypes__issuert__namelength (us_split_fields5 b))))) (= (bool_eq2 (rec__cryptotypes__issuert__name (us_split_fields5 a)) 1 40 (rec__cryptotypes__issuert__name (us_split_fields5 b)) 1 40) true)) true false))
...
(declare-fun to_rep10 (serialnumbert) Int)
(declare-fun of_rep10 (Int) serialnumbert)
(assert (forall ((x serialnumbert)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x serialnumbert)) (! (in_range14 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (bool_eq3 (rec__certtypes__idt__issuer (us_split_fields7 a)) (rec__certtypes__idt__issuer (us_split_fields7 b))) true) (= (to_rep10 (rec__certtypes__idt__serialnumber (us_split_fields7 a))) (to_rep10 (rec__certtypes__idt__serialnumber (us_split_fields7 b))))) true false))
...
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__cert__attr__auth__contentst__id us_rep3) (rec__cert__attr__auth__contentst__notbefore us_rep1) (rec__cert__attr__auth__contentst__notafter us_rep1) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep3) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields8)) us_rep3 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields8)) us_rep1 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields8)) us_rep1 (rec__cert__attr__auth__contentst__notafter a))
...
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields8)) us_rep3 (rec__cert__attr__auth__contentst__basecertid a))
(define-fun us_split_fields_Role__projection ((a us_split_fields8)) privileget (rec__cert__attr__auth__contentst__role a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields8)) us_rep (rec__cert__attr__auth__contentst__clearance a))
(declare-datatypes () ((us_split_fields__ref4 (mk___split_fields__ref4 (us_split_fields__content4 us_split_fields8)))))
(define-fun us_split_fields__ref___17__projection ((a us_split_fields__ref4)) us_split_fields8 (us_split_fields__content4 a))
...
(define-fun bool_eq5 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (and (and (and (= (bool_eq4 (rec__cert__attr__auth__contentst__id (us_split_fields9 a)) (rec__cert__attr__auth__contentst__id (us_split_fields9 b))) true) (= (bool_eq1 (rec__cert__attr__auth__contentst__notbefore (us_split_fields9 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields9 b))) true)) (= (bool_eq1 (rec__cert__attr__auth__contentst__notafter (us_split_fields9 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields9 b))) true)) (= (to_rep6 (rec__cert__attr__auth__contentst__mechanism (us_split_fields9 a))) (to_rep6 (rec__cert__attr__auth__contentst__mechanism (us_split_fields9 b))))) (= (bool_eq4 (rec__cert__attr__auth__contentst__basecertid (us_split_fields9 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields9 b))) true)) (= (to_rep (rec__cert__attr__auth__contentst__role (us_split_fields9 a))) (to_rep (rec__cert__attr__auth__contentst__role (us_split_fields9 b))))) (= (bool_eq (rec__cert__attr__auth__contentst__clearance (us_split_fields9 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields9 b))) true)) true false))
...
(define-fun us_split_fields__ref___19__projection ((a us_split_fields__ref5)) us_split_fields10 (us_split_fields__content5 a))
...
(assert (forall ((x keyidt)) (! (in_range15 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(assert (forall ((x keylengtht)) (! (in_range16 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__cert__id__contentst__id us_rep3) (rec__cert__id__contentst__notbefore us_rep1) (rec__cert__id__contentst__notafter us_rep1) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep2) (rec__cert__id__contentst__subjectpublickey us_rep6)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields14)) us_rep3 (rec__cert__id__contentst__id a))
...
(define-fun us_split_fields_Subject__projection ((a us_split_fields14)) us_rep2 (rec__cert__id__contentst__subject a))
...
(define-fun us_rep___19__projection ((a us_rep7)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq8 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (and (= (bool_eq4 (rec__cert__id__contentst__id (us_split_fields15 a)) (rec__cert__id__contentst__id (us_split_fields15 b))) true) (= (bool_eq1 (rec__cert__id__contentst__notbefore (us_split_fields15 a)) (rec__cert__id__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq1 (rec__cert__id__contentst__notafter (us_split_fields15 a)) (rec__cert__id__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep6 (rec__cert__id__contentst__mechanism (us_split_fields15 a))) (to_rep6 (rec__cert__id__contentst__mechanism (us_split_fields15 b))))) (= (bool_eq3 (rec__cert__id__contentst__subject (us_split_fields15 a)) (rec__cert__id__contentst__subject (us_split_fields15 b))) true)) (= (bool_eq7 (rec__cert__id__contentst__subjectpublickey (us_split_fields15 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields15 b))) true)) true false))
...
(define-fun us_rep___21__projection ((a us_rep8)) us_split_fields16 (us_split_fields17 a))
...
(define-fun in_range17 ((x Int)) Bool (and (<= 0 x) (<= x 8)))
...
(declare-fun user_eq26 (statust statust) Bool)
(declare-const dummy26 statust)
...
(define-fun dynamic_invariant3 ((temp___expr_2670 Int) (temp___is_init_2667 Bool) (temp___skip_constant_2668 Bool) (temp___do_toplevel_2669 Bool)) Bool (=> (or (= temp___is_init_2667 true) (<= 0 8)) (in_range17 temp___expr_2670)))
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-sort nonquiescentstates 0)
(define-fun in_range18 ((x Int)) Bool (and (<= 4 x) (<= x 8)))
...
(declare-fun user_eq27 (nonquiescentstates nonquiescentstates) Bool)
(declare-const dummy27 nonquiescentstates)
...
(declare-fun ispresent (Int us_private Int Int us_split_fields10 us_split_fields16) Bool)
(declare-fun ispresent__function_guard (Bool Int us_private Int Int us_split_fields10 us_split_fields16) Bool)
(declare-fun adminhasdeparted (Int Int us_private Int Int us_split_fields10 us_split_fields16) Bool)
(declare-fun adminhasdeparted__function_guard (Bool Int Int us_private Int Int us_split_fields10 us_split_fields16) Bool)
(assert true)
(assert (forall ((enclave__status Int) (admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields10)) (forall ((admintoken__idcert__fields us_split_fields16)) (! (= (= (adminhasdeparted enclave__status admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (and (not (= (ispresent admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true)) (in_range18 enclave__status))) :pattern ((adminhasdeparted enclave__status admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(declare-sort activeenclavestates 0)
(define-fun in_range19 ((x Int)) Bool (and (<= 5 x) (<= x 8)))
...
(declare-fun user_eq28 (activeenclavestates activeenclavestates) Bool)
(declare-const dummy28 activeenclavestates)
(declare-datatypes () ((activeenclavestates__ref (mk_activeenclavestates__ref (activeenclavestates__content activeenclavestates)))))
(define-fun activeenclavestates__ref___projection ((a activeenclavestates__ref)) activeenclavestates (activeenclavestates__content a))
(declare-fun adminactivityinprogress (Int) Bool)
(declare-fun adminactivityinprogress__function_guard (Bool Int) Bool)
(assert true)
(assert (forall ((enclave__status Int)) (! (= (= (adminactivityinprogress enclave__status) true) (in_range19 enclave__status)) :pattern ((adminactivityinprogress enclave__status)))))
(define-fun dynamic_invariant4 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range12 temp___expr_63)))
(define-fun dynamic_invariant5 ((temp___expr_2762 Int) (temp___is_init_2759 Bool) (temp___skip_constant_2760 Bool) (temp___do_toplevel_2761 Bool)) Bool (=> (or (= temp___is_init_2759 true) (<= 5 8)) (in_range19 temp___expr_2762)))
(define-fun dynamic_invariant6 ((temp___expr_2768 Int) (temp___is_init_2765 Bool) (temp___skip_constant_2766 Bool) (temp___do_toplevel_2767 Bool)) Bool (=> (or (= temp___is_init_2765 true) (<= 4 8)) (in_range18 temp___expr_2768)))
(define-fun dynamic_invariant7 ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 0 3)) (in_range4 temp___expr_383)))
(define-fun dynamic_invariant8 ((temp___expr_395 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 5)) (in_range5 temp___expr_395)))
(assert true)
(define-fun dynamic_invariant9 ((temp___expr_978 Int) (temp___is_init_975 Bool) (temp___skip_constant_976 Bool) (temp___do_toplevel_977 Bool)) Bool (=> (or (= temp___is_init_975 true) (<= 0 40)) (in_range11 temp___expr_978)))
(define-fun dynamic_invariant10 ((temp___expr_999 Int) (temp___is_init_996 Bool) (temp___skip_constant_997 Bool) (temp___do_toplevel_998 Bool)) Bool (=> (or (= temp___is_init_996 true) (<= 0 4294967295)) (in_range13 temp___expr_999)))
(define-fun dynamic_invariant11 ((temp___expr_1021 Int) (temp___is_init_1018 Bool) (temp___skip_constant_1019 Bool) (temp___do_toplevel_1020 Bool)) Bool (=> (or (= temp___is_init_1018 true) (<= 0 10)) (in_range10 temp___expr_1021)))
(define-fun dynamic_invariant12 ((temp___expr_1033 Int) (temp___is_init_1030 Bool) (temp___skip_constant_1031 Bool) (temp___do_toplevel_1032 Bool)) Bool (=> (or (= temp___is_init_1030 true) (<= 0 4294967295)) (in_range15 temp___expr_1033)))
(define-fun dynamic_invariant13 ((temp___expr_1039 Int) (temp___is_init_1036 Bool) (temp___skip_constant_1037 Bool) (temp___do_toplevel_1038 Bool)) Bool (=> (or (= temp___is_init_1036 true) (<= 0 128)) (in_range16 temp___expr_1039)))
(define-fun dynamic_invariant14 ((temp___expr_560 Int) (temp___is_init_557 Bool) (temp___skip_constant_558 Bool) (temp___do_toplevel_559 Bool)) Bool (=> (or (= temp___is_init_557 true) (<= 1901 2099)) (in_range6 temp___expr_560)))
(define-fun dynamic_invariant15 ((temp___expr_566 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 1 12)) (in_range7 temp___expr_566)))
(define-fun dynamic_invariant16 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 31)) (in_range8 temp___expr_572)))
(define-fun dynamic_invariant17 ((temp___expr_600 Int) (temp___is_init_597 Bool) (temp___skip_constant_598 Bool) (temp___do_toplevel_599 Bool)) Bool (=> (or (= temp___is_init_597 true) (<= 0 86399999)) (in_range9 temp___expr_600)))
(define-fun dynamic_invariant18 ((temp___expr_1433 Int) (temp___is_init_1430 Bool) (temp___skip_constant_1431 Bool) (temp___do_toplevel_1432 Bool)) Bool (=> (or (= temp___is_init_1430 true) (<= 0 4294967295)) (in_range14 temp___expr_1433)))
...
(declare-const enclave__currentadminactivitypossible__result Bool)
(declare-const o Bool)
(declare-const o1 Bool)
(declare-const o2 Bool)
(declare-const result Bool)
(declare-const enclave__currentadminactivitypossible__result1 Bool)
(declare-const enclave__currentadminactivitypossible__result2 Bool)
(declare-const enclave__currentadminactivitypossible__result3 Bool)
(declare-const enclave__currentadminactivitypossible__result4 Bool)
(declare-const enclave__currentadminactivitypossible__result5 Bool)
(assert (in_range17 status))
(assert (in_range1 tokenpresence))
(assert (in_range3 tokentry))
(assert (in_range2 tokenid))
(assert (= enclave__currentadminactivitypossible__result1 enclave__currentadminactivitypossible__result2))
(assert (= enclave__currentadminactivitypossible__result3 enclave__currentadminactivitypossible__result1))
(assert (and (= o (adminactivityinprogress status)) (= (= o true) (in_range19 status))))
(assert (and (= o1 (adminhasdeparted status tokenpresence state tokentry tokenid (us_split_fields__content5 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))) (= (= o1 true) (and (not (= (ispresent tokenpresence state tokentry tokenid (us_split_fields__content5 authcert__split_fields) (us_split_fields__content8 idcert__split_fields)) true)) (in_range18 status)))))
(assert (= o2 (ite (= o1 false) o true)))
(assert (= result enclave__currentadminactivitypossible__result))
(assert (= enclave__currentadminactivitypossible__result1 o2))
(assert (= (mk_bool__ref enclave__currentadminactivitypossible__result4) (mk_bool__ref enclave__currentadminactivitypossible__result2)))
(assert (= enclave__currentadminactivitypossible__result5 enclave__currentadminactivitypossible__result3))
(assert (= enclave__currentadminactivitypossible__result4 true))
(assert (not (in_range18 status)))
(check-sat)
(exit)
