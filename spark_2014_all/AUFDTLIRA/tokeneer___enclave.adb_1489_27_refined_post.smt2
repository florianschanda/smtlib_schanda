...
(define-fun us_split_fields__ref___13__projection ((a us_split_fields__ref2)) us_split_fields4 (us_split_fields__content2 a))
...
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__cryptotypes__keypartt__algorithmid algorithmt) (rec__cryptotypes__keypartt__keyid keyidt) (rec__cryptotypes__keypartt__keylength keylengtht)))))
(define-fun us_split_fields_AlgorithmID__projection ((a us_split_fields6)) algorithmt (rec__cryptotypes__keypartt__algorithmid a))
(define-fun us_split_fields_KeyID__projection ((a us_split_fields6)) keyidt (rec__cryptotypes__keypartt__keyid a))
(define-fun us_split_fields_KeyLength__projection ((a us_split_fields6)) keylengtht (rec__cryptotypes__keypartt__keylength a))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep8 (rec__cryptotypes__keypartt__algorithmid (us_split_fields7 a))) (to_rep8 (rec__cryptotypes__keypartt__algorithmid (us_split_fields7 b)))) (= (to_rep9 (rec__cryptotypes__keypartt__keyid (us_split_fields7 a))) (to_rep9 (rec__cryptotypes__keypartt__keyid (us_split_fields7 b))))) (= (to_rep10 (rec__cryptotypes__keypartt__keylength (us_split_fields7 a))) (to_rep10 (rec__cryptotypes__keypartt__keylength (us_split_fields7 b))))) true false))
...
(declare-datatypes () ((keypartt__ref (mk_keypartt__ref (keypartt__content us_rep3)))))
(define-fun keypartt__ref___projection ((a keypartt__ref)) us_rep3 (keypartt__content a))
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__cert__id__contentst__id us_rep2) (rec__cert__id__contentst__notbefore us_rep) (rec__cert__id__contentst__notafter us_rep) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep1) (rec__cert__id__contentst__subjectpublickey us_rep3)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields8)) us_rep2 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields8)) us_rep (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields8)) us_rep (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields8)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields8)) us_rep1 (rec__cert__id__contentst__subject a))
(define-fun us_split_fields_SubjectPublicKey__projection ((a us_split_fields8)) us_rep3 (rec__cert__id__contentst__subjectpublickey a))
(declare-datatypes () ((us_split_fields__ref4 (mk___split_fields__ref4 (us_split_fields__content4 us_split_fields8)))))
(define-fun us_split_fields__ref___18__projection ((a us_split_fields__ref4)) us_split_fields8 (us_split_fields__content4 a))
(declare-datatypes () ((us_rep4 (mk___rep4 (us_split_fields9 us_split_fields8)))))
(define-fun us_rep___19__projection ((a us_rep4)) us_split_fields8 (us_split_fields9 a))
(define-fun bool_eq5 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__id__contentst__id (us_split_fields9 a)) (rec__cert__id__contentst__id (us_split_fields9 b))) true) (= (bool_eq (rec__cert__id__contentst__notbefore (us_split_fields9 a)) (rec__cert__id__contentst__notbefore (us_split_fields9 b))) true)) (= (bool_eq (rec__cert__id__contentst__notafter (us_split_fields9 a)) (rec__cert__id__contentst__notafter (us_split_fields9 b))) true)) (= (to_rep8 (rec__cert__id__contentst__mechanism (us_split_fields9 a))) (to_rep8 (rec__cert__id__contentst__mechanism (us_split_fields9 b))))) (= (bool_eq2 (rec__cert__id__contentst__subject (us_split_fields9 a)) (rec__cert__id__contentst__subject (us_split_fields9 b))) true)) (= (bool_eq4 (rec__cert__id__contentst__subjectpublickey (us_split_fields9 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields9 b))) true)) true false))
...
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__admintoken__valididcertt__valid Bool) (rec__admintoken__valididcertt__contents us_rep4)))))
(define-fun us_split_fields_Valid__2__projection ((a us_split_fields10)) Bool (rec__admintoken__valididcertt__valid a))
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields10)) us_rep4 (rec__admintoken__valididcertt__contents a))
(declare-datatypes () ((us_split_fields__ref5 (mk___split_fields__ref5 (us_split_fields__content5 us_split_fields10)))))
(define-fun us_split_fields__ref___20__projection ((a us_split_fields__ref5)) us_split_fields10 (us_split_fields__content5 a))
(declare-datatypes () ((us_rep5 (mk___rep5 (us_split_fields11 us_split_fields10)))))
(define-fun us_rep___21__projection ((a us_rep5)) us_split_fields10 (us_split_fields11 a))
(define-fun bool_eq6 ((a us_rep5) (b us_rep5)) Bool (ite (and (= (rec__admintoken__valididcertt__valid (us_split_fields11 a)) (rec__admintoken__valididcertt__valid (us_split_fields11 b))) (= (bool_eq5 (rec__admintoken__valididcertt__contents (us_split_fields11 a)) (rec__admintoken__valididcertt__contents (us_split_fields11 b))) true)) true false))
...
(declare-datatypes () ((valididcertt__ref (mk_valididcertt__ref (valididcertt__content us_rep5)))))
(define-fun valididcertt__ref___projection ((a valididcertt__ref)) us_rep5 (valididcertt__content a))
...
(assert (forall ((x classt)) (! (in_range12 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(define-fun us_rep___projection ((a us_rep6)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq7 ((a us_rep6) (b us_rep6)) Bool (ite (= (to_rep11 (rec__privtypes__clearancet__class (us_split_fields13 a))) (to_rep11 (rec__privtypes__clearancet__class (us_split_fields13 b)))) true false))
...
(assert (forall ((x privileget)) (! (in_range13 (to_rep12 x)) :pattern ((to_rep12 x)))))
(assert (forall ((x Int)) (! (=> (in_range13 x) (= (to_rep12 (of_rep12 x)) x)) :pattern ((to_rep12 (of_rep12 x))))))
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__cert__attr__auth__contentst__id us_rep2) (rec__cert__attr__auth__contentst__notbefore us_rep) (rec__cert__attr__auth__contentst__notafter us_rep) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep2) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep6)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields14)) us_rep2 (rec__cert__attr__auth__contentst__id a))
...
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields14)) us_rep2 (rec__cert__attr__auth__contentst__basecertid a))
(define-fun us_split_fields_Role__projection ((a us_split_fields14)) privileget (rec__cert__attr__auth__contentst__role a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields14)) us_rep6 (rec__cert__attr__auth__contentst__clearance a))
...
(define-fun bool_eq8 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (and (and (= (bool_eq3 (rec__cert__attr__auth__contentst__id (us_split_fields15 a)) (rec__cert__attr__auth__contentst__id (us_split_fields15 b))) true) (= (bool_eq (rec__cert__attr__auth__contentst__notbefore (us_split_fields15 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq (rec__cert__attr__auth__contentst__notafter (us_split_fields15 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep8 (rec__cert__attr__auth__contentst__mechanism (us_split_fields15 a))) (to_rep8 (rec__cert__attr__auth__contentst__mechanism (us_split_fields15 b))))) (= (bool_eq3 (rec__cert__attr__auth__contentst__basecertid (us_split_fields15 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields15 b))) true)) (= (to_rep12 (rec__cert__attr__auth__contentst__role (us_split_fields15 a))) (to_rep12 (rec__cert__attr__auth__contentst__role (us_split_fields15 b))))) (= (bool_eq7 (rec__cert__attr__auth__contentst__clearance (us_split_fields15 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields15 b))) true)) true false))
...
(define-fun contentst__ref___3__projection ((a contentst__ref1)) us_rep7 (contentst__content1 a))
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__admintoken__validauthcertt__valid Bool) (rec__admintoken__validauthcertt__contents us_rep7)))))
(define-fun us_split_fields_Valid__projection ((a us_split_fields16)) Bool (rec__admintoken__validauthcertt__valid a))
(define-fun us_split_fields_Contents__projection ((a us_split_fields16)) us_rep7 (rec__admintoken__validauthcertt__contents a))
...
(define-fun us_rep___20__projection ((a us_rep8)) us_split_fields16 (us_split_fields17 a))
(define-fun bool_eq9 ((a us_rep8) (b us_rep8)) Bool (ite (and (= (rec__admintoken__validauthcertt__valid (us_split_fields17 a)) (rec__admintoken__validauthcertt__valid (us_split_fields17 b))) (= (bool_eq8 (rec__admintoken__validauthcertt__contents (us_split_fields17 a)) (rec__admintoken__validauthcertt__contents (us_split_fields17 b))) true)) true false))
...
(declare-fun ispresent (Int us_private Int Int us_split_fields16 us_split_fields10) Bool)
(declare-fun ispresent__function_guard (Bool Int us_private Int Int us_split_fields16 us_split_fields10) Bool)
(declare-fun adminhasdeparted (Int Int us_private Int Int us_split_fields16 us_split_fields10) Bool)
(declare-fun adminhasdeparted__function_guard (Bool Int Int us_private Int Int us_split_fields16 us_split_fields10) Bool)
...
(define-fun dynamic_invariant ((temp___expr_245 Int) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool) (temp___do_typ_inv_244 Bool)) Bool (=> (or (= temp___is_init_241 true) (<= 0 1)) (in_range14 temp___expr_245)))
...
(define-fun dynamic_invariant1 ((temp___expr_1517 Int) (temp___is_init_1513 Bool) (temp___skip_constant_1514 Bool) (temp___do_toplevel_1515 Bool) (temp___do_typ_inv_1516 Bool)) Bool (=> (or (= temp___is_init_1513 true) (<= 0 4294967295)) (in_range15 temp___expr_1517)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant2 ((temp___expr_1524 Int) (temp___is_init_1520 Bool) (temp___skip_constant_1521 Bool) (temp___do_toplevel_1522 Bool) (temp___do_typ_inv_1523 Bool)) Bool (=> (or (= temp___is_init_1520 true) (<= 0 2)) (in_range16 temp___expr_1524)))
...
(define-fun dynamic_invariant3 ((temp___expr_2867 Int) (temp___is_init_2863 Bool) (temp___skip_constant_2864 Bool) (temp___do_toplevel_2865 Bool) (temp___do_typ_inv_2866 Bool)) Bool (=> (or (= temp___is_init_2863 true) (<= 0 8)) (in_range17 temp___expr_2867)))
...
(define-fun dynamic_invariant5 ((temp___expr_2961 Int) (temp___is_init_2957 Bool) (temp___skip_constant_2958 Bool) (temp___do_toplevel_2959 Bool) (temp___do_typ_inv_2960 Bool)) Bool (=> (or (= temp___is_init_2957 true) (<= 5 8)) (in_range19 temp___expr_2961)))
(define-fun dynamic_invariant6 ((temp___expr_2968 Int) (temp___is_init_2964 Bool) (temp___skip_constant_2965 Bool) (temp___do_toplevel_2966 Bool) (temp___do_typ_inv_2967 Bool)) Bool (=> (or (= temp___is_init_2964 true) (<= 4 8)) (in_range18 temp___expr_2968)))
(define-fun dynamic_invariant7 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 3)) (in_range13 temp___expr_426)))
(define-fun dynamic_invariant8 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range12 temp___expr_440)))
(assert true)
(define-fun dynamic_invariant9 ((temp___expr_1092 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool) (temp___do_typ_inv_1091 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 40)) (in_range5 temp___expr_1092)))
(define-fun dynamic_invariant10 ((temp___expr_1116 Int) (temp___is_init_1112 Bool) (temp___skip_constant_1113 Bool) (temp___do_toplevel_1114 Bool) (temp___do_typ_inv_1115 Bool)) Bool (=> (or (= temp___is_init_1112 true) (<= 0 4294967295)) (in_range7 temp___expr_1116)))
(define-fun dynamic_invariant11 ((temp___expr_1140 Int) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool) (temp___do_typ_inv_1139 Bool)) Bool (=> (or (= temp___is_init_1136 true) (<= 0 10)) (in_range9 temp___expr_1140)))
(define-fun dynamic_invariant12 ((temp___expr_1154 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool) (temp___do_typ_inv_1153 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 4294967295)) (in_range10 temp___expr_1154)))
(define-fun dynamic_invariant13 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 128)) (in_range11 temp___expr_1161)))
(define-fun dynamic_invariant14 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range1 temp___expr_625)))
(define-fun dynamic_invariant15 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range2 temp___expr_632)))
(define-fun dynamic_invariant16 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range3 temp___expr_639)))
(define-fun dynamic_invariant17 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range4 temp___expr_671)))
(define-fun dynamic_invariant18 ((temp___expr_1596 Int) (temp___is_init_1592 Bool) (temp___skip_constant_1593 Bool) (temp___do_toplevel_1594 Bool) (temp___do_typ_inv_1595 Bool)) Bool (=> (or (= temp___is_init_1592 true) (<= 0 4294967295)) (in_range8 temp___expr_1596)))
(assert (not true))
(check-sat)
(exit)
