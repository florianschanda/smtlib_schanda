...
(define-fun dynamic_invariant1 ((temp___expr_1305 Int) (temp___is_init_1302 Bool) (temp___skip_constant_1303 Bool) (temp___do_toplevel_1304 Bool)) Bool (=> (or (= temp___is_init_1302 true) (<= 0 4294967295)) (in_range2 temp___expr_1305)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant2 ((temp___expr_1311 Int) (temp___is_init_1308 Bool) (temp___skip_constant_1309 Bool) (temp___do_toplevel_1310 Bool)) Bool (=> (or (= temp___is_init_1308 true) (<= 0 2)) (in_range3 temp___expr_1311)))
...
(define-fun dynamic_invariant3 ((temp___expr_2612 Int) (temp___is_init_2609 Bool) (temp___skip_constant_2610 Bool) (temp___do_toplevel_2611 Bool)) Bool (=> (or (= temp___is_init_2609 true) (<= 0 8)) (in_range17 temp___expr_2612)))
...
(define-fun dynamic_invariant5 ((temp___expr_2704 Int) (temp___is_init_2701 Bool) (temp___skip_constant_2702 Bool) (temp___do_toplevel_2703 Bool)) Bool (=> (or (= temp___is_init_2701 true) (<= 5 8)) (in_range19 temp___expr_2704)))
(define-fun dynamic_invariant6 ((temp___expr_2710 Int) (temp___is_init_2707 Bool) (temp___skip_constant_2708 Bool) (temp___do_toplevel_2709 Bool)) Bool (=> (or (= temp___is_init_2707 true) (<= 4 8)) (in_range18 temp___expr_2710)))
(define-fun dynamic_invariant7 ((temp___expr_194 Int) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool)) Bool (=> (or (= temp___is_init_191 true) (<= 0 3)) (in_range4 temp___expr_194)))
(define-fun dynamic_invariant8 ((temp___expr_206 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 5)) (in_range5 temp___expr_206)))
(assert true)
(define-fun dynamic_invariant9 ((temp___expr_924 Int) (temp___is_init_921 Bool) (temp___skip_constant_922 Bool) (temp___do_toplevel_923 Bool)) Bool (=> (or (= temp___is_init_921 true) (<= 0 40)) (in_range11 temp___expr_924)))
(define-fun dynamic_invariant10 ((temp___expr_945 Int) (temp___is_init_942 Bool) (temp___skip_constant_943 Bool) (temp___do_toplevel_944 Bool)) Bool (=> (or (= temp___is_init_942 true) (<= 0 4294967295)) (in_range13 temp___expr_945)))
(define-fun dynamic_invariant11 ((temp___expr_967 Int) (temp___is_init_964 Bool) (temp___skip_constant_965 Bool) (temp___do_toplevel_966 Bool)) Bool (=> (or (= temp___is_init_964 true) (<= 0 10)) (in_range10 temp___expr_967)))
(define-fun dynamic_invariant12 ((temp___expr_979 Int) (temp___is_init_976 Bool) (temp___skip_constant_977 Bool) (temp___do_toplevel_978 Bool)) Bool (=> (or (= temp___is_init_976 true) (<= 0 4294967295)) (in_range15 temp___expr_979)))
(define-fun dynamic_invariant13 ((temp___expr_985 Int) (temp___is_init_982 Bool) (temp___skip_constant_983 Bool) (temp___do_toplevel_984 Bool)) Bool (=> (or (= temp___is_init_982 true) (<= 0 128)) (in_range16 temp___expr_985)))
(define-fun dynamic_invariant14 ((temp___expr_510 Int) (temp___is_init_507 Bool) (temp___skip_constant_508 Bool) (temp___do_toplevel_509 Bool)) Bool (=> (or (= temp___is_init_507 true) (<= 1901 2099)) (in_range6 temp___expr_510)))
(define-fun dynamic_invariant15 ((temp___expr_516 Int) (temp___is_init_513 Bool) (temp___skip_constant_514 Bool) (temp___do_toplevel_515 Bool)) Bool (=> (or (= temp___is_init_513 true) (<= 1 12)) (in_range7 temp___expr_516)))
(define-fun dynamic_invariant16 ((temp___expr_522 Int) (temp___is_init_519 Bool) (temp___skip_constant_520 Bool) (temp___do_toplevel_521 Bool)) Bool (=> (or (= temp___is_init_519 true) (<= 1 31)) (in_range8 temp___expr_522)))
(define-fun dynamic_invariant17 ((temp___expr_546 Int) (temp___is_init_543 Bool) (temp___skip_constant_544 Bool) (temp___do_toplevel_545 Bool)) Bool (=> (or (= temp___is_init_543 true) (<= 0 86399999)) (in_range9 temp___expr_546)))
(define-fun dynamic_invariant18 ((temp___expr_1375 Int) (temp___is_init_1372 Bool) (temp___skip_constant_1373 Bool) (temp___do_toplevel_1374 Bool)) Bool (=> (or (= temp___is_init_1372 true) (<= 0 4294967295)) (in_range14 temp___expr_1375)))
