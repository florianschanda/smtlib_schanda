...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 a))) (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 b)))) (and (= (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 a))) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 b)))) (= (bool_eq1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 a)) (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 b))) true))) true false))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (dynamic_invariant2 (length1 this) true false true)) :pattern ((length1 this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (= (length1 this) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length1 this)))))
...
(assert (and (= o (length1 within)) (and (in_range4 o) (= o (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within)))))))
(assert (= o1 (ite (<= k o) true false)))
(assert (= result (ite (<= 1 k) o1 false)))
(assert (= result true))
(assert (not (<= (to_rep1 (first (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k)))
(check-sat)
(exit)
