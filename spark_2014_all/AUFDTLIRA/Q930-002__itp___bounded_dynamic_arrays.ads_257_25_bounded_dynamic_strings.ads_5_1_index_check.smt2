...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (= (length1 this) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length1 this)))))
