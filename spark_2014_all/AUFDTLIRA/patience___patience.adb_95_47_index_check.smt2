...
(assert (= o242 temp___654))
(assert (= temp___655 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o242)))
(assert (and (<= 0 i6) (<= i6 99)))
(assert (= o243 i6))
(assert (= o244 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o243)))
(assert (= temp___657 (to_rep1 o244)))
