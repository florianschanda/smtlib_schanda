...
(assert (= o127 i1))
(assert (= o128 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o127)))
(assert (= o129 (to_rep1 o128)))
(assert (= o130 (ite (<= o129 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o124 i1))
...
(assert (=> (= result23 true) (= o116 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o115))))
(assert (=> (= result23 true) (= temp___681 (to_rep1 o116))))
(assert (=> (= result23 true) (and (<= 0 temp___681) (<= temp___681 99))))
(assert (=> (= result23 true) (= o117 temp___681)))
(assert (=> (= result23 true) (= o118 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o117))))
(assert (=> (= result23 true) (= o119 (to_rep1 o118))))
(assert (=> (= result23 true) (= o120 (- o119 1))))
(assert (=> (= result23 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result23 true) (= o113 i1)))
(assert (=> (= result23 true) (= o114 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o113))))
...
(assert (= o107 temp___684))
(assert (= temp___685 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o107)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o108 i1))
(assert (= o109 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o108)))
(assert (= temp___687 (to_rep1 o109)))
