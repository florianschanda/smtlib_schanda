...
(assert (and (= o70 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 o70)))
(assert (= result12 (ite (in_range4 o70) true false)))
(assert (=> (= result12 true) (and (= o66 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o66))))
(assert (=> (= result12 true) (= result13 (ite (< j o66) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o67 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o68 (get (rec__list_allocator__m__t__allocated model____split_fields3) o67)) (in_range7 o68)))))
...
(assert (=> (= result12 true) (= o62 temp___462)))
(assert (=> (= result12 true) (= o63 (select data3 o62))))
(assert (=> (= result12 true) (= o64 (us_split_fields1 o63))))
(assert (=> (= result12 true) (= o65 (rec__list_allocator__cell__next o64))))
...
(assert (=> (< 1 j) (and (= o61 (get (rec__list_allocator__m__t__allocated model____split_fields3) o60)) (in_range7 o61))))
(assert (=> (not (< 1 j)) (= o61 0)))
(assert (and (= temp___463 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___463)))
