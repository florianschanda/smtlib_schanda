...
(assert (=> (< 1 j4) (and (= o105 (- j4 1)) (in_range2 (- j4 1)))))
(assert (=> (< 1 j4) (and (= o106 (get (rec__list_allocator__m__t__allocated model____split_fields4) o105)) (in_range7 o106))))
(assert (=> (not (< 1 j4)) (= o106 0)))
(assert (and (= temp___430 (get (rec__list_allocator__m__t__allocated model____split_fields4) j4)) (in_range7 temp___430)))
