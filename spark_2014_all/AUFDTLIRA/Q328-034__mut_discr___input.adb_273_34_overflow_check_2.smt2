...
(assert (=> (<= (to_rep1 s__first) (to_rep1 s__last)) (= o18 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1))))
(assert (=> (not (<= (to_rep1 s__first) (to_rep1 s__last))) (= o18 0)))
(assert (and (= o19 o18) (in_range1 o18)))
(assert (=> (<= (to_rep1 v__first) (to_rep1 v__last)) (= o17 (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1))))
(assert (=> (not (<= (to_rep1 v__first) (to_rep1 v__last))) (= o17 0)))
(assert (and (= o20 o17) (in_range1 o17)))
(assert (= o21 (- o20 o19)))
(assert (not (in_range1 o21)))
(check-sat)
(exit)
