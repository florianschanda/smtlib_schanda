...
(assert (=> (and (<= 1 i8) (<= i8 10)) (and (and (=> (<= 1 10) (in_range2 i9)) (forall ((temp___356 Int)) (=> (and (<= 1 temp___356) (<= temp___356 10)) (=> (< i9 temp___356) (= (select cache_v23 temp___356) (select temp___355 temp___356)))))) (and (<= 1 i9) (<= i9 10)))))
