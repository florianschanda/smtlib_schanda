...
(assert (= i8 1))
(assert (=> (and (<= 1 i8) (<= i8 10)) (= temp___398 cache_v2)))
(assert (=> (and (<= 1 i8) (<= i8 10)) (= temp___397 i8)))
...
(assert (=> (and (<= 1 i8) (<= i8 10)) (and (and (=> (<= 1 10) (in_range2 i9)) (forall ((temp___399 Int)) (=> (and (<= 1 temp___399) (<= temp___399 10)) (=> (< i9 temp___399) (= (select cache_v23 temp___399) (select temp___398 temp___399)))))) (and (<= 1 i9) (<= i9 10)))))
