...
(assert (= i11 1))
(assert (=> (and (<= 1 i11) (<= i11 10)) (and (and (= temp___355 cache_v2) (and (= temp___354 i11) (and (and (and (= (to_rep o4) 0) (= o5 (store cache_v2 i11 o4))) (and (= (mk_map__ref result5) (mk_map__ref cache_v2)) (= cache_v22 o5))) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (=> (<= k i12) (= (to_rep (select cache_v23 k)) 0)))) (and (and (and (=> (<= 1 10) (in_range2 i12)) (forall ((temp___356 Int)) (=> (and (<= 1 temp___356) (<= temp___356 10)) (=> (< i12 temp___356) (= (select cache_v23 temp___356) (select temp___355 temp___356)))))) (and (<= 1 i12) (<= i12 10))) (= i12 10)))))) (and (and (= i18 (mk_int__ref i12)) (= cache_v29 (mk_map__ref cache_v23))) (and (= i19 i12) (= cache_v210 cache_v23))))))
(assert (=> (and (<= 1 i11) (<= i11 10)) (= i20 i18)))
(assert (=> (and (<= 1 i11) (<= i11 10)) (= cache_v211 cache_v29)))
(assert (=> (and (<= 1 i11) (<= i11 10)) (= i21 i19)))
(assert (=> (and (<= 1 i11) (<= i11 10)) (= cache_v212 cache_v210)))
(assert (=> (not (and (<= 1 i11) (<= i11 10))) (= i20 (mk_int__ref i11))))
(assert (=> (not (and (<= 1 i11) (<= i11 10))) (= cache_v211 (mk_map__ref cache_v2))))
(assert (=> (not (and (<= 1 i11) (<= i11 10))) (= i21 i11)))
(assert (=> (not (and (<= 1 i11) (<= i11 10))) (= cache_v212 cache_v21)))
(assert (= i23 i20))
(assert (= i22 (mk_int__ref i9)))
(assert (= cache_v213 cache_v211))
(assert (= cache_v111 (mk_map__ref cache_v19)))
(assert (= i25 i21))
(assert (= i24 i10))
(assert (= cache_v214 cache_v212))
(assert (= cache_v112 cache_v110))
(assert (= (of_int 1) true))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k 10))
(assert (not (= (to_rep (select (map__content cache_v111) k)) (to_rep (select (map__content cache_v213) k)))))
(check-sat)
(exit)
