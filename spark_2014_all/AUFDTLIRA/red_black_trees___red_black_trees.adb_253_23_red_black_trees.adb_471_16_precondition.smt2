...
(declare-const temp___810 (Array Int us_rep7))
...
(assert (and (= temp___810 (nb_blacks c94b)) (and (= (bool_eq11 (select temp___810 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c94b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___810 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___810 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___810 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___810 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___810 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___810 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___810 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___810 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___810 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c94b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___810 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c94b)) i1 0))))))))))))))
(assert (= o45 (select temp___810 i)))
