...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (f us_void_param) true false true) :pattern ((f us_void_param)))))
...
(assert (forall ((temp___178 Int) (temp___179 Int) (temp___180 Int)) (let ((temp___177 (dyn__x__aggregate_def temp___178 temp___179 temp___180))) (and (=> (dynamic_property4 1 2147483647 temp___179 temp___180) (and (= (first3 temp___177) temp___179) (= (last3 temp___177) temp___180))) (forall ((temp___181 Int)) (= (select (to_array1 temp___177) temp___181) (of_rep temp___178)))))))
...
(define-fun dynamic_invariant3 ((temp___expr_171 us_t) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (=> (not (= temp___skip_constant_169 true)) (and (dynamic_property1 r1b r2b (first1 temp___expr_171) (last1 temp___expr_171)) (and (= (first1 temp___expr_171) r1b) (= (last1 temp___expr_171) r2b)))))
...
(assert (= o1 (- o 1)))
(assert (and (= dyn__R3b__assume o1) (in_range o1)))
(assert (= dyn__R3b__assume r3b))
(assert (in_range r3b))
(assert (not (in_range1 r3b)))
(check-sat)
(exit)
