...
(assert (=> (< 0 e) (= o9 (temp___1904 o8 i o7))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o5 (+ k 1))))
(assert (=> (< 0 e) (= o10 (select a o5))))
(assert (=> (< 0 e) (= o11 (temp___1897 o10 j o9))))
(assert (=> (< 0 e) (and (= o12 (+ k 1)) (in_range3 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5571 (temp___1874 a k (temp___1882 (select a k) j (temp___1889 (select (select a k) j) i e)) o12 o11))))
