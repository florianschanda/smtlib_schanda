...
(assert (and (= o12 (- length2 j2)) (in_range1 (- length2 j2))))
(assert (and (= o13 o12) (in_range2 o12)))
(assert (and (= o11 (+ i2 j2)) (in_range1 (+ i2 j2))))
(assert (and (= o8 (+ a_first length1)) (in_range1 (+ a_first length1))))
(assert (= o9 (+ o8 j2)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (and (= o7 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (= o14 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) o7 o10 o11 o13)))
(assert (and (= o4 (- length1 i2)) (in_range1 (- length1 i2))))
(assert (and (= o5 o4) (in_range2 o4)))
(assert (and (= o3 (+ i2 j2)) (in_range1 (+ i2 j2))))
(assert (and (= o2 (+ a_first i2)) (in_range1 (+ a_first i2))))
(assert (and (= o1 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (= o6 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) o1 o2 o3 o5)))
