...
(assert (and (= o29 (- length2 j2)) (in_range1 (- length2 j2))))
(assert (and (= o30 o29) (in_range2 o29)))
(assert (and (= o28 (+ i2 j2)) (in_range1 (+ i2 j2))))
(assert (and (= o25 (+ a_first length1)) (in_range1 (+ a_first length1))))
(assert (= o26 (+ o25 j2)))
(assert (and (= o27 o26) (in_range1 o26)))
(assert (and (= o24 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (= o31 (le_array (mk___t b1 (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) o24 o27 o28 o30)))
(assert (and (= o21 (- length1 i2)) (in_range1 (- length1 i2))))
(assert (and (= o22 o21) (in_range2 o21)))
(assert (and (= o20 (+ i2 j2)) (in_range1 (+ i2 j2))))
(assert (and (= o19 (+ a_first i2)) (in_range1 (+ a_first i2))))
(assert (and (= o18 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (= o23 (le_array (mk___t b1 (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) o18 o19 o20 o22)))
(assert (and (= o16 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (not (in_range1 (+ a_first length1))))
(check-sat)
(exit)
