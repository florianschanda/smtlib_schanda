...
(define-fun dynamic_invariant1 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 1)) (in_range2 temp___expr_207)))
(define-fun dynamic_invariant2 ((temp___expr_154 Int) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (or (= temp___is_init_151 true) (<= 1 10000)) (in_range1 temp___expr_154)))
(assert (in_range res))
(assert (not (= res 0)))
(assert (not (<= 1 res)))
(check-sat)
