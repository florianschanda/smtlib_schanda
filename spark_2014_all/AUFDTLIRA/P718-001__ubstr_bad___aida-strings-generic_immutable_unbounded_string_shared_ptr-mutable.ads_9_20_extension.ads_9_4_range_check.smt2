...
(define-fun default_initial_assumption ((temp___expr_871 us_rep) (temp___skip_top_level_872 Bool)) Bool (=> (not (= temp___skip_top_level_872 true)) (= (length1 temp___expr_871) 0)))
