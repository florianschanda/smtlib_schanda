...
(define-fun mutable_t__ref___2__projection ((a mutable_t__ref)) us_rep (mutable_t__content a))
...
(define-fun default_initial_assumption ((temp___expr_825 us_rep) (temp___skip_top_level_826 Bool)) Bool (=> (not (= temp___skip_top_level_826 true)) (= (length1 temp___expr_825) 0)))
