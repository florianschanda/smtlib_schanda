...
(declare-fun temp___468 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___470 (Array Int integer))) (forall ((temp___471 Int) (temp___472 Int)) (let ((temp___469 (temp___468 temp___470 temp___471 temp___472))) (forall ((temp___473 Int)) (ite (= temp___473 temp___471) (= (select temp___469 temp___473) (of_rep temp___472)) (= (select temp___469 temp___473) (select temp___470 temp___473))))))))
(declare-fun temp___475 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___477 (Array Int integer))) (forall ((temp___478 Int) (temp___479 Int)) (let ((temp___476 (temp___475 temp___477 temp___478 temp___479))) (forall ((temp___480 Int)) (ite (= temp___480 temp___478) (= (select temp___476 temp___480) (of_rep temp___479)) (= (select temp___476 temp___480) (select temp___477 temp___480))))))))
(assert (in_range1 i))
...
(assert (= (bool_eq d (- 2147483648) 2147483647 (temp___475 c i 42) (- 2147483648) 2147483647) true))
(assert (= (bool_eq b (- 2147483648) 2147483647 d (- 2147483648) 2147483647) true))
(assert (not (= (to_rep (select a i)) (to_rep (select (temp___468 a i 42) i)))))
(check-sat)
(exit)
