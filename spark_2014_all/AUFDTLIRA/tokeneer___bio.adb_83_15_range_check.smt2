...
(define-fun dynamic_invariant ((temp___expr_294 us_t1) (temp___is_init_291 Bool) (temp___skip_constant_292 Bool) (temp___do_toplevel_293 Bool)) Bool (and (=> (not (= temp___skip_constant_292 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_294) (last3 temp___expr_294))) (=> (= temp___do_toplevel_293 true) (=> (= temp___is_init_291 true) (and (let ((temp___296 (of_array2 (to_array1 temp___expr_294) (first3 temp___expr_294) (last3 temp___expr_294)))) (and (= (first5 temp___296) 1) (<= 0 (last5 temp___296)))) (<= (last3 temp___expr_294) 1000))))))
...
(define-fun dynamic_invariant1 ((temp___expr_1266 Int) (temp___is_init_1263 Bool) (temp___skip_constant_1264 Bool) (temp___do_toplevel_1265 Bool)) Bool (=> (or (= temp___is_init_1263 true) (<= 0 16)) (in_range3 temp___expr_1266)))
(declare-const x Int)
...
(declare-const temp___1349 (Array Int character))
(declare-const temp___13491 t1)
(assert (in_range3 x))
