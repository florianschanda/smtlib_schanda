...
(define-fun dynamic_invariant1 ((temp___expr_1418 Int) (temp___is_init_1414 Bool) (temp___skip_constant_1415 Bool) (temp___do_toplevel_1416 Bool) (temp___do_typ_inv_1417 Bool)) Bool (=> (or (= temp___is_init_1414 true) (<= 0 16)) (in_range3 temp___expr_1418)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_296 us_t2) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool (and (=> (not (= temp___skip_constant_293 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_296) (last5 temp___expr_296))) (=> (= temp___do_toplevel_294 true) (=> (= temp___is_init_292 true) (and (= (first5 temp___expr_296) 1) (<= 0 (last5 temp___expr_296)))))))
