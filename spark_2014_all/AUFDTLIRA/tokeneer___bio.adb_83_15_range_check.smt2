...
(define-fun dynamic_invariant ((temp___expr_282 us_t1) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool)) Bool (and (=> (not (= temp___skip_constant_280 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_282) (last3 temp___expr_282))) (=> (= temp___do_toplevel_281 true) (=> (= temp___is_init_279 true) (and (= (first5 (of_array2 (to_array1 temp___expr_282) (first3 temp___expr_282) (last3 temp___expr_282))) 1) (<= (last3 temp___expr_282) 1000))))))
(define-fun dynamic_predicate ((temp___286 us_t1)) Bool (and (= (first5 (of_array2 (to_array1 temp___286) (first3 temp___286) (last3 temp___286))) 1) (<= (last3 temp___286) 1000)))
...
(define-fun dynamic_invariant1 ((temp___expr_1210 Int) (temp___is_init_1207 Bool) (temp___skip_constant_1208 Bool) (temp___do_toplevel_1209 Bool)) Bool (=> (or (= temp___is_init_1207 true) (<= 0 16)) (in_range3 temp___expr_1210)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_260 us_t2) (temp___is_init_257 Bool) (temp___skip_constant_258 Bool) (temp___do_toplevel_259 Bool)) Bool (and (=> (not (= temp___skip_constant_258 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_260) (last5 temp___expr_260))) (=> (= temp___do_toplevel_259 true) (=> (= temp___is_init_257 true) (= (first5 temp___expr_260) 1)))))
(define-fun dynamic_predicate1 ((temp___263 us_t2)) Bool (= (first5 temp___263) 1))
(declare-const temp___1293 (Array Int character))
(declare-const temp___12931 t1)
(assert (in_range3 x))
