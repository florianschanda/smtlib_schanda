...
(assert (and (= this__attr__tag us_tag) (and (= (to_rep2 this__split_fields) 0) (= this__split_fields1 (temp___178 0)))))
...
(assert (= this__split_fields9 (mk___split_fields__ref (mk___split_fields this__split_fields6 this__split_fields7 this__split_fields8))))
(assert (= fixed_stream__create__result14 fixed_stream__create__result12))
(assert (= this__split_fields10 (mk___split_fields this__split_fields6 this__split_fields7 this__split_fields8)))
