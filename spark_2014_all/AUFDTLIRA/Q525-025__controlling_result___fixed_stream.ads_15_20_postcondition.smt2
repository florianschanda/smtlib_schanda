...
(assert (forall ((temp___204 Int)) (=> (dynamic_invariant3 temp___204 true true true true) (forall ((temp___205 Int)) (= (to_rep (select (temp___202 temp___204) temp___205)) temp___204)))))
...
(assert (and (= this__attr__tag us_tag) (and (= (to_rep2 this__split_fields) 0) (= this__split_fields1 (temp___202 0)))))
