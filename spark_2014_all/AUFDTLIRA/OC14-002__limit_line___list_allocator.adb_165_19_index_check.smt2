...
(assert (=> (= result35 true) (and (= o127 (+ j9 1)) (in_range1 (+ j9 1)))))
(assert (=> (= result35 true) (and (= o128 (get (rec__list_allocator__m__t__allocated model____split_fields4) o127)) (in_range7 o128))))
(assert (=> (not (= result35 true)) (= o128 0)))
(assert (and (= temp___409 (get (rec__list_allocator__m__t__allocated model____split_fields4) j9)) (in_range7 temp___409)))
(assert (not (<= 1 temp___409)))
(check-sat)
(exit)
