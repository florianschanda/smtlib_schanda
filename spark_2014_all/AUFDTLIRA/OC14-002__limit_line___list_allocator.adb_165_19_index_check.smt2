...
(assert (=> (= result12 true) (and (= o47 (get (rec__list_allocator__m__t__allocated model____split_fields3) o46)) (in_range7 o47))))
(assert (=> (not (= result12 true)) (= o47 0)))
(assert (and (= temp___409 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 temp___409)))
