...
(assert (<= i3 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= result12 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i3)) (and (= (= result12 true) (and (<= i3 (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i3)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) i3) (not (= result12 true))))))
