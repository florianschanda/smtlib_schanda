...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__const__t__k (us_split_discrs1 a))) (to_rep1 (rec__const__t__k (us_split_discrs1 b)))) (= (to_rep (rec__const__t__som (us_split_fields1 a))) (to_rep (rec__const__t__som (us_split_fields1 b))))) (= (bool_eq1 (rec__const__t__arr (us_split_fields1 a)) (rec__const__t__arr (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_149 us_rep) (temp___is_init_146 Bool) (temp___skip_constant_147 Bool) (temp___do_toplevel_148 Bool)) Bool (let ((temp___150 (rec__const__t__k (us_split_discrs1 temp___expr_149)))) (and (dynamic_property1 1 (to_rep1 temp___150) (first1 (rec__const__t__arr (us_split_fields1 temp___expr_149))) (last1 (rec__const__t__arr (us_split_fields1 temp___expr_149)))) (and (= (first1 (rec__const__t__arr (us_split_fields1 temp___expr_149))) 1) (= (last1 (rec__const__t__arr (us_split_fields1 temp___expr_149))) (to_rep1 temp___150))))))
(declare-const x us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant2 ((temp___expr_138 Int) (temp___is_init_135 Bool) (temp___skip_constant_136 Bool) (temp___do_toplevel_137 Bool)) Bool (=> (or (= temp___is_init_135 true) (<= 1 10)) (in_range1 temp___expr_138)))
(declare-const z Int)
