...
(assert (<= 1 (to_rep2 (rec__fixed_string__object__width (us_split_fields1 this)))))
(assert (not (<= (to_rep2 (rec__fixed_string__object__width (us_split_fields1 this))) 2147483647)))
(check-sat)
(exit)
