...
(assert (and (= (length source) 6) (forall ((index4 Int)) (=> (and (<= (to_rep1 (first (rt source))) index4) (<= index4 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index4))) true)))))
...
(assert (and (and (forall ((temp___1760 Int)) (=> (and (<= (to_rep1 n__first) temp___1760) (<= temp___1760 (to_rep1 n__last))) (=> (< index2 temp___1760) (= (select n3 temp___1760) (select n1 temp___1760))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 5)))))
(assert (not (= index2 temp___1763)))
