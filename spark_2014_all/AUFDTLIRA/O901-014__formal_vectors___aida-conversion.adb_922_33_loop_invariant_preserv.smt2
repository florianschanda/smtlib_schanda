...
(assert (and (and (forall ((temp___1658 Int)) (=> (and (<= (to_rep1 n__first) temp___1658) (<= temp___1658 (to_rep1 n__last))) (=> (< index3 temp___1658) (= (select n3 temp___1658) (select n1 temp___1658))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 5)))))
(assert (not (= index3 temp___1661)))
