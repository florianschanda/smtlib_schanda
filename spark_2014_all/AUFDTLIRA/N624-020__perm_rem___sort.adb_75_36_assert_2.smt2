...
(assert (= hr5 o30))
(assert (not (= (let ((temp___261 (remove (remove (mk___t values2 (mk 1 100)) x) (- y 1)))) (let ((temp___260 (remove (remove (mk___t init (mk 1 100)) x) (- y 1)))) (bool_eq (elts temp___260) (to_rep1 (first (rt temp___260))) (to_rep1 (last (rt temp___260))) (elts temp___261) (to_rep1 (first (rt temp___261))) (to_rep1 (last (rt temp___261)))))) true)))
(check-sat)
(exit)
