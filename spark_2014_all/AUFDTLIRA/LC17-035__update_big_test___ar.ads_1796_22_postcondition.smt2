...
(assert (forall ((temp___4019 (Array Int us_rep))) (forall ((temp___4020 Int)) (forall ((temp___4021 us_rep)) (let ((temp___4018 (temp___4017 temp___4019 temp___4020 temp___4021))) (forall ((temp___4022 Int)) (ite (= temp___4022 temp___4020) (= (select temp___4018 temp___4022) temp___4021) (= (select temp___4018 temp___4022) (select temp___4019 temp___4022)))))))))
...
(assert (= r__split_fields9 (mk___split_fields1 temp___9399 temp___93991 temp___93992)))
(assert (= r__split_fields10 (mk___split_fields__ref1 r__split_fields9)))
(assert (= r__split_fields11 r__split_fields9))
(assert (not (= (bool_eq2 (mk___rep1 (us_split_fields__content1 r__split_fields10)) (mk___rep1 (mk___split_fields1 (temp___4017 r__split_fields i (mk___rep (mk___split_fields (of_rep e) (of_rep1 f)))) (of_int 1) r__split_fields2))) true)))
(check-sat)
(exit)
