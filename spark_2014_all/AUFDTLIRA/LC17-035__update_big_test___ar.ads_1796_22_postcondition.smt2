...
(declare-fun temp___4076 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
...
(assert (not (= (bool_eq2 (mk___rep1 (us_split_fields__content1 r__split_fields10)) (mk___rep1 (mk___split_fields1 (temp___4076 r__split_fields i (mk___rep (mk___split_fields (of_rep e) (of_rep1 f)))) (distinct 1 0) r__split_fields2))) true)))
(check-sat)
(exit)
