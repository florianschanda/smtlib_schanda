...
(declare-fun temp_____aggregate_def_4076 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
...
(assert (forall ((temp___4078 (Array Int us_rep))) (forall ((temp___4079 Int)) (forall ((temp___4080 us_rep)) (let ((temp___4077 (temp_____aggregate_def_4076 temp___4078 temp___4079 temp___4080))) (=> (dynamic_invariant temp___4079 true true true true) (forall ((temp___4081 Int)) (ite (= temp___4081 temp___4079) (= (select temp___4077 temp___4081) temp___4080) (= (select temp___4077 temp___4081) (select temp___4078 temp___4081))))))))))
...
(declare-const temp___9451 (Array Int us_rep))
(declare-const temp___94511 Bool)
(declare-const temp___94512 enum1t)
...
(declare-const temp___9458 (Array Int us_rep))
(declare-const temp___94581 Bool)
(declare-const temp___94582 enum1t)
...
(assert (= temp___9451 o6))
(assert (= temp___94511 o7))
(assert (= temp___94512 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= temp___9451 r__split_fields3))
(assert (= temp___94511 r__split_fields4))
(assert (= temp___94512 r__split_fields5))
...
(assert (= temp___9458 o15))
(assert (= temp___94581 o16))
(assert (= temp___94582 o17))
(assert (= result6 r__split_fields6))
(assert (= result7 r__split_fields7))
(assert (= result8 r__split_fields8))
(assert (= r__split_fields9 (mk___split_fields1 temp___9458 temp___94581 temp___94582)))
(assert (= r__split_fields10 (mk___split_fields__ref1 r__split_fields9)))
(assert (= r__split_fields11 r__split_fields9))
(assert (not (= (bool_eq2 (mk___rep1 (us_split_fields__content1 r__split_fields10)) (mk___rep1 (mk___split_fields1 (temp_____aggregate_def_4076 r__split_fields i (mk___rep (mk___split_fields (of_rep e) (of_rep1 f)))) (distinct 1 0) r__split_fields2))) true)))
(check-sat)
(exit)
