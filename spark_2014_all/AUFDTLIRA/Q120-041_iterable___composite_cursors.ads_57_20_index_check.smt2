...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__composite_cursors__rec_cursor__content (us_split_fields1 a))) (to_rep (rec__composite_cursors__rec_cursor__content (us_split_fields1 b)))) true false))
...
(declare-fun user_eq2 (t13s t13s) Bool)
(declare-const dummy2 t13s)
...
(define-fun dynamic_invariant ((temp___expr_201 us_rep1) (temp___is_init_198 Bool) (temp___skip_constant_199 Bool) (temp___do_toplevel_200 Bool)) Bool (=> (= temp___do_toplevel_200 true) (=> (= temp___is_init_198 true) (<= (to_rep (rec__composite_cursors__cont2__length (us_split_fields3 temp___expr_201))) 100))))
(define-fun dynamic_predicate ((temp___210 us_rep1)) Bool (<= (to_rep (rec__composite_cursors__cont2__length (us_split_fields3 temp___210))) 100))
