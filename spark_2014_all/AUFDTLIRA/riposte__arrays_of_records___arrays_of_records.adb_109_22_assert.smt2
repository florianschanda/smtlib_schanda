...
(define-fun dynamic_invariant ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= (- 23) 69)) (in_range1 temp___expr_173)))
...
(assert (= (to_rep o) 69))
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a 23))) o1))
(assert (= (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a 23))) o2))
(assert (= o o3))
(assert (= o4 o1))
(assert (= o5 o2))
(assert (= o6 o3))
(assert (= o7 (store a 23 (mk___rep (mk___split_fields o4 o5 o6)))))
(assert (= (mk_map__ref result) (mk_map__ref a)))
(assert (= a1 o7))
(assert (= (to_rep o8) 42))
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a1 17))) o9))
(assert (= o8 o10))
(assert (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a1 17))) o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= o14 o11))
(assert (= o15 (store a1 17 (mk___rep (mk___split_fields o12 o13 o14)))))
(assert (= a1 result1))
(assert (= a2 o15))
(assert (= (to_rep o16) 23))
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 17))) o17))
(assert (= o16 o18))
(assert (= (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a2 17))) o19))
(assert (= o20 o17))
(assert (= o21 o18))
(assert (= o22 o19))
(assert (= o23 (store a2 17 (mk___rep (mk___split_fields o20 o21 o22)))))
(assert (= a2 result2))
(assert (= a3 o23))
(assert (= a3 result3))
(assert (= a4 (store a3 5 (mk___rep (mk___split_fields (distinct 0 0) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a3 5))) (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a3 5))))))))
(assert (not (= (to_rep (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a4 23)))) 69)))
(check-sat)
(exit)
