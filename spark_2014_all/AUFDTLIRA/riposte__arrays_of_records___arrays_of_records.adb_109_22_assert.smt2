...
(assert (= a1 (store a 23 (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a 23))) (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a 23))) rliteral)))))
(assert (= a1 result1))
(assert (= a2 (store a1 17 (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a1 17))) rliteral1 (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a1 17))))))))
(assert (= a2 result2))
(assert (= a3 (store a2 17 (mk___rep (mk___split_fields (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 17))) rliteral2 (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a2 17))))))))
(assert (= a3 result3))
