...
(assert (= (mk___t1 temp___942 temp___9421) (mk___t1 temp___940 temp___9401)))
(assert (= temp___942 o4))
(assert (= (mk (to_rep2 (first2 temp___9421)) (to_rep2 (last2 temp___9421))) o5))
(assert (= (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3) o6))
(assert (= o7 o4))
(assert (= o8 o5))
(assert (= this__split_discrs (mk___split_discrs temp___944)))
(assert (= temp___9441 o6))
(assert (= temp___9442 o7))
(assert (= temp___9443 o8))
(assert (dynamic_predicate (mk___rep (mk___split_discrs temp___944) (mk___split_fields temp___9441 (mk___t temp___9442 temp___9443)))))
(assert (= temp___945 (mk___rep (mk___split_discrs temp___944) (mk___split_fields temp___9441 (mk___t temp___9442 temp___9443)))))
(assert (= result1 (mk___split_fields__ref this__split_fields3)))
(assert (= this__split_fields4 (us_split_fields1 temp___945)))
(assert (= this__split_discrs (us_split_discrs1 temp___945)))
