...
(declare-const temp___1005 (Array Int character))
(declare-const temp___10051 t1)
(declare-const o4 (Array Int character))
(declare-const o5 t)
(declare-const o6 natural_index)
(declare-const o7 (Array Int character))
(declare-const o8 t)
(declare-const temp___1007 natural_index)
(declare-const temp___10071 natural_index)
(declare-const temp___10072 (Array Int character))
(declare-const temp___10073 t)
...
(define-fun temp___10074 () us_rep (mk___rep (mk___split_discrs temp___1007) (mk___split_fields temp___10071 (mk___t temp___10072 temp___10073))))
...
(assert (= (mk___t1 temp___1005 temp___10051) (mk___t1 temp___1003 temp___10031)))
(assert (= temp___1005 o4))
(assert (= (mk (to_rep2 (first2 temp___10051)) (to_rep2 (last2 temp___10051))) o5))
(assert (= (rec__bounded_dynamic_strings__sequence__current_length this__split_fields3) o6))
(assert (= o7 o4))
(assert (= o8 o5))
(assert (= this__split_discrs (mk___split_discrs temp___1007)))
(assert (= temp___10071 o6))
(assert (= temp___10072 o7))
(assert (= temp___10073 o8))
(assert (dynamic_predicate temp___10074))
(assert (= temp___1008 temp___10074))
(assert (= result1 (mk___split_fields__ref this__split_fields3)))
(assert (= this__split_fields4 (us_split_fields1 temp___1008)))
(assert (= this__split_discrs (us_split_discrs1 temp___1008)))
