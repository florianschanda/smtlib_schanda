...
(assert (and (= temp___715 (nb_blacks c106b)) (and (= (bool_eq11 (select temp___715 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___715 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___715 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___715 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___715 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___715 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___715 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___715 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___715 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___715 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c106b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___715 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i14 0))))))))))))))
(assert (= o364 (select temp___715 y3)))
(assert (= o365 (us_split_fields11 o364)))
(assert (= o366 (rec__red_black_trees__black_count__count o365)))
(assert (= o367 (to_rep o366)))
(assert (and (= temp___714 (nb_blacks c107b)) (and (= (bool_eq11 (select temp___714 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c107b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___714 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___714 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___714 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___714 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___714 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___714 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___714 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___714 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___714 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c107b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___714 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 0))))))))))))))
(assert (= o361 (select temp___714 c108b)))
(assert (= o362 (us_split_fields11 o361)))
(assert (= o363 (rec__red_black_trees__black_count__count o362)))
(assert (= o368 (to_rep o363)))
(assert (= o369 (ite (= o368 o367) true false)))
