...
(declare-const temp___764 (Array Int us_rep7))
...
(assert (and (= temp___764 (nb_blacks c106b)) (and (= (bool_eq11 (select temp___764 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___764 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___764 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___764 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___764 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___764 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___764 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___764 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___764 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___764 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c106b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___764 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))))))))))))
(assert (= o57 (select temp___764 y3)))
(assert (= o58 (us_split_fields11 o57)))
(assert (= o59 (rec__red_black_trees__black_count__count o58)))
(assert (= o60 (to_rep o59)))
(assert (and (= temp___763 (nb_blacks c107b)) (and (= (bool_eq11 (select temp___763 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c107b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___763 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___763 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___763 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c107b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___763 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))))))))
(assert (= o54 (select temp___763 c108b)))
