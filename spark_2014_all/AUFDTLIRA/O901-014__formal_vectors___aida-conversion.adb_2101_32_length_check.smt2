...
(assert (not (= (ite (<= (to_rep1 (first8 temp___24431)) (to_rep1 (last8 temp___24431))) (+ (- (to_rep1 (last8 temp___24431)) (to_rep1 (first8 temp___24431))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5)) (+ (- (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 1)) 1) 0))))
(check-sat)
(exit)
