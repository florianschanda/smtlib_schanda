...
(assert (and (= o (first (mk___rep g__split_fields6))) (and (in_range2 o) (= o 1))))
(assert (= o temp___286))
(assert (and (= result2 (has_element (mk___rep g__split_fields6) temp___286)) (= (= result2 true) (in_range3 temp___286))))
(assert (=> (= result2 true) (and (= o1 (element (mk___rep g__split_fields6) temp___286)) (and (in_range1 o1) (= o1 (to_rep (select g__split_fields1 temp___286)))))))
(assert (=> (= result2 true) (= result3 e)))
(assert (=> (= result2 true) (= e2 o1)))
(assert (=> (not (= result2 true)) (= e2 e)))
(assert (=> (not (= result2 true)) (= e2 e1)))
(assert (and (= result4 (has_element (mk___rep g__split_fields6) temp___286)) (= (= result4 true) (in_range3 temp___286))))
(assert (= result4 true))
(assert (and (= (has_element (mk___rep g__split_fields5) temp___2861) true) (= e3 (element (mk___rep g__split_fields5) temp___2861))))
(assert (= e3 0))
(assert (and (= o2 (next (mk___rep g__split_fields4) temp___2861)) (and (in_range2 o2) (= o2 (ite (= temp___2861 100) 0 (+ temp___2861 1))))))
(assert (and (= o3 (has_element (mk___rep g__split_fields4) o2)) (= (= o3 true) (in_range3 o2))))
(assert (= result5 (ite (not (= o3 true)) true false)))
(assert (not (= result5 true)))
(assert (not (= (has_element (mk___rep g__split_fields4) temp___2861) true)))
(check-sat)
(exit)
