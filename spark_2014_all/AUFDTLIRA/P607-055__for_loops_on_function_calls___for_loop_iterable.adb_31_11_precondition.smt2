...
(assert (and (= o (first (mk___rep (mk___split_fields g__split_fields1)))) (and (in_range3 o) (= o 1))))
(assert (= o temp___253))
(assert (and (= result2 (has_element (mk___rep (mk___split_fields g__split_fields1)) temp___253)) (= (= result2 true) (in_range2 temp___253))))
(assert (=> (= result2 true) (and (= o1 (element (mk___rep (mk___split_fields g__split_fields1)) temp___253)) (and (in_range1 o1) (= o1 (to_rep (select g__split_fields1 temp___253)))))))
(assert (=> (= result2 true) (= result3 e)))
(assert (=> (= result2 true) (= e2 o1)))
(assert (=> (not (= result2 true)) (= e2 e)))
(assert (=> (not (= result2 true)) (= e2 e1)))
(assert (and (= result4 (has_element (mk___rep (mk___split_fields g__split_fields1)) temp___253)) (= (= result4 true) (in_range2 temp___253))))
(assert (= result4 true))
(assert (and (= (has_element (mk___rep (mk___split_fields g__split_fields2)) temp___2531) true) (= e3 (element (mk___rep (mk___split_fields g__split_fields2)) temp___2531))))
(assert true)
(assert (= e3 0))
(assert (and (= o2 (next (mk___rep (mk___split_fields g__split_fields3)) temp___2531)) (and (in_range3 o2) (= o2 (ite (= temp___2531 100) 0 (+ temp___2531 1))))))
(assert (and (= o3 (has_element (mk___rep (mk___split_fields g__split_fields3)) o2)) (= (= o3 true) (in_range2 o2))))
(assert (= result5 (ite (not (= o3 true)) true false)))
(assert (not (= result5 true)))
(assert (not (= (has_element (mk___rep (mk___split_fields g__split_fields3)) temp___2531) true)))
(check-sat)
(exit)
