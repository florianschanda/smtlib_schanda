...
(assert (forall ((temp___281 Int)) (=> (dynamic_invariant1 temp___281 true true true true) (forall ((temp___282 Int)) (= (select (for_loop_iterable__p3__a__aggregate_def temp___281) temp___282) rliteral)))))
...
(define-fun g__split_fields4 () us_split_fields (mk___split_fields g__split_fields2))
(define-fun g__split_fields5 () us_split_fields (mk___split_fields g__split_fields1))
(assert (= result a))
...
(assert (and (= o (first (mk___rep g__split_fields5))) (and (in_range2 o) (= o 1))))
(assert (= o temp___286))
(assert (and (= result2 (has_element (mk___rep g__split_fields5) temp___286)) (= (= result2 true) (in_range3 temp___286))))
(assert (=> (= result2 true) (and (= o1 (element (mk___rep g__split_fields5) temp___286)) (and (in_range1 o1) (= o1 (to_rep (select g__split_fields1 temp___286)))))))
(assert (=> (= result2 true) (= result3 e)))
(assert (=> (= result2 true) (= e2 o1)))
(assert (=> (not (= result2 true)) (= e2 e)))
(assert (=> (not (= result2 true)) (= e2 e1)))
(assert (and (= result4 (has_element (mk___rep g__split_fields5) temp___286)) (= (= result4 true) (in_range3 temp___286))))
(assert (= result4 true))
(assert (and (= (has_element (mk___rep g__split_fields4) temp___2861) true) (= e3 (element (mk___rep g__split_fields4) temp___2861))))
(assert (= e3 0))
(assert (not (= (has_element (mk___rep (mk___split_fields g__split_fields3)) temp___2861) true)))
(check-sat)
(exit)
