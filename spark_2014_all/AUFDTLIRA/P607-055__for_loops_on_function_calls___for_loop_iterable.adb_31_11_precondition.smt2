...
(define-fun dynamic_invariant ((temp___expr_161 Int) (temp___is_init_158 Bool) (temp___skip_constant_159 Bool) (temp___do_toplevel_160 Bool)) Bool (=> (or (= temp___is_init_158 true) (<= 0 100)) (in_range3 temp___expr_161)))
(assert true)
(assert (forall ((x us_rep)) (forall ((c Int)) (! (= (= (has_element x c) true) (in_range2 c)) :pattern ((has_element x c))))))
(declare-fun next (us_rep Int) Int)
(declare-fun next__function_guard (Int us_rep Int) Bool)
(assert (forall ((x us_rep)) (forall ((c Int)) (! (=> (and (dynamic_invariant c true true true) (= (has_element x c) true)) (dynamic_invariant (next x c) true false true)) :pattern ((next x c))))))
(assert (forall ((x us_rep)) (forall ((c Int)) (! (=> (dynamic_invariant c true true true) (= (next x c) (ite (= c 100) 0 (+ c 1)))) :pattern ((next x c))))))
(declare-fun first (us_rep) Int)
(declare-fun first__function_guard (Int us_rep) Bool)
(assert (forall ((x us_rep)) (! (dynamic_invariant (first x) true false true) :pattern ((first x)))))
...
(assert (forall ((x us_rep)) (forall ((c Int)) (! (=> (and (dynamic_invariant c true true true) (= (has_element x c) true)) (dynamic_invariant1 (element x c) true false true)) :pattern ((element x c))))))
(assert (forall ((x us_rep)) (forall ((c Int)) (! (=> (dynamic_invariant c true true true) (= (element x c) (to_rep (let ((temp___173 (rec__declare_iterable__container__content (us_split_fields1 x)))) (select temp___173 c))))) :pattern ((element x c))))))
...
(assert (forall ((temp___248 Int)) (forall ((temp___249 Int)) (= (select (for_loop_iterable__p3__a__aggregate_def temp___248) temp___249) (of_rep temp___248)))))
(define-fun dynamic_invariant2 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 1 100)) (in_range2 temp___expr_136)))
...
(define-fun g__split_fields4 () us_split_fields (mk___split_fields g__split_fields3))
(define-fun g__split_fields5 () us_split_fields (mk___split_fields g__split_fields2))
(define-fun g__split_fields6 () us_split_fields (mk___split_fields g__split_fields1))
(assert (= result a))
...
(assert (and (= o (first (mk___rep g__split_fields6))) (and (in_range3 o) (= o 1))))
(assert (= o temp___253))
(assert (and (= result2 (has_element (mk___rep g__split_fields6) temp___253)) (= (= result2 true) (in_range2 temp___253))))
(assert (=> (= result2 true) (and (= o1 (element (mk___rep g__split_fields6) temp___253)) (and (in_range1 o1) (= o1 (to_rep (select g__split_fields1 temp___253)))))))
(assert (=> (= result2 true) (= result3 e)))
(assert (=> (= result2 true) (= e2 o1)))
(assert (=> (not (= result2 true)) (= e2 e)))
(assert (=> (not (= result2 true)) (= e2 e1)))
(assert (and (= result4 (has_element (mk___rep g__split_fields6) temp___253)) (= (= result4 true) (in_range2 temp___253))))
(assert (= result4 true))
(assert (and (= (has_element (mk___rep g__split_fields5) temp___2531) true) (= e3 (element (mk___rep g__split_fields5) temp___2531))))
(assert (= e3 0))
(assert (and (= o2 (next (mk___rep g__split_fields4) temp___2531)) (and (in_range3 o2) (= o2 (ite (= temp___2531 100) 0 (+ temp___2531 1))))))
(assert (and (= o3 (has_element (mk___rep g__split_fields4) o2)) (= (= o3 true) (in_range2 o2))))
(assert (= result5 (ite (not (= o3 true)) true false)))
(assert (not (= result5 true)))
(assert (not (= (has_element (mk___rep g__split_fields4) temp___2531) true)))
(check-sat)
(exit)
