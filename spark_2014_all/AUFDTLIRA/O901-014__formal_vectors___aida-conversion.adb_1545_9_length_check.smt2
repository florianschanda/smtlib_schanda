...
(assert (not (= (ite (<= (to_rep1 (first4 temp___20461)) (to_rep1 (last4 temp___20461))) (+ (- (to_rep1 (last4 temp___20461)) (to_rep1 (first4 temp___20461))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 6)) 1) 0))))
(check-sat)
(exit)
