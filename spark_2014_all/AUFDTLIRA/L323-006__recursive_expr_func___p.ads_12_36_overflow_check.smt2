...
(assert (and (= o (- hi 1)) (in_range2 (- hi 1))))
(assert (and (= o4 (sum x lo o)) (and (in_range o4) (= o4 (ite (or (or (< o lo) (< lo (to_rep (first (rt x))))) (< o (to_rep (last (rt x))))) 0 (+ (sum x lo (- o 1)) (to_rep1 (select (elts x) o))))))))
(assert (= o5 (+ o4 o3)))
