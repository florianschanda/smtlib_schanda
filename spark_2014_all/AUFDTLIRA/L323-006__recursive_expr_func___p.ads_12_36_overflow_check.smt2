...
(assert (forall ((x tindexB)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_173 us_t) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (not (= temp___skip_constant_170 true)) (dynamic_property 0 100 (first1 temp___expr_173) (last1 temp___expr_173))))
...
(define-fun dynamic_invariant3 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 1 10)) (in_range2 temp___expr_166)))
(declare-const o Int)
...
(assert (=> (not (< hi lo)) (= result1 (ite (< lo (to_rep1 (first (rt x)))) true false))))
(assert (=> (= result1 true) (= result true)))
(assert (=> (not (= result1 true)) (= result (ite (< hi (to_rep1 (last (rt x)))) true false))))
(assert (not (= result true)))
(assert (and (<= (to_rep1 (first (rt x))) hi) (<= hi (to_rep1 (last (rt x))))))
(assert (= o1 hi))
(assert (= o2 (select (elts x) o1)))
(assert (= o3 (to_rep o2)))
(assert (and (= o (- hi 1)) (in_range1 (- hi 1))))
(assert (and (= o4 (sum x lo o)) (and (in_range o4) (= o4 (ite (or (or (< o lo) (< lo (to_rep1 (first (rt x))))) (< o (to_rep1 (last (rt x))))) 0 (+ (sum x lo (- o 1)) (to_rep (select (elts x) o))))))))
(assert (= o5 (+ o4 o3)))
