...
(define-fun dynamic_invariant2 ((temp___expr_179 us_t1) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (not (= temp___skip_constant_176 true)) (dynamic_property2 1 2147483647 (first3 temp___expr_179) (last3 temp___expr_179))))
...
(define-fun to_base ((a1 us_rep2)) us_rep1 (mk___rep1 (us_split_discrs4 a1) (mk___split_fields1 (let ((temp___163 (rec__record_discr__interm_result__to_search1 (us_split_fields5 a1)))) (of_array (to_array2 temp___163) (first5 temp___163) (last5 temp___163))))))
(define-fun of_base ((r us_rep1)) us_rep2 (mk___rep2 (us_split_discrs3 r) (mk___split_fields2 (let ((temp___162 (rec__record_discr__interm_result__to_search (us_split_fields3 r)))) (of_array2 (to_array temp___162) (first1 temp___162) (last1 temp___162))))))
...
(define-fun to_base1 ((a1 us_rep3)) us_rep1 (mk___rep1 (us_split_discrs5 a1) (mk___split_fields1 (let ((temp___165 (rec__record_discr__interm_result__to_search2 (us_split_fields7 a1)))) (of_array (to_array3 temp___165) (first7 temp___165) (last7 temp___165))))))
(define-fun of_base1 ((r us_rep1)) us_rep3 (mk___rep3 (us_split_discrs3 r) (mk___split_fields3 (let ((temp___164 (rec__record_discr__interm_result__to_search (us_split_fields3 r)))) (of_array3 (to_array temp___164) (first1 temp___164) (last1 temp___164))))))
...
(assert (= init (of_base (to_base1 (mk___rep3 (mk___split_discrs1 (of_rep (last3 a))) (mk___split_fields3 (of_array3 (slide (to_array1 a) (first3 a) 1) 1 (last3 a))))))))
(define-fun dynamic_invariant5 ((temp___expr_185 us_rep1) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool) (temp___do_typ_inv_184 Bool)) Bool (let ((temp___186 (rec__record_discr__interm_result__upto (us_split_discrs3 temp___expr_185)))) (and (dynamic_property1 1 (to_rep temp___186) (first1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185))) (last1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185)))) (and (= (first1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185))) 1) (= (last1 (rec__record_discr__interm_result__to_search (us_split_fields3 temp___expr_185))) (to_rep temp___186))))))
...
(define-fun o17 () us_rep1 (mk___rep1 (mk___split_discrs1 o13) (mk___split_fields1 (mk___t o14 o15))))
(define-fun o18 () us_rep1 (mk___rep1 (mk___split_discrs1 o10) (mk___split_fields1 (mk___t o11 o12))))
(assert (dynamic_invariant2 a true false true true))
(assert (in_range1 e))
(assert (and (= (to_rep1 (first2 (rt1 a))) 1) (<= 0 (to_rep1 (last2 (rt1 a))))))
(assert (and (= us (to_rep1 (last2 (rt1 a)))) (in_range1 (to_rep1 (last2 (rt1 a))))))
(assert (= (ite (<= (to_rep1 (first2 (rt1 a))) (to_rep1 (last2 (rt1 a)))) (+ (- (to_rep1 (last2 (rt1 a))) (to_rep1 (first2 (rt1 a)))) 1) 0) (ite (<= 1 (to_rep1 (last2 (rt1 a)))) (+ (- (to_rep1 (last2 (rt1 a))) 1) 1) 0)))
(assert (= (slide (elts1 a) (to_rep1 (first2 (rt1 a))) 1) o2))
(assert (= (mk3 1 (to_rep1 (last2 (rt1 a)))) o3))
(assert (= o4 o2))
(assert (= o5 o3))
(assert (and (= o (to_rep1 (last2 (rt1 a)))) (in_range1 (to_rep1 (last2 (rt1 a))))))
(assert (= (to_rep o1) o))
(assert (= o1 o6))
(assert (= o7 o6))
(assert (= o8 o4))
...
(assert (and (= o16 (search_upto (to_base init) e)) (ite (= (rec__private_record__result_ty__found (us_split_discrs1 o16)) true) (and (<= (get_content o16) (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 (to_base init))))) (= (to_rep (select (elts (rec__record_discr__interm_result__to_search (us_split_fields3 (to_base init)))) (get_content o16))) e)) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 (to_base init)))))) (not (= (to_rep (select (elts (rec__record_discr__interm_result__to_search (us_split_fields3 (to_base init)))) i)) e)))))))
...
(assert (not (= (rec__private_record__result_ty__found (us_split_discrs1 (result_ty__content record_discr__search__result5))) true)))
(check-sat)
(exit)
