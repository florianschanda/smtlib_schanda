...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___133 (rec__main__branch_type__m_nodes (us_split_fields1 r)))) (to_array temp___133)))))
...
(define-fun dynamic_invariant ((temp___expr_184 us_rep1) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool)) Bool (=> (not (= temp___skip_constant_182 true)) (in_range4 7 (to_base temp___expr_184))))
(define-fun default_initial_assumption ((temp___expr_187 us_rep1) (temp___skip_top_level_188 Bool)) Bool (= (to_rep1 (rec__main__branch_type__m_height (us_split_discrs2 temp___expr_187))) 7))
...
(assert (forall ((temp___203 Int)) (forall ((temp___204 Int)) (= (select (temp___201 temp___203) temp___204) (of_rep temp___203)))))
...
(declare-const temp___209 natural)
(declare-const temp___2091 (Array Int integer))
(declare-const result (Array Int integer))
(declare-const b__split_fields1 (Array Int integer))
(declare-const result1 Int)
(declare-const i1 Int)
(declare-const b__split_fields2 (Array Int integer))
(declare-const i2 Int)
(declare-const result2 (Array Int integer))
(declare-const b__split_fields3 (Array Int integer))
...
(assert (and (and (forall ((temp___212 Int)) (=> (and (<= 0 temp___212) (<= temp___212 7)) (=> (<= i2 temp___212) (= (select b__split_fields2 temp___212) (select b__split_fields1 temp___212))))) (=> (<= 0 7) (dynamic_property2 0 7 i2))) (and (<= 0 i2) (<= i2 7))))
(assert (= i2 7))
(assert (not (<= 0 i2)))
(check-sat)
(exit)
