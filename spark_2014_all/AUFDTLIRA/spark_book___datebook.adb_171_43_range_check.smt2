...
(assert (= o7 (ite (<= (to_rep8 (rec__datebook__event_record__description_size (us_split_fields7 (select event_array index2)))) o6) true false)))
(assert (= result5 (ite (= o7 true) true false)))
(assert (= result5 true))
