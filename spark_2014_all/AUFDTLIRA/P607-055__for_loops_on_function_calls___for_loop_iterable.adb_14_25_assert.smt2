...
(assert (= o temp___239))
(assert (and (= result1 (has_element temp___2381 temp___239)) (= (= result1 true) (in_range2 temp___239))))
(assert (=> (= result1 true) (and (= o1 (element temp___2381 temp___239)) (and (in_range1 o1) (= o1 (to_rep (select temp___238 temp___239)))))))
(assert (=> (= result1 true) (= result2 e)))
(assert (=> (= result1 true) (= e2 o1)))
(assert (=> (not (= result1 true)) (= e2 e)))
(assert (=> (not (= result1 true)) (= e2 e1)))
(assert (and (= result3 (has_element temp___2381 temp___239)) (= (= result3 true) (in_range2 temp___239))))
(assert (= result3 true))
(assert (and (forall ((temp___235 Int)) (=> (and (<= 1 temp___235) (<= temp___235 100)) (=> (not (= 2 temp___235)) (= (select a2 temp___235) (select a1 temp___235))))) (and (= (has_element temp___2381 temp___2391) true) (= e3 (element temp___2381 temp___2391)))))
(assert (= (to_rep o2) 1))
