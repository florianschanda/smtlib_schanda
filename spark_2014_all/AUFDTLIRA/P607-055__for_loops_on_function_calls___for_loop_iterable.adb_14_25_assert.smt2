...
(assert (forall ((temp___232 Int)) (forall ((temp___233 Int)) (= (select (for_loop_iterable__p1__a__aggregate_def temp___232) temp___233) (of_rep temp___232)))))
...
(declare-const temp___2392 Int)
(declare-const result7 Bool)
(assert (= result a))
(assert (= a1 (for_loop_iterable__p1__a__aggregate_def 0)))
(assert (and (= (mk___rep (mk___split_fields temp___238)) (from_nat_array a1)) (= a1 temp___238)))
(assert (and (= o (first (mk___rep (mk___split_fields temp___238)))) (and (in_range3 o) (= o 1))))
(assert (= o temp___239))
(assert (and (= result1 (has_element (mk___rep (mk___split_fields temp___238)) temp___239)) (= (= result1 true) (in_range2 temp___239))))
(assert (=> (= result1 true) (and (= o1 (element (mk___rep (mk___split_fields temp___238)) temp___239)) (and (in_range1 o1) (= o1 (to_rep (select temp___238 temp___239)))))))
(assert (=> (= result1 true) (= result2 e)))
(assert (=> (= result1 true) (= e2 o1)))
(assert (=> (not (= result1 true)) (= e2 e)))
(assert (=> (not (= result1 true)) (= e2 e1)))
(assert (and (= result3 (has_element (mk___rep (mk___split_fields temp___238)) temp___239)) (= (= result3 true) (in_range2 temp___239))))
(assert (= result3 true))
(assert (and (forall ((temp___235 Int)) (=> (and (<= 1 temp___235) (<= temp___235 100)) (=> (not (= 2 temp___235)) (= (select a2 temp___235) (select a1 temp___235))))) (and (= (has_element (mk___rep (mk___split_fields temp___238)) temp___2391) true) (= e3 (element (mk___rep (mk___split_fields temp___238)) temp___2391)))))
(assert (= (to_rep o2) 1))
