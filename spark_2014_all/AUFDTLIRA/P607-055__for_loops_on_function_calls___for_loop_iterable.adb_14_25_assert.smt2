...
(assert (forall ((temp___265 Int)) (=> (dynamic_invariant1 temp___265 true true true true) (forall ((temp___266 Int)) (= (to_rep (select (for_loop_iterable__p1__a__aggregate_def temp___265) temp___266)) temp___265)))))
...
(assert (and (= o (first temp___2711)) (and (in_range3 o) (= o 1))))
(assert (= o temp___272))
(assert (and (= result1 (has_element temp___2711 temp___272)) (= (= result1 true) (in_range2 temp___272))))
...
(assert (and (= result3 (has_element temp___2711 temp___272)) (= (= result3 true) (in_range2 temp___272))))
(assert (= result3 true))
(assert (and (forall ((temp___268 Int)) (=> (and (<= 1 temp___268) (<= temp___268 100)) (=> (not (= 2 temp___268)) (= (select a2 temp___268) (select a1 temp___268))))) (and (= (has_element temp___2711 temp___2721) true) (= e3 (element temp___2711 temp___2721)))))
(assert (= (to_rep o2) 1))
