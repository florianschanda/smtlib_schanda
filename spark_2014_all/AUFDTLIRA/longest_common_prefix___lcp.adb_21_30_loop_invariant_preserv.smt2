...
(assert (= result1 true))
(assert (forall ((k Int)) (=> (and (<= 0 k) (<= k (- l2 1))) (= (to_rep (select (elts a) (+ x k))) (to_rep (select (elts a) (+ y k)))))))
...
(assert (= temp___161 result4))
(assert (= temp___1611 l2))
(assert (and (= o8 (+ l2 1)) (in_range1 (+ l2 1))))
(assert (= l2 result5))
(assert (= l3 o8))
(assert (and (= o16 (+ x l3)) (in_range1 (+ x l3))))
(assert (= result8 (ite (<= o16 (to_rep (last (rt a)))) true false)))
(assert (=> (= result8 true) (and (= o15 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result8 true) (= result7 (ite (<= o15 (to_rep (last (rt a)))) true false))))
...
(assert (=> (= result7 true) (= o11 temp___1631)))
(assert (=> (= result7 true) (= o12 (select (elts a) o11))))
...
(assert (=> (= result7 true) (= o9 temp___1621)))
(assert (=> (= result7 true) (= o10 (select (elts a) o9))))
...
(assert (<= 0 k))
(assert (<= k (- l3 1)))
(assert (not (= (to_rep (select (elts a) (+ x k))) (to_rep (select (elts a) (+ y k))))))
(check-sat)
(exit)
