...
(assert (= result1 true))
(assert (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 (- l2 1))) (= (to_rep (select (elts a) (+ x k2))) (to_rep (select (elts a) (+ y k2)))))))
(assert (and (=> (<= 0 2147483647) (in_range2 l2)) (and (and (<= (+ x l2) (to_rep (last (rt a)))) (<= (+ y l2) (to_rep (last (rt a))))) (= (to_rep (select (elts a) (+ x l2))) (to_rep (select (elts a) (+ y l2)))))))
(assert (= temp___1611 result4))
(assert (= temp___1612 l2))
(assert (and (= o14 (+ l2 1)) (in_range1 (+ l2 1))))
(assert (= l2 result5))
(assert (= l3 o14))
(assert (and (= o22 (+ x l3)) (in_range1 (+ x l3))))
(assert (= result8 (ite (<= o22 (to_rep (last (rt a)))) true false)))
(assert (=> (= result8 true) (and (= o21 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result8 true) (= result7 (ite (<= o21 (to_rep (last (rt a)))) true false))))
(assert (=> (not (= result8 true)) (= result7 false)))
(assert (=> (= result7 true) (and (= temp___1631 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result7 true) (and (<= (to_rep (first (rt a))) temp___1631) (<= temp___1631 (to_rep (last (rt a)))))))
(assert (=> (= result7 true) (= o17 temp___1631)))
(assert (=> (= result7 true) (= o18 (select (elts a) o17))))
(assert (=> (= result7 true) (= o19 (to_rep o18))))
(assert (=> (= result7 true) (and (= temp___1621 (+ x l3)) (in_range1 (+ x l3)))))
(assert (=> (= result7 true) (and (<= (to_rep (first (rt a))) temp___1621) (<= temp___1621 (to_rep (last (rt a)))))))
(assert (=> (= result7 true) (= o15 temp___1621)))
(assert (=> (= result7 true) (= o16 (select (elts a) o15))))
(assert (=> (= result7 true) (= o20 (to_rep o16))))
(assert (=> (= result7 true) (= o23 (ite (= o20 o19) true false))))
(assert (=> (not (= result7 true)) (= o23 false)))
(assert (= result6 (ite (not (= o23 true)) true false)))
(assert (not (= result6 true)))
(declare-const k2 Int)
(assert (<= 0 k2))
(assert (<= k2 (- l3 1)))
(assert (not (= (to_rep (select (elts a) (+ x k2))) (to_rep (select (elts a) (+ y k2))))))
(check-sat)
(exit)
