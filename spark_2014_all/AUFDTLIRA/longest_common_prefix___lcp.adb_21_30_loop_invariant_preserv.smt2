...
(assert (= temp___186 result4))
(assert (= temp___1861 l2))
...
(assert (=> (= result7 true) (and (= temp___1881 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result7 true) (and (<= (to_rep (first (rt a))) temp___1881) (<= temp___1881 (to_rep (last (rt a)))))))
(assert (=> (= result7 true) (= o11 temp___1881)))
(assert (=> (= result7 true) (= o12 (select (elts a) o11))))
(assert (=> (= result7 true) (= o13 (to_rep o12))))
(assert (=> (= result7 true) (and (= temp___1871 (+ x l3)) (in_range1 (+ x l3)))))
(assert (=> (= result7 true) (and (<= (to_rep (first (rt a))) temp___1871) (<= temp___1871 (to_rep (last (rt a)))))))
(assert (=> (= result7 true) (= o9 temp___1871)))
