...
(assert (and (= o317 (int__content x11)) (in_range2 (int__content x11))))
(assert (and (= o318 (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields23)) o317)) (and (in_range3 o318) (and (= o318 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields23)))) o317)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields23))) 0) (= o318 0))))))
(assert (not (in_range2 o318)))
(check-sat)
(exit)
