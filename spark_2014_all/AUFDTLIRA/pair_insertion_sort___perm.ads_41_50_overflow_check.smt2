...
(assert (or (and (and (= b1 b3) (= b4 b1)) (= (length a) 0)) (and (not (= (length a) 0)) (and (and (= b2 b3) (= b4 b2)) (ite (= i (to_rep (last (rt a)))) (and (and (and (= o16 (remove_last r)) (and (dynamic_invariant2 o16 true false true true) (and (= (elts r) o) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1))))) o1)))) (= (occ (mk___t b1 (mk (to_rep b__first) (to_rep b__last))) e) (occ o16 e))) (= b2 b1)) (and (and (and (and (= (to_rep o2) v) (and (and (and (<= (to_rep b__first) i) (<= i (to_rep b__last))) (= o3 i)) (= temp___267 (store b1 o3 o2)))) (and (= (to_rep b__first) 0) (= o4 temp___267))) (and (= b1 result1) (= b2 o4))) (and (and (and (= o15 (remove_last r)) (and (dynamic_invariant2 o15 true false true true) (and (= (elts r) o5) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1))))) o6)))) (= (occ o15 e) (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e))) (and (and (= o14 (remove_last a)) (and (dynamic_invariant2 o14 true false true true) (and (= (elts a) o7) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1))))) o8)))) (ite (= v (to_rep (select o7 i))) (= (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e) (occ o14 e)) (ite (= v e) (= (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e) (+ (occ o14 e) 1)) (ite (= (to_rep (select o7 i)) e) (= (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e) (- (occ o14 e) 1)) (= (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e) (occ o14 e)))))))))))))
...
(assert (= v e))
(assert (and (= o12 (occ a e)) (and (in_range3 o12) (and (= o12 (occ_def a e)) (<= o12 (length a))))))
(assert (= o13 (+ o12 1)))
