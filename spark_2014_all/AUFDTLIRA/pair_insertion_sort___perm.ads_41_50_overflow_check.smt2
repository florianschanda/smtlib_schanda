...
(assert (or (and (and (= b1 b3) (= b4 b1)) (= (length a) 0)) (and (not (= (length a) 0)) (and (and (= b2 b3) (= b4 b2)) (ite (= i (to_rep (last (rt a)))) (and (and (and (= (mk___t o o1) (remove_last r)) (and (dynamic_invariant2 (mk___t o o1) true false true) (and (= (elts r) o) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1))))) o1)))) (= (occ (mk___t b1 (mk (to_rep b__first) (to_rep b__last))) e) (occ (mk___t o o1) e))) (= b2 b1)) (and (and (and (and (= (to_rep o2) v) (and (and (and (<= (to_rep b__first) i) (<= i (to_rep b__last))) (= o3 i)) (= temp___238 (store b1 o3 o2)))) (and (= (to_rep b__first) 0) (= o4 temp___238))) (and (= b1 result1) (= b2 o4))) (and (and (and (= (mk___t o5 o6) (remove_last r)) (and (dynamic_invariant2 (mk___t o5 o6) true false true) (and (= (elts r) o5) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1))))) o6)))) (= (occ (mk___t o5 o6) e) (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e))) (and (and (= (mk___t o7 o8) (remove_last a)) (and (dynamic_invariant2 (mk___t o7 o8) true false true) (and (= (elts a) o7) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1))))) o8)))) (ite (= v (to_rep (select o7 i))) (= (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e) (occ (mk___t o7 o8) e)) (ite (= v e) (= (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e) (+ (occ (mk___t o7 o8) e) 1)) (ite (= (to_rep (select o7 i)) e) (= (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e) (- (occ (mk___t o7 o8) e) 1)) (= (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e) (occ (mk___t o7 o8) e)))))))))))))
