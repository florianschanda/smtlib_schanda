...
(declare-const temp___1370 (Array Int us_rep1))
...
(assert (= o15 (select temp___1372 i)))
...
(assert (and (= temp___1371 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o11)) (and (dynamic_invariant3 temp___1371 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1371 o11))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1371 o11)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o11)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1371 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1371 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1371 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1371 i1))) true) (not (= i1 o11))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1371 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1371 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1371 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1371 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1371 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1371 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1371 j)))) true)) (= j i1))))))))))))))
(assert (= o12 (select temp___1371 i)))
(assert (= o13 (us_split_fields1 o12)))
(assert (= o14 (rec__tree_model__path_type__a o13)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
(assert (and (= temp___1370 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) root)) (and (dynamic_invariant3 temp___1370 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1370 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1370 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1370 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1370 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1370 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1370 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1370 (parent (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1370 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1370 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1370 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1370 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1370 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1370 j)))) true)) (= j i1))))))))))))))
(assert (not (<= 1 v)))
(check-sat)
(exit)
