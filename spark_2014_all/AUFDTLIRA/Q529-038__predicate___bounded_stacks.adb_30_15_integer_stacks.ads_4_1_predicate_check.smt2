...
(assert (not (dynamic_predicate1 (mk___rep1 (mk___split_discrs (rec__integer_stacks__stack__capacity this__split_discrs)) (mk___split_fields1 (mk___t1 o o1) rliteral us_null_ext__) us_tag1))))
(check-sat)
(exit)
