...
(assert (=> (and (<= (to_rep (first (rt a))) i2) (<= i2 last4)) (and (and (= temp___262 e) (and (= temp___261 i2) (and (and (and (and (and (and (and (<= (to_rep (first (rt a))) i2) (<= i2 (to_rep (last (rt a))))) (= o1 i2)) (= o2 (select (elts a) o1))) (= o3 (to_rep o2))) (and (= (mk_int__ref result1) (mk_int__ref e)) (= e2 o3))) (in_range1 e2)) (and (and (not (= e2 0)) (and (= dynamic_ranges__search_0__nested__result2 dynamic_ranges__search_0__nested__result) (= dynamic_ranges__search_0__nested__result2 dynamic_ranges__search_0__nested__result1))) (and (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt a))) j1) (<= j1 i3)) (not (= (to_rep (select (elts a) j1)) 0)))) (and (and (and (=> (<= (to_rep (first (rt a))) last4) (dynamic_property4 (to_rep (first (rt a))) last4 i3)) (=> (<= (- 2147483648) 2147483647) (in_range1 e3))) (and (<= (to_rep (first (rt a))) i3) (<= i3 last4))) (= i3 last4))))))) (and (and (= dynamic_ranges__search_0__nested__result3 dynamic_ranges__search_0__nested__result9) (and (= e3 e9) (= i3 i9))) (and (= dynamic_ranges__search_0__nested__result10 dynamic_ranges__search_0__nested__result3) (and (= e10 e3) (= i10 i3)))))))
(assert (=> (and (<= (to_rep (first (rt a))) i2) (<= i2 last4)) (= (mk_int__ref dynamic_ranges__search_0__nested__result11) (mk_int__ref dynamic_ranges__search_0__nested__result9))))
(assert (=> (and (<= (to_rep (first (rt a))) i2) (<= i2 last4)) (= (mk_int__ref e11) (mk_int__ref e9))))
(assert (=> (and (<= (to_rep (first (rt a))) i2) (<= i2 last4)) (= (mk_int__ref i11) (mk_int__ref i9))))
(assert (=> (and (<= (to_rep (first (rt a))) i2) (<= i2 last4)) (= dynamic_ranges__search_0__nested__result12 dynamic_ranges__search_0__nested__result10)))
(assert (=> (and (<= (to_rep (first (rt a))) i2) (<= i2 last4)) (= e12 e10)))
(assert (=> (and (<= (to_rep (first (rt a))) i2) (<= i2 last4)) (= i12 i10)))
(assert (=> (not (and (<= (to_rep (first (rt a))) i2) (<= i2 last4))) (= (mk_int__ref dynamic_ranges__search_0__nested__result11) (mk_int__ref dynamic_ranges__search_0__nested__result))))
(assert (=> (not (and (<= (to_rep (first (rt a))) i2) (<= i2 last4))) (= (mk_int__ref e11) (mk_int__ref e))))
(assert (=> (not (and (<= (to_rep (first (rt a))) i2) (<= i2 last4))) (= i2 i11)))
(assert (=> (not (and (<= (to_rep (first (rt a))) i2) (<= i2 last4))) (= dynamic_ranges__search_0__nested__result12 dynamic_ranges__search_0__nested__result1)))
(assert (=> (not (and (<= (to_rep (first (rt a))) i2) (<= i2 last4))) (= e12 e1)))
(assert (=> (not (and (<= (to_rep (first (rt a))) i2) (<= i2 last4))) (= i12 i2)))
