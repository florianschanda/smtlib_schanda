...
(assert (not (= (stack_entry (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7)) (mk___split_fields my_stack__split_fields6 my_stack__split_fields7)) (stack_entry (- (count (mk___split_fields my_stack__split_fields my_stack__split_fields1)) 1) (mk___split_fields my_stack__split_fields my_stack__split_fields1)))))
(check-sat)
(exit)
