...
(assert (in_range2 y))
(assert (= (same_nb_blacks c82b) true))
(assert (= result43 (mk___split_fields__ref4 t_old__split_fields7)))
(assert (= t_old__split_fields8 t__split_fields11))
(assert (= n70 n68))
(assert (= t_old__split_fields9 (mk___split_fields__ref4 t_old__split_fields8)))
(assert (= x5 (mk_int__ref x4)))
(assert (= t__split_fields12 (mk___split_fields__ref4 t__split_fields11)))
(assert (= rho4 search_trees__left_rotate__t__fields))
(assert (= n71 n69))
(assert (= t_old__split_fields10 t_old__split_fields8))
(assert (= x6 x4))
(assert (= t__split_fields13 t__split_fields11))
