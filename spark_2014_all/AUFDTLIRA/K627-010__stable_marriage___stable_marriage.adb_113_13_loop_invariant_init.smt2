...
(assert (<= 1 g11))
(assert (<= g11 64))
(assert (exists ((prev21 Int)) (and (and (<= 1 prev21) (<= prev21 (- g21 1))) (= (to_rep (select g2_to_g1 prev21)) g11))))
(assert (not (= (to_rep (select g2_to_g1 (to_rep1 (select result__1 g11)))) g11)))
(check-sat)
(exit)
