...
(assert (and (= o60 (remove o58 o59)) (and (dynamic_invariant2 o60 true false true) (and (= (invariant__ o60) true) (and (= (to_rep2 (last (rt o60))) (- (to_rep2 (last (rt o58))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o59 1))) (= (to_rep (select (elts o58) k1)) (to_rep (select (elts o60) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o59 1) k1) (<= k1 (to_rep2 (last (rt o58))))) (= (to_rep (select (elts o58) k1)) (to_rep (select (elts o60) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o59 k1) (<= k1 (- (to_rep2 (last (rt o58))) 1))) (= (to_rep (select (elts o58) (+ k1 1))) (to_rep (select (elts o60) k1))))))))))))
(assert (not (= (invariant__ o60) true)))
(check-sat)
(exit)
