...
(assert (and (= o35 (remove a o10)) (and (dynamic_invariant2 o35 true false true) (and (= (invariant__ o35) true) (and (= (to_rep2 (last o12)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o10 1))) (= (to_rep (select (elts a) k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ o10 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= o10 k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o11 k))))))))))))
(assert (and (= o34 (remove o35 o13)) (and (dynamic_invariant2 o34 true false true) (and (= (invariant__ o34) true) (and (= (to_rep2 (last o15)) (- (to_rep2 (last o12)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select o11 k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep2 (last o12)))) (= (to_rep (select o11 k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep2 (last o12)) 1))) (= (to_rep (select o11 (+ k 1))) (to_rep (select o14 k))))))))))))
(assert (and (= o36 (remove bb ib1)) (and (dynamic_invariant2 o36 true false true) (and (= (invariant__ o36) true) (and (= (to_rep2 (last o9)) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o8 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o8 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o8 k))))))))))))
(assert (and (= o5 ia1) (in_range4 ia1)))
(assert (and (= o37 (remove aa o5)) (and (dynamic_invariant2 o37 true false true) (and (= (invariant__ o37) true) (and (= (to_rep2 (last o7)) (- (to_rep2 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o5 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o6 k))))) (and (forall ((k Int)) (=> (and (<= (+ o5 1) k) (<= k (to_rep2 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o6 (- k 1)))))) (forall ((k Int)) (=> (and (<= o5 k) (<= k (- (to_rep2 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o6 k))))))))))))
(assert (and (= o16 (shift_perm_l o37 o36 o34)) (and (in_range3 o16) (=> (= (of_int o16) true) (= (is_perm o34 o36) true)))))
...
(assert (and (= o31 (remove o29 o30)) (and (dynamic_invariant2 o31 true false true) (and (= (invariant__ o31) true) (and (= (to_rep2 (last (rt o31))) (- (to_rep2 (last (rt o29))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o30 1))) (= (to_rep (select (elts o29) k)) (to_rep (select (elts o31) k))))) (and (forall ((k Int)) (=> (and (<= (+ o30 1) k) (<= k (to_rep2 (last (rt o29))))) (= (to_rep (select (elts o29) k)) (to_rep (select (elts o31) (- k 1)))))) (forall ((k Int)) (=> (and (<= o30 k) (<= k (- (to_rep2 (last (rt o29))) 1))) (= (to_rep (select (elts o29) (+ k 1))) (to_rep (select (elts o31) k))))))))))))
