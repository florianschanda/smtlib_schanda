...
(define-fun dynamic_invariant ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 0 10000)) (in_range1 temp___expr_148)))
...
(define-fun dynamic_invariant1 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range4 temp___expr_142)))
...
(define-fun dynamic_invariant2 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 10000)) (in_range5 temp___expr_172)))
...
(define-fun dynamic_invariant3 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 2147483647)) (in_range6 temp___expr_178)))
...
(define-fun dynamic_invariant4 ((temp___expr_234 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 0 1)) (in_range3 temp___expr_234)))
(define-fun dynamic_invariant5 ((temp___expr_154 Int) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (or (= temp___is_init_151 true) (<= 1 10000)) (in_range2 temp___expr_154)))
...
(define-fun dynamic_invariant6 ((temp___expr_191 Int) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool)) Bool (=> (or (= temp___is_init_188 true) (<= 0 10000)) (in_range7 temp___expr_191)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range7 e) (= (contains1 container e) true)) (= e item))) (= (contains1 container item) true)))) :pattern ((contains1 container item))))))
...
(assert (and (= result1 (is_well_formed data first_available)) (= (= result1 true) (and (=> (not (= first_available 0)) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data first_available)))) 0)) (forall ((r1 Int)) (=> (and (<= 1 r1) (<= r1 10000)) (=> (and (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r1)))) 0) (not (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data r1)))) 0))) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data r1)))))))) 0))))))))
(assert (= result1 true))
(assert (not (= first_available 0)))
(assert (and (= (mk___rep1 (mk___split_fields1 o7 o8)) (model__ data first_available)) (= (model_is_well_formed (mk___rep1 (mk___split_fields1 o7 o8)) data first_available) true)))
(assert (= o7 o9))
(assert (= o8 o10))
(assert (= o11 o9))
(assert (and (= o12 (length o11)) (and (in_range4 o12) (<= (+ 0 o12) 2147483647))))
(assert (and (= (mk___rep1 (mk___split_fields1 o2 o3)) (model__ data first_available)) (= (model_is_well_formed (mk___rep1 (mk___split_fields1 o2 o3)) data first_available) true)))
(assert (= o2 o4))
(assert (= o3 o5))
(assert (= o6 o4))
(assert (not (<= 1 o12)))
