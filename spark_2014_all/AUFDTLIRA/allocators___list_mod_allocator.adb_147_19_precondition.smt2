...
(define-fun dynamic_invariant3 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 10000)) (in_range4 temp___expr_173)))
(assert true)
(assert (forall ((s us_rep)) (forall ((e Int)) (! (= (= (contains s e) true) (exists ((i Int)) (and (and (<= 1 i) (<= i (length s))) (= (get s i) e)))) :pattern ((contains s e))))))
...
(assert (forall ((x resource)) (! (in_range4 (to_rep x)) :pattern ((to_rep x)))))
...
(declare-fun user_eq5 (status status) Bool)
(declare-const dummy5 status)
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 a))) (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 b)))) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 a))) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 b))))) true false))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__list_mod_allocator__m__t__available us_rep) (rec__list_mod_allocator__m__t__allocated us_rep2)))))
...
(declare-fun model__ ((Array Int us_rep1) Int) us_rep3)
(declare-fun model____function_guard (us_rep3 (Array Int us_rep1) Int) Bool)
(declare-fun model_is_well_formed (us_rep3 (Array Int us_rep1) Int) Bool)
(declare-fun model_is_well_formed__function_guard (Bool us_rep3 (Array Int us_rep1) Int) Bool)
...
(define-fun dynamic_invariant4 ((temp___expr_269 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool) (temp___do_typ_inv_268 Bool)) Bool (=> (or (= temp___is_init_265 true) (<= 0 1)) (in_range5 temp___expr_269)))
(define-fun dynamic_invariant5 ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 1 10000)) (in_range6 temp___expr_180)))
...
(define-fun dynamic_invariant6 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 10000)) (in_range7 temp___expr_222)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant6 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range7 e) (= (contains1 container e) true)) (= e item))) (= (contains1 container item) true)))) :pattern ((contains1 container item))))))
...
(assert (forall ((left us_rep2) (right us_rep2)) (! (= (= (ole left right) true) (forall ((item Int)) (=> (and (in_range7 item) (= (contains1 left item) true)) (= (contains1 right item) true)))) :pattern ((ole left right)))))
...
(assert (forall ((container us_rep2)) (! (let ((result (is_empty container))) (and (= (= result true) (forall ((item Int)) (not (and (in_range7 item) (= (contains1 container item) true))))) (= (= result true) (= (length1 container) 0)))) :pattern ((is_empty container)))))
(declare-const data (Array Int us_rep1))
...
(define-fun o11 () us_rep3 (mk___rep1 (mk___split_fields1 o5 o6)))
(define-fun o12 () us_rep3 (mk___rep1 (mk___split_fields1 o o1)))
(assert (in_range4 first_available))
(assert (and (= result (is_well_formed data first_available)) (= (= result true) (and (=> (not (= first_available 0)) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data first_available)))) 0)) (forall ((r Int)) (=> (and (<= 1 r) (<= r 10000)) (=> (and (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r)))) 0) (not (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data r)))) 0))) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data r)))))))) 0))))))))
(assert (= result true))
(assert (not (= first_available 0)))
(assert (and (= o11 (model__ data first_available)) (= (model_is_well_formed o11 data first_available) true)))
(assert (= o5 o7))
(assert (= o6 o8))
(assert (= o9 o7))
(assert (and (= o10 (length o9)) (and (in_range1 o10) (<= (+ 0 o10) 2147483647))))
(assert (and (= o12 (model__ data first_available)) (= (model_is_well_formed o12 data first_available) true)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= o4 o2))
(assert (not (<= o10 (last o4))))
(check-sat)
(exit)
