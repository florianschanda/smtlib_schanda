...
(declare-fun temp___485 (Int Int) (Array Int unsigned_byte))
...
(assert (forall ((temp___487 Int) (temp___488 Int)) (let ((temp___486 (temp___485 temp___487 temp___488))) (=> (and (dynamic_invariant temp___487 true true true true) (dynamic_invariant temp___488 true true true true)) (forall ((temp___489 Int)) (ite (and (<= 2 temp___489) (<= temp___489 5)) (= (to_rep (select temp___486 temp___489)) temp___487) (= (to_rep (select temp___486 temp___489)) temp___488)))))))
...
(assert (= result x))
(assert (= x1 (temp___485 2 8)))
(assert (not (= (to_rep (select x1 4)) 5)))
(check-sat)
(exit)
