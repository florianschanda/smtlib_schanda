...
(assert (forall ((temp___487 Int) (temp___488 Int)) (let ((temp___486 (temp_____aggregate_def_485 temp___487 temp___488))) (=> (and (dynamic_invariant temp___487 true true true true) (dynamic_invariant temp___488 true true true true)) (forall ((temp___489 Int)) (ite (and (<= 2 temp___489) (<= temp___489 5)) (= (select temp___486 temp___489) rliteral) (= (select temp___486 temp___489) rliteral1)))))))
