...
(assert (and (= temp___5652 (remove b i)) (and (dynamic_invariant1 temp___5652 true false true) (and (= (invariant__ temp___5652) true) (and (= (to_rep1 (last temp___5651)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep (select (elts b) k)) (to_rep (select temp___565 k))))) (and (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select temp___565 (- k 1)))))) (forall ((k Int)) (=> (and (<= i k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select temp___565 k))))))))))))
