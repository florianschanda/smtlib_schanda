...
(assert (= (has_key1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c9) true))
(assert (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c9) (to_rep (select a1 i)))))
(assert (not (= (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c9) (to_rep (select a1 j)))))
(assert (not (= (to_rep (select a1 (element (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c9))) (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c9))))
(check-sat)
(exit)
