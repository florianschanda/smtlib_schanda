...
(assert (= result2 true))
(assert (and (= o1 (peek (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) l d)) (and (in_range6 o1) (and (ite (not (= o1 0)) (and (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o1) d) (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o1) l)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j) l) (not (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j) l) (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j) d)) (= o1 j))))))))
(assert (= result3 (ite (= o1 0) true false)))
(assert (= result3 true))
(assert (<= 1 i1))
(assert (<= i1 100))
