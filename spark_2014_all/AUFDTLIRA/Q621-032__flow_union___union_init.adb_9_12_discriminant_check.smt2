...
(define-fun default_initial_assumption1 ((temp___expr_171 us_rep) (temp___skip_top_level_172 Bool)) Bool (and (= (to_rep (rec__union_init__basic_record__length (us_split_fields1 temp___expr_171))) 0) (= (rec__union_init__basic_record__basic_array (us_split_fields1 temp___expr_171)) (temp___173 0))))
(assert (forall ((temp___175 Int)) (=> (dynamic_invariant temp___175 true true true true) (forall ((temp___176 Int)) (= (to_rep (select (temp___173 temp___175) temp___176)) temp___175)))))
(declare-const test__split_discrs integer)
(declare-const o integer)
(declare-const o1 integer)
(declare-const o2 (Array Int integer))
(declare-const o3 integer)
(declare-const temp___191 integer)
(declare-const temp___1911 integer)
(declare-const temp___1912 integer)
(declare-const temp___1913 (Array Int integer))
(declare-const temp___1914 natural)
...
(assert (= dummy temp___1911))
(assert (= o1 temp___1912))
(assert (= o2 temp___1913))
(assert (= dummy1 temp___1914))
(assert (= true temp___1915))
(assert (= test__attr__constrained true))
(assert (not (= temp___191 test__split_discrs)))
(check-sat)
(exit)
