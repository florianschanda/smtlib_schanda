...
(assert (and (= temp___407 (get_previous_track o17 id1)) (and (in_range1 temp___407) (= temp___407 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o16)))))) id1))))))
