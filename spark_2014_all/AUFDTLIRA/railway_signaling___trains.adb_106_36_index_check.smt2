...
(assert (and (= o11 (get_previous_track o18 id1)) (and (in_range1 o11) (= o11 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o10)))))) id1))))))
...
(assert (and (= temp___375 (get_previous_track o17 id1)) (and (in_range1 temp___375) (= temp___375 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o16)))))) id1))))))
(assert (not (<= 1 temp___375)))
(check-sat)
(exit)
