...
(assert (and (= o126 x) (in_range5 x)))
(assert (and (= o124 y) (in_range5 y)))
(assert (and (= o125 (remove (mk___t values2 (mk 1 100)) o124)) (and (dynamic_invariant4 o125 true false true) (and (= (invariant__ o125) true) (and (= (to_rep1 (last (rt o125))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o124 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o125) k))))) (and (forall ((k Int)) (=> (and (<= (+ o124 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o125) (- k 1)))))) (forall ((k Int)) (=> (and (<= o124 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o125) k))))))))))))
(assert (and (= temp___225 (remove o125 o126)) (and (dynamic_invariant4 temp___225 true false true) (and (= (invariant__ temp___225) true) (and (= (to_rep1 (last (rt temp___225))) (- (to_rep1 (last (rt o125))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o126 1))) (= (to_rep (select (elts o125) k)) (to_rep (select (elts temp___225) k))))) (and (forall ((k Int)) (=> (and (<= (+ o126 1) k) (<= k (to_rep1 (last (rt o125))))) (= (to_rep (select (elts o125) k)) (to_rep (select (elts temp___225) (- k 1)))))) (forall ((k Int)) (=> (and (<= o126 k) (<= k (- (to_rep1 (last (rt o125))) 1))) (= (to_rep (select (elts o125) (+ k 1))) (to_rep (select (elts temp___225) k))))))))))))
(assert (and (= o129 (- y 1)) (in_range5 (- y 1))))
(assert (and (= o127 x) (in_range5 x)))
