...
(assert (< (+ n2 1) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res6 j7))))))
(assert (not (< (length (rec__tree_model__path_type__a (us_split_fields1 (select m j7)))) (- 100 (+ n2 1)))))
(check-sat)
(exit)
