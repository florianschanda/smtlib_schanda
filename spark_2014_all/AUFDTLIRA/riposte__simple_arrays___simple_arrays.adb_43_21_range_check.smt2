...
(assert (= a2 o1))
(assert (forall ((j Int)) (=> (and (<= (- 2147483648) j) (<= j i2)) (= (to_rep (select a3 j)) (to_rep (select b j))))))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 i2)) (forall ((temp___293 Int)) (=> (and (<= (- 2147483648) temp___293) (<= temp___293 2147483647)) (=> (< i2 temp___293) (= (select a3 temp___293) (select a temp___293)))))) (and (<= (- 2147483648) i2) (<= i2 2147483647))))
(assert (<= (- 2147483648) i2))
(assert (not (<= (- 2147483648) (- 2147483648))))
(check-sat)
(exit)
