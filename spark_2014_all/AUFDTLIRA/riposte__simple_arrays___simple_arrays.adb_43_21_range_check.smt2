...
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 i2)) (forall ((temp___293 Int)) (=> (and (<= (- 2147483648) temp___293) (<= temp___293 2147483647)) (=> (< i2 temp___293) (= (select a2 temp___293) (select a temp___293)))))) (and (<= (- 2147483648) i2) (<= i2 2147483647))))
