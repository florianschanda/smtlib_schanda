...
(assert (= a1 o1))
(assert (forall ((j Int)) (=> (and (<= (- 2147483648) j) (<= j i2)) (= (to_rep (select a2 j)) (to_rep (select b j))))))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 i2)) (forall ((temp___320 Int)) (=> (and (<= (- 2147483648) temp___320) (<= temp___320 2147483647)) (=> (< i2 temp___320) (= (select a2 temp___320) (select a temp___320)))))) (and (<= (- 2147483648) i2) (<= i2 2147483647))))
