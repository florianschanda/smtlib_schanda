...
(declare-const temp___409 int_bad)
...
(assert (= (to_rep temp___409) 0))
(define-fun temp___411 () Int (to_rep temp___409))
(assert (not (or (and (<= (- 2147483648) temp___411) (<= temp___411 (- 1))) (and (<= 1 temp___411) (<= temp___411 2147483647)))))
(check-sat)
(exit)
