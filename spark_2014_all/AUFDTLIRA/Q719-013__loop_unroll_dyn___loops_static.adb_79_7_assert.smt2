...
(assert (not (not (and (and (= (mk_int__ref result) (mk_int__ref i)) (= i1 1)) (ite (and (<= 1 i1) (<= i1 2)) (and (and (and (= temp___319 bad) (and (= temp___317 a) (and (and (forall ((temp___318 Int)) (=> (and (<= (to_rep1 a__first) temp___318) (<= temp___318 (to_rep1 a__last))) (=> (<= i2 temp___318) (= (select a2 temp___318) (select temp___317 temp___318))))) (and (<= 1 i2) (<= i2 2))) (and (and (and (= (to_rep o) 0) (and (and (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))) (= o1 i2)) (= o2 (store a2 o1 o)))) (and (= a2 result1) (= a3 o2))) (and (forall ((j14 Int)) (=> (and (<= (to_rep1 a__first) j14) (<= j14 i2)) (= (to_rep (select a3 j14)) 0))) (and (and (and (and (and (and (=> (<= (to_rep1 a__first) i2) (and (and (<= (to_rep1 a__first) (to_rep1 a__first)) (<= (to_rep1 a__first) (to_rep1 a__last))) (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))))) (= o3 a3)) (and (= o3 temp___312) (= (mk1 (to_rep1 a__first) i2) temp___3121))) (and (= temp___312 loops_static__loop4__B_11__a_begins__assume) (= (mk (to_rep1 (first2 temp___3121)) (to_rep1 (last2 temp___3121))) loops_static__loop4__B_11__a_begins__assume1))) (= (mk___t loops_static__loop4__B_11__a_begins__assume loops_static__loop4__B_11__a_begins__assume1) a_begins)) (dynamic_invariant a_begins true false true)) (and (and (and (= j2 result2) (= j3 (to_rep1 (first (rt a_begins))))) (ite (and (<= (to_rep1 (first (rt a_begins))) j3) (<= j3 (to_rep1 (last (rt a_begins))))) (and (and (and (= temp___313 bad2) (and (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) j4) (<= j4 (to_rep1 a__last))) (= o4 j4)) (= o5 (select a3 o4))) (= o6 (to_rep o5))) (= o7 (ite (= o6 0) true false))) (= result3 (ite (not (= o7 true)) true false))) (ite (= result3 true) (and (= result4 bad3) (= bad4 (of_int 1))) (= bad4 bad3))) (= j4 (to_rep1 (last (rt a_begins))))))) (and (and (= j4 j5) (= bad4 bad5)) (and (= j6 j4) (= bad6 bad4)))) (and (and (= j13 (mk_int__ref j5)) (= bad13 (mk_bool__ref bad5))) (and (= j8 j6) (= bad8 bad6)))) (and (and (= j3 j7) (= bad2 bad7)) (and (= j8 j3) (= bad8 bad2))))) (= i2 2)))))))) (and (and (= j9 j13) (and (= i3 (mk_int__ref i2)) (and (= bad9 bad13) (= a3 a4)))) (and (= j10 j8) (and (= i4 i2) (and (= bad10 bad8) (= a5 a3)))))) (and (and (= j11 j9) (and (= i5 i3) (and (= bad11 bad9) (= a6 (mk_map__ref a4))))) (and (= j12 j10) (and (= i6 i4) (and (= bad12 bad10) (= a7 a5)))))) (and (and (= j11 (mk_int__ref j)) (and (= i5 (mk_int__ref i1)) (and (= bad11 (mk_bool__ref bad)) (= a6 (mk_map__ref a))))) (and (= j12 j1) (and (= i6 i1) (and (= bad12 bad1) (= a7 a1))))))))))
(check-sat)
(exit)
