...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___319 bad)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___317 a)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (and (forall ((temp___318 Int)) (=> (and (<= (to_rep1 a__first) temp___318) (<= temp___318 (to_rep1 a__last))) (=> (<= i2 temp___318) (= (select a2 temp___318) (select temp___317 temp___318))))) (and (<= 1 i2) (<= i2 2)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= (to_rep o) 0)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= o1 i2)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= o2 (store a2 o1 o))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= a2 result1)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= a3 o2)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (forall ((j14 Int)) (=> (and (<= (to_rep1 a__first) j14) (<= j14 i2)) (= (to_rep (select a3 j14)) 0)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (<= (to_rep1 a__first) i2) (and (and (<= (to_rep1 a__first) (to_rep1 a__first)) (<= (to_rep1 a__first) (to_rep1 a__last))) (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last)))))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= o3 a3)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= o3 temp___312)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= (mk1 (to_rep1 a__first) i2) temp___3121)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= temp___312 loops_static__loop4__B_11__a_begins__assume)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= (mk (to_rep1 (first2 temp___3121)) (to_rep1 (last2 temp___3121))) loops_static__loop4__B_11__a_begins__assume1)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= (mk___t loops_static__loop4__B_11__a_begins__assume loops_static__loop4__B_11__a_begins__assume1) a_begins)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (dynamic_invariant a_begins true false true)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= j3 result2)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= j4 (to_rep1 (first (rt a_begins))))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= temp___313 bad2))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (and (<= (to_rep1 (first (rt a_begins))) j5) (<= j5 (to_rep1 (last (rt a_begins))))))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (and (<= (to_rep1 a__first) j5) (<= j5 (to_rep1 a__last))))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= o4 j5))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= o5 (select a3 o4)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= o6 (to_rep o5)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= o7 (ite (= o6 0) true false)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= result3 (ite (not (= o7 true)) true false)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (=> (= result3 true) (= result4 bad3)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (=> (= result3 true) (= bad4 (of_int 1))))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (=> (not (= result3 true)) (= bad4 bad3)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= j5 (to_rep1 (last (rt a_begins)))))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= j5 j6))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= bad4 bad5))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= j7 j5))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= bad6 bad4))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= (mk_int__ref j8) (mk_int__ref j6)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= (mk_bool__ref bad7) (mk_bool__ref bad5)))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= j9 j7))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins))))) (= bad8 bad6))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (not (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins)))))) (= j4 j8))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (not (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins)))))) (= bad2 bad7))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (not (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins)))))) (= j9 j4))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (=> (not (and (<= (to_rep1 (first (rt a_begins))) j4) (<= j4 (to_rep1 (last (rt a_begins)))))) (= bad8 bad2))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= i2 2)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= j10 (mk_int__ref j8))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= bad9 (mk_bool__ref bad7))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= a3 a4)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= j11 j9)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= i4 i2)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= bad10 bad8)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= a5 a3)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= j12 j10)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= i5 i3)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= bad11 bad9)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= a6 (mk_map__ref a4))))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= j13 j11)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= i6 i4)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= bad12 bad10)))
(assert (=> (and (<= 1 i1) (<= i1 2)) (= a7 a5)))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= j12 (mk_int__ref j))))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= bad11 (mk_bool__ref bad))))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= a6 (mk_map__ref a))))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= j13 j2)))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= i6 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= bad12 bad1)))
(assert (=> (not (and (<= 1 i1) (<= i1 2))) (= a7 a1)))
(assert (not false))
(check-sat)
(exit)
