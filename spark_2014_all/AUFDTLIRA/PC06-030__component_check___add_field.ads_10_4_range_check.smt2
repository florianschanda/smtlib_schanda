...
(declare-datatypes () ((tmy_arrayC__ref (mk_tmy_arrayC__ref (tmy_arrayC__content integer)))))
(define-fun tmy_arrayC__ref___projection ((a tmy_arrayC__ref)) integer (tmy_arrayC__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_176 us_t) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (and (=> (not (= temp___skip_constant_173 true)) (dynamic_property1 1 2147483647 (first1 temp___expr_176) (last1 temp___expr_176))) (forall ((temp___177 Int)) (=> (and (<= (first1 temp___expr_176) temp___177) (<= temp___177 (last1 temp___expr_176))) (=> (or (= temp___is_init_172 true) (<= d 2147483647)) (dynamic_property d 2147483647 (to_rep (select (to_array temp___expr_176) temp___177))))))))
(declare-fun init_array (tuple0) us_t)
(declare-fun init_array__function_guard (us_t tuple0) Bool)
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant1 (init_array us_void_param) true false true true) :pattern ((init_array us_void_param)))))
