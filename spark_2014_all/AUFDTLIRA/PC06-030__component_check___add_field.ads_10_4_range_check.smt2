...
(define-fun dynamic_invariant1 ((temp___expr_159 us_t) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool)) Bool (and (=> (not (= temp___skip_constant_157 true)) (dynamic_property1 1 2147483647 (first1 temp___expr_159) (last1 temp___expr_159))) (forall ((temp___160 Int)) (=> (and (<= (first1 temp___expr_159) temp___160) (<= temp___160 (last1 temp___expr_159))) (=> (or (= temp___is_init_156 true) (<= d 2147483647)) (dynamic_property d 2147483647 (to_rep (select (to_array temp___expr_159) temp___160))))))))
(declare-fun init_array (tuple0) us_t)
(declare-fun init_array__function_guard (us_t tuple0) Bool)
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant1 (init_array us_void_param) true false true) :pattern ((init_array us_void_param)))))
