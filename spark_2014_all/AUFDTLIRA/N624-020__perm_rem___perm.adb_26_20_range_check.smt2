...
(assert (=> (= result5 true) (and (= o10 ib3) (in_range3 ib3))))
(assert (=> (= result5 true) (and (= o16 (remove b o10)) (and (dynamic_invariant o16 true false true true) (and (= (invariant__ o16) true) (and (= (to_rep1 (last o12)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o10 1))) (= (to_rep (select (elts b) k)) (to_rep (select o11 k))))) (and (forall ((k Int)) (=> (and (<= (+ o10 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o11 (- k 1)))))) (forall ((k Int)) (=> (and (<= o10 k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o11 k)))))))))))))
(assert (=> (= result5 true) (and (= o17 (remove a ia)) (and (dynamic_invariant o17 true false true true) (and (= (invariant__ o17) true) (and (= (to_rep1 (last o9)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o8 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o8 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o8 k)))))))))))))
