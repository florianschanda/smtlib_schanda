...
(assert (=> (and (<= temp___486 i_v11) (<= i_v11 (to_rep a_v1__last))) (and (forall ((m Int)) (=> (and (<= (to_rep a_v1__first) m) (<= m k_1)) (= (to_rep (select a_v12 m)) (to_rep (select (elts b_v1) m))))) (forall ((m Int)) (=> (and (<= (+ k_1 1) m) (<= m (- i_v12 1))) (= (to_rep (select a_v12 m)) (to_rep (select (elts c_v1) (- m k_1)))))))))
