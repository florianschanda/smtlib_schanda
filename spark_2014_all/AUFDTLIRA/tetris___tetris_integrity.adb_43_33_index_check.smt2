...
(assert (and (<= 1 (to_rep2 cur_piece__split_fields3)) (<= (to_rep2 cur_piece__split_fields3) 50)))
...
(assert (and (<= 1 (+ (to_rep2 cur_piece__split_fields3) 1)) (<= (+ (to_rep2 cur_piece__split_fields3) 1) 50)))
...
(assert (not (<= (to_rep2 cur_piece__split_fields3) 50)))
(check-sat)
(exit)
