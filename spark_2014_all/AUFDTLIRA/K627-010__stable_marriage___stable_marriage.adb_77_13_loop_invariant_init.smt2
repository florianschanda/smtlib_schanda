...
(assert (forall ((rank11 Int)) (=> (and (<= 1 rank11) (<= rank11 64)) (forall ((rank2 Int)) (=> (and (<= 1 rank2) (<= rank2 64)) (=> (not (= rank11 rank2)) (not (= (to_rep (select r2 rank11)) (to_rep (select r2 rank2))))))))))
...
(assert (not (= (to_rep (select r2 (to_rep1 (select result__1 g2)))) g2)))
(check-sat)
(exit)
