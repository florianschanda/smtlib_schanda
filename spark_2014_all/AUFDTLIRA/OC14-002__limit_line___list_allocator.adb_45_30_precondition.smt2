...
(assert (=> (not (= first_available 0)) (and (= o20 (length model____split_fields)) (in_range6 o20))))
(assert (=> (not (= first_available 0)) (= result2 (ite (< 0 o20) true false))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (and (= o19 (get model____split_fields 1)) (in_range7 o19)))))
(assert (=> (not (= first_available 0)) (=> (= result2 true) (= result1 (ite (= o19 first_available) true false)))))
(assert (=> (not (= first_available 0)) (=> (not (= result2 true)) (= result1 false))))
(assert (=> (not (not (= first_available 0))) (and (= o21 (length model____split_fields)) (in_range6 o21))))
(assert (=> (not (not (= first_available 0))) (= result1 (ite (= o21 0) true false))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (and (= o17 (length model____split_fields1)) (in_range6 o17)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (= result3 (ite (< 0 o17) true false)))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (and (= o16 (get model____split_fields1 1)) (in_range7 o16))))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (= result3 true) (= result (ite (= o16 first_allocated) true false))))))
(assert (=> (= result1 true) (=> (not (= first_allocated 0)) (=> (not (= result3 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (and (= o18 (length model____split_fields1)) (in_range6 o18)))))
(assert (=> (= result1 true) (=> (not (not (= first_allocated 0))) (= result (ite (= o18 0) true false)))))
...
(assert (= result6 (ite (in_range4 o15) true false)))
(assert (=> (= result6 true) (and (= o11 (length model____split_fields)) (in_range6 o11))))
(assert (=> (= result6 true) (= result7 (ite (< j o11) true false))))
(assert (=> (= result6 true) (=> (= result7 true) (and (= o12 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result6 true) (=> (= result7 true) (and (= o13 (get model____split_fields o12)) (in_range7 o13)))))
(assert (=> (= result6 true) (=> (not (= result7 true)) (= o13 0))))
