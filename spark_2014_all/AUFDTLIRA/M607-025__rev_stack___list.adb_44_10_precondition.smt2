...
(assert (and (= o37 (top (mk___rep s__split_fields12))) (and (in_range1 o37) (and (= o37 (to_rep (select (rec__stack__stack__content s__split_fields12) (to_rep1 (rec__stack__stack__top s__split_fields12))))) (= o37 (to_rep (select (elts (to__ (mk___rep s__split_fields12))) (to_rep (last (rt (to__ (mk___rep s__split_fields12))))))))))))
(assert (and (and (= (length2 (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (length2 (mk___rep1 res__split_discrs res__split_fields2)) 1)) (= (olt (model__ (mk___rep1 res__split_discrs res__split_fields2)) (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields))) true)) (= (get (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (last4 (model__ (mk___rep1 res__split_discrs res__split_fields2))) 1)) o37)))
(assert (= result11 (mk___split_fields__ref1 res__split_fields2)))
