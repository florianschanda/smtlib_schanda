...
(assert (= data2 o37))
(assert (=> (not (= prev_alloc2 0)) (= (to_rep o38) next_alloc2)))
(assert (=> (not (= prev_alloc2 0)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data2 prev_alloc2))) o39)))
(assert (=> (not (= prev_alloc2 0)) (= (rec__list_allocator__cell__prev (us_split_fields1 (select data2 prev_alloc2))) o40)))
(assert (=> (not (= prev_alloc2 0)) (= o38 o41)))
(assert (=> (not (= prev_alloc2 0)) (= o42 o39)))
(assert (=> (not (= prev_alloc2 0)) (= o43 o40)))
(assert (=> (not (= prev_alloc2 0)) (= o44 o41)))
(assert (=> (not (= prev_alloc2 0)) (and (<= 1 prev_alloc2) (<= prev_alloc2 3))))
(assert (=> (not (= prev_alloc2 0)) (= o45 prev_alloc2)))
(assert (=> (not (= prev_alloc2 0)) (= o46 (store data2 o45 (mk___rep (mk___split_fields o42 o43 o44))))))
(assert (=> (not (= prev_alloc2 0)) (= result4 (mk_map__ref data2))))
(assert (=> (not (= prev_alloc2 0)) (= data3 o46)))
(assert (=> (= prev_alloc2 0) (= data3 data2)))
(assert (=> (not (= next_alloc2 0)) (= (to_rep o47) prev_alloc2)))
(assert (=> (not (= next_alloc2 0)) (= o48 (mk___split_fields (rec__list_allocator__cell__stat (us_split_fields1 (select data3 next_alloc2))) o47 (rec__list_allocator__cell__next (us_split_fields1 (select data3 next_alloc2)))))))
(assert (=> (not (= next_alloc2 0)) (= o49 (mk___rep o48))))
(assert (=> (not (= next_alloc2 0)) (and (<= 1 next_alloc2) (<= next_alloc2 3))))
(assert (=> (not (= next_alloc2 0)) (= o50 next_alloc2)))
(assert (=> (not (= next_alloc2 0)) (= o51 (store data3 o50 o49))))
(assert (=> (not (= next_alloc2 0)) (= result5 (mk_map__ref data3))))
(assert (=> (not (= next_alloc2 0)) (= data4 o51)))
(assert (=> (= next_alloc2 0) (= data4 data3)))
(assert (= result6 (mk_int__ref first_available)))
(assert (= first_available2 res))
(assert (=> (= res first_allocated) (= result7 (mk_int__ref first_allocated))))
(assert (=> (= res first_allocated) (= first_allocated2 next_alloc2)))
...
(assert (= model____split_fields3 (us_split_fields3 temp___422)))
(assert (and (= o56 (prepend (rec__list_allocator__m__t__available model____split_fields3) res)) (= (is_prepend (rec__list_allocator__m__t__available model____split_fields3) res o56) true)))
(assert (= o57 (mk___split_fields1 o56 (rec__list_allocator__m__t__allocated model____split_fields3))))
(assert (= temp___424 (mk___rep1 o57)))
(assert (= result9 (mk___split_fields__ref1 model____split_fields3)))
(assert (= model____split_fields4 (us_split_fields3 temp___424)))
(assert (forall ((j8 Int)) (=> (and (<= 1 j8) (<= j8 (length (rec__list_allocator__m__t__available model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__available model____split_fields4) j8)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__available model____split_fields4) j8))))) (ite (< j8 (length (rec__list_allocator__m__t__available model____split_fields4))) (get (rec__list_allocator__m__t__available model____split_fields4) (+ j8 1)) 0))))))
(assert (forall ((j8 Int)) (=> (and (<= 1 j8) (<= j8 (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j8)))))
(assert (forall ((j8 Int)) (=> (and (<= 1 j8) (<= j8 (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j8)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j8))))) (ite (< j8 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (get (rec__list_allocator__m__t__allocated model____split_fields4) (+ j8 1)) 0))))))
(assert (forall ((j8 Int)) (=> (and (<= 1 j8) (<= j8 (length (rec__list_allocator__m__t__available model____split_fields4)))) (and (and (and (in_range4 (get (rec__list_allocator__m__t__available model____split_fields4) j8)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__available model____split_fields4) j8))))) (ite (< j8 (length (rec__list_allocator__m__t__available model____split_fields4))) (get (rec__list_allocator__m__t__available model____split_fields4) (+ j8 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__available model____split_fields4) j8))))) (ite (< 1 j8) (get (rec__list_allocator__m__t__available model____split_fields4) (- j8 1)) 0))) (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 (length (rec__list_allocator__m__t__available model____split_fields4)))) (=> (not (= j8 k2)) (not (= (get (rec__list_allocator__m__t__available model____split_fields4) j8) (get (rec__list_allocator__m__t__available model____split_fields4) k2))))))))))
(assert (forall ((j8 Int)) (=> (and (<= 1 j8) (<= j8 (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (and (and (and (in_range4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j8)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j8))))) (ite (< j8 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (get (rec__list_allocator__m__t__allocated model____split_fields4) (+ j8 1)) 0))) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__allocated model____split_fields4) j8))))) (ite (< 1 j8) (get (rec__list_allocator__m__t__allocated model____split_fields4) (- j8 1)) 0))) (forall ((k2 Int)) (=> (and (<= 1 k2) (<= k2 (length (rec__list_allocator__m__t__allocated model____split_fields4)))) (=> (not (= j8 k2)) (not (= (get (rec__list_allocator__m__t__allocated model____split_fields4) j8) (get (rec__list_allocator__m__t__allocated model____split_fields4) k2))))))))))
...
(assert (=> (not (= first_available2 0)) (and (= o133 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o133))))
(assert (=> (not (= first_available2 0)) (= result32 (ite (< 0 o133) true false))))
(assert (=> (not (= first_available2 0)) (=> (= result32 true) (and (= o132 (get (rec__list_allocator__m__t__available model____split_fields4) 1)) (in_range7 o132)))))
(assert (=> (not (= first_available2 0)) (=> (= result32 true) (= result31 (ite (= o132 first_available2) true false)))))
(assert (=> (not (= first_available2 0)) (=> (not (= result32 true)) (= result31 false))))
(assert (=> (= first_available2 0) (and (= o134 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o134))))
(assert (=> (= first_available2 0) (= result31 (ite (= o134 0) true false))))
(assert (=> (= result31 true) (=> (not (= first_allocated2 0)) (and (= o130 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o130)))))
(assert (=> (= result31 true) (=> (not (= first_allocated2 0)) (= result33 (ite (< 0 o130) true false)))))
(assert (=> (= result31 true) (=> (not (= first_allocated2 0)) (=> (= result33 true) (and (= o129 (get (rec__list_allocator__m__t__allocated model____split_fields4) 1)) (in_range7 o129))))))
(assert (=> (= result31 true) (=> (not (= first_allocated2 0)) (=> (= result33 true) (= result30 (ite (= o129 first_allocated2) true false))))))
(assert (=> (= result31 true) (=> (not (= first_allocated2 0)) (=> (not (= result33 true)) (= result30 false)))))
(assert (=> (= result31 true) (=> (= first_allocated2 0) (and (= o131 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o131)))))
(assert (=> (= result31 true) (=> (= first_allocated2 0) (= result30 (ite (= o131 0) true false)))))
(assert (=> (not (= result31 true)) (= result30 false)))
(assert (=> (= result30 true) (and (= o123 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o123))))
(assert (=> (= result30 true) (= o124 (ite (<= j6 o123) true false))))
(assert (=> (= result30 true) (= result34 (ite (<= 1 j6) o124 false))))
(assert (=> (= result30 true) (= (= result29 true) (forall ((j8 Int)) (=> (and (<= 1 j8) (<= j8 (length (rec__list_allocator__m__t__available model____split_fields4)))) (and (in_range4 (get (rec__list_allocator__m__t__available model____split_fields4) j8)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get (rec__list_allocator__m__t__available model____split_fields4) j8))))) (ite (< j8 (length (rec__list_allocator__m__t__available model____split_fields4))) (get (rec__list_allocator__m__t__available model____split_fields4) (+ j8 1)) 0))))))))
(assert (=> (not (= result30 true)) (= result29 false)))
(assert (= result29 true))
(assert (and (= o117 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o117)))
(assert (= o118 (ite (<= j5 o117) true false)))
(assert (= result37 (ite (<= 1 j5) o118 false)))
(assert (= result37 true))
(assert (and (= o122 (get (rec__list_allocator__m__t__allocated model____split_fields4) j5)) (in_range7 o122)))
(assert (= result38 (ite (in_range4 o122) true false)))
(assert (= result38 true))
(assert (and (= o119 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o119)))
(assert (= result39 (ite (< j5 o119) true false)))
(assert (= result39 true))
(assert (not (in_range1 (+ j5 1))))
(check-sat)
(exit)
