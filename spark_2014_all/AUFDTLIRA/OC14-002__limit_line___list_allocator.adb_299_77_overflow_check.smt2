...
(assert (=> (not (= first_available1 0)) (and (= o68 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o68))))
(assert (=> (not (= first_available1 0)) (= result13 (ite (< 0 o68) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (and (= o67 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o67)))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (= result12 (ite (= o67 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result13 true)) (= result12 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o69 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o69))))
(assert (=> (not (not (= first_available1 0))) (= result12 (ite (= o69 0) true false))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (and (= o65 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o65)))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (= result14 (ite (< 0 o65) true false)))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (=> (= result14 true) (and (= o64 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range7 o64))))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (=> (= result14 true) (= result11 (ite (= o64 first_allocated2) true false))))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (=> (not (= result14 true)) (= result11 false)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated2 0))) (and (= o66 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o66)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated2 0))) (= result11 (ite (= o66 0) true false)))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o62 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o62))))
(assert (=> (= result11 true) (= o63 (ite (<= j1 o62) true false))))
(assert (=> (= result11 true) (= result15 (ite (<= 1 j1) o63 false))))
...
(assert (and (= o61 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 o61)))
(assert (= result17 (ite (in_range4 o61) true false)))
