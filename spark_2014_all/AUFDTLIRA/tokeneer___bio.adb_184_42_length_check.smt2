...
(assert (= o30 result__))
(assert (= o30 temp___1535))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___15351))
(assert (not (= (ite (<= (to_rep1 (first6 temp___15321)) (to_rep1 (last6 temp___15321))) (+ (- (to_rep1 (last6 temp___15321)) (to_rep1 (first6 temp___15321))) 1) 0) (ite (<= (to_rep1 (first6 temp___15351)) (to_rep1 (last6 temp___15351))) (+ (- (to_rep1 (last6 temp___15351)) (to_rep1 (first6 temp___15351))) 1) 0))))
(check-sat)
(exit)
