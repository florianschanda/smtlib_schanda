...
(declare-const thecurrentfloppy3 us_rep)
...
(assert (=> (= dataok true) (= (mk_int__ref result1) status5)))
(assert (=> (= dataok true) (= status1 3)))
(assert (=> (= dataok true) (= (valid_numberlogentries state5) true)))
(assert (=> (not (= dataok true)) (= (mk_int__ref result2) status5)))
(assert (=> (not (= dataok true)) (= status2 2)))
(assert (=> (not (= dataok true)) (= (valid_numberlogentries state8) true)))
(assert (=> (not (= dataok true)) (= state3 state6)))
...
(assert (not (or (and (= status3 3) (= (privatekeypresent state10) true)) (and (= status3 2) (not (= (privatekeypresent state10) true))))))
(check-sat)
(exit)
