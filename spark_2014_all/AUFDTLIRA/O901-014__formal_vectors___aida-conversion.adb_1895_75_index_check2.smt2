...
(assert (and (= (length source) 10) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9))) (= (is_digit (to_rep (select (elts source) index2))) true))))))
