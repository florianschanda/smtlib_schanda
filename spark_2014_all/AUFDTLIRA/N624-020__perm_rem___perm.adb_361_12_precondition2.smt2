...
(define-fun o24 () us_t (mk___t o21 o22))
(define-fun o25 () us_t (mk___t o19 o20))
(define-fun o26 () us_t (mk___t o17 o18))
(define-fun o27 () us_t (mk___t o10 o11))
(define-fun o28 () us_t (mk___t o7 o8))
(define-fun o29 () us_t (mk___t o5 o6))
...
(define-fun ia23 () int__ref (mk_int__ref ia2))
...
(assert (=> (< ib ib2) (and (= o3 (get_witness bb2 aa ib)) (and (in_range3 o3) (and (and (<= (to_rep1 (first (rt aa))) o3) (<= o3 (to_rep1 (last (rt aa))))) (and (= (to_rep (select (elts bb2) ib)) (to_rep (select (elts aa) o3))) (= (is_perm (remove bb2 ib) (remove aa o3)) true)))))))
(assert (=> (< ib ib2) (= (mk_int__ref result3) ia23)))
(assert (=> (< ib ib2) (= ia21 o3)))
(assert (=> (< ib ib2) (and (= o4 (remove_swap b ib ib2)) (and (in_range4 o4) (=> (= (distinct o4 0) true) (= (let ((temp___182 (remove (remove b ib2) ib))) (let ((temp___181 (remove (remove b ib) (- ib2 1)))) (bool_eq (elts temp___181) (to_rep1 (first (rt temp___181))) (to_rep1 (last (rt temp___181))) (elts temp___182) (to_rep1 (first (rt temp___182))) (to_rep1 (last (rt temp___182)))))) true))))))
(assert (=> (< ib ib2) (= h3 result4)))
(assert (=> (< ib ib2) (= h4 o4)))
(assert (=> (< ib ib2) (= (distinct h4 0) true)))
(assert (=> (< ib ib2) (and (= o9 (- ib2 1)) (in_range3 (- ib2 1)))))
(assert (=> (< ib ib2) (and (= o27 (remove bb o9)) (and (dynamic_invariant o27 true false true true) (and (= (invariant__ o27) true) (and (= (to_rep1 (last o11)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o9 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o10 k))))) (and (forall ((k Int)) (=> (and (<= (+ o9 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o10 (- k 1)))))) (forall ((k Int)) (=> (and (<= o9 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o10 k)))))))))))))
(assert (=> (< ib ib2) (and (= o28 (remove aa ia21)) (and (dynamic_invariant o28 true false true true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last o8)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia21 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o7 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia21 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o7 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia21 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o7 k)))))))))))))
(assert (=> (< ib ib2) (and (= o29 (remove bb2 ib)) (and (dynamic_invariant o29 true false true true) (and (= (invariant__ o29) true) (and (= (to_rep1 (last o6)) (- (to_rep1 (last (rt bb2))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib 1))) (= (to_rep (select (elts bb2) k)) (to_rep (select o5 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib 1) k) (<= k (to_rep1 (last (rt bb2))))) (= (to_rep (select (elts bb2) k)) (to_rep (select o5 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib k) (<= k (- (to_rep1 (last (rt bb2))) 1))) (= (to_rep (select (elts bb2) (+ k 1))) (to_rep (select o5 k)))))))))))))
(assert (=> (< ib ib2) (and (= o12 (shift_perm_l o29 o28 o27)) (and (in_range4 o12) (=> (= (distinct o12 0) true) (= (is_perm o27 o28) true))))))
(assert (=> (< ib ib2) (= h4 result5)))
(assert (=> (< ib ib2) (= h5 o12)))
(assert (=> (< ib ib2) (= (distinct h5 0) true)))
(assert (=> (not (< ib ib2)) (and (= o13 (- ib 1)) (in_range3 (- ib 1)))))
(assert (=> (not (< ib ib2)) (and (= o14 (get_witness bb2 aa o13)) (and (in_range3 o14) (and (and (<= (to_rep1 (first (rt aa))) o14) (<= o14 (to_rep1 (last (rt aa))))) (and (= (to_rep (select (elts bb2) o13)) (to_rep (select (elts aa) o14))) (= (is_perm (remove bb2 o13) (remove aa o14)) true)))))))
(assert (=> (not (< ib ib2)) (= result6 ia23)))
(assert (=> (not (< ib ib2)) (= ia22 o14)))
(assert (=> (not (< ib ib2)) (and (= o15 (remove_swap b ib2 ib)) (and (in_range4 o15) (=> (= (distinct o15 0) true) (= (let ((temp___182 (remove (remove b ib) ib2))) (let ((temp___181 (remove (remove b ib2) (- ib 1)))) (bool_eq (elts temp___181) (to_rep1 (first (rt temp___181))) (to_rep1 (last (rt temp___181))) (elts temp___182) (to_rep1 (first (rt temp___182))) (to_rep1 (last (rt temp___182)))))) true))))))
(assert (=> (not (< ib ib2)) (= result7 (mk_int__ref h3))))
(assert (=> (not (< ib ib2)) (= h6 o15)))
(assert (=> (not (< ib ib2)) (= (distinct h6 0) true)))
(assert (=> (not (< ib ib2)) (and (= o24 (remove bb ib2)) (and (dynamic_invariant o24 true false true true) (and (= (invariant__ o24) true) (and (= (to_rep1 (last o22)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib2 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o21 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib2 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o21 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib2 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o21 k)))))))))))))
(assert (=> (not (< ib ib2)) (and (= o25 (remove aa ia22)) (and (dynamic_invariant o25 true false true true) (and (= (invariant__ o25) true) (and (= (to_rep1 (last o20)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia22 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o19 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia22 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o19 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia22 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o19 k)))))))))))))
(assert (=> (not (< ib ib2)) (and (= o16 (- ib 1)) (in_range3 (- ib 1)))))
(assert (=> (not (< ib ib2)) (and (= o26 (remove bb2 o16)) (and (dynamic_invariant o26 true false true true) (and (= (invariant__ o26) true) (and (= (to_rep1 (last o18)) (- (to_rep1 (last (rt bb2))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o16 1))) (= (to_rep (select (elts bb2) k)) (to_rep (select o17 k))))) (and (forall ((k Int)) (=> (and (<= (+ o16 1) k) (<= k (to_rep1 (last (rt bb2))))) (= (to_rep (select (elts bb2) k)) (to_rep (select o17 (- k 1)))))) (forall ((k Int)) (=> (and (<= o16 k) (<= k (- (to_rep1 (last (rt bb2))) 1))) (= (to_rep (select (elts bb2) (+ k 1))) (to_rep (select o17 k)))))))))))))
(assert (=> (not (< ib ib2)) (and (= o23 (shift_perm_l o26 o25 o24)) (and (in_range4 o23) (=> (= (distinct o23 0) true) (= (is_perm o24 o25) true))))))
(assert (=> (not (< ib ib2)) (= result8 (mk_int__ref h6))))
(assert (=> (not (< ib ib2)) (= h7 o23)))
(assert (=> (not (< ib ib2)) (= (distinct h7 0) true)))
(assert (=> (not (< ib ib2)) (= ia21 ia22)))
(assert (=> (not (< ib ib2)) (= h5 h7)))
