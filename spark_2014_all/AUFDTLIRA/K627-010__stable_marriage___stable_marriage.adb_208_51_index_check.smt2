...
(assert (= result true))
(assert (= (= o3 true) (forall ((g1_id Int)) (=> (and (<= 1 g1_id) (<= g1_id 64)) (=> (forall ((idx1 Int)) (=> (and (<= 1 idx1) (<= idx1 (to_rep2 unmatched_g1_set__split_fields1))) (not (= (to_rep (select unmatched_g1_set__split_fields idx1)) g1_id)))) (and (< 0 (to_rep2 (select proposals_made g1_id))) (= (to_rep (select result__ (to_rep3 (select (select ranking_1 g1_id) (to_rep2 (select proposals_made g1_id)))))) g1_id)))))))
(assert (= (= o2 true) (forall ((g1_id Int)) (=> (and (<= 1 g1_id) (<= g1_id 64)) (=> (= (to_rep2 (select proposals_made g1_id)) 0) (exists ((idx1 Int)) (and (and (<= 1 idx1) (<= idx1 (to_rep2 unmatched_g1_set__split_fields1))) (= (to_rep (select unmatched_g1_set__split_fields idx1)) g1_id))))))))
...
(assert (<= 1 idx))
(assert (<= idx (to_rep2 unmatched_g1_set__split_fields1)))
(assert (not (<= idx 64)))
(check-sat)
(exit)
