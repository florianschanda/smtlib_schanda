...
(assert (= result true))
(assert (= (= o3 true) (forall ((g1_id Int)) (=> (and (<= 1 g1_id) (<= g1_id 64)) (=> (forall ((idx1 Int)) (=> (and (<= 1 idx1) (<= idx1 (to_rep3 unmatched_g1_set__split_fields1))) (not (= (to_rep (select unmatched_g1_set__split_fields idx1)) g1_id)))) (and (< 0 (to_rep3 (select proposals_made g1_id))) (= (to_rep (select result__ (to_rep1 (select (select ranking_1 g1_id) (to_rep3 (select proposals_made g1_id)))))) g1_id)))))))
(assert (= (= o2 true) (forall ((g1_id Int)) (=> (and (<= 1 g1_id) (<= g1_id 64)) (=> (= (to_rep3 (select proposals_made g1_id)) 0) (exists ((idx1 Int)) (and (and (<= 1 idx1) (<= idx1 (to_rep3 unmatched_g1_set__split_fields1))) (= (to_rep (select unmatched_g1_set__split_fields idx1)) g1_id))))))))
