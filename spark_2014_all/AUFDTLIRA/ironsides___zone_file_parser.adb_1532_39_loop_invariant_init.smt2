...
(assert (= i6 r97b))
(assert (=> (and (<= r97b i6) (<= i6 r98b)) (and (and (= temp___1736 endidx10) (and (= temp___1734 newnameserver1) (and (= temp___1733 i6) (and (and (and (<= 1 begidx13) (<= (+ (- endidx10 begidx13) 1) 128)) (= endidx10 temp___1736)) (and (and (=> (<= r97b r98b) (dynamic_property r97b r98b i7)) (and (<= r97b i7) (<= i7 r98b))) (and (and (and (= (to_rep o5) (to_rep (select zonefileline i7))) (and (and (and (and (and (= o3 (+ i7 1)) (in_range1 (+ i7 1))) (= o4 (- o3 begidx13))) (and (= temp___1732 o4) (in_range1 o4))) (and (and (<= 1 temp___1732) (<= temp___1732 128)) (= o6 temp___1732))) (= o7 (store newnameserver2 o6 o5)))) (and (= result10 (mk_map__ref newnameserver2)) (= newnameserver3 o7))) (= i7 r98b))))))) (and (and (= i13 (mk_int__ref i7)) (= newnameserver8 (mk_map__ref newnameserver3))) (and (= i14 i7) (= newnameserver9 newnameserver3))))))
(assert (=> (and (<= r97b i6) (<= i6 r98b)) (= i15 i13)))
(assert (=> (and (<= r97b i6) (<= i6 r98b)) (= newnameserver10 newnameserver8)))
(assert (=> (and (<= r97b i6) (<= i6 r98b)) (= i16 i14)))
(assert (=> (and (<= r97b i6) (<= i6 r98b)) (= newnameserver11 newnameserver9)))
(assert (=> (not (and (<= r97b i6) (<= i6 r98b))) (= i15 (mk_int__ref i6))))
(assert (=> (not (and (<= r97b i6) (<= i6 r98b))) (= newnameserver10 (mk_map__ref newnameserver1))))
(assert (=> (not (and (<= r97b i6) (<= i6 r98b))) (= i16 i6)))
(assert (=> (not (and (<= r97b i6) (<= i6 r98b))) (= newnameserver11 newnameserver1)))
(assert (= (+ endidx10 1) r100b))
