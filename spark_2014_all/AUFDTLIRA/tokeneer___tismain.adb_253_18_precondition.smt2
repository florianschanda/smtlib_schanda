...
(assert (forall ((x statscount)) (! (in_range8 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun us_rep___18__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
...
(define-fun dynamic_invariant5 ((temp___expr_261 Int) (temp___is_init_258 Bool) (temp___skip_constant_259 Bool) (temp___do_toplevel_260 Bool)) Bool (=> (or (= temp___is_init_258 true) (<= 0 4)) (in_range5 temp___expr_261)))
(define-fun dynamic_invariant6 ((temp___expr_185 Int) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool)) Bool (=> (or (= temp___is_init_182 true) (<= 1 3)) (in_range7 temp___expr_185)))
(assert true)
(define-fun dynamic_invariant7 ((temp___expr_324 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= 1 150)) (in_range6 temp___expr_324)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant8 ((temp___expr_1240 Int) (temp___is_init_1237 Bool) (temp___skip_constant_1238 Bool) (temp___do_toplevel_1239 Bool)) Bool (=> (or (= temp___is_init_1237 true) (<= 0 2147483647)) (in_range8 temp___expr_1240)))
...
(assert (and (not (= (ispresent (mk___rep theadmin__split_fields)) true)) (not (= (isdoingop (mk___rep theadmin__split_fields)) true))))
(assert (= (valid_numberlogentries state1) true))
(assert (= o (privatekeypresent state2)))
(assert (= o1 (privatekeypresent state2)))
(assert (and (and (not (= (isgood state4) true)) (not (= (authcertvalid state4) true))) (not (in_range7 (theauthcertrole state4)))))
(assert (and (= (= (privatekeypresent state2) true) (not (= (enrolmentisinprogress (let ((subject state)) state5)) true))) (or (= (enrolmentisinprogress (let ((subject state)) state5)) true) (= (statusisenclavequiescent (let ((subject state)) state5)) true))))
(assert (= result (privatekeypresent state2)))
(assert (not (= result true)))
(assert (not (= (valid_numberlogentries state3) true)))
(check-sat)
(exit)
