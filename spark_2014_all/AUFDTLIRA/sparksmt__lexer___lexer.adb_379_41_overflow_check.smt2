...
(assert (or (= (to_rep3 (rec__file_io__read_result__status current_read__split_discrs2)) 1) (= (to_rep3 (rec__file_io__read_result__status current_read__split_discrs2)) 2)))
(assert (< current_col2 2147483647))
(assert (= (to_rep5 (rec__lexer__token__kind t__split_discrs1)) r54b))
(assert (in_range9 r54b))
(assert (= (to_rep2 o2) 0))
(assert (not (in_range1 (+ current_col2 1))))
(check-sat)
(exit)
