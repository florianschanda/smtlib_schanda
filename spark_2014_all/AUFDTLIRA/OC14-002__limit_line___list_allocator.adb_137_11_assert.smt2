...
(assert (<= 1 j12))
(assert (<= j12 (- (length (rec__list_allocator__m__t__available model____split_fields4)) 1)))
(assert (not (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 (get ma1 (+ j12 1)))))) (get ma1 (+ j12 2)))))
(check-sat)
(exit)
