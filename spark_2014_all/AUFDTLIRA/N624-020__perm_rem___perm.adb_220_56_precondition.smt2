...
(assert (and (= o12 (remove a o5)) (and (dynamic_invariant2 o12 true false true true) (and (= (invariant__ o12) true) (and (= (to_rep2 (last o7)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o5 1))) (= (to_rep (select (elts a) k)) (to_rep (select o6 k))))) (and (forall ((k Int)) (=> (and (<= (+ o5 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o6 (- k 1)))))) (forall ((k Int)) (=> (and (<= o5 k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o6 k))))))))))))
(assert (and (= o11 (remove o12 o8)) (and (dynamic_invariant2 o11 true false true true) (and (= (invariant__ o11) true) (and (= (to_rep2 (last o10)) (- (to_rep2 (last o7)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o8 1))) (= (to_rep (select o6 k)) (to_rep (select o9 k))))) (and (forall ((k Int)) (=> (and (<= (+ o8 1) k) (<= k (to_rep2 (last o7)))) (= (to_rep (select o6 k)) (to_rep (select o9 (- k 1)))))) (forall ((k Int)) (=> (and (<= o8 k) (<= k (- (to_rep2 (last o7)) 1))) (= (to_rep (select o6 (+ k 1))) (to_rep (select o9 k))))))))))))
