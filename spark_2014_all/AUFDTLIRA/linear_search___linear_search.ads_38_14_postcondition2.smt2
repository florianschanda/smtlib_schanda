...
(assert (=> (forall ((j Int)) (=> (and (<= 1 j) (<= j 10)) (not (= (to_rep (select a j)) val__)))) (not (= (rec__linear_search__search_result__found (us_split_discrs1 (search_result__content linear_search__search__result18))) true))))
...
(assert (not (= (to_rep (select a (to_rep1 (rec__linear_search__search_result__at_index (us_split_fields1 (search_result__content linear_search__search__result18)))))) val__)))
(check-sat)
(exit)
