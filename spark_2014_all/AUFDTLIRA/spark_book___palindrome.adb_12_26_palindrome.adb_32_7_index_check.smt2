...
(assert (=> (<= 1 r5b) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 r5b) (<= r5b 100)))))
(assert (= o9 line1))
(assert (= o9 temp___603))
(assert (= (mk4 1 r5b) temp___6031))
(assert (and (<= (to_rep1 (first8 temp___6031)) left_index2) (<= left_index2 (to_rep1 (last8 temp___6031)))))
(assert (= o10 left_index2))
(assert (= o11 (select temp___603 o10)))
(assert (= o12 (to_rep o11)))
(assert (=> (<= 1 r5b) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 r5b) (<= r5b 100)))))
(assert (= o8 line1))
(assert (= o8 temp___601))
(assert (= (mk3 1 r5b) temp___6011))
(assert (not (<= (to_rep1 (first6 temp___6011)) right_index2)))
(check-sat)
(exit)
