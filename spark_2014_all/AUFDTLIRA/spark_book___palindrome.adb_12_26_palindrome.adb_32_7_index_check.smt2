...
(assert (=> (<= 1 r5b) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 r5b) (<= r5b 100)))))
(assert (= o9 line1))
(assert (= o9 temp___596))
(assert (= (mk4 1 r5b) temp___5961))
(assert (and (<= (to_rep1 (first8 temp___5961)) left_index2) (<= left_index2 (to_rep1 (last8 temp___5961)))))
(assert (= o10 left_index2))
(assert (= o11 (select temp___596 o10)))
(assert (= o12 (to_rep o11)))
(assert (=> (<= 1 r5b) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 r5b) (<= r5b 100)))))
(assert (= o8 line1))
(assert (= o8 temp___594))
(assert (= (mk3 1 r5b) temp___5941))
(assert (not (<= right_index2 (to_rep1 (last6 temp___5941)))))
(check-sat)
(exit)
