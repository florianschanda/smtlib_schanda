...
(assert (=> (<= 1 r5b) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 r5b) (<= r5b 100)))))
(assert (= o11 line1))
(assert (= o11 temp___531))
(assert (= (mk4 1 r5b) temp___5311))
(assert (and (<= (to_rep1 (first8 temp___5311)) left_index2) (<= left_index2 (to_rep1 (last8 temp___5311)))))
(assert (= o12 left_index2))
(assert (= o13 (select temp___531 o12)))
(assert (= o14 (to_rep o13)))
(assert (=> (<= 1 r5b) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 r5b) (<= r5b 100)))))
(assert (= o8 line1))
(assert (= o8 temp___529))
(assert (= (mk3 1 r5b) temp___5291))
(assert (not (<= (to_rep1 (first6 temp___5291)) right_index2)))
(check-sat)
(exit)
