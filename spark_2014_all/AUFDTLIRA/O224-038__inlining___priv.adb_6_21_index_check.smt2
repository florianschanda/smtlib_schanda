...
(define-fun dynamic_invariant1 ((temp___expr_165 us_rep) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (let ((temp___166 (rec__priv__priv_rec__c (us_split_discrs1 temp___expr_165)))) (and (dynamic_property1 1 (to_rep temp___166) (first1 (rec__priv__priv_rec__content (us_split_fields1 temp___expr_165))) (last1 (rec__priv__priv_rec__content (us_split_fields1 temp___expr_165)))) (and (= (first1 (rec__priv__priv_rec__content (us_split_fields1 temp___expr_165))) 1) (= (last1 (rec__priv__priv_rec__content (us_split_fields1 temp___expr_165))) (to_rep temp___166))))))
...
(declare-const p__split_fields (Array Int natural))
(declare-const p__split_fields1 t)
(declare-const o natural)
(assert (dynamic_invariant1 (mk___rep p__split_discrs (mk___split_fields (mk___t p__split_fields p__split_fields1))) true false true true))
(assert (in_range2 i))
(assert (<= 1 i))
(assert (<= i (to_rep (rec__priv__priv_rec__c p__split_discrs))))
(assert (= (to_rep o) 0))
(assert (not (<= (to_rep1 (first p__split_fields1)) i)))
(check-sat)
(exit)
