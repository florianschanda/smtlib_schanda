...
(define-fun dynamic_invariant1 ((temp___expr_141 us_rep) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (let ((temp___142 (rec__priv__priv_rec__c (us_split_discrs1 temp___expr_141)))) (and (dynamic_property1 1 (to_rep temp___142) (first1 (rec__priv__priv_rec__content (us_split_fields1 temp___expr_141))) (last1 (rec__priv__priv_rec__content (us_split_fields1 temp___expr_141)))) (and (= (first1 (rec__priv__priv_rec__content (us_split_fields1 temp___expr_141))) 1) (= (last1 (rec__priv__priv_rec__content (us_split_fields1 temp___expr_141))) (to_rep temp___142))))))
...
(assert (dynamic_invariant1 (mk___rep p__split_discrs (mk___split_fields (mk___t p__split_fields p__split_fields1))) true false true))
(assert (in_range2 i))
(assert (<= 1 i))
