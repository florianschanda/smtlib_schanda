...
(assert (forall ((temp___205 (Array Int integer))) (forall ((temp___206 Int) (temp___207 Int)) (let ((temp___204 (temp___203 temp___205 temp___206 temp___207))) (forall ((temp___208 Int)) (ite (= temp___208 temp___206) (= (select temp___204 temp___208) (of_rep temp___207)) (= (select temp___204 temp___208) (select temp___205 temp___208))))))))
...
(assert (and (= (bool_eq a (- 2147483648) 2147483647 (temp___203 b 23 42) (- 2147483648) 2147483647) true) (= (bool_eq a (- 2147483648) 2147483647 c (- 2147483648) 2147483647) true)))
