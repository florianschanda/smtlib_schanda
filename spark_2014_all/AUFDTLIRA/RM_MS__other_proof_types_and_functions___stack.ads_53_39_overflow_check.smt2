...
(assert (and (= o12 (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (and (in_range2 o12) (= o12 (to_rep1 my_stack__split_fields7)))))
(assert (and (= o13 (stack_entry o12 (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (and (in_range1 o13) (= o13 (to_rep (select my_stack__split_fields6 o12))))))
(assert (= o14 (ite (= o13 x) true false)))
(assert (and (= o9 (max_stack_size Tuple0)) (and (in_range2 o9) (= o9 100))))
(assert (and (= o10 (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (and (in_range2 o10) (= o10 (to_rep1 my_stack__split_fields7)))))
