...
(assert (and (= o13 (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (and (in_range2 o13) (= o13 (to_rep1 my_stack__split_fields7)))))
(assert (and (= o14 (stack_entry o13 (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (and (in_range1 o14) (= o14 (to_rep (select my_stack__split_fields6 o13))))))
(assert (= o15 (ite (= o14 x) true false)))
(assert (and (= o10 (max_stack_size Tuple0)) (and (in_range2 o10) (= o10 100))))
(assert (and (= o11 (count (mk___split_fields my_stack__split_fields6 my_stack__split_fields7))) (and (in_range2 o11) (= o11 (to_rep1 my_stack__split_fields7)))))
