...
(assert (< (to_rep (rec__my_container_model__cursor__index (us_split_fields1 p))) 100))
(assert (not (in_range (+ (to_rep (rec__my_container_model__cursor__index (us_split_fields1 p))) 1))))
(check-sat)
(exit)
