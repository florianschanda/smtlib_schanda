...
(assert (= (bool_eq a1 0 5 a_update 0 5) true))
(assert (and (= o76 (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c4)) (= (= o76 true) (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c4) true))))
(assert (= o77 true))
(assert (= result14 (ite (= o77 true) o76 false)))
(assert (= result14 true))
(assert (not (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c4) true)))
(check-sat)
(exit)
