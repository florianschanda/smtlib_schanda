...
(declare-fun temp_____aggregate_def_3748 ((Array Int us_rep) Int us_rep Int us_rep) (Array Int us_rep))
(declare-fun temp_____aggregate_def_3756 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (forall ((temp___3750 (Array Int us_rep))) (forall ((temp___3751 Int) (temp___3753 Int)) (forall ((temp___3752 us_rep) (temp___3754 us_rep)) (let ((temp___3749 (temp_____aggregate_def_3748 temp___3750 temp___3751 temp___3752 temp___3753 temp___3754))) (=> (and (dynamic_invariant1 temp___3751 true true true true) (dynamic_invariant1 temp___3753 true true true true)) (forall ((temp___3755 Int)) (ite (= temp___3755 temp___3753) (= (select temp___3749 temp___3755) temp___3754) (ite (= temp___3755 temp___3751) (= (select temp___3749 temp___3755) temp___3752) (= (select temp___3749 temp___3755) (select temp___3750 temp___3755)))))))))))
(assert (forall ((temp___3758 (Array Int et1))) (forall ((temp___3759 Int) (temp___3760 Int)) (let ((temp___3757 (temp_____aggregate_def_3756 temp___3758 temp___3759 temp___3760))) (=> (and (dynamic_invariant temp___3759 true true true true) (dynamic_invariant2 temp___3760 true true true true)) (forall ((temp___3761 Int)) (ite (= temp___3761 temp___3759) (= (to_rep (select temp___3757 temp___3761)) temp___3760) (= (select temp___3757 temp___3761) (select temp___3758 temp___3761)))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq2 a3 1 16 (temp_____aggregate_def_3748 a x r i (mk___rep (mk___split_fields (temp_____aggregate_def_3756 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e) (rec__ar__rofa1__t1 (us_split_fields1 (select a i)))))) 1 16) true)))
(check-sat)
(exit)
