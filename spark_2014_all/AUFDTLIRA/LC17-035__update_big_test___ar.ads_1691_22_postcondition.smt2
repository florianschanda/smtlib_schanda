...
(declare-fun temp___3748 ((Array Int us_rep) Int us_rep Int us_rep) (Array Int us_rep))
(declare-fun temp___3756 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq2 a3 1 16 (temp___3748 a x r i (mk___rep (mk___split_fields (temp___3756 (rec__ar__rofa1__s1 (us_split_fields1 (select a i))) j e) (rec__ar__rofa1__t1 (us_split_fields1 (select a i)))))) 1 16) true)))
(check-sat)
(exit)
