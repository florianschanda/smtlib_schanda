...
(assert (= result3 true))
(assert (and (= o8 (key (mk___rep d__split_discrs d__split_fields1) c)) (and (in_range3 o8) (= o8 (get (keys (mk___rep d__split_discrs d__split_fields1)) (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c))))))
