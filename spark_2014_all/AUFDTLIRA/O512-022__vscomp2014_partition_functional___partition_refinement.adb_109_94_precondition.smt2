...
(assert (and (= o70 (key (mk___rep d__split_discrs d__split_fields1) c2)) (and (in_range5 o70) (= o70 (get (keys (mk___rep d__split_discrs d__split_fields1)) (get1 (positions (mk___rep d__split_discrs d__split_fields1)) c2))))))
