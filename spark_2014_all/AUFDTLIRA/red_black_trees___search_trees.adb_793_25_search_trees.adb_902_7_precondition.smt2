...
(assert (and (= temp___838 (model__ (rec__search_trees__search_tree__struct t__split_fields9) y1)) (and (dynamic_invariant6 temp___838 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___838 y1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___838 y1)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 y1)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct t__split_fields9) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___838 (parent (rec__search_trees__search_tree__struct t__split_fields9) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___838 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___838 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___838 i5))) true) (not (= i5 y1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___838 (parent (rec__search_trees__search_tree__struct t__split_fields9) i5)))) (position (rec__search_trees__search_tree__struct t__split_fields9) i5) (rec__tree_model__path_type__a (us_split_fields1 (select temp___838 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___838 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___838 i5))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___838 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___838 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___838 j15)))) true)) (= j15 i5))))))))))))))
(assert (= o31 (select temp___838 x1)))
