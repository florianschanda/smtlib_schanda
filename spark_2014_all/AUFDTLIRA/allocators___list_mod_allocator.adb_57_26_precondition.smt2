...
(assert (and (= o12 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o12) (<= (+ 0 o12) 2147483647))))
(assert (= result3 (ite (<= o12 10000) true false)))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (and (= o10 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o10) (<= (+ 0 o10) 2147483647))))))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (= result4 (ite (< 0 o10) true false)))))
(assert (=> (= result3 true) (=> (not (= first_available 0)) (=> (= result4 true) (and (= o9 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) 1)) (in_range6 o9))))))
...
(assert (=> (= result3 true) (=> (not (not (= first_available 0))) (and (= o11 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o11) (<= (+ 0 o11) 2147483647))))))
(assert (=> (= result3 true) (=> (not (not (= first_available 0))) (= result2 (ite (= o11 0) true false)))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o7 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o7) (<= (+ 0 o7) 2147483647)))))
...
(assert (=> (= result1 true) (and (= o5 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o5) (<= (+ 0 o5) 2147483647)))))
...
(assert (= result8 true))
(assert (and (= o4 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) k)) (in_range6 o4)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
