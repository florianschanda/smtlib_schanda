...
(declare-fun temp___600 ((Array Int integer) Int Int) (Array Int integer))
(assert (forall ((temp___602 (Array Int integer))) (forall ((temp___603 Int) (temp___604 Int)) (let ((temp___601 (temp___600 temp___602 temp___603 temp___604))) (forall ((temp___605 Int)) (ite (= temp___605 temp___603) (= (select temp___601 temp___605) (of_rep temp___604)) (= (select temp___601 temp___605) (select temp___602 temp___605))))))))
(assert (in_range1 j))
(assert (in_range1 k))
(assert (in_range1 x))
(assert (not (= j k)))
(assert (not (= (to_rep (select (temp___600 a j x) k)) (to_rep (select a k)))))
(check-sat)
(exit)
