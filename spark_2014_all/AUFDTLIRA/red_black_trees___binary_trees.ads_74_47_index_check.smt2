...
(assert (and (= o67 (length (rec__tree_model__path_type__a (us_split_fields1 (select (map__content binary_trees__model__result4) root))))) (and (in_range5 o67) (<= (+ 0 o67) 2147483647))))
(assert (= result18 (ite (= o67 0) true false)))
(assert (= result18 true))
(assert (= (= result19 true) (forall ((i11 Int)) (=> (and (<= 1 i11) (<= i11 100)) (=> (not (= i11 root)) (ite (and (not (= (parent f i11) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content binary_trees__model__result4) (parent f i11)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content binary_trees__model__result4) i11))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content binary_trees__model__result4) i11))) true))))))))
...
(assert (not (= i1 root)))
(assert (= (tree_structure f) true))
(assert (and (= o66 (position f i1)) (and (in_range4 o66) (= o66 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i1))))))))
(assert (= (tree_structure f) true))
