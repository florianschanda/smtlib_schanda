...
(assert (= (= result22 true) (forall ((i12 Int)) (=> (and (<= 1 i12) (<= i12 100)) (=> (not (= i12 root)) (ite (and (not (= (parent f i12) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content binary_trees__model__result4) (parent f i12)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content binary_trees__model__result4) i12))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content binary_trees__model__result4) i12))) true))))))))
(assert (= result22 true))
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (map__content binary_trees__model__result4) i1))) true))
(assert (not (= i1 root)))
(assert (= (tree_structure f) true))
(assert (and (= o76 (position f i1)) (and (in_range4 o76) (= o76 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i1))))))))
(assert (= (tree_structure f) true))
(assert (and (= temp___657 (parent f i1)) (and (in_range2 temp___657) (and (= temp___657 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i1))))) (and (=> (= (valid_root f i1) true) (= temp___657 0)) (=> (= (size f) 0) (= temp___657 0)))))))
(assert (not (<= 1 temp___657)))
(check-sat)
(exit)
