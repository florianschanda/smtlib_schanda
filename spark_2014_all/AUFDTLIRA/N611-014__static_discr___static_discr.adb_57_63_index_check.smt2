...
(define-fun dynamic_invariant4 ((temp___expr_178 us_t3) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool) (temp___do_typ_inv_177 Bool)) Bool (=> (not (= temp___skip_constant_175 true)) (dynamic_property6 1 2147483647 (first7 temp___expr_178) (last7 temp___expr_178))))
...
(assert (dynamic_invariant1 (mk___rep4 current__split_discrs (mk___split_fields4 (mk___rep3 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields3 (mk___t2 current__split_fields2 current__split_fields3))) current__split_fields4)) true false true true))
...
(assert (= current__split_fields5 (mk___split_fields4 (mk___rep3 (mk___split_discrs temp___4222 temp___4223) (mk___split_fields3 (mk___t2 temp___4224 temp___4225))) temp___4226)))
(assert (= current__split_discrs (mk___split_discrs1 temp___422 temp___4221)))
