...
(define-fun to_base1 ((a us_rep3)) us_rep (mk___rep (us_split_discrs5 a) (mk___split_fields (let ((temp___139 (rec__static_discr__i_holder__content2 (us_split_fields7 a)))) (of_array (to_array2 temp___139) (first5 temp___139) (last5 temp___139))))))
(define-fun of_base1 ((r us_rep)) us_rep3 (mk___rep3 (us_split_discrs1 r) (mk___split_fields3 (let ((temp___138 (rec__static_discr__i_holder__content (us_split_fields1 r)))) (of_array2 (to_array temp___138) (first1 temp___138) (last1 temp___138))))))
...
(define-fun dynamic_invariant1 ((temp___expr_224 us_rep4) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool)) Bool (and (=> (not (= temp___skip_constant_222 true)) (in_range5 (last7 a) (last7 a) (to_base2 temp___expr_224))) (and (in_range4 (last7 a) (last7 a) (to_base1 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_224)))) (and (dynamic_property5 1 (last7 a) (first5 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_224))))) (last5 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_224)))))) (and (= (first5 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_224))))) 1) (= (last5 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_224))))) (last7 a)))))))
(define-fun default_initial_assumption ((temp___expr_230 us_rep4) (temp___skip_top_level_231 Bool)) Bool (and (and (= (to_rep (rec__static_discr__holder__unused (us_split_discrs6 temp___expr_230))) (last7 a)) (= (to_rep (rec__static_discr__holder__c (us_split_discrs6 temp___expr_230))) (last7 a))) (and (= (to_rep (rec__static_discr__i_holder__unused (us_split_discrs5 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_230))))) (last7 a)) (= (to_rep (rec__static_discr__i_holder__c (us_split_discrs5 (rec__static_discr__holder__content1 (us_split_fields9 temp___expr_230))))) (last7 a)))))
(declare-const current__split_discrs us_split_discrs3)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(define-fun dynamic_invariant2 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range6 temp___expr_39)))
...
(define-fun dynamic_invariant4 ((temp___expr_155 us_t3) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (=> (not (= temp___skip_constant_153 true)) (dynamic_property6 1 2147483647 (first7 temp___expr_155) (last7 temp___expr_155))))
...
(declare-const temp___390 natural)
(declare-const temp___3901 natural)
(declare-const temp___3902 natural)
(declare-const temp___3903 natural)
(declare-const temp___3904 (Array Int natural))
(declare-const temp___3905 t2)
(declare-const temp___3906 natural)
(declare-const i Int)
...
(assert (dynamic_invariant1 (mk___rep4 current__split_discrs (mk___split_fields4 (mk___rep3 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields3 (mk___t2 current__split_fields2 current__split_fields3))) current__split_fields4)) true false true))
...
(assert (and (<= (to_rep1 (first4 current__split_fields3)) (to_rep current__split_fields4)) (<= (to_rep current__split_fields4) (to_rep1 (last4 current__split_fields3)))))
(assert (= o (to_rep current__split_fields4)))
(assert (= o1 (select current__split_fields2 o)))
(assert (= o2 (to_rep o1)))
(assert (= result (ite (= o2 e) true false)))
(assert (=> (= result true) (= (mk_int__ref result1) (mk_int__ref result__))))
(assert (=> (= result true) (= result__1 (to_rep current__split_fields4))))
(assert (=> (not (= result true)) (= (mk_int__ref result2) (mk_int__ref result__))))
...
(assert (= o4 o9))
(assert (= current__split_discrs (mk___split_discrs1 temp___390 temp___3901)))
(assert (= temp___3902 o5))
(assert (= temp___3903 o6))
(assert (= temp___3904 o7))
(assert (= temp___3905 o8))
(assert (= temp___3906 o9))
(assert (= result3 (mk___split_fields__ref4 (mk___split_fields4 (mk___rep3 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields3 (mk___t2 current__split_fields2 current__split_fields3))) current__split_fields4))))
(assert (= current__split_fields5 (mk___split_fields4 (mk___rep3 (mk___split_discrs temp___3902 temp___3903) (mk___split_fields3 (mk___t2 temp___3904 temp___3905))) temp___3906)))
(assert (= current__split_discrs (mk___split_discrs1 temp___390 temp___3901)))
...
(assert (= (bool_eq (elts2 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields__content4 current__split_fields6))))) (to_rep1 (first4 (rt2 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields__content4 current__split_fields6))))))) (to_rep1 (last4 (rt2 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields__content4 current__split_fields6))))))) current__split_fields2 (to_rep1 (first4 current__split_fields3)) (to_rep1 (last4 current__split_fields3))) true))
...
(assert (not (<= (to_rep1 (first4 (rt2 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields__content4 current__split_fields6))))))) (int__content result__3))))
(check-sat)
(exit)
