...
(declare-const temp___422 natural)
(declare-const temp___4221 natural)
(declare-const temp___4222 natural)
(declare-const temp___4223 natural)
(declare-const temp___4224 (Array Int natural))
(declare-const temp___4225 t3)
(declare-const temp___4226 natural)
...
(declare-const current__split_fields6 us_split_fields__ref4)
...
(assert (dynamic_invariant2 (mk___rep4 current__split_discrs (mk___split_fields4 (mk___rep3 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields3 (mk___t3 current__split_fields2 current__split_fields3))) current__split_fields4)) true false true true))
(assert (=> (<= 0 2147483647) (in_range2 result__)))
(assert (dynamic_invariant1 a true false true true))
(assert (in_range2 e))
(assert (and (<= 1 (to_rep current__split_fields4)) (<= (to_rep current__split_fields4) (to_rep (rec__static_discr__holder__c current__split_discrs)))))
(assert (and (<= (to_rep1 (first6 current__split_fields3)) (to_rep current__split_fields4)) (<= (to_rep current__split_fields4) (to_rep1 (last6 current__split_fields3)))))
...
(assert (and (= o3 (- (to_rep current__split_fields4) 1)) (in_range2 (- (to_rep current__split_fields4) 1))))
(assert (= (to_rep o4) o3))
...
(assert (= o4 o9))
(assert (= current__split_discrs (mk___split_discrs1 temp___422 temp___4221)))
(assert (= temp___4222 o5))
(assert (= temp___4223 o6))
(assert (= temp___4224 o7))
(assert (= temp___4225 o8))
(assert (= temp___4226 o9))
(assert (= result3 (mk___split_fields__ref4 (mk___split_fields4 (mk___rep3 (mk___split_discrs current__split_fields current__split_fields1) (mk___split_fields3 (mk___t3 current__split_fields2 current__split_fields3))) current__split_fields4))))
(assert (= current__split_fields5 (mk___split_fields4 (mk___rep3 (mk___split_discrs temp___4222 temp___4223) (mk___split_fields3 (mk___t3 temp___4224 temp___4225))) temp___4226)))
(assert (= current__split_discrs (mk___split_discrs1 temp___422 temp___4221)))
(assert (= result__3 (mk_int__ref result__1)))
(assert (= current__split_fields6 (mk___split_fields__ref4 current__split_fields5)))
(assert (= result__4 result__1))
(assert (= current__split_fields7 current__split_fields5))
(assert (= (bool_eq (elts3 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields__content4 current__split_fields6))))) (to_rep1 (first6 (rt3 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields__content4 current__split_fields6))))))) (to_rep1 (last6 (rt3 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields__content4 current__split_fields6))))))) current__split_fields2 (to_rep1 (first6 current__split_fields3)) (to_rep1 (last6 current__split_fields3))) true))
(assert (< (to_rep (rec__static_discr__holder__length1 (us_split_fields__content4 current__split_fields6))) (to_rep current__split_fields4)))
(assert (not (= (int__content result__3) 0)))
(assert (<= (to_rep (rec__static_discr__holder__length1 (us_split_fields__content4 current__split_fields6))) (int__content result__3)))
(assert (<= (int__content result__3) (to_rep current__split_fields4)))
(assert (not (<= (int__content result__3) (to_rep1 (last6 (rt3 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 (us_split_fields__content4 current__split_fields6))))))))))
(check-sat)
(exit)
