...
(define-fun dynamic_invariant ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 1 10)) (in_range2 temp___expr_208)))
...
(define-fun dynamic_invariant1 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_159)))
(assert true)
...
(assert (in_range2 y))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j 10)) (=> (= (to_rep (select x j)) 0) (exists ((k Int)) (and (and (<= 1 k) (<= k 10)) (= (property (to_rep (select x k)) j) true)))))))
(assert (= (bool_eq x 1 10 (all_zero Tuple0) 1 10) true))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j 10))
(assert (not (exists ((k Int)) (and (and (<= 1 k) (<= k 10)) (= (property (to_rep (select x k)) j) true)))))
(check-sat)
(exit)
