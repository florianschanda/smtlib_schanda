...
(assert (= (bool_eq (elts (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a))))) (to_rep1 (first (rt (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a))))))) (to_rep1 (last (rt (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a))))))) (elts (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content current__split_fields6)))) (to_rep1 (first (rt (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content current__split_fields6)))))) (to_rep1 (last (rt (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content current__split_fields6))))))) true))
...
(assert (= result6 true))
(assert (not (<= i (to_rep1 (last (rt (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a))))))))))
(check-sat)
(exit)
