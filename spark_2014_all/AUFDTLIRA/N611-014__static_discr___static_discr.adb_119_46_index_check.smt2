...
(assert (<= 1 (to_rep (rec__static_discr__holder__length current__split_fields6))))
(assert (<= (to_rep (rec__static_discr__holder__length current__split_fields6)) (to_rep (rec__static_discr__holder__length (us_split_fields5 a)))))
(assert (= (bool_eq (elts1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a))))) (to_rep1 (first2 (rt1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a))))))) (to_rep1 (last2 (rt1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a))))))) (elts1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content current__split_fields6)))) (to_rep1 (first2 (rt1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content current__split_fields6)))))) (to_rep1 (last2 (rt1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content current__split_fields6))))))) true))
(assert (and (= o (+ (to_rep (rec__static_discr__holder__length current__split_fields6)) 1)) (in_range1 (+ (to_rep (rec__static_discr__holder__length current__split_fields6)) 1))))
(assert (= o1 (ite (<= o i) true false)))
(assert (= result6 (ite (= o1 true) (ite (<= i (to_rep (rec__static_discr__holder__length (us_split_fields5 a)))) true false) false)))
(assert (= result6 true))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a))))))) i)))
(check-sat)
(exit)
