...
(assert (= has_complete_lines3 result10))
(assert (= has_complete_lines4 (distinct 1 0)))
(assert (= to_line3 result11))
(assert (= to_line4 del_line3))
(assert (not (= (to_rep (select (select cur_board4 del_line3) 1)) 0)))
(check-sat)
(exit)
