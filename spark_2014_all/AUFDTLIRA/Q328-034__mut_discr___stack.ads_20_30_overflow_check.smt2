...
(assert (forall ((v1 us_rep)) (! (dynamic_invariant2 (to_string1 v1) true false true true) :pattern ((to_string1 v1)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_195 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_195 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_195 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_195 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_195 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_195 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_195 us_void_param) 7)) 103)) (= (to_rep (select (temp___String_Literal_195 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_195 us_void_param) 9)) 45)) (= (to_rep (select (temp___String_Literal_195 us_void_param) 10)) 62)) (= (to_rep (select (temp___String_Literal_195 us_void_param) 11)) 32)) :pattern ((temp___String_Literal_195 us_void_param)))))
...
(declare-const temp___197 (Array Int character))
...
(assert (and (= temp___1972 (to_string1 v)) (dynamic_invariant2 temp___1972 true false true true)))
(assert (=> (<= (to_rep1 (first temp___1971)) (to_rep1 (last temp___1971))) (= o (+ (- (to_rep1 (last temp___1971)) (to_rep1 (first temp___1971))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___1971)) (to_rep1 (last temp___1971)))) (= o 0)))
...
(assert (= (concat1 (temp___String_Literal_195 Tuple0) 1 11 temp___197 (to_rep1 (first temp___1971)) (to_rep1 (last temp___1971))) o6))
(assert (= (mk 1 o5) o7))
...
(assert (= tab3 tab1))
(assert (= last5 last3))
(assert (not (in_range (+ (size last2) 1))))
(check-sat)
(exit)
