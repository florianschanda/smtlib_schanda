...
(declare-fun temp_____aggregate_def_500 (Int Int) (Array Int enum_t))
...
(assert (forall ((temp___502 Int) (temp___503 Int)) (let ((temp___501 (temp_____aggregate_def_500 temp___502 temp___503))) (=> (and (dynamic_invariant temp___502 true true true true) (dynamic_invariant temp___503 true true true true)) (forall ((temp___504 Int)) (ite (or (= temp___504 2) (and (<= 4 temp___504) (<= temp___504 6))) (= (to_rep (select temp___501 temp___504)) temp___502) (= (to_rep (select temp___501 temp___504)) temp___503)))))))
(declare-const x (Array Int enum_t))
(declare-const result (Array Int enum_t))
(declare-const x1 (Array Int enum_t))
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_500 0 1)))
