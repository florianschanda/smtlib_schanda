...
(assert (and (and (=> (<= i 1001) (dynamic_property1 i 1001 j9)) (forall ((temp___278 Int)) (=> (and (<= 0 temp___278) (<= temp___278 1001)) (=> (< j9 temp___278) (= (select tmp9 temp___278) (select tmp6 temp___278)))))) (and (<= i j9) (<= j9 1001))))
(assert (<= 0 j9))
(assert (not (<= 0 0)))
(check-sat)
(exit)
