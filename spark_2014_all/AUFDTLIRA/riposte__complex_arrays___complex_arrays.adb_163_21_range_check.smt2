...
(define-fun dynamic_invariant ((temp___expr_143 Int) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (=> (or (= temp___is_init_140 true) (<= 0 1001)) (in_range1 temp___expr_143)))
...
(assert (forall ((temp___240 Int)) (forall ((temp___241 Int)) (= (select (temp___238 temp___240) temp___241) (of_rep temp___240)))))
(define-fun dynamic_invariant1 ((temp___expr_149 Int) (temp___is_init_146 Bool) (temp___skip_constant_147 Bool) (temp___do_toplevel_148 Bool)) Bool (=> (or (= temp___is_init_146 true) (<= (- 23) 69)) (in_range2 temp___expr_149)))
...
(assert (= j2 0))
(assert (=> (and (<= 0 j2) (<= j2 i)) (and (and (= temp___245 i) (and (= temp___244 j2) (and (= temp___242 tmp1) (and (and (and (= (to_rep o) (- 23)) (= o1 (store tmp1 j2 o))) (and (= tmp1 result2) (= tmp2 o1))) (and (and (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 j3)) (=> (<= k2 j3) (= (to_rep (select tmp3 k2)) (- 23))))) (= i temp___245)) (and (and (and (forall ((temp___243 Int)) (=> (and (<= 0 temp___243) (<= temp___243 1001)) (=> (< j3 temp___243) (= (select tmp3 temp___243) (select temp___242 temp___243))))) (=> (<= 0 i) (dynamic_property 0 i j3))) (and (<= 0 j3) (<= j3 i))) (= j3 i))))))) (and (and (= j3 j7) (= tmp3 tmp7)) (and (= j8 j3) (= tmp8 tmp3))))))
(assert (=> (and (<= 0 j2) (<= j2 i)) (= (mk_int__ref j9) (mk_int__ref j7))))
(assert (=> (and (<= 0 j2) (<= j2 i)) (= (mk_map__ref tmp9) (mk_map__ref tmp7))))
(assert (=> (and (<= 0 j2) (<= j2 i)) (= j10 j8)))
(assert (=> (and (<= 0 j2) (<= j2 i)) (= tmp10 tmp8)))
(assert (=> (not (and (<= 0 j2) (<= j2 i))) (= j2 j9)))
(assert (=> (not (and (<= 0 j2) (<= j2 i))) (= tmp1 tmp9)))
(assert (=> (not (and (<= 0 j2) (<= j2 i))) (= j10 j2)))
(assert (=> (not (and (<= 0 j2) (<= j2 i))) (= tmp10 tmp1)))
(assert (= (mk_int__ref result5) (mk_int__ref j1)))
(assert (= j11 i))
(assert (<= i j11))
(assert (<= j11 1001))
(assert (= (to_rep o4) 69))
(assert (= o5 (store tmp9 j11 o4)))
(assert (= (mk_map__ref result6) (mk_map__ref tmp9)))
(assert (= tmp11 o5))
(assert (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 j12)) (and (=> (< k2 i) (= (to_rep (select tmp12 k2)) (- 23))) (=> (<= i k2) (= (to_rep (select tmp12 k2)) 69))))))
(assert (and (and (=> (<= i 1001) (dynamic_property1 i 1001 j12)) (forall ((temp___250 Int)) (=> (and (<= 0 temp___250) (<= temp___250 1001)) (=> (< j12 temp___250) (= (select tmp12 temp___250) (select tmp9 temp___250)))))) (and (<= i j12) (<= j12 1001))))
(assert (<= 0 j12))
(assert (not (<= 0 0)))
(check-sat)
(exit)
