...
(assert (=> (and (<= 0 j2) (<= j2 i)) (and (forall ((k Int)) (=> (and (<= 0 k) (<= k j3)) (=> (<= k j3) (= (to_rep (select tmp3 k)) (- 23))))) (= i temp___245))))
(assert (=> (and (<= 0 j2) (<= j2 i)) (and (and (forall ((temp___243 Int)) (=> (and (<= 0 temp___243) (<= temp___243 1001)) (=> (< j3 temp___243) (= (select tmp3 temp___243) (select temp___242 temp___243))))) (=> (<= 0 i) (dynamic_property 0 i j3))) (and (<= 0 j3) (<= j3 i)))))
...
(assert (= tmp8 o3))
(assert (forall ((k Int)) (=> (and (<= 0 k) (<= k j9)) (and (=> (< k i) (= (to_rep (select tmp9 k)) (- 23))) (=> (<= i k) (= (to_rep (select tmp9 k)) 69))))))
(assert (and (and (=> (<= i 1001) (dynamic_property1 i 1001 j9)) (forall ((temp___250 Int)) (=> (and (<= 0 temp___250) (<= temp___250 1001)) (=> (< j9 temp___250) (= (select tmp9 temp___250) (select tmp6 temp___250)))))) (and (<= i j9) (<= j9 1001))))
(assert (<= 0 j9))
(assert (not (<= 0 0)))
(check-sat)
(exit)
