...
(define-fun dynamic_invariant3 ((temp___expr_232 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool) (temp___do_typ_inv_231 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 6)) (in_range4 temp___expr_232)))
...
(declare-const temp___9402 (Array Int us_rep))
(declare-const temp___94021 Bool)
(declare-const temp___94022 enum1t)
...
(declare-const temp___9409 (Array Int us_rep))
(declare-const temp___94091 Bool)
(declare-const temp___94092 enum1t)
...
(declare-const result5 enum1t)
(declare-const r__split_fields6 (Array Int us_rep))
(declare-const r__split_fields7 Bool)
(declare-const r__split_fields8 enum1t)
(declare-const result6 (Array Int us_rep))
(declare-const result7 Bool)
(declare-const result8 enum1t)
(declare-const r__split_fields9 us_split_fields2)
(declare-const r__split_fields10 us_split_fields__ref1)
(declare-const r__split_fields11 us_split_fields2)
(assert (in_range1 i))
(assert (in_range2 e))
(assert (in_range3 f))
(assert (= (to_rep o) e))
...
(assert (= temp___9402 o6))
(assert (= temp___94021 o7))
(assert (= temp___94022 o8))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= temp___9402 r__split_fields3))
(assert (= temp___94021 r__split_fields4))
(assert (= temp___94022 r__split_fields5))
...
(assert (= (distinct 1 0) r__split_fields7))
(assert (= r__split_fields5 r__split_fields8))
(assert (= (to_rep1 o9) f))
(assert (= (rec__ar__rec1t__f1 (us_split_fields1 (select r__split_fields6 i))) o10))
(assert (= o9 o11))
(assert (= o12 o10))
(assert (= o13 o11))
(assert (= o14 (store r__split_fields6 i (mk___rep (mk___split_fields o12 o13)))))
(assert (= o14 o15))
(assert (= r__split_fields7 o16))
(assert (= r__split_fields8 o17))
(assert (= temp___9409 o15))
(assert (= temp___94091 o16))
(assert (= temp___94092 o17))
(assert (= result6 r__split_fields6))
(assert (= result7 r__split_fields7))
(assert (= result8 r__split_fields8))
(assert (= r__split_fields9 (mk___split_fields1 temp___9409 temp___94091 temp___94092)))
(assert (= r__split_fields10 (mk___split_fields__ref1 r__split_fields9)))
(assert (= r__split_fields11 r__split_fields9))
(declare-const n Int)
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (in_range2 (to_rep (rec__ar__rec1t__f1 (us_split_fields1 (select (rec__ar__rofaofr1__a1 (us_split_fields__content1 r__split_fields10)) n)))))))
(check-sat)
(exit)
