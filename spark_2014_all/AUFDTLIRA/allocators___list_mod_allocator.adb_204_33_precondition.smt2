...
(define-fun o19 () us_rep2 (mk___rep (mk___split_fields o o1)))
(assert (in_range6 first_available))
(assert (in_range6 res))
(assert (= (is_valid data first_available) true))
(assert (and (= o19 (model__ data first_available)) (= (model_is_well_formed o19 data first_available) true)))
(assert (= o o2))
(assert (= o1 o3))
...
(assert (= ma c111b))
(assert (not (= (is_well_formed data1 first_available1) true)))
(check-sat)
(exit)
