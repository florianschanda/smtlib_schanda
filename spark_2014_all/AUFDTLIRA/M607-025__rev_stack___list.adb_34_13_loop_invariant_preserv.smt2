...
(assert (= (let ((temp___195 (to__ (mk___rep s__split_fields13)))) (bool_eq (elts temp___195) (to_rep (first (rt temp___195))) (to_rep (last (rt temp___195))) (elts (to__ (mk___rep s__split_fields12))) (to_rep (first2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields12))))) 1)))) (to_rep (last2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields12))))) 1)))))) true))
(assert (not (= i13 last5)))
(assert (= result12 (mk_int__ref i13)))
(assert (= i14 (+ i13 1)))
(assert (= i15 (mk_int__ref i14)))
(assert (= res__split_fields4 (mk___split_fields__ref1 res__split_fields3)))
(assert (= s__split_fields14 (mk___split_fields__ref s__split_fields13)))
...
(assert (not (= (length2 (mk___rep1 res__split_discrs (us_split_fields__content1 res__split_fields4))) (- (int__content i15) first4))))
(check-sat)
(exit)
