...
(assert (= (let ((temp___195 (to__ (mk___rep s__split_fields10)))) (bool_eq (elts temp___195) (to_rep (first (rt temp___195))) (to_rep (last (rt temp___195))) (elts (to__ (mk___rep s__split_fields9))) (to_rep (first2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) 1)))) (to_rep (last2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) 1)))))) true))
(assert (not (= i9 last5)))
