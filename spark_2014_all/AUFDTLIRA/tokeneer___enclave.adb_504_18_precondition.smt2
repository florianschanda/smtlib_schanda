...
(define-fun theadmin__split_fields10 () us_split_fields (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))
...
(assert (=> (= result true) (= theadmin__split_fields9 theadmin__split_fields10)))
(assert (=> (not (= result true)) (= (= tokenok2 true) (and (and (= (isgood state5) true) (= (authcertvalid state5) true)) (in_range8 (theauthcertrole state5))))))
(assert (=> (not (= result true)) (= o1 (extractuser state5))))
(assert (=> (not (= result true)) (= (valid_numberlogentries state6) true)))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (= o2 (extractuser state5)))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (= (valid_numberlogentries state7) true))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (= (mk_int__ref result1) status11))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (= status5 3))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (and (= o3 (getrole state5)) (in_range8 o3)))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (and (and (= (rolepresent (mk___rep theadmin__split_fields9)) o3) (not (= (isdoingop (mk___rep theadmin__split_fields9)) true))) (= (ispresent (mk___rep theadmin__split_fields9)) true)))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= o4 (extractuser state5)))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= (valid_numberlogentries state10) true))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= (mk_int__ref result2) status11))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= status6 4))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= state9 state12))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= filestate1 filestate2))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= state8 state11))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= theadmin__split_fields theadmin__split_fields4))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= theadmin__split_fields1 theadmin__split_fields5))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= status5 status6))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= state9 state12))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= filestate1 filestate2))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= state8 state11))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= theadmin__split_fields9 theadmin__split_fields10))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= status5 status6))))
...
(assert (and (= o5 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7)))) (in_range4 o5)))
(assert (= result3 (ite (= o5 1) true false)))
(assert (=> (= result3 true) (= o9 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (= result3 true) (= o10 (ite (not (= o9 true)) true false))))
(assert (=> (= result3 true) (and (= o6 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7)))) (in_range6 o6))))
(assert (=> (= result3 true) (= o7 (ite (= o6 3) true false))))
(assert (=> (= result3 true) (= o8 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields6 theadmin__split_fields7))))))
