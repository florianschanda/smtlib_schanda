...
(assert (not (= (ite (<= (to_rep1 (first4 temp___18331)) (to_rep1 (last4 temp___18331))) (+ (- (to_rep1 (last4 temp___18331)) (to_rep1 (first4 temp___18331))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 9)) 1) 0))))
(check-sat)
(exit)
