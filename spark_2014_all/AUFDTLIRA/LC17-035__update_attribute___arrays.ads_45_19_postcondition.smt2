...
(declare-fun temp___254 ((Array Int integer) Int Int Int Int Int Int) (Array Int integer))
(assert (forall ((temp___256 (Array Int integer))) (forall ((temp___257 Int) (temp___258 Int) (temp___259 Int) (temp___260 Int) (temp___261 Int) (temp___262 Int)) (let ((temp___255 (temp___254 temp___256 temp___257 temp___258 temp___259 temp___260 temp___261 temp___262))) (forall ((temp___263 Int)) (ite (and (<= temp___260 temp___263) (<= temp___263 temp___261)) (= (select temp___255 temp___263) (of_rep temp___262)) (ite (and (<= temp___257 temp___263) (<= temp___263 temp___258)) (= (select temp___255 temp___263) (of_rep temp___259)) (= (select temp___255 temp___263) (select temp___256 temp___263)))))))))
(declare-fun temp___408 ((Array Int integer) Int Int Int Int Int Int) (Array Int integer))
(assert (forall ((temp___410 (Array Int integer))) (forall ((temp___411 Int) (temp___412 Int) (temp___413 Int) (temp___414 Int) (temp___415 Int) (temp___416 Int)) (let ((temp___409 (temp___408 temp___410 temp___411 temp___412 temp___413 temp___414 temp___415 temp___416))) (forall ((temp___417 Int)) (ite (and (<= temp___414 temp___417) (<= temp___417 temp___415)) (= (select temp___409 temp___417) (of_rep temp___416)) (ite (and (<= temp___411 temp___417) (<= temp___417 temp___412)) (= (select temp___409 temp___417) (of_rep temp___413)) (= (select temp___409 temp___417) (select temp___410 temp___417)))))))))
...
(assert (not (= (bool_eq arrays__f4__result4 1 8 (temp___254 arr_in 1 i 10 i j 20) 1 8) true)))
(check-sat)
(exit)
