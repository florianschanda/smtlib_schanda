...
(assert (=> (not (= (int__content v2) 0)) (and (= o46 (int__content v2)) (in_range1 (int__content v2)))))
(assert (=> (not (= (int__content v2) 0)) (and (= result14 (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) o46)) (and (= (= result14 true) (and (<= o46 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) o46)))) 2))) (=> (< (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) o46) (not (= result14 true)))))))
...
(assert (and (= o44 (int__content v2)) (in_range1 (int__content v2))))
