...
(assert (< ib9 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))))
(assert (and (= o79 (remove_swap b ib9 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (in_range3 o79) (=> (= (of_int o79) true) (= (let ((temp___157 (remove (remove b (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w)))) ib9))) (let ((temp___156 (remove (remove b ib9) (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)))) (bool_eq (elts temp___156) (to_rep2 (first (rt temp___156))) (to_rep2 (last (rt temp___156))) (elts temp___157) (to_rep2 (first (rt temp___157))) (to_rep2 (last (rt temp___157)))))) true)))))
(assert (= result17 (mk_int__ref ih10)))
(assert (= ih11 o79))
(assert (= (of_int ih11) true))
(assert (and (= o85 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)) (in_range4 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))
(assert (and (= o84 (remove b ib9)) (and (dynamic_invariant2 o84 true false true) (and (= (invariant__ o84) true) (and (= (to_rep2 (last (rt o84))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- ib9 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o84) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ ib9 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o84) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= ib9 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o84) k1))))))))))))
(assert (and (= o86 (remove o84 o85)) (and (dynamic_invariant2 o86 true false true) (and (= (invariant__ o86) true) (and (= (to_rep2 (last (rt o86))) (- (to_rep2 (last (rt o84))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o85 1))) (= (to_rep (select (elts o84) k1)) (to_rep (select (elts o86) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o85 1) k1) (<= k1 (to_rep2 (last (rt o84))))) (= (to_rep (select (elts o84) k1)) (to_rep (select (elts o86) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o85 k1) (<= k1 (- (to_rep2 (last (rt o84))) 1))) (= (to_rep (select (elts o84) (+ k1 1))) (to_rep (select (elts o86) k1))))))))))))
(assert (and (= o83 (remove bb ib9)) (and (dynamic_invariant2 o83 true false true) (and (= (invariant__ o83) true) (and (= (to_rep2 (last (rt o83))) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- ib9 1))) (= (to_rep (select (elts bb) k1)) (to_rep (select (elts o83) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ ib9 1) k1) (<= k1 (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k1)) (to_rep (select (elts o83) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= ib9 k1) (<= k1 (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k1 1))) (to_rep (select (elts o83) k1))))))))))))
(assert (and (= o80 ia3) (in_range4 ia3)))
(assert (and (= o81 (remove a o80)) (and (dynamic_invariant2 o81 true false true) (and (= (invariant__ o81) true) (and (= (to_rep2 (last (rt o81))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o80 1))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o81) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o80 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o81) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o80 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select (elts o81) k1))))))))))))
(assert (and (= o82 (remove o81 (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant2 o82 true false true) (and (= (invariant__ o82) true) (and (= (to_rep2 (last (rt o82))) (- (to_rep2 (last (rt o81))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts o81) k1)) (to_rep (select (elts o82) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k1) (<= k1 (to_rep2 (last (rt o81))))) (= (to_rep (select (elts o81) k1)) (to_rep (select (elts o82) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k1) (<= k1 (- (to_rep2 (last (rt o81))) 1))) (= (to_rep (select (elts o81) (+ k1 1))) (to_rep (select (elts o82) k1))))))))))))
(assert (and (= o87 (shift_perm_r o82 o83 o86)) (and (in_range3 o87) (=> (= (of_int o87) true) (= (is_perm o82 o86) true)))))
(assert (= result18 (mk_int__ref ih11)))
(assert (= ih12 o87))
(assert (= (of_int ih12) true))
(assert (and (= o92 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1)) (in_range4 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))))
(assert (and (= o91 (remove b ib9)) (and (dynamic_invariant2 o91 true false true) (and (= (invariant__ o91) true) (and (= (to_rep2 (last (rt o91))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- ib9 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o91) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ ib9 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o91) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= ib9 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o91) k1))))))))))))
(assert (and (= o93 (remove o91 o92)) (and (dynamic_invariant2 o93 true false true) (and (= (invariant__ o93) true) (and (= (to_rep2 (last (rt o93))) (- (to_rep2 (last (rt o91))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o92 1))) (= (to_rep (select (elts o91) k1)) (to_rep (select (elts o93) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o92 1) k1) (<= k1 (to_rep2 (last (rt o91))))) (= (to_rep (select (elts o91) k1)) (to_rep (select (elts o93) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o92 k1) (<= k1 (- (to_rep2 (last (rt o91))) 1))) (= (to_rep (select (elts o91) (+ k1 1))) (to_rep (select (elts o93) k1))))))))))))
(assert (and (= o88 ia3) (in_range4 ia3)))
