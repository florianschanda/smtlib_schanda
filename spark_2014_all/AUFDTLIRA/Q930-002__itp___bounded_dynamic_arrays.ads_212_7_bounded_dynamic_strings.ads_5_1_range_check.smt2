...
(define-fun dynamic_invariant ((temp___expr_169 Int) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool)) Bool (=> (or (= temp___is_init_166 true) (<= 0 255)) (in_range1 temp___expr_169)))
...
(define-fun dynamic_invariant1 ((temp___expr_175 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= 1 2147483647)) (in_range2 temp___expr_175)))
...
(declare-const temp___capacity_839 Int)
...
(assert (in_range4 temp___capacity_839))
(assert (<= 1 temp___capacity_839))
(assert (not (<= 1 1)))
(check-sat)
(exit)
