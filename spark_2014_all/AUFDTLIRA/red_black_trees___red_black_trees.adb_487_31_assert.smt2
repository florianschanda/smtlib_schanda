...
(assert (not (not (= (peek (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields23)) (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields23)) (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields23)) (int__content x11))) 1) 0))))
(check-sat)
(exit)
