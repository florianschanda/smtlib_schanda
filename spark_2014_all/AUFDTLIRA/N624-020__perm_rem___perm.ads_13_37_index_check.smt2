...
(assert (<= 1 k2))
(assert (<= k2 (- i 1)))
(assert (and (<= (to_rep1 (first perm__remove__result9)) k2) (<= k2 (to_rep1 (last perm__remove__result9)))))
(assert (= o16 k2))
(assert (= o17 (select perm__remove__result8 o16)))
(assert (= o18 (to_rep o17)))
(assert (not (<= (to_rep1 (first (rt a))) k2)))
(check-sat)
(exit)
