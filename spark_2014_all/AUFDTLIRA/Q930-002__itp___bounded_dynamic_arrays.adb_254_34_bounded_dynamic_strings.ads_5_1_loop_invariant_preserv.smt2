...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 k2)) (not (= (to_rep (select (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) j1)) fragment)))))
...
(assert (= o5 (to_rep o4)))
(assert (= result4 (ite (= o5 fragment) true false)))
