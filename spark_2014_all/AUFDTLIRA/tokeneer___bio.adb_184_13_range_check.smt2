...
(declare-const temp___1532 (Array Int character))
(declare-const temp___15321 t3)
...
(assert (= (slide fullstring1 (to_rep1 fullstring__first) 1) temp___1532))
(assert (= (mk3 1 (to_rep1 fullstring__last)) temp___15321))
