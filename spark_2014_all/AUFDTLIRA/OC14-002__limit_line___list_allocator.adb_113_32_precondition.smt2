...
(assert (=> (= result13 true) (and (= o59 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o59))))
(assert (=> (= result13 true) (= result14 (ite (< j o59) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o60 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o61 (get (rec__list_allocator__m__t__available model____split_fields3) o60)) (in_range7 o61)))))
...
(assert (=> (= result13 true) (= o55 temp___431)))
...
(assert (=> (= result12 true) (=> (< 1 j) (and (= o53 (get (rec__list_allocator__m__t__available model____split_fields3) o52)) (in_range7 o53)))))
...
(assert (=> (= result12 true) (= o48 temp___432)))
...
(assert (not (= j k)))
(assert (and (= o47 (get (rec__list_allocator__m__t__available model____split_fields3) k)) (in_range7 o47)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
