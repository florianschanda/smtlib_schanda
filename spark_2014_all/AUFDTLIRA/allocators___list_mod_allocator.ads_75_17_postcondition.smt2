...
(declare-const result22 us_rep1)
(declare-const result23 us_rep2)
...
(assert (=> (= result6 true) (= temp___295 r9)))
(assert (=> (= result6 true) (= temp___294 (set__content unseen6))))
(assert (=> (= result6 true) (= temp___293 avail)))
(assert (=> (= result6 true) (= 0 temp___299)))
(assert (=> (= result6 true) (and (= o15 (remove (set__content unseen6) r9)) (and (and (and (= (length1 o15) (- (length1 (set__content unseen6)) 1)) (not (= (contains o15 r9) true))) (= (ole1 o15 (set__content unseen6)) true)) (= (included_except (set__content unseen6) o15 r9) true)))))
(assert (=> (= result6 true) (= result7 unseen6)))
(assert (=> (= result6 true) (= unseen8 o15)))
(assert (=> (= result6 true) (and (= o16 (add avail r9)) (and (= (length o16) (+ (length avail) 1)) (and (= (get o16 (last o16)) r9) (= (ole avail o16) true))))))
(assert (=> (= result6 true) (= result8 (mk_sequence__ref avail))))
(assert (=> (= result6 true) (= avail2 o16)))
(assert (=> (= result6 true) (and (<= 1 r9) (<= r9 10000))))
(assert (=> (= result6 true) (= o17 r9)))
(assert (=> (= result6 true) (= (mk___rep (mk___split_fields o18 o19)) (select data o17))))
(assert (=> (= result6 true) (= o18 o20)))
(assert (=> (= result6 true) (= o19 o21)))
(assert (=> (= result6 true) (= o22 o21)))
(assert (=> (= result6 true) (= o23 (to_rep o22))))
(assert (=> (= result6 true) (= result9 (mk_int__ref r9))))
(assert (=> (= result6 true) (= r10 o23)))
(assert (=> (= result6 true) (<= (length1 unseen9) 10000)))
(assert (=> (= result6 true) (<= (length avail3) (- 10000 (length1 unseen9)))))
(assert (=> (= result6 true) (forall ((e3 Int)) (=> (and (<= 1 e3) (<= e3 10000)) (=> (and (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data e3)))) 0) (not (= (contains1 avail3 e3) true))) (= (contains unseen9 e3) true))))))
(assert (=> (= result6 true) (and (< 0 (length avail3)) (= (get avail3 1) first_available))))
(assert (=> (= result6 true) (forall ((j4 Int)) (=> (and (<= 1 j4) (<= j4 (length avail3))) (in_range3 (get avail3 j4))))))
(assert (=> (= result6 true) (= r11 (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get avail3 (length avail3)))))))))
(assert (=> (= result6 true) (forall ((j4 Int)) (=> (and (<= 1 j4) (<= j4 (- (length avail3) 1))) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get avail3 j4))))) (get avail3 (+ j4 1)))))))
(assert (=> (= result6 true) (forall ((j4 Int)) (=> (and (<= 2 j4) (<= j4 (length avail3))) (= (get avail3 j4) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get avail3 (- j4 1)))))))))))
(assert (=> (= result6 true) (forall ((j4 Int)) (=> (and (<= 1 j4) (<= j4 (length avail3))) (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (length avail3))) (=> (= (get avail3 j4) (get avail3 k1)) (= j4 k1))))))))
(assert (=> (= result6 true) (forall ((e3 Int)) (=> (and (<= 1 e3) (<= e3 10000)) (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data e3)))) 1) (not (= (contains1 avail3 e3) true)))))))
(assert (=> (= result6 true) (=> (<= 0 10000) (in_range2 r11))))
(assert (=> (= result6 true) (= result16 (mk_int__ref temp___2991))))
(assert (=> (= result6 true) (= temp___2992 (length avail3))))
(assert (=> (= result6 true) (and (= o51 (contains1 avail3 r11)) (= (= o51 true) (exists ((i Int)) (and (and (<= 1 i) (<= i (length avail3))) (= (get avail3 i) r11)))))))
(assert (=> (= result6 true) (= o52 (ite (not (= o51 true)) true false))))
(assert (=> (= result6 true) (= o53 (ite (not (= r11 0)) o52 false))))
(assert (=> (= result6 true) (= result17 (ite (not (= o53 true)) true false))))
(assert (=> (= result6 true) (= result17 true)))
(assert (=> (= result6 true) (= r15 (mk_int__ref r11))))
(assert (=> (= result6 true) (= unseen13 (mk_set__ref unseen9))))
(assert (=> (= result6 true) (= avail7 (mk_sequence__ref avail3))))
(assert (=> (= result6 true) (= r16 r11)))
(assert (=> (= result6 true) (= unseen14 unseen9)))
(assert (=> (= result6 true) (= avail8 avail3)))
(assert (=> (= result6 true) (= r17 r15)))
(assert (=> (= result6 true) (= unseen15 unseen13)))
(assert (=> (= result6 true) (= avail9 avail7)))
(assert (=> (= result6 true) (= r18 r16)))
(assert (=> (= result6 true) (= unseen16 unseen14)))
(assert (=> (= result6 true) (= avail10 avail8)))
(assert (=> (not (= result6 true)) (= r17 (mk_int__ref r9))))
(assert (=> (not (= result6 true)) (= unseen15 unseen6)))
(assert (=> (not (= result6 true)) (= avail9 (mk_sequence__ref avail))))
(assert (=> (not (= result6 true)) (= r18 r9)))
(assert (=> (not (= result6 true)) (= unseen16 unseen7)))
(assert (=> (not (= result6 true)) (= avail10 avail1)))
...
(assert (= result21 (mk_t__ref (mk___rep1 (mk___split_fields1 list_mod_allocator__m__model__result list_mod_allocator__m__model__result1)))))
(assert (= list_mod_allocator__m__model__result2 (mk___rep1 (mk___split_fields1 (sequence__content avail9) (set__content alloc6)))))
(assert (= list_mod_allocator__m__model__result5 list_mod_allocator__m__model__result3))
(assert (= r20 r17))
(assert (= r19 r7))
(assert (= unseen17 unseen15))
(assert (= alloc8 alloc6))
(assert (= avail11 avail9))
(assert (= list_mod_allocator__m__model__result6 list_mod_allocator__m__model__result4))
(assert (= r22 r18))
(assert (= r21 r8))
(assert (= unseen18 unseen16))
(assert (= alloc9 alloc7))
(assert (= avail12 avail10))
(assert (= (mk___rep1 (mk___split_fields1 result22 result23)) (t__content list_mod_allocator__m__model__result5)))
