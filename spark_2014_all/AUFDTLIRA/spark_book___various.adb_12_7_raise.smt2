...
(assert (= result j))
(assert (= j1 1))
(assert (not (= (to_rep (select values j1)) 0)))
(assert (= various__search_for_zero__result2 various__search_for_zero__result))
(assert (= various__search_for_zero__result2 various__search_for_zero__result1))
(assert (= result1 j1))
(assert (= j2 2))
(assert (not (= (to_rep (select values j2)) 0)))
(assert (= various__search_for_zero__result3 various__search_for_zero__result2))
(assert (= result2 j2))
(assert (= j3 3))
(assert (not (= (to_rep (select values j3)) 0)))
(assert (= various__search_for_zero__result4 various__search_for_zero__result3))
(assert (= result3 j3))
(assert (= j4 4))
(assert (not (= (to_rep (select values j4)) 0)))
(assert (= various__search_for_zero__result5 various__search_for_zero__result4))
(assert (= result4 j4))
(assert (= j5 5))
(assert (not (= (to_rep (select values j5)) 0)))
(assert (= various__search_for_zero__result6 various__search_for_zero__result5))
(assert (= result5 j5))
(assert (= j6 6))
(assert (not (= (to_rep (select values j6)) 0)))
(assert (= various__search_for_zero__result7 various__search_for_zero__result6))
(assert (= result6 j6))
(assert (= j7 7))
(assert (not (= (to_rep (select values j7)) 0)))
(assert (= various__search_for_zero__result8 various__search_for_zero__result7))
(assert (= result7 j7))
(assert (= j8 8))
(assert (not (= (to_rep (select values j8)) 0)))
(assert (= various__search_for_zero__result9 various__search_for_zero__result8))
(assert (= result8 j8))
(assert (= j9 9))
(assert (not (= (to_rep (select values j9)) 0)))
(assert (= various__search_for_zero__result10 various__search_for_zero__result9))
(assert (= result9 j9))
(assert (= j10 10))
(assert (not (= (to_rep (select values j10)) 0)))
(assert (= various__search_for_zero__result11 various__search_for_zero__result10))
(assert (not false))
(check-sat)
(exit)
