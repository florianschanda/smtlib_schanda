...
(declare-const t Int)
(declare-const temp___479 (Array Int us_rep))
(declare-const o Int)
...
(define-fun o3 () us_rep3 (mk___rep3 (mk___split_fields3 o1)))
...
(assert (<= 0 s1))
(assert (<= s1 100))
(assert (forall ((t1 Int)) (=> (and (<= 0 t1) (<= t1 (- s2 1))) (= (name (select (owned_state sm) t1)) (name__2 (select av2 t1))))))
(assert (and (=> (<= 0 100) (in_range6 s2)) (and (<= 0 s2) (<= s2 100))))
(assert (<= 0 t))
(assert (<= t (- s2 1)))
(assert (and (= o t) (in_range3 t)))
(assert (= o3 (select av2 o)))
(assert (and (= o2 (name__2 o3)) (and (in_range1 o2) (= o2 (to_rep o1)))))
(assert (and (= temp___479 (owned_state sm)) (= temp___479 (rec__model__uml_state_machine__owned_state_data (us_split_fields5 sm)))))
(assert (not (<= 0 t)))
(check-sat)
(exit)
