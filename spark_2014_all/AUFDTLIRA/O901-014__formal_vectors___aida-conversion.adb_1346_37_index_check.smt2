...
(assert (and (<= (to_rep1 (first (rt source))) temp___1817) (<= temp___1817 (to_rep1 (last (rt source))))))
(assert (= o temp___1817))
...
(assert (not (<= (to_rep1 (first (rt source))) temp___1816)))
(check-sat)
(exit)
