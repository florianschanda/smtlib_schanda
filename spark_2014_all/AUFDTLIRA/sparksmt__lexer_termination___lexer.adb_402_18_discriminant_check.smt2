...
(assert (= (to_rep3 o40) n1))
(assert (= (to_rep o41) t_length))
(assert (= (to_rep o42) first_col))
(assert (= (to_rep o43) first_line))
(assert (= o44 (mk___split_fields o43 o42 o41 o40)))
(assert (= (to_rep4 o39) 8))
(assert (= o45 (mk___split_discrs o39)))
(assert (= temp___991 (mk___rep o45 o44 true)))
(assert (= t__attr__constrained true))
(assert (not (= (rec__lexer__token__kind (us_split_discrs1 temp___991)) t__split_discrs)))
(check-sat)
(exit)
