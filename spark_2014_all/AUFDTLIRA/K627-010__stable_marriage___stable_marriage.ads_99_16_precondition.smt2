...
(assert (= g12 1))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= unmatched_g1_set__split_fields2 (mk___split_fields temp___501 temp___5011))))
...
(assert (=> (and (<= 1 g12) (<= g12 64)) (= unmatched_g1_set__split_fields4 (mk___split_fields temp___495 temp___4951))))
...
(assert (=> (and (<= 1 g12) (<= g12 64)) (= unmatched_g1_set__split_fields5 (mk___split_fields temp___499 temp___4991))))
...
(assert (=> (< 0 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality (us_split_fields__content unmatched_g1_set__split_fields8)))) (= (us_split_fields__content unmatched_g1_set__split_fields8) (mk___split_fields temp___514 temp___5141))))
(assert (=> (< 0 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality (us_split_fields__content unmatched_g1_set__split_fields8)))) (= temp___512 proposals_made1)))
(assert (=> (< 0 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality (us_split_fields__content unmatched_g1_set__split_fields8)))) (= temp___513 result__1)))
(assert (=> (< 0 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality (us_split_fields__content unmatched_g1_set__split_fields8)))) (= temp___511 unmatched_g2_set1)))
...
(assert (and (= temp___516 (invert_map (map__content stable_marriage__matching__result4))) (and (forall ((g110 Int)) (=> (and (<= 1 g110) (<= g110 64)) (= (to_rep (select (map__content stable_marriage__matching__result4) (to_rep1 (select temp___516 g110)))) g110))) (forall ((g21 Int)) (=> (and (<= 1 g21) (<= g21 64)) (= (to_rep1 (select temp___516 (to_rep (select (map__content stable_marriage__matching__result4) g21)))) g21))))))
(assert (= o13 (select temp___516 g11)))
