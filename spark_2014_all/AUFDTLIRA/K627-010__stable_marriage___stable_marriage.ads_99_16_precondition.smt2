...
(assert (and (and (and (= result (mk_map__ref6 proposals_made)) (= proposals_made1 (stable_marriage__matching__proposals_made__aggregate_def 0))) (and (and (and (and (= (to_rep3 o) 0) (and (= (temp___484 64) o1) (= o o2))) (and (= stable_marriage__matching__unmatched_g1_set__assume o1) (= stable_marriage__matching__unmatched_g1_set__assume1 o2))) (and (= result1 (mk___split_fields__ref (mk___split_fields unmatched_g1_set__split_fields unmatched_g1_set__split_fields1))) (= unmatched_g1_set__split_fields2 (mk___split_fields stable_marriage__matching__unmatched_g1_set__assume stable_marriage__matching__unmatched_g1_set__assume1)))) (and (and (= result2 (mk_map__ref7 unmatched_g2_set)) (= unmatched_g2_set1 (stable_marriage__matching__unmatched_g2_set__aggregate_def (of_int 1)))) (and (and (= result3 (mk_map__ref result__)) (= result__1 (stable_marriage__matching__result__aggregate_def 64))) (and (and (and (= o3 (invert ranking_2)) (forall ((g21 Int)) (=> (and (<= 1 g21) (<= g21 64)) (= (bool_eq4 (select o3 g21) 1 64 (invert_1 (select ranking_2 g21)) 1 64) true)))) (and (= result4 (mk_map__ref5 ranking_2_inverted)) (= ranking_2_inverted1 o3))) (and (and (and (= result5 (mk_int__ref g1)) (= g12 1)) (ite (and (<= 1 g12) (<= g12 64)) (and (and (and (= unmatched_g1_set__split_fields2 (mk___split_fields temp___501 temp___5011)) (and (= temp___500 g12) (and (and (= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) (- g13 1)) (and (= (all_unmatched_g1_set_elements_distinct unmatched_g1_set__split_fields3) true) (forall ((prev1 Int)) (=> (and (<= 1 prev1) (<= prev1 (- g13 1))) (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) prev1)) prev1))))) (and (and (=> (<= 1 64) (in_range1 g13)) (and (<= 1 g13) (<= g13 64))) (and (and (= g13 c175b) (in_range1 c175b)) (and (and (and (and (and (and (= o5 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1))) (= (to_rep3 o6) o5)) (and (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) o7) (= o6 o8))) (and (= temp___495 o7) (= temp___4951 o8))) (and (= result6 (mk___split_fields__ref unmatched_g1_set__split_fields3)) (= unmatched_g1_set__split_fields4 (mk___split_fields temp___495 temp___4951)))) (and (and (and (and (and (= (to_rep o9) c175b) (and (and (and (<= 1 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4))) (<= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)) 64)) (= o10 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (= o11 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) o10 o9)))) (and (= o11 o12) (= (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4) o13))) (and (= temp___499 o12) (= temp___4991 o13))) (and (= result7 (mk___split_fields__ref unmatched_g1_set__split_fields4)) (= unmatched_g1_set__split_fields5 (mk___split_fields temp___499 temp___4991)))) (= g13 64)))))))) (and (and (= g15 (mk_int__ref g13)) (= unmatched_g1_set__split_fields6 (mk___split_fields__ref unmatched_g1_set__split_fields5))) (and (= g16 g13) (= unmatched_g1_set__split_fields7 unmatched_g1_set__split_fields5)))) (and (and (= g17 g15) (= unmatched_g1_set__split_fields8 unmatched_g1_set__split_fields6)) (and (= g18 g16) (= unmatched_g1_set__split_fields9 unmatched_g1_set__split_fields7)))) (and (and (= g17 (mk_int__ref g12)) (= unmatched_g1_set__split_fields8 (mk___split_fields__ref unmatched_g1_set__split_fields2))) (and (= g18 g12) (= unmatched_g1_set__split_fields9 unmatched_g1_set__split_fields2))))) (and (= (all_unmatched_g1_set_elements_distinct (us_split_fields__content unmatched_g1_set__split_fields8)) true) (and (forall ((g1_id Int)) (=> (and (<= 1 g1_id) (<= g1_id 64)) (and (= (to_rep3 (select proposals_made1 g1_id)) 0) (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements (us_split_fields__content unmatched_g1_set__split_fields8)) g1_id)) g1_id)))) (and (ite (< 0 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality (us_split_fields__content unmatched_g1_set__split_fields8)))) (and (and (and (= (us_split_fields__content unmatched_g1_set__split_fields8) (mk___split_fields temp___514 temp___5141)) (and (= temp___512 proposals_made1) (and (= temp___513 result__1) (and (= temp___511 unmatched_g2_set1) (and (= (invariant_holds unmatched_g1_set__split_fields10 proposals_made2 result__2 unmatched_g2_set2) true) (and (< 0 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields10))) (and (= (invariant_holds unmatched_g1_set__split_fields11 proposals_made3 result__3 unmatched_g2_set3) true) (not (< 0 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields11))))))))))) (and (and (= result__8 (mk_map__ref result__3)) (and (= unmatched_g2_set8 (mk_map__ref7 unmatched_g2_set3)) (and (= unmatched_g1_set__split_fields16 (mk___split_fields__ref unmatched_g1_set__split_fields11)) (= proposals_made8 (mk_map__ref6 proposals_made3))))) (and (= result__9 result__3) (and (= unmatched_g2_set9 unmatched_g2_set3) (and (= unmatched_g1_set__split_fields17 unmatched_g1_set__split_fields11) (= proposals_made9 proposals_made3)))))) (and (and (= result__10 result__8) (and (= unmatched_g2_set10 unmatched_g2_set8) (and (= unmatched_g1_set__split_fields18 unmatched_g1_set__split_fields16) (= proposals_made10 proposals_made8)))) (and (= result__11 result__9) (and (= unmatched_g2_set11 unmatched_g2_set9) (and (= unmatched_g1_set__split_fields19 unmatched_g1_set__split_fields17) (= proposals_made11 proposals_made9)))))) (and (and (= result__10 (mk_map__ref result__1)) (and (= unmatched_g2_set10 (mk_map__ref7 unmatched_g2_set1)) (and (= unmatched_g1_set__split_fields18 unmatched_g1_set__split_fields8) (= proposals_made10 (mk_map__ref6 proposals_made1))))) (and (= result__11 result__1) (and (= unmatched_g2_set11 unmatched_g2_set1) (and (= unmatched_g1_set__split_fields19 unmatched_g1_set__split_fields9) (= proposals_made11 proposals_made1)))))) (and (and (= stable_marriage__matching__result2 (mk_map__ref stable_marriage__matching__result1)) (= stable_marriage__matching__result3 stable_marriage__matching__result1)) (and (= result9 (mk_map__ref stable_marriage__matching__result)) (= stable_marriage__matching__result1 (map__content result__10))))))))))))) (and (and (= stable_marriage__matching__result4 stable_marriage__matching__result2) (and (= g19 g17) (and (= result__12 result__10) (and (= unmatched_g2_set12 unmatched_g2_set10) (and (= unmatched_g1_set__split_fields20 unmatched_g1_set__split_fields18) (and (= proposals_made12 proposals_made10) (= ranking_2_inverted2 (mk_map__ref5 ranking_2_inverted1)))))))) (and (= stable_marriage__matching__result5 stable_marriage__matching__result3) (and (= g110 g18) (and (= result__13 result__11) (and (= unmatched_g2_set13 unmatched_g2_set11) (and (= unmatched_g1_set__split_fields21 unmatched_g1_set__split_fields19) (and (= proposals_made13 proposals_made11) (= ranking_2_inverted3 ranking_2_inverted1))))))))))
(assert (= (= result10 true) (forall ((g111 Int)) (=> (and (<= 1 g111) (<= g111 64)) (exists ((g21 Int)) (and (and (<= 1 g21) (<= g21 64)) (= (to_rep (select (map__content stable_marriage__matching__result4) g21)) g111)))))))
(assert (= result10 true))
(assert (<= 1 g11))
(assert (<= g11 64))
(assert (<= 1 g2))
(assert (<= g2 64))
(assert (and (= o16 (is_preferred_1 (to_rep (select (map__content stable_marriage__matching__result4) g2)) g11 (select ranking_2 g2))) (= (= o16 true) (<= (to_rep2 (select (invert_1 (select ranking_2 g2)) (to_rep (select (map__content stable_marriage__matching__result4) g2)))) (to_rep2 (select (invert_1 (select ranking_2 g2)) g11))))))
(assert (and (= temp___516 (invert_map (map__content stable_marriage__matching__result4))) (and (forall ((g111 Int)) (=> (and (<= 1 g111) (<= g111 64)) (= (to_rep (select (map__content stable_marriage__matching__result4) (to_rep1 (select temp___516 g111)))) g111))) (forall ((g21 Int)) (=> (and (<= 1 g21) (<= g21 64)) (= (to_rep1 (select temp___516 (to_rep (select (map__content stable_marriage__matching__result4) g21)))) g21))))))
(assert (= o14 (select temp___516 g11)))
