...
(assert (forall ((a (Array Int (Array Int ranking))) (b (Array Int (Array Int ranking)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_160 Int)) (=> (and (<= a__first temp___idx_160) (<= temp___idx_160 a__last)) (= (bool_eq4 (select a temp___idx_160) 1 64 (select b (+ (- b__first a__first) temp___idx_160)) 1 64) true))))))))
...
(assert (forall ((a (Array Int count)) (b (Array Int count))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_161 Int)) (=> (and (<= a__first temp___idx_161) (<= temp___idx_161 a__last)) (= (to_rep3 (select a temp___idx_161)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_161)))))))))))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_159 Int)) (=> (and (<= a__first temp___idx_159) (<= temp___idx_159 a__last)) (= (select a temp___idx_159) (select b (+ (- b__first a__first) temp___idx_159))))))))))
...
(declare-fun temp___526 (Int) (Array Int group1_id))
...
(assert (forall ((temp___524 Int)) (=> (dynamic_invariant2 temp___524 true true true true) (forall ((temp___525 Int)) (= (to_rep3 (select (stable_marriage__matching__proposals_made__aggregate_def temp___524) temp___525)) temp___524)))))
(assert (forall ((temp___528 Int)) (=> (dynamic_invariant temp___528 true true true true) (forall ((temp___529 Int)) (= (to_rep (select (temp___526 temp___528) temp___529)) temp___528)))))
...
(assert (forall ((temp___534 Int)) (=> (dynamic_invariant temp___534 true true true true) (forall ((temp___535 Int)) (= (to_rep (select (stable_marriage__matching__result__aggregate_def temp___534) temp___535)) temp___534)))))
...
(declare-const o5 count)
(declare-const o6 (Array Int group1_id))
(declare-const o7 count)
(declare-const temp___537 (Array Int group1_id))
(declare-const temp___5371 count)
(declare-const o8 group1_id)
(declare-const o9 Int)
(declare-const o10 (Array Int group1_id))
(declare-const o11 (Array Int group1_id))
(declare-const o12 count)
(declare-const temp___541 (Array Int group1_id))
(declare-const temp___5411 count)
...
(declare-const temp___558 (Array Int group2_id))
(declare-const o13 group2_id)
...
(assert (and (forall ((g110 Int)) (=> (and (<= 1 g110) (<= g110 64)) (= (is_permutation_2 (select ranking_1 g110)) true))) (forall ((g21 Int)) (=> (and (<= 1 g21) (<= g21 64)) (= (is_permutation_1 (select ranking_2 g21)) true)))))
...
(assert (= g12 1))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= unmatched_g1_set__split_fields2 (mk___split_fields temp___543 temp___5431))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___542 g12)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) (- g13 1))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (all_unmatched_g1_set_elements_distinct unmatched_g1_set__split_fields3) true)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (forall ((prev Int)) (=> (and (<= 1 prev) (<= prev (- g13 1))) (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) prev)) prev)))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (and (=> (<= 1 64) (in_range1 g13)) (and (<= 1 g13) (<= g13 64)))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= g13 c175b)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (in_range1 c175b)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (and (= o4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3)) 1)))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (to_rep3 o5) o4)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) o6)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= o5 o7)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___537 o6)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___5371 o7)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= result6 (mk___split_fields__ref unmatched_g1_set__split_fields3))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= unmatched_g1_set__split_fields4 (mk___split_fields temp___537 temp___5371))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (to_rep o8) c175b)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (and (<= 1 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4))) (<= (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)) 64))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= o9 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= o10 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) o9 o8))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= o10 o11)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4) o12)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___541 o11)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= temp___5411 o12)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= result7 (mk___split_fields__ref unmatched_g1_set__split_fields4))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= unmatched_g1_set__split_fields5 (mk___split_fields temp___541 temp___5411))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= g13 64)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= g14 (mk_int__ref g13))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= unmatched_g1_set__split_fields6 (mk___split_fields__ref unmatched_g1_set__split_fields5))))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= g15 g13)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= unmatched_g1_set__split_fields7 unmatched_g1_set__split_fields5)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= g16 g14)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= unmatched_g1_set__split_fields8 unmatched_g1_set__split_fields6)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= g17 g15)))
(assert (=> (and (<= 1 g12) (<= g12 64)) (= unmatched_g1_set__split_fields9 unmatched_g1_set__split_fields7)))
(assert (=> (not (and (<= 1 g12) (<= g12 64))) (= g16 (mk_int__ref g12))))
(assert (=> (not (and (<= 1 g12) (<= g12 64))) (= unmatched_g1_set__split_fields8 (mk___split_fields__ref unmatched_g1_set__split_fields2))))
(assert (=> (not (and (<= 1 g12) (<= g12 64))) (= g17 g12)))
(assert (=> (not (and (<= 1 g12) (<= g12 64))) (= unmatched_g1_set__split_fields9 unmatched_g1_set__split_fields2)))
...
(assert (=> (< 0 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality (us_split_fields__content unmatched_g1_set__split_fields8)))) (= unmatched_g2_set4 (mk_map__ref7 unmatched_g2_set3))))
...
(assert (=> (not (< 0 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality (us_split_fields__content unmatched_g1_set__split_fields8))))) (= unmatched_g2_set6 (mk_map__ref7 unmatched_g2_set1))))
...
(assert (= result8 (mk_map__ref stable_marriage__matching__result)))
...
(assert (= ranking_2_inverted2 (mk_map__ref5 ranking_2_inverted1)))
...
(assert (= (= result9 true) (forall ((g110 Int)) (=> (and (<= 1 g110) (<= g110 64)) (exists ((g21 Int)) (and (and (<= 1 g21) (<= g21 64)) (= (to_rep (select (map__content stable_marriage__matching__result4) g21)) g110)))))))
(assert (= result9 true))
(assert (<= 1 g11))
(assert (<= g11 64))
(assert (<= 1 g2))
(assert (<= g2 64))
(assert (and (= o15 (is_preferred_1 (to_rep (select (map__content stable_marriage__matching__result4) g2)) g11 (select ranking_2 g2))) (= (= o15 true) (<= (to_rep2 (select (invert_1 (select ranking_2 g2)) (to_rep (select (map__content stable_marriage__matching__result4) g2)))) (to_rep2 (select (invert_1 (select ranking_2 g2)) g11))))))
(assert (and (= temp___558 (invert_map (map__content stable_marriage__matching__result4))) (and (forall ((g110 Int)) (=> (and (<= 1 g110) (<= g110 64)) (= (to_rep (select (map__content stable_marriage__matching__result4) (to_rep1 (select temp___558 g110)))) g110))) (forall ((g21 Int)) (=> (and (<= 1 g21) (<= g21 64)) (= (to_rep1 (select temp___558 (to_rep (select (map__content stable_marriage__matching__result4) g21)))) g21))))))
(assert (= o13 (select temp___558 g11)))
(assert (= o14 (to_rep1 o13)))
(assert (not (= (is_permutation_2 (select ranking_1 g11)) true)))
(check-sat)
(exit)
