...
(assert (forall ((temp___133 Int) (temp___134 Int) (temp___135 Int)) (let ((temp___132 (p__x__aggregate_def temp___133 temp___134 temp___135))) (and (and (= (select temp___132 5) (of_rep temp___133)) (= (select temp___132 6) (of_rep temp___134))) (= (select temp___132 7) (of_rep temp___135))))))
