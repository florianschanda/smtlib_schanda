...
(assert (and (and (and (and (and (and (<= 0 (to_rep1 (select s__split_fields5 topstacki2))) (< (to_rep1 (select s__split_fields5 topstacki2)) (to_rep1 s__split_fields2))) (<= 0 (to_rep1 (select s__split_fields6 topstacki2)))) (< (to_rep1 (select s__split_fields6 topstacki2)) (to_rep1 (select s__split_fields3 (to_rep1 (select s__split_fields5 topstacki2)))))) (= (to_rep1 (select (select s__split_fields4 (to_rep1 (select s__split_fields5 topstacki2))) (to_rep1 (select s__split_fields6 topstacki2)))) topstacki2)) (= (to_rep1 (select s__split_fields5 topstacki2)) i2)) (= (to_rep1 (select s__split_fields6 topstacki2)) (- stackisize2 1))))
(assert (= result5 (mk_int__ref pred2)))
(assert (= pred3 topstacki2))
