...
(assert (and (= o2 (remove_swap a (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) o1)) (and (in_range3 o2) (=> (= (of_int o2) true) (= (let ((temp___157 (remove (remove a o1) (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))))) (let ((temp___156 (remove (remove a (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w)))) (- o1 1)))) (bool_eq (elts temp___156) (to_rep2 (first (rt temp___156))) (to_rep2 (last (rt temp___156))) (elts temp___157) (to_rep2 (first (rt temp___157))) (to_rep2 (last (rt temp___157)))))) true)))))
...
(assert (and (= o11 (remove a o10)) (and (dynamic_invariant2 o11 true false true) (and (= (invariant__ o11) true) (and (= (to_rep2 (last (rt o11))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o10 1))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o11) k))))) (and (forall ((k Int)) (=> (and (<= (+ o10 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o11) (- k 1)))))) (forall ((k Int)) (=> (and (<= o10 k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o11) k))))))))))))
(assert (and (= o12 (remove o11 (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant2 o12 true false true) (and (= (invariant__ o12) true) (and (= (to_rep2 (last (rt o12))) (- (to_rep2 (last (rt o11))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts o11) k)) (to_rep (select (elts o12) k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep2 (last (rt o11))))) (= (to_rep (select (elts o11) k)) (to_rep (select (elts o12) (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep2 (last (rt o11))) 1))) (= (to_rep (select (elts o11) (+ k 1))) (to_rep (select (elts o12) k))))))))))))
(assert (and (= o9 (remove bb ib1)) (and (dynamic_invariant2 o9 true false true) (and (= (invariant__ o9) true) (and (= (to_rep2 (last (rt o9))) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o9) k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o9) (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o9) k))))))))))))
(assert (and (= o6 (- ia1 1)) (in_range1 (- ia1 1))))
(assert (and (= o7 o6) (in_range4 o6)))
(assert (and (= o8 (remove aa o7)) (and (dynamic_invariant2 o8 true false true) (and (= (invariant__ o8) true) (and (= (to_rep2 (last (rt o8))) (- (to_rep2 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o7 1))) (= (to_rep (select (elts aa) k)) (to_rep (select (elts o8) k))))) (and (forall ((k Int)) (=> (and (<= (+ o7 1) k) (<= k (to_rep2 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select (elts o8) (- k 1)))))) (forall ((k Int)) (=> (and (<= o7 k) (<= k (- (to_rep2 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select (elts o8) k))))))))))))
(assert (and (= o13 (shift_perm_l o8 o9 o12)) (and (in_range3 o13) (=> (= (of_int o13) true) (= (is_perm o12 o9) true)))))
