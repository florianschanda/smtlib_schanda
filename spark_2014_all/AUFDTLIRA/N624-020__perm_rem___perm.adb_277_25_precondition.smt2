...
(assert (= ih14 o106))
(assert (= (of_int ih14) true))
(assert (and (= o110 (remove b ib10)) (and (dynamic_invariant2 o110 true false true) (and (= (invariant__ o110) true) (and (= (to_rep2 (last (rt o110))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- ib10 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o110) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ ib10 1) k1) (<= k1 (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o110) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= ib10 k1) (<= k1 (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o110) k1))))))))))))
(assert (and (= o111 (remove o110 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (dynamic_invariant2 o111 true false true) (and (= (invariant__ o111) true) (and (= (to_rep2 (last (rt o111))) (- (to_rep2 (last (rt o110))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) (= (to_rep (select (elts o110) k1)) (to_rep (select (elts o111) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k1) (<= k1 (to_rep2 (last (rt o110))))) (= (to_rep (select (elts o110) k1)) (to_rep (select (elts o111) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k1) (<= k1 (- (to_rep2 (last (rt o110))) 1))) (= (to_rep (select (elts o110) (+ k1 1))) (to_rep (select (elts o111) k1))))))))))))
(assert (and (= o107 ia3) (in_range4 ia3)))
(assert (and (= o108 (remove a o107)) (and (dynamic_invariant2 o108 true false true) (and (= (invariant__ o108) true) (and (= (to_rep2 (last (rt o108))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o107 1))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o108) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o107 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o108) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o107 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select (elts o108) k1))))))))))))
(assert (and (= o109 (remove o108 (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant2 o109 true false true) (and (= (invariant__ o109) true) (and (= (to_rep2 (last (rt o109))) (- (to_rep2 (last (rt o108))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts o108) k1)) (to_rep (select (elts o109) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k1) (<= k1 (to_rep2 (last (rt o108))))) (= (to_rep (select (elts o108) k1)) (to_rep (select (elts o109) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k1) (<= k1 (- (to_rep2 (last (rt o108))) 1))) (= (to_rep (select (elts o108) (+ k1 1))) (to_rep (select (elts o109) k1))))))))))))
(assert (not (= (invariant__ o109) true)))
(check-sat)
(exit)
