...
(define-fun dynamic_invariant1 ((temp___expr_239 Int) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (=> (or (= temp___is_init_236 true) (<= 0 5)) (in_range2 temp___expr_239)))
(define-fun dynamic_invariant2 ((temp___expr_245 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 5)) (in_range3 temp___expr_245)))
...
(declare-const temp___292 length_t)
(declare-const temp___2921 (Array Int character))
(declare-const o4 character)
(declare-const o5 Int)
(declare-const o6 (Array Int character))
(declare-const o7 length_t)
(declare-const o8 (Array Int character))
(declare-const temp___296 length_t)
(declare-const temp___2961 (Array Int character))
...
(declare-const result2 length_t)
(declare-const result3 (Array Int character))
(declare-const s__split_fields4 length_t)
(declare-const s__split_fields5 (Array Int character))
(declare-const s__split_fields6 length_t)
(declare-const s__split_fields7 (Array Int character))
(declare-const s__split_fields8 length_t)
(declare-const s__split_fields9 (Array Int character))
(assert (and (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 s__split_fields) 1) i2) (<= i2 5)) (= (to_rep (select s__split_fields1 i2)) 32))) (< (to_rep1 s__split_fields) 5)))
...
(assert (and (<= 1 (to_rep1 s__split_fields2)) (<= (to_rep1 s__split_fields2) 5)))
...
(assert (<= (+ (to_rep1 s__split_fields6) 1) i2))
(assert (<= i2 5))
(assert (not (= (to_rep (select s__split_fields7 i2)) 32)))
(check-sat)
(exit)
