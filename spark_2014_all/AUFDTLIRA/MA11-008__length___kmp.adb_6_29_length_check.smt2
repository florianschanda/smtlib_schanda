...
(assert (not (= (ite (<= (to_rep (first4 temp___1661)) (to_rep (last4 temp___1661))) (+ (- (to_rep (last4 temp___1661)) (to_rep (first4 temp___1661))) 1) 0) (ite (<= (to_rep (first (rt p))) (to_rep (last (rt p)))) (+ (- (to_rep (last (rt p))) (to_rep (first (rt p)))) 1) 0))))
(check-sat)
(exit)
