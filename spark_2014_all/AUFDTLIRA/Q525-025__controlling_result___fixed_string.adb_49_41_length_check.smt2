...
(assert (not (= (ite (<= (to_rep1 (first4 temp___2271)) (to_rep1 (last4 temp___2271))) (+ (- (to_rep1 (last4 temp___2271)) (to_rep1 (first4 temp___2271))) 1) 0) (ite (<= 1 (to_rep2 (rec__fixed_string__object__width (us_split_fields1 this)))) (+ (- (to_rep2 (rec__fixed_string__object__width (us_split_fields1 this))) 1) 1) 0))))
(check-sat)
(exit)
