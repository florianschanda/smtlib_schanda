...
(assert (= d2 o2))
(assert (and (= o3 (to_rep1 t__split_fields)) (in_range5 (to_rep1 t__split_fields))))
(assert (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) o3) j2))) true)))
(check-sat)
(exit)
