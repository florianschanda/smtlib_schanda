...
(assert (= d3 o6))
(assert (and (= o7 (to_rep1 t__split_fields)) (in_range3 (to_rep1 t__split_fields))))
(assert (not (= (valid_root (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) o7) true)))
(check-sat)
(exit)
