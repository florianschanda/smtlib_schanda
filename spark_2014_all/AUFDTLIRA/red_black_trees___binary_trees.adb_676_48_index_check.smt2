...
(assert (= o22 v))
(assert (= (mk___rep1 (mk___split_fields1 o23 o24 o25 o26)) (select f_old__split_fields1 o22)))
(assert (= o23 o27))
(assert (= o24 o28))
(assert (= o25 o29))
(assert (= o26 o30))
...
(assert (and (<= 1 v) (<= v 100)))
(assert (= o10 v))
(assert (= (mk___rep1 (mk___split_fields1 o11 o12 o13 o14)) (select f__split_fields1 o10)))
(assert (= o11 o15))
(assert (= o12 o16))
(assert (= o13 o17))
(assert (= o14 o18))
