...
(declare-const result5 (Array Int group2_id))
(assert (forall ((g11 Int)) (=> (and (<= 1 g11) (<= g11 64)) (exists ((g210 Int)) (and (and (<= 1 g210) (<= g210 64)) (= (to_rep (select g2_to_g1 g210)) g11))))))
(assert (and (and (and (= (mk_map__ref1 result) (mk_map__ref1 result__)) (= result__1 (stable_marriage__invert_map__result__aggregate_def 64))) (and (forall ((g211 Int)) (=> (and (<= 1 g211) (<= g211 64)) (forall ((g221 Int)) (=> (and (<= 1 g221) (<= g221 64)) (=> (not (= g211 g221)) (not (= (to_rep (select g2_to_g1 g211)) (to_rep (select g2_to_g1 g221))))))))) (and (and (and (= (mk_int__ref result1) (mk_int__ref g2)) (= g21 1)) (ite (and (<= 1 g21) (<= g21 64)) (and (and (and (= temp___465 result__1) (and (= temp___464 g21) (and (and (forall ((prev1 Int)) (=> (and (<= 1 prev1) (<= prev1 (- g22 1))) (= (to_rep1 (select result__2 (to_rep (select g2_to_g1 prev1)))) prev1))) (forall ((g11 Int)) (=> (and (<= 1 g11) (<= g11 64)) (=> (exists ((prev21 Int)) (and (and (<= 1 prev21) (<= prev21 (- g22 1))) (= (to_rep (select g2_to_g1 prev21)) g11))) (= (to_rep (select g2_to_g1 (to_rep1 (select result__2 g11)))) g11))))) (and (and (=> (<= 1 64) (in_range2 g22)) (and (<= 1 g22) (<= g22 64))) (and (and (and (= (to_rep1 o) g22) (= o1 (store result__2 (to_rep (select g2_to_g1 g22)) o))) (and (= result__2 result2) (= result__3 o1))) (= g22 64)))))) (and (and (= g22 g24) (= result__3 result__4)) (and (= g25 g22) (= result__5 result__3)))) (and (and (= (mk_int__ref g26) (mk_int__ref g24)) (= (mk_map__ref1 result__6) (mk_map__ref1 result__4))) (and (= g27 g25) (= result__7 result__5)))) (and (and (= g21 g26) (= result__1 result__6)) (and (= g27 g21) (= result__7 result__1))))) (and (and (= stable_marriage__invert_map__result1 stable_marriage__invert_map__result2) (= stable_marriage__invert_map__result3 stable_marriage__invert_map__result1)) (and (= result4 stable_marriage__invert_map__result) (= stable_marriage__invert_map__result1 result__6)))))) (and (and (= (mk_map__ref1 stable_marriage__invert_map__result4) (mk_map__ref1 stable_marriage__invert_map__result2)) (and (= (mk_int__ref g28) (mk_int__ref g26)) (= (mk_map__ref1 result__8) (mk_map__ref1 result__6)))) (and (= stable_marriage__invert_map__result5 stable_marriage__invert_map__result3) (and (= g29 g27) (= result__9 result__7))))))
(assert (= result5 stable_marriage__invert_map__result4))
(declare-const g11 Int)
(assert (<= 1 g11))
(assert (<= g11 64))
(assert (not (= (to_rep (select g2_to_g1 (to_rep1 (select stable_marriage__invert_map__result4 g11)))) g11)))
(check-sat)
(exit)
