...
(assert (<= 1 i3))
(assert (<= i3 100))
(assert (and (= o92 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (and (= temp___1118 (model__ (rec__search_trees__search_tree__struct t__split_fields11) o92)) (and (dynamic_invariant6 temp___1118 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1118 o92))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1118 o92)))) 0) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (not (= i6 o92)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct t__split_fields11) i6) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1118 (parent (rec__search_trees__search_tree__struct t__split_fields11) i6)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1118 i6))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1118 i6))) true)))))) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1118 i6))) true) (not (= i6 o92))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1118 (parent (rec__search_trees__search_tree__struct t__split_fields11) i6)))) (position (rec__search_trees__search_tree__struct t__split_fields11) i6) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1118 i6)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1118 i6)))) 0)))) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1118 i6))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1118 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1118 i6))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1118 j15)))) true)) (= j15 i6))))))))))))))
(assert (= o93 (select temp___1118 x1)))
(assert (= o94 (us_split_fields1 o93)))
(assert (= o95 (rec__tree_model__path_type__a o94)))
(assert (and (= o88 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)))))
(assert (not (= (valid_root (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) o88) true)))
(check-sat)
(exit)
