...
(assert (and (forall ((g22 Int)) (=> (and (<= 1 g22) (<= g22 64)) (= (is_permutation_1 (select ranking_2 g22)) true))) (and (= (bool_eq6 (invert ranking_2) 1 64 ranking_2_inverted 1 64) true) (and (= (invariant_holds (mk___split_fields unmatched_g1_set__split_fields unmatched_g1_set__split_fields1) proposals_made result__ unmatched_g2_set) true) (< 0 (to_rep3 unmatched_g1_set__split_fields1))))))
(assert (=> (<= 1 64) (in_range1 g1)))
(assert (=> (<= 1 64) (in_range2 g2)))
(assert (= result (mk_int__ref rank)))
(assert (= rank2 1))
(assert (in_range3 rank2))
...
(assert (=> (not (= already_asked1 0)) (not (= (is_preferred_1 g11 (to_rep (select result__ (to_rep1 (select (select ranking_1 g11) (- rank3 1))))) (select ranking_2 (to_rep1 (select (select ranking_1 g11) (- rank3 1))))) true))))
(assert (=> (not (not (= already_asked1 0))) (= rank3 rank2)))
(assert (= result5 (mk_int__ref g2)))
(assert (= g21 (to_rep1 (select (select ranking_1 g11) rank3))))
...
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= result9 accepted4))))
...
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= result12 accepted4))))
...
(assert (<= g1_id 64))
(assert (<= 1 rank1))
(assert (<= rank1 (to_rep3 (select proposals_made1 g1_id))))
...
(assert (=> (= result16 true) (= o45 (to_rep1 o44))))
...
(assert (=> (= result16 true) (= o40 (to_rep1 o39))))
(assert (=> (= result16 true) (= o41 (select result__2 o40))))
(assert (=> (= result16 true) (= o42 (to_rep o41))))
(assert (=> (= result16 true) (and (= o47 (is_preferred_1 g1_id o42 o46)) (= (= o47 true) (<= (to_rep2 (select (invert_1 o46) g1_id)) (to_rep2 (select (invert_1 o46) o42)))))))
