...
(declare-const temp___649 (Array Int (Array Int ranking)))
(declare-const o Int)
...
(declare-const o11 group2_id)
(declare-const o12 Int)
(declare-const o13 group1_id)
(declare-const o14 Int)
(declare-const o15 Int)
(declare-const o16 group2_id)
(declare-const o17 Int)
(declare-const o18 (Array Int group1_id))
(declare-const o19 Bool)
(declare-const o20 Int)
(declare-const o21 count)
(declare-const o22 (Array Int count))
(declare-const o23 Int)
(declare-const o24 count)
(declare-const o25 (Array Int group1_id))
(declare-const o26 count)
(declare-const temp___603 (Array Int group1_id))
(declare-const temp___6031 count)
(declare-const o27 group1_id)
(declare-const o28 Int)
(declare-const o29 (Array Int group1_id))
(declare-const o30 (Array Int group1_id))
(declare-const o31 count)
(declare-const temp___607 (Array Int group1_id))
(declare-const temp___6071 count)
(declare-const us Bool)
(declare-const o32 Int)
(declare-const o33 count)
(declare-const o34 (Array Int group1_id))
(declare-const o35 count)
(declare-const temp___595 us_rep)
(declare-const o36 group1_id)
(declare-const o37 Int)
(declare-const o38 (Array Int group1_id))
(declare-const o39 us_split_fields)
(declare-const temp___599 us_rep)
(declare-const o40 group1_id)
(declare-const o41 (Array Int group1_id))
(declare-const g2_id Int)
(declare-const idx Int)
(declare-const g1_id Int)
(declare-const rank1 Int)
(declare-const o42 Int)
(declare-const o43 group2_id)
(declare-const o44 Int)
(declare-const o45 group1_id)
(declare-const o46 Int)
(declare-const o47 Bool)
(declare-const o48 Int)
(declare-const o49 group2_id)
(declare-const o50 Int)
(declare-const o51 group1_id)
(declare-const o52 Int)
(declare-const o53 Int)
(declare-const o54 group2_id)
(declare-const o55 Int)
(declare-const o56 (Array Int group1_id))
(declare-const o57 Bool)
(declare-const o58 Bool)
(declare-const g1_id1 Int)
(declare-const idx1 Int)
(declare-const g1_id2 Int)
...
(assert (= result1 (mk_int__ref rank)))
(assert (= rank2 1))
...
(assert (= result3 (mk___split_fields__ref (mk___split_fields unmatched_g1_set__split_fields unmatched_g1_set__split_fields1))))
...
(assert (= result4 (mk_int__ref already_asked)))
...
(assert (=> (not (= already_asked1 0)) (= result5 (mk_int__ref rank2))))
...
(assert (=> (= already_asked1 0) (= rank3 rank2)))
(assert (= result6 (mk_int__ref g2)))
(assert (= g21 (to_rep1 (select (select ranking_1 g11) rank3))))
(assert (and (= o20 (+ (to_rep3 (select proposals_made g11)) 1)) (in_range4 (+ (to_rep3 (select proposals_made g11)) 1))))
(assert (= (to_rep3 o21) o20))
(assert (= o22 (store proposals_made g11 o21)))
(assert (= result7 (mk_map__ref7 proposals_made)))
(assert (= proposals_made1 o22))
(assert (=> (= (select unmatched_g2_set g21) true) (= result8 (mk_bool__ref accepted))))
(assert (=> (= (select unmatched_g2_set g21) true) (= accepted1 (of_int 1))))
(assert (=> (= (select unmatched_g2_set g21) true) (= result9 (mk_map__ref5 unmatched_g2_set))))
(assert (=> (= (select unmatched_g2_set g21) true) (= unmatched_g2_set2 (store unmatched_g2_set g21 (of_int 0)))))
(assert (=> (= (select unmatched_g2_set g21) true) (= unmatched_g1_set__split_fields4 unmatched_g1_set__split_fields2)))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= result10 (mk_bool__ref accepted)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= accepted2 (of_int 1)))))
...
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (and (= o23 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1))))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= (to_rep3 o24) o23))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields2) o25))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= o24 o26))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= temp___603 o25))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= temp___6031 o26))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= result11 (mk___split_fields__ref unmatched_g1_set__split_fields2)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= unmatched_g1_set__split_fields3 (mk___split_fields temp___603 temp___6031)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= (to_rep o27) c132b))))
...
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= o28 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3))))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= o29 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) o28 o27)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= o29 o30))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields3) o31))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= temp___607 o30))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= temp___6071 o31))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= result12 (mk___split_fields__ref unmatched_g1_set__split_fields3)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21))))) (= unmatched_g1_set__split_fields4 (mk___split_fields temp___607 temp___6071)))))
...
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= result13 (mk_bool__ref accepted)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= accepted3 (of_int 0)))))
...
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (and (= o32 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1)) (in_range4 (+ (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields2)) 1))))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= (to_rep3 o33) o32))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields2) o34))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= o33 o35))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= temp___595 (mk___rep (mk___split_fields o34 o35))))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= result14 (mk___split_fields__ref unmatched_g1_set__split_fields2)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= unmatched_g1_set__split_fields5 (us_split_fields1 temp___595)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= (to_rep o36) c134b))))
...
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= o37 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields5))))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= o38 (store (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields5) o37 o36)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= o39 (mk___split_fields o38 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields5))))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= temp___599 (mk___rep o39)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= result15 (mk___split_fields__ref unmatched_g1_set__split_fields5)))))
(assert (=> (not (= (select unmatched_g2_set g21) true)) (=> (not (< (to_rep2 (select (select ranking_2_inverted g21) g11)) (to_rep2 (select (select ranking_2_inverted g21) (to_rep (select result__ g21)))))) (= unmatched_g1_set__split_fields6 (us_split_fields1 temp___599)))))
...
(assert (=> (= accepted1 true) (= (to_rep o40) g11)))
(assert (=> (= accepted1 true) (= o41 (store result__ g21 o40))))
(assert (=> (= accepted1 true) (= result16 (mk_map__ref result__))))
(assert (=> (= accepted1 true) (= result__2 o41)))
...
(assert (forall ((g2_id1 Int)) (=> (and (<= 1 g2_id1) (<= g2_id1 64)) (=> (not (= (select unmatched_g2_set2 g2_id1) true)) (forall ((idx3 Int)) (=> (and (<= 1 idx3) (<= idx3 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (not (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) idx3)) (to_rep (select result__2 g2_id1))))))))))
(assert (<= 1 g1_id))
(assert (<= g1_id 64))
(assert (<= 1 rank1))
...
(assert (= o42 rank1))
(assert (= o43 (select (select ranking_1 g1_id) o42)))
(assert (= o44 (to_rep1 o43)))
(assert (= o45 (select result__2 o44)))
(assert (= o46 (to_rep o45)))
(assert (= o47 (ite (= o46 g1_id) true false)))
(assert (= result17 (ite (not (= o47 true)) true false)))
(assert (=> (= result17 true) (and (<= 1 rank1) (<= rank1 64))))
(assert (=> (= result17 true) (= o53 rank1)))
(assert (=> (= result17 true) (= o54 (select (select ranking_1 g1_id) o53))))
(assert (=> (= result17 true) (= o55 (to_rep1 o54))))
(assert (=> (= result17 true) (= o56 (select ranking_2 o55))))
(assert (=> (= result17 true) (and (<= 1 rank1) (<= rank1 64))))
(assert (=> (= result17 true) (= o48 rank1)))
(assert (=> (= result17 true) (= o49 (select (select ranking_1 g1_id) o48))))
(assert (=> (= result17 true) (= o50 (to_rep1 o49))))
(assert (=> (= result17 true) (= o51 (select result__2 o50))))
(assert (=> (= result17 true) (= o52 (to_rep o51))))
(assert (=> (= result17 true) (and (= o57 (is_preferred_1 g1_id o52 o56)) (= (= o57 true) (<= (to_rep2 (select (invert_1 o56) g1_id)) (to_rep2 (select (invert_1 o56) o52)))))))
(assert (=> (= result17 true) (= o58 (ite (not (= o57 true)) true false))))
(assert (=> (not (= result17 true)) (= o58 (of_int 1))))
(assert (not (<= 1 rank1)))
(check-sat)
(exit)
