...
(assert (and (= temp___1174 (model__1 (mk___rep3 t_old__split_fields4))) (and (dynamic_invariant6 temp___1174 true false true) (= temp___1174 (model__ (rec__search_trees__search_tree__struct t_old__split_fields4) (to_rep1 (rec__search_trees__search_tree__root t_old__split_fields4)))))))
(assert (= o180 (select temp___1174 j5)))
(assert (= o181 (us_split_fields1 o180)))
(assert (= result33 (rec__tree_model__path_type__k o181)))
