...
(declare-const n Int)
(declare-const j Int)
(declare-const temp___1918 (Array Int us_rep1))
...
(assert (<= 0 n1))
(assert (<= n1 100))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j1))) true) (not (= j1 root))) (< n2 (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j1)))))))))
(assert (and (=> (<= 0 100) (in_range2 n2)) (and (<= 0 n2) (<= n2 100))))
(assert (<= 1 j))
(assert (<= j 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= temp___1918 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant3 temp___1918 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1918 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1918 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1918 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1918 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1918 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1918 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1918 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1918 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1918 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1918 i))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1918 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1918 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1918 j1)))) true)) (= j1 i))))))))))))))
(assert (= (mk___rep (mk___split_fields o o1)) (select temp___1918 j)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= o4 o3))
(assert (= result1 (ite (and (= o4 true) (not (= j root))) true false)))
(assert (= result1 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
