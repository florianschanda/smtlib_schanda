...
(define-fun bool_eq ((a (Array Int element)) (a__first Int) (a__last Int) (b (Array Int element)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep2 (select a temp___idx_132)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((a (Array Int element)) (b (Array Int element))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int element)) (b (Array Int element))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant2 ((temp___expr_153 us_rep) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (and (=> (= temp___do_toplevel_152 true) (=> (= temp___is_init_150 true) (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 temp___expr_153))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 temp___expr_153)))))) (let ((temp___155 (rec__integer_stacks__stack__capacity (us_split_discrs1 temp___expr_153)))) (and (dynamic_property1 1 (to_rep1 temp___155) (first1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_153))) (last1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_153)))) (and (= (first1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_153))) 1) (= (last1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_153))) (to_rep1 temp___155)))))))
(define-fun dynamic_predicate ((temp___157 us_rep)) Bool (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 temp___157))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 temp___157)))))
...
(declare-datatypes () ((tT23bP1__ref (mk_tT23bP1__ref (tT23bP1__content integer)))))
(define-fun tT23bP1__ref___projection ((a tT23bP1__ref)) integer (tT23bP1__content a))
(declare-sort t1 0)
(declare-fun first2 (t1) integer)
(declare-fun last2 (t1) integer)
(declare-fun mk1 (Int Int) t1)
(assert (forall ((f Int) (l Int)) (! (=> (in_range3 f) (=> (in_range3 l) (and (= (to_rep3 (first2 (mk1 f l))) f) (= (to_rep3 (last2 (mk1 f l))) l)))) :pattern ((mk1 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range3 f) (=> (in_range3 l) (and (= (to_rep3 (first4 (mk2 f l))) f) (= (to_rep3 (last4 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
...
(define-fun bool_eq5 ((x us_t2) (y us_t2)) Bool (bool_eq (elts2 x) (to_rep3 (first4 (rt2 x))) (to_rep3 (last4 (rt2 x))) (elts2 y) (to_rep3 (first4 (rt2 y))) (to_rep3 (last4 (rt2 y)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range3 f) (=> (in_range3 l) (and (= (to_rep3 (first6 (mk3 f l))) f) (= (to_rep3 (last6 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
...
(define-fun bool_eq7 ((x us_t3) (y us_t3)) Bool (bool_eq (elts3 x) (to_rep3 (first6 (rt3 x))) (to_rep3 (last6 (rt3 x))) (elts3 y) (to_rep3 (first6 (rt3 y))) (to_rep3 (last6 (rt3 y)))))
...
(define-fun bool_eq8 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 a))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 b)))) (= (bool_eq7 (rec__integer_stacks__stack__values3 (us_split_fields7 a)) (rec__integer_stacks__stack__values3 (us_split_fields7 b))) true)) (= (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 a))) (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 b))))) true false))
...
(define-fun dynamic_predicate1 ((temp___213 us_rep1)) Bool (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 (to_base temp___213)))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base temp___213))))))
...
(define-fun dynamic_invariant5 ((temp___expr_234 us_rep3) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (and (and (=> (not (= temp___skip_constant_232 true)) (in_range7 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (to_base2 temp___expr_234))) (=> (= temp___do_toplevel_233 true) (=> (= temp___is_init_231 true) (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 (to_base2 temp___expr_234)))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base2 temp___expr_234)))))))) (and (dynamic_property7 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_234))) (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_234)))) (and (= (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_234))) 1) (= (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_234))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))))
(define-fun default_initial_assumption ((temp___expr_238 us_rep3) (temp___skip_top_level_239 Bool)) Bool (and (and (= (attr__tag3 temp___expr_238) us_tag3) (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_238))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (= (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 temp___expr_238))) 0))) (=> (not (= temp___skip_top_level_239 true)) (= (empty (to_base2 temp___expr_238)) true))))
(define-fun dynamic_predicate2 ((temp___245 us_rep3)) Bool (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 (to_base2 temp___245)))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base2 temp___245))))))
...
(define-fun dynamic_invariant6 ((temp___expr_218 us_rep2) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (and (and (=> (not (= temp___skip_constant_216 true)) (in_range6 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (to_base1 temp___expr_218))) (=> (= temp___do_toplevel_217 true) (=> (= temp___is_init_215 true) (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 (to_base1 temp___expr_218)))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base1 temp___expr_218)))))))) (and (dynamic_property5 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (first5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_218))) (last5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_218)))) (and (= (first5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_218))) 1) (= (last5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_218))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))))))))
(define-fun default_initial_assumption1 ((temp___expr_222 us_rep2) (temp___skip_top_level_223 Bool)) Bool (and (and (= (attr__tag2 temp___expr_222) us_tag2) (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_222))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right)))) (= (to_rep (rec__integer_stacks__stack__top2 (us_split_fields5 temp___expr_222))) 0))) (=> (not (= temp___skip_top_level_223 true)) (= (empty (to_base1 temp___expr_222)) true))))
(define-fun dynamic_predicate3 ((temp___229 us_rep2)) Bool (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 (to_base1 temp___229)))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base1 temp___229))))))
(declare-const temp___250 positive)
(declare-const temp___2501 natural)
(declare-const temp___2502 Int)
(declare-const temp___256 positive)
(declare-const temp___2561 (Array Int element))
(declare-const temp___2562 t)
(declare-const temp___2563 natural)
(declare-const temp___2564 us_private)
(declare-const temp___2565 Int)
(define-fun temp___2566 () us_rep (mk___rep (mk___split_discrs temp___256) (mk___split_fields (mk___t temp___2561 temp___2562) temp___2563 temp___2564) temp___2565))
(assert (and (= temp___2502 us_tag) (= (to_rep temp___2501) 0)))
(assert (<= (to_rep temp___2501) (to_rep1 temp___250)))
(assert (and (dynamic_invariant2 temp___2566 true false true) (and (= temp___2565 us_tag) (= (to_rep temp___2563) 0))))
(assert (not (= (empty temp___2566) true)))
(check-sat)
(exit)
