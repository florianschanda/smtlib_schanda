...
(assert (and (dynamic_invariant2 (mk___rep (mk___split_discrs temp___256) (mk___split_fields (mk___t temp___2561 temp___2562) temp___2563 temp___2564) temp___2565) true false true) (and (= temp___2565 us_tag) (= (to_rep temp___2563) 0))))
(assert (not (= (empty (mk___rep (mk___split_discrs temp___256) (mk___split_fields (mk___t temp___2561 temp___2562) temp___2563 temp___2564) temp___2565)) true)))
(check-sat)
(exit)
