...
(define-fun dynamic_invariant2 ((temp___expr_178 us_rep) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool) (temp___do_typ_inv_177 Bool)) Bool (and (=> (= temp___do_toplevel_176 true) (=> (= temp___is_init_174 true) (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 temp___expr_178))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 temp___expr_178)))))) (let ((temp___180 (rec__integer_stacks__stack__capacity (us_split_discrs1 temp___expr_178)))) (and (dynamic_property1 1 (to_rep1 temp___180) (first1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_178))) (last1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_178)))) (and (= (first1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_178))) 1) (= (last1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_178))) (to_rep1 temp___180)))))))
(define-fun dynamic_predicate ((temp___182 us_rep)) Bool (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 temp___182))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 temp___182)))))
...
(define-fun dynamic_predicate1 ((temp___239 us_rep1)) Bool (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 (to_base temp___239)))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base temp___239))))))
...
(define-fun dynamic_invariant5 ((temp___expr_262 us_rep3) (temp___is_init_258 Bool) (temp___skip_constant_259 Bool) (temp___do_toplevel_260 Bool) (temp___do_typ_inv_261 Bool)) Bool (and (and (=> (not (= temp___skip_constant_259 true)) (in_range7 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (to_base2 temp___expr_262))) (=> (= temp___do_toplevel_260 true) (=> (= temp___is_init_258 true) (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 (to_base2 temp___expr_262)))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base2 temp___expr_262)))))))) (and (dynamic_property7 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_262))) (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_262)))) (and (= (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_262))) 1) (= (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_262))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))))
(define-fun default_initial_assumption ((temp___expr_266 us_rep3) (temp___skip_top_level_267 Bool)) Bool (and (and (= (attr__tag3 temp___expr_266) us_tag3) (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_266))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (= (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 temp___expr_266))) 0))) (=> (not (= temp___skip_top_level_267 true)) (= (empty (to_base2 temp___expr_266)) true))))
(define-fun dynamic_predicate2 ((temp___273 us_rep3)) Bool (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 (to_base2 temp___273)))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base2 temp___273))))))
...
(define-fun dynamic_invariant6 ((temp___expr_245 us_rep2) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool) (temp___do_typ_inv_244 Bool)) Bool (and (and (=> (not (= temp___skip_constant_242 true)) (in_range6 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (to_base1 temp___expr_245))) (=> (= temp___do_toplevel_243 true) (=> (= temp___is_init_241 true) (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 (to_base1 temp___expr_245)))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base1 temp___expr_245)))))))) (and (dynamic_property5 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (first5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_245))) (last5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_245)))) (and (= (first5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_245))) 1) (= (last5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_245))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))))))))
(define-fun default_initial_assumption1 ((temp___expr_249 us_rep2) (temp___skip_top_level_250 Bool)) Bool (and (and (= (attr__tag2 temp___expr_249) us_tag2) (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_249))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right)))) (= (to_rep (rec__integer_stacks__stack__top2 (us_split_fields5 temp___expr_249))) 0))) (=> (not (= temp___skip_top_level_250 true)) (= (empty (to_base1 temp___expr_249)) true))))
(define-fun dynamic_predicate3 ((temp___256 us_rep2)) Bool (<= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 (to_base1 temp___256)))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base1 temp___256))))))
(declare-const temp___278 positive)
(declare-const temp___2781 natural)
(declare-const temp___2782 Int)
...
(define-fun temp___2846 () us_rep (mk___rep (mk___split_discrs temp___284) (mk___split_fields (mk___t temp___2841 temp___2842) temp___2843 temp___2844) temp___2845))
(assert (and (= temp___2782 us_tag) (= (to_rep temp___2781) 0)))
(assert (<= (to_rep temp___2781) (to_rep1 temp___278)))
(assert (and (dynamic_invariant2 temp___2846 true false true true) (and (= temp___2845 us_tag) (= (to_rep temp___2843) 0))))
(assert (not (= (empty temp___2846) true)))
(check-sat)
(exit)
