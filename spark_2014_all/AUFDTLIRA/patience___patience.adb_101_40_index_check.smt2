...
(assert (= o225 ist))
(assert (= o226 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o225)))
(assert (= o227 (to_rep1 o226)))
(assert (= o228 (- o227 1)))
(assert (= o229 (ite (<= ip o228) true false)))
(assert (= result37 (ite (<= 0 ip) o229 false)))
(assert (= result37 true))
(assert (and (<= 0 ist) (<= ist 99)))
(assert (= o233 ist))
(assert (= temp___673 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o233)))
(assert (and (<= 0 ip) (<= ip 99)))
(assert (= o234 ip))
(assert (= o235 (select temp___673 o234)))
(assert (= temp___674 (to_rep1 o235)))
(assert (and (<= 0 temp___674) (<= temp___674 99)))
(assert (= o236 temp___674))
(assert (= o237 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o236)))
(assert (= o238 (to_rep1 o237)))
(assert (= o239 (ite (= ip o238) true false)))
(assert (not (<= 0 ist)))
(check-sat)
(exit)
