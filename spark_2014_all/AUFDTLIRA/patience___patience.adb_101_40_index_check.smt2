...
(assert (= o109 ip))
(assert (= o110 (select temp___703 o109)))
(assert (= temp___704 (to_rep o110)))
(assert (and (<= 0 temp___704) (<= temp___704 99)))
(assert (= o111 temp___704))
(assert (= o112 (select (rec__patience__state__posheight (us_split_fields__content s__split_fields20)) o111)))
(assert (= o113 (to_rep o112)))
(assert (= o114 (ite (= ip o113) true false)))
(assert (not (<= ist 99)))
(check-sat)
(exit)
