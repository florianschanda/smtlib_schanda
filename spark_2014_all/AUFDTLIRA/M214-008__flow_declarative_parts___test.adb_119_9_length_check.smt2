...
(declare-fun temp_____aggregate_def_301 (Int Int Int) us_t1)
...
(assert (forall ((temp___303 Int) (temp___304 Int) (temp___305 Int)) (let ((temp___302 (temp_____aggregate_def_301 temp___303 temp___304 temp___305))) (=> (dynamic_invariant2 temp___303 true true true true) (and (=> (dynamic_property 1 2147483647 temp___304 temp___305) (and (= (first3 temp___302) temp___304) (= (last3 temp___302) temp___305))) (forall ((temp___306 Int)) (= (to_rep (select (to_array1 temp___302) temp___306)) temp___303)))))))
(declare-const b Int)
...
(assert (= (to_rep1 (first2 (rt1 (temp_____aggregate_def_301 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp_____aggregate_def_301 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___308 temp___3081) (temp_____aggregate_def_301 32 (to_rep1 a__first) (to_rep1 a__last))))
(assert (= temp___308 temp___309))
(assert (= (mk (to_rep1 (first2 temp___3081)) (to_rep1 (last2 temp___3081))) temp___3091))
(assert (not (= (ite (<= (to_rep1 (first temp___3091)) (to_rep1 (last temp___3091))) (+ (- (to_rep1 (last temp___3091)) (to_rep1 (first temp___3091))) 1) 0) (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0))))
(check-sat)
(exit)
