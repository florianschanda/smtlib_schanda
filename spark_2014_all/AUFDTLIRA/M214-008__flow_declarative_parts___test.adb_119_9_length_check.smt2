...
(assert (= (to_rep1 (first2 (rt1 (temp___301 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___301 32 (to_rep1 a__first) (to_rep1 a__last))))) (to_rep1 a__last)))
(assert (= (mk___t1 temp___308 temp___3081) (temp___301 32 (to_rep1 a__first) (to_rep1 a__last))))
