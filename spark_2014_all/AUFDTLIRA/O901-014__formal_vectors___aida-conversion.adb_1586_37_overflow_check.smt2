...
(assert (and (= o21 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= o22 (ite (<= index1 o21) true false)))
(assert (and (= o20 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (= o23 (ite (<= o20 index1) true false)))
(assert (= result (ite (= o23 true) o22 false)))
(assert (= (= o24 true) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (and (= temp___2010 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2010) (<= temp___2010 (to_rep1 (last (rt source))))))
(assert (= o16 temp___2010))
(assert (= o17 (select (elts source) o16)))
(assert (= o18 (to_rep o17)))
(assert (= o19 (ite (< o18 52) true false)))
(assert (and (= temp___2009 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2009) (<= temp___2009 (to_rep1 (last (rt source))))))
(assert (= o12 temp___2009))
(assert (= o13 (select (elts source) o12)))
(assert (= o14 (to_rep o13)))
(assert (= o15 (ite (= o14 55) true false)))
(assert (and (= temp___2008 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2008) (<= temp___2008 (to_rep1 (last (rt source))))))
(assert (= o8 temp___2008))
