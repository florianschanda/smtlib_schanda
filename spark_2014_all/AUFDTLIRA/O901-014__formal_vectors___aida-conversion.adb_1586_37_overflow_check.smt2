...
(assert (and (= o12 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (= o15 (ite (<= o12 index) true false)))
(assert (= result (ite (= o15 true) o14 false)))
(assert (= (= o16 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
(assert (and (= temp___2112 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2112) (<= temp___2112 (to_rep1 (last (rt source))))))
(assert (= o8 temp___2112))
(assert (= o9 (select (elts source) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (< o10 52) true false)))
(assert (and (= temp___2111 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2111) (<= temp___2111 (to_rep1 (last (rt source))))))
(assert (= o4 temp___2111))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 55) true false)))
(assert (and (= temp___2110 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2110) (<= temp___2110 (to_rep1 (last (rt source))))))
