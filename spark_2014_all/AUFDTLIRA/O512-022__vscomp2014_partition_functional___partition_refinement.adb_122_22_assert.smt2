...
(assert (forall ((c10 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c10) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c10) (to_rep (select a1 j))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c10))) (key (mk___rep d__split_discrs d__split_fields2) c10))))))
(assert (forall ((c10 us_rep1)) (=> (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c10) true) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c10))) (key (mk___rep d__split_discrs d__split_fields2) c10)))))
(assert (and (= o100 (+ (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields3)) 1)) (in_range2 (+ (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields3)) 1))))
(assert (= (to_rep1 o101) o100))
(assert (= o102 (mk___split_fields2 (rec__partition_refinement__interval__first p_elem__split_fields3) (rec__partition_refinement__interval__last p_elem__split_fields3) o101)))
(assert (= temp___1186 (mk___rep2 o102)))
(assert (= result21 (mk___split_fields__ref2 p_elem__split_fields3)))
...
(assert (= result22 (mk___split_fields__ref3 (mk___split_fields3 p__split_fields))))
