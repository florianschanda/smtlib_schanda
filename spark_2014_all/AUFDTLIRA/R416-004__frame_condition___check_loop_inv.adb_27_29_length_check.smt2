...
(assert (=> (<= i16 i16) (and (<= 31 i16) (<= i16 40))))
(assert (= o3 temp___330))
(assert (= o3 temp___331))
(assert (= (mk1 i16 i16) temp___3311))
(assert (not (= (ite (<= (to_rep (first2 temp___3261)) (to_rep (last2 temp___3261))) (+ (- (to_rep (last2 temp___3261)) (to_rep (first2 temp___3261))) 1) 0) (ite (<= (to_rep (first2 temp___3311)) (to_rep (last2 temp___3311))) (+ (- (to_rep (last2 temp___3311)) (to_rep (first2 temp___3311))) 1) 0))))
(check-sat)
(exit)
