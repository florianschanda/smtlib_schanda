...
(declare-const temp___441 Int)
(declare-const o2 Int)
(declare-const temp___442 (Array Int cardindex))
...
(assert (=> (and (and (and (<= 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s)))) (<= (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) (to_rep (rec__patience__state__numelts (us_split_fields1 s))))) (<= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 100)) (or (= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 0) (< 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s)))))) (= (= result true) (forall ((i1 Int)) (=> (and (<= 0 i1) (<= i1 (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1))) (and (and (<= 1 (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i1))) (<= (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i1)) (to_rep (rec__patience__state__numelts (us_split_fields1 s))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (to_rep (select (rec__patience__state__stacksizes (us_split_fields1 s)) i1)) 1))) (and (<= 0 (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i1) j))) (< (to_rep (select (select (rec__patience__state__stacks (us_split_fields1 s)) i1) j)) (to_rep (rec__patience__state__numelts (us_split_fields1 s)))))))))))))
(assert (=> (not (and (and (and (<= 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s)))) (<= (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) (to_rep (rec__patience__state__numelts (us_split_fields1 s))))) (<= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 100)) (or (= (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 0) (< 0 (to_rep (rec__patience__state__numstacks (us_split_fields1 s))))))) (= result false)))
(assert (= result true))
(assert (<= 0 i))
(assert (<= i (- (to_rep (rec__patience__state__numelts (us_split_fields1 s))) 1)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o20 i))
(assert (= o21 (select (rec__patience__state__posstack (us_split_fields1 s)) o20)))
(assert (= o22 (to_rep o21)))
(assert (= o23 (ite (<= o22 (- (to_rep (rec__patience__state__numstacks (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o17 i))
(assert (= o18 (select (rec__patience__state__posstack (us_split_fields1 s)) o17)))
(assert (= o19 (to_rep o18)))
(assert (= o24 (ite (<= 0 o19) true false)))
(assert (= result2 (ite (= o24 true) o23 false)))
(assert (=> (= result2 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result2 true) (= o8 i)))
(assert (=> (= result2 true) (= o9 (select (rec__patience__state__posstack (us_split_fields1 s)) o8))))
(assert (=> (= result2 true) (= temp___438 (to_rep o9))))
(assert (=> (= result2 true) (and (<= 0 temp___438) (<= temp___438 99))))
(assert (=> (= result2 true) (= o10 temp___438)))
(assert (=> (= result2 true) (= o11 (select (rec__patience__state__stacksizes (us_split_fields1 s)) o10))))
(assert (=> (= result2 true) (= o12 (to_rep o11))))
(assert (=> (= result2 true) (= o13 (- o12 1))))
(assert (=> (= result2 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result2 true) (= o6 i)))
(assert (=> (= result2 true) (= o7 (select (rec__patience__state__posheight (us_split_fields1 s)) o6))))
(assert (=> (= result2 true) (= o14 (to_rep o7))))
(assert (=> (= result2 true) (= o15 (ite (<= o14 o13) true false))))
(assert (=> (= result2 true) (and (<= 0 i) (<= i 99))))
(assert (=> (= result2 true) (= o3 i)))
(assert (=> (= result2 true) (= o4 (select (rec__patience__state__posheight (us_split_fields1 s)) o3))))
(assert (=> (= result2 true) (= o5 (to_rep o4))))
(assert (=> (= result2 true) (= o16 (ite (<= 0 o5) true false))))
(assert (=> (= result2 true) (= result1 (ite (= o16 true) o15 false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (= result1 true))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o i))
(assert (= o1 (select (rec__patience__state__posstack (us_split_fields1 s)) o)))
(assert (= temp___441 (to_rep o1)))
(assert (and (<= 0 temp___441) (<= temp___441 99)))
(assert (= o2 temp___441))
(assert (= temp___442 (select (rec__patience__state__stacks (us_split_fields1 s)) o2)))
(assert (not (<= i 99)))
(check-sat)
(exit)
