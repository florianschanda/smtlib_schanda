...
(assert (= o23 (ite (<= o22 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o17 i))
...
(assert (=> (= result2 true) (= temp___438 (to_rep1 o9))))
...
(assert (=> (= result2 true) (= o12 (to_rep1 o11))))
...
(assert (=> (= result2 true) (= o14 (to_rep1 o7))))
...
(assert (=> (= result2 true) (= o5 (to_rep1 o4))))
