...
(assert (=> (= result2 true) (= temp___408 (to_rep1 o9))))
(assert (=> (= result2 true) (and (<= 0 temp___408) (<= temp___408 99))))
(assert (=> (= result2 true) (= o10 temp___408)))
...
(assert (= temp___412 (select (rec__patience__state__stacks (us_split_fields1 s)) o2)))
(assert (not (<= 0 i)))
(check-sat)
(exit)
