...
(assert (and (< (to_rep (last (rt y))) 2147483647) (<= (to_rep (first (rt y))) (to_rep (last (rt y))))))
...
(assert (=> (= (length y) 0) (= (mk (- 2147483648) (- 2147483648)) concat_right__one__z__assume1)))
(assert (=> (not (= (length y) 0)) (=> (<= (to_rep (first (rt y))) (to_rep (last (rt y)))) (= o3 (+ (- (to_rep (last (rt y))) (to_rep (first (rt y)))) 1)))))
(assert (=> (not (= (length y) 0)) (=> (not (<= (to_rep (first (rt y))) (to_rep (last (rt y))))) (= o3 0))))
(assert (=> (not (= (length y) 0)) (= o4 (+ o3 1))))
(assert (=> (not (= (length y) 0)) (= o5 (+ (to_rep (first (rt y))) o4))))
(assert (=> (not (= (length y) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length y) 0)) (and (= o7 o6) (in_range o6))))
(assert (=> (not (= (length y) 0)) (= (to_rep o2) x)))
(assert (=> (not (= (length y) 0)) (= o8 (concat_singleton_right (elts y) (to_rep (first (rt y))) (to_rep (last (rt y))) o2))))
(assert (=> (not (= (length y) 0)) (= o8 concat_right__one__z__assume)))
(assert (=> (not (= (length y) 0)) (= (mk (to_rep (first (rt y))) o7) concat_right__one__z__assume1)))
(assert (= result z))
(assert (= z1 concat_right__one__z__assume))
(assert (= (to_rep z__first) (to_rep (first concat_right__one__z__assume1))))
...
(assert (not (= (to_rep z__first) (to_rep (first (rt y))))))
(check-sat)
(exit)
