...
(assert (=> (not (= (length y) 0)) (=> (<= (to_rep (first (rt y))) (to_rep (last (rt y)))) (= o4 (+ (- (to_rep (last (rt y))) (to_rep (first (rt y)))) 1)))))
(assert (=> (not (= (length y) 0)) (=> (not (<= (to_rep (first (rt y))) (to_rep (last (rt y))))) (= o4 0))))
...
(assert (=> (not (= (length y) 0)) (= o9 (concat1 (elts y) (to_rep (first (rt y))) (to_rep (last (rt y))) o3 1 1))))
(assert (=> (not (= (length y) 0)) (= o9 concat_right__one__z__assume)))
(assert (=> (not (= (length y) 0)) (= (mk (to_rep (first (rt y))) o8) concat_right__one__z__assume1)))
(assert (= result z))
