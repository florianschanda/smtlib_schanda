...
(define-fun default_initial_assumption ((temp___expr_276 us_rep) (temp___skip_top_level_277 Bool)) Bool (and (and (= (attr__tag temp___expr_276) us_tag1) (= (to_rep (rec__stackp__stack_root__length (us_split_fields1 temp___expr_276))) 0)) (=> (not (= temp___skip_top_level_277 true)) (= (size temp___expr_276) 0))))
...
(assert (forall ((temp___257 Int)) (= (select (temp___255 temp___257) 1) (of_rep1 temp___257))))
...
(assert (forall ((s us_rep)) (! (dynamic_invariant3 (size s) true false true) :pattern ((size s)))))
...
(assert (forall ((x positive_less_than_max)) (! (in_range6 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((s us_rep)) (! (let ((result (get_model__2 s))) (and (= (length result) (size s)) (dynamic_invariant4 result true false true))) :pattern ((get_model__2 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep)) (! (let ((result (get_model__21 attr__tag2 s))) (and (= (length result) (size s)) (dynamic_invariant4 result true false true))) :pattern ((get_model__21 attr__tag2 s))))))
...
(assert (forall ((s us_rep)) (! (= (get_model__2 s) (let ((temp___298 (let ((temp___296 (to_rep (rec__stackp__stack_root__length (us_split_fields1 s))))) (let ((temp___295 1)) (let ((temp___297 (rec__stackp__stack_root__content (us_split_fields1 s)))) (of_array1 temp___297 temp___295 temp___296)))))) (of_array (to_array1 temp___298) (first3 temp___298) (last3 temp___298)))) :pattern ((get_model__2 s)))))
(declare-sort t2 0)
...
(define-fun dynamic_property3 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range2 low) (in_range2 high))))))
...
(define-fun default_initial_assumption2 ((temp___expr_361 us_rep1) (temp___skip_top_level_362 Bool)) Bool (and (and (= (attr__tag1 temp___expr_361) us_tag2) (and (= (to_rep3 (rec__stackp__buffer__first (us_split_fields3 temp___expr_361))) 1) (= (to_rep (rec__stackp__stack_root__length1 (us_split_fields3 temp___expr_361))) 0))) (=> (not (= temp___skip_top_level_362 true)) (= (size (to_base temp___expr_361)) 0))))
...
(define-fun dynamic_invariant5 ((temp___expr_353 Int) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool)) Bool (=> (or (= temp___is_init_350 true) (<= 1 100)) (in_range6 temp___expr_353)))
...
(assert (forall ((s us_rep1)) (! (dynamic_invariant3 (last6 s) true false true) :pattern ((last6 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (dynamic_invariant3 (last7 attr__tag2 s) true false true) :pattern ((last7 attr__tag2 s))))))
(assert (forall ((s us_rep1)) (! (= (last6 s) (last7 us_tag2 s)) :pattern ((last7 us_tag2 s)))))
(assert (forall ((s us_rep1)) (! (= (last6 s) (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stackp__buffer__first (us_split_fields3 s))) (to_rep (rec__stackp__stack_root__length1 (us_split_fields3 s)))) 1) 100))) :pattern ((last6 s)))))
...
(declare-const temp___510 (Array Int element))
(declare-const temp___5101 less_than_max)
(declare-const temp___5102 us_private)
(declare-const temp___5103 Int)
...
(declare-const temp___514 (Array Int element))
(declare-const temp___5141 less_than_max)
(declare-const temp___5142 us_private)
(declare-const temp___5143 Int)
...
(declare-const result4 less_than_max)
...
(assert (and (= o (+ (to_rep s__split_fields1) 1)) (in_range (+ (to_rep s__split_fields1) 1))))
(assert (= (to_rep o1) o))
(assert (= s__split_fields o2))
(assert (= o1 o3))
(assert (= s__split_fields2 o4))
(assert (= temp___510 o2))
(assert (= temp___5101 o3))
(assert (= temp___5102 o4))
(assert (= s__attr__tag temp___5103))
...
(assert (= temp___510 s__split_fields3))
(assert (= temp___5101 s__split_fields4))
(assert (= temp___5102 s__split_fields5))
(assert (= (to_rep1 o5) e))
(assert (and (<= 1 (to_rep s__split_fields4)) (<= (to_rep s__split_fields4) 100)))
(assert (= o6 (to_rep s__split_fields4)))
(assert (= o7 (store s__split_fields3 o6 o5)))
(assert (= o7 o8))
(assert (= s__split_fields4 o9))
(assert (= s__split_fields5 o10))
(assert (= temp___514 o8))
(assert (= temp___5141 o9))
(assert (= temp___5142 o10))
(assert (= s__attr__tag temp___5143))
(assert (= result3 s__split_fields3))
(assert (= result4 s__split_fields4))
(assert (= result5 s__split_fields5))
(assert (= temp___514 s__split_fields6))
(assert (= temp___5141 s__split_fields7))
(assert (= temp___5142 s__split_fields8))
...
(assert (not (= (let ((temp___519 (get_model__2 (mk___rep (mk___split_fields s__split_fields9 s__split_fields10 s__split_fields11) s__attr__tag)))) (bool_eq (elts temp___519) (to_rep2 (first (rt temp___519))) (to_rep2 (last (rt temp___519))) (let ((temp___518 (temp___255 e))) (let ((temp___517 (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))) (ite (= (length temp___517) 0) temp___518 (concat1 (elts temp___517) (to_rep2 (first (rt temp___517))) (to_rep2 (last (rt temp___517))) temp___518 1 1)))) (to_rep2 (first (let ((temp___517 (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))) (ite (= (length temp___517) 0) (mk 1 1) (mk (to_rep2 (first (rt temp___517))) (- (+ (to_rep2 (first (rt temp___517))) (+ (ite (<= (to_rep2 (first (rt temp___517))) (to_rep2 (last (rt temp___517)))) (+ (- (to_rep2 (last (rt temp___517))) (to_rep2 (first (rt temp___517)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (to_rep2 (last (let ((temp___517 (get_model__2 (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)))) (ite (= (length temp___517) 0) (mk 1 1) (mk (to_rep2 (first (rt temp___517))) (- (+ (to_rep2 (first (rt temp___517))) (+ (ite (<= (to_rep2 (first (rt temp___517))) (to_rep2 (last (rt temp___517)))) (+ (- (to_rep2 (last (rt temp___517))) (to_rep2 (first (rt temp___517)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))))) true)))
(check-sat)
(exit)
