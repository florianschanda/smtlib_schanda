...
(assert (and (forall ((g12 Int)) (=> (and (<= 1 g12) (<= g12 64)) (= (is_permutation_2 (select ranking_1 g12)) true))) (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (= (is_permutation_1 (select ranking_2 g2)) true)))))
...
(assert (<= 1 g11))
(assert (<= g11 64))
(assert (not (= (all_unmatched_g1_set_elements_distinct unmatched_g1_set__split_fields2) true)))
(check-sat)
(exit)
