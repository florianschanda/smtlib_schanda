...
(declare-fun temp_____aggregate_def_3099 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3101 (Array Int et1))) (forall ((temp___3102 Int) (temp___3103 Int)) (let ((temp___3100 (temp_____aggregate_def_3099 temp___3101 temp___3102 temp___3103))) (=> (and (dynamic_invariant temp___3102 true true true true) (dynamic_invariant1 temp___3103 true true true true)) (forall ((temp___3104 Int)) (ite (= temp___3104 temp___3102) (= (to_rep (select temp___3100 temp___3104)) temp___3103) (= (select temp___3100 temp___3104) (select temp___3101 temp___3104)))))))))
...
(declare-const temp___8003 (Array Int et1))
(declare-const temp___80031 enum2t)
(declare-const o4 enum2t)
(declare-const o5 (Array Int et1))
(declare-const o6 enum2t)
(declare-const temp___8005 (Array Int et1))
(declare-const temp___80051 enum2t)
...
(assert (= temp___8003 o2))
(assert (= temp___80031 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___8003 r__split_fields2))
(assert (= temp___80031 r__split_fields3))
(assert (= (to_rep1 o4) f))
(assert (= r__split_fields2 o5))
(assert (= o4 o6))
(assert (= temp___8005 o5))
(assert (= temp___80051 o6))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8005 r__split_fields4))
(assert (= temp___80051 r__split_fields5))
...
(assert (not (= (bool_eq r__split_fields6 1 10 (temp_____aggregate_def_3099 r__split_fields i e) 1 10) true)))
(check-sat)
(exit)
