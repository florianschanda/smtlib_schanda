...
(declare-sort tTm2SP1 0)
(define-fun in_range2 ((x Int)) Bool (and (<= 1 x) (<= x 10)))
(declare-fun attr__ATTRIBUTE_IMAGE2 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Int)
(declare-fun user_eq2 (tTm2SP1 tTm2SP1) Bool)
(declare-const dummy2 tTm2SP1)
(declare-datatypes () ((tTm2SP1__ref (mk_tTm2SP1__ref (tTm2SP1__content tTm2SP1)))))
(define-fun tTm2SP1__ref___projection ((a tTm2SP1__ref)) tTm2SP1 (tTm2SP1__content a))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_177 us_void_param) 1)) 49) (= (to_rep (select (temp___String_Literal_177 us_void_param) 2)) 50)) (= (to_rep (select (temp___String_Literal_177 us_void_param) 3)) 51)) (= (to_rep (select (temp___String_Literal_177 us_void_param) 4)) 52)) (= (to_rep (select (temp___String_Literal_177 us_void_param) 5)) 53)) :pattern ((temp___String_Literal_177 us_void_param)))))
...
(declare-const m2 (Array Int character))
(declare-const p Int)
(declare-const bcheck__R2b__assume Int)
(declare-const temp___179 (Array Int character))
(declare-const temp___1791 t)
(declare-const o (Array Int character))
(declare-const temp___180 (Array Int character))
(declare-const temp___1801 t)
...
(assert (= p1 r1b))
(assert (in_range r1b))
(assert (and (= bcheck__R2b__assume (+ p1 4)) (in_range (+ p1 4))))
(assert (= bcheck__R2b__assume r2b))
(assert (in_range r2b))
(assert (= (ite (<= 1 5) (+ (- 5 1) 1) 0) (ite (<= r1b r2b) (+ (- r2b r1b) 1) 0)))
(assert (= (slide (temp___String_Literal_177 Tuple0) 1 r1b) temp___179))
(assert (= (mk r1b r2b) temp___1791))
(assert (<= r1b r2b))
(assert (not (<= 1 r1b)))
(check-sat)
(exit)
