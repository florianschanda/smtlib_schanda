...
(assert (=> (= result27 true) (and (= o113 (+ j4 1)) (in_range1 (+ j4 1)))))
(assert (=> (= result27 true) (and (= o114 (get (rec__list_allocator__m__t__allocated model____split_fields4) o113)) (in_range7 o114))))
(assert (=> (not (= result27 true)) (= o114 0)))
(assert (and (= temp___429 (get (rec__list_allocator__m__t__allocated model____split_fields4) j4)) (in_range7 temp___429)))
(assert (not (<= 1 temp___429)))
(check-sat)
(exit)
