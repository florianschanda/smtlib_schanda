...
(assert (forall ((temp___217 Int) (temp___218 Int) (temp___219 Int)) (let ((temp___216 (temp___215 temp___217 temp___218 temp___219))) (=> (dynamic_invariant2 temp___217 true true true true) (and (=> (dynamic_property4 1 2147483647 temp___218 temp___219) (and (= (first3 temp___216) temp___218) (= (last3 temp___216) temp___219))) (forall ((temp___220 Int)) (= (to_rep1 (select (to_array1 temp___216) temp___220)) temp___217)))))))
(declare-const self__ us_rep)
(declare-const temp___229 (Array Int character))
(declare-const temp___2291 t1)
(assert (= (to_rep (first2 (rt1 (temp___215 32 1 (to_rep (rec__p__pt__x (us_split_discrs1 self__))))))) 1))
(assert (= (to_rep (last2 (rt1 (temp___215 32 1 (to_rep (rec__p__pt__x (us_split_discrs1 self__))))))) (to_rep (rec__p__pt__x (us_split_discrs1 self__)))))
(assert (= (mk___t1 temp___229 temp___2291) (temp___215 32 1 (to_rep (rec__p__pt__x (us_split_discrs1 self__))))))
