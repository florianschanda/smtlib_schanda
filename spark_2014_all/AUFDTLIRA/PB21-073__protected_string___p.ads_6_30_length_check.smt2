...
(assert (forall ((temp___187 Int) (temp___188 Int) (temp___189 Int)) (let ((temp___186 (temp___185 temp___187 temp___188 temp___189))) (and (=> (dynamic_property4 1 2147483647 temp___188 temp___189) (and (= (first3 temp___186) temp___188) (= (last3 temp___186) temp___189))) (forall ((temp___190 Int)) (= (select (to_array1 temp___186) temp___190) (of_rep1 temp___187)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_171 us_rep) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool)) Bool (let ((temp___172 (rec__p__pt__x (us_split_discrs1 temp___expr_171)))) (and (dynamic_property1 1 (to_rep temp___172) (first1 (rec__p__pt__s (us_split_fields1 temp___expr_171))) (last1 (rec__p__pt__s (us_split_fields1 temp___expr_171)))) (and (= (first1 (rec__p__pt__s (us_split_fields1 temp___expr_171))) 1) (= (last1 (rec__p__pt__s (us_split_fields1 temp___expr_171))) (to_rep temp___172))))))
(declare-const self__ us_rep)
(declare-const temp___199 (Array Int character))
(declare-const temp___1991 t1)
(assert (= (to_rep (first2 (rt1 (temp___185 32 1 (to_rep (rec__p__pt__x (us_split_discrs1 self__))))))) 1))
(assert (= (to_rep (last2 (rt1 (temp___185 32 1 (to_rep (rec__p__pt__x (us_split_discrs1 self__))))))) (to_rep (rec__p__pt__x (us_split_discrs1 self__)))))
(assert (= (mk___t1 temp___199 temp___1991) (temp___185 32 1 (to_rep (rec__p__pt__x (us_split_discrs1 self__))))))
(assert (not (= (ite (<= (to_rep (first2 temp___1991)) (to_rep (last2 temp___1991))) (+ (- (to_rep (last2 temp___1991)) (to_rep (first2 temp___1991))) 1) 0) (ite (<= 1 (to_rep (rec__p__pt__x (us_split_discrs1 self__)))) (+ (- (to_rep (rec__p__pt__x (us_split_discrs1 self__))) 1) 1) 0))))
(check-sat)
(exit)
