...
(assert (forall ((temp___211 Int)) (forall ((temp___212 Int)) (= (select (unconstr__constr_return_call__s__aggregate_def temp___211) temp___212) (of_rep temp___211)))))
...
(assert (and (forall ((temp___216 Int)) (=> (and (<= (to_rep1 s__first) temp___216) (<= temp___216 (to_rep1 s__last))) (=> (<= i2 temp___216) (= (select s2 temp___216) (select s1 temp___216))))) (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last)))))
(assert (= (to_rep o) 32))
