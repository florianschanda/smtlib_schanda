...
(assert (and (forall ((temp___246 Int)) (=> (and (<= (to_rep1 s__first) temp___246) (<= temp___246 (to_rep1 s__last))) (=> (<= i2 temp___246) (= (select s2 temp___246) (select s1 temp___246))))) (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last)))))
(assert (= (to_rep o) 32))
