...
(assert (and (= o13 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1 o13 true false true true)))
...
(assert (=> (= result4 true) (= temp___520 (mk___t2 o11 (mk2 first2 temp___518)))))
...
(assert (=> (= result4 true) (= temp___519 (mk___t1 o12 (mk1 first2 temp___517)))))
...
(assert (and (= o10 (get (model__ l) o9)) (and (in_range7 o10) (= o10 (get (model__ l) o9)))))
(assert (and (= o3 j) (in_range6 j)))
(assert (not (<= o3 (last2 (model__ (mk___rep1 res__split_discrs res__split_fields2))))))
(check-sat)
(exit)
