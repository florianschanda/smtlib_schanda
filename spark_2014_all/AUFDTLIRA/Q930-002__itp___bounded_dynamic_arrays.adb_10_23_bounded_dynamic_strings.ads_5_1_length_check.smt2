...
(assert (not (= (ite (<= (to_rep2 (first4 temp___10021)) (to_rep2 (last4 temp___10021))) (+ (- (to_rep2 (last4 temp___10021)) (to_rep2 (first4 temp___10021))) 1) 0) (ite (<= 1 r79b) (+ (- r79b 1) 1) 0))))
(check-sat)
(exit)
