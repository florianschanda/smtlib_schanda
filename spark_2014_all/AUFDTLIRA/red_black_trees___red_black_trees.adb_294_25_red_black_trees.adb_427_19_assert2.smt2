...
(assert (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) c83b)))) n6))
(assert (not (= (eq (select (nb_blacks c82b) c83b) (select (nb_blacks c81b) c83b)) true)))
(check-sat)
(exit)
