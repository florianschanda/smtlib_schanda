...
(assert (= o110 i1))
(assert (= o111 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o110)))
(assert (= o112 (to_rep1 o111)))
(assert (= o113 (ite (<= o112 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o107 i1))
(assert (= o108 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o107)))
(assert (= o109 (to_rep1 o108)))
(assert (= o114 (ite (<= 0 o109) true false)))
(assert (= result22 (ite (= o114 true) o113 false)))
(assert (= result22 true))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o105 i1))
(assert (= o106 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o105)))
(assert (= temp___681 (to_rep1 o106)))
(assert (not (<= 0 temp___681)))
(check-sat)
(exit)
