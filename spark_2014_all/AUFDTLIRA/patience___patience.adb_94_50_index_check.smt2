...
(assert (= o108 i1))
(assert (= o109 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o108)))
(assert (= o110 (to_rep o109)))
(assert (= o111 (ite (<= o110 (- (to_rep (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o105 i1))
...
(assert (= temp___681 (to_rep o104)))
(assert (not (<= temp___681 99)))
(check-sat)
(exit)
