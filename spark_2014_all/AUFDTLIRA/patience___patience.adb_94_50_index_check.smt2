...
(assert (<= 0 i6))
(assert (<= i6 (- (to_rep1 (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1)))
(assert (and (<= 0 i6) (<= i6 99)))
(assert (= o262 i6))
(assert (= o263 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o262)))
(assert (= o264 (to_rep1 o263)))
(assert (= o265 (ite (<= o264 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i6) (<= i6 99)))
(assert (= o259 i6))
(assert (= o260 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o259)))
(assert (= o261 (to_rep1 o260)))
(assert (= o266 (ite (<= 0 o261) true false)))
(assert (= result36 (ite (= o266 true) o265 false)))
(assert (= result36 true))
(assert (and (<= 0 i6) (<= i6 99)))
(assert (= o250 i6))
(assert (= o251 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) o250)))
(assert (= temp___651 (to_rep1 o251)))
