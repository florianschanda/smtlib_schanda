...
(declare-const temp___737 (Array Int us_rep1))
...
(assert (and (= o10 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (and (= temp___737 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o10)) (and (dynamic_invariant9 temp___737 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___737 o10))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___737 o10)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i o10)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___737 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___737 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___737 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___737 i))) true) (not (= i o10))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___737 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___737 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___737 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___737 i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___737 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___737 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___737 j)))) true)) (= j i))))))))))))))
