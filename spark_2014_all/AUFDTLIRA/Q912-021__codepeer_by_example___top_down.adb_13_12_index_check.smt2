...
(assert (forall ((x Int)) (forall ((top_down__a (Array Int integer))) (! (=> (dynamic_invariant x true true true) (dynamic_invariant (ident x top_down__a) true false true)) :pattern ((ident x top_down__a))))))
(declare-fun top_down__a__aggregate_def (Int) (Array Int integer))
(assert (forall ((temp___146 Int)) (forall ((temp___147 Int)) (= (select (top_down__a__aggregate_def temp___146) temp___147) (of_rep temp___146)))))
(declare-const y Int)
...
(assert (and (= temp___148 (ident 3 a1)) (in_range temp___148)))
(assert (not (<= 1 temp___148)))
(check-sat)
(exit)
