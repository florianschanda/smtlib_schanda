...
(assert (and (and (and (= indexbis__result30 indexbis__result28) (and (= possible28 possible26) (= courant19 courant17))) (and (= indexbis__result31 indexbis__result29) (and (= possible29 possible27) (= courant20 courant18)))) (and (ite (= (length s) 0) (= result true) (= result (ite (= (length c) 0) true false))) (ite (= result true) (and (and (and (= indexbis__result28 (mk_int__ref indexbis__result1)) (and (= possible26 (mk_int__ref possible)) (= courant17 (mk_int__ref courant)))) (and (= indexbis__result29 indexbis__result1) (and (= possible27 possible1) (= courant18 courant1)))) (and (= (mk_int__ref result1) (mk_int__ref indexbis__result)) (= indexbis__result1 0))) (and (and (and (= indexbis__result28 indexbis__result16) (and (= possible26 (mk_int__ref possible14)) (= courant17 (mk_int__ref courant3)))) (and (= indexbis__result29 indexbis__result17) (and (= possible27 possible15) (= courant18 courant3)))) (and (and (and (= o (to_rep1 (first (rt s)))) (in_range2 (to_rep1 (first (rt s))))) (and (= (mk_int__ref result2) (mk_int__ref courant)) (= courant2 o))) (and (in_range2 courant2) (and (= temp___153 courant2) (and (and (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (not (exists ((i4 Int)) (and (and (<= (to_rep1 (first (rt s))) i4) (<= i4 (- courant3 1))) (exists ((j6 Int)) (and (and (<= (to_rep1 (first (rt c))) j6) (<= j6 (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i4)) (to_rep (select (elts c) j6))))))))) (and (=> (<= 1 2147483647) (in_range2 courant3)) (and (and (and (and (= o4 (to_rep1 (first (rt c)))) (in_range2 (to_rep1 (first (rt c))))) (and (= possible2 result3) (= possible3 o4))) (in_range2 possible3)) (or (and (and (and (= indexbis__result16 (mk_int__ref indexbis__result4)) (= possible4 possible14)) (and (= indexbis__result17 indexbis__result4) (= possible15 possible4))) (and (= temp___152 possible3) (and (and (and (and (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (not (exists ((i4 Int)) (and (and (<= (to_rep1 (first (rt s))) i4) (<= i4 (- courant3 1))) (exists ((j6 Int)) (and (and (<= (to_rep1 (first (rt c))) j6) (<= j6 (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i4)) (to_rep (select (elts c) j6))))))))) (and (<= (to_rep1 (first (rt c))) possible4) (<= possible4 (to_rep1 (last (rt c)))))) (not (exists ((j6 Int)) (and (and (<= (to_rep1 (first (rt c))) j6) (<= j6 (- possible4 1))) (= (to_rep (select (elts s) courant3)) (to_rep (select (elts c) j6))))))) (and (=> (<= 1 2147483647) (in_range2 possible4)) (and (and (and (and (and (and (<= (to_rep1 (first (rt c))) possible4) (<= possible4 (to_rep1 (last (rt c))))) (= o14 possible4)) (= o15 (select (elts c) o14))) (= o16 (to_rep o15))) (and (and (and (and (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (= o12 courant3)) (= o13 (select (elts s) o12))) (= o17 (to_rep o13))) (= result6 (ite (= o17 o16) true false)))) (and (= result6 true) (and (= indexbis__result3 result7) (= indexbis__result4 courant3)))))))) (and (and (and (and (= temp___152 possible3) (and (and (and (and (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (not (exists ((i4 Int)) (and (and (<= (to_rep1 (first (rt s))) i4) (<= i4 (- courant3 1))) (exists ((j6 Int)) (and (and (<= (to_rep1 (first (rt c))) j6) (<= j6 (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i4)) (to_rep (select (elts c) j6))))))))) (and (<= (to_rep1 (first (rt c))) possible4) (<= possible4 (to_rep1 (last (rt c)))))) (not (exists ((j6 Int)) (and (and (<= (to_rep1 (first (rt c))) j6) (<= j6 (- possible4 1))) (= (to_rep (select (elts s) courant3)) (to_rep (select (elts c) j6))))))) (and (=> (<= 1 2147483647) (in_range2 possible4)) (and (and (and (= indexbis__result3 indexbis__result5) (= possible4 possible6)) (and (= indexbis__result6 indexbis__result3) (= possible7 possible4))) (and (and (and (and (and (and (<= (to_rep1 (first (rt c))) possible4) (<= possible4 (to_rep1 (last (rt c))))) (= o14 possible4)) (= o15 (select (elts c) o14))) (= o16 (to_rep o15))) (and (and (and (and (and (<= (to_rep1 (first (rt s))) courant3) (<= courant3 (to_rep1 (last (rt s))))) (= o12 courant3)) (= o13 (select (elts s) o12))) (= o17 (to_rep o13))) (= result6 (ite (= o17 o16) true false)))) (and (not (= result6 true)) (not (< possible4 (to_rep1 (last (rt c))))))))))) (and (and (= (mk_int__ref indexbis__result9) (mk_int__ref indexbis__result5)) (= (mk_int__ref possible10) (mk_int__ref possible6))) (and (= indexbis__result10 indexbis__result6) (= possible11 possible7)))) (and (and (= (mk_int__ref indexbis__result11) (mk_int__ref indexbis__result9)) (= (mk_int__ref possible12) (mk_int__ref possible10))) (and (= indexbis__result12 indexbis__result10) (= possible13 possible11)))) (and (and (and (= indexbis__result16 (mk_int__ref indexbis__result13)) (= (mk_int__ref possible14) (mk_int__ref possible12))) (and (= indexbis__result17 indexbis__result13) (= possible15 possible13))) (and (not (< courant3 (to_rep1 (last (rt s))))) (and (= (mk_int__ref result10) (mk_int__ref indexbis__result11)) (= indexbis__result13 0)))))))))))))))))
(assert (= indexbis__result32 indexbis__result30))
(assert (= possible30 possible28))
(assert (= courant21 courant19))
(assert (= indexbis__result33 indexbis__result31))
(assert (= possible31 possible29))
(assert (= courant22 courant20))
(assert (not (= (int__content indexbis__result32) 0)))
(assert (<= (to_rep1 (first (rt s))) (int__content indexbis__result32)))
(assert (<= (int__content indexbis__result32) (to_rep1 (last (rt s)))))
(assert (<= (to_rep1 (first (rt s))) i3))
(assert (<= i3 (- (int__content indexbis__result32) 1)))
(assert (<= (to_rep1 (first (rt c))) j5))
(assert (<= j5 (to_rep1 (last (rt c)))))
(assert (not (<= (to_rep1 (first (rt c))) j5)))
(check-sat)
(exit)
