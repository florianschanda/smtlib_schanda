...
(declare-const temp___497 Int)
(declare-const temp___495 (Array Int ranking))
...
(assert (= rank1 1))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___497 rank1)))
(assert (=> (and (<= 1 rank1) (<= rank1 64)) (= temp___495 result__1)))
