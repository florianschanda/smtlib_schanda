...
(assert (and (= o113 x) (in_range5 x)))
(assert (and (= o111 y) (in_range5 y)))
(assert (and (= o112 (remove (mk___t values2 (mk 1 100)) o111)) (and (dynamic_invariant4 o112 true false true) (and (= (invariant__ o112) true) (and (= (to_rep1 (last (rt o112))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o111 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o112) k))))) (and (forall ((k Int)) (=> (and (<= (+ o111 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o112) (- k 1)))))) (forall ((k Int)) (=> (and (<= o111 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o112) k))))))))))))
(assert (and (= o109 y) (in_range5 y)))
(assert (and (= o110 (remove (mk___t interm1 (mk 1 100)) o109)) (and (dynamic_invariant4 o110 true false true) (and (= (invariant__ o110) true) (and (= (to_rep1 (last (rt o110))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o109 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o110) k))))) (and (forall ((k Int)) (=> (and (<= (+ o109 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o110) (- k 1)))))) (forall ((k Int)) (=> (and (<= o109 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o110) k))))))))))))
(assert (and (= o114 (remove_eq o110 o112 o113)) (and (in_range4 o114) (=> (= (of_int o114) true) (= (let ((temp___163 (remove o112 o113))) (let ((temp___162 (remove o110 o113))) (bool_eq (elts temp___162) (to_rep1 (first (rt temp___162))) (to_rep1 (last (rt temp___162))) (elts temp___163) (to_rep1 (first (rt temp___163))) (to_rep1 (last (rt temp___163)))))) true)))))
(assert (= result12 (mk_int__ref hr2)))
(assert (= hr13 o114))
(assert (and (= o116 y) (in_range5 y)))
(assert (and (= o115 x) (in_range5 x)))
(assert (and (= o117 (remove_swap (mk___t interm1 (mk 1 100)) o115 o116)) (and (in_range4 o117) (=> (= (of_int o117) true) (= (let ((temp___157 (remove (remove (mk___t interm1 (mk 1 100)) o116) o115))) (let ((temp___156 (remove (remove (mk___t interm1 (mk 1 100)) o115) (- o116 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))))
(assert (= result13 (mk_int__ref hr13)))
(assert (= hr14 o117))
(assert (= (let ((temp___223 (remove (remove (mk___t interm1 (mk 1 100)) y) x))) (let ((temp___222 (remove (remove (mk___t interm1 (mk 1 100)) x) (- y 1)))) (bool_eq (elts temp___222) (to_rep1 (first (rt temp___222))) (to_rep1 (last (rt temp___222))) (elts temp___223) (to_rep1 (first (rt temp___223))) (to_rep1 (last (rt temp___223)))))) true))
(assert (= (let ((temp___227 (remove (remove (mk___t values2 (mk 1 100)) y) x))) (let ((temp___226 (remove (remove (mk___t interm1 (mk 1 100)) x) (- y 1)))) (bool_eq (elts temp___226) (to_rep1 (first (rt temp___226))) (to_rep1 (last (rt temp___226))) (elts temp___227) (to_rep1 (first (rt temp___227))) (to_rep1 (last (rt temp___227)))))) true))
(assert (and (= o131 y) (in_range5 y)))
(assert (and (= o130 x) (in_range5 x)))
(assert (and (= o132 (remove_swap (mk___t values2 (mk 1 100)) o130 o131)) (and (in_range4 o132) (=> (= (of_int o132) true) (= (let ((temp___157 (remove (remove (mk___t values2 (mk 1 100)) o131) o130))) (let ((temp___156 (remove (remove (mk___t values2 (mk 1 100)) o130) (- o131 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))))
(assert (= result14 (mk_int__ref hr14)))
(assert (= hr15 o132))
