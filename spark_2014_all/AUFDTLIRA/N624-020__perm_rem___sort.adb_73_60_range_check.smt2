...
(assert (and (= o16 (remove (mk___t values2 (mk 1 100)) o15)) (and (dynamic_invariant4 o16 true false true) (and (= (invariant__ o16) true) (and (= (to_rep1 (last (rt o16))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o15 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o16) k))))) (and (forall ((k Int)) (=> (and (<= (+ o15 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o16) (- k 1)))))) (forall ((k Int)) (=> (and (<= o15 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o16) k))))))))))))
(assert (and (= o13 y) (in_range5 y)))
(assert (and (= o14 (remove (mk___t interm1 (mk 1 100)) o13)) (and (dynamic_invariant4 o14 true false true) (and (= (invariant__ o14) true) (and (= (to_rep1 (last (rt o14))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o14) k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o14) (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o14) k))))))))))))
(assert (and (= o18 (remove_eq o14 o16 o17)) (and (in_range4 o18) (=> (= (of_int o18) true) (= (let ((temp___163 (remove o16 o17))) (let ((temp___162 (remove o14 o17))) (bool_eq (elts temp___162) (to_rep1 (first (rt temp___162))) (to_rep1 (last (rt temp___162))) (elts temp___163) (to_rep1 (first (rt temp___163))) (to_rep1 (last (rt temp___163)))))) true)))))
(assert (= result4 (mk_int__ref hr1)))
(assert (= hr2 o18))
(assert (and (= o20 y) (in_range5 y)))
(assert (and (= o19 x) (in_range5 x)))
(assert (and (= o21 (remove_swap (mk___t interm1 (mk 1 100)) o19 o20)) (and (in_range4 o21) (=> (= (of_int o21) true) (= (let ((temp___157 (remove (remove (mk___t interm1 (mk 1 100)) o20) o19))) (let ((temp___156 (remove (remove (mk___t interm1 (mk 1 100)) o19) (- o20 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))))
