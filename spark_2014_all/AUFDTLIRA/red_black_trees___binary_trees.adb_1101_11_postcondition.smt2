...
(assert (<= 1 r15))
(assert (<= r15 (to_rep f_old__split_fields)))
(assert (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r15)))) 2))
(assert (not (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r15) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r15)) true)))
(check-sat)
(exit)
