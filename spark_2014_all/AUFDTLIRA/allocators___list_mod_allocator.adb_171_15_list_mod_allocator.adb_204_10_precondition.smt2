...
(assert (= o6 o8))
(assert (= o7 o9))
(assert (= list_mod_allocator__free__ma__assume o8))
(assert (= list_mod_allocator__free__ma__assume ma))
(assert (=> (not (= res 0)) (and (<= 1 res) (<= res 10000))))
(assert (=> (not (= res 0)) (= o10 res)))
(assert (=> (not (= res 0)) (= (mk___rep (mk___split_fields o11 o12)) (select data o10))))
(assert (=> (not (= res 0)) (= o11 o13)))
(assert (=> (not (= res 0)) (= o12 o14)))
(assert (=> (not (= res 0)) (= o15 o13)))
(assert (=> (not (= res 0)) (= o16 (to_rep1 o15))))
(assert (=> (not (= res 0)) (= result (ite (= o16 1) true false))))
(assert (=> (= res 0) (= result false)))
(assert (= result true))
(assert (= (to_rep o17) first_available))
(assert (= (to_rep1 o18) 0))
(assert (= o18 o19))
(assert (= o17 o20))
(assert (= o21 o19))
(assert (= o22 o20))
...
(assert (= ma c111b))
(assert (and (= (mk___rep1 (mk___split_fields1 o25 o26)) (model__ data2 first_available2)) (= (model_is_well_formed (mk___rep1 (mk___split_fields1 o25 o26)) data2 first_available2) true)))
(assert (= o27 (mk___split_fields1 o25 o26)))
(assert (= list_mod_allocator__free__C112b__assume (rec__list_mod_allocator__m__t__available o27)))
...
(assert (<= 1 i2))
(assert (<= i2 r114b))
(assert (<= (+ i3 1) (length c112b)))
(assert (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 i3)) (= (get c111b j3) (get c112b (+ j3 1))))))
(assert (forall ((j3 Int)) (=> (and (<= 2 j3) (<= j3 (+ i3 1))) (= (get c111b (- j3 1)) (get c112b j3)))))
(assert (and (=> (<= 1 r114b) (dynamic_property 1 r114b i3)) (and (<= 1 i3) (<= i3 r114b))))
(assert (and (= o32 (+ i3 1)) (in_range1 (+ i3 1))))
(assert (= o33 (ite (<= j1 o32) true false)))
(assert (= result4 (ite (<= 2 j1) o33 false)))
(assert (= result4 true))
(assert (and (= o34 (get c112b j1)) (in_range6 o34)))
(assert (not (<= 1 (- j1 1))))
(check-sat)
(exit)
