...
(declare-const c111b us_rep1)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const c112b us_rep1)
...
(declare-const list_mod_allocator__free__ma__assume us_rep1)
...
(declare-const list_mod_allocator__free__C112b__assume us_rep1)
...
(define-fun o25 () us_rep3 (mk___rep1 (mk___split_fields1 o19 o20)))
(define-fun o26 () us_rep3 (mk___rep1 (mk___split_fields1 o o1)))
...
(assert (=> (not (= res 0)) (= (mk___rep (mk___split_fields o5 o6)) (select data o4))))
...
(assert (= o17 res))
(assert (= o18 (store data o17 (mk___rep (mk___split_fields o15 o16)))))
...
(assert (= o21 (mk___split_fields1 o19 o20)))
...
(assert (and (= list_mod_allocator__free__B113b__L_4__R114b__assume (length c111b)) (and (in_range5 list_mod_allocator__free__B113b__L_4__R114b__assume) (<= (+ 0 list_mod_allocator__free__B113b__L_4__R114b__assume) 2147483647))))
...
(assert (= result4 true))
(assert (and (= o24 (get c112b j)) (in_range6 o24)))
(assert (not (<= 1 (- j 1))))
(check-sat)
(exit)
