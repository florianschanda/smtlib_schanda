...
(assert (= n1 1))
(assert (=> (and (<= 1 n1) (<= n1 100)) (and (and (= temp___678 n1) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t1) i2))) true) (< (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f t1) i2)))) n2)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t2) i2))) true))))) (and (and (=> (<= 1 100) (in_range1 n2)) (and (<= 1 n2) (<= n2 100))) (= n2 100)))) (and (= n2 n6) (= n7 n2)))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (= (mk_int__ref n8) (mk_int__ref n6))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (= n9 n7)))
(assert (=> (not (and (<= 1 n1) (<= n1 100))) (= n1 n8)))
(assert (=> (not (and (<= 1 n1) (<= n1 100))) (= n9 n1)))
(assert (= (mk_int__ref n10) (mk_int__ref n8)))
(assert (= n11 n9))
(declare-const i2 Int)
(assert (<= 1 i2))
(assert (<= i2 100))
(assert (not (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t1) i2))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t2) i2))) true)))))
(check-sat)
(exit)
