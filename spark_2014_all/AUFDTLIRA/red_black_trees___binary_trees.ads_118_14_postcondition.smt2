...
(define-fun n9 () int__ref (mk_int__ref n5))
(assert (in_range1 t1))
(assert (in_range1 t2))
...
(assert (= n1 1))
(assert (=> (and (<= 1 n1) (<= n1 100)) (= temp___724 n1)))
(assert (=> (and (<= 1 n1) (<= n1 100)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t1) i))) true) (< (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f t1) i)))) n2)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t2) i))) true)))))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (and (=> (<= 1 100) (in_range1 n2)) (and (<= 1 n2) (<= n2 100)))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (= n2 100)))
(assert (=> (and (<= 1 n1) (<= n1 100)) (= n2 n3)))
(assert (=> (and (<= 1 n1) (<= n1 100)) (= n4 n2)))
(assert (=> (and (<= 1 n1) (<= n1 100)) (= n9 (mk_int__ref n3))))
(assert (=> (and (<= 1 n1) (<= n1 100)) (= n6 n4)))
(assert (=> (not (and (<= 1 n1) (<= n1 100))) (= n1 n5)))
(assert (=> (not (and (<= 1 n1) (<= n1 100))) (= n6 n1)))
(assert (= (mk_int__ref n7) n9))
(assert (= n8 n6))
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i 100))
(assert (not (or (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t1) i))) true)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f t2) i))) true)))))
(check-sat)
(exit)
