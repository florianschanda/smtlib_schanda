...
(assert (= r2 (store r x1 (ite (= x1 c) true false))))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 x2)) (= (= (select r3 i1) true) (= i1 (+ c 1))))))
(assert (and (and (forall ((temp___156 Int)) (=> (and (<= (- 2147483648) temp___156) (<= temp___156 2147483647)) (=> (< x2 temp___156) (= (select r3 temp___156) (select r temp___156))))) (=> (<= 1 100) (in_range2 x2))) (and (<= 1 x2) (<= x2 100))))
(assert (<= 1 i))
(assert (<= i x2))
