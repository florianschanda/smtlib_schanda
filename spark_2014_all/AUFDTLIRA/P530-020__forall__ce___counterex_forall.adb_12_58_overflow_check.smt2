...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 x2)) (= (= (select r2 i1) true) (= i1 (+ c 1))))))
(assert (and (and (forall ((temp___180 Int)) (=> (and (<= (- 2147483648) temp___180) (<= temp___180 2147483647)) (=> (< x2 temp___180) (= (select r2 temp___180) (select r temp___180))))) (=> (<= 1 100) (in_range2 x2))) (and (<= 1 x2) (<= x2 100))))
(assert (<= 1 i))
(assert (<= i x2))
