...
(assert (and (= o4 (next (mk___rep g__split_fields4) temp___2861)) (and (in_range2 o4) (= o4 (ite (= temp___2861 100) 0 (+ temp___2861 1))))))
(assert (= result6 temp___2861))
(assert (= temp___2862 o4))
(assert (and (= result7 (has_element (mk___rep g__split_fields4) temp___2862)) (= (= result7 true) (in_range3 temp___2862))))
(assert (= result7 true))
(assert (not (= (has_element (mk___rep g__split_fields4) temp___2862) true)))
(check-sat)
(exit)
