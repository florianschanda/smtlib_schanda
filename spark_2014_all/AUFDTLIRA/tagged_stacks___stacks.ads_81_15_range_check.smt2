...
(declare-fun user_eq7 (telement_arrayD1 telement_arrayD1) Bool)
(declare-const dummy7 telement_arrayD1)
...
(define-fun default_initial_assumption ((temp___expr_290 us_rep) (temp___skip_top_level_291 Bool)) Bool (and (and (= (attr__tag temp___expr_290) us_tag1) (and (= (rec__stacks__stack_root__content (us_split_fields1 temp___expr_290)) (temp_____aggregate_def_187 0)) (= (to_rep (rec__stacks__stack_root__length (us_split_fields1 temp___expr_290))) 0))) (=> (not (= temp___skip_top_level_291 true)) (= (size temp___expr_290) 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 100)) (in_range1 temp___expr_159)))
...
(declare-const temp___508 (Array Int element))
(declare-const temp___5081 t1)
(assert (=> (<= 1 (to_rep (rec__stacks__stack_root__length (us_split_fields1 s)))) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 (to_rep (rec__stacks__stack_root__length (us_split_fields1 s)))) (<= (to_rep (rec__stacks__stack_root__length (us_split_fields1 s))) 100)))))
(assert (= o (rec__stacks__stack_root__content (us_split_fields1 s))))
(assert (= o temp___508))
(assert (= (mk1 1 (to_rep (rec__stacks__stack_root__length (us_split_fields1 s)))) temp___5081))
(assert (not (dynamic_property 1 2147483647 (to_rep2 (first2 temp___5081)) (to_rep2 (last2 temp___5081)))))
(check-sat)
(exit)
