...
(assert (forall ((x element)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range4 temp___expr_166)))
...
(assert (forall ((temp___189 Int)) (=> (dynamic_invariant3 temp___189 true true true true) (forall ((temp___190 Int)) (= (to_rep2 (select (temp___187 temp___189) temp___190)) temp___189)))))
