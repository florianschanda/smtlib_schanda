...
(assert (forall ((capacity Int)) (forall ((content us_t1)) (! (=> (and (and (dynamic_invariant capacity true true true true) (dynamic_invariant2 content true true true true)) (<= (length2 content) capacity)) (let ((result (instance capacity content))) (and (and (and (= (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 result))) capacity) (= (length1 result) (length2 content))) (= (let ((temp___278 (value result))) (bool_eq (to_array1 temp___278) (first3 temp___278) (last3 temp___278) (to_array1 content) (first3 content) (last3 content))) true)) (dynamic_invariant1 result true false true true)))) :pattern ((instance capacity content))))))
...
(declare-const bounded_dynamic_strings__instance__3__result natural_index)
(declare-const bounded_dynamic_strings__instance__3__result1 natural_index)
(declare-const bounded_dynamic_strings__instance__3__result2 (Array Int character))
(declare-const bounded_dynamic_strings__instance__3__result3 t)
(declare-const o Int)
(declare-const o1 natural_index)
(declare-const o2 natural_index)
(declare-const o3 (Array Int character))
(declare-const o4 t)
(declare-const temp___992 (Array Int character))
(declare-const temp___9921 t1)
...
(declare-const bounded_dynamic_strings__instance__3__result4 natural_index)
(declare-const bounded_dynamic_strings__instance__3__result5 natural_index)
(declare-const bounded_dynamic_strings__instance__3__result6 (Array Int character))
(declare-const bounded_dynamic_strings__instance__3__result7 t)
(declare-const bounded_dynamic_strings__instance__3__result8 natural_index)
(declare-const bounded_dynamic_strings__instance__3__result9 natural_index)
(declare-const bounded_dynamic_strings__instance__3__result10 (Array Int character))
(declare-const bounded_dynamic_strings__instance__3__result11 t)
(declare-const bounded_dynamic_strings__instance__3__result12 us_rep)
(declare-const bounded_dynamic_strings__instance__3__result13 sequence__ref)
(declare-const bounded_dynamic_strings__instance__3__result14 us_rep)
(define-fun bounded_dynamic_strings__instance__3__result15 () us_rep (mk___rep (mk___split_discrs bounded_dynamic_strings__instance__3__result4) (mk___split_fields bounded_dynamic_strings__instance__3__result5 (mk___t bounded_dynamic_strings__instance__3__result6 bounded_dynamic_strings__instance__3__result7))))
(define-fun temp___9922 () us_t1 (mk___t1 temp___992 temp___9921))
(define-fun o8 () us_rep (mk___rep (mk___split_discrs o1) (mk___split_fields o2 (mk___t o3 o4))))
(assert (dynamic_invariant2 content true false true true))
(assert (<= (length2 content) 2147483647))
(assert (= bounded_dynamic_strings__instance__3__result8 bounded_dynamic_strings__instance__3__result4))
(assert (= bounded_dynamic_strings__instance__3__result9 bounded_dynamic_strings__instance__3__result5))
(assert (= bounded_dynamic_strings__instance__3__result10 bounded_dynamic_strings__instance__3__result6))
(assert (= bounded_dynamic_strings__instance__3__result11 bounded_dynamic_strings__instance__3__result7))
(assert (= bounded_dynamic_strings__instance__3__result12 bounded_dynamic_strings__instance__3__result15))
(assert (and (= o (length2 content)) (in_range3 (length2 content))))
(assert (and (= o8 (instance o content)) (and (dynamic_invariant1 o8 true false true true) (and (and (= (to_rep1 o1) o) (= (length1 o8) (length2 content))) (= (let ((temp___274 (value o8))) (bool_eq (elts1 temp___274) (to_rep2 (first2 (rt1 temp___274))) (to_rep2 (last2 (rt1 temp___274))) (elts1 content) (to_rep2 (first2 (rt1 content))) (to_rep2 (last2 (rt1 content))))) true)))))
(assert (= (mk_sequence__ref (mk___rep (mk___split_discrs result) (mk___split_fields result1 (mk___t result2 result3)))) (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__instance__3__result) (mk___split_fields bounded_dynamic_strings__instance__3__result1 (mk___t bounded_dynamic_strings__instance__3__result2 bounded_dynamic_strings__instance__3__result3))))))
(assert (= bounded_dynamic_strings__instance__3__result15 o8))
(assert (= bounded_dynamic_strings__instance__3__result13 (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__instance__3__result8) (mk___split_fields bounded_dynamic_strings__instance__3__result9 (mk___t bounded_dynamic_strings__instance__3__result10 bounded_dynamic_strings__instance__3__result11))))))
(assert (= bounded_dynamic_strings__instance__3__result14 bounded_dynamic_strings__instance__3__result12))
(assert (and (= o6 (length2 content)) (in_range1 (length2 content))))
(assert (= o7 (ite (= (to_rep1 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (sequence__content bounded_dynamic_strings__instance__3__result13)))) o6) true false)))
(assert (and (= temp___9922 (value (sequence__content bounded_dynamic_strings__instance__3__result13))) (and (dynamic_invariant2 temp___9922 true false true true) (and (and (= (elts (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 (sequence__content bounded_dynamic_strings__instance__3__result13)))) temp___992) (= (mk1 (to_rep2 (first4 (mk2 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (sequence__content bounded_dynamic_strings__instance__3__result13))))))) (to_rep2 (last4 (mk2 1 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (sequence__content bounded_dynamic_strings__instance__3__result13)))))))) temp___9921)) (and (and (and (= (length2 temp___9922) (length1 (sequence__content bounded_dynamic_strings__instance__3__result13))) (= (to_rep2 (first2 temp___9921)) 1)) (= (to_rep2 (last2 temp___9921)) (length1 (sequence__content bounded_dynamic_strings__instance__3__result13)))) (= (< 0 (length1 (sequence__content bounded_dynamic_strings__instance__3__result13))) (not (= (empty (sequence__content bounded_dynamic_strings__instance__3__result13)) true))))))))
(assert (= o5 (bool_eq temp___992 (to_rep2 (first2 temp___9921)) (to_rep2 (last2 temp___9921)) (elts1 content) (to_rep2 (first2 (rt1 content))) (to_rep2 (last2 (rt1 content))))))
(assert (not (in_range1 (length2 content))))
(check-sat)
(exit)
