...
(assert (forall ((capacity Int)) (forall ((content us_t)) (! (=> (and (and (dynamic_invariant1 capacity true true true true) (dynamic_invariant content true true true true)) (<= (length content) capacity)) (let ((result (instance capacity content))) (and (and (and (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 result))) capacity) (= (length2 result) (length content))) (= (let ((temp___274 (value result))) (bool_eq (to_array temp___274) (first1 temp___274) (last1 temp___274) (to_array content) (first1 content) (last1 content))) true)) (dynamic_invariant2 result true false true true)))) :pattern ((instance capacity content))))))
...
(declare-const o4 t1)
(declare-const temp___986 (Array Int character))
(declare-const temp___9861 t)
...
(define-fun bounded_dynamic_strings__instance__3__result15 () us_rep (mk___rep (mk___split_discrs bounded_dynamic_strings__instance__3__result4) (mk___split_fields bounded_dynamic_strings__instance__3__result5 (mk___t1 bounded_dynamic_strings__instance__3__result6 bounded_dynamic_strings__instance__3__result7))))
(define-fun temp___9862 () us_t (mk___t temp___986 temp___9861))
(define-fun o8 () us_rep (mk___rep (mk___split_discrs o1) (mk___split_fields o2 (mk___t1 o3 o4))))
(assert (dynamic_invariant content true false true true))
...
(assert (and (= o (length content)) (in_range4 (length content))))
(assert (and (= o8 (instance o content)) (and (dynamic_invariant2 o8 true false true true) (and (and (= (to_rep2 o1) o) (= (length2 o8) (length content))) (= (let ((temp___270 (value o8))) (bool_eq (elts temp___270) (to_rep1 (first (rt temp___270))) (to_rep1 (last (rt temp___270))) (elts content) (to_rep1 (first (rt content))) (to_rep1 (last (rt content))))) true)))))
...
(assert (and (= o6 (length content)) (in_range1 (length content))))
(assert (= o7 (ite (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (sequence__content bounded_dynamic_strings__instance__3__result13)))) o6) true false)))
(assert (and (= temp___9862 (value (sequence__content bounded_dynamic_strings__instance__3__result13))) (and (dynamic_invariant temp___9862 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 (sequence__content bounded_dynamic_strings__instance__3__result13)))) temp___986) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (sequence__content bounded_dynamic_strings__instance__3__result13))))))) (to_rep1 (last4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (sequence__content bounded_dynamic_strings__instance__3__result13)))))))) temp___9861)) (and (and (and (= (length temp___9862) (length2 (sequence__content bounded_dynamic_strings__instance__3__result13))) (= (to_rep1 (first temp___9861)) 1)) (= (to_rep1 (last temp___9861)) (length2 (sequence__content bounded_dynamic_strings__instance__3__result13)))) (= (< 0 (length2 (sequence__content bounded_dynamic_strings__instance__3__result13))) (not (= (empty (sequence__content bounded_dynamic_strings__instance__3__result13)) true))))))))
(assert (= o5 (bool_eq temp___986 (to_rep1 (first temp___9861)) (to_rep1 (last temp___9861)) (elts content) (to_rep1 (first (rt content))) (to_rep1 (last (rt content))))))
