...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true) (dynamic_invariant1 (length2 this) true false true)) :pattern ((length2 this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true) (= (length2 this) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length2 this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true) (let ((result (value this))) (and (and (and (and (= (length result) (length2 this)) (= (first1 result) 1)) (= (last1 result) (length2 this))) (= (< 0 (length2 this)) (not (= (empty this) true)))) (dynamic_invariant result true false true)))) :pattern ((value this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true) (= (value this) (let ((temp___234 (let ((temp___232 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) (let ((temp___231 1)) (let ((temp___233 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this)))) (of_array2 (to_array1 temp___233) temp___231 temp___232)))))) (of_array (to_array2 temp___234) (first5 temp___234) (last5 temp___234))))) :pattern ((value this)))))
(declare-fun instance (Int us_t) us_rep)
(declare-fun instance__function_guard (us_rep Int us_t) Bool)
(assert (forall ((capacity Int)) (forall ((content us_t)) (! (=> (and (and (dynamic_invariant1 capacity true true true) (dynamic_invariant content true true true)) (<= (length content) capacity)) (let ((result (instance capacity content))) (and (and (and (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 result))) capacity) (= (length2 result) (length content))) (= (let ((temp___245 (value result))) (bool_eq (to_array temp___245) (first1 temp___245) (last1 temp___245) (to_array content) (first1 content) (last1 content))) true)) (dynamic_invariant2 result true false true)))) :pattern ((instance capacity content))))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant2 this true true true) (= (= (empty this) true) (= (length2 this) 0))) :pattern ((empty this)))))
...
(declare-const bounded_dynamic_strings__instance__3__result3 t1)
(declare-const o Int)
...
(declare-const temp___923 (Array Int character))
(declare-const temp___9231 t)
...
(declare-const bounded_dynamic_strings__instance__3__result7 t1)
...
(declare-const bounded_dynamic_strings__instance__3__result11 t1)
...
(assert (<= (length content) 2147483647))
...
(assert (= bounded_dynamic_strings__instance__3__result12 (mk___rep (mk___split_discrs bounded_dynamic_strings__instance__3__result4) (mk___split_fields bounded_dynamic_strings__instance__3__result5 (mk___t1 bounded_dynamic_strings__instance__3__result6 bounded_dynamic_strings__instance__3__result7)))))
(assert (and (= o1 (length content)) (in_range4 (length content))))
(assert (and (= (mk___rep (mk___split_discrs o2) (mk___split_fields o3 (mk___t1 o4 o5))) (instance o1 content)) (and (dynamic_invariant2 (mk___rep (mk___split_discrs o2) (mk___split_fields o3 (mk___t1 o4 o5))) true false true) (and (and (= (to_rep2 o2) o1) (= (length2 (mk___rep (mk___split_discrs o2) (mk___split_fields o3 (mk___t1 o4 o5)))) (length content))) (= (let ((temp___241 (value (mk___rep (mk___split_discrs o2) (mk___split_fields o3 (mk___t1 o4 o5)))))) (bool_eq (elts temp___241) (to_rep1 (first (rt temp___241))) (to_rep1 (last (rt temp___241))) (elts content) (to_rep1 (first (rt content))) (to_rep1 (last (rt content))))) true)))))
(assert (= (mk_sequence__ref (mk___rep (mk___split_discrs result) (mk___split_fields result1 (mk___t1 result2 result3)))) (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__instance__3__result) (mk___split_fields bounded_dynamic_strings__instance__3__result1 (mk___t1 bounded_dynamic_strings__instance__3__result2 bounded_dynamic_strings__instance__3__result3))))))
(assert (= (mk___rep (mk___split_discrs bounded_dynamic_strings__instance__3__result4) (mk___split_fields bounded_dynamic_strings__instance__3__result5 (mk___t1 bounded_dynamic_strings__instance__3__result6 bounded_dynamic_strings__instance__3__result7))) (mk___rep (mk___split_discrs o2) (mk___split_fields o3 (mk___t1 o4 o5)))))
(assert (= bounded_dynamic_strings__instance__3__result13 (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__instance__3__result8) (mk___split_fields bounded_dynamic_strings__instance__3__result9 (mk___t1 bounded_dynamic_strings__instance__3__result10 bounded_dynamic_strings__instance__3__result11))))))
(assert (= bounded_dynamic_strings__instance__3__result14 bounded_dynamic_strings__instance__3__result12))
(assert (and (= o8 (length content)) (in_range1 (length content))))
(assert (= o9 (ite (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 (sequence__content bounded_dynamic_strings__instance__3__result13)))) o8) true false)))
(assert (and (= (mk___t temp___923 temp___9231) (value (sequence__content bounded_dynamic_strings__instance__3__result13))) (and (dynamic_invariant (mk___t temp___923 temp___9231) true false true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 (sequence__content bounded_dynamic_strings__instance__3__result13)))) temp___923) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (sequence__content bounded_dynamic_strings__instance__3__result13))))))) (to_rep1 (last4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (sequence__content bounded_dynamic_strings__instance__3__result13)))))))) temp___9231)) (and (and (and (= (length (mk___t temp___923 temp___9231)) (length2 (sequence__content bounded_dynamic_strings__instance__3__result13))) (= (to_rep1 (first temp___9231)) 1)) (= (to_rep1 (last temp___9231)) (length2 (sequence__content bounded_dynamic_strings__instance__3__result13)))) (= (< 0 (length2 (sequence__content bounded_dynamic_strings__instance__3__result13))) (not (= (empty (sequence__content bounded_dynamic_strings__instance__3__result13)) true))))))))
(assert (= o7 (bool_eq temp___923 (to_rep1 (first temp___9231)) (to_rep1 (last temp___9231)) (elts content) (to_rep1 (first (rt content))) (to_rep1 (last (rt content))))))
(assert (not (in_range1 (length content))))
(check-sat)
(exit)
