...
(assert (= j1 o1))
(assert (<= i1 j1))
(assert (and (and (and (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (and (<= (to_rep a__first) j2) (<= j2 (to_rep a__last)))) (forall ((k Int)) (=> (and (<= (to_rep a__first) k) (<= k (- i2 1))) (not (= (select a k) true))))) (forall ((k Int)) (=> (and (<= (+ j2 1) k) (<= k (to_rep a__last))) (= (select a k) true)))))
(assert (and (and (=> (<= 0 1000000) (in_range2 i2)) (=> (<= 0 1000000) (in_range2 j2))) (<= i2 j2)))
(assert (= temp___197 result2))
(assert (= temp___1971 (- j2 i2)))
(assert (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))))
(assert (= o2 i2))
(assert (= o3 (select a o2)))
(assert (= result3 (ite (not (= o3 true)) true false)))
(assert (=> (= result3 true) (and (= o4 (+ i2 1)) (in_range2 (+ i2 1)))))
(assert (=> (= result3 true) (= i2 result4)))
(assert (=> (= result3 true) (= i3 o4)))
(assert (=> (= result3 true) (= j3 j2)))
(assert (=> (= result3 true) (= a1 a)))
(assert (=> (not (= result3 true)) (and (<= (to_rep a__first) j2) (<= j2 (to_rep a__last)))))
(assert (=> (not (= result3 true)) (= o5 j2)))
(assert (=> (not (= result3 true)) (= result5 (select a o5))))
(assert (=> (not (= result3 true)) (=> (= result5 true) (and (= o6 (- j2 1)) (in_range2 (- j2 1))))))
(assert (=> (not (= result3 true)) (=> (= result5 true) (= j2 result6))))
(assert (=> (not (= result3 true)) (=> (= result5 true) (= j3 o6))))
(assert (=> (not (= result3 true)) (=> (= result5 true) (= i4 i2))))
(assert (=> (not (= result3 true)) (=> (= result5 true) (= a1 a))))
(assert (=> (not (= result3 true)) (=> (not (= result5 true)) (and (and (= (= (select a1 i2) true) (= (select a j2) true)) (= (= (select a1 j2) true) (= (select a i2) true))) (forall ((k Int)) (=> (and (<= (to_rep a__first) k) (<= k (to_rep a__last))) (=> (and (not (= k i2)) (not (= k j2))) (= (= (select a1 k) true) (= (select a k) true)))))))))
(assert (=> (not (= result3 true)) (=> (not (= result5 true)) (and (= o7 (+ i2 1)) (in_range2 (+ i2 1))))))
(assert (=> (not (= result3 true)) (=> (not (= result5 true)) (= i2 result7))))
(assert (=> (not (= result3 true)) (=> (not (= result5 true)) (= i4 o7))))
(assert (=> (not (= result3 true)) (=> (not (= result5 true)) (and (= o8 (- j2 1)) (in_range2 (- j2 1))))))
(assert (=> (not (= result3 true)) (=> (not (= result5 true)) (= j2 result8))))
(assert (=> (not (= result3 true)) (=> (not (= result5 true)) (= j4 o8))))
(assert (=> (not (= result3 true)) (=> (not (= result5 true)) (= j3 j4))))
(assert (=> (not (= result3 true)) (= i3 i4)))
(assert (<= i3 j3))
(assert (not (<= (to_rep a__first) i3)))
(check-sat)
(exit)
