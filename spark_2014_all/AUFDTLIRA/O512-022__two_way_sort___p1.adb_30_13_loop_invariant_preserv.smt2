...
(assert (= j4 o1))
(assert (<= i2 j4))
(assert (and (and (and (and (<= (to_rep a__first) i3) (<= i3 (to_rep a__last))) (and (<= (to_rep a__first) j5) (<= j5 (to_rep a__last)))) (forall ((k3 Int)) (=> (and (<= (to_rep a__first) k3) (<= k3 (- i3 1))) (not (= (select a2 k3) true))))) (forall ((k3 Int)) (=> (and (<= (+ j5 1) k3) (<= k3 (to_rep a__last))) (= (select a2 k3) true)))))
(assert (and (and (=> (<= 0 1000000) (in_range2 i3)) (=> (<= 0 1000000) (in_range2 j5))) (<= i3 j5)))
(assert (= temp___1711 result4))
(assert (= temp___1712 (- j5 i3)))
(assert (and (<= (to_rep a__first) i3) (<= i3 (to_rep a__last))))
(assert (= o2 i3))
(assert (= o3 (select a2 o2)))
(assert (= result5 (ite (not (= o3 true)) true false)))
(assert (=> (= result5 true) (and (= o4 (+ i3 1)) (in_range2 (+ i3 1)))))
(assert (=> (= result5 true) (= i3 result6)))
(assert (=> (= result5 true) (= i4 o4)))
(assert (=> (= result5 true) (= j6 j5)))
(assert (=> (= result5 true) (= a3 a2)))
(assert (=> (not (= result5 true)) (and (<= (to_rep a__first) j5) (<= j5 (to_rep a__last)))))
(assert (=> (not (= result5 true)) (= o5 j5)))
(assert (=> (not (= result5 true)) (= result7 (select a2 o5))))
(assert (=> (not (= result5 true)) (=> (= result7 true) (and (= o6 (- j5 1)) (in_range2 (- j5 1))))))
(assert (=> (not (= result5 true)) (=> (= result7 true) (= j5 result8))))
(assert (=> (not (= result5 true)) (=> (= result7 true) (= j6 o6))))
(assert (=> (not (= result5 true)) (=> (= result7 true) (= i5 i3))))
(assert (=> (not (= result5 true)) (=> (= result7 true) (= a3 a2))))
(assert (=> (not (= result5 true)) (=> (not (= result7 true)) (and (and (= (= (select a3 i3) true) (= (select a2 j5) true)) (= (= (select a3 j5) true) (= (select a2 i3) true))) (forall ((k3 Int)) (=> (and (<= (to_rep a__first) k3) (<= k3 (to_rep a__last))) (=> (and (not (= k3 i3)) (not (= k3 j5))) (= (= (select a3 k3) true) (= (select a2 k3) true)))))))))
(assert (=> (not (= result5 true)) (=> (not (= result7 true)) (and (= o7 (+ i3 1)) (in_range2 (+ i3 1))))))
(assert (=> (not (= result5 true)) (=> (not (= result7 true)) (= i3 result9))))
(assert (=> (not (= result5 true)) (=> (not (= result7 true)) (= i5 o7))))
(assert (=> (not (= result5 true)) (=> (not (= result7 true)) (and (= o8 (- j5 1)) (in_range2 (- j5 1))))))
(assert (=> (not (= result5 true)) (=> (not (= result7 true)) (= j5 result10))))
(assert (=> (not (= result5 true)) (=> (not (= result7 true)) (= j7 o8))))
(assert (=> (not (= result5 true)) (=> (not (= result7 true)) (= j6 j7))))
(assert (=> (not (= result5 true)) (= i4 i5)))
(assert (<= i4 j6))
(assert (not (<= (to_rep a__first) i4)))
(check-sat)
(exit)
