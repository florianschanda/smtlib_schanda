...
(assert (and (= o22 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (= o23 (ite (<= o22 i) true false)))
(assert (= result5 (ite (= o23 true) (ite (<= i index3) true false) false)))
(assert (= result5 true))
(assert (and (<= (to_rep1 n__first) i) (<= i (to_rep1 n__last))))
(assert (= o24 i))
(assert (= o25 (select n3 o24)))
(assert (= o26 (to_rep1 o25)))
(assert (= o27 (ite (<= o26 9) true false)))
