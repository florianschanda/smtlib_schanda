...
(define-fun dynamic_invariant ((temp___expr_146 Int) (temp___is_init_143 Bool) (temp___skip_constant_144 Bool) (temp___do_toplevel_145 Bool)) Bool (=> (or (= temp___is_init_143 true) (<= 1 8)) (in_range1 temp___expr_146)))
...
(define-fun dynamic_invariant1 ((temp___expr_152 us_t) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (not (= temp___skip_constant_150 true)) (dynamic_property 1 8 (first1 temp___expr_152) (last1 temp___expr_152))))
(declare-sort t3s 0)
...
(assert (dynamic_invariant1 num_item_per_category true false true))
(assert (= (mk___t (counter_example__num_item_per_category__aggregate_def 3 8 10000 42 98 76 0 1) (mk 1 8)) num_item_per_category))
(assert (in_range1 cat))
(assert (not (<= (to_rep1 (first (rt num_item_per_category))) cat)))
(check-sat)
(exit)
