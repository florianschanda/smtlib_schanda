...
(define-fun dynamic_invariant ((temp___expr_169 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool) (temp___do_typ_inv_168 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= 1 8)) (in_range1 temp___expr_169)))
...
(define-fun dynamic_invariant1 ((temp___expr_176 us_t) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (not (= temp___skip_constant_173 true)) (dynamic_property 1 8 (first1 temp___expr_176) (last1 temp___expr_176))))
(declare-sort t3s 0)
...
(assert (dynamic_invariant1 num_item_per_category true false true true))
