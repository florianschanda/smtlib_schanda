...
(declare-const temp___1873 (Array Int us_rep1))
...
(assert (and (= temp___1873 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o5)) (and (dynamic_invariant8 temp___1873 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1873 o5))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1873 o5)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o5)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1873 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1873 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1873 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1873 i1))) true) (not (= i1 o5))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1873 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1873 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1873 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1873 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1873 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1873 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1873 j)))) true)) (= j i1))))))))))))))
