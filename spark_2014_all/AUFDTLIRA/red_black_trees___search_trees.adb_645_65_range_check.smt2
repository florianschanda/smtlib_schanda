...
(assert (= result7 o47))
(assert (= result7 true))
(assert (and (= o48 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (and (= temp___1829 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o48)) (and (dynamic_invariant8 temp___1829 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1829 o48))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1829 o48)))) 0) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (not (= i4 o48)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1829 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1829 i4))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1829 i4))) true)))))) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1829 i4))) true) (not (= i4 o48))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1829 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1829 i4)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1829 i4)))) 0)))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1829 i4))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1829 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1829 i4))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1829 j)))) true)) (= j i4))))))))))))))
