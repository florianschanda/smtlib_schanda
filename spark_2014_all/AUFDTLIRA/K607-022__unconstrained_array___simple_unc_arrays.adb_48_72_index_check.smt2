...
(assert (<= 2 i1))
(assert (<= i1 r25b))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (<= res2 (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1))))))
(assert (and (and (=> (<= 2 r25b) (dynamic_property2 2 r25b i2)) (=> (<= (- 2147483648) 2147483647) (in_range3 res2))) (and (<= 2 i2) (<= i2 r25b))))
(assert (<= 1 j))
(assert (<= j (- i2 1)))
