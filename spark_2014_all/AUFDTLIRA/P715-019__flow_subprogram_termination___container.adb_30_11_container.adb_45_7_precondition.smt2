...
(define-fun dynamic_invariant ((temp___expr_580 Int) (temp___is_init_576 Bool) (temp___skip_constant_577 Bool) (temp___do_toplevel_578 Bool) (temp___do_typ_inv_579 Bool)) Bool (=> (or (= temp___is_init_576 true) (<= 1 200)) (in_range1 temp___expr_580)))
...
(define-fun bool_eq ((a (Array Int positive)) (a__first Int) (a__last Int) (b (Array Int positive)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep (select a temp___idx_173)) (to_rep (select b (+ (- b__first a__first) temp___idx_173))))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_18)))
(assert (forall ((c us_rep)) (forall ((p us_rep1)) (! (=> (= (has_element c p) true) (dynamic_invariant1 (element c p) true false true true)) :pattern ((element c p))))))
(assert (forall ((c us_rep)) (forall ((p us_rep1)) (! (= (element c p) (to_rep (let ((temp___628 (rec__container__container__a (us_split_fields1 c)))) (select temp___628 (to_rep1 (rec__container__cursor__index (us_split_fields3 p))))))) :pattern ((element c p))))))
...
(declare-fun temp___676 (Int) (Array Int positive))
...
(assert (forall ((temp___678 Int)) (=> (dynamic_invariant3 temp___678 true true true true) (forall ((temp___679 Int)) (= (to_rep (select (temp___676 temp___678) temp___679)) temp___678)))))
(declare-const int__ Int)
(declare-const cont__split_fields (Array Int positive))
(declare-const e Int)
(declare-const o natural)
(declare-const temp___686 natural)
...
(declare-const temp___6861 natural)
(declare-const result5 int__ref)
(declare-const int__3 Int)
(declare-const int__4 Int)
(declare-const temp___6811 Int)
(declare-const result6 int__ref)
(declare-const temp___6812 Int)
...
(define-fun temp___6862 () us_rep1 (mk___rep1 (mk___split_fields1 temp___6861)))
(define-fun o5 () us_rep1 (mk___rep1 (mk___split_fields1 o3)))
(assert (= result int__))
(assert (= int__1 2))
(assert (in_range1 int__1))
(assert (= result1 cont__split_fields))
(assert (= (temp___676 4) cont__split_fields1))
...
(assert (= temp___686 o))
(assert (and (= result2 (has_element c12b (mk___rep1 (mk___split_fields1 temp___686)))) (= (= result2 true) (and (<= 1 (to_rep1 temp___686)) (<= (to_rep1 temp___686) 200)))))
(assert (=> (= result2 true) (and (= o1 (element c12b (mk___rep1 (mk___split_fields1 temp___686)))) (and (in_range4 o1) (= o1 (to_rep (select (rec__container__container__a (us_split_fields1 c12b)) (to_rep1 temp___686))))))))
(assert (=> (= result2 true) (= result3 e)))
(assert (=> (= result2 true) (= e2 o1)))
(assert (=> (not (= result2 true)) (= e2 e)))
(assert (=> (not (= result2 true)) (= e2 e1)))
(assert (and (= result4 (has_element c12b (mk___rep1 (mk___split_fields1 temp___686)))) (= (= result4 true) (and (<= 1 (to_rep1 temp___686)) (<= (to_rep1 temp___686) 200)))))
(assert (= result4 true))
(assert (and (=> (<= 1 200) (in_range1 int__2)) (and (= (has_element c12b temp___6862) true) (= e3 (element c12b temp___6862)))))
(assert (= temp___680 int__2))
(assert (= 0 temp___681))
(assert (and (= o2 (+ int__2 1)) (in_range1 (+ int__2 1))))
(assert (= result5 (mk_int__ref int__2)))
(assert (= int__3 o2))
(assert (=> (<= 1 200) (in_range1 int__4)))
(assert (= result6 (mk_int__ref temp___6811)))
(assert (= temp___6812 int__4))
(assert (= int__4 5))
(assert (= int__5 (mk_int__ref int__4)))
(assert (= rho temp___6812))
...
(assert (and (= o5 (next c12b temp___6862)) (= o5 (ite (< (to_rep1 temp___6861) 200) (mk___rep1 (mk___split_fields1 (of_rep1 (+ (to_rep1 temp___6861) 1)))) (mk___rep1 (mk___split_fields1 (of_rep1 0)))))))
(assert (and (= o4 (has_element c12b o5)) (= (= o4 true) (and (<= 1 (to_rep1 o3)) (<= (to_rep1 o3) 200)))))
(assert (= result8 (ite (not (= o4 true)) true false)))
(assert (not (= result8 true)))
(assert (not (= (has_element c12b temp___6862) true)))
(check-sat)
(exit)
