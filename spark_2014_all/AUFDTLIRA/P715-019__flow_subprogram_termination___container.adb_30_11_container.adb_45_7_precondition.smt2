...
(define-fun dynamic_invariant ((temp___expr_515 Int) (temp___is_init_512 Bool) (temp___skip_constant_513 Bool) (temp___do_toplevel_514 Bool)) Bool (=> (or (= temp___is_init_512 true) (<= 1 200)) (in_range1 temp___expr_515)))
...
(assert (forall ((c us_rep)) (forall ((p us_rep1)) (! (= (element c p) (to_rep (let ((temp___559 (rec__container__container__a (us_split_fields1 c)))) (select temp___559 (to_rep1 (rec__container__cursor__index (us_split_fields3 p))))))) :pattern ((element c p))))))
...
(declare-fun temp___607 (Int) (Array Int positive))
(assert (forall ((temp___609 Int)) (forall ((temp___610 Int)) (= (select (temp___607 temp___609) temp___610) (of_rep temp___609)))))
...
(declare-const temp___617 natural)
...
(declare-const temp___6171 natural)
(declare-const result5 int__ref)
(declare-const int__3 Int)
(declare-const int__4 Int)
(declare-const temp___6121 Int)
(declare-const result6 int__ref)
(declare-const temp___6122 Int)
...
(define-fun temp___6172 () us_rep1 (mk___rep1 (mk___split_fields1 temp___6171)))
(define-fun o5 () us_rep1 (mk___rep1 (mk___split_fields1 o3)))
(assert (= result int__))
(assert (= int__1 2))
(assert (in_range1 int__1))
(assert (= result1 cont__split_fields))
(assert (= (temp___607 4) cont__split_fields1))
...
(assert (= temp___617 o))
(assert (and (= result2 (has_element c12b (mk___rep1 (mk___split_fields1 temp___617)))) (= (= result2 true) (and (<= 1 (to_rep1 temp___617)) (<= (to_rep1 temp___617) 200)))))
(assert (=> (= result2 true) (and (= o1 (element c12b (mk___rep1 (mk___split_fields1 temp___617)))) (and (in_range4 o1) (= o1 (to_rep (select (rec__container__container__a (us_split_fields1 c12b)) (to_rep1 temp___617))))))))
(assert (=> (= result2 true) (= result3 e)))
(assert (=> (= result2 true) (= e2 o1)))
(assert (=> (not (= result2 true)) (= e2 e)))
(assert (=> (not (= result2 true)) (= e2 e1)))
(assert (and (= result4 (has_element c12b (mk___rep1 (mk___split_fields1 temp___617)))) (= (= result4 true) (and (<= 1 (to_rep1 temp___617)) (<= (to_rep1 temp___617) 200)))))
(assert (= result4 true))
(assert (and (=> (<= 1 200) (in_range1 int__2)) (and (= (has_element c12b temp___6172) true) (= e3 (element c12b temp___6172)))))
(assert (= temp___611 int__2))
(assert (= 0 temp___612))
(assert (and (= o2 (+ int__2 1)) (in_range1 (+ int__2 1))))
(assert (= result5 (mk_int__ref int__2)))
(assert (= int__3 o2))
(assert (=> (<= 1 200) (in_range1 int__4)))
(assert (= result6 (mk_int__ref temp___6121)))
(assert (= temp___6122 int__4))
(assert (= int__4 5))
(assert (= int__5 (mk_int__ref int__4)))
(assert (= rho temp___6122))
...
(assert (= b1 (of_int 0)))
(assert (and (= o5 (next c12b temp___6172)) (= o5 (ite (< (to_rep1 temp___6171) 200) (mk___rep1 (mk___split_fields1 (of_rep1 (+ (to_rep1 temp___6171) 1)))) (mk___rep1 (mk___split_fields1 (of_rep1 0)))))))
...
(assert (not (= (has_element c12b temp___6172) true)))
(check-sat)
(exit)
