...
(define-fun in_range1 ((x Int)) Bool (and (<= 1 x) (<= x 200)))
...
(define-fun dynamic_invariant ((temp___expr_509 Int) (temp___is_init_506 Bool) (temp___skip_constant_507 Bool) (temp___do_toplevel_508 Bool)) Bool (=> (or (= temp___is_init_506 true) (<= 1 200)) (in_range1 temp___expr_509)))
...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__container__cursor__index (us_split_fields3 a))) (to_rep1 (rec__container__cursor__index (us_split_fields3 b)))) true false))
...
(assert true)
(assert (forall ((c us_rep)) (! (= (first c) (mk___rep1 (mk___split_fields1 (of_rep1 1)))) :pattern ((first c)))))
(declare-fun has_element (us_rep us_rep1) Bool)
(declare-fun has_element__function_guard (Bool us_rep us_rep1) Bool)
(assert true)
(assert (forall ((c us_rep)) (forall ((p us_rep1)) (! (= (= (has_element c p) true) (and (<= 1 (to_rep1 (rec__container__cursor__index (us_split_fields3 p)))) (<= (to_rep1 (rec__container__cursor__index (us_split_fields3 p))) 200))) :pattern ((has_element c p))))))
(declare-fun next (us_rep us_rep1) us_rep1)
(declare-fun next__function_guard (us_rep1 us_rep us_rep1) Bool)
(assert true)
(assert (forall ((c us_rep)) (forall ((p us_rep1)) (! (= (next c p) (ite (< (to_rep1 (rec__container__cursor__index (us_split_fields3 p))) 200) (mk___rep1 (mk___split_fields1 (of_rep1 (+ (to_rep1 (rec__container__cursor__index (us_split_fields3 p))) 1)))) (mk___rep1 (mk___split_fields1 (of_rep1 0))))) :pattern ((next c p))))))
...
(define-fun dynamic_invariant1 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_15)))
(assert (forall ((c us_rep)) (forall ((p us_rep1)) (! (=> (= (has_element c p) true) (dynamic_invariant1 (element c p) true false true)) :pattern ((element c p))))))
(assert (forall ((c us_rep)) (forall ((p us_rep1)) (! (= (element c p) (to_rep (let ((temp___553 (rec__container__container__a (us_split_fields1 c)))) (select temp___553 (to_rep1 (rec__container__cursor__index (us_split_fields3 p))))))) :pattern ((element c p))))))
...
(declare-fun temp___601 (Int) (Array Int positive))
(assert (forall ((temp___603 Int)) (forall ((temp___604 Int)) (= (select (temp___601 temp___603) temp___604) (of_rep temp___603)))))
...
(declare-const temp___611 natural)
...
(declare-const temp___6111 natural)
(declare-const result5 int__ref)
(declare-const int__3 Int)
(declare-const int__4 Int)
(declare-const temp___6061 Int)
(declare-const result6 int__ref)
(declare-const temp___6062 Int)
(declare-const result7 int__ref)
(declare-const int__5 Int)
(declare-const int__6 int__ref)
(declare-const int__7 Int)
(declare-const rho Int)
(declare-const int__8 int__ref)
(declare-const int__9 Int)
(declare-const rho1 Int)
(declare-const result8 bool__ref)
(declare-const b1 Bool)
(declare-const result9 Bool)
(declare-const result10 cursor__ref)
(declare-const temp___6112 us_rep1)
(declare-const result11 Bool)
(assert (= result int__))
(assert (= int__1 2))
(assert (in_range1 int__1))
(assert (= result1 cont__split_fields))
(assert (= (temp___601 4) cont__split_fields1))
(assert (= (mk___rep (mk___split_fields cont__split_fields1)) c12b))
(assert (and (= (mk___rep1 (mk___split_fields1 o)) (first c12b)) (= (of_rep1 1) o)))
(assert (= temp___611 o))
(assert (and (= result2 (has_element c12b (mk___rep1 (mk___split_fields1 temp___611)))) (= (= result2 true) (and (<= 1 (to_rep1 temp___611)) (<= (to_rep1 temp___611) 200)))))
(assert (=> (= result2 true) (and (= o1 (element c12b (mk___rep1 (mk___split_fields1 temp___611)))) (and (in_range4 o1) (= o1 (to_rep (select (rec__container__container__a (us_split_fields1 c12b)) (to_rep1 temp___611))))))))
(assert (=> (= result2 true) (= result3 e)))
(assert (=> (= result2 true) (= e2 o1)))
(assert (=> (not (= result2 true)) (= e2 e)))
(assert (=> (not (= result2 true)) (= e2 e1)))
(assert (and (= result4 (has_element c12b (mk___rep1 (mk___split_fields1 temp___611)))) (= (= result4 true) (and (<= 1 (to_rep1 temp___611)) (<= (to_rep1 temp___611) 200)))))
(assert (= result4 true))
(assert (and (=> (<= 1 200) (in_range1 int__2)) (and (= (has_element c12b (mk___rep1 (mk___split_fields1 temp___6111))) true) (= e3 (element c12b (mk___rep1 (mk___split_fields1 temp___6111)))))))
(assert (= temp___605 int__2))
(assert (= 0 temp___606))
(assert (and (= o2 (+ int__2 1)) (in_range1 (+ int__2 1))))
(assert (= result5 (mk_int__ref int__2)))
(assert (= int__3 o2))
(assert (=> (<= 1 200) (in_range1 int__4)))
(assert (= result6 (mk_int__ref temp___6061)))
(assert (= temp___6062 int__4))
(assert (= int__4 5))
(assert (= int__6 (mk_int__ref int__4)))
(assert (= rho temp___6062))
(assert (= int__7 int__4))
(assert (= int__8 int__6))
(assert (= rho1 rho))
(assert (= int__9 int__7))
(assert (= result8 (mk_bool__ref b)))
(assert (= b1 (of_int 0)))
(assert (and (= (mk___rep1 (mk___split_fields1 o4)) (next c12b (mk___rep1 (mk___split_fields1 temp___6111)))) (= (mk___rep1 (mk___split_fields1 o4)) (ite (< (to_rep1 temp___6111) 200) (mk___rep1 (mk___split_fields1 (of_rep1 (+ (to_rep1 temp___6111) 1)))) (mk___rep1 (mk___split_fields1 (of_rep1 0)))))))
(assert (and (= o5 (has_element c12b (mk___rep1 (mk___split_fields1 o4)))) (= (= o5 true) (and (<= 1 (to_rep1 o4)) (<= (to_rep1 o4) 200)))))
(assert (= result9 (ite (not (= o5 true)) true false)))
(assert (not (= result9 true)))
(assert (not (= (has_element c12b (mk___rep1 (mk___split_fields1 temp___6111))) true)))
(check-sat)
(exit)
