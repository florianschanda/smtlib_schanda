...
(assert (= result8 true))
(assert (and (= temp___1705 (model__ f_old root)) (and (dynamic_invariant5 temp___1705 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1705 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1705 root)))) 0) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (not (= i21 root)) (ite (and (not (= (parent f_old i21) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1705 (parent f_old i21)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1705 i21))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1705 i21))) true)))))) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1705 i21))) true) (not (= i21 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1705 (parent f_old i21)))) (position f_old i21) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1705 i21)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1705 i21)))) 0)))) (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1705 i21))) true) (forall ((j26 Int)) (=> (and (<= 1 j26) (<= j26 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1705 j26))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1705 i21))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1705 j26)))) true)) (= j26 i21))))))))))))))
(assert (= o54 (select temp___1705 i6)))
(assert (= o55 (us_split_fields1 o54)))
(assert (= o56 (rec__tree_model__path_type__a o55)))
(assert (and (= o57 (length o56)) (and (in_range4 o57) (<= (+ 0 o57) 2147483647))))
(assert (= o58 (+ o57 1)))
(assert (and (= o59 o58) (in_range2 o58)))
(assert (and (= temp___1704 (model__ f root)) (and (dynamic_invariant5 temp___1704 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1704 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1704 root)))) 0) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (not (= i21 root)) (ite (and (not (= (parent f i21) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1704 (parent f i21)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1704 i21))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1704 i21))) true)))))) (and (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1704 i21))) true) (not (= i21 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1704 (parent f i21)))) (position f i21) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1704 i21)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1704 i21)))) 0)))) (forall ((i21 Int)) (=> (and (<= 1 i21) (<= i21 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1704 i21))) true) (forall ((j26 Int)) (=> (and (<= 1 j26) (<= j26 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1704 j26))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1704 i21))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1704 j26)))) true)) (= j26 i21))))))))))))))
(assert (= o51 (select temp___1704 v)))
(assert (= o52 (us_split_fields1 o51)))
(assert (= o53 (rec__tree_model__path_type__a o52)))
(assert (and (= o60 (get o53 o59)) (in_range5 o60)))
(assert (= result9 (ite (= o60 0) true false)))
(assert (= result9 true))
(assert (<= 1 j1))
(assert (<= j1 100))
