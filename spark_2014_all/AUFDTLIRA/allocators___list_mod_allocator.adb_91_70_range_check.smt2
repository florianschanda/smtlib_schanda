...
(assert (<= 1 r1))
(assert (<= r1 10000))
(assert (forall ((e1 Int)) (=> (and (in_range8 e1) (= (contains alloc1 e1) true)) (and (<= 1 e1) (<= e1 (- r2 1))))))
(assert (forall ((e1 Int)) (=> (and (in_range8 e1) (= (contains unseen1 e1) true)) (and (<= 1 e1) (<= e1 (- r2 1))))))
...
(assert (and (=> (<= 1 10000) (in_range3 r2)) (and (<= 1 r2) (<= r2 10000))))
(assert (<= 1 e))
(assert (<= e (- r2 1)))
