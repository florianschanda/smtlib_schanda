...
(assert (<= 1 r2))
(assert (<= r2 10000))
(assert (forall ((e3 Int)) (=> (and (in_range8 e3) (= (contains alloc2 e3) true)) (and (<= 1 e3) (<= e3 (- r3 1))))))
(assert (forall ((e3 Int)) (=> (and (in_range8 e3) (= (contains unseen2 e3) true)) (and (<= 1 e3) (<= e3 (- r3 1))))))
(assert (forall ((e3 Int)) (=> (and (<= 1 e3) (<= e3 10000)) (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data e3)))) 0) (not (= (contains alloc2 e3) true))))))
(assert (forall ((e3 Int)) (=> (and (<= 1 e3) (<= e3 (- r3 1))) (ite (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data e3)))) 1) (= (contains alloc2 e3) true) (= (contains unseen2 e3) true)))))
(assert (<= (length1 alloc2) (- r3 1)))
(assert (<= (length1 unseen2) (- r3 1)))
(assert (and (=> (<= 1 10000) (in_range3 r3)) (and (<= 1 r3) (<= r3 10000))))
(assert (<= 1 e2))
(assert (<= e2 (- r3 1)))
(assert (and (<= 1 e2) (<= e2 10000)))
(assert (= o2 e2))
(assert (= (mk___rep (mk___split_fields o3 o4)) (select data o2)))
(assert (= o3 o5))
(assert (= o4 o6))
(assert (= o7 o5))
(assert (= o8 (to_rep1 o7)))
(assert (= result1 (ite (= o8 1) true false)))
(assert (= result1 true))
(assert (not (in_range8 e2)))
(check-sat)
(exit)
