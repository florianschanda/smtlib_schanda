...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_186 us_void_param) 1)) 49) (= (to_rep (select (temp___String_Literal_186 us_void_param) 2)) 50)) (= (to_rep (select (temp___String_Literal_186 us_void_param) 3)) 51)) (= (to_rep (select (temp___String_Literal_186 us_void_param) 4)) 52)) (= (to_rep (select (temp___String_Literal_186 us_void_param) 5)) 53)) :pattern ((temp___String_Literal_186 us_void_param)))))
...
(assert (= o1 (bool_eq temp___189 (to_rep1 (first temp___1891)) (to_rep1 (last temp___1891)) new_sub1 1 5)))
