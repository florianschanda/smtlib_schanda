...
(define-fun dynamic_invariant2 ((temp___expr_195 us_rep1) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (not (= temp___skip_constant_193 true)) (in_range4 15 (to_base temp___expr_195))))
(define-fun default_initial_assumption ((temp___expr_198 us_rep1) (temp___skip_top_level_199 Bool)) Bool (= (to_rep (rec__main__discr_type__discr (us_split_discrs2 temp___expr_198))) 15))
...
(define-fun dynamic_invariant4 ((temp___expr_33 Int) (temp___is_init_30 Bool) (temp___skip_constant_31 Bool) (temp___do_toplevel_32 Bool)) Bool (=> (or (= temp___is_init_30 true) (<= 0 2147483647)) (in_range temp___expr_33)))
