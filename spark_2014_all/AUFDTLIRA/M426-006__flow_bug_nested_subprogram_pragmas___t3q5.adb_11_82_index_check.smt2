...
(assert (=> (< l u) (= i2 (+ l 1))))
(assert (=> (< l u) (=> (and (<= (+ l 1) i2) (<= i2 u)) (= temp___212 k1))))
(assert (=> (< l u) (=> (and (<= (+ l 1) i2) (<= i2 u)) (= temp___211 i2))))
(assert (=> (< l u) (=> (and (<= (+ l 1) i2) (<= i2 u)) (= temp___214 u))))
(assert (=> (< l u) (=> (and (<= (+ l 1) i2) (<= i2 u)) (= temp___213 l))))
...
(assert (=> (< l u) (=> (and (<= (+ l 1) i2) (<= i2 u)) (and (and (and (and (and (and (<= (+ l 1) i3) (<= i3 u)) (= l temp___213)) (= u temp___214)) (< l u)) (forall ((x1 Int)) (=> (and (<= l x1) (<= x1 i3)) (<= (to_rep (select arr k3)) (to_rep (select arr x1)))))) (and (<= l k3) (<= k3 u))))))
