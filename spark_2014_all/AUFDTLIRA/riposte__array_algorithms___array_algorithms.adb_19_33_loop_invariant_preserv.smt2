...
(assert (not (= i4 (to_rep1 (last (rt a))))))
(assert (= i4 result6))
(assert (= i5 (+ i4 1)))
(assert (and (<= (to_rep1 (first (rt b))) i5) (<= i5 (to_rep1 (last (rt b))))))
(assert (= o7 i5))
(assert (= o8 (select (elts b) o7)))
(assert (= o9 (to_rep o8)))
(assert (= o10 (ite (= (to_rep (select (elts a) i5)) o9) true false)))
(assert (= result7 (ite (not (= o10 true)) true false)))
