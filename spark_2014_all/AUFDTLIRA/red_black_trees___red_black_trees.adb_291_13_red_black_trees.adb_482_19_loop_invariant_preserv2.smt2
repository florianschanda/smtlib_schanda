...
(assert (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)) y2))))) n99) (= (eq (select (nb_blacks c101b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)) y2)) (select (nb_blacks c100b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)) y2))) true)))
(assert (not (= n99 100)))
(assert (= result78 (mk_int__ref n99)))
(assert (= n100 (+ n99 1)))
(assert (= n101 (mk_int__ref n100)))
(assert (= n102 n100))
(assert (not (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) c102b)))) (int__content n101))))
(assert (not true))
(check-sat)
(exit)
