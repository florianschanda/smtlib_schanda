...
(assert (= n9 n7))
(assert (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) c102b)))) (int__content n8)))
(assert (not (= (eq (select (nb_blacks c101b) y2) (select (nb_blacks c100b) y2)) true)))
(check-sat)
(exit)
