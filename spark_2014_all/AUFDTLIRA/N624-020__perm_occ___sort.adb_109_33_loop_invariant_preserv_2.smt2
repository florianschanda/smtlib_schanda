...
(declare-const temp___2732 (Array Int natural))
(declare-const temp___2733 t1)
...
(assert (=> (not (= smallest1 current1)) (and (and (and (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t o17 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (to_rep (select o17 o8)) (to_rep (select values smallest1)))) (= (to_rep (select o17 smallest1)) (to_rep (select values o8)))) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z o8)) (not (= z smallest1))) (= (to_rep (select o17 z)) (to_rep (select values z)))))))))
(assert (=> (not (not (= smallest1 current1))) (= previous2 previous)))
(assert (=> (not (not (= smallest1 current1))) (= o17 values)))
(assert (=> (not (not (= smallest1 current1))) (= previous2 previous1)))
(assert (=> (not (not (= smallest1 current1))) (= o17 values1)))
...
(assert (=> (not (= smallest3 current3)) (= (slide values2 (to_rep1 values__first) (to_rep1 values__first)) temp___2732)))
(assert (=> (not (= smallest3 current3)) (= (mk1 (to_rep1 values__first) (to_rep1 values__last)) temp___2733)))
(assert (=> (not (= smallest3 current3)) (= (ite (<= (to_rep1 (first2 temp___2733)) (to_rep1 (last2 temp___2733))) (+ (- (to_rep1 (last2 temp___2733)) (to_rep1 (first2 temp___2733))) 1) 0) (ite (<= (to_rep1 previous__first) (to_rep1 previous__last)) (+ (- (to_rep1 previous__last) (to_rep1 previous__first)) 1) 0))))
(assert (=> (not (= smallest3 current3)) (= (mk___t1 o13 o14) (mk___t1 temp___2732 temp___2733))))
...
(assert (=> (not (= smallest3 current3)) (and (and (and (= (is_perm (mk___t values2 (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t o18 (mk (to_rep1 values__first) (to_rep1 values__last)))) true) (= (to_rep (select o18 o16)) (to_rep (select values2 smallest3)))) (= (to_rep (select o18 smallest3)) (to_rep (select values2 o16)))) (forall ((z Int)) (=> (and (<= (to_rep1 values__first) z) (<= z (to_rep1 values__last))) (=> (and (not (= z o16)) (not (= z smallest3))) (= (to_rep (select o18 z)) (to_rep (select values2 z)))))))))
(assert (=> (not (not (= smallest3 current3))) (= previous4 previous3)))
(assert (=> (not (not (= smallest3 current3))) (= o18 values2)))
(assert (not (= (is_perm (mk___t values (mk (to_rep1 values__first) (to_rep1 values__last))) (mk___t o18 (mk (to_rep1 values__first) (to_rep1 values__last)))) true)))
(check-sat)
(exit)
