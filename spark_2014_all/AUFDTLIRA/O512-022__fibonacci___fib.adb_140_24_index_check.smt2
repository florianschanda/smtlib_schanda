...
(assert (= i4 0))
(assert (=> (and (<= 0 i4) (<= i4 k1)) (= temp___220 a1)))
(assert (=> (and (<= 0 i4) (<= i4 k1)) (and (forall ((temp___221 Int)) (=> (and (<= 0 temp___221) (<= temp___221 100)) (=> (or (< k1 temp___221) (or (< temp___221 0) (<= i5 temp___221))) (= (select a12 temp___221) (select temp___220 temp___221))))) (and (<= 0 i5) (<= i5 k1)))))
...
(assert (= i10 temp___222))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= temp___225 a16)))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (and (forall ((temp___226 Int)) (=> (and (<= 0 temp___226) (<= temp___226 100)) (=> (or (< 0 temp___226) (or (< temp___226 temp___222) (<= i11 temp___226))) (= (select a18 temp___226) (select temp___225 temp___226))))) (and (<= (+ k1 1) i11) (<= i11 0)))))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (and (= temp___224 (- i11 k1)) (in_range1 (- i11 k1)))))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (and (<= 0 temp___224) (<= temp___224 100))))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= o6 temp___224)))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= o7 (select c1 o6))))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= o8 (to_rep o7))))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= (to_rep o9) o8)))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (and (<= 0 i11) (<= i11 100))))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= o10 i11)))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= o11 (store a18 o10 o9))))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= a18 result3)))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= a19 o11)))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= i11 0)))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= i11 i12)))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= a19 a110)))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= i13 i11)))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= a111 a19)))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= i14 (mk_int__ref i12))))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= a114 (mk_map__ref a110))))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= i15 i13)))
(assert (=> (and (<= temp___222 i10) (<= i10 0)) (= a113 a111)))
(assert (=> (not (and (<= temp___222 i10) (<= i10 0))) (= i14 (mk_int__ref i10))))
(assert (=> (not (and (<= temp___222 i10) (<= i10 0))) (= a114 a115)))
(assert (=> (not (and (<= temp___222 i10) (<= i10 0))) (= i15 i10)))
(assert (=> (not (and (<= temp___222 i10) (<= i10 0))) (= a113 a17)))
(assert (= result4 (mk_int__ref i2)))
(assert (= i16 0))
(assert (=> (and (<= 0 i16) (<= i16 k2)) (= temp___229 a2)))
(assert (=> (and (<= 0 i16) (<= i16 k2)) (and (forall ((temp___230 Int)) (=> (and (<= 0 temp___230) (<= temp___230 100)) (=> (or (< k2 temp___230) (or (< temp___230 0) (<= i17 temp___230))) (= (select a22 temp___230) (select temp___229 temp___230))))) (and (<= 0 i17) (<= i17 k2)))))
...
(assert (and (= temp___231 (+ k2 1)) (in_range1 (+ k2 1))))
(assert (= result6 (mk_int__ref i3)))
(assert (= i22 temp___231))
(assert (<= temp___231 i22))
(assert (<= i22 100))
(assert (and (forall ((temp___235 Int)) (=> (and (<= 0 temp___235) (<= temp___235 100)) (=> (or (< 100 temp___235) (or (< temp___235 temp___231) (<= i23 temp___235))) (= (select a28 temp___235) (select (map__content a26) temp___235))))) (and (<= (+ k2 1) i23) (<= i23 100))))
(assert (and (= temp___233 (- i23 k2)) (in_range1 (- i23 k2))))
(assert (not (<= temp___233 100)))
(check-sat)
(exit)
