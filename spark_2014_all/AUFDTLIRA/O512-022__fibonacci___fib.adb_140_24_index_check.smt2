...
(assert (in_range2 k1))
(assert (in_range2 k2))
(assert (and (= k1 k2) (and (<= 0 k1) (and (<= k1 100) (and (<= 0 k2) (and (<= k2 100) (and (forall ((i38 Int)) (=> (and (<= 0 i38) (<= i38 k1)) (= (to_rep (select b1 i38)) (to_rep (select b2 i38))))) (forall ((i38 Int)) (=> (and (<= (+ k1 1) i38) (<= i38 100)) (= (to_rep (select c1 (- i38 k1))) (to_rep (select c2 (- i38 k2)))))))))))))
(assert (= (mk_int__ref result1) (mk_int__ref i)))
(assert (= i6 0))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= temp___195 a1)))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (and (forall ((temp___196 Int)) (=> (and (<= 0 temp___196) (<= temp___196 100)) (=> (<= i7 temp___196) (= (select a12 temp___196) (select temp___195 temp___196))))) (and (<= 0 i7) (<= i7 k1)))))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (and (<= 0 i7) (<= i7 100))))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= o6 i7)))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= o7 (select b1 o6))))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= o8 (to_rep o7))))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= (to_rep o9) o8)))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (and (<= 0 i7) (<= i7 100))))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= o10 i7)))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= o11 (store a12 o10 o9))))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= a12 result2)))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= a13 o11)))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= i7 k1)))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= i7 i8)))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= a13 a14)))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= i9 i7)))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= a15 a13)))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= (mk_int__ref i10) (mk_int__ref i8))))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= (mk_map__ref a16) (mk_map__ref a14))))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= i11 i9)))
(assert (=> (and (<= 0 i6) (<= i6 k1)) (= a17 a15)))
(assert (=> (not (and (<= 0 i6) (<= i6 k1))) (= i6 i10)))
(assert (=> (not (and (<= 0 i6) (<= i6 k1))) (= (mk_map__ref a16) (mk_map__ref a1))))
(assert (=> (not (and (<= 0 i6) (<= i6 k1))) (= i11 i6)))
(assert (=> (not (and (<= 0 i6) (<= i6 k1))) (= a17 a11)))
(assert (and (= temp___202 (+ k1 1)) (in_range1 (+ k1 1))))
(assert (= (mk_int__ref result3) (mk_int__ref i1)))
(assert (= i12 temp___202))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= temp___200 a16)))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (and (forall ((temp___201 Int)) (=> (and (<= 0 temp___201) (<= temp___201 100)) (=> (<= i13 temp___201) (= (select a18 temp___201) (select temp___200 temp___201))))) (and (<= (+ k1 1) i13) (<= i13 0)))))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (and (= temp___199 (- i13 k1)) (in_range1 (- i13 k1)))))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (and (<= 0 temp___199) (<= temp___199 100))))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= o12 temp___199)))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= o13 (select c1 o12))))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= o14 (to_rep o13))))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= (to_rep o15) o14)))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (and (<= 0 i13) (<= i13 100))))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= o16 i13)))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= o17 (store a18 o16 o15))))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= a18 result4)))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= a19 o17)))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= i13 0)))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= i13 i14)))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= a19 a110)))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= i15 i13)))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= a111 a19)))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= i16 (mk_int__ref i14))))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= (mk_map__ref a112) (mk_map__ref a110))))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= i17 i15)))
(assert (=> (and (<= temp___202 i12) (<= i12 0)) (= a113 a111)))
(assert (=> (not (and (<= temp___202 i12) (<= i12 0))) (= i16 (mk_int__ref i12))))
(assert (=> (not (and (<= temp___202 i12) (<= i12 0))) (= (mk_map__ref a112) (mk_map__ref a16))))
(assert (=> (not (and (<= temp___202 i12) (<= i12 0))) (= i17 i12)))
(assert (=> (not (and (<= temp___202 i12) (<= i12 0))) (= a113 a17)))
(assert (= result5 (mk_int__ref i2)))
(assert (= i18 0))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= temp___204 a2)))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (and (forall ((temp___205 Int)) (=> (and (<= 0 temp___205) (<= temp___205 100)) (=> (<= i19 temp___205) (= (select a22 temp___205) (select temp___204 temp___205))))) (and (<= 0 i19) (<= i19 k2)))))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (and (<= 0 i19) (<= i19 100))))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= o18 i19)))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= o19 (select b2 o18))))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= o20 (to_rep o19))))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= (to_rep o21) o20)))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (and (<= 0 i19) (<= i19 100))))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= o22 i19)))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= o23 (store a22 o22 o21))))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= result6 (mk_map__ref a22))))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= a23 o23)))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= i19 k2)))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= i20 (mk_int__ref i19))))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= a24 (mk_map__ref a23))))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= i21 i19)))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= a25 a23)))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= i22 i20)))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= a26 a24)))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= i23 i21)))
(assert (=> (and (<= 0 i18) (<= i18 k2)) (= a27 a25)))
(assert (=> (not (and (<= 0 i18) (<= i18 k2))) (= i22 (mk_int__ref i18))))
(assert (=> (not (and (<= 0 i18) (<= i18 k2))) (= a26 (mk_map__ref a2))))
(assert (=> (not (and (<= 0 i18) (<= i18 k2))) (= i23 i18)))
(assert (=> (not (and (<= 0 i18) (<= i18 k2))) (= a27 a21)))
(assert (and (= temp___211 (+ k2 1)) (in_range1 (+ k2 1))))
(assert (= result7 (mk_int__ref i3)))
(assert (= i24 temp___211))
(assert (<= temp___211 i24))
(assert (<= i24 100))
(assert (and (forall ((temp___210 Int)) (=> (and (<= 0 temp___210) (<= temp___210 100)) (=> (<= i25 temp___210) (= (select a28 temp___210) (select (map__content a26) temp___210))))) (and (<= (+ k2 1) i25) (<= i25 100))))
(assert (and (= temp___208 (- i25 k2)) (in_range1 (- i25 k2))))
(assert (not (<= 0 temp___208)))
(check-sat)
(exit)
