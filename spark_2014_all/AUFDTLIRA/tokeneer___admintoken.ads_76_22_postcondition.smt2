...
(assert (forall ((admintoken__authcert__fields us_split_fields10)) (! (dynamic_invariant3 (theauthcertrole admintoken__authcert__fields) true false true true) :pattern ((theauthcertrole admintoken__authcert__fields)))))
