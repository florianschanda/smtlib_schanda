...
(declare-const dummy2 (Array Int (Array Int et1)))
...
(declare-fun user_eq2 ((Array Int (Array Int et1)) (Array Int (Array Int et1))) Bool)
...
(assert (<= 1 m))
(assert (<= m 10))
(assert (not (in_range1 (to_rep (select (select (select a2 o) n) m)))))
(check-sat)
(exit)
