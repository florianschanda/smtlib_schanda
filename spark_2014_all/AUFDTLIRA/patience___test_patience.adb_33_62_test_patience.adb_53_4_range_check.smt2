...
(assert (=> (= (length (mk___t temp___806 temp___8061)) 0) (= (temp___String_Literal_805 Tuple0) temp___809)))
(assert (=> (= (length (mk___t temp___806 temp___8061)) 0) (= (mk 1 10) temp___8091)))
(assert (=> (not (= (length (mk___t temp___806 temp___8061)) 0)) (=> (<= 1 10) (= o56 (+ (- 10 1) 1)))))
(assert (=> (not (= (length (mk___t temp___806 temp___8061)) 0)) (=> (not (<= 1 10)) (= o56 0))))
(assert (=> (not (= (length (mk___t temp___806 temp___8061)) 0)) (=> (<= (to_rep1 (first temp___8061)) (to_rep1 (last temp___8061))) (= o57 (+ (- (to_rep1 (last temp___8061)) (to_rep1 (first temp___8061))) 1)))))
(assert (=> (not (= (length (mk___t temp___806 temp___8061)) 0)) (=> (not (<= (to_rep1 (first temp___8061)) (to_rep1 (last temp___8061)))) (= o57 0))))
(assert (=> (not (= (length (mk___t temp___806 temp___8061)) 0)) (= o58 (+ o57 o56))))
(assert (=> (not (= (length (mk___t temp___806 temp___8061)) 0)) (= o59 (+ (to_rep1 (first temp___8061)) o58))))
(assert (=> (not (= (length (mk___t temp___806 temp___8061)) 0)) (= o60 (- o59 1))))
(assert (=> (not (= (length (mk___t temp___806 temp___8061)) 0)) (and (= o61 o60) (in_range2 o60))))
(assert (=> (not (= (length (mk___t temp___806 temp___8061)) 0)) (= (concat1 temp___806 (to_rep1 (first temp___8061)) (to_rep1 (last temp___8061)) (temp___String_Literal_805 Tuple0) 1 10) temp___809)))
(assert (=> (not (= (length (mk___t temp___806 temp___8061)) 0)) (= (mk (to_rep1 (first temp___8061)) o61) temp___8091)))
(assert (not (= (length (mk___t temp___809 temp___8091)) 0)))
...
(assert (=> (<= (to_rep1 (first temp___8091)) (to_rep1 (last temp___8091))) (= o63 (+ (- (to_rep1 (last temp___8091)) (to_rep1 (first temp___8091))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___8091)) (to_rep1 (last temp___8091)))) (= o63 0)))
(assert (= o64 (+ o63 o62)))
(assert (= o65 (+ (to_rep1 (first temp___8091)) o64)))
(assert (= o66 (- o65 1)))
