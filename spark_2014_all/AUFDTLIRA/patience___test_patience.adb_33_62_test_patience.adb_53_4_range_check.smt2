...
(declare-const temp___882 (Array Int character))
(declare-const temp___8821 t)
...
(assert (=> (= (length (mk___t temp___879 temp___8791)) 0) (= (temp___String_Literal_878 Tuple0) temp___882)))
(assert (=> (= (length (mk___t temp___879 temp___8791)) 0) (= (mk 1 10) temp___8821)))
(assert (=> (not (= (length (mk___t temp___879 temp___8791)) 0)) (=> (<= 1 10) (= o56 (+ (- 10 1) 1)))))
(assert (=> (not (= (length (mk___t temp___879 temp___8791)) 0)) (=> (not (<= 1 10)) (= o56 0))))
(assert (=> (not (= (length (mk___t temp___879 temp___8791)) 0)) (=> (<= (to_rep1 (first temp___8791)) (to_rep1 (last temp___8791))) (= o57 (+ (- (to_rep1 (last temp___8791)) (to_rep1 (first temp___8791))) 1)))))
(assert (=> (not (= (length (mk___t temp___879 temp___8791)) 0)) (=> (not (<= (to_rep1 (first temp___8791)) (to_rep1 (last temp___8791)))) (= o57 0))))
(assert (=> (not (= (length (mk___t temp___879 temp___8791)) 0)) (= o58 (+ o57 o56))))
(assert (=> (not (= (length (mk___t temp___879 temp___8791)) 0)) (= o59 (+ (to_rep1 (first temp___8791)) o58))))
(assert (=> (not (= (length (mk___t temp___879 temp___8791)) 0)) (= o60 (- o59 1))))
(assert (=> (not (= (length (mk___t temp___879 temp___8791)) 0)) (and (= o61 o60) (in_range2 o60))))
(assert (=> (not (= (length (mk___t temp___879 temp___8791)) 0)) (= (concat1 temp___879 (to_rep1 (first temp___8791)) (to_rep1 (last temp___8791)) (temp___String_Literal_878 Tuple0) 1 10) temp___882)))
(assert (=> (not (= (length (mk___t temp___879 temp___8791)) 0)) (= (mk (to_rep1 (first temp___8791)) o61) temp___8821)))
(assert (not (= (length (mk___t temp___882 temp___8821)) 0)))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16)))))))) (= o62 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16)))))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__stacksizes (us_split_fields1 c60b)) i16))))))))) (= o62 0)))
(assert (=> (<= (to_rep1 (first temp___8821)) (to_rep1 (last temp___8821))) (= o63 (+ (- (to_rep1 (last temp___8821)) (to_rep1 (first temp___8821))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___8821)) (to_rep1 (last temp___8821)))) (= o63 0)))
(assert (= o64 (+ o63 o62)))
(assert (= o65 (+ (to_rep1 (first temp___8821)) o64)))
(assert (= o66 (- o65 1)))
