...
(declare-const temp___178 t1s)
(declare-const temp___1781 t2s)
(assert (= values1 values))
(assert (= (to_rep2 o) 1))
(assert (= (to_rep1 o1) 0))
(assert (= o1 o2))
(assert (= o o3))
(assert (= temp___178 o2))
(assert (= temp___1781 o3))
(assert (not (<= (to_rep1 temp___178) (to_rep (select values (to_rep2 temp___1781))))))
(check-sat)
(exit)
