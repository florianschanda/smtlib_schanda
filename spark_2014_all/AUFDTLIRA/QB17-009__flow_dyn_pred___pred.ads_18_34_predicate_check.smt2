...
(declare-fun to_rep (tvalue_arrayC) Int)
...
(declare-fun concat1 ((Array Int tvalue_arrayC) Int Int (Array Int tvalue_arrayC) Int Int) (Array Int tvalue_arrayC))
(assert (forall ((a (Array Int tvalue_arrayC)) (b (Array Int tvalue_arrayC))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (forall ((i Int)) (! (and (=> (and (<= a_first i) (<= i a_last)) (= (select (concat1 a a_first a_last b b_first b_last) i) (select a i))) (=> (< a_last i) (= (select (concat1 a a_first a_last b b_first b_last) i) (select b (+ (- i a_last) (- b_first 1)))))) :pattern ((select (concat1 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton1 (tvalue_arrayC Int) (Array Int tvalue_arrayC))
(assert (forall ((v tvalue_arrayC)) (forall ((i Int)) (! (= (select (singleton1 v i) i) v) :pattern ((select (singleton1 v i) i))))))
(define-fun bool_eq ((a (Array Int tvalue_arrayC)) (a__first Int) (a__last Int) (b (Array Int tvalue_arrayC)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep (select a temp___idx_132)) (to_rep (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(declare-fun compare ((Array Int tvalue_arrayC) Int Int (Array Int tvalue_arrayC) Int Int) Int)
(assert (forall ((a (Array Int tvalue_arrayC)) (b (Array Int tvalue_arrayC))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int tvalue_arrayC)) (b (Array Int tvalue_arrayC))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep (select a (+ i 1))) (to_rep (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int tvalue_arrayC)) (b (Array Int tvalue_arrayC))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep (select b (+ i 1))) (to_rep (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant1 ((temp___expr_145 us_rep) (temp___is_init_142 Bool) (temp___skip_constant_143 Bool) (temp___do_toplevel_144 Bool)) Bool (=> (= temp___do_toplevel_144 true) (=> (= temp___is_init_142 true) (<= (to_rep1 (rec__pred__pair_type__left (us_split_fields1 temp___expr_145))) (to_rep (select values (to_rep2 (rec__pred__pair_type__right (us_split_fields1 temp___expr_145)))))))))
(define-fun dynamic_predicate ((temp___151 us_rep)) Bool (<= (to_rep1 (rec__pred__pair_type__left (us_split_fields1 temp___151))) (to_rep (select values (to_rep2 (rec__pred__pair_type__right (us_split_fields1 temp___151)))))))
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const values1 (Array Int tvalue_arrayC))
(declare-const o t2s)
(declare-const o1 t1s)
(declare-const o2 t1s)
(declare-const o3 t2s)
(declare-const temp___154 t1s)
(declare-const temp___1541 t2s)
(assert (= values1 values))
(assert (= (to_rep2 o) 1))
(assert (= (to_rep1 o1) 0))
(assert (= o1 o2))
(assert (= o o3))
(assert (= temp___154 o2))
(assert (= temp___1541 o3))
(assert (not (<= (to_rep1 temp___154) (to_rep (select values (to_rep2 temp___1541))))))
(check-sat)
(exit)
