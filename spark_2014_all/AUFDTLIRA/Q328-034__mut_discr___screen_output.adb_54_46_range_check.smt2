...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_596 us_void_param) 1)) 115) (= (to_rep (select (temp___String_Literal_596 us_void_param) 2)) 100)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 3)) 99)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 8)) 111)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 9)) 114)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 11)) 97)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 12)) 116)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 16)) 110)) (= (to_rep (select (temp___String_Literal_596 us_void_param) 17)) 101)) :pattern ((temp___String_Literal_596 us_void_param)))))
(declare-fun temp___String_Literal_597 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_597 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_597 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_597 us_void_param)))))
...
(assert (=> (<= 1 2) (= o2 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o2 0)))
(assert (=> (<= (to_rep1 (first temp___5981)) (to_rep1 (last temp___5981))) (= o3 (+ (- (to_rep1 (last temp___5981)) (to_rep1 (first temp___5981))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___5981)) (to_rep1 (last temp___5981)))) (= o3 0)))
(assert (= o4 (+ o3 o2)))
