...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_668 us_void_param) 1)) 115) (= (to_rep (select (temp___String_Literal_668 us_void_param) 2)) 100)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 3)) 99)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 8)) 111)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 9)) 114)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 11)) 97)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 12)) 116)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 16)) 110)) (= (to_rep (select (temp___String_Literal_668 us_void_param) 17)) 101)) :pattern ((temp___String_Literal_668 us_void_param)))))
(declare-fun temp___String_Literal_669 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_669 us_void_param) 1)) 58) (= (to_rep (select (temp___String_Literal_669 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_669 us_void_param)))))
...
(declare-const temp___670 (Array Int character))
(declare-const temp___6701 t)
(declare-const o2 Int)
(declare-const o3 Int)
(declare-const o4 Int)
(declare-const o5 Int)
(declare-const o6 Int)
(define-fun temp___6702 () us_t (mk___t temp___670 temp___6701))
...
(assert (= temp___6702 (to_string o1)))
(assert (not (= (length temp___6702) 0)))
(assert (=> (<= 1 2) (= o2 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o2 0)))
(assert (=> (<= (to_rep1 (first temp___6701)) (to_rep1 (last temp___6701))) (= o3 (+ (- (to_rep1 (last temp___6701)) (to_rep1 (first temp___6701))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___6701)) (to_rep1 (last temp___6701)))) (= o3 0)))
(assert (= o4 (+ o3 o2)))
(assert (= o5 (+ (to_rep1 (first temp___6701)) o4)))
(assert (= o6 (- o5 1)))
