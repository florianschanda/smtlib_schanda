...
(assert (=> (<= (to_rep1 (first temp___8181)) (to_rep1 (last temp___8181))) (= o69 (+ (- (to_rep1 (last temp___8181)) (to_rep1 (first temp___8181))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___8181)) (to_rep1 (last temp___8181)))) (= o69 0)))
(assert (= o70 (+ o69 o68)))
