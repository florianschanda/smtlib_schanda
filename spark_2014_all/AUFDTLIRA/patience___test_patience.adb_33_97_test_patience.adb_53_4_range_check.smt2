...
(assert (not (= (length (mk___t temp___885 temp___8851)) 0)))
(assert (=> (<= 1 2) (= o68 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o68 0)))
(assert (=> (<= (to_rep1 (first temp___8851)) (to_rep1 (last temp___8851))) (= o69 (+ (- (to_rep1 (last temp___8851)) (to_rep1 (first temp___8851))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___8851)) (to_rep1 (last temp___8851)))) (= o69 0)))
(assert (= o70 (+ o69 o68)))
(assert (= o71 (+ (to_rep1 (first temp___8851)) o70)))
(assert (= o72 (- o71 1)))
