...
(assert (=> (<= (to_rep1 (first temp___8121)) (to_rep1 (last temp___8121))) (= o69 (+ (- (to_rep1 (last temp___8121)) (to_rep1 (first temp___8121))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___8121)) (to_rep1 (last temp___8121)))) (= o69 0)))
(assert (= o70 (+ o69 o68)))
(assert (= o71 (+ (to_rep1 (first temp___8121)) o70)))
(assert (= o72 (- o71 1)))
