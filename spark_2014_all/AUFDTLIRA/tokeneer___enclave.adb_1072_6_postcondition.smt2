...
(assert (= status1 3))
(assert (and (= (and (and (= (islocked state5) true) (= (thecurrentdoor state6) 0)) (= (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout state6)) true)) (= (thedooralarm state6) 0)) (= (= (islocked state5) true) (= (greaterthanorequal (thecurrenttime currenttime) (latch_timeout state5)) true))))
