...
(declare-fun temp___String_Literal_2707 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2707 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 16)) 66)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_2707 us_void_param) 18)) 100)) :pattern ((temp___String_Literal_2707 us_void_param)))))
(declare-fun temp___String_Literal_2712 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2712 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 20)) 86)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 22)) 114)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 24)) 102)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 26)) 97)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 27)) 98)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 28)) 108)) (= (to_rep (select (temp___String_Literal_2712 us_void_param) 29)) 101)) :pattern ((temp___String_Literal_2712 us_void_param)))))
(declare-fun temp___String_Literal_2717 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2717 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 20)) 67)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 21)) 117)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 22)) 114)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 25)) 110)) (= (to_rep (select (temp___String_Literal_2717 us_void_param) 26)) 116)) :pattern ((temp___String_Literal_2717 us_void_param)))))
...
(define-fun dynamic_invariant1 ((temp___expr_2236 Int) (temp___is_init_2233 Bool) (temp___skip_constant_2234 Bool) (temp___do_toplevel_2235 Bool)) Bool (=> (or (= temp___is_init_2233 true) (<= 0 3)) (in_range13 temp___expr_2236)))
(define-fun dynamic_invariant2 ((temp___expr_580 Int) (temp___is_init_577 Bool) (temp___skip_constant_578 Bool) (temp___do_toplevel_579 Bool)) Bool (=> (or (= temp___is_init_577 true) (<= 1 150)) (in_range2 temp___expr_580)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant3 ((temp___expr_626 Int) (temp___is_init_623 Bool) (temp___skip_constant_624 Bool) (temp___do_toplevel_625 Bool)) Bool (=> (or (= temp___is_init_623 true) (<= 1901 2099)) (in_range3 temp___expr_626)))
(define-fun dynamic_invariant4 ((temp___expr_632 Int) (temp___is_init_629 Bool) (temp___skip_constant_630 Bool) (temp___do_toplevel_631 Bool)) Bool (=> (or (= temp___is_init_629 true) (<= 1 12)) (in_range4 temp___expr_632)))
(define-fun dynamic_invariant5 ((temp___expr_638 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range5 temp___expr_638)))
(define-fun dynamic_invariant6 ((temp___expr_666 Int) (temp___is_init_663 Bool) (temp___skip_constant_664 Bool) (temp___do_toplevel_665 Bool)) Bool (=> (or (= temp___is_init_663 true) (<= 0 86399999)) (in_range6 temp___expr_666)))
(define-fun dynamic_invariant7 ((temp___expr_359 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 40)) (in_range8 temp___expr_359)))
(define-fun dynamic_invariant8 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 4294967295)) (in_range9 temp___expr_380)))
(define-fun dynamic_invariant9 ((temp___expr_402 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 10)) (in_range7 temp___expr_402)))
(define-fun dynamic_invariant10 ((temp___expr_414 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 0 4294967295)) (in_range11 temp___expr_414)))
(define-fun dynamic_invariant11 ((temp___expr_420 Int) (temp___is_init_417 Bool) (temp___skip_constant_418 Bool) (temp___do_toplevel_419 Bool)) Bool (=> (or (= temp___is_init_417 true) (<= 0 128)) (in_range12 temp___expr_420)))
(define-fun dynamic_invariant12 ((temp___expr_505 Int) (temp___is_init_502 Bool) (temp___skip_constant_503 Bool) (temp___do_toplevel_504 Bool)) Bool (=> (or (= temp___is_init_502 true) (<= 0 4294967295)) (in_range10 temp___expr_505)))
...
(declare-const temp___2706 us_rep6)
...
(assert (=> (= (rec__usertoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields)) true) (=> (not (= current2 true)) (= temp___2706 (mk___rep6 o3)))))
...
(assert (=> (= (rec__usertoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields)) true) (=> (not (= current2 true)) (= (let ((subject idcert__split_fields)) idcert__split_fields3) (us_split_fields13 temp___2706)))))
