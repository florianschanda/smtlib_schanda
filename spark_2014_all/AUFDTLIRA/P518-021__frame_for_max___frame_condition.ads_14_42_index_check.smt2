...
(assert (= o113 i4))
(assert (= o114 (select (map__content a20) o113)))
(assert (= o115 (us_split_fields1 o114)))
(assert (= o116 (rec__frame_condition__cell__max_right o115)))
(assert (= o117 (to_rep o116)))
(assert (and (<= (to_rep1 a__first) j2) (<= j2 (to_rep1 a__last))))
(assert (= o109 j2))
(assert (= o110 (select (map__content a20) o109)))
(assert (= o111 (us_split_fields1 o110)))
(assert (= o112 (rec__frame_condition__cell__value o111)))
(assert (= o118 (to_rep o112)))
(assert (= o119 (ite (<= o118 o117) true false)))
