...
(define-fun dynamic_invariant1 ((temp___expr_178 us_rep) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool) (temp___do_typ_inv_177 Bool)) Bool (and (=> (= temp___do_toplevel_176 true) (=> (= temp___is_init_174 true) (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 temp___expr_178))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 temp___expr_178)))))) (let ((temp___180 (rec__integer_stacks__stack__capacity (us_split_discrs1 temp___expr_178)))) (and (dynamic_property1 1 (to_rep temp___180) (first1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_178))) (last1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_178)))) (and (= (first1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_178))) 1) (= (last1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_178))) (to_rep temp___180)))))))
(define-fun dynamic_predicate ((temp___182 us_rep)) Bool (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 temp___182))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 temp___182)))))
...
(define-fun dynamic_predicate1 ((temp___239 us_rep1)) Bool (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 (to_base temp___239)))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base temp___239))))))
...
(define-fun bool_eq8 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 a))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 b)))) (and (= (bool_eq7 (rec__integer_stacks__stack__values3 (us_split_fields7 a)) (rec__integer_stacks__stack__values3 (us_split_fields7 b))) true) (= (to_rep1 (rec__integer_stacks__stack__top3 (us_split_fields7 a))) (to_rep1 (rec__integer_stacks__stack__top3 (us_split_fields7 b)))))) true false))
...
(define-fun dynamic_invariant4 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_165)))
...
(define-fun dynamic_invariant5 ((temp___expr_262 us_rep3) (temp___is_init_258 Bool) (temp___skip_constant_259 Bool) (temp___do_toplevel_260 Bool) (temp___do_typ_inv_261 Bool)) Bool (and (and (=> (not (= temp___skip_constant_259 true)) (in_range7 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (to_base2 temp___expr_262))) (=> (= temp___do_toplevel_260 true) (=> (= temp___is_init_258 true) (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 (to_base2 temp___expr_262)))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base2 temp___expr_262)))))))) (and (dynamic_property7 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_262))) (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_262)))) (and (= (first7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_262))) 1) (= (last7 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_262))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))))
(define-fun default_initial_assumption ((temp___expr_266 us_rep3) (temp___skip_top_level_267 Bool)) Bool (and (and (= (attr__tag3 temp___expr_266) us_tag3) (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_266))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (= (to_rep1 (rec__integer_stacks__stack__top3 (us_split_fields7 temp___expr_266))) 0))) (=> (not (= temp___skip_top_level_267 true)) (= (empty (to_base2 temp___expr_266)) true))))
(define-fun dynamic_predicate2 ((temp___273 us_rep3)) Bool (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 (to_base2 temp___273)))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base2 temp___273))))))
...
(define-fun dynamic_invariant6 ((temp___expr_245 us_rep2) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool) (temp___do_typ_inv_244 Bool)) Bool (and (and (=> (not (= temp___skip_constant_242 true)) (in_range6 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (to_base1 temp___expr_245))) (=> (= temp___do_toplevel_243 true) (=> (= temp___is_init_241 true) (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 (to_base1 temp___expr_245)))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base1 temp___expr_245)))))))) (and (dynamic_property5 1 (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (first5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_245))) (last5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_245)))) (and (= (first5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_245))) 1) (= (last5 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_245))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right))))))))
(define-fun default_initial_assumption1 ((temp___expr_249 us_rep2) (temp___skip_top_level_250 Bool)) Bool (and (and (= (attr__tag2 temp___expr_249) us_tag2) (and (= (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_249))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 right)))) (= (to_rep1 (rec__integer_stacks__stack__top2 (us_split_fields5 temp___expr_249))) 0))) (=> (not (= temp___skip_top_level_250 true)) (= (empty (to_base1 temp___expr_249)) true))))
(define-fun dynamic_predicate3 ((temp___256 us_rep2)) Bool (<= (to_rep1 (rec__integer_stacks__stack__top (us_split_fields1 (to_base1 temp___256)))) (to_rep (rec__integer_stacks__stack__capacity (us_split_discrs1 (to_base1 temp___256))))))
...
(declare-const temp___305 positive)
(declare-const temp___3051 (Array Int element))
(declare-const temp___3052 t)
(declare-const temp___3053 natural)
(declare-const temp___3054 us_private)
(declare-const temp___3055 Int)
...
(declare-const temp___307 positive)
(declare-const temp___3071 (Array Int element))
(declare-const temp___3072 t)
(declare-const temp___3073 natural)
(declare-const temp___3074 us_private)
(declare-const temp___3075 Int)
...
(define-fun temp___3056 () us_rep (mk___rep (mk___split_discrs temp___305) (mk___split_fields (mk___t temp___3051 temp___3052) temp___3053 temp___3054) temp___3055))
...
(assert (= (to_rep (rec__integer_stacks__stack__capacity this__split_discrs)) r19b))
(assert (in_range1 r19b))
(assert (= (to_rep (rec__integer_stacks__stack__capacity this__split_discrs)) r22b))
(assert (in_range1 r22b))
(assert (dynamic_predicate1 (mk___rep1 (mk___split_discrs (rec__integer_stacks__stack__capacity this__split_discrs)) (mk___split_fields1 (mk___t1 o o1) rliteral us_null_ext__) us_tag1)))
(assert (= (rec__integer_stacks__stack__capacity this__split_discrs) o2))
(assert (= o3 o))
(assert (= o4 o1))
(assert (= rliteral o5))
(assert (= us_null_ext__ o6))
(assert (= us_tag1 o7))
(assert (= temp___3056 (to_base (mk___rep1 (mk___split_discrs o2) (mk___split_fields1 (mk___t1 o3 o4) o5 o6) o7))))
(assert (= temp___305 (rec__integer_stacks__stack__capacity this__split_discrs)))
(assert (= (mk___rep (mk___split_discrs usq_) (mk___split_fields (mk___t usq_1 usq_2) usq_3 usq_4) usq_5) temp___3056))
(assert (= usq_ temp___307))
(assert (= usq_1 temp___3071))
(assert (= usq_2 temp___3072))
(assert (= usq_3 temp___3073))
(assert (= usq_4 temp___3074))
(assert (= this__attr__tag temp___3075))
...
(assert (= this__split_fields4 (mk___split_fields (mk___t temp___3071 temp___3072) temp___3073 temp___3074)))
(assert (= this__split_discrs (mk___split_discrs temp___307)))
