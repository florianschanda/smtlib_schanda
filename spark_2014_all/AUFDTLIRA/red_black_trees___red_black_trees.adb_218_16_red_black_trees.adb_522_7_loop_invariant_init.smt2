...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (not (= i (root (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields34))))) (or (= (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields34)) i) 0) (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields__content4 t__split_fields34)) (parent (rec__red_black_trees__rbt__struct (us_split_fields__content4 t__split_fields34)) i))) 1))) (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields__content4 t__split_fields34)) i)) 0)))))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c114b))) i))) true))
(assert (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c114b) i)))) (let ((subject n7)) n87)))
(assert (not (= i (root (rec__red_black_trees__rbt__struct (us_split_fields9 c115b))))))
(assert (not (= (eq (select (nb_blacks c115b) i) (select (nb_blacks c114b) i)) true)))
(check-sat)
(exit)
