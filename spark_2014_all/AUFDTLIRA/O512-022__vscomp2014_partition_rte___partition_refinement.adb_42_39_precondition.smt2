...
(declare-const temp___1260 us_rep5)
...
(assert (forall ((c1 us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c1) true) (=> (= (key (mk___rep d__split_discrs d__split_fields2) c1) (to_rep (select a1 j))) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c1))) (key (mk___rep d__split_discrs d__split_fields2) c1))))))
(assert (forall ((c1 us_rep1)) (=> (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields2)) c1) true) (= (to_rep (select a1 (element (mk___rep d__split_discrs d__split_fields2) c1))) (key (mk___rep d__split_discrs d__split_fields2) c1)))))
(assert (and (= o (+ (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields3)) 1)) (in_range2 (+ (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields3)) 1))))
(assert (= (to_rep1 o1) o))
(assert (= o2 (mk___split_fields2 (rec__partition_refinement__interval__first p_elem__split_fields3) (rec__partition_refinement__interval__last p_elem__split_fields3) o1)))
(assert (= temp___1260 (mk___rep2 o2)))
(assert (= result3 (mk___split_fields__ref2 p_elem__split_fields3)))
(assert (= p_elem__split_fields4 (us_split_fields5 temp___1260)))
(assert (and (and (= (length3 (mk___rep3 p__split_discrs partition_refinement__partitions__replace_element__container__fields)) (length3 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) (= (bool_eq6 (get3 (model__1 (mk___rep3 p__split_discrs partition_refinement__partitions__replace_element__container__fields)) (to_rep4 (select f i))) (mk___rep2 p_elem__split_fields4)) true)) (= (equal_except1 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) (model__1 (mk___rep3 p__split_discrs partition_refinement__partitions__replace_element__container__fields)) (to_rep4 (select f i))) true)))
(assert (= result4 (mk___split_fields__ref3 (mk___split_fields3 p__split_fields))))
...
(assert (= p_elem__split_fields5 (mk___split_fields__ref2 p_elem__split_fields4)))
...
(assert (= a3 a1))
(assert (= (= result5 true) (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select (map__content a2) k)) (ite (= k (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (to_rep (select a (+ (to_rep2 (rec__partition_refinement__interval__first (us_split_fields5 (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) (to_rep4 (select f (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem))))))) (to_rep1 (rec__partition_refinement__interval__count (us_split_fields5 (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) (to_rep4 (select f (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))))))) (ite (= k (+ (to_rep2 (rec__partition_refinement__interval__first (us_split_fields5 (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) (to_rep4 (select f (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem))))))) (to_rep1 (rec__partition_refinement__interval__count (us_split_fields5 (get3 (model__1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields))) (to_rep4 (select f (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem))))))))) (to_rep (select a (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem))) (to_rep (select a k)))))))))
(assert (= result5 true))
(assert (and (= o7 (capacity (mk___rep3 p__split_discrs (us_split_fields__content3 p__split_fields2)))) (and (in_range10 o7) (= o7 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (= result6 (ite (= o7 (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) true false)))
(assert (= result6 true))
(assert (and (= o6 (length3 (mk___rep3 p__split_discrs (us_split_fields__content3 p__split_fields2)))) (and (in_range10 o6) (<= o6 (capacity (mk___rep3 p__split_discrs (us_split_fields__content3 p__split_fields2)))))))
(assert (= result7 (ite (= o6 (length3 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) true false)))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key (model__ (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) (to_rep (select (map__content a2) j1))) true)))))
(assert (= result8 true))
(assert (and (= o3 (has_key1 (positions (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) c)) (= (= o3 true) (= (has_key1 (positions (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) c) true))))
(assert (= o4 true))
(assert (= result9 (ite (= o4 true) o3 false)))
(assert (= result9 true))
(assert (and (= o5 (key (mk___rep d__split_discrs (us_split_fields__content d__split_fields3)) c)) (and (in_range7 o5) (= o5 (get (keys (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) (get1 (positions (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) c))))))
(assert (not (= (has_key1 (positions (mk___rep d__split_discrs (us_split_fields__content d__split_fields3))) c) true)))
(check-sat)
(exit)
