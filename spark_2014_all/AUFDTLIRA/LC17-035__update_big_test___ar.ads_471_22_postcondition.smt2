...
(assert (= a4 a2))
(assert (not (or (and (< k 16) (or (and (< 0 e) (= (bool_eq2 a3 1 16 (temp___1534 a k (temp___1542 (select a k) j (temp___1549 (select (select a k) j) i e)) (+ k 1) (temp___1557 (select a (+ k 1)) j (temp___1564 (select (select a (+ k 1)) j) i (- e 1)))) 1 16) true)) (and (= e 0) (= (bool_eq2 a3 1 16 (temp___1573 a k (temp___1581 (select a k) j (temp___1588 (select (select a k) j) i e)) (+ k 1) (temp___1596 (select a (+ k 1)) j (temp___1603 (select (select a (+ k 1)) j) i 99))) 1 16) true)))) (and (= k 16) (or (and (< 0 e) (= (bool_eq2 a3 1 16 (temp___1612 a k (temp___1620 (select a k) j (temp___1627 (select (select a k) j) i e)) 1 (temp___1635 (select a 1) j (temp___1642 (select (select a 1) j) i (- e 1)))) 1 16) true)) (and (= e 0) (= (bool_eq2 a3 1 16 (temp___1651 a k (temp___1659 (select a k) j (temp___1666 (select (select a k) j) i e)) 1 (temp___1674 (select a 1) j (temp___1681 (select (select a 1) j) i 99))) 1 16) true)))))))
(check-sat)
(exit)
