...
(assert (= o6 (elts (rec__record_discr__interm_result__to_search (us_split_fields3 r)))))
(assert (= o6 temp___265))
(assert (= (mk2 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) temp___2651))
(assert (not (= (ite (<= (to_rep1 (first4 temp___2651)) (to_rep1 (last4 temp___2651))) (+ (- (to_rep1 (last4 temp___2651)) (to_rep1 (first4 temp___2651))) 1) 0) (ite (<= 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (+ (- (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1) 1) 1) 0))))
(check-sat)
(exit)
