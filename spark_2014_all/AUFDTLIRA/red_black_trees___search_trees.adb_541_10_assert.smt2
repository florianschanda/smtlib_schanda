...
(assert (<= 1 j2))
(assert (<= j2 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) i2))) true))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f1 root) j2))) true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f1 root) j2)))) true))
(assert (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f2 root) i2))) true)))
(check-sat)
(exit)
