...
(assert (and (and (=> (<= 1 10) (in_range4 n2)) (forall ((temp___144 Int)) (=> (and (<= 1 temp___144) (<= temp___144 10)) (=> (< n2 temp___144) (= (select arr3 temp___144) (select arr temp___144)))))) (and (<= 1 n2) (<= n2 10))))
(assert (not (= n2 10)))
(assert (= n2 result2))
(assert (= n3 (+ n2 1)))
