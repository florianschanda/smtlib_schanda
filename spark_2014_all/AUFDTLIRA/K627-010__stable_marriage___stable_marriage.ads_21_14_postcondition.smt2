...
(assert (= (= (bool_eq1 seen6 1 64 (temp___448 (distinct 1 0)) 1 64) true) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (and (= (select seen6 g1) true) (exists ((rank10 Int)) (and (and (<= 1 rank10) (<= rank10 64)) (= (to_rep (select r1 rank10)) g1))))))))
...
(assert (= stable_marriage__is_permutation_1__result1 (bool_eq1 seen6 1 64 (temp___454 (distinct 1 0)) 1 64)))
