...
(assert (and (and (and (= (mk_map__ref1 result) (mk_map__ref1 seen)) (= seen1 (stable_marriage__is_permutation_1__seen__aggregate_def (of_int 0)))) (and (and (and (= (mk_int__ref result1) (mk_int__ref rank)) (= rank1 1)) (ite (and (<= 1 rank1) (<= rank1 64)) (and (and (and (= temp___403 rank1) (and (= temp___401 seen1) (and (forall ((g11 Int)) (=> (and (<= 1 g11) (<= g11 64)) (= (= (select seen2 g11) true) (exists ((prev1 Int)) (and (and (<= 1 prev1) (<= prev1 (- rank2 1))) (= (to_rep (select r1 prev1)) g11)))))) (and (and (=> (<= 1 64) (in_range2 rank2)) (and (<= 1 rank2) (<= rank2 64))) (and (and (= seen2 result2) (= seen3 (store seen2 (to_rep (select r1 rank2)) (of_int 1)))) (= rank2 64)))))) (and (and (= rank2 rank6) (= seen3 seen6)) (and (= rank7 rank2) (= seen7 seen3)))) (and (and (= (mk_int__ref rank8) (mk_int__ref rank6)) (= (mk_map__ref1 seen8) (mk_map__ref1 seen6))) (and (= rank9 rank7) (= seen9 seen7)))) (and (and (= rank1 rank8) (= seen1 seen8)) (and (= rank9 rank1) (= seen9 seen1))))) (and (= (= (bool_eq1 seen8 1 64 (temp___406 (of_int 1)) 1 64) true) (forall ((g11 Int)) (=> (and (<= 1 g11) (<= g11 64)) (and (= (select seen8 g11) true) (exists ((rank12 Int)) (and (and (<= 1 rank12) (<= rank12 64)) (= (to_rep (select r1 rank12)) g11))))))) (and (and (= stable_marriage__is_permutation_1__result1 stable_marriage__is_permutation_1__result2) (= stable_marriage__is_permutation_1__result3 stable_marriage__is_permutation_1__result1)) (and (= result4 stable_marriage__is_permutation_1__result) (= stable_marriage__is_permutation_1__result1 (bool_eq1 seen8 1 64 (temp___412 (of_int 1)) 1 64))))))) (and (and (= (mk_bool__ref stable_marriage__is_permutation_1__result4) (mk_bool__ref stable_marriage__is_permutation_1__result2)) (and (= (mk_int__ref rank10) (mk_int__ref rank8)) (= (mk_map__ref1 seen10) (mk_map__ref1 seen8)))) (and (= stable_marriage__is_permutation_1__result5 stable_marriage__is_permutation_1__result3) (and (= rank11 rank9) (= seen11 seen9))))))
(assert (= result5 stable_marriage__is_permutation_1__result4))
(assert (= stable_marriage__is_permutation_1__result4 true))
(declare-const g11 Int)
(assert (<= 1 g11))
(assert (<= g11 64))
(assert (not (exists ((rank12 Int)) (and (and (<= 1 rank12) (<= rank12 64)) (= (to_rep (select r1 rank12)) g11)))))
(check-sat)
(exit)
