...
(assert (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (exists ((rank10 Int)) (and (and (<= 1 rank10) (<= rank10 64)) (= (to_rep (select r1 rank10)) g1))))))
(assert (not (= stable_marriage__is_permutation_1__result4 true)))
(check-sat)
(exit)
