...
(assert (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt r2))) i2) (<= i2 30)) (= (of_int (to_rep (select (elts r2) i2))) true))))
(assert (<= 31 i1))
(assert (<= i1 (to_rep1 (last (rt r2)))))
(assert (not (<= (to_rep1 (first (rt r2))) i1)))
(check-sat)
(exit)
