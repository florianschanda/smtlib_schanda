...
(declare-fun temp___3072 ((Array Int et1) Int Int) (Array Int et1))
...
(assert (not (= (bool_eq r__split_fields4 1 10 (temp___3072 r__split_fields i e) 1 10) true)))
(check-sat)
(exit)
