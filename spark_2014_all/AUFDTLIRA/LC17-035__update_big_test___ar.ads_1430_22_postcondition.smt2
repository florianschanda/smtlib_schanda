...
(declare-fun temp___3013 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3015 (Array Int et1))) (forall ((temp___3016 Int) (temp___3017 Int)) (let ((temp___3014 (temp___3013 temp___3015 temp___3016 temp___3017))) (forall ((temp___3018 Int)) (ite (= temp___3018 temp___3016) (= (select temp___3014 temp___3018) (of_rep temp___3017)) (= (select temp___3014 temp___3018) (select temp___3015 temp___3018))))))))
...
(declare-const temp___7897 (Array Int et1))
(declare-const temp___78971 enum2t)
...
(assert (= temp___7897 o2))
(assert (= temp___78971 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___7897 r__split_fields2))
(assert (= temp___78971 r__split_fields3))
...
(assert (not (= (bool_eq r__split_fields4 1 10 (temp___3013 r__split_fields i e) 1 10) true)))
(check-sat)
(exit)
