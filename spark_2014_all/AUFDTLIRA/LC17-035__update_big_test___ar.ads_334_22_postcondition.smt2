...
(assert (= (bool_eq1 a1 5 50 (temp___4698 t j (temp___4704 (select t j) i e)) 5 50) true))
...
(assert (= a4 a2))
(assert (not (or (and (< j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp___1026 a j (temp___1034 (select a j) i e) (+ j 1) (temp___1041 (select a (+ j 1)) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp___1049 a j (temp___1057 (select a j) i e) (+ j 1) (temp___1064 (select a (+ j 1)) i 99)) 5 50) true)))) (and (= j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp___1072 a j (temp___1080 (select a j) i e) 5 (temp___1087 (select a 5) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp___1095 a j (temp___1103 (select a j) i e) 5 (temp___1110 (select a 5) i 99)) 5 50) true)))))))
(check-sat)
(exit)
