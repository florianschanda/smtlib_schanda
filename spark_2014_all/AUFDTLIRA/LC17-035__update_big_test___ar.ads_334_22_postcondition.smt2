...
(assert (not (or (and (< j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp___967 a j (temp___975 (select a j) i e) (+ j 1) (temp___982 (select a (+ j 1)) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp___990 a j (temp___998 (select a j) i e) (+ j 1) (temp___1005 (select a (+ j 1)) i 99)) 5 50) true)))) (and (= j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp___1013 a j (temp___1021 (select a j) i e) 5 (temp___1028 (select a 5) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp___1036 a j (temp___1044 (select a j) i e) 5 (temp___1051 (select a 5) i 99)) 5 50) true)))))))
(check-sat)
(exit)
