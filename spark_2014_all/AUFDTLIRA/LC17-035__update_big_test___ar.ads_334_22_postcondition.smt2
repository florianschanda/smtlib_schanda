...
(assert (= a4 a2))
(assert (not (or (and (< j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp_____aggregate_def_1026 a j (temp_____aggregate_def_1034 (select a j) i e) (+ j 1) (temp_____aggregate_def_1041 (select a (+ j 1)) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp_____aggregate_def_1049 a j (temp_____aggregate_def_1057 (select a j) i e) (+ j 1) (temp_____aggregate_def_1064 (select a (+ j 1)) i 99)) 5 50) true)))) (and (= j 50) (or (and (< 0 e) (= (bool_eq1 a3 5 50 (temp_____aggregate_def_1072 a j (temp_____aggregate_def_1080 (select a j) i e) 5 (temp_____aggregate_def_1087 (select a 5) i (- e 1))) 5 50) true)) (and (= e 0) (= (bool_eq1 a3 5 50 (temp_____aggregate_def_1095 a j (temp_____aggregate_def_1103 (select a j) i e) 5 (temp_____aggregate_def_1110 (select a 5) i 99)) 5 50) true)))))))
(check-sat)
(exit)
