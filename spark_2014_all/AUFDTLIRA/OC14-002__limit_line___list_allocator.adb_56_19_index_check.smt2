...
(assert (=> (not (= first_available 0)) (and (= o23 (length model____split_fields)) (in_range6 o23))))
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o23) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o22 (get model____split_fields 1)) (in_range7 o22)))))
...
(assert (=> (not (not (= first_available 0))) (and (= o24 (length model____split_fields)) (in_range6 o24))))
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o24 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o20 (length model____split_fields1)) (in_range6 o20)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o20) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o19 (get model____split_fields1 1)) (in_range7 o19))))))
...
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o21 (length model____split_fields1)) (in_range6 o21)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o21 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o17 (length model____split_fields)) (in_range6 o17))))
...
(assert (=> (= result8 true) (and (= o12 (length model____split_fields1)) (in_range6 o12))))
(assert (=> (= result8 true) (= result9 (ite (< j o12) true false))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o13 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o14 (get model____split_fields1 o13)) (in_range7 o14)))))
...
(assert (=> (< 1 j) (and (= o3 (get model____split_fields1 o2)) (in_range7 o3))))
(assert (=> (not (< 1 j)) (= o3 0)))
(assert (and (= temp___388 (get model____split_fields1 j)) (in_range7 temp___388)))
(assert (not (<= 1 temp___388)))
(check-sat)
(exit)
