...
(declare-fun temp___283 (Int) (Array Int one_ten))
...
(define-fun dynamic_invariant1 ((temp___expr_168 Int) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool) (temp___do_typ_inv_167 Bool)) Bool (=> (or (= temp___is_init_164 true) (<= 1 10)) (in_range1 temp___expr_168)))
(assert (forall ((temp___285 Int)) (=> (dynamic_invariant1 temp___285 true true true true) (forall ((temp___286 Int)) (= (to_rep (select (temp___283 temp___285) temp___286)) temp___285)))))
(define-fun dynamic_invariant2 ((temp___expr_195 us_t) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool) (temp___do_typ_inv_194 Bool)) Bool (=> (not (= temp___skip_constant_192 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_195) (last1 temp___expr_195))))
