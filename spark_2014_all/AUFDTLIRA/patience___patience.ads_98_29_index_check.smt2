...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o15 i))
(assert (= temp___477 (select (rec__patience__state__stacks (us_split_fields1 s)) o15)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o16 k))
...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o12 i))
(assert (= temp___473 (select (rec__patience__state__stacks (us_split_fields1 s)) o12)))
(assert (and (<= 0 j) (<= j 99)))
(assert (= o13 j))
