...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o43 i1))
(assert (= temp___473 (select (rec__patience__state__stacks (us_split_fields1 s)) o43)))
(assert (and (<= 0 j) (<= j 99)))
(assert (= o44 j))
(assert (= o45 (select temp___473 o44)))
(assert (= temp___474 (to_rep1 o45)))
(assert (not (<= 0 temp___474)))
(check-sat)
(exit)
