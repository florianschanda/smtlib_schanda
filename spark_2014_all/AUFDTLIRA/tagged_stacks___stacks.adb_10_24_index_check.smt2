...
(declare-const dummy6 (Array Int element))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (bool_eq (rec__stacks__stack_root__content (us_split_fields1 a)) 1 100 (rec__stacks__stack_root__content (us_split_fields1 b)) 1 100) true) (= (to_rep (rec__stacks__stack_root__length (us_split_fields1 a))) (to_rep (rec__stacks__stack_root__length (us_split_fields1 b))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_290 us_rep) (temp___skip_top_level_291 Bool)) Bool (and (and (= (attr__tag temp___expr_290) us_tag1) (and (= (rec__stacks__stack_root__content (us_split_fields1 temp___expr_290)) (temp___187 0)) (= (to_rep (rec__stacks__stack_root__length (us_split_fields1 temp___expr_290))) 0))) (=> (not (= temp___skip_top_level_291 true)) (= (size temp___expr_290) 0))))
...
(declare-datatypes () ((t41s__ref (mk_t41s__ref (t41s__content us_t1)))))
(define-fun t41s__ref___projection ((a t41s__ref)) us_t1 (t41s__content a))
(define-fun dynamic_invariant1 ((temp___expr_46 Int) (temp___is_init_42 Bool) (temp___skip_constant_43 Bool) (temp___do_toplevel_44 Bool) (temp___do_typ_inv_45 Bool)) Bool (=> (or (= temp___is_init_42 true) (<= 1 2147483647)) (in_range4 temp___expr_46)))
...
(define-fun dynamic_invariant3 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 100)) (in_range temp___expr_159)))
...
(declare-fun user_eq11 (positive_less_than_max positive_less_than_max) Bool)
(declare-const dummy11 positive_less_than_max)
...
(assert (forall ((first4 positive_less_than_max)) (forall ((rec__ext__2 us_private)) (= (extract__first (hide_ext__ first4 rec__ext__2)) first4))))
...
(assert (forall ((s us_rep)) (! (let ((result (get_model__2 s))) (and (and (= (length result) (size s)) (and (in_range (last1 result)) (in_range (first1 result)))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__2 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep)) (! (let ((result (get_model__21 attr__tag2 s))) (and (and (= (length result) (size s)) (and (in_range (last1 result)) (in_range (first1 result)))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__21 attr__tag2 s))))))
...
(assert (forall ((s us_rep)) (! (=> (not (= (is_empty s) true)) (let ((result (peek__2 s))) (and (and (= result (to_rep1 (let ((temp___320 (get_model__2 s))) (select (to_array temp___320) (last1 (get_model__2 s)))))) (not (= (is_empty s) true))) (dynamic_invariant result true false true true)))) :pattern ((peek__2 s)))))
...
(assert (forall ((s us_rep)) (! (= (peek__2 s) (to_rep1 (let ((temp___322 (rec__stacks__stack_root__content (us_split_fields1 s)))) (select temp___322 (to_rep (rec__stacks__stack_root__length (us_split_fields1 s))))))) :pattern ((peek__2 s)))))
...
(define-fun dynamic_property5 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range2 low) (in_range2 high))))))
...
(declare-fun last8 (us_rep1) Int)
(declare-fun last__function_guard (Int us_rep1) Bool)
(declare-fun last9 (Int us_rep1) Int)
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range3 f) (=> (in_range3 l) (and (= (to_rep2 (first10 (mk5 f l))) f) (= (to_rep2 (last12 (mk5 f l))) l)))) :pattern ((mk5 f l)))))
(define-fun dynamic_property9 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (dynamic_property8 range_first range_last low) (dynamic_property8 range_first range_last high))))))
...
(define-fun bool_eq8 ((x us_t5) (y us_t5)) Bool (bool_eq (elts5 x) (to_rep2 (first10 (rt5 x))) (to_rep2 (last12 (rt5 x))) (elts5 y) (to_rep2 (first10 (rt5 y))) (to_rep2 (last12 (rt5 y)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range3 f) (=> (in_range3 l) (and (= (to_rep2 (first12 (mk6 f l))) f) (= (to_rep2 (last14 (mk6 f l))) l)))) :pattern ((mk6 f l)))))
(define-fun dynamic_property11 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (dynamic_property10 range_first range_last low) (dynamic_property10 range_first range_last high))))))
...
(define-fun bool_eq9 ((x us_t6) (y us_t6)) Bool (bool_eq (elts6 x) (to_rep2 (first12 (rt6 x))) (to_rep2 (last14 (rt6 x))) (elts6 y) (to_rep2 (first12 (rt6 y))) (to_rep2 (last14 (rt6 y)))))
...
(assert (forall ((s us_rep1)) (! (let ((result (get_model__3 s))) (and (and (in_range (first1 result)) (and (in_range (last1 result)) (= (length result) (size (to_base s))))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__3 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (let ((result (get_model__31 attr__tag2 s))) (and (and (in_range (first1 result)) (and (in_range (last1 result)) (= (length result) (size (to_base s))))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__31 attr__tag2 s))))))
(assert (forall ((s us_rep1)) (! (= (get_model__3 s) (get_model__31 us_tag2 s)) :pattern ((get_model__31 us_tag2 s)))))
(assert (forall ((s us_rep1)) (! (= (get_model__3 s) (ite (= (wraps_around s) true) (let ((stacks__get_model__3__R86s (last8 s))) (let ((temp___413 (let ((temp___412 (let ((temp___409 1)) (let ((temp___410 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (of_array5 temp___410 temp___409 stacks__get_model__3__R86s))))) (let ((temp___411 (let ((temp___407 100)) (let ((temp___406 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))))) (let ((temp___408 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (of_array4 temp___408 temp___406 temp___407)))))) (ite (= (length4 temp___411) 0) (of_array3 (to_array5 temp___412) (first11 temp___412) (last13 temp___412)) (of_array3 (slide (concat1 (to_array4 temp___411) (first9 temp___411) (last11 temp___411) (to_array5 temp___412) (first11 temp___412) (last13 temp___412)) (first9 temp___411) 1) 1 (- (+ 1 (+ (ite (<= (first9 temp___411) (last11 temp___411)) (+ (- (last11 temp___411) (first9 temp___411)) 1) 0) (ite (<= (first11 temp___412) (last13 temp___412)) (+ (- (last13 temp___412) (first11 temp___412)) 1) 0))) 1))))))) (of_array (to_array3 temp___413) (first7 temp___413) (last7 temp___413)))) (let ((stacks__get_model__3__R89s (last8 s))) (let ((temp___416 (let ((temp___414 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))))) (let ((temp___415 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (of_array6 temp___415 temp___414 stacks__get_model__3__R89s))))) (of_array (to_array6 temp___416) (first13 temp___416) (last15 temp___416)))))) :pattern ((get_model__3 s)))))
(assert (forall ((s us_rep1)) (! (=> (not (= (is_empty (to_base s)) true)) (let ((result (peek__3 s))) (and (and (not (= (is_empty (to_base s)) true)) (= result (to_rep1 (let ((temp___437 (get_model__3 s))) (select (to_array temp___437) (last1 (get_model__3 s))))))) (dynamic_invariant result true false true true)))) :pattern ((peek__3 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (=> (not (= (is_empty (to_base s)) true)) (let ((result (peek__31 attr__tag2 s))) (and (and (not (= (is_empty (to_base s)) true)) (= result (to_rep1 (let ((temp___436 (get_model__31 (attr__tag1 s) s))) (select (to_array temp___436) (last1 (get_model__31 (attr__tag1 s) s))))))) (dynamic_invariant result true false true true)))) :pattern ((peek__31 attr__tag2 s))))))
(assert (forall ((s us_rep1)) (! (= (peek__3 s) (peek__31 us_tag2 s)) :pattern ((peek__31 us_tag2 s)))))
(assert (forall ((s us_rep1)) (! (= (peek__3 s) (to_rep1 (let ((temp___439 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (select temp___439 (last8 s))))) :pattern ((peek__3 s)))))
(assert (forall ((temp___189 Int)) (=> (dynamic_invariant temp___189 true true true true) (forall ((temp___190 Int)) (= (to_rep1 (select (temp___187 temp___189) temp___190)) temp___189)))))
...
(assert (forall ((s us_rep1)) (! (= (= (wraps_around s) true) (< 100 (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1))) :pattern ((wraps_around s)))))
(assert (forall ((s us_rep1)) (! (dynamic_invariant3 (last8 s) true false true true) :pattern ((last8 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (dynamic_invariant3 (last9 attr__tag2 s) true false true true) :pattern ((last9 attr__tag2 s))))))
(assert (forall ((s us_rep1)) (! (= (last8 s) (last9 us_tag2 s)) :pattern ((last9 us_tag2 s)))))
(assert (forall ((s us_rep1)) (! (= (last8 s) (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100))) :pattern ((last8 s)))))
...
(assert (not (= (is_empty (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag)) true)))
(assert (not (<= 1 (to_rep s__split_fields1))))
(check-sat)
(exit)
