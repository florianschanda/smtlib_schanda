...
(assert (= hr7 o46))
(assert (and (= o50 y) (in_range5 y)))
(assert (and (= o47 x) (in_range5 x)))
(assert (and (= (mk___t o48 o49) (remove (mk___t values2 (mk 1 100)) o47)) (and (dynamic_invariant4 (mk___t o48 o49) true false true) (and (= (invariant__ (mk___t o48 o49)) true) (and (= (to_rep1 (last o49)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o47 1))) (= (to_rep (select values2 k)) (to_rep (select o48 k))))) (and (forall ((k Int)) (=> (and (<= (+ o47 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o48 (- k 1)))))) (forall ((k Int)) (=> (and (<= o47 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o48 k))))))))))))
(assert (and (= temp___254 (remove (mk___t o48 o49) o50)) (and (dynamic_invariant4 temp___254 true false true) (and (= (invariant__ temp___254) true) (and (= (to_rep1 (last (rt temp___254))) (- (to_rep1 (last o49)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o50 1))) (= (to_rep (select o48 k)) (to_rep (select (elts temp___254) k))))) (and (forall ((k Int)) (=> (and (<= (+ o50 1) k) (<= k (to_rep1 (last o49)))) (= (to_rep (select o48 k)) (to_rep (select (elts temp___254) (- k 1)))))) (forall ((k Int)) (=> (and (<= o50 k) (<= k (- (to_rep1 (last o49)) 1))) (= (to_rep (select o48 (+ k 1))) (to_rep (select (elts temp___254) k))))))))))))
(assert (and (= o53 y) (in_range5 y)))
