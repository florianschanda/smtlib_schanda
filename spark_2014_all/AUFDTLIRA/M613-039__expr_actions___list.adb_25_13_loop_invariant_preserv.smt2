...
(assert (not (= i4 last3)))
(assert (= result2 (mk_int__ref i4)))
(assert (= i5 (+ i4 1)))
(assert (and (= o10 i5) (in_range4 i5)))
(assert (and (= o11 (get (model__ l) o10)) (and (in_range7 o11) (= o11 (get (model__ l) o10)))))
(assert (and (= (top (mk___rep s__split_fields5)) o11) (= (let ((temp___181 (to__ (mk___rep s__split_fields4)))) (let ((temp___180 (to_but_top (mk___rep s__split_fields5)))) (bool_eq (elts temp___180) (to_rep (first (rt temp___180))) (to_rep (last (rt temp___180))) (elts temp___181) (to_rep (first (rt temp___181))) (to_rep (last (rt temp___181)))))) true)))
(assert (not (= (to_rep (last (rt (to__ (mk___rep s__split_fields5))))) (+ (- i5 first2) 1))))
(check-sat)
(exit)
