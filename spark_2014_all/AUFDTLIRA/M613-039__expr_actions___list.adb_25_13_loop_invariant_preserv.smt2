...
(assert (and (= (top (mk___rep s__split_fields4)) o3) (= (let ((temp___181 (to__ (mk___rep s__split_fields3)))) (let ((temp___180 (to_but_top (mk___rep s__split_fields4)))) (bool_eq (elts temp___180) (to_rep (first (rt temp___180))) (to_rep (last (rt temp___180))) (elts temp___181) (to_rep (first (rt temp___181))) (to_rep (last (rt temp___181)))))) true)))
