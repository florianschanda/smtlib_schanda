...
(define-fun dynamic_invariant1 ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_596)))
...
(assert true)
(assert (forall ((a1 us_rep)) (! (= (= (empty a1) true) (< (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a1))) 1)) :pattern ((empty a1)))))
...
(define-fun t26b__ref___projection ((a1 t26b__ref)) integer (t26b__content a1))
...
(assert (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) 1) (<= 1 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))))
(assert (= o 1))
...
(assert (= (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) r25b))
(assert (in_range1 r25b))
(assert (= (mk_int__ref result1) (mk_int__ref i)))
(assert (= i1 2))
(assert (<= 2 i1))
(assert (<= i1 r25b))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (<= res2 (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j))))))
(assert (and (and (=> (<= 2 r25b) (dynamic_property2 2 r25b i2)) (=> (<= (- 2147483648) 2147483647) (in_range2 res2))) (and (<= 2 i2) (<= i2 r25b))))
...
(assert (= result2 (ite (< o5 res2) true false)))
(assert (= result2 true))
(assert (not (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2)))
(check-sat)
(exit)
