...
(assert (= result4 true))
(assert (= (= result5 true) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep (select (elts a) k)) (to_rep (select perm__remove__result8 k)))))))
(assert (= result5 true))
(assert (= (= result6 true) (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select perm__remove__result8 (- k 1))))))))
(assert (= result6 true))
