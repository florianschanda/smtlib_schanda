...
(declare-const temp___947 natural_index)
(declare-const temp___950 (Array Int character))
(declare-const temp___9501 t3)
...
(assert (= capacity (to_rep1 temp___947)))
...
(assert (= (mk___t3 temp___950 temp___9501) (temp_____aggregate_def_530 32 1 capacity)))
(assert (not (= (ite (<= (to_rep2 (first6 temp___9501)) (to_rep2 (last6 temp___9501))) (+ (- (to_rep2 (last6 temp___9501)) (to_rep2 (first6 temp___9501))) 1) 0) (ite (<= 1 capacity) (+ (- capacity 1) 1) 0))))
(check-sat)
(exit)
