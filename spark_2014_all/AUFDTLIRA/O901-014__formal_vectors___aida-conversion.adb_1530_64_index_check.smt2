...
(assert (and (<= (to_rep1 (first (rt source))) temp___1967) (<= temp___1967 (to_rep1 (last (rt source))))))
(assert (= o4 temp___1967))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 49) true false)))
(assert (and (= temp___1966 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1966) (<= temp___1966 (to_rep1 (last (rt source))))))
(assert (= o temp___1966))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 50) true false)))
(assert (and (= temp___1965 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1965)))
(check-sat)
(exit)
