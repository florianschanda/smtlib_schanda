...
(declare-const temp___2067 Int)
(declare-const temp___2068 Int)
(declare-const o Int)
...
(assert (= (= o28 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 6) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
...
(assert (and (<= (to_rep1 (first (rt source))) temp___2069) (<= temp___2069 (to_rep1 (last (rt source))))))
(assert (= o4 temp___2069))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 49) true false)))
(assert (and (= temp___2068 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2068) (<= temp___2068 (to_rep1 (last (rt source))))))
(assert (= o temp___2068))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 50) true false)))
(assert (and (= temp___2067 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (not (<= (to_rep1 (first (rt source))) temp___2067)))
(check-sat)
(exit)
