...
(assert (=> (<= i1 temp___307) (and (and (<= (to_rep1 (first (rt haystack))) i1) (<= i1 (to_rep1 (last (rt haystack))))) (and (<= (to_rep1 (first (rt haystack))) temp___307) (<= temp___307 (to_rep1 (last (rt haystack))))))))
(assert (= o7 (elts haystack)))
(assert (= o7 temp___308))
(assert (= (mk1 i1 temp___307) temp___3081))
(assert (= result1 (bool_eq (elts needle) (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) temp___308 (to_rep1 (first2 temp___3081)) (to_rep1 (last2 temp___3081)))))
...
(assert (not (= i2 temp___311)))
(assert (= i2 result2))
(assert (= i3 (+ i2 1)))
(assert (and (= o8 (- (to_rep1 (last (rt needle))) 1)) (in_range1 (- (to_rep1 (last (rt needle))) 1))))
(assert (= o9 (+ i3 o8)))
(assert (and (= temp___3071 o9) (in_range1 o9)))
(assert (=> (<= i3 temp___3071) (and (and (<= (to_rep1 (first (rt haystack))) i3) (<= i3 (to_rep1 (last (rt haystack))))) (and (<= (to_rep1 (first (rt haystack))) temp___3071) (<= temp___3071 (to_rep1 (last (rt haystack))))))))
(assert (= o10 (elts haystack)))
(assert (= o10 temp___3082))
(assert (= (mk1 i3 temp___3071) temp___3083))
(assert (= result3 (bool_eq (elts needle) (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) temp___3082 (to_rep1 (first2 temp___3083)) (to_rep1 (last2 temp___3083)))))
