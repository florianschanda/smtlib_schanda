...
(assert (=> (<= i1 temp___276) (and (and (<= (to_rep1 (first (rt haystack))) i1) (<= i1 (to_rep1 (last (rt haystack))))) (and (<= (to_rep1 (first (rt haystack))) temp___276) (<= temp___276 (to_rep1 (last (rt haystack))))))))
(assert (= o7 (elts haystack)))
(assert (= o7 temp___277))
(assert (= (mk1 i1 temp___276) temp___2771))
(assert (= result1 (bool_eq (elts needle) (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) temp___277 (to_rep1 (first2 temp___2771)) (to_rep1 (last2 temp___2771)))))
...
(assert (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 i2)) (not (= (match_at needle haystack k1) true)))))
...
(assert (not (= i2 temp___280)))
(assert (= i2 result3))
(assert (= i3 (+ i2 1)))
(assert (and (= o8 (- (to_rep1 (last (rt needle))) 1)) (in_range1 (- (to_rep1 (last (rt needle))) 1))))
(assert (= o9 (+ i3 o8)))
(assert (and (= temp___2761 o9) (in_range1 o9)))
(assert (=> (<= i3 temp___2761) (and (and (<= (to_rep1 (first (rt haystack))) i3) (<= i3 (to_rep1 (last (rt haystack))))) (and (<= (to_rep1 (first (rt haystack))) temp___2761) (<= temp___2761 (to_rep1 (last (rt haystack))))))))
(assert (= o10 (elts haystack)))
(assert (= o10 temp___2772))
(assert (= (mk1 i3 temp___2761) temp___2773))
(assert (= result4 (bool_eq (elts needle) (to_rep1 (first (rt needle))) (to_rep1 (last (rt needle))) temp___2772 (to_rep1 (first2 temp___2773)) (to_rep1 (last2 temp___2773)))))
