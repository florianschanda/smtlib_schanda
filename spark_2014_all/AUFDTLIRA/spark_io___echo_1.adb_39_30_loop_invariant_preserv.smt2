...
(assert (= result1 true))
(assert (and (and (and (and (and (and (and (= (is_writable standard_output2) true) (= (is_open standard_output2) true)) (= (mode__2 standard_output2) (mode__2 standard_output1))) (= (let ((temp___805 (name standard_output1))) (let ((temp___804 (name standard_output2))) (bool_eq (elts temp___804) (to_rep1 (first (rt temp___804))) (to_rep1 (last (rt temp___804))) (elts temp___805) (to_rep1 (first (rt temp___805))) (to_rep1 (last (rt temp___805)))))) true)) (= (let ((temp___807 (form standard_output1))) (let ((temp___806 (form standard_output2))) (bool_eq (elts temp___806) (to_rep1 (first (rt temp___806))) (to_rep1 (last (rt temp___806))) (elts temp___807) (to_rep1 (first (rt temp___807))) (to_rep1 (last (rt temp___807)))))) true)) (= (line_length__2 standard_output2) (line_length__2 standard_output1))) (= (page_length__2 standard_output2) (page_length__2 standard_output1))) (= (= (is_standard_file standard_output2) true) (= (is_standard_file standard_output1) true))))
