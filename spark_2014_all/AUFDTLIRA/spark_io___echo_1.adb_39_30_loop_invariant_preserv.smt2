...
(assert (= result1 true))
(assert (and (and (and (and (and (and (and (= (is_writable standard_output2) true) (= (is_open standard_output2) true)) (= (mode__2 standard_output2) (mode__2 standard_output1))) (= (let ((temp___719 (name standard_output1))) (let ((temp___718 (name standard_output2))) (bool_eq (elts temp___718) (to_rep1 (first (rt temp___718))) (to_rep1 (last (rt temp___718))) (elts temp___719) (to_rep1 (first (rt temp___719))) (to_rep1 (last (rt temp___719)))))) true)) (= (let ((temp___721 (form standard_output1))) (let ((temp___720 (form standard_output2))) (bool_eq (elts temp___720) (to_rep1 (first (rt temp___720))) (to_rep1 (last (rt temp___720))) (elts temp___721) (to_rep1 (first (rt temp___721))) (to_rep1 (last (rt temp___721)))))) true)) (= (line_length__2 standard_output2) (line_length__2 standard_output1))) (= (page_length__2 standard_output2) (page_length__2 standard_output1))) (= (= (is_standard_file standard_output2) true) (= (is_standard_file standard_output1) true))))
(assert (= standard_error2 standard_error1))
(assert (= o4 (end_of_file standard_input2)))
