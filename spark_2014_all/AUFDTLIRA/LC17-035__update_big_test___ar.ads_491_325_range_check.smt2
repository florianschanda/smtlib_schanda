...
(assert (=> (< 0 e) (= o15 (temp___1904 o14 i o13))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o11 (+ k 1))))
(assert (=> (< 0 e) (= o16 (select a o11))))
(assert (=> (< 0 e) (= o17 (temp___1897 o16 j o15))))
(assert (=> (< 0 e) (and (= o18 (+ k 1)) (in_range3 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5571 (temp___1874 a k (temp___1882 (select a k) j (temp___1889 (select (select a k) j) i e)) o18 o17))))
...
(assert (= o8 (temp___1943 o7 i 99)))
(assert (and (<= 1 (+ k 1)) (<= (+ k 1) 16)))
(assert (= o5 (+ k 1)))
(assert (= o9 (select a o5)))
(assert (= o10 (temp___1936 o9 j o8)))
