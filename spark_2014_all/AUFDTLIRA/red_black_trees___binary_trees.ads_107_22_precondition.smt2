...
(assert (= result2 true))
(assert (= (tree_structure f) true))
(assert (and (= temp___661 (model__ f root)) (and (dynamic_invariant6 temp___661 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___661 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___661 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___661 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___661 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___661 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___661 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___661 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___661 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___661 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___661 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___661 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___661 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___661 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o23 o24)) (select temp___661 i)))
(assert (= o23 o25))
(assert (= o24 o26))
(assert (= o27 o25))
...
(assert (= (tree_structure f) true))
(assert (and (= temp___660 (model__ f root)) (and (dynamic_invariant6 temp___660 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___660 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___660 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___660 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___660 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___660 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___660 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___660 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___660 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___660 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___660 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___660 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___660 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___660 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o18 o19)) (select temp___660 j)))
(assert (= o18 o20))
(assert (= o19 o21))
(assert (= o22 o20))
(assert (not (<= 1 o30)))
