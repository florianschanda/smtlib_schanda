...
(assert (= result true))
(assert (= (tree_structure f) true))
(assert (and (= temp___707 (model__ f root)) (and (dynamic_invariant6 temp___707 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___707 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___707 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___707 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___707 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___707 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___707 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___707 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___707 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___707 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___707 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___707 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___707 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___707 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o19 o20)) (select temp___707 i)))
(assert (= o19 o21))
(assert (= o20 o22))
(assert (= o23 o21))
(assert (and (= o24 (length o23)) (and (in_range4 o24) (<= (+ 0 o24) 2147483647))))
(assert (= o25 (+ o24 1)))
(assert (and (= o26 o25) (in_range1 o25)))
(assert (= (tree_structure f) true))
(assert (and (= temp___706 (model__ f root)) (and (dynamic_invariant6 temp___706 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___706 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___706 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___706 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___706 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___706 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___706 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___706 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___706 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___706 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___706 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___706 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___706 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___706 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o14 o15)) (select temp___706 j)))
(assert (= o14 o16))
(assert (= o15 o17))
(assert (= o18 o16))
(assert (not (<= 1 o26)))
