...
(assert (<= temp___225 i8))
(assert (<= i8 0))
(assert (and (forall ((temp___224 Int)) (=> (and (<= 0 temp___224) (<= temp___224 100)) (=> (<= i9 temp___224) (= (select a18 temp___224) (select a16 temp___224))))) (and (<= (+ k1 1) i9) (<= i9 0))))
(assert (and (= temp___222 (- i9 k1)) (in_range1 (- i9 k1))))
(assert (not (<= 0 temp___222)))
(check-sat)
(exit)
