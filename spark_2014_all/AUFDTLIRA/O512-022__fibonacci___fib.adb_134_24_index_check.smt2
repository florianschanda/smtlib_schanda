...
(assert (= i2 0))
(assert (=> (and (<= 0 i2) (<= i2 k1)) (= temp___195 a1)))
(assert (=> (and (<= 0 i2) (<= i2 k1)) (and (forall ((temp___196 Int)) (=> (and (<= 0 temp___196) (<= temp___196 100)) (=> (<= i3 temp___196) (= (select a12 temp___196) (select temp___195 temp___196))))) (and (<= 0 i3) (<= i3 k1)))))
...
(assert (= i8 temp___202))
(assert (<= temp___202 i8))
(assert (<= i8 0))
(assert (and (forall ((temp___201 Int)) (=> (and (<= 0 temp___201) (<= temp___201 100)) (=> (<= i9 temp___201) (= (select a18 temp___201) (select a16 temp___201))))) (and (<= (+ k1 1) i9) (<= i9 0))))
(assert (and (= temp___199 (- i9 k1)) (in_range1 (- i9 k1))))
(assert (not (<= 0 temp___199)))
(check-sat)
(exit)
