...
(assert (<= temp___202 i12))
(assert (<= i12 0))
(assert (and (forall ((temp___201 Int)) (=> (and (<= 0 temp___201) (<= temp___201 100)) (=> (<= i13 temp___201) (= (select a18 temp___201) (select a16 temp___201))))) (and (<= (+ k1 1) i13) (<= i13 0))))
(assert (and (= temp___199 (- i13 k1)) (in_range1 (- i13 k1))))
