...
(define-fun s__split_fields9 () us_split_fields (mk___split_fields s__split_fields6 s__split_fields7 s__split_fields8))
(define-fun s__split_fields10 () us_split_fields (mk___split_fields s__split_fields3 s__split_fields4 s__split_fields5))
(assert (=> (<= 0 2147483647) (in_range2 e)))
(assert (and (= (is_empty (mk___rep s__split_fields10 s__attr__tag)) true) (reset__specific_post s__attr__tag s__split_fields10 s__attr__tag (mk___split_fields s__split_fields s__split_fields1 s__split_fields2))))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 1))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields9 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields10 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i1) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i1)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields10 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields10 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields9 s__attr__tag i1 s__split_fields10)))
(assert (= i1 result1))
(assert (= i2 2))
(assert (not (not (= (is_full (mk___rep s__split_fields9 s__attr__tag)) true))))
(check-sat)
(exit)
