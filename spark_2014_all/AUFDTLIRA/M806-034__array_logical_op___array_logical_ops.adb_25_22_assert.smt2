...
(assert (forall ((temp___146 Int) (temp___147 Int) (temp___148 Int)) (let ((temp___145 (array_logical_ops__test_ok2__v__aggregate_def temp___146 temp___147 temp___148))) (forall ((temp___149 Int)) (ite (and (<= 36 temp___149) (<= temp___149 45)) (= (select temp___145 temp___149) (of_rep temp___148)) (ite (and (<= 16 temp___149) (<= temp___149 35)) (= (select temp___145 temp___149) (of_rep temp___147)) (=> (and (<= 6 temp___149) (<= temp___149 15)) (= (select temp___145 temp___149) (of_rep temp___146)))))))))
(declare-sort t13b 0)
...
(assert (forall ((temp___151 Int) (temp___152 Int) (temp___153 Int) (temp___154 Int)) (let ((temp___150 (array_logical_ops__test_ok2__x__aggregate_def temp___151 temp___152 temp___153 temp___154))) (forall ((temp___155 Int)) (ite (and (<= 31 temp___155) (<= temp___155 40)) (= (select temp___150 temp___155) (of_rep temp___154)) (ite (and (<= 21 temp___155) (<= temp___155 30)) (= (select temp___150 temp___155) (of_rep temp___153)) (ite (and (<= 11 temp___155) (<= temp___155 20)) (= (select temp___150 temp___155) (of_rep temp___152)) (=> (and (<= 1 temp___155) (<= temp___155 10)) (= (select temp___150 temp___155) (of_rep temp___151))))))))))
...
(assert (<= (to_rep1 (first (rt r2))) i2))
(assert (<= i2 30))
(assert (not (= (of_int (to_rep (select (elts r2) i2))) true)))
(check-sat)
(exit)
