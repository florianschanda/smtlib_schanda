...
(assert (forall ((i t11b)) (and (<= 6 (t11bqtint i)) (<= (t11bqtint i) 45))))
...
(declare-fun array_logical_ops__test_ok2__v__aggregate_def (Int Int Int) (Array Int my_boolean))
(declare-sort t13b 0)
(declare-fun t13bqtint (t13b) Int)
(assert (forall ((i t13b)) (and (<= 1 (t13bqtint i)) (<= (t13bqtint i) 40))))
...
(declare-fun array_logical_ops__test_ok2__x__aggregate_def (Int Int Int Int) (Array Int my_boolean))
...
(assert (= v (of_array (array_logical_ops__test_ok2__v__aggregate_def 0 1 0) 6 45)))
...
(assert (forall ((temp___168 Int) (temp___169 Int) (temp___170 Int)) (let ((temp___167 (array_logical_ops__test_ok2__v__aggregate_def temp___168 temp___169 temp___170))) (=> (and (and (dynamic_invariant2 temp___168 true true true true) (dynamic_invariant2 temp___169 true true true true)) (dynamic_invariant2 temp___170 true true true true)) (forall ((temp___171 Int)) (ite (and (<= 36 temp___171) (<= temp___171 45)) (= (to_rep (select temp___167 temp___171)) temp___170) (ite (and (<= 16 temp___171) (<= temp___171 35)) (= (to_rep (select temp___167 temp___171)) temp___169) (=> (and (<= 6 temp___171) (<= temp___171 15)) (= (to_rep (select temp___167 temp___171)) temp___168)))))))))
(assert (= x (of_array (array_logical_ops__test_ok2__x__aggregate_def 1 0 1 0) 1 40)))
(assert (forall ((temp___173 Int) (temp___174 Int) (temp___175 Int) (temp___176 Int)) (let ((temp___172 (array_logical_ops__test_ok2__x__aggregate_def temp___173 temp___174 temp___175 temp___176))) (=> (and (and (and (dynamic_invariant2 temp___173 true true true true) (dynamic_invariant2 temp___174 true true true true)) (dynamic_invariant2 temp___175 true true true true)) (dynamic_invariant2 temp___176 true true true true)) (forall ((temp___177 Int)) (ite (and (<= 31 temp___177) (<= temp___177 40)) (= (to_rep (select temp___172 temp___177)) temp___176) (ite (and (<= 21 temp___177) (<= temp___177 30)) (= (to_rep (select temp___172 temp___177)) temp___175) (ite (and (<= 11 temp___177) (<= temp___177 20)) (= (to_rep (select temp___172 temp___177)) temp___174) (=> (and (<= 1 temp___177) (<= temp___177 10)) (= (to_rep (select temp___172 temp___177)) temp___173))))))))))
(assert (= r2 (of_array (orb (to_array x) (first1 x) (last1 x) (to_array v) (first1 v) (last1 v)) (first1 x) (last1 x))))
(assert (= (mk___t (array_logical_ops__test_ok2__v__aggregate_def 0 1 0) (mk 6 45)) v))
(assert (dynamic_invariant v true false true true))
(assert (= (mk___t (array_logical_ops__test_ok2__x__aggregate_def 1 0 1 0) (mk 1 40)) x))
(assert (dynamic_invariant x true false true true))
(assert (= (mk___t (orb (elts x) (to_rep1 (first (rt x))) (to_rep1 (last (rt x))) (elts v) (to_rep1 (first (rt v))) (to_rep1 (last (rt v)))) (mk (to_rep1 (first (rt x))) (to_rep1 (last (rt x))))) r2))
(assert (dynamic_invariant r2 true false true true))
(assert (= (to_rep1 (first (rt r2))) 1))
(declare-const i Int)
(assert (<= (to_rep1 (first (rt r2))) i))
(assert (<= i 30))
(assert (not (= (distinct (to_rep (select (elts r2) i)) 0) true)))
(check-sat)
(exit)
