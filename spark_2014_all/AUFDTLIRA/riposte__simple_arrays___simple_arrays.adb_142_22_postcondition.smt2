...
(assert (= (bool_eq (temp___408 a_old k 3 i 1 j 2) (- 2147483648) 2147483647 (temp___418 a_old k 3 j 2 i 1) (- 2147483648) 2147483647) true))
(assert (= a3 a4))
(assert (= a5 a3))
(assert (not (= (bool_eq a4 (- 2147483648) 2147483647 (temp___267 a i 1 j 2 k 3) (- 2147483648) 2147483647) true)))
(check-sat)
(exit)
