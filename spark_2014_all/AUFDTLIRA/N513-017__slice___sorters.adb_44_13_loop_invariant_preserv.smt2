...
(assert (= min1 o))
(assert (and (= temp___220 (+ (to_rep (first (rt unsorted))) 1)) (in_range1 (+ (to_rep (first (rt unsorted))) 1))))
(assert (= (mk_int__ref result1) (mk_int__ref index)))
(assert (= index1 temp___220))
(assert (<= temp___220 index1))
...
(assert (and (and (=> (<= (+ (to_rep (first (rt unsorted))) 1) (to_rep (last (rt unsorted)))) (dynamic_property1 (+ (to_rep (first (rt unsorted))) 1) (to_rep (last (rt unsorted))) index2)) (=> (<= 1 2147483647) (in_range2 min2))) (and (<= (+ (to_rep (first (rt unsorted))) 1) index2) (<= index2 (to_rep (last (rt unsorted)))))))
