...
(define-fun dynamic_invariant1 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 1 1)) (in_range4 temp___expr_136)))
(assert (forall ((a us_t) (b us_t)) (! (=> (and (and (dynamic_invariant a true true true) (dynamic_invariant b true true true)) (and (= (invariant__ a) true) (and (= (invariant__ b) true) (= (is_perm a b) true)))) (let ((result (perm_symmetric a b))) (and (=> (= (of_int result) true) (= (is_perm b a) true)) (dynamic_invariant1 result true false true)))) :pattern ((perm_symmetric a b)))))
(declare-fun shift_perm_l (us_t us_t us_t) Int)
(declare-fun shift_perm_l__function_guard (Int us_t us_t us_t) Bool)
(assert (forall ((a us_t) (b us_t) (c us_t)) (! (=> (and (and (and (dynamic_invariant a true true true) (dynamic_invariant b true true true)) (dynamic_invariant c true true true)) (and (= (invariant__ a) true) (and (= (invariant__ b) true) (and (= (invariant__ c) true) (and (= (bool_eq (to_array a) (first1 a) (last1 a) (to_array c) (first1 c) (last1 c)) true) (= (is_perm a b) true)))))) (let ((result (shift_perm_l a b c))) (and (=> (= (of_int result) true) (= (is_perm c b) true)) (dynamic_invariant1 result true false true)))) :pattern ((shift_perm_l a b c)))))
...
(define-fun dynamic_invariant4 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 1 100)) (in_range3 temp___expr_142)))
(assert (forall ((a1 us_t)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant a1 true true true) (dynamic_invariant4 i true true true)) (and (= (invariant__ a1) true) (and (<= (first1 a1) i) (<= i (last1 a1))))) (let ((result (remove a1 i))) (and (and (= (invariant__ result) true) (and (= (last1 result) (- (last1 a1) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep (select (to_array a1) k)) (to_rep (select (to_array result) k))))) (and (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (last1 a1))) (= (to_rep (select (to_array a1) k)) (to_rep (select (to_array result) (- k 1)))))) (forall ((k Int)) (=> (and (<= i k) (<= k (- (last1 a1) 1))) (= (to_rep (select (to_array a1) (+ k 1))) (to_rep (select (to_array result) k))))))))) (dynamic_invariant result true false true)))) :pattern ((remove a1 i))))))
(declare-const perm__shift_perm_r__result Int)
...
(declare-const perm__shift_perm_r__result1 Int)
(declare-const perm__shift_perm_r__result2 Int)
(declare-const perm__shift_perm_r__result3 Int)
(declare-const perm__shift_perm_r__result4 Int)
(declare-const perm__shift_perm_r__result5 Int)
