...
(define-fun dynamic_invariant ((temp___expr_267 us_t1) (temp___is_init_264 Bool) (temp___skip_constant_265 Bool) (temp___do_toplevel_266 Bool)) Bool (and (=> (not (= temp___skip_constant_265 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_267) (last3 temp___expr_267))) (=> (= temp___do_toplevel_266 true) (=> (= temp___is_init_264 true) (and (let ((temp___269 (of_array2 (to_array1 temp___expr_267) (first3 temp___expr_267) (last3 temp___expr_267)))) (and (= (first5 temp___269) 1) (<= 0 (last5 temp___269)))) (<= (last3 temp___expr_267) 1000))))))
(define-fun dynamic_predicate ((temp___271 us_t1)) Bool (and (let ((temp___273 (of_array2 (to_array1 temp___271) (first3 temp___271) (last3 temp___271)))) (and (= (first5 temp___273) 1) (<= 0 (last5 temp___273)))) (<= (last3 temp___271) 1000)))
...
(define-fun dynamic_invariant1 ((temp___expr_375 Int) (temp___is_init_372 Bool) (temp___skip_constant_373 Bool) (temp___do_toplevel_374 Bool)) Bool (=> (or (= temp___is_init_372 true) (<= 0 4194304)) (in_range3 temp___expr_375)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_233 us_t2) (temp___is_init_230 Bool) (temp___skip_constant_231 Bool) (temp___do_toplevel_232 Bool)) Bool (and (=> (not (= temp___skip_constant_231 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_233) (last5 temp___expr_233))) (=> (= temp___do_toplevel_232 true) (=> (= temp___is_init_230 true) (and (= (first5 temp___expr_233) 1) (<= 0 (last5 temp___expr_233)))))))
(define-fun dynamic_predicate1 ((temp___236 us_t2)) Bool (and (= (first5 temp___236) 1) (<= 0 (last5 temp___236))))
(declare-const temp___392 (Array Int character))
(declare-const temp___3921 t1)
(assert (in_range3 x))
