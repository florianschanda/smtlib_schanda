...
(define-fun dynamic_invariant ((temp___expr_902 Int) (temp___is_init_899 Bool) (temp___skip_constant_900 Bool) (temp___do_toplevel_901 Bool)) Bool (=> (or (= temp___is_init_899 true) (<= 0 4294967295)) (in_range4 temp___expr_902)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1035 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 13)) 83)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 15)) 111)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 19)) 119)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 22)) 116)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 23)) 101)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 27)) 114)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 29)) 114)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 31)) 45)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 33)) 115)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 34)) 116)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 35)) 97)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 36)) 116)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 37)) 101)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 39)) 119)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 40)) 105)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 41)) 108)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 42)) 108)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 44)) 98)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 45)) 101)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 47)) 108)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 48)) 111)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 49)) 115)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 50)) 116)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 51)) 32)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 52)) 97)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 53)) 116)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 54)) 32)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 55)) 80)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 56)) 111)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 57)) 119)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 58)) 101)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 59)) 114)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 60)) 32)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 61)) 68)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 62)) 111)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 63)) 119)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 64)) 110)) (= (to_rep (select (temp___String_Literal_1035 us_void_param) 65)) 46)) :pattern ((temp___String_Literal_1035 us_void_param)))))
