...
(declare-const cur_piece__split_fields1 py_coord)
(declare-const y Int)
...
(assert (<= 0 x1))
(assert (<= x1 2))
(assert (and (forall ((temp___782 Int)) (=> (and (<= 1 temp___782) (<= temp___782 50)) (=> (not (= (+ (to_rep2 cur_piece__split_fields1) y2) temp___782)) (= (select cur_board1 temp___782) (select cur_board temp___782))))) (and (<= 0 x2) (<= x2 2))))
