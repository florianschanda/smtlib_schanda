...
(declare-fun temp___352 (Bool Int Int) us_t2)
...
(assert (forall ((temp___354 Bool)) (forall ((temp___355 Int) (temp___356 Int)) (let ((temp___353 (temp___352 temp___354 temp___355 temp___356))) (and (=> (dynamic_property6 0 2147483647 temp___355 temp___356) (and (= (first5 temp___353) temp___355) (= (last5 temp___353) temp___356))) (forall ((temp___357 Int)) (= (select (to_array2 temp___353) temp___357) temp___354)))))))
...
(assert (= (to_rep1 (first4 (rt2 (temp___352 (distinct 0 0) 0 r6b)))) 0))
(assert (= (to_rep1 (last4 (rt2 (temp___352 (distinct 0 0) 0 r6b)))) r6b))
(assert (= (mk___t2 temp___359 temp___3591) (temp___352 (distinct 0 0) 0 r6b)))
