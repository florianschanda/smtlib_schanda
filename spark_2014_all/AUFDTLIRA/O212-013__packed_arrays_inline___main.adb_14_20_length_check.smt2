...
(declare-fun temp_____aggregate_def_352 (Bool Int Int) us_t2)
...
(define-fun of_array3 ((a (Array Int Bool)) (f Int) (l Int)) us_t3 (mk___t3 a (mk3 f l)))
...
(define-fun dynamic_invariant4 ((temp___expr_313 us_t3) (temp___is_init_309 Bool) (temp___skip_constant_310 Bool) (temp___do_toplevel_311 Bool) (temp___do_typ_inv_312 Bool)) Bool (=> (not (= temp___skip_constant_310 true)) (dynamic_property6 0 2147483647 (first7 temp___expr_313) (last7 temp___expr_313))))
(assert (forall ((temp___354 Bool)) (forall ((temp___355 Int) (temp___356 Int)) (let ((temp___353 (temp_____aggregate_def_352 temp___354 temp___355 temp___356))) (and (=> (dynamic_property6 0 2147483647 temp___355 temp___356) (and (= (first5 temp___353) temp___355) (= (last5 temp___353) temp___356))) (forall ((temp___357 Int)) (= (select (to_array2 temp___353) temp___357) temp___354)))))))
(define-fun dynamic_invariant5 ((temp___expr_328 us_t1) (temp___is_init_324 Bool) (temp___skip_constant_325 Bool) (temp___do_toplevel_326 Bool) (temp___do_typ_inv_327 Bool)) Bool (=> (not (= temp___skip_constant_325 true)) (and (dynamic_property3 0 r6b (first3 temp___expr_328) (last3 temp___expr_328)) (and (= (first3 temp___expr_328) 0) (= (last3 temp___expr_328) r6b)))))
(declare-const d__split_fields (Array Int Bool))
(declare-const d__split_fields1 t)
(declare-const temp___359 (Array Int Bool))
(declare-const temp___3591 t2)
...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_352 (distinct 0 0) 0 r6b)))) 0))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_352 (distinct 0 0) 0 r6b)))) r6b))
(assert (= (mk___t2 temp___359 temp___3591) (temp_____aggregate_def_352 (distinct 0 0) 0 r6b)))
(assert (not (= (ite (<= (to_rep1 (first4 temp___3591)) (to_rep1 (last4 temp___3591))) (+ (- (to_rep1 (last4 temp___3591)) (to_rep1 (first4 temp___3591))) 1) 0) (ite (<= 0 r6b) (+ (- r6b 0) 1) 0))))
(check-sat)
(exit)
