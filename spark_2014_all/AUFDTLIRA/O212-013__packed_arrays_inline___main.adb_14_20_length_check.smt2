...
(assert (forall ((temp___306 Bool)) (forall ((temp___307 Int) (temp___308 Int)) (let ((temp___305 (temp___304 temp___306 temp___307 temp___308))) (and (=> (dynamic_property6 0 2147483647 temp___307 temp___308) (and (= (first5 temp___305) temp___307) (= (last5 temp___305) temp___308))) (forall ((temp___309 Int)) (= (select (to_array2 temp___305) temp___309) temp___306)))))))
...
(define-fun dynamic_invariant3 ((temp___expr_281 us_t1) (temp___is_init_278 Bool) (temp___skip_constant_279 Bool) (temp___do_toplevel_280 Bool)) Bool (=> (not (= temp___skip_constant_279 true)) (and (dynamic_property3 0 r6b (first3 temp___expr_281) (last3 temp___expr_281)) (and (= (first3 temp___expr_281) 0) (= (last3 temp___expr_281) r6b)))))
(declare-const d__split_fields (Array Int Bool))
(declare-const d__split_fields1 t)
(declare-const temp___311 (Array Int Bool))
(declare-const temp___3111 t2)
(declare-const temp___312 (Array Int Bool))
...
(assert (not (= (ite (<= (to_rep1 (first4 temp___3111)) (to_rep1 (last4 temp___3111))) (+ (- (to_rep1 (last4 temp___3111)) (to_rep1 (first4 temp___3111))) 1) 0) (ite (<= 0 r6b) (+ (- r6b 0) 1) 0))))
(check-sat)
(exit)
