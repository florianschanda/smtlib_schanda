...
(assert (not (= (ite (<= (to_rep1 (first4 temp___2891)) (to_rep1 (last4 temp___2891))) (+ (- (to_rep1 (last4 temp___2891)) (to_rep1 (first4 temp___2891))) 1) 0) (ite (<= (to_rep1 interm__first) (to_rep1 interm__last)) (+ (- (to_rep1 interm__last) (to_rep1 interm__first)) 1) 0))))
(check-sat)
(exit)
