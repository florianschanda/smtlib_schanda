...
(assert (and (and (= (= (select a1 i2) true) (= (select a j2) true)) (= (= (select a1 j2) true) (= (select a i2) true))) (forall ((k Int)) (=> (and (<= (to_rep a__first) k) (<= k (to_rep a__last))) (=> (and (not (= k i2)) (not (= k j2))) (= (= (select a1 k) true) (= (select a k) true)))))))
