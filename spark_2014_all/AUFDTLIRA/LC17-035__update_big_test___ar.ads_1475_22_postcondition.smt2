...
(declare-const temp___8004 (Array Int et1))
(declare-const temp___80041 enum2t)
(declare-const o4 et1)
(declare-const o5 (Array Int et1))
(declare-const o6 (Array Int et1))
(declare-const o7 enum2t)
(declare-const temp___8007 (Array Int et1))
(declare-const temp___80071 enum2t)
...
(assert (= temp___8004 o2))
(assert (= temp___80041 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___8004 r__split_fields2))
(assert (= temp___80041 r__split_fields3))
(assert (= (to_rep o4) f))
(assert (= o5 (store r__split_fields2 j o4)))
(assert (= o5 o6))
(assert (= r__split_fields3 o7))
(assert (= temp___8007 o6))
(assert (= temp___80071 o7))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8007 r__split_fields4))
(assert (= temp___80071 r__split_fields5))
