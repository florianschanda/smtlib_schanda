...
(declare-const temp___411 (Array Int natural))
(declare-const temp___4111 t1)
...
(assert (<= 1 i1))
(assert (<= i1 2))
(assert (and (forall ((temp___414 Int)) (=> (and (<= (to_rep1 r__first) temp___414) (<= temp___414 (to_rep1 r__last))) (=> (<= i2 temp___414) (= (select r2 temp___414) (select r1 temp___414))))) (and (<= 1 i2) (<= i2 2))))
(assert (= (to_rep o) 0))
...
(assert (and (dynamic_property2 (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) (to_rep1 res__first) (to_rep1 res__last)) (and (= (to_rep1 res__first) (to_rep1 (first (rt a)))) (= (to_rep1 res__last) (to_rep1 (last (rt a)))))))
(assert (= (ite (<= (to_rep1 r__first) (to_rep1 r__last)) (+ (- (to_rep1 r__last) (to_rep1 r__first)) 1) 0) (ite (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (+ (- (to_rep1 (last (rt a))) (to_rep1 (first (rt a)))) 1) 0)))
(assert (= (slide r3 (to_rep1 r__first) (to_rep1 (first (rt a)))) temp___411))
(assert (= (mk1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) temp___4111))
(assert (not (= (ite (<= (to_rep1 (first2 temp___4111)) (to_rep1 (last2 temp___4111))) (+ (- (to_rep1 (last2 temp___4111)) (to_rep1 (first2 temp___4111))) 1) 0) (ite (<= (to_rep1 res__first) (to_rep1 res__last)) (+ (- (to_rep1 res__last) (to_rep1 res__first)) 1) 0))))
(check-sat)
(exit)
