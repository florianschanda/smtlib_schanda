...
(assert (= (slide r3 (to_rep1 r__first) (to_rep1 (first (rt a)))) temp___413))
(assert (= (mk1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) temp___4131))
(assert (not (= (ite (<= (to_rep1 (first2 temp___4131)) (to_rep1 (last2 temp___4131))) (+ (- (to_rep1 (last2 temp___4131)) (to_rep1 (first2 temp___4131))) 1) 0) (ite (<= (to_rep1 res__first) (to_rep1 res__last)) (+ (- (to_rep1 res__last) (to_rep1 res__first)) 1) 0))))
(check-sat)
(exit)
