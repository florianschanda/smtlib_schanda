...
(assert true)
(declare-const entry_table__split_fields us_main_type3)
...
(define-fun names__to_string__B_3__e__assume3 () us_rep2 (mk___rep1 (mk___split_fields1 names__to_string__B_3__e__assume names__to_string__B_3__e__assume1 names__to_string__B_3__e__assume2)))
...
(assert (and (= names__to_string__B_3__e__assume3 (get1 (model__1 (mk___rep2 entry_table__split_discrs (mk___split_fields2 entry_table__split_fields))) o)) (= (bool_eq3 names__to_string__B_3__e__assume3 (get1 (model__1 (mk___rep2 entry_table__split_discrs (mk___split_fields2 entry_table__split_fields))) o)) true)))
(assert (= names__to_string__B_3__e__assume3 e))
(assert (= (to_rep2 (rec__names__name_entry__length (us_split_fields3 e))) l))
(assert (in_range2 l))
...
(assert (<= 1 i1))
(assert (<= i1 l))
(assert (and (forall ((temp___691 Int)) (=> (and (<= (to_rep1 s__first) temp___691) (<= temp___691 (to_rep1 s__last))) (=> (or (< l temp___691) (or (< temp___691 1) (<= i2 temp___691))) (= (select s1 temp___691) (select s temp___691))))) (and (<= 1 i2) (<= i2 l))))
(assert (and (= o1 (+ (to_rep4 (rec__names__name_entry__table_index (us_split_fields3 e))) (- i2 1))) (in_range11 (+ (to_rep4 (rec__names__name_entry__table_index (us_split_fields3 e))) (- i2 1)))))
(assert (not (in_range12 o1)))
(check-sat)
(exit)
