...
(assert (forall ((s us_t)) (! (=> (dynamic_invariant s true true true) (dynamic_invariant (id s) true false true)) :pattern ((id s)))))
(assert (forall ((s us_t)) (! (=> (dynamic_invariant s true true true) (= (id s) s)) :pattern ((id s)))))
(declare-const concat2 us_t)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun temp___String_Literal_132 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_132 us_void_param) 1)) 116) (= (to_rep (select (temp___String_Literal_132 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 4)) 111)) :pattern ((temp___String_Literal_132 us_void_param)))))
...
(assert (= concat2 (let ((temp___134 0)) (let ((temp___133 (id (of_array (temp___String_Literal_132 Tuple0) 1 4)))) (ite (= (length temp___133) 0) (of_array (singleton1 (of_rep temp___134) 1) 1 1) (of_array (concat1 (to_array temp___133) (first1 temp___133) (last1 temp___133) (singleton1 (of_rep temp___134) 1) 1 1) (first1 temp___133) (- (+ (first1 temp___133) (+ (ite (<= (first1 temp___133) (last1 temp___133)) (+ (- (last1 temp___133) (first1 temp___133)) 1) 0) 1)) 1)))))))
...
(assert (and (= (mk___t temp___139 temp___1391) (id (mk___t (temp___String_Literal_132 Tuple0) (mk 1 4)))) (and (dynamic_invariant (mk___t temp___139 temp___1391) true false true) (and (= (temp___String_Literal_132 Tuple0) temp___139) (= (mk 1 4) temp___1391)))))
(assert (not (= (length (mk___t temp___139 temp___1391)) 0)))
(assert (=> (<= (to_rep1 (first temp___1391)) (to_rep1 (last temp___1391))) (= o (+ (- (to_rep1 (last temp___1391)) (to_rep1 (first temp___1391))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___1391)) (to_rep1 (last temp___1391)))) (= o 0)))
(assert (= o1 (+ o 1)))
