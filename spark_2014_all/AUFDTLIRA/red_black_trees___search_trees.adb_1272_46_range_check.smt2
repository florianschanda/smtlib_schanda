...
(assert (= o14 (+ o13 1)))
(assert (and (= o15 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range6 o15)))
...
(assert (and (= temp___2108 (model__ (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o5)) (and (dynamic_invariant8 temp___2108 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2108 o5))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2108 o5)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o5)) (ite (and (not (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2108 (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2108 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2108 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2108 i1))) true) (not (= i1 o5))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___2108 (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1)))) (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2108 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2108 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2108 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2108 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___2108 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2108 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o6 o7)) (select temp___2108 j)))
(assert (= o6 o8))
(assert (= o7 o9))
(assert (= o10 o8))
