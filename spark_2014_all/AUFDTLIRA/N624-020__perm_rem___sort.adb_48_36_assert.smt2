...
(assert (= hr8 o59))
(assert (not (= (let ((temp___260 (remove (remove (mk___t values2 (mk 1 100)) x) y))) (let ((temp___259 (remove (remove (mk___t init (mk 1 100)) x) y))) (bool_eq (elts temp___259) (to_rep1 (first (rt temp___259))) (to_rep1 (last (rt temp___259))) (elts temp___260) (to_rep1 (first (rt temp___260))) (to_rep1 (last (rt temp___260)))))) true)))
(check-sat)
(exit)
