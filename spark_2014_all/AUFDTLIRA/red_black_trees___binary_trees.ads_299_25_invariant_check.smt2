...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o46 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) (and (in_range2 o46) (= o46 (to_rep f__split_fields)))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= result5 (ite (= o47 o46) true false)))
(assert (= result5 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o45 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o45) (and (= o45 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o45 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o45) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o45) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)) (= o45 j)))))))))
(assert (= result6 (ite (= v o45) true false)))
(assert (= result6 true))
(assert (= (= result7 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j) true) (not (= j v))) (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) true))))))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) true) (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j) true))))))
(assert (= result8 true))
(assert (= (= result9 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (not (= j v)) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j)))))))
(assert (= result9 true))
(assert (= (= result10 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (not (= j v)) (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) 0))) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j)))))))
...
(assert (= (= result12 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) j))) true))))))
(assert (= result12 true))
(assert (= (= result13 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (not (= v 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) v) j))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) j))) true))))))
...
(assert (= (= result15 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) j))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) j)))) true))))))
(assert (= result15 true))
(assert (= (= result16 true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (not (= v 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) v) j))) true)) (= (is_concat (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) v) j))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) j)))) true))))))
(assert (= result16 true))
(assert (<= 1 t))
(assert (<= t 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o42 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t)) (and (= (= o42 true) (and (<= t (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 t)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) t) (not (= o42 true))))))
(assert (= o43 (ite (and (= o42 true) (not (= root t))) true false)))
(assert (= result17 (ite (and (= o43 true) (not (= v t))) true false)))
(assert (= result17 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o44 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t)) (and (dynamic_invariant o44 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o44 t))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o44 t)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 t)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o44 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o44 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o44 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o44 i1))) true) (not (= i1 t))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o44 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select o44 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o44 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o44 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o44 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o44 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select o44 j)))) true)) (= j i1))))))))))))))
(assert (not (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true)))
(check-sat)
(exit)
