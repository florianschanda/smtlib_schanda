...
(assert (= (= result26 true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (not (= v 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) v) j9))) true)) (= (is_concat (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) v) j9))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) j9)))) true))))))
(assert (= result26 true))
(assert (<= 1 t))
(assert (<= t 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o49 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t)) (and (= (= o49 true) (and (<= t (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 t)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) t) (not (= o49 true))))))
(assert (= o50 (ite (and (= o49 true) (not (= root t))) true false)))
(assert (= result28 (ite (and (= o50 true) (not (= v t))) true false)))
(assert (= result28 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o51 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t)) (and (dynamic_invariant3 o51 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o51 t))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o51 t)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 t)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o51 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o51 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o51 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o51 i2))) true) (not (= i2 t))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o51 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select o51 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o51 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o51 i2))) true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o51 j9))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o51 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select o51 j9)))) true)) (= j9 i2))))))))))))))
