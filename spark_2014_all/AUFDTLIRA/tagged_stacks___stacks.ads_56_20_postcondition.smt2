...
(assert (=> (= (to_rep3 s__split_fields4) 1) (= temp___572 o7)))
(assert (=> (= (to_rep3 s__split_fields4) 1) (= temp___5721 o8)))
(assert (=> (= (to_rep3 s__split_fields4) 1) (= temp___5722 o9)))
(assert (=> (= (to_rep3 s__split_fields4) 1) (= temp___5723 o10)))
(assert (=> (= (to_rep3 s__split_fields4) 1) (= s__attr__tag temp___5724)))
...
(assert (=> (= (to_rep3 s__split_fields4) 1) (= temp___572 s__split_fields8)))
(assert (=> (= (to_rep3 s__split_fields4) 1) (= temp___5721 s__split_fields9)))
(assert (=> (= (to_rep3 s__split_fields4) 1) (= temp___5722 s__split_fields10)))
(assert (=> (= (to_rep3 s__split_fields4) 1) (= temp___5723 s__split_fields11)))
...
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= temp___570 o13)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= temp___5701 o14)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= temp___5702 o15)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= temp___5703 o16)))
...
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= s__split_fields12 (mk___split_fields1 temp___570 temp___5701 temp___5702 temp___5703))))
...
(assert (= temp___575 o19))
(assert (= temp___5751 o20))
(assert (= temp___5752 o21))
(assert (= temp___5753 o22))
(assert (= s__attr__tag temp___5754))
(assert (= result12 (mk___split_fields__ref1 s__split_fields16)))
(assert (= s__split_fields13 (mk___split_fields1 temp___575 temp___5751 temp___5752 temp___5753)))
(assert (= s__split_fields14 (mk___split_fields__ref1 s__split_fields13)))
(assert (= s__split_fields15 s__split_fields13))
(assert (not (= (let ((temp___579 (get_model__3 (mk___rep1 (us_split_fields__content1 s__split_fields14) s__attr__tag)))) (bool_eq (elts temp___579) (to_rep2 (first (rt temp___579))) (to_rep2 (last (rt temp___579))) (let ((temp___578 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))) (concat_singleton_left (of_rep1 e) 1 (elts temp___578) (to_rep2 (first (rt temp___578))) (to_rep2 (last (rt temp___578))))) (to_rep2 (first (let ((temp___578 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))) (mk 1 (- (+ 1 (+ 1 (ite (<= (to_rep2 (first (rt temp___578))) (to_rep2 (last (rt temp___578)))) (+ (- (to_rep2 (last (rt temp___578))) (to_rep2 (first (rt temp___578)))) 1) 0))) 1))))) (to_rep2 (last (let ((temp___578 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))) (mk 1 (- (+ 1 (+ 1 (ite (<= (to_rep2 (first (rt temp___578))) (to_rep2 (last (rt temp___578)))) (+ (- (to_rep2 (last (rt temp___578))) (to_rep2 (first (rt temp___578)))) 1) 0))) 1))))))) true)))
(check-sat)
(exit)
