...
(assert (= (positive_less_than_maxqtint rliteral1) 100))
...
(declare-const o8 positive_less_than_max)
(declare-const o9 (Array Int element))
(declare-const o10 less_than_max)
...
(declare-const o12 element)
(declare-const o13 (Array Int element))
(declare-const o14 positive_less_than_max)
(declare-const o15 (Array Int element))
(declare-const o16 less_than_max)
(declare-const o17 us_private)
(declare-const temp___575 positive_less_than_max)
(declare-const temp___5751 (Array Int element))
(declare-const temp___5752 less_than_max)
(declare-const temp___5753 us_private)
(declare-const temp___5754 Int)
...
(declare-const result12 positive_less_than_max)
(declare-const result13 (Array Int element))
(declare-const result14 less_than_max)
...
(assert (=> (= (to_rep3 s__split_fields4) 1) (= rliteral1 s__split_fields8)))
(assert (=> (= (to_rep3 s__split_fields4) 1) (= s__split_fields5 s__split_fields9)))
(assert (=> (= (to_rep3 s__split_fields4) 1) (= s__split_fields6 s__split_fields10)))
(assert (=> (= (to_rep3 s__split_fields4) 1) (= s__split_fields7 s__split_fields11)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (and (= o6 (- (to_rep3 s__split_fields4) 1)) (in_range4 (- (to_rep3 s__split_fields4) 1)))))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= (to_rep3 o7) o6)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= o7 o8)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= s__split_fields5 o9)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= s__split_fields6 o10)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= s__split_fields7 o11)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= temp___570 o8)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= temp___5701 o9)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= temp___5702 o10)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= temp___5703 o11)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= s__attr__tag temp___5704)))
...
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= temp___570 s__split_fields12)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= temp___5701 s__split_fields13)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= temp___5702 s__split_fields14)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= temp___5703 s__split_fields15)))
(assert (=> (not (= (to_rep3 s__split_fields4) 1)) (= (mk___split_fields1 s__split_fields8 s__split_fields9 s__split_fields10 s__split_fields11) (mk___split_fields1 s__split_fields12 s__split_fields13 s__split_fields14 s__split_fields15))))
(assert (= (to_rep1 o12) e))
(assert (= o13 (store s__split_fields9 (to_rep3 s__split_fields8) o12)))
(assert (= s__split_fields8 o14))
(assert (= o13 o15))
(assert (= s__split_fields10 o16))
(assert (= s__split_fields11 o17))
(assert (= temp___575 o14))
(assert (= temp___5751 o15))
(assert (= temp___5752 o16))
(assert (= temp___5753 o17))
(assert (= s__attr__tag temp___5754))
(assert (= result12 s__split_fields8))
(assert (= result13 s__split_fields9))
(assert (= result14 s__split_fields10))
(assert (= result15 s__split_fields11))
(assert (= s__split_fields16 (mk___split_fields1 temp___575 temp___5751 temp___5752 temp___5753)))
(assert (= s__split_fields17 (mk___split_fields__ref1 s__split_fields16)))
(assert (= s__split_fields18 s__split_fields16))
(assert (not (= (let ((temp___579 (get_model__3 (mk___rep1 (us_split_fields__content1 s__split_fields17) s__attr__tag)))) (bool_eq (elts temp___579) (to_rep (first (rt temp___579))) (to_rep (last (rt temp___579))) (let ((temp___578 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))) (concat_singleton_left (of_rep1 e) 1 (elts temp___578) (to_rep (first (rt temp___578))) (to_rep (last (rt temp___578))))) (to_rep (first (let ((temp___578 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))) (mk 1 (- (+ 1 (+ 1 (ite (<= (to_rep (first (rt temp___578))) (to_rep (last (rt temp___578)))) (+ (- (to_rep (last (rt temp___578))) (to_rep (first (rt temp___578)))) 1) 0))) 1))))) (to_rep (last (let ((temp___578 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))) (mk 1 (- (+ 1 (+ 1 (ite (<= (to_rep (first (rt temp___578))) (to_rep (last (rt temp___578)))) (+ (- (to_rep (last (rt temp___578))) (to_rep (first (rt temp___578)))) 1) 0))) 1))))))) true)))
(check-sat)
(exit)
