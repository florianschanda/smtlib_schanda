...
(assert (<= temp___2078 index1))
(assert (<= index1 temp___2079))
...
(assert (and (and (forall ((temp___2076 Int)) (=> (and (<= (to_rep1 n__first) temp___2076) (<= temp___2076 (to_rep1 n__last))) (=> (< index2 temp___2076) (= (select n3 temp___2076) (select n1 temp___2076))))) (=> (<= (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 3) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
