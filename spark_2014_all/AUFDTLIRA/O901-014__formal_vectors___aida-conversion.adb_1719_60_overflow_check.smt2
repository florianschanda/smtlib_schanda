...
(assert (<= temp___2078 index2))
(assert (<= index2 temp___2079))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o17 index2))
(assert (= o18 (select n1 o17)))
(assert (= o19 (to_rep1 o18)))
(assert (= o19 aida__conversion__convert_character_digit_to_integer__2__target))
...
(assert (= (to_rep1 o23) aida__conversion__convert_character_digit_to_integer__2__target2))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o24 index2))
(assert (= o25 (store n1 o24 o23)))
(assert (= n1 result4))
(assert (= n2 o25))
(assert (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))))
(assert (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1))))))
(assert (and (and (forall ((temp___2076 Int)) (=> (and (<= (to_rep1 n__first) temp___2076) (<= temp___2076 (to_rep1 n__last))) (=> (< index3 temp___2076) (= (select n3 temp___2076) (select n1 temp___2076))))) (=> (<= (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 3) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10)))))
