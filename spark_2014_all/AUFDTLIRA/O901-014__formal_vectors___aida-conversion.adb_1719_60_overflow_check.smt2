...
(assert (and (= (length source) 11) (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (forall ((index3 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index3))) true))))))
...
(assert (<= temp___2176 index1))
(assert (<= index1 temp___2177))
...
(assert (= n1 result3))
(assert (= n2 o8))
(assert (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9)))))
(assert (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j))))))
(assert (and (and (forall ((temp___2180 Int)) (=> (and (<= (to_rep1 n__first) temp___2180) (<= temp___2180 (to_rep1 n__last))) (=> (or (< temp___2177 temp___2180) (or (< temp___2180 temp___2176) (< index2 temp___2180))) (= (select n3 temp___2180) (select n1 temp___2180))))) (=> (<= (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 3) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
