...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o57 (peek (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j3 e)) (and (in_range2 o57) (and (= o57 (ite (= e 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 j3)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 j3)))))) (and (ite (not (= o57 0)) (and (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o57) e) (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o57) j3)) (forall ((j6 Int)) (=> (and (<= 1 j6) (<= j6 100)) (=> (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j6) j3) (not (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j6) e)))))) (forall ((j6 Int)) (=> (and (<= 1 j6) (<= j6 100)) (=> (and (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j6) j3) (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j6) e)) (= o57 j6)))))))))
