...
(assert (= result7 (ite (= o47 (+ (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 1)) true false)))
(assert (= result7 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= o45 (select temp___1003 i)))
(assert (= o46 (us_split_fields1 o45)))
(assert (= result8 (rec__tree_model__path_type__k o46)))
(assert (= result8 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= result9 (ite (= o44 (int__content v2)) true false)))
(assert (= result9 true))
...
(assert (= o42 (select temp___1001 (int__content v2))))
(assert (= o43 (us_split_fields1 o42)))
(assert (= result11 (rec__tree_model__path_type__k o43)))
...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o41 (peek (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j e)) (and (in_range2 o41) (and (= o41 (ite (= e 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 j)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 j)))))) (and (ite (not (= o41 0)) (and (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o41) e) (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o41) j)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1) j) (not (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1) e)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1) j) (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j1) e)) (= o41 j1)))))))))
