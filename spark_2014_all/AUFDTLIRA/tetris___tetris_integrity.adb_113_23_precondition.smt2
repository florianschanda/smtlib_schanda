...
(define-fun dynamic_invariant ((temp___expr_687 Int) (temp___is_init_683 Bool) (temp___skip_constant_684 Bool) (temp___do_toplevel_685 Bool) (temp___do_typ_inv_686 Bool)) Bool (=> (or (= temp___is_init_683 true) (<= 0 4)) (in_range6 temp___expr_687)))
...
(define-fun dynamic_invariant6 ((temp___expr_595 Int) (temp___is_init_591 Bool) (temp___skip_constant_592 Bool) (temp___do_toplevel_593 Bool) (temp___do_typ_inv_594 Bool)) Bool (=> (or (= temp___is_init_591 true) (<= (- 1) 9)) (in_range3 temp___expr_595)))
(define-fun dynamic_invariant7 ((temp___expr_602 Int) (temp___is_init_598 Bool) (temp___skip_constant_599 Bool) (temp___do_toplevel_600 Bool) (temp___do_typ_inv_601 Bool)) Bool (=> (or (= temp___is_init_598 true) (<= (- 1) 49)) (in_range4 temp___expr_602)))
(define-fun dynamic_invariant8 ((temp___expr_609 Int) (temp___is_init_605 Bool) (temp___skip_constant_606 Bool) (temp___do_toplevel_607 Bool) (temp___do_typ_inv_608 Bool)) Bool (=> (or (= temp___is_init_605 true) (<= 0 3)) (in_range5 temp___expr_609)))
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range8 x) (in_range9 y)) (= (to_rep (let ((temp___666 (select b y))) (select temp___666 x))) 0))) :pattern ((is_empty b y x))))))
...
(define-fun dynamic_invariant9 ((temp___expr_701 Int) (temp___is_init_697 Bool) (temp___skip_constant_698 Bool) (temp___do_toplevel_699 Bool) (temp___do_typ_inv_700 Bool)) Bool (=> (or (= temp___is_init_697 true) (<= 3 4)) (in_range10 temp___expr_701)))
(assert (forall ((d Int) (t Int)) (! (=> (and (dynamic_invariant8 d true true true true) (dynamic_invariant9 t true true true true)) (dynamic_invariant8 (turn_direction d t) true false true true)) :pattern ((turn_direction d t)))))
(assert (forall ((d Int) (t Int)) (! (=> (and (dynamic_invariant8 d true true true true) (dynamic_invariant9 t true true true true)) (= (turn_direction d t) (ite (= t 3) (ite (= d 0) 3 (- d 1)) (ite (= d 3) 0 (+ d 1))))) :pattern ((turn_direction d t)))))
