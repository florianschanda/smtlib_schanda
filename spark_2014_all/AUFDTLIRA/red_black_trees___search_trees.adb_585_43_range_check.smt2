...
(assert (and (= o3 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))))
(assert (and (= result (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o3)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t1))) o3) (not (= result true)))))
(assert (= result true))
(assert (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))) 0)))
(assert (and (= o2 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))))))
(assert (and (= result1 (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o2)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t2))) o2) (not (= result1 true)))))
(assert (= result1 true))
(assert (and (= o1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))))
(assert (and (= result2 (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o1 (rec__search_trees__search_tree__values (us_split_fields7 t1)))) (= (= result2 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o1) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o1) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o1) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o1) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o1) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o1) i1)))) 1)) 0) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) j)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) i1))) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) i1)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) j))))))))))))
(assert (= result2 true))
...
(assert (and (= result3 (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o (rec__search_trees__search_tree__values (us_split_fields7 t2)))) (= (= result3 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o) i1)))) 1)) 0) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) j)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i1))) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i1)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) j))))))))))))
(assert (= result3 true))
