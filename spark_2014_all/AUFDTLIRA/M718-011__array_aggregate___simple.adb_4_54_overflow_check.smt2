...
(assert (forall ((temp___150 Int) (temp___151 Int)) (let ((temp___149 (temp___148 temp___150 temp___151))) (forall ((temp___152 Int)) (ite (= temp___152 1) (= (select temp___149 temp___152) (of_rep temp___150)) (= (select temp___149 temp___152) (of_rep temp___151)))))))
(declare-fun simple__foo__arr__aggregate_def (Int) (Array Int integer))
(assert (forall ((temp___158 Int)) (forall ((temp___159 Int)) (= (select (simple__foo__arr__aggregate_def temp___158) temp___159) (of_rep temp___158)))))
(define-fun dynamic_invariant1 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 1 5)) (in_range1 temp___expr_136)))
