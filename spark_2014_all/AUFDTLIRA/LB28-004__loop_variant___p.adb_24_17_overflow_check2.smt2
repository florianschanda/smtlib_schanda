...
(define-fun tab9 () map__ref (mk_map__ref tab))
(assert (in_range1 a))
(assert (in_range1 b))
...
(assert (=> (<= j1 b) (= (mk_map__ref result1) tab9)))
(assert (=> (<= j1 b) (= tab2 o2)))
...
(assert (= o5 temp___172))
(assert (= o6 (store (map__content tab6) o5 rliteral)))
(assert (= result7 tab6))
(assert (= tab8 o6))
(assert (not (< j8 100)))
