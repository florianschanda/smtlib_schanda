...
(assert (= (ite (<= (to_rep1 (first4 temp___2651)) (to_rep1 (last4 temp___2651))) (+ (- (to_rep1 (last4 temp___2651)) (to_rep1 (first4 temp___2651))) 1) 0) (ite (<= 1 (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1)) (+ (- (- (to_rep (rec__record_discr__interm_result__upto (us_split_discrs3 r))) 1) 1) 1) 0)))
(assert (= temp___265 o7))
(assert (= (mk1 (to_rep1 (first4 temp___2651)) (to_rep1 (last4 temp___2651))) o8))
(assert (= o9 o7))
(assert (= o10 o8))
