...
(declare-const g1_id3 Int)
(assert (<= 1 g1_id3))
(assert (<= g1_id3 64))
(declare-const rank6 Int)
(assert (<= 1 rank6))
(assert (<= rank6 (to_rep3 (select proposals_made1 g1_id3))))
(assert (not (not (= (select unmatched_g2_set2 (to_rep1 (select (select ranking_1 g1_id3) rank6))) true))))
(check-sat)
(exit)
