...
(assert (= result1 true))
(assert (< 0 (sum_of counter1)))
(assert (=> (<= 0 2147483647) (in_range4 counter2)))
(assert (and (= o1 (+ counter2 1)) (in_range1 (+ counter2 1))))
(assert (= counter2 result2))
(assert (= counter3 o1))
(assert (and (= o2 (sum_of counter3)) (in_range4 o2)))
(assert (= o3 (ite (< 5 o2) true false)))
(assert (= result3 (ite (not (= o3 true)) true false)))
(assert (not (= result3 true)))
(assert (not (< 0 (sum_of counter1))))
(check-sat)
(exit)
