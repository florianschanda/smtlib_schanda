...
(assert (forall ((i tmy_arrayD1)) (and (<= 1 (tmy_arrayD1qtint i)) (<= (tmy_arrayD1qtint i) 10))))
...
(define-fun dynamic_invariant1 ((temp___expr_169 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool) (temp___do_typ_inv_168 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_169)))
...
(declare-const v Int)
(assert (in_range1 j))
(assert (=> (<= (- 2147483648) 2147483647) (in_range3 v)))
(assert (<= 1 j))
(assert (<= j 10))
(assert (not (<= 1 j)))
(check-sat)
