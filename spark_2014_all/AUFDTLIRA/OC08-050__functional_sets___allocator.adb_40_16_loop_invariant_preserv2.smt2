...
(define-fun dynamic_invariant ((temp___expr_330 Int) (temp___is_init_326 Bool) (temp___skip_constant_327 Bool) (temp___do_toplevel_328 Bool) (temp___do_typ_inv_329 Bool)) Bool (=> (or (= temp___is_init_326 true) (<= 0 3)) (in_range1 temp___expr_330)))
...
(assert (forall ((s us_rep)) (forall ((e Int)) (! (=> (dynamic_invariant e true true true true) (=> (= e 0) (not (= (mem s e) true)))) :pattern ((mem s e))))))
...
(assert (forall ((s us_rep)) (forall ((e Int)) (! (=> (and (dynamic_invariant e true true true true) (and (not (= e 0)) (not (= (mem s e) true)))) (= (is_add s e (add s e)) true)) :pattern ((add s e))))))
...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (user_eq (rec__allocator__m__t__available (us_split_fields1 a)) (rec__allocator__m__t__available (us_split_fields1 b))) true) (= (user_eq (rec__allocator__m__t__allocated (us_split_fields1 a)) (rec__allocator__m__t__allocated (us_split_fields1 b))) true)) true false))
...
(assert true)
(assert (forall ((m us_rep1)) (forall ((allocator__data (Array Int status))) (! (= (= (is_valid m allocator__data) true) (and (and (forall ((e Int)) (=> (and (in_range1 e) (= (mem (rec__allocator__m__t__available (us_split_fields1 m)) e) true)) (in_range3 e))) (forall ((e Int)) (=> (and (in_range1 e) (= (mem (rec__allocator__m__t__allocated (us_split_fields1 m)) e) true)) (in_range3 e)))) (forall ((r Int)) (=> (and (<= 1 r) (<= r 3)) (ite (= (to_rep (select allocator__data r)) 0) (and (= (mem (rec__allocator__m__t__available (us_split_fields1 m)) r) true) (not (= (mem (rec__allocator__m__t__allocated (us_split_fields1 m)) r) true))) (and (not (= (mem (rec__allocator__m__t__available (us_split_fields1 m)) r) true)) (= (mem (rec__allocator__m__t__allocated (us_split_fields1 m)) r) true))))))) :pattern ((is_valid m allocator__data))))))
...
(define-fun dynamic_invariant2 ((temp___expr_317 Int) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool (=> (or (= temp___is_init_313 true) (<= 1 3)) (in_range3 temp___expr_317)))
(assert true)
(assert (forall ((x us_rep1) (y us_rep1)) (! (= (= (oeq1 x y) true) (and (= (oeq (rec__allocator__m__t__available (us_split_fields1 x)) (rec__allocator__m__t__available (us_split_fields1 y))) true) (= (oeq (rec__allocator__m__t__allocated (us_split_fields1 x)) (rec__allocator__m__t__allocated (us_split_fields1 y))) true))) :pattern ((oeq1 x y)))))
(assert (forall ((s1 us_rep) (s2 us_rep)) (! (= (= (oeq s1 s2) true) (and (forall ((e Int)) (=> (and (in_range1 e) (= (mem s1 e) true)) (= (mem s2 e) true))) (forall ((e Int)) (=> (and (in_range1 e) (= (mem s2 e) true)) (= (mem s1 e) true))))) :pattern ((oeq s1 s2)))))
(assert (forall ((s us_rep)) (! (= (= (is_empty s) true) (forall ((e Int)) (not (and (in_range1 e) (= (mem s e) true))))) :pattern ((is_empty s)))))
(assert (forall ((s us_rep) (result__ us_rep)) (forall ((e Int)) (! (=> (dynamic_invariant e true true true true) (= (= (is_add s e result__) true) (and (and (and (and (not (= e 0)) (= (mem result__ e) true)) (not (= (mem s e) true))) (forall ((f Int)) (=> (and (in_range1 f) (= (mem result__ f) true)) (or (= (mem s f) true) (= f e))))) (forall ((e1 Int)) (=> (and (in_range1 e1) (= (mem s e1) true)) (= (mem result__ e1) true)))))) :pattern ((is_add s e result__))))))
...
(declare-const avail4 us_rep)
(declare-const result5 us_rep)
(declare-const alloc4 us_rep)
...
(assert (and (and (forall ((e Int)) (=> (and (in_range1 e) (= (mem avail3 e) true)) (and (<= 1 e) (<= e r2)))) (forall ((e Int)) (=> (and (in_range1 e) (= (mem alloc3 e) true)) (and (<= 1 e) (<= e r2))))) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (ite (= (to_rep (select data rr)) 0) (and (= (mem avail3 rr) true) (not (= (mem alloc3 rr) true))) (and (not (= (mem avail3 rr) true)) (= (mem alloc3 rr) true)))))))
(assert (and (=> (<= 1 3) (in_range3 r2)) (and (<= 1 r2) (<= r2 3))))
(assert (not (= r2 3)))
(assert (= r2 result3))
(assert (= r3 (+ r2 1)))
(assert (=> (= (to_rep (select data r3)) 0) (and (= o2 (add avail3 r3)) (= (is_add avail3 r3 o2) true))))
(assert (=> (= (to_rep (select data r3)) 0) (= result4 avail3)))
(assert (=> (= (to_rep (select data r3)) 0) (= avail4 o2)))
(assert (=> (= (to_rep (select data r3)) 0) (= alloc4 alloc3)))
(assert (=> (not (= (to_rep (select data r3)) 0)) (and (= o3 (add alloc3 r3)) (= (is_add alloc3 r3 o3) true))))
(assert (=> (not (= (to_rep (select data r3)) 0)) (= result5 alloc3)))
(assert (=> (not (= (to_rep (select data r3)) 0)) (= alloc4 o3)))
(assert (=> (not (= (to_rep (select data r3)) 0)) (= avail4 avail3)))
(declare-const e Int)
(assert (in_range1 e))
(assert (= (mem avail4 e) true))
(assert (not (<= 1 e)))
(check-sat)
(exit)
