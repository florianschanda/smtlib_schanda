...
(assert (<= (to_rep1 (first (rt source))) index2))
(assert (<= index2 temp___1355))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o21 index2))
(assert (= o22 (select n1 o21)))
(assert (= o23 (to_rep1 o22)))
(assert (= o23 aida__conversion__convert_character_digit_to_integer__2__target))
...
(assert (= (to_rep1 o27) aida__conversion__convert_character_digit_to_integer__2__target2))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o28 index2))
(assert (= o29 (store n1 o28 o27)))
(assert (= n1 result3))
(assert (= n2 o29))
(assert (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))))
(assert (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1))))))
(assert (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3)) (forall ((temp___1353 Int)) (=> (and (<= (to_rep1 n__first) temp___1353) (<= temp___1353 (to_rep1 n__last))) (=> (< index3 temp___1353) (= (select n3 temp___1353) (select n1 temp___1353)))))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9)))))
(assert (not (= index3 temp___1355)))
(assert (= index3 result4))
(assert (= index4 (+ index3 1)))
(assert (and (<= (to_rep1 n__first) index4) (<= index4 (to_rep1 n__last))))
(assert (= o37 index4))
(assert (= o38 (select n3 o37)))
(assert (= o39 (to_rep1 o38)))
(assert (= o39 aida__conversion__convert_character_digit_to_integer__2__target1))
...
(assert (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target3) (<= aida__conversion__convert_character_digit_to_integer__2__target3 9)) (= aida__conversion__convert_character_digit_to_integer__2__target3 (convert_character_digit_to_integer o42))) (ite (= (= o42 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 0) (ite (= (= o42 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 1) (ite (= (= o42 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 2) (ite (= (= o42 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 3) (ite (= (= o42 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 4) (ite (= (= o42 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 5) (ite (= (= o42 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 6) (ite (= (= o42 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 7) (ite (= (= o42 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 8) (=> (= (= o42 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target3)))
(assert (= (to_rep1 o43) aida__conversion__convert_character_digit_to_integer__2__target3))
(assert (and (<= (to_rep1 n__first) index4) (<= index4 (to_rep1 n__last))))
(assert (= o44 index4))
(assert (= o45 (store n3 o44 o43)))
(assert (= result5 n3))
(assert (= n4 o45))
(declare-const j1 Int)
(assert (<= (to_rep1 (first (rt source))) j1))
(assert (<= j1 index4))
