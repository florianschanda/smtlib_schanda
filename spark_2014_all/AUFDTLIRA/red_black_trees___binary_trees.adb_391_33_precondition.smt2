...
(assert (= result3 true))
(assert (= (tree_structure f) true))
(assert (and (= temp___1173 (model__ f root)) (and (dynamic_invariant6 temp___1173 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1173 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1173 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1173 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1173 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1173 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1173 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1173 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1173 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1173 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1173 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1173 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1173 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1173 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o33 (select temp___1173 i)))
(assert (= o34 (us_split_fields1 o33)))
(assert (= o35 (rec__tree_model__path_type__a o34)))
(assert (and (= o36 (length o35)) (and (in_range3 o36) (<= (+ 0 o36) 2147483647))))
(assert (= o37 (+ o36 1)))
