...
(assert (= r5b9 r5b7))
(assert (= l9 l7))
(assert (=> (= (not (= (to_rep (select a x)) (to_rep (select a y)))) true) (= (int__content longest_common_prefix__lcp__result4) 0)))
(assert (=> (= (= x y) true) (= (int__content longest_common_prefix__lcp__result4) (+ (- 1000 x) 1))))
(assert (=> (not (= (ite (= (not (= (to_rep (select a x)) (to_rep (select a y)))) false) (= x y) true) true)) (< 0 (int__content longest_common_prefix__lcp__result4))))
(assert (= result12 (int__content longest_common_prefix__lcp__result4)))
(assert (not (or (or (=> (<= 1 (+ (int__content longest_common_prefix__lcp__result4) x)) (not (<= (+ (int__content longest_common_prefix__lcp__result4) x) 1000))) (=> (<= 1 (+ (int__content longest_common_prefix__lcp__result4) y)) (not (<= (+ (int__content longest_common_prefix__lcp__result4) y) 1000)))) (not (= (to_rep (select a (+ x (int__content longest_common_prefix__lcp__result4)))) (to_rep (select a (+ y (int__content longest_common_prefix__lcp__result4)))))))))
(check-sat)
(exit)
