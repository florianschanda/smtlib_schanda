...
(define-fun dynamic_invariant ((temp___expr_224 (Array Int integer)) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool)) Bool (=> (= temp___do_toplevel_223 true) (=> (= temp___is_init_221 true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep (select temp___expr_224 k)) 0)))))))
(define-fun default_initial_assumption ((temp___expr_227 (Array Int integer)) (temp___skip_top_level_228 Bool)) Bool (forall ((temp___229 Int)) (=> (and (<= 1 temp___229) (<= temp___229 10)) (= (to_rep (select temp___expr_227 temp___229)) 0))))
(define-fun dynamic_predicate ((temp___230 (Array Int integer))) Bool (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep (select temp___230 k)) 0)))))
...
(declare-const temp___348 (Array Int integer))
...
(assert (not (dynamic_predicate temp___348)))
(check-sat)
(exit)
