...
(assert (= result5 (mk_int__ref temp___6901)))
(assert (= temp___6902 (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) current2))))))
(assert (= result6 (mk_int__ref previous2)))
(assert (= previous3 current2))
(assert (and (<= 1 current2) (<= current2 100)))
(assert (= o36 current2))
(assert (= o37 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o36)))
(assert (= o38 (to_rep o37)))
(assert (= result7 (ite (= v o38) true false)))
(assert (not (= result7 true)))
(assert (and (<= 1 current2) (<= current2 100)))
(assert (= o39 current2))
(assert (= o40 (select (rec__search_trees__search_tree__values (us_split_fields7 t)) o39)))
(assert (= o41 (to_rep o40)))
(assert (= result9 (ite (< v o41) true false)))
(assert (=> (= result9 true) (= result10 (mk_int__ref d2))))
(assert (=> (= result9 true) (= d3 0)))
(assert (=> (= result9 true) (and (= o42 current2) (in_range3 current2))))
(assert (=> (= result9 true) (and (= o43 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) o42 0)) (and (in_range4 o43) (and (ite (not (= o43 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o43) 0) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o43) o42)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o42) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 0)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o42) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 0)) (= o43 j)))))))))
(assert (=> (= result9 true) (= result11 (mk_int__ref current2))))
(assert (=> (= result9 true) (= current3 o43)))
(assert (=> (not (= result9 true)) (= result12 (mk_int__ref d2))))
(assert (=> (not (= result9 true)) (= d4 1)))
(assert (=> (not (= result9 true)) (and (= o44 current2) (in_range3 current2))))
(assert (=> (not (= result9 true)) (and (= o45 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) o44 1)) (and (in_range4 o45) (and (ite (not (= o45 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o45) 1) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o45) o44)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o44) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 1)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) o44) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j) 1)) (= o45 j)))))))))
(assert (=> (not (= result9 true)) (= result13 (mk_int__ref current2))))
(assert (=> (not (= result9 true)) (= current4 o45)))
(assert (=> (not (= result9 true)) (= d3 d4)))
(assert (=> (not (= result9 true)) (= current3 current4)))
(assert (= search_trees__contains__result3 search_trees__contains__result2))
