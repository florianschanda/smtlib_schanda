...
(assert (not (= (bool_eq2 a1 1 16 (temp_____aggregate_def_5482 t1 k (temp_____aggregate_def_5488 (select t1 k) j (temp_____aggregate_def_5494 (select (select t1 k) j) i e))) 1 16) true)))
(check-sat)
(exit)
