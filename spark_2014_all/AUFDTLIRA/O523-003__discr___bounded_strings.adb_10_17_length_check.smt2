...
(assert (not (= (ite (<= (to_rep1 (first6 temp___1991)) (to_rep1 (last6 temp___1991))) (+ (- (to_rep1 (last6 temp___1991)) (to_rep1 (first6 temp___1991))) 1) 0) (ite (<= 1 upper_bound) (+ (- upper_bound 1) 1) 0))))
(check-sat)
(exit)
