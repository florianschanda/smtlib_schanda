...
(assert (<= 1 i1))
(assert (<= i1 r7b))
(assert (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (- i2 1))) (= (to_rep1 (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) j2)) (+ (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j2)) (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 b))) j2)))))))
(assert (and (and (and (dynamic_invariant2 (mk___rep1 c__split_discrs c__split_fields4) false true true) (forall ((temp___781 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)))) temp___781) (<= temp___781 (to_rep2 (last2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)))))) (=> (<= i2 temp___781) (= (select (elts1 (rec__simple_unc_arrays__table__v1 c__split_fields4)) temp___781) (select c__split_fields temp___781)))))) (=> (<= 1 r7b) (dynamic_property4 1 r7b i2))) (and (<= 1 i2) (<= i2 r7b))))
(assert (<= 1 j))
(assert (<= j (- i2 1)))
