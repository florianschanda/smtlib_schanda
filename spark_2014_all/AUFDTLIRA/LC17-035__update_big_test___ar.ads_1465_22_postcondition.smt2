...
(assert (forall ((temp___3060 (Array Int et1))) (forall ((temp___3061 Int) (temp___3062 Int)) (let ((temp___3059 (temp___3058 temp___3060 temp___3061 temp___3062))) (forall ((temp___3063 Int)) (ite (= temp___3063 temp___3061) (= (select temp___3059 temp___3063) (of_rep temp___3062)) (= (select temp___3059 temp___3063) (select temp___3060 temp___3063))))))))
...
(declare-const temp___7981 (Array Int et1))
(declare-const temp___79811 enum2t)
(declare-const o3 et1)
(declare-const o4 (Array Int et1))
(declare-const o5 (Array Int et1))
(declare-const o6 enum2t)
(declare-const temp___7984 (Array Int et1))
(declare-const temp___79841 enum2t)
...
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp___3058 r__split_fields i e) (of_rep1 f)))) true)))
(check-sat)
(exit)
