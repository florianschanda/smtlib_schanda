...
(declare-fun temp_____aggregate_def_3117 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3119 (Array Int et1))) (forall ((temp___3120 Int) (temp___3121 Int)) (let ((temp___3118 (temp_____aggregate_def_3117 temp___3119 temp___3120 temp___3121))) (=> (and (dynamic_invariant temp___3120 true true true true) (dynamic_invariant1 temp___3121 true true true true)) (forall ((temp___3122 Int)) (ite (= temp___3122 temp___3120) (= (to_rep (select temp___3118 temp___3122)) temp___3121) (= (select temp___3118 temp___3122) (select temp___3119 temp___3122)))))))))
...
(declare-const temp___8040 (Array Int et1))
(declare-const temp___80401 enum2t)
(declare-const o3 et1)
(declare-const o4 (Array Int et1))
(declare-const o5 (Array Int et1))
(declare-const o6 enum2t)
(declare-const temp___8043 (Array Int et1))
(declare-const temp___80431 enum2t)
...
(assert (= o o2))
(assert (= temp___8040 o1))
(assert (= temp___80401 o2))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___8040 r__split_fields2))
(assert (= temp___80401 r__split_fields3))
(assert (= (to_rep o3) e))
(assert (= o4 (store r__split_fields2 i o3)))
(assert (= o4 o5))
(assert (= r__split_fields3 o6))
(assert (= temp___8043 o5))
(assert (= temp___80431 o6))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8043 r__split_fields4))
(assert (= temp___80431 r__split_fields5))
...
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp_____aggregate_def_3117 r__split_fields i e) (of_rep1 f)))) true)))
(check-sat)
(exit)
