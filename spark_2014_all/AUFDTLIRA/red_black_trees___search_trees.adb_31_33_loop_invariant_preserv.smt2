...
(declare-const temp___6691 (Array Int us_rep1))
...
(assert (<= (length s3) j2))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i j2)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i))) true) (= (contains s3 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i))) true)))))
...
(assert (and (= temp___6691 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o9)) (and (dynamic_invariant5 temp___6691 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___6691 o9))) true) (and (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___6691 o9)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i o9)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___6691 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___6691 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___6691 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___6691 i))) true) (not (= i o9))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___6691 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___6691 i)))) true) (= (length1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___6691 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___6691 i))) true) (forall ((j4 Int)) (=> (and (<= 1 j4) (<= j4 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___6691 j4))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___6691 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___6691 j4)))) true)) (= j4 i))))))))))))))
(assert (= (mk___rep (mk___split_fields o10 o11)) (select temp___6691 j3)))
(assert (= o10 o12))
(assert (= o11 o13))
(assert (= result6 o13))
(assert (=> (= result6 true) (and (= o8 (contains s3 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j3)))) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range4 e) (= (contains s3 e) true)) (= e (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j3))))) (= o8 true))))))
