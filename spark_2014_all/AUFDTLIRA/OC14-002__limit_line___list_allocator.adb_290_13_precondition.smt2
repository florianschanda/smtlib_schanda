...
(assert (=> (not (= first_available1 0)) (and (= o64 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o64))))
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o64) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o63 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o63)))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (= result11 (ite (= o63 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result12 true)) (= result11 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o65 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o65))))
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o65 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (and (= o61 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o61)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (= result13 (ite (< 0 o61) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (and (= o60 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range7 o60))))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (= result10 (ite (= o60 first_allocated2) true false))))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (not (= result13 true)) (= result10 false)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (and (= o62 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o62)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (= result10 (ite (= o62 0) true false)))))
