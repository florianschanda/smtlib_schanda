...
(assert (<= (to_rep (rec__static_discr__holder__length (us_split_fields__content2 current__split_fields6))) (int__content result__3)))
(assert (<= (int__content result__3) (to_rep current__split_fields4)))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields__content2 current__split_fields6))))))) (int__content result__3))))
(check-sat)
(exit)
