...
(assert (<= 1 g1_id2))
(assert (<= g1_id2 64))
(assert (= (= result1 true) (forall ((idx3 Int)) (=> (and (<= 1 idx3) (<= idx3 (to_rep3 unmatched_g1_set__split_fields1))) (not (= (to_rep (select unmatched_g1_set__split_fields idx3)) g1_id2))))))
(assert (= result1 true))
(assert (< 0 (to_rep3 (select proposals_made g1_id2))))
(assert (not (in_range3 (to_rep3 (select proposals_made g1_id2)))))
(check-sat)
(exit)
