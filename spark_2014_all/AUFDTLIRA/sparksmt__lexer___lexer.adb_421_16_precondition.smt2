...
(assert (not (and (<= 0 (let ((subject c)) c2)) (<= (let ((subject c)) c2) 255))))
...
(assert (=> (<= 1 19) (= o9 (+ (- 19 1) 1))))
(assert (=> (not (<= 1 19)) (= o9 0)))
(assert (= o10 (+ o9 1)))
(assert (= o11 (+ 1 o10)))
(assert (= o12 (- o11 1)))
(assert (and (= o13 o12) (in_range2 o12)))
(assert (= (to_rep o7) (let ((subject c)) c2)))
(assert (= o8 (singleton1 o7 1)))
(assert (= o14 (concat1 (temp___String_Literal_834 Tuple0) 1 19 o8 1 1)))
(assert (= temp___837 (mk___t o14 (mk 1 o13))))
(assert (=> (= (length temp___837) 0) (= o21 (mk___t (temp___String_Literal_836 Tuple0) (mk 1 1)))))
(assert (=> (not (= (length temp___837) 0)) (=> (<= 1 1) (= o15 (+ (- 1 1) 1)))))
(assert (=> (not (= (length temp___837) 0)) (=> (not (<= 1 1)) (= o15 0))))
(assert (=> (not (= (length temp___837) 0)) (=> (<= (to_rep1 (first (rt temp___837))) (to_rep1 (last (rt temp___837)))) (= o16 (+ (- (to_rep1 (last (rt temp___837))) (to_rep1 (first (rt temp___837)))) 1)))))
(assert (=> (not (= (length temp___837) 0)) (=> (not (<= (to_rep1 (first (rt temp___837))) (to_rep1 (last (rt temp___837))))) (= o16 0))))
(assert (=> (not (= (length temp___837) 0)) (= o17 (+ o16 o15))))
(assert (=> (not (= (length temp___837) 0)) (= o18 (+ (to_rep1 (first (rt temp___837))) o17))))
(assert (=> (not (= (length temp___837) 0)) (= o19 (- o18 1))))
(assert (=> (not (= (length temp___837) 0)) (and (= o20 o19) (in_range2 o19))))
(assert (=> (not (= (length temp___837) 0)) (= o21 (mk___t (concat1 (elts temp___837) (to_rep1 (first (rt temp___837))) (to_rep1 (last (rt temp___837))) (temp___String_Literal_836 Tuple0) 1 1) (mk (to_rep1 (first (rt temp___837))) o20)))))
