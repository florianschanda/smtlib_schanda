...
(assert (=> (not (= first_available1 0)) (and (= o52 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o52))))
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o52) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o51 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o51)))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (= result11 (ite (= o51 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result12 true)) (= result11 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o53 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o53))))
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o53 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (and (= o49 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o49)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (= result13 (ite (< 0 o49) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (and (= o48 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range7 o48))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (= result13 true) (= result10 (ite (= o48 first_allocated1) true false))))))
(assert (=> (= result11 true) (=> (not (= first_allocated1 0)) (=> (not (= result13 true)) (= result10 false)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (and (= o50 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o50)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated1 0))) (= result10 (ite (= o50 0) true false)))))
