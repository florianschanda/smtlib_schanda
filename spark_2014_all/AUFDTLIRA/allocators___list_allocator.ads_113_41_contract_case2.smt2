...
(declare-const temp___3331 us_rep1)
...
(declare-const model____split_fields5 us_split_fields)
(declare-const model____split_fields6 us_split_fields__ref)
(declare-const data3 map__ref)
(declare-const first_available3 int__ref)
(declare-const model____split_fields7 us_split_fields)
...
(assert (=> (= result true) (= o14 (store data o13 (mk___rep1 (mk___split_fields1 o11 o12))))))
...
(assert (=> (= result true) (= (mk___split_fields__ref (mk___split_fields result3 result4)) (mk___split_fields__ref (mk___split_fields model____split_fields model____split_fields1)))))
(assert (=> (= result true) (= model____split_fields4 (mk___split_fields temp___331 temp___3311))))
...
(assert (=> (= result true) (= result5 (mk___split_fields__ref model____split_fields4))))
(assert (=> (= result true) (= model____split_fields5 (mk___split_fields temp___333 temp___3331))))
(assert (=> (not (= result true)) (= first_available2 first_available)))
(assert (=> (not (= result true)) (= data2 data)))
(assert (=> (not (= result true)) (= model____split_fields5 (mk___split_fields model____split_fields model____split_fields1))))
(assert (=> (not (= result true)) (= first_available2 first_available1)))
(assert (=> (not (= result true)) (= data2 data1)))
(assert (=> (not (= result true)) (= model____split_fields5 (mk___split_fields model____split_fields2 model____split_fields3))))
(assert (= first_available3 (mk_int__ref first_available2)))
(assert (= data3 (mk_map__ref data2)))
(assert (= model____split_fields6 (mk___split_fields__ref model____split_fields5)))
...
(assert (not (= (is_prepend model____split_fields res (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields6))) true)))
(check-sat)
(exit)
