...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_132 us_void_param) 1)) 101) (= (to_rep (select (temp___String_Literal_132 us_void_param) 2)) 109)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 3)) 112)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 5)) 121)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 7)) 115)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 10)) 99)) (= (to_rep (select (temp___String_Literal_132 us_void_param) 11)) 107)) :pattern ((temp___String_Literal_132 us_void_param)))))
...
(assert (= empty_stack_str (of_array (temp___String_Literal_132 Tuple0) 1 11)))
