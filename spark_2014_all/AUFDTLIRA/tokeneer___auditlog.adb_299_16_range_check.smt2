...
(declare-fun temp___String_Literal_1749 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1749 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 4)) 111)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 7)) 111)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 8)) 98)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 9)) 116)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 10)) 97)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 12)) 110)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 13)) 105)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 14)) 110)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 15)) 103)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 17)) 116)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 18)) 105)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 19)) 109)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 20)) 101)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 21)) 115)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 23)) 102)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 24)) 114)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 25)) 111)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 26)) 109)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 28)) 102)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 29)) 105)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 30)) 108)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 31)) 101)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 32)) 46)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 33)) 66)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 34)) 101)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 35)) 115)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 36)) 116)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 38)) 101)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 39)) 115)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 40)) 116)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 41)) 105)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 42)) 109)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 43)) 97)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 44)) 116)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 45)) 101)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 47)) 105)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 48)) 115)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 50)) 102)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 51)) 114)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 52)) 111)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 53)) 109)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 54)) 58)) (= (to_rep (select (temp___String_Literal_1749 us_void_param) 55)) 32)) :pattern ((temp___String_Literal_1749 us_void_param)))))
(declare-fun temp___String_Literal_1751 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_1751 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1751 us_void_param) 2)) 116)) (= (to_rep (select (temp___String_Literal_1751 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_1751 us_void_param) 4)) 58)) (= (to_rep (select (temp___String_Literal_1751 us_void_param) 5)) 32)) :pattern ((temp___String_Literal_1751 us_void_param)))))
(declare-fun temp___String_Literal_1755 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1755 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_1755 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1755 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_1755 us_void_param) 4)) 109)) (= (to_rep (select (temp___String_Literal_1755 us_void_param) 5)) 58)) (= (to_rep (select (temp___String_Literal_1755 us_void_param) 6)) 32)) :pattern ((temp___String_Literal_1755 us_void_param)))))
(declare-fun temp___String_Literal_1757 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_1757 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1757 us_void_param) 2)) 116)) (= (to_rep (select (temp___String_Literal_1757 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_1757 us_void_param) 4)) 58)) (= (to_rep (select (temp___String_Literal_1757 us_void_param) 5)) 32)) :pattern ((temp___String_Literal_1757 us_void_param)))))
...
(declare-const temp___1748 (Array Int character))
(declare-const temp___17481 t1)
...
(assert (= o temp___1748))
(assert (= (mk1 r34b r35b) temp___17481))
(assert (= (ite (<= (to_rep1 (first2 temp___17481)) (to_rep1 (last2 temp___17481))) (+ (- (to_rep1 (last2 temp___17481)) (to_rep1 (first2 temp___17481))) 1) 0) (ite (<= 1 21) (+ (- 21 1) 1) 0)))
(assert (= o1 (slide temp___1748 (to_rep1 (first2 temp___17481)) 1)))
