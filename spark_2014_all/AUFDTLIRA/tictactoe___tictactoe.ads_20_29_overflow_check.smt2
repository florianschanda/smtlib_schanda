...
(assert (in_range1 x))
(assert (in_range1 y))
(assert (=> (<= 3 x) (=> (<= 3 y) (and (= o7 (one_free_slot 3 3 my_board)) (and (in_range o7) (= o7 (ite (= (to_rep (select (select my_board 3) 3)) 0) 1 0)))))))
(assert (=> (<= 3 x) (=> (not (<= 3 y)) (= o7 0))))
(assert (=> (<= 3 x) (=> (<= 2 y) (and (= o4 (one_free_slot 3 2 my_board)) (and (in_range o4) (= o4 (ite (= (to_rep (select (select my_board 3) 2)) 0) 1 0)))))))
(assert (=> (<= 3 x) (=> (not (<= 2 y)) (= o4 0))))
(assert (=> (<= 3 x) (and (= o5 (one_free_slot 3 1 my_board)) (and (in_range o5) (= o5 (ite (= (to_rep (select (select my_board 3) 1)) 0) 1 0))))))
(assert (=> (<= 3 x) (= o6 (+ o5 o4))))
...
(assert (<= 2 x))
(assert (=> (<= 3 y) (and (= o3 (one_free_slot 2 3 my_board)) (and (in_range o3) (= o3 (ite (= (to_rep (select (select my_board 2) 3)) 0) 1 0))))))
(assert (=> (not (<= 3 y)) (= o3 0)))
(assert (=> (<= 2 y) (and (= o (one_free_slot 2 2 my_board)) (and (in_range o) (= o (ite (= (to_rep (select (select my_board 2) 2)) 0) 1 0))))))
(assert (=> (not (<= 2 y)) (= o 0)))
(assert (and (= o1 (one_free_slot 2 1 my_board)) (and (in_range o1) (= o1 (ite (= (to_rep (select (select my_board 2) 1)) 0) 1 0)))))
(assert (= o2 (+ o1 o)))
