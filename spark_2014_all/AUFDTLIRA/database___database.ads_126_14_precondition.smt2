...
(assert (or (and (and (= accounts_balance3 (mk_map__ref1 accounts_balance)) (= accounts_balance4 accounts_balance1)) (and (and (and (and (and (= o9 (currency account accounts_balance)) (and (in_range o9) (= o9 (to_rep (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))))))) (= o10 (ite (= o9 (to_rep (rec__money__amount__currency (us_split_fields1 sum)))) true false))) (= result3 (ite (not (= o10 true)) true false))) (ite (= result3 true) (= result2 true) (and (and (and (and (and (= (mk___rep (mk___split_fields o3 o4)) (balance account links accounts_balance)) (= (mk___rep (mk___split_fields o3 o4)) (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))) (and (= o3 o5) (= o4 o6))) (= o7 o6)) (= o8 (to_rep1 o7))) (= result2 (ite (< o8 (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))) true false))))) (= result2 true))) (and (and (and (and (and (and (= o9 (currency account accounts_balance)) (and (in_range o9) (= o9 (to_rep (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))))))) (= o10 (ite (= o9 (to_rep (rec__money__amount__currency (us_split_fields1 sum)))) true false))) (= result3 (ite (not (= o10 true)) true false))) (ite (= result3 true) (= result2 true) (and (and (and (and (and (= (mk___rep (mk___split_fields o3 o4)) (balance account links accounts_balance)) (= (mk___rep (mk___split_fields o3 o4)) (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))) (and (= o3 o5) (= o4 o6))) (= o7 o6)) (= o8 (to_rep1 o7))) (= result2 (ite (< o8 (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))) true false))))) (not (= result2 true))) (and (and (= accounts_balance3 (mk_map__ref1 accounts_balance2)) (= accounts_balance4 accounts_balance2)) (and (and (and (and (and (= (mk___rep (mk___split_fields o11 o12)) (osubtract (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))) sum)) (= (bool_eq (mk___rep (mk___split_fields o11 o12)) (mk___rep (mk___split_fields (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))) (of_rep1 (- (to_rep1 (rec__money__amount__raw (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account)))))) (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))))))) true)) (and (and (= o13 o11) (= o14 o12)) (= (rec__database__account_balance__account (us_split_fields5 (select accounts_balance account))) o15))) (and (and (= o16 o13) (= o17 o14)) (= o18 o15))) (= o19 (store accounts_balance account (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o16 o17)) o18))))) (and (= result4 (mk_map__ref1 accounts_balance)) (= accounts_balance2 o19)))))))
(assert (= accounts_balance5 accounts_balance3))
(assert (= accounts_balance6 accounts_balance4))
(assert (and (= (mk___rep (mk___split_fields o20 o21)) (osubtract (balance account links accounts_balance) sum)) (= (bool_eq (mk___rep (mk___split_fields o20 o21)) (mk___rep (mk___split_fields (rec__money__amount__currency (us_split_fields1 (balance account links accounts_balance))) (of_rep1 (- (to_rep1 (rec__money__amount__raw (us_split_fields1 (balance account links accounts_balance)))) (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))))))) true)))
