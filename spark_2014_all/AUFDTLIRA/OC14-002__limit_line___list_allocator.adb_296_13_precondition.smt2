...
(assert (=> (not (= first_available1 0)) (= result13 (ite (< 0 o66) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (and (= o65 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o65)))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (= result12 (ite (= o65 first_available1) true false)))))
...
(assert (=> (not (not (= first_available1 0))) (= result12 (ite (= o67 0) true false))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (and (= o63 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o63)))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (= result14 (ite (< 0 o63) true false)))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (=> (= result14 true) (and (= o62 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range7 o62))))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (=> (= result14 true) (= result11 (ite (= o62 first_allocated2) true false))))))
(assert (=> (= result12 true) (=> (not (= first_allocated2 0)) (=> (not (= result14 true)) (= result11 false)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated2 0))) (and (= o64 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o64)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated2 0))) (= result11 (ite (= o64 0) true false)))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o60 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o60))))
