...
(assert (not (= (ite (<= (to_rep1 (first temp___6301)) (to_rep1 (last temp___6301))) (+ (- (to_rep1 (last temp___6301)) (to_rep1 (first temp___6301))) 1) 0) (ite (<= (to_rep1 v__first) (to_rep1 v__last)) (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1) 0))))
(check-sat)
(exit)
