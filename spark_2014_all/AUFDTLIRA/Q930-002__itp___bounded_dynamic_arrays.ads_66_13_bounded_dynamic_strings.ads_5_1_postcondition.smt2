...
(define-fun dynamic_invariant1 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 2147483647)) (in_range1 temp___expr_222)))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true true) (dynamic_invariant1 (length1 this) true false true true)) :pattern ((length1 this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true true) (= (length1 this) (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length1 this)))))
