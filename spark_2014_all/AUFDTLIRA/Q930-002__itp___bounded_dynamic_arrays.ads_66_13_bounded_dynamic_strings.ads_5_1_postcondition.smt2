...
(define-fun dynamic_invariant1 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 2147483647)) (in_range1 temp___expr_195)))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true) (dynamic_invariant1 (length1 this) true false true)) :pattern ((length1 this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant this true true true) (= (length1 this) (to_rep (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length1 this)))))
