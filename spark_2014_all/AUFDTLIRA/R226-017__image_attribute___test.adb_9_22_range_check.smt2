...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_197 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_197 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_197 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_197 us_void_param) 4)) 58)) (= (to_rep (select (temp___String_Literal_197 us_void_param) 5)) 32)) :pattern ((temp___String_Literal_197 us_void_param)))))
(declare-fun temp___String_Literal_200 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_200 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_200 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_200 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_200 us_void_param) 4)) 58)) (= (to_rep (select (temp___String_Literal_200 us_void_param) 5)) 32)) :pattern ((temp___String_Literal_200 us_void_param)))))
...
(declare-const foo1 Int)
(assert (= result foo))
(assert (= foo1 0))
(assert (in_range3 foo1))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1)))))) (= o (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1))))))) (= o 0)))
(assert (=> (<= 1 5) (= o1 (+ (- 5 1) 1))))
(assert (=> (not (<= 1 5)) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ 1 o2)))
...
(assert (= o6 (concat1 (temp___String_Literal_197 Tuple0) 1 5 (elts (to_string (attr__ATTRIBUTE_IMAGE3 foo1))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1))))))))
(assert (= o7 (mk 1 o5)))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1)))))) (= o8 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 foo1))))))) (= o8 0)))
(assert (=> (<= 1 5) (= o9 (+ (- 5 1) 1))))
(assert (=> (not (<= 1 5)) (= o9 0)))
(assert (= o10 (+ o9 o8)))
(assert (= o11 (+ 1 o10)))
