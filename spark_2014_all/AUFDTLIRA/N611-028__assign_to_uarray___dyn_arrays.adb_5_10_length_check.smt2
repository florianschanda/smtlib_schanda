...
(assert (not (= (ite (<= (to_rep1 (first (mk 1 100))) (to_rep1 (last (mk 1 100)))) (+ (- (to_rep1 (last (mk 1 100))) (to_rep1 (first (mk 1 100)))) 1) 0) (ite (<= (to_rep1 to____first) (to_rep1 to____last)) (+ (- (to_rep1 to____last) (to_rep1 to____first)) 1) 0))))
(check-sat)
(exit)
