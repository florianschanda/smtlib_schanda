...
(assert (= result5 (ite (= o19 r2) true false)))
(assert (=> (= result5 true) (and (= o14 (contains avail3 e1)) (=> (= (of_int 1) true) (=> (exists ((e2 Int)) (and (and (in_range4 e2) (= (contains avail3 e2) true)) (= e2 e1))) (= o14 true))))))
(assert (=> (= result5 true) (= (= o15 true) (in_range4 e1))))
(assert (=> (= result5 true) (= result6 (ite (= o15 true) o14 false))))
...
(assert (=> (= result4 true) (and (= o12 (contains alloc3 e)) (=> (= (of_int 1) true) (=> (exists ((e2 Int)) (and (and (in_range4 e2) (= (contains alloc3 e2) true)) (= e2 e))) (= o12 true))))))
(assert (=> (= result4 true) (= (= o13 true) (in_range4 e))))
(assert (=> (= result4 true) (= result7 (ite (= o13 true) o12 false))))
...
(assert (and (= o10 rr) (in_range4 rr)))
(assert (and (= o11 (contains alloc3 o10)) (=> (= (of_int 1) true) (=> (exists ((e2 Int)) (and (and (in_range4 e2) (= (contains alloc3 e2) true)) (= e2 o10))) (= o11 true)))))
