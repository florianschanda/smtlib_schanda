...
(assert (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt r3))) i2) (<= i2 25)) (= (of_int (to_rep (select (elts r3) i2))) true))))
(declare-const i2 Int)
(assert (<= 26 i2))
(assert (<= i2 (to_rep1 (last (rt r3)))))
(assert (not (not (= (of_int (to_rep (select (elts r3) i2))) true))))
(check-sat)
(exit)
