...
(assert (and (= o4 (remove c (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant o4 true false true true) (and (= (invariant__ o4) true) (and (= (to_rep (last o3)) (- (to_rep (last (rt c))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep1 (select (elts c) k)) (to_rep1 (select o2 k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep (last (rt c))))) (= (to_rep1 (select (elts c) k)) (to_rep1 (select o2 (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep (last (rt c))) 1))) (= (to_rep1 (select (elts c) (+ k 1))) (to_rep1 (select o2 k))))))))))))
(assert (and (= o5 (remove b (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (dynamic_invariant o5 true false true true) (and (= (invariant__ o5) true) (and (= (to_rep (last o1)) (- (to_rep (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) (= (to_rep1 (select (elts b) k)) (to_rep1 (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k) (<= k (to_rep (last (rt b))))) (= (to_rep1 (select (elts b) k)) (to_rep1 (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) k) (<= k (- (to_rep (last (rt b))) 1))) (= (to_rep1 (select (elts b) (+ k 1))) (to_rep1 (select o k))))))))))))
