...
(assert (= j2 result4))
(assert (= j3 (+ j2 1)))
(assert (and (= temp___2951 (+ j3 (- i1 1))) (in_range1 (+ j3 (- i1 1)))))
(assert (and (<= (to_rep1 (first (rt haystack))) temp___2951) (<= temp___2951 (to_rep1 (last (rt haystack))))))
(assert (= o10 temp___2951))
