...
(assert (forall ((temp___215 Int)) (= (select (temp___213 temp___215) 1) (of_rep1 temp___215))))
...
(declare-const temp___487 (Array Int element))
(declare-const temp___4871 less_than_max)
...
(assert (= e1 o2))
(assert (not (in_range (- (to_rep s__split_fields1) 1))))
(check-sat)
(exit)
