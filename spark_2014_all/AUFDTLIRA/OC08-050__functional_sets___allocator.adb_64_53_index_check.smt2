...
(assert (= data2 data1))
(assert (= res2 res1))
(assert (and (= (bool_eq data3 1 3 data 1 3) true) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (to_rep (select data3 rr1)) 1)))))
(assert (and (and (and (forall ((temp___376 Int)) (=> (and (<= 1 temp___376) (<= temp___376 3)) (=> (< r2 temp___376) (= (select data3 temp___376) (select data temp___376))))) (=> (<= 0 3) (in_range1 res3))) (=> (<= 1 3) (in_range2 r2))) (and (<= 1 r2) (<= r2 3))))
(assert (= (bool_eq data3 1 3 data 1 3) true))
(assert (<= 1 rr))
(assert (<= rr r2))
(assert (not (<= 1 rr)))
(check-sat)
