...
(assert (and (and (and (forall ((temp___408 Int)) (=> (and (<= 1 temp___408) (<= temp___408 3)) (=> (< r2 temp___408) (= (select data3 temp___408) (select data temp___408))))) (=> (<= 0 3) (in_range1 res3))) (=> (<= 1 3) (in_range2 r2))) (and (<= 1 r2) (<= r2 3))))
