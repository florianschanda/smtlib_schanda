...
(assert (=> (not (= (length a) 0)) (=> (<= (to_rep (first (rt b))) (to_rep (last (rt b)))) (= o3 (+ (- (to_rep (last (rt b))) (to_rep (first (rt b)))) 1)))))
(assert (=> (not (= (length a) 0)) (=> (not (<= (to_rep (first (rt b))) (to_rep (last (rt b))))) (= o3 0))))
(assert (=> (not (= (length a) 0)) (=> (<= (to_rep (first (rt a))) (to_rep (last (rt a)))) (= o4 (+ (- (to_rep (last (rt a))) (to_rep (first (rt a)))) 1)))))
(assert (=> (not (= (length a) 0)) (=> (not (<= (to_rep (first (rt a))) (to_rep (last (rt a))))) (= o4 0))))
(assert (=> (not (= (length a) 0)) (= o5 (+ o4 o3))))
(assert (=> (not (= (length a) 0)) (= o6 (+ (to_rep (first (rt a))) o5))))
(assert (=> (not (= (length a) 0)) (= o7 (- o6 1))))
(assert (=> (not (= (length a) 0)) (and (= o8 o7) (in_range o7))))
...
(assert (=> (not (= (length a) 0)) (= (mk (to_rep (first (rt a))) o8) concat__three__d__assume1)))
(assert (= result d))
...
(assert (not (= (to_rep d__last) (+ (+ (to_rep (last (rt a))) 1) (- (to_rep (last (rt b))) (to_rep (first (rt b))))))))
(check-sat)
(exit)
