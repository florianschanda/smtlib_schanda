...
(declare-fun temp___324 (Int Int Int Int Int Int Int Int Int Int) (Array Int value))
(declare-fun temp___337 (Int Int Int Int Int Int Int Int Int Int) (Array Int value))
...
(assert (forall ((temp___326 Int) (temp___327 Int) (temp___328 Int) (temp___329 Int) (temp___330 Int) (temp___331 Int) (temp___332 Int) (temp___333 Int) (temp___334 Int) (temp___335 Int)) (let ((temp___325 (temp___324 temp___326 temp___327 temp___328 temp___329 temp___330 temp___331 temp___332 temp___333 temp___334 temp___335))) (=> (and (and (and (and (and (and (and (and (and (dynamic_invariant1 temp___326 true true true true) (dynamic_invariant1 temp___327 true true true true)) (dynamic_invariant1 temp___328 true true true true)) (dynamic_invariant1 temp___329 true true true true)) (dynamic_invariant1 temp___330 true true true true)) (dynamic_invariant1 temp___331 true true true true)) (dynamic_invariant1 temp___332 true true true true)) (dynamic_invariant1 temp___333 true true true true)) (dynamic_invariant1 temp___334 true true true true)) (dynamic_invariant1 temp___335 true true true true)) (and (and (and (and (and (and (and (and (and (= (to_rep3 (select temp___325 1)) temp___326) (= (to_rep3 (select temp___325 2)) temp___327)) (= (to_rep3 (select temp___325 3)) temp___328)) (= (to_rep3 (select temp___325 4)) temp___329)) (= (to_rep3 (select temp___325 5)) temp___330)) (= (to_rep3 (select temp___325 6)) temp___331)) (= (to_rep3 (select temp___325 7)) temp___332)) (= (to_rep3 (select temp___325 8)) temp___333)) (= (to_rep3 (select temp___325 9)) temp___334)) (= (to_rep3 (select temp___325 10)) temp___335))))))
(assert (forall ((temp___339 Int) (temp___340 Int) (temp___341 Int) (temp___342 Int) (temp___343 Int) (temp___344 Int) (temp___345 Int) (temp___346 Int) (temp___347 Int) (temp___348 Int)) (let ((temp___338 (temp___337 temp___339 temp___340 temp___341 temp___342 temp___343 temp___344 temp___345 temp___346 temp___347 temp___348))) (=> (and (and (and (and (and (and (and (and (and (dynamic_invariant1 temp___339 true true true true) (dynamic_invariant1 temp___340 true true true true)) (dynamic_invariant1 temp___341 true true true true)) (dynamic_invariant1 temp___342 true true true true)) (dynamic_invariant1 temp___343 true true true true)) (dynamic_invariant1 temp___344 true true true true)) (dynamic_invariant1 temp___345 true true true true)) (dynamic_invariant1 temp___346 true true true true)) (dynamic_invariant1 temp___347 true true true true)) (dynamic_invariant1 temp___348 true true true true)) (and (and (and (and (and (and (and (and (and (= (to_rep3 (select temp___338 1)) temp___339) (= (to_rep3 (select temp___338 2)) temp___340)) (= (to_rep3 (select temp___338 3)) temp___341)) (= (to_rep3 (select temp___338 4)) temp___342)) (= (to_rep3 (select temp___338 5)) temp___343)) (= (to_rep3 (select temp___338 6)) temp___344)) (= (to_rep3 (select temp___338 7)) temp___345)) (= (to_rep3 (select temp___338 8)) temp___346)) (= (to_rep3 (select temp___338 9)) temp___347)) (= (to_rep3 (select temp___338 10)) temp___348))))))
...
(declare-const temp___358 us_rep3)
...
(assert (= o o1))
(assert (= o2 o1))
(assert (= (temp___324 5 1 3 0 9 8 2 7 4 6) o3))
...
(assert (= o4 o5))
(assert (= o6 o5))
(assert (= (temp___337 4 8 6 9 0 1 7 2 5 3) o7))
...
(assert (and (= o13 (add (mk___rep t1__split_discrs t1__split_fields2) (mk___rep t2__split_discrs t2__split_fields2))) (and (dynamic_invariant o13 true false true true) (and (= (same_range o13 (mk___rep t1__split_discrs t1__split_fields2)) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 o13))) j)) (+ (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t2__split_fields2)) j))))))))))
(assert (= o14 o13))
(assert (= temp___358 (mk___rep3 (us_split_discrs1 o14) (mk___split_fields3 (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 o14)))))))
(assert (= result2 (mk___split_fields__ref3 (mk___split_fields3 t3__split_fields))))
(assert (= t3__split_fields1 (us_split_fields7 temp___358)))
(assert (= t3__split_discrs (us_split_discrs4 temp___358)))
(declare-const i Int)
(assert (<= 1 i))
