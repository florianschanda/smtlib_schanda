...
(declare-const i Int)
(assert (<= 1 i))
(assert (<= i (to_rep2 (rec__simple_unc_arrays__table__last t3__split_discrs))))
(assert (not (= (to_rep3 (select (rec__simple_unc_arrays__table__v3 t3__split_fields1) i)) 9)))
(check-sat)
(exit)
