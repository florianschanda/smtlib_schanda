...
(declare-fun concat2 ((Array Int value) Int Int (Array Int value) Int Int) (Array Int value))
...
(assert (forall ((v value)) (forall ((i Int)) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
(define-fun bool_eq2 ((a (Array Int value)) (a__first Int) (a__last Int) (b (Array Int value)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep3 (select a temp___idx_132)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(declare-fun compare1 ((Array Int value) Int Int (Array Int value) Int Int) Int)
(assert (forall ((a (Array Int value)) (b (Array Int value))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq2 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int value)) (b (Array Int value))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep3 (select a (+ i 1))) (to_rep3 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int value)) (b (Array Int value))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep3 (select b (+ i 1))) (to_rep3 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant ((temp___expr_150 us_rep) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (let ((temp___151 (rec__simple_unc_arrays__table__last (us_split_discrs1 temp___expr_150)))) (and (dynamic_property2 1 (to_rep2 temp___151) (first3 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_150))) (last3 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_150)))) (and (= (first3 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_150))) 1) (= (last3 (rec__simple_unc_arrays__table__v (us_split_fields1 temp___expr_150))) (to_rep2 temp___151))))))
...
(assert (forall ((a us_rep) (b us_rep)) (! (=> (and (and (dynamic_invariant a true true true) (dynamic_invariant b true true true)) (= (same_range a b) true)) (let ((result (add a b))) (and (and (= (same_range result a) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= (to_rep3 (let ((temp___170 (rec__simple_unc_arrays__table__v (us_split_fields1 result)))) (select (to_array1 temp___170) j))) (+ (to_rep3 (let ((temp___171 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array1 temp___171) j))) (to_rep3 (let ((temp___172 (rec__simple_unc_arrays__table__v (us_split_fields1 b)))) (select (to_array1 temp___172) j)))))))) (dynamic_invariant result true false true)))) :pattern ((add a b)))))
(define-fun dynamic_invariant1 ((temp___expr_139 Int) (temp___is_init_136 Bool) (temp___skip_constant_137 Bool) (temp___do_toplevel_138 Bool)) Bool (=> (or (= temp___is_init_136 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_139)))
...
(assert (forall ((a us_rep)) (! (=> (and (dynamic_invariant a true true true) (not (= (empty a) true))) (let ((result (min a))) (and (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= result (to_rep3 (let ((temp___194 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array1 temp___194) j)))))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= result (to_rep3 (let ((temp___193 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array1 temp___193) j))))))) (dynamic_invariant1 result true false true)))) :pattern ((min a)))))
(declare-fun max (us_rep) Int)
(declare-fun max__function_guard (Int us_rep) Bool)
(assert (forall ((a us_rep)) (! (=> (and (dynamic_invariant a true true true) (not (= (empty a) true))) (let ((result (max a))) (and (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= (to_rep3 (let ((temp___202 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array1 temp___202) j))) result))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= result (to_rep3 (let ((temp___201 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array1 temp___201) j))))))) (dynamic_invariant1 result true false true)))) :pattern ((max a)))))
(declare-fun average (us_rep) Int)
(declare-fun average__function_guard (Int us_rep) Bool)
(assert (forall ((a us_rep)) (! (=> (and (dynamic_invariant a true true true) (not (= (empty a) true))) (let ((result (average a))) (and (and (<= (min a) result) (<= result (max a))) (dynamic_invariant1 result true false true)))) :pattern ((average a)))))
...
(assert (forall ((a us_rep)) (forall ((v Int)) (! (=> (and (dynamic_invariant a true true true) (dynamic_invariant1 v true true true)) (let ((result (search a v))) (and (or (and (= result 0) (= (not_in a v 1 (to_rep2 (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))) true)) (and (= (to_rep3 (let ((temp___218 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array1 temp___218) result))) v) (= (not_in a v 1 (- result 1)) true))) (dynamic_invariant2 result true false true)))) :pattern ((search a v))))))
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___133 (rec__simple_unc_arrays__table__v (us_split_fields1 r)))) (to_array1 temp___133)))))
...
(define-fun of_base1 ((r us_rep)) us_rep2 (mk___rep2 (us_split_discrs1 r) (mk___split_fields2 (let ((temp___134 (rec__simple_unc_arrays__table__v (us_split_fields1 r)))) (to_array1 temp___134)))))
...
(define-fun of_base2 ((r us_rep)) us_rep3 (mk___rep3 (us_split_discrs1 r) (mk___split_fields3 (let ((temp___135 (rec__simple_unc_arrays__table__v (us_split_fields1 r)))) (to_array1 temp___135)))))
...
(define-fun dynamic_invariant3 ((temp___expr_283 us_rep3) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool)) Bool (=> (not (= temp___skip_constant_281 true)) (in_range11 10 (to_base2 temp___expr_283))))
(define-fun default_initial_assumption ((temp___expr_286 us_rep3) (temp___skip_top_level_287 Bool)) Bool (= (to_rep2 (rec__simple_unc_arrays__table__last (us_split_discrs4 temp___expr_286))) 10))
(declare-const t3__split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun temp___292 (Int Int Int Int Int Int Int Int Int Int) (Array Int value))
(assert (forall ((temp___294 Int) (temp___295 Int) (temp___296 Int) (temp___297 Int) (temp___298 Int) (temp___299 Int) (temp___300 Int) (temp___301 Int) (temp___302 Int) (temp___303 Int)) (let ((temp___293 (temp___292 temp___294 temp___295 temp___296 temp___297 temp___298 temp___299 temp___300 temp___301 temp___302 temp___303))) (and (and (and (and (and (and (and (and (and (= (select temp___293 1) (of_rep3 temp___294)) (= (select temp___293 2) (of_rep3 temp___295))) (= (select temp___293 3) (of_rep3 temp___296))) (= (select temp___293 4) (of_rep3 temp___297))) (= (select temp___293 5) (of_rep3 temp___298))) (= (select temp___293 6) (of_rep3 temp___299))) (= (select temp___293 7) (of_rep3 temp___300))) (= (select temp___293 8) (of_rep3 temp___301))) (= (select temp___293 9) (of_rep3 temp___302))) (= (select temp___293 10) (of_rep3 temp___303))))))
(declare-fun temp___305 (Int Int Int Int Int Int Int Int Int Int) (Array Int value))
(assert (forall ((temp___307 Int) (temp___308 Int) (temp___309 Int) (temp___310 Int) (temp___311 Int) (temp___312 Int) (temp___313 Int) (temp___314 Int) (temp___315 Int) (temp___316 Int)) (let ((temp___306 (temp___305 temp___307 temp___308 temp___309 temp___310 temp___311 temp___312 temp___313 temp___314 temp___315 temp___316))) (and (and (and (and (and (and (and (and (and (= (select temp___306 1) (of_rep3 temp___307)) (= (select temp___306 2) (of_rep3 temp___308))) (= (select temp___306 3) (of_rep3 temp___309))) (= (select temp___306 4) (of_rep3 temp___310))) (= (select temp___306 5) (of_rep3 temp___311))) (= (select temp___306 6) (of_rep3 temp___312))) (= (select temp___306 7) (of_rep3 temp___313))) (= (select temp___306 8) (of_rep3 temp___314))) (= (select temp___306 9) (of_rep3 temp___315))) (= (select temp___306 10) (of_rep3 temp___316))))))
(declare-fun temp___String_Literal_321 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_321 us_void_param) 1)) 77) (= (to_rep (select (temp___String_Literal_321 us_void_param) 2)) 97)) (= (to_rep (select (temp___String_Literal_321 us_void_param) 3)) 120)) (= (to_rep (select (temp___String_Literal_321 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_321 us_void_param) 5)) 61)) (= (to_rep (select (temp___String_Literal_321 us_void_param) 6)) 32)) :pattern ((temp___String_Literal_321 us_void_param)))))
(declare-fun temp___String_Literal_322 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_322 us_void_param) 1)) 77) (= (to_rep (select (temp___String_Literal_322 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_322 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_322 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_322 us_void_param) 5)) 61)) (= (to_rep (select (temp___String_Literal_322 us_void_param) 6)) 32)) :pattern ((temp___String_Literal_322 us_void_param)))))
(declare-fun temp___String_Literal_323 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_323 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_323 us_void_param) 2)) 118)) (= (to_rep (select (temp___String_Literal_323 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_323 us_void_param) 4)) 114)) (= (to_rep (select (temp___String_Literal_323 us_void_param) 5)) 97)) (= (to_rep (select (temp___String_Literal_323 us_void_param) 6)) 103)) (= (to_rep (select (temp___String_Literal_323 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_323 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_323 us_void_param) 9)) 61)) (= (to_rep (select (temp___String_Literal_323 us_void_param) 10)) 32)) :pattern ((temp___String_Literal_323 us_void_param)))))
(declare-fun temp___String_Literal_324 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_324 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_324 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_324 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_324 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_324 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_324 us_void_param) 6)) 48)) (= (to_rep (select (temp___String_Literal_324 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_324 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_324 us_void_param) 9)) 110)) (= (to_rep (select (temp___String_Literal_324 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_324 us_void_param) 11)) 84)) (= (to_rep (select (temp___String_Literal_324 us_void_param) 12)) 49)) (= (to_rep (select (temp___String_Literal_324 us_void_param) 13)) 32)) :pattern ((temp___String_Literal_324 us_void_param)))))
(declare-fun temp___String_Literal_325 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_325 us_void_param) 1)) 70) (= (to_rep (select (temp___String_Literal_325 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_325 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_325 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_325 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_325 us_void_param) 6)) 57)) (= (to_rep (select (temp___String_Literal_325 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_325 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_325 us_void_param) 9)) 110)) (= (to_rep (select (temp___String_Literal_325 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_325 us_void_param) 11)) 84)) (= (to_rep (select (temp___String_Literal_325 us_void_param) 12)) 50)) (= (to_rep (select (temp___String_Literal_325 us_void_param) 13)) 32)) :pattern ((temp___String_Literal_325 us_void_param)))))
...
(assert true)
(assert (forall ((a us_rep)) (forall ((v Int) (low Int) (up Int)) (! (= (= (not_in a v low up) true) (or (< (to_rep2 (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) up) (forall ((j Int)) (=> (and (<= low j) (<= j up)) (not (= (to_rep3 (let ((temp___214 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array1 temp___214) j))) v)))))) :pattern ((not_in a v low up))))))
...
(declare-const t3__split_fields (Array Int value))
...
(declare-const temp___326 us_rep3)
(declare-const i Int)
(declare-const o15 us_rep)
(declare-const o16 us_rep)
(declare-const temp___330 us_rep3)
...
(declare-const t3__split_fields1 us_split_fields6)
(declare-const result3 us_split_fields__ref3)
(declare-const t3__split_fields2 us_split_fields6)
(declare-const t1__split_fields3 us_split_fields)
(assert (= (to_rep2 o) 10))
(assert (= o o1))
(assert (= o2 o1))
...
(assert (= t1__split_fields2 (mk___split_fields (mk___t1 my_test__t1__assume1 my_test__t1__assume2))))
(assert (= t1__split_discrs (mk___split_discrs my_test__t1__assume)))
(assert (dynamic_invariant (mk___rep t1__split_discrs t1__split_fields2) true false true))
...
(assert (= t2__split_fields2 (mk___split_fields (mk___t1 my_test__t2__assume1 my_test__t2__assume2))))
(assert (= t2__split_discrs (mk___split_discrs my_test__t2__assume)))
(assert (dynamic_invariant (mk___rep t2__split_discrs t2__split_fields2) true false true))
(assert (and (= us 10) (in_range4 10)))
(assert (= (to_rep2 (rec__simple_unc_arrays__table__last t3__split_discrs)) 10))
(assert (= 10 (to_rep2 (rec__simple_unc_arrays__table__last t3__split_discrs))))
(assert (and (= o8 (max (mk___rep t1__split_discrs t1__split_fields2))) (and (in_range5 o8) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (<= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) o8))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= o8 (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)))))))))
(assert (and (= o9 (min (mk___rep t1__split_discrs t1__split_fields2))) (and (in_range5 o9) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (<= o9 (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j))))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= o9 (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)))))))))
(assert (and (= o10 (average (mk___rep t1__split_discrs t1__split_fields2))) (and (in_range5 o10) (and (<= (min (mk___rep t1__split_discrs t1__split_fields2)) o10) (<= o10 (max (mk___rep t1__split_discrs t1__split_fields2)))))))
(assert (and (= o11 (search (mk___rep t1__split_discrs t1__split_fields2) 0)) (and (in_range4 o11) (or (and (= o11 0) (= (not_in (mk___rep t1__split_discrs t1__split_fields2) 0 1 (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs))) true)) (and (= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) o11)) 0) (= (not_in (mk___rep t1__split_discrs t1__split_fields2) 0 1 (- o11 1)) true))))))
(assert (and (= o12 (search (mk___rep t2__split_discrs t2__split_fields2) 9)) (and (in_range4 o12) (or (and (= o12 0) (= (not_in (mk___rep t2__split_discrs t2__split_fields2) 9 1 (to_rep2 (rec__simple_unc_arrays__table__last t2__split_discrs))) true)) (and (= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t2__split_fields2)) o12)) 9) (= (not_in (mk___rep t2__split_discrs t2__split_fields2) 9 1 (- o12 1)) true))))))
(assert (and (= o13 (add (mk___rep t1__split_discrs t1__split_fields2) (mk___rep t2__split_discrs t2__split_fields2))) (and (dynamic_invariant o13 true false true) (and (= (same_range o13 (mk___rep t1__split_discrs t1__split_fields2)) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep2 (rec__simple_unc_arrays__table__last t1__split_discrs)))) (= (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 o13))) j)) (+ (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t1__split_fields2)) j)) (to_rep3 (select (elts1 (rec__simple_unc_arrays__table__v t2__split_fields2)) j))))))))))
(assert (= o14 o13))
(assert (= temp___326 (mk___rep3 (us_split_discrs1 o14) (mk___split_fields3 (elts1 (rec__simple_unc_arrays__table__v (us_split_fields1 o14)))))))
(assert (= result2 (mk___split_fields__ref3 (mk___split_fields3 t3__split_fields))))
(assert (= t3__split_fields1 (us_split_fields7 temp___326)))
(assert (= t3__split_discrs (us_split_discrs4 temp___326)))
(declare-const i1 Int)
(assert (<= 1 i1))
(assert (<= i1 (to_rep2 (rec__simple_unc_arrays__table__last t3__split_discrs))))
(assert (not (= (to_rep3 (select (rec__simple_unc_arrays__table__v3 t3__split_fields1) i1)) 9)))
(check-sat)
(exit)
