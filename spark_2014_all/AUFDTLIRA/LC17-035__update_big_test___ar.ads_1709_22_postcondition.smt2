...
(assert (forall ((temp___3728 (Array Int us_rep))) (forall ((temp___3729 Int)) (forall ((temp___3730 us_rep)) (let ((temp___3727 (temp___3726 temp___3728 temp___3729 temp___3730))) (forall ((temp___3731 Int)) (ite (= temp___3731 temp___3729) (= (select temp___3727 temp___3731) temp___3730) (= (select temp___3727 temp___3731) (select temp___3728 temp___3731)))))))))
(declare-fun temp___3732 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3734 (Array Int et1))) (forall ((temp___3735 Int) (temp___3736 Int)) (let ((temp___3733 (temp___3732 temp___3734 temp___3735 temp___3736))) (forall ((temp___3737 Int)) (ite (= temp___3737 temp___3735) (= (select temp___3733 temp___3737) (of_rep temp___3736)) (= (select temp___3733 temp___3737) (select temp___3734 temp___3737))))))))
...
(assert (= a4 a5))
(assert (= a6 a4))
(assert (not (= (bool_eq2 a5 1 16 (temp___3726 b i (mk___rep (mk___split_fields (temp___3732 d j e) (rec__ar__rofa1__t1 (us_split_fields1 c))))) 1 16) true)))
(check-sat)
(exit)
