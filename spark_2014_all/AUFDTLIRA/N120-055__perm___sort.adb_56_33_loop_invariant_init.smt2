...
(assert (=> (not (= smallest1 current1)) (= (is_perm__logic (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true)))
(assert (=> (not (not (= smallest1 current1))) (= values2 values)))
(assert (=> (not (not (= smallest1 current1))) (= values2 values1)))
(assert (not (= (is_perm__logic (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true)))
(check-sat)
(exit)
