...
(assert (not (= (bool_eq2 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp___3550 r__split_fields j e) (temp___3556 r__split_fields1 i (temp___3562 (select r__split_fields1 i) j f))))) true)))
(check-sat)
(exit)
