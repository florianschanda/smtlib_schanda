...
(assert (forall ((temp___3493 (Array Int et1))) (forall ((temp___3494 Int) (temp___3495 Int)) (let ((temp___3492 (temp___3491 temp___3493 temp___3494 temp___3495))) (forall ((temp___3496 Int)) (ite (= temp___3496 temp___3494) (= (select temp___3492 temp___3496) (of_rep temp___3495)) (= (select temp___3492 temp___3496) (select temp___3493 temp___3496))))))))
(declare-fun temp___3497 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___3499 (Array Int (Array Int et1)))) (forall ((temp___3500 Int)) (forall ((temp___3501 (Array Int et1))) (let ((temp___3498 (temp___3497 temp___3499 temp___3500 temp___3501))) (forall ((temp___3502 Int)) (ite (= temp___3502 temp___3500) (= (select temp___3498 temp___3502) temp___3501) (= (select temp___3498 temp___3502) (select temp___3499 temp___3502)))))))))
(declare-fun temp___3503 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3505 (Array Int et1))) (forall ((temp___3506 Int) (temp___3507 Int)) (let ((temp___3504 (temp___3503 temp___3505 temp___3506 temp___3507))) (forall ((temp___3508 Int)) (ite (= temp___3508 temp___3506) (= (select temp___3504 temp___3508) (of_rep temp___3507)) (= (select temp___3504 temp___3508) (select temp___3505 temp___3508))))))))
...
(assert (not (= (bool_eq2 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp___3491 r__split_fields j e) (temp___3497 r__split_fields1 i (temp___3503 (select r__split_fields1 i) j f))))) true)))
(check-sat)
(exit)
