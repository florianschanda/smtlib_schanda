...
(declare-fun temp_____aggregate_def_3550 ((Array Int et1) Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_3556 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_3562 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3552 (Array Int et1))) (forall ((temp___3553 Int) (temp___3554 Int)) (let ((temp___3551 (temp_____aggregate_def_3550 temp___3552 temp___3553 temp___3554))) (=> (and (dynamic_invariant temp___3553 true true true true) (dynamic_invariant2 temp___3554 true true true true)) (forall ((temp___3555 Int)) (ite (= temp___3555 temp___3553) (= (to_rep (select temp___3551 temp___3555)) temp___3554) (= (select temp___3551 temp___3555) (select temp___3552 temp___3555)))))))))
(assert (forall ((temp___3558 (Array Int (Array Int et1)))) (forall ((temp___3559 Int)) (forall ((temp___3560 (Array Int et1))) (let ((temp___3557 (temp_____aggregate_def_3556 temp___3558 temp___3559 temp___3560))) (=> (dynamic_invariant1 temp___3559 true true true true) (forall ((temp___3561 Int)) (ite (= temp___3561 temp___3559) (= (select temp___3557 temp___3561) temp___3560) (= (select temp___3557 temp___3561) (select temp___3558 temp___3561))))))))))
(assert (forall ((temp___3564 (Array Int et1))) (forall ((temp___3565 Int) (temp___3566 Int)) (let ((temp___3563 (temp_____aggregate_def_3562 temp___3564 temp___3565 temp___3566))) (=> (and (dynamic_invariant temp___3565 true true true true) (dynamic_invariant2 temp___3566 true true true true)) (forall ((temp___3567 Int)) (ite (= temp___3567 temp___3565) (= (to_rep (select temp___3563 temp___3567)) temp___3566) (= (select temp___3563 temp___3567) (select temp___3564 temp___3567)))))))))
...
(declare-const temp___8812 (Array Int et1))
(declare-const temp___88121 (Array Int (Array Int et1)))
...
(declare-const temp___8817 (Array Int et1))
(declare-const temp___88171 (Array Int (Array Int et1)))
...
(assert (not (= (bool_eq2 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp_____aggregate_def_3550 r__split_fields j e) (temp_____aggregate_def_3556 r__split_fields1 i (temp_____aggregate_def_3562 (select r__split_fields1 i) j f))))) true)))
(check-sat)
(exit)
