...
(define-fun dynamic_invariant1 ((temp___expr_179 us_t1) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool) (temp___do_typ_inv_178 Bool)) Bool (=> (not (= temp___skip_constant_176 true)) (dynamic_property2 1 2147483647 (first3 temp___expr_179) (last3 temp___expr_179))))
...
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant s true true true true) (= (to__ s) (let ((temp___194 (let ((temp___192 (to_rep (rec__stack__stack__top (us_split_fields1 s))))) (let ((temp___191 1)) (let ((temp___193 (rec__stack__stack__content (us_split_fields1 s)))) (of_array2 (to_array temp___193) temp___191 temp___192)))))) (of_array1 (to_array2 temp___194) (first5 temp___194) (last5 temp___194))))) :pattern ((to__ s)))))
...
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant s true true true true) (= (to_but_top s) (let ((temp___208 (let ((temp___206 (- (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1))) (let ((temp___205 1)) (let ((temp___207 (rec__stack__stack__content (us_split_fields1 s)))) (of_array3 (to_array temp___207) temp___205 temp___206)))))) (of_array1 (to_array3 temp___208) (first7 temp___208) (last7 temp___208))))) :pattern ((to_but_top s)))))
...
(define-fun dynamic_invariant4 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 100)) (in_range temp___expr_159)))
...
(assert (dynamic_invariant (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2))) true false true true))
...
(assert (not (= (let ((temp___301 (to__ (mk___rep s__split_discrs (mk___split_fields s__split_fields6 (mk___t s__split_fields7 s__split_fields8)))))) (let ((temp___300 (to_but_top (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2)))))) (bool_eq (elts1 temp___300) (to_rep1 (first2 (rt1 temp___300))) (to_rep1 (last2 (rt1 temp___300))) (elts1 temp___301) (to_rep1 (first2 (rt1 temp___301))) (to_rep1 (last2 (rt1 temp___301)))))) true)))
(check-sat)
(exit)
