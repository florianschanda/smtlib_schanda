...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__stack__stack__n (us_split_discrs1 a))) (to_rep (rec__stack__stack__n (us_split_discrs1 b)))) (= (to_rep (rec__stack__stack__top (us_split_fields1 a))) (to_rep (rec__stack__stack__top (us_split_fields1 b))))) (= (bool_eq1 (rec__stack__stack__content (us_split_fields1 a)) (rec__stack__stack__content (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant ((temp___expr_147 us_rep) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (let ((temp___148 (rec__stack__stack__n (us_split_discrs1 temp___expr_147)))) (and (dynamic_property1 1 (to_rep temp___148) (first1 (rec__stack__stack__content (us_split_fields1 temp___expr_147))) (last1 (rec__stack__stack__content (us_split_fields1 temp___expr_147)))) (and (= (first1 (rec__stack__stack__content (us_split_fields1 temp___expr_147))) 1) (= (last1 (rec__stack__stack__content (us_split_fields1 temp___expr_147))) (to_rep temp___148))))))
...
(define-fun dynamic_invariant1 ((temp___expr_153 us_t1) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (not (= temp___skip_constant_151 true)) (dynamic_property2 1 2147483647 (first3 temp___expr_153) (last3 temp___expr_153))))
...
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant s true true true) (dynamic_invariant1 (to__ s) true false true)) :pattern ((to__ s)))))
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant s true true true) (= (to__ s) (let ((temp___168 (let ((temp___166 (to_rep (rec__stack__stack__top (us_split_fields1 s))))) (let ((temp___165 1)) (let ((temp___167 (rec__stack__stack__content (us_split_fields1 s)))) (of_array2 (to_array temp___167) temp___165 temp___166)))))) (of_array1 (to_array2 temp___168) (first5 temp___168) (last5 temp___168))))) :pattern ((to__ s)))))
...
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant s true true true) (dynamic_invariant1 (to_but_top s) true false true)) :pattern ((to_but_top s)))))
(assert (forall ((s us_rep)) (! (=> (dynamic_invariant s true true true) (= (to_but_top s) (let ((temp___182 (let ((temp___180 (- (to_rep (rec__stack__stack__top (us_split_fields1 s))) 1))) (let ((temp___179 1)) (let ((temp___181 (rec__stack__stack__content (us_split_fields1 s)))) (of_array3 (to_array temp___181) temp___179 temp___180)))))) (of_array1 (to_array3 temp___182) (first7 temp___182) (last7 temp___182))))) :pattern ((to_but_top s)))))
...
(define-fun dynamic_invariant4 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 100)) (in_range temp___expr_136)))
...
(declare-const o4 t)
(declare-const temp___264 index)
(declare-const temp___2641 index)
(declare-const temp___2642 (Array Int integer))
(declare-const temp___2643 t)
...
(declare-const s__split_fields5 t)
(declare-const s__split_fields6 index)
(declare-const s__split_fields7 (Array Int integer))
(declare-const s__split_fields8 t)
(declare-const s__split_fields9 index)
(declare-const s__split_fields10 (Array Int integer))
(declare-const s__split_fields11 t)
(assert (dynamic_invariant (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2))) true false true))
(assert (not (= (is_empty (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2)))) true)))
...
(assert (not (= (let ((temp___273 (to__ (mk___rep s__split_discrs (mk___split_fields s__split_fields6 (mk___t s__split_fields7 s__split_fields8)))))) (let ((temp___272 (to_but_top (mk___rep s__split_discrs (mk___split_fields s__split_fields (mk___t s__split_fields1 s__split_fields2)))))) (bool_eq (elts1 temp___272) (to_rep1 (first2 (rt1 temp___272))) (to_rep1 (last2 (rt1 temp___272))) (elts1 temp___273) (to_rep1 (first2 (rt1 temp___273))) (to_rep1 (last2 (rt1 temp___273)))))) true)))
(check-sat)
(exit)
