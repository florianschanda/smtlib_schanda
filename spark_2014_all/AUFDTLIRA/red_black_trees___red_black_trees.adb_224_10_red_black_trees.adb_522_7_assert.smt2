...
(declare-const n89 int__ref)
(declare-const n90 Int)
(declare-const n91 int__ref)
...
(assert (=> (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100)) (= temp___1011 (let ((subject n7)) n87))))
(assert (=> (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c114b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c114b) i)))) (let ((subject n7)) n88))) (not (= i (root (rec__red_black_trees__rbt__struct (us_split_fields9 c115b)))))) (= (eq (select (nb_blacks c115b) i) (select (nb_blacks c114b) i)) true))))))
(assert (=> (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100)) (and (=> (<= 1 100) (in_range4 (let ((subject n7)) n88))) (and (<= 1 (let ((subject n7)) n88)) (<= (let ((subject n7)) n88) 100)))))
(assert (=> (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100)) (= (let ((subject n7)) n88) 100)))
(assert (=> (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100)) (= n89 (let ((subject n7)) (mk_int__ref n88)))))
(assert (=> (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100)) (= n90 n88)))
(assert (=> (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100)) (= n91 n89)))
(assert (=> (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100)) (= n92 n90)))
(assert (=> (not (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100))) (= n91 (let ((subject n7)) (mk_int__ref n87)))))
(assert (=> (not (and (<= 1 (let ((subject n7)) n87)) (<= (let ((subject n7)) n87) 100))) (= n92 n87)))
(assert (not (= (same_nb_blacks c115b) true)))
(check-sat)
(exit)
