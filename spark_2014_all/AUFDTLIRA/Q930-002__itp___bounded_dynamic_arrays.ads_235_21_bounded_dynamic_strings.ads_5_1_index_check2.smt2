...
(assert (forall ((x natural_index)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_229 Int) (temp___is_init_225 Bool) (temp___skip_constant_226 Bool) (temp___do_toplevel_227 Bool) (temp___do_typ_inv_228 Bool)) Bool (=> (or (= temp___is_init_225 true) (<= 1 2147483647)) (in_range3 temp___expr_229)))
...
(assert (in_range3 location))
(assert (<= location (length1 this)))
(assert (not (<= (to_rep2 (first (rt (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this))))) location)))
(check-sat)
(exit)
