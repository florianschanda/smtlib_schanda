...
(define-fun dynamic_invariant ((temp___expr_302 us_t1) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (and (=> (not (= temp___skip_constant_299 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_302) (last3 temp___expr_302))) (=> (= temp___do_toplevel_300 true) (=> (= temp___is_init_298 true) (and (let ((temp___304 (of_array2 (to_array1 temp___expr_302) (first3 temp___expr_302) (last3 temp___expr_302)))) (and (= (first5 temp___304) 1) (<= 0 (last5 temp___304)))) (<= (last3 temp___expr_302) 1000))))))
(define-fun dynamic_predicate ((temp___306 us_t1)) Bool (and (let ((temp___308 (of_array2 (to_array1 temp___306) (first3 temp___306) (last3 temp___306)))) (and (= (first5 temp___308) 1) (<= 0 (last5 temp___308)))) (<= (last3 temp___306) 1000)))
...
(define-fun dynamic_invariant1 ((temp___expr_403 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 864000)) (in_range3 temp___expr_403)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_265 us_t2) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool (and (=> (not (= temp___skip_constant_262 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_265) (last5 temp___expr_265))) (=> (= temp___do_toplevel_263 true) (=> (= temp___is_init_261 true) (and (= (first5 temp___expr_265) 1) (<= 0 (last5 temp___expr_265)))))))
(define-fun dynamic_predicate1 ((temp___268 us_t2)) Bool (and (= (first5 temp___268) 1) (<= 0 (last5 temp___268))))
(declare-const temp___480 (Array Int character))
(declare-const temp___4801 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___480))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___4801))
(assert (not (dynamic_predicate (mk___t1 temp___480 temp___4801))))
(check-sat)
(exit)
