...
(define-fun dynamic_invariant ((temp___expr_263 us_t1) (temp___is_init_260 Bool) (temp___skip_constant_261 Bool) (temp___do_toplevel_262 Bool)) Bool (and (=> (not (= temp___skip_constant_261 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_263) (last3 temp___expr_263))) (=> (= temp___do_toplevel_262 true) (=> (= temp___is_init_260 true) (and (let ((temp___265 (of_array2 (to_array1 temp___expr_263) (first3 temp___expr_263) (last3 temp___expr_263)))) (and (= (first5 temp___265) 1) (<= 0 (last5 temp___265)))) (<= (last3 temp___expr_263) 1000))))))
(define-fun dynamic_predicate ((temp___267 us_t1)) Bool (and (let ((temp___269 (of_array2 (to_array1 temp___267) (first3 temp___267) (last3 temp___267)))) (and (= (first5 temp___269) 1) (<= 0 (last5 temp___269)))) (<= (last3 temp___267) 1000)))
...
(define-fun dynamic_invariant1 ((temp___expr_355 Int) (temp___is_init_352 Bool) (temp___skip_constant_353 Bool) (temp___do_toplevel_354 Bool)) Bool (=> (or (= temp___is_init_352 true) (<= 0 864000)) (in_range3 temp___expr_355)))
(declare-const x Int)
...
(define-fun dynamic_invariant6 ((temp___expr_229 us_t2) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (and (=> (not (= temp___skip_constant_227 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_229) (last5 temp___expr_229))) (=> (= temp___do_toplevel_228 true) (=> (= temp___is_init_226 true) (and (= (first5 temp___expr_229) 1) (<= 0 (last5 temp___expr_229)))))))
(define-fun dynamic_predicate1 ((temp___232 us_t2)) Bool (and (= (first5 temp___232) 1) (<= 0 (last5 temp___232))))
(declare-const temp___425 (Array Int character))
(declare-const temp___4251 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___425))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___4251))
(assert (not (dynamic_predicate (mk___t1 temp___425 temp___4251))))
(check-sat)
(exit)
