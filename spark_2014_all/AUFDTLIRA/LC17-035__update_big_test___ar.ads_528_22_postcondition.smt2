...
(declare-fun temp_____aggregate_def_2118 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_2124 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (forall ((temp___2120 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2121 Int)) (forall ((temp___2122 (Array Int (Array Int et1)))) (let ((temp___2119 (temp_____aggregate_def_2118 temp___2120 temp___2121 temp___2122))) (=> (dynamic_invariant1 temp___2121 true true true true) (forall ((temp___2123 Int)) (ite (= temp___2123 temp___2121) (= (select temp___2119 temp___2123) temp___2122) (= (select temp___2119 temp___2123) (select temp___2120 temp___2123))))))))))
(assert (forall ((temp___2126 (Array Int (Array Int et1)))) (forall ((temp___2127 Int)) (forall ((temp___2128 (Array Int et1))) (let ((temp___2125 (temp_____aggregate_def_2124 temp___2126 temp___2127 temp___2128))) (=> (dynamic_invariant temp___2127 true true true true) (forall ((temp___2129 Int)) (ite (= temp___2129 temp___2127) (= (select temp___2125 temp___2129) temp___2128) (= (select temp___2125 temp___2129) (select temp___2126 temp___2129))))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq2 a3 1 16 (temp_____aggregate_def_2118 a i (temp_____aggregate_def_2124 b j c)) 1 16) true)))
(check-sat)
(exit)
