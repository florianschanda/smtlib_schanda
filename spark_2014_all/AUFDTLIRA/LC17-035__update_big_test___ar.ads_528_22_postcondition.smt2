...
(declare-fun temp___2118 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp___2124 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq2 a3 1 16 (temp___2118 a i (temp___2124 b j c)) 1 16) true)))
(check-sat)
(exit)
