...
(define-fun dynamic_invariant1 ((temp___expr_533 Int) (temp___is_init_530 Bool) (temp___skip_constant_531 Bool) (temp___do_toplevel_532 Bool)) Bool (=> (or (= temp___is_init_530 true) (<= 0 255)) (in_range4 temp___expr_533)))
...
(define-fun dynamic_invariant2 ((temp___expr_545 us_t) (temp___is_init_542 Bool) (temp___skip_constant_543 Bool) (temp___do_toplevel_544 Bool)) Bool (=> (not (= temp___skip_constant_543 true)) (dynamic_property 1 2147483647 (first1 temp___expr_545) (last1 temp___expr_545))))
