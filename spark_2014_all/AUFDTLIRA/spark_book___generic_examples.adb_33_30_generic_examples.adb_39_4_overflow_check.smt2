...
(define-fun dynamic_invariant1 ((temp___expr_527 Int) (temp___is_init_524 Bool) (temp___skip_constant_525 Bool) (temp___do_toplevel_526 Bool)) Bool (=> (or (= temp___is_init_524 true) (<= 0 255)) (in_range4 temp___expr_527)))
...
(define-fun dynamic_invariant2 ((temp___expr_539 us_t) (temp___is_init_536 Bool) (temp___skip_constant_537 Bool) (temp___do_toplevel_538 Bool)) Bool (=> (not (= temp___skip_constant_537 true)) (dynamic_property 1 2147483647 (first1 temp___expr_539) (last1 temp___expr_539))))
