...
(define-fun dynamic_invariant1 ((temp___expr_600 Int) (temp___is_init_596 Bool) (temp___skip_constant_597 Bool) (temp___do_toplevel_598 Bool) (temp___do_typ_inv_599 Bool)) Bool (=> (or (= temp___is_init_596 true) (<= 0 255)) (in_range4 temp___expr_600)))
...
(define-fun dynamic_invariant2 ((temp___expr_614 us_t) (temp___is_init_610 Bool) (temp___skip_constant_611 Bool) (temp___do_toplevel_612 Bool) (temp___do_typ_inv_613 Bool)) Bool (=> (not (= temp___skip_constant_611 true)) (dynamic_property 1 2147483647 (first1 temp___expr_614) (last1 temp___expr_614))))
