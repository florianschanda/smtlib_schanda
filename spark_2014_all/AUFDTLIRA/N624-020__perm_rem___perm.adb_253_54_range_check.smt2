...
(assert (and (= o9 (remove a o8)) (and (dynamic_invariant2 o9 true false true true) (and (= (invariant__ o9) true) (and (= (to_rep2 (last (rt o9))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o8 1))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o9) k))))) (and (forall ((k Int)) (=> (and (<= (+ o8 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o9) (- k 1)))))) (forall ((k Int)) (=> (and (<= o8 k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o9) k))))))))))))
(assert (and (= o10 (remove o9 (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant2 o10 true false true true) (and (= (invariant__ o10) true) (and (= (to_rep2 (last (rt o10))) (- (to_rep2 (last (rt o9))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts o9) k)) (to_rep (select (elts o10) k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep2 (last (rt o9))))) (= (to_rep (select (elts o9) k)) (to_rep (select (elts o10) (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep2 (last (rt o9))) 1))) (= (to_rep (select (elts o9) (+ k 1))) (to_rep (select (elts o10) k))))))))))))
(assert (and (= o7 (remove bb ib1)) (and (dynamic_invariant2 o7 true false true true) (and (= (invariant__ o7) true) (and (= (to_rep2 (last (rt o7))) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o7) k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o7) (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o7) k))))))))))))
