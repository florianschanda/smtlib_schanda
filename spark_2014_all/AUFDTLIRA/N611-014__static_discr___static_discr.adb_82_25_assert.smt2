...
(assert (= (to_rep (rec__static_discr__holder__unused current__split_discrs)) (to_rep1 (last (rt a)))))
(assert (not (= (let ((temp___396 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields7))))) (bool_eq (elts a) (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) (elts3 temp___396) (to_rep1 (first6 (rt3 temp___396))) (to_rep1 (last6 (rt3 temp___396))))) true)))
(check-sat)
(exit)
