...
(assert (forall ((temp___483 Int)) (=> (dynamic_invariant temp___483 true true true true) (forall ((temp___484 Int)) (= (to_rep1 (select (stable_marriage__invert_1__result__aggregate_def temp___483) temp___484)) temp___483)))))
...
(assert (forall ((g11 Int)) (=> (and (<= 1 g11) (<= g11 64)) (=> (exists ((prev Int)) (and (and (<= 1 prev) (<= prev (- rank2 1))) (= (to_rep (select r1 prev)) g11))) (= (to_rep (select r1 (to_rep1 (select result__2 g11)))) g11)))))
