...
(assert (forall ((temp___441 Int)) (forall ((temp___442 Int)) (= (select (stable_marriage__invert_1__result__aggregate_def temp___441) temp___442) (of_rep1 temp___441)))))
...
(declare-const temp___443 (Array Int ranking))
...
(assert (<= 1 rank1))
(assert (<= rank1 64))
(assert (forall ((prev2 Int)) (=> (and (<= 1 prev2) (<= prev2 (- rank2 1))) (= (to_rep1 (select result__2 (to_rep (select r1 prev2)))) prev2))))
(assert (forall ((g11 Int)) (=> (and (<= 1 g11) (<= g11 64)) (=> (exists ((prev2 Int)) (and (and (<= 1 prev2) (<= prev2 (- rank2 1))) (= (to_rep (select r1 prev2)) g11))) (= (to_rep (select r1 (to_rep1 (select result__2 g11)))) g11)))))
