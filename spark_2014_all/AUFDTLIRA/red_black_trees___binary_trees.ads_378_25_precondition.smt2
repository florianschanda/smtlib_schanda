...
(assert (<= i3 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o46 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i3)) (and (= (= o46 true) (and (<= i3 (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i3)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) i3) (not (= o46 true))))))
(assert (= result25 (ite (not (= i3 root)) o46 false)))
(assert (= result25 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o47 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i3)) (and (dynamic_invariant2 o47 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o47 i3))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o47 i3)))) 0) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (not (= i5 i3)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i5) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o47 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i5)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o47 i5))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o47 i5))) true)))))) (and (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o47 i5))) true) (not (= i5 i3))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o47 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i5)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i5) (rec__tree_model__path_type__a (us_split_fields1 (select o47 i5)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o47 i5)))) 0)))) (forall ((i5 Int)) (=> (and (<= 1 i5) (<= i5 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o47 i5))) true) (forall ((j6 Int)) (=> (and (<= 1 j6) (<= j6 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o47 j6))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o47 i5))) (rec__tree_model__path_type__a (us_split_fields1 (select o47 j6)))) true)) (= j6 i5))))))))))))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (not (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) i3) true)))
(check-sat)
(exit)
