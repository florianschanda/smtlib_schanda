...
(assert (not (= (ordered_leafs (mk___rep2 (let ((subject f_5__split_fields)) f_5__split_fields2)) (to_rep1 (rec__search_trees__search_tree__root t__split_fields11)) (rec__search_trees__search_tree__values t__split_fields11)) true)))
(check-sat)
(exit)
