...
(assert (and (= o71 (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c3)) (= (= o71 true) (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c3) true))))
(assert (= o72 true))
(assert (= result11 (ite (= o72 true) o71 false)))
(assert (= result11 true))
(assert (not (= (has_key1 (positions (mk___rep d__split_discrs d__split_fields1)) c3) true)))
(check-sat)
(exit)
