...
(assert (forall ((g11 Int)) (=> (and (<= 1 g11) (<= g11 64)) (=> (exists ((prev2 Int)) (and (and (<= 1 prev2) (<= prev2 (- g22 1))) (= (to_rep (select g2_to_g1 prev2)) g11))) (= (to_rep (select g2_to_g1 (to_rep1 (select result__2 g11)))) g11)))))
