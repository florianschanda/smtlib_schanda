...
(assert (not (= (ite (<= (to_rep1 (first temp___2921)) (to_rep1 (last temp___2921))) (+ (- (to_rep1 (last temp___2921)) (to_rep1 (first temp___2921))) 1) 0) (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0))))
(check-sat)
(exit)
