...
(define-fun dynamic_invariant2 ((temp___expr_645 Int) (temp___is_init_641 Bool) (temp___skip_constant_642 Bool) (temp___do_toplevel_643 Bool) (temp___do_typ_inv_644 Bool)) Bool (=> (or (= temp___is_init_641 true) (<= 1 1025)) (in_range3 temp___expr_645)))
...
(declare-fun user_eq3 (tlast_charS tlast_charS) Bool)
(declare-const dummy3 tlast_charS)
...
(define-fun dynamic_invariant3 ((temp___expr_652 Int) (temp___is_init_648 Bool) (temp___skip_constant_649 Bool) (temp___do_toplevel_650 Bool) (temp___do_typ_inv_651 Bool)) Bool (=> (or (= temp___is_init_648 true) (<= 0 1024)) (in_range4 temp___expr_652)))
...
(declare-fun user_eq4 (tTlineSP1 tTlineSP1) Bool)
(declare-const dummy4 tTlineSP1)
...
(declare-const temp___715 (Array Int character))
...
(assert (in_range4 last_char))
(assert (in_range1 line_num))
(assert (=> (<= 0 255) (in_range2 c)))
(assert (<= first_char 1024))
(assert (=> (< last_char (+ first_char 0)) (= temp___716 first_char)))
(assert (=> (< last_char (+ first_char 0)) (= temp___715 line)))
(assert (=> (< last_char (+ first_char 0)) (= temp___714 line_num)))
(assert (=> (< last_char (+ first_char 0)) (= temp___713 last_char)))
(assert (=> (< last_char (+ first_char 0)) (and (and (and (in_range4 last_char2) (in_range1 line_num2)) (in_range3 first_char2)) (= (< last_char2 (+ first_char2 0)) true))))
(assert (=> (< last_char (+ first_char 0)) (and (and (in_range4 last_char3) (in_range1 line_num3)) (in_range3 first_char3))))
...
(assert (=> (< last_char (+ first_char 0)) (= line_num8 (mk_int__ref line_num4))))
(assert (=> (< last_char (+ first_char 0)) (= last_char8 (mk_int__ref last_char4))))
(assert (=> (< last_char (+ first_char 0)) (= first_char8 (mk_int__ref first_char4))))
...
(assert (=> (not (< last_char (+ first_char 0))) (= line_num8 (mk_int__ref line_num))))
(assert (=> (not (< last_char (+ first_char 0))) (= last_char8 (mk_int__ref last_char))))
(assert (=> (not (< last_char (+ first_char 0))) (= first_char8 (mk_int__ref first_char))))
(assert (=> (not (< last_char (+ first_char 0))) (= line7 (mk_map__ref line))))
(assert (=> (not (< last_char (+ first_char 0))) (= line_num7 line_num1)))
(assert (=> (not (< last_char (+ first_char 0))) (= last_char7 last_char1)))
(assert (=> (not (< last_char (+ first_char 0))) (= first_char7 first_char1)))
(assert (=> (not (< last_char (+ first_char 0))) (= line6 line1)))
(assert (not (<= 1 first_char6)))
(check-sat)
(exit)
