...
(assert (= (rec__tree_model__path_type__k (us_split_fields7 (select m i2))) true))
(assert (and (= o (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) i2 1)) (and (in_range2 o) (= o (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) i2 1)))))
(assert (= red_black_trees__nb_blacks__B_3__count_r__assume (select res3 o)))
(assert (= red_black_trees__nb_blacks__B_3__count_r__assume count_r))
