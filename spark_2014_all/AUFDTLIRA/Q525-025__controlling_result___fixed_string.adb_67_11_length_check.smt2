...
(assert (not (= (ite (<= (to_rep1 (first4 temp___2561)) (to_rep1 (last4 temp___2561))) (+ (- (to_rep1 (last4 temp___2561)) (to_rep1 (first4 temp___2561))) 1) 0) (ite (<= (to_rep1 out_string__first) r19b) (+ (- r19b (to_rep1 out_string__first)) 1) 0))))
(check-sat)
(exit)
