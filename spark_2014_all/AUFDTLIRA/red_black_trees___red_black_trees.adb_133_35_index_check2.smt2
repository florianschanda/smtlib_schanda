...
(assert (= o3 j))
(assert (= o4 (select res3 o3)))
(assert (= o5 (us_split_fields11 o4)))
(assert (= o6 (rec__red_black_trees__black_count__depth o5)))
(assert (= o7 (to_rep o6)))
(assert (= o8 (ite (< (+ n2 1) o7) true false)))
(assert (and (<= 1 j) (<= j 100)))
(assert (= o j))
(assert (= o1 (select m o)))
(assert (= o2 (us_split_fields7 o1)))
(assert (= o9 (rec__tree_model__path_type__k o2)))
