...
(assert (= a2 o7))
(assert (= (to_rep o8) 23))
(assert (= (rec__arrays_of_records__basic_record__flag (us_split_fields1 (select a2 101))) o9))
(assert (= (rec__arrays_of_records__basic_record__first_value (us_split_fields1 (select a2 101))) o10))
(assert (= o8 o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= o14 o11))
...
(assert (= a2 result2))
(assert (= a3 o15))
(assert (not (= (to_rep (rec__arrays_of_records__basic_record__second_value (us_split_fields1 (select a3 101)))) 23)))
(check-sat)
(exit)
