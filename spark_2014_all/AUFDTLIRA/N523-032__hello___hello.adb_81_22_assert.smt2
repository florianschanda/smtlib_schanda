...
(assert (=> (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str))))) (and (and (= temp___592 idx1) (and (= temp___591 to_up1) (and (= temp___589 ret1) (and (ite (= to_up1 true) (and (and (and (and (= o (to_upper (to_rep (select ret1 idx1)))) (in_range3 o)) (= (to_rep o1) o)) (= o2 (store ret1 idx1 o1))) (and (= ret1 result3) (= ret2 o2))) (and (and (and (and (and (= o3 (to_lower (to_rep (select ret1 idx1)))) (in_range3 o3)) (= (to_rep o4) o3)) (= o5 (store ret1 idx1 o4))) (and (= ret1 result4) (= ret3 o5))) (= ret2 ret3))) (and (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str))))) (and (and (<= (to_rep1 ret__first) idx1) (<= idx1 (to_rep1 ret__last))) (and (and (= (to_caml_char2 str (mk___t ret4 (mk (to_rep1 ret__first) (to_rep1 ret__last))) idx2) true) (forall ((j1 Int)) (=> (and (<= idx2 j1) (<= j1 (to_rep1 (last (rt str))))) (=> (< idx2 j1) (= (to_rep (select ret4 j1)) (to_rep (select (elts str) j1))))))) (and (and (and (forall ((temp___590 Int)) (=> (and (<= (to_rep1 ret__first) temp___590) (<= temp___590 (to_rep1 ret__last))) (=> (< idx2 temp___590) (= (select ret4 temp___590) (select temp___589 temp___590))))) (=> (<= (to_rep1 (first (rt str))) (to_rep1 (last (rt str)))) (dynamic_property3 (to_rep1 (first (rt str))) (to_rep1 (last (rt str))) idx2))) (and (<= (to_rep1 (first (rt str))) idx2) (<= idx2 (to_rep1 (last (rt str)))))) (and (ite (and (not (and (<= 65 (to_rep (select (elts str) idx2))) (<= (to_rep (select (elts str) idx2)) 90))) (not (and (<= 97 (to_rep (select (elts str) idx2))) (<= (to_rep (select (elts str) idx2)) 122)))) (and (= to_up2 result5) (= to_up3 (of_int 1))) (and (and (= to_up2 result6) (= to_up4 (of_int 0))) (= to_up3 to_up4))) (= idx2 (to_rep1 (last (rt str))))))))))))) (and (and (= idx6 (mk_int__ref idx2)) (and (= to_up3 to_up7) (= ret4 ret9))) (and (= idx7 idx2) (and (= to_up8 to_up3) (= ret10 ret4)))))))
(assert (=> (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str))))) (= idx8 idx6)))
(assert (=> (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str))))) (= to_up9 (mk_bool__ref to_up7))))
(assert (=> (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str))))) (= ret11 (mk_map__ref ret9))))
(assert (=> (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str))))) (= idx9 idx7)))
(assert (=> (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str))))) (= to_up10 to_up8)))
(assert (=> (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str))))) (= ret12 ret10)))
(assert (=> (not (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str)))))) (= idx8 (mk_int__ref idx1))))
(assert (=> (not (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str)))))) (= to_up9 (mk_bool__ref to_up1))))
(assert (=> (not (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str)))))) (= ret11 (mk_map__ref ret1))))
(assert (=> (not (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str)))))) (= idx9 idx1)))
(assert (=> (not (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str)))))) (= to_up10 to_up1)))
(assert (=> (not (and (<= (to_rep1 (first (rt str))) idx1) (<= idx1 (to_rep1 (last (rt str)))))) (= ret12 ret1)))
(assert (not true))
(check-sat)
(exit)
