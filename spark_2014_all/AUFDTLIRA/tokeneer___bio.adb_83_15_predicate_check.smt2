...
(declare-const temp___1510 (Array Int character))
(declare-const temp___15101 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___1510))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___15101))
(assert (not (dynamic_predicate (mk___t1 temp___1510 temp___15101))))
(check-sat)
(exit)
