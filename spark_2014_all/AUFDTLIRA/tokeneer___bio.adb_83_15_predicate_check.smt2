...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___1293))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___12931))
(assert (not (dynamic_predicate (mk___t1 temp___1293 temp___12931))))
(check-sat)
(exit)
