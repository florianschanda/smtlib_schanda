...
(assert (and (<= (to_rep (first (rt list))) position13) (<= position13 (to_rep (last (rt list))))))
(assert (= o9 position13))
(assert (= o10 (select (elts list) o9)))
(assert (= o11 (to_rep o10)))
(assert (= result5 (ite (= o11 value) true false)))
(assert (= result5 true))
(assert (<= (to_rep (first (rt list))) index1))
(assert (<= index1 (- position13 1)))
(assert (not (<= (to_rep (first (rt list))) index1)))
(check-sat)
(exit)
