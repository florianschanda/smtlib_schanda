...
(assert (and (= o28 (remove b ib1)) (and (dynamic_invariant2 o28 true false true true) (and (= (invariant__ o28) true) (and (= (to_rep2 (last o23)) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts b) k)) (to_rep (select o22 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o22 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o22 k))))))))))))
(assert (and (= o27 (remove o28 o24)) (and (dynamic_invariant2 o27 true false true true) (and (= (invariant__ o27) true) (and (= (to_rep2 (last o26)) (- (to_rep2 (last o23)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o24 1))) (= (to_rep (select o22 k)) (to_rep (select o25 k))))) (and (forall ((k Int)) (=> (and (<= (+ o24 1) k) (<= k (to_rep2 (last o23)))) (= (to_rep (select o22 k)) (to_rep (select o25 (- k 1)))))) (forall ((k Int)) (=> (and (<= o24 k) (<= k (- (to_rep2 (last o23)) 1))) (= (to_rep (select o22 (+ k 1))) (to_rep (select o25 k))))))))))))
(assert (and (= o29 (remove bb ib1)) (and (dynamic_invariant2 o29 true false true true) (and (= (invariant__ o29) true) (and (= (to_rep2 (last o21)) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o20 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o20 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o20 k))))))))))))
