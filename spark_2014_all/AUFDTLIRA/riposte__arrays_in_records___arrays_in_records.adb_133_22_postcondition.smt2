...
(declare-const temp___300 index)
(declare-const temp___3001 (Array Int value))
(declare-const temp___3002 (Array Int value))
...
(declare-const temp___303 index)
(declare-const temp___3031 (Array Int value))
(declare-const temp___3032 (Array Int value))
...
(assert (= temp___300 o2))
(assert (= temp___3001 o3))
(assert (= temp___3002 o4))
(assert (= result a__split_fields))
(assert (= result1 a__split_fields1))
(assert (= result2 a__split_fields2))
(assert (= temp___300 a__split_fields3))
(assert (= temp___3001 a__split_fields4))
(assert (= temp___3002 a__split_fields5))
(assert (= (to_rep o5) 42))
(assert (= o6 (store a__split_fields4 5 o5)))
(assert (= a__split_fields3 o7))
(assert (= o6 o8))
(assert (= a__split_fields5 o9))
(assert (= temp___303 o7))
(assert (= temp___3031 o8))
(assert (= temp___3032 o9))
(assert (= result3 a__split_fields3))
(assert (= result4 a__split_fields4))
(assert (= result5 a__split_fields5))
(assert (= temp___303 a__split_fields6))
(assert (= temp___3031 a__split_fields7))
(assert (= temp___3032 a__split_fields8))
...
(assert (not (not (= (to_rep (select a__split_fields10 17)) 23))))
(check-sat)
(exit)
