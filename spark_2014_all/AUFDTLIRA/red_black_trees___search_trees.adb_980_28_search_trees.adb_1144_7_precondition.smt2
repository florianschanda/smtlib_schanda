...
(declare-const temp___1079 (Array Int us_rep1))
...
(assert (and (= temp___1079 (model__ (mk___rep2 f_2__split_fields3) x1)) (and (dynamic_invariant6 temp___1079 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1079 x1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1079 x1)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 x1)) (ite (and (not (= (parent (mk___rep2 f_2__split_fields3) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1079 (parent (mk___rep2 f_2__split_fields3) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1079 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1079 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1079 i1))) true) (not (= i1 x1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1079 (parent (mk___rep2 f_2__split_fields3) i1)))) (position (mk___rep2 f_2__split_fields3) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1079 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1079 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1079 i1))) true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1079 j3))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1079 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1079 j3)))) true)) (= j3 i1))))))))))))))
(assert (and (<= 1 xr1) (<= xr1 100)))
(assert (= o11 xr1))
(assert (= o12 (select temp___1079 o11)))
