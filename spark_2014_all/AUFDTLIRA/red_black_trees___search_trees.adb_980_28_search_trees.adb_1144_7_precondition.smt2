...
(assert (and (= temp___1035 (model__ (mk___rep2 f_2__split_fields3) x1)) (and (dynamic_invariant6 temp___1035 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1035 x1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1035 x1)))) 0) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (not (= i6 x1)) (ite (and (not (= (parent (mk___rep2 f_2__split_fields3) i6) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1035 (parent (mk___rep2 f_2__split_fields3) i6)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1035 i6))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1035 i6))) true)))))) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1035 i6))) true) (not (= i6 x1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1035 (parent (mk___rep2 f_2__split_fields3) i6)))) (position (mk___rep2 f_2__split_fields3) i6) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1035 i6)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1035 i6)))) 0)))) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1035 i6))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1035 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1035 i6))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1035 j15)))) true)) (= j15 i6))))))))))))))
(assert (and (<= 1 xr1) (<= xr1 100)))
(assert (= o18 xr1))
(assert (= o19 (select temp___1035 o18)))
