...
(declare-const x Int)
(declare-const arrays__single_char_set_broken__result (Array Int Bool))
(declare-const temp___356 Int)
(declare-const temp___354 (Array Int Bool))
...
(declare-const arrays__single_char_set_broken__result1 (Array Int Bool))
(declare-const arrays__single_char_set_broken__result2 (Array Int Bool))
(declare-const arrays__single_char_set_broken__result3 (Array Int Bool))
(declare-const r8 (Array Int Bool))
(declare-const x7 Int)
(declare-const arrays__single_char_set_broken__result4 (Array Int Bool))
(declare-const r9 (Array Int Bool))
(declare-const x8 Int)
(declare-const arrays__single_char_set_broken__result5 (Array Int Bool))
...
(assert (= x1 0))
(assert (=> (and (<= 0 x1) (<= x1 255)) (= temp___356 x1)))
(assert (=> (and (<= 0 x1) (<= x1 255)) (= temp___354 r)))
...
(assert (=> (and (<= 0 x1) (<= x1 255)) (and (and (forall ((temp___355 Int)) (=> (and (<= 0 temp___355) (<= temp___355 255)) (=> (or (< 255 temp___355) (or (< temp___355 0) (< x2 temp___355))) (= (select r3 temp___355) (select temp___354 temp___355))))) (=> (<= 0 255) (in_range1 x2))) (and (<= 0 x2) (<= x2 255)))))
...
(assert (= arrays__single_char_set_broken__result1 arrays__single_char_set_broken__result2))
(assert (= arrays__single_char_set_broken__result3 arrays__single_char_set_broken__result1))
(assert (= result2 arrays__single_char_set_broken__result))
(assert (= arrays__single_char_set_broken__result1 r6))
(assert (= (mk_map__ref arrays__single_char_set_broken__result4) (mk_map__ref arrays__single_char_set_broken__result2)))
(assert (= x7 x5))
(assert (= r8 r6))
(assert (= arrays__single_char_set_broken__result5 arrays__single_char_set_broken__result3))
(assert (= x8 x6))
(assert (= r9 r7))
(assert (= result3 arrays__single_char_set_broken__result4))
(declare-const i Int)
(assert (<= 0 i))
(assert (<= i 255))
(assert (= (select arrays__single_char_set_broken__result4 i) true))
(assert (not (< c i)))
(check-sat)
(exit)
