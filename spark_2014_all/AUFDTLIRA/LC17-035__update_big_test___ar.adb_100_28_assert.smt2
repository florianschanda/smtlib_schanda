...
(declare-fun temp___4412 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___4414 (Array Int et1))) (forall ((temp___4415 Int) (temp___4416 Int)) (let ((temp___4413 (temp___4412 temp___4414 temp___4415 temp___4416))) (=> (and (dynamic_invariant temp___4415 true true true true) (dynamic_invariant1 temp___4416 true true true true)) (forall ((temp___4417 Int)) (ite (= temp___4417 temp___4415) (= (to_rep (select temp___4413 temp___4417)) temp___4416) (= (select temp___4413 temp___4417) (select temp___4414 temp___4417)))))))))
...
(assert (= result1 a))
(assert (= a1 o1))
(assert (not (= (bool_eq a1 1 10 (temp___4412 t1 i e) 1 10) true)))
(check-sat)
(exit)
