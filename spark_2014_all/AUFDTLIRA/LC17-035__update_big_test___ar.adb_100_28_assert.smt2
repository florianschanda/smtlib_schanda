...
(declare-fun temp___4353 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___4355 (Array Int et1))) (forall ((temp___4356 Int) (temp___4357 Int)) (let ((temp___4354 (temp___4353 temp___4355 temp___4356 temp___4357))) (forall ((temp___4358 Int)) (ite (= temp___4358 temp___4356) (= (select temp___4354 temp___4358) (of_rep temp___4357)) (= (select temp___4354 temp___4358) (select temp___4355 temp___4358))))))))
...
(assert (= result1 a))
(assert (= a1 o1))
(assert (not (= (bool_eq a1 1 10 (temp___4353 t1 i e) 1 10) true)))
(check-sat)
(exit)
