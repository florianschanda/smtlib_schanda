...
(assert (= (= result17 true) (forall ((j14 Int)) (=> (and (<= 1 j14) (<= j14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) j14))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j14)) (to_rep (select t_old__split_fields3 j14))))))))
