...
(define-fun to_base1 ((a us_rep2)) us_rep (mk___rep (us_split_discrs3 a) (mk___split_fields (let ((temp___136 (rec__p__my_rec__content2 (us_split_fields5 a)))) (of_array (to_array2 temp___136) (first5 temp___136) (last5 temp___136))))))
(define-fun of_base1 ((r us_rep)) us_rep2 (mk___rep2 (us_split_discrs1 r) (mk___split_fields2 (let ((temp___135 (rec__p__my_rec__content (us_split_fields1 r)))) (of_array2 (to_array temp___135) (first1 temp___135) (last1 temp___135))))))
...
(define-fun dynamic_invariant2 ((temp___expr_181 us_rep) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (let ((temp___182 (rec__p__my_rec__c (us_split_discrs1 temp___expr_181)))) (and (dynamic_property1 1 (to_rep temp___182) (first1 (rec__p__my_rec__content (us_split_fields1 temp___expr_181))) (last1 (rec__p__my_rec__content (us_split_fields1 temp___expr_181)))) (and (= (first1 (rec__p__my_rec__content (us_split_fields1 temp___expr_181))) 1) (= (last1 (rec__p__my_rec__content (us_split_fields1 temp___expr_181))) (to_rep temp___182))))))
(define-fun dynamic_invariant3 ((temp___expr_187 us_rep3) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool)) Bool (let ((temp___189 (rec__p__pp__c (us_split_discrs5 temp___expr_187)))) (and (in_range3 (to_rep temp___189) (to_base (rec__p__pp__r (us_split_fields7 temp___expr_187)))) (and (dynamic_property3 1 (to_rep temp___189) (first3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields7 temp___expr_187))))) (last3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields7 temp___expr_187)))))) (and (= (first3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields7 temp___expr_187))))) 1) (= (last3 (rec__p__my_rec__content1 (us_split_fields3 (rec__p__pp__r (us_split_fields7 temp___expr_187))))) (to_rep temp___189)))))))
(declare-const self__ us_rep3)
(declare-const temp___230 (Array Int natural))
...
(declare-const o9 t)
(assert (= (to_rep1 (first6 (rt3 (temp___210 0 1 (to_rep (rec__p__pp__c (us_split_discrs5 self__))))))) 1))
(assert (= (to_rep1 (last6 (rt3 (temp___210 0 1 (to_rep (rec__p__pp__c (us_split_discrs5 self__))))))) (to_rep (rec__p__pp__c (us_split_discrs5 self__)))))
(assert (= (mk___t3 temp___230 temp___2301) (temp___210 0 1 (to_rep (rec__p__pp__c (us_split_discrs5 self__))))))
(assert (= (ite (<= (to_rep1 (first6 temp___2301)) (to_rep1 (last6 temp___2301))) (+ (- (to_rep1 (last6 temp___2301)) (to_rep1 (first6 temp___2301))) 1) 0) (ite (<= 1 (to_rep (rec__p__pp__c (us_split_discrs5 self__)))) (+ (- (to_rep (rec__p__pp__c (us_split_discrs5 self__))) 1) 1) 0)))
(assert (= temp___230 o))
(assert (= (mk2 (to_rep1 (first6 temp___2301)) (to_rep1 (last6 temp___2301))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= (rec__p__pp__c (us_split_discrs5 self__)) o4))
(assert (= o5 o2))
(assert (= o6 o3))
(assert (= (mk___rep (mk___split_discrs o7) (mk___split_fields (mk___t o8 o9))) (to_base1 (mk___rep2 (mk___split_discrs o4) (mk___split_fields2 (mk___t2 o5 o6))))))
(assert (not (= (to_rep (rec__p__pp__c (us_split_discrs5 self__))) (to_rep o7))))
(check-sat)
(exit)
