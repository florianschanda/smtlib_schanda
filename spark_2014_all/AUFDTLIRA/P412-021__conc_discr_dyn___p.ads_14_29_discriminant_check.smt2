...
(declare-const o9 t)
(assert (= (to_rep1 (first6 (rt3 (temp_____aggregate_def_243 0 1 (to_rep (rec__p__pp__c (us_split_discrs5 self__))))))) 1))
(assert (= (to_rep1 (last6 (rt3 (temp_____aggregate_def_243 0 1 (to_rep (rec__p__pp__c (us_split_discrs5 self__))))))) (to_rep (rec__p__pp__c (us_split_discrs5 self__)))))
(assert (= (mk___t3 temp___263 temp___2631) (temp_____aggregate_def_243 0 1 (to_rep (rec__p__pp__c (us_split_discrs5 self__))))))
(assert (= (ite (<= (to_rep1 (first6 temp___2631)) (to_rep1 (last6 temp___2631))) (+ (- (to_rep1 (last6 temp___2631)) (to_rep1 (first6 temp___2631))) 1) 0) (ite (<= 1 (to_rep (rec__p__pp__c (us_split_discrs5 self__)))) (+ (- (to_rep (rec__p__pp__c (us_split_discrs5 self__))) 1) 1) 0)))
(assert (= temp___263 o))
(assert (= (mk2 (to_rep1 (first6 temp___2631)) (to_rep1 (last6 temp___2631))) o1))
(assert (= o2 o))
(assert (= o3 o1))
