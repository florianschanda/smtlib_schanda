...
(assert (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= result2 (ite (<= (to_rep a__first) j2) (ite (<= j2 (to_rep a__last)) true false) false))))
(assert (=> (not (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last)))) (= result2 false)))
(assert (= result2 true))
