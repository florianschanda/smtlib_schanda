...
(assert (and (= perm__perm_symmetric__induction_hypothesis__B_4__ih__assume (induction_hypothesis o5 o4)) (and (in_range2 perm__perm_symmetric__induction_hypothesis__B_4__ih__assume) (=> (= (of_int perm__perm_symmetric__induction_hypothesis__B_4__ih__assume) true) (= (is_perm o4 o5) true)))))
