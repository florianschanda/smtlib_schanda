...
(assert (and (= (mk___rep (mk___split_fields perm__perm_symmetric__induction_hypothesis__B_4__w__assume perm__perm_symmetric__induction_hypothesis__B_4__w__assume1)) (get_witnesses a b)) (and (and (<= (to_rep2 (first (rt a))) (to_rep1 perm__perm_symmetric__induction_hypothesis__B_4__w__assume)) (<= (to_rep1 perm__perm_symmetric__induction_hypothesis__B_4__w__assume) (to_rep2 (last (rt a))))) (and (and (<= (to_rep2 (first (rt b))) (to_rep1 perm__perm_symmetric__induction_hypothesis__B_4__w__assume1)) (<= (to_rep1 perm__perm_symmetric__induction_hypothesis__B_4__w__assume1) (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) (to_rep1 perm__perm_symmetric__induction_hypothesis__B_4__w__assume))) (to_rep (select (elts b) (to_rep1 perm__perm_symmetric__induction_hypothesis__B_4__w__assume1)))) (= (is_perm (remove a (to_rep1 perm__perm_symmetric__induction_hypothesis__B_4__w__assume)) (remove b (to_rep1 perm__perm_symmetric__induction_hypothesis__B_4__w__assume1))) true))))))
(assert (= (mk___rep (mk___split_fields perm__perm_symmetric__induction_hypothesis__B_4__w__assume perm__perm_symmetric__induction_hypothesis__B_4__w__assume1)) w))
(assert (and (= (mk___t o2 o3) (remove b (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (dynamic_invariant1 (mk___t o2 o3) true false true) (and (= (invariant__ (mk___t o2 o3)) true) (and (= (to_rep2 (last o3)) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) (= (to_rep (select (elts b) k)) (to_rep (select o2 k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o2 (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o2 k))))))))))))
(assert (and (= (mk___t o o1) (remove a (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant1 (mk___t o o1) true false true) (and (= (invariant__ (mk___t o o1)) true) (and (= (to_rep2 (last o1)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts a) k)) (to_rep (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o k))))))))))))
(assert (and (= perm__perm_symmetric__induction_hypothesis__B_4__ih__assume (induction_hypothesis (mk___t o o1) (mk___t o2 o3))) (and (in_range2 perm__perm_symmetric__induction_hypothesis__B_4__ih__assume) (=> (= (of_int perm__perm_symmetric__induction_hypothesis__B_4__ih__assume) true) (= (is_perm (mk___t o2 o3) (mk___t o o1)) true)))))
(assert (= perm__perm_symmetric__induction_hypothesis__B_4__ih__assume ih))
(assert (in_range2 ih))
(assert (= (of_int ih) true))
(assert (not (= (to_rep (select (elts b) (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))) (to_rep (select (elts a) (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 w))))))))
(check-sat)
(exit)
