...
(assert (and (= (mk___t o o1) (value by__)) (and (dynamic_invariant3 (mk___t o o1) true false true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 by__))) o) (= (mk (to_rep1 (first4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__)))))) (to_rep1 (last4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 by__))))))) o1)) (and (and (and (= (length (mk___t o o1)) (length2 by__)) (= (to_rep1 (first o1)) 1)) (= (to_rep1 (last o1)) (length2 by__))) (= (< 0 (length2 by__)) (not (= (empty by__) true))))))))
(assert (not (<= 1 (- (+ start (length (mk___t o o1))) 1))))
(check-sat)
(exit)
