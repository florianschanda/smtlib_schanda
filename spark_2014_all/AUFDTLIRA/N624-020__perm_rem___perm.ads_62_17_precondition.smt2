...
(assert (and (= o29 (remove b ib)) (and (dynamic_invariant2 o29 true false true) (and (= (invariant__ o29) true) (and (= (to_rep1 (last o28)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib 1))) (= (to_rep (select (elts b) k)) (to_rep (select o27 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o27 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o27 k))))))))))))
(assert (and (= o30 (remove a ia)) (and (dynamic_invariant2 o30 true false true) (and (= (invariant__ o30) true) (and (= (to_rep1 (last o26)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia 1))) (= (to_rep (select (elts a) k)) (to_rep (select o25 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o25 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o25 k))))))))))))
