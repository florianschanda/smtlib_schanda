...
(assert (and (= temp___2006 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___2006) (<= temp___2006 (to_rep1 (last (rt source))))))
(assert (= o temp___2006))
