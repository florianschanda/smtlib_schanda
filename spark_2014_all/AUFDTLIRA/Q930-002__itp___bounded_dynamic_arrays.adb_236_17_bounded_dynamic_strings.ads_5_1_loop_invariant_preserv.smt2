...
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j k2)) (not (= (bool_eq (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) (to_rep1 (first8 (mk4 j (- (+ j (length fragment)) 1)))) (to_rep1 (last8 (mk4 j (- (+ j (length fragment)) 1)))) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))) true)))))
...
(assert (not (= k2 temp___1306)))
(assert (= k2 result3))
(assert (= k3 (+ k2 1)))
(assert (and (= o9 (length fragment)) (in_range1 (length fragment))))
(assert (= o10 (+ k3 o9)))
(assert (= temp___12921 (- o10 1)))
(assert (=> (<= k3 temp___12921) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k3) (<= k3 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) temp___12921) (<= temp___12921 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))))))
(assert (= o11 (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within)))))
(assert (= o11 temp___12942))
(assert (= (mk3 k3 temp___12921) temp___12943))
(assert (= result4 (bool_eq temp___12942 (to_rep1 (first6 temp___12943)) (to_rep1 (last6 temp___12943)) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment))))))
...
(assert (<= 1 j))
(assert (<= j k3))
(assert (not (not (= (bool_eq (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) (to_rep1 (first8 (mk4 j (- (+ j (length fragment)) 1)))) (to_rep1 (last8 (mk4 j (- (+ j (length fragment)) 1)))) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))) true))))
(check-sat)
(exit)
