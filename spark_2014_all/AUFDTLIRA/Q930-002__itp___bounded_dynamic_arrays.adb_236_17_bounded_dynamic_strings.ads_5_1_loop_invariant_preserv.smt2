...
(assert true)
(assert (forall ((within1 us_rep)) (forall ((fragment1 us_t)) (! (= (= (contains__2 within1 fragment1) true) (and (and (<= 1 (length fragment1)) (<= (length fragment1) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within1))))) (exists ((k Int)) (and (and (<= 1 k) (<= k (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within1))) (length fragment1)) 1))) (= (let ((temp___449 (let ((temp___447 (- (+ k (length fragment1)) 1))) (let ((temp___448 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within1)))) (of_array2 (to_array1 temp___448) k temp___447))))) (bool_eq (to_array2 temp___449) (first5 temp___449) (last5 temp___449) (to_array fragment1) (first1 fragment1) (last1 fragment1))) true))))) :pattern ((contains__2 within1 fragment1))))))
...
(define-fun dynamic_invariant5 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 2147483647)) (in_range4 temp___expr_195)))
(declare-const k Int)
...
(declare-const temp___1231 (Array Int character))
(declare-const temp___12311 t3)
(declare-const j Int)
...
(declare-const temp___12291 Int)
(declare-const o13 (Array Int character))
(declare-const temp___12312 (Array Int character))
(declare-const temp___12313 t3)
...
(declare-const bounded_dynamic_strings__location__2__result16 Int)
...
(declare-const bounded_dynamic_strings__location__2__result20 int__ref)
(declare-const k18 Int)
(declare-const bounded_dynamic_strings__location__2__result21 Int)
(assert (dynamic_invariant1 i52s true false true))
(assert (dynamic_invariant fragment true false true))
(assert (dynamic_invariant1 within true false true))
...
(assert (and (= o1 (length fragment)) (in_range1 (length fragment))))
(assert (= o2 (ite (<= o1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within)))) true false)))
(assert (and (= o (length fragment)) (in_range1 (length fragment))))
(assert (= o3 (ite (<= 1 o) true false)))
(assert (= result (ite (= o3 true) o2 false)))
(assert (= result true))
(assert (and (= o4 (length fragment)) (in_range1 (length fragment))))
(assert (= o5 (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) o4)))
(assert (= temp___1243 (+ o5 1)))
(assert (= (mk_int__ref result1) (mk_int__ref k)))
(assert (= k2 1))
(assert (<= 1 k2))
(assert (<= k2 temp___1243))
(assert (and (= o6 (length fragment)) (in_range1 (length fragment))))
(assert (= o7 (+ k2 o6)))
(assert (= temp___1229 (- o7 1)))
(assert (=> (<= k2 temp___1229) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k2) (<= k2 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) temp___1229) (<= temp___1229 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))))))
(assert (= o8 (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within)))))
(assert (= o8 temp___1231))
(assert (= (mk3 k2 temp___1229) temp___12311))
(assert (= result2 (bool_eq temp___1231 (to_rep1 (first6 temp___12311)) (to_rep1 (last6 temp___12311)) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment))))))
(assert (not (= result2 true)))
(assert (= bounded_dynamic_strings__location__2__result2 bounded_dynamic_strings__location__2__result))
(assert (= bounded_dynamic_strings__location__2__result2 bounded_dynamic_strings__location__2__result1))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 k3)) (not (= (bool_eq (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) (to_rep1 (first8 (mk4 j1 (- (+ j1 (length fragment)) 1)))) (to_rep1 (last8 (mk4 j1 (- (+ j1 (length fragment)) 1)))) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))) true)))))
(assert (and (=> (<= 1 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1)) (dynamic_property5 1 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1) k3)) (and (<= 1 k3) (<= k3 (+ (- (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 within))) (length fragment)) 1)))))
(assert (not (= k3 temp___1243)))
(assert (= k3 result4))
(assert (= k4 (+ k3 1)))
(assert (and (= o11 (length fragment)) (in_range1 (length fragment))))
(assert (= o12 (+ k4 o11)))
(assert (= temp___12291 (- o12 1)))
(assert (=> (<= k4 temp___12291) (and (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) k4) (<= k4 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))) (and (<= (to_rep1 (first2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))) temp___12291) (<= temp___12291 (to_rep1 (last2 (rt1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))))))))))
(assert (= o13 (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within)))))
(assert (= o13 temp___12312))
(assert (= (mk3 k4 temp___12291) temp___12313))
(assert (= result5 (bool_eq temp___12312 (to_rep1 (first6 temp___12313)) (to_rep1 (last6 temp___12313)) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment))))))
(assert (not (= result5 true)))
(assert (= bounded_dynamic_strings__location__2__result4 bounded_dynamic_strings__location__2__result3))
(declare-const j1 Int)
(assert (<= 1 j1))
(assert (<= j1 k4))
(assert (not (not (= (bool_eq (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 within))) (to_rep1 (first8 (mk4 j1 (- (+ j1 (length fragment)) 1)))) (to_rep1 (last8 (mk4 j1 (- (+ j1 (length fragment)) 1)))) (elts fragment) (to_rep1 (first (rt fragment))) (to_rep1 (last (rt fragment)))) true))))
(check-sat)
(exit)
