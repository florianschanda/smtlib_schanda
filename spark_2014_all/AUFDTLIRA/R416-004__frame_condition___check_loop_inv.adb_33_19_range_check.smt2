...
(assert (= (bool_eq (map__content a18) 1 10 (temp_____aggregate_def_348 0) 1 10) true))
(assert (= (bool_eq (map__content a18) 41 100 (temp_____aggregate_def_361 0) 41 100) true))
(assert (= (bool_eq (map__content a18) 11 20 (temp_____aggregate_def_374 1) 11 20) true))
(assert (= (bool_eq (map__content a18) 21 30 (temp_____aggregate_def_387 2) 21 30) true))
(assert (<= 31 40))
(assert (not (<= 31 (to_rep a__last))))
(check-sat)
(exit)
