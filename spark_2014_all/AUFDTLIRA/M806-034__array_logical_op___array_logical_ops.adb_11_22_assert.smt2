...
(assert (forall ((temp___135 Int) (temp___136 Int) (temp___137 Int) (temp___138 Int)) (let ((temp___134 (array_logical_ops__test_ok1__x__aggregate_def temp___135 temp___136 temp___137 temp___138))) (forall ((temp___139 Int)) (ite (and (<= 31 temp___139) (<= temp___139 40)) (= (select temp___134 temp___139) (of_rep temp___138)) (ite (and (<= 21 temp___139) (<= temp___139 30)) (= (select temp___134 temp___139) (of_rep temp___137)) (ite (and (<= 11 temp___139) (<= temp___139 20)) (= (select temp___134 temp___139) (of_rep temp___136)) (=> (and (<= 1 temp___139) (<= temp___139 10)) (= (select temp___134 temp___139) (of_rep temp___135))))))))))
(declare-sort t3b 0)
...
(assert (forall ((temp___141 Int) (temp___142 Int) (temp___143 Int)) (let ((temp___140 (array_logical_ops__test_ok1__y__aggregate_def temp___141 temp___142 temp___143))) (forall ((temp___144 Int)) (ite (and (<= 31 temp___144) (<= temp___144 40)) (= (select temp___140 temp___144) (of_rep temp___143)) (ite (and (<= 11 temp___144) (<= temp___144 30)) (= (select temp___140 temp___144) (of_rep temp___142)) (=> (and (<= 1 temp___144) (<= temp___144 10)) (= (select temp___140 temp___144) (of_rep temp___141)))))))))
...
(assert (dynamic_invariant r1 true false true))
