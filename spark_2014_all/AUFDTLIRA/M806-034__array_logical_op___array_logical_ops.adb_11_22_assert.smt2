...
(declare-fun array_logical_ops__test_ok1__x__aggregate_def (Int Int Int Int) (Array Int my_boolean))
(declare-sort t3b 0)
...
(declare-fun array_logical_ops__test_ok1__y__aggregate_def (Int Int Int) (Array Int my_boolean))
...
(assert (= x (of_array (array_logical_ops__test_ok1__x__aggregate_def 1 0 1 0) 1 40)))
...
(assert (forall ((temp___157 Int) (temp___158 Int) (temp___159 Int) (temp___160 Int)) (let ((temp___156 (array_logical_ops__test_ok1__x__aggregate_def temp___157 temp___158 temp___159 temp___160))) (=> (and (and (and (dynamic_invariant2 temp___157 true true true true) (dynamic_invariant2 temp___158 true true true true)) (dynamic_invariant2 temp___159 true true true true)) (dynamic_invariant2 temp___160 true true true true)) (forall ((temp___161 Int)) (ite (and (<= 31 temp___161) (<= temp___161 40)) (= (to_rep (select temp___156 temp___161)) temp___160) (ite (and (<= 21 temp___161) (<= temp___161 30)) (= (to_rep (select temp___156 temp___161)) temp___159) (ite (and (<= 11 temp___161) (<= temp___161 20)) (= (to_rep (select temp___156 temp___161)) temp___158) (=> (and (<= 1 temp___161) (<= temp___161 10)) (= (to_rep (select temp___156 temp___161)) temp___157))))))))))
(assert (= y (of_array (array_logical_ops__test_ok1__y__aggregate_def 0 1 0) 1 40)))
(assert (forall ((temp___163 Int) (temp___164 Int) (temp___165 Int)) (let ((temp___162 (array_logical_ops__test_ok1__y__aggregate_def temp___163 temp___164 temp___165))) (=> (and (and (dynamic_invariant2 temp___163 true true true true) (dynamic_invariant2 temp___164 true true true true)) (dynamic_invariant2 temp___165 true true true true)) (forall ((temp___166 Int)) (ite (and (<= 31 temp___166) (<= temp___166 40)) (= (to_rep (select temp___162 temp___166)) temp___165) (ite (and (<= 11 temp___166) (<= temp___166 30)) (= (to_rep (select temp___162 temp___166)) temp___164) (=> (and (<= 1 temp___166) (<= temp___166 10)) (= (to_rep (select temp___162 temp___166)) temp___163)))))))))
(assert (= r1 (of_array (andb (to_array x) (first1 x) (last1 x) (to_array y) (first1 y) (last1 y)) (first1 x) (last1 x))))
(assert (= (mk___t (array_logical_ops__test_ok1__x__aggregate_def 1 0 1 0) (mk 1 40)) x))
(assert (dynamic_invariant x true false true true))
(assert (= (mk___t (array_logical_ops__test_ok1__y__aggregate_def 0 1 0) (mk 1 40)) y))
(assert (dynamic_invariant y true false true true))
(assert (= (mk___t (andb (elts x) (to_rep1 (first (rt x))) (to_rep1 (last (rt x))) (elts y) (to_rep1 (first (rt y))) (to_rep1 (last (rt y)))) (mk (to_rep1 (first (rt x))) (to_rep1 (last (rt x))))) r1))
(assert (dynamic_invariant r1 true false true true))
(assert (not (= (to_rep1 (first (rt r1))) 1)))
(check-sat)
(exit)
