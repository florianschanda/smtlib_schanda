...
(assert (and (= o34 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (= o35 (ite (<= o34 i) true false)))
(assert (= result5 (ite (= o35 true) (ite (<= i index3) true false) false)))
(assert (= result5 true))
(assert (and (<= (to_rep1 n__first) i) (<= i (to_rep1 n__last))))
(assert (= o36 i))
(assert (= o37 (select n3 o36)))
(assert (= o38 (to_rep1 o37)))
(assert (= o39 (ite (<= o38 9) true false)))
