...
(define-fun dynamic_invariant3 ((temp___expr_182 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (=> (or (= temp___is_init_178 true) (<= 0 100)) (in_range1 temp___expr_182)))
...
(define-fun default_initial_assumption2 ((temp___expr_424 us_rep4) (temp___skip_top_level_425 Bool)) Bool (and (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_424))) 0) (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424))))) 0) (forall ((temp___428 Int)) (=> (and (<= 1 temp___428) (<= temp___428 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424)))) temp___428)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424)))) temp___428)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424)))) temp___428)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424)))) temp___428)))) 2))))) (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424))) 0))) (= (rec__search_trees__search_tree__values (us_split_fields7 temp___expr_424)) (temp_____aggregate_def_431 0))) (=> (not (= temp___skip_top_level_425 true)) (= (size1 temp___expr_424) 0))))
...
(assert (forall ((t us_rep4)) (! (=> (and (dynamic_invariant4 t true true true true) (type_invariant1 t)) (dynamic_invariant3 (size1 t) true false true true)) :pattern ((size1 t)))))
...
(assert (forall ((temp___433 Int)) (=> (dynamic_invariant5 temp___433 true true true true) (forall ((temp___434 Int)) (= (select (temp_____aggregate_def_431 temp___433) temp___434) rliteral)))))
...
(assert true)
(assert (forall ((f us_rep3)) (forall ((root Int)) (forall ((values (Array Int natural))) (! (= (= (ordered_leafs f root values) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___526 (model__ f root))) (select temp___526 i)))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___527 (model__ f root))) (select temp___527 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___528 (model__ f root))) (select temp___528 i)))) (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___529 (model__ f root))) (select temp___529 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___524 (model__ f root))) (select temp___524 j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___525 (model__ f root))) (select temp___525 i))))) 1)) 0) (< (to_rep2 (select values j)) (to_rep2 (select values i))) (< (to_rep2 (select values i)) (to_rep2 (select values j)))))))))) :pattern ((ordered_leafs f root values)))))))
...
(assert (forall ((f us_rep3)) (! (=> (dynamic_invariant2 f true true true true) (dynamic_invariant3 (size f) true false true true)) :pattern ((size f)))))
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 f true true true true) (dynamic_invariant i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 f true true true true) (dynamic_invariant i true true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant3 result true false true true)))) :pattern ((parent f i))))))
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant2 f true true true true) (dynamic_invariant i true true true true)) (not (= (parent f i) 0))) (dynamic_invariant7 (position f i) true false true true)) :pattern ((position f i))))))
...
(assert (and (= o (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range3 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t))))))
