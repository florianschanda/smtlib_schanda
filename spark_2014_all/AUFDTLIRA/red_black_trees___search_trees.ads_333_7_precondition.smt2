...
(define-fun dynamic_invariant ((temp___expr_175 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 100)) (in_range temp___expr_175)))
...
(define-fun dynamic_invariant2 ((temp___expr_315 us_rep1) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (=> (= temp___do_typ_inv_314 true) (= (tree_structure temp___expr_315) true)))
...
(define-fun dynamic_invariant3 ((temp___expr_420 us_rep4) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (= temp___do_typ_inv_419 true) (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_420))) true)))
(define-fun default_initial_assumption2 ((temp___expr_424 us_rep4) (temp___skip_top_level_425 Bool)) Bool (and (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_424))) 0) (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424))))) 0) (forall ((temp___428 Int)) (=> (and (<= 1 temp___428) (<= temp___428 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424)))) temp___428)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424)))) temp___428)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424)))) temp___428)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424)))) temp___428)))) 2))))) (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424))) 0))) (= (rec__search_trees__search_tree__values (us_split_fields7 temp___expr_424)) (temp___431 0))) (=> (not (= temp___skip_top_level_425 true)) (= (size1 temp___expr_424) 0))))
(define-fun type_invariant1 ((temp___436 us_rep4)) Bool (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___436))) 0) (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___436))) 0) (and (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___436))) 0)) (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 temp___436)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___436)))) true)) (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 temp___436)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___436))) (rec__search_trees__search_tree__values (us_split_fields7 temp___436))) true))))
(define-fun dynamic_invariant4 ((temp___expr_182 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (=> (or (= temp___is_init_178 true) (<= 0 100)) (in_range1 temp___expr_182)))
(assert (forall ((t us_rep4)) (! (=> (and (dynamic_invariant3 t true true true true) (type_invariant1 t)) (dynamic_invariant4 (size1 t) true false true true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep4)) (! (=> (dynamic_invariant3 t true true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))) :pattern ((size1 t)))))
...
(assert (forall ((temp___433 Int)) (=> (dynamic_invariant5 temp___433 true true true true) (forall ((temp___434 Int)) (= (to_rep2 (select (temp___431 temp___433) temp___434)) temp___433)))))
...
(define-fun default_initial_assumption4 ((temp___expr_232 us_rep2) (temp___skip_top_level_233 Bool)) Bool (=> (not (= temp___skip_top_level_233 true)) (= (length temp___expr_232) 0)))
(assert true)
...
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant2 f true true true true) (dynamic_invariant4 (size f) true false true true)) :pattern ((size f)))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 f true true true true) (dynamic_invariant i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 f true true true true) (dynamic_invariant i true true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant4 result true false true true)))) :pattern ((parent f i))))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant2 f true true true true) (dynamic_invariant i true true true true)) (not (= (parent f i) 0))) (dynamic_invariant7 (position f i) true false true true)) :pattern ((position f i))))))
...
(assert (forall ((container us_rep2)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant9 result true false true true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep2)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant10 position1 true true true true) (and (<= 1 position1) (<= position1 (last container)))) (dynamic_invariant11 (get container position1) true false true true)) :pattern ((get container position1))))))
(declare-const o Int)
