...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__tree_model__path_type__a us_rep2) (rec__tree_model__path_type__k Bool)))))
(define-fun us_split_fields_A__projection ((a us_split_fields4)) us_rep2 (rec__tree_model__path_type__a a))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (user_eq6 (rec__tree_model__path_type__a (us_split_fields5 a)) (rec__tree_model__path_type__a (us_split_fields5 b))) true) (= (rec__tree_model__path_type__k (us_split_fields5 a)) (rec__tree_model__path_type__k (us_split_fields5 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_150 Int) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (=> (or (= temp___is_init_147 true) (<= 1 100)) (in_range temp___expr_150)))
...
(define-fun dynamic_invariant1 ((temp___expr_216 (Array Int us_rep3)) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool)) Bool (forall ((temp___217 Int)) (=> (and (<= 1 temp___217) (<= temp___217 100)) (=> (= temp___is_init_213 true) (< (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___expr_216 temp___217)))) 100)))))
(define-fun default_initial_assumption ((temp___expr_219 (Array Int us_rep3)) (temp___skip_top_level_220 Bool)) Bool (forall ((temp___221 Int)) (=> (and (<= 1 temp___221) (<= temp___221 100)) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___expr_219 temp___221)))) 0) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___expr_219 temp___221))) (of_int 0))))))
...
(define-fun dynamic_invariant2 ((temp___expr_273 us_rep1) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool)) Bool (= (tree_structure temp___expr_273) true))
...
(declare-fun model__ (us_rep1 Int) (Array Int us_rep3))
(declare-fun model____function_guard ((Array Int us_rep3) us_rep1 Int) Bool)
(assert (forall ((f us_rep1)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant2 f true true true) (dynamic_invariant root true true true)) (= (valid_root f root) true)) (let ((result (model__ f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields5 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select result root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select result (parent f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select result i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select result i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select result i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select result (parent f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields5 (select result i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select result i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select result i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select result j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select result i))) (rec__tree_model__path_type__a (us_split_fields5 (select result j)))) true)) (= j i))))))))))) (dynamic_invariant1 result true false true)))) :pattern ((model__ f root))))))
...
(declare-const dummy9 (Array Int natural))
...
(declare-fun user_eq9 ((Array Int natural) (Array Int natural)) Bool)
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__search_trees__search_tree__root extended_index_type) (rec__search_trees__search_tree__struct us_rep1) (rec__search_trees__search_tree__values (Array Int natural))))))
...
(define-fun us_split_fields_Struct__projection ((a us_split_fields6)) us_rep1 (rec__search_trees__search_tree__struct a))
...
(define-fun bool_eq7 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 a))) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 b)))) (= (bool_eq2 (rec__search_trees__search_tree__struct (us_split_fields7 a)) (rec__search_trees__search_tree__struct (us_split_fields7 b))) true)) (= (bool_eq6 (rec__search_trees__search_tree__values (us_split_fields7 a)) 1 100 (rec__search_trees__search_tree__values (us_split_fields7 b)) 1 100) true)) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_376 us_rep4) (temp___is_init_373 Bool) (temp___skip_constant_374 Bool) (temp___do_toplevel_375 Bool)) Bool (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_376))) true))
(define-fun default_initial_assumption2 ((temp___expr_380 us_rep4) (temp___skip_top_level_381 Bool)) Bool (and (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_380))) 0) (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_380))))) 0) (forall ((temp___384 Int)) (=> (and (<= 1 temp___384) (<= temp___384 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_380)))) temp___384)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_380)))) temp___384)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_380)))) temp___384)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_380)))) temp___384)))) 2))))) (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_380))) 0))) (= (rec__search_trees__search_tree__values (us_split_fields7 temp___expr_380)) (temp___387 0))) (=> (not (= temp___skip_top_level_381 true)) (= (size1 temp___expr_380) 0))))
(define-fun type_invariant1 ((temp___392 us_rep4)) Bool (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___392))) 0) (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___392))) 0) (and (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___392))) 0)) (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 temp___392)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___392)))) true)) (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 temp___392)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___392))) (rec__search_trees__search_tree__values (us_split_fields7 temp___392))) true))))
(define-fun dynamic_invariant4 ((temp___expr_156 Int) (temp___is_init_153 Bool) (temp___skip_constant_154 Bool) (temp___do_toplevel_155 Bool)) Bool (=> (or (= temp___is_init_153 true) (<= 0 100)) (in_range1 temp___expr_156)))
(assert (forall ((t us_rep4)) (! (=> (and (dynamic_invariant3 t true true true) (type_invariant1 t)) (dynamic_invariant4 (size1 t) true false true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep4)) (! (=> (dynamic_invariant3 t true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))) :pattern ((size1 t)))))
...
(define-fun olt ((left us_rep2) (right us_rep2)) Bool (and (< (length left) (length right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last left))) (= (get left n) (get right n)))) true false)))
(declare-fun olt__function_guard (Bool us_rep2 us_rep2) Bool)
(assert true)
(assert (forall ((f us_rep1)) (forall ((root Int)) (forall ((values (Array Int natural))) (! (= (= (ordered_leafs f root values) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields5 (let ((temp___482 (model__ f root))) (select temp___482 i)))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (let ((temp___483 (model__ f root))) (select temp___483 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (let ((temp___484 (model__ f root))) (select temp___484 i)))) (rec__tree_model__path_type__a (us_split_fields5 (let ((temp___485 (model__ f root))) (select temp___485 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (let ((temp___480 (model__ f root))) (select temp___480 j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (let ((temp___481 (model__ f root))) (select temp___481 i))))) 1)) 0) (< (to_rep2 (select values j)) (to_rep2 (select values i))) (< (to_rep2 (select values i)) (to_rep2 (select values j)))))))))) :pattern ((ordered_leafs f root values)))))))
(define-fun dynamic_invariant6 ((temp___expr_162 Int) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool)) Bool (=> (or (= temp___is_init_159 true) (<= 0 2)) (in_range2 temp___expr_162)))
...
(define-fun dynamic_invariant8 ((temp___expr_205 us_rep3) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool)) Bool (=> (= temp___do_toplevel_204 true) (=> (= temp___is_init_202 true) (< (length (rec__tree_model__path_type__a (us_split_fields5 temp___expr_205))) 100))))
(define-fun default_initial_assumption3 ((temp___expr_207 us_rep3) (temp___skip_top_level_208 Bool)) Bool (and (= (length (rec__tree_model__path_type__a (us_split_fields5 temp___expr_207))) 0) (= (rec__tree_model__path_type__k (us_split_fields5 temp___expr_207)) (of_int 0))))
(define-fun dynamic_predicate ((temp___211 us_rep3)) Bool (< (length (rec__tree_model__path_type__a (us_split_fields5 temp___211))) 100))
(assert (forall ((a us_rep2) (b us_rep2)) (! (= (user_eq6 a b) (oeq a b)) :pattern ((user_eq6 a b)))))
(define-fun default_initial_assumption4 ((temp___expr_199 us_rep2) (temp___skip_top_level_200 Bool)) Bool (=> (not (= temp___skip_top_level_200 true)) (= (length temp___expr_199) 0)))
(assert true)
(assert (forall ((s1 us_rep2) (s2 us_rep2)) (forall ((d Int)) (! (= (= (is_add s1 d s2) true) (and (and (= (- (length s2) 1) (length s1)) (= (olt s1 s2) true)) (= (get s2 (length s2)) d))) :pattern ((is_add s1 d s2))))))
...
(assert (forall ((f us_rep1)) (! (=> (dynamic_invariant2 f true true true) (dynamic_invariant4 (size f) true false true)) :pattern ((size f)))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 f true true true) (dynamic_invariant i true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (dynamic_invariant2 f true true true) (dynamic_invariant i true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant4 result true false true)))) :pattern ((parent f i))))))
(assert (forall ((f us_rep1)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant2 f true true true) (dynamic_invariant i true true true)) (not (= (parent f i) 0))) (dynamic_invariant7 (position f i) true false true)) :pattern ((position f i))))))
...
(assert (forall ((container us_rep2)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant9 result true false true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep2)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant10 position1 true true true) (and (<= 1 position1) (<= position1 (last container)))) (dynamic_invariant11 (get container position1) true false true)) :pattern ((get container position1))))))
(declare-const o Int)
(declare-const o1 (Array Int us_rep3))
...
(assert (and (= o (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t))))))
