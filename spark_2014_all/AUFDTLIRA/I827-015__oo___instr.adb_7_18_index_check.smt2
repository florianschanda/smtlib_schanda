...
(define-fun default_initial_assumption ((temp___expr_161 us_rep) (temp___skip_top_level_162 Bool)) Bool (and (= (attr__tag temp___expr_161) us_tag) (= (rec__instr__instrument__name (us_split_fields1 temp___expr_161)) (temp___String_Literal_163 Tuple0))))
...
(assert (and (forall ((temp___323 Int)) (=> (and (<= 1 temp___323) (<= temp___323 14)) (=> (<= j2 temp___323) (= (select x__split_fields1 temp___323) (select x__split_fields temp___323))))) (and (<= (to_rep1 (first (rt s))) j2) (<= j2 (to_rep1 (last (rt s)))))))
