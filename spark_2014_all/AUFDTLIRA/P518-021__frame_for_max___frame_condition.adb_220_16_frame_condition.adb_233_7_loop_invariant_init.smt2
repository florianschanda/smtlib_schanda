...
(assert (not (= (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a2 i11)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a i11)))))))
(check-sat)
(exit)
