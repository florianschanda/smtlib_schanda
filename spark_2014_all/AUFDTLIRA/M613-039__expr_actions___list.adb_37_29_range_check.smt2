...
(assert (and (= o12 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1 o12 true false true true)))
...
(assert (=> (= result4 true) (= temp___518 (mk___t2 o10 (mk2 first2 temp___516)))))
...
(assert (=> (= result4 true) (= temp___517 (mk___t1 o11 (mk1 first2 temp___515)))))
...
(assert (and (= o9 (get (model__ l) o8)) (and (in_range7 o9) (= o9 (get (model__ l) o8)))))
