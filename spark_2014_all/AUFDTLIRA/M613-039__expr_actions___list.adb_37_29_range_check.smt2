...
(assert (and (= o12 (to__ (mk___rep s__split_fields10))) (dynamic_invariant1 o12 true false true)))
...
(assert (=> (= result4 true) (= temp___472 (mk___t2 o10 (mk2 first2 temp___470)))))
...
(assert (=> (= result4 true) (= temp___471 (mk___t1 o11 (mk1 first2 temp___469)))))
