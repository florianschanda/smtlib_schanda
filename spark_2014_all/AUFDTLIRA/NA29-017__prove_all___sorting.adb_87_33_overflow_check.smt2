...
(assert (and (= o14 (- length2 j2)) (in_range1 (- length2 j2))))
...
(assert (and (= o9 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (= o16 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) o9 o12 o13 o15)))
(assert (and (= o6 (- length1 i2)) (in_range1 (- length1 i2))))
(assert (and (= o7 o6) (in_range2 o6)))
(assert (and (= o5 (+ i2 j2)) (in_range1 (+ i2 j2))))
(assert (and (= o4 (+ a_first i2)) (in_range1 (+ a_first i2))))
(assert (and (= o3 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (= o8 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) o3 o4 o5 o7)))
(assert (and (= o1 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (and (= o (+ a_first length1)) (in_range1 (+ a_first length1))))
(assert (= o2 (perm2 (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t b (mk (to_rep b__first) (to_rep b__last))) a_first o o1 i2 j2)))
