...
(assert (and (= o15 (+ a_first length1)) (in_range1 (+ a_first length1))))
(assert (= o17 (perm2 (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t b1 (mk (to_rep b__first) (to_rep b__last))) a_first o15 o16 i2 j2)))
