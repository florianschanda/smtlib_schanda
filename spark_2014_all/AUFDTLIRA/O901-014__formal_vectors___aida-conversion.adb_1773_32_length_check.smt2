...
(assert (not (= (ite (<= (to_rep1 (first8 temp___21141)) (to_rep1 (last8 temp___21141))) (+ (- (to_rep1 (last8 temp___21141)) (to_rep1 (first8 temp___21141))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 2)) 1) 0))))
(check-sat)
(exit)
