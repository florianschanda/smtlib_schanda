...
(assert (=> (= 1 0) (= (to_rep o70) c205b2)))
(assert (=> (= 1 0) (= o71 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) c204b2))) o70 (rec__frame_condition__cell__max_right (us_split_fields1 (select (map__content a7) c204b2)))))))
(assert (=> (= 1 0) (= o72 (mk___rep o71))))
(assert (=> (= 1 0) (and (<= (to_rep1 a__first) c204b2) (<= c204b2 (to_rep1 a__last)))))
(assert (=> (= 1 0) (= o73 c204b2)))
(assert (=> (= 1 0) (= o74 (store (map__content a7) o73 o72))))
(assert (=> (= 1 0) (= result20 a7)))
(assert (=> (= 1 0) (= a9 o74)))
(assert (=> (= 1 0) (= a11 (mk_map__ref a9))))
(assert (=> (= 1 0) (= a12 a9)))
(assert (=> (not (= 1 0)) (= (to_rep o75) c205b2)))
(assert (=> (not (= 1 0)) (= o76 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) c204b2))) (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a7) c204b2))) o75))))
(assert (=> (not (= 1 0)) (= o77 (mk___rep o76))))
(assert (=> (not (= 1 0)) (and (<= (to_rep1 a__first) c204b2) (<= c204b2 (to_rep1 a__last)))))
(assert (=> (not (= 1 0)) (= o78 c204b2)))
(assert (=> (not (= 1 0)) (= o79 (store (map__content a7) o78 o77))))
(assert (=> (not (= 1 0)) (= result21 a7)))
(assert (=> (not (= 1 0)) (= a10 o79)))
(assert (=> (not (= 1 0)) (= a11 (mk_map__ref a10))))
(assert (=> (not (= 1 0)) (= a12 a10)))
(assert (and (<= (to_rep1 a__first) k14) (<= k14 (to_rep1 a__last))))
(assert (and (forall ((i11 Int)) (=> (and (<= first3 i11) (<= i11 k14)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a13 i11)))) max16))) (forall ((i11 Int)) (=> (and (<= k14 i11) (<= i11 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a13 i11)))) max16)))))
(assert true)
(assert (forall ((i11 Int)) (=> (and (<= k14 i11) (<= i11 (to_rep1 a__last))) (forall ((j5 Int)) (=> (and (<= i11 j5) (<= j5 (to_rep1 a__last))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a13 j5)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select a13 i11))))))))))
(assert (forall ((i11 Int)) (=> (and (<= (to_rep1 a__first) i11) (<= i11 (to_rep1 a__last))) (= (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a13 i11)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a7) i11))))))))
(assert (and (and (and (and (=> (<= 1 2147483647) (in_range3 c204b3)) (=> (<= 0 2147483647) (in_range2 c205b3))) (=> (<= 1 2147483647) (in_range3 k14))) (forall ((temp___262 Int)) (=> (and (<= (to_rep1 a__first) temp___262) (<= temp___262 (to_rep1 a__last))) (= (rec__frame_condition__cell__value (us_split_fields1 (select a13 temp___262))) (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) temp___262))))))) (=> (<= 0 2147483647) (in_range2 max16))))
(assert (not (= k14 last3)))
(assert (in_range4 c235b))
(assert (=> (= 1 0) (and (= o96 (+ k14 1)) (in_range1 (+ k14 1)))))
(assert (=> (= 1 0) (= result22 (mk_int__ref k14))))
(assert (=> (= 1 0) (= k15 o96)))
(assert (=> (= 1 0) (= k17 (mk_int__ref k15))))
(assert (=> (= 1 0) (= k18 k15)))
(assert (=> (not (= 1 0)) (and (= o97 (- k14 1)) (in_range3 (- k14 1)))))
(assert (=> (not (= 1 0)) (= result23 (mk_int__ref k14))))
(assert (=> (not (= 1 0)) (= k16 o97)))
(assert (=> (not (= 1 0)) (= k17 (mk_int__ref k16))))
(assert (=> (not (= 1 0)) (= k18 k16)))
(assert (and (<= (to_rep1 a__first) (int__content k17)) (<= (int__content k17) (to_rep1 a__last))))
(assert (= o98 (int__content k17)))
(assert (= o99 (select a13 o98)))
(assert (= o100 (us_split_fields1 o99)))
(assert (= o101 (rec__frame_condition__cell__value o100)))
(assert (= o102 (to_rep o101)))
(assert (= result24 (ite (< max16 o102) true false)))
(assert (=> (= result24 true) (and (<= (to_rep1 a__first) (int__content k17)) (<= (int__content k17) (to_rep1 a__last)))))
(assert (=> (= result24 true) (= o103 (int__content k17))))
(assert (=> (= result24 true) (= o104 (select a13 o103))))
(assert (=> (= result24 true) (= o105 (us_split_fields1 o104))))
(assert (=> (= result24 true) (= o106 (rec__frame_condition__cell__value o105))))
(assert (=> (= result24 true) (= o107 (to_rep o106))))
(assert (=> (= result24 true) (= result25 (mk_int__ref max16))))
(assert (=> (= result24 true) (= max17 o107)))
(assert (=> (= result24 true) (= max18 (mk_int__ref max17))))
(assert (=> (= result24 true) (= max19 max17)))
(assert (=> (not (= result24 true)) (= max18 (mk_int__ref max16))))
(assert (=> (not (= result24 true)) (= max19 max16)))
(assert (in_range4 c203b))
(assert (= result26 (mk_int__ref c204b3)))
(assert (= c204b4 (int__content k17)))
(assert (in_range3 c204b4))
(assert (= result27 (mk_int__ref c205b3)))
(assert (= c205b4 (int__content max18)))
(assert (in_range2 c205b4))
(assert (=> (= 1 0) (= (to_rep o108) c205b4)))
(assert (=> (= 1 0) (= o109 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select a13 c204b4))) o108 (rec__frame_condition__cell__max_right (us_split_fields1 (select a13 c204b4)))))))
(assert (=> (= 1 0) (= o110 (mk___rep o109))))
(assert (=> (= 1 0) (and (<= (to_rep1 a__first) c204b4) (<= c204b4 (to_rep1 a__last)))))
(assert (=> (= 1 0) (= o111 c204b4)))
(assert (=> (= 1 0) (= o112 (store a13 o111 o110))))
(assert (=> (= 1 0) (= result28 (mk_map__ref a13))))
(assert (=> (= 1 0) (= a14 o112)))
(assert (=> (= 1 0) (= a16 (mk_map__ref a14))))
(assert (=> (= 1 0) (= a17 a14)))
(assert (=> (not (= 1 0)) (= (to_rep o113) c205b4)))
(assert (=> (not (= 1 0)) (= o114 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select a13 c204b4))) (rec__frame_condition__cell__max_left (us_split_fields1 (select a13 c204b4))) o113))))
(assert (=> (not (= 1 0)) (= o115 (mk___rep o114))))
(assert (=> (not (= 1 0)) (and (<= (to_rep1 a__first) c204b4) (<= c204b4 (to_rep1 a__last)))))
(assert (=> (not (= 1 0)) (= o116 c204b4)))
(assert (=> (not (= 1 0)) (= o117 (store a13 o116 o115))))
(assert (=> (not (= 1 0)) (= result29 (mk_map__ref a13))))
(assert (=> (not (= 1 0)) (= a15 o117)))
(assert (=> (not (= 1 0)) (= a16 (mk_map__ref a15))))
(assert (=> (not (= 1 0)) (= a17 a15)))
(assert (= c205b5 (mk_int__ref c205b4)))
(assert (= c204b5 (mk_int__ref c204b4)))
(assert (= max20 max18))
(assert (= k21 k17))
(assert (= a18 a16))
(assert (= c205b6 c205b4))
(assert (= c204b6 c204b4))
(assert (= max21 max19))
(assert (= k22 k18))
(assert (= a19 a17))
(declare-const i11 Int)
(assert (<= (to_rep1 a__first) i11))
(assert (<= i11 (to_rep1 a__last)))
(assert (not (= (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a18) i11)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a7) i11)))))))
(check-sat)
(exit)
