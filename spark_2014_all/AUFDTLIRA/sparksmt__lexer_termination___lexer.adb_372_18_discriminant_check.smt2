...
(assert (= (to_rep4 o1) 3))
(assert (= o1 o10))
(assert (= temp___1072 o10))
(assert (= temp___10721 o6))
(assert (= temp___10722 o7))
(assert (= temp___10723 o8))
(assert (= temp___10724 o9))
(assert (= true temp___10725))
(assert (= t__attr__constrained true))
(assert (not (= temp___1072 t__split_discrs)))
(check-sat)
(exit)
