...
(assert (= (to_rep4 o1) 3))
(assert (= o1 o10))
(assert (= temp___976 o10))
(assert (= temp___9761 o6))
(assert (= temp___9762 o7))
(assert (= temp___9763 o8))
(assert (= temp___9764 o9))
(assert (= true temp___9765))
(assert (= t__attr__constrained true))
(assert (not (= temp___976 t__split_discrs)))
(check-sat)
(exit)
