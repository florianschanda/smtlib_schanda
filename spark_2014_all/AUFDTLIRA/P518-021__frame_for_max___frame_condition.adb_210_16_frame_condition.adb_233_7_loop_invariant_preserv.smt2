...
(assert (and (and (and (and (=> (<= 1 2147483647) (in_range3 c167b2)) (=> (<= 0 2147483647) (in_range2 c168b2))) (=> (<= 1 2147483647) (in_range3 k2))) (forall ((temp___252 Int)) (=> (and (<= (to_rep1 a__first) temp___252) (<= temp___252 (to_rep1 a__last))) (= (rec__frame_condition__cell__value (us_split_fields1 (select a2 temp___252))) (rec__frame_condition__cell__value (us_split_fields1 (select a temp___252))))))) (=> (<= 0 2147483647) (in_range2 max3))))
(assert (not (= k2 last2)))
...
(assert (<= i j))
(assert (<= j k3))
(assert (not (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a3 i)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a3 j)))))))
(check-sat)
(exit)
