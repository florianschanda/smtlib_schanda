...
(assert (and (= o44 (+ k5 1)) (in_range1 (+ k5 1))))
(assert (= result8 (mk_int__ref k5)))
(assert (= k6 o44))
(assert (and (<= (to_rep1 a__first) k6) (<= k6 (to_rep1 a__last))))
(assert (= o45 k6))
(assert (= o46 (select a3 o45)))
(assert (= o47 (us_split_fields1 o46)))
(assert (= o48 (rec__frame_condition__cell__value o47)))
(assert (= o49 (to_rep o48)))
(assert (= result9 (ite (< max6 o49) true false)))
(assert (=> (= result9 true) (and (<= (to_rep1 a__first) k6) (<= k6 (to_rep1 a__last)))))
(assert (=> (= result9 true) (= o50 k6)))
(assert (=> (= result9 true) (= o51 (select a3 o50))))
(assert (=> (= result9 true) (= o52 (us_split_fields1 o51))))
(assert (=> (= result9 true) (= o53 (rec__frame_condition__cell__value o52))))
(assert (=> (= result9 true) (= o54 (to_rep o53))))
(assert (=> (= result9 true) (= result10 (mk_int__ref max6))))
(assert (=> (= result9 true) (= max7 o54)))
(assert (=> (not (= result9 true)) (= max7 max6)))
(assert (in_range4 c166b))
(assert (= result11 (mk_int__ref c167b3)))
(assert (= c167b4 k6))
(assert (in_range3 c167b4))
(assert (= result12 (mk_int__ref c168b3)))
(assert (= c168b4 max7))
(assert (in_range2 c168b4))
(assert (= (to_rep o55) c168b4))
(assert (= o56 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select a3 c167b4))) o55 (rec__frame_condition__cell__max_right (us_split_fields1 (select a3 c167b4))))))
(assert (= o57 (mk___rep o56)))
(assert (and (<= (to_rep1 a__first) c167b4) (<= c167b4 (to_rep1 a__last))))
(assert (= o58 c167b4))
(assert (= o59 (store a3 o58 o57)))
(assert (= result13 (mk_map__ref a3)))
(assert (= a4 o59))
...
(assert (<= i11 j5))
(assert (<= j5 k6))
(assert (not (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a4 i11)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a4 j5)))))))
(check-sat)
(exit)
