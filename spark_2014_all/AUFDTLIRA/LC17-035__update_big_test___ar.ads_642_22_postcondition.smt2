...
(declare-fun temp_____aggregate_def_2543 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(assert (forall ((temp___2545 (Array Int (Array Int (Array Int (Array Int et1)))))) (forall ((temp___2546 Int) (temp___2548 Int)) (forall ((temp___2547 (Array Int (Array Int (Array Int et1)))) (temp___2549 (Array Int (Array Int (Array Int et1))))) (let ((temp___2544 (temp_____aggregate_def_2543 temp___2545 temp___2546 temp___2547 temp___2548 temp___2549))) (=> (and (dynamic_invariant temp___2546 true true true true) (dynamic_invariant temp___2548 true true true true)) (forall ((temp___2550 Int)) (ite (= temp___2550 temp___2548) (= (select temp___2544 temp___2550) temp___2549) (ite (= temp___2550 temp___2546) (= (select temp___2544 temp___2550) temp___2547) (= (select temp___2544 temp___2550) (select temp___2545 temp___2550)))))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq3 a3 90 99 (temp_____aggregate_def_2543 a i b j c) 90 99) true)))
(check-sat)
(exit)
