...
(declare-fun temp___2484 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(assert (forall ((temp___2486 (Array Int (Array Int (Array Int (Array Int et1)))))) (forall ((temp___2487 Int) (temp___2489 Int)) (forall ((temp___2488 (Array Int (Array Int (Array Int et1)))) (temp___2490 (Array Int (Array Int (Array Int et1))))) (let ((temp___2485 (temp___2484 temp___2486 temp___2487 temp___2488 temp___2489 temp___2490))) (forall ((temp___2491 Int)) (ite (= temp___2491 temp___2489) (= (select temp___2485 temp___2491) temp___2490) (ite (= temp___2491 temp___2487) (= (select temp___2485 temp___2491) temp___2488) (= (select temp___2485 temp___2491) (select temp___2486 temp___2491))))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq3 a3 90 99 (temp___2484 a i b j c) 90 99) true)))
(check-sat)
(exit)
