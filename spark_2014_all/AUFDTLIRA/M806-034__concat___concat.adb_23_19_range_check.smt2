...
(assert (=> (<= (to_rep (first (rt b))) (to_rep (last (rt b)))) (= o3 (+ (- (to_rep (last (rt b))) (to_rep (first (rt b)))) 1))))
(assert (=> (not (<= (to_rep (first (rt b))) (to_rep (last (rt b))))) (= o3 0)))
(assert (=> (<= (to_rep (first (rt a))) (to_rep (last (rt a)))) (= o4 (+ (- (to_rep (last (rt a))) (to_rep (first (rt a)))) 1))))
(assert (=> (not (<= (to_rep (first (rt a))) (to_rep (last (rt a))))) (= o4 0)))
(assert (= o5 (+ o4 o3)))
(assert (= o6 (+ (to_rep (first (rt a))) o5)))
(assert (= o7 (- o6 1)))
