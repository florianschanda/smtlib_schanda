...
(assert (=> (<= (to_rep (first (rt b))) (to_rep (last (rt b)))) (= o (+ (- (to_rep (last (rt b))) (to_rep (first (rt b)))) 1))))
(assert (=> (not (<= (to_rep (first (rt b))) (to_rep (last (rt b))))) (= o 0)))
(assert (=> (<= (to_rep (first (rt a))) (to_rep (last (rt a)))) (= o1 (+ (- (to_rep (last (rt a))) (to_rep (first (rt a)))) 1))))
(assert (=> (not (<= (to_rep (first (rt a))) (to_rep (last (rt a))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
