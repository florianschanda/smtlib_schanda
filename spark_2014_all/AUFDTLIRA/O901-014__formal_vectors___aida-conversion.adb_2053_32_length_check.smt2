...
(assert (not (= (ite (<= (to_rep1 (first8 temp___24101)) (to_rep1 (last8 temp___24101))) (+ (- (to_rep1 (last8 temp___24101)) (to_rep1 (first8 temp___24101))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) (+ (- (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 1)) 1) 0))))
(check-sat)
(exit)
