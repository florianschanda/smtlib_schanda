...
(define-fun dynamic_invariant ((temp___expr_313 Int) (temp___is_init_310 Bool) (temp___skip_constant_311 Bool) (temp___do_toplevel_312 Bool)) Bool (=> (or (= temp___is_init_310 true) (<= 0 43)) (in_range9 temp___expr_313)))
...
(define-fun dynamic_invariant1 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 2)) (in_range10 temp___expr_319)))
...
(assert (forall ((temp___160 Int)) (forall ((temp___161 Int)) (= (select (auditlog__noelement__aggregate_def temp___160) temp___161) (of_rep temp___160)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1372 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1372 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1372 us_void_param)))))
(declare-fun temp___String_Literal_1373 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1373 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1373 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1373 us_void_param)))))
(declare-fun temp___String_Literal_1374 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1374 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1374 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1374 us_void_param)))))
(declare-fun temp___String_Literal_1382 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1382 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1382 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1382 us_void_param)))))
(declare-fun temp___String_Literal_1383 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_1383 us_void_param) 1)) 44) (= (to_rep (select (temp___String_Literal_1383 us_void_param) 2)) 32)) :pattern ((temp___String_Literal_1383 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1034 Int) (temp___is_init_1031 Bool) (temp___skip_constant_1032 Bool) (temp___do_toplevel_1033 Bool)) Bool (=> (or (= temp___is_init_1031 true) (<= 1 20)) (in_range13 temp___expr_1034)))
(assert (= noelement (auditlog__noelement__aggregate_def 32)))
(define-fun dynamic_invariant7 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 1 150)) (in_range11 temp___expr_325)))
(define-fun dynamic_invariant8 ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 1 50)) (in_range12 temp___expr_340)))
(define-fun dynamic_invariant9 ((temp___expr_227 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1901 2099)) (in_range4 temp___expr_227)))
(define-fun dynamic_invariant10 ((temp___expr_233 Int) (temp___is_init_230 Bool) (temp___skip_constant_231 Bool) (temp___do_toplevel_232 Bool)) Bool (=> (or (= temp___is_init_230 true) (<= 1 12)) (in_range5 temp___expr_233)))
(define-fun dynamic_invariant11 ((temp___expr_239 Int) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (=> (or (= temp___is_init_236 true) (<= 1 31)) (in_range6 temp___expr_239)))
(define-fun dynamic_invariant12 ((temp___expr_263 Int) (temp___is_init_260 Bool) (temp___skip_constant_261 Bool) (temp___do_toplevel_262 Bool)) Bool (=> (or (= temp___is_init_260 true) (<= 0 86399999)) (in_range7 temp___expr_263)))
(define-fun dynamic_invariant13 ((temp___expr_279 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= 1 21)) (in_range8 temp___expr_279)))
...
(declare-const temp___1371 yearst)
(declare-const temp___13711 monthst)
(declare-const temp___13712 dayst)
(declare-const temp___13713 millisecst)
...
(assert (= o1 o))
(assert (= o2 (mk 1 21)))
(assert (= elementid c75b))
(assert (in_range9 c75b))
(assert (= result4 elementtext))
(assert (= elementtext1 noelement))
(assert (not (= (ite (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid)))))) (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid)))))) 1) 0) (ite (<= 1 (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid)))))) (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 elementid))))) 1) 1) 0))))
(check-sat)
(exit)
