...
(assert (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___150 Int)) (=> (and (<= 0 temp___150) (<= temp___150 30)) (=> (< i2 temp___150) (= (select a4 temp___150) (select a2 temp___150)))))) (and (<= 2 i2) (<= i2 30))))
(assert (<= 2 j))
(assert (<= j i2))
(assert (not (<= 0 (- j 2))))
(check-sat)
