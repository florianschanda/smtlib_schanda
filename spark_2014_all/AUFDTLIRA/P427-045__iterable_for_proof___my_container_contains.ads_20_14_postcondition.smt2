...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (and (= temp___175 c) (and (= temp___174 i1) (and (ite (= (to_rep (select c i1)) 0) (and (and (= (to_rep o) 1) (= o1 (store c i1 o))) (and (= (mk_map__ref result1) (mk_map__ref c)) (= c2 o1))) (and (= c2 c) (= c2 c1))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i2)) (= (valid (to_rep (select c3 j1))) true))) (and (and (and (=> (<= 1 100) (in_range3 i2)) (forall ((temp___176 Int)) (=> (and (<= 1 temp___176) (<= temp___176 100)) (=> (< i2 temp___176) (= (select c3 temp___176) (select temp___175 temp___176)))))) (and (<= 1 i2) (<= i2 100))) (= i2 100)))))) (and (and (= i2 i6) (= c3 c7)) (and (= i7 i2) (= c8 c3))))))
...
(assert (in_range1 e1))
(assert (= (mem c11 e1) true))
(assert (not (= (valid e1) true)))
(check-sat)
(exit)
