...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___175 c)))
...
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (and (=> (<= 1 100) (in_range3 i2)) (forall ((temp___176 Int)) (=> (and (<= 1 temp___176) (<= temp___176 100)) (=> (< i2 temp___176) (= (select c3 temp___176) (select temp___175 temp___176)))))) (and (<= 1 i2) (<= i2 100)))))
