...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___200 c)))
...
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (and (=> (<= 1 100) (in_range3 i2)) (forall ((temp___201 Int)) (=> (and (<= 1 temp___201) (<= temp___201 100)) (=> (< i2 temp___201) (= (select c3 temp___201) (select temp___200 temp___201)))))) (and (<= 1 i2) (<= i2 100)))))
