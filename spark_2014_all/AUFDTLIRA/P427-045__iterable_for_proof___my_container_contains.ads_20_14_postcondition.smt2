...
(declare-const i Int)
(declare-const temp___202 (Array Int natural))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 100)) (= temp___202 c)))
...
(assert (=> (and (<= 1 i1) (<= i1 100)) (and (and (=> (<= 1 100) (in_range3 i2)) (forall ((temp___203 Int)) (=> (and (<= 1 temp___203) (<= temp___203 100)) (=> (or (< 100 temp___203) (or (< temp___203 1) (< i2 temp___203))) (= (select c3 temp___203) (select temp___202 temp___203)))))) (and (<= 1 i2) (<= i2 100)))))
...
(declare-const e Int)
(assert (in_range1 e))
(assert (= (mem c8 e) true))
(assert (not (= (valid e) true)))
(check-sat)
(exit)
