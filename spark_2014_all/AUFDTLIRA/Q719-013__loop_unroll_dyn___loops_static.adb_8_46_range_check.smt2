...
(assert (<= 1 i1))
(assert (<= i1 2))
(assert (and (forall ((temp___319 Int)) (=> (and (<= (to_rep1 a__first) temp___319) (<= temp___319 (to_rep1 a__last))) (=> (<= i2 temp___319) (= (select a1 temp___319) (select a temp___319))))) (and (<= 1 i2) (<= i2 2))))
(assert (= (to_rep o) 0))
