...
(assert (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c106b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) y3))))) (let ((subject n7)) n110)) (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c107b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) y3)))) true)))
(assert (not (= (let ((subject n7)) n110) 100)))
(assert (= result91 (let ((subject n7)) (mk_int__ref n110))))
(assert (= (let ((subject n7)) n111) (+ (let ((subject n7)) n110) 1)))
(assert (= n112 (let ((subject n7)) (mk_int__ref n111))))
(assert (= n113 n111))
(declare-const i14 Int)
(assert (<= 1 i14))
(assert (<= i14 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i14))) true))
(assert (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c106b) i14)))) (int__content n112)))
(assert (not (= i14 y3)))
(assert (not (= i14 c108b)))
(assert (not (= (eq (select (nb_blacks c107b) i14) (select (nb_blacks c106b) i14)) true)))
(check-sat)
(exit)
