...
(assert (<= temp___2314 index2))
(assert (<= index2 temp___2315))
...
(assert (and (and (forall ((temp___2312 Int)) (=> (and (<= (to_rep1 n__first) temp___2312) (<= temp___2312 (to_rep1 n__last))) (=> (< index3 temp___2312) (= (select n3 temp___2312) (select n1 temp___2312))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6) index3))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 6)))))
(assert (not (= index3 temp___2315)))
...
(assert (<= (+ (to_rep1 (first (rt source))) 1) j1))
(assert (<= j1 index4))
