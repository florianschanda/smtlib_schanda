...
(assert (and (= (length source) 7) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index4 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index4) (<= index4 (+ (to_rep1 (first (rt source))) 6))) (= (is_digit (to_rep (select (elts source) index4))) true))))))
...
(assert (<= temp___2416 index1))
(assert (<= index1 temp___2417))
...
(assert (= n1 result3))
(assert (= n2 o8))
(assert (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9)))))
(assert (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j))))))
(assert (and (and (forall ((temp___2414 Int)) (=> (and (<= (to_rep1 n__first) temp___2414) (<= temp___2414 (to_rep1 n__last))) (=> (< index2 temp___2414) (= (select n3 temp___2414) (select n1 temp___2414))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 6)))))
(assert (not (= index2 temp___2417)))
...
(assert (= n4 o17))
(declare-const j Int)
(assert (<= (+ (to_rep1 (first (rt source))) 1) j))
(assert (<= j index3))
