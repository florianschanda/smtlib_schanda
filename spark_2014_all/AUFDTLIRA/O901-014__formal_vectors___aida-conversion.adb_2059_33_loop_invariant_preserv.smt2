...
(assert (<= temp___2314 index1))
(assert (<= index1 temp___2315))
...
(assert (and (and (forall ((temp___2312 Int)) (=> (and (<= (to_rep1 n__first) temp___2312) (<= temp___2312 (to_rep1 n__last))) (=> (< index2 temp___2312) (= (select n3 temp___2312) (select n1 temp___2312))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 6)))))
(assert (not (= index2 temp___2315)))
