...
(assert (= o7 j))
(assert (= o8 (select m o7)))
(assert (= o9 (us_split_fields7 o8)))
(assert (= result4 (rec__tree_model__path_type__k o9)))
(assert (=> (= result4 true) (and (= o1 j) (in_range5 j))))
(assert (=> (= result4 true) (and (= o2 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) o1 0)) (and (in_range2 o2) (= o2 (peek1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) o1 0))))))
(assert (=> (= result4 true) (= o3 (select res3 o2))))
(assert (=> (= result4 true) (= o4 (us_split_fields11 o3))))
(assert (=> (= result4 true) (= o5 (rec__red_black_trees__black_count__depth o4))))
(assert (=> (= result4 true) (= o6 (to_rep o5))))
(assert (=> (= result4 true) (= result3 (ite (<= o6 n2) true false))))
