...
(assert (and (= o63 (+ length1 length2)) (in_range1 (+ length1 length2))))
(assert (= o64 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t (map__content a2) (mk (to_rep a__first) (to_rep a__last))) a_first o63)))
