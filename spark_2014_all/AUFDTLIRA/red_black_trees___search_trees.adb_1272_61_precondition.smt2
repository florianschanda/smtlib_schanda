...
(declare-const j Int)
(declare-const o Int)
(declare-const temp___2109 (Array Int us_rep3))
...
(assert (= result2 true))
(assert (and (= o11 (peek (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) l d)) (and (in_range6 o11) (and (ite (not (= o11 0)) (and (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o11) d) (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o11) l)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j1) l) (not (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j1) l) (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j1) d)) (= o11 j1))))))))
(assert (= result3 (ite (= o11 0) true false)))
(assert (= result3 true))
...
(assert (= result4 true))
(assert (and (= o8 (size (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)))) (in_range6 o8)))
(assert (= o9 (+ o8 1)))
(assert (and (= o10 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range6 o10)))
(assert (= result5 (ite (= o10 o9) true false)))
(assert (= result5 true))
(assert (= (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) (to_rep1 t_old__split_fields)))
(assert (and (= o7 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range8 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (and (= result6 (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o7)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) o7) (not (= result6 true)))))
(assert (= result6 true))
(assert (not (= i 0)))
(assert (and (= o6 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) l d)) (and (in_range6 o6) (and (ite (not (= o6 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o6) d) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o6) l)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) l) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) l) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) d)) (= o6 j1))))))))
(assert (= result7 (ite (= o6 i) true false)))
(assert (= result7 true))
...
(assert (and (= temp___2109 (model__ (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o)) (and (dynamic_invariant8 temp___2109 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2109 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2109 o)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o)) (ite (and (not (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2109 (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2109 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2109 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2109 i1))) true) (not (= i1 o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___2109 (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1)))) (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2109 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2109 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2109 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2109 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___2109 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2109 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep2 (mk___split_fields2 o1 o2)) (select temp___2109 j)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= result10 o4))
...
(assert (not (= (valid_root (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o5) true)))
(check-sat)
(exit)
