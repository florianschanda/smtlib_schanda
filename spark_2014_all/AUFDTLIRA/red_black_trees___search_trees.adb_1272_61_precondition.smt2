...
(declare-const j Int)
(declare-const o Int)
(declare-const temp___2109 (Array Int us_rep1))
...
(assert (= result4 true))
(assert (and (= o8 (size (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)))) (in_range4 o8)))
(assert (= o9 (+ o8 1)))
(assert (and (= o10 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range4 o10)))
...
(assert (and (= o7 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
...
(assert (and (= temp___2109 (model__ (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) o)) (and (dynamic_invariant8 temp___2109 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2109 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2109 o)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2109 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2109 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2109 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2109 i1))) true) (not (= i1 o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___2109 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1)))) (position (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2109 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2109 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2109 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2109 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___2109 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2109 j1)))) true)) (= j1 i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___2109 j)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= result10 o4))
...
(assert (not (= (valid_root (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) o5) true)))
(check-sat)
(exit)
