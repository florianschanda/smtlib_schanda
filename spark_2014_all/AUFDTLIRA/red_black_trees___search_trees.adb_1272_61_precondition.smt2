...
(assert (and (= temp___2065 (model__ (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) o14)) (and (dynamic_invariant8 temp___2065 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2065 o14))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2065 o14)))) 0) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (not (= i4 o14)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i4) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2065 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i4)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2065 i4))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2065 i4))) true)))))) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2065 i4))) true) (not (= i4 o14))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___2065 (parent (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i4)))) (position (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) i4) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2065 i4)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2065 i4)))) 0)))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2065 i4))) true) (forall ((j14 Int)) (=> (and (<= 1 j14) (<= j14 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2065 j14))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___2065 i4))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2065 j14)))) true)) (= j14 i4))))))))))))))
(assert (= (mk___rep (mk___split_fields o15 o16)) (select temp___2065 j1)))
(assert (= o15 o17))
(assert (= o16 o18))
(assert (= result15 o18))
(assert (= result15 true))
(assert (and (= o20 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (not (= (valid_root (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)) o20) true)))
(check-sat)
(exit)
