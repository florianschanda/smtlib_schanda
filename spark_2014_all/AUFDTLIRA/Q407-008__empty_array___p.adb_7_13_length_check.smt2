...
(define-fun temp___1542 () us_t1 (mk___t1 temp___154 temp___1541))
(assert (in_range limit))
(assert (and (= us 1) (dynamic_property 1 last 1)))
(assert (= o 1))
(assert (= temp___1542 (p__c__aggregate_def o 1 limit)))
(assert (= (to_rep (first2 temp___1541)) 1))
(assert (= (to_rep (last3 temp___1541)) limit))
(assert (= (mk___t1 temp___155 temp___1551) temp___1542))
(assert (not (= (ite (<= (to_rep (first2 temp___1551)) (to_rep (last3 temp___1551))) (+ (- (to_rep (last3 temp___1551)) (to_rep (first2 temp___1551))) 1) 0) (ite (<= 1 last) (+ (- last 1) 1) 0))))
(check-sat)
(exit)
