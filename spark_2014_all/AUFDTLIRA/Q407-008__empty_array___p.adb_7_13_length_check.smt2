...
(declare-const temp___1781 t1)
(declare-const temp___179 (Array Int integer))
(declare-const temp___1791 t1)
(define-fun temp___1782 () us_t1 (mk___t1 temp___178 temp___1781))
(assert (in_range limit))
(assert (and (= us 1) (dynamic_property 1 last 1)))
(assert (= o 1))
(assert (= temp___1782 (p__c__aggregate_def o 1 limit)))
(assert (= (to_rep (first2 temp___1781)) 1))
(assert (= (to_rep (last3 temp___1781)) limit))
(assert (= (mk___t1 temp___179 temp___1791) temp___1782))
(assert (not (= (ite (<= (to_rep (first2 temp___1791)) (to_rep (last3 temp___1791))) (+ (- (to_rep (last3 temp___1791)) (to_rep (first2 temp___1791))) 1) 0) (ite (<= 1 last) (+ (- last 1) 1) 0))))
(check-sat)
(exit)
