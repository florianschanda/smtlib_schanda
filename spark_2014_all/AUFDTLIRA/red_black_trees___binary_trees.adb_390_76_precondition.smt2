...
(assert (= (mk___rep (mk___split_fields o15 o16)) (select temp___1174 j)))
(assert (= o15 o17))
(assert (= o16 o18))
(assert (= result4 o18))
...
(assert (=> (= result4 true) (= (mk___rep (mk___split_fields o10 o11)) (select temp___1176 j))))
...
(assert (=> (= result4 true) (= (mk___rep (mk___split_fields o5 o6)) (select temp___1175 i))))
(assert (=> (= result4 true) (= o5 o7)))
(assert (=> (= result4 true) (= o6 o8)))
(assert (=> (= result4 true) (= o9 o7)))
(assert (=> (= result4 true) (and (= result3 (olt o9 o14)) (= (= result3 true) (and (< (length o9) (length o14)) (forall ((n3 Int)) (=> (and (<= 1 n3) (<= n3 (last o9))) (= (get o9 n3) (get o14 n3)))))))))
