...
(assert (forall ((x max_lsid_type)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__foo__subject_state__max_id (us_split_discrs1 a))) (to_rep (rec__foo__subject_state__max_id (us_split_discrs1 b)))) (= (bool_eq1 (rec__foo__subject_state__states (us_split_fields1 a)) (rec__foo__subject_state__states (us_split_fields1 b))) true)) true false))
...
(define-fun bool_eq4 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep (rec__foo__subject_state__max_id (us_split_discrs2 a))) (to_rep (rec__foo__subject_state__max_id (us_split_discrs2 b)))) (= (bool_eq3 (rec__foo__subject_state__states1 (us_split_fields3 a)) (rec__foo__subject_state__states1 (us_split_fields3 b))) true)) true false))
(define-fun in_range3 ((rec__foo__subject_state__max_id1 Int) (a us_rep)) Bool (= rec__foo__subject_state__max_id1 (to_rep (rec__foo__subject_state__max_id (us_split_discrs1 a)))))
...
(assert (forall ((a (Array Int max_lsid_type)) (b (Array Int max_lsid_type))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep (select a temp___idx_154)) (to_rep (select b (+ (- b__first a__first) temp___idx_154)))))))))))
(declare-const cpu_lsid_last (Array Int max_lsid_type))
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-sort local_subject_id_type 0)
(declare-fun local_subject_id_typeqtint (local_subject_id_type) Int)
(assert (forall ((i local_subject_id_type)) (and (<= 0 (local_subject_id_typeqtint i)) (<= (local_subject_id_typeqtint i) 5))))
(define-fun in_range4 ((x Int)) Bool (and (<= 0 x) (<= x 5)))
(declare-fun attr__ATTRIBUTE_IMAGE5 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check5 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE5 (us_image) Int)
(declare-fun user_eq9 (local_subject_id_type local_subject_id_type) Bool)
(declare-const dummy9 local_subject_id_type)
...
(define-fun dynamic_invariant1 ((temp___expr_190 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool (and (=> (or (= temp___is_init_186 true) (<= 0 5)) (in_range4 temp___expr_190)) (=> (= temp___do_toplevel_188 true) (=> (= temp___is_init_186 true) (<= temp___expr_190 (to_rep (select cpu_lsid_last cpu_id)))))))
(define-fun dynamic_predicate ((temp___194 Int)) Bool (<= temp___194 (to_rep (select cpu_lsid_last cpu_id))))
(define-fun dynamic_invariant2 ((temp___expr_213 us_rep1) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool) (temp___do_typ_inv_212 Bool)) Bool (and (=> (not (= temp___skip_constant_210 true)) (in_range3 (to_rep (select cpu_lsid_last cpu_id)) (to_base temp___expr_213))) (and (dynamic_property3 0 (to_rep (select cpu_lsid_last cpu_id)) (first3 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_213))) (last3 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_213)))) (and (= (first3 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_213))) 0) (= (last3 (rec__foo__subject_state__states1 (us_split_fields3 temp___expr_213))) (to_rep (select cpu_lsid_last cpu_id)))))))
...
(assert (forall ((id Int)) (forall ((foo__states__fields us_split_fields2)) (! (=> (and (dynamic_invariant1 id true true true true) (dynamic_invariant2 (mk___rep1 states__split_discrs foo__states__fields) true true true true)) (dynamic_invariant (get_element id foo__states__fields) true false true true)) :pattern ((get_element id foo__states__fields))))))
(assert (forall ((id Int)) (forall ((foo__states__fields us_split_fields2)) (! (=> (and (dynamic_invariant1 id true true true true) (dynamic_invariant2 (mk___rep1 states__split_discrs foo__states__fields) true true true true)) (= (get_element id foo__states__fields) (to_rep2 (let ((temp___227 (rec__foo__subject_state__states1 (us_split_fields3 (mk___rep1 states__split_discrs foo__states__fields))))) (select (to_array1 temp___227) id))))) :pattern ((get_element id foo__states__fields))))))
...
(define-fun dynamic_invariant3 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 1)) (in_range5 temp___expr_166)))
(declare-fun foo__cpu_lsid_last__aggregate_def (Int Int) (Array Int max_lsid_type))
(define-fun dynamic_invariant4 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 5)) (in_range temp___expr_173)))
...
(assert (forall ((temp___156 Int) (temp___157 Int)) (let ((temp___155 (foo__cpu_lsid_last__aggregate_def temp___156 temp___157))) (=> (and (dynamic_invariant4 temp___156 true true true true) (dynamic_invariant4 temp___157 true true true true)) (and (= (select temp___155 0) rliteral) (= (select temp___155 1) rliteral1))))))
...
(assert (in_range5 cpu_id))
(assert (dynamic_invariant2 (mk___rep1 states__split_discrs (mk___split_fields1 (mk___t1 states__split_fields states__split_fields1))) true false true true))
