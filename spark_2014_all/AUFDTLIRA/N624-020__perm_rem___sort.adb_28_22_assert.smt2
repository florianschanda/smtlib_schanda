...
(assert (not (= (let ((temp___215 (remove (mk___t interm1 (mk 1 100)) x))) (let ((temp___214 (remove (mk___t init (mk 1 100)) x))) (bool_eq (elts temp___214) (to_rep1 (first (rt temp___214))) (to_rep1 (last (rt temp___214))) (elts temp___215) (to_rep1 (first (rt temp___215))) (to_rep1 (last (rt temp___215)))))) true)))
(check-sat)
(exit)
