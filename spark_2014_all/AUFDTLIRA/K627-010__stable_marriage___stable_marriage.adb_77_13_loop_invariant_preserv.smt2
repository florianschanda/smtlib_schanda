...
(assert (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (=> (exists ((prev Int)) (and (and (<= 1 prev) (<= prev (- rank2 1))) (= (to_rep (select r2 prev)) g2))) (= (to_rep (select r2 (to_rep1 (select result__2 g2)))) g2)))))
...
(assert (<= 1 g2))
(assert (<= g2 64))
(assert (exists ((prev Int)) (and (and (<= 1 prev) (<= prev (- rank3 1))) (= (to_rep (select r2 prev)) g2))))
(assert (not (= (to_rep (select r2 (to_rep1 (select result__3 g2)))) g2)))
(check-sat)
(exit)
