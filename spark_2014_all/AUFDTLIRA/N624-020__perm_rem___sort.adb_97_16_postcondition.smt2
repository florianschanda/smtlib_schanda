...
(assert (= index2 first))
(assert (=> (and (<= first index2) (<= index2 last)) (and (and (= temp___272 index2) (and (= temp___271 min1) (and (and (<= first min2) (<= min2 last)) (and (and (and (=> (<= 1 2147483647) (in_range2 min2)) (=> (<= first last) (dynamic_property first last index3))) (and (<= first index3) (<= index3 last))) (and (and (and (and (and (and (and (<= 1 min2) (<= min2 100)) (= o min2)) (= o1 (select values o))) (= o2 (to_rep o1))) (= result2 (ite (< (to_rep (select values index3)) o2) true false))) (ite (= result2 true) (and (= min2 result3) (= min3 index3)) (= min3 min2))) (= index3 last)))))) (and (and (= index3 index7) (= min3 min6)) (and (= index8 index3) (= min7 min3))))))
(assert (=> (and (<= first index2) (<= index2 last)) (= (mk_int__ref index9) (mk_int__ref index7))))
(assert (=> (and (<= first index2) (<= index2 last)) (= (mk_int__ref min8) (mk_int__ref min6))))
(assert (=> (and (<= first index2) (<= index2 last)) (= index10 index8)))
(assert (=> (and (<= first index2) (<= index2 last)) (= min9 min7)))
(assert (=> (not (and (<= first index2) (<= index2 last))) (= index2 index9)))
(assert (=> (not (and (<= first index2) (<= index2 last))) (= min1 min8)))
(assert (=> (not (and (<= first index2) (<= index2 last))) (= index10 index2)))
(assert (=> (not (and (<= first index2) (<= index2 last))) (= min9 min1)))
...
(assert (= result5 sort__index_of_minimum__result))
(assert (= sort__index_of_minimum__result1 min8))
...
(assert (= min11 min9))
(assert (= result6 sort__index_of_minimum__result4))
(assert (not (<= first sort__index_of_minimum__result4)))
(check-sat)
(exit)
