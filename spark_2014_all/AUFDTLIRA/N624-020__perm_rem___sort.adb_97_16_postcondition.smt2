...
(assert (= index2 first))
(assert (=> (and (<= first index2) (<= index2 last)) (= temp___298 index2)))
(assert (=> (and (<= first index2) (<= index2 last)) (= temp___297 min1)))
(assert (=> (and (<= first index2) (<= index2 last)) (and (<= first min2) (<= min2 last))))
(assert (=> (and (<= first index2) (<= index2 last)) (and (and (=> (<= 1 2147483647) (in_range2 min2)) (=> (<= first last) (dynamic_property first last index3))) (and (<= first index3) (<= index3 last)))))
(assert (=> (and (<= first index2) (<= index2 last)) (and (<= 1 min2) (<= min2 100))))
(assert (=> (and (<= first index2) (<= index2 last)) (= o min2)))
(assert (=> (and (<= first index2) (<= index2 last)) (= o1 (select values o))))
(assert (=> (and (<= first index2) (<= index2 last)) (= o2 (to_rep o1))))
(assert (=> (and (<= first index2) (<= index2 last)) (= result2 (ite (< (to_rep (select values index3)) o2) true false))))
(assert (=> (and (<= first index2) (<= index2 last)) (=> (= result2 true) (= min2 result3))))
(assert (=> (and (<= first index2) (<= index2 last)) (=> (= result2 true) (= min3 index3))))
(assert (=> (and (<= first index2) (<= index2 last)) (=> (not (= result2 true)) (= min3 min2))))
...
(assert (=> (and (<= first index2) (<= index2 last)) (= (mk_int__ref index6) (mk_int__ref index4))))
(assert (=> (and (<= first index2) (<= index2 last)) (= (mk_int__ref min6) (mk_int__ref min4))))
(assert (=> (and (<= first index2) (<= index2 last)) (= index7 index5)))
(assert (=> (and (<= first index2) (<= index2 last)) (= min7 min5)))
(assert (=> (not (and (<= first index2) (<= index2 last))) (= index2 index6)))
(assert (=> (not (and (<= first index2) (<= index2 last))) (= min1 min6)))
(assert (=> (not (and (<= first index2) (<= index2 last))) (= index7 index2)))
