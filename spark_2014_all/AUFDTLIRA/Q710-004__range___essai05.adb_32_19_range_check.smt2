...
(declare-datatypes () ((tTC23bSP1__ref (mk_tTC23bSP1__ref (tTC23bSP1__content tindex_aB)))))
(define-fun tTC23bSP1__ref___projection ((a tTC23bSP1__ref)) tindex_aB (tTC23bSP1__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((tC23bS__ref (mk_tC23bS__ref (tC23bS__content us_t2)))))
(define-fun tC23bS__ref___projection ((a tC23bS__ref)) us_t2 (tC23bS__content a))
(define-fun dynamic_invariant ((temp___expr_234 us_t2) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (=> (not (= temp___skip_constant_232 true)) (and (dynamic_property3 (to_rep a__first) (to_rep a__last) (first5 temp___expr_234) (last5 temp___expr_234)) (and (= (first5 temp___expr_234) (to_rep a__first)) (= (last5 temp___expr_234) (to_rep a__last))))))
(declare-const c23b__first tindex_aB)
(declare-const c23b__last tindex_aB)
...
(assert (forall ((temp___250 Int) (temp___251 Int) (temp___252 Int)) (let ((temp___249 (essai05__a__aggregate_def temp___250 temp___251 temp___252))) (and (and (= (select temp___249 (- 3)) (of_rep1 temp___250)) (= (select temp___249 (- 2)) (of_rep1 temp___251))) (= (select temp___249 (- 1)) (of_rep1 temp___252))))))
...
(define-fun dynamic_invariant2 ((temp___expr_172 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= (- 3) 15)) (in_range1 temp___expr_172)))
(define-fun dynamic_invariant3 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 3 15)) (in_range2 temp___expr_178)))
(define-fun dynamic_invariant4 ((temp___expr_184 us_t) (temp___is_init_181 Bool) (temp___skip_constant_182 Bool) (temp___do_toplevel_183 Bool)) Bool (=> (not (= temp___skip_constant_182 true)) (dynamic_property (- 3) 15 (first1 temp___expr_184) (last1 temp___expr_184))))
(define-fun dynamic_invariant5 ((temp___expr_189 us_t1) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (not (= temp___skip_constant_187 true)) (dynamic_property1 3 15 (first3 temp___expr_189) (last3 temp___expr_189))))
