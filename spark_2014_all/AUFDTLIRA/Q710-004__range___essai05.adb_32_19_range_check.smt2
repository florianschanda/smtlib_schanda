...
(define-fun dynamic_invariant ((temp___expr_271 us_t2) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool) (temp___do_typ_inv_270 Bool)) Bool (=> (not (= temp___skip_constant_268 true)) (and (dynamic_property3 (to_rep a__first) (to_rep a__last) (first5 temp___expr_271) (last5 temp___expr_271)) (and (= (first5 temp___expr_271) (to_rep a__first)) (= (last5 temp___expr_271) (to_rep a__last))))))
...
(assert (forall ((temp___288 Int) (temp___289 Int) (temp___290 Int)) (let ((temp___287 (essai05__a__aggregate_def temp___288 temp___289 temp___290))) (=> (and (and (dynamic_invariant1 temp___288 true true true true) (dynamic_invariant1 temp___289 true true true true)) (dynamic_invariant1 temp___290 true true true true)) (and (and (= (to_rep1 (select temp___287 (- 3))) temp___288) (= (to_rep1 (select temp___287 (- 2))) temp___289)) (= (to_rep1 (select temp___287 (- 1))) temp___290))))))
