...
(define-fun dynamic_invariant ((temp___expr_206 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 5)) (in_range2 temp___expr_206)))
...
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (in_range1 (to_rep (select r__split_fields6 n)))))
(check-sat)
(exit)
