...
(assert (= i11 i9))
(assert (= b11 b9))
(assert (and (= o61 (+ length1 length2)) (in_range1 (+ length1 length2))))
(assert (and (= o60 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (not (<= (to_rep (first (mk (to_rep b__first) (to_rep b__last)))) o60)))
(check-sat)
(exit)
