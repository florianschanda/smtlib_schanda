...
(assert (not (= (length1 temp___11482) 0)))
(assert (=> (<= (to_rep1 (first2 temp___11491)) (to_rep1 (last2 temp___11491))) (= o2 (+ (- (to_rep1 (last2 temp___11491)) (to_rep1 (first2 temp___11491))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___11491)) (to_rep1 (last2 temp___11491)))) (= o2 0)))
(assert (=> (<= (to_rep1 (first2 temp___11481)) (to_rep1 (last2 temp___11481))) (= o3 (+ (- (to_rep1 (last2 temp___11481)) (to_rep1 (first2 temp___11481))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___11481)) (to_rep1 (last2 temp___11481)))) (= o3 0)))
(assert (= o4 (+ o3 o2)))
(assert (= o5 (+ (to_rep1 (first2 temp___11481)) o4)))
(assert (= o6 (- o5 1)))
