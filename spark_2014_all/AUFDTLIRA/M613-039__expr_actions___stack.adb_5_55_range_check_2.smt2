...
(assert (=> (<= 1 (- (to_rep1 (rec__stack__stack__top (us_split_fields1 s))) 1)) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 (- (to_rep1 (rec__stack__stack__top (us_split_fields1 s))) 1)) (<= (- (to_rep1 (rec__stack__stack__top (us_split_fields1 s))) 1) 100)))))
(assert (= o (rec__stack__stack__content (us_split_fields1 s))))
(assert (= o temp___241))
(assert (= (mk1 1 (- (to_rep1 (rec__stack__stack__top (us_split_fields1 s))) 1)) temp___2411))
(assert (not (dynamic_property 1 2147483647 (to_rep (first2 temp___2411)) (to_rep (last2 temp___2411)))))
(check-sat)
(exit)
