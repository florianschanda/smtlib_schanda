...
(assert (=> (= (int__content i14) 0) (and (= o32 (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (ite (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= (is_empty o32) true) (and (forall ((i16 Int)) (=> (and (<= 1 i16) (<= i16 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i16))) true) (= (contains o32 (to_rep (select t__split_fields3 i16))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o32 v1) true) (exists ((i16 Int)) (and (and (<= 1 i16) (<= i16 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i16))) true) (= (to_rep (select t__split_fields3 i16)) v1))))))))))))
(assert (=> (= (int__content i14) 0) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= (int__content i14) 0) (and (= o31 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))) 0) (= (is_empty o31) true) (and (forall ((i16 Int)) (=> (and (<= 1 i16) (<= i16 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i16))) true) (= (contains o31 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i16))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o31 v1) true) (exists ((i16 Int)) (and (and (<= 1 i16) (<= i16 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i16))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i16)) v1))))))))))))
(assert (=> (= (int__content i14) 0) (and (= result22 (oeq1 o31 o32)) (= (= result22 true) (and (= (ole o31 o32) true) (= (ole o32 o31) true))))))
