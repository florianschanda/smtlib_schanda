...
(assert (=> (= result21 true) (and (= o91 (+ j3 1)) (in_range1 (+ j3 1)))))
(assert (=> (= result21 true) (and (= o92 (get (rec__list_allocator__m__t__available model____split_fields4) o91)) (in_range7 o92))))
(assert (=> (not (= result21 true)) (= o92 0)))
(assert (and (= temp___427 (get (rec__list_allocator__m__t__available model____split_fields4) j3)) (in_range7 temp___427)))
