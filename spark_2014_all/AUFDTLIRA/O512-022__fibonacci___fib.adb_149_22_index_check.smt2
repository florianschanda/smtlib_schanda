...
(assert (in_range2 k))
(assert (and (<= 0 k) (and (<= k 100) (and (forall ((i3 Int)) (=> (and (<= 0 i3) (<= i3 k)) (= (to_rep (select b1 i3)) (to_rep (select b2 i3))))) (forall ((i3 Int)) (=> (and (<= (+ k 1) i3) (<= i3 100)) (= (to_rep (select c1 (- i3 k))) (to_rep (select c2 (- i3 k))))))))))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 0))
(assert (<= 0 i1))
(assert (<= i1 k))
(assert (and (forall ((temp___247 Int)) (=> (and (<= 0 temp___247) (<= temp___247 100)) (=> (or (< k temp___247) (or (< temp___247 0) (<= i2 temp___247))) (= (select a11 temp___247) (select a1 temp___247))))) (and (<= 0 i2) (<= i2 k))))
(assert (not (<= i2 100)))
(check-sat)
(exit)
