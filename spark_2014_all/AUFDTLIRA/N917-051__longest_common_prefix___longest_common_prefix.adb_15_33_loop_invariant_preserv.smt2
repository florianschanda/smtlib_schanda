...
(assert (= temp___1581 result4))
(assert (= temp___1582 l2))
(assert (and (= o11 (+ l2 1)) (in_range1 (+ l2 1))))
(assert (= l2 result5))
(assert (= l3 o11))
(assert (and (= o19 (+ x l3)) (in_range1 (+ x l3))))
(assert (= result8 (ite (<= o19 1000) true false)))
(assert (=> (= result8 true) (and (= o18 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result8 true) (= result7 (ite (<= o18 1000) true false))))
...
(assert (=> (= result7 true) (= o14 temp___1601)))
(assert (=> (= result7 true) (= o15 (select a o14))))
(assert (=> (= result7 true) (= o16 (to_rep o15))))
(assert (=> (= result7 true) (and (= temp___1591 (+ x l3)) (in_range1 (+ x l3)))))
(assert (=> (= result7 true) (and (<= 1 temp___1591) (<= temp___1591 1000))))
(assert (=> (= result7 true) (= o12 temp___1591)))
(assert (=> (= result7 true) (= o13 (select a o12))))
(assert (=> (= result7 true) (= o17 (to_rep o13))))
(assert (=> (= result7 true) (= o20 (ite (= o17 o16) true false))))
(assert (=> (not (= result7 true)) (= o20 false)))
(assert (= result6 (ite (not (= o20 true)) true false)))
(assert (not (= result6 true)))
(declare-const k1 Int)
(assert (<= 0 k1))
(assert (<= k1 (- l3 1)))
(assert (not (= (to_rep (select a (+ x k1))) (to_rep (select a (+ y k1))))))
(check-sat)
(exit)
