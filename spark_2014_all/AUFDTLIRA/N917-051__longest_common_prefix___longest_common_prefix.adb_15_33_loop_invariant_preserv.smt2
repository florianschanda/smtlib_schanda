...
(assert (=> (= result2 true) (and (= temp___160 (+ y l1)) (in_range1 (+ y l1)))))
...
(assert (=> (= result2 true) (and (= temp___159 (+ x l1)) (in_range1 (+ x l1)))))
...
(assert (= result1 true))
(assert (forall ((k Int)) (=> (and (<= 0 k) (<= k (- l2 1))) (= (to_rep (select a (+ x k))) (to_rep (select a (+ y k)))))))
(assert (and (=> (<= 0 2147483647) (in_range2 l2)) (and (and (<= (+ x l2) 1000) (<= (+ y l2) 1000)) (= (to_rep (select a (+ x l2))) (to_rep (select a (+ y l2)))))))
(assert (= temp___158 result4))
(assert (= temp___1581 l2))
(assert (and (= o8 (+ l2 1)) (in_range1 (+ l2 1))))
(assert (= l2 result5))
(assert (= l3 o8))
(assert (and (= o16 (+ x l3)) (in_range1 (+ x l3))))
(assert (= result8 (ite (<= o16 1000) true false)))
(assert (=> (= result8 true) (and (= o15 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result8 true) (= result7 (ite (<= o15 1000) true false))))
(assert (=> (not (= result8 true)) (= result7 false)))
(assert (=> (= result7 true) (and (= temp___1601 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result7 true) (and (<= 1 temp___1601) (<= temp___1601 1000))))
(assert (=> (= result7 true) (= o11 temp___1601)))
(assert (=> (= result7 true) (= o12 (select a o11))))
(assert (=> (= result7 true) (= o13 (to_rep o12))))
(assert (=> (= result7 true) (and (= temp___1591 (+ x l3)) (in_range1 (+ x l3)))))
(assert (=> (= result7 true) (and (<= 1 temp___1591) (<= temp___1591 1000))))
(assert (=> (= result7 true) (= o9 temp___1591)))
(assert (=> (= result7 true) (= o10 (select a o9))))
(assert (=> (= result7 true) (= o14 (to_rep o10))))
(assert (=> (= result7 true) (= o17 (ite (= o14 o13) true false))))
(assert (=> (not (= result7 true)) (= o17 false)))
(assert (= result6 (ite (not (= o17 true)) true false)))
(assert (not (= result6 true)))
(declare-const k Int)
(assert (<= 0 k))
(assert (<= k (- l3 1)))
(assert (not (= (to_rep (select a (+ x k))) (to_rep (select a (+ y k))))))
(check-sat)
(exit)
