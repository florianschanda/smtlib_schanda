...
(assert (not (= kind1 1)))
(assert (= kind1 2))
(assert (not (var__decision__right__pred (mk___rep (mk___split_discrs d__split_discrs1) (mk___split_fields d__split_fields4 d__split_fields5 d__split_fields6 d__split_fields7) d__attr__constrained))))
(check-sat)
(exit)
