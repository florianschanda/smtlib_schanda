...
(define-fun dynamic_invariant1 ((temp___expr_239 us_t1) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (and (=> (not (= temp___skip_constant_237 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_239) (last3 temp___expr_239))) (=> (= temp___do_toplevel_238 true) (=> (= temp___is_init_236 true) (and (= (first1 (of_array (to_array1 temp___expr_239) (first3 temp___expr_239) (last3 temp___expr_239))) 1) (<= (last3 temp___expr_239) 20))))))
(define-fun dynamic_predicate1 ((temp___243 us_t1)) Bool (and (= (first1 (of_array (to_array1 temp___243) (first3 temp___243) (last3 temp___243))) 1) (<= (last3 temp___243) 20)))
...
(assert (dynamic_invariant1 i13s true false false))
(assert (dynamic_property 1 2147483647 (to_rep1 (first2 (rt1 i13s))) (to_rep1 (last2 (rt1 i13s)))))
(assert (= (elts1 i13s) temp___283))
(assert (= (mk (to_rep1 (first2 (rt1 i13s))) (to_rep1 (last2 (rt1 i13s)))) temp___2831))
(assert (not (= (to_rep1 (first temp___2831)) 1)))
(check-sat)
(exit)
