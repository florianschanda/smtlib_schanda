...
(assert (= o values))
(assert (= o temp___173))
(assert (= (mk1 current1 (to_rep values__last)) temp___1731))
(assert (= temp___173 o1))
(assert (= (mk (to_rep (first2 temp___1731)) (to_rep (last2 temp___1731))) o2))
(assert (and (= o3 (index_of_minimum (mk___t o1 o2))) (and (in_range2 o3) (and (and (<= (to_rep (first o2)) o3) (<= o3 (to_rep (last o2)))) (forall ((j2 Int)) (=> (and (<= (to_rep (first o2)) j2) (<= j2 (to_rep (last o2)))) (<= (to_rep (select o1 o3)) (to_rep (select o1 j2)))))))))
(assert (= result1 smallest))
(assert (= smallest1 o3))
(assert (=> (not (= smallest1 current1)) (and (= o4 current1) (in_range2 current1))))
(assert (=> (not (= smallest1 current1)) (and (= (to_rep (select values2 o4)) (to_rep (select values smallest1))) (and (= (to_rep (select values2 smallest1)) (to_rep (select values o4))) (forall ((j2 Int)) (=> (and (<= (to_rep values__first) j2) (<= j2 (to_rep values__last))) (=> (and (not (= j2 o4)) (not (= j2 smallest1))) (= (to_rep (select values2 j2)) (to_rep (select values j2))))))))))
(assert (=> (= smallest1 current1) (= values2 values)))
(assert (=> (= smallest1 current1) (= values2 values1)))
(assert (forall ((j2 Int)) (=> (and (<= current2 j2) (<= j2 (to_rep values__last))) (<= (to_rep (select values3 current2)) (to_rep (select values3 j2))))))
(assert (forall ((j2 Int)) (=> (and (<= (to_rep values__first) j2) (<= j2 (- current2 1))) (<= (to_rep (select values3 j2)) (to_rep (select values3 (+ j2 1)))))))
