...
(assert (= o values))
(assert (= o temp___199))
(assert (= (mk1 current1 (to_rep values__last)) temp___1991))
(assert (= temp___199 o1))
(assert (= (mk (to_rep (first2 temp___1991)) (to_rep (last2 temp___1991))) o2))
