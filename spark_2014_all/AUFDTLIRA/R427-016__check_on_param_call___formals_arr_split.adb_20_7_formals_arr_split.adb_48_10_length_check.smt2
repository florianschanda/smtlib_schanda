...
(declare-const temp___267 (Array Int natural))
(declare-const temp___2671 t6)
(declare-const temp___268 (Array Int natural))
(declare-const temp___2681 t2)
...
(assert (= b1 true))
(assert (not (= b2 true)))
(assert (= (to_rep (first12 (rt6 (temp_____aggregate_def_260 1 0 y)))) 0))
(assert (= (to_rep (last12 (rt6 (temp_____aggregate_def_260 1 0 y)))) y))
(assert (= (mk___t6 temp___267 temp___2671) (temp_____aggregate_def_260 1 0 y)))
(assert (= (ite (<= (to_rep (first12 temp___2671)) (to_rep (last12 temp___2671))) (+ (- (to_rep (last12 temp___2671)) (to_rep (first12 temp___2671))) 1) 0) (ite (<= 0 y) (+ (- y 0) 1) 0)))
(assert (= temp___267 temp___268))
(assert (= (mk2 (to_rep (first12 temp___2671)) (to_rep (last12 temp___2671))) temp___2681))
