...
(declare-const temp___1989 (Array Int character))
(declare-const temp___19891 t1)
(assert (in_range3 x))
...
(assert (= (elts (to_string (attr__ATTRIBUTE_IMAGE3 x))) temp___1989))
(assert (= (mk1 (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 x))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 x)))))) temp___19891))
(assert (not (dynamic_predicate (mk___t1 temp___1989 temp___19891))))
(check-sat)
(exit)
