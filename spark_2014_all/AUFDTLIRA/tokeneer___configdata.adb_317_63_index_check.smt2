...
(define-fun dynamic_invariant6 ((temp___expr_1189 Int) (temp___is_init_1186 Bool) (temp___skip_constant_1187 Bool) (temp___do_toplevel_1188 Bool)) Bool (=> (or (= temp___is_init_1186 true) (<= 1 12)) (in_range6 temp___expr_1189)))
...
(declare-const temp___1317 Bool)
...
(declare-const temp___13191 Int)
(declare-const temp___13181 Int)
(declare-const temp___13171 Bool)
...
(declare-const temp___13192 Int)
(declare-const temp___13182 Int)
(declare-const temp___13172 Bool)
...
(declare-const temp___13193 Int)
(declare-const temp___13183 Int)
(declare-const temp___13173 Bool)
...
(declare-const temp___13194 Int)
(declare-const temp___13184 Int)
(declare-const temp___13174 Bool)
...
(assert (= temp___1326 (configdata__classstringlookup__aggregate_def o27 o26 (mk___rep (mk___split_fields o24 o25)) (mk___rep (mk___split_fields o22 o23)) (mk___rep (mk___split_fields o20 o21)) (mk___rep (mk___split_fields o18 o19)))))
(assert (= temp___1326 classstringlookup))
...
(assert (<= i2 r30b2))
(assert (<= i3 stop1))
(assert (and (=> (<= 1 r30b2) (dynamic_property1 1 r30b2 i3)) (and (<= 1 i3) (<= i3 r30b2))))
(assert (not (<= 1 i3)))
(check-sat)
(exit)
