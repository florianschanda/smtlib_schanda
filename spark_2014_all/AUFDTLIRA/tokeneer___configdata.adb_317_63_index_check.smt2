...
(define-fun dynamic_invariant6 ((temp___expr_1402 Int) (temp___is_init_1398 Bool) (temp___skip_constant_1399 Bool) (temp___do_toplevel_1400 Bool) (temp___do_typ_inv_1401 Bool)) Bool (=> (or (= temp___is_init_1398 true) (<= 1 12)) (in_range6 temp___expr_1402)))
...
(assert (= temp___1551 (configdata__classstringlookup__aggregate_def o27 o26 (mk___rep (mk___split_fields o24 o25)) (mk___rep (mk___split_fields o22 o23)) (mk___rep (mk___split_fields o20 o21)) (mk___rep (mk___split_fields o18 o19)))))
(assert (= temp___1551 classstringlookup))
