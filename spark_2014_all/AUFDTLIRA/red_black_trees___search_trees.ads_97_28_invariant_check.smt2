...
(assert (=> (not (= (int__content i14) 0)) (= o35 (us_split_fields1 o34))))
...
(assert (=> (= result20 true) (and (= o31 (root (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (in_range3 o31) (= o31 (to_rep1 t__split_fields))))))
(assert (=> (= result20 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result20 true) (and (= o32 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o32) (= o32 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
...
(assert (=> (= result19 true) (and (= o30 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o30) (= o30 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result19 true) (= result18 (ite (= o30 (+ (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 1)) true false))))
