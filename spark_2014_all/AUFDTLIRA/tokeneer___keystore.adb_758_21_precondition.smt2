...
(declare-const c137b (Array Int character))
...
(declare-const temp___1171 (Array Int character))
(declare-const temp___11711 t1)
(declare-const temp___1172 (Array Int character))
(declare-const temp___11721 t1)
(declare-const o8 (Array Int character))
(declare-const temp___1167 (Array Int character))
(declare-const temp___11671 t)
...
(declare-const c137b1 (Array Int character))
...
(assert (=> (= result2 true) (= (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) temp___1168)))
(assert (=> (= result2 true) (= (mk1 1 (length thestring)) temp___11681)))
(assert (=> (= result2 true) (and (= temp___1170 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= result2 true) (=> (<= 1 temp___1170) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1170) (<= temp___1170 150))))))
(assert (=> (= result2 true) (= o7 result__1)))
(assert (=> (= result2 true) (= o7 temp___1171)))
(assert (=> (= result2 true) (= (mk1 1 temp___1170) temp___11711)))
(assert (=> (= result2 true) (= (ite (<= (to_rep1 (first2 temp___11681)) (to_rep1 (last2 temp___11681))) (+ (- (to_rep1 (last2 temp___11681)) (to_rep1 (first2 temp___11681))) 1) 0) (ite (<= (to_rep1 (first2 temp___11711)) (to_rep1 (last2 temp___11711))) (+ (- (to_rep1 (last2 temp___11711)) (to_rep1 (first2 temp___11711))) 1) 0))))
(assert (=> (= result2 true) (= (mk___t1 temp___1172 temp___11721) (mk___t1 temp___1168 temp___11681))))
(assert (=> (= result2 true) (forall ((temp___1173 Int)) (ite (and (<= 1 temp___1173) (<= temp___1173 (length thestring))) (= (select o8 temp___1173) (select temp___1172 temp___1173)) (= (select o8 temp___1173) (select result__1 temp___1173))))))
...
(assert (=> (not (= result2 true)) (= (mk___t temp___1167 temp___11671) thestring)))
(assert (=> (not (= result2 true)) (= o9 temp___1167)))
...
(assert (= result5 (mk_map__ref c137b)))
(assert (= c137b1 result__2))
