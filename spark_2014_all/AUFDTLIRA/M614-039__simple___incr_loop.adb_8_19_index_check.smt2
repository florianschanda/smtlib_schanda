...
(assert (and (and (=> (<= (to_rep a__first) (to_rep a__last)) (dynamic_property1 (to_rep a__first) (to_rep a__last) i2)) (forall ((temp___154 Int)) (=> (and (<= (to_rep a__first) temp___154) (<= temp___154 (to_rep a__last))) (=> (<= i2 temp___154) (= (select a1 temp___154) (select a temp___154)))))) (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last)))))
(assert (= (= o7 true) (forall ((k1 Int)) (=> (and (<= i2 k1) (<= k1 (to_rep a__last))) (= (to_rep (select a1 k1)) (to_rep (select a k1)))))))
