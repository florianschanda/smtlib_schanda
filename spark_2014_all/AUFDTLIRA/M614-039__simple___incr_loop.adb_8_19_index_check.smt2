...
(assert (and (and (=> (<= (to_rep a__first) (to_rep a__last)) (dynamic_property1 (to_rep a__first) (to_rep a__last) i2)) (forall ((temp___178 Int)) (=> (and (<= (to_rep a__first) temp___178) (<= temp___178 (to_rep a__last))) (=> (<= i2 temp___178) (= (select a1 temp___178) (select a temp___178)))))) (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last)))))
