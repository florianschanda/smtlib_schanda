...
(assert (<= (to_rep a__first) i3))
(assert (<= i3 (to_rep a__last)))
(assert (and (forall ((k2 Int)) (=> (and (<= (to_rep a__first) k2) (<= k2 (- i4 1))) (= (to_rep (select a2 k2)) (+ (to_rep (select a k2)) 1)))) (forall ((k2 Int)) (=> (and (<= i4 k2) (<= k2 (to_rep a__last))) (= (to_rep (select a2 k2)) (to_rep (select a k2)))))))
(assert (and (and (=> (<= (to_rep a__first) (to_rep a__last)) (dynamic_property1 (to_rep a__first) (to_rep a__last) i4)) (forall ((temp___154 Int)) (=> (and (<= (to_rep a__first) temp___154) (<= temp___154 (to_rep a__last))) (=> (<= i4 temp___154) (= (select a2 temp___154) (select a temp___154)))))) (and (<= (to_rep a__first) i4) (<= i4 (to_rep a__last)))))
(assert (= (= o10 true) (forall ((k2 Int)) (=> (and (<= i4 k2) (<= k2 (to_rep a__last))) (= (to_rep (select a2 k2)) (to_rep (select a k2)))))))
(assert (and (= o (- i4 1)) (in_range1 (- i4 1))))
