...
(declare-const temp___898 (Array Int us_rep7))
...
(declare-const temp___897 (Array Int us_rep7))
...
(assert (and (= temp___898 (nb_blacks c87b)) (and (= (bool_eq11 (select temp___898 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c87b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___898 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___898 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___898 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___898 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___898 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___898 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___898 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___898 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___898 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c87b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___898 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i 0))))))))))))))
(assert (and (= o50 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) y1)) (and (in_range2 o50) (and (= o50 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)))) y1)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c88b))) 0) (= o50 0))))))
(assert (= o51 (select temp___898 o50)))
...
(assert (and (= temp___897 (nb_blacks c88b)) (and (= (bool_eq11 (select temp___897 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c88b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___897 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___897 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___897 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___897 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___897 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___897 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___897 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___897 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___897 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c88b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___897 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) i 0))))))))))))))
(assert (and (= o55 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)) y1)) (and (in_range2 o55) (and (= o55 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c88b)))) y1)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c88b))) 0) (= o55 0))))))
(assert (= o56 (select temp___897 o55)))
