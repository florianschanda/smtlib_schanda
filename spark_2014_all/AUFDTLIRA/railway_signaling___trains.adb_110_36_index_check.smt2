...
(assert (=> (= result9 true) (and (= temp___375 (get_previous_track o29 id1)) (and (in_range1 temp___375) (= temp___375 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o26)))))) id1)))))))
...
(assert (and (= temp___377 (get_other_previous_track o31 id1)) (and (in_range1 temp___377) (= temp___377 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o14)))))) id1)) (to_rep o16)) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o14)))))) id1)))))))
(assert (not (<= 1 temp___377)))
(check-sat)
(exit)
