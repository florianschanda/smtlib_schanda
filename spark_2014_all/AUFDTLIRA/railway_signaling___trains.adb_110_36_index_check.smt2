...
(assert (and (= o21 (get_previous_track o30 id1)) (and (in_range3 o21) (= o21 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 o20)))))) id1))))))
...
(assert (=> (= result9 true) (and (= temp___407 (get_previous_track o29 id1)) (and (in_range3 temp___407) (= temp___407 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 o26)))))) id1)))))))
...
(assert (and (= temp___409 (get_other_previous_track o31 id1)) (and (in_range3 temp___409) (= temp___409 (ite (= (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 o14)))))) id1)) (to_rep4 o16)) 0 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 o14)))))) id1)))))))
(assert (not (<= temp___409 8)))
(check-sat)
(exit)
