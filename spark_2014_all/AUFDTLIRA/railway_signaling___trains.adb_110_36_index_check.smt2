...
(assert (and (<= 1 train1) (<= train1 10)))
(assert (= o12 train1))
(assert (= (mk___rep1 (mk___split_fields1 o13 o14 o15)) (select trains3 o12)))
(assert (and (= o16 (get_other_previous_track (mk___rep1 (mk___split_fields1 o13 o14 o15)) id2)) (and (in_range1 o16) (= o16 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o13)))))) id2)) (to_rep o15)) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o13)))))) id2)))))))
(assert (= o17 (ite (= o16 0) true false)))
(assert (= result16 (ite (not (= o17 true)) true false)))
(assert (= result16 true))
(assert (and (<= 1 train1) (<= train1 10)))
(assert (= o18 train1))
(assert (= (mk___rep1 (mk___split_fields1 o19 o20 o21)) (select trains3 o18)))
(assert (and (= temp___377 (get_other_previous_track (mk___rep1 (mk___split_fields1 o19 o20 o21)) id2)) (and (in_range1 temp___377) (= temp___377 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o19)))))) id2)) (to_rep o21)) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o19)))))) id2)))))))
