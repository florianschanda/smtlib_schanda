...
(assert (and (= o21 (get_previous_track o30 id1)) (and (in_range1 o21) (= o21 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o20)))))) id1))))))
...
(assert (=> (= result9 true) (and (= temp___407 (get_previous_track o29 id1)) (and (in_range1 temp___407) (= temp___407 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o26)))))) id1)))))))
(assert (=> (= result9 true) (and (<= 1 temp___407) (<= temp___407 8))))
(assert (=> (= result9 true) (= o27 temp___407)))
(assert (=> (= result9 true) (= o28 (select (map__content4 track_signals6) o27))))
(assert (=> (= result9 true) (= temp___408 (to_rep5 o28))))
...
(assert (and (= o11 (get_other_previous_track o32 id1)) (and (in_range1 o11) (= o11 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o8)))))) id1)) (to_rep o10)) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o8)))))) id1)))))))
...
(assert (and (= temp___409 (get_other_previous_track o31 id1)) (and (in_range1 temp___409) (= temp___409 (ite (= (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o14)))))) id1)) (to_rep o16)) 0 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o14)))))) id1)))))))
