...
(assert (= o29 a))
(assert (= o29 temp___179))
(assert (= (mk1 y (- (+ y (int__content longest_common_prefix__lcp__result4)) 1)) temp___1791))
...
(assert (= o30 a))
(assert (= o30 temp___178))
(assert (= (mk x (- (+ x (int__content longest_common_prefix__lcp__result4)) 1)) temp___1781))
(assert (= result14 (bool_eq temp___178 (to_rep (first temp___1781)) (to_rep (last temp___1781)) temp___179 (to_rep (first2 temp___1791)) (to_rep (last2 temp___1791)))))
(assert (= result14 true))
(assert (<= 1 (+ (int__content longest_common_prefix__lcp__result4) x)))
(assert (<= (+ (int__content longest_common_prefix__lcp__result4) x) 1000))
(assert (<= 1 (+ (int__content longest_common_prefix__lcp__result4) y)))
(assert (<= (+ (int__content longest_common_prefix__lcp__result4) y) 1000))
(assert (not (<= 1 (+ y (int__content longest_common_prefix__lcp__result4)))))
(check-sat)
(exit)
