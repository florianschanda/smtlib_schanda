...
(assert (and (= o4 (root (rec__red_black_trees__rbt__struct t__split_fields6))) (and (in_range4 o4) (= o4 (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct t__split_fields6))))))))
(assert (= o5 (ite (= x1 o4) true false)))
(assert (= result3 (ite (not (= o5 true)) true false)))
(assert (= result3 true))
(assert (not (in_range4 x1)))
(check-sat)
(exit)
