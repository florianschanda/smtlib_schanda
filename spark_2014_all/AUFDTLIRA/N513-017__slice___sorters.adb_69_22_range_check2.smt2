...
(assert (=> (not (= smallest1 current1)) (and (= (to_rep (select o5 o4)) (to_rep (select values smallest1))) (and (= (to_rep (select o5 smallest1)) (to_rep (select values o4))) (forall ((j Int)) (=> (and (<= (to_rep values__first) j) (<= j (to_rep values__last))) (=> (and (not (= j o4)) (not (= j smallest1))) (= (to_rep (select o5 j)) (to_rep (select values j))))))))))
...
(assert (= result2 true))
(assert (<= (to_rep values__first) (- current2 1)))
(assert (not (<= 1 (to_rep values__first))))
(check-sat)
(exit)
