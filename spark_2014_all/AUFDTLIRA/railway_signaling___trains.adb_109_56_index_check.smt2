...
(assert (=> (= result15 true) (and (<= 1 train1) (<= train1 10))))
(assert (=> (= result15 true) (= o28 train1)))
(assert (=> (= result15 true) (= (mk___rep1 (mk___split_fields1 o29 o30 o31)) (select trains3 o28))))
(assert (=> (= result15 true) (and (= temp___375 (get_previous_track (mk___rep1 (mk___split_fields1 o29 o30 o31)) id2)) (and (in_range1 temp___375) (= temp___375 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o31)))))) id2)))))))
(assert (=> (= result15 true) (and (<= 1 temp___375) (<= temp___375 8))))
(assert (=> (= result15 true) (= o32 temp___375)))
(assert (=> (= result15 true) (= o33 (select (map__content4 track_signals10) o32))))
(assert (=> (= result15 true) (= temp___376 (to_rep5 o33))))
(assert (=> (= result15 true) (= result14 (ite (or (= temp___376 1) (= temp___376 2)) true false))))
(assert (=> (not (= result15 true)) (= result14 (of_int 1))))
