...
(assert (and (= o11 (get_previous_track o20 id1)) (and (in_range3 o11) (= o11 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 o10)))))) id1))))))
...
(assert (=> (= result9 true) (and (= temp___407 (get_previous_track o19 id1)) (and (in_range3 temp___407) (= temp___407 (to_rep2 (select (select previous_tracks (to_rep (rec__trains__track__from (us_split_fields1 (select tracks (to_rep4 o16)))))) id1)))))))
(assert (=> (= result9 true) (and (<= 1 temp___407) (<= temp___407 8))))
(assert (=> (= result9 true) (= o17 temp___407)))
(assert (=> (= result9 true) (= o18 (select (map__content4 track_signals6) o17))))
(assert (=> (= result9 true) (= temp___408 (to_rep5 o18))))
