...
(define-fun o19 () us_rep1 (mk___rep1 (mk___split_fields1 o14 o15 o16)))
(define-fun o20 () us_rep1 (mk___rep1 (mk___split_fields1 o8 o9 o10)))
...
(assert (= o7 train1))
(assert (= o20 (select trains1 o7)))
(assert (and (= o11 (get_previous_track o20 id1)) (and (in_range1 o11) (= o11 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o10)))))) id1))))))
(assert (= o12 (ite (= o11 0) true false)))
(assert (= result9 (ite (not (= o12 true)) true false)))
(assert (=> (= result9 true) (and (<= 1 train1) (<= train1 10))))
(assert (=> (= result9 true) (= o13 train1)))
(assert (=> (= result9 true) (= o19 (select trains1 o13))))
(assert (=> (= result9 true) (and (= temp___375 (get_previous_track o19 id1)) (and (in_range1 temp___375) (= temp___375 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep o16)))))) id1)))))))
(assert (=> (= result9 true) (and (<= 1 temp___375) (<= temp___375 8))))
(assert (=> (= result9 true) (= o17 temp___375)))
(assert (=> (= result9 true) (= o18 (select (map__content4 track_signals6) o17))))
(assert (=> (= result9 true) (= temp___376 (to_rep5 o18))))
(assert (=> (= result9 true) (= result8 (ite (or (= temp___376 1) (= temp___376 2)) true false))))
(assert (=> (not (= result9 true)) (= result8 (of_int 1))))
(assert (= result8 true))
(assert (not (<= 1 train1)))
(check-sat)
(exit)
