...
(declare-const temp___7874 (Array Int et1))
(declare-const temp___78741 enum2t)
...
(assert (= temp___7874 o2))
(assert (= temp___78741 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___7874 r__split_fields2))
(assert (= temp___78741 r__split_fields3))
