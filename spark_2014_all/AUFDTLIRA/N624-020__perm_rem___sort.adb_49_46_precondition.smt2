...
(define-fun o35 () us_t (mk___t o17 o18))
...
(assert (and (= o35 (remove (mk___t values2 (mk 1 100)) o16)) (and (dynamic_invariant4 o35 true false true) (and (= (invariant__ o35) true) (and (= (to_rep1 (last o18)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o16 1))) (= (to_rep (select values2 k)) (to_rep (select o17 k))))) (and (forall ((k Int)) (=> (and (<= (+ o16 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o17 (- k 1)))))) (forall ((k Int)) (=> (and (<= o16 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o17 k))))))))))))
(assert (and (= o13 y) (in_range5 y)))
(assert (and (= o36 (remove (mk___t interm1 (mk 1 100)) o13)) (and (dynamic_invariant4 o36 true false true) (and (= (invariant__ o36) true) (and (= (to_rep1 (last o15)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select interm1 k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select o14 k))))))))))))
(assert (and (= o20 (remove_eq o36 o35 o19)) (and (in_range4 o20) (=> (= (of_int o20) true) (= (let ((temp___163 (remove o35 o19))) (let ((temp___162 (remove o36 o19))) (bool_eq (elts temp___162) (to_rep1 (first (rt temp___162))) (to_rep1 (last (rt temp___162))) (elts temp___163) (to_rep1 (first (rt temp___163))) (to_rep1 (last (rt temp___163)))))) true)))))
...
(assert (= (let ((temp___252 (remove (remove (mk___t values2 (mk 1 100)) y) (- x 1)))) (let ((temp___251 (remove (remove (mk___t interm1 (mk 1 100)) x) y))) (bool_eq (elts temp___251) (to_rep1 (first (rt temp___251))) (to_rep1 (last (rt temp___251))) (elts temp___252) (to_rep1 (first (rt temp___252))) (to_rep1 (last (rt temp___252)))))) true))
(assert (and (= o25 x) (in_range5 x)))
(assert (and (= o24 y) (in_range5 y)))
(assert (and (= o26 (remove_swap (mk___t values2 (mk 1 100)) o24 o25)) (and (in_range4 o26) (=> (= (of_int o26) true) (= (let ((temp___157 (remove (remove (mk___t values2 (mk 1 100)) o25) o24))) (let ((temp___156 (remove (remove (mk___t values2 (mk 1 100)) o24) (- o25 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))))
(assert (= result6 (mk_int__ref hr3)))
(assert (= hr4 o26))
(assert (= (let ((temp___256 (remove (remove (mk___t values2 (mk 1 100)) x) y))) (let ((temp___255 (remove (remove (mk___t interm1 (mk 1 100)) x) y))) (bool_eq (elts temp___255) (to_rep1 (first (rt temp___255))) (to_rep1 (last (rt temp___255))) (elts temp___256) (to_rep1 (first (rt temp___256))) (to_rep1 (last (rt temp___256)))))) true))
(assert (and (= o31 y) (in_range5 y)))
(assert (and (= o29 x) (in_range5 x)))
(assert (and (= o30 (remove (mk___t interm1 (mk 1 100)) o29)) (and (dynamic_invariant4 o30 true false true) (and (= (invariant__ o30) true) (and (= (to_rep1 (last (rt o30))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o29 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o30) k))))) (and (forall ((k Int)) (=> (and (<= (+ o29 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o30) (- k 1)))))) (forall ((k Int)) (=> (and (<= o29 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o30) k))))))))))))
(assert (and (= o27 x) (in_range5 x)))
(assert (and (= o28 (remove (mk___t init (mk 1 100)) o27)) (and (dynamic_invariant4 o28 true false true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last (rt o28))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select init k)) (to_rep (select (elts o28) k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o28) (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o28) k))))))))))))
(assert (and (= o32 (remove_eq o28 o30 o31)) (and (in_range4 o32) (=> (= (of_int o32) true) (= (let ((temp___163 (remove o30 o31))) (let ((temp___162 (remove o28 o31))) (bool_eq (elts temp___162) (to_rep1 (first (rt temp___162))) (to_rep1 (last (rt temp___162))) (elts temp___163) (to_rep1 (first (rt temp___163))) (to_rep1 (last (rt temp___163)))))) true)))))
