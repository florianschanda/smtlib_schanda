...
(assert (and (= o45 x) (in_range5 x)))
(assert (and (= o44 y) (in_range5 y)))
(assert (and (= o46 (remove_swap (mk___t values2 (mk 1 100)) o44 o45)) (and (in_range4 o46) (=> (= (of_int o46) true) (= (let ((temp___157 (remove (remove (mk___t values2 (mk 1 100)) o45) o44))) (let ((temp___156 (remove (remove (mk___t values2 (mk 1 100)) o44) (- o45 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))))
(assert (= result6 (mk_int__ref hr6)))
(assert (= hr7 o46))
...
(assert (and (= o58 y) (in_range5 y)))
(assert (and (= o56 x) (in_range5 x)))
(assert (and (= o57 (remove (mk___t interm1 (mk 1 100)) o56)) (and (dynamic_invariant4 o57 true false true) (and (= (invariant__ o57) true) (and (= (to_rep1 (last (rt o57))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o56 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o57) k))))) (and (forall ((k Int)) (=> (and (<= (+ o56 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o57) (- k 1)))))) (forall ((k Int)) (=> (and (<= o56 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o57) k))))))))))))
(assert (and (= o54 x) (in_range5 x)))
(assert (and (= o55 (remove (mk___t init (mk 1 100)) o54)) (and (dynamic_invariant4 o55 true false true) (and (= (invariant__ o55) true) (and (= (to_rep1 (last (rt o55))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o54 1))) (= (to_rep (select init k)) (to_rep (select (elts o55) k))))) (and (forall ((k Int)) (=> (and (<= (+ o54 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o55) (- k 1)))))) (forall ((k Int)) (=> (and (<= o54 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o55) k))))))))))))
(assert (and (= o59 (remove_eq o55 o57 o58)) (and (in_range4 o59) (=> (= (of_int o59) true) (= (let ((temp___163 (remove o57 o58))) (let ((temp___162 (remove o55 o58))) (bool_eq (elts temp___162) (to_rep1 (first (rt temp___162))) (to_rep1 (last (rt temp___162))) (elts temp___163) (to_rep1 (first (rt temp___163))) (to_rep1 (last (rt temp___163)))))) true)))))
(assert (= result7 (mk_int__ref hr7)))
(assert (= hr8 o59))
(assert (and (= o62 y) (in_range5 y)))
(assert (and (= o60 x) (in_range5 x)))
