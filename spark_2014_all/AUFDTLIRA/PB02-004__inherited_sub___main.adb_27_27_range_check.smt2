...
(declare-datatypes () ((us_split_discrs (mk___split_discrs (rec__rec__sub_arr__f natural) (rec__rec__sub_arr__l natural)))))
(define-fun us_split_discrs___4__projection ((a us_split_discrs)) natural (rec__rec__sub_arr__f a))
(define-fun us_split_discrs___5__projection ((a us_split_discrs)) natural (rec__rec__sub_arr__l a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__rec__sub_arr__content us_t)))))
(define-fun us_split_fields_Content__projection ((a us_split_fields)) us_t (rec__rec__sub_arr__content a))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__rec__sub_arr__f (us_split_discrs1 a))) (to_rep (rec__rec__sub_arr__f (us_split_discrs1 b)))) (= (to_rep (rec__rec__sub_arr__l (us_split_discrs1 a))) (to_rep (rec__rec__sub_arr__l (us_split_discrs1 b))))) (= (bool_eq1 (rec__rec__sub_arr__content (us_split_fields1 a)) (rec__rec__sub_arr__content (us_split_fields1 b))) true)) true false))
...
(declare-datatypes () ((sub_arr__ref (mk_sub_arr__ref (sub_arr__content us_rep)))))
(define-fun sub_arr__ref___projection ((a sub_arr__ref)) us_rep (sub_arr__content a))
(declare-const f Int)
...
(define-fun tT8bP1__ref___projection ((a tT8bP1__ref)) integer (tT8bP1__content a))
(declare-sort t1 0)
(declare-fun first2 (t1) integer)
(declare-fun last2 (t1) integer)
(declare-fun mk1 (Int Int) t1)
(assert (forall ((f1 Int) (l1 Int)) (! (=> (in_range2 f1) (=> (in_range2 l1) (and (= (to_rep1 (first2 (mk1 f1 l1))) f1) (= (to_rep1 (last2 (mk1 f1 l1))) l1)))) :pattern ((mk1 f1 l1)))))
...
(define-fun of_array1 ((a (Array Int natural)) (f1 Int) (l1 Int)) us_t1 (mk___t1 a (mk1 f1 l1)))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__rec__sub_arr__content1 us_t1)))))
(define-fun us_split_fields_Content__3__projection ((a us_split_fields2)) us_t1 (rec__rec__sub_arr__content1 a))
...
(define-fun us_rep___15__projection ((a us_rep1)) us_split_discrs (us_split_discrs2 a))
(define-fun us_rep___16__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___156 (rec__rec__sub_arr__content1 (us_split_fields3 a)))) (of_array (to_array1 temp___156) (first3 temp___156) (last3 temp___156))))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___155 (rec__rec__sub_arr__content (us_split_fields1 r)))) (of_array1 (to_array temp___155) (first1 temp___155) (last1 temp___155))))))
(define-fun bool_eq4 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep (rec__rec__sub_arr__f (us_split_discrs2 a))) (to_rep (rec__rec__sub_arr__f (us_split_discrs2 b)))) (= (to_rep (rec__rec__sub_arr__l (us_split_discrs2 a))) (to_rep (rec__rec__sub_arr__l (us_split_discrs2 b))))) (= (bool_eq3 (rec__rec__sub_arr__content1 (us_split_fields3 a)) (rec__rec__sub_arr__content1 (us_split_fields3 b))) true)) true false))
(define-fun in_range3 ((rec__rec__sub_arr__f1 Int) (rec__rec__sub_arr__l1 Int) (a us_rep)) Bool (and (= rec__rec__sub_arr__f1 (to_rep (rec__rec__sub_arr__f (us_split_discrs1 a)))) (= rec__rec__sub_arr__l1 (to_rep (rec__rec__sub_arr__l (us_split_discrs1 a))))))
...
(assert (< rec__sub_arr__content__first__bit1 rec__sub_arr__content__last__bit1))
(assert (<= 0 rec__sub_arr__content__position1))
(declare-fun user_eq7 (us_rep1 us_rep1) Bool)
(declare-const dummy7 us_rep1)
(declare-datatypes () ((tzS__ref (mk_tzS__ref (tzS__content us_rep1)))))
(define-fun tzS__ref___3__projection ((a tzS__ref)) us_rep1 (tzS__content a))
(define-fun dynamic_invariant1 ((temp___expr_301 us_rep1) (temp___is_init_297 Bool) (temp___skip_constant_298 Bool) (temp___do_toplevel_299 Bool) (temp___do_typ_inv_300 Bool)) Bool (and (=> (not (= temp___skip_constant_298 true)) (in_range3 f l (to_base temp___expr_301))) (and (dynamic_property3 f l (first3 (rec__rec__sub_arr__content1 (us_split_fields3 temp___expr_301))) (last3 (rec__rec__sub_arr__content1 (us_split_fields3 temp___expr_301)))) (and (= (first3 (rec__rec__sub_arr__content1 (us_split_fields3 temp___expr_301))) f) (= (last3 (rec__rec__sub_arr__content1 (us_split_fields3 temp___expr_301))) l)))))
(define-fun default_initial_assumption ((temp___expr_305 us_rep1) (temp___skip_top_level_306 Bool)) Bool (and (= (to_rep (rec__rec__sub_arr__f (us_split_discrs2 temp___expr_305))) f) (= (to_rep (rec__rec__sub_arr__l (us_split_discrs2 temp___expr_305))) l)))
...
(define-fun dynamic_invariant3 ((temp___expr_201 us_rep) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (let ((temp___203 (rec__rec__sub_arr__l (us_split_discrs1 temp___expr_201)))) (let ((temp___202 (rec__rec__sub_arr__f (us_split_discrs1 temp___expr_201)))) (and (dynamic_property1 (to_rep temp___202) (to_rep temp___203) (first1 (rec__rec__sub_arr__content (us_split_fields1 temp___expr_201))) (last1 (rec__rec__sub_arr__content (us_split_fields1 temp___expr_201)))) (and (= (first1 (rec__rec__sub_arr__content (us_split_fields1 temp___expr_201))) (to_rep temp___202)) (= (last1 (rec__rec__sub_arr__content (us_split_fields1 temp___expr_201))) (to_rep temp___203)))))))
(assert (in_range1 f))
(assert (in_range1 l))
(assert (not (in_range1 l)))
(check-sat)
(exit)
