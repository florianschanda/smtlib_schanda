...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___134 (rec__rec__sub_arr__content1 (us_split_fields3 a)))) (of_array (to_array1 temp___134) (first3 temp___134) (last3 temp___134))))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___133 (rec__rec__sub_arr__content (us_split_fields1 r)))) (of_array1 (to_array temp___133) (first1 temp___133) (last1 temp___133))))))
...
(define-fun dynamic_invariant1 ((temp___expr_262 us_rep1) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool)) Bool (and (=> (not (= temp___skip_constant_260 true)) (in_range3 f l (to_base temp___expr_262))) (and (dynamic_property3 f l (first3 (rec__rec__sub_arr__content1 (us_split_fields3 temp___expr_262))) (last3 (rec__rec__sub_arr__content1 (us_split_fields3 temp___expr_262)))) (and (= (first3 (rec__rec__sub_arr__content1 (us_split_fields3 temp___expr_262))) f) (= (last3 (rec__rec__sub_arr__content1 (us_split_fields3 temp___expr_262))) l)))))
(define-fun default_initial_assumption ((temp___expr_266 us_rep1) (temp___skip_top_level_267 Bool)) Bool (and (= (to_rep (rec__rec__sub_arr__f (us_split_discrs2 temp___expr_266))) f) (= (to_rep (rec__rec__sub_arr__l (us_split_discrs2 temp___expr_266))) l)))
...
(define-fun dynamic_invariant3 ((temp___expr_172 us_rep) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (let ((temp___174 (rec__rec__sub_arr__l (us_split_discrs1 temp___expr_172)))) (let ((temp___173 (rec__rec__sub_arr__f (us_split_discrs1 temp___expr_172)))) (and (dynamic_property1 (to_rep temp___173) (to_rep temp___174) (first1 (rec__rec__sub_arr__content (us_split_fields1 temp___expr_172))) (last1 (rec__rec__sub_arr__content (us_split_fields1 temp___expr_172)))) (and (= (first1 (rec__rec__sub_arr__content (us_split_fields1 temp___expr_172))) (to_rep temp___173)) (= (last1 (rec__rec__sub_arr__content (us_split_fields1 temp___expr_172))) (to_rep temp___174)))))))
(assert (in_range1 f))
(assert (in_range1 l))
