...
(define-fun dynamic_invariant2 ((temp___expr_206 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 5)) (in_range3 temp___expr_206)))
...
(declare-const temp___7908 (Array Int et1))
(declare-const temp___79081 enum2t)
(declare-const o4 enum2t)
(declare-const o5 (Array Int et1))
(declare-const o6 enum2t)
(declare-const temp___7910 (Array Int et1))
(declare-const temp___79101 enum2t)
...
(assert (= temp___7908 o2))
(assert (= temp___79081 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___7908 r__split_fields2))
(assert (= temp___79081 r__split_fields3))
(assert (= (to_rep1 o4) f))
(assert (= r__split_fields2 o5))
(assert (= o4 o6))
(assert (= temp___7910 o5))
(assert (= temp___79101 o6))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___7910 r__split_fields4))
(assert (= temp___79101 r__split_fields5))
...
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (in_range2 (to_rep (select r__split_fields6 n)))))
(check-sat)
(exit)
