...
(assert (=> (<= (to_rep1 s__first) (to_rep1 s__last)) (= o23 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1))))
(assert (=> (not (<= (to_rep1 s__first) (to_rep1 s__last))) (= o23 0)))
(assert (and (= o24 o23) (in_range1 o23)))
(assert (=> (<= (to_rep1 v__first) (to_rep1 v__last)) (= o22 (+ (- (to_rep1 v__last) (to_rep1 v__first)) 1))))
(assert (=> (not (<= (to_rep1 v__first) (to_rep1 v__last))) (= o22 0)))
