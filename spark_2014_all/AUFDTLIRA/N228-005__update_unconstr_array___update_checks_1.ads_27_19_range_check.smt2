...
(assert (= (to_rep (first8 (rt4 (temp___502 new_val 2 i)))) 2))
(assert (= (to_rep (last8 (rt4 (temp___502 new_val 2 i)))) i))
(assert (= (mk___t4 temp___509 temp___5091) (temp___502 new_val 2 i)))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (= (to_rep (first4 (rt2 (temp___308 new_val 1 i)))) 1))
(assert (= (to_rep (last4 (rt2 (temp___308 new_val 1 i)))) i))
(assert (= (mk___t2 temp___519 temp___5191) (temp___308 new_val 1 i)))
(assert (<= 1 i))
