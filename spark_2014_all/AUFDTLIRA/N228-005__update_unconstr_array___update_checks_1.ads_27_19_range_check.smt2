...
(assert (forall ((temp___276 Int) (temp___277 Int) (temp___278 Int)) (let ((temp___275 (temp___274 temp___276 temp___277 temp___278))) (and (=> (dynamic_property 1 8 temp___277 temp___278) (and (= (first5 temp___275) temp___277) (= (last5 temp___275) temp___278))) (forall ((temp___279 Int)) (= (select (to_array2 temp___275) temp___279) (of_rep1 temp___276)))))))
(declare-fun temp___460 (Int Int Int) us_t4)
(assert (forall ((temp___462 Int) (temp___463 Int) (temp___464 Int)) (let ((temp___461 (temp___460 temp___462 temp___463 temp___464))) (and (=> (dynamic_property 1 8 temp___463 temp___464) (and (= (first9 temp___461) temp___463) (= (last9 temp___461) temp___464))) (forall ((temp___465 Int)) (= (select (to_array4 temp___461) temp___465) (of_rep1 temp___462)))))))
...
(assert (= (ite (<= (to_rep (first8 temp___4671)) (to_rep (last8 temp___4671))) (+ (- (to_rep (last8 temp___4671)) (to_rep (first8 temp___4671))) 1) 0) (ite (<= 2 i) (+ (- i 2) 1) 0)))
(assert (= temp___467 temp___468))
(assert (= (mk3 (to_rep (first8 temp___4671)) (to_rep (last8 temp___4671))) temp___4681))
(assert (=> (<= 2 i) (and (and (<= (to_rep a__first) 2) (<= 2 (to_rep a__last))) (and (<= (to_rep a__first) i) (<= i (to_rep a__last))))))
(assert (= o a))
(assert (= o temp___470))
(assert (= (mk3 2 i) temp___4701))
(assert (= (ite (<= (to_rep (first6 temp___4681)) (to_rep (last6 temp___4681))) (+ (- (to_rep (last6 temp___4681)) (to_rep (first6 temp___4681))) 1) 0) (ite (<= (to_rep (first6 temp___4701)) (to_rep (last6 temp___4701))) (+ (- (to_rep (last6 temp___4701)) (to_rep (first6 temp___4701))) 1) 0)))
(assert (= (mk___t3 temp___471 temp___4711) (mk___t3 temp___468 temp___4681)))
(assert (forall ((temp___472 Int)) (ite (and (<= 2 temp___472) (<= temp___472 i)) (= (select o1 temp___472) (select temp___471 temp___472)) (= (select o1 temp___472) (select a temp___472)))))
