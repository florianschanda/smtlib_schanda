...
(assert (= (ite (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (+ (- (to_rep1 (last (rt a))) (to_rep1 (first (rt a)))) 1) 0) (ite (<= 1 (length a)) (+ (- (length a) 1) 1) 0)))
(assert (= (slide1 (elts a) (to_rep1 (first (rt a))) 1) temp___313))
(assert (= (mk2 1 (length a)) temp___3131))
(assert (not (= (ite (<= (to_rep1 (first4 temp___3131)) (to_rep1 (last4 temp___3131))) (+ (- (to_rep1 (last4 temp___3131)) (to_rep1 (first4 temp___3131))) 1) 0) (ite (<= (to_rep1 (first4 coms__split_fields1)) (to_rep1 (last4 coms__split_fields1))) (+ (- (to_rep1 (last4 coms__split_fields1)) (to_rep1 (first4 coms__split_fields1))) 1) 0))))
(check-sat)
(exit)
