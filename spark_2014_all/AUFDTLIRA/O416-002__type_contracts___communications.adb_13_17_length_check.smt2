...
(assert (= (ite (<= (to_rep1 (first2 (rt1 a))) (to_rep1 (last2 (rt1 a)))) (+ (- (to_rep1 (last2 (rt1 a))) (to_rep1 (first2 (rt1 a)))) 1) 0) (ite (<= 1 (length1 a)) (+ (- (length1 a) 1) 1) 0)))
(assert (= (slide1 (elts1 a) (to_rep1 (first2 (rt1 a))) 1) temp___342))
(assert (= (mk2 1 (length1 a)) temp___3421))
(assert (not (= (ite (<= (to_rep1 (first4 temp___3421)) (to_rep1 (last4 temp___3421))) (+ (- (to_rep1 (last4 temp___3421)) (to_rep1 (first4 temp___3421))) 1) 0) (ite (<= (to_rep1 (first4 coms__split_fields1)) (to_rep1 (last4 coms__split_fields1))) (+ (- (to_rep1 (last4 coms__split_fields1)) (to_rep1 (first4 coms__split_fields1))) 1) 0))))
(check-sat)
(exit)
