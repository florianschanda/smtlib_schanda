...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o6 i))
(assert (= temp___391 (select (rec__patience__state__stacks (us_split_fields1 s)) o6)))
(assert (and (<= 0 j) (<= j 99)))
(assert (= o7 j))
...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o5 i))
(assert (= temp___389 (select (rec__patience__state__stacks (us_split_fields1 s)) o5)))
(assert (not (<= 0 j)))
(check-sat)
(exit)
