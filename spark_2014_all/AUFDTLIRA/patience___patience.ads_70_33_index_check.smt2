...
(assert (= o122 j2))
(assert (= o123 (select temp___391 o122)))
(assert (= o124 (to_rep1 o123)))
(assert (= o125 (ite (< o124 (to_rep1 (rec__patience__state__numelts (us_split_fields1 s)))) true false)))
(assert (and (<= 0 i4) (<= i4 99)))
(assert (= o120 i4))
(assert (= temp___389 (select (rec__patience__state__stacks (us_split_fields1 s)) o120)))
(assert (not (<= 0 j2)))
(check-sat)
(exit)
