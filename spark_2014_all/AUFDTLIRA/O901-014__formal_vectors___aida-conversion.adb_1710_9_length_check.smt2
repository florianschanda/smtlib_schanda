...
(assert (not (= (ite (<= (to_rep1 (first4 temp___21661)) (to_rep1 (last4 temp___21661))) (+ (- (to_rep1 (last4 temp___21661)) (to_rep1 (first4 temp___21661))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 3)) 1) 0))))
(check-sat)
(exit)
