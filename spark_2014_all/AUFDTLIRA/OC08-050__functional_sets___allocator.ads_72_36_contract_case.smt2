...
(assert (not (= (is_add (rec__allocator__m__t__allocated (us_split_fields1 (model__ data3))) res (rec__allocator__m__t__allocated (us_split_fields1 (model__ data)))) true)))
(check-sat)
(exit)
