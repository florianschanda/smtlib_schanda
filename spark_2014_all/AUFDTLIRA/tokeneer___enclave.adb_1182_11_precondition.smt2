...
(assert (and (= o26 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o26)))
(assert (= result (ite (= o26 1) true false)))
(assert (=> (= result true) (= o30 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result true) (= o31 (ite (not (= o30 true)) true false))))
(assert (=> (= result true) (and (= o27 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range6 o27))))
(assert (=> (= result true) (= o28 (ite (= o27 3) true false))))
(assert (=> (= result true) (= o29 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
...
(assert (and (= o19 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o19)))
(assert (= result1 (ite (= o19 1) true false)))
(assert (=> (= result1 true) (and (= o22 (theauthcertrole state)) (in_range4 o22))))
