...
(assert (and (= o126 (remove a o125)) (and (dynamic_invariant2 o126 true false true) (and (= (invariant__ o126) true) (and (= (to_rep2 (last (rt o126))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o125 1))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o126) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o125 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o126) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o125 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select (elts o126) k1))))))))))))
(assert (not (= (invariant__ o126) true)))
(check-sat)
(exit)
