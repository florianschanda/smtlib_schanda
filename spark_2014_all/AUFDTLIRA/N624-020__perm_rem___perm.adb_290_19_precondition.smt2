...
(assert (and (= o4 (remove b o3)) (and (dynamic_invariant o4 true false true true) (and (= (invariant__ o4) true) (and (= (to_rep1 (last (rt o4))) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o3 1))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o4) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o3 1) k1) (<= k1 (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k1)) (to_rep (select (elts o4) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o3 k1) (<= k1 (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k1 1))) (to_rep (select (elts o4) k1))))))))))))
(assert (and (= o1 k) (in_range3 k)))
(assert (and (= o2 (remove a o1)) (and (dynamic_invariant o2 true false true true) (and (= (invariant__ o2) true) (and (= (to_rep1 (last (rt o2))) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o1 1))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o2) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o1 1) k1) (<= k1 (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o2) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o1 k1) (<= k1 (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select (elts o2) k1))))))))))))
