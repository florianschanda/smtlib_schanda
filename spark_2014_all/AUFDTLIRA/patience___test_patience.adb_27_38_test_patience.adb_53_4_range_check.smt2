...
(assert (=> (and (<= 0 i8) (<= i8 (- (to_rep3 (rec__patience__state__numelts (us_split_fields1 c60b))) 1))) (= o40 (concat1 (temp___String_Literal_797 Tuple0) 1 1 (elts (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__values (us_split_fields1 c60b)) i9))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__values (us_split_fields1 c60b)) i9))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (select (rec__patience__state__values (us_split_fields1 c60b)) i9)))))))))))
