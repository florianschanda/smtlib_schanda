...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq1 a2 5 50 (temp___819 a i2 (temp___825 (select a i2) i1 e)) 5 50) true)))
(check-sat)
(exit)
