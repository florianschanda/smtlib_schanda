...
(assert (forall ((x nat_type)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_631 Int) (temp___is_init_627 Bool) (temp___skip_constant_628 Bool) (temp___do_toplevel_629 Bool) (temp___do_typ_inv_630 Bool)) Bool (=> (or (= temp___is_init_627 true) (<= 0 3)) (in_range3 temp___expr_631)))
(assert true)
...
(define-fun dynamic_invariant3 ((temp___expr_581 Int) (temp___is_init_577 Bool) (temp___skip_constant_578 Bool) (temp___do_toplevel_579 Bool) (temp___do_typ_inv_580 Bool)) Bool (=> (or (= temp___is_init_577 true) (<= 0 1000)) (in_range1 temp___expr_581)))
...
(assert (and (= result1 (is_base cur_state1)) (= (= result1 true) (= cur_state1 3))))
(assert (not (= (is_base cur_state1) true)))
(check-sat)
(exit)
