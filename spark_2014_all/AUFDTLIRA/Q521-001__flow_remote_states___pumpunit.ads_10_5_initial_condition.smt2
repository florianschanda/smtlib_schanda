...
(define-fun dynamic_invariant1 ((temp___expr_557 Int) (temp___is_init_554 Bool) (temp___skip_constant_555 Bool) (temp___do_toplevel_556 Bool)) Bool (=> (or (= temp___is_init_554 true) (<= 0 3)) (in_range3 temp___expr_557)))
(assert true)
...
(define-fun dynamic_invariant3 ((temp___expr_510 Int) (temp___is_init_507 Bool) (temp___skip_constant_508 Bool) (temp___do_toplevel_509 Bool)) Bool (=> (or (= temp___is_init_507 true) (<= 0 1000)) (in_range1 temp___expr_510)))
