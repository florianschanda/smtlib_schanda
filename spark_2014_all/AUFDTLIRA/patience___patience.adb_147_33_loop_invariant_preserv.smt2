...
(assert (= (to_rep2 s__split_fields16) (- i2 (to_rep1 (first (rt cards))))))
(assert (= (inv (mk___rep (mk___split_fields s__split_fields16 s__split_fields17 s__split_fields18 s__split_fields19 s__split_fields20 s__split_fields21 s__split_fields22 s__split_fields23))) true))
(assert (and (=> (<= (to_rep1 (first (rt cards))) (to_rep1 (last (rt cards)))) (dynamic_property1 (to_rep1 (first (rt cards))) (to_rep1 (last (rt cards))) i2)) (and (<= (to_rep1 (first (rt cards))) i2) (<= i2 (to_rep1 (last (rt cards)))))))
(assert (and (and (= (inv (mk___rep (mk___split_fields s__split_fields24 s__split_fields25 s__split_fields26 s__split_fields27 s__split_fields28 s__split_fields29 s__split_fields30 s__split_fields31))) true) (= (to_rep (select s__split_fields25 (to_rep2 s__split_fields16))) (to_rep (select (elts cards) i2)))) (= (to_rep2 s__split_fields24) (+ (to_rep2 s__split_fields16) 1))))
(assert (not (= i2 (to_rep1 (last (rt cards))))))
(assert (= result9 i2))
(assert (= i3 (+ i2 1)))
(assert (not (= (inv (mk___rep (mk___split_fields s__split_fields24 s__split_fields25 s__split_fields26 s__split_fields27 s__split_fields28 s__split_fields29 s__split_fields30 s__split_fields31))) true)))
(check-sat)
(exit)
