...
(define-fun s__split_fields32 () us_split_fields (mk___split_fields s__split_fields24 s__split_fields25 s__split_fields26 s__split_fields27 s__split_fields28 s__split_fields29 s__split_fields30 s__split_fields31))
(assert (= (to_rep2 o) 0))
(assert (= (to_rep2 o1) 0))
(assert (= o1 o2))
...
(assert (and (and (= (inv (mk___rep s__split_fields32)) true) (= (to_rep (select s__split_fields25 (to_rep2 s__split_fields16))) (to_rep (select (elts cards) i2)))) (= (to_rep2 s__split_fields24) (+ (to_rep2 s__split_fields16) 1))))
(assert (not (= i2 (to_rep1 (last (rt cards))))))
(assert (= result9 i2))
(assert (= i3 (+ i2 1)))
(assert (not (= (inv (mk___rep s__split_fields32)) true)))
(check-sat)
(exit)
