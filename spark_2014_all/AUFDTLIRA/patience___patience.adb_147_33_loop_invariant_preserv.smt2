...
(declare-const s__split_fields25 (Array Int card1))
...
(assert (and (and (= (inv (mk___rep s__split_fields32)) true) (= (to_rep1 (select s__split_fields25 (to_rep s__split_fields16))) (to_rep1 (select (elts cards) i2)))) (= (to_rep s__split_fields24) (+ (to_rep s__split_fields16) 1))))
(assert (not (= i2 (to_rep2 (last (rt cards))))))
(assert (= result9 i2))
(assert (= i3 (+ i2 1)))
