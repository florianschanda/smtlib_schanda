...
(assert (=> (<= x1 1) (= o2 (bool_eq temp___196 (to_rep1 (first temp___1961)) (to_rep1 (last temp___1961)) new_sub 1 5))))
(assert (=> (<= x1 1) (= result1 (ite (not (= o2 true)) true false))))
(assert (=> (not (<= x1 1)) (= result1 false)))
(assert (= result1 true))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 x2)) (let ((foo__test_08__L_3__R84b2 (- (+ y 5) 1))) (and (<= x2 1) (not (= (bool_eq new_str (to_rep1 (first (mk x2 foo__test_08__L_3__R84b2))) (to_rep1 (last (mk x2 foo__test_08__L_3__R84b2))) new_sub 1 5) true))))))
