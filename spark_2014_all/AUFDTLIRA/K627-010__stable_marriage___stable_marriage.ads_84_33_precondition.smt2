...
(assert (and (= o (invert_2 r2)) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep (select o (to_rep1 (select r2 rank)))) rank))) (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (= (to_rep1 (select r2 (to_rep (select o g2)))) g2))))))
...
(assert (= stable_marriage__is_preferred_2__result1 (ite (<= (to_rep (select inverted1 g2_a)) (to_rep (select inverted1 g2_b))) true false)))
