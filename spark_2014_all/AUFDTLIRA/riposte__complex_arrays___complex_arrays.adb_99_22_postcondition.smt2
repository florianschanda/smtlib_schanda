...
(define-fun dynamic_invariant ((temp___expr_143 Int) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (=> (or (= temp___is_init_140 true) (<= 0 1001)) (in_range temp___expr_143)))
...
(declare-fun concat2 ((Array Int (Array Int value)) Int Int (Array Int (Array Int value)) Int Int) (Array Int (Array Int value)))
...
(declare-fun singleton2 ((Array Int value) Int) (Array Int (Array Int value)))
(assert (forall ((v (Array Int value))) (forall ((i Int)) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
(define-fun bool_eq1 ((a (Array Int (Array Int value))) (a__first Int) (a__last Int) (b (Array Int (Array Int value))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (bool_eq (select a temp___idx_133) 0 1001 (select b (+ (- b__first a__first) temp___idx_133)) 0 1001) true)))) true false))
(assert (forall ((a (Array Int (Array Int value))) (b (Array Int (Array Int value)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (bool_eq (select a temp___idx_133) 0 1001 (select b (+ (- b__first a__first) temp___idx_133)) 0 1001) true))))))))
