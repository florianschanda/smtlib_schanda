...
(assert (< low1 high1))
(assert (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (- low2 1))) (= (to_rep2 (select a__split_fields2 j)) (to_rep2 (select a__split_fields (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1)))))) (forall ((j Int)) (=> (and (<= (- low2 1) j) (<= j (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)))) (= (to_rep2 (select a__split_fields2 j)) (to_rep2 (select a__split_fields j)))))))
...
(assert (= (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) r22b))
(assert (in_range2 r22b))
(assert (= (ite (<= (to_rep1 (first2 a__split_fields3)) (to_rep1 (last2 a__split_fields3))) (+ (- (to_rep1 (last2 a__split_fields3)) (to_rep1 (first2 a__split_fields3))) 1) 0) (ite (<= 1 r22b) (+ (- r22b 1) 1) 0)))
...
(assert (and (= o2 high2) (in_range3 high2)))
(assert (= (to_rep1 o1) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1))))
(assert (= (to_rep1 o) (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1))))
...
(assert (= a__split_fields4 (mk___split_fields (mk___t1 (slide simple_unc_arrays__swap_cells__a (to_rep1 (first (mk (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1)) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1))))) 1) (mk1 (to_rep1 (first4 (mk2 1 r22b))) (to_rep1 (last4 (mk2 1 r22b))))))))
(assert (and (= o3 (+ low2 1)) (in_range1 (+ low2 1))))
(assert (= result4 (mk_int__ref low2)))
(assert (= low3 o3))
(assert (and (= o4 (- high2 1)) (in_range2 (- high2 1))))
(assert (= result5 (mk_int__ref high2)))
(assert (= high3 o4))
(assert (< low3 high3))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j (- low3 1)))
(assert (not (= (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v a__split_fields4)) j)) (to_rep2 (select a__split_fields (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j) 1))))))
(check-sat)
(exit)
