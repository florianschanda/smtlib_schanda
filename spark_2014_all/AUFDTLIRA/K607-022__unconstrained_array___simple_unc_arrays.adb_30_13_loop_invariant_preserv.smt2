...
(assert (= (ite (<= (to_rep1 (first2 a__split_fields5)) (to_rep1 (last2 a__split_fields5))) (+ (- (to_rep1 (last2 a__split_fields5)) (to_rep1 (first2 a__split_fields5))) 1) 0) (ite (<= 1 r22b) (+ (- r22b 1) 1) 0)))
(assert (= a__split_fields4 simple_unc_arrays__swap_cells__a__compl))
(assert (= (mk2 (to_rep1 (first2 a__split_fields5)) (to_rep1 (last2 a__split_fields5))) simple_unc_arrays__swap_cells__a__compl1))
(assert (and (= o9 high2) (in_range3 high2)))
(assert (= (to_rep1 o8) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1))))
(assert (= (to_rep1 o7) (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1))))
...
(assert (= result2 a__split_fields4))
(assert (= result3 a__split_fields5))
(assert (= a__split_fields6 (mk___split_fields (mk___t1 (slide simple_unc_arrays__swap_cells__a (to_rep1 (first (mk (to_rep1 (first4 simple_unc_arrays__swap_cells__a__compl1)) (to_rep1 (last4 simple_unc_arrays__swap_cells__a__compl1))))) 1) (mk1 (to_rep1 (first4 (mk2 1 r22b))) (to_rep1 (last4 (mk2 1 r22b))))))))
(assert (and (= o10 (+ low2 1)) (in_range1 (+ low2 1))))
(assert (= result4 (mk_int__ref low2)))
(assert (= low3 o10))
(assert (and (= o11 (- high2 1)) (in_range2 (- high2 1))))
...
(assert (<= 1 j3))
(assert (<= j3 (- low3 1)))
(assert (not (= (to_rep2 (select (elts1 (rec__simple_unc_arrays__table__v a__split_fields6)) j3)) (to_rep2 (select a__split_fields (+ (- (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) j3) 1))))))
(check-sat)
(exit)
