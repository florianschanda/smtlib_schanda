...
(define-fun dynamic_invariant1 ((temp___expr_224 (Array Int integer)) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool)) Bool (=> (= temp___do_toplevel_223 true) (=> (= temp___is_init_221 true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep1 (select temp___expr_224 k)) 0)))))))
(define-fun default_initial_assumption ((temp___expr_227 (Array Int integer)) (temp___skip_top_level_228 Bool)) Bool (forall ((temp___229 Int)) (=> (and (<= 1 temp___229) (<= temp___229 10)) (= (to_rep1 (select temp___expr_227 temp___229)) 0))))
(define-fun dynamic_predicate1 ((temp___230 (Array Int integer))) Bool (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep1 (select temp___230 k)) 0)))))
...
(define-fun dynamic_invariant2 ((temp___expr_259 us_rep) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool)) Bool (and (=> (= temp___do_toplevel_258 true) (=> (= temp___is_init_256 true) (and (and (not (= (to_rep1 (rec__preds__rec_bad__i (us_split_fields1 temp___expr_259))) 0)) (not (= (to_rep (rec__preds__rec_bad__x (us_split_fields1 temp___expr_259))) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep1 (let ((temp___261 (rec__preds__rec_bad__a (us_split_fields1 temp___expr_259)))) (select temp___261 k))) 0))))))) (and (=> (= temp___is_init_256 true) (let ((temp___263 (to_rep (rec__preds__rec_bad__x (us_split_fields1 temp___expr_259))))) (or (and (<= (- 2147483648) temp___263) (<= temp___263 (- 1))) (and (<= 1 temp___263) (<= temp___263 2147483647))))) (=> (= temp___is_init_256 true) (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep1 (select (rec__preds__rec_bad__a (us_split_fields1 temp___expr_259)) k)) 0))))))))
(define-fun default_initial_assumption1 ((temp___expr_266 us_rep) (temp___skip_top_level_267 Bool)) Bool (and (and (= (to_rep1 (rec__preds__rec_bad__i (us_split_fields1 temp___expr_266))) 0) (= (to_rep (rec__preds__rec_bad__x (us_split_fields1 temp___expr_266))) 0)) (forall ((temp___270 Int)) (=> (and (<= 1 temp___270) (<= temp___270 10)) (= (to_rep1 (select (rec__preds__rec_bad__a (us_split_fields1 temp___expr_266)) temp___270)) 0)))))
(define-fun dynamic_predicate2 ((temp___271 us_rep)) Bool (and (and (not (= (to_rep1 (rec__preds__rec_bad__i (us_split_fields1 temp___271))) 0)) (not (= (to_rep (rec__preds__rec_bad__x (us_split_fields1 temp___271))) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (not (= (to_rep1 (let ((temp___273 (rec__preds__rec_bad__a (us_split_fields1 temp___271)))) (select temp___273 k))) 0))))))
...
(declare-const temp___370 int_bad)
(declare-const temp___373 (Array Int integer))
...
(assert (default_initial_assumption1 (mk___rep (mk___split_fields temp___374 temp___3741 temp___3742)) false))
(assert (not (dynamic_predicate2 (mk___rep (mk___split_fields temp___374 temp___3741 temp___3742)))))
(check-sat)
(exit)
