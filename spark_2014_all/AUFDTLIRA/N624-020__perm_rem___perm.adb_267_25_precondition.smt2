...
(assert (and (= o95 (remove a o94)) (and (dynamic_invariant2 o95 true false true) (and (= (invariant__ o95) true) (and (= (to_rep2 (last (rt o95))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o94 1))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o95) k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o94 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select (elts o95) (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o94 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select (elts o95) k1))))))))))))
(assert (not (= (invariant__ o95) true)))
(check-sat)
(exit)
