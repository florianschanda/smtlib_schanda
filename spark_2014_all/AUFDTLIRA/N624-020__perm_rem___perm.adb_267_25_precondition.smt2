...
(assert (and (= o25 (remove b ib1)) (and (dynamic_invariant2 o25 true false true) (and (= (invariant__ o25) true) (and (= (to_rep2 (last (rt o25))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib1 1))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o25) k))))) (and (forall ((k Int)) (=> (and (<= (+ ib1 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o25) (- k 1)))))) (forall ((k Int)) (=> (and (<= ib1 k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o25) k))))))))))))
(assert (and (= o23 ia1) (in_range4 ia1)))
(assert (and (= o24 (remove a o23)) (and (dynamic_invariant2 o24 true false true) (and (= (invariant__ o24) true) (and (= (to_rep2 (last (rt o24))) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o23 1))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o24) k))))) (and (forall ((k Int)) (=> (and (<= (+ o23 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select (elts o24) (- k 1)))))) (forall ((k Int)) (=> (and (<= o23 k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select (elts o24) k))))))))))))
