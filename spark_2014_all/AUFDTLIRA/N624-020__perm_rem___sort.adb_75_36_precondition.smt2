...
(assert (and (= o149 (remove (mk___t init (mk 1 100)) o148)) (and (dynamic_invariant4 o149 true false true) (and (= (invariant__ o149) true) (and (= (to_rep1 (last (rt o149))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o148 1))) (= (to_rep (select init k)) (to_rep (select (elts o149) k))))) (and (forall ((k Int)) (=> (and (<= (+ o148 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o149) (- k 1)))))) (forall ((k Int)) (=> (and (<= o148 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o149) k))))))))))))
(assert (not (= (invariant__ o149) true)))
(check-sat)
(exit)
