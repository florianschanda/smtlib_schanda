...
(assert (=> (= (rec__usergroup_examples__value_cache_t__cached (us_split_fields1 (select vca i))) true) (= (mk_int__ref result) (mk_int__ref v))))
...
(assert (=> (not (= (rec__usergroup_examples__value_cache_t__cached (us_split_fields1 (select vca i))) true)) (= (mk_int__ref result3) (mk_int__ref v))))
