...
(assert (= o8 i2))
(assert (= o9 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o8)))
(assert (= o13 (to_rep1 o9)))
(assert (= o14 (+ o13 o12)))
(assert (and (= o15 o14) (in_range2 o14)))
(assert (= (to_rep1 o16) o15))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__simple_unc_arrays__table__v1 c__split_fields4)))) i2)))
(check-sat)
(exit)
