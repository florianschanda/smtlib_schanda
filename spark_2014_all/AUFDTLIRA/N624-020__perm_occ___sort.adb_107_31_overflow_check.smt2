...
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 values__first) i1) (<= i1 current2)) (forall ((j Int)) (=> (and (<= (+ i1 1) j) (<= j (to_rep1 values__last))) (<= (to_rep (select values3 i1)) (to_rep (select values3 j))))))))
