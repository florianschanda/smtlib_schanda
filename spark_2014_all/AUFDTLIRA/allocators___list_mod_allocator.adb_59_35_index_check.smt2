...
(assert (and (= o10 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o10) (<= (+ 0 o10) 2147483647))))
(assert (= result4 (ite (<= o10 10000) true false)))
(assert (=> (= result4 true) (=> (not (= first_available 0)) (and (= o8 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o8) (<= (+ 0 o8) 2147483647))))))
(assert (=> (= result4 true) (=> (not (= first_available 0)) (= result5 (ite (< 0 o8) true false)))))
(assert (=> (= result4 true) (=> (not (= first_available 0)) (=> (= result5 true) (and (= o7 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) 1)) (in_range6 o7))))))
(assert (=> (= result4 true) (=> (not (= first_available 0)) (=> (= result5 true) (= result3 (ite (= o7 first_available) true false))))))
(assert (=> (= result4 true) (=> (not (= first_available 0)) (=> (not (= result5 true)) (= result3 false)))))
(assert (=> (= result4 true) (=> (not (not (= first_available 0))) (and (= o9 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o9) (<= (+ 0 o9) 2147483647))))))
(assert (=> (= result4 true) (=> (not (not (= first_available 0))) (= result3 (ite (= o9 0) true false)))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (=> (= result3 true) (and (= o5 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o5) (<= (+ 0 o5) 2147483647)))))
(assert (=> (= result3 true) (= o6 (ite (<= j2 o5) true false))))
(assert (=> (= result3 true) (= result6 (ite (<= 1 j2) o6 false))))
...
(assert (=> (= result2 true) (and (= o3 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o3) (<= (+ 0 o3) 2147483647)))))
(assert (=> (= result2 true) (= o4 (ite (<= j1 o3) true false))))
(assert (=> (= result2 true) (= result7 (ite (<= 1 j1) o4 false))))
...
(assert (=> (= result1 true) (and (= o1 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o1) (<= (+ 0 o1) 2147483647)))))
(assert (=> (= result1 true) (= o2 (ite (<= j o1) true false))))
(assert (=> (= result1 true) (= result8 (ite (<= 1 j) o2 false))))
...
(assert (and (= temp___318 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) o)) (in_range6 temp___318)))
(assert (not (<= 1 temp___318)))
(check-sat)
(exit)
