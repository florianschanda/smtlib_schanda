...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___182 a2)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___181 i1)))
...
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___183 Int)) (=> (and (<= 0 temp___183) (<= temp___183 30)) (=> (or (< 30 temp___183) (or (< temp___183 2) (< i2 temp___183))) (= (select a4 temp___183) (select temp___182 temp___183)))))) (and (<= 2 i2) (<= i2 30)))))
