...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___180 a2)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___179 i1)))
...
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___181 Int)) (=> (and (<= 0 temp___181) (<= temp___181 30)) (=> (< i2 temp___181) (= (select a4 temp___181) (select temp___180 temp___181)))))) (and (<= 2 i2) (<= i2 30)))))
