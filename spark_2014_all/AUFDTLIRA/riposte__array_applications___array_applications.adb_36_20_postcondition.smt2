...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (= temp___156 a2) (and (= temp___155 i1) (and (and (and (and (and (= o4 (+ (to_rep (select a2 (- i1 1))) (to_rep (select a2 (- i1 2))))) (in_range1 (+ (to_rep (select a2 (- i1 1))) (to_rep (select a2 (- i1 2)))))) (= (to_rep o5) o4)) (= o6 (store a2 i1 o5))) (and (= a2 result3) (= a3 o6))) (and (and (and (forall ((j1 Int)) (=> (and (<= 2 j1) (<= j1 i2)) (= (to_rep (select a4 j1)) (+ (to_rep (select a4 (- j1 1))) (to_rep (select a4 (- j1 2))))))) (= (to_rep (select a4 0)) 0)) (= (to_rep (select a4 1)) 1)) (and (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___157 Int)) (=> (and (<= 0 temp___157) (<= temp___157 30)) (=> (< i2 temp___157) (= (select a4 temp___157) (select temp___156 temp___157)))))) (and (<= 2 i2) (<= i2 30))) (= i2 30)))))) (and (and (= i2 i6) (= a4 a8)) (and (= i7 i2) (= a9 a4))))))
