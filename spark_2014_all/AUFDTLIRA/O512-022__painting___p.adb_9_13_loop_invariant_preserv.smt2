...
(assert (<= 0 c1))
(assert (<= c1 2))
(assert (and (= (bool_eq1 p__split_fields4 0 2 p__split_fields 0 2) true) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- c2 1))) (=> (= (bool_eq (select p__split_fields4 j) d) true) (= (bool_eq (select p__split_fields5 j) d) true))))))
(assert (and (and (and (= p__split_fields4 p__split_fields) (forall ((temp___208 Int)) (=> (and (<= 0 temp___208) (<= temp___208 2)) (=> (<= c2 temp___208) (= (select p__split_fields5 temp___208) (select p__split_fields1 temp___208)))))) (=> (<= 0 2) (in_range2 c2))) (and (<= 0 c2) (<= c2 2))))
(assert (=> (= (bool_eq (select p__split_fields4 c2) d) true) (= result1 p__split_fields4)))
(assert (=> (= (bool_eq (select p__split_fields4 c2) d) true) (= result2 p__split_fields5)))
(assert (=> (= (bool_eq (select p__split_fields4 c2) d) true) (= p__split_fields4 p__split_fields6)))
(assert (=> (= (bool_eq (select p__split_fields4 c2) d) true) (= (store p__split_fields5 c2 d) p__split_fields7)))
(assert (=> (not (= (bool_eq (select p__split_fields4 c2) d) true)) (= (mk___split_fields1 p__split_fields6 p__split_fields7) (mk___split_fields1 p__split_fields4 p__split_fields5))))
(assert (not (= c2 2)))
(assert (= result3 c2))
(assert (= c3 (+ c2 1)))
(assert (not (= (bool_eq1 p__split_fields6 0 2 p__split_fields 0 2) true)))
(check-sat)
(exit)
