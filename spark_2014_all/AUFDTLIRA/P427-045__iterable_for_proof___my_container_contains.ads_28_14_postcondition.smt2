...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep (rec__my_container_contains__cursor__index (us_split_fields1 a))) (to_rep (rec__my_container_contains__cursor__index (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 1 100)) (in_range1 temp___expr_136)))
(declare-const my_container_contains__element__result Int)
(declare-const o Int)
(declare-const o1 natural)
(declare-const o2 Int)
(declare-const result Int)
(declare-const my_container_contains__element__result1 Int)
(declare-const my_container_contains__element__result2 Int)
(declare-const my_container_contains__element__result3 Int)
(declare-const my_container_contains__element__result4 Int)
(declare-const my_container_contains__element__result5 Int)
(declare-const result1 Int)
(assert (= (has_element c p) true))
(assert (= my_container_contains__element__result1 my_container_contains__element__result2))
(assert (= my_container_contains__element__result3 my_container_contains__element__result1))
(assert (and (<= 1 (to_rep (rec__my_container_contains__cursor__index (us_split_fields1 p)))) (<= (to_rep (rec__my_container_contains__cursor__index (us_split_fields1 p))) 100)))
(assert (= o (to_rep (rec__my_container_contains__cursor__index (us_split_fields1 p)))))
(assert (= o1 (select c o)))
(assert (= o2 (to_rep o1)))
(assert (= result my_container_contains__element__result))
(assert (= my_container_contains__element__result1 o2))
(assert (= (mk_int__ref my_container_contains__element__result4) (mk_int__ref my_container_contains__element__result2)))
(assert (= my_container_contains__element__result5 my_container_contains__element__result3))
(assert (= result1 my_container_contains__element__result4))
(assert (not (= (mem c my_container_contains__element__result4) true)))
(check-sat)
(exit)
