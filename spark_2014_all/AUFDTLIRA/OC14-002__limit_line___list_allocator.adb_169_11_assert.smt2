...
(assert (<= 1 r))
(assert (<= r 3))
(assert (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data4 r)))) 0))
(assert (not (= (mem (rec__list_allocator__m__t__available model____split_fields4) r) true)))
(check-sat)
(exit)
