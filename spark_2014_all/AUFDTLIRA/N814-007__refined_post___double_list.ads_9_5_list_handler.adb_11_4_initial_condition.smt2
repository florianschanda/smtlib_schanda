...
(define-fun dynamic_invariant1 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_141)))
(declare-const max_size Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const default_element Int)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(define-fun dynamic_invariant2 ((temp___expr_153 Int) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (=> (or (= temp___is_init_150 true) (<= 0 128)) (in_range2 temp___expr_153)))
...
(assert (forall ((list_handler__integer_list__count Int)) (! (=> (dynamic_invariant2 list_handler__integer_list__count true true true) (dynamic_invariant (size list_handler__integer_list__count) true false true)) :pattern ((size list_handler__integer_list__count)))))
(assert (forall ((list_handler__integer_list__count Int)) (! (=> (dynamic_invariant2 list_handler__integer_list__count true true true) (let ((result (size1 list_handler__integer_list__count))) (and (= result list_handler__integer_list__count) (dynamic_invariant result true false true)))) :pattern ((size1 list_handler__integer_list__count)))))
(assert (= max_size 128))
...
(assert (and (= count1 0) (and (in_range2 count1) (in_range2 free1))))
(assert (and (= o (size1 count1)) (and (in_range o) (= o count1))))
