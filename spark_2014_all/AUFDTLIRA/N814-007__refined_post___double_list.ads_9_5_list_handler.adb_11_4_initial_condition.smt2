...
(define-fun dynamic_invariant1 ((temp___expr_164 Int) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool) (temp___do_typ_inv_163 Bool)) Bool (=> (or (= temp___is_init_160 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_164)))
(declare-const max_size Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const default_element Int)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(define-fun dynamic_invariant2 ((temp___expr_178 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool) (temp___do_typ_inv_177 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= 0 128)) (in_range2 temp___expr_178)))
...
(assert (forall ((list_handler__integer_list__count Int)) (! (=> (dynamic_invariant2 list_handler__integer_list__count true true true true) (dynamic_invariant (size list_handler__integer_list__count) true false true true)) :pattern ((size list_handler__integer_list__count)))))
(assert (forall ((list_handler__integer_list__count Int)) (! (=> (dynamic_invariant2 list_handler__integer_list__count true true true true) (let ((result (size1 list_handler__integer_list__count))) (and (= result list_handler__integer_list__count) (dynamic_invariant result true false true true)))) :pattern ((size1 list_handler__integer_list__count)))))
(assert (= max_size 128))
