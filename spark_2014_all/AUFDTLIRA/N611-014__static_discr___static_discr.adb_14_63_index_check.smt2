...
(assert (= o4 o8))
(assert (= current__split_discrs (mk___split_discrs1 temp___373 temp___3731)))
...
(assert (= current__split_fields4 (mk___split_fields4 (mk___rep3 (mk___split_discrs temp___3732 temp___3733) (mk___split_fields3 temp___3734)) temp___3735)))
(assert (= current__split_discrs (mk___split_discrs1 temp___373 temp___3731)))
...
(assert (<= (to_rep (rec__static_discr__holder__length1 (us_split_fields__content4 current__split_fields5))) (int__content result__3)))
(assert (<= (int__content result__3) (to_rep current__split_fields3)))
(assert (not (<= 1 (int__content result__3))))
(check-sat)
(exit)
