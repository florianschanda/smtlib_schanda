...
(assert (in_range7 l))
(assert (in_range1 v))
(assert (and (= o10 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range5 o10)))
(assert (= result (ite (< 0 o10) true false)))
(assert (= result true))
(assert (not (= (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))) 0)))
(assert (and (= o9 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range7 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
...
(assert (= result1 true))
(assert (and (= o8 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range7 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (and (= result2 (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8 (rec__search_trees__search_tree__values (us_split_fields7 t)))) (= (= result2 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8) i1))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o8) i1)))) 1)) 0) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j)) (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1))) (< (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i1)) (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) j))))))))))))
(assert (= result2 true))
