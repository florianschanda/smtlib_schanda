...
(assert (=> (= result3 true) (=> (= result7 true) (= (mk3 pos3 fb20a00__find__L_2__R7b1) temp___2093))))
(assert (=> (= result3 true) (=> (= result7 true) (= o26 (bool_eq temp___2092 (to_rep1 (first6 temp___2093)) (to_rep1 (last6 temp___2093)) new_sub1 (to_rep1 new_sub__first) (to_rep1 new_sub__last))))))
