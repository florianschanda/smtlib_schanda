...
(declare-const temp___2392 (Array Int character))
(declare-const temp___2393 t3)
...
(assert (=> (= result3 true) (and (= fb20a00__find__L_2__R7b1 o24) (in_range1 o24))))
(assert (=> (= result3 true) (=> (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last)) (= o27 (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1)))))
(assert (=> (= result3 true) (=> (not (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))) (= o27 0))))
...
(assert (=> (= result3 true) (=> (= result7 true) (=> (<= pos3 fb20a00__find__L_2__R7b1) (and (and (<= (to_rep1 new_str__first) pos3) (<= pos3 (to_rep1 new_str__last))) (and (<= (to_rep1 new_str__first) fb20a00__find__L_2__R7b1) (<= fb20a00__find__L_2__R7b1 (to_rep1 new_str__last))))))))
(assert (=> (= result3 true) (=> (= result7 true) (= o25 new_str1))))
(assert (=> (= result3 true) (=> (= result7 true) (= o25 temp___2392))))
(assert (=> (= result3 true) (=> (= result7 true) (= (mk3 pos3 fb20a00__find__L_2__R7b1) temp___2393))))
(assert (=> (= result3 true) (=> (= result7 true) (= o26 (bool_eq temp___2392 (to_rep1 (first6 temp___2393)) (to_rep1 (last6 temp___2393)) new_sub1 (to_rep1 new_sub__first) (to_rep1 new_sub__last))))))
(assert (=> (= result3 true) (=> (= result7 true) (= o33 (ite (not (= o26 true)) true false)))))
(assert (=> (= result3 true) (=> (not (= result7 true)) (= o33 false))))
(assert (=> (= result3 true) (= result6 (ite (not (= o33 true)) true false))))
...
(assert (=> (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last)) (= o34 (+ (- (to_rep1 new_sub__last) (to_rep1 new_sub__first)) 1))))
(assert (=> (not (<= (to_rep1 new_sub__first) (to_rep1 new_sub__last))) (= o34 0)))
