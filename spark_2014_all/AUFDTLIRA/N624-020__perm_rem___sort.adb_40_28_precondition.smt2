...
(assert (and (= o32 x) (in_range5 x)))
(assert (and (= (mk___t o33 o34) (remove (mk___t interm1 (mk 1 100)) o32)) (and (dynamic_invariant4 (mk___t o33 o34) true false true) (and (= (invariant__ (mk___t o33 o34)) true) (and (= (to_rep1 (last o34)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o32 1))) (= (to_rep (select interm1 k)) (to_rep (select o33 k))))) (and (forall ((k Int)) (=> (and (<= (+ o32 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select o33 (- k 1)))))) (forall ((k Int)) (=> (and (<= o32 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select o33 k))))))))))))
(assert (not (= (invariant__ (mk___t o33 o34)) true)))
(check-sat)
(exit)
