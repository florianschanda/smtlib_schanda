...
(define-fun dynamic_invariant ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (=> (or (= temp___is_init_156 true) (<= 0 1002)) (in_range1 temp___expr_160)))
...
(define-fun dynamic_invariant1 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 0 1001)) (in_range2 temp___expr_167)))
...
(assert (forall ((i Int)) (! (=> (dynamic_invariant1 i true true true true) (let ((result (create_step_array i))) (forall ((j Int)) (=> (and (<= 0 j) (<= j 1001)) (and (=> (< j i) (= (to_rep (select result j)) (- 23))) (=> (<= i j) (= (to_rep (select result j)) 69))))))) :pattern ((create_step_array i)))))
(declare-const i Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(define-fun dynamic_invariant2 ((temp___expr_174 Int) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool) (temp___do_typ_inv_173 Bool)) Bool (=> (or (= temp___is_init_170 true) (<= (- 23) 69)) (in_range3 temp___expr_174)))
...
(assert (= c1 0))
(assert (in_range1 c1))
(assert (and (= o (create_step_array i)) (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 1001)) (and (=> (< j2 i) (= (to_rep (select o j2)) (- 23))) (=> (<= i j2) (= (to_rep (select o j2)) 69)))))))
...
(assert (<= 0 j1))
(assert (<= j1 1001))
(assert (= (to_rep (select step1 j1)) (- 23)))
(assert (not (in_range1 (+ c1 1))))
(check-sat)
(exit)
