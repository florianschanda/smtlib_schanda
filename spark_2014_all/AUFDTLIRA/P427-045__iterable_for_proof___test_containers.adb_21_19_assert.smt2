...
(assert (let ((temp___203 (get_model c3))) (forall ((temp___202 Int)) (=> (and (in_range temp___202) (= (m_has_element temp___203 temp___202) true)) (= (valid (m_element temp___203 temp___202)) true)))))
