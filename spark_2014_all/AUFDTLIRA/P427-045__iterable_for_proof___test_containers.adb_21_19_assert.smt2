...
(assert (let ((temp___177 (get_model c3))) (forall ((temp___176 Int)) (=> (and (in_range temp___176) (= (m_has_element temp___177 temp___176) true)) (= (valid (m_element temp___177 temp___176)) true)))))
(assert (= (m_has_element (get_model c3) p3) true))
(assert (not (= (valid (m_element (get_model c3) p3)) true)))
(check-sat)
(exit)
