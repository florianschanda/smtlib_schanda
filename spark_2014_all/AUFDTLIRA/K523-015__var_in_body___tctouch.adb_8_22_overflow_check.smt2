...
(declare-fun tTcollectionSP1qtint (tTcollectionSP1) Int)
(assert (forall ((i tTcollectionSP1)) (and (<= 1 (tTcollectionSP1qtint i)) (<= (tTcollectionSP1qtint i) 10))))
...
(declare-datatypes () ((tTcollectionSP1__ref (mk_tTcollectionSP1__ref (tTcollectionSP1__content tTcollectionSP1)))))
(define-fun tTcollectionSP1__ref___projection ((a tTcollectionSP1__ref)) tTcollectionSP1 (tTcollectionSP1__content a))
