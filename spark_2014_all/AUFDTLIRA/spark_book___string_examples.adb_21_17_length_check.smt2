...
(assert (= (concat1 name3 1 20 name3 1 20) temp___540))
(assert (= (mk 1 o9) temp___5401))
(assert (not (= (ite (<= (to_rep1 (first temp___5401)) (to_rep1 (last temp___5401))) (+ (- (to_rep1 (last temp___5401)) (to_rep1 (first temp___5401))) 1) 0) (ite (<= 1 40) (+ (- 40 1) 1) 0))))
(check-sat)
(exit)
