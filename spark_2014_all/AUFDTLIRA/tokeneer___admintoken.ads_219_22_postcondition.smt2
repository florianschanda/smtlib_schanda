...
(define-fun dynamic_invariant ((temp___expr_173 Int) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool)) Bool (=> (or (= temp___is_init_170 true) (<= 0 1)) (in_range1 temp___expr_173)))
...
(define-fun dynamic_invariant1 ((temp___expr_251 Int) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (=> (or (= temp___is_init_248 true) (<= 0 4294967295)) (in_range2 temp___expr_251)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant2 ((temp___expr_257 Int) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool)) Bool (=> (or (= temp___is_init_254 true) (<= 0 2)) (in_range3 temp___expr_257)))
...
(assert (forall ((x algorithmt)) (! (in_range5 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x namecountt)) (! (in_range6 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x character)) (! (in_range7 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x serialnumbert)) (! (in_range9 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x yearst)) (! (in_range10 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x monthst)) (! (in_range11 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x dayst)) (! (in_range12 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x millisecst)) (! (in_range13 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(assert (forall ((x privileget)) (! (in_range14 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(assert (forall ((x classt)) (! (in_range15 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (= (to_rep10 (rec__privtypes__clearancet__class (us_split_fields7 a))) (to_rep10 (rec__privtypes__clearancet__class (us_split_fields7 b)))) true false))
...
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields8)) us_rep2 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields8)) us_rep2 (rec__cert__attr__auth__contentst__notafter a))
...
(define-fun bool_eq5 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (and (and (and (= (bool_eq2 (rec__cert__attr__auth__contentst__id (us_split_fields9 a)) (rec__cert__attr__auth__contentst__id (us_split_fields9 b))) true) (= (bool_eq3 (rec__cert__attr__auth__contentst__notbefore (us_split_fields9 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields9 b))) true)) (= (bool_eq3 (rec__cert__attr__auth__contentst__notafter (us_split_fields9 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields9 b))) true)) (= (to_rep (rec__cert__attr__auth__contentst__mechanism (us_split_fields9 a))) (to_rep (rec__cert__attr__auth__contentst__mechanism (us_split_fields9 b))))) (= (bool_eq2 (rec__cert__attr__auth__contentst__basecertid (us_split_fields9 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields9 b))) true)) (= (to_rep9 (rec__cert__attr__auth__contentst__role (us_split_fields9 a))) (to_rep9 (rec__cert__attr__auth__contentst__role (us_split_fields9 b))))) (= (bool_eq4 (rec__cert__attr__auth__contentst__clearance (us_split_fields9 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields9 b))) true)) true false))
...
(declare-fun user_eq21 (keyidt keyidt) Bool)
(declare-const dummy21 keyidt)
...
(assert (forall ((x keyidt)) (! (in_range16 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(declare-fun user_eq22 (keylengtht keylengtht) Bool)
(declare-const dummy22 keylengtht)
...
(assert (forall ((x keylengtht)) (! (in_range17 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun bool_eq6 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (= (to_rep (rec__cryptotypes__keypartt__algorithmid (us_split_fields11 a))) (to_rep (rec__cryptotypes__keypartt__algorithmid (us_split_fields11 b)))) (= (to_rep11 (rec__cryptotypes__keypartt__keyid (us_split_fields11 a))) (to_rep11 (rec__cryptotypes__keypartt__keyid (us_split_fields11 b))))) (= (to_rep12 (rec__cryptotypes__keypartt__keylength (us_split_fields11 a))) (to_rep12 (rec__cryptotypes__keypartt__keylength (us_split_fields11 b))))) true false))
...
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__id__contentst__id us_rep1) (rec__cert__id__contentst__notbefore us_rep2) (rec__cert__id__contentst__notafter us_rep2) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep) (rec__cert__id__contentst__subjectpublickey us_rep5)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields12)) us_rep1 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields12)) us_rep2 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields12)) us_rep2 (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields12)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields12)) us_rep (rec__cert__id__contentst__subject a))
...
(define-fun bool_eq7 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (and (and (= (bool_eq2 (rec__cert__id__contentst__id (us_split_fields13 a)) (rec__cert__id__contentst__id (us_split_fields13 b))) true) (= (bool_eq3 (rec__cert__id__contentst__notbefore (us_split_fields13 a)) (rec__cert__id__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq3 (rec__cert__id__contentst__notafter (us_split_fields13 a)) (rec__cert__id__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep (rec__cert__id__contentst__mechanism (us_split_fields13 a))) (to_rep (rec__cert__id__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq1 (rec__cert__id__contentst__subject (us_split_fields13 a)) (rec__cert__id__contentst__subject (us_split_fields13 b))) true)) (= (bool_eq6 (rec__cert__id__contentst__subjectpublickey (us_split_fields13 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields13 b))) true)) true false))
...
(define-fun us_rep___15__projection ((a us_rep7)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq8 ((a us_rep7) (b us_rep7)) Bool (ite (and (= (rec__admintoken__validauthcertt__valid (us_split_fields15 a)) (rec__admintoken__validauthcertt__valid (us_split_fields15 b))) (= (bool_eq5 (rec__admintoken__validauthcertt__contents (us_split_fields15 a)) (rec__admintoken__validauthcertt__contents (us_split_fields15 b))) true)) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_885 Int) (temp___is_init_882 Bool) (temp___skip_constant_883 Bool) (temp___do_toplevel_884 Bool)) Bool (=> (or (= temp___is_init_882 true) (<= 0 3)) (in_range14 temp___expr_885)))
(declare-fun therole (us_rep4) Int)
(declare-fun therole__function_guard (Int us_rep4) Bool)
(assert (forall ((admintoken__authcert__fields us_split_fields14)) (! (dynamic_invariant3 (theauthcertrole admintoken__authcert__fields) true false true) :pattern ((theauthcertrole admintoken__authcert__fields)))))
...
(define-fun us_rep___16__projection ((a us_rep8)) us_split_fields16 (us_split_fields17 a))
(define-fun bool_eq9 ((a us_rep8) (b us_rep8)) Bool (ite (and (= (rec__admintoken__valididcertt__valid (us_split_fields17 a)) (rec__admintoken__valididcertt__valid (us_split_fields17 b))) (= (bool_eq7 (rec__admintoken__valididcertt__contents (us_split_fields17 a)) (rec__admintoken__valididcertt__contents (us_split_fields17 b))) true)) true false))
...
(define-fun dynamic_invariant4 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range7 temp___expr_63)))
(define-fun dynamic_invariant5 ((temp___expr_341 Int) (temp___is_init_338 Bool) (temp___skip_constant_339 Bool) (temp___do_toplevel_340 Bool)) Bool (=> (or (= temp___is_init_338 true) (<= 1901 2099)) (in_range10 temp___expr_341)))
(define-fun dynamic_invariant6 ((temp___expr_347 Int) (temp___is_init_344 Bool) (temp___skip_constant_345 Bool) (temp___do_toplevel_346 Bool)) Bool (=> (or (= temp___is_init_344 true) (<= 1 12)) (in_range11 temp___expr_347)))
(define-fun dynamic_invariant7 ((temp___expr_353 Int) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool)) Bool (=> (or (= temp___is_init_350 true) (<= 1 31)) (in_range12 temp___expr_353)))
(define-fun dynamic_invariant8 ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 0 86399999)) (in_range13 temp___expr_377)))
(define-fun dynamic_invariant9 ((temp___expr_179 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 40)) (in_range6 temp___expr_179)))
(define-fun dynamic_invariant10 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 4294967295)) (in_range8 temp___expr_200)))
(define-fun dynamic_invariant11 ((temp___expr_218 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 0 10)) (in_range5 temp___expr_218)))
(define-fun dynamic_invariant12 ((temp___expr_230 Int) (temp___is_init_227 Bool) (temp___skip_constant_228 Bool) (temp___do_toplevel_229 Bool)) Bool (=> (or (= temp___is_init_227 true) (<= 0 4294967295)) (in_range16 temp___expr_230)))
(define-fun dynamic_invariant13 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 0 128)) (in_range17 temp___expr_236)))
(define-fun dynamic_invariant14 ((temp___expr_891 Int) (temp___is_init_888 Bool) (temp___skip_constant_889 Bool) (temp___do_toplevel_890 Bool)) Bool (=> (or (= temp___is_init_888 true) (<= 1 3)) (in_range4 temp___expr_891)))
(define-fun dynamic_invariant15 ((temp___expr_897 Int) (temp___is_init_894 Bool) (temp___skip_constant_895 Bool) (temp___do_toplevel_896 Bool)) Bool (=> (or (= temp___is_init_894 true) (<= 0 5)) (in_range15 temp___expr_897)))
(define-fun dynamic_invariant16 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 0 4294967295)) (in_range9 temp___expr_321)))
(assert (forall ((contents us_rep4)) (! (dynamic_invariant3 (therole contents) true false true) :pattern ((therole contents)))))
...
(declare-const result3 us_split_fields__ref7)
...
(declare-const authcertcontents__split_fields2 us_split_fields__ref4)
(declare-const idcertcontents__split_fields2 us_split_fields__ref6)
...
(declare-const authcertcontents__split_fields3 us_split_fields8)
(declare-const idcertcontents__split_fields3 us_split_fields12)
(assert (=> (<= 0 1) (in_range1 tokenpresence)))
(assert (=> (<= 0 2) (in_range3 tokentry)))
(assert (=> (<= 0 4294967295) (in_range2 tokenid)))
(assert (= result tokenpresence))
(assert (= tokenpresence1 1))
(assert (= result1 tokentry))
(assert (= tokentry1 0))
(assert (= result2 tokenid))
(assert (= tokenid1 0))
(assert (= result3 authcert__split_fields))
(assert (= (let ((subject authcert__split_fields)) authcert__split_fields1) (mk___split_fields7 (of_int 0) (mk___rep4 (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields1)))))
(assert (= result4 idcert__split_fields))
(assert (= (let ((subject idcert__split_fields)) idcert__split_fields1) (mk___split_fields8 (of_int 0) (mk___rep6 (let ((subject idcertcontents__split_fields)) idcertcontents__split_fields1)))))
(assert (= idcertcontents__split_fields2 (let ((subject idcertcontents__split_fields)) (mk___split_fields__ref6 idcertcontents__split_fields1))))
(assert (= authcertcontents__split_fields2 (let ((subject authcertcontents__split_fields)) (mk___split_fields__ref4 authcertcontents__split_fields1))))
...
(assert (= idcertcontents__split_fields3 idcertcontents__split_fields1))
(assert (= authcertcontents__split_fields3 authcertcontents__split_fields1))
...
(assert (not (not (in_range4 (theauthcertrole (us_split_fields__content7 authcert__split_fields2))))))
(check-sat)
(exit)
