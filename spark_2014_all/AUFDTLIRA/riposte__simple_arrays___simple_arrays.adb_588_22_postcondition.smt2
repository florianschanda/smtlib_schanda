...
(define-fun dynamic_invariant ((temp___expr_137 Int) (temp___is_init_134 Bool) (temp___skip_constant_135 Bool) (temp___do_toplevel_136 Bool)) Bool (=> (or (= temp___is_init_134 true) (<= 0 2)) (in_range temp___expr_137)))
...
(assert (= a1 o1))
(assert (= (to_rep o2) 1))
(assert (= o3 (store a1 23 o2)))
(assert (= result1 a1))
(assert (= a2 o3))
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (not (= (to_rep (select a3 42)) 0))))
(check-sat)
(exit)
