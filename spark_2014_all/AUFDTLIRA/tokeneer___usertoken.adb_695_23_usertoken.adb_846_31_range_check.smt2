...
(assert (forall ((x classt)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x classt)) (! (in_range14 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun us_rep___6__projection ((a us_rep7)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq8 ((a us_rep7) (b us_rep7)) Bool (ite (= (to_rep12 (rec__privtypes__clearancet__class (us_split_fields15 a))) (to_rep12 (rec__privtypes__clearancet__class (us_split_fields15 b)))) true false))
...
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__cert__attr__priv__contentst__id us_rep1) (rec__cert__attr__priv__contentst__notbefore us_rep2) (rec__cert__attr__priv__contentst__notafter us_rep2) (rec__cert__attr__priv__contentst__mechanism algorithmt) (rec__cert__attr__priv__contentst__basecertid us_rep1) (rec__cert__attr__priv__contentst__role privileget) (rec__cert__attr__priv__contentst__clearance us_rep7)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields16)) us_rep1 (rec__cert__attr__priv__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields16)) us_rep2 (rec__cert__attr__priv__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields16)) us_rep2 (rec__cert__attr__priv__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields16)) algorithmt (rec__cert__attr__priv__contentst__mechanism a))
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields16)) us_rep1 (rec__cert__attr__priv__contentst__basecertid a))
(define-fun us_split_fields_Role__projection ((a us_split_fields16)) privileget (rec__cert__attr__priv__contentst__role a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields16)) us_rep7 (rec__cert__attr__priv__contentst__clearance a))
...
(define-fun bool_eq9 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (and (and (= (bool_eq2 (rec__cert__attr__priv__contentst__id (us_split_fields17 a)) (rec__cert__attr__priv__contentst__id (us_split_fields17 b))) true) (= (bool_eq3 (rec__cert__attr__priv__contentst__notbefore (us_split_fields17 a)) (rec__cert__attr__priv__contentst__notbefore (us_split_fields17 b))) true)) (= (bool_eq3 (rec__cert__attr__priv__contentst__notafter (us_split_fields17 a)) (rec__cert__attr__priv__contentst__notafter (us_split_fields17 b))) true)) (= (to_rep4 (rec__cert__attr__priv__contentst__mechanism (us_split_fields17 a))) (to_rep4 (rec__cert__attr__priv__contentst__mechanism (us_split_fields17 b))))) (= (bool_eq2 (rec__cert__attr__priv__contentst__basecertid (us_split_fields17 a)) (rec__cert__attr__priv__contentst__basecertid (us_split_fields17 b))) true)) (= (to_rep11 (rec__cert__attr__priv__contentst__role (us_split_fields17 a))) (to_rep11 (rec__cert__attr__priv__contentst__role (us_split_fields17 b))))) (= (bool_eq8 (rec__cert__attr__priv__contentst__clearance (us_split_fields17 a)) (rec__cert__attr__priv__contentst__clearance (us_split_fields17 b))) true)) true false))
...
(declare-fun cert_attr_priv_to_cert_attr__function_guard (us_rep6 us_rep8) Bool)
(assert true)
...
(assert (forall ((x certificatestatus)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x certificatestatus)) (! (in_range15 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun bool_eq10 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (= (rec__usertoken__valididcertt__valid (us_split_fields19 a)) (rec__usertoken__valididcertt__valid (us_split_fields19 b))) (= (to_rep13 (rec__usertoken__valididcertt__idstatus (us_split_fields19 a))) (to_rep13 (rec__usertoken__valididcertt__idstatus (us_split_fields19 b))))) (= (bool_eq6 (rec__usertoken__valididcertt__contents (us_split_fields19 a)) (rec__usertoken__valididcertt__contents (us_split_fields19 b))) true)) true false))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2030 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 4)) 118)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 6)) 108)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 8)) 103)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 11)) 67)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 16)) 102)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 17)) 105)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 18)) 99)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 20)) 116)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 23)) 78)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 25)) 116)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 27)) 67)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 28)) 117)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 29)) 114)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 30)) 114)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 31)) 101)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 32)) 110)) (= (to_rep (select (temp___String_Literal_2030 us_void_param) 33)) 116)) :pattern ((temp___String_Literal_2030 us_void_param)))))
(declare-fun temp___String_Literal_2035 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2035 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 4)) 118)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 6)) 108)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 8)) 103)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 11)) 67)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 16)) 102)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 17)) 105)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 18)) 99)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 20)) 116)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 23)) 78)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 25)) 116)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 27)) 86)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 28)) 101)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 29)) 114)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 30)) 105)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 31)) 102)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 32)) 105)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 33)) 97)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 34)) 98)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 35)) 108)) (= (to_rep (select (temp___String_Literal_2035 us_void_param) 36)) 101)) :pattern ((temp___String_Literal_2035 us_void_param)))))
(declare-fun temp___String_Literal_2040 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2040 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 4)) 118)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 6)) 108)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 8)) 103)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 11)) 67)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 16)) 102)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 17)) 105)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 18)) 99)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 20)) 116)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 23)) 66)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 24)) 97)) (= (to_rep (select (temp___String_Literal_2040 us_void_param) 25)) 100)) :pattern ((temp___String_Literal_2040 us_void_param)))))
...
(define-fun dynamic_invariant1 ((temp___expr_1638 Int) (temp___is_init_1635 Bool) (temp___skip_constant_1636 Bool) (temp___do_toplevel_1637 Bool)) Bool (=> (or (= temp___is_init_1635 true) (<= 0 3)) (in_range15 temp___expr_1638)))
...
(define-fun dynamic_invariant7 ((temp___expr_179 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 0 40)) (in_range2 temp___expr_179)))
(define-fun dynamic_invariant8 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 4294967295)) (in_range3 temp___expr_200)))
(define-fun dynamic_invariant9 ((temp___expr_218 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 0 10)) (in_range6 temp___expr_218)))
...
(define-fun dynamic_invariant12 ((temp___expr_341 Int) (temp___is_init_338 Bool) (temp___skip_constant_339 Bool) (temp___do_toplevel_340 Bool)) Bool (=> (or (= temp___is_init_338 true) (<= 0 3)) (in_range13 temp___expr_341)))
(define-fun dynamic_invariant13 ((temp___expr_353 Int) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool)) Bool (=> (or (= temp___is_init_350 true) (<= 0 5)) (in_range14 temp___expr_353)))
(define-fun dynamic_invariant14 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 0 4294967295)) (in_range4 temp___expr_321)))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= o1 (cert_attr_priv_to_cert_attr (mk___rep8 (let ((subject privcertcontents__split_fields)) privcertcontents__split_fields2)))))))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= o11 (cert_attr_priv_to_cert (mk___rep8 (let ((subject privcertcontents__split_fields)) privcertcontents__split_fields2)))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o12 (cert_attr_priv_to_cert (mk___rep8 (let ((subject privcertcontents__split_fields)) privcertcontents__split_fields2)))))))
...
(assert (=> (not (= certfound true)) (= (let ((subject privcertcontents__split_fields)) (mk___split_fields__ref8 privcertcontents__split_fields2)) privcertcontents__split_fields)))
