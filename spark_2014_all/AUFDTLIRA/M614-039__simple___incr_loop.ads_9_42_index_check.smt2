...
(assert (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= temp___155 a)))
(assert (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= temp___153 a)))
(assert (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= temp___156 a)))
(assert (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= temp___151 i2)))
(assert (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (and (forall ((k Int)) (=> (and (<= (to_rep a__first) k) (<= k (- i3 1))) (= (to_rep (select a2 k)) (+ (to_rep (select temp___155 k)) 1)))) (forall ((k Int)) (=> (and (<= i3 k) (<= k (to_rep a__last))) (= (to_rep (select a2 k)) (to_rep (select temp___156 k))))))))
(assert (=> (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (and (and (=> (<= (to_rep a__first) (to_rep a__last)) (dynamic_property1 (to_rep a__first) (to_rep a__last) i3)) (forall ((temp___154 Int)) (=> (and (<= (to_rep a__first) temp___154) (<= temp___154 (to_rep a__last))) (=> (<= i3 temp___154) (= (select a2 temp___154) (select temp___153 temp___154)))))) (and (<= (to_rep a__first) i3) (<= i3 (to_rep a__last))))))
