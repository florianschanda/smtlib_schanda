...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (let ((temp___447 (temp___258 (mk___t a (mk (to_rep a__first) (to_rep a__last))) (+ i 1) new_val))) (bool_eq a2 (to_rep a__first) (to_rep a__last) (elts temp___447) (to_rep (first (rt temp___447))) (to_rep (last (rt temp___447))))) true)))
(check-sat)
(exit)
