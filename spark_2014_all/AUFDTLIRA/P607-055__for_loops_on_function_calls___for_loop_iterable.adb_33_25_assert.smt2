...
(assert (and (= o (first (mk___rep g__split_fields4))) (and (in_range3 o) (= o 1))))
(assert (= o temp___253))
(assert (and (= result2 (has_element (mk___rep g__split_fields4) temp___253)) (= (= result2 true) (in_range2 temp___253))))
(assert (=> (= result2 true) (and (= o1 (element (mk___rep g__split_fields4) temp___253)) (and (in_range1 o1) (= o1 (to_rep (select g__split_fields1 temp___253)))))))
(assert (=> (= result2 true) (= result3 e)))
(assert (=> (= result2 true) (= e2 o1)))
(assert (=> (not (= result2 true)) (= e2 e)))
(assert (=> (not (= result2 true)) (= e2 e1)))
(assert (and (= result4 (has_element (mk___rep g__split_fields4) temp___253)) (= (= result4 true) (in_range2 temp___253))))
(assert (= result4 true))
(assert (and (= (has_element (mk___rep g__split_fields3) temp___2531) true) (= e3 (element (mk___rep g__split_fields3) temp___2531))))
(assert (not (= e3 0)))
(check-sat)
(exit)
