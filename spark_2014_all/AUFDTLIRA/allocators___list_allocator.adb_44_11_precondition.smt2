...
(assert (=> (= result1 true) (and (= o1 (length model____split_fields)) (and (in_range6 o1) (<= (+ 0 o1) 2147483647)))))
(assert (=> (= result1 true) (= o2 (ite (<= j o1) true false))))
(assert (=> (= result1 true) (= result6 (ite (<= 1 j) o2 false))))
(assert (=> (= result1 true) (= (= result true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length model____split_fields))) (and (and (in_range4 (get model____split_fields j1)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data (get model____split_fields j1))))) (ite (< j1 (length model____split_fields)) (get model____split_fields (+ j1 1)) 0))) (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- j1 1))) (not (= (get model____split_fields j1) (get model____split_fields k1)))))))))))
