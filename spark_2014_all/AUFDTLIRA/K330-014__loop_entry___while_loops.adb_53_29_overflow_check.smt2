...
(assert (=> (= result8 true) (and (< 0 counter18) (and (< (sum_of 2) 0) (and (and (and (and (= o10 (sum_of 2)) (in_range4 o10)) (= o11 (ite (< o10 0) true false))) (= result9 (ite (not (= o11 true)) true false))) (= result9 true))))))
