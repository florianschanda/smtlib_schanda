...
(assert (and (= o9 (size (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)))) (in_range6 o9)))
(assert (= result (ite (< 0 o9) true false)))
(assert (= result true))
(assert (not (= (to_rep (select t_old__split_fields3 l)) v)))
(assert (and (= o6 (to_rep1 t_old__split_fields)) (in_range8 (to_rep1 t_old__split_fields))))
(assert (and (= temp___2136 (model__ (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o6)) (and (dynamic_invariant8 temp___2136 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 o6))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2136 o6)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o6)) (ite (and (not (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 i1))) true) (not (= i1 o6))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___2136 (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1)))) (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2136 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___2136 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___2136 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___2136 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___2136 j1)))) true)) (= j1 i1))))))))))))))
(assert (= o7 (select temp___2136 l)))
(assert (= o8 (us_split_fields5 o7)))
(assert (= result1 (rec__tree_model__path_type__k o8)))
(assert (= result1 true))
...
(assert (= result2 true))
(assert (and (= o5 (peek (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) l d)) (and (in_range6 o5) (and (ite (not (= o5 0)) (and (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o5) d) (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) o5) l)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j1) l) (not (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j1) l) (= (position (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)) j1) d)) (= o5 j1))))))))
(assert (= result3 (ite (= o5 0) true false)))
(assert (= result3 true))
...
(assert (= result4 true))
(assert (and (= o2 (size (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)))) (in_range6 o2)))
(assert (= o3 (+ o2 1)))
(assert (and (= o4 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range6 o4)))
(assert (= result5 (ite (= o4 o3) true false)))
(assert (= result5 true))
...
(assert (and (= result6 (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o1)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) o1) (not (= result6 true)))))
(assert (= result6 true))
(assert (not (= i 0)))
(assert (and (= o (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) l d)) (and (in_range6 o) (and (ite (not (= o 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o) d) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o) l)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) l) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) l) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) d)) (= o j1))))))))
(assert (= result7 (ite (= o i) true false)))
(assert (= result7 true))
(assert (<= 1 j))
(assert (<= j 100))
