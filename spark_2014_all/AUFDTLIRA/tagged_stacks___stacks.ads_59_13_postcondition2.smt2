...
(define-fun dynamic_property1 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range6 low) (in_range6 high))))))
...
(define-fun default_initial_assumption1 ((temp___expr_185 us_rep) (temp___skip_top_level_186 Bool)) Bool (and (and (= (attr__tag temp___expr_185) us_tag) (and (= (rec__stacks__stack_root__content (us_split_fields1 temp___expr_185)) (temp_____aggregate_def_187 0)) (= (to_rep (rec__stacks__stack_root__length (us_split_fields1 temp___expr_185))) 0))) (=> (not (= temp___skip_top_level_186 true)) (= (size temp___expr_185) 0))))
...
(declare-const stacks__get_model__3__result (Array Int element))
(declare-const stacks__get_model__3__result1 t)
(declare-const stacks__get_model__3__R86s Int)
(declare-const o (Array Int element))
(declare-const temp___560 (Array Int element))
(declare-const temp___5601 t3)
(declare-const o1 (Array Int element))
(declare-const temp___559 (Array Int element))
(declare-const temp___5591 t2)
...
(declare-const temp___561 (Array Int element))
(declare-const temp___5611 t1)
(declare-const stacks__get_model__3__R89s Int)
(declare-const o8 (Array Int element))
(declare-const temp___564 (Array Int element))
(declare-const temp___5641 t4)
(declare-const o9 (Array Int element))
(declare-const o10 t)
(declare-const result Bool)
(declare-const result1 (Array Int element))
(declare-const result2 t)
(declare-const stacks__get_model__3__result2 (Array Int element))
(declare-const stacks__get_model__3__result3 t)
(declare-const stacks__get_model__3__result4 (Array Int element))
(declare-const stacks__get_model__3__result5 t)
(declare-const stacks__get_model__3__result6 (Array Int element))
(declare-const stacks__get_model__3__result7 t)
(declare-const stacks__get_model__3__result8 (Array Int element))
(declare-const stacks__get_model__3__result9 t)
(declare-const stacks__get_model__3__result10 (Array Int element))
(declare-const stacks__get_model__3__result11 t)
(define-fun stacks__get_model__3__result12 () us_t (mk___t stacks__get_model__3__result2 stacks__get_model__3__result3))
(declare-const result3 (Array Int element))
(declare-const result4 t)
(assert (= stacks__get_model__3__result4 stacks__get_model__3__result2))
(assert (= stacks__get_model__3__result5 stacks__get_model__3__result3))
(assert (= (mk___t stacks__get_model__3__result6 stacks__get_model__3__result7) stacks__get_model__3__result12))
(assert (and (= result (wraps_around s)) (= (= result true) (< 100 (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1)))))
(assert (=> (= result true) (and (= stacks__get_model__3__R86s (last2 s)) (and (in_range1 stacks__get_model__3__R86s) (= stacks__get_model__3__R86s (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100)))))))
(assert (=> (= result true) (=> (<= 1 stacks__get_model__3__R86s) (and (and (<= 1 1) (<= 1 100)) (and (<= 1 stacks__get_model__3__R86s) (<= stacks__get_model__3__R86s 100))))))
(assert (=> (= result true) (= o (rec__stacks__stack_root__content1 (us_split_fields3 s)))))
(assert (=> (= result true) (= o temp___560)))
(assert (=> (= result true) (= (mk3 1 stacks__get_model__3__R86s) temp___5601)))
(assert (=> (= result true) (=> (<= (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) 100) (and (and (<= 1 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s)))) (<= (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) 100)) (and (<= 1 100) (<= 100 100))))))
(assert (=> (= result true) (= o1 (rec__stacks__stack_root__content1 (us_split_fields3 s)))))
(assert (=> (= result true) (= o1 temp___559)))
(assert (=> (= result true) (= (mk2 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) 100) temp___5591)))
(assert (=> (= result true) (=> (= (length2 (mk___t2 temp___559 temp___5591)) 0) (= temp___560 temp___561))))
(assert (=> (= result true) (=> (= (length2 (mk___t2 temp___559 temp___5591)) 0) (= (mk1 (to_rep2 (first6 temp___5601)) (to_rep2 (last8 temp___5601))) temp___5611))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (<= (to_rep2 (first6 temp___5601)) (to_rep2 (last8 temp___5601))) (= o2 (+ (- (to_rep2 (last8 temp___5601)) (to_rep2 (first6 temp___5601))) 1))))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (not (<= (to_rep2 (first6 temp___5601)) (to_rep2 (last8 temp___5601)))) (= o2 0)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (<= (to_rep2 (first4 temp___5591)) (to_rep2 (last6 temp___5591))) (= o3 (+ (- (to_rep2 (last6 temp___5591)) (to_rep2 (first4 temp___5591))) 1))))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (not (<= (to_rep2 (first4 temp___5591)) (to_rep2 (last6 temp___5591)))) (= o3 0)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= o4 (+ o3 o2)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= o5 (+ 1 o4)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= o6 (- o5 1)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (and (= o7 o6) (in_range6 o6)))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= (slide (concat1 temp___559 (to_rep2 (first4 temp___5591)) (to_rep2 (last6 temp___5591)) temp___560 (to_rep2 (first6 temp___5601)) (to_rep2 (last8 temp___5601))) (to_rep2 (first4 temp___5591)) 1) temp___561))))
(assert (=> (= result true) (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= (mk1 1 o7) temp___5611))))
(assert (=> (= result true) (dynamic_property 1 2147483647 (to_rep2 (first2 temp___5611)) (to_rep2 (last4 temp___5611)))))
(assert (=> (= result true) (= temp___561 o9)))
(assert (=> (= result true) (= (mk (to_rep2 (first2 temp___5611)) (to_rep2 (last4 temp___5611))) o10)))
(assert (=> (not (= result true)) (and (= stacks__get_model__3__R89s (last2 s)) (and (in_range1 stacks__get_model__3__R89s) (= stacks__get_model__3__R89s (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100)))))))
(assert (=> (not (= result true)) (=> (<= (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) stacks__get_model__3__R89s) (and (and (<= 1 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s)))) (<= (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) 100)) (and (<= 1 stacks__get_model__3__R89s) (<= stacks__get_model__3__R89s 100))))))
(assert (=> (not (= result true)) (= o8 (rec__stacks__stack_root__content1 (us_split_fields3 s)))))
(assert (=> (not (= result true)) (= o8 temp___564)))
(assert (=> (not (= result true)) (= (mk4 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) stacks__get_model__3__R89s) temp___5641)))
(assert (=> (not (= result true)) (dynamic_property 1 2147483647 (to_rep2 (first8 temp___5641)) (to_rep2 (last10 temp___5641)))))
(assert (=> (not (= result true)) (= temp___564 o9)))
(assert (=> (not (= result true)) (= (mk (to_rep2 (first8 temp___5641)) (to_rep2 (last10 temp___5641))) o10)))
(assert (= result1 stacks__get_model__3__result))
(assert (= result2 stacks__get_model__3__result1))
(assert (= stacks__get_model__3__result12 (mk___t o9 o10)))
(assert (= (mk_model____ref (mk___t stacks__get_model__3__result8 stacks__get_model__3__result9)) (mk_model____ref (mk___t stacks__get_model__3__result4 stacks__get_model__3__result5))))
(assert (= stacks__get_model__3__result10 stacks__get_model__3__result6))
(assert (= stacks__get_model__3__result11 stacks__get_model__3__result7))
(assert (= result3 stacks__get_model__3__result8))
(assert (= result4 stacks__get_model__3__result9))
(assert (not (in_range1 (to_rep2 (first stacks__get_model__3__result9)))))
(check-sat)
(exit)
