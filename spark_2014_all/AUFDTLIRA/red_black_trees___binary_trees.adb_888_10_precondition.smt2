...
(assert (and (<= 1 v) (<= v 100)))
(assert (= o46 v))
(assert (= o47 (store (rec__binary_trees__forest__c f__split_fields5) o46 o45)))
(assert (= o48 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields5) o47)))
(assert (= temp___818 (mk___rep2 o48)))
(assert (= result7 (mk___split_fields__ref2 f__split_fields5)))
(assert (= f__split_fields6 (us_split_fields5 temp___818)))
(assert (and (= (tree_structure (mk___rep2 f_old__split_fields2)) true) (= (tree_structure (mk___rep2 f__split_fields6)) true)))
(assert (not (= (to_rep (rec__binary_trees__forest__s f__split_fields6)) (to_rep (rec__binary_trees__forest__s f_old__split_fields2)))))
(check-sat)
(exit)
