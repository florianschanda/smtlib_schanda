...
(assert (= (= o120 true) (forall ((j3 Int)) (=> (and (<= i4 j3) (<= j3 (to_rep1 a__last))) (and (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a20) i4)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a20) j3))))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a20) j3)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select (map__content a20) i4))))))))))
(assert (and (<= (to_rep1 a__first) i4) (<= i4 (to_rep1 a__last))))
(assert (= o99 i4))
(assert (= o100 (select a o99)))
