...
(assert (not (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (mk___rep2 (us_split_fields5 (rec__red_black_trees__rbt__struct t__split_fields7)))) o26))) true)))
(check-sat)
(exit)
