...
(assert (= (mk___t values (mk (to_rep values__first) (to_rep values__last))) values_old))
(assert (dynamic_invariant2 values_old true false true true))
...
(assert (= values2 o11))
(assert (= (perm values_old (mk___t values2 (mk (to_rep values__first) (to_rep values__last)))) true))
(assert (= temp1 temp2))
(assert (= values2 values3))
(assert (= temp3 temp1))
(assert (= values4 values2))
(assert (= result3 (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t values3 (mk (to_rep values__first) (to_rep values__last))))))
(assert (= result3 true))
(assert (and (<= (to_rep values__first) y) (<= y (to_rep values__last))))
(assert (= o17 y))
...
(assert (= result4 (ite (= o20 o19) true false)))
(assert (= result4 true))
(assert (and (<= (to_rep values__first) x) (<= x (to_rep values__last))))
(assert (= o12 x))
(assert (= o13 (select values o12)))
(assert (= o14 (to_rep o13)))
(assert (not (<= y (to_rep values__last))))
(check-sat)
(exit)
