...
(declare-fun temp___362 (Bool) (Array Int Bool))
(assert (forall ((temp___364 Bool)) (forall ((temp___365 Int)) (= (select (temp___362 temp___364) temp___365) temp___364))))
...
(assert (= test_main__my_sets__empty__result1 (temp___362 (distinct 0 0))))
