...
(define-fun dynamic_invariant ((temp___expr_901 Int) (temp___is_init_898 Bool) (temp___skip_constant_899 Bool) (temp___do_toplevel_900 Bool)) Bool (=> (or (= temp___is_init_898 true) (<= 0 2147483647)) (in_range4 temp___expr_901)))
...
(assert (forall ((x screenxcoordt)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x screenxcoordt)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x screenycoordt)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x screenycoordt)) (! (in_range6 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep3 (rec__screen__interfac__xycoordt__x (us_split_fields5 a))) (to_rep3 (rec__screen__interfac__xycoordt__x (us_split_fields5 b)))) (= (to_rep4 (rec__screen__interfac__xycoordt__y (us_split_fields5 a))) (to_rep4 (rec__screen__interfac__xycoordt__y (us_split_fields5 b))))) true false))
...
(declare-datatypes () ((t254b__ref (mk_t254b__ref (t254b__content integer)))))
(define-fun t254b__ref___projection ((a t254b__ref)) integer (t254b__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t257b__ref (mk_t257b__ref (t257b__content integer)))))
(define-fun t257b__ref___projection ((a t257b__ref)) integer (t257b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t265b__ref (mk_t265b__ref (t265b__content integer)))))
(define-fun t265b__ref___projection ((a t265b__ref)) integer (t265b__content a))
(declare-sort t3 0)
...
(declare-datatypes () ((t268b__ref (mk_t268b__ref (t268b__content integer)))))
(define-fun t268b__ref___projection ((a t268b__ref)) integer (t268b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t279b__ref (mk_t279b__ref (t279b__content integer)))))
(define-fun t279b__ref___projection ((a t279b__ref)) integer (t279b__content a))
(declare-sort t6 0)
...
(declare-datatypes () ((t287b__ref (mk_t287b__ref (t287b__content integer)))))
(define-fun t287b__ref___projection ((a t287b__ref)) integer (t287b__content a))
(declare-sort t7 0)
...
(assert (forall ((temp___1409 Int)) (forall ((temp___1410 Int)) (= (select (screen__writestatsdata__B251b__result__aggregate_def temp___1409) temp___1410) (of_rep temp___1409)))))
(declare-fun screen__writestatsdata__B262b__result__aggregate_def (Int) (Array Int character))
(assert (forall ((temp___1422 Int)) (forall ((temp___1423 Int)) (= (select (screen__writestatsdata__B262b__result__aggregate_def temp___1422) temp___1423) (of_rep temp___1422)))))
(declare-fun screen__writestatsdata__B273b__result__aggregate_def (Int) (Array Int character))
(assert (forall ((temp___1435 Int)) (forall ((temp___1436 Int)) (= (select (screen__writestatsdata__B273b__result__aggregate_def temp___1435) temp___1436) (of_rep temp___1435)))))
(declare-fun screen__writestatsdata__B284b__result__aggregate_def (Int) (Array Int character))
(assert (forall ((temp___1448 Int)) (forall ((temp___1449 Int)) (= (select (screen__writestatsdata__B284b__result__aggregate_def temp___1448) temp___1449) (of_rep temp___1448)))))
...
(define-fun dynamic_invariant5 ((temp___expr_1208 Int) (temp___is_init_1205 Bool) (temp___skip_constant_1206 Bool) (temp___do_toplevel_1207 Bool)) Bool (=> (or (= temp___is_init_1205 true) (<= 1 10)) (in_range7 temp___expr_1208)))
(define-fun dynamic_invariant6 ((temp___expr_1019 Int) (temp___is_init_1016 Bool) (temp___skip_constant_1017 Bool) (temp___do_toplevel_1018 Bool)) Bool (=> (or (= temp___is_init_1016 true) (<= 0 79)) (in_range5 temp___expr_1019)))
(define-fun dynamic_invariant7 ((temp___expr_1025 Int) (temp___is_init_1022 Bool) (temp___skip_constant_1023 Bool) (temp___do_toplevel_1024 Bool)) Bool (=> (or (= temp___is_init_1022 true) (<= 0 29)) (in_range6 temp___expr_1025)))
...
(assert (=> (= currentstats__split_fields true) (not (= (bool_eq2 (mk___rep (mk___split_fields currentstats__split_fields1 currentstats__split_fields2 currentstats__split_fields3 currentstats__split_fields4)) thestats) true))))
(assert (and (and (and (in_range4 successentry1) (in_range4 failentry1)) (in_range4 successbio1)) (in_range4 failbio1)))
(assert (= successentry1 c248b))
(assert (in_range4 c248b))
(assert (= result (mk_map__ref data)))
(assert (= data2 (elts (to_string (attr__ATTRIBUTE_IMAGE4 c248b)))))
(assert (= (to_rep1 data__first) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 c248b)))))))
(assert (= (to_rep1 data__last) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 c248b)))))))
(assert (dynamic_property 1 2147483647 (to_rep1 data__first) (to_rep1 data__last)))
(assert (= result1 (mk_map__ref result__)))
(assert (= result__2 (screen__writestatsdata__B251b__result__aggregate_def 32)))
...
(assert (= (ite (<= (to_rep1 (first4 (rt2 temp___1401))) (to_rep1 (last4 (rt2 temp___1401)))) (+ (- (to_rep1 (last4 (rt2 temp___1401))) (to_rep1 (first4 (rt2 temp___1401)))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0)))
(assert (= temp___1402 (mk___t1 (slide (elts2 temp___1401) (to_rep1 (first4 (rt2 temp___1401))) 1) (mk1 1 (- (to_rep1 data__last) 1)))))
(assert (and (= temp___1404 (- (to_rep1 data__last) 1)) (in_range1 (- (to_rep1 data__last) 1))))
(assert (=> (<= 1 temp___1404) (and (and (<= 1 1) (<= 1 10)) (and (<= 1 temp___1404) (<= temp___1404 10)))))
(assert (= o1 result__2))
(assert (= temp___1405 (mk___t1 o1 (mk1 1 temp___1404))))
(assert (= (ite (<= (to_rep1 (first2 (rt1 temp___1402))) (to_rep1 (last2 (rt1 temp___1402)))) (+ (- (to_rep1 (last2 (rt1 temp___1402))) (to_rep1 (first2 (rt1 temp___1402)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1405))) (to_rep1 (last2 (rt1 temp___1405)))) (+ (- (to_rep1 (last2 (rt1 temp___1405))) (to_rep1 (first2 (rt1 temp___1405)))) 1) 0)))
(assert (= temp___1406 temp___1402))
(assert (forall ((temp___1407 Int)) (ite (and (<= 1 temp___1407) (<= temp___1407 (- (to_rep1 data__last) 1))) (= (select o2 temp___1407) (select (elts1 temp___1406) temp___1407)) (= (select o2 temp___1407) (select result__2 temp___1407)))))
(assert (= result2 (mk_map__ref result__2)))
(assert (= result__3 o2))
(assert (= result3 (mk_map__ref c249b)))
(assert (= c249b1 result__3))
...
(assert (= data3 (elts (to_string (attr__ATTRIBUTE_IMAGE4 c259b)))))
(assert (= (to_rep1 data__first1) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 c259b)))))))
(assert (= (to_rep1 data__last1) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 c259b)))))))
(assert (dynamic_property 1 2147483647 (to_rep1 data__first1) (to_rep1 data__last1)))
(assert (= result6 (mk_map__ref result__1)))
(assert (= result__4 (screen__writestatsdata__B262b__result__aggregate_def 32)))
(assert (<= 2 (to_rep1 data__last1)))
(assert (not (<= (to_rep1 data__first1) 2)))
(check-sat)
(exit)
