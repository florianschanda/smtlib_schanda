...
(assert (not (= (inv (mk___rep (mk___split_fields s__split_fields8 s__split_fields9 s__split_fields10 s__split_fields11 s__split_fields12 s__split_fields13 s__split_fields14 s__split_fields15))) true)))
(check-sat)
(exit)
