...
(assert (forall ((temp___493 Int)) (=> (dynamic_invariant temp___493 true true true true) (forall ((temp___494 Int)) (= (to_rep1 (select (stable_marriage__invert_2__result__aggregate_def temp___493) temp___494)) temp___493)))))
