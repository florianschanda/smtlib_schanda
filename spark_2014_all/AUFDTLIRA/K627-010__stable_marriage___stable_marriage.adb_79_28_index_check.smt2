...
(define-fun bool_eq ((a (Array Int group2_id)) (a__first Int) (a__last Int) (b (Array Int group2_id)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep (select a temp___idx_133)) (to_rep (select b (+ (- b__first a__first) temp___idx_133))))))) true false))
...
(assert (forall ((a (Array Int group2_id)) (b (Array Int group2_id))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep (select a (+ i 1))) (to_rep (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int group2_id)) (b (Array Int group2_id))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep (select b (+ i 1))) (to_rep (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int ranking)) (b (Array Int ranking))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq1 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep1 (select a (+ i 1))) (to_rep1 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int ranking)) (b (Array Int ranking))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq1 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep1 (select b (+ i 1))) (to_rep1 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((temp___451 Int)) (forall ((temp___452 Int)) (= (select (stable_marriage__invert_2__result__aggregate_def temp___451) temp___452) (of_rep1 temp___451)))))
...
(declare-const stable_marriage__invert_2__result (Array Int ranking))
(declare-const temp___455 Int)
(declare-const temp___453 (Array Int ranking))
(declare-const prev Int)
(declare-const g2 Int)
(declare-const prev1 Int)
(declare-const o ranking)
(declare-const o1 (Array Int ranking))
...
(declare-const result2 (Array Int ranking))
(declare-const result__3 (Array Int ranking))
(declare-const result3 Int)
(declare-const rank3 Int)
(declare-const result__4 (Array Int ranking))
(declare-const rank4 Int)
(declare-const result__5 (Array Int ranking))
(declare-const rank5 Int)
(declare-const result__6 (Array Int ranking))
(declare-const rank6 Int)
(declare-const result__7 (Array Int ranking))
(declare-const rank7 Int)
(declare-const result4 (Array Int ranking))
(declare-const stable_marriage__invert_2__result1 (Array Int ranking))
(declare-const stable_marriage__invert_2__result2 (Array Int ranking))
(declare-const stable_marriage__invert_2__result3 (Array Int ranking))
(declare-const result__8 (Array Int ranking))
(declare-const rank8 Int)
(declare-const stable_marriage__invert_2__result4 (Array Int ranking))
(declare-const result__9 (Array Int ranking))
(declare-const rank9 Int)
(declare-const stable_marriage__invert_2__result5 (Array Int ranking))
(assert (= (is_permutation_2 r2) true))
(assert (= (mk_map__ref1 result) (mk_map__ref1 result__)))
(assert (= result__1 (stable_marriage__invert_2__result__aggregate_def 64)))
(assert (forall ((rank11 Int)) (=> (and (<= 1 rank11) (<= rank11 64)) (forall ((rank21 Int)) (=> (and (<= 1 rank21) (<= rank21 64)) (=> (not (= rank11 rank21)) (not (= (to_rep (select r2 rank11)) (to_rep (select r2 rank21))))))))))
(assert (= (mk_int__ref result1) (mk_int__ref rank)))
(assert (= rank1 1))
(assert (<= 1 rank1))
(assert (<= rank1 64))
(assert (forall ((prev2 Int)) (=> (and (<= 1 prev2) (<= prev2 (- rank2 1))) (= (to_rep1 (select result__2 (to_rep (select r2 prev2)))) prev2))))
(assert (forall ((g21 Int)) (=> (and (<= 1 g21) (<= g21 64)) (=> (exists ((prev2 Int)) (and (and (<= 1 prev2) (<= prev2 (- rank2 1))) (= (to_rep (select r2 prev2)) g21))) (= (to_rep (select r2 (to_rep1 (select result__2 g21)))) g21)))))
(assert (and (=> (<= 1 64) (in_range2 rank2)) (and (<= 1 rank2) (<= rank2 64))))
(assert (<= 1 g2))
(assert (<= g2 64))
(assert (<= 1 prev1))
(assert (<= prev1 (- rank2 1)))
(assert (not (<= 1 prev1)))
(check-sat)
(exit)
