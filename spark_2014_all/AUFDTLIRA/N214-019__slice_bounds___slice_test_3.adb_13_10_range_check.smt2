...
(declare-const temp___1741 t1)
(declare-const temp___175 (Array Int integer))
(declare-const temp___1751 t)
(assert (in_range1 i))
(assert (in_range1 j))
(assert (in_range1 k))
(assert (in_range1 l))
...
(assert (= o a))
(assert (= o temp___174))
(assert (= (mk1 k l) temp___1741))
(assert (= (ite (<= (to_rep1 (first2 temp___1741)) (to_rep1 (last2 temp___1741))) (+ (- (to_rep1 (last2 temp___1741)) (to_rep1 (first2 temp___1741))) 1) 0) (ite (<= i j) (+ (- j i) 1) 0)))
(assert (= (slide temp___174 (to_rep1 (first2 temp___1741)) i) temp___175))
(assert (= (mk i j) temp___1751))
(assert (<= i j))
(assert (not (<= 1 i)))
(check-sat)
(exit)
