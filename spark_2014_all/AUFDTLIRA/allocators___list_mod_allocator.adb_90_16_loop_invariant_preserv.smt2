...
(assert (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r3)))) 1) (and (= o11 (add1 alloc2 r3)) (and (and (and (= (length1 o11) (+ (length1 alloc2) 1)) (= (contains o11 r3) true)) (= (ole1 alloc2 o11) true)) (= (included_except o11 alloc2 r3) true)))))
(assert (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r3)))) 1) (= result2 (mk_set__ref alloc2))))
(assert (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r3)))) 1) (= alloc3 o11)))
(assert (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r3)))) 1) (= unseen3 unseen2)))
(assert (=> (not (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r3)))) 1)) (and (= o12 (add1 unseen2 r3)) (and (and (and (= (length1 o12) (+ (length1 unseen2) 1)) (= (contains o12 r3) true)) (= (ole1 unseen2 o12) true)) (= (included_except o12 unseen2 r3) true)))))
(assert (=> (not (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r3)))) 1)) (= result3 (mk_set__ref unseen2))))
(assert (=> (not (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r3)))) 1)) (= unseen3 o12)))
(assert (=> (not (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r3)))) 1)) (= alloc3 alloc2)))
(assert (not (= r3 10000)))
(assert (= result4 (mk_int__ref r3)))
(assert (= r4 (+ r3 1)))
(declare-const e3 Int)
(assert (<= 1 e3))
(assert (<= e3 (- r4 1)))
(assert (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data e3)))) 1))
(assert (not (= (contains alloc3 e3) true)))
(check-sat)
(exit)
