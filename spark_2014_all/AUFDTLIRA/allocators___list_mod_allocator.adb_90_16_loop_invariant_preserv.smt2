...
(assert (<= 1 r1))
(assert (<= r1 10000))
(assert (forall ((e Int)) (=> (and (in_range5 e) (= (contains alloc1 e) true)) (and (<= 1 e) (<= e (- r2 1))))))
(assert (forall ((e Int)) (=> (and (in_range5 e) (= (contains unseen1 e) true)) (and (<= 1 e) (<= e (- r2 1))))))
...
(assert (not (= (contains unseen2 e) true)))
(check-sat)
(exit)
