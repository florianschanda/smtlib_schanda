...
(assert (<= 1 r1))
(assert (<= r1 10000))
(assert (forall ((e Int)) (=> (and (in_range8 e) (= (contains alloc1 e) true)) (and (<= 1 e) (<= e (- r2 1))))))
(assert (forall ((e Int)) (=> (and (in_range8 e) (= (contains unseen1 e) true)) (and (<= 1 e) (<= e (- r2 1))))))
(assert (forall ((e Int)) (=> (and (<= 1 e) (<= e 10000)) (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data e)))) 0) (not (= (contains alloc1 e) true))))))
(assert (forall ((e Int)) (=> (and (<= 1 e) (<= e (- r2 1))) (ite (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data e)))) 1) (= (contains alloc1 e) true) (= (contains unseen1 e) true)))))
(assert (<= (length1 alloc1) (- r2 1)))
(assert (<= (length1 unseen1) (- r2 1)))
(assert (and (=> (<= 1 10000) (in_range3 r2)) (and (<= 1 r2) (<= r2 10000))))
(assert (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r2)))) 1) (and (= o (add1 alloc1 r2)) (and (and (and (= (length1 o) (+ (length1 alloc1) 1)) (= (contains o r2) true)) (= (ole1 alloc1 o) true)) (= (included_except o alloc1 r2) true)))))
(assert (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r2)))) 1) (= result1 (mk_set__ref alloc1))))
(assert (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r2)))) 1) (= alloc2 o)))
(assert (=> (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r2)))) 1) (= unseen2 unseen1)))
(assert (=> (not (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r2)))) 1)) (and (= o1 (add1 unseen1 r2)) (and (and (and (= (length1 o1) (+ (length1 unseen1) 1)) (= (contains o1 r2) true)) (= (ole1 unseen1 o1) true)) (= (included_except o1 unseen1 r2) true)))))
(assert (=> (not (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r2)))) 1)) (= result2 (mk_set__ref unseen1))))
(assert (=> (not (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r2)))) 1)) (= unseen2 o1)))
(assert (=> (not (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data r2)))) 1)) (= alloc2 alloc1)))
(assert (not (= r2 10000)))
...
(assert (<= 1 e))
(assert (<= e (- r3 1)))
(assert (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data e)))) 1))
(assert (not (= (contains alloc2 e) true)))
(check-sat)
(exit)
