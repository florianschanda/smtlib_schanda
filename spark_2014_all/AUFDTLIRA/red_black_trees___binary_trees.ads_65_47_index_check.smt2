...
(assert (= (tree_structure f) true))
(assert (and (= temp___704 (parent f i1)) (and (in_range2 temp___704) (and (= temp___704 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i1))))) (and (=> (= (valid_root f i1) true) (= temp___704 0)) (=> (= (size f) 0) (= temp___704 0)))))))
(assert (not (<= 1 temp___704)))
(check-sat)
(exit)
