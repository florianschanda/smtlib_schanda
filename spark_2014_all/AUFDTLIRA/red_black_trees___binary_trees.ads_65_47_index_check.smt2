...
(assert (= (tree_structure f) true))
(assert (and (= temp___658 (parent f i2)) (and (in_range2 temp___658) (and (= temp___658 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i2))))) (and (=> (= (valid_root f i2) true) (= temp___658 0)) (=> (= (size f) 0) (= temp___658 0)))))))
(assert (not (<= 1 temp___658)))
(check-sat)
(exit)
