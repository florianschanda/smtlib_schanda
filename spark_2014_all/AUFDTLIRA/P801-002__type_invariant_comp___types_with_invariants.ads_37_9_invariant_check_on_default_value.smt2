...
(assert (dynamic_invariant1 (mk___t temp___245 temp___2451) true false true))
(assert (forall ((temp___246 Int)) (=> (and (<= (to_rep (first temp___2451)) temp___246) (<= temp___246 (to_rep (last temp___2451)))) (and (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 (select temp___245 temp___246))) (of_int 1)) (= (to_rep1 (rec__types_with_invariants__my_integer__val (us_split_fields1 (select temp___245 temp___246)))) 0)))))
(declare-const temp___248 Int)
(assert (<= (to_rep (first temp___2451)) temp___248))
(assert (<= temp___248 (to_rep (last temp___2451))))
(assert (= (to_rep1 (rec__types_with_invariants__my_integer__val (us_split_fields1 (select temp___245 temp___248)))) 0))
(assert (not (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 (select temp___245 temp___248))) true)))
(check-sat)
(exit)
