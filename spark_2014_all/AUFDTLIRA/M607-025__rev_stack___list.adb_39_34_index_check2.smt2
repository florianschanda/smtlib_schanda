...
(assert (=> (and (<= first4 i2) (<= i2 last5)) (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields4))))) (+ (- i3 first4) 1)) (forall ((j1 Int)) (=> (and (<= first4 j1) (<= j1 i3)) (= (to_rep (select (elts (to__ (mk___rep s__split_fields4))) (+ (- j1 first4) 1))) (get (model__ l) j1)))))))
...
(assert (<= first4 i8))
(assert (<= i8 last5))
(assert (and (and (and (= (length2 (mk___rep1 res__split_discrs res__split_fields2)) (- i9 first4)) (= (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) (+ (- last5 i9) 1))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (+ (- last5 i9) 1))) (= (to_rep (select (elts (to__ (mk___rep s__split_fields9))) j1)) (to_rep (select (elts (to__ (mk___rep (us_split_fields__content s__split_fields7)))) j1)))))) (forall ((j1 Int)) (=> (and (<= first4 j1) (<= j1 (- i9 1))) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j1) (get (model__ l) (+ (- last5 j1) first4)))))))
(assert (and (=> (<= first4 last5) (dynamic_property4 first4 last5 i9)) (and (<= first4 i9) (<= i9 last5))))
(assert (and (= o14 (- i9 first4)) (in_range1 (- i9 first4))))
(assert (and (= o15 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range5 o15) (<= o15 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
(assert (= result5 (ite (= o15 o14) true false)))
(assert (=> (= result5 true) (and (= o10 (- last5 i9)) (in_range1 (- last5 i9)))))
(assert (=> (= result5 true) (= o11 (+ o10 1))))
(assert (=> (= result5 true) (and (= o12 o11) (in_range1 o11))))
(assert (=> (= result5 true) (and (= o9 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o9 true false true true) (and (= (to_rep (first (rt o9))) 1) (<= 0 (to_rep (last (rt o9)))))))))
(assert (=> (= result5 true) (= o13 (to_rep (last (rt o9))))))
(assert (=> (= result5 true) (= result4 (ite (= o13 o12) true false))))
...
(assert (= result6 (ite (<= 1 j) o5 false)))
(assert (= result6 true))
(assert (and (= temp___532 (to__ (mk___rep (us_split_fields__content s__split_fields7)))) (and (dynamic_invariant1 temp___532 true false true true) (and (= (to_rep (first (rt temp___532))) 1) (<= 0 (to_rep (last (rt temp___532))))))))
(assert (and (<= (to_rep (first (rt temp___532))) j) (<= j (to_rep (last (rt temp___532))))))
(assert (= o6 j))
(assert (= o7 (select (elts temp___532) o6)))
(assert (= o8 (to_rep o7)))
(assert (and (= temp___530 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 temp___530 true false true true) (and (= (to_rep (first (rt temp___530))) 1) (<= 0 (to_rep (last (rt temp___530))))))))
(assert (not (<= (to_rep (first (rt temp___530))) j)))
(check-sat)
(exit)
