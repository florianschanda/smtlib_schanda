...
(assert (and (<= (to_rep1 (first2 a__split_fields1)) j1) (<= j1 (to_rep1 (last2 a__split_fields1)))))
(assert (= o3 j1))
(assert (= o4 (select a__split_fields o3)))
(assert (= o5 (to_rep2 o4)))
(assert (not (<= (to_rep1 (first2 a__split_fields5)) j1)))
(check-sat)
(exit)
