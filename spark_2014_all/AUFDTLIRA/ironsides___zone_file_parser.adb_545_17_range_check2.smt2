...
(assert (= i1 r18b))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= temp___1602 newdomainname1)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= temp___1604 endidx8)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= temp___1601 i1)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1604))))
...
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (and (= temp___1600 o4) (in_range1 o4))))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (and (<= 1 temp___1600) (<= temp___1600 128))))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= o6 temp___1600)))
