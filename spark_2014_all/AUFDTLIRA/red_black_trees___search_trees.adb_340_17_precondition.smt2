...
(assert (= result3 true))
(assert (and (= temp___1760 (model__ f root)) (and (dynamic_invariant5 temp___1760 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 (parent f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 (parent f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1760 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 i))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1760 j)))) true)) (= j i))))))))))))))
(assert (= o (select temp___1760 v)))
(assert (= o1 (us_split_fields1 o)))
(assert (= result4 (rec__tree_model__path_type__k o1)))
(assert (= result4 true))
(assert (and (= result5 (ordered_leafs f_old root values)) (= (= result5 true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old root) i))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f_old root) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) i)))) 1)) 0) (< (to_rep (select values j)) (to_rep (select values i))) (< (to_rep (select values i)) (to_rep (select values j))))))))))))
(assert (= result5 true))
