...
(assert (and (<= (to_rep (first6 temp___2221)) (to_rep (first6 temp___2221))) (<= (to_rep (first6 temp___2221)) (to_rep (last6 temp___2221)))))
(assert (= o (to_rep (first6 temp___2221))))
(assert (= o1 (select temp___222 o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 1) true false)))
(assert (= result (ite (not (= o3 true)) true false)))
(assert (= result true))
(assert (<= (to_rep (first6 temp___2221)) i))
(assert (<= i (to_rep (last6 temp___2221))))
(assert (not (<= (to_rep (first6 temp___2221)) i)))
(check-sat)
(exit)
