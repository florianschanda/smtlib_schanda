...
(assert (=> (and (<= (to_rep values__first) current1) (<= current1 temp___180)) (and (= o3 (index_of_minimum (mk___t o1 o2))) (and (in_range2 o3) (and (and (<= (to_rep (first o2)) o3) (<= o3 (to_rep (last o2)))) (forall ((j Int)) (=> (and (<= (to_rep (first o2)) j) (<= j (to_rep (last o2)))) (<= (to_rep (select o1 o3)) (to_rep (select o1 j))))))))))
