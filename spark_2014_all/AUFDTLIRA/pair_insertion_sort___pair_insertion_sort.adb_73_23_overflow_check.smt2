...
(assert (= result8 true))
(assert (and (= o15 j1) (in_range2 j1)))
(assert (and (= o13 (+ j1 2)) (in_range1 (+ j1 2))))
(assert (and (= o14 o13) (in_range2 o13)))
(assert (and (and (= (is_perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t o22 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select o22 o14)) (to_rep (select a o15))) (and (= (to_rep (select o22 o15)) (to_rep (select a o14))) (forall ((z3 Int)) (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last))) (=> (and (not (= z3 o14)) (not (= z3 o15))) (= (to_rep (select o22 z3)) (to_rep (select a z3))))))))) (= (to_rep a__first) 0)))
(assert (= (to_rep a__first) 0))
(assert (and (<= 0 j2) (<= j2 (- (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0) 3))))
(assert (= (sorted (mk___t o23 (mk (to_rep a__first) (to_rep a__last))) 0 (- j2 1)) true))
(assert (= (sorted (mk___t o23 (mk (to_rep a__first) (to_rep a__last))) (+ j2 2) (+ i1 1)) true))
(assert (=> (< 0 j2) (<= (to_rep (select o23 (- j2 1))) (to_rep (select o23 (+ j2 2))))))
(assert (< x2 (to_rep (select o23 (+ j2 2)))))
(assert (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t o23 (mk (to_rep a__first) (to_rep a__last)))) true))
(assert (or (and (= (to_rep (select o23 j2)) x2) (= (to_rep (select o23 (+ j2 1))) y2)) (and (= (to_rep (select o23 j2)) y2) (= (to_rep (select o23 (+ j2 1))) x2))))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j2)) (= (to_rep a__first) 0)))
(assert (and (= o16 (- j2 1)) (in_range1 (- j2 1))))
(assert (= j2 result9))
(assert (= j3 o16))
(assert (=> (<= 0 j3) (and (<= (to_rep a__first) j3) (<= j3 (to_rep a__last)))))
(assert (=> (<= 0 j3) (= o17 j3)))
(assert (=> (<= 0 j3) (= o18 (select o23 o17))))
(assert (=> (<= 0 j3) (= o19 (to_rep o18))))
(assert (=> (<= 0 j3) (= o20 (ite (< x2 o19) true false))))
(assert (=> (not (<= 0 j3)) (= o20 false)))
(assert (= result10 (ite (not (= o20 true)) true false)))
(assert (not (= result10 true)))
(assert (and (= o21 j3) (in_range2 j3)))
