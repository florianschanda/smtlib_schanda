...
(assert (and (= (mk___t1 temp___984 temp___9841) (value right)) (and (dynamic_invariant (mk___t1 temp___984 temp___9841) true false true) (and (and (= (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 right))) temp___984) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))) temp___9841)) (and (and (and (= (length1 (mk___t1 temp___984 temp___9841)) (length3 right)) (= (to_rep1 (first2 temp___9841)) 1)) (= (to_rep1 (last2 temp___9841)) (length3 right))) (= (< 0 (length3 right)) (not (= (empty right) true))))))))
(assert (=> (= (length1 left) 0) (= temp___984 temp___985)))
(assert (=> (= (length1 left) 0) (= (mk (to_rep1 (first2 temp___9841)) (to_rep1 (last2 temp___9841))) temp___9851)))
(assert (=> (not (= (length1 left) 0)) (=> (<= (to_rep1 (first2 temp___9841)) (to_rep1 (last2 temp___9841))) (= o4 (+ (- (to_rep1 (last2 temp___9841)) (to_rep1 (first2 temp___9841))) 1)))))
(assert (=> (not (= (length1 left) 0)) (=> (not (<= (to_rep1 (first2 temp___9841)) (to_rep1 (last2 temp___9841)))) (= o4 0))))
(assert (=> (not (= (length1 left) 0)) (=> (<= (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left)))) (= o5 (+ (- (to_rep1 (last2 (rt1 left))) (to_rep1 (first2 (rt1 left)))) 1)))))
(assert (=> (not (= (length1 left) 0)) (=> (not (<= (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left))))) (= o5 0))))
(assert (=> (not (= (length1 left) 0)) (= o6 (+ o5 o4))))
(assert (=> (not (= (length1 left) 0)) (= o7 (+ (to_rep1 (first2 (rt1 left))) o6))))
(assert (=> (not (= (length1 left) 0)) (= o8 (- o7 1))))
(assert (=> (not (= (length1 left) 0)) (and (= o9 o8) (in_range2 o8))))
(assert (=> (not (= (length1 left) 0)) (= (concat1 (elts1 left) (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left))) temp___984 (to_rep1 (first2 temp___9841)) (to_rep1 (last2 temp___9841))) temp___985)))
(assert (=> (not (= (length1 left) 0)) (= (mk (to_rep1 (first2 (rt1 left))) o9) temp___9851)))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first temp___9851)) (to_rep1 (last temp___9851))))
(assert (= temp___985 o10))
(assert (= (mk1 (to_rep1 (first temp___9851)) (to_rep1 (last temp___9851))) o11))
