...
(assert (=> (not (= (length1 left) 0)) (=> (<= (to_rep1 (first2 temp___10471)) (to_rep1 (last2 temp___10471))) (= o (+ (- (to_rep1 (last2 temp___10471)) (to_rep1 (first2 temp___10471))) 1)))))
(assert (=> (not (= (length1 left) 0)) (=> (not (<= (to_rep1 (first2 temp___10471)) (to_rep1 (last2 temp___10471)))) (= o 0))))
(assert (=> (not (= (length1 left) 0)) (=> (<= (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left)))) (= o1 (+ (- (to_rep1 (last2 (rt1 left))) (to_rep1 (first2 (rt1 left)))) 1)))))
(assert (=> (not (= (length1 left) 0)) (=> (not (<= (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left))))) (= o1 0))))
(assert (=> (not (= (length1 left) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length1 left) 0)) (= o3 (+ (to_rep1 (first2 (rt1 left))) o2))))
(assert (=> (not (= (length1 left) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length1 left) 0)) (and (= o5 o4) (in_range2 o4))))
...
(assert (=> (not (= (length1 left) 0)) (= (mk (to_rep1 (first2 (rt1 left))) o5) temp___10481)))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first temp___10481)) (to_rep1 (last temp___10481))))
(assert (= temp___1048 o6))
(assert (= (mk1 (to_rep1 (first temp___10481)) (to_rep1 (last temp___10481))) o7))
