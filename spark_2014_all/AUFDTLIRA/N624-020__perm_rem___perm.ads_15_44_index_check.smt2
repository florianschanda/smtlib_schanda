...
(assert (= result3 true))
(assert (and (= o13 (- (to_rep1 (last (rt a))) 1)) (in_range1 (- (to_rep1 (last (rt a))) 1))))
(assert (= result4 (ite (= (to_rep1 (last perm__remove__result9)) o13) true false)))
(assert (= result4 true))
(assert (= (= result5 true) (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- i 1))) (= (to_rep (select (elts a) k1)) (to_rep (select perm__remove__result8 k1)))))))
(assert (= result5 true))
(assert (= (= result6 true) (forall ((k1 Int)) (=> (and (<= (+ i 1) k1) (<= k1 (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select perm__remove__result8 (- k1 1))))))))
(assert (= result6 true))
