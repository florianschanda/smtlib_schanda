...
(define-fun dynamic_invariant4 ((temp___expr_202 us_t1) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (=> (not (= temp___skip_constant_200 true)) (and (dynamic_property2 1 (- (last1 a) 1) (first3 temp___expr_202) (last3 temp___expr_202)) (and (= (first3 temp___expr_202) 1) (= (last3 temp___expr_202) (- (last1 a) 1))))))
...
(declare-const temp___546 (Array Int natural))
(declare-const temp___5461 t3)
(declare-const o1 (Array Int natural))
(declare-const temp___545 (Array Int natural))
(declare-const temp___5451 t2)
...
(declare-const temp___547 (Array Int natural))
...
(assert (= o (elts a)))
(assert (= o temp___546))
(assert (= (mk3 (+ i 1) (to_rep1 (last (rt a)))) temp___5461))
(assert (=> (<= 1 (- i 1)) (and (and (<= (to_rep1 (first (rt a))) 1) (<= 1 (to_rep1 (last (rt a))))) (and (<= (to_rep1 (first (rt a))) (- i 1)) (<= (- i 1) (to_rep1 (last (rt a))))))))
(assert (= o1 (elts a)))
(assert (= o1 temp___545))
(assert (= (mk2 1 (- i 1)) temp___5451))
(assert (=> (= (length2 (mk___t2 temp___545 temp___5451)) 0) (= temp___546 temp___547)))
(assert (=> (= (length2 (mk___t2 temp___545 temp___5451)) 0) (= (mk (to_rep1 (first6 temp___5461)) (to_rep1 (last6 temp___5461))) temp___5471)))
(assert (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0)) (=> (<= (to_rep1 (first6 temp___5461)) (to_rep1 (last6 temp___5461))) (= o2 (+ (- (to_rep1 (last6 temp___5461)) (to_rep1 (first6 temp___5461))) 1)))))
(assert (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0)) (=> (not (<= (to_rep1 (first6 temp___5461)) (to_rep1 (last6 temp___5461)))) (= o2 0))))
(assert (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0)) (=> (<= (to_rep1 (first4 temp___5451)) (to_rep1 (last4 temp___5451))) (= o3 (+ (- (to_rep1 (last4 temp___5451)) (to_rep1 (first4 temp___5451))) 1)))))
(assert (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0)) (=> (not (<= (to_rep1 (first4 temp___5451)) (to_rep1 (last4 temp___5451)))) (= o3 0))))
(assert (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0)) (= o4 (+ o3 o2))))
(assert (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0)) (= o5 (+ (to_rep1 (first4 temp___5451)) o4))))
(assert (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0)) (and (= o7 o6) (in_range3 o6))))
(assert (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0)) (= (concat1 temp___545 (to_rep1 (first4 temp___5451)) (to_rep1 (last4 temp___5451)) temp___546 (to_rep1 (first6 temp___5461)) (to_rep1 (last6 temp___5461))) temp___547)))
(assert (=> (not (= (length2 (mk___t2 temp___545 temp___5451)) 0)) (= (mk (to_rep1 (first4 temp___5451)) o7) temp___5471)))
(assert (= (ite (<= (to_rep1 (first temp___5471)) (to_rep1 (last temp___5471))) (+ (- (to_rep1 (last temp___5471)) (to_rep1 (first temp___5471))) 1) 0) (ite (<= 1 (- (to_rep1 (last (rt a))) 1)) (+ (- (- (to_rep1 (last (rt a))) 1) 1) 1) 0)))
(assert (= (slide temp___547 (to_rep1 (first temp___5471)) 1) perm__remove__result__assume))
...
(assert (= (mk___t perm__remove__result6 perm__remove__result7) (mk___t perm__remove__result2 perm__remove__result3)))
...
(assert (= (mk___t perm__remove__result10 perm__remove__result11) (mk___t perm__remove__result6 perm__remove__result7)))
...
(assert (= result3 true))
(assert (and (= o19 (- (to_rep1 (last (rt a))) 1)) (in_range1 (- (to_rep1 (last (rt a))) 1))))
(assert (= result4 (ite (= (to_rep1 (last perm__remove__result9)) o19) true false)))
(assert (= result4 true))
(assert (= (= result5 true) (forall ((k3 Int)) (=> (and (<= 1 k3) (<= k3 (- i 1))) (= (to_rep (select (elts a) k3)) (to_rep (select perm__remove__result8 k3)))))))
(assert (= result5 true))
(assert (= (= result6 true) (forall ((k3 Int)) (=> (and (<= (+ i 1) k3) (<= k3 (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k3)) (to_rep (select perm__remove__result8 (- k3 1))))))))
(assert (= result6 true))
(assert (and (= o8 (- (to_rep1 (last (rt a))) 1)) (in_range1 (- (to_rep1 (last (rt a))) 1))))
(assert (= o9 (ite (<= k o8) true false)))
(assert (= result7 (ite (<= i k) o9 false)))
(assert (= result7 true))
(assert (and (<= (to_rep1 (first perm__remove__result9)) k) (<= k (to_rep1 (last perm__remove__result9)))))
(assert (= o10 k))
(assert (= o11 (select perm__remove__result8 o10)))
(assert (= o12 (to_rep o11)))
(assert (and (= temp___550 (+ k 1)) (in_range1 (+ k 1))))
(assert (not (<= (to_rep1 (first (rt a))) temp___550)))
(check-sat)
(exit)
