...
(declare-const temp___4474 (Array Int et1))
...
(assert (= j3 j1))
(assert (= a4 a2))
(assert (=> (< i 10) (=> (< 0 e) (and (= o4 (- e 1)) (in_range2 (- e 1))))))
(assert (=> (< i 10) (=> (< 0 e) (and (= o5 (+ i 1)) (in_range1 (+ i 1))))))
(assert (=> (< i 10) (=> (< 0 e) (= temp___4472 (temp___740 a i e o5 o4)))))
(assert (=> (< i 10) (=> (< 0 e) (= result4 (bool_eq a3 1 10 temp___4472 1 10)))))
(assert (=> (< i 10) (=> (not (< 0 e)) (= result4 false))))
(assert (=> (< i 10) (=> (= result4 true) (= result3 true))))
(assert (=> (< i 10) (=> (not (= result4 true)) (=> (= e 0) (and (= o3 (+ i 1)) (in_range1 (+ i 1)))))))
(assert (=> (< i 10) (=> (not (= result4 true)) (=> (= e 0) (= temp___4474 (temp___749 a i e o3 99))))))
(assert (=> (< i 10) (=> (not (= result4 true)) (=> (= e 0) (= result3 (bool_eq a3 1 10 temp___4474 1 10))))))
(assert (=> (< i 10) (=> (not (= result4 true)) (=> (not (= e 0)) (= result3 false)))))
