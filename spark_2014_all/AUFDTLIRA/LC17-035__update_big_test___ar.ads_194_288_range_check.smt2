...
(assert (and (and (= (bool_eq a1 1 10 (temp___4401 t i e) 1 10) true) (or (and (= i 10) (= j1 1)) (and (< i 10) (= j1 (+ i 1))))) (in_range1 j1)))
...
(assert (=> (< i 10) (=> (< 0 e) (= temp___4413 (temp___681 a i e o5 o4)))))
(assert (=> (< i 10) (=> (< 0 e) (= result4 (bool_eq a3 1 10 temp___4413 1 10)))))
...
(assert (=> (< i 10) (=> (not (= result4 true)) (=> (= e 0) (= temp___4415 (temp___690 a i e o3 99))))))
(assert (=> (< i 10) (=> (not (= result4 true)) (=> (= e 0) (= result3 (bool_eq a3 1 10 temp___4415 1 10))))))
