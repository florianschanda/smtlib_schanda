...
(assert (= result4 true))
(assert (and (= o5 (size (mk___rep1 (mk___split_fields1 t_old__split_fields1 t_old__split_fields2)))) (in_range6 o5)))
(assert (= o6 (+ o5 1)))
(assert (and (= o7 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range6 o7)))
