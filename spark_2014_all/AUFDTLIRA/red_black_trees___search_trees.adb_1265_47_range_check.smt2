...
(assert (and (= temp___2074 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o32)) (and (dynamic_invariant8 temp___2074 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2074 o32))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2074 o32)))) 0) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (not (= i4 o32)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2074 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2074 i4))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2074 i4))) true)))))) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2074 i4))) true) (not (= i4 o32))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___2074 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i4) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2074 i4)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2074 i4)))) 0)))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2074 i4))) true) (forall ((j14 Int)) (=> (and (<= 1 j14) (<= j14 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2074 j14))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___2074 i4))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2074 j14)))) true)) (= j14 i4))))))))))))))
(assert (= o33 (select temp___2074 j3)))
