...
(declare-const j Int)
(declare-const o Int)
(declare-const temp___2118 (Array Int us_rep1))
...
(assert (= result4 true))
(assert (and (= o5 (size (mk___rep2 (mk___split_fields2 t_old__split_fields1 t_old__split_fields2)))) (in_range4 o5)))
(assert (= o6 (+ o5 1)))
(assert (and (= o7 (size (rec__search_trees__search_tree__struct (us_split_fields7 t)))) (in_range4 o7)))
(assert (= result5 (ite (= o7 o6) true false)))
(assert (= result5 true))
...
(assert (and (= result6 (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o4)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) o4) (not (= result6 true)))))
(assert (= result6 true))
(assert (not (= i 0)))
(assert (and (= o3 (peek (rec__search_trees__search_tree__struct (us_split_fields7 t)) l d)) (and (in_range4 o3) (and (ite (not (= o3 0)) (and (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) o3) d) (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) o3) l)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) l) (not (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) d)))))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) l) (= (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) j1) d)) (= o3 j1))))))))
(assert (= result7 (ite (= o3 i) true false)))
(assert (= result7 true))
(assert (<= 1 j))
(assert (<= j 100))
...
(assert (and (= temp___2118 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) o)) (and (dynamic_invariant8 temp___2118 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2118 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2118 o)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2118 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2118 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2118 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2118 i1))) true) (not (= i1 o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___2118 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2118 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___2118 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2118 i1))) true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___2118 j1))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___2118 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___2118 j1)))) true)) (= j1 i1))))))))))))))
