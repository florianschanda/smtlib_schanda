...
(assert (= result7 true))
(assert (not (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) i9))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f_old root) j14)))) true)))
(check-sat)
(exit)
