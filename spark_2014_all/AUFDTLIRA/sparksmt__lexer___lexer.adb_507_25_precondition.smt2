...
(assert (=> (= (to_rep3 (rec__file_io__read_result__status next_read__split_discrs7)) 0) (= result10 (ite (= (to_rep (rec__file_io__read_result__c next_read__split_fields7)) 34) true false))))
(assert (=> (not (= (to_rep3 (rec__file_io__read_result__status next_read__split_discrs7)) 0)) (= result10 false)))
