...
(assert (=> (= (to_rep3 (rec__file_io__read_result__status next_read__split_discrs10)) 0) (= result17 (ite (= (to_rep (rec__file_io__read_result__c next_read__split_fields10)) 34) true false))))
(assert (=> (not (= (to_rep3 (rec__file_io__read_result__status next_read__split_discrs10)) 0)) (= result17 false)))
(assert (= result17 true))
(assert (not (= (local_invariant current_read__split_fields10 current_read__split_discrs10 next_read__split_fields10 next_read__split_discrs10) true)))
(check-sat)
(exit)
