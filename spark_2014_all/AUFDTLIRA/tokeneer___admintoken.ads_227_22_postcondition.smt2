...
(define-fun dynamic_invariant1 ((temp___expr_517 Int) (temp___is_init_514 Bool) (temp___skip_constant_515 Bool) (temp___do_toplevel_516 Bool)) Bool (=> (or (= temp___is_init_514 true) (<= 0 4294967295)) (in_range2 temp___expr_517)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant2 ((temp___expr_523 Int) (temp___is_init_520 Bool) (temp___skip_constant_521 Bool) (temp___do_toplevel_522 Bool)) Bool (=> (or (= temp___is_init_520 true) (<= 0 2)) (in_range3 temp___expr_523)))
...
(define-fun dynamic_invariant3 ((temp___expr_1083 Int) (temp___is_init_1080 Bool) (temp___skip_constant_1081 Bool) (temp___do_toplevel_1082 Bool)) Bool (=> (or (= temp___is_init_1080 true) (<= 0 3)) (in_range14 temp___expr_1083)))
...
(define-fun dynamic_invariant5 ((temp___expr_359 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 40)) (in_range6 temp___expr_359)))
(define-fun dynamic_invariant6 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 4294967295)) (in_range8 temp___expr_380)))
(define-fun dynamic_invariant7 ((temp___expr_402 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 10)) (in_range5 temp___expr_402)))
(define-fun dynamic_invariant8 ((temp___expr_414 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 0 4294967295)) (in_range16 temp___expr_414)))
(define-fun dynamic_invariant9 ((temp___expr_420 Int) (temp___is_init_417 Bool) (temp___skip_constant_418 Bool) (temp___do_toplevel_419 Bool)) Bool (=> (or (= temp___is_init_417 true) (<= 0 128)) (in_range17 temp___expr_420)))
(define-fun dynamic_invariant10 ((temp___expr_597 Int) (temp___is_init_594 Bool) (temp___skip_constant_595 Bool) (temp___do_toplevel_596 Bool)) Bool (=> (or (= temp___is_init_594 true) (<= 1901 2099)) (in_range10 temp___expr_597)))
(define-fun dynamic_invariant11 ((temp___expr_603 Int) (temp___is_init_600 Bool) (temp___skip_constant_601 Bool) (temp___do_toplevel_602 Bool)) Bool (=> (or (= temp___is_init_600 true) (<= 1 12)) (in_range11 temp___expr_603)))
(define-fun dynamic_invariant12 ((temp___expr_609 Int) (temp___is_init_606 Bool) (temp___skip_constant_607 Bool) (temp___do_toplevel_608 Bool)) Bool (=> (or (= temp___is_init_606 true) (<= 1 31)) (in_range12 temp___expr_609)))
(define-fun dynamic_invariant13 ((temp___expr_637 Int) (temp___is_init_634 Bool) (temp___skip_constant_635 Bool) (temp___do_toplevel_636 Bool)) Bool (=> (or (= temp___is_init_634 true) (<= 0 86399999)) (in_range13 temp___expr_637)))
(define-fun dynamic_invariant14 ((temp___expr_1089 Int) (temp___is_init_1086 Bool) (temp___skip_constant_1087 Bool) (temp___do_toplevel_1088 Bool)) Bool (=> (or (= temp___is_init_1086 true) (<= 1 3)) (in_range4 temp___expr_1089)))
(define-fun dynamic_invariant15 ((temp___expr_1095 Int) (temp___is_init_1092 Bool) (temp___skip_constant_1093 Bool) (temp___do_toplevel_1094 Bool)) Bool (=> (or (= temp___is_init_1092 true) (<= 0 5)) (in_range15 temp___expr_1095)))
(define-fun dynamic_invariant16 ((temp___expr_493 Int) (temp___is_init_490 Bool) (temp___skip_constant_491 Bool) (temp___do_toplevel_492 Bool)) Bool (=> (or (= temp___is_init_490 true) (<= 0 4294967295)) (in_range9 temp___expr_493)))
