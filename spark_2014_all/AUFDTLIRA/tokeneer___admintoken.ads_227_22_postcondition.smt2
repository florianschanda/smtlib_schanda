...
(define-fun dynamic_invariant1 ((temp___expr_579 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool) (temp___do_typ_inv_578 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 0 4294967295)) (in_range2 temp___expr_579)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant2 ((temp___expr_586 Int) (temp___is_init_582 Bool) (temp___skip_constant_583 Bool) (temp___do_toplevel_584 Bool) (temp___do_typ_inv_585 Bool)) Bool (=> (or (= temp___is_init_582 true) (<= 0 2)) (in_range3 temp___expr_586)))
...
(define-fun dynamic_invariant3 ((temp___expr_1220 Int) (temp___is_init_1216 Bool) (temp___skip_constant_1217 Bool) (temp___do_toplevel_1218 Bool) (temp___do_typ_inv_1219 Bool)) Bool (=> (or (= temp___is_init_1216 true) (<= 0 3)) (in_range14 temp___expr_1220)))
...
(define-fun dynamic_invariant4 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range7 temp___expr_74)))
(define-fun dynamic_invariant5 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range6 temp___expr_402)))
(define-fun dynamic_invariant6 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range8 temp___expr_426)))
(define-fun dynamic_invariant7 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range5 temp___expr_450)))
(define-fun dynamic_invariant8 ((temp___expr_464 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool) (temp___do_typ_inv_463 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 4294967295)) (in_range16 temp___expr_464)))
(define-fun dynamic_invariant9 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 0 128)) (in_range17 temp___expr_471)))
(define-fun dynamic_invariant10 ((temp___expr_670 Int) (temp___is_init_666 Bool) (temp___skip_constant_667 Bool) (temp___do_toplevel_668 Bool) (temp___do_typ_inv_669 Bool)) Bool (=> (or (= temp___is_init_666 true) (<= 1901 2099)) (in_range10 temp___expr_670)))
(define-fun dynamic_invariant11 ((temp___expr_677 Int) (temp___is_init_673 Bool) (temp___skip_constant_674 Bool) (temp___do_toplevel_675 Bool) (temp___do_typ_inv_676 Bool)) Bool (=> (or (= temp___is_init_673 true) (<= 1 12)) (in_range11 temp___expr_677)))
(define-fun dynamic_invariant12 ((temp___expr_684 Int) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool) (temp___do_typ_inv_683 Bool)) Bool (=> (or (= temp___is_init_680 true) (<= 1 31)) (in_range12 temp___expr_684)))
(define-fun dynamic_invariant13 ((temp___expr_716 Int) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool) (temp___do_typ_inv_715 Bool)) Bool (=> (or (= temp___is_init_712 true) (<= 0 86399999)) (in_range13 temp___expr_716)))
(define-fun dynamic_invariant14 ((temp___expr_1227 Int) (temp___is_init_1223 Bool) (temp___skip_constant_1224 Bool) (temp___do_toplevel_1225 Bool) (temp___do_typ_inv_1226 Bool)) Bool (=> (or (= temp___is_init_1223 true) (<= 1 3)) (in_range4 temp___expr_1227)))
(define-fun dynamic_invariant15 ((temp___expr_1234 Int) (temp___is_init_1230 Bool) (temp___skip_constant_1231 Bool) (temp___do_toplevel_1232 Bool) (temp___do_typ_inv_1233 Bool)) Bool (=> (or (= temp___is_init_1230 true) (<= 0 5)) (in_range15 temp___expr_1234)))
(define-fun dynamic_invariant16 ((temp___expr_553 Int) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool) (temp___do_typ_inv_552 Bool)) Bool (=> (or (= temp___is_init_549 true) (<= 0 4294967295)) (in_range9 temp___expr_553)))
(assert (forall ((contents us_rep4)) (! (dynamic_invariant3 (therole contents) true false true true) :pattern ((therole contents)))))
(assert (forall ((contents us_rep4)) (! (= (therole contents) (to_rep9 (rec__cert__attr__auth__contentst__role (us_split_fields9 contents)))) :pattern ((therole contents)))))
...
(assert (= (let ((subject authcert__split_fields)) authcert__split_fields1) (mk___split_fields7 (distinct 0 0) (mk___rep4 (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields1)))))
(assert (= result4 idcert__split_fields))
(assert (= (let ((subject idcert__split_fields)) idcert__split_fields1) (mk___split_fields8 (distinct 0 0) (mk___rep6 (let ((subject idcertcontents__split_fields)) idcertcontents__split_fields1)))))
