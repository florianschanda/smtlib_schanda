...
(assert (<= 0 i1))
(assert (<= i1 (- length1 1)))
(assert (forall ((j1 Int)) (=> (and (<= (to_rep b__first) j1) (<= j1 (to_rep b__last))) (and (=> (and (<= b_first j1) (<= j1 (- (+ b_first i2) 1))) (= (to_rep (select b1 j1)) (to_rep (select (elts a) (- (+ a_first j1) b_first))))) (=> (=> (<= b_first j1) (not (<= j1 (- (+ b_first i2) 1)))) (= (to_rep (select b1 j1)) (to_rep (select b j1))))))))
(assert (and (=> (<= 0 (- length1 1)) (dynamic_property1 0 (- length1 1) i2)) (and (<= 0 i2) (<= i2 (- length1 1)))))
(assert (and (= temp___268 (+ a_first i2)) (in_range1 (+ a_first i2))))
(assert (and (<= (to_rep (first (rt a))) temp___268) (<= temp___268 (to_rep (last (rt a))))))
(assert (= o temp___268))
(assert (= o1 (select (elts a) o)))
(assert (= o2 (to_rep o1)))
(assert (= (to_rep o3) o2))
(assert (and (= temp___269 (+ b_first i2)) (in_range1 (+ b_first i2))))
(assert (and (<= (to_rep b__first) temp___269) (<= temp___269 (to_rep b__last))))
(assert (= o4 temp___269))
...
(assert (= o17 (+ b_first o16)))
(assert (and (= o18 o17) (in_range1 o17)))
(assert (= o19 (- o18 1)))
(assert (= o20 (ite (<= j o19) true false)))
(assert (= o21 (ite (<= b_first j) o20 false)))
(assert (= result2 (ite (not (= o21 true)) true false)))
(assert (=> (= result2 true) (and (<= (to_rep b__first) j) (<= j (to_rep b__last)))))
(assert (=> (= result2 true) (= o24 j)))
(assert (=> (= result2 true) (= o25 (select b o24))))
(assert (=> (= result2 true) (= o26 (to_rep o25))))
(assert (=> (= result2 true) (and (<= (to_rep b__first) j) (<= j (to_rep b__last)))))
(assert (=> (= result2 true) (= o22 j)))
(assert (=> (= result2 true) (= o23 (select b2 o22))))
(assert (=> (= result2 true) (= o27 (to_rep o23))))
(assert (=> (= result2 true) (= o28 (ite (= o27 o26) true false))))
(assert (=> (not (= result2 true)) (= o28 (distinct 1 0))))
(assert (and (= o6 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o7 (+ b_first o6)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (= o9 (- o8 1)))
(assert (= o10 (ite (<= j o9) true false)))
(assert (= result3 (ite (<= b_first j) o10 false)))
(assert (= result3 true))
(assert (and (= o11 (+ a_first j)) (in_range1 (+ a_first j))))
(assert (= o12 (- o11 b_first)))
(assert (and (= temp___272 o12) (in_range1 o12)))
(assert (and (<= (to_rep (first (rt a))) temp___272) (<= temp___272 (to_rep (last (rt a))))))
(assert (= o13 temp___272))
(assert (= o14 (select (elts a) o13)))
(assert (= o15 (to_rep o14)))
(assert (not (<= (to_rep b__first) j)))
(check-sat)
(exit)
