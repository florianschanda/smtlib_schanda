...
(assert (= r14 r12))
(assert (= n11 n9))
(assert (= (= result6 true) (forall ((r15 Int)) (=> (and (<= 1 r15) (<= r15 (to_rep f_old__split_fields))) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r15)))) 2) (= (oeq1 (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) r15) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) r15)) true))))))
(assert (= result6 true))
(assert (<= 1 i))
(assert (<= i 100))
(assert (not (= i root)))
