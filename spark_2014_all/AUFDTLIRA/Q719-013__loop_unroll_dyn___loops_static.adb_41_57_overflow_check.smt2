...
(assert (= a1 o1))
(assert (and (= o2 (- i2 (to_rep1 a__first))) (in_range1 (- i2 (to_rep1 a__first)))))
(assert (= o3 (+ o2 1)))
...
(assert (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 a_length1)) (= (to_rep (select a1 (+ (to_rep1 a__first) i4))) 0))))
(assert (= i2 result3))
(assert (= i3 2))
...
(assert (= a1 result4))
(assert (= a2 o7))
(assert (and (= o8 (- i3 (to_rep1 a__first))) (in_range1 (- i3 (to_rep1 a__first)))))
(assert (= o9 (+ o8 1)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (and (= o11 o10) (in_range2 o10)))
(assert (= a_length1 result5))
(assert (= a_length2 o11))
(assert (in_range2 a_length2))
(assert (<= 1 i1))
(assert (<= i1 a_length2))
(assert (not (in_range1 (+ (to_rep1 a__first) i1))))
(check-sat)
(exit)
