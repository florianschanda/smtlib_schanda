...
(assert (=> (<= (to_rep1 (first4 temp___6941)) (to_rep1 (last4 temp___6941))) (= o21 (+ (- (to_rep1 (last4 temp___6941)) (to_rep1 (first4 temp___6941))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___6941)) (to_rep1 (last4 temp___6941)))) (= o21 0)))
(assert (=> (<= (to_rep1 s__first) (to_rep1 s__last)) (= o22 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1))))
