...
(assert (=> (<= (to_rep1 (first4 temp___6231)) (to_rep1 (last4 temp___6231))) (= o32 (+ (- (to_rep1 (last4 temp___6231)) (to_rep1 (first4 temp___6231))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___6231)) (to_rep1 (last4 temp___6231)))) (= o32 0)))
(assert (=> (<= (to_rep1 s__first) (to_rep1 s__last)) (= o33 (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1))))
(assert (=> (not (<= (to_rep1 s__first) (to_rep1 s__last))) (= o33 0)))
(assert (= o34 (+ o33 o32)))
(assert (= o35 (+ (to_rep1 s__first) o34)))
(assert (= o36 (- o35 1)))
