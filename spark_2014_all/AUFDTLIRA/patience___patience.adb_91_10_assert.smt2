...
(assert (<= 0 i21))
(assert (<= i21 (- (to_rep1 (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1)))
(assert (not (<= 0 (to_rep1 (select (rec__patience__state__posstack (us_split_fields__content s__split_fields20)) i21)))))
(check-sat)
(exit)
