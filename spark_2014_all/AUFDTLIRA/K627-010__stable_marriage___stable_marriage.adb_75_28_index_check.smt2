...
(assert (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (=> (exists ((prev1 Int)) (and (and (<= 1 prev1) (<= prev1 (- rank2 1))) (= (to_rep (select r2 prev1)) g2))) (= (to_rep (select r2 (to_rep1 (select result__2 g2)))) g2)))))
