...
(assert (not (= (ite (<= (to_rep1 (first10 temp___16621)) (to_rep1 (last10 temp___16621))) (+ (- (to_rep1 (last10 temp___16621)) (to_rep1 (first10 temp___16621))) 1) 0) (ite (<= 1 r6b) (+ (- r6b 1) 1) 0))))
(check-sat)
(exit)
