...
(define-fun bool_eq ((a (Array Int integer)) (a__first Int) (a__last Int) (b (Array Int integer)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_151 Int)) (=> (and (<= a__first temp___idx_151) (<= temp___idx_151 a__last)) (= (to_rep1 (select a temp___idx_151)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_151))))))) true false))
...
(assert (forall ((a (Array Int positive)) (b (Array Int positive))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_152 Int)) (=> (and (<= a__first temp___idx_152) (<= temp___idx_152 a__last)) (= (to_rep (select a temp___idx_152)) (to_rep (select b (+ (- b__first a__first) temp___idx_152)))))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_529 us_t1) (temp___is_init_526 Bool) (temp___skip_constant_527 Bool) (temp___do_toplevel_528 Bool)) Bool (=> (not (= temp___skip_constant_527 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_529) (last3 temp___expr_529))))
...
(assert (= o5 (to_rep o4)))
(assert (= temp___630 (- o5 1)))
(assert (and (<= (to_rep1 (first2 (rt1 p))) (- i 1)) (<= (- i 1) (to_rep1 (last2 (rt1 p))))))
(assert (= o6 (- i 1)))
(assert (= o7 (select (elts1 p) o6)))
(assert (= temp___629 (to_rep o7)))
(assert (<= temp___629 temp___630))
(assert (not (<= (to_rep1 (first (rt a))) temp___629)))
(check-sat)
(exit)
