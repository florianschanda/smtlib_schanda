...
(define-fun dynamic_invariant2 ((temp___expr_535 us_t1) (temp___is_init_532 Bool) (temp___skip_constant_533 Bool) (temp___do_toplevel_534 Bool)) Bool (=> (not (= temp___skip_constant_533 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_535) (last3 temp___expr_535))))
...
(assert (not (<= (to_rep1 (first (rt a))) temp___635)))
(check-sat)
(exit)
