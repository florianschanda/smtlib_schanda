...
(define-fun dynamic_invariant1 ((temp___expr_581 us_t) (temp___is_init_577 Bool) (temp___skip_constant_578 Bool) (temp___do_toplevel_579 Bool) (temp___do_typ_inv_580 Bool)) Bool (=> (not (= temp___skip_constant_578 true)) (dynamic_property 1 2147483647 (first1 temp___expr_581) (last1 temp___expr_581))))
...
(define-fun dynamic_invariant2 ((temp___expr_601 us_t1) (temp___is_init_597 Bool) (temp___skip_constant_598 Bool) (temp___do_toplevel_599 Bool) (temp___do_typ_inv_600 Bool)) Bool (=> (not (= temp___skip_constant_598 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_601) (last3 temp___expr_601))))
...
(assert (= o2 (to_rep o1)))
(assert (= temp___706 (- o2 1)))
(assert (and (<= (to_rep1 (first2 (rt1 p))) (- i 1)) (<= (- i 1) (to_rep1 (last2 (rt1 p))))))
(assert (= o3 (- i 1)))
(assert (= o4 (select (elts1 p) o3)))
(assert (= temp___705 (to_rep o4)))
(assert (<= temp___705 temp___706))
(assert (not (<= (to_rep1 (first (rt a))) temp___705)))
(check-sat)
(exit)
