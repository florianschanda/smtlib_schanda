...
(assert (not (exists ((ib14 Int)) (and (and (<= (to_rep2 (first (rt b))) ib14) (<= ib14 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia15)) (to_rep (select (elts b) ib14))) (= (is_perm (remove a ia15) (remove b ib14)) true))))))
(check-sat)
(exit)
