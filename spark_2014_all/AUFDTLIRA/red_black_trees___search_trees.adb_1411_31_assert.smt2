...
(assert (= i8 0))
(assert (not (exists ((i20 Int)) (and (and (<= 1 i20) (<= i20 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 t__split_fields7)) i20))) true) (= (to_rep (select (rec__search_trees__search_tree__values t__split_fields7) i20)) v))))))
(check-sat)
(exit)
