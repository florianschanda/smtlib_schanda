...
(assert (= i1 r97b))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= temp___1795 endidx8)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= temp___1793 newnameserver1)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= temp___1792 i1)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1795))))
...
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (and (= temp___1791 o4) (in_range1 o4))))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (and (<= 1 temp___1791) (<= temp___1791 128))))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= o6 temp___1791)))
