...
(assert (not (= (to_rep (select (elts1 (value (mk___rep this__split_discrs (mk___split_fields this__split_fields6 (mk___t this__split_fields7 this__split_fields8))))) start)) by__)))
(check-sat)
(exit)
