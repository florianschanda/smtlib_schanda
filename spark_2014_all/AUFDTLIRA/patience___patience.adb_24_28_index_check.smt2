...
(assert (not (= i8 0)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (= temp___570 (- i8 1)) (in_range1 (- i8 1)))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (<= 0 temp___570) (<= temp___570 99))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o4 temp___570)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= temp___571 (select s__split_fields4 o4))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (= temp___573 (- i8 1)) (in_range1 (- i8 1)))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (<= 0 temp___573) (<= temp___573 99))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o5 temp___573)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o6 (select s__split_fields3 o5))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o7 (to_rep1 o6))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= temp___574 (- o7 1))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (<= 0 temp___574) (<= temp___574 99))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o8 temp___574)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o9 (select temp___571 o8))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o10 (to_rep1 o9))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= result3 (ite (= pred2 o10) true false))))
(assert (=> (not (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1)))) (= result3 false)))
(assert (= result3 true))
(assert (not (<= 0 pred2)))
(check-sat)
(exit)
