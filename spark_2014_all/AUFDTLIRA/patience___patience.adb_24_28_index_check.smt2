...
(assert (not (= i2 0)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (= temp___570 (- i2 1)) (in_range1 (- i2 1)))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (<= 0 temp___570) (<= temp___570 99))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o temp___570)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= temp___571 (select s__split_fields4 o))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (= temp___573 (- i2 1)) (in_range1 (- i2 1)))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (<= 0 temp___573) (<= temp___573 99))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o1 temp___573)))
...
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= temp___574 (- o3 1))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (<= 0 temp___574) (<= temp___574 99))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o4 temp___574)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o5 (select temp___571 o4))))
