...
(assert (not (= i2 0)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (= temp___600 (- i2 1)) (in_range1 (- i2 1)))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (<= 0 temp___600) (<= temp___600 99))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o temp___600)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= temp___601 (select s__split_fields4 o))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (= temp___603 (- i2 1)) (in_range1 (- i2 1)))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (<= 0 temp___603) (<= temp___603 99))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o1 temp___603)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o2 (select s__split_fields3 o1))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o3 (to_rep1 o2))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= temp___604 (- o3 1))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (and (<= 0 temp___604) (<= temp___604 99))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o4 temp___604)))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o5 (select temp___601 o4))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= o6 (to_rep1 o5))))
(assert (=> (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1))) (= result2 (ite (= pred2 o6) true false))))
(assert (=> (not (and (<= 0 pred2) (<= pred2 (- (to_rep1 s__split_fields) 1)))) (= result2 false)))
(assert (= result2 true))
(assert (not (<= 0 pred2)))
(check-sat)
(exit)
