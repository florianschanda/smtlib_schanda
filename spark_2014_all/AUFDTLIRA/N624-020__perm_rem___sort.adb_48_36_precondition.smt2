...
(assert (and (= o39 (remove (mk___t values2 (mk 1 100)) o16)) (and (dynamic_invariant4 o39 true false true) (and (= (invariant__ o39) true) (and (= (to_rep1 (last o18)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o16 1))) (= (to_rep (select values2 k)) (to_rep (select o17 k))))) (and (forall ((k Int)) (=> (and (<= (+ o16 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o17 (- k 1)))))) (forall ((k Int)) (=> (and (<= o16 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o17 k))))))))))))
(assert (and (= o13 y) (in_range5 y)))
(assert (and (= o40 (remove (mk___t interm1 (mk 1 100)) o13)) (and (dynamic_invariant4 o40 true false true) (and (= (invariant__ o40) true) (and (= (to_rep1 (last o15)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select interm1 k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select o14 k))))))))))))
(assert (and (= o20 (remove_eq o40 o39 o19)) (and (in_range4 o20) (=> (= (of_int o20) true) (= (let ((temp___163 (remove o39 o19))) (let ((temp___162 (remove o40 o19))) (bool_eq (elts temp___162) (to_rep1 (first (rt temp___162))) (to_rep1 (last (rt temp___162))) (elts temp___163) (to_rep1 (first (rt temp___163))) (to_rep1 (last (rt temp___163)))))) true)))))
...
(assert (and (= o34 (remove (mk___t values2 (mk 1 100)) o33)) (and (dynamic_invariant4 o34 true false true) (and (= (invariant__ o34) true) (and (= (to_rep1 (last (rt o34))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o33 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o34) k))))) (and (forall ((k Int)) (=> (and (<= (+ o33 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o34) (- k 1)))))) (forall ((k Int)) (=> (and (<= o33 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o34) k))))))))))))
(assert (and (= temp___262 (remove o34 o35)) (and (dynamic_invariant4 temp___262 true false true) (and (= (invariant__ temp___262) true) (and (= (to_rep1 (last (rt temp___262))) (- (to_rep1 (last (rt o34))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o35 1))) (= (to_rep (select (elts o34) k)) (to_rep (select (elts temp___262) k))))) (and (forall ((k Int)) (=> (and (<= (+ o35 1) k) (<= k (to_rep1 (last (rt o34))))) (= (to_rep (select (elts o34) k)) (to_rep (select (elts temp___262) (- k 1)))))) (forall ((k Int)) (=> (and (<= o35 k) (<= k (- (to_rep1 (last (rt o34))) 1))) (= (to_rep (select (elts o34) (+ k 1))) (to_rep (select (elts temp___262) k))))))))))))
(assert (and (= o38 y) (in_range5 y)))
(assert (and (= o36 x) (in_range5 x)))
(assert (and (= o37 (remove (mk___t init (mk 1 100)) o36)) (and (dynamic_invariant4 o37 true false true) (and (= (invariant__ o37) true) (and (= (to_rep1 (last (rt o37))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o36 1))) (= (to_rep (select init k)) (to_rep (select (elts o37) k))))) (and (forall ((k Int)) (=> (and (<= (+ o36 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o37) (- k 1)))))) (forall ((k Int)) (=> (and (<= o36 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o37) k))))))))))))
