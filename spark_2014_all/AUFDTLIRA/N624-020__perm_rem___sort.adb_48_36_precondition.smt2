...
(assert (and (= o61 (remove (mk___t values2 (mk 1 100)) o60)) (and (dynamic_invariant4 o61 true false true) (and (= (invariant__ o61) true) (and (= (to_rep1 (last (rt o61))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o60 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o61) k))))) (and (forall ((k Int)) (=> (and (<= (+ o60 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o61) (- k 1)))))) (forall ((k Int)) (=> (and (<= o60 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o61) k))))))))))))
(assert (and (= temp___262 (remove o61 o62)) (and (dynamic_invariant4 temp___262 true false true) (and (= (invariant__ temp___262) true) (and (= (to_rep1 (last (rt temp___262))) (- (to_rep1 (last (rt o61))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o62 1))) (= (to_rep (select (elts o61) k)) (to_rep (select (elts temp___262) k))))) (and (forall ((k Int)) (=> (and (<= (+ o62 1) k) (<= k (to_rep1 (last (rt o61))))) (= (to_rep (select (elts o61) k)) (to_rep (select (elts temp___262) (- k 1)))))) (forall ((k Int)) (=> (and (<= o62 k) (<= k (- (to_rep1 (last (rt o61))) 1))) (= (to_rep (select (elts o61) (+ k 1))) (to_rep (select (elts temp___262) k))))))))))))
(assert (and (= o65 y) (in_range5 y)))
(assert (and (= o63 x) (in_range5 x)))
(assert (and (= o64 (remove (mk___t init (mk 1 100)) o63)) (and (dynamic_invariant4 o64 true false true) (and (= (invariant__ o64) true) (and (= (to_rep1 (last (rt o64))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o63 1))) (= (to_rep (select init k)) (to_rep (select (elts o64) k))))) (and (forall ((k Int)) (=> (and (<= (+ o63 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o64) (- k 1)))))) (forall ((k Int)) (=> (and (<= o63 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o64) k))))))))))))
(assert (not (= (invariant__ o64) true)))
(check-sat)
(exit)
