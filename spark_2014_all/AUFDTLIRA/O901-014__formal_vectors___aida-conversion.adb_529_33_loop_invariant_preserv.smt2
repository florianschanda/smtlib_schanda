...
(assert (and (and (= (length source) 10) (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55))) (forall ((index4 Int)) (=> (and (<= (to_rep1 (first (rt source))) index4) (<= index4 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index4))) true)))))
...
(assert (= n1 result3))
(assert (= n2 o8))
(assert (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt source))) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9)))))
(assert (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j))))))
(assert (and (and (forall ((temp___1540 Int)) (=> (and (<= (to_rep1 n__first) temp___1540) (<= temp___1540 (to_rep1 n__last))) (=> (or (< temp___1537 temp___1540) (or (< temp___1540 (to_rep1 (first (rt source)))) (< index2 temp___1540))) (= (select n3 temp___1540) (select n1 temp___1540))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9)))))
(assert (not (= index2 temp___1537)))
...
(assert (= n4 o17))
(declare-const j Int)
(assert (<= (to_rep1 (first (rt source))) j))
(assert (<= j index3))
