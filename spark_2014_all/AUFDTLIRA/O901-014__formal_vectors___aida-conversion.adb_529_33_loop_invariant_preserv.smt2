...
(assert (and (and (forall ((temp___1538 Int)) (=> (and (<= (to_rep1 n__first) temp___1538) (<= temp___1538 (to_rep1 n__last))) (=> (< index2 temp___1538) (= (select n3 temp___1538) (select n1 temp___1538))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9)))))
(assert (not (= index2 temp___1541)))
