...
(assert (and (= (mk___t o33 o34) (remove a o32)) (and (dynamic_invariant2 (mk___t o33 o34) true false true) (and (= (invariant__ (mk___t o33 o34)) true) (and (= (to_rep2 (last o34)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- o32 1))) (= (to_rep (select (elts a) k1)) (to_rep (select o33 k1))))) (and (forall ((k1 Int)) (=> (and (<= (+ o32 1) k1) (<= k1 (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k1)) (to_rep (select o33 (- k1 1)))))) (forall ((k1 Int)) (=> (and (<= o32 k1) (<= k1 (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k1 1))) (to_rep (select o33 k1))))))))))))
