...
(assert (<= temp___251 i8))
(assert (<= i8 100))
(assert (and (forall ((temp___250 Int)) (=> (and (<= 0 temp___250) (<= temp___250 100)) (=> (<= i9 temp___250) (= (select a18 temp___250) (select a16 temp___250))))) (and (<= (+ k 1) i9) (<= i9 100))))
(assert (and (= temp___248 (- i9 k)) (in_range1 (- i9 k))))
(assert (and (<= 0 temp___248) (<= temp___248 100)))
(assert (= o6 temp___248))
