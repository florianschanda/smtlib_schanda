...
(assert (<= temp___228 i12))
(assert (<= i12 100))
(assert (and (forall ((temp___227 Int)) (=> (and (<= 0 temp___227) (<= temp___227 100)) (=> (<= i13 temp___227) (= (select a18 temp___227) (select a16 temp___227))))) (and (<= (+ k 1) i13) (<= i13 100))))
(assert (and (= temp___225 (- i13 k)) (in_range1 (- i13 k))))
(assert (and (<= 0 temp___225) (<= temp___225 100)))
(assert (= o12 temp___225))
(assert (= o13 (select c1 o12)))
