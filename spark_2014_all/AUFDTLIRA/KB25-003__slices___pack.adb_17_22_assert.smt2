...
(declare-fun temp___404 (Int) (Array Int integer))
(declare-fun temp___410 (Int) (Array Int integer))
(declare-fun temp___416 (Int) (Array Int integer))
...
(assert (forall ((temp___158 Int)) (=> (dynamic_invariant temp___158 true true true true) (forall ((temp___159 Int)) (= (to_rep1 (select (pack__a1__my_a__aggregate_def temp___158) temp___159)) temp___158)))))
(assert (= my_b (let ((temp___161 4)) (let ((temp___160 1)) my_a))))
(assert (forall ((temp___406 Int)) (=> (dynamic_invariant temp___406 true true true true) (forall ((temp___407 Int)) (= (to_rep1 (select (temp___404 temp___406) temp___407)) temp___406)))))
(assert (forall ((temp___412 Int)) (=> (dynamic_invariant temp___412 true true true true) (forall ((temp___413 Int)) (= (to_rep1 (select (temp___410 temp___412) temp___413)) temp___412)))))
(assert (forall ((temp___418 Int)) (=> (dynamic_invariant temp___418 true true true true) (forall ((temp___419 Int)) (= (to_rep1 (select (temp___416 temp___418) temp___419)) temp___418)))))
...
(assert (and (<= (to_rep1 glob__first) 1) (<= 1 (to_rep1 glob__last))))
(assert (= o 1))
(assert (= o1 (select glob o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (pack__a1__my_s1__aggregate_def o2)))
(assert (= result my_s1))
(assert (= my_s11 o3))
(assert (= (pack__a1__my_a__aggregate_def 42) my_a))
(assert (=> (<= 1 4) (and (and (<= 1 1) (<= 1 4)) (and (<= 1 4) (<= 4 4)))))
(assert (= pack__a1__my_b__assume my_a))
(assert (= pack__a1__my_b__assume my_b))
(assert (= (bool_eq2 my_a 1 4 (temp___404 42) 1 4) true))
(assert (not (= (bool_eq2 my_b 1 4 (temp___410 42) 1 4) true)))
(check-sat)
(exit)
