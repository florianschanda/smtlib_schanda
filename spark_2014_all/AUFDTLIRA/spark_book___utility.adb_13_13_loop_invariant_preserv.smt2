...
(assert (exists ((index4 Int)) (and (and (<= 0 index4) (<= index4 1023)) (= (to_rep (select values index4)) 0))))
...
(assert (exists ((j Int)) (and (and (<= (+ index2 1) j) (<= j 1023)) (= (to_rep (select values j)) 0))))
...
(assert (= utility__search_for_zero__result4 utility__search_for_zero__result3))
(assert (not (exists ((j Int)) (and (and (<= (+ index3 1) j) (<= j 1023)) (= (to_rep (select values j)) 0)))))
(check-sat)
(exit)
