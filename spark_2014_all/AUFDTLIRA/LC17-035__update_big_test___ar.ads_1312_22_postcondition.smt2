...
(declare-fun temp___2953 ((Array Int us_rep1) Int us_rep1) (Array Int us_rep1))
...
(assert (forall ((temp___2955 (Array Int us_rep1))) (forall ((temp___2956 Int)) (forall ((temp___2957 us_rep1)) (let ((temp___2954 (temp___2953 temp___2955 temp___2956 temp___2957))) (=> (dynamic_invariant temp___2956 true true true true) (forall ((temp___2958 Int)) (ite (= temp___2958 temp___2956) (= (select temp___2954 temp___2958) temp___2957) (= (select temp___2954 temp___2958) (select temp___2955 temp___2958))))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq2 a2 5 50 (temp___2953 a i (mk___rep1 (let ((usq_ (us_split_fields3 (select a i)))) (mk___split_fields1 (rec__ar__rec2t__f2 usq_) (mk___rep (mk___split_fields (of_rep f) (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (select a i))))))) (rec__ar__rec2t__h2 usq_))))) 5 50) true)))
(check-sat)
(exit)
