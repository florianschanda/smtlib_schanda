...
(define-fun dynamic_invariant2 ((temp___expr_158 us_t) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (not (= temp___skip_constant_156 true)) (and (dynamic_property1 1 b_max (first1 temp___expr_158) (last1 temp___expr_158)) (and (= (first1 temp___expr_158) 1) (= (last1 temp___expr_158) b_max)))))
...
(define-fun dynamic_invariant3 ((temp___expr_167 us_t1) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool)) Bool (=> (not (= temp___skip_constant_165 true)) (and (dynamic_property3 1 b_max (first3 temp___expr_167) (last3 temp___expr_167)) (and (= (first3 temp___expr_167) 1) (= (last3 temp___expr_167) b_max)))))
...
(define-fun dynamic_invariant4 ((temp___expr_176 us_t2) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (=> (not (= temp___skip_constant_174 true)) (and (dynamic_property5 1 b_max (first5 temp___expr_176) (last5 temp___expr_176)) (and (= (first5 temp___expr_176) 1) (= (last5 temp___expr_176) b_max)))))
...
(define-fun dynamic_invariant5 ((temp___expr_33 Int) (temp___is_init_30 Bool) (temp___skip_constant_31 Bool) (temp___do_toplevel_32 Bool)) Bool (=> (or (= temp___is_init_30 true) (<= 0 2147483647)) (in_range3 temp___expr_33)))
(assert (= b_max (id 100)))
