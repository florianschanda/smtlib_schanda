...
(assert (= perm__get_witnesses__result15 perm__get_witnesses__result9))
(assert (= ia12 ia6))
(assert (= perm__get_witnesses__result16 perm__get_witnesses__result10))
(assert (= ia13 ia7))
...
(assert (or (and (and (and (= perm__get_witnesses__result9 (mk_witnesses__ref perm__get_witnesses__result4)) (= ia6 (mk_int__ref ia1))) (and (= perm__get_witnesses__result10 perm__get_witnesses__result4) (= ia7 ia1))) (and (= (= result4 true) (exists ((ib2 Int)) (and (and (<= (to_rep2 (first (rt b))) ib2) (<= ib2 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib2))) (= (is_perm (remove a ia1) (remove b ib2)) true))))) (and (= result4 true) (and (and (and (and (and (and (= o13 ia1) (in_range2 ia1)) (and (= o14 (get_witness a b o13)) (and (in_range2 o14) (and (and (<= (to_rep2 (first (rt b))) o14) (<= o14 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) o13)) (to_rep (select (elts b) o14))) (= (is_perm (remove a o13) (remove b o14)) true)))))) (= (to_rep1 o15) o14)) (and (and (and (= o12 ia1) (in_range2 ia1)) (= (to_rep1 o16) o12)) (and (= o16 o17) (= o15 o18)))) (and (= o19 o17) (= o20 o18))) (and (= result6 (mk_witnesses__ref (mk___rep (mk___split_fields perm__get_witnesses__result perm__get_witnesses__result1)))) (= perm__get_witnesses__result4 (mk___rep (mk___split_fields o19 o20)))))))) (and (and (= (= result4 true) (exists ((ib2 Int)) (and (and (<= (to_rep2 (first (rt b))) ib2) (<= ib2 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib2))) (= (is_perm (remove a ia1) (remove b ib2)) true))))) (and (not (= result4 true)) (and (= perm__get_witnesses__result4 (mk___rep (mk___split_fields perm__get_witnesses__result perm__get_witnesses__result1))) (= perm__get_witnesses__result4 (mk___rep (mk___split_fields perm__get_witnesses__result2 perm__get_witnesses__result3)))))) (and (and (and (= perm__get_witnesses__result9 (mk_witnesses__ref perm__get_witnesses__result6)) (= ia6 (mk_int__ref ia3))) (and (= perm__get_witnesses__result10 perm__get_witnesses__result6) (= ia7 ia3))) (and (forall ((ka1 Int)) (=> (and (<= 1 ka1) (<= ka1 ia2)) (forall ((kb1 Int)) (=> (and (<= (to_rep2 (first (rt b))) kb1) (<= kb1 (to_rep2 (last (rt b))))) (not (and (= (to_rep (select (elts a) ka1)) (to_rep (select (elts b) kb1))) (= (is_perm (remove a ka1) (remove b kb1)) true))))))) (and (and (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia2)) (and (<= (to_rep2 (first (rt a))) ia2) (<= ia2 (to_rep2 (last (rt a)))))) (and (not (= ia2 temp___588)) (and (and (= result8 (mk_int__ref ia2)) (= ia3 (+ ia2 1))) (and (= (= result9 true) (exists ((ib2 Int)) (and (and (<= (to_rep2 (first (rt b))) ib2) (<= ib2 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia3)) (to_rep (select (elts b) ib2))) (= (is_perm (remove a ia3) (remove b ib2)) true))))) (and (= result9 true) (and (and (and (and (and (and (= o46 ia3) (in_range2 ia3)) (and (= o47 (get_witness a b o46)) (and (in_range2 o47) (and (and (<= (to_rep2 (first (rt b))) o47) (<= o47 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) o46)) (to_rep (select (elts b) o47))) (= (is_perm (remove a o46) (remove b o47)) true)))))) (= (to_rep1 o48) o47)) (and (and (and (= o45 ia3) (in_range2 ia3)) (= (to_rep1 o49) o45)) (and (= o49 o50) (= o48 o51)))) (and (= o52 o50) (= o53 o51))) (and (= result11 (mk_witnesses__ref perm__get_witnesses__result5)) (= perm__get_witnesses__result6 (mk___rep (mk___split_fields o52 o53)))))))))))))))
(assert (= perm__get_witnesses__result17 perm__get_witnesses__result15))
(assert (= ia14 ia12))
(assert (= perm__get_witnesses__result18 perm__get_witnesses__result16))
(assert (= ia15 ia13))
(assert (<= (to_rep2 (first (rt a))) (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result17))))))
(assert (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result17)))) (to_rep2 (last (rt a)))))
(assert (<= (to_rep2 (first (rt b))) (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result17))))))
(assert (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result17)))) (to_rep2 (last (rt b)))))
(assert (and (<= (to_rep2 (first (rt b))) (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result17))))) (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result17)))) (to_rep2 (last (rt b))))))
(assert (= o60 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result17))))))
(assert (= o61 (select (elts b) o60)))
(assert (= o62 (to_rep o61)))
(assert (and (<= (to_rep2 (first (rt a))) (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result17))))) (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result17)))) (to_rep2 (last (rt a))))))
(assert (= o58 (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result17))))))
(assert (= o59 (select (elts a) o58)))
(assert (= o63 (to_rep o59)))
(assert (= result12 (ite (= o63 o62) true false)))
(assert (= result12 true))
(assert (and (= (mk___t o56 o57) (remove b (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result17)))))) (and (dynamic_invariant (mk___t o56 o57) true false true) (and (= (invariant__ (mk___t o56 o57)) true) (and (= (to_rep2 (last o57)) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result17)))) 1))) (= (to_rep (select (elts b) k)) (to_rep (select o56 k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result17)))) 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o56 (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result17)))) k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o56 k))))))))))))
(assert (and (= (mk___t o54 o55) (remove a (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result17)))))) (and (dynamic_invariant (mk___t o54 o55) true false true) (and (= (invariant__ (mk___t o54 o55)) true) (and (= (to_rep2 (last o55)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result17)))) 1))) (= (to_rep (select (elts a) k)) (to_rep (select o54 k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result17)))) 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o54 (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result17)))) k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o54 k))))))))))))
(assert (not (= (invariant__ (mk___t o54 o55)) true)))
(check-sat)
(exit)
