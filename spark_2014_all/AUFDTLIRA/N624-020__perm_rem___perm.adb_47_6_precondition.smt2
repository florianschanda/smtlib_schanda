...
(assert (= ia7 ia5))
(assert (= temp___651 (to_rep2 (first (rt a)))))
(assert (= temp___652 (to_rep2 (last (rt a)))))
(assert (= (mk_int__ref result) (mk_int__ref ia)))
(assert (= ia1 temp___651))
(assert (<= temp___651 ia1))
(assert (<= ia1 temp___652))
(assert (= temp___650 ia1))
(assert (or (and (and (and (= perm__get_witnesses__result7 (mk_witnesses__ref perm__get_witnesses__result4)) (= ia4 (mk_int__ref ia1))) (and (= perm__get_witnesses__result8 perm__get_witnesses__result4) (= ia5 ia1))) (and (= (= result1 true) (exists ((ib Int)) (and (and (<= (to_rep2 (first (rt b))) ib) (<= ib (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib))) (= (is_perm (remove a ia1) (remove b ib)) true))))) (and (= result1 true) (and (and (and (and (and (and (= o1 ia1) (in_range2 ia1)) (and (= o2 (get_witness a b o1)) (and (in_range2 o2) (and (and (<= (to_rep2 (first (rt b))) o2) (<= o2 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) o1)) (to_rep (select (elts b) o2))) (= (is_perm (remove a o1) (remove b o2)) true)))))) (= (to_rep1 o3) o2)) (and (and (and (= o ia1) (in_range2 ia1)) (= (to_rep1 o4) o)) (and (= o4 o5) (= o3 o6)))) (and (= o7 o5) (= o8 o6))) (and (= result2 (mk_witnesses__ref (mk___rep (mk___split_fields perm__get_witnesses__result perm__get_witnesses__result1)))) (= perm__get_witnesses__result4 (mk___rep (mk___split_fields o7 o8)))))))) (and (and (= (= result1 true) (exists ((ib Int)) (and (and (<= (to_rep2 (first (rt b))) ib) (<= ib (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib))) (= (is_perm (remove a ia1) (remove b ib)) true))))) (and (not (= result1 true)) (and (= perm__get_witnesses__result4 (mk___rep (mk___split_fields perm__get_witnesses__result perm__get_witnesses__result1))) (= perm__get_witnesses__result4 (mk___rep (mk___split_fields perm__get_witnesses__result2 perm__get_witnesses__result3)))))) (and (and (and (= perm__get_witnesses__result7 (mk_witnesses__ref perm__get_witnesses__result6)) (= ia4 (mk_int__ref ia3))) (and (= perm__get_witnesses__result8 perm__get_witnesses__result6) (= ia5 ia3))) (and (forall ((ka Int)) (=> (and (<= 1 ka) (<= ka ia2)) (forall ((kb Int)) (=> (and (<= (to_rep2 (first (rt b))) kb) (<= kb (to_rep2 (last (rt b))))) (not (and (= (to_rep (select (elts a) ka)) (to_rep (select (elts b) kb))) (= (is_perm (remove a ka) (remove b kb)) true))))))) (and (and (=> (<= (to_rep2 (first (rt a))) (to_rep2 (last (rt a)))) (dynamic_property1 (to_rep2 (first (rt a))) (to_rep2 (last (rt a))) ia2)) (and (<= (to_rep2 (first (rt a))) ia2) (<= ia2 (to_rep2 (last (rt a)))))) (and (not (= ia2 temp___652)) (and (and (= result3 (mk_int__ref ia2)) (= ia3 (+ ia2 1))) (and (= (= result4 true) (exists ((ib Int)) (and (and (<= (to_rep2 (first (rt b))) ib) (<= ib (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) ia3)) (to_rep (select (elts b) ib))) (= (is_perm (remove a ia3) (remove b ib)) true))))) (and (= result4 true) (and (and (and (and (and (and (= o10 ia3) (in_range2 ia3)) (and (= o11 (get_witness a b o10)) (and (in_range2 o11) (and (and (<= (to_rep2 (first (rt b))) o11) (<= o11 (to_rep2 (last (rt b))))) (and (= (to_rep (select (elts a) o10)) (to_rep (select (elts b) o11))) (= (is_perm (remove a o10) (remove b o11)) true)))))) (= (to_rep1 o12) o11)) (and (and (and (= o9 ia3) (in_range2 ia3)) (= (to_rep1 o13) o9)) (and (= o13 o14) (= o12 o15)))) (and (= o16 o14) (= o17 o15))) (and (= result5 (mk_witnesses__ref perm__get_witnesses__result5)) (= perm__get_witnesses__result6 (mk___rep (mk___split_fields o16 o17)))))))))))))))
...
(assert (= ia9 ia7))
(assert (<= (to_rep2 (first (rt a))) (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result11))))))
(assert (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) (to_rep2 (last (rt a)))))
(assert (<= (to_rep2 (first (rt b))) (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11))))))
(assert (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) (to_rep2 (last (rt b)))))
(assert (and (<= (to_rep2 (first (rt b))) (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11))))) (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) (to_rep2 (last (rt b))))))
(assert (= o24 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11))))))
(assert (= o25 (select (elts b) o24)))
(assert (= o26 (to_rep o25)))
(assert (and (<= (to_rep2 (first (rt a))) (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result11))))) (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) (to_rep2 (last (rt a))))))
(assert (= o22 (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result11))))))
(assert (= o23 (select (elts a) o22)))
(assert (= o27 (to_rep o23)))
(assert (= result6 (ite (= o27 o26) true false)))
(assert (= result6 true))
(assert (and (= o28 (remove b (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))))) (and (dynamic_invariant o28 true false true true) (and (= (invariant__ o28) true) (and (= (to_rep2 (last o21)) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) 1))) (= (to_rep (select (elts b) k)) (to_rep (select o20 k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o20 (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o20 k))))))))))))
(assert (and (= o29 (remove a (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))))) (and (dynamic_invariant o29 true false true true) (and (= (invariant__ o29) true) (and (= (to_rep2 (last o19)) (- (to_rep2 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) 1))) (= (to_rep (select (elts a) k)) (to_rep (select o18 k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) 1) k) (<= k (to_rep2 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o18 (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ia (us_split_fields1 (witnesses__content perm__get_witnesses__result11)))) k) (<= k (- (to_rep2 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o18 k))))))))))))
