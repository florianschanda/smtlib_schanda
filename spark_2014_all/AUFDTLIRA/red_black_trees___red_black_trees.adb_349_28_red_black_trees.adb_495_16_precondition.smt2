...
(assert (=> (= result9 true) (dynamic_invariant6 c101b true false true)))
...
(assert (= temp___667 (mk___rep4 o32)))
(assert (= result13 t__split_fields9))
(assert (= t__split_fields11 (us_split_fields9 temp___667)))
...
(assert (= temp___671 (mk___rep4 o39)))
(assert (= result14 (mk___split_fields__ref4 t__split_fields11)))
(assert (= t__split_fields12 (us_split_fields9 temp___671)))
...
(assert (and (= temp___695 (nb_blacks c106b)) (and (= (bool_eq11 (select temp___695 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___695 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___695 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___695 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c106b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___695 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))))))))))))
...
(assert (= o51 (select temp___695 o50)))
...
(assert (and (= temp___694 (nb_blacks c107b)) (and (= (bool_eq11 (select temp___694 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c107b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___694 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___694 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___694 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___694 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___694 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___694 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___694 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___694 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___694 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c107b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___694 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))))))))
...
(assert (= o60 (select temp___694 o59)))
(assert (= o61 (us_split_fields11 o60)))
(assert (= o62 (rec__red_black_trees__black_count__count o61)))
(assert (= o63 (to_rep o62)))
(assert (and (= temp___693 (nb_blacks c107b)) (and (= (bool_eq11 (select temp___693 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c107b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___693 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___693 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___693 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c107b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___693 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))))))))
...
(assert (= o56 (select temp___693 o55)))
