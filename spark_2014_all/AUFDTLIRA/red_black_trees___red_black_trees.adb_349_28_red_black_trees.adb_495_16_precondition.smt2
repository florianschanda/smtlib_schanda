...
(declare-const temp___746 (Array Int us_rep7))
...
(declare-const temp___745 (Array Int us_rep7))
...
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c106b) i)))) (let ((subject n1)) n12))) (not (= i y3))) (not (= i c108b))) (= (eq (select (nb_blacks c107b) i) (select (nb_blacks c106b) i)) true)))))
...
(assert (and (= temp___746 (nb_blacks c106b)) (and (= (bool_eq11 (select temp___746 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c106b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___746 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___746 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___746 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___746 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___746 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___746 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___746 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___746 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___746 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c106b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___746 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c106b)) i 0))))))))))))))
(assert (and (= o50 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) y3)) (and (in_range2 o50) (and (= o50 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)))) y3)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c107b))) 0) (= o50 0))))))
(assert (= o51 (select temp___746 o50)))
...
(assert (and (= temp___745 (nb_blacks c107b)) (and (= (bool_eq11 (select temp___745 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c107b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___745 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___745 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___745 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___745 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___745 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___745 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___745 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___745 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___745 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c107b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___745 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))))))))
(assert (and (= o59 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) y3)) (and (in_range2 o59) (and (= o59 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)))) y3)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c107b))) 0) (= o59 0))))))
(assert (= o60 (select temp___745 o59)))
(assert (= o61 (us_split_fields11 o60)))
(assert (= o62 (rec__red_black_trees__black_count__count o61)))
(assert (= o63 (to_rep o62)))
(assert (and (= temp___744 (nb_blacks c107b)) (and (= (bool_eq11 (select temp___744 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c107b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___744 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___744 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___744 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___744 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___744 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___744 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___744 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___744 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___744 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c107b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___744 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i 0))))))))))))))
(assert (and (= o55 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) y3)) (and (in_range2 o55) (and (= o55 (parent1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)))) y3)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c107b))) 0) (= o55 0))))))
(assert (= o56 (select temp___744 o55)))
