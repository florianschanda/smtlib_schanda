...
(assert (and (= o31 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) j 0)) (and (in_range3 o31) (= o31 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) j 0)))))
(assert (= o32 (select res3 o31)))
(assert (= o33 (us_split_fields11 o32)))
(assert (= o34 (rec__red_black_trees__black_count__count o33)))
(assert (= o35 (to_rep o34)))
(assert (=> (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0) (= o36 1)))
(assert (=> (not (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 t)) j)) 0)) (= o36 0)))
(assert (= o37 (+ o36 o35)))
(assert (and (= o38 o37) (in_range1 o37)))
(assert (= o39 (ite (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select res3 j)))) o38) true false)))
...
(assert (= o30 (ite (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res3 j)))) o29) true false)))
