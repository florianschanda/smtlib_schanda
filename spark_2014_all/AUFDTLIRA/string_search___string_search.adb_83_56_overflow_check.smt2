...
(assert (and (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (and (<= 1 (to_rep (select bad_shift c))) (<= (to_rep (select bad_shift c)) (+ (length needle) 1))))) (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (ite (= (to_rep (select bad_shift c)) (+ (length needle) 1)) (forall ((k7 Int)) (=> (and (<= (to_rep2 (first (rt needle))) k7) (<= k7 (to_rep2 (last (rt needle))))) (not (= c (to_rep1 (select (elts needle) k7)))))) (and (= (to_rep1 (select (elts needle) (+ (- (length needle) (to_rep (select bad_shift c))) 1))) c) (forall ((k7 Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift c))) 2) k7) (<= k7 (to_rep2 (last (rt needle))))) (not (= (to_rep1 (select (elts needle) k7)) c))))))))))
...
(assert (forall ((k7 Int)) (=> (and (<= 1 k7) (<= k7 (- (+ i2 (to_rep (select bad_shift (to_rep1 (select (elts haystack) (+ i2 (length needle))))))) 1))) (not (= (match_at needle haystack k7) true)))))
