...
(define-fun i34 () int__ref (mk_int__ref i1))
(define-fun i35 () int__ref (mk_int__ref i))
...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i36 Int)) (=> (and (<= begidx2 i36) (<= i36 endidx1)) (and (<= 48 (to_rep (select zonefileline i36))) (<= (to_rep (select zonefileline i36)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i36 Int)) (=> (and (<= begidx5 i36) (<= i36 endidx3)) (and (<= 48 (to_rep (select zonefileline i36))) (<= (to_rep (select zonefileline i36)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (=> (<= zlength (int__content endidx6)) (= i26 i34)))
(assert (=> (<= zlength (int__content endidx6)) (= i25 i35)))
...
(assert (=> (not (<= zlength (int__content endidx6))) (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i36 Int)) (=> (and (<= begidx11 i36) (<= i36 endidx8)) (and (<= 48 (to_rep (select zonefileline i36))) (<= (to_rep (select zonefileline i36)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8)))))
...
(assert (=> (not (<= zlength (int__content endidx6))) (=> (not (= foundtype8 0)) (= i22 i34))))
(assert (=> (not (<= zlength (int__content endidx6))) (=> (not (= foundtype8 0)) (= i21 i35))))
...
(assert (=> (not (<= zlength (int__content endidx6))) (=> (not (not (= foundtype8 0))) (=> (< 128 lengthoftoken2) (= i18 i34)))))
(assert (=> (not (<= zlength (int__content endidx6))) (=> (not (not (= foundtype8 0))) (=> (< 128 lengthoftoken2) (= i17 i35)))))
...
(assert (=> (not (<= zlength (int__content endidx6))) (=> (not (not (= foundtype8 0))) (=> (not (< 128 lengthoftoken2)) (= result9 i35)))))
...
(assert (=> (not (<= zlength (int__content endidx6))) (=> (not (not (= foundtype8 0))) (=> (not (< 128 lengthoftoken2)) (= result11 i34)))))
...
(assert (= begidx14 o10))
(assert (and (and (and (and (<= begidx15 endidx11) (<= begidx15 zlength)) (<= endidx11 zlength)) (=> (= foundtype11 1) (forall ((i36 Int)) (=> (and (<= begidx15 i36) (<= i36 endidx11)) (and (<= 48 (to_rep (select zonefileline i36))) (<= (to_rep (select zonefileline i36)) 57)))))) (and (and (in_range4 begidx15) (in_range4 endidx11)) (in_range3 foundtype11))))
...
(assert (and (=> (<= r102b r103b) (dynamic_property2 r102b r103b i30)) (and (<= r102b i30) (<= i30 r103b))))
(assert (= (to_rep o14) (to_rep (select zonefileline i30))))
(assert (and (= o12 (+ i30 1)) (in_range1 (+ i30 1))))
(assert (= o13 (- o12 begidx15)))
(assert (and (= temp___1805 o13) (in_range1 o13)))
(assert (and (<= 1 temp___1805) (<= temp___1805 128)))
(assert (= o15 temp___1805))
(assert (= o16 (store newemail2 o15 o14)))
(assert (= result16 (mk_map__ref newemail2)))
(assert (= newemail3 o16))
(assert (not (= i30 r103b)))
(assert (= result17 (mk_int__ref i30)))
(assert (= i31 (+ i30 1)))
(assert (= i32 (mk_int__ref i31)))
(assert (= newemail4 (mk_map__ref newemail3)))
(assert (= i33 i31))
(assert (= newemail5 newemail3))
(assert (not (<= (+ (- endidx11 begidx15) 1) 128)))
(check-sat)
(exit)
