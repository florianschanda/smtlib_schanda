...
(assert (= data2 data3))
(assert (= data4 data2))
(assert (=> (= (mem (rec__allocator__m__t__allocated (us_split_fields1 (model__ data))) res) true) (and (= (is_add (rec__allocator__m__t__available (us_split_fields1 (model__ data))) res (rec__allocator__m__t__available (us_split_fields1 (model__ data3)))) true) (= (is_add (rec__allocator__m__t__allocated (us_split_fields1 (model__ data3))) res (rec__allocator__m__t__allocated (us_split_fields1 (model__ data)))) true))))
(assert (not (= (mem (rec__allocator__m__t__allocated (us_split_fields1 (model__ data))) res) true)))
(assert (not (= (oeq2 (model__ data3) (model__ data)) true)))
(check-sat)
(exit)
