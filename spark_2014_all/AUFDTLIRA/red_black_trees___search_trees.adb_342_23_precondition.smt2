...
(assert (= result2 true))
(assert (and (= o9 (valid_root f v)) (=> (< (size f) v) (not (= o9 true)))))
...
(assert (= o7 (select temp___1760 v)))
...
(assert (= o3 (select temp___1752 v)))
...
(assert (= o (select temp___1751 i)))
(assert (= o1 (us_split_fields1 o)))
(assert (= o2 (rec__tree_model__path_type__a o1)))
(assert (and (= o6 (olt o2 o5)) (= (= o6 true) (and (< (length o2) (length o5)) (forall ((n Int)) (=> (and (<= 1 n) (<= n (last o2))) (= (get o2 n) (get o5 n))))))))
