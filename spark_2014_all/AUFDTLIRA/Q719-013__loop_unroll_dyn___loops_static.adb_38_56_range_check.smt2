...
(assert (= a1 o1))
(assert (and (= o2 (- i1 (to_rep1 a__first))) (in_range1 (- i1 (to_rep1 a__first)))))
(assert (= o3 (+ o2 1)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (and (= o5 o4) (in_range2 o4)))
(assert (= (mk_int__ref result2) (mk_int__ref a_length)))
(assert (= a_length1 o5))
(assert (in_range2 a_length1))
(assert (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 a_length1)) (= (to_rep (select a1 (+ (to_rep1 a__first) i3))) 0))))
(assert (= i1 result3))
(assert (= i2 2))
...
(assert (= a1 result4))
(assert (= a2 o7))
(assert (and (= o8 (- i2 (to_rep1 a__first))) (in_range1 (- i2 (to_rep1 a__first)))))
(assert (= o9 (+ o8 1)))
