...
(declare-const temp___883 (Array Int character))
(declare-const temp___8831 t1)
...
(assert (= branch 19))
(assert (= (to_rep1 (first4 (rt1 (do_checks__do_range_check__B_18__a__aggregate_def 48 zero (- zero 1))))) zero))
(assert (= (to_rep1 (last3 (rt1 (do_checks__do_range_check__B_18__a__aggregate_def 48 zero (- zero 1))))) (- zero 1)))
(assert (= (mk___t1 temp___883 temp___8831) (do_checks__do_range_check__B_18__a__aggregate_def 48 zero (- zero 1))))
(assert (not (= (ite (<= (to_rep1 (first4 temp___8831)) (to_rep1 (last3 temp___8831))) (+ (- (to_rep1 (last3 temp___8831)) (to_rep1 (first4 temp___8831))) 1) 0) (ite (<= 1 0) (+ (- 0 1) 1) 0))))
(check-sat)
(exit)
