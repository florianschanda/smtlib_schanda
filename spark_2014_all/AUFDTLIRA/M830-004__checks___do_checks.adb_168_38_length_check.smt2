...
(assert (= (mk___t1 temp___803 temp___8031) (do_checks__do_range_check__B_18__a__aggregate_def 48 zero (- zero 1))))
(assert (not (= (ite (<= (to_rep1 (first4 temp___8031)) (to_rep1 (last3 temp___8031))) (+ (- (to_rep1 (last3 temp___8031)) (to_rep1 (first4 temp___8031))) 1) 0) (ite (<= 1 0) (+ (- 0 1) 1) 0))))
(check-sat)
(exit)
