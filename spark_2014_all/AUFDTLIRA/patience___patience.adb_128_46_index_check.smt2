...
(assert (= o114 i1))
(assert (= o115 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o114)))
(assert (= o116 (to_rep1 o115)))
(assert (= o117 (ite (<= o116 (- (to_rep1 (rec__patience__state__numelts (us_split_fields__content s__split_fields20))) 1)) true false)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o111 i1))
(assert (= o112 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o111)))
(assert (= o113 (to_rep1 o112)))
(assert (= o118 (ite (<= (- 1) o113) true false)))
(assert (= result27 (ite (= o118 true) o117 false)))
(assert (=> (= result27 true) (and (<= 0 i1) (<= i1 99))))
(assert (=> (= result27 true) (= o108 i1)))
(assert (=> (= result27 true) (= o109 (select (rec__patience__state__preds (us_split_fields__content s__split_fields20)) o108))))
(assert (=> (= result27 true) (= o110 (to_rep1 o109))))
(assert (=> (= result27 true) (= result26 (ite (< o110 i1) true false))))
