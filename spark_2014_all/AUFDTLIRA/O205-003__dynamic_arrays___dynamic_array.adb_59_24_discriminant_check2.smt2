...
(declare-const temp___234 us_rep)
...
(assert (= temp___234 (mk___rep (mk___split_discrs (distinct 1 0)) o23 true)))
(assert (= (attr__constrained (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2)) true))
(assert (not (= (rec__dynamic_array__rec__b (us_split_discrs1 temp___234)) (rec__dynamic_array__rec__b (us_split_discrs1 (select (elts1 (rec__dynamic_array__holder__content1 h__split_fields3)) i2))))))
(check-sat)
(exit)
