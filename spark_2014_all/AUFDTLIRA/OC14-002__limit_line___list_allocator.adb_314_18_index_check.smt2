...
(assert (<= 1 r2))
(assert (<= r2 3))
(assert (=> (< 1 r2) (= (to_rep o10) (- r2 1))))
(assert (=> (< 1 r2) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data1 r2))) o11)))
(assert (=> (< 1 r2) (= o10 o12)))
(assert (=> (< 1 r2) (= (rec__list_allocator__cell__next (us_split_fields1 (select data1 r2))) o13)))
(assert (=> (< 1 r2) (= o14 o11)))
(assert (=> (< 1 r2) (= o15 o12)))
(assert (=> (< 1 r2) (= o16 o13)))
(assert (=> (< 1 r2) (= o17 (store data1 r2 (mk___rep (mk___split_fields o14 o15 o16))))))
(assert (=> (< 1 r2) (= result4 (mk_map__ref data1))))
(assert (=> (< 1 r2) (= data2 o17)))
(assert (=> (not (< 1 r2)) (= data2 data1)))
(assert (=> (< r2 3) (and (= o18 (+ r2 1)) (in_range2 (+ r2 1)))))
(assert (=> (< r2 3) (= (to_rep o19) o18)))
(assert (=> (< r2 3) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data2 r2))) o20)))
(assert (=> (< r2 3) (= (rec__list_allocator__cell__prev (us_split_fields1 (select data2 r2))) o21)))
(assert (=> (< r2 3) (= o19 o22)))
(assert (=> (< r2 3) (= o23 o20)))
(assert (=> (< r2 3) (= o24 o21)))
(assert (=> (< r2 3) (= o25 o22)))
(assert (=> (< r2 3) (= o26 (store data2 r2 (mk___rep (mk___split_fields o23 o24 o25))))))
(assert (=> (< r2 3) (= result5 (mk_map__ref data2))))
(assert (=> (< r2 3) (= data3 o26)))
(assert (=> (not (< r2 3)) (= data3 data2)))
(assert (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 r3)) (= (to_rep (rec__list_allocator__cell__prev (us_split_fields1 (select data4 rr3)))) (ite (= rr3 1) 0 (- rr3 1))))))
(assert (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 r3)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data4 rr3)))) (ite (= rr3 3) 0 (+ rr3 1))))))
(assert (forall ((rr3 Int)) (=> (and (<= 1 rr3) (<= rr3 3)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data4 rr3)))) 0))))
(assert (and (and (forall ((temp___358 Int)) (=> (and (<= 1 temp___358) (<= temp___358 3)) (ite (< r3 temp___358) (= (select data4 temp___358) (select data1 temp___358)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data4 temp___358))) (rec__list_allocator__cell__stat (us_split_fields1 (select data1 temp___358))))))) (=> (<= 1 3) (in_range3 r3))) (and (<= 1 r3) (<= r3 3))))
(assert (<= 1 rr))
(assert (<= rr r3))
(assert (=> (= rr 1) (= o27 0)))
