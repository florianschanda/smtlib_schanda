...
(assert (and (and (forall ((temp___358 Int)) (=> (and (<= 1 temp___358) (<= temp___358 3)) (ite (< r2 temp___358) (= (select data4 temp___358) (select data1 temp___358)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data4 temp___358))) (rec__list_allocator__cell__stat (us_split_fields1 (select data1 temp___358))))))) (=> (<= 1 3) (in_range3 r2))) (and (<= 1 r2) (<= r2 3))))
(assert (<= 1 rr))
(assert (<= rr r2))
(assert (=> (= rr 1) (= o27 0)))
