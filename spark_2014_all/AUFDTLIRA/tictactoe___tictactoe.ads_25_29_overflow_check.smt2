...
(assert (in_range1 y))
(assert (<= 3 x))
(assert (=> (<= 3 y) (and (= o18 (one_free_slot 3 3 my_board)) (and (in_range o18) (= o18 (ite (= (to_rep (select (select my_board 3) 3)) 0) 1 0))))))
(assert (=> (not (<= 3 y)) (= o18 0)))
(assert (=> (<= 2 y) (and (= o15 (one_free_slot 3 2 my_board)) (and (in_range o15) (= o15 (ite (= (to_rep (select (select my_board 3) 2)) 0) 1 0))))))
(assert (=> (not (<= 2 y)) (= o15 0)))
(assert (and (= o16 (one_free_slot 3 1 my_board)) (and (in_range o16) (= o16 (ite (= (to_rep (select (select my_board 3) 1)) 0) 1 0)))))
(assert (= o17 (+ o16 o15)))
(assert (not (in_range o17)))
(check-sat)
(exit)
