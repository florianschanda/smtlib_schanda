...
(declare-const names__is_domain_name__result21 bool__ref)
...
(declare-const names__is_domain_name__result23 Bool)
...
(declare-const names__is_domain_name__result29 bool__ref)
(declare-const names__is_domain_name__result30 Bool)
...
(declare-const label_length21 int__ref)
(declare-const ch16 int__ref)
(declare-const i18 int__ref)
(declare-const names__is_domain_name__result40 bool__ref)
(declare-const state20 Int)
(declare-const label_length22 Int)
(declare-const ch17 Int)
(declare-const i19 Int)
(declare-const names__is_domain_name__result41 Bool)
(declare-const state21 int__ref)
(declare-const label_length23 int__ref)
(declare-const ch18 int__ref)
(declare-const i20 int__ref)
(declare-const names__is_domain_name__result42 bool__ref)
(declare-const state22 Int)
(declare-const label_length24 Int)
(declare-const ch19 Int)
(declare-const i21 Int)
(declare-const names__is_domain_name__result43 Bool)
...
(assert (not (< (length name) 1)))
(assert (not (< 255 (length name))))
(assert (= (mk_int__ref result3) (mk_int__ref i)))
(assert (= i3 (to_rep1 (first (rt name)))))
(assert (<= (to_rep1 (first (rt name))) i3))
(assert (<= i3 (to_rep1 (last (rt name)))))
(assert (< label_length2 (+ (- i4 (to_rep1 (first (rt name)))) 1)))
(assert (and (and (and (and (=> (<= (to_rep1 (first (rt name))) (to_rep1 (last (rt name)))) (dynamic_property1 (to_rep1 (first (rt name))) (to_rep1 (last (rt name))) i4)) (=> (<= 0 2) (in_range5 state2))) (=> (<= 0 255) (in_range6 label_length2))) (=> (<= 0 255) (in_range3 ch2))) (and (<= (to_rep1 (first (rt name))) i4) (<= i4 (to_rep1 (last (rt name)))))))
(assert (= ch2 result4))
(assert (= ch3 (to_rep (select (elts name) i4))))
(assert (in_range4 ch3))
(assert (= names__is_domain_name__result4 names__is_domain_name__result3))
(assert (=> (= state2 0) (= o3 (is_letter ch3))))
(assert (=> (= state2 0) (= result6 (ite (not (= o3 true)) true false))))
(assert (=> (= state2 0) (not (= result6 true))))
(assert (=> (= state2 0) (= state2 result8)))
(assert (=> (= state2 0) (= state3 1)))
(assert (=> (= state2 0) (and (= o4 (+ label_length2 1)) (in_range6 (+ label_length2 1)))))
(assert (=> (= state2 0) (= label_length2 result9)))
(assert (=> (= state2 0) (= label_length3 o4)))
(assert (=> (= state2 0) (= names__is_domain_name__result5 names__is_domain_name__result4)))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (= ch3 46) (not (< 63 label_length2))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (= ch3 46) (= names__is_domain_name__result6 names__is_domain_name__result4)))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (= ch3 46) (= state2 result11)))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (= ch3 46) (= state4 0)))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (= ch3 46) (= label_length2 result12)))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (= ch3 46) (= label_length4 0)))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (= ch3 45) (= state2 result13))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (= ch3 45) (= state5 2))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (= ch3 45) (and (= o5 (+ label_length2 1)) (in_range6 (+ label_length2 1))))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (= ch3 45) (= label_length2 result14))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (= ch3 45) (= label_length5 o5))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (= ch3 45) (= names__is_domain_name__result7 names__is_domain_name__result4))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (not (= ch3 45)) (= o6 (is_digit ch3)))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (not (= ch3 45)) (= o7 (is_letter ch3)))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (not (= ch3 45)) (= o8 (ite (= o7 false) o6 true)))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (not (= ch3 45)) (= result15 (ite (not (= o8 true)) true false)))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (not (= ch3 45)) (not (= result15 true)))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (not (= ch3 45)) (and (= o9 (+ label_length2 1)) (in_range6 (+ label_length2 1))))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (not (= ch3 45)) (= label_length2 result17))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (not (= ch3 45)) (= label_length6 o9))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (not (= ch3 45)) (= names__is_domain_name__result7 names__is_domain_name__result4))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (not (= ch3 45)) (= label_length5 label_length6))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (=> (not (= ch3 45)) (= state5 state2))))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (= names__is_domain_name__result6 names__is_domain_name__result7)))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (= label_length4 label_length5)))))
(assert (=> (not (= state2 0)) (=> (= state2 1) (=> (not (= ch3 46)) (= state4 state5)))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (= ch3 45) (and (= o10 (+ label_length2 1)) (in_range6 (+ label_length2 1)))))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (= ch3 45) (= result18 (mk_int__ref label_length2))))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (= ch3 45) (= label_length7 o10)))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (= ch3 45) (= names__is_domain_name__result10 names__is_domain_name__result4)))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (= ch3 45) (= state6 state2)))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (not (= ch3 45)) (= o11 (is_digit ch3))))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (not (= ch3 45)) (= o12 (is_letter ch3))))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (not (= ch3 45)) (= o13 (ite (= o12 false) o11 true))))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (not (= ch3 45)) (= result19 (ite (not (= o13 true)) true false))))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (not (= ch3 45)) (not (= result19 true))))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (not (= ch3 45)) (= result21 (mk_int__ref state2))))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (not (= ch3 45)) (= state6 1)))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (not (= ch3 45)) (and (= o14 (+ label_length2 1)) (in_range6 (+ label_length2 1)))))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (not (= ch3 45)) (= result22 (mk_int__ref label_length2))))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (not (= ch3 45)) (= label_length8 o14)))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (not (= ch3 45)) (= names__is_domain_name__result10 names__is_domain_name__result4)))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (=> (not (= ch3 45)) (= label_length7 label_length8)))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (= names__is_domain_name__result6 names__is_domain_name__result10))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (= label_length4 label_length7))))
(assert (=> (not (= state2 0)) (=> (not (= state2 1)) (= state4 state6))))
(assert (=> (not (= state2 0)) (= names__is_domain_name__result5 names__is_domain_name__result6)))
(assert (=> (not (= state2 0)) (= label_length3 label_length4)))
(assert (=> (not (= state2 0)) (= state3 state4)))
(assert (not (= i4 (to_rep1 (last (rt name))))))
(assert (= result23 (mk_int__ref i4)))
(assert (= i5 (+ i4 1)))
(assert (not (< label_length3 (+ (- i5 (to_rep1 (first (rt name)))) 1))))
(check-sat)
(exit)
