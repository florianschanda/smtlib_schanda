...
(assert (= a4 result4))
(assert (= a5 o5))
(assert (and (= o6 (- (to_rep (select a5 5)) (to_rep (select a5 4)))) (in_range (- (to_rep (select a5 5)) (to_rep (select a5 4))))))
(assert (= (to_rep o7) o6))
...
(assert (and (= o9 (- (to_rep (select b 2)) (to_rep (select a9 2)))) (in_range (- (to_rep (select b 2)) (to_rep (select a9 2))))))
...
(assert (and (= o12 (- (to_rep (select a11 3)) (to_rep (select b 6)))) (in_range (- (to_rep (select a11 3)) (to_rep (select b 6))))))
(assert (= (to_rep o13) o12))
(assert (= o14 (store a11 3 o13)))
(assert (= result11 a11))
(assert (= a12 o14))
(assert (= result12 a12))
(assert (= a13 (store a12 8 rliteral)))
(assert (= a13 a14))
(assert (= a15 a13))
(assert (not (= (to_rep (select a14 1)) 0)))
(check-sat)
(exit)
