...
(define-fun tint_arrayD1__ref___projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(define-fun tnumber_array_typeD1__ref___projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t37b__ref (mk_t37b__ref (t37b__content us_t4)))))
(define-fun t37b__ref___projection ((a t37b__ref)) us_t4 (t37b__content a))
...
(define-fun tint_arrayB__ref___projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___1158 Int) (temp___1159 Int) (temp___1160 Int) (temp___1161 Int) (temp___1162 Int) (temp___1163 Int) (temp___1164 Int) (temp___1165 Int) (temp___1166 Int) (temp___1167 Int) (temp___1168 Int) (temp___1169 Int)) (let ((temp___1157 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__aggregate_def temp___1158 temp___1159 temp___1160 temp___1161 temp___1162 temp___1163 temp___1164 temp___1165 temp___1166 temp___1167 temp___1168 temp___1169))) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1168 temp___1169) (and (= (first5 temp___1157) temp___1168) (= (last5 temp___1157) temp___1169))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1157) (+ (first1 source) 0)) (of_rep1 temp___1158)) (= (select (to_array2 temp___1157) (+ (first1 source) 1)) (of_rep1 temp___1159))) (= (select (to_array2 temp___1157) (+ (first1 source) 2)) (of_rep1 temp___1160))) (= (select (to_array2 temp___1157) (+ (first1 source) 3)) (of_rep1 temp___1161))) (= (select (to_array2 temp___1157) (+ (first1 source) 4)) (of_rep1 temp___1162))) (= (select (to_array2 temp___1157) (+ (first1 source) 5)) (of_rep1 temp___1163))) (= (select (to_array2 temp___1157) (+ (first1 source) 6)) (of_rep1 temp___1164))) (= (select (to_array2 temp___1157) (+ (first1 source) 7)) (of_rep1 temp___1165))) (= (select (to_array2 temp___1157) (+ (first1 source) 8)) (of_rep1 temp___1166))) (= (select (to_array2 temp___1157) (+ (first1 source) 9)) (of_rep1 temp___1167)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___1175 Int) (temp___1176 Int) (temp___1177 Int)) (let ((temp___1174 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__aggregate_def temp___1175 temp___1176 temp___1177))) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1176 temp___1177) (and (= (first9 temp___1174) temp___1176) (= (last9 temp___1174) temp___1177))) (forall ((temp___1178 Int)) (= (select (to_array4 temp___1174) temp___1178) (of_rep1 temp___1175)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_167 us_t3) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool)) Bool (=> (not (= temp___skip_constant_165 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_167) (last7 temp___expr_167)) (and (= (first7 temp___expr_167) (first1 source)) (= (last7 temp___expr_167) (+ (first1 source) 9))))))
...
(declare-const temp___1172 (Array Int integer))
(declare-const temp___11721 t2)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__assume1 t1)
(declare-const us Int)
(declare-const temp___1180 (Array Int integer))
(declare-const temp___11801 t4)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__assume1 t3)
(declare-const us1 Int)
(declare-const temp___1187 Int)
(declare-const temp___1184 (Array Int integer))
(declare-const temp___1182 Int)
...
(assert (and (and (= (length source) 10) (and (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 51)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 54)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 8))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 9))) 56))) (forall ((index11 Int)) (=> (and (<= (to_rep1 (first (rt source))) index11) (<= index11 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__aggregate_def 2 1 4 7 4 8 3 6 4 7 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__aggregate_def 2 1 4 7 4 8 3 6 4 7 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t2 temp___1172 temp___11721) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__aggregate_def 2 1 4 7 4 8 3 6 4 7 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___11721)) (to_rep1 (last4 temp___11721))) (+ (- (to_rep1 (last4 temp___11721)) (to_rep1 (first4 temp___11721))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1172 (to_rep1 (first4 temp___11721)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__assume))
(assert (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__int_array__assume1))))
...
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t4 temp___1180 temp___11801) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___11801)) (to_rep1 (last8 temp___11801))) (+ (- (to_rep1 (last8 temp___11801)) (to_rep1 (first8 temp___11801))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1180 (to_rep1 (first8 temp___11801)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__assume))
(assert (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_647__n__assume1))))
...
(assert (and (= temp___1187 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index2 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= temp___1184 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= temp___1182 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= o37 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= o38 (select n1 o37))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= o39 (to_rep1 o38))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= o39 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= o40 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= o41 (select (elts source) o40))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= o42 (to_rep o41))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o42))) (ite (= (= o42 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o42 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o42 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o42 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o42 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o42 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o42 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o42 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o42 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o42 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= (to_rep1 o43) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= o44 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= o45 (store n1 o44 o43))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= n2 o45)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3)) (forall ((temp___1185 Int)) (=> (and (<= (to_rep1 n__first) temp___1185) (<= temp___1185 (to_rep1 n__last))) (=> (< index3 temp___1185) (= (select n3 temp___1185) (select temp___1184 temp___1185)))))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= index3 temp___1187)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= index3 index5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= n3 n5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= index6 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= n6 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= index8 index6)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187)) (= n8 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187))) (= index8 index2)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1187))) (= n8 n1)))
