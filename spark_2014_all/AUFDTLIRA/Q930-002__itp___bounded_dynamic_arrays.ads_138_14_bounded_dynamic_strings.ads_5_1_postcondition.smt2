...
(declare-const temp___1162 (Array Int character))
(declare-const temp___11621 t4)
...
(declare-const temp___1165 natural_index)
(declare-const temp___11651 natural_index)
(declare-const temp___11652 (Array Int character))
(declare-const temp___11653 t1)
(declare-const temp___1166 natural_index)
(declare-const temp___11661 natural_index)
(declare-const temp___11662 (Array Int character))
(declare-const temp___11663 t1)
(declare-const o14 natural_index)
(declare-const o15 natural_index)
(declare-const o16 (Array Int character))
(declare-const o17 t1)
(declare-const temp___1168 us_rep)
(declare-const temp___1169 us_rep)
...
(define-fun temp___11654 () us_rep (mk___rep (mk___split_discrs temp___1165) (mk___split_fields temp___11651 (mk___t1 temp___11652 temp___11653))))
...
(assert (= (ite (<= (to_rep1 (first8 temp___11571)) (to_rep1 (last8 temp___11571))) (+ (- (to_rep1 (last8 temp___11571)) (to_rep1 (first8 temp___11571))) 1) 0) (ite (<= (to_rep1 (first8 temp___11601)) (to_rep1 (last8 temp___11601))) (+ (- (to_rep1 (last8 temp___11601)) (to_rep1 (first8 temp___11601))) 1) 0)))
(assert (= (mk___t4 temp___1162 temp___11621) (mk___t4 temp___1157 temp___11571)))
(assert (and (and (= (to_rep1 (first2 to____split_fields2)) (to_rep1 (first2 o10))) (= (to_rep1 (last2 to____split_fields2)) (to_rep1 (last2 o10)))) (forall ((temp___1163 Int)) (ite (and (<= 1 temp___1163) (<= temp___1163 new_length)) (= (select o9 temp___1163) (select temp___1162 temp___1163)) (= (select o9 temp___1163) (select to____split_fields1 temp___1163))))))
(assert (= to____split_fields o11))
(assert (= o12 o9))
(assert (= o13 o10))
(assert (= to____split_discrs (mk___split_discrs temp___1165)))
(assert (= temp___11651 o11))
(assert (= temp___11652 o12))
(assert (= temp___11653 o13))
(assert (dynamic_predicate temp___11654))
(assert (= (mk___rep (mk___split_discrs temp___1166) (mk___split_fields temp___11661 (mk___t1 temp___11662 temp___11663))) temp___11654))
...
(assert (= to____split_fields3 (mk___split_fields temp___11661 (mk___t1 temp___11662 temp___11663))))
(assert (= to____split_discrs (mk___split_discrs temp___1166)))
(assert (= (to_rep2 o14) new_length))
(assert (= o14 o15))
(assert (= (rec__bounded_dynamic_strings__sequence__content to____split_fields3) (mk___t1 o16 o17)))
(assert (= temp___1168 (mk___rep to____split_discrs (mk___split_fields o15 (mk___t1 o16 o17)))))
(assert (dynamic_predicate temp___1168))
(assert (= temp___1169 temp___1168))
(assert (= result1 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (us_split_fields1 temp___1169)))
(assert (= to____split_discrs (us_split_discrs1 temp___1169)))
(assert (= to____split_fields5 (mk___split_fields__ref to____split_fields4)))
(assert (= to____split_fields6 to____split_fields4))
(assert (not (= (length2 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))) (+ (length2 (mk___rep to____split_discrs (mk___split_fields to____split_fields (mk___t1 to____split_fields1 to____split_fields2)))) (length2 tail)))))
(check-sat)
(exit)
