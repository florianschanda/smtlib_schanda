...
(assert (and (= temp___789 (nb_blacks c81b)) (and (= (bool_eq11 (select temp___789 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___789 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___789 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___789 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___789 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___789 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___789 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___789 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___789 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___789 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c81b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___789 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i14 0))))))))))))))
(assert (and (= o119 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y)) (and (in_range3 o119) (and (= o119 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)))) y)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c82b))) 0) (= o119 0))))))
(assert (= o120 (select temp___789 o119)))
