...
(define-fun dynamic_invariant ((temp___expr_144 Int) (temp___is_init_141 Bool) (temp___skip_constant_142 Bool) (temp___do_toplevel_143 Bool)) Bool (=> (or (= temp___is_init_141 true) (<= 0 2)) (in_range2 temp___expr_144)))
...
(assert true)
(assert (forall ((p us_rep1)) (forall ((c Int)) (! (=> (dynamic_invariant c true true true) (= (get_plain p c) (let ((temp___188 (rec__p__painting__plain (us_split_fields3 p)))) (select temp___188 c)))) :pattern ((get_plain p c))))))
...
(assert (and (forall ((c Int)) (=> (and (<= 0 c) (<= c 2)) (=> (= (bool_eq (select p__split_fields c) d) true) (= (bool_eq (select p__split_fields3 c) d) true)))) (and (and (= p__split_fields4 p__split_fields2) (= p__split_fields5 p__split_fields3)) (= (mk___split_fields1 p__split_fields6 p__split_fields7) (mk___split_fields1 p__split_fields2 p__split_fields3)))))
(declare-const c Int)
(assert (<= 0 c))
(assert (<= c 2))
