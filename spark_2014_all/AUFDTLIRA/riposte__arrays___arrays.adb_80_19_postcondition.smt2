...
(assert (= arrays__is_id_2__result1 (ite (= (to_rep (select m c)) 97) true false)))
(assert (= (mk_bool__ref arrays__is_id_2__result4) (mk_bool__ref arrays__is_id_2__result2)))
(assert (= arrays__is_id_2__result5 arrays__is_id_2__result3))
(assert (= result1 arrays__is_id_2__result4))
(assert (= (to_rep (select m c)) c))
(assert (not (= arrays__is_id_2__result4 true)))
(check-sat)
(exit)
