...
(assert (and (= (length source) 6) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index3 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 5))) (= (is_digit (to_rep (select (elts source) index3))) true))))))
...
(assert (<= temp___2449 index1))
(assert (<= index1 temp___2450))
...
(assert (and (and (forall ((temp___2447 Int)) (=> (and (<= (to_rep1 n__first) temp___2447) (<= temp___2447 (to_rep1 n__last))) (=> (< index2 temp___2447) (= (select n3 temp___2447) (select n1 temp___2447))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 5)))))
