...
(assert (<= temp___2347 index2))
(assert (<= index2 temp___2348))
...
(assert (and (and (forall ((temp___2345 Int)) (=> (and (<= (to_rep1 n__first) temp___2345) (<= temp___2345 (to_rep1 n__last))) (=> (< index3 temp___2345) (= (select n3 temp___2345) (select n1 temp___2345))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5) index3))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 5)))))
(assert (and (= o20 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (= o21 (ite (<= o20 j) true false)))
(assert (= result6 (ite (= o21 true) (ite (<= j index3) true false) false)))
(assert (= result6 true))
