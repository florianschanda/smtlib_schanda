...
(assert (<= temp___2347 index1))
(assert (<= index1 temp___2348))
...
(assert (and (and (forall ((temp___2345 Int)) (=> (and (<= (to_rep1 n__first) temp___2345) (<= temp___2345 (to_rep1 n__last))) (=> (< index2 temp___2345) (= (select n3 temp___2345) (select n1 temp___2345))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 5)))))
