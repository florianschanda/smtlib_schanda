...
(assert (not (= (ite (<= (to_rep1 (first4 temp___19061)) (to_rep1 (last4 temp___19061))) (+ (- (to_rep1 (last4 temp___19061)) (to_rep1 (first4 temp___19061))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 7)) 1) 0))))
(check-sat)
(exit)
