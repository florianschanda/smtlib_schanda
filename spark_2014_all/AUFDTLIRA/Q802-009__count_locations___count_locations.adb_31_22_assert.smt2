...
(assert (= st1 1))
(assert (=> (and (<= 1 st1) (<= st1 100)) (= temp___175 lowest_max1)))
(assert (=> (and (<= 1 st1) (<= st1 100)) (= temp___174 st_count1)))
(assert (=> (and (<= 1 st1) (<= st1 100)) (= temp___173 st1)))
(assert (=> (and (<= 1 st1) (<= st1 100)) (= (count_selected_locations sel) (+ st_count2 (partial_count_selected_locations sel st2)))))
(assert (=> (and (<= 1 st1) (<= st1 100)) (forall ((s3 Int)) (=> (and (<= 1 s3) (<= s3 (- st2 1))) (=> (= (select sel s3) true) (<= lowest_max2 (to_rep (select max s3))))))))
(assert (=> (and (<= 1 st1) (<= st1 100)) (or (and (forall ((s3 Int)) (=> (and (<= 1 s3) (<= s3 (- st2 1))) (not (= (select sel s3) true)))) (= lowest_max2 2147483647)) (exists ((s3 Int)) (and (and (<= 1 s3) (<= s3 (- st2 1))) (and (= (select sel s3) true) (= (to_rep (select max s3)) lowest_max2)))))))
...
(assert (=> (and (<= 1 st1) (<= st1 100)) (=> (= (select sel st2) true) (and (= o6 (+ st_count2 1)) (in_range3 (+ st_count2 1))))))
(assert (=> (and (<= 1 st1) (<= st1 100)) (=> (= (select sel st2) true) (= st_count2 result5))))
(assert (=> (and (<= 1 st1) (<= st1 100)) (=> (= (select sel st2) true) (= st_count3 o6))))
(assert (=> (and (<= 1 st1) (<= st1 100)) (=> (= (select sel st2) true) (=> (< (to_rep (select max st2)) lowest_max2) (= lowest_max2 result6)))))
