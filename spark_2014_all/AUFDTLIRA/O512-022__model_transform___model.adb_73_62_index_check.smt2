...
(assert (and (= o9 t1) (in_range5 t1)))
(assert (= (mk___rep4 (mk___split_fields4 o10 o11)) (select cfv2 o9)))
(assert (and (= o12 (from__2 (mk___rep4 (mk___split_fields4 o10 o11)))) (and (in_range4 o12) (= o12 (to_rep2 o10)))))
(assert (= (mk___rep3 (mk___split_fields3 o13)) (select (map__content2 av8) o12)))
(assert (and (= o14 (name__2 (mk___rep3 (mk___split_fields3 o13)))) (and (in_range1 o14) (= o14 (to_rep o13)))))
