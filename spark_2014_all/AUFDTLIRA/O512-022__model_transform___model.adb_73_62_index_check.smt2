...
(declare-const t Int)
(declare-const temp___487 (Array Int us_rep))
(declare-const temp___488 (Array Int us_rep1))
...
(assert (=> (and (<= 0 s2) (<= s2 100)) (= o27 (select temp___473 s3))))
...
(assert (= o12 t))
(assert (= o24 (select temp___490 o12)))
(assert (and (= o15 (to__ o24)) (and (in_range2 o15) (= o15 (to_rep1 o14)))))
(assert (= o16 (select temp___489 o15)))
...
(assert (and (= temp___487 (owned_state sm)) (= temp___487 (rec__model__uml_state_machine__owned_state_data (us_split_fields5 sm)))))
(assert (and (= temp___488 (owned_transition sm)) (= temp___488 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm)))))
(assert (not (<= 0 t)))
(check-sat)
(exit)
