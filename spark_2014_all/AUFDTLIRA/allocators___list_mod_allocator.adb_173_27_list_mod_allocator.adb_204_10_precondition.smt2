...
(assert (and (= o36 (+ i3 1)) (in_range1 (+ i3 1))))
(assert (= o37 (ite (<= j2 o36) true false)))
(assert (= result5 (ite (<= 1 j2) o37 false)))
(assert (= result5 true))
(assert (and (= temp___317 (get c111b i3)) (in_range6 temp___317)))
(assert (and (<= 1 temp___317) (<= temp___317 10000)))
(assert (= o38 temp___317))
(assert (= o39 (select data2 o38)))
(assert (= o40 (us_split_fields1 o39)))
(assert (= o41 (rec__list_mod_allocator__cell__next o40)))
