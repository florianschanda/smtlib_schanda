...
(define-fun o29 () us_rep3 (mk___rep1 (mk___split_fields1 o19 o20)))
(define-fun o30 () us_rep3 (mk___rep1 (mk___split_fields1 o o1)))
(assert (in_range2 first_available))
(assert (in_range2 res))
(assert (= (is_valid data first_available) true))
(assert (and (= o30 (model__ data first_available)) (= (model_is_well_formed o30 data first_available) true)))
(assert (= o o2))
(assert (= o1 o3))
...
(assert (= ma c111b))
(assert (and (= o29 (model__ data1 first_available1)) (= (model_is_well_formed o29 data1 first_available1) true)))
...
(assert (= result4 true))
(assert (and (= temp___354 (get c111b i2)) (in_range6 temp___354)))
(assert (and (<= 1 temp___354) (<= temp___354 10000)))
(assert (= o24 temp___354))
(assert (= o25 (select data1 o24)))
(assert (= o26 (us_split_fields1 o25)))
(assert (= o27 (rec__list_mod_allocator__cell__next o26)))
