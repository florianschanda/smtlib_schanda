...
(declare-fun array_aggregates__zero_enum_map__aggregate_def (Int Int) (Array Int enum_t))
...
(assert (= zero_enum_map (array_aggregates__zero_enum_map__aggregate_def 2 0)))
(assert (forall ((temp___163 Int) (temp___164 Int)) (let ((temp___162 (array_aggregates__zero_enum_map__aggregate_def temp___163 temp___164))) (=> (and (dynamic_invariant temp___163 true true true true) (dynamic_invariant temp___164 true true true true)) (forall ((temp___165 Int)) (ite (= temp___165 2) (= (to_rep (select temp___162 temp___165)) temp___163) (= (to_rep (select temp___162 temp___165)) temp___164)))))))
(declare-const m (Array Int enum_t))
(declare-const result (Array Int enum_t))
(declare-const m1 (Array Int enum_t))
(assert (= (array_aggregates__zero_enum_map__aggregate_def 2 0) zero_enum_map))
(assert (= result m))
