...
(assert (= hr5 o30))
(assert (not (= (let ((temp___235 (remove (remove (mk___t values2 (mk 1 100)) x) (- y 1)))) (let ((temp___234 (remove (remove (mk___t init (mk 1 100)) x) (- y 1)))) (bool_eq (elts temp___234) (to_rep1 (first (rt temp___234))) (to_rep1 (last (rt temp___234))) (elts temp___235) (to_rep1 (first (rt temp___235))) (to_rep1 (last (rt temp___235)))))) true)))
(check-sat)
(exit)
