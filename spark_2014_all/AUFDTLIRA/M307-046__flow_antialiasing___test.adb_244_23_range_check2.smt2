...
(declare-sort t72b 0)
(declare-fun t72bqtint (t72b) Int)
(assert (forall ((i t72b)) (and (<= 1 (t72bqtint i)) (<= (t72bqtint i) 5))))
...
(declare-sort t74b 0)
(declare-fun t74bqtint (t74b) Int)
(assert (forall ((i t74b)) (and (<= 2 (t74bqtint i)) (<= (t74bqtint i) 3))))
