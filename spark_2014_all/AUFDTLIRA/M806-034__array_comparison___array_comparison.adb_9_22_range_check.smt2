...
(assert (forall ((temp___162 Int)) (=> (dynamic_invariant1 temp___162 true true true true) (forall ((temp___163 Int)) (= (to_rep1 (select (array_comparison__p__x__aggregate_def temp___162) temp___163)) temp___162)))))
(assert (forall ((temp___166 Int)) (=> (dynamic_invariant1 temp___166 true true true true) (forall ((temp___167 Int)) (= (to_rep1 (select (array_comparison__p__y__aggregate_def temp___166) temp___167)) temp___166)))))
(assert (forall ((temp___170 Int) (temp___171 Int) (temp___172 Int)) (let ((temp___169 (array_comparison__p__z__aggregate_def temp___170 temp___171 temp___172))) (=> (and (and (dynamic_invariant1 temp___170 true true true true) (dynamic_invariant1 temp___171 true true true true)) (dynamic_invariant1 temp___172 true true true true)) (forall ((temp___173 Int)) (ite (and (<= 7 temp___173) (<= temp___173 20)) (= (to_rep1 (select temp___169 temp___173)) temp___172) (ite (= temp___173 6) (= (to_rep1 (select temp___169 temp___173)) temp___171) (=> (and (<= 1 temp___173) (<= temp___173 5)) (= (to_rep1 (select temp___169 temp___173)) temp___170)))))))))
...
(declare-const temp___180 (Array Int natural))
(declare-const temp___182 (Array Int natural))
...
(assert (= temp___180 z1))
(assert (= temp___182 temp___180))
(assert (<= 1 5))
