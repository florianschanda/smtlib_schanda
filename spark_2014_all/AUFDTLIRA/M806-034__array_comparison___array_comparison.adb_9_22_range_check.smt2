...
(assert (forall ((temp___139 Int)) (forall ((temp___140 Int)) (= (select (array_comparison__p__x__aggregate_def temp___139) temp___140) (of_rep1 temp___139)))))
(declare-fun array_comparison__p__y__aggregate_def (Int) (Array Int natural))
(assert (forall ((temp___143 Int)) (forall ((temp___144 Int)) (= (select (array_comparison__p__y__aggregate_def temp___143) temp___144) (of_rep1 temp___143)))))
(declare-fun array_comparison__p__z__aggregate_def (Int Int Int) (Array Int natural))
(assert (forall ((temp___147 Int) (temp___148 Int) (temp___149 Int)) (let ((temp___146 (array_comparison__p__z__aggregate_def temp___147 temp___148 temp___149))) (forall ((temp___150 Int)) (ite (and (<= 7 temp___150) (<= temp___150 20)) (= (select temp___146 temp___150) (of_rep1 temp___149)) (ite (= temp___150 6) (= (select temp___146 temp___150) (of_rep1 temp___148)) (=> (and (<= 1 temp___150) (<= temp___150 5)) (= (select temp___146 temp___150) (of_rep1 temp___147)))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_136 us_t) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (not (= temp___skip_constant_134 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_136) (last1 temp___expr_136))))
...
(assert (=> (<= 1 5) (and (and (<= (to_rep z__first) 1) (<= 1 (to_rep z__last))) (and (<= (to_rep z__first) 5) (<= 5 (to_rep z__last))))))
(assert (= temp___157 z1))
(assert (= temp___159 temp___157))
(assert (<= 1 5))
(assert (not (<= (to_rep x__first) 1)))
(check-sat)
(exit)
