...
(assert (and (<= 1 j8) (<= j8 100)))
(assert (= o29 j8))
(assert (= (mk___rep1 (mk___split_fields1 o30 o31 o32 o33)) (select (rec__binary_trees__forest__c (us_split_fields5 f)) o29)))
(assert (= o34 (mk___split_fields1 o30 o31 o32 o33)))
(assert (= o35 (rec__binary_trees__cell__parent o34)))
(assert (= temp___599 (to_rep o35)))
(assert (not (<= 1 temp___599)))
(check-sat)
(exit)
