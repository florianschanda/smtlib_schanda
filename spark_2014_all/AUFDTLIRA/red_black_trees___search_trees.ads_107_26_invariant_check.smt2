...
(assert (=> (not (= (int__content i14) 0)) (= o35 (select temp___776 o34))))
(assert (=> (not (= (int__content i14) 0)) (= o36 (us_split_fields1 o35))))
(assert (=> (not (= (int__content i14) 0)) (= result24 (rec__tree_model__path_type__k o36))))
(assert (=> (not (not (= (int__content i14) 0))) (= result24 false)))
...
(assert (=> (= result24 true) (and (= o32 (root (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (in_range3 o32) (= o32 (to_rep1 t__split_fields))))))
(assert (=> (= result24 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result24 true) (and (= o33 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o33) (= o33 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result24 true) (= result23 (ite (= o33 o32) true false))))
...
(assert (=> (= result23 true) (and (= o31 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o31) (= o31 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result23 true) (= result22 (ite (= o31 (+ (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 1)) true false))))
...
(assert (=> (= result22 true) (and (= o30 (values1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))) 0) (= (is_empty o30) true) (and (forall ((i16 Int)) (=> (and (<= 1 i16) (<= i16 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i16))) true) (= (contains o30 (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i16))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o30 v1) true) (exists ((i16 Int)) (and (and (<= 1 i16) (<= i16 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14)))) i16))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields__content3 t__split_fields14)) i16)) v1))))))))))))
(assert (=> (= result22 true) (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))))
(assert (=> (= result22 true) (and (= o29 (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (ite (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= (is_empty o29) true) (and (forall ((i16 Int)) (=> (and (<= 1 i16) (<= i16 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i16))) true) (= (contains o29 (to_rep (select t__split_fields3 i16))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o29 v1) true) (exists ((i16 Int)) (and (and (<= 1 i16) (<= i16 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i16))) true) (= (to_rep (select t__split_fields3 i16)) v1))))))))))))
(assert (=> (= result22 true) (and (= result21 (is_add__2 o29 v o30)) (= (= result21 true) (and (and (and (not (= (contains o29 v) true)) (= (contains o30 v) true)) (= (ole o29 o30) true)) (= (included_except o30 o29 v) true))))))
(assert (=> (not (= result22 true)) (= result21 false)))
(assert (=> (= result21 true) (= (= result20 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (not (= (int__content i14) j1)) (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1) (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j1))))))))
(assert (=> (not (= result21 true)) (= result20 false)))
(assert (=> (= result20 true) (= (= result19 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (not (= (int__content i14) j1)) (not (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1) 0))) (= (position1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1) (position1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j1))))))))
(assert (=> (not (= result20 true)) (= result19 false)))
(assert (=> (= result19 true) (= (= result18 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (not (= (int__content i14) j1)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (us_split_fields__content3 t__split_fields14))) j1))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) j1))) true)))))))
