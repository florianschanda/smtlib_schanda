...
(define-fun dynamic_invariant ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= 0 100)) (in_range temp___expr_152)))
(assert (forall ((the_stack us_rep)) (! (dynamic_invariant (get_length the_stack) true false true) :pattern ((get_length the_stack)))))
...
(declare-fun temp___629 (us_rep) (Array Int us_rep))
(assert (forall ((temp___631 us_rep)) (forall ((temp___632 Int)) (= (select (temp___629 temp___631) temp___632) temp___631))))
