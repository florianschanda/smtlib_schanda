...
(declare-fun temp___678 (us_rep) (Array Int us_rep))
...
(assert (forall ((temp___680 us_rep)) (forall ((temp___681 Int)) (= (select (temp___678 temp___680) temp___681) temp___680))))
