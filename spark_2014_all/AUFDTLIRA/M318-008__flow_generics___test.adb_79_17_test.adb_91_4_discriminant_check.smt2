...
(assert (not (test__fruit_rec__record_t__arr__pred (mk___rep (mk___split_discrs rec2__split_discrs) (mk___split_fields rec2__split_fields rec2__split_fields1 rec2__split_fields2 rec2__split_fields3) rec2__attr__constrained))))
(check-sat)
(exit)
