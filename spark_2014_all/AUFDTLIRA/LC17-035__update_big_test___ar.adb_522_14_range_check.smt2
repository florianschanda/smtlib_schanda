...
(assert (= (bool_eq1 a1 5 50 (temp___4639 t1 j (temp___4645 (select t1 j) i e)) 5 50) true))
(assert (=> (= j 50) (= (mk_int__ref result2) (mk_int__ref j_next))))
(assert (=> (= j 50) (= j_next1 5)))
(assert (=> (not (= j 50)) (and (= o3 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (not (= j 50)) (= (mk_int__ref result3) (mk_int__ref j_next))))
