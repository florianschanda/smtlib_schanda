...
(assert (not (= (ite (<= (to_rep1 (first8 temp___20561)) (to_rep1 (last8 temp___20561))) (+ (- (to_rep1 (last8 temp___20561)) (to_rep1 (first8 temp___20561))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0))))
(check-sat)
(exit)
