...
(define-fun default_initial_assumption ((temp___expr_161 us_rep) (temp___skip_top_level_162 Bool)) Bool (and (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 temp___expr_161)) (distinct 1 0)) (= (to_rep1 (rec__types_with_invariants__my_integer__val (us_split_fields1 temp___expr_161))) 0)))
(define-fun type_invariant ((temp___163 us_rep)) Bool (=> (= (to_rep1 (rec__types_with_invariants__my_integer__val (us_split_fields1 temp___163))) 0) (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 temp___163)) true)))
...
(define-fun dynamic_invariant1 ((temp___expr_169 us_t) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool) (temp___do_typ_inv_168 Bool)) Bool (=> (not (= temp___skip_constant_166 true)) (dynamic_property 1 2147483647 (first1 temp___expr_169) (last1 temp___expr_169))))
...
(define-fun dynamic_invariant2 ((temp___expr_175 us_rep1) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool) (temp___do_typ_inv_174 Bool)) Bool (let ((temp___176 (rec__types_with_invariants__container__c (us_split_discrs1 temp___expr_175)))) (and (dynamic_property2 1 (to_rep1 temp___176) (first3 (rec__types_with_invariants__container__content (us_split_fields3 temp___expr_175))) (last3 (rec__types_with_invariants__container__content (us_split_fields3 temp___expr_175)))) (and (= (first3 (rec__types_with_invariants__container__content (us_split_fields3 temp___expr_175))) 1) (= (last3 (rec__types_with_invariants__container__content (us_split_fields3 temp___expr_175))) (to_rep1 temp___176))))))
(declare-sort ttB 0)
...
(define-fun type_invariant1 ((temp___188 Int)) Bool (not (= temp___188 0)))
(declare-sort t2 0)
(declare-fun tqtint (t2) Int)
(assert (forall ((i t2)) (and (<= (- 2147483648) (tqtint i)) (<= (tqtint i) 2147483647))))
...
(declare-sort tsB 0)
(declare-fun tsBqtint (tsB) Int)
(assert (forall ((i tsB)) (and (<= (- 2147483648) (tsBqtint i)) (<= (tsBqtint i) 2147483647))))
...
(assert (forall ((i taD1)) (and (<= 1 (taD1qtint i)) (<= (taD1qtint i) 100))))
...
(define-fun type_invariant2 ((temp___204 us_t2)) Bool (and (not (= (to_rep (select (to_array2 temp___204) 1)) 0)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (not (= (to_rep (select (to_array2 temp___204) i)) 0))))))
(declare-sort t4 0)
...
(define-fun dynamic_invariant3 ((temp___expr_220 us_t3) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool) (temp___do_typ_inv_219 Bool)) Bool (=> (not (= temp___skip_constant_217 true)) (dynamic_property4 1 2147483647 (first7 temp___expr_220) (last7 temp___expr_220))))
(define-fun type_invariant3 ((temp___222 us_t3)) Bool (and (not (= (to_rep (select (to_array3 temp___222) (first7 temp___222))) 1)) (forall ((i Int)) (=> (and (<= (first7 temp___222) i) (<= i (last7 temp___222))) (not (= (to_rep (select (to_array3 temp___222) i)) 0))))))
...
(define-fun dynamic_invariant6 ((temp___expr_194 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_194)))
(declare-const temp___c_270 Int)
(assert (in_range2 temp___c_270))
(assert (not (in_range5 0)))
(check-sat)
(exit)
