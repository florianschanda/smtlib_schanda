...
(assert (= b1 result1))
(assert (= b2 o2))
(assert (and (= o8 (remove_last r)) (and (dynamic_invariant1 o8 true false true true) (and (= (elts r) o3) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1))))) o4)))))
(assert (= (occ o8 e) (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e)))
(assert (and (= o7 (remove_last a)) (and (dynamic_invariant1 o7 true false true true) (and (= (elts a) o5) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1))))) o6)))))
