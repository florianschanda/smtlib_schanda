...
(assert (and (= temp___1209 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant3 temp___1209 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1209 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1209 root)))) 0) (and (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (not (= i13 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1209 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1209 i13))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1209 i13))) true)))))) (and (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1209 i13))) true) (not (= i13 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1209 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i13) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1209 i13)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1209 i13)))) 0)))) (forall ((i13 Int)) (=> (and (<= 1 i13) (<= i13 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1209 i13))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1209 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1209 i13))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1209 j2)))) true)) (= j2 i13))))))))))))))
(assert (not (<= 1 v)))
(check-sat)
(exit)
