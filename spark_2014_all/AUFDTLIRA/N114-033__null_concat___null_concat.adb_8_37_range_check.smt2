...
(assert (=> (<= (to_rep (first (rt a1))) (to_rep (last (rt a1)))) (= o10 (+ (- (to_rep (last (rt a1))) (to_rep (first (rt a1)))) 1))))
(assert (=> (not (<= (to_rep (first (rt a1))) (to_rep (last (rt a1))))) (= o10 0)))
(assert (= o11 (+ o10 1)))
(assert (= o12 (+ (to_rep (first (rt a1))) o11)))
(assert (= o13 (- o12 1)))
