...
(assert (=> (= result6 true) (and (= temp___591 (nb_blacks c61b)) (and (= (bool_eq11 (select temp___591 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___591 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___591 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___591 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___591 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___591 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___591 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___591 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___591 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___591 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c61b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___591 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 0)))))))))))))))
(assert (=> (= result6 true) (= o3 (select temp___591 i))))
(assert (=> (= result6 true) (= o4 (us_split_fields11 o3))))
(assert (=> (= result6 true) (= o5 (rec__red_black_trees__black_count__depth o4))))
(assert (=> (= result6 true) (= o6 (to_rep o5))))
(assert (=> (= result6 true) (= result5 (ite (< o6 n19) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o1 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c62b)))) (and (in_range2 o1) (= o1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c62b))))))))))
(assert (=> (= result5 true) (= o2 (ite (= i o1) true false))))
(assert (=> (= result5 true) (= result4 (ite (not (= o2 true)) true false))))
(assert (=> (not (= result5 true)) (= result4 false)))
(assert (= result4 true))
(assert (and (= temp___589 (nb_blacks c61b)) (and (= (bool_eq11 (select temp___589 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___589 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___589 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___589 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___589 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___589 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___589 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___589 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___589 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___589 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c61b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___589 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i14 0))))))))))))))
(assert (= o9 (select temp___589 i)))
(assert (not (not (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c62b))) 0))))
(check-sat)
(exit)
