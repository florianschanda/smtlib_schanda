...
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___641 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)))) (and (dynamic_invariant5 temp___641 true false true true) (= temp___641 (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))))))))))
(assert (= o7 (select temp___641 i)))
(assert (= o8 (us_split_fields7 o7)))
(assert (= result6 (rec__tree_model__path_type__k o8)))
(assert (=> (= result6 true) (and (= temp___642 (nb_blacks c61b)) (and (= (bool_eq11 (select temp___642 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___642 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___642 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___642 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___642 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___642 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___642 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___642 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___642 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___642 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c61b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___642 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 0)))))))))))))))
(assert (=> (= result6 true) (= o3 (select temp___642 i))))
...
(assert (=> (= result5 true) (and (= o1 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c62b)))) (and (in_range4 o1) (= o1 (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c62b))))))))))
...
(assert (= result4 true))
(assert (and (= temp___640 (nb_blacks c61b)) (and (= (bool_eq11 (select temp___640 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___640 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___640 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___640 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___640 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___640 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___640 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___640 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___640 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___640 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c61b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___640 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c61b)) i1 0))))))))))))))
(assert (= o9 (select temp___640 i)))
