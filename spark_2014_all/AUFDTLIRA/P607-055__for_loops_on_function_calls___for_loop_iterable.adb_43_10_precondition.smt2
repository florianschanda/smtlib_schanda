...
(assert (forall ((temp___255 Int)) (forall ((temp___256 Int)) (= (select (for_loop_iterable__p4__a__aggregate_def temp___255) temp___256) (of_rep temp___255)))))
...
(assert (and (= o (first (mk___rep (mk___split_fields h__split_fields1)))) (and (in_range3 o) (= o 1))))
(assert (= o temp___262))
(assert (and (= result3 (has_element (mk___rep (mk___split_fields h__split_fields1)) temp___262)) (= (= result3 true) (in_range2 temp___262))))
(assert (=> (= result3 true) (and (= o1 (element (mk___rep (mk___split_fields h__split_fields1)) temp___262)) (and (in_range1 o1) (= o1 (to_rep (select h__split_fields1 temp___262)))))))
...
(assert (and (= result5 (has_element (mk___rep (mk___split_fields h__split_fields1)) temp___262)) (= (= result5 true) (in_range2 temp___262))))
(assert (= result5 true))
(assert (and (= (has_element (rec__for_loop_iterable__container_holder__content h__split_fields2) temp___2621) true) (= e3 (element (rec__for_loop_iterable__container_holder__content h__split_fields2) temp___2621))))
(assert (not (= (has_element (mk___rep (us_split_fields1 (rec__for_loop_iterable__container_holder__content h__split_fields2))) 2) true)))
(check-sat)
(exit)
