...
(assert (forall ((temp___288 Int)) (=> (dynamic_invariant1 temp___288 true true true true) (forall ((temp___289 Int)) (= (to_rep (select (for_loop_iterable__p4__a__aggregate_def temp___288) temp___289)) temp___288)))))
