...
(assert (forall ((temp___3033 (Array Int et1))) (forall ((temp___3034 Int) (temp___3035 Int)) (let ((temp___3032 (temp___3031 temp___3033 temp___3034 temp___3035))) (forall ((temp___3036 Int)) (ite (= temp___3036 temp___3034) (= (select temp___3032 temp___3036) (of_rep temp___3035)) (= (select temp___3032 temp___3036) (select temp___3033 temp___3036))))))))
...
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp___3031 r__split_fields i e) (of_rep1 f)))) true)))
(check-sat)
(exit)
