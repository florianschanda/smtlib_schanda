...
(declare-fun temp_____aggregate_def_3090 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___3092 (Array Int et1))) (forall ((temp___3093 Int) (temp___3094 Int)) (let ((temp___3091 (temp_____aggregate_def_3090 temp___3092 temp___3093 temp___3094))) (=> (and (dynamic_invariant temp___3093 true true true true) (dynamic_invariant1 temp___3094 true true true true)) (forall ((temp___3095 Int)) (ite (= temp___3095 temp___3093) (= (to_rep (select temp___3091 temp___3095)) temp___3094) (= (select temp___3091 temp___3095) (select temp___3092 temp___3095)))))))))
...
(declare-const temp___7993 (Array Int et1))
(declare-const temp___79931 enum2t)
(declare-const o4 enum2t)
(declare-const o5 (Array Int et1))
(declare-const o6 enum2t)
(declare-const temp___7995 (Array Int et1))
(declare-const temp___79951 enum2t)
...
(assert (= temp___7993 o2))
(assert (= temp___79931 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___7993 r__split_fields2))
(assert (= temp___79931 r__split_fields3))
(assert (= (to_rep1 o4) f))
(assert (= r__split_fields2 o5))
(assert (= o4 o6))
(assert (= temp___7995 o5))
(assert (= temp___79951 o6))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___7995 r__split_fields4))
(assert (= temp___79951 r__split_fields5))
...
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp_____aggregate_def_3090 r__split_fields i e) (of_rep1 f)))) true)))
(check-sat)
(exit)
