...
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields r__split_fields6 r__split_fields7)) (mk___rep (mk___split_fields (temp___3090 r__split_fields i e) (of_rep1 f)))) true)))
(check-sat)
(exit)
