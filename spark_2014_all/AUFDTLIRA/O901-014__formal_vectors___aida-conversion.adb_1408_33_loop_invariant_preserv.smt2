...
(assert (and (= temp___1949 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (= temp___1950 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___1949))
(assert (<= temp___1949 index1))
(assert (<= index1 temp___1950))
...
(assert (and (and (forall ((temp___1947 Int)) (=> (and (<= (to_rep1 n__first) temp___1947) (<= temp___1947 (to_rep1 n__last))) (=> (< index2 temp___1947) (= (select n3 temp___1947) (select n1 temp___1947))))) (=> (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 9) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
(assert (not (= index2 temp___1950)))
