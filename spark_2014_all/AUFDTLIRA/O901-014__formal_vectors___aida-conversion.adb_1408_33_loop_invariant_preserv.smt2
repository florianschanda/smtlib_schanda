...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 51)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 8))) 54)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 9))) 52)) (forall ((index4 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) index4) (<= index4 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index4))) true))))))
...
(assert (<= temp___1945 index1))
(assert (<= index1 temp___1946))
...
(assert (= n1 result3))
(assert (= n2 o8))
(assert (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9)))))
(assert (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j))))))
(assert (and (and (forall ((temp___1949 Int)) (=> (and (<= (to_rep1 n__first) temp___1949) (<= temp___1949 (to_rep1 n__last))) (=> (or (< temp___1946 temp___1949) (or (< temp___1949 temp___1945) (< index2 temp___1949))) (= (select n3 temp___1949) (select n1 temp___1949))))) (=> (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 9) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
(assert (not (= index2 temp___1946)))
...
(assert (= n4 o17))
(declare-const j Int)
(assert (<= (+ (to_rep1 (first (rt source))) 9) j))
(assert (<= j index3))
