...
(assert (= index1 temp___1847))
(assert (<= temp___1847 index1))
(assert (<= index1 temp___1848))
...
(assert (and (and (forall ((temp___1845 Int)) (=> (and (<= (to_rep1 n__first) temp___1845) (<= temp___1845 (to_rep1 n__last))) (=> (< index2 temp___1845) (= (select n3 temp___1845) (select n1 temp___1845))))) (=> (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 9) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10)))))
(assert (not (= index2 temp___1848)))
