...
(assert (<= temp___1847 index2))
(assert (<= index2 temp___1848))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o41 index2))
(assert (= o42 (select n1 o41)))
(assert (= o43 (to_rep1 o42)))
(assert (= o43 aida__conversion__convert_character_digit_to_integer__2__target))
...
(assert (= (to_rep1 o47) aida__conversion__convert_character_digit_to_integer__2__target2))
(assert (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))))
(assert (= o48 index2))
(assert (= o49 (store n1 o48 o47)))
(assert (= n1 result4))
(assert (= n2 o49))
(assert (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))))
(assert (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1))))))
(assert (and (and (forall ((temp___1845 Int)) (=> (and (<= (to_rep1 n__first) temp___1845) (<= temp___1845 (to_rep1 n__last))) (=> (< index3 temp___1845) (= (select n3 temp___1845) (select n1 temp___1845))))) (=> (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 9) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10)))))
(assert (not (= index3 temp___1848)))
(assert (= index3 result7))
(assert (= index4 (+ index3 1)))
(assert (and (<= (to_rep1 n__first) index4) (<= index4 (to_rep1 n__last))))
(assert (= o61 index4))
(assert (= o62 (select n3 o61)))
(assert (= o63 (to_rep1 o62)))
(assert (= o63 aida__conversion__convert_character_digit_to_integer__2__target1))
...
(assert (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target3) (<= aida__conversion__convert_character_digit_to_integer__2__target3 9)) (= aida__conversion__convert_character_digit_to_integer__2__target3 (convert_character_digit_to_integer o66))) (ite (= (= o66 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 0) (ite (= (= o66 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 1) (ite (= (= o66 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 2) (ite (= (= o66 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 3) (ite (= (= o66 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 4) (ite (= (= o66 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 5) (ite (= (= o66 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 6) (ite (= (= o66 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 7) (ite (= (= o66 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 8) (=> (= (= o66 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target3 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target3)))
(assert (= (to_rep1 o67) aida__conversion__convert_character_digit_to_integer__2__target3))
(assert (and (<= (to_rep1 n__first) index4) (<= index4 (to_rep1 n__last))))
(assert (= o68 index4))
(assert (= o69 (store n3 o68 o67)))
(assert (= result8 n3))
(assert (= n4 o69))
(declare-const j1 Int)
(assert (<= (+ (to_rep1 (first (rt source))) 9) j1))
(assert (<= j1 index4))
