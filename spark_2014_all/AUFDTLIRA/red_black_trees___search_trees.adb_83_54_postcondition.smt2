...
(assert (not (= (ole (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) (int__content search_trees__find_root__result4)))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i)))) true)))
(check-sat)
(exit)
