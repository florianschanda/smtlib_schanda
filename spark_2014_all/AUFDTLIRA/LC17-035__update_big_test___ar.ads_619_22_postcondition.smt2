...
(declare-fun temp___2400 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(assert (forall ((temp___2402 (Array Int (Array Int (Array Int (Array Int et1)))))) (forall ((temp___2403 Int)) (forall ((temp___2404 (Array Int (Array Int (Array Int et1))))) (let ((temp___2401 (temp___2400 temp___2402 temp___2403 temp___2404))) (forall ((temp___2405 Int)) (ite (= temp___2405 temp___2403) (= (select temp___2401 temp___2405) temp___2404) (= (select temp___2401 temp___2405) (select temp___2402 temp___2405)))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq3 a2 90 99 (temp___2400 a i b) 90 99) true)))
(check-sat)
(exit)
