...
(declare-fun temp___2459 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(assert (forall ((temp___2461 (Array Int (Array Int (Array Int (Array Int et1)))))) (forall ((temp___2462 Int)) (forall ((temp___2463 (Array Int (Array Int (Array Int et1))))) (let ((temp___2460 (temp___2459 temp___2461 temp___2462 temp___2463))) (=> (dynamic_invariant temp___2462 true true true true) (forall ((temp___2464 Int)) (ite (= temp___2464 temp___2462) (= (select temp___2460 temp___2464) temp___2463) (= (select temp___2460 temp___2464) (select temp___2461 temp___2464))))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq3 a2 90 99 (temp___2459 a i b) 90 99) true)))
(check-sat)
(exit)
