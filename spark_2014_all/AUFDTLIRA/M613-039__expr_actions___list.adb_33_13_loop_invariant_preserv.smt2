...
(assert (not (= i13 last3)))
(assert (= result7 (mk_int__ref i13)))
(assert (= i14 (+ i13 1)))
(assert (and (= o27 (top (mk___rep s__split_fields13))) (and (in_range1 o27) (= o27 (to_rep1 (rec__stack__stack__top s__split_fields13))))))
(assert (and (and (= (length2 (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields1)) (+ (length2 (mk___rep1 res__split_discrs res__split_fields3)) 1)) (= (olt (model__ (mk___rep1 res__split_discrs res__split_fields3)) (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields1))) true)) (= (get (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields1)) (+ (last2 (model__ (mk___rep1 res__split_discrs res__split_fields3))) 1)) o27)))
(assert (= result8 (mk___split_fields__ref1 res__split_fields3)))
(assert (= res__split_fields4 list__my_lists__append__2__container__fields1))
(assert (= (let ((temp___185 (to__ (mk___rep s__split_fields14)))) (let ((temp___184 (to_but_top (mk___rep s__split_fields13)))) (bool_eq (elts temp___184) (to_rep (first (rt temp___184))) (to_rep (last (rt temp___184))) (elts temp___185) (to_rep (first (rt temp___185))) (to_rep (last (rt temp___185)))))) true))
(assert (= i15 (mk_int__ref i14)))
(assert (= res__split_fields5 (mk___split_fields__ref1 res__split_fields4)))
(assert (= s__split_fields15 (mk___split_fields__ref s__split_fields14)))
(assert (= rho list__my_lists__append__2__container__fields1))
(assert (= i16 i14))
(assert (= res__split_fields6 res__split_fields4))
(assert (= s__split_fields16 s__split_fields14))
(assert (not (= (to_rep (last (rt (to__ (mk___rep (us_split_fields__content s__split_fields15)))))) (- last3 (int__content i15)))))
(check-sat)
(exit)
