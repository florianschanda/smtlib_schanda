...
(assert (= (let ((temp___212 (to__ (mk___rep s__split_fields11)))) (let ((temp___211 (to_but_top (mk___rep s__split_fields10)))) (bool_eq (elts temp___211) (to_rep (first (rt temp___211))) (to_rep (last (rt temp___211))) (elts temp___212) (to_rep (first (rt temp___212))) (to_rep (last (rt temp___212)))))) true))
(assert (= i11 (mk_int__ref i10)))
(assert (= res__split_fields4 (mk___split_fields__ref1 res__split_fields3)))
(assert (= s__split_fields12 (mk___split_fields__ref s__split_fields11)))
...
(assert (not (= (to_rep (last (rt (to__ (mk___rep (us_split_fields__content s__split_fields12)))))) (- last3 (int__content i11)))))
(check-sat)
(exit)
