...
(assert (= (let ((temp___185 (to__ (mk___rep s__split_fields11)))) (let ((temp___184 (to_but_top (mk___rep s__split_fields10)))) (bool_eq (elts temp___184) (to_rep (first (rt temp___184))) (to_rep (last (rt temp___184))) (elts temp___185) (to_rep (first (rt temp___185))) (to_rep (last (rt temp___185)))))) true))
