...
(assert (= temp___282 a))
(assert (= temp___280 a))
(assert (= temp___278 max2))
(assert (= temp___277 k2))
(assert (= temp___276 c168b))
(assert (= temp___275 c167b))
...
(assert (and (forall ((i1 Int)) (=> (and (<= first2 i1) (<= i1 k3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i1)))) max4))) (forall ((i1 Int)) (=> (and (<= k3 i1) (<= i1 first2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i1)))) max4)))))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 a__first) i1) (<= i1 k3)) (forall ((j Int)) (=> (and (<= i1 j) (<= j k3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i1)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a2 j))))))))))
(assert (and (and (and (and (=> (<= 1 2147483647) (in_range3 c167b2)) (=> (<= 0 2147483647) (in_range2 c168b2))) (=> (<= 1 2147483647) (in_range3 k3))) (=> (<= 0 2147483647) (in_range2 max4))) (forall ((temp___281 Int)) (=> (and (<= (to_rep1 a__first) temp___281) (<= temp___281 (to_rep1 a__last))) (= (rec__frame_condition__cell__value (us_split_fields1 (select a2 temp___281))) (rec__frame_condition__cell__value (us_split_fields1 (select temp___280 temp___281))))))))
...
(assert (and (forall ((i1 Int)) (=> (and (<= first3 i1) (<= i1 k11)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a11 i1)))) max13))) (forall ((i1 Int)) (=> (and (<= k11 i1) (<= i1 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a11 i1)))) max13)))))
(assert (forall ((i1 Int)) (=> (and (<= k11 i1) (<= i1 (to_rep1 a__last))) (forall ((j Int)) (=> (and (<= i1 j) (<= j (to_rep1 a__last))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a11 j)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select a11 i1))))))))))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 a__first) i1) (<= i1 (to_rep1 a__last))) (= (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a11 i1)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a5) i1))))))))
(assert (and (and (and (and (=> (<= 1 2147483647) (in_range3 c204b2)) (=> (<= 0 2147483647) (in_range2 c205b2))) (=> (<= 1 2147483647) (in_range3 k11))) (forall ((temp___290 Int)) (=> (and (<= (to_rep1 a__first) temp___290) (<= temp___290 (to_rep1 a__last))) (= (rec__frame_condition__cell__value (us_split_fields1 (select a11 temp___290))) (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a5) temp___290))))))) (=> (<= 0 2147483647) (in_range2 max13))))
(assert (= (= o48 true) (forall ((i1 Int)) (=> (and (<= k11 i1) (<= i1 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a11 i1)))) max13)))))
(assert (<= first3 i))
(assert (<= i k11))
