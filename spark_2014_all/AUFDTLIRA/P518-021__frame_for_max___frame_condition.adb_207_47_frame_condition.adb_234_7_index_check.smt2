...
(assert (= (= o80 true) (forall ((i11 Int)) (=> (and (<= k14 i11) (<= i11 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a13 i11)))) max16)))))
(assert (<= first3 i5))
(assert (<= i5 k14))
(assert (not (<= (to_rep1 a__first) i5)))
(check-sat)
(exit)
