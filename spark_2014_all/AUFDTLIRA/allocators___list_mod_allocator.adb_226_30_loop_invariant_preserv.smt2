...
(assert (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data3 rr)))) (ite (= rr 10000) 0 (+ rr 1))))))
(assert (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data3 10000)))) 0))
(assert (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr 10000)) (= (to_rep1 (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data3 rr)))) 0))))
...
(assert (=> (< r3 10000) (= (rec__list_mod_allocator__cell__stat (us_split_fields1 (select data3 r3))) o16)))
...
(assert (not (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data4 10000)))) 0)))
(check-sat)
(exit)
