...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o3 i))
(assert (= o4 (select (rec__patience__state__posstack (us_split_fields1 s)) o3)))
(assert (= o5 (to_rep1 o4)))
(assert (= o6 (ite (<= o5 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields1 s))) 1)) true false)))
(assert (and (<= 0 i) (<= i 99)))
(assert (= o i))
