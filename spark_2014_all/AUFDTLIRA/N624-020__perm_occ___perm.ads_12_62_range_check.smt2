...
(assert (= result true))
(assert (and (= o7 (remove_last a)) (and (dynamic_invariant1 o7 true false true) (and (= (elts a) o3) (= (mk (to_rep1 (first2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1)))) (to_rep1 (last2 (mk1 (to_rep1 (first (rt a))) (- (to_rep1 (last (rt a))) 1))))) o4)))))
