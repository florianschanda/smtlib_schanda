...
(assert (and (= o128 (remove (mk___t interm1 (mk 1 100)) o127)) (and (dynamic_invariant4 o128 true false true) (and (= (invariant__ o128) true) (and (= (to_rep1 (last (rt o128))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o127 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o128) k))))) (and (forall ((k Int)) (=> (and (<= (+ o127 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o128) (- k 1)))))) (forall ((k Int)) (=> (and (<= o127 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o128) k))))))))))))
(assert (not (= (invariant__ o128) true)))
(check-sat)
(exit)
