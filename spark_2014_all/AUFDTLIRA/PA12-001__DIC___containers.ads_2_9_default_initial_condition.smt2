...
(assert (and (dynamic_invariant1 (mk___rep (mk___split_discrs temp___151) (mk___split_fields temp___1511 (mk___t temp___1512 temp___1513))) true false true) (= (to_rep temp___1511) 0)))
(assert (not (= (length1 (mk___rep (mk___split_discrs temp___151) (mk___split_fields temp___1511 (mk___t temp___1512 temp___1513)))) 0)))
(check-sat)
(exit)
