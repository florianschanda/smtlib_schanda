...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__containers__container__c (us_split_discrs1 a))) (to_rep (rec__containers__container__c (us_split_discrs1 b)))) (= (to_rep (rec__containers__container__l (us_split_fields1 a))) (to_rep (rec__containers__container__l (us_split_fields1 b))))) (= (bool_eq1 (rec__containers__container__v (us_split_fields1 a)) (rec__containers__container__v (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_141 us_rep) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (let ((temp___142 (rec__containers__container__c (us_split_discrs1 temp___expr_141)))) (and (dynamic_property1 1 (to_rep temp___142) (first1 (rec__containers__container__v (us_split_fields1 temp___expr_141))) (last1 (rec__containers__container__v (us_split_fields1 temp___expr_141)))) (and (= (first1 (rec__containers__container__v (us_split_fields1 temp___expr_141))) 1) (= (last1 (rec__containers__container__v (us_split_fields1 temp___expr_141))) (to_rep temp___142))))))
(declare-fun length1 (us_rep) Int)
(declare-fun length__function_guard (Int us_rep) Bool)
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant1 x true true true) (dynamic_invariant (length1 x) true false true)) :pattern ((length1 x)))))
(assert (forall ((x us_rep)) (! (=> (dynamic_invariant1 x true true true) (= (length1 x) (to_rep (rec__containers__container__l (us_split_fields1 x))))) :pattern ((length1 x)))))
...
(define-fun temp___1514 () us_rep (mk___rep (mk___split_discrs temp___151) (mk___split_fields temp___1511 (mk___t temp___1512 temp___1513))))
(assert (in_range temp___150))
(assert (= temp___150 (to_rep temp___149)))
(assert (and (dynamic_invariant1 temp___1514 true false true) (= (to_rep temp___1511) 0)))
(assert (not (= (length1 temp___1514) 0)))
(check-sat)
(exit)
