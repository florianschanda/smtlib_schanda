...
(assert (and (= o90 (length (rec__list_allocator__m__t__available model____split_fields4))) (in_range6 o90)))
(assert (= result21 (ite (< j3 o90) true false)))
(assert (= result21 true))
(assert (and (= o91 (+ j3 1)) (in_range1 (+ j3 1))))
(assert (not (<= 1 o91)))
(check-sat)
(exit)
