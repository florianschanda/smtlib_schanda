...
(assert (= (ite (<= (to_rep1 (first temp___5461)) (to_rep1 (last temp___5461))) (+ (- (to_rep1 (last temp___5461)) (to_rep1 (first temp___5461))) 1) 0) (ite (<= 1 40) (+ (- 40 1) 1) 0)))
(assert (= o10 (slide temp___546 (to_rep1 (first temp___5461)) 1)))
(assert (= result6 address2))
(assert (= address3 o10))
(assert (forall ((temp___548 Int)) (ite (and (<= 9 temp___548) (<= temp___548 28)) (= (select o11 temp___548) (select (slide name3 1 9) temp___548)) (= (select o11 temp___548) (select address3 temp___548)))))
...
(assert (= (ite (<= (to_rep1 (first2 temp___5501)) (to_rep1 (last2 temp___5501))) (+ (- (to_rep1 (last2 temp___5501)) (to_rep1 (first2 temp___5501))) 1) 0) (ite (<= (to_rep1 (first2 temp___5521)) (to_rep1 (last2 temp___5521))) (+ (- (to_rep1 (last2 temp___5521)) (to_rep1 (first2 temp___5521))) 1) 0)))
(assert (= (mk___t1 temp___553 temp___5531) (mk___t1 temp___550 temp___5501)))
(assert (forall ((temp___554 Int)) (ite (and (<= 1 temp___554) (<= temp___554 r9b)) (= (select o13 temp___554) (select temp___553 temp___554)) (= (select o13 temp___554) (select name3 temp___554)))))
