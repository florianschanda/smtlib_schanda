...
(assert (= o12 name3))
(assert (= o12 temp___612))
(assert (= (mk1 1 r9b) temp___6121))
(assert (= (ite (<= (to_rep1 (first2 temp___6101)) (to_rep1 (last2 temp___6101))) (+ (- (to_rep1 (last2 temp___6101)) (to_rep1 (first2 temp___6101))) 1) 0) (ite (<= (to_rep1 (first2 temp___6121)) (to_rep1 (last2 temp___6121))) (+ (- (to_rep1 (last2 temp___6121)) (to_rep1 (first2 temp___6121))) 1) 0)))
(assert (= (mk___t1 temp___613 temp___6131) (mk___t1 temp___610 temp___6101)))
(assert (forall ((temp___614 Int)) (ite (and (<= 1 temp___614) (<= temp___614 r9b)) (= (select o13 temp___614) (select temp___613 temp___614)) (= (select o13 temp___614) (select name3 temp___614)))))
