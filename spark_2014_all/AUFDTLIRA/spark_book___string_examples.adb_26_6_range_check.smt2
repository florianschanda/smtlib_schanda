...
(assert (= (ite (<= (to_rep1 (first temp___5401)) (to_rep1 (last temp___5401))) (+ (- (to_rep1 (last temp___5401)) (to_rep1 (first temp___5401))) 1) 0) (ite (<= 1 40) (+ (- 40 1) 1) 0)))
(assert (= o10 (slide temp___540 (to_rep1 (first temp___5401)) 1)))
(assert (= result6 address2))
(assert (= address3 o10))
(assert (forall ((temp___542 Int)) (ite (and (<= 9 temp___542) (<= temp___542 28)) (= (select o11 temp___542) (select (slide name3 1 9) temp___542)) (= (select o11 temp___542) (select address3 temp___542)))))
...
(assert (= (temp___String_Literal_543 Tuple0) temp___544))
(assert (= (mk1 1 5) temp___5441))
(assert (=> (<= 1 r9b) (and (and (<= 1 1) (<= 1 20)) (and (<= 1 r9b) (<= r9b 20)))))
(assert (= o12 name3))
(assert (= o12 temp___546))
(assert (= (mk1 1 r9b) temp___5461))
(assert (= (ite (<= (to_rep1 (first2 temp___5441)) (to_rep1 (last2 temp___5441))) (+ (- (to_rep1 (last2 temp___5441)) (to_rep1 (first2 temp___5441))) 1) 0) (ite (<= (to_rep1 (first2 temp___5461)) (to_rep1 (last2 temp___5461))) (+ (- (to_rep1 (last2 temp___5461)) (to_rep1 (first2 temp___5461))) 1) 0)))
(assert (= (mk___t1 temp___547 temp___5471) (mk___t1 temp___544 temp___5441)))
(assert (forall ((temp___548 Int)) (ite (and (<= 1 temp___548) (<= temp___548 r9b)) (= (select o13 temp___548) (select temp___547 temp___548)) (= (select o13 temp___548) (select name3 temp___548)))))
(assert (= result9 name3))
(assert (= name4 o13))
(assert (= count1 r13b))
