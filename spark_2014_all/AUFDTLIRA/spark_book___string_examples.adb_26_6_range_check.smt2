...
(declare-const temp___6191 t1)
(declare-const temp___620 (Array Int character))
(declare-const temp___6201 t1)
...
(assert (= o12 name3))
(assert (= o12 temp___619))
(assert (= (mk1 1 r9b) temp___6191))
(assert (= (ite (<= (to_rep1 (first2 temp___6171)) (to_rep1 (last2 temp___6171))) (+ (- (to_rep1 (last2 temp___6171)) (to_rep1 (first2 temp___6171))) 1) 0) (ite (<= (to_rep1 (first2 temp___6191)) (to_rep1 (last2 temp___6191))) (+ (- (to_rep1 (last2 temp___6191)) (to_rep1 (first2 temp___6191))) 1) 0)))
(assert (= (mk___t1 temp___620 temp___6201) (mk___t1 temp___617 temp___6171)))
(assert (forall ((temp___621 Int)) (ite (and (<= 1 temp___621) (<= temp___621 r9b)) (= (select o13 temp___621) (select temp___620 temp___621)) (= (select o13 temp___621) (select name3 temp___621)))))
