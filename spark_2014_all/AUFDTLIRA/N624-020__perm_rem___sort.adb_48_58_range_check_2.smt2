...
(define-fun o37 () us_t (mk___t o17 o18))
...
(assert (and (= o37 (remove (mk___t values2 (mk 1 100)) o16)) (and (dynamic_invariant3 o37 true false true true) (and (= (invariant__ o37) true) (and (= (to_rep1 (last o18)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o16 1))) (= (to_rep (select values2 k)) (to_rep (select o17 k))))) (and (forall ((k Int)) (=> (and (<= (+ o16 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o17 (- k 1)))))) (forall ((k Int)) (=> (and (<= o16 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o17 k))))))))))))
(assert (and (= o13 y) (in_range4 y)))
(assert (and (= o38 (remove (mk___t interm1 (mk 1 100)) o13)) (and (dynamic_invariant3 o38 true false true true) (and (= (invariant__ o38) true) (and (= (to_rep1 (last o15)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select interm1 k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select o14 k))))))))))))
(assert (and (= o20 (remove_eq o38 o37 o19)) (and (in_range5 o20) (=> (= (distinct o20 0) true) (= (let ((temp___188 (remove o37 o19))) (let ((temp___187 (remove o38 o19))) (bool_eq (elts temp___187) (to_rep1 (first (rt temp___187))) (to_rep1 (last (rt temp___187))) (elts temp___188) (to_rep1 (first (rt temp___188))) (to_rep1 (last (rt temp___188)))))) true)))))
...
(assert (and (= o30 (remove (mk___t interm1 (mk 1 100)) o29)) (and (dynamic_invariant3 o30 true false true true) (and (= (invariant__ o30) true) (and (= (to_rep1 (last (rt o30))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o29 1))) (= (to_rep (select interm1 k)) (to_rep (select (elts o30) k))))) (and (forall ((k Int)) (=> (and (<= (+ o29 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select (elts o30) (- k 1)))))) (forall ((k Int)) (=> (and (<= o29 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select (elts o30) k))))))))))))
(assert (and (= o27 x) (in_range4 x)))
(assert (and (= o28 (remove (mk___t init (mk 1 100)) o27)) (and (dynamic_invariant3 o28 true false true true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last (rt o28))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select init k)) (to_rep (select (elts o28) k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts o28) (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts o28) k))))))))))))
(assert (and (= o32 (remove_eq o28 o30 o31)) (and (in_range5 o32) (=> (= (distinct o32 0) true) (= (let ((temp___188 (remove o30 o31))) (let ((temp___187 (remove o28 o31))) (bool_eq (elts temp___187) (to_rep1 (first (rt temp___187))) (to_rep1 (last (rt temp___187))) (elts temp___188) (to_rep1 (first (rt temp___188))) (to_rep1 (last (rt temp___188)))))) true)))))
(assert (= result7 (mk_int__ref hr4)))
(assert (= hr5 o32))
(assert (and (= o35 y) (in_range4 y)))
(assert (and (= o33 x) (in_range4 x)))
(assert (and (= o34 (remove (mk___t values2 (mk 1 100)) o33)) (and (dynamic_invariant3 o34 true false true true) (and (= (invariant__ o34) true) (and (= (to_rep1 (last (rt o34))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o33 1))) (= (to_rep (select values2 k)) (to_rep (select (elts o34) k))))) (and (forall ((k Int)) (=> (and (<= (+ o33 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select (elts o34) (- k 1)))))) (forall ((k Int)) (=> (and (<= o33 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select (elts o34) k))))))))))))
(assert (and (= temp___288 (remove o34 o35)) (and (dynamic_invariant3 temp___288 true false true true) (and (= (invariant__ temp___288) true) (and (= (to_rep1 (last (rt temp___288))) (- (to_rep1 (last (rt o34))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o35 1))) (= (to_rep (select (elts o34) k)) (to_rep (select (elts temp___288) k))))) (and (forall ((k Int)) (=> (and (<= (+ o35 1) k) (<= k (to_rep1 (last (rt o34))))) (= (to_rep (select (elts o34) k)) (to_rep (select (elts temp___288) (- k 1)))))) (forall ((k Int)) (=> (and (<= o35 k) (<= k (- (to_rep1 (last (rt o34))) 1))) (= (to_rep (select (elts o34) (+ k 1))) (to_rep (select (elts temp___288) k))))))))))))
