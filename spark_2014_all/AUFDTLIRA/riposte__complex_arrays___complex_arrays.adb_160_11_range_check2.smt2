...
(assert (= j1 0))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= temp___275 i)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= temp___274 j1)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= temp___272 tmp1)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= tmp1 result2)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= tmp2 (store tmp1 j1 rliteral1))))
(assert (=> (and (<= 0 j1) (<= j1 i)) (and (forall ((k Int)) (=> (and (<= 0 k) (<= k j2)) (=> (<= k j2) (= (to_rep (select tmp3 k)) (- 23))))) (= i temp___275))))
(assert (=> (and (<= 0 j1) (<= j1 i)) (and (and (forall ((temp___273 Int)) (=> (and (<= 0 temp___273) (<= temp___273 1001)) (=> (or (< i temp___273) (or (< temp___273 0) (< j2 temp___273))) (= (select tmp3 temp___273) (select temp___272 temp___273))))) (=> (<= 0 i) (dynamic_property 0 i j2))) (and (<= 0 j2) (<= j2 i)))))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= j2 i)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= j2 j3)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= tmp3 tmp4)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= j4 j2)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= tmp5 tmp3)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= (mk_int__ref j5) (mk_int__ref j3))))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= (mk_map__ref tmp6) (mk_map__ref tmp4))))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= j6 j4)))
(assert (=> (and (<= 0 j1) (<= j1 i)) (= tmp7 tmp5)))
(assert (=> (not (and (<= 0 j1) (<= j1 i))) (= j1 j5)))
(assert (=> (not (and (<= 0 j1) (<= j1 i))) (= tmp1 tmp6)))
(assert (=> (not (and (<= 0 j1) (<= j1 i))) (= j6 j1)))
(assert (=> (not (and (<= 0 j1) (<= j1 i))) (= tmp7 tmp1)))
(assert (<= i 1001))
(assert (not (<= 0 i)))
(check-sat)
(exit)
