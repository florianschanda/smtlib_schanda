...
(define-fun dynamic_invariant1 ((temp___expr_305 Int) (temp___is_init_302 Bool) (temp___skip_constant_303 Bool) (temp___do_toplevel_304 Bool)) Bool (=> (or (= temp___is_init_302 true) (<= 0 5)) (in_range1 temp___expr_305)))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq a3 0 5 (temp___881 a j (to_rep (select a k)) k (to_rep (select a j))) 0 5) true)))
(check-sat)
(exit)
