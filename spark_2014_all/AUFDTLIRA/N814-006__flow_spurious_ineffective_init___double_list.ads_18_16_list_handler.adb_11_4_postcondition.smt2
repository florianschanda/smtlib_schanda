...
(assert (forall ((list_handler__integer_list__count Int)) (! (=> (dynamic_invariant list_handler__integer_list__count true true true true) (= (size list_handler__integer_list__count) list_handler__integer_list__count)) :pattern ((size list_handler__integer_list__count)))))
...
(assert (not (= (size (int__content count1)) 0)))
(check-sat)
(exit)
