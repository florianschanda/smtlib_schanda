...
(define-fun a23 () map__ref (mk_map__ref a6))
...
(define-fun a24 () map__ref (mk_map__ref a))
...
(assert (=> (= result1 true) (=> (= result8 true) (= a23 (mk_map__ref a4)))))
...
(assert (=> (= result1 true) (=> (not (= result8 true)) (= a23 a24))))
...
(assert (=> (= result1 true) (=> (not (= result11 true)) (= a9 a23))))
...
(assert (=> (not (= result1 true)) (= a20 a24)))
