...
(define-fun dynamic_invariant ((temp___expr_330 us_t2) (temp___is_init_326 Bool) (temp___skip_constant_327 Bool) (temp___do_toplevel_328 Bool) (temp___do_typ_inv_329 Bool)) Bool (and (=> (not (= temp___skip_constant_327 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_330) (last5 temp___expr_330))) (=> (= temp___do_toplevel_328 true) (=> (= temp___is_init_326 true) (and (let ((temp___332 (of_array (to_array2 temp___expr_330) (first5 temp___expr_330) (last5 temp___expr_330)))) (and (let ((temp___333 (of_array1 (to_array temp___332) (first1 temp___332) (last1 temp___332)))) (and (= (first3 temp___333) 1) (<= 0 (last3 temp___333)))) (<= (last1 temp___332) 1000))) (<= 3 (length2 temp___expr_330)))))))
(define-fun dynamic_predicate ((temp___335 us_t2)) Bool (and (let ((temp___337 (of_array (to_array2 temp___335) (first5 temp___335) (last5 temp___335)))) (and (let ((temp___338 (of_array1 (to_array temp___337) (first1 temp___337) (last1 temp___337)))) (and (= (first3 temp___338) 1) (<= 0 (last3 temp___338)))) (<= (last1 temp___337) 1000))) (<= 3 (length2 temp___335))))
...
(define-fun dynamic_invariant4 ((temp___expr_265 us_t1) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool (and (=> (not (= temp___skip_constant_262 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_265) (last3 temp___expr_265))) (=> (= temp___do_toplevel_263 true) (=> (= temp___is_init_261 true) (and (= (first3 temp___expr_265) 1) (<= 0 (last3 temp___expr_265)))))))
(define-fun dynamic_predicate1 ((temp___268 us_t1)) Bool (and (= (first3 temp___268) 1) (<= 0 (last3 temp___268))))
(define-fun dynamic_invariant5 ((temp___expr_302 us_t) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (and (=> (not (= temp___skip_constant_299 true)) (dynamic_property 1 2147483647 (first1 temp___expr_302) (last1 temp___expr_302))) (=> (= temp___do_toplevel_300 true) (=> (= temp___is_init_298 true) (and (let ((temp___304 (of_array1 (to_array temp___expr_302) (first1 temp___expr_302) (last1 temp___expr_302)))) (and (= (first3 temp___304) 1) (<= 0 (last3 temp___304)))) (<= (last1 temp___expr_302) 1000))))))
(define-fun dynamic_predicate2 ((temp___306 us_t)) Bool (and (let ((temp___308 (of_array1 (to_array temp___306) (first1 temp___306) (last1 temp___306)))) (and (= (first3 temp___308) 1) (<= 0 (last3 temp___308)))) (<= (last1 temp___306) 1000)))
(assert (dynamic_invariant i21s true false false true))
(assert (not (dynamic_property 1 2147483647 (to_rep1 (first4 (rt2 i21s))) (to_rep1 (last4 (rt2 i21s))))))
(check-sat)
(exit)
