...
(define-fun dynamic_invariant ((temp___expr_289 us_t2) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (and (=> (not (= temp___skip_constant_287 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_289) (last5 temp___expr_289))) (=> (= temp___do_toplevel_288 true) (=> (= temp___is_init_286 true) (and (let ((temp___291 (of_array1 (to_array2 temp___expr_289) (first5 temp___expr_289) (last5 temp___expr_289)))) (and (let ((temp___292 (of_array (to_array1 temp___291) (first3 temp___291) (last3 temp___291)))) (and (= (first1 temp___292) 1) (<= 0 (last1 temp___292)))) (<= (last3 temp___291) 1000))) (<= 3 (length2 temp___expr_289)))))))
(define-fun dynamic_predicate ((temp___294 us_t2)) Bool (and (let ((temp___296 (of_array1 (to_array2 temp___294) (first5 temp___294) (last5 temp___294)))) (and (let ((temp___297 (of_array (to_array1 temp___296) (first3 temp___296) (last3 temp___296)))) (and (= (first1 temp___297) 1) (<= 0 (last1 temp___297)))) (<= (last3 temp___296) 1000))) (<= 3 (length2 temp___294))))
...
(define-fun dynamic_invariant4 ((temp___expr_229 us_t) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (and (=> (not (= temp___skip_constant_227 true)) (dynamic_property 1 2147483647 (first1 temp___expr_229) (last1 temp___expr_229))) (=> (= temp___do_toplevel_228 true) (=> (= temp___is_init_226 true) (and (= (first1 temp___expr_229) 1) (<= 0 (last1 temp___expr_229)))))))
(define-fun dynamic_predicate1 ((temp___232 us_t)) Bool (and (= (first1 temp___232) 1) (<= 0 (last1 temp___232))))
(define-fun dynamic_invariant5 ((temp___expr_263 us_t1) (temp___is_init_260 Bool) (temp___skip_constant_261 Bool) (temp___do_toplevel_262 Bool)) Bool (and (=> (not (= temp___skip_constant_261 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_263) (last3 temp___expr_263))) (=> (= temp___do_toplevel_262 true) (=> (= temp___is_init_260 true) (and (let ((temp___265 (of_array (to_array1 temp___expr_263) (first3 temp___expr_263) (last3 temp___expr_263)))) (and (= (first1 temp___265) 1) (<= 0 (last1 temp___265)))) (<= (last3 temp___expr_263) 1000))))))
(define-fun dynamic_predicate2 ((temp___267 us_t1)) Bool (and (let ((temp___269 (of_array (to_array1 temp___267) (first3 temp___267) (last3 temp___267)))) (and (= (first1 temp___269) 1) (<= 0 (last1 temp___269)))) (<= (last3 temp___267) 1000)))
(declare-const temp___332 (Array Int character))
(declare-const temp___3321 t1)
(assert (dynamic_invariant i21s true false false))
