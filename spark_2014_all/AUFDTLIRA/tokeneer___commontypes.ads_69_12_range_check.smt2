...
(declare-datatypes () ((stringf1l3to1000__ref (mk_stringf1l3to1000__ref (stringf1l3to1000__content us_t2)))))
(define-fun stringf1l3to1000__ref___projection ((a stringf1l3to1000__ref)) us_t2 (stringf1l3to1000__content a))
(define-fun dynamic_invariant ((temp___expr_330 us_t2) (temp___is_init_326 Bool) (temp___skip_constant_327 Bool) (temp___do_toplevel_328 Bool) (temp___do_typ_inv_329 Bool)) Bool (and (=> (not (= temp___skip_constant_327 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_330) (last5 temp___expr_330))) (=> (= temp___do_toplevel_328 true) (=> (= temp___is_init_326 true) (and (let ((temp___332 (of_array1 (to_array2 temp___expr_330) (first5 temp___expr_330) (last5 temp___expr_330)))) (and (let ((temp___333 (of_array (to_array1 temp___332) (first3 temp___332) (last3 temp___332)))) (and (= (first1 temp___333) 1) (<= 0 (last1 temp___333)))) (<= (last3 temp___332) 1000))) (<= 3 (length2 temp___expr_330)))))))
(define-fun dynamic_predicate ((temp___335 us_t2)) Bool (and (let ((temp___337 (of_array1 (to_array2 temp___335) (first5 temp___335) (last5 temp___335)))) (and (let ((temp___338 (of_array (to_array1 temp___337) (first3 temp___337) (last3 temp___337)))) (and (= (first1 temp___338) 1) (<= 0 (last1 temp___338)))) (<= (last3 temp___337) 1000))) (<= 3 (length2 temp___335))))
(declare-const i21s us_t2)
...
(assert (dynamic_invariant i21s true false false true))
(assert (not (dynamic_property1 1 2147483647 (to_rep1 (first4 (rt2 i21s))) (to_rep1 (last4 (rt2 i21s))))))
(check-sat)
(exit)
