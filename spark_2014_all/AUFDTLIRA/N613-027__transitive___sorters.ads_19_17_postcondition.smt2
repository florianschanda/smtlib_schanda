...
(assert (not (= (perm (mk___t values (mk (to_rep values__first) (to_rep values__last))) (mk___t (map__content values8) (mk (to_rep values__first) (to_rep values__last)))) true)))
(check-sat)
(exit)
