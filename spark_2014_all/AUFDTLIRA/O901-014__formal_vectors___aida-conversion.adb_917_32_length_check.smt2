...
(assert (not (= (ite (<= (to_rep1 (first4 temp___17561)) (to_rep1 (last4 temp___17561))) (+ (- (to_rep1 (last4 temp___17561)) (to_rep1 (first4 temp___17561))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5)) (+ (- (+ (to_rep1 (first (rt source))) 5) (to_rep1 (first (rt source)))) 1) 0))))
(check-sat)
(exit)
