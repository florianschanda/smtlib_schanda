...
(assert (and (= o53 (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1)) (and (in_range7 o53) (= o53 (get (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c1))))))
(assert (= o54 (ite (= o53 (to_rep (select a1 i))) true false)))
(assert (= o58 (ite (not (= o54 true)) true false)))
(assert (= result7 (ite (= o58 true) o57 false)))
(assert (= result7 true))
