...
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 a__first) i1) (<= i1 k3)) (forall ((j1 Int)) (=> (and (<= i1 j1) (<= j1 k3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i1)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a2 j1))))))))))
...
(assert (forall ((i1 Int)) (=> (and (<= k11 i1) (<= i1 (to_rep1 a__last))) (forall ((j1 Int)) (=> (and (<= i1 j1) (<= j1 (to_rep1 a__last))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a11 j1)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select a11 i1))))))))))
