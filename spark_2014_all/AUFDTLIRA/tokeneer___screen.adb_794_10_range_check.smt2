...
(define-fun dynamic_invariant ((temp___expr_1518 Int) (temp___is_init_1514 Bool) (temp___skip_constant_1515 Bool) (temp___do_toplevel_1516 Bool) (temp___do_typ_inv_1517 Bool)) Bool (=> (or (= temp___is_init_1514 true) (<= 0 2147483647)) (in_range3 temp___expr_1518)))
(declare-sort t2 0)
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (dynamic_invariant1 (statscount_image x) true false true true)) :pattern ((statscount_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (= (statscount_image x) (let ((temp___1535 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___1535) (first1 temp___1535) (last1 temp___1535))))) :pattern ((statscount_image x)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1891 Int) (temp___is_init_1887 Bool) (temp___skip_constant_1888 Bool) (temp___do_toplevel_1889 Bool) (temp___do_typ_inv_1890 Bool)) Bool (=> (or (= temp___is_init_1887 true) (<= 1 10)) (in_range4 temp___expr_1891)))
(assert (forall ((temp___2052 Int)) (=> (dynamic_invariant3 temp___2052 true true true true) (forall ((temp___2053 Int)) (= (to_rep (select (screen__writestatsdata__statscountstring__result__aggregate_def temp___2052) temp___2053)) temp___2052)))))
...
(declare-const temp___2056 (Array Int character))
(declare-const temp___20561 t4)
(declare-const temp___2057 (Array Int character))
(declare-const temp___20571 t3)
...
(define-fun temp___20492 () us_t1 (mk___t1 temp___2049 temp___20491))
(assert (in_range3 value))
(assert (and (= temp___20492 (statscount_image value)) (and (dynamic_invariant1 temp___20492 true false true true) (= temp___20492 (let ((temp___1533 (to_string (attr__ATTRIBUTE_IMAGE3 value)))) (mk___t1 (elts temp___1533) (mk1 (to_rep1 (first (rt temp___1533))) (to_rep1 (last (rt temp___1533))))))))))
(assert (= temp___2049 screen__writestatsdata__statscountstring__data__assume))
(assert (= (mk (to_rep1 (first2 temp___20491)) (to_rep1 (last2 temp___20491))) screen__writestatsdata__statscountstring__data__assume1))
(assert (= result data))
...
(assert (= o data1))
(assert (= o temp___2056))
(assert (= (mk4 2 (to_rep1 data__last)) temp___20561))
(assert (= (ite (<= (to_rep1 (first8 temp___20561)) (to_rep1 (last8 temp___20561))) (+ (- (to_rep1 (last8 temp___20561)) (to_rep1 (first8 temp___20561))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0)))
(assert (= (slide temp___2056 (to_rep1 (first8 temp___20561)) 1) temp___2057))
(assert (= (mk3 1 (- (to_rep1 data__last) 1)) temp___20571))
(assert (and (= temp___2059 (- (to_rep1 data__last) 1)) (in_range (- (to_rep1 data__last) 1))))
(assert (<= 1 temp___2059))
(assert (not (<= 1 1)))
(check-sat)
(exit)
