...
(define-fun dynamic_invariant ((temp___expr_1364 Int) (temp___is_init_1361 Bool) (temp___skip_constant_1362 Bool) (temp___do_toplevel_1363 Bool)) Bool (=> (or (= temp___is_init_1361 true) (<= 0 2147483647)) (in_range3 temp___expr_1364)))
(declare-sort t2 0)
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (= (statscount_image x) (let ((temp___1380 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___1380) (first1 temp___1380) (last1 temp___1380))))) :pattern ((statscount_image x)))))
...
(assert (forall ((temp___1861 Int)) (forall ((temp___1862 Int)) (= (select (screen__writestatsdata__statscountstring__result__aggregate_def temp___1861) temp___1862) (of_rep temp___1861)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1701 Int) (temp___is_init_1698 Bool) (temp___skip_constant_1699 Bool) (temp___do_toplevel_1700 Bool)) Bool (=> (or (= temp___is_init_1698 true) (<= 1 10)) (in_range4 temp___expr_1701)))
...
(declare-const temp___1865 (Array Int character))
(declare-const temp___18651 t4)
(declare-const temp___1866 (Array Int character))
(declare-const temp___18661 t3)
(declare-const temp___1868 Int)
(declare-const o1 (Array Int character))
(declare-const temp___1869 (Array Int character))
(declare-const temp___18691 t3)
...
(assert (and (= (mk___t1 temp___1858 temp___18581) (statscount_image value)) (and (dynamic_invariant1 (mk___t1 temp___1858 temp___18581) true false true) (= (mk___t1 temp___1858 temp___18581) (let ((temp___1378 (to_string (attr__ATTRIBUTE_IMAGE3 value)))) (mk___t1 (elts temp___1378) (mk1 (to_rep1 (first (rt temp___1378))) (to_rep1 (last (rt temp___1378))))))))))
(assert (= temp___1858 screen__writestatsdata__statscountstring__data__assume))
(assert (= (mk (to_rep1 (first2 temp___18581)) (to_rep1 (last2 temp___18581))) screen__writestatsdata__statscountstring__data__assume1))
(assert (= result data))
...
(assert (= o data1))
(assert (= o temp___1865))
(assert (= (mk4 2 (to_rep1 data__last)) temp___18651))
(assert (= (ite (<= (to_rep1 (first8 temp___18651)) (to_rep1 (last8 temp___18651))) (+ (- (to_rep1 (last8 temp___18651)) (to_rep1 (first8 temp___18651))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0)))
(assert (= (slide temp___1865 (to_rep1 (first8 temp___18651)) 1) temp___1866))
(assert (= (mk3 1 (- (to_rep1 data__last) 1)) temp___18661))
(assert (and (= temp___1868 (- (to_rep1 data__last) 1)) (in_range (- (to_rep1 data__last) 1))))
(assert (<= 1 temp___1868))
(assert (not (<= 1 1)))
(check-sat)
(exit)
