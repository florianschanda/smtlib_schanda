...
(assert (forall ((temp___222 Int)) (=> (dynamic_invariant temp___222 true true true true) (forall ((temp___223 Int)) (= (select (rename_aggregate__a__aggregate_def temp___222) temp___223) rliteral)))))
