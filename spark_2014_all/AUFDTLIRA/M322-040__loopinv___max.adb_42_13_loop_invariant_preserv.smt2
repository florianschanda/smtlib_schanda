...
(assert (= i2 result3))
(assert (= i3 (+ i2 1)))
(assert (and (forall ((n6 Int)) (=> (and (<= 1 n6) (<= n6 (- i3 1))) (<= (to_rep (select a n6)) max3))) (exists ((n6 Int)) (and (and (<= 1 n6) (<= n6 (- i3 1))) (= (to_rep (select a n6)) max3)))))
...
(assert (forall ((n6 Int)) (=> (and (<= 1 n6) (<= n6 i3)) (<= (to_rep (select a n6)) m1))))
(assert (exists ((n6 Int)) (and (and (<= 1 n6) (<= n6 i3)) (= (to_rep (select a n6)) m1))))
(assert (not (= m1 max4)))
(check-sat)
(exit)
