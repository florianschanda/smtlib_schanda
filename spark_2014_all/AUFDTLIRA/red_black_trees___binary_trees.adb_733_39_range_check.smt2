...
(assert (= (= result61 true) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) v) i15))) true) (= (is_concat (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) v))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1)) v) i15))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i15)))) true))))))
(assert (= result61 true))
(assert (<= 1 r1))
(assert (<= r1 (to_rep f__split_fields)))
(assert (and (<= 1 r1) (<= r1 100)))
(assert (= o315 r1))
(assert (= o316 (select f_old__split_fields1 o315)))
(assert (= o317 (us_split_fields3 o316)))
(assert (= o318 (rec__binary_trees__cell__position o317)))
(assert (= o319 (to_rep1 o318)))
(assert (= o320 (ite (= o319 2) true false)))
(assert (= result63 (ite (not (= r1 root)) (ite (not (= r1 v)) o320 false) false)))
(assert (= result63 true))
(assert (and (= o323 r1) (in_range1 r1)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o324 r1) (in_range1 r1)))
(assert (and (= o325 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o324)) (and (dynamic_invariant3 o325 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o325 o324))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o325 o324)))) 0) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (not (= i15 o324)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o325 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o325 i15))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o325 i15))) true)))))) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o325 i15))) true) (not (= i15 o324))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o325 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15) (rec__tree_model__path_type__a (us_split_fields1 (select o325 i15)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o325 i15)))) 0)))) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o325 i15))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o325 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select o325 i15))) (rec__tree_model__path_type__a (us_split_fields1 (select o325 j2)))) true)) (= j2 i15))))))))))))))
