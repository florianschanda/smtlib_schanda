...
(assert (= (mk (to_rep (first2 temp___1601)) (to_rep (last2 temp___1601))) o2))
...
(assert (= smallest2 o3))
(assert (forall ((j2 Int)) (=> (and (<= current2 j2) (<= j2 (to_rep values__last))) (<= (to_rep (select values smallest2)) (to_rep (select values j2))))))
(assert (=> (not (= smallest2 current2)) (and (<= (to_rep values__first) smallest2) (<= smallest2 (to_rep values__last)))))
(assert (=> (not (= smallest2 current2)) (= o7 smallest2)))
(assert (=> (not (= smallest2 current2)) (= o8 (select values o7))))
(assert (=> (not (= smallest2 current2)) (= o9 (to_rep o8))))
(assert (=> (not (= smallest2 current2)) (= o9 sorters__swap__y)))
(assert (=> (not (= smallest2 current2)) (and (<= (to_rep values__first) current2) (<= current2 (to_rep values__last)))))
(assert (=> (not (= smallest2 current2)) (= o10 current2)))
(assert (=> (not (= smallest2 current2)) (= o11 (select values o10))))
(assert (=> (not (= smallest2 current2)) (= o12 (to_rep o11))))
(assert (=> (not (= smallest2 current2)) (= o12 sorters__swap__x)))
(assert (=> (not (= smallest2 current2)) (and (and (= sorters__swap__x1 sorters__swap__y) (= sorters__swap__y1 sorters__swap__x)) (and (in_range1 sorters__swap__x1) (in_range1 sorters__swap__y1)))))
(assert (=> (not (= smallest2 current2)) (= (to_rep o13) sorters__swap__x1)))
(assert (=> (not (= smallest2 current2)) (and (<= (to_rep values__first) current2) (<= current2 (to_rep values__last)))))
(assert (=> (not (= smallest2 current2)) (= o14 current2)))
(assert (=> (not (= smallest2 current2)) (= o15 (store values o14 o13))))
(assert (=> (not (= smallest2 current2)) (= values result2)))
(assert (=> (not (= smallest2 current2)) (= values1 o15)))
(assert (=> (not (= smallest2 current2)) (= (to_rep o16) sorters__swap__y1)))
(assert (=> (not (= smallest2 current2)) (and (<= (to_rep values__first) smallest2) (<= smallest2 (to_rep values__last)))))
(assert (=> (not (= smallest2 current2)) (= o17 smallest2)))
(assert (=> (not (= smallest2 current2)) (= o18 (store values1 o17 o16))))
(assert (=> (not (= smallest2 current2)) (= result3 values1)))
(assert (=> (not (= smallest2 current2)) (= values2 o18)))
(assert (=> (= smallest2 current2) (= values2 values)))
(assert (=> (= smallest2 current2) (= sorters__swap__x1 rho1)))
(assert (=> (= smallest2 current2) (= sorters__swap__y1 rho)))
(assert (=> (= smallest2 current2) (= values2 values)))
