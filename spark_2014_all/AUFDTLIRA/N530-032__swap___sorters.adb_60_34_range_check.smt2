...
(assert (= o values))
(assert (= o temp___185))
(assert (= (mk1 current2 (to_rep values__last)) temp___1851))
(assert (= temp___185 o1))
(assert (= (mk (to_rep (first2 temp___1851)) (to_rep (last2 temp___1851))) o2))
...
(assert (=> (not (= smallest2 current2)) (= (to_rep o10) sorters__swap__x1)))
(assert (=> (not (= smallest2 current2)) (and (<= (to_rep values__first) current2) (<= current2 (to_rep values__last)))))
...
(assert (=> (not (= smallest2 current2)) (= (to_rep o13) sorters__swap__y1)))
(assert (=> (not (= smallest2 current2)) (and (<= (to_rep values__first) smallest2) (<= smallest2 (to_rep values__last)))))
