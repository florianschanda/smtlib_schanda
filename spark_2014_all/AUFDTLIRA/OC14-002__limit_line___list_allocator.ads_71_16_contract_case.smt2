...
(assert (=> (= (= (length model____split_fields) 0) true) (and (= (int__content res3) 0) (= (oeq2 (mk___rep1 (us_split_fields__content1 model____split_fields5)) (mk___rep1 (mk___split_fields1 model____split_fields model____split_fields1))) true))))
(assert (not (= (= (length model____split_fields) 0) true)))
(assert (not (= (is_prepend (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields5)) (int__content res3) model____split_fields) true)))
(check-sat)
(exit)
