...
(assert (not (= (is_prepend model____split_fields1 (int__content res3) (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields5))) true)))
(check-sat)
(exit)
