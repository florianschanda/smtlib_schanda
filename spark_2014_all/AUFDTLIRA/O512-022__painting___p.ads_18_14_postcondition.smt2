...
(declare-const temp___2361 (Array Int us_rep))
(declare-const temp___235 Int)
(declare-const temp___233 (Array Int us_rep))
(declare-const temp___2331 (Array Int us_rep))
...
(assert (= c1 0))
(assert (=> (and (<= 0 c1) (<= c1 2)) (and (= p__split_fields temp___236) (= p__split_fields1 temp___2361))))
(assert (=> (and (<= 0 c1) (<= c1 2)) (= temp___235 c1)))
(assert (=> (and (<= 0 c1) (<= c1 2)) (and (= p__split_fields temp___233) (= p__split_fields1 temp___2331))))
(assert (=> (and (<= 0 c1) (<= c1 2)) (and (= (bool_eq1 p__split_fields4 0 2 temp___236 0 2) true) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- c2 1))) (=> (= (bool_eq (select p__split_fields4 j) d) true) (= (bool_eq (select p__split_fields5 j) d) true)))))))
(assert (=> (and (<= 0 c1) (<= c1 2)) (and (and (and (= p__split_fields4 temp___233) (forall ((temp___234 Int)) (=> (and (<= 0 temp___234) (<= temp___234 2)) (=> (<= c2 temp___234) (= (select p__split_fields5 temp___234) (select temp___2331 temp___234)))))) (=> (<= 0 2) (in_range2 c2))) (and (<= 0 c2) (<= c2 2)))))
