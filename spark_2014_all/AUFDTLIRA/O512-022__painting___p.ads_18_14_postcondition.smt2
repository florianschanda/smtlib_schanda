...
(assert (= c1 0))
(assert (=> (and (<= 0 c1) (<= c1 2)) (and (and (and (= p__split_fields temp___210) (= p__split_fields1 temp___2101)) (and (= temp___209 c1) (and (and (= p__split_fields temp___207) (= p__split_fields1 temp___2071)) (and (and (= (bool_eq1 p__split_fields4 0 2 temp___210 0 2) true) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- c2 1))) (=> (= (bool_eq (select p__split_fields4 j) d) true) (= (bool_eq (select p__split_fields5 j) d) true))))) (and (and (and (and (= p__split_fields4 temp___207) (forall ((temp___208 Int)) (=> (and (<= 0 temp___208) (<= temp___208 2)) (=> (<= c2 temp___208) (= (select p__split_fields5 temp___208) (select temp___2071 temp___208)))))) (=> (<= 0 2) (in_range2 c2))) (and (<= 0 c2) (<= c2 2))) (and (ite (= (bool_eq (select p__split_fields4 c2) d) true) (and (and (= result1 p__split_fields4) (= result2 p__split_fields5)) (and (= p__split_fields4 p__split_fields6) (= (store p__split_fields5 c2 d) p__split_fields7))) (= (mk___split_fields1 p__split_fields6 p__split_fields7) (mk___split_fields1 p__split_fields4 p__split_fields5))) (= c2 2))))))) (and (and (= c2 c6) (and (= p__split_fields12 p__split_fields6) (= p__split_fields13 p__split_fields7))) (and (= c7 c2) (= p__split_fields14 (mk___split_fields1 p__split_fields6 p__split_fields7)))))))
(assert (=> (and (<= 0 c1) (<= c1 2)) (= c8 (mk_int__ref c6))))
(assert (=> (and (<= 0 c1) (<= c1 2)) (= p__split_fields15 (mk___split_fields__ref1 (mk___split_fields1 p__split_fields12 p__split_fields13)))))
(assert (=> (and (<= 0 c1) (<= c1 2)) (= c9 c7)))
(assert (=> (and (<= 0 c1) (<= c1 2)) (= p__split_fields16 p__split_fields14)))
(assert (=> (not (and (<= 0 c1) (<= c1 2))) (= c8 (mk_int__ref c1))))
(assert (=> (not (and (<= 0 c1) (<= c1 2))) (= p__split_fields15 (mk___split_fields__ref1 (mk___split_fields1 p__split_fields p__split_fields1)))))
(assert (=> (not (and (<= 0 c1) (<= c1 2))) (= c9 c1)))
(assert (=> (not (and (<= 0 c1) (<= c1 2))) (= p__split_fields16 (mk___split_fields1 p__split_fields2 p__split_fields3))))
(assert (= c10 c8))
...
(assert (<= 0 c12))
(assert (<= c12 2))
(assert (= (bool_eq (select p__split_fields c12) d) true))
(assert (not (= (bool_eq (select (rec__p__painting__shadow (us_split_fields__content1 p__split_fields17)) c12) d) true)))
(check-sat)
(exit)
