...
(assert (= a1 o5))
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k j2)) (= (to_rep (rec__frame__rec__c1 (us_split_fields1 (select a2 k)))) (to_rep (rec__frame__rec__c2 (us_split_fields1 (select a k))))))))
(assert (and (and (=> (<= 1 10) (in_range2 j2)) (forall ((temp___191 Int)) (=> (and (<= 1 temp___191) (<= temp___191 10)) (ite (< j2 temp___191) (= (select a2 temp___191) (select a temp___191)) (= (rec__frame__rec__c2 (us_split_fields1 (select a2 temp___191))) (rec__frame__rec__c2 (us_split_fields1 (select a temp___191)))))))) (and (<= 1 j2) (<= j2 10))))
(assert (not (= j2 10)))
(assert (= result2 j2))
(assert (= j3 (+ j2 1)))
(assert (= (to_rep o6) (to_rep (rec__frame__rec__c2 (us_split_fields1 (select a2 j3))))))
(assert (= o6 o7))
(assert (= (rec__frame__rec__c2 (us_split_fields1 (select a2 j3))) o8))
(assert (= o9 o7))
(assert (= o10 o8))
(assert (= o11 (store a2 j3 (mk___rep (mk___split_fields o9 o10)))))
(assert (= result3 a2))
(assert (= a3 o11))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k j3))
(assert (not (= (to_rep (rec__frame__rec__c1 (us_split_fields1 (select a3 k)))) (to_rep (rec__frame__rec__c2 (us_split_fields1 (select a k)))))))
(check-sat)
(exit)
