...
(assert (and (and (=> (<= 1 10) (in_range2 j2)) (forall ((temp___219 Int)) (=> (and (<= 1 temp___219) (<= temp___219 10)) (ite (or (< 10 temp___219) (or (< temp___219 1) (< j2 temp___219))) (= (select a2 temp___219) (select a temp___219)) (= (rec__frame__rec__c2 (us_split_fields1 (select a2 temp___219))) (rec__frame__rec__c2 (us_split_fields1 (select a temp___219)))))))) (and (<= 1 j2) (<= j2 10))))
(assert (not (= j2 10)))
(assert (= result2 j2))
(assert (= j3 (+ j2 1)))
