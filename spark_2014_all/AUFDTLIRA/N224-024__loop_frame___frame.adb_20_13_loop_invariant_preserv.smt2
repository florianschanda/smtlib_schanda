...
(assert (and (and (=> (<= 1 10) (in_range2 j2)) (forall ((temp___217 Int)) (=> (and (<= 1 temp___217) (<= temp___217 10)) (ite (< j2 temp___217) (= (select a2 temp___217) (select a temp___217)) (= (rec__frame__rec__c2 (us_split_fields1 (select a2 temp___217))) (rec__frame__rec__c2 (us_split_fields1 (select a temp___217)))))))) (and (<= 1 j2) (<= j2 10))))
(assert (not (= j2 10)))
(assert (= result2 j2))
(assert (= j3 (+ j2 1)))
