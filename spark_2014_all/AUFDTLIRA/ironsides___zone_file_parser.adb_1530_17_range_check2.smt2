...
(assert (= i1 r97b))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= temp___1797 endidx8)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= temp___1795 newnameserver1)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= temp___1794 i1)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1797))))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (and (=> (<= r97b r98b) (dynamic_property r97b r98b i2)) (and (<= r97b i2) (<= i2 r98b)))))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= (to_rep o5) (to_rep (select zonefileline i2)))))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (and (= o3 (+ i2 1)) (in_range1 (+ i2 1)))))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= o4 (- o3 begidx11))))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (and (= temp___1793 o4) (in_range1 o4))))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (and (<= 1 temp___1793) (<= temp___1793 128))))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= o6 temp___1793)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= o7 (store newnameserver2 o6 o5))))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= result7 (mk_map__ref newnameserver2))))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= newnameserver3 o7)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= i2 r98b)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= newnameserver4 (mk_map__ref newnameserver3))))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= i4 i2)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= newnameserver5 newnameserver3)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= i5 i3)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= newnameserver6 newnameserver4)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= i6 i4)))
(assert (=> (and (<= r97b i1) (<= i1 r98b)) (= newnameserver7 newnameserver5)))
(assert (=> (not (and (<= r97b i1) (<= i1 r98b))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= r97b i1) (<= i1 r98b))) (= newnameserver6 (mk_map__ref newnameserver1))))
(assert (=> (not (and (<= r97b i1) (<= i1 r98b))) (= i6 i1)))
(assert (=> (not (and (<= r97b i1) (<= i1 r98b))) (= newnameserver7 newnameserver1)))
(assert (= (+ endidx8 1) r100b))
(assert (in_range1 r100b))
(assert (<= r100b 128))
(assert (not (<= (- 2147483648) r100b)))
(check-sat)
(exit)
