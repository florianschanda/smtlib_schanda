...
(define-fun dynamic_invariant ((temp___expr_165 us_rep1) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool)) Bool (and (=> (not (= temp___skip_constant_163 true)) (in_range1 101 temp___expr_165)) (=> (= temp___do_toplevel_164 true) (=> (= temp___is_init_162 true) (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___expr_165)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___expr_165))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___expr_165)))))))))
(define-fun default_initial_assumption ((temp___expr_169 us_rep1) (temp___skip_top_level_170 Bool)) Bool (= (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___expr_169))) 101))
(define-fun dynamic_predicate ((temp___173 us_rep1)) Bool (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___173)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___173))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___173))))))
(declare-const a us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun in_range2 ((rec__with_iterable__cursor__c1 Int) (a1 us_rep1)) Bool (= rec__with_iterable__cursor__c1 (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 a1)))))
(declare-const value__size4 Int)
(declare-fun object__size4 (us_rep1) Int)
(declare-const value__alignment4 Int)
(declare-fun object__alignment4 (us_rep1) Int)
(assert (<= 0 value__size4))
(assert (forall ((a1 us_rep1)) (<= 0 (object__size4 a1))))
(assert (<= 0 value__alignment4))
(assert (forall ((a1 us_rep1)) (<= 0 (object__alignment4 a1))))
...
(declare-datatypes () ((t14s__ref (mk_t14s__ref (t14s__content us_rep1)))))
(define-fun t14s__ref___projection ((a1 t14s__ref)) us_rep1 (t14s__content a1))
(define-fun dynamic_predicate1 ((temp___186 us_rep1)) Bool (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___186)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___186))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___186))))))
...
(define-fun dynamic_invariant2 ((temp___expr_155 us_rep1) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (=> (= temp___do_toplevel_154 true) (=> (= temp___is_init_152 true) (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___expr_155)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___expr_155))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___expr_155))))))))
(define-fun dynamic_predicate2 ((temp___158 us_rep1)) Bool (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___158)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___158))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___158))))))
(declare-const o natural)
(declare-const o1 natural)
(declare-const o2 natural)
(declare-const o3 natural)
(declare-const temp___210 natural)
...
(declare-const temp___211 natural)
(declare-const temp___2111 natural)
(assert (= (to_rep o1) 1))
(assert (= o1 o2))
(assert (= (to_rep o) 101))
(assert (= o o3))
...
(assert (dynamic_predicate1 (mk___rep1 (mk___split_discrs temp___210) (mk___split_fields1 temp___2101))))
(assert (= (mk___rep1 (mk___split_discrs o4) (mk___split_fields1 o5)) (mk___rep1 (mk___split_discrs temp___210) (mk___split_fields1 temp___2101))))
(assert (= (mk___rep1 (mk___split_discrs o6) (mk___split_fields1 o7)) (mk___rep1 (mk___split_discrs o4) (mk___split_fields1 o5))))
(assert (= (mk___rep1 (mk___split_discrs o8) (mk___split_fields1 o9)) (mk___rep1 (mk___split_discrs o6) (mk___split_fields1 o7))))
(assert (= (mk___rep1 (mk___split_discrs temp___211) (mk___split_fields1 temp___2111)) (mk___rep1 (mk___split_discrs o8) (mk___split_fields1 o9))))
(assert (not (dynamic_predicate (mk___rep1 (mk___split_discrs temp___211) (mk___split_fields1 temp___2111)))))
(check-sat)
(exit)
