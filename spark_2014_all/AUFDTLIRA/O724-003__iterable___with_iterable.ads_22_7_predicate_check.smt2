...
(define-fun temp___2112 () us_rep1 (mk___rep1 (mk___split_discrs temp___211) (mk___split_fields1 temp___2111)))
(define-fun o10 () us_rep1 (mk___rep1 (mk___split_discrs o8) (mk___split_fields1 o9)))
(define-fun o11 () us_rep1 (mk___rep1 (mk___split_discrs o6) (mk___split_fields1 o7)))
(define-fun o12 () us_rep1 (mk___rep1 (mk___split_discrs o4) (mk___split_fields1 o5)))
(define-fun temp___2102 () us_rep1 (mk___rep1 (mk___split_discrs temp___210) (mk___split_fields1 temp___2101)))
(assert (= (to_rep o1) 1))
(assert (= o1 o2))
(assert (= (to_rep o) 101))
(assert (= o o3))
...
(assert (not (dynamic_predicate temp___2112)))
(check-sat)
(exit)
