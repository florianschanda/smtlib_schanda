...
(define-fun dynamic_predicate1 ((temp___212 us_rep1)) Bool (and (<= 1 (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___212)))) (<= (to_rep (rec__with_iterable__cursor__i (us_split_fields3 temp___212))) (to_rep (rec__with_iterable__cursor__c (us_split_discrs1 temp___212))))))
...
(declare-const temp___236 natural)
...
(declare-const temp___237 natural)
(declare-const temp___2371 natural)
(define-fun temp___2372 () us_rep1 (mk___rep1 (mk___split_discrs temp___237) (mk___split_fields1 temp___2371)))
...
(define-fun temp___2362 () us_rep1 (mk___rep1 (mk___split_discrs temp___236) (mk___split_fields1 temp___2361)))
(assert (= (to_rep o1) 1))
(assert (= o1 o2))
(assert (= (to_rep o) 101))
(assert (= o o3))
(assert (= temp___236 o3))
(assert (= temp___2361 o2))
(assert (dynamic_predicate1 temp___2362))
(assert (= o12 temp___2362))
(assert (= o11 o12))
(assert (= o10 o11))
(assert (= temp___2372 o10))
(assert (not (dynamic_predicate temp___2372)))
(check-sat)
(exit)
