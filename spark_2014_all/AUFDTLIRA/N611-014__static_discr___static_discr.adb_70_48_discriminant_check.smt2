...
(assert (and (= o18 (to_rep1 (last (rt a)))) (in_range2 (to_rep1 (last (rt a))))))
...
(assert (= o12 o6))
(assert (= o13 o7))
(assert (= (mk___rep (mk___split_discrs o14 o15) (mk___split_fields (mk___t1 o16 o17))) (to_base5 (mk___rep7 (mk___split_discrs o10 o11) (mk___split_fields7 (mk___t5 o12 o13))))))
(assert (not (= (to_rep1 (last (rt a))) (to_rep o14))))
(check-sat)
(exit)
