...
(declare-const temp___832 (Array Int us_rep7))
...
(assert (and (= temp___832 (nb_blacks c81b)) (and (= (bool_eq11 (select temp___832 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___832 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___832 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___832 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___832 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___832 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___832 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___832 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___832 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___832 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c81b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___832 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))))))))))))
(assert (= o32 (select temp___832 c83b)))
