...
(assert (and (= o22 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))))) (and (in_range4 o22) (= o22 (to_rep2 this__split_fields)))))
(assert (not (in_range1 (length by__))))
(check-sat)
(exit)
