...
(assert (and (= o2 (length1 left)) (in_range1 (length1 left))))
(assert (= o3 (+ o2 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))
(assert (not (<= (length1 (mk___t1 o10 o11)) o3)))
(check-sat)
(exit)
