...
(assert (=> (= result23 true) (and (= o32 (root (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (in_range3 o32) (= o32 (to_rep1 t__split_fields))))))
(assert (=> (= result23 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result23 true) (and (= o33 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o33) (= o33 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
...
(assert (=> (= result22 true) (and (= o31 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o31) (= o31 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result22 true) (= result21 (ite (= o31 (+ (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 1)) true false))))
...
(assert (=> (= result20 true) (= (= result19 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (not (= (int__content i14) j1)) (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1) (parent1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j1))))))))
(assert (=> (not (= result20 true)) (= result19 false)))
(assert (=> (= result19 true) (= (= result18 true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (and (not (= (int__content i14) j1)) (not (= (parent1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1) 0))) (= (position1 (mk___rep3 (us_split_fields__content3 t__split_fields14)) j1) (position1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)) j1))))))))
