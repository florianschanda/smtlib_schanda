...
(assert (not (= num 1)))
(assert (= (to_rep o18) 0))
(assert (= o19 (mk___split_fields1 o18 (temp___216 0 0 0 0))))
(assert (= o20 (mk___rep1 o19)))
(assert (= o21 (mk___split_fields2 dummy2 o20)))
(assert (= (to_rep o17) 1))
(assert (= o22 (mk___split_discrs o17)))
(assert (= temp___223 (mk___rep2 o22 o21 true)))
(assert (= output__attr__constrained true))
(assert (not (= (rec__use_unchecked_union__myunion__discr (us_split_discrs1 temp___223)) output__split_discrs)))
(check-sat)
(exit)
