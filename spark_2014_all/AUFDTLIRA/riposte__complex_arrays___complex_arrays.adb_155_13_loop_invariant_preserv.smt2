...
(assert (<= j2 i))
(assert (= (to_rep o) (- 23)))
(assert (= o1 (store tmp1 j2 o)))
(assert (= tmp1 result2))
(assert (= tmp2 o1))
(assert (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 j3)) (=> (<= k2 j3) (= (to_rep (select tmp3 k2)) (- 23))))))
(assert (and (and (forall ((temp___243 Int)) (=> (and (<= 0 temp___243) (<= temp___243 1001)) (=> (< j3 temp___243) (= (select tmp3 temp___243) (select tmp1 temp___243))))) (=> (<= 0 i) (dynamic_property 0 i j3))) (and (<= 0 j3) (<= j3 i))))
(assert (not (= j3 i)))
(assert (= result3 j3))
(assert (= j4 (+ j3 1)))
(assert (= (to_rep o2) (- 23)))
(assert (= o3 (store tmp3 j4 o2)))
(assert (= result4 tmp3))
(assert (= tmp4 o3))
...
(assert (<= k2 j4))
(assert (<= k2 j4))
(assert (not (= (to_rep (select tmp4 k2)) (- 23))))
(check-sat)
(exit)
