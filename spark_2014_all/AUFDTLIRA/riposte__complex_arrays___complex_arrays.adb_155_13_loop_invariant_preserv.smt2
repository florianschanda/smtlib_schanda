...
(assert (and (and (forall ((temp___271 Int)) (=> (and (<= 0 temp___271) (<= temp___271 1001)) (=> (< j2 temp___271) (= (select tmp3 temp___271) (select tmp1 temp___271))))) (=> (<= 0 i) (dynamic_property 0 i j2))) (and (<= 0 j2) (<= j2 i))))
(assert (not (= j2 i)))
(assert (= result3 j2))
(assert (= j3 (+ j2 1)))
(assert (= (to_rep o2) (- 23)))
