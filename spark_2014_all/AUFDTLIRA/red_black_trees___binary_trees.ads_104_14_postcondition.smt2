...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) i1))) true) (forall ((d1 Int)) (=> (and (<= 0 d1) (<= d1 1)) (=> (= (peek f i1 d1) 0) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) j))) true) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j)))) true)) (not (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i1)))) 1)) d1))))))))))))
(declare-const j Int)
(assert (<= 1 j))
(assert (<= j 100))
