...
(assert (<= 1 j1))
(assert (<= j1 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) j1))) true))
(assert (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j1)))) true))
(assert (not (not (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j1))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i)))) 1)) d))))
(check-sat)
(exit)
