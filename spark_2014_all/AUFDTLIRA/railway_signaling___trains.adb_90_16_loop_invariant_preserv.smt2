...
(assert (not (= id6 3)))
(assert (= result11 (mk_int__ref id6)))
(assert (= id7 (+ id6 1)))
(assert (and (= o7 (get_previous_track cur_position id7)) (and (in_range1 o7) (= o7 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_end (us_split_fields3 cur_position)))))))) id7))))))
(assert (= result12 (mk_int__ref prev3)))
(assert (= prev4 o7))
(assert (=> (not (= prev4 0)) (and (<= 1 prev4) (<= prev4 8))))
(assert (=> (not (= prev4 0)) (= o8 prev4)))
(assert (=> (not (= prev4 0)) (= o9 (select track_signals4 o8))))
(assert (=> (not (= prev4 0)) (= o10 (to_rep5 o9))))
(assert (=> (not (= prev4 0)) (= result13 (ite (= o10 1) true false))))
(assert (=> (= prev4 0) (= result13 false)))
(assert (=> (= result13 true) (and (= o11 prev4) (in_range2 prev4))))
(assert (=> (= result13 true) (and (ite (exists ((t1 Int)) (and (and (<= 1 t1) (<= t1 cur_num_trains)) (= (is_previous_track (select trains3 t1) o11) true))) (= (to_rep5 (select track_signals5 o11)) 1) (= (to_rep5 (select track_signals5 o11)) 0)) (forall ((other_track Int)) (=> (and (<= 1 other_track) (<= other_track 8)) (=> (not (= other_track o11)) (= (to_rep5 (select track_signals5 other_track)) (to_rep5 (select track_signals4 other_track)))))))))
(assert (=> (not (= result13 true)) (= track_signals5 track_signals4)))
(declare-const j1 Int)
(assert (<= 1 j1))
(assert (<= j1 8))
(assert (= (to_rep5 (select track_signals2 j1)) 2))
(assert (not (= (to_rep5 (select track_signals5 j1)) 2)))
(check-sat)
(exit)
