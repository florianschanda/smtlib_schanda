...
(assert (= id3 (+ id2 1)))
(assert (and (= o7 (get_previous_track cur_position id3)) (and (in_range1 o7) (= o7 (to_rep3 (select (select previous_tracks (to_rep1 (rec__trains__track__from (us_split_fields1 (select tracks (to_rep (rec__trains__train_position__track_end (us_split_fields3 cur_position)))))))) id3))))))
