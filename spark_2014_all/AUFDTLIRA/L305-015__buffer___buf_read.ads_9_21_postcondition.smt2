...
(assert (=> (= pointer max_read) (and (and (and (<= (to_rep1 o) buf_read__read__count) (<= buf_read__read__count (to_rep1 o1))) (forall ((index Int)) (=> (and (<= (to_rep1 o) index) (<= index (- (+ (to_rep1 o) buf_read__read__count) 1))) (= (valid (to_rep (select buf_read__read__b index))) true)))) (in_range3 buf_read__read__count))))
...
(assert (=> (= pointer max_read) (and (= o2 buf_read__read__count) (in_range2 buf_read__read__count))))
...
(assert (=> (not (= pointer max_read)) (and (= o3 (+ pointer 1)) (in_range2 (+ pointer 1)))))
