...
(assert (=> (= (to_rep4 (rec__file_io__read_result__status next_read__split_discrs8)) 0) (= result12 (ite (= (to_rep (rec__file_io__read_result__c next_read__split_fields8)) 34) true false))))
(assert (=> (not (= (to_rep4 (rec__file_io__read_result__status next_read__split_discrs8)) 0)) (= result12 false)))
(assert (not (= result12 true)))
(assert (not (= (local_invariant the_file8 current_read__split_fields8 current_read__split_discrs8 current_idx8 next_read__split_fields8 next_read__split_discrs8 next_idx8) true)))
(check-sat)
(exit)
