...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_198 us_void_param) 1)) 47) :pattern ((temp___String_Literal_198 us_void_param)))))
(declare-fun temp___String_Literal_200 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_200 us_void_param) 1)) 42) :pattern ((temp___String_Literal_200 us_void_param)))))
(declare-fun temp___String_Literal_202 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_202 us_void_param) 1)) 45) :pattern ((temp___String_Literal_202 us_void_param)))))
(declare-fun temp___String_Literal_204 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_204 us_void_param) 1)) 43) :pattern ((temp___String_Literal_204 us_void_param)))))
...
(assert (not (= (bool_eq (elts op) (to_rep1 (first (rt op))) (to_rep1 (last (rt op))) (temp___String_Literal_204 Tuple0) 1 1) true)))
(assert (not (= (bool_eq (elts op) (to_rep1 (first (rt op))) (to_rep1 (last (rt op))) (temp___String_Literal_202 Tuple0) 1 1) true)))
(assert (not (= (bool_eq (elts op) (to_rep1 (first (rt op))) (to_rep1 (last (rt op))) (temp___String_Literal_200 Tuple0) 1 1) true)))
(assert (not (= (bool_eq (elts op) (to_rep1 (first (rt op))) (to_rep1 (last (rt op))) (temp___String_Literal_198 Tuple0) 1 1) true)))
(check-sat)
(exit)
