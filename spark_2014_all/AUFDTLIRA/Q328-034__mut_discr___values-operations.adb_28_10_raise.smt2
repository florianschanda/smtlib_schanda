...
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_172 us_void_param) 1)) 47) :pattern ((temp___String_Literal_172 us_void_param)))))
(declare-fun temp___String_Literal_174 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_174 us_void_param) 1)) 42) :pattern ((temp___String_Literal_174 us_void_param)))))
(declare-fun temp___String_Literal_176 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_176 us_void_param) 1)) 45) :pattern ((temp___String_Literal_176 us_void_param)))))
(declare-fun temp___String_Literal_178 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_178 us_void_param) 1)) 43) :pattern ((temp___String_Literal_178 us_void_param)))))
...
(assert (dynamic_invariant op true false true))
(assert (not (= (bool_eq (elts op) (to_rep1 (first (rt op))) (to_rep1 (last (rt op))) (temp___String_Literal_178 Tuple0) 1 1) true)))
