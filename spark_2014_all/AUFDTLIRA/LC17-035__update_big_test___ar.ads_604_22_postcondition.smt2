...
(define-fun dynamic_invariant3 ((temp___expr_170 Int) (temp___is_init_167 Bool) (temp___skip_constant_168 Bool) (temp___do_toplevel_169 Bool)) Bool (=> (or (= temp___is_init_167 true) (<= 90 99)) (in_range3 temp___expr_170)))
(declare-sort et1 0)
...
(define-fun dynamic_invariant4 ((temp___expr_176 Int) (temp___is_init_173 Bool) (temp___skip_constant_174 Bool) (temp___do_toplevel_175 Bool)) Bool (=> (or (= temp___is_init_173 true) (<= 0 99)) (in_range4 temp___expr_176)))
...
(declare-fun temp___2306 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(assert (forall ((temp___2308 (Array Int (Array Int (Array Int (Array Int et1)))))) (forall ((temp___2309 Int) (temp___2311 Int)) (forall ((temp___2310 (Array Int (Array Int (Array Int et1)))) (temp___2312 (Array Int (Array Int (Array Int et1))))) (let ((temp___2307 (temp___2306 temp___2308 temp___2309 temp___2310 temp___2311 temp___2312))) (forall ((temp___2313 Int)) (ite (= temp___2313 temp___2311) (= (select temp___2307 temp___2313) temp___2312) (ite (= temp___2313 temp___2309) (= (select temp___2307 temp___2313) temp___2310) (= (select temp___2307 temp___2313) (select temp___2308 temp___2313))))))))))
(declare-fun temp___2314 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___2316 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2317 Int)) (forall ((temp___2318 (Array Int (Array Int et1)))) (let ((temp___2315 (temp___2314 temp___2316 temp___2317 temp___2318))) (forall ((temp___2319 Int)) (ite (= temp___2319 temp___2317) (= (select temp___2315 temp___2319) temp___2318) (= (select temp___2315 temp___2319) (select temp___2316 temp___2319)))))))))
(declare-fun temp___2321 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___2323 (Array Int (Array Int et1)))) (forall ((temp___2324 Int)) (forall ((temp___2325 (Array Int et1))) (let ((temp___2322 (temp___2321 temp___2323 temp___2324 temp___2325))) (forall ((temp___2326 Int)) (ite (= temp___2326 temp___2324) (= (select temp___2322 temp___2326) temp___2325) (= (select temp___2322 temp___2326) (select temp___2323 temp___2326)))))))))
(declare-fun temp___2329 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___2331 (Array Int et1))) (forall ((temp___2332 Int) (temp___2333 Int)) (let ((temp___2330 (temp___2329 temp___2331 temp___2332 temp___2333))) (forall ((temp___2334 Int)) (ite (= temp___2334 temp___2332) (= (select temp___2330 temp___2334) (of_rep temp___2333)) (= (select temp___2330 temp___2334) (select temp___2331 temp___2334))))))))
(declare-fun temp___2338 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(assert (forall ((temp___2340 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2341 Int)) (forall ((temp___2342 (Array Int (Array Int et1)))) (let ((temp___2339 (temp___2338 temp___2340 temp___2341 temp___2342))) (forall ((temp___2343 Int)) (ite (= temp___2343 temp___2341) (= (select temp___2339 temp___2343) temp___2342) (= (select temp___2339 temp___2343) (select temp___2340 temp___2343)))))))))
(declare-fun temp___2345 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(assert (forall ((temp___2347 (Array Int (Array Int et1)))) (forall ((temp___2348 Int)) (forall ((temp___2349 (Array Int et1))) (let ((temp___2346 (temp___2345 temp___2347 temp___2348 temp___2349))) (forall ((temp___2350 Int)) (ite (= temp___2350 temp___2348) (= (select temp___2346 temp___2350) temp___2349) (= (select temp___2346 temp___2350) (select temp___2347 temp___2350)))))))))
(declare-fun temp___2353 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___2355 (Array Int et1))) (forall ((temp___2356 Int) (temp___2357 Int)) (let ((temp___2354 (temp___2353 temp___2355 temp___2356 temp___2357))) (forall ((temp___2358 Int)) (ite (= temp___2358 temp___2356) (= (select temp___2354 temp___2358) (of_rep temp___2357)) (= (select temp___2354 temp___2358) (select temp___2355 temp___2358))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq3 a3 90 99 (temp___2306 a l1 (temp___2314 (select a l1) k1 (temp___2321 (select (select a l1) k1) j1 (temp___2329 (select (select (select a l1) k1) j1) i1 e))) l2 (temp___2338 (select a l2) k2 (temp___2345 (select (select a l2) k2) j2 (temp___2353 (select (select (select a l2) k2) j2) i2 f)))) 90 99) true)))
(check-sat)
(exit)
