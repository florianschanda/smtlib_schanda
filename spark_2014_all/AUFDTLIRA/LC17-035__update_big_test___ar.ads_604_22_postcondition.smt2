...
(declare-fun temp_____aggregate_def_2365 ((Array Int (Array Int (Array Int (Array Int et1)))) Int (Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int (Array Int et1)))) (Array Int (Array Int (Array Int (Array Int et1)))))
(declare-fun temp_____aggregate_def_2373 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_2380 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_2388 ((Array Int et1) Int Int) (Array Int et1))
(declare-fun temp_____aggregate_def_2397 ((Array Int (Array Int (Array Int et1))) Int (Array Int (Array Int et1))) (Array Int (Array Int (Array Int et1))))
(declare-fun temp_____aggregate_def_2404 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
(declare-fun temp_____aggregate_def_2412 ((Array Int et1) Int Int) (Array Int et1))
(assert (forall ((temp___2367 (Array Int (Array Int (Array Int (Array Int et1)))))) (forall ((temp___2368 Int) (temp___2370 Int)) (forall ((temp___2369 (Array Int (Array Int (Array Int et1)))) (temp___2371 (Array Int (Array Int (Array Int et1))))) (let ((temp___2366 (temp_____aggregate_def_2365 temp___2367 temp___2368 temp___2369 temp___2370 temp___2371))) (=> (and (dynamic_invariant3 temp___2368 true true true true) (dynamic_invariant3 temp___2370 true true true true)) (forall ((temp___2372 Int)) (ite (= temp___2372 temp___2370) (= (select temp___2366 temp___2372) temp___2371) (ite (= temp___2372 temp___2368) (= (select temp___2366 temp___2372) temp___2369) (= (select temp___2366 temp___2372) (select temp___2367 temp___2372)))))))))))
(assert (forall ((temp___2375 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2376 Int)) (forall ((temp___2377 (Array Int (Array Int et1)))) (let ((temp___2374 (temp_____aggregate_def_2373 temp___2375 temp___2376 temp___2377))) (=> (dynamic_invariant2 temp___2376 true true true true) (forall ((temp___2378 Int)) (ite (= temp___2378 temp___2376) (= (select temp___2374 temp___2378) temp___2377) (= (select temp___2374 temp___2378) (select temp___2375 temp___2378))))))))))
(assert (forall ((temp___2382 (Array Int (Array Int et1)))) (forall ((temp___2383 Int)) (forall ((temp___2384 (Array Int et1))) (let ((temp___2381 (temp_____aggregate_def_2380 temp___2382 temp___2383 temp___2384))) (=> (dynamic_invariant1 temp___2383 true true true true) (forall ((temp___2385 Int)) (ite (= temp___2385 temp___2383) (= (select temp___2381 temp___2385) temp___2384) (= (select temp___2381 temp___2385) (select temp___2382 temp___2385))))))))))
(assert (forall ((temp___2390 (Array Int et1))) (forall ((temp___2391 Int) (temp___2392 Int)) (let ((temp___2389 (temp_____aggregate_def_2388 temp___2390 temp___2391 temp___2392))) (=> (and (dynamic_invariant temp___2391 true true true true) (dynamic_invariant4 temp___2392 true true true true)) (forall ((temp___2393 Int)) (ite (= temp___2393 temp___2391) (= (to_rep (select temp___2389 temp___2393)) temp___2392) (= (select temp___2389 temp___2393) (select temp___2390 temp___2393)))))))))
(assert (forall ((temp___2399 (Array Int (Array Int (Array Int et1))))) (forall ((temp___2400 Int)) (forall ((temp___2401 (Array Int (Array Int et1)))) (let ((temp___2398 (temp_____aggregate_def_2397 temp___2399 temp___2400 temp___2401))) (=> (dynamic_invariant2 temp___2400 true true true true) (forall ((temp___2402 Int)) (ite (= temp___2402 temp___2400) (= (select temp___2398 temp___2402) temp___2401) (= (select temp___2398 temp___2402) (select temp___2399 temp___2402))))))))))
(assert (forall ((temp___2406 (Array Int (Array Int et1)))) (forall ((temp___2407 Int)) (forall ((temp___2408 (Array Int et1))) (let ((temp___2405 (temp_____aggregate_def_2404 temp___2406 temp___2407 temp___2408))) (=> (dynamic_invariant1 temp___2407 true true true true) (forall ((temp___2409 Int)) (ite (= temp___2409 temp___2407) (= (select temp___2405 temp___2409) temp___2408) (= (select temp___2405 temp___2409) (select temp___2406 temp___2409))))))))))
(assert (forall ((temp___2414 (Array Int et1))) (forall ((temp___2415 Int) (temp___2416 Int)) (let ((temp___2413 (temp_____aggregate_def_2412 temp___2414 temp___2415 temp___2416))) (=> (and (dynamic_invariant temp___2415 true true true true) (dynamic_invariant4 temp___2416 true true true true)) (forall ((temp___2417 Int)) (ite (= temp___2417 temp___2415) (= (to_rep (select temp___2413 temp___2417)) temp___2416) (= (select temp___2413 temp___2417) (select temp___2414 temp___2417)))))))))
...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (not (= (bool_eq3 a3 90 99 (temp_____aggregate_def_2365 a l1 (temp_____aggregate_def_2373 (select a l1) k1 (temp_____aggregate_def_2380 (select (select a l1) k1) j1 (temp_____aggregate_def_2388 (select (select (select a l1) k1) j1) i1 e))) l2 (temp_____aggregate_def_2397 (select a l2) k2 (temp_____aggregate_def_2404 (select (select a l2) k2) j2 (temp_____aggregate_def_2412 (select (select (select a l2) k2) j2) i2 f)))) 90 99) true)))
(check-sat)
(exit)
