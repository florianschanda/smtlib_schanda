...
(assert (<= 1 i2))
(assert (<= i2 100))
(assert (and (= o24 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) (in_range2 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t))))))
(assert (not (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t)) o24) true)))
(check-sat)
(exit)
