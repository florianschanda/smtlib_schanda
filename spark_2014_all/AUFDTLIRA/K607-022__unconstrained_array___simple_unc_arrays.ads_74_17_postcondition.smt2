...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= temp___969 i1)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= temp___968 pos1)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i2 1))) (not (= (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)) v))))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (and (and (=> (<= 0 2147483647) (in_range1 pos2)) (=> (<= 1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))) (dynamic_property2 1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (or (and (and (= pos3 pos4) (= pos5 pos3)) (and (and (and (and (and (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= o i2)) (= o1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o))) (= o2 (to_rep2 o1))) (= result2 (ite (= o2 v) true false))) (and (= result2 true) (and (= pos2 result3) (= pos3 i2))))) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= o i2)) (= o1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o))) (= o2 (to_rep2 o1))) (= result2 (ite (= o2 v) true false))) (and (not (= result2 true)) (= pos3 pos2))) (and (and (= pos3 pos4) (= pos5 pos3)) (= i2 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= i2 i3)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= pos13 (mk_int__ref pos4))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= i4 i2)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= pos7 pos5)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= i9 (mk_int__ref i3))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= pos12 pos13)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= i6 i4)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= pos9 pos7)))
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))) (= i1 i5)))
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))) (= pos1 pos8)))
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))) (= i6 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))) (= pos9 pos1)))
...
(assert (not (or (and (= simple_unc_arrays__search__result4 0) (= (not_in a v 1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))) true)) (and (= (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) simple_unc_arrays__search__result4)) v) (= (not_in a v 1 (- simple_unc_arrays__search__result4 1)) true)))))
(check-sat)
(exit)
