...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= temp___974 i1)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= temp___973 pos1)))
