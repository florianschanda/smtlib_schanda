...
(assert (in_range2 v))
(assert (and (and (and (= us (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))) (in_range1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (and (and (= (mk_int__ref result) (mk_int__ref pos)) (= pos1 0)) (and (in_range1 pos1) (and (and (and (= (mk_int__ref result1) (mk_int__ref i)) (= i1 1)) (ite (and (<= 1 i1) (<= i1 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (and (and (and (= temp___889 i1) (and (= temp___888 pos1) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (not (= (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j1)) v)))) (and (and (and (=> (<= 0 2147483647) (in_range1 pos2)) (=> (<= 1 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))) (dynamic_property2 1 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))) (or (and (and (= pos3 pos4) (= pos5 pos3)) (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= o i2)) (= o1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o))) (= o2 (to_rep1 o1))) (= result2 (ite (= o2 v) true false))) (and (= result2 true) (and (= pos2 result3) (= pos3 i2))))) (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= o i2)) (= o1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o))) (= o2 (to_rep1 o1))) (= result2 (ite (= o2 v) true false))) (and (not (= result2 true)) (= pos3 pos2))) (and (and (= pos3 pos4) (= pos5 pos3)) (= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))))))))) (and (and (= i2 i6) (= (mk_int__ref pos8) (mk_int__ref pos4))) (and (= i7 i2) (= pos9 pos5)))) (and (and (= (mk_int__ref i8) (mk_int__ref i6)) (= (mk_int__ref pos10) (mk_int__ref pos8))) (and (= i9 i7) (= pos11 pos9)))) (and (and (= i1 i8) (= pos1 pos10)) (and (= i9 i1) (= pos11 pos1))))) (and (and (= simple_unc_arrays__search__result1 simple_unc_arrays__search__result2) (= simple_unc_arrays__search__result3 simple_unc_arrays__search__result1)) (and (= (mk_int__ref result5) (mk_int__ref simple_unc_arrays__search__result)) (= simple_unc_arrays__search__result1 pos10))))))) (and (and (= (mk_int__ref simple_unc_arrays__search__result4) (mk_int__ref simple_unc_arrays__search__result2)) (and (= (mk_int__ref i10) (mk_int__ref i8)) (= (mk_int__ref pos12) (mk_int__ref pos10)))) (and (= simple_unc_arrays__search__result5 simple_unc_arrays__search__result3) (and (= i11 i9) (= pos13 pos11))))))
(assert (= result8 simple_unc_arrays__search__result4))
(assert (not (or (and (= simple_unc_arrays__search__result4 0) (= (not_in a v 1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))) true)) (and (= (to_rep1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) simple_unc_arrays__search__result4)) v) (= (not_in a v 1 (- simple_unc_arrays__search__result4 1)) true)))))
(check-sat)
(exit)
