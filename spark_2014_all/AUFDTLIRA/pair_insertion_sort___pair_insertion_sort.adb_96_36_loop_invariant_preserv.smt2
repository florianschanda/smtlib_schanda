...
(define-fun a16 () map__ref (mk_map__ref a6))
...
(assert (=> (= result8 true) (= temp___288 a)))
(assert (=> (= result8 true) (= temp___285 j1)))
...
(assert (=> (= result8 true) (and (and (= (is_perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a2 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a2 o14)) (to_rep (select a o15))) (and (= (to_rep (select a2 o15)) (to_rep (select a o14))) (forall ((z3 Int)) (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last))) (=> (and (not (= z3 o14)) (not (= z3 o15))) (= (to_rep (select a2 z3)) (to_rep (select a z3))))))))) (= (to_rep a__first) 0))))
...
(assert (=> (= result11 true) (and (and (= (is_perm (mk___t a6 (mk (to_rep a__first) (to_rep a__last))) (mk___t a8 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a8 o26)) (to_rep (select a6 o28))) (and (= (to_rep (select a8 o28)) (to_rep (select a6 o26))) (forall ((z3 Int)) (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last))) (=> (and (not (= z3 o26)) (not (= z3 o28))) (= (to_rep (select a8 z3)) (to_rep (select a6 z3))))))))) (= (to_rep a__first) 0))))
(assert (=> (= result11 true) (= a9 (mk_map__ref a8))))
(assert (=> (= result11 true) (= a10 a8)))
(assert (=> (not (= result11 true)) (= a9 a16)))
...
(assert (and (and (= (is_perm (mk___t (map__content a9) (mk (to_rep a__first) (to_rep a__last))) (mk___t a11 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a11 o33)) (to_rep (select (map__content a9) o34))) (and (= (to_rep (select a11 o34)) (to_rep (select (map__content a9) o33))) (forall ((z3 Int)) (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last))) (=> (and (not (= z3 o33)) (not (= z3 o34))) (= (to_rep (select a11 z3)) (to_rep (select (map__content a9) z3))))))))) (= (to_rep a__first) 0)))
(assert (and (<= 0 j8) (<= j8 (- (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0) 3))))
(assert (= (sorted (mk___t a12 (mk (to_rep a__first) (to_rep a__last))) 0 (- j8 1)) true))
(assert (= (sorted (mk___t a12 (mk (to_rep a__first) (to_rep a__last))) (+ j8 1) (+ i1 1)) true))
(assert (=> (< 0 j8) (<= (to_rep (select a12 (- j8 1))) (to_rep (select a12 (+ j8 1))))))
...
(assert (and (= o35 (- j8 1)) (in_range1 (- j8 1))))
(assert (= result13 (mk_int__ref j8)))
(assert (= j9 o35))
(assert (=> (<= 0 j9) (and (<= (to_rep a__first) j9) (<= j9 (to_rep a__last)))))
(assert (=> (<= 0 j9) (= o36 j9)))
(assert (=> (<= 0 j9) (= o37 (select a12 o36))))
(assert (=> (<= 0 j9) (= o38 (to_rep o37))))
(assert (=> (<= 0 j9) (= o39 (ite (< y2 o38) true false))))
(assert (=> (not (<= 0 j9)) (= o39 false)))
(assert (= result14 (ite (not (= o39 true)) true false)))
(assert (not (= result14 true)))
(assert (and (= o42 j9) (in_range2 j9)))
(assert (and (= o40 (+ j9 1)) (in_range1 (+ j9 1))))
(assert (and (= o41 o40) (in_range2 o40)))
(assert (and (and (= (is_perm (mk___t a12 (mk (to_rep a__first) (to_rep a__last))) (mk___t a13 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a13 o41)) (to_rep (select a12 o42))) (and (= (to_rep (select a13 o42)) (to_rep (select a12 o41))) (forall ((z3 Int)) (=> (and (<= (to_rep a__first) z3) (<= z3 (to_rep a__last))) (=> (and (not (= z3 o41)) (not (= z3 o42))) (= (to_rep (select a13 z3)) (to_rep (select a12 z3))))))))) (= (to_rep a__first) 0)))
(assert (= j10 (mk_int__ref j9)))
(assert (= a14 (mk_map__ref a13)))
(assert (= j11 j9))
(assert (= a15 a13))
(assert (not (= (sorted (mk___t (map__content a14) (mk (to_rep a__first) (to_rep a__last))) (+ (int__content j10) 1) (+ i1 1)) true)))
(check-sat)
(exit)
