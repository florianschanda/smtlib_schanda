...
(assert (and (= o58 (int__content j9)) (in_range2 (int__content j9))))
(assert (and (= o56 (+ (int__content j9) 1)) (in_range1 (+ (int__content j9) 1))))
(assert (and (= o57 o56) (in_range2 o56)))
(assert (and (and (= (is_perm (mk___t (map__content a12) (mk (to_rep a__first) (to_rep a__last))) (mk___t a14 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a14 o57)) (to_rep (select (map__content a12) o58))) (and (= (to_rep (select a14 o58)) (to_rep (select (map__content a12) o57))) (forall ((z15 Int)) (=> (and (<= (to_rep a__first) z15) (<= z15 (to_rep a__last))) (=> (and (not (= z15 o57)) (not (= z15 o58))) (= (to_rep (select a14 z15)) (to_rep (select (map__content a12) z15))))))))) (= (to_rep a__first) 0)))
(assert (and (<= 0 j11) (<= j11 (- (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0) 3))))
(assert (= (sorted (mk___t a15 (mk (to_rep a__first) (to_rep a__last))) 0 (- j11 1)) true))
(assert (= (sorted (mk___t a15 (mk (to_rep a__first) (to_rep a__last))) (+ j11 1) (+ i1 1)) true))
(assert (=> (< 0 j11) (<= (to_rep (select a15 (- j11 1))) (to_rep (select a15 (+ j11 1))))))
(assert (< y3 (to_rep (select a15 (+ j11 1)))))
(assert (= (is_perm (mk___t (elts1 b) (mk (to_rep (first2 (rt1 b))) (to_rep (last2 (rt1 b))))) (mk___t a15 (mk (to_rep a__first) (to_rep a__last)))) true))
(assert (= (to_rep (select a15 j11)) y3))
(assert (and (=> (<= (- 2147483648) 2147483647) (in_range1 j11)) (= (to_rep a__first) 0)))
(assert (and (= o67 (- j11 1)) (in_range1 (- j11 1))))
(assert (= result13 (mk_int__ref j11)))
(assert (= j12 o67))
(assert (=> (<= 0 j12) (and (<= (to_rep a__first) j12) (<= j12 (to_rep a__last)))))
(assert (=> (<= 0 j12) (= o68 j12)))
(assert (=> (<= 0 j12) (= o69 (select a15 o68))))
(assert (=> (<= 0 j12) (= o70 (to_rep o69))))
(assert (=> (<= 0 j12) (= o71 (ite (< y3 o70) true false))))
(assert (=> (not (<= 0 j12)) (= o71 false)))
(assert (= result14 (ite (not (= o71 true)) true false)))
(assert (not (= result14 true)))
(assert (and (= o74 j12) (in_range2 j12)))
(assert (and (= o72 (+ j12 1)) (in_range1 (+ j12 1))))
(assert (and (= o73 o72) (in_range2 o72)))
(assert (and (and (= (is_perm (mk___t a15 (mk (to_rep a__first) (to_rep a__last))) (mk___t a16 (mk (to_rep a__first) (to_rep a__last)))) true) (and (= (to_rep (select a16 o73)) (to_rep (select a15 o74))) (and (= (to_rep (select a16 o74)) (to_rep (select a15 o73))) (forall ((z15 Int)) (=> (and (<= (to_rep a__first) z15) (<= z15 (to_rep a__last))) (=> (and (not (= z15 o73)) (not (= z15 o74))) (= (to_rep (select a16 z15)) (to_rep (select a15 z15))))))))) (= (to_rep a__first) 0)))
(assert (= j13 (mk_int__ref j12)))
(assert (= a17 (mk_map__ref a16)))
(assert (= j14 j12))
(assert (= a18 a16))
(assert (not (= (sorted (mk___t (map__content a17) (mk (to_rep a__first) (to_rep a__last))) (+ (int__content j13) 1) (+ i1 1)) true)))
(check-sat)
(exit)
