...
(define-fun tab35 () map__ref (mk_map__ref tab))
(assert (in_range1 a))
(assert (in_range1 b))
...
(assert (=> (<= j1 b) (= (mk_map__ref result1) tab35)))
(assert (=> (<= j1 b) (= tab2 o2)))
...
(assert (= k17 0))
(assert (<= j38 b))
(assert (= (to_rep o24) j38))
(assert (and (<= (to_rep tab__first) j38) (<= j38 (to_rep tab__last))))
(assert (= o25 j38))
(assert (= o26 (store (map__content tab30) o25 o24)))
(assert (= result30 tab30))
(assert (= tab32 o26))
(assert (and (= o27 (+ j38 1)) (in_range1 (+ j38 1))))
(assert (= result31 (mk_int__ref j38)))
(assert (= j39 o27))
(assert (and (= o28 (+ k17 1)) (in_range1 (+ k17 1))))
