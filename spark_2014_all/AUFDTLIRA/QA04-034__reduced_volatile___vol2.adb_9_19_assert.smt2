...
(declare-const temp___174 (Array Int us_rep))
(declare-const vol2__ident__x__compl integer)
(declare-const temp___175 (Array Int us_rep))
...
(assert (= temp___174 g))
(assert (= (mk___rep (mk___split_fields vol2__ident__x__compl)) (select temp___174 1)))
(assert (in_range h11))
(assert (= result g))
(assert (= g1 (store g 1 (mk___rep (mk___split_fields vol2__ident__x__fields)))))
(assert (= temp___175 g2))
(assert (= (mk___rep (mk___split_fields vol2__ident__x__compl1)) (select temp___175 1)))
(assert (in_range h21))
(assert (= result1 g2))
