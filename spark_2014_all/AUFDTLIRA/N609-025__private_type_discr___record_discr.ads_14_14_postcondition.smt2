...
(assert (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e) (and (= o11 (mk_result (of_int 1) 1)) (and (= (= o true) (= (of_int 1) true)) (=> (= (of_int 1) true) (= (get_content o11) 1))))))
...
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e) (and (= o10 (mk_result (of_int 1) 2)) (and (= (= o2 true) (= (of_int 1) true)) (=> (= (of_int 1) true) (= (get_content o10) 2)))))))
...
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (=> (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 3)) e) (and (= o9 (mk_result (of_int 1) 3)) (and (= (= o4 true) (= (of_int 1) true)) (=> (= (of_int 1) true) (= (get_content o9) 3))))))))
...
(assert (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 1)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 2)) e)) (=> (not (= (to_rep (select (rec__record_discr__interm_result__to_search1 (us_split_fields5 r)) 3)) e)) (and (= o8 (mk_result (of_int 0) 1)) (and (= (= o6 true) (= (of_int 0) true)) (=> (= (of_int 0) true) (= (get_content o8) 1))))))))
