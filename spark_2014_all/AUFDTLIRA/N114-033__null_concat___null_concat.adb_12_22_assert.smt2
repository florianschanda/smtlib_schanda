...
(define-fun dynamic_invariant ((temp___expr_151 us_t) (temp___is_init_148 Bool) (temp___skip_constant_149 Bool) (temp___do_toplevel_150 Bool)) Bool (=> (not (= temp___skip_constant_149 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_151) (last1 temp___expr_151))))
(declare-const a1 us_t)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun null_concat__p_good__a1__aggregate_def (Int) (Array Int integer))
(assert (forall ((temp___134 Int)) (forall ((temp___135 Int)) (= (select (null_concat__p_good__a1__aggregate_def temp___134) temp___135) (of_rep temp___134)))))
(declare-sort t3b 0)
...
(assert (forall ((temp___137 Int) (temp___138 Int)) (let ((temp___136 (null_concat__p_good__a2__aggregate_def temp___137 temp___138))) (forall ((temp___139 Int)) (ite (and (<= 6 temp___139) (<= temp___139 10)) (= (select temp___136 temp___139) (of_rep temp___138)) (=> (and (<= 1 temp___139) (<= temp___139 5)) (= (select temp___136 temp___139) (of_rep temp___137))))))))
...
(assert (= a4 (let ((temp___140 2)) (ite (= (length a1) 0) (of_array (singleton1 (of_rep temp___140) (- 2147483648)) (- 2147483648) (- 2147483648)) (of_array (concat1 (to_array a1) (first1 a1) (last1 a1) (singleton1 (of_rep temp___140) 1) 1 1) (first1 a1) (- (+ (first1 a1) (+ (ite (<= (first1 a1) (last1 a1)) (+ (- (last1 a1) (first1 a1)) 1) 0) 1)) 1))))))
(declare-const o Int)
...
(declare-const null_concat__p_good__a3__assume (Array Int integer))
(declare-const null_concat__p_good__a3__assume1 t)
...
(declare-const null_concat__p_good__a4__assume (Array Int integer))
(declare-const null_concat__p_good__a4__assume1 t)
...
(assert (dynamic_invariant a2 true false true))
(assert (=> (= (length a1) 0) (= (elts a2) null_concat__p_good__a3__assume)))
(assert (=> (= (length a1) 0) (= (mk (to_rep (first (rt a2))) (to_rep (last (rt a2)))) null_concat__p_good__a3__assume1)))
(assert (=> (not (= (length a1) 0)) (=> (<= (to_rep (first (rt a2))) (to_rep (last (rt a2)))) (= o (+ (- (to_rep (last (rt a2))) (to_rep (first (rt a2)))) 1)))))
(assert (=> (not (= (length a1) 0)) (=> (not (<= (to_rep (first (rt a2))) (to_rep (last (rt a2))))) (= o 0))))
(assert (=> (not (= (length a1) 0)) (=> (<= (to_rep (first (rt a1))) (to_rep (last (rt a1)))) (= o1 (+ (- (to_rep (last (rt a1))) (to_rep (first (rt a1)))) 1)))))
(assert (=> (not (= (length a1) 0)) (=> (not (<= (to_rep (first (rt a1))) (to_rep (last (rt a1))))) (= o1 0))))
(assert (=> (not (= (length a1) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length a1) 0)) (= o3 (+ (to_rep (first (rt a1))) o2))))
(assert (=> (not (= (length a1) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length a1) 0)) (and (= o5 o4) (in_range1 o4))))
(assert (=> (not (= (length a1) 0)) (= (concat1 (elts a1) (to_rep (first (rt a1))) (to_rep (last (rt a1))) (elts a2) (to_rep (first (rt a2))) (to_rep (last (rt a2)))) null_concat__p_good__a3__assume)))
(assert (=> (not (= (length a1) 0)) (= (mk (to_rep (first (rt a1))) o5) null_concat__p_good__a3__assume1)))
(assert (= (mk___t null_concat__p_good__a3__assume null_concat__p_good__a3__assume1) a3))
(assert (dynamic_invariant a3 true false true))
(assert (=> (= (length a1) 0) (= (to_rep o6) 2)))
(assert (=> (= (length a1) 0) (= o7 (singleton1 o6 (- 2147483648)))))
(assert (=> (= (length a1) 0) (= o7 null_concat__p_good__a4__assume)))
(assert (=> (= (length a1) 0) (= (mk (- 2147483648) (- 2147483648)) null_concat__p_good__a4__assume1)))
(assert (=> (not (= (length a1) 0)) (=> (<= (to_rep (first (rt a1))) (to_rep (last (rt a1)))) (= o10 (+ (- (to_rep (last (rt a1))) (to_rep (first (rt a1)))) 1)))))
(assert (=> (not (= (length a1) 0)) (=> (not (<= (to_rep (first (rt a1))) (to_rep (last (rt a1))))) (= o10 0))))
(assert (=> (not (= (length a1) 0)) (= o11 (+ o10 1))))
(assert (=> (not (= (length a1) 0)) (= o12 (+ (to_rep (first (rt a1))) o11))))
(assert (=> (not (= (length a1) 0)) (= o13 (- o12 1))))
(assert (=> (not (= (length a1) 0)) (and (= o14 o13) (in_range1 o13))))
(assert (=> (not (= (length a1) 0)) (= (to_rep o8) 2)))
(assert (=> (not (= (length a1) 0)) (= o9 (singleton1 o8 1))))
(assert (=> (not (= (length a1) 0)) (= o15 (concat1 (elts a1) (to_rep (first (rt a1))) (to_rep (last (rt a1))) o9 1 1))))
(assert (=> (not (= (length a1) 0)) (= o15 null_concat__p_good__a4__assume)))
(assert (=> (not (= (length a1) 0)) (= (mk (to_rep (first (rt a1))) o14) null_concat__p_good__a4__assume1)))
(assert (= (mk___t null_concat__p_good__a4__assume null_concat__p_good__a4__assume1) a4))
(assert (dynamic_invariant a4 true false true))
(assert (= (to_rep (first (rt a3))) 1))
(assert (= (to_rep (select (elts a3) 1)) 1))
(assert (not (= (to_rep (first (rt a4))) (- 2147483648))))
(check-sat)
(exit)
