...
(define-fun dynamic_invariant1 ((temp___expr_273 us_rep4) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool)) Bool (= (tree_structure temp___expr_273) true))
(define-fun default_initial_assumption1 ((temp___expr_276 us_rep4) (temp___skip_top_level_277 Bool)) Bool (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields5 temp___expr_276))) 0) (forall ((temp___279 Int)) (=> (and (<= 1 temp___279) (<= temp___279 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_276)) temp___279)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_276)) temp___279)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_276)) temp___279)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_276)) temp___279)))) 2))))) (=> (not (= temp___skip_top_level_277 true)) (= (size temp___expr_276) 0))))
(define-fun type_invariant ((temp___282 us_rep4)) Bool (= (tree_structure temp___282) true))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 f true true true) (dynamic_invariant i true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
...
(assert (forall ((temp___389 Int)) (forall ((temp___390 Int)) (= (select (temp___387 temp___389) temp___390) (of_rep2 temp___389)))))
(define-fun dynamic_invariant3 ((temp___expr_376 us_rep5) (temp___is_init_373 Bool) (temp___skip_constant_374 Bool) (temp___do_toplevel_375 Bool)) Bool (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_376))) true))
(define-fun default_initial_assumption3 ((temp___expr_380 us_rep5) (temp___skip_top_level_381 Bool)) Bool (and (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_380))) 0) (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_380))))) 0) (forall ((temp___384 Int)) (=> (and (<= 1 temp___384) (<= temp___384 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_380)))) temp___384)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_380)))) temp___384)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_380)))) temp___384)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_380)))) temp___384)))) 2))))) (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_380))) 0))) (= (rec__search_trees__search_tree__values (us_split_fields7 temp___expr_380)) (temp___387 0))) (=> (not (= temp___skip_top_level_381 true)) (= (size1 temp___expr_380) 0))))
(define-fun type_invariant1 ((temp___392 us_rep5)) Bool (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___392))) 0) (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___392))) 0) (and (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___392))) 0)) (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 temp___392)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___392)))) true)) (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 temp___392)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___392))) (rec__search_trees__search_tree__values (us_split_fields7 temp___392))) true))))
...
(assert (forall ((t us_rep5)) (! (=> (and (dynamic_invariant3 t true true true) (type_invariant1 t)) (=> (= (size1 t) 0) (= (is_empty (values t)) true))) :pattern ((values t)))))
(assert (forall ((t us_rep5)) (! (=> (and (dynamic_invariant3 t true true true) (type_invariant1 t)) (let ((result (values1 t))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) 0) (= (is_empty result) true) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___429 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t)))))) (select temp___429 i)))) true) (= (contains result (to_rep2 (let ((temp___428 (rec__search_trees__search_tree__values (us_split_fields7 t)))) (select temp___428 i)))) true)))) (forall ((v Int)) (=> (and (<= 0 v) (<= v 2147483647)) (=> (= (contains result v) true) (exists ((i Int)) (and (and (<= 1 i) (<= i 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___430 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t)))))) (select temp___430 i)))) true) (= (to_rep2 (let ((temp___431 (rec__search_trees__search_tree__values (us_split_fields7 t)))) (select temp___431 i))) v))))))))))) :pattern ((values1 t)))))
...
(assert true)
(assert (forall ((f us_rep4)) (forall ((root Int)) (forall ((values2 (Array Int natural))) (! (= (= (ordered_leafs f root values2) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___482 (model__ f root))) (select temp___482 i)))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___483 (model__ f root))) (select temp___483 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___484 (model__ f root))) (select temp___484 i)))) (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___485 (model__ f root))) (select temp___485 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___480 (model__ f root))) (select temp___480 j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___481 (model__ f root))) (select temp___481 i))))) 1)) 0) (< (to_rep2 (select values2 j)) (to_rep2 (select values2 i))) (< (to_rep2 (select values2 i)) (to_rep2 (select values2 j)))))))))) :pattern ((ordered_leafs f root values2)))))))
...
(define-fun dynamic_invariant5 ((temp___expr_156 Int) (temp___is_init_153 Bool) (temp___skip_constant_154 Bool) (temp___do_toplevel_155 Bool)) Bool (=> (or (= temp___is_init_153 true) (<= 0 100)) (in_range2 temp___expr_156)))
(assert (forall ((t us_rep5)) (! (=> (and (dynamic_invariant3 t true true true) (type_invariant1 t)) (dynamic_invariant5 (size1 t) true false true)) :pattern ((size1 t)))))
(assert (forall ((t us_rep5)) (! (=> (dynamic_invariant3 t true true true) (= (size1 t) (size (rec__search_trees__search_tree__struct (us_split_fields7 t))))) :pattern ((size1 t)))))
(define-fun dynamic_invariant6 ((temp___expr_162 Int) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool)) Bool (=> (or (= temp___is_init_159 true) (<= 0 2)) (in_range3 temp___expr_162)))
...
(define-fun dynamic_invariant7 ((temp___expr_168 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= 0 1)) (in_range5 temp___expr_168)))
(define-fun dynamic_invariant8 ((temp___expr_205 us_rep1) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool)) Bool (=> (= temp___do_toplevel_204 true) (=> (= temp___is_init_202 true) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___expr_205))) 100))))
...
(define-fun default_initial_assumption6 ((temp___expr_199 us_rep) (temp___skip_top_level_200 Bool)) Bool (=> (not (= temp___skip_top_level_200 true)) (= (length temp___expr_199) 0)))
(assert true)
...
(define-fun dynamic_invariant9 ((temp___expr_144 Int) (temp___is_init_141 Bool) (temp___skip_constant_142 Bool) (temp___do_toplevel_143 Bool)) Bool (=> (or (= temp___is_init_141 true) (<= 0 2147483647)) (in_range6 temp___expr_144)))
(assert (forall ((f us_rep4)) (! (=> (dynamic_invariant1 f true true true) (dynamic_invariant5 (size f) true false true)) :pattern ((size f)))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 f true true true) (dynamic_invariant i true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant5 result true false true)))) :pattern ((parent f i))))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant1 f true true true) (dynamic_invariant i true true true)) (not (= (parent f i) 0))) (dynamic_invariant7 (position f i) true false true)) :pattern ((position f i))))))
(define-fun default_initial_assumption7 ((temp___expr_259 us_rep3) (temp___skip_top_level_260 Bool)) Bool (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 temp___expr_259))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 temp___expr_259))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 temp___expr_259))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 temp___expr_259))) 2)))
(define-fun default_initial_assumption8 ((temp___expr_266 (Array Int us_rep3)) (temp___skip_top_level_267 Bool)) Bool (forall ((temp___268 Int)) (=> (and (<= 1 temp___268) (<= temp___268 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select temp___expr_266 temp___268)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select temp___expr_266 temp___268)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select temp___expr_266 temp___268)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select temp___expr_266 temp___268)))) 2)))))
(assert true)
...
(define-fun dynamic_invariant10 ((temp___expr_192 Int) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool)) Bool (=> (or (= temp___is_init_189 true) (<= 0 2147483647)) (in_range7 temp___expr_192)))
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant9 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant11 ((temp___expr_186 Int) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool)) Bool (=> (or (= temp___is_init_183 true) (<= 0 1)) (in_range8 temp___expr_186)))
(assert (forall ((container us_rep)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant10 position1 true true true) (and (<= 1 position1) (<= position1 (last container)))) (dynamic_invariant11 (get container position1) true false true)) :pattern ((get container position1))))))
...
(define-fun dynamic_invariant12 ((temp___expr_232 Int) (temp___is_init_229 Bool) (temp___skip_constant_230 Bool) (temp___do_toplevel_231 Bool)) Bool (=> (or (= temp___is_init_229 true) (<= 0 2147483647)) (in_range9 temp___expr_232)))
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant12 item true true true) (=> (= (of_int 1) true) (=> (exists ((e Int)) (and (and (in_range9 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(assert (forall ((container us_rep2)) (! (dynamic_invariant9 (length1 container) true false true) :pattern ((length1 container)))))
...
(declare-const i Int)
(declare-const o Int)
(declare-const temp___1816 (Array Int us_rep1))
(declare-const o1 us_rep)
(declare-const o2 Bool)
(declare-const o3 us_rep)
(declare-const o4 Bool)
(declare-const o5 Int)
(declare-const temp___1815 (Array Int us_rep1))
(declare-const i1 Int)
(declare-const o6 Int)
(declare-const temp___1820 (Array Int us_rep1))
(declare-const o7 us_rep)
(declare-const o8 Bool)
(declare-const o9 us_rep)
(declare-const o10 Bool)
(declare-const o11 Int)
(declare-const temp___1819 (Array Int us_rep1))
...
(assert (and (= o15 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))))
(assert (and (= result (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o15)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t1))) o15) (not (= result true)))))
(assert (= result true))
(assert (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))) 0)))
(assert (and (= o14 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))))))
(assert (and (= result1 (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o14)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t2))) o14) (not (= result1 true)))))
(assert (= result1 true))
(assert (and (= o13 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))))
(assert (and (= result2 (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o13 (rec__search_trees__search_tree__values (us_split_fields7 t1)))) (= (= result2 true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o13) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o13) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o13) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o13) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o13) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o13) i2)))) 1)) 0) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) j)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) i2))) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) i2)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) j))))))))))))
(assert (= result2 true))
(assert (and (= o12 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))))))
(assert (and (= result3 (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o12 (rec__search_trees__search_tree__values (us_split_fields7 t2)))) (= (= result3 true) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o12) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o12) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o12) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o12) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o12) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o12) i2)))) 1)) 0) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) j)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i2))) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i2)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) j))))))))))))
(assert (= result3 true))
(assert (<= 1 i1))
(assert (<= i1 100))
...
(assert (and (= temp___1820 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o6)) (and (dynamic_invariant2 temp___1820 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1820 o6))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1820 o6)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 o6)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t1)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1820 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t1)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1820 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1820 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1820 i2))) true) (not (= i2 o6))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1820 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t1)) i2)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t1)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1820 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1820 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1820 i2))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1820 j))) true) (= (oeq1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___1820 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1820 j)))) true)) (= j i2))))))))))))))
(assert (= (mk___rep (mk___split_fields o7 o8)) (select temp___1820 i1)))
(assert (= o7 o9))
(assert (= o8 o10))
(assert (= result5 o10))
(assert (= result5 true))
