...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (user_eq2 (rec__tree_model__path_type__a (us_split_fields1 a)) (rec__tree_model__path_type__a (us_split_fields1 b))) true) (= (rec__tree_model__path_type__k (us_split_fields1 a)) (rec__tree_model__path_type__k (us_split_fields1 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_276 us_rep2) (temp___skip_top_level_277 Bool)) Bool (=> (not (= temp___skip_top_level_277 true)) (= (is_empty temp___expr_276) true)))
...
(declare-const dummy7 (Array Int us_rep3))
...
(declare-fun user_eq7 ((Array Int us_rep3) (Array Int us_rep3)) Bool)
...
(define-fun dynamic_invariant1 ((temp___expr_315 us_rep4) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (=> (= temp___do_typ_inv_314 true) (= (tree_structure temp___expr_315) true)))
(define-fun default_initial_assumption1 ((temp___expr_318 us_rep4) (temp___skip_top_level_319 Bool)) Bool (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields5 temp___expr_318))) 0) (forall ((temp___321 Int)) (=> (and (<= 1 temp___321) (<= temp___321 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_318)) temp___321)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_318)) temp___321)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_318)) temp___321)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_318)) temp___321)))) 2))))) (=> (not (= temp___skip_top_level_319 true)) (= (size temp___expr_318) 0))))
(define-fun type_invariant ((temp___324 us_rep4)) Bool (= (tree_structure temp___324) true))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 f true true true true) (dynamic_invariant i true true true true)) (=> (< (size f) i) (not (= (valid_root f i) true)))) :pattern ((valid_root f i))))))
...
(assert (forall ((f us_rep4)) (forall ((root Int)) (! (=> (and (and (dynamic_invariant1 f true true true true) (dynamic_invariant root true true true true)) (= (valid_root f root) true)) (let ((result (model__ f root))) (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select result root)))) 0) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (not (= i root)) (ite (and (not (= (parent f i) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select result (parent f i)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select result i))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select result i))) true)))))) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result i))) true) (not (= i root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select result (parent f i)))) (position f i) (rec__tree_model__path_type__a (us_split_fields1 (select result i)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select result i)))) 0)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select result i))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select result j))) true) (= (oeq1 (rec__tree_model__path_type__a (us_split_fields1 (select result i))) (rec__tree_model__path_type__a (us_split_fields1 (select result j)))) true)) (= j i))))))))))) (dynamic_invariant2 result true false true true)))) :pattern ((model__ f root))))))
...
(define-fun default_initial_assumption3 ((temp___expr_424 us_rep5) (temp___skip_top_level_425 Bool)) Bool (and (and (and (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 temp___expr_424))) 0) (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424))))) 0) (forall ((temp___428 Int)) (=> (and (<= 1 temp___428) (<= temp___428 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424)))) temp___428)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424)))) temp___428)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424)))) temp___428)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424)))) temp___428)))) 2))))) (= (size (rec__search_trees__search_tree__struct (us_split_fields7 temp___expr_424))) 0))) (= (rec__search_trees__search_tree__values (us_split_fields7 temp___expr_424)) (temp___431 0))) (=> (not (= temp___skip_top_level_425 true)) (= (size1 temp___expr_424) 0))))
...
(define-fun default_initial_assumption4 ((temp___expr_291 us_rep2) (temp___skip_top_level_292 Bool)) Bool (=> (not (= temp___skip_top_level_292 true)) (= (is_empty temp___expr_291) true)))
...
(assert (forall ((t us_rep5)) (! (=> (and (dynamic_invariant3 t true true true true) (type_invariant1 t)) (let ((result (values1 t))) (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) 0) (= (is_empty result) true) (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___473 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t)))))) (select temp___473 i)))) true) (= (contains result (to_rep2 (let ((temp___472 (rec__search_trees__search_tree__values (us_split_fields7 t)))) (select temp___472 i)))) true)))) (forall ((v Int)) (=> (and (<= 0 v) (<= v 2147483647)) (=> (= (contains result v) true) (exists ((i Int)) (and (and (<= 1 i) (<= i 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___474 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t)))))) (select temp___474 i)))) true) (= (to_rep2 (let ((temp___475 (rec__search_trees__search_tree__values (us_split_fields7 t)))) (select temp___475 i))) v))))))))))) :pattern ((values1 t)))))
...
(assert true)
(assert (forall ((f us_rep4)) (forall ((root Int)) (forall ((values2 (Array Int natural))) (! (= (= (ordered_leafs f root values2) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___526 (model__ f root))) (select temp___526 i)))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (let ((temp___527 (model__ f root))) (select temp___527 j)))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___528 (model__ f root))) (select temp___528 i)))) (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___529 (model__ f root))) (select temp___529 j))))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___524 (model__ f root))) (select temp___524 j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (let ((temp___525 (model__ f root))) (select temp___525 i))))) 1)) 0) (< (to_rep2 (select values2 j)) (to_rep2 (select values2 i))) (< (to_rep2 (select values2 i)) (to_rep2 (select values2 j)))))))))) :pattern ((ordered_leafs f root values2)))))))
...
(define-fun dynamic_invariant5 ((temp___expr_182 Int) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (=> (or (= temp___is_init_178 true) (<= 0 100)) (in_range2 temp___expr_182)))
...
(assert (forall ((temp___433 Int)) (=> (dynamic_invariant4 temp___433 true true true true) (forall ((temp___434 Int)) (= (to_rep2 (select (temp___431 temp___433) temp___434)) temp___433)))))
(define-fun dynamic_invariant6 ((temp___expr_189 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 0 2)) (in_range3 temp___expr_189)))
...
(define-fun dynamic_invariant8 ((temp___expr_239 us_rep1) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (=> (= temp___do_toplevel_237 true) (=> (= temp___is_init_235 true) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___expr_239))) 100))))
...
(define-fun default_initial_assumption6 ((temp___expr_232 us_rep) (temp___skip_top_level_233 Bool)) Bool (=> (not (= temp___skip_top_level_233 true)) (= (length temp___expr_232) 0)))
(assert true)
...
(assert (forall ((f us_rep4)) (! (=> (dynamic_invariant1 f true true true true) (dynamic_invariant5 (size f) true false true true)) :pattern ((size f)))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (dynamic_invariant1 f true true true true) (dynamic_invariant i true true true true)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant5 result true false true true)))) :pattern ((parent f i))))))
(assert (forall ((f us_rep4)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant1 f true true true true) (dynamic_invariant i true true true true)) (not (= (parent f i) 0))) (dynamic_invariant7 (position f i) true false true true)) :pattern ((position f i))))))
(define-fun default_initial_assumption7 ((temp___expr_299 us_rep3) (temp___skip_top_level_300 Bool)) Bool (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 temp___expr_299))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 temp___expr_299))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 temp___expr_299))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 temp___expr_299))) 2)))
(define-fun default_initial_assumption8 ((temp___expr_307 (Array Int us_rep3)) (temp___skip_top_level_308 Bool)) Bool (forall ((temp___309 Int)) (=> (and (<= 1 temp___309) (<= temp___309 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select temp___expr_307 temp___309)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select temp___expr_307 temp___309)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select temp___expr_307 temp___309)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select temp___expr_307 temp___309)))) 2)))))
(assert true)
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant9 result true false true true))) :pattern ((length container)))))
...
(assert (forall ((container us_rep)) (forall ((position1 Int)) (! (=> (and (dynamic_invariant10 position1 true true true true) (and (<= 1 position1) (<= position1 (last container)))) (dynamic_invariant11 (get container position1) true false true true)) :pattern ((get container position1))))))
...
(assert (forall ((container us_rep2)) (forall ((item Int)) (! (=> (dynamic_invariant12 item true true true true) (=> (= (distinct 1 0) true) (=> (exists ((e Int)) (and (and (in_range9 e) (= (contains container e) true)) (= e item))) (= (contains container item) true)))) :pattern ((contains container item))))))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(assert (forall ((container us_rep2)) (! (dynamic_invariant9 (length1 container) true false true true) :pattern ((length1 container)))))
...
(declare-const i Int)
(declare-const o Int)
(declare-const temp___1864 (Array Int us_rep1))
...
(assert (and (= o8 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))))
...
(assert (and (= o7 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))))))
...
(assert (= result1 true))
(assert (and (= o6 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))))
(assert (and (= result2 (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o6 (rec__search_trees__search_tree__values (us_split_fields7 t1)))) (= (= result2 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o6) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o6) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o6) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o6) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o6) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o6) i1)))) 1)) 0) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) j)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) i1))) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) i1)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) j))))))))))))
(assert (= result2 true))
(assert (and (= o5 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))))))
(assert (and (= result3 (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o5 (rec__search_trees__search_tree__values (us_split_fields7 t2)))) (= (= result3 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o5) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o5) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o5) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o5) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o5) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o5) i1)))) 1)) 0) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) j)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i1))) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i1)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) j))))))))))))
(assert (= result3 true))
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= o (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))))
(assert (and (= temp___1864 (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o)) (and (dynamic_invariant2 temp___1864 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1864 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1864 o)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 o)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct (us_split_fields7 t1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1864 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1864 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1864 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1864 i1))) true) (not (= i1 o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1864 (parent (rec__search_trees__search_tree__struct (us_split_fields7 t1)) i1)))) (position (rec__search_trees__search_tree__struct (us_split_fields7 t1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1864 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1864 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1864 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1864 j))) true) (= (oeq1 (rec__tree_model__path_type__a (us_split_fields1 (select temp___1864 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1864 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o1 o2)) (select temp___1864 i)))
(assert (= o1 o3))
(assert (= o2 o4))
(assert (= result4 o4))
(assert (= result4 true))
(assert (not (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))))))
(check-sat)
(exit)
