...
(assert (= (= o8 true) (forall ((index Int)) (=> (and (<= (to_rep1 (first (rt source))) index) (<= index (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index))) true)))))
...
(assert (not (<= (to_rep1 (first (rt source))) temp___1466)))
(check-sat)
(exit)
