...
(define-fun dynamic_invariant1 ((temp___expr_166 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 1 10)) (in_range2 temp___expr_166)))
(declare-const cache_v1 (Array Int integer))
(declare-const cache_v2 (Array Int integer))
(declare-const i Int)
(declare-const i1 Int)
(declare-const temp___350 (Array Int integer))
(declare-const temp___349 Int)
(declare-const o integer)
(declare-const o1 (Array Int integer))
(declare-const o2 integer)
(declare-const o3 (Array Int integer))
(declare-const temp___355 (Array Int integer))
...
(declare-const cache_v18 (Array Int integer))
(declare-const i8 Int)
(declare-const cache_v19 (Array Int integer))
(declare-const i9 Int)
(declare-const cache_v110 (Array Int integer))
...
(declare-const cache_v24 (Array Int integer))
(declare-const cache_v25 (Array Int integer))
(declare-const i14 Int)
(declare-const cache_v26 (Array Int integer))
(declare-const i15 Int)
(declare-const cache_v27 (Array Int integer))
(declare-const i16 int__ref)
(declare-const cache_v28 (Array Int integer))
(declare-const i17 Int)
(declare-const cache_v29 map__ref)
(declare-const i18 int__ref)
(declare-const cache_v210 (Array Int integer))
(declare-const i19 Int)
(declare-const cache_v211 map__ref)
(declare-const i20 int__ref)
(declare-const cache_v212 (Array Int integer))
(declare-const i21 Int)
(declare-const cache_v111 map__ref)
(declare-const cache_v213 map__ref)
(declare-const i22 int__ref)
(declare-const i23 int__ref)
(declare-const cache_v112 (Array Int integer))
(declare-const cache_v214 (Array Int integer))
(declare-const i24 Int)
(declare-const i25 Int)
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 10)) (and (and (= temp___350 cache_v1) (and (= temp___349 i2) (and (and (and (= (to_rep o) 0) (= o1 (store cache_v1 i2 o))) (and (= (mk_map__ref result1) (mk_map__ref cache_v1)) (= cache_v12 o1))) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (=> (<= k i3) (= (to_rep (select cache_v13 k)) 0)))) (and (and (and (=> (<= 1 10) (in_range2 i3)) (forall ((temp___351 Int)) (=> (and (<= 1 temp___351) (<= temp___351 10)) (=> (< i3 temp___351) (= (select cache_v13 temp___351) (select temp___350 temp___351)))))) (and (<= 1 i3) (<= i3 10))) (= i3 10)))))) (and (and (= i3 i7) (= cache_v13 cache_v17)) (and (= i8 i3) (= cache_v18 cache_v13))))))
(assert (=> (and (<= 1 i2) (<= i2 10)) (= (mk_int__ref i9) (mk_int__ref i7))))
(assert (=> (and (<= 1 i2) (<= i2 10)) (= (mk_map__ref cache_v19) (mk_map__ref cache_v17))))
(assert (=> (and (<= 1 i2) (<= i2 10)) (= i10 i8)))
(assert (=> (and (<= 1 i2) (<= i2 10)) (= cache_v110 cache_v18)))
(assert (=> (not (and (<= 1 i2) (<= i2 10))) (= i2 i9)))
(assert (=> (not (and (<= 1 i2) (<= i2 10))) (= (mk_map__ref cache_v19) (mk_map__ref cache_v1))))
(assert (=> (not (and (<= 1 i2) (<= i2 10))) (= i10 i2)))
(assert (=> (not (and (<= 1 i2) (<= i2 10))) (= cache_v110 cache_v11)))
(assert (= (mk_int__ref result4) (mk_int__ref i1)))
(assert (= i11 1))
(assert (<= 1 i11))
(assert (<= i11 10))
(assert (= (to_rep o4) 0))
(assert (= o5 (store cache_v2 i11 o4)))
(assert (= (mk_map__ref result5) (mk_map__ref cache_v2)))
(assert (= cache_v22 o5))
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (=> (<= k i12) (= (to_rep (select cache_v23 k)) 0)))))
(assert (and (and (=> (<= 1 10) (in_range2 i12)) (forall ((temp___356 Int)) (=> (and (<= 1 temp___356) (<= temp___356 10)) (=> (< i12 temp___356) (= (select cache_v23 temp___356) (select cache_v2 temp___356)))))) (and (<= 1 i12) (<= i12 10))))
(assert (not (= i12 10)))
(assert (= result6 i12))
(assert (= i13 (+ i12 1)))
(assert (= (to_rep o6) 0))
(assert (= o7 (store cache_v23 i13 o6)))
(assert (= result7 cache_v23))
(assert (= cache_v24 o7))
(assert (= i13 i14))
(assert (= cache_v24 cache_v25))
(assert (= i15 i13))
(assert (= cache_v26 cache_v24))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k 10))
(assert (<= k i14))
(assert (not (= (to_rep (select cache_v25 k)) 0)))
(check-sat)
(exit)
