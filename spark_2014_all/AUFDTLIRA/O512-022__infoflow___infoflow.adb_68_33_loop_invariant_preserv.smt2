...
(assert (and (and (=> (<= 1 10) (in_range2 i9)) (forall ((temp___401 Int)) (=> (and (<= 1 temp___401) (<= temp___401 10)) (=> (or (< 10 temp___401) (or (< temp___401 1) (< i9 temp___401))) (= (select cache_v22 temp___401) (select cache_v2 temp___401)))))) (and (<= 1 i9) (<= i9 10))))
(assert (not (= i9 10)))
(assert (= result4 i9))
(assert (= i10 (+ i9 1)))
(assert (= result5 cache_v22))
(assert (= cache_v23 (store cache_v22 i10 rliteral)))
(assert (= i10 i11))
