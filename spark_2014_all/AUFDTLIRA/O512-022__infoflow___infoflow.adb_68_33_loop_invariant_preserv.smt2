...
(declare-const temp___393 (Array Int integer))
...
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 10)) (= temp___393 cache_v1)))
(assert (=> (and (<= 1 i2) (<= i2 10)) (= temp___392 i2)))
...
(assert (=> (and (<= 1 i2) (<= i2 10)) (and (and (=> (<= 1 10) (in_range2 i3)) (forall ((temp___394 Int)) (=> (and (<= 1 temp___394) (<= temp___394 10)) (=> (< i3 temp___394) (= (select cache_v13 temp___394) (select temp___393 temp___394)))))) (and (<= 1 i3) (<= i3 10)))))
...
(assert (and (and (=> (<= 1 10) (in_range2 i9)) (forall ((temp___399 Int)) (=> (and (<= 1 temp___399) (<= temp___399 10)) (=> (< i9 temp___399) (= (select cache_v22 temp___399) (select cache_v2 temp___399)))))) (and (<= 1 i9) (<= i9 10))))
(assert (not (= i9 10)))
(assert (= result4 i9))
(assert (= i10 (+ i9 1)))
(assert (= (to_rep o4) 0))
