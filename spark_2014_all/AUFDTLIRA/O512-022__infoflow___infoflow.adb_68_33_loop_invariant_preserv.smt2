...
(assert (=> (and (<= 1 i2) (<= i2 10)) (and (and (=> (<= 1 10) (in_range2 i3)) (forall ((temp___351 Int)) (=> (and (<= 1 temp___351) (<= temp___351 10)) (=> (< i3 temp___351) (= (select cache_v13 temp___351) (select temp___350 temp___351)))))) (and (<= 1 i3) (<= i3 10)))))
...
(assert (<= i8 10))
(assert (= (to_rep o2) 0))
(assert (= o3 (store cache_v2 i8 o2)))
(assert (= (mk_map__ref result3) (mk_map__ref cache_v2)))
(assert (= cache_v21 o3))
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (=> (<= k i9) (= (to_rep (select cache_v22 k)) 0)))))
(assert (and (and (=> (<= 1 10) (in_range2 i9)) (forall ((temp___356 Int)) (=> (and (<= 1 temp___356) (<= temp___356 10)) (=> (< i9 temp___356) (= (select cache_v22 temp___356) (select cache_v2 temp___356)))))) (and (<= 1 i9) (<= i9 10))))
(assert (not (= i9 10)))
(assert (= result4 i9))
(assert (= i10 (+ i9 1)))
(assert (= (to_rep o4) 0))
(assert (= o5 (store cache_v22 i10 o4)))
(assert (= result5 cache_v22))
(assert (= cache_v23 o5))
(assert (= i10 i11))
(assert (= cache_v23 cache_v24))
(assert (= i12 i10))
(assert (= cache_v25 cache_v23))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k 10))
(assert (<= k i11))
(assert (not (= (to_rep (select cache_v24 k)) 0)))
(check-sat)
(exit)
