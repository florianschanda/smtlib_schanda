...
(assert (<= 1 i1))
(assert (<= i1 (to_rep (rec__static_discr__holder__length (us_split_fields5 a)))))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__static_discr__i_holder__content1 (us_split_fields3 (rec__static_discr__holder__content (us_split_fields5 a))))))) i1)))
(check-sat)
(exit)
