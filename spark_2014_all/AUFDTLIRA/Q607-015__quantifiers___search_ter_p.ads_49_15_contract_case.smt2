...
(declare-const temp___2284 int__ref)
...
(assert (or (and (and (and (= search_ter_p__search__result19 (mk_option__ref search_ter_p__search__result4)) (and (= i13 i17) (= result____split_fields16 (mk___split_fields__ref result____split_fields2)))) (and (= search_ter_p__search__result20 search_ter_p__search__result4) (and (= i14 i1) (= result____split_fields17 result____split_fields2)))) (and (ite (< (length a) (length b)) (= result2 true) (= result2 (ite (= (length b) 0) true false))) (and (= result2 true) (and (= result3 (mk_option__ref (mk___rep (mk___split_fields search_ter_p__search__result search_ter_p__search__result1)))) (= search_ter_p__search__result4 (mk___rep result____split_fields2)))))) (and (and (ite (< (length a) (length b)) (= result2 true) (= result2 (ite (= (length b) 0) true false))) (and (not (= result2 true)) (and (= search_ter_p__search__result4 (mk___rep (mk___split_fields search_ter_p__search__result search_ter_p__search__result1))) (= search_ter_p__search__result4 (mk___rep (mk___split_fields search_ter_p__search__result2 search_ter_p__search__result3)))))) (and (and (and (= search_ter_p__search__result19 search_ter_p__search__result17) (and (= i13 i11) (= result____split_fields16 result____split_fields14))) (and (= search_ter_p__search__result20 search_ter_p__search__result18) (and (= i14 i12) (= result____split_fields17 result____split_fields15)))) (or (and (and (and (= search_ter_p__search__result17 search_ter_p__search__result8) (and (= i11 i5) (= result____split_fields14 result____split_fields8))) (and (= search_ter_p__search__result18 search_ter_p__search__result9) (and (= i12 i6) (= result____split_fields15 result____split_fields9)))) (and (= temp___229 (to_rep (first (rt a)))) (and (and (and (and (= o3 (length b)) (in_range1 (length b))) (and (and (= o4 (+ (to_rep (last (rt a))) 1)) (in_range1 (+ (to_rep (last (rt a))) 1))) (= o5 (- o4 o3)))) (and (= temp___230 o5) (in_range1 o5))) (and (and (= result4 i17) (= i2 temp___229)) (and (and (<= temp___229 i2) (<= i2 temp___230)) (and (= result____split_fields2 (mk___split_fields temp___227 temp___2271)) (and (= temp___226 i2) (and (= 0 temp___228) (or (and (and (and (= temp___2284 (mk_int__ref temp___228)) (and (= search_ter_p__search__result8 (mk_option__ref search_ter_p__search__result5)) (and (= i5 (mk_int__ref i2)) (= result____split_fields8 (mk___split_fields__ref result____split_fields4))))) (and (= temp___2285 temp___2281) (and (= search_ter_p__search__result9 search_ter_p__search__result5) (and (= i6 i2) (= result____split_fields9 result____split_fields4))))) (and (and (= result5 (equal_subrange a i2 b)) (= (= result5 true) (= (bool_eq (elts a) (to_rep (first2 (mk1 i2 (+ (- i2 1) (length b))))) (to_rep (last2 (mk1 i2 (+ (- i2 1) (length b))))) (elts b) (to_rep (first (rt b))) (to_rep (last (rt b)))) true))) (and (= result5 true) (and (and (= result6 (mk___split_fields__ref result____split_fields2)) (= result____split_fields3 (mk___split_fields (distinct 1 0) (rec__types__option__value result____split_fields2)))) (and (and (and (and (= (to_rep o6) i2) (and (= (rec__types__option__exists result____split_fields3) o7) (= o6 o8))) (and (= temp___225 o7) (= temp___2251 o8))) (and (= result7 (mk___split_fields__ref result____split_fields3)) (= result____split_fields4 (mk___split_fields temp___225 temp___2251)))) (and (= result8 (mk_option__ref search_ter_p__search__result4)) (= search_ter_p__search__result5 (mk___rep result____split_fields4)))))))) (and (and (and (= result5 (equal_subrange a i2 b)) (= (= result5 true) (= (bool_eq (elts a) (to_rep (first2 (mk1 i2 (+ (- i2 1) (length b))))) (to_rep (last2 (mk1 i2 (+ (- i2 1) (length b))))) (elts b) (to_rep (first (rt b))) (to_rep (last (rt b)))) true))) (and (not (= result5 true)) (and (= search_ter_p__search__result5 search_ter_p__search__result4) (= result____split_fields4 result____split_fields2)))) (and (and (and (= temp___2284 (mk_int__ref temp___2283)) (and (= search_ter_p__search__result8 (mk_option__ref search_ter_p__search__result7)) (and (= i5 (mk_int__ref i4)) (= result____split_fields8 (mk___split_fields__ref result____split_fields7))))) (and (= temp___2285 temp___2283) (and (= search_ter_p__search__result9 search_ter_p__search__result7) (and (= i6 i4) (= result____split_fields9 result____split_fields7))))) (and (and (not (= (has_sub_range_in_prefix a i3 b) true)) (not (= (rec__types__option__exists result____split_fields5) true))) (and (and (=> (<= (to_rep (first (rt a))) (- (+ (to_rep (last (rt a))) 1) (length b))) (dynamic_property3 (to_rep (first (rt a))) (- (+ (to_rep (last (rt a))) 1) (length b)) i3)) (and (<= (to_rep (first (rt a))) i3) (<= i3 (- (+ (to_rep (last (rt a))) 1) (length b))))) (and (and (= result9 (mk_int__ref temp___2282)) (= temp___2283 i3)) (and (not (= i3 temp___230)) (and (and (= result10 (mk_int__ref i3)) (= i4 (+ i3 1))) (and (and (= result11 (equal_subrange a i4 b)) (= (= result11 true) (= (bool_eq (elts a) (to_rep (first2 (mk1 i4 (+ (- i4 1) (length b))))) (to_rep (last2 (mk1 i4 (+ (- i4 1) (length b))))) (elts b) (to_rep (first (rt b))) (to_rep (last (rt b)))) true))) (and (= result11 true) (and (and (= result12 (mk___split_fields__ref result____split_fields5)) (= result____split_fields6 (mk___split_fields (distinct 1 0) (rec__types__option__value result____split_fields5)))) (and (and (and (and (= (to_rep o9) i4) (and (= (rec__types__option__exists result____split_fields6) o10) (= o9 o11))) (and (= temp___2252 o10) (= temp___2253 o11))) (and (= result13 (mk___split_fields__ref result____split_fields6)) (= result____split_fields7 (mk___split_fields temp___2252 temp___2253)))) (and (= result14 (mk_option__ref search_ter_p__search__result6)) (= search_ter_p__search__result7 (mk___rep result____split_fields7))))))))))))))))))))))) (and (and (and (and (and (= o3 (length b)) (in_range1 (length b))) (and (and (= o4 (+ (to_rep (last (rt a))) 1)) (in_range1 (+ (to_rep (last (rt a))) 1))) (= o5 (- o4 o3)))) (and (= temp___230 o5) (in_range1 o5))) (and (and (= result4 i17) (= i2 (to_rep (first (rt a))))) (ite (and (<= (to_rep (first (rt a))) i2) (<= i2 temp___230)) (and (and (and (= result____split_fields2 (mk___split_fields temp___227 temp___2271)) (and (= temp___226 i2) (and (= 0 temp___228) (and (and (and (= result5 (equal_subrange a i2 b)) (= (= result5 true) (= (bool_eq (elts a) (to_rep (first2 (mk1 i2 (+ (- i2 1) (length b))))) (to_rep (last2 (mk1 i2 (+ (- i2 1) (length b))))) (elts b) (to_rep (first (rt b))) (to_rep (last (rt b)))) true))) (and (not (= result5 true)) (and (= search_ter_p__search__result5 search_ter_p__search__result4) (= result____split_fields4 result____split_fields2)))) (and (and (not (= (has_sub_range_in_prefix a i3 b) true)) (not (= (rec__types__option__exists result____split_fields5) true))) (and (and (=> (<= (to_rep (first (rt a))) (- (+ (to_rep (last (rt a))) 1) (length b))) (dynamic_property3 (to_rep (first (rt a))) (- (+ (to_rep (last (rt a))) 1) (length b)) i3)) (and (<= (to_rep (first (rt a))) i3) (<= i3 (- (+ (to_rep (last (rt a))) 1) (length b))))) (and (and (= result9 (mk_int__ref temp___2282)) (= temp___2283 i3)) (= i3 temp___230)))))))) (and (and (= search_ter_p__search__result10 (mk_option__ref search_ter_p__search__result6)) (and (= i7 (mk_int__ref i3)) (= result____split_fields10 (mk___split_fields__ref result____split_fields5)))) (and (= search_ter_p__search__result11 search_ter_p__search__result6) (and (= i8 i3) (= result____split_fields11 result____split_fields5))))) (and (and (= search_ter_p__search__result12 search_ter_p__search__result10) (and (= i9 i7) (= result____split_fields12 result____split_fields10))) (and (= search_ter_p__search__result13 search_ter_p__search__result11) (and (= i10 i8) (= result____split_fields13 result____split_fields11))))) (and (and (= search_ter_p__search__result12 (mk_option__ref search_ter_p__search__result4)) (and (= i9 (mk_int__ref i2)) (= result____split_fields12 (mk___split_fields__ref result____split_fields2)))) (and (= search_ter_p__search__result13 search_ter_p__search__result4) (and (= i10 i2) (= result____split_fields13 result____split_fields2))))))) (and (and (and (= search_ter_p__search__result17 search_ter_p__search__result15) (and (= i11 i9) (= result____split_fields14 result____split_fields12))) (and (= search_ter_p__search__result18 search_ter_p__search__result16) (and (= i12 i10) (= result____split_fields15 result____split_fields13)))) (and (and (= search_ter_p__search__result15 (mk_option__ref search_ter_p__search__result14)) (= search_ter_p__search__result16 search_ter_p__search__result14)) (and (= result15 search_ter_p__search__result12) (= search_ter_p__search__result14 (mk___rep (us_split_fields__content result____split_fields12))))))))))))
...
(assert (=> (= (ite (= (>= (length a) (length b)) true) (has_sub_range a b) false) true) (and (and (= (rec__types__option__exists (us_split_fields1 (option__content search_ter_p__search__result21))) true) (= (equal_subrange a (to_rep (rec__types__option__value (us_split_fields1 (option__content search_ter_p__search__result21)))) b) true)) (=> (< (to_rep (first (rt a))) (to_rep (rec__types__option__value (us_split_fields1 (option__content search_ter_p__search__result21))))) (not (= (has_sub_range_in_prefix a (- (to_rep (rec__types__option__value (us_split_fields1 (option__content search_ter_p__search__result21)))) 1) b) true))))))
(assert (not (= (ite (= (ite (= (= (length b) 0) false) (< (length a) (length b)) true) false) (ite (= (>= (length a) (length b)) true) (has_sub_range a b) false) true) true)))
(assert (not (not (= (rec__types__option__exists (us_split_fields1 (option__content search_ter_p__search__result21))) true))))
(check-sat)
(exit)
