...
(assert (= result2 true))
(assert (and (= o11 (valid_root f_old v)) (=> (< (size f_old) v) (not (= o11 true)))))
(assert (= result3 (ite (not (= o11 true)) true false)))
(assert (= result3 true))
...
(assert (= o9 (select temp___1553 v)))
...
(assert (= (mk___rep (mk___split_fields o4 o5)) (select temp___1523 i)))
(assert (= o4 o6))
(assert (= o5 o7))
(assert (= o8 o6))
