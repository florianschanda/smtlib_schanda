...
(assert (<= 2 j4))
(assert (<= j4 (length (sequence__content avail5))))
(assert (not (= (get (sequence__content avail5) j4) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get (sequence__content avail5) (- j4 1)))))))))
(check-sat)
(exit)
