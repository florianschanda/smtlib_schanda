...
(assert (= a2 a3))
(assert (= a4 a2))
(assert (= (= o11 true) (forall ((k Int)) (=> (and (<= (to_rep a__first) k) (<= k (to_rep a__last))) (=> (and (not (= k i)) (not (= k j))) (= (= (select a3 k) true) (= (select a k) true)))))))
(assert (and (<= (to_rep a__first) j) (<= j (to_rep a__last))))
(assert (= o7 j))
(assert (= o8 (select a3 o7)))
(assert (= o9 (ite o8 1 0)))
(assert (= o10 (ite (= o9 (ite (select a i) 1 0)) true false)))
