...
(define-fun dynamic_invariant1 ((temp___expr_902 Int) (temp___is_init_899 Bool) (temp___skip_constant_900 Bool) (temp___do_toplevel_901 Bool)) Bool (=> (or (= temp___is_init_899 true) (<= 0 4294967295)) (in_range3 temp___expr_902)))
...
(define-fun dynamic_invariant2 ((temp___expr_1020 Int) (temp___is_init_1017 Bool) (temp___skip_constant_1018 Bool) (temp___do_toplevel_1019 Bool)) Bool (=> (or (= temp___is_init_1017 true) (<= 1 10)) (in_range4 temp___expr_1020)))
...
(assert (forall ((temp___1048 Int) (temp___1049 Int) (temp___1050 Int)) (let ((temp___1047 (temp___1046 temp___1048 temp___1049 temp___1050))) (and (=> (dynamic_property 1 2147483647 temp___1049 temp___1050) (and (= (first9 temp___1047) temp___1049) (= (last9 temp___1047) temp___1050))) (forall ((temp___1051 Int)) (= (select (to_array4 temp___1047) temp___1051) (of_rep temp___1048)))))))
