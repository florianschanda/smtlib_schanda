...
(assert (= (= result4 true) (forall ((i1 Int)) (=> (and (<= (+ (to_rep (rec__binary_trees__forest__s (us_split_fields3 f))) 1) i1) (<= i1 100)) (= (bool_eq (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1) (mk___rep (mk___split_fields rliteral rliteral rliteral (of_rep1 2)))) true)))))
(assert (=> (= result4 true) (= (= result3 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1))))) (<= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1)))) (to_rep (rec__binary_trees__forest__s (us_split_fields3 f))))))))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (=> (= result3 true) (= (= result2 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1))))) (<= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1)))) (to_rep (rec__binary_trees__forest__s (us_split_fields3 f))))))))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (= (= result1 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (and (<= 0 (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1))))) (<= (to_rep (rec__binary_trees__cell__right (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1)))) (to_rep (rec__binary_trees__forest__s (us_split_fields3 f))))))))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (= (= result true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1)))) 2) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1)))) 0)))))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (<= 1 i))
(assert (<= i 100))
(assert (not (= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i)))) 0)))
(assert (and (<= 1 (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i))))) (<= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i)))) 100)))
(assert (= o (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i))))))
...
(assert (= result5 true))
(assert (not (<= (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i)))) 100)))
(check-sat)
(exit)
