...
(assert (= (= result4 true) (forall ((i1 Int)) (=> (and (<= (+ (to_rep (rec__binary_trees__forest__s (us_split_fields3 f))) 1) i1) (<= i1 100)) (= (bool_eq (select (rec__binary_trees__forest__c (us_split_fields3 f)) i1) (mk___rep (mk___split_fields (of_rep 0) (of_rep 0) (of_rep 0) (of_rep1 2)))) true)))))
...
(assert (= result5 true))
(assert (not (<= 1 (to_rep (rec__binary_trees__cell__left (us_split_fields1 (select (rec__binary_trees__forest__c (us_split_fields3 f)) i)))))))
(check-sat)
(exit)
