...
(define-fun dynamic_invariant ((temp___expr_164 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= 1 16)) (in_range1 temp___expr_164)))
(declare-sort et1 0)
...
(assert (<= 1 o))
(assert (<= o 10))
(assert (not (in_range2 (to_rep (select (select (select a2 m) n) o)))))
(check-sat)
(exit)
