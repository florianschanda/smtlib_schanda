...
(define-fun dynamic_invariant2 ((temp___expr_731 Int) (temp___is_init_728 Bool) (temp___skip_constant_729 Bool) (temp___do_toplevel_730 Bool)) Bool (=> (or (= temp___is_init_728 true) (<= 0 2147483647)) (in_range6 temp___expr_731)))
...
(define-fun dynamic_invariant3 ((temp___expr_807 Int) (temp___is_init_804 Bool) (temp___skip_constant_805 Bool) (temp___do_toplevel_806 Bool)) Bool (=> (or (= temp___is_init_804 true) (<= 0 5)) (in_range7 temp___expr_807)))
...
(define-fun dynamic_invariant4 ((temp___expr_820 Int) (temp___is_init_817 Bool) (temp___skip_constant_818 Bool) (temp___do_toplevel_819 Bool)) Bool (=> (or (= temp___is_init_817 true) (<= 0 2000)) (in_range8 temp___expr_820)))
...
(define-fun dynamic_invariant5 ((temp___expr_826 Int) (temp___is_init_823 Bool) (temp___skip_constant_824 Bool) (temp___do_toplevel_825 Bool)) Bool (=> (or (= temp___is_init_823 true) (<= 0 1)) (in_range9 temp___expr_826)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_925 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_925 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 4)) 111)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 7)) 87)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 12)) 110)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 13)) 103)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 15)) 78)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 17)) 119)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 19)) 67)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 20)) 111)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 21)) 110)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 22)) 102)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 24)) 103)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 26)) 68)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 27)) 97)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 28)) 116)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 29)) 97)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 31)) 116)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 32)) 111)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 34)) 102)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 35)) 105)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 36)) 108)) (= (to_rep (select (temp___String_Literal_925 us_void_param) 37)) 101)) :pattern ((temp___String_Literal_925 us_void_param)))))
...
(assert (=> (<= 0 2000) (in_range8 thelatchunlockduration)))
(assert (=> (<= 0 2000) (in_range8 thealarmsilentduration)))
(assert (=> (<= 0 2000) (in_range8 thefingerwaitduration)))
(assert (=> (<= 0 2000) (in_range8 thetokenremovalduration)))
(assert (=> (<= 0 5) (in_range7 theenclaveclearance)))
(assert (=> (<= 0 864000) (in_range5 theworkinghoursstart)))
(assert (=> (<= 0 864000) (in_range5 theworkinghoursend)))
(assert (=> (<= 0 864000) (in_range5 themaxauthduration)))
(assert (=> (<= 0 1) (in_range9 theaccesspolicy)))
(assert (=> (<= 0 5) (in_range7 theminentryclass)))
(assert (=> (<= 0 4194304) (in_range4 theminpreservedlogsize)))
(assert (=> (<= 0 4194304) (in_range4 thealarmthresholdsize)))
(assert (=> (<= 0 2147483647) (in_range6 thesystemmaxfar)))
(assert (and (and (and (and (and (and (and (and (and (and (and (and (in_range8 thelatchunlockduration1) (in_range8 thealarmsilentduration1)) (in_range8 thefingerwaitduration1)) (in_range8 thetokenremovalduration1)) (in_range7 theenclaveclearance1)) (in_range5 theworkinghoursstart1)) (in_range5 theworkinghoursend1)) (in_range5 themaxauthduration1)) (in_range9 theaccesspolicy1)) (in_range7 theminentryclass1)) (in_range4 theminpreservedlogsize1)) (in_range4 thealarmthresholdsize1)) (in_range6 thesystemmaxfar1)))
