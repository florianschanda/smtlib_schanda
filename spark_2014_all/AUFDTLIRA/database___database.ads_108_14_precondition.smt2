...
(assert (and (= (mk___rep (mk___split_fields o21 o22)) (oadd (balance account links accounts_balance) sum)) (= (bool_eq (mk___rep (mk___split_fields o21 o22)) (mk___rep (mk___split_fields (rec__money__amount__currency (us_split_fields1 (balance account links accounts_balance))) (of_rep1 (+ (to_rep1 (rec__money__amount__raw (us_split_fields1 (balance account links accounts_balance)))) (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))))))) true)))
