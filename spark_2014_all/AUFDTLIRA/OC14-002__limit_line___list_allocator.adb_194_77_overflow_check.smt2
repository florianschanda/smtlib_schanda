...
(assert (=> (not (= first_available1 0)) (= result13 (ite (< 0 o46) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (and (= o45 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o45)))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (= result12 (ite (= o45 first_available1) true false)))))
...
(assert (=> (not (not (= first_available1 0))) (= result12 (ite (= o47 0) true false))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (and (= o43 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o43)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (= result14 (ite (< 0 o43) true false)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (and (= o42 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o42))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (= result11 (ite (= o42 first_allocated1) true false))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (not (= result14 true)) (= result11 false)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (and (= o44 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o44)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (= result11 (ite (= o44 0) true false)))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o40 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o40))))
(assert (=> (= result11 true) (= o41 (ite (<= j1 o40) true false))))
(assert (=> (= result11 true) (= result15 (ite (<= 1 j1) o41 false))))
...
(assert (= result17 (ite (in_range7 o39) true false)))
