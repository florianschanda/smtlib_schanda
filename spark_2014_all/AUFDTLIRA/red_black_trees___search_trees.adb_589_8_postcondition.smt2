...
(assert (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))) 0)) (and (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t1)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) true) (and (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))) 0)) (and (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t2)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) true) (and (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t1)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))) (rec__search_trees__search_tree__values (us_split_fields7 t1))) true) (and (= (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t2)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))) (rec__search_trees__search_tree__values (us_split_fields7 t2))) true) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) i2))) true)))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) i2))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) i2))) true)))) (= (bool_eq7 (rec__search_trees__search_tree__values (us_split_fields7 t1)) 1 100 (rec__search_trees__search_tree__values (us_split_fields7 t2)) 1 100) true))))))))))
(assert (not (= (oeq (values1 t1) (values1 t2)) true)))
(check-sat)
(exit)
