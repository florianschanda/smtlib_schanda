...
(assert (and (= temp___417 (+ (to_rep1 description__first) (- j2 1))) (in_range1 (+ (to_rep1 description__first) (- j2 1)))))
(assert (and (<= (to_rep1 description__first) temp___417) (<= temp___417 (to_rep1 description__last))))
(assert (= o9 temp___417))
(assert (= o10 (store description3 o9 o8)))
(assert (= result5 description3))
