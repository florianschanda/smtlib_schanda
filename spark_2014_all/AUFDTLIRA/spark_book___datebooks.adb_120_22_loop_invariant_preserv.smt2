...
(assert (and (= temp___461 (+ (to_rep1 description__first) (- j2 1))) (in_range1 (+ (to_rep1 description__first) (- j2 1)))))
(assert (and (<= (to_rep1 description__first) temp___461) (<= temp___461 (to_rep1 description__last))))
(assert (= o4 temp___461))
