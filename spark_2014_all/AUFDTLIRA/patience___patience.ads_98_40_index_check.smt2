...
(assert (and (<= 0 i) (<= i 99)))
(assert (= o13 i))
(assert (= temp___477 (select (rec__patience__state__stacks (us_split_fields1 s)) o13)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o14 k))
(assert (= o15 (select temp___477 o14)))
(assert (= temp___478 (to_rep1 o15)))
(assert (and (<= 0 temp___478) (<= temp___478 99)))
(assert (= o16 temp___478))
