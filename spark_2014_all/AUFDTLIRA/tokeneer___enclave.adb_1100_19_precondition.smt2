...
(assert (= o4 (islocked state9)))
(assert (= o5 (ite (not (= o4 true)) true false)))
(assert (= result1 (ite (= o5 true) (islocked state1) false)))
...
(assert (=> (= result1 true) (= o8 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (= result1 true) (= o9 (ite (= o8 true) o7 false))))
(assert (=> (not (= result1 true)) (= o9 (of_int 1))))
...
(assert (= result2 true))
(assert (= o2 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields4 theadmin__split_fields5)))))
