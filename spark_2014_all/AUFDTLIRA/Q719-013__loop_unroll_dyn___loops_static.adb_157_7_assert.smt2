...
(assert (not (not (and (and (= (mk_int__ref result1) (mk_int__ref i)) (= i1 1)) (and (and (and (= (to_rep o) 0) (and (and (and (<= (to_rep1 a__first) i1) (<= i1 (to_rep1 a__last))) (= o1 i1)) (= o2 (store a o1 o)))) (and (= (mk_map__ref result2) (mk_map__ref a)) (= a1 o2))) (and (ite (= i1 1) (and (and (= bad1 result3) (= bad2 (of_int 0))) (and (and (= j18 j20) (= bad2 bad9)) (and (= j9 j1) (= bad10 bad2)))) (and (and (and (= (mk_int__ref result4) j20) (= j2 (to_rep1 a__first))) (ite (and (<= (to_rep1 a__first) j2) (<= j2 i1)) (and (and (and (= temp___361 bad1) (and (and (<= (to_rep1 a__first) j3) (<= j3 i1)) (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) j3) (<= j3 (to_rep1 a__last))) (= o3 j3)) (= o4 (select a1 o3))) (= o5 (to_rep o4))) (= o6 (ite (= o5 0) true false))) (= result5 (ite (not (= o6 true)) true false))) (ite (= result5 true) (and (= bad3 result6) (= bad4 (of_int 1))) (= bad4 bad3))) (= j3 i1)))) (and (and (= j3 j4) (= bad4 bad5)) (and (= j5 j3) (= bad6 bad4)))) (and (and (= j19 (mk_int__ref j4)) (= bad23 (mk_bool__ref bad5))) (and (= j7 j5) (= bad8 bad6)))) (and (and (= j2 j6) (= bad1 bad7)) (and (= j7 j2) (= bad8 bad1))))) (and (and (= j18 j19) (= bad22 bad23)) (and (= j9 j7) (= bad10 bad8))))) (and (forall ((j21 Int)) (=> (and (<= (to_rep1 a__first) j21) (<= j21 i1)) (= (to_rep (select a1 j21)) 0))) (and (and (= i1 result7) (= i2 2)) (and (and (and (= (to_rep o7) 0) (and (and (and (<= (to_rep1 a__first) i2) (<= i2 (to_rep1 a__last))) (= o8 i2)) (= o9 (store a1 o8 o7)))) (and (= a1 result8) (= a2 o9))) (and (ite (= i2 1) (and (and (= (mk_bool__ref result9) bad22) (= bad11 (of_int 0))) (and (and (= j16 j18) (= bad20 (mk_bool__ref bad11))) (and (= j17 j9) (= bad21 bad11)))) (and (and (and (= result10 j18) (= j10 (to_rep1 a__first))) (ite (and (<= (to_rep1 a__first) j10) (<= j10 i2)) (and (and (and (= temp___3611 bad9) (and (and (<= (to_rep1 a__first) j11) (<= j11 i2)) (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) j11) (<= j11 (to_rep1 a__last))) (= o10 j11)) (= o11 (select a2 o10))) (= o12 (to_rep o11))) (= o13 (ite (= o12 0) true false))) (= result11 (ite (not (= o13 true)) true false))) (ite (= result11 true) (and (and (= result12 (mk_bool__ref bad12)) (= bad13 (of_int 1))) (and (= bad14 (mk_bool__ref bad13)) (= bad15 bad13))) (and (= bad14 (mk_bool__ref bad12)) (= bad15 bad12)))) (= j11 i2)))) (and (and (= j12 (mk_int__ref j11)) (= bad16 bad14)) (and (= j13 j11) (= bad17 bad15)))) (and (and (= j14 j12) (= bad18 bad16)) (and (= j15 j13) (= bad19 bad17)))) (and (and (= j14 (mk_int__ref j10)) (= bad18 bad22)) (and (= j15 j10) (= bad19 bad10))))) (and (and (= j16 j14) (= bad20 bad18)) (and (= j17 j15) (= bad21 bad19))))) (forall ((j21 Int)) (=> (and (<= (to_rep1 a__first) j21) (<= j21 i2)) (= (to_rep (select a2 j21)) 0)))))))))))))
(check-sat)
(exit)
