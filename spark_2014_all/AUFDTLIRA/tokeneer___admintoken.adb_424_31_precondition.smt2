...
(assert (forall ((temp___139 Int)) (forall ((temp___140 Int)) (= (select (audittypes__nodescription__aggregate_def temp___139) temp___140) (of_rep temp___139)))))
...
(assert (forall ((x algorithmt)) (! (in_range8 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x yearst)) (! (in_range9 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x monthst)) (! (in_range10 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x dayst)) (! (in_range11 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(assert (forall ((x millisecst)) (! (in_range12 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(assert true)
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__cert__attr__contentst__id us_rep1) (rec__cert__attr__contentst__notbefore us_rep2) (rec__cert__attr__contentst__notafter us_rep2) (rec__cert__attr__contentst__mechanism algorithmt) (rec__cert__attr__contentst__basecertid us_rep1)))))
(define-fun us_split_fields_ID__4__projection ((a us_split_fields8)) us_rep1 (rec__cert__attr__contentst__id a))
(define-fun us_split_fields_NotBefore__2__projection ((a us_split_fields8)) us_rep2 (rec__cert__attr__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__2__projection ((a us_split_fields8)) us_rep2 (rec__cert__attr__contentst__notafter a))
(define-fun us_split_fields_Mechanism__2__projection ((a us_split_fields8)) algorithmt (rec__cert__attr__contentst__mechanism a))
(define-fun us_split_fields_BaseCertID__projection ((a us_split_fields8)) us_rep1 (rec__cert__attr__contentst__basecertid a))
...
(define-fun bool_eq6 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (and (= (bool_eq3 (rec__cert__attr__contentst__id (us_split_fields9 a)) (rec__cert__attr__contentst__id (us_split_fields9 b))) true) (= (bool_eq4 (rec__cert__attr__contentst__notbefore (us_split_fields9 a)) (rec__cert__attr__contentst__notbefore (us_split_fields9 b))) true)) (= (bool_eq4 (rec__cert__attr__contentst__notafter (us_split_fields9 a)) (rec__cert__attr__contentst__notafter (us_split_fields9 b))) true)) (= (to_rep5 (rec__cert__attr__contentst__mechanism (us_split_fields9 a))) (to_rep5 (rec__cert__attr__contentst__mechanism (us_split_fields9 b))))) (= (bool_eq3 (rec__cert__attr__contentst__basecertid (us_split_fields9 a)) (rec__cert__attr__contentst__basecertid (us_split_fields9 b))) true)) true false))
...
(declare-datatypes () ((contentst__ref1 (mk_contentst__ref1 (contentst__content1 us_rep4)))))
(define-fun contentst__ref___2__projection ((a contentst__ref1)) us_rep4 (contentst__content1 a))
...
(assert (forall ((x privileget)) (! (in_range13 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(assert (forall ((x classt)) (! (in_range14 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(define-fun us_rep___10__projection ((a us_rep5)) us_split_fields10 (us_split_fields11 a))
(define-fun bool_eq7 ((a us_rep5) (b us_rep5)) Bool (ite (= (to_rep11 (rec__privtypes__clearancet__class (us_split_fields11 a))) (to_rep11 (rec__privtypes__clearancet__class (us_split_fields11 b)))) true false))
...
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__attr__auth__contentst__id us_rep1) (rec__cert__attr__auth__contentst__notbefore us_rep2) (rec__cert__attr__auth__contentst__notafter us_rep2) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep1) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep5)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields12)) us_rep1 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields12)) us_rep2 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields12)) us_rep2 (rec__cert__attr__auth__contentst__notafter a))
...
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields12)) us_rep1 (rec__cert__attr__auth__contentst__basecertid a))
...
(define-fun us_rep___13__projection ((a us_rep6)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq8 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (and (and (and (= (bool_eq3 (rec__cert__attr__auth__contentst__id (us_split_fields13 a)) (rec__cert__attr__auth__contentst__id (us_split_fields13 b))) true) (= (bool_eq4 (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq4 (rec__cert__attr__auth__contentst__notafter (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep5 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 a))) (to_rep5 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq3 (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 b))) true)) (= (to_rep10 (rec__cert__attr__auth__contentst__role (us_split_fields13 a))) (to_rep10 (rec__cert__attr__auth__contentst__role (us_split_fields13 b))))) (= (bool_eq7 (rec__cert__attr__auth__contentst__clearance (us_split_fields13 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields13 b))) true)) true false))
...
(declare-datatypes () ((contentst__ref2 (mk_contentst__ref2 (contentst__content2 us_rep6)))))
(define-fun contentst__ref___3__projection ((a contentst__ref2)) us_rep6 (contentst__content2 a))
...
(declare-fun cert_attr_auth_to_cert_attr__function_guard (us_rep4 us_rep6) Bool)
(assert true)
...
(define-fun bool_eq9 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (= (to_rep5 (rec__cryptotypes__keypartt__algorithmid (us_split_fields15 a))) (to_rep5 (rec__cryptotypes__keypartt__algorithmid (us_split_fields15 b)))) (= (to_rep12 (rec__cryptotypes__keypartt__keyid (us_split_fields15 a))) (to_rep12 (rec__cryptotypes__keypartt__keyid (us_split_fields15 b))))) (= (to_rep13 (rec__cryptotypes__keypartt__keylength (us_split_fields15 a))) (to_rep13 (rec__cryptotypes__keypartt__keylength (us_split_fields15 b))))) true false))
...
(define-fun us_split_fields_ID__6__projection ((a us_split_fields16)) us_rep1 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields16)) us_rep2 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields16)) us_rep2 (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields16)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields16)) us_rep (rec__cert__id__contentst__subject a))
...
(define-fun bool_eq10 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__id__contentst__id (us_split_fields17 a)) (rec__cert__id__contentst__id (us_split_fields17 b))) true) (= (bool_eq4 (rec__cert__id__contentst__notbefore (us_split_fields17 a)) (rec__cert__id__contentst__notbefore (us_split_fields17 b))) true)) (= (bool_eq4 (rec__cert__id__contentst__notafter (us_split_fields17 a)) (rec__cert__id__contentst__notafter (us_split_fields17 b))) true)) (= (to_rep5 (rec__cert__id__contentst__mechanism (us_split_fields17 a))) (to_rep5 (rec__cert__id__contentst__mechanism (us_split_fields17 b))))) (= (bool_eq2 (rec__cert__id__contentst__subject (us_split_fields17 a)) (rec__cert__id__contentst__subject (us_split_fields17 b))) true)) (= (bool_eq9 (rec__cert__id__contentst__subjectpublickey (us_split_fields17 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields17 b))) true)) true false))
...
(declare-datatypes () ((contentst__ref3 (mk_contentst__ref3 (contentst__content3 us_rep8)))))
(define-fun contentst__ref___4__projection ((a contentst__ref3)) us_rep8 (contentst__content3 a))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1391 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 27)) 78)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 29)) 116)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 31)) 67)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 32)) 117)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 34)) 114)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 35)) 101)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 36)) 110)) (= (to_rep (select (temp___String_Literal_1391 us_void_param) 37)) 116)) :pattern ((temp___String_Literal_1391 us_void_param)))))
(declare-fun temp___String_Literal_1392 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1392 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 27)) 78)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 29)) 116)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 31)) 86)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 34)) 105)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 35)) 102)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 36)) 105)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 37)) 97)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 38)) 98)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 39)) 108)) (= (to_rep (select (temp___String_Literal_1392 us_void_param) 40)) 101)) :pattern ((temp___String_Literal_1392 us_void_param)))))
(declare-fun temp___String_Literal_1393 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1393 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 27)) 66)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 28)) 97)) (= (to_rep (select (temp___String_Literal_1393 us_void_param) 29)) 100)) :pattern ((temp___String_Literal_1393 us_void_param)))))
...
(define-fun dynamic_invariant4 ((temp___expr_439 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 1 150)) (in_range7 temp___expr_439)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant5 ((temp___expr_341 Int) (temp___is_init_338 Bool) (temp___skip_constant_339 Bool) (temp___do_toplevel_340 Bool)) Bool (=> (or (= temp___is_init_338 true) (<= 1901 2099)) (in_range9 temp___expr_341)))
(define-fun dynamic_invariant6 ((temp___expr_347 Int) (temp___is_init_344 Bool) (temp___skip_constant_345 Bool) (temp___do_toplevel_346 Bool)) Bool (=> (or (= temp___is_init_344 true) (<= 1 12)) (in_range10 temp___expr_347)))
(define-fun dynamic_invariant7 ((temp___expr_353 Int) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool)) Bool (=> (or (= temp___is_init_350 true) (<= 1 31)) (in_range11 temp___expr_353)))
(define-fun dynamic_invariant8 ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 0 86399999)) (in_range12 temp___expr_377)))
...
(define-fun dynamic_invariant10 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 0 4294967295)) (in_range5 temp___expr_200)))
(define-fun dynamic_invariant11 ((temp___expr_218 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 0 10)) (in_range8 temp___expr_218)))
(define-fun dynamic_invariant12 ((temp___expr_230 Int) (temp___is_init_227 Bool) (temp___skip_constant_228 Bool) (temp___do_toplevel_229 Bool)) Bool (=> (or (= temp___is_init_227 true) (<= 0 4294967295)) (in_range15 temp___expr_230)))
(define-fun dynamic_invariant13 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 0 128)) (in_range16 temp___expr_236)))
(define-fun dynamic_invariant14 ((temp___expr_885 Int) (temp___is_init_882 Bool) (temp___skip_constant_883 Bool) (temp___do_toplevel_884 Bool)) Bool (=> (or (= temp___is_init_882 true) (<= 0 3)) (in_range13 temp___expr_885)))
(define-fun dynamic_invariant15 ((temp___expr_897 Int) (temp___is_init_894 Bool) (temp___skip_constant_895 Bool) (temp___do_toplevel_896 Bool)) Bool (=> (or (= temp___is_init_894 true) (<= 0 5)) (in_range14 temp___expr_897)))
(define-fun dynamic_invariant16 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 0 4294967295)) (in_range6 temp___expr_321)))
(declare-const description (Array Int character))
(declare-const authvalid Bool)
(declare-const authcertcontents__split_fields us_split_fields__ref6)
(declare-const idcertcontents__split_fields us_split_fields__ref8)
...
(declare-const o1 us_rep4)
(declare-const o2 issueridt)
(declare-const o3 namecountt)
(declare-const o4 (Array Int character))
(declare-const o5 serialnumbert)
(declare-const o6 issueridt)
(declare-const o7 namecountt)
...
(declare-const authcertcontents__split_fields1 us_split_fields12)
...
(declare-const authcertcontents__split_fields2 us_split_fields12)
...
(define-fun o13 () us_rep1 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields o6 o7 o8)) o9)))
(define-fun o14 () us_rep1 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields o2 o3 o4)) o5)))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= o1 (cert_attr_auth_to_cert_attr (mk___rep6 (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields2)))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o14 (thebasecert o1)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o (cert_id_to_cert (mk___rep8 (us_split_fields__content8 idcertcontents__split_fields)))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o13 (theid o)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o10 (bool_eq3 o13 o14)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= result4 (mk_bool__ref baseidmatches1)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= baseidmatches2 o10))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o11 (cert_attr_auth_to_cert (mk___rep6 (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields2)))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o12 (iscurrent o11 currenttime)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= result5 (mk_bool__ref current1)))))
...
(assert (=> (not (= certfound true)) (= (let ((subject authcertcontents__split_fields)) (mk___split_fields__ref6 authcertcontents__split_fields2)) authcertcontents__split_fields)))
...
(assert (=> (not (= certfound true)) (= verified2 verified1)))
(assert (=> (not (= certfound true)) (= extractok2 extractok1)))
(assert (=> (not (= certfound true)) (= authcertcontents__split_fields2 authcertcontents__split_fields1)))
(assert (= result6 (mk_bool__ref authvalid)))
(assert (= authvalid1 (ite (= (ite (= (ite (= (ite (= certfound true) extractok2 false) true) baseidmatches2 false) true) verified2 false) true) current2 false)))
(assert (= (bool_eq description 1 150 nodescription 1 150) true))
(assert (=> (= certfound true) (=> (= extractok2 true) (not (= baseidmatches2 true)))))
