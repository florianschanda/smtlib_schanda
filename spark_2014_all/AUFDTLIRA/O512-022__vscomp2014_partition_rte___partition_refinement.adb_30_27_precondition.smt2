...
(assert (and (= o44 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range8 o44) (= o44 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= o45 (select f o44)))
(assert (= o46 (to_rep4 o45)))
(assert (not (<= 0 o46)))
(check-sat)
(exit)
