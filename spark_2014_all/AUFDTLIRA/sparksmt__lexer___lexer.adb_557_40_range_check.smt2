...
(assert (=> (= (to_rep3 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs5))) 0) (= temp___957 (int__content state19))))
(assert (=> (= (to_rep3 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs5))) 0) (= temp___956 (file__content the_file4))))
(assert (=> (= (to_rep3 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs5))) 0) (= temp___955 (mk___rep (us_split_discrs__content next_read__split_discrs5) (us_split_fields__content next_read__split_fields5) next_read__attr__constrained))))
(assert (=> (= (to_rep3 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs5))) 0) (= temp___954 (mk___rep1 s__split_discrs (us_split_fields__content1 s__split_fields5)))))
(assert (=> (= (to_rep3 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs5))) 0) (= temp___953 (int__content current_pos6))))
(assert (=> (= (to_rep3 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs5))) 0) (= temp___952 (int__content current_col6))))
(assert (=> (= (to_rep3 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs5))) 0) (= temp___951 (int__content current_line6))))
(assert (=> (= (to_rep3 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs5))) 0) (= temp___950 (int__content c5))))
(assert (=> (= (to_rep3 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs5))) 0) (= temp___949 (mk___rep (us_split_discrs__content current_read__split_discrs5) (us_split_fields__content current_read__split_fields5) current_read__attr__constrained))))
...
(assert (=> (= (to_rep3 (rec__file_io__read_result__status (us_split_discrs__content current_read__split_discrs5))) 0) (and (and (and (and (= (to_rep3 (rec__file_io__read_result__status current_read__split_discrs7)) 0) (=> (in_range12 (let ((subject state)) state21)) (not (let ((temp___959 (let ((subject state)) state21))) (or (and (<= 2 temp___959) (<= temp___959 2)) (and (<= 9 temp___959) (<= temp___959 9))))))) (<= 1 (length1 (mk___rep1 s__split_discrs s__split_fields7)))) (<= (int__content first_pos5) current_pos8)) (=> (or (= (let ((subject state)) state21) 6) (= (let ((subject state)) state21) 7)) (<= 2 (length1 (mk___rep1 s__split_discrs s__split_fields7)))))))
...
(assert (and (= temp___967 (+ (to_rep1 (first (rt tmp))) 2)) (in_range1 (+ (to_rep1 (first (rt tmp))) 2))))
(assert (<= temp___967 (to_rep1 (last (rt tmp)))))
