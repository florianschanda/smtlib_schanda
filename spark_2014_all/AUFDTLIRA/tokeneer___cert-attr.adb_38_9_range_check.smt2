...
(declare-const dummy4 usertexti)
...
(declare-const dummy9 serialnumbert)
...
(declare-const dummy16 algorithmt)
...
(define-fun us_rep___12__projection ((a us_rep3)) us_split_fields6 (us_split_fields7 a))
(define-fun bool_eq5 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (and (= (bool_eq3 (rec__cert__attr__contentst__id (us_split_fields7 a)) (rec__cert__attr__contentst__id (us_split_fields7 b))) true) (= (bool_eq4 (rec__cert__attr__contentst__notbefore (us_split_fields7 a)) (rec__cert__attr__contentst__notbefore (us_split_fields7 b))) true)) (= (bool_eq4 (rec__cert__attr__contentst__notafter (us_split_fields7 a)) (rec__cert__attr__contentst__notafter (us_split_fields7 b))) true)) (= (to_rep9 (rec__cert__attr__contentst__mechanism (us_split_fields7 a))) (to_rep9 (rec__cert__attr__contentst__mechanism (us_split_fields7 b))))) (= (bool_eq3 (rec__cert__attr__contentst__basecertid (us_split_fields7 a)) (rec__cert__attr__contentst__basecertid (us_split_fields7 b))) true)) true false))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1027 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 4)) 115)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 29)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_1027 us_void_param) 50)) 32)) :pattern ((temp___String_Literal_1027 us_void_param)))))
(declare-fun temp___String_Literal_1028 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1028 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1028 us_void_param) 2)) 115)) (= (to_rep (select (temp___String_Literal_1028 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_1028 us_void_param) 4)) 117)) (= (to_rep (select (temp___String_Literal_1028 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1028 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1028 us_void_param) 7)) 58)) (= (to_rep (select (temp___String_Literal_1028 us_void_param) 8)) 32)) :pattern ((temp___String_Literal_1028 us_void_param)))))
(declare-fun temp___String_Literal_1031 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1031 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1031 us_void_param) 2)) 83)) (= (to_rep (select (temp___String_Literal_1031 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_1031 us_void_param) 4)) 114)) (= (to_rep (select (temp___String_Literal_1031 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1031 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_1031 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_1031 us_void_param) 8)) 78)) (= (to_rep (select (temp___String_Literal_1031 us_void_param) 9)) 111)) (= (to_rep (select (temp___String_Literal_1031 us_void_param) 10)) 58)) (= (to_rep (select (temp___String_Literal_1031 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1031 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_1031 us_void_param)))))
...
(define-fun dynamic_invariant4 ((temp___expr_182 Int) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool)) Bool (=> (or (= temp___is_init_179 true) (<= 1 50)) (in_range3 temp___expr_182)))
(define-fun dynamic_invariant5 ((temp___expr_239 Int) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (=> (or (= temp___is_init_236 true) (<= 1901 2099)) (in_range7 temp___expr_239)))
(define-fun dynamic_invariant6 ((temp___expr_245 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 1 12)) (in_range8 temp___expr_245)))
(define-fun dynamic_invariant7 ((temp___expr_251 Int) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (=> (or (= temp___is_init_248 true) (<= 1 31)) (in_range9 temp___expr_251)))
(define-fun dynamic_invariant8 ((temp___expr_275 Int) (temp___is_init_272 Bool) (temp___skip_constant_273 Bool) (temp___do_toplevel_274 Bool)) Bool (=> (or (= temp___is_init_272 true) (<= 0 86399999)) (in_range10 temp___expr_275)))
(define-fun dynamic_invariant9 ((temp___expr_659 Int) (temp___is_init_656 Bool) (temp___skip_constant_657 Bool) (temp___do_toplevel_658 Bool)) Bool (=> (or (= temp___is_init_656 true) (<= 0 40)) (in_range5 temp___expr_659)))
(define-fun dynamic_invariant10 ((temp___expr_680 Int) (temp___is_init_677 Bool) (temp___skip_constant_678 Bool) (temp___do_toplevel_679 Bool)) Bool (=> (or (= temp___is_init_677 true) (<= 0 4294967295)) (in_range4 temp___expr_680)))
(define-fun dynamic_invariant11 ((temp___expr_698 Int) (temp___is_init_695 Bool) (temp___skip_constant_696 Bool) (temp___do_toplevel_697 Bool)) Bool (=> (or (= temp___is_init_695 true) (<= 0 10)) (in_range11 temp___expr_698)))
(define-fun dynamic_invariant12 ((temp___expr_894 Int) (temp___is_init_891 Bool) (temp___skip_constant_892 Bool) (temp___do_toplevel_893 Bool)) Bool (=> (or (= temp___is_init_891 true) (<= 0 4294967295)) (in_range6 temp___expr_894)))
...
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents)))))))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))))))) (= o (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents)))))))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents)))))))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents)))))))))))))) (= o 0)))
(assert (=> (<= 1 8) (= o1 (+ (- 8 1) 1))))
(assert (=> (not (<= 1 8)) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ 1 o2)))
