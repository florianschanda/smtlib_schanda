...
(assert (forall ((temp___272 (Array Int integer))) (forall ((temp___273 Int) (temp___274 Int)) (let ((temp___271 (temp___270 temp___272 temp___273 temp___274))) (forall ((temp___275 Int)) (ite (= temp___275 temp___273) (= (select temp___271 temp___275) (of_rep temp___274)) (= (select temp___271 temp___275) (select temp___272 temp___275))))))))
...
(assert (not (= (bool_eq arrays__f5__result4 1 8 (temp___270 arr_in 2 1) 1 8) true)))
(check-sat)
(exit)
