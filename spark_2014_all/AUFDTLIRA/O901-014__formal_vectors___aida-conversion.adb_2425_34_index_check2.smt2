...
(assert (and (<= (to_rep1 (first (rt source))) temp___1199) (<= temp___1199 (to_rep1 (last (rt source))))))
(assert (= o45 temp___1199))
...
(assert (and (= temp___1200 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1200)))
(check-sat)
(exit)
