...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (let ((temp___524 (temp___308 new_val 1 i))) (bool_eq a2 (to_rep (first2 (mk1 1 i))) (to_rep (last2 (mk1 1 i))) (elts2 temp___524) (to_rep (first4 (rt2 temp___524))) (to_rep (last4 (rt2 temp___524))))) true)))
(check-sat)
(exit)
