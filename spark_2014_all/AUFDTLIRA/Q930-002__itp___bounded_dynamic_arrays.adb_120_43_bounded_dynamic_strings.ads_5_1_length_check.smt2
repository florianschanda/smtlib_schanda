...
(assert (not (= (ite (<= (to_rep1 (first8 temp___10241)) (to_rep1 (last9 temp___10241))) (+ (- (to_rep1 (last9 temp___10241)) (to_rep1 (first8 temp___10241))) 1) 0) (ite (<= 1 last6) (+ (- last6 1) 1) 0))))
(check-sat)
(exit)
