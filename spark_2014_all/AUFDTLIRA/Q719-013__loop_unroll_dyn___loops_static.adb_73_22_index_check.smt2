...
(assert (= a2 result1))
(assert (= a3 o2))
(assert (forall ((j14 Int)) (=> (and (<= (to_rep1 a__first) j14) (<= j14 i2)) (= (to_rep (select a3 j14)) 0))))
...
(assert (= o3 a3))
(assert (= o3 temp___312))
(assert (= (mk1 (to_rep1 a__first) i2) temp___3121))
(assert (= temp___312 loops_static__loop4__B_11__a_begins__assume))
(assert (= (mk (to_rep1 (first2 temp___3121)) (to_rep1 (last2 temp___3121))) loops_static__loop4__B_11__a_begins__assume1))
...
(assert (= j3 result2))
(assert (= j4 (to_rep1 (first (rt a_begins)))))
(assert (<= (to_rep1 (first (rt a_begins))) j4))
(assert (<= j4 (to_rep1 (last (rt a_begins)))))
(assert (and (<= (to_rep1 (first (rt a_begins))) j5) (<= j5 (to_rep1 (last (rt a_begins))))))
