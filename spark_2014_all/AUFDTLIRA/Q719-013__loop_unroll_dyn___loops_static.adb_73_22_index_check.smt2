...
(declare-const temp___347 (Array Int natural))
(declare-const temp___3471 t1)
...
(assert (= a1 result1))
(assert (= a2 o2))
(assert (forall ((j3 Int)) (=> (and (<= (to_rep1 a__first) j3) (<= j3 i2)) (= (to_rep (select a2 j3)) 0))))
...
(assert (= o3 a2))
(assert (= o3 temp___347))
(assert (= (mk1 (to_rep1 a__first) i2) temp___3471))
(assert (= temp___347 loops_static__loop4__B_11__a_begins__assume))
(assert (= (mk (to_rep1 (first2 temp___3471)) (to_rep1 (last2 temp___3471))) loops_static__loop4__B_11__a_begins__assume1))
(assert (= (mk___t loops_static__loop4__B_11__a_begins__assume loops_static__loop4__B_11__a_begins__assume1) a_begins))
(assert (dynamic_invariant a_begins true false true true))
(assert (= j result2))
(assert (= j1 (to_rep1 (first (rt a_begins)))))
(assert (<= (to_rep1 (first (rt a_begins))) j1))
(assert (<= j1 (to_rep1 (last (rt a_begins)))))
(assert (and (<= (to_rep1 (first (rt a_begins))) j2) (<= j2 (to_rep1 (last (rt a_begins))))))
