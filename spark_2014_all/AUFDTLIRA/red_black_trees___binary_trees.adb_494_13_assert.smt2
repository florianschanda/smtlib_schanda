...
(assert (<= 1 i13))
(assert (<= i13 100))
(assert (< 0 (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i13))))))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) v) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i13))))))) true))
(assert (not (not (= i13 v))))
(check-sat)
(exit)
