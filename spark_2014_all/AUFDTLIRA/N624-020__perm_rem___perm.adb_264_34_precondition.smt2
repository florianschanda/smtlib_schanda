...
(assert (and (= o27 (remove o25 o26)) (and (dynamic_invariant2 o27 true false true) (and (= (invariant__ o27) true) (and (= (to_rep2 (last (rt o27))) (- (to_rep2 (last (rt o25))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o26 1))) (= (to_rep (select (elts o25) k)) (to_rep (select (elts o27) k))))) (and (forall ((k Int)) (=> (and (<= (+ o26 1) k) (<= k (to_rep2 (last (rt o25))))) (= (to_rep (select (elts o25) k)) (to_rep (select (elts o27) (- k 1)))))) (forall ((k Int)) (=> (and (<= o26 k) (<= k (- (to_rep2 (last (rt o25))) 1))) (= (to_rep (select (elts o25) (+ k 1))) (to_rep (select (elts o27) k))))))))))))
