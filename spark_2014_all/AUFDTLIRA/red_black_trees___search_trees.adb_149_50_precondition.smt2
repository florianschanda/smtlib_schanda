...
(assert (= result2 true))
(assert (and (= o4 (valid_root f_old v)) (=> (< (size f_old) v) (not (= o4 true)))))
...
(assert (= o2 (select temp___1553 v)))
(assert (= o3 (us_split_fields1 o2)))
(assert (= result4 (rec__tree_model__path_type__k o3)))
(assert (= result4 true))
