...
(assert (<= 1 i5))
(assert (<= i5 100))
(assert (and (= temp___1496 (model__ f root)) (and (dynamic_invariant5 temp___1496 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1496 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1496 root)))) 0) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (not (= i34 root)) (ite (and (not (= (parent f i34) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1496 (parent f i34)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1496 i34))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1496 i34))) true)))))) (and (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1496 i34))) true) (not (= i34 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1496 (parent f i34)))) (position f i34) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1496 i34)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1496 i34)))) 0)))) (forall ((i34 Int)) (=> (and (<= 1 i34) (<= i34 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1496 i34))) true) (forall ((j52 Int)) (=> (and (<= 1 j52) (<= j52 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1496 j52))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1496 i34))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1496 j52)))) true)) (= j52 i34))))))))))))))
(assert (= o29 (select temp___1496 i5)))
(assert (= o30 (us_split_fields1 o29)))
(assert (= result10 (rec__tree_model__path_type__k o30)))
