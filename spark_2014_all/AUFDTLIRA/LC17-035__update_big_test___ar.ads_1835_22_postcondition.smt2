...
(declare-const temp___9708 us_rep3)
(declare-const o29 it4)
(declare-const o30 us_split_fields6)
(declare-const temp___9710 us_rep3)
...
(declare-const temp___9719 us_rep3)
...
(assert (= temp___9719 (mk___rep3 o39)))
(assert (= result2 (mk___split_fields__ref3 r__split_fields3)))
(assert (= r__split_fields4 (us_split_fields7 temp___9719)))
...
(assert (<= n 99))
(assert (not (= n i)))
(assert (not (= n (to_rep r__split_fields))))
(assert (not (= (bool_eq2 (select (rec__ar__rofaofr2__b2 (us_split_fields__content3 r__split_fields5)) n) (select r__split_fields1 n)) true)))
(check-sat)
(exit)
