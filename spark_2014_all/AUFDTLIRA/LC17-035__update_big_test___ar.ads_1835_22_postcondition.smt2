...
(declare-const temp___9649 us_rep3)
(declare-const o29 it4)
(declare-const o30 us_split_fields6)
(declare-const temp___9651 us_rep3)
...
(declare-const temp___9660 us_rep3)
...
(assert (= temp___9660 (mk___rep3 o39)))
(assert (= result2 (mk___split_fields__ref3 r__split_fields3)))
(assert (= r__split_fields4 (us_split_fields7 temp___9660)))
