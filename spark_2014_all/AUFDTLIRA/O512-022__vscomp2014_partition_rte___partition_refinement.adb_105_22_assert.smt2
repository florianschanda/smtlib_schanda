...
(assert (not (= (key (mk___rep d__split_discrs d__split_fields2) c9) (to_rep (select a1 i)))))
(assert (not (= (key (mk___rep d__split_discrs d__split_fields2) c9) (to_rep (select a1 j)))))
