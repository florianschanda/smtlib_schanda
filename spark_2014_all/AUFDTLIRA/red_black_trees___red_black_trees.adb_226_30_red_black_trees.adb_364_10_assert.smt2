...
(assert (=> (= result2 true) (= result3 (mk_int__ref n))))
(assert (=> (= result2 true) (= n18 1)))
(assert (=> (= result2 true) (=> (and (<= 1 n18) (<= n18 100)) (and (and (= temp___587 n18) (and (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c61b))) i14))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c61b) i14)))) n19)) (not (= i14 (root (rec__red_black_trees__rbt__struct (us_split_fields9 c62b)))))) (= (eq (select (nb_blacks c62b) i14) (select (nb_blacks c61b) i14)) true)))) (and (and (=> (<= 1 100) (in_range2 n19)) (and (<= 1 n19) (<= n19 100))) (= n19 100)))) (and (= n23 (mk_int__ref n19)) (= n24 n19))))))
(assert (=> (= result2 true) (=> (and (<= 1 n18) (<= n18 100)) (= n25 n23))))
(assert (=> (= result2 true) (=> (and (<= 1 n18) (<= n18 100)) (= n26 n24))))
(assert (=> (= result2 true) (=> (not (and (<= 1 n18) (<= n18 100))) (= n25 (mk_int__ref n18)))))
(assert (=> (= result2 true) (=> (not (and (<= 1 n18) (<= n18 100))) (= n26 n18))))
(assert (=> (= result2 true) (= (same_nb_blacks c62b) true)))
(assert (=> (= result2 true) (= n27 n25)))
(assert (=> (= result2 true) (= n28 n26)))
(assert (=> (not (= result2 true)) (= n27 (mk_int__ref n))))
(assert (=> (not (= result2 true)) (= n28 n9)))
(assert (not (= (same_nb_blacks c62b) true)))
(check-sat)
(exit)
