...
(define-fun dynamic_invariant1 ((temp___expr_147 us_rep1) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (let ((temp___148 (rec__use_types_with_invariants_no_spark__container__c (us_split_discrs1 temp___expr_147)))) (and (dynamic_property1 1 (to_rep temp___148) (first1 (rec__use_types_with_invariants_no_spark__container__content (us_split_fields1 temp___expr_147))) (last1 (rec__use_types_with_invariants_no_spark__container__content (us_split_fields1 temp___expr_147)))) (and (= (first1 (rec__use_types_with_invariants_no_spark__container__content (us_split_fields1 temp___expr_147))) 1) (= (last1 (rec__use_types_with_invariants_no_spark__container__content (us_split_fields1 temp___expr_147))) (to_rep temp___148))))))
...
(assert (dynamic_invariant1 (mk___rep c__split_discrs (mk___split_fields (mk___t c__split_fields c__split_fields1))) true false true))
(assert (in_range1 i))
