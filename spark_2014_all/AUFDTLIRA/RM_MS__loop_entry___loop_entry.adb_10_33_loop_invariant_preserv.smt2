...
(assert (and (forall ((n Int)) (=> (and (<= l n) (<= n i2)) (= (to_rep (select a2 n)) 0))) (forall ((n Int)) (=> (and (<= 1 n) (<= n 100)) (=> (or (< n l) (< i2 n)) (= (to_rep (select a2 n)) (to_rep (select a n))))))))
...
(assert (= i3 (+ i2 1)))
(assert (= result3 a2))
(assert (= a3 (store a2 i3 rliteral)))
(declare-const n Int)
(assert (<= 1 n))
(assert (<= n 100))
(assert (or (< n l) (< i3 n)))
