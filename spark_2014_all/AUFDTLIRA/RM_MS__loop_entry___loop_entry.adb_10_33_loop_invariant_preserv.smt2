...
(assert (and (and (forall ((temp___158 Int)) (=> (and (<= 1 temp___158) (<= temp___158 100)) (=> (< i2 temp___158) (= (select a2 temp___158) (select a temp___158))))) (=> (<= l u) (dynamic_property l u i2))) (and (<= l i2) (<= i2 u))))
(assert (not (= i2 u)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
(assert (= (to_rep o2) 0))
