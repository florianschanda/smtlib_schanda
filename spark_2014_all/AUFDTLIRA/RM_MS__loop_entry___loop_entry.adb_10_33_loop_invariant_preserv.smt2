...
(assert (and (and (forall ((temp___183 Int)) (=> (and (<= 1 temp___183) (<= temp___183 100)) (=> (< i2 temp___183) (= (select a2 temp___183) (select a temp___183))))) (=> (<= l u) (dynamic_property l u i2))) (and (<= l i2) (<= i2 u))))
(assert (not (= i2 u)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
(assert (= (to_rep o2) 0))
...
(assert (<= l n))
(assert (<= n i3))
(assert (not (= (to_rep (select a3 n)) 0)))
(check-sat)
(exit)
