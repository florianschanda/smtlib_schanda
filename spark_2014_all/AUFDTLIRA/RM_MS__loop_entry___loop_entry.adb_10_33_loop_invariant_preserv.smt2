...
(assert (= a2 o1))
(assert (and (forall ((n2 Int)) (=> (and (<= l n2) (<= n2 i2)) (= (to_rep (select a3 n2)) 0))) (forall ((n2 Int)) (=> (and (<= 1 n2) (<= n2 100)) (=> (or (< n2 l) (< i2 n2)) (= (to_rep (select a3 n2)) (to_rep (select a n2))))))))
(assert (and (and (forall ((temp___158 Int)) (=> (and (<= 1 temp___158) (<= temp___158 100)) (=> (< i2 temp___158) (= (select a3 temp___158) (select a temp___158))))) (=> (<= l u) (dynamic_property l u i2))) (and (<= l i2) (<= i2 u))))
(assert (not (= i2 u)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
(assert (= (to_rep o3) 0))
(assert (= o4 (store a3 i3 o3)))
(assert (= result3 a3))
(assert (= a4 o4))
(declare-const n2 Int)
(assert (<= l n2))
(assert (<= n2 i3))
(assert (not (= (to_rep (select a4 n2)) 0)))
(check-sat)
(exit)
