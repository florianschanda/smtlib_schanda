...
(define-fun dynamic_invariant4 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 1 100)) (in_range4 temp___expr_166)))
(assert (forall ((a1 us_t)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant1 a1 true true true true) (dynamic_invariant4 i true true true true)) (and (= (invariant__ a1) true) (and (<= (first1 a1) i) (<= i (last1 a1))))) (let ((result (remove a1 i))) (and (and (= (invariant__ result) true) (and (= (last1 result) (- (last1 a1) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep (select (to_array a1) k)) (to_rep (select (to_array result) k))))) (and (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (last1 a1))) (= (to_rep (select (to_array a1) k)) (to_rep (select (to_array result) (- k 1)))))) (forall ((k Int)) (=> (and (<= i k) (<= k (- (last1 a1) 1))) (= (to_rep (select (to_array a1) (+ k 1))) (to_rep (select (to_array result) k))))))))) (dynamic_invariant1 result true false true true)))) :pattern ((remove a1 i))))))
(declare-const hr Int)
(declare-const perm__perm_eq__result Int)
(declare-const o Int)
(declare-const result Int)
(declare-const hr1 Int)
(declare-const result1 Int)
(declare-const perm__perm_eq__result1 Int)
(declare-const perm__perm_eq__result2 Int)
(declare-const perm__perm_eq__result3 Int)
(declare-const hr2 Int)
(declare-const perm__perm_eq__result4 Int)
(declare-const hr3 Int)
(declare-const perm__perm_eq__result5 Int)
...
(assert (and (= o (extended_perm a b)) (and (in_range2 o) (=> (= (distinct o 0) true) (forall ((ia Int)) (=> (and (<= (to_rep1 (first (rt a))) ia) (<= ia (to_rep1 (last (rt a))))) (exists ((ib Int)) (and (and (<= (to_rep1 (first (rt b))) ib) (<= ib (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) ib))) (= (is_perm (remove a ia) (remove b ib)) true))))))))))
(assert (= (mk_int__ref result) (mk_int__ref hr)))
(assert (= hr1 o))
(assert (in_range2 hr1))
(assert (= perm__perm_eq__result1 perm__perm_eq__result2))
(assert (= perm__perm_eq__result3 perm__perm_eq__result1))
(assert (= (mk_int__ref result1) (mk_int__ref perm__perm_eq__result)))
(assert (= perm__perm_eq__result1 hr1))
(assert (= (mk_int__ref perm__perm_eq__result4) (mk_int__ref perm__perm_eq__result2)))
(assert (= hr1 hr2))
(assert (= perm__perm_eq__result5 perm__perm_eq__result3))
(assert (= hr3 hr1))
(assert (= result2 perm__perm_eq__result4))
(assert (= (distinct perm__perm_eq__result4 0) true))
(declare-const ia Int)
(assert (<= (to_rep1 (first (rt a))) ia))
(assert (<= ia (to_rep1 (last (rt a)))))
(assert (not (exists ((ib Int)) (and (and (<= (to_rep1 (first (rt b))) ib) (<= ib (to_rep1 (last (rt b))))) (= (to_rep (select (elts a) ia)) (to_rep (select (elts b) ib)))))))
(check-sat)
(exit)
