...
(define-fun dynamic_invariant4 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 1 100)) (in_range4 temp___expr_142)))
(assert (forall ((a1 us_t)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant1 a1 true true true) (dynamic_invariant4 i true true true)) (and (= (invariant__ a1) true) (and (<= (first1 a1) i) (<= i (last1 a1))))) (let ((result (remove a1 i))) (and (and (= (invariant__ result) true) (and (= (last1 result) (- (last1 a1) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep (select (to_array a1) k)) (to_rep (select (to_array result) k))))) (and (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (last1 a1))) (= (to_rep (select (to_array a1) k)) (to_rep (select (to_array result) (- k 1)))))) (forall ((k Int)) (=> (and (<= i k) (<= k (- (last1 a1) 1))) (= (to_rep (select (to_array a1) (+ k 1))) (to_rep (select (to_array result) k))))))))) (dynamic_invariant1 result true false true)))) :pattern ((remove a1 i))))))
...
(assert (and (= o (extended_perm a b)) (and (in_range2 o) (=> (= (of_int o) true) (forall ((ia1 Int)) (=> (and (<= (to_rep1 (first (rt a))) ia1) (<= ia1 (to_rep1 (last (rt a))))) (exists ((ib1 Int)) (and (and (<= (to_rep1 (first (rt b))) ib1) (<= ib1 (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib1))) (= (is_perm (remove a ia1) (remove b ib1)) true))))))))))
(assert (= (mk_int__ref result2) (mk_int__ref hr)))
(assert (= hr1 o))
...
(assert (= (mk_int__ref result3) (mk_int__ref perm__perm_eq__result)))
...
(assert (= hr3 hr1))
(assert (= result4 perm__perm_eq__result4))
(assert (= (of_int perm__perm_eq__result4) true))
(declare-const ia1 Int)
(assert (<= (to_rep1 (first (rt a))) ia1))
(assert (<= ia1 (to_rep1 (last (rt a)))))
(assert (not (exists ((ib1 Int)) (and (and (<= (to_rep1 (first (rt b))) ib1) (<= ib1 (to_rep1 (last (rt b))))) (= (to_rep (select (elts a) ia1)) (to_rep (select (elts b) ib1)))))))
(check-sat)
(exit)
