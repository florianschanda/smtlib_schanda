...
(assert (not (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) i9))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f_old root) j7)))) true)))
(check-sat)
(exit)
