...
(declare-const temp___288 (Array Int us_rep))
...
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___290 r1)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___288 data1)))
...
(assert (=> (and (<= 1 r1) (<= r1 10000)) (and (and (forall ((temp___289 Int)) (=> (and (<= 1 temp___289) (<= temp___289 10000)) (ite (< r2 temp___289) (= (select data3 temp___289) (select temp___288 temp___289)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data3 temp___289))) (rec__list_allocator__cell__stat (us_split_fields1 (select temp___288 temp___289))))))) (=> (<= 1 10000) (in_range3 r2))) (and (<= 1 r2) (<= r2 10000)))))
...
(assert (and (= o14 (is_valid (map__content data6) first_available1 (mk___split_fields1 model____split_fields model____split_fields1))) (= (= o14 true) (and (and (and (and (and (and (<= (length model____split_fields) 10000) (<= (length1 model____split_fields1) 10000)) (= (+ (length model____split_fields) (length1 model____split_fields1)) 10000)) (ite (not (= first_available1 0)) (and (< 0 (length model____split_fields)) (= (get model____split_fields 1) first_available1)) (= (length model____split_fields) 0))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length model____split_fields))) (and (and (in_range3 (get model____split_fields j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select (map__content data6) (get model____split_fields j))))) (ite (< j (length model____split_fields)) (get model____split_fields (+ j 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- j 1))) (not (= (get model____split_fields j) (get model____split_fields k))))))))) (forall ((e Int)) (=> (and (in_range5 e) (= (contains1 model____split_fields1 e) true)) (in_range3 e)))) (forall ((r7 Int)) (=> (and (<= 1 r7) (<= r7 10000)) (ite (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select (map__content data6) r7)))) 0) (and (= (contains model____split_fields r7) true) (not (= (contains1 model____split_fields1 r7) true))) (and (not (= (contains model____split_fields r7) true)) (= (contains1 model____split_fields1 r7) true)))))))))
(assert (and (= o15 (all_available (map__content data6))) (= (= o15 true) (forall ((r7 Int)) (=> (and (<= 1 r7) (<= r7 10000)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select (map__content data6) r7)))) 0))))))
(assert (= result4 (ite (= o15 true) o14 false)))
