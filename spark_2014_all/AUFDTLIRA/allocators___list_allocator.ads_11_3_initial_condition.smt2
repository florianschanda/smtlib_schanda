...
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___253 r1)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= temp___251 data1)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (and (= o7 (+ r1 1)) (in_range2 (+ r1 1))))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= (to_rep o8) o7))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (=> (< r1 10000) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data1 r1))) o9))))
...
(assert (=> (and (<= 1 r1) (<= r1 10000)) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 r2)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 rr1)))) (ite (= rr1 10000) 0 (+ rr1 1)))))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select data3 10000)))) 0)))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (forall ((rr1 Int)) (=> (and (<= 1 rr1) (<= rr1 10000)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select data3 rr1)))) 0)))))
(assert (=> (and (<= 1 r1) (<= r1 10000)) (and (and (forall ((temp___252 Int)) (=> (and (<= 1 temp___252) (<= temp___252 10000)) (ite (< r2 temp___252) (= (select data3 temp___252) (select temp___251 temp___252)) (= (rec__list_allocator__cell__stat (us_split_fields1 (select data3 temp___252))) (rec__list_allocator__cell__stat (us_split_fields1 (select temp___251 temp___252))))))) (=> (<= 1 10000) (in_range3 r2))) (and (<= 1 r2) (<= r2 10000)))))
...
(assert (and (= o22 (is_valid (map__content data7) first_available1 (mk___split_fields1 model____split_fields model____split_fields1))) (= (= o22 true) (and (and (and (and (and (and (<= (length model____split_fields) 10000) (<= (length1 model____split_fields1) 10000)) (= (+ (length model____split_fields) (length1 model____split_fields1)) 10000)) (ite (not (= first_available1 0)) (and (< 0 (length model____split_fields)) (= (get model____split_fields 1) first_available1)) (= (length model____split_fields) 0))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length model____split_fields))) (and (and (in_range3 (get model____split_fields j)) (= (to_rep (rec__list_allocator__cell__next (us_split_fields1 (select (map__content data7) (get model____split_fields j))))) (ite (< j (length model____split_fields)) (get model____split_fields (+ j 1)) 0))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- j 1))) (not (= (get model____split_fields j) (get model____split_fields k))))))))) (forall ((e Int)) (=> (and (in_range5 e) (= (contains1 model____split_fields1 e) true)) (in_range3 e)))) (forall ((r8 Int)) (=> (and (<= 1 r8) (<= r8 10000)) (ite (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select (map__content data7) r8)))) 0) (and (= (contains model____split_fields r8) true) (not (= (contains1 model____split_fields1 r8) true))) (and (not (= (contains model____split_fields r8) true)) (= (contains1 model____split_fields1 r8) true)))))))))
(assert (and (= o23 (all_available (map__content data7))) (= (= o23 true) (forall ((r8 Int)) (=> (and (<= 1 r8) (<= r8 10000)) (= (to_rep1 (rec__list_allocator__cell__stat (us_split_fields1 (select (map__content data7) r8)))) 0))))))
(assert (= result6 (ite (= o23 true) o22 false)))
