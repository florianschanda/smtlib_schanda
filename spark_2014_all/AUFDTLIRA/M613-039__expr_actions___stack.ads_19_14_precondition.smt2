...
(assert (forall ((s us_rep)) (! (= (to__ s) (let ((temp___177 (let ((temp___175 (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))) (let ((temp___174 1)) (let ((temp___176 (rec__stack__stack__content (us_split_fields1 s)))) (of_array1 temp___176 temp___174 temp___175)))))) (of_array (to_array1 temp___177) (first3 temp___177) (last3 temp___177)))) :pattern ((to__ s)))))
...
(assert (forall ((s us_rep)) (! (= (to_but_top s) (let ((temp___189 (let ((temp___187 (- (to_rep1 (rec__stack__stack__top (us_split_fields1 s))) 1))) (let ((temp___186 1)) (let ((temp___188 (rec__stack__stack__content (us_split_fields1 s)))) (of_array2 temp___188 temp___186 temp___187)))))) (of_array (to_array2 temp___189) (first5 temp___189) (last5 temp___189)))) :pattern ((to_but_top s)))))
...
(define-fun dynamic_invariant3 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 100)) (in_range2 temp___expr_136)))
(define-fun dynamic_invariant4 ((temp___expr_147 Int) (temp___is_init_144 Bool) (temp___skip_constant_145 Bool) (temp___do_toplevel_146 Bool)) Bool (=> (or (= temp___is_init_144 true) (<= 1 100)) (in_range3 temp___expr_147)))
...
(assert (= (to_rep o4) x))
(assert (and (<= 1 (to_rep1 s__split_fields2)) (<= (to_rep1 s__split_fields2) 100)))
...
(assert (= (mk___split_fields s__split_fields8 s__split_fields9) (mk___split_fields s__split_fields4 s__split_fields5)))
(assert (and (= (mk___t temp___229 temp___2291) (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))) (and (dynamic_invariant1 (mk___t temp___229 temp___2291) true false true) (and (= s__split_fields1 temp___229) (= (mk (to_rep (first2 (mk1 1 (to_rep1 s__split_fields)))) (to_rep (last2 (mk1 1 (to_rep1 s__split_fields))))) temp___2291)))))
(assert (and (= (mk___t temp___228 temp___2281) (to_but_top (mk___rep (mk___split_fields s__split_fields6 s__split_fields7)))) (and (dynamic_invariant1 (mk___t temp___228 temp___2281) true false true) (and (= s__split_fields7 temp___228) (= (mk (to_rep (first4 (mk2 1 (- (to_rep1 s__split_fields6) 1)))) (to_rep (last4 (mk2 1 (- (to_rep1 s__split_fields6) 1))))) temp___2281)))))
(assert (= o10 (bool_eq temp___228 (to_rep (first temp___2281)) (to_rep (last temp___2281)) temp___229 (to_rep (first temp___2291)) (to_rep (last temp___2291)))))
(assert (not (not (= (is_empty (mk___rep (mk___split_fields s__split_fields6 s__split_fields7))) true))))
(check-sat)
(exit)
