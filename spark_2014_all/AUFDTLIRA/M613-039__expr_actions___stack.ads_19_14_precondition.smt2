...
(define-fun temp___2552 () us_t (mk___t temp___255 temp___2551))
...
(assert (= o6 o8))
(assert (= temp___252 o7))
(assert (= temp___2521 o8))
(assert (= result2 s__split_fields2))
(assert (= result3 s__split_fields3))
(assert (= temp___252 s__split_fields4))
(assert (= temp___2521 s__split_fields5))
...
(assert (and (= temp___2562 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))) (and (dynamic_invariant1 temp___2562 true false true true) (and (= s__split_fields1 temp___256) (= (mk (to_rep (first2 (mk1 1 (to_rep1 s__split_fields)))) (to_rep (last2 (mk1 1 (to_rep1 s__split_fields))))) temp___2561)))))
(assert (and (= temp___2552 (to_but_top (mk___rep (mk___split_fields s__split_fields6 s__split_fields7)))) (and (dynamic_invariant1 temp___2552 true false true true) (and (= s__split_fields7 temp___255) (= (mk (to_rep (first4 (mk2 1 (- (to_rep1 s__split_fields6) 1)))) (to_rep (last4 (mk2 1 (- (to_rep1 s__split_fields6) 1))))) temp___2551)))))
(assert (= o9 (bool_eq temp___255 (to_rep (first temp___2551)) (to_rep (last temp___2551)) temp___256 (to_rep (first temp___2561)) (to_rep (last temp___2561)))))
