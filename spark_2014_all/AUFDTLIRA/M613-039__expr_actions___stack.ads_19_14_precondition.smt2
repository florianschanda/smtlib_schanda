...
(assert (and (= temp___2292 (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))) (and (dynamic_invariant1 temp___2292 true false true) (and (= s__split_fields1 temp___229) (= (mk (to_rep (first2 (mk1 1 (to_rep1 s__split_fields)))) (to_rep (last2 (mk1 1 (to_rep1 s__split_fields))))) temp___2291)))))
(assert (and (= temp___2282 (to_but_top (mk___rep (mk___split_fields s__split_fields6 s__split_fields7)))) (and (dynamic_invariant1 temp___2282 true false true) (and (= s__split_fields7 temp___228) (= (mk (to_rep (first4 (mk2 1 (- (to_rep1 s__split_fields6) 1)))) (to_rep (last4 (mk2 1 (- (to_rep1 s__split_fields6) 1))))) temp___2281)))))
(assert (= o9 (bool_eq temp___228 (to_rep (first temp___2281)) (to_rep (last temp___2281)) temp___229 (to_rep (first temp___2291)) (to_rep (last temp___2291)))))
