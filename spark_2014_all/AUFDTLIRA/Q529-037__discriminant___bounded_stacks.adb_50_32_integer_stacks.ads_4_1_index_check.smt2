...
(define-fun dynamic_property8 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range2 low) (and (in_range2 high) (=> (<= low high) (and (in_range1 low) (in_range1 high))))))
...
(assert (not (<= (to_rep this__split_fields2) (to_rep2 (last this__split_fields1)))))
(check-sat)
(exit)
