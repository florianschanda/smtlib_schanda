...
(declare-fun temp___589 ((Array Int component_t) Int Int Int) (Array Int component_t))
...
(assert (forall ((temp___591 (Array Int component_t))) (forall ((temp___592 Int) (temp___593 Int) (temp___594 Int)) (let ((temp___590 (temp___589 temp___591 temp___592 temp___593 temp___594))) (=> (and (and (dynamic_invariant temp___592 true true true true) (dynamic_invariant temp___593 true true true true)) (dynamic_invariant1 temp___594 true true true true)) (forall ((temp___595 Int)) (ite (and (<= temp___592 temp___595) (<= temp___595 temp___593)) (= (to_rep (select temp___590 temp___595)) temp___594) (= (select temp___590 temp___595) (select temp___591 temp___595)))))))))
(declare-const a (Array Int component_t))
(declare-const j Int)
(declare-const temp___609 (Array Int component_t))
...
(assert (= result j))
(assert (= j1 first))
(assert (=> (and (<= first j1) (<= j1 last)) (= temp___609 a)))
(assert (=> (and (<= first j1) (<= j1 last)) (and (forall ((temp___610 Int)) (=> (and (<= 1 temp___610) (<= temp___610 1000)) (=> (<= j2 temp___610) (= (select a2 temp___610) (select temp___609 temp___610))))) (and (<= first j2) (<= j2 last)))))
...
(assert (= j8 j6))
(assert (= a9 a7))
(assert (not (= (bool_eq a8 1 1000 (temp___589 a first last 0) 1 1000) true)))
(check-sat)
(exit)
