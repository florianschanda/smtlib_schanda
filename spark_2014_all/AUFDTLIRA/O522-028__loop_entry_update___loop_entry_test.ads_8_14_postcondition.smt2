...
(declare-fun temp___532 ((Array Int component_t) Int Int Int) (Array Int component_t))
(assert (forall ((temp___534 (Array Int component_t))) (forall ((temp___535 Int) (temp___536 Int) (temp___537 Int)) (let ((temp___533 (temp___532 temp___534 temp___535 temp___536 temp___537))) (forall ((temp___538 Int)) (ite (and (<= temp___535 temp___538) (<= temp___538 temp___536)) (= (select temp___533 temp___538) (of_rep temp___537)) (= (select temp___533 temp___538) (select temp___534 temp___538))))))))
(define-fun dynamic_invariant1 ((temp___expr_196 Int) (temp___is_init_193 Bool) (temp___skip_constant_194 Bool) (temp___do_toplevel_195 Bool)) Bool (=> (or (= temp___is_init_193 true) (<= 0 2147483647)) (in_range2 temp___expr_196)))
...
(assert (=> (and (<= first j1) (<= j1 last)) (and (forall ((temp___553 Int)) (=> (and (<= 1 temp___553) (<= temp___553 1000)) (=> (<= j2 temp___553) (= (select a2 temp___553) (select temp___552 temp___553))))) (and (<= first j2) (<= j2 last)))))
...
(assert (=> (and (<= first j1) (<= j1 last)) (= (mk_map__ref a6) (mk_map__ref a4))))
(assert (=> (and (<= first j1) (<= j1 last)) (= j6 j4)))
(assert (=> (and (<= first j1) (<= j1 last)) (= a7 a5)))
(assert (=> (not (and (<= first j1) (<= j1 last))) (= j1 j5)))
(assert (=> (not (and (<= first j1) (<= j1 last))) (= (mk_map__ref a6) (mk_map__ref a))))
...
(assert (= j8 j6))
(assert (= a9 a7))
(assert (not (= (bool_eq a8 1 1000 (temp___532 a first last 0) 1 1000) true)))
(check-sat)
(exit)
