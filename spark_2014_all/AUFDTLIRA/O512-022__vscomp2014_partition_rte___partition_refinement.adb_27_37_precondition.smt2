...
(assert (and (= o13 (length3 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) (and (in_range10 o13) (<= o13 (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))))))
...
(assert (= result1 true))
(assert (and (= o8 (length3 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) (and (in_range10 o8) (<= o8 (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))))))
(assert (= o9 (- o8 1)))
(assert (and (= o6 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range8 o6) (= o6 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
(assert (= o7 (select f o6)))
(assert (= o10 (to_rep4 o7)))
(assert (= o11 (ite (<= o10 o9) true false)))
(assert (and (= o3 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range8 o3) (= o3 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
...
(assert (= result4 true))
(assert (and (= o2 (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) c1)) (and (in_range7 o2) (= o2 (get (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) c1))))))
