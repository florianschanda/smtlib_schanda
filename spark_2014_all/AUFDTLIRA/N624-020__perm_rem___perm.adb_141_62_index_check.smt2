...
(assert (= result1 true))
(assert (and (= temp___563 (+ j1 1)) (in_range1 (+ j1 1))))
(assert (and (<= (to_rep1 (first (rt b))) temp___563) (<= temp___563 (to_rep1 (last (rt b))))))
(assert (= o12 temp___563))
(assert (= o13 (select (elts b) o12)))
(assert (= o14 (to_rep o13)))
(assert (not (<= (to_rep1 (first (rt aa))) j1)))
(check-sat)
(exit)
