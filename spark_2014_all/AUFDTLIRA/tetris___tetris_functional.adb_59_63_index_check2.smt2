...
(assert (<= 0 x1))
(assert (<= x1 2))
(assert (and (forall ((temp___795 Int)) (=> (and (<= 1 temp___795) (<= temp___795 50)) (=> (not (= (+ (to_rep3 cur_piece__split_fields3) y2) temp___795)) (= (select cur_board2 temp___795) (select cur_board1 temp___795))))) (and (<= 0 x2) (<= x2 2))))
(assert (and (<= 3 (to_rep1 cur_piece__split_fields)) (<= (to_rep1 cur_piece__split_fields) 7)))
(assert (= o (to_rep1 cur_piece__split_fields)))
(assert (= temp___790 (get1 possible_three_shapes o (to_rep4 cur_piece__split_fields1))))
(assert (= result2 (get temp___790 y2 x2)))
(assert (= result2 true))
