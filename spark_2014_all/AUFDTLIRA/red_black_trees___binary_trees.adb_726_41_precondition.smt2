...
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 r256b)) (= temp___1673 r1)))
...
(assert (=> (and (<= 1 r1) (<= r1 r256b)) (=> (and (not (= r1 root)) (and (not (= r1 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r1)))) 2))) (and (= o57 v) (in_range1 v)))))
(assert (=> (and (<= 1 r1) (<= r1 r256b)) (=> (and (not (= r1 root)) (and (not (= r1 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r1)))) 2))) (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))))
(assert (=> (and (<= 1 r1) (<= r1 r256b)) (=> (and (not (= r1 root)) (and (not (= r1 v)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields1 r1)))) 2))) (and (= o58 v) (in_range1 v)))))
