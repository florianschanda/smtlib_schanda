...
(declare-const temp___233 (Array Int pt))
(declare-const o pt)
...
(assert (not (not (and (in_range1 id) (and (and (and (= temp___233 pos) (= o (select temp___233 id))) (= o us_self__compl)) (and (= result pos) (= pos1 (store pos id us_self__compl1))))))))
(check-sat)
(exit)
