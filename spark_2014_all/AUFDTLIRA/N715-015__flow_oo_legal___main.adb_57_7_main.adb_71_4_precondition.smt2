...
(define-fun dynamic_invariant2 ((temp___expr_650 Int) (temp___is_init_646 Bool) (temp___skip_constant_647 Bool) (temp___do_toplevel_648 Bool) (temp___do_typ_inv_649 Bool)) Bool (=> (or (= temp___is_init_646 true) (<= 0 3)) (in_range5 temp___expr_650)))
...
(define-fun dynamic_invariant6 ((temp___expr_657 Int) (temp___is_init_653 Bool) (temp___skip_constant_654 Bool) (temp___do_toplevel_655 Bool) (temp___do_typ_inv_656 Bool)) Bool (=> (or (= temp___is_init_653 true) (<= 0 12)) (in_range6 temp___expr_657)))
