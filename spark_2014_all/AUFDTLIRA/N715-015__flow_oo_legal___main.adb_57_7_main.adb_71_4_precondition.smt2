...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_585 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_585 us_void_param) 2)) 97)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 3)) 109)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 7)) 115)) (= (to_rep (select (temp___String_Literal_585 us_void_param) 8)) 115)) :pattern ((temp___String_Literal_585 us_void_param)))))
(define-fun default_initial_assumption ((temp___expr_583 us_rep1) (temp___skip_top_level_584 Bool)) Bool (and (= (attr__tag temp___expr_583) us_tag) (and (and (= (rec__people__person__name (us_split_fields1 temp___expr_583)) (to_unbounded_string (of_array (temp___String_Literal_585 Tuple0) 1 8))) (= (to_rep1 (rec__people__person__dob (us_split_fields1 temp___expr_583))) (- 1))) (= (rec__people__person__alive (us_split_fields1 temp___expr_583)) (of_int 0)))))
...
(define-fun bool_eq4 ((a (Array Int skills)) (a__first Int) (a__last Int) (b (Array Int skills)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_140 Int)) (=> (and (<= a__first temp___idx_140) (<= temp___idx_140 a__last)) (= (to_rep4 (select a temp___idx_140)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_140))))))) true false))
(assert (forall ((a (Array Int skills)) (b (Array Int skills))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_140 Int)) (=> (and (<= a__first temp___idx_140) (<= temp___idx_140 a__last)) (= (to_rep4 (select a temp___idx_140)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_140)))))))))))
...
(define-fun default_initial_assumption1 ((temp___expr_637 us_rep2) (temp___skip_top_level_638 Bool)) Bool (and (= (attr__tag1 temp___expr_637) us_tag1) (and (and (= (rec__people__person__name1 (us_split_fields3 temp___expr_637)) (to_unbounded_string (of_array (temp___String_Literal_585 Tuple0) 1 8))) (= (to_rep1 (rec__people__person__dob1 (us_split_fields3 temp___expr_637))) (- 1))) (= (rec__people__person__alive1 (us_split_fields3 temp___expr_637)) (of_int 0)))))
...
(define-fun dynamic_invariant2 ((temp___expr_608 Int) (temp___is_init_605 Bool) (temp___skip_constant_606 Bool) (temp___do_toplevel_607 Bool)) Bool (=> (or (= temp___is_init_605 true) (<= 0 3)) (in_range5 temp___expr_608)))
...
(assert (forall ((name us_rep)) (forall ((dob Int) (prof Int)) (! (=> (and (dynamic_invariant1 dob true true true) (dynamic_invariant2 prof true true true)) (= (attr__tag1 (new_professional name dob prof)) us_tag1)) :pattern ((new_professional name dob prof))))))
(assert (forall ((attr__tag2 Int) (dob Int) (prof Int)) (forall ((name us_rep)) (! (=> (and (dynamic_invariant1 dob true true true) (dynamic_invariant2 prof true true true)) (= (attr__tag1 (new_professional1 attr__tag2 name dob prof)) attr__tag2)) :pattern ((new_professional1 attr__tag2 name dob prof))))))
...
(assert (forall ((p us_rep1)) (forall ((prof Int)) (! (=> (dynamic_invariant2 prof true true true) (= (attr__tag1 (new_professional__2 p prof)) us_tag1)) :pattern ((new_professional__2 p prof))))))
(assert (forall ((attr__tag2 Int) (prof Int)) (forall ((p us_rep1)) (! (=> (dynamic_invariant2 prof true true true) (= (attr__tag1 (new_professional__21 attr__tag2 p prof)) attr__tag2)) :pattern ((new_professional__21 attr__tag2 p prof))))))
...
(assert true)
(assert true)
(assert (forall ((p us_rep2)) (forall ((professionals__state us_private)) (! (= (to_int1 (has_training p professionals__state)) (to_int1 (has_training1 us_tag1 p professionals__state))) :pattern ((has_training1 us_tag1 p professionals__state))))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_678 us_void_param) 1)) 75) (= (to_rep (select (temp___String_Literal_678 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 4)) 110)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 7)) 104)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 9)) 77)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 10)) 99)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 11)) 67)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 14)) 109)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 16)) 99)) (= (to_rep (select (temp___String_Literal_678 us_void_param) 17)) 107)) :pattern ((temp___String_Literal_678 us_void_param)))))
(declare-fun temp___String_Literal_679 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_679 us_void_param) 1)) 68) (= (to_rep (select (temp___String_Literal_679 us_void_param) 2)) 97)) (= (to_rep (select (temp___String_Literal_679 us_void_param) 3)) 100)) (= (to_rep (select (temp___String_Literal_679 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_679 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_679 us_void_param) 6)) 77)) (= (to_rep (select (temp___String_Literal_679 us_void_param) 7)) 117)) (= (to_rep (select (temp___String_Literal_679 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_679 us_void_param) 9)) 112)) (= (to_rep (select (temp___String_Literal_679 us_void_param) 10)) 104)) (= (to_rep (select (temp___String_Literal_679 us_void_param) 11)) 121)) :pattern ((temp___String_Literal_679 us_void_param)))))
(declare-fun temp___String_Literal_680 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_680 us_void_param) 1)) 74) (= (to_rep (select (temp___String_Literal_680 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_680 us_void_param) 3)) 104)) (= (to_rep (select (temp___String_Literal_680 us_void_param) 4)) 110)) (= (to_rep (select (temp___String_Literal_680 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_680 us_void_param) 6)) 82)) (= (to_rep (select (temp___String_Literal_680 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_680 us_void_param) 8)) 109)) (= (to_rep (select (temp___String_Literal_680 us_void_param) 9)) 98)) (= (to_rep (select (temp___String_Literal_680 us_void_param) 10)) 111)) :pattern ((temp___String_Literal_680 us_void_param)))))
(declare-fun temp___String_Literal_681 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_681 us_void_param) 1)) 71) (= (to_rep (select (temp___String_Literal_681 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_681 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_681 us_void_param) 4)) 103)) (= (to_rep (select (temp___String_Literal_681 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_681 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_681 us_void_param) 7)) 121)) (= (to_rep (select (temp___String_Literal_681 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_681 us_void_param) 9)) 72)) (= (to_rep (select (temp___String_Literal_681 us_void_param) 10)) 111)) (= (to_rep (select (temp___String_Literal_681 us_void_param) 11)) 117)) (= (to_rep (select (temp___String_Literal_681 us_void_param) 12)) 115)) (= (to_rep (select (temp___String_Literal_681 us_void_param) 13)) 101)) :pattern ((temp___String_Literal_681 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_614 Int) (temp___is_init_611 Bool) (temp___skip_constant_612 Bool) (temp___do_toplevel_613 Bool)) Bool (=> (or (= temp___is_init_611 true) (<= 0 12)) (in_range6 temp___expr_614)))
...
(declare-const rambo__split_fields21 us_split_fields2)
(declare-const professionals__another_one_bites_the_dust__victim__fields us_split_fields)
(declare-const result70 us_split_fields__ref1)
(declare-const uni_student__split_fields21 us_split_fields2)
(declare-const kenny__split_fields5 us_split_fields)
(declare-const dr_house__split_fields21 us_split_fields2)
(assert (= o (to_unbounded_string (mk___t (temp___String_Literal_678 Tuple0) (mk 1 17)))))
...
(assert (= o1 (to_unbounded_string (mk___t (temp___String_Literal_679 Tuple0) (mk 1 11)))))
...
(assert (= o2 (to_unbounded_string (mk___t (temp___String_Literal_680 Tuple0) (mk 1 10)))))
...
(assert (= o3 (to_unbounded_string (mk___t (temp___String_Literal_681 Tuple0) (mk 1 13)))))
...
(assert (and (= (is_alive (mk___rep (mk___split_fields (rec__people__person__name1 rambo__split_fields21) (rec__people__person__dob1 rambo__split_fields21) (rec__people__person__alive1 rambo__split_fields21) (hide_ext__ (rec__professionals__professional__profession rambo__split_fields21) (rec__professionals__professional__skilled_in rambo__split_fields21) (rec__professionals__professional__number_of_people_killed rambo__split_fields21) (rec__ext__1 rambo__split_fields21))) rambo__attr__tag)) true) (not (= (is_alive1 uni_student__attr__tag (mk___rep professionals__another_one_bites_the_dust__victim__fields uni_student__attr__tag)) true))))
(assert (= result70 (mk___split_fields__ref1 uni_student__split_fields20)))
(assert (= uni_student__split_fields21 (us_split_fields3 (of_base (mk___rep professionals__another_one_bites_the_dust__victim__fields uni_student__attr__tag)))))
(assert (not (= (is_alive (mk___rep (mk___split_fields (rec__people__person__name1 dr_house__split_fields20) (rec__people__person__dob1 dr_house__split_fields20) (rec__people__person__alive1 dr_house__split_fields20) (hide_ext__ (rec__professionals__professional__profession dr_house__split_fields20) (rec__professionals__professional__skilled_in dr_house__split_fields20) (rec__professionals__professional__number_of_people_killed dr_house__split_fields20) (rec__ext__1 dr_house__split_fields20))) dr_house__attr__tag)) true)))
(check-sat)
(exit)
