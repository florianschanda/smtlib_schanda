...
(assert (= i2 r23b))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= temp___1619 i2)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= temp___1617 newdomainname1)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= temp___1620 endidx8)))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1620))))
...
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (and (= temp___1616 o4) (in_range1 o4))))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (and (<= 1 temp___1616) (<= temp___1616 128))))
(assert (=> (and (<= r23b i2) (<= i2 r24b)) (= o6 temp___1616)))
