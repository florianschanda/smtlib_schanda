...
(assert (= i6 r23b))
(assert (=> (and (<= r23b i6) (<= i6 r24b)) (and (and (= temp___1560 i6) (and (= temp___1558 newdomainname1) (and (= temp___1561 endidx10) (and (and (and (<= 1 begidx13) (<= (+ (- endidx10 begidx13) 1) 128)) (= endidx10 temp___1561)) (and (and (=> (<= r23b r24b) (dynamic_property r23b r24b i7)) (and (<= r23b i7) (<= i7 r24b))) (and (and (and (= (to_rep o5) (to_rep (select zonefileline i7))) (and (and (and (and (and (= o3 (+ i7 1)) (in_range1 (+ i7 1))) (= o4 (- o3 begidx13))) (and (= temp___1557 o4) (in_range1 o4))) (and (and (<= 1 temp___1557) (<= temp___1557 128)) (= o6 temp___1557))) (= o7 (store newdomainname2 o6 o5)))) (and (= result8 (mk_map__ref newdomainname2)) (= newdomainname3 o7))) (= i7 r24b))))))) (and (and (= i13 (mk_int__ref i7)) (= newdomainname8 (mk_map__ref newdomainname3))) (and (= i14 i7) (= newdomainname9 newdomainname3))))))
(assert (=> (and (<= r23b i6) (<= i6 r24b)) (= i15 i13)))
(assert (=> (and (<= r23b i6) (<= i6 r24b)) (= newdomainname10 newdomainname8)))
(assert (=> (and (<= r23b i6) (<= i6 r24b)) (= i16 i14)))
(assert (=> (and (<= r23b i6) (<= i6 r24b)) (= newdomainname11 newdomainname9)))
(assert (=> (not (and (<= r23b i6) (<= i6 r24b))) (= i15 (mk_int__ref i6))))
(assert (=> (not (and (<= r23b i6) (<= i6 r24b))) (= newdomainname10 (mk_map__ref newdomainname1))))
(assert (=> (not (and (<= r23b i6) (<= i6 r24b))) (= i16 i6)))
(assert (=> (not (and (<= r23b i6) (<= i6 r24b))) (= newdomainname11 newdomainname1)))
(assert (= (+ endidx10 1) r26b))
