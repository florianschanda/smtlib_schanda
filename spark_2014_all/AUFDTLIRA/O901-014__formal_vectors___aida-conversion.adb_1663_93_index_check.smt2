...
(assert (and (= o36 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (= o37 (ite (<= o36 j) true false)))
(assert (= result6 (ite (= o37 true) (ite (<= j index3) true false) false)))
(assert (= result6 true))
