...
(assert (= (ite (<= (to_rep (first2 temp___2721)) (to_rep (last2 temp___2721))) (+ (- (to_rep (last2 temp___2721)) (to_rep (first2 temp___2721))) 1) 0) (ite (<= 1 x) (+ (- x 1) 1) 0)))
(assert (= temp___272 alignment_attribute__q__a1__assume))
(assert (= (mk (to_rep (first2 temp___2721)) (to_rep (last2 temp___2721))) alignment_attribute__q__a1__assume1))
(assert (= result a1))
...
(assert (not (< (object__alignment1 a21) 0)))
(check-sat)
(exit)
