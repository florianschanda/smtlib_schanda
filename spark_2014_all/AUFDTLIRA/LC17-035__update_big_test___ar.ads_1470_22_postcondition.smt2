...
(assert (forall ((temp___3069 (Array Int et1))) (forall ((temp___3070 Int) (temp___3071 Int)) (let ((temp___3068 (temp___3067 temp___3069 temp___3070 temp___3071))) (forall ((temp___3072 Int)) (ite (= temp___3072 temp___3070) (= (select temp___3068 temp___3072) (of_rep temp___3071)) (= (select temp___3068 temp___3072) (select temp___3069 temp___3072))))))))
...
(assert (not (= (bool_eq r__split_fields6 1 10 (temp___3067 r__split_fields i e) 1 10) true)))
(check-sat)
(exit)
