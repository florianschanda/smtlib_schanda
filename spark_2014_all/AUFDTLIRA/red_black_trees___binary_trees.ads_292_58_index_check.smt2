...
(assert (and (= temp___825 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o61)) (and (dynamic_invariant3 temp___825 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___825 o61))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___825 o61)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 o61)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___825 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___825 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___825 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___825 i2))) true) (not (= i2 o61))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___825 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___825 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___825 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___825 i2))) true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___825 j9))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___825 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___825 j9)))) true)) (= j9 i2))))))))))))))
(assert (= o62 (select temp___825 j)))
(assert (= o63 (us_split_fields1 o62)))
(assert (= o64 (rec__tree_model__path_type__a o63)))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= temp___822 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root)) (and (dynamic_invariant3 temp___822 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___822 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___822 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___822 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___822 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___822 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___822 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___822 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___822 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___822 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___822 i2))) true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___822 j9))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___822 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___822 j9)))) true)) (= j9 i2))))))))))))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= temp___823 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 temp___823) (and (= temp___823 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= temp___823 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) temp___823) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) temp___823) i)) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9) d)))))) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j9) d)) (= temp___823 j9)))))))))
(assert (not (<= 1 temp___823)))
(check-sat)
(exit)
