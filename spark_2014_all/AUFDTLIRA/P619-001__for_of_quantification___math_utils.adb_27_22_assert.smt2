...
(assert (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (and (and (= temp___160 i1) (and (= temp___159 result__1) (and (= 0 temp___161) (and (ite (< result__1 (to_rep (select (elts v) i1))) (and (= result__1 result2) (= result__2 (to_rep (select (elts v) i1)))) (= result__2 result__1)) (and (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (and (and (forall ((k2 Int)) (=> (and (<= (to_rep1 (first (rt v))) k2) (<= k2 i2)) (<= (to_rep (select (elts v) k2)) result__3))) (exists ((k2 Int)) (and (and (<= (to_rep1 (first (rt v))) k2) (<= k2 i2)) (= result__3 (to_rep (select (elts v) k2)))))) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 result__3)) (=> (<= (to_rep1 (first (rt v))) (to_rep1 (last (rt v)))) (dynamic_property1 (to_rep1 (first (rt v))) (to_rep1 (last (rt v))) i2))) (and (<= (to_rep1 (first (rt v))) i2) (<= i2 (to_rep1 (last (rt v)))))) (and (and (= temp___1611 result3) (= temp___1612 i2)) (= i2 (to_rep1 (last (rt v)))))))))))) (and (and (= i2 i6) (= result__3 result__7)) (and (= i7 i2) (= result__8 result__3))))))
(assert (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (= (mk_int__ref result__9) (mk_int__ref result__7))))
(assert (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (= i9 i7)))
(assert (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (= result__10 result__8)))
(assert (=> (not (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v)))))) (= i1 i8)))
(assert (=> (not (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v)))))) (= result__1 result__9)))
(assert (=> (not (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v)))))) (= i9 i1)))
(assert (=> (not (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v)))))) (= result__10 result__1)))
(assert (not (exists ((temp___166 Int)) (and (and (<= (to_rep1 (first (rt v))) temp___166) (<= temp___166 (to_rep1 (last (rt v))))) (= result__9 (to_rep (select (elts v) temp___166)))))))
(check-sat)
(exit)
