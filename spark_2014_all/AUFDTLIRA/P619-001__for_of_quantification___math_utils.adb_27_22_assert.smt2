...
(assert (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (= (mk_int__ref result__6) (mk_int__ref result__4))))
...
(assert (not (exists ((temp___166 Int)) (and (and (<= (to_rep1 (first (rt v))) temp___166) (<= temp___166 (to_rep1 (last (rt v))))) (= result__6 (to_rep (select (elts v) temp___166)))))))
(check-sat)
(exit)
