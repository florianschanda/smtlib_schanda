...
(assert (and (= temp___1528 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant3 temp___1528 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1528 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1528 root)))) 0) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (not (= i15 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1528 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1528 i15))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1528 i15))) true)))))) (and (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1528 i15))) true) (not (= i15 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1528 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i15) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1528 i15)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1528 i15)))) 0)))) (forall ((i15 Int)) (=> (and (<= 1 i15) (<= i15 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1528 i15))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1528 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1528 i15))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1528 j2)))) true)) (= j2 i15))))))))))))))
(assert (not (<= 1 v)))
(check-sat)
(exit)
