...
(assert (and (and (and (and (not (= (select winners3 0) true)) (< latest_highest_score2 i2)) (= (select winners3 latest_highest_score2) true)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- i2 1))) (=> (< latest_highest_score2 j3) (< (to_rep (select counters j3)) (to_rep (select counters latest_highest_score2))))))) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- i2 1))) (ite (= (select winners3 j3) true) (= (to_rep (select counters latest_highest_score2)) (to_rep (select counters j3))) (< (to_rep (select counters j3)) (to_rep (select counters latest_highest_score2))))))))
...
(assert (<= 0 j1))
(assert (<= j1 (- i2 1)))
(assert (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- j2 1))) (not (= (select winners4 k1) true)))))
