...
(assert (not (or (= (int__content dynamic_types__search__result7) 0) (and (and (<= (to_rep1 (first (rt a))) (int__content dynamic_types__search__result7)) (<= (int__content dynamic_types__search__result7) (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) (int__content dynamic_types__search__result7))) c)))))
(check-sat)
(exit)
