...
(assert (= result5 (int__content dynamic_types__search__result13)))
(assert (not (or (= (int__content dynamic_types__search__result13) 0) (and (and (<= (to_rep1 (first (rt a))) (int__content dynamic_types__search__result13)) (<= (int__content dynamic_types__search__result13) (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) (int__content dynamic_types__search__result13))) c)))))
(check-sat)
(exit)
