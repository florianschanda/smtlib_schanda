...
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (= o1 (select res3 o))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (= o2 (us_split_fields11 o1))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (= o3 (rec__red_black_trees__black_count__depth o2))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (= o4 (to_rep o3))))
(assert (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true) (= result3 (ite (< o4 n2) true false))))
(assert (=> (not (= (rec__tree_model__path_type__k (us_split_fields7 (select m j))) true)) (= result3 false)))
(assert (= result3 true))
