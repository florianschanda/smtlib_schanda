...
(declare-fun temp_____aggregate_def_3156 ((Array Int et1) Int Int Int Int) (Array Int et1))
...
(assert (forall ((temp___3158 (Array Int et1))) (forall ((temp___3159 Int) (temp___3160 Int) (temp___3161 Int) (temp___3162 Int)) (let ((temp___3157 (temp_____aggregate_def_3156 temp___3158 temp___3159 temp___3160 temp___3161 temp___3162))) (=> (and (and (and (dynamic_invariant temp___3159 true true true true) (dynamic_invariant1 temp___3160 true true true true)) (dynamic_invariant temp___3161 true true true true)) (dynamic_invariant1 temp___3162 true true true true)) (forall ((temp___3163 Int)) (ite (= temp___3163 temp___3161) (= (to_rep (select temp___3157 temp___3163)) temp___3162) (ite (= temp___3163 temp___3159) (= (to_rep (select temp___3157 temp___3163)) temp___3160) (= (select temp___3157 temp___3163) (select temp___3158 temp___3163))))))))))
...
(declare-const temp___8105 (Array Int et1))
(declare-const temp___81051 enum2t)
(declare-const o4 et1)
(declare-const o5 (Array Int et1))
(declare-const o6 (Array Int et1))
(declare-const o7 enum2t)
(declare-const temp___8108 (Array Int et1))
(declare-const temp___81081 enum2t)
...
(assert (= temp___8105 o2))
(assert (= temp___81051 o3))
...
(assert (= temp___8108 o6))
(assert (= temp___81081 o7))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8108 r__split_fields4))
(assert (= temp___81081 r__split_fields5))
...
(assert (not (= (bool_eq r__split_fields6 1 10 (temp_____aggregate_def_3156 r__split_fields i e j f) 1 10) true)))
(check-sat)
(exit)
