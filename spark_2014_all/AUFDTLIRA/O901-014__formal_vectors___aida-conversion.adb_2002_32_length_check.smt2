...
(assert (not (= (ite (<= (to_rep1 (first8 temp___23751)) (to_rep1 (last8 temp___23751))) (+ (- (to_rep1 (last8 temp___23751)) (to_rep1 (first8 temp___23751))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) (+ (- (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 1)) 1) 0))))
(check-sat)
(exit)
