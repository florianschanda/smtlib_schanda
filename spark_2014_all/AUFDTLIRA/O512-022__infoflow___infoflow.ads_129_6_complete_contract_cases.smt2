...
(assert (not (<= 1 (+ (+ 0 (ite (= (ite (= (= k_1 k_2) true) (ite (<= (to_rep a_v1__first) i) (ite (<= i k_1) (= (to_rep (select (elts b_v1) i)) (to_rep (select (elts b_v2) i))) false) false) false) true) 1 0)) (ite (= (ite (= (= k_1 k_2) true) (ite (<= (+ k_1 1) i) (ite (<= i (to_rep a_v1__last)) (= (to_rep (select (elts c_v1) (- i k_1))) (to_rep (select (elts c_v2) (- i k_1)))) false) false) false) true) 1 0)))))
(check-sat)
(exit)
