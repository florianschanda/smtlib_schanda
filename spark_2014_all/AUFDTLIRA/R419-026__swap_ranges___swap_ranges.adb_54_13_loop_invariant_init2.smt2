...
(assert (= b1 o13))
(assert (< (+ (to_rep a__first) j1) (to_rep a__last)))
(assert (not (= (bool_eq a (to_rep (first14 (mk7 (+ (+ (to_rep a__first) j1) 1) (to_rep a__last)))) (to_rep (last14 (mk7 (+ (+ (to_rep a__first) j1) 1) (to_rep a__last)))) a1 (to_rep (first16 (mk8 (+ (+ (to_rep a__first) j1) 1) (to_rep a__last)))) (to_rep (last16 (mk8 (+ (+ (to_rep a__first) j1) 1) (to_rep a__last))))) true)))
(check-sat)
(exit)
