...
(assert (=> (< 0 e) (= o11 (+ k 1))))
(assert (=> (< 0 e) (= temp___5211 (select a o11))))
(assert (=> (< 0 e) (= o13 (select temp___5211 j))))
(assert (=> (< 0 e) (= o14 (temp___1505 o13 i o12))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o10 (+ k 1))))
(assert (=> (< 0 e) (= o15 (select a o10))))
(assert (=> (< 0 e) (= o16 (temp___1498 o15 j o14))))
(assert (=> (< 0 e) (and (= o17 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5212 (temp___1475 a k (temp___1483 (select a k) j (temp___1490 (select (select a k) j) i e)) o17 o16))))
