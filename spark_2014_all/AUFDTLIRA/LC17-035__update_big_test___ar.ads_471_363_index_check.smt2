...
(assert (= a4 a2))
(assert (< k 16))
(assert (=> (< 0 e) (and (= o12 (- e 1)) (in_range3 (- e 1)))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o11 (+ k 1))))
(assert (=> (< 0 e) (= temp___5270 (select a o11))))
(assert (=> (< 0 e) (= o13 (select temp___5270 j))))
(assert (=> (< 0 e) (= o14 (temp_____aggregate_def_1564 o13 i o12))))
(assert (=> (< 0 e) (and (<= 1 (+ k 1)) (<= (+ k 1) 16))))
(assert (=> (< 0 e) (= o10 (+ k 1))))
(assert (=> (< 0 e) (= o15 (select a o10))))
(assert (=> (< 0 e) (= o16 (temp_____aggregate_def_1557 o15 j o14))))
(assert (=> (< 0 e) (and (= o17 (+ k 1)) (in_range2 (+ k 1)))))
(assert (=> (< 0 e) (= temp___5271 (temp_____aggregate_def_1534 a k (temp_____aggregate_def_1542 (select a k) j (temp_____aggregate_def_1549 (select (select a k) j) i e)) o17 o16))))
