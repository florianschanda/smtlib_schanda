...
(declare-const temp___8147 (Array Int (Array Int et1)))
(declare-const temp___81471 Bool)
...
(assert (= temp___8147 o3))
(assert (= temp___81471 o4))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___8147 r__split_fields2))
(assert (= temp___81471 r__split_fields3))
...
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (in_range3 (to_rep (select (select r__split_fields4 m) n)))))
(check-sat)
(exit)
