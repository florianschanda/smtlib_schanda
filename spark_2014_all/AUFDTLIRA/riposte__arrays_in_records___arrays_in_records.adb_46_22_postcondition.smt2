...
(declare-const temp___225 index)
(declare-const temp___2251 (Array Int value))
(declare-const temp___2252 (Array Int value))
...
(assert (= temp___225 a__split_fields3))
(assert (= temp___2251 a__split_fields4))
(assert (= temp___2252 a__split_fields5))
...
(assert (not (= (to_rep (select a__split_fields7 i)) 23)))
(check-sat)
(exit)
