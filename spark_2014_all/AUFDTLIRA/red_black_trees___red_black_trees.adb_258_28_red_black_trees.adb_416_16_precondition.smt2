...
(assert (= temp___949 (mk___rep4 o33)))
(assert (= result11 (mk___split_fields__ref4 t__split_fields9)))
(assert (= t__split_fields10 (us_split_fields9 temp___949)))
...
(assert (dynamic_invariant6 c75b true false true true))
(assert (= (mk___rep4 t__split_fields10) c76b))
(assert (dynamic_invariant6 c76b true false true true))
...
(assert (and (= red_black_trees__insert__L_8__C77b__assume o37) (in_range2 o37)))
...
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c75b) i)))) n6)) (ite (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c76b)) i) c77b) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c76b) i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c76b) i)))) (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c75b) i)))) 1))) (= (eq (select (nb_blacks c76b) i) (select (nb_blacks c75b) i)) true))))))
(assert (and (=> (<= 1 100) (in_range2 n6)) (and (<= 1 n6) (<= n6 100))))
(assert (and (= temp___950 (nb_blacks c75b)) (and (= (bool_eq11 (select temp___950 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___950 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___950 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___950 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___950 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___950 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___950 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___950 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___950 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___950 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c75b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___950 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))))))))))))
(assert (= o38 (select temp___950 c77b)))
(assert (= o39 (us_split_fields11 o38)))
(assert (= o40 (rec__red_black_trees__black_count__depth o39)))
(assert (= o41 (to_rep o40)))
(assert (= result14 (ite (<= o41 n6) true false)))
(assert (= result14 true))
(assert (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c76b) c77b))) true))
(assert (and (= temp___954 (nb_blacks c75b)) (and (= (bool_eq11 (select temp___954 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___954 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___954 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___954 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___954 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___954 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___954 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___954 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___954 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___954 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c75b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___954 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))))))))))))
(assert (= o42 (select temp___954 c77b)))
(assert (= o43 (us_split_fields11 o42)))
(assert (= o44 (rec__red_black_trees__black_count__count o43)))
