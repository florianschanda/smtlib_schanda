...
(assert (= (to_rep3 o44) 0))
(assert (and (<= 1 y7) (<= y7 100)))
(assert (= o45 y7))
(assert (= o46 (store (rec__red_black_trees__rbt__color t__split_fields7) o45 o44)))
(assert (= o47 (mk___split_fields4 (rec__red_black_trees__rbt__struct t__split_fields7) o46)))
(assert (= temp___892 (mk___rep4 o47)))
(assert (= result23 (mk___split_fields__ref4 t__split_fields7)))
(assert (= t__split_fields8 (us_split_fields9 temp___892)))
(assert (= (to_rep3 o49) 0))
(assert (and (= o48 x2) (in_range2 x2)))
(assert (and (= temp___894 (parent (rec__red_black_trees__rbt__struct t__split_fields8) o48)) (and (in_range3 temp___894) (and (= temp___894 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields8))) o48)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields8)) 0) (= temp___894 0))))))
(assert (and (<= 1 temp___894) (<= temp___894 100)))
(assert (= o50 temp___894))
(assert (= o51 (store (rec__red_black_trees__rbt__color t__split_fields8) o50 o49)))
(assert (= o52 (mk___split_fields4 (rec__red_black_trees__rbt__struct t__split_fields8) o51)))
(assert (= temp___896 (mk___rep4 o52)))
(assert (= result24 (mk___split_fields__ref4 t__split_fields8)))
(assert (= t__split_fields9 (us_split_fields9 temp___896)))
(assert (= (to_rep3 o54) 1))
(assert (and (= o53 y7) (in_range2 y7)))
(assert (and (= temp___898 (parent (rec__red_black_trees__rbt__struct t__split_fields9) o53)) (and (in_range3 temp___898) (and (= temp___898 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields9))) o53)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields9)) 0) (= temp___898 0))))))
(assert (and (<= 1 temp___898) (<= temp___898 100)))
(assert (= o55 temp___898))
(assert (= o56 (store (rec__red_black_trees__rbt__color t__split_fields9) o55 o54)))
(assert (= o57 (mk___split_fields4 (rec__red_black_trees__rbt__struct t__split_fields9) o56)))
(assert (= temp___900 (mk___rep4 o57)))
(assert (= result25 (mk___split_fields__ref4 t__split_fields9)))
(assert (= t__split_fields10 (us_split_fields9 temp___900)))
(assert (and (= o58 y7) (in_range2 y7)))
(assert (and (= o59 (parent (rec__red_black_trees__rbt__struct t__split_fields10) o58)) (and (in_range3 o59) (and (= o59 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields10))) o58)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields10)) 0) (= o59 0))))))
(assert (= result26 (mk_int__ref x2)))
(assert (= x3 o59))
(assert (= (mk___rep4 t_old__split_fields7) c75b))
(assert (dynamic_invariant6 c75b true false true))
(assert (= (mk___rep4 t__split_fields10) c76b))
(assert (dynamic_invariant6 c76b true false true))
(assert (and (= o60 y7) (in_range2 y7)))
(assert (and (= o61 (parent (rec__red_black_trees__rbt__struct t__split_fields10) o60)) (and (in_range3 o61) (and (= o61 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields10))) o60)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields10)) 0) (= o61 0))))))
(assert (and (= red_black_trees__insert__L_8__C77b__assume o61) (in_range2 o61)))
(assert (= red_black_trees__insert__L_8__C77b__assume c77b))
(assert (in_range2 c77b))
(assert (= (same_nb_blacks c75b) true))
(assert (= result27 (mk_int__ref n44)))
(assert (= n50 1))
(assert (<= 1 n50))
(assert (<= n50 100))
(assert (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i14))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c75b) i14)))) n51)) (ite (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c76b)) i14) c77b) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c76b) i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c76b) i14)))) (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c75b) i14)))) 1))) (= (eq (select (nb_blacks c76b) i14) (select (nb_blacks c75b) i14)) true))))))
(assert (and (=> (<= 1 100) (in_range2 n51)) (and (<= 1 n51) (<= n51 100))))
(assert (and (= temp___901 (nb_blacks c75b)) (and (= (bool_eq11 (select temp___901 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___901 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___901 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___901 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c75b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___901 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))))))))))))
(assert (= o80 (select temp___901 c77b)))
(assert (= o81 (us_split_fields11 o80)))
(assert (= o82 (rec__red_black_trees__black_count__depth o81)))
(assert (= o83 (to_rep o82)))
(assert (= result31 (ite (<= o83 n51) true false)))
(assert (= result31 true))
(assert (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c76b) c77b))) true))
(assert (and (= temp___905 (nb_blacks c75b)) (and (= (bool_eq11 (select temp___905 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___905 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___905 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___905 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c75b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i14 0))))))))))))))
(assert (= o84 (select temp___905 c77b)))
(assert (= o85 (us_split_fields11 o84)))
(assert (= o86 (rec__red_black_trees__black_count__count o85)))
(assert (= o87 (to_rep o86)))
(assert (not (not (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c76b))) 0))))
(check-sat)
(exit)
