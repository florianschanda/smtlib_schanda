...
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c75b) i)))) n6)) (ite (= (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c76b)) i) c77b) (and (= (rec__red_black_trees__black_count__status (us_split_fields11 (select (nb_blacks c76b) i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c76b) i)))) (+ (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select (nb_blacks c75b) i)))) 1))) (= (eq (select (nb_blacks c76b) i) (select (nb_blacks c75b) i)) true))))))
(assert (and (=> (<= 1 100) (in_range4 n6)) (and (<= 1 n6) (<= n6 100))))
(assert (and (= temp___952 (nb_blacks c75b)) (and (= (bool_eq11 (select temp___952 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___952 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___952 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___952 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___952 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___952 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___952 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___952 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___952 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___952 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c75b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___952 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))))))))))))
(assert (= o38 (select temp___952 c77b)))
...
(assert (and (= temp___956 (nb_blacks c75b)) (and (= (bool_eq11 (select temp___956 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c75b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___956 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___956 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___956 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___956 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___956 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___956 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___956 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___956 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___956 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c75b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___956 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c75b)) i 0))))))))))))))
(assert (= o42 (select temp___956 c77b)))
