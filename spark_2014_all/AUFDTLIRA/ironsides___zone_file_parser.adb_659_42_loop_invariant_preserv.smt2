...
(assert (= i32 r28b))
(assert (=> (and (<= r28b i32) (<= i32 r29b)) (and (and (= temp___1573 endidx11) (and (= temp___1571 rrstring1) (and (= temp___1570 i32) (and (and (and (<= 1 begidx15) (<= (+ (- endidx11 begidx15) 1) 128)) (= endidx11 temp___1573)) (and (and (=> (<= r28b r29b) (dynamic_property2 r28b r29b i33)) (and (<= r28b i33) (<= i33 r29b))) (and (and (and (= (to_rep o14) (to_rep (select zonefileline i33))) (and (and (and (and (and (= o12 (+ i33 1)) (in_range1 (+ i33 1))) (= o13 (- o12 begidx15))) (and (= temp___1569 o13) (in_range1 o13))) (and (and (<= 1 temp___1569) (<= temp___1569 256)) (= o15 temp___1569))) (= o16 (store rrstring2 o15 o14)))) (and (= result16 (mk_map__ref rrstring2)) (= rrstring3 o16))) (= i33 r29b))))))) (and (and (= i39 (mk_int__ref i33)) (= rrstring8 (mk_map__ref rrstring3))) (and (= i40 i33) (= rrstring9 rrstring3))))))
(assert (=> (and (<= r28b i32) (<= i32 r29b)) (= i41 i39)))
(assert (=> (and (<= r28b i32) (<= i32 r29b)) (= rrstring10 rrstring8)))
(assert (=> (and (<= r28b i32) (<= i32 r29b)) (= i42 i40)))
(assert (=> (and (<= r28b i32) (<= i32 r29b)) (= rrstring11 rrstring9)))
(assert (=> (not (and (<= r28b i32) (<= i32 r29b))) (= i41 (mk_int__ref i32))))
(assert (=> (not (and (<= r28b i32) (<= i32 r29b))) (= rrstring10 (mk_map__ref rrstring1))))
(assert (=> (not (and (<= r28b i32) (<= i32 r29b))) (= i42 i32)))
(assert (=> (not (and (<= r28b i32) (<= i32 r29b))) (= rrstring11 rrstring1)))
(assert (= (- (+ endidx11 2) begidx15) r31b))
(assert (in_range1 r31b))
(assert (= result18 (mk_int__ref i3)))
(assert (= i43 r31b))
(assert (<= r31b i43))
(assert (<= i43 256))
(assert (<= begidx15 endidx11))
(assert (and (and (=> (<= r31b 256) (dynamic_property3 r31b 256 i44)) (forall ((temp___1578 Int)) (=> (and (<= 1 temp___1578) (<= temp___1578 256)) (=> (<= i44 temp___1578) (= (select rrstring12 temp___1578) (select (map__content rrstring10) temp___1578)))))) (and (<= r31b i44) (<= i44 256))))
(assert (= (to_rep o17) 32))
(assert (and (<= 1 i44) (<= i44 256)))
(assert (= o18 i44))
(assert (= o19 (store rrstring12 o18 o17)))
(assert (= result19 (mk_map__ref rrstring12)))
(assert (= rrstring13 o19))
(assert (not (= i44 256)))
(assert (= result20 (mk_int__ref i44)))
(assert (= i45 (+ i44 1)))
(assert (= i46 (mk_int__ref i45)))
(assert (= rrstring14 (mk_map__ref rrstring13)))
(assert (= i47 i45))
(assert (= rrstring15 rrstring13))
(assert (not (<= begidx15 endidx11)))
(check-sat)
(exit)
