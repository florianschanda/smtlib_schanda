...
(declare-const temp___1617 (Array Int character))
...
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i6) (<= i6 r24b)) (= temp___1619 i6))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i6) (<= i6 r24b)) (= temp___1617 newdomainname1))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i6) (<= i6 r24b)) (= temp___1620 endidx8))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i6) (<= i6 r24b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1620)))))
...
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i6) (<= i6 r24b)) (and (= temp___1616 o4) (in_range1 o4)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i6) (<= i6 r24b)) (and (<= 1 temp___1616) (<= temp___1616 128)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r23b i6) (<= i6 r24b)) (= o6 temp___1616))))
...
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i12) (<= i12 128)) (= temp___1625 i12))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i12) (<= i12 128)) (= temp___1623 (map__content newdomainname6)))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i12) (<= i12 128)) (<= 1 endidx8))))
(assert (=> (not (< 128 lengthoftoken1)) (=> (and (<= r26b i12) (<= i12 128)) (and (and (forall ((temp___1624 Int)) (=> (and (<= 1 temp___1624) (<= temp___1624 128)) (=> (<= i13 temp___1624) (= (select newdomainname8 temp___1624) (select temp___1623 temp___1624))))) (=> (<= r26b 128) (dynamic_property1 r26b 128 i13))) (and (<= r26b i13) (<= i13 128))))))
...
(assert (= i22 r28b))
(assert (=> (and (<= r28b i22) (<= i22 r29b)) (= temp___1632 endidx9)))
(assert (=> (and (<= r28b i22) (<= i22 r29b)) (= temp___1630 rrstring1)))
(assert (=> (and (<= r28b i22) (<= i22 r29b)) (= temp___1629 i22)))
(assert (=> (and (<= r28b i22) (<= i22 r29b)) (and (and (<= 1 begidx13) (<= (+ (- endidx9 begidx13) 1) 128)) (= endidx9 temp___1632))))
...
(assert (=> (and (<= r28b i22) (<= i22 r29b)) (and (= temp___1628 o13) (in_range1 o13))))
(assert (=> (and (<= r28b i22) (<= i22 r29b)) (and (<= 1 temp___1628) (<= temp___1628 256))))
(assert (=> (and (<= r28b i22) (<= i22 r29b)) (= o15 temp___1628)))
...
(assert (and (and (=> (<= r31b 256) (dynamic_property3 r31b 256 i29)) (forall ((temp___1637 Int)) (=> (and (<= 1 temp___1637) (<= temp___1637 256)) (=> (<= i29 temp___1637) (= (select rrstring8 temp___1637) (select (map__content rrstring6) temp___1637)))))) (and (<= r31b i29) (<= i29 256))))
