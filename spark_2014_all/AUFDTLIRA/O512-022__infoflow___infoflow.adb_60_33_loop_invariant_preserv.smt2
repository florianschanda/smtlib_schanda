...
(assert (<= i2 10))
(assert (= (to_rep o) 0))
(assert (= o1 (store cache_v1 i2 o)))
(assert (= (mk_map__ref result1) (mk_map__ref cache_v1)))
(assert (= cache_v12 o1))
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (=> (<= k i3) (= (to_rep (select cache_v13 k)) 0)))))
(assert (and (and (=> (<= 1 10) (in_range2 i3)) (forall ((temp___351 Int)) (=> (and (<= 1 temp___351) (<= temp___351 10)) (=> (< i3 temp___351) (= (select cache_v13 temp___351) (select cache_v1 temp___351)))))) (and (<= 1 i3) (<= i3 10))))
(assert (not (= i3 10)))
(assert (= result2 i3))
(assert (= i4 (+ i3 1)))
(assert (= (to_rep o2) 0))
(assert (= o3 (store cache_v13 i4 o2)))
(assert (= result3 cache_v13))
(assert (= cache_v14 o3))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k 10))
(assert (<= k i4))
(assert (not (= (to_rep (select cache_v14 k)) 0)))
(check-sat)
(exit)
