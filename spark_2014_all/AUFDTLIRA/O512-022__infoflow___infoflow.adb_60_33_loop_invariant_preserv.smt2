...
(assert (and (and (=> (<= 1 10) (in_range2 i2)) (forall ((temp___351 Int)) (=> (and (<= 1 temp___351) (<= temp___351 10)) (=> (< i2 temp___351) (= (select cache_v12 temp___351) (select cache_v1 temp___351)))))) (and (<= 1 i2) (<= i2 10))))
(assert (not (= i2 10)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
(assert (= (to_rep o2) 0))
