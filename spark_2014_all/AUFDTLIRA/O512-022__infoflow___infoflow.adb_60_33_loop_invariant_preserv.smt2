...
(assert (forall ((k Int)) (=> (and (<= 1 k) (<= k 10)) (=> (<= k i2) (= (to_rep (select cache_v12 k)) 0)))))
(assert (and (and (=> (<= 1 10) (in_range2 i2)) (forall ((temp___396 Int)) (=> (and (<= 1 temp___396) (<= temp___396 10)) (=> (or (< 10 temp___396) (or (< temp___396 1) (< i2 temp___396))) (= (select cache_v12 temp___396) (select cache_v1 temp___396)))))) (and (<= 1 i2) (<= i2 10))))
(assert (not (= i2 10)))
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
(assert (= result3 cache_v12))
(assert (= cache_v13 (store cache_v12 i3 rliteral)))
(declare-const k Int)
(assert (<= 1 k))
(assert (<= k 10))
(assert (<= k i3))
(assert (not (= (to_rep (select cache_v13 k)) 0)))
(check-sat)
(exit)
