...
(assert (=> (= status3 8) (and (= o25 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7)))) (in_range9 o25))))
(assert (=> (= status3 8) (= o26 (ite (= o25 0) true false))))
(assert (=> (= status3 8) (= o24 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (= status3 8) (= o27 (ite (not (= o24 true)) true false))))
(assert (=> (= status3 8) (= o28 (ite (= o27 true) o26 false))))
(assert (=> (not (= status3 8)) (= o28 (of_int 1))))
(assert (=> (= status3 3) (and (= o19 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (in_range9 o19))))
(assert (=> (= status3 3) (and (= o20 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7)))) (in_range9 o20))))
(assert (=> (= status3 3) (= o21 (ite (= o20 o19) true false))))
(assert (=> (= status3 3) (= o18 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (= status3 3) (= o22 (ite (not (= o18 true)) true false))))
(assert (=> (= status3 3) (= o23 (ite (= o22 true) o21 false))))
(assert (=> (not (= status3 3)) (= o23 (of_int 1))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (and (= o13 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (in_range9 o13))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (and (= o14 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7)))) (in_range9 o14))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (= o15 (ite (= o14 o13) true false))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (= o11 (ispresent (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (= o12 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7))))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (= o16 (ite (= o12 true) o11 false))))
(assert (=> (=> (not (= status3 6)) (= status3 7)) (= o17 (ite (= o16 true) o15 false))))
(assert (=> (not (=> (not (= status3 6)) (= status3 7))) (= o17 (of_int 1))))
(assert (and (= o7 (thecurrentop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7)))) (in_range8 o7)))
(assert (= o8 (ite (= o7 4) true false)))
(assert (= o9 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7)))))
(assert (= result2 (ite (= o9 true) o8 false)))
(assert (=> (= result2 true) (= o10 (ite (= status3 6) true false))))
(assert (=> (not (= result2 true)) (= o10 (of_int 1))))
(assert (and (= o4 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7)))) (in_range9 o4)))
(assert (= result3 (ite (= o4 1) true false)))
(assert (= result3 true))
(assert (= o5 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields6 theadmin__split_fields7)))))
