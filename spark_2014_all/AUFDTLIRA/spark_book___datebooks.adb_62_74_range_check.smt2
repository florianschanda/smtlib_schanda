...
(assert (=> (and (<= (to_rep1 (first (rt description))) i11) (<= i11 (to_rep1 (last (rt description))))) (and (and (= temp___377 i11) (and (= temp___374 book1) (and (and (and (in_range12 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11)))) (<= (length description) 128)) (< (- i12 (to_rep1 (first (rt description)))) 128)) (and (and (and (forall ((temp___375 Int)) (=> (and (<= 1 temp___375) (<= temp___375 64)) (ite (not (= (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11))) temp___375)) (= (select book2 temp___375) (select temp___374 temp___375)) (and (and (= (rec__datebooks__event_record__description_size (us_split_fields7 (select book2 temp___375))) (rec__datebooks__event_record__description_size (us_split_fields7 (select temp___374 temp___375)))) (= (rec__datebooks__event_record__date (us_split_fields7 (select book2 temp___375))) (rec__datebooks__event_record__date (us_split_fields7 (select temp___374 temp___375))))) (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book2 temp___375))) (rec__datebooks__event_record__is_used (us_split_fields7 (select temp___374 temp___375)))))))) (=> (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description)))) (dynamic_property1 (to_rep1 (first (rt description))) (to_rep1 (last (rt description))) i12))) (and (<= (to_rep1 (first (rt description))) i12) (<= i12 (to_rep1 (last (rt description)))))) (and (and (and (and (and (and (= (to_rep o9) (to_rep (select (elts description) i12))) (and (and (and (and (and (= o7 (- i12 (to_rep1 (first (rt description))))) (in_range1 (- i12 (to_rep1 (first (rt description)))))) (= o8 (+ 1 o7))) (and (= temp___372 o8) (in_range1 o8))) (and (and (<= 1 temp___372) (<= temp___372 128)) (= o10 temp___372))) (= o11 (store (rec__datebooks__event_record__description_text (us_split_fields7 (select book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11)))))) o10 o9)))) (and (= o11 o12) (and (= (rec__datebooks__event_record__description_size (us_split_fields7 (select book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11)))))) o13) (and (= (rec__datebooks__event_record__date (us_split_fields7 (select book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11)))))) (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o14 o15 o16)) (mk___rep1 (mk___split_fields1 o17 o18 o19))))) (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11)))))) o20))))) (= o21 (mk___rep3 (mk___split_fields3 o12 o13 (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o14 o15 o16)) (mk___rep1 (mk___split_fields1 o17 o18 o19)))) o20)))) (= o22 (store book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields11))) o21))) (and (= result6 (mk_map__ref1 book2)) (= book3 o22))) (= i12 (to_rep1 (last (rt description))))))))) (and (and (= i18 (mk_int__ref i12)) (= book8 (mk_map__ref1 book3))) (and (= i19 i12) (= book9 book3))))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i11) (<= i11 (to_rep1 (last (rt description))))) (= i20 i18)))
(assert (=> (and (<= (to_rep1 (first (rt description))) i11) (<= i11 (to_rep1 (last (rt description))))) (= book10 book8)))
(assert (=> (and (<= (to_rep1 (first (rt description))) i11) (<= i11 (to_rep1 (last (rt description))))) (= i21 i19)))
(assert (=> (and (<= (to_rep1 (first (rt description))) i11) (<= i11 (to_rep1 (last (rt description))))) (= book11 book9)))
(assert (=> (not (and (<= (to_rep1 (first (rt description))) i11) (<= i11 (to_rep1 (last (rt description)))))) (= i20 (mk_int__ref i11))))
(assert (=> (not (and (<= (to_rep1 (first (rt description))) i11) (<= i11 (to_rep1 (last (rt description)))))) (= book10 (mk_map__ref1 book1))))
(assert (=> (not (and (<= (to_rep1 (first (rt description))) i11) (<= i11 (to_rep1 (last (rt description)))))) (= i21 i11)))
(assert (=> (not (and (<= (to_rep1 (first (rt description))) i11) (<= i11 (to_rep1 (last (rt description)))))) (= book11 book1)))
