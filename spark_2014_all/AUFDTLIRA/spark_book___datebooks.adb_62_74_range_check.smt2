...
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= temp___377 i8)))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= temp___374 book1)))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (and (and (in_range12 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))) (<= (length description) 128)) (< (- i9 (to_rep1 (first (rt description)))) 128))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (and (and (forall ((temp___375 Int)) (=> (and (<= 1 temp___375) (<= temp___375 64)) (ite (not (= (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9))) temp___375)) (= (select book2 temp___375) (select temp___374 temp___375)) (and (and (= (rec__datebooks__event_record__description_size (us_split_fields7 (select book2 temp___375))) (rec__datebooks__event_record__description_size (us_split_fields7 (select temp___374 temp___375)))) (= (rec__datebooks__event_record__date (us_split_fields7 (select book2 temp___375))) (rec__datebooks__event_record__date (us_split_fields7 (select temp___374 temp___375))))) (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book2 temp___375))) (rec__datebooks__event_record__is_used (us_split_fields7 (select temp___374 temp___375)))))))) (=> (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description)))) (dynamic_property1 (to_rep1 (first (rt description))) (to_rep1 (last (rt description))) i9))) (and (<= (to_rep1 (first (rt description))) i9) (<= i9 (to_rep1 (last (rt description))))))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= (to_rep o8) (to_rep (select (elts description) i9)))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (and (= o6 (- i9 (to_rep1 (first (rt description))))) (in_range1 (- i9 (to_rep1 (first (rt description))))))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= o7 (+ 1 o6))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (and (= temp___372 o7) (in_range1 o7))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (and (<= 1 temp___372) (<= temp___372 128))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= o9 temp___372)))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= o10 (store (rec__datebooks__event_record__description_text (us_split_fields7 (select book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) o9 o8))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= o10 o11)))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= (rec__datebooks__event_record__description_size (us_split_fields7 (select book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) o12)))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= (rec__datebooks__event_record__date (us_split_fields7 (select book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o13 o14 o15)) (mk___rep1 (mk___split_fields1 o16 o17 o18)))))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) o19)))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= o20 (mk___rep3 (mk___split_fields3 o11 o12 (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o13 o14 o15)) (mk___rep1 (mk___split_fields1 o16 o17 o18)))) o19)))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= o21 (store book2 (to_rep9 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9))) o20))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= result5 (mk_map__ref1 book2))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= book3 o21)))
...
(assert (not (in_range11 (length description))))
(check-sat)
(exit)
