...
(declare-const temp___418 (Array Int us_rep3))
...
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= temp___421 i8)))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= temp___418 book1)))
...
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (and (and (forall ((temp___419 Int)) (=> (and (<= 1 temp___419) (<= temp___419 64)) (ite (not (= (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9))) temp___419)) (= (select book2 temp___419) (select temp___418 temp___419)) (and (and (= (rec__datebooks__event_record__description_size (us_split_fields7 (select book2 temp___419))) (rec__datebooks__event_record__description_size (us_split_fields7 (select temp___418 temp___419)))) (= (rec__datebooks__event_record__date (us_split_fields7 (select book2 temp___419))) (rec__datebooks__event_record__date (us_split_fields7 (select temp___418 temp___419))))) (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book2 temp___419))) (rec__datebooks__event_record__is_used (us_split_fields7 (select temp___418 temp___419)))))))) (=> (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description)))) (dynamic_property1 (to_rep1 (first (rt description))) (to_rep1 (last (rt description))) i9))) (and (<= (to_rep1 (first (rt description))) i9) (<= i9 (to_rep1 (last (rt description))))))))
...
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (and (= temp___416 o7) (in_range1 o7))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (and (<= 1 temp___416) (<= temp___416 128))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= o9 temp___416)))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= o10 (store (rec__datebooks__event_record__description_text (us_split_fields7 (select book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) o9 o8))))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= o10 o11)))
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= (rec__datebooks__event_record__description_size (us_split_fields7 (select book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) o12)))
...
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9)))))) o19)))
...
(assert (=> (and (<= (to_rep1 (first (rt description))) i8) (<= i8 (to_rep1 (last (rt description))))) (= o21 (store book2 (to_rep8 (rec__datebooks__add_event__find_result_record__fresh_index (us_split_fields__content4 find_result__split_fields9))) o20))))
