...
(assert (forall ((temp___185 Int)) (=> (dynamic_invariant1 temp___185 true true true true) (forall ((temp___186 Int)) (= (select (temp_____aggregate_def_183 temp___185) temp___186) rliteral)))))
...
(assert (not (in_range2 (- (to_rep1 s__split_fields) 1))))
(check-sat)
(exit)
