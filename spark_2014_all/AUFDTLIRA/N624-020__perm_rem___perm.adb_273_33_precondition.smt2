...
(assert (and (= o19 (remove b ib2)) (and (dynamic_invariant2 o19 true false true true) (and (= (invariant__ o19) true) (and (= (to_rep2 (last (rt o19))) (- (to_rep2 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib2 1))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o19) k))))) (and (forall ((k Int)) (=> (and (<= (+ ib2 1) k) (<= k (to_rep2 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select (elts o19) (- k 1)))))) (forall ((k Int)) (=> (and (<= ib2 k) (<= k (- (to_rep2 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select (elts o19) k))))))))))))
(assert (and (= o20 (remove o19 (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (dynamic_invariant2 o20 true false true true) (and (= (invariant__ o20) true) (and (= (to_rep2 (last (rt o20))) (- (to_rep2 (last (rt o19))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) (= (to_rep (select (elts o19) k)) (to_rep (select (elts o20) k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k) (<= k (to_rep2 (last (rt o19))))) (= (to_rep (select (elts o19) k)) (to_rep (select (elts o20) (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep1 (rec__perm__witnesses__ib (us_split_fields1 w))) k) (<= k (- (to_rep2 (last (rt o19))) 1))) (= (to_rep (select (elts o19) (+ k 1))) (to_rep (select (elts o20) k))))))))))))
(assert (and (= o17 (- ib2 1)) (in_range4 (- ib2 1))))
(assert (and (= o18 (remove bb o17)) (and (dynamic_invariant2 o18 true false true true) (and (= (invariant__ o18) true) (and (= (to_rep2 (last (rt o18))) (- (to_rep2 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o17 1))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o18) k))))) (and (forall ((k Int)) (=> (and (<= (+ o17 1) k) (<= k (to_rep2 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select (elts o18) (- k 1)))))) (forall ((k Int)) (=> (and (<= o17 k) (<= k (- (to_rep2 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select (elts o18) k))))))))))))
