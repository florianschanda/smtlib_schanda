...
(declare-const temp___659 (Array Int cardindex))
...
(assert (= result22 (ite (<= 0 j) o107 false)))
(assert (= result22 true))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o108 i1))
(assert (= temp___659 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o108)))
(assert (not (<= j 99)))
(check-sat)
(exit)
