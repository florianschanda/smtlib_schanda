...
(assert (<= 0 i2))
(assert (<= i2 (- (to_rep1 (rec__patience__state__numstacks (us_split_fields__content s__split_fields20))) 1)))
(assert (and (<= 0 i2) (<= i2 99)))
(assert (= o144 i2))
(assert (= o145 (select (rec__patience__state__stacksizes (us_split_fields__content s__split_fields20)) o144)))
(assert (= o146 (to_rep1 o145)))
(assert (= o147 (- o146 1)))
(assert (= o148 (ite (<= j o147) true false)))
(assert (= result30 (ite (<= 0 j) o148 false)))
(assert (= result30 true))
(assert (and (<= 0 i2) (<= i2 99)))
(assert (= o150 i2))
(assert (= temp___629 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o150)))
(assert (not (<= 0 j)))
(check-sat)
(exit)
