...
(declare-const o35 (Array Int natural))
(declare-const o36 Int)
(declare-const o37 Int)
(declare-const o38 natural)
(declare-const o39 (Array Int natural))
...
(assert (= x5 result6))
(assert (= x6 o23))
(assert (and (= o24 (+ 7 one1)) (in_range1 (+ 7 one1))))
(assert (and (= o25 o24) (in_range2 o24)))
(assert (= (to_rep o26) o25))
(assert (= o27 (store x6 7 o26)))
(assert (= x6 result7))
(assert (= x7 o27))
(assert (and (= o28 (+ 8 one1)) (in_range1 (+ 8 one1))))
(assert (and (= o29 o28) (in_range2 o28)))
(assert (= (to_rep o30) o29))
(assert (= o31 (store x7 8 o30)))
(assert (= x7 result8))
(assert (= x8 o31))
(assert (and (= o32 (+ 9 one1)) (in_range1 (+ 9 one1))))
(assert (and (= o33 o32) (in_range2 o32)))
(assert (= (to_rep o34) o33))
(assert (= o35 (store x8 9 o34)))
(assert (= x8 result9))
(assert (= x9 o35))
(assert (not (in_range1 (+ 10 one1))))
(check-sat)
(exit)
