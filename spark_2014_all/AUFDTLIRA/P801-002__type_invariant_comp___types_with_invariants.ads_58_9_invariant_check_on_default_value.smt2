...
(assert (dynamic_invariant3 (mk___t3 temp___222 temp___2221) true false true))
(assert (forall ((temp___224 Int)) (=> (and (<= (to_rep (first6 temp___2221)) temp___224) (<= temp___224 (to_rep (last6 temp___2221)))) (= (to_rep (select temp___222 temp___224)) 1))))
(assert (not (type_invariant3 (mk___t3 temp___222 temp___2221))))
(check-sat)
(exit)
