...
(assert (and (and (forall ((e Int)) (=> (and (in_range3 e) (= (mem avail3 e) true)) (and (<= 1 e) (<= e r2)))) (forall ((e Int)) (=> (and (in_range3 e) (= (mem alloc3 e) true)) (and (<= 1 e) (<= e r2))))) (forall ((rr Int)) (=> (and (<= 1 rr) (<= rr r2)) (ite (= (to_rep (select data rr)) 0) (and (= (mem avail3 rr) true) (not (= (mem alloc3 rr) true))) (and (not (= (mem avail3 rr) true)) (= (mem alloc3 rr) true)))))))
