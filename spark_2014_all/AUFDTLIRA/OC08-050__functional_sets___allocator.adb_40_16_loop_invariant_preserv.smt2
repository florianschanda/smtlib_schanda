...
(assert (= r2 result8))
(assert (= r3 (+ r2 1)))
(assert (=> (= (to_rep (select data r3)) 0) (and (= o16 (add avail3 r3)) (= (is_add avail3 r3 o16) true))))
(assert (=> (= (to_rep (select data r3)) 0) (= result9 avail3)))
(assert (=> (= (to_rep (select data r3)) 0) (= avail4 o16)))
(assert (=> (= (to_rep (select data r3)) 0) (= alloc4 alloc3)))
(assert (=> (not (= (to_rep (select data r3)) 0)) (and (= o17 (add alloc3 r3)) (= (is_add alloc3 r3 o17) true))))
(assert (=> (not (= (to_rep (select data r3)) 0)) (= result10 alloc3)))
(assert (=> (not (= (to_rep (select data r3)) 0)) (= alloc4 o17)))
(assert (=> (not (= (to_rep (select data r3)) 0)) (= avail4 avail3)))
(declare-const e2 Int)
(assert (in_range3 e2))
(assert (= (mem avail4 e2) true))
(assert (not (<= 1 e2)))
(check-sat)
(exit)
