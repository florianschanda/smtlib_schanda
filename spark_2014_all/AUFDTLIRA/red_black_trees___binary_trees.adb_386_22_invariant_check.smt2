...
(assert (<= 1 n1))
(assert (<= n1 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) i1))) true) (forall ((d1 Int)) (=> (and (<= 0 d1) (<= d1 1)) (=> (= (peek f i1 d1) 0) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields5 (select (model__ f root) j))) true) (= (olt (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i1))) (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j)))) true)) (<= (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j)))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i1)))) n2))) (not (= (get (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields5 (select (model__ f root) i1)))) 1)) d1))))))))))))
(assert (and (=> (<= 1 100) (in_range6 n2)) (and (<= 1 n2) (<= n2 100))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (= (tree_structure f) true))
(assert (and (= temp___1195 (model__ f root)) (and (dynamic_invariant6 temp___1195 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1195 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1195 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent f i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1195 (parent f i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1195 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1195 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1195 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields5 (select temp___1195 (parent f i1)))) (position f i1) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1195 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields5 (select temp___1195 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1195 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields5 (select temp___1195 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields5 (select temp___1195 i1))) (rec__tree_model__path_type__a (us_split_fields5 (select temp___1195 j)))) true)) (= j i1))))))))))))))
