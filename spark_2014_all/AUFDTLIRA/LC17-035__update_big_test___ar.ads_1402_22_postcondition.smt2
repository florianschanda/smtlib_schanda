...
(declare-fun temp_____aggregate_def_3036 ((Array Int us_rep2) Int us_rep2) (Array Int us_rep2))
...
(assert (forall ((temp___3038 (Array Int us_rep2))) (forall ((temp___3039 Int)) (forall ((temp___3040 us_rep2)) (let ((temp___3037 (temp_____aggregate_def_3036 temp___3038 temp___3039 temp___3040))) (=> (dynamic_invariant temp___3039 true true true true) (forall ((temp___3041 Int)) (ite (= temp___3041 temp___3039) (= (select temp___3037 temp___3041) temp___3040) (= (select temp___3037 temp___3041) (select temp___3038 temp___3041))))))))))
...
(assert (= a4 a2))
(assert (not (= (bool_eq3 (map__content a3) 90 99 (temp_____aggregate_def_3036 a i (mk___rep2 (mk___split_fields2 (mk___rep1 (let ((usq_ (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select a i)))))) (mk___split_fields1 (rec__ar__rec2t__f2 usq_) (mk___rep (mk___split_fields (of_rep f) (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec5t__f5 (us_split_fields5 (select a i))))))))) (rec__ar__rec2t__h2 usq_)))) (rec__ar__rec5t__g5 (us_split_fields5 (select a i))) (mk___rep (mk___split_fields (of_rep g) (rec__ar__rec1t__g1 (us_split_fields1 (rec__ar__rec5t__h5 (us_split_fields5 (select a i)))))))))) 90 99) true)))
(check-sat)
(exit)
