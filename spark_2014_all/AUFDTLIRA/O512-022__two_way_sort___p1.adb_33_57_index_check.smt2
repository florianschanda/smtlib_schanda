...
(assert (=> (and (<= (to_rep a__first) i3) (<= i3 (to_rep a__last))) (= result3 (ite (<= (to_rep a__first) j5) (ite (<= j5 (to_rep a__last)) true false) false))))
(assert (=> (not (and (<= (to_rep a__first) i3) (<= i3 (to_rep a__last)))) (= result3 false)))
(assert (=> (= result3 true) (= (= result2 true) (forall ((k3 Int)) (=> (and (<= (to_rep a__first) k3) (<= k3 (- i3 1))) (not (= (select a2 k3) true)))))))
