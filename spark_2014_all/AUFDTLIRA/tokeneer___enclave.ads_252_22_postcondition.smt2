...
(assert (and (and (and (and (not (= (enrolmentisinprogress status1) true)) (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))) 0)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields2 theadmin__split_fields3))) true))) (or (or (= status1 3) (= status1 4)) (= status1 status))) (not (or (= status1 6) (= status1 7)))))
(assert (in_range7 status1))
