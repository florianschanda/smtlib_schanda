...
(assert (= values1 o8))
(assert (not (= (is_set (mk___t (elts1 init) (mk (to_rep (first2 (rt1 init))) (to_rep (last2 (rt1 init))))) x (to_rep (select (elts1 init) y)) (mk___t values1 (mk (to_rep values__first) (to_rep values__last)))) true)))
(check-sat)
(exit)
