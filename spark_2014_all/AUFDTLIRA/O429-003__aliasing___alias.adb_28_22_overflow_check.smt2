...
(define-fun dynamic_invariant1 ((temp___expr_151 us_t) (temp___is_init_148 Bool) (temp___skip_constant_149 Bool) (temp___do_toplevel_150 Bool)) Bool (=> (not (= temp___skip_constant_149 true)) (dynamic_property 1 2147483647 (first1 temp___expr_151) (last1 temp___expr_151))))
(declare-const c Int)
...
(define-fun dynamic_invariant4 ((temp___expr_156 us_t1) (temp___is_init_153 Bool) (temp___skip_constant_154 Bool) (temp___do_toplevel_155 Bool)) Bool (=> (not (= temp___skip_constant_154 true)) (and (dynamic_property2 1 c (first3 temp___expr_156) (last3 temp___expr_156)) (and (= (first3 temp___expr_156) 1) (= (last3 temp___expr_156) c)))))
