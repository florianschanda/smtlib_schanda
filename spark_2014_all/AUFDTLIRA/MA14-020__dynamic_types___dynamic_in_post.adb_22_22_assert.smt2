...
(assert (forall ((s us_t)) (! (=> (dynamic_invariant1 s true true true) (let ((result (get_last s))) (and (= result (last3 (let ((temp___178 (last1 s))) (let ((temp___177 (first1 s))) (of_array1 (to_array s) temp___177 temp___178))))) (dynamic_invariant result true false true)))) :pattern ((get_last s)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_207 us_void_param) 1)) 104) (= (to_rep (select (temp___String_Literal_207 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_207 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_207 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_207 us_void_param) 5)) 111)) :pattern ((temp___String_Literal_207 us_void_param)))))
(declare-fun temp___String_Literal_209 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_209 us_void_param) 1)) 121) (= (to_rep (select (temp___String_Literal_209 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_209 us_void_param) 3)) 117)) :pattern ((temp___String_Literal_209 us_void_param)))))
