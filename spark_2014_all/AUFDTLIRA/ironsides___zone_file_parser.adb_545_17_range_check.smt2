...
(assert (= i1 r18b))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= temp___1600 newdomainname1)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= temp___1602 endidx8)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= temp___1599 i1)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (and (and (<= 1 begidx11) (<= (+ (- endidx8 begidx11) 1) 128)) (= endidx8 temp___1602))))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (and (=> (<= r18b r19b) (dynamic_property r18b r19b i2)) (and (<= r18b i2) (<= i2 r19b)))))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= (to_rep o5) (to_rep (select zonefileline i2)))))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (and (= o3 (+ i2 1)) (in_range1 (+ i2 1)))))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= o4 (- o3 begidx11))))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (and (= temp___1598 o4) (in_range1 o4))))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (and (<= 1 temp___1598) (<= temp___1598 128))))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= o6 temp___1598)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= o7 (store newdomainname2 o6 o5))))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= result6 (mk_map__ref newdomainname2))))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= newdomainname3 o7)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= i2 r19b)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= newdomainname4 (mk_map__ref newdomainname3))))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= i4 i2)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= newdomainname5 newdomainname3)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= i5 i3)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= newdomainname6 newdomainname4)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= i6 i4)))
(assert (=> (and (<= r18b i1) (<= i1 r19b)) (= newdomainname7 newdomainname5)))
(assert (=> (not (and (<= r18b i1) (<= i1 r19b))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= r18b i1) (<= i1 r19b))) (= newdomainname6 (mk_map__ref newdomainname1))))
(assert (=> (not (and (<= r18b i1) (<= i1 r19b))) (= i6 i1)))
(assert (=> (not (and (<= r18b i1) (<= i1 r19b))) (= newdomainname7 newdomainname1)))
(assert (= (+ endidx8 1) r21b))
(assert (in_range1 r21b))
(assert (<= r21b 128))
(assert (not (<= (- 2147483648) r21b)))
(check-sat)
(exit)
