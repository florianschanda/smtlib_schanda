...
(assert (= kj10 kj8))
(assert (= ki10 ki8))
(assert (= result16 (int__content search_trees__find_root__result4)))
(assert (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) (int__content search_trees__find_root__result4)))) true)))
(check-sat)
(exit)
