...
(assert (forall ((configdata__state us_private)) (! (dynamic_invariant (thefingerwaitduration configdata__state) true false true) :pattern ((thefingerwaitduration configdata__state)))))
...
(define-fun dynamic_invariant1 ((temp___expr_1683 Int) (temp___is_init_1680 Bool) (temp___skip_constant_1681 Bool) (temp___do_toplevel_1682 Bool)) Bool (=> (or (= temp___is_init_1680 true) (<= 0 7)) (in_range10 temp___expr_1683)))
...
(assert true)
(define-fun dynamic_invariant6 ((temp___expr_334 Int) (temp___is_init_331 Bool) (temp___skip_constant_332 Bool) (temp___do_toplevel_333 Bool)) Bool (=> (or (= temp___is_init_331 true) (<= 1 150)) (in_range3 temp___expr_334)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant7 ((temp___expr_376 Int) (temp___is_init_373 Bool) (temp___skip_constant_374 Bool) (temp___do_toplevel_375 Bool)) Bool (=> (or (= temp___is_init_373 true) (<= 1901 2099)) (in_range4 temp___expr_376)))
(define-fun dynamic_invariant8 ((temp___expr_382 Int) (temp___is_init_379 Bool) (temp___skip_constant_380 Bool) (temp___do_toplevel_381 Bool)) Bool (=> (or (= temp___is_init_379 true) (<= 1 12)) (in_range5 temp___expr_382)))
(define-fun dynamic_invariant9 ((temp___expr_388 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 1 31)) (in_range6 temp___expr_388)))
(define-fun dynamic_invariant10 ((temp___expr_412 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= 0 86399999)) (in_range7 temp___expr_412)))
(define-fun dynamic_invariant11 ((temp___expr_1028 Int) (temp___is_init_1025 Bool) (temp___skip_constant_1026 Bool) (temp___do_toplevel_1027 Bool)) Bool (=> (or (= temp___is_init_1025 true) (<= 0 2147483647)) (in_range9 temp___expr_1028)))
