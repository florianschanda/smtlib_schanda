...
(assert (and (and (and (= (mk_int__ref result) (mk_int__ref st_count)) (= st_count1 0)) (and (in_range3 st_count1) (and (and (= (mk_int__ref result1) (mk_int__ref lowest_max)) (= lowest_max1 2147483647)) (and (in_range1 lowest_max1) (and (and (and (= (mk_int__ref result2) (mk_int__ref st)) (= st1 1)) (ite (and (<= 1 st1) (<= st1 100)) (and (and (and (= temp___175 lowest_max1) (and (= temp___174 st_count1) (and (= temp___173 st1) (and (and (= (count_selected_locations sel) (+ st_count2 (partial_count_selected_locations sel st2))) (and (forall ((s3 Int)) (=> (and (<= 1 s3) (<= s3 (- st2 1))) (=> (= (select sel s3) true) (<= lowest_max2 (to_rep (select max s3)))))) (and (or (and (forall ((s3 Int)) (=> (and (<= 1 s3) (<= s3 (- st2 1))) (not (= (select sel s3) true)))) (= lowest_max2 2147483647)) (exists ((s3 Int)) (and (and (<= 1 s3) (<= s3 (- st2 1))) (and (= (select sel s3) true) (= (to_rep (select max s3)) lowest_max2))))) (< st_count2 st2)))) (and (and (and (and (=> (<= 1 100) (in_range4 st2)) (=> (<= 0 100) (in_range3 st_count2))) (=> (<= 0 2147483647) (in_range1 lowest_max2))) (and (<= 1 st2) (<= st2 100))) (and (ite (= (select sel st2) true) (and (and (and (= o6 (+ st_count2 1)) (in_range3 (+ st_count2 1))) (and (= st_count2 result5) (= st_count3 o6))) (ite (< (to_rep (select max st2)) lowest_max2) (and (= lowest_max2 result6) (= lowest_max3 (to_rep (select max st2)))) (= lowest_max3 lowest_max2))) (and (= lowest_max3 lowest_max2) (= st_count3 st_count2))) (= st2 100))))))) (and (and (= st2 st4) (and (= lowest_max3 lowest_max4) (= st_count3 st_count4))) (and (= st5 st2) (and (= lowest_max5 lowest_max3) (= st_count5 st_count3))))) (and (and (= (mk_int__ref st6) (mk_int__ref st4)) (and (= (mk_int__ref lowest_max6) (mk_int__ref lowest_max4)) (= (mk_int__ref st_count6) (mk_int__ref st_count4)))) (and (= st7 st5) (and (= lowest_max7 lowest_max5) (= st_count7 st_count5))))) (and (and (= st1 st6) (and (= lowest_max1 lowest_max6) (= st_count1 st_count6))) (and (= st7 st1) (and (= lowest_max7 lowest_max1) (= st_count7 st_count1)))))) (and (= st_count6 (count_selected_locations sel)) (and (forall ((s3 Int)) (=> (and (<= 1 s3) (<= s3 100)) (=> (= (select sel s3) true) (<= lowest_max6 (to_rep (select max s3)))))) (and (and (= count_locations__check_selected_locations__result1 count_locations__check_selected_locations__result2) (= count_locations__check_selected_locations__result3 count_locations__check_selected_locations__result1)) (and (= result8 count_locations__check_selected_locations__result) (= count_locations__check_selected_locations__result1 (ite (<= st_count6 lowest_max6) true false))))))))))) (and (and (= count_locations__check_selected_locations__result4 (mk_bool__ref count_locations__check_selected_locations__result2)) (and (= st8 (mk_int__ref st6)) (and (= lowest_max8 (mk_int__ref lowest_max6)) (= st_count8 (mk_int__ref st_count6))))) (and (= count_locations__check_selected_locations__result5 count_locations__check_selected_locations__result3) (and (= st9 st7) (and (= lowest_max9 lowest_max7) (= st_count9 st_count7)))))))
(assert (= result9 (bool__content count_locations__check_selected_locations__result4)))
(assert (= (bool__content count_locations__check_selected_locations__result4) true))
(declare-const s3 Int)
(assert (<= 1 s3))
(assert (<= s3 100))
(assert (= (select sel s3) true))
(assert (not (<= (count_selected_locations sel) (to_rep (select max s3)))))
(check-sat)
(exit)
