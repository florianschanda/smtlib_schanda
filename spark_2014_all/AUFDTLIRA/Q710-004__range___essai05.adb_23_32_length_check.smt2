...
(declare-const temp___302 (Array Int integer))
(declare-const temp___3021 t3)
...
(assert (= (mk___t3 temp___302 temp___3021) (essai05__conv2__r__aggregate_def 0 (to_rep1 (first (rt v))) (to_rep1 (last (rt v))))))
(assert (not (= (ite (<= (to_rep1 (first6 temp___3021)) (to_rep1 (last6 temp___3021))) (+ (- (to_rep1 (last6 temp___3021)) (to_rep1 (first6 temp___3021))) 1) 0) (ite (<= (to_rep1 (first (rt v))) (to_rep1 (last (rt v)))) (+ (- (to_rep1 (last (rt v))) (to_rep1 (first (rt v)))) 1) 0))))
(check-sat)
(exit)
