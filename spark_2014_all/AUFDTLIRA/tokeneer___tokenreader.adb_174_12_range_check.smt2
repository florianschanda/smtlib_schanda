...
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 thecodename))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 thecodename)))))) (= o6 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 thecodename))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 thecodename)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 thecodename))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 thecodename))))))) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___11851)) (to_rep1 (last temp___11851))) (= o7 (+ (- (to_rep1 (last temp___11851)) (to_rep1 (first temp___11851))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___11851)) (to_rep1 (last temp___11851)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
