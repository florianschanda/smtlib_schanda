...
(assert (and (= o15 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o15) (<= (+ 0 o15) 2147483647))))
(assert (= result2 (ite (<= o15 10000) true false)))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (and (= o13 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o13) (<= (+ 0 o13) 2147483647))))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (= result3 (ite (< 0 o13) true false)))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (=> (= result3 true) (and (= o12 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) 1)) (in_range3 o12))))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (=> (= result3 true) (= result1 (ite (= o12 first_available) true false))))))
(assert (=> (= result2 true) (=> (not (= first_available 0)) (=> (not (= result3 true)) (= result1 false)))))
(assert (=> (= result2 true) (=> (not (not (= first_available 0))) (and (= o14 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o14) (<= (+ 0 o14) 2147483647))))))
(assert (=> (= result2 true) (=> (not (not (= first_available 0))) (= result1 (ite (= o14 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o10 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o10) (<= (+ 0 o10) 2147483647)))))
(assert (=> (= result1 true) (= o11 (ite (<= j1 o10) true false))))
(assert (=> (= result1 true) (= result4 (ite (<= 1 j1) o11 false))))
...
(assert (= result5 true))
(assert (< 1 j))
(assert (and (= o9 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) (- j 1))) (in_range3 o9)))
(assert (= result6 (ite (in_range7 o9) true false)))
(assert (= result6 true))
(assert (and (= temp___316 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) (- j 1))) (in_range3 temp___316)))
(assert (and (<= 1 temp___316) (<= temp___316 10000)))
(assert (= o2 temp___316))
(assert (= (mk___rep1 (mk___split_fields1 o3 o4)) (select data o2)))
(assert (= o3 o5))
(assert (= o4 o6))
(assert (= o7 o6))
(assert (= o8 (to_rep o7)))
