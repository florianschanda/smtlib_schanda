...
(assert (and (and (ite (= (rec__usergroup_examples__value_cache_t__cached (us_split_fields1 (select vca i))) true) (and (and (= (mk_int__ref result) (mk_int__ref v)) (= v1 (to_rep (rec__usergroup_examples__value_cache_t__cache (us_split_fields1 (select vca i)))))) (and (= vca3 vca) (= vca3 vca1))) (and (and (and (and (and (and (= (to_rep o) (to_rep (select va i))) (and (= (rec__usergroup_examples__value_cache_t__cached (us_split_fields1 (select vca i))) o1) (= o o2))) (and (= o3 o1) (= o4 o2))) (= o5 (store vca i (mk___rep (mk___split_fields o3 o4))))) (and (= (mk_map__ref1 result1) (mk_map__ref1 vca)) (= vca2 o5))) (and (and (= vca2 result2) (= vca3 (store vca2 i (mk___rep (mk___split_fields (of_int 1) (rec__usergroup_examples__value_cache_t__cache (us_split_fields1 (select vca2 i)))))))) (and (= (mk_int__ref result3) (mk_int__ref v)) (= v2 (to_rep (rec__usergroup_examples__value_cache_t__cache (us_split_fields1 (select vca3 i)))))))) (= v1 v2))) (= (is_valid (to_rep (select va i))) true)) (and (and (= v1 v3) (= vca3 vca4)) (and (= v4 v1) (= vca5 vca3)))))
