...
(define-fun dynamic_invariant ((temp___expr_472 Int) (temp___is_init_468 Bool) (temp___skip_constant_469 Bool) (temp___do_toplevel_470 Bool) (temp___do_typ_inv_471 Bool)) Bool (=> (or (= temp___is_init_468 true) (<= 0 4)) (in_range5 temp___expr_472)))
(declare-sort opt 0)
...
(define-fun dynamic_invariant1 ((temp___expr_479 Int) (temp___is_init_475 Bool) (temp___skip_constant_476 Bool) (temp___do_toplevel_477 Bool) (temp___do_typ_inv_478 Bool)) Bool (=> (or (= temp___is_init_475 true) (<= 1 4)) (in_range6 temp___expr_479)))
...
(define-fun bool_eq4 ((a (Array Int us_rep2)) (a__first Int) (a__last Int) (b (Array Int us_rep2)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (bool_eq3 (select a temp___idx_178) (select b (+ (- b__first a__first) temp___idx_178))) true)))) true false))
...
(assert true)
(assert (forall ((theadmin us_rep1)) (forall ((op Int)) (! (= (= (allowedop theadmin op) true) (= (let ((temp___498 (select isavailable (to_rep (rec__admin__t__rolepresent (us_split_fields3 theadmin)))))) (select temp___498 op)) true)) :pattern ((allowedop theadmin op))))))
...
(define-fun dynamic_invariant3 ((temp___expr_528 Int) (temp___is_init_524 Bool) (temp___skip_constant_525 Bool) (temp___do_toplevel_526 Bool) (temp___do_typ_inv_527 Bool)) Bool (=> (or (= temp___is_init_524 true) (<= 0 18)) (in_range7 temp___expr_528)))
(define-fun dynamic_invariant4 ((temp___expr_535 Int) (temp___is_init_531 Bool) (temp___skip_constant_532 Bool) (temp___do_toplevel_533 Bool) (temp___do_typ_inv_534 Bool)) Bool (=> (or (= temp___is_init_531 true) (<= 1 18)) (in_range8 temp___expr_535)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 1)) 65) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 2)) 82)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 3)) 67)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 4)) 72)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 5)) 73)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 6)) 86)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 7)) 69)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 8)) 32)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 9)) 76)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 10)) 79)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 11)) 71)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 12)) 32)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 13)) 32)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 14)) 32)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 15)) 32)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 16)) 32)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 17)) 32)) (= (to_rep2 (select (temp___String_Literal_185 us_void_param) 18)) 32)) :pattern ((temp___String_Literal_185 us_void_param)))))
(declare-fun temp___String_Literal_186 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 1)) 85) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 2)) 80)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 3)) 68)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 4)) 65)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 5)) 84)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 6)) 69)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 7)) 32)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 8)) 67)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 9)) 79)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 10)) 78)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 11)) 70)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 12)) 73)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 13)) 71)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 14)) 32)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 15)) 68)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 16)) 65)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 17)) 84)) (= (to_rep2 (select (temp___String_Literal_186 us_void_param) 18)) 65)) :pattern ((temp___String_Literal_186 us_void_param)))))
(declare-fun temp___String_Literal_187 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 1)) 79) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 2)) 86)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 3)) 69)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 4)) 82)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 5)) 82)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 6)) 73)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 7)) 68)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 8)) 69)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 9)) 32)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 10)) 76)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 11)) 79)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 12)) 67)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 13)) 75)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 14)) 32)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 15)) 32)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 16)) 32)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 17)) 32)) (= (to_rep2 (select (temp___String_Literal_187 us_void_param) 18)) 32)) :pattern ((temp___String_Literal_187 us_void_param)))))
(declare-fun temp___String_Literal_188 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 1)) 83) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 2)) 72)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 3)) 85)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 4)) 84)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 5)) 68)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 6)) 79)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 7)) 87)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 8)) 78)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 9)) 32)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 10)) 32)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 11)) 32)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 12)) 32)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 13)) 32)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 14)) 32)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 15)) 32)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 16)) 32)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 17)) 32)) (= (to_rep2 (select (temp___String_Literal_188 us_void_param) 18)) 32)) :pattern ((temp___String_Literal_188 us_void_param)))))
(assert (= optokeyed (admin__optokeyed__aggregate_def (mk___rep2 (mk___split_fields2 (of_rep4 11) (of_rep5 7) (temp___String_Literal_185 Tuple0))) (mk___rep2 (mk___split_fields2 (of_rep4 18) (of_rep5 6) (temp___String_Literal_186 Tuple0))) (mk___rep2 (mk___split_fields2 (of_rep4 13) (of_rep5 8) (temp___String_Literal_187 Tuple0))) (mk___rep2 (mk___split_fields2 (of_rep4 8) (of_rep5 8) (temp___String_Literal_188 Tuple0))))))
(assert (forall ((temp___180 us_rep2) (temp___181 us_rep2) (temp___182 us_rep2) (temp___183 us_rep2)) (let ((temp___179 (admin__optokeyed__aggregate_def temp___180 temp___181 temp___182 temp___183))) (and (and (and (= (select temp___179 1) temp___180) (= (select temp___179 2) temp___181)) (= (select temp___179 3) temp___182)) (= (select temp___179 4) temp___183)))))
...
(define-fun dynamic_invariant5 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 3)) (in_range1 temp___expr_402)))
(define-fun dynamic_invariant6 ((temp___expr_409 Int) (temp___is_init_405 Bool) (temp___skip_constant_406 Bool) (temp___do_toplevel_407 Bool) (temp___do_typ_inv_408 Bool)) Bool (=> (or (= temp___is_init_405 true) (<= 1 3)) (in_range2 temp___expr_409)))
(define-fun dynamic_invariant7 ((temp___expr_435 Int) (temp___is_init_431 Bool) (temp___skip_constant_432 Bool) (temp___do_toplevel_433 Bool) (temp___do_typ_inv_434 Bool)) Bool (=> (or (= temp___is_init_431 true) (<= 0 78)) (in_range3 temp___expr_435)))
...
(declare-const o Int)
(declare-const temp___589 (Array Int Bool))
...
(assert (= (admin__isavailable__aggregate_def (temp___162 (distinct 1 0) (distinct 0 0)) (temp___167 (distinct 1 0) (distinct 0 0)) (temp___172 (distinct 1 0) (distinct 1 0) (distinct 0 0))) isavailable))
...
(assert (= op2 1))
(assert (=> (and (<= 1 op2) (<= op2 4)) (= temp___591 op2)))
(assert (=> (and (<= 1 op2) (<= op2 4)) (= temp___590 theop1)))
(assert (=> (and (<= 1 op2) (<= op2 4)) (= theop2 0)))
(assert (=> (and (<= 1 op2) (<= op2 4)) (and (and (=> (<= 0 4) (in_range5 theop2)) (=> (<= 1 4) (in_range6 op3))) (and (<= 1 op3) (<= op3 4)))))
(assert (=> (and (<= 1 op2) (<= op2 4)) (or (and (and (= theop3 theop4) (= theop5 theop3)) (and (and (= result2 (str_comp keyedop op3)) (= (= result2 true) (and (and (<= (to_rep5 (rec__admin__datat__minmatchlength (us_split_fields5 (select optokeyed op3)))) (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop)))) (<= (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop))) (to_rep4 (rec__admin__datat__length (us_split_fields5 (select optokeyed op3)))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop))))) (= (to_rep2 (select (rec__admin__datat__text (us_split_fields5 (select optokeyed op3))) i)) (to_rep2 (select (rec__keyboard__datat__text (us_split_fields1 keyedop)) i)))))))) (and (= result2 true) (and (and (and (and (and (<= 1 (to_rep (rec__admin__t__rolepresent (us_split_fields3 theadmin)))) (<= (to_rep (rec__admin__t__rolepresent (us_split_fields3 theadmin))) 3)) (= o (to_rep (rec__admin__t__rolepresent (us_split_fields3 theadmin))))) (= temp___589 (select isavailable o))) (= result3 (select temp___589 op3))) (ite (= result3 true) (and (= theop2 result4) (= theop3 op3)) (= theop3 theop2)))))) (and (and (and (= result2 (str_comp keyedop op3)) (= (= result2 true) (and (and (<= (to_rep5 (rec__admin__datat__minmatchlength (us_split_fields5 (select optokeyed op3)))) (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop)))) (<= (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop))) (to_rep4 (rec__admin__datat__length (us_split_fields5 (select optokeyed op3)))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop))))) (= (to_rep2 (select (rec__admin__datat__text (us_split_fields5 (select optokeyed op3))) i)) (to_rep2 (select (rec__keyboard__datat__text (us_split_fields1 keyedop)) i)))))))) (and (not (= result2 true)) (= theop3 theop2))) (and (and (= theop3 theop4) (= theop5 theop3)) (= op3 4))))))
