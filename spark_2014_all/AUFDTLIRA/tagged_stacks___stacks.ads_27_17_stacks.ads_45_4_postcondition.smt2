...
(define-fun dynamic_invariant2 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 100)) (in_range temp___expr_159)))
...
(assert (forall ((s1 us_rep)) (! (let ((result (get_model__2 s1))) (and (and (= (length result) (size s1)) (and (in_range (last1 result)) (in_range (first1 result)))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__2 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep)) (! (let ((result (get_model__21 attr__tag2 s1))) (and (and (= (length result) (size s1)) (and (in_range (last1 result)) (in_range (first1 result)))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__21 attr__tag2 s1))))))
...
(assert (forall ((s1 us_rep1)) (! (let ((result (get_model__3 s1))) (and (and (in_range (first1 result)) (and (in_range (last1 result)) (= (length result) (size (to_base s1))))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__3 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep1)) (! (let ((result (get_model__31 attr__tag2 s1))) (and (and (in_range (first1 result)) (and (in_range (last1 result)) (= (length result) (size (to_base s1))))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__31 attr__tag2 s1))))))
...
(assert (forall ((s1 us_rep1)) (! (= (= (wraps_around s1) true) (< 100 (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s1)))) 1))) :pattern ((wraps_around s1)))))
(assert (forall ((s1 us_rep1)) (! (dynamic_invariant2 (last6 s1) true false true true) :pattern ((last6 s1)))))
(assert (forall ((attr__tag2 Int)) (forall ((s1 us_rep1)) (! (dynamic_invariant2 (last7 attr__tag2 s1) true false true true) :pattern ((last7 attr__tag2 s1))))))
(assert (forall ((s1 us_rep1)) (! (= (last6 s1) (last7 us_tag2 s1)) :pattern ((last7 us_tag2 s1)))))
(assert (forall ((s1 us_rep1)) (! (= (last6 s1) (ite (not (= (wraps_around s1) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s1)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s1))) (to_rep (rec__stacks__stack_root__length1 (us_split_fields3 s1)))) 1) 100))) :pattern ((last6 s1)))))
...
(assert (and (<= 1 (to_rep (rec__stacks__stack_root__length (us_split_fields1 s)))) (<= (to_rep (rec__stacks__stack_root__length (us_split_fields1 s))) 100)))
(assert (= o (to_rep (rec__stacks__stack_root__length (us_split_fields1 s)))))
...
(assert (not (= stacks__peek__2__result4 (to_rep1 (select (elts (get_model__2 s)) (to_rep2 (last (rt (get_model__2 s)))))))))
(check-sat)
(exit)
