...
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) i)))) n6)) (not (= i y))) (= (eq (select (nb_blacks c82b) i) (select (nb_blacks c81b) i)) true)))))
...
(assert (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) c83b)))) n6) (= (eq (select (nb_blacks c82b) c83b) (select (nb_blacks c81b) c83b)) true)))
(assert (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y))))) n6))
(assert (not (= (eq (select (nb_blacks c82b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y)) (select (nb_blacks c81b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y))) true)))
(check-sat)
(exit)
