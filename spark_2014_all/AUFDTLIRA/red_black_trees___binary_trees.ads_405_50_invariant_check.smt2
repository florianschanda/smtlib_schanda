...
(assert (forall ((f us_rep3)) (! (=> (type_invariant f) (dynamic_invariant2 (size f) true false true)) :pattern ((size f)))))
...
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant i true true true) (type_invariant f)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant2 result true false true)))) :pattern ((parent f i))))))
...
(define-fun dynamic_invariant3 ((temp___expr_168 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= 0 1)) (in_range4 temp___expr_168)))
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant i true true true) (type_invariant f)) (not (= (parent f i) 0))) (dynamic_invariant3 (position f i) true false true)) :pattern ((position f i))))))
...
(define-fun default_initial_assumption5 ((temp___expr_199 us_rep) (temp___skip_top_level_200 Bool)) Bool (=> (not (= temp___skip_top_level_200 true)) (= (length temp___expr_199) 0)))
...
(declare-const temp___975 extended_index_type)
(declare-const temp___9751 (Array Int us_rep2))
...
(assert (= temp___975 o2))
(assert (= temp___9751 o3))
...
(assert (= temp___975 f__split_fields2))
(assert (= temp___9751 f__split_fields3))
(assert (and (= o4 (to_rep f__split_fields2)) (in_range1 (to_rep f__split_fields2))))
(assert (= (mk_int__ref result4) (mk_int__ref root)))
(assert (= root1 o4))
(assert (and (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields2 f__split_fields3))) true) (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields2 f_old__split_fields3))) true)))
(assert (and (forall ((r Int)) (=> (and (<= 1 r) (<= r (to_rep f_old__split_fields2))) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields3 r)))) 2) (= (oeq (model__ (mk___rep2 (mk___split_fields2 f_old__split_fields2 f_old__split_fields3)) r) (model__ (mk___rep2 (mk___split_fields2 f__split_fields2 f__split_fields3)) r)) true)))) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (not (= i6 root1)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields2 f__split_fields3)) root1) i6))) true)))))))
...
(assert (= f_old__split_fields6 (mk___split_fields2 f_old__split_fields2 f_old__split_fields3)))
(assert (= root3 root1))
(assert (= (mk___split_fields2 f__split_fields6 f__split_fields7) (mk___split_fields2 f__split_fields2 f__split_fields3)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (and (= o12 (size (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)))) (and (in_range2 o12) (= o12 (to_rep f__split_fields4)))))
(assert (= result5 (ite (= o12 (+ (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 1)) true false)))
(assert (= result5 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o11 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root2)) (and (= (= o11 true) (and (<= root2 (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 root2)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) root2) (not (= o11 true))))))
(assert (= result6 (ite (not (= o11 true)) true false)))
(assert (= result6 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
...
(assert (= result7 true))
(assert (= (= result8 true) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (= (parent (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i6) (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i6))))))
(assert (= result8 true))
(assert (= (= result9 true) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i6) 0)) (= (position (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i6) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i6)))))))
(assert (= result9 true))
(assert (= (= result11 true) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i6) true) (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i6) true))))))
(assert (= result11 true))
(assert (= (= result13 true) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (and (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i6) true) (not (= i6 root2))) (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i6) true))))))
(assert (= result13 true))
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= result16 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)) (and (= (= result16 true) (and (<= i1 (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i1)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) i1) (not (= result16 true))))))
(assert (= result16 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o5 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)) (and (dynamic_invariant1 o5 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o5 i1)))) 0) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (not (= i6 i1)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i6) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i6)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i6))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i6))) true)))))) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i6))) true) (not (= i6 i1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o5 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i6)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i6) (rec__tree_model__path_type__a (us_split_fields1 (select o5 i6)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o5 i6)))) 0)))) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i6))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 j))) true) (= (oeq1 (rec__tree_model__path_type__a (us_split_fields1 (select o5 i6))) (rec__tree_model__path_type__a (us_split_fields1 (select o5 j)))) true)) (= j i6))))))))))))))
