...
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant i true true true true) (type_invariant f)) (let ((result (parent f i))) (and (and (=> (= (valid_root f i) true) (= result 0)) (=> (= (size f) 0) (= result 0))) (dynamic_invariant2 result true false true true)))) :pattern ((parent f i))))))
...
(assert (forall ((f us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant i true true true true) (type_invariant f)) (not (= (parent f i) 0))) (dynamic_invariant3 (position f i) true false true true)) :pattern ((position f i))))))
