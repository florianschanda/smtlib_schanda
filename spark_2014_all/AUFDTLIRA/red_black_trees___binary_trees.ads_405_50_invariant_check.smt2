...
(declare-fun oeq ((Array Int us_rep1) (Array Int us_rep1)) Bool)
(declare-fun oeq__function_guard (Bool (Array Int us_rep1) (Array Int us_rep1)) Bool)
...
(assert (forall ((a us_rep) (b us_rep)) (! (= (user_eq a b) (oeq1 a b)) :pattern ((user_eq a b)))))
(define-fun default_initial_assumption5 ((temp___expr_232 us_rep) (temp___skip_top_level_233 Bool)) Bool (=> (not (= temp___skip_top_level_233 true)) (= (length temp___expr_232) 0)))
(assert true)
...
(declare-const o3 (Array Int us_rep2))
(declare-const temp___1021 extended_index_type)
(declare-const temp___10211 (Array Int us_rep2))
(declare-const o4 Int)
(declare-const i Int)
(declare-const o5 (Array Int us_rep1))
(declare-const o6 Bool)
(declare-const o7 Int)
(declare-const result extended_index_type)
(declare-const result1 (Array Int us_rep2))
(declare-const f_old__split_fields2 extended_index_type)
(declare-const f_old__split_fields3 (Array Int us_rep2))
(declare-const result2 extended_index_type)
(declare-const result3 (Array Int us_rep2))
(declare-const f__split_fields2 extended_index_type)
(declare-const f__split_fields3 (Array Int us_rep2))
(declare-const result4 Int)
(declare-const root1 Int)
(declare-const f__split_fields4 extended_index_type)
(declare-const f__split_fields5 (Array Int us_rep2))
(declare-const root2 Int)
(declare-const f_old__split_fields4 extended_index_type)
(declare-const f_old__split_fields5 (Array Int us_rep2))
(declare-const f__split_fields6 extended_index_type)
(declare-const f__split_fields7 (Array Int us_rep2))
(declare-const root3 Int)
(declare-const f_old__split_fields6 us_split_fields4)
...
(define-fun f__split_fields8 () us_split_fields4 (mk___split_fields2 f__split_fields2 f__split_fields3))
(define-fun f_old__split_fields7 () us_split_fields4 (mk___split_fields2 f_old__split_fields2 f_old__split_fields3))
(assert (=> (<= 1 100) (in_range1 root)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 100))
(assert (= (mk___split_fields__ref2 (mk___split_fields2 result result1)) (mk___split_fields__ref2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))))
(assert (= f__split_fields f_old__split_fields2))
(assert (= f__split_fields1 f_old__split_fields3))
(assert (and (= o (+ (to_rep f__split_fields) 1)) (in_range2 (+ (to_rep f__split_fields) 1))))
(assert (= (to_rep o1) o))
(assert (= o1 o2))
(assert (= f__split_fields1 o3))
(assert (= temp___1021 o2))
(assert (= temp___10211 o3))
(assert (= (mk___split_fields__ref2 (mk___split_fields2 result2 result3)) (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1))))
(assert (= temp___1021 f__split_fields2))
(assert (= temp___10211 f__split_fields3))
(assert (and (= o4 (to_rep f__split_fields2)) (in_range1 (to_rep f__split_fields2))))
(assert (= (mk_int__ref result4) (mk_int__ref root)))
(assert (= root1 o4))
(assert (and (= (tree_structure (mk___rep2 f__split_fields8)) true) (= (tree_structure (mk___rep2 f_old__split_fields7)) true)))
(assert (and (forall ((r Int)) (=> (and (<= 1 r) (<= r (to_rep f_old__split_fields2))) (=> (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f_old__split_fields3 r)))) 2) (= (oeq (model__ (mk___rep2 f_old__split_fields7) r) (model__ (mk___rep2 f__split_fields8) r)) true)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root1)) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields8) root1) i1))) true)))))))
(assert (= f_old__split_fields4 f_old__split_fields2))
(assert (= f_old__split_fields5 f_old__split_fields3))
(assert (= root1 root2))
(assert (= f__split_fields4 f__split_fields2))
(assert (= f__split_fields5 f__split_fields3))
(assert (= f_old__split_fields6 f_old__split_fields7))
(assert (= root3 root1))
(assert (= (mk___split_fields2 f__split_fields6 f__split_fields7) f__split_fields8))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (and (= o7 (size (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)))) (and (in_range2 o7) (= o7 (to_rep f__split_fields4)))))
(assert (= result5 (ite (= o7 (+ (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 1)) true false)))
(assert (= result5 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o6 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root2)) (and (= (= o6 true) (and (<= root2 (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 root2)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) root2) (not (= o6 true))))))
(assert (= result6 (ite (not (= o6 true)) true false)))
(assert (= result6 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (and (= result7 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) root2)) (and (= (= result7 true) (and (<= root2 (to_rep f__split_fields4)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields5 root2)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) root2) (not (= result7 true))))))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (= (parent (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i1) (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1))))))
(assert (= result8 true))
(assert (= (= result9 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i1) 0)) (= (position (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i1) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))))))
(assert (= result9 true))
(assert (= (= result10 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) true) (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i1) true))))))
(assert (= result10 true))
(assert (= (= result11 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)) i1) true) (not (= i1 root2))) (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) true))))))
(assert (= result11 true))
(assert (<= 1 i))
(assert (<= i 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= result12 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)) (and (= (= result12 true) (and (<= i (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) i) (not (= result12 true))))))
(assert (= result12 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o5 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i)) (and (dynamic_invariant o5 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o5 i)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 i)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i1))) true) (not (= i1 i))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select o5 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select o5 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select o5 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select o5 j))) true) (= (oeq1 (rec__tree_model__path_type__a (us_split_fields1 (select o5 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select o5 j)))) true)) (= j i1))))))))))))))
(assert (not (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true)))
(check-sat)
(exit)
