...
(assert (and (= o135 (get (rec__list_allocator__m__t__allocated model____split_fields4) j10)) (in_range7 o135)))
(assert (= result45 (ite (in_range4 o135) true false)))
(assert (= result45 true))
(assert (and (= o132 (length (rec__list_allocator__m__t__allocated model____split_fields4))) (in_range6 o132)))
(assert (= result46 (ite (< j10 o132) true false)))
(assert (=> (= result46 true) (and (= o133 (+ j10 1)) (in_range1 (+ j10 1)))))
(assert (=> (= result46 true) (and (= o134 (get (rec__list_allocator__m__t__allocated model____split_fields4) o133)) (in_range7 o134))))
(assert (=> (not (= result46 true)) (= o134 0)))
(assert (not (<= 1 j10)))
(check-sat)
(exit)
