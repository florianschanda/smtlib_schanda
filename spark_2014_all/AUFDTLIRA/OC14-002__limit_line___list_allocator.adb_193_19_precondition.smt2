...
(assert (=> (not (= first_available1 0)) (and (= o55 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o55))))
(assert (=> (not (= first_available1 0)) (= result13 (ite (< 0 o55) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (and (= o54 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range7 o54)))))
(assert (=> (not (= first_available1 0)) (=> (= result13 true) (= result12 (ite (= o54 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result13 true)) (= result12 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o56 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o56))))
(assert (=> (not (not (= first_available1 0))) (= result12 (ite (= o56 0) true false))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (and (= o52 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o52)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (= result14 (ite (< 0 o52) true false)))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (and (= o51 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range7 o51))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (= result14 true) (= result11 (ite (= o51 first_allocated1) true false))))))
(assert (=> (= result12 true) (=> (not (= first_allocated1 0)) (=> (not (= result14 true)) (= result11 false)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (and (= o53 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o53)))))
(assert (=> (= result12 true) (=> (not (not (= first_allocated1 0))) (= result11 (ite (= o53 0) true false)))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o49 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o49))))
(assert (=> (= result11 true) (= o50 (ite (<= j1 o49) true false))))
(assert (=> (= result11 true) (= result15 (ite (<= 1 j1) o50 false))))
...
(assert (and (= o48 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range7 o48)))
(assert (= result17 (ite (in_range4 o48) true false)))
(assert (= result17 true))
(assert (and (= o45 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range6 o45)))
(assert (= result18 (ite (< j o45) true false)))
(assert (=> (= result18 true) (and (= o46 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (= result18 true) (and (= o47 (get (rec__list_allocator__m__t__allocated model____split_fields3) o46)) (in_range7 o47))))
(assert (=> (not (= result18 true)) (= o47 0)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
