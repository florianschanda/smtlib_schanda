...
(declare-fun temp_____aggregate_def_908 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (forall ((temp___910 (Array Int (Array Int et1)))) (forall ((temp___911 Int)) (forall ((temp___912 (Array Int et1))) (let ((temp___909 (temp_____aggregate_def_908 temp___910 temp___911 temp___912))) (=> (dynamic_invariant temp___911 true true true true) (forall ((temp___913 Int)) (ite (= temp___913 temp___911) (= (select temp___909 temp___913) temp___912) (= (select temp___909 temp___913) (select temp___910 temp___913))))))))))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq1 a2 5 50 (temp_____aggregate_def_908 a i b) 5 50) true)))
(check-sat)
(exit)
