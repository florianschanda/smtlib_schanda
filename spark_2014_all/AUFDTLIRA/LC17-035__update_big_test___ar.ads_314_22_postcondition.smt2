...
(declare-fun temp___908 ((Array Int (Array Int et1)) Int (Array Int et1)) (Array Int (Array Int et1)))
...
(assert (= a1 a2))
(assert (= a3 a1))
(assert (not (= (bool_eq1 a2 5 50 (temp___908 a i b) 5 50) true)))
(check-sat)
(exit)
