...
(define-fun dynamic_invariant ((temp___expr_150 Int) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (=> (or (= temp___is_init_147 true) (<= 1 100)) (in_range2 temp___expr_150)))
...
(define-fun dynamic_invariant2 ((temp___expr_186 Int) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool)) Bool (=> (or (= temp___is_init_183 true) (<= 0 1)) (in_range4 temp___expr_186)))
...
(define-fun dynamic_invariant3 ((temp___expr_192 Int) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool)) Bool (=> (or (= temp___is_init_189 true) (<= 0 2147483647)) (in_range5 temp___expr_192)))
...
(assert (forall ((x extended_index_type)) (! (in_range6 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x position_type)) (! (in_range7 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun default_initial_assumption1 ((temp___expr_275 us_rep3) (temp___skip_top_level_276 Bool)) Bool (and (and (= (to_rep (rec__binary_trees__forest__s (us_split_fields5 temp___expr_275))) 0) (forall ((temp___278 Int)) (=> (and (<= 1 temp___278) (<= temp___278 100)) (and (and (and (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_275)) temp___278)))) 0) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_275)) temp___278)))) 0)) (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_275)) temp___278)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 temp___expr_275)) temp___278)))) 2))))) (=> (not (= temp___skip_top_level_276 true)) (= (size temp___expr_275) 0))))
...
(define-fun dynamic_invariant4 ((temp___expr_156 Int) (temp___is_init_153 Bool) (temp___skip_constant_154 Bool) (temp___do_toplevel_155 Bool)) Bool (=> (or (= temp___is_init_153 true) (<= 0 100)) (in_range6 temp___expr_156)))
...
(define-fun dynamic_invariant5 ((temp___expr_168 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= 0 1)) (in_range8 temp___expr_168)))
...
(assert (forall ((f us_rep3)) (forall ((i Int) (d Int)) (! (=> (and (and (dynamic_invariant i true true true) (dynamic_invariant5 d true true true)) (type_invariant f)) (let ((result (peek f i d))) (and (and (ite (not (= result 0)) (and (= (position f result) d) (= (parent f result) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent f j) i) (not (= (position f j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent f j) i) (= (position f j) d)) (= result j))))) (dynamic_invariant4 result true false true)))) :pattern ((peek f i d))))))
(assert (forall ((f us_rep3)) (forall ((i Int) (d Int)) (! (=> (and (dynamic_invariant i true true true) (dynamic_invariant5 d true true true)) (= (peek f i d) (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (let ((temp___301 (rec__binary_trees__forest__c (us_split_fields5 f)))) (select temp___301 i))))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (let ((temp___302 (rec__binary_trees__forest__c (us_split_fields5 f)))) (select temp___302 i)))))))) :pattern ((peek f i d))))))
...
(assert (forall ((f1 us_rep3)) (! (=> (type_invariant f1) (dynamic_invariant4 (size f1) true false true)) :pattern ((size f1)))))
(assert (forall ((f1 us_rep3)) (! (= (size f1) (to_rep (rec__binary_trees__forest__s (us_split_fields5 f1)))) :pattern ((size f1)))))
(assert (forall ((f1 us_rep3)) (forall ((i Int)) (! (=> (and (dynamic_invariant i true true true) (type_invariant f1)) (let ((result (parent f1 i))) (and (and (=> (= (valid_root f1 i) true) (= result 0)) (=> (= (size f1) 0) (= result 0))) (dynamic_invariant4 result true false true)))) :pattern ((parent f1 i))))))
(assert (forall ((f1 us_rep3)) (forall ((i Int)) (! (=> (dynamic_invariant i true true true) (= (parent f1 i) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (let ((temp___292 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___292 i))))))) :pattern ((parent f1 i))))))
(assert (forall ((f1 us_rep3)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant i true true true) (type_invariant f1)) (not (= (parent f1 i) 0))) (dynamic_invariant5 (position f1 i) true false true)) :pattern ((position f1 i))))))
(assert (forall ((f1 us_rep3)) (forall ((i Int)) (! (=> (dynamic_invariant i true true true) (= (position f1 i) (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (let ((temp___296 (rec__binary_trees__forest__c (us_split_fields5 f1)))) (select temp___296 i))))))) :pattern ((position f1 i))))))
...
(define-fun dynamic_invariant7 ((temp___expr_162 Int) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool)) Bool (=> (or (= temp___is_init_159 true) (<= 0 2)) (in_range7 temp___expr_162)))
...
(declare-const i Int)
(declare-const temp___1147 (Array Int us_rep1))
...
(assert (<= 1 n1))
(assert (<= n1 100))
(assert (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) i2))) true) (forall ((d2 Int)) (=> (and (<= 0 d2) (<= d2 1)) (=> (= (peek f i2 d2) 0) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ f root) j2))) true) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i2))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j2)))) true)) (<= (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j2)))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i2)))) n2))) (not (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) j2))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ f root) i2)))) 1)) d2))))))))))))
(assert (and (=> (<= 1 100) (in_range2 n2)) (and (<= 1 n2) (<= n2 100))))
(assert (<= 1 i))
(assert (<= i 100))
(assert (= (tree_structure f) true))
(assert (and (= temp___1147 (model__ f root)) (and (dynamic_invariant6 temp___1147 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1147 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1147 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent f i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1147 (parent f i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1147 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1147 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1147 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1147 (parent f i2)))) (position f i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1147 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1147 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1147 i2))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1147 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1147 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1147 j2)))) true)) (= j2 i2))))))))))))))
(assert (= (mk___rep (mk___split_fields o o1)) (select temp___1147 i)))
(assert (= o o2))
(assert (= o1 o3))
(assert (= result2 o3))
(assert (= result2 true))
...
(assert (<= d 1))
(assert (= (tree_structure f) true))
(assert (and (= o4 (peek f i d)) (and (in_range6 o4) (and (= o4 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f)) i)))))) (and (ite (not (= o4 0)) (and (= (position f o4) d) (= (parent f o4) i)) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (= (parent f j2) i) (not (= (position f j2) d)))))) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (parent f j2) i) (= (position f j2) d)) (= o4 j2)))))))))
(assert (= result3 (ite (= o4 0) true false)))
(assert (= result3 true))
(assert (<= 1 j))
(assert (<= j 100))
(assert (= (tree_structure f) true))
(assert (and (= temp___1128 (model__ f root)) (and (dynamic_invariant6 temp___1128 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1128 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent f i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 (parent f i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1128 (parent f i2)))) (position f i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1128 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1128 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 i2))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1128 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1128 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1128 j2)))) true)) (= j2 i2))))))))))))))
(assert (= (mk___rep (mk___split_fields o29 o30)) (select temp___1128 j)))
(assert (= o29 o31))
(assert (= o30 o32))
(assert (= result6 o32))
(assert (=> (= result6 true) (= (tree_structure f) true)))
(assert (=> (= result6 true) (and (= temp___1130 (model__ f root)) (and (dynamic_invariant6 temp___1130 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1130 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1130 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent f i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1130 (parent f i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1130 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1130 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1130 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1130 (parent f i2)))) (position f i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1130 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1130 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1130 i2))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1130 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1130 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1130 j2)))) true)) (= j2 i2)))))))))))))))
(assert (=> (= result6 true) (= (mk___rep (mk___split_fields o24 o25)) (select temp___1130 j))))
(assert (=> (= result6 true) (= o24 o26)))
(assert (=> (= result6 true) (= o25 o27)))
(assert (=> (= result6 true) (= o28 o26)))
(assert (=> (= result6 true) (= (tree_structure f) true)))
(assert (=> (= result6 true) (and (= temp___1129 (model__ f root)) (and (dynamic_invariant6 temp___1129 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1129 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1129 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent f i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1129 (parent f i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1129 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1129 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1129 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1129 (parent f i2)))) (position f i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1129 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1129 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1129 i2))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1129 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1129 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1129 j2)))) true)) (= j2 i2)))))))))))))))
(assert (=> (= result6 true) (= (mk___rep (mk___split_fields o19 o20)) (select temp___1129 i))))
(assert (=> (= result6 true) (= o19 o21)))
(assert (=> (= result6 true) (= o20 o22)))
(assert (=> (= result6 true) (= o23 o21)))
(assert (=> (= result6 true) (and (= result5 (olt o23 o28)) (= (= result5 true) (and (< (length o23) (length o28)) (forall ((n12 Int)) (=> (and (<= 1 n12) (<= n12 (last o23))) (= (get o23 n12) (get o28 n12)))))))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (= (tree_structure f) true)))
(assert (=> (= result5 true) (and (= temp___1132 (model__ f root)) (and (dynamic_invariant6 temp___1132 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1132 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1132 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent f i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1132 (parent f i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1132 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1132 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1132 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1132 (parent f i2)))) (position f i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1132 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1132 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1132 i2))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1132 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1132 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1132 j2)))) true)) (= j2 i2)))))))))))))))
(assert (=> (= result5 true) (= (mk___rep (mk___split_fields o10 o11)) (select temp___1132 i))))
(assert (=> (= result5 true) (= o10 o12)))
(assert (=> (= result5 true) (= o11 o13)))
(assert (=> (= result5 true) (= o14 o12)))
(assert (=> (= result5 true) (and (= o15 (length o14)) (and (in_range3 o15) (<= (+ 0 o15) 2147483647)))))
(assert (=> (= result5 true) (= o16 (+ o15 n2))))
(assert (=> (= result5 true) (and (= o17 o16) (in_range1 o16))))
(assert (=> (= result5 true) (= (tree_structure f) true)))
(assert (=> (= result5 true) (and (= temp___1131 (model__ f root)) (and (dynamic_invariant6 temp___1131 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1131 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1131 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent f i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1131 (parent f i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1131 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1131 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1131 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1131 (parent f i2)))) (position f i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1131 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1131 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1131 i2))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1131 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1131 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1131 j2)))) true)) (= j2 i2)))))))))))))))
(assert (=> (= result5 true) (= (mk___rep (mk___split_fields o5 o6)) (select temp___1131 j))))
(assert (=> (= result5 true) (= o5 o7)))
(assert (=> (= result5 true) (= o6 o8)))
(assert (=> (= result5 true) (= o9 o7)))
(assert (=> (= result5 true) (and (= o18 (length o9)) (and (in_range3 o18) (<= (+ 0 o18) 2147483647)))))
(assert (=> (= result5 true) (= result4 (ite (<= o18 o17) true false))))
