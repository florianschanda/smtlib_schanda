...
(assert (not (= (ite (<= (to_rep1 (first4 temp___24021)) (to_rep1 (last4 temp___24021))) (+ (- (to_rep1 (last4 temp___24021)) (to_rep1 (first4 temp___24021))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) (+ (- (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 1)) 1) 0))))
(check-sat)
(exit)
