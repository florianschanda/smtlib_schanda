...
(assert (= result3 true))
(assert (and (= o23 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o23) (<= (+ 0 o23) 2147483647))))
(assert (= o24 (ite (<= j1 o23) true false)))
(assert (= result10 (ite (<= 1 j1) o24 false)))
(assert (= result10 true))
(assert (< 1 j1))
(assert (and (= o33 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) (- j1 1))) (in_range6 o33)))
(assert (= result11 (ite (in_range3 o33) true false)))
