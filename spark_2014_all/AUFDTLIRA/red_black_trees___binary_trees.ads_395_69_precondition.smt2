...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (and (= o8 (size (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)))) (and (in_range2 o8) (= o8 (to_rep f__split_fields4)))))
(assert (= result5 (ite (= o8 (+ (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 1)) true false)))
(assert (= result5 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o7 (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root2)) (and (= (= o7 true) (and (<= root2 (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 root2)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) root2) (not (= o7 true))))))
...
(assert (= result9 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (not (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i) 0))))
(check-sat)
(exit)
