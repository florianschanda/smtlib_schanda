...
(assert (=> (= result1 true) (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 r6b3)) (=> (<= (- 2147483648) 2147483647) (in_range1 r9b3))) (=> (<= 0 2147483647) (in_range2 l2)))))
...
(assert (=> (= result1 true) (=> (= result9 true) (and (= temp___1751 (+ y l3)) (in_range1 (+ y l3))))))
(assert (=> (= result1 true) (=> (= result9 true) (and (<= (to_rep (first (rt a))) temp___1751) (<= temp___1751 (to_rep (last (rt a))))))))
...
(assert (=> (= result1 true) (=> (= result9 true) (and (= temp___1741 (+ x l3)) (in_range1 (+ x l3))))))
(assert (=> (= result1 true) (=> (= result9 true) (and (<= (to_rep (first (rt a))) temp___1741) (<= temp___1741 (to_rep (last (rt a))))))))
