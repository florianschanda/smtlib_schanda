...
(assert (=> (= result2 true) (and (= temp___175 (+ y l1)) (in_range1 (+ y l1)))))
(assert (=> (= result2 true) (and (<= (to_rep (first (rt a))) temp___175) (<= temp___175 (to_rep (last (rt a)))))))
(assert (=> (= result2 true) (= o5 temp___175)))
(assert (=> (= result2 true) (= o6 (select (elts a) o5))))
(assert (=> (= result2 true) (= o7 (to_rep o6))))
(assert (=> (= result2 true) (and (= temp___174 (+ x l1)) (in_range1 (+ x l1)))))
(assert (=> (= result2 true) (and (<= (to_rep (first (rt a))) temp___174) (<= temp___174 (to_rep (last (rt a)))))))
(assert (=> (= result2 true) (= o3 temp___174)))
(assert (=> (= result2 true) (= o4 (select (elts a) o3))))
(assert (=> (= result2 true) (= o8 (to_rep o4))))
(assert (=> (= result2 true) (= result1 (ite (= o8 o7) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (and (= temp___168 r9b) (and (= temp___167 l1) (and (= temp___166 r6b) (and (= 0 temp___173) (and (and (and (and (and (and (= o11 (+ x l1)) (in_range1 (+ x l1))) (= o12 (- o11 1))) (and (= o13 o12) (in_range1 o12))) (and (= (mk_int__ref result4) (mk_int__ref r6b)) (= r6b2 o13))) (in_range1 r6b2)) (and (and (and (and (and (and (= o14 (+ y l1)) (in_range1 (+ y l1))) (= o15 (- o14 1))) (and (= o16 o15) (in_range1 o15))) (and (= (mk_int__ref result5) (mk_int__ref r9b)) (= r9b2 o16))) (in_range1 r9b2)) (and (= (bool_eq (elts a) (to_rep (first6 (mk3 x r6b3))) (to_rep (last6 (mk3 x r6b3))) (elts a) (to_rep (first8 (mk4 y r9b3))) (to_rep (last8 (mk4 y r9b3)))) true) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 r6b3)) (=> (<= 0 2147483647) (in_range2 l2))) (=> (<= (- 2147483648) 2147483647) (in_range1 r9b3))) (and (and (= temp___1731 result6) (= temp___1732 l2)) (and (and (and (= o18 (+ l2 1)) (in_range1 (+ l2 1))) (and (= l2 result7) (= l3 o18))) (and (and (and (and (and (and (= o26 (+ x l3)) (in_range1 (+ x l3))) (= result10 (ite (<= o26 (to_rep (last (rt a)))) true false))) (ite (= result10 true) (and (and (= o25 (+ y l3)) (in_range1 (+ y l3))) (= result9 (ite (<= o25 (to_rep (last (rt a)))) true false))) (= result9 false))) (ite (= result9 true) (and (and (and (and (and (= temp___1751 (+ y l3)) (in_range1 (+ y l3))) (and (and (<= (to_rep (first (rt a))) temp___1751) (<= temp___1751 (to_rep (last (rt a))))) (= o21 temp___1751))) (= o22 (select (elts a) o21))) (= o23 (to_rep o22))) (and (and (and (and (and (= temp___1741 (+ x l3)) (in_range1 (+ x l3))) (and (and (<= (to_rep (first (rt a))) temp___1741) (<= temp___1741 (to_rep (last (rt a))))) (= o19 temp___1741))) (= o20 (select (elts a) o19))) (= o24 (to_rep o20))) (= o27 (ite (= o24 o23) true false)))) (= o27 false))) (= result8 (ite (not (= o27 true)) true false))) (= result8 true)))))))))))) (and (and (= r9b7 (mk_int__ref r9b3)) (and (= r6b3 r6b7) (= l3 l6))) (and (= r9b8 r9b3) (and (= r6b8 r6b3) (= l7 l3)))))))
(assert (=> (= result1 true) (= r9b9 r9b7)))
(assert (=> (= result1 true) (= r6b9 (mk_int__ref r6b7))))
(assert (=> (= result1 true) (= l8 (mk_int__ref l6))))
(assert (=> (= result1 true) (= r9b10 r9b8)))
(assert (=> (= result1 true) (= r6b10 r6b8)))
(assert (=> (= result1 true) (= l9 l7)))
(assert (=> (not (= result1 true)) (= r9b9 (mk_int__ref r9b))))
(assert (=> (not (= result1 true)) (= r6b9 (mk_int__ref r6b))))
(assert (=> (not (= result1 true)) (= l8 (mk_int__ref l1))))
(assert (=> (not (= result1 true)) (= r9b10 r9b1)))
(assert (=> (not (= result1 true)) (= r6b10 r6b1)))
(assert (=> (not (= result1 true)) (= l9 l1)))
(assert (= lcp__result2 (mk_int__ref lcp__result1)))
(assert (= lcp__result3 lcp__result1))
(assert (= result13 (mk_int__ref lcp__result)))
(assert (= lcp__result1 (int__content l8)))
