...
(assert (= o24 j))
(assert (= o25 (select m o24)))
(assert (= o26 (us_split_fields1 o25)))
(assert (= result4 (rec__tree_model__path_type__k o26)))
(assert (=> (= result4 true) (and (= o18 j) (in_range2 j))))
(assert (=> (= result4 true) (and (= o19 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 t)) o18 0)) (and (in_range3 o19) (= o19 (peek1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 t)))) o18 0))))))
(assert (=> (= result4 true) (= o20 (select res3 o19))))
(assert (=> (= result4 true) (= o21 (us_split_fields11 o20))))
(assert (=> (= result4 true) (= o22 (rec__red_black_trees__black_count__depth o21))))
(assert (=> (= result4 true) (= o23 (to_rep o22))))
(assert (=> (= result4 true) (= result3 (ite (<= o23 n2) true false))))
