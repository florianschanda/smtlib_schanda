...
(declare-fun temp_____aggregate_def_290 (Int Int Int) us_t1)
...
(assert (forall ((temp___292 Int) (temp___293 Int) (temp___294 Int)) (let ((temp___291 (temp_____aggregate_def_290 temp___292 temp___293 temp___294))) (=> (dynamic_invariant1 temp___292 true true true true) (and (=> (dynamic_property 1 2147483647 temp___293 temp___294) (and (= (first3 temp___291) temp___293) (= (last3 temp___291) temp___294))) (forall ((temp___295 Int)) (= (to_rep (select (to_array1 temp___291) temp___295)) temp___292)))))))
(declare-const temp___297 (Array Int character))
(declare-const temp___2971 t1)
...
(assert (= (to_rep1 (first2 (rt1 (temp_____aggregate_def_290 32 (to_rep1 s__first) (to_rep1 s__last))))) (to_rep1 s__first)))
(assert (= (to_rep1 (last2 (rt1 (temp_____aggregate_def_290 32 (to_rep1 s__first) (to_rep1 s__last))))) (to_rep1 s__last)))
(assert (= (mk___t1 temp___297 temp___2971) (temp_____aggregate_def_290 32 (to_rep1 s__first) (to_rep1 s__last))))
(assert (= temp___297 temp___298))
(assert (= (mk (to_rep1 (first2 temp___2971)) (to_rep1 (last2 temp___2971))) temp___2981))
(assert (not (= (ite (<= (to_rep1 (first temp___2981)) (to_rep1 (last temp___2981))) (+ (- (to_rep1 (last temp___2981)) (to_rep1 (first temp___2981))) 1) 0) (ite (<= (to_rep1 s__first) (to_rep1 s__last)) (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1) 0))))
(check-sat)
(exit)
