...
(assert (= (to_rep1 (first2 (rt1 (temp___254 32 (to_rep1 s__first) (to_rep1 s__last))))) (to_rep1 s__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___254 32 (to_rep1 s__first) (to_rep1 s__last))))) (to_rep1 s__last)))
(assert (= (mk___t1 temp___261 temp___2611) (temp___254 32 (to_rep1 s__first) (to_rep1 s__last))))
(assert (= temp___261 temp___262))
(assert (= (mk (to_rep1 (first2 temp___2611)) (to_rep1 (last2 temp___2611))) temp___2621))
(assert (not (= (ite (<= (to_rep1 (first temp___2621)) (to_rep1 (last temp___2621))) (+ (- (to_rep1 (last temp___2621)) (to_rep1 (first temp___2621))) 1) 0) (ite (<= (to_rep1 s__first) (to_rep1 s__last)) (+ (- (to_rep1 s__last) (to_rep1 s__first)) 1) 0))))
(check-sat)
(exit)
