...
(declare-fun temp___290 (Int Int Int) us_t1)
...
(assert (= (to_rep1 (first2 (rt1 (temp___290 32 (to_rep1 s__first) (to_rep1 s__last))))) (to_rep1 s__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___290 32 (to_rep1 s__first) (to_rep1 s__last))))) (to_rep1 s__last)))
(assert (= (mk___t1 temp___297 temp___2971) (temp___290 32 (to_rep1 s__first) (to_rep1 s__last))))
