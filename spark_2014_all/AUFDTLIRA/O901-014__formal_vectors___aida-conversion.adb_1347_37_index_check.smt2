...
(assert (and (= o32 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= o35 (ite (<= o32 index) true false)))
(assert (= result (ite (= o35 true) o34 false)))
(assert (= (= o36 true) (forall ((index1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 10) index1) (<= index1 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index1))) true)))))
...
(assert (= o28 temp___1825))
(assert (= o29 (select (elts source) o28)))
(assert (= o30 (to_rep o29)))
(assert (= o31 (ite (< o30 57) true false)))
...
(assert (= o4 temp___1819))
(assert (= o5 (select (elts source) o4)))
(assert (= o6 (to_rep o5)))
(assert (= o7 (ite (= o6 55) true false)))
(assert (and (= temp___1818 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1818) (<= temp___1818 (to_rep1 (last (rt source))))))
(assert (= o temp___1818))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (ite (= o2 52) true false)))
(assert (and (= temp___1817 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1817)))
(check-sat)
(exit)
