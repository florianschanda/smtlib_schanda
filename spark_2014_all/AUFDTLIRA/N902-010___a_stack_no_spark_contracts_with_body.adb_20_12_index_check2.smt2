...
(assert true)
(assert (forall ((a_stack_no_spark_contracts_with_body__sp Int)) (! (= (= (is_full a_stack_no_spark_contracts_with_body__sp) true) (= a_stack_no_spark_contracts_with_body__sp 100)) :pattern ((is_full a_stack_no_spark_contracts_with_body__sp)))))
(declare-sort item 0)
...
(assert (and (= o (+ sp 1)) (in_range (+ sp 1))))
(assert (= result sp))
(assert (= sp1 o))
(assert (= (to_rep o1) it))
(assert (not (<= 1 sp1)))
