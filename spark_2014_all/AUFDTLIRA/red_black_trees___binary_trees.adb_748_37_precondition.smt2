...
(assert (= o2 v))
(assert (= o3 (select temp___1574 o2)))
(assert (= o4 (us_split_fields1 o3)))
(assert (= o5 (rec__tree_model__path_type__a o4)))
(assert (and (= o6 (length o5)) (and (in_range5 o6) (<= (+ 0 o6) 2147483647))))
