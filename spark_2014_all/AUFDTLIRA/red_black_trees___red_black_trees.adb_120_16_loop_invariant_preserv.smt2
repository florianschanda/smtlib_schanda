...
(assert (<= i7 j7))
(assert (<= j7 100))
(assert (not (or (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res6 j7)))) 100) (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select res6 j7)))) n2))))
(check-sat)
(exit)
