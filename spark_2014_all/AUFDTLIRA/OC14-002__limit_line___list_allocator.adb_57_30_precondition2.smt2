...
(assert (=> (not (= first_available 0)) (and (= o22 (length model____split_fields)) (in_range3 o22))))
(assert (=> (not (= first_available 0)) (= result3 (ite (< 0 o22) true false))))
(assert (=> (not (= first_available 0)) (=> (= result3 true) (and (= o21 (get model____split_fields 1)) (in_range4 o21)))))
...
(assert (=> (not (not (= first_available 0))) (and (= o23 (length model____split_fields)) (in_range3 o23))))
(assert (=> (not (not (= first_available 0))) (= result2 (ite (= o23 0) true false))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (and (= o19 (length model____split_fields1)) (in_range3 o19)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (= result4 (ite (< 0 o19) true false)))))
(assert (=> (= result2 true) (=> (not (= first_allocated 0)) (=> (= result4 true) (and (= o18 (get model____split_fields1 1)) (in_range4 o18))))))
...
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (and (= o20 (length model____split_fields1)) (in_range3 o20)))))
(assert (=> (= result2 true) (=> (not (not (= first_allocated 0))) (= result1 (ite (= o20 0) true false)))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o16 (length model____split_fields)) (in_range3 o16))))
...
(assert (= result6 true))
(assert (and (= o15 (get model____split_fields1 j)) (in_range4 o15)))
(assert (= result8 (ite (in_range6 o15) true false)))
(assert (=> (= result8 true) (and (= o11 (length model____split_fields1)) (in_range3 o11))))
(assert (=> (= result8 true) (= result9 (ite (< j o11) true false))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o12 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o13 (get model____split_fields1 o12)) (in_range4 o13)))))
