...
(assert (or (and (and (and (= max24 (mk_int__ref max)) (and (= k22 (mk_int__ref k)) (= a18 (mk_map__ref a)))) (and (= max25 max1) (and (= k23 k1) (= a19 a1)))) (and (and (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (= o (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (= result true))) (and (and (and (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (= o (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1)) (= o 0)) (= result (ite (= o 0) true false))) (not (= result true))) (and (and (and (= max24 max22) (and (= k22 k20) (= a18 a16))) (and (= max25 max23) (and (= k23 k21) (= a19 a17)))) (and (and (and (= o1 (to_rep1 a__first)) (in_range3 (to_rep1 a__first))) (and (= result1 (mk_int__ref k)) (= k2 o1))) (and (and (= result2 (mk_int__ref max)) (= max2 0)) (and (and (and (and (= temp___228 max2) (and (= temp___226 a) (and (= temp___224 k2) (and (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) k2) (<= k2 (to_rep1 a__last))) (= o2 k2)) (= (mk___rep (mk___split_fields o3 o4 o5)) (select a o2))) (and (= o3 o6) (and (= o4 o7) (= o5 o8)))) (= o9 o6)) (= o10 (to_rep o9))) (= result3 (ite (< max2 o10) true false))) (ite (= result3 true) (and (and (and (and (and (and (and (<= (to_rep1 a__first) k2) (<= k2 (to_rep1 a__last))) (= o11 k2)) (= (mk___rep (mk___split_fields o12 o13 o14)) (select a o11))) (and (= o12 o15) (and (= o13 o16) (= o14 o17)))) (= o18 o15)) (= o19 (to_rep o18))) (and (= result4 (mk_int__ref max2)) (= max3 o19))) (= max3 max2))) (and (and (and (and (and (= (to_rep o20) max3) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a k2))) o21) (and (= o20 o22) (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a k2))) o23)))) (and (= o24 o21) (and (= o25 o22) (= o26 o23)))) (and (and (and (<= (to_rep1 a__first) k2) (<= k2 (to_rep1 a__last))) (= o27 k2)) (= o28 (store a o27 (mk___rep (mk___split_fields o24 o25 o26)))))) (and (= result5 (mk_map__ref a)) (= a2 o28))) (and (and (and (<= (to_rep1 a__first) k3) (<= k3 (to_rep1 a__last))) (and (forall ((i5 Int)) (=> (and (<= (to_rep1 a__first) i5) (<= i5 k3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a3 i5)))) max4))) (forall ((i5 Int)) (=> (and (<= (to_rep1 a__first) i5) (<= i5 k3)) (forall ((j3 Int)) (=> (and (<= i5 j3) (<= j3 k3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a3 i5)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a3 j3))))))))))) (and (and (and (=> (<= 1 2147483647) (in_range3 k3)) (forall ((temp___227 Int)) (=> (and (<= (to_rep1 a__first) temp___227) (<= temp___227 (to_rep1 a__last))) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a3 temp___227))) (rec__frame_condition__cell__value (us_split_fields1 (select temp___226 temp___227)))) (= (rec__frame_condition__cell__max_right (us_split_fields1 (select a3 temp___227))) (rec__frame_condition__cell__max_right (us_split_fields1 (select temp___226 temp___227)))))))) (=> (<= 0 2147483647) (in_range2 max4))) (and (and (= k5 (mk_int__ref k3)) (= k6 k3)) (= k3 (to_rep1 a__last)))))))))) (and (and (= max6 (mk_int__ref max4)) (and (= k7 k5) (= a5 (mk_map__ref a3)))) (and (= max7 max4) (and (= k8 k6) (= a6 a3))))) (and (and (= max8 max6) (and (= k9 k7) (= a7 a5))) (and (= max9 max7) (and (= k10 k8) (= a8 a6))))) (and (and (and (= o62 (to_rep1 a__last)) (in_range3 (to_rep1 a__last))) (and (= result10 k9) (= k11 o62))) (and (and (= result11 max8) (= max10 0)) (and (and (and (= temp___234 max10) (and (= temp___232 (map__content a7)) (and (= temp___230 k11) (and (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) k11) (<= k11 (to_rep1 a__last))) (= o63 k11)) (= o64 (select (map__content a7) o63))) (= o65 (us_split_fields1 o64))) (= o66 (rec__frame_condition__cell__value o65))) (= o67 (to_rep o66))) (= result12 (ite (< max10 o67) true false))) (ite (= result12 true) (and (and (and (and (and (and (and (and (<= (to_rep1 a__first) k11) (<= k11 (to_rep1 a__last))) (= o68 k11)) (= o69 (select (map__content a7) o68))) (= o70 (us_split_fields1 o69))) (= o71 (rec__frame_condition__cell__value o70))) (= o72 (to_rep o71))) (and (= result13 (mk_int__ref max10)) (= max11 o72))) (and (= max12 (mk_int__ref max11)) (= max13 max11))) (and (= max12 (mk_int__ref max10)) (= max13 max10)))) (and (and (and (and (and (= (to_rep o73) (int__content max12)) (= o74 (mk___split_fields (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) k11))) (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a7) k11))) o73))) (= o75 (mk___rep o74))) (and (and (and (<= (to_rep1 a__first) k11) (<= k11 (to_rep1 a__last))) (= o76 k11)) (= o77 (store (map__content a7) o76 o75)))) (and (= result14 a7) (= a9 o77))) (and (and (and (<= (to_rep1 a__first) k12) (<= k12 (to_rep1 a__last))) (and (forall ((i5 Int)) (=> (and (<= k12 i5) (<= i5 (to_rep1 a__last))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a10 i5)))) max14))) (forall ((i5 Int)) (=> (and (<= k12 i5) (<= i5 (to_rep1 a__last))) (forall ((j3 Int)) (=> (and (<= i5 j3) (<= j3 (to_rep1 a__last))) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a10 j3)))) (to_rep (rec__frame_condition__cell__max_right (us_split_fields1 (select a10 i5))))))))))) (and (and (and (=> (<= 1 2147483647) (in_range3 k12)) (forall ((temp___233 Int)) (=> (and (<= (to_rep1 a__first) temp___233) (<= temp___233 (to_rep1 a__last))) (and (= (rec__frame_condition__cell__value (us_split_fields1 (select a10 temp___233))) (rec__frame_condition__cell__value (us_split_fields1 (select temp___232 temp___233)))) (= (rec__frame_condition__cell__max_left (us_split_fields1 (select a10 temp___233))) (rec__frame_condition__cell__max_left (us_split_fields1 (select temp___232 temp___233)))))))) (=> (<= 0 2147483647) (in_range2 max14))) (and (and (= k14 (mk_int__ref k12)) (= k15 k12)) (= k12 (to_rep1 a__first)))))))))) (and (and (= max20 (mk_int__ref max14)) (and (= k18 k14) (= a14 (mk_map__ref a10)))) (and (= max21 max14) (and (= k19 k15) (= a15 a10))))) (and (and (= max22 max20) (and (= k20 k18) (= a16 a14))) (and (= max23 max21) (and (= k21 k19) (= a17 a15))))))))))))))
(assert (= max26 max24))
(assert (= k24 k22))
(assert (= a20 a18))
(assert (= max27 max25))
...
(assert (<= (to_rep1 a__first) i5))
(assert (<= i5 (to_rep1 a__last)))
(assert (not (= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a20) i5)))) (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a i5)))))))
(check-sat)
(exit)
