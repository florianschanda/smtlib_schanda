...
(define-fun dynamic_invariant ((temp___expr_275 us_t2) (temp___is_init_272 Bool) (temp___skip_constant_273 Bool) (temp___do_toplevel_274 Bool)) Bool (and (=> (not (= temp___skip_constant_273 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_275) (last5 temp___expr_275))) (=> (= temp___do_toplevel_274 true) (=> (= temp___is_init_272 true) (and (let ((temp___277 (of_array1 (to_array2 temp___expr_275) (first5 temp___expr_275) (last5 temp___expr_275)))) (and (let ((temp___278 (of_array (to_array1 temp___277) (first3 temp___277) (last3 temp___277)))) (and (= (first1 temp___278) 1) (<= 0 (last1 temp___278)))) (<= (last3 temp___277) 1000))) (<= 2 (length2 temp___expr_275)))))))
(define-fun dynamic_predicate ((temp___280 us_t2)) Bool (and (let ((temp___282 (of_array1 (to_array2 temp___280) (first5 temp___280) (last5 temp___280)))) (and (let ((temp___283 (of_array (to_array1 temp___282) (first3 temp___282) (last3 temp___282)))) (and (= (first1 temp___283) 1) (<= 0 (last1 temp___283)))) (<= (last3 temp___282) 1000))) (<= 2 (length2 temp___280))))
...
(declare-const temp___329 (Array Int character))
(declare-const temp___3291 t1)
(assert (dynamic_invariant i19s true false false))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first4 (rt2 i19s))) (to_rep1 (last4 (rt2 i19s)))))
(assert (= (elts2 i19s) temp___329))
(assert (= (mk1 (to_rep1 (first4 (rt2 i19s))) (to_rep1 (last4 (rt2 i19s)))) temp___3291))
(assert (not (dynamic_property 1 2147483647 (to_rep1 (first2 temp___3291)) (to_rep1 (last2 temp___3291)))))
(check-sat)
(exit)
