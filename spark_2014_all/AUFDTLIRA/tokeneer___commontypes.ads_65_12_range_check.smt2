...
(define-fun dynamic_invariant ((temp___expr_315 us_t2) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (and (=> (not (= temp___skip_constant_312 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_315) (last5 temp___expr_315))) (=> (= temp___do_toplevel_313 true) (=> (= temp___is_init_311 true) (and (let ((temp___317 (of_array1 (to_array2 temp___expr_315) (first5 temp___expr_315) (last5 temp___expr_315)))) (and (let ((temp___318 (of_array (to_array1 temp___317) (first3 temp___317) (last3 temp___317)))) (and (= (first1 temp___318) 1) (<= 0 (last1 temp___318)))) (<= (last3 temp___317) 1000))) (<= 2 (length2 temp___expr_315)))))))
(define-fun dynamic_predicate ((temp___320 us_t2)) Bool (and (let ((temp___322 (of_array1 (to_array2 temp___320) (first5 temp___320) (last5 temp___320)))) (and (let ((temp___323 (of_array (to_array1 temp___322) (first3 temp___322) (last3 temp___322)))) (and (= (first1 temp___323) 1) (<= 0 (last1 temp___323)))) (<= (last3 temp___322) 1000))) (<= 2 (length2 temp___320))))
(declare-const i19s us_t2)
...
(define-fun dynamic_invariant4 ((temp___expr_265 us_t) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool (and (=> (not (= temp___skip_constant_262 true)) (dynamic_property 1 2147483647 (first1 temp___expr_265) (last1 temp___expr_265))) (=> (= temp___do_toplevel_263 true) (=> (= temp___is_init_261 true) (and (= (first1 temp___expr_265) 1) (<= 0 (last1 temp___expr_265)))))))
(define-fun dynamic_predicate1 ((temp___268 us_t)) Bool (and (= (first1 temp___268) 1) (<= 0 (last1 temp___268))))
(define-fun dynamic_invariant5 ((temp___expr_302 us_t1) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (and (=> (not (= temp___skip_constant_299 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_302) (last3 temp___expr_302))) (=> (= temp___do_toplevel_300 true) (=> (= temp___is_init_298 true) (and (let ((temp___304 (of_array (to_array1 temp___expr_302) (first3 temp___expr_302) (last3 temp___expr_302)))) (and (= (first1 temp___304) 1) (<= 0 (last1 temp___304)))) (<= (last3 temp___expr_302) 1000))))))
(define-fun dynamic_predicate2 ((temp___306 us_t1)) Bool (and (let ((temp___308 (of_array (to_array1 temp___306) (first3 temp___306) (last3 temp___306)))) (and (= (first1 temp___308) 1) (<= 0 (last1 temp___308)))) (<= (last3 temp___306) 1000)))
(declare-const temp___371 (Array Int character))
(declare-const temp___3711 t1)
(assert (dynamic_invariant i19s true false false true))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first4 (rt2 i19s))) (to_rep1 (last4 (rt2 i19s)))))
(assert (= (elts2 i19s) temp___371))
(assert (= (mk1 (to_rep1 (first4 (rt2 i19s))) (to_rep1 (last4 (rt2 i19s)))) temp___3711))
(assert (not (dynamic_property 1 2147483647 (to_rep1 (first2 temp___3711)) (to_rep1 (last2 temp___3711)))))
(check-sat)
(exit)
