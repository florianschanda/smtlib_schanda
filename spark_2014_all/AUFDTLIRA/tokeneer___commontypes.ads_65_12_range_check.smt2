...
(define-fun dynamic_invariant ((temp___expr_229 us_t) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (and (=> (not (= temp___skip_constant_227 true)) (dynamic_property 1 2147483647 (first1 temp___expr_229) (last1 temp___expr_229))) (=> (= temp___do_toplevel_228 true) (=> (= temp___is_init_226 true) (= (first1 temp___expr_229) 1)))))
(define-fun dynamic_predicate ((temp___232 us_t)) Bool (= (first1 temp___232) 1))
(declare-sort t1 0)
...
(define-fun dynamic_property2 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range1 low) (and (in_range1 high) (=> (<= low high) (and (in_range low) (in_range high))))))
...
(declare-datatypes () ((stringf1l1000ne__ref (mk_stringf1l1000ne__ref (stringf1l1000ne__content us_t2)))))
(define-fun stringf1l1000ne__ref___projection ((a stringf1l1000ne__ref)) us_t2 (stringf1l1000ne__content a))
(define-fun dynamic_invariant2 ((temp___expr_263 us_t2) (temp___is_init_260 Bool) (temp___skip_constant_261 Bool) (temp___do_toplevel_262 Bool)) Bool (and (=> (not (= temp___skip_constant_261 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_263) (last5 temp___expr_263))) (=> (= temp___do_toplevel_262 true) (=> (= temp___is_init_260 true) (and (let ((temp___265 (of_array1 (to_array2 temp___expr_263) (first5 temp___expr_263) (last5 temp___expr_263)))) (and (= (first1 (of_array (to_array1 temp___265) (first3 temp___265) (last3 temp___265))) 1) (<= (last3 temp___265) 1000))) (<= 1 (length2 temp___expr_263)))))))
(define-fun dynamic_predicate2 ((temp___268 us_t2)) Bool (and (let ((temp___270 (of_array1 (to_array2 temp___268) (first5 temp___268) (last5 temp___268)))) (and (= (first1 (of_array (to_array1 temp___270) (first3 temp___270) (last3 temp___270))) 1) (<= (last3 temp___270) 1000))) (<= 1 (length2 temp___268))))
(declare-const i17s us_t2)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant3 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range temp___expr_39)))
...
(declare-const temp___289 (Array Int character))
(declare-const temp___2891 t1)
(declare-const temp___290 (Array Int character))
(declare-const temp___2901 t1)
(declare-const temp___291 (Array Int character))
(declare-const temp___2911 t)
(assert (dynamic_invariant2 i17s true false false))
(assert (not (dynamic_property1 1 2147483647 (to_rep1 (first4 (rt2 i17s))) (to_rep1 (last4 (rt2 i17s))))))
(check-sat)
(exit)
