...
(define-fun dynamic_invariant ((temp___expr_192 Int) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool) (temp___do_typ_inv_191 Bool)) Bool (=> (or (= temp___is_init_188 true) (<= 0 255)) (in_range4 temp___expr_192)))
(declare-sort t1 0)
...
(define-fun dynamic_invariant2 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 2147483647)) (in_range5 temp___expr_222)))
...
(define-fun dynamic_invariant3 ((temp___expr_206 us_t1) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_206) (last3 temp___expr_206))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (let ((result (value this))) (and (and (and (and (= (length1 result) (length3 this)) (= (first3 result) 1)) (= (last3 result) (length3 this))) (= (< 0 (length3 this)) (not (= (empty this) true)))) (dynamic_invariant3 result true false true true)))) :pattern ((value this)))))
...
(declare-const temp___1072 (Array Int character))
(declare-const temp___10721 t1)
...
(declare-const temp___1073 (Array Int character))
(declare-const temp___10731 t)
(declare-const o7 (Array Int character))
(declare-const o8 t1)
(define-fun temp___10722 () us_t1 (mk___t1 temp___1072 temp___10721))
...
(assert (and (= temp___10722 (value right)) (and (dynamic_invariant3 temp___10722 true false true true) (and (and (= (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 right))) temp___1072) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))) temp___10721)) (and (and (and (= (length1 temp___10722) (length3 right)) (= (to_rep1 (first2 temp___10721)) 1)) (= (to_rep1 (last2 temp___10721)) (length3 right))) (= (< 0 (length3 right)) (not (= (empty right) true))))))))
(assert (=> (<= (to_rep1 (first2 temp___10721)) (to_rep1 (last2 temp___10721))) (= o1 (+ (- (to_rep1 (last2 temp___10721)) (to_rep1 (first2 temp___10721))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___10721)) (to_rep1 (last2 temp___10721)))) (= o1 0)))
(assert (= o2 (+ 1 o1)))
(assert (= o3 (+ 1 o2)))
(assert (= o4 (- o3 1)))
(assert (and (= o5 o4) (in_range2 o4)))
(assert (= (to_rep o) left))
(assert (= o6 (concat_singleton_left o 1 temp___1072 (to_rep1 (first2 temp___10721)) (to_rep1 (last2 temp___10721)))))
(assert (= o6 temp___1073))
(assert (= (mk 1 o5) temp___10731))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first temp___10731)) (to_rep1 (last temp___10731))))
(assert (= temp___1073 o7))
(assert (= (mk1 (to_rep1 (first temp___10731)) (to_rep1 (last temp___10731))) o8))
(assert (not (<= (length1 (mk___t1 o7 o8)) (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))) 1))))
(check-sat)
(exit)
