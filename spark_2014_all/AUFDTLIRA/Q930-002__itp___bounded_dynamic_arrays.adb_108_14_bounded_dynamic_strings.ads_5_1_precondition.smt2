...
(declare-fun user_eq4 (component component) Bool)
(declare-const dummy4 component)
...
(define-fun dynamic_invariant ((temp___expr_169 Int) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool)) Bool (=> (or (= temp___is_init_166 true) (<= 0 255)) (in_range4 temp___expr_169)))
(declare-sort t1 0)
...
(declare-fun user_eq6 (natural_index natural_index) Bool)
(declare-const dummy6 natural_index)
...
(assert (forall ((x natural_index)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 2147483647)) (in_range5 temp___expr_195)))
...
(define-fun dynamic_invariant3 ((temp___expr_181 us_t1) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool)) Bool (=> (not (= temp___skip_constant_179 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_181) (last3 temp___expr_181))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (let ((result (value this))) (and (and (and (and (= (length1 result) (length3 this)) (= (first3 result) 1)) (= (last3 result) (length3 this))) (= (< 0 (length3 this)) (not (= (empty this) true)))) (dynamic_invariant3 result true false true)))) :pattern ((value this)))))
...
(declare-const bounded_dynamic_strings__Oconcat__5__result natural_index)
(declare-const bounded_dynamic_strings__Oconcat__5__result1 natural_index)
(declare-const bounded_dynamic_strings__Oconcat__5__result2 (Array Int character))
(declare-const bounded_dynamic_strings__Oconcat__5__result3 t2)
(declare-const us Int)
(declare-const temp___1009 (Array Int character))
(declare-const temp___10091 t1)
...
(declare-const temp___1010 (Array Int character))
(declare-const temp___10101 t)
...
(declare-const temp___1013 (Array Int character))
(declare-const temp___10131 t1)
...
(declare-const bounded_dynamic_strings__Oconcat__5__result4 natural_index)
(declare-const bounded_dynamic_strings__Oconcat__5__result5 natural_index)
(declare-const bounded_dynamic_strings__Oconcat__5__result6 (Array Int character))
(declare-const bounded_dynamic_strings__Oconcat__5__result7 t2)
(declare-const bounded_dynamic_strings__Oconcat__5__result8 sequence__ref)
(declare-const bounded_dynamic_strings__Oconcat__5__result9 us_rep)
(declare-const bounded_dynamic_strings__Oconcat__5__result10 sequence__ref)
(declare-const bounded_dynamic_strings__Oconcat__5__result11 us_rep)
(assert (dynamic_invariant1 i52s true false true))
(assert (in_range4 left))
(assert (dynamic_invariant1 right true false true))
(assert (<= (+ 1 (length3 right)) 2147483647))
(assert (and (= us (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 right)))) (in_range5 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 right))))))
(assert (and (= (mk___t1 temp___1009 temp___10091) (value right)) (and (dynamic_invariant3 (mk___t1 temp___1009 temp___10091) true false true) (and (and (= (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 right))) temp___1009) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))) temp___10091)) (and (and (and (= (length1 (mk___t1 temp___1009 temp___10091)) (length3 right)) (= (to_rep1 (first2 temp___10091)) 1)) (= (to_rep1 (last2 temp___10091)) (length3 right))) (= (< 0 (length3 right)) (not (= (empty right) true))))))))
(assert (=> (<= (to_rep1 (first2 temp___10091)) (to_rep1 (last2 temp___10091))) (= o2 (+ (- (to_rep1 (last2 temp___10091)) (to_rep1 (first2 temp___10091))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___10091)) (to_rep1 (last2 temp___10091)))) (= o2 0)))
(assert (= o3 (+ 1 o2)))
(assert (= o4 (+ 1 o3)))
(assert (= o5 (- o4 1)))
(assert (and (= o6 o5) (in_range2 o5)))
(assert (= (to_rep o) left))
(assert (= o1 (singleton1 o 1)))
(assert (= o7 (concat1 o1 1 1 temp___1009 (to_rep1 (first2 temp___10091)) (to_rep1 (last2 temp___10091)))))
(assert (= o7 temp___1010))
(assert (= (mk 1 o6) temp___10101))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first temp___10101)) (to_rep1 (last temp___10101))))
(assert (= temp___1010 o8))
(assert (= (mk1 (to_rep1 (first temp___10101)) (to_rep1 (last temp___10101))) o9))
(assert (not (<= (length1 (mk___t1 o8 o9)) (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))) 1))))
(check-sat)
(exit)
