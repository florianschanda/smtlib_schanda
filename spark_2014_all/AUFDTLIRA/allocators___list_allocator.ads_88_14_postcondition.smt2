...
(declare-const temp___322 us_rep)
(declare-const temp___3221 us_rep1)
...
(assert (=> (not (= first_available 0)) (= (mk___rep1 (mk___split_fields1 o1 o2)) (select data o))))
...
(assert (=> (not (= first_available 0)) (= (to_rep1 o7) 1)))
(assert (=> (not (= first_available 0)) (= o7 o8)))
(assert (=> (not (= first_available 0)) (= rliteral o9)))
(assert (=> (not (= first_available 0)) (= o10 o8)))
(assert (=> (not (= first_available 0)) (= o11 o9)))
(assert (=> (not (= first_available 0)) (and (<= 1 res1) (<= res1 10000))))
(assert (=> (not (= first_available 0)) (= o12 res1)))
(assert (=> (not (= first_available 0)) (= o13 (store data o12 (mk___rep1 (mk___split_fields1 o10 o11))))))
(assert (=> (not (= first_available 0)) (= result3 (mk_map__ref data))))
(assert (=> (not (= first_available 0)) (= data2 o13)))
(assert (=> (not (= first_available 0)) (= result4 (mk_int__ref first_available))))
(assert (=> (not (= first_available 0)) (= first_available2 next_avail2)))
(assert (=> (not (= first_available 0)) (and (= o14 (remove model____split_fields 1)) (and (= (length o14) (- (length model____split_fields) 1)) (and (= (range_equal model____split_fields o14 1 (- 1 1)) true) (= (range_shifted o14 model____split_fields 1 (last o14) 1) true))))))
(assert (=> (not (= first_available 0)) (= o14 o15)))
(assert (=> (not (= first_available 0)) (= model____split_fields1 o16)))
(assert (=> (not (= first_available 0)) (= temp___320 o15)))
(assert (=> (not (= first_available 0)) (= temp___3201 o16)))
(assert (=> (not (= first_available 0)) (= result5 (mk___split_fields__ref (mk___split_fields model____split_fields model____split_fields1)))))
(assert (=> (not (= first_available 0)) (= model____split_fields4 (mk___split_fields temp___320 temp___3201))))
(assert (=> (not (= first_available 0)) (and (= o17 (add (rec__list_allocator__m__t__allocated model____split_fields4) res1)) (and (and (and (= (length1 o17) (+ (length1 (rec__list_allocator__m__t__allocated model____split_fields4)) 1)) (= (contains o17 res1) true)) (= (ole (rec__list_allocator__m__t__allocated model____split_fields4) o17) true)) (= (included_except o17 (rec__list_allocator__m__t__allocated model____split_fields4) res1) true)))))
(assert (=> (not (= first_available 0)) (= (rec__list_allocator__m__t__available model____split_fields4) o18)))
(assert (=> (not (= first_available 0)) (= o17 o19)))
(assert (=> (not (= first_available 0)) (= temp___322 o18)))
(assert (=> (not (= first_available 0)) (= temp___3221 o19)))
(assert (=> (not (= first_available 0)) (= result6 (mk___split_fields__ref model____split_fields4))))
(assert (=> (not (= first_available 0)) (= model____split_fields5 (mk___split_fields temp___322 temp___3221))))
(assert (=> (not (= first_available 0)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length (rec__list_allocator__m__t__available model____split_fields5)))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (- j 1))) (not (= (get (rec__list_allocator__m__t__available model____split_fields5) j) (get (rec__list_allocator__m__t__available model____split_fields5) k)))))))))
...
(assert (=> (not (not (= first_available 0))) (= model____split_fields5 (mk___split_fields model____split_fields model____split_fields1))))
...
(assert (=> (not (not (= first_available 0))) (= res1 res2)))
(assert (=> (not (not (= first_available 0))) (= model____split_fields5 (mk___split_fields model____split_fields2 model____split_fields3))))
...
(assert (=> (= (= (length model____split_fields) 0) true) (and (= (int__content res3) 0) (= (oeq1 (mk___rep (us_split_fields__content model____split_fields6)) (mk___rep (mk___split_fields model____split_fields model____split_fields1))) true))))
(assert (=> (not (= (= (length model____split_fields) 0) true)) (and (= (is_prepend (rec__list_allocator__m__t__available (us_split_fields__content model____split_fields6)) (int__content res3) model____split_fields) true) (= (is_add model____split_fields1 (int__content res3) (rec__list_allocator__m__t__allocated (us_split_fields__content model____split_fields6))) true))))
(assert (not (= (is_valid (map__content data3) (int__content first_available3) (us_split_fields__content model____split_fields6)) true)))
(check-sat)
(exit)
