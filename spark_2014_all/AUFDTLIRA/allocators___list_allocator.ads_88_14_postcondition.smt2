...
(assert (=> (not (= first_available 0)) (= (mk___rep (mk___split_fields o1 o2)) (select data o))))
...
(assert (=> (not (= first_available 0)) (= o14 (store data o13 (mk___rep (mk___split_fields o11 o12))))))
...
(assert (=> (not (= first_available 0)) (and (= o15 (remove model____split_fields 1)) (and (= (length o15) (- (length model____split_fields) 1)) (and (= (range_equal model____split_fields o15 1 (- 1 1)) true) (= (range_shifted o15 model____split_fields 1 (last o15) 1) true))))))
(assert (=> (not (= first_available 0)) (= o15 o16)))
(assert (=> (not (= first_available 0)) (= model____split_fields1 o17)))
(assert (=> (not (= first_available 0)) (= temp___320 o16)))
(assert (=> (not (= first_available 0)) (= temp___3201 o17)))
(assert (=> (not (= first_available 0)) (= result5 (mk___split_fields__ref1 (mk___split_fields1 model____split_fields model____split_fields1)))))
(assert (=> (not (= first_available 0)) (= model____split_fields4 (mk___split_fields1 temp___320 temp___3201))))
(assert (=> (not (= first_available 0)) (and (= o18 (add (rec__list_allocator__m__t__allocated model____split_fields4) res1)) (and (and (and (= (length1 o18) (+ (length1 (rec__list_allocator__m__t__allocated model____split_fields4)) 1)) (= (contains o18 res1) true)) (= (ole (rec__list_allocator__m__t__allocated model____split_fields4) o18) true)) (= (included_except o18 (rec__list_allocator__m__t__allocated model____split_fields4) res1) true)))))
(assert (=> (not (= first_available 0)) (= (rec__list_allocator__m__t__available model____split_fields4) o19)))
(assert (=> (not (= first_available 0)) (= o18 o20)))
(assert (=> (not (= first_available 0)) (= temp___322 o19)))
(assert (=> (not (= first_available 0)) (= temp___3221 o20)))
(assert (=> (not (= first_available 0)) (= result6 (mk___split_fields__ref1 model____split_fields4))))
(assert (=> (not (= first_available 0)) (= model____split_fields5 (mk___split_fields1 temp___322 temp___3221))))
...
(assert (=> (not (not (= first_available 0))) (= model____split_fields5 (mk___split_fields1 model____split_fields model____split_fields1))))
...
(assert (=> (not (not (= first_available 0))) (= res1 res2)))
(assert (=> (not (not (= first_available 0))) (= model____split_fields5 (mk___split_fields1 model____split_fields2 model____split_fields3))))
...
(assert (=> (= (= (length model____split_fields) 0) true) (and (= (int__content res3) 0) (= (oeq1 (mk___rep1 (us_split_fields__content1 model____split_fields6)) (mk___rep1 (mk___split_fields1 model____split_fields model____split_fields1))) true))))
(assert (=> (not (= (= (length model____split_fields) 0) true)) (and (= (is_prepend (rec__list_allocator__m__t__available (us_split_fields__content1 model____split_fields6)) (int__content res3) model____split_fields) true) (= (is_add model____split_fields1 (int__content res3) (rec__list_allocator__m__t__allocated (us_split_fields__content1 model____split_fields6))) true))))
