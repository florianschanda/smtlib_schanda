...
(assert (=> (not (= first_available 0)) (= model____split_fields4 (mk___split_fields1 temp___283 temp___2831))))
...
(assert (=> (not (= first_available 0)) (= model____split_fields5 (mk___split_fields1 temp___285 temp___2851))))
(assert (=> (not (= first_available 0)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (length (rec__list_allocator__m__t__available model____split_fields5)))) (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (- j1 1))) (not (= (get (rec__list_allocator__m__t__available model____split_fields5) j1) (get (rec__list_allocator__m__t__available model____split_fields5) k1)))))))))
...
(assert (=> (= first_available 0) (= data2 data)))
(assert (=> (= first_available 0) (= res1 res2)))
(assert (=> (= first_available 0) (= model____split_fields5 (mk___split_fields1 model____split_fields model____split_fields1))))
(assert (=> (= first_available 0) (= next_avail2 next_avail1)))
(assert (=> (= first_available 0) (= first_available2 first_available1)))
(assert (=> (= first_available 0) (= data2 data1)))
(assert (=> (= first_available 0) (= res1 res2)))
(assert (=> (= first_available 0) (= model____split_fields5 (mk___split_fields1 model____split_fields2 model____split_fields3))))
