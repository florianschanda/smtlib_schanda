...
(assert (and (= o55 (get (rec__list_allocator__m__t__allocated model____split_fields3) j)) (in_range4 o55)))
(assert (= result13 (ite (in_range7 o55) true false)))
(assert (=> (= result13 true) (and (= o51 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o51))))
(assert (=> (= result13 true) (= result14 (ite (< j o51) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o52 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o53 (get (rec__list_allocator__m__t__allocated model____split_fields3) o52)) (in_range4 o53)))))
...
(assert (=> (= result13 true) (= o47 temp___433)))
...
(assert (=> (= result12 true) (=> (< 1 j) (and (= o45 (get (rec__list_allocator__m__t__allocated model____split_fields3) o44)) (in_range4 o45)))))
...
(assert (=> (= result12 true) (= o40 temp___434)))
