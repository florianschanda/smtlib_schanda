...
(assert (=> (and (<= l i1) (<= i1 u)) (and (forall ((n Int)) (=> (and (<= l n) (<= n i2)) (= (to_rep (select a3 n)) 0))) (forall ((n Int)) (=> (and (<= 1 n) (<= n 100)) (=> (or (< n l) (< i2 n)) (= (to_rep (select a3 n)) (to_rep (select temp___160 n)))))))))
(assert (=> (and (<= l i1) (<= i1 u)) (and (and (forall ((temp___158 Int)) (=> (and (<= 1 temp___158) (<= temp___158 100)) (=> (< i2 temp___158) (= (select a3 temp___158) (select temp___157 temp___158))))) (=> (<= l u) (dynamic_property l u i2))) (and (<= l i2) (<= i2 u)))))
...
(assert (<= l n))
(assert (<= n u))
(assert (not (= (to_rep (select a8 n)) 0)))
(check-sat)
(exit)
