...
(declare-const i Int)
(declare-const temp___185 (Array Int elementtype))
(declare-const temp___184 Int)
(declare-const temp___182 (Array Int elementtype))
...
(assert (= i1 l))
(assert (=> (and (<= l i1) (<= i1 u)) (= temp___185 a)))
(assert (=> (and (<= l i1) (<= i1 u)) (= temp___184 i1)))
(assert (=> (and (<= l i1) (<= i1 u)) (= temp___182 a)))
...
(assert (=> (and (<= l i1) (<= i1 u)) (and (forall ((n Int)) (=> (and (<= l n) (<= n i2)) (= (to_rep (select a3 n)) 0))) (forall ((n Int)) (=> (and (<= 1 n) (<= n 100)) (=> (or (< n l) (< i2 n)) (= (to_rep (select a3 n)) (to_rep (select temp___185 n)))))))))
(assert (=> (and (<= l i1) (<= i1 u)) (and (and (forall ((temp___183 Int)) (=> (and (<= 1 temp___183) (<= temp___183 100)) (=> (< i2 temp___183) (= (select a3 temp___183) (select temp___182 temp___183))))) (=> (<= l u) (dynamic_property l u i2))) (and (<= l i2) (<= i2 u)))))
