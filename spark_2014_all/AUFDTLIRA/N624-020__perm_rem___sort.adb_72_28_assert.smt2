...
(assert (= hr4 o24))
(assert (not (= (let ((temp___231 (remove (remove (mk___t values2 (mk 1 100)) x) (- y 1)))) (let ((temp___230 (remove (remove (mk___t interm1 (mk 1 100)) x) (- y 1)))) (bool_eq (elts temp___230) (to_rep1 (first (rt temp___230))) (to_rep1 (last (rt temp___230))) (elts temp___231) (to_rep1 (first (rt temp___231))) (to_rep1 (last (rt temp___231)))))) true)))
(check-sat)
(exit)
