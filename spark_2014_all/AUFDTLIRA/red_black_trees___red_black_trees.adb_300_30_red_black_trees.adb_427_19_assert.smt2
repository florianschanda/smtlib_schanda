...
(assert (and (= o92 x2) (in_range2 x2)))
(assert (and (= o93 (parent (rec__red_black_trees__rbt__struct t__split_fields7) o92)) (and (in_range3 o93) (and (= o93 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7))) o92)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields7)) 0) (= o93 0))))))
(assert (= result34 (mk_int__ref x2)))
(assert (= x4 o93))
(assert (and (= o94 x4) (in_range2 x4)))
...
(assert (= result35 (mk___split_fields__ref4 t__split_fields7)))
(assert (= t__split_fields11 (mk___split_fields4 (mk___rep3 search_trees__left_rotate__t__fields) (rec__red_black_trees__rbt__color t__split_fields7))))
(assert (= (mk___rep4 t_old__split_fields7) c81b))
(assert (dynamic_invariant6 c81b true false true))
(assert (= (mk___rep4 t__split_fields11) c82b))
(assert (dynamic_invariant6 c82b true false true))
(assert (and (= red_black_trees__insert__L_8__C83b__assume x4) (in_range2 x4)))
(assert (= red_black_trees__insert__L_8__C83b__assume c83b))
(assert (in_range2 c83b))
(assert (and (= o95 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) c83b)) (and (in_range3 o95) (and (= o95 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)))) c83b)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c82b))) 0) (= o95 0))))))
(assert (and (= red_black_trees__insert__L_8__B84b__y__assume o95) (in_range2 o95)))
(assert (= red_black_trees__insert__L_8__B84b__y__assume y))
(assert (in_range2 y))
(assert (= result36 (mk_int__ref n45)))
(assert (= n61 1))
(assert (=> (and (<= 1 n61) (<= n61 100)) (= temp___794 n61)))
(assert (=> (and (<= 1 n61) (<= n61 100)) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i14))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) i14)))) n62)) (not (= i14 y))) (= (eq (select (nb_blacks c82b) i14) (select (nb_blacks c81b) i14)) true))))))
(assert (=> (and (<= 1 n61) (<= n61 100)) (=> (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) c83b)))) n62) (= (eq (select (nb_blacks c82b) y) (select (nb_blacks c81b) y)) true))))
(assert (=> (and (<= 1 n61) (<= n61 100)) (and (=> (<= 1 100) (in_range2 n62)) (and (<= 1 n62) (<= n62 100)))))
(assert (=> (and (<= 1 n61) (<= n61 100)) (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) c83b)))) n62) (= (eq (select (nb_blacks c82b) c83b) (select (nb_blacks c81b) c83b)) true))))
(assert (=> (and (<= 1 n61) (<= n61 100)) (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y))))) n62) (= (eq (select (nb_blacks c82b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y)) (select (nb_blacks c81b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y))) true))))
(assert (=> (and (<= 1 n61) (<= n61 100)) (= n62 100)))
(assert (=> (and (<= 1 n61) (<= n61 100)) (= n66 (mk_int__ref n62))))
(assert (=> (and (<= 1 n61) (<= n61 100)) (= n67 n62)))
(assert (=> (and (<= 1 n61) (<= n61 100)) (= n68 n66)))
(assert (=> (and (<= 1 n61) (<= n61 100)) (= n69 n67)))
(assert (=> (not (and (<= 1 n61) (<= n61 100))) (= n68 (mk_int__ref n61))))
(assert (=> (not (and (<= 1 n61) (<= n61 100))) (= n69 n61)))
(assert (not (= (same_nb_blacks c82b) true)))
(check-sat)
(exit)
