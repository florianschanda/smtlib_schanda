...
(assert (= n5 1))
(assert (=> (and (<= 1 n5) (<= n5 100)) (= temp___845 n5)))
(assert (=> (and (<= 1 n5) (<= n5 100)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) i)))) n6)) (not (= i y))) (= (eq (select (nb_blacks c82b) i) (select (nb_blacks c81b) i)) true))))))
...
(assert (=> (and (<= 1 n5) (<= n5 100)) (and (=> (<= 1 100) (in_range4 n6)) (and (<= 1 n6) (<= n6 100)))))
