...
(assert (= n5 1))
(assert (=> (and (<= 1 n5) (<= n5 100)) (= temp___843 n5)))
(assert (=> (and (<= 1 n5) (<= n5 100)) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) i)))) n6)) (not (= i y))) (= (eq (select (nb_blacks c82b) i) (select (nb_blacks c81b) i)) true))))))
(assert (=> (and (<= 1 n5) (<= n5 100)) (=> (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) c83b)))) n6) (= (eq (select (nb_blacks c82b) y) (select (nb_blacks c81b) y)) true))))
(assert (=> (and (<= 1 n5) (<= n5 100)) (and (=> (<= 1 100) (in_range2 n6)) (and (<= 1 n6) (<= n6 100)))))
(assert (=> (and (<= 1 n5) (<= n5 100)) (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) c83b)))) n6) (= (eq (select (nb_blacks c82b) c83b) (select (nb_blacks c81b) c83b)) true))))
(assert (=> (and (<= 1 n5) (<= n5 100)) (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y))))) n6) (= (eq (select (nb_blacks c82b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y)) (select (nb_blacks c81b) (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y))) true))))
(assert (=> (and (<= 1 n5) (<= n5 100)) (= n6 100)))
(assert (=> (and (<= 1 n5) (<= n5 100)) (= n7 (mk_int__ref n6))))
(assert (=> (and (<= 1 n5) (<= n5 100)) (= n8 n6)))
(assert (=> (and (<= 1 n5) (<= n5 100)) (= n9 n7)))
(assert (=> (and (<= 1 n5) (<= n5 100)) (= n10 n8)))
(assert (=> (not (and (<= 1 n5) (<= n5 100))) (= n9 (mk_int__ref n5))))
(assert (=> (not (and (<= 1 n5) (<= n5 100))) (= n10 n5)))
