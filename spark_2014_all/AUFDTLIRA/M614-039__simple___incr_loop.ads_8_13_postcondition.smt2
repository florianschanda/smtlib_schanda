...
(assert (forall ((i10 Int)) (=> (and (<= (to_rep a__first) i10) (<= i10 (to_rep a__last))) (< (to_rep (select a i10)) 2147483647))))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 (to_rep a__first)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= temp___181 a)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= temp___179 a)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= temp___182 a)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= temp___177 i1)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (and (forall ((k Int)) (=> (and (<= (to_rep a__first) k) (<= k (- i2 1))) (= (to_rep (select a2 k)) (+ (to_rep (select temp___181 k)) 1)))) (forall ((k Int)) (=> (and (<= i2 k) (<= k (to_rep a__last))) (= (to_rep (select a2 k)) (to_rep (select temp___182 k))))))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (and (and (=> (<= (to_rep a__first) (to_rep a__last)) (dynamic_property1 (to_rep a__first) (to_rep a__last) i2)) (forall ((temp___180 Int)) (=> (and (<= (to_rep a__first) temp___180) (<= temp___180 (to_rep a__last))) (=> (or (< (to_rep a__last) temp___180) (or (< temp___180 (to_rep a__first)) (<= i2 temp___180))) (= (select a2 temp___180) (select temp___179 temp___180)))))) (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (and (= o (+ (to_rep (select a2 i2)) 1)) (in_range1 (+ (to_rep (select a2 i2)) 1)))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= (to_rep o1) o)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= o2 (store a2 i2 o1))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= a2 result1)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= a3 o2)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= i2 (to_rep a__last))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= i2 i3)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= a3 a4)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= i4 i2)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= a5 a3)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= i9 (mk_int__ref i3))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= a10 (mk_map__ref a4))))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= i6 i4)))
(assert (=> (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last))) (= a7 a5)))
(assert (=> (not (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))) (= i1 i5)))
(assert (=> (not (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))) (= a10 (mk_map__ref a))))
(assert (=> (not (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))) (= i6 i1)))
(assert (=> (not (and (<= (to_rep a__first) i1) (<= i1 (to_rep a__last)))) (= a7 a1)))
(assert (= (mk_int__ref i7) i9))
(assert (= (mk_map__ref a8) a10))
(assert (= i8 i6))
(assert (= a9 a7))
(declare-const i10 Int)
(assert (<= (to_rep a__first) i10))
(assert (<= i10 (to_rep a__last)))
(assert (not (= (to_rep (select a8 i10)) (+ (to_rep (select a i10)) 1))))
(check-sat)
(exit)
