...
(assert (<= 1 j15))
(assert (<= j15 100))
(assert (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 t_old__split_fields4)) j15))) true))
(assert (not (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__1 (mk___rep3 t__split_fields10)) j15))) true)))
(check-sat)
(exit)
