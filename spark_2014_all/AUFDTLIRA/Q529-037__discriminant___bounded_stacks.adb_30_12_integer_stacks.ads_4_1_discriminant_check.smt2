...
(define-fun bool_eq ((a (Array Int element)) (a__first Int) (a__last Int) (b (Array Int element)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (to_rep3 (select a temp___idx_132)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_132))))))) true false))
...
(assert (forall ((a (Array Int element)) (b (Array Int element))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep3 (select a (+ i 1))) (to_rep3 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int element)) (b (Array Int element))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep3 (select b (+ i 1))) (to_rep3 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 a))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 b)))) (= (bool_eq1 (rec__integer_stacks__stack__values (us_split_fields1 a)) (rec__integer_stacks__stack__values (us_split_fields1 b))) true)) (= (to_rep (rec__integer_stacks__stack__top (us_split_fields1 a))) (to_rep (rec__integer_stacks__stack__top (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_153 us_rep) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (let ((temp___154 (rec__integer_stacks__stack__capacity (us_split_discrs1 temp___expr_153)))) (and (dynamic_property1 1 (to_rep1 temp___154) (first1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_153))) (last1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_153)))) (and (= (first1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_153))) 1) (= (last1 (rec__integer_stacks__stack__values (us_split_fields1 temp___expr_153))) (to_rep1 temp___154))))))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___134 (rec__integer_stacks__stack__values1 (us_split_fields3 a)))) (of_array (to_array1 temp___134) (first3 temp___134) (last3 temp___134))) (rec__integer_stacks__stack__top1 (us_split_fields3 a)) (hide_ext__ (rec__ext__1 (us_split_fields3 a)))) (attr__tag1 a)))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___133 (rec__integer_stacks__stack__values (us_split_fields1 r)))) (of_array1 (to_array temp___133) (first1 temp___133) (last1 temp___133))) (rec__integer_stacks__stack__top (us_split_fields1 r)) (extract__ext__ (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
(define-fun bool_eq4 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs2 a))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs2 b)))) (= (bool_eq3 (rec__integer_stacks__stack__values1 (us_split_fields3 a)) (rec__integer_stacks__stack__values1 (us_split_fields3 b))) true)) (= (to_rep (rec__integer_stacks__stack__top1 (us_split_fields3 a))) (to_rep (rec__integer_stacks__stack__top1 (us_split_fields3 b))))) true false))
(declare-const us_tag1 Int)
(define-fun in_range4 ((rec__integer_stacks__stack__capacity1 Int) (a us_rep)) Bool (= rec__integer_stacks__stack__capacity1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 a)))))
...
(declare-datatypes () ((contents__ref (mk_contents__ref (contents__content us_t3)))))
(define-fun contents__ref___projection ((a contents__ref)) us_t3 (contents__content a))
(declare-fun temp___260 (Int Int Int) us_t2)
(assert (forall ((temp___262 Int) (temp___263 Int) (temp___264 Int)) (let ((temp___261 (temp___260 temp___262 temp___263 temp___264))) (and (=> (dynamic_property6 1 2147483647 temp___263 temp___264) (and (= (first5 temp___261) temp___263) (= (last5 temp___261) temp___264))) (forall ((temp___265 Int)) (= (select (to_array2 temp___261) temp___265) (of_rep3 temp___262)))))))
...
(declare-datatypes () ((t28b__ref (mk_t28b__ref (t28b__content us_t4)))))
(define-fun t28b__ref___projection ((a t28b__ref)) us_t4 (t28b__content a))
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__integer_stacks__stack__values2 us_t4) (rec__integer_stacks__stack__top2 natural) (rec__ext__2 us_private)))))
(define-fun us_split_fields_Values__3__projection ((a us_split_fields4)) us_t4 (rec__integer_stacks__stack__values2 a))
...
(define-fun to_base1 ((a us_rep2)) us_rep (mk___rep (us_split_discrs3 a) (mk___split_fields (let ((temp___136 (rec__integer_stacks__stack__values2 (us_split_fields5 a)))) (of_array (to_array4 temp___136) (first9 temp___136) (last9 temp___136))) (rec__integer_stacks__stack__top2 (us_split_fields5 a)) (hide_ext__1 (rec__ext__2 (us_split_fields5 a)))) (attr__tag2 a)))
(define-fun of_base1 ((r us_rep)) us_rep2 (mk___rep2 (us_split_discrs1 r) (mk___split_fields2 (let ((temp___135 (rec__integer_stacks__stack__values (us_split_fields1 r)))) (of_array4 (to_array temp___135) (first1 temp___135) (last1 temp___135))) (rec__integer_stacks__stack__top (us_split_fields1 r)) (extract__ext__1 (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
(define-fun bool_eq8 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs3 a))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs3 b)))) (= (bool_eq7 (rec__integer_stacks__stack__values2 (us_split_fields5 a)) (rec__integer_stacks__stack__values2 (us_split_fields5 b))) true)) (= (to_rep (rec__integer_stacks__stack__top2 (us_split_fields5 a))) (to_rep (rec__integer_stacks__stack__top2 (us_split_fields5 b))))) true false))
...
(define-fun bool_eq9 ((x us_t5) (y us_t5)) Bool (bool_eq (elts5 x) (to_rep2 (first10 (rt5 x))) (to_rep2 (last10 (rt5 x))) (elts5 y) (to_rep2 (first10 (rt5 y))) (to_rep2 (last10 (rt5 y)))))
(declare-fun user_eq17 (us_t5 us_t5) Bool)
(declare-const dummy17 us_t5)
(declare-datatypes () ((t26b__ref (mk_t26b__ref (t26b__content us_t5)))))
(define-fun t26b__ref___projection ((a t26b__ref)) us_t5 (t26b__content a))
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__integer_stacks__stack__values3 us_t5) (rec__integer_stacks__stack__top3 natural) (rec__ext__3 us_private)))))
(define-fun us_split_fields_Values__4__projection ((a us_split_fields6)) us_t5 (rec__integer_stacks__stack__values3 a))
...
(define-fun to_base2 ((a us_rep3)) us_rep (mk___rep (us_split_discrs4 a) (mk___split_fields (let ((temp___138 (rec__integer_stacks__stack__values3 (us_split_fields7 a)))) (of_array (to_array5 temp___138) (first11 temp___138) (last11 temp___138))) (rec__integer_stacks__stack__top3 (us_split_fields7 a)) (hide_ext__2 (rec__ext__3 (us_split_fields7 a)))) (attr__tag3 a)))
(define-fun of_base2 ((r us_rep)) us_rep3 (mk___rep3 (us_split_discrs1 r) (mk___split_fields3 (let ((temp___137 (rec__integer_stacks__stack__values (us_split_fields1 r)))) (of_array5 (to_array temp___137) (first1 temp___137) (last1 temp___137))) (rec__integer_stacks__stack__top (us_split_fields1 r)) (extract__ext__2 (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
(define-fun bool_eq10 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 a))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 b)))) (= (bool_eq9 (rec__integer_stacks__stack__values3 (us_split_fields7 a)) (rec__integer_stacks__stack__values3 (us_split_fields7 b))) true)) (= (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 a))) (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 b))))) true false))
...
(assert true)
(assert true)
(assert (forall ((left us_rep) (right us_rep)) (! (= (to_int1 (oeq left right)) (to_int1 (oeq1 us_tag left right))) :pattern ((oeq1 us_tag left right)))))
(assert (forall ((left us_rep) (right us_rep)) (! (= (to_int1 (oeq left right)) (to_int1 (oeq1 us_tag1 left right))) :pattern ((oeq1 us_tag1 left right)))))
(assert (forall ((left us_rep) (right us_rep)) (! (= (to_int1 (oeq left right)) (to_int1 (oeq1 us_tag3 left right))) :pattern ((oeq1 us_tag3 left right)))))
(assert (forall ((left us_rep) (right us_rep)) (! (= (to_int1 (oeq left right)) (to_int1 (oeq1 us_tag2 left right))) :pattern ((oeq1 us_tag2 left right)))))
(assert true)
(assert true)
(assert (forall ((this us_rep)) (! (= (to_int1 (empty this)) (to_int1 (empty1 us_tag this))) :pattern ((empty1 us_tag this)))))
(assert (forall ((this us_rep)) (! (= (to_int1 (empty this)) (to_int1 (empty1 us_tag1 this))) :pattern ((empty1 us_tag1 this)))))
(assert (forall ((this us_rep)) (! (= (to_int1 (empty this)) (to_int1 (empty1 us_tag3 this))) :pattern ((empty1 us_tag3 this)))))
(assert (forall ((this us_rep)) (! (= (to_int1 (empty this)) (to_int1 (empty1 us_tag2 this))) :pattern ((empty1 us_tag2 this)))))
...
(assert true)
(assert true)
(assert (forall ((this us_rep)) (! (= (to_int1 (full this)) (to_int1 (full1 us_tag this))) :pattern ((full1 us_tag this)))))
(assert (forall ((this us_rep)) (! (= (to_int1 (full this)) (to_int1 (full1 us_tag1 this))) :pattern ((full1 us_tag1 this)))))
(assert (forall ((this us_rep)) (! (= (to_int1 (full this)) (to_int1 (full1 us_tag3 this))) :pattern ((full1 us_tag3 this)))))
(assert (forall ((this us_rep)) (! (= (to_int1 (full this)) (to_int1 (full1 us_tag2 this))) :pattern ((full1 us_tag2 this)))))
...
(define-fun dynamic_invariant4 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_142)))
...
(define-fun dynamic_property12 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range2 low) (and (in_range2 high) (=> (<= low high) (and (dynamic_property11 range_first range_last low) (dynamic_property11 range_first range_last high))))))
...
(define-fun bool_eq11 ((x us_t6) (y us_t6)) Bool (bool_eq (elts6 x) (to_rep2 (first12 (rt6 x))) (to_rep2 (last12 (rt6 x))) (elts6 y) (to_rep2 (first12 (rt6 y))) (to_rep2 (last12 (rt6 y)))))
(declare-fun user_eq20 (us_t6 us_t6) Bool)
(declare-const dummy20 us_t6)
(declare-datatypes () ((t12s__ref (mk_t12s__ref (t12s__content us_t6)))))
(define-fun t12s__ref___projection ((a t12s__ref)) us_t6 (t12s__content a))
(declare-const left us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-fun temp___218 (Int Int Int) us_t6)
(assert (forall ((temp___220 Int) (temp___221 Int) (temp___222 Int)) (let ((temp___219 (temp___218 temp___220 temp___221 temp___222))) (and (=> (dynamic_property6 1 2147483647 temp___221 temp___222) (and (= (first13 temp___219) temp___221) (= (last13 temp___219) temp___222))) (forall ((temp___223 Int)) (= (select (to_array6 temp___219) temp___223) (of_rep3 temp___220)))))))
(assert (forall ((a us_rep3) (b us_rep3)) (! (= (user_eq18 a b) (oeq (to_base2 a) (to_base2 b))) :pattern ((user_eq18 a b)))))
(define-fun dynamic_invariant5 ((temp___expr_229 us_rep3) (temp___is_init_226 Bool) (temp___skip_constant_227 Bool) (temp___do_toplevel_228 Bool)) Bool (and (=> (not (= temp___skip_constant_227 true)) (in_range7 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (to_base2 temp___expr_229))) (and (dynamic_property10 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (first11 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) (last11 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229)))) (and (= (first11 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) 1) (= (last11 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_229))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))))
(define-fun default_initial_assumption ((temp___expr_232 us_rep3) (temp___skip_top_level_233 Bool)) Bool (and (and (= (attr__tag3 temp___expr_232) us_tag3) (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_232))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (= (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_232)) (let ((temp___235 (temp___218 0 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_232)))))) (of_array5 (to_array6 temp___235) (first13 temp___235) (last13 temp___235))))) (= (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 temp___expr_232))) 0))) (=> (not (= temp___skip_top_level_233 true)) (= (empty (to_base2 temp___expr_232)) true))))
(declare-const right us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(assert (forall ((a us_rep2) (b us_rep2)) (! (= (user_eq15 a b) (oeq (to_base1 a) (to_base1 b))) :pattern ((user_eq15 a b)))))
(define-fun dynamic_invariant6 ((temp___expr_212 us_rep2) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool)) Bool (and (=> (not (= temp___skip_constant_210 true)) (in_range6 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (to_base1 temp___expr_212))) (and (dynamic_property8 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (first9 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_212))) (last9 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_212)))) (and (= (first9 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_212))) 1) (= (last9 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_212))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))))))))
(define-fun default_initial_assumption1 ((temp___expr_215 us_rep2) (temp___skip_top_level_216 Bool)) Bool (and (and (= (attr__tag2 temp___expr_215) us_tag2) (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_215))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right)))) (= (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_215)) (let ((temp___224 (temp___218 0 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_215)))))) (of_array4 (to_array6 temp___224) (first13 temp___224) (last13 temp___224))))) (= (to_rep (rec__integer_stacks__stack__top2 (us_split_fields5 temp___expr_215))) 0))) (=> (not (= temp___skip_top_level_216 true)) (= (empty (to_base1 temp___expr_215)) true))))
...
(declare-const temp___267 (Array Int element))
(declare-const temp___2671 t2)
...
(declare-const temp___268 positive)
(declare-const temp___2681 (Array Int element))
(declare-const temp___2682 t)
(declare-const temp___2683 natural)
(declare-const temp___2684 us_private)
(declare-const temp___2685 Int)
(assert (dynamic_invariant1 (mk___rep this__split_discrs (mk___split_fields (mk___t this__split_fields this__split_fields1) this__split_fields2 this__split_fields3) this__attr__tag) false false true))
(assert (= (to_rep1 (rec__integer_stacks__stack__capacity this__split_discrs)) r17b))
(assert (in_range1 r17b))
(assert (= (to_rep1 (rec__integer_stacks__stack__capacity this__split_discrs)) r20b))
(assert (in_range1 r20b))
(assert (= (to_rep o) 0))
(assert (= (to_rep2 (first4 (rt2 (temp___260 0 1 r20b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___260 0 1 r20b)))) r20b))
(assert (= (mk___t2 temp___267 temp___2671) (temp___260 0 1 r20b)))
(assert (= (ite (<= (to_rep2 (first4 temp___2671)) (to_rep2 (last4 temp___2671))) (+ (- (to_rep2 (last4 temp___2671)) (to_rep2 (first4 temp___2671))) 1) 0) (ite (<= 1 r20b) (+ (- r20b 1) 1) 0)))
(assert (= temp___267 o1))
(assert (= (mk1 (to_rep2 (first4 temp___2671)) (to_rep2 (last4 temp___2671))) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= o o5))
(assert (= us_null_ext__ o6))
(assert (= (rec__integer_stacks__stack__capacity this__split_discrs) o7))
(assert (= o8 o3))
(assert (= o9 o4))
(assert (= o10 o5))
(assert (= o11 o6))
(assert (= us_tag1 o12))
(assert (= (mk___rep (mk___split_discrs temp___268) (mk___split_fields (mk___t temp___2681 temp___2682) temp___2683 temp___2684) temp___2685) (to_base (mk___rep1 (mk___split_discrs o7) (mk___split_fields1 (mk___t1 o8 o9) o10 o11) o12))))
(assert (not (= temp___268 (rec__integer_stacks__stack__capacity this__split_discrs))))
(check-sat)
(exit)
