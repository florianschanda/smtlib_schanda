...
(declare-fun temp___288 (Int Int Int) us_t2)
...
(declare-datatypes () ((t28b__ref (mk_t28b__ref (t28b__content us_t3)))))
(define-fun t28b__ref___projection ((a t28b__ref)) us_t3 (t28b__content a))
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__integer_stacks__stack__values2 us_t3) (rec__integer_stacks__stack__top2 natural) (rec__ext__2 us_private)))))
(define-fun us_split_fields_Values__3__projection ((a us_split_fields4)) us_t3 (rec__integer_stacks__stack__values2 a))
...
(define-fun bool_eq8 ((x us_t4) (y us_t4)) Bool (bool_eq (elts4 x) (to_rep2 (first8 (rt4 x))) (to_rep2 (last8 (rt4 x))) (elts4 y) (to_rep2 (first8 (rt4 y))) (to_rep2 (last8 (rt4 y)))))
(declare-fun user_eq16 (us_t4 us_t4) Bool)
(declare-const dummy16 us_t4)
(declare-datatypes () ((t26b__ref (mk_t26b__ref (t26b__content us_t4)))))
(define-fun t26b__ref___projection ((a t26b__ref)) us_t4 (t26b__content a))
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__integer_stacks__stack__values3 us_t4) (rec__integer_stacks__stack__top3 natural) (rec__ext__3 us_private)))))
(define-fun us_split_fields_Values__4__projection ((a us_split_fields6)) us_t4 (rec__integer_stacks__stack__values3 a))
...
(define-fun to_base2 ((a us_rep3)) us_rep (mk___rep (us_split_discrs4 a) (mk___split_fields (let ((temp___160 (rec__integer_stacks__stack__values3 (us_split_fields7 a)))) (of_array (to_array4 temp___160) (first9 temp___160) (last9 temp___160))) (rec__integer_stacks__stack__top3 (us_split_fields7 a)) (hide_ext__2 (rec__ext__3 (us_split_fields7 a)))) (attr__tag3 a)))
(define-fun of_base2 ((r us_rep)) us_rep3 (mk___rep3 (us_split_discrs1 r) (mk___split_fields3 (let ((temp___159 (rec__integer_stacks__stack__values (us_split_fields1 r)))) (of_array4 (to_array temp___159) (first1 temp___159) (last1 temp___159))) (rec__integer_stacks__stack__top (us_split_fields1 r)) (extract__ext__2 (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
(define-fun bool_eq9 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 a))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 b)))) (and (= (bool_eq8 (rec__integer_stacks__stack__values3 (us_split_fields7 a)) (rec__integer_stacks__stack__values3 (us_split_fields7 b))) true) (= (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 a))) (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 b)))))) true false))
...
(define-fun dynamic_property10 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range2 low) (and (in_range2 high) (=> (<= low high) (and (in_range1 low) (in_range1 high))))))
...
(define-fun dynamic_invariant4 ((temp___expr_172 us_t5) (temp___is_init_168 Bool) (temp___skip_constant_169 Bool) (temp___do_toplevel_170 Bool) (temp___do_typ_inv_171 Bool)) Bool (=> (not (= temp___skip_constant_169 true)) (dynamic_property10 1 2147483647 (first11 temp___expr_172) (last11 temp___expr_172))))
(define-fun dynamic_invariant5 ((temp___expr_165 Int) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool) (temp___do_typ_inv_164 Bool)) Bool (=> (or (= temp___is_init_161 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_165)))
...
(declare-fun temp___245 (Int Int Int) us_t6)
(assert (forall ((temp___247 Int) (temp___248 Int) (temp___249 Int)) (let ((temp___246 (temp___245 temp___247 temp___248 temp___249))) (=> (dynamic_invariant5 temp___247 true true true true) (and (=> (dynamic_property10 1 2147483647 temp___248 temp___249) (and (= (first13 temp___246) temp___248) (= (last13 temp___246) temp___249))) (forall ((temp___250 Int)) (= (to_rep3 (select (to_array6 temp___246) temp___250)) temp___247)))))))
(assert (forall ((a us_rep1) (b us_rep1)) (! (= (user_eq9 a b) (oeq (to_base a) (to_base b))) :pattern ((user_eq9 a b)))))
(assert (forall ((temp___290 Int) (temp___291 Int) (temp___292 Int)) (let ((temp___289 (temp___288 temp___290 temp___291 temp___292))) (=> (dynamic_invariant5 temp___290 true true true true) (and (=> (dynamic_property10 1 2147483647 temp___291 temp___292) (and (= (first5 temp___289) temp___291) (= (last5 temp___289) temp___292))) (forall ((temp___293 Int)) (= (to_rep3 (select (to_array2 temp___289) temp___293)) temp___290)))))))
(declare-const left us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(assert (forall ((a us_rep3) (b us_rep3)) (! (= (user_eq17 a b) (oeq (to_base2 a) (to_base2 b))) :pattern ((user_eq17 a b)))))
(define-fun dynamic_invariant6 ((temp___expr_257 us_rep3) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (and (=> (not (= temp___skip_constant_254 true)) (in_range7 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (to_base2 temp___expr_257))) (and (dynamic_property9 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))) (first9 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257))) (last9 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257)))) (and (= (first9 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257))) 1) (= (last9 (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_257))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left))))))))
(define-fun default_initial_assumption ((temp___expr_260 us_rep3) (temp___skip_top_level_261 Bool)) Bool (and (and (= (attr__tag3 temp___expr_260) us_tag3) (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_260))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 left)))) (= (rec__integer_stacks__stack__values3 (us_split_fields7 temp___expr_260)) (let ((temp___263 (temp___245 0 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs4 temp___expr_260)))))) (of_array4 (to_array6 temp___263) (first13 temp___263) (last13 temp___263))))) (= (to_rep (rec__integer_stacks__stack__top3 (us_split_fields7 temp___expr_260))) 0))) (=> (not (= temp___skip_top_level_261 true)) (= (empty (to_base2 temp___expr_260)) true))))
(declare-const right us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(assert (forall ((a us_rep2) (b us_rep2)) (! (= (user_eq14 a b) (oeq (to_base1 a) (to_base1 b))) :pattern ((user_eq14 a b)))))
(define-fun dynamic_invariant7 ((temp___expr_239 us_rep2) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool) (temp___do_typ_inv_238 Bool)) Bool (and (=> (not (= temp___skip_constant_236 true)) (in_range6 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (to_base1 temp___expr_239))) (and (dynamic_property7 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))) (first7 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_239))) (last7 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_239)))) (and (= (first7 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_239))) 1) (= (last7 (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_239))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right))))))))
(define-fun default_initial_assumption1 ((temp___expr_242 us_rep2) (temp___skip_top_level_243 Bool)) Bool (and (and (= (attr__tag2 temp___expr_242) us_tag2) (and (and (= (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_242))) (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs1 right)))) (= (rec__integer_stacks__stack__values2 (us_split_fields5 temp___expr_242)) (let ((temp___251 (temp___245 0 1 (to_rep1 (rec__integer_stacks__stack__capacity (us_split_discrs3 temp___expr_242)))))) (of_array3 (to_array6 temp___251) (first13 temp___251) (last13 temp___251))))) (= (to_rep (rec__integer_stacks__stack__top2 (us_split_fields5 temp___expr_242))) 0))) (=> (not (= temp___skip_top_level_243 true)) (= (empty (to_base1 temp___expr_242)) true))))
...
(declare-const temp___295 (Array Int element))
(declare-const temp___2951 t2)
...
(declare-const temp___296 positive)
(declare-const temp___2961 (Array Int element))
(declare-const temp___2962 t)
(declare-const temp___2963 natural)
(declare-const temp___2964 us_private)
(declare-const temp___2965 Int)
(assert (dynamic_invariant1 (mk___rep this__split_discrs (mk___split_fields (mk___t this__split_fields this__split_fields1) this__split_fields2 this__split_fields3) this__attr__tag) false false true true))
...
(assert (= (to_rep o) 0))
(assert (= (to_rep2 (first4 (rt2 (temp___288 0 1 r20b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___288 0 1 r20b)))) r20b))
(assert (= (mk___t2 temp___295 temp___2951) (temp___288 0 1 r20b)))
(assert (= (ite (<= (to_rep2 (first4 temp___2951)) (to_rep2 (last4 temp___2951))) (+ (- (to_rep2 (last4 temp___2951)) (to_rep2 (first4 temp___2951))) 1) 0) (ite (<= 1 r20b) (+ (- r20b 1) 1) 0)))
(assert (= temp___295 o1))
(assert (= (mk1 (to_rep2 (first4 temp___2951)) (to_rep2 (last4 temp___2951))) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= o o5))
...
(assert (= o11 o6))
(assert (= us_tag1 o12))
(assert (= (mk___rep (mk___split_discrs temp___296) (mk___split_fields (mk___t temp___2961 temp___2962) temp___2963 temp___2964) temp___2965) (to_base (mk___rep1 (mk___split_discrs o7) (mk___split_fields1 (mk___t1 o8 o9) o10 o11) o12))))
(assert (not (= temp___296 (rec__integer_stacks__stack__capacity this__split_discrs))))
(check-sat)
(exit)
