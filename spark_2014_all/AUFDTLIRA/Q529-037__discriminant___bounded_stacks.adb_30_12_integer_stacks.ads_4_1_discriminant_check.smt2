...
(declare-const usq_ positive)
(declare-const usq_1 (Array Int element))
(declare-const usq_2 t)
(declare-const usq_3 natural)
(declare-const usq_4 us_private)
(declare-const usq_5 Int)
(declare-const temp___270 positive)
(declare-const temp___2701 (Array Int element))
(declare-const temp___2702 t)
(declare-const temp___2703 natural)
(declare-const temp___2704 us_private)
(declare-const temp___2705 Int)
(declare-const result us_split_fields__ref)
(declare-const this__split_fields4 us_split_fields)
(declare-const this__split_fields5 us_split_fields__ref)
(declare-const this__split_fields6 us_split_fields)
