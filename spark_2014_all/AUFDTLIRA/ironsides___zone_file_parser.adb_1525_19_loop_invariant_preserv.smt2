...
(assert (and (=> (<= r97b r98b) (dynamic_property r97b r98b i2)) (and (<= r97b i2) (<= i2 r98b))))
(assert (= (to_rep o5) (to_rep (select zonefileline i2))))
(assert (and (= o3 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o4 (- o3 begidx11)))
(assert (and (= temp___1791 o4) (in_range1 o4)))
(assert (and (<= 1 temp___1791) (<= temp___1791 128)))
(assert (= o6 temp___1791))
(assert (= o7 (store newnameserver2 o6 o5)))
(assert (= result7 (mk_map__ref newnameserver2)))
(assert (= newnameserver3 o7))
(assert (not (= i2 r98b)))
(assert (= result8 (mk_int__ref i2)))
(assert (= i3 (+ i2 1)))
(assert (= i4 (mk_int__ref i3)))
(assert (= newnameserver4 (mk_map__ref newnameserver3)))
(assert (= i5 i3))
(assert (= newnameserver5 newnameserver3))
