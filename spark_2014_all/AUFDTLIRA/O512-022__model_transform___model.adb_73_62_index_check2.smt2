...
(declare-const t Int)
(declare-const temp___489 (Array Int us_rep))
(declare-const temp___490 (Array Int us_rep1))
...
(declare-const temp___491 (Array Int us_rep))
(declare-const temp___492 (Array Int us_rep1))
...
(assert (=> (and (<= 0 s2) (<= s2 100)) (= o27 (select temp___475 s3))))
...
(assert (<= 0 t))
(assert (<= t (- s9 1)))
(assert (and (= o17 t) (in_range4 t)))
(assert (= o18 (select cfv2 o17)))
(assert (and (= o19 (to__2 o18)) (and (in_range3 o19) (= o19 (to_rep2 (rec__model__uml_control_flow__to_data (us_split_fields9 o18)))))))
...
(assert (and (= temp___491 (owned_state sm)) (= temp___491 (rec__model__uml_state_machine__owned_state_data (us_split_fields5 sm)))))
(assert (and (= temp___492 (owned_transition sm)) (= temp___492 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm)))))
(assert (and (<= 0 t) (<= t 100)))
(assert (= o12 t))
(assert (= o24 (select temp___492 o12)))
(assert (and (= o15 (to__ o24)) (and (in_range2 o15) (= o15 (to_rep1 o14)))))
(assert (= o16 (select temp___491 o15)))
...
(assert (and (= o6 t) (in_range4 t)))
(assert (= o26 (select cfv2 o6)))
(assert (and (= o9 (from__2 o26)) (and (in_range3 o9) (= o9 (to_rep2 o7)))))
(assert (= o25 (select (map__content2 av6) o9)))
(assert (and (= o11 (name__2 o25)) (and (in_range1 o11) (= o11 (to_rep o10)))))
(assert (and (= temp___489 (owned_state sm)) (= temp___489 (rec__model__uml_state_machine__owned_state_data (us_split_fields5 sm)))))
(assert (and (= temp___490 (owned_transition sm)) (= temp___490 (rec__model__uml_state_machine__owned_transition_data (us_split_fields5 sm)))))
(assert (not (<= 0 t)))
(check-sat)
(exit)
