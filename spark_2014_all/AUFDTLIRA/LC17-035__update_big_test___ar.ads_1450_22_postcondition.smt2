...
(assert (forall ((temp___3042 (Array Int et1))) (forall ((temp___3043 Int) (temp___3044 Int)) (let ((temp___3041 (temp___3040 temp___3042 temp___3043 temp___3044))) (forall ((temp___3045 Int)) (ite (= temp___3045 temp___3043) (= (select temp___3041 temp___3045) (of_rep temp___3044)) (= (select temp___3041 temp___3045) (select temp___3042 temp___3045))))))))
...
(assert (not (= (bool_eq r__split_fields6 1 10 (temp___3040 r__split_fields i e) 1 10) true)))
(check-sat)
(exit)
