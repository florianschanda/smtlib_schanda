...
(assert (and (and (and (= (mk_int__ref result) (mk_int__ref current_candidate)) (= current_candidate1 0)) (and (in_range7 current_candidate1) (and (=> (<= 0 2147483647) (in_range4 last6)) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 candidates)) (= candidates1 (temp___616 (temp___620 32)))) (and (and (and (forall ((temp___626 Int)) (ite (and (<= 1 temp___626) (<= temp___626 7)) (= (select o temp___626) (select no_vote_entry temp___626)) (= (select o temp___626) (select (select candidates1 0) temp___626)))) (= o1 (store candidates1 0 o))) (and (= candidates1 result2) (= candidates2 o1))) (and (and (and (and (= o2 (end_of_file file)) (= o3 (ite (not (= o2 true)) true false))) (= result3 (ite (= o3 true) (ite (< current_candidate1 20) true false) false))) (ite (= result3 true) (and (and (and (= temp___643 current_candidate1) (and (= temp___640 candidates2) (and (= temp___639 item) (and (= temp___638 last6) (and (and (and (= o4 (+ current_candidate1 1)) (in_range7 (+ current_candidate1 1))) (and (= current_candidate1 result4) (= current_candidate2 o4))) (and (forall ((i2 Int)) (=> (and (<= current_candidate3 i2) (<= i2 20)) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 70)) (= (to_rep (select (select candidates3 i2) j2)) 32))))) (and (and (and (=> (<= 0 2147483647) (in_range4 last8)) (forall ((temp___641 Int)) (=> (and (<= 0 temp___641) (<= temp___641 20)) (forall ((temp___642 Int)) (=> (and (<= 1 temp___642) (<= temp___642 70)) (=> (< temp___642 1) (= (select (select candidates3 temp___641) temp___642) (select (select temp___640 temp___641) temp___642)))))))) (=> (<= 0 20) (in_range7 current_candidate3))) (and (and (and (= (to_rep1 o6) 70) (and (= (to_rep1 o5) 1) (in_range4 last9))) (and (= item2 result5) (= item3 (slide ada__text_io__get_line__item (to_rep1 (first (mk 1 70))) 1)))) (and (and (= last9 r17b) (in_range4 r17b)) (and (and (= last9 r20b) (in_range4 r20b)) (and (and (and (and (and (and (and (and (=> (<= 1 r20b) (and (and (<= 1 1) (<= 1 70)) (and (<= 1 r20b) (<= r20b 70)))) (= o7 item3)) (and (= o7 temp___630) (= (mk2 1 r20b) temp___6301))) (and (= (ite (<= (to_rep1 (first4 temp___6301)) (to_rep1 (last4 temp___6301))) (+ (- (to_rep1 (last4 temp___6301)) (to_rep1 (first4 temp___6301))) 1) 0) (ite (<= 1 r17b) (+ (- r17b 1) 1) 0)) (and (= temp___630 temp___631) (= (mk1 (to_rep1 (first4 temp___6301)) (to_rep1 (last4 temp___6301))) temp___6311)))) (and (and (and (=> (<= 1 r17b) (and (and (<= 1 1) (<= 1 70)) (and (<= 1 r17b) (<= r17b 70)))) (= o8 (select candidates3 current_candidate3))) (and (= o8 temp___634) (= (mk1 1 r17b) temp___6341))) (and (= (ite (<= (to_rep1 (first2 temp___6311)) (to_rep1 (last2 temp___6311))) (+ (- (to_rep1 (last2 temp___6311)) (to_rep1 (first2 temp___6311))) 1) 0) (ite (<= (to_rep1 (first2 temp___6341)) (to_rep1 (last2 temp___6341))) (+ (- (to_rep1 (last2 temp___6341)) (to_rep1 (first2 temp___6341))) 1) 0)) (= (mk___t1 temp___636 temp___6361) (mk___t1 temp___631 temp___6311))))) (forall ((temp___637 Int)) (ite (and (<= 1 temp___637) (<= temp___637 r17b)) (= (select o9 temp___637) (select temp___636 temp___637)) (= (select o9 temp___637) (select (select candidates3 current_candidate3) temp___637))))) (= o10 (store candidates3 current_candidate3 o9))) (and (= candidates3 result6) (= candidates4 o10))) (and (and (and (and (= o11 (end_of_file file)) (= o12 (ite (not (= o11 true)) true false))) (= o13 (ite (= o12 true) (ite (< current_candidate3 20) true false) false))) (= result7 (ite (not (= o13 true)) true false))) (= result7 true))))))))))))) (and (and (= item6 (mk_map__ref item3)) (and (= last12 (mk_int__ref last9)) (and (= current_candidate7 (mk_int__ref current_candidate3)) (= candidates7 (mk_map__ref1 candidates4))))) (and (= item7 item3) (and (= last13 last9) (and (= current_candidate8 current_candidate3) (= candidates8 candidates4)))))) (and (and (= item8 item6) (and (= last14 last12) (and (= current_candidate9 current_candidate7) (= candidates9 candidates7)))) (and (= item9 item7) (and (= last15 last13) (and (= current_candidate10 current_candidate8) (= candidates10 candidates8)))))) (and (and (= item8 (mk_map__ref item)) (and (= last14 (mk_int__ref last6)) (and (= current_candidate9 (mk_int__ref current_candidate1)) (= candidates9 (mk_map__ref1 candidates2))))) (and (= item9 item1) (and (= last15 last7) (and (= current_candidate10 current_candidate1) (= candidates10 candidates2))))))) (and (= result9 (mk_int__ref last_candidate)) (= last_candidate1 (int__content current_candidate9))))))))) (and (and (= item10 item8) (and (= last16 last14) (and (= current_candidate11 current_candidate9) (and (= file2 (mk_file_type__ref file1)) (and (= last_candidate2 (mk_int__ref last_candidate1)) (= candidates11 candidates9)))))) (and (= item11 item9) (and (= last17 last15) (and (= current_candidate12 current_candidate10) (and (= file3 file1) (and (= last_candidate3 last_candidate1) (= candidates12 candidates10)))))))))
(declare-const i2 Int)
(assert (<= (+ (int__content last_candidate2) 1) i2))
(assert (<= i2 20))
(declare-const j2 Int)
(assert (<= 1 j2))
(assert (<= j2 70))
(assert (not (= (to_rep (select (select (map__content1 candidates11) i2) j2)) 32)))
(check-sat)
(exit)
