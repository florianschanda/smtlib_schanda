...
(assert (=> (= result3 true) (and (and (=> (<= 0 2147483647) (in_range4 last8)) (forall ((temp___647 Int)) (=> (and (<= 0 temp___647) (<= temp___647 20)) (forall ((temp___648 Int)) (=> (and (<= 1 temp___648) (<= temp___648 70)) (=> (< temp___648 1) (= (select (select candidates3 temp___647) temp___648) (select (select temp___646 temp___647) temp___648)))))))) (=> (<= 0 20) (in_range7 current_candidate3)))))
...
(assert (=> (= result3 true) (= (ite (<= (to_rep1 (first4 temp___6361)) (to_rep1 (last4 temp___6361))) (+ (- (to_rep1 (last4 temp___6361)) (to_rep1 (first4 temp___6361))) 1) 0) (ite (<= 1 r17b) (+ (- r17b 1) 1) 0))))
(assert (=> (= result3 true) (= temp___636 temp___637)))
(assert (=> (= result3 true) (= (mk1 (to_rep1 (first4 temp___6361)) (to_rep1 (last4 temp___6361))) temp___6371)))
...
(assert (=> (= result3 true) (= (ite (<= (to_rep1 (first2 temp___6371)) (to_rep1 (last2 temp___6371))) (+ (- (to_rep1 (last2 temp___6371)) (to_rep1 (first2 temp___6371))) 1) 0) (ite (<= (to_rep1 (first2 temp___6401)) (to_rep1 (last2 temp___6401))) (+ (- (to_rep1 (last2 temp___6401)) (to_rep1 (first2 temp___6401))) 1) 0))))
(assert (=> (= result3 true) (= (mk___t1 temp___642 temp___6421) (mk___t1 temp___637 temp___6371))))
(assert (=> (= result3 true) (forall ((temp___643 Int)) (ite (and (<= 1 temp___643) (<= temp___643 r17b)) (= (select o9 temp___643) (select temp___642 temp___643)) (= (select o9 temp___643) (select (select candidates3 current_candidate3) temp___643))))))
