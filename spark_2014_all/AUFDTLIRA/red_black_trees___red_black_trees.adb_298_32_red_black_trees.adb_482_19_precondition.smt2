...
(assert (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) c102b)))) n99) (= (eq (select (nb_blacks c101b) c102b) (select (nb_blacks c100b) c102b)) true)))
(assert (and (= temp___638 (nb_blacks c100b)) (and (= (bool_eq11 (select temp___638 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___638 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___638 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___638 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___638 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___638 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___638 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___638 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___638 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___638 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c100b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___638 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i14 0))))))))))))))
(assert (and (= o310 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)) y2)) (and (in_range3 o310) (and (= o310 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)))) y2)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c101b))) 0) (= o310 0))))))
(assert (= o311 (select temp___638 o310)))
(assert (= o312 (us_split_fields11 o311)))
(assert (= o313 (rec__red_black_trees__black_count__depth o312)))
(assert (= o314 (to_rep o313)))
(assert (= result77 (ite (<= o314 n99) true false)))
(assert (= result77 true))
(assert (not (not (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) 0))))
(check-sat)
(exit)
