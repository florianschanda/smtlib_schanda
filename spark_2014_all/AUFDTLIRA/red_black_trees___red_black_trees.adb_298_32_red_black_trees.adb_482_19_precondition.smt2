...
(declare-const o29 us_rep7)
(declare-const o30 us_split_fields10)
...
(assert (and (= o25 (parent (rec__red_black_trees__rbt__struct t__split_fields7) o24)) (and (in_range3 o25) (and (= o25 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields7))) o24)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields7)) 0) (= o25 0))))))
(assert (= result10 (mk_int__ref x2)))
(assert (= x3 o25))
(assert (and (= o26 x3) (in_range2 x3)))
...
(assert (= result11 (mk___split_fields__ref4 t__split_fields7)))
(assert (= t__split_fields8 (mk___split_fields4 (mk___rep3 search_trees__right_rotate__t__fields) (rec__red_black_trees__rbt__color t__split_fields7))))
(assert (= (mk___rep4 t_old__split_fields7) c100b))
(assert (dynamic_invariant6 c100b true false true true))
(assert (= (mk___rep4 t__split_fields8) c101b))
(assert (dynamic_invariant6 c101b true false true true))
(assert (and (= red_black_trees__insert__L_8__C102b__assume x3) (in_range2 x3)))
(assert (= red_black_trees__insert__L_8__C102b__assume c102b))
(assert (in_range2 c102b))
(assert (and (= o27 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)) c102b)) (and (in_range3 o27) (and (= o27 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)))) c102b)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c101b))) 0) (= o27 0))))))
(assert (and (= red_black_trees__insert__L_8__B103b__y__assume o27) (in_range2 o27)))
(assert (= red_black_trees__insert__L_8__B103b__y__assume y2))
(assert (in_range2 y2))
(assert (= result12 (mk_int__ref n4)))
(assert (= n5 1))
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) i)))) n6)) (not (= i y2))) (= (eq (select (nb_blacks c101b) i) (select (nb_blacks c100b) i)) true)))))
(assert (=> (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) c102b)))) n6) (= (eq (select (nb_blacks c101b) y2) (select (nb_blacks c100b) y2)) true)))
(assert (and (=> (<= 1 100) (in_range2 n6)) (and (<= 1 n6) (<= n6 100))))
(assert (=> (<= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c100b) c102b)))) n6) (= (eq (select (nb_blacks c101b) c102b) (select (nb_blacks c100b) c102b)) true)))
(assert (and (= temp___687 (nb_blacks c100b)) (and (= (bool_eq11 (select temp___687 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c100b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___687 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___687 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___687 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___687 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___687 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___687 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___687 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___687 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___687 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c100b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___687 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c100b)) i 0))))))))))))))
(assert (and (= o28 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)) y2)) (and (in_range3 o28) (and (= o28 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c101b)))) y2)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c101b))) 0) (= o28 0))))))
(assert (= o29 (select temp___687 o28)))
(assert (= o30 (us_split_fields11 o29)))
(assert (= o31 (rec__red_black_trees__black_count__depth o30)))
(assert (= o32 (to_rep o31)))
(assert (= result13 (ite (<= o32 n6) true false)))
