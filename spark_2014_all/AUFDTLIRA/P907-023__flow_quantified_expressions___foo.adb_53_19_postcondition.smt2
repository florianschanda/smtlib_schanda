...
(declare-const i Int)
(declare-const temp___193 (Array Int us_rep))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___193 a)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___192 i1)))
...
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (=> (<= 1 10) (in_range2 i2)) (forall ((temp___194 Int)) (=> (and (<= 1 temp___194) (<= temp___194 10)) (=> (< i2 temp___194) (= (select a3 temp___194) (select temp___193 temp___194)))))) (and (<= 1 i2) (<= i2 10)))))
