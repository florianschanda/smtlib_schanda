...
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (=> (<= 1 10) (in_range2 i2)) (forall ((temp___168 Int)) (=> (and (<= 1 temp___168) (<= temp___168 10)) (=> (< i2 temp___168) (= (select a3 temp___168) (select temp___167 temp___168)))))) (and (<= 1 i2) (<= i2 10)))))
