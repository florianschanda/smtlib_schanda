...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (= temp___167 a) (and (= temp___166 i1) (and (and (= (mk_map__ref result1) (mk_map__ref a)) (= a2 (store a i1 (mk___rep (mk___split_fields (ite (= (rec__foo__r__x (us_split_fields1 (select a i1))) false) (ite (not (= (rec__foo__r__x (us_split_fields1 (select a i1))) true)) true false) true)))))) (and (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i2)) (= (rec__foo__r__x (us_split_fields1 (select a3 j1))) true))) (and (and (and (=> (<= 1 10) (in_range2 i2)) (forall ((temp___168 Int)) (=> (and (<= 1 temp___168) (<= temp___168 10)) (=> (< i2 temp___168) (= (select a3 temp___168) (select temp___167 temp___168)))))) (and (<= 1 i2) (<= i2 10))) (= i2 10)))))) (and (and (= i2 i6) (= a3 a7)) (and (= i7 i2) (= a8 a3))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_map__ref a9) (mk_map__ref a7))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= i9 i7)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= a10 a8)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= i1 i8)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= (mk_map__ref a9) (mk_map__ref a))))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= i9 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= a10 a1)))
(assert (= i10 i8))
...
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (= (rec__foo__r__x (us_split_fields1 (select a11 n))) true)))
(check-sat)
(exit)
