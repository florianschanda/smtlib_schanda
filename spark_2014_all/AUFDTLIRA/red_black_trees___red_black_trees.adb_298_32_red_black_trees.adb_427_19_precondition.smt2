...
(assert (<= 1 n5))
(assert (<= n5 100))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c81b) i)))) n6)) (not (= i y))) (= (eq (select (nb_blacks c82b) i) (select (nb_blacks c81b) i)) true)))))
...
(assert (and (= temp___839 (nb_blacks c81b)) (and (= (bool_eq11 (select temp___839 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) (of_rep 0) (of_rep 0)))) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c81b))) i))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___839 i))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___839 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___839 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___839 i)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___839 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___839 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___839 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___839 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___839 i)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c81b)) i)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___839 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c81b)) i 0))))))))))))))
(assert (and (= o28 (parent (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)) y)) (and (in_range3 o28) (and (= o28 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct (us_split_fields9 c82b)))) y)) (=> (= (size (rec__red_black_trees__rbt__struct (us_split_fields9 c82b))) 0) (= o28 0))))))
(assert (= o29 (select temp___839 o28)))
