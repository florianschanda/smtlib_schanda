...
(assert (not (= (ite (<= (to_rep1 (first8 temp___20721)) (to_rep1 (last8 temp___20721))) (+ (- (to_rep1 (last8 temp___20721)) (to_rep1 (first8 temp___20721))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 3)) 1) 0))))
(check-sat)
(exit)
