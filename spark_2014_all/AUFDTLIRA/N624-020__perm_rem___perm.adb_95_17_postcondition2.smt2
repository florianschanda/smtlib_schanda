...
(assert (= ih (induction_hypothesis (remove a (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w)))) (remove b (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w)))))))
...
(declare-const perm__perm_symmetric__induction_hypothesis__result3 Int)
(declare-const perm__perm_symmetric__induction_hypothesis__result4 Int)
(declare-const perm__perm_symmetric__induction_hypothesis__result5 Int)
(declare-const perm__perm_symmetric__induction_hypothesis__result6 Int)
(declare-const perm__perm_symmetric__induction_hypothesis__result7 Int)
(declare-const perm__perm_symmetric__induction_hypothesis__result8 Int)
(declare-const perm__perm_symmetric__induction_hypothesis__result9 Int)
(define-fun perm__perm_symmetric__induction_hypothesis__result10 () int__ref (mk_int__ref perm__perm_symmetric__induction_hypothesis__result6))
...
(assert (or (and (and (= perm__perm_symmetric__induction_hypothesis__result2 perm__perm_symmetric__induction_hypothesis__result6) (= perm__perm_symmetric__induction_hypothesis__result7 perm__perm_symmetric__induction_hypothesis__result2)) (and (= (length a) 0) (and (= (mk_int__ref result) (mk_int__ref perm__perm_symmetric__induction_hypothesis__result)) (= perm__perm_symmetric__induction_hypothesis__result2 1)))) (and (and (not (= (length a) 0)) (and (= perm__perm_symmetric__induction_hypothesis__result2 perm__perm_symmetric__induction_hypothesis__result) (= perm__perm_symmetric__induction_hypothesis__result2 perm__perm_symmetric__induction_hypothesis__result1))) (and (and (= perm__perm_symmetric__induction_hypothesis__result10 (mk_int__ref perm__perm_symmetric__induction_hypothesis__result4)) (= perm__perm_symmetric__induction_hypothesis__result7 perm__perm_symmetric__induction_hypothesis__result5)) (and (and (= perm__perm_symmetric__induction_hypothesis__result3 perm__perm_symmetric__induction_hypothesis__result4) (= perm__perm_symmetric__induction_hypothesis__result5 perm__perm_symmetric__induction_hypothesis__result3)) (and (and (and (= perm__perm_symmetric__induction_hypothesis__B_4__w__assume2 (get_witnesses a b)) (and (and (<= (to_rep1 (first (rt a))) (to_rep2 perm__perm_symmetric__induction_hypothesis__B_4__w__assume)) (<= (to_rep2 perm__perm_symmetric__induction_hypothesis__B_4__w__assume) (to_rep1 (last (rt a))))) (and (and (<= (to_rep1 (first (rt b))) (to_rep2 perm__perm_symmetric__induction_hypothesis__B_4__w__assume1)) (<= (to_rep2 perm__perm_symmetric__induction_hypothesis__B_4__w__assume1) (to_rep1 (last (rt b))))) (and (= (to_rep (select (elts a) (to_rep2 perm__perm_symmetric__induction_hypothesis__B_4__w__assume))) (to_rep (select (elts b) (to_rep2 perm__perm_symmetric__induction_hypothesis__B_4__w__assume1)))) (= (is_perm (remove a (to_rep2 perm__perm_symmetric__induction_hypothesis__B_4__w__assume)) (remove b (to_rep2 perm__perm_symmetric__induction_hypothesis__B_4__w__assume1))) true))))) (= perm__perm_symmetric__induction_hypothesis__B_4__w__assume2 w)) (and (and (and (and (= o4 (remove b (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))))) (and (dynamic_invariant o4 true false true true) (and (= (invariant__ o4) true) (and (= (to_rep1 (last o3)) (- (to_rep1 (last (rt b))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1))) (= (to_rep (select (elts b) k)) (to_rep (select o2 k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) 1) k) (<= k (to_rep1 (last (rt b))))) (= (to_rep (select (elts b) k)) (to_rep (select o2 (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))) k) (<= k (- (to_rep1 (last (rt b))) 1))) (= (to_rep (select (elts b) (+ k 1))) (to_rep (select o2 k))))))))))) (and (and (= o5 (remove a (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))))) (and (dynamic_invariant o5 true false true true) (and (= (invariant__ o5) true) (and (= (to_rep1 (last o1)) (- (to_rep1 (last (rt a))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1))) (= (to_rep (select (elts a) k)) (to_rep (select o k))))) (and (forall ((k Int)) (=> (and (<= (+ (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) 1) k) (<= k (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) k)) (to_rep (select o (- k 1)))))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w))) k) (<= k (- (to_rep1 (last (rt a))) 1))) (= (to_rep (select (elts a) (+ k 1))) (to_rep (select o k))))))))))) (and (= perm__perm_symmetric__induction_hypothesis__B_4__ih__assume (induction_hypothesis o5 o4)) (and (in_range4 perm__perm_symmetric__induction_hypothesis__B_4__ih__assume) (=> (= (distinct perm__perm_symmetric__induction_hypothesis__B_4__ih__assume 0) true) (= (is_perm o4 o5) true)))))) (= perm__perm_symmetric__induction_hypothesis__B_4__ih__assume ih)) (and (in_range4 ih) (and (= (distinct ih 0) true) (and (= (to_rep (select (elts b) (to_rep2 (rec__perm__witnesses__ib (us_split_fields1 w))))) (to_rep (select (elts a) (to_rep2 (rec__perm__witnesses__ia (us_split_fields1 w)))))) (and (= perm__perm_symmetric__induction_hypothesis__result2 result1) (= perm__perm_symmetric__induction_hypothesis__result3 ih))))))))))))
(assert (= (mk_int__ref perm__perm_symmetric__induction_hypothesis__result8) perm__perm_symmetric__induction_hypothesis__result10))
(assert (= perm__perm_symmetric__induction_hypothesis__result9 perm__perm_symmetric__induction_hypothesis__result7))
(assert (= result2 perm__perm_symmetric__induction_hypothesis__result8))
(assert (= (distinct perm__perm_symmetric__induction_hypothesis__result8 0) true))
(assert (not (= (is_perm b a) true)))
(check-sat)
(exit)
