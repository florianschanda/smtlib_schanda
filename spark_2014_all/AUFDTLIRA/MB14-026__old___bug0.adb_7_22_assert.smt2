...
(assert (= old__1 s))
(assert (= (to_rep1 old____first) (to_rep1 (first (mk (to_rep1 s__first) (to_rep1 s__last))))))
(assert (= (to_rep1 old____last) (to_rep1 (last (mk (to_rep1 s__first) (to_rep1 s__last))))))
(assert (dynamic_property 1 2147483647 (to_rep1 old____first) (to_rep1 old____last)))
(assert (not (= (bool_eq old__1 (to_rep1 old____first) (to_rep1 old____last) s (to_rep1 s__first) (to_rep1 s__last)) true)))
(check-sat)
(exit)
