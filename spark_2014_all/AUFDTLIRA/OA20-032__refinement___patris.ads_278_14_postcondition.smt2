...
(define-fun dynamic_invariant1 ((temp___expr_2185 Int) (temp___is_init_2181 Bool) (temp___skip_constant_2182 Bool) (temp___do_toplevel_2183 Bool) (temp___do_typ_inv_2184 Bool)) Bool (=> (or (= temp___is_init_2181 true) (<= 0 4)) (in_range8 temp___expr_2185)))
...
(define-fun dynamic_invariant2 ((temp___expr_2264 Int) (temp___is_init_2260 Bool) (temp___skip_constant_2261 Bool) (temp___do_toplevel_2262 Bool) (temp___do_typ_inv_2263 Bool)) Bool (=> (or (= temp___is_init_2260 true) (<= 0 4)) (in_range9 temp___expr_2264)))
...
(define-fun dynamic_invariant5 ((temp___expr_2094 Int) (temp___is_init_2090 Bool) (temp___skip_constant_2091 Bool) (temp___do_toplevel_2092 Bool) (temp___do_typ_inv_2093 Bool)) Bool (=> (or (= temp___is_init_2090 true) (<= 1 7)) (in_range4 temp___expr_2094)))
...
(define-fun dynamic_invariant7 ((temp___expr_2115 Int) (temp___is_init_2111 Bool) (temp___skip_constant_2112 Bool) (temp___do_toplevel_2113 Bool) (temp___do_typ_inv_2114 Bool)) Bool (=> (or (= temp___is_init_2111 true) (<= 1 20)) (in_range11 temp___expr_2115)))
(assert true)
...
(define-fun dynamic_invariant8 ((temp___expr_2153 Int) (temp___is_init_2149 Bool) (temp___skip_constant_2150 Bool) (temp___do_toplevel_2151 Bool) (temp___do_typ_inv_2152 Bool)) Bool (=> (or (= temp___is_init_2149 true) (<= (- 1) 9)) (in_range5 temp___expr_2153)))
(define-fun dynamic_invariant9 ((temp___expr_2160 Int) (temp___is_init_2156 Bool) (temp___skip_constant_2157 Bool) (temp___do_toplevel_2158 Bool) (temp___do_typ_inv_2159 Bool)) Bool (=> (or (= temp___is_init_2156 true) (<= (- 1) 19)) (in_range6 temp___expr_2160)))
(define-fun dynamic_invariant10 ((temp___expr_2167 Int) (temp___is_init_2163 Bool) (temp___skip_constant_2164 Bool) (temp___do_toplevel_2165 Bool) (temp___do_typ_inv_2166 Bool)) Bool (=> (or (= temp___is_init_2163 true) (<= 0 3)) (in_range7 temp___expr_2167)))
(assert true)
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range10 x) (in_range11 y)) (= (to_rep (let ((temp___2231 (select b y))) (select temp___2231 x))) 0))) :pattern ((is_empty b y x))))))
