...
(assert (= index1 1))
(assert (=> (<= index1 10) (and (and (= temp___152 found1) (and (= temp___151 index1) (and (= 0 temp___153) (and (not (= found2 true)) (and (and (=> (<= 1 10) (in_range2 index2)) (<= index2 10)) (and (and (= temp___1531 result2) (= temp___1532 index2)) (or (and (and (and (= index2 index6) (= found3 found4)) (and (= index7 index2) (= found5 found3))) (and (= (to_rep (select table index2)) value) (and (= result3 found2) (= found3 (of_int 1))))) (and (and (not (= (to_rep (select table index2)) value)) (= found3 found2)) (and (and (and (= (mk_int__ref index6) (mk_int__ref index4)) (= found3 found4)) (and (= index7 index5) (= found5 found3))) (or (and (and (= index2 index4) (= index5 index2)) (= index2 10)) (and (not (= index2 10)) (and (and (= index3 index4) (= index5 index3)) (and (and (and (= o (+ index2 1)) (in_range2 (+ index2 1))) (and (= index2 result4) (= index3 o))) (not (<= index3 10))))))))))))))) (and (and (= (mk_int__ref index10) (mk_int__ref index6)) (= (mk_bool__ref found8) (mk_bool__ref found4))) (and (= index11 index7) (= found9 found5))))))
