...
(assert (=> (<= index1 10) (or (and (and (and (= index2 index6) (= found3 found4)) (and (= index7 index2) (= found5 found3))) (and (= (to_rep (select table index2)) value) (and (= result3 found2) (= found3 (of_int 1))))) (and (and (not (= (to_rep (select table index2)) value)) (= found3 found2)) (and (and (and (= index16 (mk_int__ref index4)) (= found3 found4)) (and (= index7 index5) (= found5 found3))) (or (and (and (= index2 index4) (= index5 index2)) (= index2 10)) (and (not (= index2 10)) (and (and (= index3 index4) (= index5 index3)) (and (and (and (= o (+ index2 1)) (in_range2 (+ index2 1))) (and (= index2 result4) (= index3 o))) (not (<= index3 10)))))))))))
