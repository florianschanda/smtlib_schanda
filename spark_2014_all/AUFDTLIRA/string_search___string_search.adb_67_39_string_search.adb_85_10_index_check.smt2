...
(assert (<= r58b1 k1))
(assert (<= k1 r59b1))
(assert (and (= o28 (length needle)) (in_range1 (length needle))))
(assert (= o29 (+ i1 o28)))
(assert (and (= o30 o29) (in_range1 o29)))
(assert (= o31 (- o30 k1)))
(assert (and (= o32 o31) (in_range1 o31)))
(assert (= o33 (+ o32 1)))
(assert (and (= temp___330 o33) (in_range1 o33)))
(assert (and (<= (to_rep2 (first (rt needle))) temp___330) (<= temp___330 (to_rep2 (last (rt needle))))))
(assert (= o34 temp___330))
(assert (= o35 (select (elts needle) o34)))
(assert (= o36 (to_rep1 o35)))
(assert (and (= o26 (length needle)) (in_range1 (length needle))))
(assert (= o27 (+ i1 o26)))
(assert (and (= temp___329 o27) (in_range1 o27)))
(assert (not (<= (to_rep2 (first (rt haystack))) temp___329)))
(check-sat)
(exit)
