...
(assert (<= r58b2 k3))
(assert (<= k3 r59b2))
(assert (and (= o30 (length needle)) (in_range1 (length needle))))
(assert (= o31 (+ i1 o30)))
(assert (and (= o32 o31) (in_range1 o31)))
(assert (= o33 (- o32 k3)))
(assert (and (= o34 o33) (in_range1 o33)))
(assert (= o35 (+ o34 1)))
(assert (and (= temp___299 o35) (in_range1 o35)))
(assert (and (<= (to_rep2 (first (rt needle))) temp___299) (<= temp___299 (to_rep2 (last (rt needle))))))
(assert (= o36 temp___299))
(assert (= o37 (select (elts needle) o36)))
(assert (= o38 (to_rep1 o37)))
(assert (and (= o28 (length needle)) (in_range1 (length needle))))
(assert (= o29 (+ i1 o28)))
(assert (and (= temp___298 o29) (in_range1 o29)))
(assert (not (<= (to_rep2 (first (rt haystack))) temp___298)))
(check-sat)
(exit)
