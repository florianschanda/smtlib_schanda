...
(assert (= o33 (+ o32 1)))
(assert (and (= temp___332 o33) (in_range1 o33)))
(assert (and (<= (to_rep2 (first (rt needle))) temp___332) (<= temp___332 (to_rep2 (last (rt needle))))))
(assert (= o34 temp___332))
(assert (= o35 (select (elts needle) o34)))
(assert (= o36 (to_rep1 o35)))
(assert (and (= o26 (length needle)) (in_range1 (length needle))))
(assert (= o27 (+ i1 o26)))
(assert (and (= temp___331 o27) (in_range1 o27)))
(assert (not (<= temp___331 (to_rep2 (last (rt haystack))))))
(check-sat)
(exit)
