...
(assert (= result (mk_int__ref temp___949)))
(assert (= temp___9491 current_idx2))
...
(assert (not (and (<= 48 (let ((subject c)) c2)) (<= (let ((subject c)) c2) 57))))
(assert (not (and (<= 0 (let ((subject c)) c2)) (not (not (<= (let ((subject c)) c2) 255))))))
(assert (not (and (<= 0 (let ((subject c)) c2)) (and (<= 0 (let ((subject c)) c2)) (<= (let ((subject c)) c2) 255)))))
(assert (not (and (not (<= 0 (let ((subject c)) c2))) (and (<= 0 (let ((subject c)) c2)) (<= (let ((subject c)) c2) 255)))))
(assert (not (= (let ((subject c)) c2) 34)))
(assert (=> (<= 1 19) (= o1 (+ (- 19 1) 1))))
(assert (=> (not (<= 1 19)) (= o1 0)))
(assert (= o2 (+ o1 1)))
(assert (= o3 (+ 1 o2)))
(assert (= o4 (- o3 1)))
(assert (and (= o5 o4) (in_range2 o4)))
(assert (= (to_rep o) (let ((subject c)) c2)))
(assert (= o6 (concat_singleton_right (temp___String_Literal_930 Tuple0) 1 19 o)))
(assert (= temp___933 (mk___t o6 (mk 1 o5))))
(assert (=> (= (length temp___933) 0) (= o13 (mk___t (temp___String_Literal_932 Tuple0) (mk 1 1)))))
(assert (=> (not (= (length temp___933) 0)) (=> (<= 1 1) (= o7 (+ (- 1 1) 1)))))
(assert (=> (not (= (length temp___933) 0)) (=> (not (<= 1 1)) (= o7 0))))
(assert (=> (not (= (length temp___933) 0)) (=> (<= (to_rep1 (first (rt temp___933))) (to_rep1 (last (rt temp___933)))) (= o8 (+ (- (to_rep1 (last (rt temp___933))) (to_rep1 (first (rt temp___933)))) 1)))))
(assert (=> (not (= (length temp___933) 0)) (=> (not (<= (to_rep1 (first (rt temp___933))) (to_rep1 (last (rt temp___933))))) (= o8 0))))
(assert (=> (not (= (length temp___933) 0)) (= o9 (+ o8 o7))))
(assert (=> (not (= (length temp___933) 0)) (= o10 (+ (to_rep1 (first (rt temp___933))) o9))))
(assert (=> (not (= (length temp___933) 0)) (= o11 (- o10 1))))
(assert (=> (not (= (length temp___933) 0)) (and (= o12 o11) (in_range2 o11))))
(assert (=> (not (= (length temp___933) 0)) (= o13 (mk___t (concat1 (elts temp___933) (to_rep1 (first (rt temp___933))) (to_rep1 (last (rt temp___933))) (temp___String_Literal_932 Tuple0) 1 1) (mk (to_rep1 (first (rt temp___933))) o12)))))
(assert (= (let ((subject state)) (mk_int__ref state6)) (let ((subject state)) (mk_int__ref state1))))
(assert (= state6 state1))
(assert (= (let ((subject state)) (mk_int__ref state5)) (let ((subject state)) (mk_int__ref state6))))
(assert (= state5 state6))
(assert (= (let ((subject state)) (mk_int__ref state4)) (let ((subject state)) (mk_int__ref state5))))
(assert (= state4 state5))
(assert (= (let ((subject state)) (mk_int__ref state3)) (let ((subject state)) (mk_int__ref state4))))
(assert (= state3 state4))
(assert (= (let ((subject state)) (mk_int__ref state2)) (let ((subject state)) (mk_int__ref state3))))
...
(assert (and (and (= (local_invariant the_file4 current_read__split_fields4 current_read__split_discrs4 current_idx4 next_read__split_fields4 next_read__split_discrs4 next_idx4) true) (<= current_idx3 current_idx4)) (and (and (and (in_range2 current_line4) (in_range4 current_col4)) (in_range4 current_idx4)) (in_range4 next_idx4))))
(assert (or (= (to_rep4 (rec__file_io__read_result__status current_read__split_discrs4)) 1) (= (to_rep4 (rec__file_io__read_result__status current_read__split_discrs4)) 2)))
(assert (< current_col4 2147483647))
(assert (= result5 (let ((subject r57b)) (mk_int__ref r57b3))))
(assert (= (let ((subject r57b)) r57b4) (to_rep6 (rec__lexer__token__kind t__split_discrs4))))
(assert (in_range9 (let ((subject r57b)) r57b4)))
(assert (not (in_range1 (+ current_col4 1))))
(check-sat)
(exit)
