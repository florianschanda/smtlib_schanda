...
(assert (and (= o96 (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c7)) (= (= o96 true) (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c7) true))))
(assert (= o97 true))
(assert (= result20 (ite (= o97 true) o96 false)))
(assert (= result20 true))
(assert (not (= (has_key (positions (mk___rep d__split_discrs d__split_fields2)) c7) true)))
(check-sat)
(exit)
