...
(assert (= (mk___t2 temp___228 temp___2281) (test_globals__au__aggregate_def 0 1 c)))
(assert (= temp___228 test_globals__au__assume))
(assert (= (mk (to_rep1 (first4 temp___2281)) (to_rep1 (last4 temp___2281))) test_globals__au__assume1))
...
(assert (= (mk___t3 temp___239 temp___2391) (test_globals__ad__aggregate_def 0 1 c)))
(assert (= (ite (<= (to_rep1 (first6 temp___2391)) (to_rep1 (last6 temp___2391))) (+ (- (to_rep1 (last6 temp___2391)) (to_rep1 (first6 temp___2391))) 1) 0) (ite (<= 1 c) (+ (- c 1) 1) 0)))
(assert (= temp___239 test_globals__ad__assume))
(assert (= (mk1 (to_rep1 (first6 temp___2391)) (to_rep1 (last6 temp___2391))) test_globals__ad__assume1))
