...
(assert (= (naturalqtint rliteral1) 100))
...
(assert (= (to_rep o) c))
(assert (= o o1))
(assert (= test_globals__ru__assume o1))
(assert (= rliteral test_globals__ru__assume1))
...
(assert (= rs__split_fields1 (mk___split_fields rliteral)))
(assert (= rs__split_discrs (mk___split_discrs rliteral1)))
(assert (= 100 (to_rep (rec__test_globals__my_rec__d rs__split_discrs))))
(assert (= (to_rep o2) c))
(assert (= o2 o3))
(assert (= o4 o3))
(assert (= rliteral o5))
(assert (= o6 (mk___rep (mk___split_discrs o4) (mk___split_fields o5))))
(assert (= o7 o6))
(assert (= test_globals__rd__assume o7))
