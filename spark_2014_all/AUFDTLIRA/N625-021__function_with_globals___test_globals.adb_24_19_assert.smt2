...
(define-fun dynamic_invariant1 ((temp___expr_164 us_rep) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (=> (not (= temp___skip_constant_162 true)) (in_range3 100 temp___expr_164)))
(define-fun default_initial_assumption ((temp___expr_166 us_rep) (temp___skip_top_level_167 Bool)) Bool (= (to_rep (rec__test_globals__my_rec__d (us_split_discrs1 temp___expr_166))) 100))
...
(define-fun dynamic_invariant2 ((temp___expr_173 us_rep) (temp___is_init_170 Bool) (temp___skip_constant_171 Bool) (temp___do_toplevel_172 Bool)) Bool (=> (not (= temp___skip_constant_171 true)) (in_range4 c temp___expr_173)))
(define-fun default_initial_assumption1 ((temp___expr_175 us_rep) (temp___skip_top_level_176 Bool)) Bool (= (to_rep (rec__test_globals__my_rec__d (us_split_discrs1 temp___expr_175))) c))
...
(assert (forall ((temp___195 Int) (temp___196 Int) (temp___197 Int)) (let ((temp___194 (test_globals__au__aggregate_def temp___195 temp___196 temp___197))) (and (=> (dynamic_property 0 2147483647 temp___196 temp___197) (and (= (first5 temp___194) temp___196) (= (last5 temp___194) temp___197))) (forall ((temp___198 Int)) (= (select (to_array2 temp___194) temp___198) (of_rep temp___195)))))))
(declare-fun test_globals__as__aggregate_def (Int) (Array Int natural))
(assert (forall ((temp___203 Int)) (forall ((temp___204 Int)) (= (select (test_globals__as__aggregate_def temp___203) temp___204) (of_rep temp___203)))))
(declare-fun test_globals__ad__aggregate_def (Int Int Int) us_t3)
(assert (forall ((temp___206 Int) (temp___207 Int) (temp___208 Int)) (let ((temp___205 (test_globals__ad__aggregate_def temp___206 temp___207 temp___208))) (and (=> (dynamic_property 0 2147483647 temp___207 temp___208) (and (= (first7 temp___205) temp___207) (= (last7 temp___205) temp___208))) (forall ((temp___209 Int)) (= (select (to_array3 temp___205) temp___209) (of_rep temp___206)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_136 us_t) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (not (= temp___skip_constant_134 true)) (dynamic_property 0 2147483647 (first1 temp___expr_136) (last1 temp___expr_136))))
(define-fun dynamic_invariant5 ((temp___expr_150 us_t1) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (=> (not (= temp___skip_constant_148 true)) (and (dynamic_property2 1 c (first3 temp___expr_150) (last3 temp___expr_150)) (and (= (first3 temp___expr_150) 1) (= (last3 temp___expr_150) c)))))
(declare-const au (Array Int natural))
(declare-const as__ (Array Int natural))
(declare-const ad (Array Int natural))
...
(declare-const test_globals__ad__assume (Array Int natural))
(declare-const test_globals__ad__assume1 t1)
(declare-const o natural)
(declare-const o1 natural)
(declare-const o2 natural)
(declare-const o3 natural)
(declare-const test_globals__ru__assume natural)
(declare-const test_globals__ru__assume1 natural)
...
(declare-const test_globals__rs__assume us_rep)
...
(declare-const ad1 (Array Int natural))
(declare-const result3 us_split_fields__ref)
(declare-const ru__split_fields1 us_split_fields)
(declare-const result4 us_split_fields__ref)
(declare-const rs__split_fields1 us_split_fields)
(declare-const result5 us_split_fields__ref)
(declare-const rd__split_fields1 us_split_fields)
(assert (in_range1 c))
(assert (and (= us 100) (in_range1 100)))
(assert (and (= us1 c) (in_range1 c)))
(assert (= (to_rep1 (first4 (rt2 (test_globals__au__aggregate_def 0 1 c)))) 1))
(assert (= (to_rep1 (last4 (rt2 (test_globals__au__aggregate_def 0 1 c)))) c))
(assert (= (mk___t2 temp___200 temp___2001) (test_globals__au__aggregate_def 0 1 c)))
(assert (= temp___200 test_globals__au__assume))
(assert (= (mk (to_rep1 (first4 temp___2001)) (to_rep1 (last4 temp___2001))) test_globals__au__assume1))
(assert (= result (mk_map__ref au)))
(assert (= au1 test_globals__au__assume))
(assert (= (to_rep1 au__first) (to_rep1 (first test_globals__au__assume1))))
...
(assert (= (to_rep1 (first6 (rt3 (test_globals__ad__aggregate_def 0 1 c)))) 1))
(assert (= (to_rep1 (last6 (rt3 (test_globals__ad__aggregate_def 0 1 c)))) c))
(assert (= (mk___t3 temp___211 temp___2111) (test_globals__ad__aggregate_def 0 1 c)))
(assert (= (ite (<= (to_rep1 (first6 temp___2111)) (to_rep1 (last6 temp___2111))) (+ (- (to_rep1 (last6 temp___2111)) (to_rep1 (first6 temp___2111))) 1) 0) (ite (<= 1 c) (+ (- c 1) 1) 0)))
(assert (= temp___211 test_globals__ad__assume))
(assert (= (mk1 (to_rep1 (first6 temp___2111)) (to_rep1 (last6 temp___2111))) test_globals__ad__assume1))
(assert (= result2 (mk_map__ref ad)))
(assert (= ad1 test_globals__ad__assume))
(assert (= (to_rep1 ad__first) (to_rep1 (first2 test_globals__ad__assume1))))
(assert (= (to_rep1 ad__last) (to_rep1 (last2 test_globals__ad__assume1))))
(assert (and (dynamic_property2 1 c (to_rep1 ad__first) (to_rep1 ad__last)) (and (= (to_rep1 ad__first) 1) (= (to_rep1 ad__last) c))))
(assert (= (to_rep o1) 0))
(assert (= o1 o2))
(assert (= (to_rep o) c))
(assert (= o o3))
(assert (= test_globals__ru__assume o3))
(assert (= test_globals__ru__assume1 o2))
(assert (= result3 (mk___split_fields__ref (mk___split_fields ru__split_fields))))
(assert (= ru__split_fields1 (mk___split_fields test_globals__ru__assume1)))
(assert (= ru__split_discrs (mk___split_discrs test_globals__ru__assume)))
(assert (= (to_rep o5) 0))
(assert (= o5 o6))
(assert (= (to_rep o4) 100))
(assert (= o4 o7))
(assert (= o8 o7))
(assert (= o9 o6))
(assert (= o10 (mk___rep (mk___split_discrs o8) (mk___split_fields o9))))
(assert (= o11 o10))
(assert (= test_globals__rs__assume o11))
(assert (= result4 (mk___split_fields__ref (mk___split_fields rs__split_fields))))
(assert (= rs__split_fields1 (us_split_fields1 test_globals__rs__assume)))
(assert (= rs__split_discrs (us_split_discrs1 test_globals__rs__assume)))
(assert (= 100 (to_rep (rec__test_globals__my_rec__d rs__split_discrs))))
(assert (= (to_rep o13) 0))
(assert (= o14 (mk___split_fields o13)))
(assert (= (to_rep o12) c))
(assert (= o15 (mk___split_discrs o12)))
(assert (= o16 (mk___rep o15 o14)))
(assert (= o17 o16))
(assert (= o18 o17))
(assert (= test_globals__rd__assume o18))
(assert (= result5 (mk___split_fields__ref (mk___split_fields rd__split_fields))))
(assert (= rd__split_fields1 (us_split_fields1 test_globals__rd__assume)))
(assert (= rd__split_discrs (us_split_discrs1 test_globals__rd__assume)))
(assert (= c (to_rep (rec__test_globals__my_rec__d rd__split_discrs))))
(assert (not (= (nested_with_globals au1 as__1 ad1 ru__split_fields1 rs__split_fields1 rd__split_fields1) true)))
(check-sat)
(exit)
