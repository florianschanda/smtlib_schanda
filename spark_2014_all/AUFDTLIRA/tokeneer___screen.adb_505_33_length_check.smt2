...
(assert (= o result__1))
(assert (= o temp___1826))
(assert (= (mk3 1 (to_rep1 data__last)) temp___18261))
(assert (not (= (ite (<= (to_rep1 (first6 temp___18231)) (to_rep1 (last6 temp___18231))) (+ (- (to_rep1 (last6 temp___18231)) (to_rep1 (first6 temp___18231))) 1) 0) (ite (<= (to_rep1 (first6 temp___18261)) (to_rep1 (last6 temp___18261))) (+ (- (to_rep1 (last6 temp___18261)) (to_rep1 (first6 temp___18261))) 1) 0))))
(check-sat)
(exit)
