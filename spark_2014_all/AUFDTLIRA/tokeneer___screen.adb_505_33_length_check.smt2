...
(declare-const temp___2010 (Array Int character))
(declare-const temp___20101 t3)
...
(assert (= (mk3 1 (to_rep1 data__last)) temp___20101))
(assert (not (= (ite (<= (to_rep1 (first6 temp___20071)) (to_rep1 (last6 temp___20071))) (+ (- (to_rep1 (last6 temp___20071)) (to_rep1 (first6 temp___20071))) 1) 0) (ite (<= (to_rep1 (first6 temp___20101)) (to_rep1 (last6 temp___20101))) (+ (- (to_rep1 (last6 temp___20101)) (to_rep1 (first6 temp___20101))) 1) 0))))
(check-sat)
(exit)
