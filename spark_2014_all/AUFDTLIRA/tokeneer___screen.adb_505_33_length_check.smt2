...
(declare-const temp___2014 (Array Int character))
(declare-const temp___20141 t3)
(declare-const o (Array Int character))
(declare-const temp___2017 (Array Int character))
(declare-const temp___20171 t3)
...
(assert (= (slide data1 (to_rep1 data__first) 1) temp___2014))
(assert (= (mk3 1 (to_rep1 data__last)) temp___20141))
(assert (=> (<= 1 (to_rep1 data__last)) (and (and (<= 1 1) (<= 1 12)) (and (<= 1 (to_rep1 data__last)) (<= (to_rep1 data__last) 12)))))
(assert (= o result__1))
(assert (= o temp___2017))
(assert (= (mk3 1 (to_rep1 data__last)) temp___20171))
(assert (not (= (ite (<= (to_rep1 (first6 temp___20141)) (to_rep1 (last6 temp___20141))) (+ (- (to_rep1 (last6 temp___20141)) (to_rep1 (first6 temp___20141))) 1) 0) (ite (<= (to_rep1 (first6 temp___20171)) (to_rep1 (last6 temp___20171))) (+ (- (to_rep1 (last6 temp___20171)) (to_rep1 (first6 temp___20171))) 1) 0))))
(check-sat)
(exit)
