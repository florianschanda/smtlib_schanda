...
(assert (= status1 3))
(assert (and (= (and (and (= (islocked state2) true) (= (thecurrentdoor state3) 0)) (= (greaterthanorequal (thecurrenttime currenttime) (alarm_timeout state3)) true)) (= (thedooralarm state3) 0)) (= (= (islocked state2) true) (= (greaterthanorequal (thecurrenttime currenttime) (latch_timeout state2)) true))))
