...
(assert (not (= (length (mk___t temp___1519 temp___15191)) 0)))
(assert (=> (<= 1 2) (= o24 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o24 0)))
(assert (=> (<= (to_rep1 (first temp___15191)) (to_rep1 (last temp___15191))) (= o25 (+ (- (to_rep1 (last temp___15191)) (to_rep1 (first temp___15191))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___15191)) (to_rep1 (last temp___15191)))) (= o25 0)))
(assert (= o26 (+ o25 o24)))
(assert (= o27 (+ (to_rep1 (first temp___15191)) o26)))
(assert (= o28 (- o27 1)))
