...
(assert (= (concat1 (temp___String_Literal_1028 Tuple0) 1 8 (elts (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents)))))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents)))))))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))))))) temp___1032))
(assert (= (mk 1 o5) temp___10321))
(assert (not (= (length (mk___t temp___1032 temp___10321)) 0)))
(assert (=> (<= 1 12) (= o6 (+ (- 12 1) 1))))
(assert (=> (not (<= 1 12)) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___10321)) (to_rep1 (last temp___10321))) (= o7 (+ (- (to_rep1 (last temp___10321)) (to_rep1 (first temp___10321))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___10321)) (to_rep1 (last temp___10321)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
