...
(assert (not (<= (+ (+ (+ (+ 0 (ite (= (= (to_int1 (select number_list value)) (to_int1 (of_int 1))) true) 1 0)) (ite (= (ite (= (= (to_int1 (select number_list value)) (to_int1 (of_int 0))) true) (= mode 0) false) true) 1 0)) (ite (= (ite (= (= (to_int1 (select number_list value)) (to_int1 (of_int 0))) true) (= mode 1) false) true) 1 0)) (ite (= (ite (= (= (to_int1 (select number_list value)) (to_int1 (of_int 0))) true) (= mode 2) false) true) 1 0)) 1)))
(check-sat)
(exit)
