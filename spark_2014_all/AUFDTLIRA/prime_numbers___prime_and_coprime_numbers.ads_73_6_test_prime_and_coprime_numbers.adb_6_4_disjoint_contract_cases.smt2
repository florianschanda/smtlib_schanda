...
(assert (not (<= (+ (+ (+ (+ 0 (ite (= (= (ite (select number_list value) 1 0) (ite (distinct 1 0) 1 0)) true) 1 0)) (ite (= (ite (= (= (ite (select number_list value) 1 0) (ite (distinct 0 0) 1 0)) true) (= mode 0) false) true) 1 0)) (ite (= (ite (= (= (ite (select number_list value) 1 0) (ite (distinct 0 0) 1 0)) true) (= mode 1) false) true) 1 0)) (ite (= (ite (= (= (ite (select number_list value) 1 0) (ite (distinct 0 0) 1 0)) true) (= mode 2) false) true) 1 0)) 1)))
(check-sat)
(exit)
