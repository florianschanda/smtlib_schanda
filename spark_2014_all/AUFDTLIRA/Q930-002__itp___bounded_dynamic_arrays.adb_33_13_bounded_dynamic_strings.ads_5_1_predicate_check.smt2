...
(assert (= (ite (<= (to_rep1 (first12 (rt6 temp___887))) (to_rep1 (last12 (rt6 temp___887)))) (+ (- (to_rep1 (last12 (rt6 temp___887))) (to_rep1 (first12 (rt6 temp___887)))) 1) 0) (ite (<= (to_rep1 (first12 (rt6 temp___890))) (to_rep1 (last12 (rt6 temp___890)))) (+ (- (to_rep1 (last12 (rt6 temp___890))) (to_rep1 (first12 (rt6 temp___890)))) 1) 0)))
(assert (= temp___892 temp___887))
(assert (and (and (= (to_rep1 (first8 (rt4 (rec__bounded_dynamic_strings__sequence__content1 result____split_fields3)))) (to_rep1 (first8 (rt4 o7)))) (= (to_rep1 (last8 (rt4 (rec__bounded_dynamic_strings__sequence__content1 result____split_fields3)))) (to_rep1 (last8 (rt4 o7))))) (forall ((temp___893 Int)) (ite (and (<= 1 temp___893) (<= temp___893 r88b)) (= (select (elts4 o7) temp___893) (select (elts6 temp___892) temp___893)) (= (select (elts4 o7) temp___893) (select (elts4 (rec__bounded_dynamic_strings__sequence__content1 result____split_fields3)) temp___893))))))
(assert (= o8 (mk___split_fields1 (rec__bounded_dynamic_strings__sequence__current_length1 result____split_fields3) o7)))
(assert (= temp___895 (mk___rep1 result____split_discrs o8)))
(assert (not (dynamic_predicate1 temp___895)))
(check-sat)
(exit)
