...
(define-fun dynamic_invariant ((temp___expr_189 us_t) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (not (= temp___skip_constant_186 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_189) (last1 temp___expr_189))))
...
(define-fun dynamic_invariant2 ((temp___expr_217 us_t1) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool (=> (not (= temp___skip_constant_214 true)) (dynamic_property1 (- 2147483648) 2147483647 (first3 temp___expr_217) (last3 temp___expr_217))))
(declare-const i Int)
(declare-const o Int)
(declare-const o1 integer)
(declare-const o2 Int)
(assert (dynamic_invariant arr true false true true))
(assert (<= (+ (to_rep (first (rt arr))) 1) i))
(assert (<= i (to_rep (last (rt arr)))))
(assert (and (<= (to_rep (first (rt arr))) i) (<= i (to_rep (last (rt arr))))))
(assert (= o i))
(assert (= o1 (select (elts arr) o)))
(assert (= o2 (to_rep o1)))
(assert (not (<= (to_rep (first (rt arr))) (- i 1))))
(check-sat)
(exit)
