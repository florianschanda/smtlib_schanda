...
(define-fun dynamic_invariant ((temp___expr_163 us_t) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool)) Bool (=> (not (= temp___skip_constant_161 true)) (dynamic_property (- 2147483648) 2147483647 (first1 temp___expr_163) (last1 temp___expr_163))))
...
(define-fun dynamic_invariant2 ((temp___expr_187 us_t1) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool)) Bool (=> (not (= temp___skip_constant_185 true)) (dynamic_property1 (- 2147483648) 2147483647 (first3 temp___expr_187) (last3 temp___expr_187))))
(declare-const i Int)
(declare-const o Int)
