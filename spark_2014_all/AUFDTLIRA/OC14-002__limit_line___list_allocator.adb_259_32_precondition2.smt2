...
(assert (= result10 (ite (<= 1 j) o58 false)))
(assert (= result10 true))
(assert (and (= o77 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 o77)))
(assert (= result13 (ite (in_range7 o77) true false)))
(assert (=> (= result13 true) (and (= o73 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o73))))
(assert (=> (= result13 true) (= result14 (ite (< j o73) true false))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o74 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o75 (get (rec__list_allocator__m__t__available model____split_fields3) o74)) (in_range4 o75)))))
(assert (=> (= result13 true) (=> (not (= result14 true)) (= o75 0))))
(assert (=> (= result13 true) (and (= temp___460 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 temp___460))))
(assert (=> (= result13 true) (and (<= 1 temp___460) (<= temp___460 3))))
(assert (=> (= result13 true) (= o69 temp___460)))
(assert (=> (= result13 true) (= o70 (select data3 o69))))
(assert (=> (= result13 true) (= o71 (us_split_fields3 o70))))
(assert (=> (= result13 true) (= o72 (rec__list_allocator__cell__next o71))))
(assert (=> (= result13 true) (= o76 (to_rep o72))))
(assert (=> (= result13 true) (= result12 (ite (= o76 o75) true false))))
(assert (=> (not (= result13 true)) (= result12 false)))
(assert (=> (= result12 true) (=> (< 1 j) (and (= o66 (- j 1)) (in_range2 (- j 1))))))
(assert (=> (= result12 true) (=> (< 1 j) (and (= o67 (get (rec__list_allocator__m__t__available model____split_fields3) o66)) (in_range4 o67)))))
(assert (=> (= result12 true) (=> (not (< 1 j)) (= o67 0))))
(assert (=> (= result12 true) (and (= temp___461 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 temp___461))))
(assert (=> (= result12 true) (and (<= 1 temp___461) (<= temp___461 3))))
(assert (=> (= result12 true) (= o62 temp___461)))
(assert (=> (= result12 true) (= o63 (select data3 o62))))
(assert (=> (= result12 true) (= o64 (us_split_fields3 o63))))
(assert (=> (= result12 true) (= o65 (rec__list_allocator__cell__prev o64))))
(assert (=> (= result12 true) (= o68 (to_rep o65))))
(assert (=> (= result12 true) (= result11 (ite (= o68 o67) true false))))
...
(assert (= o60 (ite (<= k o59) true false)))
(assert (= result15 (ite (<= 1 k) o60 false)))
(assert (= result15 true))
(assert (not (= j k)))
(assert (and (= o61 (get (rec__list_allocator__m__t__available model____split_fields3) k)) (in_range4 o61)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
