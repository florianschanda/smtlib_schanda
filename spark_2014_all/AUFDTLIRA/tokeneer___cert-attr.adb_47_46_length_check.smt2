...
(declare-fun user_eq5 (usertexti usertexti) Bool)
(declare-const dummy5 usertexti)
...
(define-fun dynamic_invariant1 ((temp___expr_818 Int) (temp___is_init_815 Bool) (temp___skip_constant_816 Bool) (temp___do_toplevel_817 Bool)) Bool (=> (or (= temp___is_init_815 true) (<= 0 4294967295)) (in_range4 temp___expr_818)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (= (issueridt_image x) (let ((temp___824 (to_string (attr__ATTRIBUTE_IMAGE4 x)))) (of_array1 (to_array temp___824) (first1 temp___824) (last1 temp___824))))) :pattern ((issueridt_image x)))))
...
(declare-fun user_eq11 (serialnumbert serialnumbert) Bool)
(declare-const dummy11 serialnumbert)
...
(define-fun dynamic_invariant2 ((temp___expr_1261 Int) (temp___is_init_1258 Bool) (temp___skip_constant_1259 Bool) (temp___do_toplevel_1260 Bool)) Bool (=> (or (= temp___is_init_1258 true) (<= 0 4294967295)) (in_range6 temp___expr_1261)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant2 x true true true) (= (serialnumbert_image x) (let ((temp___1267 (to_string (attr__ATTRIBUTE_IMAGE6 x)))) (of_array1 (to_array temp___1267) (first1 temp___1267) (last1 temp___1267))))) :pattern ((serialnumbert_image x)))))
...
(declare-fun user_eq18 (algorithmt algorithmt) Bool)
(declare-const dummy18 algorithmt)
...
(define-fun bool_eq7 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (and (= (bool_eq5 (rec__cert__attr__contentst__id (us_split_fields7 a)) (rec__cert__attr__contentst__id (us_split_fields7 b))) true) (= (bool_eq6 (rec__cert__attr__contentst__notbefore (us_split_fields7 a)) (rec__cert__attr__contentst__notbefore (us_split_fields7 b))) true)) (= (bool_eq6 (rec__cert__attr__contentst__notafter (us_split_fields7 a)) (rec__cert__attr__contentst__notafter (us_split_fields7 b))) true)) (= (to_rep9 (rec__cert__attr__contentst__mechanism (us_split_fields7 a))) (to_rep9 (rec__cert__attr__contentst__mechanism (us_split_fields7 b))))) (= (bool_eq5 (rec__cert__attr__contentst__basecertid (us_split_fields7 a)) (rec__cert__attr__contentst__basecertid (us_split_fields7 b))) true)) true false))
...
(declare-fun temp___String_Literal_1478 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1478 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 4)) 115)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 29)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_1478 us_void_param) 50)) 32)) :pattern ((temp___String_Literal_1478 us_void_param)))))
(declare-fun temp___String_Literal_1479 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1479 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 2)) 115)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 4)) 117)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 7)) 58)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 8)) 32)) :pattern ((temp___String_Literal_1479 us_void_param)))))
(declare-fun temp___String_Literal_1482 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1482 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1482 us_void_param) 2)) 83)) (= (to_rep (select (temp___String_Literal_1482 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_1482 us_void_param) 4)) 114)) (= (to_rep (select (temp___String_Literal_1482 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1482 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_1482 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_1482 us_void_param) 8)) 78)) (= (to_rep (select (temp___String_Literal_1482 us_void_param) 9)) 111)) (= (to_rep (select (temp___String_Literal_1482 us_void_param) 10)) 58)) (= (to_rep (select (temp___String_Literal_1482 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1482 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_1482 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_350 Int) (temp___is_init_347 Bool) (temp___skip_constant_348 Bool) (temp___do_toplevel_349 Bool)) Bool (=> (or (= temp___is_init_347 true) (<= 1 50)) (in_range3 temp___expr_350)))
...
(define-fun dynamic_invariant9 ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 1901 2099)) (in_range7 temp___expr_383)))
(define-fun dynamic_invariant10 ((temp___expr_389 Int) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (or (= temp___is_init_386 true) (<= 1 12)) (in_range8 temp___expr_389)))
(define-fun dynamic_invariant11 ((temp___expr_395 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 1 31)) (in_range9 temp___expr_395)))
(define-fun dynamic_invariant12 ((temp___expr_419 Int) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool)) Bool (=> (or (= temp___is_init_416 true) (<= 0 86399999)) (in_range10 temp___expr_419)))
(define-fun dynamic_invariant13 ((temp___expr_797 Int) (temp___is_init_794 Bool) (temp___skip_constant_795 Bool) (temp___do_toplevel_796 Bool)) Bool (=> (or (= temp___is_init_794 true) (<= 0 40)) (in_range5 temp___expr_797)))
(define-fun dynamic_invariant14 ((temp___expr_840 Int) (temp___is_init_837 Bool) (temp___skip_constant_838 Bool) (temp___do_toplevel_839 Bool)) Bool (=> (or (= temp___is_init_837 true) (<= 0 10)) (in_range11 temp___expr_840)))
(declare-const localuser (Array Int character))
(declare-const fullstring (Array Int character))
(declare-const temp___1486 (Array Int character))
(declare-const temp___14861 t1)
(declare-const temp___1481 (Array Int character))
(declare-const temp___14811 t1)
(declare-const o Int)
...
(declare-const temp___1483 (Array Int character))
(declare-const temp___14831 t)
...
(declare-const temp___1485 (Array Int character))
(declare-const temp___14851 t)
...
(declare-const temp___14911 t3)
(declare-const o18 (Array Int character))
(declare-const temp___1494 (Array Int character))
(declare-const temp___14941 t3)
...
(assert (= localuser1 (temp___String_Literal_1478 Tuple0)))
(assert (and (= (mk___t1 temp___1486 temp___14861) (serialnumbert_image (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))) (and (dynamic_invariant (mk___t1 temp___1486 temp___14861) true false true) (= (mk___t1 temp___1486 temp___14861) (let ((temp___1265 (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))) (mk___t1 (elts temp___1265) (mk1 (to_rep1 (first (rt temp___1265))) (to_rep1 (last (rt temp___1265))))))))))
(assert (and (= (mk___t1 temp___1481 temp___14811) (issueridt_image (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))) (and (dynamic_invariant (mk___t1 temp___1481 temp___14811) true false true) (= (mk___t1 temp___1481 temp___14811) (let ((temp___822 (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))))) (mk___t1 (elts temp___822) (mk1 (to_rep1 (first (rt temp___822))) (to_rep1 (last (rt temp___822))))))))))
(assert (=> (<= (to_rep1 (first2 temp___14811)) (to_rep1 (last2 temp___14811))) (= o (+ (- (to_rep1 (last2 temp___14811)) (to_rep1 (first2 temp___14811))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___14811)) (to_rep1 (last2 temp___14811)))) (= o 0)))
(assert (=> (<= 1 8) (= o1 (+ (- 8 1) 1))))
(assert (=> (not (<= 1 8)) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ 1 o2)))
...
(assert (= (concat1 (temp___String_Literal_1479 Tuple0) 1 8 temp___1481 (to_rep1 (first2 temp___14811)) (to_rep1 (last2 temp___14811))) temp___1483))
(assert (= (mk 1 o5) temp___14831))
(assert (=> (= (length (mk___t temp___1483 temp___14831)) 0) (= (temp___String_Literal_1482 Tuple0) temp___1485)))
(assert (=> (= (length (mk___t temp___1483 temp___14831)) 0) (= (mk 1 12) temp___14851)))
(assert (=> (not (= (length (mk___t temp___1483 temp___14831)) 0)) (=> (<= 1 12) (= o6 (+ (- 12 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1483 temp___14831)) 0)) (=> (not (<= 1 12)) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___1483 temp___14831)) 0)) (=> (<= (to_rep1 (first temp___14831)) (to_rep1 (last temp___14831))) (= o7 (+ (- (to_rep1 (last temp___14831)) (to_rep1 (first temp___14831))) 1)))))
(assert (=> (not (= (length (mk___t temp___1483 temp___14831)) 0)) (=> (not (<= (to_rep1 (first temp___14831)) (to_rep1 (last temp___14831)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___1483 temp___14831)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___1483 temp___14831)) 0)) (= o9 (+ (to_rep1 (first temp___14831)) o8))))
(assert (=> (not (= (length (mk___t temp___1483 temp___14831)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___1483 temp___14831)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___1483 temp___14831)) 0)) (= (concat1 temp___1483 (to_rep1 (first temp___14831)) (to_rep1 (last temp___14831)) (temp___String_Literal_1482 Tuple0) 1 12) temp___1485)))
(assert (=> (not (= (length (mk___t temp___1483 temp___14831)) 0)) (= (mk (to_rep1 (first temp___14831)) o11) temp___14851)))
(assert (=> (= (length (mk___t temp___1485 temp___14851)) 0) (= temp___1486 cert__attr__extractuser__fullstring__assume)))
(assert (=> (= (length (mk___t temp___1485 temp___14851)) 0) (= (mk (to_rep1 (first2 temp___14861)) (to_rep1 (last2 temp___14861))) cert__attr__extractuser__fullstring__assume1)))
(assert (=> (not (= (length (mk___t temp___1485 temp___14851)) 0)) (=> (<= (to_rep1 (first2 temp___14861)) (to_rep1 (last2 temp___14861))) (= o12 (+ (- (to_rep1 (last2 temp___14861)) (to_rep1 (first2 temp___14861))) 1)))))
(assert (=> (not (= (length (mk___t temp___1485 temp___14851)) 0)) (=> (not (<= (to_rep1 (first2 temp___14861)) (to_rep1 (last2 temp___14861)))) (= o12 0))))
(assert (=> (not (= (length (mk___t temp___1485 temp___14851)) 0)) (=> (<= (to_rep1 (first temp___14851)) (to_rep1 (last temp___14851))) (= o13 (+ (- (to_rep1 (last temp___14851)) (to_rep1 (first temp___14851))) 1)))))
(assert (=> (not (= (length (mk___t temp___1485 temp___14851)) 0)) (=> (not (<= (to_rep1 (first temp___14851)) (to_rep1 (last temp___14851)))) (= o13 0))))
(assert (=> (not (= (length (mk___t temp___1485 temp___14851)) 0)) (= o14 (+ o13 o12))))
(assert (=> (not (= (length (mk___t temp___1485 temp___14851)) 0)) (= o15 (+ (to_rep1 (first temp___14851)) o14))))
(assert (=> (not (= (length (mk___t temp___1485 temp___14851)) 0)) (= o16 (- o15 1))))
(assert (=> (not (= (length (mk___t temp___1485 temp___14851)) 0)) (and (= o17 o16) (in_range1 o16))))
(assert (=> (not (= (length (mk___t temp___1485 temp___14851)) 0)) (= (concat1 temp___1485 (to_rep1 (first temp___14851)) (to_rep1 (last temp___14851)) temp___1486 (to_rep1 (first2 temp___14861)) (to_rep1 (last2 temp___14861))) cert__attr__extractuser__fullstring__assume)))
(assert (=> (not (= (length (mk___t temp___1485 temp___14851)) 0)) (= (mk (to_rep1 (first temp___14851)) o17) cert__attr__extractuser__fullstring__assume1)))
