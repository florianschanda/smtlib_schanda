...
(define-fun dynamic_invariant ((temp___expr_297 us_t1) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool)) Bool (and (=> (not (= temp___skip_constant_295 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_297) (last3 temp___expr_297))) (=> (= temp___do_toplevel_296 true) (=> (= temp___is_init_294 true) (and (let ((temp___299 (of_array3 (to_array1 temp___expr_297) (first3 temp___expr_297) (last3 temp___expr_297)))) (and (= (first7 temp___299) 1) (<= 0 (last7 temp___299)))) (<= (last3 temp___expr_297) 1000))))))
(define-fun dynamic_predicate ((temp___301 us_t1)) Bool (and (let ((temp___303 (of_array3 (to_array1 temp___301) (first3 temp___301) (last3 temp___301)))) (and (= (first7 temp___303) 1) (<= 0 (last7 temp___303)))) (<= (last3 temp___301) 1000)))
(define-fun dynamic_invariant1 ((temp___expr_866 Int) (temp___is_init_863 Bool) (temp___skip_constant_864 Bool) (temp___do_toplevel_865 Bool)) Bool (=> (or (= temp___is_init_863 true) (<= 0 4294967295)) (in_range4 temp___expr_866)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (= (issueridt_image x) (let ((temp___872 (to_string (attr__ATTRIBUTE_IMAGE4 x)))) (of_array1 (to_array temp___872) (first1 temp___872) (last1 temp___872))))) :pattern ((issueridt_image x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_309 us_t2) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool)) Bool (and (=> (not (= temp___skip_constant_307 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_309) (last5 temp___expr_309))) (=> (= temp___do_toplevel_308 true) (=> (= temp___is_init_306 true) (and (let ((temp___311 (of_array1 (to_array2 temp___expr_309) (first5 temp___expr_309) (last5 temp___expr_309)))) (and (let ((temp___312 (of_array3 (to_array1 temp___311) (first3 temp___311) (last3 temp___311)))) (and (= (first7 temp___312) 1) (<= 0 (last7 temp___312)))) (<= (last3 temp___311) 1000))) (<= 2 (length2 temp___expr_309)))))))
(define-fun dynamic_predicate1 ((temp___314 us_t2)) Bool (and (let ((temp___316 (of_array1 (to_array2 temp___314) (first5 temp___314) (last5 temp___314)))) (and (let ((temp___317 (of_array3 (to_array1 temp___316) (first3 temp___316) (last3 temp___316)))) (and (= (first7 temp___317) 1) (<= 0 (last7 temp___317)))) (<= (last3 temp___316) 1000))) (<= 2 (length2 temp___314))))
(define-fun dynamic_invariant3 ((temp___expr_1317 Int) (temp___is_init_1314 Bool) (temp___skip_constant_1315 Bool) (temp___do_toplevel_1316 Bool)) Bool (=> (or (= temp___is_init_1314 true) (<= 0 4294967295)) (in_range6 temp___expr_1317)))
(declare-fun serialnumbert_image (Int) us_t2)
(declare-fun serialnumbert_image__function_guard (us_t2 Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant3 x true true true) (dynamic_invariant2 (serialnumbert_image x) true false true)) :pattern ((serialnumbert_image x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant3 x true true true) (= (serialnumbert_image x) (let ((temp___1323 (to_string (attr__ATTRIBUTE_IMAGE6 x)))) (of_array2 (to_array temp___1323) (first1 temp___1323) (last1 temp___1323))))) :pattern ((serialnumbert_image x)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1534 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 4)) 115)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 29)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 50)) 32)) :pattern ((temp___String_Literal_1534 us_void_param)))))
(declare-fun temp___String_Literal_1535 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1535 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1535 us_void_param) 2)) 115)) (= (to_rep (select (temp___String_Literal_1535 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_1535 us_void_param) 4)) 117)) (= (to_rep (select (temp___String_Literal_1535 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1535 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1535 us_void_param) 7)) 58)) (= (to_rep (select (temp___String_Literal_1535 us_void_param) 8)) 32)) :pattern ((temp___String_Literal_1535 us_void_param)))))
(declare-fun temp___String_Literal_1538 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1538 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1538 us_void_param) 2)) 83)) (= (to_rep (select (temp___String_Literal_1538 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_1538 us_void_param) 4)) 114)) (= (to_rep (select (temp___String_Literal_1538 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1538 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_1538 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_1538 us_void_param) 8)) 78)) (= (to_rep (select (temp___String_Literal_1538 us_void_param) 9)) 111)) (= (to_rep (select (temp___String_Literal_1538 us_void_param) 10)) 58)) (= (to_rep (select (temp___String_Literal_1538 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1538 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_1538 us_void_param)))))
...
(define-fun dynamic_invariant8 ((temp___expr_390 Int) (temp___is_init_387 Bool) (temp___skip_constant_388 Bool) (temp___do_toplevel_389 Bool)) Bool (=> (or (= temp___is_init_387 true) (<= 1 50)) (in_range3 temp___expr_390)))
(define-fun dynamic_invariant9 ((temp___expr_263 us_t3) (temp___is_init_260 Bool) (temp___skip_constant_261 Bool) (temp___do_toplevel_262 Bool)) Bool (and (=> (not (= temp___skip_constant_261 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_263) (last7 temp___expr_263))) (=> (= temp___do_toplevel_262 true) (=> (= temp___is_init_260 true) (and (= (first7 temp___expr_263) 1) (<= 0 (last7 temp___expr_263)))))))
(define-fun dynamic_predicate2 ((temp___266 us_t3)) Bool (and (= (first7 temp___266) 1) (<= 0 (last7 temp___266))))
(define-fun dynamic_invariant10 ((temp___expr_427 Int) (temp___is_init_424 Bool) (temp___skip_constant_425 Bool) (temp___do_toplevel_426 Bool)) Bool (=> (or (= temp___is_init_424 true) (<= 1901 2099)) (in_range7 temp___expr_427)))
(define-fun dynamic_invariant11 ((temp___expr_433 Int) (temp___is_init_430 Bool) (temp___skip_constant_431 Bool) (temp___do_toplevel_432 Bool)) Bool (=> (or (= temp___is_init_430 true) (<= 1 12)) (in_range8 temp___expr_433)))
(define-fun dynamic_invariant12 ((temp___expr_439 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 1 31)) (in_range9 temp___expr_439)))
(define-fun dynamic_invariant13 ((temp___expr_467 Int) (temp___is_init_464 Bool) (temp___skip_constant_465 Bool) (temp___do_toplevel_466 Bool)) Bool (=> (or (= temp___is_init_464 true) (<= 0 86399999)) (in_range10 temp___expr_467)))
(define-fun dynamic_invariant14 ((temp___expr_845 Int) (temp___is_init_842 Bool) (temp___skip_constant_843 Bool) (temp___do_toplevel_844 Bool)) Bool (=> (or (= temp___is_init_842 true) (<= 0 40)) (in_range5 temp___expr_845)))
(define-fun dynamic_invariant15 ((temp___expr_888 Int) (temp___is_init_885 Bool) (temp___skip_constant_886 Bool) (temp___do_toplevel_887 Bool)) Bool (=> (or (= temp___is_init_885 true) (<= 0 10)) (in_range11 temp___expr_888)))
...
(declare-const temp___15421 t2)
(declare-const temp___1537 (Array Int character))
(declare-const temp___15371 t1)
(declare-const o Int)
...
(declare-const temp___1539 (Array Int character))
(declare-const temp___15391 t)
...
(declare-const temp___1547 (Array Int character))
(declare-const temp___15471 t4)
(declare-const o18 (Array Int character))
(declare-const temp___1550 (Array Int character))
(declare-const temp___15501 t4)
...
(assert (= localuser1 (temp___String_Literal_1534 Tuple0)))
(assert (and (= (mk___t2 temp___1542 temp___15421) (serialnumbert_image (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))) (and (dynamic_invariant2 (mk___t2 temp___1542 temp___15421) true false true) (= (mk___t2 temp___1542 temp___15421) (let ((temp___1321 (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (rec__certtypes__idt__serialnumber (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))) (mk___t2 (elts temp___1321) (mk2 (to_rep1 (first (rt temp___1321))) (to_rep1 (last (rt temp___1321))))))))))
(assert (and (= (mk___t1 temp___1537 temp___15371) (issueridt_image (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))) (and (dynamic_invariant (mk___t1 temp___1537 temp___15371) true false true) (= (mk___t1 temp___1537 temp___15371) (let ((temp___870 (to_string (attr__ATTRIBUTE_IMAGE4 (to_rep2 (rec__cryptotypes__issuert__id (us_split_fields1 (rec__certtypes__idt__issuer (us_split_fields3 (rec__cert__attr__contentst__basecertid (us_split_fields7 contents))))))))))) (mk___t1 (elts temp___870) (mk1 (to_rep1 (first (rt temp___870))) (to_rep1 (last (rt temp___870))))))))))
(assert (=> (<= (to_rep1 (first2 temp___15371)) (to_rep1 (last2 temp___15371))) (= o (+ (- (to_rep1 (last2 temp___15371)) (to_rep1 (first2 temp___15371))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___15371)) (to_rep1 (last2 temp___15371)))) (= o 0)))
(assert (=> (<= 1 8) (= o1 (+ (- 8 1) 1))))
(assert (=> (not (<= 1 8)) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ 1 o2)))
...
(assert (= (concat1 (temp___String_Literal_1535 Tuple0) 1 8 temp___1537 (to_rep1 (first2 temp___15371)) (to_rep1 (last2 temp___15371))) temp___1539))
(assert (= (mk 1 o5) temp___15391))
(assert (=> (= (length (mk___t temp___1539 temp___15391)) 0) (= (temp___String_Literal_1538 Tuple0) temp___1541)))
(assert (=> (= (length (mk___t temp___1539 temp___15391)) 0) (= (mk 1 12) temp___15411)))
(assert (=> (not (= (length (mk___t temp___1539 temp___15391)) 0)) (=> (<= 1 12) (= o6 (+ (- 12 1) 1)))))
(assert (=> (not (= (length (mk___t temp___1539 temp___15391)) 0)) (=> (not (<= 1 12)) (= o6 0))))
(assert (=> (not (= (length (mk___t temp___1539 temp___15391)) 0)) (=> (<= (to_rep1 (first temp___15391)) (to_rep1 (last temp___15391))) (= o7 (+ (- (to_rep1 (last temp___15391)) (to_rep1 (first temp___15391))) 1)))))
(assert (=> (not (= (length (mk___t temp___1539 temp___15391)) 0)) (=> (not (<= (to_rep1 (first temp___15391)) (to_rep1 (last temp___15391)))) (= o7 0))))
(assert (=> (not (= (length (mk___t temp___1539 temp___15391)) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length (mk___t temp___1539 temp___15391)) 0)) (= o9 (+ (to_rep1 (first temp___15391)) o8))))
(assert (=> (not (= (length (mk___t temp___1539 temp___15391)) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length (mk___t temp___1539 temp___15391)) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length (mk___t temp___1539 temp___15391)) 0)) (= (concat1 temp___1539 (to_rep1 (first temp___15391)) (to_rep1 (last temp___15391)) (temp___String_Literal_1538 Tuple0) 1 12) temp___1541)))
(assert (=> (not (= (length (mk___t temp___1539 temp___15391)) 0)) (= (mk (to_rep1 (first temp___15391)) o11) temp___15411)))
(assert (=> (= (length (mk___t temp___1541 temp___15411)) 0) (= temp___1542 cert__attr__extractuser__fullstring__assume)))
(assert (=> (= (length (mk___t temp___1541 temp___15411)) 0) (= (mk (to_rep1 (first4 temp___15421)) (to_rep1 (last4 temp___15421))) cert__attr__extractuser__fullstring__assume1)))
(assert (=> (not (= (length (mk___t temp___1541 temp___15411)) 0)) (=> (<= (to_rep1 (first4 temp___15421)) (to_rep1 (last4 temp___15421))) (= o12 (+ (- (to_rep1 (last4 temp___15421)) (to_rep1 (first4 temp___15421))) 1)))))
(assert (=> (not (= (length (mk___t temp___1541 temp___15411)) 0)) (=> (not (<= (to_rep1 (first4 temp___15421)) (to_rep1 (last4 temp___15421)))) (= o12 0))))
(assert (=> (not (= (length (mk___t temp___1541 temp___15411)) 0)) (=> (<= (to_rep1 (first temp___15411)) (to_rep1 (last temp___15411))) (= o13 (+ (- (to_rep1 (last temp___15411)) (to_rep1 (first temp___15411))) 1)))))
(assert (=> (not (= (length (mk___t temp___1541 temp___15411)) 0)) (=> (not (<= (to_rep1 (first temp___15411)) (to_rep1 (last temp___15411)))) (= o13 0))))
(assert (=> (not (= (length (mk___t temp___1541 temp___15411)) 0)) (= o14 (+ o13 o12))))
(assert (=> (not (= (length (mk___t temp___1541 temp___15411)) 0)) (= o15 (+ (to_rep1 (first temp___15411)) o14))))
(assert (=> (not (= (length (mk___t temp___1541 temp___15411)) 0)) (= o16 (- o15 1))))
(assert (=> (not (= (length (mk___t temp___1541 temp___15411)) 0)) (and (= o17 o16) (in_range1 o16))))
(assert (=> (not (= (length (mk___t temp___1541 temp___15411)) 0)) (= (concat1 temp___1541 (to_rep1 (first temp___15411)) (to_rep1 (last temp___15411)) temp___1542 (to_rep1 (first4 temp___15421)) (to_rep1 (last4 temp___15421))) cert__attr__extractuser__fullstring__assume)))
(assert (=> (not (= (length (mk___t temp___1541 temp___15411)) 0)) (= (mk (to_rep1 (first temp___15411)) o17) cert__attr__extractuser__fullstring__assume1)))
