...
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 8)) (and (and (= temp___192 b) (and (= temp___191 done__) (and (= temp___190 r1) (and (= temp___189 b) (and (and (and (not (= done__2 true)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (- i 1))) (= (to_rep (select b2 j3)) (to_rep (select temp___192 j3)))))) (=> (< (to_rep (select c i)) r2) (not (= (consistent c 8) true)))) (and (and (=> (<= 1 8) (in_range1 r2)) (and (<= 1 r2) (<= r2 8))) (and (and (and (= (to_rep o10) r2) (= o11 (store b2 i o10))) (and (= b2 result1) (= b3 o11))) (and (ite (= (to_rep (select c i)) r2) (and (ite (= done__3 true) (= (consistent b4 8) true) (not (= (consistent c 8) true))) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 i)) (= (to_rep (select b4 j3)) (to_rep (select b3 j3)))))) (and (and (and (= o12 (copy_until b3 i c)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 i)) (= (to_rep (select o12 j3)) (to_rep (select b3 j3)))))) (and (ite (= done__4 true) (= (consistent b5 8) true) (not (= (consistent o12 8) true))) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 i)) (= (to_rep (select b5 j3)) (to_rep (select b3 j3))))))) (and (= done__3 done__4) (= b4 b5)))) (or (= done__3 true) (and (not (= done__3 true)) (= r2 8))))))))))) (and (and (= r2 r6) (and (= done__3 done__7) (= b4 b8))) (and (= r7 r2) (and (= done__8 done__3) (= b9 b4)))))))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= (mk_int__ref r8) (mk_int__ref r6))))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= (mk_bool__ref done__9) (mk_bool__ref done__7))))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= (mk_map__ref b10) (mk_map__ref b8))))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= r9 r7)))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= done__10 done__8)))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= b11 b9)))
(assert (=> (not (and (<= 1 r1) (<= r1 8))) (= r1 r8)))
(assert (=> (not (and (<= 1 r1) (<= r1 8))) (= (mk_bool__ref done__9) (mk_bool__ref done__))))
(assert (=> (not (and (<= 1 r1) (<= r1 8))) (= (mk_map__ref b10) (mk_map__ref b))))
(assert (=> (not (and (<= 1 r1) (<= r1 8))) (= r9 r1)))
(assert (=> (not (and (<= 1 r1) (<= r1 8))) (= done__10 done__1)))
(assert (=> (not (and (<= 1 r1) (<= r1 8))) (= b11 b1)))
(assert (= (mk_int__ref r10) (mk_int__ref r8)))
(assert (= (mk_bool__ref done__11) (mk_bool__ref done__9)))
(assert (= (mk_map__ref b12) (mk_map__ref b10)))
(assert (= r11 r9))
(assert (= done__12 done__10))
(assert (= b13 b11))
(assert (<= 1 j2))
(assert (<= j2 (- i 1)))
