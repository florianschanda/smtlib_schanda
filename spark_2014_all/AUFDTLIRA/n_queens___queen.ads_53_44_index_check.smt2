...
(declare-const r Int)
(declare-const temp___216 (Array Int index))
(declare-const temp___215 Bool)
(declare-const temp___214 Int)
(declare-const temp___213 (Array Int index))
(declare-const o index)
(declare-const o1 (Array Int index))
(declare-const o2 (Array Int index))
(declare-const j Int)
...
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= temp___216 b)))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= temp___215 done__)))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= temp___214 r1)))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= temp___213 b)))
(assert (=> (and (<= 1 r1) (<= r1 8)) (and (and (not (= done__2 true)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i 1))) (= (to_rep (select b2 j1)) (to_rep (select temp___216 j1)))))) (=> (< (to_rep (select c i)) r2) (not (= (consistent c 8) true))))))
(assert (=> (and (<= 1 r1) (<= r1 8)) (and (=> (<= 1 8) (in_range1 r2)) (and (<= 1 r2) (<= r2 8)))))
...
(assert (=> (and (<= 1 r1) (<= r1 8)) (=> (= (to_rep (select c i)) r2) (and (ite (= done__3 true) (= (consistent b4 8) true) (not (= (consistent c 8) true))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i)) (= (to_rep (select b4 j1)) (to_rep (select b3 j1)))))))))
(assert (=> (and (<= 1 r1) (<= r1 8)) (=> (not (= (to_rep (select c i)) r2)) (and (= o2 (copy_until b3 i c)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i)) (= (to_rep (select o2 j1)) (to_rep (select b3 j1)))))))))
(assert (=> (and (<= 1 r1) (<= r1 8)) (=> (not (= (to_rep (select c i)) r2)) (and (ite (= done__4 true) (= (consistent b5 8) true) (not (= (consistent o2 8) true))) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i)) (= (to_rep (select b5 j1)) (to_rep (select b3 j1)))))))))
(assert (=> (and (<= 1 r1) (<= r1 8)) (=> (not (= (to_rep (select c i)) r2)) (= done__3 done__4))))
(assert (=> (and (<= 1 r1) (<= r1 8)) (=> (not (= (to_rep (select c i)) r2)) (= b4 b5))))
(assert (=> (and (<= 1 r1) (<= r1 8)) (or (= done__3 true) (and (not (= done__3 true)) (= r2 8)))))
...
(assert (=> (not (and (<= 1 r1) (<= r1 8))) (= done__11 (mk_bool__ref done__))))
