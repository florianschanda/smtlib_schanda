...
(declare-const r Int)
(declare-const temp___218 (Array Int index))
(declare-const temp___217 Bool)
(declare-const temp___216 Int)
(declare-const temp___215 (Array Int index))
...
(assert (= r1 1))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= temp___218 b)))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= temp___217 done__)))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= temp___216 r1)))
(assert (=> (and (<= 1 r1) (<= r1 8)) (= temp___215 b)))
(assert (=> (and (<= 1 r1) (<= r1 8)) (and (and (not (= done__2 true)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i 1))) (= (to_rep (select b2 j1)) (to_rep (select temp___218 j1)))))) (=> (< (to_rep (select c i)) r2) (not (= (consistent c 8) true))))))
