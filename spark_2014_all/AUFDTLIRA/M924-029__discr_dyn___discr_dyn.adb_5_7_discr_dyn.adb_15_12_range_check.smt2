...
(define-fun dynamic_invariant ((temp___expr_174 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 1 10)) (in_range1 temp___expr_174)))
...
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___133 (rec__discr_dyn__r2__b (us_split_fields1 r)))) (to_array temp___133)) (rec__discr_dyn__r2__c (us_split_fields1 r)))))
...
(define-fun dynamic_invariant1 ((temp___expr_191 us_rep1) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool)) Bool (=> (not (= temp___skip_constant_189 true)) (in_range4 3 (to_base temp___expr_191))))
(define-fun default_initial_assumption ((temp___expr_194 us_rep1) (temp___skip_top_level_195 Bool)) Bool (= (to_rep (rec__discr_dyn__r2__a (us_split_discrs2 temp___expr_194))) 3))
...
(define-fun of_base1 ((r us_rep)) us_rep2 (mk___rep2 (us_split_discrs1 r) (mk___split_fields2 (let ((temp___134 (rec__discr_dyn__r2__b (us_split_fields1 r)))) (to_array temp___134)) (rec__discr_dyn__r2__c (us_split_fields1 r)))))
...
(assert (forall ((temp___204 Int) (temp___205 Int)) (let ((temp___203 (temp___202 temp___204 temp___205))) (and (= (select temp___203 1) (of_rep1 temp___204)) (= (select temp___203 2) (of_rep1 temp___205))))))
...
(define-fun dynamic_invariant3 ((temp___expr_185 us_rep) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool)) Bool (let ((temp___186 (rec__discr_dyn__r2__a (us_split_discrs1 temp___expr_185)))) (and (dynamic_property1 1 (to_rep temp___186) (first1 (rec__discr_dyn__r2__b (us_split_fields1 temp___expr_185))) (last1 (rec__discr_dyn__r2__b (us_split_fields1 temp___expr_185)))) (and (= (first1 (rec__discr_dyn__r2__b (us_split_fields1 temp___expr_185))) 1) (= (last1 (rec__discr_dyn__r2__b (us_split_fields1 temp___expr_185))) (to_rep temp___186))))))
(declare-const temp___a_201 Int)
(declare-const us Int)
(declare-const o stb)
(declare-const o1 stb)
(declare-const o2 stb)
(declare-const o3 (Array Int integer))
(declare-const o4 Bool)
(declare-const o5 stb)
(declare-const o6 (Array Int integer))
(declare-const o7 t)
(declare-const o8 Bool)
(declare-const o9 stb)
