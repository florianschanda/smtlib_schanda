...
(assert (forall ((temp___236 Int) (temp___237 Int)) (let ((temp___235 (temp___234 temp___236 temp___237))) (=> (and (dynamic_invariant2 temp___236 true true true true) (dynamic_invariant2 temp___237 true true true true)) (and (= (to_rep1 (select temp___235 1)) temp___236) (= (to_rep1 (select temp___235 2)) temp___237))))))
