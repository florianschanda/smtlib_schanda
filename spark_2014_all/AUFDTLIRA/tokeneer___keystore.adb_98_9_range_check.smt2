...
(assert (not (= (length (mk___t temp___1881 temp___18811)) 0)))
(assert (=> (<= (to_rep1 (first2 temp___18821)) (to_rep1 (last2 temp___18821))) (= o12 (+ (- (to_rep1 (last2 temp___18821)) (to_rep1 (first2 temp___18821))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___18821)) (to_rep1 (last2 temp___18821)))) (= o12 0)))
(assert (=> (<= (to_rep1 (first temp___18811)) (to_rep1 (last temp___18811))) (= o13 (+ (- (to_rep1 (last temp___18811)) (to_rep1 (first temp___18811))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___18811)) (to_rep1 (last temp___18811)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first temp___18811)) o14)))
(assert (= o16 (- o15 1)))
