...
(define-fun cur_board8 () map__ref1 (mk_map__ref1 cur_board6))
...
(assert (=> (and (<= 1 del_line1) (<= del_line1 50)) (= cur_board8 (mk_map__ref1 cur_board4))))
...
(assert (=> (not (and (<= 1 del_line1) (<= del_line1 50))) (= cur_board8 (mk_map__ref1 cur_board))))
