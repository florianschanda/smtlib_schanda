...
(assert (=> (< l2 (to_rep b__last)) (let ((swap_ranges__swap_ranges_with_error__L_1__R31b1 (+ l2 1))) (let ((swap_ranges__swap_ranges_with_error__L_1__R28b (+ l2 1))) (= (bool_eq b (to_rep (first10 (mk5 swap_ranges__swap_ranges_with_error__L_1__R28b (to_rep b__last)))) (to_rep (last10 (mk5 swap_ranges__swap_ranges_with_error__L_1__R28b (to_rep b__last)))) b2 (to_rep (first12 (mk6 swap_ranges__swap_ranges_with_error__L_1__R31b1 (to_rep b__last)))) (to_rep (last12 (mk6 swap_ranges__swap_ranges_with_error__L_1__R31b1 (to_rep b__last))))) true)))))
