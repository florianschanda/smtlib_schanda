...
(declare-const result9 cursor__ref)
(declare-const temp___6792 us_rep)
(declare-const result10 Bool)
(define-fun temp___6793 () us_rep (mk___rep (mk___split_fields temp___6791)))
(define-fun o6 () us_rep (mk___rep (mk___split_fields o5)))
(define-fun o7 () us_rep (mk___rep (mk___split_fields o3)))
(assert (= result int__))
(assert (= int__1 2))
...
(assert (= result4 true))
(assert (and (=> (<= 1 200) (in_range4 int__2)) (and (= (has_element c12b temp___6793) true) (= e3 (element c12b temp___6793)))))
...
(assert (and (= o7 (next c12b temp___6793)) (= o7 (ite (< (to_rep temp___6791) 200) (mk___rep (mk___split_fields (of_rep (+ (to_rep temp___6791) 1)))) (mk___rep (mk___split_fields rliteral1))))))
(assert (and (= o4 (has_element c12b o7)) (= (= o4 true) (and (<= 1 (to_rep o3)) (<= (to_rep o3) 200)))))
(assert (= result8 (ite (not (= o4 true)) true false)))
(assert (not (= result8 true)))
(assert (and (= o6 (next c12b temp___6793)) (= o6 (ite (< (to_rep temp___6791) 200) (mk___rep (mk___split_fields (of_rep (+ (to_rep temp___6791) 1)))) (mk___rep (mk___split_fields rliteral1))))))
(assert (= result9 (mk_cursor__ref temp___6793)))
(assert (= temp___6792 o6))
(assert (and (= result10 (has_element c12b temp___6792)) (= (= result10 true) (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields1 temp___6792)))) (<= (to_rep (rec__container__cursor__index (us_split_fields1 temp___6792))) 200)))))
