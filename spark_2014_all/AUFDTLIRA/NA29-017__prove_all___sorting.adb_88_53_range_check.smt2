...
(assert (and (= o11 (- length2 j2)) (in_range1 (- length2 j2))))
(assert (and (= o12 o11) (in_range2 o11)))
(assert (and (= o10 (+ i2 j2)) (in_range1 (+ i2 j2))))
(assert (and (= o7 (+ a_first length1)) (in_range1 (+ a_first length1))))
(assert (= o8 (+ o7 j2)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (and (= o6 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (= o13 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) o6 o9 o10 o12)))
(assert (and (= o3 (- length1 i2)) (in_range1 (- length1 i2))))
(assert (and (= o4 o3) (in_range2 o3)))
(assert (and (= o2 (+ i2 j2)) (in_range1 (+ i2 j2))))
(assert (and (= o1 (+ a_first i2)) (in_range1 (+ a_first i2))))
(assert (and (= o (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (= o5 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) o o1 o2 o4)))
