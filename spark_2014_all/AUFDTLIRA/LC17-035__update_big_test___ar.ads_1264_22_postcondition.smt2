...
(define-fun dynamic_invariant2 ((temp___expr_182 Int) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool)) Bool (=> (or (= temp___is_init_179 true) (<= 1 25)) (in_range3 temp___expr_182)))
...
(assert (<= n 10))
(assert (not (= n i)))
(assert (not (= (bool_eq (select a2 n) (select a n)) true)))
(check-sat)
(exit)
