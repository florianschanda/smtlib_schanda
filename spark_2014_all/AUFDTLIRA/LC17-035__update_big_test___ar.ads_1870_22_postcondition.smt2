...
(declare-fun temp___4233 ((Array Int us_rep) Int us_rep) (Array Int us_rep))
(assert (forall ((temp___4235 (Array Int us_rep))) (forall ((temp___4236 Int)) (forall ((temp___4237 us_rep)) (let ((temp___4234 (temp___4233 temp___4235 temp___4236 temp___4237))) (forall ((temp___4238 Int)) (ite (= temp___4238 temp___4236) (= (select temp___4234 temp___4238) temp___4237) (= (select temp___4234 temp___4238) (select temp___4235 temp___4238)))))))))
(define-fun dynamic_invariant3 ((temp___expr_182 Int) (temp___is_init_179 Bool) (temp___skip_constant_180 Bool) (temp___do_toplevel_181 Bool)) Bool (=> (or (= temp___is_init_179 true) (<= 1 25)) (in_range3 temp___expr_182)))
