...
(declare-const temp___7866 (Array Int et1))
(declare-const temp___78661 enum2t)
...
(assert (= temp___7866 o2))
(assert (= temp___78661 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= temp___7866 r__split_fields2))
(assert (= temp___78661 r__split_fields3))
