...
(assert (not (ite (= (ite (exists ((op10 Int)) (and (and (<= 1 op10) (<= op10 4)) (and (and (= (str_comp keyedop op10) true) (= (allowedop theadmin op10) true)) (= admin__opisavailable__result4 op10)))) true (= admin__opisavailable__result4 0)) true) (ite (= (ite (exists ((op10 Int)) (and (and (<= 1 op10) (<= op10 4)) (and (and (= (str_comp keyedop op10) true) (= (allowedop theadmin op10) true)) (= admin__opisavailable__result4 op10)))) (= admin__opisavailable__result4 0) false) false) true false) true)))
(check-sat)
(exit)
