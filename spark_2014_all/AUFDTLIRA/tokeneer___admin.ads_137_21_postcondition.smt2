...
(assert (= result7 admin__opisavailable__result4))
(assert (not (ite (= (ite (exists ((op14 Int)) (and (and (<= 1 op14) (<= op14 4)) (and (and (= (str_comp keyedop op14) true) (= (allowedop theadmin op14) true)) (= admin__opisavailable__result4 op14)))) true (= admin__opisavailable__result4 0)) true) (ite (= (ite (exists ((op14 Int)) (and (and (<= 1 op14) (<= op14 4)) (and (and (= (str_comp keyedop op14) true) (= (allowedop theadmin op14) true)) (= admin__opisavailable__result4 op14)))) (= admin__opisavailable__result4 0) false) false) true true) true)))
(check-sat)
(exit)
