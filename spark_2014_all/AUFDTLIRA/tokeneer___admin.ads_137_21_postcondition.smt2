...
(assert (= op1 1))
(assert (=> (and (<= 1 op1) (<= op1 4)) (= temp___591 op1)))
(assert (=> (and (<= 1 op1) (<= op1 4)) (= temp___590 theop1)))
(assert (=> (and (<= 1 op1) (<= op1 4)) (= theop2 0)))
(assert (=> (and (<= 1 op1) (<= op1 4)) (and (and (=> (<= 0 4) (in_range5 theop2)) (=> (<= 1 4) (in_range6 op2))) (and (<= 1 op2) (<= op2 4)))))
(assert (=> (and (<= 1 op1) (<= op1 4)) (or (and (and (= theop3 theop4) (= theop5 theop3)) (and (and (= result2 (str_comp keyedop op2)) (= (= result2 true) (and (and (<= (to_rep5 (rec__admin__datat__minmatchlength (us_split_fields5 (select optokeyed op2)))) (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop)))) (<= (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop))) (to_rep4 (rec__admin__datat__length (us_split_fields5 (select optokeyed op2)))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop))))) (= (to_rep2 (select (rec__admin__datat__text (us_split_fields5 (select optokeyed op2))) i)) (to_rep2 (select (rec__keyboard__datat__text (us_split_fields1 keyedop)) i)))))))) (and (= result2 true) (and (and (and (and (and (<= 1 (to_rep (rec__admin__t__rolepresent (us_split_fields3 theadmin)))) (<= (to_rep (rec__admin__t__rolepresent (us_split_fields3 theadmin))) 3)) (= o (to_rep (rec__admin__t__rolepresent (us_split_fields3 theadmin))))) (= temp___589 (select isavailable o))) (= result3 (select temp___589 op2))) (ite (= result3 true) (and (= theop2 result4) (= theop3 op2)) (= theop3 theop2)))))) (and (and (and (= result2 (str_comp keyedop op2)) (= (= result2 true) (and (and (<= (to_rep5 (rec__admin__datat__minmatchlength (us_split_fields5 (select optokeyed op2)))) (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop)))) (<= (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop))) (to_rep4 (rec__admin__datat__length (us_split_fields5 (select optokeyed op2)))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop))))) (= (to_rep2 (select (rec__admin__datat__text (us_split_fields5 (select optokeyed op2))) i)) (to_rep2 (select (rec__keyboard__datat__text (us_split_fields1 keyedop)) i)))))))) (and (not (= result2 true)) (= theop3 theop2))) (and (and (= theop3 theop4) (= theop5 theop3)) (= op2 4))))))
