...
(assert (= i1 1))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields25 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields26 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i1) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i1)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields26 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields26 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields25 s__attr__tag i1 s__split_fields26)))
(assert (= i1 result1))
(assert (= i2 2))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields24 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields25 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i2) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i2)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields25 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields25 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields24 s__attr__tag i2 s__split_fields25)))
(assert (= i2 result2))
(assert (= i3 3))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields23 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields24 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i3) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i3)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields24 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields24 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields23 s__attr__tag i3 s__split_fields24)))
(assert (= i3 result3))
(assert (= i4 4))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields22 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields23 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i4) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i4)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields23 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields23 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields22 s__attr__tag i4 s__split_fields23)))
(assert (= i4 result4))
(assert (= i5 5))
(assert (and (= (let ((temp___265 (get_model1 s__attr__tag (mk___rep s__split_fields21 s__attr__tag)))) (bool_eq (elts temp___265) (to_rep (first (rt temp___265))) (to_rep (last (rt temp___265))) (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields22 s__attr__tag)))) (ite (= (length temp___264) 0) (singleton1 (of_rep1 i5) 1) (concat_singleton_right (elts temp___264) (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264))) (of_rep1 i5)))) (to_rep (first (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields22 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___264 (get_model1 s__attr__tag (mk___rep s__split_fields22 s__attr__tag)))) (ite (= (length temp___264) 0) (mk 1 1) (mk (to_rep (first (rt temp___264))) (- (+ (to_rep (first (rt temp___264))) (+ (ite (<= (to_rep (first (rt temp___264))) (to_rep (last (rt temp___264)))) (+ (- (to_rep (last (rt temp___264))) (to_rep (first (rt temp___264)))) 1) 0) 1)) 1)))))))) true) (push__specific_post s__attr__tag s__split_fields21 s__attr__tag i5 s__split_fields22)))
(assert (not (= (let ((temp___488 (get_model1 s__attr__tag (mk___rep s__split_fields21 s__attr__tag)))) (bool_eq (elts temp___488) (to_rep (first (rt temp___488))) (to_rep (last (rt temp___488))) (temp_____aggregate_def_478 1 2 3 4 5) 1 5)) true)))
(check-sat)
(exit)
