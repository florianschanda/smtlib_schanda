...
(assert (and (= temp___1026 (model__ (mk___rep2 f_1__split_fields3) y1)) (and (dynamic_invariant6 temp___1026 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1026 y1))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1026 y1)))) 0) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (not (= i6 y1)) (ite (and (not (= (parent (mk___rep2 f_1__split_fields3) i6) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1026 (parent (mk___rep2 f_1__split_fields3) i6)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1026 i6))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1026 i6))) true)))))) (and (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1026 i6))) true) (not (= i6 y1))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1026 (parent (mk___rep2 f_1__split_fields3) i6)))) (position (mk___rep2 f_1__split_fields3) i6) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1026 i6)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1026 i6)))) 0)))) (forall ((i6 Int)) (=> (and (<= 1 i6) (<= i6 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1026 i6))) true) (forall ((j15 Int)) (=> (and (<= 1 j15) (<= j15 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1026 j15))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1026 i6))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1026 j15)))) true)) (= j15 i6))))))))))))))
(assert (= o12 (select temp___1026 x1)))
