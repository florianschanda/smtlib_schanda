...
(assert (not (= (ite (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (last (rt (rec__simple_unc_arrays__table__v res__split_fields4))))) (+ (- (to_rep1 (last (rt (rec__simple_unc_arrays__table__v res__split_fields4)))) (to_rep1 (first (rt (rec__simple_unc_arrays__table__v res__split_fields4))))) 1) 0) (ite (<= 1 r59b) (+ (- r59b 1) 1) 0))))
(check-sat)
(exit)
