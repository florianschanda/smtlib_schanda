...
(assert (and (<= (to_rep1 (first2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))) temp___985) (<= temp___985 (to_rep1 (last2 (rt1 (rec__simple_unc_arrays__table__v res__split_fields4)))))))
(assert (= o temp___985))
