...
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (and (and (= temp___277 min1) (and (= temp___276 index2) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt values))) min1) (<= min1 (to_rep1 (last (rt values))))) (= o1 min1)) (= o2 (select (elts values) o1))) (= o3 (to_rep o2))) (= result2 (ite (< (to_rep (select (elts values) index2)) o3) true false))) (ite (= result2 true) (and (and (= o4 index2) (in_range2 index2)) (and (= min1 result3) (= min2 o4))) (= min2 min1))) (and (and (and (<= (to_rep1 (first (rt values))) min3) (<= min3 (to_rep1 (last (rt values))))) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt values))) i2) (<= i2 index3)) (<= (to_rep (select (elts values) min3)) (to_rep (select (elts values) i2)))))) (and (and (and (=> (<= (to_rep1 (first (rt values))) (to_rep1 (last (rt values)))) (dynamic_property1 (to_rep1 (first (rt values))) (to_rep1 (last (rt values))) index3)) (=> (<= 1 2147483647) (in_range2 min3))) (and (<= (to_rep1 (first (rt values))) index3) (<= index3 (to_rep1 (last (rt values)))))) (= index3 (to_rep1 (last (rt values))))))))) (and (and (= index3 index7) (= min3 min7)) (and (= index8 index3) (= min8 min3))))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= (mk_int__ref index9) (mk_int__ref index7))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= (mk_int__ref min9) (mk_int__ref min7))))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= index10 index8)))
(assert (=> (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values))))) (= min10 min8)))
(assert (=> (not (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values)))))) (= index2 index9)))
(assert (=> (not (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values)))))) (= min1 min9)))
(assert (=> (not (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values)))))) (= index10 index2)))
(assert (=> (not (and (<= (to_rep1 (first (rt values))) index2) (<= index2 (to_rep1 (last (rt values)))))) (= min10 min1)))
...
(assert (= (mk_int__ref result7) (mk_int__ref sort__index_of_minimum__result)))
(assert (= sort__index_of_minimum__result1 min9))
(assert (= (mk_int__ref sort__index_of_minimum__result4) (mk_int__ref sort__index_of_minimum__result2)))
(assert (= (mk_int__ref index11) (mk_int__ref index9)))
(assert (= (mk_int__ref min11) (mk_int__ref min9)))
(assert (= sort__index_of_minimum__result5 sort__index_of_minimum__result3))
(assert (= index12 index10))
(assert (= min12 min10))
(assert (= result8 sort__index_of_minimum__result4))
