...
(assert (and (= temp___763 (model__ (rec__search_trees__search_tree__struct t__split_fields5) o)) (and (dynamic_invariant9 temp___763 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___763 o))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___763 o)))) 0) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (not (= i4 o)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct t__split_fields5) i4) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___763 (parent (rec__search_trees__search_tree__struct t__split_fields5) i4)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___763 i4))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___763 i4))) true)))))) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___763 i4))) true) (not (= i4 o))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___763 (parent (rec__search_trees__search_tree__struct t__split_fields5) i4)))) (position (rec__search_trees__search_tree__struct t__split_fields5) i4) (rec__tree_model__path_type__a (us_split_fields1 (select temp___763 i4)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___763 i4)))) 0)))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___763 i4))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___763 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___763 i4))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___763 j)))) true)) (= j i4))))))))))))))
