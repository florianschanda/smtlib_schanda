...
(assert (and (= o12 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7))) (in_range3 (to_rep1 (rec__search_trees__search_tree__root t__split_fields7)))))
(assert (and (= temp___719 (model__ (rec__search_trees__search_tree__struct t__split_fields7) o12)) (and (dynamic_invariant9 temp___719 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___719 o12))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___719 o12)))) 0) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (not (= i20 o12)) (ite (and (not (= (parent (rec__search_trees__search_tree__struct t__split_fields7) i20) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___719 (parent (rec__search_trees__search_tree__struct t__split_fields7) i20)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___719 i20))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___719 i20))) true)))))) (and (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___719 i20))) true) (not (= i20 o12))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___719 (parent (rec__search_trees__search_tree__struct t__split_fields7) i20)))) (position (rec__search_trees__search_tree__struct t__split_fields7) i20) (rec__tree_model__path_type__a (us_split_fields1 (select temp___719 i20)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___719 i20)))) 0)))) (forall ((i20 Int)) (=> (and (<= 1 i20) (<= i20 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___719 i20))) true) (forall ((j10 Int)) (=> (and (<= 1 j10) (<= j10 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___719 j10))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___719 i20))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___719 j10)))) true)) (= j10 i20))))))))))))))
