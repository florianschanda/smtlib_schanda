...
(define-fun default_initial_assumption ((temp___expr_185 us_rep) (temp___skip_top_level_186 Bool)) Bool (and (and (= (attr__tag temp___expr_185) us_tag) (and (= (rec__stacks__stack_root__content (us_split_fields1 temp___expr_185)) (temp___187 0)) (= (to_rep (rec__stacks__stack_root__length (us_split_fields1 temp___expr_185))) 0))) (=> (not (= temp___skip_top_level_186 true)) (= (size temp___expr_185) 0))))
...
(assert (forall ((temp___189 Int)) (=> (dynamic_invariant3 temp___189 true true true true) (forall ((temp___190 Int)) (= (to_rep1 (select (temp___187 temp___189) temp___190)) temp___189)))))
