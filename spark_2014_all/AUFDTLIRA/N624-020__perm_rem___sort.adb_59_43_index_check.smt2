...
(assert (and (= temp___265 (remove (mk___t init (mk 1 100)) o100)) (and (dynamic_invariant4 temp___265 true false true) (and (= (invariant__ temp___265) true) (and (= (to_rep1 (last (rt temp___265))) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o100 1))) (= (to_rep (select init k)) (to_rep (select (elts temp___265) k))))) (and (forall ((k Int)) (=> (and (<= (+ o100 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select init k)) (to_rep (select (elts temp___265) (- k 1)))))) (forall ((k Int)) (=> (and (<= o100 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select init (+ k 1))) (to_rep (select (elts temp___265) k))))))))))))
