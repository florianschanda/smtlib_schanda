...
(assert (forall ((g1_id3 Int)) (=> (and (<= 1 g1_id3) (<= g1_id3 64)) (forall ((rank6 Int)) (=> (and (<= 1 rank6) (<= rank6 (to_rep3 (select proposals_made1 g1_id3)))) (and (not (= (select unmatched_g2_set2 (to_rep1 (select (select ranking_1 g1_id3) rank6))) true)) (=> (not (= (to_rep (select result__2 (to_rep1 (select (select ranking_1 g1_id3) rank6)))) g1_id3)) (not (= (is_preferred_1 g1_id3 (to_rep (select result__2 (to_rep1 (select (select ranking_1 g1_id3) rank6)))) (select ranking_2 (to_rep1 (select (select ranking_1 g1_id3) rank6)))) true)))))))))
(assert (forall ((g1_id3 Int)) (=> (and (<= 1 g1_id3) (<= g1_id3 64)) (=> (= (to_rep3 (select proposals_made1 g1_id3)) 0) (exists ((idx3 Int)) (and (and (<= 1 idx3) (<= idx3 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) idx3)) g1_id3)))))))
(assert (<= 1 g1_id2))
(assert (<= g1_id2 64))
(assert (= (= result18 true) (forall ((idx3 Int)) (=> (and (<= 1 idx3) (<= idx3 (to_rep3 (rec__stable_marriage__matching__group1_set__cardinality unmatched_g1_set__split_fields4)))) (not (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields4) idx3)) g1_id2))))))
(assert (= result18 true))
(assert (< 0 (to_rep3 (select proposals_made1 g1_id2))))
(assert (not (in_range3 (to_rep3 (select proposals_made1 g1_id2)))))
(check-sat)
(exit)
