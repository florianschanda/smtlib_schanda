...
(assert (<= 1 i2))
(assert (<= i2 2))
(assert (and (forall ((temp___284 Int)) (=> (and (<= (to_rep1 a__first) temp___284) (<= temp___284 (to_rep1 a__last))) (=> (<= i3 temp___284) (= (select a2 temp___284) (select a temp___284))))) (and (<= 1 i3) (<= i3 2))))
(assert (= (to_rep o) 0))
...
(assert (= o3 a3))
(assert (= o3 temp___281))
(assert (= (mk1 (to_rep1 a__first) i3) temp___2811))
(assert (= temp___281 loops_static__loop1__B_2__a_begins__assume))
(assert (= (mk (to_rep1 (first2 temp___2811)) (to_rep1 (last2 temp___2811))) loops_static__loop1__B_2__a_begins__assume1))
...
(assert (<= (to_rep1 (first (rt a_begins))) i1))
(assert (<= i1 (to_rep1 (last (rt a_begins)))))
(assert (not (<= (to_rep1 (first (rt a_begins))) i1)))
(check-sat)
(exit)
