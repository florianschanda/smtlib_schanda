...
(assert (<= 1 i2))
(assert (<= i2 2))
(assert (and (forall ((temp___321 Int)) (=> (and (<= (to_rep1 a__first) temp___321) (<= temp___321 (to_rep1 a__last))) (=> (or (< 2 temp___321) (or (< temp___321 1) (<= i3 temp___321))) (= (select a1 temp___321) (select a temp___321))))) (and (<= 1 i3) (<= i3 2))))
...
(assert (= (mk1 (to_rep1 a__first) i3) temp___3181))
...
(assert (not (<= i1 (to_rep1 (last (rt a_begins))))))
(check-sat)
(exit)
