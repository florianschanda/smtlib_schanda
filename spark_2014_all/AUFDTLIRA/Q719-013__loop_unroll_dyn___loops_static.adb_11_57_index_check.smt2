...
(assert (<= 1 i2))
(assert (<= i2 2))
(assert (and (forall ((temp___319 Int)) (=> (and (<= (to_rep1 a__first) temp___319) (<= temp___319 (to_rep1 a__last))) (=> (<= i3 temp___319) (= (select a1 temp___319) (select a temp___319))))) (and (<= 1 i3) (<= i3 2))))
(assert (= (to_rep o) 0))
...
(assert (= o3 a2))
(assert (= o3 temp___316))
(assert (= (mk1 (to_rep1 a__first) i3) temp___3161))
(assert (= temp___316 loops_static__loop1__B_2__a_begins__assume))
(assert (= (mk (to_rep1 (first2 temp___3161)) (to_rep1 (last2 temp___3161))) loops_static__loop1__B_2__a_begins__assume1))
