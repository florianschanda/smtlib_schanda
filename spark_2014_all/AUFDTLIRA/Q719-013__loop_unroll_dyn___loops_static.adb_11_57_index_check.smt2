...
(assert (<= 1 i2))
(assert (<= i2 2))
(assert (and (forall ((temp___284 Int)) (=> (and (<= (to_rep1 a__first) temp___284) (<= temp___284 (to_rep1 a__last))) (=> (<= i3 temp___284) (= (select a1 temp___284) (select a temp___284))))) (and (<= 1 i3) (<= i3 2))))
(assert (= (to_rep o) 0))
