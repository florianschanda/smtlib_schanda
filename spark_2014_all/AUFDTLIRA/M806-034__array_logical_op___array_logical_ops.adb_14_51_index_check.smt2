...
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 20)) (not (= (of_int (to_rep (select (elts r1) i1))) true)))))
(assert (forall ((i1 Int)) (=> (and (<= 31 i1) (<= i1 40)) (not (= (of_int (to_rep (select (elts r1) i1))) true)))))
(assert (<= 21 i))
(assert (<= i 30))
