...
(assert (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 20)) (not (= (of_int (to_rep (select (elts r1) i3))) true)))))
(assert (forall ((i3 Int)) (=> (and (<= 31 i3) (<= i3 40)) (not (= (of_int (to_rep (select (elts r1) i3))) true)))))
(assert (<= 21 i2))
(assert (<= i2 30))
(assert (not (<= (to_rep1 (first (rt r1))) i2)))
(check-sat)
(exit)
