...
(assert (and (and (and (and (and (and (= (to_rep1 o) 69) (= o1 (store a__split_fields2 23 o))) (and (= a__split_fields o2) (and (= a__split_fields1 o3) (= o1 o4)))) (and (= temp___243 o2) (and (= temp___2431 o3) (= temp___2432 o4)))) (and (= (mk___split_fields__ref (mk___split_fields result result1 result2)) (mk___split_fields__ref (mk___split_fields a__split_fields a__split_fields1 a__split_fields2))) (and (= temp___243 a__split_fields3) (and (= temp___2431 a__split_fields4) (= temp___2432 a__split_fields5))))) (and (and (and (and (and (= (to_rep1 o5) 42) (= o6 (store a__split_fields4 17 o5))) (and (= a__split_fields3 o7) (and (= o6 o8) (= a__split_fields5 o9)))) (and (= temp___246 o7) (and (= temp___2461 o8) (= temp___2462 o9)))) (and (and (= result3 a__split_fields3) (and (= result4 a__split_fields4) (= result5 a__split_fields5))) (and (= temp___246 a__split_fields6) (and (= temp___2461 a__split_fields7) (= temp___2462 a__split_fields8))))) (and (and (and (and (and (= (to_rep1 o10) 23) (= o11 (store a__split_fields7 17 o10))) (and (= a__split_fields6 o12) (and (= o11 o13) (= a__split_fields8 o14)))) (and (= temp___249 o12) (and (= temp___2491 o13) (= temp___2492 o14)))) (and (and (= result6 a__split_fields6) (and (= result7 a__split_fields7) (= result8 a__split_fields8))) (= a__split_fields9 (mk___split_fields temp___249 temp___2491 temp___2492)))) (and (and (and (and (= (to_rep o15) 100) (and (= o15 o16) (and (= (rec__arrays_in_records__record_with_arrays__first_array a__split_fields9) o17) (= (rec__arrays_in_records__record_with_arrays__second_array a__split_fields9) o18)))) (and (= temp___251 o16) (and (= temp___2511 o17) (= temp___2512 o18)))) (and (= result9 (mk___split_fields__ref a__split_fields9)) (= a__split_fields10 (mk___split_fields temp___251 temp___2511 temp___2512)))) (= (to_rep1 (select (rec__arrays_in_records__record_with_arrays__second_array a__split_fields10) 23)) 69))))) (and (= a__split_fields11 (mk___split_fields__ref a__split_fields10)) (= a__split_fields12 a__split_fields10))))
(assert (not (= (to_rep1 (select (rec__arrays_in_records__record_with_arrays__first_array (us_split_fields__content a__split_fields11)) 17)) 42)))
(check-sat)
(exit)
