...
(define-fun p__split_fields22 () us_split_fields (mk___split_fields p__split_fields6 p__split_fields7))
(define-fun p__split_fields23 () us_split_fields (mk___split_fields p__split_fields4 p__split_fields5))
...
(assert (= p__split_fields16 (mk___split_fields__ref p__split_fields22)))
(assert (= c3 c1))
(assert (= found4 found2))
(assert (= p__split_fields17 p__split_fields22))
...
(assert (=> (not (= c1 49)) (=> (= c1 50) (= result8 (mk___split_fields__ref p__split_fields23)))))
(assert (=> (not (= c1 49)) (=> (= c1 50) (= p__split_fields8 (mk___split_fields rliteral1 rliteral)))))
(assert (=> (not (= c1 49)) (=> (= c1 50) (= found2 found1))))
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (= c1 51) (= result9 (mk___split_fields__ref p__split_fields23))))))
...
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (= c1 52) (= result10 (mk___split_fields__ref p__split_fields23)))))))
...
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (= c1 53) (= result11 (mk___split_fields__ref p__split_fields23))))))))
...
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (= c1 54) (= result12 (mk___split_fields__ref p__split_fields23)))))))))
...
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (= c1 55) (= result13 (mk___split_fields__ref p__split_fields23))))))))))
...
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (= c1 56) (= result14 (mk___split_fields__ref p__split_fields23)))))))))))
...
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (not (= c1 56)) (=> (= c1 57) (= result15 (mk___split_fields__ref p__split_fields23))))))))))))
...
(assert (=> (not (= c1 49)) (=> (not (= c1 50)) (=> (not (= c1 51)) (=> (not (= c1 52)) (=> (not (= c1 53)) (=> (not (= c1 54)) (=> (not (= c1 55)) (=> (not (= c1 56)) (=> (not (= c1 57)) (= p__split_fields15 p__split_fields23)))))))))))
...
(assert (=> (not (= c1 49)) (= p__split_fields22 p__split_fields8)))
(assert (= found2 true))
...
(assert (not (= (to_rep2 (select (select my_board (to_rep3 (rec__tictactoe__position__x (us_split_fields__content p__split_fields20)))) (to_rep3 (rec__tictactoe__position__y (us_split_fields__content p__split_fields20))))) 0)))
(check-sat)
(exit)
