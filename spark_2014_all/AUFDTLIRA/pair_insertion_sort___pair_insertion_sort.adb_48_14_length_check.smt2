...
(assert (= (mk___t2 temp___330 temp___3301) (mk___t2 temp___329 temp___3291)))
(assert (not (= (ite (<= (to_rep (first4 temp___3301)) (to_rep (last4 temp___3301))) (+ (- (to_rep (last4 temp___3301)) (to_rep (first4 temp___3301))) 1) 0) (ite (<= (to_rep interm__first) (to_rep interm__last)) (+ (- (to_rep interm__last) (to_rep interm__first)) 1) 0))))
(check-sat)
(exit)
