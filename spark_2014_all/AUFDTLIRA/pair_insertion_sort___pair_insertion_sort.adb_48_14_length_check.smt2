...
(assert (not (= (ite (<= (to_rep (first4 temp___3001)) (to_rep (last4 temp___3001))) (+ (- (to_rep (last4 temp___3001)) (to_rep (first4 temp___3001))) 1) 0) (ite (<= (to_rep interm__first) (to_rep interm__last)) (+ (- (to_rep interm__last) (to_rep interm__first)) 1) 0))))
(check-sat)
(exit)
