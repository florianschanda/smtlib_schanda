...
(assert (forall ((y Int) (array_arith__init3__one Int)) (! (=> (and (dynamic_invariant1 y true true true) (dynamic_invariant array_arith__init3__one true true true)) (dynamic_invariant1 (ident y array_arith__init3__one) true false true)) :pattern ((ident y array_arith__init3__one)))))
