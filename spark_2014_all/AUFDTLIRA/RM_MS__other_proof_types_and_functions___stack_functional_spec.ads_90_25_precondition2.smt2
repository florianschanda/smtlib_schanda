...
(assert (and (= o16 (state__2 (us_split_fields__content my_stack__split_fields4))) (= o16 (mk___rep (us_split_fields__content my_stack__split_fields4)))))
(assert (and (= o17 (count o16)) (and (in_range2 o17) (= o17 (to_rep1 (rec__stack_functional_spec__stack_type__pointer (us_split_fields1 o16)))))))
(assert (= o18 (- o17 2)))
(assert (= o19 (ite (<= i o18) true false)))
(assert (= result3 (ite (<= 1 i) o19 false)))
(assert (= result3 true))
(assert (and (= o21 (stack_entry (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)) i)) (and (in_range1 o21) (= o21 (to_rep (select (rec__stack_functional_spec__stack_type__s (us_split_fields1 (state__2 (mk___split_fields my_stack__split_fields my_stack__split_fields1)))) i))))))
(assert (and (= o20 (state__2 (us_split_fields__content my_stack__split_fields4))) (= o20 (mk___rep (us_split_fields__content my_stack__split_fields4)))))
(assert (not (<= 1 i)))
(check-sat)
(exit)
