...
(assert (<= i5 100))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= temp___1806 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant3 temp___1806 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1806 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1806 root)))) 0) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (not (= i7 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1806 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1806 i7))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1806 i7))) true)))))) (and (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1806 i7))) true) (not (= i7 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___1806 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i7) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1806 i7)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___1806 i7)))) 0)))) (forall ((i7 Int)) (=> (and (<= 1 i7) (<= i7 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1806 i7))) true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___1806 j2))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___1806 i7))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___1806 j2)))) true)) (= j2 i7))))))))))))))
(assert (= o120 (select temp___1806 i5)))
(assert (= o121 (us_split_fields1 o120)))
(assert (= o122 (rec__tree_model__path_type__k o121)))
(assert (= result28 (ite (= o122 true) (ite (not (= i5 v)) true false) false)))
