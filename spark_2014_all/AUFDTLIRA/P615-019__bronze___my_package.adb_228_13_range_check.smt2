...
(assert (forall ((temp___193 Int)) (forall ((temp___194 Int)) (= (select (my_package__bad_aliasing__a__aggregate_def temp___193) temp___194) (of_rep1 temp___193)))))
...
(declare-const my_package__swap__y Int)
(declare-const o11 Int)
(declare-const my_package__swap__x Int)
...
(declare-const my_package__swap__y1 Int)
(declare-const my_package__swap__x1 Int)
...
(assert (and (= o11 (to_rep1 (select a1 1))) (in_range (to_rep1 (select a1 1)))))
(assert (= o11 my_package__swap__x))
(assert (and (in_range my_package__swap__x1) (in_range my_package__swap__y1)))
(assert (not (in_range1 my_package__swap__x1)))
(check-sat)
(exit)
