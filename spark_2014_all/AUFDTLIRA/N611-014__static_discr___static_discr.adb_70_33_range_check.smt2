...
(define-fun o28 () us_rep (mk___rep (mk___split_discrs o20 o21) (mk___split_fields (mk___t o22 o23))))
(define-fun o29 () us_rep (mk___rep (mk___split_discrs o16 o17) (mk___split_fields (mk___t o18 o19))))
...
(assert (and (= o24 (to_rep1 (last6 (rt3 a)))) (in_range2 (to_rep1 (last6 (rt3 a))))))
...
(assert (= (slide (elts3 a) (to_rep1 (first6 (rt3 a))) 1) o6))
(assert (= (mk5 1 (to_rep1 (last6 (rt3 a)))) o7))
(assert (= o8 o6))
(assert (= o9 o7))
(assert (and (= o3 (to_rep1 (last6 (rt3 a)))) (in_range2 (to_rep1 (last6 (rt3 a))))))
(assert (= (to_rep o4) o3))
(assert (and (= o2 (to_rep1 (last6 (rt3 a)))) (in_range2 (to_rep1 (last6 (rt3 a))))))
(assert (= (to_rep o5) o2))
(assert (= o5 o10))
(assert (= o4 o11))
(assert (= o12 o10))
