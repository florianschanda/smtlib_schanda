...
(declare-const o23 t1)
(declare-const o24 Int)
(declare-const o25 natural)
(declare-const o26 us_rep5)
(declare-const o27 us_split_fields12)
(define-fun o28 () us_rep (mk___rep (mk___split_discrs o20 o21) (mk___split_fields (mk___t1 o22 o23))))
(define-fun o29 () us_rep (mk___rep (mk___split_discrs o16 o17) (mk___split_fields (mk___t1 o18 o19))))
...
(assert (and (= o24 (to_rep1 (last (rt a)))) (in_range2 (to_rep1 (last (rt a))))))
...
(assert (= (slide (elts a) (to_rep1 (first (rt a))) 1) o6))
(assert (= (mk5 1 (to_rep1 (last (rt a)))) o7))
(assert (= o8 o6))
(assert (= o9 o7))
(assert (and (= o3 (to_rep1 (last (rt a)))) (in_range2 (to_rep1 (last (rt a))))))
(assert (= (to_rep o4) o3))
(assert (and (= o2 (to_rep1 (last (rt a)))) (in_range2 (to_rep1 (last (rt a))))))
(assert (= (to_rep o5) o2))
(assert (= o5 o10))
(assert (= o4 o11))
(assert (= o12 o10))
...
(assert (= o14 o8))
(assert (= o15 o9))
(assert (= o29 (to_base5 (mk___rep7 (mk___split_discrs o12 o13) (mk___split_fields7 (mk___t5 o14 o15))))))
(assert (= o28 o29))
(assert (= o26 (of_base3 o28)))
(assert (= o27 (mk___split_fields6 o26 o25)))
