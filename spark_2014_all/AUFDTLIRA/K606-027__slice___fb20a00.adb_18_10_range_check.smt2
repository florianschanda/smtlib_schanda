...
(define-fun dynamic_invariant2 ((temp___expr_224 us_t1) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool) (temp___do_typ_inv_223 Bool)) Bool (=> (not (= temp___skip_constant_221 true)) (and (dynamic_property2 (first1 str) (last1 str) (first3 temp___expr_224) (last3 temp___expr_224)) (and (= (first3 temp___expr_224) (first1 str)) (= (last3 temp___expr_224) (last1 str))))))
...
(define-fun dynamic_invariant5 ((temp___expr_217 Int) (temp___is_init_213 Bool) (temp___skip_constant_214 Bool) (temp___do_toplevel_215 Bool) (temp___do_typ_inv_216 Bool)) Bool (=> (or (= temp___is_init_213 true) (<= 97 122)) (in_range4 temp___expr_217)))
