...
(define-fun dynamic_invariant2 ((temp___expr_194 us_t1) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool)) Bool (=> (not (= temp___skip_constant_192 true)) (and (dynamic_property2 (first1 str) (last1 str) (first3 temp___expr_194) (last3 temp___expr_194)) (and (= (first3 temp___expr_194) (first1 str)) (= (last3 temp___expr_194) (last1 str))))))
...
(define-fun dynamic_invariant5 ((temp___expr_188 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 97 122)) (in_range4 temp___expr_188)))
