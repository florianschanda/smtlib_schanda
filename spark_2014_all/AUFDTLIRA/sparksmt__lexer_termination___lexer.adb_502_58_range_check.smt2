...
(assert (not (= (length temp___852) 0)))
(assert (=> (<= 1 1) (= o8 (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o8 0)))
(assert (=> (<= (to_rep1 (first (rt temp___852))) (to_rep1 (last (rt temp___852)))) (= o9 (+ (- (to_rep1 (last (rt temp___852))) (to_rep1 (first (rt temp___852)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___852))) (to_rep1 (last (rt temp___852))))) (= o9 0)))
(assert (= o10 (+ o9 o8)))
(assert (= o11 (+ (to_rep1 (first (rt temp___852))) o10)))
(assert (= o12 (- o11 1)))
