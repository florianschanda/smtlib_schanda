...
(assert (not (= (length temp___940) 0)))
(assert (=> (<= 1 1) (= o7 (+ (- 1 1) 1))))
(assert (=> (not (<= 1 1)) (= o7 0)))
(assert (=> (<= (to_rep1 (first (rt temp___940))) (to_rep1 (last (rt temp___940)))) (= o8 (+ (- (to_rep1 (last (rt temp___940))) (to_rep1 (first (rt temp___940)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___940))) (to_rep1 (last (rt temp___940))))) (= o8 0)))
(assert (= o9 (+ o8 o7)))
(assert (= o10 (+ (to_rep1 (first (rt temp___940))) o9)))
(assert (= o11 (- o10 1)))
