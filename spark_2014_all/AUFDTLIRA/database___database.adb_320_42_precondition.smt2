...
(define-fun o8 () us_rep (mk___rep (mk___split_fields o o1)))
...
(assert (and (= o6 (currency account accounts_balance)) (and (in_range o6) (= o6 (to_rep (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))))))))
(assert (= o7 (ite (= o6 (to_rep (rec__money__amount__currency (us_split_fields1 sum)))) true false)))
(assert (= result1 (ite (not (= o7 true)) true false)))
(assert (=> (= result1 true) (= result true)))
(assert (=> (not (= result1 true)) (and (= o8 (balance account links accounts_balance)) (= o8 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account)))))))
(assert (=> (not (= result1 true)) (= o o2)))
(assert (=> (not (= result1 true)) (= o1 o3)))
(assert (=> (not (= result1 true)) (= o4 o3)))
(assert (=> (not (= result1 true)) (= o5 (to_rep1 o4))))
(assert (=> (not (= result1 true)) (= result (ite (< o5 (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))) true false))))
