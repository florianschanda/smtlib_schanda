...
(assert (forall ((a us_rep) (b us_rep)) (! (=> (and (= (to_rep (rec__money__amount__currency (us_split_fields1 a))) (to_rep (rec__money__amount__currency (us_split_fields1 b)))) (<= (to_rep1 (rec__money__amount__raw (us_split_fields1 b))) (to_rep1 (rec__money__amount__raw (us_split_fields1 a))))) (= (bool_eq (osubtract a b) (mk___rep (mk___split_fields (rec__money__amount__currency (us_split_fields1 a)) (of_rep1 (- (to_rep1 (rec__money__amount__raw (us_split_fields1 a))) (to_rep1 (rec__money__amount__raw (us_split_fields1 b)))))))) true)) :pattern ((osubtract a b)))))
...
(define-fun dynamic_invariant ((temp___expr_215 Int) (temp___is_init_212 Bool) (temp___skip_constant_213 Bool) (temp___do_toplevel_214 Bool)) Bool (=> (or (= temp___is_init_212 true) (<= 1 200000)) (in_range2 temp___expr_215)))
...
(assert (forall ((x ext_account_num)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq4 ((a (Array Int us_rep2)) (a__first Int) (a__last Int) (b (Array Int us_rep2)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_143 Int)) (=> (and (<= a__first temp___idx_143) (<= temp___idx_143 a__last)) (= (bool_eq3 (select a temp___idx_143) (select b (+ (- b__first a__first) temp___idx_143))) true)))) true false))
(assert (forall ((a (Array Int us_rep2)) (b (Array Int us_rep2))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_143 Int)) (=> (and (<= a__first temp___idx_143) (<= temp___idx_143 a__last)) (= (bool_eq3 (select a temp___idx_143) (select b (+ (- b__first a__first) temp___idx_143))) true))))))))
...
(define-fun dynamic_invariant1 ((temp___expr_183 Int) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool (=> (or (= temp___is_init_180 true) (<= 0 6)) (in_range temp___expr_183)))
(assert (forall ((account Int)) (forall ((database__accounts_balance (Array Int us_rep2))) (! (=> (dynamic_invariant account true true true) (dynamic_invariant1 (currency account database__accounts_balance) true false true)) :pattern ((currency account database__accounts_balance))))))
(assert (forall ((account Int)) (forall ((database__accounts_balance (Array Int us_rep2))) (! (=> (dynamic_invariant account true true true) (= (currency account database__accounts_balance) (to_rep (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select database__accounts_balance account)))))))) :pattern ((currency account database__accounts_balance))))))
...
(define-fun dynamic_invariant2 ((temp___expr_209 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 200000)) (in_range3 temp___expr_209)))
(define-fun dynamic_invariant3 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 1000000)) (in_range1 temp___expr_195)))
(declare-const links (Array Int us_rep1))
(declare-const accounts_balance (Array Int us_rep2))
(declare-const o cur)
(declare-const o1 raw_amount)
(declare-const o2 Int)
(declare-const us cur)
(declare-const us1 raw_amount)
(declare-const o3 cur)
(declare-const o4 raw_amount)
(declare-const o5 cur)
(declare-const o6 raw_amount)
(declare-const o7 raw_amount)
...
(declare-const o16 cur)
(declare-const o17 raw_amount)
(declare-const o18 ext_account_num)
(declare-const o19 (Array Int us_rep2))
(declare-const o20 cur)
(declare-const o21 raw_amount)
...
(assert (and (= (existing account links) true) (and (= (currency account accounts_balance) (to_rep (rec__money__amount__currency (us_split_fields1 sum)))) (<= (to_rep1 (rec__money__amount__raw (us_split_fields1 sum))) (to_rep1 (rec__money__amount__raw (us_split_fields1 (balance account links accounts_balance))))))))
(assert (and (= o9 (currency account accounts_balance)) (and (in_range o9) (= o9 (to_rep (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))))))))
(assert (= o10 (ite (= o9 (to_rep (rec__money__amount__currency (us_split_fields1 sum)))) true false)))
(assert (= result3 (ite (not (= o10 true)) true false)))
(assert (=> (= result3 true) (= result2 true)))
(assert (=> (not (= result3 true)) (and (= (mk___rep (mk___split_fields o3 o4)) (balance account links accounts_balance)) (= (mk___rep (mk___split_fields o3 o4)) (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account)))))))
(assert (=> (not (= result3 true)) (= o3 o5)))
(assert (=> (not (= result3 true)) (= o4 o6)))
(assert (=> (not (= result3 true)) (= o7 o6)))
(assert (=> (not (= result3 true)) (= o8 (to_rep1 o7))))
(assert (=> (not (= result3 true)) (= result2 (ite (< o8 (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))) true false))))
(assert (not (= result2 true)))
(assert (not (= (to_rep (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account)))))) (to_rep (rec__money__amount__currency (us_split_fields1 sum))))))
(check-sat)
(exit)
