...
(declare-fun temp_____aggregate_def_257 (us_rep Int Int) us_t2)
(declare-fun temp_____aggregate_def_265 (us_rep) (Array Int us_rep))
...
(assert (forall ((temp___267 us_rep)) (=> (dynamic_invariant4 temp___267 true true true true) (forall ((temp___268 Int)) (= (select (temp_____aggregate_def_265 temp___267) temp___268) temp___267)))))
(assert (forall ((temp___259 us_rep)) (forall ((temp___260 Int) (temp___261 Int)) (let ((temp___258 (temp_____aggregate_def_257 temp___259 temp___260 temp___261))) (=> (dynamic_invariant4 temp___259 true true true true) (and (=> (dynamic_property7 1 2147483647 temp___260 temp___261) (and (= (first5 temp___258) temp___260) (= (last6 temp___258) temp___261))) (forall ((temp___262 Int)) (= (select (to_array2 temp___258) temp___262) temp___259))))))))
(declare-const rliteral natural)
(assert (= (naturalqtint rliteral) 0))
(declare-const dynamic_array__new_holder__result natural)
(declare-const dynamic_array__new_holder__result1 (Array Int us_rep))
(declare-const dynamic_array__new_holder__result2 t)
...
(declare-const temp___263 us_t2)
(declare-const temp___264 us_t2)
(declare-const o21 us_t1)
(declare-const o22 us_split_fields6)
(declare-const o23 us_split_discrs2)
(declare-const o24 us_rep3)
(declare-const o25 us_rep1)
(declare-const result holder__ref)
(declare-const dynamic_array__new_holder__result3 us_rep1)
(declare-const result1 holder__ref)
(declare-const dynamic_array__new_holder__result4 us_rep1)
(declare-const dynamic_array__new_holder__result5 holder__ref)
(declare-const dynamic_array__new_holder__result6 us_rep1)
(declare-const dynamic_array__new_holder__result7 holder__ref)
(declare-const dynamic_array__new_holder__result8 us_rep1)
(declare-const dynamic_array__new_holder__result9 holder__ref)
(declare-const dynamic_array__new_holder__result10 us_rep1)
(define-fun dynamic_array__new_holder__result11 () holder__ref (mk_holder__ref (mk___rep1 (mk___split_discrs1 dynamic_array__new_holder__result) (mk___split_fields1 (mk___t dynamic_array__new_holder__result1 dynamic_array__new_holder__result2)))))
(declare-const result2 natural)
(declare-const result3 (Array Int us_rep))
(declare-const result4 t)
(assert (in_range1 c))
(assert (in_range1 d))
(assert (= dynamic_array__new_holder__result7 dynamic_array__new_holder__result5))
(assert (= dynamic_array__new_holder__result8 dynamic_array__new_holder__result6))
(assert (=> (= c 0) (= dynamic_array__new_holder__result5 (mk_holder__ref dynamic_array__new_holder__result3))))
(assert (=> (= c 0) (= dynamic_array__new_holder__result6 dynamic_array__new_holder__result3)))
(assert (=> (= c 0) (and (= us c) (dynamic_property 0 last c))))
(assert (=> (= c 0) (= o c)))
(assert (=> (= c 0) (= o1 (of_rep1 o))))
(assert (=> (= c 0) (= o1 o2)))
(assert (=> (= c 0) (= dummy3 o3)))
(assert (=> (= c 0) (= (distinct 1 0) usq_)))
(assert (=> (= c 0) (= usq_1 o2)))
(assert (=> (= c 0) (= usq_2 o3)))
(assert (=> (= c 0) (= true usq_3)))
(assert (=> (= c 0) (= usq_ o4)))
(assert (=> (= c 0) (= usq_1 o5)))
(assert (=> (= c 0) (= usq_2 o6)))
(assert (=> (= c 0) (= false o7)))
(assert (=> (= c 0) (= o8 (temp_____aggregate_def_265 (mk___rep (mk___split_discrs o4) (mk___split_fields o5 o6) o7)))))
(assert (=> (= c 0) (= o8 o9)))
(assert (=> (= c 0) (= rliteral o10)))
(assert (=> (= c 0) (= o11 o9)))
(assert (=> (= c 0) (= o10 o12)))
(assert (=> (= c 0) (= o11 o13)))
(assert (=> (= c 0) (= (mk 1 0) o14)))
(assert (=> (= c 0) (= result dynamic_array__new_holder__result11)))
(assert (=> (= c 0) (= dynamic_array__new_holder__result3 (mk___rep1 (mk___split_discrs1 o12) (mk___split_fields1 (mk___t o13 o14))))))
(assert (=> (not (= c 0)) (= dynamic_array__new_holder__result5 (mk_holder__ref dynamic_array__new_holder__result4))))
(assert (=> (not (= c 0)) (= dynamic_array__new_holder__result6 dynamic_array__new_holder__result4)))
(assert (=> (not (= c 0)) (and (= us1 c) (dynamic_property 0 last c))))
(assert (=> (not (= c 0)) (= o16 c)))
(assert (=> (not (= c 0)) (= o17 (of_rep1 o16))))
(assert (=> (not (= c 0)) (= o17 o18)))
(assert (=> (not (= c 0)) (= dummy3 o19)))
(assert (=> (not (= c 0)) (= usq_4 (mk___rep (mk___split_discrs (distinct 1 0)) (mk___split_fields o18 o19) true))))
(assert (=> (not (= c 0)) (= o20 (mk___rep (us_split_discrs1 usq_4) (us_split_fields1 usq_4) false))))
(assert (=> (not (= c 0)) (= temp___263 (temp_____aggregate_def_257 o20 1 d))))
(assert (=> (not (= c 0)) (= (to_rep1 (first4 (rt2 temp___263))) 1)))
(assert (=> (not (= c 0)) (= (to_rep1 (last5 (rt2 temp___263))) d)))
(assert (=> (not (= c 0)) (= temp___264 temp___263)))
(assert (=> (not (= c 0)) (= (ite (<= (to_rep1 (first4 (rt2 temp___264))) (to_rep1 (last5 (rt2 temp___264)))) (+ (- (to_rep1 (last5 (rt2 temp___264))) (to_rep1 (first4 (rt2 temp___264)))) 1) 0) (ite (<= 1 d) (+ (- d 1) 1) 0))))
(assert (=> (not (= c 0)) (= o21 (mk___t1 (elts2 temp___264) (mk1 (to_rep1 (first4 (rt2 temp___264))) (to_rep1 (last5 (rt2 temp___264))))))))
(assert (=> (not (= c 0)) (= o22 (mk___split_fields3 o21))))
(assert (=> (not (= c 0)) (= (to_rep o15) d)))
(assert (=> (not (= c 0)) (= o23 (mk___split_discrs1 o15))))
(assert (=> (not (= c 0)) (= o24 (mk___rep3 o23 o22))))
(assert (=> (not (= c 0)) (= o25 (to_base1 o24))))
(assert (=> (not (= c 0)) (= result1 dynamic_array__new_holder__result11)))
(assert (=> (not (= c 0)) (= dynamic_array__new_holder__result4 o25)))
(assert (= dynamic_array__new_holder__result9 dynamic_array__new_holder__result7))
(assert (= dynamic_array__new_holder__result10 dynamic_array__new_holder__result8))
(assert (= (mk___rep1 (mk___split_discrs1 result2) (mk___split_fields1 (mk___t result3 result4))) (holder__content dynamic_array__new_holder__result9)))
(assert (= c 0))
(assert (not (= (to_rep (rec__dynamic_array__holder__d (us_split_discrs3 (holder__content dynamic_array__new_holder__result9)))) 0)))
(check-sat)
(exit)
