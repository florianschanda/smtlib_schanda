...
(assert (=> (and (<= temp___2176 index1) (<= index1 temp___2177)) (forall ((i1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) i1) (<= i1 index2)) (and (<= 0 (to_rep1 (select n3 i1))) (<= (to_rep1 (select n3 i1)) 9))))))
...
(assert (not (<= i (to_rep1 int_array__last))))
(check-sat)
(exit)
