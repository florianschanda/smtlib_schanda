...
(assert (and (= o15 (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2))))) (and (in_range3 o15) (= o15 (to_rep1 this__split_fields)))))
(assert (and (= o13 (length2 by__)) (in_range1 (length2 by__))))
(assert (= o14 (+ start o13)))
(assert (= o16 (- o14 1)))
(assert (= result2 (ite (< o15 o16) true false)))
(assert (=> (= result2 true) (and (= o17 (length2 by__)) (in_range1 (length2 by__)))))
(assert (=> (= result2 true) (= o18 (+ start o17))))
(assert (=> (= result2 true) (= o19 (- o18 1))))
(assert (=> (= result2 true) (and (= o20 (length1 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (and (in_range3 o20) (= o20 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5))))))))
(assert (=> (= result2 true) (= o23 (ite (= o20 o19) true false))))
(assert (=> (not (= result2 true)) (and (= o21 (length1 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t this__split_fields1 this__split_fields2))))) (and (in_range3 o21) (= o21 (to_rep1 this__split_fields))))))
(assert (=> (not (= result2 true)) (and (= o22 (length1 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (and (in_range3 o22) (= o22 (to_rep1 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5))))))))
(assert (=> (not (= result2 true)) (= o23 (ite (= o22 o21) true false))))
