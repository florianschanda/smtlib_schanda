...
(assert (and (= o20 (length by__)) (in_range1 (length by__))))
(assert (= o21 (+ start o20)))
(assert (= o23 (- o21 1)))
(assert (= result2 (ite (< o22 o23) true false)))
(assert (=> (= result2 true) (and (= o24 (length by__)) (in_range1 (length by__)))))
(assert (=> (= result2 true) (= o25 (+ start o24))))
(assert (=> (= result2 true) (= o26 (- o25 1))))
(assert (=> (= result2 true) (and (= o27 (length2 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (and (in_range4 o27) (= o27 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5))))))))
(assert (=> (= result2 true) (= o30 (ite (= o27 o26) true false))))
(assert (=> (not (= result2 true)) (and (= o28 (length2 (mk___rep this__split_discrs (mk___split_fields this__split_fields (mk___t1 this__split_fields1 this__split_fields2))))) (and (in_range4 o28) (= o28 (to_rep2 this__split_fields))))))
(assert (=> (not (= result2 true)) (and (= o29 (length2 (mk___rep this__split_discrs (us_split_fields__content this__split_fields5)))) (and (in_range4 o29) (= o29 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content this__split_fields5))))))))
(assert (=> (not (= result2 true)) (= o30 (ite (= o29 o28) true false))))
