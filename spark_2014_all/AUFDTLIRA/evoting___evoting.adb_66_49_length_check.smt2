...
(declare-const temp___710 (Array Int character))
(declare-const temp___7101 t2)
(declare-const temp___711 (Array Int character))
(declare-const temp___7111 t1)
(declare-const o8 (Array Int character))
(declare-const temp___714 (Array Int character))
...
(assert (and (and (=> (<= 0 2147483647) (in_range4 last7)) (forall ((temp___721 Int)) (=> (and (<= 0 temp___721) (<= temp___721 20)) (forall ((temp___722 Int)) (=> (and (<= 1 temp___722) (<= temp___722 70)) (=> (< temp___722 1) (= (select (select candidates3 temp___721) temp___722) (select (select candidates2 temp___721) temp___722)))))))) (=> (<= 0 20) (in_range7 current_candidate3))))
...
(assert (= o7 item1))
(assert (= o7 temp___710))
(assert (= (mk2 1 r20b) temp___7101))
(assert (= (ite (<= (to_rep1 (first4 temp___7101)) (to_rep1 (last4 temp___7101))) (+ (- (to_rep1 (last4 temp___7101)) (to_rep1 (first4 temp___7101))) 1) 0) (ite (<= 1 r17b) (+ (- r17b 1) 1) 0)))
(assert (= temp___710 temp___711))
(assert (= (mk1 (to_rep1 (first4 temp___7101)) (to_rep1 (last4 temp___7101))) temp___7111))
(assert (=> (<= 1 r17b) (and (and (<= 1 1) (<= 1 70)) (and (<= 1 r17b) (<= r17b 70)))))
(assert (= o8 (select candidates3 current_candidate3)))
(assert (= o8 temp___714))
(assert (= (mk1 1 r17b) temp___7141))
(assert (not (= (ite (<= (to_rep1 (first2 temp___7111)) (to_rep1 (last2 temp___7111))) (+ (- (to_rep1 (last2 temp___7111)) (to_rep1 (first2 temp___7111))) 1) 0) (ite (<= (to_rep1 (first2 temp___7141)) (to_rep1 (last2 temp___7141))) (+ (- (to_rep1 (last2 temp___7141)) (to_rep1 (first2 temp___7141))) 1) 0))))
(check-sat)
(exit)
