...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_151 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_151 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 4)) 118)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 7)) 101)) :pattern ((temp___String_Literal_151 us_void_param)))))
...
(define-fun dynamic_invariant2 ((temp___expr_533 Int) (temp___is_init_530 Bool) (temp___skip_constant_531 Bool) (temp___do_toplevel_532 Bool)) Bool (=> (or (= temp___is_init_530 true) (<= 0 2)) (in_range6 temp___expr_533)))
...
(define-fun dynamic_invariant3 ((temp___expr_545 Int) (temp___is_init_542 Bool) (temp___skip_constant_543 Bool) (temp___do_toplevel_544 Bool)) Bool (=> (or (= temp___is_init_542 true) (<= 0 20)) (in_range7 temp___expr_545)))
...
(assert (forall ((a (Array Int (Array Int character))) (b (Array Int (Array Int character)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_152 Int)) (=> (and (<= a__first temp___idx_152) (<= temp___idx_152 a__last)) (= (bool_eq (select a temp___idx_152) 1 70 (select b (+ (- b__first a__first) temp___idx_152)) 1 70) true))))))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_155 us_void_param) 1)) 99) (= (to_rep (select (temp___String_Literal_155 us_void_param) 2)) 97)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 3)) 110)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 4)) 100)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 6)) 100)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 7)) 97)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 10)) 115)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 11)) 46)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 12)) 116)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 13)) 120)) (= (to_rep (select (temp___String_Literal_155 us_void_param) 14)) 116)) :pattern ((temp___String_Literal_155 us_void_param)))))
...
(declare-fun temp___616 ((Array Int character)) (Array Int (Array Int character)))
(assert (forall ((temp___618 (Array Int character))) (forall ((temp___619 Int)) (= (select (temp___616 temp___618) temp___619) temp___618))))
(declare-fun temp___620 (Int) (Array Int character))
(assert (forall ((temp___622 Int)) (forall ((temp___623 Int)) (= (select (temp___620 temp___622) temp___623) (of_rep temp___622)))))
...
(assert (= candidates_filename (of_array (temp___String_Literal_155 Tuple0) 1 14)))
...
(declare-const temp___643 Int)
(declare-const temp___640 (Array Int (Array Int character)))
(declare-const temp___639 (Array Int character))
...
(declare-const temp___6301 t2)
(declare-const temp___631 (Array Int character))
(declare-const temp___6311 t1)
(declare-const o8 (Array Int character))
(declare-const temp___634 (Array Int character))
(declare-const temp___6341 t1)
(declare-const temp___636 (Array Int character))
(declare-const temp___6361 t1)
...
(assert (= (mk___t (temp___String_Literal_155 Tuple0) (mk 1 14)) candidates_filename))
...
(assert (= candidates1 (temp___616 (temp___620 32))))
(assert (forall ((temp___626 Int)) (ite (and (<= 1 temp___626) (<= temp___626 7)) (= (select o temp___626) (select no_vote_entry temp___626)) (= (select o temp___626) (select (select candidates1 0) temp___626)))))
...
(assert (forall ((i2 Int)) (=> (and (<= current_candidate3 i2) (<= i2 20)) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 70)) (= (to_rep (select (select candidates3 i2) j2)) 32))))))
(assert (and (and (=> (<= 0 2147483647) (in_range4 last8)) (forall ((temp___641 Int)) (=> (and (<= 0 temp___641) (<= temp___641 20)) (forall ((temp___642 Int)) (=> (and (<= 1 temp___642) (<= temp___642 70)) (=> (< temp___642 1) (= (select (select candidates3 temp___641) temp___642) (select (select candidates2 temp___641) temp___642)))))))) (=> (<= 0 20) (in_range7 current_candidate3))))
(assert (= (to_rep1 o6) 70))
(assert (= (to_rep1 o5) 1))
(assert (in_range4 last9))
(assert (= item2 result5))
(assert (= item3 (slide ada__text_io__get_line__item (to_rep1 (first (mk 1 70))) 1)))
(assert (= last9 r17b))
...
(assert (= o7 item3))
(assert (= o7 temp___630))
(assert (= (mk2 1 r20b) temp___6301))
(assert (= (ite (<= (to_rep1 (first4 temp___6301)) (to_rep1 (last4 temp___6301))) (+ (- (to_rep1 (last4 temp___6301)) (to_rep1 (first4 temp___6301))) 1) 0) (ite (<= 1 r17b) (+ (- r17b 1) 1) 0)))
(assert (= temp___630 temp___631))
(assert (= (mk1 (to_rep1 (first4 temp___6301)) (to_rep1 (last4 temp___6301))) temp___6311))
(assert (=> (<= 1 r17b) (and (and (<= 1 1) (<= 1 70)) (and (<= 1 r17b) (<= r17b 70)))))
(assert (= o8 (select candidates3 current_candidate3)))
(assert (= o8 temp___634))
(assert (= (mk1 1 r17b) temp___6341))
(assert (not (= (ite (<= (to_rep1 (first2 temp___6311)) (to_rep1 (last2 temp___6311))) (+ (- (to_rep1 (last2 temp___6311)) (to_rep1 (first2 temp___6311))) 1) 0) (ite (<= (to_rep1 (first2 temp___6341)) (to_rep1 (last2 temp___6341))) (+ (- (to_rep1 (last2 temp___6341)) (to_rep1 (first2 temp___6341))) 1) 0))))
(check-sat)
(exit)
