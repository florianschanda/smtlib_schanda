...
(define-fun dynamic_invariant2 ((temp___expr_539 Int) (temp___is_init_536 Bool) (temp___skip_constant_537 Bool) (temp___do_toplevel_538 Bool)) Bool (=> (or (= temp___is_init_536 true) (<= 0 2)) (in_range6 temp___expr_539)))
...
(define-fun dynamic_invariant3 ((temp___expr_551 Int) (temp___is_init_548 Bool) (temp___skip_constant_549 Bool) (temp___do_toplevel_550 Bool)) Bool (=> (or (= temp___is_init_548 true) (<= 0 20)) (in_range7 temp___expr_551)))
...
(assert (forall ((temp___624 (Array Int character))) (forall ((temp___625 Int)) (= (select (temp___622 temp___624) temp___625) temp___624))))
(declare-fun temp___626 (Int) (Array Int character))
(assert (forall ((temp___628 Int)) (forall ((temp___629 Int)) (= (select (temp___626 temp___628) temp___629) (of_rep temp___628)))))
...
(declare-const temp___6361 t2)
(declare-const temp___637 (Array Int character))
(declare-const temp___6371 t1)
(declare-const o8 (Array Int character))
(declare-const temp___640 (Array Int character))
(declare-const temp___6401 t1)
...
(assert (forall ((temp___632 Int)) (ite (and (<= 1 temp___632) (<= temp___632 7)) (= (select o temp___632) (select no_vote_entry temp___632)) (= (select o temp___632) (select (select candidates1 0) temp___632)))))
...
(assert (and (and (=> (<= 0 2147483647) (in_range4 last7)) (forall ((temp___647 Int)) (=> (and (<= 0 temp___647) (<= temp___647 20)) (forall ((temp___648 Int)) (=> (and (<= 1 temp___648) (<= temp___648 70)) (=> (< temp___648 1) (= (select (select candidates3 temp___647) temp___648) (select (select candidates2 temp___647) temp___648)))))))) (=> (<= 0 20) (in_range7 current_candidate3))))
...
(assert (= o7 item1))
(assert (= o7 temp___636))
(assert (= (mk2 1 r20b) temp___6361))
(assert (= (ite (<= (to_rep1 (first4 temp___6361)) (to_rep1 (last4 temp___6361))) (+ (- (to_rep1 (last4 temp___6361)) (to_rep1 (first4 temp___6361))) 1) 0) (ite (<= 1 r17b) (+ (- r17b 1) 1) 0)))
(assert (= temp___636 temp___637))
(assert (= (mk1 (to_rep1 (first4 temp___6361)) (to_rep1 (last4 temp___6361))) temp___6371))
(assert (=> (<= 1 r17b) (and (and (<= 1 1) (<= 1 70)) (and (<= 1 r17b) (<= r17b 70)))))
(assert (= o8 (select candidates3 current_candidate3)))
(assert (= o8 temp___640))
(assert (= (mk1 1 r17b) temp___6401))
(assert (not (= (ite (<= (to_rep1 (first2 temp___6371)) (to_rep1 (last2 temp___6371))) (+ (- (to_rep1 (last2 temp___6371)) (to_rep1 (first2 temp___6371))) 1) 0) (ite (<= (to_rep1 (first2 temp___6401)) (to_rep1 (last2 temp___6401))) (+ (- (to_rep1 (last2 temp___6401)) (to_rep1 (first2 temp___6401))) 1) 0))))
(check-sat)
(exit)
