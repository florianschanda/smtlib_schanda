...
(declare-fun temp___547 (us_t Int Int Int) us_t)
...
(assert (forall ((temp___549 us_t)) (forall ((temp___550 Int) (temp___551 Int) (temp___552 Int)) (let ((temp___548 (temp___547 temp___549 temp___550 temp___551 temp___552))) (=> (and (and (and (dynamic_invariant2 temp___549 true true true true) (dynamic_invariant1 temp___550 true true true true)) (dynamic_invariant1 temp___551 true true true true)) (dynamic_invariant temp___552 true true true true)) (and (and (= (first1 temp___548) (first1 temp___549)) (= (last1 temp___548) (last1 temp___549))) (forall ((temp___553 Int)) (ite (and (<= temp___550 temp___553) (<= temp___553 temp___551)) (= (to_rep1 (select (to_array temp___548) temp___553)) temp___552) (= (select (to_array temp___548) temp___553) (select (to_array temp___549) temp___553))))))))))
(declare-const a (Array Int integer))
(declare-const us Int)
(declare-const us1 Int)
(declare-const o Int)
(declare-const o1 Int)
(declare-const temp___556 (Array Int integer))
(declare-const temp___5561 t)
...
(assert (= o1 1))
(assert (= (mk___t temp___556 temp___5561) (temp___547 (mk___t a (mk (to_rep a__first) (to_rep a__last))) o1 o new_val)))
(assert (not (= (ite (<= (to_rep (first temp___5561)) (to_rep (last temp___5561))) (+ (- (to_rep (last temp___5561)) (to_rep (first temp___5561))) 1) 0) (ite (<= (to_rep a__first) (to_rep a__last)) (+ (- (to_rep a__last) (to_rep a__first)) 1) 0))))
(check-sat)
(exit)
