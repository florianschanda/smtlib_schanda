...
(assert (=> (not (< (to_rep (last (rt list))) position1)) (= o4 position1)))
(assert (=> (not (< (to_rep (last (rt list))) position1)) (= o5 (select (elts list) o4))))
(assert (=> (not (< (to_rep (last (rt list))) position1)) (= o6 (to_rep o5))))
(assert (=> (not (< (to_rep (last (rt list))) position1)) (= result1 (ite (= o6 value) true false))))
(assert (not (= result1 true)))
(assert (and (= o7 (+ position1 1)) (in_range1 (+ position1 1))))
(assert (= position1 result2))
(assert (= position2 o7))
(assert (and (and (<= (to_rep (first (rt list))) position3) (<= position3 (+ (to_rep (last (rt list))) 1))) (forall ((j3 Int)) (=> (and (<= (to_rep (first (rt list))) j3) (<= j3 (- position3 1))) (not (= (to_rep (select (elts list) j3)) value))))))
(assert (=> (<= 1 2147483647) (in_range2 position3)))
(assert (=> (< (to_rep (last (rt list))) position3) (= result4 true)))
(assert (=> (not (< (to_rep (last (rt list))) position3)) (and (<= (to_rep (first (rt list))) position3) (<= position3 (to_rep (last (rt list)))))))
(assert (=> (not (< (to_rep (last (rt list))) position3)) (= o10 position3)))
(assert (=> (not (< (to_rep (last (rt list))) position3)) (= o11 (select (elts list) o10))))
(assert (=> (not (< (to_rep (last (rt list))) position3)) (= o12 (to_rep o11))))
(assert (=> (not (< (to_rep (last (rt list))) position3)) (= result4 (ite (= o12 value) true false))))
(assert (not (= result4 true)))
(assert (and (= o13 (+ position3 1)) (in_range1 (+ position3 1))))
(assert (= result5 position3))
(assert (= position4 o13))
