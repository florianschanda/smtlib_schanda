...
(assert (< k1 (to_rep a__last)))
(define-fun swap_ranges__swap_ranges_with_error__L_1__R41b () Int (+ k1 1))
(define-fun swap_ranges__swap_ranges_with_error__L_1__R38b () Int (+ k1 1))
(assert (not (= (bool_eq a (to_rep (first14 (mk7 swap_ranges__swap_ranges_with_error__L_1__R38b (to_rep a__last)))) (to_rep (last14 (mk7 swap_ranges__swap_ranges_with_error__L_1__R38b (to_rep a__last)))) a1 (to_rep (first16 (mk8 swap_ranges__swap_ranges_with_error__L_1__R41b (to_rep a__last)))) (to_rep (last16 (mk8 swap_ranges__swap_ranges_with_error__L_1__R41b (to_rep a__last))))) true)))
(check-sat)
(exit)
