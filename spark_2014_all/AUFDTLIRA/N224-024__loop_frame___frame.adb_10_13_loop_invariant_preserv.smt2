...
(assert (= result3 j2))
(assert (= j3 (+ j2 1)))
(assert (=> (< 10 (to_rep (select a3 j3))) (= (to_rep o8) 10)))
(assert (=> (< 10 (to_rep (select a3 j3))) (= o9 (store a3 j3 o8))))
(assert (=> (< 10 (to_rep (select a3 j3))) (= result4 a3)))
(assert (=> (< 10 (to_rep (select a3 j3))) (= a4 o9)))
(assert (=> (not (< 10 (to_rep (select a3 j3)))) (= a4 a3)))
(declare-const k1 Int)
(assert (<= 1 k1))
(assert (<= k1 j3))
(assert (not (= (to_rep (select a4 k1)) (ite (< 10 (to_rep (select a k1))) 10 (to_rep (select a k1))))))
(check-sat)
(exit)
