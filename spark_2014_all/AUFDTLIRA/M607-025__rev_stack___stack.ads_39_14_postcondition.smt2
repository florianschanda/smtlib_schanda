...
(assert (not (= (let ((temp___262 (to__ (mk___rep (mk___split_fields s__split_fields4 s__split_fields5))))) (bool_eq (elts temp___262) (to_rep1 (first (rt temp___262))) (to_rep1 (last (rt temp___262))) (elts (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))) (to_rep1 (first4 (mk2 1 (- (to_rep1 (last (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) 1)))) (to_rep1 (last4 (mk2 1 (- (to_rep1 (last (rt (to__ (mk___rep (mk___split_fields s__split_fields s__split_fields1)))))) 1)))))) true)))
(check-sat)
(exit)
