...
(assert (and (= o9 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))))
(assert (and (= result (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o9)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t1))) o9) (not (= result true)))))
(assert (= result true))
(assert (not (= (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))) 0)))
(assert (and (= o8 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))))))
(assert (and (= result1 (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o8)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t2))) o8) (not (= result1 true)))))
(assert (= result1 true))
(assert (and (= o7 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))))
(assert (and (= result2 (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o7 (rec__search_trees__search_tree__values (us_split_fields7 t1)))) (= (= result2 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o7) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o7) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o7) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o7) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o7) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o7) i1)))) 1)) 0) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) j)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) i1))) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) i1)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t1)) j))))))))))))
(assert (= result2 true))
(assert (and (= o6 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2)))) (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t2))))))
(assert (and (= result3 (ordered_leafs (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o6 (rec__search_trees__search_tree__values (us_split_fields7 t2)))) (= (= result3 true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o6) i1))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o6) j))) true)) (= (olt (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o6) i1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o6) j)))) true)) (ite (= (get (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o6) j))) (+ (length (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o6) i1)))) 1)) 0) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) j)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i1))) (< (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) i1)) (to_rep2 (select (rec__search_trees__search_tree__values (us_split_fields7 t2)) j))))))))))))
(assert (= result3 true))
(assert (<= 1 i))
(assert (<= i 100))
...
(assert (not (= (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o5) true)))
(check-sat)
(exit)
