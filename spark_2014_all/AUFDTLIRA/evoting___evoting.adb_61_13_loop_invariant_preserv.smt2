...
(assert (= (ite (<= (to_rep1 (first2 temp___7041)) (to_rep1 (last2 temp___7041))) (+ (- (to_rep1 (last2 temp___7041)) (to_rep1 (first2 temp___7041))) 1) 0) (ite (<= (to_rep1 (first2 temp___7071)) (to_rep1 (last2 temp___7071))) (+ (- (to_rep1 (last2 temp___7071)) (to_rep1 (first2 temp___7071))) 1) 0)))
(assert (= (mk___t1 temp___709 temp___7091) (mk___t1 temp___704 temp___7041)))
(assert (forall ((temp___710 Int)) (ite (and (<= 1 temp___710) (<= temp___710 r17b)) (= (select o9 temp___710) (select temp___709 temp___710)) (= (select o9 temp___710) (select (select candidates3 current_candidate3) temp___710)))))
