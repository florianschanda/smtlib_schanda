...
(assert (= (ite (<= (to_rep1 (first2 temp___6311)) (to_rep1 (last2 temp___6311))) (+ (- (to_rep1 (last2 temp___6311)) (to_rep1 (first2 temp___6311))) 1) 0) (ite (<= (to_rep1 (first2 temp___6341)) (to_rep1 (last2 temp___6341))) (+ (- (to_rep1 (last2 temp___6341)) (to_rep1 (first2 temp___6341))) 1) 0)))
(assert (= (mk___t1 temp___636 temp___6361) (mk___t1 temp___631 temp___6311)))
(assert (forall ((temp___637 Int)) (ite (and (<= 1 temp___637) (<= temp___637 r17b)) (= (select o9 temp___637) (select temp___636 temp___637)) (= (select o9 temp___637) (select (select candidates3 current_candidate3) temp___637)))))
...
(assert (= o13 (ite (= o12 true) (ite (< current_candidate3 20) true false) false)))
(assert (= result7 (ite (not (= o13 true)) true false)))
(assert (not (= result7 true)))
(assert (and (= o14 (+ current_candidate3 1)) (in_range7 (+ current_candidate3 1))))
(assert (= result8 current_candidate3))
(assert (= current_candidate4 o14))
(declare-const i2 Int)
(assert (<= current_candidate4 i2))
(assert (<= i2 20))
(declare-const j2 Int)
(assert (<= 1 j2))
(assert (<= j2 70))
(assert (not (= (to_rep (select (select candidates4 i2) j2)) 32)))
(check-sat)
(exit)
