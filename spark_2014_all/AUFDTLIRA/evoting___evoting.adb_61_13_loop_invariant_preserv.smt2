...
(assert (= (ite (<= (to_rep1 (first2 temp___6371)) (to_rep1 (last2 temp___6371))) (+ (- (to_rep1 (last2 temp___6371)) (to_rep1 (first2 temp___6371))) 1) 0) (ite (<= (to_rep1 (first2 temp___6401)) (to_rep1 (last2 temp___6401))) (+ (- (to_rep1 (last2 temp___6401)) (to_rep1 (first2 temp___6401))) 1) 0)))
(assert (= (mk___t1 temp___642 temp___6421) (mk___t1 temp___637 temp___6371)))
(assert (forall ((temp___643 Int)) (ite (and (<= 1 temp___643) (<= temp___643 r17b)) (= (select o9 temp___643) (select temp___642 temp___643)) (= (select o9 temp___643) (select (select candidates3 current_candidate3) temp___643)))))
