...
(assert (= (ite (<= (to_rep1 (first2 temp___7111)) (to_rep1 (last2 temp___7111))) (+ (- (to_rep1 (last2 temp___7111)) (to_rep1 (first2 temp___7111))) 1) 0) (ite (<= (to_rep1 (first2 temp___7141)) (to_rep1 (last2 temp___7141))) (+ (- (to_rep1 (last2 temp___7141)) (to_rep1 (first2 temp___7141))) 1) 0)))
(assert (= (mk___t1 temp___716 temp___7161) (mk___t1 temp___711 temp___7111)))
(assert (forall ((temp___717 Int)) (ite (and (<= 1 temp___717) (<= temp___717 r17b)) (= (select o9 temp___717) (select temp___716 temp___717)) (= (select o9 temp___717) (select (select candidates3 current_candidate3) temp___717)))))
...
(assert (<= 1 j))
(assert (<= j 70))
(assert (not (= (to_rep (select (select candidates4 i) j)) 32)))
(check-sat)
(exit)
