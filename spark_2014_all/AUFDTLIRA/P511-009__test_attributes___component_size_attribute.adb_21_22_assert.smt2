...
(assert (= (ite (<= (to_rep (first2 temp___2151)) (to_rep (last2 temp___2151))) (+ (- (to_rep (last2 temp___2151)) (to_rep (first2 temp___2151))) 1) 0) (ite (<= 1 x) (+ (- x 1) 1) 0)))
(assert (= temp___215 component_size_attribute__p__a1__assume))
(assert (= (mk (to_rep (first2 temp___2151)) (to_rep (last2 temp___2151))) component_size_attribute__p__a1__assume1))
(assert (= result a1))
