...
(assert (= (ite (<= (to_rep (first2 temp___2451)) (to_rep (last2 temp___2451))) (+ (- (to_rep (last2 temp___2451)) (to_rep (first2 temp___2451))) 1) 0) (ite (<= 1 x) (+ (- x 1) 1) 0)))
(assert (= temp___245 component_size_attribute__p__a1__assume))
(assert (= (mk (to_rep (first2 temp___2451)) (to_rep (last2 temp___2451))) component_size_attribute__p__a1__assume1))
(assert (= result a1))
(assert (= a11 component_size_attribute__p__a1__assume))
(assert (= (to_rep a1__first) (to_rep (first component_size_attribute__p__a1__assume1))))
(assert (= (to_rep a1__last) (to_rep (last component_size_attribute__p__a1__assume1))))
(assert (and (dynamic_property1 1 x (to_rep a1__first) (to_rep a1__last)) (and (= (to_rep a1__first) 1) (= (to_rep a1__last) x))))
(assert (= result1 a2))
(assert (= a21 (component_size_attribute__p__a2__aggregate_def (mk___t a11 (mk (to_rep a1__first) (to_rep a1__last))))))
(assert (dynamic_invariant1 a21 true false true true))
(assert (<= 0 (object__component__size1 a21)))
(assert (not (= (object__component__size1 a21) 32)))
(check-sat)
(exit)
