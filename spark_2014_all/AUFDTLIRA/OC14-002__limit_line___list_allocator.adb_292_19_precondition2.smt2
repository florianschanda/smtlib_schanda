...
(assert (= o9 res))
(assert (= (mk___rep1 (mk___split_fields1 o10 o11 o12)) (select data o9)))
(assert (= o10 o13))
(assert (= o11 o14))
(assert (= o12 o15))
(assert (= o16 o14))
...
(assert (and (<= 1 res) (<= res 3)))
(assert (= o18 res))
(assert (= (mk___rep1 (mk___split_fields1 o19 o20 o21)) (select data o18)))
(assert (= o19 o22))
(assert (= o20 o23))
(assert (= o21 o24))
(assert (= o25 o24))
...
(assert (and (<= 1 res) (<= res 3)))
(assert (= o35 res))
(assert (= o36 (store data o35 (mk___rep1 (mk___split_fields1 o32 o33 o34)))))
(assert (= result3 (mk_map__ref data)))
(assert (= data1 o36))
(assert (=> (not (= prev_alloc1 0)) (= (to_rep o37) next_alloc1)))
(assert (=> (not (= prev_alloc1 0)) (= (rec__list_allocator__cell__stat (us_split_fields3 (select data1 prev_alloc1))) o38)))
(assert (=> (not (= prev_alloc1 0)) (= (rec__list_allocator__cell__prev (us_split_fields3 (select data1 prev_alloc1))) o39)))
(assert (=> (not (= prev_alloc1 0)) (= o37 o40)))
(assert (=> (not (= prev_alloc1 0)) (= o41 o38)))
(assert (=> (not (= prev_alloc1 0)) (= o42 o39)))
(assert (=> (not (= prev_alloc1 0)) (= o43 o40)))
(assert (=> (not (= prev_alloc1 0)) (and (<= 1 prev_alloc1) (<= prev_alloc1 3))))
(assert (=> (not (= prev_alloc1 0)) (= o44 prev_alloc1)))
(assert (=> (not (= prev_alloc1 0)) (= o45 (store data1 o44 (mk___rep1 (mk___split_fields1 o41 o42 o43))))))
(assert (=> (not (= prev_alloc1 0)) (= result4 (mk_map__ref data1))))
(assert (=> (not (= prev_alloc1 0)) (= data2 o45)))
(assert (=> (not (not (= prev_alloc1 0))) (= data2 data1)))
(assert (=> (not (= next_alloc1 0)) (= (to_rep o46) prev_alloc1)))
(assert (=> (not (= next_alloc1 0)) (= o47 (mk___split_fields1 (rec__list_allocator__cell__stat (us_split_fields3 (select data2 next_alloc1))) o46 (rec__list_allocator__cell__next (us_split_fields3 (select data2 next_alloc1)))))))
(assert (=> (not (= next_alloc1 0)) (= o48 (mk___rep1 o47))))
(assert (=> (not (= next_alloc1 0)) (and (<= 1 next_alloc1) (<= next_alloc1 3))))
(assert (=> (not (= next_alloc1 0)) (= o49 next_alloc1)))
(assert (=> (not (= next_alloc1 0)) (= o50 (store data2 o49 o48))))
(assert (=> (not (= next_alloc1 0)) (= result5 (mk_map__ref data2))))
(assert (=> (not (= next_alloc1 0)) (= data3 o50)))
...
(assert (and (= o51 (find model____split_fields1 res)) (and (in_range3 o51) (ite (= (mem model____split_fields1 res) true) (and (and (<= 1 o51) (<= o51 (length model____split_fields1))) (= (get model____split_fields1 o51) res)) (= o51 0)))))
(assert (and (= o52 o51) (in_range2 o51)))
(assert (and (= o53 (remove_at model____split_fields1 o52)) (= (is_removed_at model____split_fields1 o52 o53) true)))
(assert (= o54 (mk___split_fields model____split_fields o53)))
(assert (= temp___455 (mk___rep o54)))
(assert (= result8 (mk___split_fields__ref (mk___split_fields model____split_fields model____split_fields1))))
(assert (= model____split_fields2 (us_split_fields1 temp___455)))
(assert (and (= o55 (prepend (rec__list_allocator__m__t__available model____split_fields2) res)) (= (is_prepend (rec__list_allocator__m__t__available model____split_fields2) res o55) true)))
(assert (= o56 (mk___split_fields o55 (rec__list_allocator__m__t__allocated model____split_fields2))))
(assert (= temp___457 (mk___rep o56)))
(assert (= result9 (mk___split_fields__ref model____split_fields2)))
(assert (= model____split_fields3 (us_split_fields1 temp___457)))
...
(assert (=> (not (= first_available1 0)) (and (= o67 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o67))))
(assert (=> (not (= first_available1 0)) (= result12 (ite (< 0 o67) true false))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (and (= o66 (get (rec__list_allocator__m__t__available model____split_fields3) 1)) (in_range4 o66)))))
(assert (=> (not (= first_available1 0)) (=> (= result12 true) (= result11 (ite (= o66 first_available1) true false)))))
(assert (=> (not (= first_available1 0)) (=> (not (= result12 true)) (= result11 false))))
(assert (=> (not (not (= first_available1 0))) (and (= o68 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o68))))
(assert (=> (not (not (= first_available1 0))) (= result11 (ite (= o68 0) true false))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (and (= o64 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o64)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (= result13 (ite (< 0 o64) true false)))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (and (= o63 (get (rec__list_allocator__m__t__allocated model____split_fields3) 1)) (in_range4 o63))))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (= result13 true) (= result10 (ite (= o63 first_allocated2) true false))))))
(assert (=> (= result11 true) (=> (not (= first_allocated2 0)) (=> (not (= result13 true)) (= result10 false)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (and (= o65 (length (rec__list_allocator__m__t__allocated model____split_fields3))) (in_range3 o65)))))
(assert (=> (= result11 true) (=> (not (not (= first_allocated2 0))) (= result10 (ite (= o65 0) true false)))))
(assert (=> (not (= result11 true)) (= result10 false)))
(assert (= result10 true))
(assert (and (= o57 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o57)))
(assert (= o58 (ite (<= j o57) true false)))
(assert (= result14 (ite (<= 1 j) o58 false)))
(assert (= result14 true))
(assert (and (= o62 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range4 o62)))
(assert (= result15 (ite (in_range7 o62) true false)))
(assert (= result15 true))
(assert (and (= o59 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range3 o59)))
(assert (= result16 (ite (< j o59) true false)))
(assert (=> (= result16 true) (and (= o60 (+ j 1)) (in_range1 (+ j 1)))))
(assert (=> (= result16 true) (and (= o61 (get (rec__list_allocator__m__t__available model____split_fields3) o60)) (in_range4 o61))))
(assert (=> (not (= result16 true)) (= o61 0)))
(assert (not (<= 1 j)))
(check-sat)
(exit)
