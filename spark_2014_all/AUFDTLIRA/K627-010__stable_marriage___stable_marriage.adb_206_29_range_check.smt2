...
(assert (= result true))
(assert (= (= o3 true) (forall ((g1_id Int)) (=> (and (<= 1 g1_id) (<= g1_id 64)) (=> (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx (to_rep3 unmatched_g1_set__split_fields1))) (not (= (to_rep (select unmatched_g1_set__split_fields idx)) g1_id)))) (and (< 0 (to_rep3 (select proposals_made g1_id))) (= (to_rep (select result__ (to_rep1 (select (select ranking_1 g1_id) (to_rep3 (select proposals_made g1_id)))))) g1_id)))))))
(assert (= (= o2 true) (forall ((g1_id Int)) (=> (and (<= 1 g1_id) (<= g1_id 64)) (=> (= (to_rep3 (select proposals_made g1_id)) 0) (exists ((idx Int)) (and (and (<= 1 idx) (<= idx (to_rep3 unmatched_g1_set__split_fields1))) (= (to_rep (select unmatched_g1_set__split_fields idx)) g1_id))))))))
(assert (= (= o1 true) (forall ((g1_id Int)) (=> (and (<= 1 g1_id) (<= g1_id 64)) (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank (to_rep3 (select proposals_made g1_id)))) (and (not (= (select unmatched_g2_set (to_rep1 (select (select ranking_1 g1_id) rank))) true)) (=> (not (= (to_rep (select result__ (to_rep1 (select (select ranking_1 g1_id) rank)))) g1_id)) (not (= (is_preferred_1 g1_id (to_rep (select result__ (to_rep1 (select (select ranking_1 g1_id) rank)))) (select ranking_2 (to_rep1 (select (select ranking_1 g1_id) rank)))) true))))))))))
...
(assert (<= 1 (to_rep3 unmatched_g1_set__split_fields1)))
(assert (not (<= 0 1)))
(check-sat)
(exit)
