...
(assert (= (= o18 true) (forall ((g1_id3 Int)) (=> (and (<= 1 g1_id3) (<= g1_id3 64)) (forall ((rank1 Int)) (=> (and (<= 1 rank1) (<= rank1 (to_rep3 (select proposals_made g1_id3)))) (and (not (= (select unmatched_g2_set (to_rep1 (select (select ranking_1 g1_id3) rank1))) true)) (=> (not (= (to_rep (select result__ (to_rep1 (select (select ranking_1 g1_id3) rank1)))) g1_id3)) (not (= (is_preferred_1 g1_id3 (to_rep (select result__ (to_rep1 (select (select ranking_1 g1_id3) rank1)))) (select ranking_2 (to_rep1 (select (select ranking_1 g1_id3) rank1)))) true))))))))))
