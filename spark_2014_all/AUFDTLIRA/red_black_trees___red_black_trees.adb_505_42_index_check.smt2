...
(assert (<= 1 i11))
(assert (<= i11 100))
(assert (and (= o428 (parent (rec__red_black_trees__rbt__struct t__split_fields27) i11)) (and (in_range3 o428) (and (= o428 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields27))) i11)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields27)) 0) (= o428 0))))))
(assert (= result92 (ite (= o428 0) true false)))
(assert (not (= result92 true)))
(assert (and (= temp___733 (parent (rec__red_black_trees__rbt__struct t__split_fields27) i11)) (and (in_range3 temp___733) (and (= temp___733 (parent1 (rec__search_trees__search_tree__struct (us_split_fields7 (rec__red_black_trees__rbt__struct t__split_fields27))) i11)) (=> (= (size (rec__red_black_trees__rbt__struct t__split_fields27)) 0) (= temp___733 0))))))
