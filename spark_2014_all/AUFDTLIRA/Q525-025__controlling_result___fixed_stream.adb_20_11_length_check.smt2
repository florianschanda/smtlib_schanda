...
(assert (not (= (ite (<= (to_rep1 (first6 temp___2951)) (to_rep1 (last6 temp___2951))) (+ (- (to_rep1 (last6 temp___2951)) (to_rep1 (first6 temp___2951))) 1) 0) (ite (<= (to_rep1 change__first) r5b) (+ (- r5b (to_rep1 change__first)) 1) 0))))
(check-sat)
(exit)
