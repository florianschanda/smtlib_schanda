...
(declare-fun isinentryperiod (Int us_rep us_private) Bool)
(declare-fun isinentryperiod__function_guard (Bool Int us_rep us_private) Bool)
...
(define-fun dynamic_invariant ((temp___expr_821 Int) (temp___is_init_818 Bool) (temp___skip_constant_819 Bool) (temp___do_toplevel_820 Bool)) Bool (=> (or (= temp___is_init_818 true) (<= 0 2000)) (in_range8 temp___expr_821)))
(declare-fun thetokenremovalduration (us_private) Int)
(declare-fun thetokenremovalduration__function_guard (Int us_private) Bool)
(assert (forall ((configdata__state us_private)) (! (dynamic_invariant (thetokenremovalduration configdata__state) true false true) :pattern ((thetokenremovalduration configdata__state)))))
...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (= (to_rep6 (rec__stats__t__successentry (us_split_fields3 a))) (to_rep6 (rec__stats__t__successentry (us_split_fields3 b)))) (= (to_rep6 (rec__stats__t__failentry (us_split_fields3 a))) (to_rep6 (rec__stats__t__failentry (us_split_fields3 b))))) (= (to_rep6 (rec__stats__t__successbio (us_split_fields3 a))) (to_rep6 (rec__stats__t__successbio (us_split_fields3 b))))) (= (to_rep6 (rec__stats__t__failbio (us_split_fields3 a))) (to_rep6 (rec__stats__t__failbio (us_split_fields3 b))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_808 Int) (temp___is_init_805 Bool) (temp___skip_constant_806 Bool) (temp___do_toplevel_807 Bool)) Bool (=> (or (= temp___is_init_805 true) (<= 0 5)) (in_range10 temp___expr_808)))
(declare-fun getclass (us_private) Int)
(declare-fun getclass__function_guard (Int us_private) Bool)
(assert (forall ((usertoken__state us_private)) (! (dynamic_invariant1 (getclass usertoken__state) true false true) :pattern ((getclass usertoken__state)))))
...
(define-fun dynamic_invariant2 ((temp___expr_1683 Int) (temp___is_init_1680 Bool) (temp___skip_constant_1681 Bool) (temp___do_toplevel_1682 Bool)) Bool (=> (or (= temp___is_init_1680 true) (<= 0 7)) (in_range11 temp___expr_1683)))
...
(assert true)
(define-fun dynamic_invariant7 ((temp___expr_334 Int) (temp___is_init_331 Bool) (temp___skip_constant_332 Bool) (temp___do_toplevel_333 Bool)) Bool (=> (or (= temp___is_init_331 true) (<= 1 150)) (in_range3 temp___expr_334)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant8 ((temp___expr_376 Int) (temp___is_init_373 Bool) (temp___skip_constant_374 Bool) (temp___do_toplevel_375 Bool)) Bool (=> (or (= temp___is_init_373 true) (<= 1901 2099)) (in_range4 temp___expr_376)))
(define-fun dynamic_invariant9 ((temp___expr_382 Int) (temp___is_init_379 Bool) (temp___skip_constant_380 Bool) (temp___do_toplevel_381 Bool)) Bool (=> (or (= temp___is_init_379 true) (<= 1 12)) (in_range5 temp___expr_382)))
(define-fun dynamic_invariant10 ((temp___expr_388 Int) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool)) Bool (=> (or (= temp___is_init_385 true) (<= 1 31)) (in_range6 temp___expr_388)))
(define-fun dynamic_invariant11 ((temp___expr_412 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= 0 86399999)) (in_range7 temp___expr_412)))
(define-fun dynamic_invariant12 ((temp___expr_1028 Int) (temp___is_init_1025 Bool) (temp___skip_constant_1026 Bool) (temp___do_toplevel_1027 Bool)) Bool (=> (or (= temp___is_init_1025 true) (<= 0 2147483647)) (in_range9 temp___expr_1028)))
...
(declare-const o2 yearst)
(declare-const o3 monthst)
(declare-const o4 dayst)
(declare-const o5 millisecst)
(declare-const o6 (Array Int character))
(declare-const result Bool)
(declare-const result1 Bool)
(define-fun o7 () us_rep (mk___rep (mk___split_fields o2 o3 o4 o5)))
...
(assert (not (= (valid_numberlogentries state1) true)))
(check-sat)
(exit)
