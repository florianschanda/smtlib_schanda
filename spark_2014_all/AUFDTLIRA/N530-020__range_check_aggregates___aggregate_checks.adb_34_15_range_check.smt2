...
(define-fun dynamic_invariant ((temp___expr_151 us_t) (temp___is_init_148 Bool) (temp___skip_constant_149 Bool) (temp___do_toplevel_150 Bool)) Bool (=> (not (= temp___skip_constant_149 true)) (dynamic_property 1 2147483647 (first1 temp___expr_151) (last1 temp___expr_151))))
...
(define-fun a_range__ref___4__projection ((a1 a_range__ref)) integer (a_range__content a1))
(declare-sort t1 0)
(declare-fun first3 (t1) integer)
(declare-fun last3 (t1) integer)
(declare-fun mk1 (Int Int) t1)
(assert (forall ((f Int) (l Int)) (! (=> (in_range2 f) (=> (in_range2 l) (and (= (to_rep (first3 (mk1 f l))) f) (= (to_rep (last3 (mk1 f l))) l)))) :pattern ((mk1 f l)))))
...
(define-fun length1 ((a1 us_t1)) Int (ite (<= (first4 a1) (last4 a1)) (+ (- (last4 a1) (first4 a1)) 1) 0))
...
(declare-datatypes () ((uarray__ref (mk_uarray__ref (uarray__content us_t1)))))
(define-fun uarray__ref___projection ((a1 uarray__ref)) us_t1 (uarray__content a1))
(define-fun dynamic_invariant1 ((temp___expr_245 us_t1) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool)) Bool (=> (not (= temp___skip_constant_243 true)) (dynamic_property2 first2 last2 (first4 temp___expr_245) (last4 temp___expr_245))))
...
(define-fun t15b__ref___projection ((a1 t15b__ref)) integer (t15b__content a1))
(declare-sort t2 0)
(declare-fun first5 (t2) integer)
(declare-fun last5 (t2) integer)
(declare-fun mk2 (Int Int) t2)
(assert (forall ((f Int) (l Int)) (! (=> (in_range2 f) (=> (in_range2 l) (and (= (to_rep (first5 (mk2 f l))) f) (= (to_rep (last5 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
...
(define-fun length2 ((a1 us_t2)) Int (ite (<= (first6 a1) (last6 a1)) (+ (- (last6 a1) (first6 a1)) 1) 0))
...
(define-fun t16b__ref___projection ((a1 t16b__ref)) us_t2 (t16b__content a1))
(declare-const should_fail3 us_t1)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun aggregate_checks__do_wrong_aggregate_4__should_fail3__aggregate_def (Int Int Int) us_t2)
(assert (forall ((temp___143 Int) (temp___144 Int) (temp___145 Int)) (let ((temp___142 (aggregate_checks__do_wrong_aggregate_4__should_fail3__aggregate_def temp___143 temp___144 temp___145))) (and (=> (dynamic_property2 first2 last2 temp___144 temp___145) (and (= (first6 temp___142) temp___144) (= (last6 temp___142) temp___145))) (forall ((temp___146 Int)) (= (select (to_array2 temp___142) temp___146) (of_rep1 temp___143)))))))
...
(define-fun dynamic_invariant5 ((temp___expr_239 Int) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (=> (or (= temp___is_init_236 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_239)))
(assert (= first2 (first1 a)))
(assert (= last2 (last1 a)))
(assert (= should_fail3 (let ((temp___147 (aggregate_checks__do_wrong_aggregate_4__should_fail3__aggregate_def 0 0 (last1 a)))) (of_array1 (to_array2 temp___147) (first6 temp___147) (last6 temp___147)))))
(assert (dynamic_invariant a true false true))
(assert (<= (to_rep (first (rt a))) (to_rep (last (rt a)))))
(assert (<= (to_rep (first (rt a))) (to_rep (last (rt a)))))
(assert (not (<= 1 (to_rep (first (rt a))))))
(check-sat)
(exit)
