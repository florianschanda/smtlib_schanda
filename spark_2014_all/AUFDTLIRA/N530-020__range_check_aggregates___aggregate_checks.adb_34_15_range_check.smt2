...
(define-fun dynamic_invariant1 ((temp___expr_280 us_t1) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool) (temp___do_typ_inv_279 Bool)) Bool (=> (not (= temp___skip_constant_277 true)) (dynamic_property2 first2 last2 (first4 temp___expr_280) (last4 temp___expr_280))))
...
(define-fun dynamic_invariant5 ((temp___expr_273 Int) (temp___is_init_269 Bool) (temp___skip_constant_270 Bool) (temp___do_toplevel_271 Bool) (temp___do_typ_inv_272 Bool)) Bool (=> (or (= temp___is_init_269 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_273)))
(assert (= first2 (first1 a)))
(assert (= last2 (last1 a)))
(assert (= should_fail3 (let ((temp___169 (aggregate_checks__do_wrong_aggregate_4__should_fail3__aggregate_def 0 0 (last1 a)))) (of_array1 (to_array2 temp___169) (first6 temp___169) (last6 temp___169)))))
(assert (forall ((temp___165 Int) (temp___166 Int) (temp___167 Int)) (let ((temp___164 (aggregate_checks__do_wrong_aggregate_4__should_fail3__aggregate_def temp___165 temp___166 temp___167))) (=> (dynamic_invariant2 temp___165 true true true true) (and (=> (dynamic_property2 first2 last2 temp___166 temp___167) (and (= (first6 temp___164) temp___166) (= (last6 temp___164) temp___167))) (forall ((temp___168 Int)) (= (to_rep1 (select (to_array2 temp___164) temp___168)) temp___165)))))))
