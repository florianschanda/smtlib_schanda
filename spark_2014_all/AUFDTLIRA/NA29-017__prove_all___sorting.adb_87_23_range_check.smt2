...
(assert (and (= o15 (- length2 j2)) (in_range1 (- length2 j2))))
...
(assert (and (= o10 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (= o17 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) o10 o13 o14 o16)))
(assert (and (= o7 (- length1 i2)) (in_range1 (- length1 i2))))
(assert (and (= o8 o7) (in_range2 o7)))
(assert (and (= o6 (+ i2 j2)) (in_range1 (+ i2 j2))))
(assert (and (= o5 (+ a_first i2)) (in_range1 (+ a_first i2))))
(assert (and (= o4 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (= o9 (le_array (mk___t b (mk (to_rep b__first) (to_rep b__last))) (mk___t a (mk (to_rep a__first) (to_rep a__last))) o4 o5 o6 o8)))
(assert (and (= o2 (to_rep b__first)) (in_range2 (to_rep b__first))))
(assert (and (= o1 (+ a_first length1)) (in_range1 (+ a_first length1))))
(assert (= o3 (perm2 (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t b (mk (to_rep b__first) (to_rep b__last))) a_first o1 o2 i2 j2)))
