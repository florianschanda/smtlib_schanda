...
(assert (forall ((temp___660 Int)) (forall ((temp___661 Int)) (= (select (temp___658 temp___660) temp___661) (of_rep temp___660)))))
(declare-fun temp___662 (Int Int) (Array Int character))
(assert (forall ((temp___664 Int) (temp___665 Int)) (let ((temp___663 (temp___662 temp___664 temp___665))) (forall ((temp___666 Int)) (ite (= temp___666 1) (= (select temp___663 temp___666) (of_rep temp___664)) (= (select temp___663 temp___666) (of_rep temp___665)))))))
(declare-fun temp___671 (Int) (Array Int character))
(assert (forall ((temp___673 Int)) (forall ((temp___674 Int)) (= (select (temp___671 temp___673) temp___674) (of_rep temp___673)))))
(declare-fun temp___675 (Int Int) (Array Int character))
(assert (forall ((temp___677 Int) (temp___678 Int)) (let ((temp___676 (temp___675 temp___677 temp___678))) (forall ((temp___679 Int)) (ite (= temp___679 1) (= (select temp___676 temp___679) (of_rep temp___677)) (= (select temp___676 temp___679) (of_rep temp___678)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_320 Int) (temp___is_init_317 Bool) (temp___skip_constant_318 Bool) (temp___do_toplevel_319 Bool)) Bool (=> (or (= temp___is_init_317 true) (<= 1 5)) (in_range2 temp___expr_320)))
(assert (= (bool_eq (temp___658 32) 1 5 (temp___662 32 32) 1 5) true))
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields (of_rep1 0) (temp___671 32))) (mk___rep (mk___split_fields (of_rep1 0) (temp___675 32 32)))) true)))
(check-sat)
(exit)
