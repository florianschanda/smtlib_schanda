...
(declare-fun temp___707 (Int) (Array Int character))
(declare-fun temp___711 (Int Int) (Array Int character))
(declare-fun temp___720 (Int) (Array Int character))
(declare-fun temp___724 (Int Int) (Array Int character))
...
(assert (forall ((temp___709 Int)) (=> (dynamic_invariant temp___709 true true true true) (forall ((temp___710 Int)) (= (to_rep (select (temp___707 temp___709) temp___710)) temp___709)))))
(assert (forall ((temp___713 Int) (temp___714 Int)) (let ((temp___712 (temp___711 temp___713 temp___714))) (=> (and (dynamic_invariant temp___713 true true true true) (dynamic_invariant temp___714 true true true true)) (forall ((temp___715 Int)) (ite (= temp___715 1) (= (to_rep (select temp___712 temp___715)) temp___713) (= (to_rep (select temp___712 temp___715)) temp___714)))))))
(assert (forall ((temp___722 Int)) (=> (dynamic_invariant temp___722 true true true true) (forall ((temp___723 Int)) (= (to_rep (select (temp___720 temp___722) temp___723)) temp___722)))))
(assert (forall ((temp___726 Int) (temp___727 Int)) (let ((temp___725 (temp___724 temp___726 temp___727))) (=> (and (dynamic_invariant temp___726 true true true true) (dynamic_invariant temp___727 true true true true)) (forall ((temp___728 Int)) (ite (= temp___728 1) (= (to_rep (select temp___725 temp___728)) temp___726) (= (to_rep (select temp___725 temp___728)) temp___727)))))))
(assert (= (bool_eq (temp___707 32) 1 5 (temp___711 32 32) 1 5) true))
(assert (not (= (bool_eq1 (mk___rep (mk___split_fields (of_rep1 0) (temp___720 32))) (mk___rep (mk___split_fields (of_rep1 0) (temp___724 32 32)))) true)))
(check-sat)
(exit)
