...
(assert (forall ((s us_rep)) (! (dynamic_invariant (count s) true false true true) :pattern ((count s)))))
...
(define-fun dynamic_invariant2 ((temp___expr_163 Int) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool) (temp___do_typ_inv_162 Bool)) Bool (=> (or (= temp___is_init_159 true) (<= 0 100)) (in_range4 temp___expr_163)))
