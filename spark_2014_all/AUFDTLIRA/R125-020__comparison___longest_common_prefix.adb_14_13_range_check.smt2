...
(assert (= (mk_int__ref result4) (mk_int__ref r5b)))
(assert (= r5b2 o11))
(assert (in_range1 r5b2))
(assert (and (= o12 (+ y l1)) (in_range1 (+ y l1))))
(assert (= (mk_int__ref result5) (mk_int__ref r8b)))
(assert (= r8b2 o12))
(assert (in_range1 r8b2))
(assert (= (bool_eq a (to_rep (first4 (mk2 x r5b3))) (to_rep (last4 (mk2 x r5b3))) a (to_rep (first6 (mk3 y r8b3))) (to_rep (last6 (mk3 y r8b3)))) true))
(assert (and (and (=> (<= 0 2147483647) (in_range2 l2)) (=> (<= (- 2147483648) 2147483647) (in_range1 r5b3))) (=> (<= (- 2147483648) 2147483647) (in_range1 r8b3))))
(assert (=> (<= y r8b3) (and (and (<= 1 y) (<= y 1000)) (and (<= 1 r8b3) (<= r8b3 1000)))))
(assert (= o13 a))
(assert (= temp___168 o13))
(assert (= temp___1681 (mk3 y r8b3)))
(assert (<= x r5b3))
(assert (not (<= 1 x)))
(check-sat)
(exit)
