...
(assert (= r5b1 o8))
(assert (in_range1 r5b1))
(assert (and (= o9 (+ y l1)) (in_range1 (+ y l1))))
(assert (= (mk_int__ref result5) (mk_int__ref r8b)))
(assert (= r8b1 o9))
(assert (in_range1 r8b1))
(assert (= (bool_eq a (to_rep (first4 (mk2 x r5b2))) (to_rep (last4 (mk2 x r5b2))) a (to_rep (first6 (mk3 y r8b2))) (to_rep (last6 (mk3 y r8b2)))) true))
(assert (and (and (=> (<= 0 2147483647) (in_range2 l2)) (=> (<= (- 2147483648) 2147483647) (in_range1 r5b2))) (=> (<= (- 2147483648) 2147483647) (in_range1 r8b2))))
(assert (=> (<= y r8b2) (and (and (<= 1 y) (<= y 1000)) (and (<= 1 r8b2) (<= r8b2 1000)))))
(assert (= o10 a))
(assert (= temp___192 o10))
(assert (= temp___1921 (mk3 y r8b2)))
(assert (<= x r5b2))
(assert (not (<= 1 x)))
(check-sat)
(exit)
