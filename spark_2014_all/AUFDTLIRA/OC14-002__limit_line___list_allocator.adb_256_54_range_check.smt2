...
(assert (and (= o68 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 o68)))
(assert (= result12 (ite (in_range4 o68) true false)))
(assert (=> (= result12 true) (and (= o64 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o64))))
(assert (=> (= result12 true) (= result13 (ite (< j o64) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o65 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o66 (get (rec__list_allocator__m__t__available model____split_fields3) o65)) (in_range7 o66)))))
