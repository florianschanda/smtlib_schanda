...
(assert (= result2 true))
(assert (and (= o20 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1))))) (in_range4 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 ki1)))))))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) true))
...
(assert (= o17 (select temp___1786 ki1)))
...
(assert (= o14 (select temp___1785 ki1)))
...
(assert (= o11 (select temp___1782 o10)))
...
(assert (= o7 (select temp___1779 o6)))
