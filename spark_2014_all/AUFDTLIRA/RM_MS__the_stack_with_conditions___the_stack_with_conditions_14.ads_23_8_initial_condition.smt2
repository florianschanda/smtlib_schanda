...
(define-fun dynamic_invariant ((temp___expr_143 Int) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (=> (or (= temp___is_init_140 true) (<= 0 1024)) (in_range1 temp___expr_143)))
(assert true)
(assert (forall ((the_stack_with_conditions_14__pointer Int)) (! (= (= (is_empty the_stack_with_conditions_14__pointer) true) (= the_stack_with_conditions_14__pointer 0)) :pattern ((is_empty the_stack_with_conditions_14__pointer)))))
...
(declare-fun temp___161 (Int) (Array Int integer))
(assert (forall ((temp___163 Int)) (forall ((temp___164 Int)) (= (select (temp___161 temp___163) temp___164) (of_rep temp___163)))))
