...
(assert (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (dynamic_invariant (num_free_slots tictactoe__my_board) true false true) :pattern ((num_free_slots tictactoe__my_board)))))
...
(assert (forall ((temp___740 (Array Int slot))) (forall ((temp___741 Int)) (= (select (temp___738 temp___740) temp___741) temp___740))))
(declare-fun temp___742 (Int) (Array Int slot))
(assert (forall ((temp___744 Int)) (forall ((temp___745 Int)) (= (select (temp___742 temp___744) temp___745) (of_rep temp___744)))))
...
(define-fun dynamic_invariant2 ((temp___expr_519 Int) (temp___is_init_516 Bool) (temp___skip_constant_517 Bool) (temp___do_toplevel_518 Bool)) Bool (=> (or (= temp___is_init_516 true) (<= 0 2)) (in_range temp___expr_519)))
(declare-sort pos 0)
...
(assert (forall ((x Int) (y Int)) (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (=> (and (dynamic_invariant3 x true true true) (dynamic_invariant3 y true true true)) (dynamic_invariant1 (one_free_slot x y tictactoe__my_board) true false true)) :pattern ((one_free_slot x y tictactoe__my_board))))))
...
(assert (forall ((x Int) (y Int)) (forall ((tictactoe__my_board (Array Int (Array Int slot)))) (! (=> (and (dynamic_invariant3 x true true true) (dynamic_invariant3 y true true true)) (dynamic_invariant1 (count_free_slots x y tictactoe__my_board) true false true)) :pattern ((count_free_slots x y tictactoe__my_board))))))
