...
(assert (or (and (and (and (= perm__remove_perm__result6 (mk_int__ref perm__remove_perm__result2)) (and (= ia24 ia28) (= h9 (mk_int__ref h1)))) (and (= perm__remove_perm__result7 perm__remove_perm__result2) (and (= ia25 ia21) (= h10 h1)))) (and (= ib ib2) (and (= (mk_int__ref result1) (mk_int__ref perm__remove_perm__result)) (= perm__remove_perm__result2 1)))) (and (and (not (= ib ib2)) (and (= perm__remove_perm__result2 perm__remove_perm__result) (= perm__remove_perm__result2 perm__remove_perm__result1))) (and (and (and (= perm__remove_perm__result6 perm__remove_perm__result4) (and (= ia24 (mk_int__ref ia22)) (= h9 (mk_int__ref h8)))) (and (= perm__remove_perm__result7 perm__remove_perm__result5) (and (= ia25 ia22) (= h10 h8)))) (and (and (and (= o1 (perm_symmetric aa bb2)) (and (in_range2 o1) (=> (= (of_int o1) true) (= (is_perm bb2 aa) true)))) (and (= h1 result2) (= h2 o1))) (and (= (of_int h2) true) (and (and (and (= o2 (extended_perm bb2 aa)) (and (in_range2 o2) (=> (= (of_int o2) true) (forall ((ia3 Int)) (=> (and (<= (to_rep1 (first (rt bb2))) ia3) (<= ia3 (to_rep1 (last (rt bb2))))) (exists ((ib3 Int)) (and (and (<= (to_rep1 (first (rt aa))) ib3) (<= ib3 (to_rep1 (last (rt aa))))) (and (= (to_rep (select (elts bb2) ia3)) (to_rep (select (elts aa) ib3))) (= (is_perm (remove bb2 ia3) (remove aa ib3)) true))))))))) (and (= h2 result3) (= h3 o2))) (and (= (of_int h3) true) (and (ite (< ib ib2) (and (and (and (= o3 (get_witness bb2 aa ib)) (and (in_range3 o3) (and (and (<= (to_rep1 (first (rt aa))) o3) (<= o3 (to_rep1 (last (rt aa))))) (and (= (to_rep (select (elts bb2) ib)) (to_rep (select (elts aa) o3))) (= (is_perm (remove bb2 ib) (remove aa o3)) true))))) (and (= (mk_int__ref result4) ia28) (= ia22 o3))) (and (and (and (= o4 (remove_swap b ib ib2)) (and (in_range2 o4) (=> (= (of_int o4) true) (= (let ((temp___157 (remove (remove b ib2) ib))) (let ((temp___156 (remove (remove b ib) (- ib2 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))) (and (= h3 result5) (= h4 o4))) (and (= (of_int h4) true) (and (and (and (and (and (= o9 (- ib2 1)) (in_range3 (- ib2 1))) (and (= o28 (remove bb o9)) (and (dynamic_invariant2 o28 true false true) (and (= (invariant__ o28) true) (and (= (to_rep1 (last o11)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o9 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o10 k))))) (and (forall ((k Int)) (=> (and (<= (+ o9 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o10 (- k 1)))))) (forall ((k Int)) (=> (and (<= o9 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o10 k)))))))))))) (and (and (= o29 (remove aa ia22)) (and (dynamic_invariant2 o29 true false true) (and (= (invariant__ o29) true) (and (= (to_rep1 (last o8)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia22 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o7 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia22 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o7 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia22 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o7 k))))))))))) (and (and (= o30 (remove bb2 ib)) (and (dynamic_invariant2 o30 true false true) (and (= (invariant__ o30) true) (and (= (to_rep1 (last o6)) (- (to_rep1 (last (rt bb2))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib 1))) (= (to_rep (select (elts bb2) k)) (to_rep (select o5 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib 1) k) (<= k (to_rep1 (last (rt bb2))))) (= (to_rep (select (elts bb2) k)) (to_rep (select o5 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib k) (<= k (- (to_rep1 (last (rt bb2))) 1))) (= (to_rep (select (elts bb2) (+ k 1))) (to_rep (select o5 k))))))))))) (and (= o12 (shift_perm_l o30 o29 o28)) (and (in_range2 o12) (=> (= (of_int o12) true) (= (is_perm o28 o29) true))))))) (and (= h4 result6) (= h5 o12))) (= (of_int h5) true))))) (and (and (and (and (and (= o13 (- ib 1)) (in_range3 (- ib 1))) (and (= o14 (get_witness bb2 aa o13)) (and (in_range3 o14) (and (and (<= (to_rep1 (first (rt aa))) o14) (<= o14 (to_rep1 (last (rt aa))))) (and (= (to_rep (select (elts bb2) o13)) (to_rep (select (elts aa) o14))) (= (is_perm (remove bb2 o13) (remove aa o14)) true)))))) (and (= result7 ia28) (= ia23 o14))) (and (and (and (= o15 (remove_swap b ib2 ib)) (and (in_range2 o15) (=> (= (of_int o15) true) (= (let ((temp___157 (remove (remove b ib) ib2))) (let ((temp___156 (remove (remove b ib2) (- ib 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))) (and (= result8 (mk_int__ref h3)) (= h6 o15))) (and (= (of_int h6) true) (and (and (and (and (= o25 (remove bb ib2)) (and (dynamic_invariant2 o25 true false true) (and (= (invariant__ o25) true) (and (= (to_rep1 (last o22)) (- (to_rep1 (last (rt bb))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ib2 1))) (= (to_rep (select (elts bb) k)) (to_rep (select o21 k))))) (and (forall ((k Int)) (=> (and (<= (+ ib2 1) k) (<= k (to_rep1 (last (rt bb))))) (= (to_rep (select (elts bb) k)) (to_rep (select o21 (- k 1)))))) (forall ((k Int)) (=> (and (<= ib2 k) (<= k (- (to_rep1 (last (rt bb))) 1))) (= (to_rep (select (elts bb) (+ k 1))) (to_rep (select o21 k))))))))))) (and (and (= o26 (remove aa ia23)) (and (dynamic_invariant2 o26 true false true) (and (= (invariant__ o26) true) (and (= (to_rep1 (last o20)) (- (to_rep1 (last (rt aa))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- ia23 1))) (= (to_rep (select (elts aa) k)) (to_rep (select o19 k))))) (and (forall ((k Int)) (=> (and (<= (+ ia23 1) k) (<= k (to_rep1 (last (rt aa))))) (= (to_rep (select (elts aa) k)) (to_rep (select o19 (- k 1)))))) (forall ((k Int)) (=> (and (<= ia23 k) (<= k (- (to_rep1 (last (rt aa))) 1))) (= (to_rep (select (elts aa) (+ k 1))) (to_rep (select o19 k))))))))))) (and (and (and (= o16 (- ib 1)) (in_range3 (- ib 1))) (and (= o27 (remove bb2 o16)) (and (dynamic_invariant2 o27 true false true) (and (= (invariant__ o27) true) (and (= (to_rep1 (last o18)) (- (to_rep1 (last (rt bb2))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o16 1))) (= (to_rep (select (elts bb2) k)) (to_rep (select o17 k))))) (and (forall ((k Int)) (=> (and (<= (+ o16 1) k) (<= k (to_rep1 (last (rt bb2))))) (= (to_rep (select (elts bb2) k)) (to_rep (select o17 (- k 1)))))) (forall ((k Int)) (=> (and (<= o16 k) (<= k (- (to_rep1 (last (rt bb2))) 1))) (= (to_rep (select (elts bb2) (+ k 1))) (to_rep (select o17 k)))))))))))) (and (= o23 (shift_perm_l o27 o26 o25)) (and (in_range2 o23) (=> (= (of_int o23) true) (= (is_perm o25 o26) true))))))) (and (= result9 (mk_int__ref h6)) (= h7 o23))) (= (of_int h7) true))))) (and (= ia22 ia23) (= h5 h7)))) (and (and (and (= o24 (perm_symmetric bb aa)) (and (in_range2 o24) (=> (= (of_int o24) true) (= (is_perm aa bb) true)))) (and (= result10 (mk_int__ref h5)) (= h8 o24))) (and (and (= perm__remove_perm__result4 (mk_int__ref perm__remove_perm__result3)) (= perm__remove_perm__result5 perm__remove_perm__result3)) (and (= result11 (mk_int__ref perm__remove_perm__result2)) (= perm__remove_perm__result3 h8)))))))))))))
