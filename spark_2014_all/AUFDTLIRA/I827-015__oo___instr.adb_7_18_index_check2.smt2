...
(assert (and (forall ((temp___349 Int)) (=> (and (<= 1 temp___349) (<= temp___349 14)) (=> (or (< (to_rep1 (last (rt s))) temp___349) (or (< temp___349 (to_rep1 (first (rt s)))) (<= j2 temp___349))) (= (select x__split_fields1 temp___349) (select x__split_fields temp___349))))) (and (<= (to_rep1 (first (rt s))) j2) (<= j2 (to_rep1 (last (rt s)))))))
