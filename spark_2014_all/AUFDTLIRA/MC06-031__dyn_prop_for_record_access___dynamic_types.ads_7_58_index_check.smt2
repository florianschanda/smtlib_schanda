...
(define-fun dynamic_invariant1 ((temp___expr_137 us_t) (temp___is_init_134 Bool) (temp___skip_constant_135 Bool) (temp___do_toplevel_136 Bool)) Bool (=> (not (= temp___skip_constant_135 true)) (dynamic_property 1 2147483647 (first1 temp___expr_137) (last1 temp___expr_137))))
...
(define-fun a_range__ref___projection ((a1 a_range__ref)) integer (a_range__content a1))
(define-fun dynamic_invariant2 ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= first2 last2)) (dynamic_property1 first2 last2 temp___expr_152)))
...
(assert (forall ((a1 (Array Int integer)) (b (Array Int integer))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (forall ((i Int)) (! (and (=> (and (<= a_first i) (<= i a_last)) (= (select (concat2 a1 a_first a_last b b_first b_last) i) (select a1 i))) (=> (< a_last i) (= (select (concat2 a1 a_first a_last b b_first b_last) i) (select b (+ (- i a_last) (- b_first 1)))))) :pattern ((select (concat2 a1 a_first a_last b b_first b_last) i)))))))
...
(define-fun bool_eq2 ((a1 (Array Int integer)) (a__first Int) (a__last Int) (b (Array Int integer)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep1 (select a1 temp___idx_133)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_133))))))) true false))
(assert (forall ((a1 (Array Int integer)) (b (Array Int integer))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a1 a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (to_rep1 (select a1 temp___idx_133)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_133)))))))))))
(declare-fun compare1 ((Array Int integer) Int Int (Array Int integer) Int Int) Int)
(assert (forall ((a1 (Array Int integer)) (b (Array Int integer))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a1 a_first a_last b b_first b_last) 0) (= (bool_eq2 a1 a_first a_last b b_first b_last) true)) :pattern ((compare1 a1 a_first a_last b b_first b_last))))))
(assert (forall ((a1 (Array Int integer)) (b (Array Int integer))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a1 a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a1 a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep1 (select a1 (+ i 1))) (to_rep1 (select b (+ j 1))))))))))) :pattern ((compare1 a1 a_first a_last b b_first b_last))))))
(assert (forall ((a1 (Array Int integer)) (b (Array Int integer))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a1 a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a1 a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep1 (select b (+ i 1))) (to_rep1 (select a1 (+ j 1))))))))))) :pattern ((compare1 a1 a_first a_last b b_first b_last))))))
...
(define-fun us_split_fields_From__projection ((a1 us_split_fields)) (Array Int integer) (rec__dynamic_types__search__result_type__from a1))
(define-fun us_split_fields_Result__projection ((a1 us_split_fields)) natural (rec__dynamic_types__search__result_type__result a1))
...
(define-fun bool_eq3 ((a1 us_rep) (b us_rep)) Bool (ite (and (= (bool_eq2 (rec__dynamic_types__search__result_type__from (us_split_fields1 a1)) 1 1 (rec__dynamic_types__search__result_type__from (us_split_fields1 b)) 1 1) true) (= (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 a1))) (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 b))))) true false))
...
(define-fun result_type__ref___projection ((a1 result_type__ref)) us_rep (result_type__content a1))
...
(define-fun dynamic_invariant3 ((temp___expr_167 us_rep) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool)) Bool (forall ((temp___168 Int)) (=> (and (<= 1 temp___168) (<= temp___168 1)) (=> (or (= temp___is_init_164 true) (<= first2 last2)) (dynamic_property1 first2 last2 (to_rep1 (select (rec__dynamic_types__search__result_type__from (us_split_fields1 temp___expr_167)) temp___168)))))))
(declare-fun search_range (Int) us_rep)
(declare-fun search_range__function_guard (us_rep Int) Bool)
(assert (forall ((from Int)) (! (=> (and (dynamic_invariant from true true true) (and (<= (first1 a) from) (<= from (last1 a)))) (let ((result (search_range from))) (and (or (and (= (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 result))) 0) (forall ((i Int)) (=> (and (<= from i) (<= i (to_rep1 (let ((temp___176 (rec__dynamic_types__search__result_type__from (us_split_fields1 result)))) (select temp___176 1))))) (not (= (to_rep (select (to_array a) i)) c))))) (and (and (<= (first1 a) (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 result)))) (<= (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 result))) (last1 a))) (= (to_rep (select (to_array a) (to_rep (rec__dynamic_types__search__result_type__result (us_split_fields1 result))))) c))) (dynamic_invariant3 result true false true)))) :pattern ((search_range from)))))
...
(define-fun dynamic_invariant6 ((temp___expr_158 (Array Int integer)) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (forall ((temp___159 Int)) (=> (and (<= 1 temp___159) (<= temp___159 1)) (=> (or (= temp___is_init_155 true) (<= first2 last2)) (dynamic_property1 first2 last2 (to_rep1 (select temp___expr_158 temp___159)))))))
...
(declare-const temp___1801 natural)
...
(declare-const from9 int__ref)
(declare-const result__7 int__ref)
(declare-const tmp__split_fields10 us_split_fields__ref)
(declare-const dynamic_types__search__result9 int__ref)
(declare-const from10 Int)
(declare-const result__8 Int)
(declare-const tmp__split_fields11 us_split_fields)
(declare-const dynamic_types__search__result10 Int)
(declare-const from11 int__ref)
(declare-const result__9 int__ref)
(declare-const tmp__split_fields12 us_split_fields__ref)
(declare-const dynamic_types__search__result11 int__ref)
(declare-const from12 Int)
(declare-const result__10 Int)
(declare-const tmp__split_fields13 us_split_fields)
(declare-const dynamic_types__search__result12 Int)
(declare-const from13 int__ref)
(declare-const result__11 int__ref)
(declare-const tmp__split_fields14 us_split_fields__ref)
(declare-const dynamic_types__search__result13 int__ref)
(declare-const from14 Int)
(declare-const result__12 Int)
(declare-const tmp__split_fields15 us_split_fields)
(declare-const dynamic_types__search__result14 Int)
(assert (dynamic_invariant1 a true false true))
(assert (in_range2 c))
(assert (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))))
(assert (and (= us (to_rep1 (first (rt a)))) (dynamic_property1 first2 last2 (to_rep1 (first (rt a))))))
(assert (= o (to_rep1 (first (rt a)))))
(assert (= (mk_int__ref result) (mk_int__ref from)))
(assert (= from1 o))
(assert (dynamic_property1 first2 last2 from1))
(assert (=> (<= 0 2147483647) (in_range2 result__)))
(assert (dynamic_invariant3 (mk___rep (mk___split_fields tmp__split_fields tmp__split_fields1)) false false true))
(assert (and (and (and (= dynamic_types__search__result11 (mk_int__ref dynamic_types__search__result3)) (and (= tmp__split_fields12 (mk___split_fields__ref (mk___split_fields tmp__split_fields4 tmp__split_fields5))) (and (= result__9 (mk_int__ref result__2)) (= from11 (mk_int__ref from3))))) (and (= dynamic_types__search__result12 dynamic_types__search__result4) (and (= tmp__split_fields13 (mk___split_fields tmp__split_fields4 tmp__split_fields5)) (and (= result__10 result__2) (= from12 from3))))) (and (and (= tmp__split_fields temp___185) (= tmp__split_fields1 temp___1851)) (and (= temp___184 result__) (and (= temp___183 from1) (and (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (- from2 1))) (not (= (to_rep (select (elts a) i1)) c)))) (and (and (and (=> (<= first2 last2) (dynamic_property1 first2 last2 from2)) (=> (<= 0 2147483647) (in_range2 result__1))) (dynamic_invariant3 (mk___rep (mk___split_fields tmp__split_fields2 tmp__split_fields3)) false true true)) (and (and (and (and (= o3 from2) (in_range2 from2)) (and (= (mk___rep (mk___split_fields temp___180 temp___1801)) (search_range o3)) (and (dynamic_invariant3 (mk___rep (mk___split_fields temp___180 temp___1801)) true false true) (or (and (= (to_rep temp___1801) 0) (forall ((i1 Int)) (=> (and (<= o3 i1) (<= i1 (to_rep1 (select temp___180 1)))) (not (= (to_rep (select (elts a) i1)) c))))) (and (and (<= (to_rep1 (first (rt a))) (to_rep temp___1801)) (<= (to_rep temp___1801) (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) (to_rep temp___1801))) c)))))) (and (and (= result2 tmp__split_fields2) (= result3 tmp__split_fields3)) (and (= temp___180 tmp__split_fields4) (= temp___1801 tmp__split_fields5)))) (and (and (= result__1 result4) (= result__2 (to_rep tmp__split_fields5))) (and (and (= from2 result5) (= from3 (to_rep1 (select tmp__split_fields4 1)))) (or (and (and (= dynamic_types__search__result1 dynamic_types__search__result3) (= dynamic_types__search__result4 dynamic_types__search__result1)) (and (< 0 result__2) (and (= dynamic_types__search__result result6) (= dynamic_types__search__result1 result__2)))) (and (and (not (< 0 result__2)) (= dynamic_types__search__result1 dynamic_types__search__result)) (and (and (= dynamic_types__search__result2 dynamic_types__search__result3) (= dynamic_types__search__result4 dynamic_types__search__result2)) (and (= from3 (to_rep1 (last (rt a)))) (and (= dynamic_types__search__result1 result7) (= dynamic_types__search__result2 0))))))))))))))))
(assert (= dynamic_types__search__result13 dynamic_types__search__result11))
(assert (= tmp__split_fields14 tmp__split_fields12))
(assert (= result__11 result__9))
(assert (= from13 from11))
(assert (= dynamic_types__search__result14 dynamic_types__search__result12))
(assert (= tmp__split_fields15 tmp__split_fields13))
(assert (= result__12 result__10))
(assert (= from14 from12))
(assert (not (= (int__content dynamic_types__search__result13) 0)))
(assert (<= (to_rep1 (first (rt a))) (int__content dynamic_types__search__result13)))
(assert (<= (int__content dynamic_types__search__result13) (to_rep1 (last (rt a)))))
(assert (not (<= (to_rep1 (first (rt a))) (int__content dynamic_types__search__result13))))
(check-sat)
(exit)
