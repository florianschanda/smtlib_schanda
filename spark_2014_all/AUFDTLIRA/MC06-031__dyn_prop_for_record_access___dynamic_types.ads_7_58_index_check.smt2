...
(define-fun temp___1802 () us_rep (mk___rep (mk___split_fields temp___180 temp___1801)))
...
(assert (= from5 from3))
(assert (and (= tmp__split_fields temp___185) (= tmp__split_fields1 temp___1851)))
(assert (= temp___184 result__))
(assert (= temp___183 from1))
(assert (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt a))) i) (<= i (- from2 1))) (not (= (to_rep (select (elts a) i)) c)))))
...
(assert (and (= temp___1802 (search_range o1)) (and (dynamic_invariant3 temp___1802 true false true) (or (and (= (to_rep temp___1801) 0) (forall ((i Int)) (=> (and (<= o1 i) (<= i (to_rep1 (select temp___180 1)))) (not (= (to_rep (select (elts a) i)) c))))) (and (and (<= (to_rep1 (first (rt a))) (to_rep temp___1801)) (<= (to_rep temp___1801) (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) (to_rep temp___1801))) c))))))
...
(assert (= from7 from5))
(assert (not (= (int__content dynamic_types__search__result7) 0)))
(assert (<= (to_rep1 (first (rt a))) (int__content dynamic_types__search__result7)))
(assert (<= (int__content dynamic_types__search__result7) (to_rep1 (last (rt a)))))
(assert (not (<= (to_rep1 (first (rt a))) (int__content dynamic_types__search__result7))))
(check-sat)
(exit)
