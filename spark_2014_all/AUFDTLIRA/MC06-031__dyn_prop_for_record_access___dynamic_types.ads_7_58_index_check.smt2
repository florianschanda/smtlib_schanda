...
(assert (<= (to_rep1 (first1 (rt a))) (int__content dynamic_types__search__result7)))
(assert (<= (int__content dynamic_types__search__result7) (to_rep1 (last1 (rt a)))))
(assert (not (<= (int__content dynamic_types__search__result7) (to_rep1 (last1 (rt a))))))
(check-sat)
(exit)
