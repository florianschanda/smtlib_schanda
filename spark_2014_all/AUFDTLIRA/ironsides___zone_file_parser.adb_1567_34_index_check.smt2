...
(assert (<= r102b i40))
(assert (<= i40 r103b))
(assert (and (<= 1 begidx17) (<= (+ (- endidx13 begidx17) 1) 128)))
(assert (and (=> (<= r102b r103b) (dynamic_property2 r102b r103b i41)) (and (<= r102b i41) (<= i41 r103b))))
(assert (= (to_rep o14) (to_rep (select zonefileline i41))))
(assert (and (= o12 (+ i41 1)) (in_range1 (+ i41 1))))
(assert (= o13 (- o12 begidx17)))
(assert (and (= temp___1744 o13) (in_range1 o13)))
(assert (not (<= 1 temp___1744)))
(check-sat)
(exit)
