...
(assert (=> (= (length2 (mk___t2 temp___559 temp___5591)) 0) (= temp___560 temp___561)))
(assert (=> (= (length2 (mk___t2 temp___559 temp___5591)) 0) (= (mk (to_rep1 (first6 temp___5601)) (to_rep1 (last8 temp___5601))) temp___5611)))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (<= (to_rep1 (first6 temp___5601)) (to_rep1 (last8 temp___5601))) (= o2 (+ (- (to_rep1 (last8 temp___5601)) (to_rep1 (first6 temp___5601))) 1)))))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (not (<= (to_rep1 (first6 temp___5601)) (to_rep1 (last8 temp___5601)))) (= o2 0))))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (<= (to_rep1 (first4 temp___5591)) (to_rep1 (last6 temp___5591))) (= o3 (+ (- (to_rep1 (last6 temp___5591)) (to_rep1 (first4 temp___5591))) 1)))))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (=> (not (<= (to_rep1 (first4 temp___5591)) (to_rep1 (last6 temp___5591)))) (= o3 0))))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= o4 (+ o3 o2))))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= o5 (+ 1 o4))))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (and (= o7 o6) (in_range2 o6))))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= (slide (concat1 temp___559 (to_rep1 (first4 temp___5591)) (to_rep1 (last6 temp___5591)) temp___560 (to_rep1 (first6 temp___5601)) (to_rep1 (last8 temp___5601))) (to_rep1 (first4 temp___5591)) 1) temp___561)))
(assert (=> (not (= (length2 (mk___t2 temp___559 temp___5591)) 0)) (= (mk 1 o7) temp___5611)))
(assert (not (dynamic_property1 1 2147483647 (to_rep1 (first temp___5611)) (to_rep1 (last temp___5611)))))
(check-sat)
(exit)
