...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_888 us_void_param) 1)) 72) (= (to_rep (select (temp___String_Literal_888 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_888 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_888 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_888 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_888 us_void_param) 6)) 32)) :pattern ((temp___String_Literal_888 us_void_param)))))
(declare-fun temp___String_Literal_889 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_889 us_void_param) 1)) 87) (= (to_rep (select (temp___String_Literal_889 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_889 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_889 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_889 us_void_param) 5)) 100)) (= (to_rep (select (temp___String_Literal_889 us_void_param) 6)) 46)) :pattern ((temp___String_Literal_889 us_void_param)))))
