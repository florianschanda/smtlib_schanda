...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_802 us_void_param) 1)) 72) (= (to_rep (select (temp___String_Literal_802 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_802 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_802 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_802 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_802 us_void_param) 6)) 32)) :pattern ((temp___String_Literal_802 us_void_param)))))
(declare-fun temp___String_Literal_803 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_803 us_void_param) 1)) 87) (= (to_rep (select (temp___String_Literal_803 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_803 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_803 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_803 us_void_param) 5)) 100)) (= (to_rep (select (temp___String_Literal_803 us_void_param) 6)) 46)) :pattern ((temp___String_Literal_803 us_void_param)))))
...
(assert (and (and (and (and (and (and (= (is_open standard_output1) true) (= (mode__2 standard_output1) 1)) (= (let ((temp___776 (name standard_output))) (let ((temp___775 (name standard_output1))) (bool_eq (elts temp___775) (to_rep1 (first (rt temp___775))) (to_rep1 (last (rt temp___775))) (elts temp___776) (to_rep1 (first (rt temp___776))) (to_rep1 (last (rt temp___776)))))) true)) (= (let ((temp___778 (form standard_output))) (let ((temp___777 (form standard_output1))) (bool_eq (elts temp___777) (to_rep1 (first (rt temp___777))) (to_rep1 (last (rt temp___777))) (elts temp___778) (to_rep1 (first (rt temp___778))) (to_rep1 (last (rt temp___778)))))) true)) (= (line_length__2 standard_output1) (line_length__2 standard_output))) (= (page_length__2 standard_output1) (page_length__2 standard_output))) (= (is_standard_output standard_output1) true)))
