...
(define-fun o11 () us_rep (mk___rep (mk___split_discrs o6) (mk___split_fields o7 o8) o9))
...
(assert (= dummy o4))
(assert (= true o5))
(assert (= o11 (mk___rep (mk___split_discrs o2) (mk___split_fields o3 o4) o5)))
(assert (= temp___2684 o11))
...
(assert (not (= 1 (to_rep2 (rec__p_init__t__e (us_split_discrs1 o10))))))
(check-sat)
(exit)
