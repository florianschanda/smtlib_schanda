...
(assert (= result true))
(assert (and (= result1 (belongs_to account customer id accounts)) (= (= result1 true) (= (bool_eq5 (select accounts account) (mk___rep2 (mk___split_fields2 customer id (of_rep3 account)))) true))))
(assert (= result1 true))
