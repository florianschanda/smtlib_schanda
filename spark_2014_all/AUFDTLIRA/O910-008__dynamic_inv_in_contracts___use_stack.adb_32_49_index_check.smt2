...
(define-fun dynamic_invariant2 ((temp___expr_192 us_t) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool)) Bool (=> (not (= temp___skip_constant_190 true)) (and (dynamic_property1 1 max (first1 temp___expr_192) (last1 temp___expr_192)) (and (= (first1 temp___expr_192) 1) (= (last1 temp___expr_192) max)))))
(declare-const i Int)
