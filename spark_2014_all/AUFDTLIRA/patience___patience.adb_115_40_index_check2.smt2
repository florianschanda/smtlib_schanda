...
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o116 i1))
(assert (= temp___750 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o116)))
(assert (and (<= 0 k) (<= k 99)))
(assert (= o117 k))
(assert (= o118 (select temp___750 o117)))
(assert (= temp___751 (to_rep o118)))
(assert (and (<= 0 temp___751) (<= temp___751 99)))
(assert (= o119 temp___751))
(assert (= o120 (select (rec__patience__state__values (us_split_fields__content s__split_fields20)) o119)))
(assert (= o121 (to_rep1 o120)))
(assert (and (<= 0 i1) (<= i1 99)))
(assert (= o115 i1))
(assert (= temp___746 (select (rec__patience__state__stacks (us_split_fields__content s__split_fields20)) o115)))
(assert (not (<= 0 j)))
(check-sat)
(exit)
