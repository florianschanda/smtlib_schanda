...
(assert (<= 1 n10))
(assert (<= n10 100))
(assert (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (and (and (and (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c87b))) i1))) true) (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select (nb_blacks c87b) i1)))) n11)) (not (= i1 y1))) (not (= i1 c89b))) (= (eq (select (nb_blacks c88b) i1) (select (nb_blacks c87b) i1)) true)))))
...
(assert (<= 1 i))
(assert (<= i 100))
(assert (and (= temp___906 (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)))) (and (dynamic_invariant5 temp___906 true false true true) (= temp___906 (model__1 (rec__search_trees__search_tree__struct (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)))) (to_rep (rec__search_trees__search_tree__root (us_split_fields5 (rec__red_black_trees__rbt__struct (us_split_fields9 c87b))))))))))
(assert (= o54 (select temp___906 i)))
(assert (= o55 (us_split_fields7 o54)))
(assert (= result18 (rec__tree_model__path_type__k o55)))
(assert (=> (= result18 true) (and (= temp___907 (nb_blacks c87b)) (and (= (bool_eq11 (select temp___907 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c87b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___907 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___907 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___907 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___907 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___907 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___907 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___907 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___907 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___907 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c87b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___907 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 0)))))))))))))))
(assert (=> (= result18 true) (= o50 (select temp___907 i))))
...
(assert (and (= temp___905 (nb_blacks c87b)) (and (= (bool_eq11 (select temp___905 0) (mk___rep5 (mk___split_fields5 (distinct 1 0) rliteral rliteral))) true) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields7 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c87b))) i1))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___905 i1))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___905 i1)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___905 i1)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c87b)) i1)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___905 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c87b)) i1 0))))))))))))))
(assert (= o58 (select temp___905 i)))
