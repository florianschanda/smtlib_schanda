...
(assert (and (= o (thetokentry state1)) (in_range5 o)))
(assert (= (mk_int__ref result) (mk_int__ref tokentry)))
(assert (= tokentry1 o))
(assert (=> (= tokentry1 2) (and (= o1 (thetokenid state1)) (in_range4 o1))))
(assert (=> (= tokentry1 2) (= (mk_int__ref result1) (mk_int__ref tokenid))))
(assert (=> (= tokentry1 2) (= tokenid2 o1)))
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (and (= o2 (therole (mk___rep4 (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields2)))) (in_range15 o2)))))
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (= result2 (ite (in_range6 o2) true false)))))
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (=> (= result2 true) (= result3 roleok)))))
...
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (=> (not (= result2 true)) (= o3 (makedescription (mk___t (temp___String_Literal_1343 Tuple0) (mk 1 47))))))))
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (=> (not (= result2 true)) (= result4 description1)))))
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (=> (not (= result2 true)) (= description2 o3)))))
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (=> (not (= result2 true)) (= result5 roleok)))))
...
(assert (=> (= tokentry1 2) (=> (not (= (ite (= idvalid1 true) authvalid1 false) true)) (= result6 roleok))))
...
(assert (=> (not (= tokentry1 2)) (= (mk_bool__ref result7) (mk_bool__ref authvalid))))
(assert (=> (not (= tokentry1 2)) (= authvalid2 (of_int 0))))
(assert (=> (not (= tokentry1 2)) (= (mk_bool__ref result8) (mk_bool__ref idvalid))))
(assert (=> (not (= tokentry1 2)) (= idvalid2 (of_int 0))))
(assert (=> (not (= tokentry1 2)) (= (mk_bool__ref result9) (mk_bool__ref roleok))))
(assert (=> (not (= tokentry1 2)) (= roleok4 (of_int 0))))
(assert (=> (not (= tokentry1 2)) (= o4 (makedescription (mk___t (temp___String_Literal_1342 Tuple0) (mk 1 9))))))
(assert (=> (not (= tokentry1 2)) (= result10 description)))
(assert (=> (not (= tokentry1 2)) (= description3 o4)))
(assert (=> (not (= tokentry1 2)) (= status2 status)))
(assert (=> (not (= tokentry1 2)) (= filestate2 filestate)))
(assert (=> (not (= tokentry1 2)) (= state3 state)))
...
(assert (= status3 (mk___private__ref status2)))
