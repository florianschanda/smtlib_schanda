...
(assert (= l1 0))
(assert (in_range2 l1))
(assert (or (and (and (and (= lcp__result14 (mk_int__ref lcp__result5)) (and (= j7 (mk_int__ref j2)) (= l2 l8))) (and (= lcp__result15 lcp__result6) (and (= j8 j2) (= l9 l2)))) (and (= temp___158 (to_rep (first (rt a)))) (and (= temp___159 (to_rep (last (rt a)))) (and (and (= (mk_int__ref result1) (mk_int__ref j)) (= j1 temp___158)) (and (and (<= temp___158 j1) (<= j1 temp___159)) (and (= temp___157 l1) (and (and (=> (<= 0 2147483647) (in_range2 l2)) (and (<= (to_rep (first (rt a))) j2) (<= j2 (to_rep (last (rt a)))))) (or (and (and (= lcp__result3 lcp__result5) (= lcp__result6 lcp__result3)) (and (and (and (and (and (and (= o6 (+ x l2)) (in_range1 (+ x l2))) (= o7 (ite (<= o6 (to_rep (last (rt a)))) true false))) (and (and (and (= o5 (+ x l2)) (in_range1 (+ x l2))) (= o8 (ite (<= (to_rep (first (rt a))) o5) true false))) (= o9 (ite (= o8 true) o7 false)))) (= result3 (ite (not (= o9 true)) true false))) (ite (= result3 true) (= result2 true) (and (and (and (and (= o1 (+ y l2)) (in_range1 (+ y l2))) (= o2 (ite (<= o1 (to_rep (last (rt a)))) true false))) (and (and (and (= o (+ y l2)) (in_range1 (+ y l2))) (= o3 (ite (<= (to_rep (first (rt a))) o) true false))) (= o4 (ite (= o3 true) o2 false)))) (= result2 (ite (not (= o4 true)) true false))))) (and (= result2 true) (and (= lcp__result2 result4) (= lcp__result3 l2))))) (and (and (and (and (and (and (and (= o6 (+ x l2)) (in_range1 (+ x l2))) (= o7 (ite (<= o6 (to_rep (last (rt a)))) true false))) (and (and (and (= o5 (+ x l2)) (in_range1 (+ x l2))) (= o8 (ite (<= (to_rep (first (rt a))) o5) true false))) (= o9 (ite (= o8 true) o7 false)))) (= result3 (ite (not (= o9 true)) true false))) (ite (= result3 true) (= result2 true) (and (and (and (and (= o1 (+ y l2)) (in_range1 (+ y l2))) (= o2 (ite (<= o1 (to_rep (last (rt a)))) true false))) (and (and (and (= o (+ y l2)) (in_range1 (+ y l2))) (= o3 (ite (<= (to_rep (first (rt a))) o) true false))) (= o4 (ite (= o3 true) o2 false)))) (= result2 (ite (not (= o4 true)) true false))))) (and (not (= result2 true)) (= lcp__result3 lcp__result2))) (and (and (= lcp__result4 lcp__result5) (= lcp__result6 lcp__result4)) (and (and (and (and (and (and (and (= temp___156 (+ y l2)) (in_range1 (+ y l2))) (and (and (<= (to_rep (first (rt a))) temp___156) (<= temp___156 (to_rep (last (rt a))))) (= o12 temp___156))) (= o13 (select (elts a) o12))) (= o14 (to_rep o13))) (and (and (and (and (and (= temp___155 (+ x l2)) (in_range1 (+ x l2))) (and (and (<= (to_rep (first (rt a))) temp___155) (<= temp___155 (to_rep (last (rt a))))) (= o10 temp___155))) (= o11 (select (elts a) o10))) (= o15 (to_rep o11))) (= o16 (ite (= o15 o14) true false)))) (= result5 (ite (not (= o16 true)) true false))) (and (= result5 true) (and (= lcp__result3 result6) (= lcp__result4 l2)))))))))))))) (and (and (and (= (mk_int__ref result1) (mk_int__ref j)) (= j1 (to_rep (first (rt a))))) (ite (and (<= (to_rep (first (rt a))) j1) (<= j1 (to_rep (last (rt a))))) (and (and (and (= temp___157 l1) (and (and (=> (<= 0 2147483647) (in_range2 l2)) (and (<= (to_rep (first (rt a))) j2) (<= j2 (to_rep (last (rt a)))))) (and (and (and (and (and (and (and (= o6 (+ x l2)) (in_range1 (+ x l2))) (= o7 (ite (<= o6 (to_rep (last (rt a)))) true false))) (and (and (and (= o5 (+ x l2)) (in_range1 (+ x l2))) (= o8 (ite (<= (to_rep (first (rt a))) o5) true false))) (= o9 (ite (= o8 true) o7 false)))) (= result3 (ite (not (= o9 true)) true false))) (ite (= result3 true) (= result2 true) (and (and (and (and (= o1 (+ y l2)) (in_range1 (+ y l2))) (= o2 (ite (<= o1 (to_rep (last (rt a)))) true false))) (and (and (and (= o (+ y l2)) (in_range1 (+ y l2))) (= o3 (ite (<= (to_rep (first (rt a))) o) true false))) (= o4 (ite (= o3 true) o2 false)))) (= result2 (ite (not (= o4 true)) true false))))) (and (not (= result2 true)) (= lcp__result3 lcp__result2))) (and (and (and (and (and (and (and (and (= temp___156 (+ y l2)) (in_range1 (+ y l2))) (and (and (<= (to_rep (first (rt a))) temp___156) (<= temp___156 (to_rep (last (rt a))))) (= o12 temp___156))) (= o13 (select (elts a) o12))) (= o14 (to_rep o13))) (and (and (and (and (and (= temp___155 (+ x l2)) (in_range1 (+ x l2))) (and (and (<= (to_rep (first (rt a))) temp___155) (<= temp___155 (to_rep (last (rt a))))) (= o10 temp___155))) (= o11 (select (elts a) o10))) (= o15 (to_rep o11))) (= o16 (ite (= o15 o14) true false)))) (= result5 (ite (not (= o16 true)) true false))) (and (not (= result5 true)) (= lcp__result4 lcp__result3))) (and (and (and (= o17 (+ l2 1)) (in_range1 (+ l2 1))) (and (= l2 result7) (= l3 o17))) (= j2 (to_rep (last (rt a))))))))) (and (and (= lcp__result4 lcp__result7) (and (= j2 j3) (= l3 l4))) (and (= lcp__result8 lcp__result4) (and (= j4 j2) (= l5 l3))))) (and (and (= (mk_int__ref lcp__result9) (mk_int__ref lcp__result7)) (and (= (mk_int__ref j5) (mk_int__ref j3)) (= (mk_int__ref l6) (mk_int__ref l4)))) (and (= lcp__result10 lcp__result8) (and (= j6 j4) (= l7 l5))))) (and (and (= (mk_int__ref lcp__result9) (mk_int__ref lcp__result)) (and (= j1 j5) (= l1 l6))) (and (= lcp__result10 lcp__result1) (and (= j6 j1) (= l7 l1)))))) (and (and (and (= lcp__result14 (mk_int__ref lcp__result12)) (and (= j7 (mk_int__ref j5)) (= (mk_int__ref l8) (mk_int__ref l6)))) (and (= lcp__result15 lcp__result13) (and (= j8 j6) (= l9 l7)))) (and (and (= lcp__result11 lcp__result12) (= lcp__result13 lcp__result11)) (and (= (mk_int__ref result8) (mk_int__ref lcp__result9)) (= lcp__result11 l6)))))))
(assert (= lcp__result16 lcp__result14))
(assert (= j9 j7))
(assert (= l10 (mk_int__ref l8)))
(assert (= lcp__result17 lcp__result15))
(assert (= j10 j8))
(assert (= l11 l9))
(assert (= (= result9 true) (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (int__content lcp__result16))) (= (to_rep (select (elts a) (+ x k1))) (to_rep (select (elts a) (+ y k1))))))))
(assert (= result9 true))
(assert (and (= o27 (+ x (int__content lcp__result16))) (in_range1 (+ x (int__content lcp__result16)))))
(assert (= o28 (ite (<= o27 (to_rep (last (rt a)))) true false)))
(assert (and (= o26 (+ x (int__content lcp__result16))) (in_range1 (+ x (int__content lcp__result16)))))
(assert (= o29 (ite (<= (to_rep (first (rt a))) o26) true false)))
(assert (= o30 (ite (= o29 true) o28 false)))
(assert (= result11 (ite (not (= o30 true)) true false)))
(assert (=> (= result11 true) (= result10 true)))
(assert (=> (not (= result11 true)) (and (= o22 (+ y (int__content lcp__result16))) (in_range1 (+ y (int__content lcp__result16))))))
(assert (=> (not (= result11 true)) (= o23 (ite (<= o22 (to_rep (last (rt a)))) true false))))
(assert (=> (not (= result11 true)) (and (= o21 (+ y (int__content lcp__result16))) (in_range1 (+ y (int__content lcp__result16))))))
(assert (=> (not (= result11 true)) (= o24 (ite (<= (to_rep (first (rt a))) o21) true false))))
(assert (=> (not (= result11 true)) (= o25 (ite (= o24 true) o23 false))))
(assert (=> (not (= result11 true)) (= result10 (ite (not (= o25 true)) true false))))
(assert (not (= result10 true)))
(assert (and (= temp___161 (+ y (int__content lcp__result16))) (in_range1 (+ y (int__content lcp__result16)))))
(assert (and (<= (to_rep (first (rt a))) temp___161) (<= temp___161 (to_rep (last (rt a))))))
(assert (= o18 temp___161))
(assert (= o19 (select (elts a) o18)))
(assert (= o20 (to_rep o19)))
(assert (and (= temp___160 (+ x (int__content lcp__result16))) (in_range1 (+ x (int__content lcp__result16)))))
(assert (not (<= (to_rep (first (rt a))) temp___160)))
(check-sat)
(exit)
