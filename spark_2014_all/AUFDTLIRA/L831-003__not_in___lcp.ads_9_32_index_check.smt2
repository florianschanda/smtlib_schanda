...
(assert (= j10 j8))
(assert (= l11 l9))
(assert (= (= result9 true) (forall ((k Int)) (=> (and (<= 0 k) (<= k (int__content lcp__result16))) (= (to_rep (select (elts a) (+ x k))) (to_rep (select (elts a) (+ y k))))))))
(assert (= result9 true))
