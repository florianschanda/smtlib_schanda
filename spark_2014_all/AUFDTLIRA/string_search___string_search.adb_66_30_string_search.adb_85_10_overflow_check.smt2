...
(assert (and (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (and (<= 1 (to_rep (select bad_shift c))) (<= (to_rep (select bad_shift c)) (+ (length needle) 1))))) (forall ((c Int)) (=> (and (<= 0 c) (<= c 255)) (ite (= (to_rep (select bad_shift c)) (+ (length needle) 1)) (forall ((k Int)) (=> (and (<= (to_rep2 (first (rt needle))) k) (<= k (to_rep2 (last (rt needle))))) (not (= c (to_rep1 (select (elts needle) k)))))) (and (= (to_rep1 (select (elts needle) (+ (- (length needle) (to_rep (select bad_shift c))) 1))) c) (forall ((k Int)) (=> (and (<= (+ (- (length needle) (to_rep (select bad_shift c))) 2) k) (<= k (to_rep2 (last (rt needle))))) (not (= (to_rep1 (select (elts needle) k)) c))))))))))
...
(assert (not (in_range1 (+ i1 shift1))))
(check-sat)
(exit)
