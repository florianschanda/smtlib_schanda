...
(declare-datatypes () ((stringf1l1000ne__ref (mk_stringf1l1000ne__ref (stringf1l1000ne__content us_t1)))))
(define-fun stringf1l1000ne__ref___projection ((a stringf1l1000ne__ref)) us_t1 (stringf1l1000ne__content a))
(declare-sort durationt 0)
(define-fun in_range3 ((x Int)) Bool (and (<= 0 x) (<= x 2000)))
...
(define-fun dynamic_invariant ((temp___expr_1019 Int) (temp___is_init_1016 Bool) (temp___skip_constant_1017 Bool) (temp___do_toplevel_1018 Bool)) Bool (=> (or (= temp___is_init_1016 true) (<= 0 2000)) (in_range3 temp___expr_1019)))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_356 us_t1) (temp___is_init_353 Bool) (temp___skip_constant_354 Bool) (temp___do_toplevel_355 Bool)) Bool (and (=> (not (= temp___skip_constant_354 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_356) (last3 temp___expr_356))) (=> (= temp___do_toplevel_355 true) (=> (= temp___is_init_353 true) (and (let ((temp___358 (of_array3 (to_array1 temp___expr_356) (first3 temp___expr_356) (last3 temp___expr_356)))) (and (= (first5 (of_array2 (to_array3 temp___358) (first7 temp___358) (last7 temp___358))) 1) (<= (last7 temp___358) 1000))) (<= 1 (length1 temp___expr_356)))))))
(define-fun dynamic_predicate ((temp___361 us_t1)) Bool (and (let ((temp___363 (of_array3 (to_array1 temp___361) (first3 temp___361) (last3 temp___361)))) (and (= (first5 (of_array2 (to_array3 temp___363) (first7 temp___363) (last7 temp___363))) 1) (<= (last7 temp___363) 1000))) (<= 1 (length1 temp___361))))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (= (durationt_image x) (let ((temp___1025 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___1025) (first1 temp___1025) (last1 temp___1025))))) :pattern ((durationt_image x)))))
...
(declare-fun temp___String_Literal_1806 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1806 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1806 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_1806 us_void_param) 3)) 48)) (= (to_rep (select (temp___String_Literal_1806 us_void_param) 4)) 46)) (= (to_rep (select (temp___String_Literal_1806 us_void_param) 5)) 48)) (= (to_rep (select (temp___String_Literal_1806 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_1806 us_void_param) 7)) 115)) :pattern ((temp___String_Literal_1806 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1553 Int) (temp___is_init_1550 Bool) (temp___skip_constant_1551 Bool) (temp___do_toplevel_1552 Bool)) Bool (=> (or (= temp___is_init_1550 true) (<= 1 7)) (in_range4 temp___expr_1553)))
(define-fun dynamic_invariant7 ((temp___expr_322 us_t2) (temp___is_init_319 Bool) (temp___skip_constant_320 Bool) (temp___do_toplevel_321 Bool)) Bool (and (=> (not (= temp___skip_constant_320 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_322) (last5 temp___expr_322))) (=> (= temp___do_toplevel_321 true) (=> (= temp___is_init_319 true) (= (first5 temp___expr_322) 1)))))
(define-fun dynamic_predicate1 ((temp___325 us_t2)) Bool (= (first5 temp___325) 1))
(define-fun dynamic_invariant8 ((temp___expr_344 us_t3) (temp___is_init_341 Bool) (temp___skip_constant_342 Bool) (temp___do_toplevel_343 Bool)) Bool (and (=> (not (= temp___skip_constant_342 true)) (dynamic_property3 1 2147483647 (first7 temp___expr_344) (last7 temp___expr_344))) (=> (= temp___do_toplevel_343 true) (=> (= temp___is_init_341 true) (and (= (first5 (of_array2 (to_array3 temp___expr_344) (first7 temp___expr_344) (last7 temp___expr_344))) 1) (<= (last7 temp___expr_344) 1000))))))
(define-fun dynamic_predicate2 ((temp___348 us_t3)) Bool (and (= (first5 (of_array2 (to_array3 temp___348) (first7 temp___348) (last7 temp___348))) 1) (<= (last7 temp___348) 1000)))
(declare-const str (Array Int character))
(declare-const valuestr (Array Int character))
(declare-const temp___1807 (Array Int character))
(declare-const temp___18071 t1)
...
(declare-const temp___18121 t5)
(declare-const temp___1813 (Array Int character))
(declare-const temp___18131 t4)
(declare-const temp___1814 Int)
(declare-const o6 (Array Int character))
(declare-const temp___1816 (Array Int character))
(declare-const temp___18161 t4)
...
(assert (= result str))
(assert (= str1 (temp___String_Literal_1806 Tuple0)))
(assert (and (= (mk___t1 temp___1807 temp___18071) (durationt_image value)) (and (dynamic_invariant1 (mk___t1 temp___1807 temp___18071) true false true) (= (mk___t1 temp___1807 temp___18071) (let ((temp___1023 (to_string (attr__ATTRIBUTE_IMAGE3 value)))) (mk___t1 (elts temp___1023) (mk1 (to_rep1 (first (rt temp___1023))) (to_rep1 (last (rt temp___1023))))))))))
(assert (= temp___1807 screen__writeconfigdata__secondsstring__valuestr__assume))
(assert (= (mk (to_rep1 (first2 temp___18071)) (to_rep1 (last2 temp___18071))) screen__writeconfigdata__secondsstring__valuestr__assume1))
...
(assert (= str2 o4))
(assert (<= 10 value))
(assert (and (= temp___1811 (- (to_rep1 valuestr__last) 1)) (in_range (- (to_rep1 valuestr__last) 1))))
(assert (=> (<= 2 temp___1811) (and (and (<= (to_rep1 valuestr__first) 2) (<= 2 (to_rep1 valuestr__last))) (and (<= (to_rep1 valuestr__first) temp___1811) (<= temp___1811 (to_rep1 valuestr__last))))))
(assert (= o5 valuestr1))
(assert (= o5 temp___1812))
(assert (= (mk5 2 temp___1811) temp___18121))
(assert (= (ite (<= (to_rep1 (first10 temp___18121)) (to_rep1 (last10 temp___18121))) (+ (- (to_rep1 (last10 temp___18121)) (to_rep1 (first10 temp___18121))) 1) 0) (ite (<= (- 6 (to_rep1 valuestr__last)) 3) (+ (- 3 (- 6 (to_rep1 valuestr__last))) 1) 0)))
(assert (= (slide temp___1812 (to_rep1 (first10 temp___18121)) (- 6 (to_rep1 valuestr__last))) temp___1813))
(assert (= (mk4 (- 6 (to_rep1 valuestr__last)) 3) temp___18131))
(assert (not (in_range (- 6 (to_rep1 valuestr__last)))))
(check-sat)
(exit)
