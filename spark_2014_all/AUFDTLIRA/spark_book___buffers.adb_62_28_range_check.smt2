...
(assert (and (and (and (=> (<= 0 1024) (in_range2 count2)) (=> (<= 1 1024) (in_range3 index2))) (forall ((temp___258 Int)) (=> (and (<= 1 temp___258) (<= temp___258 1024)) (=> (<= index2 temp___258) (= (select buffer1 temp___258) (select buffer temp___258)))))) (and (<= 1 index2) (<= index2 1024))))
