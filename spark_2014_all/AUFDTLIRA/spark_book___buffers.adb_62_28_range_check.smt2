...
(assert (and (and (and (=> (<= 0 1024) (in_range2 count2)) (=> (<= 1 1024) (in_range3 index2))) (forall ((temp___230 Int)) (=> (and (<= 1 temp___230) (<= temp___230 1024)) (=> (<= index2 temp___230) (= (select buffer1 temp___230) (select buffer temp___230)))))) (and (<= 1 index2) (<= index2 1024))))
