...
(assert (and (and (and (=> (<= 0 1024) (in_range2 count2)) (=> (<= 1 1024) (in_range3 index2))) (forall ((temp___260 Int)) (=> (and (<= 1 temp___260) (<= temp___260 1024)) (=> (or (< 1024 temp___260) (or (< temp___260 1) (<= index2 temp___260))) (= (select buffer1 temp___260) (select buffer temp___260)))))) (and (<= 1 index2) (<= index2 1024))))
(assert (= (to_rep (select buffer1 index2)) ch))
