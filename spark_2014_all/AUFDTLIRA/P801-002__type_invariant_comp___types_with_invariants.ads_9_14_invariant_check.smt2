...
(define-fun dynamic_invariant1 ((temp___expr_150 us_rep1) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (let ((temp___151 (rec__types_with_invariants__container__c (us_split_discrs1 temp___expr_150)))) (and (dynamic_property1 1 (to_rep temp___151) (first1 (rec__types_with_invariants__container__content (us_split_fields3 temp___expr_150))) (last1 (rec__types_with_invariants__container__content (us_split_fields3 temp___expr_150)))) (and (= (first1 (rec__types_with_invariants__container__content (us_split_fields3 temp___expr_150))) 1) (= (last1 (rec__types_with_invariants__container__content (us_split_fields3 temp___expr_150))) (to_rep temp___151))))))
...
(declare-const temp___2601 (Array Int us_rep))
(declare-const temp___2602 t)
(declare-const result (Array Int us_rep))
(declare-const result1 t)
(declare-const c__split_fields2 (Array Int us_rep))
(declare-const c__split_fields3 t)
(declare-const c__split_fields4 (Array Int us_rep))
(declare-const c__split_fields5 t)
(declare-const c__split_fields6 (Array Int us_rep))
(declare-const c__split_fields7 t)
(assert (dynamic_invariant1 (mk___rep1 c__split_discrs (mk___split_fields1 (mk___t c__split_fields c__split_fields1))) true false true))
(assert (in_range1 i))
(assert (and (forall ((temp___264 Int)) (=> (and (<= (to_rep1 (first c__split_fields1)) temp___264) (<= temp___264 (to_rep1 (last c__split_fields1)))) (let ((temp___141 (select c__split_fields temp___264))) (=> (= (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 temp___141))) 0) (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 temp___141)) true))))) (let ((temp___141 e)) (=> (= (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 temp___141))) 0) (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 temp___141)) true)))))
(assert (<= i (to_rep (rec__types_with_invariants__container__c c__split_discrs))))
(assert (and (<= (to_rep1 (first c__split_fields1)) i) (<= i (to_rep1 (last c__split_fields1)))))
(assert (= o i))
(assert (= o1 (store c__split_fields o e)))
(assert (= o1 o2))
(assert (= c__split_fields1 o3))
(assert (= o4 o2))
(assert (= o5 o3))
(assert (= c__split_discrs (mk___split_discrs temp___260)))
(assert (= temp___2601 o4))
(assert (= temp___2602 o5))
(assert (= result c__split_fields))
(assert (= result1 c__split_fields1))
(assert (= temp___2601 c__split_fields2))
(assert (= temp___2602 c__split_fields3))
(assert (= c__split_discrs (mk___split_discrs temp___260)))
(assert (= c__split_fields4 c__split_fields2))
(assert (= c__split_fields5 c__split_fields3))
(assert (= c__split_fields6 c__split_fields2))
(assert (= c__split_fields7 c__split_fields3))
(declare-const temp___262 Int)
(assert (<= (to_rep1 (first c__split_fields5)) temp___262))
(assert (<= temp___262 (to_rep1 (last c__split_fields5))))
(assert (= (to_rep (rec__types_with_invariants__my_integer__val (us_split_fields1 (select c__split_fields4 temp___262)))) 0))
(assert (not (= (rec__types_with_invariants__my_integer__sign (us_split_fields1 (select c__split_fields4 temp___262))) true)))
(check-sat)
(exit)
