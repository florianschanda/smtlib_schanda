...
(declare-const d3 (Array Int integer))
(declare-const d4 (Array Int integer))
(declare-const c4 Int)
(declare-const d5 (Array Int integer))
(declare-const c5 Int)
(assert (= result c))
(assert (= c1 0))
(assert (= (to_rep o) (to_rep (select d c1))))
(assert (= o1 (store d c1 o)))
(assert (= result1 d))
(assert (= d1 o1))
(assert (= result2 c1))
(assert (= c2 1))
(assert (= (to_rep o2) (to_rep (select d1 c2))))
(assert (= o3 (store d1 c2 o2)))
(assert (= result3 d1))
(assert (= d2 o3))
(assert (= result4 c2))
(assert (= c3 2))
(assert (= (to_rep o4) (to_rep (select d2 c3))))
(assert (= o5 (store d2 c3 o4)))
(assert (= result5 d2))
(assert (= d3 o5))
(assert (= c4 c3))
(assert (= d4 d3))
