...
(assert (< 11 (to_rep (select (rec__test__t__c (us_split_fields1 (select x 10))) 1))))
(assert (= test__f3__result1 test__f3__result2))
(assert (= test__f3__result3 test__f3__result1))
(assert (= result test__f3__result))
(assert (= test__f3__result1 (to_rep (select (rec__test__t__c (us_split_fields1 (select x 10))) 1))))
(assert (= (mk_int__ref test__f3__result4) (mk_int__ref test__f3__result2)))
(assert (= test__f3__result5 test__f3__result3))
(assert (= result1 test__f3__result4))
(assert (not (< 11 test__f3__result4)))
(check-sat)
(exit)
