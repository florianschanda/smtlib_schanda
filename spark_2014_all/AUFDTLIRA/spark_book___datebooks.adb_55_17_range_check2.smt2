...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 64)) (= temp___409 i1)))
(assert (=> (and (<= 1 i1) (<= i1 64)) (= (mk___split_fields4 temp___408 temp___4081) find_result__split_fields2)))
(assert (=> (and (<= 1 i1) (<= i1 64)) (<= (length description) 128)))
(assert (=> (and (<= 1 i1) (<= i1 64)) (and (=> (<= 1 64) (in_range10 i2)) (and (<= 1 i2) (<= i2 64)))))
(assert (=> (and (<= 1 i1) (<= i1 64)) (or (and (and (= find_result__split_fields5 (mk___split_fields__ref4 find_result__split_fields4)) (= find_result__split_fields6 find_result__split_fields4)) (and (not (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book i2))) true)) (and (and (and (= (to_rep8 o) i2) (and (= o o1) (= (distinct 1 0) o2))) (and (= temp___407 o1) (= temp___4071 o2))) (and (= result2 (mk___split_fields__ref4 find_result__split_fields3)) (= find_result__split_fields4 (mk___split_fields4 temp___407 temp___4071)))))) (and (and (= (rec__datebooks__event_record__is_used (us_split_fields7 (select book i2))) true) (= find_result__split_fields4 find_result__split_fields3)) (and (and (= find_result__split_fields5 (mk___split_fields__ref4 find_result__split_fields4)) (= find_result__split_fields6 find_result__split_fields4)) (= i2 64))))))
(assert (=> (and (<= 1 i1) (<= i1 64)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= 1 i1) (<= i1 64)) (= find_result__split_fields7 find_result__split_fields5)))
(assert (=> (and (<= 1 i1) (<= i1 64)) (= i4 i2)))
(assert (=> (and (<= 1 i1) (<= i1 64)) (= find_result__split_fields8 find_result__split_fields6)))
(assert (=> (and (<= 1 i1) (<= i1 64)) (= i5 i3)))
(assert (=> (and (<= 1 i1) (<= i1 64)) (= find_result__split_fields9 find_result__split_fields7)))
(assert (=> (and (<= 1 i1) (<= i1 64)) (= i6 i4)))
(assert (=> (and (<= 1 i1) (<= i1 64)) (= find_result__split_fields10 find_result__split_fields8)))
(assert (=> (not (and (<= 1 i1) (<= i1 64))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= 1 i1) (<= i1 64))) (= find_result__split_fields9 (mk___split_fields__ref4 find_result__split_fields2))))
(assert (=> (not (and (<= 1 i1) (<= i1 64))) (= i6 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 64))) (= find_result__split_fields10 find_result__split_fields2)))
...
(assert (<= (to_rep1 (first (rt description))) (to_rep1 (last (rt description)))))
(assert (not (<= 1 (to_rep1 (first (rt description))))))
(check-sat)
(exit)
