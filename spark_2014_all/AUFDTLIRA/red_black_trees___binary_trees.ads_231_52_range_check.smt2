...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= result (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (= (= result true) (and (<= root (to_rep f__split_fields)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 root)))) 2))) (=> (< (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) root) (not (= result true))))))
(assert (= result true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= temp___914 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant temp___914 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___914 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___914 root)))) 0) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (not (= i1 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___914 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___914 i1))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___914 i1))) true)))))) (and (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___914 i1))) true) (not (= i1 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___914 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i1) (rec__tree_model__path_type__a (us_split_fields1 (select temp___914 i1)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___914 i1)))) 0)))) (forall ((i1 Int)) (=> (and (<= 1 i1) (<= i1 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___914 i1))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___914 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___914 i1))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___914 j)))) true)) (= j i1))))))))))))))
(assert (= (mk___rep (mk___split_fields o2 o3)) (select temp___914 i)))
(assert (= o2 o4))
(assert (= o3 o5))
(assert (= result1 o5))
(assert (= result1 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o1 (peek (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i d)) (and (in_range2 o1) (and (= o1 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 i)))))) (and (ite (not (= o1 0)) (and (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o1) d) (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o1) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j) i) (not (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j) i) (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j) d)) (= o1 j)))))))))
(assert (= result2 (ite (= o1 0) true false)))
(assert (= result2 true))
(assert (not (= root v)))
(assert (not (= v 0)))
(assert (and (= o v) (in_range1 v)))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (not (in_range1 v)))
(check-sat)
(exit)
