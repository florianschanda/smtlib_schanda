...
(assert (= result true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= temp___868 (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root)) (and (dynamic_invariant3 temp___868 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___868 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___868 root)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 root)) (ite (and (not (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___868 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___868 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___868 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___868 i2))) true) (not (= i2 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___868 (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2)))) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___868 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___868 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___868 i2))) true) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___868 j9))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___868 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___868 j9)))) true)) (= j9 i2))))))))))))))
(assert (= (mk___rep (mk___split_fields o3 o4)) (select temp___868 i)))
(assert (= o3 o5))
(assert (= o4 o6))
(assert (= result1 o6))
(assert (= result1 true))
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) true))
(assert (and (= o2 (peek (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i d)) (and (in_range2 o2) (and (= o2 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 i)))))) (and (ite (not (= o2 0)) (and (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o2) d) (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) o2) i)) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j9) i) (not (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j9) d)))))) (forall ((j9 Int)) (=> (and (<= 1 j9) (<= j9 100)) (=> (and (= (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j9) i) (= (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j9) d)) (= o2 j9)))))))))
