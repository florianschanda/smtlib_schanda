...
(assert (forall ((temp___541 Int)) (forall ((temp___542 Int)) (= (select (temp___539 temp___541) temp___542) (of_rep temp___541)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_549 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_549 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_549 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_549 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_549 us_void_param) 5)) 114)) :pattern ((temp___String_Literal_549 us_void_param)))))
