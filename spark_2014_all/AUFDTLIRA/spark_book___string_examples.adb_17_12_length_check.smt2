...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_151 us_void_param) 1)) 68) (= (to_rep (select (temp___String_Literal_151 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 3)) 108)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 5)) 97)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 7)) 115)) :pattern ((temp___String_Literal_151 us_void_param)))))
...
(declare-fun temp___533 (Int) (Array Int character))
(assert (forall ((temp___535 Int)) (forall ((temp___536 Int)) (= (select (temp___533 temp___535) temp___536) (of_rep temp___535)))))
(declare-fun temp___String_Literal_537 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_537 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_537 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_537 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_537 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_537 us_void_param) 5)) 114)) :pattern ((temp___String_Literal_537 us_void_param)))))
(declare-fun temp___String_Literal_543 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_543 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_543 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_543 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_543 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_543 us_void_param) 5)) 114)) :pattern ((temp___String_Literal_543 us_void_param)))))
...
(declare-const temp___5401 t)
(declare-const o10 (Array Int character))
(declare-const o11 (Array Int character))
(declare-const temp___544 (Array Int character))
(declare-const temp___5441 t1)
