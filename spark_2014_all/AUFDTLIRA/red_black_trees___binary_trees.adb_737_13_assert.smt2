...
(assert (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i15)))) 0)))
(assert (not (or (= i15 v) (= (ole (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) v))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i15)))))))) true))))
(check-sat)
(exit)
