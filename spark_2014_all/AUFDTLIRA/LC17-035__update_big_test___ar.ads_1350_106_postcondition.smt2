...
(assert (= a3 a1))
(assert (not (= (to_rep (rec__ar__rec1t__f1 (us_split_fields1 (rec__ar__rec2t__g2 (us_split_fields3 (rec__ar__rec3t__f3 (us_split_fields5 (select (map__content a2) i)))))))) f)))
(check-sat)
(exit)
