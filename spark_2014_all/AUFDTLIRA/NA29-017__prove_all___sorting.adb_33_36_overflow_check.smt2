...
(assert (=> (= result7 true) (and (<= (to_rep b__first) j2) (<= j2 (to_rep b__last)))))
(assert (=> (= result7 true) (= o67 j2)))
(assert (=> (= result7 true) (= o68 (select b o67))))
(assert (=> (= result7 true) (= o69 (to_rep o68))))
(assert (=> (= result7 true) (and (<= (to_rep b__first) j2) (<= j2 (to_rep b__last)))))
(assert (=> (= result7 true) (= o65 j2)))
(assert (=> (= result7 true) (= o66 (select b10 o65))))
(assert (=> (= result7 true) (= o70 (to_rep o66))))
(assert (=> (= result7 true) (= o71 (ite (= o70 o69) true false))))
(assert (=> (not (= result7 true)) (= o71 (of_int 1))))
(assert (and (= o53 (+ b_first length1)) (in_range1 (+ b_first length1))))
(assert (= o54 (- o53 1)))
(assert (= o55 (ite (<= j2 o54) true false)))
(assert (= result8 (ite (<= b_first j2) o55 false)))
(assert (= result8 true))
(assert (and (= o56 (+ a_first j2)) (in_range1 (+ a_first j2))))
(assert (= o57 (- o56 b_first)))
