...
(assert (and (= o13 (length1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) (and (in_range5 o13) (<= o13 (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))))))
...
(assert (= result1 true))
(assert (and (= o8 (length1 (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))) (and (in_range5 o8) (<= o8 (capacity (mk___rep2 p__split_discrs (mk___split_fields2 p__split_fields)))))))
(assert (= o9 (- o8 1)))
(assert (and (= o6 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)) (and (in_range4 o6) (= o6 (get2 (model__ (mk___rep d__split_discrs (mk___split_fields d__split_fields))) x_elem)))))
