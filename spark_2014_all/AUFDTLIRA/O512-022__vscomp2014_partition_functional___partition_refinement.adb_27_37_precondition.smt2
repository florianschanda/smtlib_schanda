...
(assert (= result4 true))
(assert (and (= o3 (key (mk___rep d__split_discrs (mk___split_fields d__split_fields)) (mk___rep1 (mk___split_fields1 c)))) (and (in_range5 o3) (= o3 (get (keys (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (get1 (positions (mk___rep d__split_discrs (mk___split_fields d__split_fields))) (mk___rep1 (mk___split_fields1 c))))))))
