...
(assert (and (= o13 (length1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) (and (in_range8 o13) (<= o13 (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))))))
...
(assert (= result1 true))
(assert (and (= o8 (length1 (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))) (and (in_range8 o8) (<= o8 (capacity (mk___rep3 p__split_discrs (mk___split_fields3 p__split_fields)))))))
(assert (= o9 (- o8 1)))
