...
(assert (= i22 result3))
(assert (= i221 1))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= temp___291 i221)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= temp___296 x3)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= temp___286 x3)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= (bool_eq2 x4 (to_rep (first8 (mk4 (+ i32 1) 3))) (to_rep (last8 (mk4 (+ i32 1) 3))) temp___296 (to_rep (first10 (mk5 (+ i32 1) 3))) (to_rep (last10 (mk5 (+ i32 1) 3)))) true)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (and (and (forall ((temp___287 Int)) (=> (and (<= 1 temp___287) (<= temp___287 3)) (ite (not (= i32 temp___287)) (= (select x4 temp___287) (select temp___286 temp___287)) (forall ((temp___288 Int) (temp___289 Int)) (=> (and (and (<= 1 temp___288) (<= temp___288 3)) (and (<= 1 temp___289) (<= temp___289 3))) (=> (or (<= i222 temp___289) (not (= i212 temp___288))) (= (get (select x4 temp___287) temp___288 temp___289) (get (select temp___286 temp___287) temp___288 temp___289)))))))) (=> (<= 1 3) (in_range2 i222))) (and (<= 1 i222) (<= i222 3)))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i11 result4)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i12 1)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= temp___270 i12))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= temp___265 x4))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= temp___275 x4))))
...
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= (bool_eq2 x6 (to_rep (first12 (mk6 (+ i32 1) 3))) (to_rep (last12 (mk6 (+ i32 1) 3))) temp___275 (to_rep (first14 (mk7 (+ i32 1) 3))) (to_rep (last14 (mk7 (+ i32 1) 3)))) true))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (and (and (forall ((temp___266 Int)) (=> (and (<= 1 temp___266) (<= temp___266 3)) (ite (not (= i32 temp___266)) (= (select x6 temp___266) (select temp___265 temp___266)) (forall ((temp___267 Int) (temp___268 Int)) (=> (and (and (<= 1 temp___267) (<= temp___267 3)) (and (<= 1 temp___268) (<= temp___268 3))) (ite (or (not (= i222 temp___268)) (not (= i212 temp___267))) (= (get (select x6 temp___266) temp___267 temp___268) (get (select temp___265 temp___266) temp___267 temp___268)) (forall ((temp___269 Int)) (=> (and (<= 1 temp___269) (<= temp___269 3)) (=> (< i13 temp___269) (= (select (get (select x6 temp___266) temp___267 temp___268) temp___269) (select (get (select temp___265 temp___266) temp___267 temp___268) temp___269))))))))))) (=> (<= 1 3) (in_range2 i13))) (and (<= 1 i13) (<= i13 3))))))
