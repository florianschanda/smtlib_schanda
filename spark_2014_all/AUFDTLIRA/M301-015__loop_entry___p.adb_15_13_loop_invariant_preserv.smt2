...
(assert (= i215 i213))
(assert (= x23 x21))
(assert (not (= (bool_eq2 (map__content2 x22) (to_rep (first4 (mk2 (+ i32 1) 3))) (to_rep (last4 (mk2 (+ i32 1) 3))) x2 (to_rep (first6 (mk3 (+ i32 1) 3))) (to_rep (last6 (mk3 (+ i32 1) 3)))) true)))
(check-sat)
(exit)
