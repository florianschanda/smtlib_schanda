...
(assert (= i22 result3))
(assert (= i221 1))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= temp___259 i221)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= temp___264 x3)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= temp___254 x3)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= (bool_eq2 x4 (to_rep (first8 (mk4 (+ i32 1) 3))) (to_rep (last8 (mk4 (+ i32 1) 3))) temp___264 (to_rep (first10 (mk5 (+ i32 1) 3))) (to_rep (last10 (mk5 (+ i32 1) 3)))) true)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (and (and (forall ((temp___255 Int)) (=> (and (<= 1 temp___255) (<= temp___255 3)) (ite (not (= i32 temp___255)) (= (select x4 temp___255) (select temp___254 temp___255)) (forall ((temp___256 Int) (temp___257 Int)) (=> (and (and (<= 1 temp___256) (<= temp___256 3)) (and (<= 1 temp___257) (<= temp___257 3))) (=> (or (<= i222 temp___257) (not (= i212 temp___256))) (= (get (select x4 temp___255) temp___256 temp___257) (get (select temp___254 temp___255) temp___256 temp___257)))))))) (=> (<= 1 3) (in_range2 i222))) (and (<= 1 i222) (<= i222 3)))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i11 result4)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i12 1)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= temp___238 i12))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= temp___233 x4))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= temp___243 x4))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= (to_rep o) 1))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= o1 (store (get (select x4 i32) i212 i222) i12 o)))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= o2 (set (select x4 i32) i212 i222 o1)))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= o3 (store x4 i32 o2)))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= x4 result5))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= x5 o3))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= (bool_eq2 x6 (to_rep (first12 (mk6 (+ i32 1) 3))) (to_rep (last12 (mk6 (+ i32 1) 3))) temp___243 (to_rep (first14 (mk7 (+ i32 1) 3))) (to_rep (last14 (mk7 (+ i32 1) 3)))) true))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (and (and (forall ((temp___234 Int)) (=> (and (<= 1 temp___234) (<= temp___234 3)) (ite (not (= i32 temp___234)) (= (select x6 temp___234) (select temp___233 temp___234)) (forall ((temp___235 Int) (temp___236 Int)) (=> (and (and (<= 1 temp___235) (<= temp___235 3)) (and (<= 1 temp___236) (<= temp___236 3))) (ite (or (not (= i222 temp___236)) (not (= i212 temp___235))) (= (get (select x6 temp___234) temp___235 temp___236) (get (select temp___233 temp___234) temp___235 temp___236)) (forall ((temp___237 Int)) (=> (and (<= 1 temp___237) (<= temp___237 3)) (=> (< i13 temp___237) (= (select (get (select x6 temp___234) temp___235 temp___236) temp___237) (select (get (select temp___233 temp___234) temp___235 temp___236) temp___237))))))))))) (=> (<= 1 3) (in_range2 i13))) (and (<= 1 i13) (<= i13 3))))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= i13 3))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= i13 i14))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= x6 x7))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= i15 i13))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= x8 x6))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= i16 (mk_int__ref i14)))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= x9 (mk_map__ref2 x7)))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= i17 i15))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (and (<= 1 i12) (<= i12 3)) (= x10 x8))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (not (and (<= 1 i12) (<= i12 3))) (= i16 (mk_int__ref i12)))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (not (and (<= 1 i12) (<= i12 3))) (= x9 (mk_map__ref2 x4)))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (not (and (<= 1 i12) (<= i12 3))) (= i17 i12))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (=> (not (and (<= 1 i12) (<= i12 3))) (= x10 x4))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i222 3)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i18 i16)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i223 (mk_int__ref i222))))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= x11 x9)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i19 i17)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i224 i222)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= x12 x10)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i110 i18)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i225 i223)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= x13 x11)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i111 i19)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= i226 i224)))
(assert (=> (and (<= 1 i221) (<= i221 3)) (= x14 x12)))
(assert (=> (not (and (<= 1 i221) (<= i221 3))) (= i110 (mk_int__ref i1))))
(assert (=> (not (and (<= 1 i221) (<= i221 3))) (= i225 (mk_int__ref i221))))
(assert (=> (not (and (<= 1 i221) (<= i221 3))) (= x13 (mk_map__ref2 x3))))
(assert (=> (not (and (<= 1 i221) (<= i221 3))) (= i111 i1)))
(assert (=> (not (and (<= 1 i221) (<= i221 3))) (= i226 i221)))
(assert (=> (not (and (<= 1 i221) (<= i221 3))) (= x14 x3)))
(assert (not (= i212 3)))
(assert (= result6 (mk_int__ref i212)))
(assert (= i213 (+ i212 1)))
(assert (= i112 i110))
(assert (= i227 i225))
(assert (= i214 (mk_int__ref i213)))
(assert (= x15 x13))
(assert (= i113 i111))
(assert (= i228 i226))
(assert (= i215 i213))
(assert (= x16 x14))
(assert (not (= (bool_eq2 (map__content2 x15) (to_rep (first4 (mk2 (+ i32 1) 3))) (to_rep (last4 (mk2 (+ i32 1) 3))) x2 (to_rep (first6 (mk3 (+ i32 1) 3))) (to_rep (last6 (mk3 (+ i32 1) 3)))) true)))
(check-sat)
(exit)
