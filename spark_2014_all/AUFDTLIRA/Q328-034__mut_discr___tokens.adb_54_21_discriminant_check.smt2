...
(assert (and (= o73 (read (mk___t word1 (mk (to_rep1 word__first) (to_rep1 word__last))))) (in_range4 o73)))
(assert (= (to_rep2 o74) o73))
(assert (= o75 (mk___split_fields1 dummy5 dummy6 o74)))
(assert (= (to_rep4 o72) 2))
(assert (= o76 (mk___split_discrs o72)))
(assert (= temp___244 (mk___rep1 o76 o75 true)))
