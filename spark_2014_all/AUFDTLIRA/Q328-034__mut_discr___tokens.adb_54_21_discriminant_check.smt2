...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (= (to_rep4 (rec__tokens__token__kind (us_split_discrs1 a))) (to_rep4 (rec__tokens__token__kind (us_split_discrs1 b)))) (=> (tokens__token__val__pred a) (= (bool_eq2 (rec__tokens__token__val (us_split_fields3 a)) (rec__tokens__token__val (us_split_fields3 b))) true))) (=> (tokens__token__op__pred a) (= (to_rep3 (rec__tokens__token__op (us_split_fields3 a))) (to_rep3 (rec__tokens__token__op (us_split_fields3 b)))))) (=> (tokens__token__instr__pred a) (= (to_rep2 (rec__tokens__token__instr (us_split_fields3 a))) (to_rep2 (rec__tokens__token__instr (us_split_fields3 b)))))) true false))
...
(declare-const o51 token_kind)
(declare-const o52 Int)
(declare-const o53 instruction)
(declare-const o54 us_split_fields2)
(declare-const o55 us_split_discrs)
...
(assert (and (<= (to_rep1 word__first) (to_rep1 word__first)) (<= (to_rep1 word__first) (to_rep1 word__last))))
(assert (= o44 (to_rep1 word__first)))
(assert (= o45 (select word1 o44)))
(assert (= o46 (to_rep o45)))
(assert (= o47 (ite (<= o46 90) true false)))
(assert (and (<= (to_rep1 word__first) (to_rep1 word__first)) (<= (to_rep1 word__first) (to_rep1 word__last))))
(assert (= o41 (to_rep1 word__first)))
(assert (= o42 (select word1 o41)))
(assert (= o43 (to_rep o42)))
(assert (= o48 (ite (<= 65 o43) true false)))
(assert (= o49 (ite (= o48 true) o47 false)))
(assert (and (<= (to_rep1 word__first) (to_rep1 word__first)) (<= (to_rep1 word__first) (to_rep1 word__last))))
(assert (= o36 (to_rep1 word__first)))
(assert (= o37 (select word1 o36)))
(assert (= o38 (to_rep o37)))
(assert (= o39 (ite (<= o38 122) true false)))
(assert (and (<= (to_rep1 word__first) (to_rep1 word__first)) (<= (to_rep1 word__first) (to_rep1 word__last))))
(assert (= o33 (to_rep1 word__first)))
(assert (= o34 (select word1 o33)))
(assert (= o35 (to_rep o34)))
(assert (= o40 (ite (<= 97 o35) true false)))
(assert (= o50 (ite (= o40 true) o39 false)))
(assert (= result6 (ite (= o50 false) o49 true)))
(assert (= result6 true))
(assert (= (to_rep4 (rec__tokens__token__kind v__split_discrs)) r21b))
(assert (in_range6 r21b))
(assert (and (= o52 (read (mk___t word1 (mk (to_rep1 word__first) (to_rep1 word__last))))) (in_range4 o52)))
(assert (= (to_rep2 o53) o52))
(assert (= o54 (mk___split_fields1 dummy5 dummy6 o53)))
(assert (= (to_rep4 o51) 2))
(assert (= o55 (mk___split_discrs o51)))
(assert (= temp___244 (mk___rep1 o55 o54 true)))
(assert (= v__attr__constrained true))
(assert (not (= (rec__tokens__token__kind (us_split_discrs1 temp___244)) (rec__tokens__token__kind v__split_discrs))))
(check-sat)
(exit)
