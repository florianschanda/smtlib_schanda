...
(assert (=> (and (<= (to_rep (first (rt x))) j2) (<= j2 (to_rep (last (rt x))))) (= temp___174 k1)))
(assert (=> (and (<= (to_rep (first (rt x))) j2) (<= j2 (to_rep (last (rt x))))) (= temp___172 z)))
...
(assert (=> (and (<= (to_rep (first (rt x))) j2) (<= j2 (to_rep (last (rt x))))) (= (mk_map__ref z6) (mk_map__ref z4))))
...
(assert (=> (not (and (<= (to_rep (first (rt x))) j2) (<= j2 (to_rep (last (rt x)))))) (= (mk_map__ref z6) (mk_map__ref z))))
