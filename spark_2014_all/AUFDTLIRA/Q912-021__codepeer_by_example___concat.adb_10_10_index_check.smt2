...
(define-fun z8 () map__ref (mk_map__ref z6))
...
(assert (=> (and (<= (to_rep (first (rt x))) j2) (<= j2 (to_rep (last (rt x))))) (= temp___200 k1)))
(assert (=> (and (<= (to_rep (first (rt x))) j2) (<= j2 (to_rep (last (rt x))))) (= temp___198 z)))
...
(assert (=> (and (<= (to_rep (first (rt x))) j2) (<= j2 (to_rep (last (rt x))))) (= z8 (mk_map__ref z4))))
...
(assert (=> (not (and (<= (to_rep (first (rt x))) j2) (<= j2 (to_rep (last (rt x)))))) (= z8 (mk_map__ref z))))
