...
(assert (=> (and (<= (to_rep1 (first (rt s))) (int__content indexbis__result32)) (<= (int__content indexbis__result32) (to_rep1 (last (rt s))))) (= (= o33 true) (exists ((i4 Int)) (and (and (<= (to_rep1 (first (rt s))) i4) (<= i4 (- (int__content indexbis__result32) 1))) (exists ((j6 Int)) (and (and (<= (to_rep1 (first (rt c))) j6) (<= j6 (to_rep1 (last (rt c))))) (= (to_rep (select (elts s) i4)) (to_rep (select (elts c) j6))))))))))
(assert (=> (and (<= (to_rep1 (first (rt s))) (int__content indexbis__result32)) (<= (int__content indexbis__result32) (to_rep1 (last (rt s))))) (= result11 (ite (not (= o33 true)) true false))))
(assert (=> (not (and (<= (to_rep1 (first (rt s))) (int__content indexbis__result32)) (<= (int__content indexbis__result32) (to_rep1 (last (rt s)))))) (= result11 false)))
(assert (= result11 true))
(assert (<= (to_rep1 (first (rt c))) j4))
(assert (<= j4 (to_rep1 (last (rt c)))))
(assert (and (<= (to_rep1 (first (rt c))) j4) (<= j4 (to_rep1 (last (rt c))))))
(assert (= o27 j4))
(assert (= o28 (select (elts c) o27)))
(assert (= o29 (to_rep o28)))
(assert (not (<= (to_rep1 (first (rt s))) (int__content indexbis__result32))))
(check-sat)
(exit)
