...
(declare-const temp___352 (Array Int Bool))
...
(assert (= x1 0))
(assert (=> (and (<= 0 x1) (<= x1 255)) (= temp___354 x1)))
(assert (=> (and (<= 0 x1) (<= x1 255)) (= temp___352 r)))
...
(assert (=> (and (<= 0 x1) (<= x1 255)) (and (and (forall ((temp___353 Int)) (=> (and (<= 0 temp___353) (<= temp___353 255)) (=> (< x2 temp___353) (= (select r3 temp___353) (select temp___352 temp___353))))) (=> (<= 0 255) (in_range1 x2))) (and (<= 0 x2) (<= x2 255)))))
