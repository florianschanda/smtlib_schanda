...
(assert (=> (and (<= 0 x1) (<= x1 255)) (and (and (forall ((temp___315 Int)) (=> (and (<= 0 temp___315) (<= temp___315 255)) (=> (< x2 temp___315) (= (select r3 temp___315) (select temp___314 temp___315))))) (=> (<= 0 255) (in_range1 x2))) (and (<= 0 x2) (<= x2 255)))))
