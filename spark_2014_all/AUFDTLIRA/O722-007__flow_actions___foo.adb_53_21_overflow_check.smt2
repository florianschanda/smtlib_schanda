...
(declare-const temp___194 (Array Int character))
(declare-const temp___1941 t1)
...
(assert (= o2 new_str))
(assert (= o2 temp___194))
(assert (= (mk1 pos1 5) temp___1941))
(assert (= o3 (bool_eq temp___194 (to_rep1 (first2 temp___1941)) (to_rep1 (last2 temp___1941)) new_sub 1 5)))
