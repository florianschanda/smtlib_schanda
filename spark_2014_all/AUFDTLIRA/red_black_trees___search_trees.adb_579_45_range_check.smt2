...
(assert (and (= result (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t1)) o1)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t1))) o1) (not (= result true)))))
(assert (= result true))
...
(assert (and (= result1 (valid_root (rec__search_trees__search_tree__struct (us_split_fields7 t2)) o)) (=> (< (size (rec__search_trees__search_tree__struct (us_split_fields7 t2))) o) (not (= result1 true)))))
(assert (= result1 true))
(assert (not (in_range1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))))
(check-sat)
(exit)
