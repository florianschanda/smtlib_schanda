...
(assert (and (= o1 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1)))) (in_range3 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))))
...
(assert (= result1 true))
(assert (not (in_range3 (to_rep (rec__search_trees__search_tree__root (us_split_fields7 t1))))))
(check-sat)
(exit)
