...
(assert (<= 1 rank1))
(assert (<= rank1 64))
(assert (forall ((g2 Int)) (=> (and (<= 1 g2) (<= g2 64)) (= (= (select seen2 g2) true) (exists ((prev Int)) (and (and (<= 1 prev) (<= prev (- rank2 1))) (= (to_rep (select r2 prev)) g2)))))))
...
(assert (<= 1 g2))
(assert (<= g2 64))
(assert (= (select seen3 g2) true))
(assert (not (exists ((prev Int)) (and (and (<= 1 prev) (<= prev (- rank3 1))) (= (to_rep (select r2 prev)) g2)))))
(check-sat)
(exit)
