...
(assert (<= 1 rank1))
(assert (<= rank1 64))
(assert (forall ((g21 Int)) (=> (and (<= 1 g21) (<= g21 64)) (= (= (select seen2 g21) true) (exists ((prev1 Int)) (and (and (<= 1 prev1) (<= prev1 (- rank2 1))) (= (to_rep (select r2 prev1)) g21)))))))
(assert (and (=> (<= 1 64) (in_range2 rank2)) (and (<= 1 rank2) (<= rank2 64))))
(assert (= seen2 result2))
(assert (= seen3 (store seen2 (to_rep (select r2 rank2)) (of_int 1))))
(assert (not (= rank2 64)))
...
(assert (<= 1 g21))
(assert (<= g21 64))
(assert (= (select seen3 g21) true))
(assert (not (exists ((prev1 Int)) (and (and (<= 1 prev1) (<= prev1 (- rank3 1))) (= (to_rep (select r2 prev1)) g21)))))
(check-sat)
(exit)
