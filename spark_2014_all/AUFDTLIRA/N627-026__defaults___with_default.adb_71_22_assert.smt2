...
(assert (and (= us2 c) (dynamic_property1 first1 2147483647 c)))
(assert (= o2 c))
(assert (= o3 (with_default__ok_array__no_def__aggregate_def o2)))
(assert (= o3 with_default__ok_array__no_def__assume))
(assert (= (mk 1 100) with_default__ok_array__no_def__assume1))
(assert (= result2 no_def))
...
(assert (dynamic_invariant3 all_2 false false true))
