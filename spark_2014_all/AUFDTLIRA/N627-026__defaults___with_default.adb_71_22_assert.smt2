...
(declare-const all_0 (Array Int scalar_with_default))
(declare-const all_1 (Array Int natural))
(declare-const all_2 (Array Int tscalar_with_defaultB))
...
(assert (dynamic_invariant2 empty2 false false true true))
...
(assert (and (dynamic_property2 1 2147483647 (to_rep1 no_def__first) (to_rep1 no_def__last)) (forall ((temp___697 Int)) (=> (and (<= (to_rep1 no_def__first) temp___697) (<= temp___697 (to_rep1 no_def__last))) (dynamic_property1 first1 2147483647 (to_rep1 (select no_def1 temp___697)))))))
(assert (default_initial_assumption2 all_0 false))
(assert (default_initial_assumption3 all_1 false))
(assert (default_initial_assumption4 all_2 false))
(assert (dynamic_invariant3 all_2 false false true true))
(assert (= (to_rep2 (select all_0 1)) 0))
(assert (= (to_rep (select all_1 1)) 1))
(assert (not (= (to_rep3 (select all_2 1)) 2)))
(check-sat)
(exit)
