...
(declare-fun user_eq1 (cursor cursor) Bool)
(declare-const dummy1 cursor)
...
(declare-fun user_eq2 (valid_cursor valid_cursor) Bool)
(declare-const dummy2 valid_cursor)
