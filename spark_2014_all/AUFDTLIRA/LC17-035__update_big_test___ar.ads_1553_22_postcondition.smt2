...
(define-fun dynamic_invariant ((temp___expr_158 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 5 50)) (in_range1 temp___expr_158)))
(declare-sort et1 0)
...
(declare-const temp___8263 (Array Int (Array Int et1)))
(declare-const temp___82631 Bool)
...
(assert (= temp___8263 o3))
(assert (= temp___82631 o4))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8263 r__split_fields4))
(assert (= temp___82631 r__split_fields5))
...
(assert (<= 1 n))
(assert (<= n 10))
(assert (not (in_range2 (to_rep (select (select r__split_fields6 m) n)))))
(check-sat)
(exit)
