...
(declare-const temp___8322 (Array Int (Array Int et1)))
(declare-const temp___83221 Bool)
...
(assert (= temp___8322 o3))
(assert (= temp___83221 o4))
(assert (= result2 r__split_fields2))
(assert (= result3 r__split_fields3))
(assert (= temp___8322 r__split_fields4))
(assert (= temp___83221 r__split_fields5))
