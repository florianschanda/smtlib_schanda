...
(define-fun theadmin__split_fields4 () us_split_fields2 (mk___split_fields1 theadmin__split_fields2 theadmin__split_fields3))
...
(assert (and (and (and (= (rolepresent (mk___rep1 theadmin__split_fields4)) (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (= (ispresent (mk___rep1 theadmin__split_fields4)) true)) (= (isdoingop (mk___rep1 theadmin__split_fields4)) true)) (= (thecurrentop (mk___rep1 theadmin__split_fields4)) o1)))
