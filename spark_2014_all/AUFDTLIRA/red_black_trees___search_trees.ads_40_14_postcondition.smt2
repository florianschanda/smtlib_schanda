...
(declare-const result15 us_rep2)
(assert (= (tree_structure (rec__search_trees__search_tree__struct (us_split_fields7 t))) true))
(assert (type_invariant1 t))
(assert (ite (= (size (rec__search_trees__search_tree__struct (us_split_fields7 t))) 0) (= (is_empty (value_set__content search_trees__values__result8)) true) (and (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i4))) true) (= (contains (value_set__content search_trees__values__result8) (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i4))) true)))) (forall ((v2 Int)) (=> (and (<= 0 v2) (<= v2 2147483647)) (=> (= (contains (value_set__content search_trees__values__result8) v2) true) (exists ((i4 Int)) (and (and (<= 1 i4) (<= i4 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__search_trees__search_tree__struct (us_split_fields7 t)) (to_rep1 (rec__search_trees__search_tree__root (us_split_fields7 t)))) i4))) true) (= (to_rep (select (rec__search_trees__search_tree__values (us_split_fields7 t)) i4)) v2))))))))))
(assert (= result15 (value_set__content search_trees__values__result8)))
(assert (= (size1 t) 0))
