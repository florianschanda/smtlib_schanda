...
(assert (and (= temp___722 (nb_blacks c107b)) (and (= (bool_eq11 (select temp___722 0) (mk___rep5 (mk___split_fields5 (of_int 1) (of_rep 0) (of_rep 0)))) true) (forall ((i14 Int)) (=> (and (<= 1 i14) (<= i14 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (rec__red_black_trees__rbt__struct (us_split_fields9 c107b))) i14))) true) (and (and (= (= (rec__red_black_trees__black_count__status (us_split_fields11 (select temp___722 i14))) true) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___722 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___722 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 1))))))) (= (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___722 i14)))) (+ 1 (ite (< (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___722 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 0))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___722 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 1)))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___722 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 1))))) (to_rep (rec__red_black_trees__black_count__depth (us_split_fields11 (select temp___722 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 0))))))))) (= (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___722 i14)))) (+ (ite (= (to_rep3 (select (rec__red_black_trees__rbt__color (us_split_fields9 c107b)) i14)) 0) 1 0) (to_rep (rec__red_black_trees__black_count__count (us_split_fields11 (select temp___722 (peek (rec__red_black_trees__rbt__struct (us_split_fields9 c107b)) i14 0))))))))))))))
(assert (= o374 (select temp___722 y3)))
(assert (= o375 (us_split_fields11 o374)))
(assert (= o376 (rec__red_black_trees__black_count__count o375)))
(assert (= o381 (to_rep o376)))
(assert (= o382 (ite (= o381 o380) true false)))
