...
(assert (and (= o17 (- i9 first4)) (in_range1 (- i9 first4))))
(assert (and (= o18 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range6 o18) (<= o18 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
(assert (= result6 (ite (= o18 o17) true false)))
(assert (=> (= result6 true) (and (= o13 (- last5 i9)) (in_range1 (- last5 i9)))))
(assert (=> (= result6 true) (= o14 (+ o13 1))))
(assert (=> (= result6 true) (and (= o15 o14) (in_range1 o14))))
(assert (=> (= result6 true) (and (= o12 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o12 true false true) (and (= (to_rep (first (rt o12))) 1) (<= 0 (to_rep (last (rt o12)))))))))
(assert (=> (= result6 true) (= o16 (to_rep (last (rt o12))))))
(assert (=> (= result6 true) (= result5 (ite (= o16 o15) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o8 (- last5 i9)) (in_range1 (- last5 i9)))))
(assert (=> (= result5 true) (= o9 (+ o8 1))))
(assert (=> (= result5 true) (and (= o10 o9) (in_range1 o9))))
(assert (=> (= result5 true) (= o11 (ite (<= j1 o10) true false))))
(assert (=> (= result5 true) (= result7 (ite (<= 1 j1) o11 false))))
