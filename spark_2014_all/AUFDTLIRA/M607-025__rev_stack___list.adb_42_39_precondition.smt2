...
(assert (and (= o18 (length2 (mk___rep1 res__split_discrs res__split_fields2))) (and (in_range5 o18) (<= o18 (capacity (mk___rep1 res__split_discrs res__split_fields2))))))
...
(assert (=> (= result6 true) (and (= o12 (to__ (mk___rep s__split_fields9))) (and (dynamic_invariant1 o12 true false true true) (and (= (to_rep (first (rt o12))) 1) (<= 0 (to_rep (last (rt o12)))))))))
