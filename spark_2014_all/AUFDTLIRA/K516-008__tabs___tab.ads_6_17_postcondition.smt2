...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___155 cur1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___153 a)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___152 cur1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___151 i1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (<= temp___155 cur2) (<= cur2 (prev i2)))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (prev i2))) (=> (< threshold (to_rep (select b j1))) (exists ((k1 Int)) (and (and (<= 1 k1) (<= k1 cur2)) (= (to_rep (select a2 k1)) (to_rep (select b j1))))))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (=> (<= 1 10) (in_range2 i2)) (=> (<= (- 2147483648) 2147483647) (in_range1 cur2))) (and (<= 1 i2) (<= i2 10)))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (=> (< threshold (to_rep (select b i2))) (and (= o8 (+ cur2 1)) (in_range1 (+ cur2 1))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (=> (< threshold (to_rep (select b i2))) (= cur2 result4))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (=> (< threshold (to_rep (select b i2))) (= cur3 o8))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (=> (< threshold (to_rep (select b i2))) (= (to_rep o9) (to_rep (select b i2))))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (=> (< threshold (to_rep (select b i2))) (and (<= 1 cur3) (<= cur3 10)))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (=> (< threshold (to_rep (select b i2))) (= o10 cur3))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (=> (< threshold (to_rep (select b i2))) (= o11 (store a2 o10 o9)))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (=> (< threshold (to_rep (select b i2))) (= a2 result5))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (=> (< threshold (to_rep (select b i2))) (= a3 o11))))
...
(assert (=> (and (<= 1 i1) (<= i1 10)) (= i2 i4)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= cur3 cur4)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= a3 a4)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= i5 i2)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= cur5 cur3)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= a5 a3)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref i6) (mk_int__ref i4))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref cur6) (mk_int__ref cur4))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_map__ref a6) (mk_map__ref a4))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= i7 i5)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= cur7 cur5)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= a7 a5)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= i1 i6)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= cur1 cur6)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= (mk_map__ref a6) (mk_map__ref a))))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= i7 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= cur7 cur1)))
(assert (=> (not (and (<= 1 i1) (<= i1 10))) (= a7 a1)))
(assert (= i8 i6))
(assert (= cur8 cur6))
(assert (= (mk_map__ref a8) (mk_map__ref a6)))
(assert (= i9 i7))
(assert (= cur9 cur7))
(assert (= a9 a7))
...
(assert (<= 1 j1))
(assert (<= j1 10))
(assert (< threshold (to_rep (select b j1))))
(assert (not (exists ((k1 Int)) (and (and (<= 1 k1) (<= k1 10)) (= (to_rep (select a8 k1)) (to_rep (select b j1)))))))
(check-sat)
(exit)
