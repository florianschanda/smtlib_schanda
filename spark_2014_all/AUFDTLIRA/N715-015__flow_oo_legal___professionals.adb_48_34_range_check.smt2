...
(assert (= o15 (concat1 (temp___String_Literal_1057 Tuple0) 1 12 (elts (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (to_rep3 (rec__professionals__professional__profession (us_split_fields3 this)))))))))))
(assert (= o16 (mk 1 o14)))
(assert (= result1 i))
(assert (= i1 1))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1)))))))) (= o17 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1))))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1)))))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1))))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE6 (to_rep4 (select (rec__professionals__professional__skilled_in (us_split_fields3 this)) i1))))))))) (= o17 0)))
