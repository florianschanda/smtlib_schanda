...
(define-fun o36 () us_rep (mk___rep (mk___split_discrs o22 o23) (mk___split_fields (mk___t1 o24 o25))))
(define-fun o37 () us_rep (mk___rep (mk___split_discrs o18 o19) (mk___split_fields (mk___t1 o20 o21))))
...
(assert (<= (to_rep1 (first (rt a))) (to_rep (rec__static_discr__holder__length1 current__split_fields6))))
(assert (<= (to_rep (rec__static_discr__holder__length1 current__split_fields6)) (to_rep1 (last (rt a)))))
(assert (= (bool_eq (elts a) (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) (elts3 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields6)))) (to_rep1 (first6 (rt3 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields6)))))) (to_rep1 (last6 (rt3 (rec__static_discr__i_holder__content2 (us_split_fields7 (rec__static_discr__holder__content1 current__split_fields6))))))) true))
...
(assert (= result2 (ite (= o35 true) (ite (<= i (to_rep1 (last (rt a)))) true false) false)))
(assert (= result2 true))
