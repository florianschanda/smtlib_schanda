...
(assert (forall ((temp___213 Int)) (=> (dynamic_invariant temp___213 true true true true) (forall ((temp___214 Int)) (= (to_rep2 (select (temp___211 temp___213) temp___214)) temp___213)))))
...
(declare-const temp___2081 ar_index)
(declare-const temp___2082 length_type)
...
(declare-const temp___2101 ar_index)
(declare-const temp___2102 length_type)
