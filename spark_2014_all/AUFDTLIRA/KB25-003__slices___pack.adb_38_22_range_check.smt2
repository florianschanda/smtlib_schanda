...
(assert (forall ((temp___168 Int)) (=> (dynamic_invariant temp___168 true true true true) (forall ((temp___169 Int)) (= (to_rep1 (select (pack__an21__my_a__aggregate_def temp___168) temp___169)) temp___168)))))
...
(declare-const temp___472 (Array Int character))
(declare-const temp___474 (Array Int character))
...
(assert (= temp___472 glob))
(assert (= temp___474 temp___472))
(assert (<= 1 3))
(assert (not (<= 1 1)))
(check-sat)
(exit)
