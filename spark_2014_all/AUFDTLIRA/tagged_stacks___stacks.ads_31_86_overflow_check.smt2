...
(assert (forall ((x less_than_max)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((s us_rep)) (! (let ((result (get_model s))) (and (and (in_range3 (first1 result)) (and (in_range3 (last1 result)) (= (length result) (size s)))) (dynamic_invariant1 result true false true true))) :pattern ((get_model s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep)) (! (let ((result (get_model1 attr__tag2 s))) (and (and (in_range3 (first1 result)) (and (in_range3 (last1 result)) (= (length result) (size s)))) (dynamic_invariant1 result true false true true))) :pattern ((get_model1 attr__tag2 s))))))
...
(assert (forall ((s us_rep)) (! (let ((result (get_model__2 s))) (and (and (= (length result) (size s)) (and (in_range3 (last1 result)) (in_range3 (first1 result)))) (dynamic_invariant1 result true false true true))) :pattern ((get_model__2 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep)) (! (let ((result (get_model__21 attr__tag2 s))) (and (and (= (length result) (size s)) (and (in_range3 (last1 result)) (in_range3 (first1 result)))) (dynamic_invariant1 result true false true true))) :pattern ((get_model__21 attr__tag2 s))))))
...
(assert (forall ((s us_rep)) (! (= (get_model__2 s) (let ((temp___310 (let ((temp___308 (to_rep1 (rec__stacks__stack_root__length (us_split_fields1 s))))) (let ((temp___307 1)) (let ((temp___309 (rec__stacks__stack_root__content (us_split_fields1 s)))) (of_array2 temp___309 temp___307 temp___308)))))) (of_array (to_array2 temp___310) (first5 temp___310) (last5 temp___310)))) :pattern ((get_model__2 s)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep2 (first8 (mk4 f l))) f) (= (to_rep2 (last10 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep2 (first10 (mk5 f l))) f) (= (to_rep2 (last12 (mk5 f l))) l)))) :pattern ((mk5 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep2 (first12 (mk6 f l))) f) (= (to_rep2 (last14 (mk6 f l))) l)))) :pattern ((mk6 f l)))))
...
(assert (forall ((s us_rep1)) (! (let ((result (get_model__3 s))) (and (and (in_range3 (first1 result)) (and (in_range3 (last1 result)) (= (length result) (size (to_base s))))) (dynamic_invariant1 result true false true true))) :pattern ((get_model__3 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (let ((result (get_model__31 attr__tag2 s))) (and (and (in_range3 (first1 result)) (and (in_range3 (last1 result)) (= (length result) (size (to_base s))))) (dynamic_invariant1 result true false true true))) :pattern ((get_model__31 attr__tag2 s))))))
...
(assert (forall ((s us_rep1)) (! (= (peek__3 s) (to_rep (let ((temp___439 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (select temp___439 (last8 s))))) :pattern ((peek__3 s)))))
...
(assert (forall ((s us_rep1)) (! (dynamic_invariant4 (last8 s) true false true true) :pattern ((last8 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (dynamic_invariant4 (last9 attr__tag2 s) true false true true) :pattern ((last9 attr__tag2 s))))))
(assert (forall ((s us_rep1)) (! (= (last8 s) (last9 us_tag2 s)) :pattern ((last9 us_tag2 s)))))
(assert (forall ((s us_rep1)) (! (= (last8 s) (ite (not (= (wraps_around s) true)) (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep1 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) (- (- (+ (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))) (to_rep1 (rec__stacks__stack_root__length1 (us_split_fields3 s)))) 1) 100))) :pattern ((last8 s)))))
...
(assert (in_range2 e1))
(assert (not (in_range1 (- (to_rep2 (last (rt (get_model (mk___rep (mk___split_fields s__split_fields s__split_fields1 s__split_fields2) s__attr__tag))))) 1))))
(check-sat)
(exit)
