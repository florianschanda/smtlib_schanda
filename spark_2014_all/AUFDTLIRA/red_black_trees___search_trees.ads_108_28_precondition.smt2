...
(declare-const j Int)
(declare-const temp___833 (Array Int us_rep1))
...
(assert (=> (not (= (int__content i14) 0)) (= result24 (rec__tree_model__path_type__k o38))))
...
(assert (=> (= result24 true) (and (= o34 (root (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (in_range3 o34) (= o34 (to_rep1 t__split_fields))))))
(assert (=> (= result24 true) (type_invariant1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))))
(assert (=> (= result24 true) (and (= o35 (root (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range3 o35) (= o35 (to_rep1 (rec__search_trees__search_tree__root (us_split_fields__content3 t__split_fields14))))))))
...
(assert (=> (= result23 true) (and (= o33 (size1 (mk___rep3 (us_split_fields__content3 t__split_fields14)))) (and (in_range4 o33) (= o33 (size (rec__search_trees__search_tree__struct (us_split_fields__content3 t__split_fields14))))))))
(assert (=> (= result23 true) (= result22 (ite (= o33 (+ (size1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))) 1)) true false))))
...
(assert (=> (= result22 true) (and (= o31 (values1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (ite (= (size (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2))) 0) (= (is_empty o31) true) (and (forall ((i16 Int)) (=> (and (<= 1 i16) (<= i16 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i16))) true) (= (contains o31 (to_rep (select t__split_fields3 i16))) true)))) (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 2147483647)) (=> (= (contains o31 v1) true) (exists ((i16 Int)) (and (and (<= 1 i16) (<= i16 100)) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields)) i16))) true) (= (to_rep (select t__split_fields3 i16)) v1))))))))))))
(assert (=> (= result22 true) (and (= result21 (is_add__2 o31 v o32)) (= (= result21 true) (and (and (and (not (= (contains o31 v) true)) (= (contains o32 v) true)) (= (ole o31 o32) true)) (= (included_except o32 o31 v) true))))))
...
(assert (<= j 100))
(assert (type_invariant1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3))))
(assert (and (= temp___833 (model__1 (mk___rep3 (mk___split_fields3 t__split_fields (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) t__split_fields3)))) (and (dynamic_invariant9 temp___833 true false true true) (= temp___833 (model__ (mk___rep2 (mk___split_fields2 t__split_fields1 t__split_fields2)) (to_rep1 t__split_fields))))))
(assert (= o29 (select temp___833 j)))
