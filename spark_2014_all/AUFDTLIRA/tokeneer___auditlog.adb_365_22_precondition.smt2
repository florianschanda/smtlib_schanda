...
(define-fun dynamic_invariant4 ((temp___expr_1391 Int) (temp___is_init_1387 Bool) (temp___skip_constant_1388 Bool) (temp___do_toplevel_1389 Bool) (temp___do_typ_inv_1390 Bool)) Bool (=> (or (= temp___is_init_1387 true) (<= 1 17)) (in_range3 temp___expr_1391)))
(assert (= archivefilename (temp___String_Literal_182 Tuple0)))
(declare-const temp___1756 (Array Int character))
(declare-const temp___17561 t)
(declare-const o (Array Int character))
(declare-const o1 t)
(define-fun temp___17562 () us_t (mk___t temp___1756 temp___17561))
(assert (= (temp___String_Literal_182 Tuple0) archivefilename))
(assert (dynamic_property 1 2147483647 1 17))
(assert (= archivefilename temp___1756))
(assert (= (mk 1 17) temp___17561))
(assert (dynamic_predicate temp___17562))
(assert (= (mk___t o o1) temp___17562))
