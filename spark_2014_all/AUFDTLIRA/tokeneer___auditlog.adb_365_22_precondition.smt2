...
(define-fun dynamic_invariant ((temp___expr_297 us_t) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool)) Bool (and (=> (not (= temp___skip_constant_295 true)) (dynamic_property 1 2147483647 (first1 temp___expr_297) (last1 temp___expr_297))) (=> (= temp___do_toplevel_296 true) (=> (= temp___is_init_294 true) (= (first1 temp___expr_297) 1)))))
(define-fun dynamic_predicate ((temp___300 us_t)) Bool (= (first1 temp___300) 1))
...
(define-fun dynamic_invariant4 ((temp___expr_1194 Int) (temp___is_init_1191 Bool) (temp___skip_constant_1192 Bool) (temp___do_toplevel_1193 Bool)) Bool (=> (or (= temp___is_init_1191 true) (<= 1 17)) (in_range3 temp___expr_1194)))
(assert (= archivefilename (temp___String_Literal_160 Tuple0)))
(declare-const temp___1553 (Array Int character))
(declare-const temp___15531 t)
...
(assert (= archivefilename temp___1553))
(assert (= (mk 1 17) temp___15531))
(assert (= (to_rep1 (first temp___15531)) 1))
(assert (= (mk___t o o1) (mk___t temp___1553 temp___15531)))
