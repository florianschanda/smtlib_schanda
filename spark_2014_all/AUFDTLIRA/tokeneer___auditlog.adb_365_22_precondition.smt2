...
(define-fun dynamic_invariant ((temp___expr_297 us_t) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool)) Bool (and (=> (not (= temp___skip_constant_295 true)) (dynamic_property 1 2147483647 (first1 temp___expr_297) (last1 temp___expr_297))) (=> (= temp___do_toplevel_296 true) (=> (= temp___is_init_294 true) (and (= (first1 temp___expr_297) 1) (<= 0 (last1 temp___expr_297)))))))
(define-fun dynamic_predicate ((temp___300 us_t)) Bool (and (= (first1 temp___300) 1) (<= 0 (last1 temp___300))))
...
(define-fun dynamic_invariant4 ((temp___expr_1250 Int) (temp___is_init_1247 Bool) (temp___skip_constant_1248 Bool) (temp___do_toplevel_1249 Bool)) Bool (=> (or (= temp___is_init_1247 true) (<= 1 17)) (in_range3 temp___expr_1250)))
(assert (= archivefilename (temp___String_Literal_160 Tuple0)))
(declare-const temp___1609 (Array Int character))
(declare-const temp___16091 t)
...
(assert (= archivefilename temp___1609))
(assert (= (mk 1 17) temp___16091))
(assert (dynamic_predicate (mk___t temp___1609 temp___16091)))
(assert (= (mk___t o o1) (mk___t temp___1609 temp___16091)))
