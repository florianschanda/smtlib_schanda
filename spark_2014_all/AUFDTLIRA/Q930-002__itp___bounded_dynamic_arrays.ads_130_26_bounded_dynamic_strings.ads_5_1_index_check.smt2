...
(declare-const temp___1140 natural_index)
(declare-const temp___11401 natural_index)
(declare-const temp___11402 (Array Int character))
(declare-const temp___11403 t1)
(declare-const temp___1143 us_t)
...
(define-fun temp___11394 () us_rep (mk___rep (mk___split_discrs temp___1139) (mk___split_fields temp___11391 (mk___t1 temp___11392 temp___11393))))
...
(assert (dynamic_predicate temp___11394))
(assert (= (mk___rep (mk___split_discrs temp___1140) (mk___split_fields temp___11401 (mk___t1 temp___11402 temp___11403))) temp___11394))
(assert (= result1 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (mk___split_fields temp___11401 (mk___t1 temp___11402 temp___11403))))
(assert (= to____split_discrs (mk___split_discrs temp___1140)))
(assert (= to____split_fields5 (mk___split_fields__ref to____split_fields4)))
(assert (= to____split_fields6 to____split_fields4))
(assert (and (= o12 (length2 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (and (in_range5 o12) (= o12 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5)))))))
(assert (= o13 (ite (= o12 1) true false)))
(assert (and (= temp___1143 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (and (dynamic_invariant3 temp___1143 true false true true) (and (= temp___1143 (mk___t (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields__content to____split_fields5))) (mk (to_rep1 (first4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5)))))) (to_rep1 (last4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5))))))))) (and (and (and (= (length temp___1143) (length2 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (= (to_rep1 (first (rt temp___1143))) 1)) (= (to_rep1 (last (rt temp___1143))) (length2 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (= (< 0 (length2 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (not (= (empty (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))) true))))))))
(assert (not (<= (to_rep1 (first (rt temp___1143))) 1)))
(check-sat)
(exit)
