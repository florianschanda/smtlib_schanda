...
(assert (dynamic_predicate (mk___rep (mk___split_discrs temp___1076) (mk___split_fields temp___10761 (mk___t1 temp___10762 temp___10763)))))
(assert (= (mk___rep (mk___split_discrs temp___1077) (mk___split_fields temp___10771 (mk___t1 temp___10772 temp___10773))) (mk___rep (mk___split_discrs temp___1076) (mk___split_fields temp___10761 (mk___t1 temp___10762 temp___10763)))))
(assert (= result1 (mk___split_fields__ref to____split_fields3)))
(assert (= to____split_fields4 (mk___split_fields temp___10771 (mk___t1 temp___10772 temp___10773))))
(assert (= to____split_discrs (mk___split_discrs temp___1077)))
...
(assert (and (= temp___1080 (value (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (and (dynamic_invariant3 temp___1080 true false true) (and (= temp___1080 (mk___t (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields__content to____split_fields5))) (mk (to_rep1 (first4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5)))))) (to_rep1 (last4 (mk2 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields__content to____split_fields5))))))))) (and (and (and (= (length temp___1080) (length2 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (= (to_rep1 (first (rt temp___1080))) 1)) (= (to_rep1 (last (rt temp___1080))) (length2 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))))) (= (< 0 (length2 (mk___rep to____split_discrs (us_split_fields__content to____split_fields5)))) (not (= (empty (mk___rep to____split_discrs (us_split_fields__content to____split_fields5))) true))))))))
(assert (not (<= (to_rep1 (first (rt temp___1080))) 1)))
(check-sat)
(exit)
