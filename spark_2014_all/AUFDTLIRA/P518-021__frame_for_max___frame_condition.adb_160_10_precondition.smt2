...
(assert (and (and (forall ((i1 Int)) (=> (and (<= first3 i1) (<= i1 last3)) (forall ((j1 Int)) (=> (and (<= i1 j1) (<= j1 last3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 i1)))) (get_max_left j1 a2)))))) (forall ((i1 Int)) (=> (and (<= last3 i1) (<= i1 first3)) (forall ((j1 Int)) (=> (and (<= i1 j1) (<= j1 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a2 j1)))) (get_max_left i1 a2))))))) (= (frame_left (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) a2) true)))
