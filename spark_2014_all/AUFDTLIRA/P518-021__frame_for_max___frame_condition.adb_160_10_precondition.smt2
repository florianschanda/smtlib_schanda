...
(assert (= frame_condition__update_max_2__B_3__first__assume first4))
...
(assert (= frame_condition__update_max_2__B_3__last__assume last4))
(assert (in_range2 last4))
(assert (and (and (forall ((i Int)) (=> (and (<= first2 i) (<= i last2)) (forall ((j Int)) (=> (and (<= i j) (<= j last2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a1 i)))) (get_max_left j a1)))))) (forall ((i Int)) (=> (and (<= last2 i) (<= i first2)) (forall ((j Int)) (=> (and (<= i j) (<= j first2)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a1 j)))) (get_max_left i a1))))))) (= (frame_left (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) a1) true)))
