...
(assert (and (= frame_condition__update_max_2__B_3__first__assume (to_rep1 a__first)) (in_range2 (to_rep1 a__first))))
(assert (= frame_condition__update_max_2__B_3__first__assume first2))
(assert (in_range2 first2))
(assert (and (= frame_condition__update_max_2__B_3__last__assume (to_rep1 a__last)) (in_range2 (to_rep1 a__last))))
(assert (= frame_condition__update_max_2__B_3__last__assume last2))
(assert (in_range2 last2))
(assert (and (and (forall ((i Int)) (=> (and (<= first3 i) (<= i last3)) (forall ((j Int)) (=> (and (<= i j) (<= j last3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a1 i)))) (get_max_left j a1)))))) (forall ((i Int)) (=> (and (<= last3 i) (<= i first3)) (forall ((j Int)) (=> (and (<= i j) (<= j first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a1 j)))) (get_max_left i a1))))))) (= (frame_left (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) a1) true)))
(assert (not (< 0 (ite (<= (to_rep1 a__first) (to_rep1 a__last)) (+ (- (to_rep1 a__last) (to_rep1 a__first)) 1) 0))))
(check-sat)
(exit)
