...
(assert (= o12 (- o11 1)))
(assert (= result14 (mk_int__ref left3)))
(assert (= left4 o12))
(assert (= result15 (mk_bool__ref left_is_out3)))
(assert (= left_is_out4 (ite (< left4 0) true false)))
(assert (=> (= left_is_out4 true) (= result16 true)))
(assert (=> (not (= left_is_out4 true)) (and (<= 0 left4) (<= left4 100000))))
(assert (=> (not (= left_is_out4 true)) (= o13 left4)))
(assert (=> (not (= left_is_out4 true)) (= result16 (select number_list o13))))
(assert (not (= result16 true)))
(assert (= left_is_out7 (mk_bool__ref left_is_out4)))
(assert (= left5 (mk_int__ref left4)))
(assert (= left_is_out8 left_is_out4))
(assert (= left6 left4))
(declare-const v6 Int)
(assert (<= (int__content left5) v6))
(assert (<= v6 value))
(assert (not (not (= (select number_list v6) true))))
(check-sat)
(exit)
