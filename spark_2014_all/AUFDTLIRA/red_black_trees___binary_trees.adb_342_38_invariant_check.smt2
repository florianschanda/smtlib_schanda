...
(assert (= result4 true))
(assert (and (= o34 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f1)) j3))))) (in_range5 (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields5 f1)) j3)))))))
...
(assert (= o31 (select temp___11121 j3)))
