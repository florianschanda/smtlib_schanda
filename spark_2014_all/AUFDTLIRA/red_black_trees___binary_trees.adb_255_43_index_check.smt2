...
(assert (=> (not (= i1 0)) (=> (not (= j4 0)) (= temp___647 (mk___rep o34)))))
(assert (=> (not (= i1 0)) (=> (not (= j4 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___647))) 100))))
...
(assert (=> (not (= i1 0)) (=> (not (= j5 0)) (= o45 (mk___rep (mk___split_fields (rec__tree_model__path_type__a (us_split_fields1 (select r4 j5))) (distinct 1 0)))))))
...
(assert (=> (not (= i1 0)) (=> (not (= j5 0)) (= temp___654 (mk___rep o57)))))
(assert (=> (not (= i1 0)) (=> (not (= j5 0)) (< (length (rec__tree_model__path_type__a (us_split_fields1 temp___654))) 100))))
