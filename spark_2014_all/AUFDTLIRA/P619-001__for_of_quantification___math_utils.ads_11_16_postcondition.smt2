...
(assert (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (= temp___160 i1)))
(assert (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (= temp___159 result__1)))
(assert (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (= 0 temp___161)))
...
(assert (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (= temp___1611 result3)))
(assert (=> (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (= temp___1612 i2)))
...
(assert (exists ((temp___166 Int)) (and (and (<= (to_rep1 (first (rt v))) temp___166) (<= temp___166 (to_rep1 (last (rt v))))) (= result__6 (to_rep (select (elts v) temp___166))))))
