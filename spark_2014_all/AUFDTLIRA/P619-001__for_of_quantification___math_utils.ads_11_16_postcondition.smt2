...
(assert (< 0 (length v)))
(assert (and (and (and (= (mk_int__ref result) (mk_int__ref result__)) (= result__1 (- 2147483648))) (and (in_range1 result__1) (and (< 0 (length v)) (and (and (and (= (mk_int__ref result1) (mk_int__ref i)) (= i1 (to_rep1 (first (rt v))))) (ite (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (and (and (and (= temp___160 i1) (and (= temp___159 result__1) (and (= 0 temp___161) (and (ite (< result__1 (to_rep (select (elts v) i1))) (and (= result__1 result2) (= result__2 (to_rep (select (elts v) i1)))) (= result__2 result__1)) (and (and (<= (to_rep1 (first (rt v))) i1) (<= i1 (to_rep1 (last (rt v))))) (and (and (forall ((k2 Int)) (=> (and (<= (to_rep1 (first (rt v))) k2) (<= k2 i2)) (<= (to_rep (select (elts v) k2)) result__3))) (exists ((k2 Int)) (and (and (<= (to_rep1 (first (rt v))) k2) (<= k2 i2)) (= result__3 (to_rep (select (elts v) k2)))))) (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 result__3)) (=> (<= (to_rep1 (first (rt v))) (to_rep1 (last (rt v)))) (dynamic_property1 (to_rep1 (first (rt v))) (to_rep1 (last (rt v))) i2))) (and (<= (to_rep1 (first (rt v))) i2) (<= i2 (to_rep1 (last (rt v)))))) (and (and (= temp___1611 result3) (= temp___1612 i2)) (= i2 (to_rep1 (last (rt v)))))))))))) (and (and (= i2 i6) (= result__3 result__7)) (and (= i7 i2) (= result__8 result__3)))) (and (and (= (mk_int__ref i8) (mk_int__ref i6)) (= (mk_int__ref result__9) (mk_int__ref result__7))) (and (= i9 i7) (= result__10 result__8)))) (and (and (= i1 i8) (= result__1 result__9)) (and (= i9 i1) (= result__10 result__1))))) (and (exists ((temp___166 Int)) (and (and (<= (to_rep1 (first (rt v))) temp___166) (<= temp___166 (to_rep1 (last (rt v))))) (= result__9 (to_rep (select (elts v) temp___166))))) (and (and (= math_utils__max__result1 math_utils__max__result2) (= math_utils__max__result3 math_utils__max__result1)) (and (= result6 math_utils__max__result) (= math_utils__max__result1 result__9)))))))) (and (and (= math_utils__max__result4 (mk_int__ref math_utils__max__result2)) (and (= (mk_int__ref i10) (mk_int__ref i8)) (= (mk_int__ref result__11) (mk_int__ref result__9)))) (and (= math_utils__max__result5 math_utils__max__result3) (and (= i11 i9) (= result__12 result__10))))))
(assert (= result7 (int__content math_utils__max__result4)))
(declare-const temp___172 Int)
(assert (<= (to_rep1 (first (rt v))) temp___172))
(assert (<= temp___172 (to_rep1 (last (rt v)))))
(assert (not (<= (to_rep (select (elts v) temp___172)) (int__content math_utils__max__result4))))
(check-sat)
(exit)
