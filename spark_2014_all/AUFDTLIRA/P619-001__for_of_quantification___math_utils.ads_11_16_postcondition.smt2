...
(assert (not (exists ((temp___198 Int)) (and (and (<= (to_rep1 (first (rt v))) temp___198) (<= temp___198 (to_rep1 (last (rt v))))) (= (int__content math_utils__max__result4) (to_rep (select (elts v) temp___198)))))))
(check-sat)
(exit)
