...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep1 (select (temp___String_Literal_155 us_void_param) 1)) 50) (= (to_rep1 (select (temp___String_Literal_155 us_void_param) 2)) 48)) (= (to_rep1 (select (temp___String_Literal_155 us_void_param) 3)) 49)) (= (to_rep1 (select (temp___String_Literal_155 us_void_param) 4)) 50)) (= (to_rep1 (select (temp___String_Literal_155 us_void_param) 5)) 45)) (= (to_rep1 (select (temp___String_Literal_155 us_void_param) 6)) 48)) (= (to_rep1 (select (temp___String_Literal_155 us_void_param) 7)) 49)) (= (to_rep1 (select (temp___String_Literal_155 us_void_param) 8)) 45)) (= (to_rep1 (select (temp___String_Literal_155 us_void_param) 9)) 48)) (= (to_rep1 (select (temp___String_Literal_155 us_void_param) 10)) 49)) :pattern ((temp___String_Literal_155 us_void_param)))))
(declare-fun temp___String_Literal_156 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep1 (select (temp___String_Literal_156 us_void_param) 1)) 50) (= (to_rep1 (select (temp___String_Literal_156 us_void_param) 2)) 48)) (= (to_rep1 (select (temp___String_Literal_156 us_void_param) 3)) 49)) (= (to_rep1 (select (temp___String_Literal_156 us_void_param) 4)) 50)) (= (to_rep1 (select (temp___String_Literal_156 us_void_param) 5)) 45)) (= (to_rep1 (select (temp___String_Literal_156 us_void_param) 6)) 48)) (= (to_rep1 (select (temp___String_Literal_156 us_void_param) 7)) 49)) (= (to_rep1 (select (temp___String_Literal_156 us_void_param) 8)) 45)) (= (to_rep1 (select (temp___String_Literal_156 us_void_param) 9)) 48)) (= (to_rep1 (select (temp___String_Literal_156 us_void_param) 10)) 49)) :pattern ((temp___String_Literal_156 us_void_param)))))
...
(declare-fun temp___354 (us_rep Int Int) us_t2)
...
(assert (forall ((temp___356 us_rep)) (forall ((temp___357 Int) (temp___358 Int)) (let ((temp___355 (temp___354 temp___356 temp___357 temp___358))) (=> (dynamic_invariant1 temp___356 true true true true) (and (=> (dynamic_property6 (- 2147483648) 2147483647 temp___357 temp___358) (and (= (first5 temp___355) temp___357) (= (last5 temp___355) temp___358))) (forall ((temp___359 Int)) (= (select (to_array2 temp___355) temp___359) temp___356))))))))
...
(assert (in_range r4b))
(assert (= (to_rep2 (first4 (rt2 (temp___354 null_msg 1 r4b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___354 null_msg 1 r4b)))) r4b))
(assert (= (mk___t2 temp___361 temp___3611) (temp___354 null_msg 1 r4b)))
(assert (not (= (ite (<= (to_rep2 (first4 temp___3611)) (to_rep2 (last4 temp___3611))) (+ (- (to_rep2 (last4 temp___3611)) (to_rep2 (first4 temp___3611))) 1) 0) (ite (<= 1 r4b) (+ (- r4b 1) 1) 0))))
(check-sat)
(exit)
