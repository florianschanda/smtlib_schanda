...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep1 (select (temp___String_Literal_133 us_void_param) 1)) 50) (= (to_rep1 (select (temp___String_Literal_133 us_void_param) 2)) 48)) (= (to_rep1 (select (temp___String_Literal_133 us_void_param) 3)) 49)) (= (to_rep1 (select (temp___String_Literal_133 us_void_param) 4)) 50)) (= (to_rep1 (select (temp___String_Literal_133 us_void_param) 5)) 45)) (= (to_rep1 (select (temp___String_Literal_133 us_void_param) 6)) 48)) (= (to_rep1 (select (temp___String_Literal_133 us_void_param) 7)) 49)) (= (to_rep1 (select (temp___String_Literal_133 us_void_param) 8)) 45)) (= (to_rep1 (select (temp___String_Literal_133 us_void_param) 9)) 48)) (= (to_rep1 (select (temp___String_Literal_133 us_void_param) 10)) 49)) :pattern ((temp___String_Literal_133 us_void_param)))))
(declare-fun temp___String_Literal_134 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep1 (select (temp___String_Literal_134 us_void_param) 1)) 50) (= (to_rep1 (select (temp___String_Literal_134 us_void_param) 2)) 48)) (= (to_rep1 (select (temp___String_Literal_134 us_void_param) 3)) 49)) (= (to_rep1 (select (temp___String_Literal_134 us_void_param) 4)) 50)) (= (to_rep1 (select (temp___String_Literal_134 us_void_param) 5)) 45)) (= (to_rep1 (select (temp___String_Literal_134 us_void_param) 6)) 48)) (= (to_rep1 (select (temp___String_Literal_134 us_void_param) 7)) 49)) (= (to_rep1 (select (temp___String_Literal_134 us_void_param) 8)) 45)) (= (to_rep1 (select (temp___String_Literal_134 us_void_param) 9)) 48)) (= (to_rep1 (select (temp___String_Literal_134 us_void_param) 10)) 49)) :pattern ((temp___String_Literal_134 us_void_param)))))
...
(define-fun bool_eq5 ((x us_t1) (y us_t1)) Bool (bool_eq2 (elts1 x) (to_rep2 (first2 (rt1 x))) (to_rep2 (last2 (rt1 x))) (elts1 y) (to_rep2 (first2 (rt1 y))) (to_rep2 (last2 (rt1 y)))))
...
(define-fun bool_eq6 ((x us_t2) (y us_t2)) Bool (bool_eq2 (elts2 x) (to_rep2 (first4 (rt2 x))) (to_rep2 (last4 (rt2 x))) (elts2 y) (to_rep2 (first4 (rt2 y))) (to_rep2 (last4 (rt2 y)))))
...
(define-fun dynamic_property6 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range3 low) (and (in_range3 high) (=> (<= low high) (and (in_range3 low) (in_range3 high))))))
...
(define-fun bool_eq7 ((x us_t3) (y us_t3)) Bool (bool_eq2 (elts3 x) (to_rep2 (first6 (rt3 x))) (to_rep2 (last6 (rt3 x))) (elts3 y) (to_rep2 (first6 (rt3 y))) (to_rep2 (last6 (rt3 y)))))
...
(assert (forall ((temp___327 us_rep)) (forall ((temp___328 Int) (temp___329 Int)) (let ((temp___326 (temp___325 temp___327 temp___328 temp___329))) (and (=> (dynamic_property6 (- 2147483648) 2147483647 temp___328 temp___329) (and (= (first5 temp___326) temp___328) (= (last5 temp___326) temp___329))) (forall ((temp___330 Int)) (= (select (to_array2 temp___326) temp___330) temp___327)))))))
...
(assert (= null_msg (mk___rep (mk___split_fields (temp___String_Literal_133 Tuple0) (temp___String_Literal_134 Tuple0)))))
(define-fun dynamic_invariant5 ((temp___expr_227 us_t1) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool)) Bool (and (=> (not (= temp___skip_constant_225 true)) (and (dynamic_property3 1 r4b (first3 temp___expr_227) (last3 temp___expr_227)) (and (= (first3 temp___expr_227) 1) (= (last3 temp___expr_227) r4b)))) (forall ((temp___228 Int)) (=> (and (<= (first3 temp___expr_227) temp___228) (<= temp___228 (last3 temp___expr_227))) (=> (= temp___is_init_224 true) (let ((temp___229 (select (to_array1 temp___expr_227) temp___228))) (<= (let ((temp___231 (rec__messages__message__received (us_split_fields1 temp___229)))) (let ((temp___230 (rec__messages__message__sent (us_split_fields1 temp___229)))) (compare temp___230 1 10 temp___231 1 10))) 0)))))))
...
(assert (let ((temp___150 i1s)) (<= (compare (rec__messages__message__sent (us_split_fields1 temp___150)) 1 10 (rec__messages__message__received (us_split_fields1 temp___150)) 1 10) 0)))
(assert (dynamic_invariant2 (mk___rep1 com__split_discrs (mk___split_fields1 (mk___t com__split_fields com__split_fields1))) true false true))
(assert (type_invariant (mk___rep1 com__split_discrs (mk___split_fields1 (mk___t com__split_fields com__split_fields1)))))
(assert (<= (compare (temp___String_Literal_133 Tuple0) 1 10 (temp___String_Literal_134 Tuple0) 1 10) 0))
(assert (= (temp___String_Literal_133 Tuple0) communications__mark_duplicates__null_msg__assume))
(assert (= (temp___String_Literal_134 Tuple0) communications__mark_duplicates__null_msg__assume1))
...
(assert (let ((temp___150 null_msg)) (<= (compare (rec__messages__message__sent (us_split_fields1 temp___150)) 1 10 (rec__messages__message__received (us_split_fields1 temp___150)) 1 10) 0)))
...
(assert (not (= (ite (<= (to_rep2 (first4 temp___3321)) (to_rep2 (last4 temp___3321))) (+ (- (to_rep2 (last4 temp___3321)) (to_rep2 (first4 temp___3321))) 1) 0) (ite (<= 1 r4b) (+ (- r4b 1) 1) 0))))
(check-sat)
(exit)
