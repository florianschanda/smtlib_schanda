...
(assert (and (= o26 (shift_perm_l (mk___t o20 o21) (mk___t o22 o23) (mk___t o24 o25))) (and (in_range2 o26) (=> (= (of_int o26) true) (= (is_perm (mk___t o24 o25) (mk___t o22 o23)) true)))))
(assert (= result12 (mk_int__ref h6)))
(assert (= h7 o26))
(assert (not (= (of_int h7) true)))
(check-sat)
(exit)
