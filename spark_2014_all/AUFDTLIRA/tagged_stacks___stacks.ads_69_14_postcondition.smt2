...
(declare-fun user_eq3 (telement_arrayD1 telement_arrayD1) Bool)
(declare-const dummy3 telement_arrayD1)
...
(declare-const dummy4 (Array Int element))
...
(declare-fun user_eq4 ((Array Int element) (Array Int element)) Bool)
...
(define-fun dynamic_property ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range4 low) (and (in_range4 high) (=> (<= low high) (and (in_range low) (in_range high))))))
...
(assert (forall ((s us_rep1)) (! (dynamic_invariant1 (last2 s) true false true true) :pattern ((last2 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (dynamic_invariant1 (last3 attr__tag2 s) true false true true) :pattern ((last3 attr__tag2 s))))))
...
(assert (forall ((s us_rep)) (! (dynamic_invariant1 (size s) true false true true) :pattern ((size s)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep2 (first2 (mk1 f l))) f) (= (to_rep2 (last4 (mk1 f l))) l)))) :pattern ((mk1 f l)))))
(define-fun dynamic_property1 ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range4 low) (and (in_range4 high) (=> (<= low high) (and (in_range3 low) (in_range3 high))))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep2 (first4 (mk2 f l))) f) (= (to_rep2 (last6 (mk2 f l))) l)))) :pattern ((mk2 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep2 (first6 (mk3 f l))) f) (= (to_rep2 (last8 (mk3 f l))) l)))) :pattern ((mk3 f l)))))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range4 f) (=> (in_range4 l) (and (= (to_rep2 (first8 (mk4 f l))) f) (= (to_rep2 (last10 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
...
(assert (forall ((s us_rep1)) (! (let ((result (get_model__3 s))) (and (and (in_range1 (first1 result)) (and (in_range1 (last1 result)) (= (length result) (size (to_base s))))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__3 s)))))
(assert (forall ((attr__tag2 Int)) (forall ((s us_rep1)) (! (let ((result (get_model__31 attr__tag2 s))) (and (and (in_range1 (first1 result)) (and (in_range1 (last1 result)) (= (length result) (size (to_base s))))) (dynamic_invariant4 result true false true true))) :pattern ((get_model__31 attr__tag2 s))))))
(assert (forall ((s us_rep1)) (! (= (get_model__3 s) (get_model__31 us_tag1 s)) :pattern ((get_model__31 us_tag1 s)))))
(assert (forall ((s us_rep1)) (! (= (get_model__3 s) (ite (= (wraps_around s) true) (let ((stacks__get_model__3__R86s (last2 s))) (let ((temp___413 (let ((temp___412 (let ((temp___409 1)) (let ((temp___410 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (of_array3 temp___410 temp___409 stacks__get_model__3__R86s))))) (let ((temp___411 (let ((temp___407 100)) (let ((temp___406 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))))) (let ((temp___408 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (of_array2 temp___408 temp___406 temp___407)))))) (ite (= (length2 temp___411) 0) (of_array1 (to_array3 temp___412) (first7 temp___412) (last9 temp___412)) (of_array1 (slide (concat1 (to_array2 temp___411) (first5 temp___411) (last7 temp___411) (to_array3 temp___412) (first7 temp___412) (last9 temp___412)) (first5 temp___411) 1) 1 (- (+ 1 (+ (ite (<= (first5 temp___411) (last7 temp___411)) (+ (- (last7 temp___411) (first5 temp___411)) 1) 0) (ite (<= (first7 temp___412) (last9 temp___412)) (+ (- (last9 temp___412) (first7 temp___412)) 1) 0))) 1))))))) (of_array (to_array1 temp___413) (first3 temp___413) (last5 temp___413)))) (let ((stacks__get_model__3__R89s (last2 s))) (let ((temp___416 (let ((temp___414 (to_rep3 (rec__stacks__buffer__first (us_split_fields3 s))))) (let ((temp___415 (rec__stacks__stack_root__content1 (us_split_fields3 s)))) (of_array4 temp___415 temp___414 stacks__get_model__3__R89s))))) (of_array (to_array4 temp___416) (first9 temp___416) (last11 temp___416)))))) :pattern ((get_model__3 s)))))
...
(declare-const temp___617 positive_less_than_max)
(declare-const temp___6171 (Array Int element))
(declare-const temp___6172 less_than_max)
(declare-const temp___6173 us_private)
(declare-const temp___6174 Int)
...
(declare-const temp___621 positive_less_than_max)
(declare-const temp___6211 (Array Int element))
(declare-const temp___6212 less_than_max)
(declare-const temp___6213 us_private)
(declare-const temp___6214 Int)
...
(define-fun s__split_fields20 () us_split_fields2 (mk___split_fields1 s__split_fields4 s__split_fields5 s__split_fields6 s__split_fields7))
(assert (in_range2 e))
...
(assert (and (= o (+ (to_rep s__split_fields2) 1)) (in_range1 (+ (to_rep s__split_fields2) 1))))
(assert (= (to_rep o1) o))
(assert (= s__split_fields o2))
(assert (= s__split_fields1 o3))
(assert (= o1 o4))
(assert (= s__split_fields3 o5))
(assert (= temp___617 o2))
(assert (= temp___6171 o3))
(assert (= temp___6172 o4))
(assert (= temp___6173 o5))
(assert (= s__attr__tag temp___6174))
(assert (= (mk___split_fields__ref1 (mk___split_fields1 result result1 result2 result3)) (mk___split_fields__ref1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3))))
(assert (= temp___617 s__split_fields4))
(assert (= temp___6171 s__split_fields5))
(assert (= temp___6172 s__split_fields6))
(assert (= temp___6173 s__split_fields7))
(assert (= (to_rep1 o6) e))
(assert (and (= temp___619 (last2 (mk___rep1 s__split_fields20 s__attr__tag))) (and (in_range1 temp___619) (= temp___619 (ite (not (= (wraps_around (mk___rep1 s__split_fields20 s__attr__tag)) true)) (- (+ (to_rep3 s__split_fields4) (to_rep s__split_fields6)) 1) (- (- (+ (to_rep3 s__split_fields4) (to_rep s__split_fields6)) 1) 100))))))
(assert (and (<= 1 temp___619) (<= temp___619 100)))
(assert (= o7 temp___619))
(assert (= o8 (store s__split_fields5 o7 o6)))
(assert (= s__split_fields4 o9))
(assert (= o8 o10))
(assert (= s__split_fields6 o11))
(assert (= s__split_fields7 o12))
(assert (= temp___621 o9))
(assert (= temp___6211 o10))
(assert (= temp___6212 o11))
(assert (= temp___6213 o12))
(assert (= s__attr__tag temp___6214))
...
(assert (= temp___621 s__split_fields8))
(assert (= temp___6211 s__split_fields9))
(assert (= temp___6212 s__split_fields10))
(assert (= temp___6213 s__split_fields11))
...
(assert (not (= (let ((temp___625 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields12 s__split_fields13 s__split_fields14 s__split_fields15) s__attr__tag)))) (bool_eq (elts temp___625) (to_rep2 (first (rt temp___625))) (to_rep2 (last (rt temp___625))) (let ((temp___624 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))) (ite (= (length temp___624) 0) (singleton1 (of_rep1 e) 1) (concat_singleton_right (elts temp___624) (to_rep2 (first (rt temp___624))) (to_rep2 (last (rt temp___624))) (of_rep1 e)))) (to_rep2 (first (let ((temp___624 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))) (ite (= (length temp___624) 0) (mk 1 1) (mk (to_rep2 (first (rt temp___624))) (- (+ (to_rep2 (first (rt temp___624))) (+ (ite (<= (to_rep2 (first (rt temp___624))) (to_rep2 (last (rt temp___624)))) (+ (- (to_rep2 (last (rt temp___624))) (to_rep2 (first (rt temp___624)))) 1) 0) 1)) 1)))))) (to_rep2 (last (let ((temp___624 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))) (ite (= (length temp___624) 0) (mk 1 1) (mk (to_rep2 (first (rt temp___624))) (- (+ (to_rep2 (first (rt temp___624))) (+ (ite (<= (to_rep2 (first (rt temp___624))) (to_rep2 (last (rt temp___624)))) (+ (- (to_rep2 (last (rt temp___624))) (to_rep2 (first (rt temp___624)))) 1) 0) 1)) 1)))))))) true)))
(check-sat)
(exit)
