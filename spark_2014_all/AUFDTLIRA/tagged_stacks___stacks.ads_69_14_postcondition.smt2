...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep (first2 (mk1 f l))) f) (= (to_rep (last4 (mk1 f l))) l)))) :pattern ((mk1 f l)))))
...
(assert (and (= o (+ (to_rep2 s__split_fields2) 1)) (in_range3 (+ (to_rep2 s__split_fields2) 1))))
(assert (= (to_rep2 o1) o))
...
(assert (= (to_rep1 o6) e))
(assert (and (= temp___619 (last2 (mk___rep1 s__split_fields20 s__attr__tag))) (and (in_range3 temp___619) (= temp___619 (ite (not (= (wraps_around (mk___rep1 s__split_fields20 s__attr__tag)) true)) (- (+ (to_rep3 s__split_fields4) (to_rep2 s__split_fields6)) 1) (- (- (+ (to_rep3 s__split_fields4) (to_rep2 s__split_fields6)) 1) 100))))))
...
(assert (not (= (let ((temp___625 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields12 s__split_fields13 s__split_fields14 s__split_fields15) s__attr__tag)))) (bool_eq (elts temp___625) (to_rep (first (rt temp___625))) (to_rep (last (rt temp___625))) (let ((temp___624 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))) (ite (= (length temp___624) 0) (singleton1 (of_rep1 e) 1) (concat_singleton_right (elts temp___624) (to_rep (first (rt temp___624))) (to_rep (last (rt temp___624))) (of_rep1 e)))) (to_rep (first (let ((temp___624 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))) (ite (= (length temp___624) 0) (mk 1 1) (mk (to_rep (first (rt temp___624))) (- (+ (to_rep (first (rt temp___624))) (+ (ite (<= (to_rep (first (rt temp___624))) (to_rep (last (rt temp___624)))) (+ (- (to_rep (last (rt temp___624))) (to_rep (first (rt temp___624)))) 1) 0) 1)) 1)))))) (to_rep (last (let ((temp___624 (get_model__3 (mk___rep1 (mk___split_fields1 s__split_fields s__split_fields1 s__split_fields2 s__split_fields3) s__attr__tag)))) (ite (= (length temp___624) 0) (mk 1 1) (mk (to_rep (first (rt temp___624))) (- (+ (to_rep (first (rt temp___624))) (+ (ite (<= (to_rep (first (rt temp___624))) (to_rep (last (rt temp___624)))) (+ (- (to_rep (last (rt temp___624))) (to_rep (first (rt temp___624)))) 1) 0) 1)) 1)))))))) true)))
(check-sat)
(exit)
