...
(assert (= (tree_structure (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5))) true))
(assert (and (= o5 (size (mk___rep2 (mk___split_fields2 f__split_fields4 f__split_fields5)))) (and (in_range2 o5) (= o5 (to_rep f__split_fields4)))))
(assert (= result5 (ite (= o5 (+ (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1))) 1)) true false)))
(assert (= result5 true))
