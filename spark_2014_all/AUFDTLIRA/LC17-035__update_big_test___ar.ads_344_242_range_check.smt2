...
(assert (=> (< 0 e) (= o10 (temp_____aggregate_def_1142 o9 i o8))))
(assert (=> (< 0 e) (and (= o11 (+ j 1)) (in_range2 (+ j 1)))))
(assert (=> (< 0 e) (= temp___4799 (temp_____aggregate_def_1127 a j (temp_____aggregate_def_1135 (select a j) i e) o11 o10))))
...
(assert (= o6 (temp_____aggregate_def_1165 o5 i 99)))
