...
(assert (=> (< 0 e) (= o16 (temp___1083 o15 i o14))))
(assert (=> (< 0 e) (and (= o17 (+ j 1)) (in_range2 (+ j 1)))))
(assert (=> (< 0 e) (= temp___4740 (temp___1068 a j (temp___1076 (select a j) i e) o17 o16))))
(assert (=> (< 0 e) (= result8 (bool_eq1 a3 5 50 temp___4740 5 50))))
...
(assert (= o11 (temp___1106 o10 i 99)))
