...
(define-fun o15 () us_rep (mk___rep (mk___split_discrs o10) (mk___split_fields o11 (mk___t1 o12 o13))))
(define-fun o16 () us_t2 (mk___t2 o8 o9))
...
(assert (and (= o15 (instance o1 o16)) (and (dynamic_invariant1 o15 true false true true) (and (and (= (to_rep2 o10) o1) (= (length2 o15) (length3 o16))) (= (let ((temp___274 (value o15))) (bool_eq (elts2 temp___274) (to_rep1 (first4 (rt2 temp___274))) (to_rep1 (last4 (rt2 temp___274))) o8 (to_rep1 (first4 o9)) (to_rep1 (last4 o9)))) true)))))
...
(assert (and (= o14 (length2 right)) (and (in_range4 o14) (= o14 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(assert (not (in_range1 (length3 left))))
(check-sat)
(exit)
