...
(define-fun dynamic_invariant2 ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 2147483647)) (in_range4 temp___expr_195)))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (dynamic_invariant2 (length3 this) true false true)) :pattern ((length3 this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (= (length3 this) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length3 this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (let ((result (value this))) (and (and (and (and (= (length1 result) (length3 this)) (= (first3 result) 1)) (= (last3 result) (length3 this))) (= (< 0 (length3 this)) (not (= (empty this) true)))) (dynamic_invariant result true false true)))) :pattern ((value this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (= (value this) (let ((temp___234 (let ((temp___232 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) (let ((temp___231 1)) (let ((temp___233 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this)))) (of_array3 (to_array2 temp___233) temp___231 temp___232)))))) (of_array1 (to_array3 temp___234) (first7 temp___234) (last7 temp___234))))) :pattern ((value this)))))
(declare-fun instance (Int us_t1) us_rep)
(declare-fun instance__function_guard (us_rep Int us_t1) Bool)
(assert (forall ((capacity Int)) (forall ((content us_t1)) (! (=> (and (and (dynamic_invariant2 capacity true true true) (dynamic_invariant content true true true)) (<= (length1 content) capacity)) (let ((result (instance capacity content))) (and (and (and (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 result))) capacity) (= (length3 result) (length1 content))) (= (let ((temp___245 (value result))) (bool_eq (to_array1 temp___245) (first3 temp___245) (last3 temp___245) (to_array1 content) (first3 content) (last3 content))) true)) (dynamic_invariant1 result true false true)))) :pattern ((instance capacity content))))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true) (= (= (empty this) true) (= (length3 this) 0))) :pattern ((empty this)))))
...
(declare-const temp___984 (Array Int character))
(declare-const temp___9841 t1)
...
(declare-const temp___985 (Array Int character))
(declare-const temp___9851 t)
(declare-const o10 (Array Int character))
(declare-const o11 t1)
(declare-const o12 natural_index)
(declare-const o13 natural_index)
(declare-const o14 (Array Int character))
(declare-const o15 t2)
(declare-const temp___988 (Array Int character))
(declare-const temp___9881 t1)
...
(assert (and (and (and (= us (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 right)))) (in_range4 (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 right))))) (and (and (= bounded_dynamic_strings__Oconcat__3__result8 (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__3__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__3__result5 (mk___t2 bounded_dynamic_strings__Oconcat__3__result6 bounded_dynamic_strings__Oconcat__3__result7))))) (= bounded_dynamic_strings__Oconcat__3__result9 (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__3__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__3__result5 (mk___t2 bounded_dynamic_strings__Oconcat__3__result6 bounded_dynamic_strings__Oconcat__3__result7))))) (and (and (and (and (and (= (mk___t1 temp___984 temp___9841) (value right)) (and (dynamic_invariant (mk___t1 temp___984 temp___9841) true false true) (and (and (= (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 right))) temp___984) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))) temp___9841)) (and (and (and (= (length1 (mk___t1 temp___984 temp___9841)) (length3 right)) (= (to_rep1 (first2 temp___9841)) 1)) (= (to_rep1 (last2 temp___9841)) (length3 right))) (= (< 0 (length3 right)) (not (= (empty right) true))))))) (ite (= (length1 left) 0) (and (= temp___984 temp___985) (= (mk (to_rep1 (first2 temp___9841)) (to_rep1 (last2 temp___9841))) temp___9851)) (and (and (and (and (and (ite (<= (to_rep1 (first2 temp___9841)) (to_rep1 (last2 temp___9841))) (= o4 (+ (- (to_rep1 (last2 temp___9841)) (to_rep1 (first2 temp___9841))) 1)) (= o4 0)) (and (ite (<= (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left)))) (= o5 (+ (- (to_rep1 (last2 (rt1 left))) (to_rep1 (first2 (rt1 left)))) 1)) (= o5 0)) (= o6 (+ o5 o4)))) (= o7 (+ (to_rep1 (first2 (rt1 left))) o6))) (= o8 (- o7 1))) (and (= o9 o8) (in_range2 o8))) (and (= (concat1 (elts1 left) (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left))) temp___984 (to_rep1 (first2 temp___9841)) (to_rep1 (last2 temp___9841))) temp___985) (= (mk (to_rep1 (first2 (rt1 left))) o9) temp___9851))))) (and (dynamic_property1 1 2147483647 (to_rep1 (first temp___9851)) (to_rep1 (last temp___9851))) (and (= temp___985 o10) (= (mk1 (to_rep1 (first temp___9851)) (to_rep1 (last temp___9851))) o11)))) (and (and (and (= o2 (length1 left)) (in_range1 (length1 left))) (= o3 (+ o2 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (and (= (mk___rep (mk___split_discrs o12) (mk___split_fields o13 (mk___t2 o14 o15))) (instance o3 (mk___t1 o10 o11))) (and (dynamic_invariant1 (mk___rep (mk___split_discrs o12) (mk___split_fields o13 (mk___t2 o14 o15))) true false true) (and (and (= (to_rep2 o12) o3) (= (length3 (mk___rep (mk___split_discrs o12) (mk___split_fields o13 (mk___t2 o14 o15)))) (length1 (mk___t1 o10 o11)))) (= (let ((temp___241 (value (mk___rep (mk___split_discrs o12) (mk___split_fields o13 (mk___t2 o14 o15)))))) (bool_eq (elts1 temp___241) (to_rep1 (first2 (rt1 temp___241))) (to_rep1 (last2 (rt1 temp___241))) o10 (to_rep1 (first2 o11)) (to_rep1 (last2 o11)))) true)))))) (and (= (mk_sequence__ref (mk___rep (mk___split_discrs result) (mk___split_fields result1 (mk___t2 result2 result3)))) (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__3__result) (mk___split_fields bounded_dynamic_strings__Oconcat__3__result1 (mk___t2 bounded_dynamic_strings__Oconcat__3__result2 bounded_dynamic_strings__Oconcat__3__result3))))) (= (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__3__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__3__result5 (mk___t2 bounded_dynamic_strings__Oconcat__3__result6 bounded_dynamic_strings__Oconcat__3__result7))) (mk___rep (mk___split_discrs o12) (mk___split_fields o13 (mk___t2 o14 o15)))))))) (and (= bounded_dynamic_strings__Oconcat__3__result10 bounded_dynamic_strings__Oconcat__3__result8) (= bounded_dynamic_strings__Oconcat__3__result11 bounded_dynamic_strings__Oconcat__3__result9))))
(assert (and (= o27 (length3 right)) (and (in_range4 o27) (= o27 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
