...
(define-fun dynamic_invariant ((temp___expr_206 us_t1) (temp___is_init_202 Bool) (temp___skip_constant_203 Bool) (temp___do_toplevel_204 Bool) (temp___do_typ_inv_205 Bool)) Bool (=> (not (= temp___skip_constant_203 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_206) (last3 temp___expr_206))))
...
(define-fun dynamic_invariant2 ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 2147483647)) (in_range4 temp___expr_222)))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (dynamic_invariant2 (length3 this) true false true true)) :pattern ((length3 this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (= (length3 this) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) :pattern ((length3 this)))))
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (let ((result (value this))) (and (and (and (and (= (length1 result) (length3 this)) (= (first3 result) 1)) (= (last3 result) (length3 this))) (= (< 0 (length3 this)) (not (= (empty this) true)))) (dynamic_invariant result true false true true)))) :pattern ((value this)))))
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (= (value this) (let ((temp___263 (let ((temp___261 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 this))))) (let ((temp___260 1)) (let ((temp___262 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 this)))) (of_array3 (to_array2 temp___262) temp___260 temp___261)))))) (of_array1 (to_array3 temp___263) (first7 temp___263) (last7 temp___263))))) :pattern ((value this)))))
(declare-fun instance (Int us_t1) us_rep)
(declare-fun instance__function_guard (us_rep Int us_t1) Bool)
(assert (forall ((capacity Int)) (forall ((content us_t1)) (! (=> (and (and (dynamic_invariant2 capacity true true true true) (dynamic_invariant content true true true true)) (<= (length1 content) capacity)) (let ((result (instance capacity content))) (and (and (and (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 result))) capacity) (= (length3 result) (length1 content))) (= (let ((temp___274 (value result))) (bool_eq (to_array1 temp___274) (first3 temp___274) (last3 temp___274) (to_array1 content) (first3 content) (last3 content))) true)) (dynamic_invariant1 result true false true true)))) :pattern ((instance capacity content))))))
(declare-const left us_t1)
...
(assert (forall ((this us_rep)) (! (=> (dynamic_invariant1 this true true true true) (= (= (empty this) true) (= (length3 this) 0))) :pattern ((empty this)))))
...
(declare-const bounded_dynamic_strings__Oconcat__3__result natural_index)
(declare-const bounded_dynamic_strings__Oconcat__3__result1 natural_index)
(declare-const bounded_dynamic_strings__Oconcat__3__result2 (Array Int character))
(declare-const bounded_dynamic_strings__Oconcat__3__result3 t2)
(declare-const us Int)
(declare-const o Int)
(declare-const o1 Int)
(declare-const temp___1047 (Array Int character))
(declare-const temp___10471 t1)
...
(declare-const temp___1048 (Array Int character))
(declare-const temp___10481 t)
(declare-const o8 (Array Int character))
(declare-const o9 t1)
(declare-const o10 natural_index)
(declare-const o11 natural_index)
...
(declare-const bounded_dynamic_strings__Oconcat__3__result4 natural_index)
(declare-const bounded_dynamic_strings__Oconcat__3__result5 natural_index)
(declare-const bounded_dynamic_strings__Oconcat__3__result6 (Array Int character))
(declare-const bounded_dynamic_strings__Oconcat__3__result7 t2)
(declare-const bounded_dynamic_strings__Oconcat__3__result8 sequence__ref)
(declare-const bounded_dynamic_strings__Oconcat__3__result9 us_rep)
(declare-const bounded_dynamic_strings__Oconcat__3__result10 sequence__ref)
(declare-const bounded_dynamic_strings__Oconcat__3__result11 us_rep)
(define-fun bounded_dynamic_strings__Oconcat__3__result12 () us_rep (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__3__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__3__result5 (mk___t2 bounded_dynamic_strings__Oconcat__3__result6 bounded_dynamic_strings__Oconcat__3__result7))))
(define-fun o15 () us_rep (mk___rep (mk___split_discrs o10) (mk___split_fields o11 (mk___t2 o12 o13))))
(define-fun o16 () us_t1 (mk___t1 o8 o9))
(define-fun temp___10472 () us_t1 (mk___t1 temp___1047 temp___10471))
...
(assert (<= (+ (length1 left) (length3 right)) 2147483647))
...
(assert (= bounded_dynamic_strings__Oconcat__3__result8 (mk_sequence__ref bounded_dynamic_strings__Oconcat__3__result12)))
(assert (= bounded_dynamic_strings__Oconcat__3__result9 bounded_dynamic_strings__Oconcat__3__result12))
(assert (and (= temp___10472 (value right)) (and (dynamic_invariant temp___10472 true false true true) (and (and (= (elts2 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 right))) temp___1047) (= (mk1 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))) temp___10471)) (and (and (and (= (length1 temp___10472) (length3 right)) (= (to_rep1 (first2 temp___10471)) 1)) (= (to_rep1 (last2 temp___10471)) (length3 right))) (= (< 0 (length3 right)) (not (= (empty right) true))))))))
(assert (=> (= (length1 left) 0) (= temp___1047 temp___1048)))
(assert (=> (= (length1 left) 0) (= (mk (to_rep1 (first2 temp___10471)) (to_rep1 (last2 temp___10471))) temp___10481)))
(assert (=> (not (= (length1 left) 0)) (=> (<= (to_rep1 (first2 temp___10471)) (to_rep1 (last2 temp___10471))) (= o2 (+ (- (to_rep1 (last2 temp___10471)) (to_rep1 (first2 temp___10471))) 1)))))
(assert (=> (not (= (length1 left) 0)) (=> (not (<= (to_rep1 (first2 temp___10471)) (to_rep1 (last2 temp___10471)))) (= o2 0))))
(assert (=> (not (= (length1 left) 0)) (=> (<= (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left)))) (= o3 (+ (- (to_rep1 (last2 (rt1 left))) (to_rep1 (first2 (rt1 left)))) 1)))))
(assert (=> (not (= (length1 left) 0)) (=> (not (<= (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left))))) (= o3 0))))
(assert (=> (not (= (length1 left) 0)) (= o4 (+ o3 o2))))
(assert (=> (not (= (length1 left) 0)) (= o5 (+ (to_rep1 (first2 (rt1 left))) o4))))
(assert (=> (not (= (length1 left) 0)) (= o6 (- o5 1))))
(assert (=> (not (= (length1 left) 0)) (and (= o7 o6) (in_range2 o6))))
(assert (=> (not (= (length1 left) 0)) (= (concat1 (elts1 left) (to_rep1 (first2 (rt1 left))) (to_rep1 (last2 (rt1 left))) temp___1047 (to_rep1 (first2 temp___10471)) (to_rep1 (last2 temp___10471))) temp___1048)))
(assert (=> (not (= (length1 left) 0)) (= (mk (to_rep1 (first2 (rt1 left))) o7) temp___10481)))
(assert (dynamic_property1 1 2147483647 (to_rep1 (first temp___10481)) (to_rep1 (last temp___10481))))
(assert (= temp___1048 o8))
(assert (= (mk1 (to_rep1 (first temp___10481)) (to_rep1 (last temp___10481))) o9))
(assert (and (= o (length1 left)) (in_range1 (length1 left))))
(assert (= o1 (+ o (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))
(assert (and (= o15 (instance o1 o16)) (and (dynamic_invariant1 o15 true false true true) (and (and (= (to_rep2 o10) o1) (= (length3 o15) (length1 o16))) (= (let ((temp___270 (value o15))) (bool_eq (elts1 temp___270) (to_rep1 (first2 (rt1 temp___270))) (to_rep1 (last2 (rt1 temp___270))) o8 (to_rep1 (first2 o9)) (to_rep1 (last2 o9)))) true)))))
(assert (= (mk_sequence__ref (mk___rep (mk___split_discrs result) (mk___split_fields result1 (mk___t2 result2 result3)))) (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__3__result) (mk___split_fields bounded_dynamic_strings__Oconcat__3__result1 (mk___t2 bounded_dynamic_strings__Oconcat__3__result2 bounded_dynamic_strings__Oconcat__3__result3))))))
(assert (= bounded_dynamic_strings__Oconcat__3__result12 o15))
(assert (= bounded_dynamic_strings__Oconcat__3__result10 bounded_dynamic_strings__Oconcat__3__result8))
(assert (= bounded_dynamic_strings__Oconcat__3__result11 bounded_dynamic_strings__Oconcat__3__result9))
(assert (and (= o14 (length3 right)) (and (in_range4 o14) (= o14 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(assert (not (in_range1 (length1 left))))
(check-sat)
(exit)
