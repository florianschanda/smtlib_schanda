...
(assert (forall ((temp___156 Int)) (=> (dynamic_invariant temp___156 true true true true) (forall ((temp___157 Int)) (= (to_rep (select (p__x__aggregate_def temp___156) temp___157)) temp___156)))))
