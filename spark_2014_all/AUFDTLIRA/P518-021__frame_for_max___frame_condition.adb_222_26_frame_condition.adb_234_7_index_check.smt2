...
(assert (<= (to_rep1 a__first) i9))
(assert (<= i9 (to_rep1 a__last)))
(assert (and (<= (to_rep1 a__first) i9) (<= i9 (to_rep1 a__last))))
(assert (= o91 i9))
(assert (= o92 (select (map__content a7) o91)))
(assert (= o93 (us_split_fields1 o92)))
(assert (= o94 (rec__frame_condition__cell__max_left o93)))
(assert (= o95 (to_rep o94)))
(assert (not (<= (to_rep1 a__first) i9)))
(check-sat)
(exit)
