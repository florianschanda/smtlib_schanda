...
(assert (= b1 result1))
(assert (= b2 o2))
(assert (and (= o5 (remove_last r)) (and (dynamic_invariant2 o5 true false true true) (and (= (elts r) o3) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1))))) o4)))))
