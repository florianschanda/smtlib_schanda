...
(assert (forall ((a us_t)) (! (=> (dynamic_invariant2 a true true true) (= (remove_last a) (let ((temp___164 (let ((temp___163 (- (last1 a) 1))) (let ((temp___162 (first1 a))) (of_array1 (to_array a) temp___162 temp___163))))) (of_array (to_array1 temp___164) (first3 temp___164) (last3 temp___164))))) :pattern ((remove_last a)))))
...
(assert (and (= (mk___t perm__occ_set__b__assume perm__occ_set__b__assume1) (remove_last a)) (and (dynamic_invariant2 (mk___t perm__occ_set__b__assume perm__occ_set__b__assume1) true false true) (and (= (elts a) perm__occ_set__b__assume) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1))))) perm__occ_set__b__assume1)))))
...
(assert (= o3 i))
(assert (= temp___238 (store b1 o3 o2)))
(assert (= (to_rep b__first) 0))
(assert (= o4 temp___238))
(assert (= b1 result1))
(assert (= b2 o4))
(assert (and (= (mk___t o5 o6) (remove_last r)) (and (dynamic_invariant2 (mk___t o5 o6) true false true) (and (= (elts r) o5) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1))))) o6)))))
(assert (= (occ (mk___t o5 o6) e) (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e)))
