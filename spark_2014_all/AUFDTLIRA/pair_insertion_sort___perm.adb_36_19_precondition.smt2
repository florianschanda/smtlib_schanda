...
(assert (and (= perm__occ_set__b__assume2 (remove_last a)) (and (dynamic_invariant2 perm__occ_set__b__assume2 true false true) (and (= (elts a) perm__occ_set__b__assume) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt a))) (- (to_rep (last (rt a))) 1))))) perm__occ_set__b__assume1)))))
...
(assert (= b1 result1))
(assert (= b2 o2))
(assert (and (= o5 (remove_last r)) (and (dynamic_invariant2 o5 true false true) (and (= (elts r) o3) (= (mk (to_rep (first2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1)))) (to_rep (last2 (mk1 (to_rep (first (rt r))) (- (to_rep (last (rt r))) 1))))) o4)))))
(assert (= (occ o5 e) (occ (mk___t b2 (mk (to_rep b__first) (to_rep b__last))) e)))
