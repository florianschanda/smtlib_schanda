...
(assert (= temp___195 result6))
(assert (= temp___1951 l2))
(assert (and (= o10 (+ l2 1)) (in_range1 (+ l2 1))))
(assert (= l2 result7))
(assert (= l3 o10))
(assert (and (= o18 (+ x l3)) (in_range1 (+ x l3))))
(assert (= result10 (ite (<= o18 1000) true false)))
(assert (=> (= result10 true) (and (= o17 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result10 true) (= result9 (ite (<= o17 1000) true false))))
(assert (=> (not (= result10 true)) (= result9 false)))
(assert (=> (= result9 true) (and (= temp___1971 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result9 true) (and (<= 1 temp___1971) (<= temp___1971 1000))))
(assert (=> (= result9 true) (= o13 temp___1971)))
(assert (=> (= result9 true) (= o14 (select a o13))))
(assert (=> (= result9 true) (= o15 (to_rep o14))))
(assert (=> (= result9 true) (and (= temp___1961 (+ x l3)) (in_range1 (+ x l3)))))
(assert (=> (= result9 true) (and (<= 1 temp___1961) (<= temp___1961 1000))))
(assert (=> (= result9 true) (= o11 temp___1961)))
(assert (=> (= result9 true) (= o12 (select a o11))))
(assert (=> (= result9 true) (= o16 (to_rep o12))))
(assert (=> (= result9 true) (= o19 (ite (= o16 o15) true false))))
(assert (=> (not (= result9 true)) (= o19 false)))
(assert (= result8 (ite (not (= o19 true)) true false)))
(assert (not (= result8 true)))
(assert (and (= o20 (+ x l3)) (in_range1 (+ x l3))))
(assert (= r5b2 result11))
(assert (= r5b3 o20))
(assert (in_range1 r5b3))
(assert (and (= o21 (+ y l3)) (in_range1 (+ y l3))))
(assert (= r8b2 result12))
(assert (= r8b3 o21))
(assert (in_range1 r8b3))
(assert (not (< temp___1951 l3)))
(check-sat)
(exit)
