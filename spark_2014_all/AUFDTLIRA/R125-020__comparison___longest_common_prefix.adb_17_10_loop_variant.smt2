...
(assert (= temp___1711 result6))
(assert (= temp___1712 l2))
(assert (and (= o14 (+ l2 1)) (in_range1 (+ l2 1))))
(assert (= l2 result7))
(assert (= l3 o14))
(assert (and (= o22 (+ x l3)) (in_range1 (+ x l3))))
(assert (= result10 (ite (<= o22 1000) true false)))
(assert (=> (= result10 true) (and (= o21 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result10 true) (= result9 (ite (<= o21 1000) true false))))
(assert (=> (not (= result10 true)) (= result9 false)))
(assert (=> (= result9 true) (and (= temp___1731 (+ y l3)) (in_range1 (+ y l3)))))
(assert (=> (= result9 true) (and (<= 1 temp___1731) (<= temp___1731 1000))))
(assert (=> (= result9 true) (= o17 temp___1731)))
(assert (=> (= result9 true) (= o18 (select a o17))))
(assert (=> (= result9 true) (= o19 (to_rep o18))))
(assert (=> (= result9 true) (and (= temp___1721 (+ x l3)) (in_range1 (+ x l3)))))
(assert (=> (= result9 true) (and (<= 1 temp___1721) (<= temp___1721 1000))))
(assert (=> (= result9 true) (= o15 temp___1721)))
(assert (=> (= result9 true) (= o16 (select a o15))))
...
(assert (= r5b3 result11))
(assert (= r5b4 o24))
(assert (in_range1 r5b4))
(assert (and (= o25 (+ y l3)) (in_range1 (+ y l3))))
(assert (= r8b3 result12))
(assert (= r8b4 o25))
(assert (in_range1 r8b4))
(assert (not (< temp___1712 l3)))
(check-sat)
(exit)
