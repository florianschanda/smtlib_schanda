...
(define-fun temp___2502 () us_t (mk___t temp___250 temp___2501))
...
(assert (and (= o30 (remove (mk___t values2 (mk 1 100)) o16)) (and (dynamic_invariant4 o30 true false true) (and (= (invariant__ o30) true) (and (= (to_rep1 (last o18)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o16 1))) (= (to_rep (select values2 k)) (to_rep (select o17 k))))) (and (forall ((k Int)) (=> (and (<= (+ o16 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o17 (- k 1)))))) (forall ((k Int)) (=> (and (<= o16 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o17 k))))))))))))
(assert (and (= o13 y) (in_range5 y)))
(assert (and (= o31 (remove (mk___t interm1 (mk 1 100)) o13)) (and (dynamic_invariant4 o31 true false true) (and (= (invariant__ o31) true) (and (= (to_rep1 (last o15)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o13 1))) (= (to_rep (select interm1 k)) (to_rep (select o14 k))))) (and (forall ((k Int)) (=> (and (<= (+ o13 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select o14 (- k 1)))))) (forall ((k Int)) (=> (and (<= o13 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select o14 k))))))))))))
(assert (and (= o20 (remove_eq o31 o30 o19)) (and (in_range4 o20) (=> (= (of_int o20) true) (= (let ((temp___163 (remove o30 o19))) (let ((temp___162 (remove o31 o19))) (bool_eq (elts temp___162) (to_rep1 (first (rt temp___162))) (to_rep1 (last (rt temp___162))) (elts temp___163) (to_rep1 (first (rt temp___163))) (to_rep1 (last (rt temp___163)))))) true)))))
(assert (= result4 (mk_int__ref hr1)))
(assert (= hr2 o20))
(assert (and (= o22 x) (in_range5 x)))
(assert (and (= o21 y) (in_range5 y)))
(assert (and (= o23 (remove_swap (mk___t interm1 (mk 1 100)) o21 o22)) (and (in_range4 o23) (=> (= (of_int o23) true) (= (let ((temp___157 (remove (remove (mk___t interm1 (mk 1 100)) o22) o21))) (let ((temp___156 (remove (remove (mk___t interm1 (mk 1 100)) o21) (- o22 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))))
...
(assert (and (= o29 (remove (mk___t values2 (mk 1 100)) o24)) (and (dynamic_invariant4 o29 true false true) (and (= (invariant__ o29) true) (and (= (to_rep1 (last o26)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o24 1))) (= (to_rep (select values2 k)) (to_rep (select o25 k))))) (and (forall ((k Int)) (=> (and (<= (+ o24 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o25 (- k 1)))))) (forall ((k Int)) (=> (and (<= o24 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o25 k))))))))))))
(assert (and (= temp___2502 (remove o29 o27)) (and (dynamic_invariant4 temp___2502 true false true) (and (= (invariant__ temp___2502) true) (and (= (to_rep1 (last temp___2501)) (- (to_rep1 (last o26)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o27 1))) (= (to_rep (select o25 k)) (to_rep (select temp___250 k))))) (and (forall ((k Int)) (=> (and (<= (+ o27 1) k) (<= k (to_rep1 (last o26)))) (= (to_rep (select o25 k)) (to_rep (select temp___250 (- k 1)))))) (forall ((k Int)) (=> (and (<= o27 k) (<= k (- (to_rep1 (last o26)) 1))) (= (to_rep (select o25 (+ k 1))) (to_rep (select temp___250 k))))))))))))
