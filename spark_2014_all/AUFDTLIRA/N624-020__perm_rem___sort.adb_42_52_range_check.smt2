...
(assert (and (= o23 (- x 1)) (in_range5 (- x 1))))
(assert (and (= o20 y) (in_range5 y)))
(assert (and (= (mk___t o21 o22) (remove (mk___t values2 (mk 1 100)) o20)) (and (dynamic_invariant4 (mk___t o21 o22) true false true) (and (= (invariant__ (mk___t o21 o22)) true) (and (= (to_rep1 (last o22)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o20 1))) (= (to_rep (select values2 k)) (to_rep (select o21 k))))) (and (forall ((k Int)) (=> (and (<= (+ o20 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o21 (- k 1)))))) (forall ((k Int)) (=> (and (<= o20 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o21 k))))))))))))
(assert (and (= o17 y) (in_range5 y)))
(assert (and (= (mk___t o18 o19) (remove (mk___t interm1 (mk 1 100)) o17)) (and (dynamic_invariant4 (mk___t o18 o19) true false true) (and (= (invariant__ (mk___t o18 o19)) true) (and (= (to_rep1 (last o19)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o17 1))) (= (to_rep (select interm1 k)) (to_rep (select o18 k))))) (and (forall ((k Int)) (=> (and (<= (+ o17 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select interm1 k)) (to_rep (select o18 (- k 1)))))) (forall ((k Int)) (=> (and (<= o17 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select interm1 (+ k 1))) (to_rep (select o18 k))))))))))))
(assert (and (= o24 (remove_eq (mk___t o18 o19) (mk___t o21 o22) o23)) (and (in_range4 o24) (=> (= (of_int o24) true) (= (let ((temp___163 (remove (mk___t o21 o22) o23))) (let ((temp___162 (remove (mk___t o18 o19) o23))) (bool_eq (elts temp___162) (to_rep1 (first (rt temp___162))) (to_rep1 (last (rt temp___162))) (elts temp___163) (to_rep1 (first (rt temp___163))) (to_rep1 (last (rt temp___163)))))) true)))))
(assert (= result4 (mk_int__ref hr1)))
(assert (= hr5 o24))
(assert (and (= o26 x) (in_range5 x)))
(assert (and (= o25 y) (in_range5 y)))
(assert (and (= o27 (remove_swap (mk___t interm1 (mk 1 100)) o25 o26)) (and (in_range4 o27) (=> (= (of_int o27) true) (= (let ((temp___157 (remove (remove (mk___t interm1 (mk 1 100)) o26) o25))) (let ((temp___156 (remove (remove (mk___t interm1 (mk 1 100)) o25) (- o26 1)))) (bool_eq (elts temp___156) (to_rep1 (first (rt temp___156))) (to_rep1 (last (rt temp___156))) (elts temp___157) (to_rep1 (first (rt temp___157))) (to_rep1 (last (rt temp___157)))))) true)))))
(assert (= result5 (mk_int__ref hr5)))
(assert (= hr6 o27))
(assert (= (let ((temp___248 (remove (remove (mk___t interm1 (mk 1 100)) y) (- x 1)))) (let ((temp___247 (remove (remove (mk___t interm1 (mk 1 100)) x) y))) (bool_eq (elts temp___247) (to_rep1 (first (rt temp___247))) (to_rep1 (last (rt temp___247))) (elts temp___248) (to_rep1 (first (rt temp___248))) (to_rep1 (last (rt temp___248)))))) true))
(assert (and (= o39 (- x 1)) (in_range5 (- x 1))))
(assert (and (= o36 y) (in_range5 y)))
(assert (and (= (mk___t o37 o38) (remove (mk___t values2 (mk 1 100)) o36)) (and (dynamic_invariant4 (mk___t o37 o38) true false true) (and (= (invariant__ (mk___t o37 o38)) true) (and (= (to_rep1 (last o38)) (- (to_rep1 (last (mk 1 100))) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o36 1))) (= (to_rep (select values2 k)) (to_rep (select o37 k))))) (and (forall ((k Int)) (=> (and (<= (+ o36 1) k) (<= k (to_rep1 (last (mk 1 100))))) (= (to_rep (select values2 k)) (to_rep (select o37 (- k 1)))))) (forall ((k Int)) (=> (and (<= o36 k) (<= k (- (to_rep1 (last (mk 1 100))) 1))) (= (to_rep (select values2 (+ k 1))) (to_rep (select o37 k))))))))))))
(assert (and (= (mk___t temp___250 temp___2501) (remove (mk___t o37 o38) o39)) (and (dynamic_invariant4 (mk___t temp___250 temp___2501) true false true) (and (= (invariant__ (mk___t temp___250 temp___2501)) true) (and (= (to_rep1 (last temp___2501)) (- (to_rep1 (last o38)) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- o39 1))) (= (to_rep (select o37 k)) (to_rep (select temp___250 k))))) (and (forall ((k Int)) (=> (and (<= (+ o39 1) k) (<= k (to_rep1 (last o38)))) (= (to_rep (select o37 k)) (to_rep (select temp___250 (- k 1)))))) (forall ((k Int)) (=> (and (<= o39 k) (<= k (- (to_rep1 (last o38)) 1))) (= (to_rep (select o37 (+ k 1))) (to_rep (select temp___250 k))))))))))))
(assert (and (= o43 y) (in_range5 y)))
