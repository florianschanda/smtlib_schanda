...
(declare-const temp___708 extended_index_type)
(declare-const temp___7081 (Array Int us_rep2))
...
(declare-const temp___703 extended_index_type)
(declare-const temp___7031 (Array Int us_rep2))
...
(declare-const temp___715 us_rep3)
...
(declare-const temp___720 us_rep3)
(declare-const i1 Int)
(declare-const i2 Int)
(declare-const i3 Int)
(declare-const o44 Int)
(declare-const o45 Int)
(declare-const temp___751 (Array Int us_rep1))
...
(declare-const o71 (Array Int us_rep1))
...
(assert (and (and (and (= result1 (mk___split_fields__ref2 (mk___split_fields2 f_old__split_fields f_old__split_fields1))) (= f_old__split_fields2 (mk___split_fields2 f__split_fields f__split_fields1))) (and (and (ite (= d 0) (= o (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 i))))) (= o (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 i)))))) (and (= result2 (mk_int__ref v)) (= v1 o))) (and (ite (not (= v1 0)) (and (ite (= d 0) (and (and (and (and (and (and (= (to_rep o1) 0) (and (= o1 o2) (and (= (rec__binary_trees__cell__right (us_split_fields3 (select f__split_fields1 i))) o3) (and (= (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))) o4) (= (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i))) o5))))) (and (= o6 o2) (and (= o7 o3) (and (= o8 o4) (= o9 o5))))) (= o10 (store f__split_fields1 i (mk___rep1 (mk___split_fields1 o6 o7 o8 o9))))) (and (= f__split_fields o11) (= o10 o12))) (and (= temp___708 o11) (= temp___7081 o12))) (and (= result3 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1))) (= f__split_fields3 (mk___split_fields2 temp___708 temp___7081)))) (and (and (and (and (and (and (and (= (to_rep o13) 0) (and (= (rec__binary_trees__cell__left (us_split_fields3 (select f__split_fields1 i))) o14) (and (= o13 o15) (and (= (rec__binary_trees__cell__parent (us_split_fields3 (select f__split_fields1 i))) o16) (= (rec__binary_trees__cell__position (us_split_fields3 (select f__split_fields1 i))) o17))))) (and (= o18 o14) (and (= o19 o15) (and (= o20 o16) (= o21 o17))))) (= o22 (store f__split_fields1 i (mk___rep1 (mk___split_fields1 o18 o19 o20 o21))))) (and (= f__split_fields o23) (= o22 o24))) (and (= temp___703 o23) (= temp___7031 o24))) (and (= result4 (mk___split_fields__ref2 (mk___split_fields2 f__split_fields f__split_fields1))) (= f__split_fields4 (mk___split_fields2 temp___703 temp___7031)))) (= f__split_fields3 f__split_fields4))) (and (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v1)))) i) (and (and (and (and (and (and (and (= (to_rep1 o25) 2) (and (= (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v1))) o26) (and (= (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v1))) o27) (and (= (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields3) v1))) o28) (= o25 o29))))) (and (= o30 o26) (and (= o31 o27) (and (= o32 o28) (= o33 o29))))) (and (and (and (<= 1 v1) (<= v1 100)) (= o34 v1)) (= o35 (store (rec__binary_trees__forest__c f__split_fields3) o34 (mk___rep1 (mk___split_fields1 o30 o31 o32 o33)))))) (and (= (rec__binary_trees__forest__s f__split_fields3) o36) (= o35 o37))) (= temp___715 (mk___rep2 (mk___split_fields2 o36 o37)))) (and (= result5 (mk___split_fields__ref2 f__split_fields3)) (= f__split_fields5 (us_split_fields5 temp___715)))) (and (and (and (and (and (and (= (to_rep o38) 0) (= o39 (mk___split_fields1 (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields5) v1))) (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields5) v1))) o38 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields5) v1)))))) (= o40 (mk___rep1 o39))) (and (and (and (<= 1 v1) (<= v1 100)) (= o41 v1)) (= o42 (store (rec__binary_trees__forest__c f__split_fields5) o41 o40)))) (= o43 (mk___split_fields2 (rec__binary_trees__forest__s f__split_fields5) o42))) (= temp___720 (mk___rep2 o43))) (and (= result6 (mk___split_fields__ref2 f__split_fields5)) (= f__split_fields6 (us_split_fields5 temp___720))))))) (and (= f__split_fields6 (mk___split_fields2 f__split_fields f__split_fields1)) (= f__split_fields6 f__split_fields2))) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i8)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i8)))) 0)) (= (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i8)))))))) i8)))) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (and (not (= (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i8)))) 0)) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i8)))) 1)) (= (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) (to_rep (rec__binary_trees__cell__parent (us_split_fields3 (select (rec__binary_trees__forest__c f__split_fields6) i8)))))))) i8)))) (=> (not (= v1 0)) (and (and (= (tree_structure (mk___rep2 f__split_fields6)) true) (= (tree_structure (mk___rep2 f_old__split_fields2)) true)) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i8))) true) (ite (= (ole (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) v1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i8)))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) v1) i8))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i8))) true))))) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i8))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i8))) true)))) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) v1) i8))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i8))) true)))) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i8))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) root) i8))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i8)))) true)))) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) v1) i8))) true) (= (is_concat (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) v1))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f__split_fields6) v1) i8))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 f_old__split_fields2) root) i8)))) true)))) (forall ((r Int)) (=> (and (<= 1 r) (<= r (to_rep (rec__binary_trees__forest__s f__split_fields6)))) (=> (and (and (not (= r root)) (not (= r v1))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c f_old__split_fields2) r)))) 2)) (= (oeq1 (model__ (mk___rep2 f_old__split_fields2) r) (model__ (mk___rep2 f__split_fields6) r)) true)))))))))))))))) (and (and (= f_old__split_fields3 (mk___split_fields__ref2 f_old__split_fields2)) (and (= v2 (mk_int__ref v1)) (= f__split_fields7 (mk___split_fields__ref2 f__split_fields6)))) (and (= f_old__split_fields4 f_old__split_fields2) (and (= v3 v1) (= f__split_fields8 f__split_fields6))))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o81 (size (mk___rep2 (us_split_fields__content2 f__split_fields7)))) (and (in_range2 o81) (= o81 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))))))
(assert (= result7 (ite (= o81 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) true false)))
(assert (= result7 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= result8 (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) root)) (and (= (= result8 true) (and (<= root (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) root)))) 2))) (=> (< (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) root) (not (= result8 true))))))
(assert (= result8 true))
(assert (= (int__content v2) (peek (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) i d)))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o80 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o80) (and (= o80 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o80 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o80) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o80) i)) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j3) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j3) d)))))) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j3) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j3) d)) (= o80 j3)))))))))
(assert (= result9 (ite (= o80 0) true false)))
(assert (= result9 true))
(assert (= (= result10 true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (not (= j3 (int__content v2))) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j3) (parent (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j3)))))))
(assert (= result10 true))
(assert (= (= result11 true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (not (= j3 (int__content v2))) (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j3) 0))) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j3) (position (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j3)))))))
(assert (= result11 true))
(assert (= (= result13 true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (forall ((e1 Int)) (=> (and (<= 0 e1) (<= e1 1)) (=> (or (not (= j3 i)) (not (= e1 d))) (= (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) j3 e1) (peek (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) j3 e1)))))))))
(assert (= result13 true))
(assert (= (= result14 true) (forall ((t2 Int)) (=> (and (<= 1 t2) (<= t2 100)) (=> (and (and (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t2) true) (not (= i t2))) (not (= (int__content v2) t2))) (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) t2) true))))))
(assert (= result14 true))
(assert (= (= result16 true) (forall ((t2 Int)) (=> (and (<= 1 t2) (<= t2 100)) (=> (and (and (= (valid_root (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t2) true) (not (= root t2))) (not (= (int__content v2) t2))) (= (oeq1 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) t2) (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) t2)) true))))))
(assert (= result16 true))
(assert (=> (not (= (int__content v2) 0)) (and (= o67 (int__content v2)) (in_range1 (int__content v2)))))
(assert (=> (not (= (int__content v2) 0)) (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true)))
(assert (=> (not (= (int__content v2) 0)) (and (= o68 (int__content v2)) (in_range1 (int__content v2)))))
(assert (=> (not (= (int__content v2) 0)) (and (= result18 (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) o68)) (and (= (= result18 true) (and (<= o68 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) o68)))) 2))) (=> (< (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) o68) (not (= result18 true)))))))
(assert (=> (= (int__content v2) 0) (= result18 (of_int 1))))
(assert (= result18 true))
(assert (= (= result19 true) (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i8))) true) (ite (and (not (= (int__content v2) 0)) (= (ole (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) (int__content v2)))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i8)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) (int__content v2)) i8))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) i8))) true)))))))
(assert (= result19 true))
(assert (= (= result21 true) (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) i8))) true) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i8))) true))))))
(assert (= result21 true))
(assert (= (= result22 true) (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (and (not (= (int__content v2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) (int__content v2)) i8))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i8))) true))))))
(assert (= result22 true))
(assert (= (= result23 true) (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) i8))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root) i8))) (rec__tree_model__path_type__a (us_split_fields1 (select (model__ (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)) root) i8)))) true))))))
...
(assert (=> (not (= (int__content v2) 0)) (and (= temp___751 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) o45)) (and (dynamic_invariant3 temp___751 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___751 o45))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___751 o45)))) 0) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (not (= i8 o45)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i8) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___751 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i8)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___751 i8))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___751 i8))) true)))))) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___751 i8))) true) (not (= i8 o45))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___751 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i8)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i8) (rec__tree_model__path_type__a (us_split_fields1 (select temp___751 i8)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___751 i8)))) 0)))) (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___751 i8))) true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___751 j3))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___751 i8))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___751 j3)))) true)) (= j3 i8)))))))))))))))
(assert (=> (not (= (int__content v2) 0)) (= o46 (select temp___751 i3))))
(assert (=> (not (= (int__content v2) 0)) (= o47 (us_split_fields1 o46))))
(assert (=> (not (= (int__content v2) 0)) (= result25 (rec__tree_model__path_type__k o47))))
(assert (=> (= (int__content v2) 0) (= result25 false)))
(assert (= result25 true))
(assert (and (= o52 (int__content v2)) (in_range1 (int__content v2))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o53 (int__content v2)) (in_range1 (int__content v2))))
(assert (not (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) o53) true)))
(check-sat)
(exit)
