...
(assert (= result6 (ite (= o53 (size (mk___rep2 (mk___split_fields2 f__split_fields f__split_fields1)))) true false)))
(assert (= result6 true))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
...
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o52 (peek (mk___rep2 (us_split_fields__content2 f__split_fields7)) i d)) (and (in_range2 o52) (and (= o52 (ite (= d 0) (to_rep (rec__binary_trees__cell__left (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))) (to_rep (rec__binary_trees__cell__right (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) i)))))) (and (ite (not (= o52 0)) (and (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) o52) d) (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) o52) i)) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (not (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)))))) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) i) (= (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) j) d)) (= o52 j)))))))))
(assert (= result8 (ite (= o52 0) true false)))
(assert (= result8 true))
...
(assert (=> (not (= (int__content v2) 0)) (and (= o50 (int__content v2)) (in_range1 (int__content v2)))))
(assert (=> (not (= (int__content v2) 0)) (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true)))
(assert (=> (not (= (int__content v2) 0)) (and (= o51 (int__content v2)) (in_range1 (int__content v2)))))
(assert (=> (not (= (int__content v2) 0)) (and (= result14 (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) o51)) (and (= (= result14 true) (and (<= o51 (to_rep (rec__binary_trees__forest__s (us_split_fields__content2 f__split_fields7)))) (= (to_rep1 (rec__binary_trees__cell__position (us_split_fields3 (select (rec__binary_trees__forest__c (us_split_fields__content2 f__split_fields7)) o51)))) 2))) (=> (< (size (mk___rep2 (us_split_fields__content2 f__split_fields7))) o51) (not (= result14 true)))))))
...
(assert (=> (not (= (int__content v2) 0)) (and (= temp___797 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) o45)) (and (dynamic_invariant3 temp___797 true false true true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___797 o45))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___797 o45)))) 0) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (not (= i2 o45)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___797 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___797 i2))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___797 i2))) true)))))) (and (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___797 i2))) true) (not (= i2 o45))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___797 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i2) (rec__tree_model__path_type__a (us_split_fields1 (select temp___797 i2)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___797 i2)))) 0)))) (forall ((i2 Int)) (=> (and (<= 1 i2) (<= i2 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___797 i2))) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___797 j))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___797 i2))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___797 j)))) true)) (= j i2)))))))))))))))
(assert (=> (not (= (int__content v2) 0)) (= o46 (select temp___797 i1))))
(assert (=> (not (= (int__content v2) 0)) (= o47 (us_split_fields1 o46))))
(assert (=> (not (= (int__content v2) 0)) (= result19 (rec__tree_model__path_type__k o47))))
(assert (=> (not (not (= (int__content v2) 0))) (= result19 false)))
(assert (= result19 true))
(assert (and (= o48 (int__content v2)) (in_range1 (int__content v2))))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= o49 (int__content v2)) (in_range1 (int__content v2))))
(assert (not (= (valid_root (mk___rep2 (us_split_fields__content2 f__split_fields7)) o49) true)))
(check-sat)
(exit)
