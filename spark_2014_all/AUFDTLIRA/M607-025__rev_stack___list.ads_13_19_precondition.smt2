...
(define-fun dynamic_invariant1 ((temp___expr_164 us_t) (temp___is_init_161 Bool) (temp___skip_constant_162 Bool) (temp___do_toplevel_163 Bool)) Bool (=> (not (= temp___skip_constant_162 true)) (dynamic_property 1 2147483647 (first1 temp___expr_164) (last1 temp___expr_164))))
(assert (forall ((s us_rep)) (! (let ((result (to__ s))) (and (and (= (first1 result) 1) (<= 0 (last1 result))) (dynamic_invariant1 result true false true))) :pattern ((to__ s)))))
...
(assert (forall ((s us_rep)) (! (=> (not (= (is_empty s) true)) (let ((result (top s))) (and (= result (to_rep (let ((temp___179 (to__ s))) (select (to_array temp___179) (last1 (to__ s)))))) (dynamic_invariant result true false true)))) :pattern ((top s)))))
(assert (forall ((s us_rep)) (! (= (top s) (to_rep (let ((temp___181 (rec__stack__stack__content (us_split_fields1 s)))) (select temp___181 (to_rep1 (rec__stack__stack__top (us_split_fields1 s))))))) :pattern ((top s)))))
...
(assert (forall ((temp___184 Int)) (= (select (temp___182 temp___184) 1) (of_rep temp___184))))
...
(define-fun dynamic_invariant2 ((temp___expr_274 Int) (temp___is_init_271 Bool) (temp___skip_constant_272 Bool) (temp___do_toplevel_273 Bool)) Bool (=> (or (= temp___is_init_271 true) (<= 0 100)) (in_range6 temp___expr_274)))
...
(define-fun capacity ((container us_rep1)) Int (ite (= (of_int 1) true) (to_rep2 (rec__list__my_lists__vector__capacity (us_split_discrs1 container))) 100))
(declare-fun capacity__function_guard (Int us_rep1) Bool)
(assert (forall ((container us_rep1)) (! (let ((result (length2 container))) (and (<= result (capacity container)) (dynamic_invariant2 result true false true))) :pattern ((length2 container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_268 Int) (temp___is_init_265 Bool) (temp___skip_constant_266 Bool) (temp___do_toplevel_267 Bool)) Bool (=> (or (= temp___is_init_265 true) (<= 0 101)) (in_range7 temp___expr_268)))
(declare-fun first_index__function_guard (Int us_rep1) Bool)
(define-fun dynamic_invariant4 ((temp___expr_256 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= 1 100)) (in_range5 temp___expr_256)))
...
(define-fun dynamic_invariant5 ((temp___expr_262 Int) (temp___is_init_259 Bool) (temp___skip_constant_260 Bool) (temp___do_toplevel_261 Bool)) Bool (=> (or (= temp___is_init_259 true) (<= (- 2147483648) 2147483647)) (in_range8 temp___expr_262)))
...
(define-fun dynamic_invariant6 ((temp___expr_398 us_rep1) (temp___is_init_395 Bool) (temp___skip_constant_396 Bool) (temp___do_toplevel_397 Bool)) Bool (=> (not (= temp___skip_constant_396 true)) (in_range9 100 temp___expr_398)))
(define-fun default_initial_assumption ((temp___expr_400 us_rep1) (temp___skip_top_level_401 Bool)) Bool (and (= (to_rep2 (rec__list__my_lists__vector__capacity (us_split_discrs1 temp___expr_400))) 100) (=> (not (= temp___skip_top_level_401 true)) (= (is_empty1 temp___expr_400) true))))
...
(define-fun dynamic_invariant7 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range3 temp___expr_39)))
(assert (= first4 1))
...
(define-fun dynamic_invariant8 ((temp___expr_208 Int) (temp___is_init_205 Bool) (temp___skip_constant_206 Bool) (temp___do_toplevel_207 Bool)) Bool (=> (or (= temp___is_init_205 true) (<= 0 2147483647)) (in_range10 temp___expr_208)))
(assert true)
...
(define-fun dynamic_invariant9 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 100)) (in_range2 temp___expr_136)))
...
(define-fun default_initial_assumption1 ((temp___expr_308 us_rep2) (temp___skip_top_level_309 Bool)) Bool (=> (not (= temp___skip_top_level_309 true)) (= (length3 temp___expr_308) 0)))
...
(define-fun dynamic_invariant10 ((temp___expr_301 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 0 100)) (in_range11 temp___expr_301)))
(assert (forall ((container us_rep2)) (! (let ((result (length3 container))) (and (<= (+ 0 result) 100) (dynamic_invariant8 result true false true))) :pattern ((length3 container)))))
...
(define-fun dynamic_invariant11 ((temp___expr_295 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= (- 2147483648) 2147483647)) (in_range12 temp___expr_295)))
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant10 position true true true) (and (<= 1 position) (<= position (last4 container)))) (dynamic_invariant11 (get container position) true false true)) :pattern ((get container position))))))
...
(declare-const temp___471 Int)
(declare-const temp___470 r1)
(declare-const temp___4701 (Array Int integer))
(declare-const o Int)
(declare-const o1 Int)
(declare-const j Int)
(declare-const temp___472 (Array Int integer))
(declare-const temp___4721 t)
(declare-const o2 Int)
(declare-const o3 Int)
(declare-const temp___473 Int)
...
(declare-const temp___481 Int)
(declare-const temp___480 r1)
(declare-const temp___4801 (Array Int integer))
(declare-const temp___479 capacity_range)
(declare-const temp___4791 us_main_type)
(declare-const temp___483 us_rep)
...
(declare-const s__split_fields10 us_split_fields__ref)
...
(declare-const res__split_fields13 us_split_fields2)
...
(declare-const res__split_fields14 us_split_fields__ref1)
...
(declare-const res__split_fields15 us_split_fields2)
...
(assert (and (= (mk___rep (mk___split_fields list__reverse_list__s__assume list__reverse_list__s__assume1)) (empty_stack Tuple0)) (= (is_empty (mk___rep (mk___split_fields list__reverse_list__s__assume list__reverse_list__s__assume1))) true)))
...
(assert (= i3 first4))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (and (and (= temp___471 i3) (and (= s__split_fields2 (mk___split_fields temp___470 temp___4701)) (and (and (and (and (= o i3) (in_range5 i3)) (and (= o1 (get (model__ l) o)) (and (in_range8 o1) (= o1 (get (model__ l) o))))) (= (let ((temp___188 (to__ (mk___rep s__split_fields3)))) (bool_eq (elts temp___188) (to_rep (first (rt temp___188))) (to_rep (last (rt temp___188))) (let ((temp___187 (temp___182 o1))) (let ((temp___186 (to__ (mk___rep s__split_fields2)))) (ite (= (length temp___186) 0) temp___187 (concat1 (elts temp___186) (to_rep (first (rt temp___186))) (to_rep (last (rt temp___186))) temp___187 1 1)))) (to_rep (first (let ((temp___186 (to__ (mk___rep s__split_fields2)))) (ite (= (length temp___186) 0) (mk 1 1) (mk (to_rep (first (rt temp___186))) (- (+ (to_rep (first (rt temp___186))) (+ (ite (<= (to_rep (first (rt temp___186))) (to_rep (last (rt temp___186)))) (+ (- (to_rep (last (rt temp___186))) (to_rep (first (rt temp___186)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (to_rep (last (let ((temp___186 (to__ (mk___rep s__split_fields2)))) (ite (= (length temp___186) 0) (mk 1 1) (mk (to_rep (first (rt temp___186))) (- (+ (to_rep (first (rt temp___186))) (+ (ite (<= (to_rep (first (rt temp___186))) (to_rep (last (rt temp___186)))) (+ (- (to_rep (last (rt temp___186))) (to_rep (first (rt temp___186)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))))) true)) (and (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields4))))) (+ (- i4 first4) 1)) (forall ((j3 Int)) (=> (and (<= first4 j3) (<= j3 i4)) (= (to_rep (select (elts (to__ (mk___rep s__split_fields4))) (+ (- j3 first4) 1))) (get (model__ l) j3))))) (and (and (=> (<= first4 last5) (dynamic_property3 first4 last5 i4)) (and (<= first4 i4) (<= i4 last5))) (= i4 last5)))))) (and (and (= i8 (mk_int__ref i4)) (= s__split_fields8 (mk___split_fields__ref s__split_fields4))) (and (= i9 i4) (= s__split_fields9 s__split_fields4))))))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= i10 i8)))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= s__split_fields10 s__split_fields8)))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= i11 i9)))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= s__split_fields11 s__split_fields9)))
(assert (=> (not (and (<= first4 i3) (<= i3 last5))) (= i10 (mk_int__ref i3))))
(assert (=> (not (and (<= first4 i3) (<= i3 last5))) (= s__split_fields10 (mk___split_fields__ref s__split_fields2))))
(assert (=> (not (and (<= first4 i3) (<= i3 last5))) (= i11 i3)))
(assert (=> (not (and (<= first4 i3) (<= i3 last5))) (= s__split_fields11 s__split_fields2)))
(assert (= result5 (mk_int__ref i1)))
(assert (= i12 first4))
(assert (=> (and (<= first4 i12) (<= i12 last5)) (and (and (= temp___481 i12) (and (= (us_split_fields__content s__split_fields10) (mk___split_fields temp___480 temp___4801)) (and (and (= res__split_discrs (mk___split_discrs temp___479)) (= res__split_fields1 (mk___split_fields1 temp___4791))) (and (= temp___483 (mk___rep (us_split_fields__content s__split_fields10))) (and (and (and (and (= (length2 (mk___rep1 res__split_discrs res__split_fields2)) (- i13 first4)) (= (to_rep (last (rt (to__ (mk___rep s__split_fields12))))) (+ (- last5 i13) 1))) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (+ (- last5 i13) 1))) (= (to_rep (select (elts (to__ (mk___rep s__split_fields12))) j3)) (to_rep (select (elts (to__ temp___483)) j3)))))) (forall ((j3 Int)) (=> (and (<= first4 j3) (<= j3 (- i13 1))) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j3) (get (model__ l) (+ (- last5 j3) first4)))))) (and (and (=> (<= first4 last5) (dynamic_property4 first4 last5 i13)) (and (<= first4 i13) (<= i13 last5))) (and (and (and (and (= o37 (top (mk___rep s__split_fields12))) (and (in_range1 o37) (and (= o37 (to_rep (select (rec__stack__stack__content s__split_fields12) (to_rep1 (rec__stack__stack__top s__split_fields12))))) (= o37 (to_rep (select (elts (to__ (mk___rep s__split_fields12))) (to_rep (last (rt (to__ (mk___rep s__split_fields12))))))))))) (and (and (= (length2 (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (length2 (mk___rep1 res__split_discrs res__split_fields2)) 1)) (= (olt (model__ (mk___rep1 res__split_discrs res__split_fields2)) (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields))) true)) (= (get (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (last4 (model__ (mk___rep1 res__split_discrs res__split_fields2))) 1)) o37))) (and (= result11 (mk___split_fields__ref1 res__split_fields2)) (= res__split_fields3 list__my_lists__append__2__container__fields))) (and (= (let ((temp___195 (to__ (mk___rep s__split_fields13)))) (bool_eq (elts temp___195) (to_rep (first (rt temp___195))) (to_rep (last (rt temp___195))) (elts (to__ (mk___rep s__split_fields12))) (to_rep (first2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields12))))) 1)))) (to_rep (last2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields12))))) 1)))))) true) (= i13 last5))))))))) (and (and (= i19 (mk_int__ref i13)) (and (= res__split_fields8 (mk___split_fields__ref1 res__split_fields3)) (= s__split_fields18 (mk___split_fields__ref s__split_fields13)))) (and (= i20 i13) (and (= res__split_fields9 res__split_fields3) (= s__split_fields19 s__split_fields13)))))))
(assert (=> (and (<= first4 i12) (<= i12 last5)) (= i21 i19)))
(assert (=> (and (<= first4 i12) (<= i12 last5)) (= res__split_fields10 res__split_fields8)))
(assert (=> (and (<= first4 i12) (<= i12 last5)) (= s__split_fields20 s__split_fields18)))
(assert (=> (and (<= first4 i12) (<= i12 last5)) (= i22 i20)))
(assert (=> (and (<= first4 i12) (<= i12 last5)) (= res__split_fields11 res__split_fields9)))
(assert (=> (and (<= first4 i12) (<= i12 last5)) (= s__split_fields21 s__split_fields19)))
(assert (=> (not (and (<= first4 i12) (<= i12 last5))) (= i21 (mk_int__ref i12))))
(assert (=> (not (and (<= first4 i12) (<= i12 last5))) (= res__split_fields10 (mk___split_fields__ref1 res__split_fields1))))
(assert (=> (not (and (<= first4 i12) (<= i12 last5))) (= s__split_fields20 s__split_fields10)))
(assert (=> (not (and (<= first4 i12) (<= i12 last5))) (= i22 i12)))
(assert (=> (not (and (<= first4 i12) (<= i12 last5))) (= res__split_fields11 res__split_fields1)))
(assert (=> (not (and (<= first4 i12) (<= i12 last5))) (= s__split_fields21 s__split_fields11)))
(assert (= result13 (mk_list__ref (mk___rep1 (mk___split_discrs list__reverse_list__result) (mk___split_fields1 list__reverse_list__result1)))))
(assert (= list__reverse_list__result2 (mk___rep1 res__split_discrs (us_split_fields__content1 res__split_fields10))))
(assert (= list__reverse_list__result5 list__reverse_list__result3))
(assert (= i28 i24))
(assert (= i27 i23))
(assert (= res__split_fields14 res__split_fields12))
(assert (= s__split_fields24 s__split_fields22))
(assert (= list__reverse_list__result6 list__reverse_list__result4))
(assert (= i30 i26))
(assert (= i29 i25))
(assert (= res__split_fields15 res__split_fields13))
(assert (= s__split_fields25 s__split_fields23))
(assert (and (= o39 (last4 (model__ l))) (and (in_range7 o39) (= o39 (last4 (model__ l))))))
(assert (= o40 (ite (<= i2 o39) true false)))
(assert (and (= o38 1) (and (in_range5 o38) (= o38 1))))
(assert (= o41 (ite (<= o38 i2) true false)))
(assert (= result14 (ite (= o41 true) o40 false)))
(assert (= result14 true))
(assert (and (= o45 1) (and (in_range5 o45) (= o45 1))))
(assert (and (= o43 (last4 (model__ l))) (and (in_range7 o43) (= o43 (last4 (model__ l))))))
(assert (= o44 (- o43 i2)))
(assert (and (= o46 o44) (in_range1 o44)))
(assert (= o47 (+ o46 o45)))
(assert (and (= o48 o47) (in_range1 o47)))
(assert (and (= o49 o48) (in_range5 o48)))
(assert (and (= o50 (get (model__ (list__content list__reverse_list__result5)) o49)) (and (in_range8 o50) (= o50 (get (model__ (list__content list__reverse_list__result5)) o49)))))
(assert (and (= o42 i2) (in_range5 i2)))
(assert (not (<= 1 o42)))
(check-sat)
(exit)
