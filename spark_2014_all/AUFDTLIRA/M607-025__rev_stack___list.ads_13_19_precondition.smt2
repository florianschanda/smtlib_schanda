...
(declare-const s__split_fields11 us_split_fields__ref)
...
(declare-const s__split_fields13 us_split_fields__ref)
...
(assert (= i3 first4))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= temp___471 i3)))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= s__split_fields2 (mk___split_fields temp___470 temp___4701))))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (and (= o i3) (in_range5 i3))))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (and (= o1 (get (model__ l) o)) (and (in_range8 o1) (= o1 (get (model__ l) o))))))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= (let ((temp___188 (to__ (mk___rep s__split_fields3)))) (bool_eq (elts temp___188) (to_rep (first (rt temp___188))) (to_rep (last (rt temp___188))) (let ((temp___187 (temp___182 o1))) (let ((temp___186 (to__ (mk___rep s__split_fields2)))) (ite (= (length temp___186) 0) temp___187 (concat1 (elts temp___186) (to_rep (first (rt temp___186))) (to_rep (last (rt temp___186))) temp___187 1 1)))) (to_rep (first (let ((temp___186 (to__ (mk___rep s__split_fields2)))) (ite (= (length temp___186) 0) (mk 1 1) (mk (to_rep (first (rt temp___186))) (- (+ (to_rep (first (rt temp___186))) (+ (ite (<= (to_rep (first (rt temp___186))) (to_rep (last (rt temp___186)))) (+ (- (to_rep (last (rt temp___186))) (to_rep (first (rt temp___186)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))) (to_rep (last (let ((temp___186 (to__ (mk___rep s__split_fields2)))) (ite (= (length temp___186) 0) (mk 1 1) (mk (to_rep (first (rt temp___186))) (- (+ (to_rep (first (rt temp___186))) (+ (ite (<= (to_rep (first (rt temp___186))) (to_rep (last (rt temp___186)))) (+ (- (to_rep (last (rt temp___186))) (to_rep (first (rt temp___186)))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))) 1)))))))) true)))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (and (= (to_rep (last (rt (to__ (mk___rep s__split_fields4))))) (+ (- i4 first4) 1)) (forall ((j Int)) (=> (and (<= first4 j) (<= j i4)) (= (to_rep (select (elts (to__ (mk___rep s__split_fields4))) (+ (- j first4) 1))) (get (model__ l) j)))))))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (and (=> (<= first4 last5) (dynamic_property3 first4 last5 i4)) (and (<= first4 i4) (<= i4 last5)))))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= i4 last5)))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= i5 (mk_int__ref i4))))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= s__split_fields5 (mk___split_fields__ref s__split_fields4))))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= i6 i4)))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= s__split_fields6 s__split_fields4)))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= i7 i5)))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= s__split_fields7 s__split_fields5)))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= i8 i6)))
(assert (=> (and (<= first4 i3) (<= i3 last5)) (= s__split_fields8 s__split_fields6)))
(assert (=> (not (and (<= first4 i3) (<= i3 last5))) (= i7 (mk_int__ref i3))))
(assert (=> (not (and (<= first4 i3) (<= i3 last5))) (= s__split_fields7 (mk___split_fields__ref s__split_fields2))))
(assert (=> (not (and (<= first4 i3) (<= i3 last5))) (= i8 i3)))
(assert (=> (not (and (<= first4 i3) (<= i3 last5))) (= s__split_fields8 s__split_fields2)))
(assert (= result3 (mk_int__ref i1)))
(assert (= i9 first4))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= temp___481 i9)))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= (us_split_fields__content s__split_fields7) (mk___split_fields temp___480 temp___4801))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (and (= res__split_discrs (mk___split_discrs temp___479)) (= res__split_fields1 (mk___split_fields1 temp___4791)))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= temp___483 (mk___rep (us_split_fields__content s__split_fields7)))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (and (and (and (= (length2 (mk___rep1 res__split_discrs res__split_fields2)) (- i10 first4)) (= (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) (+ (- last5 i10) 1))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (+ (- last5 i10) 1))) (= (to_rep (select (elts (to__ (mk___rep s__split_fields9))) j)) (to_rep (select (elts (to__ temp___483)) j)))))) (forall ((j Int)) (=> (and (<= first4 j) (<= j (- i10 1))) (= (get (model__ (mk___rep1 res__split_discrs res__split_fields2)) j) (get (model__ l) (+ (- last5 j) first4))))))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (and (=> (<= first4 last5) (dynamic_property4 first4 last5 i10)) (and (<= first4 i10) (<= i10 last5)))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (and (= o2 (top (mk___rep s__split_fields9))) (and (in_range1 o2) (and (= o2 (to_rep (select (rec__stack__stack__content s__split_fields9) (to_rep1 (rec__stack__stack__top s__split_fields9))))) (= o2 (to_rep (select (elts (to__ (mk___rep s__split_fields9))) (to_rep (last (rt (to__ (mk___rep s__split_fields9)))))))))))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (and (and (= (length2 (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (length2 (mk___rep1 res__split_discrs res__split_fields2)) 1)) (= (olt (model__ (mk___rep1 res__split_discrs res__split_fields2)) (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields))) true)) (= (get (model__ (mk___rep1 res__split_discrs list__my_lists__append__2__container__fields)) (+ (last4 (model__ (mk___rep1 res__split_discrs res__split_fields2))) 1)) o2))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= result4 (mk___split_fields__ref1 res__split_fields2))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= res__split_fields3 list__my_lists__append__2__container__fields)))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= (let ((temp___195 (to__ (mk___rep s__split_fields10)))) (bool_eq (elts temp___195) (to_rep (first (rt temp___195))) (to_rep (last (rt temp___195))) (elts (to__ (mk___rep s__split_fields9))) (to_rep (first2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) 1)))) (to_rep (last2 (mk1 1 (- (to_rep (last (rt (to__ (mk___rep s__split_fields9))))) 1)))))) true)))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= i10 last5)))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= i11 (mk_int__ref i10))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= res__split_fields4 (mk___split_fields__ref1 res__split_fields3))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= s__split_fields11 (mk___split_fields__ref s__split_fields10))))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= i12 i10)))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= res__split_fields5 res__split_fields3)))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= s__split_fields12 s__split_fields10)))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= i13 i11)))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= res__split_fields6 res__split_fields4)))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= s__split_fields13 s__split_fields11)))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= i14 i12)))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= res__split_fields7 res__split_fields5)))
(assert (=> (and (<= first4 i9) (<= i9 last5)) (= s__split_fields14 s__split_fields12)))
(assert (=> (not (and (<= first4 i9) (<= i9 last5))) (= i13 (mk_int__ref i9))))
(assert (=> (not (and (<= first4 i9) (<= i9 last5))) (= res__split_fields6 (mk___split_fields__ref1 res__split_fields1))))
(assert (=> (not (and (<= first4 i9) (<= i9 last5))) (= s__split_fields13 s__split_fields7)))
(assert (=> (not (and (<= first4 i9) (<= i9 last5))) (= i14 i9)))
(assert (=> (not (and (<= first4 i9) (<= i9 last5))) (= res__split_fields7 res__split_fields1)))
(assert (=> (not (and (<= first4 i9) (<= i9 last5))) (= s__split_fields14 s__split_fields8)))
(assert (= result5 (mk_list__ref (mk___rep1 (mk___split_discrs list__reverse_list__result) (mk___split_fields1 list__reverse_list__result1)))))
...
(assert (and (= o4 (last4 (model__ l))) (and (in_range7 o4) (= o4 (last4 (model__ l))))))
(assert (= o5 (ite (<= i2 o4) true false)))
(assert (and (= o3 1) (and (in_range5 o3) (= o3 1))))
(assert (= o6 (ite (<= o3 i2) true false)))
(assert (= result6 (ite (= o6 true) o5 false)))
(assert (= result6 true))
(assert (and (= o10 1) (and (in_range5 o10) (= o10 1))))
(assert (and (= o8 (last4 (model__ l))) (and (in_range7 o8) (= o8 (last4 (model__ l))))))
(assert (= o9 (- o8 i2)))
(assert (and (= o11 o9) (in_range1 o9)))
(assert (= o12 (+ o11 o10)))
(assert (and (= o13 o12) (in_range1 o12)))
(assert (and (= o14 o13) (in_range5 o13)))
(assert (and (= o15 (get (model__ (list__content list__reverse_list__result5)) o14)) (and (in_range8 o15) (= o15 (get (model__ (list__content list__reverse_list__result5)) o14)))))
(assert (and (= o7 i2) (in_range5 i2)))
(assert (not (<= 1 o7)))
(check-sat)
(exit)
