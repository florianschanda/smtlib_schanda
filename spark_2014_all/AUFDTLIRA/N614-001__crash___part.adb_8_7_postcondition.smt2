...
(define-fun dynamic_invariant2 ((temp___expr_581 us_t) (temp___is_init_577 Bool) (temp___skip_constant_578 Bool) (temp___do_toplevel_579 Bool) (temp___do_typ_inv_580 Bool)) Bool (=> (not (= temp___skip_constant_578 true)) (dynamic_property 1 2147483647 (first1 temp___expr_581) (last1 temp___expr_581))))
...
(assert (= tmp3 tmp1))
(assert (= x4 x2))
(assert (not (= (to_rep (select x3 a)) (to_rep (select x b)))))
(check-sat)
(exit)
