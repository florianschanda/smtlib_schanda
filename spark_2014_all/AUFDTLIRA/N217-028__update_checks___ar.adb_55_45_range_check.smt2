...
(declare-fun temp___261 (Int Int) (Array Int et1))
(assert (forall ((temp___263 Int) (temp___264 Int)) (let ((temp___262 (temp___261 temp___263 temp___264))) (=> (and (dynamic_invariant1 temp___263 true true true true) (dynamic_invariant1 temp___264 true true true true)) (forall ((temp___265 Int)) (ite (and (<= 5 temp___265) (<= temp___265 10)) (= (to_rep (select temp___262 temp___265)) temp___264) (=> (and (<= 1 temp___265) (<= temp___265 4)) (= (to_rep (select temp___262 temp___265)) temp___263))))))))
(assert (in_range1 i))
(assert (in_range2 e))
