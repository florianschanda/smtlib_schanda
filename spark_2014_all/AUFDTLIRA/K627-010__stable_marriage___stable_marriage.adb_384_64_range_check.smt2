...
(assert (forall ((prev1 Int)) (=> (and (<= 1 prev1) (<= prev1 (- g12 1))) (= (to_rep (select (rec__stable_marriage__matching__group1_set__elements unmatched_g1_set__split_fields3) prev1)) prev1))))
