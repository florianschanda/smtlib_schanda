...
(declare-const temp___575 (Array Int (Array Int ranking)))
...
(assert (= g22 1))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= temp___575 result__1)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= temp___574 g22)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (forall ((prev Int)) (=> (and (<= 1 prev) (<= prev (- g23 1))) (= (bool_eq2 (select result__2 prev) 1 64 (invert_1 (select r2 prev)) 1 64) true)))))
(assert (=> (and (<= 1 g22) (<= g22 64)) (and (and (=> (<= 1 64) (in_range2 g23)) (forall ((temp___576 Int)) (=> (and (<= 1 temp___576) (<= temp___576 64)) (=> (<= g23 temp___576) (= (select result__2 temp___576) (select temp___575 temp___576)))))) (and (<= 1 g23) (<= g23 64)))))
