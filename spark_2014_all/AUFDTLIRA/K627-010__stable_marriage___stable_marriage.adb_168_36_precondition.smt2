...
(assert (= g22 1))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= temp___533 result__1)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= temp___532 g22)))
...
(assert (=> (and (<= 1 g22) (<= g22 64)) (and (and (=> (<= 1 64) (in_range2 g23)) (forall ((temp___534 Int)) (=> (and (<= 1 temp___534) (<= temp___534 64)) (=> (<= g23 temp___534) (= (select result__2 temp___534) (select temp___533 temp___534)))))) (and (<= 1 g23) (<= g23 64)))))
