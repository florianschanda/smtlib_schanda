...
(assert (= g22 1))
(assert (=> (and (<= 1 g22) (<= g22 64)) (and (and (= temp___533 result__1) (and (= temp___532 g22) (and (forall ((prev1 Int)) (=> (and (<= 1 prev1) (<= prev1 (- g23 1))) (= (bool_eq2 (select result__2 prev1) 1 64 (invert_1 (select r2 prev1)) 1 64) true))) (and (and (and (=> (<= 1 64) (in_range2 g23)) (forall ((temp___534 Int)) (=> (and (<= 1 temp___534) (<= temp___534 64)) (=> (<= g23 temp___534) (= (select result__2 temp___534) (select temp___533 temp___534)))))) (and (<= 1 g23) (<= g23 64))) (and (and (and (and (= o2 (invert_1 (select r2 g23))) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep1 (select o2 (to_rep (select (select r2 g23) rank)))) rank))) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (to_rep (select (select r2 g23) (to_rep1 (select o2 g1)))) g1))))) (= o3 (store result__2 g23 o2))) (and (= result__2 result2) (= result__3 o3))) (= g23 64)))))) (and (and (= g23 g27) (= result__3 result__6)) (and (= g28 g23) (= result__7 result__3))))))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= (mk_int__ref g29) (mk_int__ref g27))))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= (mk_map__ref3 result__8) (mk_map__ref3 result__6))))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= g210 g28)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= result__9 result__7)))
(assert (=> (not (and (<= 1 g22) (<= g22 64))) (= g22 g29)))
(assert (=> (not (and (<= 1 g22) (<= g22 64))) (= result__1 result__8)))
(assert (=> (not (and (<= 1 g22) (<= g22 64))) (= g210 g22)))
(assert (=> (not (and (<= 1 g22) (<= g22 64))) (= result__9 result__1)))
...
(assert (= (mk_map__ref3 result4) (mk_map__ref3 stable_marriage__matching__invert__result)))
(assert (= stable_marriage__matching__invert__result1 result__8))
(assert (= (mk_map__ref3 stable_marriage__matching__invert__result4) (mk_map__ref3 stable_marriage__matching__invert__result2)))
(assert (= (mk_int__ref g211) (mk_int__ref g29)))
(assert (= (mk_map__ref3 result__10) (mk_map__ref3 result__8)))
