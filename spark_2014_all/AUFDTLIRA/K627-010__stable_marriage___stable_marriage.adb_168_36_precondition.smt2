...
(declare-const temp___577 (Array Int (Array Int ranking)))
...
(define-fun g210 () int__ref (mk_int__ref g26))
(define-fun result__10 () map__ref3 (mk_map__ref3 result__6))
(assert (forall ((g211 Int)) (=> (and (<= 1 g211) (<= g211 64)) (= (is_permutation_1 (select r2 g211)) true))))
...
(assert (= g22 1))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= temp___577 result__1)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= temp___576 g22)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (forall ((prev Int)) (=> (and (<= 1 prev) (<= prev (- g23 1))) (= (bool_eq1 (select result__2 prev) 1 64 (invert_1 (select r2 prev)) 1 64) true)))))
(assert (=> (and (<= 1 g22) (<= g22 64)) (and (and (=> (<= 1 64) (in_range3 g23)) (forall ((temp___578 Int)) (=> (and (<= 1 temp___578) (<= temp___578 64)) (=> (or (< 64 temp___578) (or (< temp___578 1) (<= g23 temp___578))) (= (select result__2 temp___578) (select temp___577 temp___578)))))) (and (<= 1 g23) (<= g23 64)))))
(assert (=> (and (<= 1 g22) (<= g22 64)) (and (= o (invert_1 (select r2 g23))) (and (forall ((rank Int)) (=> (and (<= 1 rank) (<= rank 64)) (= (to_rep1 (select o (to_rep (select (select r2 g23) rank)))) rank))) (forall ((g1 Int)) (=> (and (<= 1 g1) (<= g1 64)) (= (to_rep (select (select r2 g23) (to_rep1 (select o g1)))) g1)))))))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= o1 (store result__2 g23 o))))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= result__2 result2)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= result__3 o1)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= g23 64)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= g23 g24)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= result__3 result__4)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= g25 g23)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= result__5 result__3)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= g210 (mk_int__ref g24))))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= result__10 (mk_map__ref3 result__4))))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= g27 g25)))
(assert (=> (and (<= 1 g22) (<= g22 64)) (= result__7 result__5)))
(assert (=> (not (and (<= 1 g22) (<= g22 64))) (= g22 g26)))
(assert (=> (not (and (<= 1 g22) (<= g22 64))) (= result__1 result__6)))
(assert (=> (not (and (<= 1 g22) (<= g22 64))) (= g27 g22)))
(assert (=> (not (and (<= 1 g22) (<= g22 64))) (= result__7 result__1)))
(assert (= stable_marriage__matching__invert__result1 stable_marriage__matching__invert__result2))
(assert (= stable_marriage__matching__invert__result3 stable_marriage__matching__invert__result1))
(assert (= (mk_map__ref3 result3) (mk_map__ref3 stable_marriage__matching__invert__result)))
(assert (= stable_marriage__matching__invert__result1 result__6))
(assert (= (mk_map__ref3 stable_marriage__matching__invert__result4) (mk_map__ref3 stable_marriage__matching__invert__result2)))
(assert (= (mk_int__ref g28) g210))
(assert (= (mk_map__ref3 result__8) result__10))
(assert (= stable_marriage__matching__invert__result5 stable_marriage__matching__invert__result3))
(assert (= g29 g27))
(assert (= result__9 result__7))
(assert (<= 1 g21))
(assert (<= g21 64))
(assert (not (= (is_permutation_1 (select r2 g21)) true)))
(check-sat)
(exit)
