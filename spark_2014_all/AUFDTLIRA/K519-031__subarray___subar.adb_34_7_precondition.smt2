...
(declare-sort teP1 0)
(declare-fun teP1qtint (teP1) Int)
(assert (forall ((i teP1)) (and (<= 1 (teP1qtint i)) (<= (teP1qtint i) 10))))
...
(define-fun dynamic_invariant1 ((temp___expr_168 Int) (temp___is_init_164 Bool) (temp___skip_constant_165 Bool) (temp___do_toplevel_166 Bool) (temp___do_typ_inv_167 Bool)) Bool (=> (or (= temp___is_init_164 true) (<= 1 10)) (in_range temp___expr_168)))
...
(declare-const rliteral one_ten)
(assert (= (one_tenqtint rliteral) 1))
(declare-const ae (Array Int one_ten))
(declare-const result (Array Int one_ten))
(declare-const ae1 (Array Int one_ten))
(assert (= result ae))
(assert (= ae1 (store ae 1 rliteral)))
(assert (not (= (to_rep (select ae1 (to_rep1 (first (mk 1 10))))) 1)))
(check-sat)
(exit)
