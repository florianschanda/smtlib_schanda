...
(assert (and (and (and (and (and (= o (- current_idx first_idx)) (in_range1 (- current_idx first_idx))) (and (= lexer__read_token__new_token__2__t_length__assume o) (in_range2 o))) (= lexer__read_token__new_token__2__t_length__assume t_length)) (and (in_range2 t_length) (and (=> (<= 0 2147483647) (in_range5 n)) (and (and (= (invariant__ name_table1) true) (in_range5 n1)) (ite (= kind 3) (and (and (= (to_rep4 t__split_discrs) r31b) (in_range6 r31b)) (and (and (and (and (and (= (to_rep3 o2) n1) (and (= (to_rep o3) t_length) (and (= (to_rep o4) first_col) (and (= (to_rep o5) first_line) (and (= o5 o6) (and (= o4 o7) (and (= o3 o8) (= o2 o9)))))))) (and (and (= (to_rep4 o1) 3) (= o1 o10)) (and (= temp___976 o10) (and (and (= temp___9761 o6) (and (= temp___9762 o7) (and (= temp___9763 o8) (= temp___9764 o9)))) (= true temp___9765))))) (and (=> (= t__attr__constrained true) (= temp___976 t__split_discrs)) (= (mk___rep (mk___split_discrs usq_) (mk___split_fields usq_1 usq_2 usq_3 usq_4) usq_5) (mk___rep (mk___split_discrs temp___976) (mk___split_fields temp___9761 temp___9762 temp___9763 temp___9764) temp___9765)))) (and (= usq_ temp___978) (and (and (= usq_1 temp___9781) (and (= usq_2 temp___9782) (and (= usq_3 temp___9783) (= usq_4 temp___9784)))) (= t__attr__constrained temp___9785)))) (and (and (= result (mk___split_fields__ref (mk___split_fields t__split_fields t__split_fields1 t__split_fields2 t__split_fields3))) (= t__split_fields4 (mk___split_fields temp___9781 temp___9782 temp___9783 temp___9784))) (and (= result1 (mk___split_discrs__ref (mk___split_discrs t__split_discrs))) (= t__split_discrs1 (mk___split_discrs temp___978)))))) (and (ite (= kind 4) (and (and (= (to_rep4 t__split_discrs) r34b) (in_range6 r34b)) (and (and (and (and (and (= (to_rep3 o12) n1) (and (= (to_rep o13) t_length) (and (= (to_rep o14) first_col) (and (= (to_rep o15) first_line) (= o16 (mk___split_fields o15 o14 o13 o12)))))) (and (and (= (to_rep4 o11) 4) (= o17 (mk___split_discrs o11))) (= temp___979 (mk___rep o17 o16 true)))) (and (=> (= t__attr__constrained true) (= (rec__lexer__token__kind (us_split_discrs1 temp___979)) t__split_discrs)) (= usq_6 temp___979))) (= temp___981 (mk___rep (us_split_discrs1 usq_6) (us_split_fields1 usq_6) t__attr__constrained))) (and (and (= result2 (mk___split_fields__ref (mk___split_fields t__split_fields t__split_fields1 t__split_fields2 t__split_fields3))) (= t__split_fields5 (us_split_fields1 temp___981))) (and (= result3 (mk___split_discrs__ref (mk___split_discrs t__split_discrs))) (= t__split_discrs2 (us_split_discrs1 temp___981)))))) (and (ite (= kind 5) (and (and (= (to_rep4 t__split_discrs) r37b) (in_range6 r37b)) (and (and (and (and (and (= (to_rep3 o19) n1) (and (= (to_rep o20) t_length) (and (= (to_rep o21) first_col) (and (= (to_rep o22) first_line) (= o23 (mk___split_fields o22 o21 o20 o19)))))) (and (and (= (to_rep4 o18) 5) (= o24 (mk___split_discrs o18))) (= temp___982 (mk___rep o24 o23 true)))) (and (=> (= t__attr__constrained true) (= (rec__lexer__token__kind (us_split_discrs1 temp___982)) t__split_discrs)) (= usq_7 temp___982))) (= temp___984 (mk___rep (us_split_discrs1 usq_7) (us_split_fields1 usq_7) t__attr__constrained))) (and (and (= result4 (mk___split_fields__ref (mk___split_fields t__split_fields t__split_fields1 t__split_fields2 t__split_fields3))) (= t__split_fields6 (us_split_fields1 temp___984))) (and (= result5 (mk___split_discrs__ref (mk___split_discrs t__split_discrs))) (= t__split_discrs3 (us_split_discrs1 temp___984)))))) (and (ite (= kind 6) (and (and (= (to_rep4 t__split_discrs) r40b) (in_range6 r40b)) (and (and (and (and (and (= (to_rep3 o26) n1) (and (= (to_rep o27) t_length) (and (= (to_rep o28) first_col) (and (= (to_rep o29) first_line) (= o30 (mk___split_fields o29 o28 o27 o26)))))) (and (and (= (to_rep4 o25) 6) (= o31 (mk___split_discrs o25))) (= temp___985 (mk___rep o31 o30 true)))) (and (=> (= t__attr__constrained true) (= (rec__lexer__token__kind (us_split_discrs1 temp___985)) t__split_discrs)) (= usq_8 temp___985))) (= temp___987 (mk___rep (us_split_discrs1 usq_8) (us_split_fields1 usq_8) t__attr__constrained))) (and (and (= result6 (mk___split_fields__ref (mk___split_fields t__split_fields t__split_fields1 t__split_fields2 t__split_fields3))) (= t__split_fields7 (us_split_fields1 temp___987))) (and (= result7 (mk___split_discrs__ref (mk___split_discrs t__split_discrs))) (= t__split_discrs4 (us_split_discrs1 temp___987)))))) (and (ite (= kind 7) (and (and (= (to_rep4 t__split_discrs) r43b) (in_range6 r43b)) (and (and (and (and (and (= (to_rep3 o33) n1) (and (= (to_rep o34) t_length) (and (= (to_rep o35) first_col) (and (= (to_rep o36) first_line) (= o37 (mk___split_fields o36 o35 o34 o33)))))) (and (and (= (to_rep4 o32) 7) (= o38 (mk___split_discrs o32))) (= temp___988 (mk___rep o38 o37 true)))) (and (=> (= t__attr__constrained true) (= (rec__lexer__token__kind (us_split_discrs1 temp___988)) t__split_discrs)) (= usq_9 temp___988))) (= temp___990 (mk___rep (us_split_discrs1 usq_9) (us_split_fields1 usq_9) t__attr__constrained))) (and (and (= result8 (mk___split_fields__ref (mk___split_fields t__split_fields t__split_fields1 t__split_fields2 t__split_fields3))) (= t__split_fields8 (us_split_fields1 temp___990))) (and (= result9 (mk___split_discrs__ref (mk___split_discrs t__split_discrs))) (= t__split_discrs5 (us_split_discrs1 temp___990)))))) (and (and (and (= (to_rep4 t__split_discrs) r46b) (in_range6 r46b)) (and (and (and (and (and (= (to_rep3 o40) n1) (and (= (to_rep o41) t_length) (and (= (to_rep o42) first_col) (and (= (to_rep o43) first_line) (= o44 (mk___split_fields o43 o42 o41 o40)))))) (and (and (= (to_rep4 o39) 8) (= o45 (mk___split_discrs o39))) (= temp___991 (mk___rep o45 o44 true)))) (and (=> (= t__attr__constrained true) (= (rec__lexer__token__kind (us_split_discrs1 temp___991)) t__split_discrs)) (= usq_10 temp___991))) (= temp___993 (mk___rep (us_split_discrs1 usq_10) (us_split_fields1 usq_10) t__attr__constrained))) (and (and (= result10 (mk___split_fields__ref (mk___split_fields t__split_fields t__split_fields1 t__split_fields2 t__split_fields3))) (= t__split_fields9 (us_split_fields1 temp___993))) (and (= result11 (mk___split_discrs__ref (mk___split_discrs t__split_discrs))) (= t__split_discrs6 (us_split_discrs1 temp___993)))))) (and (= t__split_discrs5 t__split_discrs6) (= t__split_fields8 t__split_fields9)))) (and (= t__split_discrs4 t__split_discrs5) (= t__split_fields7 t__split_fields8)))) (and (= t__split_discrs3 t__split_discrs4) (= t__split_fields6 t__split_fields7)))) (and (= t__split_discrs2 t__split_discrs3) (= t__split_fields5 t__split_fields6)))) (and (= t__split_discrs1 t__split_discrs2) (= t__split_fields4 t__split_fields5)))))))) (and (and (= name_table2 (mk___private__ref name_table1)) (and (= n2 (mk_int__ref n1)) (and (= t__split_discrs7 (mk___split_discrs__ref t__split_discrs1)) (= t__split_fields10 (mk___split_fields__ref t__split_fields4))))) (and (= name_table3 name_table1) (and (= n3 n1) (and (= t__split_discrs8 t__split_discrs1) (= t__split_fields11 t__split_fields4)))))))
(assert (not (= (invariant__ (us_private__content name_table2)) true)))
(check-sat)
(exit)
