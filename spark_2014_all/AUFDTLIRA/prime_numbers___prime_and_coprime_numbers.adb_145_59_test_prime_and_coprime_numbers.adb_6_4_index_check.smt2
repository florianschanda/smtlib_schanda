...
(assert (=> (or (= mode 0) (= mode 2)) (or (and (and (and (= right_is_out1 right_is_out6) (= right2 right5)) (and (= right_is_out7 right_is_out1) (= right6 right2))) (and (ite (= right_is_out1 true) (= result5 true) (and (and (and (<= 0 right2) (<= right2 100000)) (= o3 right2)) (= result5 (select number_list o3)))) (= result5 true))) (and (and (ite (= right_is_out1 true) (= result5 true) (and (and (and (<= 0 right2) (<= right2 100000)) (= o3 right2)) (= result5 (select number_list o3)))) (not (= result5 true))) (and (and (and (= right_is_out17 (mk_bool__ref right_is_out4)) (= right4 right5)) (and (= right_is_out7 right_is_out5) (= right6 right4))) (and (and (and (<= (+ value 1) right3) (<= right3 100000)) (forall ((v1 Int)) (=> (and (<= value v1) (<= v1 right3)) (not (= (select number_list v1) true))))) (and (=> (<= (- 2147483648) 2147483647) (in_range1 right3)) (and (and (and (and (= o4 right3) (not (= right3 2147483647))) (= o5 (+ o4 1))) (and (= right3 result6) (= right4 o5))) (and (and (= right_is_out3 right_is_out4) (= right_is_out5 right_is_out3)) (and (and (= right_is_out2 result7) (= right_is_out3 (ite (< 100000 right4) true false))) (and (ite (= right_is_out3 true) (= result8 true) (and (and (and (<= 0 right4) (<= right4 100000)) (= o6 right4)) (= result8 (select number_list o6)))) (= result8 true))))))))))))
...
(assert (forall ((v1 Int)) (=> (and (<= left3 v1) (<= v1 value)) (not (= (select number_list v1) true)))))
