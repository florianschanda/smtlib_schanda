...
(assert (<= 1 g21))
(assert (<= g21 64))
(assert (forall ((prev1 Int)) (=> (and (<= 1 prev1) (<= prev1 (- g22 1))) (= (bool_eq2 (select result__2 prev1) 1 64 (invert_1 (select r2 prev1)) 1 64) true))))
(assert (and (and (=> (<= 1 64) (in_range2 g22)) (forall ((temp___534 Int)) (=> (and (<= 1 temp___534) (<= temp___534 64)) (=> (<= g22 temp___534) (= (select result__2 temp___534) (select result__1 temp___534)))))) (and (<= 1 g22) (<= g22 64))))
(assert (<= 1 prev))
(assert (<= prev (- g22 1)))
(assert (not (<= 1 prev)))
(check-sat)
