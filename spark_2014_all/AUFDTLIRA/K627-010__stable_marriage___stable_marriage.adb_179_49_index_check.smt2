...
(declare-datatypes () ((map__ref1 (mk_map__ref1 (map__content1 (Array Int (Array Int group1_id)))))))
(declare-fun slide1 ((Array Int (Array Int group1_id)) Int Int) (Array Int (Array Int group1_id)))
(assert (forall ((a (Array Int (Array Int group1_id)))) (forall ((first Int)) (! (= (slide1 a first first) a) :pattern ((slide1 a first first))))))
(assert (forall ((a (Array Int (Array Int group1_id)))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide1 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide1 a old_first new_first) i))))))))
(declare-fun concat2 ((Array Int (Array Int group1_id)) Int Int (Array Int (Array Int group1_id)) Int Int) (Array Int (Array Int group1_id)))
...
(declare-fun singleton2 ((Array Int group1_id) Int) (Array Int (Array Int group1_id)))
(assert (forall ((v (Array Int group1_id))) (forall ((i Int)) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
...
(assert (forall ((a (Array Int (Array Int group1_id))) (b (Array Int (Array Int group1_id)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_135 Int)) (=> (and (<= a__first temp___idx_135) (<= temp___idx_135 a__last)) (= (bool_eq (select a temp___idx_135) 1 64 (select b (+ (- b__first a__first) temp___idx_135)) 1 64) true))))))))
...
(assert (forall ((x ranking)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-fun concat3 ((Array Int ranking) Int Int (Array Int ranking) Int Int) (Array Int ranking))
...
(assert (forall ((a (Array Int ranking)) (b (Array Int ranking))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq2 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int ranking)) (b (Array Int ranking))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep1 (select a (+ i 1))) (to_rep1 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int ranking)) (b (Array Int ranking))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep1 (select b (+ i 1))) (to_rep1 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(declare-fun concat4 ((Array Int (Array Int ranking)) Int Int (Array Int (Array Int ranking)) Int Int) (Array Int (Array Int ranking)))
...
(declare-fun singleton4 ((Array Int ranking) Int) (Array Int (Array Int ranking)))
(assert (forall ((v (Array Int ranking))) (forall ((i Int)) (! (= (select (singleton4 v i) i) v) :pattern ((select (singleton4 v i) i))))))
(define-fun bool_eq3 ((a (Array Int (Array Int ranking))) (a__first Int) (a__last Int) (b (Array Int (Array Int ranking))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_138 Int)) (=> (and (<= a__first temp___idx_138) (<= temp___idx_138 a__last)) (= (bool_eq2 (select a temp___idx_138) 1 64 (select b (+ (- b__first a__first) temp___idx_138)) 1 64) true)))) true false))
(assert (forall ((a (Array Int (Array Int ranking))) (b (Array Int (Array Int ranking)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_138 Int)) (=> (and (<= a__first temp___idx_138) (<= temp___idx_138 a__last)) (= (bool_eq2 (select a temp___idx_138) 1 64 (select b (+ (- b__first a__first) temp___idx_138)) 1 64) true))))))))
...
(assert (forall ((temp___526 (Array Int ranking))) (forall ((temp___527 Int)) (= (select (temp___524 temp___526) temp___527) temp___526))))
(declare-fun temp___528 (Int) (Array Int ranking))
(assert (forall ((temp___530 Int)) (forall ((temp___531 Int)) (= (select (temp___528 temp___530) temp___531) (of_rep1 temp___530)))))
...
(declare-const temp___536 (Array Int ranking))
(declare-const o2 (Array Int ranking))
(declare-const o3 (Array Int (Array Int ranking)))
(declare-const g21 Int)
(declare-const temp___544 (Array Int ranking))
...
(declare-const result__10 (Array Int (Array Int ranking)))
(declare-const g211 Int)
(declare-const stable_marriage__matching__invert__result4 (Array Int (Array Int ranking)))
(declare-const result__11 (Array Int (Array Int ranking)))
(declare-const g212 Int)
(declare-const stable_marriage__matching__invert__result5 (Array Int (Array Int ranking)))
(assert (forall ((g213 Int)) (=> (and (<= 1 g213) (<= g213 64)) (= (is_permutation_1 (select r2 g213)) true))))
...
(assert (<= 1 g22))
(assert (<= g22 64))
(assert (forall ((prev1 Int)) (=> (and (<= 1 prev1) (<= prev1 (- g23 1))) (= (bool_eq2 (select result__2 prev1) 1 64 (invert_1 (select r2 prev1)) 1 64) true))))
(assert (and (and (=> (<= 1 64) (in_range2 g23)) (forall ((temp___534 Int)) (=> (and (<= 1 temp___534) (<= temp___534 64)) (=> (<= g23 temp___534) (= (select result__2 temp___534) (select result__1 temp___534)))))) (and (<= 1 g23) (<= g23 64))))
(assert (<= 1 prev))
(assert (<= prev (- g23 1)))
(assert (not (<= 1 prev)))
(check-sat)
