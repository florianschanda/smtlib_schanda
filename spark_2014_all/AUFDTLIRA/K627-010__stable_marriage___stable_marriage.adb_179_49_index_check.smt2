...
(declare-fun temp___566 ((Array Int ranking)) (Array Int (Array Int ranking)))
(declare-fun temp___570 (Int) (Array Int ranking))
(assert (forall ((temp___568 (Array Int ranking))) (forall ((temp___569 Int)) (= (select (temp___566 temp___568) temp___569) temp___568))))
(define-fun dynamic_invariant ((temp___expr_180 Int) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (or (= temp___is_init_176 true) (<= 1 64)) (in_range3 temp___expr_180)))
(assert (forall ((temp___572 Int)) (=> (dynamic_invariant temp___572 true true true true) (forall ((temp___573 Int)) (= (to_rep1 (select (temp___570 temp___572) temp___573)) temp___572)))))
...
(define-fun dynamic_invariant2 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 1 64)) (in_range2 temp___expr_173)))
...
(assert (= result__1 (temp___566 (temp___570 64))))
...
(assert (and (and (=> (<= 1 64) (in_range2 g22)) (forall ((temp___576 Int)) (=> (and (<= 1 temp___576) (<= temp___576 64)) (=> (<= g22 temp___576) (= (select result__2 temp___576) (select result__1 temp___576)))))) (and (<= 1 g22) (<= g22 64))))
(assert (<= 1 prev))
(assert (<= prev (- g22 1)))
(assert (not (<= 1 prev)))
(check-sat)
