...
(assert (= k10 k8))
(assert (= a8 a6))
(assert (and (= o28 (frame_right (mk___t a (mk (to_rep1 a__first) (to_rep1 a__last))) (map__content a7))) (= (= o28 true) (forall ((i1 Int)) (=> (and (<= (to_rep1 a__first) i1) (<= i1 (to_rep1 a__last))) (and (= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) i1)))) (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select a i1))))) (= (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select (map__content a7) i1)))) (to_rep (rec__frame_condition__cell__max_left (us_split_fields1 (select a i1)))))))))))
(assert (= (= o27 true) (forall ((i1 Int)) (=> (and (<= last3 i1) (<= i1 first3)) (forall ((j1 Int)) (=> (and (<= i1 j1) (<= j1 first3)) (<= (to_rep (rec__frame_condition__cell__value (us_split_fields1 (select (map__content a7) j1)))) (get_max_right i1 (map__content a7)))))))))
(assert (<= first3 i))
(assert (<= i last3))
(assert (<= i j))
(assert (<= j last3))
(assert (not (in_range2 j)))
(check-sat)
(exit)
