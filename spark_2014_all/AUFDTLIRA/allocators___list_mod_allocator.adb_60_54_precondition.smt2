...
(assert (and (= o18 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o18) (<= (+ 0 o18) 2147483647))))
(assert (= result4 (ite (<= o18 10000) true false)))
(assert (=> (= result4 true) (=> (not (= first_available 0)) (and (= o16 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o16) (<= (+ 0 o16) 2147483647))))))
(assert (=> (= result4 true) (=> (not (= first_available 0)) (= result5 (ite (< 0 o16) true false)))))
(assert (=> (= result4 true) (=> (not (= first_available 0)) (=> (= result5 true) (and (= o15 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) 1)) (in_range3 o15))))))
(assert (=> (= result4 true) (=> (not (= first_available 0)) (=> (= result5 true) (= result3 (ite (= o15 first_available) true false))))))
(assert (=> (= result4 true) (=> (not (= first_available 0)) (=> (not (= result5 true)) (= result3 false)))))
(assert (=> (= result4 true) (=> (not (not (= first_available 0))) (and (= o17 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o17) (<= (+ 0 o17) 2147483647))))))
(assert (=> (= result4 true) (=> (not (not (= first_available 0))) (= result3 (ite (= o17 0) true false)))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (=> (= result3 true) (and (= o13 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o13) (<= (+ 0 o13) 2147483647)))))
(assert (=> (= result3 true) (= o14 (ite (<= j2 o13) true false))))
(assert (=> (= result3 true) (= result6 (ite (<= 1 j2) o14 false))))
(assert (=> (= result3 true) (= (= result2 true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m))))) (and (in_range7 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) j3)) (=> (< j3 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields3 (select data (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) j3))))) (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) (+ j3 1))))))))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o11 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o11) (<= (+ 0 o11) 2147483647)))))
(assert (=> (= result2 true) (= o12 (ite (<= j1 o11) true false))))
(assert (=> (= result2 true) (= result7 (ite (<= 1 j1) o12 false))))
(assert (=> (= result2 true) (= (= result1 true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m))))) (=> (< 1 j3) (and (in_range7 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) (- j3 1))) (= (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) j3) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields3 (select data (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) (- j3 1))))))))))))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o9 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o9) (<= (+ 0 o9) 2147483647)))))
(assert (=> (= result1 true) (= o10 (ite (<= j o9) true false))))
(assert (=> (= result1 true) (= result8 (ite (<= 1 j) o10 false))))
(assert (=> (= result1 true) (= (= result true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m))))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m))))) (=> (= (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) j3) (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) k)) (= j3 k)))))))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (=> (not (= first_available 0)) (and (= o (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o) (<= (+ 0 o) 2147483647)))))
(assert (=> (not (= first_available 0)) (and (= temp___318 (get (rec__list_mod_allocator__m__t__available (us_split_fields1 m)) o)) (in_range3 temp___318))))
(assert (=> (not (= first_available 0)) (and (<= 1 temp___318) (<= temp___318 10000))))
(assert (=> (not (= first_available 0)) (= o1 temp___318)))
(assert (=> (not (= first_available 0)) (= (mk___rep1 (mk___split_fields1 o2 o3)) (select data o1))))
(assert (=> (not (= first_available 0)) (= o2 o4)))
(assert (=> (not (= first_available 0)) (= o3 o5)))
(assert (=> (not (= first_available 0)) (= o6 o5)))
(assert (=> (not (= first_available 0)) (= o7 (to_rep o6))))
(assert (=> (not (= first_available 0)) (= result9 (ite (in_range7 o7) true false))))
(assert (=> (not (not (= first_available 0))) (= result9 false)))
(assert (= result9 true))
(assert (and (= o8 (length (rec__list_mod_allocator__m__t__available (us_split_fields1 m)))) (and (in_range2 o8) (<= (+ 0 o8) 2147483647))))
(assert (not (<= o8 (last (rec__list_mod_allocator__m__t__available (us_split_fields1 m))))))
(check-sat)
(exit)
