...
(assert (and (= o43 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o43) (<= (+ 0 o43) 2147483647))))
(assert (= result5 (ite (<= o43 10000) true false)))
(assert (=> (= result5 true) (=> (not (= first_available 0)) (and (= o41 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o41) (<= (+ 0 o41) 2147483647))))))
(assert (=> (= result5 true) (=> (not (= first_available 0)) (= result6 (ite (< 0 o41) true false)))))
(assert (=> (= result5 true) (=> (not (= first_available 0)) (=> (= result6 true) (and (= o40 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) 1)) (in_range6 o40))))))
(assert (=> (= result5 true) (=> (not (= first_available 0)) (=> (= result6 true) (= result4 (ite (= o40 first_available) true false))))))
(assert (=> (= result5 true) (=> (not (= first_available 0)) (=> (not (= result6 true)) (= result4 false)))))
(assert (=> (= result5 true) (=> (= first_available 0) (and (= o42 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o42) (<= (+ 0 o42) 2147483647))))))
(assert (=> (= result5 true) (=> (= first_available 0) (= result4 (ite (= o42 0) true false)))))
(assert (=> (not (= result5 true)) (= result4 false)))
(assert (=> (= result4 true) (and (= o34 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o34) (<= (+ 0 o34) 2147483647)))))
(assert (=> (= result4 true) (= o35 (ite (<= j2 o34) true false))))
(assert (=> (= result4 true) (= result7 (ite (<= 1 j2) o35 false))))
(assert (=> (= result4 true) (= (= result3 true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))) (and (in_range3 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) j3)) (=> (< j3 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (= (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) j3))))) (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) (+ j3 1))))))))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (=> (= result3 true) (and (= o23 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o23) (<= (+ 0 o23) 2147483647)))))
(assert (=> (= result3 true) (= o24 (ite (<= j1 o23) true false))))
(assert (=> (= result3 true) (= result10 (ite (<= 1 j1) o24 false))))
(assert (=> (= result3 true) (= (= result2 true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))) (=> (< 1 j3) (and (in_range3 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) (- j3 1))) (= (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) j3) (to_rep (rec__list_mod_allocator__cell__next (us_split_fields1 (select data (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) (- j3 1))))))))))))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o17 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o17) (<= (+ 0 o17) 2147483647)))))
(assert (=> (= result2 true) (= o18 (ite (<= j o17) true false))))
(assert (=> (= result2 true) (= result12 (ite (<= 1 j) o18 false))))
(assert (=> (= result2 true) (= (= result1 true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))) (forall ((k1 Int)) (=> (and (<= 1 k1) (<= k1 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))) (=> (= (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) j3) (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) k1)) (= j3 k1)))))))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (= result1 true))
(assert (=> (not (= first_available 0)) (and (= o1 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o1) (<= (+ 0 o1) 2147483647)))))
(assert (=> (not (= first_available 0)) (and (= temp___281 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) o1)) (in_range6 temp___281))))
(assert (=> (not (= first_available 0)) (and (<= 1 temp___281) (<= temp___281 10000))))
(assert (=> (not (= first_available 0)) (= o2 temp___281)))
(assert (=> (not (= first_available 0)) (= (mk___rep (mk___split_fields o3 o4)) (select data o2))))
(assert (=> (not (= first_available 0)) (= o3 o5)))
(assert (=> (not (= first_available 0)) (= o4 o6)))
(assert (=> (not (= first_available 0)) (= o7 o6)))
(assert (=> (not (= first_available 0)) (= o8 (to_rep o7))))
(assert (=> (not (= first_available 0)) (= result14 (ite (in_range3 o8) true false))))
(assert (=> (= first_available 0) (= result14 false)))
(assert (= result14 true))
(assert (and (= o9 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o9) (<= (+ 0 o9) 2147483647))))
(assert (not (<= 1 o9)))
(check-sat)
(exit)
