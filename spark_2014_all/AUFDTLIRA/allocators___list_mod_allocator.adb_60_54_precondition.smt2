...
(assert (=> (not (= first_available 0)) (and (= temp___281 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) o)) (in_range6 temp___281))))
(assert (=> (not (= first_available 0)) (and (<= 1 temp___281) (<= temp___281 10000))))
(assert (=> (not (= first_available 0)) (= o1 temp___281)))
