...
(assert (and (= o18 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o18) (<= (+ 0 o18) 2147483647))))
(assert (= result4 (ite (<= o18 10000) true false)))
(assert (=> (= result4 true) (=> (not (= first_available 0)) (and (= o16 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o16) (<= (+ 0 o16) 2147483647))))))
(assert (=> (= result4 true) (=> (not (= first_available 0)) (= result5 (ite (< 0 o16) true false)))))
(assert (=> (= result4 true) (=> (not (= first_available 0)) (=> (= result5 true) (and (= o15 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) 1)) (in_range6 o15))))))
...
(assert (=> (= result4 true) (=> (not (not (= first_available 0))) (and (= o17 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o17) (<= (+ 0 o17) 2147483647))))))
(assert (=> (= result4 true) (=> (not (not (= first_available 0))) (= result3 (ite (= o17 0) true false)))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (=> (= result3 true) (and (= o13 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o13) (<= (+ 0 o13) 2147483647)))))
...
(assert (=> (= result2 true) (and (= o11 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o11) (<= (+ 0 o11) 2147483647)))))
...
(assert (=> (= result1 true) (and (= o9 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o9) (<= (+ 0 o9) 2147483647)))))
(assert (=> (= result1 true) (= o10 (ite (<= j o9) true false))))
(assert (=> (= result1 true) (= result8 (ite (<= 1 j) o10 false))))
(assert (=> (= result1 true) (= (= result true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))) (forall ((k Int)) (=> (and (<= 1 k) (<= k (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m))))) (=> (= (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) j3) (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) k)) (= j3 k)))))))))
(assert (=> (not (= result1 true)) (= result false)))
(assert (= result true))
(assert (=> (not (= first_available 0)) (and (= o (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o) (<= (+ 0 o) 2147483647)))))
(assert (=> (not (= first_available 0)) (and (= temp___318 (get (rec__list_mod_allocator__m__t__available (us_split_fields3 m)) o)) (in_range6 temp___318))))
(assert (=> (not (= first_available 0)) (and (<= 1 temp___318) (<= temp___318 10000))))
(assert (=> (not (= first_available 0)) (= o1 temp___318)))
(assert (=> (not (= first_available 0)) (= (mk___rep (mk___split_fields o2 o3)) (select data o1))))
...
(assert (=> (not (= first_available 0)) (= result9 (ite (in_range3 o7) true false))))
(assert (=> (not (not (= first_available 0))) (= result9 false)))
(assert (= result9 true))
(assert (and (= o8 (length (rec__list_mod_allocator__m__t__available (us_split_fields3 m)))) (and (in_range5 o8) (<= (+ 0 o8) 2147483647))))
(assert (not (<= 1 o8)))
(check-sat)
(exit)
