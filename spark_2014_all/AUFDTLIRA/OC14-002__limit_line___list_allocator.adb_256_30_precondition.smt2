...
(assert (and (= o69 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 o69)))
(assert (= result12 (ite (in_range4 o69) true false)))
(assert (=> (= result12 true) (and (= o65 (length (rec__list_allocator__m__t__available model____split_fields3))) (in_range6 o65))))
(assert (=> (= result12 true) (= result13 (ite (< j o65) true false))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o66 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o67 (get (rec__list_allocator__m__t__available model____split_fields3) o66)) (in_range7 o67)))))
(assert (=> (= result12 true) (=> (not (= result13 true)) (= o67 0))))
(assert (=> (= result12 true) (and (= temp___427 (get (rec__list_allocator__m__t__available model____split_fields3) j)) (in_range7 temp___427))))
(assert (=> (= result12 true) (and (<= 1 temp___427) (<= temp___427 3))))
(assert (=> (= result12 true) (= o61 temp___427)))
