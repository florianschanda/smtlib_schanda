...
(declare-datatypes () ((t46s__ref (mk_t46s__ref (t46s__content integer)))))
(define-fun t46s__ref___projection ((a t46s__ref)) integer (t46s__content a))
(declare-sort t3 0)
...
(declare-datatypes () ((t47s__ref (mk_t47s__ref (t47s__content us_t3)))))
(define-fun t47s__ref___projection ((a t47s__ref)) us_t3 (t47s__content a))
...
(assert (forall ((f Int) (l Int)) (! (=> (in_range1 f) (=> (in_range1 l) (and (= (to_rep2 (first8 (mk4 f l))) f) (= (to_rep2 (last9 (mk4 f l))) l)))) :pattern ((mk4 f l)))))
...
(declare-datatypes () ((t144b__ref (mk_t144b__ref (t144b__content us_t4)))))
(define-fun t144b__ref___projection ((a t144b__ref)) us_t4 (t144b__content a))
...
(assert (= last8 (- (+ start (length2 by__)) 1)))
...
(assert (dynamic_invariant2 by__ true false true true))
(assert (in_range5 start))
(assert (not (in_range1 (length2 by__))))
(check-sat)
(exit)
