...
(assert (<= i4 100))
(assert (= (tree_structure (mk___rep2 (us_split_fields__content2 f__split_fields7))) true))
(assert (and (= temp___756 (model__ (mk___rep2 (us_split_fields__content2 f__split_fields7)) root)) (and (dynamic_invariant3 temp___756 true false true) (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___756 root))) true) (and (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___756 root)))) 0) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (not (= i8 root)) (ite (and (not (= (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i8) 0)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___756 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i8)))) true)) (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___756 i8))) true) (not (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___756 i8))) true)))))) (and (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (ite (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___756 i8))) true) (not (= i8 root))) (= (is_add (rec__tree_model__path_type__a (us_split_fields1 (select temp___756 (parent (mk___rep2 (us_split_fields__content2 f__split_fields7)) i8)))) (position (mk___rep2 (us_split_fields__content2 f__split_fields7)) i8) (rec__tree_model__path_type__a (us_split_fields1 (select temp___756 i8)))) true) (= (length (rec__tree_model__path_type__a (us_split_fields1 (select temp___756 i8)))) 0)))) (forall ((i8 Int)) (=> (and (<= 1 i8) (<= i8 100)) (=> (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___756 i8))) true) (forall ((j3 Int)) (=> (and (<= 1 j3) (<= j3 100)) (=> (and (= (rec__tree_model__path_type__k (us_split_fields1 (select temp___756 j3))) true) (= (oeq (rec__tree_model__path_type__a (us_split_fields1 (select temp___756 i8))) (rec__tree_model__path_type__a (us_split_fields1 (select temp___756 j3)))) true)) (= j3 i8))))))))))))))
(assert (= o57 (select temp___756 i4)))
(assert (= o58 (us_split_fields1 o57)))
(assert (= result24 (rec__tree_model__path_type__k o58)))
