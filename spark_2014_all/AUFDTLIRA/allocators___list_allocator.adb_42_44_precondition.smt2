...
(assert (and (= o21 (length model____split_fields)) (and (in_range6 o21) (<= (+ 0 o21) 2147483647))))
(assert (= result3 (ite (<= o21 10000) true false)))
(assert (=> (= result3 true) (and (= o20 (length1 model____split_fields1)) (in_range6 o20))))
(assert (=> (= result3 true) (= result2 (ite (<= o20 10000) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o16 (length1 model____split_fields1)) (in_range6 o16))))
(assert (=> (= result2 true) (and (= o17 (length model____split_fields)) (and (in_range6 o17) (<= (+ 0 o17) 2147483647)))))
(assert (=> (= result2 true) (= o18 (+ o17 o16))))
(assert (=> (= result2 true) (and (= o19 o18) (in_range2 o18))))
(assert (=> (= result2 true) (= result1 (ite (= o19 10000) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (and (= o14 (length model____split_fields)) (and (in_range6 o14) (<= (+ 0 o14) 2147483647))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (= result4 (ite (< 0 o14) true false)))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result4 true) (and (= o13 (get model____split_fields 1)) (in_range7 o13))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (= result4 true) (= result (ite (= o13 first_available) true false))))))
(assert (=> (= result1 true) (=> (not (= first_available 0)) (=> (not (= result4 true)) (= result false)))))
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (and (= o15 (length model____split_fields)) (and (in_range6 o15) (<= (+ 0 o15) 2147483647))))))
(assert (=> (= result1 true) (=> (not (not (= first_available 0))) (= result (ite (= o15 0) true false)))))
...
(assert (= result5 true))
(assert (and (= o12 (get model____split_fields j)) (in_range7 o12)))
(assert (= result7 (ite (in_range4 o12) true false)))
(assert (=> (= result7 true) (and (= o8 (length model____split_fields)) (and (in_range6 o8) (<= (+ 0 o8) 2147483647)))))
(assert (=> (= result7 true) (= result8 (ite (< j o8) true false))))
(assert (=> (= result7 true) (=> (= result8 true) (and (= o9 (+ j 1)) (in_range1 (+ j 1))))))
(assert (=> (= result7 true) (=> (= result8 true) (and (= o10 (get model____split_fields o9)) (in_range7 o10)))))
(assert (=> (= result7 true) (=> (not (= result8 true)) (= o10 0))))
...
(assert (=> (= result7 true) (= o2 temp___313)))
(assert (=> (= result7 true) (= (mk___rep (mk___split_fields o3 o4)) (select data o2))))
(assert (=> (= result7 true) (= o3 o5)))
(assert (=> (= result7 true) (= o4 o6)))
(assert (=> (= result7 true) (= o7 o6)))
(assert (=> (= result7 true) (= o11 (to_rep o7))))
(assert (=> (= result7 true) (= result6 (ite (= o11 o10) true false))))
