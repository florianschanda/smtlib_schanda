...
(assert (and (and (forall ((temp___151 Int)) (=> (and (<= 1 temp___151) (<= temp___151 10)) (=> (< i2 temp___151) (= (select f3 temp___151) (select f temp___151))))) (=> (<= 1 10) (in_range1 i2))) (and (<= 1 i2) (<= i2 10))))
(assert (not (= i2 10)))
(assert (= result3 i2))
(assert (= i3 (+ i2 1)))
(assert (= (to_rep o2) j1))
(assert (= o3 (store f3 i3 o2)))
(assert (= result4 f3))
(assert (= f4 o3))
