...
(assert (= (slide data1 (to_rep1 data__first) 1) temp___1834))
(assert (= (mk3 1 (to_rep1 data__last)) temp___18341))
(assert (=> (<= 1 (to_rep1 data__last)) (and (and (<= 1 1) (<= 1 12)) (and (<= 1 (to_rep1 data__last)) (<= (to_rep1 data__last) 12)))))
(assert (= o result__1))
(assert (= o temp___1837))
(assert (= (mk3 1 (to_rep1 data__last)) temp___18371))
(assert (not (= (ite (<= (to_rep1 (first6 temp___18341)) (to_rep1 (last6 temp___18341))) (+ (- (to_rep1 (last6 temp___18341)) (to_rep1 (first6 temp___18341))) 1) 0) (ite (<= (to_rep1 (first6 temp___18371)) (to_rep1 (last6 temp___18371))) (+ (- (to_rep1 (last6 temp___18371)) (to_rep1 (first6 temp___18371))) 1) 0))))
(check-sat)
(exit)
