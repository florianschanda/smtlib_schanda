...
(declare-const temp___2025 (Array Int character))
(declare-const temp___20251 t3)
(declare-const o (Array Int character))
(declare-const temp___2028 (Array Int character))
(declare-const temp___20281 t3)
...
(assert (= (slide data1 (to_rep1 data__first) 1) temp___2025))
(assert (= (mk3 1 (to_rep1 data__last)) temp___20251))
(assert (=> (<= 1 (to_rep1 data__last)) (and (and (<= 1 1) (<= 1 12)) (and (<= 1 (to_rep1 data__last)) (<= (to_rep1 data__last) 12)))))
(assert (= o result__1))
(assert (= o temp___2028))
(assert (= (mk3 1 (to_rep1 data__last)) temp___20281))
(assert (not (= (ite (<= (to_rep1 (first6 temp___20251)) (to_rep1 (last6 temp___20251))) (+ (- (to_rep1 (last6 temp___20251)) (to_rep1 (first6 temp___20251))) 1) 0) (ite (<= (to_rep1 (first6 temp___20281)) (to_rep1 (last6 temp___20281))) (+ (- (to_rep1 (last6 temp___20281)) (to_rep1 (first6 temp___20281))) 1) 0))))
(check-sat)
(exit)
