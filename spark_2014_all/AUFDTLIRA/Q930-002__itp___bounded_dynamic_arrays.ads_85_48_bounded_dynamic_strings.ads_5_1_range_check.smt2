...
(declare-fun instance (Int us_t2) us_rep)
(declare-fun instance__function_guard (us_rep Int us_t2) Bool)
(assert (forall ((capacity Int)) (forall ((content us_t2)) (! (=> (and (and (dynamic_invariant capacity true true true true) (dynamic_invariant2 content true true true true)) (<= (length3 content) capacity)) (let ((result (instance capacity content))) (and (and (and (= (to_rep2 (rec__bounded_dynamic_strings__sequence__capacity (us_split_discrs1 result))) capacity) (= (length2 result) (length3 content))) (= (let ((temp___278 (value result))) (bool_eq (to_array2 temp___278) (first5 temp___278) (last5 temp___278) (to_array2 content) (first5 content) (last5 content))) true)) (dynamic_invariant1 result true false true true)))) :pattern ((instance capacity content))))))
...
(declare-const bounded_dynamic_strings__Oconcat__result3 t1)
(declare-const temp___1024 (Array Int character))
(declare-const temp___10241 t2)
(declare-const temp___1023 (Array Int character))
(declare-const temp___10231 t2)
(declare-const o Int)
...
(declare-const o11 t1)
(declare-const temp___1029 (Array Int character))
(declare-const temp___10291 t2)
(declare-const temp___1028 (Array Int character))
(declare-const temp___10281 t2)
...
(declare-const bounded_dynamic_strings__Oconcat__result7 t1)
...
(define-fun bounded_dynamic_strings__Oconcat__result12 () us_rep (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__result4) (mk___split_fields bounded_dynamic_strings__Oconcat__result5 (mk___t1 bounded_dynamic_strings__Oconcat__result6 bounded_dynamic_strings__Oconcat__result7))))
(define-fun temp___10282 () us_t2 (mk___t2 temp___1028 temp___10281))
(define-fun temp___10292 () us_t2 (mk___t2 temp___1029 temp___10291))
(define-fun o26 () us_rep (mk___rep (mk___split_discrs o8) (mk___split_fields o9 (mk___t1 o10 o11))))
(define-fun o27 () us_t2 (mk___t2 o6 o7))
(define-fun temp___10232 () us_t2 (mk___t2 temp___1023 temp___10231))
(define-fun temp___10242 () us_t2 (mk___t2 temp___1024 temp___10241))
...
(assert (<= (+ (length2 left) (length2 right)) 2147483647))
...
(assert (and (= temp___10242 (value right)) (and (dynamic_invariant2 temp___10242 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 right))) temp___1024) (= (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))) temp___10241)) (and (and (and (= (length3 temp___10242) (length2 right)) (= (to_rep1 (first4 temp___10241)) 1)) (= (to_rep1 (last4 temp___10241)) (length2 right))) (= (< 0 (length2 right)) (not (= (empty right) true))))))))
(assert (and (= temp___10232 (value left)) (and (dynamic_invariant2 temp___10232 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 left))) temp___1023) (= (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))))))) temp___10231)) (and (and (and (= (length3 temp___10232) (length2 left)) (= (to_rep1 (first4 temp___10231)) 1)) (= (to_rep1 (last4 temp___10231)) (length2 left))) (= (< 0 (length2 left)) (not (= (empty left) true))))))))
(assert (=> (= (length3 temp___10232) 0) (= temp___1024 temp___1025)))
(assert (=> (= (length3 temp___10232) 0) (= (mk (to_rep1 (first4 temp___10241)) (to_rep1 (last4 temp___10241))) temp___10251)))
(assert (=> (not (= (length3 temp___10232) 0)) (=> (<= (to_rep1 (first4 temp___10241)) (to_rep1 (last4 temp___10241))) (= o (+ (- (to_rep1 (last4 temp___10241)) (to_rep1 (first4 temp___10241))) 1)))))
(assert (=> (not (= (length3 temp___10232) 0)) (=> (not (<= (to_rep1 (first4 temp___10241)) (to_rep1 (last4 temp___10241)))) (= o 0))))
(assert (=> (not (= (length3 temp___10232) 0)) (=> (<= (to_rep1 (first4 temp___10231)) (to_rep1 (last4 temp___10231))) (= o1 (+ (- (to_rep1 (last4 temp___10231)) (to_rep1 (first4 temp___10231))) 1)))))
(assert (=> (not (= (length3 temp___10232) 0)) (=> (not (<= (to_rep1 (first4 temp___10231)) (to_rep1 (last4 temp___10231)))) (= o1 0))))
(assert (=> (not (= (length3 temp___10232) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length3 temp___10232) 0)) (= o3 (+ (to_rep1 (first4 temp___10231)) o2))))
(assert (=> (not (= (length3 temp___10232) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length3 temp___10232) 0)) (and (= o5 o4) (in_range2 o4))))
(assert (=> (not (= (length3 temp___10232) 0)) (= (concat1 temp___1023 (to_rep1 (first4 temp___10231)) (to_rep1 (last4 temp___10231)) temp___1024 (to_rep1 (first4 temp___10241)) (to_rep1 (last4 temp___10241))) temp___1025)))
(assert (=> (not (= (length3 temp___10232) 0)) (= (mk (to_rep1 (first4 temp___10231)) o5) temp___10251)))
(assert (dynamic_property3 1 2147483647 (to_rep1 (first temp___10251)) (to_rep1 (last temp___10251))))
(assert (= temp___1025 o6))
(assert (= (mk2 (to_rep1 (first temp___10251)) (to_rep1 (last temp___10251))) o7))
(assert (and (= o26 (instance (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))) o27)) (and (dynamic_invariant1 o26 true false true true) (and (and (= (to_rep2 o8) (+ (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))) (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))) (= (length2 o26) (length3 o27))) (= (let ((temp___274 (value o26))) (bool_eq (elts2 temp___274) (to_rep1 (first4 (rt2 temp___274))) (to_rep1 (last4 (rt2 temp___274))) o6 (to_rep1 (first4 o7)) (to_rep1 (last4 o7)))) true)))))
(assert (= (mk_sequence__ref (mk___rep (mk___split_discrs result) (mk___split_fields result1 (mk___t1 result2 result3)))) (mk_sequence__ref (mk___rep (mk___split_discrs bounded_dynamic_strings__Oconcat__result) (mk___split_fields bounded_dynamic_strings__Oconcat__result1 (mk___t1 bounded_dynamic_strings__Oconcat__result2 bounded_dynamic_strings__Oconcat__result3))))))
...
(assert (and (= o22 (length2 right)) (and (in_range4 o22) (= o22 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(assert (and (= o23 (length2 left)) (and (in_range4 o23) (= o23 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))))
(assert (= o24 (+ o23 o22)))
...
(assert (and (= o17 (length2 right)) (and (in_range4 o17) (= o17 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))))
(assert (and (= o18 (length2 left)) (and (in_range4 o18) (= o18 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))))
(assert (= o19 (+ o18 o17)))
(assert (and (= o20 (length2 (sequence__content bounded_dynamic_strings__Oconcat__result10))) (and (in_range4 o20) (= o20 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 (sequence__content bounded_dynamic_strings__Oconcat__result10))))))))
(assert (= o21 (ite (= o20 o19) true false)))
(assert (and (= temp___10292 (value right)) (and (dynamic_invariant2 temp___10292 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 right))) temp___1029) (= (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 right))))))) temp___10291)) (and (and (and (= (length3 temp___10292) (length2 right)) (= (to_rep1 (first4 temp___10291)) 1)) (= (to_rep1 (last4 temp___10291)) (length2 right))) (= (< 0 (length2 right)) (not (= (empty right) true))))))))
(assert (and (= temp___10282 (value left)) (and (dynamic_invariant2 temp___10282 true false true true) (and (and (= (elts1 (rec__bounded_dynamic_strings__sequence__content (us_split_fields1 left))) temp___1028) (= (mk2 (to_rep1 (first6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left)))))) (to_rep1 (last6 (mk3 1 (to_rep2 (rec__bounded_dynamic_strings__sequence__current_length (us_split_fields1 left))))))) temp___10281)) (and (and (and (= (length3 temp___10282) (length2 left)) (= (to_rep1 (first4 temp___10281)) 1)) (= (to_rep1 (last4 temp___10281)) (length2 left))) (= (< 0 (length2 left)) (not (= (empty left) true))))))))
(assert (not (= (length3 temp___10282) 0)))
(assert (=> (<= (to_rep1 (first4 temp___10291)) (to_rep1 (last4 temp___10291))) (= o12 (+ (- (to_rep1 (last4 temp___10291)) (to_rep1 (first4 temp___10291))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___10291)) (to_rep1 (last4 temp___10291)))) (= o12 0)))
(assert (=> (<= (to_rep1 (first4 temp___10281)) (to_rep1 (last4 temp___10281))) (= o13 (+ (- (to_rep1 (last4 temp___10281)) (to_rep1 (first4 temp___10281))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___10281)) (to_rep1 (last4 temp___10281)))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first4 temp___10281)) o14)))
(assert (= o16 (- o15 1)))
