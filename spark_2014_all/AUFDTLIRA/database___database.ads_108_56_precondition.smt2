...
(declare-const o21 cur)
(declare-const o22 raw_amount)
(declare-const o23 cur)
(declare-const o24 raw_amount)
...
(assert (or (and (and (= accounts_balance3 (mk_map__ref1 accounts_balance)) (= accounts_balance4 accounts_balance1)) (and (and (and (and (and (= o10 (currency account accounts_balance)) (and (in_range o10) (= o10 (to_rep (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))))))) (= o11 (ite (= o10 (to_rep (rec__money__amount__currency (us_split_fields1 sum)))) true false))) (= result3 (ite (not (= o11 true)) true false))) (ite (= result3 true) (= result2 true) (and (and (and (and (and (and (= (mk___rep (mk___split_fields o3 o4)) (balance account links accounts_balance)) (= (mk___rep (mk___split_fields o3 o4)) (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))) (and (= o3 o5) (= o4 o6))) (= o7 o6)) (= o8 (to_rep1 o7))) (= o9 (+ o8 (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))))) (= result2 (ite (< 1000000 o9) true false))))) (= result2 true))) (and (and (and (and (and (and (= o10 (currency account accounts_balance)) (and (in_range o10) (= o10 (to_rep (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))))))) (= o11 (ite (= o10 (to_rep (rec__money__amount__currency (us_split_fields1 sum)))) true false))) (= result3 (ite (not (= o11 true)) true false))) (ite (= result3 true) (= result2 true) (and (and (and (and (and (and (= (mk___rep (mk___split_fields o3 o4)) (balance account links accounts_balance)) (= (mk___rep (mk___split_fields o3 o4)) (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))) (and (= o3 o5) (= o4 o6))) (= o7 o6)) (= o8 (to_rep1 o7))) (= o9 (+ o8 (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))))) (= result2 (ite (< 1000000 o9) true false))))) (not (= result2 true))) (and (and (= accounts_balance3 (mk_map__ref1 accounts_balance2)) (= accounts_balance4 accounts_balance2)) (and (and (and (and (and (= (mk___rep (mk___split_fields o12 o13)) (oadd (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))) sum)) (= (bool_eq (mk___rep (mk___split_fields o12 o13)) (mk___rep (mk___split_fields (rec__money__amount__currency (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account))))) (of_rep1 (+ (to_rep1 (rec__money__amount__raw (us_split_fields1 (rec__database__account_balance__value (us_split_fields5 (select accounts_balance account)))))) (to_rep1 (rec__money__amount__raw (us_split_fields1 sum)))))))) true)) (and (and (= o14 o12) (= o15 o13)) (= (rec__database__account_balance__account (us_split_fields5 (select accounts_balance account))) o16))) (and (and (= o17 o14) (= o18 o15)) (= o19 o16))) (= o20 (store accounts_balance account (mk___rep2 (mk___split_fields2 (mk___rep (mk___split_fields o17 o18)) o19))))) (and (= result4 (mk_map__ref1 accounts_balance)) (= accounts_balance2 o20)))))))
