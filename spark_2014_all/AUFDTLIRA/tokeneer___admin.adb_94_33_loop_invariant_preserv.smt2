...
(assert (<= op1 4))
(assert (= theop2 0))
(assert (and (and (=> (<= 0 4) (in_range5 theop2)) (=> (<= 1 4) (in_range6 op2))) (and (<= 1 op2) (<= op2 4))))
(assert (and (= result2 (str_comp keyedop op2)) (= (= result2 true) (and (and (<= (to_rep5 (rec__admin__datat__minmatchlength (us_split_fields5 (select optokeyed op2)))) (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop)))) (<= (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop))) (to_rep4 (rec__admin__datat__length (us_split_fields5 (select optokeyed op2)))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (to_rep1 (rec__keyboard__datat__length (us_split_fields1 keyedop))))) (= (to_rep2 (select (rec__admin__datat__text (us_split_fields5 (select optokeyed op2))) i)) (to_rep2 (select (rec__keyboard__datat__text (us_split_fields1 keyedop)) i)))))))))
