...
(declare-fun remove ((Array Int Bool) Int) (Array Int Bool))
(declare-fun remove__function_guard ((Array Int Bool) (Array Int Bool) Int) Bool)
(declare-fun mem ((Array Int Bool) Int) Bool)
(declare-fun mem__function_guard (Bool (Array Int Bool) Int) Bool)
(assert (forall ((s (Array Int Bool))) (forall ((e Int)) (! (=> (dynamic_invariant e true true true true) (forall ((elt Int)) (=> (and (<= 1 elt) (<= elt 10)) (= (= (mem (remove s e) elt) true) (and (not (= elt e)) (= (mem s elt) true)))))) :pattern ((remove s e))))))
...
(assert true)
(assert (forall ((s (Array Int Bool))) (forall ((e1 Int)) (! (= (= (mem s e1) true) (= (select s e1) true)) :pattern ((mem s e1))))))
...
(assert (in_range1 e))
(assert (= result s))
(assert (= s1 (store s e (distinct 0 0))))
(assert (= s1 s2))
(assert (= s3 s1))
(assert (not (= (ext_equal s2 (remove s e)) true)))
(check-sat)
(exit)
