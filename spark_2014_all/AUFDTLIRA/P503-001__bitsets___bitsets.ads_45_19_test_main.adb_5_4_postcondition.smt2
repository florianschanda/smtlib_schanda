...
(assert (forall ((s (Array Int Bool))) (forall ((e Int)) (! (=> (dynamic_invariant e true true true) (forall ((elt Int)) (=> (and (<= 1 elt) (<= elt 10)) (= (= (mem (remove s e) elt) true) (and (not (= elt e)) (= (mem s elt) true)))))) :pattern ((remove s e))))))
