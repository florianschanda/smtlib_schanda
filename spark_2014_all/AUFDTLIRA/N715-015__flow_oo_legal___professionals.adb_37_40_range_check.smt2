...
(assert (not (= (length temp___11512) 0)))
(assert (=> (<= 1 4) (= o1 (+ (- 4 1) 1))))
(assert (=> (not (<= 1 4)) (= o1 0)))
(assert (=> (<= (to_rep1 (first temp___11511)) (to_rep1 (last temp___11511))) (= o2 (+ (- (to_rep1 (last temp___11511)) (to_rep1 (first temp___11511))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___11511)) (to_rep1 (last temp___11511)))) (= o2 0)))
(assert (= o3 (+ o2 o1)))
(assert (= o4 (+ (to_rep1 (first temp___11511)) o3)))
(assert (= o5 (- o4 1)))
