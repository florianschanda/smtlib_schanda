...
(assert (and (and (and (and (forall ((m12 Int)) (=> (and (<= (to_rep a_v1__first) m12) (<= m12 k_1)) (= (to_rep (select (map__content a_v118) m12)) (to_rep (select (elts b_v1) m12))))) (forall ((m12 Int)) (=> (and (<= (+ k_1 1) m12) (<= m12 (to_rep a_v1__last))) (= (to_rep (select (map__content a_v118) m12)) (to_rep (select (elts c_v1) (- m12 k_1))))))) (forall ((m12 Int)) (=> (and (<= (to_rep a_v2__first) m12) (<= m12 k_2)) (= (to_rep (select (map__content a_v210) m12)) (to_rep (select (elts b_v2) m12)))))) (and (and (= temp___464 (+ k_2 1)) (in_range1 (+ k_2 1))) (and (and (= result15 (mk_int__ref i_v21)) (= i_v213 temp___464)) (ite (and (<= temp___464 i_v213) (<= i_v213 (to_rep a_v2__last))) (and (and (and (= temp___462 i_v213) (and (= temp___460 (map__content a_v210)) (and (and (forall ((m12 Int)) (=> (and (<= (to_rep a_v2__first) m12) (<= m12 k_2)) (= (to_rep (select a_v212 m12)) (to_rep (select (elts b_v2) m12))))) (forall ((m12 Int)) (=> (and (<= (+ k_2 1) m12) (<= m12 (- i_v214 1))) (= (to_rep (select a_v212 m12)) (to_rep (select (elts c_v2) (- m12 k_2))))))) (and (and (and (forall ((temp___461 Int)) (=> (and (<= (to_rep a_v2__first) temp___461) (<= temp___461 (to_rep a_v2__last))) (=> (<= i_v214 temp___461) (= (select a_v212 temp___461) (select temp___460 temp___461))))) (=> (<= (+ k_2 1) (to_rep a_v2__last)) (dynamic_property4 (+ k_2 1) (to_rep a_v2__last) i_v214))) (and (<= (+ k_2 1) i_v214) (<= i_v214 (to_rep a_v2__last)))) (and (and (and (and (and (and (and (and (= temp___458 (- i_v214 k_2)) (in_range1 (- i_v214 k_2))) (and (and (<= (to_rep (first (rt c_v2))) temp___458) (<= temp___458 (to_rep (last (rt c_v2))))) (= o60 temp___458))) (= o61 (select (elts c_v2) o60))) (= o62 (to_rep o61))) (= (to_rep o63) o62)) (and (and (and (<= (to_rep a_v2__first) i_v214) (<= i_v214 (to_rep a_v2__last))) (= o64 i_v214)) (= o65 (store a_v212 o64 o63)))) (and (= result17 (mk_map__ref a_v212)) (= a_v213 o65))) (= i_v214 (to_rep a_v2__last))))))) (and (and (= i_v220 (mk_int__ref i_v214)) (= a_v218 (mk_map__ref a_v213))) (and (= i_v221 i_v214) (= a_v219 a_v213)))) (and (and (= i_v222 i_v220) (= a_v220 a_v218)) (and (= i_v223 i_v221) (= a_v221 a_v219)))) (and (and (= i_v222 (mk_int__ref i_v213)) (= a_v220 a_v210)) (and (= i_v223 i_v213) (= a_v221 a_v211))))))) (and (and (= i_v225 i_v222) (and (= i_v224 i_v211) (and (= i_v123 i_v120) (and (= i_v122 (mk_int__ref i_v19)) (and (= a_v222 a_v220) (= a_v120 a_v118)))))) (and (= i_v227 i_v223) (and (= i_v226 i_v212) (and (= i_v125 i_v121) (and (= i_v124 i_v110) (and (= a_v223 a_v221) (= a_v121 a_v119)))))))))
(assert (=> (= (ite (= (= k_1 k_2) true) (ite (<= (to_rep a_v1__first) i) (ite (<= i k_1) (= (to_rep (select (elts b_v1) i)) (to_rep (select (elts b_v2) i))) false) false) false) true) (= (to_rep (select (map__content a_v120) i)) (to_rep (select (map__content a_v222) i)))))
...
(assert (not (= (to_rep (select (map__content a_v120) i)) (to_rep (select (map__content a_v222) i)))))
(check-sat)
(exit)
