...
(declare-const temp___503 (Array Int integer))
...
(declare-const i_v12 int__ref)
(declare-const a_v11 (Array Int integer))
(declare-const i_v13 Int)
(declare-const a_v2 map__ref)
(declare-const i_v21 int__ref)
...
(assert (and (and (forall ((m Int)) (=> (and (<= (to_rep a_v1__first) m) (<= m k_1)) (= (to_rep (select (map__content a_v1) m)) (to_rep (select (elts b_v1) m))))) (forall ((m Int)) (=> (and (<= (+ k_1 1) m) (<= m (to_rep a_v1__last))) (= (to_rep (select (map__content a_v1) m)) (to_rep (select (elts c_v1) (- m k_1))))))) (forall ((m Int)) (=> (and (<= (to_rep a_v2__first) m) (<= m k_2)) (= (to_rep (select (map__content a_v2) m)) (to_rep (select (elts b_v2) m)))))))
(assert (and (= temp___507 (+ k_2 1)) (in_range1 (+ k_2 1))))
(assert (= result (mk_int__ref i_v2)))
(assert (= i_v23 temp___507))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= temp___505 i_v23)))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= temp___503 (map__content a_v2))))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (and (forall ((m Int)) (=> (and (<= (to_rep a_v2__first) m) (<= m k_2)) (= (to_rep (select a_v22 m)) (to_rep (select (elts b_v2) m))))) (forall ((m Int)) (=> (and (<= (+ k_2 1) m) (<= m (- i_v24 1))) (= (to_rep (select a_v22 m)) (to_rep (select (elts c_v2) (- m k_2)))))))))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (and (and (forall ((temp___504 Int)) (=> (and (<= (to_rep a_v2__first) temp___504) (<= temp___504 (to_rep a_v2__last))) (=> (<= i_v24 temp___504) (= (select a_v22 temp___504) (select temp___503 temp___504))))) (=> (<= (+ k_2 1) (to_rep a_v2__last)) (dynamic_property4 (+ k_2 1) (to_rep a_v2__last) i_v24))) (and (<= (+ k_2 1) i_v24) (<= i_v24 (to_rep a_v2__last))))))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (and (= temp___501 (- i_v24 k_2)) (in_range1 (- i_v24 k_2)))))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (and (<= (to_rep (first (rt c_v2))) temp___501) (<= temp___501 (to_rep (last (rt c_v2)))))))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= o temp___501)))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= o1 (select (elts c_v2) o))))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= o2 (to_rep o1))))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= (to_rep o3) o2)))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (and (<= (to_rep a_v2__first) i_v24) (<= i_v24 (to_rep a_v2__last)))))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= o4 i_v24)))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= o5 (store a_v22 o4 o3))))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= result1 (mk_map__ref a_v22))))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= a_v23 o5)))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= i_v24 (to_rep a_v2__last))))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= i_v25 (mk_int__ref i_v24))))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= a_v24 (mk_map__ref a_v23))))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= i_v26 i_v24)))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= a_v25 a_v23)))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= i_v27 i_v25)))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= a_v26 a_v24)))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= i_v28 i_v26)))
(assert (=> (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last))) (= a_v27 a_v25)))
(assert (=> (not (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last)))) (= i_v27 (mk_int__ref i_v23))))
(assert (=> (not (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last)))) (= a_v26 a_v2)))
(assert (=> (not (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last)))) (= i_v28 i_v23)))
(assert (=> (not (and (<= temp___507 i_v23) (<= i_v23 (to_rep a_v2__last)))) (= a_v27 a_v21)))
(assert (= i_v210 i_v27))
(assert (= i_v29 i_v21))
(assert (= i_v15 i_v12))
(assert (= i_v14 (mk_int__ref i_v1)))
(assert (= a_v28 a_v26))
(assert (= a_v12 a_v1))
(assert (= i_v212 i_v28))
(assert (= i_v211 i_v22))
...
(assert (= a_v29 a_v27))
(assert (= a_v13 a_v11))
(assert (=> (= (ite (= (= k_1 k_2) true) (ite (<= (to_rep a_v1__first) i) (ite (<= i k_1) (= (to_rep (select (elts b_v1) i)) (to_rep (select (elts b_v2) i))) false) false) false) true) (= (to_rep (select (map__content a_v12) i)) (to_rep (select (map__content a_v28) i)))))
(assert (= (ite (= (= k_1 k_2) true) (ite (<= (+ k_1 1) i) (ite (<= i (to_rep a_v1__last)) (= (to_rep (select (elts c_v1) (- i k_1))) (to_rep (select (elts c_v2) (- i k_1)))) false) false) false) true))
(assert (not (= (to_rep (select (map__content a_v12) i)) (to_rep (select (map__content a_v28) i)))))
(check-sat)
(exit)
