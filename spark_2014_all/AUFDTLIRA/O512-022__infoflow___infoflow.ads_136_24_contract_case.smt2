...
(assert (and (= temp___464 (+ k_2 1)) (in_range1 (+ k_2 1))))
(assert (= result (mk_int__ref i_v2)))
(assert (= i_v23 temp___464))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= temp___462 i_v23)))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= temp___460 (map__content a_v2))))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (and (forall ((m Int)) (=> (and (<= (to_rep a_v2__first) m) (<= m k_2)) (= (to_rep (select a_v22 m)) (to_rep (select (elts b_v2) m))))) (forall ((m Int)) (=> (and (<= (+ k_2 1) m) (<= m (- i_v24 1))) (= (to_rep (select a_v22 m)) (to_rep (select (elts c_v2) (- m k_2)))))))))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (and (and (forall ((temp___461 Int)) (=> (and (<= (to_rep a_v2__first) temp___461) (<= temp___461 (to_rep a_v2__last))) (=> (<= i_v24 temp___461) (= (select a_v22 temp___461) (select temp___460 temp___461))))) (=> (<= (+ k_2 1) (to_rep a_v2__last)) (dynamic_property4 (+ k_2 1) (to_rep a_v2__last) i_v24))) (and (<= (+ k_2 1) i_v24) (<= i_v24 (to_rep a_v2__last))))))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (and (= temp___458 (- i_v24 k_2)) (in_range1 (- i_v24 k_2)))))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (and (<= (to_rep (first (rt c_v2))) temp___458) (<= temp___458 (to_rep (last (rt c_v2)))))))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= o temp___458)))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= o1 (select (elts c_v2) o))))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= o2 (to_rep o1))))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= (to_rep o3) o2)))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (and (<= (to_rep a_v2__first) i_v24) (<= i_v24 (to_rep a_v2__last)))))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= o4 i_v24)))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= o5 (store a_v22 o4 o3))))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= result1 (mk_map__ref a_v22))))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= a_v23 o5)))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= i_v24 (to_rep a_v2__last))))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= i_v25 (mk_int__ref i_v24))))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= a_v24 (mk_map__ref a_v23))))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= i_v26 i_v24)))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= a_v25 a_v23)))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= i_v27 i_v25)))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= a_v26 a_v24)))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= i_v28 i_v26)))
(assert (=> (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last))) (= a_v27 a_v25)))
(assert (=> (not (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last)))) (= i_v27 (mk_int__ref i_v23))))
(assert (=> (not (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last)))) (= a_v26 a_v2)))
(assert (=> (not (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last)))) (= i_v28 i_v23)))
(assert (=> (not (and (<= temp___464 i_v23) (<= i_v23 (to_rep a_v2__last)))) (= a_v27 a_v21)))
(assert (= i_v210 i_v27))
(assert (= i_v29 i_v21))
(assert (= i_v15 i_v12))
