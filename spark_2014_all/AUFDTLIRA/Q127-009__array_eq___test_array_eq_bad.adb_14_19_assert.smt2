...
(define-fun bool_eq1 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (user_eq1 (select a temp___idx_132) (select b (+ (- b__first a__first) temp___idx_132))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_132 Int)) (=> (and (<= a__first temp___idx_132) (<= temp___idx_132 a__last)) (= (user_eq1 (select a temp___idx_132) (select b (+ (- b__first a__first) temp___idx_132))) true))))))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun test_array_eq_bad__a__aggregate_def (us_rep us_rep) (Array Int us_rep))
(assert (forall ((temp___189 us_rep) (temp___190 us_rep)) (let ((temp___188 (test_array_eq_bad__a__aggregate_def temp___189 temp___190))) (and (= (select temp___188 1) temp___189) (= (select temp___188 2) temp___190)))))
(declare-fun test_array_eq_bad__b__aggregate_def (us_rep us_rep) (Array Int us_rep))
(assert (forall ((temp___193 us_rep) (temp___194 us_rep)) (let ((temp___192 (test_array_eq_bad__b__aggregate_def temp___193 temp___194))) (and (= (select temp___192 1) temp___193) (= (select temp___192 2) temp___194)))))
