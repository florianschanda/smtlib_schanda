...
(define-fun dynamic_invariant4 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 1 100)) (in_range1 temp___expr_142)))
(assert (forall ((a1 us_t)) (forall ((i Int)) (! (=> (and (and (dynamic_invariant a1 true true true) (dynamic_invariant4 i true true true)) (and (= (invariant__ a1) true) (and (<= (first1 a1) i) (<= i (last1 a1))))) (let ((result (remove a1 i))) (and (and (= (invariant__ result) true) (and (= (last1 result) (- (last1 a1) 1)) (and (forall ((k Int)) (=> (and (<= 1 k) (<= k (- i 1))) (= (to_rep1 (select (to_array a1) k)) (to_rep1 (select (to_array result) k))))) (and (forall ((k Int)) (=> (and (<= (+ i 1) k) (<= k (last1 a1))) (= (to_rep1 (select (to_array a1) k)) (to_rep1 (select (to_array result) (- k 1)))))) (forall ((k Int)) (=> (and (<= i k) (<= k (- (last1 a1) 1))) (= (to_rep1 (select (to_array a1) (+ k 1))) (to_rep1 (select (to_array result) k))))))))) (dynamic_invariant result true false true)))) :pattern ((remove a1 i))))))
...
(assert (and (= o (induction_hypothesis a b)) (and (in_range4 o) (=> (= (of_int o) true) (= (is_perm b a) true)))))
(assert (= (mk_int__ref result2) (mk_int__ref perm__perm_symmetric__result)))
...
(assert (= (of_int perm__perm_symmetric__result4) true))
