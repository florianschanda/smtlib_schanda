...
(define-fun dynamic_invariant4 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 1 100)) (in_range1 temp___expr_166)))
...
(declare-const perm__perm_symmetric__result Int)
(declare-const o Int)
(declare-const result Int)
(declare-const perm__perm_symmetric__result1 Int)
(declare-const perm__perm_symmetric__result2 Int)
(declare-const perm__perm_symmetric__result3 Int)
(declare-const perm__perm_symmetric__result4 Int)
(declare-const perm__perm_symmetric__result5 Int)
...
(assert (= perm__perm_symmetric__result1 perm__perm_symmetric__result2))
(assert (= perm__perm_symmetric__result3 perm__perm_symmetric__result1))
(assert (and (= o (induction_hypothesis a b)) (and (in_range4 o) (=> (= (distinct o 0) true) (= (is_perm b a) true)))))
(assert (= (mk_int__ref result) (mk_int__ref perm__perm_symmetric__result)))
(assert (= perm__perm_symmetric__result1 o))
(assert (= (mk_int__ref perm__perm_symmetric__result4) (mk_int__ref perm__perm_symmetric__result2)))
(assert (= perm__perm_symmetric__result5 perm__perm_symmetric__result3))
(assert (= (distinct perm__perm_symmetric__result4 0) true))
