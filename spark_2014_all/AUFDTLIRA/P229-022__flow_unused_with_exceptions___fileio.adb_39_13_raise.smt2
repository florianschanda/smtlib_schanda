...
(assert (not (= ch eof)))
(assert (and (=> (not (= result__1 eof)) (and (= cur_position1 (- cur_position 1)) (= (bool_eq the_file1 1 2147483647 (temp___419 the_file cur_position1 ch) 1 2147483647) true))) (and (in_range2 result__1) (in_range cur_position1))))
