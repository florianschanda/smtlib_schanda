...
(define-fun dynamic_invariant1 ((temp___expr_300 Int) (temp___is_init_297 Bool) (temp___skip_constant_298 Bool) (temp___do_toplevel_299 Bool)) Bool (=> (or (= temp___is_init_297 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_300)))
...
(declare-fun temp___361 ((Array Int character) Int Int) (Array Int character))
(assert (forall ((temp___363 (Array Int character))) (forall ((temp___364 Int) (temp___365 Int)) (let ((temp___362 (temp___361 temp___363 temp___364 temp___365))) (forall ((temp___366 Int)) (ite (= temp___366 temp___364) (= (select temp___362 temp___366) (of_rep temp___365)) (= (select temp___362 temp___366) (select temp___363 temp___366))))))))
...
(declare-fun temp___381 ((Array Int character) Int Int) (Array Int character))
(assert (forall ((temp___383 (Array Int character))) (forall ((temp___384 Int) (temp___385 Int)) (let ((temp___382 (temp___381 temp___383 temp___384 temp___385))) (forall ((temp___386 Int)) (ite (= temp___386 temp___384) (= (select temp___382 temp___386) (of_rep temp___385)) (= (select temp___382 temp___386) (select temp___383 temp___386))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_348 Int) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool)) Bool (=> (or (= temp___is_init_345 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_348)))
...
(assert (not (= ch eof)))
(assert (and (=> (not (= result__2 eof)) (and (= cur_position2 (- cur_position 1)) (= (bool_eq the_file2 1 2147483647 (temp___361 the_file cur_position2 ch) 1 2147483647) true))) (and (in_range2 result__2) (in_range cur_position2))))
(assert (= result__2 eof))
(assert (not false))
(check-sat)
(exit)
