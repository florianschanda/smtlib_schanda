...
(define-fun dynamic_invariant1 ((temp___expr_306 Int) (temp___is_init_303 Bool) (temp___skip_constant_304 Bool) (temp___do_toplevel_305 Bool)) Bool (=> (or (= temp___is_init_303 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_306)))
...
(declare-fun temp___367 ((Array Int character) Int Int) (Array Int character))
(assert (forall ((temp___369 (Array Int character))) (forall ((temp___370 Int) (temp___371 Int)) (let ((temp___368 (temp___367 temp___369 temp___370 temp___371))) (forall ((temp___372 Int)) (ite (= temp___372 temp___370) (= (select temp___368 temp___372) (of_rep temp___371)) (= (select temp___368 temp___372) (select temp___369 temp___372))))))))
...
(declare-fun temp___387 ((Array Int character) Int Int) (Array Int character))
(assert (forall ((temp___389 (Array Int character))) (forall ((temp___390 Int) (temp___391 Int)) (let ((temp___388 (temp___387 temp___389 temp___390 temp___391))) (forall ((temp___392 Int)) (ite (= temp___392 temp___390) (= (select temp___388 temp___392) (of_rep temp___391)) (= (select temp___388 temp___392) (select temp___389 temp___392))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_354 Int) (temp___is_init_351 Bool) (temp___skip_constant_352 Bool) (temp___do_toplevel_353 Bool)) Bool (=> (or (= temp___is_init_351 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_354)))
...
(assert (not (= ch eof)))
(assert (and (=> (not (= result__1 eof)) (and (= cur_position1 (- cur_position 1)) (= (bool_eq the_file1 1 2147483647 (temp___367 the_file cur_position1 ch) 1 2147483647) true))) (and (in_range2 result__1) (in_range cur_position1))))
(assert (not (not (= result__1 eof))))
(check-sat)
(exit)
