...
(define-fun dynamic_invariant1 ((temp___expr_143 us_rep) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (let ((temp___144 (rec__priv__priv_rec__c (us_split_discrs1 temp___expr_143)))) (and (dynamic_property1 1 (to_rep temp___144) (first1 (rec__priv__priv_rec__content (us_split_fields1 temp___expr_143))) (last1 (rec__priv__priv_rec__content (us_split_fields1 temp___expr_143)))) (and (= (first1 (rec__priv__priv_rec__content (us_split_fields1 temp___expr_143))) 1) (= (last1 (rec__priv__priv_rec__content (us_split_fields1 temp___expr_143))) (to_rep temp___144))))))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___134 (rec__priv__priv_rec__content1 (us_split_fields3 a)))) (of_array (to_array1 temp___134) (first3 temp___134) (last3 temp___134))))))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r) (mk___split_fields1 (let ((temp___133 (rec__priv__priv_rec__content (us_split_fields1 r)))) (of_array1 (to_array temp___133) (first1 temp___133) (last1 temp___133))))))
...
(define-fun dynamic_invariant2 ((temp___expr_153 us_rep2) (temp___is_init_150 Bool) (temp___skip_constant_151 Bool) (temp___do_toplevel_152 Bool)) Bool (and (in_range2 max (to_base (rec__main__r__content (us_split_fields5 temp___expr_153)))) (and (dynamic_property3 1 max (first3 (rec__priv__priv_rec__content1 (us_split_fields3 (rec__main__r__content (us_split_fields5 temp___expr_153))))) (last3 (rec__priv__priv_rec__content1 (us_split_fields3 (rec__main__r__content (us_split_fields5 temp___expr_153)))))) (and (= (first3 (rec__priv__priv_rec__content1 (us_split_fields3 (rec__main__r__content (us_split_fields5 temp___expr_153))))) 1) (= (last3 (rec__priv__priv_rec__content1 (us_split_fields3 (rec__main__r__content (us_split_fields5 temp___expr_153))))) max)))))
(define-fun default_initial_assumption ((temp___expr_156 us_rep2) (temp___skip_top_level_157 Bool)) Bool (= (to_rep (rec__priv__priv_rec__c (us_split_discrs2 (rec__main__r__content (us_split_fields5 temp___expr_156))))) max))
...
(assert (dynamic_invariant2 (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_discrs v__split_fields) (mk___split_fields1 (mk___t1 v__split_fields1 v__split_fields2))))) false false true))
(assert (not (< 0 (to_rep (rec__priv__priv_rec__c (us_split_discrs1 (to_base (mk___rep1 (mk___split_discrs v__split_fields) (mk___split_fields1 (mk___t1 v__split_fields1 v__split_fields2))))))))))
(check-sat)
(exit)
