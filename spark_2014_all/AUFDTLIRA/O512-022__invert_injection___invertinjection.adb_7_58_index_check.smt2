...
(assert (and (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (=> (= (to_rep (select a i3)) (to_rep (select a j1))) (= i3 j1)))))) (forall ((i3 Int)) (=> (and (<= 1 i3) (<= i3 100)) (not (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (not (= (to_rep (select a j1)) i3)))))))))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 100))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i2 1))) (= (to_rep (select b (to_rep (select a j1)))) j1))))
