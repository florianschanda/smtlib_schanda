...
(declare-datatypes () ((constr_arr_2__ref (mk_constr_arr_2__ref (constr_arr_2__content us_t1)))))
(define-fun constr_arr_2__ref___projection ((a constr_arr_2__ref)) us_t1 (constr_arr_2__content a))
(define-fun dynamic_invariant ((temp___expr_225 us_t1) (temp___is_init_221 Bool) (temp___skip_constant_222 Bool) (temp___do_toplevel_223 Bool) (temp___do_typ_inv_224 Bool)) Bool (and (=> (not (= temp___skip_constant_222 true)) (dynamic_property1 (- 2147483648) 2147483647 (first3 temp___expr_225) (last3 temp___expr_225))) (=> (= temp___do_toplevel_223 true) (=> (= temp___is_init_221 true) (and (let ((temp___227 (of_array (to_array1 temp___expr_225) (first3 temp___expr_225) (last3 temp___expr_225)))) (and (<= (first1 temp___227) 1) (<= 3 (last1 temp___227)))) (not (= (to_rep (select (to_array1 temp___expr_225) 3)) 0)))))))
(define-fun dynamic_predicate ((temp___229 us_t1)) Bool (and (let ((temp___231 (of_array (to_array1 temp___229) (first3 temp___229) (last3 temp___229)))) (and (<= (first1 temp___231) 1) (<= 3 (last1 temp___231)))) (not (= (to_rep (select (to_array1 temp___229) 3)) 0))))
(declare-const i9b us_t1)
...
(assert (and (dynamic_property1 (- 2147483648) 2147483647 (to_rep1 a__first) (to_rep1 a__last)) (and (and (<= (to_rep1 (first (mk (to_rep1 a__first) (to_rep1 a__last)))) 1) (<= 3 (to_rep1 (last (mk (to_rep1 a__first) (to_rep1 a__last)))))) (not (= (to_rep (select a 3)) 0)))))
