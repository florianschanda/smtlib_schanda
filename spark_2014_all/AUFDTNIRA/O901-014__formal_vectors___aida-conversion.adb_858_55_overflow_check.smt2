...
(assert (= o87 (+ o86 o85)))
(assert (and (= o94 o87) (in_range1 o87)))
(assert (= o95 (+ o94 o93)))
(assert (and (= o102 o95) (in_range1 o95)))
(assert (= o103 (+ o102 o101)))
(assert (and (= o110 o103) (in_range1 o103)))
(assert (= o111 (+ o110 o109)))
(assert (and (= o118 o111) (in_range1 o111)))
(assert (= o119 (+ o118 o117)))
(assert (not (in_range1 o119)))
(check-sat)
(exit)
