...
(define-fun dynamic_invariant ((temp___expr_517 Int) (temp___is_init_514 Bool) (temp___skip_constant_515 Bool) (temp___do_toplevel_516 Bool)) Bool (=> (or (= temp___is_init_514 true) (<= 0 4294967295)) (in_range7 temp___expr_517)))
...
(define-fun dynamic_invariant1 ((temp___expr_529 Int) (temp___is_init_526 Bool) (temp___skip_constant_527 Bool) (temp___do_toplevel_528 Bool)) Bool (=> (or (= temp___is_init_526 true) (<= 0 1)) (in_range8 temp___expr_529)))
...
(define-fun bool_eq4 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep5 (select a temp___idx_153)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_153))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep5 (select a temp___idx_153)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
...
(define-fun bool_eq6 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep8 (select a temp___idx_154)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep8 (select a temp___idx_154)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_154)))))))))))
...
(assert (forall ((temp___1195 Int)) (forall ((temp___1196 Int)) (= (select (temp___1193 temp___1195) temp___1196) (of_rep5 temp___1195)))))
(declare-fun temp___1197 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1199 Int)) (forall ((temp___1200 Int)) (= (select (temp___1197 temp___1199) temp___1200) (of_rep8 temp___1199)))))
(define-fun dynamic_invariant2 ((temp___expr_1187 us_rep3) (temp___is_init_1184 Bool) (temp___skip_constant_1185 Bool) (temp___do_toplevel_1186 Bool)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1187))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1187))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1187)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1187))) true))
(define-fun default_initial_assumption ((temp___expr_1191 us_rep3) (temp___skip_top_level_1192 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1191))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1191))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1191)) (mk___rep2 (mk___split_fields2 (temp___1193 1) (of_rep5 1) (of_rep5 1) (of_rep7 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1191)) (temp___1197 0))))
(define-fun type_invariant ((temp___1201 us_rep3)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1201))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1201))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1201)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1201))) true))
...
(define-fun bool_eq9 ((a (Array Int us_rep4)) (a__first Int) (a__last Int) (b (Array Int us_rep4)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_155 Int)) (=> (and (<= a__first temp___idx_155) (<= temp___idx_155 a__last)) (= (bool_eq8 (select a temp___idx_155) (select b (+ (- b__first a__first) temp___idx_155))) true)))) true false))
...
(define-fun bool_eq10 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep9 (select a temp___idx_156)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_156))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep9 (select a temp___idx_156)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_156)))))))))))
...
(declare-fun temp___String_Literal_1958 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1958 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 20)) 86)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 22)) 114)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 24)) 102)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 26)) 97)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 27)) 98)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 28)) 108)) (= (to_rep (select (temp___String_Literal_1958 us_void_param) 29)) 101)) :pattern ((temp___String_Literal_1958 us_void_param)))))
(declare-fun temp___String_Literal_1959 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1959 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 16)) 66)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_1959 us_void_param) 18)) 100)) :pattern ((temp___String_Literal_1959 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_359 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 40)) (in_range5 temp___expr_359)))
(define-fun dynamic_invariant8 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 4294967295)) (in_range6 temp___expr_380)))
(define-fun dynamic_invariant9 ((temp___expr_402 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 10)) (in_range14 temp___expr_402)))
(define-fun dynamic_invariant10 ((temp___expr_414 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 0 4294967295)) (in_range19 temp___expr_414)))
(define-fun dynamic_invariant11 ((temp___expr_420 Int) (temp___is_init_417 Bool) (temp___skip_constant_418 Bool) (temp___do_toplevel_419 Bool)) Bool (=> (or (= temp___is_init_417 true) (<= 0 128)) (in_range20 temp___expr_420)))
(define-fun dynamic_invariant12 ((temp___expr_1153 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 17)) (in_range11 temp___expr_1153)))
(define-fun dynamic_invariant13 ((temp___expr_1132 Int) (temp___is_init_1129 Bool) (temp___skip_constant_1130 Bool) (temp___do_toplevel_1131 Bool)) Bool (=> (or (= temp___is_init_1129 true) (<= 1 17)) (in_range9 temp___expr_1132)))
(define-fun dynamic_invariant14 ((temp___expr_1257 Int) (temp___is_init_1254 Bool) (temp___skip_constant_1255 Bool) (temp___do_toplevel_1256 Bool)) Bool (=> (or (= temp___is_init_1254 true) (<= 0 2)) (in_range13 temp___expr_1257)))
(define-fun dynamic_invariant15 ((temp___expr_1138 Int) (temp___is_init_1135 Bool) (temp___skip_constant_1136 Bool) (temp___do_toplevel_1137 Bool)) Bool (=> (or (= temp___is_init_1135 true) (<= 0 17408)) (in_range10 temp___expr_1138)))
(define-fun dynamic_invariant16 ((temp___expr_1172 Int) (temp___is_init_1169 Bool) (temp___skip_constant_1170 Bool) (temp___do_toplevel_1171 Bool)) Bool (=> (or (= temp___is_init_1169 true) (<= 0 1024)) (in_range12 temp___expr_1172)))
(assert true)
...
(define-fun dynamic_invariant17 ((temp___expr_597 Int) (temp___is_init_594 Bool) (temp___skip_constant_595 Bool) (temp___do_toplevel_596 Bool)) Bool (=> (or (= temp___is_init_594 true) (<= 1901 2099)) (in_range15 temp___expr_597)))
(define-fun dynamic_invariant18 ((temp___expr_603 Int) (temp___is_init_600 Bool) (temp___skip_constant_601 Bool) (temp___do_toplevel_602 Bool)) Bool (=> (or (= temp___is_init_600 true) (<= 1 12)) (in_range16 temp___expr_603)))
(define-fun dynamic_invariant19 ((temp___expr_609 Int) (temp___is_init_606 Bool) (temp___skip_constant_607 Bool) (temp___do_toplevel_608 Bool)) Bool (=> (or (= temp___is_init_606 true) (<= 1 31)) (in_range17 temp___expr_609)))
(define-fun dynamic_invariant20 ((temp___expr_637 Int) (temp___is_init_634 Bool) (temp___skip_constant_635 Bool) (temp___do_toplevel_636 Bool)) Bool (=> (or (= temp___is_init_634 true) (<= 0 86399999)) (in_range18 temp___expr_637)))
(define-fun dynamic_invariant21 ((temp___expr_493 Int) (temp___is_init_490 Bool) (temp___skip_constant_491 Bool) (temp___do_toplevel_492 Bool)) Bool (=> (or (= temp___is_init_490 true) (<= 0 4294967295)) (in_range4 temp___expr_493)))
