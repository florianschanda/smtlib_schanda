...
(assert (forall ((x serialnumbert)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x serialnumbert)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x issueridt)) (! (in_range6 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (bool_eq2 (rec__certtypes__idt__issuer (us_split_fields3 a)) (rec__certtypes__idt__issuer (us_split_fields3 b))) true) (= (to_rep2 (rec__certtypes__idt__serialnumber (us_split_fields3 a))) (to_rep2 (rec__certtypes__idt__serialnumber (us_split_fields3 b))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_579 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool) (temp___do_typ_inv_578 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 0 4294967295)) (in_range7 temp___expr_579)))
...
(define-fun dynamic_invariant1 ((temp___expr_593 Int) (temp___is_init_589 Bool) (temp___skip_constant_590 Bool) (temp___do_toplevel_591 Bool) (temp___do_typ_inv_592 Bool)) Bool (=> (or (= temp___is_init_589 true) (<= 0 1)) (in_range8 temp___expr_593)))
...
(define-fun bool_eq4 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep5 (select a temp___idx_175)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_175))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep5 (select a temp___idx_175)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(define-fun bool_eq6 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep8 (select a temp___idx_176)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_176))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep8 (select a temp___idx_176)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_1337 us_rep3) (temp___is_init_1333 Bool) (temp___skip_constant_1334 Bool) (temp___do_toplevel_1335 Bool) (temp___do_typ_inv_1336 Bool)) Bool (=> (= temp___do_typ_inv_1336 true) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1337))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1337))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1337)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1337))) true)))
(define-fun default_initial_assumption ((temp___expr_1341 us_rep3) (temp___skip_top_level_1342 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1341))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1341))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1341)) (mk___rep2 (mk___split_fields2 (temp___1343 1) (of_rep5 1) (of_rep5 1) (of_rep7 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1341)) (temp___1347 0))))
(define-fun type_invariant ((temp___1351 us_rep3)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1351))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1351))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1351)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1351))) true))
...
(define-fun t__ref___projection ((a t__ref)) us_rep4 (t__content a))
...
(define-fun bool_eq9 ((a (Array Int us_rep4)) (a__first Int) (a__last Int) (b (Array Int us_rep4)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq8 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true)))) true false))
...
(define-fun bool_eq10 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep9 (select a temp___idx_178)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_178))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep9 (select a temp___idx_178)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_178)))))))))))
...
(declare-fun user_eq22 (algorithmt algorithmt) Bool)
(declare-const dummy22 algorithmt)
...
(assert (forall ((x algorithmt)) (! (in_range14 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(declare-fun user_eq23 (yearst yearst) Bool)
(declare-const dummy23 yearst)
...
(assert (forall ((x yearst)) (! (in_range15 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(declare-fun user_eq24 (monthst monthst) Bool)
(declare-const dummy24 monthst)
...
(assert (forall ((x monthst)) (! (in_range16 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(declare-fun user_eq25 (dayst dayst) Bool)
(declare-const dummy25 dayst)
...
(assert (forall ((x dayst)) (! (in_range17 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(declare-fun user_eq26 (millisecst millisecst) Bool)
(declare-const dummy26 millisecst)
...
(assert (forall ((x millisecst)) (! (in_range18 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(define-fun bool_eq11 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (= (to_rep11 (rec__clock__timet__year (us_split_fields9 a))) (to_rep11 (rec__clock__timet__year (us_split_fields9 b)))) (= (to_rep12 (rec__clock__timet__month (us_split_fields9 a))) (to_rep12 (rec__clock__timet__month (us_split_fields9 b))))) (= (to_rep13 (rec__clock__timet__day (us_split_fields9 a))) (to_rep13 (rec__clock__timet__day (us_split_fields9 b))))) (= (to_rep14 (rec__clock__timet__millisec (us_split_fields9 a))) (to_rep14 (rec__clock__timet__millisec (us_split_fields9 b))))) true false))
...
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__cert__contentst__id us_rep1) (rec__cert__contentst__notbefore us_rep5) (rec__cert__contentst__notafter us_rep5) (rec__cert__contentst__mechanism algorithmt)))))
(define-fun us_split_fields_ID__3__projection ((a us_split_fields10)) us_rep1 (rec__cert__contentst__id a))
(define-fun us_split_fields_NotBefore__projection ((a us_split_fields10)) us_rep5 (rec__cert__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__projection ((a us_split_fields10)) us_rep5 (rec__cert__contentst__notafter a))
...
(define-fun bool_eq12 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (= (bool_eq3 (rec__cert__contentst__id (us_split_fields11 a)) (rec__cert__contentst__id (us_split_fields11 b))) true) (= (bool_eq11 (rec__cert__contentst__notbefore (us_split_fields11 a)) (rec__cert__contentst__notbefore (us_split_fields11 b))) true)) (= (bool_eq11 (rec__cert__contentst__notafter (us_split_fields11 a)) (rec__cert__contentst__notafter (us_split_fields11 b))) true)) (= (to_rep10 (rec__cert__contentst__mechanism (us_split_fields11 a))) (to_rep10 (rec__cert__contentst__mechanism (us_split_fields11 b))))) true false))
...
(declare-fun user_eq29 (keyidt keyidt) Bool)
(declare-const dummy29 keyidt)
...
(declare-fun to_rep15 (keyidt) Int)
...
(declare-fun user_eq30 (keylengtht keylengtht) Bool)
(declare-const dummy30 keylengtht)
...
(declare-fun to_rep16 (keylengtht) Int)
...
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__cert__id__contentst__id us_rep1) (rec__cert__id__contentst__notbefore us_rep5) (rec__cert__id__contentst__notafter us_rep5) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep) (rec__cert__id__contentst__subjectpublickey us_rep7)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields14)) us_rep1 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields14)) us_rep5 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields14)) us_rep5 (rec__cert__id__contentst__notafter a))
...
(define-fun bool_eq14 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__id__contentst__id (us_split_fields15 a)) (rec__cert__id__contentst__id (us_split_fields15 b))) true) (= (bool_eq11 (rec__cert__id__contentst__notbefore (us_split_fields15 a)) (rec__cert__id__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq11 (rec__cert__id__contentst__notafter (us_split_fields15 a)) (rec__cert__id__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep10 (rec__cert__id__contentst__mechanism (us_split_fields15 a))) (to_rep10 (rec__cert__id__contentst__mechanism (us_split_fields15 b))))) (= (bool_eq2 (rec__cert__id__contentst__subject (us_split_fields15 a)) (rec__cert__id__contentst__subject (us_split_fields15 b))) true)) (= (bool_eq13 (rec__cert__id__contentst__subjectpublickey (us_split_fields15 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields15 b))) true)) true false))
...
(declare-fun temp___String_Literal_2128 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2128 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 20)) 86)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 22)) 114)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 24)) 102)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 26)) 97)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 27)) 98)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 28)) 108)) (= (to_rep (select (temp___String_Literal_2128 us_void_param) 29)) 101)) :pattern ((temp___String_Literal_2128 us_void_param)))))
(declare-fun temp___String_Literal_2129 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2129 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 16)) 66)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_2129 us_void_param) 18)) 100)) :pattern ((temp___String_Literal_2129 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range5 temp___expr_402)))
(define-fun dynamic_invariant8 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range6 temp___expr_426)))
(define-fun dynamic_invariant9 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range14 temp___expr_450)))
(define-fun dynamic_invariant10 ((temp___expr_464 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool) (temp___do_typ_inv_463 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 4294967295)) (in_range19 temp___expr_464)))
(define-fun dynamic_invariant11 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 0 128)) (in_range20 temp___expr_471)))
(define-fun dynamic_invariant12 ((temp___expr_1275 Int) (temp___is_init_1271 Bool) (temp___skip_constant_1272 Bool) (temp___do_toplevel_1273 Bool) (temp___do_typ_inv_1274 Bool)) Bool (=> (or (= temp___is_init_1271 true) (<= 0 17)) (in_range11 temp___expr_1275)))
(define-fun dynamic_invariant13 ((temp___expr_1282 Int) (temp___is_init_1278 Bool) (temp___skip_constant_1279 Bool) (temp___do_toplevel_1280 Bool) (temp___do_typ_inv_1281 Bool)) Bool (=> (or (= temp___is_init_1278 true) (<= 1 17)) (in_range9 temp___expr_1282)))
(define-fun dynamic_invariant14 ((temp___expr_1408 Int) (temp___is_init_1404 Bool) (temp___skip_constant_1405 Bool) (temp___do_toplevel_1406 Bool) (temp___do_typ_inv_1407 Bool)) Bool (=> (or (= temp___is_init_1404 true) (<= 0 2)) (in_range13 temp___expr_1408)))
(define-fun dynamic_invariant15 ((temp___expr_1289 Int) (temp___is_init_1285 Bool) (temp___skip_constant_1286 Bool) (temp___do_toplevel_1287 Bool) (temp___do_typ_inv_1288 Bool)) Bool (=> (or (= temp___is_init_1285 true) (<= 0 17408)) (in_range10 temp___expr_1289)))
(define-fun dynamic_invariant16 ((temp___expr_1320 Int) (temp___is_init_1316 Bool) (temp___skip_constant_1317 Bool) (temp___do_toplevel_1318 Bool) (temp___do_typ_inv_1319 Bool)) Bool (=> (or (= temp___is_init_1316 true) (<= 0 1024)) (in_range12 temp___expr_1320)))
(assert true)
...
(assert (forall ((temp___1349 Int)) (=> (dynamic_invariant16 temp___1349 true true true true) (forall ((temp___1350 Int)) (= (to_rep8 (select (temp___1347 temp___1349) temp___1350)) temp___1349)))))
...
(define-fun dynamic_invariant17 ((temp___expr_670 Int) (temp___is_init_666 Bool) (temp___skip_constant_667 Bool) (temp___do_toplevel_668 Bool) (temp___do_typ_inv_669 Bool)) Bool (=> (or (= temp___is_init_666 true) (<= 1901 2099)) (in_range15 temp___expr_670)))
(define-fun dynamic_invariant18 ((temp___expr_677 Int) (temp___is_init_673 Bool) (temp___skip_constant_674 Bool) (temp___do_toplevel_675 Bool) (temp___do_typ_inv_676 Bool)) Bool (=> (or (= temp___is_init_673 true) (<= 1 12)) (in_range16 temp___expr_677)))
(define-fun dynamic_invariant19 ((temp___expr_684 Int) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool) (temp___do_typ_inv_683 Bool)) Bool (=> (or (= temp___is_init_680 true) (<= 1 31)) (in_range17 temp___expr_684)))
(define-fun dynamic_invariant20 ((temp___expr_716 Int) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool) (temp___do_typ_inv_715 Bool)) Bool (=> (or (= temp___is_init_712 true) (<= 0 86399999)) (in_range18 temp___expr_716)))
(define-fun dynamic_invariant21 ((temp___expr_553 Int) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool) (temp___do_typ_inv_552 Bool)) Bool (=> (or (= temp___is_init_549 true) (<= 0 4294967295)) (in_range4 temp___expr_553)))
(assert (forall ((temp___1345 Int)) (=> (dynamic_invariant13 temp___1345 true true true true) (forall ((temp___1346 Int)) (= (to_rep5 (select (temp___1343 temp___1345) temp___1346)) temp___1345)))))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= o7 (to_rep2 o6)))))
...
(assert (=> (not (= certfound true)) (= logfilestate__split_fields8 (mk___split_fields3 logfilestate__split_fields logfilestate__split_fields1 (mk___rep2 (mk___split_fields2 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))))
