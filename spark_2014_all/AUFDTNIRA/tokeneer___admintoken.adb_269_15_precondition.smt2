...
(define-fun dynamic_invariant ((temp___expr_477 Int) (temp___is_init_474 Bool) (temp___skip_constant_475 Bool) (temp___do_toplevel_476 Bool)) Bool (=> (or (= temp___is_init_474 true) (<= 0 4294967295)) (in_range7 temp___expr_477)))
...
(define-fun dynamic_invariant1 ((temp___expr_489 Int) (temp___is_init_486 Bool) (temp___skip_constant_487 Bool) (temp___do_toplevel_488 Bool)) Bool (=> (or (= temp___is_init_486 true) (<= 0 1)) (in_range8 temp___expr_489)))
...
(assert (forall ((temp___1139 Int)) (forall ((temp___1140 Int)) (= (select (temp___1137 temp___1139) temp___1140) (of_rep5 temp___1139)))))
(declare-fun temp___1141 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1143 Int)) (forall ((temp___1144 Int)) (= (select (temp___1141 temp___1143) temp___1144) (of_rep8 temp___1143)))))
(define-fun dynamic_invariant2 ((temp___expr_1131 us_rep3) (temp___is_init_1128 Bool) (temp___skip_constant_1129 Bool) (temp___do_toplevel_1130 Bool)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1131))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1131))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1131)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1131))) true))
(define-fun default_initial_assumption ((temp___expr_1135 us_rep3) (temp___skip_top_level_1136 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1135))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1135))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1135)) (mk___rep2 (mk___split_fields2 (temp___1137 1) (of_rep5 1) (of_rep5 1) (of_rep7 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1135)) (temp___1141 0))))
(define-fun type_invariant ((temp___1145 us_rep3)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1145))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1145))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1145)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1145))) true))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1902 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 20)) 86)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 22)) 114)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 24)) 102)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 26)) 97)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 27)) 98)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 28)) 108)) (= (to_rep (select (temp___String_Literal_1902 us_void_param) 29)) 101)) :pattern ((temp___String_Literal_1902 us_void_param)))))
(declare-fun temp___String_Literal_1903 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1903 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 16)) 66)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_1903 us_void_param) 18)) 100)) :pattern ((temp___String_Literal_1903 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 40)) (in_range5 temp___expr_319)))
(define-fun dynamic_invariant8 ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 0 4294967295)) (in_range6 temp___expr_340)))
(define-fun dynamic_invariant9 ((temp___expr_362 Int) (temp___is_init_359 Bool) (temp___skip_constant_360 Bool) (temp___do_toplevel_361 Bool)) Bool (=> (or (= temp___is_init_359 true) (<= 0 10)) (in_range14 temp___expr_362)))
(define-fun dynamic_invariant10 ((temp___expr_374 Int) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool)) Bool (=> (or (= temp___is_init_371 true) (<= 0 4294967295)) (in_range19 temp___expr_374)))
(define-fun dynamic_invariant11 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 128)) (in_range20 temp___expr_380)))
(define-fun dynamic_invariant12 ((temp___expr_1097 Int) (temp___is_init_1094 Bool) (temp___skip_constant_1095 Bool) (temp___do_toplevel_1096 Bool)) Bool (=> (or (= temp___is_init_1094 true) (<= 0 17)) (in_range11 temp___expr_1097)))
(define-fun dynamic_invariant13 ((temp___expr_1076 Int) (temp___is_init_1073 Bool) (temp___skip_constant_1074 Bool) (temp___do_toplevel_1075 Bool)) Bool (=> (or (= temp___is_init_1073 true) (<= 1 17)) (in_range9 temp___expr_1076)))
(define-fun dynamic_invariant14 ((temp___expr_1201 Int) (temp___is_init_1198 Bool) (temp___skip_constant_1199 Bool) (temp___do_toplevel_1200 Bool)) Bool (=> (or (= temp___is_init_1198 true) (<= 0 2)) (in_range13 temp___expr_1201)))
(define-fun dynamic_invariant15 ((temp___expr_1082 Int) (temp___is_init_1079 Bool) (temp___skip_constant_1080 Bool) (temp___do_toplevel_1081 Bool)) Bool (=> (or (= temp___is_init_1079 true) (<= 0 17408)) (in_range10 temp___expr_1082)))
(define-fun dynamic_invariant16 ((temp___expr_1116 Int) (temp___is_init_1113 Bool) (temp___skip_constant_1114 Bool) (temp___do_toplevel_1115 Bool)) Bool (=> (or (= temp___is_init_1113 true) (<= 0 1024)) (in_range12 temp___expr_1116)))
(assert true)
...
(define-fun dynamic_invariant17 ((temp___expr_553 Int) (temp___is_init_550 Bool) (temp___skip_constant_551 Bool) (temp___do_toplevel_552 Bool)) Bool (=> (or (= temp___is_init_550 true) (<= 1901 2099)) (in_range15 temp___expr_553)))
(define-fun dynamic_invariant18 ((temp___expr_559 Int) (temp___is_init_556 Bool) (temp___skip_constant_557 Bool) (temp___do_toplevel_558 Bool)) Bool (=> (or (= temp___is_init_556 true) (<= 1 12)) (in_range16 temp___expr_559)))
(define-fun dynamic_invariant19 ((temp___expr_565 Int) (temp___is_init_562 Bool) (temp___skip_constant_563 Bool) (temp___do_toplevel_564 Bool)) Bool (=> (or (= temp___is_init_562 true) (<= 1 31)) (in_range17 temp___expr_565)))
(define-fun dynamic_invariant20 ((temp___expr_589 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 0 86399999)) (in_range18 temp___expr_589)))
(define-fun dynamic_invariant21 ((temp___expr_453 Int) (temp___is_init_450 Bool) (temp___skip_constant_451 Bool) (temp___do_toplevel_452 Bool)) Bool (=> (or (= temp___is_init_450 true) (<= 0 4294967295)) (in_range4 temp___expr_453)))
