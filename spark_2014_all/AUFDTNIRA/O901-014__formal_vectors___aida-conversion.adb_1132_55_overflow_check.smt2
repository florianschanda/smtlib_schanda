...
(assert (and (= temp___1789 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1789) (<= temp___1789 (to_rep1 (last (rt source))))))
(assert (= o143 temp___1789))
(assert (= o144 (select (elts source) o143)))
(assert (= o145 (to_rep o144)))
(assert (and (= o146 (convert_character_digit_to_integer o145)) (and (in_range1 o146) (and (and (<= 0 o146) (<= o146 9)) (ite (= (= o145 48) true) (= o146 0) (ite (= (= o145 49) true) (= o146 1) (ite (= (= o145 50) true) (= o146 2) (ite (= (= o145 51) true) (= o146 3) (ite (= (= o145 52) true) (= o146 4) (ite (= (= o145 53) true) (= o146 5) (ite (= (= o145 54) true) (= o146 6) (ite (= (= o145 55) true) (= o146 7) (ite (= (= o145 56) true) (= o146 8) (=> (= (= o145 57) true) (= o146 9)))))))))))))))
(assert (= o147 (* o146 1)))
(assert (and (= o148 o147) (in_range1 o147)))
(assert (and (= temp___1788 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1788) (<= temp___1788 (to_rep1 (last (rt source))))))
(assert (= o135 temp___1788))
(assert (= o136 (select (elts source) o135)))
(assert (= o137 (to_rep o136)))
(assert (and (= o138 (convert_character_digit_to_integer o137)) (and (in_range1 o138) (and (and (<= 0 o138) (<= o138 9)) (ite (= (= o137 48) true) (= o138 0) (ite (= (= o137 49) true) (= o138 1) (ite (= (= o137 50) true) (= o138 2) (ite (= (= o137 51) true) (= o138 3) (ite (= (= o137 52) true) (= o138 4) (ite (= (= o137 53) true) (= o138 5) (ite (= (= o137 54) true) (= o138 6) (ite (= (= o137 55) true) (= o138 7) (ite (= (= o137 56) true) (= o138 8) (=> (= (= o137 57) true) (= o138 9)))))))))))))))
(assert (= o139 (* o138 10)))
(assert (and (= o140 o139) (in_range1 o139)))
(assert (and (= temp___1787 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1787) (<= temp___1787 (to_rep1 (last (rt source))))))
(assert (= o127 temp___1787))
...
(assert (= o131 (* o130 100)))
(assert (and (= o132 o131) (in_range1 o131)))
(assert (and (= temp___1786 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1786) (<= temp___1786 (to_rep1 (last (rt source))))))
(assert (= o119 temp___1786))
