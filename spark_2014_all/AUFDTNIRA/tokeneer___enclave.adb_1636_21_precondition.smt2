...
(assert (forall ((x logfileindext)) (! (in_range11 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range12 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range13 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x fileentrycountt)) (! (in_range14 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x filestatust)) (! (in_range15 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(define-fun dynamic_invariant4 ((temp___expr_1524 Int) (temp___is_init_1520 Bool) (temp___skip_constant_1521 Bool) (temp___do_toplevel_1522 Bool) (temp___do_typ_inv_1523 Bool)) Bool (=> (or (= temp___is_init_1520 true) (<= 0 4294967295)) (in_range16 temp___expr_1524)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant5 ((temp___expr_1531 Int) (temp___is_init_1527 Bool) (temp___skip_constant_1528 Bool) (temp___do_toplevel_1529 Bool) (temp___do_typ_inv_1530 Bool)) Bool (=> (or (= temp___is_init_1527 true) (<= 0 2)) (in_range17 temp___expr_1531)))
...
(assert (forall ((x classt)) (! (in_range18 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(assert (forall ((x yearst)) (! (in_range19 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(assert (forall ((x monthst)) (! (in_range20 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(assert (forall ((x dayst)) (! (in_range21 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(assert (forall ((x millisecst)) (! (in_range22 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun dynamic_invariant6 ((temp___expr_2874 Int) (temp___is_init_2870 Bool) (temp___skip_constant_2871 Bool) (temp___do_toplevel_2872 Bool) (temp___do_typ_inv_2873 Bool)) Bool (=> (or (= temp___is_init_2870 true) (<= 0 8)) (in_range29 temp___expr_2874)))
...
(declare-fun user_eq46 (enrolmentstates enrolmentstates) Bool)
(declare-const dummy46 enrolmentstates)
...
(assert true)
(assert (forall ((enclave__status Int)) (! (= (= (enrolmentisinprogress enclave__status) true) (in_range30 enclave__status)) :pattern ((enrolmentisinprogress enclave__status)))))
(declare-const attr__ATTRIBUTE_ADDRESS12 Int)
(declare-fun presentadminhasdeparted (us_rep Int us_private Int Int us_split_fields16 us_split_fields22) Bool)
(declare-fun presentadminhasdeparted__function_guard (Bool us_rep Int us_private Int Int us_split_fields16 us_split_fields22) Bool)
(assert true)
...
(define-fun dynamic_invariant11 ((temp___expr_2961 Int) (temp___is_init_2957 Bool) (temp___skip_constant_2958 Bool) (temp___do_toplevel_2959 Bool) (temp___do_typ_inv_2960 Bool)) Bool (=> (or (= temp___is_init_2957 true) (<= 0 2)) (in_range30 temp___expr_2961)))
...
(define-fun dynamic_invariant15 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range18 temp___expr_440)))
(define-fun dynamic_invariant16 ((temp___expr_1099 Int) (temp___is_init_1095 Bool) (temp___skip_constant_1096 Bool) (temp___do_toplevel_1097 Bool) (temp___do_typ_inv_1098 Bool)) Bool (=> (or (= temp___is_init_1095 true) (<= 0 40)) (in_range24 temp___expr_1099)))
(define-fun dynamic_invariant17 ((temp___expr_1123 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool) (temp___do_typ_inv_1122 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 4294967295)) (in_range25 temp___expr_1123)))
(define-fun dynamic_invariant18 ((temp___expr_1147 Int) (temp___is_init_1143 Bool) (temp___skip_constant_1144 Bool) (temp___do_toplevel_1145 Bool) (temp___do_typ_inv_1146 Bool)) Bool (=> (or (= temp___is_init_1143 true) (<= 0 10)) (in_range23 temp___expr_1147)))
(define-fun dynamic_invariant19 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 4294967295)) (in_range27 temp___expr_1161)))
(define-fun dynamic_invariant20 ((temp___expr_1168 Int) (temp___is_init_1164 Bool) (temp___skip_constant_1165 Bool) (temp___do_toplevel_1166 Bool) (temp___do_typ_inv_1167 Bool)) Bool (=> (or (= temp___is_init_1164 true) (<= 0 128)) (in_range28 temp___expr_1168)))
...
(assert (forall ((temp___1357 Int)) (=> (dynamic_invariant25 temp___1357 true true true true) (forall ((temp___1358 Int)) (= (to_rep7 (select (temp___1355 temp___1357) temp___1358)) temp___1357)))))
(define-fun dynamic_invariant26 ((temp___expr_573 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool) (temp___do_typ_inv_572 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 150)) (in_range10 temp___expr_573)))
...
(define-fun dynamic_invariant27 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range19 temp___expr_625)))
(define-fun dynamic_invariant28 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range20 temp___expr_632)))
(define-fun dynamic_invariant29 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range21 temp___expr_639)))
(define-fun dynamic_invariant30 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range22 temp___expr_671)))
...
(assert (forall ((temp___1353 Int)) (=> (dynamic_invariant22 temp___1353 true true true true) (forall ((temp___1354 Int)) (= (to_rep4 (select (temp___1351 temp___1353) temp___1354)) temp___1353)))))
...
(assert (= result (presentadminhasdeparted (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)) tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))))
(assert (= result true))
(assert (= status 3))
