...
(define-fun dynamic_invariant4 ((temp___expr_1305 Int) (temp___is_init_1302 Bool) (temp___skip_constant_1303 Bool) (temp___do_toplevel_1304 Bool)) Bool (=> (or (= temp___is_init_1302 true) (<= 0 4294967295)) (in_range16 temp___expr_1305)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant5 ((temp___expr_1311 Int) (temp___is_init_1308 Bool) (temp___skip_constant_1309 Bool) (temp___do_toplevel_1310 Bool)) Bool (=> (or (= temp___is_init_1308 true) (<= 0 2)) (in_range17 temp___expr_1311)))
...
(define-fun dynamic_invariant6 ((temp___expr_2612 Int) (temp___is_init_2609 Bool) (temp___skip_constant_2610 Bool) (temp___do_toplevel_2611 Bool)) Bool (=> (or (= temp___is_init_2609 true) (<= 0 8)) (in_range29 temp___expr_2612)))
...
(define-fun dynamic_invariant11 ((temp___expr_2698 Int) (temp___is_init_2695 Bool) (temp___skip_constant_2696 Bool) (temp___do_toplevel_2697 Bool)) Bool (=> (or (= temp___is_init_2695 true) (<= 0 2)) (in_range30 temp___expr_2698)))
...
(define-fun dynamic_invariant15 ((temp___expr_206 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 5)) (in_range18 temp___expr_206)))
(define-fun dynamic_invariant16 ((temp___expr_924 Int) (temp___is_init_921 Bool) (temp___skip_constant_922 Bool) (temp___do_toplevel_923 Bool)) Bool (=> (or (= temp___is_init_921 true) (<= 0 40)) (in_range24 temp___expr_924)))
(define-fun dynamic_invariant17 ((temp___expr_945 Int) (temp___is_init_942 Bool) (temp___skip_constant_943 Bool) (temp___do_toplevel_944 Bool)) Bool (=> (or (= temp___is_init_942 true) (<= 0 4294967295)) (in_range25 temp___expr_945)))
(define-fun dynamic_invariant18 ((temp___expr_967 Int) (temp___is_init_964 Bool) (temp___skip_constant_965 Bool) (temp___do_toplevel_966 Bool)) Bool (=> (or (= temp___is_init_964 true) (<= 0 10)) (in_range23 temp___expr_967)))
(define-fun dynamic_invariant19 ((temp___expr_979 Int) (temp___is_init_976 Bool) (temp___skip_constant_977 Bool) (temp___do_toplevel_978 Bool)) Bool (=> (or (= temp___is_init_976 true) (<= 0 4294967295)) (in_range27 temp___expr_979)))
(define-fun dynamic_invariant20 ((temp___expr_985 Int) (temp___is_init_982 Bool) (temp___skip_constant_983 Bool) (temp___do_toplevel_984 Bool)) Bool (=> (or (= temp___is_init_982 true) (<= 0 128)) (in_range28 temp___expr_985)))
...
(define-fun dynamic_invariant26 ((temp___expr_468 Int) (temp___is_init_465 Bool) (temp___skip_constant_466 Bool) (temp___do_toplevel_467 Bool)) Bool (=> (or (= temp___is_init_465 true) (<= 1 150)) (in_range10 temp___expr_468)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant27 ((temp___expr_510 Int) (temp___is_init_507 Bool) (temp___skip_constant_508 Bool) (temp___do_toplevel_509 Bool)) Bool (=> (or (= temp___is_init_507 true) (<= 1901 2099)) (in_range19 temp___expr_510)))
(define-fun dynamic_invariant28 ((temp___expr_516 Int) (temp___is_init_513 Bool) (temp___skip_constant_514 Bool) (temp___do_toplevel_515 Bool)) Bool (=> (or (= temp___is_init_513 true) (<= 1 12)) (in_range20 temp___expr_516)))
(define-fun dynamic_invariant29 ((temp___expr_522 Int) (temp___is_init_519 Bool) (temp___skip_constant_520 Bool) (temp___do_toplevel_521 Bool)) Bool (=> (or (= temp___is_init_519 true) (<= 1 31)) (in_range21 temp___expr_522)))
(define-fun dynamic_invariant30 ((temp___expr_546 Int) (temp___is_init_543 Bool) (temp___skip_constant_544 Bool) (temp___do_toplevel_545 Bool)) Bool (=> (or (= temp___is_init_543 true) (<= 0 86399999)) (in_range22 temp___expr_546)))
