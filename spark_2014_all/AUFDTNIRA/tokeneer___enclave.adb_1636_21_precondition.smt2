...
(define-fun dynamic_invariant4 ((temp___expr_1363 Int) (temp___is_init_1360 Bool) (temp___skip_constant_1361 Bool) (temp___do_toplevel_1362 Bool)) Bool (=> (or (= temp___is_init_1360 true) (<= 0 4294967295)) (in_range16 temp___expr_1363)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant5 ((temp___expr_1369 Int) (temp___is_init_1366 Bool) (temp___skip_constant_1367 Bool) (temp___do_toplevel_1368 Bool)) Bool (=> (or (= temp___is_init_1366 true) (<= 0 2)) (in_range17 temp___expr_1369)))
...
(define-fun dynamic_invariant6 ((temp___expr_2670 Int) (temp___is_init_2667 Bool) (temp___skip_constant_2668 Bool) (temp___do_toplevel_2669 Bool)) Bool (=> (or (= temp___is_init_2667 true) (<= 0 8)) (in_range29 temp___expr_2670)))
(declare-const attr__ATTRIBUTE_ADDRESS11 Int)
(declare-fun getstatus (Int) Int)
(declare-fun getstatus__function_guard (Int Int) Bool)
(assert (forall ((enclave__status Int)) (! (=> (dynamic_invariant6 enclave__status true true true) (dynamic_invariant6 (getstatus enclave__status) true false true)) :pattern ((getstatus enclave__status)))))
(assert (forall ((enclave__status Int)) (! (=> (dynamic_invariant6 enclave__status true true true) (= (getstatus enclave__status) enclave__status)) :pattern ((getstatus enclave__status)))))
...
(define-fun dynamic_invariant11 ((temp___expr_2756 Int) (temp___is_init_2753 Bool) (temp___skip_constant_2754 Bool) (temp___do_toplevel_2755 Bool)) Bool (=> (or (= temp___is_init_2753 true) (<= 0 2)) (in_range30 temp___expr_2756)))
(define-fun dynamic_invariant12 ((temp___expr_445 Int) (temp___is_init_442 Bool) (temp___skip_constant_443 Bool) (temp___do_toplevel_444 Bool)) Bool (=> (or (= temp___is_init_442 true) (<= 0 4)) (in_range6 temp___expr_445)))
(define-fun dynamic_invariant13 ((temp___expr_451 Int) (temp___is_init_448 Bool) (temp___skip_constant_449 Bool) (temp___do_toplevel_450 Bool)) Bool (=> (or (= temp___is_init_448 true) (<= 1 4)) (in_range7 temp___expr_451)))
(define-fun dynamic_invariant14 ((temp___expr_389 Int) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (or (= temp___is_init_386 true) (<= 1 3)) (in_range8 temp___expr_389)))
(define-fun dynamic_invariant15 ((temp___expr_395 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 5)) (in_range18 temp___expr_395)))
(define-fun dynamic_invariant16 ((temp___expr_978 Int) (temp___is_init_975 Bool) (temp___skip_constant_976 Bool) (temp___do_toplevel_977 Bool)) Bool (=> (or (= temp___is_init_975 true) (<= 0 40)) (in_range24 temp___expr_978)))
(define-fun dynamic_invariant17 ((temp___expr_999 Int) (temp___is_init_996 Bool) (temp___skip_constant_997 Bool) (temp___do_toplevel_998 Bool)) Bool (=> (or (= temp___is_init_996 true) (<= 0 4294967295)) (in_range25 temp___expr_999)))
(define-fun dynamic_invariant18 ((temp___expr_1021 Int) (temp___is_init_1018 Bool) (temp___skip_constant_1019 Bool) (temp___do_toplevel_1020 Bool)) Bool (=> (or (= temp___is_init_1018 true) (<= 0 10)) (in_range23 temp___expr_1021)))
(define-fun dynamic_invariant19 ((temp___expr_1033 Int) (temp___is_init_1030 Bool) (temp___skip_constant_1031 Bool) (temp___do_toplevel_1032 Bool)) Bool (=> (or (= temp___is_init_1030 true) (<= 0 4294967295)) (in_range27 temp___expr_1033)))
(define-fun dynamic_invariant20 ((temp___expr_1039 Int) (temp___is_init_1036 Bool) (temp___skip_constant_1037 Bool) (temp___do_toplevel_1038 Bool)) Bool (=> (or (= temp___is_init_1036 true) (<= 0 128)) (in_range28 temp___expr_1039)))
...
(define-fun dynamic_invariant26 ((temp___expr_514 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 1 150)) (in_range10 temp___expr_514)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant27 ((temp___expr_560 Int) (temp___is_init_557 Bool) (temp___skip_constant_558 Bool) (temp___do_toplevel_559 Bool)) Bool (=> (or (= temp___is_init_557 true) (<= 1901 2099)) (in_range19 temp___expr_560)))
(define-fun dynamic_invariant28 ((temp___expr_566 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 1 12)) (in_range20 temp___expr_566)))
(define-fun dynamic_invariant29 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 31)) (in_range21 temp___expr_572)))
(define-fun dynamic_invariant30 ((temp___expr_600 Int) (temp___is_init_597 Bool) (temp___skip_constant_598 Bool) (temp___do_toplevel_599 Bool)) Bool (=> (or (= temp___is_init_597 true) (<= 0 86399999)) (in_range22 temp___expr_600)))
(define-fun dynamic_invariant31 ((temp___expr_1433 Int) (temp___is_init_1430 Bool) (temp___skip_constant_1431 Bool) (temp___do_toplevel_1432 Bool)) Bool (=> (or (= temp___is_init_1430 true) (<= 0 4294967295)) (in_range26 temp___expr_1433)))
...
(declare-const logfilestate__split_fields21 us_split_fields4)
...
(declare-const authcert__split_fields3 us_split_fields16)
...
(declare-const logfilestate__split_fields22 us_split_fields4)
...
(declare-const logfilestate__split_fields23 us_split_fields__ref2)
...
(declare-const authcert__split_fields4 us_split_fields__ref8)
(declare-const idcert__split_fields4 us_split_fields__ref11)
...
(declare-const logfilestate__split_fields24 us_split_fields4)
...
(declare-const authcert__split_fields5 us_split_fields16)
(declare-const idcert__split_fields5 us_split_fields22)
...
(assert (= result (presentadminhasdeparted (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)) tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))))
(assert (= result true))
(assert (= status 3))
(assert (= o (extractuser tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))))
