...
(assert (and (= (length source) 7) (forall ((index7 Int)) (=> (and (<= (to_rep1 (first (rt source))) index7) (<= index7 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index7))) true)))))
...
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= (mk_int__ref index5) (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= (mk_map__ref1 n6) (mk_map__ref1 n4))))
...
(assert (not (<= (to_rep1 n__first) temp___1741)))
(check-sat)
(exit)
