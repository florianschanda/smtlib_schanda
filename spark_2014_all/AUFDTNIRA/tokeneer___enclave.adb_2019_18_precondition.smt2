...
(assert (=> (= result16 true) (and (= o36 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range4 o36))))
(assert (=> (= result16 true) (= result15 (ite (= o36 3) true false))))
(assert (=> (not (= result16 true)) (= result15 false)))
(assert (=> (= result15 true) (and (= o37 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o37) (= o37 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result15 true) (= o38 (ite (= o37 1) true false))))
(assert (=> (not (= result15 true)) (= o38 (of_int 1))))
(assert (and (= o29 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o29) (= o29 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result17 (ite (= o29 1) true false)))
(assert (=> (= result17 true) (and (= o32 (theauthcertrole tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range2 o32) (= o32 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields))))))))
(assert (=> (= result17 true) (= o33 (ite (= o32 1) true false))))
(assert (=> (= result17 true) (and (= o30 (authcertvalid tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o30 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields)) true)))))
(assert (=> (= result17 true) (and (= o31 (isgood tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o31 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields)) true)))))
(assert (=> (= result17 true) (= o34 (ite (= o31 true) o30 false))))
(assert (=> (= result17 true) (= o35 (ite (= o34 true) o33 false))))
(assert (=> (not (= result17 true)) (= o35 (of_int 1))))
(assert (and (= result18 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result18 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
