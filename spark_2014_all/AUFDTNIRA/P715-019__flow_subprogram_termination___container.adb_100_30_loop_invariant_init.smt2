...
(define-fun o19 () us_rep1 (mk___rep1 (mk___split_fields1 o7)))
...
(assert (= x18 x16))
(assert (= x19 x17))
(assert (and (= o19 (first (mk___rep my_container__split_fields1))) (= (of_rep 1) o7)))
(assert (= temp___641 (mk_cursor__ref o19)))
