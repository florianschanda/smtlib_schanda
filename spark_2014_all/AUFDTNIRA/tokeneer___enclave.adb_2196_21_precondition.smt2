...
(define-fun dynamic_invariant1 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 4)) (in_range7 temp___expr_496)))
(declare-sort opt 0)
...
(define-fun dynamic_invariant2 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 3)) (in_range9 temp___expr_426)))
(assert (forall ((theadmin us_rep1)) (! (dynamic_invariant2 (rolepresent theadmin) true false true true) :pattern ((rolepresent theadmin)))))
...
(define-fun dynamic_invariant3 ((temp___expr_503 Int) (temp___is_init_499 Bool) (temp___skip_constant_500 Bool) (temp___do_toplevel_501 Bool) (temp___do_typ_inv_502 Bool)) Bool (=> (or (= temp___is_init_499 true) (<= 1 4)) (in_range8 temp___expr_503)))
(assert (forall ((theadmin us_rep1)) (! (=> (= (isdoingop theadmin) true) (dynamic_invariant3 (thecurrentop theadmin) true false true true)) :pattern ((thecurrentop theadmin)))))
...
(assert (forall ((theadmin us_rep1)) (forall ((keyedop us_rep)) (! (=> (= (ispresent theadmin) true) (let ((result (opisavailable theadmin keyedop))) (and (= (and (or (ite (exists ((op Int)) (and (and (<= 1 op) (<= op 4)) (and (and (= (str_comp keyedop op) true) (= (allowedop theadmin op) true)) (= result op)))) true false) (= result 0)) (not (and (ite (exists ((op Int)) (and (and (<= 1 op) (<= op 4)) (and (and (= (str_comp keyedop op) true) (= (allowedop theadmin op) true)) (= result op)))) true false) (= result 0)))) true) (dynamic_invariant1 result true false true true)))) :pattern ((opisavailable theadmin keyedop))))))
...
(define-fun dynamic_invariant4 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range11 temp___expr_548)))
...
(define-fun dynamic_invariant5 ((temp___expr_1345 us_rep3) (temp___is_init_1341 Bool) (temp___skip_constant_1342 Bool) (temp___do_toplevel_1343 Bool) (temp___do_typ_inv_1344 Bool)) Bool (=> (= temp___do_typ_inv_1344 true) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1345))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1345))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1345)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1345))) true)))
(define-fun default_initial_assumption ((temp___expr_1349 us_rep3) (temp___skip_top_level_1350 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1349))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1349))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1349)) (mk___rep2 (mk___split_fields2 (temp___1351 1) (of_rep5 1) (of_rep5 1) (of_rep7 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1349)) (temp___1355 0))))
(define-fun type_invariant ((temp___1359 us_rep3)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1359))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1359))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1359)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1359))) true))
...
(define-fun dynamic_invariant6 ((temp___expr_1524 Int) (temp___is_init_1520 Bool) (temp___skip_constant_1521 Bool) (temp___do_toplevel_1522 Bool) (temp___do_typ_inv_1523 Bool)) Bool (=> (or (= temp___is_init_1520 true) (<= 0 4294967295)) (in_range17 temp___expr_1524)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant7 ((temp___expr_1531 Int) (temp___is_init_1527 Bool) (temp___skip_constant_1528 Bool) (temp___do_toplevel_1529 Bool) (temp___do_typ_inv_1530 Bool)) Bool (=> (or (= temp___is_init_1527 true) (<= 0 2)) (in_range18 temp___expr_1531)))
...
(define-fun dynamic_invariant8 ((temp___expr_2874 Int) (temp___is_init_2870 Bool) (temp___skip_constant_2871 Bool) (temp___do_toplevel_2872 Bool) (temp___do_typ_inv_2873 Bool)) Bool (=> (or (= temp___is_init_2870 true) (<= 0 8)) (in_range30 temp___expr_2874)))
...
(declare-fun temp___162 (Bool Bool) (Array Int Bool))
(declare-fun temp___167 (Bool Bool) (Array Int Bool))
(declare-fun temp___172 (Bool Bool Bool) (Array Int Bool))
(assert (= isavailable (admin__isavailable__aggregate_def (temp___162 (distinct 1 0) (distinct 0 0)) (temp___167 (distinct 1 0) (distinct 0 0)) (temp___172 (distinct 1 0) (distinct 1 0) (distinct 0 0)))))
...
(assert (forall ((temp___164 Bool) (temp___165 Bool)) (let ((temp___163 (temp___162 temp___164 temp___165))) (forall ((temp___166 Int)) (ite (= temp___166 3) (= (select temp___163 temp___166) temp___164) (= (select temp___163 temp___166) temp___165))))))
(assert (forall ((temp___169 Bool) (temp___170 Bool)) (let ((temp___168 (temp___167 temp___169 temp___170))) (forall ((temp___171 Int)) (ite (= temp___171 1) (= (select temp___168 temp___171) temp___169) (= (select temp___168 temp___171) temp___170))))))
(assert (forall ((temp___174 Bool) (temp___175 Bool) (temp___176 Bool)) (let ((temp___173 (temp___172 temp___174 temp___175 temp___176))) (forall ((temp___177 Int)) (ite (= temp___177 4) (= (select temp___173 temp___177) temp___175) (ite (= temp___177 2) (= (select temp___173 temp___177) temp___174) (= (select temp___173 temp___177) temp___176)))))))
(define-fun dynamic_invariant13 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range10 temp___expr_433)))
(define-fun dynamic_invariant14 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range19 temp___expr_440)))
(define-fun dynamic_invariant15 ((temp___expr_459 Int) (temp___is_init_455 Bool) (temp___skip_constant_456 Bool) (temp___do_toplevel_457 Bool) (temp___do_typ_inv_458 Bool)) Bool (=> (or (= temp___is_init_455 true) (<= 0 78)) (in_range6 temp___expr_459)))
(define-fun dynamic_invariant16 ((temp___expr_466 Int) (temp___is_init_462 Bool) (temp___skip_constant_463 Bool) (temp___do_toplevel_464 Bool) (temp___do_typ_inv_465 Bool)) Bool (=> (or (= temp___is_init_462 true) (<= 1 78)) (in_range5 temp___expr_466)))
(assert true)
(define-fun dynamic_invariant17 ((temp___expr_1099 Int) (temp___is_init_1095 Bool) (temp___skip_constant_1096 Bool) (temp___do_toplevel_1097 Bool) (temp___do_typ_inv_1098 Bool)) Bool (=> (or (= temp___is_init_1095 true) (<= 0 40)) (in_range25 temp___expr_1099)))
(define-fun dynamic_invariant18 ((temp___expr_1123 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool) (temp___do_typ_inv_1122 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 4294967295)) (in_range26 temp___expr_1123)))
(define-fun dynamic_invariant19 ((temp___expr_1147 Int) (temp___is_init_1143 Bool) (temp___skip_constant_1144 Bool) (temp___do_toplevel_1145 Bool) (temp___do_typ_inv_1146 Bool)) Bool (=> (or (= temp___is_init_1143 true) (<= 0 10)) (in_range24 temp___expr_1147)))
(define-fun dynamic_invariant20 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 4294967295)) (in_range28 temp___expr_1161)))
(define-fun dynamic_invariant21 ((temp___expr_1168 Int) (temp___is_init_1164 Bool) (temp___skip_constant_1165 Bool) (temp___do_toplevel_1166 Bool) (temp___do_typ_inv_1167 Bool)) Bool (=> (or (= temp___is_init_1164 true) (<= 0 128)) (in_range29 temp___expr_1168)))
(define-fun dynamic_invariant22 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 0 17)) (in_range14 temp___expr_1283)))
(define-fun dynamic_invariant23 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 1 17)) (in_range12 temp___expr_1290)))
(define-fun dynamic_invariant24 ((temp___expr_1416 Int) (temp___is_init_1412 Bool) (temp___skip_constant_1413 Bool) (temp___do_toplevel_1414 Bool) (temp___do_typ_inv_1415 Bool)) Bool (=> (or (= temp___is_init_1412 true) (<= 0 2)) (in_range16 temp___expr_1416)))
(define-fun dynamic_invariant25 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 17408)) (in_range13 temp___expr_1297)))
(define-fun dynamic_invariant26 ((temp___expr_1328 Int) (temp___is_init_1324 Bool) (temp___skip_constant_1325 Bool) (temp___do_toplevel_1326 Bool) (temp___do_typ_inv_1327 Bool)) Bool (=> (or (= temp___is_init_1324 true) (<= 0 1024)) (in_range15 temp___expr_1328)))
(assert true)
...
(assert (forall ((temp___1357 Int)) (=> (dynamic_invariant26 temp___1357 true true true true) (forall ((temp___1358 Int)) (= (to_rep8 (select (temp___1355 temp___1357) temp___1358)) temp___1357)))))
(define-fun dynamic_invariant27 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range20 temp___expr_625)))
(define-fun dynamic_invariant28 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range21 temp___expr_632)))
(define-fun dynamic_invariant29 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range22 temp___expr_639)))
(define-fun dynamic_invariant30 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range23 temp___expr_671)))
(define-fun dynamic_invariant31 ((temp___expr_1603 Int) (temp___is_init_1599 Bool) (temp___skip_constant_1600 Bool) (temp___do_toplevel_1601 Bool) (temp___do_typ_inv_1602 Bool)) Bool (=> (or (= temp___is_init_1599 true) (<= 0 4294967295)) (in_range27 temp___expr_1603)))
(assert (forall ((contents us_rep9)) (! (dynamic_invariant2 (therole contents) true false true true) :pattern ((therole contents)))))
...
(assert (forall ((temp___1353 Int)) (=> (dynamic_invariant23 temp___1353 true true true true) (forall ((temp___1354 Int)) (= (to_rep5 (select (temp___1351 temp___1353) temp___1354)) temp___1353)))))
...
(assert (and (and (and (and (and (and (= (adminopcanstart status (mk___split_fields1 theadmin__split_fields theadmin__split_fields1) tokenpresence state tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) true) (= status 3)) (= (ispresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1))) true)) (not (= (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1))) true))) (=> (= (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1))) 1) (and (and (= (isgood tokenpresence state tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) true) (= (authcertvalid tokenpresence state tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence state tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) 1)))) (=> (and (= (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1))) 3)) (= (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1))) 1))) (=> (= (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1))) 1) (or (and (= (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1))) 3)) (not (= (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1))) true))))))
