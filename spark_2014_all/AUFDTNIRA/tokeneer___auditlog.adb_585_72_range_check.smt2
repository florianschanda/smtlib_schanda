...
(assert (and (= result (valid_numberlogentries__2 (mk___rep1 (mk___split_fields1 logfilestate__split_fields logfilestate__split_fields1 (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6)))) (= (= result true) (= (valid_numberlogentries (to_rep logfilestate__split_fields) (to_rep1 logfilestate__split_fields1) (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6) true))))
(assert (= result true))
(assert (< (to_rep1 logfilestate__split_fields1) 17408))
(assert (=> (not (< (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024)) (< (to_rep2 logfilestate__split_fields5) 17)))
(assert (not (in_range2 (- (to_rep2 logfilestate__split_fields5) 1))))
(check-sat)
(exit)
