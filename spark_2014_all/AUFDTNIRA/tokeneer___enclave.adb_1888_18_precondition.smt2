...
(declare-fun user_eq14 (logfilecountt logfilecountt) Bool)
(declare-const dummy14 logfilecountt)
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep9 (select a temp___idx_196)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_1345 us_rep3) (temp___is_init_1341 Bool) (temp___skip_constant_1342 Bool) (temp___do_toplevel_1343 Bool) (temp___do_typ_inv_1344 Bool)) Bool (=> (= temp___do_typ_inv_1344 true) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1345))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1345))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1345)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1345))) true)))
(define-fun default_initial_assumption ((temp___expr_1349 us_rep3) (temp___skip_top_level_1350 Bool)) Bool (and (and (and (= (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1349))) 1) (= (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1349))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1349)) (mk___rep2 (mk___split_fields2 (temp___1351 1) (of_rep6 1) (of_rep6 1) (of_rep8 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1349)) (temp___1355 0))))
(define-fun type_invariant ((temp___1359 us_rep3)) Bool (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1359))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1359))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1359)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1359))) true))
...
(define-fun bool_eq7 ((a (Array Int us_rep4)) (a__first Int) (a__last Int) (b (Array Int us_rep4)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq6 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true)))) true false))
...
(define-fun bool_eq8 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_198 Int)) (=> (and (<= a__first temp___idx_198) (<= temp___idx_198 a__last)) (= (to_rep10 (select a temp___idx_198)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_198))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_198 Int)) (=> (and (<= a__first temp___idx_198) (<= temp___idx_198 a__last)) (= (to_rep10 (select a temp___idx_198)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_198)))))))))))
...
(declare-fun user_eq22 (tokenidt tokenidt) Bool)
(declare-const dummy22 tokenidt)
...
(define-fun dynamic_invariant5 ((temp___expr_1524 Int) (temp___is_init_1520 Bool) (temp___skip_constant_1521 Bool) (temp___do_toplevel_1522 Bool) (temp___do_typ_inv_1523 Bool)) Bool (=> (or (= temp___is_init_1520 true) (<= 0 4294967295)) (in_range16 temp___expr_1524)))
(declare-sort tryt 0)
...
(declare-fun user_eq23 (tryt tryt) Bool)
(declare-const dummy23 tryt)
...
(define-fun dynamic_invariant6 ((temp___expr_1531 Int) (temp___is_init_1527 Bool) (temp___skip_constant_1528 Bool) (temp___do_toplevel_1529 Bool) (temp___do_typ_inv_1530 Bool)) Bool (=> (or (= temp___is_init_1527 true) (<= 0 2)) (in_range17 temp___expr_1531)))
...
(define-fun bool_eq9 ((a (Array Int character)) (a__first Int) (a__last Int) (b (Array Int character)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep12 (select a temp___idx_91)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_91))))))) true false))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep12 (select a temp___idx_91)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_91)))))))))))
...
(define-fun us_split_fields__ref___6__projection ((a us_split_fields__ref4)) us_split_fields8 (us_split_fields__content4 a))
(declare-datatypes () ((us_rep5 (mk___rep4 (us_split_fields9 us_split_fields8)))))
(define-fun us_rep___7__projection ((a us_rep5)) us_split_fields8 (us_split_fields9 a))
...
(define-fun dynamic_invariant7 ((temp___expr_2160 Int) (temp___is_init_2156 Bool) (temp___skip_constant_2157 Bool) (temp___do_toplevel_2158 Bool) (temp___do_typ_inv_2159 Bool)) Bool (=> (or (= temp___is_init_2156 true) (<= 0 1)) (in_range26 temp___expr_2160)))
...
(define-fun dynamic_invariant8 ((temp___expr_2183 Int) (temp___is_init_2179 Bool) (temp___skip_constant_2180 Bool) (temp___do_toplevel_2181 Bool) (temp___do_typ_inv_2182 Bool)) Bool (=> (or (= temp___is_init_2179 true) (<= 0 1)) (in_range27 temp___expr_2183)))
...
(define-fun in_range28 ((x Int)) Bool (and (<= 0 x) (<= x 8)))
...
(declare-fun user_eq44 (statust1 statust1) Bool)
(declare-const dummy44 statust1)
...
(define-fun dynamic_invariant9 ((temp___expr_2874 Int) (temp___is_init_2870 Bool) (temp___skip_constant_2871 Bool) (temp___do_toplevel_2872 Bool) (temp___do_typ_inv_2873 Bool)) Bool (=> (or (= temp___is_init_2870 true) (<= 0 8)) (in_range28 temp___expr_2874)))
...
(define-fun in_range29 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
...
(declare-fun user_eq45 (enrolmentstates enrolmentstates) Bool)
(declare-const dummy45 enrolmentstates)
...
(assert true)
(assert (forall ((enclave__status Int)) (! (= (= (enrolmentisinprogress enclave__status) true) (in_range29 enclave__status)) :pattern ((enrolmentisinprogress enclave__status)))))
(declare-fun currentadminactivitypossible (Int Int us_private Int Int us_split_fields18 us_split_fields24) Bool)
(declare-fun currentadminactivitypossible__function_guard (Bool Int Int us_private Int Int us_split_fields18 us_split_fields24) Bool)
(declare-fun currentadminactivitypossible1 (Int Int us_private Int Int us_split_fields18 us_split_fields24) Bool)
(declare-fun currentadminactivitypossible__function_guard1 (Bool Int Int us_private Int Int us_split_fields18 us_split_fields24) Bool)
(declare-sort nonquiescentstates 0)
(define-fun in_range30 ((x Int)) Bool (and (<= 4 x) (<= x 8)))
...
(declare-fun user_eq46 (nonquiescentstates nonquiescentstates) Bool)
(declare-const dummy46 nonquiescentstates)
...
(assert true)
(assert (forall ((enclave__status Int) (admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields18)) (forall ((admintoken__idcert__fields us_split_fields24)) (! (=> (and (and (and (dynamic_invariant9 enclave__status true true true true) (dynamic_invariant admintoken__tokenpresence true true true true)) (dynamic_invariant6 admintoken__tokentry true true true true)) (dynamic_invariant5 admintoken__tokenid true true true true)) (=> (= (currentadminactivitypossible1 enclave__status admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (in_range30 enclave__status))) :pattern ((currentadminactivitypossible1 enclave__status admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(declare-const attr__ATTRIBUTE_ADDRESS14 Int)
(define-fun dynamic_invariant10 ((temp___expr_2975 Int) (temp___is_init_2971 Bool) (temp___skip_constant_2972 Bool) (temp___do_toplevel_2973 Bool) (temp___do_typ_inv_2974 Bool)) Bool (=> (or (= temp___is_init_2971 true) (<= 4 8)) (in_range30 temp___expr_2975)))
(declare-const attr__ATTRIBUTE_ADDRESS15 Int)
(declare-const attr__ATTRIBUTE_ADDRESS16 Int)
(define-fun dynamic_invariant11 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range19 temp___expr_74)))
(define-fun dynamic_invariant12 ((temp___expr_2961 Int) (temp___is_init_2957 Bool) (temp___skip_constant_2958 Bool) (temp___do_toplevel_2959 Bool) (temp___do_typ_inv_2960 Bool)) Bool (=> (or (= temp___is_init_2957 true) (<= 0 2)) (in_range29 temp___expr_2961)))
(define-fun dynamic_invariant13 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 4)) (in_range3 temp___expr_496)))
(define-fun dynamic_invariant14 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range5 temp___expr_433)))
(define-fun dynamic_invariant15 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range21 temp___expr_440)))
(define-fun dynamic_invariant16 ((temp___expr_1099 Int) (temp___is_init_1095 Bool) (temp___skip_constant_1096 Bool) (temp___do_toplevel_1097 Bool) (temp___do_typ_inv_1098 Bool)) Bool (=> (or (= temp___is_init_1095 true) (<= 0 40)) (in_range18 temp___expr_1099)))
(define-fun dynamic_invariant17 ((temp___expr_1123 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool) (temp___do_typ_inv_1122 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 4294967295)) (in_range20 temp___expr_1123)))
(define-fun dynamic_invariant18 ((temp___expr_1147 Int) (temp___is_init_1143 Bool) (temp___skip_constant_1144 Bool) (temp___do_toplevel_1145 Bool) (temp___do_typ_inv_1146 Bool)) Bool (=> (or (= temp___is_init_1143 true) (<= 0 10)) (in_range22 temp___expr_1147)))
(define-fun dynamic_invariant19 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 4294967295)) (in_range24 temp___expr_1161)))
(define-fun dynamic_invariant20 ((temp___expr_1168 Int) (temp___is_init_1164 Bool) (temp___skip_constant_1165 Bool) (temp___do_toplevel_1166 Bool) (temp___do_typ_inv_1167 Bool)) Bool (=> (or (= temp___is_init_1164 true) (<= 0 128)) (in_range25 temp___expr_1168)))
(define-fun dynamic_invariant21 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 0 17)) (in_range13 temp___expr_1283)))
(define-fun dynamic_invariant22 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 1 17)) (in_range11 temp___expr_1290)))
(define-fun dynamic_invariant23 ((temp___expr_1416 Int) (temp___is_init_1412 Bool) (temp___skip_constant_1413 Bool) (temp___do_toplevel_1414 Bool) (temp___do_typ_inv_1415 Bool)) Bool (=> (or (= temp___is_init_1412 true) (<= 0 2)) (in_range15 temp___expr_1416)))
(define-fun dynamic_invariant24 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 17408)) (in_range12 temp___expr_1297)))
(define-fun dynamic_invariant25 ((temp___expr_1328 Int) (temp___is_init_1324 Bool) (temp___skip_constant_1325 Bool) (temp___do_toplevel_1326 Bool) (temp___do_typ_inv_1327 Bool)) Bool (=> (or (= temp___is_init_1324 true) (<= 0 1024)) (in_range14 temp___expr_1328)))
(assert true)
...
(assert (forall ((temp___1357 Int)) (=> (dynamic_invariant25 temp___1357 true true true true) (forall ((temp___1358 Int)) (= (to_rep9 (select (temp___1355 temp___1357) temp___1358)) temp___1357)))))
(define-fun dynamic_invariant26 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range7 temp___expr_625)))
(define-fun dynamic_invariant27 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range8 temp___expr_632)))
(define-fun dynamic_invariant28 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range9 temp___expr_639)))
(define-fun dynamic_invariant29 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range10 temp___expr_671)))
(assert true)
...
(define-fun dynamic_invariant30 ((temp___expr_1603 Int) (temp___is_init_1599 Bool) (temp___skip_constant_1600 Bool) (temp___do_toplevel_1601 Bool) (temp___do_typ_inv_1602 Bool)) Bool (=> (or (= temp___is_init_1599 true) (<= 0 4294967295)) (in_range23 temp___expr_1603)))
(assert (forall ((contents us_rep9)) (! (dynamic_invariant1 (therole contents) true false true true) :pattern ((therole contents)))))
...
(assert (forall ((temp___1353 Int)) (=> (dynamic_invariant22 temp___1353 true true true true) (forall ((temp___1354 Int)) (= (to_rep6 (select (temp___1351 temp___1353) temp___1354)) temp___1353)))))
...
(declare-const logfiles5 map__ref2)
(declare-const logfilesstatus5 map__ref3)
...
(declare-const tokenpresence5 int__ref)
(declare-const tokentry5 int__ref)
(declare-const tokenid5 int__ref)
(declare-const authcert__split_fields5 us_split_fields__ref9)
(declare-const idcert__split_fields5 us_split_fields__ref12)
...
(declare-const status8 int__ref)
...
(declare-const status9 us_private__ref)
...
(declare-const logfiles6 (Array Int us_rep4))
...
(declare-const tokenpresence6 Int)
(declare-const tokentry6 Int)
(declare-const tokenid6 Int)
(declare-const authcert__split_fields6 us_split_fields18)
(declare-const idcert__split_fields6 us_split_fields24)
...
(declare-const status11 us_private)
...
(assert (in_range28 (int__content status)))
(assert (in_range1 tokenpresence))
(assert (in_range17 tokentry))
(assert (in_range16 tokenid))
...
(assert (and (and (and (and (and (and (and (and (and (and (and (not (= (enrolmentisinprogress (int__content status)) true)) (= (currentadminactivitypossible1 (int__content status) tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) true)) (= (and (and (= (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) true) (= (thecurrentdoor (us_private__content state4)) 0)) (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime)) (alarm_timeout (us_private__content state4))) true)) (= (thedooralarm (us_private__content state4)) 0))) (=> (or (= (statusisgotadmintoken (int__content status)) true) (= (statusiswaitingremoveadmintokenfail (int__content status)) true)) (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))) (=> (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))) (=> (or (= (statusiswaitingstartadminop (int__content status)) true) (= (statusiswaitingfinishadminop (int__content status)) true)) (and (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))) (=> (= (statusisenclavequiescent (int__content status)) true) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))) (=> (= (statusisshutdown (int__content status)) true) (and (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)) (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 0)))) (=> (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 4)) (= (statusiswaitingstartadminop (int__content status)) true))) (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (and (and (= (isgood tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) true) (= (authcertvalid tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) 1)))) (=> (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)) (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1))) (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (or (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true))))))
(assert (=> (<= 4 8) (in_range30 (int__content localstatus))))
(assert (and (= o (int__content status)) (in_range30 (int__content status))))
(assert (= result localstatus))
(assert (= (let ((subject localstatus)) localstatus1) o))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (and (and (and (and (and (and (or (= (let ((subject status)) status4) 3) (= (let ((subject status)) status4) 4)) (=> (= (let ((subject status)) status4) 4) (not (= (ispresent (mk___rep theadmin__split_fields3)) true)))) (not (= (isdoingop (mk___rep theadmin__split_fields3)) true))) (=> (= (rolepresent (mk___rep theadmin__split_fields3)) 1) (and (and (= (isgood tokenpresence2 (let ((subject state2)) state19) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true) (= (authcertvalid tokenpresence2 (let ((subject state2)) state19) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true)) (= (theauthcertrole tokenpresence2 (let ((subject state2)) state19) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) 1)))) (=> (and (= (isdoingop (mk___rep theadmin__split_fields3)) true) (= (thecurrentop (mk___rep theadmin__split_fields3)) 3)) (= (rolepresent (mk___rep theadmin__split_fields3)) 1))) (=> (= (rolepresent (mk___rep theadmin__split_fields3)) 1) (or (and (= (isdoingop (mk___rep theadmin__split_fields3)) true) (= (thecurrentop (mk___rep theadmin__split_fields3)) 3)) (not (= (isdoingop (mk___rep theadmin__split_fields3)) true))))) (and (and (and (and (and (in_range6 auditalarm2) (in_range17 tokentry2)) (in_range16 tokenid2)) (in_range28 (let ((subject status)) status4))) (in_range1 tokenpresence2)) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true)))))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= (let ((subject state8)) (mk___private__ref state32)) state8)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= (let ((subject output)) (mk___private__ref output2)) output)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= (let ((subject writtenstate)) (mk___private__ref writtenstate2)) writtenstate)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= (let ((subject state6)) (mk___private__ref state30)) state6)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= (let ((subject state5)) (mk___private__ref state29)) state5)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= (let ((subject state4)) (mk___private__ref state28)) state4)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= (let ((subject state3)) (mk___private__ref state27)) state3)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= (let ((subject state)) (mk___private__ref state24)) state)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= (let ((subject filestate)) (mk___private__ref filestate6)) filestate)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= latchtimeout__split_fields5 (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= currentlatch2 currentlatch)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= state32 state17)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= output2 output1)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= writtenstate2 writtenstate1)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= state30 state15)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= state29 state14)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= state28 state13)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= state27 state12)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= state24 state9)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= filestate6 filestate2)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= latchtimeout__split_fields5 latchtimeout__split_fields4)))
(assert (=> (= (let ((subject localstatus)) localstatus1) 5) (= currentlatch2 currentlatch1)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (and (= (let ((subject status)) status6) 3) (and (and (and (and (and (in_range6 auditalarm3) (in_range17 tokentry3)) (in_range16 tokenid3)) (in_range28 (let ((subject status)) status6))) (in_range1 tokenpresence3)) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true))))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= (let ((subject state8)) (mk___private__ref state32)) state8))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= (let ((subject output)) (mk___private__ref output2)) output))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= (let ((subject writtenstate)) (mk___private__ref writtenstate2)) writtenstate))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= (let ((subject state6)) (mk___private__ref state30)) state6))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= (let ((subject state5)) (mk___private__ref state29)) state5))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= (let ((subject state4)) (mk___private__ref state28)) state4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= (let ((subject state3)) (mk___private__ref state27)) state3))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= (let ((subject state)) (mk___private__ref state24)) state))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= (let ((subject filestate)) (mk___private__ref filestate6)) filestate))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= theadmin__split_fields4 (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= latchtimeout__split_fields5 (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= currentlatch2 currentlatch))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= state32 state17))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= output2 output1))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= writtenstate2 writtenstate1))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= state30 state15))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= state29 state14))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= state28 state13))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= state27 state12))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= state24 state9))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= filestate6 filestate2))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= theadmin__split_fields4 theadmin__split_fields2))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= latchtimeout__split_fields5 latchtimeout__split_fields4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (= (let ((subject localstatus)) localstatus1) 4) (= currentlatch2 currentlatch1))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7)) (and (and (and (and (and (and (and (and (and (and (and (or (or (or (= (let ((subject status)) status7) 6) (= (let ((subject status)) status7) 7)) (= (let ((subject status)) status7) 3)) (= (let ((subject status)) status7) 8)) (=> (or (= (let ((subject status)) status7) 6) (= (let ((subject status)) status7) 7)) (and (and (= (isdoingop (mk___rep theadmin__split_fields4)) true) (= (ispresent (mk___rep theadmin__split_fields4)) true)) (= (rolepresent (mk___rep theadmin__split_fields4)) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))) (=> (= (let ((subject status)) status7) 3) (and (and (not (= (isdoingop (mk___rep theadmin__split_fields4)) true)) (= (ispresent (mk___rep theadmin__split_fields4)) true)) (= (rolepresent (mk___rep theadmin__split_fields4)) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))) (=> (= (let ((subject status)) status7) 8) (and (not (= (isdoingop (mk___rep theadmin__split_fields4)) true)) (= (rolepresent (mk___rep theadmin__split_fields4)) 0)))) (=> (and (= (isdoingop (mk___rep theadmin__split_fields4)) true) (= (thecurrentop (mk___rep theadmin__split_fields4)) 4)) (= (let ((subject status)) status7) 6))) (= (and (and (= (islocked currentlatch2 (let ((subject state3)) state27) latchtimeout__split_fields5) true) (= (thecurrentdoor (let ((subject state4)) state28)) 0)) (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime)) (alarm_timeout (let ((subject state4)) state28))) true)) (= (thedooralarm (let ((subject state4)) state28)) 0))) (=> (= (rolepresent (mk___rep theadmin__split_fields4)) 1) (and (and (= (isgood tokenpresence4 (let ((subject state2)) state26) tokentry4 tokenid4 (let ((subject authcert__split_fields)) authcert__split_fields4) (let ((subject idcert__split_fields)) idcert__split_fields4)) true) (= (authcertvalid tokenpresence4 (let ((subject state2)) state26) tokentry4 tokenid4 (let ((subject authcert__split_fields)) authcert__split_fields4) (let ((subject idcert__split_fields)) idcert__split_fields4)) true)) (= (theauthcertrole tokenpresence4 (let ((subject state2)) state26) tokentry4 tokenid4 (let ((subject authcert__split_fields)) authcert__split_fields4) (let ((subject idcert__split_fields)) idcert__split_fields4)) 1)))) (=> (and (not (= (islocked currentlatch2 (let ((subject state3)) state27) latchtimeout__split_fields5) true)) (= (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) true)) (and (and (= (isgood tokenpresence4 (let ((subject state2)) state26) tokentry4 tokenid4 (let ((subject authcert__split_fields)) authcert__split_fields4) (let ((subject idcert__split_fields)) idcert__split_fields4)) true) (= (authcertvalid tokenpresence4 (let ((subject state2)) state26) tokentry4 tokenid4 (let ((subject authcert__split_fields)) authcert__split_fields4) (let ((subject idcert__split_fields)) idcert__split_fields4)) true)) (= (theauthcertrole tokenpresence4 (let ((subject state2)) state26) tokentry4 tokenid4 (let ((subject authcert__split_fields)) authcert__split_fields4) (let ((subject idcert__split_fields)) idcert__split_fields4)) 1)))) (=> (and (= (isdoingop (mk___rep theadmin__split_fields4)) true) (= (thecurrentop (mk___rep theadmin__split_fields4)) 3)) (= (rolepresent (mk___rep theadmin__split_fields4)) 1))) (=> (= (rolepresent (mk___rep theadmin__split_fields4)) 1) (or (and (= (isdoingop (mk___rep theadmin__split_fields4)) true) (= (thecurrentop (mk___rep theadmin__split_fields4)) 3)) (not (= (isdoingop (mk___rep theadmin__split_fields4)) true))))) (=> (and (not (= (islocked currentlatch2 (let ((subject state3)) state27) latchtimeout__split_fields5) true)) (= (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) true)) (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)))) (and (and (and (and (and (and (in_range6 auditalarm4) (in_range17 tokentry4)) (in_range16 tokenid4)) (in_range28 (let ((subject status)) status7))) (in_range26 currentlatch2)) (in_range1 tokenpresence4)) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true)))))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject state8)) (mk___private__ref state32)) state8)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject state7)) (mk___private__ref state31)) state7)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject output)) (mk___private__ref output2)) output)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject writtenstate)) (mk___private__ref writtenstate2)) writtenstate)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject state6)) (mk___private__ref state30)) state6)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject state5)) (mk___private__ref state29)) state5)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject state4)) (mk___private__ref state28)) state4)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject state3)) (mk___private__ref state27)) state3)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject state2)) (mk___private__ref state26)) state2)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject state1)) (mk___private__ref state25)) state1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject filestate1)) (mk___private__ref filestate7)) filestate1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject state)) (mk___private__ref state24)) state)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject filestate)) (mk___private__ref filestate6)) filestate)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject status)) (mk_int__ref status7)) status)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= theadmin__split_fields4 (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= latchtimeout__split_fields5 (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= currentlatch2 currentlatch)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields4)) idcert__split_fields)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields4)) authcert__split_fields)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= tokenid4 tokenid)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= tokentry4 tokentry)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= tokenpresence4 tokenpresence)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= auditsystemfault4 auditsystemfault)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= auditalarm4 auditalarm)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= logfilestate__split_fields10 (mk___split_fields3 logfilestate__split_fields logfilestate__split_fields1 (mk___rep2 (mk___split_fields2 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= logfilesstatus4 logfilesstatus)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= logfiles4 logfiles)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= state32 state17)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= state31 state16)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= output2 output1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= writtenstate2 writtenstate1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= state30 state15)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= state29 state14)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= state28 state13)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= state27 state12)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= state26 state11)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= state25 state10)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= filestate7 filestate3)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= state24 state9)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= filestate6 filestate2)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= status7 status2)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= theadmin__split_fields4 theadmin__split_fields2)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= latchtimeout__split_fields5 latchtimeout__split_fields4)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= currentlatch2 currentlatch1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= idcert__split_fields4 idcert__split_fields1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= authcert__split_fields4 authcert__split_fields1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= tokenid4 tokenid1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= tokentry4 tokentry1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= tokenpresence4 tokenpresence1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= auditsystemfault4 auditsystemfault1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= auditalarm4 auditalarm1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= logfilestate__split_fields10 logfilestate__split_fields7)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= logfilesstatus4 logfilesstatus1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (=> (not (=> (not (= (let ((subject localstatus)) localstatus1) 6)) (= (let ((subject localstatus)) localstatus1) 7))) (= logfiles4 logfiles1)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= (let ((subject state7)) (mk___private__ref state23)) (let ((subject state7)) (mk___private__ref state31))))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= (let ((subject state2)) (mk___private__ref state22)) (let ((subject state2)) (mk___private__ref state26))))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= (let ((subject state1)) (mk___private__ref state21)) (let ((subject state1)) (mk___private__ref state25))))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= (let ((subject filestate1)) (mk___private__ref filestate5)) (let ((subject filestate1)) (mk___private__ref filestate7))))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= (let ((subject status)) (mk_int__ref status6)) (let ((subject status)) (mk_int__ref status7))))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields3)) (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields4))))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields3)) (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields4))))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= tokenid3 tokenid4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= tokentry3 tokentry4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= tokenpresence3 tokenpresence4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= auditsystemfault3 auditsystemfault4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= auditalarm3 auditalarm4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= logfilestate__split_fields9 logfilestate__split_fields10))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= logfilesstatus3 logfilesstatus4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= logfiles3 logfiles4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= state23 state31))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= state22 state26))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= state21 state25))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= filestate5 filestate7))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= status6 status7))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= idcert__split_fields3 idcert__split_fields4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= authcert__split_fields3 authcert__split_fields4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= tokenid3 tokenid4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= tokentry3 tokentry4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= tokenpresence3 tokenpresence4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= auditsystemfault3 auditsystemfault4))))
...
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= logfilesstatus3 logfilesstatus4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (=> (not (= (let ((subject localstatus)) localstatus1) 4)) (= logfiles3 logfiles4))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= (let ((subject state7)) (mk___private__ref state20)) (let ((subject state7)) (mk___private__ref state23)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= (let ((subject status1)) (mk___private__ref status5)) status1)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= (let ((subject state2)) (mk___private__ref state19)) (let ((subject state2)) (mk___private__ref state22)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= (let ((subject state1)) (mk___private__ref state18)) (let ((subject state1)) (mk___private__ref state21)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= (let ((subject filestate1)) (mk___private__ref filestate4)) (let ((subject filestate1)) (mk___private__ref filestate5)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= (let ((subject status)) (mk_int__ref status4)) (let ((subject status)) (mk_int__ref status6)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= theadmin__split_fields3 theadmin__split_fields4)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields2)) (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields3)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields2)) (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields3)))))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= tokenid2 tokenid3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= tokentry2 tokentry3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= tokenpresence2 tokenpresence3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= auditsystemfault2 auditsystemfault3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= auditalarm2 auditalarm3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= logfilestate__split_fields8 logfilestate__split_fields9)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= logfilesstatus2 logfilesstatus3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= logfiles2 logfiles3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= state20 state23)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= status5 status3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= state19 state22)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= state18 state21)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= filestate4 filestate5)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= status4 status6)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= theadmin__split_fields3 theadmin__split_fields4)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= idcert__split_fields2 idcert__split_fields3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= authcert__split_fields2 authcert__split_fields3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= tokenid2 tokenid3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= tokentry2 tokentry3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= tokenpresence2 tokenpresence3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= auditsystemfault2 auditsystemfault3)))
...
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= logfilesstatus2 logfilesstatus3)))
(assert (=> (not (= (let ((subject localstatus)) localstatus1) 5)) (= logfiles2 logfiles3)))
(assert (= state41 (let ((subject state8)) (mk___private__ref state32))))
(assert (= state40 (let ((subject state7)) (mk___private__ref state20))))
...
(assert (= state39 (let ((subject state6)) (mk___private__ref state30))))
(assert (= state38 (let ((subject state5)) (mk___private__ref state29))))
(assert (= state37 (let ((subject state4)) (mk___private__ref state28))))
(assert (= state36 (let ((subject state3)) (mk___private__ref state27))))
(assert (= status9 (let ((subject status1)) (mk___private__ref status5))))
(assert (= state35 (let ((subject state2)) (mk___private__ref state19))))
(assert (= state34 (let ((subject state1)) (mk___private__ref state18))))
(assert (= filestate9 (let ((subject filestate1)) (mk___private__ref filestate4))))
(assert (= state33 (let ((subject state)) (mk___private__ref state24))))
(assert (= filestate8 (let ((subject filestate)) (mk___private__ref filestate6))))
(assert (= localstatus2 (let ((subject localstatus)) (mk_int__ref localstatus1))))
(assert (= status8 (let ((subject status)) (mk_int__ref status4))))
(assert (= theadmin__split_fields5 (mk___split_fields__ref theadmin__split_fields3)))
...
(assert (= idcert__split_fields5 (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields2))))
(assert (= authcert__split_fields5 (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields2))))
(assert (= tokenid5 (mk_int__ref tokenid2)))
(assert (= tokentry5 (mk_int__ref tokentry2)))
(assert (= tokenpresence5 (mk_int__ref tokenpresence2)))
(assert (= auditsystemfault5 (mk_bool__ref auditsystemfault2)))
(assert (= auditalarm5 (mk_int__ref auditalarm2)))
(assert (= logfilestate__split_fields11 (mk___split_fields__ref3 logfilestate__split_fields8)))
(assert (= logfilesstatus5 (mk_map__ref3 logfilesstatus2)))
(assert (= logfiles5 (mk_map__ref2 logfiles2)))
...
(assert (= theadmin__split_fields6 theadmin__split_fields3))
(assert (= latchtimeout__split_fields7 latchtimeout__split_fields5))
(assert (= currentlatch4 currentlatch2))
(assert (= idcert__split_fields6 idcert__split_fields2))
(assert (= authcert__split_fields6 authcert__split_fields2))
(assert (= tokenid6 tokenid2))
(assert (= tokentry6 tokentry2))
(assert (= tokenpresence6 tokenpresence2))
(assert (= auditsystemfault6 auditsystemfault2))
(assert (= auditalarm6 auditalarm2))
(assert (= logfilestate__split_fields12 logfilestate__split_fields8))
(assert (= logfilesstatus6 logfilesstatus2))
(assert (= logfiles6 logfiles2))
(assert (and (= o1 (islocked (int__content currentlatch3) (us_private__content state36) (us_split_fields__content1 latchtimeout__split_fields6))) (= (= o1 true) (= (int__content currentlatch3) 0))))
(assert (= o2 (ite (not (= o1 true)) true false)))
(assert (= result1 (ite (= o2 true) (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result1 true) (and (= o3 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o3))))
(assert (=> (= result1 true) (= o4 (ite (= o3 3) true false))))
(assert (=> (= result1 true) (and (= o5 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o5 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result1 true) (= o6 (ite (= o5 true) o4 false))))
(assert (=> (not (= result1 true)) (= o6 (distinct 1 0))))
(assert (and (= result2 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (= (= result2 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields5)))))))
(assert (= result2 true))
