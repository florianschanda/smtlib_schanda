...
(define-fun dynamic_invariant ((temp___expr_190 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 4294967295)) (in_range3 temp___expr_190)))
(declare-sort t1 0)
...
(define-fun dynamic_invariant2 ((temp___expr_485 Int) (temp___is_init_481 Bool) (temp___skip_constant_482 Bool) (temp___do_toplevel_483 Bool) (temp___do_typ_inv_484 Bool)) Bool (=> (or (= temp___is_init_481 true) (<= 0 2147483647)) (in_range4 temp___expr_485)))
...
(define-fun dynamic_invariant3 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 1)) (in_range5 temp___expr_496)))
...
(define-fun dynamic_invariant4 ((temp___expr_561 Int) (temp___is_init_557 Bool) (temp___skip_constant_558 Bool) (temp___do_toplevel_559 Bool) (temp___do_typ_inv_560 Bool)) Bool (=> (or (= temp___is_init_557 true) (<= 0 1)) (in_range8 temp___expr_561)))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep5 (select a temp___idx_172)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep8 (select a temp___idx_173)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_1229 us_rep2) (temp___is_init_1225 Bool) (temp___skip_constant_1226 Bool) (temp___do_toplevel_1227 Bool) (temp___do_typ_inv_1228 Bool)) Bool (=> (= temp___do_typ_inv_1228 true) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1229))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1229))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1229)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1229))) true)))
(define-fun default_initial_assumption ((temp___expr_1233 us_rep2) (temp___skip_top_level_1234 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1233))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1233))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1233)) (mk___rep1 (mk___split_fields1 (temp___1235 1) (of_rep5 1) (of_rep5 1) (of_rep7 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1233)) (temp___1239 0))))
(define-fun type_invariant ((temp___1243 us_rep2)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1243))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1243))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1243)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1243))) true))
...
(define-fun bool_eq11 ((a (Array Int us_rep3)) (a__first Int) (a__last Int) (b (Array Int us_rep3)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq10 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true)))) true false))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq12 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep9 (select a temp___idx_175)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(define-fun dynamic_invariant6 ((temp___expr_1418 Int) (temp___is_init_1414 Bool) (temp___skip_constant_1415 Bool) (temp___do_toplevel_1416 Bool) (temp___do_typ_inv_1417 Bool)) Bool (=> (or (= temp___is_init_1414 true) (<= 0 16)) (in_range15 temp___expr_1418)))
...
(define-fun dynamic_invariant7 ((temp___expr_1486 Int) (temp___is_init_1482 Bool) (temp___skip_constant_1483 Bool) (temp___do_toplevel_1484 Bool) (temp___do_typ_inv_1485 Bool)) Bool (=> (or (= temp___is_init_1482 true) (<= 0 16)) (in_range16 temp___expr_1486)))
...
(define-fun dynamic_invariant8 ((temp___expr_1493 Int) (temp___is_init_1489 Bool) (temp___skip_constant_1490 Bool) (temp___do_toplevel_1491 Bool) (temp___do_typ_inv_1492 Bool)) Bool (=> (or (= temp___is_init_1489 true) (<= 0 4294967295)) (in_range17 temp___expr_1493)))
(declare-fun codetoval (Int) Int)
(declare-fun codetoval__function_guard (Int Int) Bool)
(assert (forall ((s Int)) (! (=> (dynamic_invariant7 s true true true true) (dynamic_invariant8 (codetoval s) true false true true)) :pattern ((codetoval s)))))
(declare-fun temp___String_Literal_1496 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1496 us_void_param) 1)) 66) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 4)) 109)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 11)) 100)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 13)) 118)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 14)) 105)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 18)) 102)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 20)) 105)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 21)) 108)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 22)) 117)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_1496 us_void_param) 25)) 32)) :pattern ((temp___String_Literal_1496 us_void_param)))))
...
(define-fun dynamic_invariant13 ((temp___expr_1167 Int) (temp___is_init_1163 Bool) (temp___skip_constant_1164 Bool) (temp___do_toplevel_1165 Bool) (temp___do_typ_inv_1166 Bool)) Bool (=> (or (= temp___is_init_1163 true) (<= 0 17)) (in_range12 temp___expr_1167)))
(define-fun dynamic_invariant14 ((temp___expr_1174 Int) (temp___is_init_1170 Bool) (temp___skip_constant_1171 Bool) (temp___do_toplevel_1172 Bool) (temp___do_typ_inv_1173 Bool)) Bool (=> (or (= temp___is_init_1170 true) (<= 1 17)) (in_range10 temp___expr_1174)))
(define-fun dynamic_invariant15 ((temp___expr_1300 Int) (temp___is_init_1296 Bool) (temp___skip_constant_1297 Bool) (temp___do_toplevel_1298 Bool) (temp___do_typ_inv_1299 Bool)) Bool (=> (or (= temp___is_init_1296 true) (<= 0 2)) (in_range14 temp___expr_1300)))
(define-fun dynamic_invariant16 ((temp___expr_1181 Int) (temp___is_init_1177 Bool) (temp___skip_constant_1178 Bool) (temp___do_toplevel_1179 Bool) (temp___do_typ_inv_1180 Bool)) Bool (=> (or (= temp___is_init_1177 true) (<= 0 17408)) (in_range11 temp___expr_1181)))
(define-fun dynamic_invariant17 ((temp___expr_1212 Int) (temp___is_init_1208 Bool) (temp___skip_constant_1209 Bool) (temp___do_toplevel_1210 Bool) (temp___do_typ_inv_1211 Bool)) Bool (=> (or (= temp___is_init_1208 true) (<= 0 1024)) (in_range13 temp___expr_1212)))
(assert true)
...
(assert (forall ((temp___1241 Int)) (=> (dynamic_invariant17 temp___1241 true true true true) (forall ((temp___1242 Int)) (= (to_rep8 (select (temp___1239 temp___1241) temp___1242)) temp___1241)))))
(define-fun dynamic_invariant18 ((temp___expr_586 Int) (temp___is_init_582 Bool) (temp___skip_constant_583 Bool) (temp___do_toplevel_584 Bool) (temp___do_typ_inv_585 Bool)) Bool (=> (or (= temp___is_init_582 true) (<= 1 150)) (in_range9 temp___expr_586)))
(assert (= nouser (temp___String_Literal_169 Tuple0)))
(define-fun dynamic_invariant19 ((temp___expr_211 Int) (temp___is_init_207 Bool) (temp___skip_constant_208 Bool) (temp___do_toplevel_209 Bool) (temp___do_typ_inv_210 Bool)) Bool (=> (or (= temp___is_init_207 true) (<= 0 255)) (in_range6 temp___expr_211)))
...
(define-fun dynamic_invariant21 ((temp___expr_520 Int) (temp___is_init_516 Bool) (temp___skip_constant_517 Bool) (temp___do_toplevel_518 Bool) (temp___do_typ_inv_519 Bool)) Bool (=> (or (= temp___is_init_516 true) (<= 0 4294967295)) (in_range7 temp___expr_520)))
(assert (forall ((temp___1237 Int)) (=> (dynamic_invariant14 temp___1237 true true true true) (forall ((temp___1238 Int)) (= (to_rep5 (select (temp___1235 temp___1237) temp___1238)) temp___1237)))))
...
(declare-const o Int)
(declare-const temp___1497 (Array Int character))
(declare-const temp___14971 t1)
...
(assert (dynamic_property1 1 2147483647 1 25))
(assert (= (temp___String_Literal_1496 Tuple0) temp___1497))
(assert (= (mk1 1 25) temp___14971))
(assert (not (dynamic_predicate (mk___t1 temp___1497 temp___14971))))
(check-sat)
(exit)
