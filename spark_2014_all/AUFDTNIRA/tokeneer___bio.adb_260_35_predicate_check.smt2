...
(define-fun dynamic_invariant3 ((temp___expr_402 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 1)) (in_range5 temp___expr_402)))
...
(define-fun dynamic_invariant4 ((temp___expr_460 Int) (temp___is_init_457 Bool) (temp___skip_constant_458 Bool) (temp___do_toplevel_459 Bool)) Bool (=> (or (= temp___is_init_457 true) (<= 0 1)) (in_range8 temp___expr_460)))
...
(assert (forall ((temp___1042 Int)) (forall ((temp___1043 Int)) (= (select (temp___1040 temp___1042) temp___1043) (of_rep5 temp___1042)))))
(declare-fun temp___1044 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1046 Int)) (forall ((temp___1047 Int)) (= (select (temp___1044 temp___1046) temp___1047) (of_rep8 temp___1046)))))
(define-fun dynamic_invariant5 ((temp___expr_1034 us_rep2) (temp___is_init_1031 Bool) (temp___skip_constant_1032 Bool) (temp___do_toplevel_1033 Bool)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1034))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1034))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1034)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1034))) true))
(define-fun default_initial_assumption ((temp___expr_1038 us_rep2) (temp___skip_top_level_1039 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1038))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1038))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1038)) (mk___rep1 (mk___split_fields1 (temp___1040 1) (of_rep5 1) (of_rep5 1) (of_rep7 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1038)) (temp___1044 0))))
(define-fun type_invariant ((temp___1048 us_rep2)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1048))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1048))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1048)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1048))) true))
...
(define-fun dynamic_invariant6 ((temp___expr_1210 Int) (temp___is_init_1207 Bool) (temp___skip_constant_1208 Bool) (temp___do_toplevel_1209 Bool)) Bool (=> (or (= temp___is_init_1207 true) (<= 0 16)) (in_range15 temp___expr_1210)))
...
(define-fun dynamic_invariant7 ((temp___expr_1270 Int) (temp___is_init_1267 Bool) (temp___skip_constant_1268 Bool) (temp___do_toplevel_1269 Bool)) Bool (=> (or (= temp___is_init_1267 true) (<= 0 16)) (in_range16 temp___expr_1270)))
...
(define-fun dynamic_invariant8 ((temp___expr_1276 Int) (temp___is_init_1273 Bool) (temp___skip_constant_1274 Bool) (temp___do_toplevel_1275 Bool)) Bool (=> (or (= temp___is_init_1273 true) (<= 0 4294967295)) (in_range17 temp___expr_1276)))
...
(declare-fun temp___String_Literal_1279 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1279 us_void_param) 1)) 66) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 4)) 109)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 11)) 100)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 13)) 118)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 14)) 105)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 18)) 102)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 20)) 105)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 21)) 108)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 22)) 117)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_1279 us_void_param) 25)) 32)) :pattern ((temp___String_Literal_1279 us_void_param)))))
...
(define-fun dynamic_invariant13 ((temp___expr_1000 Int) (temp___is_init_997 Bool) (temp___skip_constant_998 Bool) (temp___do_toplevel_999 Bool)) Bool (=> (or (= temp___is_init_997 true) (<= 0 17)) (in_range12 temp___expr_1000)))
(define-fun dynamic_invariant14 ((temp___expr_979 Int) (temp___is_init_976 Bool) (temp___skip_constant_977 Bool) (temp___do_toplevel_978 Bool)) Bool (=> (or (= temp___is_init_976 true) (<= 1 17)) (in_range10 temp___expr_979)))
(define-fun dynamic_invariant15 ((temp___expr_1104 Int) (temp___is_init_1101 Bool) (temp___skip_constant_1102 Bool) (temp___do_toplevel_1103 Bool)) Bool (=> (or (= temp___is_init_1101 true) (<= 0 2)) (in_range14 temp___expr_1104)))
(define-fun dynamic_invariant16 ((temp___expr_985 Int) (temp___is_init_982 Bool) (temp___skip_constant_983 Bool) (temp___do_toplevel_984 Bool)) Bool (=> (or (= temp___is_init_982 true) (<= 0 17408)) (in_range11 temp___expr_985)))
(define-fun dynamic_invariant17 ((temp___expr_1019 Int) (temp___is_init_1016 Bool) (temp___skip_constant_1017 Bool) (temp___do_toplevel_1018 Bool)) Bool (=> (or (= temp___is_init_1016 true) (<= 0 1024)) (in_range13 temp___expr_1019)))
(assert true)
...
(define-fun dynamic_invariant18 ((temp___expr_482 Int) (temp___is_init_479 Bool) (temp___skip_constant_480 Bool) (temp___do_toplevel_481 Bool)) Bool (=> (or (= temp___is_init_479 true) (<= 1 150)) (in_range9 temp___expr_482)))
...
(define-fun dynamic_invariant21 ((temp___expr_423 Int) (temp___is_init_420 Bool) (temp___skip_constant_421 Bool) (temp___do_toplevel_422 Bool)) Bool (=> (or (= temp___is_init_420 true) (<= 0 4294967295)) (in_range7 temp___expr_423)))
...
(assert (= (temp___String_Literal_1279 Tuple0) temp___1280))
(assert (= (mk1 1 25) temp___12801))
(assert (not (dynamic_predicate (mk___t1 temp___1280 temp___12801))))
(check-sat)
(exit)
