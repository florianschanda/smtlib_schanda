...
(define-fun c1 () us_rep4 (mk___rep2 (mk___split_fields2 c)))
(assert (= (to_rep1 o) 0))
(assert (= o o1))
(assert (= temp___1155 o1))
(assert (= (mk___rep (mk___split_fields temp___1155)) no_element))
(assert (and (= o8 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o8) (= o8 (ite (= (of_int 1) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o6 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o6) (<= o6 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= o7 (* 2 o6)))
(assert (and (= o9 o7) (in_range2 o7)))
(assert (= result (ite (<= o9 o8) true false)))
(assert (= result true))
(assert (and (= o5 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o5) (<= o5 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= result1 (ite (<= o5 5000) true false)))
(assert (= result1 true))
(assert (= (= result2 true) (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (to_rep (select a j))) true)))))
(assert (= result2 true))
...
(assert (= o3 true))
(assert (= result3 (ite (= o3 true) o2 false)))
(assert (= result3 true))
(assert (and (= o4 (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c1)) (and (in_range8 o4) (= o4 (get2 (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (get3 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1))))))
(assert (not (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true)))
(check-sat)
(exit)
