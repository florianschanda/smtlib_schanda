...
(define-fun dynamic_invariant1 ((temp___expr_1233 us_rep1) (temp___is_init_1229 Bool) (temp___skip_constant_1230 Bool) (temp___do_toplevel_1231 Bool) (temp___do_typ_inv_1232 Bool)) Bool (=> (= temp___do_typ_inv_1232 true) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1233))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1233))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1233)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1233))) true)))
(define-fun default_initial_assumption ((temp___expr_1237 us_rep1) (temp___skip_top_level_1238 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1237))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1237))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1237)) (mk___rep (mk___split_fields (temp___1239 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1237)) (temp___1243 0))))
(define-fun type_invariant ((temp___1247 us_rep1)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1247))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1247))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1247)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1247))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_2558 Int) (temp___is_init_2554 Bool) (temp___skip_constant_2555 Bool) (temp___do_toplevel_2556 Bool) (temp___do_typ_inv_2557 Bool)) Bool (=> (or (= temp___is_init_2554 true) (<= 0 7)) (in_range11 temp___expr_2558)))
...
(define-fun dynamic_invariant9 ((temp___expr_1304 Int) (temp___is_init_1300 Bool) (temp___skip_constant_1301 Bool) (temp___do_toplevel_1302 Bool) (temp___do_typ_inv_1303 Bool)) Bool (=> (or (= temp___is_init_1300 true) (<= 0 2)) (in_range9 temp___expr_1304)))
...
(assert (forall ((temp___1245 Int)) (=> (dynamic_invariant11 temp___1245 true true true true) (forall ((temp___1246 Int)) (= (to_rep5 (select (temp___1243 temp___1245) temp___1246)) temp___1245)))))
...
(define-fun dynamic_invariant13 ((temp___expr_1781 Int) (temp___is_init_1777 Bool) (temp___skip_constant_1778 Bool) (temp___do_toplevel_1779 Bool) (temp___do_typ_inv_1780 Bool)) Bool (=> (or (= temp___is_init_1777 true) (<= 0 2147483647)) (in_range10 temp___expr_1781)))
(assert (forall ((temp___1241 Int)) (=> (dynamic_invariant8 temp___1241 true true true true) (forall ((temp___1242 Int)) (= (to_rep2 (select (temp___1239 temp___1241) temp___1242)) temp___1241)))))
