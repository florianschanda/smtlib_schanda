...
(assert (forall ((temp___1046 Int)) (forall ((temp___1047 Int)) (= (select (temp___1044 temp___1046) temp___1047) (of_rep2 temp___1046)))))
(declare-fun temp___1048 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1050 Int)) (forall ((temp___1051 Int)) (= (select (temp___1048 temp___1050) temp___1051) (of_rep5 temp___1050)))))
(define-fun dynamic_invariant1 ((temp___expr_1038 us_rep1) (temp___is_init_1035 Bool) (temp___skip_constant_1036 Bool) (temp___do_toplevel_1037 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1038))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1038))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1038)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1038))) true))
(define-fun default_initial_assumption ((temp___expr_1042 us_rep1) (temp___skip_top_level_1043 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1042))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1042))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1042)) (mk___rep (mk___split_fields (temp___1044 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1042)) (temp___1048 0))))
(define-fun type_invariant ((temp___1052 us_rep1)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1052))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1052))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1052)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1052))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_2310 Int) (temp___is_init_2307 Bool) (temp___skip_constant_2308 Bool) (temp___do_toplevel_2309 Bool)) Bool (=> (or (= temp___is_init_2307 true) (<= 0 7)) (in_range11 temp___expr_2310)))
...
(define-fun dynamic_invariant7 ((temp___expr_1004 Int) (temp___is_init_1001 Bool) (temp___skip_constant_1002 Bool) (temp___do_toplevel_1003 Bool)) Bool (=> (or (= temp___is_init_1001 true) (<= 0 17)) (in_range7 temp___expr_1004)))
(define-fun dynamic_invariant8 ((temp___expr_983 Int) (temp___is_init_980 Bool) (temp___skip_constant_981 Bool) (temp___do_toplevel_982 Bool)) Bool (=> (or (= temp___is_init_980 true) (<= 1 17)) (in_range5 temp___expr_983)))
(define-fun dynamic_invariant9 ((temp___expr_1108 Int) (temp___is_init_1105 Bool) (temp___skip_constant_1106 Bool) (temp___do_toplevel_1107 Bool)) Bool (=> (or (= temp___is_init_1105 true) (<= 0 2)) (in_range9 temp___expr_1108)))
(define-fun dynamic_invariant10 ((temp___expr_989 Int) (temp___is_init_986 Bool) (temp___skip_constant_987 Bool) (temp___do_toplevel_988 Bool)) Bool (=> (or (= temp___is_init_986 true) (<= 0 17408)) (in_range6 temp___expr_989)))
(define-fun dynamic_invariant11 ((temp___expr_1023 Int) (temp___is_init_1020 Bool) (temp___skip_constant_1021 Bool) (temp___do_toplevel_1022 Bool)) Bool (=> (or (= temp___is_init_1020 true) (<= 0 1024)) (in_range8 temp___expr_1023)))
(assert true)
...
(define-fun dynamic_invariant13 ((temp___expr_1551 Int) (temp___is_init_1548 Bool) (temp___skip_constant_1549 Bool) (temp___do_toplevel_1550 Bool)) Bool (=> (or (= temp___is_init_1548 true) (<= 0 2147483647)) (in_range10 temp___expr_1551)))
