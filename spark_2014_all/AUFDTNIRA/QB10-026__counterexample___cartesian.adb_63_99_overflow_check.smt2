...
(assert (and (= o58 (length array2)) (in_range1 (length array2))))
(assert (and (= o59 (- i1 (to_rep (first (rt array1))))) (in_range1 (- i1 (to_rep (first (rt array1)))))))
(assert (= o60 (* o59 o58)))
(assert (and (= o62 o60) (in_range1 o60)))
(assert (= o63 (+ o62 o61)))
