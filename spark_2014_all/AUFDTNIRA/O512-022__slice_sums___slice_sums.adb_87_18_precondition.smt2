...
(assert (<= (to_rep3 (first (rt x))) lo_index1))
(assert (<= lo_index1 (- current_lo3 1)))
(assert (= (to_rep2 o31) (- current_lo3 1)))
(assert (= (to_rep1 o32) lo_index1))
(assert (= o33 (mk___split_fields o32 o31)))
(assert (= o34 (mk_slice_bounds o33)))
(assert (not (or (< (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o34))) (to_rep1 (rec__sums__slice_bounds__lo (us_split_fields1 o34)))) (and (<= (to_rep3 (first (rt x))) (to_rep1 (rec__sums__slice_bounds__lo (us_split_fields1 o34)))) (<= (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o34))) (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
