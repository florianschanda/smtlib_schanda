...
(assert (forall ((lo_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index1) (<= lo_index1 (- current_hi2 1))) (forall ((hi_index Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index) (<= hi_index (- current_hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep1 lo_index1) (of_rep2 hi_index)))) max_sum2))))))
(assert (forall ((lo_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index1) (<= lo_index1 (- current_lo2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep1 lo_index1) (of_rep2 (- current_lo2 1))))) 0))))
...
(assert (<= lo_index (- current_lo2 1)))
(assert (= (to_rep2 o5) (- current_lo2 1)))
(assert (= (to_rep1 o6) lo_index))
(assert (= o7 (mk___split_fields o6 o5)))
(assert (= o8 (mk_slice_bounds o7)))
(assert (not (or (< (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o8))) (to_rep1 (rec__sums__slice_bounds__lo (us_split_fields1 o8)))) (and (<= (to_rep3 (first (rt x))) (to_rep1 (rec__sums__slice_bounds__lo (us_split_fields1 o8)))) (<= (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o8))) (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
