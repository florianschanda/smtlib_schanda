...
(assert (not (= (length temp___1951) 0)))
(assert (=> (<= (to_rep1 (first4 temp___19521)) (to_rep1 (last4 temp___19521))) (= o126 (+ (- (to_rep1 (last4 temp___19521)) (to_rep1 (first4 temp___19521))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___19521)) (to_rep1 (last4 temp___19521)))) (= o126 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1951))) (to_rep1 (last (rt temp___1951)))) (= o127 (+ (- (to_rep1 (last (rt temp___1951))) (to_rep1 (first (rt temp___1951)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1951))) (to_rep1 (last (rt temp___1951))))) (= o127 0)))
(assert (= o128 (+ o127 o126)))
(assert (= o129 (+ (to_rep1 (first (rt temp___1951))) o128)))
(assert (= o130 (- o129 1)))
