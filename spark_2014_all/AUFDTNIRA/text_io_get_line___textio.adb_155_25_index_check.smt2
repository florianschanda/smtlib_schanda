...
(declare-const temp___724 (Array Int character))
(declare-const temp___7241 t3)
...
(assert (=> (< last11 (to_rep1 buffer__last)) (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___721)))
(assert (=> (< last11 (to_rep1 buffer__last)) (= (mk3 1 r77b) temp___7211)))
...
(assert (=> (< last11 (to_rep1 buffer__last)) (= o13 temp___723)))
(assert (=> (< last11 (to_rep1 buffer__last)) (= (mk3 1 r77b) temp___7231)))
(assert (=> (< last11 (to_rep1 buffer__last)) (= (ite (<= (to_rep1 (first6 temp___7211)) (to_rep1 (last6 temp___7211))) (+ (- (to_rep1 (last6 temp___7211)) (to_rep1 (first6 temp___7211))) 1) 0) (ite (<= (to_rep1 (first6 temp___7231)) (to_rep1 (last6 temp___7231))) (+ (- (to_rep1 (last6 temp___7231)) (to_rep1 (first6 temp___7231))) 1) 0))))
(assert (=> (< last11 (to_rep1 buffer__last)) (= (mk___t3 temp___724 temp___7241) (mk___t3 temp___721 temp___7211))))
(assert (=> (< last11 (to_rep1 buffer__last)) (forall ((temp___725 Int)) (ite (and (<= 1 temp___725) (<= temp___725 r77b)) (= (select o14 temp___725) (select temp___724 temp___725)) (= (select o14 temp___725) (select result__ temp___725))))))
...
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___716))))
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (= (mk4 1 r80b) temp___7161))))
...
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (= o15 temp___718))))
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (= (mk4 1 r80b) temp___7181))))
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (= (ite (<= (to_rep1 (first8 temp___7161)) (to_rep1 (last8 temp___7161))) (+ (- (to_rep1 (last8 temp___7161)) (to_rep1 (first8 temp___7161))) 1) 0) (ite (<= (to_rep1 (first8 temp___7181)) (to_rep1 (last8 temp___7181))) (+ (- (to_rep1 (last8 temp___7181)) (to_rep1 (first8 temp___7181))) 1) 0)))))
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (= (mk___t4 temp___719 temp___7191) (mk___t4 temp___716 temp___7161)))))
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (forall ((temp___720 Int)) (ite (and (<= 1 temp___720) (<= temp___720 r80b)) (= (select o16 temp___720) (select temp___719 temp___720)) (= (select o16 temp___720) (select result__ temp___720)))))))
