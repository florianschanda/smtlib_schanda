...
(declare-const temp___653 (Array Int character))
(declare-const temp___6531 t4)
...
(assert (and (ite (< (to_rep1 buffer__last) (to_rep1 buffer__first)) (= last11 (- (to_rep1 buffer__first) 1)) (and (and (and (or (= last11 (- (to_rep1 buffer__first) 1)) (and (<= (to_rep1 buffer__first) last11) (<= last11 (to_rep1 buffer__last)))) (forall ((idx1 Int)) (=> (and (<= (to_rep1 buffer__first) idx1) (<= idx1 last11)) (= (to_rep (select buffer idx1)) (to_rep (select the_file (+ (- idx1 (to_rep1 buffer__first)) cur_position))))))) (= cur_position1 (+ (- (+ cur_position last11) (to_rep1 buffer__first)) 1))) (or (or (= last11 (to_rep1 buffer__last)) (= (to_rep (select the_file cur_position1)) eof_ch)) (= (to_rep (select the_file cur_position1)) 10)))) (and (in_range4 last11) (in_range2 cur_position1))))
(assert (= last11 r74b))
...
(assert (=> (< last11 (to_rep1 buffer__last)) (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___655)))
(assert (=> (< last11 (to_rep1 buffer__last)) (= (mk3 1 r77b) temp___6551)))
...
(assert (=> (< last11 (to_rep1 buffer__last)) (= o13 temp___657)))
(assert (=> (< last11 (to_rep1 buffer__last)) (= (mk3 1 r77b) temp___6571)))
(assert (=> (< last11 (to_rep1 buffer__last)) (= (ite (<= (to_rep1 (first6 temp___6551)) (to_rep1 (last6 temp___6551))) (+ (- (to_rep1 (last6 temp___6551)) (to_rep1 (first6 temp___6551))) 1) 0) (ite (<= (to_rep1 (first6 temp___6571)) (to_rep1 (last6 temp___6571))) (+ (- (to_rep1 (last6 temp___6571)) (to_rep1 (first6 temp___6571))) 1) 0))))
(assert (=> (< last11 (to_rep1 buffer__last)) (= (mk___t3 temp___658 temp___6581) (mk___t3 temp___655 temp___6551))))
(assert (=> (< last11 (to_rep1 buffer__last)) (forall ((temp___659 Int)) (ite (and (<= 1 temp___659) (<= temp___659 r77b)) (= (select o14 temp___659) (select temp___658 temp___659)) (= (select o14 temp___659) (select result__ temp___659))))))
(assert (=> (< last11 (to_rep1 buffer__last)) (= (mk_map__ref result1) result__6)))
...
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___650))))
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (= (mk4 1 r80b) temp___6501))))
...
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (= o15 temp___652))))
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (= (mk4 1 r80b) temp___6521))))
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (= (ite (<= (to_rep1 (first8 temp___6501)) (to_rep1 (last8 temp___6501))) (+ (- (to_rep1 (last8 temp___6501)) (to_rep1 (first8 temp___6501))) 1) 0) (ite (<= (to_rep1 (first8 temp___6521)) (to_rep1 (last8 temp___6521))) (+ (- (to_rep1 (last8 temp___6521)) (to_rep1 (first8 temp___6521))) 1) 0)))))
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (= (mk___t4 temp___653 temp___6531) (mk___t4 temp___650 temp___6501)))))
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (forall ((temp___654 Int)) (ite (and (<= 1 temp___654) (<= temp___654 r80b)) (= (select o16 temp___654) (select temp___653 temp___654)) (= (select o16 temp___654) (select result__ temp___654)))))))
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (= result2 true) (= (mk_map__ref result3) result__6))))
...
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (not (= result2 true)) (and (and (forall ((idx1 Int)) (=> (and (<= 1 idx1) (<= idx1 num2)) (= (to_rep (select result__3 idx1)) (to_rep (select the_file2 (+ (- idx1 1) cur_position_at_start)))))) (and (= cur_position2 (+ cur_position_at_start num2)) (or (= (to_rep (select the_file2 cur_position2)) eof_ch) (= (to_rep (select the_file2 cur_position2)) 10)))) (and (in_range4 num2) (in_range2 cur_position2))))))
(assert (=> (not (< last11 (to_rep1 buffer__last))) (=> (not (= result2 true)) (= result__2 result__3))))
