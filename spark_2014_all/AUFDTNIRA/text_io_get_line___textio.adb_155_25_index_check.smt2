...
(assert (and (and (and (dynamic_property2 1 (ite (< 500 (length s)) (length s) 500) (to_rep1 buffer__first) (to_rep1 buffer__last)) (and (= (to_rep1 buffer__first) 1) (= (to_rep1 buffer__last) (ite (< 500 (length s)) (length s) 500)))) (and (=> (<= 0 2147483647) (in_range4 last10)) (and (and (ite (< (to_rep1 buffer__last) (to_rep1 buffer__first)) (= last11 (- (to_rep1 buffer__first) 1)) (and (and (and (or (= last11 (- (to_rep1 buffer__first) 1)) (and (<= (to_rep1 buffer__first) last11) (<= last11 (to_rep1 buffer__last)))) (forall ((idx2 Int)) (=> (and (<= (to_rep1 buffer__first) idx2) (<= idx2 last11)) (= (to_rep (select buffer idx2)) (to_rep (select the_file (+ (- idx2 (to_rep1 buffer__first)) cur_position))))))) (= cur_position1 (+ (- (+ cur_position last11) (to_rep1 buffer__first)) 1))) (or (or (= last11 (to_rep1 buffer__last)) (= (to_rep (select the_file cur_position1)) eof_ch)) (= (to_rep (select the_file cur_position1)) 10)))) (and (in_range4 last11) (in_range2 cur_position1))) (and (= last11 r74b) (and (in_range4 r74b) (and (and (and (and (and (=> (<= 1 r74b) (and (and (<= (to_rep1 buffer__first) 1) (<= 1 (to_rep1 buffer__last))) (and (<= (to_rep1 buffer__first) r74b) (<= r74b (to_rep1 buffer__last))))) (= o5 buffer)) (and (= o5 temp___655) (= (mk2 1 r74b) temp___6551))) (ite (= (length s) 0) (and (= temp___655 textio__get_line_function__get_rest__B_1__r__assume) (= (mk (to_rep1 (first4 temp___6551)) (to_rep1 (last4 temp___6551))) textio__get_line_function__get_rest__B_1__r__assume1)) (and (and (and (and (and (ite (<= (to_rep1 (first4 temp___6551)) (to_rep1 (last4 temp___6551))) (= o6 (+ (- (to_rep1 (last4 temp___6551)) (to_rep1 (first4 temp___6551))) 1)) (= o6 0)) (and (ite (<= (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))) (= o7 (+ (- (to_rep1 (last (rt s))) (to_rep1 (first (rt s)))) 1)) (= o7 0)) (= o8 (+ o7 o6)))) (= o9 (+ (to_rep1 (first (rt s))) o8))) (= o10 (- o9 1))) (and (= o11 o10) (in_range2 o10))) (and (= (concat1 (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s))) temp___655 (to_rep1 (first4 temp___6551)) (to_rep1 (last4 temp___6551))) textio__get_line_function__get_rest__B_1__r__assume) (= (mk (to_rep1 (first (rt s))) o11) textio__get_line_function__get_rest__B_1__r__assume1))))) (= (mk___t textio__get_line_function__get_rest__B_1__r__assume textio__get_line_function__get_rest__B_1__r__assume1) r)) (and (dynamic_invariant3 r true false true) (and (= (to_rep1 (first (rt r))) (to_rep1 (first (rt s)))) (and (= (to_rep1 (last (rt r))) (+ (to_rep1 (last (rt s))) last11)) (and (and (and (and (and (and (and (and (= o12 (- (to_rep1 (last (rt s))) (to_rep1 (first (rt s))))) (in_range1 (- (to_rep1 (last (rt s))) (to_rep1 (first (rt s)))))) (= o13 (+ o12 1))) (and (= o14 o13) (in_range1 o13))) (= o15 (+ o14 last11))) (and (= o16 o15) (in_range1 o15))) (and (= o17 o16) (in_range4 o16))) (and (= (mk_int__ref result1) (mk_int__ref num)) (= num1 o17))) (ite (< last11 (to_rep1 buffer__last)) (and (and (and (= num1 r77b) (in_range4 r77b)) (and (and (and (and (= (ite (<= (to_rep1 (first (rt r))) (to_rep1 (last (rt r)))) (+ (- (to_rep1 (last (rt r))) (to_rep1 (first (rt r)))) 1) 0) (ite (<= 1 r77b) (+ (- r77b 1) 1) 0)) (and (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___649) (= (mk3 1 r77b) temp___6491))) (and (and (and (=> (<= 1 r77b) (and (and (<= (to_rep1 result____first) 1) (<= 1 (to_rep1 result____last))) (and (<= (to_rep1 result____first) r77b) (<= r77b (to_rep1 result____last))))) (= o18 result__)) (and (= o18 temp___651) (= (mk3 1 r77b) temp___6511))) (and (= (ite (<= (to_rep1 (first6 temp___6491)) (to_rep1 (last6 temp___6491))) (+ (- (to_rep1 (last6 temp___6491)) (to_rep1 (first6 temp___6491))) 1) 0) (ite (<= (to_rep1 (first6 temp___6511)) (to_rep1 (last6 temp___6511))) (+ (- (to_rep1 (last6 temp___6511)) (to_rep1 (first6 temp___6511))) 1) 0)) (= (mk___t3 temp___652 temp___6521) (mk___t3 temp___649 temp___6491))))) (forall ((temp___653 Int)) (ite (and (<= 1 temp___653) (<= temp___653 r77b)) (= (select o19 temp___653) (select temp___652 temp___653)) (= (select o19 temp___653) (select result__ temp___653))))) (and (= (mk_map__ref result2) (mk_map__ref result__)) (= result__1 o19)))) (and (and (= num2 num1) (and (= (mk___split_fields file__split_fields14 file__split_fields15 file__split_fields16 file__split_fields17 file__split_fields18 file__split_fields19 file__split_fields20) (mk___split_fields file__split_fields7 file__split_fields8 file__split_fields9 file__split_fields10 file__split_fields11 file__split_fields12 file__split_fields13)) (and (= cur_position2 cur_position1) (= the_file2 the_file)))) (and (= num2 num1) (and (= (mk___split_fields file__split_fields14 file__split_fields15 file__split_fields16 file__split_fields17 file__split_fields18 file__split_fields19 file__split_fields20) (mk___split_fields file__split_fields7 file__split_fields8 file__split_fields9 file__split_fields10 file__split_fields11 file__split_fields12 file__split_fields13)) (and (= cur_position2 cur_position1) (= the_file2 the_file1)))))) (and (and (= last11 (to_rep1 buffer__last)) (and (and (= result3 (end_of_file (mk___rep (mk___split_fields file__split_fields7 file__split_fields8 file__split_fields9 file__split_fields10 file__split_fields11 file__split_fields12 file__split_fields13)) cur_position1 the_file)) (= (= result3 true) (= (fpeek (mk___rep (mk___split_fields file__split_fields7 file__split_fields8 file__split_fields9 file__split_fields10 file__split_fields11 file__split_fields12 file__split_fields13)) cur_position1 the_file) eof))) (ite (= result3 true) (and (and (and (= num1 r80b) (in_range4 r80b)) (and (and (and (and (= (ite (<= (to_rep1 (first (rt r))) (to_rep1 (last (rt r)))) (+ (- (to_rep1 (last (rt r))) (to_rep1 (first (rt r)))) 1) 0) (ite (<= 1 r80b) (+ (- r80b 1) 1) 0)) (and (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___644) (= (mk4 1 r80b) temp___6441))) (and (and (and (=> (<= 1 r80b) (and (and (<= (to_rep1 result____first) 1) (<= 1 (to_rep1 result____last))) (and (<= (to_rep1 result____first) r80b) (<= r80b (to_rep1 result____last))))) (= o20 result__)) (and (= o20 temp___646) (= (mk4 1 r80b) temp___6461))) (and (= (ite (<= (to_rep1 (first8 temp___6441)) (to_rep1 (last8 temp___6441))) (+ (- (to_rep1 (last8 temp___6441)) (to_rep1 (first8 temp___6441))) 1) 0) (ite (<= (to_rep1 (first8 temp___6461)) (to_rep1 (last8 temp___6461))) (+ (- (to_rep1 (last8 temp___6461)) (to_rep1 (first8 temp___6461))) 1) 0)) (= (mk___t4 temp___647 temp___6471) (mk___t4 temp___644 temp___6441))))) (forall ((temp___648 Int)) (ite (and (<= 1 temp___648) (<= temp___648 r80b)) (= (select o21 temp___648) (select temp___647 temp___648)) (= (select o21 temp___648) (select result__ temp___648))))) (and (= (mk_map__ref result4) (mk_map__ref result__)) (= result__2 o21)))) (and (and (= num2 num1) (and (= (mk___split_fields file__split_fields14 file__split_fields15 file__split_fields16 file__split_fields17 file__split_fields18 file__split_fields19 file__split_fields20) (mk___split_fields file__split_fields7 file__split_fields8 file__split_fields9 file__split_fields10 file__split_fields11 file__split_fields12 file__split_fields13)) (and (= cur_position2 cur_position1) (= the_file2 the_file)))) (and (= num2 num1) (and (= (mk___split_fields file__split_fields14 file__split_fields15 file__split_fields16 file__split_fields17 file__split_fields18 file__split_fields19 file__split_fields20) (mk___split_fields file__split_fields7 file__split_fields8 file__split_fields9 file__split_fields10 file__split_fields11 file__split_fields12 file__split_fields13)) (and (= cur_position2 cur_position1) (= the_file2 the_file1)))))) (and (and (and (forall ((idx2 Int)) (=> (and (<= 1 idx2) (<= idx2 num2)) (= (to_rep (select result__3 idx2)) (to_rep (select the_file2 (+ (- idx2 1) cur_position_at_start)))))) (and (= cur_position2 (+ cur_position_at_start num2)) (or (= (to_rep (select the_file2 cur_position2)) eof_ch) (= (to_rep (select the_file2 cur_position2)) 10)))) (and (in_range4 num2) (in_range2 cur_position2))) (= result__2 result__3))))) (= result__1 result__2))))))))))))) (and (and (= last12 (mk_int__ref last11)) (and (= buffer1 (mk_map__ref buffer)) (and (= num3 (mk_int__ref num2)) (and (= result__4 (mk_map__ref result__1)) (and (= file__split_fields21 (mk___split_fields__ref (mk___split_fields file__split_fields14 file__split_fields15 file__split_fields16 file__split_fields17 file__split_fields18 file__split_fields19 file__split_fields20))) (and (= cur_position3 (mk_int__ref cur_position2)) (= the_file3 (mk_map__ref the_file2)))))))) (and (= last13 last11) (and (= buffer2 buffer) (and (= num4 num2) (and (= result__5 result__1) (and (= file__split_fields22 (mk___split_fields file__split_fields14 file__split_fields15 file__split_fields16 file__split_fields17 file__split_fields18 file__split_fields19 file__split_fields20)) (and (= cur_position4 cur_position2) (= the_file4 the_file2))))))))))
(assert (<= 1 idx1))
(assert (<= idx1 (int__content num3)))
(assert (not (<= (to_rep1 result____first) idx1)))
(check-sat)
(exit)
