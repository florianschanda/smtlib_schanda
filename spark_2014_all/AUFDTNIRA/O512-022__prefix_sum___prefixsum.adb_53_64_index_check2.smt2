...
(assert (=> (= (mod2 (+ left3 1) space2) 0) (and (= result5 (all_left_elements_in a2 left3 o1)) (= (= result5 true) (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 7)) (=> (< k1 left3) (and (<= (- o1) (to_rep (select a2 k1))) (<= (to_rep (select a2 k1)) o1)))))))))
(assert (=> (not (= (mod2 (+ left3 1) space2) 0)) (= result5 false)))
(assert (=> (= result5 true) (and (= o (* space2 1000000)) (in_range3 (* space2 1000000)))))
(assert (=> (= result5 true) (and (= result4 (all_right_elements_in a2 (- left3 1) o)) (= (= result4 true) (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 7)) (=> (< (- left3 1) k1) (and (<= (- o) (to_rep (select a2 k1))) (<= (to_rep (select a2 k1)) o)))))))))
(assert (=> (not (= result5 true)) (= result4 false)))
(assert (=> (= result4 true) (= o2 (ite (= (mod2 (+ left3 1) (* space2 2)) space2) true false))))
(assert (=> (not (= result4 true)) (= o2 false)))
(assert (=> (<= 8 left3) (= o3 (ite (= left3 8) true (ite (= left3 9) true false)))))
(assert (=> (not (<= 8 left3)) (= o3 (distinct 1 0))))
(assert (= result3 (ite (and (= o2 true) (= o3 true)) true false)))
(assert (= result3 true))
(assert (<= 0 k))
(assert (<= k 7))
(assert (=> (and (<= 0 k) (<= k (- left3 space2))) (= result6 (ite (= (mod2 (+ k 1) (* 2 space2)) 0) true false))))
(assert (=> (not (and (<= 0 k) (<= k (- left3 space2)))) (= result6 false)))
(assert (= result6 true))
(assert (not (<= 0 (- k space2))))
(check-sat)
(exit)
