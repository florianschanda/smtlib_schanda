...
(assert (=> (= result true) (and (in_range11 auditalarm6) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields12)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields12)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields12)) true))))
(assert (=> (not (= result true)) (and (in_range11 auditalarm7) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields13)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields13)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields13)) true))))
