...
(assert (<= q1 r30b))
(assert (forall ((k2 Int)) (=> (and (<= (to_rep h__first) k2) (<= k2 (to_rep h__last))) (ite (< k2 q2) (= (to_rep1 (select h2 k2)) (to_rep1 (select h (+ k2 m1)))) (ite (< (+ q2 m1) k2) (= (to_rep1 (select h2 k2)) (to_rep1 (select h (- k2 m1)))) (= (to_rep1 (select h2 k2)) (to_rep1 (select h k2))))))))
(assert (and (and (=> (<= (to_rep h__first) r30b) (dynamic_property1 (to_rep h__first) r30b q2)) (=> (<= (- 2147483648) 2147483647) (in_range2 t3))) (and (<= (to_rep h__first) q2) (<= q2 r30b))))
(assert (<= (to_rep h__first) k))
(assert (<= k (to_rep h__last)))
(assert (< k q2))
(assert (and (<= (to_rep h__first) (+ k m1)) (<= (+ k m1) (to_rep h__last))))
(assert (= o (+ k m1)))
(assert (= o1 (select h o)))
