...
(assert (<= q1 r30b))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep h__first) k1) (<= k1 (to_rep h__last))) (ite (< k1 q2) (= (to_rep1 (select h1 k1)) (to_rep1 (select h (+ k1 m1)))) (ite (< (+ q2 m1) k1) (= (to_rep1 (select h1 k1)) (to_rep1 (select h (- k1 m1)))) (= (to_rep1 (select h1 k1)) (to_rep1 (select h k1))))))))
