...
(assert (= p2 o6))
(assert (not (= p2 0)))
(assert (and (= o9 (- p2 1)) (in_range4 (- p2 1))))
(assert (= (mk_int__ref result9) (mk_int__ref k)))
(assert (= k2 o9))
(assert (in_range4 k2))
(assert (=> (= (no_char_in_slice eof_ch cur_position_at_start (- (+ cur_position_at_start n) 2) the_file) true) (= k2 (- (find_char_in_slice 10 cur_position_at_start (- (+ cur_position_at_start n) 2) the_file) cur_position_at_start))))
(assert (and (= o17 (+ k2 2)) (in_range1 (+ k2 2))))
(assert (= result12 (ite (< n o17) true false)))
(assert (=> (= result12 true) (= result11 true)))
(assert (=> (not (= result12 true)) (and (= temp___594 (+ k2 2)) (in_range1 (+ k2 2)))))
(assert (=> (not (= result12 true)) (and (<= 1 temp___594) (<= temp___594 80))))
(assert (=> (not (= result12 true)) (= o13 temp___594)))
(assert (=> (not (= result12 true)) (= o14 (select buf3 o13))))
(assert (=> (not (= result12 true)) (= o15 (to_rep o14))))
(assert (=> (not (= result12 true)) (= o16 (ite (= o15 0) true false))))
(assert (=> (not (= result12 true)) (= result11 (ite (not (= o16 true)) true false))))
(assert (=> (= result11 true) (= (to_rep (select buf3 k2)) 0)))
(assert (=> (= result11 true) (and (= o18 (- k2 1)) (in_range4 (- k2 1)))))
(assert (=> (= result11 true) (= k2 result13)))
(assert (=> (= result11 true) (= k3 o18)))
(assert (=> (not (= result11 true)) (= k3 k2)))
