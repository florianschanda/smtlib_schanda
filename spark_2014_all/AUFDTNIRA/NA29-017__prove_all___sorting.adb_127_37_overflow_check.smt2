...
(assert (= o6 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (<= 0 j))
(assert (<= j 2147483647))
...
(assert (= o2 (- length1 o1)))
(assert (and (= o3 o2) (in_range1 o2)))
(assert (= o4 (ite (< l2 o3) l2 o3)))
