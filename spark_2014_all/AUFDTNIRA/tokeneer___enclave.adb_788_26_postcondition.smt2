...
(assert (and (and (and (= result (ispresent1 state1)) (ite (= result true) (ite (= writeok2 true) (and (and (= o (extractuser tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range9 auditalarm1) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true))) (and (in_range9 auditalarm2) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true))) (and (and (and (in_range9 auditalarm3) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true)) (and (and (= o1 (extractuser tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range9 auditalarm4) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true))) (and (in_range9 auditalarm5) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true)))) (and (= state5 state7) (and (= state4 state6) (and (= filestate filestate1) (and (= auditsystemfault auditsystemfault1) (and (= auditalarm2 auditalarm5) (and (= logfilestate__split_fields8 logfilestate__split_fields11) (and (= logfilesstatus logfilesstatus1) (= logfiles logfiles1)))))))))) (and (and (and (in_range9 auditalarm6) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields12)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields12)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields12)) true)) (and (and (= o2 (extractuser tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range9 auditalarm7) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields13)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields13)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields13)) true))) (and (in_range9 auditalarm8) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields14)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields14)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields14)) true)))) (and (and (= state5 state9) (and (= writtenstate2 writtenstate) (and (= state3 state1) (and (= state4 state8) (and (= filestate filestate2) (and (= writeok2 writeok) (and (= auditsystemfault auditsystemfault2) (and (= auditalarm2 auditalarm8) (and (= logfilestate__split_fields8 logfilestate__split_fields14) (and (= logfilesstatus logfilesstatus2) (= logfiles logfiles2))))))))))) (and (= state5 state9) (and (= writtenstate2 writtenstate1) (and (= state3 state2) (and (= state4 state8) (and (= filestate filestate2) (and (= writeok2 writeok1) (and (= auditsystemfault auditsystemfault2) (and (= auditalarm2 auditalarm8) (and (= logfilestate__split_fields8 logfilestate__split_fields14) (and (= logfilesstatus logfilesstatus2) (= logfiles logfiles2))))))))))))))) (and (and (= result1 (mk_int__ref status)) (= status1 3)) (and (and (not (= (isdoingop (mk___rep theadmin__split_fields2)) true)) (= (rolepresent (mk___rep theadmin__split_fields2)) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))) (= (ispresent (mk___rep theadmin__split_fields2)) true)))) (and (and (= state12 (mk___private__ref state5)) (and (= writtenstate3 (mk___private__ref writtenstate2)) (and (= state11 (mk___private__ref state3)) (and (= state10 (mk___private__ref state4)) (and (= filestate3 (mk___private__ref filestate)) (and (= writeok3 (mk_bool__ref writeok2)) (and (= theadmin__split_fields3 (mk___split_fields__ref theadmin__split_fields2)) (and (= status2 (mk_int__ref status1)) (and (= auditsystemfault3 (mk_bool__ref auditsystemfault)) (and (= auditalarm9 (mk_int__ref auditalarm2)) (and (= logfilestate__split_fields15 (mk___split_fields__ref2 logfilestate__split_fields8)) (and (= logfilesstatus3 (mk_map__ref4 logfilesstatus)) (= logfiles3 (mk_map__ref3 logfiles)))))))))))))) (and (= state15 state5) (and (= writtenstate4 writtenstate2) (and (= state14 state3) (and (= state13 state4) (and (= filestate4 filestate) (and (= writeok4 writeok2) (and (= theadmin__split_fields4 theadmin__split_fields2) (and (= status3 status1) (and (= auditsystemfault4 auditsystemfault) (and (= auditalarm10 auditalarm2) (and (= logfilestate__split_fields16 logfilestate__split_fields8) (and (= logfilesstatus4 logfilesstatus) (= logfiles4 logfiles))))))))))))))))
