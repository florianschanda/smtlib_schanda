...
(define-fun dynamic_invariant ((temp___expr_504 Int) (temp___is_init_501 Bool) (temp___skip_constant_502 Bool) (temp___do_toplevel_503 Bool)) Bool (=> (or (= temp___is_init_501 true) (<= 0 1)) (in_range4 temp___expr_504)))
...
(define-fun dynamic_invariant2 ((temp___expr_1260 Int) (temp___is_init_1257 Bool) (temp___skip_constant_1258 Bool) (temp___do_toplevel_1259 Bool)) Bool (=> (or (= temp___is_init_1257 true) (<= 0 1)) (in_range15 temp___expr_1260)))
...
(define-fun dynamic_invariant3 ((temp___expr_1282 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 0 1)) (in_range16 temp___expr_1282)))
...
(define-fun dynamic_invariant4 ((temp___expr_2366 Int) (temp___is_init_2363 Bool) (temp___skip_constant_2364 Bool) (temp___do_toplevel_2365 Bool)) Bool (=> (or (= temp___is_init_2363 true) (<= 0 7)) (in_range18 temp___expr_2366)))
...
(define-fun dynamic_invariant9 ((temp___expr_1060 Int) (temp___is_init_1057 Bool) (temp___skip_constant_1058 Bool) (temp___do_toplevel_1059 Bool)) Bool (=> (or (= temp___is_init_1057 true) (<= 0 17)) (in_range12 temp___expr_1060)))
(define-fun dynamic_invariant10 ((temp___expr_1039 Int) (temp___is_init_1036 Bool) (temp___skip_constant_1037 Bool) (temp___do_toplevel_1038 Bool)) Bool (=> (or (= temp___is_init_1036 true) (<= 1 17)) (in_range10 temp___expr_1039)))
(define-fun dynamic_invariant11 ((temp___expr_1164 Int) (temp___is_init_1161 Bool) (temp___skip_constant_1162 Bool) (temp___do_toplevel_1163 Bool)) Bool (=> (or (= temp___is_init_1161 true) (<= 0 2)) (in_range14 temp___expr_1164)))
(define-fun dynamic_invariant12 ((temp___expr_1045 Int) (temp___is_init_1042 Bool) (temp___skip_constant_1043 Bool) (temp___do_toplevel_1044 Bool)) Bool (=> (or (= temp___is_init_1042 true) (<= 0 17408)) (in_range11 temp___expr_1045)))
(define-fun dynamic_invariant13 ((temp___expr_1079 Int) (temp___is_init_1076 Bool) (temp___skip_constant_1077 Bool) (temp___do_toplevel_1078 Bool)) Bool (=> (or (= temp___is_init_1076 true) (<= 0 1024)) (in_range13 temp___expr_1079)))
(assert true)
...
(define-fun dynamic_invariant14 ((temp___expr_526 Int) (temp___is_init_523 Bool) (temp___skip_constant_524 Bool) (temp___do_toplevel_525 Bool)) Bool (=> (or (= temp___is_init_523 true) (<= 1 150)) (in_range5 temp___expr_526)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant15 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1901 2099)) (in_range6 temp___expr_572)))
(define-fun dynamic_invariant16 ((temp___expr_578 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 1 12)) (in_range7 temp___expr_578)))
(define-fun dynamic_invariant17 ((temp___expr_584 Int) (temp___is_init_581 Bool) (temp___skip_constant_582 Bool) (temp___do_toplevel_583 Bool)) Bool (=> (or (= temp___is_init_581 true) (<= 1 31)) (in_range8 temp___expr_584)))
(define-fun dynamic_invariant18 ((temp___expr_612 Int) (temp___is_init_609 Bool) (temp___skip_constant_610 Bool) (temp___do_toplevel_611 Bool)) Bool (=> (or (= temp___is_init_609 true) (<= 0 86399999)) (in_range9 temp___expr_612)))
(assert true)
(assert (forall ((latch__currentlatch Int)) (forall ((latch__state us_private)) (forall ((latch__latchtimeout__fields us_split_fields)) (! (=> (dynamic_invariant2 latch__currentlatch true true true) (= (latch_timeout latch__currentlatch latch__state latch__latchtimeout__fields) (mk___rep latch__latchtimeout__fields))) :pattern ((latch_timeout latch__currentlatch latch__state latch__latchtimeout__fields)))))))
(define-fun dynamic_invariant19 ((temp___expr_1607 Int) (temp___is_init_1604 Bool) (temp___skip_constant_1605 Bool) (temp___do_toplevel_1606 Bool)) Bool (=> (or (= temp___is_init_1604 true) (<= 0 2147483647)) (in_range17 temp___expr_1607)))
...
(declare-const thestats__split_fields4 us_split_fields6)
...
(declare-const thestats__split_fields5 us_split_fields6)
...
(declare-const thestats__split_fields6 us_split_fields__ref3)
...
(declare-const thestats__split_fields7 us_split_fields6)
