...
(define-fun dynamic_invariant ((temp___expr_565 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool) (temp___do_typ_inv_564 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 0 1)) (in_range4 temp___expr_565)))
...
(assert (forall ((x yearst)) (! (in_range6 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x monthst)) (! (in_range7 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x dayst)) (! (in_range8 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x millisecst)) (! (in_range9 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(declare-fun user_eq21 (t1 t1) Bool)
(declare-const dummy21 t1)
(declare-datatypes () ((t__ref1 (mk_t__ref1 (t__content1 t1)))))
(define-fun t__ref___2__projection ((a t__ref1)) t1 (t__content1 a))
(define-fun dynamic_invariant2 ((temp___expr_1412 Int) (temp___is_init_1408 Bool) (temp___skip_constant_1409 Bool) (temp___do_toplevel_1410 Bool) (temp___do_typ_inv_1411 Bool)) Bool (=> (or (= temp___is_init_1408 true) (<= 0 1)) (in_range15 temp___expr_1412)))
...
(declare-fun user_eq22 (t2 t2) Bool)
(declare-const dummy22 t2)
(declare-datatypes () ((t__ref2 (mk_t__ref2 (t__content2 t2)))))
(define-fun t__ref___3__projection ((a t__ref2)) t2 (t__content2 a))
(define-fun dynamic_invariant3 ((temp___expr_1435 Int) (temp___is_init_1431 Bool) (temp___skip_constant_1432 Bool) (temp___do_toplevel_1433 Bool) (temp___do_typ_inv_1434 Bool)) Bool (=> (or (= temp___is_init_1431 true) (<= 0 1)) (in_range16 temp___expr_1435)))
...
(declare-fun user_eq23 (statscount statscount) Bool)
(declare-const dummy23 statscount)
...
(declare-fun to_rep11 (statscount) Int)
(declare-fun of_rep11 (Int) statscount)
(assert (forall ((x statscount)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x statscount)) (! (in_range17 (to_rep11 x)) :pattern ((to_rep11 x)))))
(assert (forall ((x Int)) (! (=> (in_range17 x) (= (to_rep11 (of_rep11 x)) x)) :pattern ((to_rep11 (of_rep11 x))))))
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__stats__t__successentry statscount) (rec__stats__t__failentry statscount) (rec__stats__t__successbio statscount) (rec__stats__t__failbio statscount)))))
(define-fun us_split_fields_SuccessEntry__projection ((a us_split_fields6)) statscount (rec__stats__t__successentry a))
(define-fun us_split_fields_FailEntry__projection ((a us_split_fields6)) statscount (rec__stats__t__failentry a))
(define-fun us_split_fields_SuccessBio__projection ((a us_split_fields6)) statscount (rec__stats__t__successbio a))
(define-fun us_split_fields_FailBio__projection ((a us_split_fields6)) statscount (rec__stats__t__failbio a))
...
(define-fun us_rep___17__projection ((a us_rep4)) us_split_fields6 (us_split_fields7 a))
(define-fun bool_eq10 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (= (to_rep11 (rec__stats__t__successentry (us_split_fields7 a))) (to_rep11 (rec__stats__t__successentry (us_split_fields7 b)))) (= (to_rep11 (rec__stats__t__failentry (us_split_fields7 a))) (to_rep11 (rec__stats__t__failentry (us_split_fields7 b))))) (= (to_rep11 (rec__stats__t__successbio (us_split_fields7 a))) (to_rep11 (rec__stats__t__successbio (us_split_fields7 b))))) (= (to_rep11 (rec__stats__t__failbio (us_split_fields7 a))) (to_rep11 (rec__stats__t__failbio (us_split_fields7 b))))) true false))
...
(declare-datatypes () ((t__ref3 (mk_t__ref3 (t__content3 us_rep4)))))
(define-fun t__ref___4__projection ((a t__ref3)) us_rep4 (t__content3 a))
...
(declare-fun user_eq25 (statust1 statust1) Bool)
(declare-const dummy25 statust1)
...
(define-fun dynamic_invariant4 ((temp___expr_2558 Int) (temp___is_init_2554 Bool) (temp___skip_constant_2555 Bool) (temp___do_toplevel_2556 Bool) (temp___do_typ_inv_2557 Bool)) Bool (=> (or (= temp___is_init_2554 true) (<= 0 7)) (in_range18 temp___expr_2558)))
...
(define-fun dynamic_invariant9 ((temp___expr_1171 Int) (temp___is_init_1167 Bool) (temp___skip_constant_1168 Bool) (temp___do_toplevel_1169 Bool) (temp___do_typ_inv_1170 Bool)) Bool (=> (or (= temp___is_init_1167 true) (<= 0 17)) (in_range12 temp___expr_1171)))
(define-fun dynamic_invariant10 ((temp___expr_1178 Int) (temp___is_init_1174 Bool) (temp___skip_constant_1175 Bool) (temp___do_toplevel_1176 Bool) (temp___do_typ_inv_1177 Bool)) Bool (=> (or (= temp___is_init_1174 true) (<= 1 17)) (in_range10 temp___expr_1178)))
(define-fun dynamic_invariant11 ((temp___expr_1304 Int) (temp___is_init_1300 Bool) (temp___skip_constant_1301 Bool) (temp___do_toplevel_1302 Bool) (temp___do_typ_inv_1303 Bool)) Bool (=> (or (= temp___is_init_1300 true) (<= 0 2)) (in_range14 temp___expr_1304)))
(define-fun dynamic_invariant12 ((temp___expr_1185 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool) (temp___do_typ_inv_1184 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 0 17408)) (in_range11 temp___expr_1185)))
(define-fun dynamic_invariant13 ((temp___expr_1216 Int) (temp___is_init_1212 Bool) (temp___skip_constant_1213 Bool) (temp___do_toplevel_1214 Bool) (temp___do_typ_inv_1215 Bool)) Bool (=> (or (= temp___is_init_1212 true) (<= 0 1024)) (in_range13 temp___expr_1216)))
(assert true)
...
(assert (forall ((temp___1245 Int)) (=> (dynamic_invariant13 temp___1245 true true true true) (forall ((temp___1246 Int)) (= (to_rep9 (select (temp___1243 temp___1245) temp___1246)) temp___1245)))))
(define-fun dynamic_invariant14 ((temp___expr_590 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool) (temp___do_typ_inv_589 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 1 150)) (in_range5 temp___expr_590)))
...
(define-fun dynamic_invariant15 ((temp___expr_642 Int) (temp___is_init_638 Bool) (temp___skip_constant_639 Bool) (temp___do_toplevel_640 Bool) (temp___do_typ_inv_641 Bool)) Bool (=> (or (= temp___is_init_638 true) (<= 1901 2099)) (in_range6 temp___expr_642)))
(define-fun dynamic_invariant16 ((temp___expr_649 Int) (temp___is_init_645 Bool) (temp___skip_constant_646 Bool) (temp___do_toplevel_647 Bool) (temp___do_typ_inv_648 Bool)) Bool (=> (or (= temp___is_init_645 true) (<= 1 12)) (in_range7 temp___expr_649)))
(define-fun dynamic_invariant17 ((temp___expr_656 Int) (temp___is_init_652 Bool) (temp___skip_constant_653 Bool) (temp___do_toplevel_654 Bool) (temp___do_typ_inv_655 Bool)) Bool (=> (or (= temp___is_init_652 true) (<= 1 31)) (in_range8 temp___expr_656)))
(define-fun dynamic_invariant18 ((temp___expr_688 Int) (temp___is_init_684 Bool) (temp___skip_constant_685 Bool) (temp___do_toplevel_686 Bool) (temp___do_typ_inv_687 Bool)) Bool (=> (or (= temp___is_init_684 true) (<= 0 86399999)) (in_range9 temp___expr_688)))
(assert true)
...
(define-fun dynamic_invariant19 ((temp___expr_1781 Int) (temp___is_init_1777 Bool) (temp___skip_constant_1778 Bool) (temp___do_toplevel_1779 Bool) (temp___do_typ_inv_1780 Bool)) Bool (=> (or (= temp___is_init_1777 true) (<= 0 2147483647)) (in_range17 temp___expr_1781)))
(assert (forall ((temp___1241 Int)) (=> (dynamic_invariant10 temp___1241 true true true true) (forall ((temp___1242 Int)) (= (to_rep6 (select (temp___1239 temp___1241) temp___1242)) temp___1241)))))
...
(declare-const tokenremovaltimeout__split_fields yearst)
(declare-const tokenremovaltimeout__split_fields1 monthst)
(declare-const tokenremovaltimeout__split_fields2 dayst)
(declare-const tokenremovaltimeout__split_fields3 millisecst)
...
(assert (and (= result1 (greaterthan o1 (mk___rep (mk___split_fields tokenremovaltimeout__split_fields tokenremovaltimeout__split_fields1 tokenremovaltimeout__split_fields2 tokenremovaltimeout__split_fields3)))) (= (= result1 true) (or (or (or (< (to_rep2 tokenremovaltimeout__split_fields) (to_rep2 (rec__clock__timet__year (us_split_fields1 o1)))) (and (= (to_rep2 (rec__clock__timet__year (us_split_fields1 o1))) (to_rep2 tokenremovaltimeout__split_fields)) (< (to_rep3 tokenremovaltimeout__split_fields1) (to_rep3 (rec__clock__timet__month (us_split_fields1 o1)))))) (and (and (= (to_rep2 (rec__clock__timet__year (us_split_fields1 o1))) (to_rep2 tokenremovaltimeout__split_fields)) (= (to_rep3 (rec__clock__timet__month (us_split_fields1 o1))) (to_rep3 tokenremovaltimeout__split_fields1))) (< (to_rep4 tokenremovaltimeout__split_fields2) (to_rep4 (rec__clock__timet__day (us_split_fields1 o1)))))) (and (and (and (= (to_rep2 (rec__clock__timet__year (us_split_fields1 o1))) (to_rep2 tokenremovaltimeout__split_fields)) (= (to_rep3 (rec__clock__timet__month (us_split_fields1 o1))) (to_rep3 tokenremovaltimeout__split_fields1))) (= (to_rep4 (rec__clock__timet__day (us_split_fields1 o1))) (to_rep4 tokenremovaltimeout__split_fields2))) (< (to_rep5 tokenremovaltimeout__split_fields3) (to_rep5 (rec__clock__timet__millisec (us_split_fields1 o1)))))))))
(assert (= result1 true))
(assert (= o2 (extractuser (us_private__content state2))))
