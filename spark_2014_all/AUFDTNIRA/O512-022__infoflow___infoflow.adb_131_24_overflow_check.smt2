...
(assert (<= q_v21 r17b))
(assert (forall ((k Int)) (=> (and (<= (to_rep h_v2__first) k) (<= k (to_rep h_v2__last))) (ite (< k q_v22) (= (to_rep1 (select h_v21 k)) (to_rep1 (select h_v2 (+ k m_v21)))) (ite (< (+ q_v22 m_v21) k) (= (to_rep1 (select h_v21 k)) (to_rep1 (select h_v2 (- k m_v21)))) (= (to_rep1 (select h_v21 k)) (to_rep1 (select h_v2 k))))))))
(assert (and (and (=> (<= (to_rep h_v2__first) r17b) (dynamic_property2 (to_rep h_v2__first) r17b q_v22)) (=> (<= (- 2147483648) 2147483647) (in_range2 t_v21))) (and (<= (to_rep h_v2__first) q_v22) (<= q_v22 r17b))))
(assert (and (<= (to_rep h_v2__first) q_v22) (<= q_v22 (to_rep h_v2__last))))
(assert (= o q_v22))
(assert (= o1 (select h_v21 o)))
(assert (= o2 (to_rep1 o1)))
(assert (= t_v21 result2))
(assert (= t_v22 o2))
...
(assert (= o3 temp___392))
(assert (= o4 (select h_v21 o3)))
(assert (= o5 (to_rep1 o4)))
(assert (= (to_rep1 o6) o5))
(assert (and (<= (to_rep h_v2__first) q_v22) (<= q_v22 (to_rep h_v2__last))))
(assert (= o7 q_v22))
(assert (= o8 (store h_v21 o7 o6)))
(assert (= h_v21 result3))
(assert (= h_v22 o8))
(assert (= (to_rep1 o9) t_v22))
