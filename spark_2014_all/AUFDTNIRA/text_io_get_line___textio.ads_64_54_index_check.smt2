...
(assert (and (and (ite (< (to_rep1 item__last) (to_rep1 item__first)) (= last3 (- (to_rep1 item__first) 1)) (and (and (and (or (= last3 (- (to_rep1 item__first) 1)) (and (<= (to_rep1 item__first) last3) (<= last3 (to_rep1 item__last)))) (forall ((idx1 Int)) (=> (and (<= (to_rep1 item__first) idx1) (<= idx1 last3)) (= (to_rep (select item idx1)) (to_rep (select the_file (+ (- idx1 (to_rep1 item__first)) cur_position))))))) (= cur_position1 (+ (- (+ cur_position last3) (to_rep1 item__first)) 1))) (or (or (= last3 (to_rep1 item__last)) (= (to_rep (select the_file cur_position1)) eof_ch)) (= (to_rep (select the_file cur_position1)) 10)))) (and (in_range4 last3) (in_range2 cur_position1))) (and (and (and (= current_in__split_fields14 current_in__split_fields7) (and (= current_in__split_fields15 current_in__split_fields8) (and (= current_in__split_fields16 current_in__split_fields9) (and (= current_in__split_fields17 current_in__split_fields10) (and (= current_in__split_fields18 current_in__split_fields11) (and (= current_in__split_fields19 current_in__split_fields12) (= current_in__split_fields20 current_in__split_fields13))))))) (and (= last3 last4) (and (= item item1) (= cur_position1 cur_position2)))) (and (= (mk___split_fields current_in__split_fields21 current_in__split_fields22 current_in__split_fields23 current_in__split_fields24 current_in__split_fields25 current_in__split_fields26 current_in__split_fields27) (mk___split_fields current_in__split_fields7 current_in__split_fields8 current_in__split_fields9 current_in__split_fields10 current_in__split_fields11 current_in__split_fields12 current_in__split_fields13)) (and (= last5 last3) (and (= item2 item) (= cur_position3 cur_position1)))))))
