...
(assert (=> (= (int__content status3) 8) (and (= o26 (rolepresent (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (and (in_range6 o26) (= o26 (to_rep3 (rec__admin__t__rolepresent (us_split_fields__content1 theadmin__split_fields4))))))))
...
(assert (=> (= (int__content status3) 3) (and (= o20 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (and (in_range6 o20) (= o20 (to_rep3 theadmin__split_fields))))))
(assert (=> (= (int__content status3) 3) (and (= o21 (rolepresent (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (and (in_range6 o21) (= o21 (to_rep3 (rec__admin__t__rolepresent (us_split_fields__content1 theadmin__split_fields4))))))))
...
(assert (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7)) (and (= o14 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (and (in_range6 o14) (= o14 (to_rep3 theadmin__split_fields))))))
(assert (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7)) (and (= o15 (rolepresent (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (and (in_range6 o15) (= o15 (to_rep3 (rec__admin__t__rolepresent (us_split_fields__content1 theadmin__split_fields4))))))))
(assert (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7)) (= o16 (ite (= o15 o14) true false))))
(assert (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7)) (and (= o12 (ispresent (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (= (= o12 true) (in_range9 (to_rep3 (rec__admin__t__rolepresent (us_split_fields__content1 theadmin__split_fields4))))))))
...
(assert (and (= o4 (rolepresent (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (and (in_range6 o4) (= o4 (to_rep3 (rec__admin__t__rolepresent (us_split_fields__content1 theadmin__split_fields4)))))))
