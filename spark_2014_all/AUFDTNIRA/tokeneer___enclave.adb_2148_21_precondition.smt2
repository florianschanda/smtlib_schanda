...
(assert (and (= o18 (thecurrentop (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (in_range8 o18)))
(assert (= o19 (ite (= o18 4) true false)))
(assert (and (= o20 (isdoingop (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (= (= o20 true) (in_range8 (to_rep4 (rec__admin__t__currentop (us_split_fields__content1 theadmin__split_fields4)))))))
(assert (= result5 (ite (= o20 true) o19 false)))
(assert (=> (= result5 true) (= o21 (ite (= (int__content status3) 6) true false))))
(assert (=> (not (= result5 true)) (= o21 (of_int 1))))
...
(assert (= result6 (ite (= o12 1) true false)))
(assert (=> (= result6 true) (and (= o14 (isdoingop (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (= (= o14 true) (in_range8 (to_rep4 (rec__admin__t__currentop (us_split_fields__content1 theadmin__split_fields4))))))))
(assert (=> (= result6 true) (= o15 (ite (not (= o14 true)) true false))))
(assert (=> (= result6 true) (and (= result7 (isdoingop (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (= (= result7 true) (in_range8 (to_rep4 (rec__admin__t__currentop (us_split_fields__content1 theadmin__split_fields4))))))))
(assert (=> (= result6 true) (=> (= result7 true) (and (= o13 (thecurrentop (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (in_range8 o13)))))
(assert (=> (= result6 true) (=> (= result7 true) (= o16 (ite (= o13 3) true false)))))
(assert (=> (= result6 true) (=> (not (= result7 true)) (= o16 false))))
(assert (=> (= result6 true) (= o17 (ite (= o16 false) o15 true))))
(assert (=> (not (= result6 true)) (= o17 (of_int 1))))
(assert (and (= result8 (isdoingop (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (= (= result8 true) (in_range8 (to_rep4 (rec__admin__t__currentop (us_split_fields__content1 theadmin__split_fields4)))))))
(assert (= result8 true))
