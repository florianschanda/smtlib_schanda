...
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (forall ((j Int)) (=> (and (<= (to_rep (first (rt array2))) j) (<= j index23)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) index11))))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (forall ((j Int)) (=> (and (<= (to_rep (first (rt array2))) j) (<= j index23)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j))))))))
...
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (forall ((i Int)) (=> (and (<= (to_rep (first (rt array1))) i) (<= i index12)) (forall ((j Int)) (=> (and (<= (to_rep (first (rt array2))) j) (<= j (to_rep (last (rt array2))))) (= (to_rep (select (select result__8 (+ (+ (* (- i (to_rep (first (rt array1)))) (length array2)) (- j (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) i)))))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (forall ((i Int)) (=> (and (<= (to_rep (first (rt array1))) i) (<= i index12)) (forall ((j Int)) (=> (and (<= (to_rep (first (rt array2))) j) (<= j (to_rep (last (rt array2))))) (= (to_rep (select (select result__8 (+ (+ (* (- i (to_rep (first (rt array1)))) (length array2)) (- j (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j)))))))))
...
(assert (forall ((i Int)) (=> (and (<= (to_rep (first (rt array1))) i) (<= i (to_rep (last (rt array1))))) (forall ((j Int)) (=> (and (<= (to_rep (first (rt array2))) j) (<= j (to_rep (last (rt array2))))) (= (to_rep (select (select (map__content1 result__11) (+ (+ (* (- i (to_rep (first (rt array1)))) (length array2)) (- j (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) i))))))))
(declare-const i Int)
...
(assert (not (= (to_rep (select (select (map__content1 result__11) (+ (+ (* (- i (to_rep (first (rt array1)))) (length array2)) (- j (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j)))))
(check-sat)
(exit)
