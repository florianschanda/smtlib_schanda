...
(assert (<= (to_rep (rec__sums__slice_bounds__lo result____split_fields4)) (to_rep1 (rec__sums__slice_bounds__hi result____split_fields4))))
(assert (=> (<= (to_rep3 (first (rt x))) (to_rep (rec__sums__slice_bounds__lo result____split_fields4))) (= result8 (ite (<= (to_rep1 (rec__sums__slice_bounds__hi result____split_fields4)) (to_rep3 (last (rt x)))) true false))))
(assert (=> (not (<= (to_rep3 (first (rt x))) (to_rep (rec__sums__slice_bounds__lo result____split_fields4)))) (= result8 false)))
(assert (= result8 true))
(assert (not (or (< (to_rep1 (rec__sums__slice_bounds__hi result____split_fields4)) (to_rep (rec__sums__slice_bounds__lo result____split_fields4))) (and (<= (to_rep3 (first (rt x))) (to_rep (rec__sums__slice_bounds__lo result____split_fields4))) (<= (to_rep1 (rec__sums__slice_bounds__hi result____split_fields4)) (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
