...
(assert (=> (= (ite (= (is_prime value) false) (= mode 0) false) true) (and (< value test_prime_and_coprime_numbers__p__nearest_prime_number__result4) (forall ((v1 Int)) (=> (and (<= value v1) (<= v1 (- test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1))) (not (= (is_prime v1) true)))))))
(assert (=> (= (ite (= (is_prime value) false) (= mode 1) false) true) (and (< test_prime_and_coprime_numbers__p__nearest_prime_number__result4 value) (forall ((v1 Int)) (=> (and (<= (+ test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1) v1) (<= v1 value)) (not (= (is_prime v1) true)))))))
(assert (= (ite (= (is_prime value) false) (= mode 2) false) true))
(assert (and (= o5 (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4)) (in_range1 (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))))
(assert (= o6 (abs o5)))
...
(assert (= (= result1 true) (forall ((v1 Int)) (=> (and (<= (ite (< 0 (+ (- value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1)) (+ (- value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1) 0) v1) (<= v1 value)) (not (= (is_prime v1) true))))))
(assert (= result1 true))
