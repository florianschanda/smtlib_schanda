...
(assert (= result3 (ite (= o23 true) (ite (<= v3 value) true false) false)))
(assert (= (= result2 true) (forall ((v4 Int)) (=> (and (<= (ite (< 0 (+ (- value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1)) (+ (- value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1) 0) v4) (<= v4 value)) (not (= (is_prime v4) true))))))
(assert (= result2 true))
