...
(assert (not (= (to_rep2 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content1 logfilestate__split_fields22))) (+ (* (- (to_rep3 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) 1) 1024) (to_rep4 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields22)) (to_rep1 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields22)))))))))
(check-sat)
(exit)
