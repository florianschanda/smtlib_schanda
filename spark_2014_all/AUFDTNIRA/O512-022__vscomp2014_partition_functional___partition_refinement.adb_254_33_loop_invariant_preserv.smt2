...
(define-fun default_initial_assumption ((temp___expr_364 us_rep) (temp___skip_top_level_365 Bool)) Bool (= (to_rep3 (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields1 temp___expr_364))) 0))
...
(define-fun dynamic_invariant ((temp___expr_350 Int) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool) (temp___do_typ_inv_349 Bool)) Bool (=> (or (= temp___is_init_346 true) (<= 1 2147483647)) (in_range6 temp___expr_350)))
...
(define-fun dynamic_invariant1 ((temp___expr_540 Int) (temp___is_init_536 Bool) (temp___skip_constant_537 Bool) (temp___do_toplevel_538 Bool) (temp___do_typ_inv_539 Bool)) Bool (=> (or (= temp___is_init_536 true) (<= 1 2147483647)) (in_range7 temp___expr_540)))
(assert (forall ((attr__tag Int)) (forall ((container us_rep5)) (forall ((position us_rep4)) (! (dynamic_invariant1 (key1 attr__tag container position) true false true true) :pattern ((key1 attr__tag container position)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_547 Int) (temp___is_init_543 Bool) (temp___skip_constant_544 Bool) (temp___do_toplevel_545 Bool) (temp___do_typ_inv_546 Bool)) Bool (=> (or (= temp___is_init_543 true) (<= 0 5)) (in_range8 temp___expr_547)))
(assert (forall ((attr__tag Int)) (forall ((container us_rep5)) (forall ((position us_rep4)) (! (dynamic_invariant2 (element2 attr__tag container position) true false true true) :pattern ((element2 attr__tag container position)))))))
...
(define-fun capacity ((container us_rep10)) Int (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity (us_split_discrs5 container))) 10001))
(declare-fun capacity__function_guard (Int us_rep10) Bool)
(define-fun dynamic_invariant3 ((temp___expr_799 Int) (temp___is_init_795 Bool) (temp___skip_constant_796 Bool) (temp___do_toplevel_797 Bool) (temp___do_typ_inv_798 Bool)) Bool (=> (or (= temp___is_init_795 true) (<= 0 10001)) (in_range11 temp___expr_799)))
(declare-fun length1 (us_rep10) Int)
(declare-fun length__function_guard1 (Int us_rep10) Bool)
(assert (forall ((container us_rep10)) (! (let ((result (length1 container))) (and (<= result (capacity container)) (dynamic_invariant3 result true false true true))) :pattern ((length1 container)))))
...
(define-fun bool_eq12 ((a (Array Int partition_index)) (a__first Int) (a__last Int) (b (Array Int partition_index)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep4 (select a temp___idx_156)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_156))))))) true false))
(assert (forall ((a (Array Int partition_index)) (b (Array Int partition_index))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq12 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep4 (select a temp___idx_156)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_156)))))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_326 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool) (temp___do_typ_inv_325 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 0 6)) (in_range3 temp___expr_326)))
(define-fun dynamic_invariant6 ((temp___expr_333 Int) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool) (temp___do_typ_inv_332 Bool)) Bool (=> (or (= temp___is_init_329 true) (<= 0 5)) (in_range4 temp___expr_333)))
...
(define-fun dynamic_invariant8 ((temp___expr_176 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= 0 2147483647)) (in_range5 temp___expr_176)))
(assert (= no_element (mk___rep (mk___split_fields (of_rep3 0)))))
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= result (to_rep3 (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 container)))) (dynamic_invariant8 result true false true true))) :pattern ((length container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_423 us_rep2) (temp___skip_top_level_424 Bool)) Bool (=> (not (= temp___skip_top_level_424 true)) (and (= (is_empty temp___expr_423) true) (= (length4 temp___expr_423) 0))))
(define-fun default_initial_assumption3 ((temp___expr_409 us_rep) (temp___skip_top_level_410 Bool)) Bool (= (to_rep3 (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields1 temp___expr_409))) 0))
...
(assert (forall ((container us_rep2)) (forall ((key2 us_rep)) (! (=> (= (distinct 0 0) true) (=> (exists ((k us_rep)) (and (= (has_key container k) true) (= (bool_eq1 k key2) true))) (= (has_key container key2) true))) :pattern ((has_key container key2))))))
...
(assert (forall ((container us_rep2)) (forall ((key2 us_rep)) (! (=> (= (has_key container key2) true) (let ((result (get1 container key2))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key2))) (forall ((k us_rep)) (=> (= (has_key container k) true) (= (= (bool_eq1 k key2) true) (= (witness container key2) (witness container k))))))) (dynamic_invariant11 result true false true true)))) :pattern ((get1 container key2))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant8 (length4 container) true false true true) :pattern ((length4 container)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 us_rep)) (! (=> (= (has_key container key2) true) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant8 result true false true true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant8 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant11 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
...
(assert (forall ((container us_rep5)) (! (let ((result (length5 container))) (and (<= result (to_rep3 (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs3 container)))) (dynamic_invariant8 result true false true true))) :pattern ((length5 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep5)) (! (dynamic_invariant8 (length6 attr__tag container) true false true true) :pattern ((length6 attr__tag container))))))
...
(define-fun k_is_find ((container us_rep7) (key2 Int) (position Int)) Bool (and (ite (< 0 position) (k_bigger_than_range container 1 (- position 1) key2) (distinct 1 0)) (ite (< position (length7 container)) (k_smaller_than_range container (+ position 1) (length7 container) key2) (distinct 1 0))))
...
(define-fun default_initial_assumption4 ((temp___expr_628 us_rep7) (temp___skip_top_level_629 Bool)) Bool (=> (not (= temp___skip_top_level_629 true)) (= (length7 temp___expr_628) 0)))
(assert (forall ((container us_rep7)) (forall ((key2 Int)) (! (=> (dynamic_invariant1 key2 true true true true) (let ((result (find2 container key2))) (and (=> (< 0 result) (and (<= result (length7 container)) (= (equivalent_keys key2 (get2 container result)) true))) (dynamic_invariant8 result true false true true)))) :pattern ((find2 container key2))))))
...
(define-fun default_initial_assumption5 ((temp___expr_592 us_rep8) (temp___skip_top_level_593 Bool)) Bool (=> (not (= temp___skip_top_level_593 true)) (and (= (is_empty1 temp___expr_592) true) (= (length8 temp___expr_592) 0))))
(assert true)
...
(define-fun default_initial_assumption6 ((temp___expr_651 us_rep6) (temp___skip_top_level_652 Bool)) Bool (=> (not (= temp___skip_top_level_652 true)) (and (= (is_empty2 temp___expr_651) true) (= (length9 temp___expr_651) 0))))
...
(assert true)
(assert (forall ((attr__tag Int) (key2 Int)) (forall ((container us_rep5)) (! (=> (dynamic_invariant1 key2 true true true true) (dynamic_invariant2 (element__21 attr__tag container key2) true false true true)) :pattern ((element__21 attr__tag container key2))))))
...
(assert (forall ((container us_rep8)) (forall ((key2 Int)) (! (=> (dynamic_invariant12 key2 true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range15 k) (= (has_key2 container k) true)) (= (equivalent_keys k key2) true))) (= (has_key2 container key2) true)))) :pattern ((has_key2 container key2))))))
...
(assert (forall ((container us_rep8)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant12 key2 true true true true) (= (has_key2 container key2) true)) (let ((result (get4 container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k Int)) (=> (and (in_range15 k) (= (has_key2 container k) true)) (= (= (equivalent_keys k key2) true) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant13 result true false true true)))) :pattern ((get4 container key2))))))
(assert (forall ((container us_rep8)) (! (dynamic_invariant8 (length8 container) true false true true) :pattern ((length8 container)))))
...
(assert true)
(assert (forall ((container us_rep8)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant12 key2 true true true true) (= (has_key2 container key2) true)) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant8 result true false true true)))) :pattern ((witness1 container key2))))))
...
(assert (forall ((container us_rep7)) (! (let ((result (length7 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant8 result true false true true))) :pattern ((length7 container)))))
...
(assert (forall ((container us_rep6)) (forall ((key2 us_rep4)) (! (=> (= (distinct 0 0) true) (=> (exists ((k us_rep4)) (and (= (has_key1 container k) true) (= (bool_eq5 k key2) true))) (= (has_key1 container key2) true))) :pattern ((has_key1 container key2))))))
...
(assert (forall ((container us_rep6)) (forall ((key2 us_rep4)) (! (=> (= (has_key1 container key2) true) (let ((result (get3 container key2))) (and (=> (= (distinct 0 0) true) (and (= result (w_get2 container (witness2 container key2))) (forall ((k us_rep4)) (=> (= (has_key1 container k) true) (= (= (bool_eq5 k key2) true) (= (witness2 container key2) (witness2 container k))))))) (dynamic_invariant16 result true false true true)))) :pattern ((get3 container key2))))))
(assert (forall ((container us_rep6)) (! (dynamic_invariant8 (length9 container) true false true true) :pattern ((length9 container)))))
...
(assert true)
(assert (forall ((container us_rep6)) (forall ((key2 us_rep4)) (! (=> (= (has_key1 container key2) true) (let ((result (witness2 container key2))) (and (= (has_witness2 container result) true) (dynamic_invariant8 result true false true true)))) :pattern ((witness2 container key2))))))
(assert (forall ((container us_rep6)) (forall ((witness3 Int)) (! (=> (and (dynamic_invariant8 witness3 true true true true) (= (has_witness2 container witness3) true)) (dynamic_invariant16 (w_get2 container witness3) true false true true)) :pattern ((w_get2 container witness3))))))
...
(define-fun dynamic_invariant18 ((temp___expr_775 Int) (temp___is_init_771 Bool) (temp___skip_constant_772 Bool) (temp___do_toplevel_773 Bool) (temp___do_typ_inv_774 Bool)) Bool (=> (or (= temp___is_init_771 true) (<= 0 10000)) (in_range10 temp___expr_775)))
...
(assert (and (<= (* 2 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (<= (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 5000) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (to_rep (select a j))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c) true) (= (to_rep (select a (element1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c))) (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c)))) (and (forall ((c us_rep)) (=> (= (has_key (positions x) c) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x c)) true))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= 0 (to_rep4 (select f j))) (<= (to_rep4 (select f j)) (- (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j)))))) j) (<= j (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j)))))))))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j)))) k) (<= k (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j)))))) (= (to_rep4 (select f k)) j))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))) (= (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j)))) 0))))))))))))
...
(assert (and (= o (element x (mk___rep c__split_fields1))) (and (in_range6 o) (= o (get (model__ x) (get1 (positions x) (mk___rep c__split_fields1)))))))
(assert (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a1 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o)) (to_rep (select a (+ (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))) (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o)))))))))) (ite (= k (+ (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))) (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))))) (to_rep (select a (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))) (to_rep (select a k))))))) (and (= (capacity (mk___rep5 p__split_discrs p__split_fields1)) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (= (length1 (mk___rep5 p__split_discrs p__split_fields1)) (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields1)) (to_rep (select a1 j))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields1)) c) true) (= (to_rep (select a1 (element1 (mk___rep3 d__split_discrs d__split_fields1) c))) (key (mk___rep3 d__split_discrs d__split_fields1) c)))) (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c) true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields1)) c) true)))))))))
...
(assert (= (capacity (mk___rep5 p__split_discrs p__split_fields2)) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))
(assert (= (length1 (mk___rep5 p__split_discrs p__split_fields2)) (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))
...
(assert (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= 0 (to_rep4 (select f j))) (<= (to_rep4 (select f j)) (- (length1 (mk___rep5 p__split_discrs p__split_fields2)) 1))))))
(assert (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) (to_rep4 (select f j)))))) j) (<= j (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) (to_rep4 (select f j)))))))))))
(assert (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (length1 (mk___rep5 p__split_discrs p__split_fields2)) 1))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) j)))) k) (<= k (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) j)))))) (= (to_rep4 (select f k)) j))))))
...
(assert (and (= o2 (element x (mk___rep c__split_fields3))) (and (in_range6 o2) (= o2 (get (model__ x) (get1 (positions x) (mk___rep c__split_fields3)))))))
(assert (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a3 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o2)) (to_rep (select a2 (+ (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o2))))))) (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o2)))))))))) (ite (= k (+ (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o2))))))) (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o2))))))))) (to_rep (select a2 (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o2))) (to_rep (select a2 k))))))) (and (= (capacity (mk___rep5 p__split_discrs p__split_fields3)) (capacity (mk___rep5 p__split_discrs p__split_fields2))) (and (= (length1 (mk___rep5 p__split_discrs p__split_fields3)) (length1 (mk___rep5 p__split_discrs p__split_fields2))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (to_rep (select a3 j))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c) true) (= (to_rep (select a3 (element1 (mk___rep3 d__split_discrs d__split_fields3) c))) (key (mk___rep3 d__split_discrs d__split_fields3) c)))) (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c) true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c) true)))))))))
...
(assert (<= 0 j))
(assert (<= j 5))
(assert (not (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (to_rep (select a3 j))) true)))
(check-sat)
(exit)
