...
(assert (forall ((x index_count)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x index)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep3 (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields1 a))) (to_rep3 (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields1 b)))) true false))
...
(define-fun default_initial_assumption ((temp___expr_332 us_rep) (temp___skip_top_level_333 Bool)) Bool (= (to_rep3 (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields1 temp___expr_332))) 0))
...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep3 (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 a))) (to_rep3 (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 b)))) (= (us_main_eq (rec__partition_refinement__partitioning_sets__list (us_split_fields3 a)) (rec__partition_refinement__partitioning_sets__list (us_split_fields3 b))) true)) true false))
...
(define-fun element ((container us_rep1) (position us_rep)) Int (get (model__ container) (get1 (positions container) position)))
...
(define-fun dynamic_invariant ((temp___expr_320 Int) (temp___is_init_317 Bool) (temp___skip_constant_318 Bool) (temp___do_toplevel_319 Bool)) Bool (=> (or (= temp___is_init_317 true) (<= 1 2147483647)) (in_range6 temp___expr_320)))
...
(assert (forall ((container us_rep1)) (! (let ((result (first container))) (ite (= (length container) 0) (= (bool_eq1 result no_element) true) (and (= (has_element container result) true) (= (get1 (positions container) result) 1)))) :pattern ((first container)))))
...
(define-fun bool_eq5 ((a us_rep4) (b us_rep4)) Bool (ite (= (to_rep3 (rec__partition_refinement__inverse_sets__cursor__node (us_split_fields5 a))) (to_rep3 (rec__partition_refinement__inverse_sets__cursor__node (us_split_fields5 b)))) true false))
...
(define-fun bool_eq6 ((a us_rep5) (b us_rep5)) Bool (ite (and (= (to_rep3 (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs3 a))) (to_rep3 (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs3 b)))) (= (us_main_eq3 (rec__partition_refinement__inverse_sets__map (us_split_fields7 a)) (rec__partition_refinement__inverse_sets__map (us_split_fields7 b))) true)) true false))
...
(assert (forall ((a us_rep5) (b us_rep5)) (! (= (user_eq12 a b) (oeq a b)) :pattern ((user_eq12 a b)))))
(assert true)
...
(declare-fun user_eq15 (key_type key_type) Bool)
(declare-const dummy15 key_type)
...
(define-fun dynamic_invariant1 ((temp___expr_497 Int) (temp___is_init_494 Bool) (temp___skip_constant_495 Bool) (temp___do_toplevel_496 Bool)) Bool (=> (or (= temp___is_init_494 true) (<= 1 2147483647)) (in_range7 temp___expr_497)))
(assert (forall ((attr__tag Int)) (forall ((container us_rep5)) (forall ((position us_rep4)) (! (dynamic_invariant1 (key1 attr__tag container position) true false true) :pattern ((key1 attr__tag container position)))))))
...
(declare-fun user_eq16 (us_rep8 us_rep8) Bool)
(declare-const dummy16 us_rep8)
...
(define-fun dynamic_invariant2 ((temp___expr_503 Int) (temp___is_init_500 Bool) (temp___skip_constant_501 Bool) (temp___do_toplevel_502 Bool)) Bool (=> (or (= temp___is_init_500 true) (<= 0 5)) (in_range8 temp___expr_503)))
(assert (forall ((attr__tag Int)) (forall ((container us_rep5)) (forall ((position us_rep4)) (! (dynamic_invariant2 (element2 attr__tag container position) true false true) :pattern ((element2 attr__tag container position)))))))
...
(assert (forall ((container us_rep5)) (forall ((key2 Int)) (! (=> (dynamic_invariant1 key2 true true true) (let ((result (find container key2))) (ite (not (= (has_key2 (model__1 container) key2) true)) (and (not (= (has_key1 (positions1 container) result) true)) (= (bool_eq5 result no_element1) true)) (and (and (= (has_key1 (positions1 container) result) true) (= (get3 (positions1 container) result) (find2 (keys container) key2))) (= (equivalent_keys (key container result) key2) true))))) :pattern ((find container key2))))))
(assert true)
...
(assert (forall ((a us_rep5) (b us_rep5)) (! (= (user_eq18 a b) (oeq a b)) :pattern ((user_eq18 a b)))))
...
(declare-fun user_eq20 (index_type index_type) Bool)
(declare-const dummy20 index_type)
...
(define-fun bool_eq10 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 a))) (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 b)))) (= (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 a))) (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 b))))) (= (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 a))) (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 b))))) true false))
...
(declare-datatypes () ((element_type__ref2 (mk_element_type__ref2 (element_type__content2 us_rep9)))))
(define-fun element_type__ref___8__projection ((a element_type__ref2)) us_rep9 (element_type__content2 a))
(declare-sort capacity_range 0)
(define-fun in_range11 ((x Int)) Bool (and (<= 0 x) (<= x 10001)))
(declare-fun attr__ATTRIBUTE_IMAGE11 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check11 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE11 (us_image) Int)
(declare-fun user_eq22 (capacity_range capacity_range) Bool)
(declare-const dummy22 capacity_range)
...
(assert (forall ((x capacity_range)) (! (in_range11 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_733 Int) (temp___is_init_730 Bool) (temp___skip_constant_731 Bool) (temp___do_toplevel_732 Bool)) Bool (=> (or (= temp___is_init_730 true) (<= 0 10001)) (in_range11 temp___expr_733)))
(declare-fun length1 (us_rep10) Int)
(declare-fun length__function_guard1 (Int us_rep10) Bool)
(assert (forall ((container us_rep10)) (! (let ((result (length1 container))) (and (<= result (capacity container)) (dynamic_invariant3 result true false true))) :pattern ((length1 container)))))
(declare-datatypes () ((element_type__ref3 (mk_element_type__ref3 (element_type__content3 us_rep9)))))
(define-fun element_type__ref___9__projection ((a element_type__ref3)) us_rep9 (element_type__content3 a))
...
(define-fun dynamic_invariant5 ((temp___expr_299 Int) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool)) Bool (=> (or (= temp___is_init_296 true) (<= 0 6)) (in_range3 temp___expr_299)))
(define-fun dynamic_invariant6 ((temp___expr_305 Int) (temp___is_init_302 Bool) (temp___skip_constant_303 Bool) (temp___do_toplevel_304 Bool)) Bool (=> (or (= temp___is_init_302 true) (<= 0 5)) (in_range4 temp___expr_305)))
(define-fun dynamic_invariant7 ((temp___expr_706 Int) (temp___is_init_703 Bool) (temp___skip_constant_704 Bool) (temp___do_toplevel_705 Bool)) Bool (=> (or (= temp___is_init_703 true) (<= 0 10000)) (in_range9 temp___expr_706)))
(define-fun dynamic_invariant8 ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= 0 2147483647)) (in_range5 temp___expr_152)))
(assert (= no_element (mk___rep (mk___split_fields (of_rep3 0)))))
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= result (to_rep3 (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 container)))) (dynamic_invariant8 result true false true))) :pattern ((length container)))))
...
(define-fun oeq2 ((left us_rep3) (right us_rep3)) Bool (and (= (length3 left) (length3 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last1 left))) (= (get left n) (get right n)))) true false)))
(declare-fun oeq__function_guard2 (Bool us_rep3 us_rep3) Bool)
(assert (forall ((a us_rep3) (b us_rep3)) (! (= (user_eq8 a b) (oeq2 a b)) :pattern ((user_eq8 a b)))))
(define-fun default_initial_assumption1 ((temp___expr_364 us_rep3) (temp___skip_top_level_365 Bool)) Bool (=> (not (= temp___skip_top_level_365 true)) (= (length3 temp___expr_364) 0)))
(assert (forall ((container us_rep1)) (! (= (length3 (model__ container)) (length container)) :pattern ((model__ container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_383 us_rep2) (temp___skip_top_level_384 Bool)) Bool (=> (not (= temp___skip_top_level_384 true)) (and (= (is_empty temp___expr_383) true) (= (length4 temp___expr_383) 0))))
(define-fun default_initial_assumption3 ((temp___expr_371 us_rep) (temp___skip_top_level_372 Bool)) Bool (= (to_rep3 (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields1 temp___expr_371))) 0))
(assert (forall ((container us_rep1)) (! (let ((result (positions container))) (and (not (= (has_key result no_element) true)) (forall ((i us_rep)) (=> (= (has_key result i) true) (and (and (<= 1 (get1 result i)) (<= (get1 result i) (length container))) (forall ((j us_rep)) (=> (= (has_key result j) true) (=> (= (get1 result i) (get1 result j)) (= (bool_eq1 i j) true))))))))) :pattern ((positions container)))))
...
(define-fun dynamic_invariant9 ((temp___expr_357 Int) (temp___is_init_354 Bool) (temp___skip_constant_355 Bool) (temp___do_toplevel_356 Bool)) Bool (=> (or (= temp___is_init_354 true) (<= 0 2147483647)) (in_range12 temp___expr_357)))
(assert (forall ((container us_rep3)) (! (let ((result (length3 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant8 result true false true))) :pattern ((length3 container)))))
...
(define-fun dynamic_invariant10 ((temp___expr_351 Int) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool)) Bool (=> (or (= temp___is_init_348 true) (<= 1 2147483647)) (in_range13 temp___expr_351)))
(assert (forall ((container us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant9 position true true true) (and (<= 1 position) (<= position (last1 container)))) (dynamic_invariant10 (get container position) true false true)) :pattern ((get container position))))))
...
(define-fun dynamic_invariant11 ((temp___expr_376 Int) (temp___is_init_373 Bool) (temp___skip_constant_374 Bool) (temp___do_toplevel_375 Bool)) Bool (=> (or (= temp___is_init_373 true) (<= 1 2147483647)) (in_range14 temp___expr_376)))
...
(assert (forall ((container us_rep2)) (forall ((key2 us_rep)) (! (=> (= (has_key container key2) true) (let ((result (get1 container key2))) (and (=> (= (of_int 0) true) (and (= result (w_get container (witness container key2))) (forall ((k us_rep)) (=> (= (has_key container k) true) (= (= (bool_eq1 k key2) true) (= (witness container key2) (witness container k))))))) (dynamic_invariant11 result true false true)))) :pattern ((get1 container key2))))))
(assert (forall ((container us_rep2)) (! (dynamic_invariant8 (length4 container) true false true) :pattern ((length4 container)))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 us_rep)) (! (=> (= (has_key container key2) true) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant8 result true false true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep2)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant8 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant11 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(assert (forall ((container us_rep5)) (! (let ((result (length5 container))) (and (<= result (to_rep3 (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs3 container)))) (dynamic_invariant8 result true false true))) :pattern ((length5 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep5)) (! (dynamic_invariant8 (length6 attr__tag container) true false true) :pattern ((length6 attr__tag container))))))
...
(define-fun k_is_find ((container us_rep7) (key2 Int) (position Int)) Bool (and (ite (< 0 position) (k_bigger_than_range container 1 (- position 1) key2) (of_int 1)) (ite (< position (length7 container)) (k_smaller_than_range container (+ position 1) (length7 container) key2) (of_int 1))))
...
(define-fun oeq3 ((left us_rep7) (right us_rep7)) Bool (and (= (length7 left) (length7 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last2 left))) (= (get2 left n) (get2 right n)))) true false)))
(declare-fun oeq__function_guard3 (Bool us_rep7 us_rep7) Bool)
(assert (forall ((a us_rep7) (b us_rep7)) (! (= (user_eq14 a b) (oeq3 a b)) :pattern ((user_eq14 a b)))))
(define-fun default_initial_assumption4 ((temp___expr_573 us_rep7) (temp___skip_top_level_574 Bool)) Bool (=> (not (= temp___skip_top_level_574 true)) (= (length7 temp___expr_573) 0)))
(assert (forall ((container us_rep7)) (forall ((key2 Int)) (! (=> (dynamic_invariant1 key2 true true true) (let ((result (find2 container key2))) (and (=> (< 0 result) (and (<= result (length7 container)) (= (equivalent_keys key2 (get2 container result)) true))) (dynamic_invariant8 result true false true)))) :pattern ((find2 container key2))))))
...
(assert (forall ((container us_rep5)) (! (let ((result (keys container))) (and (and (and (= (length7 result) (length5 container)) (forall ((temp___607 Int)) (=> (and (in_range16 temp___607) (= (iter_has_element result temp___607) true)) (= (has_key2 (model__1 container) (get2 result temp___607)) true)))) (forall ((key2 Int)) (=> (and (in_range15 key2) (= (has_key2 (model__1 container) key2) true)) (and (< 0 (find2 result key2)) (= (equivalent_keys (get2 result (find2 result key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length5 container))) (and (= (find2 result (get2 result i)) i) (= (k_is_find result (get2 result i) i) true)))))) :pattern ((keys container)))))
...
(assert (forall ((container us_rep5)) (! (let ((result (positions1 container))) (and (not (= (has_key1 result no_element1) true)) (forall ((i us_rep4)) (=> (= (has_key1 result i) true) (and (and (<= 1 (get3 result i)) (<= (get3 result i) (length5 container))) (forall ((j us_rep4)) (=> (= (has_key1 result j) true) (=> (= (get3 result i) (get3 result j)) (= (bool_eq5 i j) true))))))))) :pattern ((positions1 container)))))
...
(assert true)
(assert (forall ((attr__tag Int) (key2 Int)) (forall ((container us_rep5)) (! (=> (dynamic_invariant1 key2 true true true) (dynamic_invariant2 (element__21 attr__tag container key2) true false true)) :pattern ((element__21 attr__tag container key2))))))
...
(assert (forall ((container us_rep8)) (! (dynamic_invariant8 (length8 container) true false true) :pattern ((length8 container)))))
...
(assert true)
(assert (forall ((container us_rep8)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant12 key2 true true true) (= (has_key2 container key2) true)) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant8 result true false true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep8)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant8 witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant13 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
...
(assert (forall ((container us_rep7)) (! (let ((result (length7 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant8 result true false true))) :pattern ((length7 container)))))
...
(assert (forall ((container us_rep7)) (forall ((position Int)) (! (=> (and (dynamic_invariant14 position true true true) (and (<= 1 position) (<= position (last2 container)))) (dynamic_invariant15 (get2 container position) true false true)) :pattern ((get2 container position))))))
...
(assert (forall ((container us_rep6)) (! (dynamic_invariant8 (length9 container) true false true) :pattern ((length9 container)))))
...
(assert true)
(assert (forall ((container us_rep6)) (forall ((key2 us_rep4)) (! (=> (= (has_key1 container key2) true) (let ((result (witness2 container key2))) (and (= (has_witness2 container result) true) (dynamic_invariant8 result true false true)))) :pattern ((witness2 container key2))))))
(assert (forall ((container us_rep6)) (forall ((witness3 Int)) (! (=> (and (dynamic_invariant8 witness3 true true true) (= (has_witness2 container witness3) true)) (dynamic_invariant16 (w_get2 container witness3) true false true)) :pattern ((w_get2 container witness3))))))
...
(define-fun oeq5 ((left us_rep11) (right us_rep11)) Bool (and (= (length2 left) (length2 right)) (ite (forall ((n Int)) (=> (and (<= 0 n) (<= n (last left))) (= (bool_eq10 (get5 left n) (get5 right n)) true))) true false)))
(declare-fun oeq__function_guard5 (Bool us_rep11 us_rep11) Bool)
(assert (forall ((a us_rep11) (b us_rep11)) (! (= (user_eq24 a b) (oeq5 a b)) :pattern ((user_eq24 a b)))))
(define-fun default_initial_assumption7 ((temp___expr_770 us_rep11) (temp___skip_top_level_771 Bool)) Bool (=> (not (= temp___skip_top_level_771 true)) (= (length2 temp___expr_770) 0)))
(assert (forall ((container us_rep10)) (! (= (length2 (model__2 container)) (length1 container)) :pattern ((model__2 container)))))
(define-fun dynamic_invariant18 ((temp___expr_712 Int) (temp___is_init_709 Bool) (temp___skip_constant_710 Bool) (temp___do_toplevel_711 Bool)) Bool (=> (or (= temp___is_init_709 true) (<= 0 10000)) (in_range10 temp___expr_712)))
...
(assert (forall ((container us_rep11)) (! (let ((result (length2 container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant8 result true false true))) :pattern ((length2 container)))))
(assert true)
...
(declare-const o21 index)
(declare-const o22 index_count)
...
(declare-const o33 index)
(declare-const o34 index_count)
...
(declare-const o40 index)
(declare-const o41 index_count)
(declare-const o42 us_rep9)
(declare-const o43 us_split_fields8)
(declare-const o44 index)
...
(declare-const temp___1137 us_rep10)
(declare-const temp___1136 us_rep5)
(declare-const temp___1135 (Array Int positive))
(declare-const temp___1139 Int)
(declare-const temp___1134 us_rep)
...
(declare-const o70 us_rep9)
(declare-const o71 us_rep9)
(declare-const o72 us_split_fields8)
(declare-const o73 index)
...
(declare-const o80 us_rep9)
(declare-const o81 us_split_fields8)
(declare-const o82 index)
(declare-const o83 Int)
(declare-const o84 Int)
(declare-const o85 us_rep9)
(declare-const o86 us_split_fields8)
(declare-const o87 index)
...
(declare-const o95 us_rep9)
(declare-const o96 us_rep9)
(declare-const o97 us_split_fields8)
(declare-const o98 index)
...
(declare-const p__split_fields11 us_split_fields10)
(declare-const f1 (Array Int partition_index))
(declare-const a11 map__ref)
(declare-const d__split_fields11 us_split_fields__ref3)
(declare-const p__split_fields12 us_split_fields__ref5)
(declare-const f2 map__ref5)
(declare-const c__split_fields11 us_split_fields__ref)
(declare-const a12 (Array Int positive))
(declare-const d__split_fields12 us_split_fields6)
(declare-const p__split_fields13 us_split_fields10)
(declare-const f3 (Array Int partition_index))
(declare-const c__split_fields12 us_split_fields)
(declare-const result20 Bool)
(assert (and (<= (* 2 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (<= (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 5000) (and (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (to_rep (select a j6))) true))) (and (forall ((c5 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c5) true) (= (to_rep (select a (element1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c5))) (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c5)))) (and (forall ((c5 us_rep)) (=> (= (has_key (positions x) c5) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x c5)) true))) (and (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 5)) (and (<= 0 (to_rep4 (select f j6))) (<= (to_rep4 (select f j6)) (- (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))))) (and (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 5)) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j6)))))) j6) (<= j6 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j6)))))))))) (and (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 (- (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))) (forall ((k2 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j6)))) k2) (<= k2 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j6)))))) (= (to_rep4 (select f k2)) j6))))) (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 (- (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))) (= (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j6)))) 0))))))))))))
(assert (and (= partition_refinement__refine__c__assume (first x)) (ite (= (= (length x) 0) true) (= (bool_eq1 partition_refinement__refine__c__assume no_element) true) (and (= (has_key (positions x) partition_refinement__refine__c__assume) true) (= (get1 (positions x) partition_refinement__refine__c__assume) 1)))))
(assert (= result13 (mk___split_fields__ref (mk___split_fields c__split_fields))))
...
(assert (and (= result14 (has_key (positions x) (mk___rep c__split_fields1))) (= (= result14 true) (= (has_key (positions x) (mk___rep c__split_fields1)) true))))
...
(assert (and (= o61 (element x (mk___rep c__split_fields1))) (and (in_range6 o61) (= o61 (get (model__ x) (get1 (positions x) (mk___rep c__split_fields1)))))))
(assert (and (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 5)) (= (to_rep (select a2 k2)) (ite (= k2 (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o61)) (to_rep (select a (+ (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o61))))))) (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o61)))))))))) (ite (= k2 (+ (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o61))))))) (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o61))))))))) (to_rep (select a (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o61))) (to_rep (select a k2))))))) (and (= (capacity (mk___rep5 p__split_discrs p__split_fields2)) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (= (length1 (mk___rep5 p__split_discrs p__split_fields2)) (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) (to_rep (select a2 j6))) true))) (and (forall ((c5 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c5) true) (= (to_rep (select a2 (element1 (mk___rep3 d__split_discrs d__split_fields2) c5))) (key (mk___rep3 d__split_discrs d__split_fields2) c5)))) (forall ((c5 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c5) true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c5) true)))))))))
(assert (ite (= (ite (= (bool_eq1 (mk___rep c__split_fields1) no_element) false) (= (get1 (positions x) (mk___rep c__split_fields1)) (length x)) true) true) (= (bool_eq1 (mk___rep c__split_fields2) no_element) true) (and (= (has_key (positions x) (mk___rep c__split_fields2)) true) (= (get1 (positions x) (mk___rep c__split_fields2)) (+ (get1 (positions x) (mk___rep c__split_fields1)) 1)))))
(assert (= (capacity (mk___rep5 p__split_discrs p__split_fields3)) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))
(assert (= (length1 (mk___rep5 p__split_discrs p__split_fields3)) (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))
(assert (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (to_rep (select a3 j6))) true))))
(assert (forall ((c5 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c5) true) (= (to_rep (select a3 (element1 (mk___rep3 d__split_discrs d__split_fields3) c5))) (key (mk___rep3 d__split_discrs d__split_fields3) c5)))))
(assert (forall ((c5 us_rep4)) (=> (= (has_key1 (positions1 d_old) c5) true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c5) true))))
(assert (forall ((c5 us_rep)) (=> (= (has_key (positions x) c5) true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) (find d_old (element x c5))) true))))
(assert (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 5)) (and (<= 0 (to_rep4 (select f j6))) (<= (to_rep4 (select f j6)) (- (length1 (mk___rep5 p__split_discrs p__split_fields3)) 1))))))
(assert (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 5)) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) (to_rep4 (select f j6)))))) j6) (<= j6 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) (to_rep4 (select f j6)))))))))))
(assert (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 (- (length1 (mk___rep5 p__split_discrs p__split_fields3)) 1))) (forall ((k2 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) j6)))) k2) (<= k2 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) j6)))))) (= (to_rep4 (select f k2)) j6))))))
(assert (and (= o91 (has_key (positions x) (mk___rep c__split_fields3))) (= (= o91 true) (= (has_key (positions x) (mk___rep c__split_fields3)) true))))
(assert (= result19 (ite (not (= o91 true)) true false)))
(assert (not (= result19 true)))
(assert (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) (find d_old (element x (mk___rep c__split_fields3)))) true))
(assert (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (element x (mk___rep c__split_fields3))) true))
(assert (and (= o94 (element x (mk___rep c__split_fields3))) (and (in_range6 o94) (= o94 (get (model__ x) (get1 (positions x) (mk___rep c__split_fields3)))))))
(assert (and (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 5)) (= (to_rep (select a4 k2)) (ite (= k2 (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) o94)) (to_rep (select a3 (+ (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) o94))))))) (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) o94)))))))))) (ite (= k2 (+ (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) o94))))))) (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) o94))))))))) (to_rep (select a3 (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) o94))) (to_rep (select a3 k2))))))) (and (= (capacity (mk___rep5 p__split_discrs p__split_fields4)) (capacity (mk___rep5 p__split_discrs p__split_fields3))) (and (= (length1 (mk___rep5 p__split_discrs p__split_fields4)) (length1 (mk___rep5 p__split_discrs p__split_fields3))) (and (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields4)) (to_rep (select a4 j6))) true))) (and (forall ((c5 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields4)) c5) true) (= (to_rep (select a4 (element1 (mk___rep3 d__split_discrs d__split_fields4) c5))) (key (mk___rep3 d__split_discrs d__split_fields4) c5)))) (forall ((c5 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c5) true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields4)) c5) true)))))))))
(assert (ite (= (ite (= (bool_eq1 (mk___rep c__split_fields3) no_element) false) (= (get1 (positions x) (mk___rep c__split_fields3)) (length x)) true) true) (= (bool_eq1 (mk___rep c__split_fields4) no_element) true) (and (= (has_key (positions x) (mk___rep c__split_fields4)) true) (= (get1 (positions x) (mk___rep c__split_fields4)) (+ (get1 (positions x) (mk___rep c__split_fields3)) 1)))))
(declare-const j6 Int)
(assert (<= 0 j6))
(assert (<= j6 5))
(assert (not (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields4)) (to_rep (select a4 j6))) true)))
(check-sat)
(exit)
