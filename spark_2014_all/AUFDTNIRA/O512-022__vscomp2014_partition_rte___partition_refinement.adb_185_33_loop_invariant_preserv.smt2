...
(assert (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields4)) c4) true))
(assert (not (= (to_rep (select a4 (element1 (mk___rep3 d__split_discrs d__split_fields4) c4))) (key (mk___rep3 d__split_discrs d__split_fields4) c4))))
(check-sat)
(exit)
