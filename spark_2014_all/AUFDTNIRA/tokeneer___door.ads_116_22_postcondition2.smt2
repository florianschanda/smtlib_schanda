...
(declare-const logfilestate__split_fields7 us_split_fields__ref2)
(declare-const auditalarm1 int__ref)
(declare-const currentlatch1 int__ref)
(declare-const latchtimeout__split_fields4 us_split_fields__ref)
(declare-const currentdoor1 int__ref)
...
(assert (and (and (= (and (and (= (int__content currentdoor1) 0) (= (islocked (int__content currentlatch1) (us_private__content state1) (us_split_fields__content latchtimeout__split_fields4)) true)) (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (mk___rep (mk___split_fields alarmtimeout__split_fields alarmtimeout__split_fields1 alarmtimeout__split_fields2 alarmtimeout__split_fields3))) true)) (= (int__content dooralarm1) 0)) (= (= (islocked (int__content currentlatch1) (us_private__content state1) (us_split_fields__content latchtimeout__split_fields4)) true) (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (latch_timeout (int__content currentlatch1) (us_private__content state1) (us_split_fields__content latchtimeout__split_fields4))) true))) (= (bool_eq2 (latch_timeout (int__content currentlatch1) (us_private__content state1) (us_split_fields__content latchtimeout__split_fields4)) (latch_timeout currentlatch (us_private__content state) (mk___split_fields latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) true)))
(assert (and (and (and (and (in_range14 (int__content currentlatch1)) (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content2 logfilestate__split_fields7))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content2 logfilestate__split_fields7))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content2 logfilestate__split_fields7)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content2 logfilestate__split_fields7))) true)) (in_range15 (int__content currentdoor1))) (in_range13 (int__content auditalarm1))) (in_range13 (int__content dooralarm1))))
(assert (= (islocked (int__content currentlatch1) (us_private__content state1) (us_split_fields__content latchtimeout__split_fields4)) true))
(assert (= (thecurrentdoor (int__content currentdoor1)) 0))
(assert (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (alarm_timeout (mk___split_fields alarmtimeout__split_fields alarmtimeout__split_fields1 alarmtimeout__split_fields2 alarmtimeout__split_fields3))) true))
