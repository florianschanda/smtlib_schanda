...
(assert (forall ((temp___1649 Int) (temp___1650 Int) (temp___1651 Int)) (let ((temp___1648 (aida__conversion__calculate_positive_target_length_6__n__aggregate_def temp___1649 temp___1650 temp___1651))) (and (=> (dynamic_property6 (first1 source) (+ (first1 source) 5) temp___1650 temp___1651) (and (= (first5 temp___1648) temp___1650) (= (last5 temp___1648) temp___1651))) (forall ((temp___1652 Int)) (= (select (to_array2 temp___1648) temp___1652) (of_rep1 temp___1649)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_401 us_t1) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool)) Bool (=> (not (= temp___skip_constant_399 true)) (and (dynamic_property2 (first1 source) (+ (first1 source) 5) (first3 temp___expr_401) (last3 temp___expr_401)) (and (= (first3 temp___expr_401) (first1 source)) (= (last3 temp___expr_401) (+ (first1 source) 5))))))
...
(assert (and (= (length source) 6) (forall ((index13 Int)) (=> (and (<= (to_rep1 (first (rt source))) index13) (<= index13 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index13))) true)))))
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_length_6__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_length_6__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5))))) (+ (to_rep1 (first (rt source))) 5)) (= (mk___t2 temp___1654 temp___16541) (aida__conversion__calculate_positive_target_length_6__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5))))) (and (= (ite (<= (to_rep1 (first4 temp___16541)) (to_rep1 (last4 temp___16541))) (+ (- (to_rep1 (last4 temp___16541)) (to_rep1 (first4 temp___16541))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5)) (+ (- (+ (to_rep1 (first (rt source))) 5) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1654 (to_rep1 (first4 temp___16541)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_length_6__n__assume) (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5)) aida__conversion__calculate_positive_target_length_6__n__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_positive_target_length_6__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_length_6__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_length_6__n__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 5)))) (and (and (and (= temp___1661 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (= (mk_int__ref result1) (mk_int__ref index)) (= index2 (to_rep1 (first (rt source))))) (ite (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1661)) (and (and (and (= temp___1659 index2) (and (= temp___1657 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o index2)) (= o1 (select n1 o))) (= o2 (to_rep1 o1))) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o3 index2)) (= o4 (select (elts source) o3))) (= o5 (to_rep o4))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o7 index2)) (= o8 (store n1 o7 o6)))) (and (= n1 result2) (= n2 o8))))) (and (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (= (to_rep1 (select n3 j1)) (convert_character_digit_to_integer (to_rep (select (elts source) j1)))))) (and (and (and (forall ((temp___1658 Int)) (=> (and (<= (to_rep1 n__first) temp___1658) (<= temp___1658 (to_rep1 n__last))) (=> (< index3 temp___1658) (= (select n3 temp___1658) (select temp___1657 temp___1658))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 5) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 5)))) (= index3 temp___1661)))))) (and (and (= index3 index7) (= n3 n7)) (and (= index8 index3) (= n8 n3)))) (and (and (= (mk_int__ref index9) (mk_int__ref index7)) (= (mk_map__ref1 n9) (mk_map__ref1 n7))) (and (= index10 index8) (= n10 n8)))) (and (and (= index2 index9) (= n1 n9)) (and (= index10 index2) (= n10 n1)))))) (and (and (and (and (and (and (= temp___1662 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (<= (to_rep1 n__first) temp___1662) (<= temp___1662 (to_rep1 n__last))) (= o22 temp___1662))) (= o23 (select n9 o22))) (= o24 (to_rep1 o23))) (and (= (mk_int__ref result5) (mk_int__ref target)) (= target1 o24))) (and (<= target1 9) (and (and (and (and (and (and (and (and (and (and (= temp___1663 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (<= (to_rep1 n__first) temp___1663) (<= temp___1663 (to_rep1 n__last))) (= o25 temp___1663))) (= o26 (select n9 o25))) (= o27 (to_rep1 o26))) (= o28 (* o27 10))) (and (= o29 o28) (in_range1 o28))) (= o30 (+ target1 o29))) (and (= o31 o30) (in_range1 o30))) (and (= target1 result6) (= target2 o31))) (and (<= target2 99) (and (and (and (and (and (and (and (and (and (and (= temp___1664 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))) (and (and (<= (to_rep1 n__first) temp___1664) (<= temp___1664 (to_rep1 n__last))) (= o32 temp___1664))) (= o33 (select n9 o32))) (= o34 (to_rep1 o33))) (= o35 (* o34 100))) (and (= o36 o35) (in_range1 o35))) (= o37 (+ target2 o36))) (and (= o38 o37) (in_range1 o37))) (and (= result7 (mk_int__ref target2)) (= target3 o38))) (and (<= target3 999) (and (and (and (and (and (and (and (and (and (and (= temp___1665 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (<= (to_rep1 n__first) temp___1665) (<= temp___1665 (to_rep1 n__last))) (= o39 temp___1665))) (= o40 (select n9 o39))) (= o41 (to_rep1 o40))) (= o42 (* o41 1000))) (and (= o43 o42) (in_range1 o42))) (= o44 (+ target3 o43))) (and (= o45 o44) (in_range1 o44))) (and (= result8 (mk_int__ref target3)) (= target4 o45))) (and (<= target4 9999) (and (and (and (and (and (and (and (and (and (and (= temp___1666 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (<= (to_rep1 n__first) temp___1666) (<= temp___1666 (to_rep1 n__last))) (= o46 temp___1666))) (= o47 (select n9 o46))) (= o48 (to_rep1 o47))) (= o49 (* o48 10000))) (and (= o50 o49) (in_range1 o49))) (= o51 (+ target4 o50))) (and (= o52 o51) (in_range1 o51))) (and (= result9 (mk_int__ref target4)) (= target5 o52))) (and (<= target5 99999) (and (and (and (and (and (and (and (and (and (and (= temp___1667 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))) (and (and (<= (to_rep1 n__first) temp___1667) (<= temp___1667 (to_rep1 n__last))) (= o53 temp___1667))) (= o54 (select n9 o53))) (= o55 (to_rep1 o54))) (= o56 (* o55 100000))) (and (= o57 o56) (in_range1 o56))) (= o58 (+ target5 o57))) (and (= o59 o58) (in_range1 o58))) (and (= result10 (mk_int__ref target5)) (= target6 o59))) (and (<= target6 999999) (and (= result11 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0)))))))))))))))))) (and (and (= index11 (mk_int__ref index9)) (and (= n11 (mk_map__ref1 n9)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target7 (mk_int__ref target6))))) (and (= index12 index10) (and (= n12 n10) (and (= has_failed3 has_failed1) (= target8 target6)))))))
(assert (and (= temp___1673 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1673) (<= temp___1673 (to_rep1 (last (rt source))))))
(assert (= o97 temp___1673))
...
(assert (and (= temp___1672 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1672) (<= temp___1672 (to_rep1 (last (rt source))))))
(assert (= o89 temp___1672))
...
(assert (and (= temp___1671 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1671) (<= temp___1671 (to_rep1 (last (rt source))))))
(assert (= o81 temp___1671))
...
(assert (and (= temp___1670 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1670) (<= temp___1670 (to_rep1 (last (rt source))))))
(assert (= o73 temp___1670))
...
(assert (and (= temp___1669 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1669) (<= temp___1669 (to_rep1 (last (rt source))))))
(assert (= o65 temp___1669))
(assert (= o66 (select (elts source) o65)))
(assert (= o67 (to_rep o66)))
(assert (and (= o68 (convert_character_digit_to_integer o67)) (and (in_range1 o68) (and (and (<= 0 o68) (<= o68 9)) (ite (= (= o67 48) true) (= o68 0) (ite (= (= o67 49) true) (= o68 1) (ite (= (= o67 50) true) (= o68 2) (ite (= (= o67 51) true) (= o68 3) (ite (= (= o67 52) true) (= o68 4) (ite (= (= o67 53) true) (= o68 5) (ite (= (= o67 54) true) (= o68 6) (ite (= (= o67 55) true) (= o68 7) (ite (= (= o67 56) true) (= o68 8) (=> (= (= o67 57) true) (= o68 9)))))))))))))))
(assert (= o69 (* o68 10000)))
(assert (and (= o70 o69) (in_range1 o69)))
(assert (and (= temp___1668 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1668) (<= temp___1668 (to_rep1 (last (rt source))))))
(assert (= o60 temp___1668))
...
(assert (= o64 (* o63 100000)))
(assert (and (= o71 o64) (in_range1 o64)))
(assert (= o72 (+ o71 o70)))
