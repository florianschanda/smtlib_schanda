...
(assert (dynamic_property1 1 2147483647 1 43))
(assert (= temp___1795 (mk___t1 (temp___String_Literal_1794 Tuple0) (mk1 1 43))))
(assert (not (dynamic_predicate temp___1795)))
(check-sat)
(exit)
