...
(declare-const temp___187 (Array Int natural))
...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___187 a2)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___186 i1)))
...
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___188 Int)) (=> (and (<= 0 temp___188) (<= temp___188 30)) (=> (< i2 temp___188) (= (select a4 temp___188) (select temp___187 temp___188)))))) (and (<= 2 i2) (<= i2 30)))))
