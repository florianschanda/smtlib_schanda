...
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___164 Int)) (=> (and (<= 0 temp___164) (<= temp___164 30)) (=> (< i2 temp___164) (= (select a4 temp___164) (select temp___163 temp___164)))))) (and (<= 2 i2) (<= i2 30)))))
