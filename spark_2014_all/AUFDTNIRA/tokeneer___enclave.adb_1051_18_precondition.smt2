...
(assert (= o (extractuser tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))))
...
(assert (= logfilesstatus1 (mk_map__ref4 logfilesstatus)))
...
(assert (and (= o7 (islocked (int__content currentlatch2) (us_private__content state12) (us_split_fields__content1 latchtimeout__split_fields5))) (= (= o7 true) (= (int__content currentlatch2) 0))))
(assert (= o8 (ite (not (= o7 true)) true false)))
(assert (= result1 (ite (= o8 true) (islocked currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result1 true) (and (= o9 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range7 o9))))
(assert (=> (= result1 true) (= o10 (ite (= o9 3) true false))))
(assert (=> (= result1 true) (and (= o11 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o11 true) (in_range7 (to_rep3 theadmin__split_fields1))))))
(assert (=> (= result1 true) (= o12 (ite (= o11 true) o10 false))))
(assert (=> (not (= result1 true)) (= o12 (distinct 1 0))))
(assert (and (= o1 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (and (in_range5 o1) (= o1 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3)))))))
(assert (= result2 (ite (= o1 1) true false)))
(assert (=> (= result2 true) (and (= o3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o3 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result2 true) (= o4 (ite (not (= o3 true)) true false))))
(assert (=> (= result2 true) (and (= result3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result3 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result2 true) (=> (= result3 true) (and (= o2 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (in_range7 o2)))))
(assert (=> (= result2 true) (=> (= result3 true) (= o5 (ite (= o2 3) true false)))))
(assert (=> (= result2 true) (=> (not (= result3 true)) (= o5 false))))
(assert (=> (= result2 true) (= o6 (ite (= o5 false) o4 true))))
(assert (=> (not (= result2 true)) (= o6 (distinct 1 0))))
(assert (and (= result4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result4 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
(assert (= result4 true))
