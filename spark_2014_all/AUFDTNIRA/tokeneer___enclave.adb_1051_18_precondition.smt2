...
(define-fun dynamic_invariant3 ((temp___expr_446 Int) (temp___is_init_443 Bool) (temp___skip_constant_444 Bool) (temp___do_toplevel_445 Bool)) Bool (=> (or (= temp___is_init_443 true) (<= 0 1)) (in_range8 temp___expr_446)))
...
(define-fun dynamic_invariant5 ((temp___expr_1305 Int) (temp___is_init_1302 Bool) (temp___skip_constant_1303 Bool) (temp___do_toplevel_1304 Bool)) Bool (=> (or (= temp___is_init_1302 true) (<= 0 4294967295)) (in_range19 temp___expr_1305)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant6 ((temp___expr_1311 Int) (temp___is_init_1308 Bool) (temp___skip_constant_1309 Bool) (temp___do_toplevel_1310 Bool)) Bool (=> (or (= temp___is_init_1308 true) (<= 0 2)) (in_range20 temp___expr_1311)))
...
(define-fun dynamic_invariant7 ((temp___expr_1923 Int) (temp___is_init_1920 Bool) (temp___skip_constant_1921 Bool) (temp___do_toplevel_1922 Bool)) Bool (=> (or (= temp___is_init_1920 true) (<= 0 1)) (in_range28 temp___expr_1923)))
...
(define-fun dynamic_invariant8 ((temp___expr_1945 Int) (temp___is_init_1942 Bool) (temp___skip_constant_1943 Bool) (temp___do_toplevel_1944 Bool)) Bool (=> (or (= temp___is_init_1942 true) (<= 0 1)) (in_range29 temp___expr_1945)))
...
(define-fun dynamic_invariant9 ((temp___expr_2612 Int) (temp___is_init_2609 Bool) (temp___skip_constant_2610 Bool) (temp___do_toplevel_2611 Bool)) Bool (=> (or (= temp___is_init_2609 true) (<= 0 8)) (in_range30 temp___expr_2612)))
(declare-const attr__ATTRIBUTE_ADDRESS14 Int)
(declare-const attr__ATTRIBUTE_ADDRESS15 Int)
(define-fun dynamic_invariant10 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range2 temp___expr_39)))
(define-fun dynamic_invariant11 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range3 temp___expr_63)))
(define-fun dynamic_invariant12 ((temp___expr_82 us_t) (temp___is_init_79 Bool) (temp___skip_constant_80 Bool) (temp___do_toplevel_81 Bool)) Bool (=> (not (= temp___skip_constant_80 true)) (dynamic_property 1 2147483647 (first1 temp___expr_82) (last1 temp___expr_82))))
(define-fun dynamic_invariant13 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_15)))
(define-fun dynamic_invariant14 ((temp___expr_401 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 4)) (in_range6 temp___expr_401)))
...
(define-fun dynamic_invariant15 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 1 3)) (in_range31 temp___expr_200)))
(define-fun dynamic_invariant16 ((temp___expr_206 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 5)) (in_range21 temp___expr_206)))
(define-fun dynamic_invariant17 ((temp___expr_924 Int) (temp___is_init_921 Bool) (temp___skip_constant_922 Bool) (temp___do_toplevel_923 Bool)) Bool (=> (or (= temp___is_init_921 true) (<= 0 40)) (in_range23 temp___expr_924)))
(define-fun dynamic_invariant18 ((temp___expr_945 Int) (temp___is_init_942 Bool) (temp___skip_constant_943 Bool) (temp___do_toplevel_944 Bool)) Bool (=> (or (= temp___is_init_942 true) (<= 0 4294967295)) (in_range24 temp___expr_945)))
(define-fun dynamic_invariant19 ((temp___expr_967 Int) (temp___is_init_964 Bool) (temp___skip_constant_965 Bool) (temp___do_toplevel_966 Bool)) Bool (=> (or (= temp___is_init_964 true) (<= 0 10)) (in_range22 temp___expr_967)))
(define-fun dynamic_invariant20 ((temp___expr_979 Int) (temp___is_init_976 Bool) (temp___skip_constant_977 Bool) (temp___do_toplevel_978 Bool)) Bool (=> (or (= temp___is_init_976 true) (<= 0 4294967295)) (in_range26 temp___expr_979)))
(define-fun dynamic_invariant21 ((temp___expr_985 Int) (temp___is_init_982 Bool) (temp___skip_constant_983 Bool) (temp___do_toplevel_984 Bool)) Bool (=> (or (= temp___is_init_982 true) (<= 0 128)) (in_range27 temp___expr_985)))
(define-fun dynamic_invariant22 ((temp___expr_1105 Int) (temp___is_init_1102 Bool) (temp___skip_constant_1103 Bool) (temp___do_toplevel_1104 Bool)) Bool (=> (or (= temp___is_init_1102 true) (<= 0 17)) (in_range16 temp___expr_1105)))
(define-fun dynamic_invariant23 ((temp___expr_1084 Int) (temp___is_init_1081 Bool) (temp___skip_constant_1082 Bool) (temp___do_toplevel_1083 Bool)) Bool (=> (or (= temp___is_init_1081 true) (<= 1 17)) (in_range14 temp___expr_1084)))
(define-fun dynamic_invariant24 ((temp___expr_1209 Int) (temp___is_init_1206 Bool) (temp___skip_constant_1207 Bool) (temp___do_toplevel_1208 Bool)) Bool (=> (or (= temp___is_init_1206 true) (<= 0 2)) (in_range18 temp___expr_1209)))
(define-fun dynamic_invariant25 ((temp___expr_1090 Int) (temp___is_init_1087 Bool) (temp___skip_constant_1088 Bool) (temp___do_toplevel_1089 Bool)) Bool (=> (or (= temp___is_init_1087 true) (<= 0 17408)) (in_range15 temp___expr_1090)))
(define-fun dynamic_invariant26 ((temp___expr_1124 Int) (temp___is_init_1121 Bool) (temp___skip_constant_1122 Bool) (temp___do_toplevel_1123 Bool)) Bool (=> (or (= temp___is_init_1121 true) (<= 0 1024)) (in_range17 temp___expr_1124)))
(assert true)
...
(define-fun dynamic_invariant27 ((temp___expr_468 Int) (temp___is_init_465 Bool) (temp___skip_constant_466 Bool) (temp___do_toplevel_467 Bool)) Bool (=> (or (= temp___is_init_465 true) (<= 1 150)) (in_range9 temp___expr_468)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant28 ((temp___expr_510 Int) (temp___is_init_507 Bool) (temp___skip_constant_508 Bool) (temp___do_toplevel_509 Bool)) Bool (=> (or (= temp___is_init_507 true) (<= 1901 2099)) (in_range10 temp___expr_510)))
(define-fun dynamic_invariant29 ((temp___expr_516 Int) (temp___is_init_513 Bool) (temp___skip_constant_514 Bool) (temp___do_toplevel_515 Bool)) Bool (=> (or (= temp___is_init_513 true) (<= 1 12)) (in_range11 temp___expr_516)))
(define-fun dynamic_invariant30 ((temp___expr_522 Int) (temp___is_init_519 Bool) (temp___skip_constant_520 Bool) (temp___do_toplevel_521 Bool)) Bool (=> (or (= temp___is_init_519 true) (<= 1 31)) (in_range12 temp___expr_522)))
(define-fun dynamic_invariant31 ((temp___expr_546 Int) (temp___is_init_543 Bool) (temp___skip_constant_544 Bool) (temp___do_toplevel_545 Bool)) Bool (=> (or (= temp___is_init_543 true) (<= 0 86399999)) (in_range13 temp___expr_546)))
(assert true)
...
(define-fun dynamic_invariant32 ((temp___expr_1375 Int) (temp___is_init_1372 Bool) (temp___skip_constant_1373 Bool) (temp___do_toplevel_1374 Bool)) Bool (=> (or (= temp___is_init_1372 true) (<= 0 4294967295)) (in_range25 temp___expr_1375)))
...
(declare-const logfilesstatus1 map__ref4)
...
(assert (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (and (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3) (and (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (and (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (and (and (= (isgood tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true) (= (authcertvalid tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) 1))) (and (=> (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)) (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1)) (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (or (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true))))))))))
(assert (and (and (and (= o14 (extractuser tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true) (in_range8 auditalarm1))) (and (and (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range8 auditalarm2)) (and (and (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range8 auditalarm3)) (and (and (= result10 (mk_int__ref status)) (= status1 3)) (and (and (and (= (and (and (= (islocked currentlatch1 (let ((subject state2)) state9) latchtimeout__split_fields4) true) (= (thecurrentdoor (let ((subject state3)) state10)) 0)) (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (alarm_timeout (let ((subject state3)) state10))) true)) (= (thedooralarm (let ((subject state3)) state10)) 0)) (= (= (islocked currentlatch1 (let ((subject state2)) state9) latchtimeout__split_fields4) true) (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (latch_timeout currentlatch1 (let ((subject state2)) state9) latchtimeout__split_fields4)) true))) (and (and (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true) (in_range8 auditalarm4)) (in_range28 currentlatch1))) (and (and (not (= (isdoingop (mk___rep theadmin__split_fields2)) true)) (= (rolepresent (mk___rep theadmin__split_fields2)) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))) (= (ispresent (mk___rep theadmin__split_fields2)) true))))))) (and (and (= state15 (let ((subject state5)) (mk___private__ref state6))) (and (= state14 (let ((subject state4)) (mk___private__ref state7))) (and (= state13 (let ((subject state3)) (mk___private__ref state10))) (and (= state12 (let ((subject state2)) (mk___private__ref state9))) (and (= state11 (let ((subject state)) (mk___private__ref state8))) (and (= filestate1 (mk___private__ref filestate)) (and (= theadmin__split_fields3 (mk___split_fields__ref theadmin__split_fields2)) (and (= status2 (mk_int__ref status1)) (and (= latchtimeout__split_fields5 (mk___split_fields__ref1 latchtimeout__split_fields4)) (and (= currentlatch2 (mk_int__ref currentlatch1)) (and (= auditsystemfault1 (mk_bool__ref auditsystemfault)) (and (= auditalarm5 (mk_int__ref auditalarm4)) (and (= logfilestate__split_fields11 (mk___split_fields__ref3 logfilestate__split_fields10)) (and (= logfilesstatus1 (mk_map__ref4 logfilesstatus)) (= logfiles1 (mk_map__ref3 logfiles)))))))))))))))) (and (= state20 state6) (and (= state19 state7) (and (= state18 state10) (and (= state17 state9) (and (= state16 state8) (and (= filestate2 filestate) (and (= theadmin__split_fields4 theadmin__split_fields2) (and (= status3 status1) (and (= latchtimeout__split_fields6 latchtimeout__split_fields4) (and (= currentlatch3 currentlatch1) (and (= auditsystemfault2 auditsystemfault) (and (= auditalarm6 auditalarm4) (and (= logfilestate__split_fields12 logfilestate__split_fields10) (and (= logfilesstatus2 logfilesstatus) (= logfiles2 logfiles))))))))))))))))))
(assert (and (= o22 (islocked (int__content currentlatch2) (us_private__content state12) (us_split_fields__content1 latchtimeout__split_fields5))) (= (= o22 true) (= (int__content currentlatch2) 0))))
(assert (= o23 (ite (not (= o22 true)) true false)))
(assert (= result11 (ite (= o23 true) (islocked currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result11 true) (and (= o24 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range7 o24))))
(assert (=> (= result11 true) (= o25 (ite (= o24 3) true false))))
(assert (=> (= result11 true) (and (= o26 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o26 true) (in_range7 (to_rep3 theadmin__split_fields1))))))
(assert (=> (= result11 true) (= o27 (ite (= o26 true) o25 false))))
(assert (=> (not (= result11 true)) (= o27 (of_int 1))))
(assert (and (= o16 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (and (in_range5 o16) (= o16 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3)))))))
(assert (= result12 (ite (= o16 1) true false)))
(assert (=> (= result12 true) (and (= o18 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o18 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result12 true) (= o19 (ite (not (= o18 true)) true false))))
(assert (=> (= result12 true) (and (= result13 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result13 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result12 true) (=> (= result13 true) (and (= o17 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (in_range7 o17)))))
(assert (=> (= result12 true) (=> (= result13 true) (= o20 (ite (= o17 3) true false)))))
(assert (=> (= result12 true) (=> (not (= result13 true)) (= o20 false))))
(assert (=> (= result12 true) (= o21 (ite (= o20 false) o19 true))))
(assert (=> (not (= result12 true)) (= o21 (of_int 1))))
(assert (and (= result14 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result14 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
