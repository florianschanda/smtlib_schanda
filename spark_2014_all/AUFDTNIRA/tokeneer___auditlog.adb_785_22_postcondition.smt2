...
(assert (= temp___1661 (mk___rep1 o22)))
(assert (= result5 (mk___split_fields__ref1 logfilestate__split_fields8)))
(assert (= logfilestate__split_fields9 (us_split_fields3 temp___1661)))
...
(assert (= temp___1663 (mk___rep1 o25)))
(assert (= result6 (mk___split_fields__ref1 logfilestate__split_fields9)))
(assert (= logfilestate__split_fields10 (us_split_fields3 temp___1663)))
