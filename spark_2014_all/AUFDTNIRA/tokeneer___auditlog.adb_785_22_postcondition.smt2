...
(assert (and (= o17 (- (to_rep1 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) 1)) (in_range3 (- (to_rep1 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) 1))))
...
(assert (= temp___1871 (mk___rep1 o21)))
(assert (= result5 (mk___split_fields__ref1 logfilestate__split_fields8)))
(assert (= logfilestate__split_fields9 (us_split_fields3 temp___1871)))
(assert (and (= o22 (- (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) 1024)) (in_range6 (- (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) 1024))))
(assert (= (to_rep3 o23) o22))
(assert (= o24 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9) o23 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9))))
(assert (= temp___1873 (mk___rep1 o24)))
(assert (= result6 (mk___split_fields__ref1 logfilestate__split_fields9)))
(assert (= logfilestate__split_fields10 (us_split_fields3 temp___1873)))
...
(assert (= logfilestate__split_fields11 (mk___split_fields__ref1 logfilestate__split_fields10)))
...
(assert (not (<= 1 (to_rep1 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields11))))))))
(check-sat)
(exit)
