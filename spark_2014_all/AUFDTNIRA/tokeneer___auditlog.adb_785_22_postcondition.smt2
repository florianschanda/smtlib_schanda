...
(assert (and (= o18 (- (to_rep3 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) 1)) (in_range6 (- (to_rep3 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) 1))))
(assert (= (to_rep3 o19) o18))
(assert (= o20 (mk___split_fields (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) o19)))
(assert (= o21 (mk___rep o20)))
(assert (= o22 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8) o21 (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8))))
(assert (= temp___1717 (mk___rep1 o22)))
(assert (= result5 (mk___split_fields__ref1 logfilestate__split_fields8)))
(assert (= logfilestate__split_fields9 (us_split_fields3 temp___1717)))
(assert (and (= o23 (- (to_rep2 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) 1024)) (in_range5 (- (to_rep2 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) 1024))))
(assert (= (to_rep2 o24) o23))
(assert (= o25 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9) o24 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9))))
(assert (= temp___1719 (mk___rep1 o25)))
(assert (= result6 (mk___split_fields__ref1 logfilestate__split_fields9)))
(assert (= logfilestate__split_fields10 (us_split_fields3 temp___1719)))
...
(assert (not (<= 1 (to_rep3 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields11))))))))
(check-sat)
(exit)
