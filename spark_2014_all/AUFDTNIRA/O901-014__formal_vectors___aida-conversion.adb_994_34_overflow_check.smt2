...
(define-fun tnumber_array_typeD1__ref___16__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t1 0)
...
(define-fun number_array_type__ref___16__projection ((a number_array_type__ref)) us_t1 (number_array_type__content a))
...
(declare-datatypes () ((t332b__ref (mk_t332b__ref (t332b__content integer)))))
(define-fun t332b__ref___projection ((a t332b__ref)) integer (t332b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t333b__ref (mk_t333b__ref (t333b__content us_t2)))))
(define-fun t333b__ref___projection ((a t333b__ref)) us_t2 (t333b__content a))
...
(declare-datatypes () ((t334b__ref (mk_t334b__ref (t334b__content integer)))))
(define-fun t334b__ref___projection ((a t334b__ref)) integer (t334b__content a))
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-fun aida__conversion__calculate_positive_target_length_4__n__aggregate_def (Int Int Int) us_t2)
...
(define-fun dynamic_invariant4 ((temp___expr_494 us_t1) (temp___is_init_490 Bool) (temp___skip_constant_491 Bool) (temp___do_toplevel_492 Bool) (temp___do_typ_inv_493 Bool)) Bool (=> (not (= temp___skip_constant_491 true)) (and (dynamic_property2 (first1 source) (+ (first1 source) 3) (first3 temp___expr_494) (last3 temp___expr_494)) (and (= (first3 temp___expr_494) (first1 source)) (= (last3 temp___expr_494) (+ (first1 source) 3))))))
(declare-sort t3 0)
...
(define-fun tnumber_array_typeB__ref___16__projection ((a tnumber_array_typeB__ref)) us_t3 (tnumber_array_typeB__content a))
(declare-const rliteral integer)
(assert (= (integerqtint rliteral) 0))
(assert (forall ((temp___1801 Int) (temp___1802 Int) (temp___1803 Int)) (let ((temp___1800 (aida__conversion__calculate_positive_target_length_4__n__aggregate_def temp___1801 temp___1802 temp___1803))) (=> (dynamic_invariant temp___1801 true true true true) (and (=> (dynamic_property6 (first1 source) (+ (first1 source) 3) temp___1802 temp___1803) (and (= (first5 temp___1800) temp___1802) (= (last5 temp___1800) temp___1803))) (forall ((temp___1804 Int)) (= (select (to_array2 temp___1800) temp___1804) rliteral)))))))
(declare-const target Int)
(declare-const has_failed Bool)
(declare-const n (Array Int integer))
(declare-const index Int)
(declare-const temp___1806 (Array Int integer))
(declare-const temp___18061 t2)
(declare-const aida__conversion__calculate_positive_target_length_4__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_length_4__n__assume1 t1)
(declare-const temp___1809 Int)
(declare-const temp___1813 Int)
(declare-const temp___1811 (Array Int integer))
(declare-const o Int)
...
(declare-const temp___1814 Int)
(declare-const o9 Int)
(declare-const o10 integer)
(declare-const o11 Int)
(declare-const temp___1815 Int)
...
(assert (and (= (length source) 4) (forall ((index10 Int)) (=> (and (<= (to_rep1 (first (rt source))) index10) (<= index10 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index10))) true)))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_length_4__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_length_4__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3))))) (+ (to_rep1 (first (rt source))) 3)))
(assert (= (mk___t2 temp___1806 temp___18061) (aida__conversion__calculate_positive_target_length_4__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3))))
(assert (= (ite (<= (to_rep1 (first4 temp___18061)) (to_rep1 (last4 temp___18061))) (+ (- (to_rep1 (last4 temp___18061)) (to_rep1 (first4 temp___18061))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3)) (+ (- (+ (to_rep1 (first (rt source))) 3) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1806 (to_rep1 (first4 temp___18061)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_length_4__n__assume))
(assert (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3)) aida__conversion__calculate_positive_target_length_4__n__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_positive_target_length_4__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_length_4__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_length_4__n__assume1))))
(assert (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 3)))))
(assert (and (= temp___1809 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (= (mk_int__ref result1) (mk_int__ref index)))
(assert (= index1 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= temp___1813 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= temp___1811 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= o index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= o1 (select n1 o))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= o3 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= o7 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= n1 result2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= n2 o8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (= (to_rep1 (select n3 j)) (convert_character_digit_to_integer (to_rep (select (elts source) j))))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (and (and (forall ((temp___1812 Int)) (=> (and (<= (to_rep1 n__first) temp___1812) (<= temp___1812 (to_rep1 n__last))) (=> (or (< temp___1809 temp___1812) (or (< temp___1812 (to_rep1 (first (rt source)))) (< index2 temp___1812))) (= (select n3 temp___1812) (select temp___1811 temp___1812))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 3))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= index2 temp___1809)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= index2 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= n3 n4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= index4 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= n5 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= index9 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= n10 (mk_map__ref1 n4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= index6 index4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809)) (= n7 n5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809))) (= index1 index5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809))) (= n1 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1809))) (= n7 n1)))
(assert (and (= temp___1814 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___1814) (<= temp___1814 (to_rep1 n__last))))
(assert (= o9 temp___1814))
(assert (= o10 (select n6 o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= (mk_int__ref result3) (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 9))
(assert (and (= temp___1815 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___1815) (<= temp___1815 (to_rep1 n__last))))
(assert (= o12 temp___1815))
...
(assert (= target2 o18))
(assert (<= target2 99))
(assert (and (= temp___1816 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___1816) (<= temp___1816 (to_rep1 n__last))))
(assert (= o19 temp___1816))
...
(assert (= target3 o25))
(assert (<= target3 999))
(assert (and (= temp___1817 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 n__first) temp___1817) (<= temp___1817 (to_rep1 n__last))))
(assert (= o26 temp___1817))
...
(assert (and (= temp___1821 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1821) (<= temp___1821 (to_rep1 (last (rt source))))))
(assert (= o45 temp___1821))
...
(assert (and (= temp___1820 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1820) (<= temp___1820 (to_rep1 (last (rt source))))))
(assert (= o39 temp___1820))
(assert (= o40 (select (elts source) o39)))
(assert (= o41 (to_rep o40)))
(assert (and (= o42 (convert_character_digit_to_integer o41)) (and (in_range1 o42) (and (and (<= 0 o42) (<= o42 9)) (ite (= (= o41 48) true) (= o42 0) (ite (= (= o41 49) true) (= o42 1) (ite (= (= o41 50) true) (= o42 2) (ite (= (= o41 51) true) (= o42 3) (ite (= (= o41 52) true) (= o42 4) (ite (= (= o41 53) true) (= o42 5) (ite (= (= o41 54) true) (= o42 6) (ite (= (= o41 55) true) (= o42 7) (ite (= (= o41 56) true) (= o42 8) (=> (= (= o41 57) true) (= o42 9)))))))))))))))
(assert (= o43 (* o42 10)))
(assert (and (= o44 o43) (in_range1 o43)))
(assert (and (= temp___1819 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1819) (<= temp___1819 (to_rep1 (last (rt source))))))
(assert (= o33 temp___1819))
(assert (= o34 (select (elts source) o33)))
(assert (= o35 (to_rep o34)))
(assert (and (= o36 (convert_character_digit_to_integer o35)) (and (in_range1 o36) (and (and (<= 0 o36) (<= o36 9)) (ite (= (= o35 48) true) (= o36 0) (ite (= (= o35 49) true) (= o36 1) (ite (= (= o35 50) true) (= o36 2) (ite (= (= o35 51) true) (= o36 3) (ite (= (= o35 52) true) (= o36 4) (ite (= (= o35 53) true) (= o36 5) (ite (= (= o35 54) true) (= o36 6) (ite (= (= o35 55) true) (= o36 7) (ite (= (= o35 56) true) (= o36 8) (=> (= (= o35 57) true) (= o36 9)))))))))))))))
(assert (= o37 (* o36 100)))
