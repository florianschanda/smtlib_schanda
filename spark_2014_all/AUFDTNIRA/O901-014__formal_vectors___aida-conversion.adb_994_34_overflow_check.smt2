...
(assert (forall ((temp___1699 Int) (temp___1700 Int) (temp___1701 Int)) (let ((temp___1698 (aida__conversion__calculate_positive_target_length_4__n__aggregate_def temp___1699 temp___1700 temp___1701))) (and (=> (dynamic_property6 (first1 source) (+ (first1 source) 3) temp___1700 temp___1701) (and (= (first5 temp___1698) temp___1700) (= (last5 temp___1698) temp___1701))) (forall ((temp___1702 Int)) (= (select (to_array2 temp___1698) temp___1702) (of_rep1 temp___1699)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_437 us_t1) (temp___is_init_434 Bool) (temp___skip_constant_435 Bool) (temp___do_toplevel_436 Bool)) Bool (=> (not (= temp___skip_constant_435 true)) (and (dynamic_property2 (first1 source) (+ (first1 source) 3) (first3 temp___expr_437) (last3 temp___expr_437)) (and (= (first3 temp___expr_437) (first1 source)) (= (last3 temp___expr_437) (+ (first1 source) 3))))))
...
(declare-const temp___1704 (Array Int integer))
(declare-const temp___17041 t2)
...
(declare-const temp___1707 (Array Int integer))
(declare-const o Int)
...
(assert (and (= (length source) 4) (forall ((index13 Int)) (=> (and (<= (to_rep1 (first (rt source))) index13) (<= index13 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index13))) true)))))
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_length_4__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_length_4__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3))))) (+ (to_rep1 (first (rt source))) 3)) (= (mk___t2 temp___1704 temp___17041) (aida__conversion__calculate_positive_target_length_4__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3))))) (and (= (ite (<= (to_rep1 (first4 temp___17041)) (to_rep1 (last4 temp___17041))) (+ (- (to_rep1 (last4 temp___17041)) (to_rep1 (first4 temp___17041))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3)) (+ (- (+ (to_rep1 (first (rt source))) 3) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1704 (to_rep1 (first4 temp___17041)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_length_4__n__assume) (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3)) aida__conversion__calculate_positive_target_length_4__n__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_positive_target_length_4__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_length_4__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_length_4__n__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 3)))) (and (and (and (= temp___1711 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))) (and (and (= (mk_int__ref result1) (mk_int__ref index)) (= index2 (to_rep1 (first (rt source))))) (ite (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1711)) (and (and (and (= temp___1709 index2) (and (= temp___1707 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o index2)) (= o1 (select n1 o))) (= o2 (to_rep1 o1))) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o3 index2)) (= o4 (select (elts source) o3))) (= o5 (to_rep o4))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o7 index2)) (= o8 (store n1 o7 o6)))) (and (= n1 result2) (= n2 o8))))) (and (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (= (to_rep1 (select n3 j1)) (convert_character_digit_to_integer (to_rep (select (elts source) j1)))))) (and (and (and (forall ((temp___1708 Int)) (=> (and (<= (to_rep1 n__first) temp___1708) (<= temp___1708 (to_rep1 n__last))) (=> (< index3 temp___1708) (= (select n3 temp___1708) (select temp___1707 temp___1708))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 3) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 3)))) (= index3 temp___1711)))))) (and (and (= index3 index7) (= n3 n7)) (and (= index8 index3) (= n8 n3)))) (and (and (= (mk_int__ref index9) (mk_int__ref index7)) (= (mk_map__ref1 n9) (mk_map__ref1 n7))) (and (= index10 index8) (= n10 n8)))) (and (and (= index2 index9) (= n1 n9)) (and (= index10 index2) (= n10 n1)))))) (and (and (and (and (and (and (= temp___1712 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))) (and (and (<= (to_rep1 n__first) temp___1712) (<= temp___1712 (to_rep1 n__last))) (= o22 temp___1712))) (= o23 (select n9 o22))) (= o24 (to_rep1 o23))) (and (= (mk_int__ref result5) (mk_int__ref target)) (= target1 o24))) (and (<= target1 9) (and (and (and (and (and (and (and (and (and (and (= temp___1713 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (<= (to_rep1 n__first) temp___1713) (<= temp___1713 (to_rep1 n__last))) (= o25 temp___1713))) (= o26 (select n9 o25))) (= o27 (to_rep1 o26))) (= o28 (* o27 10))) (and (= o29 o28) (in_range1 o28))) (= o30 (+ target1 o29))) (and (= o31 o30) (in_range1 o30))) (and (= target1 result6) (= target2 o31))) (and (<= target2 99) (and (and (and (and (and (and (and (and (and (and (= temp___1714 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (<= (to_rep1 n__first) temp___1714) (<= temp___1714 (to_rep1 n__last))) (= o32 temp___1714))) (= o33 (select n9 o32))) (= o34 (to_rep1 o33))) (= o35 (* o34 100))) (and (= o36 o35) (in_range1 o35))) (= o37 (+ target2 o36))) (and (= o38 o37) (in_range1 o37))) (and (= result7 (mk_int__ref target2)) (= target3 o38))) (and (<= target3 999) (and (and (and (and (and (and (and (and (and (and (= temp___1715 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))) (and (and (<= (to_rep1 n__first) temp___1715) (<= temp___1715 (to_rep1 n__last))) (= o39 temp___1715))) (= o40 (select n9 o39))) (= o41 (to_rep1 o40))) (= o42 (* o41 1000))) (and (= o43 o42) (in_range1 o42))) (= o44 (+ target3 o43))) (and (= o45 o44) (in_range1 o44))) (and (= result8 (mk_int__ref target3)) (= target4 o45))) (and (<= target4 9999) (and (= result9 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0)))))))))))))) (and (and (= index11 (mk_int__ref index9)) (and (= n11 (mk_map__ref1 n9)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target5 (mk_int__ref target4))))) (and (= index12 index10) (and (= n12 n10) (and (= has_failed3 has_failed1) (= target6 target4)))))))
(assert (and (= temp___1719 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1719) (<= temp___1719 (to_rep1 (last (rt source))))))
(assert (= o67 temp___1719))
...
(assert (and (= temp___1718 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1718) (<= temp___1718 (to_rep1 (last (rt source))))))
(assert (= o59 temp___1718))
...
(assert (and (= temp___1717 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1717) (<= temp___1717 (to_rep1 (last (rt source))))))
(assert (= o51 temp___1717))
