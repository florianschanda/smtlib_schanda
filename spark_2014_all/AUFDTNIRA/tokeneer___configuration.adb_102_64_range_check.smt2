...
(assert (not (= (length temp___1905) 0)))
(assert (=> (<= 1 2) (= o36 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o36 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1905))) (to_rep1 (last (rt temp___1905)))) (= o37 (+ (- (to_rep1 (last (rt temp___1905))) (to_rep1 (first (rt temp___1905)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1905))) (to_rep1 (last (rt temp___1905))))) (= o37 0)))
(assert (= o38 (+ o37 o36)))
(assert (= o39 (+ (to_rep1 (first (rt temp___1905))) o38)))
(assert (= o40 (- o39 1)))
