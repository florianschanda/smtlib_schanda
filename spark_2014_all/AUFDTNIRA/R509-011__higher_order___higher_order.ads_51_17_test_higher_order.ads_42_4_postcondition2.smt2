...
(declare-const result6 (Array Int element_2))
...
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= temp___396 i1)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= temp___395 acc1)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= temp___393 r)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (and (= o (+ (to_rep1 (select (elts2 a) i1)) acc1)) (in_range1 (+ (to_rep1 (select (elts2 a) i1)) acc1)))))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= (to_rep2 o1) o)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= o2 (store r i1 o1))))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= (mk_map__ref1 result2) r13)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= r2 o2)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (forall ((k Int)) (=> (and (<= (to_rep (first4 (rt2 a))) k) (<= k i2)) (and (= (in_range5 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) (to_rep2 (select r3 k)) (+ (- k (to_rep (first4 (rt2 a)))) 1)) true) (= (to_rep2 (select r3 k)) (+ (to_rep1 (select (elts2 a) k)) (ite (= k (to_rep (first4 (rt2 a)))) init (to_rep2 (select r3 (- k 1)))))))))))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (and (and (and (forall ((temp___394 Int)) (=> (and (<= (to_rep r__first) temp___394) (<= temp___394 (to_rep r__last))) (=> (or (< (to_rep (last4 (rt2 a))) temp___394) (or (< temp___394 (to_rep (first4 (rt2 a)))) (< i2 temp___394))) (= (select r3 temp___394) (select temp___393 temp___394))))) (=> (<= (- 2147483648) 2147483647) (in_range7 acc2))) (=> (<= (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))) (dynamic_property5 (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))) i2))) (and (<= (to_rep (first4 (rt2 a))) i2) (<= i2 (to_rep (last4 (rt2 a))))))))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= acc2 result3)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= acc3 (to_rep2 (select r3 i2)))))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= i2 (to_rep (last4 (rt2 a))))))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= i2 i3)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= r3 r4)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= acc3 acc4)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= i4 i2)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= r5 r3)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= acc5 acc3)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= i11 (mk_int__ref i3))))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= r12 (mk_map__ref1 r4))))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= acc12 (mk_int__ref acc4))))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= i6 i4)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= r7 r5)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= acc7 acc5)))
(assert (=> (not (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a)))))) (= i1 i5)))
(assert (=> (not (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a)))))) (= r12 r13)))
(assert (=> (not (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a)))))) (= acc1 acc6)))
(assert (=> (not (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a)))))) (= i6 i1)))
(assert (=> (not (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a)))))) (= r7 r1)))
(assert (=> (not (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a)))))) (= acc7 acc1)))
...
(assert (= r11 r9))
(assert (= acc11 acc9))
(assert (= (mk___t1 result6 result7) (acc_array__content test_higher_order__sum__acc_f__result5)))
(assert (not (= (to_rep (first2 (rt1 (acc_array__content test_higher_order__sum__acc_f__result5)))) (to_rep (first4 (rt2 a))))))
(check-sat)
(exit)
