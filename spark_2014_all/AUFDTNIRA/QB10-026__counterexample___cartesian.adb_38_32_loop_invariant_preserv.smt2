...
(assert (= result9 (mk_int__ref index12)))
(assert (= index13 (+ index12 1)))
(assert (= result10 (mk_int__ref index29)))
(assert (= index210 (to_rep (first (rt array2)))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= temp___2451 result__9)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= temp___2431 index210)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= temp___2421 result_index9)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (and (= o69 (+ result_index9 1)) (in_range1 (+ result_index9 1)))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= result11 (mk_int__ref result_index9))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= result_index10 o69)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (and (<= (to_rep result____first) result_index10) (<= result_index10 (to_rep result____last)))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= o70 result_index10)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= o71 (store result__9 o70 (temp___237 (to_rep (select (elts array1) index13)) (to_rep (select (elts array2) index210)))))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= result12 (mk_map__ref1 result__9))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= result__10 o71)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= result_index11 (+ (+ (* (- index13 (to_rep (first (rt array1)))) (length array2)) (- index211 (to_rep (first (rt array2))))) 1))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 index211)) (= (to_rep (select (select result__11 (+ (+ (* (- index13 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) index13)))))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 index211)) (= (to_rep (select (select result__11 (+ (+ (* (- index13 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j9)))))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (and (and (=> (<= 0 2147483647) (in_range2 result_index11)) (=> (<= (to_rep (first (rt array2))) (to_rep (last (rt array2)))) (dynamic_property7 (to_rep (first (rt array2))) (to_rep (last (rt array2))) index211))) (and (<= (to_rep (first (rt array2))) index211) (<= index211 (to_rep (last (rt array2))))))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= index211 (to_rep (last (rt array2))))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= index215 (mk_int__ref index211))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= result_index15 (mk_int__ref result_index11))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= result__15 (mk_map__ref1 result__11))))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= index216 index211)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= result_index16 result_index11)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= result__16 result__11)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= index217 index215)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= result_index17 result_index15)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= result__17 result__15)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= index218 index216)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= result_index18 result_index16)))
(assert (=> (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2))))) (= result__18 result__16)))
(assert (=> (not (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2)))))) (= index217 (mk_int__ref index210))))
(assert (=> (not (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2)))))) (= result_index17 (mk_int__ref result_index9))))
(assert (=> (not (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2)))))) (= result__17 (mk_map__ref1 result__9))))
(assert (=> (not (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2)))))) (= index218 index210)))
(assert (=> (not (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2)))))) (= result_index18 result_index9)))
(assert (=> (not (and (<= (to_rep (first (rt array2))) index210) (<= index210 (to_rep (last (rt array2)))))) (= result__18 result__9)))
(assert (= index219 index217))
(assert (= index14 (mk_int__ref index13)))
(assert (= result_index19 result_index17))
(assert (= result__19 result__17))
(assert (= index220 index218))
(assert (= index15 index13))
(assert (= result_index20 result_index18))
(assert (= result__20 result__18))
(assert (not (= (int__content result_index19) (* (+ (- (int__content index14) (to_rep (first (rt array1)))) 1) (length array2)))))
(check-sat)
(exit)
