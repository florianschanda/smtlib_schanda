...
(define-fun dynamic_invariant2 ((temp___expr_1197 Int) (temp___is_init_1193 Bool) (temp___skip_constant_1194 Bool) (temp___do_toplevel_1195 Bool) (temp___do_typ_inv_1196 Bool)) Bool (=> (or (= temp___is_init_1193 true) (<= 0 1)) (in_range4 temp___expr_1197)))
...
(declare-fun user_eq6 (tlogentrycounttB tlogentrycounttB) Bool)
(declare-const dummy6 tlogentrycounttB)
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep2 (select a temp___idx_172)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(assert (forall ((x fileentrycountt)) (! (in_range9 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep4 (select a temp___idx_173)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(define-fun bool_eq6 ((a (Array Int us_rep2)) (a__first Int) (a__last Int) (b (Array Int us_rep2)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq5 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true)))) true false))
...
(declare-fun valid_numberlogentries__2 (us_rep1) Bool)
(declare-fun valid_numberlogentries__2__function_guard (Bool us_rep1) Bool)
...
(define-fun dynamic_invariant4 ((temp___expr_1204 Int) (temp___is_init_1200 Bool) (temp___skip_constant_1201 Bool) (temp___do_toplevel_1202 Bool) (temp___do_typ_inv_1203 Bool)) Bool (=> (or (= temp___is_init_1200 true) (<= 0 17)) (in_range5 temp___expr_1204)))
(define-fun dynamic_invariant5 ((temp___expr_1211 Int) (temp___is_init_1207 Bool) (temp___skip_constant_1208 Bool) (temp___do_toplevel_1209 Bool) (temp___do_typ_inv_1210 Bool)) Bool (=> (or (= temp___is_init_1207 true) (<= 1 17)) (in_range6 temp___expr_1211)))
(define-fun dynamic_invariant6 ((temp___expr_1324 Int) (temp___is_init_1320 Bool) (temp___skip_constant_1321 Bool) (temp___do_toplevel_1322 Bool) (temp___do_typ_inv_1323 Bool)) Bool (=> (or (= temp___is_init_1320 true) (<= 0 2)) (in_range10 temp___expr_1324)))
(define-fun dynamic_invariant7 ((temp___expr_1218 Int) (temp___is_init_1214 Bool) (temp___skip_constant_1215 Bool) (temp___do_toplevel_1216 Bool) (temp___do_typ_inv_1217 Bool)) Bool (=> (or (= temp___is_init_1214 true) (<= 0 17408)) (in_range8 temp___expr_1218)))
(define-fun dynamic_invariant8 ((temp___expr_1249 Int) (temp___is_init_1245 Bool) (temp___skip_constant_1246 Bool) (temp___do_toplevel_1247 Bool) (temp___do_typ_inv_1248 Bool)) Bool (=> (or (= temp___is_init_1245 true) (<= 0 1024)) (in_range9 temp___expr_1249)))
(assert true)
...
(assert (forall ((temp___1277 Int)) (=> (dynamic_invariant8 temp___1277 true true true true) (forall ((temp___1278 Int)) (= (to_rep4 (select (temp___1275 temp___1277) temp___1278)) temp___1277)))))
(assert true)
(assert (forall ((logfilestate us_rep1)) (! (= (= (valid_numberlogentries__2 logfilestate) true) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 logfilestate))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 logfilestate))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 logfilestate)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 logfilestate))) true)) :pattern ((valid_numberlogentries__2 logfilestate)))))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(assert (forall ((temp___1273 Int)) (=> (dynamic_invariant5 temp___1273 true true true true) (forall ((temp___1274 Int)) (= (to_rep2 (select (temp___1271 temp___1273) temp___1274)) temp___1273)))))
...
(declare-const truncatedescription (Array Int character))
(declare-const o Int)
...
(declare-const truncatedescription1 (Array Int character))
...
(declare-const logfilestate__split_fields16 logfilecountt)
(declare-const logfilestate__split_fields17 (Array Int fileentrycountt))
(declare-const truncatedescription2 (Array Int character))
...
(declare-const logfilestate__split_fields19 logentrycountt)
(declare-const logfilestate__split_fields20 (Array Int logfileindext))
(declare-const logfilestate__split_fields21 logfileindext)
(declare-const logfilestate__split_fields22 logfileindext)
(declare-const logfilestate__split_fields23 logfilecountt)
(declare-const logfilestate__split_fields24 (Array Int fileentrycountt))
...
(declare-const logfilestate__split_fields26 logentrycountt)
(declare-const logfilestate__split_fields27 (Array Int logfileindext))
(declare-const logfilestate__split_fields28 logfileindext)
(declare-const logfilestate__split_fields29 logfileindext)
(declare-const logfilestate__split_fields30 logfilecountt)
(declare-const logfilestate__split_fields31 (Array Int fileentrycountt))
...
(declare-const logfilestate__split_fields32 us_split_fields__ref1)
(declare-const truncatedescription3 map__ref)
...
(declare-const logfilestate__split_fields33 us_split_fields2)
(declare-const truncatedescription4 (Array Int character))
(define-fun logfilestate__split_fields34 () us_split_fields2 (mk___split_fields1 logfilestate__split_fields25 logfilestate__split_fields26 (mk___rep (mk___split_fields logfilestate__split_fields27 logfilestate__split_fields28 logfilestate__split_fields29 logfilestate__split_fields30)) logfilestate__split_fields31))
...
(assert (and (<= 1 (to_rep1 logfilestate__split_fields5)) (= (to_rep3 logfilestate__split_fields1) (+ (* (- (to_rep1 logfilestate__split_fields5) 1) 1024) (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields)))))))
(assert (=> (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17)) (and (and (and (and (<= 1 (to_rep1 logfilestate__split_fields16)) (= (to_rep4 (select logfilestate__split_fields17 (to_rep2 logfilestate__split_fields14))) (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))))) (= (to_rep1 logfilestate__split_fields16) 16)) (= (to_rep3 logfilestate__split_fields15) (* (to_rep1 logfilestate__split_fields16) 1024))) (in_range4 auditalarm2))))
(assert (=> (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17)) (and (and (and (= (to_rep3 logfilestate__split_fields19) (+ (* (- (to_rep1 logfilestate__split_fields23) 1) 1024) (to_rep4 (select logfilestate__split_fields24 (to_rep2 logfilestate__split_fields18))))) (= (to_rep3 logfilestate__split_fields19) (+ (to_rep3 logfilestate__split_fields15) 1))) (=> (= (to_rep4 (select logfilestate__split_fields17 (to_rep2 logfilestate__split_fields14))) 1024) (and (= (to_rep4 (select logfilestate__split_fields24 (to_rep2 logfilestate__split_fields18))) 1) (= (to_rep1 logfilestate__split_fields23) (+ (to_rep1 logfilestate__split_fields16) 1))))) (=> (< (to_rep4 (select logfilestate__split_fields17 (to_rep2 logfilestate__split_fields14))) 1024) (and (= (to_rep4 (select logfilestate__split_fields24 (to_rep2 logfilestate__split_fields18))) (+ (to_rep4 (select logfilestate__split_fields17 (to_rep2 logfilestate__split_fields14))) 1)) (= (to_rep1 logfilestate__split_fields23) (to_rep1 logfilestate__split_fields16)))))))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= truncatedescription2 truncatedescription)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= logfilestate__split_fields logfilestate__split_fields18)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= logfilestate__split_fields1 logfilestate__split_fields19)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= logfilestate__split_fields2 logfilestate__split_fields20)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= logfilestate__split_fields3 logfilestate__split_fields21)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= logfilestate__split_fields4 logfilestate__split_fields22)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= logfilestate__split_fields5 logfilestate__split_fields23)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= logfilestate__split_fields6 logfilestate__split_fields24)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= auditsystemfault2 auditsystemfault)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= auditalarm2 auditalarm)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= logfilesstatus2 logfilesstatus)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= logfiles2 logfiles)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= truncatedescription2 truncatedescription1)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= (mk___split_fields1 logfilestate__split_fields18 logfilestate__split_fields19 (mk___rep (mk___split_fields logfilestate__split_fields20 logfilestate__split_fields21 logfilestate__split_fields22 logfilestate__split_fields23)) logfilestate__split_fields24) (mk___split_fields1 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13))))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= auditsystemfault2 auditsystemfault1)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= auditalarm2 auditalarm1)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= logfilesstatus2 logfilesstatus1)))
(assert (=> (not (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= (to_rep1 logfilestate__split_fields5) 17))) (= logfiles2 logfiles1)))
(assert (and (and (and (= (to_rep3 logfilestate__split_fields26) (+ (* (- (to_rep1 logfilestate__split_fields30) 1) 1024) (to_rep4 (select logfilestate__split_fields31 (to_rep2 logfilestate__split_fields25))))) (= (to_rep3 logfilestate__split_fields26) (+ (to_rep3 logfilestate__split_fields19) 1))) (=> (= (to_rep4 (select logfilestate__split_fields24 (to_rep2 logfilestate__split_fields18))) 1024) (and (= (to_rep4 (select logfilestate__split_fields31 (to_rep2 logfilestate__split_fields25))) 1) (= (to_rep1 logfilestate__split_fields30) (+ (to_rep1 logfilestate__split_fields23) 1))))) (=> (< (to_rep4 (select logfilestate__split_fields24 (to_rep2 logfilestate__split_fields18))) 1024) (and (= (to_rep4 (select logfilestate__split_fields31 (to_rep2 logfilestate__split_fields25))) (+ (to_rep4 (select logfilestate__split_fields24 (to_rep2 logfilestate__split_fields18))) 1)) (= (to_rep1 logfilestate__split_fields30) (to_rep1 logfilestate__split_fields23))))))
(assert (= truncatedescription3 (mk_map__ref truncatedescription2)))
(assert (= logfilestate__split_fields32 (mk___split_fields__ref1 logfilestate__split_fields34)))
(assert (= auditsystemfault4 (mk_bool__ref auditsystemfault3)))
(assert (= auditalarm3 (mk_int__ref auditalarm2)))
(assert (= logfilesstatus4 (mk_map__ref4 logfilesstatus3)))
(assert (= logfiles4 (mk_map__ref3 logfiles3)))
(assert (= truncatedescription4 truncatedescription2))
(assert (= logfilestate__split_fields33 logfilestate__split_fields34))
(assert (= auditsystemfault5 auditsystemfault3))
(assert (= auditalarm4 auditalarm2))
(assert (= logfilesstatus5 logfilesstatus3))
(assert (= logfiles5 logfiles3))
(assert (and (= o (- (to_rep1 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields32))))) 1)) (in_range8 (- (to_rep1 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields32))))) 1))))
(assert (= o1 (* o 1024)))
(assert (and (= o2 o1) (in_range7 o1)))
(assert (= o3 (+ o2 (to_rep4 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields32)) (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields32))))))))
(assert (not (in_range7 o3)))
(check-sat)
(exit)
