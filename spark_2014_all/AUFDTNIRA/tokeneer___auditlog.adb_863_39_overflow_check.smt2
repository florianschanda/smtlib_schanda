...
(define-fun dynamic_invariant2 ((temp___expr_1066 Int) (temp___is_init_1063 Bool) (temp___skip_constant_1064 Bool) (temp___do_toplevel_1065 Bool)) Bool (=> (or (= temp___is_init_1063 true) (<= 0 1)) (in_range4 temp___expr_1066)))
...
(assert (forall ((x logfileindext)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range7 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range8 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq1 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq1 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep1 (select a (+ i 1))) (to_rep1 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq1 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep1 (select b (+ i 1))) (to_rep1 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare2 a a_first a_last b b_first b_last) 0) (= (bool_eq3 a a_first a_last b b_first b_last) true)) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq3 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep4 (select a (+ i 1))) (to_rep4 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq3 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep4 (select b (+ i 1))) (to_rep4 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq6 ((a (Array Int us_rep2)) (a__first Int) (a__last Int) (b (Array Int us_rep2)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_152 Int)) (=> (and (<= a__first temp___idx_152) (<= temp___idx_152 a__last)) (= (bool_eq5 (select a temp___idx_152) (select b (+ (- b__first a__first) temp___idx_152))) true)))) true false))
...
(define-fun dynamic_invariant4 ((temp___expr_1093 Int) (temp___is_init_1090 Bool) (temp___skip_constant_1091 Bool) (temp___do_toplevel_1092 Bool)) Bool (=> (or (= temp___is_init_1090 true) (<= 0 17)) (in_range8 temp___expr_1093)))
(define-fun dynamic_invariant5 ((temp___expr_1072 Int) (temp___is_init_1069 Bool) (temp___skip_constant_1070 Bool) (temp___do_toplevel_1071 Bool)) Bool (=> (or (= temp___is_init_1069 true) (<= 1 17)) (in_range5 temp___expr_1072)))
(define-fun dynamic_invariant6 ((temp___expr_1184 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 0 2)) (in_range10 temp___expr_1184)))
(define-fun dynamic_invariant7 ((temp___expr_1078 Int) (temp___is_init_1075 Bool) (temp___skip_constant_1076 Bool) (temp___do_toplevel_1077 Bool)) Bool (=> (or (= temp___is_init_1075 true) (<= 0 17408)) (in_range7 temp___expr_1078)))
(define-fun dynamic_invariant8 ((temp___expr_1112 Int) (temp___is_init_1109 Bool) (temp___skip_constant_1110 Bool) (temp___do_toplevel_1111 Bool)) Bool (=> (or (= temp___is_init_1109 true) (<= 0 1024)) (in_range9 temp___expr_1112)))
(assert true)
...
(declare-const logfilestate__split_fields29 logentrycountt)
(declare-const logfilestate__split_fields30 (Array Int logfileindext))
(declare-const logfilestate__split_fields31 logfileindext)
(declare-const logfilestate__split_fields32 logfileindext)
(declare-const logfilestate__split_fields33 logfilecountt)
(declare-const logfilestate__split_fields34 (Array Int fileentrycountt))
...
(assert (and (<= 1 (to_rep3 logfilestate__split_fields5)) (= (to_rep2 logfilestate__split_fields1) (+ (* (- (to_rep3 logfilestate__split_fields5) 1) 1024) (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields)))))))
(assert (and (and (ite (and (= (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024) (= (to_rep3 logfilestate__split_fields5) 17)) (and (and (and (and (and (<= 1 (to_rep3 logfilestate__split_fields19)) (= (to_rep4 (select logfilestate__split_fields20 (to_rep1 logfilestate__split_fields14))) (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))))) (= (to_rep3 logfilestate__split_fields19) 16)) (= (to_rep2 logfilestate__split_fields15) (* (to_rep3 logfilestate__split_fields19) 1024))) (in_range4 auditalarm2)) (and (and (and (= (to_rep2 logfilestate__split_fields22) (+ (* (- (to_rep3 logfilestate__split_fields26) 1) 1024) (to_rep4 (select logfilestate__split_fields27 (to_rep1 logfilestate__split_fields21))))) (= (to_rep2 logfilestate__split_fields22) (+ (to_rep2 logfilestate__split_fields15) 1))) (=> (= (to_rep4 (select logfilestate__split_fields20 (to_rep1 logfilestate__split_fields14))) 1024) (and (= (to_rep4 (select logfilestate__split_fields27 (to_rep1 logfilestate__split_fields21))) 1) (= (to_rep3 logfilestate__split_fields26) (+ (to_rep3 logfilestate__split_fields19) 1))))) (=> (< (to_rep4 (select logfilestate__split_fields20 (to_rep1 logfilestate__split_fields14))) 1024) (and (= (to_rep4 (select logfilestate__split_fields27 (to_rep1 logfilestate__split_fields21))) (+ (to_rep4 (select logfilestate__split_fields20 (to_rep1 logfilestate__split_fields14))) 1)) (= (to_rep3 logfilestate__split_fields26) (to_rep3 logfilestate__split_fields19)))))) (and (and (= truncatedescription2 truncatedescription) (and (and (= logfilestate__split_fields logfilestate__split_fields21) (and (= logfilestate__split_fields1 logfilestate__split_fields22) (and (and (= logfilestate__split_fields2 logfilestate__split_fields23) (and (= logfilestate__split_fields3 logfilestate__split_fields24) (and (= logfilestate__split_fields4 logfilestate__split_fields25) (= logfilestate__split_fields5 logfilestate__split_fields26)))) (= logfilestate__split_fields6 logfilestate__split_fields27)))) (and (= auditsystemfault2 auditsystemfault) (and (= auditalarm2 auditalarm) (and (= logfilesstatus2 logfilesstatus) (= logfiles2 logfiles)))))) (and (= truncatedescription2 truncatedescription1) (and (= (mk___split_fields1 logfilestate__split_fields21 logfilestate__split_fields22 (mk___rep (mk___split_fields logfilestate__split_fields23 logfilestate__split_fields24 logfilestate__split_fields25 logfilestate__split_fields26)) logfilestate__split_fields27) (mk___split_fields1 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13)) (and (= auditsystemfault2 auditsystemfault1) (and (= auditalarm2 auditalarm1) (and (= logfilesstatus2 logfilesstatus1) (= logfiles2 logfiles1)))))))) (and (and (and (= (to_rep2 logfilestate__split_fields29) (+ (* (- (to_rep3 logfilestate__split_fields33) 1) 1024) (to_rep4 (select logfilestate__split_fields34 (to_rep1 logfilestate__split_fields28))))) (= (to_rep2 logfilestate__split_fields29) (+ (to_rep2 logfilestate__split_fields22) 1))) (=> (= (to_rep4 (select logfilestate__split_fields27 (to_rep1 logfilestate__split_fields21))) 1024) (and (= (to_rep4 (select logfilestate__split_fields34 (to_rep1 logfilestate__split_fields28))) 1) (= (to_rep3 logfilestate__split_fields33) (+ (to_rep3 logfilestate__split_fields26) 1))))) (=> (< (to_rep4 (select logfilestate__split_fields27 (to_rep1 logfilestate__split_fields21))) 1024) (and (= (to_rep4 (select logfilestate__split_fields34 (to_rep1 logfilestate__split_fields28))) (+ (to_rep4 (select logfilestate__split_fields27 (to_rep1 logfilestate__split_fields21))) 1)) (= (to_rep3 logfilestate__split_fields33) (to_rep3 logfilestate__split_fields26)))))) (and (and (= truncatedescription3 (mk_map__ref truncatedescription2)) (and (= logfilestate__split_fields35 (mk___split_fields__ref1 (mk___split_fields1 logfilestate__split_fields28 logfilestate__split_fields29 (mk___rep (mk___split_fields logfilestate__split_fields30 logfilestate__split_fields31 logfilestate__split_fields32 logfilestate__split_fields33)) logfilestate__split_fields34))) (and (= auditsystemfault4 (mk_bool__ref auditsystemfault3)) (and (= auditalarm3 (mk_int__ref auditalarm2)) (and (= logfilesstatus4 (mk_map__ref4 logfilesstatus3)) (= logfiles4 (mk_map__ref3 logfiles3))))))) (and (= truncatedescription4 truncatedescription2) (and (= logfilestate__split_fields36 (mk___split_fields1 logfilestate__split_fields28 logfilestate__split_fields29 (mk___rep (mk___split_fields logfilestate__split_fields30 logfilestate__split_fields31 logfilestate__split_fields32 logfilestate__split_fields33)) logfilestate__split_fields34)) (and (= auditsystemfault5 auditsystemfault3) (and (= auditalarm4 auditalarm2) (and (= logfilesstatus5 logfilesstatus3) (= logfiles5 logfiles3)))))))))
(assert (and (= o5 (- (to_rep3 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields35))))) 1)) (in_range7 (- (to_rep3 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields35))))) 1))))
(assert (= o6 (* o5 1024)))
(assert (and (= o7 o6) (in_range6 o6)))
(assert (= o8 (+ o7 (to_rep4 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields35)) (to_rep1 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields35))))))))
(assert (not (in_range6 o8)))
(check-sat)
(exit)
