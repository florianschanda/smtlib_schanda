...
(declare-const o10 t)
(declare-const temp___338 positive)
(declare-const temp___3381 natural)
(declare-const temp___3382 positive)
(declare-const temp___3383 positive)
(declare-const temp___3384 (Array Int element_type))
(declare-const temp___3385 t)
...
(assert (= item1 o2))
(assert (and (= o3 (+ (mod1 (to_rep1 queue__split_fields1) (to_rep1 (rec__bounded_queue_v1__queue_type__max_size queue__split_discrs))) 1)) (in_range (+ (mod1 (to_rep1 queue__split_fields1) (to_rep1 (rec__bounded_queue_v1__queue_type__max_size queue__split_discrs))) 1))))
...
(assert (= queue__split_discrs (mk___split_discrs temp___338)))
(assert (= temp___3381 o6))
(assert (= temp___3382 o7))
(assert (= temp___3383 o8))
(assert (= temp___3384 o9))
(assert (= temp___3385 o10))
...
(assert (= temp___3381 queue__split_fields5))
(assert (= temp___3382 queue__split_fields6))
(assert (= temp___3383 queue__split_fields7))
(assert (= temp___3384 queue__split_fields8))
(assert (= temp___3385 queue__split_fields9))
(assert (= queue__split_discrs (mk___split_discrs temp___338)))
