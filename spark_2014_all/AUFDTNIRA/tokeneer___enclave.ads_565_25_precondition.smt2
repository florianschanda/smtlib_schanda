...
(assert (and (= o22 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o22) (= o22 (to_rep theadmin__split_fields)))))
(assert (= result (ite (= o22 1) true false)))
(assert (=> (= result true) (and (= o24 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o24 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result true) (= o25 (ite (not (= o24 true)) true false))))
...
(assert (=> (= result true) (=> (= result1 true) (and (= o23 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o23)))))
(assert (=> (= result true) (=> (= result1 true) (= o26 (ite (= o23 3) true false)))))
(assert (=> (= result true) (=> (not (= result1 true)) (= o26 false))))
(assert (=> (= result true) (= o27 (ite (= o26 false) o25 true))))
(assert (=> (not (= result true)) (= o27 (of_int 1))))
...
(assert (=> (= result3 true) (and (= o20 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o20))))
(assert (=> (= result3 true) (= result2 (ite (= o20 4) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o21 (statusiswaitingstartadminop status)) (= (= o21 true) (= status 6)))))
(assert (=> (not (= result2 true)) (= o21 (of_int 1))))
(assert (and (= result4 (statusisshutdown status)) (= (= result4 true) (= status 8))))
(assert (=> (= result4 true) (and (= o16 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o16) (= o16 (to_rep theadmin__split_fields))))))
(assert (=> (= result4 true) (= o17 (ite (= o16 0) true false))))
(assert (=> (= result4 true) (and (= o15 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o15 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result4 true) (= o18 (ite (not (= o15 true)) true false))))
...
(assert (=> (= result5 true) (and (= o13 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o13 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result5 true) (= o14 (ite (not (= o13 true)) true false))))
(assert (=> (not (= result5 true)) (= o14 (of_int 1))))
(assert (and (= o8 (statusiswaitingfinishadminop status)) (= (= o8 true) (= status 7))))
(assert (and (= o9 (statusiswaitingstartadminop status)) (= (= o9 true) (= status 6))))
(assert (= result6 (ite (= o9 false) o8 true)))
(assert (=> (= result6 true) (and (= o10 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o10 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result6 true) (and (= o11 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o11 true) (in_range5 (to_rep theadmin__split_fields))))))
(assert (=> (= result6 true) (= o12 (ite (= o11 true) o10 false))))
(assert (=> (not (= result6 true)) (= o12 (of_int 1))))
(assert (and (= o4 (statusiswaitingremoveadmintokenfail status)) (= (= o4 true) (= status 4))))
(assert (and (= o5 (statusisgotadmintoken status)) (= (= o5 true) (= status 5))))
(assert (= result7 (ite (= o5 false) o4 true)))
(assert (=> (= result7 true) (and (= o6 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o6 true) (in_range5 (to_rep theadmin__split_fields))))))
(assert (=> (= result7 true) (= o7 (ite (not (= o6 true)) true false))))
(assert (=> (not (= result7 true)) (= o7 (of_int 1))))
(assert (and (= o1 (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o1 true) (in_range5 (to_rep theadmin__split_fields)))))
(assert (= result8 (ite (not (= o1 true)) true false)))
(assert (=> (= result8 true) (and (= o2 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o2 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result8 true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (not (= result8 true)) (= o3 (of_int 1))))
