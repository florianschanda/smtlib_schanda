...
(define-fun dynamic_invariant1 ((temp___expr_234 Int) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool)) Bool (=> (or (= temp___is_init_231 true) (<= 0 23)) (in_range2 temp___expr_234)))
...
(define-fun dynamic_invariant2 ((temp___expr_240 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 0 59)) (in_range3 temp___expr_240)))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-fun temp___256 (Int Int Int Int) (Array Int displaydigits))
(assert (forall ((temp___258 Int) (temp___259 Int) (temp___260 Int) (temp___261 Int)) (let ((temp___257 (temp___256 temp___258 temp___259 temp___260 temp___261))) (and (and (and (= (select temp___257 0) (of_rep temp___258)) (= (select temp___257 1) (of_rep temp___259))) (= (select temp___257 2) (of_rep temp___260))) (= (select temp___257 3) (of_rep temp___261))))))
(define-fun dynamic_invariant3 ((temp___expr_143 Int) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (=> (or (= temp___is_init_140 true) (<= 0 9)) (in_range1 temp___expr_143)))
