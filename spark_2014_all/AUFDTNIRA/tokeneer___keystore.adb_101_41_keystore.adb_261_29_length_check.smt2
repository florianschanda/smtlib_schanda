...
(assert (=> (<= 1 temp___1720) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1720) (<= temp___1720 150)))))
(assert (= o27 (let ((subject result__1)) result__12)))
(assert (= temp___1721 (mk___t2 o27 (mk2 1 temp___1720))))
(assert (not (= (ite (<= (to_rep1 (first4 (rt2 temp___1718))) (to_rep1 (last4 (rt2 temp___1718)))) (+ (- (to_rep1 (last4 (rt2 temp___1718))) (to_rep1 (first4 (rt2 temp___1718)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1721))) (to_rep1 (last4 (rt2 temp___1721)))) (+ (- (to_rep1 (last4 (rt2 temp___1721))) (to_rep1 (first4 (rt2 temp___1721)))) 1) 0))))
(check-sat)
(exit)
