...
(define-fun o32 () us_rep9 (mk___rep4 (mk___split_fields4 o13 o14 o15)))
(define-fun o33 () us_rep9 (mk___rep4 (mk___split_fields4 o4 o5 o6)))
(assert (and (= o30 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o30) (= o30 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o28 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o28) (<= o28 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= o29 (* 2 o28)))
(assert (and (= o31 o29) (in_range2 o29)))
(assert (= result (ite (<= o31 o30) true false)))
(assert (= result true))
(assert (and (= o27 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o27) (<= o27 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= result1 (ite (<= o27 5000) true false)))
(assert (= result1 true))
...
(assert (= result2 true))
(assert (and (= o25 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1)) (= (= o25 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true))))
(assert (= o26 true))
...
(assert (= result3 true))
(assert (and (= o23 (has_key (positions x) c)) (= (= o23 true) (= (has_key (positions x) c) true))))
(assert (= o24 true))
(assert (= result6 (ite (= o24 true) o23 false)))
...
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j1)))))) j1) (<= j1 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j1))))))))))))
(assert (= result8 true))
...
(assert (= result9 true))
(assert (and (= o12 j) (in_range10 j)))
(assert (and (= o32 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) o12)) (= (bool_eq10 o32 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) o12)) true)))
(assert (= o13 o16))
(assert (= o14 o17))
(assert (= o15 o18))
(assert (= o19 o17))
...
(assert (and (= o3 j) (in_range10 j)))
(assert (and (= o33 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) o3)) (= (bool_eq10 o33 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) o3)) true)))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o6 o9))
(assert (= o10 o7))
...
(assert (= result10 (ite (= o22 true) o21 false)))
