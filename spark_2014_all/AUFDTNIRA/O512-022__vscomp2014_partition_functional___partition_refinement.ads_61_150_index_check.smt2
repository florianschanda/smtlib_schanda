...
(define-fun o32 () us_rep10 (mk___rep5 (mk___split_fields5 o13 o14 o15)))
(define-fun o33 () us_rep10 (mk___rep5 (mk___split_fields5 o4 o5 o6)))
(assert (and (= o30 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o30) (= o30 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o28 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o28) (<= o28 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= o29 (* 2 o28)))
(assert (and (= o31 o29) (in_range10 o29)))
(assert (= result (ite (<= o31 o30) true false)))
(assert (= result true))
(assert (and (= o27 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o27) (<= o27 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
...
(assert (= result9 true))
(assert (and (= o12 j) (in_range11 j)))
(assert (and (= o32 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) o12)) (= (bool_eq9 o32 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) o12)) true)))
(assert (= o13 o16))
(assert (= o14 o17))
(assert (= o15 o18))
(assert (= o19 o17))
(assert (= o20 (to_rep4 o19)))
(assert (= o21 (ite (<= k o20) true false)))
(assert (and (= o3 j) (in_range11 j)))
(assert (and (= o33 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) o3)) (= (bool_eq9 o33 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) o3)) true)))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o6 o9))
(assert (= o10 o7))
(assert (= o11 (to_rep4 o10)))
