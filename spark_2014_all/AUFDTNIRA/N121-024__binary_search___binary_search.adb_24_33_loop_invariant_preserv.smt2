...
(assert (=> (= result10 true) (and (= o19 (+ med3 1)) (in_range2 (+ med3 1)))))
(assert (=> (= result10 true) (= left3 result11)))
(assert (=> (= result10 true) (= left4 o19)))
...
(assert (=> (not (= result10 true)) (= o20 med3)))
(assert (=> (not (= result10 true)) (= o21 (select (elts a) o20))))
(assert (=> (not (= result10 true)) (= o22 (to_rep o21))))
(assert (=> (not (= result10 true)) (= result12 (ite (< i o22) true false))))
(assert (=> (not (= result10 true)) (= result12 true)))
(assert (=> (not (= result10 true)) (and (= o23 (- med3 1)) (in_range3 (- med3 1)))))
(assert (=> (not (= result10 true)) (= right3 result13)))
(assert (=> (not (= result10 true)) (= right4 o23)))
...
(assert (< left4 right4))
(assert (not (<= (to_rep1 (first (rt a))) left4)))
(check-sat)
(exit)
