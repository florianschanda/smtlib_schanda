...
(define-fun dynamic_invariant ((temp___expr_443 Int) (temp___is_init_440 Bool) (temp___skip_constant_441 Bool) (temp___do_toplevel_442 Bool)) Bool (=> (or (= temp___is_init_440 true) (<= 0 1)) (in_range3 temp___expr_443)))
...
(assert (forall ((temp___1144 Int)) (forall ((temp___1145 Int)) (= (select (temp___1142 temp___1144) temp___1145) (of_rep6 temp___1144)))))
(declare-fun temp___1146 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1148 Int)) (forall ((temp___1149 Int)) (= (select (temp___1146 temp___1148) temp___1149) (of_rep9 temp___1148)))))
(define-fun dynamic_invariant1 ((temp___expr_1136 us_rep3) (temp___is_init_1133 Bool) (temp___skip_constant_1134 Bool) (temp___do_toplevel_1135 Bool)) Bool (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1136))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1136))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1136)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1136))) true))
(define-fun default_initial_assumption ((temp___expr_1140 us_rep3) (temp___skip_top_level_1141 Bool)) Bool (and (and (and (= (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1140))) 1) (= (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1140))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1140)) (mk___rep2 (mk___split_fields2 (temp___1142 1) (of_rep6 1) (of_rep6 1) (of_rep8 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1140)) (temp___1146 0))))
(define-fun type_invariant ((temp___1150 us_rep3)) Bool (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1150))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1150))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1150)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1150))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_1302 Int) (temp___is_init_1299 Bool) (temp___skip_constant_1300 Bool) (temp___do_toplevel_1301 Bool)) Bool (=> (or (= temp___is_init_1299 true) (<= 0 1)) (in_range13 temp___expr_1302)))
...
(define-fun dynamic_invariant3 ((temp___expr_398 Int) (temp___is_init_395 Bool) (temp___skip_constant_396 Bool) (temp___do_toplevel_397 Bool)) Bool (=> (or (= temp___is_init_395 true) (<= 0 4)) (in_range2 temp___expr_398)))
(define-fun dynamic_invariant4 ((temp___expr_191 Int) (temp___is_init_188 Bool) (temp___skip_constant_189 Bool) (temp___do_toplevel_190 Bool)) Bool (=> (or (= temp___is_init_188 true) (<= 0 3)) (in_range1 temp___expr_191)))
(define-fun dynamic_invariant5 ((temp___expr_1102 Int) (temp___is_init_1099 Bool) (temp___skip_constant_1100 Bool) (temp___do_toplevel_1101 Bool)) Bool (=> (or (= temp___is_init_1099 true) (<= 0 17)) (in_range10 temp___expr_1102)))
(define-fun dynamic_invariant6 ((temp___expr_1081 Int) (temp___is_init_1078 Bool) (temp___skip_constant_1079 Bool) (temp___do_toplevel_1080 Bool)) Bool (=> (or (= temp___is_init_1078 true) (<= 1 17)) (in_range8 temp___expr_1081)))
(define-fun dynamic_invariant7 ((temp___expr_1206 Int) (temp___is_init_1203 Bool) (temp___skip_constant_1204 Bool) (temp___do_toplevel_1205 Bool)) Bool (=> (or (= temp___is_init_1203 true) (<= 0 2)) (in_range12 temp___expr_1206)))
(define-fun dynamic_invariant8 ((temp___expr_1087 Int) (temp___is_init_1084 Bool) (temp___skip_constant_1085 Bool) (temp___do_toplevel_1086 Bool)) Bool (=> (or (= temp___is_init_1084 true) (<= 0 17408)) (in_range9 temp___expr_1087)))
(define-fun dynamic_invariant9 ((temp___expr_1121 Int) (temp___is_init_1118 Bool) (temp___skip_constant_1119 Bool) (temp___do_toplevel_1120 Bool)) Bool (=> (or (= temp___is_init_1118 true) (<= 0 1024)) (in_range11 temp___expr_1121)))
(assert true)
...
(define-fun dynamic_invariant10 ((temp___expr_507 Int) (temp___is_init_504 Bool) (temp___skip_constant_505 Bool) (temp___do_toplevel_506 Bool)) Bool (=> (or (= temp___is_init_504 true) (<= 1901 2099)) (in_range4 temp___expr_507)))
(define-fun dynamic_invariant11 ((temp___expr_513 Int) (temp___is_init_510 Bool) (temp___skip_constant_511 Bool) (temp___do_toplevel_512 Bool)) Bool (=> (or (= temp___is_init_510 true) (<= 1 12)) (in_range5 temp___expr_513)))
(define-fun dynamic_invariant12 ((temp___expr_519 Int) (temp___is_init_516 Bool) (temp___skip_constant_517 Bool) (temp___do_toplevel_518 Bool)) Bool (=> (or (= temp___is_init_516 true) (<= 1 31)) (in_range6 temp___expr_519)))
(define-fun dynamic_invariant13 ((temp___expr_543 Int) (temp___is_init_540 Bool) (temp___skip_constant_541 Bool) (temp___do_toplevel_542 Bool)) Bool (=> (or (= temp___is_init_540 true) (<= 0 86399999)) (in_range7 temp___expr_543)))
(define-fun dynamic_invariant14 ((temp___expr_1469 Int) (temp___is_init_1466 Bool) (temp___skip_constant_1467 Bool) (temp___do_toplevel_1468 Bool)) Bool (=> (or (= temp___is_init_1466 true) (<= 0 2147483647)) (in_range14 temp___expr_1469)))
