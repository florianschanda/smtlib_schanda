...
(define-fun dynamic_invariant ((temp___expr_545 Int) (temp___is_init_541 Bool) (temp___skip_constant_542 Bool) (temp___do_toplevel_543 Bool) (temp___do_typ_inv_544 Bool)) Bool (=> (or (= temp___is_init_541 true) (<= 0 1)) (in_range3 temp___expr_545)))
...
(define-fun dynamic_invariant1 ((temp___expr_1342 us_rep3) (temp___is_init_1338 Bool) (temp___skip_constant_1339 Bool) (temp___do_toplevel_1340 Bool) (temp___do_typ_inv_1341 Bool)) Bool (=> (= temp___do_typ_inv_1341 true) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1342))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1342))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1342)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1342))) true)))
(define-fun default_initial_assumption ((temp___expr_1346 us_rep3) (temp___skip_top_level_1347 Bool)) Bool (and (and (and (= (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1346))) 1) (= (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1346))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1346)) (mk___rep2 (mk___split_fields2 (temp___1348 1) (of_rep6 1) (of_rep6 1) (of_rep8 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1346)) (temp___1352 0))))
(define-fun type_invariant ((temp___1356 us_rep3)) Bool (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1356))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1356))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1356)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1356))) true))
...
(declare-fun user_eq19 (t t) Bool)
...
(define-fun dynamic_invariant2 ((temp___expr_1521 Int) (temp___is_init_1517 Bool) (temp___skip_constant_1518 Bool) (temp___do_toplevel_1519 Bool) (temp___do_typ_inv_1520 Bool)) Bool (=> (or (= temp___is_init_1517 true) (<= 0 1)) (in_range13 temp___expr_1521)))
...
(define-fun dynamic_invariant3 ((temp___expr_493 Int) (temp___is_init_489 Bool) (temp___skip_constant_490 Bool) (temp___do_toplevel_491 Bool) (temp___do_typ_inv_492 Bool)) Bool (=> (or (= temp___is_init_489 true) (<= 0 4)) (in_range2 temp___expr_493)))
(define-fun dynamic_invariant4 ((temp___expr_423 Int) (temp___is_init_419 Bool) (temp___skip_constant_420 Bool) (temp___do_toplevel_421 Bool) (temp___do_typ_inv_422 Bool)) Bool (=> (or (= temp___is_init_419 true) (<= 0 3)) (in_range1 temp___expr_423)))
(define-fun dynamic_invariant5 ((temp___expr_1280 Int) (temp___is_init_1276 Bool) (temp___skip_constant_1277 Bool) (temp___do_toplevel_1278 Bool) (temp___do_typ_inv_1279 Bool)) Bool (=> (or (= temp___is_init_1276 true) (<= 0 17)) (in_range10 temp___expr_1280)))
(define-fun dynamic_invariant6 ((temp___expr_1287 Int) (temp___is_init_1283 Bool) (temp___skip_constant_1284 Bool) (temp___do_toplevel_1285 Bool) (temp___do_typ_inv_1286 Bool)) Bool (=> (or (= temp___is_init_1283 true) (<= 1 17)) (in_range8 temp___expr_1287)))
(define-fun dynamic_invariant7 ((temp___expr_1413 Int) (temp___is_init_1409 Bool) (temp___skip_constant_1410 Bool) (temp___do_toplevel_1411 Bool) (temp___do_typ_inv_1412 Bool)) Bool (=> (or (= temp___is_init_1409 true) (<= 0 2)) (in_range12 temp___expr_1413)))
(define-fun dynamic_invariant8 ((temp___expr_1294 Int) (temp___is_init_1290 Bool) (temp___skip_constant_1291 Bool) (temp___do_toplevel_1292 Bool) (temp___do_typ_inv_1293 Bool)) Bool (=> (or (= temp___is_init_1290 true) (<= 0 17408)) (in_range9 temp___expr_1294)))
(define-fun dynamic_invariant9 ((temp___expr_1325 Int) (temp___is_init_1321 Bool) (temp___skip_constant_1322 Bool) (temp___do_toplevel_1323 Bool) (temp___do_typ_inv_1324 Bool)) Bool (=> (or (= temp___is_init_1321 true) (<= 0 1024)) (in_range11 temp___expr_1325)))
(assert true)
...
(assert (forall ((temp___1354 Int)) (=> (dynamic_invariant9 temp___1354 true true true true) (forall ((temp___1355 Int)) (= (to_rep9 (select (temp___1352 temp___1354) temp___1355)) temp___1354)))))
(define-fun dynamic_invariant10 ((temp___expr_622 Int) (temp___is_init_618 Bool) (temp___skip_constant_619 Bool) (temp___do_toplevel_620 Bool) (temp___do_typ_inv_621 Bool)) Bool (=> (or (= temp___is_init_618 true) (<= 1901 2099)) (in_range4 temp___expr_622)))
(define-fun dynamic_invariant11 ((temp___expr_629 Int) (temp___is_init_625 Bool) (temp___skip_constant_626 Bool) (temp___do_toplevel_627 Bool) (temp___do_typ_inv_628 Bool)) Bool (=> (or (= temp___is_init_625 true) (<= 1 12)) (in_range5 temp___expr_629)))
(define-fun dynamic_invariant12 ((temp___expr_636 Int) (temp___is_init_632 Bool) (temp___skip_constant_633 Bool) (temp___do_toplevel_634 Bool) (temp___do_typ_inv_635 Bool)) Bool (=> (or (= temp___is_init_632 true) (<= 1 31)) (in_range6 temp___expr_636)))
(define-fun dynamic_invariant13 ((temp___expr_668 Int) (temp___is_init_664 Bool) (temp___skip_constant_665 Bool) (temp___do_toplevel_666 Bool) (temp___do_typ_inv_667 Bool)) Bool (=> (or (= temp___is_init_664 true) (<= 0 86399999)) (in_range7 temp___expr_668)))
(define-fun dynamic_invariant14 ((temp___expr_1700 Int) (temp___is_init_1696 Bool) (temp___skip_constant_1697 Bool) (temp___do_toplevel_1698 Bool) (temp___do_typ_inv_1699 Bool)) Bool (=> (or (= temp___is_init_1696 true) (<= 0 2147483647)) (in_range14 temp___expr_1700)))
(assert (forall ((temp___1350 Int)) (=> (dynamic_invariant6 temp___1350 true true true true) (forall ((temp___1351 Int)) (= (to_rep6 (select (temp___1348 temp___1350) temp___1351)) temp___1350)))))
...
(assert (in_range13 currentlatch))
...
(assert (= logfilestate__split_fields10 (mk___split_fields__ref3 logfilestate__split_fields9)))
