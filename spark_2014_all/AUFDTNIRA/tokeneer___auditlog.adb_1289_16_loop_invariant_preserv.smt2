...
(assert (and (= o11 (+ archivedfilecount3 1)) (in_range9 (+ archivedfilecount3 1))))
(assert (= result12 (mk_int__ref archivedfilecount3)))
(assert (= archivedfilecount4 o11))
(assert (and (= o12 (nextlistindex fileindexinusedlist3)) (and (in_range6 o12) (= o12 (ite (= fileindexinusedlist3 17) 1 (+ fileindexinusedlist3 1))))))
(assert (= result13 (mk_int__ref fileindexinusedlist3)))
(assert (= fileindexinusedlist4 o12))
(assert (< archivedfilecount4 4))
(assert (< archivedfilecount4 (to_rep4 logfilestate__split_fields5)))
