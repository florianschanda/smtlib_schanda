...
(assert (=> (= result32 true) (and (= o70 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o70 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result32 true) (= o71 (ite (not (= o70 true)) true false))))
(assert (=> (= result32 true) (and (= result33 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= result33 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result32 true) (=> (= result33 true) (and (= o69 (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (in_range4 o69)))))
(assert (=> (= result32 true) (=> (= result33 true) (= o72 (ite (= o69 3) true false)))))
(assert (=> (= result32 true) (=> (not (= result33 true)) (= o72 false))))
(assert (=> (= result32 true) (= o73 (ite (= o72 false) o71 true))))
(assert (=> (not (= result32 true)) (= o73 (of_int 1))))
(assert (and (= result34 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= result34 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5)))))))
