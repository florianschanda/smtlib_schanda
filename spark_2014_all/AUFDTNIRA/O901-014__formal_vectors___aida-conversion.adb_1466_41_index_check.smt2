...
(assert (forall ((temp___1964 Int) (temp___1965 Int) (temp___1966 Int) (temp___1967 Int) (temp___1968 Int)) (let ((temp___1963 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__aggregate_def temp___1964 temp___1965 temp___1966 temp___1967 temp___1968))) (=> (and (and (dynamic_invariant temp___1964 true true true true) (dynamic_invariant temp___1965 true true true true)) (dynamic_invariant temp___1966 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 8) (+ (first1 source) 10) temp___1967 temp___1968) (and (= (first5 temp___1963) temp___1967) (= (last5 temp___1963) temp___1968))) (and (and (= (to_rep1 (select (to_array2 temp___1963) (+ (+ (first1 source) 8) 0))) temp___1964) (= (to_rep1 (select (to_array2 temp___1963) (+ (+ (first1 source) 8) 1))) temp___1965)) (= (to_rep1 (select (to_array2 temp___1963) (+ (+ (first1 source) 8) 2))) temp___1966)))))))
(define-fun dynamic_invariant4 ((temp___expr_614 us_t3) (temp___is_init_610 Bool) (temp___skip_constant_611 Bool) (temp___do_toplevel_612 Bool) (temp___do_typ_inv_613 Bool)) Bool (=> (not (= temp___skip_constant_611 true)) (and (dynamic_property6 (+ (first1 source) 8) (+ (first1 source) 10) (first7 temp___expr_614) (last7 temp___expr_614)) (and (= (first7 temp___expr_614) (+ (first1 source) 8)) (= (last7 temp___expr_614) (+ (first1 source) 10))))))
(declare-sort t6 0)
...
(assert (forall ((temp___1974 Int) (temp___1975 Int) (temp___1976 Int)) (let ((temp___1973 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__aggregate_def temp___1974 temp___1975 temp___1976))) (=> (dynamic_invariant temp___1974 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 8) (+ (first1 source) 10) temp___1975 temp___1976) (and (= (first9 temp___1973) temp___1975) (= (last9 temp___1973) temp___1976))) (forall ((temp___1977 Int)) (= (to_rep1 (select (to_array4 temp___1973) temp___1977)) temp___1974)))))))
...
(declare-const temp___1971 (Array Int integer))
(declare-const temp___19711 t2)
...
(declare-const temp___1979 (Array Int integer))
(declare-const temp___19791 t4)
...
(declare-const temp___1985 Int)
(declare-const temp___1986 Int)
(declare-const temp___1984 Int)
(declare-const temp___1982 (Array Int integer))
(declare-const o Int)
...
(declare-const temp___1987 Int)
(declare-const o9 Int)
(declare-const o10 integer)
(declare-const o11 Int)
(declare-const o12 Int)
(declare-const o13 Int)
(declare-const temp___1988 Int)
...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (<= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 51)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 8))) 54)) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) index7) (<= index7 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___1971 temp___19711) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__aggregate_def 5 9 9 (+ (to_rep1 (first (rt source))) 8) (+ (+ (to_rep1 (first (rt source))) 8) 2))))
(assert (= (ite (<= (to_rep1 (first4 temp___19711)) (to_rep1 (last4 temp___19711))) (+ (- (to_rep1 (last4 temp___19711)) (to_rep1 (first4 temp___19711))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 8)) 1) 0)))
(assert (= (slide1 temp___1971 (to_rep1 (first4 temp___19711)) (+ (to_rep1 (first (rt source))) 8)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__assume))
...
(assert (= (mk___t4 temp___1979 temp___19791) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___19791)) (to_rep1 (last8 temp___19791))) (+ (- (to_rep1 (last8 temp___19791)) (to_rep1 (first8 temp___19791))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 8)) 1) 0)))
(assert (= (slide1 temp___1979 (to_rep1 (first8 temp___19791)) (+ (to_rep1 (first (rt source))) 8)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__assume))
...
(assert (and (= temp___1985 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (= temp___1986 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___1985))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= temp___1984 index1)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= temp___1982 n1)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= o index1)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= o3 index1)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= o7 index1)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= n1 result3)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= n2 o8)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (and (and (forall ((temp___1983 Int)) (=> (and (<= (to_rep1 n__first) temp___1983) (<= temp___1983 (to_rep1 n__last))) (=> (< index2 temp___1983) (= (select n3 temp___1983) (select temp___1982 temp___1983))))) (=> (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 8) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= index2 temp___1986)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= index2 index3)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= n3 n4)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= index4 index2)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= n5 n3)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= index6 index4)))
(assert (=> (and (<= temp___1985 index1) (<= index1 temp___1986)) (= n7 n5)))
(assert (=> (not (and (<= temp___1985 index1) (<= index1 temp___1986))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___1985 index1) (<= index1 temp___1986))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___1985 index1) (<= index1 temp___1986))) (= index6 index1)))
(assert (=> (not (and (<= temp___1985 index1) (<= index1 temp___1986))) (= n7 n1)))
...
(assert (and (= temp___1987 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___1987) (<= temp___1987 (to_rep1 n__last))))
(assert (= o9 temp___1987))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___1988 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1988) (<= temp___1988 (to_rep1 n__last))))
(assert (= o14 temp___1988))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___1989 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (not (<= (to_rep1 n__first) temp___1989)))
(check-sat)
(exit)
