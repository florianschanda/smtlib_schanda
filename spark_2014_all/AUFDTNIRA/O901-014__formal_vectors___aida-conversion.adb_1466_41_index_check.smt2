...
(define-fun tint_arrayD1__ref___11__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___11__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t436b__ref (mk_t436b__ref (t436b__content integer)))))
(define-fun t436b__ref___projection ((a t436b__ref)) integer (t436b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t437b__ref (mk_t437b__ref (t437b__content us_t2)))))
(define-fun t437b__ref___projection ((a t437b__ref)) us_t2 (t437b__content a))
...
(define-fun tnumber_array_typeD1__ref___20__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___20__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t440b__ref (mk_t440b__ref (t440b__content integer)))))
(define-fun t440b__ref___projection ((a t440b__ref)) integer (t440b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t441b__ref (mk_t441b__ref (t441b__content us_t4)))))
(define-fun t441b__ref___projection ((a t441b__ref)) us_t4 (t441b__content a))
...
(declare-datatypes () ((t442b__ref (mk_t442b__ref (t442b__content integer)))))
(define-fun t442b__ref___projection ((a t442b__ref)) integer (t442b__content a))
...
(define-fun tint_arrayB__ref___11__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__aggregate_def (Int Int Int Int Int) us_t2)
(assert (forall ((temp___1862 Int) (temp___1863 Int) (temp___1864 Int) (temp___1865 Int) (temp___1866 Int)) (let ((temp___1861 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__aggregate_def temp___1862 temp___1863 temp___1864 temp___1865 temp___1866))) (and (=> (dynamic_property10 (+ (first1 source) 8) (+ (first1 source) 10) temp___1865 temp___1866) (and (= (first5 temp___1861) temp___1865) (= (last5 temp___1861) temp___1866))) (and (and (= (select (to_array2 temp___1861) (+ (+ (first1 source) 8) 0)) (of_rep1 temp___1862)) (= (select (to_array2 temp___1861) (+ (+ (first1 source) 8) 1)) (of_rep1 temp___1863))) (= (select (to_array2 temp___1861) (+ (+ (first1 source) 8) 2)) (of_rep1 temp___1864)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___20__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___1872 Int) (temp___1873 Int) (temp___1874 Int)) (let ((temp___1871 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__aggregate_def temp___1872 temp___1873 temp___1874))) (and (=> (dynamic_property11 (+ (first1 source) 8) (+ (first1 source) 10) temp___1873 temp___1874) (and (= (first9 temp___1871) temp___1873) (= (last9 temp___1871) temp___1874))) (forall ((temp___1875 Int)) (= (select (to_array4 temp___1871) temp___1875) (of_rep1 temp___1872)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_545 us_t3) (temp___is_init_542 Bool) (temp___skip_constant_543 Bool) (temp___do_toplevel_544 Bool)) Bool (=> (not (= temp___skip_constant_543 true)) (and (dynamic_property6 (+ (first1 source) 8) (+ (first1 source) 10) (first7 temp___expr_545) (last7 temp___expr_545)) (and (= (first7 temp___expr_545) (+ (first1 source) 8)) (= (last7 temp___expr_545) (+ (first1 source) 10))))))
...
(declare-const temp___1888 Int)
(declare-const temp___1889 Int)
(declare-const o Int)
(declare-const o1 character)
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const temp___1890 Int)
...
(declare-const temp___1869 (Array Int integer))
(declare-const temp___18691 t2)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___1877 (Array Int integer))
(declare-const temp___18771 t4)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__assume1 t3)
...
(declare-const temp___1880 (Array Int integer))
...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (<= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 51)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 8))) 54)) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__aggregate_def 5 9 9 (+ (to_rep1 (first (rt source))) 8) (+ (+ (to_rep1 (first (rt source))) 8) 2))))) (+ (to_rep1 (first (rt source))) 8)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__aggregate_def 5 9 9 (+ (to_rep1 (first (rt source))) 8) (+ (+ (to_rep1 (first (rt source))) 8) 2))))) (+ (+ (to_rep1 (first (rt source))) 8) 2)))
(assert (= (mk___t2 temp___1869 temp___18691) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__aggregate_def 5 9 9 (+ (to_rep1 (first (rt source))) 8) (+ (+ (to_rep1 (first (rt source))) 8) 2))))
(assert (= (ite (<= (to_rep1 (first4 temp___18691)) (to_rep1 (last4 temp___18691))) (+ (- (to_rep1 (last4 temp___18691)) (to_rep1 (first4 temp___18691))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 8)) 1) 0)))
(assert (= (slide1 temp___1869 (to_rep1 (first4 temp___18691)) (+ (to_rep1 (first (rt source))) 8)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 8)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 8)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)))
(assert (= (mk___t4 temp___1877 temp___18771) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___18771)) (to_rep1 (last8 temp___18771))) (+ (- (to_rep1 (last8 temp___18771)) (to_rep1 (first8 temp___18771))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 8)) 1) 0)))
(assert (= (slide1 temp___1877 (to_rep1 (first8 temp___18771)) (+ (to_rep1 (first (rt source))) 8)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 8)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= temp___1883 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (= temp___1884 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___1883))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= temp___1882 index2)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= temp___1880 n1)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= o37 index2)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= o38 (select n1 o37))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= o39 (to_rep1 o38))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= o39 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= o40 index2)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= o41 (select (elts source) o40))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= o42 (to_rep o41))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o42))) (ite (= (= o42 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o42 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o42 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o42 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o42 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o42 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o42 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o42 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o42 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o42 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= (to_rep1 o43) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= o44 index2)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= o45 (store n1 o44 o43))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= n1 result4)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= n2 o45)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (and (and (forall ((temp___1881 Int)) (=> (and (<= (to_rep1 n__first) temp___1881) (<= temp___1881 (to_rep1 n__last))) (=> (< index3 temp___1881) (= (select n3 temp___1881) (select temp___1880 temp___1881))))) (=> (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 8) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= index3 temp___1884)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= index3 index5)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= n3 n5)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= index6 index3)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= n6 n3)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= index8 index6)))
(assert (=> (and (<= temp___1883 index2) (<= index2 temp___1884)) (= n8 n6)))
(assert (=> (not (and (<= temp___1883 index2) (<= index2 temp___1884))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___1883 index2) (<= index2 temp___1884))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___1883 index2) (<= index2 temp___1884))) (= index8 index2)))
(assert (=> (not (and (<= temp___1883 index2) (<= index2 temp___1884))) (= n8 n1)))
...
(assert (and (= temp___1885 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___1885) (<= temp___1885 (to_rep1 n__last))))
(assert (= o73 temp___1885))
...
(assert (= target1 o77))
(assert (<= (- 9) target1))
(assert (and (= temp___1886 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1886) (<= temp___1886 (to_rep1 n__last))))
(assert (= o78 temp___1886))
(assert (= o79 (select (map__content1 n7) o78)))
(assert (= o80 (to_rep1 o79)))
(assert (= o81 (* o80 10)))
(assert (and (= o82 o81) (in_range1 o81)))
(assert (= o83 (- target1 o82)))
(assert (and (= o84 o83) (in_range1 o83)))
(assert (= result10 (mk_int__ref target1)))
(assert (= target2 o84))
(assert (<= (- 99) target2))
(assert (and (= temp___1887 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (not (<= (to_rep1 n__first) temp___1887)))
(check-sat)
(exit)
