...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___264 i1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___263 sum1)))
...
(assert (not (and (<= early_pitch1 average3) (<= average3 pitch))))
(assert (<= average3 early_pitch1))
(assert (<= pitch average3))
(assert (not (in_range1 (* (- pitch early_pitch1) 10))))
(check-sat)
(exit)
