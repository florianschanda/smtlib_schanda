...
(assert (and (= temp___1489 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___1489) (<= temp___1489 (to_rep1 n__last))))
(assert (= o86 temp___1489))
(assert (= o87 (select (map__content1 n7) o86)))
(assert (= o88 (to_rep1 o87)))
(assert (= o89 (* o88 10000000)))
