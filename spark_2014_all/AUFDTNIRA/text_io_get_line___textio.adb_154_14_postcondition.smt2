...
(assert (not (= (to_rep (select (map__content result__4) idx)) (to_rep (select (map__content the_file3) (+ (- idx 1) cur_position_at_start))))))
(check-sat)
(exit)
