...
(assert (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))))
(assert (and (and (and (<= 1 (let ((subject i1)) i14)) (<= (let ((subject i1)) i14) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b))))))) (= (bool_eq10 c37b c37b) true)) (= (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))) (+ (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b))))) 3))))
(assert (and (and (= (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16)) (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields15))) (=> (<= 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))) (dynamic_property2 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b))))) (let ((subject i1)) i14)))) (and (<= 1 (let ((subject i1)) i14)) (<= (let ((subject i1)) i14) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))))))
(assert (= (to_rep o74) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))) (let ((subject i1)) i14)))))
(assert (and (= temp___1519 (+ (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))) (let ((subject i1)) i14))) (in_range1 (+ (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))) (let ((subject i1)) i14)))))
(assert (and (<= 1 temp___1519) (<= temp___1519 50)))
(assert (= o75 temp___1519))
...
(assert (= temp___1521 (mk___rep4 o77)))
(assert (= result13 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields16))))
(assert (= (let ((subject result____split_fields)) result____split_fields17) (us_split_fields9 temp___1521)))
(assert (not (= (let ((subject i1)) i14) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b))))))))
