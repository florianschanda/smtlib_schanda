...
(assert (<= (let ((subject i1)) i8) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))))
(assert (and (and (and (<= 1 (let ((subject i1)) i9)) (<= (let ((subject i1)) i9) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b))))))) (= (bool_eq10 c37b c37b) true)) (= (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields13))) (+ (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b))))) 3))))
(assert (and (and (= (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields13)) (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields12))) (=> (<= 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))) (dynamic_property2 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b))))) (let ((subject i1)) i9)))) (and (<= 1 (let ((subject i1)) i9)) (<= (let ((subject i1)) i9) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))))))
(assert (= (to_rep o74) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))) (let ((subject i1)) i9)))))
(assert (and (= temp___1682 (+ (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields13))) (let ((subject i1)) i9))) (in_range1 (+ (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields13))) (let ((subject i1)) i9)))))
(assert (and (<= 1 temp___1682) (<= temp___1682 50)))
(assert (= o75 temp___1682))
(assert (= o76 (store (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields13)) o75 o74)))
(assert (= o77 (mk___split_fields4 o76 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields13)))))
(assert (= temp___1684 (mk___rep4 o77)))
(assert (= result11 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields13))))
(assert (= (let ((subject result____split_fields)) result____split_fields14) (us_split_fields9 temp___1684)))
(assert (not (= (let ((subject i1)) i9) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b))))))))
(assert (= result12 (let ((subject i1)) (mk_int__ref i9))))
(assert (= (let ((subject i1)) i10) (+ (let ((subject i1)) i9) 1)))
(assert (= i11 (let ((subject i1)) (mk_int__ref i10))))
(assert (= result____split_fields15 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields14))))
(assert (= i12 i10))
