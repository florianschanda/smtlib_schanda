...
(assert (and (= result12 (adminopcanstart status (mk___split_fields theadmin__split_fields theadmin__split_fields1) tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= result12 true) (and (and (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= status 3)) (= (ispresent1 tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true)))))
(assert (= result12 true))
(assert (not (= (adminopcanstart status (mk___split_fields theadmin__split_fields theadmin__split_fields1) tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true)))
(check-sat)
(exit)
