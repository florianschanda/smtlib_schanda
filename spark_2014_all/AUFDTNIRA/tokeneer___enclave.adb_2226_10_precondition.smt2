...
(assert (and (= result (adminlogoncanstart status (mk___split_fields theadmin__split_fields theadmin__split_fields1) tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= result true) (and (and (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)) (= status 3)) (= (ispresent1 tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true)))))
(assert (not (= result true)))
(assert (and (= result1 (adminopcanstart status (mk___split_fields theadmin__split_fields theadmin__split_fields1) tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= result1 true) (and (and (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= status 3)) (= (ispresent1 tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true)))))
(assert (= result1 true))
(assert (not (= (adminopcanstart status (mk___split_fields theadmin__split_fields theadmin__split_fields1) tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true)))
(check-sat)
(exit)
