...
(assert (and (<= 1 (+ mid_index2 1)) (<= (+ mid_index2 1) 10)))
(assert (= o (+ mid_index2 1)))
(assert (= o1 (select items o)))
(assert (= o2 (to_rep o1)))
(assert (= result7 (ite (< search_item o2) true false)))
(assert (not (= result7 true)))
(assert (not (in_range4 (+ mid_index2 1))))
(check-sat)
(exit)
