...
(define-fun dynamic_invariant ((temp___expr_464 Int) (temp___is_init_461 Bool) (temp___skip_constant_462 Bool) (temp___do_toplevel_463 Bool)) Bool (=> (or (= temp___is_init_461 true) (<= 0 1)) (in_range3 temp___expr_464)))
...
(declare-fun temp___1044 (Int) (Array Int logfileindext))
(assert (forall ((temp___1046 Int)) (forall ((temp___1047 Int)) (= (select (temp___1044 temp___1046) temp___1047) (of_rep6 temp___1046)))))
(declare-fun temp___1048 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1050 Int)) (forall ((temp___1051 Int)) (= (select (temp___1048 temp___1050) temp___1051) (of_rep9 temp___1050)))))
(define-fun dynamic_invariant1 ((temp___expr_1038 us_rep2) (temp___is_init_1035 Bool) (temp___skip_constant_1036 Bool) (temp___do_toplevel_1037 Bool)) Bool (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1038))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1038))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1038)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1038))) true))
(define-fun default_initial_assumption ((temp___expr_1042 us_rep2) (temp___skip_top_level_1043 Bool)) Bool (and (and (and (= (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1042))) 1) (= (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1042))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1042)) (mk___rep1 (mk___split_fields1 (temp___1044 1) (of_rep6 1) (of_rep6 1) (of_rep8 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1042)) (temp___1048 0))))
(define-fun type_invariant ((temp___1052 us_rep2)) Bool (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1052))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1052))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1052)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1052))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_2310 Int) (temp___is_init_2307 Bool) (temp___skip_constant_2308 Bool) (temp___do_toplevel_2309 Bool)) Bool (=> (or (= temp___is_init_2307 true) (<= 0 7)) (in_range17 temp___expr_2310)))
...
(define-fun dynamic_invariant7 ((temp___expr_1004 Int) (temp___is_init_1001 Bool) (temp___skip_constant_1002 Bool) (temp___do_toplevel_1003 Bool)) Bool (=> (or (= temp___is_init_1001 true) (<= 0 17)) (in_range11 temp___expr_1004)))
(define-fun dynamic_invariant8 ((temp___expr_983 Int) (temp___is_init_980 Bool) (temp___skip_constant_981 Bool) (temp___do_toplevel_982 Bool)) Bool (=> (or (= temp___is_init_980 true) (<= 1 17)) (in_range9 temp___expr_983)))
(define-fun dynamic_invariant9 ((temp___expr_1108 Int) (temp___is_init_1105 Bool) (temp___skip_constant_1106 Bool) (temp___do_toplevel_1107 Bool)) Bool (=> (or (= temp___is_init_1105 true) (<= 0 2)) (in_range13 temp___expr_1108)))
(define-fun dynamic_invariant10 ((temp___expr_989 Int) (temp___is_init_986 Bool) (temp___skip_constant_987 Bool) (temp___do_toplevel_988 Bool)) Bool (=> (or (= temp___is_init_986 true) (<= 0 17408)) (in_range10 temp___expr_989)))
(define-fun dynamic_invariant11 ((temp___expr_1023 Int) (temp___is_init_1020 Bool) (temp___skip_constant_1021 Bool) (temp___do_toplevel_1022 Bool)) Bool (=> (or (= temp___is_init_1020 true) (<= 0 1024)) (in_range12 temp___expr_1023)))
(assert true)
...
(define-fun dynamic_invariant12 ((temp___expr_486 Int) (temp___is_init_483 Bool) (temp___skip_constant_484 Bool) (temp___do_toplevel_485 Bool)) Bool (=> (or (= temp___is_init_483 true) (<= 1 150)) (in_range4 temp___expr_486)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant13 ((temp___expr_528 Int) (temp___is_init_525 Bool) (temp___skip_constant_526 Bool) (temp___do_toplevel_527 Bool)) Bool (=> (or (= temp___is_init_525 true) (<= 1901 2099)) (in_range5 temp___expr_528)))
(define-fun dynamic_invariant14 ((temp___expr_534 Int) (temp___is_init_531 Bool) (temp___skip_constant_532 Bool) (temp___do_toplevel_533 Bool)) Bool (=> (or (= temp___is_init_531 true) (<= 1 12)) (in_range6 temp___expr_534)))
(define-fun dynamic_invariant15 ((temp___expr_540 Int) (temp___is_init_537 Bool) (temp___skip_constant_538 Bool) (temp___do_toplevel_539 Bool)) Bool (=> (or (= temp___is_init_537 true) (<= 1 31)) (in_range7 temp___expr_540)))
(define-fun dynamic_invariant16 ((temp___expr_564 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 0 86399999)) (in_range8 temp___expr_564)))
(define-fun dynamic_invariant17 ((temp___expr_320 Int) (temp___is_init_317 Bool) (temp___skip_constant_318 Bool) (temp___do_toplevel_319 Bool)) Bool (=> (or (= temp___is_init_317 true) (<= 0 40)) (in_range14 temp___expr_320)))
(define-fun dynamic_invariant18 ((temp___expr_341 Int) (temp___is_init_338 Bool) (temp___skip_constant_339 Bool) (temp___do_toplevel_340 Bool)) Bool (=> (or (= temp___is_init_338 true) (<= 0 4294967295)) (in_range15 temp___expr_341)))
(define-fun dynamic_invariant19 ((temp___expr_1551 Int) (temp___is_init_1548 Bool) (temp___skip_constant_1549 Bool) (temp___do_toplevel_1550 Bool)) Bool (=> (or (= temp___is_init_1548 true) (<= 0 2147483647)) (in_range16 temp___expr_1551)))
