...
(define-fun dynamic_invariant2 ((temp___expr_2366 Int) (temp___is_init_2363 Bool) (temp___skip_constant_2364 Bool) (temp___do_toplevel_2365 Bool)) Bool (=> (or (= temp___is_init_2363 true) (<= 0 7)) (in_range17 temp___expr_2366)))
...
(define-fun dynamic_invariant7 ((temp___expr_1060 Int) (temp___is_init_1057 Bool) (temp___skip_constant_1058 Bool) (temp___do_toplevel_1059 Bool)) Bool (=> (or (= temp___is_init_1057 true) (<= 0 17)) (in_range11 temp___expr_1060)))
(define-fun dynamic_invariant8 ((temp___expr_1039 Int) (temp___is_init_1036 Bool) (temp___skip_constant_1037 Bool) (temp___do_toplevel_1038 Bool)) Bool (=> (or (= temp___is_init_1036 true) (<= 1 17)) (in_range9 temp___expr_1039)))
(define-fun dynamic_invariant9 ((temp___expr_1164 Int) (temp___is_init_1161 Bool) (temp___skip_constant_1162 Bool) (temp___do_toplevel_1163 Bool)) Bool (=> (or (= temp___is_init_1161 true) (<= 0 2)) (in_range13 temp___expr_1164)))
(define-fun dynamic_invariant10 ((temp___expr_1045 Int) (temp___is_init_1042 Bool) (temp___skip_constant_1043 Bool) (temp___do_toplevel_1044 Bool)) Bool (=> (or (= temp___is_init_1042 true) (<= 0 17408)) (in_range10 temp___expr_1045)))
(define-fun dynamic_invariant11 ((temp___expr_1079 Int) (temp___is_init_1076 Bool) (temp___skip_constant_1077 Bool) (temp___do_toplevel_1078 Bool)) Bool (=> (or (= temp___is_init_1076 true) (<= 0 1024)) (in_range12 temp___expr_1079)))
(assert true)
...
(define-fun dynamic_invariant12 ((temp___expr_526 Int) (temp___is_init_523 Bool) (temp___skip_constant_524 Bool) (temp___do_toplevel_525 Bool)) Bool (=> (or (= temp___is_init_523 true) (<= 1 150)) (in_range4 temp___expr_526)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant13 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1901 2099)) (in_range5 temp___expr_572)))
(define-fun dynamic_invariant14 ((temp___expr_578 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 1 12)) (in_range6 temp___expr_578)))
(define-fun dynamic_invariant15 ((temp___expr_584 Int) (temp___is_init_581 Bool) (temp___skip_constant_582 Bool) (temp___do_toplevel_583 Bool)) Bool (=> (or (= temp___is_init_581 true) (<= 1 31)) (in_range7 temp___expr_584)))
(define-fun dynamic_invariant16 ((temp___expr_612 Int) (temp___is_init_609 Bool) (temp___skip_constant_610 Bool) (temp___do_toplevel_611 Bool)) Bool (=> (or (= temp___is_init_609 true) (<= 0 86399999)) (in_range8 temp___expr_612)))
(define-fun dynamic_invariant17 ((temp___expr_360 Int) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool)) Bool (=> (or (= temp___is_init_357 true) (<= 0 40)) (in_range14 temp___expr_360)))
(define-fun dynamic_invariant18 ((temp___expr_381 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= 0 4294967295)) (in_range15 temp___expr_381)))
(define-fun dynamic_invariant19 ((temp___expr_1607 Int) (temp___is_init_1604 Bool) (temp___skip_constant_1605 Bool) (temp___do_toplevel_1606 Bool)) Bool (=> (or (= temp___is_init_1604 true) (<= 0 2147483647)) (in_range16 temp___expr_1607)))
