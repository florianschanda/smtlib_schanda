...
(assert (or (= (= (islocked1 currentlatch) true) (= (islocked Tuple0) true)) (= (bool__content systemfault) true)))
(assert (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields7))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content1 logfilestate__split_fields7))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields7)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields7))) true) (in_range4 (int__content auditalarm1))))
(assert (not (or (= (= (islocked1 currentlatch) true) (= (latchislocked Tuple0) true)) (= (bool__content systemfault) true))))
(check-sat)
(exit)
