...
(assert (and (= (length source) 7) (forall ((index13 Int)) (=> (and (<= (to_rep1 (first (rt source))) index13) (<= index13 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index13))) true)))))
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_length_7__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_length_7__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6))))) (+ (to_rep1 (first (rt source))) 6)) (= (mk___t2 temp___1626 temp___16261) (aida__conversion__calculate_positive_target_length_7__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6))))) (and (= (ite (<= (to_rep1 (first4 temp___16261)) (to_rep1 (last4 temp___16261))) (+ (- (to_rep1 (last4 temp___16261)) (to_rep1 (first4 temp___16261))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6)) (+ (- (+ (to_rep1 (first (rt source))) 6) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1626 (to_rep1 (first4 temp___16261)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_length_7__n__assume) (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6)) aida__conversion__calculate_positive_target_length_7__n__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_positive_target_length_7__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_length_7__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_length_7__n__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 6)))) (and (and (and (= temp___1633 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))) (and (and (= (mk_int__ref result1) (mk_int__ref index)) (= index2 (to_rep1 (first (rt source))))) (ite (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1633)) (and (and (and (= temp___1631 index2) (and (= temp___1629 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o index2)) (= o1 (select n1 o))) (= o2 (to_rep1 o1))) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o3 index2)) (= o4 (select (elts source) o3))) (= o5 (to_rep o4))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o7 index2)) (= o8 (store n1 o7 o6)))) (and (= n1 result2) (= n2 o8))))) (and (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (= (to_rep1 (select n3 j1)) (convert_character_digit_to_integer (to_rep (select (elts source) j1)))))) (and (and (and (forall ((temp___1630 Int)) (=> (and (<= (to_rep1 n__first) temp___1630) (<= temp___1630 (to_rep1 n__last))) (=> (< index3 temp___1630) (= (select n3 temp___1630) (select temp___1629 temp___1630))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 6)))) (= index3 temp___1633)))))) (and (and (= index3 index7) (= n3 n7)) (and (= index8 index3) (= n8 n3)))) (and (and (= (mk_int__ref index9) (mk_int__ref index7)) (= (mk_map__ref1 n9) (mk_map__ref1 n7))) (and (= index10 index8) (= n10 n8)))) (and (and (= index2 index9) (= n1 n9)) (and (= index10 index2) (= n10 n1)))))) (and (and (and (and (and (and (= temp___1634 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))) (and (and (<= (to_rep1 n__first) temp___1634) (<= temp___1634 (to_rep1 n__last))) (= o22 temp___1634))) (= o23 (select n9 o22))) (= o24 (to_rep1 o23))) (and (= (mk_int__ref result5) (mk_int__ref target)) (= target1 o24))) (and (<= target1 9) (and (and (and (and (and (and (and (and (and (and (= temp___1635 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (<= (to_rep1 n__first) temp___1635) (<= temp___1635 (to_rep1 n__last))) (= o25 temp___1635))) (= o26 (select n9 o25))) (= o27 (to_rep1 o26))) (= o28 (* o27 10))) (and (= o29 o28) (in_range1 o28))) (= o30 (+ target1 o29))) (and (= o31 o30) (in_range1 o30))) (and (= target1 result6) (= target2 o31))) (and (<= target2 99) (and (and (and (and (and (and (and (and (and (and (= temp___1636 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (<= (to_rep1 n__first) temp___1636) (<= temp___1636 (to_rep1 n__last))) (= o32 temp___1636))) (= o33 (select n9 o32))) (= o34 (to_rep1 o33))) (= o35 (* o34 100))) (and (= o36 o35) (in_range1 o35))) (= o37 (+ target2 o36))) (and (= o38 o37) (in_range1 o37))) (and (= result7 (mk_int__ref target2)) (= target3 o38))) (and (<= target3 999) (and (and (and (and (and (and (and (and (and (and (= temp___1637 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))) (and (and (<= (to_rep1 n__first) temp___1637) (<= temp___1637 (to_rep1 n__last))) (= o39 temp___1637))) (= o40 (select n9 o39))) (= o41 (to_rep1 o40))) (= o42 (* o41 1000))) (and (= o43 o42) (in_range1 o42))) (= o44 (+ target3 o43))) (and (= o45 o44) (in_range1 o44))) (and (= result8 (mk_int__ref target3)) (= target4 o45))) (and (<= target4 9999) (and (and (and (and (and (and (and (and (and (and (= temp___1638 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (<= (to_rep1 n__first) temp___1638) (<= temp___1638 (to_rep1 n__last))) (= o46 temp___1638))) (= o47 (select n9 o46))) (= o48 (to_rep1 o47))) (= o49 (* o48 10000))) (and (= o50 o49) (in_range1 o49))) (= o51 (+ target4 o50))) (and (= o52 o51) (in_range1 o51))) (and (= result9 (mk_int__ref target4)) (= target5 o52))) (and (<= target5 99999) (and (and (and (and (and (and (and (and (and (and (= temp___1639 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (<= (to_rep1 n__first) temp___1639) (<= temp___1639 (to_rep1 n__last))) (= o53 temp___1639))) (= o54 (select n9 o53))) (= o55 (to_rep1 o54))) (= o56 (* o55 100000))) (and (= o57 o56) (in_range1 o56))) (= o58 (+ target5 o57))) (and (= o59 o58) (in_range1 o58))) (and (= result10 (mk_int__ref target5)) (= target6 o59))) (and (<= target6 999999) (and (and (and (and (and (and (and (and (and (and (= temp___1640 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))) (and (and (<= (to_rep1 n__first) temp___1640) (<= temp___1640 (to_rep1 n__last))) (= o60 temp___1640))) (= o61 (select n9 o60))) (= o62 (to_rep1 o61))) (= o63 (* o62 1000000))) (and (= o64 o63) (in_range1 o63))) (= o65 (+ target6 o64))) (and (= o66 o65) (in_range1 o65))) (and (= result11 (mk_int__ref target6)) (= target7 o66))) (and (<= target7 9999999) (and (= result12 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0)))))))))))))))))))) (and (and (= index11 (mk_int__ref index9)) (and (= n11 (mk_map__ref1 n9)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target8 (mk_int__ref target7))))) (and (= index12 index10) (and (= n12 n10) (and (= has_failed3 has_failed1) (= target9 target7)))))))
(assert (and (= temp___1647 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1647) (<= temp___1647 (to_rep1 (last (rt source))))))
(assert (= o112 temp___1647))
(assert (= o113 (select (elts source) o112)))
(assert (= o114 (to_rep o113)))
(assert (and (= o115 (convert_character_digit_to_integer o114)) (and (in_range1 o115) (and (and (<= 0 o115) (<= o115 9)) (ite (= (= o114 48) true) (= o115 0) (ite (= (= o114 49) true) (= o115 1) (ite (= (= o114 50) true) (= o115 2) (ite (= (= o114 51) true) (= o115 3) (ite (= (= o114 52) true) (= o115 4) (ite (= (= o114 53) true) (= o115 5) (ite (= (= o114 54) true) (= o115 6) (ite (= (= o114 55) true) (= o115 7) (ite (= (= o114 56) true) (= o115 8) (=> (= (= o114 57) true) (= o115 9)))))))))))))))
(assert (= o116 (* o115 1)))
(assert (and (= o117 o116) (in_range1 o116)))
(assert (and (= temp___1646 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1646) (<= temp___1646 (to_rep1 (last (rt source))))))
(assert (= o104 temp___1646))
...
(assert (and (= temp___1645 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1645) (<= temp___1645 (to_rep1 (last (rt source))))))
(assert (= o96 temp___1645))
...
(assert (and (= temp___1644 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1644) (<= temp___1644 (to_rep1 (last (rt source))))))
(assert (= o88 temp___1644))
(assert (= o89 (select (elts source) o88)))
(assert (= o90 (to_rep o89)))
(assert (and (= o91 (convert_character_digit_to_integer o90)) (and (in_range1 o91) (and (and (<= 0 o91) (<= o91 9)) (ite (= (= o90 48) true) (= o91 0) (ite (= (= o90 49) true) (= o91 1) (ite (= (= o90 50) true) (= o91 2) (ite (= (= o90 51) true) (= o91 3) (ite (= (= o90 52) true) (= o91 4) (ite (= (= o90 53) true) (= o91 5) (ite (= (= o90 54) true) (= o91 6) (ite (= (= o90 55) true) (= o91 7) (ite (= (= o90 56) true) (= o91 8) (=> (= (= o90 57) true) (= o91 9)))))))))))))))
(assert (= o92 (* o91 1000)))
