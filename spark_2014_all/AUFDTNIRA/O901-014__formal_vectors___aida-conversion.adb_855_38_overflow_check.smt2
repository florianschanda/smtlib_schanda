...
(define-fun dynamic_invariant4 ((temp___expr_434 us_t1) (temp___is_init_430 Bool) (temp___skip_constant_431 Bool) (temp___do_toplevel_432 Bool) (temp___do_typ_inv_433 Bool)) Bool (=> (not (= temp___skip_constant_431 true)) (and (dynamic_property2 (first1 source) (+ (first1 source) 6) (first3 temp___expr_434) (last3 temp___expr_434)) (and (= (first3 temp___expr_434) (first1 source)) (= (last3 temp___expr_434) (+ (first1 source) 6))))))
(declare-sort t3 0)
...
(assert (forall ((temp___1723 Int) (temp___1724 Int) (temp___1725 Int)) (let ((temp___1722 (aida__conversion__calculate_positive_target_length_7__n__aggregate_def temp___1723 temp___1724 temp___1725))) (=> (dynamic_invariant temp___1723 true true true true) (and (=> (dynamic_property6 (first1 source) (+ (first1 source) 6) temp___1724 temp___1725) (and (= (first5 temp___1722) temp___1724) (= (last5 temp___1722) temp___1725))) (forall ((temp___1726 Int)) (= (select (to_array2 temp___1722) temp___1726) rliteral)))))))
(declare-const target Int)
(declare-const has_failed Bool)
(declare-const n (Array Int integer))
(declare-const index Int)
(declare-const temp___1728 (Array Int integer))
(declare-const temp___17281 t2)
...
(declare-const temp___1733 (Array Int integer))
(declare-const o Int)
...
(assert (and (= (length source) 7) (forall ((index10 Int)) (=> (and (<= (to_rep1 (first (rt source))) index10) (<= index10 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index10))) true)))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_length_7__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_length_7__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6))))) (+ (to_rep1 (first (rt source))) 6)))
(assert (= (mk___t2 temp___1728 temp___17281) (aida__conversion__calculate_positive_target_length_7__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6))))
(assert (= (ite (<= (to_rep1 (first4 temp___17281)) (to_rep1 (last4 temp___17281))) (+ (- (to_rep1 (last4 temp___17281)) (to_rep1 (first4 temp___17281))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6)) (+ (- (+ (to_rep1 (first (rt source))) 6) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1728 (to_rep1 (first4 temp___17281)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_length_7__n__assume))
(assert (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6)) aida__conversion__calculate_positive_target_length_7__n__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_positive_target_length_7__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_length_7__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_length_7__n__assume1))))
(assert (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 6)))))
(assert (and (= temp___1731 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (= (mk_int__ref result1) (mk_int__ref index)))
(assert (= index1 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= temp___1735 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= temp___1733 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= o index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= o1 (select n1 o))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= o3 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= o7 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= n1 result2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= n2 o8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (= (to_rep1 (select n3 j)) (convert_character_digit_to_integer (to_rep (select (elts source) j))))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (and (and (forall ((temp___1734 Int)) (=> (and (<= (to_rep1 n__first) temp___1734) (<= temp___1734 (to_rep1 n__last))) (=> (or (< temp___1731 temp___1734) (or (< temp___1734 (to_rep1 (first (rt source)))) (< index2 temp___1734))) (= (select n3 temp___1734) (select temp___1733 temp___1734))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 6) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 6))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= index2 temp___1731)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= index2 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= n3 n4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= index4 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= n5 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= index9 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= n10 (mk_map__ref1 n4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= index6 index4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731)) (= n7 n5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731))) (= index1 index5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731))) (= n1 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1731))) (= n7 n1)))
(assert (and (= temp___1736 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___1736) (<= temp___1736 (to_rep1 n__last))))
(assert (= o9 temp___1736))
(assert (= o10 (select n6 o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= (mk_int__ref result3) (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 9))
(assert (and (= temp___1737 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___1737) (<= temp___1737 (to_rep1 n__last))))
(assert (= o12 temp___1737))
...
(assert (= target2 o18))
(assert (<= target2 99))
(assert (and (= temp___1738 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___1738) (<= temp___1738 (to_rep1 n__last))))
(assert (= o19 temp___1738))
...
(assert (= target3 o25))
(assert (<= target3 999))
(assert (and (= temp___1739 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___1739) (<= temp___1739 (to_rep1 n__last))))
(assert (= o26 temp___1739))
...
(assert (= target4 o32))
(assert (<= target4 9999))
(assert (and (= temp___1740 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___1740) (<= temp___1740 (to_rep1 n__last))))
(assert (= o33 temp___1740))
...
(assert (and (= temp___1741 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___1741) (<= temp___1741 (to_rep1 n__last))))
(assert (= o40 temp___1741))
...
(assert (and (= temp___1742 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 n__first) temp___1742) (<= temp___1742 (to_rep1 n__last))))
(assert (= o47 temp___1742))
...
(assert (and (= temp___1749 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1749) (<= temp___1749 (to_rep1 (last (rt source))))))
(assert (= o72 temp___1749))
(assert (= o73 (select (elts source) o72)))
(assert (= o74 (to_rep o73)))
(assert (and (= o75 (convert_character_digit_to_integer o74)) (and (in_range1 o75) (and (and (<= 0 o75) (<= o75 9)) (ite (= (= o74 48) true) (= o75 0) (ite (= (= o74 49) true) (= o75 1) (ite (= (= o74 50) true) (= o75 2) (ite (= (= o74 51) true) (= o75 3) (ite (= (= o74 52) true) (= o75 4) (ite (= (= o74 53) true) (= o75 5) (ite (= (= o74 54) true) (= o75 6) (ite (= (= o74 55) true) (= o75 7) (ite (= (= o74 56) true) (= o75 8) (=> (= (= o74 57) true) (= o75 9)))))))))))))))
(assert (= o76 (* o75 1)))
(assert (and (= o77 o76) (in_range1 o76)))
(assert (and (= temp___1748 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1748) (<= temp___1748 (to_rep1 (last (rt source))))))
(assert (= o66 temp___1748))
...
(assert (and (= temp___1747 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1747) (<= temp___1747 (to_rep1 (last (rt source))))))
(assert (= o60 temp___1747))
...
(assert (and (= temp___1746 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1746) (<= temp___1746 (to_rep1 (last (rt source))))))
(assert (= o54 temp___1746))
(assert (= o55 (select (elts source) o54)))
(assert (= o56 (to_rep o55)))
(assert (and (= o57 (convert_character_digit_to_integer o56)) (and (in_range1 o57) (and (and (<= 0 o57) (<= o57 9)) (ite (= (= o56 48) true) (= o57 0) (ite (= (= o56 49) true) (= o57 1) (ite (= (= o56 50) true) (= o57 2) (ite (= (= o56 51) true) (= o57 3) (ite (= (= o56 52) true) (= o57 4) (ite (= (= o56 53) true) (= o57 5) (ite (= (= o56 54) true) (= o57 6) (ite (= (= o56 55) true) (= o57 7) (ite (= (= o56 56) true) (= o57 8) (=> (= (= o56 57) true) (= o57 9)))))))))))))))
(assert (= o58 (* o57 1000)))
