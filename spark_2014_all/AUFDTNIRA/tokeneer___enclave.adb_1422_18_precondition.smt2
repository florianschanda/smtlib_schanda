...
(define-fun dynamic_invariant10 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range21 temp___expr_63)))
...
(define-fun dynamic_invariant13 ((temp___expr_206 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 5)) (in_range18 temp___expr_206)))
(define-fun dynamic_invariant14 ((temp___expr_924 Int) (temp___is_init_921 Bool) (temp___skip_constant_922 Bool) (temp___do_toplevel_923 Bool)) Bool (=> (or (= temp___is_init_921 true) (<= 0 40)) (in_range20 temp___expr_924)))
(define-fun dynamic_invariant15 ((temp___expr_945 Int) (temp___is_init_942 Bool) (temp___skip_constant_943 Bool) (temp___do_toplevel_944 Bool)) Bool (=> (or (= temp___is_init_942 true) (<= 0 4294967295)) (in_range22 temp___expr_945)))
(define-fun dynamic_invariant16 ((temp___expr_967 Int) (temp___is_init_964 Bool) (temp___skip_constant_965 Bool) (temp___do_toplevel_966 Bool)) Bool (=> (or (= temp___is_init_964 true) (<= 0 10)) (in_range19 temp___expr_967)))
(define-fun dynamic_invariant17 ((temp___expr_979 Int) (temp___is_init_976 Bool) (temp___skip_constant_977 Bool) (temp___do_toplevel_978 Bool)) Bool (=> (or (= temp___is_init_976 true) (<= 0 4294967295)) (in_range24 temp___expr_979)))
(define-fun dynamic_invariant18 ((temp___expr_985 Int) (temp___is_init_982 Bool) (temp___skip_constant_983 Bool) (temp___do_toplevel_984 Bool)) Bool (=> (or (= temp___is_init_982 true) (<= 0 128)) (in_range25 temp___expr_985)))
(define-fun dynamic_invariant19 ((temp___expr_1105 Int) (temp___is_init_1102 Bool) (temp___skip_constant_1103 Bool) (temp___do_toplevel_1104 Bool)) Bool (=> (or (= temp___is_init_1102 true) (<= 0 17)) (in_range13 temp___expr_1105)))
(define-fun dynamic_invariant20 ((temp___expr_1084 Int) (temp___is_init_1081 Bool) (temp___skip_constant_1082 Bool) (temp___do_toplevel_1083 Bool)) Bool (=> (or (= temp___is_init_1081 true) (<= 1 17)) (in_range11 temp___expr_1084)))
(define-fun dynamic_invariant21 ((temp___expr_1209 Int) (temp___is_init_1206 Bool) (temp___skip_constant_1207 Bool) (temp___do_toplevel_1208 Bool)) Bool (=> (or (= temp___is_init_1206 true) (<= 0 2)) (in_range15 temp___expr_1209)))
(define-fun dynamic_invariant22 ((temp___expr_1090 Int) (temp___is_init_1087 Bool) (temp___skip_constant_1088 Bool) (temp___do_toplevel_1089 Bool)) Bool (=> (or (= temp___is_init_1087 true) (<= 0 17408)) (in_range12 temp___expr_1090)))
(define-fun dynamic_invariant23 ((temp___expr_1124 Int) (temp___is_init_1121 Bool) (temp___skip_constant_1122 Bool) (temp___do_toplevel_1123 Bool)) Bool (=> (or (= temp___is_init_1121 true) (<= 0 1024)) (in_range14 temp___expr_1124)))
(assert true)
...
(define-fun dynamic_invariant24 ((temp___expr_510 Int) (temp___is_init_507 Bool) (temp___skip_constant_508 Bool) (temp___do_toplevel_509 Bool)) Bool (=> (or (= temp___is_init_507 true) (<= 1901 2099)) (in_range7 temp___expr_510)))
(define-fun dynamic_invariant25 ((temp___expr_516 Int) (temp___is_init_513 Bool) (temp___skip_constant_514 Bool) (temp___do_toplevel_515 Bool)) Bool (=> (or (= temp___is_init_513 true) (<= 1 12)) (in_range8 temp___expr_516)))
(define-fun dynamic_invariant26 ((temp___expr_522 Int) (temp___is_init_519 Bool) (temp___skip_constant_520 Bool) (temp___do_toplevel_521 Bool)) Bool (=> (or (= temp___is_init_519 true) (<= 1 31)) (in_range9 temp___expr_522)))
(define-fun dynamic_invariant27 ((temp___expr_546 Int) (temp___is_init_543 Bool) (temp___skip_constant_544 Bool) (temp___do_toplevel_545 Bool)) Bool (=> (or (= temp___is_init_543 true) (<= 0 86399999)) (in_range10 temp___expr_546)))
(assert true)
...
(assert (forall ((latch__currentlatch Int)) (forall ((latch__state us_private)) (forall ((latch__latchtimeout__fields us_split_fields2)) (! (=> (dynamic_invariant7 latch__currentlatch true true true) (dynamic_invariant7 (current_latch latch__currentlatch latch__state latch__latchtimeout__fields) true false true)) :pattern ((current_latch latch__currentlatch latch__state latch__latchtimeout__fields)))))))
(assert (forall ((latch__currentlatch Int)) (forall ((latch__state us_private)) (forall ((latch__latchtimeout__fields us_split_fields2)) (! (=> (dynamic_invariant7 latch__currentlatch true true true) (= (current_latch latch__currentlatch latch__state latch__latchtimeout__fields) latch__currentlatch)) :pattern ((current_latch latch__currentlatch latch__state latch__latchtimeout__fields)))))))
(assert true)
...
(assert (and (= o32 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o32)))
(assert (= result6 (ite (= o32 1) true false)))
(assert (=> (= result6 true) (and (and (and (and (and (and (and (and (or (or (= status1 6) (= status1 7)) (= status1 3)) (= (ispresent (mk___rep theadmin__split_fields2)) true)) (=> (or (= status1 6) (= status1 7)) (and (and (= (isdoingop (mk___rep theadmin__split_fields2)) true) (= (ispresent (mk___rep theadmin__split_fields2)) true)) (= (thecurrentop (mk___rep theadmin__split_fields2)) 1)))) (=> (= status1 3) (not (= (isdoingop (mk___rep theadmin__split_fields2)) true)))) (=> (= (rolepresent (mk___rep theadmin__split_fields2)) 1) (and (and (= (isgood tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true) (= (authcertvalid tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) 1)))) (=> (and (= (isdoingop (mk___rep theadmin__split_fields2)) true) (= (thecurrentop (mk___rep theadmin__split_fields2)) 3)) (= (rolepresent (mk___rep theadmin__split_fields2)) 1))) (=> (= (rolepresent (mk___rep theadmin__split_fields2)) 1) (or (and (= (isdoingop (mk___rep theadmin__split_fields2)) true) (= (thecurrentop (mk___rep theadmin__split_fields2)) 3)) (not (= (isdoingop (mk___rep theadmin__split_fields2)) true))))) (= (rolepresent (mk___rep theadmin__split_fields2)) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))) (and (and (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true) (in_range6 auditalarm1)) (in_range28 status1)))))
(assert (=> (= result6 true) (= (let ((subject state8)) (mk___private__ref state34)) state8)))
(assert (=> (= result6 true) (= (let ((subject state5)) (mk___private__ref state26)) state5)))
(assert (=> (= result6 true) (= (let ((subject state4)) (mk___private__ref state25)) state4)))
(assert (=> (= result6 true) (= (let ((subject state3)) (mk___private__ref state24)) state3)))
(assert (=> (= result6 true) (= (let ((subject state2)) (mk___private__ref state29)) state2)))
(assert (=> (= result6 true) (= (let ((subject filestate)) (mk___private__ref filestate4)) filestate)))
(assert (=> (= result6 true) (= state19 state)))
(assert (=> (= result6 true) (= latchtimeout__split_fields5 (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))))
(assert (=> (= result6 true) (= currentlatch2 currentlatch)))
(assert (=> (= result6 true) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref11 idcert__split_fields2)) idcert__split_fields)))
(assert (=> (= result6 true) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref8 authcert__split_fields2)) authcert__split_fields)))
(assert (=> (= result6 true) (= tokenid2 tokenid)))
(assert (=> (= result6 true) (= tokentry2 tokentry)))
(assert (=> (= result6 true) (= tokenpresence2 tokenpresence)))
(assert (=> (= result6 true) (= state34 state15)))
(assert (=> (= result6 true) (= state26 state13)))
(assert (=> (= result6 true) (= state25 state12)))
(assert (=> (= result6 true) (= state24 state11)))
(assert (=> (= result6 true) (= state29 state10)))
(assert (=> (= result6 true) (= filestate4 filestate2)))
(assert (=> (= result6 true) (= state19 state9)))
(assert (=> (= result6 true) (= latchtimeout__split_fields5 latchtimeout__split_fields4)))
(assert (=> (= result6 true) (= currentlatch2 currentlatch1)))
(assert (=> (= result6 true) (= idcert__split_fields2 idcert__split_fields1)))
(assert (=> (= result6 true) (= authcert__split_fields2 authcert__split_fields1)))
(assert (=> (= result6 true) (= tokenid2 tokenid1)))
(assert (=> (= result6 true) (= tokentry2 tokentry1)))
(assert (=> (= result6 true) (= tokenpresence2 tokenpresence1)))
(assert (=> (not (= result6 true)) (and (= o33 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o33))))
(assert (=> (not (= result6 true)) (= result7 (ite (= o33 2) true false))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (and (and (and (and (and (or (or (= status2 6) (= status2 7)) (= status2 3)) (= (ispresent (mk___rep theadmin__split_fields3)) true)) (=> (or (= status2 6) (= status2 7)) (and (and (= (isdoingop (mk___rep theadmin__split_fields3)) true) (= (ispresent (mk___rep theadmin__split_fields3)) true)) (= (thecurrentop (mk___rep theadmin__split_fields3)) 2)))) (=> (= status2 3) (not (= (isdoingop (mk___rep theadmin__split_fields3)) true)))) (= (rolepresent (mk___rep theadmin__split_fields3)) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))) (and (and (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range6 auditalarm2)) (in_range28 status2))))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= (let ((subject state8)) (mk___private__ref state34)) state8))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= (let ((subject state5)) (mk___private__ref state26)) state5))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= (let ((subject state4)) (mk___private__ref state25)) state4))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= (let ((subject state3)) (mk___private__ref state24)) state3))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= (let ((subject state2)) (mk___private__ref state29)) state2))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= latchtimeout__split_fields5 (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= currentlatch2 currentlatch))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref11 idcert__split_fields2)) idcert__split_fields))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref8 authcert__split_fields2)) authcert__split_fields))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= tokenid2 tokenid))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= tokentry2 tokentry))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= tokenpresence2 tokenpresence))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= state34 state15))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= state26 state13))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= state25 state12))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= state24 state11))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= state29 state10))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= latchtimeout__split_fields5 latchtimeout__split_fields4))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= currentlatch2 currentlatch1))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= idcert__split_fields2 idcert__split_fields1))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= authcert__split_fields2 authcert__split_fields1))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= tokenid2 tokenid1))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= tokentry2 tokentry1))))
(assert (=> (not (= result6 true)) (=> (= result7 true) (= tokenpresence2 tokenpresence1))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (and (= o34 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o34)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= result8 (ite (= o34 3) true false)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (and (and (and (and (and (and (and (and (and (= status3 3) (= (and (and (= (islocked currentlatch2 (let ((subject state3)) state24) latchtimeout__split_fields5) true) (= (thecurrentdoor (let ((subject state4)) state25)) 0)) (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (alarm_timeout (let ((subject state4)) state25))) true)) (= (thedooralarm (let ((subject state4)) state25)) 0))) (= (rolepresent (mk___rep theadmin__split_fields4)) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))) (not (= (isdoingop (mk___rep theadmin__split_fields4)) true))) (=> (= (rolepresent (mk___rep theadmin__split_fields4)) 1) (and (and (= (isgood tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true) (= (authcertvalid tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) 1)))) (=> (and (not (= (islocked currentlatch2 (let ((subject state3)) state24) latchtimeout__split_fields5) true)) (= (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) true)) (and (and (= (isgood tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true) (= (authcertvalid tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) 1)))) (=> (and (= (isdoingop (mk___rep theadmin__split_fields4)) true) (= (thecurrentop (mk___rep theadmin__split_fields4)) 3)) (= (rolepresent (mk___rep theadmin__split_fields4)) 1))) (=> (= (rolepresent (mk___rep theadmin__split_fields4)) 1) (or (and (= (isdoingop (mk___rep theadmin__split_fields4)) true) (= (thecurrentop (mk___rep theadmin__split_fields4)) 3)) (not (= (isdoingop (mk___rep theadmin__split_fields4)) true))))) (=> (and (not (= (islocked currentlatch2 (let ((subject state3)) state24) latchtimeout__split_fields5) true)) (= (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) true)) (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)))) (and (and (and (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range6 auditalarm3)) (in_range28 status3)) (in_range26 currentlatch2)))))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= (let ((subject state8)) (mk___private__ref state34)) state8)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= (let ((subject state2)) (mk___private__ref state29)) state2)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref11 idcert__split_fields2)) idcert__split_fields)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref8 authcert__split_fields2)) authcert__split_fields)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= tokenid2 tokenid)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= tokentry2 tokentry)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= tokenpresence2 tokenpresence)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= state34 state15)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= state29 state10)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= idcert__split_fields2 idcert__split_fields1)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= authcert__split_fields2 authcert__split_fields1)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= tokenid2 tokenid1)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= tokentry2 tokentry1)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (= result8 true) (= tokenpresence2 tokenpresence1)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (and (and (and (and (and (and (and (and (and (or (= status4 8) (= status4 6)) (or (not (= status4 6)) (and (and (and (and (and (= (rolepresent (mk___rep theadmin__split_fields5)) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (ispresent (mk___rep theadmin__split_fields5)) true)) (= (isdoingop (mk___rep theadmin__split_fields5)) true)) (= (current_latch currentlatch3 (let ((subject state3)) state30) latchtimeout__split_fields6) (current_latch currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)))) (= (bool_eq1 (latch_timeout currentlatch3 (let ((subject state3)) state30) latchtimeout__split_fields6) (latch_timeout currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) true)) (= (thecurrentop (mk___rep theadmin__split_fields5)) 4)))) (=> (= status4 8) (and (and (= (rolepresent (mk___rep theadmin__split_fields5)) 0) (= (islocked currentlatch3 (let ((subject state3)) state30) latchtimeout__split_fields6) true)) (not (= (isdoingop (mk___rep theadmin__split_fields5)) true))))) (= (and (= (isdoingop (mk___rep theadmin__split_fields5)) true) (= (thecurrentop (mk___rep theadmin__split_fields5)) 4)) (= status4 6))) (= (and (and (= (islocked currentlatch3 (let ((subject state3)) state30) latchtimeout__split_fields6) true) (= (thecurrentdoor (let ((subject state4)) state31)) 0)) (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (alarm_timeout (let ((subject state4)) state31))) true)) (= (thedooralarm (let ((subject state4)) state31)) 0))) (=> (= (rolepresent (mk___rep theadmin__split_fields5)) 1) (and (and (= (isgood tokenpresence2 (let ((subject state2)) state29) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true) (= (authcertvalid tokenpresence2 (let ((subject state2)) state29) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true)) (= (theauthcertrole tokenpresence2 (let ((subject state2)) state29) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) 1)))) (=> (and (not (= (islocked currentlatch3 (let ((subject state3)) state30) latchtimeout__split_fields6) true)) (= (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) true)) (and (and (= (isgood tokenpresence2 (let ((subject state2)) state29) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true) (= (authcertvalid tokenpresence2 (let ((subject state2)) state29) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true)) (= (theauthcertrole tokenpresence2 (let ((subject state2)) state29) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) 1)))) (=> (and (= (isdoingop (mk___rep theadmin__split_fields5)) true) (= (thecurrentop (mk___rep theadmin__split_fields5)) 3)) (= (rolepresent (mk___rep theadmin__split_fields5)) 1))) (=> (= (rolepresent (mk___rep theadmin__split_fields5)) 1) (or (and (= (isdoingop (mk___rep theadmin__split_fields5)) true) (= (thecurrentop (mk___rep theadmin__split_fields5)) 3)) (not (= (isdoingop (mk___rep theadmin__split_fields5)) true))))) (and (and (and (and (and (and (in_range1 tokenpresence2) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true)) (in_range6 auditalarm4)) (in_range17 tokentry2)) (in_range28 status4)) (in_range26 currentlatch3)) (in_range16 tokenid2)))))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= (let ((subject state7)) (mk___private__ref state27)) (let ((subject state7)) (mk___private__ref state33)))))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= (let ((subject state5)) (mk___private__ref state26)) (let ((subject state5)) (mk___private__ref state32)))))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= (let ((subject state4)) (mk___private__ref state25)) (let ((subject state4)) (mk___private__ref state31)))))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= (let ((subject state3)) (mk___private__ref state24)) (let ((subject state3)) (mk___private__ref state30)))))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= (let ((subject state1)) (mk___private__ref state23)) (let ((subject state1)) (mk___private__ref state28)))))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= (let ((subject filestate1)) (mk___private__ref filestate6)) (let ((subject filestate1)) (mk___private__ref filestate7)))))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= theadmin__split_fields4 theadmin__split_fields5)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= status3 status4)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= latchtimeout__split_fields5 latchtimeout__split_fields6)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= currentlatch2 currentlatch3)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= auditsystemfault2 auditsystemfault3)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= auditalarm3 auditalarm4)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= logfilestate__split_fields9 logfilestate__split_fields10)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= logfilesstatus2 logfilesstatus3)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= logfiles2 logfiles3)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= state27 state33)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= state26 state32)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= state25 state31)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= state24 state30)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= state23 state28)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= filestate6 filestate7)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= theadmin__split_fields4 theadmin__split_fields5)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= status3 status4)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= latchtimeout__split_fields5 latchtimeout__split_fields6)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= currentlatch2 currentlatch3)))))
...
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= logfilesstatus2 logfilesstatus3)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (=> (not (= result8 true)) (= logfiles2 logfiles3)))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= (let ((subject state7)) (mk___private__ref state22)) (let ((subject state7)) (mk___private__ref state27))))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= (let ((subject state6)) (mk___private__ref state21)) state6))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= (let ((subject state1)) (mk___private__ref state20)) (let ((subject state1)) (mk___private__ref state23))))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= (let ((subject filestate1)) (mk___private__ref filestate5)) (let ((subject filestate1)) (mk___private__ref filestate6))))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= (let ((subject filestate)) (mk___private__ref filestate4)) filestate))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= state19 state))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= theadmin__split_fields3 theadmin__split_fields4))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= status2 status3))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= auditsystemfault1 auditsystemfault2))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= auditalarm2 auditalarm3))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= logfilestate__split_fields8 logfilestate__split_fields9))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= logfilesstatus1 logfilesstatus2))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= logfiles1 logfiles2))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= state22 state27))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= state21 state14))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= state20 state23))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= filestate5 filestate6))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= filestate4 filestate2))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= state19 state9))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= theadmin__split_fields3 theadmin__split_fields4))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= status2 status3))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= auditsystemfault1 auditsystemfault2))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= auditalarm2 auditalarm3))))
...
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= logfilesstatus1 logfilesstatus2))))
(assert (=> (not (= result6 true)) (=> (not (= result7 true)) (= logfiles1 logfiles2))))
(assert (=> (not (= result6 true)) (= (let ((subject state7)) (mk___private__ref state18)) (let ((subject state7)) (mk___private__ref state22)))))
(assert (=> (not (= result6 true)) (= (let ((subject output)) (mk___private__ref output2)) output)))
(assert (=> (not (= result6 true)) (= (let ((subject writtenstate)) (mk___private__ref writtenstate2)) writtenstate)))
(assert (=> (not (= result6 true)) (= (let ((subject state6)) (mk___private__ref state17)) (let ((subject state6)) (mk___private__ref state21)))))
(assert (=> (not (= result6 true)) (= (let ((subject state1)) (mk___private__ref state16)) (let ((subject state1)) (mk___private__ref state20)))))
(assert (=> (not (= result6 true)) (= (let ((subject filestate1)) (mk___private__ref filestate3)) (let ((subject filestate1)) (mk___private__ref filestate5)))))
(assert (=> (not (= result6 true)) (= theadmin__split_fields2 theadmin__split_fields3)))
(assert (=> (not (= result6 true)) (= status1 status2)))
(assert (=> (not (= result6 true)) (= auditsystemfault auditsystemfault1)))
(assert (=> (not (= result6 true)) (= auditalarm1 auditalarm2)))
(assert (=> (not (= result6 true)) (= logfilestate__split_fields7 logfilestate__split_fields8)))
(assert (=> (not (= result6 true)) (= logfilesstatus logfilesstatus1)))
(assert (=> (not (= result6 true)) (= logfiles logfiles1)))
(assert (=> (not (= result6 true)) (= state18 state22)))
(assert (=> (not (= result6 true)) (= output2 output1)))
(assert (=> (not (= result6 true)) (= writtenstate2 writtenstate1)))
(assert (=> (not (= result6 true)) (= state17 state21)))
(assert (=> (not (= result6 true)) (= state16 state20)))
(assert (=> (not (= result6 true)) (= filestate3 filestate5)))
(assert (=> (not (= result6 true)) (= theadmin__split_fields2 theadmin__split_fields3)))
(assert (=> (not (= result6 true)) (= status1 status2)))
(assert (=> (not (= result6 true)) (= auditsystemfault auditsystemfault1)))
(assert (=> (not (= result6 true)) (= auditalarm1 auditalarm2)))
...
(assert (= filestate8 (let ((subject filestate)) (mk___private__ref filestate4))))
...
(assert (and (= o73 (islocked (int__content currentlatch4) (us_private__content state38) (us_split_fields__content1 latchtimeout__split_fields7))) (= (= o73 true) (= (int__content currentlatch4) 0))))
(assert (= o74 (ite (not (= o73 true)) true false)))
(assert (= result9 (ite (= o74 true) (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (= result9 true))
(assert (and (= result10 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result10 true) (in_range4 (to_rep1 theadmin__split_fields1)))))
