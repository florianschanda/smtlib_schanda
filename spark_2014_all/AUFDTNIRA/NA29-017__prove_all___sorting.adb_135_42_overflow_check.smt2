...
(assert (= (= o1 true) (forall ((j Int)) (=> (and (<= 0 j) (<= j 2147483647)) (=> (< (* j l2) (- length1 i3)) (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ (+ a_first i3) (* j l2)) (ite (< l2 (- (- length1 i3) (* j l2))) l2 (- (- length1 i3) (* j l2)))) true))))))
(assert (= (= o true) (forall ((j Int)) (=> (and (<= 0 j) (<= j 2147483647)) (=> (< (* (* j l2) 2) i3) (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* (* j l2) 2)) (ite (< (* l2 2) (- length1 (* (* j l2) 2))) (* l2 2) (- length1 (* (* j l2) 2)))) true))))))
(assert (< i3 length1))
