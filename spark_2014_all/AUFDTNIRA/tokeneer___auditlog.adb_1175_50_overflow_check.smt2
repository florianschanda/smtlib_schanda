...
(assert (and (= o1 (- (to_rep2 logfilestate__split_fields26) 1)) (in_range10 (- (to_rep2 logfilestate__split_fields26) 1))))
(assert (= o2 (* o1 1024)))
(assert (and (= o3 o2) (in_range9 o2)))
(assert (= o4 (+ o3 (to_rep5 (select logfilestate__split_fields27 (to_rep3 logfilestate__split_fields21))))))
(assert (not (in_range9 o4)))
(check-sat)
(exit)
