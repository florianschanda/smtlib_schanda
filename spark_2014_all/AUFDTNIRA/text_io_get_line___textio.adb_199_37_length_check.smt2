...
(define-fun dynamic_invariant5 ((temp___expr_518 us_t1) (temp___is_init_515 Bool) (temp___skip_constant_516 Bool) (temp___do_toplevel_517 Bool)) Bool (=> (not (= temp___skip_constant_516 true)) (and (dynamic_property2 1 (ite (< 500 (length s)) (length s) 500) (first3 temp___expr_518) (last3 temp___expr_518)) (and (= (first3 temp___expr_518) 1) (= (last3 temp___expr_518) (ite (< 500 (length s)) (length s) 500))))))
...
(assert (forall ((file us_rep)) (forall ((helpers__cur_position Int)) (forall ((helpers__the_file (Array Int character))) (! (=> (dynamic_invariant1 helpers__cur_position true true true) (dynamic_invariant4 (fpeek file helpers__cur_position helpers__the_file) true false true)) :pattern ((fpeek file helpers__cur_position helpers__the_file)))))))
...
(define-fun dynamic_invariant8 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_380)))
(assert (forall ((stream Int) (helpers__cur_position Int)) (forall ((helpers__the_file (Array Int character))) (! (=> (and (dynamic_invariant8 stream true true true) (dynamic_invariant1 helpers__cur_position true true true)) (dynamic_invariant4 (fpeek1 stream helpers__cur_position helpers__the_file) true false true)) :pattern ((fpeek1 stream helpers__cur_position helpers__the_file))))))
...
(declare-const temp___655 (Array Int character))
(declare-const temp___6551 t2)
...
(declare-const temp___649 (Array Int character))
(declare-const temp___6491 t3)
(declare-const o18 (Array Int character))
(declare-const temp___651 (Array Int character))
(declare-const temp___6511 t3)
(declare-const temp___652 (Array Int character))
(declare-const temp___6521 t3)
(declare-const o19 (Array Int character))
(declare-const temp___644 (Array Int character))
(declare-const temp___6441 t4)
(declare-const o20 (Array Int character))
(declare-const temp___646 (Array Int character))
(declare-const temp___6461 t4)
(declare-const temp___647 (Array Int character))
(declare-const temp___6471 t4)
...
(declare-const the_file3 map__ref)
(declare-const cur_position3 int__ref)
(declare-const file__split_fields21 us_split_fields__ref)
(declare-const result__4 map__ref)
(declare-const num3 int__ref)
(declare-const buffer1 map__ref)
(declare-const last12 int__ref)
(declare-const the_file4 (Array Int character))
(declare-const cur_position4 Int)
(declare-const file__split_fields22 us_split_fields)
...
(assert (and (not (= (end_of_file (mk___rep (mk___split_fields file__split_fields file__split_fields1 file__split_fields2 file__split_fields3 file__split_fields4 file__split_fields5 file__split_fields6)) cur_position the_file) true)) (and (= (to_rep1 result____first) 1) (and (= (to_rep1 result____last) 2147483647) (and (= cur_position (+ (- (+ cur_position_at_start (to_rep1 (last (rt s)))) (to_rep1 (first (rt s)))) 1)) (forall ((idx2 Int)) (=> (and (<= (to_rep1 (first (rt s))) idx2) (<= idx2 (to_rep1 (last (rt s))))) (= (to_rep (select (elts s) idx2)) (to_rep (select the_file (+ (- idx2 (to_rep1 (first (rt s)))) cur_position_at_start)))))))))))
...
(assert (and (ite (< (to_rep1 buffer__last) (to_rep1 buffer__first)) (= last11 (- (to_rep1 buffer__first) 1)) (and (and (and (or (= last11 (- (to_rep1 buffer__first) 1)) (and (<= (to_rep1 buffer__first) last11) (<= last11 (to_rep1 buffer__last)))) (forall ((idx2 Int)) (=> (and (<= (to_rep1 buffer__first) idx2) (<= idx2 last11)) (= (to_rep (select buffer idx2)) (to_rep (select the_file (+ (- idx2 (to_rep1 buffer__first)) cur_position))))))) (= cur_position1 (+ (- (+ cur_position last11) (to_rep1 buffer__first)) 1))) (or (or (= last11 (to_rep1 buffer__last)) (= (to_rep (select the_file cur_position1)) eof_ch)) (= (to_rep (select the_file cur_position1)) 10)))) (and (in_range4 last11) (in_range2 cur_position1))))
(assert (= last11 r74b))
...
(assert (= o5 buffer))
(assert (= o5 temp___655))
(assert (= (mk2 1 r74b) temp___6551))
(assert (=> (= (length s) 0) (= temp___655 textio__get_line_function__get_rest__B_1__r__assume)))
(assert (=> (= (length s) 0) (= (mk (to_rep1 (first4 temp___6551)) (to_rep1 (last4 temp___6551))) textio__get_line_function__get_rest__B_1__r__assume1)))
(assert (=> (not (= (length s) 0)) (=> (<= (to_rep1 (first4 temp___6551)) (to_rep1 (last4 temp___6551))) (= o6 (+ (- (to_rep1 (last4 temp___6551)) (to_rep1 (first4 temp___6551))) 1)))))
(assert (=> (not (= (length s) 0)) (=> (not (<= (to_rep1 (first4 temp___6551)) (to_rep1 (last4 temp___6551)))) (= o6 0))))
(assert (=> (not (= (length s) 0)) (=> (<= (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))) (= o7 (+ (- (to_rep1 (last (rt s))) (to_rep1 (first (rt s)))) 1)))))
(assert (=> (not (= (length s) 0)) (=> (not (<= (to_rep1 (first (rt s))) (to_rep1 (last (rt s))))) (= o7 0))))
(assert (=> (not (= (length s) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length s) 0)) (= o9 (+ (to_rep1 (first (rt s))) o8))))
(assert (=> (not (= (length s) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length s) 0)) (and (= o11 o10) (in_range2 o10))))
(assert (=> (not (= (length s) 0)) (= (concat1 (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s))) temp___655 (to_rep1 (first4 temp___6551)) (to_rep1 (last4 temp___6551))) textio__get_line_function__get_rest__B_1__r__assume)))
(assert (=> (not (= (length s) 0)) (= (mk (to_rep1 (first (rt s))) o11) textio__get_line_function__get_rest__B_1__r__assume1)))
...
(assert (and (= o12 (- (to_rep1 (last (rt s))) (to_rep1 (first (rt s))))) (in_range1 (- (to_rep1 (last (rt s))) (to_rep1 (first (rt s)))))))
(assert (= o13 (+ o12 1)))
(assert (and (= o14 o13) (in_range1 o13)))
(assert (= o15 (+ o14 last11)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (and (= o17 o16) (in_range4 o16)))
(assert (= (mk_int__ref result1) (mk_int__ref num)))
(assert (= num1 o17))
(assert (not (< last11 (to_rep1 buffer__last))))
(assert (= last11 (to_rep1 buffer__last)))
(assert (and (= result3 (end_of_file (mk___rep (mk___split_fields file__split_fields7 file__split_fields8 file__split_fields9 file__split_fields10 file__split_fields11 file__split_fields12 file__split_fields13)) cur_position1 the_file)) (= (= result3 true) (= (fpeek (mk___rep (mk___split_fields file__split_fields7 file__split_fields8 file__split_fields9 file__split_fields10 file__split_fields11 file__split_fields12 file__split_fields13)) cur_position1 the_file) eof))))
(assert (= result3 true))
(assert (= num1 r80b))
...
(assert (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___644))
(assert (= (mk4 1 r80b) temp___6441))
...
(assert (= o20 result__))
(assert (= o20 temp___646))
(assert (= (mk4 1 r80b) temp___6461))
(assert (not (= (ite (<= (to_rep1 (first8 temp___6441)) (to_rep1 (last8 temp___6441))) (+ (- (to_rep1 (last8 temp___6441)) (to_rep1 (first8 temp___6441))) 1) 0) (ite (<= (to_rep1 (first8 temp___6461)) (to_rep1 (last8 temp___6461))) (+ (- (to_rep1 (last8 temp___6461)) (to_rep1 (first8 temp___6461))) 1) 0))))
(check-sat)
(exit)
