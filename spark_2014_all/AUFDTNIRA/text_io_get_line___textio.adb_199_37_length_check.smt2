...
(define-fun dynamic_invariant5 ((temp___expr_590 us_t1) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool) (temp___do_typ_inv_589 Bool)) Bool (=> (not (= temp___skip_constant_587 true)) (and (dynamic_property2 1 (ite (< 500 (length s)) (length s) 500) (first3 temp___expr_590) (last3 temp___expr_590)) (and (= (first3 temp___expr_590) 1) (= (last3 temp___expr_590) (ite (< 500 (length s)) (length s) 500))))))
...
(define-fun dynamic_invariant8 ((temp___expr_442 Int) (temp___is_init_438 Bool) (temp___skip_constant_439 Bool) (temp___do_toplevel_440 Bool) (temp___do_typ_inv_441 Bool)) Bool (=> (or (= temp___is_init_438 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_442)))
...
(declare-const temp___727 (Array Int character))
(declare-const temp___7271 t2)
...
(declare-const temp___716 (Array Int character))
(declare-const temp___7161 t4)
(declare-const o13 (Array Int character))
(declare-const temp___718 (Array Int character))
(declare-const temp___7181 t4)
...
(assert (and (ite (< (to_rep1 buffer__last) (to_rep1 buffer__first)) (= last11 (- (to_rep1 buffer__first) 1)) (and (and (and (or (= last11 (- (to_rep1 buffer__first) 1)) (and (<= (to_rep1 buffer__first) last11) (<= last11 (to_rep1 buffer__last)))) (forall ((idx Int)) (=> (and (<= (to_rep1 buffer__first) idx) (<= idx last11)) (= (to_rep (select buffer idx)) (to_rep (select the_file (+ (- idx (to_rep1 buffer__first)) cur_position))))))) (= cur_position1 (+ (- (+ cur_position last11) (to_rep1 buffer__first)) 1))) (or (or (= last11 (to_rep1 buffer__last)) (= (to_rep (select the_file cur_position1)) eof_ch)) (= (to_rep (select the_file cur_position1)) 10)))) (and (in_range4 last11) (in_range2 cur_position1))))
(assert (= last11 r74b))
...
(assert (= o buffer))
(assert (= o temp___727))
(assert (= (mk2 1 r74b) temp___7271))
(assert (=> (= (length s) 0) (= temp___727 textio__get_line_function__get_rest__B_1__r__assume)))
(assert (=> (= (length s) 0) (= (mk (to_rep1 (first4 temp___7271)) (to_rep1 (last4 temp___7271))) textio__get_line_function__get_rest__B_1__r__assume1)))
(assert (=> (not (= (length s) 0)) (=> (<= (to_rep1 (first4 temp___7271)) (to_rep1 (last4 temp___7271))) (= o1 (+ (- (to_rep1 (last4 temp___7271)) (to_rep1 (first4 temp___7271))) 1)))))
(assert (=> (not (= (length s) 0)) (=> (not (<= (to_rep1 (first4 temp___7271)) (to_rep1 (last4 temp___7271)))) (= o1 0))))
...
(assert (=> (not (= (length s) 0)) (= (concat1 (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s))) temp___727 (to_rep1 (first4 temp___7271)) (to_rep1 (last4 temp___7271))) textio__get_line_function__get_rest__B_1__r__assume)))
...
(assert (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___716))
(assert (= (mk4 1 r80b) temp___7161))
...
(assert (= o13 result__))
(assert (= o13 temp___718))
(assert (= (mk4 1 r80b) temp___7181))
(assert (not (= (ite (<= (to_rep1 (first8 temp___7161)) (to_rep1 (last8 temp___7161))) (+ (- (to_rep1 (last8 temp___7161)) (to_rep1 (first8 temp___7161))) 1) 0) (ite (<= (to_rep1 (first8 temp___7181)) (to_rep1 (last8 temp___7181))) (+ (- (to_rep1 (last8 temp___7181)) (to_rep1 (first8 temp___7181))) 1) 0))))
(check-sat)
(exit)
