...
(define-fun dynamic_invariant5 ((temp___expr_524 us_t1) (temp___is_init_521 Bool) (temp___skip_constant_522 Bool) (temp___do_toplevel_523 Bool)) Bool (=> (not (= temp___skip_constant_522 true)) (and (dynamic_property2 1 (ite (< 500 (length s)) (length s) 500) (first3 temp___expr_524) (last3 temp___expr_524)) (and (= (first3 temp___expr_524) 1) (= (last3 temp___expr_524) (ite (< 500 (length s)) (length s) 500))))))
...
(define-fun dynamic_invariant8 ((temp___expr_386 Int) (temp___is_init_383 Bool) (temp___skip_constant_384 Bool) (temp___do_toplevel_385 Bool)) Bool (=> (or (= temp___is_init_383 true) (<= (- 2147483648) 2147483647)) (in_range6 temp___expr_386)))
...
(declare-const temp___661 (Array Int character))
(declare-const temp___6611 t2)
...
(assert (=> (= (length s) 0) (= temp___661 textio__get_line_function__get_rest__B_1__r__assume)))
(assert (=> (= (length s) 0) (= (mk (to_rep1 (first4 temp___6611)) (to_rep1 (last4 temp___6611))) textio__get_line_function__get_rest__B_1__r__assume1)))
(assert (=> (not (= (length s) 0)) (=> (<= (to_rep1 (first4 temp___6611)) (to_rep1 (last4 temp___6611))) (= o1 (+ (- (to_rep1 (last4 temp___6611)) (to_rep1 (first4 temp___6611))) 1)))))
(assert (=> (not (= (length s) 0)) (=> (not (<= (to_rep1 (first4 temp___6611)) (to_rep1 (last4 temp___6611)))) (= o1 0))))
...
(assert (=> (not (= (length s) 0)) (= (concat1 (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s))) temp___661 (to_rep1 (first4 temp___6611)) (to_rep1 (last4 temp___6611))) textio__get_line_function__get_rest__B_1__r__assume)))
...
(assert (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___650))
(assert (= (mk4 1 r80b) temp___6501))
...
(assert (= o13 result__))
(assert (= o13 temp___652))
(assert (= (mk4 1 r80b) temp___6521))
(assert (not (= (ite (<= (to_rep1 (first8 temp___6501)) (to_rep1 (last8 temp___6501))) (+ (- (to_rep1 (last8 temp___6501)) (to_rep1 (first8 temp___6501))) 1) 0) (ite (<= (to_rep1 (first8 temp___6521)) (to_rep1 (last8 temp___6521))) (+ (- (to_rep1 (last8 temp___6521)) (to_rep1 (first8 temp___6521))) 1) 0))))
(check-sat)
(exit)
