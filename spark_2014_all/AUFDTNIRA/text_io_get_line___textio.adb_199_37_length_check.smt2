...
(declare-datatypes () ((tTbufferSP1__ref (mk_tTbufferSP1__ref (tTbufferSP1__content integer)))))
(define-fun tTbufferSP1__ref___projection ((a tTbufferSP1__ref)) integer (tTbufferSP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((tbufferS__ref (mk_tbufferS__ref (tbufferS__content us_t1)))))
(define-fun tbufferS__ref___projection ((a tbufferS__ref)) us_t1 (tbufferS__content a))
(define-fun dynamic_invariant5 ((temp___expr_583 us_t1) (temp___is_init_579 Bool) (temp___skip_constant_580 Bool) (temp___do_toplevel_581 Bool) (temp___do_typ_inv_582 Bool)) Bool (=> (not (= temp___skip_constant_580 true)) (and (dynamic_property2 1 (ite (< 500 (length s)) (length s) 500) (first3 temp___expr_583) (last3 temp___expr_583)) (and (= (first3 temp___expr_583) 1) (= (last3 temp___expr_583) (ite (< 500 (length s)) (length s) 500))))))
...
(define-fun dynamic_invariant7 ((temp___expr_474 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool) (temp___do_typ_inv_473 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 0 2147483647)) (in_range6 temp___expr_474)))
...
(assert (forall ((file us_rep)) (forall ((helpers__cur_position Int)) (forall ((helpers__the_file (Array Int character))) (! (=> (dynamic_invariant1 helpers__cur_position true true true true) (dynamic_invariant4 (fpeek file helpers__cur_position helpers__the_file) true false true true)) :pattern ((fpeek file helpers__cur_position helpers__the_file)))))))
(assert (forall ((file us_rep)) (forall ((helpers__cur_position Int)) (forall ((helpers__the_file (Array Int character))) (! (=> (dynamic_invariant1 helpers__cur_position true true true true) (= (fpeek file helpers__cur_position helpers__the_file) (fpeek1 (to_rep2 (rec__textio__file_type__descr (us_split_fields1 file))) helpers__cur_position helpers__the_file))) :pattern ((fpeek file helpers__cur_position helpers__the_file)))))))
(assert (= eof_ch (mod2 eof 256)))
(define-fun dynamic_invariant8 ((temp___expr_435 Int) (temp___is_init_431 Bool) (temp___skip_constant_432 Bool) (temp___do_toplevel_433 Bool) (temp___do_typ_inv_434 Bool)) Bool (=> (or (= temp___is_init_431 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_435)))
(assert (forall ((stream Int) (helpers__cur_position Int)) (forall ((helpers__the_file (Array Int character))) (! (=> (and (dynamic_invariant8 stream true true true true) (dynamic_invariant1 helpers__cur_position true true true true)) (dynamic_invariant4 (fpeek1 stream helpers__cur_position helpers__the_file) true false true true)) :pattern ((fpeek1 stream helpers__cur_position helpers__the_file))))))
(assert (forall ((stream Int) (helpers__cur_position Int)) (forall ((helpers__the_file (Array Int character))) (! (=> (and (dynamic_invariant8 stream true true true true) (dynamic_invariant1 helpers__cur_position true true true true)) (= (fpeek1 stream helpers__cur_position helpers__the_file) (ite (= (to_rep (select helpers__the_file helpers__cur_position)) eof_ch) eof (to_rep (select helpers__the_file helpers__cur_position))))) :pattern ((fpeek1 stream helpers__cur_position helpers__the_file))))))
...
(declare-const temp___720 (Array Int character))
(declare-const temp___7201 t2)
...
(declare-const textio__get_line_function__get_rest__B_1__r__assume (Array Int character))
(declare-const textio__get_line_function__get_rest__B_1__r__assume1 t)
...
(define-fun file__split_fields14 () us_split_fields (mk___split_fields file__split_fields7 file__split_fields8 file__split_fields9 file__split_fields10 file__split_fields11 file__split_fields12 file__split_fields13))
...
(assert (and (not (= (end_of_file (mk___rep (mk___split_fields file__split_fields file__split_fields1 file__split_fields2 file__split_fields3 file__split_fields4 file__split_fields5 file__split_fields6)) cur_position the_file) true)) (and (= (to_rep1 result____first) 1) (and (= (to_rep1 result____last) 2147483647) (and (= cur_position (+ (- (+ cur_position_at_start (to_rep1 (last (rt s)))) (to_rep1 (first (rt s)))) 1)) (forall ((idx Int)) (=> (and (<= (to_rep1 (first (rt s))) idx) (<= idx (to_rep1 (last (rt s))))) (= (to_rep (select (elts s) idx)) (to_rep (select the_file (+ (- idx (to_rep1 (first (rt s)))) cur_position_at_start)))))))))))
(assert (and (dynamic_property2 1 (ite (< 500 (length s)) (length s) 500) (to_rep1 buffer__first) (to_rep1 buffer__last)) (and (= (to_rep1 buffer__first) 1) (= (to_rep1 buffer__last) (ite (< 500 (length s)) (length s) 500)))))
(assert (=> (<= 0 2147483647) (in_range4 last10)))
(assert (and (ite (< (to_rep1 buffer__last) (to_rep1 buffer__first)) (= last11 (- (to_rep1 buffer__first) 1)) (and (and (and (or (= last11 (- (to_rep1 buffer__first) 1)) (and (<= (to_rep1 buffer__first) last11) (<= last11 (to_rep1 buffer__last)))) (forall ((idx Int)) (=> (and (<= (to_rep1 buffer__first) idx) (<= idx last11)) (= (to_rep (select o14 idx)) (to_rep (select the_file (+ (- idx (to_rep1 buffer__first)) cur_position))))))) (= cur_position1 (+ (- (+ cur_position last11) (to_rep1 buffer__first)) 1))) (or (or (= last11 (to_rep1 buffer__last)) (= (to_rep (select the_file cur_position1)) eof_ch)) (= (to_rep (select the_file cur_position1)) 10)))) (and (in_range4 last11) (in_range2 cur_position1))))
(assert (= last11 r74b))
(assert (in_range4 r74b))
(assert (=> (<= 1 r74b) (and (and (<= (to_rep1 buffer__first) 1) (<= 1 (to_rep1 buffer__last))) (and (<= (to_rep1 buffer__first) r74b) (<= r74b (to_rep1 buffer__last))))))
(assert (= o o14))
(assert (= o temp___720))
(assert (= (mk2 1 r74b) temp___7201))
(assert (=> (= (length s) 0) (= temp___720 textio__get_line_function__get_rest__B_1__r__assume)))
(assert (=> (= (length s) 0) (= (mk (to_rep1 (first4 temp___7201)) (to_rep1 (last4 temp___7201))) textio__get_line_function__get_rest__B_1__r__assume1)))
(assert (=> (not (= (length s) 0)) (=> (<= (to_rep1 (first4 temp___7201)) (to_rep1 (last4 temp___7201))) (= o1 (+ (- (to_rep1 (last4 temp___7201)) (to_rep1 (first4 temp___7201))) 1)))))
(assert (=> (not (= (length s) 0)) (=> (not (<= (to_rep1 (first4 temp___7201)) (to_rep1 (last4 temp___7201)))) (= o1 0))))
(assert (=> (not (= (length s) 0)) (=> (<= (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))) (= o2 (+ (- (to_rep1 (last (rt s))) (to_rep1 (first (rt s)))) 1)))))
(assert (=> (not (= (length s) 0)) (=> (not (<= (to_rep1 (first (rt s))) (to_rep1 (last (rt s))))) (= o2 0))))
...
(assert (=> (not (= (length s) 0)) (= (concat1 (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s))) temp___720 (to_rep1 (first4 temp___7201)) (to_rep1 (last4 temp___7201))) textio__get_line_function__get_rest__B_1__r__assume)))
(assert (=> (not (= (length s) 0)) (= (mk (to_rep1 (first (rt s))) o6) textio__get_line_function__get_rest__B_1__r__assume1)))
(assert (= (mk___t textio__get_line_function__get_rest__B_1__r__assume textio__get_line_function__get_rest__B_1__r__assume1) r))
(assert (dynamic_invariant3 r true false true true))
(assert (= (to_rep1 (first (rt r))) (to_rep1 (first (rt s)))))
(assert (= (to_rep1 (last (rt r))) (+ (to_rep1 (last (rt s))) last11)))
(assert (and (= o7 (- (to_rep1 (last (rt s))) (to_rep1 (first (rt s))))) (in_range1 (- (to_rep1 (last (rt s))) (to_rep1 (first (rt s)))))))
(assert (= o8 (+ o7 1)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (= o10 (+ o9 last11)))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (and (= o12 o11) (in_range4 o11)))
(assert (= (mk_int__ref result) (mk_int__ref num)))
(assert (= num1 o12))
(assert (not (< last11 (to_rep1 buffer__last))))
(assert (= last11 (to_rep1 buffer__last)))
(assert (and (= result1 (end_of_file (mk___rep file__split_fields14) cur_position1 the_file)) (= (= result1 true) (= (fpeek (mk___rep file__split_fields14) cur_position1 the_file) eof))))
(assert (= result1 true))
(assert (= num1 r80b))
(assert (in_range4 r80b))
(assert (= (ite (<= (to_rep1 (first (rt r))) (to_rep1 (last (rt r)))) (+ (- (to_rep1 (last (rt r))) (to_rep1 (first (rt r)))) 1) 0) (ite (<= 1 r80b) (+ (- r80b 1) 1) 0)))
(assert (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___709))
(assert (= (mk4 1 r80b) temp___7091))
(assert (=> (<= 1 r80b) (and (and (<= (to_rep1 result____first) 1) (<= 1 (to_rep1 result____last))) (and (<= (to_rep1 result____first) r80b) (<= r80b (to_rep1 result____last))))))
(assert (= o13 result__))
(assert (= o13 temp___711))
(assert (= (mk4 1 r80b) temp___7111))
(assert (not (= (ite (<= (to_rep1 (first8 temp___7091)) (to_rep1 (last8 temp___7091))) (+ (- (to_rep1 (last8 temp___7091)) (to_rep1 (first8 temp___7091))) 1) 0) (ite (<= (to_rep1 (first8 temp___7111)) (to_rep1 (last8 temp___7111))) (+ (- (to_rep1 (last8 temp___7111)) (to_rep1 (first8 temp___7111))) 1) 0))))
(check-sat)
(exit)
