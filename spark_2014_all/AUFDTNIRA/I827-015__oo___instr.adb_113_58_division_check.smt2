...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_163 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_163 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_163 us_void_param) 14)) 32)) :pattern ((temp___String_Literal_163 us_void_param)))))
(define-fun default_initial_assumption ((temp___expr_272 us_rep4) (temp___skip_top_level_273 Bool)) Bool (and (= (attr__tag4 temp___expr_272) us_tag5) (and (and (and (= (rec__instr__instrument__name4 (us_split_fields9 temp___expr_272)) (temp___String_Literal_163 Tuple0)) (= (to_rep4 (rec__instr__clock__seconds (us_split_fields9 temp___expr_272))) 0)) (= (to_rep4 (rec__instr__clock__minutes (us_split_fields9 temp___expr_272))) 0)) (= (to_rep5 (rec__instr__clock__hours (us_split_fields9 temp___expr_272))) 0))))
(declare-const x us_rep4)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun temp___String_Literal_375 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_375 us_void_param) 1)) 60) (= (to_rep (select (temp___String_Literal_375 us_void_param) 2)) 60)) :pattern ((temp___String_Literal_375 us_void_param)))))
(declare-fun temp___String_Literal_376 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_376 us_void_param) 1)) 62) (= (to_rep (select (temp___String_Literal_376 us_void_param) 2)) 62)) :pattern ((temp___String_Literal_376 us_void_param)))))
...
(define-fun dynamic_invariant4 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 85)) (in_range3 temp___expr_178)))
(define-fun dynamic_invariant5 ((temp___expr_202 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 0 100)) (in_range4 temp___expr_202)))
(define-fun dynamic_invariant6 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 0 60)) (in_range5 temp___expr_236)))
(define-fun dynamic_invariant7 ((temp___expr_242 Int) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool)) Bool (=> (or (= temp___is_init_239 true) (<= 0 24)) (in_range6 temp___expr_242)))
(define-fun default_initial_assumption1 ((temp___expr_161 us_rep) (temp___skip_top_level_162 Bool)) Bool (and (= (attr__tag temp___expr_161) us_tag) (= (rec__instr__instrument__name (us_split_fields1 temp___expr_161)) (temp___String_Literal_163 Tuple0))))
(define-fun default_initial_assumption2 ((temp___expr_186 us_rep1) (temp___skip_top_level_187 Bool)) Bool (and (= (attr__tag1 temp___expr_186) us_tag1) (and (= (to_rep2 (rec__instr__speedometer__value (us_split_fields3 temp___expr_186))) 0) (= (rec__instr__instrument__name1 (us_split_fields3 temp___expr_186)) (temp___String_Literal_163 Tuple0)))))
(define-fun default_initial_assumption3 ((temp___expr_210 us_rep2) (temp___skip_top_level_211 Bool)) Bool (and (= (attr__tag2 temp___expr_210) us_tag2) (and (= (to_rep3 (rec__instr__gauge__value (us_split_fields5 temp___expr_210))) 0) (= (rec__instr__instrument__name2 (us_split_fields5 temp___expr_210)) (temp___String_Literal_163 Tuple0)))))
(define-fun default_initial_assumption4 ((temp___expr_229 us_rep3) (temp___skip_top_level_230 Bool)) Bool (and (= (attr__tag3 temp___expr_229) us_tag3) (and (and (and (and (= (to_rep1 (rec__instr__graphic_gauge__size (us_split_fields7 temp___expr_229))) 20) (= (to_rep (rec__instr__graphic_gauge__fill (us_split_fields7 temp___expr_229))) 42)) (= (to_rep (rec__instr__graphic_gauge__empty (us_split_fields7 temp___expr_229))) 46)) (= (rec__instr__instrument__name3 (us_split_fields7 temp___expr_229)) (temp___String_Literal_163 Tuple0))) (= (to_rep3 (rec__instr__gauge__value1 (us_split_fields7 temp___expr_229))) 0))))
(define-fun default_initial_assumption5 ((temp___expr_250 us_rep4) (temp___skip_top_level_251 Bool)) Bool (and (= (attr__tag4 temp___expr_250) us_tag4) (and (and (and (= (to_rep4 (rec__instr__clock__seconds (us_split_fields9 temp___expr_250))) 0) (= (to_rep4 (rec__instr__clock__minutes (us_split_fields9 temp___expr_250))) 0)) (= (to_rep5 (rec__instr__clock__hours (us_split_fields9 temp___expr_250))) 0)) (= (rec__instr__instrument__name4 (us_split_fields9 temp___expr_250)) (temp___String_Literal_163 Tuple0)))))
(declare-const v Int)
(declare-const o Int)
...
(assert (and (= o2 (* (to_rep5 (rec__instr__clock__hours (us_split_fields9 x))) 3600)) (in_range (* (to_rep5 (rec__instr__clock__hours (us_split_fields9 x))) 3600))))
(assert (and (= o (* (to_rep4 (rec__instr__clock__minutes (us_split_fields9 x))) 60)) (in_range (* (to_rep4 (rec__instr__clock__minutes (us_split_fields9 x))) 60))))
(assert (= o1 (+ (to_rep4 (rec__instr__clock__seconds (us_split_fields9 x))) o)))
