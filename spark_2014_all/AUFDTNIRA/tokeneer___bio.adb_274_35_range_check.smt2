...
(assert (forall ((a (Array Int us_rep))) (forall ((first4 Int)) (! (= (slide1 a first4 first4) a) :pattern ((slide1 a first4 first4))))))
...
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq3 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true))))))))
...
(assert (forall ((a (Array Int filestatust))) (forall ((first4 Int)) (! (= (slide2 a first4 first4) a) :pattern ((slide2 a first4 first4))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep2 (select a temp___idx_175)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(assert (forall ((a (Array Int logfileindext))) (forall ((first4 Int)) (! (= (slide3 a first4 first4) a) :pattern ((slide3 a first4 first4))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep3 (select a temp___idx_172)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(define-fun bool_eq7 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (= (bool_eq6 (rec__auditlog__logfilelistt__list (us_split_fields1 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields1 b)) 1 17) true) (= (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 a))) (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 b))))) (= (to_rep3 (rec__auditlog__logfilelistt__lasti (us_split_fields1 a))) (to_rep3 (rec__auditlog__logfilelistt__lasti (us_split_fields1 b))))) (= (to_rep5 (rec__auditlog__logfilelistt__length (us_split_fields1 a))) (to_rep5 (rec__auditlog__logfilelistt__length (us_split_fields1 b))))) true false))
...
(assert (forall ((a (Array Int fileentrycountt))) (forall ((first4 Int)) (! (= (slide4 a first4 first4) a) :pattern ((slide4 a first4 first4))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep6 (select a temp___idx_173)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(define-fun bool_eq9 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (= (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 a))) (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 b)))) (= (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 a))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 b))))) (= (bool_eq7 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 b))) true)) (= (bool_eq8 (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 b)) 1 17) true)) true false))
...
(define-fun dynamic_invariant ((temp___expr_561 Int) (temp___is_init_557 Bool) (temp___skip_constant_558 Bool) (temp___do_toplevel_559 Bool) (temp___do_typ_inv_560 Bool)) Bool (=> (or (= temp___is_init_557 true) (<= 0 1)) (in_range8 temp___expr_561)))
...
(define-fun dynamic_invariant1 ((temp___expr_1222 us_rep2) (temp___is_init_1218 Bool) (temp___skip_constant_1219 Bool) (temp___do_toplevel_1220 Bool) (temp___do_typ_inv_1221 Bool)) Bool (=> (= temp___do_typ_inv_1221 true) (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1222))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1222))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1222)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1222))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1226 us_rep2) (temp___skip_top_level_1227 Bool)) Bool (and (and (and (= (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1226))) 1) (= (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1226))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1226)) (mk___rep (mk___split_fields (temp_____aggregate_def_1228 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1226)) (temp_____aggregate_def_1232 0))))
(define-fun type_invariant ((temp___1236 us_rep2)) Bool (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1236))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1236))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1236)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1236))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_190 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 4294967295)) (in_range9 temp___expr_190)))
(declare-sort fart 0)
...
(declare-fun user_eq17 (fart fart) Bool)
(declare-const dummy17 fart)
...
(define-fun dynamic_invariant3 ((temp___expr_485 Int) (temp___is_init_481 Bool) (temp___skip_constant_482 Bool) (temp___do_toplevel_483 Bool) (temp___do_typ_inv_484 Bool)) Bool (=> (or (= temp___is_init_481 true) (<= 0 2147483647)) (in_range10 temp___expr_485)))
(declare-sort matchresultt 0)
(define-fun in_range11 ((x Int)) Bool (and (<= 0 x) (<= x 1)))
(declare-fun attr__ATTRIBUTE_IMAGE11 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check11 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE11 (us_image) Int)
(declare-fun user_eq18 (matchresultt matchresultt) Bool)
(declare-const dummy18 matchresultt)
...
(define-fun dynamic_invariant4 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 1)) (in_range11 temp___expr_496)))
(define-fun to_rep7 ((x fart)) Int (fartqtint x))
(declare-fun of_rep7 (Int) fart)
(assert (forall ((x fart)) (! (= (of_rep7 (to_rep7 x)) x) :pattern ((to_rep7 x)))))
(assert (forall ((x fart)) (! (in_range10 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(declare-fun user_eq19 (bytet bytet) Bool)
(declare-const dummy19 bytet)
...
(define-fun to_rep8 ((x bytet)) Int (bytetqtint x))
(declare-fun of_rep8 (Int) bytet)
(assert (forall ((x bytet)) (! (= (of_rep8 (to_rep8 x)) x) :pattern ((to_rep8 x)))))
(assert (forall ((x bytet)) (! (in_range12 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(define-fun bool_eq10 ((a (Array Int bytet)) (a__first Int) (a__last Int) (b (Array Int bytet)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_158 Int)) (=> (and (<= a__first temp___idx_158) (<= temp___idx_158 a__last)) (= (to_rep8 (select a temp___idx_158)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_158))))))) true false))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_158 Int)) (=> (and (<= a__first temp___idx_158) (<= temp___idx_158 a__last)) (= (to_rep8 (select a temp___idx_158)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_158)))))))))))
(declare-const dummy20 (Array Int bytet))
...
(declare-fun user_eq20 ((Array Int bytet) (Array Int bytet)) Bool)
...
(declare-fun user_eq21 (templatelengtht templatelengtht) Bool)
(declare-const dummy21 templatelengtht)
...
(define-fun to_rep9 ((x templatelengtht)) Int (templatelengthtqtint x))
(declare-fun of_rep9 (Int) templatelengtht)
(assert (forall ((x templatelengtht)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)))))
(assert (forall ((x templatelengtht)) (! (in_range13 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__iandatypes__templatet__length templatelengtht) (rec__iandatypes__templatet__requiredmaxfar fart) (rec__iandatypes__templatet__id (Array Int character)) (rec__iandatypes__templatet__pad (Array Int bytet))))))
(define-fun us_split_fields_Length__projection ((a us_split_fields4)) templatelengtht (rec__iandatypes__templatet__length a))
(define-fun us_split_fields_RequiredMaxFAR__projection ((a us_split_fields4)) fart (rec__iandatypes__templatet__requiredmaxfar a))
(define-fun us_split_fields_ID__2__projection ((a us_split_fields4)) (Array Int character) (rec__iandatypes__templatet__id a))
(define-fun us_split_fields_Pad__projection ((a us_split_fields4)) (Array Int bytet) (rec__iandatypes__templatet__pad a))
...
(define-fun bool_eq11 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (to_rep9 (rec__iandatypes__templatet__length (us_split_fields5 a))) (to_rep9 (rec__iandatypes__templatet__length (us_split_fields5 b)))) (= (to_rep7 (rec__iandatypes__templatet__requiredmaxfar (us_split_fields5 a))) (to_rep7 (rec__iandatypes__templatet__requiredmaxfar (us_split_fields5 b))))) (= (bool_eq (rec__iandatypes__templatet__id (us_split_fields5 a)) 1 40 (rec__iandatypes__templatet__id (us_split_fields5 b)) 1 40) true)) (= (bool_eq10 (rec__iandatypes__templatet__pad (us_split_fields5 a)) 1 452 (rec__iandatypes__templatet__pad (us_split_fields5 b)) 1 452) true)) true false))
...
(declare-datatypes () ((templatet__ref (mk_templatet__ref (templatet__content us_rep3)))))
(define-fun templatet__ref___projection ((a templatet__ref)) us_rep3 (templatet__content a))
...
(define-fun bool_eq12 ((x us_t2) (y us_t2)) Bool (bool_eq (elts2 x) (to_rep1 (first4 (rt2 x))) (to_rep1 (last4 (rt2 x))) (elts2 y) (to_rep1 (first4 (rt2 y))) (to_rep1 (last4 (rt2 y)))))
...
(define-fun in_range14 ((x Int)) Bool (and (<= 0 x) (<= x 16)))
(declare-fun attr__ATTRIBUTE_IMAGE14 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check14 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE14 (us_image) Int)
(declare-fun user_eq25 (source source) Bool)
(declare-const dummy25 source)
...
(define-fun dynamic_invariant6 ((temp___expr_1479 Int) (temp___is_init_1475 Bool) (temp___skip_constant_1476 Bool) (temp___do_toplevel_1477 Bool) (temp___do_typ_inv_1478 Bool)) Bool (=> (or (= temp___is_init_1475 true) (<= 0 16)) (in_range14 temp___expr_1479)))
(declare-sort target 0)
(declare-fun targetqtint (target) Int)
(assert (forall ((i target)) (and (<= 0 (targetqtint i)) (<= (targetqtint i) 4294967295))))
(define-fun in_range15 ((x Int)) Bool (and (<= 0 x) (<= x 4294967295)))
(declare-fun attr__ATTRIBUTE_IMAGE15 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check15 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE15 (us_image) Int)
(declare-fun user_eq26 (target target) Bool)
(declare-const dummy26 target)
...
(define-fun dynamic_invariant7 ((temp___expr_1486 Int) (temp___is_init_1482 Bool) (temp___skip_constant_1483 Bool) (temp___do_toplevel_1484 Bool) (temp___do_typ_inv_1485 Bool)) Bool (=> (or (= temp___is_init_1482 true) (<= 0 4294967295)) (in_range15 temp___expr_1486)))
(assert (forall ((s Int)) (! (=> (dynamic_invariant6 s true true true true) (dynamic_invariant7 (codetoval s) true false true true)) :pattern ((codetoval s)))))
...
(define-fun in_range16 ((x Int)) Bool (and (<= 1 x) (<= x 150)))
...
(declare-fun user_eq27 (descriptioni descriptioni) Bool)
(declare-const dummy27 descriptioni)
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_169 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_169 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 4)) 115)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 29)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_169 us_void_param) 50)) 32)) :pattern ((temp___String_Literal_169 us_void_param)))))
(declare-const template us_rep3)
...
(define-fun in_range17 ((x Int)) Bool (and (<= 0 x) (<= x 16)))
...
(declare-fun user_eq28 (returnt returnt) Bool)
(declare-const dummy28 returnt)
...
(define-fun dynamic_invariant8 ((temp___expr_1411 Int) (temp___is_init_1407 Bool) (temp___skip_constant_1408 Bool) (temp___do_toplevel_1409 Bool) (temp___do_typ_inv_1410 Bool)) Bool (=> (or (= temp___is_init_1407 true) (<= 0 16)) (in_range17 temp___expr_1411)))
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-const c31b Int)
(declare-const attr__ATTRIBUTE_ADDRESS11 Int)
(declare-const attr__ATTRIBUTE_ADDRESS12 Int)
(declare-fun temp___String_Literal_1489 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1489 us_void_param) 1)) 66) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 4)) 109)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 9)) 99)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 11)) 100)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 13)) 118)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 14)) 105)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 15)) 99)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 18)) 102)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 20)) 105)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 21)) 108)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 22)) 117)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_1489 us_void_param) 25)) 32)) :pattern ((temp___String_Literal_1489 us_void_param)))))
...
(define-fun dynamic_invariant10 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range2 temp___expr_74)))
...
(define-fun dynamic_invariant12 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_18)))
(define-fun dynamic_invariant13 ((temp___expr_1160 Int) (temp___is_init_1156 Bool) (temp___skip_constant_1157 Bool) (temp___do_toplevel_1158 Bool) (temp___do_typ_inv_1159 Bool)) Bool (=> (or (= temp___is_init_1156 true) (<= 0 17)) (in_range6 temp___expr_1160)))
(define-fun dynamic_invariant14 ((temp___expr_1167 Int) (temp___is_init_1163 Bool) (temp___skip_constant_1164 Bool) (temp___do_toplevel_1165 Bool) (temp___do_typ_inv_1166 Bool)) Bool (=> (or (= temp___is_init_1163 true) (<= 1 17)) (in_range4 temp___expr_1167)))
(define-fun dynamic_invariant15 ((temp___expr_1293 Int) (temp___is_init_1289 Bool) (temp___skip_constant_1290 Bool) (temp___do_toplevel_1291 Bool) (temp___do_typ_inv_1292 Bool)) Bool (=> (or (= temp___is_init_1289 true) (<= 0 2)) (in_range3 temp___expr_1293)))
(define-fun dynamic_invariant16 ((temp___expr_1174 Int) (temp___is_init_1170 Bool) (temp___skip_constant_1171 Bool) (temp___do_toplevel_1172 Bool) (temp___do_typ_inv_1173 Bool)) Bool (=> (or (= temp___is_init_1170 true) (<= 0 17408)) (in_range5 temp___expr_1174)))
(define-fun dynamic_invariant17 ((temp___expr_1205 Int) (temp___is_init_1201 Bool) (temp___skip_constant_1202 Bool) (temp___do_toplevel_1203 Bool) (temp___do_typ_inv_1204 Bool)) Bool (=> (or (= temp___is_init_1201 true) (<= 0 1024)) (in_range7 temp___expr_1205)))
(assert true)
...
(assert (forall ((temp___1234 Int)) (=> (dynamic_invariant17 temp___1234 true true true true) (forall ((temp___1235 Int)) (= (select (temp_____aggregate_def_1232 temp___1234) temp___1235) rliteral2)))))
(define-fun dynamic_invariant18 ((temp___expr_586 Int) (temp___is_init_582 Bool) (temp___skip_constant_583 Bool) (temp___do_toplevel_584 Bool) (temp___do_typ_inv_585 Bool)) Bool (=> (or (= temp___is_init_582 true) (<= 1 150)) (in_range16 temp___expr_586)))
(assert (= nouser (temp___String_Literal_169 Tuple0)))
(define-fun dynamic_invariant19 ((temp___expr_211 Int) (temp___is_init_207 Bool) (temp___skip_constant_208 Bool) (temp___do_toplevel_209 Bool) (temp___do_typ_inv_210 Bool)) Bool (=> (or (= temp___is_init_207 true) (<= 0 255)) (in_range12 temp___expr_211)))
(define-fun dynamic_invariant20 ((temp___expr_296 us_t2) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool (and (=> (not (= temp___skip_constant_293 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_296) (last5 temp___expr_296))) (=> (= temp___do_toplevel_294 true) (=> (= temp___is_init_292 true) (and (= (first5 temp___expr_296) 1) (<= 0 (last5 temp___expr_296)))))))
(define-fun dynamic_predicate1 ((temp___299 us_t2)) Bool (and (= (first5 temp___299) 1) (<= 0 (last5 temp___299))))
(define-fun dynamic_invariant21 ((temp___expr_520 Int) (temp___is_init_516 Bool) (temp___skip_constant_517 Bool) (temp___do_toplevel_518 Bool) (temp___do_typ_inv_519 Bool)) Bool (=> (or (= temp___is_init_516 true) (<= 0 4294967295)) (in_range13 temp___expr_520)))
(assert (forall ((temp___1230 Int)) (=> (dynamic_invariant14 temp___1230 true true true true) (forall ((temp___1231 Int)) (= (select (temp_____aggregate_def_1228 temp___1230) temp___1231) rliteral)))))
...
(assert (= (temp___String_Literal_169 Tuple0) nouser))
(assert (in_range10 maxfar))
(assert (=> (<= 0 1) (in_range11 matchresult)))
(assert (=> (<= 0 2147483647) (in_range10 achievedfar)))
...
(assert (=> (<= 0 4294967295) (in_range9 numericreturn)))
(assert (and (and (in_range11 matchresult1) (in_range10 achievedfar1)) (in_range9 numericreturn1)))
(assert (in_range17 c31b))
(assert (=> (<= 0 4294967295) (in_range9 c32b)))
(assert (and (= o (codetoval 0)) (in_range15 o)))
(assert (= result c32b))
(assert (= c32b1 o))
