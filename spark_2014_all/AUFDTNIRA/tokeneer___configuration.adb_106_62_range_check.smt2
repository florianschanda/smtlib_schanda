...
(assert (not (= (length temp___1934) 0)))
(assert (=> (<= 1 2) (= o84 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o84 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1934))) (to_rep1 (last (rt temp___1934)))) (= o85 (+ (- (to_rep1 (last (rt temp___1934))) (to_rep1 (first (rt temp___1934)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1934))) (to_rep1 (last (rt temp___1934))))) (= o85 0)))
(assert (= o86 (+ o85 o84)))
(assert (= o87 (+ (to_rep1 (first (rt temp___1934))) o86)))
(assert (= o88 (- o87 1)))
