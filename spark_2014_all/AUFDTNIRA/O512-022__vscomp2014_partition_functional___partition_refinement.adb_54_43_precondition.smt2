...
(assert (<= 0 j2))
(assert (<= j2 5))
(assert (and (= (mk___rep (mk___split_fields o26 o27 o28)) (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) (to_rep2 (select f j2)))) (= (bool_eq (mk___rep (mk___split_fields o26 o27 o28)) (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) (to_rep2 (select f j2)))) true)))
(assert (= o26 o29))
(assert (= o27 o30))
(assert (= o28 o31))
(assert (= o32 o30))
(assert (= o33 (to_rep1 o32)))
(assert (= o34 (ite (<= j2 o33) true false)))
(assert (not (<= 0 (to_rep2 (select f j2)))))
(check-sat)
(exit)
