...
(assert (and (= o12 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o12) (= o12 (ite (= (distinct 1 0) true) (to_rep3 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o10 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o10) (<= o10 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
(assert (= o11 (* 2 o10)))
(assert (and (= o13 o11) (in_range1 o11)))
(assert (= result (ite (<= o13 o12) true false)))
(assert (= result true))
(assert (and (= o9 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o9) (<= o9 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
...
(assert (<= 0 j))
(assert (<= j 5))
(assert (and (= o14 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) (to_rep2 (select f j)))) (= (bool_eq o14 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) (to_rep2 (select f j)))) true)))
(assert (= o o3))
(assert (= o1 o4))
(assert (= o2 o5))
(assert (= o6 o4))
...
(assert (not (<= 0 (to_rep2 (select f j)))))
(check-sat)
(exit)
