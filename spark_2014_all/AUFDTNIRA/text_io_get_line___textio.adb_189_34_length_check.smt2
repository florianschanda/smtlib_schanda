...
(declare-const temp___6551 t3)
(declare-const o13 (Array Int character))
(declare-const temp___657 (Array Int character))
(declare-const temp___6571 t3)
...
(assert (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___655))
(assert (= (mk3 1 r77b) temp___6551))
...
(assert (= o13 result__))
(assert (= o13 temp___657))
(assert (= (mk3 1 r77b) temp___6571))
(assert (not (= (ite (<= (to_rep1 (first6 temp___6551)) (to_rep1 (last6 temp___6551))) (+ (- (to_rep1 (last6 temp___6551)) (to_rep1 (first6 temp___6551))) 1) 0) (ite (<= (to_rep1 (first6 temp___6571)) (to_rep1 (last6 temp___6571))) (+ (- (to_rep1 (last6 temp___6571)) (to_rep1 (first6 temp___6571))) 1) 0))))
(check-sat)
(exit)
