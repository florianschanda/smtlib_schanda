...
(assert (= num1 r77b))
(assert (in_range4 r77b))
(assert (= (ite (<= (to_rep1 (first (rt r))) (to_rep1 (last (rt r)))) (+ (- (to_rep1 (last (rt r))) (to_rep1 (first (rt r)))) 1) 0) (ite (<= 1 r77b) (+ (- r77b 1) 1) 0)))
(assert (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___649))
(assert (= (mk3 1 r77b) temp___6491))
(assert (=> (<= 1 r77b) (and (and (<= (to_rep1 result____first) 1) (<= 1 (to_rep1 result____last))) (and (<= (to_rep1 result____first) r77b) (<= r77b (to_rep1 result____last))))))
(assert (= o18 result__))
(assert (= o18 temp___651))
(assert (= (mk3 1 r77b) temp___6511))
(assert (not (= (ite (<= (to_rep1 (first6 temp___6491)) (to_rep1 (last6 temp___6491))) (+ (- (to_rep1 (last6 temp___6491)) (to_rep1 (first6 temp___6491))) 1) 0) (ite (<= (to_rep1 (first6 temp___6511)) (to_rep1 (last6 temp___6511))) (+ (- (to_rep1 (last6 temp___6511)) (to_rep1 (first6 temp___6511))) 1) 0))))
(check-sat)
(exit)
