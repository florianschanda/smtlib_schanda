...
(declare-const temp___721 (Array Int character))
(declare-const temp___7211 t3)
(declare-const o13 (Array Int character))
(declare-const temp___723 (Array Int character))
(declare-const temp___7231 t3)
...
(assert (= (slide (elts r) (to_rep1 (first (rt r))) 1) temp___721))
(assert (= (mk3 1 r77b) temp___7211))
...
(assert (= o13 result__))
(assert (= o13 temp___723))
(assert (= (mk3 1 r77b) temp___7231))
(assert (not (= (ite (<= (to_rep1 (first6 temp___7211)) (to_rep1 (last6 temp___7211))) (+ (- (to_rep1 (last6 temp___7211)) (to_rep1 (first6 temp___7211))) 1) 0) (ite (<= (to_rep1 (first6 temp___7231)) (to_rep1 (last6 temp___7231))) (+ (- (to_rep1 (last6 temp___7231)) (to_rep1 (first6 temp___7231))) 1) 0))))
(check-sat)
(exit)
