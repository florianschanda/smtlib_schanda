...
(declare-const m Int)
(declare-const q Int)
(declare-const temp___528 (Array Int content))
(declare-const temp___526 (Array Int content))
(declare-const temp___524 Int)
(declare-const temp___532 (Array Int content))
(declare-const temp___523 Int)
(declare-const temp___530 (Array Int content))
(declare-const o Int)
...
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= temp___528 h)))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= temp___526 h)))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= temp___524 t1)))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= temp___532 h)))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= temp___523 q1)))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= temp___530 h)))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (forall ((k1 Int)) (=> (and (<= (to_rep h__first) k1) (<= k1 (to_rep h__last))) (ite (< k1 q2) (= (to_rep1 (select h2 k1)) (to_rep1 (select temp___528 (+ k1 m1)))) (ite (< (+ q2 m1) k1) (= (to_rep1 (select h2 k1)) (to_rep1 (select temp___530 (- k1 m1)))) (= (to_rep1 (select h2 k1)) (to_rep1 (select temp___532 k1)))))))))
...
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (and (= temp___521 (+ q2 m1)) (in_range1 (+ q2 m1)))))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (and (<= (to_rep h__first) temp___521) (<= temp___521 (to_rep h__last)))))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= o3 temp___521)))
...
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (and (= temp___522 (+ q2 m1)) (in_range1 (+ q2 m1)))))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (and (<= (to_rep h__first) temp___522) (<= temp___522 (to_rep h__last)))))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= o10 temp___522)))
