...
(declare-const temp___524 (Array Int content))
...
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= temp___524 h)))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= temp___522 t1)))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= temp___530 h)))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= temp___521 q1)))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= temp___528 h)))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (forall ((k1 Int)) (=> (and (<= (to_rep h__first) k1) (<= k1 (to_rep h__last))) (ite (< k1 q2) (= (to_rep1 (select h2 k1)) (to_rep1 (select temp___526 (+ k1 m1)))) (ite (< (+ q2 m1) k1) (= (to_rep1 (select h2 k1)) (to_rep1 (select temp___528 (- k1 m1)))) (= (to_rep1 (select h2 k1)) (to_rep1 (select temp___530 k1)))))))))
...
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (and (= temp___519 (+ q2 m1)) (in_range1 (+ q2 m1)))))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (and (<= (to_rep h__first) temp___519) (<= temp___519 (to_rep h__last)))))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= o3 temp___519)))
...
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (and (= temp___520 (+ q2 m1)) (in_range1 (+ q2 m1)))))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (and (<= (to_rep h__first) temp___520) (<= temp___520 (to_rep h__last)))))
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (= o10 temp___520)))
