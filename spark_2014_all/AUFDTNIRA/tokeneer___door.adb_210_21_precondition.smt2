...
(assert (=> (= newdoor1 1) (= result (mk_int__ref id))))
(assert (=> (= newdoor1 1) (= id2 6)))
(assert (=> (not (= newdoor1 1)) (= result1 (mk_int__ref id))))
(assert (=> (not (= newdoor1 1)) (= id3 7)))
(assert (=> (not (= newdoor1 1)) (= id2 id3)))
