...
(assert (= result9 true))
(assert (and (= o27 (+ (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14)))) 1)) (in_range6 (+ (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14)))) 1))))
(assert (= (to_rep2 o28) o27))
(assert (= o29 (mk___split_fields (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14))) (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14))) o28 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14))))))
(assert (= o30 (mk___rep o29)))
(assert (= o31 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields14) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields14) o30 (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields14))))
(assert (= temp___1339 (mk___rep1 o31)))
(assert (= result10 (mk___split_fields__ref1 logfilestate__split_fields14)))
(assert (= logfilestate__split_fields15 (us_split_fields3 temp___1339)))
(assert (and (= o32 (+ (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields15)))) 1)) (in_range9 (+ (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields15)))) 1))))
(assert (= (to_rep4 o33) o32))
(assert (= o34 (mk___split_fields (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields15))) (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields15))) (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields15))) o33)))
(assert (= o35 (mk___rep o34)))
(assert (= o36 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields15) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields15) o35 (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields15))))
(assert (= temp___1342 (mk___rep1 o36)))
(assert (= result11 (mk___split_fields__ref1 logfilestate__split_fields15)))
(assert (= logfilestate__split_fields16 (us_split_fields3 temp___1342)))
(assert (= (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields16)))) r78b))
(assert (in_range6 r78b))
(assert (and (= temp___1351 (+ j4 1)) (in_range5 (+ j4 1))))
(assert (= result12 (mk_int__ref k3)))
(assert (= k4 r78b))
(assert (<= temp___1351 k4))
(assert (<= k4 r78b))
(assert (and (and (and (and (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields17) (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields16)) (= (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields17) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields16))) (and (and (and (forall ((temp___1350 Int)) (=> (and (<= 1 temp___1350) (<= temp___1350 17)) (=> (<= temp___1350 k5) (= (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields17))) temp___1350) (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields16))) temp___1350))))) (= (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields17))) (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields16))))) (= (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields17))) (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields16))))) (= (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields17))) (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields16)))))) (= (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields17) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields16))) (and (<= (+ j4 1) k5) (<= k5 r78b))))
(assert (not (in_range5 (- k5 1))))
(check-sat)
(exit)
