...
(assert (= result5 true))
(assert (and (= o7 (+ (to_rep3 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))) 1)) (in_range7 (+ (to_rep3 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))) 1))))
(assert (= (to_rep3 o8) o7))
(assert (= o9 (mk___split_fields (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10))) (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10))) o8 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10))))))
(assert (= o10 (mk___rep o9)))
(assert (= o11 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10) o10 (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10))))
(assert (= temp___1549 (mk___rep1 o11)))
(assert (= result6 (mk___split_fields__ref1 logfilestate__split_fields10)))
(assert (= logfilestate__split_fields11 (us_split_fields3 temp___1549)))
(assert (and (= o12 (+ (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11)))) 1)) (in_range6 (+ (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11)))) 1))))
(assert (= (to_rep2 o13) o12))
(assert (= o14 (mk___split_fields (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11))) (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11))) (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11))) o13)))
(assert (= o15 (mk___rep o14)))
(assert (= o16 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11) o15 (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11))))
(assert (= temp___1552 (mk___rep1 o16)))
(assert (= result7 (mk___split_fields__ref1 logfilestate__split_fields11)))
(assert (= logfilestate__split_fields12 (us_split_fields3 temp___1552)))
(assert (= (to_rep3 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12)))) r78b))
(assert (in_range7 r78b))
(assert (and (= temp___1561 (+ j2 1)) (in_range5 (+ j2 1))))
(assert (= result8 (mk_int__ref k)))
(assert (= k1 r78b))
(assert (<= temp___1561 k1))
(assert (<= k1 r78b))
(assert (and (and (and (and (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields13) (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields12)) (= (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields13) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields12))) (and (and (and (forall ((temp___1560 Int)) (=> (and (<= 1 temp___1560) (<= temp___1560 17)) (=> (<= temp___1560 k2) (= (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13))) temp___1560) (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12))) temp___1560))))) (= (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13))) (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12))))) (= (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13))) (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12))))) (= (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13))) (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12)))))) (= (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields13) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields12))) (and (<= (+ j2 1) k2) (<= k2 r78b))))
(assert (not (in_range5 (- k2 1))))
(check-sat)
(exit)
