...
(assert (= temp___1395 (mk___rep1 o31)))
(assert (= result10 (mk___split_fields__ref1 logfilestate__split_fields14)))
(assert (= logfilestate__split_fields15 (us_split_fields3 temp___1395)))
...
(assert (= temp___1398 (mk___rep1 o36)))
(assert (= result11 (mk___split_fields__ref1 logfilestate__split_fields15)))
(assert (= logfilestate__split_fields16 (us_split_fields3 temp___1398)))
...
(assert (and (= temp___1407 (+ j4 1)) (in_range5 (+ j4 1))))
(assert (= result12 (mk_int__ref k3)))
(assert (= k4 r78b))
(assert (<= temp___1407 k4))
(assert (<= k4 r78b))
(assert (and (and (and (and (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields17) (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields16)) (= (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields17) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields16))) (and (and (and (forall ((temp___1406 Int)) (=> (and (<= 1 temp___1406) (<= temp___1406 17)) (=> (<= temp___1406 k5) (= (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields17))) temp___1406) (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields16))) temp___1406))))) (= (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields17))) (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields16))))) (= (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields17))) (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields16))))) (= (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields17))) (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields16)))))) (= (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields17) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields16))) (and (<= (+ j4 1) k5) (<= k5 r78b))))
