...
(assert (forall ((temp___2278 Int) (temp___2279 Int) (temp___2280 Int) (temp___2281 Int) (temp___2282 Int) (temp___2283 Int) (temp___2284 Int) (temp___2285 Int) (temp___2286 Int) (temp___2287 Int) (temp___2288 Int)) (let ((temp___2277 (aida__conversion__calculate_negative_target_length_10__int_array__aggregate_def temp___2278 temp___2279 temp___2280 temp___2281 temp___2282 temp___2283 temp___2284 temp___2285 temp___2286 temp___2287 temp___2288))) (=> (and (and (and (and (and (and (and (and (dynamic_invariant temp___2278 true true true true) (dynamic_invariant temp___2279 true true true true)) (dynamic_invariant temp___2280 true true true true)) (dynamic_invariant temp___2281 true true true true)) (dynamic_invariant temp___2282 true true true true)) (dynamic_invariant temp___2283 true true true true)) (dynamic_invariant temp___2284 true true true true)) (dynamic_invariant temp___2285 true true true true)) (dynamic_invariant temp___2286 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 9) temp___2287 temp___2288) (and (= (first5 temp___2277) temp___2287) (= (last5 temp___2277) temp___2288))) (and (and (and (and (and (and (and (and (= (to_rep1 (select (to_array2 temp___2277) (+ (+ (first1 source) 1) 0))) temp___2278) (= (to_rep1 (select (to_array2 temp___2277) (+ (+ (first1 source) 1) 1))) temp___2279)) (= (to_rep1 (select (to_array2 temp___2277) (+ (+ (first1 source) 1) 2))) temp___2280)) (= (to_rep1 (select (to_array2 temp___2277) (+ (+ (first1 source) 1) 3))) temp___2281)) (= (to_rep1 (select (to_array2 temp___2277) (+ (+ (first1 source) 1) 4))) temp___2282)) (= (to_rep1 (select (to_array2 temp___2277) (+ (+ (first1 source) 1) 5))) temp___2283)) (= (to_rep1 (select (to_array2 temp___2277) (+ (+ (first1 source) 1) 6))) temp___2284)) (= (to_rep1 (select (to_array2 temp___2277) (+ (+ (first1 source) 1) 7))) temp___2285)) (= (to_rep1 (select (to_array2 temp___2277) (+ (+ (first1 source) 1) 8))) temp___2286)))))))
(define-fun dynamic_invariant4 ((temp___expr_774 us_t3) (temp___is_init_770 Bool) (temp___skip_constant_771 Bool) (temp___do_toplevel_772 Bool) (temp___do_typ_inv_773 Bool)) Bool (=> (not (= temp___skip_constant_771 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 9) (first7 temp___expr_774) (last7 temp___expr_774)) (and (= (first7 temp___expr_774) (+ (first1 source) 1)) (= (last7 temp___expr_774) (+ (first1 source) 9))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2294 Int) (temp___2295 Int) (temp___2296 Int)) (let ((temp___2293 (aida__conversion__calculate_negative_target_length_10__n__aggregate_def temp___2294 temp___2295 temp___2296))) (=> (dynamic_invariant temp___2294 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 9) temp___2295 temp___2296) (and (= (first9 temp___2293) temp___2295) (= (last9 temp___2293) temp___2296))) (forall ((temp___2297 Int)) (= (to_rep1 (select (to_array4 temp___2293) temp___2297)) temp___2294)))))))
...
(declare-const temp___2299 (Array Int integer))
(declare-const temp___22991 t4)
...
(declare-const temp___2306 Int)
(declare-const temp___2304 Int)
(declare-const temp___2302 (Array Int integer))
(declare-const o Int)
...
(declare-const temp___2307 Int)
(declare-const o9 Int)
(declare-const o10 integer)
(declare-const o11 Int)
(declare-const o12 Int)
(declare-const o13 Int)
(declare-const temp___2308 Int)
...
(assert (and (= (length source) 10) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index7) (<= index7 (+ (to_rep1 (first (rt source))) 9))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2291 temp___22911) (aida__conversion__calculate_negative_target_length_10__int_array__aggregate_def 9 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 8))))
(assert (= (ite (<= (to_rep1 (first4 temp___22911)) (to_rep1 (last4 temp___22911))) (+ (- (to_rep1 (last4 temp___22911)) (to_rep1 (first4 temp___22911))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2291 (to_rep1 (first4 temp___22911)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_10__int_array__assume))
...
(assert (= (mk___t4 temp___2299 temp___22991) (aida__conversion__calculate_negative_target_length_10__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___22991)) (to_rep1 (last8 temp___22991))) (+ (- (to_rep1 (last8 temp___22991)) (to_rep1 (first8 temp___22991))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2299 (to_rep1 (first8 temp___22991)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_10__n__assume))
...
(assert (and (= temp___2305 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2306 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2305))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= temp___2304 index1)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= temp___2302 n1)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= o index1)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= o3 index1)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= o7 index1)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= n1 result3)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= n2 o8)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (and (and (forall ((temp___2303 Int)) (=> (and (<= (to_rep1 n__first) temp___2303) (<= temp___2303 (to_rep1 n__last))) (=> (< index2 temp___2303) (= (select n3 temp___2303) (select temp___2302 temp___2303))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= index2 temp___2306)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= index2 index3)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= n3 n4)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= index4 index2)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= n5 n3)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= index6 index4)))
(assert (=> (and (<= temp___2305 index1) (<= index1 temp___2306)) (= n7 n5)))
(assert (=> (not (and (<= temp___2305 index1) (<= index1 temp___2306))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2305 index1) (<= index1 temp___2306))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2305 index1) (<= index1 temp___2306))) (= index6 index1)))
(assert (=> (not (and (<= temp___2305 index1) (<= index1 temp___2306))) (= n7 n1)))
...
(assert (and (= temp___2307 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___2307) (<= temp___2307 (to_rep1 n__last))))
(assert (= o9 temp___2307))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2308 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2308) (<= temp___2308 (to_rep1 n__last))))
(assert (= o14 temp___2308))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___2309 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2309) (<= temp___2309 (to_rep1 n__last))))
(assert (= o21 temp___2309))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___2310 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2310) (<= temp___2310 (to_rep1 n__last))))
(assert (= o28 temp___2310))
...
(assert (= target4 o34))
(assert (<= (- 9999) target4))
(assert (and (= temp___2311 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2311) (<= temp___2311 (to_rep1 n__last))))
(assert (= o35 temp___2311))
...
(assert (and (= temp___2312 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2312) (<= temp___2312 (to_rep1 n__last))))
(assert (= o42 temp___2312))
...
(assert (and (= temp___2313 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2313) (<= temp___2313 (to_rep1 n__last))))
(assert (= o49 temp___2313))
