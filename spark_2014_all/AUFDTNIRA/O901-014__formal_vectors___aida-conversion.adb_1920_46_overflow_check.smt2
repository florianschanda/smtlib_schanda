...
(assert (forall ((temp___2294 Int) (temp___2295 Int) (temp___2296 Int)) (let ((temp___2293 (aida__conversion__calculate_negative_target_length_10__n__aggregate_def temp___2294 temp___2295 temp___2296))) (=> (dynamic_invariant temp___2294 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 9) temp___2295 temp___2296) (and (= (first9 temp___2293) temp___2295) (= (last9 temp___2293) temp___2296))) (forall ((temp___2297 Int)) (= (select (to_array4 temp___2293) temp___2297) rliteral1)))))))
...
(declare-const temp___2304 (Array Int integer))
(declare-const o Int)
...
(assert (and (= temp___2301 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2302 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2301))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= temp___2306 index1)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= temp___2304 n1)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= o index1)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= o3 index1)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= o7 index1)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= n1 result3)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= n2 o8)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (and (and (forall ((temp___2305 Int)) (=> (and (<= (to_rep1 n__first) temp___2305) (<= temp___2305 (to_rep1 n__last))) (=> (or (< temp___2302 temp___2305) (or (< temp___2305 temp___2301) (< index2 temp___2305))) (= (select n3 temp___2305) (select temp___2304 temp___2305))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= index2 temp___2302)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= index2 index3)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= n3 n4)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= index4 index2)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= n5 n3)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= index6 index4)))
(assert (=> (and (<= temp___2301 index1) (<= index1 temp___2302)) (= n7 n5)))
(assert (=> (not (and (<= temp___2301 index1) (<= index1 temp___2302))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2301 index1) (<= index1 temp___2302))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2301 index1) (<= index1 temp___2302))) (= index6 index1)))
(assert (=> (not (and (<= temp___2301 index1) (<= index1 temp___2302))) (= n7 n1)))
