...
(assert (and (= o51 (- length1 l2)) (in_range1 (- length1 l2))))
(assert (= o52 (ite (< i3 o51) true false)))
(assert (= result5 (ite (not (= o52 true)) true false)))
(assert (not (= result5 true)))
(assert (and (= o53 (- length1 l2)) (in_range1 (- length1 l2))))
(assert (= o54 (- o53 i3)))
