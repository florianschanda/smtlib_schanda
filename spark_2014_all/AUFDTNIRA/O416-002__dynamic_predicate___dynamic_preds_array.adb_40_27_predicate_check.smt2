...
(assert (forall ((temp___279 Int) (temp___280 Int)) (let ((temp___278 (dynamic_preds_array__init_even_pair__tmp__aggregate_def temp___279 temp___280))) (=> (and (dynamic_invariant1 temp___279 true true true true) (dynamic_invariant1 temp___280 true true true true)) (and (= (to_rep (select temp___278 1)) temp___279) (= (to_rep (select temp___278 2)) temp___280))))))
...
(assert (in_range a))
(assert (in_range b))
(assert (and (= temp___284 b) (in_range1 b)))
(assert (= (mod2 temp___284 2) 0))
(assert (= o temp___284))
(assert (and (= temp___282 a) (in_range1 a)))
