...
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1711)) (= (mk_int__ref index5) (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1711)) (= (mk_map__ref1 n6) (mk_map__ref1 n4))))
