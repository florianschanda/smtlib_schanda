...
(define-fun dynamic_invariant ((temp___expr_169 Int) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool) (temp___do_typ_inv_168 Bool)) Bool (=> (or (= temp___is_init_165 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_169)))
...
(define-fun bool_eq ((a (Array Int element_type)) (a__first Int) (a__last Int) (b (Array Int element_type)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep2 (select a temp___idx_154)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_182 us_rep) (temp___is_init_178 Bool) (temp___skip_constant_179 Bool) (temp___do_toplevel_180 Bool) (temp___do_typ_inv_181 Bool)) Bool (let ((temp___183 (rec__bounded_queue_v1__queue_type__max_size (us_split_discrs1 temp___expr_182)))) (and (dynamic_property1 1 (to_rep1 temp___183) (first1 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 temp___expr_182))) (last1 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 temp___expr_182)))) (and (= (first1 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 temp___expr_182))) 1) (= (last1 (rec__bounded_queue_v1__queue_type__items (us_split_fields1 temp___expr_182))) (to_rep1 temp___183))))))
...
(declare-const o7 t)
(declare-const temp___323 positive)
(declare-const temp___3231 natural)
(declare-const temp___3232 positive)
(declare-const temp___3233 positive)
(declare-const temp___3234 (Array Int element_type))
(declare-const temp___3235 t)
...
(declare-const o24 t)
(declare-const temp___329 positive)
(declare-const temp___3291 natural)
(declare-const temp___3292 positive)
(declare-const temp___3293 positive)
(declare-const temp___3294 (Array Int element_type))
(declare-const temp___3295 t)
...
(assert (= queue__split_discrs (mk___split_discrs temp___323)))
(assert (= temp___3231 o3))
(assert (= temp___3232 o4))
(assert (= temp___3233 o5))
(assert (= temp___3234 o6))
(assert (= temp___3235 o7))
...
(assert (= queue__split_fields5 (mk___split_fields temp___3231 temp___3232 temp___3233 (mk___t temp___3234 temp___3235))))
(assert (= queue__split_discrs (mk___split_discrs temp___323)))
...
(assert (= queue__split_fields6 (mk___split_fields temp___3271 temp___3272 temp___3273 (mk___t temp___3274 temp___3275))))
(assert (= queue__split_discrs (mk___split_discrs temp___327)))
...
(assert (= queue__split_discrs (mk___split_discrs temp___329)))
(assert (= temp___3291 o20))
(assert (= temp___3292 o21))
(assert (= temp___3293 o22))
(assert (= temp___3294 o23))
(assert (= temp___3295 o24))
(assert (= result2 (mk___split_fields__ref queue__split_fields6)))
(assert (= queue__split_fields7 (mk___split_fields temp___3291 temp___3292 temp___3293 (mk___t temp___3294 temp___3295))))
(assert (= queue__split_discrs (mk___split_discrs temp___329)))
