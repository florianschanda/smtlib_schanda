...
(assert (=> (and (<= 1 (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields1))) (<= (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields1)) (- (to_rep2 (rec__partition_refinement__interval__last p_elem__split_fields1)) (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields1))))) (forall ((k1 Int)) (=> (and (<= (+ j2 1) k1) (<= k1 (- (length (mk___rep p__split_discrs p__split_fields3)) 1))) (forall ((l Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) k1)))) l) (<= l (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) k1)))))) (= (to_rep3 (select (map__content f6) l)) k1)))))))
...
(assert (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs (us_split_fields__content p__split_fields4))) k)))) (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs (us_split_fields__content p__split_fields4))) k))))))
(assert (not (<= 0 (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs (us_split_fields__content p__split_fields4))) k)))))))
(check-sat)
(exit)
