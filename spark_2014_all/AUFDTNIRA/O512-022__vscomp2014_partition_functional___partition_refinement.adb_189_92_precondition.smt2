...
(assert (and (= o93 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o92)) (= (bool_eq o93 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o92)) true)))
(assert (= o94 (us_split_fields1 o93)))
(assert (= o95 (rec__partition_refinement__interval__last o94)))
(assert (= o96 (to_rep1 o95)))
(assert (= o97 (ite (<= k8 o96) true false)))
(assert (and (<= 0 k8) (<= k8 5)))
(assert (= o86 k8))
(assert (= o87 (select (map__content f8) o86)))
