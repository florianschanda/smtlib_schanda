...
(define-fun temp___18232 () us_t1 (mk___t1 temp___1823 temp___18231))
...
(assert (= (temp___String_Literal_1822 Tuple0) temp___1823))
(assert (= (mk1 1 6) temp___18231))
(assert (dynamic_predicate temp___18232))
(assert (= o5 temp___18232))
