...
(assert (= (temp___String_Literal_1648 Tuple0) temp___1649))
(assert (= (mk1 1 6) temp___16491))
(assert (dynamic_predicate (mk___t1 temp___1649 temp___16491)))
(assert (= (mk___t1 o o1) (mk___t1 temp___1649 temp___16491)))
