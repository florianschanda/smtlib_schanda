...
(declare-const total10 Int)
(declare-const it11 Int)
(declare-const pricing__price_of_basket__result4 Int)
(declare-const total11 Int)
(declare-const it12 Int)
...
(assert (=> (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk))))) (and (and (= temp___166 it2) (and (= temp___165 total1) (and (forall ((k1 Int)) (=> (and (<= (to_rep1 (first (rt bk))) k1) (<= k1 (- it3 1))) (<= (price_of_item (select (elts bk) k1)) total2))) (and (and (and (=> (<= 0 10000) (in_range3 total2)) (=> (<= (to_rep1 (first (rt bk))) (to_rep1 (last (rt bk)))) (dynamic_property1 (to_rep1 (first (rt bk))) (to_rep1 (last (rt bk))) it3))) (and (<= (to_rep1 (first (rt bk))) it3) (<= it3 (to_rep1 (last (rt bk)))))) (and (and (and (and (= o2 (price_of_item (select (elts bk) it3))) (and (in_range3 o2) (= o2 (mult (to_rep (rec__pricing__item__price (us_split_fields1 (select (elts bk) it3)))) (to_rep (rec__pricing__item__number (us_split_fields1 (select (elts bk) it3)))))))) (and (= o3 (add total2 o2)) (and (in_range3 o3) (ite (= (< (+ total2 o2) 10000) true) (= o3 (+ total2 o2)) (=> (= (>= (+ total2 o2) 10000) true) (= o3 10000)))))) (and (= total2 result3) (= total3 o3))) (= it3 (to_rep1 (last (rt bk))))))))) (and (and (= it3 it7) (= total3 total6)) (and (= it8 it3) (= total7 total3))))))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk))))) (= (mk_int__ref it9) (mk_int__ref it7))))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk))))) (= (mk_int__ref total8) (mk_int__ref total6))))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk))))) (= it10 it8)))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk))))) (= total9 total7)))
(assert (=> (not (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk)))))) (= it2 it9)))
(assert (=> (not (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk)))))) (= total1 total8)))
(assert (=> (not (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk)))))) (= it10 it2)))
(assert (=> (not (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk)))))) (= total9 total1)))
...
(assert (= (mk_int__ref result5) (mk_int__ref pricing__price_of_basket__result)))
(assert (= pricing__price_of_basket__result1 total8))
(assert (= (mk_int__ref pricing__price_of_basket__result4) (mk_int__ref pricing__price_of_basket__result2)))
(assert (= (mk_int__ref it11) (mk_int__ref it9)))
(assert (= (mk_int__ref total10) (mk_int__ref total8)))
(assert (= pricing__price_of_basket__result5 pricing__price_of_basket__result3))
(assert (= it12 it10))
(assert (= total11 total9))
