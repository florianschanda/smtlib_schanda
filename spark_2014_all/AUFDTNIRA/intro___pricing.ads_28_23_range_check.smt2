...
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= temp___194 it1)))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= temp___193 total1)))
...
(assert (not (<= (to_rep1 (last (rt bk))) 2147483647)))
(check-sat)
(exit)
