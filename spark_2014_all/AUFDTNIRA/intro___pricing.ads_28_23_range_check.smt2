...
(define-fun dynamic_invariant ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 10000)) (in_range3 temp___expr_136)))
(declare-fun add (Int Int) Int)
(declare-fun add__function_guard (Int Int Int) Bool)
(assert (forall ((x Int) (y Int)) (! (=> (and (dynamic_invariant x true true true) (dynamic_invariant y true true true)) (let ((result (add x y))) (and (ite (< (+ x y) 10000) (= result (+ x y)) (=> (<= 10000 (+ x y)) (= result 10000))) (dynamic_invariant result true false true)))) :pattern ((add x y)))))
...
(assert (forall ((it us_rep)) (! (let ((result (price_of_item it))) (and (= result (mult (to_rep (rec__pricing__item__price (us_split_fields1 it))) (to_rep (rec__pricing__item__number (us_split_fields1 it))))) (dynamic_invariant result true false true))) :pattern ((price_of_item it)))))
...
(define-fun dynamic_invariant1 ((temp___expr_150 us_t) (temp___is_init_147 Bool) (temp___skip_constant_148 Bool) (temp___do_toplevel_149 Bool)) Bool (=> (not (= temp___skip_constant_148 true)) (dynamic_property 1 2147483647 (first1 temp___expr_150) (last1 temp___expr_150))))
...
(assert (forall ((x Int) (y Int)) (! (=> (and (dynamic_invariant x true true true) (dynamic_invariant y true true true)) (let ((result (mult x y))) (and (ite (< (* x y) 10000) (= result (* x y)) (=> (<= 10000 (* x y)) (= result 10000))) (dynamic_invariant result true false true)))) :pattern ((mult x y)))))
...
(define-fun it9 () int__ref (mk_int__ref it5))
...
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= temp___166 it1)))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= temp___165 total1)))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (forall ((k Int)) (=> (and (<= (to_rep1 (first (rt bk))) k) (<= k (- it2 1))) (<= (price_of_item (select (elts bk) k)) total2)))))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (and (and (=> (<= 0 10000) (in_range3 total2)) (=> (<= (to_rep1 (first (rt bk))) (to_rep1 (last (rt bk)))) (dynamic_property1 (to_rep1 (first (rt bk))) (to_rep1 (last (rt bk))) it2))) (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk))))))))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (and (= o (price_of_item (select (elts bk) it2))) (and (in_range3 o) (= o (mult (to_rep (rec__pricing__item__price (us_split_fields1 (select (elts bk) it2)))) (to_rep (rec__pricing__item__number (us_split_fields1 (select (elts bk) it2))))))))))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (and (= o1 (add total2 o)) (and (in_range3 o1) (ite (= (< (+ total2 o) 10000) true) (= o1 (+ total2 o)) (=> (= (>= (+ total2 o) 10000) true) (= o1 10000)))))))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= total2 result2)))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= total3 o1)))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= it2 (to_rep1 (last (rt bk))))))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= it2 it3)))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= total3 total4)))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= it4 it2)))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= total5 total3)))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= it9 (mk_int__ref it3))))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= total10 (mk_int__ref total4))))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= it6 it4)))
(assert (=> (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk))))) (= total7 total5)))
(assert (=> (not (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk)))))) (= it1 it5)))
(assert (=> (not (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk)))))) (= total1 total6)))
(assert (=> (not (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk)))))) (= it6 it1)))
(assert (=> (not (and (<= (to_rep1 (first (rt bk))) it1) (<= it1 (to_rep1 (last (rt bk)))))) (= total7 total1)))
