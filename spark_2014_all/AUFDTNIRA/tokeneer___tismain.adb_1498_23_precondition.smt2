...
(assert (and (= o37 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o37 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3)))))))
(assert (= o38 (ite (not (= o37 true)) true false)))
(assert (and (= result21 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= result21 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3)))))))
