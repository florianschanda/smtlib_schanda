...
(assert (< (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024))
(assert (not (< (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024)))
(check-sat)
(exit)
