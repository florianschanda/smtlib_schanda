...
(declare-fun temp___245 (Bool Bool) (Array Int Bool))
...
(assert (forall ((temp___247 Bool) (temp___248 Bool)) (let ((temp___246 (temp___245 temp___247 temp___248))) (forall ((temp___249 Int)) (ite (= temp___249 1) (= (select temp___246 temp___249) temp___247) (= (select temp___246 temp___249) temp___248))))))
...
(assert (= result p))
(assert (= p1 (temp___245 (distinct 0 0) (distinct 1 0))))
(assert (= result1 i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 1000))
