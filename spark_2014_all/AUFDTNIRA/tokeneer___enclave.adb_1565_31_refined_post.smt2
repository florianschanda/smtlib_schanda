...
(define-fun dynamic_invariant ((temp___expr_446 Int) (temp___is_init_443 Bool) (temp___skip_constant_444 Bool) (temp___do_toplevel_445 Bool)) Bool (=> (or (= temp___is_init_443 true) (<= 0 1)) (in_range1 temp___expr_446)))
...
(assert (forall ((temp___1147 Int)) (forall ((temp___1148 Int)) (= (select (temp___1145 temp___1147) temp___1148) (of_rep temp___1147)))))
(declare-fun temp___1149 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1151 Int)) (forall ((temp___1152 Int)) (= (select (temp___1149 temp___1151) temp___1152) (of_rep3 temp___1151)))))
(define-fun dynamic_invariant1 ((temp___expr_1139 us_rep1) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool)) Bool (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1139))) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1139))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1139)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1139))) true))
(define-fun default_initial_assumption ((temp___expr_1143 us_rep1) (temp___skip_top_level_1144 Bool)) Bool (and (and (and (= (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1143))) 1) (= (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1143))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1143)) (mk___rep (mk___split_fields (temp___1145 1) (of_rep 1) (of_rep 1) (of_rep2 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1143)) (temp___1149 0))))
(define-fun type_invariant ((temp___1153 us_rep1)) Bool (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1153))) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1153))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1153)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1153))) true))
...
(define-fun bool_eq7 ((a (Array Int character)) (a__first Int) (a__last Int) (b (Array Int character)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_78 Int)) (=> (and (<= a__first temp___idx_78) (<= temp___idx_78 a__last)) (= (to_rep6 (select a temp___idx_78)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_78))))))) true false))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_78 Int)) (=> (and (<= a__first temp___idx_78) (<= temp___idx_78 a__last)) (= (to_rep6 (select a temp___idx_78)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_78)))))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_2612 Int) (temp___is_init_2609 Bool) (temp___skip_constant_2610 Bool) (temp___do_toplevel_2611 Bool)) Bool (=> (or (= temp___is_init_2609 true) (<= 0 8)) (in_range10 temp___expr_2612)))
...
(define-fun dynamic_invariant3 ((temp___expr_2698 Int) (temp___is_init_2695 Bool) (temp___skip_constant_2696 Bool) (temp___do_toplevel_2697 Bool)) Bool (=> (or (= temp___is_init_2695 true) (<= 0 2)) (in_range11 temp___expr_2698)))
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(define-fun dynamic_invariant4 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range8 temp___expr_63)))
(define-fun dynamic_invariant5 ((temp___expr_924 Int) (temp___is_init_921 Bool) (temp___skip_constant_922 Bool) (temp___do_toplevel_923 Bool)) Bool (=> (or (= temp___is_init_921 true) (<= 0 40)) (in_range7 temp___expr_924)))
(define-fun dynamic_invariant6 ((temp___expr_945 Int) (temp___is_init_942 Bool) (temp___skip_constant_943 Bool) (temp___do_toplevel_944 Bool)) Bool (=> (or (= temp___is_init_942 true) (<= 0 4294967295)) (in_range9 temp___expr_945)))
(define-fun dynamic_invariant7 ((temp___expr_1105 Int) (temp___is_init_1102 Bool) (temp___skip_constant_1103 Bool) (temp___do_toplevel_1104 Bool)) Bool (=> (or (= temp___is_init_1102 true) (<= 0 17)) (in_range4 temp___expr_1105)))
(define-fun dynamic_invariant8 ((temp___expr_1084 Int) (temp___is_init_1081 Bool) (temp___skip_constant_1082 Bool) (temp___do_toplevel_1083 Bool)) Bool (=> (or (= temp___is_init_1081 true) (<= 1 17)) (in_range2 temp___expr_1084)))
(define-fun dynamic_invariant9 ((temp___expr_1209 Int) (temp___is_init_1206 Bool) (temp___skip_constant_1207 Bool) (temp___do_toplevel_1208 Bool)) Bool (=> (or (= temp___is_init_1206 true) (<= 0 2)) (in_range6 temp___expr_1209)))
(define-fun dynamic_invariant10 ((temp___expr_1090 Int) (temp___is_init_1087 Bool) (temp___skip_constant_1088 Bool) (temp___do_toplevel_1089 Bool)) Bool (=> (or (= temp___is_init_1087 true) (<= 0 17408)) (in_range3 temp___expr_1090)))
(define-fun dynamic_invariant11 ((temp___expr_1124 Int) (temp___is_init_1121 Bool) (temp___skip_constant_1122 Bool) (temp___do_toplevel_1123 Bool)) Bool (=> (or (= temp___is_init_1121 true) (<= 0 1024)) (in_range5 temp___expr_1124)))
(assert true)
...
(assert (=> (= localstatus1 0) (and (in_range11 status1) (and (and (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true) (in_range1 auditalarm1)) (in_range10 status1)))))
...
(assert (=> (not (= localstatus1 0)) (=> (= localstatus1 1) (and (or (and (= status2 3) (= (privatekeypresent thistisinfo__split_fields5 state9) true)) (and (= status2 2) (not (= (privatekeypresent thistisinfo__split_fields5 state9) true)))) (and (and (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range1 auditalarm2)) (in_range10 status2))))))
(assert (=> (not (= localstatus1 0)) (=> (not (= localstatus1 1)) (and (or (= status3 2) (= status3 0)) (and (and (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range1 auditalarm3)) (in_range10 status3))))))
