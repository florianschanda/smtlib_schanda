...
(assert (not (in_range12 (+ (to_rep8 (rec__display__scrollstrt__len (us_split_fields__content4 result____split_fields24))) (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))))))
(check-sat)
(exit)
