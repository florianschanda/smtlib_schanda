...
(define-fun dynamic_invariant1 ((temp___expr_1218 Int) (temp___is_init_1214 Bool) (temp___skip_constant_1215 Bool) (temp___do_toplevel_1216 Bool) (temp___do_typ_inv_1217 Bool)) Bool (=> (or (= temp___is_init_1214 true) (<= 0 17408)) (in_range3 temp___expr_1218)))
...
(define-fun dynamic_invariant2 ((temp___expr_1204 Int) (temp___is_init_1200 Bool) (temp___skip_constant_1201 Bool) (temp___do_toplevel_1202 Bool) (temp___do_typ_inv_1203 Bool)) Bool (=> (or (= temp___is_init_1200 true) (<= 0 17)) (in_range temp___expr_1204)))
(define-fun dynamic_invariant3 ((temp___expr_1249 Int) (temp___is_init_1245 Bool) (temp___skip_constant_1246 Bool) (temp___do_toplevel_1247 Bool) (temp___do_typ_inv_1248 Bool)) Bool (=> (or (= temp___is_init_1245 true) (<= 0 1024)) (in_range4 temp___expr_1249)))
(declare-const o Int)
