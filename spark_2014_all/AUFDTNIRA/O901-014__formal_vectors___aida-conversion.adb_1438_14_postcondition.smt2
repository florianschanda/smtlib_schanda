...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (<= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 51)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 8))) 54)) (forall ((index9 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) index9) (<= index9 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index9))) true))))))
...
(assert (and (<= (to_rep1 n__first) temp___1989) (<= temp___1989 (to_rep1 n__last))))
(assert (= o21 temp___1989))
...
(assert (= target3 o27))
(assert (<= (- 599) target3))
(assert (and (= o28 (- target3 2147483000)) (in_range1 (- target3 2147483000))))
(assert (= result7 (mk_int__ref target3)))
(assert (= target4 o28))
(assert (<= (- 2147483599) target4))
