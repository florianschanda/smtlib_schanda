...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__aggregate_def 5 9 9 (+ (to_rep1 (first (rt source))) 8) (+ (+ (to_rep1 (first (rt source))) 8) 2))))) (+ (to_rep1 (first (rt source))) 8)) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__aggregate_def 5 9 9 (+ (to_rep1 (first (rt source))) 8) (+ (+ (to_rep1 (first (rt source))) 8) 2))))) (+ (+ (to_rep1 (first (rt source))) 8) 2)) (= (mk___t2 temp___1869 temp___18691) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__aggregate_def 5 9 9 (+ (to_rep1 (first (rt source))) 8) (+ (+ (to_rep1 (first (rt source))) 8) 2))))) (and (= (ite (<= (to_rep1 (first4 temp___18691)) (to_rep1 (last4 temp___18691))) (+ (- (to_rep1 (last4 temp___18691)) (to_rep1 (first4 temp___18691))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 8)) 1) 0)) (and (= (slide1 temp___1869 (to_rep1 (first4 temp___18691)) (+ (to_rep1 (first (rt source))) 8)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__assume) (= (mk1 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__int_array__assume1)))))) (and (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 8)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 8)) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)) (= (mk___t4 temp___1877 temp___18771) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10))))) (and (= (ite (<= (to_rep1 (first8 temp___18771)) (to_rep1 (last8 temp___18771))) (+ (- (to_rep1 (last8 temp___18771)) (to_rep1 (first8 temp___18771))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 8)) 1) 0)) (and (= (slide1 temp___1877 (to_rep1 (first8 temp___18771)) (+ (to_rep1 (first (rt source))) 8)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__assume) (= (mk3 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__assume1)))) (and (and (= (mk_map__ref1 result2) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_5xx__n__assume1)))))) (and (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 8)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))) (and (and (and (= temp___1883 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (= temp___1884 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))) (and (and (= (mk_int__ref result3) (mk_int__ref index)) (= index2 temp___1883)) (ite (and (<= temp___1883 index2) (<= index2 temp___1884)) (and (and (and (= temp___1882 index2) (and (= temp___1880 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o37 index2)) (= o38 (select n1 o37))) (= o39 (to_rep1 o38))) (= o39 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o40 index2)) (= o41 (select (elts source) o40))) (= o42 (to_rep o41))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o42))) (ite (= (= o42 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o42 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o42 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o42 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o42 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o42 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o42 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o42 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o42 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o42 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o43) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o44 index2)) (= o45 (store n1 o44 o43)))) (and (= n1 result4) (= n2 o45))))) (and (and (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 8) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (forall ((temp___1881 Int)) (=> (and (<= (to_rep1 n__first) temp___1881) (<= temp___1881 (to_rep1 n__last))) (=> (< index3 temp___1881) (= (select n3 temp___1881) (select temp___1880 temp___1881))))) (=> (<= (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 8) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10)))) (= index3 temp___1884)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1))))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (and (and (= temp___1885 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))) (and (and (<= (to_rep1 n__first) temp___1885) (<= temp___1885 (to_rep1 n__last))) (= o73 temp___1885))) (= o74 (select (map__content1 n7) o73))) (= o75 (to_rep1 o74))) (= o76 (- o75))) (and (= o77 o76) (in_range1 o76))) (and (= result9 (mk_int__ref target)) (= target1 o77))) (and (<= (- 9) target1) (and (and (and (and (and (and (and (and (and (and (= temp___1886 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (<= (to_rep1 n__first) temp___1886) (<= temp___1886 (to_rep1 n__last))) (= o78 temp___1886))) (= o79 (select (map__content1 n7) o78))) (= o80 (to_rep1 o79))) (= o81 (* o80 10))) (and (= o82 o81) (in_range1 o81))) (= o83 (- target1 o82))) (and (= o84 o83) (in_range1 o83))) (and (= result10 (mk_int__ref target1)) (= target2 o84))) (and (<= (- 99) target2) (and (and (and (and (and (and (and (and (and (and (= temp___1887 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (<= (to_rep1 n__first) temp___1887) (<= temp___1887 (to_rep1 n__last))) (= o85 temp___1887))) (= o86 (select (map__content1 n7) o85))) (= o87 (to_rep1 o86))) (= o88 (* o87 100))) (and (= o89 o88) (in_range1 o88))) (= o90 (- target2 o89))) (and (= o91 o90) (in_range1 o90))) (and (= result11 (mk_int__ref target2)) (= target3 o91))) (and (<= (- 599) target3) (and (and (and (= o92 (- target3 2147483000)) (in_range1 (- target3 2147483000))) (and (= result12 (mk_int__ref target3)) (= target4 o92))) (and (<= (- 2147483599) target4) (and (= result13 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target5 (mk_int__ref target4)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target6 target4))))))))
