...
(define-fun default_initial_assumption ((temp___expr_250 us_rep4) (temp___skip_top_level_251 Bool)) Bool (and (= (attr__tag4 temp___expr_250) us_tag4) (and (and (and (= (to_rep4 (rec__instr__clock__seconds (us_split_fields9 temp___expr_250))) 0) (= (to_rep4 (rec__instr__clock__minutes (us_split_fields9 temp___expr_250))) 0)) (= (to_rep5 (rec__instr__clock__hours (us_split_fields9 temp___expr_250))) 0)) (= (rec__instr__instrument__name4 (us_split_fields9 temp___expr_250)) (temp___String_Literal_163 Tuple0)))))
(declare-const x us_rep4)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun temp___String_Literal_354 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_354 us_void_param) 1)) 58) :pattern ((temp___String_Literal_354 us_void_param)))))
(declare-fun temp___String_Literal_355 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_355 us_void_param) 1)) 58) :pattern ((temp___String_Literal_355 us_void_param)))))
...
(define-fun default_initial_assumption5 ((temp___expr_272 us_rep4) (temp___skip_top_level_273 Bool)) Bool (and (= (attr__tag4 temp___expr_272) us_tag5) (and (and (and (= (rec__instr__instrument__name4 (us_split_fields9 temp___expr_272)) (temp___String_Literal_163 Tuple0)) (= (to_rep4 (rec__instr__clock__seconds (us_split_fields9 temp___expr_272))) 0)) (= (to_rep4 (rec__instr__clock__minutes (us_split_fields9 temp___expr_272))) 0)) (= (to_rep5 (rec__instr__clock__hours (us_split_fields9 temp___expr_272))) 0))))
(assert (not (not (= 10 0))))
(check-sat)
(exit)
