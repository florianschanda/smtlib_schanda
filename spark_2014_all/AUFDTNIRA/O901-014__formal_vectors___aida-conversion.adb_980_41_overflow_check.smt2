...
(assert (= o22 temp___1688))
(assert (= o23 (select n9 o22)))
...
(assert (= o25 temp___1689))
(assert (= o26 (select n9 o25)))
(assert (= o27 (to_rep1 o26)))
(assert (= o28 (* o27 10)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (= o30 (+ target1 o29)))
...
(assert (= o32 temp___1690))
(assert (= o33 (select n9 o32)))
(assert (= o34 (to_rep1 o33)))
(assert (= o35 (* o34 100)))
(assert (and (= o36 o35) (in_range1 o35)))
(assert (= o37 (+ target2 o36)))
