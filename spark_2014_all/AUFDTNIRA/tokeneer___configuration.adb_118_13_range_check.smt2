...
(assert (=> (= (length temp___1956) 0) (= configuration__updatedata__makedescription__str__assume (mk___t temp___1957 (mk (to_rep1 (first4 temp___19571)) (to_rep1 (last4 temp___19571)))))))
(assert (=> (not (= (length temp___1956) 0)) (=> (<= (to_rep1 (first4 temp___19571)) (to_rep1 (last4 temp___19571))) (= o138 (+ (- (to_rep1 (last4 temp___19571)) (to_rep1 (first4 temp___19571))) 1)))))
(assert (=> (not (= (length temp___1956) 0)) (=> (not (<= (to_rep1 (first4 temp___19571)) (to_rep1 (last4 temp___19571)))) (= o138 0))))
(assert (=> (not (= (length temp___1956) 0)) (=> (<= (to_rep1 (first (rt temp___1956))) (to_rep1 (last (rt temp___1956)))) (= o139 (+ (- (to_rep1 (last (rt temp___1956))) (to_rep1 (first (rt temp___1956)))) 1)))))
(assert (=> (not (= (length temp___1956) 0)) (=> (not (<= (to_rep1 (first (rt temp___1956))) (to_rep1 (last (rt temp___1956))))) (= o139 0))))
(assert (=> (not (= (length temp___1956) 0)) (= o140 (+ o139 o138))))
(assert (=> (not (= (length temp___1956) 0)) (= o141 (+ (to_rep1 (first (rt temp___1956))) o140))))
(assert (=> (not (= (length temp___1956) 0)) (= o142 (- o141 1))))
(assert (=> (not (= (length temp___1956) 0)) (and (= o143 o142) (in_range1 o142))))
(assert (=> (not (= (length temp___1956) 0)) (= configuration__updatedata__makedescription__str__assume (mk___t (concat1 (elts temp___1956) (to_rep1 (first (rt temp___1956))) (to_rep1 (last (rt temp___1956))) temp___1957 (to_rep1 (first4 temp___19571)) (to_rep1 (last4 temp___19571))) (mk (to_rep1 (first (rt temp___1956))) o143)))))
...
(assert (= temp___1959 (mk___t4 (slide str1 (to_rep1 str__first) 1) (mk4 1 (to_rep1 str__last)))))
