...
(assert (and (= o3 j1) (in_range8 j1)))
(assert (and (= (mk___rep (mk___split_fields o4 o5 o6)) (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) o3)) (= (bool_eq (mk___rep (mk___split_fields o4 o5 o6)) (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) o3)) true)))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o6 o9))
(assert (= o10 o7))
