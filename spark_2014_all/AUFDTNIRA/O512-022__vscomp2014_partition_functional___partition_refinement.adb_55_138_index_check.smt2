...
(define-fun o28 () us_rep (mk___rep (mk___split_fields o13 o14 o15)))
(define-fun o29 () us_rep (mk___rep (mk___split_fields o4 o5 o6)))
(assert (and (= o26 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o26) (= o26 (ite (= (distinct 1 0) true) (to_rep3 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o24 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o24) (<= o24 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
(assert (= o25 (* 2 o24)))
(assert (and (= o27 o25) (in_range1 o25)))
(assert (= result (ite (<= o27 o26) true false)))
(assert (= result true))
(assert (and (= o23 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o23) (<= o23 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
...
(assert (= result4 true))
(assert (and (= o12 j) (in_range8 j)))
(assert (and (= o28 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) o12)) (= (bool_eq o28 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) o12)) true)))
(assert (= o13 o16))
(assert (= o14 o17))
(assert (= o15 o18))
(assert (= o19 o17))
...
(assert (and (= o29 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) o3)) (= (bool_eq o29 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) o3)) true)))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o6 o9))
(assert (= o10 o7))
