...
(define-fun dynamic_invariant ((temp___expr_477 Int) (temp___is_init_474 Bool) (temp___skip_constant_475 Bool) (temp___do_toplevel_476 Bool)) Bool (=> (or (= temp___is_init_474 true) (<= 0 4294967295)) (in_range4 temp___expr_477)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant1 ((temp___expr_483 Int) (temp___is_init_480 Bool) (temp___skip_constant_481 Bool) (temp___do_toplevel_482 Bool)) Bool (=> (or (= temp___is_init_480 true) (<= 0 2)) (in_range5 temp___expr_483)))
...
(define-fun dynamic_invariant2 ((temp___expr_489 Int) (temp___is_init_486 Bool) (temp___skip_constant_487 Bool) (temp___do_toplevel_488 Bool)) Bool (=> (or (= temp___is_init_486 true) (<= 0 1)) (in_range6 temp___expr_489)))
...
(define-fun bool_eq3 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep6 (select a temp___idx_153)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_153))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep6 (select a temp___idx_153)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
...
(define-fun bool_eq5 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep9 (select a temp___idx_154)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep9 (select a temp___idx_154)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_154)))))))))))
...
(assert (forall ((temp___1139 Int)) (forall ((temp___1140 Int)) (= (select (temp___1137 temp___1139) temp___1140) (of_rep6 temp___1139)))))
(declare-fun temp___1141 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1143 Int)) (forall ((temp___1144 Int)) (= (select (temp___1141 temp___1143) temp___1144) (of_rep9 temp___1143)))))
(define-fun dynamic_invariant3 ((temp___expr_1131 us_rep2) (temp___is_init_1128 Bool) (temp___skip_constant_1129 Bool) (temp___do_toplevel_1130 Bool)) Bool (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1131))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1131))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1131)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1131))) true))
(define-fun default_initial_assumption ((temp___expr_1135 us_rep2) (temp___skip_top_level_1136 Bool)) Bool (and (and (and (= (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1135))) 1) (= (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1135))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1135)) (mk___rep1 (mk___split_fields1 (temp___1137 1) (of_rep6 1) (of_rep6 1) (of_rep8 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1135)) (temp___1141 0))))
(define-fun type_invariant ((temp___1145 us_rep2)) Bool (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1145))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1145))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1145)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1145))) true))
...
(define-fun bool_eq9 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep10 (select a temp___idx_156)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_156))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep10 (select a temp___idx_156)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_156)))))))))))
...
(assert (forall ((x namecountt)) (! (in_range17 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(declare-fun user_eq25 (issueridt issueridt) Bool)
(declare-const dummy25 issueridt)
...
(assert (forall ((x issueridt)) (! (in_range18 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(declare-fun to_rep14 (serialnumbert) Int)
(declare-fun of_rep14 (Int) serialnumbert)
(assert (forall ((x serialnumbert)) (! (= (of_rep14 (to_rep14 x)) x) :pattern ((to_rep14 x)))))
(assert (forall ((x serialnumbert)) (! (in_range20 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(define-fun bool_eq12 ((a us_rep6) (b us_rep6)) Bool (ite (and (= (bool_eq10 (rec__certtypes__idt__issuer (us_split_fields11 a)) (rec__certtypes__idt__issuer (us_split_fields11 b))) true) (= (to_rep14 (rec__certtypes__idt__serialnumber (us_split_fields11 a))) (to_rep14 (rec__certtypes__idt__serialnumber (us_split_fields11 b))))) true false))
...
(declare-fun to_rep15 (privileget) Int)
(declare-fun of_rep15 (Int) privileget)
(assert (forall ((x privileget)) (! (= (of_rep15 (to_rep15 x)) x) :pattern ((to_rep15 x)))))
(assert (forall ((x privileget)) (! (in_range21 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(assert (forall ((x classt)) (! (in_range22 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun us_rep___10__projection ((a us_rep7)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq13 ((a us_rep7) (b us_rep7)) Bool (ite (= (to_rep16 (rec__privtypes__clearancet__class (us_split_fields13 a))) (to_rep16 (rec__privtypes__clearancet__class (us_split_fields13 b)))) true false))
...
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__cert__attr__auth__contentst__id us_rep6) (rec__cert__attr__auth__contentst__notbefore us_rep) (rec__cert__attr__auth__contentst__notafter us_rep) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep6) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep7)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields14)) us_rep6 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields14)) us_rep (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields14)) us_rep (rec__cert__attr__auth__contentst__notafter a))
...
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields14)) us_rep6 (rec__cert__attr__auth__contentst__basecertid a))
(define-fun us_split_fields_Role__projection ((a us_split_fields14)) privileget (rec__cert__attr__auth__contentst__role a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields14)) us_rep7 (rec__cert__attr__auth__contentst__clearance a))
...
(define-fun us_rep___16__projection ((a us_rep8)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq14 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (and (and (= (bool_eq12 (rec__cert__attr__auth__contentst__id (us_split_fields15 a)) (rec__cert__attr__auth__contentst__id (us_split_fields15 b))) true) (= (bool_eq2 (rec__cert__attr__auth__contentst__notbefore (us_split_fields15 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq2 (rec__cert__attr__auth__contentst__notafter (us_split_fields15 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep13 (rec__cert__attr__auth__contentst__mechanism (us_split_fields15 a))) (to_rep13 (rec__cert__attr__auth__contentst__mechanism (us_split_fields15 b))))) (= (bool_eq12 (rec__cert__attr__auth__contentst__basecertid (us_split_fields15 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields15 b))) true)) (= (to_rep15 (rec__cert__attr__auth__contentst__role (us_split_fields15 a))) (to_rep15 (rec__cert__attr__auth__contentst__role (us_split_fields15 b))))) (= (bool_eq13 (rec__cert__attr__auth__contentst__clearance (us_split_fields15 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields15 b))) true)) true false))
...
(define-fun dynamic_invariant4 ((temp___expr_1035 Int) (temp___is_init_1032 Bool) (temp___skip_constant_1033 Bool) (temp___do_toplevel_1034 Bool)) Bool (=> (or (= temp___is_init_1032 true) (<= 0 3)) (in_range21 temp___expr_1035)))
(assert (forall ((contents us_rep8)) (! (dynamic_invariant4 (therole contents) true false true) :pattern ((therole contents)))))
(assert (forall ((contents us_rep8)) (! (= (therole contents) (to_rep15 (rec__cert__attr__auth__contentst__role (us_split_fields15 contents)))) :pattern ((therole contents)))))
...
(declare-fun user_eq35 (keyidt keyidt) Bool)
(declare-const dummy35 keyidt)
...
(declare-fun user_eq36 (keylengtht keylengtht) Bool)
(declare-const dummy36 keylengtht)
...
(declare-fun user_eq37 (us_rep9 us_rep9) Bool)
(declare-const dummy37 us_rep9)
...
(declare-datatypes () ((us_split_fields20 (mk___split_fields10 (rec__admintoken__validauthcertt__valid Bool) (rec__admintoken__validauthcertt__contents us_rep8)))))
(define-fun us_split_fields_Valid__projection ((a us_split_fields20)) Bool (rec__admintoken__validauthcertt__valid a))
(define-fun us_split_fields_Contents__projection ((a us_split_fields20)) us_rep8 (rec__admintoken__validauthcertt__contents a))
...
(define-fun bool_eq17 ((a us_rep11) (b us_rep11)) Bool (ite (and (= (rec__admintoken__validauthcertt__valid (us_split_fields21 a)) (rec__admintoken__validauthcertt__valid (us_split_fields21 b))) (= (bool_eq14 (rec__admintoken__validauthcertt__contents (us_split_fields21 a)) (rec__admintoken__validauthcertt__contents (us_split_fields21 b))) true)) true false))
...
(declare-fun theauthcertrole (us_split_fields20) Int)
(declare-fun theauthcertrole__function_guard (Int us_split_fields20) Bool)
(assert (forall ((admintoken__authcert__fields us_split_fields20)) (! (dynamic_invariant4 (theauthcertrole admintoken__authcert__fields) true false true) :pattern ((theauthcertrole admintoken__authcert__fields)))))
(assert (forall ((admintoken__authcert__fields us_split_fields20)) (! (= (theauthcertrole admintoken__authcert__fields) (therole (rec__admintoken__validauthcertt__contents (us_split_fields21 (mk___rep10 admintoken__authcert__fields))))) :pattern ((theauthcertrole admintoken__authcert__fields)))))
(declare-datatypes () ((us_split_fields22 (mk___split_fields11 (rec__admintoken__valididcertt__valid Bool) (rec__admintoken__valididcertt__contents us_rep10)))))
(define-fun us_split_fields_Valid__2__projection ((a us_split_fields22)) Bool (rec__admintoken__valididcertt__valid a))
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields22)) us_rep10 (rec__admintoken__valididcertt__contents a))
...
(define-fun bool_eq18 ((a us_rep12) (b us_rep12)) Bool (ite (and (= (rec__admintoken__valididcertt__valid (us_split_fields23 a)) (rec__admintoken__valididcertt__valid (us_split_fields23 b))) (= (bool_eq16 (rec__admintoken__valididcertt__contents (us_split_fields23 a)) (rec__admintoken__valididcertt__contents (us_split_fields23 b))) true)) true false))
...
(declare-fun isgood (us_split_fields22) Bool)
(declare-fun isgood__function_guard (Bool us_split_fields22) Bool)
(assert true)
(assert (forall ((admintoken__idcert__fields us_split_fields22)) (! (= (= (isgood admintoken__idcert__fields) true) (= (rec__admintoken__valididcertt__valid (us_split_fields23 (mk___rep11 admintoken__idcert__fields))) true)) :pattern ((isgood admintoken__idcert__fields)))))
(declare-fun authcertvalid (us_split_fields20) Bool)
(declare-fun authcertvalid__function_guard (Bool us_split_fields20) Bool)
(assert true)
(assert (forall ((admintoken__authcert__fields us_split_fields20)) (! (= (= (authcertvalid admintoken__authcert__fields) true) (= (rec__admintoken__validauthcertt__valid (us_split_fields21 (mk___rep10 admintoken__authcert__fields))) true)) :pattern ((authcertvalid admintoken__authcert__fields)))))
...
(declare-fun temp___String_Literal_1852 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1852 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_1852 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1852 us_void_param) 3)) 107)) (= (to_rep (select (temp___String_Literal_1852 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1852 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_1852 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_1852 us_void_param) 7)) 66)) (= (to_rep (select (temp___String_Literal_1852 us_void_param) 8)) 97)) (= (to_rep (select (temp___String_Literal_1852 us_void_param) 9)) 100)) :pattern ((temp___String_Literal_1852 us_void_param)))))
(declare-fun temp___String_Literal_1853 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1853 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 27)) 110)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 29)) 116)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 31)) 102)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 32)) 111)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 35)) 65)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 36)) 100)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 37)) 109)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 38)) 105)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 39)) 110)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 40)) 105)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 41)) 115)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 42)) 116)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 43)) 114)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 44)) 97)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 45)) 116)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 46)) 111)) (= (to_rep (select (temp___String_Literal_1853 us_void_param) 47)) 114)) :pattern ((temp___String_Literal_1853 us_void_param)))))
...
(define-fun dynamic_invariant9 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 40)) (in_range17 temp___expr_319)))
(define-fun dynamic_invariant10 ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 0 4294967295)) (in_range18 temp___expr_340)))
(define-fun dynamic_invariant11 ((temp___expr_362 Int) (temp___is_init_359 Bool) (temp___skip_constant_360 Bool) (temp___do_toplevel_361 Bool)) Bool (=> (or (= temp___is_init_359 true) (<= 0 10)) (in_range19 temp___expr_362)))
(define-fun dynamic_invariant12 ((temp___expr_374 Int) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool)) Bool (=> (or (= temp___is_init_371 true) (<= 0 4294967295)) (in_range23 temp___expr_374)))
(define-fun dynamic_invariant13 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 128)) (in_range24 temp___expr_380)))
(define-fun dynamic_invariant14 ((temp___expr_1097 Int) (temp___is_init_1094 Bool) (temp___skip_constant_1095 Bool) (temp___do_toplevel_1096 Bool)) Bool (=> (or (= temp___is_init_1094 true) (<= 0 17)) (in_range14 temp___expr_1097)))
(define-fun dynamic_invariant15 ((temp___expr_1076 Int) (temp___is_init_1073 Bool) (temp___skip_constant_1074 Bool) (temp___do_toplevel_1075 Bool)) Bool (=> (or (= temp___is_init_1073 true) (<= 1 17)) (in_range12 temp___expr_1076)))
(define-fun dynamic_invariant16 ((temp___expr_1201 Int) (temp___is_init_1198 Bool) (temp___skip_constant_1199 Bool) (temp___do_toplevel_1200 Bool)) Bool (=> (or (= temp___is_init_1198 true) (<= 0 2)) (in_range16 temp___expr_1201)))
(define-fun dynamic_invariant17 ((temp___expr_1082 Int) (temp___is_init_1079 Bool) (temp___skip_constant_1080 Bool) (temp___do_toplevel_1081 Bool)) Bool (=> (or (= temp___is_init_1079 true) (<= 0 17408)) (in_range13 temp___expr_1082)))
(define-fun dynamic_invariant18 ((temp___expr_1116 Int) (temp___is_init_1113 Bool) (temp___skip_constant_1114 Bool) (temp___do_toplevel_1115 Bool)) Bool (=> (or (= temp___is_init_1113 true) (<= 0 1024)) (in_range15 temp___expr_1116)))
(assert true)
...
(define-fun dynamic_invariant19 ((temp___expr_553 Int) (temp___is_init_550 Bool) (temp___skip_constant_551 Bool) (temp___do_toplevel_552 Bool)) Bool (=> (or (= temp___is_init_550 true) (<= 1901 2099)) (in_range7 temp___expr_553)))
(define-fun dynamic_invariant20 ((temp___expr_559 Int) (temp___is_init_556 Bool) (temp___skip_constant_557 Bool) (temp___do_toplevel_558 Bool)) Bool (=> (or (= temp___is_init_556 true) (<= 1 12)) (in_range8 temp___expr_559)))
(define-fun dynamic_invariant21 ((temp___expr_565 Int) (temp___is_init_562 Bool) (temp___skip_constant_563 Bool) (temp___do_toplevel_564 Bool)) Bool (=> (or (= temp___is_init_562 true) (<= 1 31)) (in_range9 temp___expr_565)))
(define-fun dynamic_invariant22 ((temp___expr_589 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 0 86399999)) (in_range10 temp___expr_589)))
(define-fun dynamic_invariant23 ((temp___expr_1041 Int) (temp___is_init_1038 Bool) (temp___skip_constant_1039 Bool) (temp___do_toplevel_1040 Bool)) Bool (=> (or (= temp___is_init_1038 true) (<= 1 3)) (in_range11 temp___expr_1041)))
(define-fun dynamic_invariant24 ((temp___expr_1047 Int) (temp___is_init_1044 Bool) (temp___skip_constant_1045 Bool) (temp___do_toplevel_1046 Bool)) Bool (=> (or (= temp___is_init_1044 true) (<= 0 5)) (in_range22 temp___expr_1047)))
(define-fun dynamic_invariant25 ((temp___expr_453 Int) (temp___is_init_450 Bool) (temp___skip_constant_451 Bool) (temp___do_toplevel_452 Bool)) Bool (=> (or (= temp___is_init_450 true) (<= 0 4294967295)) (in_range20 temp___expr_453)))
...
(declare-const authcertcontents__split_fields us_split_fields__ref7)
(declare-const idcertcontents__split_fields us_split_fields__ref9)
...
(declare-const authcertcontents__split_fields1 us_split_fields14)
(declare-const idcertcontents__split_fields1 us_split_fields18)
...
(declare-const idcertcontents__split_fields2 us_split_fields18)
...
(declare-const authcertcontents__split_fields2 us_split_fields14)
...
(declare-const result12 us_split_fields__ref11)
(declare-const idcert__split_fields1 us_split_fields22)
(declare-const result13 us_split_fields__ref10)
...
(declare-const idcert__split_fields2 us_split_fields__ref11)
(declare-const authvalid3 bool__ref)
(declare-const idvalid3 bool__ref)
(declare-const roleok5 bool__ref)
(declare-const authcertcontents__split_fields3 us_split_fields__ref7)
(declare-const idcertcontents__split_fields3 us_split_fields__ref9)
...
(declare-const idcert__split_fields3 us_split_fields22)
(declare-const authvalid4 Bool)
(declare-const idvalid4 Bool)
(declare-const roleok6 Bool)
(declare-const authcertcontents__split_fields4 us_split_fields14)
(declare-const idcertcontents__split_fields4 us_split_fields18)
...
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (and (= o2 (therole (mk___rep7 (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields2)))) (and (in_range21 o2) (= o2 (to_rep15 (rec__cert__attr__auth__contentst__role (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields2)))))))))
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (= result2 (ite (in_range11 o2) true false)))))
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (=> (= result2 true) (= result3 (mk_bool__ref roleok))))))
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (=> (= result2 true) (= roleok1 (of_int 1))))))
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (=> (= result2 true) (= description2 description1)))))
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (=> (not (= result2 true)) (= o3 (makedescription (mk___t (temp___String_Literal_1853 Tuple0) (mk 1 47))))))))
...
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (=> (not (= result2 true)) (= result5 (mk_bool__ref roleok))))))
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (=> (not (= result2 true)) (= roleok2 (of_int 0))))))
(assert (=> (= tokentry1 2) (=> (= (ite (= idvalid1 true) authvalid1 false) true) (=> (not (= result2 true)) (= roleok1 roleok2)))))
(assert (=> (= tokentry1 2) (=> (not (= (ite (= idvalid1 true) authvalid1 false) true)) (= result6 (mk_bool__ref roleok)))))
(assert (=> (= tokentry1 2) (=> (not (= (ite (= idvalid1 true) authvalid1 false) true)) (= roleok3 (of_int 0)))))
...
(assert (=> (not (= tokentry1 2)) (= authvalid2 (of_int 0))))
(assert (=> (not (= tokentry1 2)) (= result8 (mk_bool__ref idvalid))))
(assert (=> (not (= tokentry1 2)) (= idvalid2 (of_int 0))))
(assert (=> (not (= tokentry1 2)) (= result9 (mk_bool__ref roleok))))
(assert (=> (not (= tokentry1 2)) (= roleok4 (of_int 0))))
(assert (=> (not (= tokentry1 2)) (= o4 (makedescription (mk___t (temp___String_Literal_1852 Tuple0) (mk 1 9))))))
...
(assert (=> (not (= tokentry1 2)) (= (let ((subject idcertcontents__split_fields)) (mk___split_fields__ref9 idcertcontents__split_fields2)) (let ((subject idcertcontents__split_fields)) (mk___split_fields__ref9 idcertcontents__split_fields1)))))
(assert (=> (not (= tokentry1 2)) (= (let ((subject authcertcontents__split_fields)) (mk___split_fields__ref7 authcertcontents__split_fields2)) (let ((subject authcertcontents__split_fields)) (mk___split_fields__ref7 authcertcontents__split_fields1)))))
...
(assert (=> (not (= tokentry1 2)) (= logfilestate__split_fields9 (mk___split_fields2 logfilestate__split_fields logfilestate__split_fields1 (mk___rep1 (mk___split_fields1 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))))
...
(assert (= (let ((subject idcert__split_fields)) idcert__split_fields1) (mk___split_fields11 idvalid1 (mk___rep9 (let ((subject idcertcontents__split_fields)) idcertcontents__split_fields2)))))
(assert (= result13 authcert__split_fields))
(assert (= (let ((subject authcert__split_fields)) authcert__split_fields1) (mk___split_fields10 authvalid1 (mk___rep7 (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields2)))))
...
(assert (= idcertcontents__split_fields3 (let ((subject idcertcontents__split_fields)) (mk___split_fields__ref9 idcertcontents__split_fields2))))
(assert (= authcertcontents__split_fields3 (let ((subject authcertcontents__split_fields)) (mk___split_fields__ref7 authcertcontents__split_fields2))))
(assert (= roleok5 (mk_bool__ref roleok1)))
(assert (= idvalid3 (mk_bool__ref idvalid1)))
(assert (= authvalid3 (mk_bool__ref authvalid1)))
(assert (= idcert__split_fields2 (let ((subject idcert__split_fields)) (mk___split_fields__ref11 idcert__split_fields1))))
...
(assert (not (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields2)) true)))
(check-sat)
(exit)
