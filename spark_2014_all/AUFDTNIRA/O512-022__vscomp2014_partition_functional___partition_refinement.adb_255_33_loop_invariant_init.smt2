...
(assert (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields1)) c) true))
(assert (not (= (to_rep (select a1 (element1 (mk___rep3 d__split_discrs d__split_fields1) c))) (key (mk___rep3 d__split_discrs d__split_fields1) c))))
(check-sat)
(exit)
