...
(assert (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields))) 1))
(assert (not (= (isgood tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content7 authcert__split_fields) (us_split_fields__content10 idcert__split_fields)) true)))
(check-sat)
(exit)
