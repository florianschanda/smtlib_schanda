...
(assert (not (in_range7 (* (to_rep3 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields11))))) 1024))))
(check-sat)
(exit)
