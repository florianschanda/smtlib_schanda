...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__keystore__optionalprivatekeyt__ispresent Bool) (rec__keystore__optionalprivatekeyt__owner us_rep1)))))
(define-fun us_split_fields_IsPresent__projection ((a us_split_fields2)) Bool (rec__keystore__optionalprivatekeyt__ispresent a))
(define-fun us_split_fields_Owner__projection ((a us_split_fields2)) us_rep1 (rec__keystore__optionalprivatekeyt__owner a))
...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields3 a)) (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields3 b))) (= (bool_eq3 (rec__keystore__optionalprivatekeyt__owner (us_split_fields3 a)) (rec__keystore__optionalprivatekeyt__owner (us_split_fields3 b))) true)) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_350 us_t) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool) (temp___do_typ_inv_349 Bool)) Bool (and (=> (not (= temp___skip_constant_347 true)) (dynamic_property 1 2147483647 (first1 temp___expr_350) (last1 temp___expr_350))) (=> (= temp___do_toplevel_348 true) (=> (= temp___is_init_346 true) (and (let ((temp___352 (of_array1 (to_array temp___expr_350) (first1 temp___expr_350) (last1 temp___expr_350)))) (and (= (first3 temp___352) 1) (<= 0 (last3 temp___352)))) (<= (last1 temp___expr_350) 1000))))))
...
(assert (forall ((x logfileindext)) (! (in_range7 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range8 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range9 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(define-fun bool_eq7 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep5 (select a temp___idx_172)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_172))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep5 (select a temp___idx_172)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(define-fun bool_eq8 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (bool_eq7 (rec__auditlog__logfilelistt__list (us_split_fields5 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields5 b)) 1 17) true) (= (to_rep5 (rec__auditlog__logfilelistt__head (us_split_fields5 a))) (to_rep5 (rec__auditlog__logfilelistt__head (us_split_fields5 b))))) (= (to_rep5 (rec__auditlog__logfilelistt__lasti (us_split_fields5 a))) (to_rep5 (rec__auditlog__logfilelistt__lasti (us_split_fields5 b))))) (= (to_rep7 (rec__auditlog__logfilelistt__length (us_split_fields5 a))) (to_rep7 (rec__auditlog__logfilelistt__length (us_split_fields5 b))))) true false))
...
(assert (forall ((x fileentrycountt)) (! (in_range10 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(define-fun bool_eq9 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep8 (select a temp___idx_173)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_173))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep8 (select a temp___idx_173)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(define-fun bool_eq10 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 a))) (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 b)))) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 a))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 b))))) (= (bool_eq8 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 b))) true)) (= (bool_eq9 (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 b)) 1 17) true)) true false))
...
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq2 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 0 1)) (in_range11 temp___expr_200)))
...
(declare-fun temp_____aggregate_def_1238 (Int) (Array Int logfileindext))
(declare-fun temp_____aggregate_def_1242 (Int) (Array Int fileentrycountt))
(define-fun dynamic_invariant3 ((temp___expr_1232 us_rep4) (temp___is_init_1228 Bool) (temp___skip_constant_1229 Bool) (temp___do_toplevel_1230 Bool) (temp___do_typ_inv_1231 Bool)) Bool (=> (= temp___do_typ_inv_1231 true) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1232))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1232))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1232)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1232))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1236 us_rep4) (temp___skip_top_level_1237 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1236))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1236))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1236)) (mk___rep2 (mk___split_fields2 (temp_____aggregate_def_1238 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1236)) (temp_____aggregate_def_1242 0))))
(define-fun type_invariant ((temp___1246 us_rep4)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1246))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1246))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1246)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1246))) true))
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-fun temp___String_Literal_1735 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1735 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 2)) 104)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 8)) 111)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 9)) 108)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 10)) 109)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 12)) 110)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 15)) 102)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 16)) 105)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 17)) 108)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 18)) 101)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 20)) 105)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 21)) 115)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 23)) 99)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 25)) 114)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 27)) 117)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 28)) 112)) (= (to_rep (select (temp___String_Literal_1735 us_void_param) 29)) 116)) :pattern ((temp___String_Literal_1735 us_void_param)))))
(declare-fun temp___String_Literal_1747 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1747 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 2)) 104)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 8)) 111)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 9)) 108)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 10)) 109)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 12)) 110)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 15)) 102)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 16)) 105)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 17)) 108)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 18)) 101)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 20)) 105)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 21)) 115)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 23)) 99)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 25)) 114)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 27)) 117)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 28)) 112)) (= (to_rep (select (temp___String_Literal_1747 us_void_param) 29)) 116)) :pattern ((temp___String_Literal_1747 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1170 Int) (temp___is_init_1166 Bool) (temp___skip_constant_1167 Bool) (temp___do_toplevel_1168 Bool) (temp___do_typ_inv_1169 Bool)) Bool (=> (or (= temp___is_init_1166 true) (<= 0 17)) (in_range9 temp___expr_1170)))
(define-fun dynamic_invariant8 ((temp___expr_1177 Int) (temp___is_init_1173 Bool) (temp___skip_constant_1174 Bool) (temp___do_toplevel_1175 Bool) (temp___do_typ_inv_1176 Bool)) Bool (=> (or (= temp___is_init_1173 true) (<= 1 17)) (in_range7 temp___expr_1177)))
(define-fun dynamic_invariant9 ((temp___expr_1303 Int) (temp___is_init_1299 Bool) (temp___skip_constant_1300 Bool) (temp___do_toplevel_1301 Bool) (temp___do_typ_inv_1302 Bool)) Bool (=> (or (= temp___is_init_1299 true) (<= 0 2)) (in_range6 temp___expr_1303)))
(define-fun dynamic_invariant10 ((temp___expr_1184 Int) (temp___is_init_1180 Bool) (temp___skip_constant_1181 Bool) (temp___do_toplevel_1182 Bool) (temp___do_typ_inv_1183 Bool)) Bool (=> (or (= temp___is_init_1180 true) (<= 0 17408)) (in_range8 temp___expr_1184)))
(define-fun dynamic_invariant11 ((temp___expr_1215 Int) (temp___is_init_1211 Bool) (temp___skip_constant_1212 Bool) (temp___do_toplevel_1213 Bool) (temp___do_typ_inv_1214 Bool)) Bool (=> (or (= temp___is_init_1211 true) (<= 0 1024)) (in_range10 temp___expr_1215)))
(assert true)
...
(assert (forall ((temp___1244 Int)) (=> (dynamic_invariant11 temp___1244 true true true true) (forall ((temp___1245 Int)) (= (select (temp_____aggregate_def_1242 temp___1244) temp___1245) rliteral2)))))
(define-fun dynamic_invariant12 ((temp___expr_953 Int) (temp___is_init_949 Bool) (temp___skip_constant_950 Bool) (temp___do_toplevel_951 Bool) (temp___do_typ_inv_952 Bool)) Bool (=> (or (= temp___is_init_949 true) (<= 0 40)) (in_range4 temp___expr_953)))
(define-fun dynamic_invariant13 ((temp___expr_977 Int) (temp___is_init_973 Bool) (temp___skip_constant_974 Bool) (temp___do_toplevel_975 Bool) (temp___do_typ_inv_976 Bool)) Bool (=> (or (= temp___is_init_973 true) (<= 0 4294967295)) (in_range5 temp___expr_977)))
(assert (forall ((temp___1240 Int)) (=> (dynamic_invariant8 temp___1240 true true true true) (forall ((temp___1241 Int)) (= (select (temp_____aggregate_def_1238 temp___1240) temp___1241) rliteral)))))
...
(declare-const temp___1736 us_t)
(declare-const o us_t)
(declare-const o1 (Array Int character))
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const o4 Bool)
(declare-const temp___1746 (Array Int us_rep))
(declare-const temp___1745 Int)
(declare-const temp___1744 Int)
(declare-const temp___1743 us_rep4)
(declare-const temp___1742 (Array Int character))
(declare-const temp___1740 (Array Int filestatust))
(declare-const temp___1741 Bool)
(declare-const temp___1739 us_rep2)
(declare-const temp___1738 Bool)
(declare-const temp___1737 us_rep)
...
(declare-const thistisinfo__split_fields7 us_split_fields2)
...
(declare-const thistisinfo__split_fields8 us_split_fields2)
...
(declare-const thistisinfo__split_fields9 us_split_fields__ref1)
...
(declare-const thistisinfo__split_fields10 us_split_fields2)
...
(declare-const thistisinfo__split_fields11 us_split_fields__ref1)
...
(declare-const thistisinfo__split_fields12 us_split_fields2)
...
(assert (not (= (privatekeypresent (mk___split_fields1 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) state1) true)))
(assert (= result (mk_int__ref certno)))
(assert (= certno1 1))
(assert (in_range2 certno1))
(assert (=> (= dataok true) (and (and (=> (and (= (distinct 0 0) true) (= dataok1 true)) (= (privatekeypresent thistisinfo__split_fields5 state5) true)) (=> (not (and (= (distinct 0 0) true) (= dataok1 true))) (= (= (privatekeypresent thistisinfo__split_fields5 state5) true) (= (privatekeypresent (mk___split_fields1 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) state1) true)))) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range11 auditalarm2)))))
(assert (=> (not (= dataok true)) (dynamic_property 1 2147483647 1 29)))
(assert (=> (not (= dataok true)) (= temp___1736 (mk___t (temp___String_Literal_1735 Tuple0) (mk 1 29)))))
(assert (=> (not (= dataok true)) (dynamic_predicate temp___1736)))
(assert (=> (not (= dataok true)) (= o temp___1736)))
...
(assert (=> (not (= dataok true)) (= thistisinfo__split_fields5 (mk___split_fields1 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))))))
(assert (=> (not (= dataok true)) (= auditsystemfault2 auditsystemfault)))
(assert (=> (not (= dataok true)) (= auditalarm2 auditalarm)))
(assert (=> (not (= dataok true)) (= logfilestate__split_fields8 (mk___split_fields3 logfilestate__split_fields logfilestate__split_fields1 (mk___rep2 (mk___split_fields2 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))))
...
(assert (=> (= dataok1 true) (and (and (=> (and (= (distinct 1 0) true) (= dataok2 true)) (= (privatekeypresent thistisinfo__split_fields6 state7) true)) (=> (not (and (= (distinct 1 0) true) (= dataok2 true))) (= (= (privatekeypresent thistisinfo__split_fields6 state7) true) (= (privatekeypresent thistisinfo__split_fields5 state5) true)))) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range11 auditalarm3)))))
...
(assert (=> (= result3 true) (= temp___1746 logfiles3)))
(assert (=> (= result3 true) (= temp___1745 auditalarm3)))
(assert (=> (= result3 true) (= temp___1744 certno2)))
(assert (=> (= result3 true) (= temp___1743 (mk___rep3 logfilestate__split_fields9))))
(assert (=> (= result3 true) (= temp___1742 description3)))
(assert (=> (= result3 true) (= temp___1740 logfilesstatus3)))
(assert (=> (= result3 true) (= temp___1741 dataok2)))
(assert (=> (= result3 true) (= temp___1739 (mk___rep1 thistisinfo__split_fields6))))
(assert (=> (= result3 true) (= temp___1738 auditsystemfault3)))
(assert (=> (= result3 true) (= temp___1737 thefile2)))
(assert (=> (= result3 true) (= (privatekeypresent thistisinfo__split_fields7 state9) true)))
(assert (=> (= result3 true) (<= 2 certno3)))
(assert (=> (= result3 true) (and (and (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true) (=> (<= 1 2147483647) (in_range2 certno3))) (in_range11 auditalarm4)) (and (not (= (endoffile thefile3) true)) (= dataok3 true)))))
(assert (=> (= result3 true) (= o5 (endofline thefile3))))
(assert (=> (= result3 true) (= result4 (ite (not (= o5 true)) true false))))
(assert (=> (= result3 true) (=> (= result4 true) (and (= o6 (+ certno3 1)) (in_range1 (+ certno3 1))))))
(assert (=> (= result3 true) (=> (= result4 true) (= result5 (mk_int__ref certno3)))))
(assert (=> (= result3 true) (=> (= result4 true) (= certno4 o6))))
(assert (=> (= result3 true) (=> (= result4 true) (and (and (=> (and (= (distinct 0 0) true) (= dataok4 true)) (= (privatekeypresent thistisinfo__split_fields8 state11) true)) (=> (not (and (= (distinct 0 0) true) (= dataok4 true))) (= (= (privatekeypresent thistisinfo__split_fields8 state11) true) (= (privatekeypresent thistisinfo__split_fields7 state9) true)))) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true) (in_range11 auditalarm5))))))
...
(assert (=> (= result3 true) (=> (not (= result4 true)) (= thistisinfo__split_fields8 thistisinfo__split_fields7))))
(assert (=> (= result3 true) (=> (not (= result4 true)) (= auditsystemfault5 auditsystemfault4))))
(assert (=> (= result3 true) (=> (not (= result4 true)) (= auditalarm5 auditalarm4))))
(assert (=> (= result3 true) (=> (not (= result4 true)) (= logfilestate__split_fields11 logfilestate__split_fields10))))
(assert (=> (= result3 true) (=> (not (= result4 true)) (= logfilesstatus5 logfilesstatus4))))
(assert (=> (= result3 true) (=> (not (= result4 true)) (= logfiles5 logfiles4))))
(assert (=> (= result3 true) (= o7 (endoffile thefile4))))
(assert (=> (= result3 true) (= o8 (ite (not (= o7 true)) true false))))
(assert (=> (= result3 true) (= o9 (ite (= o8 true) dataok4 false))))
(assert (=> (= result3 true) (= result6 (ite (not (= o9 true)) true false))))
...
(assert (=> (= result3 true) (= thistisinfo__split_fields9 (mk___split_fields__ref1 thistisinfo__split_fields8))))
(assert (=> (= result3 true) (= auditsystemfault6 (mk_bool__ref auditsystemfault5))))
(assert (=> (= result3 true) (= auditalarm6 (mk_int__ref auditalarm5))))
(assert (=> (= result3 true) (= logfilestate__split_fields12 (mk___split_fields__ref3 logfilestate__split_fields11))))
(assert (=> (= result3 true) (= logfilesstatus6 (mk_map__ref1 logfilesstatus5))))
(assert (=> (= result3 true) (= logfiles6 (mk_map__ref4 logfiles5))))
...
(assert (=> (= result3 true) (= thistisinfo__split_fields10 thistisinfo__split_fields8)))
(assert (=> (= result3 true) (= auditsystemfault7 auditsystemfault5)))
(assert (=> (= result3 true) (= auditalarm7 auditalarm5)))
(assert (=> (= result3 true) (= logfilestate__split_fields13 logfilestate__split_fields11)))
(assert (=> (= result3 true) (= logfilesstatus7 logfilesstatus5)))
(assert (=> (= result3 true) (= logfiles7 logfiles5)))
...
(assert (=> (= result3 true) (= thistisinfo__split_fields11 thistisinfo__split_fields9)))
(assert (=> (= result3 true) (= auditsystemfault8 auditsystemfault6)))
(assert (=> (= result3 true) (= auditalarm8 auditalarm6)))
(assert (=> (= result3 true) (= logfilestate__split_fields14 logfilestate__split_fields12)))
(assert (=> (= result3 true) (= logfilesstatus8 logfilesstatus6)))
(assert (=> (= result3 true) (= logfiles8 logfiles6)))
...
(assert (=> (= result3 true) (= thistisinfo__split_fields12 thistisinfo__split_fields10)))
(assert (=> (= result3 true) (= auditsystemfault9 auditsystemfault7)))
(assert (=> (= result3 true) (= auditalarm9 auditalarm7)))
(assert (=> (= result3 true) (= logfilestate__split_fields15 logfilestate__split_fields13)))
(assert (=> (= result3 true) (= logfilesstatus9 logfilesstatus7)))
(assert (=> (= result3 true) (= logfiles9 logfiles7)))
...
(assert (=> (not (= result3 true)) (= thistisinfo__split_fields11 (mk___split_fields__ref1 thistisinfo__split_fields6))))
(assert (=> (not (= result3 true)) (= auditsystemfault8 (mk_bool__ref auditsystemfault3))))
(assert (=> (not (= result3 true)) (= auditalarm8 (mk_int__ref auditalarm3))))
(assert (=> (not (= result3 true)) (= logfilestate__split_fields14 (mk___split_fields__ref3 logfilestate__split_fields9))))
(assert (=> (not (= result3 true)) (= logfilesstatus8 (mk_map__ref1 logfilesstatus3))))
(assert (=> (not (= result3 true)) (= logfiles8 (mk_map__ref4 logfiles3))))
...
(assert (=> (not (= result3 true)) (= thistisinfo__split_fields12 thistisinfo__split_fields6)))
(assert (=> (not (= result3 true)) (= auditsystemfault9 auditsystemfault3)))
(assert (=> (not (= result3 true)) (= auditalarm9 auditalarm3)))
(assert (=> (not (= result3 true)) (= logfilestate__split_fields15 logfilestate__split_fields9)))
(assert (=> (not (= result3 true)) (= logfilesstatus9 logfilesstatus3)))
(assert (=> (not (= result3 true)) (= logfiles9 logfiles3)))
(assert (not (= closedok true)))
(assert (not (dynamic_property 1 2147483647 1 29)))
(check-sat)
(exit)
