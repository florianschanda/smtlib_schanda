...
(define-fun dynamic_invariant1 ((temp___expr_177 Int) (temp___is_init_174 Bool) (temp___skip_constant_175 Bool) (temp___do_toplevel_176 Bool)) Bool (=> (or (= temp___is_init_174 true) (<= 0 1)) (in_range3 temp___expr_177)))
...
(define-fun dynamic_invariant2 ((temp___expr_310 us_t) (temp___is_init_307 Bool) (temp___skip_constant_308 Bool) (temp___do_toplevel_309 Bool)) Bool (and (=> (not (= temp___skip_constant_308 true)) (dynamic_property 1 2147483647 (first1 temp___expr_310) (last1 temp___expr_310))) (=> (= temp___do_toplevel_309 true) (=> (= temp___is_init_307 true) (and (let ((temp___312 (of_array1 (to_array temp___expr_310) (first1 temp___expr_310) (last1 temp___expr_310)))) (and (= (first3 temp___312) 1) (<= 0 (last3 temp___312)))) (<= (last1 temp___expr_310) 1000))))))
(define-fun dynamic_predicate ((temp___314 us_t)) Bool (and (let ((temp___316 (of_array1 (to_array temp___314) (first1 temp___314) (last1 temp___314)))) (and (= (first3 temp___316) 1) (<= 0 (last3 temp___316)))) (<= (last1 temp___314) 1000)))
...
(assert (forall ((temp___1108 Int)) (forall ((temp___1109 Int)) (= (select (temp___1106 temp___1108) temp___1109) (of_rep2 temp___1108)))))
(declare-fun temp___1110 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1112 Int)) (forall ((temp___1113 Int)) (= (select (temp___1110 temp___1112) temp___1113) (of_rep5 temp___1112)))))
(define-fun dynamic_invariant3 ((temp___expr_1100 us_rep2) (temp___is_init_1097 Bool) (temp___skip_constant_1098 Bool) (temp___do_toplevel_1099 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1100))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1100))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1100)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1100))) true))
(define-fun default_initial_assumption ((temp___expr_1104 us_rep2) (temp___skip_top_level_1105 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1104))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1104))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1104)) (mk___rep (mk___split_fields (temp___1106 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1104)) (temp___1110 0))))
(define-fun type_invariant ((temp___1114 us_rep2)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1114))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1114))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1114)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1114))) true))
...
(assert true)
(declare-fun temp___String_Literal_1578 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1578 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 2)) 104)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 8)) 111)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 9)) 108)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 10)) 109)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 12)) 110)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 15)) 102)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 16)) 105)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 17)) 108)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 18)) 101)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 20)) 105)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 21)) 115)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 23)) 99)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 25)) 114)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 27)) 117)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 28)) 112)) (= (to_rep (select (temp___String_Literal_1578 us_void_param) 29)) 116)) :pattern ((temp___String_Literal_1578 us_void_param)))))
(declare-fun temp___String_Literal_1590 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1590 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 2)) 104)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 8)) 111)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 9)) 108)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 10)) 109)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 12)) 110)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 15)) 102)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 16)) 105)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 17)) 108)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 18)) 101)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 20)) 105)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 21)) 115)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 23)) 99)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 25)) 114)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 27)) 117)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 28)) 112)) (= (to_rep (select (temp___String_Literal_1590 us_void_param) 29)) 116)) :pattern ((temp___String_Literal_1590 us_void_param)))))
(define-fun dynamic_invariant4 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range4 temp___expr_63)))
...
(define-fun dynamic_invariant6 ((temp___expr_276 us_t1) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool)) Bool (and (=> (not (= temp___skip_constant_274 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_276) (last3 temp___expr_276))) (=> (= temp___do_toplevel_275 true) (=> (= temp___is_init_273 true) (and (= (first3 temp___expr_276) 1) (<= 0 (last3 temp___expr_276)))))))
(define-fun dynamic_predicate1 ((temp___279 us_t1)) Bool (and (= (first3 temp___279) 1) (<= 0 (last3 temp___279))))
(define-fun dynamic_invariant7 ((temp___expr_1066 Int) (temp___is_init_1063 Bool) (temp___skip_constant_1064 Bool) (temp___do_toplevel_1065 Bool)) Bool (=> (or (= temp___is_init_1063 true) (<= 0 17)) (in_range7 temp___expr_1066)))
(define-fun dynamic_invariant8 ((temp___expr_1045 Int) (temp___is_init_1042 Bool) (temp___skip_constant_1043 Bool) (temp___do_toplevel_1044 Bool)) Bool (=> (or (= temp___is_init_1042 true) (<= 1 17)) (in_range5 temp___expr_1045)))
(define-fun dynamic_invariant9 ((temp___expr_1170 Int) (temp___is_init_1167 Bool) (temp___skip_constant_1168 Bool) (temp___do_toplevel_1169 Bool)) Bool (=> (or (= temp___is_init_1167 true) (<= 0 2)) (in_range9 temp___expr_1170)))
(define-fun dynamic_invariant10 ((temp___expr_1051 Int) (temp___is_init_1048 Bool) (temp___skip_constant_1049 Bool) (temp___do_toplevel_1050 Bool)) Bool (=> (or (= temp___is_init_1048 true) (<= 0 17408)) (in_range6 temp___expr_1051)))
(define-fun dynamic_invariant11 ((temp___expr_1085 Int) (temp___is_init_1082 Bool) (temp___skip_constant_1083 Bool) (temp___do_toplevel_1084 Bool)) Bool (=> (or (= temp___is_init_1082 true) (<= 0 1024)) (in_range8 temp___expr_1085)))
(assert true)
...
(define-fun dynamic_invariant12 ((temp___expr_852 Int) (temp___is_init_849 Bool) (temp___skip_constant_850 Bool) (temp___do_toplevel_851 Bool)) Bool (=> (or (= temp___is_init_849 true) (<= 0 40)) (in_range10 temp___expr_852)))
(define-fun dynamic_invariant13 ((temp___expr_873 Int) (temp___is_init_870 Bool) (temp___skip_constant_871 Bool) (temp___do_toplevel_872 Bool)) Bool (=> (or (= temp___is_init_870 true) (<= 0 4294967295)) (in_range11 temp___expr_873)))
...
(declare-const temp___1579 us_t)
(declare-const o us_t)
(declare-const o1 (Array Int character))
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const o4 Bool)
(declare-const temp___1589 (Array Int filestatust))
(declare-const temp___1588 Bool)
(declare-const temp___1587 (Array Int character))
(declare-const temp___1586 (Array Int us_rep))
(declare-const temp___1584 Int)
(declare-const temp___1585 Bool)
(declare-const temp___1583 us_rep4)
(declare-const temp___1582 Int)
(declare-const temp___1581 us_rep)
...
(declare-const temp___1591 us_t)
(declare-const o10 us_t)
...
(declare-const thistisinfo__split_fields9 us_split_fields__ref3)
...
(declare-const thistisinfo__split_fields10 us_split_fields6)
...
(declare-const thistisinfo__split_fields11 us_split_fields__ref3)
...
(declare-const thistisinfo__split_fields12 us_split_fields6)
...
(declare-const thistisinfo__split_fields13 us_split_fields6)
(declare-const state20 us_private)
(declare-const store11 us_private)
(declare-const thistisinfo__split_fields14 us_split_fields__ref3)
(declare-const state21 us_private__ref)
(declare-const store12 us_private__ref)
(declare-const thistisinfo__split_fields15 us_split_fields6)
...
(declare-const logfilestate__split_fields16 us_split_fields__ref1)
(declare-const auditalarm10 int__ref)
(declare-const auditsystemfault10 bool__ref)
(declare-const thistisinfo__split_fields16 us_split_fields__ref3)
...
(declare-const auditalarm11 Int)
(declare-const auditsystemfault11 Bool)
(declare-const thistisinfo__split_fields17 us_split_fields6)
...
(assert (=> (= dataok true) (and (and (=> (and (= (of_int 0) true) (= dataok1 true)) (= (privatekeypresent thistisinfo__split_fields5 state5) true)) (=> (not (and (= (of_int 0) true) (= dataok1 true))) (= (= (privatekeypresent thistisinfo__split_fields5 state5) true) (= (privatekeypresent (mk___split_fields3 thistisinfo__split_fields (mk___rep2 (mk___split_fields2 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) state1) true)))) (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range3 auditalarm2)))))
(assert (=> (not (= dataok true)) (dynamic_property 1 2147483647 1 29)))
(assert (=> (not (= dataok true)) (= temp___1579 (mk___t (temp___String_Literal_1578 Tuple0) (mk 1 29)))))
(assert (=> (not (= dataok true)) (dynamic_predicate temp___1579)))
(assert (=> (not (= dataok true)) (= o temp___1579)))
...
(assert (=> (= dataok1 true) (and (and (=> (and (= (of_int 1) true) (= dataok2 true)) (= (privatekeypresent thistisinfo__split_fields6 state7) true)) (=> (not (and (= (of_int 1) true) (= dataok2 true))) (= (= (privatekeypresent thistisinfo__split_fields6 state7) true) (= (privatekeypresent thistisinfo__split_fields5 state5) true)))) (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range3 auditalarm3)))))
...
(assert (=> (= result3 true) (= temp___1589 logfilesstatus3)))
(assert (=> (= result3 true) (= temp___1588 auditsystemfault3)))
(assert (=> (= result3 true) (= temp___1587 description3)))
(assert (=> (= result3 true) (= temp___1586 logfiles3)))
(assert (=> (= result3 true) (= temp___1584 auditalarm3)))
(assert (=> (= result3 true) (= temp___1585 dataok2)))
(assert (=> (= result3 true) (= temp___1583 (mk___rep3 thistisinfo__split_fields6))))
(assert (=> (= result3 true) (= temp___1582 certno2)))
(assert (=> (= result3 true) (= temp___1581 thefile2)))
(assert (=> (= result3 true) (= temp___1580 (mk___rep1 logfilestate__split_fields9))))
(assert (=> (= result3 true) (= (privatekeypresent thistisinfo__split_fields7 state9) true)))
(assert (=> (= result3 true) (<= 2 certno3)))
(assert (=> (= result3 true) (and (and (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true) (=> (<= 1 2147483647) (in_range2 certno3))) (in_range3 auditalarm4)) (and (not (= (endoffile thefile3) true)) (= dataok3 true)))))
...
(assert (=> (= result3 true) (= thistisinfo__split_fields9 (mk___split_fields__ref3 thistisinfo__split_fields8))))
...
(assert (=> (= result3 true) (= logfilestate__split_fields12 (mk___split_fields__ref1 logfilestate__split_fields11))))
(assert (=> (= result3 true) (= logfilesstatus6 (mk_map__ref4 logfilesstatus5))))
(assert (=> (= result3 true) (= logfiles6 (mk_map__ref3 logfiles5))))
...
(assert (=> (not (= result3 true)) (= thistisinfo__split_fields11 (mk___split_fields__ref3 thistisinfo__split_fields6))))
...
(assert (=> (not (= result3 true)) (= logfilestate__split_fields14 (mk___split_fields__ref1 logfilestate__split_fields9))))
(assert (=> (not (= result3 true)) (= logfilesstatus8 (mk_map__ref4 logfilesstatus3))))
(assert (=> (not (= result3 true)) (= logfiles8 (mk_map__ref3 logfiles3))))
