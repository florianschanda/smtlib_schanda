...
(define-fun dynamic_invariant2 ((temp___expr_298 us_t) (temp___is_init_295 Bool) (temp___skip_constant_296 Bool) (temp___do_toplevel_297 Bool)) Bool (and (=> (not (= temp___skip_constant_296 true)) (dynamic_property 1 2147483647 (first1 temp___expr_298) (last1 temp___expr_298))) (=> (= temp___do_toplevel_297 true) (=> (= temp___is_init_295 true) (and (= (first3 (of_array1 (to_array temp___expr_298) (first1 temp___expr_298) (last1 temp___expr_298))) 1) (<= (last1 temp___expr_298) 1000))))))
(define-fun dynamic_predicate ((temp___302 us_t)) Bool (and (= (first3 (of_array1 (to_array temp___302) (first1 temp___302) (last1 temp___302))) 1) (<= (last1 temp___302) 1000)))
...
(assert (forall ((temp___1052 Int)) (forall ((temp___1053 Int)) (= (select (temp___1050 temp___1052) temp___1053) (of_rep2 temp___1052)))))
(declare-fun temp___1054 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1056 Int)) (forall ((temp___1057 Int)) (= (select (temp___1054 temp___1056) temp___1057) (of_rep5 temp___1056)))))
(define-fun dynamic_invariant3 ((temp___expr_1044 us_rep2) (temp___is_init_1041 Bool) (temp___skip_constant_1042 Bool) (temp___do_toplevel_1043 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1044))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1044))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1044)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1044))) true))
(define-fun default_initial_assumption ((temp___expr_1048 us_rep2) (temp___skip_top_level_1049 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1048))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1048))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1048)) (mk___rep (mk___split_fields (temp___1050 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1048)) (temp___1054 0))))
(define-fun type_invariant ((temp___1058 us_rep2)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1058))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1058))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1058)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1058))) true))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1522 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 2)) 104)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 8)) 111)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 9)) 108)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 10)) 109)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 12)) 110)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 15)) 102)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 16)) 105)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 17)) 108)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 18)) 101)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 20)) 105)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 21)) 115)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 23)) 99)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 25)) 114)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 27)) 117)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 28)) 112)) (= (to_rep (select (temp___String_Literal_1522 us_void_param) 29)) 116)) :pattern ((temp___String_Literal_1522 us_void_param)))))
(declare-fun temp___String_Literal_1534 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1534 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 2)) 104)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 3)) 101)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 8)) 111)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 9)) 108)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 10)) 109)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 12)) 110)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 15)) 102)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 16)) 105)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 17)) 108)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 18)) 101)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 20)) 105)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 21)) 115)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 23)) 99)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 25)) 114)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 27)) 117)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 28)) 112)) (= (to_rep (select (temp___String_Literal_1534 us_void_param) 29)) 116)) :pattern ((temp___String_Literal_1534 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_276 us_t1) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool)) Bool (and (=> (not (= temp___skip_constant_274 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_276) (last3 temp___expr_276))) (=> (= temp___do_toplevel_275 true) (=> (= temp___is_init_273 true) (= (first3 temp___expr_276) 1)))))
(define-fun dynamic_predicate1 ((temp___279 us_t1)) Bool (= (first3 temp___279) 1))
(define-fun dynamic_invariant7 ((temp___expr_1010 Int) (temp___is_init_1007 Bool) (temp___skip_constant_1008 Bool) (temp___do_toplevel_1009 Bool)) Bool (=> (or (= temp___is_init_1007 true) (<= 0 17)) (in_range7 temp___expr_1010)))
(define-fun dynamic_invariant8 ((temp___expr_989 Int) (temp___is_init_986 Bool) (temp___skip_constant_987 Bool) (temp___do_toplevel_988 Bool)) Bool (=> (or (= temp___is_init_986 true) (<= 1 17)) (in_range5 temp___expr_989)))
(define-fun dynamic_invariant9 ((temp___expr_1114 Int) (temp___is_init_1111 Bool) (temp___skip_constant_1112 Bool) (temp___do_toplevel_1113 Bool)) Bool (=> (or (= temp___is_init_1111 true) (<= 0 2)) (in_range9 temp___expr_1114)))
(define-fun dynamic_invariant10 ((temp___expr_995 Int) (temp___is_init_992 Bool) (temp___skip_constant_993 Bool) (temp___do_toplevel_994 Bool)) Bool (=> (or (= temp___is_init_992 true) (<= 0 17408)) (in_range6 temp___expr_995)))
(define-fun dynamic_invariant11 ((temp___expr_1029 Int) (temp___is_init_1026 Bool) (temp___skip_constant_1027 Bool) (temp___do_toplevel_1028 Bool)) Bool (=> (or (= temp___is_init_1026 true) (<= 0 1024)) (in_range8 temp___expr_1029)))
(assert true)
...
(define-fun dynamic_invariant12 ((temp___expr_804 Int) (temp___is_init_801 Bool) (temp___skip_constant_802 Bool) (temp___do_toplevel_803 Bool)) Bool (=> (or (= temp___is_init_801 true) (<= 0 40)) (in_range10 temp___expr_804)))
(define-fun dynamic_invariant13 ((temp___expr_825 Int) (temp___is_init_822 Bool) (temp___skip_constant_823 Bool) (temp___do_toplevel_824 Bool)) Bool (=> (or (= temp___is_init_822 true) (<= 0 4294967295)) (in_range11 temp___expr_825)))
...
(declare-const temp___1523 us_t)
(declare-const o us_t)
(declare-const o1 (Array Int character))
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const o4 Bool)
(declare-const temp___1533 us_rep)
(declare-const temp___1532 us_rep4)
(declare-const temp___1531 (Array Int filestatust))
(declare-const temp___1530 Bool)
(declare-const temp___1529 (Array Int character))
(declare-const temp___1528 (Array Int us_rep))
(declare-const temp___1527 Int)
(declare-const temp___1526 Bool)
(declare-const temp___1525 Int)
(declare-const temp___1524 us_rep2)
(declare-const o5 Bool)
(declare-const o6 Int)
(declare-const o7 Bool)
(declare-const o8 Bool)
(declare-const o9 Bool)
(declare-const temp___1535 us_t)
...
(assert (=> (not (= dataok true)) (= temp___1523 (mk___t (temp___String_Literal_1522 Tuple0) (mk 1 29)))))
(assert (=> (not (= dataok true)) (dynamic_predicate temp___1523)))
(assert (=> (not (= dataok true)) (= o temp___1523)))
...
(assert (=> (= result3 true) (= temp___1533 thefile2)))
(assert (=> (= result3 true) (= temp___1532 (mk___rep3 thistisinfo__split_fields6))))
(assert (=> (= result3 true) (= temp___1531 logfilesstatus3)))
(assert (=> (= result3 true) (= temp___1530 auditsystemfault3)))
(assert (=> (= result3 true) (= temp___1529 description3)))
(assert (=> (= result3 true) (= temp___1528 logfiles3)))
(assert (=> (= result3 true) (= temp___1527 auditalarm3)))
(assert (=> (= result3 true) (= temp___1526 dataok2)))
(assert (=> (= result3 true) (= temp___1525 certno2)))
(assert (=> (= result3 true) (= temp___1524 (mk___rep1 logfilestate__split_fields9))))
