...
(declare-const temp___1753 (Array Int filestatust))
(declare-const temp___1752 Bool)
(declare-const temp___1751 (Array Int character))
(declare-const temp___1750 (Array Int us_rep))
(declare-const temp___1748 Int)
(declare-const temp___1749 Bool)
(declare-const temp___1747 us_rep4)
(declare-const temp___1746 Int)
(declare-const temp___1745 us_rep)
(declare-const temp___1744 us_rep2)
...
(assert (=> (= result3 true) (= temp___1753 logfilesstatus3)))
(assert (=> (= result3 true) (= temp___1752 auditsystemfault3)))
(assert (=> (= result3 true) (= temp___1751 description3)))
(assert (=> (= result3 true) (= temp___1750 logfiles3)))
(assert (=> (= result3 true) (= temp___1748 auditalarm3)))
(assert (=> (= result3 true) (= temp___1749 dataok2)))
(assert (=> (= result3 true) (= temp___1747 (mk___rep3 thistisinfo__split_fields6))))
(assert (=> (= result3 true) (= temp___1746 certno2)))
(assert (=> (= result3 true) (= temp___1745 thefile2)))
(assert (=> (= result3 true) (= temp___1744 (mk___rep1 logfilestate__split_fields9))))
