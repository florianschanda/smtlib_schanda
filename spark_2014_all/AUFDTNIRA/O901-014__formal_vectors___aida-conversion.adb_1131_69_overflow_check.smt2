...
(assert (= o31 temp___1891))
(assert (= o32 (select (elts source) o31)))
(assert (= o33 (to_rep o32)))
(assert (and (= o34 (convert_character_digit_to_integer o33)) (and (in_range1 o34) (and (and (<= 0 o34) (<= o34 9)) (ite (= (= o33 48) true) (= o34 0) (ite (= (= o33 49) true) (= o34 1) (ite (= (= o33 50) true) (= o34 2) (ite (= (= o33 51) true) (= o34 3) (ite (= (= o33 52) true) (= o34 4) (ite (= (= o33 53) true) (= o34 5) (ite (= (= o33 54) true) (= o34 6) (ite (= (= o33 55) true) (= o34 7) (ite (= (= o33 56) true) (= o34 8) (=> (= (= o33 57) true) (= o34 9)))))))))))))))
(assert (= o35 (* o34 1)))
...
(assert (= o25 temp___1890))
(assert (= o26 (select (elts source) o25)))
(assert (= o27 (to_rep o26)))
(assert (and (= o28 (convert_character_digit_to_integer o27)) (and (in_range1 o28) (and (and (<= 0 o28) (<= o28 9)) (ite (= (= o27 48) true) (= o28 0) (ite (= (= o27 49) true) (= o28 1) (ite (= (= o27 50) true) (= o28 2) (ite (= (= o27 51) true) (= o28 3) (ite (= (= o27 52) true) (= o28 4) (ite (= (= o27 53) true) (= o28 5) (ite (= (= o27 54) true) (= o28 6) (ite (= (= o27 55) true) (= o28 7) (ite (= (= o27 56) true) (= o28 8) (=> (= (= o27 57) true) (= o28 9)))))))))))))))
(assert (= o29 (* o28 10)))
...
(assert (and (= temp___1887 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1887) (<= temp___1887 (to_rep1 (last (rt source))))))
(assert (= o5 temp___1887))
...
(assert (and (= temp___1886 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1886) (<= temp___1886 (to_rep1 (last (rt source))))))
(assert (= o temp___1886))
