...
(assert (and (and (and (= (rolepresent (mk___rep1 theadmin__split_fields3)) (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (= (ispresent (mk___rep1 theadmin__split_fields3)) true)) (= (isdoingop (mk___rep1 theadmin__split_fields3)) true)) (= (thecurrentop (mk___rep1 theadmin__split_fields3)) o8)))
(assert (= o9 (extractuser tokenpresence state1 tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields))))
(assert (not (= (to_rep1 (first (mk 1 78))) 1)))
(check-sat)
(exit)
