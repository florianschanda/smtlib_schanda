...
(assert (and (and (and (= (rolepresent (mk___rep1 theadmin__split_fields2)) (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (= (ispresent (mk___rep1 theadmin__split_fields2)) true)) (= (isdoingop (mk___rep1 theadmin__split_fields2)) true)) (= (thecurrentop (mk___rep1 theadmin__split_fields2)) o1)))
(assert (= o2 (extractuser tokenpresence state tokentry tokenid (us_split_fields__content12 authcert__split_fields) (us_split_fields__content9 idcert__split_fields))))
