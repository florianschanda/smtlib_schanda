...
(assert (and (= o (nearest_number is_prime1 mode value)) (and (in_range2 o) (and (and (and (<= 0 o) (<= o 100000)) (= (select is_prime1 o) true)) (ite (= (= (ite (select is_prime1 value) 1 0) (ite (distinct 1 0) 1 0)) true) (= o value) (ite (= (ite (= (= (ite (select is_prime1 value) 1 0) (ite (distinct 0 0) 1 0)) true) (= mode 0) false) true) (and (< value o) (forall ((v1 Int)) (=> (and (<= value v1) (<= v1 (- o 1))) (not (= (select is_prime1 v1) true))))) (ite (= (ite (= (= (ite (select is_prime1 value) 1 0) (ite (distinct 0 0) 1 0)) true) (= mode 1) false) true) (and (< o value) (forall ((v1 Int)) (=> (and (<= (+ o 1) v1) (<= v1 value)) (not (= (select is_prime1 v1) true))))) (=> (= (ite (= (= (ite (select is_prime1 value) 1 0) (ite (distinct 0 0) 1 0)) true) (= mode 2) false) true) (and (forall ((v1 Int)) (=> (and (<= (ite (< 0 (+ (- value (abs (- value o))) 1)) (+ (- value (abs (- value o))) 1) 0) v1) (<= v1 value)) (not (= (select is_prime1 v1) true)))) (forall ((v1 Int)) (=> (and (<= value v1) (<= v1 (ite (< 100000 (- (+ value (abs (- value o))) 1)) 100000 (- (+ value (abs (- value o))) 1)))) (not (= (select is_prime1 v1) true)))))))))))))
...
(assert (< value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))
(assert (<= value v))
(assert (<= v (- test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1)))
