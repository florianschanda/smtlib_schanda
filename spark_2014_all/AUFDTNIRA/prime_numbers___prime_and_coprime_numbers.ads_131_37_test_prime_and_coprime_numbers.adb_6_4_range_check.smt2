...
(assert (and (= o (nearest_number is_prime1 mode value)) (and (in_range2 o) (and (and (and (<= 0 o) (<= o 100000)) (= (select is_prime1 o) true)) (ite (= (= (to_int1 (select is_prime1 value)) (to_int1 (of_int 1))) true) (= o value) (ite (= (ite (= (= (to_int1 (select is_prime1 value)) (to_int1 (of_int 0))) true) (= mode 0) false) true) (and (< value o) (forall ((v1 Int)) (=> (and (<= value v1) (<= v1 (- o 1))) (not (= (select is_prime1 v1) true))))) (ite (= (ite (= (= (to_int1 (select is_prime1 value)) (to_int1 (of_int 0))) true) (= mode 1) false) true) (and (< o value) (forall ((v1 Int)) (=> (and (<= (+ o 1) v1) (<= v1 value)) (not (= (select is_prime1 v1) true))))) (=> (= (ite (= (= (to_int1 (select is_prime1 value)) (to_int1 (of_int 0))) true) (= mode 2) false) true) (and (forall ((v1 Int)) (=> (and (<= (ite (< 0 (+ (- value (abs (- value o))) 1)) (+ (- value (abs (- value o))) 1) 0) v1) (<= v1 value)) (not (= (select is_prime1 v1) true)))) (forall ((v1 Int)) (=> (and (<= value v1) (<= v1 (ite (< 100000 (- (+ value (abs (- value o))) 1)) 100000 (- (+ value (abs (- value o))) 1)))) (not (= (select is_prime1 v1) true)))))))))))))
