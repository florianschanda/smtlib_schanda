...
(assert (and (and (= (and (and (= (int__content currentdoor3) 0) (= (islocked (int__content currentlatch2) (us_private__content state8) (us_split_fields__content latchtimeout__split_fields5)) true)) (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (mk___rep (mk___split_fields alarmtimeout__split_fields alarmtimeout__split_fields1 alarmtimeout__split_fields2 alarmtimeout__split_fields3))) true)) (= (int__content dooralarm2) 0)) (= (= (islocked (int__content currentlatch2) (us_private__content state8) (us_split_fields__content latchtimeout__split_fields5)) true) (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (latch_timeout (int__content currentlatch2) (us_private__content state8) (us_split_fields__content latchtimeout__split_fields5))) true))) (= (bool_eq2 (latch_timeout (int__content currentlatch2) (us_private__content state8) (us_split_fields__content latchtimeout__split_fields5)) (latch_timeout currentlatch (us_private__content state1) (mk___split_fields latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) true)))
(assert (and (and (and (and (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content2 logfilestate__split_fields12))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content2 logfilestate__split_fields12))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content2 logfilestate__split_fields12)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content2 logfilestate__split_fields12))) true) (in_range16 (int__content currentlatch2))) (in_range17 (int__content currentdoor3))) (in_range4 (int__content auditalarm6))) (in_range4 (int__content dooralarm2))))
...
(assert (= (thecurrentdoor (int__content currentdoor3)) 0))
