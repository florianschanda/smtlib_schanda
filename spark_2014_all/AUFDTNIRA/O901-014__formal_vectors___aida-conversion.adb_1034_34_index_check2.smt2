...
(define-fun tnumber_array_typeD1__ref___17__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t1 0)
...
(define-fun number_array_type__ref___17__projection ((a number_array_type__ref)) us_t1 (number_array_type__content a))
...
(declare-datatypes () ((t346b__ref (mk_t346b__ref (t346b__content integer)))))
(define-fun t346b__ref___projection ((a t346b__ref)) integer (t346b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t348b__ref (mk_t348b__ref (t348b__content integer)))))
(define-fun t348b__ref___projection ((a t348b__ref)) integer (t348b__content a))
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-fun aida__conversion__calculate_positive_target_length_3__n__aggregate_def (Int Int Int) us_t2)
...
(define-fun dynamic_invariant4 ((temp___expr_514 us_t1) (temp___is_init_510 Bool) (temp___skip_constant_511 Bool) (temp___do_toplevel_512 Bool) (temp___do_typ_inv_513 Bool)) Bool (=> (not (= temp___skip_constant_511 true)) (and (dynamic_property2 (first1 source) (+ (first1 source) 2) (first3 temp___expr_514) (last3 temp___expr_514)) (and (= (first3 temp___expr_514) (first1 source)) (= (last3 temp___expr_514) (+ (first1 source) 2))))))
(declare-sort t3 0)
...
(define-fun tnumber_array_typeB__ref___17__projection ((a tnumber_array_typeB__ref)) us_t3 (tnumber_array_typeB__content a))
(declare-const rliteral integer)
(assert (= (integerqtint rliteral) 0))
(assert (forall ((temp___1823 Int) (temp___1824 Int) (temp___1825 Int)) (let ((temp___1822 (aida__conversion__calculate_positive_target_length_3__n__aggregate_def temp___1823 temp___1824 temp___1825))) (=> (dynamic_invariant temp___1823 true true true true) (and (=> (dynamic_property6 (first1 source) (+ (first1 source) 2) temp___1824 temp___1825) (and (= (first5 temp___1822) temp___1824) (= (last5 temp___1822) temp___1825))) (forall ((temp___1826 Int)) (= (select (to_array2 temp___1822) temp___1826) rliteral)))))))
(declare-const target Int)
(declare-const has_failed Bool)
(declare-const n (Array Int integer))
(declare-const index Int)
(declare-const temp___1828 (Array Int integer))
(declare-const temp___18281 t2)
...
(declare-const temp___1834 (Array Int integer))
...
(assert (and (= (length source) 3) (forall ((index10 Int)) (=> (and (<= (to_rep1 (first (rt source))) index10) (<= index10 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index10))) true)))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_length_3__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_length_3__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2))))) (+ (to_rep1 (first (rt source))) 2)))
(assert (= (mk___t2 temp___1828 temp___18281) (aida__conversion__calculate_positive_target_length_3__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2))))
(assert (= (ite (<= (to_rep1 (first4 temp___18281)) (to_rep1 (last4 temp___18281))) (+ (- (to_rep1 (last4 temp___18281)) (to_rep1 (first4 temp___18281))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2)) (+ (- (+ (to_rep1 (first (rt source))) 2) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1828 (to_rep1 (first4 temp___18281)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_length_3__n__assume))
(assert (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_positive_target_length_3__n__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_positive_target_length_3__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_length_3__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_length_3__n__assume1))))
(assert (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 2)))))
(assert (and (= temp___1831 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (= (mk_int__ref result1) (mk_int__ref index)))
(assert (= index1 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= temp___1834 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= temp___1832 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= o index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= o1 (select n1 o))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= o3 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= o7 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= n1 result2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= n2 o8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (= (to_rep1 (select n3 j)) (convert_character_digit_to_integer (to_rep (select (elts source) j))))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2) index2)) (forall ((temp___1835 Int)) (=> (and (<= (to_rep1 n__first) temp___1835) (<= temp___1835 (to_rep1 n__last))) (=> (or (< temp___1831 temp___1835) (or (< temp___1835 (to_rep1 (first (rt source)))) (< index2 temp___1835))) (= (select n3 temp___1835) (select temp___1834 temp___1835)))))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 2))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= index2 temp___1831)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= index2 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= n3 n4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= index4 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= n5 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= index9 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= n10 (mk_map__ref1 n4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= index6 index4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831)) (= n7 n5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831))) (= index1 index5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831))) (= n1 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1831))) (= n7 n1)))
(assert (and (= temp___1836 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___1836) (<= temp___1836 (to_rep1 n__last))))
(assert (= o9 temp___1836))
(assert (= o10 (select n6 o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= (mk_int__ref result3) (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 9))
(assert (and (= temp___1837 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___1837) (<= temp___1837 (to_rep1 n__last))))
(assert (= o12 temp___1837))
...
(assert (= target2 o18))
(assert (<= target2 99))
(assert (and (= temp___1838 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 n__first) temp___1838) (<= temp___1838 (to_rep1 n__last))))
(assert (= o19 temp___1838))
...
(assert (and (= temp___1841 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1841) (<= temp___1841 (to_rep1 (last (rt source))))))
(assert (= o26 temp___1841))
(assert (= o27 (select (elts source) o26)))
(assert (= o28 (to_rep o27)))
(assert (and (= o29 (convert_character_digit_to_integer o28)) (and (in_range1 o29) (and (and (<= 0 o29) (<= o29 9)) (ite (= (= o28 48) true) (= o29 0) (ite (= (= o28 49) true) (= o29 1) (ite (= (= o28 50) true) (= o29 2) (ite (= (= o28 51) true) (= o29 3) (ite (= (= o28 52) true) (= o29 4) (ite (= (= o28 53) true) (= o29 5) (ite (= (= o28 54) true) (= o29 6) (ite (= (= o28 55) true) (= o29 7) (ite (= (= o28 56) true) (= o29 8) (=> (= (= o28 57) true) (= o29 9)))))))))))))))
(assert (= o30 (* o29 1)))
(assert (and (= o31 o30) (in_range1 o30)))
(assert (and (= temp___1840 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1840)))
(check-sat)
(exit)
