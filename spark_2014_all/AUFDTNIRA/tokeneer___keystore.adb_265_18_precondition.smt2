...
(assert (=> (= result23 true) (= (ite (<= (to_rep1 (first (rt thestring2))) (to_rep1 (last (rt thestring2)))) (+ (- (to_rep1 (last (rt thestring2))) (to_rep1 (first (rt thestring2)))) 1) 0) (ite (<= 1 (length thestring2)) (+ (- (length thestring2) 1) 1) 0))))
(assert (=> (= result23 true) (= temp___1731 (mk___t3 (slide (elts thestring2) (to_rep1 (first (rt thestring2))) 1) (mk3 1 (length thestring2))))))
(assert (=> (= result23 true) (and (= temp___1733 (length thestring2)) (in_range1 (length thestring2)))))
(assert (=> (= result23 true) (=> (<= 1 temp___1733) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1733) (<= temp___1733 150))))))
(assert (=> (= result23 true) (= o37 (let ((subject result__2)) result__19))))
(assert (=> (= result23 true) (= temp___1734 (mk___t3 o37 (mk3 1 temp___1733)))))
(assert (=> (= result23 true) (= (ite (<= (to_rep1 (first6 (rt3 temp___1731))) (to_rep1 (last6 (rt3 temp___1731)))) (+ (- (to_rep1 (last6 (rt3 temp___1731))) (to_rep1 (first6 (rt3 temp___1731)))) 1) 0) (ite (<= (to_rep1 (first6 (rt3 temp___1734))) (to_rep1 (last6 (rt3 temp___1734)))) (+ (- (to_rep1 (last6 (rt3 temp___1734))) (to_rep1 (first6 (rt3 temp___1734)))) 1) 0))))
(assert (=> (= result23 true) (= temp___1735 temp___1731)))
(assert (=> (= result23 true) (forall ((temp___1736 Int)) (ite (and (<= 1 temp___1736) (<= temp___1736 (length thestring2))) (= (select o38 temp___1736) (select (elts3 temp___1735) temp___1736)) (= (select o38 temp___1736) (select (let ((subject result__2)) result__19) temp___1736))))))
(assert (=> (= result23 true) (= result24 (let ((subject result__2)) (mk_map__ref result__19)))))
(assert (=> (= result23 true) (= (let ((subject result__2)) result__20) o38)))
(assert (=> (= result23 true) (= result__22 (let ((subject result__2)) (mk_map__ref result__20)))))
(assert (=> (= result23 true) (= result__23 result__20)))
(assert (=> (not (= result23 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring2))) 1) (<= 1 (to_rep1 (last (rt thestring2))))) (and (<= (to_rep1 (first (rt thestring2))) 150) (<= 150 (to_rep1 (last (rt thestring2)))))))))
(assert (=> (not (= result23 true)) (= temp___1730 thestring2)))
(assert (=> (not (= result23 true)) (= o39 (elts temp___1730))))
(assert (=> (not (= result23 true)) (= result25 (let ((subject result__2)) (mk_map__ref result__19)))))
(assert (=> (not (= result23 true)) (= (let ((subject result__2)) result__21) o39)))
(assert (=> (not (= result23 true)) (= result__22 (let ((subject result__2)) (mk_map__ref result__21)))))
(assert (=> (not (= result23 true)) (= result__23 result__21)))
(assert (= result26 c58b))
(assert (= (let ((subject c58b)) c58b1) (map__content result__22)))
