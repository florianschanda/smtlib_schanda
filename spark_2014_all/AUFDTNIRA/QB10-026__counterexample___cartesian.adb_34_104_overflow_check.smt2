...
(assert (<= (to_rep (first (rt array2))) index21))
(assert (<= index21 (to_rep (last (rt array2)))))
...
(assert (= o6 (store result__1 o5 (temp___265 (to_rep (select (elts array1) index11)) (to_rep (select (elts array2) index21))))))
(assert (= result__1 result5))
(assert (= result__2 o6))
(assert (= result_index3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- index22 (to_rep (first (rt array2))))) 1)))
(assert (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt array2))) j1) (<= j1 index22)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j1 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) index11))))))
(assert (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt array2))) j1) (<= j1 index22)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j1 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j1))))))
(assert (and (and (=> (<= 0 2147483647) (in_range2 result_index3)) (=> (<= (to_rep (first (rt array2))) (to_rep (last (rt array2)))) (dynamic_property7 (to_rep (first (rt array2))) (to_rep (last (rt array2))) index22))) (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))))
(assert (<= (to_rep (first (rt array2))) j))
(assert (<= j index22))
(assert (and (<= (to_rep (first (rt array2))) j) (<= j (to_rep (last (rt array2))))))
(assert (= o15 j))
(assert (= o16 (select (elts array2) o15)))
(assert (= o17 (to_rep o16)))
(assert (and (= o10 (- j (to_rep (first (rt array2))))) (in_range1 (- j (to_rep (first (rt array2)))))))
(assert (and (= o7 (length array2)) (in_range1 (length array2))))
(assert (and (= o8 (- index11 (to_rep (first (rt array1))))) (in_range1 (- index11 (to_rep (first (rt array1)))))))
(assert (= o9 (* o8 o7)))
