...
(assert (<= (to_rep (first (rt array2))) j1))
(assert (<= j1 index23))
(assert (and (<= (to_rep (first (rt array2))) j1) (<= j1 (to_rep (last (rt array2))))))
(assert (= o35 j1))
(assert (= o36 (select (elts array2) o35)))
(assert (= o37 (to_rep o36)))
(assert (and (= o30 (- j1 (to_rep (first (rt array2))))) (in_range1 (- j1 (to_rep (first (rt array2)))))))
(assert (and (= o27 (length array2)) (in_range1 (length array2))))
(assert (and (= o28 (- index11 (to_rep (first (rt array1))))) (in_range1 (- index11 (to_rep (first (rt array1)))))))
(assert (= o29 (* o28 o27)))
(assert (and (= o31 o29) (in_range1 o29)))
(assert (= o32 (+ o31 o30)))
