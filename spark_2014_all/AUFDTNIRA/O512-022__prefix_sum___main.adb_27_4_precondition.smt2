...
(assert (= o6 (concat1 (temp___String_Literal_551 Tuple0) 1 3 (elts (to_string (attr__ATTRIBUTE_IMAGE3 space1))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE3 space1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE3 space1))))))))
(assert (= o7 (mk 1 o5)))
(assert (= result10 j1))
(assert (= j10 0))
(assert (= result11 j10))
...
(assert (= j17 7))
(assert (not (= (all_elements_in copy1 1000000) true)))
(check-sat)
(exit)
