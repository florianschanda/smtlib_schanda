...
(assert (forall ((x logfileindext)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x fileentrycountt)) (! (in_range6 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x filestatust)) (! (in_range7 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(define-fun dynamic_invariant ((temp___expr_565 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool) (temp___do_typ_inv_564 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 0 1)) (in_range8 temp___expr_565)))
...
(assert (forall ((x statscount)) (! (in_range9 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(declare-fun user_eq17 (descriptioni descriptioni) Bool)
(declare-const dummy17 descriptioni)
...
(define-fun dynamic_invariant2 ((temp___expr_2551 Int) (temp___is_init_2547 Bool) (temp___skip_constant_2548 Bool) (temp___do_toplevel_2549 Bool) (temp___do_typ_inv_2550 Bool)) Bool (=> (or (= temp___is_init_2547 true) (<= 0 7)) (in_range11 temp___expr_2551)))
...
(define-fun dynamic_invariant7 ((temp___expr_1164 Int) (temp___is_init_1160 Bool) (temp___skip_constant_1161 Bool) (temp___do_toplevel_1162 Bool) (temp___do_typ_inv_1163 Bool)) Bool (=> (or (= temp___is_init_1160 true) (<= 0 17)) (in_range5 temp___expr_1164)))
(define-fun dynamic_invariant8 ((temp___expr_1171 Int) (temp___is_init_1167 Bool) (temp___skip_constant_1168 Bool) (temp___do_toplevel_1169 Bool) (temp___do_typ_inv_1170 Bool)) Bool (=> (or (= temp___is_init_1167 true) (<= 1 17)) (in_range3 temp___expr_1171)))
(define-fun dynamic_invariant9 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 2)) (in_range7 temp___expr_1297)))
(define-fun dynamic_invariant10 ((temp___expr_1178 Int) (temp___is_init_1174 Bool) (temp___skip_constant_1175 Bool) (temp___do_toplevel_1176 Bool) (temp___do_typ_inv_1177 Bool)) Bool (=> (or (= temp___is_init_1174 true) (<= 0 17408)) (in_range4 temp___expr_1178)))
(define-fun dynamic_invariant11 ((temp___expr_1209 Int) (temp___is_init_1205 Bool) (temp___skip_constant_1206 Bool) (temp___do_toplevel_1207 Bool) (temp___do_typ_inv_1208 Bool)) Bool (=> (or (= temp___is_init_1205 true) (<= 0 1024)) (in_range6 temp___expr_1209)))
(assert true)
...
(define-fun dynamic_invariant12 ((temp___expr_590 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool) (temp___do_typ_inv_589 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 1 150)) (in_range10 temp___expr_590)))
...
(define-fun dynamic_invariant13 ((temp___expr_1774 Int) (temp___is_init_1770 Bool) (temp___skip_constant_1771 Bool) (temp___do_toplevel_1772 Bool) (temp___do_typ_inv_1773 Bool)) Bool (=> (or (= temp___is_init_1770 true) (<= 0 2147483647)) (in_range9 temp___expr_1774)))
