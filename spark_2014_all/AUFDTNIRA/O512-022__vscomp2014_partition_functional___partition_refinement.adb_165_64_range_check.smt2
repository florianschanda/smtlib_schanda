...
(assert (and (= o53 (length (mk___rep1 p__split_discrs p__split_fields4))) (and (in_range9 o53) (<= o53 (capacity (mk___rep1 p__split_discrs p__split_fields4))))))
(assert (not (in_range7 o53)))
(check-sat)
(exit)
