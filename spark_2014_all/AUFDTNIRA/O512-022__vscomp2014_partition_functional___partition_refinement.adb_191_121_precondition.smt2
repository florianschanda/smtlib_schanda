...
(assert (<= (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) k))
(assert (<= k (to_rep2 (rec__partition_refinement__interval__last p_prime__split_fields1))))
(assert (and (<= 0 k) (<= k 5)))
(assert (= o11 k))
