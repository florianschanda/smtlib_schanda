...
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= auditsystemfault7 auditsystemfault9)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= logfilestate__split_fields17 logfilestate__split_fields19)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= logfilesstatus8 logfilesstatus10)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= logfiles7 logfiles9)))
