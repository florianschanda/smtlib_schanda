...
(assert (forall ((temp___1428 Int) (temp___1429 Int) (temp___1430 Int) (temp___1431 Int) (temp___1432 Int) (temp___1433 Int) (temp___1434 Int) (temp___1435 Int) (temp___1436 Int) (temp___1437 Int) (temp___1438 Int) (temp___1439 Int)) (let ((temp___1427 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def temp___1428 temp___1429 temp___1430 temp___1431 temp___1432 temp___1433 temp___1434 temp___1435 temp___1436 temp___1437 temp___1438 temp___1439))) (=> (and (and (and (and (and (and (and (and (and (dynamic_invariant temp___1428 true true true true) (dynamic_invariant temp___1429 true true true true)) (dynamic_invariant temp___1430 true true true true)) (dynamic_invariant temp___1431 true true true true)) (dynamic_invariant temp___1432 true true true true)) (dynamic_invariant temp___1433 true true true true)) (dynamic_invariant temp___1434 true true true true)) (dynamic_invariant temp___1435 true true true true)) (dynamic_invariant temp___1436 true true true true)) (dynamic_invariant temp___1437 true true true true)) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1438 temp___1439) (and (= (first5 temp___1427) temp___1438) (= (last5 temp___1427) temp___1439))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1427) (+ (first1 source) 0)) rliteral) (= (select (to_array2 temp___1427) (+ (first1 source) 1)) rliteral1)) (= (select (to_array2 temp___1427) (+ (first1 source) 2)) rliteral2)) (= (select (to_array2 temp___1427) (+ (first1 source) 3)) rliteral3)) (= (select (to_array2 temp___1427) (+ (first1 source) 4)) rliteral2)) (= (select (to_array2 temp___1427) (+ (first1 source) 5)) rliteral3)) (= (select (to_array2 temp___1427) (+ (first1 source) 6)) rliteral4)) (= (select (to_array2 temp___1427) (+ (first1 source) 7)) rliteral4)) (= (select (to_array2 temp___1427) (+ (first1 source) 8)) rliteral4)) (= (select (to_array2 temp___1427) (+ (first1 source) 9)) rliteral4)))))))
(define-fun dynamic_invariant4 ((temp___expr_274 us_t3) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool) (temp___do_typ_inv_273 Bool)) Bool (=> (not (= temp___skip_constant_271 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_274) (last7 temp___expr_274)) (and (= (first7 temp___expr_274) (first1 source)) (= (last7 temp___expr_274) (+ (first1 source) 9))))))
(declare-sort t6 0)
...
(assert (forall ((temp___1445 Int) (temp___1446 Int) (temp___1447 Int)) (let ((temp___1444 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def temp___1445 temp___1446 temp___1447))) (=> (dynamic_invariant temp___1445 true true true true) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1446 temp___1447) (and (= (first9 temp___1444) temp___1446) (= (last9 temp___1444) temp___1447))) (forall ((temp___1448 Int)) (= (select (to_array4 temp___1444) temp___1448) rliteral5)))))))
...
(declare-const temp___1442 (Array Int integer))
(declare-const temp___14421 t2)
...
(declare-const temp___1450 (Array Int integer))
(declare-const temp___14501 t4)
...
(declare-const temp___1453 Int)
(declare-const temp___1456 (Array Int integer))
...
(declare-const temp___1458 Int)
(declare-const o9 Int)
(declare-const o10 integer)
(declare-const o11 Int)
(declare-const temp___1459 Int)
...
(assert (and (and (= (length source) 10) (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 56))) (forall ((index9 Int)) (=> (and (<= (to_rep1 (first (rt source))) index9) (<= index9 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index9))) true)))))
...
(assert (= (mk___t2 temp___1442 temp___14421) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def 2 1 4 7 4 7 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___14421)) (to_rep1 (last4 temp___14421))) (+ (- (to_rep1 (last4 temp___14421)) (to_rep1 (first4 temp___14421))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1442 (to_rep1 (first4 temp___14421)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume))
...
(assert (= (mk___t4 temp___1450 temp___14501) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___14501)) (to_rep1 (last8 temp___14501))) (+ (- (to_rep1 (last8 temp___14501)) (to_rep1 (first8 temp___14501))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1450 (to_rep1 (first8 temp___14501)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume))
...
(assert (and (= temp___1453 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= temp___1456 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= temp___1454 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= o index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= o1 (select n1 o))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= o3 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= o7 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= n2 o8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt source))) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2)) (forall ((temp___1457 Int)) (=> (and (<= (to_rep1 n__first) temp___1457) (<= temp___1457 (to_rep1 n__last))) (=> (or (< temp___1453 temp___1457) (or (< temp___1457 (to_rep1 (first (rt source)))) (< index2 temp___1457))) (= (select n3 temp___1457) (select temp___1456 temp___1457)))))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= index2 temp___1453)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= index2 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= n3 n4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= index4 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= n5 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= index6 index4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453)) (= n7 n5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1453))) (= n7 n1)))
...
(assert (and (= temp___1458 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1458) (<= temp___1458 (to_rep1 n__last))))
(assert (= o9 temp___1458))
(assert (= o10 (select (map__content1 n6) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= result4 (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 9))
(assert (and (= temp___1459 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1459) (<= temp___1459 (to_rep1 n__last))))
(assert (= o12 temp___1459))
...
(assert (= target2 o18))
(assert (<= target2 99))
(assert (and (= temp___1460 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1460) (<= temp___1460 (to_rep1 n__last))))
(assert (= o19 temp___1460))
...
(assert (= target3 o25))
(assert (<= target3 999))
(assert (and (= temp___1461 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___1461) (<= temp___1461 (to_rep1 n__last))))
(assert (= o26 temp___1461))
...
(assert (= target4 o32))
(assert (<= target4 9999))
(assert (and (= temp___1462 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___1462) (<= temp___1462 (to_rep1 n__last))))
(assert (= o33 temp___1462))
...
(assert (= target5 o39))
(assert (<= target5 79999))
(assert (and (= o40 (+ target5 2147400000)) (in_range1 (+ target5 2147400000))))
(assert (= result9 (mk_int__ref target5)))
(assert (= target6 o40))
(assert (<= target6 2147479999))
