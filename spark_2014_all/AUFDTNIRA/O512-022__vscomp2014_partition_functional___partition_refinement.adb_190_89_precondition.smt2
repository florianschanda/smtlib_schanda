...
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields5)) k9))
(assert (<= k9 (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields5))))
(assert (and (<= 0 k9) (<= k9 5)))
(assert (= o98 k9))
(assert (= o99 (select (map__content f8) o98)))
(assert (= o100 (to_rep2 o99)))
(assert (not (<= 0 o100)))
(check-sat)
(exit)
