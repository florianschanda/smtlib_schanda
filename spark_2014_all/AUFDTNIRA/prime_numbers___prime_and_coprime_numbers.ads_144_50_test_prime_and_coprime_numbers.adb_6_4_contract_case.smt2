...
(assert (<= (ite (< 0 (+ (- value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1)) (+ (- value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1) 0) v4))
(assert (<= v4 value))
(assert (not (not (= (is_prime v4) true))))
(check-sat)
(exit)
