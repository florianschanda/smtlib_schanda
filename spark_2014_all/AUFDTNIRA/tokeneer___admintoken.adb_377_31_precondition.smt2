...
(define-fun dynamic_invariant ((temp___expr_489 Int) (temp___is_init_486 Bool) (temp___skip_constant_487 Bool) (temp___do_toplevel_488 Bool)) Bool (=> (or (= temp___is_init_486 true) (<= 0 1)) (in_range7 temp___expr_489)))
...
(assert (forall ((x yearst)) (! (in_range9 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x monthst)) (! (in_range10 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x dayst)) (! (in_range11 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x millisecst)) (! (in_range12 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(declare-fun to_rep9 (logfileindext) Int)
...
(declare-fun to_rep10 (logentrycountt) Int)
...
(define-fun bool_eq5 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep9 (select a temp___idx_153)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_153))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep9 (select a temp___idx_153)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq5 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep9 (select a (+ i 1))) (to_rep9 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq5 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep9 (select b (+ i 1))) (to_rep9 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(declare-fun to_rep11 (logfilecountt) Int)
...
(define-fun bool_eq6 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (bool_eq5 (rec__auditlog__logfilelistt__list (us_split_fields7 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields7 b)) 1 17) true) (= (to_rep9 (rec__auditlog__logfilelistt__head (us_split_fields7 a))) (to_rep9 (rec__auditlog__logfilelistt__head (us_split_fields7 b))))) (= (to_rep9 (rec__auditlog__logfilelistt__lasti (us_split_fields7 a))) (to_rep9 (rec__auditlog__logfilelistt__lasti (us_split_fields7 b))))) (= (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields7 a))) (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields7 b))))) true false))
...
(declare-fun to_rep12 (fileentrycountt) Int)
...
(define-fun bool_eq7 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep12 (select a temp___idx_154)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep12 (select a temp___idx_154)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_154)))))))))))
...
(define-fun bool_eq8 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (= (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 a))) (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 b)))) (= (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 a))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 b))))) (= (bool_eq6 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 b))) true)) (= (bool_eq7 (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 b)) 1 17) true)) true false))
...
(assert (forall ((temp___1139 Int)) (forall ((temp___1140 Int)) (= (select (temp___1137 temp___1139) temp___1140) (of_rep9 temp___1139)))))
(declare-fun temp___1141 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1143 Int)) (forall ((temp___1144 Int)) (= (select (temp___1141 temp___1143) temp___1144) (of_rep12 temp___1143)))))
(define-fun dynamic_invariant1 ((temp___expr_1131 us_rep4) (temp___is_init_1128 Bool) (temp___skip_constant_1129 Bool) (temp___do_toplevel_1130 Bool)) Bool (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___expr_1131))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___expr_1131))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___expr_1131)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___expr_1131))) true))
(define-fun default_initial_assumption ((temp___expr_1135 us_rep4) (temp___skip_top_level_1136 Bool)) Bool (and (and (and (= (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___expr_1135))) 1) (= (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___expr_1135))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___expr_1135)) (mk___rep3 (mk___split_fields3 (temp___1137 1) (of_rep9 1) (of_rep9 1) (of_rep11 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___expr_1135)) (temp___1141 0))))
(define-fun type_invariant ((temp___1145 us_rep4)) Bool (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___1145))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___1145))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___1145)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___1145))) true))
...
(assert (forall ((a (Array Int us_rep5))) (forall ((first2 Int)) (! (= (slide3 a first2 first2) a) :pattern ((slide3 a first2 first2))))))
...
(assert (forall ((x filestatust)) (! (in_range17 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun bool_eq11 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep13 (select a temp___idx_156)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_156))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep13 (select a temp___idx_156)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_156)))))))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare3 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq11 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep13 (select a (+ i 1))) (to_rep13 (select b (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare3 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq11 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep13 (select b (+ i 1))) (to_rep13 (select a (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__keystore__optionalprivatekeyt__ispresent Bool) (rec__keystore__optionalprivatekeyt__owner us_rep)))))
...
(define-fun us_split_fields_Owner__projection ((a us_split_fields10)) us_rep (rec__keystore__optionalprivatekeyt__owner a))
...
(define-fun bool_eq12 ((a us_rep6) (b us_rep6)) Bool (ite (and (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields11 a)) (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields11 b))) (= (bool_eq2 (rec__keystore__optionalprivatekeyt__owner (us_split_fields11 a)) (rec__keystore__optionalprivatekeyt__owner (us_split_fields11 b))) true)) true false))
...
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__contentst__id us_rep1) (rec__cert__contentst__notbefore us_rep2) (rec__cert__contentst__notafter us_rep2) (rec__cert__contentst__mechanism algorithmt)))))
(define-fun us_split_fields_ID__3__projection ((a us_split_fields12)) us_rep1 (rec__cert__contentst__id a))
(define-fun us_split_fields_NotBefore__projection ((a us_split_fields12)) us_rep2 (rec__cert__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__projection ((a us_split_fields12)) us_rep2 (rec__cert__contentst__notafter a))
...
(define-fun bool_eq13 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (= (bool_eq3 (rec__cert__contentst__id (us_split_fields13 a)) (rec__cert__contentst__id (us_split_fields13 b))) true) (= (bool_eq4 (rec__cert__contentst__notbefore (us_split_fields13 a)) (rec__cert__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq4 (rec__cert__contentst__notafter (us_split_fields13 a)) (rec__cert__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep14 (rec__cert__contentst__mechanism (us_split_fields13 a))) (to_rep14 (rec__cert__contentst__mechanism (us_split_fields13 b))))) true false))
...
(declare-fun theid (us_rep7) us_rep1)
(declare-fun theid__function_guard (us_rep1 us_rep7) Bool)
(assert true)
(declare-fun iscurrent (us_rep7 us_split_fields4 us_private) Bool)
(declare-fun iscurrent__function_guard (Bool us_rep7 us_split_fields4 us_private) Bool)
(assert true)
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__cert__attr__contentst__id us_rep1) (rec__cert__attr__contentst__notbefore us_rep2) (rec__cert__attr__contentst__notafter us_rep2) (rec__cert__attr__contentst__mechanism algorithmt) (rec__cert__attr__contentst__basecertid us_rep1)))))
(define-fun us_split_fields_ID__4__projection ((a us_split_fields14)) us_rep1 (rec__cert__attr__contentst__id a))
(define-fun us_split_fields_NotBefore__2__projection ((a us_split_fields14)) us_rep2 (rec__cert__attr__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__2__projection ((a us_split_fields14)) us_rep2 (rec__cert__attr__contentst__notafter a))
(define-fun us_split_fields_Mechanism__2__projection ((a us_split_fields14)) algorithmt (rec__cert__attr__contentst__mechanism a))
(define-fun us_split_fields_BaseCertID__projection ((a us_split_fields14)) us_rep1 (rec__cert__attr__contentst__basecertid a))
...
(define-fun bool_eq14 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (= (bool_eq3 (rec__cert__attr__contentst__id (us_split_fields15 a)) (rec__cert__attr__contentst__id (us_split_fields15 b))) true) (= (bool_eq4 (rec__cert__attr__contentst__notbefore (us_split_fields15 a)) (rec__cert__attr__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq4 (rec__cert__attr__contentst__notafter (us_split_fields15 a)) (rec__cert__attr__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep14 (rec__cert__attr__contentst__mechanism (us_split_fields15 a))) (to_rep14 (rec__cert__attr__contentst__mechanism (us_split_fields15 b))))) (= (bool_eq3 (rec__cert__attr__contentst__basecertid (us_split_fields15 a)) (rec__cert__attr__contentst__basecertid (us_split_fields15 b))) true)) true false))
...
(declare-fun thebasecert (us_rep8) us_rep1)
(declare-fun thebasecert__function_guard (us_rep1 us_rep8) Bool)
(assert true)
...
(assert (forall ((x privileget)) (! (in_range19 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(assert (forall ((x classt)) (! (in_range20 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun us_rep___10__projection ((a us_rep9)) us_split_fields16 (us_split_fields17 a))
(define-fun bool_eq15 ((a us_rep9) (b us_rep9)) Bool (ite (= (to_rep16 (rec__privtypes__clearancet__class (us_split_fields17 a))) (to_rep16 (rec__privtypes__clearancet__class (us_split_fields17 b)))) true false))
...
(declare-datatypes () ((us_split_fields18 (mk___split_fields9 (rec__cert__attr__auth__contentst__id us_rep1) (rec__cert__attr__auth__contentst__notbefore us_rep2) (rec__cert__attr__auth__contentst__notafter us_rep2) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep1) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep9)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields18)) us_rep1 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields18)) us_rep2 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields18)) us_rep2 (rec__cert__attr__auth__contentst__notafter a))
...
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields18)) us_rep1 (rec__cert__attr__auth__contentst__basecertid a))
...
(define-fun us_split_fields__ref___15__projection ((a us_split_fields__ref9)) us_split_fields18 (us_split_fields__content9 a))
(declare-datatypes () ((us_rep10 (mk___rep9 (us_split_fields19 us_split_fields18)))))
(define-fun us_rep___16__projection ((a us_rep10)) us_split_fields18 (us_split_fields19 a))
(define-fun bool_eq16 ((a us_rep10) (b us_rep10)) Bool (ite (and (and (and (and (and (and (= (bool_eq3 (rec__cert__attr__auth__contentst__id (us_split_fields19 a)) (rec__cert__attr__auth__contentst__id (us_split_fields19 b))) true) (= (bool_eq4 (rec__cert__attr__auth__contentst__notbefore (us_split_fields19 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields19 b))) true)) (= (bool_eq4 (rec__cert__attr__auth__contentst__notafter (us_split_fields19 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields19 b))) true)) (= (to_rep14 (rec__cert__attr__auth__contentst__mechanism (us_split_fields19 a))) (to_rep14 (rec__cert__attr__auth__contentst__mechanism (us_split_fields19 b))))) (= (bool_eq3 (rec__cert__attr__auth__contentst__basecertid (us_split_fields19 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields19 b))) true)) (= (to_rep15 (rec__cert__attr__auth__contentst__role (us_split_fields19 a))) (to_rep15 (rec__cert__attr__auth__contentst__role (us_split_fields19 b))))) (= (bool_eq15 (rec__cert__attr__auth__contentst__clearance (us_split_fields19 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields19 b))) true)) true false))
...
(declare-datatypes () ((contentst__ref2 (mk_contentst__ref2 (contentst__content2 us_rep10)))))
(define-fun contentst__ref___3__projection ((a contentst__ref2)) us_rep10 (contentst__content2 a))
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-fun cert_attr_auth_to_cert (us_rep10) us_rep7)
(declare-fun cert_attr_auth_to_cert__function_guard (us_rep7 us_rep10) Bool)
(assert true)
(declare-fun cert_attr_auth_to_cert_attr (us_rep10) us_rep8)
(declare-fun cert_attr_auth_to_cert_attr__function_guard (us_rep8 us_rep10) Bool)
(assert true)
...
(declare-datatypes () ((us_split_fields22 (mk___split_fields11 (rec__cert__id__contentst__id us_rep1) (rec__cert__id__contentst__notbefore us_rep2) (rec__cert__id__contentst__notafter us_rep2) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep) (rec__cert__id__contentst__subjectpublickey us_rep11)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields22)) us_rep1 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields22)) us_rep2 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields22)) us_rep2 (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields22)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields22)) us_rep (rec__cert__id__contentst__subject a))
...
(define-fun bool_eq18 ((a us_rep12) (b us_rep12)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__id__contentst__id (us_split_fields23 a)) (rec__cert__id__contentst__id (us_split_fields23 b))) true) (= (bool_eq4 (rec__cert__id__contentst__notbefore (us_split_fields23 a)) (rec__cert__id__contentst__notbefore (us_split_fields23 b))) true)) (= (bool_eq4 (rec__cert__id__contentst__notafter (us_split_fields23 a)) (rec__cert__id__contentst__notafter (us_split_fields23 b))) true)) (= (to_rep14 (rec__cert__id__contentst__mechanism (us_split_fields23 a))) (to_rep14 (rec__cert__id__contentst__mechanism (us_split_fields23 b))))) (= (bool_eq2 (rec__cert__id__contentst__subject (us_split_fields23 a)) (rec__cert__id__contentst__subject (us_split_fields23 b))) true)) (= (bool_eq17 (rec__cert__id__contentst__subjectpublickey (us_split_fields23 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields23 b))) true)) true false))
...
(declare-fun cert_id_to_cert (us_rep12) us_rep7)
(declare-fun cert_id_to_cert__function_guard (us_rep7 us_rep12) Bool)
(assert true)
...
(declare-fun temp___String_Literal_1918 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1918 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 27)) 78)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 29)) 116)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 31)) 67)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 32)) 117)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 34)) 114)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 35)) 101)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 36)) 110)) (= (to_rep (select (temp___String_Literal_1918 us_void_param) 37)) 116)) :pattern ((temp___String_Literal_1918 us_void_param)))))
(declare-fun temp___String_Literal_1919 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1919 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 27)) 78)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 29)) 116)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 31)) 86)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 34)) 105)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 35)) 102)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 36)) 105)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 37)) 97)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 38)) 98)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 39)) 108)) (= (to_rep (select (temp___String_Literal_1919 us_void_param) 40)) 101)) :pattern ((temp___String_Literal_1919 us_void_param)))))
(declare-fun temp___String_Literal_1920 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1920 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 27)) 66)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 28)) 97)) (= (to_rep (select (temp___String_Literal_1920 us_void_param) 29)) 100)) :pattern ((temp___String_Literal_1920 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 40)) (in_range4 temp___expr_319)))
(define-fun dynamic_invariant7 ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 0 4294967295)) (in_range5 temp___expr_340)))
(define-fun dynamic_invariant8 ((temp___expr_362 Int) (temp___is_init_359 Bool) (temp___skip_constant_360 Bool) (temp___do_toplevel_361 Bool)) Bool (=> (or (= temp___is_init_359 true) (<= 0 10)) (in_range18 temp___expr_362)))
(define-fun dynamic_invariant9 ((temp___expr_374 Int) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool)) Bool (=> (or (= temp___is_init_371 true) (<= 0 4294967295)) (in_range21 temp___expr_374)))
(define-fun dynamic_invariant10 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 128)) (in_range22 temp___expr_380)))
(define-fun dynamic_invariant11 ((temp___expr_1097 Int) (temp___is_init_1094 Bool) (temp___skip_constant_1095 Bool) (temp___do_toplevel_1096 Bool)) Bool (=> (or (= temp___is_init_1094 true) (<= 0 17)) (in_range15 temp___expr_1097)))
(define-fun dynamic_invariant12 ((temp___expr_1076 Int) (temp___is_init_1073 Bool) (temp___skip_constant_1074 Bool) (temp___do_toplevel_1075 Bool)) Bool (=> (or (= temp___is_init_1073 true) (<= 1 17)) (in_range13 temp___expr_1076)))
(define-fun dynamic_invariant13 ((temp___expr_1201 Int) (temp___is_init_1198 Bool) (temp___skip_constant_1199 Bool) (temp___do_toplevel_1200 Bool)) Bool (=> (or (= temp___is_init_1198 true) (<= 0 2)) (in_range17 temp___expr_1201)))
(define-fun dynamic_invariant14 ((temp___expr_1082 Int) (temp___is_init_1079 Bool) (temp___skip_constant_1080 Bool) (temp___do_toplevel_1081 Bool)) Bool (=> (or (= temp___is_init_1079 true) (<= 0 17408)) (in_range14 temp___expr_1082)))
(define-fun dynamic_invariant15 ((temp___expr_1116 Int) (temp___is_init_1113 Bool) (temp___skip_constant_1114 Bool) (temp___do_toplevel_1115 Bool)) Bool (=> (or (= temp___is_init_1113 true) (<= 0 1024)) (in_range16 temp___expr_1116)))
(assert true)
(assert (forall ((currentlogfile Int) (numberlogentries Int)) (forall ((usedlogfiles us_rep3)) (forall ((logfileentries (Array Int fileentrycountt))) (! (= (= (valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries) true) (and (<= 1 (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields7 usedlogfiles)))) (= numberlogentries (+ (* (- (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields7 usedlogfiles))) 1) 1024) (to_rep12 (select logfileentries currentlogfile)))))) :pattern ((valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries)))))))
(define-fun dynamic_invariant16 ((temp___expr_511 Int) (temp___is_init_508 Bool) (temp___skip_constant_509 Bool) (temp___do_toplevel_510 Bool)) Bool (=> (or (= temp___is_init_508 true) (<= 1 150)) (in_range8 temp___expr_511)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant17 ((temp___expr_553 Int) (temp___is_init_550 Bool) (temp___skip_constant_551 Bool) (temp___do_toplevel_552 Bool)) Bool (=> (or (= temp___is_init_550 true) (<= 1901 2099)) (in_range9 temp___expr_553)))
(define-fun dynamic_invariant18 ((temp___expr_559 Int) (temp___is_init_556 Bool) (temp___skip_constant_557 Bool) (temp___do_toplevel_558 Bool)) Bool (=> (or (= temp___is_init_556 true) (<= 1 12)) (in_range10 temp___expr_559)))
(define-fun dynamic_invariant19 ((temp___expr_565 Int) (temp___is_init_562 Bool) (temp___skip_constant_563 Bool) (temp___do_toplevel_564 Bool)) Bool (=> (or (= temp___is_init_562 true) (<= 1 31)) (in_range11 temp___expr_565)))
(define-fun dynamic_invariant20 ((temp___expr_589 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 0 86399999)) (in_range12 temp___expr_589)))
(define-fun dynamic_invariant21 ((temp___expr_1035 Int) (temp___is_init_1032 Bool) (temp___skip_constant_1033 Bool) (temp___do_toplevel_1034 Bool)) Bool (=> (or (= temp___is_init_1032 true) (<= 0 3)) (in_range19 temp___expr_1035)))
(define-fun dynamic_invariant22 ((temp___expr_1047 Int) (temp___is_init_1044 Bool) (temp___skip_constant_1045 Bool) (temp___do_toplevel_1046 Bool)) Bool (=> (or (= temp___is_init_1044 true) (<= 0 5)) (in_range20 temp___expr_1047)))
(define-fun dynamic_invariant23 ((temp___expr_453 Int) (temp___is_init_450 Bool) (temp___skip_constant_451 Bool) (temp___do_toplevel_452 Bool)) Bool (=> (or (= temp___is_init_450 true) (<= 0 4294967295)) (in_range6 temp___expr_453)))
...
(declare-const authcertcontents__split_fields us_split_fields__ref9)
...
(declare-const o us_rep7)
(declare-const o1 us_rep8)
...
(declare-const authcertcontents__split_fields1 us_split_fields18)
...
(declare-const authcertcontents__split_fields2 us_split_fields18)
...
(assert (= (valid_numberlogentries (to_rep9 logfilestate__split_fields) (to_rep10 logfilestate__split_fields1) (mk___rep3 (mk___split_fields3 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6) true))
...
(assert (= (let ((subject baseidmatches)) baseidmatches1) (of_int 0)))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o1 (cert_attr_auth_to_cert_attr (mk___rep9 (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields2)))))))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range7 auditalarm2)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o5 (cert_attr_auth_to_cert (mk___rep9 (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields2)))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o6 (iscurrent o5 (mk___split_fields2 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime))))))
...
(assert (=> (not (= certfound true)) (= (let ((subject authcertcontents__split_fields)) (mk___split_fields__ref9 authcertcontents__split_fields2)) authcertcontents__split_fields)))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (not (= (let ((subject baseidmatches)) baseidmatches2) true)))))
