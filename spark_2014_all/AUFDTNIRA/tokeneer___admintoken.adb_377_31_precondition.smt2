...
(define-fun dynamic_invariant ((temp___expr_593 Int) (temp___is_init_589 Bool) (temp___skip_constant_590 Bool) (temp___do_toplevel_591 Bool) (temp___do_typ_inv_592 Bool)) Bool (=> (or (= temp___is_init_589 true) (<= 0 1)) (in_range7 temp___expr_593)))
...
(define-fun dynamic_invariant1 ((temp___expr_1337 us_rep4) (temp___is_init_1333 Bool) (temp___skip_constant_1334 Bool) (temp___do_toplevel_1335 Bool) (temp___do_typ_inv_1336 Bool)) Bool (=> (= temp___do_typ_inv_1336 true) (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___expr_1337))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___expr_1337))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___expr_1337)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___expr_1337))) true)))
(define-fun default_initial_assumption ((temp___expr_1341 us_rep4) (temp___skip_top_level_1342 Bool)) Bool (and (and (and (= (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___expr_1341))) 1) (= (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___expr_1341))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___expr_1341)) (mk___rep3 (mk___split_fields3 (temp___1343 1) (of_rep9 1) (of_rep9 1) (of_rep11 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___expr_1341)) (temp___1347 0))))
(define-fun type_invariant ((temp___1351 us_rep4)) Bool (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___1351))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___1351))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___1351)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___1351))) true))
...
(define-fun bool_eq10 ((a (Array Int us_rep5)) (a__first Int) (a__last Int) (b (Array Int us_rep5)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq9 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true)))) true false))
...
(declare-fun temp___String_Literal_2144 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2144 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 27)) 78)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 29)) 116)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 31)) 67)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 32)) 117)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 34)) 114)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 35)) 101)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 36)) 110)) (= (to_rep (select (temp___String_Literal_2144 us_void_param) 37)) 116)) :pattern ((temp___String_Literal_2144 us_void_param)))))
(declare-fun temp___String_Literal_2145 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2145 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 27)) 78)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 29)) 116)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 31)) 86)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 34)) 105)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 35)) 102)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 36)) 105)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 37)) 97)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 38)) 98)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 39)) 108)) (= (to_rep (select (temp___String_Literal_2145 us_void_param) 40)) 101)) :pattern ((temp___String_Literal_2145 us_void_param)))))
(declare-fun temp___String_Literal_2146 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2146 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 27)) 66)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 28)) 97)) (= (to_rep (select (temp___String_Literal_2146 us_void_param) 29)) 100)) :pattern ((temp___String_Literal_2146 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range5 temp___expr_426)))
(define-fun dynamic_invariant8 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range18 temp___expr_450)))
(define-fun dynamic_invariant9 ((temp___expr_464 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool) (temp___do_typ_inv_463 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 4294967295)) (in_range21 temp___expr_464)))
(define-fun dynamic_invariant10 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 0 128)) (in_range22 temp___expr_471)))
(define-fun dynamic_invariant11 ((temp___expr_1275 Int) (temp___is_init_1271 Bool) (temp___skip_constant_1272 Bool) (temp___do_toplevel_1273 Bool) (temp___do_typ_inv_1274 Bool)) Bool (=> (or (= temp___is_init_1271 true) (<= 0 17)) (in_range15 temp___expr_1275)))
(define-fun dynamic_invariant12 ((temp___expr_1282 Int) (temp___is_init_1278 Bool) (temp___skip_constant_1279 Bool) (temp___do_toplevel_1280 Bool) (temp___do_typ_inv_1281 Bool)) Bool (=> (or (= temp___is_init_1278 true) (<= 1 17)) (in_range13 temp___expr_1282)))
(define-fun dynamic_invariant13 ((temp___expr_1408 Int) (temp___is_init_1404 Bool) (temp___skip_constant_1405 Bool) (temp___do_toplevel_1406 Bool) (temp___do_typ_inv_1407 Bool)) Bool (=> (or (= temp___is_init_1404 true) (<= 0 2)) (in_range17 temp___expr_1408)))
(define-fun dynamic_invariant14 ((temp___expr_1289 Int) (temp___is_init_1285 Bool) (temp___skip_constant_1286 Bool) (temp___do_toplevel_1287 Bool) (temp___do_typ_inv_1288 Bool)) Bool (=> (or (= temp___is_init_1285 true) (<= 0 17408)) (in_range14 temp___expr_1289)))
(define-fun dynamic_invariant15 ((temp___expr_1320 Int) (temp___is_init_1316 Bool) (temp___skip_constant_1317 Bool) (temp___do_toplevel_1318 Bool) (temp___do_typ_inv_1319 Bool)) Bool (=> (or (= temp___is_init_1316 true) (<= 0 1024)) (in_range16 temp___expr_1320)))
(assert true)
...
(assert (forall ((temp___1349 Int)) (=> (dynamic_invariant15 temp___1349 true true true true) (forall ((temp___1350 Int)) (= (to_rep12 (select (temp___1347 temp___1349) temp___1350)) temp___1349)))))
(define-fun dynamic_invariant16 ((temp___expr_618 Int) (temp___is_init_614 Bool) (temp___skip_constant_615 Bool) (temp___do_toplevel_616 Bool) (temp___do_typ_inv_617 Bool)) Bool (=> (or (= temp___is_init_614 true) (<= 1 150)) (in_range8 temp___expr_618)))
...
(define-fun dynamic_invariant17 ((temp___expr_670 Int) (temp___is_init_666 Bool) (temp___skip_constant_667 Bool) (temp___do_toplevel_668 Bool) (temp___do_typ_inv_669 Bool)) Bool (=> (or (= temp___is_init_666 true) (<= 1901 2099)) (in_range9 temp___expr_670)))
(define-fun dynamic_invariant18 ((temp___expr_677 Int) (temp___is_init_673 Bool) (temp___skip_constant_674 Bool) (temp___do_toplevel_675 Bool) (temp___do_typ_inv_676 Bool)) Bool (=> (or (= temp___is_init_673 true) (<= 1 12)) (in_range10 temp___expr_677)))
(define-fun dynamic_invariant19 ((temp___expr_684 Int) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool) (temp___do_typ_inv_683 Bool)) Bool (=> (or (= temp___is_init_680 true) (<= 1 31)) (in_range11 temp___expr_684)))
(define-fun dynamic_invariant20 ((temp___expr_716 Int) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool) (temp___do_typ_inv_715 Bool)) Bool (=> (or (= temp___is_init_712 true) (<= 0 86399999)) (in_range12 temp___expr_716)))
(define-fun dynamic_invariant21 ((temp___expr_1220 Int) (temp___is_init_1216 Bool) (temp___skip_constant_1217 Bool) (temp___do_toplevel_1218 Bool) (temp___do_typ_inv_1219 Bool)) Bool (=> (or (= temp___is_init_1216 true) (<= 0 3)) (in_range19 temp___expr_1220)))
(define-fun dynamic_invariant22 ((temp___expr_1234 Int) (temp___is_init_1230 Bool) (temp___skip_constant_1231 Bool) (temp___do_toplevel_1232 Bool) (temp___do_typ_inv_1233 Bool)) Bool (=> (or (= temp___is_init_1230 true) (<= 0 5)) (in_range20 temp___expr_1234)))
(define-fun dynamic_invariant23 ((temp___expr_553 Int) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool) (temp___do_typ_inv_552 Bool)) Bool (=> (or (= temp___is_init_549 true) (<= 0 4294967295)) (in_range6 temp___expr_553)))
(assert (forall ((temp___1345 Int)) (=> (dynamic_invariant12 temp___1345 true true true true) (forall ((temp___1346 Int)) (= (to_rep9 (select (temp___1343 temp___1345) temp___1346)) temp___1345)))))
