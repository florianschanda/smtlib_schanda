...
(define-fun dynamic_invariant ((temp___expr_529 Int) (temp___is_init_526 Bool) (temp___skip_constant_527 Bool) (temp___do_toplevel_528 Bool)) Bool (=> (or (= temp___is_init_526 true) (<= 0 1)) (in_range7 temp___expr_529)))
...
(assert (forall ((temp___1195 Int)) (forall ((temp___1196 Int)) (= (select (temp___1193 temp___1195) temp___1196) (of_rep9 temp___1195)))))
(declare-fun temp___1197 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1199 Int)) (forall ((temp___1200 Int)) (= (select (temp___1197 temp___1199) temp___1200) (of_rep12 temp___1199)))))
(define-fun dynamic_invariant1 ((temp___expr_1187 us_rep4) (temp___is_init_1184 Bool) (temp___skip_constant_1185 Bool) (temp___do_toplevel_1186 Bool)) Bool (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___expr_1187))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___expr_1187))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___expr_1187)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___expr_1187))) true))
(define-fun default_initial_assumption ((temp___expr_1191 us_rep4) (temp___skip_top_level_1192 Bool)) Bool (and (and (and (= (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___expr_1191))) 1) (= (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___expr_1191))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___expr_1191)) (mk___rep3 (mk___split_fields3 (temp___1193 1) (of_rep9 1) (of_rep9 1) (of_rep11 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___expr_1191)) (temp___1197 0))))
(define-fun type_invariant ((temp___1201 us_rep4)) Bool (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___1201))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___1201))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___1201)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___1201))) true))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1974 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 27)) 78)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 29)) 116)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 31)) 67)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 32)) 117)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 34)) 114)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 35)) 101)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 36)) 110)) (= (to_rep (select (temp___String_Literal_1974 us_void_param) 37)) 116)) :pattern ((temp___String_Literal_1974 us_void_param)))))
(declare-fun temp___String_Literal_1975 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1975 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 27)) 78)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 29)) 116)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 31)) 86)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 34)) 105)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 35)) 102)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 36)) 105)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 37)) 97)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 38)) 98)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 39)) 108)) (= (to_rep (select (temp___String_Literal_1975 us_void_param) 40)) 101)) :pattern ((temp___String_Literal_1975 us_void_param)))))
(declare-fun temp___String_Literal_1976 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1976 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 2)) 117)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 13)) 110)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 15)) 67)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 20)) 102)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 27)) 66)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 28)) 97)) (= (to_rep (select (temp___String_Literal_1976 us_void_param) 29)) 100)) :pattern ((temp___String_Literal_1976 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_359 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 40)) (in_range4 temp___expr_359)))
(define-fun dynamic_invariant7 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 4294967295)) (in_range5 temp___expr_380)))
(define-fun dynamic_invariant8 ((temp___expr_402 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 10)) (in_range18 temp___expr_402)))
(define-fun dynamic_invariant9 ((temp___expr_414 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 0 4294967295)) (in_range21 temp___expr_414)))
(define-fun dynamic_invariant10 ((temp___expr_420 Int) (temp___is_init_417 Bool) (temp___skip_constant_418 Bool) (temp___do_toplevel_419 Bool)) Bool (=> (or (= temp___is_init_417 true) (<= 0 128)) (in_range22 temp___expr_420)))
(define-fun dynamic_invariant11 ((temp___expr_1153 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 17)) (in_range15 temp___expr_1153)))
(define-fun dynamic_invariant12 ((temp___expr_1132 Int) (temp___is_init_1129 Bool) (temp___skip_constant_1130 Bool) (temp___do_toplevel_1131 Bool)) Bool (=> (or (= temp___is_init_1129 true) (<= 1 17)) (in_range13 temp___expr_1132)))
(define-fun dynamic_invariant13 ((temp___expr_1257 Int) (temp___is_init_1254 Bool) (temp___skip_constant_1255 Bool) (temp___do_toplevel_1256 Bool)) Bool (=> (or (= temp___is_init_1254 true) (<= 0 2)) (in_range17 temp___expr_1257)))
(define-fun dynamic_invariant14 ((temp___expr_1138 Int) (temp___is_init_1135 Bool) (temp___skip_constant_1136 Bool) (temp___do_toplevel_1137 Bool)) Bool (=> (or (= temp___is_init_1135 true) (<= 0 17408)) (in_range14 temp___expr_1138)))
(define-fun dynamic_invariant15 ((temp___expr_1172 Int) (temp___is_init_1169 Bool) (temp___skip_constant_1170 Bool) (temp___do_toplevel_1171 Bool)) Bool (=> (or (= temp___is_init_1169 true) (<= 0 1024)) (in_range16 temp___expr_1172)))
(assert true)
...
(define-fun dynamic_invariant16 ((temp___expr_551 Int) (temp___is_init_548 Bool) (temp___skip_constant_549 Bool) (temp___do_toplevel_550 Bool)) Bool (=> (or (= temp___is_init_548 true) (<= 1 150)) (in_range8 temp___expr_551)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant17 ((temp___expr_597 Int) (temp___is_init_594 Bool) (temp___skip_constant_595 Bool) (temp___do_toplevel_596 Bool)) Bool (=> (or (= temp___is_init_594 true) (<= 1901 2099)) (in_range9 temp___expr_597)))
(define-fun dynamic_invariant18 ((temp___expr_603 Int) (temp___is_init_600 Bool) (temp___skip_constant_601 Bool) (temp___do_toplevel_602 Bool)) Bool (=> (or (= temp___is_init_600 true) (<= 1 12)) (in_range10 temp___expr_603)))
(define-fun dynamic_invariant19 ((temp___expr_609 Int) (temp___is_init_606 Bool) (temp___skip_constant_607 Bool) (temp___do_toplevel_608 Bool)) Bool (=> (or (= temp___is_init_606 true) (<= 1 31)) (in_range11 temp___expr_609)))
(define-fun dynamic_invariant20 ((temp___expr_637 Int) (temp___is_init_634 Bool) (temp___skip_constant_635 Bool) (temp___do_toplevel_636 Bool)) Bool (=> (or (= temp___is_init_634 true) (<= 0 86399999)) (in_range12 temp___expr_637)))
(define-fun dynamic_invariant21 ((temp___expr_1083 Int) (temp___is_init_1080 Bool) (temp___skip_constant_1081 Bool) (temp___do_toplevel_1082 Bool)) Bool (=> (or (= temp___is_init_1080 true) (<= 0 3)) (in_range19 temp___expr_1083)))
(define-fun dynamic_invariant22 ((temp___expr_1095 Int) (temp___is_init_1092 Bool) (temp___skip_constant_1093 Bool) (temp___do_toplevel_1094 Bool)) Bool (=> (or (= temp___is_init_1092 true) (<= 0 5)) (in_range20 temp___expr_1095)))
(define-fun dynamic_invariant23 ((temp___expr_493 Int) (temp___is_init_490 Bool) (temp___skip_constant_491 Bool) (temp___do_toplevel_492 Bool)) Bool (=> (or (= temp___is_init_490 true) (<= 0 4294967295)) (in_range6 temp___expr_493)))
