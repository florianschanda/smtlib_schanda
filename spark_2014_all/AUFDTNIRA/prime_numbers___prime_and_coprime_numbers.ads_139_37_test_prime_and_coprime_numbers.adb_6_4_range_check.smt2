...
(assert (and (= o2 (+ test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1)) (in_range1 (+ test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1))))
(assert (= o3 (ite (<= o2 v1) true false)))
(assert (= result1 (ite (= o3 true) (ite (<= v1 value) true false) false)))
(assert (= result1 true))
(assert (not (in_range2 v1)))
(check-sat)
(exit)
