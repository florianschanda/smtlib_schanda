...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 1)) 32) (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 2)) 32)) (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 3)) 32)) (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 4)) 32)) (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 5)) 32)) (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 6)) 32)) (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 7)) 32)) (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 8)) 32)) (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 9)) 32)) (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 10)) 32)) (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 11)) 32)) (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 12)) 32)) (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 13)) 32)) (= (to_rep2 (select (temp___String_Literal_163 us_void_param) 14)) 32)) :pattern ((temp___String_Literal_163 us_void_param)))))
(define-fun default_initial_assumption ((temp___expr_250 us_rep1) (temp___skip_top_level_251 Bool)) Bool (and (= (attr__tag1 temp___expr_250) us_tag1) (and (and (and (= (to_rep (rec__instr__clock__seconds (us_split_fields3 temp___expr_250))) 0) (= (to_rep (rec__instr__clock__minutes (us_split_fields3 temp___expr_250))) 0)) (= (to_rep1 (rec__instr__clock__hours (us_split_fields3 temp___expr_250))) 0)) (= (rec__instr__instrument__name1 (us_split_fields3 temp___expr_250)) (temp___String_Literal_163 Tuple0)))))
...
(define-fun dynamic_invariant2 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 0 60)) (in_range1 temp___expr_236)))
(define-fun dynamic_invariant3 ((temp___expr_242 Int) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool)) Bool (=> (or (= temp___is_init_239 true) (<= 0 24)) (in_range2 temp___expr_242)))
...
(declare-const temp___367 sixty)
(declare-const temp___3671 sixty)
(declare-const temp___3672 twenty_four)
(declare-const temp___3673 (Array Int character))
(declare-const temp___3674 us_private)
(declare-const temp___3675 Int)
(declare-const o8 Int)
(declare-const o9 Int)
(declare-const o10 Int)
(declare-const o11 Int)
(declare-const o12 sixty)
(declare-const o13 sixty)
(declare-const o14 sixty)
(declare-const o15 twenty_four)
(declare-const o16 (Array Int character))
(declare-const o17 us_private)
(declare-const temp___369 sixty)
(declare-const temp___3691 sixty)
(declare-const temp___3692 twenty_four)
(declare-const temp___3693 (Array Int character))
(declare-const temp___3694 us_private)
(declare-const temp___3695 Int)
...
(declare-const ninc1 Int)
(declare-const result6 sixty)
(declare-const result7 sixty)
(declare-const result8 twenty_four)
(declare-const result9 (Array Int character))
(declare-const result10 us_private)
(declare-const x__split_fields10 sixty)
(declare-const x__split_fields11 sixty)
(declare-const x__split_fields12 twenty_four)
(declare-const x__split_fields13 (Array Int character))
(declare-const x__split_fields14 us_private)
(declare-const result11 Int)
(declare-const ninc2 Int)
(assert (in_range inc))
...
(assert (= result5 ninc))
(assert (= ninc1 o9))
(assert (and (= o10 (+ (to_rep x__split_fields6) ninc1)) (in_range (+ (to_rep x__split_fields6) ninc1))))
...
(assert (and (= o18 (+ (to_rep x__split_fields11) ninc1)) (in_range (+ (to_rep x__split_fields11) ninc1))))
(assert (= o19 (div1 o18 60)))
(assert (= result11 ninc1))
(assert (= ninc2 o19))
(assert (not (in_range (+ (to_rep1 x__split_fields12) ninc2))))
(check-sat)
(exit)
