...
(declare-const temp___393 sixty)
(declare-const temp___3931 sixty)
(declare-const temp___3932 twenty_four)
(declare-const temp___3933 (Array Int character))
(declare-const temp___3934 us_private)
(declare-const temp___3935 Int)
...
(assert (= temp___393 o13))
(assert (= temp___3931 o14))
(assert (= temp___3932 o15))
(assert (= temp___3933 o16))
(assert (= temp___3934 o17))
(assert (= x__attr__tag temp___3935))
...
(assert (= temp___393 x__split_fields10))
(assert (= temp___3931 x__split_fields11))
(assert (= temp___3932 x__split_fields12))
(assert (= temp___3933 x__split_fields13))
(assert (= temp___3934 x__split_fields14))
