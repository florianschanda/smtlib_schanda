...
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 100)) (forall ((k1 Int)) (=> (and (<= (+ j1 1) k1) (<= k1 100)) (<= (to_rep (select items j1)) (to_rep (select items k1))))))))
...
(assert (and (<= (to_rep (select items low_index2)) search_item) (<= search_item (to_rep (select items high_index2)))))
(assert (and (and (and (=> (<= 1 100) (in_range2 result__3)) (=> (<= 1 100) (in_range2 low_index2))) (=> (<= 1 100) (in_range2 mid_index3))) (=> (<= 1 100) (in_range2 high_index2))))
(assert (=> (< (to_rep (select items mid_index3)) search_item) (= low_index2 result7)))
(assert (=> (< (to_rep (select items mid_index3)) search_item) (= low_index3 mid_index3)))
(assert (=> (< (to_rep (select items mid_index3)) search_item) (= high_index3 high_index2)))
(assert (=> (not (< (to_rep (select items mid_index3)) search_item)) (= high_index2 result8)))
...
(assert (not (<= (to_rep (select items low_index3)) search_item)))
(check-sat)
(exit)
