...
(assert (and (= o20 (length (mk___rep1 p__split_discrs p__split_fields2))) (and (in_range6 o20) (<= o20 (capacity (mk___rep1 p__split_discrs p__split_fields2))))))
(assert (not (in_range5 o20)))
(check-sat)
(exit)
