...
(assert (and (= o16 (length (mk___rep1 p__split_discrs p__split_fields2))) (and (in_range6 o16) (<= o16 (capacity (mk___rep1 p__split_discrs p__split_fields2))))))
(assert (not (in_range5 o16)))
(check-sat)
(exit)
