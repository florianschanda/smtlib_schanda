...
(assert (not (= (capacity (mk___rep p__split_discrs (us_split_fields__content p__split_fields6))) (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields))))))
(check-sat)
(exit)
