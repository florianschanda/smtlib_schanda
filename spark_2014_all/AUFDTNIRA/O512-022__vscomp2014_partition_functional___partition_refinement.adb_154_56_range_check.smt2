...
(assert (not (in_range3 (- (+ (to_rep2 (rec__partition_refinement__interval__first p_elem__split_fields1)) (to_rep1 (rec__partition_refinement__interval__count p_elem__split_fields1))) 1))))
(check-sat)
(exit)
