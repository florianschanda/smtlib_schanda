...
(assert (not (in_range5 (- (+ (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields5)) (to_rep (rec__partition_refinement__interval__count p_elem__split_fields5))) 1))))
(check-sat)
(exit)
