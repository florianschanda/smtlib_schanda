...
(assert (= result true))
(assert (and (= o24 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o24 true) (in_range4 (to_rep1 theadmin__split_fields1)))))
(assert (= o25 (ite (not (= o24 true)) true false)))
