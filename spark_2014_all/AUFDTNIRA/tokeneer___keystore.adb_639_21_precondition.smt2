...
(assert (forall ((x namecountt)) (! (in_range7 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x issueridt)) (! (in_range8 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_884 Int) (temp___is_init_881 Bool) (temp___skip_constant_882 Bool) (temp___do_toplevel_883 Bool)) Bool (=> (or (= temp___is_init_881 true) (<= 0 10)) (in_range9 temp___expr_884)))
...
(assert (forall ((x logfileindext)) (! (in_range10 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range11 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_150 Int)) (=> (and (<= a__first temp___idx_150) (<= temp___idx_150 a__last)) (= (to_rep4 (select a temp___idx_150)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_150)))))))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq3 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep4 (select a (+ i 1))) (to_rep4 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq3 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep4 (select b (+ i 1))) (to_rep4 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((x logfilecountt)) (! (in_range12 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x fileentrycountt)) (! (in_range13 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq5 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep7 (select a (+ i 1))) (to_rep7 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq5 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep7 (select b (+ i 1))) (to_rep7 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq6 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (= (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 a))) (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 b)))) (= (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 a))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 b))))) (= (bool_eq4 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 b))) true)) (= (bool_eq5 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 b)) 1 17) true)) true false))
...
(assert (forall ((temp___1089 Int)) (forall ((temp___1090 Int)) (= (select (temp___1087 temp___1089) temp___1090) (of_rep4 temp___1089)))))
(declare-fun temp___1091 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1093 Int)) (forall ((temp___1094 Int)) (= (select (temp___1091 temp___1093) temp___1094) (of_rep7 temp___1093)))))
(define-fun dynamic_invariant4 ((temp___expr_1081 us_rep2) (temp___is_init_1078 Bool) (temp___skip_constant_1079 Bool) (temp___do_toplevel_1080 Bool)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1081))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1081))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1081)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1081))) true))
(define-fun default_initial_assumption ((temp___expr_1085 us_rep2) (temp___skip_top_level_1086 Bool)) Bool (and (and (and (= (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1085))) 1) (= (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1085))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1085)) (mk___rep1 (mk___split_fields1 (temp___1087 1) (of_rep4 1) (of_rep4 1) (of_rep6 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1085)) (temp___1091 0))))
(define-fun type_invariant ((temp___1095 us_rep2)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1095))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1095))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1095)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1095))) true))
...
(assert (forall ((x filestatust)) (! (in_range14 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep8 (select a temp___idx_153)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare3 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq9 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep8 (select a (+ i 1))) (to_rep8 (select b (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare3 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq9 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep8 (select b (+ i 1))) (to_rep8 (select a (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-sort rawcertificatei 0)
(define-fun in_range15 ((x Int)) Bool (and (<= 1 x) (<= x 4096)))
(declare-fun attr__ATTRIBUTE_IMAGE15 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check15 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE15 (us_image) Int)
(declare-fun user_eq22 (rawcertificatei rawcertificatei) Bool)
(declare-const dummy22 rawcertificatei)
...
(declare-fun to_rep9 (rawcertificatei) Int)
(declare-fun of_rep9 (Int) rawcertificatei)
(assert (forall ((x rawcertificatei)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)))))
(assert (forall ((x rawcertificatei)) (! (in_range15 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__certtypes__rawdatat__rawdata (Array Int character)) (rec__certtypes__rawdatat__datalength rawcertificatei)))))
(define-fun us_split_fields_RawData__projection ((a us_split_fields6)) (Array Int character) (rec__certtypes__rawdatat__rawdata a))
(define-fun us_split_fields_DataLength__projection ((a us_split_fields6)) rawcertificatei (rec__certtypes__rawdatat__datalength a))
...
(define-fun bool_eq10 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (bool_eq (rec__certtypes__rawdatat__rawdata (us_split_fields7 a)) 1 4096 (rec__certtypes__rawdatat__rawdata (us_split_fields7 b)) 1 4096) true) (= (to_rep9 (rec__certtypes__rawdatat__datalength (us_split_fields7 a))) (to_rep9 (rec__certtypes__rawdatat__datalength (us_split_fields7 b))))) true false))
...
(declare-datatypes () ((rawdatat__ref (mk_rawdatat__ref (rawdatat__content us_rep4)))))
(define-fun rawdatat__ref___projection ((a rawdatat__ref)) us_rep4 (rawdatat__content a))
...
(declare-fun user_eq25 (sigdatai sigdatai) Bool)
(declare-const dummy25 sigdatai)
...
(declare-fun to_rep10 (sigdatai) Int)
(declare-fun of_rep10 (Int) sigdatai)
(assert (forall ((x sigdatai)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x sigdatai)) (! (in_range16 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__certtypes__signaturet__sigdata (Array Int character)) (rec__certtypes__signaturet__siglength sigdatai)))))
(define-fun us_split_fields_SigData__projection ((a us_split_fields8)) (Array Int character) (rec__certtypes__signaturet__sigdata a))
(define-fun us_split_fields_SigLength__projection ((a us_split_fields8)) sigdatai (rec__certtypes__signaturet__siglength a))
...
(define-fun bool_eq11 ((a us_rep5) (b us_rep5)) Bool (ite (and (= (bool_eq (rec__certtypes__signaturet__sigdata (us_split_fields9 a)) 1 4096 (rec__certtypes__signaturet__sigdata (us_split_fields9 b)) 1 4096) true) (= (to_rep10 (rec__certtypes__signaturet__siglength (us_split_fields9 a))) (to_rep10 (rec__certtypes__signaturet__siglength (us_split_fields9 b))))) true false))
...
(declare-datatypes () ((signaturet__ref (mk_signaturet__ref (signaturet__content us_rep5)))))
(define-fun signaturet__ref___projection ((a signaturet__ref)) us_rep5 (signaturet__content a))
(declare-const mechanism Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-const rawcertdata us_rep4)
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-const signature us_rep5)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-const theissuer us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-const attr__ATTRIBUTE_ADDRESS11 Int)
(declare-sort returnvaluet 0)
(define-fun in_range17 ((x Int)) Bool (and (<= 0 x) (<= x 28)))
...
(define-fun dynamic_invariant5 ((temp___expr_1463 Int) (temp___is_init_1460 Bool) (temp___skip_constant_1461 Bool) (temp___do_toplevel_1462 Bool)) Bool (=> (or (= temp___is_init_1460 true) (<= 0 28)) (in_range17 temp___expr_1463)))
(declare-fun to_rep11 (unsigned32t) Int)
(declare-fun of_rep11 (Int) unsigned32t)
(assert (forall ((x unsigned32t)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x unsigned32t)) (! (in_range5 (to_rep11 x)) :pattern ((to_rep11 x)))))
(assert (forall ((x Int)) (! (=> (in_range5 x) (= (to_rep11 (of_rep11 x)) x)) :pattern ((to_rep11 (of_rep11 x))))))
(declare-fun to_rep12 (returnvaluet) Int)
(declare-fun of_rep12 (Int) returnvaluet)
(assert (forall ((x returnvaluet)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x returnvaluet)) (! (in_range17 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(declare-fun user_eq29 (bytet bytet) Bool)
(declare-const dummy29 bytet)
...
(declare-fun to_rep13 (bytet) Int)
(declare-fun of_rep13 (Int) bytet)
(assert (forall ((x bytet)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x bytet)) (! (in_range18 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare4 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq12 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep13 (select a (+ i 1))) (to_rep13 (select b (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare4 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq12 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep13 (select b (+ i 1))) (to_rep13 (select a (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(declare-const dummy30 (Array Int bytet))
(declare-const value__size12 Int)
(declare-fun object__size12 ((Array Int bytet)) Int)
...
(declare-fun object__alignment12 ((Array Int bytet)) Int)
(assert (<= 0 value__size12))
(assert (forall ((a (Array Int bytet))) (<= 0 (object__size12 a))))
(assert (<= 0 value__component__size6))
(assert (forall ((a (Array Int bytet))) (<= 0 (object__component__size6 a))))
(assert (<= 0 value__alignment12))
(assert (forall ((a (Array Int bytet))) (<= 0 (object__alignment12 a))))
(declare-fun user_eq30 ((Array Int bytet) (Array Int bytet)) Bool)
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__keystore__interfac__digestt__digestid unsigned32t) (rec__keystore__interfac__digestt__signreturn returnvaluet) (rec__keystore__interfac__digestt__verifyreturn returnvaluet) (rec__keystore__interfac__digestt__pad (Array Int bytet))))))
(define-fun us_split_fields_DigestID__projection ((a us_split_fields10)) unsigned32t (rec__keystore__interfac__digestt__digestid a))
(define-fun us_split_fields_SignReturn__projection ((a us_split_fields10)) returnvaluet (rec__keystore__interfac__digestt__signreturn a))
(define-fun us_split_fields_VerifyReturn__projection ((a us_split_fields10)) returnvaluet (rec__keystore__interfac__digestt__verifyreturn a))
(define-fun us_split_fields_Pad__2__projection ((a us_split_fields10)) (Array Int bytet) (rec__keystore__interfac__digestt__pad a))
...
(define-fun bool_eq13 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (= (to_rep11 (rec__keystore__interfac__digestt__digestid (us_split_fields11 a))) (to_rep11 (rec__keystore__interfac__digestt__digestid (us_split_fields11 b)))) (= (to_rep12 (rec__keystore__interfac__digestt__signreturn (us_split_fields11 a))) (to_rep12 (rec__keystore__interfac__digestt__signreturn (us_split_fields11 b))))) (= (to_rep12 (rec__keystore__interfac__digestt__verifyreturn (us_split_fields11 a))) (to_rep12 (rec__keystore__interfac__digestt__verifyreturn (us_split_fields11 b))))) (= (bool_eq12 (rec__keystore__interfac__digestt__pad (us_split_fields11 a)) 1 20 (rec__keystore__interfac__digestt__pad (us_split_fields11 b)) 1 20) true)) true false))
(declare-const value__size13 Int)
(declare-fun object__size13 (us_rep6) Int)
(declare-const value__alignment13 Int)
(declare-fun object__alignment13 (us_rep6) Int)
(assert (<= 0 value__size13))
(assert (forall ((a us_rep6)) (<= 0 (object__size13 a))))
(assert (<= 0 value__alignment13))
(assert (forall ((a us_rep6)) (<= 0 (object__alignment13 a))))
...
(declare-datatypes () ((digestt__ref (mk_digestt__ref (digestt__content us_rep6)))))
(define-fun digestt__ref___projection ((a digestt__ref)) us_rep6 (digestt__content a))
...
(define-fun bool_eq15 ((x us_t1) (y us_t1)) Bool (bool_eq (elts1 x) (to_rep1 (first2 (rt1 x))) (to_rep1 (last2 (rt1 x))) (elts1 y) (to_rep1 (first2 (rt1 y))) (to_rep1 (last2 (rt1 y)))))
(declare-fun user_eq33 (us_t1 us_t1) Bool)
(declare-const dummy33 us_t1)
(declare-datatypes () ((t127b__ref (mk_t127b__ref (t127b__content us_t1)))))
(define-fun t127b__ref___projection ((a t127b__ref)) us_t1 (t127b__content a))
(declare-fun temp___String_Literal_1597 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1597 us_void_param) 1)) 86) (= (to_rep (select (temp___String_Literal_1597 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1597 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1597 us_void_param) 4)) 105)) (= (to_rep (select (temp___String_Literal_1597 us_void_param) 5)) 102)) (= (to_rep (select (temp___String_Literal_1597 us_void_param) 6)) 121)) :pattern ((temp___String_Literal_1597 us_void_param)))))
(declare-fun temp___String_Literal_1607 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1607 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 23)) 110)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 25)) 86)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 27)) 114)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 28)) 105)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 29)) 102)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 30)) 121)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 32)) 58)) (= (to_rep (select (temp___String_Literal_1607 us_void_param) 33)) 32)) :pattern ((temp___String_Literal_1607 us_void_param)))))
...
(define-fun dynamic_invariant9 ((temp___expr_238 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 0 255)) (in_range18 temp___expr_238)))
(define-fun dynamic_invariant10 ((temp___expr_1247 Int) (temp___is_init_1244 Bool) (temp___skip_constant_1245 Bool) (temp___do_toplevel_1246 Bool)) Bool (=> (or (= temp___is_init_1244 true) (<= 1 4096)) (in_range15 temp___expr_1247)))
(define-fun dynamic_invariant11 ((temp___expr_1279 Int) (temp___is_init_1276 Bool) (temp___skip_constant_1277 Bool) (temp___do_toplevel_1278 Bool)) Bool (=> (or (= temp___is_init_1276 true) (<= 1 4096)) (in_range16 temp___expr_1279)))
(define-fun dynamic_invariant12 ((temp___expr_841 Int) (temp___is_init_838 Bool) (temp___skip_constant_839 Bool) (temp___do_toplevel_840 Bool)) Bool (=> (or (= temp___is_init_838 true) (<= 0 40)) (in_range7 temp___expr_841)))
(define-fun dynamic_invariant13 ((temp___expr_862 Int) (temp___is_init_859 Bool) (temp___skip_constant_860 Bool) (temp___do_toplevel_861 Bool)) Bool (=> (or (= temp___is_init_859 true) (<= 0 4294967295)) (in_range8 temp___expr_862)))
(define-fun dynamic_invariant14 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 150)) (in_range6 temp___expr_385)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_136 Tuple0)))
(define-fun dynamic_invariant15 ((temp___expr_1047 Int) (temp___is_init_1044 Bool) (temp___skip_constant_1045 Bool) (temp___do_toplevel_1046 Bool)) Bool (=> (or (= temp___is_init_1044 true) (<= 0 17)) (in_range12 temp___expr_1047)))
(define-fun dynamic_invariant16 ((temp___expr_1026 Int) (temp___is_init_1023 Bool) (temp___skip_constant_1024 Bool) (temp___do_toplevel_1025 Bool)) Bool (=> (or (= temp___is_init_1023 true) (<= 1 17)) (in_range10 temp___expr_1026)))
(define-fun dynamic_invariant17 ((temp___expr_1151 Int) (temp___is_init_1148 Bool) (temp___skip_constant_1149 Bool) (temp___do_toplevel_1150 Bool)) Bool (=> (or (= temp___is_init_1148 true) (<= 0 2)) (in_range14 temp___expr_1151)))
(define-fun dynamic_invariant18 ((temp___expr_1032 Int) (temp___is_init_1029 Bool) (temp___skip_constant_1030 Bool) (temp___do_toplevel_1031 Bool)) Bool (=> (or (= temp___is_init_1029 true) (<= 0 17408)) (in_range11 temp___expr_1032)))
(define-fun dynamic_invariant19 ((temp___expr_1066 Int) (temp___is_init_1063 Bool) (temp___skip_constant_1064 Bool) (temp___do_toplevel_1065 Bool)) Bool (=> (or (= temp___is_init_1063 true) (<= 0 1024)) (in_range13 temp___expr_1066)))
(assert true)
...
(declare-const c122b (Array Int character))
...
(declare-const keystore__isverifiedby__B124b__thestring__assume (Array Int character))
(declare-const keystore__isverifiedby__B124b__thestring__assume1 t)
(declare-const o6 Int)
(declare-const temp___1601 (Array Int character))
(declare-const temp___16011 t1)
(declare-const temp___1603 Int)
(declare-const o7 (Array Int character))
(declare-const temp___1604 (Array Int character))
(declare-const temp___16041 t1)
(declare-const temp___1605 (Array Int character))
(declare-const temp___16051 t1)
(declare-const o8 (Array Int character))
(declare-const temp___1600 (Array Int character))
(declare-const temp___16001 t)
...
(assert (=> (<= 0 28) (in_range17 retval)))
(assert (and (= (valid_numberlogentries (to_rep4 logfilestate__split_fields7) (to_rep5 logfilestate__split_fields8) (mk___rep1 (mk___split_fields1 logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) true) (in_range4 auditalarm1)))
(assert (= digested true))
(assert (and (and (in_range5 theissuerkey1) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields14)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields14)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields14)) true)) (in_range4 auditalarm2)))
(assert (in_range17 retval1))
(assert (= result (mk_bool__ref verified)))
(assert (= verified1 (ite (= retval1 0) true false)))
(assert (= (select issystem retval1) true))
(assert (= retval1 c120b))
(assert (in_range17 c120b))
(assert (= result1 (mk_map__ref result__)))
(assert (= result__1 nodescription))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE17 c120b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE17 c120b)))))) (= o (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE17 c120b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE17 c120b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE17 c120b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE17 c120b))))))) (= o 0)))
...
(assert (= (concat1 (temp___String_Literal_1607 Tuple0) 1 33 (elts (to_string (attr__ATTRIBUTE_IMAGE17 c120b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE17 c120b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE17 c120b)))))) keystore__isverifiedby__B124b__thestring__assume))
(assert (= (mk 1 o5) keystore__isverifiedby__B124b__thestring__assume1))
(assert (= (mk___t keystore__isverifiedby__B124b__thestring__assume keystore__isverifiedby__B124b__thestring__assume1) thestring))
...
(assert (=> (= result2 true) (= (ite (<= (to_rep1 (first (rt thestring))) (to_rep1 (last (rt thestring)))) (+ (- (to_rep1 (last (rt thestring))) (to_rep1 (first (rt thestring)))) 1) 0) (ite (<= 1 (length thestring)) (+ (- (length thestring) 1) 1) 0))))
(assert (=> (= result2 true) (= (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) temp___1601)))
(assert (=> (= result2 true) (= (mk1 1 (length thestring)) temp___16011)))
(assert (=> (= result2 true) (and (= temp___1603 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= result2 true) (=> (<= 1 temp___1603) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1603) (<= temp___1603 150))))))
(assert (=> (= result2 true) (= o7 result__1)))
(assert (=> (= result2 true) (= o7 temp___1604)))
(assert (=> (= result2 true) (= (mk1 1 temp___1603) temp___16041)))
(assert (=> (= result2 true) (= (ite (<= (to_rep1 (first2 temp___16011)) (to_rep1 (last2 temp___16011))) (+ (- (to_rep1 (last2 temp___16011)) (to_rep1 (first2 temp___16011))) 1) 0) (ite (<= (to_rep1 (first2 temp___16041)) (to_rep1 (last2 temp___16041))) (+ (- (to_rep1 (last2 temp___16041)) (to_rep1 (first2 temp___16041))) 1) 0))))
(assert (=> (= result2 true) (= (mk___t1 temp___1605 temp___16051) (mk___t1 temp___1601 temp___16011))))
(assert (=> (= result2 true) (forall ((temp___1606 Int)) (ite (and (<= 1 temp___1606) (<= temp___1606 (length thestring))) (= (select o8 temp___1606) (select temp___1605 temp___1606)) (= (select o8 temp___1606) (select result__1 temp___1606))))))
(assert (=> (= result2 true) (= result3 (mk_map__ref result__1))))
(assert (=> (= result2 true) (= result__2 o8)))
(assert (=> (not (= result2 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring))) 1) (<= 1 (to_rep1 (last (rt thestring))))) (and (<= (to_rep1 (first (rt thestring))) 150) (<= 150 (to_rep1 (last (rt thestring)))))))))
(assert (=> (not (= result2 true)) (= (mk___t temp___1600 temp___16001) thestring)))
(assert (=> (not (= result2 true)) (= o9 temp___1600)))
(assert (=> (not (= result2 true)) (= result4 (mk_map__ref result__1))))
(assert (=> (not (= result2 true)) (= result__3 o9)))
(assert (=> (not (= result2 true)) (= result__2 result__3)))
(assert (= result5 (mk_map__ref c122b)))
(assert (= c122b1 result__2))
