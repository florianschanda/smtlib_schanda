...
(define-fun dynamic_invariant ((temp___expr_514 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 0 1)) (in_range8 temp___expr_514)))
...
(assert true)
(define-fun dynamic_invariant1 ((temp___expr_501 Int) (temp___is_init_498 Bool) (temp___skip_constant_499 Bool) (temp___do_toplevel_500 Bool)) Bool (=> (or (= temp___is_init_498 true) (<= 0 5)) (in_range7 temp___expr_501)))
...
(assert (forall ((temp___1139 Int)) (forall ((temp___1140 Int)) (= (select (temp___1137 temp___1139) temp___1140) (of_rep10 temp___1139)))))
(declare-fun temp___1141 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1143 Int)) (forall ((temp___1144 Int)) (= (select (temp___1141 temp___1143) temp___1144) (of_rep13 temp___1143)))))
(define-fun dynamic_invariant2 ((temp___expr_1131 us_rep5) (temp___is_init_1128 Bool) (temp___skip_constant_1129 Bool) (temp___do_toplevel_1130 Bool)) Bool (= (valid_numberlogentries (to_rep10 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___expr_1131))) (to_rep11 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___expr_1131))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___expr_1131)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___expr_1131))) true))
(define-fun default_initial_assumption ((temp___expr_1135 us_rep5) (temp___skip_top_level_1136 Bool)) Bool (and (and (and (= (to_rep10 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___expr_1135))) 1) (= (to_rep11 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___expr_1135))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___expr_1135)) (mk___rep4 (mk___split_fields4 (temp___1137 1) (of_rep10 1) (of_rep10 1) (of_rep12 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___expr_1135)) (temp___1141 0))))
(define-fun type_invariant ((temp___1145 us_rep5)) Bool (= (valid_numberlogentries (to_rep10 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___1145))) (to_rep11 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___1145))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___1145)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___1145))) true))
...
(define-fun dynamic_invariant3 ((temp___expr_489 Int) (temp___is_init_486 Bool) (temp___skip_constant_487 Bool) (temp___do_toplevel_488 Bool)) Bool (=> (or (= temp___is_init_486 true) (<= 0 3)) (in_range21 temp___expr_489)))
...
(assert true)
(define-fun dynamic_invariant4 ((temp___expr_465 Int) (temp___is_init_462 Bool) (temp___skip_constant_463 Bool) (temp___do_toplevel_464 Bool)) Bool (=> (or (= temp___is_init_462 true) (<= 0 4294967295)) (in_range6 temp___expr_465)))
...
(declare-fun temp___String_Literal_2562 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2562 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 4)) 83)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 8)) 97)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 9)) 108)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 11)) 78)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 12)) 117)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 13)) 109)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 14)) 98)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 17)) 115)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 20)) 118)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 21)) 97)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 24)) 98)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 25)) 108)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 28)) 102)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 29)) 111)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 30)) 114)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 32)) 105)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 33)) 115)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 34)) 115)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 35)) 117)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 36)) 101)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 38)) 111)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 39)) 102)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 41)) 65)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 42)) 117)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 43)) 116)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 44)) 104)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 45)) 111)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 46)) 114)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 47)) 105)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 48)) 115)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 49)) 97)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 50)) 116)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 51)) 105)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 52)) 111)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 53)) 110)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 54)) 32)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 55)) 67)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 56)) 101)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 57)) 114)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 58)) 116)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 59)) 105)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 60)) 102)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 61)) 105)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 62)) 99)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 63)) 97)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 64)) 116)) (= (to_rep (select (temp___String_Literal_2562 us_void_param) 65)) 101)) :pattern ((temp___String_Literal_2562 us_void_param)))))
...
(define-fun dynamic_invariant9 ((temp___expr_2180 Int) (temp___is_init_2177 Bool) (temp___skip_constant_2178 Bool) (temp___do_toplevel_2179 Bool)) Bool (=> (or (= temp___is_init_2177 true) (<= 0 3)) (in_range22 temp___expr_2180)))
(define-fun dynamic_invariant10 ((temp___expr_1097 Int) (temp___is_init_1094 Bool) (temp___skip_constant_1095 Bool) (temp___do_toplevel_1096 Bool)) Bool (=> (or (= temp___is_init_1094 true) (<= 0 17)) (in_range15 temp___expr_1097)))
(define-fun dynamic_invariant11 ((temp___expr_1076 Int) (temp___is_init_1073 Bool) (temp___skip_constant_1074 Bool) (temp___do_toplevel_1075 Bool)) Bool (=> (or (= temp___is_init_1073 true) (<= 1 17)) (in_range13 temp___expr_1076)))
(define-fun dynamic_invariant12 ((temp___expr_1201 Int) (temp___is_init_1198 Bool) (temp___skip_constant_1199 Bool) (temp___do_toplevel_1200 Bool)) Bool (=> (or (= temp___is_init_1198 true) (<= 0 2)) (in_range17 temp___expr_1201)))
(define-fun dynamic_invariant13 ((temp___expr_1082 Int) (temp___is_init_1079 Bool) (temp___skip_constant_1080 Bool) (temp___do_toplevel_1081 Bool)) Bool (=> (or (= temp___is_init_1079 true) (<= 0 17408)) (in_range14 temp___expr_1082)))
(define-fun dynamic_invariant14 ((temp___expr_1116 Int) (temp___is_init_1113 Bool) (temp___skip_constant_1114 Bool) (temp___do_toplevel_1115 Bool)) Bool (=> (or (= temp___is_init_1113 true) (<= 0 1024)) (in_range16 temp___expr_1116)))
(assert true)
...
(define-fun dynamic_invariant15 ((temp___expr_578 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 1901 2099)) (in_range9 temp___expr_578)))
(define-fun dynamic_invariant16 ((temp___expr_584 Int) (temp___is_init_581 Bool) (temp___skip_constant_582 Bool) (temp___do_toplevel_583 Bool)) Bool (=> (or (= temp___is_init_581 true) (<= 1 12)) (in_range10 temp___expr_584)))
(define-fun dynamic_invariant17 ((temp___expr_590 Int) (temp___is_init_587 Bool) (temp___skip_constant_588 Bool) (temp___do_toplevel_589 Bool)) Bool (=> (or (= temp___is_init_587 true) (<= 1 31)) (in_range11 temp___expr_590)))
(define-fun dynamic_invariant18 ((temp___expr_614 Int) (temp___is_init_611 Bool) (temp___skip_constant_612 Bool) (temp___do_toplevel_613 Bool)) Bool (=> (or (= temp___is_init_611 true) (<= 0 86399999)) (in_range12 temp___expr_614)))
(assert (= zerotime (mk___rep3 (mk___split_fields3 (of_rep6 1901) (of_rep7 1) (of_rep8 1) (of_rep9 0)))))
(define-fun dynamic_invariant19 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 40)) (in_range4 temp___expr_319)))
(define-fun dynamic_invariant20 ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 0 4294967295)) (in_range5 temp___expr_340)))
(define-fun dynamic_invariant21 ((temp___expr_362 Int) (temp___is_init_359 Bool) (temp___skip_constant_360 Bool) (temp___do_toplevel_361 Bool)) Bool (=> (or (= temp___is_init_359 true) (<= 0 10)) (in_range18 temp___expr_362)))
(define-fun dynamic_invariant22 ((temp___expr_374 Int) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool)) Bool (=> (or (= temp___is_init_371 true) (<= 0 4294967295)) (in_range19 temp___expr_374)))
(define-fun dynamic_invariant23 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 128)) (in_range20 temp___expr_380)))
...
(declare-const temp___2583 us_rep3)
...
(declare-const temp___2554 us_rep2)
(declare-const o11 Int)
(declare-const o12 Int)
(declare-const o13 classt)
(declare-const o14 us_split_fields4)
(declare-const temp___2556 us_rep2)
(declare-const temp___2557 us_rep3)
...
(declare-const temp___2561 us_rep1)
...
(assert (= temp___2583 (mk___rep3 o4)))
(assert (= temp___2583 zerotime))
...
(assert (= temp___2554 (mk___rep2 o10)))
(assert (= result clearance__split_fields))
(assert (= (let ((subject clearance__split_fields)) clearance__split_fields1) (us_split_fields5 temp___2554)))
...
(assert (=> (= result1 true) (= temp___2556 (mk___rep2 o14))))
(assert (=> (= result1 true) (= result2 (let ((subject clearance__split_fields)) (mk___split_fields__ref2 clearance__split_fields1)))))
(assert (=> (= result1 true) (= (let ((subject clearance__split_fields)) clearance__split_fields2) (us_split_fields5 temp___2556))))
...
(assert (=> (= result3 true) (and (= temp___2557 (thecurrenttime (mk___split_fields3 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime))) (= temp___2557 (mk___rep3 (mk___split_fields3 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3))))))
...
(assert (=> (= result3 true) (= notbefore__split_fields4 (us_split_fields7 temp___2557))))
...
(assert (= temp___2559 (mk___rep1 o17)))
...
(assert (= id__split_fields4 (us_split_fields3 temp___2559)))
