...
(assert (= k2 o9))
(assert (in_range4 k2))
(assert (= (no_char_in_slice eof_ch cur_position_at_start (- (+ cur_position_at_start n) 2) the_file) true))
(assert (not (= k2 (- (find_char_in_slice 10 cur_position_at_start (- (+ cur_position_at_start n) 2) the_file) cur_position_at_start))))
(check-sat)
(exit)
