...
(assert (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___188 Int)) (=> (and (<= 0 temp___188) (<= temp___188 30)) (=> (< i2 temp___188) (= (select a4 temp___188) (select a2 temp___188)))))) (and (<= 2 i2) (<= i2 30))))
(assert (not (= i2 30)))
(assert (= i2 result4))
(assert (= i3 (+ i2 1)))
(assert (and (= o7 (+ (to_rep (select a4 (- i3 1))) (to_rep (select a4 (- i3 2))))) (in_range1 (+ (to_rep (select a4 (- i3 1))) (to_rep (select a4 (- i3 2)))))))
(assert (= (to_rep o8) o7))
(assert (= o9 (store a4 i3 o8)))
(assert (= result5 a4))
(assert (= a5 o9))
(assert (not (= (to_rep (select a5 0)) 0)))
(check-sat)
(exit)
