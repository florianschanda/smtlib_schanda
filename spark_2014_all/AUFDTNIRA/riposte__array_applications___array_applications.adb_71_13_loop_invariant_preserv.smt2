...
(assert (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___164 Int)) (=> (and (<= 0 temp___164) (<= temp___164 30)) (=> (< i2 temp___164) (= (select a4 temp___164) (select a2 temp___164)))))) (and (<= 2 i2) (<= i2 30))))
(assert (not (= i2 30)))
(assert (= i2 result4))
(assert (= i3 (+ i2 1)))
(assert (and (= o21 (+ (to_rep (select a4 (- i3 1))) (to_rep (select a4 (- i3 2))))) (in_range1 (+ (to_rep (select a4 (- i3 1))) (to_rep (select a4 (- i3 2)))))))
(assert (= (to_rep o22) o21))
(assert (= o23 (store a4 i3 o22)))
(assert (= result5 a4))
(assert (= a5 o23))
