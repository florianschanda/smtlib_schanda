...
(assert (= result7 (mk_bool__ref authvalid)))
(assert (= authvalid2 (of_int 0)))
(assert (= result8 (mk_bool__ref idvalid)))
(assert (= idvalid2 (of_int 0)))
(assert (= result9 (mk_bool__ref roleok)))
(assert (= roleok4 (of_int 0)))
