...
(assert (and (= o17 k) (in_range9 k)))
(assert (and (= o18 (get (model__ (mk___rep p__split_discrs p__split_fields3)) o17)) (= (bool_eq o18 (get (model__ (mk___rep p__split_discrs p__split_fields3)) o17)) true)))
(assert (= o19 (us_split_fields3 o18)))
