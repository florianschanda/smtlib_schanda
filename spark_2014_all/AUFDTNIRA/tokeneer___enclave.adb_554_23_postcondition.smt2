...
(define-fun in_range25 ((x Int)) Bool (and (<= 1 x) (<= x 3)))
...
(declare-fun user_eq41 (adminprivileget adminprivileget) Bool)
(declare-const dummy41 adminprivileget)
...
(define-fun dynamic_invariant5 ((temp___expr_2670 Int) (temp___is_init_2667 Bool) (temp___skip_constant_2668 Bool) (temp___do_toplevel_2669 Bool)) Bool (=> (or (= temp___is_init_2667 true) (<= 0 8)) (in_range26 temp___expr_2670)))
...
(define-fun dynamic_invariant11 ((temp___expr_389 Int) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (or (= temp___is_init_386 true) (<= 1 3)) (in_range25 temp___expr_389)))
...
(define-fun dynamic_invariant14 ((temp___expr_999 Int) (temp___is_init_996 Bool) (temp___skip_constant_997 Bool) (temp___do_toplevel_998 Bool)) Bool (=> (or (= temp___is_init_996 true) (<= 0 4294967295)) (in_range21 temp___expr_999)))
...
(define-fun dynamic_invariant16 ((temp___expr_1033 Int) (temp___is_init_1030 Bool) (temp___skip_constant_1031 Bool) (temp___do_toplevel_1032 Bool)) Bool (=> (or (= temp___is_init_1030 true) (<= 0 4294967295)) (in_range23 temp___expr_1033)))
(define-fun dynamic_invariant17 ((temp___expr_1039 Int) (temp___is_init_1036 Bool) (temp___skip_constant_1037 Bool) (temp___do_toplevel_1038 Bool)) Bool (=> (or (= temp___is_init_1036 true) (<= 0 128)) (in_range24 temp___expr_1039)))
(define-fun dynamic_invariant18 ((temp___expr_1163 Int) (temp___is_init_1160 Bool) (temp___skip_constant_1161 Bool) (temp___do_toplevel_1162 Bool)) Bool (=> (or (= temp___is_init_1160 true) (<= 0 17)) (in_range8 temp___expr_1163)))
(define-fun dynamic_invariant19 ((temp___expr_1142 Int) (temp___is_init_1139 Bool) (temp___skip_constant_1140 Bool) (temp___do_toplevel_1141 Bool)) Bool (=> (or (= temp___is_init_1139 true) (<= 1 17)) (in_range6 temp___expr_1142)))
(define-fun dynamic_invariant20 ((temp___expr_1267 Int) (temp___is_init_1264 Bool) (temp___skip_constant_1265 Bool) (temp___do_toplevel_1266 Bool)) Bool (=> (or (= temp___is_init_1264 true) (<= 0 2)) (in_range10 temp___expr_1267)))
(define-fun dynamic_invariant21 ((temp___expr_1148 Int) (temp___is_init_1145 Bool) (temp___skip_constant_1146 Bool) (temp___do_toplevel_1147 Bool)) Bool (=> (or (= temp___is_init_1145 true) (<= 0 17408)) (in_range7 temp___expr_1148)))
(define-fun dynamic_invariant22 ((temp___expr_1182 Int) (temp___is_init_1179 Bool) (temp___skip_constant_1180 Bool) (temp___do_toplevel_1181 Bool)) Bool (=> (or (= temp___is_init_1179 true) (<= 0 1024)) (in_range9 temp___expr_1182)))
(assert true)
...
(define-fun dynamic_invariant23 ((temp___expr_514 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 1 150)) (in_range5 temp___expr_514)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant24 ((temp___expr_560 Int) (temp___is_init_557 Bool) (temp___skip_constant_558 Bool) (temp___do_toplevel_559 Bool)) Bool (=> (or (= temp___is_init_557 true) (<= 1901 2099)) (in_range15 temp___expr_560)))
(define-fun dynamic_invariant25 ((temp___expr_566 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 1 12)) (in_range16 temp___expr_566)))
(define-fun dynamic_invariant26 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 31)) (in_range17 temp___expr_572)))
(define-fun dynamic_invariant27 ((temp___expr_600 Int) (temp___is_init_597 Bool) (temp___skip_constant_598 Bool) (temp___do_toplevel_599 Bool)) Bool (=> (or (= temp___is_init_597 true) (<= 0 86399999)) (in_range18 temp___expr_600)))
(define-fun dynamic_invariant28 ((temp___expr_1433 Int) (temp___is_init_1430 Bool) (temp___skip_constant_1431 Bool) (temp___do_toplevel_1432 Bool)) Bool (=> (or (= temp___is_init_1430 true) (<= 0 4294967295)) (in_range22 temp___expr_1433)))
(assert (forall ((contents us_rep7)) (! (dynamic_invariant10 (therole contents) true false true) :pattern ((therole contents)))))
(assert (forall ((contents us_rep7)) (! (= (therole contents) (to_rep7 (rec__cert__attr__auth__contentst__role (us_split_fields13 contents)))) :pattern ((therole contents)))))
...
(assert (and (and (and (= o (extractuser tokenpresence state tokentry tokenid (us_split_fields__content7 authcert__split_fields) (us_split_fields__content10 idcert__split_fields))) (and (in_range4 auditalarm1) (= (valid_numberlogentries (to_rep2 logfilestate__split_fields7) (to_rep3 logfilestate__split_fields8) (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) true))) (and (and (= result status) (= status1 3)) (and (and (in_range4 auditalarm2) (= (valid_numberlogentries (to_rep2 logfilestate__split_fields14) (to_rep3 logfilestate__split_fields15) (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20) true)) (and (and (not (= (isgood tokenpresence1 state3 tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true)) (and (not (= (authcertvalid tokenpresence1 state3 tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true)) (not (in_range25 (theauthcertrole tokenpresence1 state3 tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)))))) (and (and (in_range12 tokentry1) (in_range11 tokenid1)) (in_range3 tokenpresence1)))))) (and (and (= state6 (mk___private__ref state2)) (and (= state5 (mk___private__ref state3)) (and (= state4 (mk___private__ref state1)) (and (= filestate1 (mk___private__ref filestate)) (and (= status2 (mk_int__ref status1)) (and (= idcert__split_fields2 (let ((subject idcert__split_fields)) (mk___split_fields__ref10 idcert__split_fields1))) (and (= authcert__split_fields2 (let ((subject authcert__split_fields)) (mk___split_fields__ref7 authcert__split_fields1))) (and (= tokenid2 (mk_int__ref tokenid1)) (and (= tokentry2 (mk_int__ref tokentry1)) (and (= tokenpresence2 (mk_int__ref tokenpresence1)) (and (= auditsystemfault1 (mk_bool__ref auditsystemfault)) (and (= auditalarm3 (mk_int__ref auditalarm2)) (and (= logfilestate__split_fields21 (mk___split_fields__ref1 (mk___split_fields1 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20))) (and (= logfilesstatus1 (mk_map__ref4 logfilesstatus)) (= logfiles1 (mk_map__ref3 logfiles)))))))))))))))) (and (= state9 state2) (and (= state8 state3) (and (= state7 state1) (and (= filestate2 filestate) (and (= status3 status1) (and (= idcert__split_fields3 idcert__split_fields1) (and (= authcert__split_fields3 authcert__split_fields1) (and (= tokenid3 tokenid1) (and (= tokentry3 tokentry1) (and (= tokenpresence3 tokenpresence1) (and (= auditsystemfault2 auditsystemfault) (and (= auditalarm4 auditalarm2) (and (= logfilestate__split_fields22 (mk___split_fields1 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20)) (and (= logfilesstatus2 logfilesstatus) (= logfiles2 logfiles))))))))))))))))))
