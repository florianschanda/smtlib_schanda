...
(assert (= right2 o4))
(assert (=> (< right2 8) (= temp___244 a2)))
(assert (=> (< right2 8) (= temp___243 a2)))
(assert (=> (< right2 8) (= temp___236 a2)))
(assert (=> (< right2 8) (= temp___235 temp1)))
(assert (=> (< right2 8) (= temp___241 a2)))
(assert (=> (< right2 8) (= temp___234 right2)))
(assert (=> (< right2 8) (= temp___233 left1)))
(assert (=> (< right2 8) (= temp___239 a2)))
(assert (=> (< right2 8) (= temp___238 a2)))
(assert (=> (< right2 8) (= 0 temp___245)))
(assert (=> (< right2 8) (and (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 7)) (ite (and (<= 0 k) (<= k (- right3 (* space3 2)))) (ite (= (mod2 (+ k 1) (* 2 space3)) 0) (= (to_rep (select a3 k)) (+ (to_rep (select temp___238 k)) (to_rep (select temp___239 (- k space3))))) (ite (= (mod2 (+ k 1) space3) 0) (= (to_rep (select a3 k)) (to_rep (select temp___241 (+ k space3)))) (= (to_rep (select a3 k)) (to_rep (select temp___243 k))))) (= (to_rep (select a3 k)) (to_rep (select temp___244 k)))))) (= (mod2 (+ right3 1) (* space3 2)) 0)) (not (<= 8 right3)))))
...
(assert (=> (< right2 8) (= temp___2451 result5)))
(assert (=> (< right2 8) (= temp___2452 right3)))
(assert (=> (< right2 8) (and (= o5 (- right3 space3)) (in_range1 (- right3 space3)))))
(assert (=> (< right2 8) (and (= o6 o5) (in_range2 o5))))
(assert (=> (< right2 8) (= left2 result6)))
(assert (=> (< right2 8) (= left3 o6)))
(assert (=> (< right2 8) (and (<= 0 right3) (<= right3 7))))
(assert (=> (< right2 8) (= o7 right3)))
(assert (=> (< right2 8) (= o8 (select a3 o7))))
(assert (=> (< right2 8) (= o9 (to_rep o8))))
(assert (=> (< right2 8) (= temp2 result7)))
(assert (=> (< right2 8) (= temp3 o9)))
(assert (=> (< right2 8) (and (<= 0 right3) (<= right3 7))))
(assert (=> (< right2 8) (= o12 right3)))
(assert (=> (< right2 8) (= o13 (select a3 o12))))
(assert (=> (< right2 8) (= o14 (to_rep o13))))
(assert (=> (< right2 8) (and (<= 0 left3) (<= left3 7))))
(assert (=> (< right2 8) (= o10 left3)))
(assert (=> (< right2 8) (= o11 (select a3 o10))))
(assert (=> (< right2 8) (= o15 (to_rep o11))))
(assert (=> (< right2 8) (= o16 (+ o15 o14))))
(assert (=> (< right2 8) (and (= o17 o16) (in_range1 o16))))
(assert (=> (< right2 8) (= (to_rep o18) o17)))
(assert (=> (< right2 8) (and (<= 0 right3) (<= right3 7))))
(assert (=> (< right2 8) (= o19 right3)))
(assert (=> (< right2 8) (= o20 (store a3 o19 o18))))
(assert (=> (< right2 8) (= a3 result8)))
(assert (=> (< right2 8) (= a4 o20)))
(assert (=> (< right2 8) (= (to_rep o21) temp3)))
(assert (=> (< right2 8) (and (<= 0 left3) (<= left3 7))))
(assert (=> (< right2 8) (= o22 left3)))
(assert (=> (< right2 8) (= o23 (store a4 o22 o21))))
(assert (=> (< right2 8) (= a4 result9)))
(assert (=> (< right2 8) (= a5 o23)))
(assert (=> (< right2 8) (and (= o24 (* space3 2)) (in_range1 (* space3 2)))))
(assert (=> (< right2 8) (= o25 (+ right3 o24))))
(assert (=> (< right2 8) (and (= o26 o25) (in_range1 o25))))
(assert (=> (< right2 8) (and (= o27 o26) (in_range2 o26))))
(assert (=> (< right2 8) (= right3 result10)))
(assert (=> (< right2 8) (= right4 o27)))
...
(assert (=> (< right2 8) (= rho1 temp___2452)))
