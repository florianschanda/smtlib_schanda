...
(assert (not (= (length temp___1954) 0)))
(assert (=> (<= 1 2) (= o132 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o132 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1954))) (to_rep1 (last (rt temp___1954)))) (= o133 (+ (- (to_rep1 (last (rt temp___1954))) (to_rep1 (first (rt temp___1954)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1954))) (to_rep1 (last (rt temp___1954))))) (= o133 0)))
(assert (= o134 (+ o133 o132)))
(assert (= o135 (+ (to_rep1 (first (rt temp___1954))) o134)))
(assert (= o136 (- o135 1)))
