...
(declare-const o17 t)
(declare-const temp___314 positive)
(declare-const temp___3141 natural)
(declare-const temp___3142 positive)
(declare-const temp___3143 positive)
(declare-const temp___3144 (Array Int element_type))
(declare-const temp___3145 t)
...
(declare-const o24 t)
(declare-const temp___316 positive)
(declare-const temp___3161 natural)
(declare-const temp___3162 positive)
(declare-const temp___3163 positive)
(declare-const temp___3164 (Array Int element_type))
(declare-const temp___3165 t)
...
(assert (and (= o (+ (mod1 (to_rep1 queue__split_fields2) (to_rep1 (rec__bounded_queue_v2__queue_type__max_size queue__split_discrs))) 1)) (in_range (+ (mod1 (to_rep1 queue__split_fields2) (to_rep1 (rec__bounded_queue_v2__queue_type__max_size queue__split_discrs))) 1))))
...
(assert (= temp___3101 o3))
(assert (= temp___3102 o4))
(assert (= temp___3103 o5))
(assert (= temp___3104 o6))
(assert (= temp___3105 o7))
...
(assert (= queue__split_fields5 (mk___split_fields temp___3101 temp___3102 temp___3103 (mk___t temp___3104 temp___3105))))
(assert (= queue__split_discrs (mk___split_discrs temp___310)))
(assert (= (to_rep3 o8) item))
(assert (and (<= (to_rep2 (first (rt (rec__bounded_queue_v2__queue_type__items queue__split_fields5)))) (to_rep1 (rec__bounded_queue_v2__queue_type__rear queue__split_fields5))) (<= (to_rep1 (rec__bounded_queue_v2__queue_type__rear queue__split_fields5)) (to_rep2 (last (rt (rec__bounded_queue_v2__queue_type__items queue__split_fields5)))))))
(assert (= o9 (to_rep1 (rec__bounded_queue_v2__queue_type__rear queue__split_fields5))))
(assert (= o10 (store (elts (rec__bounded_queue_v2__queue_type__items queue__split_fields5)) o9 o8)))
(assert (= o10 o11))
(assert (= (rt (rec__bounded_queue_v2__queue_type__items queue__split_fields5)) o12))
(assert (= (rec__bounded_queue_v2__queue_type__count queue__split_fields5) o13))
(assert (= (rec__bounded_queue_v2__queue_type__front queue__split_fields5) o14))
(assert (= (rec__bounded_queue_v2__queue_type__rear queue__split_fields5) o15))
(assert (= o16 o11))
(assert (= o17 o12))
(assert (= queue__split_discrs (mk___split_discrs temp___314)))
(assert (= temp___3141 o13))
(assert (= temp___3142 o14))
(assert (= temp___3143 o15))
(assert (= temp___3144 o16))
(assert (= temp___3145 o17))
(assert (= result1 (mk___split_fields__ref queue__split_fields5)))
(assert (= queue__split_fields6 (mk___split_fields temp___3141 temp___3142 temp___3143 (mk___t temp___3144 temp___3145))))
(assert (= queue__split_discrs (mk___split_discrs temp___314)))
(assert (and (= o18 (+ (to_rep (rec__bounded_queue_v2__queue_type__count queue__split_fields6)) 1)) (in_range (+ (to_rep (rec__bounded_queue_v2__queue_type__count queue__split_fields6)) 1))))
(assert (= (to_rep o19) o18))
(assert (= o19 o20))
(assert (= (rec__bounded_queue_v2__queue_type__front queue__split_fields6) o21))
(assert (= (rec__bounded_queue_v2__queue_type__rear queue__split_fields6) o22))
(assert (= (rec__bounded_queue_v2__queue_type__items queue__split_fields6) (mk___t o23 o24)))
(assert (= queue__split_discrs (mk___split_discrs temp___316)))
(assert (= temp___3161 o20))
(assert (= temp___3162 o21))
(assert (= temp___3163 o22))
(assert (= temp___3164 o23))
(assert (= temp___3165 o24))
(assert (= result2 (mk___split_fields__ref queue__split_fields6)))
(assert (= queue__split_fields7 (mk___split_fields temp___3161 temp___3162 temp___3163 (mk___t temp___3164 temp___3165))))
(assert (= queue__split_discrs (mk___split_discrs temp___316)))
(assert (= queue__split_fields8 (mk___split_fields__ref queue__split_fields7)))
(assert (= queue__split_fields9 queue__split_fields7))
(assert (not (= (size (mk___rep queue__split_discrs (us_split_fields__content queue__split_fields8))) (+ (size (mk___rep queue__split_discrs (mk___split_fields queue__split_fields queue__split_fields1 queue__split_fields2 (mk___t queue__split_fields3 queue__split_fields4)))) 1))))
(check-sat)
(exit)
