...
(assert (=> (= result11 true) (and (and (= temp___1136 a) (and (= temp___1135 (mk___rep c__split_fields1)) (and (= temp___1138 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (= temp___1137 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (= temp___1134 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (and (= temp___1133 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (and (= temp___1142 (mk_int__ref 0)) (and (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x (mk___rep c__split_fields1))) true) (and (and (and (= o35 (element x (mk___rep c__split_fields1))) (and (in_range7 o35) (= o35 (get1 (model__ x) (get (positions x) (mk___rep c__split_fields1)))))) (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a2 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o35)) (to_rep (select a (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o35))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o35)))))))))) (ite (= k (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o35))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o35))))))))) (to_rep (select a (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o35))) (to_rep (select a k))))))) (and (= (capacity (mk___rep5 p__split_discrs p__split_fields2)) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (= (length2 (mk___rep5 p__split_discrs p__split_fields2)) (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) (to_rep (select a2 j2))) true))) (and (forall ((c4 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c4) true) (= (to_rep (select a2 (element1 (mk___rep3 d__split_discrs d__split_fields2) c4))) (key (mk___rep3 d__split_discrs d__split_fields2) c4)))) (= (oeq2 (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (keys (mk___rep3 d__split_discrs d__split_fields2))) true))))))) (and (ite (= (ite (= (bool_eq1 (mk___rep c__split_fields1) no_element) false) (= (get (positions x) (mk___rep c__split_fields1)) (length x)) true) true) (= (bool_eq1 (mk___rep c__split_fields2) no_element) true) (and (= (has_key (positions x) (mk___rep c__split_fields2)) true) (= (get (positions x) (mk___rep c__split_fields2)) (+ (get (positions x) (mk___rep c__split_fields1)) 1)))) (and (and (= (capacity (mk___rep5 p__split_discrs p__split_fields3)) temp___1137) (and (= (length2 (mk___rep5 p__split_discrs p__split_fields3)) temp___1138) (and (forall ((c4 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c4) true) (= (to_rep (select a3 (element1 (mk___rep3 d__split_discrs d__split_fields3) c4))) (key (mk___rep3 d__split_discrs d__split_fields3) c4)))) (and (forall ((c4 us_rep)) (=> (= (has_key (positions x) c4) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (element x c4)) true))) (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (to_rep (select a3 j2))) true))))))) (and (and (ite (= (bool_eq1 (mk___rep c__split_fields3) no_element) true) (= o43 (length x)) (= o43 (- (get (positions x) (mk___rep c__split_fields3)) 1))) (and (= result14 (let ((subject temp___1142)) (mk_int__ref temp___11421))) (= (let ((subject temp___1142)) temp___11422) o43))) (and (and (and (= o44 (has_key (positions x) (mk___rep c__split_fields3))) (= (= o44 true) (= (has_key (positions x) (mk___rep c__split_fields3)) true))) (= result15 (ite (not (= o44 true)) true false))) (= result15 true)))))))))))))) (and (and (= c__split_fields7 (mk___split_fields__ref c__split_fields3)) (and (= p__split_fields7 (mk___split_fields__ref5 p__split_fields3)) (and (= d__split_fields7 (mk___split_fields__ref3 d__split_fields3)) (= a7 (mk_map__ref a3))))) (and (= c__split_fields8 c__split_fields3) (and (= p__split_fields8 p__split_fields3) (and (= d__split_fields8 d__split_fields3) (= a8 a3))))))))
(assert (=> (= result11 true) (= c__split_fields9 c__split_fields7)))
(assert (=> (= result11 true) (= p__split_fields9 p__split_fields7)))
(assert (=> (= result11 true) (= d__split_fields9 d__split_fields7)))
(assert (=> (= result11 true) (= a9 a7)))
(assert (=> (= result11 true) (= c__split_fields10 c__split_fields8)))
(assert (=> (= result11 true) (= p__split_fields10 p__split_fields8)))
(assert (=> (= result11 true) (= d__split_fields10 d__split_fields8)))
(assert (=> (= result11 true) (= a10 a8)))
(assert (=> (not (= result11 true)) (= c__split_fields9 (mk___split_fields__ref c__split_fields1))))
(assert (=> (not (= result11 true)) (= p__split_fields9 (mk___split_fields__ref5 (mk___split_fields5 p__split_fields)))))
(assert (=> (not (= result11 true)) (= d__split_fields9 (mk___split_fields__ref3 (mk___split_fields3 d__split_fields)))))
(assert (=> (not (= result11 true)) (= a9 (mk_map__ref a))))
(assert (=> (not (= result11 true)) (= c__split_fields10 c__split_fields1)))
(assert (=> (not (= result11 true)) (= p__split_fields10 p__split_fields1)))
(assert (=> (not (= result11 true)) (= d__split_fields10 d__split_fields1)))
(assert (=> (not (= result11 true)) (= a10 a1)))
(assert (not (<= (* 2 (length2 (mk___rep5 p__split_discrs (us_split_fields__content5 p__split_fields9)))) (capacity (mk___rep5 p__split_discrs (us_split_fields__content5 p__split_fields9))))))
(check-sat)
(exit)
