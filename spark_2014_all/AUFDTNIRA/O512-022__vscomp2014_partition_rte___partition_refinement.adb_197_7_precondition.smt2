...
(assert (=> (= result1 true) (= temp___1138 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))))))
(assert (=> (= result1 true) (= temp___1137 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))))))
(assert (=> (= result1 true) (= temp___1134 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))
(assert (=> (= result1 true) (= temp___1133 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)))))
...
(assert (=> (= result1 true) (and (= o2 (element x (mk___rep c__split_fields1))) (and (in_range7 o2) (= o2 (get1 (model__ x) (get (positions x) (mk___rep c__split_fields1))))))))
(assert (=> (= result1 true) (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a2 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2)) (to_rep (select a (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2)))))))))) (ite (= k (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2))))))))) (to_rep (select a (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2))) (to_rep (select a k))))))) (and (= (capacity (mk___rep5 p__split_discrs p__split_fields2)) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (= (length2 (mk___rep5 p__split_discrs p__split_fields2)) (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) (to_rep (select a2 j))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c) true) (= (to_rep (select a2 (element1 (mk___rep3 d__split_discrs d__split_fields2) c))) (key (mk___rep3 d__split_discrs d__split_fields2) c)))) (= (oeq2 (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (keys (mk___rep3 d__split_discrs d__split_fields2))) true))))))))
...
(assert (=> (= result1 true) (= (capacity (mk___rep5 p__split_discrs p__split_fields3)) temp___1137)))
(assert (=> (= result1 true) (= (length2 (mk___rep5 p__split_discrs p__split_fields3)) temp___1138)))
...
(assert (=> (= result1 true) (forall ((c us_rep)) (=> (= (has_key (positions x) c) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (element x c)) true)))))
...
(assert (=> (= result1 true) (=> (= (bool_eq1 (mk___rep c__split_fields3) no_element) true) (= o3 (length x)))))
(assert (=> (= result1 true) (=> (not (= (bool_eq1 (mk___rep c__split_fields3) no_element) true)) (= o3 (- (get (positions x) (mk___rep c__split_fields3)) 1)))))
(assert (=> (= result1 true) (= result2 (let ((subject temp___1142)) (mk_int__ref temp___11421)))))
(assert (=> (= result1 true) (= (let ((subject temp___1142)) temp___11422) o3)))
(assert (=> (= result1 true) (and (= o4 (has_key (positions x) (mk___rep c__split_fields3))) (= (= o4 true) (= (has_key (positions x) (mk___rep c__split_fields3)) true)))))
...
(assert (not (<= (* 2 (length2 (mk___rep5 p__split_discrs (us_split_fields__content5 p__split_fields6)))) (capacity (mk___rep5 p__split_discrs (us_split_fields__content5 p__split_fields6))))))
(check-sat)
(exit)
