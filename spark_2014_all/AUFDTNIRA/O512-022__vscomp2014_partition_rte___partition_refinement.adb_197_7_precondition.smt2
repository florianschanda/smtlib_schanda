...
(declare-const temp___1207 us_rep10)
(declare-const temp___1206 us_rep5)
...
(assert (=> (= result1 true) (= temp___1208 (mk___rep c__split_fields1))))
(assert (=> (= result1 true) (= temp___1211 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))))))
(assert (=> (= result1 true) (= temp___1210 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))))))
(assert (=> (= result1 true) (= temp___1207 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))
...
(assert (=> (= result1 true) (= (capacity (mk___rep5 p__split_discrs p__split_fields3)) temp___1210)))
(assert (=> (= result1 true) (= (length2 (mk___rep5 p__split_discrs p__split_fields3)) temp___1211)))
...
(assert (=> (= result1 true) (= (let ((subject temp___1215)) temp___12152) o3)))
