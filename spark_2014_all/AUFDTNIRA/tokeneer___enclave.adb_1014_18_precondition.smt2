...
(assert (= result true))
(assert (and (= o7 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range6 o7)))
(assert (= result1 (ite (= o7 3) true false)))
(assert (= result1 true))
(assert (and (= o6 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range4 o6) (= o6 (to_rep2 theadmin__split_fields)))))
(assert (= result2 (ite (= o6 1) true false)))
(assert (= result2 true))
...
(assert (=> (= result4 true) (and (= o3 (theauthcertrole tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))) (and (in_range4 o3) (= o3 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content11 authcert__split_fields))))))))
(assert (=> (= result4 true) (= o4 (ite (= o3 1) true false))))
(assert (=> (= result4 true) (and (= o1 (authcertvalid tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))) (= (= o1 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content11 authcert__split_fields)) true)))))
(assert (=> (= result4 true) (and (= o2 (isgood tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))) (= (= o2 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content8 idcert__split_fields)) true)))))
(assert (=> (= result4 true) (= o5 (ite (= o2 true) o1 false))))
(assert (=> (= result4 true) (= result3 (ite (= o5 true) o4 false))))
(assert (=> (not (= result4 true)) (= result3 (distinct 1 0))))
(assert (= result3 true))
(assert (and (= result5 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result5 true) (in_range6 (to_rep3 theadmin__split_fields1)))))
(assert (= result5 true))
