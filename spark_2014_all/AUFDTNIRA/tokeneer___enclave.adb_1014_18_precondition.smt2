...
(assert (= result true))
(assert (and (= o7 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range7 o7)))
...
(assert (=> (= result4 true) (and (= o3 (theauthcertrole tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range5 o3) (= o3 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields))))))))
(assert (=> (= result4 true) (= o4 (ite (= o3 1) true false))))
(assert (=> (= result4 true) (and (= o1 (authcertvalid tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o1 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields)) true)))))
(assert (=> (= result4 true) (and (= o2 (isgood tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o2 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields)) true)))))
...
(assert (= result3 true))
(assert (and (= result5 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result5 true) (in_range7 (to_rep3 theadmin__split_fields1)))))
(assert (= result5 true))
