...
(define-fun thistisinfo__split_fields16 () us_split_fields__ref4 (mk___split_fields__ref4 (mk___split_fields4 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3)))))
...
(define-fun logfiles16 () map__ref3 (mk_map__ref3 logfiles))
...
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= thistisinfo__split_fields6 thistisinfo__split_fields16))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= auditsystemfault3 auditsystemfault16))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= auditalarm3 auditalarm16))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfilestate__split_fields9 logfilestate__split_fields22))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfilesstatus3 logfilesstatus16))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfiles3 logfiles16))))
...
(assert (= temp___1798 (mk___t1 (temp___String_Literal_1797 Tuple0) (mk1 1 33))))
(assert (not (dynamic_predicate temp___1798)))
(check-sat)
(exit)
