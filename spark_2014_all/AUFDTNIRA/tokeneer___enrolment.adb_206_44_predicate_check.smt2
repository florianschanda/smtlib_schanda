...
(define-fun thistisinfo__split_fields16 () us_split_fields__ref1 (mk___split_fields__ref1 (mk___split_fields1 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3)))))
(define-fun auditsystemfault16 () bool__ref (mk_bool__ref auditsystemfault))
(define-fun auditalarm16 () int__ref (mk_int__ref auditalarm))
(define-fun logfilestate__split_fields22 () us_split_fields__ref3 (mk___split_fields__ref3 (mk___split_fields3 logfilestate__split_fields logfilestate__split_fields1 (mk___rep2 (mk___split_fields2 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6)))
(define-fun logfilesstatus16 () map__ref1 (mk_map__ref1 logfilesstatus))
(define-fun logfiles16 () map__ref4 (mk_map__ref4 logfiles))
...
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= thistisinfo__split_fields6 thistisinfo__split_fields16))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= auditsystemfault3 auditsystemfault16))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= auditalarm3 auditalarm16))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfilestate__split_fields9 logfilestate__split_fields22))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfilesstatus3 logfilesstatus16))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep3 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep3 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfiles3 logfiles16))))
...
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= thistisinfo__split_fields8 thistisinfo__split_fields16)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= auditsystemfault5 auditsystemfault16)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= auditalarm5 auditalarm16)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= logfilestate__split_fields11 logfilestate__split_fields22)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= logfilesstatus5 logfilesstatus16)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= logfiles5 logfiles16)))
...
(assert (= (bool__content addedok11) true))
(assert (not (= (bool__content verifiedok3) true)))
(assert (dynamic_property1 1 2147483647 1 33))
(assert (= temp___1791 (mk___t1 (temp___String_Literal_1790 Tuple0) (mk1 1 33))))
(assert (not (dynamic_predicate temp___1791)))
(check-sat)
(exit)
