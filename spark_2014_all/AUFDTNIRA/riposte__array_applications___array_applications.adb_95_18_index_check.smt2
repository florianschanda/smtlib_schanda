...
(assert (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___198 Int)) (=> (and (<= 0 temp___198) (<= temp___198 30)) (=> (< i2 temp___198) (= (select a4 temp___198) (select a2 temp___198)))))) (and (<= 2 i2) (<= i2 30))))
(assert (= (= o15 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 i2)) (and (<= 0 (to_rep (select a4 j1))) (< (to_rep (select a4 j1)) (power 2 j1)))))))
(assert (<= 2 j))
(assert (<= j i2))
(assert (and (<= 0 (- j 2)) (<= (- j 2) 30)))
(assert (= o9 (- j 2)))
(assert (= o10 (select a4 o9)))
(assert (= o11 (to_rep o10)))
(assert (and (<= 0 (- j 1)) (<= (- j 1) 30)))
(assert (= o7 (- j 1)))
(assert (= o8 (select a4 o7)))
