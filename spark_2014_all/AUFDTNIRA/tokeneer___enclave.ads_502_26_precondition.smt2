...
(assert (=> (= result14 true) (and (= o82 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o82))))
(assert (=> (= result14 true) (= o83 (ite (= o82 3) true false))))
(assert (=> (= result14 true) (and (= o84 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o84 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result14 true) (= o85 (ite (= o84 true) o83 false))))
(assert (=> (not (= result14 true)) (= o85 (of_int 1))))
(assert (and (= o72 (islocked (int__content currentlatch3) (us_private__content state36) (us_split_fields__content1 latchtimeout__split_fields6))) (= (= o72 true) (= (int__content currentlatch3) 0))))
(assert (= o73 (ite (not (= o72 true)) true false)))
(assert (= result15 (ite (= o73 true) (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result15 true) (and (= o76 (theauthcertrole (int__content tokenpresence5) (us_private__content state35) (int__content tokentry5) (int__content tokenid5) (us_split_fields__content9 authcert__split_fields5) (us_split_fields__content12 idcert__split_fields5))) (and (in_range2 o76) (= o76 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content9 authcert__split_fields5))))))))
(assert (=> (= result15 true) (= o77 (ite (= o76 1) true false))))
(assert (=> (= result15 true) (and (= o74 (authcertvalid (int__content tokenpresence5) (us_private__content state35) (int__content tokentry5) (int__content tokenid5) (us_split_fields__content9 authcert__split_fields5) (us_split_fields__content12 idcert__split_fields5))) (= (= o74 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content9 authcert__split_fields5)) true)))))
(assert (=> (= result15 true) (and (= o75 (isgood (int__content tokenpresence5) (us_private__content state35) (int__content tokentry5) (int__content tokenid5) (us_split_fields__content9 authcert__split_fields5) (us_split_fields__content12 idcert__split_fields5))) (= (= o75 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content12 idcert__split_fields5)) true)))))
(assert (=> (= result15 true) (= o78 (ite (= o75 true) o74 false))))
(assert (=> (= result15 true) (= o79 (ite (= o78 true) o77 false))))
(assert (=> (not (= result15 true)) (= o79 (of_int 1))))
(assert (and (= o69 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields5)))) (= (= o69 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields5)))))))
(assert (= result16 (ite (not (= o69 true)) true false)))
(assert (=> (= result16 true) (and (= o70 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (= (= o70 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields5))))))))
(assert (=> (= result16 true) (= o71 (ite (not (= o70 true)) true false))))
(assert (=> (not (= result16 true)) (= o71 (of_int 1))))
(assert (and (= o63 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5)))) (and (in_range2 o63) (= o63 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields5)))))))
(assert (= result17 (ite (= o63 1) true false)))
(assert (= result17 true))
(assert (and (= o65 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (= (= o65 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields5)))))))
(assert (= o66 (ite (not (= o65 true)) true false)))
(assert (and (= result18 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (= (= result18 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields5)))))))
