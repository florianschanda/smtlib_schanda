...
(assert (and (= o14 (islocked (int__content currentlatch1) (us_private__content state4) (us_split_fields__content1 latchtimeout__split_fields4))) (= (= o14 true) (= (int__content currentlatch1) 0))))
(assert (= o15 (ite (not (= o14 true)) true false)))
(assert (= result (ite (= o15 true) (islocked currentlatch (us_private__content state1) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result true) (and (= o16 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o16))))
(assert (=> (= result true) (= o17 (ite (= o16 3) true false))))
(assert (=> (= result true) (and (= o18 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o18 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result true) (= o19 (ite (= o18 true) o17 false))))
(assert (=> (not (= result true)) (= o19 (distinct 1 0))))
(assert (and (= o6 (islocked (int__content currentlatch1) (us_private__content state4) (us_split_fields__content1 latchtimeout__split_fields4))) (= (= o6 true) (= (int__content currentlatch1) 0))))
(assert (= o7 (ite (not (= o6 true)) true false)))
(assert (= result1 (ite (= o7 true) (islocked currentlatch (us_private__content state1) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result1 true) (and (= o10 (theauthcertrole (int__content tokenpresence1) (us_private__content state3) (int__content tokentry1) (int__content tokenid1) (us_split_fields__content9 authcert__split_fields1) (us_split_fields__content12 idcert__split_fields1))) (and (in_range2 o10) (= o10 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content9 authcert__split_fields1))))))))
(assert (=> (= result1 true) (= o11 (ite (= o10 1) true false))))
(assert (=> (= result1 true) (and (= o8 (authcertvalid (int__content tokenpresence1) (us_private__content state3) (int__content tokentry1) (int__content tokenid1) (us_split_fields__content9 authcert__split_fields1) (us_split_fields__content12 idcert__split_fields1))) (= (= o8 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content9 authcert__split_fields1)) true)))))
(assert (=> (= result1 true) (and (= o9 (isgood (int__content tokenpresence1) (us_private__content state3) (int__content tokentry1) (int__content tokenid1) (us_split_fields__content9 authcert__split_fields1) (us_split_fields__content12 idcert__split_fields1))) (= (= o9 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content12 idcert__split_fields1)) true)))))
(assert (=> (= result1 true) (= o12 (ite (= o9 true) o8 false))))
(assert (=> (= result1 true) (= o13 (ite (= o12 true) o11 false))))
(assert (=> (not (= result1 true)) (= o13 (distinct 1 0))))
(assert (and (= o3 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o3 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result2 (ite (not (= o3 true)) true false)))
(assert (=> (= result2 true) (and (= o4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o4 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
(assert (=> (= result2 true) (= o5 (ite (not (= o4 true)) true false))))
(assert (=> (not (= result2 true)) (= o5 (distinct 1 0))))
(assert (and (= o (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (and (in_range2 o) (= o (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result3 (ite (= o 1) true false)))
(assert (= result3 true))
(assert (and (= o1 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o1 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2)))))))
(assert (= o2 (ite (not (= o1 true)) true false)))
(assert (and (= result4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result4 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result4 true))
(assert (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2))) true)))
(check-sat)
(exit)
