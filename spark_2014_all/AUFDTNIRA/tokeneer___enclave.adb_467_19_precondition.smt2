...
(assert (= result6 true))
(assert (and (= o15 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o15 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= o16 (ite (not (= o15 true)) true false)))
(assert (and (= result7 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result7 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result7 true))
