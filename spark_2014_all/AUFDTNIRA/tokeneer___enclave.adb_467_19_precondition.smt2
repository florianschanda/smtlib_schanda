...
(assert (= result3 true))
(assert (and (= o6 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o6 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
