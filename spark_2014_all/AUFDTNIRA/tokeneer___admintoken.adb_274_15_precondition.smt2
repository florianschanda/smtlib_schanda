...
(define-fun to_rep2 ((x namecountt)) Int (namecounttqtint x))
(declare-fun of_rep2 (Int) namecountt)
(assert (forall ((x namecountt)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x namecountt)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun to_rep3 ((x issueridt)) Int (issueridtqtint x))
(declare-fun of_rep3 (Int) issueridt)
(assert (forall ((x issueridt)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x issueridt)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep3 (rec__cryptotypes__issuert__id (us_split_fields1 a))) (to_rep3 (rec__cryptotypes__issuert__id (us_split_fields1 b)))) (= (to_rep2 (rec__cryptotypes__issuert__namelength (us_split_fields1 a))) (to_rep2 (rec__cryptotypes__issuert__namelength (us_split_fields1 b))))) (= (bool_eq (rec__cryptotypes__issuert__name (us_split_fields1 a)) 1 40 (rec__cryptotypes__issuert__name (us_split_fields1 b)) 1 40) true)) true false))
...
(define-fun to_rep4 ((x serialnumbert)) Int (serialnumbertqtint x))
...
(declare-fun user_eq10 (yearst yearst) Bool)
(declare-const dummy10 yearst)
...
(define-fun to_rep5 ((x yearst)) Int (yearstqtint x))
...
(declare-fun user_eq11 (monthst monthst) Bool)
(declare-const dummy11 monthst)
...
(define-fun to_rep6 ((x monthst)) Int (monthstqtint x))
...
(declare-fun user_eq12 (dayst dayst) Bool)
(declare-const dummy12 dayst)
...
(define-fun to_rep7 ((x dayst)) Int (daystqtint x))
...
(declare-fun user_eq13 (millisecst millisecst) Bool)
(declare-const dummy13 millisecst)
...
(define-fun to_rep8 ((x millisecst)) Int (millisecstqtint x))
...
(define-fun us_split_fields_NotBefore__projection ((a us_split_fields6)) us_rep2 (rec__cert__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__projection ((a us_split_fields6)) us_rep2 (rec__cert__contentst__notafter a))
...
(define-fun bool_eq5 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (bool_eq3 (rec__cert__contentst__id (us_split_fields7 a)) (rec__cert__contentst__id (us_split_fields7 b))) true) (= (bool_eq4 (rec__cert__contentst__notbefore (us_split_fields7 a)) (rec__cert__contentst__notbefore (us_split_fields7 b))) true)) (= (bool_eq4 (rec__cert__contentst__notafter (us_split_fields7 a)) (rec__cert__contentst__notafter (us_split_fields7 b))) true)) (= (to_rep9 (rec__cert__contentst__mechanism (us_split_fields7 a))) (to_rep9 (rec__cert__contentst__mechanism (us_split_fields7 b))))) true false))
...
(assert (forall ((x filestatust)) (! (in_range12 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep10 (select a temp___idx_178)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_178)))))))))))
...
(declare-fun user_eq18 (logfileindext logfileindext) Bool)
(declare-const dummy18 logfileindext)
...
(define-fun to_rep11 ((x logfileindext)) Int (logfileindextqtint x))
(declare-fun of_rep11 (Int) logfileindext)
(assert (forall ((x logfileindext)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x logfileindext)) (! (in_range13 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(declare-fun user_eq19 (logentrycountt logentrycountt) Bool)
(declare-const dummy19 logentrycountt)
...
(define-fun to_rep12 ((x logentrycountt)) Int (logentrycounttqtint x))
(declare-fun of_rep12 (Int) logentrycountt)
(assert (forall ((x logentrycountt)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x logentrycountt)) (! (in_range14 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun to_rep13 ((x logfilecountt)) Int (logfilecounttqtint x))
(declare-fun of_rep13 (Int) logfilecountt)
(assert (forall ((x logfilecountt)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x logfilecountt)) (! (in_range15 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun bool_eq7 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep11 (select a temp___idx_175)) (to_rep11 (select b (+ (- b__first a__first) temp___idx_175))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep11 (select a temp___idx_175)) (to_rep11 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
(declare-const dummy21 (Array Int logfileindext))
...
(declare-fun user_eq21 ((Array Int logfileindext) (Array Int logfileindext)) Bool)
...
(define-fun bool_eq8 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (= (bool_eq7 (rec__auditlog__logfilelistt__list (us_split_fields9 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields9 b)) 1 17) true) (= (to_rep11 (rec__auditlog__logfilelistt__head (us_split_fields9 a))) (to_rep11 (rec__auditlog__logfilelistt__head (us_split_fields9 b))))) (= (to_rep11 (rec__auditlog__logfilelistt__lasti (us_split_fields9 a))) (to_rep11 (rec__auditlog__logfilelistt__lasti (us_split_fields9 b))))) (= (to_rep13 (rec__auditlog__logfilelistt__length (us_split_fields9 a))) (to_rep13 (rec__auditlog__logfilelistt__length (us_split_fields9 b))))) true false))
...
(declare-fun user_eq23 (fileentrycountt fileentrycountt) Bool)
(declare-const dummy23 fileentrycountt)
...
(define-fun to_rep14 ((x fileentrycountt)) Int (fileentrycounttqtint x))
(declare-fun of_rep14 (Int) fileentrycountt)
(assert (forall ((x fileentrycountt)) (! (= (of_rep14 (to_rep14 x)) x) :pattern ((to_rep14 x)))))
(assert (forall ((x fileentrycountt)) (! (in_range16 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(define-fun bool_eq9 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep14 (select a temp___idx_176)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_176))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep14 (select a temp___idx_176)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
(declare-const dummy24 (Array Int fileentrycountt))
...
(declare-fun user_eq24 ((Array Int fileentrycountt) (Array Int fileentrycountt)) Bool)
...
(define-fun bool_eq10 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (= (to_rep11 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 a))) (to_rep11 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 b)))) (= (to_rep12 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 a))) (to_rep12 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 b))))) (= (bool_eq8 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 b))) true)) (= (bool_eq9 (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 b)) 1 17) true)) true false))
...
(declare-fun bool_eq11 (us_rep6 us_rep6) Bool)
...
(assert (forall ((a (Array Int us_rep6))) (forall ((first2 Int)) (! (= (slide4 a first2 first2) a) :pattern ((slide4 a first2 first2))))))
...
(define-fun bool_eq12 ((a (Array Int us_rep6)) (a__first Int) (a__last Int) (b (Array Int us_rep6)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq11 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true)))) true false))
(assert (forall ((a (Array Int us_rep6)) (b (Array Int us_rep6))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq12 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq11 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true))))))))
...
(declare-fun user_eq27 (statust statust) Bool)
(declare-const dummy27 statust)
...
(define-fun dynamic_invariant ((temp___expr_593 Int) (temp___is_init_589 Bool) (temp___skip_constant_590 Bool) (temp___do_toplevel_591 Bool) (temp___do_typ_inv_592 Bool)) Bool (=> (or (= temp___is_init_589 true) (<= 0 1)) (in_range17 temp___expr_593)))
...
(define-fun dynamic_invariant1 ((temp___expr_1330 us_rep5) (temp___is_init_1326 Bool) (temp___skip_constant_1327 Bool) (temp___do_toplevel_1328 Bool) (temp___do_typ_inv_1329 Bool)) Bool (=> (= temp___do_typ_inv_1329 true) (= (valid_numberlogentries (to_rep11 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___expr_1330))) (to_rep12 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___expr_1330))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___expr_1330)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___expr_1330))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1334 us_rep5) (temp___skip_top_level_1335 Bool)) Bool (and (and (and (= (to_rep11 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___expr_1334))) 1) (= (to_rep12 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___expr_1334))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___expr_1334)) (mk___rep4 (mk___split_fields4 (temp_____aggregate_def_1336 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___expr_1334)) (temp_____aggregate_def_1340 0))))
(define-fun type_invariant ((temp___1344 us_rep5)) Bool (= (valid_numberlogentries (to_rep11 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___1344))) (to_rep12 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___1344))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___1344)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___1344))) true))
...
(declare-fun user_eq28 (keyidt keyidt) Bool)
(declare-const dummy28 keyidt)
...
(assert (forall ((x keyidt)) (! (in_range18 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(define-fun in_range19 ((x Int)) Bool (and (<= 0 x) (<= x 128)))
...
(declare-fun user_eq29 (keylengtht keylengtht) Bool)
(declare-const dummy29 keylengtht)
...
(assert (forall ((x keylengtht)) (! (in_range19 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun bool_eq13 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (= (to_rep9 (rec__cryptotypes__keypartt__algorithmid (us_split_fields13 a))) (to_rep9 (rec__cryptotypes__keypartt__algorithmid (us_split_fields13 b)))) (= (to_rep15 (rec__cryptotypes__keypartt__keyid (us_split_fields13 a))) (to_rep15 (rec__cryptotypes__keypartt__keyid (us_split_fields13 b))))) (= (to_rep16 (rec__cryptotypes__keypartt__keylength (us_split_fields13 a))) (to_rep16 (rec__cryptotypes__keypartt__keylength (us_split_fields13 b))))) true false))
...
(define-fun us_split_fields_ID__6__projection ((a us_split_fields14)) us_rep1 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields14)) us_rep2 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields14)) us_rep2 (rec__cert__id__contentst__notafter a))
...
(define-fun us_rep___17__projection ((a us_rep8)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq14 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__id__contentst__id (us_split_fields15 a)) (rec__cert__id__contentst__id (us_split_fields15 b))) true) (= (bool_eq4 (rec__cert__id__contentst__notbefore (us_split_fields15 a)) (rec__cert__id__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq4 (rec__cert__id__contentst__notafter (us_split_fields15 a)) (rec__cert__id__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep9 (rec__cert__id__contentst__mechanism (us_split_fields15 a))) (to_rep9 (rec__cert__id__contentst__mechanism (us_split_fields15 b))))) (= (bool_eq2 (rec__cert__id__contentst__subject (us_split_fields15 a)) (rec__cert__id__contentst__subject (us_split_fields15 b))) true)) (= (bool_eq13 (rec__cert__id__contentst__subjectpublickey (us_split_fields15 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields15 b))) true)) true false))
...
(define-fun contentst__ref___4__projection ((a contentst__ref1)) us_rep8 (contentst__content1 a))
...
(declare-fun user_eq32 (tokenidt tokenidt) Bool)
(declare-const dummy32 tokenidt)
...
(define-fun dynamic_invariant3 ((temp___expr_579 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool) (temp___do_typ_inv_578 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 0 4294967295)) (in_range20 temp___expr_579)))
...
(declare-fun temp___String_Literal_2121 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2121 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 20)) 86)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 22)) 114)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 24)) 102)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 26)) 97)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 27)) 98)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 28)) 108)) (= (to_rep (select (temp___String_Literal_2121 us_void_param) 29)) 101)) :pattern ((temp___String_Literal_2121 us_void_param)))))
(declare-fun temp___String_Literal_2122 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2122 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 2)) 68)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 9)) 102)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 11)) 99)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 14)) 101)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 16)) 66)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_2122 us_void_param) 18)) 100)) :pattern ((temp___String_Literal_2122 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range4 temp___expr_402)))
(define-fun dynamic_invariant8 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range5 temp___expr_426)))
(define-fun dynamic_invariant9 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range11 temp___expr_450)))
(define-fun dynamic_invariant10 ((temp___expr_464 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool) (temp___do_typ_inv_463 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 4294967295)) (in_range18 temp___expr_464)))
(define-fun dynamic_invariant11 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 0 128)) (in_range19 temp___expr_471)))
(define-fun dynamic_invariant12 ((temp___expr_1268 Int) (temp___is_init_1264 Bool) (temp___skip_constant_1265 Bool) (temp___do_toplevel_1266 Bool) (temp___do_typ_inv_1267 Bool)) Bool (=> (or (= temp___is_init_1264 true) (<= 0 17)) (in_range15 temp___expr_1268)))
(define-fun dynamic_invariant13 ((temp___expr_1275 Int) (temp___is_init_1271 Bool) (temp___skip_constant_1272 Bool) (temp___do_toplevel_1273 Bool) (temp___do_typ_inv_1274 Bool)) Bool (=> (or (= temp___is_init_1271 true) (<= 1 17)) (in_range13 temp___expr_1275)))
(define-fun dynamic_invariant14 ((temp___expr_1401 Int) (temp___is_init_1397 Bool) (temp___skip_constant_1398 Bool) (temp___do_toplevel_1399 Bool) (temp___do_typ_inv_1400 Bool)) Bool (=> (or (= temp___is_init_1397 true) (<= 0 2)) (in_range12 temp___expr_1401)))
(define-fun dynamic_invariant15 ((temp___expr_1282 Int) (temp___is_init_1278 Bool) (temp___skip_constant_1279 Bool) (temp___do_toplevel_1280 Bool) (temp___do_typ_inv_1281 Bool)) Bool (=> (or (= temp___is_init_1278 true) (<= 0 17408)) (in_range14 temp___expr_1282)))
(define-fun dynamic_invariant16 ((temp___expr_1313 Int) (temp___is_init_1309 Bool) (temp___skip_constant_1310 Bool) (temp___do_toplevel_1311 Bool) (temp___do_typ_inv_1312 Bool)) Bool (=> (or (= temp___is_init_1309 true) (<= 0 1024)) (in_range16 temp___expr_1313)))
(assert true)
(assert (forall ((currentlogfile Int) (numberlogentries Int)) (forall ((usedlogfiles us_rep4)) (forall ((logfileentries (Array Int fileentrycountt))) (! (= (= (valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries) true) (and (<= 1 (to_rep13 (rec__auditlog__logfilelistt__length (us_split_fields9 usedlogfiles)))) (= numberlogentries (+ (* (- (to_rep13 (rec__auditlog__logfilelistt__length (us_split_fields9 usedlogfiles))) 1) 1024) (to_rep14 (select logfileentries currentlogfile)))))) :pattern ((valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries)))))))
(declare-const rliteral2 fileentrycountt)
(assert (= (fileentrycounttqtint rliteral2) 0))
(assert (forall ((temp___1342 Int)) (=> (dynamic_invariant16 temp___1342 true true true true) (forall ((temp___1343 Int)) (= (select (temp_____aggregate_def_1340 temp___1342) temp___1343) rliteral2)))))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___162 Int)) (=> (dynamic_invariant5 temp___162 true true true true) (forall ((temp___163 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___162) temp___163)) temp___162)))))
(define-fun dynamic_invariant17 ((temp___expr_670 Int) (temp___is_init_666 Bool) (temp___skip_constant_667 Bool) (temp___do_toplevel_668 Bool) (temp___do_typ_inv_669 Bool)) Bool (=> (or (= temp___is_init_666 true) (<= 1901 2099)) (in_range7 temp___expr_670)))
(define-fun dynamic_invariant18 ((temp___expr_677 Int) (temp___is_init_673 Bool) (temp___skip_constant_674 Bool) (temp___do_toplevel_675 Bool) (temp___do_typ_inv_676 Bool)) Bool (=> (or (= temp___is_init_673 true) (<= 1 12)) (in_range8 temp___expr_677)))
(define-fun dynamic_invariant19 ((temp___expr_684 Int) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool) (temp___do_typ_inv_683 Bool)) Bool (=> (or (= temp___is_init_680 true) (<= 1 31)) (in_range9 temp___expr_684)))
(define-fun dynamic_invariant20 ((temp___expr_716 Int) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool) (temp___do_typ_inv_715 Bool)) Bool (=> (or (= temp___is_init_712 true) (<= 0 86399999)) (in_range10 temp___expr_716)))
(define-fun dynamic_invariant21 ((temp___expr_553 Int) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool) (temp___do_typ_inv_552 Bool)) Bool (=> (or (= temp___is_init_549 true) (<= 0 4294967295)) (in_range6 temp___expr_553)))
(assert (forall ((temp___1338 Int)) (=> (dynamic_invariant13 temp___1338 true true true true) (forall ((temp___1339 Int)) (= (select (temp_____aggregate_def_1336 temp___1338) temp___1339) rliteral)))))
...
(declare-const o6 serialnumbert)
...
(assert (in_range20 tokenid))
(assert (= (valid_numberlogentries (to_rep11 logfilestate__split_fields) (to_rep12 logfilestate__split_fields1) (mk___rep4 (mk___split_fields4 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6) true))
...
(assert (= result2 (mk_bool__ref tokenidmatches)))
(assert (= tokenidmatches1 (distinct 0 0)))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields o1 o2 o3)) o4)) (theid o)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o5 (mk___split_fields1 (mk___rep (mk___split_fields o1 o2 o3)) o4)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o6 (rec__certtypes__idt__serialnumber o5)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o7 (to_rep4 o6)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o8 (ite (= tokenid o7) true false)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= result3 (mk_bool__ref tokenidmatches1)))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= tokenidmatches2 o8))))
(assert (=> (= certfound true) (=> (= extractok2 true) (= o9 (cert_id_to_cert (mk___rep7 (let ((subject idcertcontents__split_fields)) idcertcontents__split_fields2)))))))
(assert (=> (= certfound true) (=> (= extractok2 true) (and (= (valid_numberlogentries (to_rep11 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep12 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range17 auditalarm2)))))
(assert (=> (= certfound true) (=> (not (= extractok2 true)) (= state2 state))))
(assert (=> (= certfound true) (=> (not (= extractok2 true)) (= filestate2 filestate))))
(assert (=> (= certfound true) (=> (not (= extractok2 true)) (= tokenidmatches2 tokenidmatches1))))
...
(assert (= idvalid1 (ite (= (ite (= (ite (= certfound true) extractok2 false) true) tokenidmatches2 false) true) verified2 false)))
(assert (not (not (= certfound true))))
(assert (not (not (= extractok2 true))))
(assert (not (not (= tokenidmatches2 true))))
(assert (not (= verified2 true)))
(assert (not (= (to_rep1 (first (mk 1 29))) 1)))
(check-sat)
(exit)
