...
(define-fun dynamic_invariant1 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 1 10)) (in_range2 temp___expr_142)))
...
(assert (in_range1 i))
(assert (forall ((i11 Int)) (=> (and (<= 1 i11) (<= i11 10)) (forall ((i21 Int)) (=> (and (<= i11 i21) (<= i21 10)) (<= (to_rep (select a i11)) (to_rep (select a i21))))))))
...
(assert (<= 1 index2))
(assert (<= index2 (- left1 1)))
(assert (not (< (to_rep (select a index2)) i)))
(check-sat)
(exit)
