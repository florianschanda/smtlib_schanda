...
(assert (= b7 b5))
(assert (= a8 a6))
(assert (= o5 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t (map__content a7) (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (<= 0 j))
(assert (<= j 2147483647))
(assert (and (= o2 (* j l2)) (in_range1 (* j l2))))
(assert (= o3 (* o2 2)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (= result3 (ite (< o4 length1) true false)))
(assert (= result3 true))
