...
(assert (<= 2 certno3))
(assert (and (and (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true) (=> (<= 1 2147483647) (in_range2 certno3))) (in_range11 auditalarm4)) (and (not (= (endoffile thefile3) true)) (= dataok3 true))))
...
(assert (not (= (privatekeypresent thistisinfo__split_fields8 state11) true)))
(check-sat)
(exit)
