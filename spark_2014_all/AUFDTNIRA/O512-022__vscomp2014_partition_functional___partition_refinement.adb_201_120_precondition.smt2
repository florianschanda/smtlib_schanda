...
(assert (= temp___1213 (mk___rep o4)))
(assert (= result2 (mk___split_fields__ref p_prime__split_fields)))
(assert (= p_prime__split_fields1 (us_split_fields1 temp___1213)))
...
(assert (= temp___1215 (mk___rep o7)))
(assert (= result3 (mk___split_fields__ref p_elem__split_fields1)))
(assert (= p_elem__split_fields2 (us_split_fields1 temp___1215)))
(assert (= (to_rep o8) 0))
...
(assert (= temp___1217 (mk___rep o9)))
(assert (= result4 (mk___split_fields__ref p_elem__split_fields2)))
(assert (= p_elem__split_fields3 (us_split_fields1 temp___1217)))
...
(assert (= i1 r54b))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (= temp___1222 i1)))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (= temp___1220 f1)))
...
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields1)) k1) (<= k1 i2)) (= (to_rep2 (select f3 k1)) p_prime_index2)))))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1))) (= (to_rep2 (select f3 k1)) (to_rep2 (select f_loop_entry k1)))))))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 5)) (= (to_rep2 (select f3 k1)) (to_rep2 (select f_loop_entry k1)))))))
(assert (=> (and (<= r54b i1) (<= i1 r55b)) (and (and (forall ((temp___1221 Int)) (=> (and (<= 0 temp___1221) (<= temp___1221 5)) (=> (< i2 temp___1221) (= (select f3 temp___1221) (select temp___1220 temp___1221))))) (=> (<= r54b r55b) (dynamic_property r54b r55b i2))) (and (<= r54b i2) (<= i2 r55b)))))
...
(assert (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields1)) k1) (<= k1 (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields1)))) (= (to_rep2 (select (map__content f6) k1)) (- (length (mk___rep1 p__split_discrs p__split_fields3)) 1)))))
(assert (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1))) (and (<= 0 (to_rep2 (select (map__content f6) k1))) (<= (to_rep2 (select (map__content f6) k1)) (- (length (mk___rep1 p__split_discrs p__split_fields3)) 1))))))
(assert (forall ((k1 Int)) (=> (and (<= (+ (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields1)) 1) k1) (<= k1 5)) (and (<= 0 (to_rep2 (select (map__content f6) k1))) (<= (to_rep2 (select (map__content f6) k1)) (- (length (mk___rep1 p__split_discrs p__split_fields3)) 1))))))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields3)) k1) (<= k1 (to_rep1 (rec__partition_refinement__interval__last p_elem__split_fields3)))) (= (bool_eq (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) (to_rep2 (select (map__content f6) k1))) (mk___rep p_elem__split_fields3)) true))))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields3)) k1) (<= k1 (to_rep1 (rec__partition_refinement__interval__last p_elem__split_fields3)))) (and (<= (to_rep1 (rec__partition_refinement__interval__first (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) (to_rep2 (select (map__content f6) k1)))))) k1) (<= k1 (to_rep1 (rec__partition_refinement__interval__last (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) (to_rep2 (select (map__content f6) k1)))))))))))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields1)) k1) (<= k1 (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields1)))) (= (bool_eq (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) (to_rep2 (select (map__content f6) k1))) (mk___rep p_prime__split_fields1)) true))))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields1)) k1) (<= k1 (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields1)))) (and (<= (to_rep1 (rec__partition_refinement__interval__first (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) (to_rep2 (select (map__content f6) k1)))))) k1) (<= k1 (to_rep1 (rec__partition_refinement__interval__last (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) (to_rep2 (select (map__content f6) k1)))))))))))
(assert (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields3)) 1))) (and (<= (to_rep1 (rec__partition_refinement__interval__first (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) (to_rep2 (select (map__content f6) k1)))))) k1) (<= k1 (to_rep1 (rec__partition_refinement__interval__last (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) (to_rep2 (select (map__content f6) k1)))))))))))
(assert (forall ((k1 Int)) (=> (and (<= (+ (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields1)) 1) k1) (<= k1 5)) (and (<= (to_rep1 (rec__partition_refinement__interval__first (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) (to_rep2 (select (map__content f6) k1)))))) k1) (<= k1 (to_rep1 (rec__partition_refinement__interval__last (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) (to_rep2 (select (map__content f6) k1)))))))))))
(assert (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- j2 1))) (forall ((l1 Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) k1)))) l1) (<= l1 (to_rep1 (rec__partition_refinement__interval__last (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) k1)))))) (= (to_rep2 (select (map__content f6) l1)) k1))))))
(assert (forall ((l1 Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) j2)))) l1) (<= l1 (to_rep1 (rec__partition_refinement__interval__last (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) j2)))))) (= (to_rep2 (select (map__content f6) l1)) j2))))
(assert (and (= o15 (length (mk___rep1 p__split_discrs p__split_fields3))) (and (in_range9 o15) (<= o15 (capacity (mk___rep1 p__split_discrs p__split_fields3))))))
(assert (= o16 (- o15 1)))
(assert (= o17 (ite (<= k o16) true false)))
(assert (and (= o14 (+ j2 1)) (in_range6 (+ j2 1))))
(assert (= o18 (ite (<= o14 k) true false)))
(assert (= result10 (ite (= o18 true) o17 false)))
(assert (= result10 true))
(assert (and (= o20 k) (in_range8 k)))
(assert (and (= o21 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o20)) (= (bool_eq o21 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o20)) true)))
(assert (= o22 (us_split_fields1 o21)))
(assert (= o23 (rec__partition_refinement__interval__last o22)))
(assert (= o24 (to_rep1 o23)))
(assert (= o25 (ite (<= l o24) true false)))
(assert (and (= o19 k) (in_range8 k)))
(assert (not (<= 0 o19)))
(check-sat)
(exit)
