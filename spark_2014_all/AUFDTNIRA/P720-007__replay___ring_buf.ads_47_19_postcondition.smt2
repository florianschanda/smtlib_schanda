...
(assert true)
(assert (forall ((r us_rep)) (! (= (= (is_full r) true) (= (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))) 10000)) :pattern ((is_full r)))))
...
(assert (= (to_rep o) x))
(assert (= o1 (store r__split_fields (mod2 (+ (to_rep1 r__split_fields1) (to_rep2 r__split_fields2)) 10000) o)))
(assert (= o1 o2))
...
(assert (= (mk___split_fields__ref (mk___split_fields result result1 result2)) (mk___split_fields__ref (mk___split_fields r__split_fields r__split_fields1 r__split_fields2))))
(assert (= temp___196 r__split_fields3))
(assert (= temp___1961 r__split_fields4))
(assert (= temp___1962 r__split_fields5))
(assert (and (= o5 (+ (to_rep2 r__split_fields5) 1)) (in_range2 (+ (to_rep2 r__split_fields5) 1))))
