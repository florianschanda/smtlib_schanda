...
(declare-fun adminmustlogout (us_rep Int us_private Int us_private us_split_fields2 Int us_private Int us_split_fields18 us_split_fields24) Bool)
(declare-fun adminmustlogout__function_guard (Bool us_rep Int us_private Int us_private us_split_fields2 Int us_private Int us_split_fields18 us_split_fields24) Bool)
(assert true)
...
(assert (forall ((enclave__status Int)) (forall ((enclave__state us_private)) (! (=> (dynamic_invariant9 enclave__status true true true) (dynamic_invariant9 (getstatus enclave__status enclave__state) true false true)) :pattern ((getstatus enclave__status enclave__state))))))
(assert (forall ((enclave__status Int)) (forall ((enclave__state us_private)) (! (=> (dynamic_invariant9 enclave__status true true true) (= (getstatus enclave__status enclave__state) enclave__status)) :pattern ((getstatus enclave__status enclave__state))))))
...
(declare-const logfilestate__split_fields14 us_split_fields6)
...
(declare-const logfiles6 map__ref2)
(declare-const logfilesstatus6 map__ref3)
(declare-const logfilestate__split_fields16 us_split_fields__ref3)
...
(declare-const tokenpresence4 int__ref)
(declare-const tokentry4 int__ref)
(declare-const tokenid4 int__ref)
(declare-const authcert__split_fields4 us_split_fields__ref9)
(declare-const idcert__split_fields4 us_split_fields__ref12)
(declare-const currentlatch4 int__ref)
(declare-const latchtimeout__split_fields7 us_split_fields__ref1)
...
(declare-const filestate15 us_private__ref)
...
(declare-const status14 us_private__ref)
(declare-const output7 us_private__ref)
(declare-const state70 us_private__ref)
(declare-const state71 us_private__ref)
(declare-const logfiles7 (Array Int us_rep4))
(declare-const logfilesstatus7 (Array Int filestatust))
(declare-const logfilestate__split_fields17 us_split_fields6)
...
(declare-const tokenpresence5 Int)
(declare-const tokentry5 Int)
(declare-const tokenid5 Int)
(declare-const authcert__split_fields5 us_split_fields18)
(declare-const idcert__split_fields5 us_split_fields24)
(declare-const currentlatch5 Int)
(declare-const latchtimeout__split_fields8 us_split_fields2)
(declare-const status15 Int)
...
(declare-const status16 us_private)
(declare-const state76 us_private)
(declare-const state77 us_private)
(declare-const filestate18 us_private)
...
(declare-const status17 us_private)
(declare-const output9 us_private)
(declare-const state83 us_private)
(declare-const state84 us_private)
...
(assert (and (= result (enrolmentisinprogress status (us_private__content state11))) (= (= result true) (in_range30 status))))
(assert (=> (= result true) (and (= o29 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o29 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result true) (= o30 (ite (not (= o29 true)) true false))))
(assert (=> (= result true) (and (= o28 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o28 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result true) (= o31 (ite (not (= o28 true)) true false))))
(assert (=> (= result true) (= o32 (ite (= o31 true) o30 false))))
(assert (=> (not (= result true)) (= o32 (of_int 1))))
(assert (and (= result1 (statusisshutdown status (us_private__content state11))) (= (= result1 true) (= status 8))))
(assert (=> (= result1 true) (and (= o24 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (and (in_range2 o24) (= o24 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result1 true) (= o25 (ite (= o24 0) true false))))
(assert (=> (= result1 true) (and (= o23 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o23 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result1 true) (= o26 (ite (not (= o23 true)) true false))))
(assert (=> (= result1 true) (= o27 (ite (= o26 true) o25 false))))
(assert (=> (not (= result1 true)) (= o27 (of_int 1))))
(assert (and (= result2 (statusisenclavequiescent status (us_private__content state11))) (= (= result2 true) (= status 3))))
(assert (=> (= result2 true) (and (= o21 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o21 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result2 true) (= o22 (ite (not (= o21 true)) true false))))
(assert (=> (not (= result2 true)) (= o22 (of_int 1))))
(assert (and (= o16 (statusiswaitingfinishadminop status (us_private__content state11))) (= (= o16 true) (= status 7))))
(assert (and (= o17 (statusiswaitingstartadminop status (us_private__content state11))) (= (= o17 true) (= status 6))))
(assert (= result3 (ite (= o17 false) o16 true)))
(assert (=> (= result3 true) (and (= o18 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o18 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result3 true) (and (= o19 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o19 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result3 true) (= o20 (ite (= o19 true) o18 false))))
(assert (=> (not (= result3 true)) (= o20 (of_int 1))))
(assert (and (= o12 (statusiswaitingremoveadmintokenfail status (us_private__content state11))) (= (= o12 true) (= status 4))))
(assert (and (= o13 (statusisgotadmintoken status (us_private__content state11))) (= (= o13 true) (= status 5))))
(assert (= result4 (ite (= o13 false) o12 true)))
(assert (=> (= result4 true) (and (= o14 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o14 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result4 true) (= o15 (ite (not (= o14 true)) true false))))
(assert (=> (not (= result4 true)) (= o15 (of_int 1))))
(assert (and (= result6 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= result6 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields)))))))
(assert (=> (= result6 true) (and (= o10 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields)))) (in_range4 o10))))
(assert (=> (= result6 true) (= result5 (ite (= o10 4) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o11 (statusiswaitingstartadminop status (us_private__content state11))) (= (= o11 true) (= status 6)))))
(assert (=> (not (= result5 true)) (= o11 (of_int 1))))
(assert (and (= o7 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o7 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields)))))))
(assert (= result7 (ite (not (= o7 true)) true false)))
(assert (=> (= result7 true) (and (= o8 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o8 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result7 true) (= o9 (ite (not (= o8 true)) true false))))
(assert (=> (not (= result7 true)) (= o9 (of_int 1))))
(assert (and (= o1 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (and (in_range2 o1) (= o1 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields)))))))
(assert (= result8 (ite (= o1 1) true false)))
(assert (= result8 true))
(assert (and (= o3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o3 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields)))))))
(assert (= o4 (ite (not (= o3 true)) true false)))
(assert (and (= result9 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= result9 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields)))))))
(assert (= result9 true))
