...
(assert (and (<= (to_rep h_v1__first) temp___424) (<= temp___424 (to_rep h_v1__last))))
(assert (= o10 temp___424))
...
(assert (not (< k q_v13)))
(assert (< (+ q_v13 m_v11) k))
(assert (not (= (to_rep1 (select h_v13 k)) (to_rep1 (select h_v1 (- k m_v11))))))
(check-sat)
(exit)
