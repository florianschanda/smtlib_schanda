...
(assert (= o10 (select o18 o9)))
(assert (= o11 (to_rep o10)))
(assert (= (to_rep o12) o11))
(assert (and (<= (to_rep c__first) i2) (<= i2 (to_rep c__last))))
(assert (= o13 i2))
(assert (= o14 (store o18 o13 o12)))
(assert (= result2 o18))
(assert (= o19 o14))
(assert (= (to_rep o17) temp1))
(assert (and (= o15 (- (to_rep c__last) i2)) (in_range1 (- (to_rep c__last) i2))))
(assert (= o16 (+ o15 (to_rep c__first))))
(assert (and (= temp___479 o16) (in_range1 o16)))
(assert (not (<= (to_rep c__first) temp___479)))
(check-sat)
(exit)
