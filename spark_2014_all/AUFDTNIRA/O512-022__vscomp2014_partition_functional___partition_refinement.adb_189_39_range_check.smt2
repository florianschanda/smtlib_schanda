...
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields3)) (to_rep1 (rec__partition_refinement__interval__last p_elem__split_fields3))))
(assert (not (<= 0 (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields3)))))
(check-sat)
(exit)
