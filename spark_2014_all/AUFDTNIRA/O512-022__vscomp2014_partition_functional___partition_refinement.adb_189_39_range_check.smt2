...
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields7)) (to_rep1 (rec__partition_refinement__interval__last p_elem__split_fields7))))
(assert (not (<= 0 (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields7)))))
(check-sat)
(exit)
