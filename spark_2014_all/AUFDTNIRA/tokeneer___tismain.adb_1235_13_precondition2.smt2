...
(define-fun in_range22 ((x Int)) Bool (and (<= 0 x) (<= x 8)))
...
(define-fun dynamic_invariant7 ((temp___expr_2880 Int) (temp___is_init_2876 Bool) (temp___skip_constant_2877 Bool) (temp___do_toplevel_2878 Bool) (temp___do_typ_inv_2879 Bool)) Bool (=> (or (= temp___is_init_2876 true) (<= 0 8)) (in_range22 temp___expr_2880)))
(assert true)
...
(assert true)
(assert (forall ((enclave__status Int)) (forall ((enclave__state us_private)) (! (= (= (enrolmentisinprogress enclave__status enclave__state) true) (in_range23 enclave__status)) :pattern ((enrolmentisinprogress enclave__status enclave__state))))))
...
(declare-fun user_eq35 (us_rep11 us_rep11) Bool)
(declare-const dummy35 us_rep11)
...
(assert (forall ((x filestatust)) (! (in_range24 (to_rep14 x)) :pattern ((to_rep14 x)))))
(assert (forall ((x Int)) (! (=> (in_range24 x) (= (to_rep14 (of_rep14 x)) x)) :pattern ((to_rep14 (of_rep14 x))))))
...
(define-fun in_range25 ((x Int)) Bool (and (<= 1 x) (<= x 17)))
...
(assert (forall ((x logfileindext)) (! (in_range25 (to_rep15 x)) :pattern ((to_rep15 x)))))
(assert (forall ((x Int)) (! (=> (in_range25 x) (= (to_rep15 (of_rep15 x)) x)) :pattern ((to_rep15 (of_rep15 x))))))
...
(define-fun in_range26 ((x Int)) Bool (and (<= 0 x) (<= x 17408)))
...
(assert (forall ((x logentrycountt)) (! (in_range26 (to_rep16 x)) :pattern ((to_rep16 x)))))
(assert (forall ((x Int)) (! (=> (in_range26 x) (= (to_rep16 (of_rep16 x)) x)) :pattern ((to_rep16 (of_rep16 x))))))
...
(define-fun in_range27 ((x Int)) Bool (and (<= 0 x) (<= x 17)))
...
(assert (forall ((x logfilecountt)) (! (in_range27 (to_rep17 x)) :pattern ((to_rep17 x)))))
(assert (forall ((x Int)) (! (=> (in_range27 x) (= (to_rep17 (of_rep17 x)) x)) :pattern ((to_rep17 (of_rep17 x))))))
...
(define-fun in_range28 ((x Int)) Bool (and (<= 0 x) (<= x 1024)))
...
(assert (forall ((x fileentrycountt)) (! (in_range28 (to_rep18 x)) :pattern ((to_rep18 x)))))
(assert (forall ((x Int)) (! (=> (in_range28 x) (= (to_rep18 (of_rep18 x)) x)) :pattern ((to_rep18 (of_rep18 x))))))
...
(define-fun dynamic_invariant8 ((temp___expr_648 Int) (temp___is_init_644 Bool) (temp___skip_constant_645 Bool) (temp___do_toplevel_646 Bool) (temp___do_typ_inv_647 Bool)) Bool (=> (or (= temp___is_init_644 true) (<= 0 1)) (in_range29 temp___expr_648)))
...
(define-fun dynamic_invariant19 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17)) (in_range27 temp___expr_1290)))
(define-fun dynamic_invariant20 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 1 17)) (in_range25 temp___expr_1297)))
(define-fun dynamic_invariant21 ((temp___expr_1423 Int) (temp___is_init_1419 Bool) (temp___skip_constant_1420 Bool) (temp___do_toplevel_1421 Bool) (temp___do_typ_inv_1422 Bool)) Bool (=> (or (= temp___is_init_1419 true) (<= 0 2)) (in_range24 temp___expr_1423)))
(define-fun dynamic_invariant22 ((temp___expr_1304 Int) (temp___is_init_1300 Bool) (temp___skip_constant_1301 Bool) (temp___do_toplevel_1302 Bool) (temp___do_typ_inv_1303 Bool)) Bool (=> (or (= temp___is_init_1300 true) (<= 0 17408)) (in_range26 temp___expr_1304)))
(define-fun dynamic_invariant23 ((temp___expr_1335 Int) (temp___is_init_1331 Bool) (temp___skip_constant_1332 Bool) (temp___do_toplevel_1333 Bool) (temp___do_typ_inv_1334 Bool)) Bool (=> (or (= temp___is_init_1331 true) (<= 0 1024)) (in_range28 temp___expr_1335)))
(assert true)
...
(assert (forall ((door__state us_private)) (! (dynamic_invariant8 (thedooralarm door__state) true false true true) :pattern ((thedooralarm door__state)))))
(assert true)
...
(define-fun dynamic_invariant29 ((temp___expr_2967 Int) (temp___is_init_2963 Bool) (temp___skip_constant_2964 Bool) (temp___do_toplevel_2965 Bool) (temp___do_typ_inv_2966 Bool)) Bool (=> (or (= temp___is_init_2963 true) (<= 0 2)) (in_range23 temp___expr_2967)))
...
(declare-const logfilestate__split_fields7 us_split_fields24)
...
(declare-const logfilestate__split_fields8 us_split_fields24)
