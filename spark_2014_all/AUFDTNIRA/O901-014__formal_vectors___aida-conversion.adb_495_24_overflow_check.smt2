...
(assert (and (<= (to_rep1 n__first) temp___1401) (<= temp___1401 (to_rep1 n__last))))
(assert (= o66 temp___1401))
(assert (= o67 (select (map__content1 n7) o66)))
(assert (= o68 (to_rep1 o67)))
(assert (= o69 (* o68 1000)))
(assert (and (= o70 o69) (in_range1 o69)))
(assert (= o71 (+ target3 o70)))
(assert (and (= o72 o71) (in_range1 o71)))
(assert (= result9 (mk_int__ref target3)))
(assert (= target4 o72))
(assert (<= target4 9999))
(assert (and (= temp___1402 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___1402) (<= temp___1402 (to_rep1 n__last))))
(assert (= o73 temp___1402))
(assert (= o74 (select (map__content1 n7) o73)))
(assert (= o75 (to_rep1 o74)))
(assert (= o76 (* o75 10000)))
(assert (and (= o77 o76) (in_range1 o76)))
(assert (= o78 (+ target4 o77)))
(assert (and (= o79 o78) (in_range1 o78)))
(assert (= result10 (mk_int__ref target4)))
(assert (= target5 o79))
(assert (<= target5 99999))
(assert (and (= temp___1403 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___1403) (<= temp___1403 (to_rep1 n__last))))
(assert (= o80 temp___1403))
(assert (= o81 (select (map__content1 n7) o80)))
(assert (= o82 (to_rep1 o81)))
(assert (= o83 (* o82 100000)))
(assert (and (= o84 o83) (in_range1 o83)))
(assert (= o85 (+ target5 o84)))
