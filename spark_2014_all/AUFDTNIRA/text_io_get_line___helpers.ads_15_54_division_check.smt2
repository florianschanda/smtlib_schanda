...
(define-fun dynamic_invariant2 ((temp___expr_349 Int) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool) (temp___do_typ_inv_348 Bool)) Bool (=> (or (= temp___is_init_345 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_349)))
