...
(assert (and (and (and (=> (<= 1 2147483647) (in_range3 left3)) (=> (<= 1 2147483647) (in_range3 right3))) (=> (<= 1 2147483647) (in_range3 med2))) (< left3 right3)))
...
(assert (= result10 (ite (< o18 i) true false)))
(assert (= result10 true))
(assert (not (in_range2 (+ med3 1))))
(check-sat)
(exit)
