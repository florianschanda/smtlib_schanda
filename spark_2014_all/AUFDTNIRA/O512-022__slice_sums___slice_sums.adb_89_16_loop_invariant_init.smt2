...
(assert (<= current_lo2 hi_index2))
(assert (<= hi_index2 (- current_hi2 1)))
(assert (not (<= 0 (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep1 current_lo2) (of_rep2 hi_index2)))))))
(check-sat)
(exit)
