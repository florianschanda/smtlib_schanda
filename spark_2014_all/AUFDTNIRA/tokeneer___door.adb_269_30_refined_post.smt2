...
(define-fun in_range5 ((x Int)) Bool (and (<= 0 x) (<= x 2000)))
...
(define-fun dynamic_invariant ((temp___expr_1138 Int) (temp___is_init_1134 Bool) (temp___skip_constant_1135 Bool) (temp___do_toplevel_1136 Bool) (temp___do_typ_inv_1137 Bool)) Bool (=> (or (= temp___is_init_1134 true) (<= 0 2000)) (in_range5 temp___expr_1138)))
(assert (forall ((configdata__state us_private)) (! (dynamic_invariant (thelatchunlockduration configdata__state) true false true true) :pattern ((thelatchunlockduration configdata__state)))))
(declare-fun thealarmsilentduration (us_private) Int)
(declare-fun thealarmsilentduration__function_guard (Int us_private) Bool)
(assert (forall ((configdata__state us_private)) (! (dynamic_invariant (thealarmsilentduration configdata__state) true false true true) :pattern ((thealarmsilentduration configdata__state)))))
...
(define-fun dynamic_invariant1 ((temp___expr_1401 Int) (temp___is_init_1397 Bool) (temp___skip_constant_1398 Bool) (temp___do_toplevel_1399 Bool) (temp___do_typ_inv_1400 Bool)) Bool (=> (or (= temp___is_init_1397 true) (<= 0 1)) (in_range6 temp___expr_1401)))
(assert true)
(assert (forall ((latch__currentlatch Int)) (forall ((latch__state us_private)) (forall ((latch__latchtimeout__fields us_split_fields)) (! (=> (dynamic_invariant1 latch__currentlatch true true true true) (= (latch_timeout latch__currentlatch latch__state latch__latchtimeout__fields) (mk___rep latch__latchtimeout__fields))) :pattern ((latch_timeout latch__currentlatch latch__state latch__latchtimeout__fields)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_190 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 1)) (in_range12 temp___expr_190)))
...
(define-fun dynamic_invariant4 ((temp___expr_1424 Int) (temp___is_init_1420 Bool) (temp___skip_constant_1421 Bool) (temp___do_toplevel_1422 Bool) (temp___do_typ_inv_1423 Bool)) Bool (=> (or (= temp___is_init_1420 true) (<= 0 1)) (in_range13 temp___expr_1424)))
...
(assert (forall ((door__dooralarm Int)) (! (=> (dynamic_invariant2 door__dooralarm true true true true) (dynamic_invariant2 (thedooralarm door__dooralarm) true false true true)) :pattern ((thedooralarm door__dooralarm)))))
(assert (forall ((door__dooralarm Int)) (! (=> (dynamic_invariant2 door__dooralarm true true true true) (= (thedooralarm door__dooralarm) door__dooralarm)) :pattern ((thedooralarm door__dooralarm)))))
(declare-const attr__ATTRIBUTE_ADDRESS11 Int)
(define-fun dynamic_invariant5 ((temp___expr_1160 Int) (temp___is_init_1156 Bool) (temp___skip_constant_1157 Bool) (temp___do_toplevel_1158 Bool) (temp___do_typ_inv_1159 Bool)) Bool (=> (or (= temp___is_init_1156 true) (<= 0 17)) (in_range10 temp___expr_1160)))
(define-fun dynamic_invariant6 ((temp___expr_1167 Int) (temp___is_init_1163 Bool) (temp___skip_constant_1164 Bool) (temp___do_toplevel_1165 Bool) (temp___do_typ_inv_1166 Bool)) Bool (=> (or (= temp___is_init_1163 true) (<= 1 17)) (in_range8 temp___expr_1167)))
(define-fun dynamic_invariant7 ((temp___expr_1293 Int) (temp___is_init_1289 Bool) (temp___skip_constant_1290 Bool) (temp___do_toplevel_1291 Bool) (temp___do_typ_inv_1292 Bool)) Bool (=> (or (= temp___is_init_1289 true) (<= 0 2)) (in_range7 temp___expr_1293)))
(define-fun dynamic_invariant8 ((temp___expr_1174 Int) (temp___is_init_1170 Bool) (temp___skip_constant_1171 Bool) (temp___do_toplevel_1172 Bool) (temp___do_typ_inv_1173 Bool)) Bool (=> (or (= temp___is_init_1170 true) (<= 0 17408)) (in_range9 temp___expr_1174)))
(define-fun dynamic_invariant9 ((temp___expr_1205 Int) (temp___is_init_1201 Bool) (temp___skip_constant_1202 Bool) (temp___do_toplevel_1203 Bool) (temp___do_typ_inv_1204 Bool)) Bool (=> (or (= temp___is_init_1201 true) (<= 0 1024)) (in_range11 temp___expr_1205)))
(assert true)
...
(assert (forall ((temp___1234 Int)) (=> (dynamic_invariant9 temp___1234 true true true true) (forall ((temp___1235 Int)) (= (select (temp_____aggregate_def_1232 temp___1234) temp___1235) rliteral2)))))
(define-fun dynamic_invariant10 ((temp___expr_476 Int) (temp___is_init_472 Bool) (temp___skip_constant_473 Bool) (temp___do_toplevel_474 Bool) (temp___do_typ_inv_475 Bool)) Bool (=> (or (= temp___is_init_472 true) (<= 1901 2099)) (in_range1 temp___expr_476)))
(define-fun dynamic_invariant11 ((temp___expr_483 Int) (temp___is_init_479 Bool) (temp___skip_constant_480 Bool) (temp___do_toplevel_481 Bool) (temp___do_typ_inv_482 Bool)) Bool (=> (or (= temp___is_init_479 true) (<= 1 12)) (in_range2 temp___expr_483)))
(define-fun dynamic_invariant12 ((temp___expr_490 Int) (temp___is_init_486 Bool) (temp___skip_constant_487 Bool) (temp___do_toplevel_488 Bool) (temp___do_typ_inv_489 Bool)) Bool (=> (or (= temp___is_init_486 true) (<= 1 31)) (in_range3 temp___expr_490)))
(define-fun dynamic_invariant13 ((temp___expr_522 Int) (temp___is_init_518 Bool) (temp___skip_constant_519 Bool) (temp___do_toplevel_520 Bool) (temp___do_typ_inv_521 Bool)) Bool (=> (or (= temp___is_init_518 true) (<= 0 86399999)) (in_range4 temp___expr_522)))
(assert true)
...
(assert (forall ((temp___1230 Int)) (=> (dynamic_invariant6 temp___1230 true true true true) (forall ((temp___1231 Int)) (= (select (temp_____aggregate_def_1228 temp___1230) temp___1231) rliteral)))))
...
(declare-const temp___1476 us_rep)
(declare-const o2 Int)
(declare-const temp___1477 us_rep)
...
(assert (in_range6 currentlatch))
(assert (and (= o1 (thelatchunlockduration state)) (in_range5 o1)))
...
(assert (= temp___1476 (addduration o o1)))
...
(assert (= latchtimeout__split_fields4 (us_split_fields1 temp___1476)))
(assert (and (= (bool_eq (latch_timeout currentlatch1 (let ((subject state2)) state3) latchtimeout__split_fields5) (mk___rep latchtimeout__split_fields4)) true) (in_range6 currentlatch1)))
(assert (and (= o2 (thealarmsilentduration state)) (in_range5 o2)))
(assert (= temp___1477 (addduration (mk___rep latchtimeout__split_fields4) o2)))
