...
(define-fun dynamic_invariant1 ((temp___expr_1015 Int) (temp___is_init_1012 Bool) (temp___skip_constant_1013 Bool) (temp___do_toplevel_1014 Bool)) Bool (=> (or (= temp___is_init_1012 true) (<= 0 2000)) (in_range6 temp___expr_1015)))
...
(assert (forall ((temp___1098 Int)) (forall ((temp___1099 Int)) (= (select (temp___1096 temp___1098) temp___1099) (of_rep4 temp___1098)))))
(declare-fun temp___1100 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1102 Int)) (forall ((temp___1103 Int)) (= (select (temp___1100 temp___1102) temp___1103) (of_rep7 temp___1102)))))
(define-fun dynamic_invariant2 ((temp___expr_1090 us_rep2) (temp___is_init_1087 Bool) (temp___skip_constant_1088 Bool) (temp___do_toplevel_1089 Bool)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1090))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1090))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1090)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1090))) true))
(define-fun default_initial_assumption ((temp___expr_1094 us_rep2) (temp___skip_top_level_1095 Bool)) Bool (and (and (and (= (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1094))) 1) (= (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1094))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1094)) (mk___rep1 (mk___split_fields1 (temp___1096 1) (of_rep4 1) (of_rep4 1) (of_rep6 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1094)) (temp___1100 0))))
(define-fun type_invariant ((temp___1104 us_rep2)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1104))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1104))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1104)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1104))) true))
...
(define-fun dynamic_invariant3 ((temp___expr_1256 Int) (temp___is_init_1253 Bool) (temp___skip_constant_1254 Bool) (temp___do_toplevel_1255 Bool)) Bool (=> (or (= temp___is_init_1253 true) (<= 0 1)) (in_range12 temp___expr_1256)))
...
(define-fun dynamic_invariant4 ((temp___expr_1278 Int) (temp___is_init_1275 Bool) (temp___skip_constant_1276 Bool) (temp___do_toplevel_1277 Bool)) Bool (=> (or (= temp___is_init_1275 true) (<= 0 1)) (in_range13 temp___expr_1278)))
...
(define-fun dynamic_invariant5 ((temp___expr_1056 Int) (temp___is_init_1053 Bool) (temp___skip_constant_1054 Bool) (temp___do_toplevel_1055 Bool)) Bool (=> (or (= temp___is_init_1053 true) (<= 0 17)) (in_range9 temp___expr_1056)))
(define-fun dynamic_invariant6 ((temp___expr_1035 Int) (temp___is_init_1032 Bool) (temp___skip_constant_1033 Bool) (temp___do_toplevel_1034 Bool)) Bool (=> (or (= temp___is_init_1032 true) (<= 1 17)) (in_range7 temp___expr_1035)))
(define-fun dynamic_invariant7 ((temp___expr_1160 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 2)) (in_range11 temp___expr_1160)))
(define-fun dynamic_invariant8 ((temp___expr_1041 Int) (temp___is_init_1038 Bool) (temp___skip_constant_1039 Bool) (temp___do_toplevel_1040 Bool)) Bool (=> (or (= temp___is_init_1038 true) (<= 0 17408)) (in_range8 temp___expr_1041)))
(define-fun dynamic_invariant9 ((temp___expr_1075 Int) (temp___is_init_1072 Bool) (temp___skip_constant_1073 Bool) (temp___do_toplevel_1074 Bool)) Bool (=> (or (= temp___is_init_1072 true) (<= 0 1024)) (in_range10 temp___expr_1075)))
(assert true)
...
(define-fun dynamic_invariant10 ((temp___expr_424 Int) (temp___is_init_421 Bool) (temp___skip_constant_422 Bool) (temp___do_toplevel_423 Bool)) Bool (=> (or (= temp___is_init_421 true) (<= 1901 2099)) (in_range2 temp___expr_424)))
(define-fun dynamic_invariant11 ((temp___expr_430 Int) (temp___is_init_427 Bool) (temp___skip_constant_428 Bool) (temp___do_toplevel_429 Bool)) Bool (=> (or (= temp___is_init_427 true) (<= 1 12)) (in_range3 temp___expr_430)))
(define-fun dynamic_invariant12 ((temp___expr_436 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 1 31)) (in_range4 temp___expr_436)))
(define-fun dynamic_invariant13 ((temp___expr_464 Int) (temp___is_init_461 Bool) (temp___skip_constant_462 Bool) (temp___do_toplevel_463 Bool)) Bool (=> (or (= temp___is_init_461 true) (<= 0 86399999)) (in_range5 temp___expr_464)))
(assert true)
...
(declare-const temp___1330 us_rep)
(declare-const o2 Int)
(declare-const temp___1331 us_rep)
...
(assert (= temp___1330 (addduration o o1)))
...
(assert (= latchtimeout__split_fields4 (us_split_fields1 temp___1330)))
...
(assert (= temp___1331 (addduration (mk___rep latchtimeout__split_fields4) o2)))
...
(assert (= alarmtimeout__split_fields4 (us_split_fields1 temp___1331)))
