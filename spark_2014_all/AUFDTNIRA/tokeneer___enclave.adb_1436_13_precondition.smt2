...
(assert (and (= o33 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o33)))
(assert (= result7 (ite (= o33 2) true false)))
(assert (not (= result7 true)))
(assert (and (= o34 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o34)))
(assert (= result8 (ite (= o34 3) true false)))
