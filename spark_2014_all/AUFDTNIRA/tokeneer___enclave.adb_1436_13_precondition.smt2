...
(assert (and (= o1 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o1)))
(assert (= result1 (ite (= o1 2) true false)))
(assert (not (= result1 true)))
(assert (and (= o2 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o2)))
