...
(define-fun dynamic_invariant1 ((temp___expr_580 Int) (temp___is_init_576 Bool) (temp___skip_constant_577 Bool) (temp___do_toplevel_578 Bool) (temp___do_typ_inv_579 Bool)) Bool (=> (or (= temp___is_init_576 true) (<= 1 200)) (in_range3 temp___expr_580)))
...
(define-fun dynamic_invariant2 ((temp___expr_587 Int) (temp___is_init_583 Bool) (temp___skip_constant_584 Bool) (temp___do_toplevel_585 Bool) (temp___do_typ_inv_586 Bool)) Bool (=> (or (= temp___is_init_583 true) (<= 1 10)) (in_range4 temp___expr_587)))
...
(assert (forall ((c us_rep)) (forall ((p us_rep1)) (! (=> (= (has_element c p) true) (dynamic_invariant (element c p) true false true true)) :pattern ((element c p))))))
(assert (forall ((c us_rep)) (forall ((p us_rep1)) (! (= (element c p) (to_rep1 (let ((temp___628 (rec__container__container__a (us_split_fields1 c)))) (select temp___628 (to_rep (rec__container__cursor__index (us_split_fields3 p))))))) :pattern ((element c p))))))
...
(define-fun dynamic_invariant4 ((temp___expr_46 Int) (temp___is_init_42 Bool) (temp___skip_constant_43 Bool) (temp___do_toplevel_44 Bool) (temp___do_typ_inv_45 Bool)) Bool (=> (or (= temp___is_init_42 true) (<= 1 2147483647)) (in_range5 temp___expr_46)))
(assert (forall ((temp___664 Int)) (=> (dynamic_invariant4 temp___664 true true true true) (forall ((temp___665 Int)) (= (to_rep1 (select (container__arr__aggregate_def temp___664) temp___665)) temp___664)))))
(declare-const x Int)
(declare-const r Int)
(declare-const i Int)
...
(declare-const temp___629 Bool)
(declare-const o2 Int)
(declare-const temp___632 Int)
(declare-const temp___631 Int)
(declare-const temp___634 Int)
(declare-const temp___633 Int)
...
(declare-const temp___6341 Int)
(declare-const temp___6331 Int)
(declare-const result8 int__ref)
(declare-const temp___6342 Int)
(declare-const result9 int__ref)
(declare-const temp___6332 Int)
...
(declare-const temp___6412 us_rep1)
...
(declare-const temp___6414 us_rep1)
...
(declare-const temp___6416 us_rep1)
(declare-const temp___6481 us_rep1)
...
(declare-const temp___6482 us_rep1)
(declare-const result23 int__ref)
(declare-const x21 Int)
(declare-const x22 Int)
(declare-const temp___6431 Int)
(declare-const result24 int__ref)
(declare-const temp___6432 Int)
...
(declare-const temp___6521 Int)
(declare-const temp___6511 Int)
(declare-const result35 int__ref)
(declare-const temp___6512 Int)
(declare-const result36 int__ref)
(declare-const temp___6522 Int)
...
(define-fun o20 () us_rep1 (mk___rep1 (mk___split_fields1 o7)))
...
(assert (=> (< 0 x1) (= temp___630 x1)))
(assert (=> (< 0 x1) (= temp___629 b)))
...
(assert (=> (< i1 10) (= temp___632 i1)))
(assert (=> (< i1 10) (= temp___631 r1)))
(assert (=> (< i1 10) (= 0 temp___634)))
(assert (=> (< i1 10) (= 0 temp___633)))
(assert (=> (< i1 10) (<= (- 100 (* 10 i2)) r2)))
(assert (=> (< i1 10) (and (and (=> (<= 1 200) (in_range3 r2)) (=> (<= 1 10) (in_range4 i2))) (< i2 10))))
(assert (=> (< i1 10) (= result8 (mk_int__ref temp___6341))))
(assert (=> (< i1 10) (= temp___6342 i2)))
(assert (=> (< i1 10) (= result9 (mk_int__ref temp___6331))))
(assert (=> (< i1 10) (= temp___6332 r2)))
...
(assert (= temp___635 (int__content x6)))
...
(assert (= x12 x10))
(assert (= x13 x11))
(assert (= temp___636 (int__content x12)))
(assert (= 0 temp___637))
(assert (and (= o6 (+ (int__content x12) 1)) (in_range3 (+ (int__content x12) 1))))
(assert (= result13 x12))
(assert (= x14 o6))
(assert (=> (<= 1 200) (in_range3 x15)))
(assert (= result14 (mk_int__ref temp___6371)))
(assert (= temp___6372 x15))
(assert (= x15 5))
(assert (= x16 (mk_int__ref x15)))
(assert (= x17 x15))
(assert (= x18 x16))
(assert (= x19 x17))
(assert (and (= o20 (first (mk___rep my_container__split_fields1))) (= (of_rep 1) o7)))
(assert (= temp___641 (mk_cursor__ref o20)))
(assert (and (= result15 (has_element (mk___rep my_container__split_fields1) (cursor__content temp___641))) (= (= result15 true) (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___641))))) (<= (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___641)))) 200)))))
(assert (=> (= result15 true) (and (= o8 (element (mk___rep my_container__split_fields1) (cursor__content temp___641))) (and (in_range1 o8) (= o8 (to_rep1 (select (rec__container__container__a my_container__split_fields1) (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___641)))))))))))
...
(assert (and (= result17 (has_element (mk___rep my_container__split_fields1) (cursor__content temp___641))) (= (= result17 true) (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___641))))) (<= (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___641)))) 200)))))
(assert (=> (= result17 true) (= temp___638 (bool__content b6))))
(assert (=> (= result17 true) (and (= (has_element (mk___rep my_container__split_fields1) (let ((subject temp___641)) temp___6412)) true) (= e9 (element (mk___rep my_container__split_fields1) (let ((subject temp___641)) temp___6412))))))
(assert (=> (= result17 true) (= result18 (mk_bool__ref b8))))
(assert (=> (= result17 true) (= b9 (distinct 0 0))))
(assert (=> (= result17 true) (and (= o9 (next (mk___rep my_container__split_fields1) (let ((subject temp___641)) temp___6412))) (= o9 (ite (< (to_rep (rec__container__cursor__index (us_split_fields3 (let ((subject temp___641)) temp___6412)))) 200) (mk___rep1 (mk___split_fields1 (of_rep (+ (to_rep (rec__container__cursor__index (us_split_fields3 (let ((subject temp___641)) temp___6412)))) 1)))) (mk___rep1 (mk___split_fields1 (of_rep 0))))))))
...
(assert (=> (= result17 true) (= temp___6413 (let ((subject temp___641)) (mk_cursor__ref temp___6412)))))
(assert (=> (= result17 true) (= e10 (mk_int__ref e9))))
(assert (=> (= result17 true) (= b10 (mk_bool__ref b9))))
(assert (=> (= result17 true) (= temp___6414 temp___6412)))
(assert (=> (= result17 true) (= e11 e9)))
(assert (=> (= result17 true) (= b11 b9)))
(assert (=> (= result17 true) (= temp___6415 temp___6413)))
(assert (=> (= result17 true) (= e12 e10)))
(assert (=> (= result17 true) (= b12 b10)))
(assert (=> (= result17 true) (= temp___6416 temp___6414)))
(assert (=> (= result17 true) (= e13 e11)))
(assert (=> (= result17 true) (= b13 b11)))
(assert (=> (not (= result17 true)) (= temp___6415 temp___641)))
(assert (=> (not (= result17 true)) (= e12 e7)))
(assert (=> (not (= result17 true)) (= b12 b6)))
(assert (=> (not (= result17 true)) (= temp___6416 temp___6411)))
...
(assert (= temp___648 (mk_cursor__ref o11)))
(assert (and (= result20 (has_element (mk___rep my_container__split_fields1) (cursor__content temp___648))) (= (= result20 true) (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___648))))) (<= (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___648)))) 200)))))
(assert (=> (= result20 true) (and (= o12 (element (mk___rep my_container__split_fields1) (cursor__content temp___648))) (and (in_range1 o12) (= o12 (to_rep1 (select (rec__container__container__a my_container__split_fields1) (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___648)))))))))))
...
(assert (and (= result22 (has_element (mk___rep my_container__split_fields1) (cursor__content temp___648))) (= (= result22 true) (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___648))))) (<= (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___648)))) 200)))))
(assert (=> (= result22 true) (= temp___645 (int__content x18))))
(assert (=> (= result22 true) (= temp___644 (bool__content b12))))
(assert (=> (= result22 true) (and (=> (<= 1 200) (in_range3 x20)) (and (= (has_element (mk___rep my_container__split_fields1) (let ((subject temp___648)) temp___6482)) true) (= e17 (element (mk___rep my_container__split_fields1) (let ((subject temp___648)) temp___6482)))))))
(assert (=> (= result22 true) (= temp___642 x20)))
(assert (=> (= result22 true) (= temp___643 (mk_int__ref 0))))
...
(assert (=> (= result22 true) (= result24 (let ((subject temp___643)) (mk_int__ref temp___6431)))))
(assert (=> (= result22 true) (= (let ((subject temp___643)) temp___6432) x22)))
(assert (=> (= result22 true) (= x22 5)))
(assert (=> (= result22 true) (= x23 (mk_int__ref x22))))
(assert (=> (= result22 true) (= rho temp___6432)))
...
(assert (=> (= result22 true) (and (= o14 (next (mk___rep my_container__split_fields1) (let ((subject temp___648)) temp___6482))) (= o14 (ite (< (to_rep (rec__container__cursor__index (us_split_fields3 (let ((subject temp___648)) temp___6482)))) 200) (mk___rep1 (mk___split_fields1 (of_rep (+ (to_rep (rec__container__cursor__index (us_split_fields3 (let ((subject temp___648)) temp___6482)))) 1)))) (mk___rep1 (mk___split_fields1 (of_rep 0))))))))
...
(assert (= temp___662 (mk_cursor__ref o16)))
(assert (and (= result27 (has_element (mk___rep my_container__split_fields1) (cursor__content temp___662))) (= (= result27 true) (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___662))))) (<= (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___662)))) 200)))))
(assert (=> (= result27 true) (and (= o17 (element (mk___rep my_container__split_fields1) (cursor__content temp___662))) (and (in_range1 o17) (= o17 (to_rep1 (select (rec__container__container__a my_container__split_fields1) (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___662)))))))))))
...
(assert (and (= result29 (has_element (mk___rep my_container__split_fields1) (cursor__content temp___662))) (= (= result29 true) (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___662))))) (<= (to_rep (rec__container__cursor__index (us_split_fields3 (cursor__content temp___662)))) 200)))))
...
(assert (= r8 o18))
(assert (= b21 true))
(assert (and (and (and (=> (<= 1 200) (in_range3 r9)) (=> (<= (- 2147483648) 2147483647) (in_range1 e25))) (=> (<= 1 200) (in_range3 x31))) (and (= (has_element (mk___rep my_container__split_fields1) (let ((subject temp___662)) temp___6621)) true) (= e25 (element (mk___rep my_container__split_fields1) (let ((subject temp___662)) temp___6621))))))
(assert (= result32 (mk_int__ref temp___659)))
(assert (= temp___6591 r9))
(assert (= result33 (mk_int__ref i8)))
(assert (= i9 1))
(assert (=> (and (<= 1 i9) (<= i9 200)) (= temp___650 x31)))
(assert (=> (and (<= 1 i9) (<= i9 200)) (= temp___649 i9)))
(assert (=> (and (<= 1 i9) (<= i9 200)) (= temp___652 (mk_int__ref 0))))
(assert (=> (and (<= 1 i9) (<= i9 200)) (= temp___651 (mk_int__ref 0))))
...
(assert (=> (and (<= 1 i9) (<= i9 200)) (= result35 (let ((subject temp___651)) (mk_int__ref temp___6511)))))
(assert (=> (and (<= 1 i9) (<= i9 200)) (= (let ((subject temp___651)) temp___6512) i10)))
(assert (=> (and (<= 1 i9) (<= i9 200)) (= result36 (let ((subject temp___652)) (mk_int__ref temp___6521)))))
(assert (=> (and (<= 1 i9) (<= i9 200)) (= (let ((subject temp___652)) temp___6522) x33)))
(assert (=> (and (<= 1 i9) (<= i9 200)) (= i10 200)))
(assert (=> (and (<= 1 i9) (<= i9 200)) (= i11 (mk_int__ref i10))))
(assert (=> (and (<= 1 i9) (<= i9 200)) (= x34 (mk_int__ref x33))))
(assert (=> (and (<= 1 i9) (<= i9 200)) (= rho5 temp___6512)))
(assert (=> (and (<= 1 i9) (<= i9 200)) (= rho4 temp___6522)))
...
(assert (not (= (has_element (mk___rep my_container__split_fields1) (let ((subject temp___662)) temp___6621)) true)))
(check-sat)
(exit)
