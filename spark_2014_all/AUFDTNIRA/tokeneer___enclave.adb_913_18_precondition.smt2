...
(assert (=> (= status 6) (= result2 (ispresent1 state1))))
(assert (=> (= status 6) (=> (= result2 true) (and (in_range6 auditalarm1) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)))))
(assert (=> (= status 6) (=> (= result2 true) (= result3 (mk_int__ref status)))))
(assert (=> (= status 6) (=> (= result2 true) (= status2 7))))
(assert (=> (= status 6) (=> (not (= result2 true)) (and (in_range6 auditalarm2) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true)))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= (let ((subject state2)) (mk___private__ref state7)) (let ((subject state2)) (mk___private__ref state9))))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= state5 state1))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= state6 state8))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= filestate2 filestate3))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= status2 status))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= auditsystemfault auditsystemfault1))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= auditalarm1 auditalarm2))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= logfilestate__split_fields7 logfilestate__split_fields8))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= logfilesstatus logfilesstatus1))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= logfiles logfiles1))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= state7 state9))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= state5 state4))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= state6 state8))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= filestate2 filestate3))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= status2 status1))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= auditsystemfault auditsystemfault1))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= auditalarm1 auditalarm2))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= logfilestate__split_fields7 logfilestate__split_fields8))))
(assert (=> (= status 6) (=> (not (= result2 true)) (= logfilesstatus logfilesstatus1))))
...
(assert (=> (not (= status 6)) (= o1 (currentfloppy state1))))
(assert (=> (not (= status 6)) (= result4 (mk_t__ref1 thecurrentfloppy))))
(assert (=> (not (= status 6)) (= thecurrentfloppy2 o1)))
(assert (=> (not (= status 6)) (and (in_range6 auditalarm3) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true))))
...
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= logfilesstatus2 logfilesstatus3))))
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= logfiles2 logfiles3))))
(assert (=> (not (= status 6)) (= result5 (mk_int__ref status))))
...
(assert (= logfilestate__split_fields12 (mk___split_fields__ref2 logfilestate__split_fields7)))
...
(assert (and (= o6 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o6) (= o6 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= o7 (ite (= o6 o5) true false)))
(assert (=> (= (int__content status4) 3) (and (= o3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o3 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= (int__content status4) 3) (= o4 (ite (not (= o3 true)) true false))))
(assert (=> (not (= (int__content status4) 3)) (= o4 (of_int 1))))
(assert (=> (not (= (int__content status4) 6)) (= (int__content status4) 7)))
