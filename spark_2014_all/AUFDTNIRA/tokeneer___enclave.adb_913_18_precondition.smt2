...
(assert (=> (= (int__content status4) 3) (and (= o1 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o1 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= (int__content status4) 3) (= o2 (ite (not (= o1 true)) true false))))
(assert (=> (not (= (int__content status4) 3)) (= o2 (distinct 1 0))))
