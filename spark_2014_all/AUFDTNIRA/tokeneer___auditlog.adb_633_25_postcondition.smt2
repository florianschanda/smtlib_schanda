...
(declare-const temp___1823 logfileindext)
(declare-const temp___18231 logentrycountt)
(declare-const temp___18232 (Array Int logfileindext))
(declare-const temp___18233 logfileindext)
(declare-const temp___18234 logfileindext)
(declare-const temp___18235 logfilecountt)
(declare-const temp___18236 (Array Int fileentrycountt))
...
(assert (= o2 o9))
(assert (= temp___1823 o3))
(assert (= temp___18231 o4))
(assert (= temp___18232 o5))
(assert (= temp___18233 o6))
(assert (= temp___18234 o7))
(assert (= temp___18235 o8))
(assert (= temp___18236 o9))
...
(assert (= temp___1823 logfilestate__split_fields7))
(assert (= temp___18231 logfilestate__split_fields8))
(assert (= temp___18232 logfilestate__split_fields9))
(assert (= temp___18233 logfilestate__split_fields10))
(assert (= temp___18234 logfilestate__split_fields11))
(assert (= temp___18235 logfilestate__split_fields12))
(assert (= temp___18236 logfilestate__split_fields13))
