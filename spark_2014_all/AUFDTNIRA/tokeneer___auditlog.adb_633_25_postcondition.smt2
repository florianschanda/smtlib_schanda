...
(assert (= o2 o9))
(assert (= temp___1613 o3))
(assert (= temp___16131 o4))
(assert (= temp___16132 o5))
(assert (= temp___16133 o6))
(assert (= temp___16134 o7))
(assert (= temp___16135 o8))
(assert (= temp___16136 o9))
...
(assert (= temp___1613 logfilestate__split_fields7))
(assert (= temp___16131 logfilestate__split_fields8))
(assert (= temp___16132 logfilestate__split_fields9))
(assert (= temp___16133 logfilestate__split_fields10))
(assert (= temp___16134 logfilestate__split_fields11))
(assert (= temp___16135 logfilestate__split_fields12))
(assert (= temp___16136 logfilestate__split_fields13))
(assert (= thefile3 (mk_t__ref thefile2)))
(assert (= logfilestate__split_fields14 (mk___split_fields__ref1 (mk___split_fields1 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13))))
(assert (= auditsystemfault1 (mk_bool__ref auditsystemfault)))
(assert (= logfiles2 (mk_map__ref3 logfiles1)))
(assert (= thefile4 thefile2))
(assert (= logfilestate__split_fields15 (mk___split_fields1 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13)))
