...
(assert (<= 0 k))
(assert (<= k (- j2 1)))
(assert (and (= o15 k) (in_range8 k)))
(assert (and (= o16 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o15)) (= (bool_eq o16 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o15)) true)))
