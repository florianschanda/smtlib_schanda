...
(assert (and (= o25 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o25) (= o25 (to_rep theadmin__split_fields)))))
(assert (= result (ite (= o25 1) true false)))
(assert (=> (= result true) (and (= o27 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o27 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
...
(assert (=> (= result true) (=> (= result1 true) (and (= o26 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o26)))))
...
(assert (=> (= result3 true) (and (= o22 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o22))))
(assert (=> (= result3 true) (= result2 (ite (= o22 3) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o23 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o23) (= o23 (to_rep theadmin__split_fields))))))
(assert (=> (= result2 true) (= o24 (ite (= o23 1) true false))))
(assert (=> (not (= result2 true)) (= o24 (distinct 1 0))))
(assert (and (= o15 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o15) (= o15 (to_rep theadmin__split_fields)))))
(assert (= result4 (ite (= o15 1) true false)))
(assert (=> (= result4 true) (and (= o18 (theauthcertrole tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range2 o18) (= o18 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields))))))))
(assert (=> (= result4 true) (= o19 (ite (= o18 1) true false))))
(assert (=> (= result4 true) (and (= o16 (authcertvalid tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o16 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields)) true)))))
(assert (=> (= result4 true) (and (= o17 (isgood tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o17 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields)) true)))))
...
(assert (and (= o10 (thedooralarm (us_private__content state2))) (in_range6 o10)))
...
(assert (and (= o2 (thecurrentdoor (us_private__content state2))) (in_range27 o2)))
...
(assert (and (= result5 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result5 true) (in_range4 (to_rep1 theadmin__split_fields1)))))
(assert (= result5 true))
