...
(assert (and (= o26 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o26) (= o26 (to_rep theadmin__split_fields)))))
(assert (= result (ite (= o26 1) true false)))
(assert (=> (= result true) (and (= o28 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o28 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
...
(assert (=> (= result true) (=> (= result1 true) (and (= o27 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o27)))))
(assert (=> (= result true) (=> (= result1 true) (= o30 (ite (= o27 3) true false)))))
(assert (=> (= result true) (=> (not (= result1 true)) (= o30 false))))
(assert (=> (= result true) (= o31 (ite (= o30 false) o29 true))))
(assert (=> (not (= result true)) (= o31 (of_int 1))))
...
(assert (=> (= result3 true) (and (= o23 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o23))))
(assert (=> (= result3 true) (= result2 (ite (= o23 3) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o24 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o24) (= o24 (to_rep theadmin__split_fields))))))
(assert (=> (= result2 true) (= o25 (ite (= o24 1) true false))))
(assert (=> (not (= result2 true)) (= o25 (of_int 1))))
(assert (and (= o16 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o16) (= o16 (to_rep theadmin__split_fields)))))
(assert (= result4 (ite (= o16 1) true false)))
(assert (=> (= result4 true) (and (= o19 (theauthcertrole tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range2 o19) (= o19 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields))))))))
(assert (=> (= result4 true) (= o20 (ite (= o19 1) true false))))
(assert (=> (= result4 true) (and (= o17 (authcertvalid tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o17 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields)) true)))))
(assert (=> (= result4 true) (and (= o18 (isgood tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o18 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields)) true)))))
(assert (=> (= result4 true) (= o21 (ite (= o18 true) o17 false))))
(assert (=> (= result4 true) (= o22 (ite (= o21 true) o20 false))))
(assert (=> (not (= result4 true)) (= o22 (of_int 1))))
(assert (and (= o11 (thedooralarm (us_private__content state4))) (in_range6 o11)))
(assert (= o12 (ite (= o11 0) true false)))
(assert (= o13 (to_int1 o12)))
(assert (= o7 (alarm_timeout (us_private__content state4))))
(assert (and (= o6 (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime)) (= o6 (mk___rep1 (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3)))))
(assert (and (= o8 (greaterthanorequal o6 o7)) (= (= o8 true) (or (= (greaterthan o6 o7) true) (= (bool_eq1 o6 o7) true)))))
(assert (and (= o3 (thecurrentdoor (us_private__content state4))) (in_range27 o3)))
(assert (= o4 (ite (= o3 0) true false)))
(assert (and (= o5 (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) (= (= o5 true) (= currentlatch 0))))
