...
(assert (and (= o25 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range1 o25) (= o25 (to_rep theadmin__split_fields)))))
(assert (= result (ite (= o25 1) true false)))
(assert (=> (= result true) (and (= o27 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o27 true) (in_range3 (to_rep1 theadmin__split_fields1))))))
...
(assert (=> (= result true) (=> (= result1 true) (and (= o26 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o26)))))
(assert (=> (= result true) (=> (= result1 true) (= o29 (ite (= o26 3) true false)))))
(assert (=> (= result true) (=> (not (= result1 true)) (= o29 false))))
(assert (=> (= result true) (= o30 (ite (= o29 false) o28 true))))
(assert (=> (not (= result true)) (= o30 (distinct 1 0))))
...
(assert (=> (= result3 true) (and (= o22 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o22))))
(assert (=> (= result3 true) (= result2 (ite (= o22 3) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o23 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range1 o23) (= o23 (to_rep theadmin__split_fields))))))
(assert (=> (= result2 true) (= o24 (ite (= o23 1) true false))))
(assert (=> (not (= result2 true)) (= o24 (distinct 1 0))))
(assert (and (= o15 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range1 o15) (= o15 (to_rep theadmin__split_fields)))))
(assert (= result4 (ite (= o15 1) true false)))
(assert (=> (= result4 true) (and (= o18 (theauthcertrole tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content6 idcert__split_fields))) (and (in_range1 o18) (= o18 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content9 authcert__split_fields))))))))
(assert (=> (= result4 true) (= o19 (ite (= o18 1) true false))))
(assert (=> (= result4 true) (and (= o16 (authcertvalid tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content6 idcert__split_fields))) (= (= o16 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content9 authcert__split_fields)) true)))))
(assert (=> (= result4 true) (and (= o17 (isgood tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content6 idcert__split_fields))) (= (= o17 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields)) true)))))
(assert (=> (= result4 true) (= o20 (ite (= o17 true) o16 false))))
(assert (=> (= result4 true) (= o21 (ite (= o20 true) o19 false))))
(assert (=> (not (= result4 true)) (= o21 (distinct 1 0))))
(assert (and (= o10 (thedooralarm (us_private__content state2))) (in_range22 o10)))
(assert (= o11 (ite (= o10 0) true false)))
(assert (= o12 (ite o11 1 0)))
(assert (= o6 (alarm_timeout (us_private__content state2))))
(assert (and (= o5 (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime)) (= o5 (mk___rep1 (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3)))))
(assert (and (= o7 (greaterthanorequal o5 o6)) (= (= o7 true) (or (= (greaterthan o5 o6) true) (= (bool_eq1 o5 o6) true)))))
(assert (and (= o2 (thecurrentdoor (us_private__content state2))) (in_range21 o2)))
(assert (= o3 (ite (= o2 0) true false)))
(assert (and (= o4 (islocked currentlatch (us_private__content state1) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) (= (= o4 true) (= currentlatch 0))))
(assert (= o8 (ite (= o4 true) o3 false)))
(assert (= o9 (ite (= o8 true) o7 false)))
(assert (= o13 (ite o9 1 0)))
