...
(assert (= (= o2 true) (forall ((hi_index1 Int)) (=> (and (<= (to_rep (first (rt x))) hi_index1) (<= hi_index1 (- hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index1)))) max_sum3)))))
