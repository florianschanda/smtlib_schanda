...
(define-fun dynamic_invariant ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 1)) (in_range1 temp___expr_221)))
...
(define-fun dynamic_invariant1 ((temp___expr_593 Int) (temp___is_init_589 Bool) (temp___skip_constant_590 Bool) (temp___do_toplevel_591 Bool) (temp___do_typ_inv_592 Bool)) Bool (=> (or (= temp___is_init_589 true) (<= 0 1)) (in_range2 temp___expr_593)))
...
(define-fun bool_eq2 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep3 (select a temp___idx_176)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_176))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep3 (select a temp___idx_176)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_1337 us_rep1) (temp___is_init_1333 Bool) (temp___skip_constant_1334 Bool) (temp___do_toplevel_1335 Bool) (temp___do_typ_inv_1336 Bool)) Bool (=> (= temp___do_typ_inv_1336 true) (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1337))) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1337))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1337)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1337))) true)))
(define-fun default_initial_assumption ((temp___expr_1341 us_rep1) (temp___skip_top_level_1342 Bool)) Bool (and (and (and (= (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1341))) 1) (= (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1341))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1341)) (mk___rep (mk___split_fields (temp___1343 1) (of_rep 1) (of_rep 1) (of_rep2 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1341)) (temp___1347 0))))
(define-fun type_invariant ((temp___1351 us_rep1)) Bool (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1351))) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1351))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1351)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1351))) true))
...
(define-fun bool_eq5 ((a (Array Int us_rep2)) (a__first Int) (a__last Int) (b (Array Int us_rep2)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq4 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true)))) true false))
(assert (forall ((a (Array Int us_rep2)) (b (Array Int us_rep2))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq4 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true))))))))
...
(define-fun bool_eq6 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep4 (select a temp___idx_178)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_178))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep4 (select a temp___idx_178)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_178)))))))))))
...
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep7 (select a temp___idx_91)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_91)))))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_1220 Int) (temp___is_init_1216 Bool) (temp___skip_constant_1217 Bool) (temp___do_toplevel_1218 Bool) (temp___do_typ_inv_1219 Bool)) Bool (=> (or (= temp___is_init_1216 true) (<= 0 3)) (in_range17 temp___expr_1220)))
(declare-fun therole (us_rep7) Int)
(declare-fun therole__function_guard (Int us_rep7) Bool)
(assert (forall ((admintoken__authcert__fields us_split_fields14)) (! (dynamic_invariant3 (theauthcertrole admintoken__authcert__fields) true false true true) :pattern ((theauthcertrole admintoken__authcert__fields)))))
...
(define-fun dynamic_invariant4 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range10 temp___expr_74)))
(define-fun dynamic_invariant5 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range9 temp___expr_402)))
(define-fun dynamic_invariant6 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range11 temp___expr_426)))
(define-fun dynamic_invariant7 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range8 temp___expr_450)))
(define-fun dynamic_invariant8 ((temp___expr_464 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool) (temp___do_typ_inv_463 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 4294967295)) (in_range19 temp___expr_464)))
(define-fun dynamic_invariant9 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 0 128)) (in_range20 temp___expr_471)))
(define-fun dynamic_invariant10 ((temp___expr_1275 Int) (temp___is_init_1271 Bool) (temp___skip_constant_1272 Bool) (temp___do_toplevel_1273 Bool) (temp___do_typ_inv_1274 Bool)) Bool (=> (or (= temp___is_init_1271 true) (<= 0 17)) (in_range5 temp___expr_1275)))
(define-fun dynamic_invariant11 ((temp___expr_1282 Int) (temp___is_init_1278 Bool) (temp___skip_constant_1279 Bool) (temp___do_toplevel_1280 Bool) (temp___do_typ_inv_1281 Bool)) Bool (=> (or (= temp___is_init_1278 true) (<= 1 17)) (in_range3 temp___expr_1282)))
(define-fun dynamic_invariant12 ((temp___expr_1408 Int) (temp___is_init_1404 Bool) (temp___skip_constant_1405 Bool) (temp___do_toplevel_1406 Bool) (temp___do_typ_inv_1407 Bool)) Bool (=> (or (= temp___is_init_1404 true) (<= 0 2)) (in_range7 temp___expr_1408)))
(define-fun dynamic_invariant13 ((temp___expr_1289 Int) (temp___is_init_1285 Bool) (temp___skip_constant_1286 Bool) (temp___do_toplevel_1287 Bool) (temp___do_typ_inv_1288 Bool)) Bool (=> (or (= temp___is_init_1285 true) (<= 0 17408)) (in_range4 temp___expr_1289)))
(define-fun dynamic_invariant14 ((temp___expr_1320 Int) (temp___is_init_1316 Bool) (temp___skip_constant_1317 Bool) (temp___do_toplevel_1318 Bool) (temp___do_typ_inv_1319 Bool)) Bool (=> (or (= temp___is_init_1316 true) (<= 0 1024)) (in_range6 temp___expr_1320)))
(assert true)
...
(assert (forall ((temp___1349 Int)) (=> (dynamic_invariant14 temp___1349 true true true true) (forall ((temp___1350 Int)) (= (to_rep3 (select (temp___1347 temp___1349) temp___1350)) temp___1349)))))
(define-fun dynamic_invariant15 ((temp___expr_670 Int) (temp___is_init_666 Bool) (temp___skip_constant_667 Bool) (temp___do_toplevel_668 Bool) (temp___do_typ_inv_669 Bool)) Bool (=> (or (= temp___is_init_666 true) (<= 1901 2099)) (in_range13 temp___expr_670)))
(define-fun dynamic_invariant16 ((temp___expr_677 Int) (temp___is_init_673 Bool) (temp___skip_constant_674 Bool) (temp___do_toplevel_675 Bool) (temp___do_typ_inv_676 Bool)) Bool (=> (or (= temp___is_init_673 true) (<= 1 12)) (in_range14 temp___expr_677)))
(define-fun dynamic_invariant17 ((temp___expr_684 Int) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool) (temp___do_typ_inv_683 Bool)) Bool (=> (or (= temp___is_init_680 true) (<= 1 31)) (in_range15 temp___expr_684)))
(define-fun dynamic_invariant18 ((temp___expr_716 Int) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool) (temp___do_typ_inv_715 Bool)) Bool (=> (or (= temp___is_init_712 true) (<= 0 86399999)) (in_range16 temp___expr_716)))
(define-fun dynamic_invariant19 ((temp___expr_1234 Int) (temp___is_init_1230 Bool) (temp___skip_constant_1231 Bool) (temp___do_toplevel_1232 Bool) (temp___do_typ_inv_1233 Bool)) Bool (=> (or (= temp___is_init_1230 true) (<= 0 5)) (in_range18 temp___expr_1234)))
(define-fun dynamic_invariant20 ((temp___expr_553 Int) (temp___is_init_549 Bool) (temp___skip_constant_550 Bool) (temp___do_toplevel_551 Bool) (temp___do_typ_inv_552 Bool)) Bool (=> (or (= temp___is_init_549 true) (<= 0 4294967295)) (in_range12 temp___expr_553)))
(assert (forall ((contents us_rep7)) (! (dynamic_invariant3 (therole contents) true false true true) :pattern ((therole contents)))))
...
(assert (forall ((temp___1345 Int)) (=> (dynamic_invariant11 temp___1345 true true true true) (forall ((temp___1346 Int)) (= (to_rep (select (temp___1343 temp___1345) temp___1346)) temp___1345)))))
(assert (not true))
(check-sat)
(exit)
