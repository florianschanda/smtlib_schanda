...
(define-fun dynamic_invariant ((temp___expr_194 Int) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool)) Bool (=> (or (= temp___is_init_191 true) (<= 0 1)) (in_range1 temp___expr_194)))
...
(define-fun dynamic_invariant1 ((temp___expr_529 Int) (temp___is_init_526 Bool) (temp___skip_constant_527 Bool) (temp___do_toplevel_528 Bool)) Bool (=> (or (= temp___is_init_526 true) (<= 0 1)) (in_range2 temp___expr_529)))
...
(assert (forall ((x logfileindext)) (! (in_range3 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range4 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x fileentrycountt)) (! (in_range6 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun bool_eq2 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep3 (select a temp___idx_154)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(assert (forall ((temp___1195 Int)) (forall ((temp___1196 Int)) (= (select (temp___1193 temp___1195) temp___1196) (of_rep temp___1195)))))
(declare-fun temp___1197 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1199 Int)) (forall ((temp___1200 Int)) (= (select (temp___1197 temp___1199) temp___1200) (of_rep3 temp___1199)))))
(define-fun dynamic_invariant2 ((temp___expr_1187 us_rep1) (temp___is_init_1184 Bool) (temp___skip_constant_1185 Bool) (temp___do_toplevel_1186 Bool)) Bool (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1187))) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1187))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1187)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1187))) true))
(define-fun default_initial_assumption ((temp___expr_1191 us_rep1) (temp___skip_top_level_1192 Bool)) Bool (and (and (and (= (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1191))) 1) (= (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1191))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1191)) (mk___rep (mk___split_fields (temp___1193 1) (of_rep 1) (of_rep 1) (of_rep2 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1191)) (temp___1197 0))))
(define-fun type_invariant ((temp___1201 us_rep1)) Bool (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1201))) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1201))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1201)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1201))) true))
...
(define-fun bool_eq6 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep4 (select a temp___idx_156)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_156))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep4 (select a temp___idx_156)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_156)))))))))))
...
(declare-fun user_eq13 (namecountt namecountt) Bool)
(declare-const dummy13 namecountt)
...
(declare-fun user_eq14 (character character) Bool)
(declare-const dummy14 character)
...
(define-fun bool_eq7 ((a (Array Int character)) (a__first Int) (a__last Int) (b (Array Int character)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_78 Int)) (=> (and (<= a__first temp___idx_78) (<= temp___idx_78 a__last)) (= (to_rep7 (select a temp___idx_78)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_78))))))) true false))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_78 Int)) (=> (and (<= a__first temp___idx_78) (<= temp___idx_78 a__last)) (= (to_rep7 (select a temp___idx_78)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_78)))))))))))
...
(declare-fun user_eq16 (issueridt issueridt) Bool)
(declare-const dummy16 issueridt)
...
(define-fun bool_eq8 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep8 (rec__cryptotypes__issuert__id (us_split_fields5 a))) (to_rep8 (rec__cryptotypes__issuert__id (us_split_fields5 b)))) (= (to_rep6 (rec__cryptotypes__issuert__namelength (us_split_fields5 a))) (to_rep6 (rec__cryptotypes__issuert__namelength (us_split_fields5 b))))) (= (bool_eq7 (rec__cryptotypes__issuert__name (us_split_fields5 a)) 1 40 (rec__cryptotypes__issuert__name (us_split_fields5 b)) 1 40) true)) true false))
...
(declare-fun user_eq18 (serialnumbert serialnumbert) Bool)
(declare-const dummy18 serialnumbert)
...
(declare-fun to_rep9 (serialnumbert) Int)
...
(define-fun bool_eq9 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (bool_eq8 (rec__certtypes__idt__issuer (us_split_fields7 a)) (rec__certtypes__idt__issuer (us_split_fields7 b))) true) (= (to_rep9 (rec__certtypes__idt__serialnumber (us_split_fields7 a))) (to_rep9 (rec__certtypes__idt__serialnumber (us_split_fields7 b))))) true false))
...
(define-fun in_range13 ((x Int)) Bool (and (<= 1901 x) (<= x 2099)))
...
(assert (forall ((x yearst)) (! (in_range13 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(assert (forall ((x monthst)) (! (in_range14 (to_rep11 x)) :pattern ((to_rep11 x)))))
(assert (forall ((x Int)) (! (=> (in_range14 x) (= (to_rep11 (of_rep11 x)) x)) :pattern ((to_rep11 (of_rep11 x))))))
(declare-sort dayst 0)
(define-fun in_range15 ((x Int)) Bool (and (<= 1 x) (<= x 31)))
...
(assert (forall ((x dayst)) (! (in_range15 (to_rep12 x)) :pattern ((to_rep12 x)))))
(assert (forall ((x Int)) (! (=> (in_range15 x) (= (to_rep12 (of_rep12 x)) x)) :pattern ((to_rep12 (of_rep12 x))))))
(declare-sort millisecst 0)
(define-fun in_range16 ((x Int)) Bool (and (<= 0 x) (<= x 86399999)))
...
(assert (forall ((x millisecst)) (! (in_range16 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun in_range17 ((x Int)) Bool (and (<= 0 x) (<= x 3)))
...
(declare-fun user_eq25 (privileget privileget) Bool)
(declare-const dummy25 privileget)
...
(declare-fun to_rep14 (privileget) Int)
(declare-fun of_rep14 (Int) privileget)
(assert (forall ((x privileget)) (! (= (of_rep14 (to_rep14 x)) x) :pattern ((to_rep14 x)))))
(assert (forall ((x privileget)) (! (in_range17 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(assert (forall ((x classt)) (! (in_range18 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(define-fun us_rep___10__projection ((a us_rep6)) us_split_fields10 (us_split_fields11 a))
(define-fun bool_eq11 ((a us_rep6) (b us_rep6)) Bool (ite (= (to_rep15 (rec__privtypes__clearancet__class (us_split_fields11 a))) (to_rep15 (rec__privtypes__clearancet__class (us_split_fields11 b)))) true false))
...
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__attr__auth__contentst__id us_rep4) (rec__cert__attr__auth__contentst__notbefore us_rep5) (rec__cert__attr__auth__contentst__notafter us_rep5) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep4) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep6)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields12)) us_rep4 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields12)) us_rep5 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields12)) us_rep5 (rec__cert__attr__auth__contentst__notafter a))
...
(define-fun bool_eq12 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (and (and (= (bool_eq9 (rec__cert__attr__auth__contentst__id (us_split_fields13 a)) (rec__cert__attr__auth__contentst__id (us_split_fields13 b))) true) (= (bool_eq10 (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq10 (rec__cert__attr__auth__contentst__notafter (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep5 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 a))) (to_rep5 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq9 (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 b))) true)) (= (to_rep14 (rec__cert__attr__auth__contentst__role (us_split_fields13 a))) (to_rep14 (rec__cert__attr__auth__contentst__role (us_split_fields13 b))))) (= (bool_eq11 (rec__cert__attr__auth__contentst__clearance (us_split_fields13 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields13 b))) true)) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_1083 Int) (temp___is_init_1080 Bool) (temp___skip_constant_1081 Bool) (temp___do_toplevel_1082 Bool)) Bool (=> (or (= temp___is_init_1080 true) (<= 0 3)) (in_range17 temp___expr_1083)))
...
(assert (forall ((x keyidt)) (! (in_range19 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(assert (forall ((x keylengtht)) (! (in_range20 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(define-fun bool_eq14 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (= (to_rep5 (rec__cryptotypes__keypartt__algorithmid (us_split_fields17 a))) (to_rep5 (rec__cryptotypes__keypartt__algorithmid (us_split_fields17 b)))) (= (to_rep16 (rec__cryptotypes__keypartt__keyid (us_split_fields17 a))) (to_rep16 (rec__cryptotypes__keypartt__keyid (us_split_fields17 b))))) (= (to_rep17 (rec__cryptotypes__keypartt__keylength (us_split_fields17 a))) (to_rep17 (rec__cryptotypes__keypartt__keylength (us_split_fields17 b))))) true false))
...
(declare-datatypes () ((us_split_fields18 (mk___split_fields9 (rec__cert__id__contentst__id us_rep4) (rec__cert__id__contentst__notbefore us_rep5) (rec__cert__id__contentst__notafter us_rep5) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep3) (rec__cert__id__contentst__subjectpublickey us_rep9)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields18)) us_rep4 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields18)) us_rep5 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields18)) us_rep5 (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields18)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields18)) us_rep3 (rec__cert__id__contentst__subject a))
...
(declare-fun user_eq33 (us_rep10 us_rep10) Bool)
(declare-const dummy33 us_rep10)
...
(declare-fun user_eq34 (us_rep11 us_rep11) Bool)
(declare-const dummy34 us_rep11)
...
(declare-fun isgood (us_split_fields20) Bool)
(declare-fun isgood__function_guard (Bool us_split_fields20) Bool)
(assert true)
(assert (forall ((admintoken__idcert__fields us_split_fields20)) (! (= (= (isgood admintoken__idcert__fields) true) (= (rec__admintoken__valididcertt__valid (us_split_fields21 (mk___rep10 admintoken__idcert__fields))) true)) :pattern ((isgood admintoken__idcert__fields)))))
...
(define-fun dynamic_invariant4 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range10 temp___expr_63)))
(define-fun dynamic_invariant5 ((temp___expr_359 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 40)) (in_range9 temp___expr_359)))
(define-fun dynamic_invariant6 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 4294967295)) (in_range11 temp___expr_380)))
(define-fun dynamic_invariant7 ((temp___expr_402 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 10)) (in_range8 temp___expr_402)))
(define-fun dynamic_invariant8 ((temp___expr_414 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 0 4294967295)) (in_range19 temp___expr_414)))
(define-fun dynamic_invariant9 ((temp___expr_420 Int) (temp___is_init_417 Bool) (temp___skip_constant_418 Bool) (temp___do_toplevel_419 Bool)) Bool (=> (or (= temp___is_init_417 true) (<= 0 128)) (in_range20 temp___expr_420)))
(define-fun dynamic_invariant10 ((temp___expr_1153 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 17)) (in_range5 temp___expr_1153)))
(define-fun dynamic_invariant11 ((temp___expr_1132 Int) (temp___is_init_1129 Bool) (temp___skip_constant_1130 Bool) (temp___do_toplevel_1131 Bool)) Bool (=> (or (= temp___is_init_1129 true) (<= 1 17)) (in_range3 temp___expr_1132)))
(define-fun dynamic_invariant12 ((temp___expr_1257 Int) (temp___is_init_1254 Bool) (temp___skip_constant_1255 Bool) (temp___do_toplevel_1256 Bool)) Bool (=> (or (= temp___is_init_1254 true) (<= 0 2)) (in_range7 temp___expr_1257)))
(define-fun dynamic_invariant13 ((temp___expr_1138 Int) (temp___is_init_1135 Bool) (temp___skip_constant_1136 Bool) (temp___do_toplevel_1137 Bool)) Bool (=> (or (= temp___is_init_1135 true) (<= 0 17408)) (in_range4 temp___expr_1138)))
(define-fun dynamic_invariant14 ((temp___expr_1172 Int) (temp___is_init_1169 Bool) (temp___skip_constant_1170 Bool) (temp___do_toplevel_1171 Bool)) Bool (=> (or (= temp___is_init_1169 true) (<= 0 1024)) (in_range6 temp___expr_1172)))
(assert true)
...
(define-fun dynamic_invariant15 ((temp___expr_597 Int) (temp___is_init_594 Bool) (temp___skip_constant_595 Bool) (temp___do_toplevel_596 Bool)) Bool (=> (or (= temp___is_init_594 true) (<= 1901 2099)) (in_range13 temp___expr_597)))
(define-fun dynamic_invariant16 ((temp___expr_603 Int) (temp___is_init_600 Bool) (temp___skip_constant_601 Bool) (temp___do_toplevel_602 Bool)) Bool (=> (or (= temp___is_init_600 true) (<= 1 12)) (in_range14 temp___expr_603)))
(define-fun dynamic_invariant17 ((temp___expr_609 Int) (temp___is_init_606 Bool) (temp___skip_constant_607 Bool) (temp___do_toplevel_608 Bool)) Bool (=> (or (= temp___is_init_606 true) (<= 1 31)) (in_range15 temp___expr_609)))
(define-fun dynamic_invariant18 ((temp___expr_637 Int) (temp___is_init_634 Bool) (temp___skip_constant_635 Bool) (temp___do_toplevel_636 Bool)) Bool (=> (or (= temp___is_init_634 true) (<= 0 86399999)) (in_range16 temp___expr_637)))
(define-fun dynamic_invariant19 ((temp___expr_1095 Int) (temp___is_init_1092 Bool) (temp___skip_constant_1093 Bool) (temp___do_toplevel_1094 Bool)) Bool (=> (or (= temp___is_init_1092 true) (<= 0 5)) (in_range18 temp___expr_1095)))
(define-fun dynamic_invariant20 ((temp___expr_493 Int) (temp___is_init_490 Bool) (temp___skip_constant_491 Bool) (temp___do_toplevel_492 Bool)) Bool (=> (or (= temp___is_init_490 true) (<= 0 4294967295)) (in_range12 temp___expr_493)))
(assert (forall ((contents us_rep7)) (! (dynamic_invariant3 (therole contents) true false true) :pattern ((therole contents)))))
(assert (forall ((contents us_rep7)) (! (= (therole contents) (to_rep14 (rec__cert__attr__auth__contentst__role (us_split_fields13 contents)))) :pattern ((therole contents)))))
...
(assert (in_range2 auditalarm))
(assert (and (= (valid_numberlogentries (to_rep logfilestate__split_fields7) (to_rep1 logfilestate__split_fields8) (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) true) (in_range2 auditalarm1)))
(assert (and (= o (thetokenpresence state1)) (in_range1 o)))
(assert (= result tokenpresence))
(assert (= tokenpresence1 o))
(assert (= status1 (mk___private__ref status)))
(assert (= state3 (mk___private__ref state1)))
(assert (= filestate1 (mk___private__ref filestate)))
(assert (= state2 (mk___private__ref state)))
...
(assert (= logfilestate__split_fields14 logfilestate__split_fields7))
(assert (= logfilestate__split_fields15 logfilestate__split_fields8))
(assert (= logfilestate__split_fields16 logfilestate__split_fields9))
(assert (= logfilestate__split_fields17 logfilestate__split_fields10))
(assert (= logfilestate__split_fields18 logfilestate__split_fields11))
(assert (= logfilestate__split_fields19 logfilestate__split_fields12))
(assert (= logfilestate__split_fields20 logfilestate__split_fields13))
...
(assert (= logfilestate__split_fields21 (mk___split_fields1 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13)))
