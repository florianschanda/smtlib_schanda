...
(assert (not (= (enrolmentisinprogress (int__content status9) (us_private__content state51)) true)))
(assert (not (= (privatekeypresent (us_split_fields__content5 thistisinfo__split_fields6) (us_private__content state42)) true)))
(check-sat)
(exit)
