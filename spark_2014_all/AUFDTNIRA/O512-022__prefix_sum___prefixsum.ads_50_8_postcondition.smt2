...
(assert (=> (< 0 space2) (and (and (or (or (= space3 4) (= space3 2)) (= space3 1)) (= (all_elements_in a2 (* (* (div1 4 space3) 8) 1000000)) true)) (forall ((k Int)) (=> (and (<= 0 k) (<= k 7)) (ite (= space3 4) (= (to_rep (select a2 k)) (to_rep (select temp___228 k))) (ite (and (= space3 2) (= (mod2 (+ k 1) 8) 0)) (= (to_rep (select a2 k)) (+ (to_rep (select temp___229 k)) (to_rep (select temp___230 (- k (* 2 space3)))))) (ite (and (= space3 2) (= (mod2 (+ k 1) 4) 0)) (= (to_rep (select a2 k)) (to_rep (select temp___232 (+ k (* 2 space3))))) (ite (= space3 2) (= (to_rep (select a2 k)) (to_rep (select temp___234 k))) (ite (and (= space3 1) (= (mod2 (+ k 1) 2) 0)) (and (and (and (= (to_rep (select a2 1)) (to_rep (select temp___235 7))) (= (to_rep (select a2 3)) (+ (to_rep (select temp___236 1)) (to_rep (select temp___237 7))))) (= (to_rep (select a2 5)) (+ (to_rep (select temp___238 7)) (to_rep (select temp___239 3))))) (= (to_rep (select a2 7)) (+ (+ (to_rep (select temp___240 5)) (to_rep (select temp___241 7))) (to_rep (select temp___242 3))))) (= (to_rep (select a2 k)) (to_rep (select temp___243 k)))))))))))))
...
(assert (=> (< 0 space2) (and (= o3 (* space3 2)) (in_range1 (* space3 2)))))
...
(assert (=> (< 0 space2) (=> (< right3 8) (and (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 7)) (ite (and (<= 0 k) (<= k (- right4 (* space3 2)))) (ite (= (mod2 (+ k 1) (* 2 space3)) 0) (= (to_rep (select a3 k)) (+ (to_rep (select temp___214 k)) (to_rep (select temp___215 (- k space3))))) (ite (= (mod2 (+ k 1) space3) 0) (= (to_rep (select a3 k)) (to_rep (select temp___217 (+ k space3)))) (= (to_rep (select a3 k)) (to_rep (select temp___219 k))))) (= (to_rep (select a3 k)) (to_rep (select temp___220 k)))))) (= (mod2 (+ right4 1) (* space3 2)) 0)) (not (<= 8 right4))))))
...
(assert (=> (< 0 space2) (=> (< right3 8) (and (= o7 (- right4 space3)) (in_range1 (- right4 space3))))))
...
(assert (=> (< 0 space2) (=> (< right3 8) (and (= o19 o18) (in_range1 o18)))))
...
(assert (=> (< 0 space2) (=> (< right3 8) (and (= o26 (* space3 2)) (in_range1 (* space3 2))))))
(assert (=> (< 0 space2) (=> (< right3 8) (= o27 (+ right4 o26)))))
(assert (=> (< 0 space2) (=> (< right3 8) (and (= o28 o27) (in_range1 o27)))))
(assert (=> (< 0 space2) (=> (< right3 8) (and (= o29 o28) (in_range2 o28)))))
