...
(assert (= right2 o6))
(assert (< right2 8))
(assert (and (and (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 7)) (ite (and (<= 0 k1) (<= k1 (- right3 (* space3 2)))) (ite (= (mod2 (+ k1 1) (* 2 space3)) 0) (= (to_rep (select a3 k1)) (+ (to_rep (select a2 k1)) (to_rep (select a2 (- k1 space3))))) (ite (= (mod2 (+ k1 1) space3) 0) (= (to_rep (select a3 k1)) (to_rep (select a2 (+ k1 space3)))) (= (to_rep (select a3 k1)) (to_rep (select a2 k1))))) (= (to_rep (select a3 k1)) (to_rep (select a2 k1)))))) (= (mod2 (+ right3 1) (* space3 2)) 0)) (not (<= 8 right3))))
...
(assert (= (mod2 (+ k 1) space3) 0))
(assert (not (<= 0 (+ k space3))))
(check-sat)
(exit)
