...
(assert (= o101 (- target7 o100)))
(assert (and (= o102 o101) (in_range1 o101)))
(assert (= result16 (mk_int__ref target7)))
(assert (= target8 o102))
(assert (<= (- 99999999) target8))
(assert (and (= o103 (- target8 2000000000)) (in_range1 (- target8 2000000000))))
(assert (= result17 (mk_int__ref target8)))
(assert (= target9 o103))
(assert (not (<= (- 2099999999) target9)))
(check-sat)
(exit)
