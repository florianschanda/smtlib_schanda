...
(assert (and (= temp___2287 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___2287) (<= temp___2287 (to_rep1 n__last))))
(assert (= o81 temp___2287))
