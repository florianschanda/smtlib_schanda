...
(define-fun dynamic_invariant ((temp___expr_446 Int) (temp___is_init_443 Bool) (temp___skip_constant_444 Bool) (temp___do_toplevel_445 Bool)) Bool (=> (or (= temp___is_init_443 true) (<= 0 1)) (in_range temp___expr_446)))
...
(define-fun dynamic_invariant2 ((temp___expr_2612 Int) (temp___is_init_2609 Bool) (temp___skip_constant_2610 Bool) (temp___do_toplevel_2611 Bool)) Bool (=> (or (= temp___is_init_2609 true) (<= 0 8)) (in_range6 temp___expr_2612)))
...
(define-fun dynamic_invariant3 ((temp___expr_2698 Int) (temp___is_init_2695 Bool) (temp___skip_constant_2696 Bool) (temp___do_toplevel_2697 Bool)) Bool (=> (or (= temp___is_init_2695 true) (<= 0 2)) (in_range7 temp___expr_2698)))
(define-fun dynamic_invariant4 ((temp___expr_1105 Int) (temp___is_init_1102 Bool) (temp___skip_constant_1103 Bool) (temp___do_toplevel_1104 Bool)) Bool (=> (or (= temp___is_init_1102 true) (<= 0 17)) (in_range3 temp___expr_1105)))
(define-fun dynamic_invariant5 ((temp___expr_1084 Int) (temp___is_init_1081 Bool) (temp___skip_constant_1082 Bool) (temp___do_toplevel_1083 Bool)) Bool (=> (or (= temp___is_init_1081 true) (<= 1 17)) (in_range1 temp___expr_1084)))
(define-fun dynamic_invariant6 ((temp___expr_1209 Int) (temp___is_init_1206 Bool) (temp___skip_constant_1207 Bool) (temp___do_toplevel_1208 Bool)) Bool (=> (or (= temp___is_init_1206 true) (<= 0 2)) (in_range5 temp___expr_1209)))
(define-fun dynamic_invariant7 ((temp___expr_1090 Int) (temp___is_init_1087 Bool) (temp___skip_constant_1088 Bool) (temp___do_toplevel_1089 Bool)) Bool (=> (or (= temp___is_init_1087 true) (<= 0 17408)) (in_range2 temp___expr_1090)))
(define-fun dynamic_invariant8 ((temp___expr_1124 Int) (temp___is_init_1121 Bool) (temp___skip_constant_1122 Bool) (temp___do_toplevel_1123 Bool)) Bool (=> (or (= temp___is_init_1121 true) (<= 0 1024)) (in_range4 temp___expr_1124)))
(assert true)
...
(assert (=> (= result true) (and (= (valid_numberlogentries (to_rep logfilestate__split_fields7) (to_rep1 logfilestate__split_fields8) (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) true) (in_range auditalarm1))))
(assert (=> (= result true) (and (= (valid_numberlogentries (to_rep logfilestate__split_fields14) (to_rep1 logfilestate__split_fields15) (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20) true) (in_range auditalarm2))))
(assert (=> (= result true) (= result1 status)))
(assert (=> (= result true) (= status2 1)))
(assert (=> (not (= result true)) (and (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields21)) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields21)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields21) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields21)) true) (in_range auditalarm3))))
(assert (=> (not (= result true)) (and (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields22)) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields22)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields22) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields22)) true) (in_range auditalarm4))))
