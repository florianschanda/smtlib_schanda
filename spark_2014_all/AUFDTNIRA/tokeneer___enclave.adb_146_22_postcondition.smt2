...
(assert (forall ((x filestatust)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x fileentrycountt)) (! (in_range4 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun dynamic_invariant ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range5 temp___expr_548)))
...
(define-fun dynamic_invariant2 ((temp___expr_2867 Int) (temp___is_init_2863 Bool) (temp___skip_constant_2864 Bool) (temp___do_toplevel_2865 Bool) (temp___do_typ_inv_2866 Bool)) Bool (=> (or (= temp___is_init_2863 true) (<= 0 8)) (in_range6 temp___expr_2867)))
...
(define-fun dynamic_invariant3 ((temp___expr_2954 Int) (temp___is_init_2950 Bool) (temp___skip_constant_2951 Bool) (temp___do_toplevel_2952 Bool) (temp___do_typ_inv_2953 Bool)) Bool (=> (or (= temp___is_init_2950 true) (<= 0 2)) (in_range7 temp___expr_2954)))
(define-fun dynamic_invariant4 ((temp___expr_1276 Int) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (or (= temp___is_init_1272 true) (<= 0 17)) (in_range3 temp___expr_1276)))
(define-fun dynamic_invariant5 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 1 17)) (in_range1 temp___expr_1283)))
(define-fun dynamic_invariant6 ((temp___expr_1409 Int) (temp___is_init_1405 Bool) (temp___skip_constant_1406 Bool) (temp___do_toplevel_1407 Bool) (temp___do_typ_inv_1408 Bool)) Bool (=> (or (= temp___is_init_1405 true) (<= 0 2)) (in_range temp___expr_1409)))
(define-fun dynamic_invariant7 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17408)) (in_range2 temp___expr_1290)))
(define-fun dynamic_invariant8 ((temp___expr_1321 Int) (temp___is_init_1317 Bool) (temp___skip_constant_1318 Bool) (temp___do_toplevel_1319 Bool) (temp___do_typ_inv_1320 Bool)) Bool (=> (or (= temp___is_init_1317 true) (<= 0 1024)) (in_range4 temp___expr_1321)))
(assert true)
...
(assert (forall ((temp___1350 Int)) (=> (dynamic_invariant8 temp___1350 true true true true) (forall ((temp___1351 Int)) (= (select (temp_____aggregate_def_1348 temp___1350) temp___1351) rliteral2)))))
(assert (forall ((temp___1346 Int)) (=> (dynamic_invariant5 temp___1346 true true true true) (forall ((temp___1347 Int)) (= (select (temp_____aggregate_def_1344 temp___1346) temp___1347) rliteral)))))
...
(declare-const logfilesstatus2 map__ref)
...
(define-fun logfilestate__split_fields25 () us_split_fields2 (mk___split_fields1 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20))
...
(assert (=> (= result true) (and (= (valid_numberlogentries (to_rep1 logfilestate__split_fields7) (to_rep2 logfilestate__split_fields8) (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) true) (in_range5 auditalarm1))))
(assert (=> (= result true) (and (= (valid_numberlogentries (to_rep1 logfilestate__split_fields14) (to_rep2 logfilestate__split_fields15) (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20) true) (in_range5 auditalarm2))))
(assert (=> (= result true) (= result1 status)))
(assert (=> (= result true) (= status2 1)))
(assert (=> (not (= result true)) (and (= (valid_numberlogentries (to_rep1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields21)) (to_rep2 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields21)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields21) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields21)) true) (in_range5 auditalarm3))))
(assert (=> (not (= result true)) (and (= (valid_numberlogentries (to_rep1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields22)) (to_rep2 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields22)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields22) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields22)) true) (in_range5 auditalarm4))))
...
(assert (=> (not (= result true)) (= logfilestate__split_fields25 logfilestate__split_fields22)))
...
(assert (= logfilestate__split_fields23 (mk___split_fields__ref1 logfilestate__split_fields25)))
(assert (= logfilesstatus2 (mk_map__ref logfilesstatus)))
...
(assert (= logfilestate__split_fields24 logfilestate__split_fields25))
