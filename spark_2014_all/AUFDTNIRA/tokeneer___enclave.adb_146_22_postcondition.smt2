...
(define-fun dynamic_invariant ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range temp___expr_548)))
...
(define-fun dynamic_invariant2 ((temp___expr_2874 Int) (temp___is_init_2870 Bool) (temp___skip_constant_2871 Bool) (temp___do_toplevel_2872 Bool) (temp___do_typ_inv_2873 Bool)) Bool (=> (or (= temp___is_init_2870 true) (<= 0 8)) (in_range6 temp___expr_2874)))
...
(define-fun dynamic_invariant3 ((temp___expr_2961 Int) (temp___is_init_2957 Bool) (temp___skip_constant_2958 Bool) (temp___do_toplevel_2959 Bool) (temp___do_typ_inv_2960 Bool)) Bool (=> (or (= temp___is_init_2957 true) (<= 0 2)) (in_range7 temp___expr_2961)))
(define-fun dynamic_invariant4 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 0 17)) (in_range3 temp___expr_1283)))
(define-fun dynamic_invariant5 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 1 17)) (in_range1 temp___expr_1290)))
(define-fun dynamic_invariant6 ((temp___expr_1416 Int) (temp___is_init_1412 Bool) (temp___skip_constant_1413 Bool) (temp___do_toplevel_1414 Bool) (temp___do_typ_inv_1415 Bool)) Bool (=> (or (= temp___is_init_1412 true) (<= 0 2)) (in_range5 temp___expr_1416)))
(define-fun dynamic_invariant7 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 17408)) (in_range2 temp___expr_1297)))
(define-fun dynamic_invariant8 ((temp___expr_1328 Int) (temp___is_init_1324 Bool) (temp___skip_constant_1325 Bool) (temp___do_toplevel_1326 Bool) (temp___do_typ_inv_1327 Bool)) Bool (=> (or (= temp___is_init_1324 true) (<= 0 1024)) (in_range4 temp___expr_1328)))
(assert true)
...
(assert (forall ((temp___1357 Int)) (=> (dynamic_invariant8 temp___1357 true true true true) (forall ((temp___1358 Int)) (= (to_rep3 (select (temp___1355 temp___1357) temp___1358)) temp___1357)))))
(assert (forall ((temp___1353 Int)) (=> (dynamic_invariant5 temp___1353 true true true true) (forall ((temp___1354 Int)) (= (to_rep (select (temp___1351 temp___1353) temp___1354)) temp___1353)))))
