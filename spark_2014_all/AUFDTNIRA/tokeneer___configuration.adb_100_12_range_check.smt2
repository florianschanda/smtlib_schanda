...
(assert (not (= (length (mk___t temp___1836 temp___18361)) 0)))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thelatchunlockduration 10)))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thelatchunlockduration 10))))))) (= o6 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thelatchunlockduration 10)))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thelatchunlockduration 10))))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thelatchunlockduration 10)))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thelatchunlockduration 10)))))))) (= o6 0)))
(assert (=> (<= (to_rep1 (first temp___18361)) (to_rep1 (last temp___18361))) (= o7 (+ (- (to_rep1 (last temp___18361)) (to_rep1 (first temp___18361))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___18361)) (to_rep1 (last temp___18361)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___18361)) o8)))
(assert (= o10 (- o9 1)))
