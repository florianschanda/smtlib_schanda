...
(assert (not (= (length temp___1892) 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 temp___1893))) (to_rep1 (last4 (rt2 temp___1893)))) (= o6 (+ (- (to_rep1 (last4 (rt2 temp___1893))) (to_rep1 (first4 (rt2 temp___1893)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 temp___1893))) (to_rep1 (last4 (rt2 temp___1893))))) (= o6 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1892))) (to_rep1 (last (rt temp___1892)))) (= o7 (+ (- (to_rep1 (last (rt temp___1892))) (to_rep1 (first (rt temp___1892)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1892))) (to_rep1 (last (rt temp___1892))))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first (rt temp___1892))) o8)))
(assert (= o10 (- o9 1)))
