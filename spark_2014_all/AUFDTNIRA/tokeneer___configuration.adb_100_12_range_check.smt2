...
(assert (not (= (length (mk___t temp___931 temp___9311)) 0)))
...
(assert (=> (<= (to_rep1 (first temp___9311)) (to_rep1 (last temp___9311))) (= o7 (+ (- (to_rep1 (last temp___9311)) (to_rep1 (first temp___9311))) 1))))
(assert (=> (not (<= (to_rep1 (first temp___9311)) (to_rep1 (last temp___9311)))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first temp___9311)) o8)))
(assert (= o10 (- o9 1)))
