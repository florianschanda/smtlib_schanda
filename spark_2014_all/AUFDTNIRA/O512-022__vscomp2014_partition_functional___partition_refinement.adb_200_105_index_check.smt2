...
(assert (and (= o163 j6) (in_range8 j6)))
(assert (and (= o164 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o163)) (= (bool_eq o164 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o163)) true)))
(assert (= o165 (us_split_fields1 o164)))
(assert (= o166 (rec__partition_refinement__interval__last o165)))
(assert (= o167 (to_rep1 o166)))
(assert (= o168 (ite (<= l1 o167) true false)))
(assert (and (= o158 j6) (in_range8 j6)))
(assert (and (= o159 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o158)) (= (bool_eq o159 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o158)) true)))
(assert (= o160 (us_split_fields1 o159)))
(assert (= o161 (rec__partition_refinement__interval__first o160)))
(assert (= o162 (to_rep1 o161)))
(assert (= o169 (ite (<= o162 l1) true false)))
(assert (= result20 (ite (= o169 true) o168 false)))
