...
(assert (forall ((k Int)) (=> (and (<= 0 k) (<= k (- j2 1))) (forall ((l1 Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) k)))) l1) (<= l1 (to_rep1 (rec__partition_refinement__interval__last (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) k)))))) (= (to_rep2 (select (map__content f6) l1)) k))))))
...
(assert (and (= o15 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o14)) (= (bool_eq o15 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o14)) true)))
