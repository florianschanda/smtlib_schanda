...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def 0 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 2) (+ (+ (to_rep1 (first (rt source))) 2) 8))))) (+ (to_rep1 (first (rt source))) 2)) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def 0 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 2) (+ (+ (to_rep1 (first (rt source))) 2) 8))))) (+ (+ (to_rep1 (first (rt source))) 2) 8)) (= (mk___t2 temp___2106 temp___21061) (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def 0 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 2) (+ (+ (to_rep1 (first (rt source))) 2) 8))))) (and (= (ite (<= (to_rep1 (first4 temp___21061)) (to_rep1 (last4 temp___21061))) (+ (- (to_rep1 (last4 temp___21061)) (to_rep1 (first4 temp___21061))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 2)) 1) 0)) (and (= (slide1 temp___2106 (to_rep1 (first4 temp___21061)) (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume) (= (mk1 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume1)))))) (and (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 2)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 2)) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)) (= (mk___t4 temp___2114 temp___21141) (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10))))) (and (= (ite (<= (to_rep1 (first8 temp___21141)) (to_rep1 (last8 temp___21141))) (+ (- (to_rep1 (last8 temp___21141)) (to_rep1 (first8 temp___21141))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 2)) 1) 0)) (and (= (slide1 temp___2114 (to_rep1 (first8 temp___21141)) (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume) (= (mk3 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume1)))) (and (and (= (mk_map__ref1 result2) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume1)))))) (and (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 2)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))) (and (and (and (= temp___2120 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (= temp___2121 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))) (and (and (= (mk_int__ref result3) (mk_int__ref index)) (= index2 temp___2120)) (ite (and (<= temp___2120 index2) (<= index2 temp___2121)) (and (and (and (= temp___2118 n1) (and (= temp___2116 index2) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o13 index2)) (= o14 (select n1 o13))) (= o15 (to_rep1 o14))) (= o15 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o16 index2)) (= o17 (select (elts source) o16))) (= o18 (to_rep o17))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o18))) (ite (= (= o18 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o18 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o18 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o18 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o18 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o18 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o18 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o18 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o18 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o18 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o19) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o20 index2)) (= o21 (store n1 o20 o19)))) (and (= n1 result4) (= n2 o21))))) (and (and (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (=> (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10) index3)) (forall ((temp___2119 Int)) (=> (and (<= (to_rep1 n__first) temp___2119) (<= temp___2119 (to_rep1 n__last))) (=> (< index3 temp___2119) (= (select n3 temp___2119) (select temp___2118 temp___2119)))))) (and (<= (+ (to_rep1 (first (rt source))) 2) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10)))) (= index3 temp___2121)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1))))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (and (and (= temp___2122 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))) (and (and (<= (to_rep1 n__first) temp___2122) (<= temp___2122 (to_rep1 n__last))) (= o49 temp___2122))) (= o50 (select (map__content1 n7) o49))) (= o51 (to_rep1 o50))) (= o52 (- o51))) (and (= o53 o52) (in_range1 o52))) (and (= result9 (mk_int__ref target)) (= target1 o53))) (and (<= (- 9) target1) (and (and (and (and (and (and (and (and (and (and (= temp___2123 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (<= (to_rep1 n__first) temp___2123) (<= temp___2123 (to_rep1 n__last))) (= o54 temp___2123))) (= o55 (select (map__content1 n7) o54))) (= o56 (to_rep1 o55))) (= o57 (* o56 10))) (and (= o58 o57) (in_range1 o57))) (= o59 (- target1 o58))) (and (= o60 o59) (in_range1 o59))) (and (= result10 (mk_int__ref target1)) (= target2 o60))) (and (<= (- 99) target2) (and (and (and (and (and (and (and (and (and (and (= temp___2124 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (<= (to_rep1 n__first) temp___2124) (<= temp___2124 (to_rep1 n__last))) (= o61 temp___2124))) (= o62 (select (map__content1 n7) o61))) (= o63 (to_rep1 o62))) (= o64 (* o63 100))) (and (= o65 o64) (in_range1 o64))) (= o66 (- target2 o65))) (and (= o67 o66) (in_range1 o66))) (and (= result11 (mk_int__ref target2)) (= target3 o67))) (and (<= (- 999) target3) (and (and (and (and (and (and (and (and (and (and (= temp___2125 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))) (and (and (<= (to_rep1 n__first) temp___2125) (<= temp___2125 (to_rep1 n__last))) (= o68 temp___2125))) (= o69 (select (map__content1 n7) o68))) (= o70 (to_rep1 o69))) (= o71 (* o70 1000))) (and (= o72 o71) (in_range1 o71))) (= o73 (- target3 o72))) (and (= o74 o73) (in_range1 o73))) (and (= result12 (mk_int__ref target3)) (= target4 o74))) (and (<= (- 9999) target4) (and (and (and (and (and (and (and (and (and (and (= temp___2126 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))) (and (and (<= (to_rep1 n__first) temp___2126) (<= temp___2126 (to_rep1 n__last))) (= o75 temp___2126))) (= o76 (select (map__content1 n7) o75))) (= o77 (to_rep1 o76))) (= o78 (* o77 10000))) (and (= o79 o78) (in_range1 o78))) (= o80 (- target4 o79))) (and (= o81 o80) (in_range1 o80))) (and (= result13 (mk_int__ref target4)) (= target5 o81))) (and (<= (- 99999) target5) (and (and (and (and (and (and (and (and (and (and (= temp___2127 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (<= (to_rep1 n__first) temp___2127) (<= temp___2127 (to_rep1 n__last))) (= o82 temp___2127))) (= o83 (select (map__content1 n7) o82))) (= o84 (to_rep1 o83))) (= o85 (* o84 100000))) (and (= o86 o85) (in_range1 o85))) (= o87 (- target5 o86))) (and (= o88 o87) (in_range1 o87))) (and (= result14 (mk_int__ref target5)) (= target6 o88))) (and (<= (- 999999) target6) (and (and (and (and (and (and (and (and (and (and (= temp___2128 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (<= (to_rep1 n__first) temp___2128) (<= temp___2128 (to_rep1 n__last))) (= o89 temp___2128))) (= o90 (select (map__content1 n7) o89))) (= o91 (to_rep1 o90))) (= o92 (* o91 1000000))) (and (= o93 o92) (in_range1 o92))) (= o94 (- target6 o93))) (and (= o95 o94) (in_range1 o94))) (and (= result15 (mk_int__ref target6)) (= target7 o95))) (and (<= (- 9999999) target7) (and (and (and (and (and (and (and (and (and (and (= temp___2129 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))) (and (and (<= (to_rep1 n__first) temp___2129) (<= temp___2129 (to_rep1 n__last))) (= o96 temp___2129))) (= o97 (select (map__content1 n7) o96))) (= o98 (to_rep1 o97))) (= o99 (* o98 10000000))) (and (= o100 o99) (in_range1 o99))) (= o101 (- target7 o100))) (and (= o102 o101) (in_range1 o101))) (and (= result16 (mk_int__ref target7)) (= target8 o102))) (and (<= (- 99999999) target8) (and (and (and (= o103 (- target8 2000000000)) (in_range1 (- target8 2000000000))) (and (= result17 (mk_int__ref target8)) (= target9 o103))) (and (<= (- 2099999999) target9) (and (= result18 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))))))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target10 (mk_int__ref target9)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target11 target9))))))))
