...
(define-fun dynamic_invariant ((temp___expr_243 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 0 1)) (in_range3 temp___expr_243)))
...
(define-fun dynamic_invariant1 ((temp___expr_446 Int) (temp___is_init_443 Bool) (temp___skip_constant_444 Bool) (temp___do_toplevel_445 Bool)) Bool (=> (or (= temp___is_init_443 true) (<= 0 1)) (in_range4 temp___expr_446)))
...
(define-fun dynamic_invariant3 ((temp___expr_1305 Int) (temp___is_init_1302 Bool) (temp___skip_constant_1303 Bool) (temp___do_toplevel_1304 Bool)) Bool (=> (or (= temp___is_init_1302 true) (<= 0 4294967295)) (in_range11 temp___expr_1305)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant4 ((temp___expr_1311 Int) (temp___is_init_1308 Bool) (temp___skip_constant_1309 Bool) (temp___do_toplevel_1310 Bool)) Bool (=> (or (= temp___is_init_1308 true) (<= 0 2)) (in_range12 temp___expr_1311)))
...
(define-fun dynamic_invariant5 ((temp___expr_2612 Int) (temp___is_init_2609 Bool) (temp___skip_constant_2610 Bool) (temp___do_toplevel_2611 Bool)) Bool (=> (or (= temp___is_init_2609 true) (<= 0 8)) (in_range25 temp___expr_2612)))
...
(define-fun dynamic_invariant10 ((temp___expr_194 Int) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool)) Bool (=> (or (= temp___is_init_191 true) (<= 0 3)) (in_range13 temp___expr_194)))
...
(define-fun dynamic_invariant13 ((temp___expr_945 Int) (temp___is_init_942 Bool) (temp___skip_constant_943 Bool) (temp___do_toplevel_944 Bool)) Bool (=> (or (= temp___is_init_942 true) (<= 0 4294967295)) (in_range21 temp___expr_945)))
...
(define-fun dynamic_invariant15 ((temp___expr_979 Int) (temp___is_init_976 Bool) (temp___skip_constant_977 Bool) (temp___do_toplevel_978 Bool)) Bool (=> (or (= temp___is_init_976 true) (<= 0 4294967295)) (in_range23 temp___expr_979)))
(define-fun dynamic_invariant16 ((temp___expr_985 Int) (temp___is_init_982 Bool) (temp___skip_constant_983 Bool) (temp___do_toplevel_984 Bool)) Bool (=> (or (= temp___is_init_982 true) (<= 0 128)) (in_range24 temp___expr_985)))
(define-fun dynamic_invariant17 ((temp___expr_1105 Int) (temp___is_init_1102 Bool) (temp___skip_constant_1103 Bool) (temp___do_toplevel_1104 Bool)) Bool (=> (or (= temp___is_init_1102 true) (<= 0 17)) (in_range8 temp___expr_1105)))
(define-fun dynamic_invariant18 ((temp___expr_1084 Int) (temp___is_init_1081 Bool) (temp___skip_constant_1082 Bool) (temp___do_toplevel_1083 Bool)) Bool (=> (or (= temp___is_init_1081 true) (<= 1 17)) (in_range6 temp___expr_1084)))
(define-fun dynamic_invariant19 ((temp___expr_1209 Int) (temp___is_init_1206 Bool) (temp___skip_constant_1207 Bool) (temp___do_toplevel_1208 Bool)) Bool (=> (or (= temp___is_init_1206 true) (<= 0 2)) (in_range10 temp___expr_1209)))
(define-fun dynamic_invariant20 ((temp___expr_1090 Int) (temp___is_init_1087 Bool) (temp___skip_constant_1088 Bool) (temp___do_toplevel_1089 Bool)) Bool (=> (or (= temp___is_init_1087 true) (<= 0 17408)) (in_range7 temp___expr_1090)))
(define-fun dynamic_invariant21 ((temp___expr_1124 Int) (temp___is_init_1121 Bool) (temp___skip_constant_1122 Bool) (temp___do_toplevel_1123 Bool)) Bool (=> (or (= temp___is_init_1121 true) (<= 0 1024)) (in_range9 temp___expr_1124)))
(assert true)
...
(define-fun dynamic_invariant22 ((temp___expr_468 Int) (temp___is_init_465 Bool) (temp___skip_constant_466 Bool) (temp___do_toplevel_467 Bool)) Bool (=> (or (= temp___is_init_465 true) (<= 1 150)) (in_range5 temp___expr_468)))
...
(define-fun dynamic_invariant27 ((temp___expr_1375 Int) (temp___is_init_1372 Bool) (temp___skip_constant_1373 Bool) (temp___do_toplevel_1374 Bool)) Bool (=> (or (= temp___is_init_1372 true) (<= 0 4294967295)) (in_range22 temp___expr_1375)))
