...
(define-fun dynamic_invariant ((temp___expr_245 Int) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool) (temp___do_typ_inv_244 Bool)) Bool (=> (or (= temp___is_init_241 true) (<= 0 1)) (in_range3 temp___expr_245)))
...
(define-fun dynamic_invariant1 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range4 temp___expr_548)))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep5 (select a temp___idx_196)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
...
(define-fun bool_eq7 ((a (Array Int us_rep2)) (a__first Int) (a__last Int) (b (Array Int us_rep2)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq6 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true)))) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_1524 Int) (temp___is_init_1520 Bool) (temp___skip_constant_1521 Bool) (temp___do_toplevel_1522 Bool) (temp___do_typ_inv_1523 Bool)) Bool (=> (or (= temp___is_init_1520 true) (<= 0 4294967295)) (in_range11 temp___expr_1524)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant4 ((temp___expr_1531 Int) (temp___is_init_1527 Bool) (temp___skip_constant_1528 Bool) (temp___do_toplevel_1529 Bool) (temp___do_typ_inv_1530 Bool)) Bool (=> (or (= temp___is_init_1527 true) (<= 0 2)) (in_range12 temp___expr_1531)))
...
(declare-fun to_rep7 (privileget) Int)
(declare-fun of_rep7 (Int) privileget)
(assert (forall ((x privileget)) (! (= (of_rep7 (to_rep7 x)) x) :pattern ((to_rep7 x)))))
(assert (forall ((x privileget)) (! (in_range13 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x classt)) (! (in_range14 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(define-fun bool_eq9 ((a us_rep3) (b us_rep3)) Bool (ite (= (to_rep8 (rec__privtypes__clearancet__class (us_split_fields5 a))) (to_rep8 (rec__privtypes__clearancet__class (us_split_fields5 b)))) true false))
...
(declare-fun user_eq22 (yearst yearst) Bool)
(declare-const dummy22 yearst)
...
(declare-fun to_rep9 (yearst) Int)
(declare-fun of_rep9 (Int) yearst)
(assert (forall ((x yearst)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)))))
(assert (forall ((x yearst)) (! (in_range15 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(declare-fun user_eq23 (monthst monthst) Bool)
(declare-const dummy23 monthst)
...
(declare-fun to_rep10 (monthst) Int)
(declare-fun of_rep10 (Int) monthst)
(assert (forall ((x monthst)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x monthst)) (! (in_range16 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(declare-fun user_eq24 (dayst dayst) Bool)
(declare-const dummy24 dayst)
...
(declare-fun to_rep11 (dayst) Int)
(declare-fun of_rep11 (Int) dayst)
(assert (forall ((x dayst)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x dayst)) (! (in_range17 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(declare-fun user_eq25 (millisecst millisecst) Bool)
(declare-const dummy25 millisecst)
...
(declare-fun to_rep12 (millisecst) Int)
(declare-fun of_rep12 (Int) millisecst)
(assert (forall ((x millisecst)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x millisecst)) (! (in_range18 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(declare-fun user_eq27 (algorithmt algorithmt) Bool)
(declare-const dummy27 algorithmt)
...
(assert (forall ((x algorithmt)) (! (in_range19 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__attr__auth__contentst__id us_rep6) (rec__cert__attr__auth__contentst__notbefore us_rep4) (rec__cert__attr__auth__contentst__notafter us_rep4) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep6) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep3)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields12)) us_rep6 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields12)) us_rep4 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields12)) us_rep4 (rec__cert__attr__auth__contentst__notafter a))
...
(define-fun us_split_fields_Clearance__projection ((a us_split_fields12)) us_rep3 (rec__cert__attr__auth__contentst__clearance a))
...
(define-fun us_rep___18__projection ((a us_rep7)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq13 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (and (and (= (bool_eq12 (rec__cert__attr__auth__contentst__id (us_split_fields13 a)) (rec__cert__attr__auth__contentst__id (us_split_fields13 b))) true) (= (bool_eq10 (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq10 (rec__cert__attr__auth__contentst__notafter (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep13 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 a))) (to_rep13 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq12 (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 b))) true)) (= (to_rep7 (rec__cert__attr__auth__contentst__role (us_split_fields13 a))) (to_rep7 (rec__cert__attr__auth__contentst__role (us_split_fields13 b))))) (= (bool_eq9 (rec__cert__attr__auth__contentst__clearance (us_split_fields13 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields13 b))) true)) true false))
...
(define-fun us_rep___20__projection ((a us_rep8)) us_split_fields14 (us_split_fields15 a))
...
(assert (forall ((x keyidt)) (! (in_range23 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(assert (forall ((x keylengtht)) (! (in_range24 (to_rep18 x)) :pattern ((to_rep18 x)))))
...
(define-fun us_split_fields__ref___7__projection ((a us_split_fields__ref8)) us_split_fields16 (us_split_fields__content8 a))
(declare-datatypes () ((us_rep9 (mk___rep8 (us_split_fields17 us_split_fields16)))))
(define-fun us_rep___8__projection ((a us_rep9)) us_split_fields16 (us_split_fields17 a))
(define-fun bool_eq15 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (= (to_rep13 (rec__cryptotypes__keypartt__algorithmid (us_split_fields17 a))) (to_rep13 (rec__cryptotypes__keypartt__algorithmid (us_split_fields17 b)))) (= (to_rep17 (rec__cryptotypes__keypartt__keyid (us_split_fields17 a))) (to_rep17 (rec__cryptotypes__keypartt__keyid (us_split_fields17 b))))) (= (to_rep18 (rec__cryptotypes__keypartt__keylength (us_split_fields17 a))) (to_rep18 (rec__cryptotypes__keypartt__keylength (us_split_fields17 b))))) true false))
...
(declare-datatypes () ((us_split_fields18 (mk___split_fields9 (rec__cert__id__contentst__id us_rep6) (rec__cert__id__contentst__notbefore us_rep4) (rec__cert__id__contentst__notafter us_rep4) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep5) (rec__cert__id__contentst__subjectpublickey us_rep9)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields18)) us_rep6 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields18)) us_rep4 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields18)) us_rep4 (rec__cert__id__contentst__notafter a))
...
(define-fun us_rep___19__projection ((a us_rep10)) us_split_fields18 (us_split_fields19 a))
(define-fun bool_eq16 ((a us_rep10) (b us_rep10)) Bool (ite (and (and (and (and (and (= (bool_eq12 (rec__cert__id__contentst__id (us_split_fields19 a)) (rec__cert__id__contentst__id (us_split_fields19 b))) true) (= (bool_eq10 (rec__cert__id__contentst__notbefore (us_split_fields19 a)) (rec__cert__id__contentst__notbefore (us_split_fields19 b))) true)) (= (bool_eq10 (rec__cert__id__contentst__notafter (us_split_fields19 a)) (rec__cert__id__contentst__notafter (us_split_fields19 b))) true)) (= (to_rep13 (rec__cert__id__contentst__mechanism (us_split_fields19 a))) (to_rep13 (rec__cert__id__contentst__mechanism (us_split_fields19 b))))) (= (bool_eq11 (rec__cert__id__contentst__subject (us_split_fields19 a)) (rec__cert__id__contentst__subject (us_split_fields19 b))) true)) (= (bool_eq15 (rec__cert__id__contentst__subjectpublickey (us_split_fields19 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields19 b))) true)) true false))
...
(declare-fun user_eq39 (us_rep10 us_rep10) Bool)
(declare-const dummy39 us_rep10)
...
(define-fun us_rep___21__projection ((a us_rep11)) us_split_fields20 (us_split_fields21 a))
...
(define-fun dynamic_invariant5 ((temp___expr_2874 Int) (temp___is_init_2870 Bool) (temp___skip_constant_2871 Bool) (temp___do_toplevel_2872 Bool) (temp___do_typ_inv_2873 Bool)) Bool (=> (or (= temp___is_init_2870 true) (<= 0 8)) (in_range25 temp___expr_2874)))
...
(define-fun dynamic_invariant10 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 3)) (in_range13 temp___expr_426)))
...
(define-fun dynamic_invariant13 ((temp___expr_1123 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool) (temp___do_typ_inv_1122 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 4294967295)) (in_range21 temp___expr_1123)))
...
(define-fun dynamic_invariant15 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 4294967295)) (in_range23 temp___expr_1161)))
(define-fun dynamic_invariant16 ((temp___expr_1168 Int) (temp___is_init_1164 Bool) (temp___skip_constant_1165 Bool) (temp___do_toplevel_1166 Bool) (temp___do_typ_inv_1167 Bool)) Bool (=> (or (= temp___is_init_1164 true) (<= 0 128)) (in_range24 temp___expr_1168)))
(define-fun dynamic_invariant17 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 0 17)) (in_range8 temp___expr_1283)))
(define-fun dynamic_invariant18 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 1 17)) (in_range6 temp___expr_1290)))
(define-fun dynamic_invariant19 ((temp___expr_1416 Int) (temp___is_init_1412 Bool) (temp___skip_constant_1413 Bool) (temp___do_toplevel_1414 Bool) (temp___do_typ_inv_1415 Bool)) Bool (=> (or (= temp___is_init_1412 true) (<= 0 2)) (in_range10 temp___expr_1416)))
(define-fun dynamic_invariant20 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 17408)) (in_range7 temp___expr_1297)))
(define-fun dynamic_invariant21 ((temp___expr_1328 Int) (temp___is_init_1324 Bool) (temp___skip_constant_1325 Bool) (temp___do_toplevel_1326 Bool) (temp___do_typ_inv_1327 Bool)) Bool (=> (or (= temp___is_init_1324 true) (<= 0 1024)) (in_range9 temp___expr_1328)))
(assert true)
...
(define-fun dynamic_invariant22 ((temp___expr_573 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool) (temp___do_typ_inv_572 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 150)) (in_range5 temp___expr_573)))
...
(define-fun dynamic_invariant27 ((temp___expr_1603 Int) (temp___is_init_1599 Bool) (temp___skip_constant_1600 Bool) (temp___do_toplevel_1601 Bool) (temp___do_typ_inv_1602 Bool)) Bool (=> (or (= temp___is_init_1599 true) (<= 0 4294967295)) (in_range22 temp___expr_1603)))
...
(assert (in_range12 tokentry))
(assert (in_range11 tokenid))
...
(assert (= o (extractuser tokenpresence state tokentry tokenid (us_split_fields__content7 authcert__split_fields) (us_split_fields__content10 idcert__split_fields))))
