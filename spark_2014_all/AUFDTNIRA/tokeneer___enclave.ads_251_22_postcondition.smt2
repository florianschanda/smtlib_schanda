...
(assert (and (and (and (and (not (= (enrolmentisinprogress (int__content status4)) true)) (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields3))) 0)) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3))) true))) (or (or (= (int__content status4) 3) (= (int__content status4) 4)) (= (int__content status4) status))) (not (or (= (int__content status4) 6) (= (int__content status4) 7)))))
(assert (and (and (and (and (and (in_range9 (int__content auditalarm5)) (in_range17 (int__content tokentry4))) (in_range16 (int__content tokenid4))) (in_range29 (int__content status4))) (in_range4 (int__content tokenpresence4))) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content2 logfilestate__split_fields23))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content2 logfilestate__split_fields23))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content2 logfilestate__split_fields23)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content2 logfilestate__split_fields23))) true)))
