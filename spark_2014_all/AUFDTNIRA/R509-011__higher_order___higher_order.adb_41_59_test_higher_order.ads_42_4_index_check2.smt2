...
(assert (<= k i2))
(assert (and (= o6 (- k (to_rep (first4 (rt2 a))))) (in_range1 (- k (to_rep (first4 (rt2 a)))))))
(assert (and (= o7 o6) (in_range2 o6)))
(assert (= o8 (+ o7 1)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (and (<= (to_rep r__first) k) (<= k (to_rep r__last))))
(assert (= o3 k))
(assert (= o4 (select r2 o3)))
(assert (= o5 (to_rep2 o4)))
(assert (and (= result3 (in_range5 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) o5 o9)) (= (= result3 true) (and (<= (+ (- 2147483648) (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o9))) o5) (<= o5 (- 2147483647 (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o9))))))))
(assert (= result3 true))
(assert (not (= k (to_rep (first4 (rt2 a))))))
(assert (and (= temp___397 (- k 1)) (in_range1 (- k 1))))
(assert (not (<= (to_rep r__first) temp___397)))
(check-sat)
(exit)
