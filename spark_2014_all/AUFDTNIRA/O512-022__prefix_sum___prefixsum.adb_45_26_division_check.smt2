...
(assert (=> (= result6 true) (and (= o8 (* space2 1000000)) (in_range3 (* space2 1000000)))))
(assert (=> (= result6 true) (and (= result5 (all_right_elements_in a3 (- left4 1) o8)) (= (= result5 true) (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 7)) (=> (< (- left4 1) k2) (and (<= (- o8) (to_rep (select a3 k2))) (<= (to_rep (select a3 k2)) o8)))))))))
