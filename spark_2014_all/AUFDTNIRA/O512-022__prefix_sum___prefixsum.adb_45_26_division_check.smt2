...
(assert (=> (= (mod2 (+ left3 1) space2) 0) (and (= o1 (* (* space2 2) 1000000)) (in_range3 (* (* space2 2) 1000000)))))
(assert (=> (= (mod2 (+ left3 1) space2) 0) (and (= result4 (all_left_elements_in a2 left3 o1)) (= (= result4 true) (forall ((k Int)) (=> (and (<= 0 k) (<= k 7)) (=> (< k left3) (and (<= (- o1) (to_rep (select a2 k))) (<= (to_rep (select a2 k)) o1)))))))))
(assert (=> (not (= (mod2 (+ left3 1) space2) 0)) (= result4 false)))
(assert (=> (= result4 true) (and (= o (* space2 1000000)) (in_range3 (* space2 1000000)))))
(assert (=> (= result4 true) (and (= result3 (all_right_elements_in a2 (- left3 1) o)) (= (= result3 true) (forall ((k Int)) (=> (and (<= 0 k) (<= k 7)) (=> (< (- left3 1) k) (and (<= (- o) (to_rep (select a2 k))) (<= (to_rep (select a2 k)) o)))))))))
(assert (=> (not (= result4 true)) (= result3 false)))
(assert (= result3 true))
(assert (not (not (= (* space2 2) 0))))
(check-sat)
(exit)
