...
(assert (= o8 (mk___split_fields o7 (rec__sums__slice_bounds__hi result____split_fields3))))
(assert (= temp___202 (mk_slice_bounds o8)))
(assert (= result7 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___202)))
(assert (not (in_range5 current_hi2)))
(check-sat)
(exit)
