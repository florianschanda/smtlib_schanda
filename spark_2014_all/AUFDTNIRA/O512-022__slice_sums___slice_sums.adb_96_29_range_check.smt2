...
(assert (and (= o44 current_sum3) (in_range2 current_sum3)))
(assert (= result11 (mk_int__ref max_sum2)))
(assert (= max_sum3 o44))
(assert (= (to_rep1 o45) current_lo3))
(assert (= o46 (mk___split_fields o45 (rec__sums__slice_bounds__hi result____split_fields4))))
(assert (= temp___178 (mk_slice_bounds o46)))
(assert (= result12 (mk___split_fields__ref result____split_fields4)))
(assert (= result____split_fields5 (us_split_fields1 temp___178)))
(assert (not (in_range5 current_hi3)))
(check-sat)
(exit)
