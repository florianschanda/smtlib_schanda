...
(assert (and (= o4 (+ current_sum2 (vector_elementqtint (select (elts x) current_hi2)))) (in_range1 (+ current_sum2 (vector_elementqtint (select (elts x) current_hi2))))))
(assert (= result5 (mk_int__ref current_sum2)))
(assert (= current_sum3 o4))
(assert (< max_sum2 current_sum3))
(assert (and (= o5 current_sum3) (in_range2 current_sum3)))
(assert (= result6 (mk_int__ref max_sum2)))
(assert (= max_sum3 o5))
(assert (= (indexqtint o6) current_lo2))
(assert (= o7 (mk___split_fields o6 (rec__sums__slice_bounds__hi result____split_fields3))))
(assert (= temp___204 (mk_slice_bounds o7)))
(assert (= result7 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___204)))
(assert (not (in_range4 current_hi2)))
(check-sat)
(exit)
