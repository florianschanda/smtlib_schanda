...
(assert (and (= o1 (* 2 l2)) (in_range1 (* 2 l2))))
(assert (and (= o2 o1) (in_range2 o1)))
(assert (= result2 (mk_int__ref l2)))
(assert (= l3 o2))
(assert (= k4 k2))
(assert (= l4 (mk_int__ref l3)))
(assert (= i4 i2))
(assert (= b2 b))
(assert (= a4 a2))
(assert (= k5 k3))
...
(assert (not (= (sorted (mk___t (map__content a4) (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* j (int__content l4))) (ite (< (int__content l4) (- length1 (* j (int__content l4)))) (int__content l4) (- length1 (* j (int__content l4))))) true)))
(check-sat)
(exit)
