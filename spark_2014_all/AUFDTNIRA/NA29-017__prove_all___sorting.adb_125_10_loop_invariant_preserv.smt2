...
(assert (and (and (forall ((j4 Int)) (=> (and (<= 0 j4) (<= j4 2147483647)) (=> (< (* (* j4 l2) 2) length1) (= (sorted (mk___t (map__content a10) (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* (* j4 l2) 2)) (ite (< (* l2 2) (- length1 (* (* j4 l2) 2))) (* l2 2) (- length1 (* (* j4 l2) 2)))) true)))) (= (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t (map__content a10) (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)) (<= 1 l2)))
(assert (=> (<= 0 2147483647) (in_range2 l2)))
(assert (and (= o80 (- length1 l2)) (in_range1 (- length1 l2))))
(assert (= result9 (ite (<= o80 l2) true false)))
(assert (not (= result9 true)))
(assert (and (= o81 (* 2 l2)) (in_range1 (* 2 l2))))
(assert (and (= o82 o81) (in_range2 o81)))
(assert (= result10 (mk_int__ref l2)))
(assert (= l3 o82))
(assert (= k12 k10))
(assert (= l6 (mk_int__ref l3)))
(assert (= i13 i11))
(assert (= b12 b10))
(assert (= a12 a10))
(assert (= k13 k11))
...
(assert (<= 0 j4))
(assert (<= j4 2147483647))
(assert (< (* j4 (int__content l6)) length1))
(assert (not (= (sorted (mk___t (map__content a12) (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* j4 (int__content l6))) (ite (< (int__content l6) (- length1 (* j4 (int__content l6)))) (int__content l6) (- length1 (* j4 (int__content l6))))) true)))
(check-sat)
(exit)
