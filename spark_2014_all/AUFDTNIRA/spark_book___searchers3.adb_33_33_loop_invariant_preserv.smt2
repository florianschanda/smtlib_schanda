...
(assert (and (and (and (=> (<= 1 100) (in_range2 low_index2)) (=> (<= 1 100) (in_range2 mid_index3))) (=> (<= 1 100) (in_range2 high_index2))) (=> (<= 1 100) (in_range2 result__3))))
(assert (= temp___1552 result7))
(assert (= temp___1553 (- high_index2 low_index2)))
(assert (=> (< (to_rep (select items mid_index3)) search_item) (and (<= 1 (+ mid_index3 1)) (<= (+ mid_index3 1) 100))))
...
(assert (=> (< (to_rep (select items mid_index3)) search_item) (= result8 (ite (< search_item o2) true false))))
(assert (=> (< (to_rep (select items mid_index3)) search_item) (not (= result8 true))))
(assert (=> (< (to_rep (select items mid_index3)) search_item) (and (= o3 (+ mid_index3 1)) (in_range2 (+ mid_index3 1)))))
(assert (=> (< (to_rep (select items mid_index3)) search_item) (= low_index2 result9)))
...
(assert (=> (not (< (to_rep (select items mid_index3)) search_item)) (= high_index2 result10)))
