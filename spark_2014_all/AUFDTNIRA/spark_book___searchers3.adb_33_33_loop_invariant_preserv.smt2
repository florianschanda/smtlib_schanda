...
(assert (and (and (and (=> (<= 1 100) (in_range2 low_index2)) (=> (<= 1 100) (in_range2 mid_index2))) (=> (<= 1 100) (in_range2 high_index2))) (=> (<= 1 100) (in_range2 result__3))))
(assert (= temp___179 result5))
(assert (= temp___1791 (- high_index2 low_index2)))
(assert (=> (< (to_rep (select items mid_index2)) search_item) (and (<= 1 (+ mid_index2 1)) (<= (+ mid_index2 1) 100))))
...
(assert (=> (< (to_rep (select items mid_index2)) search_item) (= result6 (ite (< search_item o2) true false))))
(assert (=> (< (to_rep (select items mid_index2)) search_item) (not (= result6 true))))
(assert (=> (< (to_rep (select items mid_index2)) search_item) (and (= o3 (+ mid_index2 1)) (in_range2 (+ mid_index2 1)))))
(assert (=> (< (to_rep (select items mid_index2)) search_item) (= low_index2 result7)))
...
(assert (=> (not (< (to_rep (select items mid_index2)) search_item)) (= high_index2 result8)))
