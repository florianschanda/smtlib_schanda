...
(assert (forall ((temp___2516 Int) (temp___2517 Int) (temp___2518 Int) (temp___2519 Int)) (let ((temp___2515 (aida__conversion__calculate_negative_target_length_3__int_array__aggregate_def temp___2516 temp___2517 temp___2518 temp___2519))) (=> (and (dynamic_invariant temp___2516 true true true true) (dynamic_invariant temp___2517 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 2) temp___2518 temp___2519) (and (= (first5 temp___2515) temp___2518) (= (last5 temp___2515) temp___2519))) (and (= (to_rep1 (select (to_array2 temp___2515) (+ (+ (first1 source) 1) 0))) temp___2516) (= (to_rep1 (select (to_array2 temp___2515) (+ (+ (first1 source) 1) 1))) temp___2517)))))))
(define-fun dynamic_invariant4 ((temp___expr_914 us_t3) (temp___is_init_910 Bool) (temp___skip_constant_911 Bool) (temp___do_toplevel_912 Bool) (temp___do_typ_inv_913 Bool)) Bool (=> (not (= temp___skip_constant_911 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 2) (first7 temp___expr_914) (last7 temp___expr_914)) (and (= (first7 temp___expr_914) (+ (first1 source) 1)) (= (last7 temp___expr_914) (+ (first1 source) 2))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2525 Int) (temp___2526 Int) (temp___2527 Int)) (let ((temp___2524 (aida__conversion__calculate_negative_target_length_3__n__aggregate_def temp___2525 temp___2526 temp___2527))) (=> (dynamic_invariant temp___2525 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 2) temp___2526 temp___2527) (and (= (first9 temp___2524) temp___2526) (= (last9 temp___2524) temp___2527))) (forall ((temp___2528 Int)) (= (to_rep1 (select (to_array4 temp___2524) temp___2528)) temp___2525)))))))
...
(declare-const temp___2522 (Array Int integer))
(declare-const temp___25221 t2)
...
(declare-const temp___2530 (Array Int integer))
(declare-const temp___25301 t4)
...
(declare-const temp___2536 Int)
(declare-const temp___2537 Int)
(declare-const temp___2535 Int)
(declare-const temp___2533 (Array Int integer))
(declare-const o Int)
...
(declare-const temp___2538 Int)
(declare-const o9 Int)
(declare-const o10 integer)
(declare-const o11 Int)
(declare-const o12 Int)
(declare-const o13 Int)
(declare-const temp___2539 Int)
...
(assert (and (= (length source) 3) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index9 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index9) (<= index9 (+ (to_rep1 (first (rt source))) 2))) (= (is_digit (to_rep (select (elts source) index9))) true))))))
...
(assert (= (mk___t2 temp___2522 temp___25221) (aida__conversion__calculate_negative_target_length_3__int_array__aggregate_def 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 1))))
(assert (= (ite (<= (to_rep1 (first4 temp___25221)) (to_rep1 (last4 temp___25221))) (+ (- (to_rep1 (last4 temp___25221)) (to_rep1 (first4 temp___25221))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2)) (+ (- (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2522 (to_rep1 (first4 temp___25221)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_3__int_array__assume))
...
(assert (= (mk___t4 temp___2530 temp___25301) (aida__conversion__calculate_negative_target_length_3__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2))))
(assert (= (ite (<= (to_rep1 (first8 temp___25301)) (to_rep1 (last8 temp___25301))) (+ (- (to_rep1 (last8 temp___25301)) (to_rep1 (first8 temp___25301))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2)) (+ (- (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2530 (to_rep1 (first8 temp___25301)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_3__n__assume))
...
(assert (and (= temp___2536 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2537 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2536))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= temp___2535 index1)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= temp___2533 n1)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= o index1)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= o3 index1)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= o7 index1)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= n1 result3)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= n2 o8)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (and (and (forall ((temp___2534 Int)) (=> (and (<= (to_rep1 n__first) temp___2534) (<= temp___2534 (to_rep1 n__last))) (=> (< index2 temp___2534) (= (select n3 temp___2534) (select temp___2533 temp___2534))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 2))))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= index2 temp___2537)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= index2 index3)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= n3 n4)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= index4 index2)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= n5 n3)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= index6 index4)))
(assert (=> (and (<= temp___2536 index1) (<= index1 temp___2537)) (= n7 n5)))
(assert (=> (not (and (<= temp___2536 index1) (<= index1 temp___2537))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2536 index1) (<= index1 temp___2537))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2536 index1) (<= index1 temp___2537))) (= index6 index1)))
(assert (=> (not (and (<= temp___2536 index1) (<= index1 temp___2537))) (= n7 n1)))
...
(assert (and (= temp___2538 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2538) (<= temp___2538 (to_rep1 n__last))))
(assert (= o9 temp___2538))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2539 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___2539) (<= temp___2539 (to_rep1 n__last))))
(assert (= o14 temp___2539))
