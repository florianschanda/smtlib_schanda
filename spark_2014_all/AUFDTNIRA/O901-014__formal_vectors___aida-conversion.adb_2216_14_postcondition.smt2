...
(assert (and (= (length source) 3) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index11) (<= index11 (+ (to_rep1 (first (rt source))) 2))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_length_3__int_array__aggregate_def 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 1))))) (+ (to_rep1 (first (rt source))) 1)) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_length_3__int_array__aggregate_def 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 1))))) (+ (+ (to_rep1 (first (rt source))) 1) 1)) (= (mk___t2 temp___2420 temp___24201) (aida__conversion__calculate_negative_target_length_3__int_array__aggregate_def 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 1))))) (and (= (ite (<= (to_rep1 (first4 temp___24201)) (to_rep1 (last4 temp___24201))) (+ (- (to_rep1 (last4 temp___24201)) (to_rep1 (first4 temp___24201))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2)) (+ (- (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 1)) 1) 0)) (and (= (slide1 temp___2420 (to_rep1 (first4 temp___24201)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_3__int_array__assume) (= (mk1 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_negative_target_length_3__int_array__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_negative_target_length_3__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_length_3__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_length_3__int_array__assume1)))))) (and (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 2)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_length_3__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2))))) (+ (to_rep1 (first (rt source))) 1)) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_length_3__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2))))) (+ (to_rep1 (first (rt source))) 2)) (= (mk___t4 temp___2428 temp___24281) (aida__conversion__calculate_negative_target_length_3__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2))))) (and (= (ite (<= (to_rep1 (first8 temp___24281)) (to_rep1 (last8 temp___24281))) (+ (- (to_rep1 (last8 temp___24281)) (to_rep1 (first8 temp___24281))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2)) (+ (- (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 1)) 1) 0)) (and (= (slide1 temp___2428 (to_rep1 (first8 temp___24281)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_3__n__assume) (= (mk3 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_negative_target_length_3__n__assume1)))) (and (and (= (mk_map__ref1 result2) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_negative_target_length_3__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_length_3__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_length_3__n__assume1)))))) (and (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 2)))) (and (and (and (= temp___2434 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (= temp___2435 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (= (mk_int__ref result3) (mk_int__ref index)) (= index2 temp___2434)) (ite (and (<= temp___2434 index2) (<= index2 temp___2435)) (and (and (and (= temp___2433 index2) (and (= temp___2431 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o5 index2)) (= o6 (select n1 o5))) (= o7 (to_rep1 o6))) (= o7 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o8 index2)) (= o9 (select (elts source) o8))) (= o10 (to_rep o9))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o10))) (ite (= (= o10 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o10 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o10 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o10 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o10 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o10 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o10 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o10 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o10 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o10 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o11) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o12 index2)) (= o13 (store n1 o12 o11)))) (and (= n1 result4) (= n2 o13))))) (and (and (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (forall ((temp___2432 Int)) (=> (and (<= (to_rep1 n__first) temp___2432) (<= temp___2432 (to_rep1 n__last))) (=> (< index3 temp___2432) (= (select n3 temp___2432) (select temp___2431 temp___2432))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 2) index3))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 2)))) (= index3 temp___2435)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1))))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (and (and (= temp___2436 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (<= (to_rep1 n__first) temp___2436) (<= temp___2436 (to_rep1 n__last))) (= o41 temp___2436))) (= o42 (select (map__content1 n7) o41))) (= o43 (to_rep1 o42))) (= o44 (- o43))) (and (= o45 o44) (in_range1 o44))) (and (= result9 (mk_int__ref target)) (= target1 o45))) (and (<= (- 9) target1) (and (and (and (and (and (and (and (and (and (and (= temp___2437 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (<= (to_rep1 n__first) temp___2437) (<= temp___2437 (to_rep1 n__last))) (= o46 temp___2437))) (= o47 (select (map__content1 n7) o46))) (= o48 (to_rep1 o47))) (= o49 (* o48 10))) (and (= o50 o49) (in_range1 o49))) (= o51 (- target1 o50))) (and (= o52 o51) (in_range1 o51))) (and (= result10 (mk_int__ref target1)) (= target2 o52))) (and (<= (- 99) target2) (and (= result11 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target3 (mk_int__ref target2)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target4 target2))))))))
