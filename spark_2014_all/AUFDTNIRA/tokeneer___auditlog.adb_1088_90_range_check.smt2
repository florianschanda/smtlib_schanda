...
(assert (= result8 (mk_int__ref j2)))
(assert (= j3 1))
(assert (<= 1 j3))
(assert (<= j3 r76b))
(assert (and (<= 1 (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14))))) (<= (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14)))) (- i2 1))))
(assert (=> (< 0 (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14))))) (< (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14)))) i2)))
(assert (and (and (and (and (and (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields14) (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (= (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields14) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9))) (= (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14))) (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9))))) (= (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields14) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9))) (=> (<= 1 r76b) (dynamic_property1 1 r76b j4))) (and (<= 1 j4) (<= j4 r76b))))
(assert (and (= result9 (agelessthan (select fileages i2) (select fileages (to_rep2 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14))) j4))))) (= (= result9 true) (< (compare (select fileages i2) 1 21 (select fileages (to_rep2 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14))) j4))) 1 21) 0))))
(assert (= result9 true))
(assert (not (in_range6 (+ (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14)))) 1))))
(check-sat)
(exit)
