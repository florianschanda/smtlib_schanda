...
(assert (= o9 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (<= 0 j))
(assert (<= j 2147483647))
(assert (and (= o (* j l2)) (in_range1 (* j l2))))
(assert (= result1 (ite (< o length1) true false)))
(assert (= result1 true))
(assert (and (= o4 (* j l2)) (in_range1 (* j l2))))
(assert (= o5 (- length1 o4)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (= o7 (ite (< l2 o6) l2 o6)))
(assert (and (= o8 o7) (in_range2 o7)))
(assert (and (= o1 (* j l2)) (in_range1 (* j l2))))
(assert (= o2 (+ a_first o1)))
