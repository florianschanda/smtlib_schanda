...
(assert (= o15 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (<= 0 j))
(assert (<= j 2147483647))
(assert (and (= o5 (* j l2)) (in_range1 (* j l2))))
(assert (= result1 (ite (< o5 length1) true false)))
(assert (= result1 true))
(assert (and (= o10 (* j l2)) (in_range1 (* j l2))))
(assert (= o11 (- length1 o10)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (= o13 (ite (< l2 o12) l2 o12)))
(assert (and (= o14 o13) (in_range2 o13)))
(assert (and (= o6 (* j l2)) (in_range1 (* j l2))))
(assert (= o7 (+ a_first o6)))
