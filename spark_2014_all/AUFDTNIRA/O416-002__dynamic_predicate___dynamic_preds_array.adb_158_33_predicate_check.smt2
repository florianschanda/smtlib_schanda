...
(declare-fun get_even_close_pair__2 ((Array Int even)) (Array Int even))
(declare-fun get_even_close_pair__2__function_guard ((Array Int even) (Array Int even)) Bool)
(assert (forall ((x (Array Int even))) (! (=> (dynamic_invariant2 x true true true true) (dynamic_invariant2 (get_even_close_pair__2 x) true false true true)) :pattern ((get_even_close_pair__2 x)))))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const x (Array Int even))
(declare-const o (Array Int even))
(declare-const o1 (Array Int even))
...
(assert (dynamic_predicate1 x))
(assert (= o x))
(assert (and (= o1 (get_even_close_pair__2 o)) (dynamic_invariant2 o1 true false true true)))
(assert (= result x))
(assert (= x1 o1))
(assert (not (dynamic_predicate1 x1)))
(check-sat)
(exit)
