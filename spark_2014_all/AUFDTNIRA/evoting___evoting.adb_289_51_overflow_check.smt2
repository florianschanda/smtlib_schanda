...
(define-fun dynamic_invariant ((temp___expr_539 Int) (temp___is_init_536 Bool) (temp___skip_constant_537 Bool) (temp___do_toplevel_538 Bool)) Bool (=> (or (= temp___is_init_536 true) (<= 0 2)) (in_range4 temp___expr_539)))
...
(define-fun dynamic_invariant1 ((temp___expr_551 Int) (temp___is_init_548 Bool) (temp___skip_constant_549 Bool) (temp___do_toplevel_550 Bool)) Bool (=> (or (= temp___is_init_548 true) (<= 0 20)) (in_range6 temp___expr_551)))
...
(define-fun dynamic_invariant2 ((temp___expr_557 Int) (temp___is_init_554 Bool) (temp___skip_constant_555 Bool) (temp___do_toplevel_556 Bool)) Bool (=> (or (= temp___is_init_554 true) (<= 0 210000)) (in_range8 temp___expr_557)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_724 us_void_param) 1)) 42) (= (to_rep (select (temp___String_Literal_724 us_void_param) 2)) 42)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 3)) 42)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 4)) 42)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 6)) 82)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 9)) 117)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 10)) 108)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 13)) 42)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 14)) 42)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 15)) 42)) (= (to_rep (select (temp___String_Literal_724 us_void_param) 16)) 42)) :pattern ((temp___String_Literal_724 us_void_param)))))
(declare-fun temp___String_Literal_729 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_729 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_729 us_void_param) 2)) 118)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 6)) 40)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 7)) 115)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 8)) 41)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 9)) 58)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 10)) 32)) :pattern ((temp___String_Literal_729 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_733 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_733 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 4)) 97)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 7)) 110)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 8)) 117)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 9)) 109)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 15)) 102)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 17)) 118)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 20)) 101)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 21)) 115)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 22)) 58)) (= (to_rep (select (temp___String_Literal_733 us_void_param) 23)) 32)) :pattern ((temp___String_Literal_733 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_735 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_735 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 4)) 97)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 7)) 110)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 8)) 117)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 9)) 109)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 15)) 102)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 17)) 118)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 18)) 97)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 19)) 108)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 20)) 105)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 21)) 100)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 23)) 118)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 25)) 116)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 27)) 115)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 28)) 58)) (= (to_rep (select (temp___String_Literal_735 us_void_param) 29)) 32)) :pattern ((temp___String_Literal_735 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_737 us_void_param) 1)) 42) (= (to_rep (select (temp___String_Literal_737 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_737 us_void_param) 3)) 87)) (= (to_rep (select (temp___String_Literal_737 us_void_param) 4)) 105)) (= (to_rep (select (temp___String_Literal_737 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_737 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_737 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_737 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_737 us_void_param) 9)) 40)) (= (to_rep (select (temp___String_Literal_737 us_void_param) 10)) 115)) (= (to_rep (select (temp___String_Literal_737 us_void_param) 11)) 41)) (= (to_rep (select (temp___String_Literal_737 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_737 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_545 Int) (temp___is_init_542 Bool) (temp___skip_constant_543 Bool) (temp___do_toplevel_544 Bool)) Bool (=> (or (= temp___is_init_542 true) (<= 0 10000)) (in_range5 temp___expr_545)))
...
(assert (and (and (and (=> (< 0 i2) (<= (to_rep2 (select counters 0)) total2)) (<= last_candidate 20)) (and (<= 0 i2) (<= i2 20))) (<= total2 (* i2 10000))))
(assert (and (and (=> (<= 0 210000) (in_range8 total2)) (=> (<= 0 last_candidate) (dynamic_property1 0 last_candidate i2))) (and (<= 0 i2) (<= i2 last_candidate))))
(assert (not (in_range7 (* i2 10000))))
(check-sat)
(exit)
