...
(define-fun dynamic_invariant ((temp___expr_533 Int) (temp___is_init_530 Bool) (temp___skip_constant_531 Bool) (temp___do_toplevel_532 Bool)) Bool (=> (or (= temp___is_init_530 true) (<= 0 2)) (in_range4 temp___expr_533)))
...
(define-fun dynamic_invariant1 ((temp___expr_545 Int) (temp___is_init_542 Bool) (temp___skip_constant_543 Bool) (temp___do_toplevel_544 Bool)) Bool (=> (or (= temp___is_init_542 true) (<= 0 20)) (in_range6 temp___expr_545)))
...
(declare-datatypes () ((ttotal_range_tB__ref (mk_ttotal_range_tB__ref (ttotal_range_tB__content ttotal_range_tB)))))
(define-fun ttotal_range_tB__ref___projection ((a ttotal_range_tB__ref)) ttotal_range_tB (ttotal_range_tB__content a))
...
(declare-datatypes () ((total_range_t__ref (mk_total_range_t__ref (total_range_t__content total_range_t)))))
(define-fun total_range_t__ref___projection ((a total_range_t__ref)) total_range_t (total_range_t__content a))
(define-fun dynamic_invariant2 ((temp___expr_551 Int) (temp___is_init_548 Bool) (temp___skip_constant_549 Bool) (temp___do_toplevel_550 Bool)) Bool (=> (or (= temp___is_init_548 true) (<= 0 210000)) (in_range8 temp___expr_551)))
...
(declare-datatypes () ((map__ref3 (mk_map__ref3 (map__content3 (Array Int Bool))))))
(declare-fun slide3 ((Array Int Bool) Int Int) (Array Int Bool))
(assert (forall ((a (Array Int Bool))) (forall ((first2 Int)) (! (= (slide3 a first2 first2) a) :pattern ((slide3 a first2 first2))))))
(assert (forall ((a (Array Int Bool))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide3 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide3 a old_first new_first) i))))))))
(declare-fun concat4 ((Array Int Bool) Int Int (Array Int Bool) Int Int) (Array Int Bool))
...
(assert (forall ((v Bool)) (forall ((i Int)) (! (= (select (singleton4 v i) i) v) :pattern ((select (singleton4 v i) i))))))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (select a temp___idx_154) (select b (+ (- b__first a__first) temp___idx_154))))))))))
(declare-fun compare2 ((Array Int Bool) Int Int (Array Int Bool) Int Int) Int)
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare2 a a_first a_last b b_first b_last) 0) (= (bool_eq4 a a_first a_last b b_first b_last) true)) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq4 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_int1 (select a (+ i 1))) (to_int1 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq4 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_int1 (select b (+ i 1))) (to_int1 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(assert (forall ((x tcandidate_number_tB)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x tcandidate_number_tB)) (! (in_range9 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(declare-datatypes () ((t83b__ref (mk_t83b__ref (t83b__content tcandidate_number_tB)))))
(define-fun t83b__ref___projection ((a t83b__ref)) tcandidate_number_tB (t83b__content a))
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-fun temp___String_Literal_718 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_718 us_void_param) 1)) 42) (= (to_rep (select (temp___String_Literal_718 us_void_param) 2)) 42)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 3)) 42)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 4)) 42)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 6)) 82)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 9)) 117)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 10)) 108)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 13)) 42)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 14)) 42)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 15)) 42)) (= (to_rep (select (temp___String_Literal_718 us_void_param) 16)) 42)) :pattern ((temp___String_Literal_718 us_void_param)))))
(declare-fun temp___String_Literal_723 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_723 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_723 us_void_param) 2)) 118)) (= (to_rep (select (temp___String_Literal_723 us_void_param) 3)) 111)) (= (to_rep (select (temp___String_Literal_723 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_723 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_723 us_void_param) 6)) 40)) (= (to_rep (select (temp___String_Literal_723 us_void_param) 7)) 115)) (= (to_rep (select (temp___String_Literal_723 us_void_param) 8)) 41)) (= (to_rep (select (temp___String_Literal_723 us_void_param) 9)) 58)) (= (to_rep (select (temp___String_Literal_723 us_void_param) 10)) 32)) :pattern ((temp___String_Literal_723 us_void_param)))))
(declare-fun temp___String_Literal_724 (tuple0) (Array Int character))
(assert true)
(declare-fun temp___String_Literal_727 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_727 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_727 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 4)) 97)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 7)) 110)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 8)) 117)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 9)) 109)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 15)) 102)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 17)) 118)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 20)) 101)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 21)) 115)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 22)) 58)) (= (to_rep (select (temp___String_Literal_727 us_void_param) 23)) 32)) :pattern ((temp___String_Literal_727 us_void_param)))))
(declare-fun temp___String_Literal_728 (tuple0) (Array Int character))
(assert true)
(declare-fun temp___String_Literal_729 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_729 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_729 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 4)) 97)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 5)) 108)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 7)) 110)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 8)) 117)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 9)) 109)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 15)) 102)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 17)) 118)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 18)) 97)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 19)) 108)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 20)) 105)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 21)) 100)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 23)) 118)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 25)) 116)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 27)) 115)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 28)) 58)) (= (to_rep (select (temp___String_Literal_729 us_void_param) 29)) 32)) :pattern ((temp___String_Literal_729 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_731 us_void_param) 1)) 42) (= (to_rep (select (temp___String_Literal_731 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_731 us_void_param) 3)) 87)) (= (to_rep (select (temp___String_Literal_731 us_void_param) 4)) 105)) (= (to_rep (select (temp___String_Literal_731 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_731 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_731 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_731 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_731 us_void_param) 9)) 40)) (= (to_rep (select (temp___String_Literal_731 us_void_param) 10)) 115)) (= (to_rep (select (temp___String_Literal_731 us_void_param) 11)) 41)) (= (to_rep (select (temp___String_Literal_731 us_void_param) 12)) 32)) :pattern ((temp___String_Literal_731 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_539 Int) (temp___is_init_536 Bool) (temp___skip_constant_537 Bool) (temp___do_toplevel_538 Bool)) Bool (=> (or (= temp___is_init_536 true) (<= 0 10000)) (in_range5 temp___expr_539)))
(declare-const total Int)
(declare-const valid_total Int)
(declare-const i Int)
(declare-const i1 Int)
(declare-const temp___720 Int)
...
(declare-const valid_total1 Int)
...
(assert (and (and (and (=> (< 0 i3) (<= (to_rep2 (select counters 0)) total2)) (<= last_candidate 20)) (and (<= 0 i3) (<= i3 20))) (<= total2 (* i3 10000))))
(assert (and (and (=> (<= 0 210000) (in_range8 total2)) (=> (<= 0 last_candidate) (dynamic_property1 0 last_candidate i3))) (and (<= 0 i3) (<= i3 last_candidate))))
(assert (not (in_range7 (* i3 10000))))
(check-sat)
(exit)
