...
(assert (forall ((temp___220 Bool) (temp___221 Bool)) (let ((temp___219 (temp___218 temp___220 temp___221))) (forall ((temp___222 Int)) (ite (= temp___222 1) (= (select temp___219 temp___222) temp___220) (= (select temp___219 temp___222) temp___221))))))
