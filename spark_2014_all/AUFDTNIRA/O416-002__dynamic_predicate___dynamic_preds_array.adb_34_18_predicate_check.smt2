...
(define-fun dynamic_invariant1 ((temp___expr_181 (Array Int integer)) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool) (temp___do_typ_inv_180 Bool)) Bool (=> (= temp___do_toplevel_179 true) (=> (= temp___is_init_177 true) (and (and (in_range1 (to_rep (select temp___expr_181 1))) (= (mod2 (to_rep (select temp___expr_181 1)) 2) 0)) (and (in_range1 (to_rep (select temp___expr_181 2))) (= (mod2 (to_rep (select temp___expr_181 2)) 2) 0))))))
(define-fun dynamic_predicate ((temp___192 (Array Int integer))) Bool (and (and (in_range1 (to_rep (select temp___192 1))) (= (mod2 (to_rep (select temp___192 1)) 2) 0)) (and (in_range1 (to_rep (select temp___192 2))) (= (mod2 (to_rep (select temp___192 2)) 2) 0))))
...
(declare-const temp___273 (Array Int integer))
...
(assert (= temp___273 (store x 1 o)))
(assert (not (dynamic_predicate temp___273)))
(check-sat)
(exit)
