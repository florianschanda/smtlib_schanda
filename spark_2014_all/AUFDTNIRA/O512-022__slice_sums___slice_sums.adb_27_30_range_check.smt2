...
(assert (= result5 (mk_int__ref hi3)))
(assert (= hi4 (to_rep3 (first (rt x)))))
(assert (<= (to_rep3 (first (rt x))) hi4))
(assert (<= hi4 (to_rep3 (last (rt x)))))
(assert (and (forall ((lo_index2 Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index2) (<= lo_index2 (- lo3 1))) (forall ((hi_index3 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index3) (<= hi_index3 (to_rep3 (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index2) (of_rep1 hi_index3)))) max_sum3))))) (forall ((hi_index3 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index3) (<= hi_index3 (- hi5 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo3) (of_rep1 hi_index3)))) max_sum3)))))
...
(assert (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 current_sum3)) (=> (<= (to_rep3 (first (rt x))) (to_rep3 (last (rt x)))) (dynamic_property2 (to_rep3 (first (rt x))) (to_rep3 (last (rt x))) hi5))) (=> (<= 0 2147483647) (in_range2 max_sum3))) (and (<= (to_rep3 (first (rt x))) hi5) (<= hi5 (to_rep3 (last (rt x)))))))
(assert (and (= o20 (- hi5 1)) (in_range1 (- hi5 1))))
(assert (= o21 (ite (<= hi_index2 o20) true false)))
(assert (= result6 (ite (<= (to_rep3 (first (rt x))) hi_index2) o21 false)))
(assert (= (= o27 true) (forall ((hi_index3 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index3) (<= hi_index3 (- hi5 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo3) (of_rep1 hi_index3)))) max_sum3)))))
(assert (and (= o13 (- lo3 1)) (in_range1 (- lo3 1))))
(assert (= o14 (ite (<= lo_index1 o13) true false)))
(assert (= result7 (ite (<= (to_rep3 (first (rt x))) lo_index1) o14 false)))
(assert (= result7 true))
