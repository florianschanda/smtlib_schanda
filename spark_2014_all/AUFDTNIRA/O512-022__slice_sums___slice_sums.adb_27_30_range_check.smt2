...
(assert (forall ((lo_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index1) (<= lo_index1 (- lo2 1))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index1) (<= hi_index1 (to_rep3 (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index1) (of_rep1 hi_index1)))) max_sum2))))))
...
(assert (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 current_sum1)) (=> (<= (to_rep3 (first (rt x))) (to_rep3 (last (rt x)))) (dynamic_property1 (to_rep3 (first (rt x))) (to_rep3 (last (rt x))) lo2))) (=> (<= 0 2147483647) (in_range2 max_sum2))) (and (<= (to_rep3 (first (rt x))) lo2) (<= lo2 (to_rep3 (last (rt x)))))))
(assert (= result3 (mk_int__ref hi)))
(assert (= hi1 (to_rep3 (first (rt x)))))
(assert (<= (to_rep3 (first (rt x))) hi1))
(assert (<= hi1 (to_rep3 (last (rt x)))))
(assert (and (forall ((lo_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index1) (<= lo_index1 (- lo2 1))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index1) (<= hi_index1 (to_rep3 (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index1) (of_rep1 hi_index1)))) max_sum3))))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index1) (<= hi_index1 (- hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index1)))) max_sum3)))))
(assert (=> (<= (to_rep (rec__sums__slice_bounds__lo result____split_fields4)) (to_rep1 (rec__sums__slice_bounds__hi result____split_fields4))) (and (and (<= (to_rep3 (first (rt x))) (to_rep (rec__sums__slice_bounds__lo result____split_fields4))) (<= (to_rep1 (rec__sums__slice_bounds__hi result____split_fields4)) (to_rep3 (last (rt x))))) (= max_sum3 (sum__logic x (mk_slice_bounds result____split_fields4))))))
(assert (and (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 current_sum2)) (=> (<= (to_rep3 (first (rt x))) (to_rep3 (last (rt x)))) (dynamic_property2 (to_rep3 (first (rt x))) (to_rep3 (last (rt x))) hi2))) (=> (<= 0 2147483647) (in_range2 max_sum3))) (and (<= (to_rep3 (first (rt x))) hi2) (<= hi2 (to_rep3 (last (rt x)))))))
...
(assert (= (= o8 true) (forall ((hi_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index1) (<= hi_index1 (- hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index1)))) max_sum3)))))
