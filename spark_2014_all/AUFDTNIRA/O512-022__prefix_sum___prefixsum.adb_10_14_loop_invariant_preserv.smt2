...
(assert (and (= o29 o28) (in_range3 o28)))
(assert (= result12 (mk_int__ref space2)))
(assert (= space3 o29))
(assert (< space3 8))
(assert (= temp___2053 (mk_int__ref temp___2052)))
(assert (= right11 right9))
(assert (= left12 left10))
(assert (= space4 (mk_int__ref space3)))
(assert (= a11 a9))
(assert (= rho3 rho2))
(assert (= temp___2054 temp___2052))
(assert (= right12 right10))
(assert (= left13 left11))
(assert (= space5 space3))
(assert (= a12 a10))
(assert (not (= (all_elements_in (map__content a11) (* (int__content space4) 1000000)) true)))
(check-sat)
(exit)
