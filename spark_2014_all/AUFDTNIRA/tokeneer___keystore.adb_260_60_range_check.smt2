...
(assert (=> (= (select issystem retvalini1) true) (= temp___1902 (mk___t1 (temp___String_Literal_1901 Tuple0) (mk1 1 10)))))
(assert (=> (= (select issystem retvalini1) true) (dynamic_predicate temp___1902)))
(assert (=> (= (select issystem retvalini1) true) (= o5 temp___1902)))
(assert (=> (= (select issystem retvalini1) true) (= o6 (convertretvaltotext retvalini1 o5))))
(assert (=> (= (select issystem retvalini1) true) (= o7 (mk___t o6 (mk 1 150)))))
...
(assert (=> (= (select issystem retvalini1) true) (= logfilesstatus3 (mk_map__ref1 logfilesstatus2))))
(assert (=> (= (select issystem retvalini1) true) (= logfiles3 (mk_map__ref4 logfiles2))))
...
(assert (=> (not (= (select issystem retvalini1) true)) (= logfilesstatus3 (mk_map__ref1 logfilesstatus))))
(assert (=> (not (= (select issystem retvalini1) true)) (= logfiles3 (mk_map__ref4 logfiles))))
