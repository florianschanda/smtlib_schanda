...
(assert (= a20 a18))
(assert (and (= result14 (all_elements_in (map__content a19) 8000000)) (= (= result14 true) (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 7)) (and (<= (- 8000000) (to_rep (select (map__content a19) k2))) (<= (to_rep (select (map__content a19) k2)) 8000000)))))))
