...
(define-fun dynamic_invariant ((temp___expr_529 Int) (temp___is_init_526 Bool) (temp___skip_constant_527 Bool) (temp___do_toplevel_528 Bool)) Bool (=> (or (= temp___is_init_526 true) (<= 0 2147483647)) (in_range3 temp___expr_529)))
...
(define-fun dynamic_invariant1 ((temp___expr_535 Int) (temp___is_init_532 Bool) (temp___skip_constant_533 Bool) (temp___do_toplevel_534 Bool)) Bool (=> (or (= temp___is_init_532 true) (<= 1 10)) (in_range4 temp___expr_535)))
...
(define-fun dynamic_invariant3 ((temp___expr_514 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 1 10)) (in_range2 temp___expr_514)))
...
(declare-const temp___5711 Int)
(declare-const result6 Int)
(declare-const temp___5701 Int)
...
(assert (and (and (and (=> (<= 1 10) (in_range4 low_index2)) (=> (<= 1 10) (in_range4 mid_index2))) (=> (<= 1 10) (in_range4 result__3))) (=> (<= 1 10) (in_range4 high_index2))))
(assert (= temp___571 result5))
(assert (= temp___5711 low_index2))
(assert (= temp___570 result6))
(assert (= temp___5701 high_index2))
