...
(define-fun dynamic_invariant ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= 0 2147483647)) (in_range3 temp___expr_596)))
...
(define-fun dynamic_invariant1 ((temp___expr_603 Int) (temp___is_init_599 Bool) (temp___skip_constant_600 Bool) (temp___do_toplevel_601 Bool) (temp___do_typ_inv_602 Bool)) Bool (=> (or (= temp___is_init_599 true) (<= 1 10)) (in_range4 temp___expr_603)))
...
(define-fun dynamic_invariant3 ((temp___expr_579 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool) (temp___do_typ_inv_578 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 1 10)) (in_range2 temp___expr_579)))
...
(declare-const temp___639 Int)
(declare-const result5 Int)
(declare-const temp___6401 Int)
(declare-const result6 Int)
(declare-const temp___6391 Int)
...
(assert (and (and (and (=> (<= 1 10) (in_range4 result__3)) (=> (<= 1 10) (in_range4 mid_index2))) (=> (<= 1 10) (in_range4 high_index2))) (=> (<= 1 10) (in_range4 low_index2))))
(assert (= temp___640 result5))
(assert (= temp___6401 low_index2))
(assert (= temp___639 result6))
(assert (= temp___6391 high_index2))
...
(assert (not (or (< search_item (to_rep (select items high_index3))) (= search_item (to_rep (select items high_index3))))))
(check-sat)
(exit)
