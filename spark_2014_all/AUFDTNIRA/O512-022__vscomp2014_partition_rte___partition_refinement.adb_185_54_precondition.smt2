...
(assert (and (<= (* 2 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (<= (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 5000) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (to_rep (select a j))) true))) (and (forall ((c1 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true) (= (to_rep (select a (element1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c1))) (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c1)))) (and (forall ((c1 us_rep)) (=> (= (has_key (positions x) c1) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x c1)) true))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= 0 (to_rep4 (select f j))) (<= (to_rep4 (select f j)) (- (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j)))))) j) (<= j (to_rep3 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j)))))))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))) (= (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j)))) 0)))))))))))
...
(assert (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a1 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2)) (to_rep (select a (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2)))))))))) (ite (= k (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2))))))))) (to_rep (select a (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2))) (to_rep (select a k))))))) (and (= (capacity (mk___rep5 p__split_discrs p__split_fields1)) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (= (length2 (mk___rep5 p__split_discrs p__split_fields1)) (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields1)) (to_rep (select a1 j))) true))) (and (forall ((c1 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields1)) c1) true) (= (to_rep (select a1 (element1 (mk___rep3 d__split_discrs d__split_fields1) c1))) (key (mk___rep3 d__split_discrs d__split_fields1) c1)))) (= (oeq2 (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (keys (mk___rep3 d__split_discrs d__split_fields1))) true)))))))
...
(assert (forall ((c1 us_rep)) (=> (= (has_key (positions x) c1) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) (element x c1)) true))))
(assert (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) (to_rep (select a2 j))) true))))
(assert (and (= o3 (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c)) (= (= o3 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c) true))))
(assert (= o4 true))
(assert (= result2 (ite (= o4 true) o3 false)))
(assert (= result2 true))
(assert (and (= o5 (key (mk___rep3 d__split_discrs d__split_fields2) c)) (and (in_range8 o5) (= o5 (get2 (keys (mk___rep3 d__split_discrs d__split_fields2)) (get3 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c))))))
