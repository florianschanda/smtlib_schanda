...
(assert (and (= o36 (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c2)) (= (= o36 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c2) true))))
(assert (= o37 true))
(assert (= result12 (ite (= o37 true) o36 false)))
(assert (= result12 true))
(assert (and (= o39 (key (mk___rep3 d__split_discrs d__split_fields3) c2)) (and (in_range8 o39) (= o39 (get2 (keys (mk___rep3 d__split_discrs d__split_fields3)) (get3 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c2))))))
