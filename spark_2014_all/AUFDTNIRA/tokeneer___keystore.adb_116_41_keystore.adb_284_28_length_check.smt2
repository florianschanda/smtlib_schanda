...
(define-fun dynamic_invariant2 ((temp___expr_259 Int) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool)) Bool (=> (or (= temp___is_init_256 true) (<= 0 4294967295)) (in_range5 temp___expr_259)))
...
(define-fun dynamic_invariant3 ((temp___expr_742 Int) (temp___is_init_739 Bool) (temp___skip_constant_740 Bool) (temp___do_toplevel_741 Bool)) Bool (=> (or (= temp___is_init_739 true) (<= 0 10)) (in_range6 temp___expr_742)))
...
(assert (forall ((x rawcertificatei)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x rawcertificatei)) (! (in_range7 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun dynamic_invariant4 ((temp___expr_1038 Int) (temp___is_init_1035 Bool) (temp___skip_constant_1036 Bool) (temp___do_toplevel_1037 Bool)) Bool (=> (or (= temp___is_init_1035 true) (<= 0 28)) (in_range8 temp___expr_1038)))
(declare-fun to_rep4 (returnvaluet) Int)
(declare-fun of_rep4 (Int) returnvaluet)
(assert (forall ((x returnvaluet)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x returnvaluet)) (! (in_range8 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x bytet)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x bytet)) (! (in_range9 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun bool_eq3 ((a (Array Int bytet)) (a__first Int) (a__last Int) (b (Array Int bytet)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_141 Int)) (=> (and (<= a__first temp___idx_141) (<= temp___idx_141 a__last)) (= (to_rep5 (select a temp___idx_141)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_141))))))) true false))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_141 Int)) (=> (and (<= a__first temp___idx_141) (<= temp___idx_141 a__last)) (= (to_rep5 (select a temp___idx_141)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_141)))))))))))
(declare-fun compare1 ((Array Int bytet) Int Int (Array Int bytet) Int Int) Int)
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq3 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq3 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep5 (select a (+ i 1))) (to_rep5 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq3 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep5 (select b (+ i 1))) (to_rep5 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int bytet))) (<= 0 (object__component__size2 a))))
(assert (<= 0 value__alignment3))
(assert (forall ((a (Array Int bytet))) (<= 0 (object__alignment3 a))))
(declare-fun user_eq12 ((Array Int bytet) (Array Int bytet)) Bool)
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__keystore__interfac__digestt__digestid unsigned32t) (rec__keystore__interfac__digestt__signreturn returnvaluet) (rec__keystore__interfac__digestt__verifyreturn returnvaluet) (rec__keystore__interfac__digestt__pad (Array Int bytet))))))
(define-fun us_split_fields_DigestID__projection ((a us_split_fields2)) unsigned32t (rec__keystore__interfac__digestt__digestid a))
(define-fun us_split_fields_SignReturn__projection ((a us_split_fields2)) returnvaluet (rec__keystore__interfac__digestt__signreturn a))
(define-fun us_split_fields_VerifyReturn__projection ((a us_split_fields2)) returnvaluet (rec__keystore__interfac__digestt__verifyreturn a))
(define-fun us_split_fields_Pad__2__projection ((a us_split_fields2)) (Array Int bytet) (rec__keystore__interfac__digestt__pad a))
...
(define-fun bool_eq4 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (= (to_rep2 (rec__keystore__interfac__digestt__digestid (us_split_fields3 a))) (to_rep2 (rec__keystore__interfac__digestt__digestid (us_split_fields3 b)))) (= (to_rep4 (rec__keystore__interfac__digestt__signreturn (us_split_fields3 a))) (to_rep4 (rec__keystore__interfac__digestt__signreturn (us_split_fields3 b))))) (= (to_rep4 (rec__keystore__interfac__digestt__verifyreturn (us_split_fields3 a))) (to_rep4 (rec__keystore__interfac__digestt__verifyreturn (us_split_fields3 b))))) (= (bool_eq3 (rec__keystore__interfac__digestt__pad (us_split_fields3 a)) 1 20 (rec__keystore__interfac__digestt__pad (us_split_fields3 b)) 1 20) true)) true false))
...
(declare-datatypes () ((digestt__ref (mk_digestt__ref (digestt__content us_rep1)))))
(define-fun digestt__ref___projection ((a digestt__ref)) us_rep1 (digestt__content a))
(declare-const nulldigest us_rep1)
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun temp___153 (Int) (Array Int bytet))
(assert (forall ((temp___155 Int)) (forall ((temp___156 Int)) (= (select (temp___153 temp___155) temp___156) (of_rep5 temp___155)))))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare2 a a_first a_last b b_first b_last) 0) (= (bool_eq5 a a_first a_last b b_first b_last) true)) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq5 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_int1 (select a (+ i 1))) (to_int1 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq5 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_int1 (select b (+ i 1))) (to_int1 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq7 ((x us_t2) (y us_t2)) Bool (bool_eq (elts2 x) (to_rep1 (first4 (rt2 x))) (to_rep1 (last4 (rt2 x))) (elts2 y) (to_rep1 (first4 (rt2 y))) (to_rep1 (last4 (rt2 y)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1218 us_void_param) 1)) 68) (= (to_rep (select (temp___String_Literal_1218 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1218 us_void_param) 3)) 103)) (= (to_rep (select (temp___String_Literal_1218 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1218 us_void_param) 5)) 115)) (= (to_rep (select (temp___String_Literal_1218 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1218 us_void_param) 7)) 73)) (= (to_rep (select (temp___String_Literal_1218 us_void_param) 8)) 110)) (= (to_rep (select (temp___String_Literal_1218 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1218 us_void_param) 10)) 116)) :pattern ((temp___String_Literal_1218 us_void_param)))))
(declare-fun temp___String_Literal_1228 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1228 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 23)) 110)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 25)) 68)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 26)) 105)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 27)) 103)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 28)) 101)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 29)) 115)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 30)) 116)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 31)) 73)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 32)) 110)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 33)) 105)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 34)) 116)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 36)) 58)) (= (to_rep (select (temp___String_Literal_1228 us_void_param) 37)) 32)) :pattern ((temp___String_Literal_1228 us_void_param)))))
(declare-fun temp___String_Literal_1231 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1231 us_void_param) 1)) 68) (= (to_rep (select (temp___String_Literal_1231 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1231 us_void_param) 3)) 103)) (= (to_rep (select (temp___String_Literal_1231 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1231 us_void_param) 5)) 115)) (= (to_rep (select (temp___String_Literal_1231 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1231 us_void_param) 7)) 85)) (= (to_rep (select (temp___String_Literal_1231 us_void_param) 8)) 112)) (= (to_rep (select (temp___String_Literal_1231 us_void_param) 9)) 100)) (= (to_rep (select (temp___String_Literal_1231 us_void_param) 10)) 97)) (= (to_rep (select (temp___String_Literal_1231 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_1231 us_void_param) 12)) 101)) :pattern ((temp___String_Literal_1231 us_void_param)))))
(declare-fun temp___String_Literal_1241 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1241 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 23)) 110)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 25)) 68)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 26)) 105)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 27)) 103)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 28)) 101)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 29)) 115)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 30)) 116)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 31)) 85)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 32)) 112)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 33)) 100)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 34)) 97)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 35)) 116)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 36)) 101)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 38)) 58)) (= (to_rep (select (temp___String_Literal_1241 us_void_param) 39)) 32)) :pattern ((temp___String_Literal_1241 us_void_param)))))
(declare-fun temp___String_Literal_1244 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1244 us_void_param) 1)) 68) (= (to_rep (select (temp___String_Literal_1244 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1244 us_void_param) 3)) 103)) (= (to_rep (select (temp___String_Literal_1244 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1244 us_void_param) 5)) 115)) (= (to_rep (select (temp___String_Literal_1244 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1244 us_void_param) 7)) 70)) (= (to_rep (select (temp___String_Literal_1244 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1244 us_void_param) 9)) 110)) (= (to_rep (select (temp___String_Literal_1244 us_void_param) 10)) 97)) (= (to_rep (select (temp___String_Literal_1244 us_void_param) 11)) 108)) :pattern ((temp___String_Literal_1244 us_void_param)))))
(declare-fun temp___String_Literal_1254 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1254 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 23)) 110)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 25)) 68)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 26)) 105)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 27)) 103)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 28)) 101)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 29)) 115)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 30)) 116)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 31)) 70)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 32)) 105)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 33)) 110)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 34)) 97)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 35)) 108)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 37)) 58)) (= (to_rep (select (temp___String_Literal_1254 us_void_param) 38)) 32)) :pattern ((temp___String_Literal_1254 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_271 Int) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (=> (or (= temp___is_init_268 true) (<= 0 255)) (in_range9 temp___expr_271)))
...
(define-fun dynamic_invariant9 ((temp___expr_217 Int) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool)) Bool (=> (or (= temp___is_init_214 true) (<= 1 150)) (in_range4 temp___expr_217)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_135 Tuple0)))
(assert true)
(assert (= nulldigest (mk___rep1 (mk___split_fields1 (of_rep2 0) (of_rep4 3) (of_rep4 3) (temp___153 0)))))
...
(declare-const c46b (Array Int character))
...
(declare-const temp___1235 us_t2)
(declare-const temp___1237 Int)
(declare-const o26 (Array Int character))
(declare-const temp___1238 us_t2)
(declare-const temp___1239 us_t2)
...
(define-fun result__20 () map__ref (mk_map__ref result__1))
(define-fun c46b5 () map__ref (mk_map__ref c46b))
(define-fun result__21 () map__ref (mk_map__ref result__))
...
(assert (= (mk___rep1 (mk___split_fields1 temp___1260 temp___12601 temp___12602 temp___12603)) nulldigest))
...
(assert (= result3 (mk___split_fields__ref1 (mk___split_fields1 thedigest__split_fields thedigest__split_fields1 thedigest__split_fields2 thedigest__split_fields3))))
...
(assert (=> (= retvalini1 0) (= loopmax2 (+ (div1 (- (to_rep3 (rec__certtypes__rawdatat__datalength (us_split_fields1 rawcertdata))) 1) 100) 1))))
(assert (=> (= retvalini1 0) (= result5 bytesleft13)))
(assert (=> (= retvalini1 0) (= bytesleft2 (to_rep3 (rec__certtypes__rawdatat__datalength (us_split_fields1 rawcertdata))))))
...
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= temp___1214 j2))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= temp___1213 size1))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= temp___1212 retvalupd1))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= temp___1211 block))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= temp___1215 loopmax2))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= temp___1210 bytesleft2))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (and (and (and (and (and (and (and (= loopmax2 (+ (div1 (- (to_rep3 (rec__certtypes__rawdatat__datalength (us_split_fields1 rawcertdata))) 1) 100) 1)) (= loopmax2 temp___1215)) (and (<= 1 j3) (<= j3 loopmax2))) (= bytesleft3 (- (to_rep3 (rec__certtypes__rawdatat__datalength (us_split_fields1 rawcertdata))) (* (- j3 1) 100)))) (and (<= 1 (to_rep3 (rec__certtypes__rawdatat__datalength (us_split_fields1 rawcertdata)))) (<= (to_rep3 (rec__certtypes__rawdatat__datalength (us_split_fields1 rawcertdata))) 4096))) (and (<= 1 size2) (<= size2 100))) (= retvalini1 0)) (= retvalfin1 0)))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (and (and (and (and (=> (<= 1 2147483647) (in_range2 bytesleft3)) (=> (<= 0 28) (in_range8 retvalupd2))) (=> (<= 0 4294967295) (in_range5 size2))) (=> (<= 1 r29b) (dynamic_property1 1 r29b j3))) (and (<= 1 j3) (<= j3 r29b))))))
...
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= o7 (getblock (rec__certtypes__rawdatat__rawdata (us_split_fields1 rawcertdata)) j3 size3)))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= result8 (mk_map__ref block2)))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (= block3 o7))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (in_range8 retvalupd3))))
(assert (=> (= retvalini1 0) (=> (and (<= 1 j2) (<= j2 r29b)) (or (and (and (= bytesleft5 (mk_int__ref bytesleft3)) (= bytesleft6 bytesleft3)) (=> (= retvalupd3 0) (= j3 loopmax2))) (and (not (=> (= retvalupd3 0) (= j3 loopmax2))) (and (and (= bytesleft5 (mk_int__ref bytesleft4)) (= bytesleft6 bytesleft4)) (and (and (and (= o8 (- bytesleft3 100)) (in_range2 (- bytesleft3 100))) (and (= result9 (mk_int__ref bytesleft3)) (= bytesleft4 o8))) (= j3 r29b))))))))
...
(assert (=> (= retvalini1 0) (=> (= (int__content retvalupd6) 0) (in_range8 retvalfin2))))
(assert (=> (= retvalini1 0) (=> (= (int__content retvalupd6) 0) (= retvalfin3 (mk_int__ref retvalfin2)))))
(assert (=> (= retvalini1 0) (=> (= (int__content retvalupd6) 0) (= thedigest__split_fields6 (mk___split_fields__ref1 thedigest__split_fields5)))))
...
(assert (=> (= retvalini1 0) (=> (not (= (int__content retvalupd6) 0)) (= thedigest__split_fields6 (mk___split_fields__ref1 thedigest__split_fields4)))))
...
(assert (=> (not (= retvalini1 0)) (= thedigest__split_fields8 (mk___split_fields__ref1 thedigest__split_fields4))))
...
(assert (=> (= (select issystem retvalini1) true) (= result11 result__21)))
(assert (=> (= (select issystem retvalini1) true) (= result__5 nodescription)))
(assert (=> (= (select issystem retvalini1) true) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b)))))) (= o9 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b)))))) 1)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b))))))) (= o9 0))))
(assert (=> (= (select issystem retvalini1) true) (=> (<= 1 37) (= o10 (+ (- 37 1) 1)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (<= 1 37)) (= o10 0))))
...
(assert (=> (= (select issystem retvalini1) true) (and (= o14 o13) (in_range2 o13))))
(assert (=> (= (select issystem retvalini1) true) (= keystore__digest__B36b__thestring__assume (mk___t (concat1 (temp___String_Literal_1228 Tuple0) 1 37 (elts (to_string (attr__ATTRIBUTE_IMAGE8 c32b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b)))))) (mk 1 o14)))))
(assert (=> (= (select issystem retvalini1) true) (= keystore__digest__B36b__thestring__assume thestring)))
(assert (=> (= (select issystem retvalini1) true) (dynamic_invariant1 thestring true false true)))
(assert (=> (= (select issystem retvalini1) true) (and (= o15 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= (select issystem retvalini1) true) (= result12 (ite (<= o15 150) true false))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= (ite (<= (to_rep1 (first (rt thestring))) (to_rep1 (last (rt thestring)))) (+ (- (to_rep1 (last (rt thestring))) (to_rep1 (first (rt thestring)))) 1) 0) (ite (<= 1 (length thestring)) (+ (- (length thestring) 1) 1) 0)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= temp___1222 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring)))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (and (= temp___1224 (length thestring)) (in_range1 (length thestring))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (=> (<= 1 temp___1224) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1224) (<= temp___1224 150)))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= o16 result__5))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= temp___1225 (mk___t1 o16 (mk1 1 temp___1224))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= (ite (<= (to_rep1 (first2 (rt1 temp___1222))) (to_rep1 (last2 (rt1 temp___1222)))) (+ (- (to_rep1 (last2 (rt1 temp___1222))) (to_rep1 (first2 (rt1 temp___1222)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1225))) (to_rep1 (last2 (rt1 temp___1225)))) (+ (- (to_rep1 (last2 (rt1 temp___1225))) (to_rep1 (first2 (rt1 temp___1225)))) 1) 0)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= temp___1226 temp___1222))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (forall ((temp___1227 Int)) (ite (and (<= 1 temp___1227) (<= temp___1227 (length thestring))) (= (select o17 temp___1227) (select (elts1 temp___1226) temp___1227)) (= (select o17 temp___1227) (select result__5 temp___1227)))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= result13 (mk_map__ref result__5)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= result__6 o17))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= result__8 (mk_map__ref result__6)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= result__9 result__6))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result12 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring))) 1) (<= 1 (to_rep1 (last (rt thestring))))) (and (<= (to_rep1 (first (rt thestring))) 150) (<= 150 (to_rep1 (last (rt thestring))))))))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result12 true)) (= temp___1221 thestring))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result12 true)) (= o18 (elts temp___1221)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result12 true)) (= result14 (mk_map__ref result__5)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result12 true)) (= result__7 o18))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result12 true)) (= result__8 (mk_map__ref result__7)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result12 true)) (= result__9 result__7))))
(assert (=> (= (select issystem retvalini1) true) (= result15 c34b5)))
(assert (=> (= (select issystem retvalini1) true) (= c34b2 (map__content result__8))))
(assert (=> (= (select issystem retvalini1) true) (= (valid_numberlogentries state2) true)))
...
(assert (=> (= (select issystem retvalini1) true) (= result__10 result__8)))
(assert (=> (= (select issystem retvalini1) true) (= c34b3 (mk_map__ref c34b2))))
(assert (=> (= (select issystem retvalini1) true) (= filestate4 filestate2)))
(assert (=> (= (select issystem retvalini1) true) (= state4 state2)))
(assert (=> (= (select issystem retvalini1) true) (= result__11 result__9)))
...
(assert (=> (not (= (select issystem retvalini1) true)) (= result__10 result__21)))
...
(assert (=> (not (= (select issystem retvalini1) true)) (= result__11 result__3)))
(assert (=> (not (= (select issystem retvalini1) true)) (= c34b4 c34b1)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= (int__content retvalupd8) c44b)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (in_range8 c44b)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= result16 result__20)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= result__12 nodescription)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b)))))) (= o19 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b)))))) 1)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b))))))) (= o19 0))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (<= 1 39) (= o20 (+ (- 39 1) 1)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (not (<= 1 39)) (= o20 0))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= o21 (+ o20 o19))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= o22 (+ 1 o21))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= o23 (- o22 1))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (and (= o24 o23) (in_range2 o23))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= keystore__digest__B48b__thestring__assume (mk___t (concat1 (temp___String_Literal_1241 Tuple0) 1 39 (elts (to_string (attr__ATTRIBUTE_IMAGE8 c44b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b)))))) (mk 1 o24)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= keystore__digest__B48b__thestring__assume thestring1)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (dynamic_invariant1 thestring1 true false true)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (and (= o25 (length thestring1)) (in_range1 (length thestring1)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= result17 (ite (<= o25 150) true false))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (= result17 true) (= (ite (<= (to_rep1 (first (rt thestring1))) (to_rep1 (last (rt thestring1)))) (+ (- (to_rep1 (last (rt thestring1))) (to_rep1 (first (rt thestring1)))) 1) 0) (ite (<= 1 (length thestring1)) (+ (- (length thestring1) 1) 1) 0)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (= result17 true) (= temp___1235 (mk___t2 (slide (elts thestring1) (to_rep1 (first (rt thestring1))) 1) (mk2 1 (length thestring1)))))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (= result17 true) (and (= temp___1237 (length thestring1)) (in_range1 (length thestring1))))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (= result17 true) (=> (<= 1 temp___1237) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1237) (<= temp___1237 150)))))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (= result17 true) (= o26 result__12))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (= result17 true) (= temp___1238 (mk___t2 o26 (mk2 1 temp___1237))))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (= result17 true) (= (ite (<= (to_rep1 (first4 (rt2 temp___1235))) (to_rep1 (last4 (rt2 temp___1235)))) (+ (- (to_rep1 (last4 (rt2 temp___1235))) (to_rep1 (first4 (rt2 temp___1235)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1238))) (to_rep1 (last4 (rt2 temp___1238)))) (+ (- (to_rep1 (last4 (rt2 temp___1238))) (to_rep1 (first4 (rt2 temp___1238)))) 1) 0)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (= result17 true) (= temp___1239 temp___1235))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (= result17 true) (forall ((temp___1240 Int)) (ite (and (<= 1 temp___1240) (<= temp___1240 (length thestring1))) (= (select o27 temp___1240) (select (elts2 temp___1239) temp___1240)) (= (select o27 temp___1240) (select result__12 temp___1240)))))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (= result17 true) (= result18 (mk_map__ref result__12)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (= result17 true) (= result__13 o27))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (= result17 true) (= result__15 (mk_map__ref result__13)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (= result17 true) (= result__16 result__13))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (not (= result17 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring1))) 1) (<= 1 (to_rep1 (last (rt thestring1))))) (and (<= (to_rep1 (first (rt thestring1))) 150) (<= 150 (to_rep1 (last (rt thestring1))))))))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (not (= result17 true)) (= temp___1234 thestring1))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (not (= result17 true)) (= o28 (elts temp___1234)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (not (= result17 true)) (= result19 (mk_map__ref result__12)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (not (= result17 true)) (= result__14 o28))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (not (= result17 true)) (= result__15 (mk_map__ref result__14)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (=> (not (= result17 true)) (= result__16 result__14))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= result20 c46b5)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= c46b2 (map__content result__15))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= (valid_numberlogentries state5) true)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= filestate6 (mk___private__ref filestate5))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= state6 (mk___private__ref state5))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= result__17 result__15)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= c46b3 (mk_map__ref c46b2))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= filestate7 filestate5)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= state7 state5)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= result__18 result__16)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= c46b4 c46b2)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= filestate6 filestate3)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= state6 state3)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= result__17 result__20)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= c46b3 c46b5)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= filestate7 filestate4)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= state7 state4)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= result__18 result__4)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= c46b4 c46b1)))
(assert (= (select issystem (int__content retvalfin5)) true))
(assert (= (int__content retvalfin5) c56b))
(assert (in_range8 c56b))
(assert (= result21 (mk_map__ref result__2)))
(assert (= result__19 nodescription))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c56b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c56b)))))) (= o29 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c56b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c56b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c56b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c56b))))))) (= o29 0)))
(assert (=> (<= 1 38) (= o30 (+ (- 38 1) 1))))
(assert (=> (not (<= 1 38)) (= o30 0)))
(assert (= o31 (+ o30 o29)))
(assert (= o32 (+ 1 o31)))
(assert (= o33 (- o32 1)))
(assert (and (= o34 o33) (in_range2 o33)))
(assert (= keystore__digest__B60b__thestring__assume (mk___t (concat1 (temp___String_Literal_1254 Tuple0) 1 38 (elts (to_string (attr__ATTRIBUTE_IMAGE8 c56b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c56b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c56b)))))) (mk 1 o34))))
(assert (= keystore__digest__B60b__thestring__assume thestring2))
(assert (dynamic_invariant1 thestring2 true false true))
(assert (and (= o35 (length thestring2)) (in_range1 (length thestring2))))
(assert (= result22 (ite (<= o35 150) true false)))
(assert (= result22 true))
(assert (= (ite (<= (to_rep1 (first (rt thestring2))) (to_rep1 (last (rt thestring2)))) (+ (- (to_rep1 (last (rt thestring2))) (to_rep1 (first (rt thestring2)))) 1) 0) (ite (<= 1 (length thestring2)) (+ (- (length thestring2) 1) 1) 0)))
(assert (= temp___1248 (mk___t3 (slide (elts thestring2) (to_rep1 (first (rt thestring2))) 1) (mk3 1 (length thestring2)))))
(assert (and (= temp___1250 (length thestring2)) (in_range1 (length thestring2))))
(assert (=> (<= 1 temp___1250) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1250) (<= temp___1250 150)))))
(assert (= o36 result__19))
(assert (= temp___1251 (mk___t3 o36 (mk3 1 temp___1250))))
(assert (not (= (ite (<= (to_rep1 (first6 (rt3 temp___1248))) (to_rep1 (last6 (rt3 temp___1248)))) (+ (- (to_rep1 (last6 (rt3 temp___1248))) (to_rep1 (first6 (rt3 temp___1248)))) 1) 0) (ite (<= (to_rep1 (first6 (rt3 temp___1251))) (to_rep1 (last6 (rt3 temp___1251)))) (+ (- (to_rep1 (last6 (rt3 temp___1251))) (to_rep1 (first6 (rt3 temp___1251)))) 1) 0))))
(check-sat)
(exit)
