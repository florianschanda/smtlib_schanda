...
(define-fun dynamic_invariant9 ((temp___expr_445 Int) (temp___is_init_442 Bool) (temp___skip_constant_443 Bool) (temp___do_toplevel_444 Bool)) Bool (=> (or (= temp___is_init_442 true) (<= 0 4)) (in_range3 temp___expr_445)))
(define-fun dynamic_invariant10 ((temp___expr_389 Int) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (or (= temp___is_init_386 true) (<= 1 3)) (in_range5 temp___expr_389)))
(define-fun dynamic_invariant11 ((temp___expr_395 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 5)) (in_range14 temp___expr_395)))
(define-fun dynamic_invariant12 ((temp___expr_978 Int) (temp___is_init_975 Bool) (temp___skip_constant_976 Bool) (temp___do_toplevel_977 Bool)) Bool (=> (or (= temp___is_init_975 true) (<= 0 40)) (in_range20 temp___expr_978)))
(define-fun dynamic_invariant13 ((temp___expr_999 Int) (temp___is_init_996 Bool) (temp___skip_constant_997 Bool) (temp___do_toplevel_998 Bool)) Bool (=> (or (= temp___is_init_996 true) (<= 0 4294967295)) (in_range22 temp___expr_999)))
(define-fun dynamic_invariant14 ((temp___expr_1021 Int) (temp___is_init_1018 Bool) (temp___skip_constant_1019 Bool) (temp___do_toplevel_1020 Bool)) Bool (=> (or (= temp___is_init_1018 true) (<= 0 10)) (in_range19 temp___expr_1021)))
(define-fun dynamic_invariant15 ((temp___expr_1033 Int) (temp___is_init_1030 Bool) (temp___skip_constant_1031 Bool) (temp___do_toplevel_1032 Bool)) Bool (=> (or (= temp___is_init_1030 true) (<= 0 4294967295)) (in_range24 temp___expr_1033)))
(define-fun dynamic_invariant16 ((temp___expr_1039 Int) (temp___is_init_1036 Bool) (temp___skip_constant_1037 Bool) (temp___do_toplevel_1038 Bool)) Bool (=> (or (= temp___is_init_1036 true) (<= 0 128)) (in_range25 temp___expr_1039)))
(define-fun dynamic_invariant17 ((temp___expr_1163 Int) (temp___is_init_1160 Bool) (temp___skip_constant_1161 Bool) (temp___do_toplevel_1162 Bool)) Bool (=> (or (= temp___is_init_1160 true) (<= 0 17)) (in_range9 temp___expr_1163)))
(define-fun dynamic_invariant18 ((temp___expr_1142 Int) (temp___is_init_1139 Bool) (temp___skip_constant_1140 Bool) (temp___do_toplevel_1141 Bool)) Bool (=> (or (= temp___is_init_1139 true) (<= 1 17)) (in_range7 temp___expr_1142)))
(define-fun dynamic_invariant19 ((temp___expr_1267 Int) (temp___is_init_1264 Bool) (temp___skip_constant_1265 Bool) (temp___do_toplevel_1266 Bool)) Bool (=> (or (= temp___is_init_1264 true) (<= 0 2)) (in_range11 temp___expr_1267)))
(define-fun dynamic_invariant20 ((temp___expr_1148 Int) (temp___is_init_1145 Bool) (temp___skip_constant_1146 Bool) (temp___do_toplevel_1147 Bool)) Bool (=> (or (= temp___is_init_1145 true) (<= 0 17408)) (in_range8 temp___expr_1148)))
(define-fun dynamic_invariant21 ((temp___expr_1182 Int) (temp___is_init_1179 Bool) (temp___skip_constant_1180 Bool) (temp___do_toplevel_1181 Bool)) Bool (=> (or (= temp___is_init_1179 true) (<= 0 1024)) (in_range10 temp___expr_1182)))
(assert true)
...
(define-fun dynamic_invariant22 ((temp___expr_560 Int) (temp___is_init_557 Bool) (temp___skip_constant_558 Bool) (temp___do_toplevel_559 Bool)) Bool (=> (or (= temp___is_init_557 true) (<= 1901 2099)) (in_range15 temp___expr_560)))
(define-fun dynamic_invariant23 ((temp___expr_566 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 1 12)) (in_range16 temp___expr_566)))
(define-fun dynamic_invariant24 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 31)) (in_range17 temp___expr_572)))
(define-fun dynamic_invariant25 ((temp___expr_600 Int) (temp___is_init_597 Bool) (temp___skip_constant_598 Bool) (temp___do_toplevel_599 Bool)) Bool (=> (or (= temp___is_init_597 true) (<= 0 86399999)) (in_range18 temp___expr_600)))
(define-fun dynamic_invariant26 ((temp___expr_1433 Int) (temp___is_init_1430 Bool) (temp___skip_constant_1431 Bool) (temp___do_toplevel_1432 Bool)) Bool (=> (or (= temp___is_init_1430 true) (<= 0 4294967295)) (in_range23 temp___expr_1433)))
