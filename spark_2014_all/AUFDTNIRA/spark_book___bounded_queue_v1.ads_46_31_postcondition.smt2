...
(declare-const o17 t)
(declare-const temp___340 positive)
(declare-const temp___3401 natural)
(declare-const temp___3402 positive)
(declare-const temp___3403 positive)
(declare-const temp___3404 (Array Int element_type))
(declare-const temp___3405 t)
...
(assert (= queue__split_discrs (mk___split_discrs temp___340)))
(assert (= temp___3401 o13))
(assert (= temp___3402 o14))
(assert (= temp___3403 o15))
(assert (= temp___3404 o16))
(assert (= temp___3405 o17))
...
(assert (= queue__split_fields10 (mk___split_fields temp___3401 temp___3402 temp___3403 (mk___t temp___3404 temp___3405))))
(assert (= queue__split_discrs (mk___split_discrs temp___340)))
