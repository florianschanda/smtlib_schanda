...
(assert (not (= (length temp___1931) 0)))
(assert (=> (<= 1 5) (= o78 (+ (- 5 1) 1))))
(assert (=> (not (<= 1 5)) (= o78 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1931))) (to_rep1 (last (rt temp___1931)))) (= o79 (+ (- (to_rep1 (last (rt temp___1931))) (to_rep1 (first (rt temp___1931)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1931))) (to_rep1 (last (rt temp___1931))))) (= o79 0)))
(assert (= o80 (+ o79 o78)))
(assert (= o81 (+ (to_rep1 (first (rt temp___1931))) o80)))
(assert (= o82 (- o81 1)))
