...
(assert (not (= (length temp___1923) 0)))
(assert (=> (<= 1 5) (= o66 (+ (- 5 1) 1))))
(assert (=> (not (<= 1 5)) (= o66 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1923))) (to_rep1 (last (rt temp___1923)))) (= o67 (+ (- (to_rep1 (last (rt temp___1923))) (to_rep1 (first (rt temp___1923)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1923))) (to_rep1 (last (rt temp___1923))))) (= o67 0)))
(assert (= o68 (+ o67 o66)))
(assert (= o69 (+ (to_rep1 (first (rt temp___1923))) o68)))
(assert (= o70 (- o69 1)))
