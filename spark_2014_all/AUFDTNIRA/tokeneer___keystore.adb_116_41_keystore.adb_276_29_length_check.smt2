...
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= o16 result__3))))
...
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (forall ((temp___1227 Int)) (ite (and (<= 1 temp___1227) (<= temp___1227 (length thestring))) (= (select o17 temp___1227) (select (elts1 temp___1226) temp___1227)) (= (select o17 temp___1227) (select result__3 temp___1227)))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= result13 (mk_map__ref result__3)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= result__4 o17))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= result__6 (mk_map__ref result__4)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result12 true) (= result__7 result__4))))
...
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result12 true)) (= result14 (mk_map__ref result__3)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result12 true)) (= result__5 o18))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result12 true)) (= result__6 (mk_map__ref result__5)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result12 true)) (= result__7 result__5))))
(assert (=> (= (select issystem retvalini1) true) (= result15 c34b5)))
(assert (=> (= (select issystem retvalini1) true) (= c34b2 (map__content result__6))))
...
(assert (=> (not (= (select issystem retvalini1) true)) (= result__8 result__11)))
...
(assert (=> (not (= (select issystem retvalini1) true)) (= result__9 result__2)))
...
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b)))))) (= o19 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b))))))) (= o19 0)))
...
(assert (= keystore__digest__B48b__thestring__assume (mk___t (concat1 (temp___String_Literal_1241 Tuple0) 1 39 (elts (to_string (attr__ATTRIBUTE_IMAGE8 c44b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c44b)))))) (mk 1 o24))))
...
(assert (= temp___1235 (mk___t2 (slide (elts thestring1) (to_rep1 (first (rt thestring1))) 1) (mk2 1 (length thestring1)))))
(assert (and (= temp___1237 (length thestring1)) (in_range1 (length thestring1))))
(assert (=> (<= 1 temp___1237) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1237) (<= temp___1237 150)))))
(assert (= o26 result__10))
(assert (= temp___1238 (mk___t2 o26 (mk2 1 temp___1237))))
(assert (not (= (ite (<= (to_rep1 (first4 (rt2 temp___1235))) (to_rep1 (last4 (rt2 temp___1235)))) (+ (- (to_rep1 (last4 (rt2 temp___1235))) (to_rep1 (first4 (rt2 temp___1235)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1238))) (to_rep1 (last4 (rt2 temp___1238)))) (+ (- (to_rep1 (last4 (rt2 temp___1238))) (to_rep1 (first4 (rt2 temp___1238)))) 1) 0))))
(check-sat)
(exit)
