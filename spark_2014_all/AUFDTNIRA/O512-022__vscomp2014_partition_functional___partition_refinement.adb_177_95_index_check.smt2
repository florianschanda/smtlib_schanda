...
(assert (<= 0 k2))
(assert (<= k2 (- (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields5)) 1)))
(assert (and (<= 0 k2) (<= k2 5)))
(assert (= o58 k2))
(assert (= o59 (select f_loop_entry o58)))
(assert (= o60 (to_rep2 o59)))
(assert (not (<= 0 k2)))
(check-sat)
(exit)
