...
(assert (not (<= (* 2 (length1 (mk___rep5 p__split_discrs (us_split_fields__content5 p__split_fields6)))) (capacity (mk___rep5 p__split_discrs (us_split_fields__content5 p__split_fields6))))))
(check-sat)
(exit)
