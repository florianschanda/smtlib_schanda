...
(assert (=> (<= (to_rep b__first) (to_rep b__last)) (= o2 (+ (- (to_rep b__last) (to_rep b__first)) 1))))
(assert (=> (not (<= (to_rep b__first) (to_rep b__last))) (= o2 0)))
(assert (and (= o3 o2) (in_range1 o2)))
(assert (= o4 (ite (<= length1 o3) true false)))
