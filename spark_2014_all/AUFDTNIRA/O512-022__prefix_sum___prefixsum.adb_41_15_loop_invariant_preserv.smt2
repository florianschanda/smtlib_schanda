...
(assert (and (<= 0 right3) (<= right3 7)))
(assert (= o10 right3))
(assert (= o11 (store a2 o10 o9)))
(assert (= a2 result5))
(assert (= a3 o11))
(assert (and (= o12 (* space2 2)) (in_range1 (* space2 2))))
(assert (= o13 (+ left3 o12)))
(assert (and (= o14 o13) (in_range1 o13)))
(assert (and (= o15 o14) (in_range2 o14)))
(assert (= left3 result6))
(assert (= left4 o15))
(assert (< left4 8))
(assert (not (= (all_left_elements_in a3 left4 (* (* space2 2) 1000000)) true)))
(check-sat)
(exit)
