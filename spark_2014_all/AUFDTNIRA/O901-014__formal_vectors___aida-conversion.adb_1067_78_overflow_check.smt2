...
(assert (forall ((temp___1741 Int) (temp___1742 Int) (temp___1743 Int)) (let ((temp___1740 (aida__conversion__calculate_positive_target_length_2__n__aggregate_def temp___1741 temp___1742 temp___1743))) (and (=> (dynamic_property6 (first1 source) (+ (first1 source) 1) temp___1742 temp___1743) (and (= (first5 temp___1740) temp___1742) (= (last5 temp___1740) temp___1743))) (forall ((temp___1744 Int)) (= (select (to_array2 temp___1740) temp___1744) (of_rep1 temp___1741)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_473 us_t1) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool)) Bool (=> (not (= temp___skip_constant_471 true)) (and (dynamic_property2 (first1 source) (+ (first1 source) 1) (first3 temp___expr_473) (last3 temp___expr_473)) (and (= (first3 temp___expr_473) (first1 source)) (= (last3 temp___expr_473) (+ (first1 source) 1))))))
...
(declare-const temp___1746 (Array Int integer))
(declare-const temp___17461 t2)
...
(declare-const temp___1753 Int)
(declare-const temp___1751 Int)
(declare-const temp___1749 (Array Int integer))
(declare-const o Int)
...
(assert (and (= (length source) 2) (forall ((index13 Int)) (=> (and (<= (to_rep1 (first (rt source))) index13) (<= index13 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index13))) true)))))
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_length_2__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_length_2__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1))))) (+ (to_rep1 (first (rt source))) 1)) (= (mk___t2 temp___1746 temp___17461) (aida__conversion__calculate_positive_target_length_2__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1))))) (and (= (ite (<= (to_rep1 (first4 temp___17461)) (to_rep1 (last4 temp___17461))) (+ (- (to_rep1 (last4 temp___17461)) (to_rep1 (first4 temp___17461))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1)) (+ (- (+ (to_rep1 (first (rt source))) 1) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1746 (to_rep1 (first4 temp___17461)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_length_2__n__assume) (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_positive_target_length_2__n__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_positive_target_length_2__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_length_2__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_length_2__n__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 1)))) (and (and (and (= temp___1753 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (= (mk_int__ref result1) (mk_int__ref index)) (= index2 (to_rep1 (first (rt source))))) (ite (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1753)) (and (and (and (= temp___1751 index2) (and (= temp___1749 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o index2)) (= o1 (select n1 o))) (= o2 (to_rep1 o1))) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o3 index2)) (= o4 (select (elts source) o3))) (= o5 (to_rep o4))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o7 index2)) (= o8 (store n1 o7 o6)))) (and (= n1 result2) (= n2 o8))))) (and (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (= (to_rep1 (select n3 j1)) (convert_character_digit_to_integer (to_rep (select (elts source) j1)))))) (and (and (and (forall ((temp___1750 Int)) (=> (and (<= (to_rep1 n__first) temp___1750) (<= temp___1750 (to_rep1 n__last))) (=> (< index3 temp___1750) (= (select n3 temp___1750) (select temp___1749 temp___1750))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 1)))) (= index3 temp___1753)))))) (and (and (= index3 index7) (= n3 n7)) (and (= index8 index3) (= n8 n3)))) (and (and (= (mk_int__ref index9) (mk_int__ref index7)) (= (mk_map__ref1 n9) (mk_map__ref1 n7))) (and (= index10 index8) (= n10 n8)))) (and (and (= index2 index9) (= n1 n9)) (and (= index10 index2) (= n10 n1)))))) (and (and (and (and (and (and (= temp___1754 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (<= (to_rep1 n__first) temp___1754) (<= temp___1754 (to_rep1 n__last))) (= o22 temp___1754))) (= o23 (select n9 o22))) (= o24 (to_rep1 o23))) (and (= (mk_int__ref result5) (mk_int__ref target)) (= target1 o24))) (and (<= target1 9) (and (and (and (and (and (and (and (and (and (and (= temp___1755 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))) (and (and (<= (to_rep1 n__first) temp___1755) (<= temp___1755 (to_rep1 n__last))) (= o25 temp___1755))) (= o26 (select n9 o25))) (= o27 (to_rep1 o26))) (= o28 (* o27 10))) (and (= o29 o28) (in_range1 o28))) (= o30 (+ target1 o29))) (and (= o31 o30) (in_range1 o30))) (and (= target1 result6) (= target2 o31))) (and (<= target2 99) (and (= result7 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0)))))))))) (and (and (= index11 (mk_int__ref index9)) (and (= n11 (mk_map__ref1 n9)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target3 (mk_int__ref target2))))) (and (= index12 index10) (and (= n12 n10) (and (= has_failed3 has_failed1) (= target4 target2)))))))
(assert (and (= temp___1757 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1757) (<= temp___1757 (to_rep1 (last (rt source))))))
(assert (= o37 temp___1757))
(assert (= o38 (select (elts source) o37)))
(assert (= o39 (to_rep o38)))
(assert (and (= o40 (convert_character_digit_to_integer o39)) (and (in_range1 o40) (and (and (<= 0 o40) (<= o40 9)) (ite (= (= o39 48) true) (= o40 0) (ite (= (= o39 49) true) (= o40 1) (ite (= (= o39 50) true) (= o40 2) (ite (= (= o39 51) true) (= o40 3) (ite (= (= o39 52) true) (= o40 4) (ite (= (= o39 53) true) (= o40 5) (ite (= (= o39 54) true) (= o40 6) (ite (= (= o39 55) true) (= o40 7) (ite (= (= o39 56) true) (= o40 8) (=> (= (= o39 57) true) (= o40 9)))))))))))))))
(assert (and (= temp___1756 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1756) (<= temp___1756 (to_rep1 (last (rt source))))))
(assert (= o32 temp___1756))
(assert (= o33 (select (elts source) o32)))
(assert (= o34 (to_rep o33)))
(assert (and (= o35 (convert_character_digit_to_integer o34)) (and (in_range1 o35) (and (and (<= 0 o35) (<= o35 9)) (ite (= (= o34 48) true) (= o35 0) (ite (= (= o34 49) true) (= o35 1) (ite (= (= o34 50) true) (= o35 2) (ite (= (= o34 51) true) (= o35 3) (ite (= (= o34 52) true) (= o35 4) (ite (= (= o34 53) true) (= o35 5) (ite (= (= o34 54) true) (= o35 6) (ite (= (= o34 55) true) (= o35 7) (ite (= (= o34 56) true) (= o35 8) (=> (= (= o34 57) true) (= o35 9)))))))))))))))
(assert (= o36 (* o35 10)))
