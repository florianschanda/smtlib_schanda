...
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields5)) k10))
(assert (<= k10 (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields5))))
(assert (and (<= 0 k10) (<= k10 5)))
(assert (= o106 k10))
(assert (= o107 (select (map__content f8) o106)))
(assert (= o108 (to_rep2 o107)))
(assert (and (= o109 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o108)) (= (bool_eq o109 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o108)) true)))
(assert (= o110 (us_split_fields1 o109)))
(assert (= o111 (rec__partition_refinement__interval__last o110)))
(assert (= o112 (to_rep1 o111)))
(assert (= o113 (ite (<= k10 o112) true false)))
(assert (and (<= 0 k10) (<= k10 5)))
(assert (= o102 k10))
(assert (= o103 (select (map__content f8) o102)))
(assert (= o104 (to_rep2 o103)))
(assert (not (<= 0 o104)))
(check-sat)
(exit)
