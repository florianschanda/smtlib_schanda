...
(declare-const o18 partition_index)
...
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields1)) k))
(assert (<= k (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields1))))
(assert (and (<= 0 k) (<= k 5)))
(assert (= o17 k))
(assert (= o18 (select (map__content f6) o17)))
(assert (= o19 (to_rep2 o18)))
(assert (and (= o20 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o19)) (= (bool_eq o20 (get (model__ (mk___rep1 p__split_discrs p__split_fields3)) o19)) true)))
(assert (= o21 (us_split_fields1 o20)))
(assert (= o22 (rec__partition_refinement__interval__last o21)))
(assert (= o23 (to_rep1 o22)))
(assert (= o24 (ite (<= k o23) true false)))
(assert (and (<= 0 k) (<= k 5)))
(assert (= o14 k))
