...
(assert (and (= a__split_discrs (mk___split_discrs temp___981)) (and (= a__split_fields temp___9811) (= a__split_fields1 temp___9812))))
(assert (and (and (and (dynamic_invariant2 (mk___rep a__split_discrs a__split_fields13) true true true) (= (rec__simple_unc_arrays__table__last a__split_discrs) temp___981)) (=> (<= 0 2147483647) (in_range2 right2))) (=> (<= 0 2147483647) (in_range2 left2))))
...
(assert (=> (< first4 (int__content right13)) (dynamic_invariant2 (mk___rep a__split_discrs a__split_fields10) true true true)))
