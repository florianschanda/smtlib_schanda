...
(declare-const temp___1060 natural)
(declare-const temp___10601 (Array Int value))
(declare-const temp___10602 t1)
...
(define-fun a__split_fields13 () us_split_fields (mk___split_fields (mk___t1 a__split_fields2 a__split_fields3)))
...
(assert (= right1 last4))
(assert (= temp___1063 left1))
(assert (= temp___1062 right1))
(assert (and (= a__split_discrs (mk___split_discrs temp___1060)) (and (= a__split_fields temp___10601) (= a__split_fields1 temp___10602))))
(assert (and (and (and (dynamic_invariant2 (mk___rep a__split_discrs a__split_fields13) true true true true) (= (rec__simple_unc_arrays__table__last a__split_discrs) temp___1060)) (=> (<= 0 2147483647) (in_range2 right2))) (=> (<= 0 2147483647) (in_range2 left2))))
...
(assert (=> (< first4 (int__content right13)) (dynamic_invariant2 (mk___rep a__split_discrs a__split_fields10) true true true true)))
