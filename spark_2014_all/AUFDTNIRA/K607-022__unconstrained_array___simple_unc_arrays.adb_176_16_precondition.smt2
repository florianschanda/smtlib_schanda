...
(assert (= right1 last4))
(assert (= temp___978 left1))
(assert (= temp___977 right1))
(assert (and (= a__split_discrs (mk___split_discrs temp___975)) (and (= a__split_fields temp___9751) (= a__split_fields1 temp___9752))))
(assert (and (and (and (dynamic_invariant2 (mk___rep a__split_discrs (mk___split_fields (mk___t1 a__split_fields2 a__split_fields3))) true true true) (= (rec__simple_unc_arrays__table__last a__split_discrs) temp___975)) (=> (<= 0 2147483647) (in_range2 right2))) (=> (<= 0 2147483647) (in_range2 left2))))
...
(assert (= a__split_fields5 (mk___split_fields__ref (mk___split_fields (mk___t1 a__split_fields2 a__split_fields3)))))
(assert (= rho1 rho))
(assert (= left11 left8))
(assert (= right10 right8))
(assert (= a__split_fields6 (mk___split_fields (mk___t1 a__split_fields2 a__split_fields3))))
...
(assert (=> (< first4 (int__content right13)) (and (= o29 (- (int__content right13) 1)) (in_range2 (- (int__content right13) 1)))))
(assert (=> (< first4 (int__content right13)) (dynamic_invariant2 (mk___rep a__split_discrs a__split_fields11) true true true)))
(assert (=> (< first4 (int__content right13)) (= a__split_fields12 (mk___split_fields__ref a__split_fields11))))
(assert (=> (< first4 (int__content right13)) (= a__split_fields13 a__split_fields11)))
(assert (=> (not (< first4 (int__content right13))) (= a__split_fields12 a__split_fields9)))
(assert (=> (not (< first4 (int__content right13))) (= a__split_fields13 a__split_fields10)))
(assert (< (int__content left14) last4))
(assert (not (or (= last4 0) (<= (int__content left14) last4))))
(check-sat)
(exit)
