...
(declare-const temp___1053 natural)
(declare-const temp___10531 (Array Int value))
(declare-const temp___10532 t)
...
(define-fun a__split_fields13 () us_split_fields (mk___split_fields (mk___t a__split_fields2 a__split_fields3)))
...
(assert (= right1 last4))
(assert (= temp___1056 left1))
(assert (= temp___1055 right1))
(assert (and (= a__split_discrs (mk___split_discrs temp___1053)) (and (= a__split_fields temp___10531) (= a__split_fields1 temp___10532))))
(assert (and (and (and (dynamic_invariant1 (mk___rep a__split_discrs a__split_fields13) true true true true) (= (rec__simple_unc_arrays__table__last a__split_discrs) temp___1053)) (=> (<= 0 2147483647) (in_range2 right2))) (=> (<= 0 2147483647) (in_range2 left2))))
...
(assert (=> (< first4 (int__content right13)) (and (= o23 (- (int__content right13) 1)) (in_range2 (- (int__content right13) 1)))))
(assert (=> (< first4 (int__content right13)) (dynamic_invariant1 (mk___rep a__split_discrs a__split_fields10) true true true true)))
(assert (=> (< first4 (int__content right13)) (= a__split_fields11 (mk___split_fields__ref a__split_fields10))))
(assert (=> (< first4 (int__content right13)) (= a__split_fields12 a__split_fields10)))
(assert (=> (not (< first4 (int__content right13))) (= a__split_fields11 a__split_fields8)))
(assert (=> (not (< first4 (int__content right13))) (= a__split_fields12 a__split_fields9)))
(assert (< (int__content left13) last4))
(assert (not (or (= last4 0) (<= (int__content left13) last4))))
(check-sat)
(exit)
