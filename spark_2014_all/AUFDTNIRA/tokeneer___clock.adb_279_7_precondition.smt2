...
(define-fun dynamic_invariant ((temp___expr_337 Int) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool)) Bool (=> (or (= temp___is_init_334 true) (<= 1 21)) (in_range7 temp___expr_337)))
...
(declare-fun temp___String_Literal_389 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_389 us_void_param) 1)) 121) (= (to_rep (select (temp___String_Literal_389 us_void_param) 2)) 121)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 4)) 121)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 5)) 45)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 6)) 109)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 7)) 109)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 8)) 45)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 9)) 100)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 10)) 100)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 12)) 104)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 13)) 104)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 14)) 58)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 15)) 109)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 16)) 109)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 17)) 58)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 18)) 115)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 19)) 115)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 20)) 46)) (= (to_rep (select (temp___String_Literal_389 us_void_param) 21)) 115)) :pattern ((temp___String_Literal_389 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_285 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 1901 2099)) (in_range3 temp___expr_285)))
(define-fun dynamic_invariant6 ((temp___expr_291 Int) (temp___is_init_288 Bool) (temp___skip_constant_289 Bool) (temp___do_toplevel_290 Bool)) Bool (=> (or (= temp___is_init_288 true) (<= 1 12)) (in_range4 temp___expr_291)))
(define-fun dynamic_invariant7 ((temp___expr_297 Int) (temp___is_init_294 Bool) (temp___skip_constant_295 Bool) (temp___do_toplevel_296 Bool)) Bool (=> (or (= temp___is_init_294 true) (<= 1 31)) (in_range5 temp___expr_297)))
(define-fun dynamic_invariant8 ((temp___expr_321 Int) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool)) Bool (=> (or (= temp___is_init_318 true) (<= 0 86399999)) (in_range6 temp___expr_321)))
...
(assert (= localtext1 (temp___String_Literal_389 Tuple0)))
