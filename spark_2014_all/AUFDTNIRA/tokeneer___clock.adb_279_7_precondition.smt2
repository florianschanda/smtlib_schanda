...
(define-fun dynamic_invariant ((temp___expr_381 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= 1 21)) (in_range7 temp___expr_381)))
...
(declare-fun temp___String_Literal_436 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_436 us_void_param) 1)) 121) (= (to_rep (select (temp___String_Literal_436 us_void_param) 2)) 121)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 4)) 121)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 5)) 45)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 6)) 109)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 7)) 109)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 8)) 45)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 9)) 100)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 10)) 100)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 12)) 104)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 13)) 104)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 14)) 58)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 15)) 109)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 16)) 109)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 17)) 58)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 18)) 115)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 19)) 115)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 20)) 46)) (= (to_rep (select (temp___String_Literal_436 us_void_param) 21)) 115)) :pattern ((temp___String_Literal_436 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_325 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 1901 2099)) (in_range3 temp___expr_325)))
(define-fun dynamic_invariant6 ((temp___expr_331 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 1 12)) (in_range4 temp___expr_331)))
(define-fun dynamic_invariant7 ((temp___expr_337 Int) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool)) Bool (=> (or (= temp___is_init_334 true) (<= 1 31)) (in_range5 temp___expr_337)))
(define-fun dynamic_invariant8 ((temp___expr_365 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= 0 86399999)) (in_range6 temp___expr_365)))
...
(declare-const clock__setstringsegment__s5 (Array Int character))
(declare-const result6 (Array Int character))
(declare-const localtext7 (Array Int character))
(assert (= result localtext))
(assert (= localtext1 (temp___String_Literal_436 Tuple0)))
