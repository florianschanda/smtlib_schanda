...
(declare-fun temp___1064 (Int) (Array Int logfileindext))
(assert (forall ((temp___1066 Int)) (forall ((temp___1067 Int)) (= (select (temp___1064 temp___1066) temp___1067) (of_rep2 temp___1066)))))
(declare-fun temp___1068 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1070 Int)) (forall ((temp___1071 Int)) (= (select (temp___1068 temp___1070) temp___1071) (of_rep5 temp___1070)))))
(define-fun dynamic_invariant1 ((temp___expr_1058 us_rep1) (temp___is_init_1055 Bool) (temp___skip_constant_1056 Bool) (temp___do_toplevel_1057 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1058))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1058))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1058)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1058))) true))
(define-fun default_initial_assumption ((temp___expr_1062 us_rep1) (temp___skip_top_level_1063 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1062))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1062))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1062)) (mk___rep (mk___split_fields (temp___1064 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1062)) (temp___1068 0))))
(define-fun type_invariant ((temp___1072 us_rep1)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1072))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1072))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1072)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1072))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_1224 Int) (temp___is_init_1221 Bool) (temp___skip_constant_1222 Bool) (temp___do_toplevel_1223 Bool)) Bool (=> (or (= temp___is_init_1221 true) (<= 0 7)) (in_range10 temp___expr_1224)))
...
(assert (forall ((a (Array Int us_rep4)) (b (Array Int us_rep4))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq12 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_165 Int)) (=> (and (<= a__first temp___idx_165) (<= temp___idx_165 a__last)) (= (bool_eq10 (select a temp___idx_165) (select b (+ (- b__first a__first) temp___idx_165))) true))))))))
...
(declare-fun temp___1406 (Int) (Array Int character))
(assert (forall ((temp___1408 Int)) (forall ((temp___1409 Int)) (= (select (temp___1406 temp___1408) temp___1409) (of_rep temp___1408)))))
...
(assert (= msgtostrings (display__msgtostrings__aggregate_def (mk___rep3 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (temp___String_Literal_176 Tuple0) (of_rep7 22))) blankline)) (mk___rep3 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (temp___String_Literal_177 Tuple0) (of_rep7 14))) (mk___rep2 (mk___split_fields2 (temp___String_Literal_178 Tuple0) (of_rep7 11))))) (mk___rep3 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (temp___String_Literal_179 Tuple0) (of_rep7 19))) (mk___rep2 (mk___split_fields2 (temp___String_Literal_180 Tuple0) (of_rep7 13))))) (mk___rep3 (mk___split_fields3 blankline (mk___rep2 (mk___split_fields2 (temp___String_Literal_181 Tuple0) (of_rep7 22))))) (mk___rep3 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (temp___String_Literal_182 Tuple0) (of_rep7 19))) (mk___rep2 (mk___split_fields2 (temp___String_Literal_183 Tuple0) (of_rep7 11))))) (mk___rep3 (mk___split_fields3 (mk___rep2 (mk___split_fields2 (temp___String_Literal_184 Tuple0) (of_rep7 12))) (mk___rep2 (mk___split_fields2 (temp___String_Literal_185 Tuple0) (of_rep7 12))))) (mk___rep3 (mk___split_fields3 blankline (mk___rep2 (mk___split_fields2 (temp___String_Literal_186 Tuple0) (of_rep7 19))))) (mk___rep3 (mk___split_fields3 blankline (mk___rep2 (mk___split_fields2 (temp___String_Literal_187 Tuple0) (of_rep7 13))))))))
(define-fun dynamic_invariant7 ((temp___expr_1230 Int) (temp___is_init_1227 Bool) (temp___skip_constant_1228 Bool) (temp___do_toplevel_1229 Bool)) Bool (=> (or (= temp___is_init_1227 true) (<= 0 23)) (in_range11 temp___expr_1230)))
...
(assert (= blankline (mk___rep2 (mk___split_fields2 (temp___String_Literal_164 Tuple0) (of_rep7 0)))))
(define-fun dynamic_invariant8 ((temp___expr_1280 Int) (temp___is_init_1277 Bool) (temp___skip_constant_1278 Bool) (temp___do_toplevel_1279 Bool)) Bool (=> (or (= temp___is_init_1277 true) (<= 0 50)) (in_range12 temp___expr_1280)))
(define-fun dynamic_invariant9 ((temp___expr_1286 Int) (temp___is_init_1283 Bool) (temp___skip_constant_1284 Bool) (temp___do_toplevel_1285 Bool)) Bool (=> (or (= temp___is_init_1283 true) (<= 1 50)) (in_range13 temp___expr_1286)))
(define-fun dynamic_invariant10 ((temp___expr_1024 Int) (temp___is_init_1021 Bool) (temp___skip_constant_1022 Bool) (temp___do_toplevel_1023 Bool)) Bool (=> (or (= temp___is_init_1021 true) (<= 0 17)) (in_range7 temp___expr_1024)))
(define-fun dynamic_invariant11 ((temp___expr_1003 Int) (temp___is_init_1000 Bool) (temp___skip_constant_1001 Bool) (temp___do_toplevel_1002 Bool)) Bool (=> (or (= temp___is_init_1000 true) (<= 1 17)) (in_range5 temp___expr_1003)))
(define-fun dynamic_invariant12 ((temp___expr_1128 Int) (temp___is_init_1125 Bool) (temp___skip_constant_1126 Bool) (temp___do_toplevel_1127 Bool)) Bool (=> (or (= temp___is_init_1125 true) (<= 0 2)) (in_range9 temp___expr_1128)))
(define-fun dynamic_invariant13 ((temp___expr_1009 Int) (temp___is_init_1006 Bool) (temp___skip_constant_1007 Bool) (temp___do_toplevel_1008 Bool)) Bool (=> (or (= temp___is_init_1006 true) (<= 0 17408)) (in_range6 temp___expr_1009)))
(define-fun dynamic_invariant14 ((temp___expr_1043 Int) (temp___is_init_1040 Bool) (temp___skip_constant_1041 Bool) (temp___do_toplevel_1042 Bool)) Bool (=> (or (= temp___is_init_1040 true) (<= 0 1024)) (in_range8 temp___expr_1043)))
(assert true)
...
(declare-const c28b__split_fields (Array Int character))
(declare-const c28b__split_fields1 scrolltextcount)
...
(declare-const temp___1418 (Array Int us_rep4))
...
(assert (= temp___1418 (display__msgtostrings__aggregate_def o56 o55 o54 o53 o52 o51 o50 o49)))
(assert (= temp___1418 msgtostrings))
...
(assert (= o58 (mk___split_fields4 (temp___1406 32) o57)))
...
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))))) (and (and (= temp___1372 i2) (and (= temp___1370 (mk___rep4 result____split_fields2)) (and (= temp___1373 c27b) (and (and (and (<= 1 i3) (<= i3 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))))) (= (bool_eq10 c27b temp___1373) true)) (and (and (and (and (forall ((temp___1371 Int)) (=> (and (<= 1 temp___1371) (<= temp___1371 50)) (=> (<= i3 temp___1371) (= (select (rec__display__scrollstrt__text result____split_fields3) temp___1371) (select (rec__display__scrollstrt__text (us_split_fields9 temp___1370)) temp___1371))))) (= (rec__display__scrollstrt__len result____split_fields3) (rec__display__scrollstrt__len (us_split_fields9 temp___1370)))) (=> (<= 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))) (dynamic_property1 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))) i3))) (and (<= 1 i3) (<= i3 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))))) (and (and (and (and (and (= (to_rep o59) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))) i3))) (= o60 (store (rec__display__scrollstrt__text result____split_fields3) i3 o59))) (= o61 (mk___split_fields4 o60 (rec__display__scrollstrt__len result____split_fields3)))) (= temp___1369 (mk___rep4 o61))) (and (= result2 (mk___split_fields__ref4 result____split_fields3)) (= result____split_fields4 (us_split_fields9 temp___1369)))) (= i3 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))))))))) (and (and (= i7 (mk_int__ref i3)) (= result____split_fields7 (mk___split_fields__ref4 result____split_fields4))) (and (= i8 i3) (= result____split_fields8 result____split_fields4))))))
(assert (=> (and (<= 1 i2) (<= i2 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))))) (= i9 i7)))
(assert (=> (and (<= 1 i2) (<= i2 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))))) (= result____split_fields9 result____split_fields7)))
(assert (=> (and (<= 1 i2) (<= i2 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))))) (= i10 i8)))
(assert (=> (and (<= 1 i2) (<= i2 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))))) (= result____split_fields10 result____split_fields8)))
(assert (=> (not (and (<= 1 i2) (<= i2 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))))) (= i9 (mk_int__ref i2))))
(assert (=> (not (and (<= 1 i2) (<= i2 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))))) (= result____split_fields9 (mk___split_fields__ref4 result____split_fields2))))
(assert (=> (not (and (<= 1 i2) (<= i2 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))))) (= i10 i2)))
(assert (=> (not (and (<= 1 i2) (<= i2 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))))) (= result____split_fields10 result____split_fields2)))
(assert (= (to_rep8 o62) (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))))
(assert (= o63 (mk___split_fields4 (rec__display__scrollstrt__text (us_split_fields__content4 result____split_fields9)) o62)))
(assert (= temp___1377 (mk___rep4 o63)))
(assert (= result4 result____split_fields9))
(assert (= result____split_fields11 (us_split_fields9 temp___1377)))
(assert (= (to_rep o64) 32))
(assert (and (<= 1 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields11)) 1)) (<= (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields11)) 1) 50)))
(assert (= o65 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields11)) 1)))
(assert (= o66 (store (rec__display__scrollstrt__text result____split_fields11) o65 o64)))
(assert (= o67 (mk___split_fields4 o66 (rec__display__scrollstrt__len result____split_fields11))))
(assert (= temp___1381 (mk___rep4 o67)))
(assert (= result5 (mk___split_fields__ref4 result____split_fields11)))
(assert (= result____split_fields12 (us_split_fields9 temp___1381)))
(assert (= (to_rep o68) 47))
(assert (and (<= 1 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields12)) 2)) (<= (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields12)) 2) 50)))
(assert (= o69 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields12)) 2)))
(assert (= o70 (store (rec__display__scrollstrt__text result____split_fields12) o69 o68)))
(assert (= o71 (mk___split_fields4 o70 (rec__display__scrollstrt__len result____split_fields12))))
(assert (= temp___1385 (mk___rep4 o71)))
(assert (= result6 (mk___split_fields__ref4 result____split_fields12)))
(assert (= result____split_fields13 (us_split_fields9 temp___1385)))
(assert (= (to_rep o72) 32))
(assert (and (<= 1 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields13)) 3)) (<= (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields13)) 3) 50)))
(assert (= o73 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields13)) 3)))
(assert (= o74 (store (rec__display__scrollstrt__text result____split_fields13) o73 o72)))
(assert (= o75 (mk___split_fields4 o74 (rec__display__scrollstrt__len result____split_fields13))))
(assert (= temp___1389 (mk___rep4 o75)))
(assert (= result7 (mk___split_fields__ref4 result____split_fields13)))
(assert (= result____split_fields14 (us_split_fields9 temp___1389)))
(assert (and (= o76 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields14)) 3)) (in_range12 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields14)) 3))))
(assert (= (to_rep8 o77) o76))
(assert (= o78 (mk___split_fields4 (rec__display__scrollstrt__text result____split_fields14) o77)))
(assert (= temp___1391 (mk___rep4 o78)))
(assert (= result8 (mk___split_fields__ref4 result____split_fields14)))
(assert (= result____split_fields15 (us_split_fields9 temp___1391)))
(assert (= result9 (mk_int__ref i1)))
(assert (= i11 1))
(assert (<= 1 i11))
(assert (<= i11 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))))
(assert (not (<= 1 i11)))
(check-sat)
(exit)
