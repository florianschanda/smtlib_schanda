...
(assert (forall ((temp___1122 Int)) (forall ((temp___1123 Int)) (= (select (temp___1120 temp___1122) temp___1123) (of_rep2 temp___1122)))))
(declare-fun temp___1124 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1126 Int)) (forall ((temp___1127 Int)) (= (select (temp___1124 temp___1126) temp___1127) (of_rep5 temp___1126)))))
(define-fun dynamic_invariant1 ((temp___expr_1114 us_rep1) (temp___is_init_1111 Bool) (temp___skip_constant_1112 Bool) (temp___do_toplevel_1113 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1114))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1114))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1114)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1114))) true))
(define-fun default_initial_assumption ((temp___expr_1118 us_rep1) (temp___skip_top_level_1119 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1118))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1118))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1118)) (mk___rep (mk___split_fields (temp___1120 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1118)) (temp___1124 0))))
(define-fun type_invariant ((temp___1128 us_rep1)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1128))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1128))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1128)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1128))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_1280 Int) (temp___is_init_1277 Bool) (temp___skip_constant_1278 Bool) (temp___do_toplevel_1279 Bool)) Bool (=> (or (= temp___is_init_1277 true) (<= 0 7)) (in_range10 temp___expr_1280)))
...
(declare-fun temp___1462 (Int) (Array Int character))
(assert (forall ((temp___1464 Int)) (forall ((temp___1465 Int)) (= (select (temp___1462 temp___1464) temp___1465) (of_rep temp___1464)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1286 Int) (temp___is_init_1283 Bool) (temp___skip_constant_1284 Bool) (temp___do_toplevel_1285 Bool)) Bool (=> (or (= temp___is_init_1283 true) (<= 0 23)) (in_range11 temp___expr_1286)))
...
(define-fun dynamic_invariant8 ((temp___expr_1336 Int) (temp___is_init_1333 Bool) (temp___skip_constant_1334 Bool) (temp___do_toplevel_1335 Bool)) Bool (=> (or (= temp___is_init_1333 true) (<= 0 50)) (in_range12 temp___expr_1336)))
(define-fun dynamic_invariant9 ((temp___expr_1342 Int) (temp___is_init_1339 Bool) (temp___skip_constant_1340 Bool) (temp___do_toplevel_1341 Bool)) Bool (=> (or (= temp___is_init_1339 true) (<= 1 50)) (in_range13 temp___expr_1342)))
(define-fun dynamic_invariant10 ((temp___expr_1080 Int) (temp___is_init_1077 Bool) (temp___skip_constant_1078 Bool) (temp___do_toplevel_1079 Bool)) Bool (=> (or (= temp___is_init_1077 true) (<= 0 17)) (in_range7 temp___expr_1080)))
(define-fun dynamic_invariant11 ((temp___expr_1059 Int) (temp___is_init_1056 Bool) (temp___skip_constant_1057 Bool) (temp___do_toplevel_1058 Bool)) Bool (=> (or (= temp___is_init_1056 true) (<= 1 17)) (in_range5 temp___expr_1059)))
(define-fun dynamic_invariant12 ((temp___expr_1184 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 0 2)) (in_range9 temp___expr_1184)))
(define-fun dynamic_invariant13 ((temp___expr_1065 Int) (temp___is_init_1062 Bool) (temp___skip_constant_1063 Bool) (temp___do_toplevel_1064 Bool)) Bool (=> (or (= temp___is_init_1062 true) (<= 0 17408)) (in_range6 temp___expr_1065)))
(define-fun dynamic_invariant14 ((temp___expr_1099 Int) (temp___is_init_1096 Bool) (temp___skip_constant_1097 Bool) (temp___do_toplevel_1098 Bool)) Bool (=> (or (= temp___is_init_1096 true) (<= 0 1024)) (in_range8 temp___expr_1099)))
(assert true)
...
(declare-const temp___1474 (Array Int us_rep4))
...
(assert (= temp___1474 (display__msgtostrings__aggregate_def o56 o55 o54 o53 o52 o51 o50 o49)))
(assert (= temp___1474 msgtostrings))
...
(assert (= o58 (mk___split_fields4 (temp___1462 32) o57)))
...
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))))) (and (and (= temp___1428 i2) (and (= temp___1426 (mk___rep4 result____split_fields2)) (and (= temp___1429 c27b) (and (and (and (<= 1 i3) (<= i3 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))))) (= (bool_eq10 c27b temp___1429) true)) (and (and (and (and (forall ((temp___1427 Int)) (=> (and (<= 1 temp___1427) (<= temp___1427 50)) (=> (<= i3 temp___1427) (= (select (rec__display__scrollstrt__text result____split_fields3) temp___1427) (select (rec__display__scrollstrt__text (us_split_fields9 temp___1426)) temp___1427))))) (= (rec__display__scrollstrt__len result____split_fields3) (rec__display__scrollstrt__len (us_split_fields9 temp___1426)))) (=> (<= 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))) (dynamic_property1 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))) i3))) (and (<= 1 i3) (<= i3 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))))) (and (and (and (and (and (= (to_rep o59) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))) i3))) (= o60 (store (rec__display__scrollstrt__text result____split_fields3) i3 o59))) (= o61 (mk___split_fields4 o60 (rec__display__scrollstrt__len result____split_fields3)))) (= temp___1425 (mk___rep4 o61))) (and (= result2 (mk___split_fields__ref4 result____split_fields3)) (= result____split_fields4 (us_split_fields9 temp___1425)))) (= i3 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))))))))) (and (and (= i7 (mk_int__ref i3)) (= result____split_fields7 (mk___split_fields__ref4 result____split_fields4))) (and (= i8 i3) (= result____split_fields8 result____split_fields4))))))
...
(assert (= temp___1433 (mk___rep4 o63)))
(assert (= result4 result____split_fields9))
(assert (= result____split_fields11 (us_split_fields9 temp___1433)))
...
(assert (= temp___1437 (mk___rep4 o67)))
(assert (= result5 (mk___split_fields__ref4 result____split_fields11)))
(assert (= result____split_fields12 (us_split_fields9 temp___1437)))
...
(assert (= temp___1441 (mk___rep4 o71)))
(assert (= result6 (mk___split_fields__ref4 result____split_fields12)))
(assert (= result____split_fields13 (us_split_fields9 temp___1441)))
...
(assert (= temp___1445 (mk___rep4 o75)))
(assert (= result7 (mk___split_fields__ref4 result____split_fields13)))
(assert (= result____split_fields14 (us_split_fields9 temp___1445)))
...
(assert (= temp___1447 (mk___rep4 o78)))
(assert (= result8 (mk___split_fields__ref4 result____split_fields14)))
(assert (= result____split_fields15 (us_split_fields9 temp___1447)))
