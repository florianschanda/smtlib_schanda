...
(declare-const temp___341 (Array Int natural))
...
(assert (= (to_rep o8) o7))
(assert (and (<= (to_rep1 a__first) 1) (<= 1 (to_rep1 a__last))))
(assert (= o9 1))
(assert (= temp___341 (store a o9 o8)))
(assert (not (<= (to_rep1 (first (mk (to_rep1 a__first) (to_rep1 a__last)))) 1)))
(check-sat)
(exit)
