...
(assert (=> (= result true) (and (= o12 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o12 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
...
(assert (=> (= result true) (=> (= result1 true) (and (= o11 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range3 o11)))))
...
(assert (and (= result3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result3 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2)))))))
(assert (=> (= result3 true) (and (= o7 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range3 o7))))
(assert (=> (= result3 true) (= result2 (ite (= o7 3) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o8 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (and (in_range1 o8) (= o8 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields2))))))))
