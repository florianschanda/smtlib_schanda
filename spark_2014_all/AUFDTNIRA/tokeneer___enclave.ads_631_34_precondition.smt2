...
(assert (=> (= result22 true) (and (= o53 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range4 o53))))
(assert (=> (= result22 true) (= result21 (ite (= o53 3) true false))))
(assert (=> (not (= result22 true)) (= result21 false)))
(assert (=> (= result21 true) (and (= o54 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o54) (= o54 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result21 true) (= o55 (ite (= o54 1) true false))))
(assert (=> (not (= result21 true)) (= o55 (of_int 1))))
(assert (and (= o46 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o46) (= o46 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result23 (ite (= o46 1) true false)))
(assert (=> (= result23 true) (and (= o49 (theauthcertrole tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range2 o49) (= o49 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields))))))))
(assert (=> (= result23 true) (= o50 (ite (= o49 1) true false))))
(assert (=> (= result23 true) (and (= o47 (authcertvalid tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o47 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields)) true)))))
(assert (=> (= result23 true) (and (= o48 (isgood tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o48 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields)) true)))))
(assert (=> (= result23 true) (= o51 (ite (= o48 true) o47 false))))
(assert (=> (= result23 true) (= o52 (ite (= o51 true) o50 false))))
(assert (=> (not (= result23 true)) (= o52 (of_int 1))))
(assert (and (= result24 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result24 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
