...
(assert (in_range14 c32b))
(assert (= result12 (mk_map__ref result__)))
(assert (= result__5 nodescription))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b)))))) (= o10 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b))))))) (= o10 0)))
(assert (=> (<= 1 37) (= o11 (+ (- 37 1) 1))))
(assert (=> (not (<= 1 37)) (= o11 0)))
(assert (= o12 (+ o11 o10)))
(assert (= o13 (+ 1 o12)))
(assert (= o14 (- o13 1)))
(assert (and (= o15 o14) (in_range2 o14)))
(assert (= keystore__digest__B36b__thestring__assume (mk___t (concat1 (temp___String_Literal_1711 Tuple0) 1 37 (elts (to_string (attr__ATTRIBUTE_IMAGE14 c32b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b)))))) (mk 1 o15))))
