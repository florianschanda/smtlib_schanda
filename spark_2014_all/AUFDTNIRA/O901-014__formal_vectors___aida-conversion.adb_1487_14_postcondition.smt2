...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 51)) (forall ((index9 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) index9) (<= index9 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index9))) true))))))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___1925 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1925) (<= temp___1925 (to_rep1 n__last))))
...
(assert (= target4 o34))
(assert (<= (- 2999) target4))
(assert (and (= o35 (- target4 2147480000)) (in_range1 (- target4 2147480000))))
(assert (= result8 (mk_int__ref target4)))
(assert (= target5 o35))
(assert (<= (- 2147482999) target5))
