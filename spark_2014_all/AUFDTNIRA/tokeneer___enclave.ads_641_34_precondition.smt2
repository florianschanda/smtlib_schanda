...
(assert (and (and (and (and (and (and (and (and (and (not (= (enrolmentisinprogress (int__content status4)) true)) (=> (not (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))) true)) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))) true)))) (=> (or (= (int__content status4) 5) (= (int__content status4) 4)) (not (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))) true)))) (=> (or (= (int__content status4) 6) (= (int__content status4) 7)) (and (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))) true) (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))) true)) (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4))) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))) (=> (= (int__content status4) 3) (and (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))) true)) (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4))) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))) (=> (= (int__content status4) 8) (and (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))) true)) (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4))) 0)))) (=> (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))) true) (= (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4))) 4)) (= (int__content status4) 6))) (=> (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4))) 1) (and (and (= (isgood tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true) (= (authcertvalid tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) 1)))) (=> (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))) true) (= (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4))) 3)) (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4))) 1))) (=> (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4))) 1) (or (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))) true) (= (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4))) 3)) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))) true))))))
(assert (and (and (in_range6 (int__content auditalarm3)) (in_range26 (int__content status4))) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content2 logfilestate__split_fields15))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content2 logfilestate__split_fields15))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content2 logfilestate__split_fields15)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content2 logfilestate__split_fields15))) true)))
(assert (and (= o56 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o56) (= o56 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result19 (ite (= o56 1) true false)))
(assert (=> (= result19 true) (and (= o58 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o58 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result19 true) (= o59 (ite (not (= o58 true)) true false))))
(assert (=> (= result19 true) (and (= result20 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result20 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result19 true) (=> (= result20 true) (and (= o57 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range4 o57)))))
(assert (=> (= result19 true) (=> (= result20 true) (= o60 (ite (= o57 3) true false)))))
(assert (=> (= result19 true) (=> (not (= result20 true)) (= o60 false))))
(assert (=> (= result19 true) (= o61 (ite (= o60 false) o59 true))))
(assert (=> (not (= result19 true)) (= o61 (of_int 1))))
(assert (and (= result22 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result22 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
