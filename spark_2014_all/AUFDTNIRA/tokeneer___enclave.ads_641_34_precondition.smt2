...
(assert (=> (= result true) (and (= o2 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o2 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
(assert (=> (= result true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (= result true) (and (= result1 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result1 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
(assert (=> (= result true) (=> (= result1 true) (and (= o1 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range4 o1)))))
...
(assert (and (= result2 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result2 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result2 true))
