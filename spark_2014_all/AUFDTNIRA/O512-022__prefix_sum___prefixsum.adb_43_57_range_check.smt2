...
(assert (=> (= (mod2 (+ left3 1) space2) 0) (and (= o (* (* space2 2) 1000000)) (in_range3 (* (* space2 2) 1000000)))))
(assert (=> (= (mod2 (+ left3 1) space2) 0) (and (= result3 (all_left_elements_in a2 left3 o)) (= (= result3 true) (forall ((k Int)) (=> (and (<= 0 k) (<= k 7)) (=> (< k left3) (and (<= (- o) (to_rep (select a2 k))) (<= (to_rep (select a2 k)) o)))))))))
(assert (=> (not (= (mod2 (+ left3 1) space2) 0)) (= result3 false)))
(assert (= result3 true))
