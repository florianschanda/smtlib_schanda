...
(assert (=> (= status 6) (and (or (= status1 6) (= status1 7)) (and (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true) (in_range6 auditalarm1)) (in_range26 status1)))))
...
(assert (=> (not (= status 6)) (and (and (and (and (= status2 3) (= (ispresent (mk___rep theadmin__split_fields3)) true)) (not (= (isdoingop (mk___rep theadmin__split_fields3)) true))) (= (rolepresent (mk___rep theadmin__split_fields3)) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))) (and (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range6 auditalarm2)) (in_range26 status2)))))
...
(assert (and (= o34 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o34) (= o34 (to_rep theadmin__split_fields)))))
(assert (and (= o35 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o35) (= o35 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= o36 (ite (= o35 o34) true false)))
(assert (and (= o26 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o26) (= o26 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result10 (ite (= o26 1) true false)))
(assert (=> (= result10 true) (and (= o30 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o30 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result10 true) (= o31 (ite (not (= o30 true)) true false))))
(assert (=> (= result10 true) (and (= o27 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range4 o27))))
(assert (=> (= result10 true) (= o28 (ite (= o27 3) true false))))
(assert (=> (= result10 true) (and (= o29 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o29 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result10 true) (= o32 (ite (= o29 true) o28 false))))
(assert (=> (= result10 true) (= o33 (ite (= o32 false) o31 true))))
(assert (=> (not (= result10 true)) (= o33 (of_int 1))))
(assert (and (= result12 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result12 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (=> (= result12 true) (and (= o23 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range4 o23))))
(assert (=> (= result12 true) (= result11 (ite (= o23 3) true false))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o24 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o24) (= o24 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result11 true) (= o25 (ite (= o24 1) true false))))
(assert (=> (not (= result11 true)) (= o25 (of_int 1))))
(assert (and (= o16 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o16) (= o16 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result13 (ite (= o16 1) true false)))
(assert (=> (= result13 true) (and (= o19 (theauthcertrole tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range2 o19) (= o19 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields))))))))
(assert (=> (= result13 true) (= o20 (ite (= o19 1) true false))))
(assert (=> (= result13 true) (and (= o17 (authcertvalid tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o17 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields)) true)))))
(assert (=> (= result13 true) (and (= o18 (isgood tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o18 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields)) true)))))
(assert (=> (= result13 true) (= o21 (ite (= o18 true) o17 false))))
(assert (=> (= result13 true) (= o22 (ite (= o21 true) o20 false))))
(assert (=> (not (= result13 true)) (= o22 (of_int 1))))
(assert (=> (= (int__content status3) 3) (and (= o14 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o14 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= (int__content status3) 3) (= o15 (ite (not (= o14 true)) true false))))
(assert (=> (not (= (int__content status3) 3)) (= o15 (of_int 1))))
