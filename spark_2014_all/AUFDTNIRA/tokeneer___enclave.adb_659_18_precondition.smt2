...
(assert (=> (= status 6) (and (or (= status1 6) (= status1 7)) (and (and (in_range6 auditalarm1) (in_range26 status1)) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)))))
(assert (=> (= status 6) (= theadmin__split_fields3 (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
(assert (=> (= status 6) (= theadmin__split_fields3 theadmin__split_fields2)))
(assert (=> (not (= status 6)) (and (and (and (and (= status2 3) (= (ispresent (mk___rep theadmin__split_fields3)) true)) (not (= (isdoingop (mk___rep theadmin__split_fields3)) true))) (= (rolepresent (mk___rep theadmin__split_fields3)) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))) (and (and (in_range6 auditalarm2) (in_range26 status2)) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true)))))
...
(assert (=> (not (= status 6)) (= auditsystemfault auditsystemfault1)))
(assert (=> (not (= status 6)) (= auditalarm1 auditalarm2)))
(assert (=> (not (= status 6)) (= logfilestate__split_fields7 logfilestate__split_fields8)))
(assert (=> (not (= status 6)) (= logfilesstatus logfilesstatus1)))
(assert (=> (not (= status 6)) (= logfiles logfiles1)))
(assert (=> (not (= status 6)) (= state3 state6)))
...
(assert (=> (not (= status 6)) (= logfilesstatus logfilesstatus1)))
(assert (=> (not (= status 6)) (= logfiles logfiles1)))
(assert (= state9 (mk___private__ref state3)))
(assert (= output3 (mk___private__ref output2)))
(assert (= writtenstate2 (mk___private__ref writtenstate)))
(assert (= state8 (mk___private__ref state2)))
(assert (= state7 (mk___private__ref state1)))
...
(assert (= auditalarm3 (mk_int__ref auditalarm1)))
(assert (= logfilestate__split_fields9 (mk___split_fields__ref2 logfilestate__split_fields7)))
...
(assert (= auditalarm4 auditalarm1))
(assert (= logfilestate__split_fields10 logfilestate__split_fields7))
(assert (= logfilesstatus3 logfilesstatus))
(assert (= logfiles3 logfiles))
(assert (and (= o20 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o20) (= o20 (to_rep theadmin__split_fields)))))
(assert (and (= o21 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o21) (= o21 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= o22 (ite (= o21 o20) true false)))
(assert (and (= o12 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o12) (= o12 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result (ite (= o12 1) true false)))
(assert (=> (= result true) (and (= o16 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o16 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result true) (= o17 (ite (not (= o16 true)) true false))))
(assert (=> (= result true) (and (= o13 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range4 o13))))
(assert (=> (= result true) (= o14 (ite (= o13 3) true false))))
(assert (=> (= result true) (and (= o15 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o15 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result true) (= o18 (ite (= o15 true) o14 false))))
(assert (=> (= result true) (= o19 (ite (= o18 false) o17 true))))
(assert (=> (not (= result true)) (= o19 (distinct 1 0))))
(assert (and (= result2 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result2 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (=> (= result2 true) (and (= o9 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range4 o9))))
(assert (=> (= result2 true) (= result1 (ite (= o9 3) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (and (= o10 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o10) (= o10 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result1 true) (= o11 (ite (= o10 1) true false))))
(assert (=> (not (= result1 true)) (= o11 (distinct 1 0))))
(assert (and (= o2 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o2) (= o2 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result3 (ite (= o2 1) true false)))
(assert (=> (= result3 true) (and (= o5 (theauthcertrole tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range2 o5) (= o5 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields))))))))
(assert (=> (= result3 true) (= o6 (ite (= o5 1) true false))))
(assert (=> (= result3 true) (and (= o3 (authcertvalid tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o3 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields)) true)))))
(assert (=> (= result3 true) (and (= o4 (isgood tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o4 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields)) true)))))
(assert (=> (= result3 true) (= o7 (ite (= o4 true) o3 false))))
(assert (=> (= result3 true) (= o8 (ite (= o7 true) o6 false))))
(assert (=> (not (= result3 true)) (= o8 (distinct 1 0))))
(assert (=> (= (int__content status3) 3) (and (= o (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= (int__content status3) 3) (= o1 (ite (not (= o true)) true false))))
(assert (=> (not (= (int__content status3) 3)) (= o1 (distinct 1 0))))
(assert (=> (not (= (int__content status3) 6)) (= (int__content status3) 7)))
