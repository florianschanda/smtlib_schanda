...
(assert (dynamic_predicate (mk___t1 temp___1568 temp___15681)))
(assert (= (mk___t1 o2 o3) (mk___t1 temp___1568 temp___15681)))
(assert (= o4 (makedescription (mk___t1 o2 o3) responsecode1)))
(assert (= o4 o5))
(assert (= (mk 1 150) o6))
(assert (not (= (to_rep1 (first o6)) 1)))
(check-sat)
(exit)
