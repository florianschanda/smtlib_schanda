...
(declare-const temp___1792 (Array Int character))
(declare-const temp___17921 t1)
...
(define-fun temp___17922 () us_t1 (mk___t1 temp___1792 temp___17921))
(assert (= (temp___String_Literal_164 Tuple0) nouser))
(assert (in_range17 reader))
...
(assert (=> (<= 0 4294967295) (in_range10 rawnewstate)))
(assert (=> (<= 0 6) (in_range11 newstate)))
(assert (and (in_range10 rawnewstate1) (in_range10 responsecode1)))
(assert (not (= responsecode1 0)))
(assert (not (= responsecode1 7)))
(assert (not (= (to_rep7 (rec__tokenreader__readerinfot__lastfault (us_split_fields5 (select readerstatus reader)))) responsecode1)))
(assert (dynamic_property1 1 2147483647 1 37))
(assert (= (temp___String_Literal_1791 Tuple0) temp___1792))
(assert (= (mk1 1 37) temp___17921))
(assert (dynamic_predicate temp___17922))
(assert (= o5 temp___17922))
(assert (= o2 (makedescription o5 responsecode1)))
(assert (= o2 o3))
(assert (= (mk 1 150) o4))
