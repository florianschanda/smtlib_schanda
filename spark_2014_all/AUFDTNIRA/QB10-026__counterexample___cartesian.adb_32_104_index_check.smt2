...
(assert (and (= o16 (length array2)) (in_range1 (length array2))))
(assert (and (= o17 (- index11 (to_rep (first (rt array1))))) (in_range1 (- index11 (to_rep (first (rt array1)))))))
(assert (= o18 (* o17 o16)))
(assert (and (= o20 o18) (in_range1 o18)))
(assert (= o21 (+ o20 o19)))
(assert (and (= o22 o21) (in_range1 o21)))
(assert (= o23 (+ o22 1)))
(assert (and (= temp___247 o23) (in_range1 o23)))
(assert (not (<= (to_rep result____first) temp___247)))
(check-sat)
(exit)
