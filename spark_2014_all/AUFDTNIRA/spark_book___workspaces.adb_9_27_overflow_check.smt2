...
(assert (forall ((temp___150 Int) (temp___151 Int) (temp___152 Int)) (let ((temp___149 (workspaces__generate_workspace__workspace__aggregate_def temp___150 temp___151 temp___152))) (and (=> (dynamic_property 1 2147483647 temp___151 temp___152) (and (= (first5 temp___149) temp___151) (= (last5 temp___149) temp___152))) (forall ((temp___153 Int)) (= (select (to_array2 temp___149) temp___153) (of_rep temp___150)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_143 us_t1) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool (=> (not (= temp___skip_constant_141 true)) (and (dynamic_property2 1 size (first3 temp___expr_143) (last3 temp___expr_143)) (and (= (first3 temp___expr_143) 1) (= (last3 temp___expr_143) size)))))
...
(assert (= (mk___t2 temp___155 temp___1551) (workspaces__generate_workspace__workspace__aggregate_def 0 1 size)))
(assert (= (ite (<= (to_rep1 (first4 temp___1551)) (to_rep1 (last4 temp___1551))) (+ (- (to_rep1 (last4 temp___1551)) (to_rep1 (first4 temp___1551))) 1) 0) (ite (<= 1 size) (+ (- size 1) 1) 0)))
(assert (= temp___155 workspaces__generate_workspace__workspace__assume))
(assert (= (mk1 (to_rep1 (first4 temp___1551)) (to_rep1 (last4 temp___1551))) workspaces__generate_workspace__workspace__assume1))
