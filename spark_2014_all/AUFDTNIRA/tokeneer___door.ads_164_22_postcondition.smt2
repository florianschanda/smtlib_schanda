...
(assert (and (and (and (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content2 logfilestate__split_fields7))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content2 logfilestate__split_fields7))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content2 logfilestate__split_fields7)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content2 logfilestate__split_fields7))) true) (in_range12 (int__content currentlatch1))) (in_range1 (int__content auditalarm1))) (in_range1 (int__content dooralarm1))))
(assert (= (islocked (int__content currentlatch1) (us_private__content state) (us_split_fields__content latchtimeout__split_fields)) true))
(assert (= (thecurrentdoor currentdoor) 0))
(assert (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (alarm_timeout (us_split_fields__content alarmtimeout__split_fields))) true))
