...
(assert (and (= (and (and (= currentdoor 0) (= (islocked (int__content currentlatch3) (us_private__content state7) (us_split_fields__content latchtimeout__split_fields7)) true)) (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (mk___rep (us_split_fields__content alarmtimeout__split_fields5))) true)) (= (int__content dooralarm2) 0)) (= (= (islocked (int__content currentlatch3) (us_private__content state7) (us_split_fields__content latchtimeout__split_fields7)) true) (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (latch_timeout (int__content currentlatch3) (us_private__content state7) (us_split_fields__content latchtimeout__split_fields7))) true))))
(assert (and (and (and (in_range12 (int__content currentlatch3)) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content2 logfilestate__split_fields9))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content2 logfilestate__split_fields9))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content2 logfilestate__split_fields9)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content2 logfilestate__split_fields9))) true)) (in_range1 (int__content auditalarm3))) (in_range1 (int__content dooralarm2))))
...
(assert (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (alarm_timeout (us_split_fields__content alarmtimeout__split_fields5))) true))
(assert (not (= (thedooralarm (int__content dooralarm2)) 0)))
(check-sat)
(exit)
