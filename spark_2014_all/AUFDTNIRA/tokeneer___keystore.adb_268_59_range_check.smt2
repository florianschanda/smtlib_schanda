...
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= temp___1904 (mk___t1 (temp___String_Literal_1903 Tuple0) (mk1 1 12)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (dynamic_predicate temp___1904)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= o8 temp___1904)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= o9 (convertretvaltotext (int__content retvalupd8) o8))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= o10 (mk___t o9 (mk 1 150)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (and (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true) (in_range9 auditalarm5))))
...
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= logfilesstatus6 (mk_map__ref1 logfilesstatus5))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= logfiles6 (mk_map__ref4 logfiles5))))
...
(assert (not (dynamic_property1 1 2147483647 1 11)))
(check-sat)
(exit)
