...
(assert (forall ((temp___1098 Int)) (forall ((temp___1099 Int)) (= (select (temp___1096 temp___1098) temp___1099) (of_rep2 temp___1098)))))
(declare-fun temp___1100 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1102 Int)) (forall ((temp___1103 Int)) (= (select (temp___1100 temp___1102) temp___1103) (of_rep5 temp___1102)))))
(define-fun dynamic_invariant1 ((temp___expr_1090 us_rep1) (temp___is_init_1087 Bool) (temp___skip_constant_1088 Bool) (temp___do_toplevel_1089 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1090))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1090))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1090)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1090))) true))
(define-fun default_initial_assumption ((temp___expr_1094 us_rep1) (temp___skip_top_level_1095 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1094))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1094))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1094)) (mk___rep (mk___split_fields (temp___1096 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1094)) (temp___1100 0))))
(define-fun type_invariant ((temp___1104 us_rep1)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1104))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1104))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1104)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1104))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_1256 Int) (temp___is_init_1253 Bool) (temp___skip_constant_1254 Bool) (temp___do_toplevel_1255 Bool)) Bool (=> (or (= temp___is_init_1253 true) (<= 0 1)) (in_range10 temp___expr_1256)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1289 us_void_param) 1)) 76) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 2)) 65)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 3)) 84)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 4)) 67)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 5)) 72)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 7)) 83)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 8)) 84)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 9)) 65)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 10)) 84)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 11)) 69)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 13)) 67)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 14)) 65)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 15)) 78)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 16)) 78)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 17)) 79)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 18)) 84)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 20)) 66)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 21)) 69)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 23)) 68)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 24)) 69)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 25)) 84)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 26)) 69)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 27)) 82)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 28)) 77)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 29)) 73)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 30)) 78)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 31)) 69)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 32)) 68)) (= (to_rep (select (temp___String_Literal_1289 us_void_param) 33)) 46)) :pattern ((temp___String_Literal_1289 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1056 Int) (temp___is_init_1053 Bool) (temp___skip_constant_1054 Bool) (temp___do_toplevel_1055 Bool)) Bool (=> (or (= temp___is_init_1053 true) (<= 0 17)) (in_range7 temp___expr_1056)))
(define-fun dynamic_invariant8 ((temp___expr_1035 Int) (temp___is_init_1032 Bool) (temp___skip_constant_1033 Bool) (temp___do_toplevel_1034 Bool)) Bool (=> (or (= temp___is_init_1032 true) (<= 1 17)) (in_range5 temp___expr_1035)))
(define-fun dynamic_invariant9 ((temp___expr_1160 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 2)) (in_range9 temp___expr_1160)))
(define-fun dynamic_invariant10 ((temp___expr_1041 Int) (temp___is_init_1038 Bool) (temp___skip_constant_1039 Bool) (temp___do_toplevel_1040 Bool)) Bool (=> (or (= temp___is_init_1038 true) (<= 0 17408)) (in_range6 temp___expr_1041)))
(define-fun dynamic_invariant11 ((temp___expr_1075 Int) (temp___is_init_1072 Bool) (temp___skip_constant_1073 Bool) (temp___do_toplevel_1074 Bool)) Bool (=> (or (= temp___is_init_1072 true) (<= 0 1024)) (in_range8 temp___expr_1075)))
(assert true)
