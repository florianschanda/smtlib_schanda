...
(assert (<= (let ((subject i)) i1) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b)))))))
(assert (and (and (<= 1 (let ((subject i)) i2)) (<= (let ((subject i)) i2) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b))))))) (= (bool_eq10 c37b c37b) true)))
(assert (and (and (and (forall ((temp___1659 Int)) (=> (and (<= 1 temp___1659) (<= temp___1659 50)) (=> (<= (let ((subject i)) i2) temp___1659) (= (select (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields2)) temp___1659) (select (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields1)) temp___1659))))) (= (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields2)) (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields1)))) (=> (<= 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b)))))) (dynamic_property1 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b))))) (let ((subject i)) i2)))) (and (<= 1 (let ((subject i)) i2)) (<= (let ((subject i)) i2) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b)))))))))
(assert (= (to_rep o54) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b)))) (let ((subject i)) i2)))))
(assert (= o55 (store (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields2)) (let ((subject i)) i2) o54)))
(assert (= o56 (mk___split_fields4 o55 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields2)))))
(assert (= temp___1657 (mk___rep4 o56)))
(assert (= result4 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields2))))
(assert (= (let ((subject result____split_fields)) result____split_fields3) (us_split_fields9 temp___1657)))
(assert (not (= (let ((subject i)) i2) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b))))))))
