...
(assert (<= (let ((subject i)) i4) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b)))))))
(assert (and (and (<= 1 (let ((subject i)) i5)) (<= (let ((subject i)) i5) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b))))))) (= (bool_eq10 c37b c37b) true)))
(assert (and (and (and (forall ((temp___1496 Int)) (=> (and (<= 1 temp___1496) (<= temp___1496 50)) (=> (<= (let ((subject i)) i5) temp___1496) (= (select (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields3)) temp___1496) (select (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields2)) temp___1496))))) (= (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields3)) (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields2)))) (=> (<= 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b)))))) (dynamic_property1 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b))))) (let ((subject i)) i5)))) (and (<= 1 (let ((subject i)) i5)) (<= (let ((subject i)) i5) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b)))))))))
(assert (= (to_rep o54) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b)))) (let ((subject i)) i5)))))
(assert (= o55 (store (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields3)) (let ((subject i)) i5) o54)))
(assert (= o56 (mk___split_fields4 o55 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields3)))))
(assert (= temp___1494 (mk___rep4 o56)))
(assert (= result5 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields3))))
(assert (= (let ((subject result____split_fields)) result____split_fields4) (us_split_fields9 temp___1494)))
(assert (not (= (let ((subject i)) i5) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b))))))))
(assert (= result6 (let ((subject i)) (mk_int__ref i5))))
(assert (= (let ((subject i)) i6) (+ (let ((subject i)) i5) 1)))
(assert (not (<= 1 (let ((subject i)) i6))))
(check-sat)
(exit)
