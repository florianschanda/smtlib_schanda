...
(assert (and (= o57 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o57) (= o57 (ite (= (of_int 1) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o55 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o55) (<= o55 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= o56 (* 2 o55)))
(assert (and (= o58 o56) (in_range2 o56)))
(assert (= result (ite (<= o58 o57) true false)))
(assert (= result true))
(assert (and (= o54 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o54) (<= o54 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= result1 (ite (<= o54 5000) true false)))
(assert (= result1 true))
(assert (= (= result2 true) (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (to_rep (select a j6))) true)))))
(assert (= result2 true))
(assert (and (= o50 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1)) (= (= o50 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true))))
(assert (= o51 true))
(assert (= result4 (ite (= o51 true) o50 false)))
(assert (= (= result3 true) (forall ((c5 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c5) true) (= (to_rep (select a (element1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c5))) (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c5))))))
(assert (= result3 true))
(assert (and (= o47 (has_key (positions x) c)) (= (= o47 true) (= (has_key (positions x) c) true))))
(assert (= o48 true))
(assert (= result6 (ite (= o48 true) o47 false)))
(assert (= (= result5 true) (forall ((c5 us_rep)) (=> (= (has_key (positions x) c5) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x c5)) true)))))
(assert (= result5 true))
(assert (= (= result7 true) (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 5)) (and (<= 0 (to_rep4 (select f j6))) (<= (to_rep4 (select f j6)) (- (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1)))))))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 5)) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j6)))))) j6) (<= j6 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j6))))))))))))
(assert (= result8 true))
(assert (and (= o8 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o8) (<= o8 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= o9 (- o8 1)))
(assert (= o10 (ite (<= j1 o9) true false)))
(assert (= result10 (ite (<= 0 j1) o10 false)))
(assert (= (= result9 true) (forall ((j6 Int)) (=> (and (<= 0 j6) (<= j6 (- (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))) (forall ((k2 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j6)))) k2) (<= k2 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j6)))))) (= (to_rep4 (select f k2)) j6)))))))
(assert (= result9 true))
(assert (and (= o (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o) (<= o (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (and (= o1 o) (in_range9 o)))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= j o2) true false)))
(assert (= result12 (ite (<= 0 j) o3 false)))
