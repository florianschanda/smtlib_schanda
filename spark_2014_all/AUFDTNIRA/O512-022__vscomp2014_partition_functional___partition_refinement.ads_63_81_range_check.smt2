...
(assert (and (= o14 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o14) (= o14 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o12 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o12) (<= o12 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= o13 (* 2 o12)))
(assert (and (= o15 o13) (in_range2 o13)))
(assert (= result (ite (<= o15 o14) true false)))
(assert (= result true))
(assert (and (= o11 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o11) (<= o11 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= result1 (ite (<= o11 5000) true false)))
(assert (= result1 true))
...
(assert (= result2 true))
(assert (and (= o9 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1)) (= (= o9 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true))))
(assert (= o10 true))
(assert (= result4 (ite (= o10 true) o9 false)))
(assert (= (= result3 true) (forall ((c2 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2) true) (= (to_rep (select a (element1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c2))) (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c2))))))
(assert (= result3 true))
(assert (and (= o7 (has_key (positions x) c)) (= (= o7 true) (= (has_key (positions x) c) true))))
(assert (= o8 true))
(assert (= result6 (ite (= o8 true) o7 false)))
(assert (= (= result5 true) (forall ((c2 us_rep)) (=> (= (has_key (positions x) c2) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x c2)) true)))))
(assert (= result5 true))
(assert (= (= result7 true) (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 5)) (and (<= 0 (to_rep4 (select f j2))) (<= (to_rep4 (select f j2)) (- (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1)))))))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 5)) (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j2)))))) j2) (<= j2 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j2))))))))))))
(assert (= result8 true))
(assert (and (= o4 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o4) (<= o4 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= o5 (- o4 1)))
(assert (= o6 (ite (<= j1 o5) true false)))
(assert (= result10 (ite (<= 0 j1) o6 false)))
(assert (= (= result9 true) (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 (- (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j2)))) k) (<= k (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j2)))))) (= (to_rep4 (select f k)) j2)))))))
(assert (= result9 true))
...
(assert (= result11 (ite (<= 0 j) o3 false)))
