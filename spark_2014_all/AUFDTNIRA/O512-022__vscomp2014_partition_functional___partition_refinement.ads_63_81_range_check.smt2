...
(assert (and (= o14 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o14) (= o14 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o12 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o12) (<= o12 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= o13 (* 2 o12)))
(assert (and (= o15 o13) (in_range10 o13)))
(assert (= result (ite (<= o15 o14) true false)))
(assert (= result true))
(assert (and (= o11 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o11) (<= o11 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
...
(assert (= result5 true))
(assert (= (= result7 true) (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 5)) (and (<= 0 (to_rep5 (select f j2))) (<= (to_rep5 (select f j2)) (- (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1)))))))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 5)) (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j2)))))) j2) (<= j2 (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j2))))))))))))
(assert (= result8 true))
(assert (and (= o4 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o4) (<= o4 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= o5 (- o4 1)))
(assert (= o6 (ite (<= j1 o5) true false)))
(assert (= result10 (ite (<= 0 j1) o6 false)))
(assert (= (= result9 true) (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 (- (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1))) (forall ((k Int)) (=> (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) j2)))) k) (<= k (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) j2)))))) (= (to_rep5 (select f k)) j2)))))))
(assert (= result9 true))
(assert (and (= o (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o) (<= o (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (and (= o1 o) (in_range9 o)))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= j o2) true false)))
(assert (= result11 (ite (<= 0 j) o3 false)))
(assert (= result11 true))
(assert (not (in_range11 j)))
(check-sat)
(exit)
