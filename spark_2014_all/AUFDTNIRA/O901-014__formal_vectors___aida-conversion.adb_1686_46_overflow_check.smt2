...
(assert (forall ((temp___2128 Int) (temp___2129 Int) (temp___2130 Int)) (let ((temp___2127 (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__aggregate_def temp___2128 temp___2129 temp___2130))) (=> (dynamic_invariant temp___2128 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 4) (+ (first1 source) 10) temp___2129 temp___2130) (and (= (first9 temp___2127) temp___2129) (= (last9 temp___2127) temp___2130))) (forall ((temp___2131 Int)) (= (select (to_array4 temp___2127) temp___2131) rliteral2)))))))
...
(declare-const temp___2135 Int)
(declare-const temp___2136 Int)
(declare-const temp___2140 Int)
(declare-const temp___2138 (Array Int integer))
(declare-const o Int)
...
(assert (and (= temp___2135 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (= temp___2136 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2135))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= temp___2140 index1)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= temp___2138 n1)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= o index1)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= o3 index1)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= o7 index1)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= n1 result3)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= n2 o8)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (and (and (forall ((temp___2139 Int)) (=> (and (<= (to_rep1 n__first) temp___2139) (<= temp___2139 (to_rep1 n__last))) (=> (or (< temp___2136 temp___2139) (or (< temp___2139 temp___2135) (< index2 temp___2139))) (= (select n3 temp___2139) (select temp___2138 temp___2139))))) (=> (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 4) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= index2 temp___2136)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= index2 index3)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= n3 n4)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= index4 index2)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= n5 n3)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= index6 index4)))
(assert (=> (and (<= temp___2135 index1) (<= index1 temp___2136)) (= n7 n5)))
(assert (=> (not (and (<= temp___2135 index1) (<= index1 temp___2136))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2135 index1) (<= index1 temp___2136))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2135 index1) (<= index1 temp___2136))) (= index6 index1)))
(assert (=> (not (and (<= temp___2135 index1) (<= index1 temp___2136))) (= n7 n1)))
