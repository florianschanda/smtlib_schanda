...
(assert (and (= o17 (islocked (int__content currentlatch1) (us_private__content state4) (us_split_fields__content1 latchtimeout__split_fields4))) (= (= o17 true) (= (int__content currentlatch1) 0))))
(assert (= o18 (ite (not (= o17 true)) true false)))
(assert (= result (ite (= o18 true) (islocked currentlatch (us_private__content state1) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result true) (and (= o19 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o19))))
(assert (=> (= result true) (= o20 (ite (= o19 3) true false))))
(assert (=> (= result true) (and (= o21 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o21 true) (in_range3 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result true) (= o22 (ite (= o21 true) o20 false))))
(assert (=> (not (= result true)) (= o22 (distinct 1 0))))
(assert (and (= o9 (islocked (int__content currentlatch1) (us_private__content state4) (us_split_fields__content1 latchtimeout__split_fields4))) (= (= o9 true) (= (int__content currentlatch1) 0))))
(assert (= o10 (ite (not (= o9 true)) true false)))
(assert (= result1 (ite (= o10 true) (islocked currentlatch (us_private__content state1) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result1 true) (and (= o13 (theauthcertrole (int__content tokenpresence1) (us_private__content state3) (int__content tokentry1) (int__content tokenid1) (us_split_fields__content9 authcert__split_fields1) (us_split_fields__content6 idcert__split_fields1))) (and (in_range1 o13) (= o13 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content9 authcert__split_fields1))))))))
(assert (=> (= result1 true) (= o14 (ite (= o13 1) true false))))
(assert (=> (= result1 true) (and (= o11 (authcertvalid (int__content tokenpresence1) (us_private__content state3) (int__content tokentry1) (int__content tokenid1) (us_split_fields__content9 authcert__split_fields1) (us_split_fields__content6 idcert__split_fields1))) (= (= o11 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content9 authcert__split_fields1)) true)))))
(assert (=> (= result1 true) (and (= o12 (isgood (int__content tokenpresence1) (us_private__content state3) (int__content tokentry1) (int__content tokenid1) (us_split_fields__content9 authcert__split_fields1) (us_split_fields__content6 idcert__split_fields1))) (= (= o12 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content6 idcert__split_fields1)) true)))))
(assert (=> (= result1 true) (= o15 (ite (= o12 true) o11 false))))
(assert (=> (= result1 true) (= o16 (ite (= o15 true) o14 false))))
(assert (=> (not (= result1 true)) (= o16 (distinct 1 0))))
(assert (and (= o6 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o6 true) (in_range4 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result2 (ite (not (= o6 true)) true false)))
(assert (=> (= result2 true) (and (= o7 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o7 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
(assert (=> (= result2 true) (= o8 (ite (not (= o7 true)) true false))))
(assert (=> (not (= result2 true)) (= o8 (distinct 1 0))))
...
(assert (=> (= result3 true) (and (= o2 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o2 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
(assert (=> (= result3 true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (= result3 true) (and (= result4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result4 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
(assert (=> (= result3 true) (=> (= result4 true) (and (= o1 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range3 o1)))))
...
(assert (and (= result5 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result5 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result5 true))
