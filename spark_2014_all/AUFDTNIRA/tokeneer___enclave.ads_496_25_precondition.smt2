...
(assert (=> (= result true) (and (= o19 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o19))))
(assert (=> (= result true) (= o20 (ite (= o19 3) true false))))
(assert (=> (= result true) (and (= o21 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o21 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
...
(assert (and (= o6 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o6 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result2 (ite (not (= o6 true)) true false)))
(assert (=> (= result2 true) (and (= o7 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o7 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
...
(assert (=> (= result3 true) (and (= o2 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o2 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
(assert (=> (= result3 true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (= result3 true) (and (= result4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result4 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
(assert (=> (= result3 true) (=> (= result4 true) (and (= o1 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range4 o1)))))
...
(assert (and (= result5 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result5 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result5 true))
