...
(assert (=> (= result17 true) (and (= o65 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (= (= o65 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields5))))))))
(assert (=> (= result17 true) (= o66 (ite (not (= o65 true)) true false))))
(assert (=> (= result17 true) (and (= result18 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (= (= result18 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields5))))))))
(assert (=> (= result17 true) (=> (= result18 true) (and (= o64 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range4 o64)))))
(assert (=> (= result17 true) (=> (= result18 true) (= o67 (ite (= o64 3) true false)))))
(assert (=> (= result17 true) (=> (not (= result18 true)) (= o67 false))))
(assert (=> (= result17 true) (= o68 (ite (= o67 false) o66 true))))
(assert (=> (not (= result17 true)) (= o68 (of_int 1))))
(assert (and (= result20 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (= (= result20 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields5)))))))
