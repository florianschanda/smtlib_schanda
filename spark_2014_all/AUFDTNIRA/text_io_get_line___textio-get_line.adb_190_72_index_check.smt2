...
(assert (= n2 o6))
(assert (<= 80 n2))
(assert (and (<= (to_rep1 item__first) (+ last6 1)) (= (+ last6 n3) (to_rep1 item__last))))
(assert (forall ((idx2 Int)) (=> (and (<= (to_rep1 item__first) idx2) (<= idx2 last6)) (= (to_rep (select item2 idx2)) (to_rep (select the_file (+ (- idx2 (to_rep1 item__first)) cur_position)))))))
(assert (= cur_position2 (+ (- (+ cur_position last6) (to_rep1 item__first)) 1)))
(assert (and (and (and (and (=> (<= 0 2147483647) (in_range4 last6)) (=> (<= 0 2147483647) (in_range4 n3))) (=> (<= (- 2147483648) 2147483647) (in_range1 rest2))) (in_range2 cur_position2)) (<= 80 n3)))
