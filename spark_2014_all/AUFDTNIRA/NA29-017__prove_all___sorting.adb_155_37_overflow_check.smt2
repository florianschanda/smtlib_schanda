...
(assert (= b7 b5))
(assert (= a8 a6))
(assert (= o13 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t (map__content a7) (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (<= 0 j))
(assert (<= j 2147483647))
...
(assert (= o8 (- length1 o7)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (and (= o10 (* l2 2)) (in_range1 (* l2 2))))
(assert (= o11 (ite (< o10 o9) o10 o9)))
