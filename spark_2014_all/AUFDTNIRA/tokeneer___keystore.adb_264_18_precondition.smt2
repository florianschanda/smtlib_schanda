...
(assert (=> (= result12 true) (= (ite (<= (to_rep1 (first (rt thestring))) (to_rep1 (last (rt thestring)))) (+ (- (to_rep1 (last (rt thestring))) (to_rep1 (first (rt thestring)))) 1) 0) (ite (<= 1 (length thestring)) (+ (- (length thestring) 1) 1) 0))))
(assert (=> (= result12 true) (= temp___1222 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring))))))
(assert (=> (= result12 true) (and (= temp___1224 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= result12 true) (=> (<= 1 temp___1224) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1224) (<= temp___1224 150))))))
(assert (=> (= result12 true) (= o16 result__1)))
(assert (=> (= result12 true) (= temp___1225 (mk___t1 o16 (mk1 1 temp___1224)))))
(assert (=> (= result12 true) (= (ite (<= (to_rep1 (first2 (rt1 temp___1222))) (to_rep1 (last2 (rt1 temp___1222)))) (+ (- (to_rep1 (last2 (rt1 temp___1222))) (to_rep1 (first2 (rt1 temp___1222)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1225))) (to_rep1 (last2 (rt1 temp___1225)))) (+ (- (to_rep1 (last2 (rt1 temp___1225))) (to_rep1 (first2 (rt1 temp___1225)))) 1) 0))))
(assert (=> (= result12 true) (= temp___1226 temp___1222)))
(assert (=> (= result12 true) (forall ((temp___1227 Int)) (ite (and (<= 1 temp___1227) (<= temp___1227 (length thestring))) (= (select o17 temp___1227) (select (elts1 temp___1226) temp___1227)) (= (select o17 temp___1227) (select result__1 temp___1227))))))
(assert (=> (= result12 true) (= result13 (mk_map__ref result__1))))
(assert (=> (= result12 true) (= result__2 o17)))
(assert (=> (= result12 true) (= result__4 (mk_map__ref result__2))))
(assert (=> (= result12 true) (= result__5 result__2)))
(assert (=> (not (= result12 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring))) 1) (<= 1 (to_rep1 (last (rt thestring))))) (and (<= (to_rep1 (first (rt thestring))) 150) (<= 150 (to_rep1 (last (rt thestring)))))))))
(assert (=> (not (= result12 true)) (= temp___1221 thestring)))
(assert (=> (not (= result12 true)) (= o18 (elts temp___1221))))
(assert (=> (not (= result12 true)) (= result14 (mk_map__ref result__1))))
(assert (=> (not (= result12 true)) (= result__3 o18)))
