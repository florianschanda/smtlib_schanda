...
(assert (= o9 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (= (= o8 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 2147483647)) (=> (< (* j1 l2) (- length1 i3)) (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ (+ a_first i3) (* j1 l2)) (ite (< l2 (- (- length1 i3) (* j1 l2))) l2 (- (- length1 i3) (* j1 l2)))) true))))))
(assert (<= 0 j))
(assert (<= j 2147483647))
