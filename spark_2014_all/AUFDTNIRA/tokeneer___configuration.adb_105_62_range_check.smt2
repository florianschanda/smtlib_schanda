...
(assert (not (= (length temp___1926) 0)))
(assert (=> (<= 1 2) (= o72 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o72 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1926))) (to_rep1 (last (rt temp___1926)))) (= o73 (+ (- (to_rep1 (last (rt temp___1926))) (to_rep1 (first (rt temp___1926)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1926))) (to_rep1 (last (rt temp___1926))))) (= o73 0)))
(assert (= o74 (+ o73 o72)))
(assert (= o75 (+ (to_rep1 (first (rt temp___1926))) o74)))
(assert (= o76 (- o75 1)))
