...
(define-fun e20 () int__ref (mk_int__ref e1))
(define-fun e21 () int__ref (mk_int__ref e))
...
(assert (=> (= result22 true) (and (=> (<= 1 200) (in_range4 x20)) (and (= (has_element (mk___rep1 my_container__split_fields1) (let ((subject temp___641)) temp___6412)) true) (= e15 (element (mk___rep1 my_container__split_fields1) (let ((subject temp___641)) temp___6412)))))))
...
(assert (not (= (has_element (mk___rep1 my_container__split_fields1) (cursor__content temp___655)) true)))
(check-sat)
(exit)
