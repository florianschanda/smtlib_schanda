...
(assert (= o9 i))
(assert (= o10 (select (elts array1) o9)))
(assert (= o11 (to_rep o10)))
(assert (and (= o8 (- j (to_rep (first (rt array2))))) (in_range1 (- j (to_rep (first (rt array2)))))))
(assert (and (= o7 (length array2)) (in_range1 (length array2))))
(assert (not (in_range1 (- i (to_rep (first (rt array1)))))))
(check-sat)
(exit)
