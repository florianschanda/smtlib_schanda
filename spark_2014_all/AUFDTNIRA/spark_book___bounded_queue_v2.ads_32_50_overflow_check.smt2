...
(assert (= queue__split_fields5 (mk___split_fields temp___2801 temp___2802 temp___2803 (mk___t temp___2804 temp___2805))))
(assert (= queue__split_discrs (mk___split_discrs temp___280)))
(assert (= (to_rep2 o8) item))
(assert (and (<= (to_rep3 (first (rt (rec__bounded_queue_v2__queue_type__items queue__split_fields5)))) (to_rep1 (rec__bounded_queue_v2__queue_type__rear queue__split_fields5))) (<= (to_rep1 (rec__bounded_queue_v2__queue_type__rear queue__split_fields5)) (to_rep3 (last (rt (rec__bounded_queue_v2__queue_type__items queue__split_fields5)))))))
...
(assert (= queue__split_fields6 (mk___split_fields temp___2841 temp___2842 temp___2843 (mk___t temp___2844 temp___2845))))
(assert (= queue__split_discrs (mk___split_discrs temp___284)))
...
(assert (= queue__split_fields7 (mk___split_fields temp___2861 temp___2862 temp___2863 (mk___t temp___2864 temp___2865))))
(assert (= queue__split_discrs (mk___split_discrs temp___286)))
