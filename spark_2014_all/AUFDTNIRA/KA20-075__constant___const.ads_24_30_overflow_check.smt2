...
(assert (forall ((temp___162 Int) (temp___163 Int)) (let ((temp___161 (const__d__aggregate_def temp___162 temp___163))) (=> (and (dynamic_invariant temp___162 true true true true) (dynamic_invariant temp___163 true true true true)) (and (= (to_rep (select temp___161 1)) temp___162) (= (to_rep (select temp___161 2)) temp___163))))))
