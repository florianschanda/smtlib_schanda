...
(assert (= (integerqtint rliteral4) 8))
(declare-const rliteral5 integer)
(assert (= (integerqtint rliteral5) 9))
(assert (forall ((temp___1386 Int) (temp___1387 Int) (temp___1388 Int) (temp___1389 Int) (temp___1390 Int) (temp___1391 Int) (temp___1392 Int) (temp___1393 Int) (temp___1394 Int) (temp___1395 Int) (temp___1396 Int) (temp___1397 Int)) (let ((temp___1385 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__aggregate_def temp___1386 temp___1387 temp___1388 temp___1389 temp___1390 temp___1391 temp___1392 temp___1393 temp___1394 temp___1395 temp___1396 temp___1397))) (=> (and (and (and (and (and (and (and (and (and (dynamic_invariant temp___1386 true true true true) (dynamic_invariant temp___1387 true true true true)) (dynamic_invariant temp___1388 true true true true)) (dynamic_invariant temp___1389 true true true true)) (dynamic_invariant temp___1390 true true true true)) (dynamic_invariant temp___1391 true true true true)) (dynamic_invariant temp___1392 true true true true)) (dynamic_invariant temp___1393 true true true true)) (dynamic_invariant temp___1394 true true true true)) (dynamic_invariant temp___1395 true true true true)) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1396 temp___1397) (and (= (first5 temp___1385) temp___1396) (= (last5 temp___1385) temp___1397))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1385) (+ (first1 source) 0)) rliteral) (= (select (to_array2 temp___1385) (+ (first1 source) 1)) rliteral1)) (= (select (to_array2 temp___1385) (+ (first1 source) 2)) rliteral2)) (= (select (to_array2 temp___1385) (+ (first1 source) 3)) rliteral3)) (= (select (to_array2 temp___1385) (+ (first1 source) 4)) rliteral2)) (= (select (to_array2 temp___1385) (+ (first1 source) 5)) rliteral4)) (= (select (to_array2 temp___1385) (+ (first1 source) 6)) rliteral)) (= (select (to_array2 temp___1385) (+ (first1 source) 7)) rliteral5)) (= (select (to_array2 temp___1385) (+ (first1 source) 8)) rliteral5)) (= (select (to_array2 temp___1385) (+ (first1 source) 9)) rliteral5)))))))
(define-fun dynamic_invariant4 ((temp___expr_254 us_t3) (temp___is_init_250 Bool) (temp___skip_constant_251 Bool) (temp___do_toplevel_252 Bool) (temp___do_typ_inv_253 Bool)) Bool (=> (not (= temp___skip_constant_251 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_254) (last7 temp___expr_254)) (and (= (first7 temp___expr_254) (first1 source)) (= (last7 temp___expr_254) (+ (first1 source) 9))))))
(declare-sort t6 0)
...
(assert (forall ((temp___1403 Int) (temp___1404 Int) (temp___1405 Int)) (let ((temp___1402 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__aggregate_def temp___1403 temp___1404 temp___1405))) (=> (dynamic_invariant temp___1403 true true true true) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1404 temp___1405) (and (= (first9 temp___1402) temp___1404) (= (last9 temp___1402) temp___1405))) (forall ((temp___1406 Int)) (= (select (to_array4 temp___1402) temp___1406) rliteral6)))))))
...
(declare-const temp___1400 (Array Int integer))
(declare-const temp___14001 t2)
...
(declare-const temp___1408 (Array Int integer))
(declare-const temp___14081 t4)
...
(declare-const temp___1411 Int)
(declare-const temp___1415 Int)
(declare-const temp___1413 (Array Int integer))
(declare-const o Int)
...
(assert (and (and (= (length source) 10) (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 56)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 51))) (forall ((index7 Int)) (=> (and (<= (to_rep1 (first (rt source))) index7) (<= index7 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index7))) true)))))
...
(assert (= (mk___t2 temp___1400 temp___14001) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__aggregate_def 2 1 4 7 4 8 2 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___14001)) (to_rep1 (last4 temp___14001))) (+ (- (to_rep1 (last4 temp___14001)) (to_rep1 (first4 temp___14001))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1400 (to_rep1 (first4 temp___14001)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__assume))
...
(assert (= (mk___t4 temp___1408 temp___14081) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___14081)) (to_rep1 (last8 temp___14081))) (+ (- (to_rep1 (last8 temp___14081)) (to_rep1 (first8 temp___14081))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1408 (to_rep1 (first8 temp___14081)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__assume))
...
(assert (and (= temp___1411 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= temp___1415 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= temp___1413 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= o index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= o1 (select n1 o))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= o3 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= o7 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= n2 o8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt source))) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (and (and (forall ((temp___1414 Int)) (=> (and (<= (to_rep1 n__first) temp___1414) (<= temp___1414 (to_rep1 n__last))) (=> (or (< temp___1411 temp___1414) (or (< temp___1414 (to_rep1 (first (rt source)))) (< index2 temp___1414))) (= (select n3 temp___1414) (select temp___1413 temp___1414))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= index2 temp___1411)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= index2 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= n3 n4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= index4 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= n5 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= index6 index4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411)) (= n7 n5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1411))) (= n7 n1)))
...
(assert (and (= temp___1416 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1416) (<= temp___1416 (to_rep1 n__last))))
(assert (= o9 temp___1416))
(assert (= o10 (select (map__content1 n6) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= result4 (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 9))
(assert (and (= temp___1417 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1417) (<= temp___1417 (to_rep1 n__last))))
(assert (= o12 temp___1417))
...
(assert (= target2 o18))
(assert (<= target2 99))
(assert (and (= temp___1418 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1418) (<= temp___1418 (to_rep1 n__last))))
(assert (= o19 temp___1418))
...
(assert (= target3 o25))
(assert (<= target3 999))
(assert (and (= temp___1419 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___1419) (<= temp___1419 (to_rep1 n__last))))
(assert (= o26 temp___1419))
