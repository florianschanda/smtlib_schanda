...
(define-fun tint_arrayD1__ref___4__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___4__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t105b__ref (mk_t105b__ref (t105b__content us_t2)))))
(define-fun t105b__ref___projection ((a t105b__ref)) us_t2 (t105b__content a))
...
(define-fun tnumber_array_typeD1__ref___4__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___4__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t108b__ref (mk_t108b__ref (t108b__content integer)))))
(define-fun t108b__ref___projection ((a t108b__ref)) integer (t108b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t109b__ref (mk_t109b__ref (t109b__content us_t4)))))
(define-fun t109b__ref___projection ((a t109b__ref)) us_t4 (t109b__content a))
...
(declare-datatypes () ((t110b__ref (mk_t110b__ref (t110b__content integer)))))
(define-fun t110b__ref___projection ((a t110b__ref)) integer (t110b__content a))
...
(define-fun tint_arrayB__ref___4__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___1284 Int) (temp___1285 Int) (temp___1286 Int) (temp___1287 Int) (temp___1288 Int) (temp___1289 Int) (temp___1290 Int) (temp___1291 Int) (temp___1292 Int) (temp___1293 Int) (temp___1294 Int) (temp___1295 Int)) (let ((temp___1283 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__aggregate_def temp___1284 temp___1285 temp___1286 temp___1287 temp___1288 temp___1289 temp___1290 temp___1291 temp___1292 temp___1293 temp___1294 temp___1295))) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1294 temp___1295) (and (= (first5 temp___1283) temp___1294) (= (last5 temp___1283) temp___1295))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1283) (+ (first1 source) 0)) (of_rep1 temp___1284)) (= (select (to_array2 temp___1283) (+ (first1 source) 1)) (of_rep1 temp___1285))) (= (select (to_array2 temp___1283) (+ (first1 source) 2)) (of_rep1 temp___1286))) (= (select (to_array2 temp___1283) (+ (first1 source) 3)) (of_rep1 temp___1287))) (= (select (to_array2 temp___1283) (+ (first1 source) 4)) (of_rep1 temp___1288))) (= (select (to_array2 temp___1283) (+ (first1 source) 5)) (of_rep1 temp___1289))) (= (select (to_array2 temp___1283) (+ (first1 source) 6)) (of_rep1 temp___1290))) (= (select (to_array2 temp___1283) (+ (first1 source) 7)) (of_rep1 temp___1291))) (= (select (to_array2 temp___1283) (+ (first1 source) 8)) (of_rep1 temp___1292))) (= (select (to_array2 temp___1283) (+ (first1 source) 9)) (of_rep1 temp___1293)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___4__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___1301 Int) (temp___1302 Int) (temp___1303 Int)) (let ((temp___1300 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__aggregate_def temp___1301 temp___1302 temp___1303))) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1302 temp___1303) (and (= (first9 temp___1300) temp___1302) (= (last9 temp___1300) temp___1303))) (forall ((temp___1304 Int)) (= (select (to_array4 temp___1300) temp___1304) (of_rep1 temp___1301)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_221 us_t3) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool)) Bool (=> (not (= temp___skip_constant_219 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_221) (last7 temp___expr_221)) (and (= (first7 temp___expr_221) (first1 source)) (= (last7 temp___expr_221) (+ (first1 source) 9))))))
...
(declare-const temp___1298 (Array Int integer))
(declare-const temp___12981 t2)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__assume1 t1)
(declare-const us Int)
(declare-const temp___1306 (Array Int integer))
(declare-const temp___13061 t4)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__assume1 t3)
(declare-const us1 Int)
(declare-const temp___1313 Int)
(declare-const temp___1311 Int)
(declare-const temp___1309 (Array Int integer))
...
(declare-const target6 int__ref)
...
(assert (and (and (= (length source) 10) (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 56)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 51))) (forall ((index11 Int)) (=> (and (<= (to_rep1 (first (rt source))) index11) (<= index11 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__aggregate_def 2 1 4 7 4 8 2 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__aggregate_def 2 1 4 7 4 8 2 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t2 temp___1298 temp___12981) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__aggregate_def 2 1 4 7 4 8 2 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___12981)) (to_rep1 (last4 temp___12981))) (+ (- (to_rep1 (last4 temp___12981)) (to_rep1 (first4 temp___12981))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1298 (to_rep1 (first4 temp___12981)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__assume))
(assert (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__int_array__assume1))))
...
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t4 temp___1306 temp___13061) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___13061)) (to_rep1 (last8 temp___13061))) (+ (- (to_rep1 (last8 temp___13061)) (to_rep1 (first8 temp___13061))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1306 (to_rep1 (first8 temp___13061)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__assume))
(assert (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_482_xxx__n__assume1))))
...
(assert (and (= temp___1313 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index2 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= temp___1311 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= temp___1309 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= o25 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= o26 (select n1 o25))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= o27 (to_rep1 o26))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= o27 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= o28 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= o29 (select (elts source) o28))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= o30 (to_rep o29))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o30))) (ite (= (= o30 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o30 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o30 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o30 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o30 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o30 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o30 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o30 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o30 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o30 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= (to_rep1 o31) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= o32 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= o33 (store n1 o32 o31))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= n2 o33)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (and (and (forall ((temp___1310 Int)) (=> (and (<= (to_rep1 n__first) temp___1310) (<= temp___1310 (to_rep1 n__last))) (=> (< index3 temp___1310) (= (select n3 temp___1310) (select temp___1309 temp___1310))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= index3 temp___1313)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= index3 index5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= n3 n5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= index6 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= n6 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= index8 index6)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313)) (= n8 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313))) (= index8 index2)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1313))) (= n8 n1)))
...
(assert (and (= temp___1314 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1314) (<= temp___1314 (to_rep1 n__last))))
(assert (= o57 temp___1314))
(assert (= o58 (select (map__content1 n7) o57)))
(assert (= o59 (to_rep1 o58)))
(assert (= result6 (mk_int__ref target)))
(assert (= target1 o59))
(assert (<= target1 9))
(assert (and (= temp___1315 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1315) (<= temp___1315 (to_rep1 n__last))))
(assert (= o60 temp___1315))
(assert (= o61 (select (map__content1 n7) o60)))
(assert (= o62 (to_rep1 o61)))
(assert (= o63 (* o62 10)))
(assert (and (= o64 o63) (in_range1 o63)))
(assert (= o65 (+ target1 o64)))
(assert (and (= o66 o65) (in_range1 o65)))
(assert (= result7 (mk_int__ref target1)))
(assert (= target2 o66))
(assert (<= target2 99))
(assert (and (= temp___1316 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1316) (<= temp___1316 (to_rep1 n__last))))
(assert (= o67 temp___1316))
(assert (= o68 (select (map__content1 n7) o67)))
(assert (= o69 (to_rep1 o68)))
(assert (= o70 (* o69 100)))
(assert (and (= o71 o70) (in_range1 o70)))
(assert (= o72 (+ target2 o71)))
(assert (and (= o73 o72) (in_range1 o72)))
(assert (= result8 (mk_int__ref target2)))
(assert (= target3 o73))
(assert (<= target3 999))
(assert (and (= temp___1317 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___1317) (<= temp___1317 (to_rep1 n__last))))
(assert (= o74 temp___1317))
(assert (= o75 (select (map__content1 n7) o74)))
(assert (= o76 (to_rep1 o75)))
(assert (= o77 (* o76 1000)))
(assert (and (= o78 o77) (in_range1 o77)))
(assert (= o79 (+ target3 o78)))
(assert (not (in_range1 o79)))
(check-sat)
(exit)
