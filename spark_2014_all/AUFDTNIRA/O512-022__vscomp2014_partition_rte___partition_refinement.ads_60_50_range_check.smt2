...
(assert (and (= o10 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o10) (= o10 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o8 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o8) (<= o8 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= o9 (* 2 o8)))
(assert (and (= o11 o9) (in_range2 o9)))
(assert (= result (ite (<= o11 o10) true false)))
(assert (= result true))
(assert (and (= o7 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o7) (<= o7 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
...
(assert (= result2 true))
(assert (and (= o5 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2)) (= (= o5 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2) true))))
(assert (= o6 true))
...
(assert (= result3 true))
(assert (and (= o3 (has_key (positions x) c3)) (= (= o3 true) (= (has_key (positions x) c3) true))))
(assert (= o4 true))
...
(assert (= result5 true))
(assert (= (= result7 true) (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= 0 (to_rep4 (select f j))) (<= (to_rep4 (select f j)) (- (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1)))))))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j)))))) j) (<= j (to_rep3 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j))))))))))))
(assert (= result8 true))
