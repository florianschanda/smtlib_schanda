...
(assert (and (= o8 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o8) (= o8 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o6 (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o6) (<= o6 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= o7 (* 2 o6)))
(assert (and (= o9 o7) (in_range11 o7)))
...
(assert (= result2 true))
(assert (and (= o3 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2)) (= (= o3 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2) true))))
(assert (= o4 true))
...
(assert (= result3 true))
(assert (and (= o1 (has_key (positions x) c3)) (= (= o1 true) (= (has_key (positions x) c3) true))))
(assert (= o2 true))
(assert (= result6 (ite (= o2 true) o1 false)))
...
(assert (= result5 true))
(assert (= (= result7 true) (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= 0 (to_rep5 (select f j))) (<= (to_rep5 (select f j)) (- (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1)))))))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j)))))) j) (<= j (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j))))))))))))
(assert (= result8 true))
