...
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= (mk_int__ref result3) index213)))
...
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= index211 index213)))
...
(assert (and (= o8 (- i (to_rep (first (rt array1))))) (in_range1 (- i (to_rep (first (rt array1)))))))
(assert (= o9 (* o8 o7)))
...
(assert (not (<= (to_rep result____first) temp___307)))
(check-sat)
(exit)
