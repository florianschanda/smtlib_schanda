...
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= temp___260 result__1)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= temp___258 index11)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= temp___257 result_index1)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= (mk_int__ref result3) (mk_int__ref index2))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index22 (to_rep (first (rt array2))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= temp___245 result__1))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= temp___243 index22))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= temp___242 result_index1))))
...
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= o6 (store result__1 o5 (temp___237 (to_rep (select (elts array1) index11)) (to_rep (select (elts array2) index22))))))))
...
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 index23)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) index11))))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 index23)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j9))))))))
...
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= index25 (mk_int__ref index23)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index5 (mk_int__ref result_index3)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__3 result__5))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= index26 index23))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index6 result_index3))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__6 result__3))))
...
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__7 (mk_map__ref1 result__5)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= index28 index26))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index8 result_index6))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__8 result__6))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= index27 (mk_int__ref index22)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= result_index7 (mk_int__ref result_index1)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= result__7 (mk_map__ref1 result__1)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= index28 index22))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= result_index8 result_index1))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= result__8 result__1))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result_index9 (* (+ (- index12 (to_rep (first (rt array1)))) 1) (length array2)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (forall ((i5 Int)) (=> (and (<= (to_rep (first (rt array1))) i5) (<= i5 index12)) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 (to_rep (last (rt array2))))) (= (to_rep (select (select result__9 (+ (+ (* (- i5 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) i5)))))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (forall ((i5 Int)) (=> (and (<= (to_rep (first (rt array1))) i5) (<= i5 index12)) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 (to_rep (last (rt array2))))) (= (to_rep (select (select result__9 (+ (+ (* (- i5 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j9)))))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (and (and (=> (<= 0 2147483647) (in_range2 result_index9)) (=> (<= (to_rep (first (rt array1))) (to_rep (last (rt array1)))) (dynamic_property6 (to_rep (first (rt array1))) (to_rep (last (rt array1))) index12))) (and (<= (to_rep (first (rt array1))) index12) (<= index12 (to_rep (last (rt array1))))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index12 (to_rep (last (rt array1))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index221 (mk_int__ref index29))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index16 (mk_int__ref index12))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result_index21 (mk_int__ref result_index9))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result__21 (mk_map__ref1 result__9))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index222 index29)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index17 index12)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result_index22 result_index9)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result__22 result__9)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index223 index221)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index18 index16)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result_index23 result_index21)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result__23 result__21)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index224 index222)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index19 index17)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result_index24 result_index22)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result__24 result__22)))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= index223 (mk_int__ref index2))))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= index18 (mk_int__ref index11))))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= result_index23 (mk_int__ref result_index1))))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= result__23 (mk_map__ref1 result__1))))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= index224 index21)))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= index19 index11)))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= result_index24 result_index1)))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= result__24 result__1)))
(assert (forall ((i5 Int)) (=> (and (<= (to_rep (first (rt array1))) i5) (<= i5 (to_rep (last (rt array1))))) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 (to_rep (last (rt array2))))) (= (to_rep (select (select (map__content1 result__23) (+ (+ (* (- i5 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) i5))))))))
(assert (<= (to_rep (first (rt array1))) i3))
(assert (<= i3 (to_rep (last (rt array1)))))
(assert (<= (to_rep (first (rt array2))) j7))
(assert (<= j7 (to_rep (last (rt array2)))))
(assert (and (<= (to_rep (first (rt array2))) j7) (<= j7 (to_rep (last (rt array2))))))
(assert (= o125 j7))
(assert (= o126 (select (elts array2) o125)))
(assert (= o127 (to_rep o126)))
(assert (and (= o120 (- j7 (to_rep (first (rt array2))))) (in_range1 (- j7 (to_rep (first (rt array2)))))))
(assert (and (= o117 (length array2)) (in_range1 (length array2))))
(assert (and (= o118 (- i3 (to_rep (first (rt array1))))) (in_range1 (- i3 (to_rep (first (rt array1)))))))
(assert (= o119 (* o118 o117)))
(assert (and (= o121 o119) (in_range1 o119)))
(assert (= o122 (+ o121 o120)))
(assert (and (= o123 o122) (in_range1 o122)))
(assert (= o124 (+ o123 1)))
(assert (and (= temp___279 o124) (in_range1 o124)))
(assert (not (<= (to_rep result____first) temp___279)))
(check-sat)
(exit)
