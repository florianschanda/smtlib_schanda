...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___173 a2)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___172 i1)))
...
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___174 Int)) (=> (and (<= 0 temp___174) (<= temp___174 30)) (=> (< i2 temp___174) (= (select a4 temp___174) (select temp___173 temp___174)))))) (and (<= 2 i2) (<= i2 30)))))
