...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___197 a2)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= temp___196 i1)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (= o4 (+ (to_rep (select a2 (- i1 1))) (to_rep (select a2 (- i1 2))))) (in_range1 (+ (to_rep (select a2 (- i1 1))) (to_rep (select a2 (- i1 2))))))))
...
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (and (= (to_rep (select a4 0)) 0) (= (to_rep (select a4 1)) 1)) (forall ((j Int)) (=> (and (<= 2 j) (<= j i2)) (= (to_rep (select a4 j)) (+ (to_rep (select a4 (- j 1))) (to_rep (select a4 (- j 2)))))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j i2)) (and (<= 0 (to_rep (select a4 j))) (< (to_rep (select a4 j)) (power 2 j))))))))
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___198 Int)) (=> (and (<= 0 temp___198) (<= temp___198 30)) (=> (< i2 temp___198) (= (select a4 temp___198) (select temp___197 temp___198)))))) (and (<= 2 i2) (<= i2 30)))))
...
(assert (=> (and (<= 2 i1) (<= i1 30)) (= (mk_int__ref i5) (mk_int__ref i3))))
...
(assert (= i8 i6))
(assert (= a10 a8))
(assert (not (= (to_rep (select a9 30)) 832040)))
(check-sat)
(exit)
