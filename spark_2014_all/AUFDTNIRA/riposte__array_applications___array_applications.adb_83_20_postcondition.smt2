...
(assert (= i1 2))
(assert (=> (and (<= 2 i1) (<= i1 30)) (and (and (= temp___173 a2) (and (= temp___172 i1) (and (and (and (and (and (= o4 (+ (to_rep (select a2 (- i1 1))) (to_rep (select a2 (- i1 2))))) (in_range1 (+ (to_rep (select a2 (- i1 1))) (to_rep (select a2 (- i1 2)))))) (= (to_rep o5) o4)) (= o6 (store a2 i1 o5))) (and (= a2 result3) (= a3 o6))) (and (and (and (and (= (to_rep (select a4 0)) 0) (= (to_rep (select a4 1)) 1)) (forall ((j2 Int)) (=> (and (<= 2 j2) (<= j2 i2)) (= (to_rep (select a4 j2)) (+ (to_rep (select a4 (- j2 1))) (to_rep (select a4 (- j2 2)))))))) (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 i2)) (and (<= 0 (to_rep (select a4 j2))) (< (to_rep (select a4 j2)) (power 2 j2)))))) (and (and (and (=> (<= 2 30) (in_range4 i2)) (forall ((temp___174 Int)) (=> (and (<= 0 temp___174) (<= temp___174 30)) (=> (< i2 temp___174) (= (select a4 temp___174) (select temp___173 temp___174)))))) (and (<= 2 i2) (<= i2 30))) (= i2 30)))))) (and (and (= i2 i6) (= a4 a8)) (and (= i7 i2) (= a9 a4))))))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= (mk_map__ref a10) (mk_map__ref a8))))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= i9 i7)))
(assert (=> (and (<= 2 i1) (<= i1 30)) (= a11 a9)))
(assert (=> (not (and (<= 2 i1) (<= i1 30))) (= i1 i8)))
(assert (=> (not (and (<= 2 i1) (<= i1 30))) (= a2 a10)))
(assert (=> (not (and (<= 2 i1) (<= i1 30))) (= i9 i1)))
(assert (=> (not (and (<= 2 i1) (<= i1 30))) (= a11 a2)))
(assert (= i10 i8))
(assert (= (mk_map__ref a12) (mk_map__ref a10)))
(assert (= i11 i9))
(assert (= a13 a11))
(assert (not (= (to_rep (select a12 30)) 832040)))
(check-sat)
(exit)
