...
(assert (forall ((x privileget)) (! (in_range19 (to_rep16 x)) :pattern ((to_rep16 x)))))
(assert (forall ((x Int)) (! (=> (in_range19 x) (= (to_rep16 (of_rep16 x)) x)) :pattern ((to_rep16 (of_rep16 x))))))
(declare-sort classt 0)
(define-fun in_range20 ((x Int)) Bool (and (<= 0 x) (<= x 5)))
...
(assert (forall ((x classt)) (! (in_range20 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(define-fun bool_eq15 ((a us_rep10) (b us_rep10)) Bool (ite (= (to_rep17 (rec__privtypes__clearancet__class (us_split_fields19 a))) (to_rep17 (rec__privtypes__clearancet__class (us_split_fields19 b)))) true false))
...
(declare-datatypes () ((us_split_fields20 (mk___split_fields10 (rec__cert__attr__priv__contentst__id us_rep1) (rec__cert__attr__priv__contentst__notbefore us_rep2) (rec__cert__attr__priv__contentst__notafter us_rep2) (rec__cert__attr__priv__contentst__mechanism algorithmt) (rec__cert__attr__priv__contentst__basecertid us_rep1) (rec__cert__attr__priv__contentst__role privileget) (rec__cert__attr__priv__contentst__clearance us_rep10)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields20)) us_rep1 (rec__cert__attr__priv__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields20)) us_rep2 (rec__cert__attr__priv__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields20)) us_rep2 (rec__cert__attr__priv__contentst__notafter a))
...
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields20)) us_rep1 (rec__cert__attr__priv__contentst__basecertid a))
...
(define-fun bool_eq16 ((a us_rep11) (b us_rep11)) Bool (ite (and (and (and (and (and (and (= (bool_eq2 (rec__cert__attr__priv__contentst__id (us_split_fields21 a)) (rec__cert__attr__priv__contentst__id (us_split_fields21 b))) true) (= (bool_eq3 (rec__cert__attr__priv__contentst__notbefore (us_split_fields21 a)) (rec__cert__attr__priv__contentst__notbefore (us_split_fields21 b))) true)) (= (bool_eq3 (rec__cert__attr__priv__contentst__notafter (us_split_fields21 a)) (rec__cert__attr__priv__contentst__notafter (us_split_fields21 b))) true)) (= (to_rep13 (rec__cert__attr__priv__contentst__mechanism (us_split_fields21 a))) (to_rep13 (rec__cert__attr__priv__contentst__mechanism (us_split_fields21 b))))) (= (bool_eq2 (rec__cert__attr__priv__contentst__basecertid (us_split_fields21 a)) (rec__cert__attr__priv__contentst__basecertid (us_split_fields21 b))) true)) (= (to_rep16 (rec__cert__attr__priv__contentst__role (us_split_fields21 a))) (to_rep16 (rec__cert__attr__priv__contentst__role (us_split_fields21 b))))) (= (bool_eq15 (rec__cert__attr__priv__contentst__clearance (us_split_fields21 a)) (rec__cert__attr__priv__contentst__clearance (us_split_fields21 b))) true)) true false))
...
(define-fun contentst__ref___4__projection ((a contentst__ref3)) us_rep11 (contentst__content3 a))
(declare-fun cert_attr_priv_to_cert (us_rep11) us_rep6)
(declare-fun cert_attr_priv_to_cert__function_guard (us_rep6 us_rep11) Bool)
(assert true)
(declare-fun cert_attr_priv_to_cert_attr (us_rep11) us_rep9)
(declare-fun cert_attr_priv_to_cert_attr__function_guard (us_rep9 us_rep11) Bool)
(assert true)
...
(declare-fun user_eq35 (certificatestatus certificatestatus) Bool)
(declare-const dummy35 certificatestatus)
...
(declare-fun to_rep18 (certificatestatus) Int)
(declare-fun of_rep18 (Int) certificatestatus)
(assert (forall ((x certificatestatus)) (! (= (of_rep18 (to_rep18 x)) x) :pattern ((to_rep18 x)))))
(assert (forall ((x certificatestatus)) (! (in_range21 (to_rep18 x)) :pattern ((to_rep18 x)))))
...
(define-fun bool_eq17 ((a us_rep12) (b us_rep12)) Bool (ite (and (and (= (rec__usertoken__valididcertt__valid (us_split_fields23 a)) (rec__usertoken__valididcertt__valid (us_split_fields23 b))) (= (to_rep18 (rec__usertoken__valididcertt__idstatus (us_split_fields23 a))) (to_rep18 (rec__usertoken__valididcertt__idstatus (us_split_fields23 b))))) (= (bool_eq13 (rec__usertoken__valididcertt__contents (us_split_fields23 a)) (rec__usertoken__valididcertt__contents (us_split_fields23 b))) true)) true false))
...
(declare-fun temp___String_Literal_2675 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2675 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 4)) 118)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 6)) 108)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 8)) 103)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 11)) 67)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 16)) 102)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 17)) 105)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 18)) 99)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 20)) 116)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 23)) 78)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 25)) 116)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 27)) 67)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 28)) 117)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 29)) 114)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 30)) 114)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 31)) 101)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 32)) 110)) (= (to_rep (select (temp___String_Literal_2675 us_void_param) 33)) 116)) :pattern ((temp___String_Literal_2675 us_void_param)))))
(declare-fun temp___String_Literal_2680 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2680 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 4)) 118)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 6)) 108)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 8)) 103)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 11)) 67)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 16)) 102)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 17)) 105)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 18)) 99)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 20)) 116)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 23)) 78)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 25)) 116)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 27)) 86)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 28)) 101)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 29)) 114)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 30)) 105)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 31)) 102)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 32)) 105)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 33)) 97)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 34)) 98)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 35)) 108)) (= (to_rep (select (temp___String_Literal_2680 us_void_param) 36)) 101)) :pattern ((temp___String_Literal_2680 us_void_param)))))
(declare-fun temp___String_Literal_2685 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2685 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 4)) 118)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 6)) 108)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 8)) 103)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 11)) 67)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 16)) 102)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 17)) 105)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 18)) 99)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 20)) 116)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 23)) 66)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 24)) 97)) (= (to_rep (select (temp___String_Literal_2685 us_void_param) 25)) 100)) :pattern ((temp___String_Literal_2685 us_void_param)))))
...
(define-fun dynamic_invariant3 ((temp___expr_2180 Int) (temp___is_init_2177 Bool) (temp___skip_constant_2178 Bool) (temp___do_toplevel_2179 Bool)) Bool (=> (or (= temp___is_init_2177 true) (<= 0 3)) (in_range21 temp___expr_2180)))
...
(define-fun dynamic_invariant10 ((temp___expr_578 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 1901 2099)) (in_range7 temp___expr_578)))
(define-fun dynamic_invariant11 ((temp___expr_584 Int) (temp___is_init_581 Bool) (temp___skip_constant_582 Bool) (temp___do_toplevel_583 Bool)) Bool (=> (or (= temp___is_init_581 true) (<= 1 12)) (in_range8 temp___expr_584)))
(define-fun dynamic_invariant12 ((temp___expr_590 Int) (temp___is_init_587 Bool) (temp___skip_constant_588 Bool) (temp___do_toplevel_589 Bool)) Bool (=> (or (= temp___is_init_587 true) (<= 1 31)) (in_range9 temp___expr_590)))
(define-fun dynamic_invariant13 ((temp___expr_614 Int) (temp___is_init_611 Bool) (temp___skip_constant_612 Bool) (temp___do_toplevel_613 Bool)) Bool (=> (or (= temp___is_init_611 true) (<= 0 86399999)) (in_range10 temp___expr_614)))
(define-fun dynamic_invariant14 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 40)) (in_range2 temp___expr_319)))
(define-fun dynamic_invariant15 ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 0 4294967295)) (in_range3 temp___expr_340)))
(define-fun dynamic_invariant16 ((temp___expr_362 Int) (temp___is_init_359 Bool) (temp___skip_constant_360 Bool) (temp___do_toplevel_361 Bool)) Bool (=> (or (= temp___is_init_359 true) (<= 0 10)) (in_range16 temp___expr_362)))
(define-fun dynamic_invariant17 ((temp___expr_374 Int) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool)) Bool (=> (or (= temp___is_init_371 true) (<= 0 4294967295)) (in_range17 temp___expr_374)))
(define-fun dynamic_invariant18 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 128)) (in_range18 temp___expr_380)))
(define-fun dynamic_invariant19 ((temp___expr_489 Int) (temp___is_init_486 Bool) (temp___skip_constant_487 Bool) (temp___do_toplevel_488 Bool)) Bool (=> (or (= temp___is_init_486 true) (<= 0 3)) (in_range19 temp___expr_489)))
(define-fun dynamic_invariant20 ((temp___expr_501 Int) (temp___is_init_498 Bool) (temp___skip_constant_499 Bool) (temp___do_toplevel_500 Bool)) Bool (=> (or (= temp___is_init_498 true) (<= 0 5)) (in_range20 temp___expr_501)))
(define-fun dynamic_invariant21 ((temp___expr_465 Int) (temp___is_init_462 Bool) (temp___skip_constant_463 Bool) (temp___do_toplevel_464 Bool)) Bool (=> (or (= temp___is_init_462 true) (<= 0 4294967295)) (in_range4 temp___expr_465)))
...
(declare-const privcertcontents__split_fields us_split_fields__ref10)
...
(declare-const privcertcontents__split_fields1 us_split_fields20)
...
(declare-const privcertcontents__split_fields2 us_split_fields20)
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= o1 (cert_attr_priv_to_cert_attr (mk___rep10 (let ((subject privcertcontents__split_fields)) privcertcontents__split_fields2)))))))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= o5 (cert_attr_priv_to_cert (mk___rep10 (let ((subject privcertcontents__split_fields)) privcertcontents__split_fields2)))))))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= o6 (cert_attr_priv_to_cert (mk___rep10 (let ((subject privcertcontents__split_fields)) privcertcontents__split_fields2)))))))
...
(assert (=> (not (= certfound true)) (= (let ((subject privcertcontents__split_fields)) (mk___split_fields__ref10 privcertcontents__split_fields2)) privcertcontents__split_fields)))
...
(assert (=> (not (= certfound true)) (= privcertcontents__split_fields2 privcertcontents__split_fields1)))
...
(assert (= privvalid1 (ite (= (ite (= (ite (= (ite (= certfound true) extractok2 false) true) baseidmatches2 false) true) verified2 false) true) current2 false)))
...
(assert (= result__3 nodescription))
