...
(assert (= result6 true))
(assert (and (= o14 (isdoingop (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (= (= o14 true) (in_range8 (to_rep4 (rec__admin__t__currentop (us_split_fields__content1 theadmin__split_fields4)))))))
(assert (= o15 (ite (not (= o14 true)) true false)))
(assert (and (= result7 (isdoingop (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (= (= result7 true) (in_range8 (to_rep4 (rec__admin__t__currentop (us_split_fields__content1 theadmin__split_fields4)))))))
(assert (= result7 true))
