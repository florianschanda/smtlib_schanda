...
(define-fun dynamic_invariant3 ((temp___expr_310 us_t1) (temp___is_init_307 Bool) (temp___skip_constant_308 Bool) (temp___do_toplevel_309 Bool)) Bool (and (=> (not (= temp___skip_constant_308 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_310) (last3 temp___expr_310))) (=> (= temp___do_toplevel_309 true) (=> (= temp___is_init_307 true) (and (let ((temp___312 (of_array2 (to_array1 temp___expr_310) (first3 temp___expr_310) (last3 temp___expr_310)))) (and (= (first5 temp___312) 1) (<= 0 (last5 temp___312)))) (<= (last3 temp___expr_310) 1000))))))
(define-fun dynamic_predicate ((temp___314 us_t1)) Bool (and (let ((temp___316 (of_array2 (to_array1 temp___314) (first3 temp___314) (last3 temp___314)))) (and (= (first5 temp___316) 1) (<= 0 (last5 temp___316)))) (<= (last3 temp___314) 1000)))
...
(declare-fun temp___1106 (Int) (Array Int logfileindext))
(assert (forall ((temp___1108 Int)) (forall ((temp___1109 Int)) (= (select (temp___1106 temp___1108) temp___1109) (of_rep7 temp___1108)))))
(declare-fun temp___1110 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1112 Int)) (forall ((temp___1113 Int)) (= (select (temp___1110 temp___1112) temp___1113) (of_rep10 temp___1112)))))
(define-fun dynamic_invariant4 ((temp___expr_1100 us_rep4) (temp___is_init_1097 Bool) (temp___skip_constant_1098 Bool) (temp___do_toplevel_1099 Bool)) Bool (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1100))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1100))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1100)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1100))) true))
(define-fun default_initial_assumption ((temp___expr_1104 us_rep4) (temp___skip_top_level_1105 Bool)) Bool (and (and (and (= (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1104))) 1) (= (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1104))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1104)) (mk___rep2 (mk___split_fields2 (temp___1106 1) (of_rep7 1) (of_rep7 1) (of_rep9 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1104)) (temp___1110 0))))
(define-fun type_invariant ((temp___1114 us_rep4)) Bool (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1114))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1114))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1114)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1114))) true))
...
(declare-fun temp___String_Literal_1633 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1633 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 13)) 99)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 15)) 117)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 16)) 108)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 17)) 100)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 19)) 110)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 20)) 111)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 21)) 116)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 23)) 98)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 26)) 118)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 27)) 101)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 28)) 114)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 29)) 105)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 30)) 102)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 31)) 105)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1633 us_void_param) 33)) 100)) :pattern ((temp___String_Literal_1633 us_void_param)))))
(declare-fun temp___String_Literal_1635 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1635 us_void_param) 1)) 75) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 5)) 99)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 7)) 117)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 8)) 108)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 9)) 100)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 11)) 110)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 15)) 98)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 18)) 97)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 19)) 100)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 20)) 100)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 22)) 100)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 25)) 111)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 27)) 116)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 28)) 104)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 29)) 101)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 31)) 75)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 33)) 121)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 35)) 83)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 36)) 116)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 37)) 111)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 38)) 114)) (= (to_rep (select (temp___String_Literal_1635 us_void_param) 39)) 101)) :pattern ((temp___String_Literal_1635 us_void_param)))))
(declare-fun temp___String_Literal_1637 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1637 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 13)) 99)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 15)) 110)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 16)) 116)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 18)) 110)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 20)) 115)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 23)) 111)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 24)) 117)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 25)) 108)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 26)) 100)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 28)) 110)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 29)) 111)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 30)) 116)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 32)) 98)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 33)) 101)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 35)) 101)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 36)) 120)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 37)) 116)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 38)) 114)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 39)) 97)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 40)) 99)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 41)) 116)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 42)) 101)) (= (to_rep (select (temp___String_Literal_1637 us_void_param) 43)) 100)) :pattern ((temp___String_Literal_1637 us_void_param)))))
...
(define-fun dynamic_invariant8 ((temp___expr_276 us_t2) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool)) Bool (and (=> (not (= temp___skip_constant_274 true)) (dynamic_property2 1 2147483647 (first5 temp___expr_276) (last5 temp___expr_276))) (=> (= temp___do_toplevel_275 true) (=> (= temp___is_init_273 true) (and (= (first5 temp___expr_276) 1) (<= 0 (last5 temp___expr_276)))))))
(define-fun dynamic_predicate1 ((temp___279 us_t2)) Bool (and (= (first5 temp___279) 1) (<= 0 (last5 temp___279))))
(define-fun dynamic_invariant9 ((temp___expr_1066 Int) (temp___is_init_1063 Bool) (temp___skip_constant_1064 Bool) (temp___do_toplevel_1065 Bool)) Bool (=> (or (= temp___is_init_1063 true) (<= 0 17)) (in_range13 temp___expr_1066)))
(define-fun dynamic_invariant10 ((temp___expr_1045 Int) (temp___is_init_1042 Bool) (temp___skip_constant_1043 Bool) (temp___do_toplevel_1044 Bool)) Bool (=> (or (= temp___is_init_1042 true) (<= 1 17)) (in_range11 temp___expr_1045)))
(define-fun dynamic_invariant11 ((temp___expr_1170 Int) (temp___is_init_1167 Bool) (temp___skip_constant_1168 Bool) (temp___do_toplevel_1169 Bool)) Bool (=> (or (= temp___is_init_1167 true) (<= 0 2)) (in_range15 temp___expr_1170)))
(define-fun dynamic_invariant12 ((temp___expr_1051 Int) (temp___is_init_1048 Bool) (temp___skip_constant_1049 Bool) (temp___do_toplevel_1050 Bool)) Bool (=> (or (= temp___is_init_1048 true) (<= 0 17408)) (in_range12 temp___expr_1051)))
(define-fun dynamic_invariant13 ((temp___expr_1085 Int) (temp___is_init_1082 Bool) (temp___skip_constant_1083 Bool) (temp___do_toplevel_1084 Bool)) Bool (=> (or (= temp___is_init_1082 true) (<= 0 1024)) (in_range14 temp___expr_1085)))
(assert true)
...
(define-fun dynamic_invariant14 ((temp___expr_434 Int) (temp___is_init_431 Bool) (temp___skip_constant_432 Bool) (temp___do_toplevel_433 Bool)) Bool (=> (or (= temp___is_init_431 true) (<= 1901 2099)) (in_range17 temp___expr_434)))
(define-fun dynamic_invariant15 ((temp___expr_440 Int) (temp___is_init_437 Bool) (temp___skip_constant_438 Bool) (temp___do_toplevel_439 Bool)) Bool (=> (or (= temp___is_init_437 true) (<= 1 12)) (in_range18 temp___expr_440)))
(define-fun dynamic_invariant16 ((temp___expr_446 Int) (temp___is_init_443 Bool) (temp___skip_constant_444 Bool) (temp___do_toplevel_445 Bool)) Bool (=> (or (= temp___is_init_443 true) (<= 1 31)) (in_range19 temp___expr_446)))
(define-fun dynamic_invariant17 ((temp___expr_474 Int) (temp___is_init_471 Bool) (temp___skip_constant_472 Bool) (temp___do_toplevel_473 Bool)) Bool (=> (or (= temp___is_init_471 true) (<= 0 86399999)) (in_range20 temp___expr_474)))
(define-fun dynamic_invariant18 ((temp___expr_852 Int) (temp___is_init_849 Bool) (temp___skip_constant_850 Bool) (temp___do_toplevel_851 Bool)) Bool (=> (or (= temp___is_init_849 true) (<= 0 40)) (in_range7 temp___expr_852)))
(define-fun dynamic_invariant19 ((temp___expr_873 Int) (temp___is_init_870 Bool) (temp___skip_constant_871 Bool) (temp___do_toplevel_872 Bool)) Bool (=> (or (= temp___is_init_870 true) (<= 0 4294967295)) (in_range6 temp___expr_873)))
(define-fun dynamic_invariant20 ((temp___expr_895 Int) (temp___is_init_892 Bool) (temp___skip_constant_893 Bool) (temp___do_toplevel_894 Bool)) Bool (=> (or (= temp___is_init_892 true) (<= 0 10)) (in_range8 temp___expr_895)))
(define-fun dynamic_invariant21 ((temp___expr_907 Int) (temp___is_init_904 Bool) (temp___skip_constant_905 Bool) (temp___do_toplevel_906 Bool)) Bool (=> (or (= temp___is_init_904 true) (<= 0 4294967295)) (in_range9 temp___expr_907)))
(define-fun dynamic_invariant22 ((temp___expr_913 Int) (temp___is_init_910 Bool) (temp___skip_constant_911 Bool) (temp___do_toplevel_912 Bool)) Bool (=> (or (= temp___is_init_910 true) (<= 0 128)) (in_range10 temp___expr_913)))
(define-fun dynamic_invariant23 ((temp___expr_1266 Int) (temp___is_init_1263 Bool) (temp___skip_constant_1264 Bool) (temp___do_toplevel_1265 Bool)) Bool (=> (or (= temp___is_init_1263 true) (<= 1 4096)) (in_range16 temp___expr_1266)))
(assert (= nullrawcertificate (certtypes__nullrawcertificate__aggregate_def 32)))
(define-fun dynamic_invariant24 ((temp___expr_1324 Int) (temp___is_init_1321 Bool) (temp___skip_constant_1322 Bool) (temp___do_toplevel_1323 Bool)) Bool (=> (or (= temp___is_init_1321 true) (<= 0 4294967295)) (in_range21 temp___expr_1324)))
...
(declare-const temp___1629 (Array Int character))
(declare-const temp___1628 Int)
(declare-const temp___1627 us_rep)
(declare-const o2 integer)
(declare-const o3 integer)
(declare-const o4 Bool)
(declare-const o5 Bool)
(declare-const o6 Bool)
(declare-const temp___1630 us_rep1)
(declare-const o7 us_rep8)
(declare-const temp___1631 us_rep1)
(declare-const temp___1632 us_rep2)
(declare-const o8 us_rep8)
(declare-const temp___1638 us_t1)
(declare-const o9 us_t1)
(declare-const o10 (Array Int character))
(declare-const temp___1636 us_t1)
(declare-const o11 us_t1)
(declare-const o12 (Array Int character))
(declare-const temp___1634 us_t1)
...
(assert (=> (= result5 true) (= temp___1629 thecert1)))
(assert (=> (= result5 true) (= temp___1628 (let ((subject stop)) stop1))))
(assert (=> (= result5 true) (= temp___1627 thefile)))
...
(assert (= temp___1630 (thesubject (mk___rep8 (let ((subject thecontents__split_fields)) thecontents__split_fields1)))))
...
(assert (= theissuer__split_fields3 (us_split_fields1 temp___1631)))
(assert (= temp___1632 (thepublickey (mk___rep8 (let ((subject thecontents__split_fields)) thecontents__split_fields1)))))
(assert (= result10 thepublickey__split_fields))
(assert (= (let ((subject thepublickey__split_fields)) thepublickey__split_fields1) (us_split_fields3 temp___1632)))
...
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= temp___1638 (mk___t1 (temp___String_Literal_1637 Tuple0) (mk1 1 43)))))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (dynamic_predicate temp___1638)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= o9 temp___1638)))
...
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (bool__content addedok11) true)) (dynamic_property1 1 2147483647 1 39))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (bool__content addedok11) true)) (= temp___1636 (mk___t1 (temp___String_Literal_1635 Tuple0) (mk1 1 39))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (bool__content addedok11) true)) (dynamic_predicate temp___1636))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (bool__content addedok11) true)) (= o11 temp___1636))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (bool__content addedok11) true)) (= o12 (makedescription o11 certno)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (bool__content addedok11) true)) (= result12 (mk_map__ref description1)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (bool__content addedok11) true)) (= description3 o12))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (bool__content addedok11) true)) (= description7 (mk_map__ref description3)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (bool__content addedok11) true)) (= description8 description3))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (not (= (bool__content verifiedok3) true)) (dynamic_property1 1 2147483647 1 33)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (not (= (bool__content verifiedok3) true)) (= temp___1634 (mk___t1 (temp___String_Literal_1633 Tuple0) (mk1 1 33)))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (not (= (bool__content verifiedok3) true)) (dynamic_predicate temp___1634)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (not (= (bool__content verifiedok3) true)) (= o13 temp___1634)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (not (= (bool__content verifiedok3) true)) (= o14 (makedescription o13 certno))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (not (= (bool__content verifiedok3) true)) (= result13 (mk_map__ref description1))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (not (= (bool__content verifiedok3) true)) (= description4 o14)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (not (= (bool__content verifiedok3) true)) (= description5 (mk_map__ref description4))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (not (= (bool__content verifiedok3) true)) (= description6 description4)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (= (bool__content verifiedok3) true) (= description5 (mk_map__ref description1))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (= (bool__content verifiedok3) true) (= description6 description1)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (= description7 description5))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (= description8 description6))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (= description9 description7)))
(assert (=> (= (let ((subject extracted)) extracted1) true) (= description10 description8)))
