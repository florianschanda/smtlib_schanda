...
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= temp___1582 (mk___t1 (temp___String_Literal_1581 Tuple0) (mk1 1 43)))))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (dynamic_predicate temp___1582)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= o9 temp___1582)))
...
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (bool__content addedok11) true)) (= temp___1580 (mk___t1 (temp___String_Literal_1579 Tuple0) (mk1 1 39))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (bool__content addedok11) true)) (dynamic_predicate temp___1580))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (bool__content addedok11) true)) (= o11 temp___1580))))
...
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (not (= (bool__content verifiedok3) true)) (= temp___1578 (mk___t1 (temp___String_Literal_1577 Tuple0) (mk1 1 33)))))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (not (= (bool__content verifiedok3) true)) (dynamic_predicate temp___1578)))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (bool__content addedok11) true) (=> (not (= (bool__content verifiedok3) true)) (= o13 temp___1578)))))
