...
(define-fun dynamic_invariant2 ((temp___expr_200 Int) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool) (temp___do_typ_inv_199 Bool)) Bool (=> (or (= temp___is_init_196 true) (<= 0 1)) (in_range5 temp___expr_200)))
(declare-sort t1 0)
...
(define-fun dynamic_invariant3 ((temp___expr_350 us_t1) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool) (temp___do_typ_inv_349 Bool)) Bool (and (=> (not (= temp___skip_constant_347 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_350) (last3 temp___expr_350))) (=> (= temp___do_toplevel_348 true) (=> (= temp___is_init_346 true) (and (let ((temp___352 (of_array2 (to_array1 temp___expr_350) (first3 temp___expr_350) (last3 temp___expr_350)))) (and (= (first5 temp___352) 1) (<= 0 (last5 temp___352)))) (<= (last3 temp___expr_350) 1000))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep7 (select a temp___idx_172)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep10 (select a temp___idx_173)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_1239 us_rep4) (temp___is_init_1235 Bool) (temp___skip_constant_1236 Bool) (temp___do_toplevel_1237 Bool) (temp___do_typ_inv_1238 Bool)) Bool (=> (= temp___do_typ_inv_1238 true) (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1239))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1239))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1239)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1239))) true)))
(define-fun default_initial_assumption ((temp___expr_1243 us_rep4) (temp___skip_top_level_1244 Bool)) Bool (and (and (and (= (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1243))) 1) (= (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1243))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1243)) (mk___rep2 (mk___split_fields2 (temp___1245 1) (of_rep7 1) (of_rep7 1) (of_rep9 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1243)) (temp___1249 0))))
(define-fun type_invariant ((temp___1253 us_rep4)) Bool (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1253))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1253))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1253)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1253))) true))
...
(define-fun bool_eq11 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq4 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq4 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true))))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq12 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep11 (select a temp___idx_175)) (to_rep11 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(declare-fun temp___String_Literal_1797 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1797 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 13)) 99)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 15)) 117)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 16)) 108)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 17)) 100)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 19)) 110)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 20)) 111)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 21)) 116)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 23)) 98)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 26)) 118)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 27)) 101)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 28)) 114)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 29)) 105)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 30)) 102)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 31)) 105)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1797 us_void_param) 33)) 100)) :pattern ((temp___String_Literal_1797 us_void_param)))))
(declare-fun temp___String_Literal_1799 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1799 us_void_param) 1)) 75) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 5)) 99)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 7)) 117)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 8)) 108)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 9)) 100)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 11)) 110)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 12)) 111)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 15)) 98)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 18)) 97)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 19)) 100)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 20)) 100)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 22)) 100)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 24)) 116)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 25)) 111)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 27)) 116)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 28)) 104)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 29)) 101)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 31)) 75)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 32)) 101)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 33)) 121)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 35)) 83)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 36)) 116)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 37)) 111)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 38)) 114)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 39)) 101)) :pattern ((temp___String_Literal_1799 us_void_param)))))
(declare-fun temp___String_Literal_1801 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1801 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 13)) 99)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 15)) 110)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 16)) 116)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 18)) 110)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 20)) 115)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 22)) 99)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 23)) 111)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 24)) 117)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 25)) 108)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 26)) 100)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 28)) 110)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 29)) 111)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 30)) 116)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 32)) 98)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 33)) 101)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 35)) 101)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 36)) 120)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 37)) 116)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 38)) 114)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 39)) 97)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 40)) 99)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 41)) 116)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 42)) 101)) (= (to_rep (select (temp___String_Literal_1801 us_void_param) 43)) 100)) :pattern ((temp___String_Literal_1801 us_void_param)))))
...
(define-fun dynamic_invariant9 ((temp___expr_1177 Int) (temp___is_init_1173 Bool) (temp___skip_constant_1174 Bool) (temp___do_toplevel_1175 Bool) (temp___do_typ_inv_1176 Bool)) Bool (=> (or (= temp___is_init_1173 true) (<= 0 17)) (in_range13 temp___expr_1177)))
(define-fun dynamic_invariant10 ((temp___expr_1184 Int) (temp___is_init_1180 Bool) (temp___skip_constant_1181 Bool) (temp___do_toplevel_1182 Bool) (temp___do_typ_inv_1183 Bool)) Bool (=> (or (= temp___is_init_1180 true) (<= 1 17)) (in_range11 temp___expr_1184)))
(define-fun dynamic_invariant11 ((temp___expr_1310 Int) (temp___is_init_1306 Bool) (temp___skip_constant_1307 Bool) (temp___do_toplevel_1308 Bool) (temp___do_typ_inv_1309 Bool)) Bool (=> (or (= temp___is_init_1306 true) (<= 0 2)) (in_range15 temp___expr_1310)))
(define-fun dynamic_invariant12 ((temp___expr_1191 Int) (temp___is_init_1187 Bool) (temp___skip_constant_1188 Bool) (temp___do_toplevel_1189 Bool) (temp___do_typ_inv_1190 Bool)) Bool (=> (or (= temp___is_init_1187 true) (<= 0 17408)) (in_range12 temp___expr_1191)))
(define-fun dynamic_invariant13 ((temp___expr_1222 Int) (temp___is_init_1218 Bool) (temp___skip_constant_1219 Bool) (temp___do_toplevel_1220 Bool) (temp___do_typ_inv_1221 Bool)) Bool (=> (or (= temp___is_init_1218 true) (<= 0 1024)) (in_range14 temp___expr_1222)))
(assert true)
...
(assert (forall ((temp___1251 Int)) (=> (dynamic_invariant13 temp___1251 true true true true) (forall ((temp___1252 Int)) (= (to_rep10 (select (temp___1249 temp___1251) temp___1252)) temp___1251)))))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___156 Int)) (=> (dynamic_invariant5 temp___156 true true true true) (forall ((temp___157 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___156) temp___157)) temp___156)))))
(define-fun dynamic_invariant14 ((temp___expr_486 Int) (temp___is_init_482 Bool) (temp___skip_constant_483 Bool) (temp___do_toplevel_484 Bool) (temp___do_typ_inv_485 Bool)) Bool (=> (or (= temp___is_init_482 true) (<= 1901 2099)) (in_range17 temp___expr_486)))
(define-fun dynamic_invariant15 ((temp___expr_493 Int) (temp___is_init_489 Bool) (temp___skip_constant_490 Bool) (temp___do_toplevel_491 Bool) (temp___do_typ_inv_492 Bool)) Bool (=> (or (= temp___is_init_489 true) (<= 1 12)) (in_range18 temp___expr_493)))
(define-fun dynamic_invariant16 ((temp___expr_500 Int) (temp___is_init_496 Bool) (temp___skip_constant_497 Bool) (temp___do_toplevel_498 Bool) (temp___do_typ_inv_499 Bool)) Bool (=> (or (= temp___is_init_496 true) (<= 1 31)) (in_range19 temp___expr_500)))
(define-fun dynamic_invariant17 ((temp___expr_532 Int) (temp___is_init_528 Bool) (temp___skip_constant_529 Bool) (temp___do_toplevel_530 Bool) (temp___do_typ_inv_531 Bool)) Bool (=> (or (= temp___is_init_528 true) (<= 0 86399999)) (in_range20 temp___expr_532)))
(define-fun dynamic_invariant18 ((temp___expr_960 Int) (temp___is_init_956 Bool) (temp___skip_constant_957 Bool) (temp___do_toplevel_958 Bool) (temp___do_typ_inv_959 Bool)) Bool (=> (or (= temp___is_init_956 true) (<= 0 40)) (in_range7 temp___expr_960)))
(define-fun dynamic_invariant19 ((temp___expr_984 Int) (temp___is_init_980 Bool) (temp___skip_constant_981 Bool) (temp___do_toplevel_982 Bool) (temp___do_typ_inv_983 Bool)) Bool (=> (or (= temp___is_init_980 true) (<= 0 4294967295)) (in_range6 temp___expr_984)))
(define-fun dynamic_invariant20 ((temp___expr_1008 Int) (temp___is_init_1004 Bool) (temp___skip_constant_1005 Bool) (temp___do_toplevel_1006 Bool) (temp___do_typ_inv_1007 Bool)) Bool (=> (or (= temp___is_init_1004 true) (<= 0 10)) (in_range8 temp___expr_1008)))
(define-fun dynamic_invariant21 ((temp___expr_1022 Int) (temp___is_init_1018 Bool) (temp___skip_constant_1019 Bool) (temp___do_toplevel_1020 Bool) (temp___do_typ_inv_1021 Bool)) Bool (=> (or (= temp___is_init_1018 true) (<= 0 4294967295)) (in_range9 temp___expr_1022)))
(define-fun dynamic_invariant22 ((temp___expr_1029 Int) (temp___is_init_1025 Bool) (temp___skip_constant_1026 Bool) (temp___do_toplevel_1027 Bool) (temp___do_typ_inv_1028 Bool)) Bool (=> (or (= temp___is_init_1025 true) (<= 0 128)) (in_range10 temp___expr_1029)))
(define-fun dynamic_invariant23 ((temp___expr_1418 Int) (temp___is_init_1414 Bool) (temp___skip_constant_1415 Bool) (temp___do_toplevel_1416 Bool) (temp___do_typ_inv_1417 Bool)) Bool (=> (or (= temp___is_init_1414 true) (<= 1 4096)) (in_range16 temp___expr_1418)))
(assert (= nullrawcertificate (certtypes__nullrawcertificate__aggregate_def 32)))
(assert (forall ((temp___187 Int)) (=> (dynamic_invariant5 temp___187 true true true true) (forall ((temp___188 Int)) (= (to_rep (select (certtypes__nullrawcertificate__aggregate_def temp___187) temp___188)) temp___187)))))
(define-fun dynamic_invariant24 ((temp___expr_1483 Int) (temp___is_init_1479 Bool) (temp___skip_constant_1480 Bool) (temp___do_toplevel_1481 Bool) (temp___do_typ_inv_1482 Bool)) Bool (=> (or (= temp___is_init_1479 true) (<= 0 4294967295)) (in_range21 temp___expr_1483)))
(assert (forall ((temp___1247 Int)) (=> (dynamic_invariant10 temp___1247 true true true true) (forall ((temp___1248 Int)) (= (to_rep7 (select (temp___1245 temp___1247) temp___1248)) temp___1247)))))
...
(declare-const temp___1793 (Array Int character))
(declare-const temp___1792 Int)
(declare-const temp___1791 us_rep)
(declare-const o2 integer)
(declare-const o3 integer)
(declare-const o4 Bool)
(declare-const o5 Bool)
(declare-const o6 Bool)
(declare-const temp___1794 us_rep1)
(declare-const o7 us_rep8)
(declare-const temp___1795 us_rep1)
(declare-const temp___1796 us_rep2)
(declare-const o8 us_rep8)
(declare-const temp___1802 us_t1)
(declare-const o9 us_t1)
(declare-const o10 (Array Int character))
(declare-const temp___1800 us_t1)
(declare-const o11 us_t1)
(declare-const o12 (Array Int character))
(declare-const temp___1798 us_t1)
...
(define-fun thistisinfo__split_fields18 () us_split_fields__ref4 (mk___split_fields__ref4 (mk___split_fields4 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3)))))
(define-fun auditsystemfault18 () bool__ref (mk_bool__ref auditsystemfault))
(define-fun auditalarm18 () int__ref (mk_int__ref auditalarm))
(define-fun logfilestate__split_fields24 () us_split_fields__ref3 (mk___split_fields__ref3 (mk___split_fields3 logfilestate__split_fields logfilestate__split_fields1 (mk___rep2 (mk___split_fields2 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6)))
(define-fun logfilesstatus18 () map__ref4 (mk_map__ref4 logfilesstatus))
(define-fun logfiles18 () map__ref3 (mk_map__ref3 logfiles))
...
(assert (= (let ((subject addedok)) addedok1) (distinct 1 0)))
(assert (= result2 verifiedok))
(assert (= (let ((subject verifiedok)) verifiedok1) (distinct 0 0)))
(assert (= result3 stop))
...
(assert (=> (= result5 true) (= temp___1793 thecert1)))
(assert (=> (= result5 true) (= temp___1792 (let ((subject stop)) stop1))))
(assert (=> (= result5 true) (= temp___1791 thefile)))
...
(assert (= temp___1794 (thesubject (mk___rep8 (let ((subject thecontents__split_fields)) thecontents__split_fields1)))))
...
(assert (= theissuer__split_fields3 (us_split_fields1 temp___1795)))
(assert (= temp___1796 (thepublickey (mk___rep8 (let ((subject thecontents__split_fields)) thecontents__split_fields1)))))
(assert (= result10 thepublickey__split_fields))
(assert (= (let ((subject thepublickey__split_fields)) thepublickey__split_fields1) (us_split_fields3 temp___1796)))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3))) (and (ite (= (ite (= (ite (= (let ((subject addedok)) addedok2) true) (ite (= (distinct 1 0) false) (privatekeypresent thistisinfo__split_fields5 (let ((subject state1)) state5)) false) false) false) (ite (= (let ((subject addedok)) addedok2) true) (ite (= (distinct 1 0) false) false (= (ite (privatekeypresent thistisinfo__split_fields5 (let ((subject state1)) state5)) 1 0) (ite (privatekeypresent (mk___split_fields4 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state1)) 1 0))) (= (ite (privatekeypresent thistisinfo__split_fields5 (let ((subject state1)) state5)) 1 0) (ite (privatekeypresent (mk___split_fields4 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state1)) 1 0))) true) true) (ite (= (ite (= (ite (= (let ((subject addedok)) addedok2) true) (ite (= (distinct 1 0) false) (privatekeypresent thistisinfo__split_fields5 (let ((subject state1)) state5)) false) false) true) (ite (= (let ((subject addedok)) addedok2) true) (ite (= (distinct 1 0) false) false (= (ite (privatekeypresent thistisinfo__split_fields5 (let ((subject state1)) state5)) 1 0) (ite (privatekeypresent (mk___split_fields4 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state1)) 1 0))) (= (ite (privatekeypresent thistisinfo__split_fields5 (let ((subject state1)) state5)) 1 0) (ite (privatekeypresent (mk___split_fields4 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state1)) 1 0))) false) false) true false) false) (and (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range5 auditalarm2))))))
...
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= thistisinfo__split_fields6 thistisinfo__split_fields18))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= auditsystemfault3 auditsystemfault18))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= auditalarm3 auditalarm18))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfilestate__split_fields9 logfilestate__split_fields24))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfilesstatus3 logfilesstatus18))))
(assert (=> (= (let ((subject extracted)) extracted1) true) (=> (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) (= logfiles3 logfiles18))))
...
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= thistisinfo__split_fields8 thistisinfo__split_fields18)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= auditsystemfault5 auditsystemfault18)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= auditalarm5 auditalarm18)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= logfilestate__split_fields11 logfilestate__split_fields24)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= logfilesstatus5 logfilesstatus18)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= logfiles5 logfiles18)))
...
(assert (=> (ite (= (bool__content verifiedok3) true) (not (= (to_rep2 (rec__cryptotypes__issuert__id thesubject__split_fields3)) (to_rep2 (rec__cryptotypes__issuert__id theissuer__split_fields3)))) false) (and (ite (= (ite (= (ite (= (let ((subject addedok)) addedok7) true) (ite (= (distinct 1 0) false) (privatekeypresent thistisinfo__split_fields10 (let ((subject state1)) state18)) false) false) false) (ite (= (let ((subject addedok)) addedok7) true) (ite (= (distinct 1 0) false) false (= (ite (privatekeypresent thistisinfo__split_fields10 (let ((subject state1)) state18)) 1 0) (ite (privatekeypresent (us_split_fields__content4 thistisinfo__split_fields8) (us_private__content state11)) 1 0))) (= (ite (privatekeypresent thistisinfo__split_fields10 (let ((subject state1)) state18)) 1 0) (ite (privatekeypresent (us_split_fields__content4 thistisinfo__split_fields8) (us_private__content state11)) 1 0))) true) true) (ite (= (ite (= (ite (= (let ((subject addedok)) addedok7) true) (ite (= (distinct 1 0) false) (privatekeypresent thistisinfo__split_fields10 (let ((subject state1)) state18)) false) false) true) (ite (= (let ((subject addedok)) addedok7) true) (ite (= (distinct 1 0) false) false (= (ite (privatekeypresent thistisinfo__split_fields10 (let ((subject state1)) state18)) 1 0) (ite (privatekeypresent (us_split_fields__content4 thistisinfo__split_fields8) (us_private__content state11)) 1 0))) (= (ite (privatekeypresent thistisinfo__split_fields10 (let ((subject state1)) state18)) 1 0) (ite (privatekeypresent (us_split_fields__content4 thistisinfo__split_fields8) (us_private__content state11)) 1 0))) false) false) true false) false) (and (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields16)) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields16)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields16) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields16)) true) (in_range5 auditalarm10)))))
...
(assert (=> (= (ite (= (ite (= (bool__content verifiedok3) true) (bool__content addedok8) false) true) istis false) true) (and (ite (= (ite (= (ite (= (let ((subject addedok)) addedok10) true) (ite (= (distinct 0 0) false) (privatekeypresent thistisinfo__split_fields13 (let ((subject state1)) state24)) false) false) false) (ite (= (let ((subject addedok)) addedok10) true) (ite (= (distinct 0 0) false) false (= (ite (privatekeypresent thistisinfo__split_fields13 (let ((subject state1)) state24)) 1 0) (ite (privatekeypresent (us_split_fields__content4 thistisinfo__split_fields11) (us_private__content state20)) 1 0))) (= (ite (privatekeypresent thistisinfo__split_fields13 (let ((subject state1)) state24)) 1 0) (ite (privatekeypresent (us_split_fields__content4 thistisinfo__split_fields11) (us_private__content state20)) 1 0))) true) true) (ite (= (ite (= (ite (= (let ((subject addedok)) addedok10) true) (ite (= (distinct 0 0) false) (privatekeypresent thistisinfo__split_fields13 (let ((subject state1)) state24)) false) false) true) (ite (= (let ((subject addedok)) addedok10) true) (ite (= (distinct 0 0) false) false (= (ite (privatekeypresent thistisinfo__split_fields13 (let ((subject state1)) state24)) 1 0) (ite (privatekeypresent (us_split_fields__content4 thistisinfo__split_fields11) (us_private__content state20)) 1 0))) (= (ite (privatekeypresent thistisinfo__split_fields13 (let ((subject state1)) state24)) 1 0) (ite (privatekeypresent (us_split_fields__content4 thistisinfo__split_fields11) (us_private__content state20)) 1 0))) false) false) true false) false) (and (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields19)) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields19)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields19) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields19)) true) (in_range5 auditalarm13)))))
...
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (dynamic_property1 1 2147483647 1 43)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= temp___1802 (mk___t1 (temp___String_Literal_1801 Tuple0) (mk1 1 43)))))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (dynamic_predicate temp___1802)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= o9 temp___1802)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= o10 (makedescription o9 certno))))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= result11 (mk_map__ref description1))))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= description2 o10)))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= description9 (mk_map__ref description2))))
(assert (=> (not (= (let ((subject extracted)) extracted1) true)) (= description10 description2)))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (= (bool__content addedok11) true)) (dynamic_property1 1 2147483647 1 39))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (= (bool__content addedok11) true)) (= temp___1800 (mk___t1 (temp___String_Literal_1799 Tuple0) (mk1 1 39))))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (= (bool__content addedok11) true)) (dynamic_predicate temp___1800))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (= (bool__content addedok11) true)) (= o11 temp___1800))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (= (bool__content addedok11) true)) (= o12 (makedescription o11 certno)))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (= (bool__content addedok11) true)) (= result12 (mk_map__ref description1)))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (= (bool__content addedok11) true)) (= description3 o12))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (= (bool__content addedok11) true)) (= description7 (mk_map__ref description3)))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (= (bool__content addedok11) true)) (= description8 description3))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (dynamic_property1 1 2147483647 1 33)))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= temp___1798 (mk___t1 (temp___String_Literal_1797 Tuple0) (mk1 1 33)))))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (dynamic_predicate temp___1798)))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= o13 temp___1798)))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= o14 (makedescription o13 certno))))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= result13 (mk_map__ref description1))))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= description4 o14)))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= description5 (mk_map__ref description4))))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (= (bool__content verifiedok3) true)) (= description6 description4)))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (not (= (bool__content verifiedok3) true))) (= description5 (mk_map__ref description1))))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (=> (not (not (= (bool__content verifiedok3) true))) (= description6 description1)))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (= description7 description5))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (=> (not (not (= (bool__content addedok11) true))) (= description8 description6))))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (= description9 description7)))
(assert (=> (not (not (= (let ((subject extracted)) extracted1) true))) (= description10 description8)))
(assert (= result14 (mk_bool__ref keyadded)))
(assert (= keyadded1 (ite (= (bool__content verifiedok3) true) (bool__content addedok11) false)))
...
(assert (= extracted2 (let ((subject extracted)) (mk_bool__ref extracted1))))
(assert (= thepublickey__split_fields2 (let ((subject thepublickey__split_fields)) (mk___split_fields__ref1 thepublickey__split_fields1))))
(assert (= theissuer__split_fields4 (mk___split_fields__ref theissuer__split_fields3)))
(assert (= thesubject__split_fields4 (mk___split_fields__ref thesubject__split_fields3)))
(assert (= thecontents__split_fields2 (let ((subject thecontents__split_fields)) (mk___split_fields__ref8 thecontents__split_fields1))))
(assert (= thecert8 thecert6))
(assert (= description11 description9))
(assert (= keyadded2 (mk_bool__ref keyadded1)))
(assert (= thefile8 thefile6))
(assert (= thistisinfo__split_fields16 thistisinfo__split_fields14))
(assert (= auditsystemfault16 auditsystemfault14))
(assert (= auditalarm16 auditalarm14))
(assert (= logfilestate__split_fields22 logfilestate__split_fields20))
(assert (= logfilesstatus16 logfilesstatus14))
(assert (= logfiles16 logfiles14))
...
(assert (= extracted3 extracted1))
(assert (= thepublickey__split_fields3 thepublickey__split_fields1))
...
(assert (= thistisinfo__split_fields17 thistisinfo__split_fields15))
(assert (= auditsystemfault17 auditsystemfault15))
(assert (= auditalarm17 auditalarm15))
(assert (= logfilestate__split_fields23 logfilestate__split_fields21))
(assert (= logfilesstatus17 logfilesstatus15))
(assert (= logfiles17 logfiles15))
(assert (= istis true))
(assert (= (bool__content keyadded2) true))
(assert (not (= (privatekeypresent (us_split_fields__content4 thistisinfo__split_fields16) (us_private__content state30)) true)))
(check-sat)
(exit)
