...
(assert (=> (and (<= (to_rep h__first) q1) (<= q1 r30b)) (forall ((k Int)) (=> (and (<= (to_rep h__first) k) (<= k (to_rep h__last))) (ite (< k q2) (= (to_rep1 (select h2 k)) (to_rep1 (select temp___528 (+ k m1)))) (ite (< (+ q2 m1) k) (= (to_rep1 (select h2 k)) (to_rep1 (select temp___530 (- k m1)))) (= (to_rep1 (select h2 k)) (to_rep1 (select temp___532 k)))))))))
...
(assert (not (<= k (div1 (to_rep h__last) 2))))
(assert (not (= (to_rep1 (select h9 k)) (to_rep1 (select h (- k (div1 (to_rep h__last) 2)))))))
(check-sat)
(exit)
