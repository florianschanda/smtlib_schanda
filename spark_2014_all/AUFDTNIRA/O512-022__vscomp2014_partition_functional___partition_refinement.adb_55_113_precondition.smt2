...
(assert (and (= o7 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o7) (= o7 (ite (= (distinct 1 0) true) (to_rep3 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o5 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o5) (<= o5 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
(assert (= o6 (* 2 o5)))
(assert (and (= o8 o6) (in_range1 o6)))
(assert (= result (ite (<= o8 o7) true false)))
(assert (= result true))
(assert (and (= o4 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o4) (<= o4 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
