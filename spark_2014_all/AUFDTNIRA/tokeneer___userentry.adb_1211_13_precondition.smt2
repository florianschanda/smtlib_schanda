...
(assert (= (islocked currentlatch (us_private__content state) (mk___split_fields latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) true))
(assert (= (thecurrentdoor (us_private__content state1)) 0))
(assert (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime)) (alarm_timeout (us_private__content state1))) true))
(assert (not (= (thedooralarm (us_private__content state1)) 0)))
(check-sat)
(exit)
