...
(assert (not (in_range8 (- (to_rep1 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields32))))) 1))))
(check-sat)
(exit)
