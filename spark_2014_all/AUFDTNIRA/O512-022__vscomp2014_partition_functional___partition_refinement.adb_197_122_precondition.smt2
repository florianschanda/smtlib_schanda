...
(assert (<= (+ (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields5)) 1) k12))
(assert (<= k12 5))
(assert (and (<= 0 k12) (<= k12 5)))
(assert (= o130 k12))
(assert (= o131 (select (map__content f8) o130)))
(assert (= o132 (to_rep2 o131)))
(assert (not (<= 0 o132)))
(check-sat)
(exit)
