...
(assert (<= (+ (to_rep2 (rec__partition_refinement__interval__last p_prime__split_fields1)) 1) k))
(assert (<= k 5))
(assert (and (<= 0 k) (<= k 5)))
(assert (= o11 k))
(assert (= o12 (select (map__content f6) o11)))
(assert (= o13 (to_rep3 o12)))
(assert (not (<= o13 (last (model__ (mk___rep p__split_discrs p__split_fields3))))))
(check-sat)
(exit)
