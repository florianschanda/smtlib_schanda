...
(declare-const o15 partition_index)
...
(assert (<= (+ (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields1)) 1) k))
(assert (<= k 5))
(assert (and (<= 0 k) (<= k 5)))
(assert (= o14 k))
(assert (= o15 (select (map__content f6) o14)))
(assert (= o16 (to_rep2 o15)))
(assert (not (<= 0 o16)))
(check-sat)
(exit)
