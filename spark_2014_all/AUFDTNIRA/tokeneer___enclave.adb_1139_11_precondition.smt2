...
(define-fun in_range22 ((x Int)) Bool (and (<= 0 x) (<= x 5)))
...
(declare-fun user_eq29 (classt classt) Bool)
(declare-const dummy29 classt)
...
(assert (forall ((x classt)) (! (in_range22 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(declare-fun user_eq30 (us_rep5 us_rep5) Bool)
(declare-const dummy30 us_rep5)
...
(assert (forall ((x algorithmt)) (! (in_range23 (to_rep14 x)) :pattern ((to_rep14 x)))))
(assert (forall ((x Int)) (! (=> (in_range23 x) (= (to_rep14 (of_rep14 x)) x)) :pattern ((to_rep14 (of_rep14 x))))))
(declare-sort namecountt 0)
(define-fun in_range24 ((x Int)) Bool (and (<= 0 x) (<= x 40)))
...
(declare-fun user_eq32 (namecountt namecountt) Bool)
(declare-const dummy32 namecountt)
...
(assert (forall ((x namecountt)) (! (in_range24 (to_rep15 x)) :pattern ((to_rep15 x)))))
(assert (forall ((x Int)) (! (=> (in_range24 x) (= (to_rep15 (of_rep15 x)) x)) :pattern ((to_rep15 (of_rep15 x))))))
(declare-const dummy33 (Array Int character))
...
(declare-fun user_eq33 ((Array Int character) (Array Int character)) Bool)
...
(declare-fun user_eq34 (issueridt issueridt) Bool)
(declare-const dummy34 issueridt)
...
(assert (forall ((x issueridt)) (! (in_range25 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(declare-fun user_eq35 (us_rep6 us_rep6) Bool)
(declare-const dummy35 us_rep6)
...
(declare-fun user_eq36 (serialnumbert serialnumbert) Bool)
(declare-const dummy36 serialnumbert)
...
(declare-fun user_eq37 (us_rep7 us_rep7) Bool)
(declare-const dummy37 us_rep7)
...
(declare-fun user_eq40 (keyidt keyidt) Bool)
(declare-const dummy40 keyidt)
...
(declare-fun user_eq41 (keylengtht keylengtht) Bool)
(declare-const dummy41 keylengtht)
...
(declare-fun user_eq45 (t1 t1) Bool)
(declare-const dummy45 t1)
(declare-datatypes () ((t__ref2 (mk_t__ref2 (t__content2 t1)))))
(define-fun t__ref___3__projection ((a t__ref2)) t1 (t__content2 a))
(define-fun dynamic_invariant7 ((temp___expr_2160 Int) (temp___is_init_2156 Bool) (temp___skip_constant_2157 Bool) (temp___do_toplevel_2158 Bool) (temp___do_typ_inv_2159 Bool)) Bool (=> (or (= temp___is_init_2156 true) (<= 0 1)) (in_range29 temp___expr_2160)))
...
(declare-sort t2 0)
(define-fun in_range30 ((x Int)) Bool (and (<= 0 x) (<= x 1)))
...
(declare-fun user_eq46 (t2 t2) Bool)
(declare-const dummy46 t2)
(declare-datatypes () ((t__ref3 (mk_t__ref3 (t__content3 t2)))))
(define-fun t__ref___4__projection ((a t__ref3)) t2 (t__content3 a))
(define-fun dynamic_invariant8 ((temp___expr_2183 Int) (temp___is_init_2179 Bool) (temp___skip_constant_2180 Bool) (temp___do_toplevel_2181 Bool) (temp___do_typ_inv_2182 Bool)) Bool (=> (or (= temp___is_init_2179 true) (<= 0 1)) (in_range30 temp___expr_2183)))
...
(define-fun in_range31 ((x Int)) Bool (and (<= 0 x) (<= x 8)))
...
(define-fun dynamic_invariant9 ((temp___expr_2874 Int) (temp___is_init_2870 Bool) (temp___skip_constant_2871 Bool) (temp___do_toplevel_2872 Bool) (temp___do_typ_inv_2873 Bool)) Bool (=> (or (= temp___is_init_2870 true) (<= 0 8)) (in_range31 temp___expr_2874)))
...
(define-fun dynamic_invariant15 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range8 temp___expr_433)))
(define-fun dynamic_invariant16 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range22 temp___expr_440)))
(define-fun dynamic_invariant17 ((temp___expr_1099 Int) (temp___is_init_1095 Bool) (temp___skip_constant_1096 Bool) (temp___do_toplevel_1097 Bool) (temp___do_typ_inv_1098 Bool)) Bool (=> (or (= temp___is_init_1095 true) (<= 0 40)) (in_range24 temp___expr_1099)))
(define-fun dynamic_invariant18 ((temp___expr_1123 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool) (temp___do_typ_inv_1122 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 4294967295)) (in_range25 temp___expr_1123)))
(define-fun dynamic_invariant19 ((temp___expr_1147 Int) (temp___is_init_1143 Bool) (temp___skip_constant_1144 Bool) (temp___do_toplevel_1145 Bool) (temp___do_typ_inv_1146 Bool)) Bool (=> (or (= temp___is_init_1143 true) (<= 0 10)) (in_range23 temp___expr_1147)))
(define-fun dynamic_invariant20 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 4294967295)) (in_range27 temp___expr_1161)))
(define-fun dynamic_invariant21 ((temp___expr_1168 Int) (temp___is_init_1164 Bool) (temp___skip_constant_1165 Bool) (temp___do_toplevel_1166 Bool) (temp___do_typ_inv_1167 Bool)) Bool (=> (or (= temp___is_init_1164 true) (<= 0 128)) (in_range28 temp___expr_1168)))
(define-fun dynamic_invariant22 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 0 17)) (in_range17 temp___expr_1283)))
(define-fun dynamic_invariant23 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 1 17)) (in_range15 temp___expr_1290)))
(define-fun dynamic_invariant24 ((temp___expr_1416 Int) (temp___is_init_1412 Bool) (temp___skip_constant_1413 Bool) (temp___do_toplevel_1414 Bool) (temp___do_typ_inv_1415 Bool)) Bool (=> (or (= temp___is_init_1412 true) (<= 0 2)) (in_range19 temp___expr_1416)))
(define-fun dynamic_invariant25 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 17408)) (in_range16 temp___expr_1297)))
(define-fun dynamic_invariant26 ((temp___expr_1328 Int) (temp___is_init_1324 Bool) (temp___skip_constant_1325 Bool) (temp___do_toplevel_1326 Bool) (temp___do_typ_inv_1327 Bool)) Bool (=> (or (= temp___is_init_1324 true) (<= 0 1024)) (in_range18 temp___expr_1328)))
(assert true)
...
(define-fun dynamic_invariant27 ((temp___expr_573 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool) (temp___do_typ_inv_572 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 150)) (in_range10 temp___expr_573)))
...
(define-fun dynamic_invariant28 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range11 temp___expr_625)))
(define-fun dynamic_invariant29 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range12 temp___expr_632)))
(define-fun dynamic_invariant30 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range13 temp___expr_639)))
(define-fun dynamic_invariant31 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range14 temp___expr_671)))
(assert true)
...
(define-fun dynamic_invariant32 ((temp___expr_1603 Int) (temp___is_init_1599 Bool) (temp___skip_constant_1600 Bool) (temp___do_toplevel_1601 Bool) (temp___do_typ_inv_1602 Bool)) Bool (=> (or (= temp___is_init_1599 true) (<= 0 4294967295)) (in_range26 temp___expr_1603)))
...
(assert (in_range29 currentlatch))
(assert (= status 6))
(assert (and (= result (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result true) (in_range8 (to_rep2 theadmin__split_fields)))))
(assert (= result true))
(assert (and (= result1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result1 true) (in_range7 (to_rep3 theadmin__split_fields1)))))
(assert (= result1 true))
