...
(assert (and (= o180 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o179)) (= (bool_eq o180 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o179)) true)))
(assert (= o181 (us_split_fields1 o180)))
(assert (= o182 (rec__partition_refinement__interval__first o181)))
(assert (= o183 (to_rep1 o182)))
(assert (= o190 (ite (<= o183 l2) true false)))
(assert (= result22 (ite (= o190 true) o189 false)))
