...
(define-fun o18 () us_rep10 (mk___rep5 (mk___split_fields5 o o1 o2)))
(assert (= (mk___rep1 (mk___split_fields1 rliteral)) no_element))
(assert (and (= o16 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o16) (= o16 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o14 (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o14) (<= o14 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= o15 (* 2 o14)))
(assert (and (= o17 o15) (in_range11 o15)))
(assert (= result (ite (<= o17 o16) true false)))
(assert (= result true))
(assert (and (= o13 (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o13) (<= o13 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
...
(assert (= result2 true))
(assert (and (= o11 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2)) (= (= o11 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2) true))))
(assert (= o12 true))
...
(assert (= result3 true))
(assert (and (= o9 (has_key (positions x) c3)) (= (= o9 true) (= (has_key (positions x) c3) true))))
(assert (= o10 true))
...
(assert (<= 0 j))
(assert (<= j 5))
(assert (and (= o18 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j)))) (= (bool_eq9 o18 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j)))) true)))
(assert (= o o3))
(assert (= o1 o4))
(assert (= o2 o5))
(assert (= o6 o4))
(assert (= o7 (to_rep4 o6)))
