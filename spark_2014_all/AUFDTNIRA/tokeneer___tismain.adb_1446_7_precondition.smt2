...
(assert (= (privatekeypresent thistisinfo__split_fields1 (let ((subject state)) state8)) true))
(assert (not (not (= (enrolmentisinprogress status2 (let ((subject state3)) state11)) true))))
(check-sat)
(exit)
