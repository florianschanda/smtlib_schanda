...
(assert (not (= (enrolmentisinprogress status2 (let ((subject state7)) state15)) true)))
(assert (not (= (privatekeypresent thistisinfo__split_fields1 (let ((subject state1)) state12)) true)))
(check-sat)
(exit)
