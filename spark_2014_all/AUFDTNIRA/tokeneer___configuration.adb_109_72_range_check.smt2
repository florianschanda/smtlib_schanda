...
(assert (not (= (length temp___1949) 0)))
(assert (=> (<= 1 2) (= o120 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o120 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1949))) (to_rep1 (last (rt temp___1949)))) (= o121 (+ (- (to_rep1 (last (rt temp___1949))) (to_rep1 (first (rt temp___1949)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1949))) (to_rep1 (last (rt temp___1949))))) (= o121 0)))
(assert (= o122 (+ o121 o120)))
(assert (= o123 (+ (to_rep1 (first (rt temp___1949))) o122)))
(assert (= o124 (- o123 1)))
