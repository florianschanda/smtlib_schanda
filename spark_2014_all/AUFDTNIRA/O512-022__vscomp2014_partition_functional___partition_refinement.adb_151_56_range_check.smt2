...
(assert (= (to_rep o42) 0))
(assert (not (in_range5 (+ (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields5)) (to_rep (rec__partition_refinement__interval__count p_elem__split_fields5))))))
(check-sat)
(exit)
