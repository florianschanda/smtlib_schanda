...
(assert (and (= o3 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o3) (= o3 (to_rep theadmin__split_fields)))))
(assert (and (= o4 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o4) (= o4 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
...
(assert (= result true))
(assert (and (= o1 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o1 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
