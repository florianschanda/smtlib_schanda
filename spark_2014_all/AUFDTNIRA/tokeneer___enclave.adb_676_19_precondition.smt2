...
(assert (and (= o30 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o30 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= o31 (ite (not (= o30 true)) true false)))
