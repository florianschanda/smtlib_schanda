...
(declare-fun user_eq30 (filestatust filestatust) Bool)
(declare-const dummy30 filestatust)
...
(assert (forall ((x filestatust)) (! (in_range20 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(define-fun in_range21 ((x Int)) Bool (and (<= 1 x) (<= x 17)))
...
(declare-fun user_eq31 (logfileindext logfileindext) Bool)
(declare-const dummy31 logfileindext)
...
(assert (forall ((x logfileindext)) (! (in_range21 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(define-fun in_range22 ((x Int)) Bool (and (<= 0 x) (<= x 17408)))
...
(declare-fun user_eq32 (logentrycountt logentrycountt) Bool)
(declare-const dummy32 logentrycountt)
...
(assert (forall ((x logentrycountt)) (! (in_range22 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun in_range23 ((x Int)) Bool (and (<= 0 x) (<= x 17)))
...
(declare-fun user_eq33 (logfilecountt logfilecountt) Bool)
(declare-const dummy33 logfilecountt)
...
(assert (forall ((x logfilecountt)) (! (in_range23 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(declare-const dummy34 (Array Int logfileindext))
...
(declare-fun user_eq34 ((Array Int logfileindext) (Array Int logfileindext)) Bool)
...
(define-fun in_range24 ((x Int)) Bool (and (<= 0 x) (<= x 1024)))
...
(declare-fun user_eq36 (fileentrycountt fileentrycountt) Bool)
(declare-const dummy36 fileentrycountt)
...
(assert (forall ((x fileentrycountt)) (! (in_range24 (to_rep18 x)) :pattern ((to_rep18 x)))))
...
(declare-const dummy37 (Array Int fileentrycountt))
...
(declare-fun user_eq37 ((Array Int fileentrycountt) (Array Int fileentrycountt)) Bool)
...
(declare-fun user_eq40 (statust statust) Bool)
(declare-const dummy40 statust)
...
(define-fun dynamic_invariant5 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range25 temp___expr_548)))
...
(define-fun dynamic_invariant7 ((temp___expr_2867 Int) (temp___is_init_2863 Bool) (temp___skip_constant_2864 Bool) (temp___do_toplevel_2865 Bool) (temp___do_typ_inv_2866 Bool)) Bool (=> (or (= temp___is_init_2863 true) (<= 0 8)) (in_range26 temp___expr_2867)))
...
(define-fun dynamic_invariant9 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 4)) (in_range2 temp___expr_496)))
(define-fun dynamic_invariant10 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range4 temp___expr_433)))
(define-fun dynamic_invariant11 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range16 temp___expr_440)))
(define-fun dynamic_invariant12 ((temp___expr_1092 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool) (temp___do_typ_inv_1091 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 40)) (in_range9 temp___expr_1092)))
(define-fun dynamic_invariant13 ((temp___expr_1116 Int) (temp___is_init_1112 Bool) (temp___skip_constant_1113 Bool) (temp___do_toplevel_1114 Bool) (temp___do_typ_inv_1115 Bool)) Bool (=> (or (= temp___is_init_1112 true) (<= 0 4294967295)) (in_range11 temp___expr_1116)))
(define-fun dynamic_invariant14 ((temp___expr_1140 Int) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool) (temp___do_typ_inv_1139 Bool)) Bool (=> (or (= temp___is_init_1136 true) (<= 0 10)) (in_range13 temp___expr_1140)))
(define-fun dynamic_invariant15 ((temp___expr_1154 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool) (temp___do_typ_inv_1153 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 4294967295)) (in_range14 temp___expr_1154)))
(define-fun dynamic_invariant16 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 128)) (in_range15 temp___expr_1161)))
(define-fun dynamic_invariant17 ((temp___expr_1276 Int) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (or (= temp___is_init_1272 true) (<= 0 17)) (in_range23 temp___expr_1276)))
(define-fun dynamic_invariant18 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 1 17)) (in_range21 temp___expr_1283)))
(define-fun dynamic_invariant19 ((temp___expr_1409 Int) (temp___is_init_1405 Bool) (temp___skip_constant_1406 Bool) (temp___do_toplevel_1407 Bool) (temp___do_typ_inv_1408 Bool)) Bool (=> (or (= temp___is_init_1405 true) (<= 0 2)) (in_range20 temp___expr_1409)))
(define-fun dynamic_invariant20 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17408)) (in_range22 temp___expr_1290)))
(define-fun dynamic_invariant21 ((temp___expr_1321 Int) (temp___is_init_1317 Bool) (temp___skip_constant_1318 Bool) (temp___do_toplevel_1319 Bool) (temp___do_typ_inv_1320 Bool)) Bool (=> (or (= temp___is_init_1317 true) (<= 0 1024)) (in_range24 temp___expr_1321)))
(assert true)
...
(define-fun dynamic_invariant22 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range5 temp___expr_625)))
(define-fun dynamic_invariant23 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range6 temp___expr_632)))
(define-fun dynamic_invariant24 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range7 temp___expr_639)))
(define-fun dynamic_invariant25 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range8 temp___expr_671)))
(define-fun dynamic_invariant26 ((temp___expr_1596 Int) (temp___is_init_1592 Bool) (temp___skip_constant_1593 Bool) (temp___do_toplevel_1594 Bool) (temp___do_typ_inv_1595 Bool)) Bool (=> (or (= temp___is_init_1592 true) (<= 0 4294967295)) (in_range12 temp___expr_1596)))
...
(declare-const logfilestate__split_fields9 us_split_fields__ref11)
...
(assert (= logfilestate__split_fields9 (mk___split_fields__ref11 logfilestate__split_fields7)))
...
(assert (and (= o3 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range1 o3) (= o3 (to_rep theadmin__split_fields)))))
(assert (and (= o4 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range1 o4) (= o4 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= o5 (ite (= o4 o3) true false)))
(assert (and (= o (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range1 o) (= o (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result (ite (= o 1) true false)))
(assert (= result true))
(assert (and (= o1 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o1 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
