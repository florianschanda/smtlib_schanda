...
(assert (not (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))) true)))
(assert (not (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))) true))))
(check-sat)
(exit)
