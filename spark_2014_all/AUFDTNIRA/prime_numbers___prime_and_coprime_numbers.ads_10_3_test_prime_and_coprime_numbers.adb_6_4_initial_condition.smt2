...
(define-fun dynamic_invariant ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 2147483647)) (in_range temp___expr_208)))
...
(assert (and (= result (valid_prime_data is_prime1)) (= (= result true) (forall ((v Int)) (=> (and (<= 0 v) (<= v 100000)) (= (= (select is_prime1 v) true) (= (is_prime v) true)))))))
(assert (not (= (valid_prime_data is_prime1) true)))
(check-sat)
(exit)
