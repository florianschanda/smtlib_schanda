...
(assert (<= 0 j2))
(assert (<= j2 5))
(assert (and (= o42 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j2)))) (= (bool_eq10 o42 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j2)))) true)))
(assert (= o43 (us_split_fields9 o42)))
(assert (= o44 (rec__partition_refinement__interval__last o43)))
(assert (= o45 (to_rep2 o44)))
(assert (= o46 (ite (<= j2 o45) true false)))
