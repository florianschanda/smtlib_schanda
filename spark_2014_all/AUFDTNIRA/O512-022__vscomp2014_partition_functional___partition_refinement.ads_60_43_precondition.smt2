...
(declare-const j Int)
(declare-const o us_rep9)
(declare-const o1 us_split_fields8)
...
(assert (and (= o12 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o12) (= o12 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o10 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o10) (<= o10 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= o11 (* 2 o10)))
(assert (and (= o13 o11) (in_range2 o11)))
(assert (= result (ite (<= o13 o12) true false)))
(assert (= result true))
(assert (and (= o9 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o9) (<= o9 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= result1 (ite (<= o9 5000) true false)))
(assert (= result1 true))
...
(assert (= result2 true))
(assert (and (= o7 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1)) (= (= o7 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true))))
(assert (= o8 true))
(assert (= result4 (ite (= o8 true) o7 false)))
...
(assert (= result3 true))
(assert (and (= o5 (has_key (positions x) c)) (= (= o5 true) (= (has_key (positions x) c) true))))
(assert (= o6 true))
...
(assert (<= 0 j))
(assert (<= j 5))
(assert (and (= o (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j)))) (= (bool_eq10 o (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j)))) true)))
(assert (= o1 (us_split_fields9 o)))
(assert (= o2 (rec__partition_refinement__interval__last o1)))
