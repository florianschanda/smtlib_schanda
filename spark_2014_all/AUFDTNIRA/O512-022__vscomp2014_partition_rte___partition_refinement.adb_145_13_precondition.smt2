...
(assert (= o2 o6))
(assert (= temp___1213 o4))
(assert (= temp___12131 o5))
(assert (= temp___12132 o6))
(assert (= result2 (mk___split_fields__ref p_prime__split_fields)))
(assert (= p_prime__split_fields1 (mk___split_fields temp___1213 temp___12131 temp___12132)))
...
(assert (= temp___1215 o9))
(assert (= temp___12151 o10))
(assert (= temp___12152 o11))
(assert (= result3 (mk___split_fields__ref p_elem__split_fields1)))
(assert (= p_elem__split_fields2 (mk___split_fields temp___1215 temp___12151 temp___12152)))
(assert (= (to_rep o12) 0))
...
(assert (= o12 o15))
(assert (= temp___1217 o13))
(assert (= temp___12171 o14))
(assert (= temp___12172 o15))
(assert (= result4 (mk___split_fields__ref p_elem__split_fields2)))
(assert (= p_elem__split_fields3 (mk___split_fields temp___1217 temp___12171 temp___12172)))
(assert (not (<= 0 j2)))
(check-sat)
(exit)
