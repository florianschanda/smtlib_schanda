...
(declare-const temp___1286 index)
(declare-const temp___12861 index)
(declare-const temp___12862 index_count)
...
(assert (= (to_rep o2) 0))
(assert (and (= o1 (+ (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields1)) (to_rep (rec__partition_refinement__interval__count p_elem__split_fields1)))) (in_range3 (+ (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields1)) (to_rep (rec__partition_refinement__interval__count p_elem__split_fields1))))))
(assert (= (to_rep1 o3) o1))
(assert (= o3 o4))
(assert (= (rec__partition_refinement__interval__last p_elem__split_fields1) o5))
(assert (= o2 o6))
(assert (= temp___1286 o4))
(assert (= temp___12861 o5))
(assert (= temp___12862 o6))
(assert (= result2 (mk___split_fields__ref p_prime__split_fields)))
(assert (= p_prime__split_fields1 (mk___split_fields temp___1286 temp___12861 temp___12862)))
(assert (and (= o7 (- (+ (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields1)) (to_rep (rec__partition_refinement__interval__count p_elem__split_fields1))) 1)) (in_range3 (- (+ (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields1)) (to_rep (rec__partition_refinement__interval__count p_elem__split_fields1))) 1))))
(assert (= (to_rep1 o8) o7))
(assert (= (rec__partition_refinement__interval__first p_elem__split_fields1) o9))
(assert (= o8 o10))
(assert (= (rec__partition_refinement__interval__count p_elem__split_fields1) o11))
(assert (= temp___1288 o9))
(assert (= temp___12881 o10))
(assert (= temp___12882 o11))
(assert (= result3 (mk___split_fields__ref p_elem__split_fields1)))
(assert (= p_elem__split_fields2 (mk___split_fields temp___1288 temp___12881 temp___12882)))
(assert (= (to_rep o12) 0))
(assert (= (rec__partition_refinement__interval__first p_elem__split_fields2) o13))
(assert (= (rec__partition_refinement__interval__last p_elem__split_fields2) o14))
(assert (= o12 o15))
(assert (= temp___1290 o13))
(assert (= temp___12901 o14))
(assert (= temp___12902 o15))
(assert (= result4 (mk___split_fields__ref p_elem__split_fields2)))
(assert (= p_elem__split_fields3 (mk___split_fields temp___1290 temp___12901 temp___12902)))
(assert (not (<= 0 j2)))
(check-sat)
(exit)
