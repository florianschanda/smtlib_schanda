...
(assert (=> (= result true) (and (= o28 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o28 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result true) (= o29 (ite (not (= o28 true)) true false))))
(assert (=> (= result true) (and (= o27 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o27 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
...
(assert (=> (= result1 true) (and (= o23 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (and (in_range2 o23) (= o23 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result1 true) (= o24 (ite (= o23 0) true false))))
(assert (=> (= result1 true) (and (= o22 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o22 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
...
(assert (=> (= result2 true) (and (= o20 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o20 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
...
(assert (=> (= result3 true) (and (= o17 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o17 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result3 true) (and (= o18 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o18 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
...
(assert (=> (= result4 true) (and (= o13 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o13 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
...
(assert (=> (= result6 true) (and (= o9 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields)))) (in_range4 o9))))
...
(assert (and (= o6 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o6 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields)))))))
(assert (= result7 (ite (not (= o6 true)) true false)))
(assert (=> (= result7 true) (and (= o7 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o7 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
...
(assert (=> (= result8 true) (and (= o2 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o2 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result8 true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (= result8 true) (and (= result9 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= result9 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o1 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields)))) (in_range4 o1)))))
...
(assert (and (= result10 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= result10 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields)))))))
