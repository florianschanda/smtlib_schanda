...
(assert (= f2 o13))
(assert (forall ((k Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields1)) k) (<= k i2)) (= (to_rep2 (select f3 k)) p_prime_index2))))
(assert (forall ((k Int)) (=> (and (<= 0 k) (<= k (- (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1))) (= (to_rep2 (select f3 k)) (to_rep2 (select f_loop_entry k))))))
(assert (forall ((k Int)) (=> (and (<= (+ i2 1) k) (<= k 5)) (= (to_rep2 (select f3 k)) (to_rep2 (select f_loop_entry k))))))
...
(assert (<= 0 (- (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1)))
(assert (not (<= 0 0)))
(check-sat)
(exit)
