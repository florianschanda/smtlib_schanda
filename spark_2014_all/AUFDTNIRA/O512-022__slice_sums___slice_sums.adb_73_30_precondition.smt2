...
(assert (and (= o12 (- current_hi3 1)) (in_range1 (- current_hi3 1))))
(assert (and (= o13 o12) (in_range5 o12)))
(assert (= (to_rep2 o14) o13))
(assert (= (to_rep1 o15) current_lo3))
(assert (= o15 o16))
(assert (= o14 o17))
(assert (= o18 o16))
(assert (= o19 o17))
(assert (not (or (< (to_rep2 o19) (to_rep1 o18)) (and (<= (to_rep3 (first (rt x))) (to_rep1 o18)) (<= (to_rep2 o19) (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
