...
(assert (and (= o4 (- current_hi2 1)) (in_range1 (- current_hi2 1))))
(assert (and (= o5 o4) (in_range4 o4)))
(assert (= (extended_indexqtint o6) o5))
(assert (= (indexqtint o7) current_lo2))
(assert (= o7 o8))
(assert (= o6 o9))
(assert (= o10 o8))
(assert (= o11 o9))
(assert (not (or (< (extended_indexqtint o11) (indexqtint o10)) (and (<= (to_rep (first (rt x))) (indexqtint o10)) (<= (extended_indexqtint o11) (to_rep (last (rt x))))))))
(check-sat)
(exit)
