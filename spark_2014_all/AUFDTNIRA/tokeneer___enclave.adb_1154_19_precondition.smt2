...
(assert (= result1 true))
(assert (and (= o21 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range7 o21)))
(assert (= result2 (ite (= o21 4) true false)))
(assert (= result2 true))
(assert (and (= o17 (thedooralarm (us_private__content state2))) (in_range9 o17)))
...
(assert (and (= o9 (thecurrentdoor (us_private__content state2))) (in_range30 o9)))
...
(assert (= result3 true))
(assert (and (= o3 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range5 o3) (= o3 (to_rep2 theadmin__split_fields)))))
(assert (= result5 (ite (= o3 1) true false)))
(assert (=> (= result5 true) (and (= o6 (theauthcertrole tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range5 o6) (= o6 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields))))))))
(assert (=> (= result5 true) (= o7 (ite (= o6 1) true false))))
(assert (=> (= result5 true) (and (= o4 (authcertvalid tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o4 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields)) true)))))
(assert (=> (= result5 true) (and (= o5 (isgood tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o5 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields)) true)))))
