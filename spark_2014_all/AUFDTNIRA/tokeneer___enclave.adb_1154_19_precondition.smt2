...
(assert (= result1 true))
(assert (and (= o22 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range7 o22)))
(assert (= result2 (ite (= o22 4) true false)))
(assert (= result2 true))
(assert (and (= o18 (thedooralarm (us_private__content state3))) (in_range9 o18)))
(assert (= o19 (ite (= o18 0) true false)))
(assert (= o20 (to_int1 o19)))
(assert (= o14 (alarm_timeout (us_private__content state3))))
(assert (and (= o13 (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime)) (= o13 (mk___rep1 (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3)))))
(assert (and (= o15 (greaterthanorequal o13 o14)) (= (= o15 true) (or (= (greaterthan o13 o14) true) (= (bool_eq3 o13 o14) true)))))
(assert (and (= o10 (thecurrentdoor (us_private__content state3))) (in_range30 o10)))
(assert (= o11 (ite (= o10 0) true false)))
(assert (and (= o12 (islocked currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) (= (= o12 true) (= currentlatch 0))))
(assert (= o16 (ite (= o12 true) o11 false)))
(assert (= o17 (ite (= o16 true) o15 false)))
(assert (= o21 (to_int1 o17)))
(assert (= result3 (ite (= o21 o20) true false)))
(assert (= result3 true))
...
(assert (= result5 (ite (= o4 1) true false)))
(assert (=> (= result5 true) (and (= o7 (theauthcertrole tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range5 o7) (= o7 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields))))))))
(assert (=> (= result5 true) (= o8 (ite (= o7 1) true false))))
(assert (=> (= result5 true) (and (= o5 (authcertvalid tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o5 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields)) true)))))
(assert (=> (= result5 true) (and (= o6 (isgood tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o6 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields)) true)))))
(assert (=> (= result5 true) (= o9 (ite (= o6 true) o5 false))))
(assert (=> (= result5 true) (= result4 (ite (= o9 true) o8 false))))
(assert (=> (not (= result5 true)) (= result4 (of_int 1))))
(assert (= result4 true))
