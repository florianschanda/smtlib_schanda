...
(assert (forall ((temp___1929 Int) (temp___1930 Int) (temp___1931 Int) (temp___1932 Int)) (let ((temp___1928 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def temp___1929 temp___1930 temp___1931 temp___1932))) (=> (and (dynamic_invariant temp___1929 true true true true) (dynamic_invariant temp___1930 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 9) (+ (first1 source) 10) temp___1931 temp___1932) (and (= (first5 temp___1928) temp___1931) (= (last5 temp___1928) temp___1932))) (and (= (select (to_array2 temp___1928) (+ (+ (first1 source) 9) 0)) rliteral) (= (select (to_array2 temp___1928) (+ (+ (first1 source) 9) 1)) rliteral1)))))))
(define-fun dynamic_invariant4 ((temp___expr_594 us_t3) (temp___is_init_590 Bool) (temp___skip_constant_591 Bool) (temp___do_toplevel_592 Bool) (temp___do_typ_inv_593 Bool)) Bool (=> (not (= temp___skip_constant_591 true)) (and (dynamic_property6 (+ (first1 source) 9) (+ (first1 source) 10) (first7 temp___expr_594) (last7 temp___expr_594)) (and (= (first7 temp___expr_594) (+ (first1 source) 9)) (= (last7 temp___expr_594) (+ (first1 source) 10))))))
(declare-sort t6 0)
...
(assert (forall ((temp___1938 Int) (temp___1939 Int) (temp___1940 Int)) (let ((temp___1937 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def temp___1938 temp___1939 temp___1940))) (=> (dynamic_invariant temp___1938 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 9) (+ (first1 source) 10) temp___1939 temp___1940) (and (= (first9 temp___1937) temp___1939) (= (last9 temp___1937) temp___1940))) (forall ((temp___1941 Int)) (= (select (to_array4 temp___1937) temp___1941) rliteral2)))))))
...
(declare-const temp___1935 (Array Int integer))
(declare-const temp___19351 t2)
...
(declare-const temp___1943 (Array Int integer))
(declare-const temp___19431 t4)
...
(declare-const temp___1945 Int)
(declare-const temp___1946 Int)
(declare-const temp___1950 Int)
(declare-const temp___1948 (Array Int integer))
(declare-const o Int)
...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 51)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 8))) 54)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 9))) 52)) (forall ((index9 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) index9) (<= index9 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index9))) true))))))
...
(assert (= (mk___t2 temp___1935 temp___19351) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def 3 9 (+ (to_rep1 (first (rt source))) 9) (+ (+ (to_rep1 (first (rt source))) 9) 1))))
(assert (= (ite (<= (to_rep1 (first4 temp___19351)) (to_rep1 (last4 temp___19351))) (+ (- (to_rep1 (last4 temp___19351)) (to_rep1 (first4 temp___19351))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 9)) 1) 0)))
(assert (= (slide1 temp___1935 (to_rep1 (first4 temp___19351)) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume))
...
(assert (= (mk___t4 temp___1943 temp___19431) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___19431)) (to_rep1 (last8 temp___19431))) (+ (- (to_rep1 (last8 temp___19431)) (to_rep1 (first8 temp___19431))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 9)) 1) 0)))
(assert (= (slide1 temp___1943 (to_rep1 (first8 temp___19431)) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume))
...
(assert (and (= temp___1945 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (= temp___1946 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___1945))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= temp___1950 index1)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= temp___1948 n1)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= o index1)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= o3 index1)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= o7 index1)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= n1 result3)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= n2 o8)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (and (and (forall ((temp___1949 Int)) (=> (and (<= (to_rep1 n__first) temp___1949) (<= temp___1949 (to_rep1 n__last))) (=> (or (< temp___1946 temp___1949) (or (< temp___1949 temp___1945) (< index2 temp___1949))) (= (select n3 temp___1949) (select temp___1948 temp___1949))))) (=> (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 9) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= index2 temp___1946)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= index2 index3)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= n3 n4)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= index4 index2)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= n5 n3)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= index6 index4)))
(assert (=> (and (<= temp___1945 index1) (<= index1 temp___1946)) (= n7 n5)))
(assert (=> (not (and (<= temp___1945 index1) (<= index1 temp___1946))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___1945 index1) (<= index1 temp___1946))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___1945 index1) (<= index1 temp___1946))) (= index6 index1)))
(assert (=> (not (and (<= temp___1945 index1) (<= index1 temp___1946))) (= n7 n1)))
...
(assert (and (= temp___1951 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___1951) (<= temp___1951 (to_rep1 n__last))))
(assert (= o9 temp___1951))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___1952 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1952) (<= temp___1952 (to_rep1 n__last))))
(assert (= o14 temp___1952))
...
(assert (= target2 o20))
(assert (<= (- 39) target2))
(assert (and (= o21 (- target2 2147483600)) (in_range1 (- target2 2147483600))))
(assert (= result6 (mk_int__ref target2)))
(assert (= target3 o21))
(assert (<= (- 2147483639) target3))
(assert (= result7 (mk_bool__ref has_failed)))
