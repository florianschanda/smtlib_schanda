...
(assert (= (to_rep4 o20) 0))
(assert (= o21 (mk___split_fields1 (rec__certtypes__idt__issuer id__split_fields4) o20)))
(assert (= temp___2561 (mk___rep1 o21)))
(assert (= result8 (mk___split_fields__ref1 id__split_fields4)))
(assert (= id__split_fields5 (us_split_fields3 temp___2561)))
