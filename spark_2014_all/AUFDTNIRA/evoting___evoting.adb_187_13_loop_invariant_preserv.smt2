...
(declare-const temp___691 (Array Int character))
...
(assert (and (and (and (in_range4 number_of_votes1) (=> (<= 0 2147483647) (in_range4 last3))) (=> (<= 0 20) (in_range7 chosen_vote1))) (< number_of_votes1 (* last_candidate 20))))
(assert (= (to_rep1 o2) 255))
(assert (= (to_rep1 o1) 1))
(assert (in_range4 last4))
(assert (= buf result1))
(assert (= buf1 (slide ada__text_io__get_line__2__item (to_rep1 (first (mk 1 255))) 1)))
(assert (=> (= (to_rep (select buf1 1)) 118) (and (<= chosen_vote2 last_candidate) (in_range7 chosen_vote2))))
(assert (=> (= (to_rep (select buf1 1)) 118) (< (to_rep2 (select counters1 chosen_vote2)) 10000)))
(assert (=> (= (to_rep (select buf1 1)) 118) (and (= o3 (+ (to_rep2 (select counters1 chosen_vote2)) 1)) (in_range6 (+ (to_rep2 (select counters1 chosen_vote2)) 1)))))
...
(assert (=> (not (= (to_rep (select buf1 1)) 118)) (= temp___691 buf1)))
(assert (=> (not (= (to_rep (select buf1 1)) 118)) (= result4 (bool_eq temp___691 1 11 (temp___String_Literal_690 Tuple0) 1 11))))
