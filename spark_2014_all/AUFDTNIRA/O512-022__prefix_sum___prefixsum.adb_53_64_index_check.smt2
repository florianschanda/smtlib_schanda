...
(assert (=> (= result5 true) (= o10 (ite (= (mod2 (+ left4 1) (* space2 2)) space2) true false))))
(assert (=> (not (= result5 true)) (= o10 false)))
(assert (=> (<= 8 left4) (= o11 (ite (= left4 8) true (ite (= left4 9) true false)))))
(assert (=> (not (<= 8 left4)) (= o11 (of_int 1))))
(assert (= result4 (ite (and (= o10 true) (= o11 true)) true false)))
(assert (= result4 true))
(assert (<= 0 k1))
(assert (<= k1 7))
(assert (=> (and (<= 0 k1) (<= k1 (- left4 space2))) (= result7 (ite (= (mod2 (+ k1 1) (* 2 space2)) 0) true false))))
(assert (=> (not (and (<= 0 k1) (<= k1 (- left4 space2)))) (= result7 false)))
(assert (= result7 true))
(assert (not (<= 0 (- k1 space2))))
(check-sat)
(exit)
