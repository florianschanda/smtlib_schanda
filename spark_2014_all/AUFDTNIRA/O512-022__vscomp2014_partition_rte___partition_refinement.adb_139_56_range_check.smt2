...
(assert (forall ((x index_count)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant ((temp___expr_305 Int) (temp___is_init_302 Bool) (temp___skip_constant_303 Bool) (temp___do_toplevel_304 Bool)) Bool (=> (or (= temp___is_init_302 true) (<= 0 5)) (in_range3 temp___expr_305)))
...
(define-fun dynamic_invariant1 ((temp___expr_706 Int) (temp___is_init_703 Bool) (temp___skip_constant_704 Bool) (temp___do_toplevel_705 Bool)) Bool (=> (or (= temp___is_init_703 true) (<= 0 10000)) (in_range5 temp___expr_706)))
...
(assert (forall ((x partition_index)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x capacity_range)) (! (in_range6 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_733 Int) (temp___is_init_730 Bool) (temp___skip_constant_731 Bool) (temp___do_toplevel_732 Bool)) Bool (=> (or (= temp___is_init_730 true) (<= 0 10001)) (in_range6 temp___expr_733)))
(declare-fun length (us_rep1) Int)
(declare-fun length__function_guard (Int us_rep1) Bool)
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= result (capacity container)) (dynamic_invariant2 result true false true))) :pattern ((length container)))))
...
(assert (forall ((x tpartition_indexB)) (! (in_range4 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_299 Int) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool)) Bool (=> (or (= temp___is_init_296 true) (<= 0 6)) (in_range2 temp___expr_299)))
...
(define-fun dynamic_invariant4 ((temp___expr_152 Int) (temp___is_init_149 Bool) (temp___skip_constant_150 Bool) (temp___do_toplevel_151 Bool)) Bool (=> (or (= temp___is_init_149 true) (<= 0 2147483647)) (in_range7 temp___expr_152)))
...
(define-fun dynamic_invariant5 ((temp___expr_727 Int) (temp___is_init_724 Bool) (temp___skip_constant_725 Bool) (temp___do_toplevel_726 Bool)) Bool (=> (or (= temp___is_init_724 true) (<= (- 1) 10001)) (in_range8 temp___expr_727)))
...
(define-fun dynamic_invariant6 ((temp___expr_712 Int) (temp___is_init_709 Bool) (temp___skip_constant_710 Bool) (temp___do_toplevel_711 Bool)) Bool (=> (or (= temp___is_init_709 true) (<= 0 10000)) (in_range9 temp___expr_712)))
...
(define-fun dynamic_invariant7 ((temp___expr_763 Int) (temp___is_init_760 Bool) (temp___skip_constant_761 Bool) (temp___do_toplevel_762 Bool)) Bool (=> (or (= temp___is_init_760 true) (<= (- 1) 10000)) (in_range10 temp___expr_763)))
(assert (forall ((container us_rep2)) (! (let ((result (length1 container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant4 result true false true))) :pattern ((length1 container)))))
(assert true)
...
(declare-const temp___1212 index)
(declare-const temp___12121 index)
(declare-const temp___12122 index_count)
(declare-const o5 Int)
(declare-const o6 index_count)
(declare-const o7 index)
(declare-const o8 index)
(declare-const o9 index)
(declare-const o10 index_count)
(declare-const temp___1213 index)
(declare-const temp___12131 index)
(declare-const temp___12132 index_count)
(declare-const o11 Int)
(declare-const o12 index)
(declare-const o13 index)
(declare-const o14 index)
(declare-const o15 index_count)
(declare-const temp___1215 index)
(declare-const temp___12151 index)
(declare-const temp___12152 index_count)
(declare-const o16 index_count)
(declare-const o17 index)
(declare-const o18 index)
(declare-const o19 index_count)
(declare-const temp___1217 index)
(declare-const temp___12171 index)
(declare-const temp___12172 index_count)
(declare-const o20 Int)
(declare-const o21 Int)
(declare-const temp___1220 (Array Int partition_index))
(declare-const o22 partition_index)
(declare-const o23 (Array Int partition_index))
...
(declare-const p__split_fields6 us_split_fields__ref1)
(declare-const f9 map__ref)
(declare-const p_elem__split_fields6 us_split_fields__ref)
(declare-const p_prime__split_fields4 us_split_fields__ref)
(declare-const p_prime_index5 int__ref)
(declare-const j4 int__ref)
(declare-const i9 int__ref)
(declare-const p__split_fields7 us_split_fields2)
...
(declare-const p_prime_index6 Int)
(declare-const j5 Int)
(declare-const i10 Int)
(declare-const rho4 us_split_fields2)
(declare-const rho5 us_split_fields2)
(assert (and (<= (* 2 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (<= (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) 5000)))
(assert (=> (<= 0 10000) (in_range5 p_prime_index)))
(assert (and (= o4 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range6 o4) (<= o4 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
(assert (= partition_refinement__make_new_partitions__L_1__R29b__assume (- o4 1)))
...
(assert (<= 0 j1))
(assert (<= j1 r29b))
(assert (= (capacity (mk___rep1 p__split_discrs p__split_fields1)) (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))
(assert (and (<= 0 (- (length (mk___rep1 p__split_discrs p__split_fields1)) (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))))) (<= (- (length (mk___rep1 p__split_discrs p__split_fields1)) (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) j2)))
(assert (and (and (=> (<= 0 10000) (in_range5 p_prime_index1)) (=> (<= 0 r29b) (dynamic_property 0 r29b j2))) (and (<= 0 j2) (<= j2 r29b))))
(assert (and (= (mk___rep (mk___split_fields temp___1212 temp___12121 temp___12122)) (get (model__ (mk___rep1 p__split_discrs p__split_fields1)) j2)) (= (bool_eq (mk___rep (mk___split_fields temp___1212 temp___12121 temp___12122)) (get (model__ (mk___rep1 p__split_discrs p__split_fields1)) j2)) true)))
(assert (= result1 (mk___split_fields__ref p_elem__split_fields)))
(assert (= p_elem__split_fields1 (mk___split_fields temp___1212 temp___12121 temp___12122)))
...
(assert (= (to_rep o6) 0))
(assert (not (in_range3 (+ (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields1)) (to_rep (rec__partition_refinement__interval__count p_elem__split_fields1))))))
(check-sat)
(exit)
