...
(define-fun temp___12123 () us_rep (mk___rep (mk___split_fields temp___1212 temp___12121 temp___12122)))
...
(assert (and (= o (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range6 o) (<= o (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
...
(assert (and (= temp___12123 (get (model__ (mk___rep1 p__split_discrs p__split_fields1)) j2)) (= (bool_eq temp___12123 (get (model__ (mk___rep1 p__split_discrs p__split_fields1)) j2)) true)))
