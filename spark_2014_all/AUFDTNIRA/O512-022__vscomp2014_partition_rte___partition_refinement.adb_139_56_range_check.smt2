...
(define-fun dynamic_invariant ((temp___expr_333 Int) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool) (temp___do_typ_inv_332 Bool)) Bool (=> (or (= temp___is_init_329 true) (<= 0 5)) (in_range3 temp___expr_333)))
...
(define-fun dynamic_invariant1 ((temp___expr_768 Int) (temp___is_init_764 Bool) (temp___skip_constant_765 Bool) (temp___do_toplevel_766 Bool) (temp___do_typ_inv_767 Bool)) Bool (=> (or (= temp___is_init_764 true) (<= 0 10000)) (in_range5 temp___expr_768)))
...
(define-fun dynamic_invariant2 ((temp___expr_799 Int) (temp___is_init_795 Bool) (temp___skip_constant_796 Bool) (temp___do_toplevel_797 Bool) (temp___do_typ_inv_798 Bool)) Bool (=> (or (= temp___is_init_795 true) (<= 0 10001)) (in_range6 temp___expr_799)))
(declare-fun length (us_rep1) Int)
(declare-fun length__function_guard (Int us_rep1) Bool)
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= result (capacity container)) (dynamic_invariant2 result true false true true))) :pattern ((length container)))))
...
(declare-const temp___1285 index)
(declare-const temp___12851 index)
(declare-const temp___12852 index_count)
...
(define-fun temp___12853 () us_rep (mk___rep (mk___split_fields temp___1285 temp___12851 temp___12852)))
...
(assert (and (= temp___12853 (get (model__ (mk___rep1 p__split_discrs p__split_fields1)) j2)) (= (bool_eq temp___12853 (get (model__ (mk___rep1 p__split_discrs p__split_fields1)) j2)) true)))
(assert (= result1 (mk___split_fields__ref p_elem__split_fields)))
(assert (= p_elem__split_fields1 (mk___split_fields temp___1285 temp___12851 temp___12852)))
