...
(declare-const t3 (Array Int integer))
(assert (in_range1 a))
(assert (= result i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 10))
(assert (and (= o (* a i1)) (in_range1 (* a i1))))
(assert (= (to_rep o1) o))
(assert (= o2 (store t i1 o1)))
(assert (= result1 t))
(assert (= t1 o2))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 i2)) (= (to_rep (select t2 j1)) (* a j1)))))
(assert (and (and (=> (<= 1 10) (in_range3 i2)) (forall ((temp___151 Int)) (=> (and (<= 1 temp___151) (<= temp___151 10)) (=> (< i2 temp___151) (= (select t2 temp___151) (select t temp___151)))))) (and (<= 1 i2) (<= i2 10))))
(assert (= (to_rep (select t2 i2)) (* a i2)))
(assert (not (= i2 10)))
(assert (= i2 result2))
(assert (= i3 (+ i2 1)))
(assert (and (= o5 (* a i3)) (in_range1 (* a i3))))
(assert (= (to_rep o6) o5))
(assert (= o7 (store t2 i3 o6)))
(assert (= result3 t2))
(assert (= t3 o7))
(declare-const j1 Int)
(assert (<= 1 j1))
(assert (<= j1 i3))
(assert (not (= (to_rep (select t3 j1)) (* a j1))))
(check-sat)
(exit)
