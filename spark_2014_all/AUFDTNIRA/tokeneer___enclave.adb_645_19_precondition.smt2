...
(assert (= result1 true))
(assert (and (= o12 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o12)))
(assert (= result2 (ite (= o12 1) true false)))
(assert (= result2 true))
(assert (and (= o6 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o6) (= o6 (to_rep theadmin__split_fields)))))
(assert (= result4 (ite (= o6 1) true false)))
(assert (=> (= result4 true) (and (= o9 (theauthcertrole tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range2 o9) (= o9 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields))))))))
(assert (=> (= result4 true) (= o10 (ite (= o9 1) true false))))
(assert (=> (= result4 true) (and (= o7 (authcertvalid tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o7 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields)) true)))))
(assert (=> (= result4 true) (and (= o8 (isgood tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o8 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields)) true)))))
...
(assert (=> (= result7 true) (and (= o4 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o4))))
(assert (=> (= result7 true) (= result6 (ite (= o4 3) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (and (= o5 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o5) (= o5 (to_rep theadmin__split_fields))))))
...
(assert (= result8 true))
(assert (and (= o2 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o2 true) (in_range4 (to_rep1 theadmin__split_fields1)))))
