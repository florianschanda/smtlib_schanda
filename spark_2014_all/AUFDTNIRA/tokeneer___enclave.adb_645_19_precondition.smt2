...
(assert (= result1 true))
(assert (and (= o11 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o11)))
(assert (= result2 (ite (= o11 1) true false)))
(assert (= result2 true))
(assert (and (= o5 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o5) (= o5 (to_rep theadmin__split_fields)))))
(assert (= result4 (ite (= o5 1) true false)))
(assert (=> (= result4 true) (and (= o8 (theauthcertrole tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range2 o8) (= o8 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields))))))))
(assert (=> (= result4 true) (= o9 (ite (= o8 1) true false))))
(assert (=> (= result4 true) (and (= o6 (authcertvalid tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o6 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields)) true)))))
(assert (=> (= result4 true) (and (= o7 (isgood tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o7 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields)) true)))))
...
(assert (= result3 true))
(assert (and (= result7 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result7 true) (in_range4 (to_rep1 theadmin__split_fields1)))))
(assert (=> (= result7 true) (and (= o3 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o3))))
(assert (=> (= result7 true) (= result6 (ite (= o3 3) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (and (= o4 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o4) (= o4 (to_rep theadmin__split_fields))))))
