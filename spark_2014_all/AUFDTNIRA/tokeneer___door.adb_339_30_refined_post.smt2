...
(define-fun dynamic_invariant2 ((temp___expr_1408 Int) (temp___is_init_1404 Bool) (temp___skip_constant_1405 Bool) (temp___do_toplevel_1406 Bool) (temp___do_typ_inv_1407 Bool)) Bool (=> (or (= temp___is_init_1404 true) (<= 0 1)) (in_range11 temp___expr_1408)))
...
(define-fun dynamic_invariant3 ((temp___expr_1431 Int) (temp___is_init_1427 Bool) (temp___skip_constant_1428 Bool) (temp___do_toplevel_1429 Bool) (temp___do_typ_inv_1430 Bool)) Bool (=> (or (= temp___is_init_1427 true) (<= 0 1)) (in_range12 temp___expr_1431)))
...
(define-fun dynamic_invariant4 ((temp___expr_1167 Int) (temp___is_init_1163 Bool) (temp___skip_constant_1164 Bool) (temp___do_toplevel_1165 Bool) (temp___do_typ_inv_1166 Bool)) Bool (=> (or (= temp___is_init_1163 true) (<= 0 17)) (in_range8 temp___expr_1167)))
(define-fun dynamic_invariant5 ((temp___expr_1174 Int) (temp___is_init_1170 Bool) (temp___skip_constant_1171 Bool) (temp___do_toplevel_1172 Bool) (temp___do_typ_inv_1173 Bool)) Bool (=> (or (= temp___is_init_1170 true) (<= 1 17)) (in_range6 temp___expr_1174)))
(define-fun dynamic_invariant6 ((temp___expr_1300 Int) (temp___is_init_1296 Bool) (temp___skip_constant_1297 Bool) (temp___do_toplevel_1298 Bool) (temp___do_typ_inv_1299 Bool)) Bool (=> (or (= temp___is_init_1296 true) (<= 0 2)) (in_range10 temp___expr_1300)))
(define-fun dynamic_invariant7 ((temp___expr_1181 Int) (temp___is_init_1177 Bool) (temp___skip_constant_1178 Bool) (temp___do_toplevel_1179 Bool) (temp___do_typ_inv_1180 Bool)) Bool (=> (or (= temp___is_init_1177 true) (<= 0 17408)) (in_range7 temp___expr_1181)))
(define-fun dynamic_invariant8 ((temp___expr_1212 Int) (temp___is_init_1208 Bool) (temp___skip_constant_1209 Bool) (temp___do_toplevel_1210 Bool) (temp___do_typ_inv_1211 Bool)) Bool (=> (or (= temp___is_init_1208 true) (<= 0 1024)) (in_range9 temp___expr_1212)))
(assert true)
...
(assert (forall ((temp___1241 Int)) (=> (dynamic_invariant8 temp___1241 true true true true) (forall ((temp___1242 Int)) (= (to_rep7 (select (temp___1239 temp___1241) temp___1242)) temp___1241)))))
(define-fun dynamic_invariant9 ((temp___expr_476 Int) (temp___is_init_472 Bool) (temp___skip_constant_473 Bool) (temp___do_toplevel_474 Bool) (temp___do_typ_inv_475 Bool)) Bool (=> (or (= temp___is_init_472 true) (<= 1901 2099)) (in_range2 temp___expr_476)))
(define-fun dynamic_invariant10 ((temp___expr_483 Int) (temp___is_init_479 Bool) (temp___skip_constant_480 Bool) (temp___do_toplevel_481 Bool) (temp___do_typ_inv_482 Bool)) Bool (=> (or (= temp___is_init_479 true) (<= 1 12)) (in_range3 temp___expr_483)))
(define-fun dynamic_invariant11 ((temp___expr_490 Int) (temp___is_init_486 Bool) (temp___skip_constant_487 Bool) (temp___do_toplevel_488 Bool) (temp___do_typ_inv_489 Bool)) Bool (=> (or (= temp___is_init_486 true) (<= 1 31)) (in_range4 temp___expr_490)))
(define-fun dynamic_invariant12 ((temp___expr_522 Int) (temp___is_init_518 Bool) (temp___skip_constant_519 Bool) (temp___do_toplevel_520 Bool) (temp___do_typ_inv_521 Bool)) Bool (=> (or (= temp___is_init_518 true) (<= 0 86399999)) (in_range5 temp___expr_522)))
(assert true)
...
(assert (forall ((temp___1237 Int)) (=> (dynamic_invariant5 temp___1237 true true true true) (forall ((temp___1238 Int)) (= (to_rep4 (select (temp___1235 temp___1237) temp___1238)) temp___1237)))))
...
(declare-const temp___1493 us_rep)
...
(assert (and (= (bool_eq (latch_timeout currentlatch1 state latchtimeout__split_fields) o) true) (in_range11 currentlatch1)))
(assert (and (= temp___1493 (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime)) (= temp___1493 (mk___rep (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3)))))
