...
(define-fun dynamic_invariant2 ((temp___expr_1256 Int) (temp___is_init_1253 Bool) (temp___skip_constant_1254 Bool) (temp___do_toplevel_1255 Bool)) Bool (=> (or (= temp___is_init_1253 true) (<= 0 1)) (in_range11 temp___expr_1256)))
...
(define-fun dynamic_invariant3 ((temp___expr_1278 Int) (temp___is_init_1275 Bool) (temp___skip_constant_1276 Bool) (temp___do_toplevel_1277 Bool)) Bool (=> (or (= temp___is_init_1275 true) (<= 0 1)) (in_range12 temp___expr_1278)))
...
(define-fun dynamic_invariant4 ((temp___expr_1056 Int) (temp___is_init_1053 Bool) (temp___skip_constant_1054 Bool) (temp___do_toplevel_1055 Bool)) Bool (=> (or (= temp___is_init_1053 true) (<= 0 17)) (in_range8 temp___expr_1056)))
(define-fun dynamic_invariant5 ((temp___expr_1035 Int) (temp___is_init_1032 Bool) (temp___skip_constant_1033 Bool) (temp___do_toplevel_1034 Bool)) Bool (=> (or (= temp___is_init_1032 true) (<= 1 17)) (in_range6 temp___expr_1035)))
(define-fun dynamic_invariant6 ((temp___expr_1160 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 2)) (in_range10 temp___expr_1160)))
(define-fun dynamic_invariant7 ((temp___expr_1041 Int) (temp___is_init_1038 Bool) (temp___skip_constant_1039 Bool) (temp___do_toplevel_1040 Bool)) Bool (=> (or (= temp___is_init_1038 true) (<= 0 17408)) (in_range7 temp___expr_1041)))
(define-fun dynamic_invariant8 ((temp___expr_1075 Int) (temp___is_init_1072 Bool) (temp___skip_constant_1073 Bool) (temp___do_toplevel_1074 Bool)) Bool (=> (or (= temp___is_init_1072 true) (<= 0 1024)) (in_range9 temp___expr_1075)))
(assert true)
...
(define-fun dynamic_invariant9 ((temp___expr_424 Int) (temp___is_init_421 Bool) (temp___skip_constant_422 Bool) (temp___do_toplevel_423 Bool)) Bool (=> (or (= temp___is_init_421 true) (<= 1901 2099)) (in_range2 temp___expr_424)))
(define-fun dynamic_invariant10 ((temp___expr_430 Int) (temp___is_init_427 Bool) (temp___skip_constant_428 Bool) (temp___do_toplevel_429 Bool)) Bool (=> (or (= temp___is_init_427 true) (<= 1 12)) (in_range3 temp___expr_430)))
(define-fun dynamic_invariant11 ((temp___expr_436 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 1 31)) (in_range4 temp___expr_436)))
(define-fun dynamic_invariant12 ((temp___expr_464 Int) (temp___is_init_461 Bool) (temp___skip_constant_462 Bool) (temp___do_toplevel_463 Bool)) Bool (=> (or (= temp___is_init_461 true) (<= 0 86399999)) (in_range5 temp___expr_464)))
(assert true)
...
(declare-const temp___1340 us_rep)
...
(assert (and (= temp___1340 (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime)) (= temp___1340 (mk___rep (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3)))))
...
(assert (= alarmtimeout__split_fields4 (us_split_fields1 temp___1340)))
