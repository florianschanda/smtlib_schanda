...
(assert (= (= o35 true) (forall ((j4 Int)) (=> (and (<= 0 j4) (<= j4 2147483647)) (=> (< (* (* j4 l2) 2) i3) (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* (* j4 l2) 2)) (ite (< (* l2 2) (- length1 (* (* j4 l2) 2))) (* l2 2) (- length1 (* (* j4 l2) 2)))) true))))))
(assert (< i3 length1))
(assert (and (= o16 (* l2 2)) (in_range1 (* l2 2))))
(assert (not (not (= o16 0))))
(check-sat)
(exit)
