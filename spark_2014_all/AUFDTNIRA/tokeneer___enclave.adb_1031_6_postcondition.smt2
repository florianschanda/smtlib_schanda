...
(assert (= (islocked (int__content currentlatch2) (us_private__content state12) (us_split_fields__content1 latchtimeout__split_fields1)) true))
(assert (= (thecurrentdoor (us_private__content state13)) 0))
(assert (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (alarm_timeout (us_private__content state13))) true))
(assert (not (= (thedooralarm (us_private__content state13)) 0)))
(check-sat)
(exit)
