...
(assert (= result7 true))
(assert (and (= o23 (- current_hi3 1)) (in_range1 (- current_hi3 1))))
(assert (= o24 (ite (<= hi_index o23) true false)))
(assert (= result8 (ite (<= (to_rep3 (first (rt x))) hi_index) o24 false)))
(assert (= result8 true))
(assert (= (to_rep2 o25) hi_index))
(assert (= (to_rep1 o26) lo_index))
(assert (= o26 o27))
(assert (= o25 o28))
(assert (= o29 (mk_slice_bounds (mk___split_fields o27 o28))))
(assert (not (or (< (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o29))) (to_rep1 (rec__sums__slice_bounds__lo (us_split_fields1 o29)))) (and (<= (to_rep3 (first (rt x))) (to_rep1 (rec__sums__slice_bounds__lo (us_split_fields1 o29)))) (<= (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o29))) (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
