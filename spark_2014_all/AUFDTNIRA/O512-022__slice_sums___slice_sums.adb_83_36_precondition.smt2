...
(declare-const o13 extended_index)
...
(assert (forall ((lo_index1 Int)) (=> (and (<= (to_rep (first (rt x))) lo_index1) (<= lo_index1 (- current_hi2 1))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep (first (rt x))) hi_index1) (<= hi_index1 (- current_hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index1) (of_rep1 hi_index1)))) max_sum2))))))
(assert (forall ((lo_index1 Int)) (=> (and (<= (to_rep (first (rt x))) lo_index1) (<= lo_index1 (- current_lo2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index1) (of_rep1 (- current_lo2 1))))) 0))))
(assert (forall ((hi_index1 Int)) (=> (and (<= current_lo2 hi_index1) (<= hi_index1 (- current_hi2 1))) (<= 0 (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep current_lo2) (of_rep1 hi_index1))))))))
...
(assert (= result5 (ite (<= (to_rep (first (rt x))) lo_index) o5 false)))
(assert (= result5 true))
(assert (and (= o6 (- current_hi2 1)) (in_range1 (- current_hi2 1))))
(assert (= o7 (ite (<= hi_index o6) true false)))
(assert (= result6 (ite (<= (to_rep (first (rt x))) hi_index) o7 false)))
(assert (= result6 true))
(assert (= (extended_indexqtint o8) hi_index))
(assert (= (indexqtint o9) lo_index))
(assert (= o9 o10))
(assert (= o8 o11))
(assert (= o12 o10))
(assert (= o13 o11))
(assert (not (or (< (extended_indexqtint o13) (indexqtint o12)) (and (<= (to_rep (first (rt x))) (indexqtint o12)) (<= (extended_indexqtint o13) (to_rep (last (rt x))))))))
(check-sat)
(exit)
