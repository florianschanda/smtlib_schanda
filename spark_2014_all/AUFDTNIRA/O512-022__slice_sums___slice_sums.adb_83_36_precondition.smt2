...
(assert (forall ((lo_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index1) (<= lo_index1 (- current_hi2 1))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index1) (<= hi_index1 (- current_hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep1 lo_index1) (of_rep2 hi_index1)))) max_sum2))))))
...
(assert (forall ((hi_index1 Int)) (=> (and (<= current_lo2 hi_index1) (<= hi_index1 (- current_hi2 1))) (<= 0 (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep1 current_lo2) (of_rep2 hi_index1))))))))
...
(assert (= o6 (ite (<= lo_index o5) true false)))
(assert (= result5 (ite (<= (to_rep3 (first (rt x))) lo_index) o6 false)))
(assert (= result5 true))
(assert (and (= o7 (- current_hi2 1)) (in_range1 (- current_hi2 1))))
(assert (= o8 (ite (<= hi_index o7) true false)))
(assert (= result6 (ite (<= (to_rep3 (first (rt x))) hi_index) o8 false)))
(assert (= result6 true))
(assert (= (to_rep2 o9) hi_index))
(assert (= (to_rep1 o10) lo_index))
(assert (= o10 o11))
(assert (= o9 o12))
(assert (= o13 (mk_slice_bounds (mk___split_fields o11 o12))))
(assert (not (or (< (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o13))) (to_rep1 (rec__sums__slice_bounds__lo (us_split_fields1 o13)))) (and (<= (to_rep3 (first (rt x))) (to_rep1 (rec__sums__slice_bounds__lo (us_split_fields1 o13)))) (<= (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o13))) (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
