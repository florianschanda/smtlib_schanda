...
(assert (and (= o5 (euclid value index3)) (and (in_range1 o5) (ite (= (are_coprime value index3) true) (= o5 1) (< 1 o5)))))
(assert (= o6 (ite (= o5 1) true false)))
(assert (= o7 (store result__3 index3 o6)))
(assert (= result3 result__3))
(assert (= result__4 o7))
(declare-const v1 Int)
(assert (<= 0 v1))
(assert (<= v1 index3))
(assert (= (select result__4 v1) true))
