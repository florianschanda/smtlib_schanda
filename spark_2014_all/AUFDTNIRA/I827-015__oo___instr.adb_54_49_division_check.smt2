...
(define-fun dynamic_invariant1 ((temp___expr_303 us_t1) (temp___is_init_300 Bool) (temp___skip_constant_301 Bool) (temp___do_toplevel_302 Bool)) Bool (=> (not (= temp___skip_constant_301 true)) (and (dynamic_property2 1 lg (first3 temp___expr_303) (last3 temp___expr_303)) (and (= (first3 temp___expr_303) 1) (= (last3 temp___expr_303) lg)))))
...
(assert (forall ((temp___133 Int) (temp___134 Int) (temp___135 Int)) (let ((temp___132 (instr__display_value__4__s1__aggregate_def temp___133 temp___134 temp___135))) (and (=> (dynamic_property 1 2147483647 temp___134 temp___135) (and (= (first5 temp___132) temp___134) (= (last5 temp___132) temp___135))) (forall ((temp___136 Int)) (= (select (to_array2 temp___132) temp___136) (of_rep temp___133)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_312 us_t3) (temp___is_init_309 Bool) (temp___skip_constant_310 Bool) (temp___do_toplevel_311 Bool)) Bool (=> (not (= temp___skip_constant_310 true)) (and (dynamic_property6 (+ lg 1) (to_rep1 (rec__instr__graphic_gauge__size (us_split_fields7 x))) (first7 temp___expr_312) (last7 temp___expr_312)) (and (= (first7 temp___expr_312) (+ lg 1)) (= (last7 temp___expr_312) (to_rep1 (rec__instr__graphic_gauge__size (us_split_fields7 x))))))))
...
(assert (forall ((temp___139 Int) (temp___140 Int) (temp___141 Int)) (let ((temp___138 (instr__display_value__4__s2__aggregate_def temp___139 temp___140 temp___141))) (and (=> (dynamic_property 1 2147483647 temp___140 temp___141) (and (= (first9 temp___138) temp___140) (= (last9 temp___138) temp___141))) (forall ((temp___142 Int)) (= (select (to_array4 temp___138) temp___142) (of_rep temp___139)))))))
...
(assert (= s1 (let ((temp___137 (instr__display_value__4__s1__aggregate_def (to_rep (rec__instr__graphic_gauge__fill (us_split_fields7 x))) 1 lg))) (of_array1 (to_array2 temp___137) (first5 temp___137) (last5 temp___137)))))
(assert (= s2 (let ((temp___143 (instr__display_value__4__s2__aggregate_def (to_rep (rec__instr__graphic_gauge__empty (us_split_fields7 x))) (+ lg 1) (to_rep1 (rec__instr__graphic_gauge__size (us_split_fields7 x)))))) (of_array3 (slide (to_array4 temp___143) (first9 temp___143) (+ lg 1)) (+ lg 1) (to_rep1 (rec__instr__graphic_gauge__size (us_split_fields7 x)))))))
(define-fun dynamic_invariant6 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 85)) (in_range3 temp___expr_178)))
(define-fun dynamic_invariant7 ((temp___expr_202 Int) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (=> (or (= temp___is_init_199 true) (<= 0 100)) (in_range4 temp___expr_202)))
(define-fun dynamic_invariant8 ((temp___expr_236 Int) (temp___is_init_233 Bool) (temp___skip_constant_234 Bool) (temp___do_toplevel_235 Bool)) Bool (=> (or (= temp___is_init_233 true) (<= 0 60)) (in_range5 temp___expr_236)))
(define-fun dynamic_invariant9 ((temp___expr_242 Int) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool)) Bool (=> (or (= temp___is_init_239 true) (<= 0 24)) (in_range6 temp___expr_242)))
...
(declare-const temp___349 (Array Int character))
(declare-const temp___3491 t2)
...
(declare-const temp___351 (Array Int character))
(declare-const temp___3511 t4)
