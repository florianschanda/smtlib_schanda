...
(assert (<= 0 k))
(assert (<= k (- j2 1)))
(assert (and (= o11 k) (in_range9 k)))
(assert (and (= o12 (get (model__ (mk___rep p__split_discrs p__split_fields3)) o11)) (= (bool_eq o12 (get (model__ (mk___rep p__split_discrs p__split_fields3)) o11)) true)))
(assert (= o13 (us_split_fields3 o12)))
(assert (= o14 (rec__partition_refinement__interval__last o13)))
(assert (= o15 (to_rep2 o14)))
(assert (= o16 (ite (<= l o15) true false)))
