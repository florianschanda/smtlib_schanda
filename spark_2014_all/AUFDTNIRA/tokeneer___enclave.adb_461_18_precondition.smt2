...
(assert (and (= o5 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range5 o5) (= o5 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result3 (ite (= o5 1) true false)))
(assert (=> (= result3 true) (and (= o7 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o7 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result3 true) (= o8 (ite (not (= o7 true)) true false))))
(assert (=> (= result3 true) (and (= result4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result4 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result3 true) (=> (= result4 true) (and (= o6 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range7 o6)))))
...
(assert (and (= result5 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result5 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result5 true))
