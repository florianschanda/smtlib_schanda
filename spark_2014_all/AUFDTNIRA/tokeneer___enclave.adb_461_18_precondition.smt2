...
(assert (and (= o13 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range5 o13) (= o13 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result6 (ite (= o13 1) true false)))
(assert (=> (= result6 true) (and (= o15 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o15 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result6 true) (= o16 (ite (not (= o15 true)) true false))))
(assert (=> (= result6 true) (and (= result7 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result7 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result6 true) (=> (= result7 true) (and (= o14 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range7 o14)))))
(assert (=> (= result6 true) (=> (= result7 true) (= o17 (ite (= o14 3) true false)))))
(assert (=> (= result6 true) (=> (not (= result7 true)) (= o17 false))))
(assert (=> (= result6 true) (= o18 (ite (= o17 false) o16 true))))
(assert (=> (not (= result6 true)) (= o18 (of_int 1))))
(assert (and (= result8 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result8 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result8 true))
