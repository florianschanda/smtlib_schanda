...
(assert (=> (= result3 true) (and (= o7 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o7 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result3 true) (= o8 (ite (not (= o7 true)) true false))))
(assert (=> (= result3 true) (and (= result4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result4 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result3 true) (=> (= result4 true) (and (= o6 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range6 o6)))))
(assert (=> (= result3 true) (=> (= result4 true) (= o9 (ite (= o6 3) true false)))))
(assert (=> (= result3 true) (=> (not (= result4 true)) (= o9 false))))
(assert (=> (= result3 true) (= o10 (ite (= o9 false) o8 true))))
(assert (=> (not (= result3 true)) (= o10 (distinct 1 0))))
(assert (and (= result5 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result5 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result5 true))
