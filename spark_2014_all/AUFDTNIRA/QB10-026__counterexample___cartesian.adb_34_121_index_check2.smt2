...
(assert (forall ((j1 Int)) (=> (and (<= (to_rep (first2 (rt1 array2))) j1) (<= j1 index22)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first2 (rt1 array1)))) (length1 array2)) (- j1 (to_rep (first2 (rt1 array2))))) 1)) 1)) (to_rep (select (elts1 array1) index11))))))
(assert (forall ((j1 Int)) (=> (and (<= (to_rep (first2 (rt1 array2))) j1) (<= j1 index22)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first2 (rt1 array1)))) (length1 array2)) (- j1 (to_rep (first2 (rt1 array2))))) 1)) 2)) (to_rep (select (elts1 array2) j1))))))
...
(assert (<= j index22))
(assert (not (<= (to_rep (first2 (rt1 array2))) j)))
(check-sat)
(exit)
