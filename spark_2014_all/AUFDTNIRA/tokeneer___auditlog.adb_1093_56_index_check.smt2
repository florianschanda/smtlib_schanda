...
(assert (and (<= 1 temp___1554) (<= temp___1554 17)))
(assert (= o17 temp___1554))
(assert (= o18 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13))) o17)))
(assert (= o19 (to_rep3 o18)))
