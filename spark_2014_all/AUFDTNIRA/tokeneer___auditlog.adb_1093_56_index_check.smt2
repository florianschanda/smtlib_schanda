...
(assert (and (<= 1 temp___1344) (<= temp___1344 17)))
(assert (= o37 temp___1344))
(assert (= o38 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields17))) o37)))
(assert (= o39 (to_rep2 o38)))
