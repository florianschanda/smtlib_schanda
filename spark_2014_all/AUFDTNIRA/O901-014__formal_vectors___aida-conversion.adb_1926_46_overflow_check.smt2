...
(assert (and (= temp___2212 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2212) (<= temp___2212 (to_rep1 n__last))))
(assert (= o88 temp___2212))
(assert (= o89 (select (map__content1 n7) o88)))
(assert (= o90 (to_rep1 o89)))
(assert (= o91 (* o90 10000000)))
(assert (and (= o92 o91) (in_range1 o91)))
(assert (= o93 (- target7 o92)))
(assert (and (= o94 o93) (in_range1 o93)))
(assert (= result16 (mk_int__ref target7)))
(assert (= target8 o94))
(assert (<= (- 99999999) target8))
(assert (and (= temp___2213 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___2213) (<= temp___2213 (to_rep1 n__last))))
(assert (= o95 temp___2213))
(assert (= o96 (select (map__content1 n7) o95)))
(assert (= o97 (to_rep1 o96)))
(assert (= o98 (* o97 100000000)))
(assert (not (in_range1 o98)))
(check-sat)
(exit)
