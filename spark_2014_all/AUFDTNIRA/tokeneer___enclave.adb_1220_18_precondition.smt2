...
(assert (= status1 8))
(assert (and (and (= (and (and (= (islocked currentlatch1 (let ((subject state1)) state3) latchtimeout__split_fields4) true) (= (thecurrentdoor (let ((subject state2)) state4)) 0)) (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (alarm_timeout (let ((subject state2)) state4))) true)) (= (thedooralarm (let ((subject state2)) state4)) 0)) (= (islocked currentlatch1 (let ((subject state1)) state3) latchtimeout__split_fields4) true)) (and (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range17 auditalarm3)) (in_range28 currentlatch1))))
(assert (and (not (= (ispresent (mk___rep theadmin__split_fields2)) true)) (not (= (isdoingop (mk___rep theadmin__split_fields2)) true))))
(assert (= o1 (extractuser tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))))
