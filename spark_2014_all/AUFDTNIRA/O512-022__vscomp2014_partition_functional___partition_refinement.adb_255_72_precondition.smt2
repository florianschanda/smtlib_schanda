...
(assert (and (<= (* 2 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (<= (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 5000) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (to_rep (select a j))) true))) (and (forall ((c1 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true) (= (to_rep (select a (element1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c1))) (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c1)))) (and (forall ((c1 us_rep)) (=> (= (has_key (positions x) c1) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x c1)) true))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= 0 (to_rep5 (select f j))) (<= (to_rep5 (select f j)) (- (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1))))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j)))))) j) (<= j (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j)))))))))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1))) (forall ((k Int)) (=> (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) j)))) k) (<= k (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) j)))))) (= (to_rep5 (select f k)) j))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1))) (= (to_rep3 (rec__partition_refinement__interval__count (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) j)))) 0))))))))))))
