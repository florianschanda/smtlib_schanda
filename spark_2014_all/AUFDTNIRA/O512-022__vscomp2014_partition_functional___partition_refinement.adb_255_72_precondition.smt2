...
(assert (and (= o62 (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c2)) (= (= o62 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c2) true))))
(assert (= o63 true))
(assert (= result15 (ite (= o63 true) o62 false)))
(assert (= result15 true))
(assert (not (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c2) true)))
(check-sat)
(exit)
