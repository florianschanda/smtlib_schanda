...
(assert (not (= (length temp___1946) 0)))
(assert (=> (<= (to_rep1 (first4 temp___19471)) (to_rep1 (last4 temp___19471))) (= o114 (+ (- (to_rep1 (last4 temp___19471)) (to_rep1 (first4 temp___19471))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___19471)) (to_rep1 (last4 temp___19471)))) (= o114 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1946))) (to_rep1 (last (rt temp___1946)))) (= o115 (+ (- (to_rep1 (last (rt temp___1946))) (to_rep1 (first (rt temp___1946)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1946))) (to_rep1 (last (rt temp___1946))))) (= o115 0)))
(assert (= o116 (+ o115 o114)))
(assert (= o117 (+ (to_rep1 (first (rt temp___1946))) o116)))
(assert (= o118 (- o117 1)))
