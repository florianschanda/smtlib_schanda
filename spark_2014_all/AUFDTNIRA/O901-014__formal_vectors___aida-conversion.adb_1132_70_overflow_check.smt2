...
(assert (= o110 (* o109 100000)))
(assert (and (= o117 o110) (in_range1 o110)))
(assert (= o118 (+ o117 o116)))
(assert (and (= o125 o118) (in_range1 o118)))
(assert (= o126 (+ o125 o124)))
(assert (not (in_range1 o126)))
(check-sat)
(exit)
