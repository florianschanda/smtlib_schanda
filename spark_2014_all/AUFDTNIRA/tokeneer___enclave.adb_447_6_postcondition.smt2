...
(declare-const authcert__split_fields2 us_split_fields22)
(declare-const idcert__split_fields2 us_split_fields16)
...
(declare-const authcert__split_fields3 us_split_fields__ref11)
(declare-const idcert__split_fields3 us_split_fields__ref8)
...
(declare-const authcert__split_fields4 us_split_fields22)
(declare-const idcert__split_fields4 us_split_fields16)
...
(assert (=> (not (= result true)) (and (= (= tokenok2 true) (and (and (= (isgood tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true) (= (authcertvalid tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true)) (in_range7 (theauthcertrole tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2))))) (and (and (and (and (in_range27 tokentry2) (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true)) (in_range26 tokenid2)) (in_range17 auditalarm2)) (in_range25 tokenpresence2)))))
...
(assert (=> (not (= result true)) (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range17 auditalarm3))))
...
(assert (=> (not (= result true)) (=> (= tokenok2 true) (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true) (in_range17 auditalarm4)))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true) (in_range17 auditalarm5)))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (= result1 status11))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (= status5 3))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (and (= o3 (getrole tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2))) (and (in_range7 o3) (= o3 (therole (rec__admintoken__validauthcertt__contents (let ((subject authcert__split_fields)) authcert__split_fields2)))))))))
...
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields12)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields12)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields12)) true) (in_range17 auditalarm6)))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields13)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields13)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields13)) true) (in_range17 auditalarm7)))))
...
(assert (=> (not (= result true)) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref8 idcert__split_fields1)) (let ((subject idcert__split_fields)) (mk___split_fields__ref8 idcert__split_fields2)))))
(assert (=> (not (= result true)) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref11 authcert__split_fields1)) (let ((subject authcert__split_fields)) (mk___split_fields__ref11 authcert__split_fields2)))))
...
(assert (= idcert__split_fields3 (let ((subject idcert__split_fields)) (mk___split_fields__ref8 idcert__split_fields1))))
(assert (= authcert__split_fields3 (let ((subject authcert__split_fields)) (mk___split_fields__ref11 authcert__split_fields1))))
...
(assert (= logfilesstatus3 (mk_map__ref1 logfilesstatus)))
(assert (= logfiles3 (mk_map__ref4 logfiles)))
...
(assert (= (int__content status7) 4))
(assert (not (not (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4))) true))))
(check-sat)
(exit)
