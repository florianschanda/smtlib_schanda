...
(define-fun status11 () int__ref (mk_int__ref status))
...
(assert (= o (ispresent1 tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields))))
(assert (= result (ite (not (= o true)) true false)))
(assert (=> (= result true) (and (= status3 3) (and (and (and (and (and (in_range9 auditalarm1) (in_range21 tokentry1)) (in_range20 tokenid1)) (in_range29 status3)) (in_range4 tokenpresence1)) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)))))
(assert (=> (= result true) (= (let ((subject state2)) (mk___private__ref state8)) state2)))
(assert (=> (= result true) (= (let ((subject status1)) (mk___private__ref status4)) status1)))
(assert (=> (= result true) (= (let ((subject description)) (mk_map__ref description2)) description)))
...
(assert (=> (= result true) (= state8 state3)))
...
(assert (=> (not (= result true)) (and (= (= tokenok2 true) (and (and (= (isgood tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true) (= (authcertvalid tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true)) (in_range8 (theauthcertrole tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2))))) (and (and (and (and (in_range9 auditalarm2) (in_range21 tokentry2)) (in_range20 tokenid2)) (in_range4 tokenpresence2)) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true)))))
(assert (=> (not (= result true)) (= o1 (extractuser tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)))))
(assert (=> (not (= result true)) (and (in_range9 auditalarm3) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (= o2 (extractuser tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2))))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (and (in_range9 auditalarm4) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true)))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (and (in_range9 auditalarm5) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true)))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (= result1 status11))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (= status5 3))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (and (= o3 (getrole tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2))) (and (in_range8 o3) (= o3 (therole (rec__admintoken__validauthcertt__contents (let ((subject authcert__split_fields)) authcert__split_fields2)))))))))
(assert (=> (not (= result true)) (=> (= tokenok2 true) (and (and (= (rolepresent (mk___rep theadmin__split_fields3)) o3) (not (= (isdoingop (mk___rep theadmin__split_fields3)) true))) (= (ispresent (mk___rep theadmin__split_fields3)) true)))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= o4 (extractuser tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2))))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (and (in_range9 auditalarm6) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields12)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields12)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields12)) true)))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (and (in_range9 auditalarm7) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields13)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields13)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields13)) true)))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= result2 status11))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= status6 4))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= (let ((subject state2)) (mk___private__ref state8)) (let ((subject state2)) (mk___private__ref state10))))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= (let ((subject state)) (mk___private__ref state7)) (let ((subject state)) (mk___private__ref state9))))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= (let ((subject filestate)) (mk___private__ref filestate2)) (let ((subject filestate)) (mk___private__ref filestate3))))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= theadmin__split_fields3 (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= status5 status6))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= auditsystemfault1 auditsystemfault2))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= auditalarm5 auditalarm7))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= logfilestate__split_fields11 logfilestate__split_fields13))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= logfilesstatus1 logfilesstatus2))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= logfiles1 logfiles2))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= state8 state10))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= state7 state9))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= filestate2 filestate3))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= theadmin__split_fields3 theadmin__split_fields2))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= status5 status6))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= auditsystemfault1 auditsystemfault2))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= auditalarm5 auditalarm7))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= logfilestate__split_fields11 logfilestate__split_fields13))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= logfilesstatus1 logfilesstatus2))))
(assert (=> (not (= result true)) (=> (not (= tokenok2 true)) (= logfiles1 logfiles2))))
(assert (=> (not (= result true)) (= (let ((subject state1)) (mk___private__ref state5)) (let ((subject state1)) (mk___private__ref state6)))))
(assert (=> (not (= result true)) (= (let ((subject state)) (mk___private__ref state4)) (let ((subject state)) (mk___private__ref state7)))))
(assert (=> (not (= result true)) (= (let ((subject filestate)) (mk___private__ref filestate1)) (let ((subject filestate)) (mk___private__ref filestate2)))))
(assert (=> (not (= result true)) (= status3 status5)))
(assert (=> (not (= result true)) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields1)) (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields2)))))
(assert (=> (not (= result true)) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields1)) (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields2)))))
(assert (=> (not (= result true)) (= tokenid1 tokenid2)))
(assert (=> (not (= result true)) (= tokentry1 tokentry2)))
(assert (=> (not (= result true)) (= tokenpresence1 tokenpresence2)))
(assert (=> (not (= result true)) (= auditsystemfault auditsystemfault1)))
(assert (=> (not (= result true)) (= auditalarm1 auditalarm5)))
(assert (=> (not (= result true)) (= logfilestate__split_fields7 logfilestate__split_fields11)))
(assert (=> (not (= result true)) (= logfilesstatus logfilesstatus1)))
(assert (=> (not (= result true)) (= logfiles logfiles1)))
(assert (=> (not (= result true)) (= state5 state6)))
(assert (=> (not (= result true)) (= state4 state7)))
(assert (=> (not (= result true)) (= filestate1 filestate2)))
(assert (=> (not (= result true)) (= status3 status5)))
(assert (=> (not (= result true)) (= idcert__split_fields1 idcert__split_fields2)))
(assert (=> (not (= result true)) (= authcert__split_fields1 authcert__split_fields2)))
(assert (=> (not (= result true)) (= tokenid1 tokenid2)))
(assert (=> (not (= result true)) (= tokentry1 tokentry2)))
(assert (=> (not (= result true)) (= tokenpresence1 tokenpresence2)))
(assert (=> (not (= result true)) (= auditsystemfault auditsystemfault1)))
...
(assert (=> (not (= result true)) (= logfilesstatus logfilesstatus1)))
(assert (=> (not (= result true)) (= logfiles logfiles1)))
(assert (= state13 (let ((subject state2)) (mk___private__ref state8))))
(assert (= status8 (let ((subject status1)) (mk___private__ref status4))))
(assert (= state12 (let ((subject state1)) (mk___private__ref state5))))
(assert (= state11 (let ((subject state)) (mk___private__ref state4))))
(assert (= filestate4 (let ((subject filestate)) (mk___private__ref filestate1))))
(assert (= description3 (let ((subject description)) (mk_map__ref description2))))
(assert (= tokenok3 (mk_bool__ref tokenok2)))
(assert (= theadmin__split_fields4 (mk___split_fields__ref theadmin__split_fields3)))
(assert (= status7 (mk_int__ref status3)))
(assert (= idcert__split_fields3 (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields1))))
(assert (= authcert__split_fields3 (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields1))))
(assert (= tokenid3 (mk_int__ref tokenid1)))
(assert (= tokentry3 (mk_int__ref tokentry1)))
(assert (= tokenpresence3 (mk_int__ref tokenpresence1)))
(assert (= auditsystemfault3 (mk_bool__ref auditsystemfault)))
(assert (= auditalarm8 (mk_int__ref auditalarm1)))
(assert (= logfilestate__split_fields14 (mk___split_fields__ref3 logfilestate__split_fields7)))
(assert (= logfilesstatus3 (mk_map__ref4 logfilesstatus)))
(assert (= logfiles3 (mk_map__ref3 logfiles)))
(assert (= state16 state8))
(assert (= status10 status4))
(assert (= state15 state5))
(assert (= state14 state4))
(assert (= filestate5 filestate1))
(assert (= description4 description2))
(assert (= tokenok4 tokenok2))
(assert (= theadmin__split_fields5 theadmin__split_fields3))
(assert (= status9 status3))
(assert (= idcert__split_fields4 idcert__split_fields1))
(assert (= authcert__split_fields4 authcert__split_fields1))
(assert (= tokenid4 tokenid1))
(assert (= tokentry4 tokentry1))
(assert (= tokenpresence4 tokenpresence1))
...
(assert (not (or (= (int__content status7) 3) (= (int__content status7) 4))))
(check-sat)
(exit)
