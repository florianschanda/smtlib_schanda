...
(declare-const thistisinfo__split_fields4 us_split_fields__ref3)
...
(assert (and (= (= (privatekeypresent (us_split_fields__content3 thistisinfo__split_fields4) (us_private__content state1)) true) (not (= (enrolmentisinprogress (int__content status1)) true))) (or (= (enrolmentisinprogress (int__content status1)) true) (= (int__content status1) 3))))
(assert (and (and (in_range1 (int__content auditalarm1)) (in_range10 (int__content status1))) (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields7))) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content1 logfilestate__split_fields7))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields7)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields7))) true)))
(assert (= (privatekeypresent (us_split_fields__content3 thistisinfo__split_fields4) (us_private__content state1)) true))
