...
(assert (not (= (enrolmentisinprogress (int__content status1)) true)))
(assert (not (= (privatekeypresent (us_split_fields__content1 thistisinfo__split_fields4) (us_private__content state1)) true)))
(check-sat)
(exit)
