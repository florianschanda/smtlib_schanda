...
(assert (and (= (= (privatekeypresent (us_split_fields__content3 thistisinfo__split_fields6) (us_private__content state16)) true) (not (= (enrolmentisinprogress (int__content status4)) true))) (or (= (enrolmentisinprogress (int__content status4)) true) (= (int__content status4) 3))))
(assert (and (and (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields10))) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content1 logfilestate__split_fields10))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields10)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields10))) true) (in_range1 (int__content auditalarm4))) (in_range10 (int__content status4))))
