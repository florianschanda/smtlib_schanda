...
(assert (forall ((temp___2075 Int) (temp___2076 Int) (temp___2077 Int) (temp___2078 Int) (temp___2079 Int) (temp___2080 Int) (temp___2081 Int) (temp___2082 Int)) (let ((temp___2074 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def temp___2075 temp___2076 temp___2077 temp___2078 temp___2079 temp___2080 temp___2081 temp___2082))) (=> (and (and (and (and (and (dynamic_invariant temp___2075 true true true true) (dynamic_invariant temp___2076 true true true true)) (dynamic_invariant temp___2077 true true true true)) (dynamic_invariant temp___2078 true true true true)) (dynamic_invariant temp___2079 true true true true)) (dynamic_invariant temp___2080 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 5) (+ (first1 source) 10) temp___2081 temp___2082) (and (= (first5 temp___2074) temp___2081) (= (last5 temp___2074) temp___2082))) (and (and (and (and (and (= (to_rep1 (select (to_array2 temp___2074) (+ (+ (first1 source) 5) 0))) temp___2075) (= (to_rep1 (select (to_array2 temp___2074) (+ (+ (first1 source) 5) 1))) temp___2076)) (= (to_rep1 (select (to_array2 temp___2074) (+ (+ (first1 source) 5) 2))) temp___2077)) (= (to_rep1 (select (to_array2 temp___2074) (+ (+ (first1 source) 5) 3))) temp___2078)) (= (to_rep1 (select (to_array2 temp___2074) (+ (+ (first1 source) 5) 4))) temp___2079)) (= (to_rep1 (select (to_array2 temp___2074) (+ (+ (first1 source) 5) 5))) temp___2080)))))))
(define-fun dynamic_invariant4 ((temp___expr_674 us_t3) (temp___is_init_670 Bool) (temp___skip_constant_671 Bool) (temp___do_toplevel_672 Bool) (temp___do_typ_inv_673 Bool)) Bool (=> (not (= temp___skip_constant_671 true)) (and (dynamic_property6 (+ (first1 source) 5) (+ (first1 source) 10) (first7 temp___expr_674) (last7 temp___expr_674)) (and (= (first7 temp___expr_674) (+ (first1 source) 5)) (= (last7 temp___expr_674) (+ (first1 source) 10))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2088 Int) (temp___2089 Int) (temp___2090 Int)) (let ((temp___2087 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def temp___2088 temp___2089 temp___2090))) (=> (dynamic_invariant temp___2088 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 5) (+ (first1 source) 10) temp___2089 temp___2090) (and (= (first9 temp___2087) temp___2089) (= (last9 temp___2087) temp___2090))) (forall ((temp___2091 Int)) (= (to_rep1 (select (to_array4 temp___2087) temp___2091)) temp___2088)))))))
...
(declare-const temp___2085 (Array Int integer))
(declare-const temp___20851 t2)
...
(declare-const temp___2093 (Array Int integer))
(declare-const temp___20931 t4)
...
(declare-const temp___2099 Int)
(declare-const temp___2100 Int)
(declare-const temp___2098 Int)
(declare-const temp___2096 (Array Int integer))
(declare-const o Int)
...
(declare-const temp___2101 Int)
(declare-const o9 Int)
(declare-const o10 integer)
(declare-const o11 Int)
(declare-const o12 Int)
(declare-const o13 Int)
(declare-const temp___2102 Int)
...
(assert (and (= (length source) 11) (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) index7) (<= index7 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2085 temp___20851) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def 3 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 5) (+ (+ (to_rep1 (first (rt source))) 5) 5))))
(assert (= (ite (<= (to_rep1 (first4 temp___20851)) (to_rep1 (last4 temp___20851))) (+ (- (to_rep1 (last4 temp___20851)) (to_rep1 (first4 temp___20851))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 5)) 1) 0)))
(assert (= (slide1 temp___2085 (to_rep1 (first4 temp___20851)) (+ (to_rep1 (first (rt source))) 5)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume))
...
(assert (= (mk___t4 temp___2093 temp___20931) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___20931)) (to_rep1 (last8 temp___20931))) (+ (- (to_rep1 (last8 temp___20931)) (to_rep1 (first8 temp___20931))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 5)) 1) 0)))
(assert (= (slide1 temp___2093 (to_rep1 (first8 temp___20931)) (+ (to_rep1 (first (rt source))) 5)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume))
...
(assert (and (= temp___2099 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (= temp___2100 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2099))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= temp___2098 index1)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= temp___2096 n1)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= o index1)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= o3 index1)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= o7 index1)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= n1 result3)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= n2 o8)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (and (and (forall ((temp___2097 Int)) (=> (and (<= (to_rep1 n__first) temp___2097) (<= temp___2097 (to_rep1 n__last))) (=> (< index2 temp___2097) (= (select n3 temp___2097) (select temp___2096 temp___2097))))) (=> (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 5) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= index2 temp___2100)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= index2 index3)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= n3 n4)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= index4 index2)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= n5 n3)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= index6 index4)))
(assert (=> (and (<= temp___2099 index1) (<= index1 temp___2100)) (= n7 n5)))
(assert (=> (not (and (<= temp___2099 index1) (<= index1 temp___2100))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2099 index1) (<= index1 temp___2100))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2099 index1) (<= index1 temp___2100))) (= index6 index1)))
(assert (=> (not (and (<= temp___2099 index1) (<= index1 temp___2100))) (= n7 n1)))
...
(assert (and (= temp___2101 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___2101) (<= temp___2101 (to_rep1 n__last))))
(assert (= o9 temp___2101))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2102 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___2102) (<= temp___2102 (to_rep1 n__last))))
(assert (= o14 temp___2102))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___2103 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2103) (<= temp___2103 (to_rep1 n__last))))
(assert (= o21 temp___2103))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___2104 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2104) (<= temp___2104 (to_rep1 n__last))))
(assert (= o28 temp___2104))
...
(assert (= target4 o34))
(assert (<= (- 9999) target4))
(assert (and (= temp___2105 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2105) (<= temp___2105 (to_rep1 n__last))))
(assert (= o35 temp___2105))
...
(assert (and (= temp___2106 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2106) (<= temp___2106 (to_rep1 n__last))))
(assert (= o42 temp___2106))
...
(assert (and (= o49 (- target6 2147000000)) (in_range1 (- target6 2147000000))))
