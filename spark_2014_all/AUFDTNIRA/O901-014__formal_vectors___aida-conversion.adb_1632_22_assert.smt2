...
(define-fun tint_arrayD1__ref___14__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___14__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t511b__ref (mk_t511b__ref (t511b__content integer)))))
(define-fun t511b__ref___projection ((a t511b__ref)) integer (t511b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t512b__ref (mk_t512b__ref (t512b__content us_t2)))))
(define-fun t512b__ref___projection ((a t512b__ref)) us_t2 (t512b__content a))
...
(define-fun tnumber_array_typeD1__ref___23__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___23__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t515b__ref (mk_t515b__ref (t515b__content integer)))))
(define-fun t515b__ref___projection ((a t515b__ref)) integer (t515b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t516b__ref (mk_t516b__ref (t516b__content us_t4)))))
(define-fun t516b__ref___projection ((a t516b__ref)) us_t4 (t516b__content a))
...
(declare-datatypes () ((t517b__ref (mk_t517b__ref (t517b__content integer)))))
(define-fun t517b__ref___projection ((a t517b__ref)) integer (t517b__content a))
...
(define-fun tint_arrayB__ref___14__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def (Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___1973 Int) (temp___1974 Int) (temp___1975 Int) (temp___1976 Int) (temp___1977 Int) (temp___1978 Int) (temp___1979 Int) (temp___1980 Int)) (let ((temp___1972 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def temp___1973 temp___1974 temp___1975 temp___1976 temp___1977 temp___1978 temp___1979 temp___1980))) (and (=> (dynamic_property10 (+ (first1 source) 5) (+ (first1 source) 10) temp___1979 temp___1980) (and (= (first5 temp___1972) temp___1979) (= (last5 temp___1972) temp___1980))) (and (and (and (and (and (= (select (to_array2 temp___1972) (+ (+ (first1 source) 5) 0)) (of_rep1 temp___1973)) (= (select (to_array2 temp___1972) (+ (+ (first1 source) 5) 1)) (of_rep1 temp___1974))) (= (select (to_array2 temp___1972) (+ (+ (first1 source) 5) 2)) (of_rep1 temp___1975))) (= (select (to_array2 temp___1972) (+ (+ (first1 source) 5) 3)) (of_rep1 temp___1976))) (= (select (to_array2 temp___1972) (+ (+ (first1 source) 5) 4)) (of_rep1 temp___1977))) (= (select (to_array2 temp___1972) (+ (+ (first1 source) 5) 5)) (of_rep1 temp___1978)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___23__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___1986 Int) (temp___1987 Int) (temp___1988 Int)) (let ((temp___1985 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def temp___1986 temp___1987 temp___1988))) (and (=> (dynamic_property11 (+ (first1 source) 5) (+ (first1 source) 10) temp___1987 temp___1988) (and (= (first9 temp___1985) temp___1987) (= (last9 temp___1985) temp___1988))) (forall ((temp___1989 Int)) (= (select (to_array4 temp___1985) temp___1989) (of_rep1 temp___1986)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_599 us_t3) (temp___is_init_596 Bool) (temp___skip_constant_597 Bool) (temp___do_toplevel_598 Bool)) Bool (=> (not (= temp___skip_constant_597 true)) (and (dynamic_property6 (+ (first1 source) 5) (+ (first1 source) 10) (first7 temp___expr_599) (last7 temp___expr_599)) (and (= (first7 temp___expr_599) (+ (first1 source) 5)) (= (last7 temp___expr_599) (+ (first1 source) 10))))))
...
(declare-const temp___1983 (Array Int integer))
(declare-const temp___19831 t2)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___1991 (Array Int integer))
(declare-const temp___19911 t4)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume1 t3)
(declare-const us2 Int)
(declare-const us3 Int)
(declare-const temp___1997 Int)
(declare-const temp___1998 Int)
(declare-const temp___1996 Int)
(declare-const temp___1994 (Array Int integer))
...
(assert (and (= (length source) 11) (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def 3 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 5) (+ (+ (to_rep1 (first (rt source))) 5) 5))))) (+ (to_rep1 (first (rt source))) 5)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def 3 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 5) (+ (+ (to_rep1 (first (rt source))) 5) 5))))) (+ (+ (to_rep1 (first (rt source))) 5) 5)))
(assert (= (mk___t2 temp___1983 temp___19831) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def 3 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 5) (+ (+ (to_rep1 (first (rt source))) 5) 5))))
(assert (= (ite (<= (to_rep1 (first4 temp___19831)) (to_rep1 (last4 temp___19831))) (+ (- (to_rep1 (last4 temp___19831)) (to_rep1 (first4 temp___19831))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 5)) 1) 0)))
(assert (= (slide1 temp___1983 (to_rep1 (first4 temp___19831)) (+ (to_rep1 (first (rt source))) 5)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 5)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 5)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)))
(assert (= (mk___t4 temp___1991 temp___19911) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___19911)) (to_rep1 (last8 temp___19911))) (+ (- (to_rep1 (last8 temp___19911)) (to_rep1 (first8 temp___19911))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 5)) 1) 0)))
(assert (= (slide1 temp___1991 (to_rep1 (first8 temp___19911)) (+ (to_rep1 (first (rt source))) 5)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 5)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= temp___1997 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (= temp___1998 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___1997))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= temp___1996 index2)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= temp___1994 n1)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= o25 index2)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= o26 (select n1 o25))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= o27 (to_rep1 o26))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= o27 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= o28 index2)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= o29 (select (elts source) o28))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= o30 (to_rep o29))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o30))) (ite (= (= o30 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o30 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o30 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o30 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o30 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o30 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o30 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o30 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o30 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o30 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= (to_rep1 o31) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= o32 index2)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= o33 (store n1 o32 o31))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= n1 result4)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= n2 o33)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (and (and (forall ((temp___1995 Int)) (=> (and (<= (to_rep1 n__first) temp___1995) (<= temp___1995 (to_rep1 n__last))) (=> (< index3 temp___1995) (= (select n3 temp___1995) (select temp___1994 temp___1995))))) (=> (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 5) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= index3 temp___1998)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= index3 index5)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= n3 n5)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= index6 index3)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= n6 n3)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= index8 index6)))
(assert (=> (and (<= temp___1997 index2) (<= index2 temp___1998)) (= n8 n6)))
(assert (=> (not (and (<= temp___1997 index2) (<= index2 temp___1998))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___1997 index2) (<= index2 temp___1998))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___1997 index2) (<= index2 temp___1998))) (= index8 index2)))
(assert (=> (not (and (<= temp___1997 index2) (<= index2 temp___1998))) (= n8 n1)))
...
(assert (and (= temp___1999 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___1999) (<= temp___1999 (to_rep1 n__last))))
(assert (= o61 temp___1999))
...
(assert (= target1 o65))
(assert (<= (- 9) target1))
(assert (and (= temp___2000 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___2000) (<= temp___2000 (to_rep1 n__last))))
(assert (= o66 temp___2000))
(assert (= o67 (select (map__content1 n7) o66)))
(assert (= o68 (to_rep1 o67)))
(assert (= o69 (* o68 10)))
(assert (and (= o70 o69) (in_range1 o69)))
(assert (= o71 (- target1 o70)))
(assert (and (= o72 o71) (in_range1 o71)))
(assert (= result10 (mk_int__ref target1)))
(assert (= target2 o72))
(assert (<= (- 99) target2))
(assert (and (= temp___2001 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2001) (<= temp___2001 (to_rep1 n__last))))
(assert (= o73 temp___2001))
(assert (= o74 (select (map__content1 n7) o73)))
(assert (= o75 (to_rep1 o74)))
(assert (= o76 (* o75 100)))
(assert (and (= o77 o76) (in_range1 o76)))
(assert (= o78 (- target2 o77)))
(assert (and (= o79 o78) (in_range1 o78)))
(assert (= result11 (mk_int__ref target2)))
(assert (= target3 o79))
(assert (<= (- 999) target3))
(assert (and (= temp___2002 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2002) (<= temp___2002 (to_rep1 n__last))))
(assert (= o80 temp___2002))
(assert (= o81 (select (map__content1 n7) o80)))
(assert (= o82 (to_rep1 o81)))
(assert (= o83 (* o82 1000)))
(assert (and (= o84 o83) (in_range1 o83)))
(assert (= o85 (- target3 o84)))
(assert (and (= o86 o85) (in_range1 o85)))
(assert (= result12 (mk_int__ref target3)))
(assert (= target4 o86))
(assert (<= (- 9999) target4))
(assert (and (= temp___2003 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2003) (<= temp___2003 (to_rep1 n__last))))
(assert (= o87 temp___2003))
(assert (= o88 (select (map__content1 n7) o87)))
(assert (= o89 (to_rep1 o88)))
(assert (= o90 (* o89 10000)))
(assert (and (= o91 o90) (in_range1 o90)))
(assert (= o92 (- target4 o91)))
(assert (and (= o93 o92) (in_range1 o92)))
(assert (= result13 (mk_int__ref target4)))
(assert (= target5 o93))
(assert (<= (- 99999) target5))
(assert (and (= temp___2004 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2004) (<= temp___2004 (to_rep1 n__last))))
(assert (= o94 temp___2004))
(assert (= o95 (select (map__content1 n7) o94)))
(assert (= o96 (to_rep1 o95)))
(assert (= o97 (* o96 100000)))
(assert (and (= o98 o97) (in_range1 o97)))
(assert (= o99 (- target5 o98)))
(assert (and (= o100 o99) (in_range1 o99)))
(assert (= result14 (mk_int__ref target5)))
(assert (= target6 o100))
(assert (<= (- 399999) target6))
(assert (and (= o101 (- target6 2147000000)) (in_range1 (- target6 2147000000))))
(assert (= result15 (mk_int__ref target6)))
(assert (= target7 o101))
(assert (not (<= (- 2147399999) target7)))
(check-sat)
(exit)
