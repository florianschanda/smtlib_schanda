...
(assert (= o1 switchposition1))
(assert (= o2 (select onofftime2 o1)))
(assert (= o3 (to_rep o2)))
(assert (= result8 (mk_int__ref timer)))
(assert (= timer5 o3))
(assert (and (= o4 (currentmode advancemode)) (in_range4 o4)))
(assert (= result9 (ite (= o4 0) true false)))
(assert (= result9 true))
(assert (= slowadvance3 true))
