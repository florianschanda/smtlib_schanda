...
(declare-const c5 us_rep)
(assert (= (has_key (positions x) c5) true))
(assert (not (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) (find d_old (element x c5))) true)))
(check-sat)
(exit)
