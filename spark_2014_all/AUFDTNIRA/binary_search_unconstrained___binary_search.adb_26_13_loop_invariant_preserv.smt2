...
(assert (=> (= result7 true) (and (= o19 (+ med2 1)) (in_range2 (+ med2 1)))))
(assert (=> (= result7 true) (and (= o20 o19) (in_range3 o19))))
(assert (=> (= result7 true) (= left2 result8)))
(assert (=> (= result7 true) (= left3 o20)))
(assert (=> (= result7 true) (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 med2)) (<= (to_rep (select (elts a) i1)) (to_rep (select (elts a) med2)))))))
(assert (=> (= result7 true) (= binary_search__search__result6 binary_search__search__result5)))
(assert (=> (= result7 true) (= right3 right2)))
(assert (=> (not (= result7 true)) (and (<= (to_rep1 (first (rt a))) med2) (<= med2 (to_rep1 (last (rt a)))))))
...
(assert (=> (not (= result7 true)) (and (= o24 (- med2 1)) (in_range3 (- med2 1)))))
(assert (=> (not (= result7 true)) (= right2 result10)))
(assert (=> (not (= result7 true)) (= right3 o24)))
(assert (=> (not (= result7 true)) (and (<= (to_rep1 (first (rt a))) med2) (<= med2 (to_rep1 (last (rt a)))))))
(assert (=> (not (= result7 true)) (forall ((i2 Int)) (=> (and (<= med2 i2) (<= i2 (to_rep1 (last (rt a))))) (<= (to_rep (select (elts a) med2)) (to_rep (select (elts a) i2)))))))
(assert (=> (not (= result7 true)) (= binary_search__search__result6 binary_search__search__result5)))
(assert (=> (not (= result7 true)) (= left3 left2)))
(assert (<= left3 right3))
(declare-const index1 Int)
(assert (<= (to_rep1 (first (rt a))) index1))
(assert (<= index1 (- left3 1)))
(assert (not (< (to_rep (select (elts a) index1)) i)))
(check-sat)
(exit)
