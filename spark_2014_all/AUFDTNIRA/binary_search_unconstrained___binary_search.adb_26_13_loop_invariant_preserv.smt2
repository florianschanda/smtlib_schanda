...
(assert (=> (= result10 true) (and (= o22 (+ med3 1)) (in_range2 (+ med3 1)))))
(assert (=> (= result10 true) (and (= o23 o22) (in_range3 o22))))
(assert (=> (= result10 true) (= left3 result11)))
(assert (=> (= result10 true) (= left4 o23)))
(assert (=> (= result10 true) (forall ((i12 Int)) (=> (and (<= (to_rep1 (first (rt a))) i12) (<= i12 med3)) (<= (to_rep (select (elts a) i12)) (to_rep (select (elts a) med3)))))))
(assert (=> (= result10 true) (= binary_search__search__result8 binary_search__search__result7)))
(assert (=> (= result10 true) (= right4 right3)))
(assert (=> (not (= result10 true)) (and (<= (to_rep1 (first (rt a))) med3) (<= med3 (to_rep1 (last (rt a)))))))
(assert (=> (not (= result10 true)) (= o27 med3)))
(assert (=> (not (= result10 true)) (= o28 (select (elts a) o27))))
(assert (=> (not (= result10 true)) (= o29 (to_rep o28))))
(assert (=> (not (= result10 true)) (= result12 (ite (< i o29) true false))))
(assert (=> (not (= result10 true)) (= result12 true)))
(assert (=> (not (= result10 true)) (and (= o30 (- med3 1)) (in_range3 (- med3 1)))))
(assert (=> (not (= result10 true)) (= right3 result13)))
(assert (=> (not (= result10 true)) (= right4 o30)))
(assert (=> (not (= result10 true)) (and (<= (to_rep1 (first (rt a))) med3) (<= med3 (to_rep1 (last (rt a)))))))
(assert (=> (not (= result10 true)) (forall ((i22 Int)) (=> (and (<= med3 i22) (<= i22 (to_rep1 (last (rt a))))) (<= (to_rep (select (elts a) med3)) (to_rep (select (elts a) i22)))))))
(assert (=> (not (= result10 true)) (= binary_search__search__result8 binary_search__search__result7)))
(assert (=> (not (= result10 true)) (= left4 left3)))
(assert (<= left4 right4))
(declare-const index4 Int)
(assert (<= (to_rep1 (first (rt a))) index4))
(assert (<= index4 (- left4 1)))
(assert (not (< (to_rep (select (elts a) index4)) i)))
(check-sat)
(exit)
