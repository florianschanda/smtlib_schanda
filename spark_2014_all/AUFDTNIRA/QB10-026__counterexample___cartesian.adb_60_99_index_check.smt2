...
(assert (and (= o47 (length array2)) (in_range1 (length array2))))
(assert (and (= o48 (- i (to_rep (first (rt array1))))) (in_range1 (- i (to_rep (first (rt array1)))))))
(assert (= o49 (* o48 o47)))
(assert (and (= o51 o49) (in_range1 o49)))
(assert (= o52 (+ o51 o50)))
(assert (and (= o53 o52) (in_range1 o52)))
(assert (= o54 (+ o53 1)))
(assert (and (= temp___262 o54) (in_range1 o54)))
(assert (not (<= (to_rep result____first) temp___262)))
(check-sat)
(exit)
