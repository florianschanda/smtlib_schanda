...
(define-fun temp___18192 () us_t1 (mk___t1 temp___1819 temp___18191))
...
(assert (dynamic_predicate temp___18192))
(assert (= o5 temp___18192))
(assert (= o2 (convertretvaltotext retval1 o5)))
(assert (= o2 o3))
(assert (= (mk 1 150) o4))
(assert (not (= (to_rep1 (first o4)) 1)))
(check-sat)
(exit)
