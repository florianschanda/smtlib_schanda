...
(define-fun dynamic_invariant ((temp___expr_135 Int) (temp___is_init_132 Bool) (temp___skip_constant_133 Bool) (temp___do_toplevel_134 Bool)) Bool (=> (or (= temp___is_init_132 true) (<= 0 1024)) (in_range2 temp___expr_135)))
...
(define-fun dynamic_invariant1 ((temp___expr_141 Int) (temp___is_init_138 Bool) (temp___skip_constant_139 Bool) (temp___do_toplevel_140 Bool)) Bool (=> (or (= temp___is_init_138 true) (<= 1 1024)) (in_range3 temp___expr_141)))
...
(declare-fun temp___204 (Int) (Array Int character))
(assert (forall ((temp___206 Int)) (forall ((temp___207 Int)) (= (select (temp___204 temp___206) temp___207) (of_rep temp___206)))))
...
(assert (= workspace1 (temp___204 32)))
(assert (= result1 i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 1024))
