...
(declare-fun temp_____aggregate_def_232 (Int) (Array Int character))
...
(assert (forall ((temp___234 Int)) (=> (dynamic_invariant2 temp___234 true true true true) (forall ((temp___235 Int)) (= (to_rep (select (temp_____aggregate_def_232 temp___234) temp___235)) temp___234)))))
...
(assert (= workspace1 (temp_____aggregate_def_232 32)))
(assert (= result1 i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 1024))
