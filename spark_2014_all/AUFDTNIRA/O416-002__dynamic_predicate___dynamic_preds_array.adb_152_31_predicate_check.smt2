...
(declare-const dynamic_preds_array__update_even_close_pair__x (Array Int even))
(declare-const dynamic_preds_array__update_even_close_pair__x1 (Array Int even))
...
(assert (= o x))
(assert (= o dynamic_preds_array__update_even_close_pair__x))
(assert (dynamic_invariant2 dynamic_preds_array__update_even_close_pair__x1 true true true true))
(assert (= result x))
(assert (= x1 dynamic_preds_array__update_even_close_pair__x1))
