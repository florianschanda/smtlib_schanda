...
(assert (= (= o49 true) (forall ((j4 Int)) (=> (and (<= 0 j4) (<= j4 2147483647)) (=> (< (* j4 l2) (- length1 i3)) (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ (+ a_first i3) (* j4 l2)) (ite (< l2 (- (- length1 i3) (* j4 l2))) l2 (- (- length1 i3) (* j4 l2)))) true))))))
(assert (<= 0 j1))
(assert (<= j1 2147483647))
(assert (and (= o18 (* j1 l2)) (in_range1 (* j1 l2))))
(assert (= o19 (* o18 2)))
(assert (and (= o20 o19) (in_range1 o19)))
(assert (= result4 (ite (< o20 i3) true false)))
(assert (= result4 true))
(assert (and (= o27 (* j1 l2)) (in_range1 (* j1 l2))))
(assert (= o28 (* o27 2)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (= o30 (- length1 o29)))
(assert (and (= o31 o30) (in_range1 o30)))
(assert (and (= o32 (* l2 2)) (in_range1 (* l2 2))))
(assert (= o33 (ite (< o32 o31) o32 o31)))
(assert (and (= o34 o33) (in_range2 o33)))
(assert (not (in_range1 (* j1 l2))))
(check-sat)
(exit)
