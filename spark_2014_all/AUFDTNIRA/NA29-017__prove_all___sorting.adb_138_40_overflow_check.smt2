...
(assert (= o12 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (= (= o11 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 2147483647)) (=> (< (* j1 l2) (- length1 i3)) (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ (+ a_first i3) (* j1 l2)) (ite (< l2 (- (- length1 i3) (* j1 l2))) l2 (- (- length1 i3) (* j1 l2)))) true))))))
(assert (<= 0 j))
(assert (<= j 2147483647))
(assert (and (= o (* j l2)) (in_range1 (* j l2))))
(assert (= o1 (* o 2)))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (= result2 (ite (< o2 i3) true false)))
(assert (= result2 true))
(assert (and (= o3 (* j l2)) (in_range1 (* j l2))))
(assert (= o4 (* o3 2)))
(assert (and (= o5 o4) (in_range1 o4)))
(assert (= o6 (- length1 o5)))
(assert (and (= o7 o6) (in_range1 o6)))
(assert (and (= o8 (* l2 2)) (in_range1 (* l2 2))))
(assert (= o9 (ite (< o8 o7) o8 o7)))
