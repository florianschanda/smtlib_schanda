...
(assert (= c (add_signals (of_fixed 400) (of_fixed (- 800)))))
(declare-const o signal_type)
(declare-const o1 signal_type)
(assert (= (to_fixed o1) (- 800)))
(assert (= (to_fixed o) 400))
(assert (not (< 0 (+ (to_fixed o) (to_fixed o1)))))
(check-sat)
(exit)
