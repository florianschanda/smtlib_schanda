...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def 2 1 4 7 3 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def 2 1 4 7 3 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)) (= (mk___t2 temp___1382 temp___13821) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def 2 1 4 7 3 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (and (= (ite (<= (to_rep1 (first4 temp___13821)) (to_rep1 (last4 temp___13821))) (+ (- (to_rep1 (last4 temp___13821)) (to_rep1 (first4 temp___13821))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1382 (to_rep1 (first4 temp___13821)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume) (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (to_rep1 (first (rt source)))) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 9)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)) (= (mk___t4 temp___1390 temp___13901) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (and (= (ite (<= (to_rep1 (first8 temp___13901)) (to_rep1 (last8 temp___13901))) (+ (- (to_rep1 (last8 temp___13901)) (to_rep1 (first8 temp___13901))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1390 (to_rep1 (first8 temp___13901)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume) (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume1)))))) (and (and (dynamic_property6 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 9)))) (and (and (and (= temp___1397 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (= (mk_int__ref result2) (mk_int__ref index)) (= index2 (to_rep1 (first (rt source))))) (ite (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (and (and (and (= temp___1395 index2) (and (= temp___1393 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o17 index2)) (= o18 (select n1 o17))) (= o19 (to_rep1 o18))) (= o19 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o20 index2)) (= o21 (select (elts source) o20))) (= o22 (to_rep o21))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o22))) (ite (= (= o22 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o22 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o22 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o22 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o22 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o22 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o22 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o22 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o22 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o22 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o23) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o24 index2)) (= o25 (store n1 o24 o23)))) (and (= n1 result3) (= n2 o25))))) (and (and (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (forall ((temp___1394 Int)) (=> (and (<= (to_rep1 n__first) temp___1394) (<= temp___1394 (to_rep1 n__last))) (=> (< index3 temp___1394) (= (select n3 temp___1394) (select temp___1393 temp___1394))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9)))) (= index3 temp___1397)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1)))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (= temp___1398 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (<= (to_rep1 n__first) temp___1398) (<= temp___1398 (to_rep1 n__last))) (= o49 temp___1398))) (= o50 (select (map__content1 n7) o49))) (= o51 (to_rep1 o50))) (and (= result6 (mk_int__ref target)) (= target1 o51))) (and (<= target1 9) (and (and (and (and (and (and (and (and (and (and (= temp___1399 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (<= (to_rep1 n__first) temp___1399) (<= temp___1399 (to_rep1 n__last))) (= o52 temp___1399))) (= o53 (select (map__content1 n7) o52))) (= o54 (to_rep1 o53))) (= o55 (* o54 10))) (and (= o56 o55) (in_range1 o55))) (= o57 (+ target1 o56))) (and (= o58 o57) (in_range1 o57))) (and (= result7 (mk_int__ref target1)) (= target2 o58))) (and (<= target2 99) (and (and (and (and (and (and (and (and (and (and (= temp___1400 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))) (and (and (<= (to_rep1 n__first) temp___1400) (<= temp___1400 (to_rep1 n__last))) (= o59 temp___1400))) (= o60 (select (map__content1 n7) o59))) (= o61 (to_rep1 o60))) (= o62 (* o61 100))) (and (= o63 o62) (in_range1 o62))) (= o64 (+ target2 o63))) (and (= o65 o64) (in_range1 o64))) (and (= result8 (mk_int__ref target2)) (= target3 o65))) (and (<= target3 999) (and (and (and (and (and (and (and (and (and (and (= temp___1401 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))) (and (and (<= (to_rep1 n__first) temp___1401) (<= temp___1401 (to_rep1 n__last))) (= o66 temp___1401))) (= o67 (select (map__content1 n7) o66))) (= o68 (to_rep1 o67))) (= o69 (* o68 1000))) (and (= o70 o69) (in_range1 o69))) (= o71 (+ target3 o70))) (and (= o72 o71) (in_range1 o71))) (and (= result9 (mk_int__ref target3)) (= target4 o72))) (and (<= target4 9999) (and (and (and (and (and (and (and (and (and (and (= temp___1402 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (<= (to_rep1 n__first) temp___1402) (<= temp___1402 (to_rep1 n__last))) (= o73 temp___1402))) (= o74 (select (map__content1 n7) o73))) (= o75 (to_rep1 o74))) (= o76 (* o75 10000))) (and (= o77 o76) (in_range1 o76))) (= o78 (+ target4 o77))) (and (= o79 o78) (in_range1 o78))) (and (= result10 (mk_int__ref target4)) (= target5 o79))) (and (<= target5 99999) (and (and (and (and (and (and (and (and (and (and (= temp___1403 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (<= (to_rep1 n__first) temp___1403) (<= temp___1403 (to_rep1 n__last))) (= o80 temp___1403))) (= o81 (select (map__content1 n7) o80))) (= o82 (to_rep1 o81))) (= o83 (* o82 100000))) (and (= o84 o83) (in_range1 o83))) (= o85 (+ target5 o84))) (and (= o86 o85) (in_range1 o85))) (and (= result11 (mk_int__ref target5)) (= target6 o86))) (and (<= target6 399999) (and (and (and (= o87 (+ target6 2147000000)) (in_range1 (+ target6 2147000000))) (and (= result12 (mk_int__ref target6)) (= target7 o87))) (and (<= target7 2147399999) (and (= result13 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target8 (mk_int__ref target7)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target9 target7))))))))
