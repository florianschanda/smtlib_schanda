...
(assert (and (and (=> (<= 1 10) (in_range3 i2)) (forall ((temp___175 Int)) (=> (and (<= 1 temp___175) (<= temp___175 10)) (=> (< i2 temp___175) (= (select t2 temp___175) (select t temp___175)))))) (and (<= 1 i2) (<= i2 10))))
