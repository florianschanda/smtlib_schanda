...
(assert (= (= result10 true) (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 7)) (ite (and (<= 0 k2) (<= k2 (- right4 (* space3 2)))) (ite (= (mod2 (+ k2 1) (* 2 space3)) 0) (= (to_rep (select a3 k2)) (+ (to_rep (select a2 k2)) (to_rep (select a2 (- k2 space3))))) (ite (= (mod2 (+ k2 1) space3) 0) (= (to_rep (select a3 k2)) (to_rep (select a2 (+ k2 space3)))) (= (to_rep (select a3 k2)) (to_rep (select a2 k2))))) (= (to_rep (select a3 k2)) (to_rep (select a2 k2))))))))
