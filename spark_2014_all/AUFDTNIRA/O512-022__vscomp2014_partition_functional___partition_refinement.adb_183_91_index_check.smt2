...
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields5)) k4))
(assert (<= k4 (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields5))))
(assert (and (= o68 (length (mk___rep1 p__split_discrs p__split_fields4))) (and (in_range9 o68) (<= o68 (capacity (mk___rep1 p__split_discrs p__split_fields4))))))
(assert (= o69 (- o68 1)))
(assert (not (<= 0 k4)))
(check-sat)
(exit)
