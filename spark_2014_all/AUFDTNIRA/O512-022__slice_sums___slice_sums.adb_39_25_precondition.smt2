...
(assert (not (or (< (extended_indexqtint (rec__sums__slice_bounds__hi current_slice__split_fields1)) (indexqtint (rec__sums__slice_bounds__lo current_slice__split_fields1))) (and (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo current_slice__split_fields1))) (<= (extended_indexqtint (rec__sums__slice_bounds__hi current_slice__split_fields1)) (to_rep (last (rt x))))))))
(check-sat)
(exit)
