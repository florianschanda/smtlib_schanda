...
(assert (not (or (< (to_rep1 (rec__sums__slice_bounds__hi current_slice__split_fields1)) (to_rep (rec__sums__slice_bounds__lo current_slice__split_fields1))) (and (<= (to_rep3 (first (rt x))) (to_rep (rec__sums__slice_bounds__lo current_slice__split_fields1))) (<= (to_rep1 (rec__sums__slice_bounds__hi current_slice__split_fields1)) (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
