...
(assert (not (not (= (end_of_file (mk___rep (mk___split_fields current_in__split_fields current_in__split_fields1 current_in__split_fields2 current_in__split_fields3 current_in__split_fields4 current_in__split_fields5 current_in__split_fields6)) cur_position the_file) true))))
(check-sat)
(exit)
