...
(declare-const temp___1910 us_t1)
(declare-const o12 us_t1)
...
(assert (=> (= (select issystem (int__content retvalupd8)) true) (dynamic_property1 1 2147483647 1 12)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= temp___1908 (mk___t1 (temp___String_Literal_1907 Tuple0) (mk1 1 12)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (dynamic_predicate temp___1908)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= o9 temp___1908)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= o10 (convertretvaltotext (int__content retvalupd8) o9))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= o11 (mk___t o10 (mk 1 150)))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (and (in_range4 auditalarm5) (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true))))
...
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= auditsystemfault6 (mk_bool__ref auditsystemfault5))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= auditalarm6 (mk_int__ref auditalarm5))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= logfilestate__split_fields12 (mk___split_fields__ref1 logfilestate__split_fields11))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= logfilesstatus6 (mk_map__ref4 logfilesstatus5))))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= logfiles6 (mk_map__ref3 logfiles5))))
...
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= auditsystemfault7 auditsystemfault5)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= auditalarm7 auditalarm5)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= logfilestate__split_fields13 logfilestate__split_fields11)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= logfilesstatus7 logfilesstatus5)))
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= logfiles7 logfiles5)))
...
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= auditsystemfault6 auditsystemfault3)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= auditalarm6 auditalarm3)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= logfilestate__split_fields12 logfilestate__split_fields9)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= logfilesstatus6 logfilesstatus3)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= logfiles6 logfiles3)))
...
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= auditsystemfault7 auditsystemfault4)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= auditalarm7 auditalarm4)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= logfilestate__split_fields13 logfilestate__split_fields10)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= logfilesstatus7 logfilesstatus4)))
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= logfiles7 logfiles4)))
(assert (= (select issystem (int__content retvalfin5)) true))
(assert (dynamic_property1 1 2147483647 1 11))
(assert (= temp___1910 (mk___t1 (temp___String_Literal_1909 Tuple0) (mk1 1 11))))
(assert (dynamic_predicate temp___1910))
(assert (= o12 temp___1910))
(assert (= o13 (convertretvaltotext (int__content retvalfin5) o12)))
(assert (= o14 (mk___t o13 (mk 1 150))))
(assert (not (= (to_rep1 (first (rt o14))) 1)))
(check-sat)
(exit)
