...
(assert (dynamic_predicate temp___1736))
(assert (= o16 temp___1736))
(assert (= o17 (convertretvaltotext (int__content retvalfin5) o16)))
(assert (= o18 (mk___t o17 (mk 1 150))))
(assert (not (= (to_rep1 (first (rt o18))) 1)))
(check-sat)
(exit)
