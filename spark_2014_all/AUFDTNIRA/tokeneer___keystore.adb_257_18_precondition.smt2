...
(assert (=> (= (select issystem retvalini1) true) (in_range14 c32b)))
(assert (=> (= (select issystem retvalini1) true) (= result12 (mk_map__ref result__))))
(assert (=> (= (select issystem retvalini1) true) (= result__5 nodescription)))
(assert (=> (= (select issystem retvalini1) true) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b)))))) (= o10 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b)))))) 1)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b))))))) (= o10 0))))
(assert (=> (= (select issystem retvalini1) true) (=> (<= 1 37) (= o11 (+ (- 37 1) 1)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (<= 1 37)) (= o11 0))))
(assert (=> (= (select issystem retvalini1) true) (= o12 (+ o11 o10))))
(assert (=> (= (select issystem retvalini1) true) (= o13 (+ 1 o12))))
(assert (=> (= (select issystem retvalini1) true) (= o14 (- o13 1))))
(assert (=> (= (select issystem retvalini1) true) (and (= o15 o14) (in_range2 o14))))
(assert (=> (= (select issystem retvalini1) true) (= keystore__digest__B36b__thestring__assume (mk___t (concat1 (temp___String_Literal_1711 Tuple0) 1 37 (elts (to_string (attr__ATTRIBUTE_IMAGE14 c32b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c32b)))))) (mk 1 o15)))))
...
(assert (=> (= (select issystem retvalini1) true) (and (= o16 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= (select issystem retvalini1) true) (= result13 (ite (<= o16 150) true false))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result13 true) (= (ite (<= (to_rep1 (first (rt thestring))) (to_rep1 (last (rt thestring)))) (+ (- (to_rep1 (last (rt thestring))) (to_rep1 (first (rt thestring)))) 1) 0) (ite (<= 1 (length thestring)) (+ (- (length thestring) 1) 1) 0)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result13 true) (= temp___1705 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring)))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result13 true) (and (= temp___1707 (length thestring)) (in_range1 (length thestring))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result13 true) (=> (<= 1 temp___1707) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1707) (<= temp___1707 150)))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result13 true) (= o17 result__5))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result13 true) (= temp___1708 (mk___t1 o17 (mk1 1 temp___1707))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result13 true) (= (ite (<= (to_rep1 (first2 (rt1 temp___1705))) (to_rep1 (last2 (rt1 temp___1705)))) (+ (- (to_rep1 (last2 (rt1 temp___1705))) (to_rep1 (first2 (rt1 temp___1705)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1708))) (to_rep1 (last2 (rt1 temp___1708)))) (+ (- (to_rep1 (last2 (rt1 temp___1708))) (to_rep1 (first2 (rt1 temp___1708)))) 1) 0)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result13 true) (= temp___1709 temp___1705))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result13 true) (forall ((temp___1710 Int)) (ite (and (<= 1 temp___1710) (<= temp___1710 (length thestring))) (= (select o18 temp___1710) (select (elts1 temp___1709) temp___1710)) (= (select o18 temp___1710) (select result__5 temp___1710)))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result13 true) (= result14 (mk_map__ref result__5)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result13 true) (= result__6 o18))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result13 true) (= result__8 (mk_map__ref result__6)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result13 true) (= result__9 result__6))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result13 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring))) 1) (<= 1 (to_rep1 (last (rt thestring))))) (and (<= (to_rep1 (first (rt thestring))) 150) (<= 150 (to_rep1 (last (rt thestring))))))))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result13 true)) (= temp___1704 thestring))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result13 true)) (= o19 (elts temp___1704)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result13 true)) (= result15 (mk_map__ref result__5)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result13 true)) (= result__7 o19))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result13 true)) (= result__8 (mk_map__ref result__7)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result13 true)) (= result__9 result__7))))
(assert (=> (= (select issystem retvalini1) true) (= result16 (mk_map__ref c34b))))
...
(assert (=> (= (select issystem retvalini1) true) (= filestate3 (let ((subject filestate)) (mk___private__ref filestate2)))))
(assert (=> (= (select issystem retvalini1) true) (= state3 (let ((subject state)) (mk___private__ref state2)))))
...
(assert (=> (not (= (select issystem retvalini1) true)) (= filestate3 filestate)))
(assert (=> (not (= (select issystem retvalini1) true)) (= state3 state)))
(assert (=> (not (= (select issystem retvalini1) true)) (= result__10 (mk_map__ref result__))))
(assert (=> (not (= (select issystem retvalini1) true)) (= c34b3 (mk_map__ref c34b))))
...
(assert (= (select issystem (int__content retvalupd10)) true))
(assert (= (int__content retvalupd10) c44b))
(assert (in_range14 c44b))
(assert (= result17 result__1))
(assert (= (let ((subject result__1)) result__12) nodescription))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b)))))) (= o20 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b))))))) (= o20 0)))
(assert (=> (<= 1 39) (= o21 (+ (- 39 1) 1))))
(assert (=> (not (<= 1 39)) (= o21 0)))
(assert (= o22 (+ o21 o20)))
(assert (= o23 (+ 1 o22)))
(assert (= o24 (- o23 1)))
(assert (and (= o25 o24) (in_range2 o24)))
(assert (= keystore__digest__B48b__thestring__assume (mk___t (concat1 (temp___String_Literal_1724 Tuple0) 1 39 (elts (to_string (attr__ATTRIBUTE_IMAGE14 c44b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b)))))) (mk 1 o25))))
(assert (= keystore__digest__B48b__thestring__assume thestring1))
(assert (dynamic_invariant1 thestring1 true false true))
(assert (and (= o26 (length thestring1)) (in_range1 (length thestring1))))
(assert (= result18 (ite (<= o26 150) true false)))
(assert (=> (= result18 true) (= (ite (<= (to_rep1 (first (rt thestring1))) (to_rep1 (last (rt thestring1)))) (+ (- (to_rep1 (last (rt thestring1))) (to_rep1 (first (rt thestring1)))) 1) 0) (ite (<= 1 (length thestring1)) (+ (- (length thestring1) 1) 1) 0))))
(assert (=> (= result18 true) (= temp___1718 (mk___t2 (slide (elts thestring1) (to_rep1 (first (rt thestring1))) 1) (mk2 1 (length thestring1))))))
(assert (=> (= result18 true) (and (= temp___1720 (length thestring1)) (in_range1 (length thestring1)))))
(assert (=> (= result18 true) (=> (<= 1 temp___1720) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1720) (<= temp___1720 150))))))
(assert (=> (= result18 true) (= o27 (let ((subject result__1)) result__12))))
(assert (=> (= result18 true) (= temp___1721 (mk___t2 o27 (mk2 1 temp___1720)))))
(assert (=> (= result18 true) (= (ite (<= (to_rep1 (first4 (rt2 temp___1718))) (to_rep1 (last4 (rt2 temp___1718)))) (+ (- (to_rep1 (last4 (rt2 temp___1718))) (to_rep1 (first4 (rt2 temp___1718)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1721))) (to_rep1 (last4 (rt2 temp___1721)))) (+ (- (to_rep1 (last4 (rt2 temp___1721))) (to_rep1 (first4 (rt2 temp___1721)))) 1) 0))))
(assert (=> (= result18 true) (= temp___1722 temp___1718)))
(assert (=> (= result18 true) (forall ((temp___1723 Int)) (ite (and (<= 1 temp___1723) (<= temp___1723 (length thestring1))) (= (select o28 temp___1723) (select (elts2 temp___1722) temp___1723)) (= (select o28 temp___1723) (select (let ((subject result__1)) result__12) temp___1723))))))
(assert (=> (= result18 true) (= result19 (let ((subject result__1)) (mk_map__ref result__12)))))
(assert (=> (= result18 true) (= (let ((subject result__1)) result__13) o28)))
(assert (=> (= result18 true) (= result__15 (let ((subject result__1)) (mk_map__ref result__13)))))
(assert (=> (= result18 true) (= result__16 result__13)))
(assert (=> (not (= result18 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring1))) 1) (<= 1 (to_rep1 (last (rt thestring1))))) (and (<= (to_rep1 (first (rt thestring1))) 150) (<= 150 (to_rep1 (last (rt thestring1)))))))))
(assert (=> (not (= result18 true)) (= temp___1717 thestring1)))
(assert (=> (not (= result18 true)) (= o29 (elts temp___1717))))
(assert (=> (not (= result18 true)) (= result20 (let ((subject result__1)) (mk_map__ref result__12)))))
(assert (=> (not (= result18 true)) (= (let ((subject result__1)) result__14) o29)))
(assert (=> (not (= result18 true)) (= result__15 (let ((subject result__1)) (mk_map__ref result__14)))))
(assert (=> (not (= result18 true)) (= result__16 result__14)))
(assert (= result21 c46b))
(assert (= (let ((subject c46b)) c46b2) (map__content result__15)))
