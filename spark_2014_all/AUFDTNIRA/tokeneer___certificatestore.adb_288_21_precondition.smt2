...
(define-fun dynamic_invariant ((temp___expr_271 us_t1) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (and (=> (not (= temp___skip_constant_269 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_271) (last3 temp___expr_271))) (=> (= temp___do_toplevel_270 true) (=> (= temp___is_init_268 true) (= (first3 temp___expr_271) 1)))))
(define-fun dynamic_predicate ((temp___274 us_t1)) Bool (= (first3 temp___274) 1))
...
(define-fun dynamic_invariant1 ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 1)) (in_range4 temp___expr_385)))
...
(declare-fun temp___1051 (Int) (Array Int logfileindext))
(assert (forall ((temp___1053 Int)) (forall ((temp___1054 Int)) (= (select (temp___1051 temp___1053) temp___1054) (of_rep2 temp___1053)))))
(declare-fun temp___1055 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1057 Int)) (forall ((temp___1058 Int)) (= (select (temp___1055 temp___1057) temp___1058) (of_rep5 temp___1057)))))
(define-fun dynamic_invariant2 ((temp___expr_1045 us_rep2) (temp___is_init_1042 Bool) (temp___skip_constant_1043 Bool) (temp___do_toplevel_1044 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1045))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1045))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1045)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1045))) true))
(define-fun default_initial_assumption ((temp___expr_1049 us_rep2) (temp___skip_top_level_1050 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1049))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1049))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1049)) (mk___rep (mk___split_fields (temp___1051 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1049)) (temp___1055 0))))
(define-fun type_invariant ((temp___1059 us_rep2)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1059))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1059))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1059)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1059))) true))
...
(define-fun dynamic_invariant3 ((temp___expr_1269 Int) (temp___is_init_1266 Bool) (temp___skip_constant_1267 Bool) (temp___do_toplevel_1268 Bool)) Bool (=> (or (= temp___is_init_1266 true) (<= 0 4294967295)) (in_range10 temp___expr_1269)))
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-fun temp___String_Literal_1419 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1419 us_void_param) 1)) 46) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 2)) 47)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 3)) 83)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 4)) 121)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 5)) 115)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 8)) 109)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 9)) 47)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 10)) 99)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 14)) 46)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 15)) 100)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 16)) 97)) (= (to_rep (select (temp___String_Literal_1419 us_void_param) 17)) 116)) :pattern ((temp___String_Literal_1419 us_void_param)))))
(declare-fun temp___String_Literal_1421 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1421 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 13)) 83)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 15)) 111)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 19)) 114)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 20)) 101)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 21)) 97)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 22)) 100)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 25)) 114)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 27)) 111)) (= (to_rep (select (temp___String_Literal_1421 us_void_param) 28)) 114)) :pattern ((temp___String_Literal_1421 us_void_param)))))
...
(define-fun dynamic_invariant8 ((temp___expr_1011 Int) (temp___is_init_1008 Bool) (temp___skip_constant_1009 Bool) (temp___do_toplevel_1010 Bool)) Bool (=> (or (= temp___is_init_1008 true) (<= 0 17)) (in_range7 temp___expr_1011)))
(define-fun dynamic_invariant9 ((temp___expr_990 Int) (temp___is_init_987 Bool) (temp___skip_constant_988 Bool) (temp___do_toplevel_989 Bool)) Bool (=> (or (= temp___is_init_987 true) (<= 1 17)) (in_range5 temp___expr_990)))
(define-fun dynamic_invariant10 ((temp___expr_1115 Int) (temp___is_init_1112 Bool) (temp___skip_constant_1113 Bool) (temp___do_toplevel_1114 Bool)) Bool (=> (or (= temp___is_init_1112 true) (<= 0 2)) (in_range9 temp___expr_1115)))
(define-fun dynamic_invariant11 ((temp___expr_996 Int) (temp___is_init_993 Bool) (temp___skip_constant_994 Bool) (temp___do_toplevel_995 Bool)) Bool (=> (or (= temp___is_init_993 true) (<= 0 17408)) (in_range6 temp___expr_996)))
(define-fun dynamic_invariant12 ((temp___expr_1030 Int) (temp___is_init_1027 Bool) (temp___skip_constant_1028 Bool) (temp___do_toplevel_1029 Bool)) Bool (=> (or (= temp___is_init_1027 true) (<= 0 1024)) (in_range8 temp___expr_1030)))
(assert true)
...
(declare-const temp___1420 (Array Int character))
(declare-const temp___14201 t1)
...
(assert (= (temp___String_Literal_1419 Tuple0) temp___1420))
(assert (= (mk1 1 17) temp___14201))
(assert (= (to_rep1 (first2 temp___14201)) 1))
(assert (= o temp___1420))
(assert (= o1 temp___14201))
