...
(assert (and (= temp___1880 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1880) (<= temp___1880 (to_rep1 (last (rt source))))))
(assert (= o15 temp___1880))
(assert (= o16 (select (elts source) o15)))
(assert (= o17 (to_rep o16)))
(assert (and (= o18 (convert_character_digit_to_integer o17)) (and (in_range1 o18) (and (and (<= 0 o18) (<= o18 9)) (ite (= (= o17 48) true) (= o18 0) (ite (= (= o17 49) true) (= o18 1) (ite (= (= o17 50) true) (= o18 2) (ite (= (= o17 51) true) (= o18 3) (ite (= (= o17 52) true) (= o18 4) (ite (= (= o17 53) true) (= o18 5) (ite (= (= o17 54) true) (= o18 6) (ite (= (= o17 55) true) (= o18 7) (ite (= (= o17 56) true) (= o18 8) (=> (= (= o17 57) true) (= o18 9)))))))))))))))
(assert (= o19 (* o18 1)))
(assert (and (= o20 o19) (in_range1 o19)))
(assert (and (= temp___1879 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1879) (<= temp___1879 (to_rep1 (last (rt source))))))
(assert (= o9 temp___1879))
...
(assert (and (= temp___1878 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1878) (<= temp___1878 (to_rep1 (last (rt source))))))
(assert (= o3 temp___1878))
(assert (= o4 (select (elts source) o3)))
(assert (= o5 (to_rep o4)))
(assert (and (= o6 (convert_character_digit_to_integer o5)) (and (in_range1 o6) (and (and (<= 0 o6) (<= o6 9)) (ite (= (= o5 48) true) (= o6 0) (ite (= (= o5 49) true) (= o6 1) (ite (= (= o5 50) true) (= o6 2) (ite (= (= o5 51) true) (= o6 3) (ite (= (= o5 52) true) (= o6 4) (ite (= (= o5 53) true) (= o6 5) (ite (= (= o5 54) true) (= o6 6) (ite (= (= o5 55) true) (= o6 7) (ite (= (= o5 56) true) (= o6 8) (=> (= (= o5 57) true) (= o6 9)))))))))))))))
(assert (= o7 (* o6 100)))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (and (= temp___1877 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1877) (<= temp___1877 (to_rep1 (last (rt source))))))
(assert (= o temp___1877))
(assert (= o1 (select (elts source) o)))
(assert (= o2 (to_rep o1)))
(assert (not (= (is_digit o2) true)))
(check-sat)
(exit)
