...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def 2 1 4 7 4 8 3 5 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def 2 1 4 7 4 8 3 5 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)) (= (mk___t2 temp___1256 temp___12561) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def 2 1 4 7 4 8 3 5 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (and (= (ite (<= (to_rep1 (first4 temp___12561)) (to_rep1 (last4 temp___12561))) (+ (- (to_rep1 (last4 temp___12561)) (to_rep1 (first4 temp___12561))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1256 (to_rep1 (first4 temp___12561)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume) (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (to_rep1 (first (rt source)))) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 9)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)) (= (mk___t4 temp___1264 temp___12641) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (and (= (ite (<= (to_rep1 (first8 temp___12641)) (to_rep1 (last8 temp___12641))) (+ (- (to_rep1 (last8 temp___12641)) (to_rep1 (first8 temp___12641))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1264 (to_rep1 (first8 temp___12641)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume) (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume1)))))) (and (and (dynamic_property6 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 9)))) (and (and (and (= temp___1271 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (= (mk_int__ref result2) (mk_int__ref index)) (= index2 (to_rep1 (first (rt source))))) (ite (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (and (and (and (= temp___1269 index2) (and (= temp___1267 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o29 index2)) (= o30 (select n1 o29))) (= o31 (to_rep1 o30))) (= o31 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o32 index2)) (= o33 (select (elts source) o32))) (= o34 (to_rep o33))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o34))) (ite (= (= o34 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o34 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o34 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o34 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o34 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o34 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o34 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o34 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o34 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o34 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o35) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o36 index2)) (= o37 (store n1 o36 o35)))) (and (= n1 result3) (= n2 o37))))) (and (and (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (forall ((temp___1268 Int)) (=> (and (<= (to_rep1 n__first) temp___1268) (<= temp___1268 (to_rep1 n__last))) (=> (< index3 temp___1268) (= (select n3 temp___1268) (select temp___1267 temp___1268))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9)))) (= index3 temp___1271)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1)))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (= temp___1272 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (<= (to_rep1 n__first) temp___1272) (<= temp___1272 (to_rep1 n__last))) (= o61 temp___1272))) (= o62 (select (map__content1 n7) o61))) (= o63 (to_rep1 o62))) (and (= result6 (mk_int__ref target)) (= target1 o63))) (and (<= target1 9) (and (and (and (and (and (and (and (and (and (and (= temp___1273 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (<= (to_rep1 n__first) temp___1273) (<= temp___1273 (to_rep1 n__last))) (= o64 temp___1273))) (= o65 (select (map__content1 n7) o64))) (= o66 (to_rep1 o65))) (= o67 (* o66 10))) (and (= o68 o67) (in_range1 o67))) (= o69 (+ target1 o68))) (and (= o70 o69) (in_range1 o69))) (and (= result7 (mk_int__ref target1)) (= target2 o70))) (and (<= target2 99) (and (and (and (and (and (and (and (and (and (and (= temp___1274 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))) (and (and (<= (to_rep1 n__first) temp___1274) (<= temp___1274 (to_rep1 n__last))) (= o71 temp___1274))) (= o72 (select (map__content1 n7) o71))) (= o73 (to_rep1 o72))) (= o74 (* o73 100))) (and (= o75 o74) (in_range1 o74))) (= o76 (+ target2 o75))) (and (= o77 o76) (in_range1 o76))) (and (= result8 (mk_int__ref target2)) (= target3 o77))) (and (<= target3 599) (and (and (and (= o78 (+ target3 2147483000)) (in_range1 (+ target3 2147483000))) (and (= result9 (mk_int__ref target3)) (= target4 o78))) (and (<= target4 2147483599) (and (= result10 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target5 (mk_int__ref target4)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target6 target4))))))))
(assert (= (bool__content has_failed2) true))
(assert (not false))
(check-sat)
(exit)
