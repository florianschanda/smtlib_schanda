...
(assert (forall ((temp___1344 Int) (temp___1345 Int) (temp___1346 Int) (temp___1347 Int) (temp___1348 Int) (temp___1349 Int) (temp___1350 Int) (temp___1351 Int) (temp___1352 Int) (temp___1353 Int) (temp___1354 Int) (temp___1355 Int)) (let ((temp___1343 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def temp___1344 temp___1345 temp___1346 temp___1347 temp___1348 temp___1349 temp___1350 temp___1351 temp___1352 temp___1353 temp___1354 temp___1355))) (=> (and (and (and (and (and (and (and (and (and (dynamic_invariant temp___1344 true true true true) (dynamic_invariant temp___1345 true true true true)) (dynamic_invariant temp___1346 true true true true)) (dynamic_invariant temp___1347 true true true true)) (dynamic_invariant temp___1348 true true true true)) (dynamic_invariant temp___1349 true true true true)) (dynamic_invariant temp___1350 true true true true)) (dynamic_invariant temp___1351 true true true true)) (dynamic_invariant temp___1352 true true true true)) (dynamic_invariant temp___1353 true true true true)) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1354 temp___1355) (and (= (first5 temp___1343) temp___1354) (= (last5 temp___1343) temp___1355))) (and (and (and (and (and (and (and (and (and (= (to_rep1 (select (to_array2 temp___1343) (+ (first1 source) 0))) temp___1344) (= (to_rep1 (select (to_array2 temp___1343) (+ (first1 source) 1))) temp___1345)) (= (to_rep1 (select (to_array2 temp___1343) (+ (first1 source) 2))) temp___1346)) (= (to_rep1 (select (to_array2 temp___1343) (+ (first1 source) 3))) temp___1347)) (= (to_rep1 (select (to_array2 temp___1343) (+ (first1 source) 4))) temp___1348)) (= (to_rep1 (select (to_array2 temp___1343) (+ (first1 source) 5))) temp___1349)) (= (to_rep1 (select (to_array2 temp___1343) (+ (first1 source) 6))) temp___1350)) (= (to_rep1 (select (to_array2 temp___1343) (+ (first1 source) 7))) temp___1351)) (= (to_rep1 (select (to_array2 temp___1343) (+ (first1 source) 8))) temp___1352)) (= (to_rep1 (select (to_array2 temp___1343) (+ (first1 source) 9))) temp___1353)))))))
(define-fun dynamic_invariant4 ((temp___expr_234 us_t3) (temp___is_init_230 Bool) (temp___skip_constant_231 Bool) (temp___do_toplevel_232 Bool) (temp___do_typ_inv_233 Bool)) Bool (=> (not (= temp___skip_constant_231 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_234) (last7 temp___expr_234)) (and (= (first7 temp___expr_234) (first1 source)) (= (last7 temp___expr_234) (+ (first1 source) 9))))))
(declare-sort t6 0)
...
(assert (forall ((temp___1361 Int) (temp___1362 Int) (temp___1363 Int)) (let ((temp___1360 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def temp___1361 temp___1362 temp___1363))) (=> (dynamic_invariant temp___1361 true true true true) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1362 temp___1363) (and (= (first9 temp___1360) temp___1362) (= (last9 temp___1360) temp___1363))) (forall ((temp___1364 Int)) (= (to_rep1 (select (to_array4 temp___1360) temp___1364)) temp___1361)))))))
...
(declare-const temp___1358 (Array Int integer))
(declare-const temp___13581 t2)
...
(declare-const temp___1366 (Array Int integer))
(declare-const temp___13661 t4)
...
(declare-const temp___1373 Int)
(declare-const temp___1371 Int)
(declare-const temp___1369 (Array Int integer))
(declare-const o Int)
...
(assert (and (and (= (length source) 10) (and (and (and (and (and (and (and (<= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 51)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 54))) (forall ((index9 Int)) (=> (and (<= (to_rep1 (first (rt source))) index9) (<= index9 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index9))) true)))))
...
(assert (= (mk___t2 temp___1358 temp___13581) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def 2 1 4 7 4 8 3 5 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___13581)) (to_rep1 (last4 temp___13581))) (+ (- (to_rep1 (last4 temp___13581)) (to_rep1 (first4 temp___13581))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1358 (to_rep1 (first4 temp___13581)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume))
...
(assert (= (mk___t4 temp___1366 temp___13661) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___13661)) (to_rep1 (last8 temp___13661))) (+ (- (to_rep1 (last8 temp___13661)) (to_rep1 (first8 temp___13661))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1366 (to_rep1 (first8 temp___13661)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume))
...
(assert (and (= temp___1373 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= temp___1371 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= temp___1369 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= o index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= o1 (select n1 o))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= o3 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= o7 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= n2 o8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt source))) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (and (and (forall ((temp___1370 Int)) (=> (and (<= (to_rep1 n__first) temp___1370) (<= temp___1370 (to_rep1 n__last))) (=> (< index2 temp___1370) (= (select n3 temp___1370) (select temp___1369 temp___1370))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= index2 temp___1373)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= index2 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= n3 n4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= index4 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= n5 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= index6 index4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373)) (= n7 n5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1373))) (= n7 n1)))
...
(assert (and (= temp___1374 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1374) (<= temp___1374 (to_rep1 n__last))))
(assert (= o9 temp___1374))
(assert (= o10 (select (map__content1 n6) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= result4 (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 9))
(assert (and (= temp___1375 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1375) (<= temp___1375 (to_rep1 n__last))))
(assert (= o12 temp___1375))
...
(assert (= target2 o18))
(assert (<= target2 99))
(assert (and (= temp___1376 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1376) (<= temp___1376 (to_rep1 n__last))))
(assert (= o19 temp___1376))
...
(assert (= target3 o25))
(assert (<= target3 599))
(assert (and (= o26 (+ target3 2147483000)) (in_range1 (+ target3 2147483000))))
(assert (= result7 (mk_int__ref target3)))
(assert (= target4 o26))
(assert (<= target4 2147483599))
(assert (= result8 (mk_bool__ref has_failed)))
