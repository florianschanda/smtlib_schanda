...
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= auditsystemfault7 auditsystemfault15)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= logfilestate__split_fields17 logfilestate__split_fields25)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= logfilesstatus8 logfilesstatus16)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= logfiles7 logfiles15)))
...
(assert (and (and (<= 1 (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields22))))) (= (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields22)) (+ (* (- (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields22)))) 1) 1024) (to_rep5 (select (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields22) (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields22))))))) (and (in_range5 auditalarm6) (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields22)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields22)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields22) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields22)) true))))
...
(assert (= logfilestate__split_fields23 (mk___split_fields__ref1 logfilestate__split_fields22)))
...
(assert (= logfilestate__split_fields24 logfilestate__split_fields22))
(assert (= logfilesstatus15 logfilesstatus13))
(assert (= logfiles14 logfiles12))
(assert (and (= o25 (- (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields23))))) 1)) (in_range9 (- (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields23))))) 1))))
(assert (= o26 (* o25 1024)))
(assert (not (in_range8 o26)))
(check-sat)
(exit)
