...
(assert (and (and (<= 1 (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields24))))) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields24)) (+ (* (- (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields24)))) 1) 1024) (to_rep5 (select (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields24) (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields24))))))) (and (in_range5 auditalarm6) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields24)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields24)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields24) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields24)) true))))
(assert (= oldalarm2 (mk_int__ref oldalarm1)))
(assert (= auditsystemfault16 (mk_bool__ref auditsystemfault15)))
(assert (= auditalarm7 (mk_int__ref auditalarm6)))
(assert (= logfilestate__split_fields25 (mk___split_fields__ref1 logfilestate__split_fields24)))
(assert (= logfilesstatus16 (mk_map__ref4 logfilesstatus15)))
(assert (= logfiles16 (mk_map__ref3 logfiles15)))
(assert (= oldalarm3 oldalarm1))
(assert (= auditsystemfault17 auditsystemfault15))
(assert (= auditalarm8 auditalarm6))
(assert (= logfilestate__split_fields26 logfilestate__split_fields24))
(assert (= logfilesstatus17 logfilesstatus15))
(assert (= logfiles17 logfiles15))
(assert (and (= o30 (- (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields25))))) 1)) (in_range8 (- (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields25))))) 1))))
(assert (= o31 (* o30 1024)))
(assert (not (in_range7 o31)))
(check-sat)
(exit)
