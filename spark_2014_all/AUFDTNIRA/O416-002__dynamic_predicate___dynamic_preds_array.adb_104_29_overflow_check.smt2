...
(assert (forall ((us_void_param tuple0)) (! (let ((result (get_constant_even_pair us_void_param))) (and (and (= (to_rep (select result 1)) 0) (= (to_rep (select result 2)) 0)) (dynamic_invariant1 result true false true true))) :pattern ((get_constant_even_pair us_void_param)))))
(declare-const above Int)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant3 ((temp___expr_160 Int) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool (and (=> (or (= temp___is_init_156 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_160)) (=> (= temp___do_toplevel_158 true) (=> (= temp___is_init_156 true) (= (mod2 temp___expr_160 2) 0)))))
...
(assert (and (= o (get_constant_even_pair Tuple0)) (and (dynamic_invariant1 o true false true true) (and (= (to_rep (select o 1)) 0) (= (to_rep (select o 2)) 0)))))
(assert (= result result__))
(assert (= result__1 o))
(assert (dynamic_invariant1 result__1 true false true true))
