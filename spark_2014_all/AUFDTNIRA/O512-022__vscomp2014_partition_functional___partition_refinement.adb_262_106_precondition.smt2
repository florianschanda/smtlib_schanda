...
(assert (and (= o76 (length1 (mk___rep5 p__split_discrs p__split_fields3))) (and (in_range11 o76) (<= o76 (capacity (mk___rep5 p__split_discrs p__split_fields3))))))
(assert (= o77 (- o76 1)))
(assert (= o78 (ite (<= j4 o77) true false)))
(assert (= result17 (ite (<= 0 j4) o78 false)))
(assert (= result17 true))
(assert (and (= o84 j4) (in_range10 j4)))
(assert (and (= o85 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) o84)) (= (bool_eq10 o85 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) o84)) true)))
(assert (= o86 (us_split_fields9 o85)))
(assert (= o87 (rec__partition_refinement__interval__last o86)))
(assert (= o88 (to_rep2 o87)))
(assert (= o89 (ite (<= k1 o88) true false)))
(assert (and (= o79 j4) (in_range10 j4)))
(assert (not (<= 0 o79)))
(check-sat)
(exit)
