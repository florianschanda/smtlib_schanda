...
(declare-const o7 us_split_fields8)
...
(assert (= result2 true))
(assert (and (= o5 j) (in_range10 j)))
(assert (and (= o6 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) o5)) (= (bool_eq10 o6 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) o5)) true)))
(assert (= o7 (us_split_fields9 o6)))
(assert (= o8 (rec__partition_refinement__interval__last o7)))
(assert (= o9 (to_rep2 o8)))
