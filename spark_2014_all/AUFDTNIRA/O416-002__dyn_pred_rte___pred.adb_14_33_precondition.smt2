...
(define-fun dynamic_invariant1 ((temp___expr_169 us_t) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool) (temp___do_typ_inv_168 Bool)) Bool (and (=> (not (= temp___skip_constant_166 true)) (dynamic_property 1 2147483647 (first1 temp___expr_169) (last1 temp___expr_169))) (=> (= temp___do_toplevel_167 true) (=> (= temp___is_init_165 true) (forall ((x Int)) (=> (and (<= (first1 temp___expr_169) x) (<= x (last1 temp___expr_169))) (= (prop__ x) true)))))))
(define-fun dynamic_predicate ((temp___172 us_t)) Bool (forall ((x Int)) (=> (and (<= (first1 temp___172) x) (<= x (last1 temp___172))) (= (prop__ x) true))))
...
(declare-const x Int)
(assert (dynamic_invariant1 i7b true false false true))
