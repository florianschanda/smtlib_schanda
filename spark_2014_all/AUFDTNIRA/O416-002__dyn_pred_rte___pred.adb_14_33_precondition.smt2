...
(define-fun dynamic_invariant1 ((temp___expr_145 us_t) (temp___is_init_142 Bool) (temp___skip_constant_143 Bool) (temp___do_toplevel_144 Bool)) Bool (and (=> (not (= temp___skip_constant_143 true)) (dynamic_property 1 2147483647 (first1 temp___expr_145) (last1 temp___expr_145))) (=> (= temp___do_toplevel_144 true) (=> (= temp___is_init_142 true) (forall ((x Int)) (=> (and (<= (first1 temp___expr_145) x) (<= x (last1 temp___expr_145))) (= (prop__ x) true)))))))
(define-fun dynamic_predicate ((temp___148 us_t)) Bool (forall ((x Int)) (=> (and (<= (first1 temp___148) x) (<= x (last1 temp___148))) (= (prop__ x) true))))
