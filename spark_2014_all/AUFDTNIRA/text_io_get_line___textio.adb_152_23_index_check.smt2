...
(assert (and (= o3 (end_of_file (mk___rep (mk___split_fields file__split_fields file__split_fields1 file__split_fields2 file__split_fields3 file__split_fields4 file__split_fields5 file__split_fields6)) cur_position the_file)) (= (= o3 true) (= (fpeek (mk___rep (mk___split_fields file__split_fields file__split_fields1 file__split_fields2 file__split_fields3 file__split_fields4 file__split_fields5 file__split_fields6)) cur_position the_file) eof))))
(assert (= result (ite (not (= o3 true)) true false)))
(assert (= result true))
(assert (= (to_rep1 result____first) 1))
(assert (= (to_rep1 result____last) 2147483647))
(assert (= cur_position (+ (- (+ cur_position_at_start (to_rep1 (last (rt s)))) (to_rep1 (first (rt s)))) 1)))
(assert (<= (to_rep1 (first (rt s))) idx))
(assert (<= idx (to_rep1 (last (rt s)))))
(assert (and (<= 1 (+ (- idx (to_rep1 (first (rt s)))) cur_position_at_start)) (<= (+ (- idx (to_rep1 (first (rt s)))) cur_position_at_start) 2147483647)))
(assert (= o (+ (- idx (to_rep1 (first (rt s)))) cur_position_at_start)))
