...
(assert (and (= temp___1903 (durationt_image (div1 thefingerwaitduration 10))) (and (dynamic_invariant1 temp___1903 true false true) (= temp___1903 (let ((temp___455 (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thefingerwaitduration 10))))) (mk___t2 (elts temp___455) (mk2 (to_rep1 (first (rt temp___455))) (to_rep1 (last (rt temp___455))))))))))
(assert (and (= temp___1898 (durationt_image (div1 thetokenremovalduration 10))) (and (dynamic_invariant1 temp___1898 true false true) (= temp___1898 (let ((temp___455 (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thetokenremovalduration 10))))) (mk___t2 (elts temp___455) (mk2 (to_rep1 (first (rt temp___455))) (to_rep1 (last (rt temp___455))))))))))
(assert (and (= temp___1893 (durationt_image (div1 thelatchunlockduration 10))) (and (dynamic_invariant1 temp___1893 true false true) (= temp___1893 (let ((temp___455 (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thelatchunlockduration 10))))) (mk___t2 (elts temp___455) (mk2 (to_rep1 (first (rt temp___455))) (to_rep1 (last (rt temp___455))))))))))
(assert (and (= temp___1890 (durationt_image (div1 thealarmsilentduration 10))) (and (dynamic_invariant1 temp___1890 true false true) (= temp___1890 (let ((temp___455 (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thealarmsilentduration 10))))) (mk___t2 (elts temp___455) (mk2 (to_rep1 (first (rt temp___455))) (to_rep1 (last (rt temp___455))))))))))
(assert (=> (= (length2 temp___1890) 0) (= temp___1892 (mk___t (temp___String_Literal_1889 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length2 temp___1890) 0)) (=> (<= 1 2) (= o (+ (- 2 1) 1)))))
(assert (=> (not (= (length2 temp___1890) 0)) (=> (not (<= 1 2)) (= o 0))))
(assert (=> (not (= (length2 temp___1890) 0)) (=> (<= (to_rep1 (first4 (rt2 temp___1890))) (to_rep1 (last4 (rt2 temp___1890)))) (= o1 (+ (- (to_rep1 (last4 (rt2 temp___1890))) (to_rep1 (first4 (rt2 temp___1890)))) 1)))))
(assert (=> (not (= (length2 temp___1890) 0)) (=> (not (<= (to_rep1 (first4 (rt2 temp___1890))) (to_rep1 (last4 (rt2 temp___1890))))) (= o1 0))))
(assert (=> (not (= (length2 temp___1890) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length2 temp___1890) 0)) (= o3 (+ (to_rep1 (first4 (rt2 temp___1890))) o2))))
(assert (=> (not (= (length2 temp___1890) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length2 temp___1890) 0)) (and (= o5 o4) (in_range1 o4))))
(assert (=> (not (= (length2 temp___1890) 0)) (= temp___1892 (mk___t (concat1 (elts2 temp___1890) (to_rep1 (first4 (rt2 temp___1890))) (to_rep1 (last4 (rt2 temp___1890))) (temp___String_Literal_1889 Tuple0) 1 2) (mk (to_rep1 (first4 (rt2 temp___1890))) o5)))))
(assert (=> (= (length temp___1892) 0) (= temp___1895 (mk___t (elts2 temp___1893) (mk (to_rep1 (first4 (rt2 temp___1893))) (to_rep1 (last4 (rt2 temp___1893))))))))
(assert (=> (not (= (length temp___1892) 0)) (=> (<= (to_rep1 (first4 (rt2 temp___1893))) (to_rep1 (last4 (rt2 temp___1893)))) (= o6 (+ (- (to_rep1 (last4 (rt2 temp___1893))) (to_rep1 (first4 (rt2 temp___1893)))) 1)))))
(assert (=> (not (= (length temp___1892) 0)) (=> (not (<= (to_rep1 (first4 (rt2 temp___1893))) (to_rep1 (last4 (rt2 temp___1893))))) (= o6 0))))
(assert (=> (not (= (length temp___1892) 0)) (=> (<= (to_rep1 (first (rt temp___1892))) (to_rep1 (last (rt temp___1892)))) (= o7 (+ (- (to_rep1 (last (rt temp___1892))) (to_rep1 (first (rt temp___1892)))) 1)))))
(assert (=> (not (= (length temp___1892) 0)) (=> (not (<= (to_rep1 (first (rt temp___1892))) (to_rep1 (last (rt temp___1892))))) (= o7 0))))
(assert (=> (not (= (length temp___1892) 0)) (= o8 (+ o7 o6))))
(assert (=> (not (= (length temp___1892) 0)) (= o9 (+ (to_rep1 (first (rt temp___1892))) o8))))
(assert (=> (not (= (length temp___1892) 0)) (= o10 (- o9 1))))
(assert (=> (not (= (length temp___1892) 0)) (and (= o11 o10) (in_range1 o10))))
(assert (=> (not (= (length temp___1892) 0)) (= temp___1895 (mk___t (concat1 (elts temp___1892) (to_rep1 (first (rt temp___1892))) (to_rep1 (last (rt temp___1892))) (elts2 temp___1893) (to_rep1 (first4 (rt2 temp___1893))) (to_rep1 (last4 (rt2 temp___1893)))) (mk (to_rep1 (first (rt temp___1892))) o11)))))
(assert (=> (= (length temp___1895) 0) (= temp___1897 (mk___t (temp___String_Literal_1894 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length temp___1895) 0)) (=> (<= 1 2) (= o12 (+ (- 2 1) 1)))))
(assert (=> (not (= (length temp___1895) 0)) (=> (not (<= 1 2)) (= o12 0))))
(assert (=> (not (= (length temp___1895) 0)) (=> (<= (to_rep1 (first (rt temp___1895))) (to_rep1 (last (rt temp___1895)))) (= o13 (+ (- (to_rep1 (last (rt temp___1895))) (to_rep1 (first (rt temp___1895)))) 1)))))
(assert (=> (not (= (length temp___1895) 0)) (=> (not (<= (to_rep1 (first (rt temp___1895))) (to_rep1 (last (rt temp___1895))))) (= o13 0))))
(assert (=> (not (= (length temp___1895) 0)) (= o14 (+ o13 o12))))
(assert (=> (not (= (length temp___1895) 0)) (= o15 (+ (to_rep1 (first (rt temp___1895))) o14))))
(assert (=> (not (= (length temp___1895) 0)) (= o16 (- o15 1))))
(assert (=> (not (= (length temp___1895) 0)) (and (= o17 o16) (in_range1 o16))))
(assert (=> (not (= (length temp___1895) 0)) (= temp___1897 (mk___t (concat1 (elts temp___1895) (to_rep1 (first (rt temp___1895))) (to_rep1 (last (rt temp___1895))) (temp___String_Literal_1894 Tuple0) 1 2) (mk (to_rep1 (first (rt temp___1895))) o17)))))
(assert (=> (= (length temp___1897) 0) (= temp___1900 (mk___t (elts2 temp___1898) (mk (to_rep1 (first4 (rt2 temp___1898))) (to_rep1 (last4 (rt2 temp___1898))))))))
(assert (=> (not (= (length temp___1897) 0)) (=> (<= (to_rep1 (first4 (rt2 temp___1898))) (to_rep1 (last4 (rt2 temp___1898)))) (= o18 (+ (- (to_rep1 (last4 (rt2 temp___1898))) (to_rep1 (first4 (rt2 temp___1898)))) 1)))))
(assert (=> (not (= (length temp___1897) 0)) (=> (not (<= (to_rep1 (first4 (rt2 temp___1898))) (to_rep1 (last4 (rt2 temp___1898))))) (= o18 0))))
(assert (=> (not (= (length temp___1897) 0)) (=> (<= (to_rep1 (first (rt temp___1897))) (to_rep1 (last (rt temp___1897)))) (= o19 (+ (- (to_rep1 (last (rt temp___1897))) (to_rep1 (first (rt temp___1897)))) 1)))))
(assert (=> (not (= (length temp___1897) 0)) (=> (not (<= (to_rep1 (first (rt temp___1897))) (to_rep1 (last (rt temp___1897))))) (= o19 0))))
(assert (=> (not (= (length temp___1897) 0)) (= o20 (+ o19 o18))))
(assert (=> (not (= (length temp___1897) 0)) (= o21 (+ (to_rep1 (first (rt temp___1897))) o20))))
(assert (=> (not (= (length temp___1897) 0)) (= o22 (- o21 1))))
(assert (=> (not (= (length temp___1897) 0)) (and (= o23 o22) (in_range1 o22))))
(assert (=> (not (= (length temp___1897) 0)) (= temp___1900 (mk___t (concat1 (elts temp___1897) (to_rep1 (first (rt temp___1897))) (to_rep1 (last (rt temp___1897))) (elts2 temp___1898) (to_rep1 (first4 (rt2 temp___1898))) (to_rep1 (last4 (rt2 temp___1898)))) (mk (to_rep1 (first (rt temp___1897))) o23)))))
(assert (=> (= (length temp___1900) 0) (= temp___1902 (mk___t (temp___String_Literal_1899 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length temp___1900) 0)) (=> (<= 1 2) (= o24 (+ (- 2 1) 1)))))
(assert (=> (not (= (length temp___1900) 0)) (=> (not (<= 1 2)) (= o24 0))))
(assert (=> (not (= (length temp___1900) 0)) (=> (<= (to_rep1 (first (rt temp___1900))) (to_rep1 (last (rt temp___1900)))) (= o25 (+ (- (to_rep1 (last (rt temp___1900))) (to_rep1 (first (rt temp___1900)))) 1)))))
(assert (=> (not (= (length temp___1900) 0)) (=> (not (<= (to_rep1 (first (rt temp___1900))) (to_rep1 (last (rt temp___1900))))) (= o25 0))))
(assert (=> (not (= (length temp___1900) 0)) (= o26 (+ o25 o24))))
(assert (=> (not (= (length temp___1900) 0)) (= o27 (+ (to_rep1 (first (rt temp___1900))) o26))))
(assert (=> (not (= (length temp___1900) 0)) (= o28 (- o27 1))))
(assert (=> (not (= (length temp___1900) 0)) (and (= o29 o28) (in_range1 o28))))
(assert (=> (not (= (length temp___1900) 0)) (= temp___1902 (mk___t (concat1 (elts temp___1900) (to_rep1 (first (rt temp___1900))) (to_rep1 (last (rt temp___1900))) (temp___String_Literal_1899 Tuple0) 1 2) (mk (to_rep1 (first (rt temp___1900))) o29)))))
(assert (=> (= (length temp___1902) 0) (= temp___1905 (mk___t (elts2 temp___1903) (mk (to_rep1 (first4 (rt2 temp___1903))) (to_rep1 (last4 (rt2 temp___1903))))))))
(assert (=> (not (= (length temp___1902) 0)) (=> (<= (to_rep1 (first4 (rt2 temp___1903))) (to_rep1 (last4 (rt2 temp___1903)))) (= o30 (+ (- (to_rep1 (last4 (rt2 temp___1903))) (to_rep1 (first4 (rt2 temp___1903)))) 1)))))
(assert (=> (not (= (length temp___1902) 0)) (=> (not (<= (to_rep1 (first4 (rt2 temp___1903))) (to_rep1 (last4 (rt2 temp___1903))))) (= o30 0))))
(assert (=> (not (= (length temp___1902) 0)) (=> (<= (to_rep1 (first (rt temp___1902))) (to_rep1 (last (rt temp___1902)))) (= o31 (+ (- (to_rep1 (last (rt temp___1902))) (to_rep1 (first (rt temp___1902)))) 1)))))
(assert (=> (not (= (length temp___1902) 0)) (=> (not (<= (to_rep1 (first (rt temp___1902))) (to_rep1 (last (rt temp___1902))))) (= o31 0))))
(assert (=> (not (= (length temp___1902) 0)) (= o32 (+ o31 o30))))
(assert (=> (not (= (length temp___1902) 0)) (= o33 (+ (to_rep1 (first (rt temp___1902))) o32))))
(assert (=> (not (= (length temp___1902) 0)) (= o34 (- o33 1))))
(assert (=> (not (= (length temp___1902) 0)) (and (= o35 o34) (in_range1 o34))))
(assert (=> (not (= (length temp___1902) 0)) (= temp___1905 (mk___t (concat1 (elts temp___1902) (to_rep1 (first (rt temp___1902))) (to_rep1 (last (rt temp___1902))) (elts2 temp___1903) (to_rep1 (first4 (rt2 temp___1903))) (to_rep1 (last4 (rt2 temp___1903)))) (mk (to_rep1 (first (rt temp___1902))) o35)))))
(assert (=> (= (length temp___1905) 0) (= temp___1907 (mk___t (temp___String_Literal_1904 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length temp___1905) 0)) (=> (<= 1 2) (= o36 (+ (- 2 1) 1)))))
(assert (=> (not (= (length temp___1905) 0)) (=> (not (<= 1 2)) (= o36 0))))
(assert (=> (not (= (length temp___1905) 0)) (=> (<= (to_rep1 (first (rt temp___1905))) (to_rep1 (last (rt temp___1905)))) (= o37 (+ (- (to_rep1 (last (rt temp___1905))) (to_rep1 (first (rt temp___1905)))) 1)))))
(assert (=> (not (= (length temp___1905) 0)) (=> (not (<= (to_rep1 (first (rt temp___1905))) (to_rep1 (last (rt temp___1905))))) (= o37 0))))
(assert (=> (not (= (length temp___1905) 0)) (= o38 (+ o37 o36))))
(assert (=> (not (= (length temp___1905) 0)) (= o39 (+ (to_rep1 (first (rt temp___1905))) o38))))
(assert (=> (not (= (length temp___1905) 0)) (= o40 (- o39 1))))
(assert (=> (not (= (length temp___1905) 0)) (and (= o41 o40) (in_range1 o40))))
(assert (=> (not (= (length temp___1905) 0)) (= temp___1907 (mk___t (concat1 (elts temp___1905) (to_rep1 (first (rt temp___1905))) (to_rep1 (last (rt temp___1905))) (temp___String_Literal_1904 Tuple0) 1 2) (mk (to_rep1 (first (rt temp___1905))) o41)))))
(assert (=> (= (length temp___1907) 0) (= temp___1910 (mk___t temp___1908 (mk (to_rep1 (first2 temp___19081)) (to_rep1 (last2 temp___19081)))))))
(assert (=> (not (= (length temp___1907) 0)) (=> (<= (to_rep1 (first2 temp___19081)) (to_rep1 (last2 temp___19081))) (= o42 (+ (- (to_rep1 (last2 temp___19081)) (to_rep1 (first2 temp___19081))) 1)))))
(assert (=> (not (= (length temp___1907) 0)) (=> (not (<= (to_rep1 (first2 temp___19081)) (to_rep1 (last2 temp___19081)))) (= o42 0))))
(assert (=> (not (= (length temp___1907) 0)) (=> (<= (to_rep1 (first (rt temp___1907))) (to_rep1 (last (rt temp___1907)))) (= o43 (+ (- (to_rep1 (last (rt temp___1907))) (to_rep1 (first (rt temp___1907)))) 1)))))
(assert (=> (not (= (length temp___1907) 0)) (=> (not (<= (to_rep1 (first (rt temp___1907))) (to_rep1 (last (rt temp___1907))))) (= o43 0))))
(assert (=> (not (= (length temp___1907) 0)) (= o44 (+ o43 o42))))
(assert (=> (not (= (length temp___1907) 0)) (= o45 (+ (to_rep1 (first (rt temp___1907))) o44))))
(assert (=> (not (= (length temp___1907) 0)) (= o46 (- o45 1))))
(assert (=> (not (= (length temp___1907) 0)) (and (= o47 o46) (in_range1 o46))))
(assert (=> (not (= (length temp___1907) 0)) (= temp___1910 (mk___t (concat1 (elts temp___1907) (to_rep1 (first (rt temp___1907))) (to_rep1 (last (rt temp___1907))) temp___1908 (to_rep1 (first2 temp___19081)) (to_rep1 (last2 temp___19081))) (mk (to_rep1 (first (rt temp___1907))) o47)))))
(assert (=> (= (length temp___1910) 0) (= temp___1915 (mk___t (temp___String_Literal_1909 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length temp___1910) 0)) (=> (<= 1 2) (= o48 (+ (- 2 1) 1)))))
(assert (=> (not (= (length temp___1910) 0)) (=> (not (<= 1 2)) (= o48 0))))
(assert (=> (not (= (length temp___1910) 0)) (=> (<= (to_rep1 (first (rt temp___1910))) (to_rep1 (last (rt temp___1910)))) (= o49 (+ (- (to_rep1 (last (rt temp___1910))) (to_rep1 (first (rt temp___1910)))) 1)))))
(assert (=> (not (= (length temp___1910) 0)) (=> (not (<= (to_rep1 (first (rt temp___1910))) (to_rep1 (last (rt temp___1910))))) (= o49 0))))
(assert (=> (not (= (length temp___1910) 0)) (= o50 (+ o49 o48))))
(assert (=> (not (= (length temp___1910) 0)) (= o51 (+ (to_rep1 (first (rt temp___1910))) o50))))
(assert (=> (not (= (length temp___1910) 0)) (= o52 (- o51 1))))
(assert (=> (not (= (length temp___1910) 0)) (and (= o53 o52) (in_range1 o52))))
(assert (=> (not (= (length temp___1910) 0)) (= temp___1915 (mk___t (concat1 (elts temp___1910) (to_rep1 (first (rt temp___1910))) (to_rep1 (last (rt temp___1910))) (temp___String_Literal_1909 Tuple0) 1 2) (mk (to_rep1 (first (rt temp___1910))) o53)))))
(assert (=> (= (length temp___1915) 0) (= temp___1918 (mk___t temp___1916 (mk 1 5)))))
(assert (=> (not (= (length temp___1915) 0)) (=> (<= 1 5) (= o54 (+ (- 5 1) 1)))))
(assert (=> (not (= (length temp___1915) 0)) (=> (not (<= 1 5)) (= o54 0))))
(assert (=> (not (= (length temp___1915) 0)) (=> (<= (to_rep1 (first (rt temp___1915))) (to_rep1 (last (rt temp___1915)))) (= o55 (+ (- (to_rep1 (last (rt temp___1915))) (to_rep1 (first (rt temp___1915)))) 1)))))
(assert (=> (not (= (length temp___1915) 0)) (=> (not (<= (to_rep1 (first (rt temp___1915))) (to_rep1 (last (rt temp___1915))))) (= o55 0))))
(assert (=> (not (= (length temp___1915) 0)) (= o56 (+ o55 o54))))
(assert (=> (not (= (length temp___1915) 0)) (= o57 (+ (to_rep1 (first (rt temp___1915))) o56))))
(assert (=> (not (= (length temp___1915) 0)) (= o58 (- o57 1))))
(assert (=> (not (= (length temp___1915) 0)) (and (= o59 o58) (in_range1 o58))))
(assert (=> (not (= (length temp___1915) 0)) (= temp___1918 (mk___t (concat1 (elts temp___1915) (to_rep1 (first (rt temp___1915))) (to_rep1 (last (rt temp___1915))) temp___1916 1 5) (mk (to_rep1 (first (rt temp___1915))) o59)))))
(assert (=> (= (length temp___1918) 0) (= temp___1923 (mk___t (temp___String_Literal_1917 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length temp___1918) 0)) (=> (<= 1 2) (= o60 (+ (- 2 1) 1)))))
(assert (=> (not (= (length temp___1918) 0)) (=> (not (<= 1 2)) (= o60 0))))
(assert (=> (not (= (length temp___1918) 0)) (=> (<= (to_rep1 (first (rt temp___1918))) (to_rep1 (last (rt temp___1918)))) (= o61 (+ (- (to_rep1 (last (rt temp___1918))) (to_rep1 (first (rt temp___1918)))) 1)))))
(assert (=> (not (= (length temp___1918) 0)) (=> (not (<= (to_rep1 (first (rt temp___1918))) (to_rep1 (last (rt temp___1918))))) (= o61 0))))
(assert (=> (not (= (length temp___1918) 0)) (= o62 (+ o61 o60))))
(assert (=> (not (= (length temp___1918) 0)) (= o63 (+ (to_rep1 (first (rt temp___1918))) o62))))
(assert (=> (not (= (length temp___1918) 0)) (= o64 (- o63 1))))
(assert (=> (not (= (length temp___1918) 0)) (and (= o65 o64) (in_range1 o64))))
(assert (=> (not (= (length temp___1918) 0)) (= temp___1923 (mk___t (concat1 (elts temp___1918) (to_rep1 (first (rt temp___1918))) (to_rep1 (last (rt temp___1918))) (temp___String_Literal_1917 Tuple0) 1 2) (mk (to_rep1 (first (rt temp___1918))) o65)))))
(assert (=> (= (length temp___1923) 0) (= temp___1926 (mk___t temp___1924 (mk 1 5)))))
(assert (=> (not (= (length temp___1923) 0)) (=> (<= 1 5) (= o66 (+ (- 5 1) 1)))))
(assert (=> (not (= (length temp___1923) 0)) (=> (not (<= 1 5)) (= o66 0))))
(assert (=> (not (= (length temp___1923) 0)) (=> (<= (to_rep1 (first (rt temp___1923))) (to_rep1 (last (rt temp___1923)))) (= o67 (+ (- (to_rep1 (last (rt temp___1923))) (to_rep1 (first (rt temp___1923)))) 1)))))
(assert (=> (not (= (length temp___1923) 0)) (=> (not (<= (to_rep1 (first (rt temp___1923))) (to_rep1 (last (rt temp___1923))))) (= o67 0))))
(assert (=> (not (= (length temp___1923) 0)) (= o68 (+ o67 o66))))
(assert (=> (not (= (length temp___1923) 0)) (= o69 (+ (to_rep1 (first (rt temp___1923))) o68))))
(assert (=> (not (= (length temp___1923) 0)) (= o70 (- o69 1))))
(assert (=> (not (= (length temp___1923) 0)) (and (= o71 o70) (in_range1 o70))))
(assert (=> (not (= (length temp___1923) 0)) (= temp___1926 (mk___t (concat1 (elts temp___1923) (to_rep1 (first (rt temp___1923))) (to_rep1 (last (rt temp___1923))) temp___1924 1 5) (mk (to_rep1 (first (rt temp___1923))) o71)))))
(assert (=> (= (length temp___1926) 0) (= temp___1931 (mk___t (temp___String_Literal_1925 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length temp___1926) 0)) (=> (<= 1 2) (= o72 (+ (- 2 1) 1)))))
(assert (=> (not (= (length temp___1926) 0)) (=> (not (<= 1 2)) (= o72 0))))
(assert (=> (not (= (length temp___1926) 0)) (=> (<= (to_rep1 (first (rt temp___1926))) (to_rep1 (last (rt temp___1926)))) (= o73 (+ (- (to_rep1 (last (rt temp___1926))) (to_rep1 (first (rt temp___1926)))) 1)))))
(assert (=> (not (= (length temp___1926) 0)) (=> (not (<= (to_rep1 (first (rt temp___1926))) (to_rep1 (last (rt temp___1926))))) (= o73 0))))
(assert (=> (not (= (length temp___1926) 0)) (= o74 (+ o73 o72))))
(assert (=> (not (= (length temp___1926) 0)) (= o75 (+ (to_rep1 (first (rt temp___1926))) o74))))
(assert (=> (not (= (length temp___1926) 0)) (= o76 (- o75 1))))
(assert (=> (not (= (length temp___1926) 0)) (and (= o77 o76) (in_range1 o76))))
(assert (=> (not (= (length temp___1926) 0)) (= temp___1931 (mk___t (concat1 (elts temp___1926) (to_rep1 (first (rt temp___1926))) (to_rep1 (last (rt temp___1926))) (temp___String_Literal_1925 Tuple0) 1 2) (mk (to_rep1 (first (rt temp___1926))) o77)))))
(assert (=> (= (length temp___1931) 0) (= temp___1934 (mk___t temp___1932 (mk 1 5)))))
(assert (=> (not (= (length temp___1931) 0)) (=> (<= 1 5) (= o78 (+ (- 5 1) 1)))))
(assert (=> (not (= (length temp___1931) 0)) (=> (not (<= 1 5)) (= o78 0))))
(assert (=> (not (= (length temp___1931) 0)) (=> (<= (to_rep1 (first (rt temp___1931))) (to_rep1 (last (rt temp___1931)))) (= o79 (+ (- (to_rep1 (last (rt temp___1931))) (to_rep1 (first (rt temp___1931)))) 1)))))
(assert (=> (not (= (length temp___1931) 0)) (=> (not (<= (to_rep1 (first (rt temp___1931))) (to_rep1 (last (rt temp___1931))))) (= o79 0))))
(assert (=> (not (= (length temp___1931) 0)) (= o80 (+ o79 o78))))
(assert (=> (not (= (length temp___1931) 0)) (= o81 (+ (to_rep1 (first (rt temp___1931))) o80))))
(assert (=> (not (= (length temp___1931) 0)) (= o82 (- o81 1))))
(assert (=> (not (= (length temp___1931) 0)) (and (= o83 o82) (in_range1 o82))))
(assert (=> (not (= (length temp___1931) 0)) (= temp___1934 (mk___t (concat1 (elts temp___1931) (to_rep1 (first (rt temp___1931))) (to_rep1 (last (rt temp___1931))) temp___1932 1 5) (mk (to_rep1 (first (rt temp___1931))) o83)))))
(assert (=> (= (length temp___1934) 0) (= temp___1936 (mk___t (temp___String_Literal_1933 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length temp___1934) 0)) (=> (<= 1 2) (= o84 (+ (- 2 1) 1)))))
(assert (=> (not (= (length temp___1934) 0)) (=> (not (<= 1 2)) (= o84 0))))
(assert (=> (not (= (length temp___1934) 0)) (=> (<= (to_rep1 (first (rt temp___1934))) (to_rep1 (last (rt temp___1934)))) (= o85 (+ (- (to_rep1 (last (rt temp___1934))) (to_rep1 (first (rt temp___1934)))) 1)))))
(assert (=> (not (= (length temp___1934) 0)) (=> (not (<= (to_rep1 (first (rt temp___1934))) (to_rep1 (last (rt temp___1934))))) (= o85 0))))
(assert (=> (not (= (length temp___1934) 0)) (= o86 (+ o85 o84))))
(assert (=> (not (= (length temp___1934) 0)) (= o87 (+ (to_rep1 (first (rt temp___1934))) o86))))
(assert (=> (not (= (length temp___1934) 0)) (= o88 (- o87 1))))
(assert (=> (not (= (length temp___1934) 0)) (and (= o89 o88) (in_range1 o88))))
(assert (=> (not (= (length temp___1934) 0)) (= temp___1936 (mk___t (concat1 (elts temp___1934) (to_rep1 (first (rt temp___1934))) (to_rep1 (last (rt temp___1934))) (temp___String_Literal_1933 Tuple0) 1 2) (mk (to_rep1 (first (rt temp___1934))) o89)))))
(assert (=> (= (length temp___1936) 0) (= temp___1939 (mk___t temp___1937 (mk (to_rep1 (first2 temp___19371)) (to_rep1 (last2 temp___19371)))))))
(assert (=> (not (= (length temp___1936) 0)) (=> (<= (to_rep1 (first2 temp___19371)) (to_rep1 (last2 temp___19371))) (= o90 (+ (- (to_rep1 (last2 temp___19371)) (to_rep1 (first2 temp___19371))) 1)))))
(assert (=> (not (= (length temp___1936) 0)) (=> (not (<= (to_rep1 (first2 temp___19371)) (to_rep1 (last2 temp___19371)))) (= o90 0))))
(assert (=> (not (= (length temp___1936) 0)) (=> (<= (to_rep1 (first (rt temp___1936))) (to_rep1 (last (rt temp___1936)))) (= o91 (+ (- (to_rep1 (last (rt temp___1936))) (to_rep1 (first (rt temp___1936)))) 1)))))
(assert (=> (not (= (length temp___1936) 0)) (=> (not (<= (to_rep1 (first (rt temp___1936))) (to_rep1 (last (rt temp___1936))))) (= o91 0))))
(assert (=> (not (= (length temp___1936) 0)) (= o92 (+ o91 o90))))
(assert (=> (not (= (length temp___1936) 0)) (= o93 (+ (to_rep1 (first (rt temp___1936))) o92))))
(assert (=> (not (= (length temp___1936) 0)) (= o94 (- o93 1))))
(assert (=> (not (= (length temp___1936) 0)) (and (= o95 o94) (in_range1 o94))))
(assert (=> (not (= (length temp___1936) 0)) (= temp___1939 (mk___t (concat1 (elts temp___1936) (to_rep1 (first (rt temp___1936))) (to_rep1 (last (rt temp___1936))) temp___1937 (to_rep1 (first2 temp___19371)) (to_rep1 (last2 temp___19371))) (mk (to_rep1 (first (rt temp___1936))) o95)))))
(assert (=> (= (length temp___1939) 0) (= temp___1941 (mk___t (temp___String_Literal_1938 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length temp___1939) 0)) (=> (<= 1 2) (= o96 (+ (- 2 1) 1)))))
(assert (=> (not (= (length temp___1939) 0)) (=> (not (<= 1 2)) (= o96 0))))
(assert (=> (not (= (length temp___1939) 0)) (=> (<= (to_rep1 (first (rt temp___1939))) (to_rep1 (last (rt temp___1939)))) (= o97 (+ (- (to_rep1 (last (rt temp___1939))) (to_rep1 (first (rt temp___1939)))) 1)))))
(assert (=> (not (= (length temp___1939) 0)) (=> (not (<= (to_rep1 (first (rt temp___1939))) (to_rep1 (last (rt temp___1939))))) (= o97 0))))
(assert (=> (not (= (length temp___1939) 0)) (= o98 (+ o97 o96))))
(assert (=> (not (= (length temp___1939) 0)) (= o99 (+ (to_rep1 (first (rt temp___1939))) o98))))
(assert (=> (not (= (length temp___1939) 0)) (= o100 (- o99 1))))
(assert (=> (not (= (length temp___1939) 0)) (and (= o101 o100) (in_range1 o100))))
(assert (=> (not (= (length temp___1939) 0)) (= temp___1941 (mk___t (concat1 (elts temp___1939) (to_rep1 (first (rt temp___1939))) (to_rep1 (last (rt temp___1939))) (temp___String_Literal_1938 Tuple0) 1 2) (mk (to_rep1 (first (rt temp___1939))) o101)))))
(assert (=> (= (length temp___1941) 0) (= temp___1944 (mk___t temp___1942 (mk (to_rep1 (first2 temp___19421)) (to_rep1 (last2 temp___19421)))))))
(assert (=> (not (= (length temp___1941) 0)) (=> (<= (to_rep1 (first2 temp___19421)) (to_rep1 (last2 temp___19421))) (= o102 (+ (- (to_rep1 (last2 temp___19421)) (to_rep1 (first2 temp___19421))) 1)))))
(assert (=> (not (= (length temp___1941) 0)) (=> (not (<= (to_rep1 (first2 temp___19421)) (to_rep1 (last2 temp___19421)))) (= o102 0))))
(assert (=> (not (= (length temp___1941) 0)) (=> (<= (to_rep1 (first (rt temp___1941))) (to_rep1 (last (rt temp___1941)))) (= o103 (+ (- (to_rep1 (last (rt temp___1941))) (to_rep1 (first (rt temp___1941)))) 1)))))
(assert (=> (not (= (length temp___1941) 0)) (=> (not (<= (to_rep1 (first (rt temp___1941))) (to_rep1 (last (rt temp___1941))))) (= o103 0))))
(assert (=> (not (= (length temp___1941) 0)) (= o104 (+ o103 o102))))
(assert (=> (not (= (length temp___1941) 0)) (= o105 (+ (to_rep1 (first (rt temp___1941))) o104))))
(assert (=> (not (= (length temp___1941) 0)) (= o106 (- o105 1))))
(assert (=> (not (= (length temp___1941) 0)) (and (= o107 o106) (in_range1 o106))))
(assert (=> (not (= (length temp___1941) 0)) (= temp___1944 (mk___t (concat1 (elts temp___1941) (to_rep1 (first (rt temp___1941))) (to_rep1 (last (rt temp___1941))) temp___1942 (to_rep1 (first2 temp___19421)) (to_rep1 (last2 temp___19421))) (mk (to_rep1 (first (rt temp___1941))) o107)))))
(assert (=> (= (length temp___1944) 0) (= temp___1946 (mk___t (temp___String_Literal_1943 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length temp___1944) 0)) (=> (<= 1 2) (= o108 (+ (- 2 1) 1)))))
(assert (=> (not (= (length temp___1944) 0)) (=> (not (<= 1 2)) (= o108 0))))
(assert (=> (not (= (length temp___1944) 0)) (=> (<= (to_rep1 (first (rt temp___1944))) (to_rep1 (last (rt temp___1944)))) (= o109 (+ (- (to_rep1 (last (rt temp___1944))) (to_rep1 (first (rt temp___1944)))) 1)))))
(assert (=> (not (= (length temp___1944) 0)) (=> (not (<= (to_rep1 (first (rt temp___1944))) (to_rep1 (last (rt temp___1944))))) (= o109 0))))
(assert (=> (not (= (length temp___1944) 0)) (= o110 (+ o109 o108))))
(assert (=> (not (= (length temp___1944) 0)) (= o111 (+ (to_rep1 (first (rt temp___1944))) o110))))
(assert (=> (not (= (length temp___1944) 0)) (= o112 (- o111 1))))
(assert (=> (not (= (length temp___1944) 0)) (and (= o113 o112) (in_range1 o112))))
(assert (=> (not (= (length temp___1944) 0)) (= temp___1946 (mk___t (concat1 (elts temp___1944) (to_rep1 (first (rt temp___1944))) (to_rep1 (last (rt temp___1944))) (temp___String_Literal_1943 Tuple0) 1 2) (mk (to_rep1 (first (rt temp___1944))) o113)))))
(assert (=> (= (length temp___1946) 0) (= temp___1949 (mk___t temp___1947 (mk (to_rep1 (first4 temp___19471)) (to_rep1 (last4 temp___19471)))))))
(assert (=> (not (= (length temp___1946) 0)) (=> (<= (to_rep1 (first4 temp___19471)) (to_rep1 (last4 temp___19471))) (= o114 (+ (- (to_rep1 (last4 temp___19471)) (to_rep1 (first4 temp___19471))) 1)))))
(assert (=> (not (= (length temp___1946) 0)) (=> (not (<= (to_rep1 (first4 temp___19471)) (to_rep1 (last4 temp___19471)))) (= o114 0))))
(assert (=> (not (= (length temp___1946) 0)) (=> (<= (to_rep1 (first (rt temp___1946))) (to_rep1 (last (rt temp___1946)))) (= o115 (+ (- (to_rep1 (last (rt temp___1946))) (to_rep1 (first (rt temp___1946)))) 1)))))
(assert (=> (not (= (length temp___1946) 0)) (=> (not (<= (to_rep1 (first (rt temp___1946))) (to_rep1 (last (rt temp___1946))))) (= o115 0))))
(assert (=> (not (= (length temp___1946) 0)) (= o116 (+ o115 o114))))
(assert (=> (not (= (length temp___1946) 0)) (= o117 (+ (to_rep1 (first (rt temp___1946))) o116))))
(assert (=> (not (= (length temp___1946) 0)) (= o118 (- o117 1))))
(assert (=> (not (= (length temp___1946) 0)) (and (= o119 o118) (in_range1 o118))))
(assert (=> (not (= (length temp___1946) 0)) (= temp___1949 (mk___t (concat1 (elts temp___1946) (to_rep1 (first (rt temp___1946))) (to_rep1 (last (rt temp___1946))) temp___1947 (to_rep1 (first4 temp___19471)) (to_rep1 (last4 temp___19471))) (mk (to_rep1 (first (rt temp___1946))) o119)))))
(assert (=> (= (length temp___1949) 0) (= temp___1951 (mk___t (temp___String_Literal_1948 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length temp___1949) 0)) (=> (<= 1 2) (= o120 (+ (- 2 1) 1)))))
(assert (=> (not (= (length temp___1949) 0)) (=> (not (<= 1 2)) (= o120 0))))
(assert (=> (not (= (length temp___1949) 0)) (=> (<= (to_rep1 (first (rt temp___1949))) (to_rep1 (last (rt temp___1949)))) (= o121 (+ (- (to_rep1 (last (rt temp___1949))) (to_rep1 (first (rt temp___1949)))) 1)))))
(assert (=> (not (= (length temp___1949) 0)) (=> (not (<= (to_rep1 (first (rt temp___1949))) (to_rep1 (last (rt temp___1949))))) (= o121 0))))
(assert (=> (not (= (length temp___1949) 0)) (= o122 (+ o121 o120))))
(assert (=> (not (= (length temp___1949) 0)) (= o123 (+ (to_rep1 (first (rt temp___1949))) o122))))
(assert (=> (not (= (length temp___1949) 0)) (= o124 (- o123 1))))
(assert (=> (not (= (length temp___1949) 0)) (and (= o125 o124) (in_range1 o124))))
(assert (=> (not (= (length temp___1949) 0)) (= temp___1951 (mk___t (concat1 (elts temp___1949) (to_rep1 (first (rt temp___1949))) (to_rep1 (last (rt temp___1949))) (temp___String_Literal_1948 Tuple0) 1 2) (mk (to_rep1 (first (rt temp___1949))) o125)))))
(assert (=> (= (length temp___1951) 0) (= temp___1954 (mk___t temp___1952 (mk (to_rep1 (first4 temp___19521)) (to_rep1 (last4 temp___19521)))))))
(assert (=> (not (= (length temp___1951) 0)) (=> (<= (to_rep1 (first4 temp___19521)) (to_rep1 (last4 temp___19521))) (= o126 (+ (- (to_rep1 (last4 temp___19521)) (to_rep1 (first4 temp___19521))) 1)))))
(assert (=> (not (= (length temp___1951) 0)) (=> (not (<= (to_rep1 (first4 temp___19521)) (to_rep1 (last4 temp___19521)))) (= o126 0))))
(assert (=> (not (= (length temp___1951) 0)) (=> (<= (to_rep1 (first (rt temp___1951))) (to_rep1 (last (rt temp___1951)))) (= o127 (+ (- (to_rep1 (last (rt temp___1951))) (to_rep1 (first (rt temp___1951)))) 1)))))
(assert (=> (not (= (length temp___1951) 0)) (=> (not (<= (to_rep1 (first (rt temp___1951))) (to_rep1 (last (rt temp___1951))))) (= o127 0))))
(assert (=> (not (= (length temp___1951) 0)) (= o128 (+ o127 o126))))
(assert (=> (not (= (length temp___1951) 0)) (= o129 (+ (to_rep1 (first (rt temp___1951))) o128))))
(assert (=> (not (= (length temp___1951) 0)) (= o130 (- o129 1))))
(assert (=> (not (= (length temp___1951) 0)) (and (= o131 o130) (in_range1 o130))))
(assert (=> (not (= (length temp___1951) 0)) (= temp___1954 (mk___t (concat1 (elts temp___1951) (to_rep1 (first (rt temp___1951))) (to_rep1 (last (rt temp___1951))) temp___1952 (to_rep1 (first4 temp___19521)) (to_rep1 (last4 temp___19521))) (mk (to_rep1 (first (rt temp___1951))) o131)))))
(assert (=> (= (length temp___1954) 0) (= temp___1956 (mk___t (temp___String_Literal_1953 Tuple0) (mk 1 2)))))
(assert (=> (not (= (length temp___1954) 0)) (=> (<= 1 2) (= o132 (+ (- 2 1) 1)))))
(assert (=> (not (= (length temp___1954) 0)) (=> (not (<= 1 2)) (= o132 0))))
(assert (=> (not (= (length temp___1954) 0)) (=> (<= (to_rep1 (first (rt temp___1954))) (to_rep1 (last (rt temp___1954)))) (= o133 (+ (- (to_rep1 (last (rt temp___1954))) (to_rep1 (first (rt temp___1954)))) 1)))))
(assert (=> (not (= (length temp___1954) 0)) (=> (not (<= (to_rep1 (first (rt temp___1954))) (to_rep1 (last (rt temp___1954))))) (= o133 0))))
(assert (=> (not (= (length temp___1954) 0)) (= o134 (+ o133 o132))))
(assert (=> (not (= (length temp___1954) 0)) (= o135 (+ (to_rep1 (first (rt temp___1954))) o134))))
(assert (=> (not (= (length temp___1954) 0)) (= o136 (- o135 1))))
(assert (=> (not (= (length temp___1954) 0)) (and (= o137 o136) (in_range1 o136))))
(assert (=> (not (= (length temp___1954) 0)) (= temp___1956 (mk___t (concat1 (elts temp___1954) (to_rep1 (first (rt temp___1954))) (to_rep1 (last (rt temp___1954))) (temp___String_Literal_1953 Tuple0) 1 2) (mk (to_rep1 (first (rt temp___1954))) o137)))))
(assert (not (= (length temp___1956) 0)))
(assert (=> (<= (to_rep1 (first4 temp___19571)) (to_rep1 (last4 temp___19571))) (= o138 (+ (- (to_rep1 (last4 temp___19571)) (to_rep1 (first4 temp___19571))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___19571)) (to_rep1 (last4 temp___19571)))) (= o138 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1956))) (to_rep1 (last (rt temp___1956)))) (= o139 (+ (- (to_rep1 (last (rt temp___1956))) (to_rep1 (first (rt temp___1956)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1956))) (to_rep1 (last (rt temp___1956))))) (= o139 0)))
(assert (= o140 (+ o139 o138)))
(assert (= o141 (+ (to_rep1 (first (rt temp___1956))) o140)))
(assert (= o142 (- o141 1)))
