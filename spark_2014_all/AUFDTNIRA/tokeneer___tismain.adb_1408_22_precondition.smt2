...
(assert (=> (= result8 true) (and (= o3 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o3 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result8 true) (= o4 (ite (not (= o3 true)) true false))))
...
(assert (=> (= result8 true) (=> (= result9 true) (and (= o2 (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (in_range4 o2)))))
(assert (=> (= result8 true) (=> (= result9 true) (= o5 (ite (= o2 3) true false)))))
(assert (=> (= result8 true) (=> (not (= result9 true)) (= o5 false))))
(assert (=> (= result8 true) (= o6 (ite (= o5 false) o4 true))))
