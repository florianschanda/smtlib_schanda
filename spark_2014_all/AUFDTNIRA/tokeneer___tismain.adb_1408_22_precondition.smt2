...
(assert (and (and (and (and (and (and (and (and (and (and (and (= (not (= (enrolmentisinprogress status2 (let ((subject state3)) state11)) true)) (= (privatekeypresent thistisinfo__split_fields1 (let ((subject state)) state8)) true)) (= (= (islocked currentlatch2 (let ((subject state2)) state10) latchtimeout__split_fields1) true) (= (latchislocked Tuple0) true))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 1) (and (and (= (isgood tokenpresence2 (let ((subject state1)) state9) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true) (= (authcertvalid tokenpresence2 (let ((subject state1)) state9) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true)) (= (theauthcertrole tokenpresence2 (let ((subject state1)) state9) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) 1)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 3)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 1))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 1) (or (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 3)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true))))) (=> (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 4)) (= (statusiswaitingstartadminop status2 (let ((subject state3)) state11)) true))) (=> (or (= (statusisgotadmintoken status2 (let ((subject state3)) state11)) true) (= (statusiswaitingremoveadmintokenfail status2 (let ((subject state3)) state11)) true)) (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)))) (=> (or (= (statusiswaitingstartadminop status2 (let ((subject state3)) state11)) true) (= (statusiswaitingfinishadminop status2 (let ((subject state3)) state11)) true)) (and (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true) (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)))) (=> (= (statusisenclavequiescent status2 (let ((subject state3)) state11)) true) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)))) (=> (= (statusisshutdown status2 (let ((subject state3)) state11)) true) (and (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 0)))) (=> (= (enrolmentisinprogress status2 (let ((subject state3)) state11)) true) (and (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true))))))
...
(assert (and (= result (enrolmentisinprogress status2 (let ((subject state3)) state11))) (= (= result true) (in_range30 status2))))
(assert (=> (= result true) (and (= o28 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o28 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result true) (= o29 (ite (not (= o28 true)) true false))))
(assert (=> (= result true) (and (= o27 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o27 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result true) (= o30 (ite (not (= o27 true)) true false))))
(assert (=> (= result true) (= o31 (ite (= o30 true) o29 false))))
(assert (=> (not (= result true)) (= o31 (distinct 1 0))))
(assert (and (= result1 (statusisshutdown status2 (let ((subject state3)) state11))) (= (= result1 true) (= status2 8))))
(assert (=> (= result1 true) (and (= o23 (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (and (in_range2 o23) (= o23 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result1 true) (= o24 (ite (= o23 0) true false))))
(assert (=> (= result1 true) (and (= o22 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o22 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result1 true) (= o25 (ite (not (= o22 true)) true false))))
(assert (=> (= result1 true) (= o26 (ite (= o25 true) o24 false))))
(assert (=> (not (= result1 true)) (= o26 (distinct 1 0))))
(assert (and (= result2 (statusisenclavequiescent status2 (let ((subject state3)) state11))) (= (= result2 true) (= status2 3))))
(assert (=> (= result2 true) (and (= o20 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o20 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result2 true) (= o21 (ite (not (= o20 true)) true false))))
(assert (=> (not (= result2 true)) (= o21 (distinct 1 0))))
(assert (and (= o15 (statusiswaitingfinishadminop status2 (let ((subject state3)) state11))) (= (= o15 true) (= status2 7))))
(assert (and (= o16 (statusiswaitingstartadminop status2 (let ((subject state3)) state11))) (= (= o16 true) (= status2 6))))
(assert (= result3 (ite (= o16 false) o15 true)))
(assert (=> (= result3 true) (and (= o17 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o17 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result3 true) (and (= o18 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o18 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result3 true) (= o19 (ite (= o18 true) o17 false))))
(assert (=> (not (= result3 true)) (= o19 (distinct 1 0))))
(assert (and (= o11 (statusiswaitingremoveadmintokenfail status2 (let ((subject state3)) state11))) (= (= o11 true) (= status2 4))))
(assert (and (= o12 (statusisgotadmintoken status2 (let ((subject state3)) state11))) (= (= o12 true) (= status2 5))))
(assert (= result4 (ite (= o12 false) o11 true)))
(assert (=> (= result4 true) (and (= o13 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o13 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result4 true) (= o14 (ite (not (= o13 true)) true false))))
(assert (=> (not (= result4 true)) (= o14 (distinct 1 0))))
...
(assert (=> (= result6 true) (and (= o9 (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (in_range4 o9))))
(assert (=> (= result6 true) (= result5 (ite (= o9 4) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o10 (statusiswaitingstartadminop status2 (let ((subject state3)) state11))) (= (= o10 true) (= status2 6)))))
(assert (=> (not (= result5 true)) (= o10 (distinct 1 0))))
(assert (and (= o6 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o6 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2)))))))
(assert (= result7 (ite (not (= o6 true)) true false)))
(assert (=> (= result7 true) (and (= o7 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o7 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result7 true) (= o8 (ite (not (= o7 true)) true false))))
(assert (=> (not (= result7 true)) (= o8 (distinct 1 0))))
(assert (and (= o (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (and (in_range2 o) (= o (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2)))))))
(assert (= result8 (ite (= o 1) true false)))
(assert (=> (= result8 true) (and (= o2 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o2 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result8 true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (= result8 true) (and (= result9 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= result9 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result8 true) (=> (= result9 true) (and (= o1 (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (in_range4 o1)))))
(assert (=> (= result8 true) (=> (= result9 true) (= o4 (ite (= o1 3) true false)))))
(assert (=> (= result8 true) (=> (not (= result9 true)) (= o4 false))))
(assert (=> (= result8 true) (= o5 (ite (= o4 false) o3 true))))
(assert (=> (not (= result8 true)) (= o5 (distinct 1 0))))
(assert (and (= result10 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= result10 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2)))))))
