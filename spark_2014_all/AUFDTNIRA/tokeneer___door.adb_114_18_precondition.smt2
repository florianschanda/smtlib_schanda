...
(assert (and (= o (islocked currentlatch (us_private__content state) (mk___split_fields latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) (= (= o true) (= currentlatch 0))))
(assert (= o3 (ite (= currentdoor 0) o false)))
(assert (= result (ite (= o3 true) o2 false)))
(assert (=> (= result true) (= result1 localalarm3)))
(assert (=> (= result true) (= localalarm1 0)))
(assert (=> (= result true) (= result2 severity3)))
(assert (=> (= result true) (= severity1 2)))
(assert (=> (= result true) (= result3 id3)))
(assert (=> (= result true) (= id1 10)))
(assert (=> (not (= result true)) (= result4 localalarm3)))
(assert (=> (not (= result true)) (= localalarm2 1)))
(assert (=> (not (= result true)) (= result5 severity3)))
(assert (=> (not (= result true)) (= severity2 0)))
(assert (=> (not (= result true)) (= result6 id3)))
