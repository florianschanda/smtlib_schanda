...
(declare-fun user_eq10 (tokenidt tokenidt) Bool)
(declare-const dummy10 tokenidt)
...
(define-fun dynamic_invariant2 ((temp___expr_522 Int) (temp___is_init_519 Bool) (temp___skip_constant_520 Bool) (temp___do_toplevel_521 Bool)) Bool (=> (or (= temp___is_init_519 true) (<= 0 4294967295)) (in_range9 temp___expr_522)))
(declare-sort tryt 0)
(define-fun in_range10 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
(declare-fun attr__ATTRIBUTE_IMAGE10 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check10 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE10 (us_image) Int)
(declare-fun user_eq11 (tryt tryt) Bool)
(declare-const dummy11 tryt)
...
(define-fun dynamic_invariant3 ((temp___expr_528 Int) (temp___is_init_525 Bool) (temp___skip_constant_526 Bool) (temp___do_toplevel_527 Bool)) Bool (=> (or (= temp___is_init_525 true) (<= 0 2)) (in_range10 temp___expr_528)))
...
(define-fun dynamic_invariant4 ((temp___expr_534 Int) (temp___is_init_531 Bool) (temp___skip_constant_532 Bool) (temp___do_toplevel_533 Bool)) Bool (=> (or (= temp___is_init_531 true) (<= 0 1)) (in_range11 temp___expr_534)))
...
(assert (forall ((temp___160 Int)) (forall ((temp___161 Int)) (= (select (audittypes__nodescription__aggregate_def temp___160) temp___161) (of_rep temp___160)))))
(declare-const nouser (Array Int character))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun temp___String_Literal_162 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_162 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_162 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 4)) 115)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 29)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_162 us_void_param) 50)) 32)) :pattern ((temp___String_Literal_162 us_void_param)))))
...
(assert (forall ((x yearst)) (! (in_range13 (to_rep4 x)) :pattern ((to_rep4 x)))))
(assert (forall ((x Int)) (! (=> (in_range13 x) (= (to_rep4 (of_rep4 x)) x)) :pattern ((to_rep4 (of_rep4 x))))))
...
(assert (forall ((x monthst)) (! (in_range14 (to_rep5 x)) :pattern ((to_rep5 x)))))
(assert (forall ((x Int)) (! (=> (in_range14 x) (= (to_rep5 (of_rep5 x)) x)) :pattern ((to_rep5 (of_rep5 x))))))
...
(assert (forall ((x dayst)) (! (in_range15 (to_rep6 x)) :pattern ((to_rep6 x)))))
(assert (forall ((x Int)) (! (=> (in_range15 x) (= (to_rep6 (of_rep6 x)) x)) :pattern ((to_rep6 (of_rep6 x))))))
...
(assert (forall ((x millisecst)) (! (in_range16 (to_rep7 x)) :pattern ((to_rep7 x)))))
(assert (forall ((x Int)) (! (=> (in_range16 x) (= (to_rep7 (of_rep7 x)) x)) :pattern ((to_rep7 (of_rep7 x))))))
...
(declare-fun user_eq19 (logfileindext logfileindext) Bool)
(declare-const dummy19 logfileindext)
...
(assert (forall ((x logfileindext)) (! (in_range17 (to_rep8 x)) :pattern ((to_rep8 x)))))
(assert (forall ((x Int)) (! (=> (in_range17 x) (= (to_rep8 (of_rep8 x)) x)) :pattern ((to_rep8 (of_rep8 x))))))
...
(declare-fun user_eq20 (logentrycountt logentrycountt) Bool)
(declare-const dummy20 logentrycountt)
...
(assert (forall ((x logentrycountt)) (! (in_range18 (to_rep9 x)) :pattern ((to_rep9 x)))))
(assert (forall ((x Int)) (! (=> (in_range18 x) (= (to_rep9 (of_rep9 x)) x)) :pattern ((to_rep9 (of_rep9 x))))))
...
(declare-fun user_eq22 (logfilecountt logfilecountt) Bool)
(declare-const dummy22 logfilecountt)
...
(assert (forall ((x logfilecountt)) (! (in_range19 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(declare-fun user_eq24 (fileentrycountt fileentrycountt) Bool)
(declare-const dummy24 fileentrycountt)
...
(assert (forall ((x fileentrycountt)) (! (in_range20 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(declare-const dummy25 (Array Int fileentrycountt))
...
(declare-fun user_eq25 ((Array Int fileentrycountt) (Array Int fileentrycountt)) Bool)
...
(assert (forall ((temp___1159 Int)) (forall ((temp___1160 Int)) (= (select (temp___1157 temp___1159) temp___1160) (of_rep8 temp___1159)))))
(declare-fun temp___1161 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1163 Int)) (forall ((temp___1164 Int)) (= (select (temp___1161 temp___1163) temp___1164) (of_rep11 temp___1163)))))
(define-fun dynamic_invariant5 ((temp___expr_1151 us_rep3) (temp___is_init_1148 Bool) (temp___skip_constant_1149 Bool) (temp___do_toplevel_1150 Bool)) Bool (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1151))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1151))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1151)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1151))) true))
(define-fun default_initial_assumption ((temp___expr_1155 us_rep3) (temp___skip_top_level_1156 Bool)) Bool (and (and (and (= (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1155))) 1) (= (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1155))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1155)) (mk___rep2 (mk___split_fields2 (temp___1157 1) (of_rep8 1) (of_rep8 1) (of_rep10 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1155)) (temp___1161 0))))
(define-fun type_invariant ((temp___1165 us_rep3)) Bool (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1165))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1165))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1165)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1165))) true))
...
(declare-fun user_eq27 (us_rep4 us_rep4) Bool)
(declare-const dummy27 us_rep4)
...
(assert (forall ((x filestatust)) (! (in_range21 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(declare-fun user_eq46 (t1 t1) Bool)
(declare-const dummy46 t1)
(declare-datatypes () ((t__ref2 (mk_t__ref2 (t__content2 t1)))))
(define-fun t__ref___3__projection ((a t__ref2)) t1 (t__content2 a))
(define-fun dynamic_invariant6 ((temp___expr_1911 Int) (temp___is_init_1908 Bool) (temp___skip_constant_1909 Bool) (temp___do_toplevel_1910 Bool)) Bool (=> (or (= temp___is_init_1908 true) (<= 0 1)) (in_range29 temp___expr_1911)))
...
(declare-fun user_eq47 (statscount statscount) Bool)
(declare-const dummy47 statscount)
...
(declare-fun to_rep20 (statscount) Int)
(declare-fun of_rep20 (Int) statscount)
(assert (forall ((x statscount)) (! (= (of_rep20 (to_rep20 x)) x) :pattern ((to_rep20 x)))))
(assert (forall ((x statscount)) (! (in_range30 (to_rep20 x)) :pattern ((to_rep20 x)))))
(assert (forall ((x Int)) (! (=> (in_range30 x) (= (to_rep20 (of_rep20 x)) x)) :pattern ((to_rep20 (of_rep20 x))))))
...
(declare-fun user_eq48 (us_rep14 us_rep14) Bool)
(declare-const dummy48 us_rep14)
...
(declare-fun user_eq49 (statust1 statust1) Bool)
(declare-const dummy49 statust1)
...
(define-fun dynamic_invariant7 ((temp___expr_2625 Int) (temp___is_init_2622 Bool) (temp___skip_constant_2623 Bool) (temp___do_toplevel_2624 Bool)) Bool (=> (or (= temp___is_init_2622 true) (<= 0 8)) (in_range31 temp___expr_2625)))
...
(define-fun in_range32 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
...
(declare-fun user_eq50 (enrolmentstates enrolmentstates) Bool)
(declare-const dummy50 enrolmentstates)
...
(assert true)
(assert (forall ((enclave__status Int)) (forall ((enclave__state us_private)) (! (= (= (enrolmentisinprogress enclave__status enclave__state) true) (in_range32 enclave__status)) :pattern ((enrolmentisinprogress enclave__status enclave__state))))))
...
(define-fun dynamic_invariant12 ((temp___expr_401 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 4)) (in_range6 temp___expr_401)))
(define-fun dynamic_invariant13 ((temp___expr_407 Int) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool)) Bool (=> (or (= temp___is_init_404 true) (<= 1 4)) (in_range7 temp___expr_407)))
(define-fun dynamic_invariant14 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 1 3)) (in_range8 temp___expr_200)))
(define-fun dynamic_invariant15 ((temp___expr_206 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 5)) (in_range24 temp___expr_206)))
(define-fun dynamic_invariant16 ((temp___expr_446 Int) (temp___is_init_443 Bool) (temp___skip_constant_444 Bool) (temp___do_toplevel_445 Bool)) Bool (=> (or (= temp___is_init_443 true) (<= 0 40)) (in_range22 temp___expr_446)))
(define-fun dynamic_invariant17 ((temp___expr_467 Int) (temp___is_init_464 Bool) (temp___skip_constant_465 Bool) (temp___do_toplevel_466 Bool)) Bool (=> (or (= temp___is_init_464 true) (<= 0 4294967295)) (in_range23 temp___expr_467)))
(define-fun dynamic_invariant18 ((temp___expr_489 Int) (temp___is_init_486 Bool) (temp___skip_constant_487 Bool) (temp___do_toplevel_488 Bool)) Bool (=> (or (= temp___is_init_486 true) (<= 0 10)) (in_range25 temp___expr_489)))
(define-fun dynamic_invariant19 ((temp___expr_501 Int) (temp___is_init_498 Bool) (temp___skip_constant_499 Bool) (temp___do_toplevel_500 Bool)) Bool (=> (or (= temp___is_init_498 true) (<= 0 4294967295)) (in_range27 temp___expr_501)))
(define-fun dynamic_invariant20 ((temp___expr_507 Int) (temp___is_init_504 Bool) (temp___skip_constant_505 Bool) (temp___do_toplevel_506 Bool)) Bool (=> (or (= temp___is_init_504 true) (<= 0 128)) (in_range28 temp___expr_507)))
(define-fun dynamic_invariant21 ((temp___expr_1117 Int) (temp___is_init_1114 Bool) (temp___skip_constant_1115 Bool) (temp___do_toplevel_1116 Bool)) Bool (=> (or (= temp___is_init_1114 true) (<= 0 17)) (in_range19 temp___expr_1117)))
(define-fun dynamic_invariant22 ((temp___expr_1096 Int) (temp___is_init_1093 Bool) (temp___skip_constant_1094 Bool) (temp___do_toplevel_1095 Bool)) Bool (=> (or (= temp___is_init_1093 true) (<= 1 17)) (in_range17 temp___expr_1096)))
(define-fun dynamic_invariant23 ((temp___expr_1221 Int) (temp___is_init_1218 Bool) (temp___skip_constant_1219 Bool) (temp___do_toplevel_1220 Bool)) Bool (=> (or (= temp___is_init_1218 true) (<= 0 2)) (in_range21 temp___expr_1221)))
(define-fun dynamic_invariant24 ((temp___expr_1102 Int) (temp___is_init_1099 Bool) (temp___skip_constant_1100 Bool) (temp___do_toplevel_1101 Bool)) Bool (=> (or (= temp___is_init_1099 true) (<= 0 17408)) (in_range18 temp___expr_1102)))
(define-fun dynamic_invariant25 ((temp___expr_1136 Int) (temp___is_init_1133 Bool) (temp___skip_constant_1134 Bool) (temp___do_toplevel_1135 Bool)) Bool (=> (or (= temp___is_init_1133 true) (<= 0 1024)) (in_range20 temp___expr_1136)))
(assert true)
...
(define-fun dynamic_invariant26 ((temp___expr_556 Int) (temp___is_init_553 Bool) (temp___skip_constant_554 Bool) (temp___do_toplevel_555 Bool)) Bool (=> (or (= temp___is_init_553 true) (<= 1 150)) (in_range12 temp___expr_556)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_162 Tuple0)))
(define-fun dynamic_invariant27 ((temp___expr_598 Int) (temp___is_init_595 Bool) (temp___skip_constant_596 Bool) (temp___do_toplevel_597 Bool)) Bool (=> (or (= temp___is_init_595 true) (<= 1901 2099)) (in_range13 temp___expr_598)))
(define-fun dynamic_invariant28 ((temp___expr_604 Int) (temp___is_init_601 Bool) (temp___skip_constant_602 Bool) (temp___do_toplevel_603 Bool)) Bool (=> (or (= temp___is_init_601 true) (<= 1 12)) (in_range14 temp___expr_604)))
(define-fun dynamic_invariant29 ((temp___expr_610 Int) (temp___is_init_607 Bool) (temp___skip_constant_608 Bool) (temp___do_toplevel_609 Bool)) Bool (=> (or (= temp___is_init_607 true) (<= 1 31)) (in_range15 temp___expr_610)))
(define-fun dynamic_invariant30 ((temp___expr_634 Int) (temp___is_init_631 Bool) (temp___skip_constant_632 Bool) (temp___do_toplevel_633 Bool)) Bool (=> (or (= temp___is_init_631 true) (<= 0 86399999)) (in_range16 temp___expr_634)))
(define-fun dynamic_invariant31 ((temp___expr_1375 Int) (temp___is_init_1372 Bool) (temp___skip_constant_1373 Bool) (temp___do_toplevel_1374 Bool)) Bool (=> (or (= temp___is_init_1372 true) (<= 0 4294967295)) (in_range26 temp___expr_1375)))
...
(define-fun dynamic_invariant32 ((temp___expr_2711 Int) (temp___is_init_2708 Bool) (temp___skip_constant_2709 Bool) (temp___do_toplevel_2710 Bool)) Bool (=> (or (= temp___is_init_2708 true) (<= 0 2)) (in_range32 temp___expr_2711)))
(define-fun dynamic_invariant33 ((temp___expr_2127 Int) (temp___is_init_2124 Bool) (temp___skip_constant_2125 Bool) (temp___do_toplevel_2126 Bool)) Bool (=> (or (= temp___is_init_2124 true) (<= 0 2147483647)) (in_range30 temp___expr_2127)))
...
(declare-const thestats__split_fields us_split_fields26)
...
(declare-const thistisinfo__split_fields1 us_split_fields__ref5)
(declare-const tokenpresence2 int__ref)
(declare-const tokentry2 int__ref)
(declare-const tokenid2 int__ref)
(declare-const authcert__split_fields2 us_split_fields__ref9)
(declare-const idcert__split_fields2 us_split_fields__ref12)
(declare-const currentlatch2 int__ref)
(declare-const latchtimeout__split_fields1 us_split_fields__ref1)
(declare-const status6 int__ref)
(declare-const thestats__split_fields1 us_split_fields__ref13)
...
(declare-const state28 us_private__ref)
...
(declare-const state31 us_private__ref)
(declare-const state32 us_private__ref)
...
(assert (= (temp___String_Literal_162 Tuple0) nouser))
(assert (=> (<= 0 1) (in_range4 tokenpresence)))
(assert (=> (<= 0 2) (in_range10 tokentry)))
(assert (=> (<= 0 4294967295) (in_range9 tokenid)))
...
(assert (=> (<= 0 1) (in_range11 auditalarm)))
(assert (=> (<= 0 1) (in_range29 currentlatch)))
(assert (=> (<= 0 8) (in_range31 status)))
...
(assert (and (= o (privatekeypresent thistisinfo__split_fields (let ((subject state2)) state14))) (= (= o true) (= (rec__keystore__optionalprivatekeyt__ispresent thistisinfo__split_fields) true))))
(assert (and (= o1 (privatekeypresent thistisinfo__split_fields (let ((subject state2)) state14))) (= (= o1 true) (= (rec__keystore__optionalprivatekeyt__ispresent thistisinfo__split_fields) true))))
...
(assert (in_range29 currentlatch1))
...
(assert (and (and (and (not (= (isgood tokenpresence1 (let ((subject state3)) state21) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true)) (not (= (authcertvalid tokenpresence1 (let ((subject state3)) state21) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true))) (not (in_range8 (theauthcertrole tokenpresence1 (let ((subject state3)) state21) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1))))) (and (and (in_range4 tokenpresence1) (in_range10 tokentry1)) (in_range9 tokenid1))))
(assert (and (and (= (= (privatekeypresent thistisinfo__split_fields (let ((subject state2)) state14)) true) (not (= (enrolmentisinprogress status5 (let ((subject state11)) state22)) true))) (or (= (enrolmentisinprogress status5 (let ((subject state11)) state22)) true) (= (statusisenclavequiescent status5 (let ((subject state11)) state22)) true))) (in_range31 status5)))
(assert (and (= result (privatekeypresent thistisinfo__split_fields (let ((subject state2)) state14))) (= (= result true) (= (rec__keystore__optionalprivatekeyt__ispresent thistisinfo__split_fields) true))))
(assert (= result true))
