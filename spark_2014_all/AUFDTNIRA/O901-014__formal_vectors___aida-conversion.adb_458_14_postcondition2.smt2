...
(define-fun tint_arrayD1__ref___6__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___6__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t153b__ref (mk_t153b__ref (t153b__content us_t2)))))
...
(define-fun tnumber_array_typeD1__ref___6__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___6__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t156b__ref (mk_t156b__ref (t156b__content integer)))))
(define-fun t156b__ref___projection ((a t156b__ref)) integer (t156b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t157b__ref (mk_t157b__ref (t157b__content us_t4)))))
...
(declare-datatypes () ((t158b__ref (mk_t158b__ref (t158b__content integer)))))
(define-fun t158b__ref___projection ((a t158b__ref)) integer (t158b__content a))
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int Int Int Int) us_t2)
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__aggregate_def (Int Int Int) us_t4)
...
(define-fun tint_arrayB__ref___6__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
...
(assert (= (integerqtint rliteral3) 7))
(declare-const rliteral4 integer)
(assert (= (integerqtint rliteral4) 3))
(declare-const rliteral5 integer)
(assert (= (integerqtint rliteral5) 9))
(assert (forall ((temp___1470 Int) (temp___1471 Int) (temp___1472 Int) (temp___1473 Int) (temp___1474 Int) (temp___1475 Int) (temp___1476 Int) (temp___1477 Int) (temp___1478 Int) (temp___1479 Int) (temp___1480 Int) (temp___1481 Int)) (let ((temp___1469 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def temp___1470 temp___1471 temp___1472 temp___1473 temp___1474 temp___1475 temp___1476 temp___1477 temp___1478 temp___1479 temp___1480 temp___1481))) (=> (and (and (and (and (and (and (and (and (and (dynamic_invariant temp___1470 true true true true) (dynamic_invariant temp___1471 true true true true)) (dynamic_invariant temp___1472 true true true true)) (dynamic_invariant temp___1473 true true true true)) (dynamic_invariant temp___1474 true true true true)) (dynamic_invariant temp___1475 true true true true)) (dynamic_invariant temp___1476 true true true true)) (dynamic_invariant temp___1477 true true true true)) (dynamic_invariant temp___1478 true true true true)) (dynamic_invariant temp___1479 true true true true)) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1480 temp___1481) (and (= (first5 temp___1469) temp___1480) (= (last5 temp___1469) temp___1481))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1469) (+ (first1 source) 0)) rliteral) (= (select (to_array2 temp___1469) (+ (first1 source) 1)) rliteral1)) (= (select (to_array2 temp___1469) (+ (first1 source) 2)) rliteral2)) (= (select (to_array2 temp___1469) (+ (first1 source) 3)) rliteral3)) (= (select (to_array2 temp___1469) (+ (first1 source) 4)) rliteral4)) (= (select (to_array2 temp___1469) (+ (first1 source) 5)) rliteral5)) (= (select (to_array2 temp___1469) (+ (first1 source) 6)) rliteral5)) (= (select (to_array2 temp___1469) (+ (first1 source) 7)) rliteral5)) (= (select (to_array2 temp___1469) (+ (first1 source) 8)) rliteral5)) (= (select (to_array2 temp___1469) (+ (first1 source) 9)) rliteral5)))))))
(define-fun dynamic_invariant4 ((temp___expr_294 us_t3) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool) (temp___do_typ_inv_293 Bool)) Bool (=> (not (= temp___skip_constant_291 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_294) (last7 temp___expr_294)) (and (= (first7 temp___expr_294) (first1 source)) (= (last7 temp___expr_294) (+ (first1 source) 9))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___6__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-const rliteral6 integer)
(assert (= (integerqtint rliteral6) 0))
(assert (forall ((temp___1487 Int) (temp___1488 Int) (temp___1489 Int)) (let ((temp___1486 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__aggregate_def temp___1487 temp___1488 temp___1489))) (=> (dynamic_invariant temp___1487 true true true true) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1488 temp___1489) (and (= (first9 temp___1486) temp___1488) (= (last9 temp___1486) temp___1489))) (forall ((temp___1490 Int)) (= (select (to_array4 temp___1486) temp___1490) rliteral6)))))))
...
(declare-const temp___1484 (Array Int integer))
(declare-const temp___14841 t2)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume1 t1)
(declare-const temp___1492 (Array Int integer))
(declare-const temp___14921 t4)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume1 t3)
(declare-const temp___1495 Int)
(declare-const temp___1499 Int)
(declare-const temp___1497 (Array Int integer))
(declare-const o Int)
...
(assert (and (and (= (length source) 10) (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52))) (forall ((index9 Int)) (=> (and (<= (to_rep1 (first (rt source))) index9) (<= index9 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index9))) true)))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def 2 1 4 7 3 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def 2 1 4 7 3 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t2 temp___1484 temp___14841) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def 2 1 4 7 3 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___14841)) (to_rep1 (last4 temp___14841))) (+ (- (to_rep1 (last4 temp___14841)) (to_rep1 (first4 temp___14841))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1484 (to_rep1 (first4 temp___14841)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume))
(assert (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume1))))
...
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t4 temp___1492 temp___14921) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___14921)) (to_rep1 (last8 temp___14921))) (+ (- (to_rep1 (last8 temp___14921)) (to_rep1 (first8 temp___14921))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1492 (to_rep1 (first8 temp___14921)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume))
(assert (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume1))))
...
(assert (and (= temp___1495 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= temp___1499 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= temp___1497 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= o index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= o1 (select n1 o))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= o3 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= o7 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= n2 o8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt source))) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (and (and (forall ((temp___1498 Int)) (=> (and (<= (to_rep1 n__first) temp___1498) (<= temp___1498 (to_rep1 n__last))) (=> (or (< temp___1495 temp___1498) (or (< temp___1498 (to_rep1 (first (rt source)))) (< index2 temp___1498))) (= (select n3 temp___1498) (select temp___1497 temp___1498))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= index2 temp___1495)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= index2 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= n3 n4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= index4 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= n5 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= index6 index4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495)) (= n7 n5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1495))) (= n7 n1)))
...
(assert (and (= temp___1500 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1500) (<= temp___1500 (to_rep1 n__last))))
(assert (= o9 temp___1500))
(assert (= o10 (select (map__content1 n6) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= result4 (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 9))
(assert (and (= temp___1501 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1501) (<= temp___1501 (to_rep1 n__last))))
(assert (= o12 temp___1501))
...
(assert (= target2 o18))
(assert (<= target2 99))
(assert (and (= temp___1502 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1502) (<= temp___1502 (to_rep1 n__last))))
(assert (= o19 temp___1502))
...
(assert (= target3 o25))
(assert (<= target3 999))
(assert (and (= temp___1503 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___1503) (<= temp___1503 (to_rep1 n__last))))
(assert (= o26 temp___1503))
...
(assert (= target4 o32))
(assert (<= target4 9999))
(assert (and (= temp___1504 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___1504) (<= temp___1504 (to_rep1 n__last))))
(assert (= o33 temp___1504))
...
(assert (and (= temp___1505 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___1505) (<= temp___1505 (to_rep1 n__last))))
(assert (= o40 temp___1505))
