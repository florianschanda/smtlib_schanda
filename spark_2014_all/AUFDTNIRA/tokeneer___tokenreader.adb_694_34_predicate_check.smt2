...
(assert (forall ((x logentrycountt)) (! (in_range8 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun bool_eq4 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep3 (select a temp___idx_153)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_153))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep3 (select a temp___idx_153)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
...
(assert (forall ((x logfilecountt)) (! (in_range9 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x fileentrycountt)) (! (in_range10 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(define-fun bool_eq6 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep6 (select a temp___idx_154)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep6 (select a temp___idx_154)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_154)))))))))))
...
(assert (forall ((temp___1219 Int)) (forall ((temp___1220 Int)) (= (select (temp___1217 temp___1219) temp___1220) (of_rep3 temp___1219)))))
(declare-fun temp___1221 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1223 Int)) (forall ((temp___1224 Int)) (= (select (temp___1221 temp___1223) temp___1224) (of_rep6 temp___1223)))))
(define-fun dynamic_invariant3 ((temp___expr_1211 us_rep1) (temp___is_init_1208 Bool) (temp___skip_constant_1209 Bool) (temp___do_toplevel_1210 Bool)) Bool (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1211))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1211))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1211)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1211))) true))
(define-fun default_initial_assumption ((temp___expr_1215 us_rep1) (temp___skip_top_level_1216 Bool)) Bool (and (and (and (= (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1215))) 1) (= (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1215))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1215)) (mk___rep (mk___split_fields (temp___1217 1) (of_rep3 1) (of_rep3 1) (of_rep5 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1215)) (temp___1221 0))))
(define-fun type_invariant ((temp___1225 us_rep1)) Bool (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1225))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1225))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1225)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1225))) true))
...
(assert (forall ((x filestatust)) (! (in_range11 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(define-fun bool_eq10 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep7 (select a temp___idx_156)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_156))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep7 (select a temp___idx_156)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_156)))))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_1377 Int) (temp___is_init_1374 Bool) (temp___skip_constant_1375 Bool) (temp___do_toplevel_1376 Bool)) Bool (=> (or (= temp___is_init_1374 true) (<= 0 1)) (in_range12 temp___expr_1377)))
...
(declare-const reader Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-sort readerstatet 0)
(define-fun in_range17 ((x Int)) Bool (and (<= 0 x) (<= x 6)))
...
(declare-fun user_eq26 (readerstatet readerstatet) Bool)
(declare-const dummy26 readerstatet)
(declare-datatypes () ((readerstatet__ref (mk_readerstatet__ref (readerstatet__content readerstatet)))))
(define-fun readerstatet__ref___projection ((a readerstatet__ref)) readerstatet (readerstatet__content a))
(define-fun dynamic_invariant5 ((temp___expr_1476 Int) (temp___is_init_1473 Bool) (temp___skip_constant_1474 Bool) (temp___do_toplevel_1475 Bool)) Bool (=> (or (= temp___is_init_1473 true) (<= 0 6)) (in_range17 temp___expr_1476)))
(declare-fun getreaderstate (Int) Int)
(declare-fun getreaderstate__function_guard (Int Int) Bool)
(assert (forall ((readerstate Int)) (! (=> (dynamic_invariant readerstate true true true) (dynamic_invariant5 (getreaderstate readerstate) true false true)) :pattern ((getreaderstate readerstate)))))
(assert (forall ((readerstate Int)) (! (=> (dynamic_invariant readerstate true true true) (= (getreaderstate readerstate) (ite (and (<= 0 readerstate) (<= readerstate 6)) readerstate 0))) :pattern ((getreaderstate readerstate)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1623 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 3)) 107)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 7)) 82)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 8)) 101)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 10)) 100)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 14)) 115)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 15)) 116)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 16)) 97)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 17)) 116)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 18)) 117)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 19)) 115)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 21)) 99)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 22)) 104)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 24)) 110)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 25)) 103)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 28)) 102)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 29)) 97)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 30)) 105)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 31)) 108)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 32)) 117)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 34)) 101)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 36)) 58)) (= (to_rep (select (temp___String_Literal_1623 us_void_param) 37)) 32)) :pattern ((temp___String_Literal_1623 us_void_param)))))
...
(define-fun dynamic_invariant19 ((temp___expr_1482 Int) (temp___is_init_1479 Bool) (temp___skip_constant_1480 Bool) (temp___do_toplevel_1481 Bool)) Bool (=> (or (= temp___is_init_1479 true) (<= 1 6)) (in_range16 temp___expr_1482)))
(define-fun dynamic_invariant20 ((temp___expr_1423 Int) (temp___is_init_1420 Bool) (temp___skip_constant_1421 Bool) (temp___do_toplevel_1422 Bool)) Bool (=> (or (= temp___is_init_1420 true) (<= 0 4294967295)) (in_range15 temp___expr_1423)))
...
(declare-const rawnewstate Int)
(declare-const newstate Int)
(declare-const o Int)
(declare-const o1 Int)
(declare-const temp___1624 (Array Int character))
(declare-const temp___16241 t1)
...
(assert (=> (<= 0 6) (in_range17 newstate)))
(assert (and (in_range4 rawnewstate1) (in_range4 responsecode1)))
(assert (not (= responsecode1 0)))
(assert (not (= responsecode1 7)))
(assert (not (= (to_rep2 (rec__tokenreader__readerinfot__lastfault (us_split_fields5 (select readerstatus reader)))) responsecode1)))
(assert (dynamic_property1 1 2147483647 1 37))
(assert (= (temp___String_Literal_1623 Tuple0) temp___1624))
(assert (= (mk1 1 37) temp___16241))
(assert (not (dynamic_predicate (mk___t1 temp___1624 temp___16241))))
(check-sat)
(exit)
