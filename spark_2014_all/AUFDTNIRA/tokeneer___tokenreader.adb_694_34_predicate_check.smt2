...
(define-fun dynamic_invariant3 ((temp___expr_1361 us_rep1) (temp___is_init_1357 Bool) (temp___skip_constant_1358 Bool) (temp___do_toplevel_1359 Bool) (temp___do_typ_inv_1360 Bool)) Bool (=> (= temp___do_typ_inv_1360 true) (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1361))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1361))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1361)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1361))) true)))
(define-fun default_initial_assumption ((temp___expr_1365 us_rep1) (temp___skip_top_level_1366 Bool)) Bool (and (and (and (= (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1365))) 1) (= (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1365))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1365)) (mk___rep (mk___split_fields (temp___1367 1) (of_rep3 1) (of_rep3 1) (of_rep5 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1365)) (temp___1371 0))))
(define-fun type_invariant ((temp___1375 us_rep1)) Bool (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1375))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1375))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1375)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1375))) true))
...
(define-fun bool_eq10 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep7 (select a temp___idx_178)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_178))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep7 (select a temp___idx_178)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_178)))))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_1540 Int) (temp___is_init_1536 Bool) (temp___skip_constant_1537 Bool) (temp___do_toplevel_1538 Bool) (temp___do_typ_inv_1539 Bool)) Bool (=> (or (= temp___is_init_1536 true) (<= 0 1)) (in_range12 temp___expr_1540)))
...
(define-fun dynamic_invariant5 ((temp___expr_1647 Int) (temp___is_init_1643 Bool) (temp___skip_constant_1644 Bool) (temp___do_toplevel_1645 Bool) (temp___do_typ_inv_1646 Bool)) Bool (=> (or (= temp___is_init_1643 true) (<= 0 6)) (in_range17 temp___expr_1647)))
(declare-fun getreaderstate (Int) Int)
(declare-fun getreaderstate__function_guard (Int Int) Bool)
(assert (forall ((readerstate Int)) (! (=> (dynamic_invariant readerstate true true true true) (dynamic_invariant5 (getreaderstate readerstate) true false true true)) :pattern ((getreaderstate readerstate)))))
(assert (forall ((readerstate Int)) (! (=> (dynamic_invariant readerstate true true true true) (= (getreaderstate readerstate) (ite (and (<= 0 readerstate) (<= readerstate 6)) readerstate 0))) :pattern ((getreaderstate readerstate)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1799 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 3)) 107)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 7)) 82)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 8)) 101)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 10)) 100)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 14)) 115)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 15)) 116)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 16)) 97)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 17)) 116)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 18)) 117)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 19)) 115)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 21)) 99)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 22)) 104)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 24)) 110)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 25)) 103)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 28)) 102)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 29)) 97)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 30)) 105)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 31)) 108)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 32)) 117)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 34)) 101)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 36)) 58)) (= (to_rep (select (temp___String_Literal_1799 us_void_param) 37)) 32)) :pattern ((temp___String_Literal_1799 us_void_param)))))
...
(assert (forall ((temp___1373 Int)) (=> (dynamic_invariant14 temp___1373 true true true true) (forall ((temp___1374 Int)) (= (to_rep6 (select (temp___1371 temp___1373) temp___1374)) temp___1373)))))
...
(define-fun dynamic_invariant19 ((temp___expr_1654 Int) (temp___is_init_1650 Bool) (temp___skip_constant_1651 Bool) (temp___do_toplevel_1652 Bool) (temp___do_typ_inv_1653 Bool)) Bool (=> (or (= temp___is_init_1650 true) (<= 1 6)) (in_range16 temp___expr_1654)))
(define-fun dynamic_invariant20 ((temp___expr_1587 Int) (temp___is_init_1583 Bool) (temp___skip_constant_1584 Bool) (temp___do_toplevel_1585 Bool) (temp___do_typ_inv_1586 Bool)) Bool (=> (or (= temp___is_init_1583 true) (<= 0 4294967295)) (in_range15 temp___expr_1587)))
(assert (forall ((temp___1369 Int)) (=> (dynamic_invariant11 temp___1369 true true true true) (forall ((temp___1370 Int)) (= (to_rep3 (select (temp___1367 temp___1369) temp___1370)) temp___1369)))))
...
(declare-const temp___1800 (Array Int character))
(declare-const temp___18001 t1)
...
(assert (= (temp___String_Literal_1799 Tuple0) temp___1800))
(assert (= (mk1 1 37) temp___18001))
(assert (not (dynamic_predicate (mk___t1 temp___1800 temp___18001))))
(check-sat)
(exit)
