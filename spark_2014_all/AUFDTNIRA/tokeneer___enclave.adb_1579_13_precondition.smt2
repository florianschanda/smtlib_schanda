...
(assert (= localstatus1 1))
(assert (not (not (= (privatekeypresent (mk___split_fields1 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) state) true))))
(check-sat)
(exit)
