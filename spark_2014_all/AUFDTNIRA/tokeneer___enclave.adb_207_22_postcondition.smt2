...
(define-fun dynamic_invariant ((temp___expr_446 Int) (temp___is_init_443 Bool) (temp___skip_constant_444 Bool) (temp___do_toplevel_445 Bool)) Bool (=> (or (= temp___is_init_443 true) (<= 0 1)) (in_range4 temp___expr_446)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_159 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_159 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 4)) 115)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 29)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_159 us_void_param) 50)) 32)) :pattern ((temp___String_Literal_159 us_void_param)))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (to_rep5 (select a temp___idx_174)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_174)))))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq5 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep5 (select a (+ i 1))) (to_rep5 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq5 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep5 (select b (+ i 1))) (to_rep5 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(define-fun us_rep___11__projection ((a us_rep2)) us_split_fields2 (us_split_fields3 a))
(define-fun bool_eq6 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 a))) (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 b)))) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 a))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 b))))) (= (bool_eq4 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 b))) true)) (= (bool_eq5 (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 b)) 1 17) true)) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_1139 us_rep2) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1139))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1139))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1139)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1139))) true))
(define-fun default_initial_assumption ((temp___expr_1143 us_rep2) (temp___skip_top_level_1144 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1143))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1143))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1143)) (mk___rep (mk___split_fields (temp___1145 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1143)) (temp___1149 0))))
(define-fun type_invariant ((temp___1153 us_rep2)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1153))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1153))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1153)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1153))) true))
...
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (bool_eq2 (select a temp___idx_175) (select b (+ (- b__first a__first) temp___idx_175))) true))))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep6 (select a temp___idx_176)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
...
(define-fun bool_eq10 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields7 a)) (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields7 b))) (= (bool_eq9 (rec__keystore__optionalprivatekeyt__owner (us_split_fields7 a)) (rec__keystore__optionalprivatekeyt__owner (us_split_fields7 b))) true)) true false))
...
(define-fun in_range13 ((x Int)) Bool (and (<= 0 x) (<= x 8)))
(declare-fun attr__ATTRIBUTE_IMAGE13 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check13 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE13 (us_image) Int)
(declare-fun user_eq21 (statust1 statust1) Bool)
(declare-const dummy21 statust1)
...
(define-fun dynamic_invariant2 ((temp___expr_2612 Int) (temp___is_init_2609 Bool) (temp___skip_constant_2610 Bool) (temp___do_toplevel_2611 Bool)) Bool (=> (or (= temp___is_init_2609 true) (<= 0 8)) (in_range13 temp___expr_2612)))
...
(define-fun dynamic_invariant7 ((temp___expr_924 Int) (temp___is_init_921 Bool) (temp___skip_constant_922 Bool) (temp___do_toplevel_923 Bool)) Bool (=> (or (= temp___is_init_921 true) (<= 0 40)) (in_range11 temp___expr_924)))
(define-fun dynamic_invariant8 ((temp___expr_945 Int) (temp___is_init_942 Bool) (temp___skip_constant_943 Bool) (temp___do_toplevel_944 Bool)) Bool (=> (or (= temp___is_init_942 true) (<= 0 4294967295)) (in_range12 temp___expr_945)))
(define-fun dynamic_invariant9 ((temp___expr_1105 Int) (temp___is_init_1102 Bool) (temp___skip_constant_1103 Bool) (temp___do_toplevel_1104 Bool)) Bool (=> (or (= temp___is_init_1102 true) (<= 0 17)) (in_range8 temp___expr_1105)))
(define-fun dynamic_invariant10 ((temp___expr_1084 Int) (temp___is_init_1081 Bool) (temp___skip_constant_1082 Bool) (temp___do_toplevel_1083 Bool)) Bool (=> (or (= temp___is_init_1081 true) (<= 1 17)) (in_range6 temp___expr_1084)))
(define-fun dynamic_invariant11 ((temp___expr_1209 Int) (temp___is_init_1206 Bool) (temp___skip_constant_1207 Bool) (temp___do_toplevel_1208 Bool)) Bool (=> (or (= temp___is_init_1206 true) (<= 0 2)) (in_range10 temp___expr_1209)))
(define-fun dynamic_invariant12 ((temp___expr_1090 Int) (temp___is_init_1087 Bool) (temp___skip_constant_1088 Bool) (temp___do_toplevel_1089 Bool)) Bool (=> (or (= temp___is_init_1087 true) (<= 0 17408)) (in_range7 temp___expr_1090)))
(define-fun dynamic_invariant13 ((temp___expr_1124 Int) (temp___is_init_1121 Bool) (temp___skip_constant_1122 Bool) (temp___do_toplevel_1123 Bool)) Bool (=> (or (= temp___is_init_1121 true) (<= 0 1024)) (in_range9 temp___expr_1124)))
(assert true)
...
(define-fun dynamic_invariant14 ((temp___expr_468 Int) (temp___is_init_465 Bool) (temp___skip_constant_466 Bool) (temp___do_toplevel_467 Bool)) Bool (=> (or (= temp___is_init_465 true) (<= 1 150)) (in_range5 temp___expr_468)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_159 Tuple0)))
...
(declare-const thecurrentfloppy2 us_rep)
...
(declare-const thistisinfo__split_fields5 us_split_fields__ref3)
(declare-const status3 int__ref)
(declare-const thecurrentfloppy3 t__ref)
(declare-const dataok1 bool__ref)
(declare-const description1 map__ref)
...
(declare-const thecurrentfloppy4 us_rep)
...
(assert (= (temp___String_Literal_159 Tuple0) nouser))
(assert (=> (<= 0 8) (in_range13 status)))
...
(assert (not (= (privatekeypresent (mk___split_fields3 thistisinfo__split_fields (mk___rep2 (mk___split_fields2 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) state) true)))
(assert (and (and (and (= o (currentfloppy (us_private__content state1))) (and (= result (mk_t__ref thecurrentfloppy)) (= thecurrentfloppy1 o))) (and (and (= (= dataok true) (= (privatekeypresent thistisinfo__split_fields4 state3) true)) (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true) (in_range4 auditalarm1))) (ite (= dataok true) (and (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range4 auditalarm2)) (and (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range4 auditalarm3)) (and (and (= result1 (mk_int__ref status)) (= status1 3)) (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true) (in_range4 auditalarm4))))) (and (and (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true) (in_range4 auditalarm5)) (and (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields12)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields12)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields12)) true) (in_range4 auditalarm6)) (and (and (= result2 (mk_int__ref status)) (= status2 2)) (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields13)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields13)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields13)) true) (in_range4 auditalarm7))))) (and (and (= (let ((subject state2)) (mk___private__ref state4)) (let ((subject state2)) (mk___private__ref state7))) (and (= state5 state8) (and (= state6 state9) (and (= filestate filestate1) (and (= status1 status2) (and (= auditsystemfault auditsystemfault1) (and (= auditalarm4 auditalarm7) (and (= logfilestate__split_fields10 logfilestate__split_fields13) (and (= logfilesstatus logfilesstatus1) (= logfiles logfiles1)))))))))) (and (= state4 state7) (and (= state5 state8) (and (= state6 state9) (and (= filestate filestate1) (and (= status1 status2) (and (= auditsystemfault auditsystemfault1) (and (= auditalarm4 auditalarm7) (and (= logfilestate__split_fields10 logfilestate__split_fields13) (and (= logfilesstatus logfilesstatus1) (= logfiles logfiles1))))))))))))))) (and (and (= state13 (let ((subject state2)) (mk___private__ref state4))) (and (= state12 (mk___private__ref state5)) (and (= store2 (mk___private__ref store1)) (and (= state11 (mk___private__ref state3)) (and (= state10 (mk___private__ref state6)) (and (= filestate2 (mk___private__ref filestate)) (and (= description1 (mk_map__ref description)) (and (= dataok1 (mk_bool__ref dataok)) (and (= thecurrentfloppy3 (mk_t__ref thecurrentfloppy2)) (and (= status3 (mk_int__ref status1)) (and (= thistisinfo__split_fields5 (mk___split_fields__ref3 thistisinfo__split_fields4)) (and (= auditsystemfault2 (mk_bool__ref auditsystemfault)) (and (= auditalarm8 (mk_int__ref auditalarm4)) (and (= logfilestate__split_fields14 (mk___split_fields__ref1 logfilestate__split_fields10)) (and (= logfilesstatus2 (mk_map__ref4 logfilesstatus)) (= logfiles2 (mk_map__ref3 logfiles))))))))))))))))) (and (= state17 state4) (and (= state16 state5) (and (= store3 store1) (and (= state15 state3) (and (= state14 state6) (and (= filestate3 filestate) (and (= description2 description) (and (= dataok2 dataok) (and (= thecurrentfloppy4 thecurrentfloppy2) (and (= status4 status1) (and (= thistisinfo__split_fields6 thistisinfo__split_fields4) (and (= auditsystemfault3 auditsystemfault) (and (= auditalarm9 auditalarm4) (and (= logfilestate__split_fields15 logfilestate__split_fields10) (and (= logfilesstatus3 logfilesstatus) (= logfiles3 logfiles)))))))))))))))))))
(assert (not (or (and (= (int__content status3) 3) (= (privatekeypresent (us_split_fields__content3 thistisinfo__split_fields5) (us_private__content state11)) true)) (and (= (int__content status3) 2) (not (= (privatekeypresent (us_split_fields__content3 thistisinfo__split_fields5) (us_private__content state11)) true))))))
(check-sat)
(exit)
