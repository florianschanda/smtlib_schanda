...
(define-fun dynamic_invariant ((temp___expr_492 Int) (temp___is_init_489 Bool) (temp___skip_constant_490 Bool) (temp___do_toplevel_491 Bool)) Bool (=> (or (= temp___is_init_489 true) (<= 0 1)) (in_range4 temp___expr_492)))
...
(define-fun dynamic_invariant1 ((temp___expr_1197 us_rep2) (temp___is_init_1194 Bool) (temp___skip_constant_1195 Bool) (temp___do_toplevel_1196 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1197))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1197))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1197)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1197))) true))
(define-fun default_initial_assumption ((temp___expr_1201 us_rep2) (temp___skip_top_level_1202 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1201))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1201))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1201)) (mk___rep (mk___split_fields (temp___1203 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1201)) (temp___1207 0))))
(define-fun type_invariant ((temp___1211 us_rep2)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1211))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1211))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1211)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1211))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_2670 Int) (temp___is_init_2667 Bool) (temp___skip_constant_2668 Bool) (temp___do_toplevel_2669 Bool)) Bool (=> (or (= temp___is_init_2667 true) (<= 0 8)) (in_range13 temp___expr_2670)))
...
(define-fun dynamic_invariant7 ((temp___expr_978 Int) (temp___is_init_975 Bool) (temp___skip_constant_976 Bool) (temp___do_toplevel_977 Bool)) Bool (=> (or (= temp___is_init_975 true) (<= 0 40)) (in_range11 temp___expr_978)))
(define-fun dynamic_invariant8 ((temp___expr_999 Int) (temp___is_init_996 Bool) (temp___skip_constant_997 Bool) (temp___do_toplevel_998 Bool)) Bool (=> (or (= temp___is_init_996 true) (<= 0 4294967295)) (in_range12 temp___expr_999)))
(define-fun dynamic_invariant9 ((temp___expr_1163 Int) (temp___is_init_1160 Bool) (temp___skip_constant_1161 Bool) (temp___do_toplevel_1162 Bool)) Bool (=> (or (= temp___is_init_1160 true) (<= 0 17)) (in_range8 temp___expr_1163)))
(define-fun dynamic_invariant10 ((temp___expr_1142 Int) (temp___is_init_1139 Bool) (temp___skip_constant_1140 Bool) (temp___do_toplevel_1141 Bool)) Bool (=> (or (= temp___is_init_1139 true) (<= 1 17)) (in_range6 temp___expr_1142)))
(define-fun dynamic_invariant11 ((temp___expr_1267 Int) (temp___is_init_1264 Bool) (temp___skip_constant_1265 Bool) (temp___do_toplevel_1266 Bool)) Bool (=> (or (= temp___is_init_1264 true) (<= 0 2)) (in_range10 temp___expr_1267)))
(define-fun dynamic_invariant12 ((temp___expr_1148 Int) (temp___is_init_1145 Bool) (temp___skip_constant_1146 Bool) (temp___do_toplevel_1147 Bool)) Bool (=> (or (= temp___is_init_1145 true) (<= 0 17408)) (in_range7 temp___expr_1148)))
(define-fun dynamic_invariant13 ((temp___expr_1182 Int) (temp___is_init_1179 Bool) (temp___skip_constant_1180 Bool) (temp___do_toplevel_1181 Bool)) Bool (=> (or (= temp___is_init_1179 true) (<= 0 1024)) (in_range9 temp___expr_1182)))
(assert true)
...
(define-fun dynamic_invariant14 ((temp___expr_514 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 1 150)) (in_range5 temp___expr_514)))
...
(assert (and (and (and (= o (currentfloppy (us_private__content state1))) (and (= result (mk_t__ref thecurrentfloppy)) (= thecurrentfloppy1 o))) (and (and (= (= dataok true) (= (privatekeypresent thistisinfo__split_fields4 state3) true)) (and (in_range4 auditalarm1) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true))) (ite (= dataok true) (and (and (in_range4 auditalarm2) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true)) (and (and (in_range4 auditalarm3) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true)) (and (and (= result1 (mk_int__ref status)) (= status1 3)) (and (in_range4 auditalarm4) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true))))) (and (and (and (in_range4 auditalarm5) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true)) (and (and (in_range4 auditalarm6) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields12)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields12)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields12)) true)) (and (and (= result2 (mk_int__ref status)) (= status2 2)) (and (in_range4 auditalarm7) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields13)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields13)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields13)) true))))) (and (and (= (let ((subject state2)) (mk___private__ref state4)) (let ((subject state2)) (mk___private__ref state7))) (and (= state5 state8) (and (= state6 state9) (and (= filestate filestate1) (and (= status1 status2) (and (= auditsystemfault auditsystemfault1) (and (= auditalarm4 auditalarm7) (and (= logfilestate__split_fields10 logfilestate__split_fields13) (and (= logfilesstatus logfilesstatus1) (= logfiles logfiles1)))))))))) (and (= state4 state7) (and (= state5 state8) (and (= state6 state9) (and (= filestate filestate1) (and (= status1 status2) (and (= auditsystemfault auditsystemfault1) (and (= auditalarm4 auditalarm7) (and (= logfilestate__split_fields10 logfilestate__split_fields13) (and (= logfilesstatus logfilesstatus1) (= logfiles logfiles1))))))))))))))) (and (and (= state13 (let ((subject state2)) (mk___private__ref state4))) (and (= state12 (mk___private__ref state5)) (and (= store2 (mk___private__ref store1)) (and (= state11 (mk___private__ref state3)) (and (= state10 (mk___private__ref state6)) (and (= filestate2 (mk___private__ref filestate)) (and (= description1 (mk_map__ref description)) (and (= dataok1 (mk_bool__ref dataok)) (and (= thecurrentfloppy3 (mk_t__ref thecurrentfloppy2)) (and (= status3 (mk_int__ref status1)) (and (= thistisinfo__split_fields5 (mk___split_fields__ref3 thistisinfo__split_fields4)) (and (= auditsystemfault2 (mk_bool__ref auditsystemfault)) (and (= auditalarm8 (mk_int__ref auditalarm4)) (and (= logfilestate__split_fields14 (mk___split_fields__ref1 logfilestate__split_fields10)) (and (= logfilesstatus2 (mk_map__ref4 logfilesstatus)) (= logfiles2 (mk_map__ref3 logfiles))))))))))))))))) (and (= state17 state4) (and (= state16 state5) (and (= store3 store1) (and (= state15 state3) (and (= state14 state6) (and (= filestate3 filestate) (and (= description2 description) (and (= dataok2 dataok) (and (= thecurrentfloppy4 thecurrentfloppy2) (and (= status4 status1) (and (= thistisinfo__split_fields6 thistisinfo__split_fields4) (and (= auditsystemfault3 auditsystemfault) (and (= auditalarm9 auditalarm4) (and (= logfilestate__split_fields15 logfilestate__split_fields10) (and (= logfilesstatus3 logfilesstatus) (= logfiles3 logfiles)))))))))))))))))))
