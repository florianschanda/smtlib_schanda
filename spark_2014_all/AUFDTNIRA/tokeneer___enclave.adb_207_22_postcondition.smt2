...
(define-fun dynamic_invariant ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range4 temp___expr_548)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_181 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_181 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 3)) 85)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 4)) 115)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 19)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 29)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 34)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 39)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 41)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 44)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 49)) 32)) (= (to_rep (select (temp___String_Literal_181 us_void_param) 50)) 32)) :pattern ((temp___String_Literal_181 us_void_param)))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep5 (select a temp___idx_196)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
...
(define-fun dynamic_invariant1 ((temp___expr_1345 us_rep2) (temp___is_init_1341 Bool) (temp___skip_constant_1342 Bool) (temp___do_toplevel_1343 Bool) (temp___do_typ_inv_1344 Bool)) Bool (=> (= temp___do_typ_inv_1344 true) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1345))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1345))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1345)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1345))) true)))
(define-fun default_initial_assumption ((temp___expr_1349 us_rep2) (temp___skip_top_level_1350 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1349))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1349))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1349)) (mk___rep (mk___split_fields (temp___1351 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1349)) (temp___1355 0))))
(define-fun type_invariant ((temp___1359 us_rep2)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1359))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1359))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1359)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1359))) true))
...
(define-fun bool_eq7 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq2 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq2 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_2874 Int) (temp___is_init_2870 Bool) (temp___skip_constant_2871 Bool) (temp___do_toplevel_2872 Bool) (temp___do_typ_inv_2873 Bool)) Bool (=> (or (= temp___is_init_2870 true) (<= 0 8)) (in_range13 temp___expr_2874)))
...
(define-fun dynamic_invariant7 ((temp___expr_1099 Int) (temp___is_init_1095 Bool) (temp___skip_constant_1096 Bool) (temp___do_toplevel_1097 Bool) (temp___do_typ_inv_1098 Bool)) Bool (=> (or (= temp___is_init_1095 true) (<= 0 40)) (in_range11 temp___expr_1099)))
(define-fun dynamic_invariant8 ((temp___expr_1123 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool) (temp___do_typ_inv_1122 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 4294967295)) (in_range12 temp___expr_1123)))
(define-fun dynamic_invariant9 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 0 17)) (in_range8 temp___expr_1283)))
(define-fun dynamic_invariant10 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 1 17)) (in_range6 temp___expr_1290)))
(define-fun dynamic_invariant11 ((temp___expr_1416 Int) (temp___is_init_1412 Bool) (temp___skip_constant_1413 Bool) (temp___do_toplevel_1414 Bool) (temp___do_typ_inv_1415 Bool)) Bool (=> (or (= temp___is_init_1412 true) (<= 0 2)) (in_range10 temp___expr_1416)))
(define-fun dynamic_invariant12 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 17408)) (in_range7 temp___expr_1297)))
(define-fun dynamic_invariant13 ((temp___expr_1328 Int) (temp___is_init_1324 Bool) (temp___skip_constant_1325 Bool) (temp___do_toplevel_1326 Bool) (temp___do_typ_inv_1327 Bool)) Bool (=> (or (= temp___is_init_1324 true) (<= 0 1024)) (in_range9 temp___expr_1328)))
(assert true)
...
(assert (forall ((temp___1357 Int)) (=> (dynamic_invariant13 temp___1357 true true true true) (forall ((temp___1358 Int)) (= (to_rep5 (select (temp___1355 temp___1357) temp___1358)) temp___1357)))))
(define-fun dynamic_invariant14 ((temp___expr_573 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool) (temp___do_typ_inv_572 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 150)) (in_range5 temp___expr_573)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___179 Int)) (=> (dynamic_invariant4 temp___179 true true true true) (forall ((temp___180 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___179) temp___180)) temp___179)))))
(assert (= nouser (temp___String_Literal_181 Tuple0)))
(assert (forall ((temp___1353 Int)) (=> (dynamic_invariant10 temp___1353 true true true true) (forall ((temp___1354 Int)) (= (to_rep2 (select (temp___1351 temp___1353) temp___1354)) temp___1353)))))
...
(define-fun status5 () int__ref (mk_int__ref status))
(assert (= (audittypes__nodescription__aggregate_def 32) nodescription))
(assert (= (temp___String_Literal_181 Tuple0) nouser))
...
(assert (= o (currentfloppy (us_private__content state1))))
(assert (= result (mk_t__ref thecurrentfloppy)))
(assert (= thecurrentfloppy1 o))
(assert (and (= (= dataok true) (= (privatekeypresent thistisinfo__split_fields4 state3) true)) (and (in_range4 auditalarm1) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true))))
(assert (=> (= dataok true) (and (in_range4 auditalarm2) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true))))
(assert (=> (= dataok true) (and (in_range4 auditalarm3) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true))))
(assert (=> (= dataok true) (= result1 status5)))
(assert (=> (= dataok true) (= status1 3)))
(assert (=> (= dataok true) (and (in_range4 auditalarm4) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true))))
(assert (=> (not (= dataok true)) (and (in_range4 auditalarm5) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true))))
(assert (=> (not (= dataok true)) (and (in_range4 auditalarm6) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields12)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields12)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields12)) true))))
(assert (=> (not (= dataok true)) (= result2 status5)))
(assert (=> (not (= dataok true)) (= status2 2)))
(assert (=> (not (= dataok true)) (and (in_range4 auditalarm7) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields13)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields13)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields13)) true))))
(assert (=> (not (= dataok true)) (= (let ((subject state2)) (mk___private__ref state4)) (let ((subject state2)) (mk___private__ref state7)))))
(assert (=> (not (= dataok true)) (= state5 state8)))
(assert (=> (not (= dataok true)) (= state6 state9)))
(assert (=> (not (= dataok true)) (= filestate filestate1)))
(assert (=> (not (= dataok true)) (= status1 status2)))
(assert (=> (not (= dataok true)) (= auditsystemfault auditsystemfault1)))
(assert (=> (not (= dataok true)) (= auditalarm4 auditalarm7)))
(assert (=> (not (= dataok true)) (= logfilestate__split_fields10 logfilestate__split_fields13)))
(assert (=> (not (= dataok true)) (= logfilesstatus logfilesstatus1)))
(assert (=> (not (= dataok true)) (= logfiles logfiles1)))
(assert (=> (not (= dataok true)) (= state4 state7)))
(assert (=> (not (= dataok true)) (= state5 state8)))
(assert (=> (not (= dataok true)) (= state6 state9)))
(assert (=> (not (= dataok true)) (= filestate filestate1)))
(assert (=> (not (= dataok true)) (= status1 status2)))
...
(assert (=> (not (= dataok true)) (= logfilesstatus logfilesstatus1)))
(assert (=> (not (= dataok true)) (= logfiles logfiles1)))
(assert (= state13 (let ((subject state2)) (mk___private__ref state4))))
(assert (= state12 (mk___private__ref state5)))
(assert (= store2 (mk___private__ref store1)))
(assert (= state11 (mk___private__ref state3)))
(assert (= state10 (mk___private__ref state6)))
(assert (= filestate2 (mk___private__ref filestate)))
(assert (= description1 (mk_map__ref description)))
(assert (= dataok1 (mk_bool__ref dataok)))
(assert (= thecurrentfloppy3 (mk_t__ref thecurrentfloppy2)))
(assert (= status3 (mk_int__ref status1)))
(assert (= thistisinfo__split_fields5 (mk___split_fields__ref3 thistisinfo__split_fields4)))
(assert (= auditsystemfault2 (mk_bool__ref auditsystemfault)))
(assert (= auditalarm8 (mk_int__ref auditalarm4)))
(assert (= logfilestate__split_fields14 (mk___split_fields__ref1 logfilestate__split_fields10)))
(assert (= logfilesstatus2 (mk_map__ref4 logfilesstatus)))
(assert (= logfiles2 (mk_map__ref3 logfiles)))
(assert (= state17 state4))
(assert (= state16 state5))
(assert (= store3 store1))
(assert (= state15 state3))
(assert (= state14 state6))
(assert (= filestate3 filestate))
(assert (= description2 description))
(assert (= dataok2 dataok))
(assert (= thecurrentfloppy4 thecurrentfloppy2))
(assert (= status4 status1))
(assert (= thistisinfo__split_fields6 thistisinfo__split_fields4))
(assert (= auditsystemfault3 auditsystemfault))
(assert (= auditalarm9 auditalarm4))
(assert (= logfilestate__split_fields15 logfilestate__split_fields10))
