...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep6 (select a temp___idx_196)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
...
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq2 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true))))))))
...
(define-fun dynamic_invariant ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range9 temp___expr_548)))
...
(declare-fun user_eq15 (namecountt namecountt) Bool)
(declare-const dummy15 namecountt)
...
(declare-fun user_eq17 (issueridt issueridt) Bool)
(declare-const dummy17 issueridt)
...
(declare-fun user_eq20 (descriptioni descriptioni) Bool)
(declare-const dummy20 descriptioni)
...
(define-fun dynamic_invariant2 ((temp___expr_2867 Int) (temp___is_init_2863 Bool) (temp___skip_constant_2864 Bool) (temp___do_toplevel_2865 Bool) (temp___do_typ_inv_2866 Bool)) Bool (=> (or (= temp___is_init_2863 true) (<= 0 8)) (in_range13 temp___expr_2867)))
...
(define-fun dynamic_invariant7 ((temp___expr_1092 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool) (temp___do_typ_inv_1091 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 40)) (in_range10 temp___expr_1092)))
(define-fun dynamic_invariant8 ((temp___expr_1116 Int) (temp___is_init_1112 Bool) (temp___skip_constant_1113 Bool) (temp___do_toplevel_1114 Bool) (temp___do_typ_inv_1115 Bool)) Bool (=> (or (= temp___is_init_1112 true) (<= 0 4294967295)) (in_range11 temp___expr_1116)))
(define-fun dynamic_invariant9 ((temp___expr_1276 Int) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (or (= temp___is_init_1272 true) (<= 0 17)) (in_range7 temp___expr_1276)))
(define-fun dynamic_invariant10 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 1 17)) (in_range5 temp___expr_1283)))
(define-fun dynamic_invariant11 ((temp___expr_1409 Int) (temp___is_init_1405 Bool) (temp___skip_constant_1406 Bool) (temp___do_toplevel_1407 Bool) (temp___do_typ_inv_1408 Bool)) Bool (=> (or (= temp___is_init_1405 true) (<= 0 2)) (in_range4 temp___expr_1409)))
(define-fun dynamic_invariant12 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17408)) (in_range6 temp___expr_1290)))
(define-fun dynamic_invariant13 ((temp___expr_1321 Int) (temp___is_init_1317 Bool) (temp___skip_constant_1318 Bool) (temp___do_toplevel_1319 Bool) (temp___do_typ_inv_1320 Bool)) Bool (=> (or (= temp___is_init_1317 true) (<= 0 1024)) (in_range8 temp___expr_1321)))
(assert true)
...
(assert (forall ((temp___1350 Int)) (=> (dynamic_invariant13 temp___1350 true true true true) (forall ((temp___1351 Int)) (= (select (temp_____aggregate_def_1348 temp___1350) temp___1351) rliteral2)))))
(define-fun dynamic_invariant14 ((temp___expr_573 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool) (temp___do_typ_inv_572 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 150)) (in_range12 temp___expr_573)))
...
(assert (forall ((temp___1346 Int)) (=> (dynamic_invariant10 temp___1346 true true true true) (forall ((temp___1347 Int)) (= (select (temp_____aggregate_def_1344 temp___1346) temp___1347) rliteral)))))
...
(declare-const logfiles2 map__ref4)
(declare-const logfilesstatus2 map__ref1)
...
(assert (and (= (= dataok true) (= (privatekeypresent thistisinfo__split_fields4 state3) true)) (and (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true) (in_range9 auditalarm1))))
(assert (=> (= dataok true) (and (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range9 auditalarm2))))
(assert (=> (= dataok true) (and (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range9 auditalarm3))))
(assert (=> (= dataok true) (= result1 status5)))
(assert (=> (= dataok true) (= status1 3)))
(assert (=> (= dataok true) (and (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true) (in_range9 auditalarm4))))
(assert (=> (not (= dataok true)) (and (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true) (in_range9 auditalarm5))))
(assert (=> (not (= dataok true)) (and (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields12)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields12)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields12)) true) (in_range9 auditalarm6))))
(assert (=> (not (= dataok true)) (= result2 status5)))
(assert (=> (not (= dataok true)) (= status2 2)))
(assert (=> (not (= dataok true)) (and (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields13)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields13)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields13)) true) (in_range9 auditalarm7))))
...
(assert (= logfilesstatus2 (mk_map__ref1 logfilesstatus)))
(assert (= logfiles2 (mk_map__ref4 logfiles)))
