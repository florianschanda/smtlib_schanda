...
(assert (and (and (and (=> (<= 1 10) (in_range4 low_index2)) (=> (<= 1 10) (in_range4 result__3))) (=> (<= 1 10) (in_range4 mid_index2))) (=> (<= 1 10) (in_range4 high_index2))))
(assert (= temp___633 result5))
(assert (= temp___6331 low_index2))
(assert (= temp___632 result6))
(assert (= temp___6321 high_index2))
(assert (< (to_rep (select items mid_index2)) search_item))
(assert (not (<= (+ mid_index2 1) 10)))
(check-sat)
(exit)
