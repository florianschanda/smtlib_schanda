...
(assert (< space1 8))
(assert (and (and (= (all_elements_in a1 (* space2 1000000)) true) (or (or (= space2 1) (= space2 2)) (= space2 4))) (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 7)) (ite (and (= (mod2 (+ k1 1) 8) 0) (= space2 8)) (= (to_rep (select a1 k1)) (+ (+ (+ (+ (+ (+ (+ (to_rep (select a 0)) (to_rep (select a 1))) (to_rep (select a 2))) (to_rep (select a 3))) (to_rep (select a 4))) (to_rep (select a 5))) (to_rep (select a 6))) (to_rep (select a 7)))) (ite (and (= (mod2 (+ k1 1) 4) 0) (<= 4 space2)) (= (to_rep (select a1 k1)) (+ (+ (+ (to_rep (select a k1)) (to_rep (select a (- k1 1)))) (to_rep (select a (- k1 2)))) (to_rep (select a (- k1 3))))) (ite (and (= (mod2 (+ k1 1) 2) 0) (<= 2 space2)) (= (to_rep (select a1 k1)) (+ (to_rep (select a k1)) (to_rep (select a (- k1 1))))) (= (to_rep (select a1 k1)) (to_rep (select a k1))))))))))
(assert (and (and (=> (<= 1 2147483647) (in_range3 space2)) (=> (<= 0 2147483647) (in_range2 left1))) (=> (<= 0 2147483647) (in_range2 right1))))
(assert (and (= o (* space2 1000000)) (in_range3 (* space2 1000000))))
(assert (and (= o1 (all_elements_in a1 o)) (= (= o1 true) (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 7)) (and (<= (- o) (to_rep (select a1 k1))) (<= (to_rep (select a1 k1)) o)))))))
(assert (= result1 (ite (and (= o1 true) (=> (not (= space2 1)) (=> (not (= space2 2)) (= space2 4)))) true false)))
(assert (= result1 true))
(assert (<= 0 k))
(assert (<= k 7))
(assert (not (and (= (mod2 (+ k 1) 8) 0) (= space2 8))))
(assert (not (not (= 4 0))))
(check-sat)
(exit)
