...
(assert (<= 1 (let ((subject i1)) i13)))
(assert (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b)))))))
(assert (and (and (and (<= 1 (let ((subject i1)) i14)) (<= (let ((subject i1)) i14) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b))))))) (= (bool_eq10 c35b c35b) true)) (= (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))) (+ (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b))))) 3))))
(assert (and (and (= (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16)) (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields15))) (=> (<= 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b)))))) (dynamic_property2 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b))))) (let ((subject i1)) i14)))) (and (<= 1 (let ((subject i1)) i14)) (<= (let ((subject i1)) i14) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b)))))))))
(assert (= (to_rep o74) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b)))) (let ((subject i1)) i14)))))
(assert (and (= temp___1463 (+ (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))) (let ((subject i1)) i14))) (in_range1 (+ (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))) (let ((subject i1)) i14)))))
(assert (and (<= 1 temp___1463) (<= temp___1463 50)))
(assert (= o75 temp___1463))
(assert (= o76 (store (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields16)) o75 o74)))
(assert (= o77 (mk___split_fields4 o76 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16)))))
(assert (= temp___1465 (mk___rep4 o77)))
(assert (= result13 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields16))))
(assert (= (let ((subject result____split_fields)) result____split_fields17) (us_split_fields9 temp___1465)))
(assert (not (= (let ((subject i1)) i14) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b))))))))
(assert (= result14 (let ((subject i1)) (mk_int__ref i14))))
(assert (= (let ((subject i1)) i15) (+ (let ((subject i1)) i14) 1)))
(assert (= i16 (let ((subject i1)) (mk_int__ref i15))))
(assert (= result____split_fields18 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields17))))
(assert (= i17 i15))
(assert (= result____split_fields19 result____split_fields17))
(assert (not (<= 1 (int__content i16))))
(check-sat)
(exit)
