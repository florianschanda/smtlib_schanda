...
(assert (not (= (enrolmentisinprogress (int__content status12) (us_private__content state70)) true)))
(assert (not (= (privatekeypresent (us_split_fields__content5 thistisinfo__split_fields6) (us_private__content state61)) true)))
(check-sat)
(exit)
