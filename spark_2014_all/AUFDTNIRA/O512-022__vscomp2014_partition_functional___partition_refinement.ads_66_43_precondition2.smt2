...
(declare-const temp___1210 us_rep9)
(declare-const temp___1209 us_rep6)
(declare-const temp___1208 (Array Int positive))
(declare-const temp___1212 Int)
(declare-const temp___1207 us_rep)
(declare-const temp___1211 Int)
(declare-const o Int)
(declare-const o1 Bool)
(declare-const j Int)
(declare-const o2 us_rep10)
...
(declare-const a4 map__ref4)
(declare-const d__split_fields4 us_split_fields__ref3)
(declare-const p__split_fields4 us_split_fields__ref4)
(declare-const c__split_fields4 us_split_fields__ref)
(declare-const a5 (Array Int positive))
(declare-const d__split_fields5 us_split_fields6)
(declare-const p__split_fields5 us_split_fields8)
(declare-const c__split_fields5 us_split_fields)
(declare-const a6 map__ref4)
(declare-const d__split_fields6 us_split_fields__ref3)
(declare-const p__split_fields6 us_split_fields__ref4)
(declare-const c__split_fields6 us_split_fields__ref)
(declare-const a7 (Array Int positive))
(declare-const d__split_fields7 us_split_fields6)
(declare-const p__split_fields7 us_split_fields8)
(declare-const c__split_fields7 us_split_fields)
(declare-const p__split_fields8 us_split_fields8)
(declare-const f1 (Array Int partition_index))
(declare-const a8 map__ref4)
(declare-const d__split_fields8 us_split_fields__ref3)
(declare-const p__split_fields9 us_split_fields__ref4)
(declare-const f2 map__ref5)
(declare-const c__split_fields8 us_split_fields__ref)
(declare-const a9 (Array Int positive))
(declare-const d__split_fields9 us_split_fields6)
(declare-const p__split_fields10 us_split_fields8)
(declare-const f3 (Array Int partition_index))
(declare-const c__split_fields9 us_split_fields)
(declare-const result3 Bool)
(assert (and (<= (* 2 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (<= (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 5000) (and (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (to_rep (select a j1))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c) true) (= (to_rep (select a (element1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c))) (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c)))) (and (forall ((c us_rep)) (=> (= (has_key (positions x) c) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x c)) true))) (and (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= 0 (to_rep5 (select f j1))) (<= (to_rep5 (select f j1)) (- (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1))))) (and (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j1)))))) j1) (<= j1 (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j1)))))))))) (and (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1))) (forall ((k Int)) (=> (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) j1)))) k) (<= k (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) j1)))))) (= (to_rep5 (select f k)) j1))))) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1))) (= (to_rep3 (rec__partition_refinement__interval__count (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) j1)))) 0))))))))))))
...
(assert (=> (= result1 true) (= temp___1210 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))
(assert (=> (= result1 true) (= temp___1209 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)))))
(assert (=> (= result1 true) (= temp___1208 a)))
(assert (=> (= result1 true) (= temp___1212 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))))))
(assert (=> (= result1 true) (= temp___1207 (mk___rep c__split_fields1))))
(assert (=> (= result1 true) (= temp___1211 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))))))
(assert (=> (= result1 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (find d_old (element x (mk___rep c__split_fields1)))) true)))
(assert (=> (= result1 true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x (mk___rep c__split_fields1))) true)))
(assert (=> (= result1 true) (and (= o (element x (mk___rep c__split_fields1))) (and (in_range3 o) (= o (get (model__ x) (get1 (positions x) (mk___rep c__split_fields1))))))))
(assert (=> (= result1 true) (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a2 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o)) (to_rep (select a (+ (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))) (to_rep3 (rec__partition_refinement__interval__count (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o)))))))))) (ite (= k (+ (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))) (to_rep3 (rec__partition_refinement__interval__count (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))))) (to_rep (select a (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))) (to_rep (select a k))))))) (and (= (capacity (mk___rep4 p__split_discrs p__split_fields2)) (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (= (length1 (mk___rep4 p__split_discrs p__split_fields2)) (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) (to_rep (select a2 j1))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c) true) (= (to_rep (select a2 (element1 (mk___rep3 d__split_discrs d__split_fields2) c))) (key (mk___rep3 d__split_discrs d__split_fields2) c)))) (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c) true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c) true))))))))))
(assert (=> (= result1 true) (ite (= (ite (= (bool_eq (mk___rep c__split_fields1) no_element) false) (= (get1 (positions x) (mk___rep c__split_fields1)) (length x)) true) true) (= (bool_eq (mk___rep c__split_fields2) no_element) true) (and (= (has_key (positions x) (mk___rep c__split_fields2)) true) (= (get1 (positions x) (mk___rep c__split_fields2)) (+ (get1 (positions x) (mk___rep c__split_fields1)) 1))))))
(assert (=> (= result1 true) (= (capacity (mk___rep4 p__split_discrs p__split_fields3)) temp___1211)))
(assert (=> (= result1 true) (= (length1 (mk___rep4 p__split_discrs p__split_fields3)) temp___1212)))
(assert (=> (= result1 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (to_rep (select a3 j1))) true)))))
(assert (=> (= result1 true) (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c) true) (= (to_rep (select a3 (element1 (mk___rep3 d__split_discrs d__split_fields3) c))) (key (mk___rep3 d__split_discrs d__split_fields3) c))))))
(assert (=> (= result1 true) (forall ((c us_rep4)) (=> (= (has_key1 (positions1 d_old) c) true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c) true)))))
(assert (=> (= result1 true) (forall ((c us_rep)) (=> (= (has_key (positions x) c) true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) (find d_old (element x c))) true)))))
(assert (=> (= result1 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= 0 (to_rep5 (select f j1))) (<= (to_rep5 (select f j1)) (- (length1 (mk___rep4 p__split_discrs p__split_fields3)) 1)))))))
(assert (=> (= result1 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields3)) (to_rep5 (select f j1)))))) j1) (<= j1 (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields3)) (to_rep5 (select f j1))))))))))))
(assert (=> (= result1 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- (length1 (mk___rep4 p__split_discrs p__split_fields3)) 1))) (forall ((k Int)) (=> (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields3)) j1)))) k) (<= k (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields3)) j1)))))) (= (to_rep5 (select f k)) j1)))))))
(assert (=> (= result1 true) (and (= o1 (has_key (positions x) (mk___rep c__split_fields3))) (= (= o1 true) (= (has_key (positions x) (mk___rep c__split_fields3)) true)))))
(assert (=> (= result1 true) (= result2 (ite (not (= o1 true)) true false))))
(assert (=> (= result1 true) (= result2 true)))
(assert (=> (= result1 true) (= c__split_fields4 (mk___split_fields__ref c__split_fields3))))
(assert (=> (= result1 true) (= p__split_fields4 (mk___split_fields__ref4 p__split_fields3))))
(assert (=> (= result1 true) (= d__split_fields4 (mk___split_fields__ref3 d__split_fields3))))
(assert (=> (= result1 true) (= a4 (mk_map__ref4 a3))))
(assert (=> (= result1 true) (= c__split_fields5 c__split_fields3)))
(assert (=> (= result1 true) (= p__split_fields5 p__split_fields3)))
(assert (=> (= result1 true) (= d__split_fields5 d__split_fields3)))
(assert (=> (= result1 true) (= a5 a3)))
(assert (=> (= result1 true) (= c__split_fields6 c__split_fields4)))
(assert (=> (= result1 true) (= p__split_fields6 p__split_fields4)))
(assert (=> (= result1 true) (= d__split_fields6 d__split_fields4)))
(assert (=> (= result1 true) (= a6 a4)))
(assert (=> (= result1 true) (= c__split_fields7 c__split_fields5)))
(assert (=> (= result1 true) (= p__split_fields7 p__split_fields5)))
(assert (=> (= result1 true) (= d__split_fields7 d__split_fields5)))
(assert (=> (= result1 true) (= a7 a5)))
(assert (=> (not (= result1 true)) (= c__split_fields6 (mk___split_fields__ref c__split_fields1))))
(assert (=> (not (= result1 true)) (= p__split_fields6 (mk___split_fields__ref4 (mk___split_fields4 p__split_fields)))))
(assert (=> (not (= result1 true)) (= d__split_fields6 (mk___split_fields__ref3 (mk___split_fields3 d__split_fields)))))
(assert (=> (not (= result1 true)) (= a6 (mk_map__ref4 a))))
(assert (=> (not (= result1 true)) (= c__split_fields7 c__split_fields1)))
(assert (=> (not (= result1 true)) (= p__split_fields7 p__split_fields1)))
(assert (=> (not (= result1 true)) (= d__split_fields7 d__split_fields1)))
(assert (=> (not (= result1 true)) (= a7 a1)))
(assert (and (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= 0 (to_rep5 (select f1 j1))) (<= (to_rep5 (select f1 j1)) (- (length1 (mk___rep4 p__split_discrs p__split_fields8)) 1))))) (and (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields8)) (to_rep5 (select f1 j1)))))) j1) (<= j1 (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields8)) (to_rep5 (select f1 j1)))))))))) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- (length1 (mk___rep4 p__split_discrs p__split_fields8)) 1))) (forall ((k Int)) (=> (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields8)) j1)))) k) (<= k (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields8)) j1)))))) (= (to_rep5 (select f1 k)) j1))))))))
(assert (= c__split_fields8 c__split_fields6))
(assert (= f2 (mk_map__ref5 f1)))
(assert (= p__split_fields9 (mk___split_fields__ref4 p__split_fields8)))
(assert (= d__split_fields8 d__split_fields6))
(assert (= a8 a6))
(assert (= c__split_fields9 c__split_fields7))
(assert (= f3 f1))
(assert (= p__split_fields10 p__split_fields8))
(assert (= d__split_fields9 d__split_fields7))
(assert (= a9 a7))
(assert (= (= result3 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= 0 (to_rep5 (select (map__content5 f2) j1))) (<= (to_rep5 (select (map__content5 f2) j1)) (- (length1 (mk___rep4 p__split_discrs (us_split_fields__content4 p__split_fields9))) 1)))))))
(assert (= result3 true))
(assert (<= 0 j))
(assert (<= j 5))
(assert (and (= o2 (get5 (model__2 (mk___rep4 p__split_discrs (us_split_fields__content4 p__split_fields9))) (to_rep5 (select (map__content5 f2) j)))) (= (bool_eq9 o2 (get5 (model__2 (mk___rep4 p__split_discrs (us_split_fields__content4 p__split_fields9))) (to_rep5 (select (map__content5 f2) j)))) true)))
(assert (= o3 (us_split_fields11 o2)))
(assert (= o4 (rec__partition_refinement__interval__last o3)))
(assert (= o5 (to_rep4 o4)))
(assert (= o6 (ite (<= j o5) true false)))
(assert (not (<= 0 (to_rep5 (select (map__content5 f2) j)))))
(check-sat)
(exit)
