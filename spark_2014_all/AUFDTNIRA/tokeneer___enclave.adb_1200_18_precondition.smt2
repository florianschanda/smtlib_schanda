...
(assert (and (= o2 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range4 o2) (= o2 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result2 (ite (= o2 1) true false)))
(assert (=> (= result2 true) (and (= o6 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o6 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result2 true) (= o7 (ite (not (= o6 true)) true false))))
(assert (=> (= result2 true) (and (= o3 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range6 o3))))
(assert (=> (= result2 true) (= o4 (ite (= o3 3) true false))))
(assert (=> (= result2 true) (and (= o5 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o5 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
...
(assert (and (= result3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result3 true) (in_range6 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result3 true))
