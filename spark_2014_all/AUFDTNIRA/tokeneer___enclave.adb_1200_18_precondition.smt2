...
(assert (=> (= result10 true) (and (= o76 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o76 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result10 true) (= o77 (ite (not (= o76 true)) true false))))
(assert (=> (= result10 true) (and (= o73 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range7 o73))))
(assert (=> (= result10 true) (= o74 (ite (= o73 3) true false))))
(assert (=> (= result10 true) (and (= o75 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o75 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result10 true) (= o78 (ite (= o75 true) o74 false))))
(assert (=> (= result10 true) (= o79 (ite (= o78 false) o77 true))))
(assert (=> (not (= result10 true)) (= o79 (of_int 1))))
(assert (and (= result12 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result12 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
