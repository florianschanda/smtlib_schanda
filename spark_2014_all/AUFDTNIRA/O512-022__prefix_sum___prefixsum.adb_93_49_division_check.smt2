...
(assert (=> (=> (not (= space3 4)) (=> (not (= space3 2)) (= space3 1))) (and (= result5 (all_elements_in a2 o3)) (= (= result5 true) (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 7)) (and (<= (- o3) (to_rep (select a2 k2))) (<= (to_rep (select a2 k2)) o3))))))))
(assert (=> (not (=> (not (= space3 4)) (=> (not (= space3 2)) (= space3 1)))) (= result5 false)))
(assert (= result5 true))
(assert (<= 0 k))
(assert (<= k 7))
(assert (not (= space3 4)))
(assert (=> (= space3 2) (= result6 (ite (= (mod2 (+ k 1) 8) 0) true false))))
(assert (=> (not (= space3 2)) (= result6 false)))
(assert (not (= result6 true)))
(assert (=> (= space3 2) (= result7 (ite (= (mod2 (+ k 1) 4) 0) true false))))
(assert (=> (not (= space3 2)) (= result7 false)))
