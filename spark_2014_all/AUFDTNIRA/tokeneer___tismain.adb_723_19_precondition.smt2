...
(assert (forall ((door__state us_private)) (! (dynamic_invariant5 (thedooralarm door__state) true false true true) :pattern ((thedooralarm door__state)))))
...
(declare-fun adminmustlogout (us_rep Int us_private us_split_fields2 Int us_private us_private Int Int us_split_fields18 us_split_fields24) Bool)
(declare-fun adminmustlogout__function_guard (Bool us_rep Int us_private us_split_fields2 Int us_private us_private Int Int us_split_fields18 us_split_fields24) Bool)
(assert true)
(declare-fun currentadminactivitypossible (Int us_private Int us_private Int Int us_split_fields18 us_split_fields24) Bool)
(declare-fun currentadminactivitypossible__function_guard (Bool Int us_private Int us_private Int Int us_split_fields18 us_split_fields24) Bool)
(assert true)
...
(assert (forall ((enclave__status Int)) (forall ((enclave__state us_private)) (! (=> (dynamic_invariant9 enclave__status true true true true) (dynamic_invariant9 (getstatus enclave__status enclave__state) true false true true)) :pattern ((getstatus enclave__status enclave__state))))))
(assert (forall ((enclave__status Int)) (forall ((enclave__state us_private)) (! (=> (dynamic_invariant9 enclave__status true true true true) (= (getstatus enclave__status enclave__state) enclave__status)) :pattern ((getstatus enclave__status enclave__state))))))
