...
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__keystore__optionalprivatekeyt__ispresent Bool) (rec__keystore__optionalprivatekeyt__owner us_rep2)))))
(define-fun us_split_fields_IsPresent__projection ((a us_split_fields6)) Bool (rec__keystore__optionalprivatekeyt__ispresent a))
(define-fun us_split_fields_Owner__projection ((a us_split_fields6)) us_rep2 (rec__keystore__optionalprivatekeyt__owner a))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields7 a)) (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields7 b))) (= (bool_eq3 (rec__keystore__optionalprivatekeyt__owner (us_split_fields7 a)) (rec__keystore__optionalprivatekeyt__owner (us_split_fields7 b))) true)) true false))
...
(declare-datatypes () ((optionalprivatekeyt__ref (mk_optionalprivatekeyt__ref (optionalprivatekeyt__content us_rep3)))))
(define-fun optionalprivatekeyt__ref___projection ((a optionalprivatekeyt__ref)) us_rep3 (optionalprivatekeyt__content a))
...
(declare-fun user_eq16 (serialnumbert serialnumbert) Bool)
(declare-const dummy16 serialnumbert)
...
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__certtypes__idt__issuer us_rep2) (rec__certtypes__idt__serialnumber serialnumbert)))))
(define-fun us_split_fields_Issuer__projection ((a us_split_fields8)) us_rep2 (rec__certtypes__idt__issuer a))
(define-fun us_split_fields_SerialNumber__projection ((a us_split_fields8)) serialnumbert (rec__certtypes__idt__serialnumber a))
...
(define-fun bool_eq5 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (bool_eq3 (rec__certtypes__idt__issuer (us_split_fields9 a)) (rec__certtypes__idt__issuer (us_split_fields9 b))) true) (= (to_rep9 (rec__certtypes__idt__serialnumber (us_split_fields9 a))) (to_rep9 (rec__certtypes__idt__serialnumber (us_split_fields9 b))))) true false))
...
(declare-datatypes () ((idt__ref (mk_idt__ref (idt__content us_rep4)))))
...
(assert (forall ((x classt)) (! (in_range13 (to_rep10 x)) :pattern ((to_rep10 x)))))
(assert (forall ((x Int)) (! (=> (in_range13 x) (= (to_rep10 (of_rep10 x)) x)) :pattern ((to_rep10 (of_rep10 x))))))
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__privtypes__clearancet__class classt)))))
(define-fun us_split_fields_Class__projection ((a us_split_fields10)) classt (rec__privtypes__clearancet__class a))
...
(define-fun us_rep___projection ((a us_rep5)) us_split_fields10 (us_split_fields11 a))
(define-fun bool_eq6 ((a us_rep5) (b us_rep5)) Bool (ite (= (to_rep10 (rec__privtypes__clearancet__class (us_split_fields11 a))) (to_rep10 (rec__privtypes__clearancet__class (us_split_fields11 b)))) true false))
...
(declare-fun user_eq20 (algorithmt algorithmt) Bool)
(declare-const dummy20 algorithmt)
...
(declare-fun to_rep11 (algorithmt) Int)
(declare-fun of_rep11 (Int) algorithmt)
(assert (forall ((x algorithmt)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x algorithmt)) (! (in_range14 (to_rep11 x)) :pattern ((to_rep11 x)))))
(assert (forall ((x Int)) (! (=> (in_range14 x) (= (to_rep11 (of_rep11 x)) x)) :pattern ((to_rep11 (of_rep11 x))))))
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__attr__auth__contentst__id us_rep4) (rec__cert__attr__auth__contentst__notbefore us_rep1) (rec__cert__attr__auth__contentst__notafter us_rep1) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep4) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep5)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields12)) us_rep4 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields12)) us_rep1 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields12)) us_rep1 (rec__cert__attr__auth__contentst__notafter a))
...
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields12)) us_rep4 (rec__cert__attr__auth__contentst__basecertid a))
(define-fun us_split_fields_Role__projection ((a us_split_fields12)) privileget (rec__cert__attr__auth__contentst__role a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields12)) us_rep5 (rec__cert__attr__auth__contentst__clearance a))
(declare-datatypes () ((us_split_fields__ref6 (mk___split_fields__ref6 (us_split_fields__content6 us_split_fields12)))))
(define-fun us_split_fields__ref___17__projection ((a us_split_fields__ref6)) us_split_fields12 (us_split_fields__content6 a))
(declare-datatypes () ((us_rep6 (mk___rep6 (us_split_fields13 us_split_fields12)))))
(define-fun us_rep___18__projection ((a us_rep6)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq7 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (and (and (and (= (bool_eq5 (rec__cert__attr__auth__contentst__id (us_split_fields13 a)) (rec__cert__attr__auth__contentst__id (us_split_fields13 b))) true) (= (bool_eq1 (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq1 (rec__cert__attr__auth__contentst__notafter (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep11 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 a))) (to_rep11 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq5 (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 b))) true)) (= (to_rep (rec__cert__attr__auth__contentst__role (us_split_fields13 a))) (to_rep (rec__cert__attr__auth__contentst__role (us_split_fields13 b))))) (= (bool_eq6 (rec__cert__attr__auth__contentst__clearance (us_split_fields13 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields13 b))) true)) true false))
...
(define-fun contentst__ref___3__projection ((a contentst__ref)) us_rep6 (contentst__content a))
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__admintoken__validauthcertt__valid Bool) (rec__admintoken__validauthcertt__contents us_rep6)))))
(define-fun us_split_fields_Valid__projection ((a us_split_fields14)) Bool (rec__admintoken__validauthcertt__valid a))
(define-fun us_split_fields_Contents__projection ((a us_split_fields14)) us_rep6 (rec__admintoken__validauthcertt__contents a))
(declare-datatypes () ((us_split_fields__ref7 (mk___split_fields__ref7 (us_split_fields__content7 us_split_fields14)))))
(define-fun us_split_fields__ref___19__projection ((a us_split_fields__ref7)) us_split_fields14 (us_split_fields__content7 a))
(declare-datatypes () ((us_rep7 (mk___rep7 (us_split_fields15 us_split_fields14)))))
(define-fun us_rep___20__projection ((a us_rep7)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq8 ((a us_rep7) (b us_rep7)) Bool (ite (and (= (rec__admintoken__validauthcertt__valid (us_split_fields15 a)) (rec__admintoken__validauthcertt__valid (us_split_fields15 b))) (= (bool_eq7 (rec__admintoken__validauthcertt__contents (us_split_fields15 a)) (rec__admintoken__validauthcertt__contents (us_split_fields15 b))) true)) true false))
...
(assert (forall ((x keyidt)) (! (in_range15 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(assert (forall ((x keylengtht)) (! (in_range16 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun us_rep___5__projection ((a us_rep8)) us_split_fields16 (us_split_fields17 a))
(define-fun bool_eq9 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (= (to_rep11 (rec__cryptotypes__keypartt__algorithmid (us_split_fields17 a))) (to_rep11 (rec__cryptotypes__keypartt__algorithmid (us_split_fields17 b)))) (= (to_rep12 (rec__cryptotypes__keypartt__keyid (us_split_fields17 a))) (to_rep12 (rec__cryptotypes__keypartt__keyid (us_split_fields17 b))))) (= (to_rep13 (rec__cryptotypes__keypartt__keylength (us_split_fields17 a))) (to_rep13 (rec__cryptotypes__keypartt__keylength (us_split_fields17 b))))) true false))
...
(declare-datatypes () ((us_split_fields18 (mk___split_fields9 (rec__cert__id__contentst__id us_rep4) (rec__cert__id__contentst__notbefore us_rep1) (rec__cert__id__contentst__notafter us_rep1) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep2) (rec__cert__id__contentst__subjectpublickey us_rep8)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields18)) us_rep4 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields18)) us_rep1 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields18)) us_rep1 (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields18)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields18)) us_rep2 (rec__cert__id__contentst__subject a))
(define-fun us_split_fields_SubjectPublicKey__projection ((a us_split_fields18)) us_rep8 (rec__cert__id__contentst__subjectpublickey a))
...
(define-fun us_rep___19__projection ((a us_rep9)) us_split_fields18 (us_split_fields19 a))
(define-fun bool_eq10 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (and (and (and (= (bool_eq5 (rec__cert__id__contentst__id (us_split_fields19 a)) (rec__cert__id__contentst__id (us_split_fields19 b))) true) (= (bool_eq1 (rec__cert__id__contentst__notbefore (us_split_fields19 a)) (rec__cert__id__contentst__notbefore (us_split_fields19 b))) true)) (= (bool_eq1 (rec__cert__id__contentst__notafter (us_split_fields19 a)) (rec__cert__id__contentst__notafter (us_split_fields19 b))) true)) (= (to_rep11 (rec__cert__id__contentst__mechanism (us_split_fields19 a))) (to_rep11 (rec__cert__id__contentst__mechanism (us_split_fields19 b))))) (= (bool_eq3 (rec__cert__id__contentst__subject (us_split_fields19 a)) (rec__cert__id__contentst__subject (us_split_fields19 b))) true)) (= (bool_eq9 (rec__cert__id__contentst__subjectpublickey (us_split_fields19 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields19 b))) true)) true false))
...
(define-fun contentst__ref___4__projection ((a contentst__ref1)) us_rep9 (contentst__content1 a))
(declare-datatypes () ((us_split_fields20 (mk___split_fields10 (rec__admintoken__valididcertt__valid Bool) (rec__admintoken__valididcertt__contents us_rep9)))))
(define-fun us_split_fields_Valid__2__projection ((a us_split_fields20)) Bool (rec__admintoken__valididcertt__valid a))
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields20)) us_rep9 (rec__admintoken__valididcertt__contents a))
(declare-datatypes () ((us_split_fields__ref10 (mk___split_fields__ref10 (us_split_fields__content10 us_split_fields20)))))
(define-fun us_split_fields__ref___20__projection ((a us_split_fields__ref10)) us_split_fields20 (us_split_fields__content10 a))
(declare-datatypes () ((us_rep10 (mk___rep10 (us_split_fields21 us_split_fields20)))))
(define-fun us_rep___21__projection ((a us_rep10)) us_split_fields20 (us_split_fields21 a))
(define-fun bool_eq11 ((a us_rep10) (b us_rep10)) Bool (ite (and (= (rec__admintoken__valididcertt__valid (us_split_fields21 a)) (rec__admintoken__valididcertt__valid (us_split_fields21 b))) (= (bool_eq10 (rec__admintoken__valididcertt__contents (us_split_fields21 a)) (rec__admintoken__valididcertt__contents (us_split_fields21 b))) true)) true false))
(declare-const value__size11 Int)
(declare-fun object__size11 (us_rep10) Int)
(declare-const value__alignment11 Int)
(declare-fun object__alignment11 (us_rep10) Int)
(assert (<= 0 value__size11))
(assert (forall ((a us_rep10)) (<= 0 (object__size11 a))))
(assert (<= 0 value__alignment11))
(assert (forall ((a us_rep10)) (<= 0 (object__alignment11 a))))
...
(declare-fun therole (us_rep6) Int)
(declare-fun therole__function_guard (Int us_rep6) Bool)
...
(declare-fun user_eq28 (presencet presencet) Bool)
(declare-const dummy28 presencet)
...
(declare-fun user_eq29 (tokenidt tokenidt) Bool)
(declare-const dummy29 tokenidt)
...
(define-fun dynamic_invariant3 ((temp___expr_634 Int) (temp___is_init_630 Bool) (temp___skip_constant_631 Bool) (temp___do_toplevel_632 Bool) (temp___do_typ_inv_633 Bool)) Bool (=> (or (= temp___is_init_630 true) (<= 0 4294967295)) (in_range18 temp___expr_634)))
(declare-sort tryt 0)
...
(declare-fun user_eq30 (tryt tryt) Bool)
(declare-const dummy30 tryt)
...
(define-fun dynamic_invariant4 ((temp___expr_641 Int) (temp___is_init_637 Bool) (temp___skip_constant_638 Bool) (temp___do_toplevel_639 Bool) (temp___do_typ_inv_640 Bool)) Bool (=> (or (= temp___is_init_637 true) (<= 0 2)) (in_range19 temp___expr_641)))
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields14)) (forall ((admintoken__idcert__fields us_split_fields20)) (! (=> (and (and (dynamic_invariant2 admintoken__tokenpresence true true true true) (dynamic_invariant4 admintoken__tokentry true true true true)) (dynamic_invariant3 admintoken__tokenid true true true true)) (dynamic_invariant (theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true false true true)) :pattern ((theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields14)) (forall ((admintoken__idcert__fields us_split_fields20)) (! (=> (and (and (dynamic_invariant2 admintoken__tokenpresence true true true true) (dynamic_invariant4 admintoken__tokentry true true true true)) (dynamic_invariant3 admintoken__tokenid true true true true)) (= (theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) (therole (rec__admintoken__validauthcertt__contents (us_split_fields15 (mk___rep7 admintoken__authcert__fields)))))) :pattern ((theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
...
(declare-fun user_eq31 (t t) Bool)
(declare-const dummy31 t)
(declare-datatypes () ((t__ref1 (mk_t__ref1 (t__content1 t)))))
(define-fun t__ref___3__projection ((a t__ref1)) t (t__content1 a))
(define-fun dynamic_invariant5 ((temp___expr_2141 Int) (temp___is_init_2137 Bool) (temp___skip_constant_2138 Bool) (temp___do_toplevel_2139 Bool) (temp___do_typ_inv_2140 Bool)) Bool (=> (or (= temp___is_init_2137 true) (<= 0 1)) (in_range20 temp___expr_2141)))
(assert true)
...
(declare-fun user_eq32 (t1 t1) Bool)
(declare-const dummy32 t1)
(declare-datatypes () ((t__ref2 (mk_t__ref2 (t__content2 t1)))))
(define-fun t__ref___4__projection ((a t__ref2)) t1 (t__content2 a))
(define-fun dynamic_invariant6 ((temp___expr_2164 Int) (temp___is_init_2160 Bool) (temp___skip_constant_2161 Bool) (temp___do_toplevel_2162 Bool) (temp___do_typ_inv_2163 Bool)) Bool (=> (or (= temp___is_init_2160 true) (<= 0 1)) (in_range21 temp___expr_2164)))
...
(declare-fun user_eq33 (statust statust) Bool)
(declare-const dummy33 statust)
...
(define-fun dynamic_invariant7 ((temp___expr_648 Int) (temp___is_init_644 Bool) (temp___skip_constant_645 Bool) (temp___do_toplevel_646 Bool) (temp___do_typ_inv_647 Bool)) Bool (=> (or (= temp___is_init_644 true) (<= 0 1)) (in_range22 temp___expr_648)))
...
(declare-fun user_eq34 (statust1 statust1) Bool)
(declare-const dummy34 statust1)
...
(define-fun dynamic_invariant8 ((temp___expr_2880 Int) (temp___is_init_2876 Bool) (temp___skip_constant_2877 Bool) (temp___do_toplevel_2878 Bool) (temp___do_typ_inv_2879 Bool)) Bool (=> (or (= temp___is_init_2876 true) (<= 0 8)) (in_range23 temp___expr_2880)))
(assert true)
...
(declare-fun user_eq35 (enrolmentstates enrolmentstates) Bool)
(declare-const dummy35 enrolmentstates)
...
(assert true)
(assert (forall ((enclave__status Int)) (forall ((enclave__state us_private)) (! (= (= (enrolmentisinprogress enclave__status enclave__state) true) (in_range24 enclave__status)) :pattern ((enrolmentisinprogress enclave__status enclave__state))))))
(declare-fun adminmustlogout (us_rep Int us_private us_split_fields2 us_private Int us_private Int Int us_split_fields14 us_split_fields20) Bool)
(declare-fun adminmustlogout__function_guard (Bool us_rep Int us_private us_split_fields2 us_private Int us_private Int Int us_split_fields14 us_split_fields20) Bool)
(assert true)
(declare-fun currentadminactivitypossible (Int us_private Int us_private Int Int us_split_fields14 us_split_fields20) Bool)
(declare-fun currentadminactivitypossible__function_guard (Bool Int us_private Int us_private Int Int us_split_fields14 us_split_fields20) Bool)
(assert true)
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-sort us_main_type 0)
(declare-fun us_main_eq (us_main_type us_main_type) Bool)
(declare-sort us_rep11 0)
(declare-fun bool_eq12 (us_rep11 us_rep11) Bool)
(declare-const value__size12 Int)
(declare-fun object__size12 (us_rep11) Int)
(declare-const value__alignment12 Int)
(declare-fun object__alignment12 (us_rep11) Int)
(assert (<= 0 value__size12))
(assert (forall ((a us_rep11)) (<= 0 (object__size12 a))))
(assert (<= 0 value__alignment12))
(assert (forall ((a us_rep11)) (<= 0 (object__alignment12 a))))
(declare-fun user_eq36 (us_rep11 us_rep11) Bool)
(declare-const dummy36 us_rep11)
(declare-datatypes () ((t__ref3 (mk_t__ref3 (t__content3 us_rep11)))))
(define-fun t__ref___2__projection ((a t__ref3)) us_rep11 (t__content3 a))
(declare-datatypes () ((map__ref1 (mk_map__ref1 (map__content1 (Array Int us_rep11))))))
(declare-fun slide1 ((Array Int us_rep11) Int Int) (Array Int us_rep11))
(assert (forall ((a (Array Int us_rep11))) (forall ((first Int)) (! (= (slide1 a first first) a) :pattern ((slide1 a first first))))))
(assert (forall ((a (Array Int us_rep11))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide1 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide1 a old_first new_first) i))))))))
(define-fun bool_eq13 ((a (Array Int us_rep11)) (a__first Int) (a__last Int) (b (Array Int us_rep11)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq12 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true)))) true false))
(assert (forall ((a (Array Int us_rep11)) (b (Array Int us_rep11))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq13 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq12 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true))))))))
(declare-const attr__ATTRIBUTE_ADDRESS11 Int)
(declare-const attr__ATTRIBUTE_ADDRESS12 Int)
(declare-sort filestatust 0)
(define-fun in_range25 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
...
(declare-fun user_eq37 (filestatust filestatust) Bool)
(declare-const dummy37 filestatust)
...
(assert (forall ((x filestatust)) (! (in_range25 (to_rep14 x)) :pattern ((to_rep14 x)))))
(assert (forall ((x Int)) (! (=> (in_range25 x) (= (to_rep14 (of_rep14 x)) x)) :pattern ((to_rep14 (of_rep14 x))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq14 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_198 Int)) (=> (and (<= a__first temp___idx_198) (<= temp___idx_198 a__last)) (= (to_rep14 (select a temp___idx_198)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_198)))))))))))
...
(define-fun in_range26 ((x Int)) Bool (and (<= 1 x) (<= x 17)))
...
(declare-fun user_eq38 (logfileindext logfileindext) Bool)
(declare-const dummy38 logfileindext)
...
(assert (forall ((x logfileindext)) (! (in_range26 (to_rep15 x)) :pattern ((to_rep15 x)))))
(assert (forall ((x Int)) (! (=> (in_range26 x) (= (to_rep15 (of_rep15 x)) x)) :pattern ((to_rep15 (of_rep15 x))))))
...
(define-fun in_range27 ((x Int)) Bool (and (<= 0 x) (<= x 17408)))
...
(declare-fun user_eq39 (logentrycountt logentrycountt) Bool)
(declare-const dummy39 logentrycountt)
...
(assert (forall ((x logentrycountt)) (! (in_range27 (to_rep16 x)) :pattern ((to_rep16 x)))))
(assert (forall ((x Int)) (! (=> (in_range27 x) (= (to_rep16 (of_rep16 x)) x)) :pattern ((to_rep16 (of_rep16 x))))))
...
(define-fun in_range28 ((x Int)) Bool (and (<= 0 x) (<= x 17)))
...
(declare-fun user_eq40 (logfilecountt logfilecountt) Bool)
(declare-const dummy40 logfilecountt)
...
(assert (forall ((x logfilecountt)) (! (in_range28 (to_rep17 x)) :pattern ((to_rep17 x)))))
(assert (forall ((x Int)) (! (=> (in_range28 x) (= (to_rep17 (of_rep17 x)) x)) :pattern ((to_rep17 (of_rep17 x))))))
(declare-datatypes () ((map__ref3 (mk_map__ref3 (map__content3 (Array Int logfileindext))))))
(declare-fun slide3 ((Array Int logfileindext) Int Int) (Array Int logfileindext))
(assert (forall ((a (Array Int logfileindext))) (forall ((first Int)) (! (= (slide3 a first first) a) :pattern ((slide3 a first first))))))
(assert (forall ((a (Array Int logfileindext))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide3 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide3 a old_first new_first) i))))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq15 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_195 Int)) (=> (and (<= a__first temp___idx_195) (<= temp___idx_195 a__last)) (= (to_rep15 (select a temp___idx_195)) (to_rep15 (select b (+ (- b__first a__first) temp___idx_195)))))))))))
(declare-const dummy41 (Array Int logfileindext))
(declare-const value__size13 Int)
(declare-fun object__size13 ((Array Int logfileindext)) Int)
(declare-const value__component__size1 Int)
(declare-fun object__component__size1 ((Array Int logfileindext)) Int)
(declare-const value__alignment13 Int)
(declare-fun object__alignment13 ((Array Int logfileindext)) Int)
(assert (<= 0 value__size13))
(assert (forall ((a (Array Int logfileindext))) (<= 0 (object__size13 a))))
(assert (<= 0 value__component__size1))
(assert (forall ((a (Array Int logfileindext))) (<= 0 (object__component__size1 a))))
(assert (<= 0 value__alignment13))
(assert (forall ((a (Array Int logfileindext))) (<= 0 (object__alignment13 a))))
(declare-fun user_eq41 ((Array Int logfileindext) (Array Int logfileindext)) Bool)
(declare-datatypes () ((us_split_fields22 (mk___split_fields11 (rec__auditlog__logfilelistt__list (Array Int logfileindext)) (rec__auditlog__logfilelistt__head logfileindext) (rec__auditlog__logfilelistt__lasti logfileindext) (rec__auditlog__logfilelistt__length logfilecountt)))))
(define-fun us_split_fields_List__projection ((a us_split_fields22)) (Array Int logfileindext) (rec__auditlog__logfilelistt__list a))
(define-fun us_split_fields_Head__projection ((a us_split_fields22)) logfileindext (rec__auditlog__logfilelistt__head a))
(define-fun us_split_fields_LastI__projection ((a us_split_fields22)) logfileindext (rec__auditlog__logfilelistt__lasti a))
(define-fun us_split_fields_Length__3__projection ((a us_split_fields22)) logfilecountt (rec__auditlog__logfilelistt__length a))
(declare-datatypes () ((us_split_fields__ref11 (mk___split_fields__ref11 (us_split_fields__content11 us_split_fields22)))))
(define-fun us_split_fields__ref___9__projection ((a us_split_fields__ref11)) us_split_fields22 (us_split_fields__content11 a))
(declare-datatypes () ((us_rep12 (mk___rep11 (us_split_fields23 us_split_fields22)))))
(define-fun us_rep___10__projection ((a us_rep12)) us_split_fields22 (us_split_fields23 a))
(define-fun bool_eq16 ((a us_rep12) (b us_rep12)) Bool (ite (and (and (and (= (bool_eq15 (rec__auditlog__logfilelistt__list (us_split_fields23 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields23 b)) 1 17) true) (= (to_rep15 (rec__auditlog__logfilelistt__head (us_split_fields23 a))) (to_rep15 (rec__auditlog__logfilelistt__head (us_split_fields23 b))))) (= (to_rep15 (rec__auditlog__logfilelistt__lasti (us_split_fields23 a))) (to_rep15 (rec__auditlog__logfilelistt__lasti (us_split_fields23 b))))) (= (to_rep17 (rec__auditlog__logfilelistt__length (us_split_fields23 a))) (to_rep17 (rec__auditlog__logfilelistt__length (us_split_fields23 b))))) true false))
(declare-const value__size14 Int)
(declare-fun object__size14 (us_rep12) Int)
(declare-const value__alignment14 Int)
(declare-fun object__alignment14 (us_rep12) Int)
(assert (<= 0 value__size14))
(assert (forall ((a us_rep12)) (<= 0 (object__size14 a))))
(assert (<= 0 value__alignment14))
(assert (forall ((a us_rep12)) (<= 0 (object__alignment14 a))))
...
(declare-fun user_eq42 (us_rep12 us_rep12) Bool)
(declare-const dummy42 us_rep12)
(declare-datatypes () ((logfilelistt__ref (mk_logfilelistt__ref (logfilelistt__content us_rep12)))))
(define-fun logfilelistt__ref___projection ((a logfilelistt__ref)) us_rep12 (logfilelistt__content a))
...
(define-fun in_range29 ((x Int)) Bool (and (<= 0 x) (<= x 1024)))
...
(declare-fun user_eq43 (fileentrycountt fileentrycountt) Bool)
(declare-const dummy43 fileentrycountt)
...
(assert (forall ((x fileentrycountt)) (! (in_range29 (to_rep18 x)) :pattern ((to_rep18 x)))))
(assert (forall ((x Int)) (! (=> (in_range29 x) (= (to_rep18 (of_rep18 x)) x)) :pattern ((to_rep18 (of_rep18 x))))))
(declare-datatypes () ((map__ref4 (mk_map__ref4 (map__content4 (Array Int fileentrycountt))))))
(declare-fun slide4 ((Array Int fileentrycountt) Int Int) (Array Int fileentrycountt))
(assert (forall ((a (Array Int fileentrycountt))) (forall ((first Int)) (! (= (slide4 a first first) a) :pattern ((slide4 a first first))))))
(assert (forall ((a (Array Int fileentrycountt))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide4 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide4 a old_first new_first) i))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq17 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep18 (select a temp___idx_196)) (to_rep18 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
(declare-const dummy44 (Array Int fileentrycountt))
(declare-const value__size15 Int)
(declare-fun object__size15 ((Array Int fileentrycountt)) Int)
(declare-const value__component__size2 Int)
(declare-fun object__component__size2 ((Array Int fileentrycountt)) Int)
(declare-const value__alignment15 Int)
(declare-fun object__alignment15 ((Array Int fileentrycountt)) Int)
(assert (<= 0 value__size15))
(assert (forall ((a (Array Int fileentrycountt))) (<= 0 (object__size15 a))))
(assert (<= 0 value__component__size2))
(assert (forall ((a (Array Int fileentrycountt))) (<= 0 (object__component__size2 a))))
(assert (<= 0 value__alignment15))
(assert (forall ((a (Array Int fileentrycountt))) (<= 0 (object__alignment15 a))))
(declare-fun user_eq44 ((Array Int fileentrycountt) (Array Int fileentrycountt)) Bool)
(declare-datatypes () ((us_split_fields24 (mk___split_fields12 (rec__auditlog__logfilestatet__currentlogfile logfileindext) (rec__auditlog__logfilestatet__numberlogentries logentrycountt) (rec__auditlog__logfilestatet__usedlogfiles us_rep12) (rec__auditlog__logfilestatet__logfileentries (Array Int fileentrycountt))))))
(define-fun us_split_fields_CurrentLogFile__projection ((a us_split_fields24)) logfileindext (rec__auditlog__logfilestatet__currentlogfile a))
(define-fun us_split_fields_NumberLogEntries__projection ((a us_split_fields24)) logentrycountt (rec__auditlog__logfilestatet__numberlogentries a))
(define-fun us_split_fields_UsedLogFiles__projection ((a us_split_fields24)) us_rep12 (rec__auditlog__logfilestatet__usedlogfiles a))
(define-fun us_split_fields_LogFileEntries__projection ((a us_split_fields24)) (Array Int fileentrycountt) (rec__auditlog__logfilestatet__logfileentries a))
...
(define-fun us_rep___11__projection ((a us_rep13)) us_split_fields24 (us_split_fields25 a))
(define-fun bool_eq18 ((a us_rep13) (b us_rep13)) Bool (ite (and (and (and (= (to_rep15 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields25 a))) (to_rep15 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields25 b)))) (= (to_rep16 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields25 a))) (to_rep16 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields25 b))))) (= (bool_eq16 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields25 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields25 b))) true)) (= (bool_eq17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields25 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields25 b)) 1 17) true)) true false))
...
(declare-fun user_eq45 (us_rep13 us_rep13) Bool)
(declare-const dummy45 us_rep13)
(declare-datatypes () ((logfilestatet__ref (mk_logfilestatet__ref (logfilestatet__content us_rep13)))))
(define-fun logfilestatet__ref___projection ((a logfilestatet__ref)) us_rep13 (logfilestatet__content a))
(declare-const attr__ATTRIBUTE_ADDRESS14 Int)
(declare-fun valid_numberlogentries (Int Int us_rep12 (Array Int fileentrycountt)) Bool)
(declare-fun valid_numberlogentries__function_guard (Bool Int Int us_rep12 (Array Int fileentrycountt)) Bool)
(declare-fun temp_____aggregate_def_1358 (Int) (Array Int logfileindext))
(declare-fun temp_____aggregate_def_1362 (Int) (Array Int fileentrycountt))
(define-fun dynamic_invariant9 ((temp___expr_1352 us_rep13) (temp___is_init_1348 Bool) (temp___skip_constant_1349 Bool) (temp___do_toplevel_1350 Bool) (temp___do_typ_inv_1351 Bool)) Bool (=> (= temp___do_typ_inv_1351 true) (= (valid_numberlogentries (to_rep15 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields25 temp___expr_1352))) (to_rep16 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields25 temp___expr_1352))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields25 temp___expr_1352)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields25 temp___expr_1352))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1356 us_rep13) (temp___skip_top_level_1357 Bool)) Bool (and (and (and (= (to_rep15 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields25 temp___expr_1356))) 1) (= (to_rep16 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields25 temp___expr_1356))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields25 temp___expr_1356)) (mk___rep11 (mk___split_fields11 (temp_____aggregate_def_1358 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields25 temp___expr_1356)) (temp_____aggregate_def_1362 0))))
(define-fun type_invariant ((temp___1366 us_rep13)) Bool (= (valid_numberlogentries (to_rep15 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields25 temp___1366))) (to_rep16 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields25 temp___1366))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields25 temp___1366)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields25 temp___1366))) true))
(declare-fun getstatus (Int us_private) Int)
(declare-fun getstatus__function_guard (Int Int us_private) Bool)
...
(define-fun in_range30 ((x Int)) Bool (and (<= 0 x) (<= x 2147483647)))
...
(declare-fun user_eq46 (statscount statscount) Bool)
(declare-const dummy46 statscount)
...
(define-fun to_rep19 ((x statscount)) Int (statscountqtint x))
(declare-fun of_rep19 (Int) statscount)
(assert (forall ((x statscount)) (! (= (of_rep19 (to_rep19 x)) x) :pattern ((to_rep19 x)))))
(assert (forall ((x statscount)) (! (in_range30 (to_rep19 x)) :pattern ((to_rep19 x)))))
(assert (forall ((x Int)) (! (=> (in_range30 x) (= (to_rep19 (of_rep19 x)) x)) :pattern ((to_rep19 (of_rep19 x))))))
...
(declare-fun user_eq47 (us_rep14 us_rep14) Bool)
(declare-const dummy47 us_rep14)
...
(define-fun dynamic_invariant10 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range10 temp___expr_74)))
(define-fun dynamic_invariant11 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 4)) (in_range2 temp___expr_496)))
(define-fun dynamic_invariant12 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range4 temp___expr_433)))
(define-fun dynamic_invariant13 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range13 temp___expr_440)))
(define-fun dynamic_invariant14 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 40)) (in_range9 temp___expr_548)))
(define-fun dynamic_invariant15 ((temp___expr_572 Int) (temp___is_init_568 Bool) (temp___skip_constant_569 Bool) (temp___do_toplevel_570 Bool) (temp___do_typ_inv_571 Bool)) Bool (=> (or (= temp___is_init_568 true) (<= 0 4294967295)) (in_range11 temp___expr_572)))
(define-fun dynamic_invariant16 ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= 0 10)) (in_range14 temp___expr_596)))
(define-fun dynamic_invariant17 ((temp___expr_610 Int) (temp___is_init_606 Bool) (temp___skip_constant_607 Bool) (temp___do_toplevel_608 Bool) (temp___do_typ_inv_609 Bool)) Bool (=> (or (= temp___is_init_606 true) (<= 0 4294967295)) (in_range15 temp___expr_610)))
(define-fun dynamic_invariant18 ((temp___expr_617 Int) (temp___is_init_613 Bool) (temp___skip_constant_614 Bool) (temp___do_toplevel_615 Bool) (temp___do_typ_inv_616 Bool)) Bool (=> (or (= temp___is_init_613 true) (<= 0 128)) (in_range16 temp___expr_617)))
(define-fun dynamic_invariant19 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17)) (in_range28 temp___expr_1290)))
(define-fun dynamic_invariant20 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 1 17)) (in_range26 temp___expr_1297)))
(define-fun dynamic_invariant21 ((temp___expr_1423 Int) (temp___is_init_1419 Bool) (temp___skip_constant_1420 Bool) (temp___do_toplevel_1421 Bool) (temp___do_typ_inv_1422 Bool)) Bool (=> (or (= temp___is_init_1419 true) (<= 0 2)) (in_range25 temp___expr_1423)))
(define-fun dynamic_invariant22 ((temp___expr_1304 Int) (temp___is_init_1300 Bool) (temp___skip_constant_1301 Bool) (temp___do_toplevel_1302 Bool) (temp___do_typ_inv_1303 Bool)) Bool (=> (or (= temp___is_init_1300 true) (<= 0 17408)) (in_range27 temp___expr_1304)))
(define-fun dynamic_invariant23 ((temp___expr_1335 Int) (temp___is_init_1331 Bool) (temp___skip_constant_1332 Bool) (temp___do_toplevel_1333 Bool) (temp___do_typ_inv_1334 Bool)) Bool (=> (or (= temp___is_init_1331 true) (<= 0 1024)) (in_range29 temp___expr_1335)))
(assert true)
(assert (forall ((currentlogfile Int) (numberlogentries Int)) (forall ((usedlogfiles us_rep12)) (forall ((logfileentries (Array Int fileentrycountt))) (! (= (= (valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries) true) (and (<= 1 (to_rep17 (rec__auditlog__logfilelistt__length (us_split_fields23 usedlogfiles)))) (= numberlogentries (+ (* (- (to_rep17 (rec__auditlog__logfilelistt__length (us_split_fields23 usedlogfiles))) 1) 1024) (to_rep18 (select logfileentries currentlogfile)))))) :pattern ((valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries)))))))
(declare-const rliteral2 fileentrycountt)
(assert (= (fileentrycounttqtint rliteral2) 0))
(assert (forall ((temp___1364 Int)) (=> (dynamic_invariant23 temp___1364 true true true true) (forall ((temp___1365 Int)) (= (select (temp_____aggregate_def_1362 temp___1364) temp___1365) rliteral2)))))
(define-fun dynamic_invariant24 ((temp___expr_725 Int) (temp___is_init_721 Bool) (temp___skip_constant_722 Bool) (temp___do_toplevel_723 Bool) (temp___do_typ_inv_724 Bool)) Bool (=> (or (= temp___is_init_721 true) (<= 1901 2099)) (in_range5 temp___expr_725)))
(define-fun dynamic_invariant25 ((temp___expr_732 Int) (temp___is_init_728 Bool) (temp___skip_constant_729 Bool) (temp___do_toplevel_730 Bool) (temp___do_typ_inv_731 Bool)) Bool (=> (or (= temp___is_init_728 true) (<= 1 12)) (in_range6 temp___expr_732)))
(define-fun dynamic_invariant26 ((temp___expr_739 Int) (temp___is_init_735 Bool) (temp___skip_constant_736 Bool) (temp___do_toplevel_737 Bool) (temp___do_typ_inv_738 Bool)) Bool (=> (or (= temp___is_init_735 true) (<= 1 31)) (in_range7 temp___expr_739)))
(define-fun dynamic_invariant27 ((temp___expr_771 Int) (temp___is_init_767 Bool) (temp___skip_constant_768 Bool) (temp___do_toplevel_769 Bool) (temp___do_typ_inv_770 Bool)) Bool (=> (or (= temp___is_init_767 true) (<= 0 86399999)) (in_range8 temp___expr_771)))
(assert true)
...
(define-fun dynamic_invariant28 ((temp___expr_1596 Int) (temp___is_init_1592 Bool) (temp___skip_constant_1593 Bool) (temp___do_toplevel_1594 Bool) (temp___do_typ_inv_1595 Bool)) Bool (=> (or (= temp___is_init_1592 true) (<= 0 4294967295)) (in_range12 temp___expr_1596)))
(assert (forall ((contents us_rep6)) (! (dynamic_invariant (therole contents) true false true true) :pattern ((therole contents)))))
(assert (forall ((contents us_rep6)) (! (= (therole contents) (to_rep (rec__cert__attr__auth__contentst__role (us_split_fields13 contents)))) :pattern ((therole contents)))))
(assert (forall ((enclave__status Int)) (forall ((enclave__state us_private)) (! (=> (dynamic_invariant8 enclave__status true true true true) (dynamic_invariant8 (getstatus enclave__status enclave__state) true false true true)) :pattern ((getstatus enclave__status enclave__state))))))
(assert (forall ((enclave__status Int)) (forall ((enclave__state us_private)) (! (=> (dynamic_invariant8 enclave__status true true true true) (= (getstatus enclave__status enclave__state) enclave__status)) :pattern ((getstatus enclave__status enclave__state))))))
(define-fun dynamic_invariant29 ((temp___expr_2967 Int) (temp___is_init_2963 Bool) (temp___skip_constant_2964 Bool) (temp___do_toplevel_2965 Bool) (temp___do_typ_inv_2966 Bool)) Bool (=> (or (= temp___is_init_2963 true) (<= 0 2)) (in_range24 temp___expr_2967)))
(define-fun dynamic_invariant30 ((temp___expr_2369 Int) (temp___is_init_2365 Bool) (temp___skip_constant_2366 Bool) (temp___do_toplevel_2367 Bool) (temp___do_typ_inv_2368 Bool)) Bool (=> (or (= temp___is_init_2365 true) (<= 0 2147483647)) (in_range30 temp___expr_2369)))
(assert (forall ((temp___1360 Int)) (=> (dynamic_invariant20 temp___1360 true true true true) (forall ((temp___1361 Int)) (= (select (temp_____aggregate_def_1358 temp___1360) temp___1361) rliteral)))))
...
(assert (= (valid_numberlogentries (to_rep15 logfilestate__split_fields) (to_rep16 logfilestate__split_fields1) (mk___rep11 (mk___split_fields11 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6) true))
(assert (in_range22 auditalarm))
(assert (in_range20 currentlatch))
(assert (in_range23 status))
(assert (and (and (and (and (and (and (and (and (and (and (and (= (not (= (enrolmentisinprogress status (us_private__content state5)) true)) (= (privatekeypresent (mk___split_fields3 thistisinfo__split_fields (mk___rep2 (mk___split_fields2 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state)) true)) (= (and (and (= (islocked currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) true) (= (thecurrentdoor (us_private__content state3)) 0)) (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime)) (alarm_timeout (us_private__content state3))) true)) (= (thedooralarm (us_private__content state3)) 0))) (=> (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields))) 1) (and (and (= (isgood tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content7 authcert__split_fields) (us_split_fields__content10 idcert__split_fields)) true) (= (authcertvalid tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content7 authcert__split_fields) (us_split_fields__content10 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content7 authcert__split_fields) (us_split_fields__content10 idcert__split_fields)) 1)))) (=> (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true) (= (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields))) 3)) (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields))) 1))) (=> (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields))) 1) (or (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true) (= (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields))) 3)) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true))))) (=> (not (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields))) true)) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true)))) (=> (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true) (= (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields))) 4)) (= (statusiswaitingstartadminop status (us_private__content state5)) true))) (=> (or (= (statusisgotadmintoken status (us_private__content state5)) true) (= (statusiswaitingremoveadmintokenfail status (us_private__content state5)) true)) (not (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields))) true)))) (=> (or (= (statusiswaitingstartadminop status (us_private__content state5)) true) (= (statusiswaitingfinishadminop status (us_private__content state5)) true)) (and (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields))) true) (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true)))) (=> (= (statusisenclavequiescent status (us_private__content state5)) true) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true)))) (=> (= (statusisshutdown status (us_private__content state5)) true) (and (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true)) (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields))) 0)))) (=> (= (enrolmentisinprogress status (us_private__content state5)) true) (and (not (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields))) true)) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true))))))
(assert (and (= result (enrolmentisinprogress status (us_private__content state5))) (= (= result true) (in_range24 status))))
(assert (not (= result true)))
(assert (= result1 (adminmustlogout (mk___rep (us_split_fields__content theadmin__split_fields)) status (us_private__content state5) (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime) tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content7 authcert__split_fields) (us_split_fields__content10 idcert__split_fields))))
(assert (not (= result1 true)))
(assert (= result2 (currentactivitypossible (us_private__content state4) (us_private__content state6))))
(assert (= result2 true))
(assert (not (= (privatekeypresent (mk___split_fields3 thistisinfo__split_fields (mk___rep2 (mk___split_fields2 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state)) true)))
(check-sat)
(exit)
