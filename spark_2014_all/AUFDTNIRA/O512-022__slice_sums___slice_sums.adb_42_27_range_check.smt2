...
(assert (and (= o28 lo3) (in_range3 lo3)))
(assert (= (to_rep o31) o28))
(assert (= o32 (mk___split_fields o31 o30)))
(assert (= temp___157 (mk_slice_bounds o32)))
(assert (= result9 (mk___split_fields__ref current_slice__split_fields4)))
(assert (= current_slice__split_fields5 (us_split_fields1 temp___157)))
(assert (= result10 (mk_int__ref current_sum3)))
(assert (= current_sum4 (sum__logic x (mk_slice_bounds current_slice__split_fields5))))
(assert (< max_sum3 current_sum4))
(assert (= result11 (mk___split_fields__ref result____split_fields4)))
(assert (= result____split_fields5 current_slice__split_fields5))
(assert (not (in_range2 current_sum4)))
(check-sat)
(exit)
