...
(assert (= temp___181 (mk_slice_bounds o8)))
(assert (= result4 (mk___split_fields__ref current_slice__split_fields)))
(assert (= current_slice__split_fields1 (us_split_fields1 temp___181)))
(assert (= result5 (mk_int__ref current_sum2)))
(assert (= current_sum3 (sum__logic x (mk_slice_bounds current_slice__split_fields1))))
(assert (< max_sum3 current_sum3))
(assert (= result6 (mk___split_fields__ref result____split_fields4)))
(assert (= result____split_fields5 current_slice__split_fields1))
(assert (not (in_range2 current_sum3)))
(check-sat)
(exit)
