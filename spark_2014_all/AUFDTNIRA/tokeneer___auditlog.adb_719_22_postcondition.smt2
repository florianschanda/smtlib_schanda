...
(define-fun usedlogfiles__split_fields20 () us_split_fields (mk___split_fields usedlogfiles__split_fields8 usedlogfiles__split_fields9 usedlogfiles__split_fields10 usedlogfiles__split_fields11))
(assert (in_range6 currentlogfile))
(assert (in_range9 numberlogentries))
(assert (in_range1 elementid))
(assert (in_range2 severity))
(assert (and (and (< numberlogentries 17408) (or (< (to_rep1 (select logfileentries currentlogfile)) 1024) (< (to_rep2 usedlogfiles__split_fields3) 17))) (= numberlogentries (+ (* (- (to_rep2 usedlogfiles__split_fields3) 1) 1024) (to_rep1 (select logfileentries currentlogfile))))))
(assert (=> (< (to_rep1 (select logfileentries currentlogfile)) 1024) (= (to_rep1 (select logfileentries1 currentlogfile)) (+ (to_rep1 (select logfileentries currentlogfile)) 1))))
(assert (=> (< (to_rep1 (select logfileentries currentlogfile)) 1024) (= usedlogfiles__split_fields usedlogfiles__split_fields8)))
(assert (=> (< (to_rep1 (select logfileentries currentlogfile)) 1024) (= usedlogfiles__split_fields1 usedlogfiles__split_fields9)))
(assert (=> (< (to_rep1 (select logfileentries currentlogfile)) 1024) (= usedlogfiles__split_fields2 usedlogfiles__split_fields10)))
(assert (=> (< (to_rep1 (select logfileentries currentlogfile)) 1024) (= usedlogfiles__split_fields3 usedlogfiles__split_fields11)))
(assert (=> (< (to_rep1 (select logfileentries currentlogfile)) 1024) (= logfilesstatus2 logfilesstatus)))
(assert (=> (< (to_rep1 (select logfileentries currentlogfile)) 1024) (= currentlogfile2 currentlogfile)))
(assert (=> (< (to_rep1 (select logfileentries currentlogfile)) 1024) (= usedlogfiles__split_fields20 (mk___split_fields usedlogfiles__split_fields4 usedlogfiles__split_fields5 usedlogfiles__split_fields6 usedlogfiles__split_fields7))))
(assert (=> (< (to_rep1 (select logfileentries currentlogfile)) 1024) (= logfilesstatus2 logfilesstatus1)))
(assert (=> (< (to_rep1 (select logfileentries currentlogfile)) 1024) (= currentlogfile2 currentlogfile1)))
(assert (=> (not (< (to_rep1 (select logfileentries currentlogfile)) 1024)) (and (and (= (to_rep2 usedlogfiles__split_fields11) (+ (to_rep2 usedlogfiles__split_fields3) 1)) (= (to_rep1 (select logfileentries2 currentlogfile2)) 1)) (in_range6 currentlogfile2))))
(assert (=> (not (< (to_rep1 (select logfileentries currentlogfile)) 1024)) (= auditsystemfault auditsystemfault1)))
(assert (=> (not (< (to_rep1 (select logfileentries currentlogfile)) 1024)) (= logfileentries1 logfileentries2)))
(assert (=> (not (< (to_rep1 (select logfileentries currentlogfile)) 1024)) (= logfiles logfiles1)))
(assert (and (= o (+ numberlogentries 1)) (in_range9 (+ numberlogentries 1))))
...
(assert (= (mk___split_fields usedlogfiles__split_fields16 usedlogfiles__split_fields17 usedlogfiles__split_fields18 usedlogfiles__split_fields19) usedlogfiles__split_fields20))
...
(assert (not (= (to_rep1 (select logfileentries3 currentlogfile3)) 1)))
(check-sat)
(exit)
