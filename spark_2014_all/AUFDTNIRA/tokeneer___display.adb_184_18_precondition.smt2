...
(assert (= i11 1))
(assert (=> (and (<= 1 i11) (<= i11 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))))) (and (and (= temp___1399 i11) (and (= temp___1397 (mk___rep4 result____split_fields15)) (and (= temp___1400 c27b) (and (and (and (and (<= 1 i12) (<= i12 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))))) (= (bool_eq10 c27b temp___1400) true)) (= (to_rep8 (rec__display__scrollstrt__len result____split_fields16)) (+ (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))) 3))) (and (and (and (= (rec__display__scrollstrt__len result____split_fields16) (rec__display__scrollstrt__len (us_split_fields9 temp___1397))) (=> (<= 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))) (dynamic_property2 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))) i12))) (and (<= 1 i12) (<= i12 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))))) (and (and (and (and (and (= (to_rep o79) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))) i12))) (and (and (and (= temp___1394 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields16)) i12)) (in_range1 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields16)) i12))) (and (and (<= 1 temp___1394) (<= temp___1394 50)) (= o80 temp___1394))) (= o81 (store (rec__display__scrollstrt__text result____split_fields16) o80 o79)))) (= o82 (mk___split_fields4 o81 (rec__display__scrollstrt__len result____split_fields16)))) (= temp___1396 (mk___rep4 o82))) (and (= result10 (mk___split_fields__ref4 result____split_fields16)) (= result____split_fields17 (us_split_fields9 temp___1396)))) (= i12 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))))))))) (and (and (= i18 (mk_int__ref i12)) (= result____split_fields22 (mk___split_fields__ref4 result____split_fields17))) (and (= i19 i12) (= result____split_fields23 result____split_fields17))))))
...
(assert (= temp___1404 (mk___rep4 o85)))
(assert (= result12 result____split_fields24))
(assert (= result____split_fields26 (us_split_fields9 temp___1404)))
