...
(assert (= i11 1))
(assert (=> (and (<= 1 i11) (<= i11 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))))) (and (and (= temp___1455 i11) (and (= temp___1453 (mk___rep4 result____split_fields15)) (and (= temp___1456 c27b) (and (and (and (and (<= 1 i12) (<= i12 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))))) (= (bool_eq10 c27b temp___1456) true)) (= (to_rep8 (rec__display__scrollstrt__len result____split_fields16)) (+ (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))) 3))) (and (and (and (= (rec__display__scrollstrt__len result____split_fields16) (rec__display__scrollstrt__len (us_split_fields9 temp___1453))) (=> (<= 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))) (dynamic_property2 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))) i12))) (and (<= 1 i12) (<= i12 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))))) (and (and (and (and (and (= (to_rep o79) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))) i12))) (and (and (and (= temp___1450 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields16)) i12)) (in_range1 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields16)) i12))) (and (and (<= 1 temp___1450) (<= temp___1450 50)) (= o80 temp___1450))) (= o81 (store (rec__display__scrollstrt__text result____split_fields16) o80 o79)))) (= o82 (mk___split_fields4 o81 (rec__display__scrollstrt__len result____split_fields16)))) (= temp___1452 (mk___rep4 o82))) (and (= result10 (mk___split_fields__ref4 result____split_fields16)) (= result____split_fields17 (us_split_fields9 temp___1452)))) (= i12 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))))))))) (and (and (= i18 (mk_int__ref i12)) (= result____split_fields22 (mk___split_fields__ref4 result____split_fields17))) (and (= i19 i12) (= result____split_fields23 result____split_fields17))))))
(assert (=> (and (<= 1 i11) (<= i11 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))))) (= i20 i18)))
(assert (=> (and (<= 1 i11) (<= i11 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))))) (= result____split_fields24 result____split_fields22)))
(assert (=> (and (<= 1 i11) (<= i11 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))))) (= i21 i19)))
(assert (=> (and (<= 1 i11) (<= i11 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))))) (= result____split_fields25 result____split_fields23)))
(assert (=> (not (and (<= 1 i11) (<= i11 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))))) (= i20 (mk_int__ref i11))))
(assert (=> (not (and (<= 1 i11) (<= i11 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))))) (= result____split_fields24 (mk___split_fields__ref4 result____split_fields15))))
(assert (=> (not (and (<= 1 i11) (<= i11 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))))) (= i21 i11)))
(assert (=> (not (and (<= 1 i11) (<= i11 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))))) (= result____split_fields25 result____split_fields15)))
(assert (and (= o83 (+ (to_rep8 (rec__display__scrollstrt__len (us_split_fields__content4 result____split_fields24))) (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))))) (in_range12 (+ (to_rep8 (rec__display__scrollstrt__len (us_split_fields__content4 result____split_fields24))) (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))))))
(assert (= (to_rep8 o84) o83))
(assert (= o85 (mk___split_fields4 (rec__display__scrollstrt__text (us_split_fields__content4 result____split_fields24)) o84)))
(assert (= temp___1460 (mk___rep4 o85)))
(assert (= result12 result____split_fields24))
(assert (= result____split_fields26 (us_split_fields9 temp___1460)))
(assert (= result13 (mk___split_fields__ref4 (mk___split_fields4 c28b__split_fields c28b__split_fields1))))
(assert (= c28b__split_fields2 result____split_fields26))
