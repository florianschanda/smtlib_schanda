...
(assert (=> (< left2 8) (= temp___203 a1)))
(assert (=> (< left2 8) (= temp___199 right1)))
(assert (=> (< left2 8) (= temp___197 a1)))
(assert (=> (< left2 8) (= temp___201 a1)))
(assert (=> (< left2 8) (= temp___196 left2)))
(assert (=> (< left2 8) (= temp___200 a1)))
(assert (=> (< left2 8) (= 0 temp___204)))
(assert (=> (< left2 8) (and (and (and (and (and (= (mod2 (+ left3 1) space2) 0) (= (all_left_elements_in a2 left3 (* (* space2 2) 1000000)) true)) (= (all_right_elements_in a2 (- left3 1) (* space2 1000000)) true)) (= (mod2 (+ left3 1) (* space2 2)) space2)) (=> (<= 8 left3) (or (= left3 8) (= left3 9)))) (forall ((k Int)) (=> (and (<= 0 k) (<= k 7)) (ite (and (and (<= 0 k) (<= k (- left3 space2))) (= (mod2 (+ k 1) (* 2 space2)) 0)) (= (to_rep (select a2 k)) (+ (to_rep (select temp___200 k)) (to_rep (select temp___201 (- k space2))))) (= (to_rep (select a2 k)) (to_rep (select temp___203 k)))))))))
(assert (=> (< left2 8) (and (and (=> (<= 0 2147483647) (in_range2 left3)) (=> (<= 0 2147483647) (in_range2 right2))) (< left3 8))))
(assert (=> (< left2 8) (= temp___2041 result3)))
(assert (=> (< left2 8) (= temp___2042 left3)))
(assert (=> (< left2 8) (and (= o (+ left3 space2)) (in_range1 (+ left3 space2)))))
...
(assert (=> (< left2 8) (and (= o12 (* space2 2)) (in_range1 (* space2 2)))))
...
(assert (=> (< left2 8) (= rho1 temp___2042)))
...
(assert (= space3 o17))
(assert (< space3 8))
(assert (= temp___2292 (mk_int__ref temp___2291)))
(assert (= right8 right6))
(assert (= left9 left7))
(assert (= space4 (mk_int__ref space3)))
(assert (= a8 a6))
(assert (= rho3 rho2))
(assert (= temp___2293 temp___2291))
(assert (= right9 right7))
(assert (= left10 left8))
(assert (= space5 space3))
(assert (= a9 a7))
(assert (not (or (or (= (int__content space4) 1) (= (int__content space4) 2)) (= (int__content space4) 4))))
(check-sat)
(exit)
