...
(assert (not (<= (- (length (mk___rep p__split_discrs (us_split_fields__content p__split_fields4))) (length (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (+ j2 1))))
(check-sat)
(exit)
