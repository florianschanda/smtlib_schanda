...
(assert (forall ((x bounded_integer)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 300)) (in_range3 temp___expr_159)))
...
(define-fun dynamic_invariant2 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= (- 2000) 2000)) (in_range2 temp___expr_166)))
(declare-const s Int)
(declare-const k Int)
(declare-const o Int)
...
(assert (<= i k1))
(assert (<= k1 (- j 1)))
(assert (<= (abs s2) (* k2 2000)))
(assert (= s2 (sum a i k2)))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 s2)) (=> (<= i (- j 1)) (dynamic_property i (- j 1) k2))) (and (<= i k2) (<= k2 (- j 1)))))
(assert (and (= o k2) (in_range3 k2)))
(assert (not (<= i o)))
(check-sat)
(exit)
