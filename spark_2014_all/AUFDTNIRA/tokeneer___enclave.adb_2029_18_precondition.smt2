...
(assert (forall ((temp___1205 Int)) (forall ((temp___1206 Int)) (= (select (temp___1203 temp___1205) temp___1206) (of_rep2 temp___1205)))))
(declare-fun temp___1207 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1209 Int)) (forall ((temp___1210 Int)) (= (select (temp___1207 temp___1209) temp___1210) (of_rep5 temp___1209)))))
(define-fun dynamic_invariant4 ((temp___expr_1197 us_rep2) (temp___is_init_1194 Bool) (temp___skip_constant_1195 Bool) (temp___do_toplevel_1196 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1197))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1197))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1197)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1197))) true))
(define-fun default_initial_assumption ((temp___expr_1201 us_rep2) (temp___skip_top_level_1202 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1201))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1201))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1201)) (mk___rep1 (mk___split_fields1 (temp___1203 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1201)) (temp___1207 0))))
(define-fun type_invariant ((temp___1211 us_rep2)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1211))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1211))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1211)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1211))) true))
...
(define-fun dynamic_invariant5 ((temp___expr_1363 Int) (temp___is_init_1360 Bool) (temp___skip_constant_1361 Bool) (temp___do_toplevel_1362 Bool)) Bool (=> (or (= temp___is_init_1360 true) (<= 0 4294967295)) (in_range12 temp___expr_1363)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant6 ((temp___expr_1369 Int) (temp___is_init_1366 Bool) (temp___skip_constant_1367 Bool) (temp___do_toplevel_1368 Bool)) Bool (=> (or (= temp___is_init_1366 true) (<= 0 2)) (in_range13 temp___expr_1369)))
...
(define-fun dynamic_invariant7 ((temp___expr_2670 Int) (temp___is_init_2667 Bool) (temp___skip_constant_2668 Bool) (temp___do_toplevel_2669 Bool)) Bool (=> (or (= temp___is_init_2667 true) (<= 0 8)) (in_range26 temp___expr_2670)))
...
(define-fun dynamic_invariant9 ((temp___expr_2756 Int) (temp___is_init_2753 Bool) (temp___skip_constant_2754 Bool) (temp___do_toplevel_2755 Bool)) Bool (=> (or (= temp___is_init_2753 true) (<= 0 2)) (in_range27 temp___expr_2756)))
(define-fun dynamic_invariant10 ((temp___expr_445 Int) (temp___is_init_442 Bool) (temp___skip_constant_443 Bool) (temp___do_toplevel_444 Bool)) Bool (=> (or (= temp___is_init_442 true) (<= 0 4)) (in_range3 temp___expr_445)))
(define-fun dynamic_invariant11 ((temp___expr_389 Int) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (or (= temp___is_init_386 true) (<= 1 3)) (in_range5 temp___expr_389)))
(define-fun dynamic_invariant12 ((temp___expr_395 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 5)) (in_range14 temp___expr_395)))
(assert true)
(define-fun dynamic_invariant13 ((temp___expr_978 Int) (temp___is_init_975 Bool) (temp___skip_constant_976 Bool) (temp___do_toplevel_977 Bool)) Bool (=> (or (= temp___is_init_975 true) (<= 0 40)) (in_range20 temp___expr_978)))
(define-fun dynamic_invariant14 ((temp___expr_999 Int) (temp___is_init_996 Bool) (temp___skip_constant_997 Bool) (temp___do_toplevel_998 Bool)) Bool (=> (or (= temp___is_init_996 true) (<= 0 4294967295)) (in_range22 temp___expr_999)))
(define-fun dynamic_invariant15 ((temp___expr_1021 Int) (temp___is_init_1018 Bool) (temp___skip_constant_1019 Bool) (temp___do_toplevel_1020 Bool)) Bool (=> (or (= temp___is_init_1018 true) (<= 0 10)) (in_range19 temp___expr_1021)))
(define-fun dynamic_invariant16 ((temp___expr_1033 Int) (temp___is_init_1030 Bool) (temp___skip_constant_1031 Bool) (temp___do_toplevel_1032 Bool)) Bool (=> (or (= temp___is_init_1030 true) (<= 0 4294967295)) (in_range24 temp___expr_1033)))
(define-fun dynamic_invariant17 ((temp___expr_1039 Int) (temp___is_init_1036 Bool) (temp___skip_constant_1037 Bool) (temp___do_toplevel_1038 Bool)) Bool (=> (or (= temp___is_init_1036 true) (<= 0 128)) (in_range25 temp___expr_1039)))
(define-fun dynamic_invariant18 ((temp___expr_1163 Int) (temp___is_init_1160 Bool) (temp___skip_constant_1161 Bool) (temp___do_toplevel_1162 Bool)) Bool (=> (or (= temp___is_init_1160 true) (<= 0 17)) (in_range9 temp___expr_1163)))
(define-fun dynamic_invariant19 ((temp___expr_1142 Int) (temp___is_init_1139 Bool) (temp___skip_constant_1140 Bool) (temp___do_toplevel_1141 Bool)) Bool (=> (or (= temp___is_init_1139 true) (<= 1 17)) (in_range7 temp___expr_1142)))
(define-fun dynamic_invariant20 ((temp___expr_1267 Int) (temp___is_init_1264 Bool) (temp___skip_constant_1265 Bool) (temp___do_toplevel_1266 Bool)) Bool (=> (or (= temp___is_init_1264 true) (<= 0 2)) (in_range11 temp___expr_1267)))
(define-fun dynamic_invariant21 ((temp___expr_1148 Int) (temp___is_init_1145 Bool) (temp___skip_constant_1146 Bool) (temp___do_toplevel_1147 Bool)) Bool (=> (or (= temp___is_init_1145 true) (<= 0 17408)) (in_range8 temp___expr_1148)))
(define-fun dynamic_invariant22 ((temp___expr_1182 Int) (temp___is_init_1179 Bool) (temp___skip_constant_1180 Bool) (temp___do_toplevel_1181 Bool)) Bool (=> (or (= temp___is_init_1179 true) (<= 0 1024)) (in_range10 temp___expr_1182)))
(assert true)
...
(define-fun dynamic_invariant23 ((temp___expr_560 Int) (temp___is_init_557 Bool) (temp___skip_constant_558 Bool) (temp___do_toplevel_559 Bool)) Bool (=> (or (= temp___is_init_557 true) (<= 1901 2099)) (in_range15 temp___expr_560)))
(define-fun dynamic_invariant24 ((temp___expr_566 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 1 12)) (in_range16 temp___expr_566)))
(define-fun dynamic_invariant25 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 31)) (in_range17 temp___expr_572)))
(define-fun dynamic_invariant26 ((temp___expr_600 Int) (temp___is_init_597 Bool) (temp___skip_constant_598 Bool) (temp___do_toplevel_599 Bool)) Bool (=> (or (= temp___is_init_597 true) (<= 0 86399999)) (in_range18 temp___expr_600)))
(define-fun dynamic_invariant27 ((temp___expr_1433 Int) (temp___is_init_1430 Bool) (temp___skip_constant_1431 Bool) (temp___do_toplevel_1432 Bool)) Bool (=> (or (= temp___is_init_1430 true) (<= 0 4294967295)) (in_range23 temp___expr_1433)))
