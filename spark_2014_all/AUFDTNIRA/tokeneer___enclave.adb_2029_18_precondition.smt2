...
(define-fun dynamic_invariant9 ((temp___expr_2961 Int) (temp___is_init_2957 Bool) (temp___skip_constant_2958 Bool) (temp___do_toplevel_2959 Bool) (temp___do_typ_inv_2960 Bool)) Bool (=> (or (= temp___is_init_2957 true) (<= 0 2)) (in_range27 temp___expr_2961)))
(define-fun dynamic_invariant10 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 4)) (in_range3 temp___expr_496)))
(define-fun dynamic_invariant11 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range5 temp___expr_433)))
(define-fun dynamic_invariant12 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range14 temp___expr_440)))
(assert true)
(define-fun dynamic_invariant13 ((temp___expr_1099 Int) (temp___is_init_1095 Bool) (temp___skip_constant_1096 Bool) (temp___do_toplevel_1097 Bool) (temp___do_typ_inv_1098 Bool)) Bool (=> (or (= temp___is_init_1095 true) (<= 0 40)) (in_range20 temp___expr_1099)))
(define-fun dynamic_invariant14 ((temp___expr_1123 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool) (temp___do_typ_inv_1122 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 4294967295)) (in_range22 temp___expr_1123)))
(define-fun dynamic_invariant15 ((temp___expr_1147 Int) (temp___is_init_1143 Bool) (temp___skip_constant_1144 Bool) (temp___do_toplevel_1145 Bool) (temp___do_typ_inv_1146 Bool)) Bool (=> (or (= temp___is_init_1143 true) (<= 0 10)) (in_range19 temp___expr_1147)))
(define-fun dynamic_invariant16 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 4294967295)) (in_range24 temp___expr_1161)))
(define-fun dynamic_invariant17 ((temp___expr_1168 Int) (temp___is_init_1164 Bool) (temp___skip_constant_1165 Bool) (temp___do_toplevel_1166 Bool) (temp___do_typ_inv_1167 Bool)) Bool (=> (or (= temp___is_init_1164 true) (<= 0 128)) (in_range25 temp___expr_1168)))
(define-fun dynamic_invariant18 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 0 17)) (in_range9 temp___expr_1283)))
(define-fun dynamic_invariant19 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 1 17)) (in_range7 temp___expr_1290)))
(define-fun dynamic_invariant20 ((temp___expr_1416 Int) (temp___is_init_1412 Bool) (temp___skip_constant_1413 Bool) (temp___do_toplevel_1414 Bool) (temp___do_typ_inv_1415 Bool)) Bool (=> (or (= temp___is_init_1412 true) (<= 0 2)) (in_range11 temp___expr_1416)))
(define-fun dynamic_invariant21 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 17408)) (in_range8 temp___expr_1297)))
(define-fun dynamic_invariant22 ((temp___expr_1328 Int) (temp___is_init_1324 Bool) (temp___skip_constant_1325 Bool) (temp___do_toplevel_1326 Bool) (temp___do_typ_inv_1327 Bool)) Bool (=> (or (= temp___is_init_1324 true) (<= 0 1024)) (in_range10 temp___expr_1328)))
(assert true)
...
(assert (forall ((temp___1357 Int)) (=> (dynamic_invariant22 temp___1357 true true true true) (forall ((temp___1358 Int)) (= (to_rep5 (select (temp___1355 temp___1357) temp___1358)) temp___1357)))))
(define-fun dynamic_invariant23 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range15 temp___expr_625)))
(define-fun dynamic_invariant24 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range16 temp___expr_632)))
(define-fun dynamic_invariant25 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range17 temp___expr_639)))
(define-fun dynamic_invariant26 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range18 temp___expr_671)))
(define-fun dynamic_invariant27 ((temp___expr_1603 Int) (temp___is_init_1599 Bool) (temp___skip_constant_1600 Bool) (temp___do_toplevel_1601 Bool) (temp___do_typ_inv_1602 Bool)) Bool (=> (or (= temp___is_init_1599 true) (<= 0 4294967295)) (in_range23 temp___expr_1603)))
...
(assert (forall ((temp___1353 Int)) (=> (dynamic_invariant19 temp___1353 true true true true) (forall ((temp___1354 Int)) (= (to_rep2 (select (temp___1351 temp___1353) temp___1354)) temp___1353)))))
...
(define-fun logfilestate__split_fields17 () us_split_fields4 (mk___split_fields2 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep1 (mk___split_fields1 logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13))
...
(assert (=> (= result true) (= auditsystemfault2 auditsystemfault)))
(assert (=> (= result true) (= auditalarm2 auditalarm)))
(assert (=> (= result true) (= logfilestate__split_fields14 (mk___split_fields2 logfilestate__split_fields logfilestate__split_fields1 (mk___rep1 (mk___split_fields1 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))))
(assert (=> (= result true) (= logfilesstatus2 logfilesstatus)))
(assert (=> (= result true) (= logfiles2 logfiles)))
...
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= theadmin__split_fields3 (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= auditsystemfault2 auditsystemfault))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= auditalarm2 auditalarm))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= logfilestate__split_fields14 (mk___split_fields2 logfilestate__split_fields logfilestate__split_fields1 (mk___rep1 (mk___split_fields1 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6)))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= logfilesstatus2 logfilesstatus))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= logfiles2 logfiles))))
...
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= theadmin__split_fields3 theadmin__split_fields2))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= auditsystemfault2 auditsystemfault1))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= auditalarm2 auditalarm1))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= logfilestate__split_fields14 logfilestate__split_fields17))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= logfilesstatus2 logfilesstatus1))))
(assert (=> (not (= result true)) (=> (not (= result2 true)) (= logfiles2 logfiles1))))
...
(assert (and (= o (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o) (= o (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result3 (ite (= o 1) true false)))
(assert (=> (= result3 true) (and (= o2 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o2 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result3 true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (= result3 true) (and (= result4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result4 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result3 true) (=> (= result4 true) (and (= o1 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range4 o1)))))
(assert (=> (= result3 true) (=> (= result4 true) (= o4 (ite (= o1 3) true false)))))
(assert (=> (= result3 true) (=> (not (= result4 true)) (= o4 false))))
(assert (=> (= result3 true) (= o5 (ite (= o4 false) o3 true))))
(assert (=> (not (= result3 true)) (= o5 (distinct 1 0))))
(assert (and (= result5 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result5 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result5 true))
