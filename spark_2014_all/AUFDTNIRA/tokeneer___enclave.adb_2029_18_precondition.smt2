...
(define-fun bool_eq1 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep2 (select a temp___idx_173)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_173))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep2 (select a temp___idx_173)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(define-fun bool_eq3 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (to_rep5 (select a temp___idx_174)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_174))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (to_rep5 (select a temp___idx_174)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_174)))))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq3 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep5 (select a (+ i 1))) (to_rep5 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq3 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep5 (select b (+ i 1))) (to_rep5 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((temp___1147 Int)) (forall ((temp___1148 Int)) (= (select (temp___1145 temp___1147) temp___1148) (of_rep2 temp___1147)))))
(declare-fun temp___1149 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1151 Int)) (forall ((temp___1152 Int)) (= (select (temp___1149 temp___1151) temp___1152) (of_rep5 temp___1151)))))
(define-fun dynamic_invariant4 ((temp___expr_1139 us_rep2) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1139))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1139))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1139)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1139))) true))
(define-fun default_initial_assumption ((temp___expr_1143 us_rep2) (temp___skip_top_level_1144 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1143))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1143))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1143)) (mk___rep1 (mk___split_fields1 (temp___1145 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1143)) (temp___1149 0))))
(define-fun type_invariant ((temp___1153 us_rep2)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1153))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1153))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1153)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1153))) true))
...
(define-fun bool_eq6 ((a (Array Int us_rep3)) (a__first Int) (a__last Int) (b (Array Int us_rep3)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (bool_eq5 (select a temp___idx_175) (select b (+ (- b__first a__first) temp___idx_175))) true)))) true false))
(assert (forall ((a (Array Int us_rep3)) (b (Array Int us_rep3))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (bool_eq5 (select a temp___idx_175) (select b (+ (- b__first a__first) temp___idx_175))) true))))))))
...
(define-fun bool_eq7 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep6 (select a temp___idx_176)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_176))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep6 (select a temp___idx_176)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_1305 Int) (temp___is_init_1302 Bool) (temp___skip_constant_1303 Bool) (temp___do_toplevel_1304 Bool)) Bool (=> (or (= temp___is_init_1302 true) (<= 0 4294967295)) (in_range12 temp___expr_1305)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant6 ((temp___expr_1311 Int) (temp___is_init_1308 Bool) (temp___skip_constant_1309 Bool) (temp___do_toplevel_1310 Bool)) Bool (=> (or (= temp___is_init_1308 true) (<= 0 2)) (in_range13 temp___expr_1311)))
...
(define-fun bool_eq10 ((a (Array Int character)) (a__first Int) (a__last Int) (b (Array Int character)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_78 Int)) (=> (and (<= a__first temp___idx_78) (<= temp___idx_78 a__last)) (= (to_rep14 (select a temp___idx_78)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_78))))))) true false))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_78 Int)) (=> (and (<= a__first temp___idx_78) (<= temp___idx_78 a__last)) (= (to_rep14 (select a temp___idx_78)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_78)))))))))))
(declare-fun compare3 ((Array Int character) Int Int (Array Int character) Int Int) Int)
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare3 a a_first a_last b b_first b_last) 0) (= (bool_eq10 a a_first a_last b b_first b_last) true)) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare3 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq10 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep14 (select a (+ i 1))) (to_rep14 (select b (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare3 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq10 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep14 (select b (+ i 1))) (to_rep14 (select a (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant7 ((temp___expr_2612 Int) (temp___is_init_2609 Bool) (temp___skip_constant_2610 Bool) (temp___do_toplevel_2611 Bool)) Bool (=> (or (= temp___is_init_2609 true) (<= 0 8)) (in_range26 temp___expr_2612)))
...
(declare-fun user_eq42 (enrolmentstates enrolmentstates) Bool)
(declare-const dummy42 enrolmentstates)
...
(assert true)
(assert (forall ((enclave__status Int)) (! (= (= (enrolmentisinprogress enclave__status) true) (in_range27 enclave__status)) :pattern ((enrolmentisinprogress enclave__status)))))
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-fun ispresent1 (Int us_private Int Int us_split_fields16 us_split_fields22) Bool)
(declare-fun ispresent__function_guard1 (Bool Int us_private Int Int us_split_fields16 us_split_fields22) Bool)
(declare-fun adminlogoncanstart (Int us_split_fields Int us_private Int Int us_split_fields16 us_split_fields22) Bool)
(declare-fun adminlogoncanstart__function_guard (Bool Int us_split_fields Int us_private Int Int us_split_fields16 us_split_fields22) Bool)
(assert true)
(assert (forall ((enclave__status Int) (admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((enclave__startadminactivity__theadmin__fields us_split_fields)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields16)) (forall ((admintoken__idcert__fields us_split_fields22)) (! (= (= (adminlogoncanstart enclave__status enclave__startadminactivity__theadmin__fields admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (and (and (not (= (ispresent (mk___rep enclave__startadminactivity__theadmin__fields)) true)) (= enclave__status 3)) (= (ispresent1 admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true))) :pattern ((adminlogoncanstart enclave__status enclave__startadminactivity__theadmin__fields admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields)))))))))
(declare-fun adminopcanstart (Int us_split_fields Int us_private Int Int us_split_fields16 us_split_fields22) Bool)
(declare-fun adminopcanstart__function_guard (Bool Int us_split_fields Int us_private Int Int us_split_fields16 us_split_fields22) Bool)
(assert true)
(assert (forall ((enclave__status Int) (admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((enclave__startadminactivity__theadmin__fields us_split_fields)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields16)) (forall ((admintoken__idcert__fields us_split_fields22)) (! (= (= (adminopcanstart enclave__status enclave__startadminactivity__theadmin__fields admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (and (and (= (ispresent (mk___rep enclave__startadminactivity__theadmin__fields)) true) (= enclave__status 3)) (= (ispresent1 admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true))) :pattern ((adminopcanstart enclave__status enclave__startadminactivity__theadmin__fields admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields)))))))))
(declare-const attr__ATTRIBUTE_ADDRESS11 Int)
(define-fun dynamic_invariant8 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range21 temp___expr_63)))
(define-fun dynamic_invariant9 ((temp___expr_2698 Int) (temp___is_init_2695 Bool) (temp___skip_constant_2696 Bool) (temp___do_toplevel_2697 Bool)) Bool (=> (or (= temp___is_init_2695 true) (<= 0 2)) (in_range27 temp___expr_2698)))
(define-fun dynamic_invariant10 ((temp___expr_401 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 4)) (in_range3 temp___expr_401)))
(define-fun dynamic_invariant11 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 1 3)) (in_range5 temp___expr_200)))
(define-fun dynamic_invariant12 ((temp___expr_206 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 5)) (in_range14 temp___expr_206)))
(assert true)
(define-fun dynamic_invariant13 ((temp___expr_924 Int) (temp___is_init_921 Bool) (temp___skip_constant_922 Bool) (temp___do_toplevel_923 Bool)) Bool (=> (or (= temp___is_init_921 true) (<= 0 40)) (in_range20 temp___expr_924)))
(define-fun dynamic_invariant14 ((temp___expr_945 Int) (temp___is_init_942 Bool) (temp___skip_constant_943 Bool) (temp___do_toplevel_944 Bool)) Bool (=> (or (= temp___is_init_942 true) (<= 0 4294967295)) (in_range22 temp___expr_945)))
(define-fun dynamic_invariant15 ((temp___expr_967 Int) (temp___is_init_964 Bool) (temp___skip_constant_965 Bool) (temp___do_toplevel_966 Bool)) Bool (=> (or (= temp___is_init_964 true) (<= 0 10)) (in_range19 temp___expr_967)))
(define-fun dynamic_invariant16 ((temp___expr_979 Int) (temp___is_init_976 Bool) (temp___skip_constant_977 Bool) (temp___do_toplevel_978 Bool)) Bool (=> (or (= temp___is_init_976 true) (<= 0 4294967295)) (in_range24 temp___expr_979)))
(define-fun dynamic_invariant17 ((temp___expr_985 Int) (temp___is_init_982 Bool) (temp___skip_constant_983 Bool) (temp___do_toplevel_984 Bool)) Bool (=> (or (= temp___is_init_982 true) (<= 0 128)) (in_range25 temp___expr_985)))
(define-fun dynamic_invariant18 ((temp___expr_1105 Int) (temp___is_init_1102 Bool) (temp___skip_constant_1103 Bool) (temp___do_toplevel_1104 Bool)) Bool (=> (or (= temp___is_init_1102 true) (<= 0 17)) (in_range9 temp___expr_1105)))
(define-fun dynamic_invariant19 ((temp___expr_1084 Int) (temp___is_init_1081 Bool) (temp___skip_constant_1082 Bool) (temp___do_toplevel_1083 Bool)) Bool (=> (or (= temp___is_init_1081 true) (<= 1 17)) (in_range7 temp___expr_1084)))
(define-fun dynamic_invariant20 ((temp___expr_1209 Int) (temp___is_init_1206 Bool) (temp___skip_constant_1207 Bool) (temp___do_toplevel_1208 Bool)) Bool (=> (or (= temp___is_init_1206 true) (<= 0 2)) (in_range11 temp___expr_1209)))
(define-fun dynamic_invariant21 ((temp___expr_1090 Int) (temp___is_init_1087 Bool) (temp___skip_constant_1088 Bool) (temp___do_toplevel_1089 Bool)) Bool (=> (or (= temp___is_init_1087 true) (<= 0 17408)) (in_range8 temp___expr_1090)))
(define-fun dynamic_invariant22 ((temp___expr_1124 Int) (temp___is_init_1121 Bool) (temp___skip_constant_1122 Bool) (temp___do_toplevel_1123 Bool)) Bool (=> (or (= temp___is_init_1121 true) (<= 0 1024)) (in_range10 temp___expr_1124)))
(assert true)
...
(define-fun dynamic_invariant23 ((temp___expr_510 Int) (temp___is_init_507 Bool) (temp___skip_constant_508 Bool) (temp___do_toplevel_509 Bool)) Bool (=> (or (= temp___is_init_507 true) (<= 1901 2099)) (in_range15 temp___expr_510)))
(define-fun dynamic_invariant24 ((temp___expr_516 Int) (temp___is_init_513 Bool) (temp___skip_constant_514 Bool) (temp___do_toplevel_515 Bool)) Bool (=> (or (= temp___is_init_513 true) (<= 1 12)) (in_range16 temp___expr_516)))
(define-fun dynamic_invariant25 ((temp___expr_522 Int) (temp___is_init_519 Bool) (temp___skip_constant_520 Bool) (temp___do_toplevel_521 Bool)) Bool (=> (or (= temp___is_init_519 true) (<= 1 31)) (in_range17 temp___expr_522)))
(define-fun dynamic_invariant26 ((temp___expr_546 Int) (temp___is_init_543 Bool) (temp___skip_constant_544 Bool) (temp___do_toplevel_545 Bool)) Bool (=> (or (= temp___is_init_543 true) (<= 0 86399999)) (in_range18 temp___expr_546)))
(define-fun dynamic_invariant27 ((temp___expr_1375 Int) (temp___is_init_1372 Bool) (temp___skip_constant_1373 Bool) (temp___do_toplevel_1374 Bool)) Bool (=> (or (= temp___is_init_1372 true) (<= 0 4294967295)) (in_range23 temp___expr_1375)))
(assert (forall ((contents us_rep8)) (! (dynamic_invariant1 (therole contents) true false true) :pattern ((therole contents)))))
...
(assert (and (and (and (and (and (and (and (and (and (not (= (enrolmentisinprogress status) true)) (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (and (and (= (isgood tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true) (= (authcertvalid tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) 1)))) (=> (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)) (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1))) (=> (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))) (=> (or (= (statusisgotadmintoken status) true) (= (statusiswaitingremoveadmintokenfail status) true)) (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))) (=> (or (= (statusiswaitingstartadminop status) true) (= (statusiswaitingfinishadminop status) true)) (and (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))) (=> (= (statusisenclavequiescent status) true) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)))) (=> (= (statusisshutdown status) true) (and (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)) (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 0)))) (=> (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 4)) (= (statusiswaitingstartadminop status) true))) (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (or (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true))))))
(assert (and (= result10 (adminlogoncanstart status (mk___split_fields theadmin__split_fields theadmin__split_fields1) tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= result10 true) (and (and (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)) (= status 3)) (= (ispresent1 tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true)))))
(assert (=> (= result10 true) (= result11 (mk_int__ref status))))
(assert (=> (= result10 true) (= status2 5)))
(assert (=> (= result10 true) (= state6 state2)))
(assert (=> (= result10 true) (= state5 state)))
(assert (=> (= result10 true) (= filestate2 filestate)))
(assert (=> (= result10 true) (= theadmin__split_fields3 (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
(assert (=> (= result10 true) (= auditsystemfault2 auditsystemfault)))
(assert (=> (= result10 true) (= auditalarm2 auditalarm)))
(assert (=> (= result10 true) (= logfilestate__split_fields14 (mk___split_fields2 logfilestate__split_fields logfilestate__split_fields1 (mk___rep1 (mk___split_fields1 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))))
(assert (=> (= result10 true) (= logfilesstatus2 logfilesstatus)))
(assert (=> (= result10 true) (= logfiles2 logfiles)))
(assert (=> (= result10 true) (= state6 state4)))
(assert (=> (= result10 true) (= state5 state3)))
(assert (=> (= result10 true) (= filestate2 filestate1)))
(assert (=> (= result10 true) (= theadmin__split_fields3 theadmin__split_fields2)))
(assert (=> (= result10 true) (= auditsystemfault2 auditsystemfault1)))
(assert (=> (= result10 true) (= auditalarm2 auditalarm1)))
(assert (=> (= result10 true) (= logfilestate__split_fields14 (mk___split_fields2 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep1 (mk___split_fields1 logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13))))
(assert (=> (= result10 true) (= logfilesstatus2 logfilesstatus1)))
(assert (=> (= result10 true) (= logfiles2 logfiles1)))
(assert (=> (not (= result10 true)) (and (= result12 (adminopcanstart status (mk___split_fields theadmin__split_fields theadmin__split_fields1) tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= result12 true) (and (and (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= status 3)) (= (ispresent1 tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true))))))
(assert (=> (not (= result10 true)) (=> (= result12 true) (and (and (and (and (and (and (and (and (or (= status3 3) (= status3 6)) (=> (= (rolepresent (mk___rep theadmin__split_fields3)) 1) (and (and (= (isgood tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true) (= (authcertvalid tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)) 1)))) (=> (and (= (isdoingop (mk___rep theadmin__split_fields3)) true) (= (thecurrentop (mk___rep theadmin__split_fields3)) 3)) (= (rolepresent (mk___rep theadmin__split_fields3)) 1))) (=> (= (rolepresent (mk___rep theadmin__split_fields3)) 1) (or (and (= (isdoingop (mk___rep theadmin__split_fields3)) true) (= (thecurrentop (mk___rep theadmin__split_fields3)) 3)) (not (= (isdoingop (mk___rep theadmin__split_fields3)) true))))) (=> (and (= (isdoingop (mk___rep theadmin__split_fields3)) true) (= (thecurrentop (mk___rep theadmin__split_fields3)) 4)) (= status3 6))) (=> (or (= status3 6) (= status3 7)) (and (and (= (isdoingop (mk___rep theadmin__split_fields3)) true) (= (ispresent (mk___rep theadmin__split_fields3)) true)) (= (rolepresent (mk___rep theadmin__split_fields3)) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))) (=> (= status3 3) (and (not (= (isdoingop (mk___rep theadmin__split_fields3)) true)) (= (rolepresent (mk___rep theadmin__split_fields3)) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))) (=> (= status3 8) (and (not (= (isdoingop (mk___rep theadmin__split_fields3)) true)) (= (rolepresent (mk___rep theadmin__split_fields3)) 0)))) (and (and (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields14)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields14)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields14)) true) (in_range6 auditalarm2)) (in_range26 status3))))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= state6 state2))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= state5 state))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= filestate2 filestate))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= status3 status))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= theadmin__split_fields3 (mk___split_fields theadmin__split_fields theadmin__split_fields1)))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= auditsystemfault2 auditsystemfault))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= auditalarm2 auditalarm))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= logfilestate__split_fields14 (mk___split_fields2 logfilestate__split_fields logfilestate__split_fields1 (mk___rep1 (mk___split_fields1 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6)))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= logfilesstatus2 logfilesstatus))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= logfiles2 logfiles))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= state6 state4))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= state5 state3))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= filestate2 filestate1))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= status3 status1))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= theadmin__split_fields3 theadmin__split_fields2))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= auditsystemfault2 auditsystemfault1))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= auditalarm2 auditalarm1))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= logfilestate__split_fields14 (mk___split_fields2 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep1 (mk___split_fields1 logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13)))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= logfilesstatus2 logfilesstatus1))))
(assert (=> (not (= result10 true)) (=> (not (= result12 true)) (= logfiles2 logfiles1))))
(assert (=> (not (= result10 true)) (= status2 status3)))
(assert (= state8 (mk___private__ref state6)))
(assert (= state7 (mk___private__ref state5)))
...
(assert (= logfilestate__split_fields15 (mk___split_fields__ref2 logfilestate__split_fields14)))
...
(assert (= logfilestate__split_fields16 logfilestate__split_fields14))
(assert (= logfilesstatus4 logfilesstatus2))
(assert (= logfiles4 logfiles2))
(assert (and (= o39 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range2 o39) (= o39 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result13 (ite (= o39 1) true false)))
(assert (=> (= result13 true) (and (= o41 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o41 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result13 true) (= o42 (ite (not (= o41 true)) true false))))
(assert (=> (= result13 true) (and (= result14 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result14 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result13 true) (=> (= result14 true) (and (= o40 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range4 o40)))))
(assert (=> (= result13 true) (=> (= result14 true) (= o43 (ite (= o40 3) true false)))))
(assert (=> (= result13 true) (=> (not (= result14 true)) (= o43 false))))
(assert (=> (= result13 true) (= o44 (ite (= o43 false) o42 true))))
(assert (=> (not (= result13 true)) (= o44 (of_int 1))))
(assert (and (= result16 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result16 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result16 true))
(assert (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4))) true)))
(check-sat)
(exit)
