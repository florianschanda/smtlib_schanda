...
(define-fun dynamic_invariant2 ((temp___expr_504 Int) (temp___is_init_501 Bool) (temp___skip_constant_502 Bool) (temp___do_toplevel_503 Bool)) Bool (=> (or (= temp___is_init_501 true) (<= 0 1)) (in_range7 temp___expr_504)))
...
(assert (forall ((temp___1106 Int)) (forall ((temp___1107 Int)) (= (select (temp___1104 temp___1106) temp___1107) (of_rep8 temp___1106)))))
(define-fun dynamic_invariant3 ((temp___expr_1094 us_rep2) (temp___is_init_1091 Bool) (temp___skip_constant_1092 Bool) (temp___do_toplevel_1093 Bool)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1094))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1094))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1094)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1094))) true))
(define-fun default_initial_assumption ((temp___expr_1098 us_rep2) (temp___skip_top_level_1099 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1098))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1098))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1098)) (mk___rep1 (mk___split_fields1 (temp___1100 1) (of_rep5 1) (of_rep5 1) (of_rep7 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1098)) (temp___1104 0))))
(define-fun type_invariant ((temp___1108 us_rep2)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1108))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1108))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1108)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1108))) true))
...
(define-fun dynamic_invariant4 ((temp___expr_2366 Int) (temp___is_init_2363 Bool) (temp___skip_constant_2364 Bool) (temp___do_toplevel_2365 Bool)) Bool (=> (or (= temp___is_init_2363 true) (<= 0 7)) (in_range15 temp___expr_2366)))
...
(define-fun dynamic_invariant9 ((temp___expr_1060 Int) (temp___is_init_1057 Bool) (temp___skip_constant_1058 Bool) (temp___do_toplevel_1059 Bool)) Bool (=> (or (= temp___is_init_1057 true) (<= 0 17)) (in_range11 temp___expr_1060)))
(define-fun dynamic_invariant10 ((temp___expr_1039 Int) (temp___is_init_1036 Bool) (temp___skip_constant_1037 Bool) (temp___do_toplevel_1038 Bool)) Bool (=> (or (= temp___is_init_1036 true) (<= 1 17)) (in_range9 temp___expr_1039)))
(define-fun dynamic_invariant11 ((temp___expr_1164 Int) (temp___is_init_1161 Bool) (temp___skip_constant_1162 Bool) (temp___do_toplevel_1163 Bool)) Bool (=> (or (= temp___is_init_1161 true) (<= 0 2)) (in_range13 temp___expr_1164)))
(define-fun dynamic_invariant12 ((temp___expr_1045 Int) (temp___is_init_1042 Bool) (temp___skip_constant_1043 Bool) (temp___do_toplevel_1044 Bool)) Bool (=> (or (= temp___is_init_1042 true) (<= 0 17408)) (in_range10 temp___expr_1045)))
(define-fun dynamic_invariant13 ((temp___expr_1079 Int) (temp___is_init_1076 Bool) (temp___skip_constant_1077 Bool) (temp___do_toplevel_1078 Bool)) Bool (=> (or (= temp___is_init_1076 true) (<= 0 1024)) (in_range12 temp___expr_1079)))
(assert true)
...
(define-fun dynamic_invariant14 ((temp___expr_526 Int) (temp___is_init_523 Bool) (temp___skip_constant_524 Bool) (temp___do_toplevel_525 Bool)) Bool (=> (or (= temp___is_init_523 true) (<= 1 150)) (in_range8 temp___expr_526)))
...
(define-fun dynamic_invariant16 ((temp___expr_467 Int) (temp___is_init_464 Bool) (temp___skip_constant_465 Bool) (temp___do_toplevel_466 Bool)) Bool (=> (or (= temp___is_init_464 true) (<= 0 4294967295)) (in_range6 temp___expr_467)))
(define-fun dynamic_invariant17 ((temp___expr_1607 Int) (temp___is_init_1604 Bool) (temp___skip_constant_1605 Bool) (temp___do_toplevel_1606 Bool)) Bool (=> (or (= temp___is_init_1604 true) (<= 0 2147483647)) (in_range14 temp___expr_1607)))
...
(declare-const temp___2500 templatelengtht)
(declare-const temp___25001 fart)
(declare-const temp___25002 (Array Int character))
(declare-const temp___25003 (Array Int bytet))
...
(assert (= (mk___rep (mk___split_fields temp___2500 temp___25001 temp___25002 temp___25003)) (getiandatemplate state1)))
...
(assert (= thetemplate__split_fields4 (mk___split_fields temp___2500 temp___25001 temp___25002 temp___25003)))
