...
(define-fun dynamic_invariant1 ((temp___expr_406 Int) (temp___is_init_403 Bool) (temp___skip_constant_404 Bool) (temp___do_toplevel_405 Bool)) Bool (=> (or (= temp___is_init_403 true) (<= 0 1)) (in_range4 temp___expr_406)))
...
(define-fun dynamic_invariant2 ((temp___expr_464 Int) (temp___is_init_461 Bool) (temp___skip_constant_462 Bool) (temp___do_toplevel_463 Bool)) Bool (=> (or (= temp___is_init_461 true) (<= 0 1)) (in_range7 temp___expr_464)))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_150 Int)) (=> (and (<= a__first temp___idx_150) (<= temp___idx_150 a__last)) (= (to_rep5 (select a temp___idx_150)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_150)))))))))))
(declare-fun compare2 ((Array Int logfileindext) Int Int (Array Int logfileindext) Int Int) Int)
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare2 a a_first a_last b b_first b_last) 0) (= (bool_eq4 a a_first a_last b b_first b_last) true)) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq4 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep5 (select b (+ i 1))) (to_rep5 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare3 a a_first a_last b b_first b_last) 0) (= (bool_eq6 a a_first a_last b b_first b_last) true)) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare3 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq6 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep8 (select a (+ i 1))) (to_rep8 (select b (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare3 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq6 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep8 (select b (+ i 1))) (to_rep8 (select a (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
...
(assert (forall ((temp___1050 Int)) (forall ((temp___1051 Int)) (= (select (temp___1048 temp___1050) temp___1051) (of_rep8 temp___1050)))))
(define-fun dynamic_invariant3 ((temp___expr_1038 us_rep2) (temp___is_init_1035 Bool) (temp___skip_constant_1036 Bool) (temp___do_toplevel_1037 Bool)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1038))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1038))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1038)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1038))) true))
(define-fun default_initial_assumption ((temp___expr_1042 us_rep2) (temp___skip_top_level_1043 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1042))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1042))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1042)) (mk___rep1 (mk___split_fields1 (temp___1044 1) (of_rep5 1) (of_rep5 1) (of_rep7 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1042)) (temp___1048 0))))
(define-fun type_invariant ((temp___1052 us_rep2)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1052))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1052))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1052)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1052))) true))
...
(define-fun bool_eq9 ((a (Array Int us_rep3)) (a__first Int) (a__last Int) (b (Array Int us_rep3)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_152 Int)) (=> (and (<= a__first temp___idx_152) (<= temp___idx_152 a__last)) (= (bool_eq8 (select a temp___idx_152) (select b (+ (- b__first a__first) temp___idx_152))) true)))) true false))
...
(assert (forall ((a (Array Int filestatust))) (forall ((first2 Int)) (! (= (slide5 a first2 first2) a) :pattern ((slide5 a first2 first2))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep9 (select a temp___idx_153)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
(declare-fun compare4 ((Array Int filestatust) Int Int (Array Int filestatust) Int Int) Int)
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare4 a a_first a_last b b_first b_last) 0) (= (bool_eq10 a a_first a_last b b_first b_last) true)) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare4 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq10 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep9 (select a (+ i 1))) (to_rep9 (select b (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare4 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq10 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep9 (select b (+ i 1))) (to_rep9 (select a (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
...
(declare-fun to_rep10 (statscount) Int)
(declare-fun of_rep10 (Int) statscount)
(assert (forall ((x statscount)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x statscount)) (! (in_range14 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun dynamic_invariant4 ((temp___expr_2310 Int) (temp___is_init_2307 Bool) (temp___skip_constant_2308 Bool) (temp___do_toplevel_2309 Bool)) Bool (=> (or (= temp___is_init_2307 true) (<= 0 7)) (in_range15 temp___expr_2310)))
...
(define-fun dynamic_invariant9 ((temp___expr_1004 Int) (temp___is_init_1001 Bool) (temp___skip_constant_1002 Bool) (temp___do_toplevel_1003 Bool)) Bool (=> (or (= temp___is_init_1001 true) (<= 0 17)) (in_range11 temp___expr_1004)))
(define-fun dynamic_invariant10 ((temp___expr_983 Int) (temp___is_init_980 Bool) (temp___skip_constant_981 Bool) (temp___do_toplevel_982 Bool)) Bool (=> (or (= temp___is_init_980 true) (<= 1 17)) (in_range9 temp___expr_983)))
(define-fun dynamic_invariant11 ((temp___expr_1108 Int) (temp___is_init_1105 Bool) (temp___skip_constant_1106 Bool) (temp___do_toplevel_1107 Bool)) Bool (=> (or (= temp___is_init_1105 true) (<= 0 2)) (in_range13 temp___expr_1108)))
(define-fun dynamic_invariant12 ((temp___expr_989 Int) (temp___is_init_986 Bool) (temp___skip_constant_987 Bool) (temp___do_toplevel_988 Bool)) Bool (=> (or (= temp___is_init_986 true) (<= 0 17408)) (in_range10 temp___expr_989)))
(define-fun dynamic_invariant13 ((temp___expr_1023 Int) (temp___is_init_1020 Bool) (temp___skip_constant_1021 Bool) (temp___do_toplevel_1022 Bool)) Bool (=> (or (= temp___is_init_1020 true) (<= 0 1024)) (in_range12 temp___expr_1023)))
(assert true)
...
(define-fun dynamic_invariant14 ((temp___expr_486 Int) (temp___is_init_483 Bool) (temp___skip_constant_484 Bool) (temp___do_toplevel_485 Bool)) Bool (=> (or (= temp___is_init_483 true) (<= 1 150)) (in_range8 temp___expr_486)))
(define-fun dynamic_invariant15 ((temp___expr_189 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 255)) (in_range5 temp___expr_189)))
(define-fun dynamic_invariant16 ((temp___expr_427 Int) (temp___is_init_424 Bool) (temp___skip_constant_425 Bool) (temp___do_toplevel_426 Bool)) Bool (=> (or (= temp___is_init_424 true) (<= 0 4294967295)) (in_range6 temp___expr_427)))
(define-fun dynamic_invariant17 ((temp___expr_1551 Int) (temp___is_init_1548 Bool) (temp___skip_constant_1549 Bool) (temp___do_toplevel_1550 Bool)) Bool (=> (or (= temp___is_init_1548 true) (<= 0 2147483647)) (in_range14 temp___expr_1551)))
...
(declare-const temp___2444 templatelengtht)
(declare-const temp___24441 fart)
(declare-const temp___24442 (Array Int character))
(declare-const temp___24443 (Array Int bytet))
...
(declare-const thetemplate__split_fields4 us_split_fields)
...
(assert (= (mk___rep (mk___split_fields temp___2444 temp___24441 temp___24442 temp___24443)) (getiandatemplate state1)))
(assert (= result1 (mk___split_fields__ref (mk___split_fields thetemplate__split_fields thetemplate__split_fields1 thetemplate__split_fields2 thetemplate__split_fields3))))
(assert (= thetemplate__split_fields4 (mk___split_fields temp___2444 temp___24441 temp___24442 temp___24443)))
(assert (and (= o1 (thesystemmaxfar state)) (in_range3 o1)))
(assert (= result2 (mk_int__ref maxfar)))
(assert (= maxfar1 o1))
(assert (=> (< (to_rep2 (rec__iandatypes__templatet__requiredmaxfar thetemplate__split_fields4)) maxfar1) (= result3 (mk_int__ref maxfar1))))
(assert (=> (< (to_rep2 (rec__iandatypes__templatet__requiredmaxfar thetemplate__split_fields4)) maxfar1) (= maxfar2 (to_rep2 (rec__iandatypes__templatet__requiredmaxfar thetemplate__split_fields4)))))
(assert (=> (not (< (to_rep2 (rec__iandatypes__templatet__requiredmaxfar thetemplate__split_fields4)) maxfar1)) (= maxfar2 maxfar1)))
(assert (and (and (and (in_range4 matchresult1) (in_range3 achievedfar1)) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)) (in_range7 auditalarm1)))
(assert (not (= matchresult1 0)))
(assert (= o7 (achievedfardescription achievedfar1)))
(assert (= o7 o8))
(assert (= (mk 1 150) o9))
(assert (= o6 (extractuser state1)))
(assert (not (= (to_rep1 (first o9)) 1)))
(check-sat)
(exit)
