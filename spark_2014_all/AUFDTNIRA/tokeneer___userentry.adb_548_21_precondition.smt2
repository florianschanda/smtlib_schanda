...
(define-fun dynamic_invariant1 ((temp___expr_500 Int) (temp___is_init_496 Bool) (temp___skip_constant_497 Bool) (temp___do_toplevel_498 Bool) (temp___do_typ_inv_499 Bool)) Bool (=> (or (= temp___is_init_496 true) (<= 0 1)) (in_range4 temp___expr_500)))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep5 (select a temp___idx_172)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep8 (select a temp___idx_173)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_1233 us_rep2) (temp___is_init_1229 Bool) (temp___skip_constant_1230 Bool) (temp___do_toplevel_1231 Bool) (temp___do_typ_inv_1232 Bool)) Bool (=> (= temp___do_typ_inv_1232 true) (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1233))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1233))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1233)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1233))) true)))
(define-fun default_initial_assumption ((temp___expr_1237 us_rep2) (temp___skip_top_level_1238 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1237))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1237))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1237)) (mk___rep1 (mk___split_fields1 (temp___1239 1) (of_rep5 1) (of_rep5 1) (of_rep7 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1237)) (temp___1243 0))))
(define-fun type_invariant ((temp___1247 us_rep2)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1247))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1247))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1247)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1247))) true))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep9 (select a temp___idx_175)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_2558 Int) (temp___is_init_2554 Bool) (temp___skip_constant_2555 Bool) (temp___do_toplevel_2556 Bool) (temp___do_typ_inv_2557 Bool)) Bool (=> (or (= temp___is_init_2554 true) (<= 0 7)) (in_range15 temp___expr_2558)))
...
(define-fun dynamic_invariant9 ((temp___expr_1171 Int) (temp___is_init_1167 Bool) (temp___skip_constant_1168 Bool) (temp___do_toplevel_1169 Bool) (temp___do_typ_inv_1170 Bool)) Bool (=> (or (= temp___is_init_1167 true) (<= 0 17)) (in_range11 temp___expr_1171)))
(define-fun dynamic_invariant10 ((temp___expr_1178 Int) (temp___is_init_1174 Bool) (temp___skip_constant_1175 Bool) (temp___do_toplevel_1176 Bool) (temp___do_typ_inv_1177 Bool)) Bool (=> (or (= temp___is_init_1174 true) (<= 1 17)) (in_range9 temp___expr_1178)))
(define-fun dynamic_invariant11 ((temp___expr_1304 Int) (temp___is_init_1300 Bool) (temp___skip_constant_1301 Bool) (temp___do_toplevel_1302 Bool) (temp___do_typ_inv_1303 Bool)) Bool (=> (or (= temp___is_init_1300 true) (<= 0 2)) (in_range13 temp___expr_1304)))
(define-fun dynamic_invariant12 ((temp___expr_1185 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool) (temp___do_typ_inv_1184 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 0 17408)) (in_range10 temp___expr_1185)))
(define-fun dynamic_invariant13 ((temp___expr_1216 Int) (temp___is_init_1212 Bool) (temp___skip_constant_1213 Bool) (temp___do_toplevel_1214 Bool) (temp___do_typ_inv_1215 Bool)) Bool (=> (or (= temp___is_init_1212 true) (<= 0 1024)) (in_range12 temp___expr_1216)))
(assert true)
...
(assert (forall ((temp___1245 Int)) (=> (dynamic_invariant13 temp___1245 true true true true) (forall ((temp___1246 Int)) (= (to_rep8 (select (temp___1243 temp___1245) temp___1246)) temp___1245)))))
(define-fun dynamic_invariant14 ((temp___expr_590 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool) (temp___do_typ_inv_589 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 1 150)) (in_range8 temp___expr_590)))
(define-fun dynamic_invariant15 ((temp___expr_215 Int) (temp___is_init_211 Bool) (temp___skip_constant_212 Bool) (temp___do_toplevel_213 Bool) (temp___do_typ_inv_214 Bool)) Bool (=> (or (= temp___is_init_211 true) (<= 0 255)) (in_range5 temp___expr_215)))
(define-fun dynamic_invariant16 ((temp___expr_524 Int) (temp___is_init_520 Bool) (temp___skip_constant_521 Bool) (temp___do_toplevel_522 Bool) (temp___do_typ_inv_523 Bool)) Bool (=> (or (= temp___is_init_520 true) (<= 0 4294967295)) (in_range6 temp___expr_524)))
(define-fun dynamic_invariant17 ((temp___expr_1781 Int) (temp___is_init_1777 Bool) (temp___skip_constant_1778 Bool) (temp___do_toplevel_1779 Bool) (temp___do_typ_inv_1780 Bool)) Bool (=> (or (= temp___is_init_1777 true) (<= 0 2147483647)) (in_range14 temp___expr_1781)))
(assert (forall ((temp___1241 Int)) (=> (dynamic_invariant10 temp___1241 true true true true) (forall ((temp___1242 Int)) (= (to_rep5 (select (temp___1239 temp___1241) temp___1242)) temp___1241)))))
...
(declare-const temp___2693 templatelengtht)
(declare-const temp___26931 fart)
(declare-const temp___26932 (Array Int character))
(declare-const temp___26933 (Array Int bytet))
...
(assert (= (mk___rep (mk___split_fields temp___2693 temp___26931 temp___26932 temp___26933)) (getiandatemplate state1)))
...
(assert (= thetemplate__split_fields4 (mk___split_fields temp___2693 temp___26931 temp___26932 temp___26933)))
