...
(assert (= target4 o76))
(assert (<= target4 9999))
(assert (and (= temp___1360 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___1360) (<= temp___1360 (to_rep1 n__last))))
(assert (= o77 temp___1360))
(assert (= o78 (select (map__content1 n7) o77)))
(assert (= o79 (to_rep1 o78)))
(assert (= o80 (* o79 10000)))
(assert (and (= o81 o80) (in_range1 o80)))
(assert (= o82 (+ target4 o81)))
