...
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields5)) (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields5))))
(assert (not (<= 0 (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields5)))))
(check-sat)
(exit)
