...
(define-fun dynamic_invariant ((temp___expr_1066 Int) (temp___is_init_1063 Bool) (temp___skip_constant_1064 Bool) (temp___do_toplevel_1065 Bool)) Bool (=> (or (= temp___is_init_1063 true) (<= 0 1)) (in_range2 temp___expr_1066)))
...
(define-fun dynamic_invariant1 ((temp___expr_1072 Int) (temp___is_init_1069 Bool) (temp___skip_constant_1070 Bool) (temp___do_toplevel_1071 Bool)) Bool (=> (or (= temp___is_init_1069 true) (<= 1 17)) (in_range3 temp___expr_1072)))
...
(define-fun dynamic_invariant3 ((temp___expr_1093 Int) (temp___is_init_1090 Bool) (temp___skip_constant_1091 Bool) (temp___do_toplevel_1092 Bool)) Bool (=> (or (= temp___is_init_1090 true) (<= 0 17)) (in_range6 temp___expr_1093)))
(define-fun dynamic_invariant4 ((temp___expr_1184 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 0 2)) (in_range8 temp___expr_1184)))
(define-fun dynamic_invariant5 ((temp___expr_1078 Int) (temp___is_init_1075 Bool) (temp___skip_constant_1076 Bool) (temp___do_toplevel_1077 Bool)) Bool (=> (or (= temp___is_init_1075 true) (<= 0 17408)) (in_range5 temp___expr_1078)))
(define-fun dynamic_invariant6 ((temp___expr_1112 Int) (temp___is_init_1109 Bool) (temp___skip_constant_1110 Bool) (temp___do_toplevel_1111 Bool)) Bool (=> (or (= temp___is_init_1109 true) (<= 0 1024)) (in_range7 temp___expr_1112)))
(assert true)
...
(declare-const temp___1714 logfileindext)
(declare-const temp___17141 logentrycountt)
(declare-const temp___17142 (Array Int logfileindext))
(declare-const temp___17143 logfileindext)
(declare-const temp___17144 logfileindext)
(declare-const temp___17145 logfilecountt)
(declare-const temp___17146 (Array Int fileentrycountt))
...
(assert (= temp___1714 o11))
(assert (= temp___17141 o12))
(assert (= temp___17142 o13))
(assert (= temp___17143 o14))
(assert (= temp___17144 o15))
(assert (= temp___17145 o16))
(assert (= temp___17146 o17))
(assert (= result4 (mk___split_fields__ref1 logfilestate__split_fields7)))
(assert (= logfilestate__split_fields8 (mk___split_fields1 temp___1714 temp___17141 (mk___rep (mk___split_fields temp___17142 temp___17143 temp___17144 temp___17145)) temp___17146)))
