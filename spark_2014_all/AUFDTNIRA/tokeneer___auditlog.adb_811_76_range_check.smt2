...
(declare-const temp___1868 logfileindext)
(declare-const temp___18681 logentrycountt)
(declare-const temp___18682 (Array Int logfileindext))
(declare-const temp___18683 logfileindext)
(declare-const temp___18684 logfileindext)
(declare-const temp___18685 logfilecountt)
(declare-const temp___18686 (Array Int fileentrycountt))
...
(assert (and (and (<= 1 (to_rep1 logfilestate__split_fields5)) (= (to_rep1 logfilestate__split_fields5) 17)) (= (to_rep3 logfilestate__split_fields1) (* (to_rep1 logfilestate__split_fields5) 1024))))
(assert (=> (<= 1 17) (in_range4 head)))
(assert (= result (mk_int__ref head)))
(assert (= head1 (to_rep2 (select logfilestate__split_fields2 (to_rep2 logfilestate__split_fields3)))))
...
(assert (not (= head1 (to_rep2 logfilestate__split_fields))))
...
(assert (and (= o (nextlistindex (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7)))))) (and (in_range4 o) (= o (ite (= (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7)))) 17) 1 (+ (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7)))) 1))))))
(assert (= (to_rep2 o1) o))
...
(assert (= temp___1868 o10))
(assert (= temp___18681 o11))
(assert (= temp___18682 o12))
(assert (= temp___18683 o13))
(assert (= temp___18684 o14))
(assert (= temp___18685 o15))
(assert (= temp___18686 o16))
(assert (= result4 (mk___split_fields__ref1 logfilestate__split_fields7)))
(assert (= logfilestate__split_fields8 (mk___split_fields1 temp___1868 temp___18681 (mk___rep (mk___split_fields temp___18682 temp___18683 temp___18684 temp___18685)) temp___18686)))
(assert (not (in_range3 (- (to_rep1 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) 1))))
(check-sat)
(exit)
