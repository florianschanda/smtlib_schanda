...
(define-fun dynamic_invariant ((temp___expr_1010 Int) (temp___is_init_1007 Bool) (temp___skip_constant_1008 Bool) (temp___do_toplevel_1009 Bool)) Bool (=> (or (= temp___is_init_1007 true) (<= 0 1)) (in_range2 temp___expr_1010)))
...
(define-fun dynamic_invariant1 ((temp___expr_1016 Int) (temp___is_init_1013 Bool) (temp___skip_constant_1014 Bool) (temp___do_toplevel_1015 Bool)) Bool (=> (or (= temp___is_init_1013 true) (<= 1 17)) (in_range3 temp___expr_1016)))
...
(define-fun dynamic_invariant3 ((temp___expr_1037 Int) (temp___is_init_1034 Bool) (temp___skip_constant_1035 Bool) (temp___do_toplevel_1036 Bool)) Bool (=> (or (= temp___is_init_1034 true) (<= 0 17)) (in_range6 temp___expr_1037)))
(define-fun dynamic_invariant4 ((temp___expr_1128 Int) (temp___is_init_1125 Bool) (temp___skip_constant_1126 Bool) (temp___do_toplevel_1127 Bool)) Bool (=> (or (= temp___is_init_1125 true) (<= 0 2)) (in_range8 temp___expr_1128)))
(define-fun dynamic_invariant5 ((temp___expr_1022 Int) (temp___is_init_1019 Bool) (temp___skip_constant_1020 Bool) (temp___do_toplevel_1021 Bool)) Bool (=> (or (= temp___is_init_1019 true) (<= 0 17408)) (in_range5 temp___expr_1022)))
(define-fun dynamic_invariant6 ((temp___expr_1056 Int) (temp___is_init_1053 Bool) (temp___skip_constant_1054 Bool) (temp___do_toplevel_1055 Bool)) Bool (=> (or (= temp___is_init_1053 true) (<= 0 1024)) (in_range7 temp___expr_1056)))
(assert true)
...
(declare-const o12 logentrycountt)
(declare-const o13 (Array Int logfileindext))
(declare-const o14 logfileindext)
(declare-const o15 logfileindext)
(declare-const o16 logfilecountt)
(declare-const o17 (Array Int fileentrycountt))
(declare-const temp___1658 logfileindext)
(declare-const temp___16581 logentrycountt)
(declare-const temp___16582 (Array Int logfileindext))
(declare-const temp___16583 logfileindext)
(declare-const temp___16584 logfileindext)
(declare-const temp___16585 logfilecountt)
(declare-const temp___16586 (Array Int fileentrycountt))
...
(declare-const temp___1661 us_rep2)
(declare-const o23 Int)
(declare-const o24 logentrycountt)
(declare-const o25 us_split_fields2)
(declare-const temp___1663 us_rep2)
...
(declare-const logfilestate__split_fields11 us_split_fields__ref1)
...
(assert (and (and (<= 1 (to_rep3 logfilestate__split_fields5)) (= (to_rep3 logfilestate__split_fields5) 17)) (= (to_rep2 logfilestate__split_fields1) (* (to_rep3 logfilestate__split_fields5) 1024))))
(assert (=> (<= 1 17) (in_range3 head)))
(assert (= result (mk_int__ref head)))
(assert (= head1 (to_rep1 (select logfilestate__split_fields2 (to_rep1 logfilestate__split_fields3)))))
(assert (= result1 (mk_t__ref thefile)))
(assert (= thefile1 (select logfiles head1)))
(assert (= result2 (mk_map__ref3 logfiles)))
(assert (= logfiles1 (store logfiles head1 thefile2)))
(assert (not (= head1 (to_rep1 logfilestate__split_fields))))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 17)) (=> (not (= i head1)) (= (to_rep4 (select auditlog__deletelogfile__logfileentries i)) (to_rep4 (select logfilestate__split_fields6 i)))))))
...
(assert (and (= o1 (nextlistindex (to_rep1 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7)))))) (and (in_range3 o1) (= o1 (ite (= (to_rep1 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7)))) 17) 1 (+ (to_rep1 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7)))) 1))))))
(assert (= (to_rep1 o2) o1))
(assert (= (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7))) o3))
(assert (= o2 o4))
(assert (= (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7))) o5))
(assert (= (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7))) o6))
(assert (= o7 o3))
(assert (= o8 o4))
(assert (= o9 o5))
(assert (= o10 o6))
(assert (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7) o11))
(assert (= (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7) o12))
(assert (= o13 o7))
(assert (= o14 o8))
(assert (= o15 o9))
(assert (= o16 o10))
(assert (= (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7) o17))
(assert (= temp___1658 o11))
(assert (= temp___16581 o12))
(assert (= temp___16582 o13))
(assert (= temp___16583 o14))
(assert (= temp___16584 o15))
(assert (= temp___16585 o16))
(assert (= temp___16586 o17))
(assert (= result4 (mk___split_fields__ref1 logfilestate__split_fields7)))
(assert (= logfilestate__split_fields8 (mk___split_fields1 temp___1658 temp___16581 (mk___rep (mk___split_fields temp___16582 temp___16583 temp___16584 temp___16585)) temp___16586)))
(assert (not (in_range6 (- (to_rep3 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) 1))))
(check-sat)
(exit)
