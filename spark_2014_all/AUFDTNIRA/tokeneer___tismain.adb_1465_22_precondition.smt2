...
(assert (=> (= result18 true) (and (= o44 (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (in_range4 o44))))
(assert (=> (= result18 true) (= result17 (ite (= o44 4) true false))))
(assert (=> (not (= result18 true)) (= result17 false)))
(assert (=> (= result17 true) (and (= o45 (statusiswaitingstartadminop status3 (let ((subject state7)) state23))) (= (= o45 true) (= status3 6)))))
(assert (=> (not (= result17 true)) (= o45 (of_int 1))))
(assert (and (= o41 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o41 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3)))))))
(assert (= result19 (ite (not (= o41 true)) true false)))
(assert (=> (= result19 true) (and (= o42 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o42 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result19 true) (= o43 (ite (not (= o42 true)) true false))))
(assert (=> (not (= result19 true)) (= o43 (of_int 1))))
(assert (and (= o35 (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (and (in_range2 o35) (= o35 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3)))))))
(assert (= result20 (ite (= o35 1) true false)))
(assert (=> (= result20 true) (and (= o37 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o37 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result20 true) (= o38 (ite (not (= o37 true)) true false))))
(assert (=> (= result20 true) (and (= result21 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= result21 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result20 true) (=> (= result21 true) (and (= o36 (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (in_range4 o36)))))
(assert (=> (= result20 true) (=> (= result21 true) (= o39 (ite (= o36 3) true false)))))
(assert (=> (= result20 true) (=> (not (= result21 true)) (= o39 false))))
(assert (=> (= result20 true) (= o40 (ite (= o39 false) o38 true))))
(assert (=> (not (= result20 true)) (= o40 (of_int 1))))
(assert (and (= result22 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= result22 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3)))))))
