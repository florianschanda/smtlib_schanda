...
(assert (<= 0 k11))
(assert (<= k11 (- (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields7)) 1)))
(assert (and (<= 0 k11) (<= k11 5)))
(assert (= o118 k11))
(assert (= o119 (select (map__content f8) o118)))
(assert (= o120 (to_rep2 o119)))
(assert (and (= o121 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o120)) (= (bool_eq o121 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o120)) true)))
(assert (= o122 (us_split_fields1 o121)))
(assert (= o123 (rec__partition_refinement__interval__last o122)))
(assert (= o124 (to_rep1 o123)))
(assert (= o125 (ite (<= k11 o124) true false)))
(assert (and (<= 0 k11) (<= k11 5)))
(assert (= o114 k11))
(assert (= o115 (select (map__content f8) o114)))
(assert (= o116 (to_rep2 o115)))
(assert (not (<= 0 o116)))
(check-sat)
(exit)
