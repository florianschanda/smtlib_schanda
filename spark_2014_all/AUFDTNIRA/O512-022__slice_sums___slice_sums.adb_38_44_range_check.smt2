...
(assert (forall ((lo_index Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index) (<= lo_index (- lo2 1))) (forall ((hi_index Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index) (<= hi_index (to_rep3 (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index) (of_rep1 hi_index)))) max_sum2))))))
...
(assert (and (forall ((lo_index Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index) (<= lo_index (- lo2 1))) (forall ((hi_index Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index) (<= hi_index (to_rep3 (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index) (of_rep1 hi_index)))) max_sum3))))) (forall ((hi_index Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index) (<= hi_index (- hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index)))) max_sum3)))))
...
(assert (and (= o4 hi2) (in_range4 hi2)))
(assert (= (to_rep1 o5) o4))
(assert (not (in_range3 lo2)))
(check-sat)
(exit)
