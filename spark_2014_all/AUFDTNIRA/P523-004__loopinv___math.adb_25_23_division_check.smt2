...
(assert (<= 1 j1))
(assert (<= j1 100))
(assert (and (and (= (sorted v1) true) (forall ((temp___220 Int)) (=> (and (<= 1 temp___220) (<= temp___220 100)) (=> (<= j2 temp___220) (= (select v1 temp___220) (select v temp___220)))))) (and (<= 1 j2) (<= j2 100))))
