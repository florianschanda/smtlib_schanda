...
(assert (= temp___572 (mk_cursor__ref o13)))
...
(assert (=> (= result17 true) (and (= (has_element (mk___rep my_container__split_fields1) (let ((subject temp___572)) temp___5722)) true) (= e7 (element (mk___rep my_container__split_fields1) (let ((subject temp___572)) temp___5722))))))
...
(assert (and (=> (<= 1 200) (in_range3 x20)) (and (= (has_element (mk___rep my_container__split_fields1) (let ((subject temp___579)) temp___5791)) true) (= e15 (element (mk___rep my_container__split_fields1) (let ((subject temp___579)) temp___5791))))))
