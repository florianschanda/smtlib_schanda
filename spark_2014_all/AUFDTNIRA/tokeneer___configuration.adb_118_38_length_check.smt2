...
(assert (= temp___1962 (mk___t4 o144 (mk4 1 (to_rep1 str__last)))))
(assert (not (= (ite (<= (to_rep1 (first8 (rt4 temp___1959))) (to_rep1 (last8 (rt4 temp___1959)))) (+ (- (to_rep1 (last8 (rt4 temp___1959))) (to_rep1 (first8 (rt4 temp___1959)))) 1) 0) (ite (<= (to_rep1 (first8 (rt4 temp___1962))) (to_rep1 (last8 (rt4 temp___1962)))) (+ (- (to_rep1 (last8 (rt4 temp___1962))) (to_rep1 (first8 (rt4 temp___1962)))) 1) 0))))
(check-sat)
(exit)
