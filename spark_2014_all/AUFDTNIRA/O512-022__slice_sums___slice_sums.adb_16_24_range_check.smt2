...
(assert (forall ((lo_index1 Int)) (=> (and (<= (to_rep (first (rt x))) lo_index1) (<= lo_index1 (- lo2 1))) (forall ((hi_index Int)) (=> (and (<= (to_rep (first (rt x))) hi_index) (<= hi_index (to_rep (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index1) (of_rep1 hi_index)))) max_sum2))))))
