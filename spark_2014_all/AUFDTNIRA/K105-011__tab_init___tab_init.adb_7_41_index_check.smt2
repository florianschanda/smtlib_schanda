...
(assert (and (and (=> (<= 1 10) (in_range3 i2)) (forall ((temp___177 Int)) (=> (and (<= 1 temp___177) (<= temp___177 10)) (=> (or (< 10 temp___177) (or (< temp___177 1) (< i2 temp___177))) (= (select t2 temp___177) (select t temp___177)))))) (and (<= 1 i2) (<= i2 10))))
(assert (<= 1 j))
(assert (<= j i2))
(assert (and (= o3 (* a j)) (in_range1 (* a j))))
(assert (not (<= j 10)))
(check-sat)
(exit)
