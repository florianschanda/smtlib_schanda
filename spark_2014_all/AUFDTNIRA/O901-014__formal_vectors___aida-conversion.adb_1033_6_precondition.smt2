...
(assert (and (= temp___1738 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1738) (<= temp___1738 (to_rep1 (last (rt source))))))
(assert (= o44 temp___1738))
(assert (= o45 (select (elts source) o44)))
(assert (= o46 (to_rep o45)))
(assert (and (= o47 (convert_character_digit_to_integer o46)) (and (in_range1 o47) (and (and (<= 0 o47) (<= o47 9)) (ite (= (= o46 48) true) (= o47 0) (ite (= (= o46 49) true) (= o47 1) (ite (= (= o46 50) true) (= o47 2) (ite (= (= o46 51) true) (= o47 3) (ite (= (= o46 52) true) (= o47 4) (ite (= (= o46 53) true) (= o47 5) (ite (= (= o46 54) true) (= o47 6) (ite (= (= o46 55) true) (= o47 7) (ite (= (= o46 56) true) (= o47 8) (=> (= (= o46 57) true) (= o47 9)))))))))))))))
(assert (= o48 (* o47 10)))
(assert (and (= o49 o48) (in_range1 o48)))
(assert (and (= temp___1737 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1737) (<= temp___1737 (to_rep1 (last (rt source))))))
(assert (= o39 temp___1737))
(assert (= o40 (select (elts source) o39)))
(assert (= o41 (to_rep o40)))
(assert (not (= (is_digit o41) true)))
(check-sat)
(exit)
