...
(assert (=> (<= (to_rep1 (first4 temp___6551)) (to_rep1 (last4 temp___6551))) (= o6 (+ (- (to_rep1 (last4 temp___6551)) (to_rep1 (first4 temp___6551))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___6551)) (to_rep1 (last4 temp___6551)))) (= o6 0)))
(assert (=> (<= (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))) (= o7 (+ (- (to_rep1 (last (rt s))) (to_rep1 (first (rt s)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt s))) (to_rep1 (last (rt s))))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep1 (first (rt s))) o8)))
(assert (= o10 (- o9 1)))
