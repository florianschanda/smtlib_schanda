...
(assert (=> (<= (to_rep1 (first4 temp___6611)) (to_rep1 (last4 temp___6611))) (= o1 (+ (- (to_rep1 (last4 temp___6611)) (to_rep1 (first4 temp___6611))) 1))))
(assert (=> (not (<= (to_rep1 (first4 temp___6611)) (to_rep1 (last4 temp___6611)))) (= o1 0)))
(assert (=> (<= (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))) (= o2 (+ (- (to_rep1 (last (rt s))) (to_rep1 (first (rt s)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt s))) (to_rep1 (last (rt s))))) (= o2 0)))
(assert (= o3 (+ o2 o1)))
(assert (= o4 (+ (to_rep1 (first (rt s))) o3)))
(assert (= o5 (- o4 1)))
