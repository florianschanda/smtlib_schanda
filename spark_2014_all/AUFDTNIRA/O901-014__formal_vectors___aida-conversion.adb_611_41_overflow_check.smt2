...
(assert (forall ((temp___1452 Int) (temp___1453 Int) (temp___1454 Int) (temp___1455 Int) (temp___1456 Int) (temp___1457 Int) (temp___1458 Int) (temp___1459 Int) (temp___1460 Int) (temp___1461 Int) (temp___1462 Int) (temp___1463 Int)) (let ((temp___1451 (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__aggregate_def temp___1452 temp___1453 temp___1454 temp___1455 temp___1456 temp___1457 temp___1458 temp___1459 temp___1460 temp___1461 temp___1462 temp___1463))) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1462 temp___1463) (and (= (first5 temp___1451) temp___1462) (= (last5 temp___1451) temp___1463))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1451) (+ (first1 source) 0)) (of_rep1 temp___1452)) (= (select (to_array2 temp___1451) (+ (first1 source) 1)) (of_rep1 temp___1453))) (= (select (to_array2 temp___1451) (+ (first1 source) 2)) (of_rep1 temp___1454))) (= (select (to_array2 temp___1451) (+ (first1 source) 3)) (of_rep1 temp___1455))) (= (select (to_array2 temp___1451) (+ (first1 source) 4)) (of_rep1 temp___1456))) (= (select (to_array2 temp___1451) (+ (first1 source) 5)) (of_rep1 temp___1457))) (= (select (to_array2 temp___1451) (+ (first1 source) 6)) (of_rep1 temp___1458))) (= (select (to_array2 temp___1451) (+ (first1 source) 7)) (of_rep1 temp___1459))) (= (select (to_array2 temp___1451) (+ (first1 source) 8)) (of_rep1 temp___1460))) (= (select (to_array2 temp___1451) (+ (first1 source) 9)) (of_rep1 temp___1461)))))))
(declare-sort t6 0)
...
(assert (forall ((temp___1469 Int) (temp___1470 Int) (temp___1471 Int)) (let ((temp___1468 (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__aggregate_def temp___1469 temp___1470 temp___1471))) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1470 temp___1471) (and (= (first9 temp___1468) temp___1470) (= (last9 temp___1468) temp___1471))) (forall ((temp___1472 Int)) (= (select (to_array4 temp___1468) temp___1472) (of_rep1 temp___1469)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_293 us_t3) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool)) Bool (=> (not (= temp___skip_constant_291 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_293) (last7 temp___expr_293)) (and (= (first7 temp___expr_293) (first1 source)) (= (last7 temp___expr_293) (+ (first1 source) 9))))))
...
(declare-const temp___1466 (Array Int integer))
(declare-const temp___14661 t2)
...
(declare-const temp___1474 (Array Int integer))
(declare-const temp___14741 t4)
...
(declare-const temp___1479 Int)
(declare-const temp___1477 (Array Int integer))
...
(assert (and (and (= (length source) 10) (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52))) (forall ((index11 Int)) (=> (and (<= (to_rep1 (first (rt source))) index11) (<= index11 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
...
(assert (= (mk___t2 temp___1466 temp___14661) (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__aggregate_def 2 1 3 9 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___14661)) (to_rep1 (last4 temp___14661))) (+ (- (to_rep1 (last4 temp___14661)) (to_rep1 (first4 temp___14661))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1466 (to_rep1 (first4 temp___14661)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__assume))
...
(assert (= (mk___t4 temp___1474 temp___14741) (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___14741)) (to_rep1 (last8 temp___14741))) (+ (- (to_rep1 (last8 temp___14741)) (to_rep1 (first8 temp___14741))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1474 (to_rep1 (first8 temp___14741)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__assume))
...
(assert (and (= temp___1481 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index2 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= temp___1479 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= temp___1477 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= o9 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= o10 (select n1 o9))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= o11 (to_rep1 o10))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= o11 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= o12 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= o13 (select (elts source) o12))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= o14 (to_rep o13))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o14))) (ite (= (= o14 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o14 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o14 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o14 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o14 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o14 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o14 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o14 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o14 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o14 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= (to_rep1 o15) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= o16 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= o17 (store n1 o16 o15))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= n2 o17)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (and (and (forall ((temp___1478 Int)) (=> (and (<= (to_rep1 n__first) temp___1478) (<= temp___1478 (to_rep1 n__last))) (=> (< index3 temp___1478) (= (select n3 temp___1478) (select temp___1477 temp___1478))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= index3 temp___1481)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= index3 index5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= n3 n5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= index6 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= n6 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= index8 index6)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (= n8 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481))) (= index8 index2)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481))) (= n8 n1)))
...
(assert (and (= temp___1482 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1482) (<= temp___1482 (to_rep1 n__last))))
(assert (= o41 temp___1482))
(assert (= o42 (select (map__content1 n7) o41)))
(assert (= o43 (to_rep1 o42)))
(assert (= result6 (mk_int__ref target)))
(assert (= target1 o43))
(assert (<= target1 9))
(assert (and (= temp___1483 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1483) (<= temp___1483 (to_rep1 n__last))))
(assert (= o44 temp___1483))
(assert (= o45 (select (map__content1 n7) o44)))
(assert (= o46 (to_rep1 o45)))
(assert (= o47 (* o46 10)))
(assert (and (= o48 o47) (in_range1 o47)))
(assert (= o49 (+ target1 o48)))
(assert (and (= o50 o49) (in_range1 o49)))
(assert (= result7 (mk_int__ref target1)))
(assert (= target2 o50))
(assert (<= target2 99))
(assert (and (= temp___1484 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1484) (<= temp___1484 (to_rep1 n__last))))
(assert (= o51 temp___1484))
(assert (= o52 (select (map__content1 n7) o51)))
(assert (= o53 (to_rep1 o52)))
(assert (= o54 (* o53 100)))
(assert (and (= o55 o54) (in_range1 o54)))
(assert (= o56 (+ target2 o55)))
(assert (and (= o57 o56) (in_range1 o56)))
(assert (= result8 (mk_int__ref target2)))
(assert (= target3 o57))
(assert (<= target3 999))
(assert (and (= temp___1485 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___1485) (<= temp___1485 (to_rep1 n__last))))
(assert (= o58 temp___1485))
(assert (= o59 (select (map__content1 n7) o58)))
(assert (= o60 (to_rep1 o59)))
(assert (= o61 (* o60 1000)))
(assert (and (= o62 o61) (in_range1 o61)))
(assert (= o63 (+ target3 o62)))
(assert (and (= o64 o63) (in_range1 o63)))
(assert (= result9 (mk_int__ref target3)))
(assert (= target4 o64))
(assert (<= target4 9999))
(assert (and (= temp___1486 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___1486) (<= temp___1486 (to_rep1 n__last))))
(assert (= o65 temp___1486))
(assert (= o66 (select (map__content1 n7) o65)))
(assert (= o67 (to_rep1 o66)))
(assert (= o68 (* o67 10000)))
(assert (and (= o69 o68) (in_range1 o68)))
(assert (= o70 (+ target4 o69)))
(assert (and (= o71 o70) (in_range1 o70)))
(assert (= result10 (mk_int__ref target4)))
(assert (= target5 o71))
(assert (<= target5 99999))
(assert (and (= temp___1487 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___1487) (<= temp___1487 (to_rep1 n__last))))
(assert (= o72 temp___1487))
(assert (= o73 (select (map__content1 n7) o72)))
(assert (= o74 (to_rep1 o73)))
(assert (= o75 (* o74 100000)))
(assert (and (= o76 o75) (in_range1 o75)))
(assert (= o77 (+ target5 o76)))
(assert (and (= o78 o77) (in_range1 o77)))
(assert (= result11 (mk_int__ref target5)))
(assert (= target6 o78))
(assert (<= target6 999999))
(assert (and (= temp___1488 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___1488) (<= temp___1488 (to_rep1 n__last))))
(assert (= o79 temp___1488))
(assert (= o80 (select (map__content1 n7) o79)))
(assert (= o81 (to_rep1 o80)))
(assert (= o82 (* o81 1000000)))
(assert (and (= o83 o82) (in_range1 o82)))
(assert (= o84 (+ target6 o83)))
