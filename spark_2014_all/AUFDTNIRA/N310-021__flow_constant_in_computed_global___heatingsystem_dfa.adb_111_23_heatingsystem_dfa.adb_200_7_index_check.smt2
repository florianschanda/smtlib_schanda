...
(assert (=> (= result9 true) (=> (= slowadvance3 true) (= result10 (mk_int__ref timer5)))))
(assert (=> (= result9 true) (=> (= slowadvance3 true) (= timer6 (mod2 (+ timer5 60) 86400)))))
(assert (=> (= result9 true) (=> (not (= slowadvance3 true)) (= timer6 timer5))))
(assert (=> (= result9 true) (=> (not (= changetofastmode3 true)) (= advancemode3 advancemode))))
(assert (=> (= result9 true) (= changetoslowmode3 changetoslowmode1)))
(assert (=> (= result9 true) (= fastadvance3 fastadvance1)))
(assert (=> (not (= result9 true)) (=> (= fastadvance3 true) (= result11 (mk_int__ref timer5)))))
(assert (=> (not (= result9 true)) (=> (= fastadvance3 true) (= timer7 (mod2 (+ timer5 600) 86400)))))
(assert (=> (not (= result9 true)) (=> (not (= fastadvance3 true)) (= timer7 timer5))))
(assert (=> (not (= result9 true)) (=> (not (= changetoslowmode3 true)) (= advancemode4 advancemode))))
(assert (=> (not (= result9 true)) (= advtimer3 advtimer4)))
(assert (=> (not (= result9 true)) (= advpressed3 advpressed4)))
(assert (=> (not (= result9 true)) (= advancemode3 advancemode4)))
(assert (=> (not (= result9 true)) (= changetofastmode3 changetofastmode1)))
(assert (=> (not (= result9 true)) (= slowadvance3 slowadvance1)))
(assert (=> (not (= result9 true)) (= timer6 timer7)))
(assert (= (to_rep o5) timer6))
