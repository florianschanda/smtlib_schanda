...
(assert (not (= (length temp___1907) 0)))
(assert (=> (<= (to_rep1 (first2 temp___19081)) (to_rep1 (last2 temp___19081))) (= o42 (+ (- (to_rep1 (last2 temp___19081)) (to_rep1 (first2 temp___19081))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___19081)) (to_rep1 (last2 temp___19081)))) (= o42 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1907))) (to_rep1 (last (rt temp___1907)))) (= o43 (+ (- (to_rep1 (last (rt temp___1907))) (to_rep1 (first (rt temp___1907)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1907))) (to_rep1 (last (rt temp___1907))))) (= o43 0)))
(assert (= o44 (+ o43 o42)))
(assert (= o45 (+ (to_rep1 (first (rt temp___1907))) o44)))
(assert (= o46 (- o45 1)))
