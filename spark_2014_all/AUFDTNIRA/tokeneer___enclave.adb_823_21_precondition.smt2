...
(define-fun dynamic_invariant2 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range9 temp___expr_548)))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep7 (select a temp___idx_196)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_1345 us_rep2) (temp___is_init_1341 Bool) (temp___skip_constant_1342 Bool) (temp___do_toplevel_1343 Bool) (temp___do_typ_inv_1344 Bool)) Bool (=> (= temp___do_typ_inv_1344 true) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1345))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1345))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1345)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1345))) true)))
(define-fun default_initial_assumption ((temp___expr_1349 us_rep2) (temp___skip_top_level_1350 Bool)) Bool (and (and (and (= (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1349))) 1) (= (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1349))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1349)) (mk___rep1 (mk___split_fields1 (temp___1351 1) (of_rep4 1) (of_rep4 1) (of_rep6 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1349)) (temp___1355 0))))
(define-fun type_invariant ((temp___1359 us_rep2)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1359))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1359))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1359)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1359))) true))
...
(define-fun bool_eq8 ((a (Array Int us_rep3)) (a__first Int) (a__last Int) (b (Array Int us_rep3)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq7 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true)))) true false))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_198 Int)) (=> (and (<= a__first temp___idx_198) (<= temp___idx_198 a__last)) (= (to_rep8 (select a temp___idx_198)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_198)))))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_1524 Int) (temp___is_init_1520 Bool) (temp___skip_constant_1521 Bool) (temp___do_toplevel_1522 Bool) (temp___do_typ_inv_1523 Bool)) Bool (=> (or (= temp___is_init_1520 true) (<= 0 4294967295)) (in_range15 temp___expr_1524)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant5 ((temp___expr_1531 Int) (temp___is_init_1527 Bool) (temp___skip_constant_1528 Bool) (temp___do_toplevel_1529 Bool) (temp___do_typ_inv_1530 Bool)) Bool (=> (or (= temp___is_init_1527 true) (<= 0 2)) (in_range16 temp___expr_1531)))
...
(define-fun dynamic_invariant6 ((temp___expr_2874 Int) (temp___is_init_2870 Bool) (temp___skip_constant_2871 Bool) (temp___do_toplevel_2872 Bool) (temp___do_typ_inv_2873 Bool)) Bool (=> (or (= temp___is_init_2870 true) (<= 0 8)) (in_range28 temp___expr_2874)))
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-const attr__ATTRIBUTE_ADDRESS11 Int)
(declare-const attr__ATTRIBUTE_ADDRESS12 Int)
(declare-fun temp___String_Literal_3421 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_3421 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 3)) 99)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 6)) 118)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 9)) 67)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 10)) 97)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 11)) 110)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 13)) 101)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 15)) 108)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 17)) 100)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 19)) 45)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 21)) 70)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 22)) 108)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 23)) 111)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 24)) 112)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 25)) 112)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 26)) 121)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 28)) 104)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 29)) 97)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 30)) 115)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 32)) 98)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 33)) 101)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 34)) 101)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 35)) 110)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 37)) 114)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 38)) 101)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 39)) 109)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 40)) 111)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 41)) 118)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 42)) 101)) (= (to_rep (select (temp___String_Literal_3421 us_void_param) 43)) 100)) :pattern ((temp___String_Literal_3421 us_void_param)))))
(declare-fun temp___String_Literal_3422 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_3422 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 3)) 99)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 6)) 118)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 9)) 67)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 10)) 97)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 11)) 110)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 13)) 101)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 15)) 108)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 17)) 100)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 19)) 45)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 21)) 70)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 22)) 108)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 23)) 111)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 24)) 112)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 25)) 112)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 26)) 121)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 28)) 104)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 29)) 97)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 30)) 115)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 32)) 98)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 33)) 97)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 34)) 100)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 36)) 100)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 37)) 97)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 38)) 116)) (= (to_rep (select (temp___String_Literal_3422 us_void_param) 39)) 97)) :pattern ((temp___String_Literal_3422 us_void_param)))))
...
(define-fun dynamic_invariant11 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 4)) (in_range6 temp___expr_496)))
(define-fun dynamic_invariant12 ((temp___expr_503 Int) (temp___is_init_499 Bool) (temp___skip_constant_500 Bool) (temp___do_toplevel_501 Bool) (temp___do_typ_inv_502 Bool)) Bool (=> (or (= temp___is_init_499 true) (<= 1 4)) (in_range7 temp___expr_503)))
(define-fun dynamic_invariant13 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range8 temp___expr_433)))
(define-fun dynamic_invariant14 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range17 temp___expr_440)))
(define-fun dynamic_invariant15 ((temp___expr_1099 Int) (temp___is_init_1095 Bool) (temp___skip_constant_1096 Bool) (temp___do_toplevel_1097 Bool) (temp___do_typ_inv_1098 Bool)) Bool (=> (or (= temp___is_init_1095 true) (<= 0 40)) (in_range23 temp___expr_1099)))
(define-fun dynamic_invariant16 ((temp___expr_1123 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool) (temp___do_typ_inv_1122 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 4294967295)) (in_range24 temp___expr_1123)))
(define-fun dynamic_invariant17 ((temp___expr_1147 Int) (temp___is_init_1143 Bool) (temp___skip_constant_1144 Bool) (temp___do_toplevel_1145 Bool) (temp___do_typ_inv_1146 Bool)) Bool (=> (or (= temp___is_init_1143 true) (<= 0 10)) (in_range22 temp___expr_1147)))
(define-fun dynamic_invariant18 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 4294967295)) (in_range26 temp___expr_1161)))
(define-fun dynamic_invariant19 ((temp___expr_1168 Int) (temp___is_init_1164 Bool) (temp___skip_constant_1165 Bool) (temp___do_toplevel_1166 Bool) (temp___do_typ_inv_1167 Bool)) Bool (=> (or (= temp___is_init_1164 true) (<= 0 128)) (in_range27 temp___expr_1168)))
(define-fun dynamic_invariant20 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 0 17)) (in_range12 temp___expr_1283)))
(define-fun dynamic_invariant21 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 1 17)) (in_range10 temp___expr_1290)))
(define-fun dynamic_invariant22 ((temp___expr_1416 Int) (temp___is_init_1412 Bool) (temp___skip_constant_1413 Bool) (temp___do_toplevel_1414 Bool) (temp___do_typ_inv_1415 Bool)) Bool (=> (or (= temp___is_init_1412 true) (<= 0 2)) (in_range14 temp___expr_1416)))
(define-fun dynamic_invariant23 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 17408)) (in_range11 temp___expr_1297)))
(define-fun dynamic_invariant24 ((temp___expr_1328 Int) (temp___is_init_1324 Bool) (temp___skip_constant_1325 Bool) (temp___do_toplevel_1326 Bool) (temp___do_typ_inv_1327 Bool)) Bool (=> (or (= temp___is_init_1324 true) (<= 0 1024)) (in_range13 temp___expr_1328)))
(assert true)
...
(assert (forall ((temp___1357 Int)) (=> (dynamic_invariant24 temp___1357 true true true true) (forall ((temp___1358 Int)) (= (to_rep7 (select (temp___1355 temp___1357) temp___1358)) temp___1357)))))
(define-fun dynamic_invariant25 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range18 temp___expr_625)))
(define-fun dynamic_invariant26 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range19 temp___expr_632)))
(define-fun dynamic_invariant27 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range20 temp___expr_639)))
(define-fun dynamic_invariant28 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range21 temp___expr_671)))
(define-fun dynamic_invariant29 ((temp___expr_1603 Int) (temp___is_init_1599 Bool) (temp___skip_constant_1600 Bool) (temp___do_toplevel_1601 Bool) (temp___do_typ_inv_1602 Bool)) Bool (=> (or (= temp___is_init_1599 true) (<= 0 4294967295)) (in_range25 temp___expr_1603)))
(assert (forall ((temp___1353 Int)) (=> (dynamic_invariant21 temp___1353 true true true true) (forall ((temp___1354 Int)) (= (to_rep4 (select (temp___1351 temp___1353) temp___1354)) temp___1353)))))
...
(assert (and (in_range9 auditalarm1) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)))
(assert (= o (extractuser tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))))
