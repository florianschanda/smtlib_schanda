...
(define-fun dynamic_invariant2 ((temp___expr_446 Int) (temp___is_init_443 Bool) (temp___skip_constant_444 Bool) (temp___do_toplevel_445 Bool)) Bool (=> (or (= temp___is_init_443 true) (<= 0 1)) (in_range9 temp___expr_446)))
...
(define-fun bool_eq3 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep4 (select a temp___idx_173)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_173))))))) true false))
...
(define-fun bool_eq5 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (to_rep7 (select a temp___idx_174)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_174))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (to_rep7 (select a temp___idx_174)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_174)))))))))))
...
(assert (forall ((temp___1147 Int)) (forall ((temp___1148 Int)) (= (select (temp___1145 temp___1147) temp___1148) (of_rep4 temp___1147)))))
(declare-fun temp___1149 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1151 Int)) (forall ((temp___1152 Int)) (= (select (temp___1149 temp___1151) temp___1152) (of_rep7 temp___1151)))))
(define-fun dynamic_invariant3 ((temp___expr_1139 us_rep2) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1139))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1139))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1139)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1139))) true))
(define-fun default_initial_assumption ((temp___expr_1143 us_rep2) (temp___skip_top_level_1144 Bool)) Bool (and (and (and (= (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1143))) 1) (= (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1143))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1143)) (mk___rep1 (mk___split_fields1 (temp___1145 1) (of_rep4 1) (of_rep4 1) (of_rep6 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1143)) (temp___1149 0))))
(define-fun type_invariant ((temp___1153 us_rep2)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1153))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1153))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1153)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1153))) true))
...
(define-fun bool_eq8 ((a (Array Int us_rep3)) (a__first Int) (a__last Int) (b (Array Int us_rep3)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (bool_eq7 (select a temp___idx_175) (select b (+ (- b__first a__first) temp___idx_175))) true)))) true false))
(assert (forall ((a (Array Int us_rep3)) (b (Array Int us_rep3))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (bool_eq7 (select a temp___idx_175) (select b (+ (- b__first a__first) temp___idx_175))) true))))))))
...
(define-fun bool_eq9 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep8 (select a temp___idx_176)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_176))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep8 (select a temp___idx_176)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
...
(declare-fun user_eq21 (tokenidt tokenidt) Bool)
(declare-const dummy21 tokenidt)
...
(define-fun dynamic_invariant4 ((temp___expr_1305 Int) (temp___is_init_1302 Bool) (temp___skip_constant_1303 Bool) (temp___do_toplevel_1304 Bool)) Bool (=> (or (= temp___is_init_1302 true) (<= 0 4294967295)) (in_range15 temp___expr_1305)))
(declare-sort tryt 0)
...
(declare-fun user_eq22 (tryt tryt) Bool)
(declare-const dummy22 tryt)
...
(define-fun dynamic_invariant5 ((temp___expr_1311 Int) (temp___is_init_1308 Bool) (temp___skip_constant_1309 Bool) (temp___do_toplevel_1310 Bool)) Bool (=> (or (= temp___is_init_1308 true) (<= 0 2)) (in_range16 temp___expr_1311)))
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-sort classt 0)
(define-fun in_range17 ((x Int)) Bool (and (<= 0 x) (<= x 5)))
...
(assert (forall ((x classt)) (! (in_range17 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun bool_eq10 ((a us_rep4) (b us_rep4)) Bool (ite (= (to_rep9 (rec__privtypes__clearancet__class (us_split_fields7 a))) (to_rep9 (rec__privtypes__clearancet__class (us_split_fields7 b)))) true false))
...
(define-fun in_range18 ((x Int)) Bool (and (<= 1901 x) (<= x 2099)))
...
(declare-fun to_rep13 (millisecst) Int)
(declare-fun of_rep13 (Int) millisecst)
(assert (forall ((x millisecst)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x millisecst)) (! (in_range21 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun bool_eq14 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (and (and (= (bool_eq13 (rec__cert__attr__auth__contentst__id (us_split_fields15 a)) (rec__cert__attr__auth__contentst__id (us_split_fields15 b))) true) (= (bool_eq11 (rec__cert__attr__auth__contentst__notbefore (us_split_fields15 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq11 (rec__cert__attr__auth__contentst__notafter (us_split_fields15 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep14 (rec__cert__attr__auth__contentst__mechanism (us_split_fields15 a))) (to_rep14 (rec__cert__attr__auth__contentst__mechanism (us_split_fields15 b))))) (= (bool_eq13 (rec__cert__attr__auth__contentst__basecertid (us_split_fields15 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields15 b))) true)) (= (to_rep2 (rec__cert__attr__auth__contentst__role (us_split_fields15 a))) (to_rep2 (rec__cert__attr__auth__contentst__role (us_split_fields15 b))))) (= (bool_eq10 (rec__cert__attr__auth__contentst__clearance (us_split_fields15 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields15 b))) true)) true false))
...
(define-fun dynamic_invariant6 ((temp___expr_2612 Int) (temp___is_init_2609 Bool) (temp___skip_constant_2610 Bool) (temp___do_toplevel_2611 Bool)) Bool (=> (or (= temp___is_init_2609 true) (<= 0 8)) (in_range28 temp___expr_2612)))
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-const attr__ATTRIBUTE_ADDRESS11 Int)
(declare-const attr__ATTRIBUTE_ADDRESS12 Int)
(declare-fun temp___String_Literal_3156 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_3156 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 3)) 99)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 6)) 118)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 9)) 67)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 10)) 97)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 11)) 110)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 13)) 101)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 15)) 108)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 17)) 100)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 19)) 45)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 21)) 70)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 22)) 108)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 23)) 111)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 24)) 112)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 25)) 112)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 26)) 121)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 28)) 104)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 29)) 97)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 30)) 115)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 32)) 98)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 33)) 101)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 34)) 101)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 35)) 110)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 36)) 32)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 37)) 114)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 38)) 101)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 39)) 109)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 40)) 111)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 41)) 118)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 42)) 101)) (= (to_rep (select (temp___String_Literal_3156 us_void_param) 43)) 100)) :pattern ((temp___String_Literal_3156 us_void_param)))))
(declare-fun temp___String_Literal_3157 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_3157 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 3)) 99)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 4)) 104)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 6)) 118)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 9)) 67)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 10)) 97)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 11)) 110)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 13)) 101)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 15)) 108)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 17)) 100)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 19)) 45)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 21)) 70)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 22)) 108)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 23)) 111)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 24)) 112)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 25)) 112)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 26)) 121)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 28)) 104)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 29)) 97)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 30)) 115)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 32)) 98)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 33)) 97)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 34)) 100)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 36)) 100)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 37)) 97)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 38)) 116)) (= (to_rep (select (temp___String_Literal_3157 us_void_param) 39)) 97)) :pattern ((temp___String_Literal_3157 us_void_param)))))
...
(define-fun dynamic_invariant9 ((temp___expr_82 us_t) (temp___is_init_79 Bool) (temp___skip_constant_80 Bool) (temp___do_toplevel_81 Bool)) Bool (=> (not (= temp___skip_constant_80 true)) (dynamic_property 1 2147483647 (first1 temp___expr_82) (last1 temp___expr_82))))
...
(define-fun dynamic_invariant11 ((temp___expr_401 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 4)) (in_range6 temp___expr_401)))
(define-fun dynamic_invariant12 ((temp___expr_407 Int) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool)) Bool (=> (or (= temp___is_init_404 true) (<= 1 4)) (in_range7 temp___expr_407)))
(define-fun dynamic_invariant13 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 1 3)) (in_range8 temp___expr_200)))
(define-fun dynamic_invariant14 ((temp___expr_206 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 5)) (in_range17 temp___expr_206)))
(define-fun dynamic_invariant15 ((temp___expr_924 Int) (temp___is_init_921 Bool) (temp___skip_constant_922 Bool) (temp___do_toplevel_923 Bool)) Bool (=> (or (= temp___is_init_921 true) (<= 0 40)) (in_range23 temp___expr_924)))
(define-fun dynamic_invariant16 ((temp___expr_945 Int) (temp___is_init_942 Bool) (temp___skip_constant_943 Bool) (temp___do_toplevel_944 Bool)) Bool (=> (or (= temp___is_init_942 true) (<= 0 4294967295)) (in_range24 temp___expr_945)))
(define-fun dynamic_invariant17 ((temp___expr_967 Int) (temp___is_init_964 Bool) (temp___skip_constant_965 Bool) (temp___do_toplevel_966 Bool)) Bool (=> (or (= temp___is_init_964 true) (<= 0 10)) (in_range22 temp___expr_967)))
(define-fun dynamic_invariant18 ((temp___expr_979 Int) (temp___is_init_976 Bool) (temp___skip_constant_977 Bool) (temp___do_toplevel_978 Bool)) Bool (=> (or (= temp___is_init_976 true) (<= 0 4294967295)) (in_range26 temp___expr_979)))
(define-fun dynamic_invariant19 ((temp___expr_985 Int) (temp___is_init_982 Bool) (temp___skip_constant_983 Bool) (temp___do_toplevel_984 Bool)) Bool (=> (or (= temp___is_init_982 true) (<= 0 128)) (in_range27 temp___expr_985)))
(define-fun dynamic_invariant20 ((temp___expr_1105 Int) (temp___is_init_1102 Bool) (temp___skip_constant_1103 Bool) (temp___do_toplevel_1104 Bool)) Bool (=> (or (= temp___is_init_1102 true) (<= 0 17)) (in_range12 temp___expr_1105)))
(define-fun dynamic_invariant21 ((temp___expr_1084 Int) (temp___is_init_1081 Bool) (temp___skip_constant_1082 Bool) (temp___do_toplevel_1083 Bool)) Bool (=> (or (= temp___is_init_1081 true) (<= 1 17)) (in_range10 temp___expr_1084)))
(define-fun dynamic_invariant22 ((temp___expr_1209 Int) (temp___is_init_1206 Bool) (temp___skip_constant_1207 Bool) (temp___do_toplevel_1208 Bool)) Bool (=> (or (= temp___is_init_1206 true) (<= 0 2)) (in_range14 temp___expr_1209)))
(define-fun dynamic_invariant23 ((temp___expr_1090 Int) (temp___is_init_1087 Bool) (temp___skip_constant_1088 Bool) (temp___do_toplevel_1089 Bool)) Bool (=> (or (= temp___is_init_1087 true) (<= 0 17408)) (in_range11 temp___expr_1090)))
(define-fun dynamic_invariant24 ((temp___expr_1124 Int) (temp___is_init_1121 Bool) (temp___skip_constant_1122 Bool) (temp___do_toplevel_1123 Bool)) Bool (=> (or (= temp___is_init_1121 true) (<= 0 1024)) (in_range13 temp___expr_1124)))
(assert true)
...
(define-fun dynamic_invariant25 ((temp___expr_510 Int) (temp___is_init_507 Bool) (temp___skip_constant_508 Bool) (temp___do_toplevel_509 Bool)) Bool (=> (or (= temp___is_init_507 true) (<= 1901 2099)) (in_range18 temp___expr_510)))
(define-fun dynamic_invariant26 ((temp___expr_516 Int) (temp___is_init_513 Bool) (temp___skip_constant_514 Bool) (temp___do_toplevel_515 Bool)) Bool (=> (or (= temp___is_init_513 true) (<= 1 12)) (in_range19 temp___expr_516)))
(define-fun dynamic_invariant27 ((temp___expr_522 Int) (temp___is_init_519 Bool) (temp___skip_constant_520 Bool) (temp___do_toplevel_521 Bool)) Bool (=> (or (= temp___is_init_519 true) (<= 1 31)) (in_range20 temp___expr_522)))
(define-fun dynamic_invariant28 ((temp___expr_546 Int) (temp___is_init_543 Bool) (temp___skip_constant_544 Bool) (temp___do_toplevel_545 Bool)) Bool (=> (or (= temp___is_init_543 true) (<= 0 86399999)) (in_range21 temp___expr_546)))
(define-fun dynamic_invariant29 ((temp___expr_1375 Int) (temp___is_init_1372 Bool) (temp___skip_constant_1373 Bool) (temp___do_toplevel_1374 Bool)) Bool (=> (or (= temp___is_init_1372 true) (<= 0 4294967295)) (in_range25 temp___expr_1375)))
...
(declare-const auditalarm9 int__ref)
...
(declare-const writeok3 bool__ref)
...
(assert (in_range16 tokentry))
(assert (in_range15 tokenid))
...
(assert (and (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields12)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields12)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields12)) true) (in_range9 auditalarm6)))
(assert (= o2 (extractuser tokenpresence state tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))))
(assert (not (= (to_rep1 (first (mk 1 43))) 1)))
(check-sat)
(exit)
