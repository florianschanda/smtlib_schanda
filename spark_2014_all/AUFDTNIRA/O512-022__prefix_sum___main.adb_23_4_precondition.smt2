...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_618 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_618 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_618 us_void_param) 3)) 61)) (= (to_rep (select (temp___String_Literal_618 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_618 us_void_param) 5)) 40)) :pattern ((temp___String_Literal_618 us_void_param)))))
(declare-fun temp___String_Literal_621 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_621 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_621 us_void_param) 2)) 41)) :pattern ((temp___String_Literal_621 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_623 us_void_param) 1)) 76) (= (to_rep (select (temp___String_Literal_623 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_623 us_void_param) 3)) 61)) :pattern ((temp___String_Literal_623 us_void_param)))))
(declare-fun temp___String_Literal_626 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_626 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_626 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_626 us_void_param) 3)) 61)) (= (to_rep (select (temp___String_Literal_626 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_626 us_void_param) 5)) 40)) :pattern ((temp___String_Literal_626 us_void_param)))))
(declare-fun temp___String_Literal_629 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_629 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_629 us_void_param) 2)) 41)) :pattern ((temp___String_Literal_629 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_631 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_631 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 3)) 61)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_631 us_void_param) 5)) 40)) :pattern ((temp___String_Literal_631 us_void_param)))))
(declare-fun temp___String_Literal_634 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_634 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_634 us_void_param) 2)) 41)) :pattern ((temp___String_Literal_634 us_void_param)))))
...
(assert (forall ((temp___609 Int) (temp___610 Int) (temp___611 Int) (temp___612 Int) (temp___613 Int) (temp___614 Int) (temp___615 Int) (temp___616 Int)) (let ((temp___608 (main__a__aggregate_def temp___609 temp___610 temp___611 temp___612 temp___613 temp___614 temp___615 temp___616))) (=> (and (and (and (and (and (and (and (dynamic_invariant1 temp___609 true true true true) (dynamic_invariant1 temp___610 true true true true)) (dynamic_invariant1 temp___611 true true true true)) (dynamic_invariant1 temp___612 true true true true)) (dynamic_invariant1 temp___613 true true true true)) (dynamic_invariant1 temp___614 true true true true)) (dynamic_invariant1 temp___615 true true true true)) (dynamic_invariant1 temp___616 true true true true)) (and (and (and (and (and (and (and (= (to_rep1 (select temp___608 0)) temp___609) (= (to_rep1 (select temp___608 1)) temp___610)) (= (to_rep1 (select temp___608 2)) temp___611)) (= (to_rep1 (select temp___608 3)) temp___612)) (= (to_rep1 (select temp___608 4)) temp___613)) (= (to_rep1 (select temp___608 5)) temp___614)) (= (to_rep1 (select temp___608 6)) temp___615)) (= (to_rep1 (select temp___608 7)) temp___616))))))
