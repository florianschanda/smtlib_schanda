...
(assert (forall ((temp___543 Int) (temp___544 Int) (temp___545 Int) (temp___546 Int) (temp___547 Int) (temp___548 Int) (temp___549 Int) (temp___550 Int)) (let ((temp___542 (main__a__aggregate_def temp___543 temp___544 temp___545 temp___546 temp___547 temp___548 temp___549 temp___550))) (and (and (and (and (and (and (and (= (select temp___542 0) (of_rep1 temp___543)) (= (select temp___542 1) (of_rep1 temp___544))) (= (select temp___542 2) (of_rep1 temp___545))) (= (select temp___542 3) (of_rep1 temp___546))) (= (select temp___542 4) (of_rep1 temp___547))) (= (select temp___542 5) (of_rep1 temp___548))) (= (select temp___542 6) (of_rep1 temp___549))) (= (select temp___542 7) (of_rep1 temp___550))))))
(declare-fun temp___String_Literal_552 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_552 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_552 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_552 us_void_param) 3)) 61)) (= (to_rep (select (temp___String_Literal_552 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_552 us_void_param) 5)) 40)) :pattern ((temp___String_Literal_552 us_void_param)))))
(declare-fun temp___String_Literal_555 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_555 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_555 us_void_param) 2)) 41)) :pattern ((temp___String_Literal_555 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_557 us_void_param) 1)) 76) (= (to_rep (select (temp___String_Literal_557 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_557 us_void_param) 3)) 61)) :pattern ((temp___String_Literal_557 us_void_param)))))
(declare-fun temp___String_Literal_560 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_560 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_560 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_560 us_void_param) 3)) 61)) (= (to_rep (select (temp___String_Literal_560 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_560 us_void_param) 5)) 40)) :pattern ((temp___String_Literal_560 us_void_param)))))
(declare-fun temp___String_Literal_563 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_563 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_563 us_void_param) 2)) 41)) :pattern ((temp___String_Literal_563 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_565 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_565 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_565 us_void_param) 3)) 61)) (= (to_rep (select (temp___String_Literal_565 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_565 us_void_param) 5)) 40)) :pattern ((temp___String_Literal_565 us_void_param)))))
(declare-fun temp___String_Literal_568 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_568 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_568 us_void_param) 2)) 41)) :pattern ((temp___String_Literal_568 us_void_param)))))
