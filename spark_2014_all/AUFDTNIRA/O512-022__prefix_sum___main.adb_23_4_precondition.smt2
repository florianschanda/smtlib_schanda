...
(assert (forall ((temp___537 Int) (temp___538 Int) (temp___539 Int) (temp___540 Int) (temp___541 Int) (temp___542 Int) (temp___543 Int) (temp___544 Int)) (let ((temp___536 (main__a__aggregate_def temp___537 temp___538 temp___539 temp___540 temp___541 temp___542 temp___543 temp___544))) (and (and (and (and (and (and (and (= (select temp___536 0) (of_rep1 temp___537)) (= (select temp___536 1) (of_rep1 temp___538))) (= (select temp___536 2) (of_rep1 temp___539))) (= (select temp___536 3) (of_rep1 temp___540))) (= (select temp___536 4) (of_rep1 temp___541))) (= (select temp___536 5) (of_rep1 temp___542))) (= (select temp___536 6) (of_rep1 temp___543))) (= (select temp___536 7) (of_rep1 temp___544))))))
(declare-fun temp___String_Literal_546 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_546 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_546 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_546 us_void_param) 3)) 61)) (= (to_rep (select (temp___String_Literal_546 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_546 us_void_param) 5)) 40)) :pattern ((temp___String_Literal_546 us_void_param)))))
(declare-fun temp___String_Literal_549 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_549 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_549 us_void_param) 2)) 41)) :pattern ((temp___String_Literal_549 us_void_param)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_551 us_void_param) 1)) 76) (= (to_rep (select (temp___String_Literal_551 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_551 us_void_param) 3)) 61)) :pattern ((temp___String_Literal_551 us_void_param)))))
(declare-fun temp___String_Literal_554 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_554 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_554 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_554 us_void_param) 3)) 61)) (= (to_rep (select (temp___String_Literal_554 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_554 us_void_param) 5)) 40)) :pattern ((temp___String_Literal_554 us_void_param)))))
(declare-fun temp___String_Literal_557 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_557 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_557 us_void_param) 2)) 41)) :pattern ((temp___String_Literal_557 us_void_param)))))
(declare-fun temp___String_Literal_558 (tuple0) (Array Int character))
(assert true)
(declare-fun temp___String_Literal_559 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_559 us_void_param) 1)) 65) (= (to_rep (select (temp___String_Literal_559 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_559 us_void_param) 3)) 61)) (= (to_rep (select (temp___String_Literal_559 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_559 us_void_param) 5)) 40)) :pattern ((temp___String_Literal_559 us_void_param)))))
(declare-fun temp___String_Literal_562 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (= (to_rep (select (temp___String_Literal_562 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_562 us_void_param) 2)) 41)) :pattern ((temp___String_Literal_562 us_void_param)))))
...
(define-fun dynamic_invariant4 ((temp___expr_155 Int) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool (=> (or (= temp___is_init_152 true) (<= 0 7)) (in_range3 temp___expr_155)))
(assert true)
