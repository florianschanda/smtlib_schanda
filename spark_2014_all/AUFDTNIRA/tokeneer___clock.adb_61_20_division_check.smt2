...
(assert (<= sstart i1))
(assert (<= i1 send))
(assert (and (and (forall ((temp___502 Int)) (=> (and (<= (to_rep1 s__first) temp___502) (<= temp___502 (to_rep1 s__last))) (=> (<= temp___502 i2) (= (select s1 temp___502) (select s temp___502))))) (=> (<= 0 2147483647) (in_range4 v2))) (and (<= sstart i2) (<= i2 send))))
(assert (= (to_rep o) (+ 48 (mod2 v2 10))))
(assert (and (<= (to_rep1 s__first) i2) (<= i2 (to_rep1 s__last))))
(assert (= o1 i2))
(assert (= o2 (store s1 o1 o)))
(assert (= result2 s1))
(assert (= s2 o2))
(assert (not (not (= 10 0))))
(check-sat)
