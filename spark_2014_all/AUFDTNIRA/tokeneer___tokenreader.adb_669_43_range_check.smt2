...
(assert (and (= o (getreaderstate rawnewstate1)) (and (in_range17 o) (= o (ite (and (<= 0 rawnewstate1) (<= rawnewstate1 6)) rawnewstate1 0)))))
(assert (= result newstate))
(assert (= newstate1 o))
(assert (in_range16 newstate1))
(assert (not (in_range16 newstate1)))
(check-sat)
(exit)
