...
(assert (not (= (to_rep4 logfilestate__split_fields5) 0)))
(assert (not (and (= (to_rep4 logfilestate__split_fields5) 1) (< (to_rep5 (select logfilestate__split_fields6 (to_rep2 (select logfilestate__split_fields2 (to_rep2 logfilestate__split_fields3))))) 1024))))
(assert (= result5 (mk_int__ref archivedfilecount)))
(assert (= archivedfilecount2 0))
(assert (= result6 (mk_int__ref fileindexinusedlist)))
(assert (= fileindexinusedlist2 (to_rep2 logfilestate__split_fields3)))
(assert (< archivedfilecount2 4))
(assert (< archivedfilecount2 (to_rep4 logfilestate__split_fields5)))
(assert (not (= (to_rep3 logfilestate__split_fields1) (+ (* (- (to_rep4 logfilestate__split_fields5) 1) 1024) (to_rep5 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields)))))))
(check-sat)
(exit)
