...
(assert (and (= o14 (- i1 (to_rep (first4 (rt2 a))))) (in_range1 (- i1 (to_rep (first4 (rt2 a)))))))
...
(assert (= o11 i1))
(assert (= o12 (select (elts1 (acc_array__content test_higher_order__sum__acc_f__result5)) o11)))
(assert (= o13 (to_rep2 o12)))
(assert (and (= result6 (in_range5 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) o13 o17)) (= (= result6 true) (and (<= (+ (- 2147483648) (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o17))) o13) (<= o13 (- 2147483647 (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o17))))))))
(assert (= result6 true))
