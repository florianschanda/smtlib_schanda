...
(assert (and (= o133 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o132)) (= (bool_eq o133 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o132)) true)))
(assert (= o134 (us_split_fields1 o133)))
(assert (= o135 (rec__partition_refinement__interval__last o134)))
(assert (= o136 (to_rep1 o135)))
(assert (= o137 (ite (<= k12 o136) true false)))
(assert (and (<= 0 k12) (<= k12 5)))
(assert (= o126 k12))
(assert (= o127 (select (map__content f8) o126)))
(assert (= o128 (to_rep2 o127)))
(assert (not (<= 0 o128)))
(check-sat)
(exit)
