...
(declare-const r Int)
(declare-const i Int)
(declare-const test_higher_order__sum__fold_f__result Int)
...
(declare-const test_higher_order__sum__fold_f__result1 Int)
(declare-const r8 Int)
(declare-const i7 Int)
(declare-const test_higher_order__sum__fold_f__result2 Int)
(declare-const r9 Int)
(declare-const i8 Int)
(declare-const test_higher_order__sum__fold_f__result3 Int)
(declare-const r10 Int)
(declare-const i9 int__ref)
(declare-const test_higher_order__sum__fold_f__result4 int__ref)
(declare-const r11 Int)
(declare-const i10 Int)
(declare-const test_higher_order__sum__fold_f__result5 Int)
(define-fun i11 () int__ref (mk_int__ref i7))
(define-fun r12 () int__ref (mk_int__ref r8))
(define-fun i12 () int__ref (mk_int__ref i5))
(define-fun r13 () int__ref (mk_int__ref r6))
...
(assert (= test_higher_order__sum__fold_f__result1 test_higher_order__sum__fold_f__result2))
(assert (= i11 i12))
(assert (= r12 r13))
(assert (= test_higher_order__sum__fold_f__result3 test_higher_order__sum__fold_f__result1))
(assert (= i8 i6))
(assert (= r9 r7))
...
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= temp___404 i1)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= temp___403 r1)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (and (= o (+ (to_rep1 (select (elts2 a) i1)) r1)) (in_range1 (+ (to_rep1 (select (elts2 a) i1)) r1)))))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= r1 result2)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= r2 o)))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= r3 (to_rep2 (select (elts1 (acc_f a init)) i2)))))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (and (and (=> (<= (- 2147483648) 2147483647) (in_range7 r3)) (=> (<= (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))) (dynamic_property3 (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))) i2))) (and (<= (to_rep (first4 (rt2 a))) i2) (<= i2 (to_rep (last4 (rt2 a))))))))
...
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= i12 (mk_int__ref i3))))
(assert (=> (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a))))) (= r13 (mk_int__ref r4))))
...
(assert (=> (not (and (<= (to_rep (first4 (rt2 a))) i1) (<= i1 (to_rep (last4 (rt2 a)))))) (= r1 r6)))
...
(assert (= (mk_int__ref result3) (mk_int__ref test_higher_order__sum__fold_f__result)))
(assert (= test_higher_order__sum__fold_f__result1 r6))
(assert (= test_higher_order__sum__fold_f__result4 (mk_int__ref test_higher_order__sum__fold_f__result2)))
(assert (= i9 i11))
(assert (= (mk_int__ref r10) r12))
(assert (= test_higher_order__sum__fold_f__result5 test_higher_order__sum__fold_f__result3))
(assert (= i10 i8))
(assert (= r11 r9))
(assert (= result4 (int__content test_higher_order__sum__fold_f__result4)))
(assert (not (= (int__content test_higher_order__sum__fold_f__result4) (ite (= (length2 a) 0) init (to_rep2 (select (elts1 (acc_f a init)) (to_rep (last4 (rt2 a)))))))))
(check-sat)
(exit)
