...
(assert (=> (and (<= (to_rep (first (rt array2))) index21) (<= index21 (to_rep (last (rt array2))))) (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt array2))) j1) (<= j1 index22)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j1 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) index11)))))))
(assert (=> (and (<= (to_rep (first (rt array2))) index21) (<= index21 (to_rep (last (rt array2))))) (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt array2))) j1) (<= j1 index22)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j1 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j1)))))))
...
(assert (forall ((i1 Int)) (=> (and (<= (to_rep (first (rt array1))) i1) (<= i1 index12)) (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt array2))) j1) (<= j1 (to_rep (last (rt array2))))) (= (to_rep (select (select result__8 (+ (+ (* (- i1 (to_rep (first (rt array1)))) (length array2)) (- j1 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) i1))))))))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep (first (rt array1))) i1) (<= i1 index12)) (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt array2))) j1) (<= j1 (to_rep (last (rt array2))))) (= (to_rep (select (select result__8 (+ (+ (* (- i1 (to_rep (first (rt array1)))) (length array2)) (- j1 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j1))))))))
...
(assert (and (<= (to_rep (first (rt array1))) i) (<= i (to_rep (last (rt array1))))))
(assert (= o8 i))
(assert (= o9 (select (elts array1) o8)))
(assert (= o10 (to_rep o9)))
(assert (and (= o7 (- j (to_rep (first (rt array2))))) (in_range1 (- j (to_rep (first (rt array2)))))))
