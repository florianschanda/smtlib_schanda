...
(assert (<= i index12))
(assert (<= (to_rep (first (rt array2))) j2))
(assert (<= j2 (to_rep (last (rt array2)))))
(assert (and (<= (to_rep (first (rt array1))) i) (<= i (to_rep (last (rt array1))))))
(assert (= o55 i))
(assert (= o56 (select (elts array1) o55)))
(assert (= o57 (to_rep o56)))
(assert (and (= o50 (- j2 (to_rep (first (rt array2))))) (in_range1 (- j2 (to_rep (first (rt array2)))))))
