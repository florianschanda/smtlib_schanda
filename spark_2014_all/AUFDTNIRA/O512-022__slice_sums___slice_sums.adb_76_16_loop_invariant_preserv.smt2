...
(assert (= result____split_fields2 (mk___split_fields temp___176 temp___1761)))
...
(assert (=> (< max_sum2 current_sum3) (= result____split_fields4 (us_split_fields1 temp___178))))
...
(assert (=> (< max_sum2 current_sum3) (= temp___180 (mk_slice_bounds o11))))
(assert (=> (< max_sum2 current_sum3) (= result8 (mk___split_fields__ref result____split_fields4))))
(assert (=> (< max_sum2 current_sum3) (= result____split_fields5 (us_split_fields1 temp___180))))
