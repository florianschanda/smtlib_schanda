...
(declare-const o10 extended_index)
...
(assert (and (and (and (<= (to_rep3 (first (rt x))) current_lo2) (<= current_lo2 current_hi2)) (<= 0 current_sum2)) (<= current_sum2 (* (- current_hi2 current_lo2) 32767))))
(assert (= current_sum2 (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep1 current_lo2) (of_rep2 (- current_hi2 1)))))))
(assert (=> (<= (to_rep1 (rec__sums__slice_bounds__lo result____split_fields3)) (to_rep2 (rec__sums__slice_bounds__hi result____split_fields3))) (and (and (<= (to_rep3 (first (rt x))) (to_rep1 (rec__sums__slice_bounds__lo result____split_fields3))) (<= (to_rep2 (rec__sums__slice_bounds__hi result____split_fields3)) (to_rep3 (last (rt x))))) (= max_sum2 (sum__logic x (mk_slice_bounds result____split_fields3))))))
(assert (forall ((lo_index Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index) (<= lo_index (- current_hi2 1))) (forall ((hi_index Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index) (<= hi_index (- current_hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep1 lo_index) (of_rep2 hi_index)))) max_sum2))))))
(assert (forall ((lo_index Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index) (<= lo_index (- current_lo2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep1 lo_index) (of_rep2 (- current_lo2 1))))) 0))))
(assert (forall ((hi_index Int)) (=> (and (<= current_lo2 hi_index) (<= hi_index (- current_hi2 1))) (<= 0 (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep1 current_lo2) (of_rep2 hi_index))))))))
(assert (and (and (and (and (=> (<= 0 2147483647) (in_range2 max_sum2)) (=> (<= (- 2147483648) 2147483647) (in_range1 current_sum2))) (in_range4 current_lo2)) (=> (<= (to_rep3 (first (rt x))) (to_rep3 (last (rt x)))) (dynamic_property1 (to_rep3 (first (rt x))) (to_rep3 (last (rt x))) current_hi2))) (and (<= (to_rep3 (first (rt x))) current_hi2) (<= current_hi2 (to_rep3 (last (rt x)))))))
(assert (and (= o5 (+ current_sum2 (to_rep (select (elts x) current_hi2)))) (in_range1 (+ current_sum2 (to_rep (select (elts x) current_hi2))))))
(assert (= result5 (mk_int__ref current_sum2)))
(assert (= current_sum3 o5))
(assert (=> (< max_sum2 current_sum3) (and (= o6 current_sum3) (in_range2 current_sum3))))
...
(assert (=> (< max_sum2 current_sum3) (= o8 (mk___split_fields o7 (rec__sums__slice_bounds__hi result____split_fields3)))))
(assert (=> (< max_sum2 current_sum3) (= temp___202 (mk_slice_bounds o8))))
(assert (=> (< max_sum2 current_sum3) (= result7 (mk___split_fields__ref result____split_fields3))))
(assert (=> (< max_sum2 current_sum3) (= result____split_fields4 (us_split_fields1 temp___202))))
(assert (=> (< max_sum2 current_sum3) (and (= o9 current_hi2) (in_range5 current_hi2))))
(assert (=> (< max_sum2 current_sum3) (= (to_rep2 o10) o9)))
(assert (=> (< max_sum2 current_sum3) (= o11 (mk___split_fields (rec__sums__slice_bounds__lo result____split_fields4) o10))))
(assert (=> (< max_sum2 current_sum3) (= temp___204 (mk_slice_bounds o11))))
(assert (=> (< max_sum2 current_sum3) (= result8 (mk___split_fields__ref result____split_fields4))))
(assert (=> (< max_sum2 current_sum3) (= result____split_fields5 (us_split_fields1 temp___204))))
(assert (=> (< max_sum2 current_sum3) (= current_lo3 current_lo2)))
(assert (=> (< max_sum2 current_sum3) (= current_sum4 current_sum3)))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi2 65536)) (and (= o12 (+ current_hi2 1)) (in_range1 (+ current_hi2 1)))))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi2 65536)) (and (= o13 o12) (in_range4 o12))))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi2 65536)) (= result9 (mk_int__ref current_lo2))))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi2 65536)) (= current_lo3 o13)))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi2 65536)) (= result10 (mk_int__ref current_sum3))))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi2 65536)) (= current_sum4 0)))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (not (= current_hi2 65536))) (= current_lo3 current_lo2)))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (not (= current_hi2 65536))) (= current_sum4 current_sum3)))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (not (< current_sum3 0)) (= current_lo3 current_lo2))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (not (< current_sum3 0)) (= current_sum4 current_sum3))))
(assert (=> (not (< max_sum2 current_sum3)) (= result____split_fields5 result____split_fields3)))
...
(assert (<= (to_rep1 (rec__sums__slice_bounds__lo result____split_fields5)) (to_rep2 (rec__sums__slice_bounds__hi result____split_fields5))))
(assert (not (<= (to_rep3 (first (rt x))) (to_rep1 (rec__sums__slice_bounds__lo result____split_fields5)))))
(check-sat)
(exit)
