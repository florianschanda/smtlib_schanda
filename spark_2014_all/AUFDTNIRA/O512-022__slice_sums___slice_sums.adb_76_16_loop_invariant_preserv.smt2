...
(assert (and (= o43 (+ current_sum2 (to_rep (select (elts x) current_hi3)))) (in_range1 (+ current_sum2 (to_rep (select (elts x) current_hi3))))))
(assert (= result10 (mk_int__ref current_sum2)))
(assert (= current_sum3 o43))
(assert (=> (< max_sum2 current_sum3) (and (= o44 current_sum3) (in_range2 current_sum3))))
(assert (=> (< max_sum2 current_sum3) (= result11 (mk_int__ref max_sum2))))
(assert (=> (< max_sum2 current_sum3) (= max_sum3 o44)))
(assert (=> (< max_sum2 current_sum3) (= (to_rep1 o45) current_lo3)))
(assert (=> (< max_sum2 current_sum3) (= o46 (mk___split_fields o45 (rec__sums__slice_bounds__hi result____split_fields4)))))
(assert (=> (< max_sum2 current_sum3) (= temp___178 (mk_slice_bounds o46))))
(assert (=> (< max_sum2 current_sum3) (= result12 (mk___split_fields__ref result____split_fields4))))
(assert (=> (< max_sum2 current_sum3) (= result____split_fields5 (us_split_fields1 temp___178))))
(assert (=> (< max_sum2 current_sum3) (and (= o47 current_hi3) (in_range5 current_hi3))))
(assert (=> (< max_sum2 current_sum3) (= (to_rep2 o48) o47)))
(assert (=> (< max_sum2 current_sum3) (= o49 (mk___split_fields (rec__sums__slice_bounds__lo result____split_fields5) o48))))
(assert (=> (< max_sum2 current_sum3) (= temp___180 (mk_slice_bounds o49))))
(assert (=> (< max_sum2 current_sum3) (= result13 (mk___split_fields__ref result____split_fields5))))
(assert (=> (< max_sum2 current_sum3) (= result____split_fields6 (us_split_fields1 temp___180))))
(assert (=> (< max_sum2 current_sum3) (= current_lo4 current_lo3)))
(assert (=> (< max_sum2 current_sum3) (= current_sum4 current_sum3)))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi3 65536)) (and (= o50 (+ current_hi3 1)) (in_range1 (+ current_hi3 1)))))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi3 65536)) (and (= o51 o50) (in_range4 o50))))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi3 65536)) (= result14 (mk_int__ref current_lo3))))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi3 65536)) (= current_lo4 o51)))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi3 65536)) (= result15 (mk_int__ref current_sum3))))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi3 65536)) (= current_sum4 0)))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (= current_hi3 65536) (= current_lo4 current_lo3)))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (= current_hi3 65536) (= current_sum4 current_sum3)))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (not (< current_sum3 0)) (= current_lo4 current_lo3))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (not (< current_sum3 0)) (= current_sum4 current_sum3))))
(assert (=> (not (< max_sum2 current_sum3)) (= result____split_fields6 result____split_fields4)))
(assert (=> (not (< max_sum2 current_sum3)) (= max_sum3 max_sum2)))
(assert (not (= current_hi3 (to_rep3 (last (rt x))))))
(assert (= result16 (mk_int__ref current_hi3)))
(assert (= current_hi4 (+ current_hi3 1)))
(assert (<= (to_rep1 (rec__sums__slice_bounds__lo result____split_fields6)) (to_rep2 (rec__sums__slice_bounds__hi result____split_fields6))))
(assert (not (<= (to_rep3 (first (rt x))) (to_rep1 (rec__sums__slice_bounds__lo result____split_fields6)))))
(check-sat)
(exit)
