...
(define-fun dynamic_invariant ((temp___expr_514 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 0 1)) (in_range5 temp___expr_514)))
...
(declare-fun temp___1137 (Int) (Array Int logfileindext))
(assert (forall ((temp___1139 Int)) (forall ((temp___1140 Int)) (= (select (temp___1137 temp___1139) temp___1140) (of_rep8 temp___1139)))))
(declare-fun temp___1141 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1143 Int)) (forall ((temp___1144 Int)) (= (select (temp___1141 temp___1143) temp___1144) (of_rep11 temp___1143)))))
(define-fun dynamic_invariant1 ((temp___expr_1131 us_rep4) (temp___is_init_1128 Bool) (temp___skip_constant_1129 Bool) (temp___do_toplevel_1130 Bool)) Bool (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___expr_1131))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___expr_1131))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___expr_1131)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___expr_1131))) true))
(define-fun default_initial_assumption ((temp___expr_1135 us_rep4) (temp___skip_top_level_1136 Bool)) Bool (and (and (and (= (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___expr_1135))) 1) (= (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___expr_1135))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___expr_1135)) (mk___rep3 (mk___split_fields3 (temp___1137 1) (of_rep8 1) (of_rep8 1) (of_rep10 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___expr_1135)) (temp___1141 0))))
(define-fun type_invariant ((temp___1145 us_rep4)) Bool (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___1145))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___1145))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___1145)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___1145))) true))
...
(declare-fun temp___String_Literal_2710 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2710 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 2)) 38)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 3)) 65)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 5)) 67)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 10)) 102)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 17)) 78)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 21)) 67)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 22)) 117)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 24)) 114)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 26)) 110)) (= (to_rep (select (temp___String_Literal_2710 us_void_param) 27)) 116)) :pattern ((temp___String_Literal_2710 us_void_param)))))
(declare-fun temp___String_Literal_2715 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2715 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 2)) 38)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 3)) 65)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 5)) 67)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 10)) 102)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 17)) 78)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 21)) 86)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 22)) 101)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 24)) 105)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 25)) 102)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 26)) 105)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 27)) 97)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 28)) 98)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 29)) 108)) (= (to_rep (select (temp___String_Literal_2715 us_void_param) 30)) 101)) :pattern ((temp___String_Literal_2715 us_void_param)))))
(declare-fun temp___String_Literal_2720 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2720 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 2)) 38)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 3)) 65)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 5)) 67)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 10)) 102)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 17)) 66)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 18)) 97)) (= (to_rep (select (temp___String_Literal_2720 us_void_param) 19)) 100)) :pattern ((temp___String_Literal_2720 us_void_param)))))
...
(define-fun dynamic_invariant3 ((temp___expr_2180 Int) (temp___is_init_2177 Bool) (temp___skip_constant_2178 Bool) (temp___do_toplevel_2179 Bool)) Bool (=> (or (= temp___is_init_2177 true) (<= 0 3)) (in_range22 temp___expr_2180)))
(define-fun dynamic_invariant4 ((temp___expr_1097 Int) (temp___is_init_1094 Bool) (temp___skip_constant_1095 Bool) (temp___do_toplevel_1096 Bool)) Bool (=> (or (= temp___is_init_1094 true) (<= 0 17)) (in_range13 temp___expr_1097)))
(define-fun dynamic_invariant5 ((temp___expr_1076 Int) (temp___is_init_1073 Bool) (temp___skip_constant_1074 Bool) (temp___do_toplevel_1075 Bool)) Bool (=> (or (= temp___is_init_1073 true) (<= 1 17)) (in_range11 temp___expr_1076)))
(define-fun dynamic_invariant6 ((temp___expr_1201 Int) (temp___is_init_1198 Bool) (temp___skip_constant_1199 Bool) (temp___do_toplevel_1200 Bool)) Bool (=> (or (= temp___is_init_1198 true) (<= 0 2)) (in_range15 temp___expr_1201)))
(define-fun dynamic_invariant7 ((temp___expr_1082 Int) (temp___is_init_1079 Bool) (temp___skip_constant_1080 Bool) (temp___do_toplevel_1081 Bool)) Bool (=> (or (= temp___is_init_1079 true) (<= 0 17408)) (in_range12 temp___expr_1082)))
(define-fun dynamic_invariant8 ((temp___expr_1116 Int) (temp___is_init_1113 Bool) (temp___skip_constant_1114 Bool) (temp___do_toplevel_1115 Bool)) Bool (=> (or (= temp___is_init_1113 true) (<= 0 1024)) (in_range14 temp___expr_1116)))
(assert true)
...
(define-fun dynamic_invariant9 ((temp___expr_536 Int) (temp___is_init_533 Bool) (temp___skip_constant_534 Bool) (temp___do_toplevel_535 Bool)) Bool (=> (or (= temp___is_init_533 true) (<= 1 150)) (in_range6 temp___expr_536)))
...
(define-fun dynamic_invariant11 ((temp___expr_578 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 1901 2099)) (in_range7 temp___expr_578)))
(define-fun dynamic_invariant12 ((temp___expr_584 Int) (temp___is_init_581 Bool) (temp___skip_constant_582 Bool) (temp___do_toplevel_583 Bool)) Bool (=> (or (= temp___is_init_581 true) (<= 1 12)) (in_range8 temp___expr_584)))
(define-fun dynamic_invariant13 ((temp___expr_590 Int) (temp___is_init_587 Bool) (temp___skip_constant_588 Bool) (temp___do_toplevel_589 Bool)) Bool (=> (or (= temp___is_init_587 true) (<= 1 31)) (in_range9 temp___expr_590)))
(define-fun dynamic_invariant14 ((temp___expr_614 Int) (temp___is_init_611 Bool) (temp___skip_constant_612 Bool) (temp___do_toplevel_613 Bool)) Bool (=> (or (= temp___is_init_611 true) (<= 0 86399999)) (in_range10 temp___expr_614)))
(define-fun dynamic_invariant15 ((temp___expr_992 Int) (temp___is_init_989 Bool) (temp___skip_constant_990 Bool) (temp___do_toplevel_991 Bool)) Bool (=> (or (= temp___is_init_989 true) (<= 0 2147483647)) (in_range19 temp___expr_992)))
(define-fun dynamic_invariant16 ((temp___expr_1023 Int) (temp___is_init_1020 Bool) (temp___skip_constant_1021 Bool) (temp___do_toplevel_1022 Bool)) Bool (=> (or (= temp___is_init_1020 true) (<= 0 4294967295)) (in_range21 temp___expr_1023)))
(define-fun dynamic_invariant17 ((temp___expr_319 Int) (temp___is_init_316 Bool) (temp___skip_constant_317 Bool) (temp___do_toplevel_318 Bool)) Bool (=> (or (= temp___is_init_316 true) (<= 0 40)) (in_range2 temp___expr_319)))
(define-fun dynamic_invariant18 ((temp___expr_340 Int) (temp___is_init_337 Bool) (temp___skip_constant_338 Bool) (temp___do_toplevel_339 Bool)) Bool (=> (or (= temp___is_init_337 true) (<= 0 4294967295)) (in_range3 temp___expr_340)))
(define-fun dynamic_invariant19 ((temp___expr_362 Int) (temp___is_init_359 Bool) (temp___skip_constant_360 Bool) (temp___do_toplevel_361 Bool)) Bool (=> (or (= temp___is_init_359 true) (<= 0 10)) (in_range16 temp___expr_362)))
(define-fun dynamic_invariant20 ((temp___expr_374 Int) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool)) Bool (=> (or (= temp___is_init_371 true) (<= 0 4294967295)) (in_range17 temp___expr_374)))
(define-fun dynamic_invariant21 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 128)) (in_range18 temp___expr_380)))
(define-fun dynamic_invariant22 ((temp___expr_465 Int) (temp___is_init_462 Bool) (temp___skip_constant_463 Bool) (temp___do_toplevel_464 Bool)) Bool (=> (or (= temp___is_init_462 true) (<= 0 4294967295)) (in_range4 temp___expr_465)))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (and (in_range5 auditalarm2) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true)))))
