...
(assert (and (<= (to_rep1 n__first) temp___2087) (<= temp___2087 (to_rep1 n__last))))
(assert (= o100 temp___2087))
(assert (= o101 (select (map__content1 n7) o100)))
(assert (= o102 (to_rep1 o101)))
(assert (= o103 (* o102 10000000)))
(assert (and (= o104 o103) (in_range1 o103)))
(assert (= o105 (- target7 o104)))
(assert (and (= o106 o105) (in_range1 o105)))
(assert (= result16 (mk_int__ref target7)))
(assert (= target8 o106))
(assert (<= (- 39999999) target8))
(assert (and (= o107 (- target8 2100000000)) (in_range1 (- target8 2100000000))))
(assert (= result17 (mk_int__ref target8)))
(assert (= target9 o107))
(assert (not (<= (- 2139999999) target9)))
(check-sat)
(exit)
