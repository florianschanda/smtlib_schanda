...
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields7)) k18))
(assert (<= k18 (to_rep1 (rec__partition_refinement__interval__last p_elem__split_fields7))))
(assert (not (= (bool_eq (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) (to_rep2 (select (map__content f8) k18))) (mk___rep p_elem__split_fields7)) true)))
(check-sat)
(exit)
