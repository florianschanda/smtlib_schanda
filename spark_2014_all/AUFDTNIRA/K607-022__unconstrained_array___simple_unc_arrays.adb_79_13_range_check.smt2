...
(assert (forall ((a us_rep)) (! (=> (and (dynamic_invariant2 a true true true) (not (= (empty a) true))) (let ((result (min a))) (and (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= result (to_rep1 (let ((temp___586 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___586) j)))))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= result (to_rep1 (let ((temp___585 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___585) j))))))) (dynamic_invariant1 result true false true)))) :pattern ((min a)))))
(declare-fun max (us_rep) Int)
(declare-fun max__function_guard (Int us_rep) Bool)
(assert (forall ((a us_rep)) (! (=> (and (dynamic_invariant2 a true true true) (not (= (empty a) true))) (let ((result (max a))) (and (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= (to_rep1 (let ((temp___594 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___594) j))) result))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= result (to_rep1 (let ((temp___593 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___593) j))))))) (dynamic_invariant1 result true false true)))) :pattern ((max a)))))
