...
(define-fun dynamic_invariant1 ((temp___expr_525 Int) (temp___is_init_522 Bool) (temp___skip_constant_523 Bool) (temp___do_toplevel_524 Bool)) Bool (=> (or (= temp___is_init_522 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_525)))
...
(assert (forall ((a us_rep)) (! (=> (and (dynamic_invariant2 a true true true) (not (= (empty a) true))) (let ((result (min a))) (and (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= result (to_rep1 (let ((temp___580 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___580) j)))))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= result (to_rep1 (let ((temp___579 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___579) j))))))) (dynamic_invariant1 result true false true)))) :pattern ((min a)))))
(declare-fun max (us_rep) Int)
(declare-fun max__function_guard (Int us_rep) Bool)
(assert (forall ((a us_rep)) (! (=> (and (dynamic_invariant2 a true true true) (not (= (empty a) true))) (let ((result (max a))) (and (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= (to_rep1 (let ((temp___588 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___588) j))) result))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= result (to_rep1 (let ((temp___587 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___587) j))))))) (dynamic_invariant1 result true false true)))) :pattern ((max a)))))
...
(declare-const i Int)
(declare-const simple_unc_arrays__average__result Int)
...
(declare-const simple_unc_arrays__average__result1 Int)
(declare-const simple_unc_arrays__average__result2 Int)
(declare-const simple_unc_arrays__average__result3 Int)
(declare-const sum8 Int)
(declare-const i7 Int)
(declare-const simple_unc_arrays__average__result4 Int)
(declare-const sum9 Int)
(declare-const i8 Int)
(declare-const simple_unc_arrays__average__result5 Int)
