...
(define-fun dynamic_invariant1 ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_596)))
...
(assert (forall ((a us_rep)) (! (=> (and (dynamic_invariant2 a true true true true) (not (= (empty a) true))) (let ((result (min a))) (and (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= result (to_rep1 (let ((temp___653 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___653) j)))))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= result (to_rep1 (let ((temp___652 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___652) j))))))) (dynamic_invariant1 result true false true true)))) :pattern ((min a)))))
(declare-fun max (us_rep) Int)
(declare-fun max__function_guard (Int us_rep) Bool)
(assert (forall ((a us_rep)) (! (=> (and (dynamic_invariant2 a true true true true) (not (= (empty a) true))) (let ((result (max a))) (and (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= (to_rep1 (let ((temp___661 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___661) j))) result))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= result (to_rep1 (let ((temp___660 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___660) j))))))) (dynamic_invariant1 result true false true true)))) :pattern ((max a)))))
...
(assert (not (in_range1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))))
(check-sat)
(exit)
