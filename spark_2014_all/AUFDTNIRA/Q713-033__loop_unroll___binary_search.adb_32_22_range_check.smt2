...
(assert (= j1 1))
(assert (and (= o (+ left1 (div1 (- right1 left1) 2))) (in_range2 (+ left1 (div1 (- right1 left1) 2)))))
(assert (= (mk_int__ref result3) (mk_int__ref med)))
(assert (= med1 o))
(assert (=> (< (to_rep (select a med1)) i) (and (= o1 (+ med1 1)) (in_range2 (+ med1 1)))))
(assert (=> (< (to_rep (select a med1)) i) (= left1 result4)))
(assert (=> (< (to_rep (select a med1)) i) (= left2 o1)))
(assert (=> (< (to_rep (select a med1)) i) (= binary_search__search__result3 binary_search__search__result2)))
(assert (=> (< (to_rep (select a med1)) i) (= right2 right1)))
(assert (=> (not (< (to_rep (select a med1)) i)) (< i (to_rep (select a med1)))))
(assert (=> (not (< (to_rep (select a med1)) i)) (and (= o2 (- med1 1)) (in_range2 (- med1 1)))))
(assert (=> (not (< (to_rep (select a med1)) i)) (= right1 result5)))
(assert (=> (not (< (to_rep (select a med1)) i)) (= right2 o2)))
(assert (=> (not (< (to_rep (select a med1)) i)) (= binary_search__search__result3 binary_search__search__result2)))
(assert (=> (not (< (to_rep (select a med1)) i)) (= left2 left1)))
(assert (= j1 result6))
(assert (= j2 2))
(assert (not (in_range2 (+ left2 (div1 (- right2 left2) 2)))))
(check-sat)
(exit)
