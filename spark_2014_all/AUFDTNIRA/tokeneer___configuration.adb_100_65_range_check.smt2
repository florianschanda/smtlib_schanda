...
(assert (=> (<= (to_rep1 (first (rt temp___1895))) (to_rep1 (last (rt temp___1895)))) (= o13 (+ (- (to_rep1 (last (rt temp___1895))) (to_rep1 (first (rt temp___1895)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1895))) (to_rep1 (last (rt temp___1895))))) (= o13 0)))
(assert (= o14 (+ o13 o12)))
(assert (= o15 (+ (to_rep1 (first (rt temp___1895))) o14)))
(assert (= o16 (- o15 1)))
