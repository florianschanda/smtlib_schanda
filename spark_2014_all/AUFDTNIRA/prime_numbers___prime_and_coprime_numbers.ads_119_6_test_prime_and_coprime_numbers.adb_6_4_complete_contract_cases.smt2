...
(assert (not (<= 1 (+ (+ (+ (+ 0 (ite (= (is_prime value) true) 1 0)) (ite (= (ite (= (is_prime value) false) (= mode 0) false) true) 1 0)) (ite (= (ite (= (is_prime value) false) (= mode 1) false) true) 1 0)) (ite (= (ite (= (is_prime value) false) (= mode 2) false) true) 1 0)))))
(check-sat)
(exit)
