...
(define-fun logfilesstatus13 () map__ref1 (mk_map__ref1 logfilesstatus))
(define-fun logfiles12 () map__ref4 (mk_map__ref4 logfiles))
...
(assert (=> (not (< 1 (to_rep5 logfilestate__split_fields5))) (= auditsystemfault7 auditsystemfault12)))
(assert (=> (not (< 1 (to_rep5 logfilestate__split_fields5))) (= logfilestate__split_fields17 logfilestate__split_fields22)))
(assert (=> (not (< 1 (to_rep5 logfilestate__split_fields5))) (= logfilesstatus8 logfilesstatus13)))
(assert (=> (not (< 1 (to_rep5 logfilestate__split_fields5))) (= logfiles7 logfiles12)))
