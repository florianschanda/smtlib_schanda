...
(assert (and (= o303 o296) (in_range1 o296)))
(assert (= o304 (+ o303 o302)))
(assert (and (= o311 o304) (in_range1 o304)))
(assert (= o312 (+ o311 o310)))
(assert (and (= o319 o312) (in_range1 o312)))
(assert (= o320 (+ o319 o318)))
(assert (not (in_range1 o320)))
(check-sat)
(exit)
