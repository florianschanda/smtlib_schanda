...
(assert (= j1 0))
(assert (=> (and (<= 0 j1) (<= j1 9)) (and (and (= temp___179 j1) (and (= temp___178 r1) (and (and (and (= o (+ r1 (to_rep (select (select x i1) j1)))) (in_range4 (+ r1 (to_rep (select (select x i1) j1))))) (and (= r1 result3) (= r2 o))) (and (<= r3 (+ (+ (* i1 10) j2) 1)) (and (and (and (=> (<= 0 100) (in_range4 r3)) (=> (<= 0 9) (in_range3 j2))) (and (<= 0 j2) (<= j2 9))) (= j2 9)))))) (and (and (= j2 j6) (= r3 r7)) (and (= j7 j2) (= r8 r3))))))
(assert (=> (and (<= 0 j1) (<= j1 9)) (= (mk_int__ref j8) (mk_int__ref j6))))
(assert (=> (and (<= 0 j1) (<= j1 9)) (= (mk_int__ref r9) (mk_int__ref r7))))
(assert (=> (and (<= 0 j1) (<= j1 9)) (= j9 j7)))
(assert (=> (and (<= 0 j1) (<= j1 9)) (= r10 r8)))
(assert (=> (not (and (<= 0 j1) (<= j1 9))) (= j1 j8)))
(assert (=> (not (and (<= 0 j1) (<= j1 9))) (= r1 r9)))
(assert (=> (not (and (<= 0 j1) (<= j1 9))) (= j9 j1)))
(assert (=> (not (and (<= 0 j1) (<= j1 9))) (= r10 r1)))
(assert (<= r11 (* (+ i2 1) 10)))
(assert (and (and (=> (<= 0 100) (in_range4 r11)) (=> (<= 0 9) (in_range3 i2))) (and (<= 0 i2) (<= i2 9))))
(assert (not (= i2 9)))
(assert (= i2 result6))
(assert (= i3 (+ i2 1)))
(assert (= j10 result7))
(assert (= j11 0))
(assert (=> (and (<= 0 j11) (<= j11 9)) (and (and (= temp___1791 j11) (and (= temp___1781 r11) (and (and (and (= o8 (+ r11 (to_rep (select (select x i3) j11)))) (in_range4 (+ r11 (to_rep (select (select x i3) j11))))) (and (= r11 result8) (= r12 o8))) (and (<= r13 (+ (+ (* i3 10) j12) 1)) (and (and (and (=> (<= 0 100) (in_range4 r13)) (=> (<= 0 9) (in_range3 j12))) (and (<= 0 j12) (<= j12 9))) (= j12 9)))))) (and (and (= j18 (mk_int__ref j12)) (= r19 (mk_int__ref r13))) (and (= j19 j12) (= r20 r13))))))
(assert (=> (and (<= 0 j11) (<= j11 9)) (= j20 j18)))
(assert (=> (and (<= 0 j11) (<= j11 9)) (= r21 r19)))
(assert (=> (and (<= 0 j11) (<= j11 9)) (= j21 j19)))
(assert (=> (and (<= 0 j11) (<= j11 9)) (= r22 r20)))
(assert (=> (not (and (<= 0 j11) (<= j11 9))) (= j20 (mk_int__ref j11))))
(assert (=> (not (and (<= 0 j11) (<= j11 9))) (= r21 (mk_int__ref r11))))
(assert (=> (not (and (<= 0 j11) (<= j11 9))) (= j21 j11)))
(assert (=> (not (and (<= 0 j11) (<= j11 9))) (= r22 r11)))
(assert (= j22 j20))
...
(assert (= i5 i3))
(assert (= r24 r22))
(assert (not (<= (int__content r23) (* (+ (int__content i4) 1) 10))))
(check-sat)
(exit)
