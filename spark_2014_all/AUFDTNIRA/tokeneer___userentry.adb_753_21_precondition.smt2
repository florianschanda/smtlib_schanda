...
(assert (forall ((configdata__state us_private)) (! (dynamic_invariant1 (thetokenremovalduration configdata__state) true false true) :pattern ((thetokenremovalduration configdata__state)))))
...
(assert (forall ((x statscount)) (! (in_range15 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_1002 Int) (temp___is_init_999 Bool) (temp___skip_constant_1000 Bool) (temp___do_toplevel_1001 Bool)) Bool (=> (or (= temp___is_init_999 true) (<= 0 5)) (in_range16 temp___expr_1002)))
(declare-fun getclass (us_private) Int)
(declare-fun getclass__function_guard (Int us_private) Bool)
(assert (forall ((usertoken__state us_private)) (! (dynamic_invariant3 (getclass usertoken__state) true false true) :pattern ((getclass usertoken__state)))))
...
(define-fun dynamic_invariant8 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_15)))
...
(define-fun dynamic_invariant14 ((temp___expr_526 Int) (temp___is_init_523 Bool) (temp___skip_constant_524 Bool) (temp___do_toplevel_525 Bool)) Bool (=> (or (= temp___is_init_523 true) (<= 1 150)) (in_range4 temp___expr_526)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant15 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1901 2099)) (in_range5 temp___expr_572)))
(define-fun dynamic_invariant16 ((temp___expr_578 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 1 12)) (in_range6 temp___expr_578)))
(define-fun dynamic_invariant17 ((temp___expr_584 Int) (temp___is_init_581 Bool) (temp___skip_constant_582 Bool) (temp___do_toplevel_583 Bool)) Bool (=> (or (= temp___is_init_581 true) (<= 1 31)) (in_range7 temp___expr_584)))
(define-fun dynamic_invariant18 ((temp___expr_612 Int) (temp___is_init_609 Bool) (temp___skip_constant_610 Bool) (temp___do_toplevel_611 Bool)) Bool (=> (or (= temp___is_init_609 true) (<= 0 86399999)) (in_range8 temp___expr_612)))
(define-fun dynamic_invariant19 ((temp___expr_1607 Int) (temp___is_init_1604 Bool) (temp___skip_constant_1605 Bool) (temp___do_toplevel_1606 Bool)) Bool (=> (or (= temp___is_init_1604 true) (<= 0 2147483647)) (in_range15 temp___expr_1607)))
...
(assert (and (= (mk___rep (mk___split_fields o2 o3 o4 o5)) (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime)) (and (= currenttimevar__split_fields o2) (and (= currenttimevar__split_fields1 o3) (and (= currenttimevar__split_fields2 o4) (= currenttimevar__split_fields3 o5))))))
(assert (and (= o1 (getclass state1)) (in_range16 o1)))
(assert (= result1 (isinentryperiod o1 (mk___rep (mk___split_fields o2 o3 o4 o5)) state)))
(assert (= result1 true))
(assert (= o6 (extractuser state1)))
