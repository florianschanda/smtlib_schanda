...
(assert (forall ((configdata__state us_private)) (! (dynamic_invariant1 (thetokenremovalduration configdata__state) true false true true) :pattern ((thetokenremovalduration configdata__state)))))
...
(define-fun dynamic_invariant3 ((temp___expr_1130 Int) (temp___is_init_1126 Bool) (temp___skip_constant_1127 Bool) (temp___do_toplevel_1128 Bool) (temp___do_typ_inv_1129 Bool)) Bool (=> (or (= temp___is_init_1126 true) (<= 0 5)) (in_range16 temp___expr_1130)))
(declare-fun getclass (us_private) Int)
(declare-fun getclass__function_guard (Int us_private) Bool)
(assert (forall ((usertoken__state us_private)) (! (dynamic_invariant3 (getclass usertoken__state) true false true true) :pattern ((getclass usertoken__state)))))
...
(define-fun dynamic_invariant14 ((temp___expr_590 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool) (temp___do_typ_inv_589 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 1 150)) (in_range4 temp___expr_590)))
...
(define-fun dynamic_invariant15 ((temp___expr_642 Int) (temp___is_init_638 Bool) (temp___skip_constant_639 Bool) (temp___do_toplevel_640 Bool) (temp___do_typ_inv_641 Bool)) Bool (=> (or (= temp___is_init_638 true) (<= 1901 2099)) (in_range5 temp___expr_642)))
(define-fun dynamic_invariant16 ((temp___expr_649 Int) (temp___is_init_645 Bool) (temp___skip_constant_646 Bool) (temp___do_toplevel_647 Bool) (temp___do_typ_inv_648 Bool)) Bool (=> (or (= temp___is_init_645 true) (<= 1 12)) (in_range6 temp___expr_649)))
(define-fun dynamic_invariant17 ((temp___expr_656 Int) (temp___is_init_652 Bool) (temp___skip_constant_653 Bool) (temp___do_toplevel_654 Bool) (temp___do_typ_inv_655 Bool)) Bool (=> (or (= temp___is_init_652 true) (<= 1 31)) (in_range7 temp___expr_656)))
(define-fun dynamic_invariant18 ((temp___expr_688 Int) (temp___is_init_684 Bool) (temp___skip_constant_685 Bool) (temp___do_toplevel_686 Bool) (temp___do_typ_inv_687 Bool)) Bool (=> (or (= temp___is_init_684 true) (<= 0 86399999)) (in_range8 temp___expr_688)))
(define-fun dynamic_invariant19 ((temp___expr_1781 Int) (temp___is_init_1777 Bool) (temp___skip_constant_1778 Bool) (temp___do_toplevel_1779 Bool) (temp___do_typ_inv_1780 Bool)) Bool (=> (or (= temp___is_init_1777 true) (<= 0 2147483647)) (in_range15 temp___expr_1781)))
