...
(assert (= k10 (mk_int__ref k3)))
(assert (= logfilestate__split_fields24 (mk___split_fields__ref1 logfilestate__split_fields14)))
(assert (= k11 k3))
(assert (= logfilestate__split_fields25 logfilestate__split_fields14))
(assert (not (= j4 (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields24))))))))
(assert (= logfilestate__split_fields29 logfilestate__split_fields24))
(assert (= logfilestate__split_fields30 logfilestate__split_fields25))
(assert (not (= j4 r76b)))
(assert (= result18 (mk_int__ref j4)))
(assert (= j5 (+ j4 1)))
(assert (= k14 k10))
(assert (= j6 (mk_int__ref j5)))
(assert (= logfilestate__split_fields35 logfilestate__split_fields29))
(assert (= k15 k11))
(assert (= j7 j5))
(assert (= logfilestate__split_fields36 logfilestate__split_fields30))
(assert (< 0 (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields35)))))))
(assert (not (< (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields35))))) i2)))
(check-sat)
(exit)
