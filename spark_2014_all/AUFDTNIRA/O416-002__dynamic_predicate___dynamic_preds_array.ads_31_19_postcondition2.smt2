...
(assert (= result__2 o5))
(assert (= dynamic_preds_array__get_constant_even_pair__result1 dynamic_preds_array__get_constant_even_pair__result2))
(assert (= dynamic_preds_array__get_constant_even_pair__result3 dynamic_preds_array__get_constant_even_pair__result1))
...
(assert (= (mk_map__ref dynamic_preds_array__get_constant_even_pair__result4) (mk_map__ref dynamic_preds_array__get_constant_even_pair__result2)))
(assert (= result__3 result__2))
(assert (= dynamic_preds_array__get_constant_even_pair__result5 dynamic_preds_array__get_constant_even_pair__result3))
(assert (= result__4 result__2))
(assert (= result3 dynamic_preds_array__get_constant_even_pair__result4))
(assert (not (= (to_rep (select dynamic_preds_array__get_constant_even_pair__result4 1)) 0)))
(check-sat)
(exit)
