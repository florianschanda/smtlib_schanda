...
(define-fun logfilestate__split_fields25 () us_split_fields2 (mk___split_fields1 logfilestate__split_fields18 logfilestate__split_fields19 (mk___rep (mk___split_fields logfilestate__split_fields20 logfilestate__split_fields21 logfilestate__split_fields22 logfilestate__split_fields23)) logfilestate__split_fields24))
...
(assert (not (= (valid_numberlogentries__2 (mk___rep1 logfilestate__split_fields25)) true)))
(check-sat)
(exit)
