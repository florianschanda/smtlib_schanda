...
(assert (= result7 true))
(assert (<= (to_rep3 (first (rt x))) hi_index1))
(assert (<= hi_index1 (to_rep3 (last (rt x)))))
(assert (= (to_rep1 o15) hi_index1))
(assert (= (to_rep o16) lo_index1))
(assert (= o17 (mk___split_fields o16 o15)))
(assert (= o18 (mk_slice_bounds o17)))
(assert (not (or (< (to_rep1 (rec__sums__slice_bounds__hi (us_split_fields1 o18))) (to_rep (rec__sums__slice_bounds__lo (us_split_fields1 o18)))) (and (<= (to_rep3 (first (rt x))) (to_rep (rec__sums__slice_bounds__lo (us_split_fields1 o18)))) (<= (to_rep1 (rec__sums__slice_bounds__hi (us_split_fields1 o18))) (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
