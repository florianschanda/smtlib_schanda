...
(assert (forall ((lo_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index1) (<= lo_index1 (- lo2 1))) (forall ((hi_index2 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index2) (<= hi_index2 (to_rep3 (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index1) (of_rep1 hi_index2)))) max_sum2))))))
...
(assert (and (forall ((lo_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index1) (<= lo_index1 (- lo2 1))) (forall ((hi_index2 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index2) (<= hi_index2 (to_rep3 (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index1) (of_rep1 hi_index2)))) max_sum3))))) (forall ((hi_index2 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index2) (<= hi_index2 (- hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index2)))) max_sum3)))))
...
(assert (= result4 (ite (<= (to_rep3 (first (rt x))) hi_index1) o11 false)))
(assert (= (= o12 true) (forall ((hi_index2 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index2) (<= hi_index2 (- hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index2)))) max_sum3)))))
