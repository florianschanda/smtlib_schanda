...
(define-fun tint_arrayD1__ref___23__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___23__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t736b__ref (mk_t736b__ref (t736b__content integer)))))
(define-fun t736b__ref___projection ((a t736b__ref)) integer (t736b__content a))
(declare-sort t2 0)
...
(define-fun tnumber_array_typeD1__ref___32__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___32__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t740b__ref (mk_t740b__ref (t740b__content integer)))))
(define-fun t740b__ref___projection ((a t740b__ref)) integer (t740b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t742b__ref (mk_t742b__ref (t742b__content integer)))))
(define-fun t742b__ref___projection ((a t742b__ref)) integer (t742b__content a))
...
(define-fun tint_arrayB__ref___23__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_length_6__int_array__aggregate_def (Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___2324 Int) (temp___2325 Int) (temp___2326 Int) (temp___2327 Int) (temp___2328 Int) (temp___2329 Int) (temp___2330 Int)) (let ((temp___2323 (aida__conversion__calculate_negative_target_length_6__int_array__aggregate_def temp___2324 temp___2325 temp___2326 temp___2327 temp___2328 temp___2329 temp___2330))) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 5) temp___2329 temp___2330) (and (= (first5 temp___2323) temp___2329) (= (last5 temp___2323) temp___2330))) (and (and (and (and (= (select (to_array2 temp___2323) (+ (+ (first1 source) 1) 0)) (of_rep1 temp___2324)) (= (select (to_array2 temp___2323) (+ (+ (first1 source) 1) 1)) (of_rep1 temp___2325))) (= (select (to_array2 temp___2323) (+ (+ (first1 source) 1) 2)) (of_rep1 temp___2326))) (= (select (to_array2 temp___2323) (+ (+ (first1 source) 1) 3)) (of_rep1 temp___2327))) (= (select (to_array2 temp___2323) (+ (+ (first1 source) 1) 4)) (of_rep1 temp___2328)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___32__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_length_6__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___2336 Int) (temp___2337 Int) (temp___2338 Int)) (let ((temp___2335 (aida__conversion__calculate_negative_target_length_6__n__aggregate_def temp___2336 temp___2337 temp___2338))) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 5) temp___2337 temp___2338) (and (= (first9 temp___2335) temp___2337) (= (last9 temp___2335) temp___2338))) (forall ((temp___2339 Int)) (= (select (to_array4 temp___2335) temp___2339) (of_rep1 temp___2336)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_761 us_t3) (temp___is_init_758 Bool) (temp___skip_constant_759 Bool) (temp___do_toplevel_760 Bool)) Bool (=> (not (= temp___skip_constant_759 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 5) (first7 temp___expr_761) (last7 temp___expr_761)) (and (= (first7 temp___expr_761) (+ (first1 source) 1)) (= (last7 temp___expr_761) (+ (first1 source) 5))))))
...
(declare-const temp___2333 (Array Int integer))
(declare-const temp___23331 t2)
(declare-const aida__conversion__calculate_negative_target_length_6__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_length_6__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___2341 (Array Int integer))
(declare-const temp___23411 t4)
(declare-const aida__conversion__calculate_negative_target_length_6__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_length_6__n__assume1 t3)
...
(assert (and (= (length source) 6) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index11) (<= index11 (+ (to_rep1 (first (rt source))) 5))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_length_6__int_array__aggregate_def 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 4))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_length_6__int_array__aggregate_def 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 4))))) (+ (+ (to_rep1 (first (rt source))) 1) 4)))
(assert (= (mk___t2 temp___2333 temp___23331) (aida__conversion__calculate_negative_target_length_6__int_array__aggregate_def 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 4))))
(assert (= (ite (<= (to_rep1 (first4 temp___23331)) (to_rep1 (last4 temp___23331))) (+ (- (to_rep1 (last4 temp___23331)) (to_rep1 (first4 temp___23331))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5)) (+ (- (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2333 (to_rep1 (first4 temp___23331)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_6__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5)) aida__conversion__calculate_negative_target_length_6__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_length_6__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_length_6__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_length_6__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 5)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_length_6__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_length_6__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5))))) (+ (to_rep1 (first (rt source))) 5)))
(assert (= (mk___t4 temp___2341 temp___23411) (aida__conversion__calculate_negative_target_length_6__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5))))
(assert (= (ite (<= (to_rep1 (first8 temp___23411)) (to_rep1 (last8 temp___23411))) (+ (- (to_rep1 (last8 temp___23411)) (to_rep1 (first8 temp___23411))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5)) (+ (- (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2341 (to_rep1 (first8 temp___23411)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_6__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5)) aida__conversion__calculate_negative_target_length_6__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_length_6__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_length_6__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_length_6__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 5)))))
(assert (and (= temp___2347 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2348 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___2347))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= temp___2346 index2)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= temp___2344 n1)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= o5 index2)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= o6 (select n1 o5))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= o7 (to_rep1 o6))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= o7 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= o8 index2)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= o9 (select (elts source) o8))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= o10 (to_rep o9))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o10))) (ite (= (= o10 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o10 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o10 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o10 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o10 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o10 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o10 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o10 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o10 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o10 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= (to_rep1 o11) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= o12 index2)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= o13 (store n1 o12 o11))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= n1 result4)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= n2 o13)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (and (and (forall ((temp___2345 Int)) (=> (and (<= (to_rep1 n__first) temp___2345) (<= temp___2345 (to_rep1 n__last))) (=> (< index3 temp___2345) (= (select n3 temp___2345) (select temp___2344 temp___2345))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 5) index3))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 5))))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= index3 temp___2348)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= index3 index5)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= n3 n5)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= index6 index3)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= n6 n3)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= index8 index6)))
(assert (=> (and (<= temp___2347 index2) (<= index2 temp___2348)) (= n8 n6)))
(assert (=> (not (and (<= temp___2347 index2) (<= index2 temp___2348))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___2347 index2) (<= index2 temp___2348))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2347 index2) (<= index2 temp___2348))) (= index8 index2)))
(assert (=> (not (and (<= temp___2347 index2) (<= index2 temp___2348))) (= n8 n1)))
