...
(assert (and (and (forall ((temp___261 Int)) (=> (and (<= 0 temp___261) (<= temp___261 100000)) (=> (< index2 temp___261) (= (select result__2 temp___261) (select result__ temp___261))))) (=> (<= 0 100000) (in_range3 index2))) (and (<= 0 index2) (<= index2 100000))))
(assert (<= 0 v))
(assert (<= v index2))
