...
(assert (= result__1 o2))
(assert (forall ((v1 Int)) (=> (and (<= 0 v1) (<= v1 index2)) (= (= (select result__2 v1) true) (= (are_coprime value v1) true)))))
(assert (and (and (=> (<= 0 100000) (in_range3 index2)) (forall ((temp___227 Int)) (=> (and (<= 0 temp___227) (<= temp___227 100000)) (=> (< index2 temp___227) (= (select result__2 temp___227) (select result__ temp___227)))))) (and (<= 0 index2) (<= index2 100000))))
(assert (<= 0 v))
(assert (<= v index2))
