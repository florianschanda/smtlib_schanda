...
(assert (= i1 result2))
(assert (= i2 0))
(assert (and (and (and (and (and (<= i3 length1) (=> (< i3 length1) (= (mod2 i3 (* l2 2)) 0))) (forall ((j4 Int)) (=> (and (<= 0 j4) (<= j4 2147483647)) (=> (< (* (* j4 l2) 2) i3) (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* (* j4 l2) 2)) (ite (< (* l2 2) (- length1 (* (* j4 l2) 2))) (* l2 2) (- length1 (* (* j4 l2) 2)))) true))))) (forall ((j4 Int)) (=> (and (<= 0 j4) (<= j4 2147483647)) (=> (< (* j4 l2) (- length1 i3)) (= (sorted (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ (+ a_first i3) (* j4 l2)) (ite (< l2 (- (- length1 i3) (* j4 l2))) l2 (- (- length1 i3) (* j4 l2)))) true))))) (= (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)) (<= 1 l2)))
(assert (and (=> (<= 0 2147483647) (in_range2 i3)) (=> (<= 0 2147483647) (in_range2 k2))))
(assert (= o50 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (<= 0 j2))
(assert (<= j2 2147483647))
(assert (and (= o36 (- length1 i3)) (in_range1 (- length1 i3))))
(assert (and (= o37 (* j2 l2)) (in_range1 (* j2 l2))))
(assert (= result3 (ite (< o37 o36) true false)))
(assert (= result3 true))
(assert (not (in_range1 (* j2 l2))))
(check-sat)
(exit)
