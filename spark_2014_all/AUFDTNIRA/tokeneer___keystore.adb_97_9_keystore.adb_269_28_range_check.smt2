...
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= (int__content retvalupd10) c44b)))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (in_range14 c44b)))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= result17 result__1)))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= (let ((subject result__1)) result__12) nodescription)))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b)))))) (= o20 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b)))))) 1)))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b))))))) (= o20 0))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (<= 1 39) (= o21 (+ (- 39 1) 1)))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (not (<= 1 39)) (= o21 0))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= o22 (+ o21 o20))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= o23 (+ 1 o22))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= o24 (- o23 1))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (and (= o25 o24) (in_range2 o24))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= keystore__digest__B48b__thestring__assume (mk___t (concat1 (temp___String_Literal_1724 Tuple0) 1 39 (elts (to_string (attr__ATTRIBUTE_IMAGE14 c44b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c44b)))))) (mk 1 o25)))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= keystore__digest__B48b__thestring__assume thestring1)))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (dynamic_invariant1 thestring1 true false true)))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (and (= o26 (length thestring1)) (in_range1 (length thestring1)))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= result18 (ite (<= o26 150) true false))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (= result18 true) (= (ite (<= (to_rep1 (first (rt thestring1))) (to_rep1 (last (rt thestring1)))) (+ (- (to_rep1 (last (rt thestring1))) (to_rep1 (first (rt thestring1)))) 1) 0) (ite (<= 1 (length thestring1)) (+ (- (length thestring1) 1) 1) 0)))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (= result18 true) (= temp___1718 (mk___t2 (slide (elts thestring1) (to_rep1 (first (rt thestring1))) 1) (mk2 1 (length thestring1)))))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (= result18 true) (and (= temp___1720 (length thestring1)) (in_range1 (length thestring1))))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (= result18 true) (=> (<= 1 temp___1720) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1720) (<= temp___1720 150)))))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (= result18 true) (= o27 (let ((subject result__1)) result__12)))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (= result18 true) (= temp___1721 (mk___t2 o27 (mk2 1 temp___1720))))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (= result18 true) (= (ite (<= (to_rep1 (first4 (rt2 temp___1718))) (to_rep1 (last4 (rt2 temp___1718)))) (+ (- (to_rep1 (last4 (rt2 temp___1718))) (to_rep1 (first4 (rt2 temp___1718)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1721))) (to_rep1 (last4 (rt2 temp___1721)))) (+ (- (to_rep1 (last4 (rt2 temp___1721))) (to_rep1 (first4 (rt2 temp___1721)))) 1) 0)))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (= result18 true) (= temp___1722 temp___1718))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (= result18 true) (forall ((temp___1723 Int)) (ite (and (<= 1 temp___1723) (<= temp___1723 (length thestring1))) (= (select o28 temp___1723) (select (elts2 temp___1722) temp___1723)) (= (select o28 temp___1723) (select (let ((subject result__1)) result__12) temp___1723)))))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (= result18 true) (= result19 (let ((subject result__1)) (mk_map__ref result__12))))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (= result18 true) (= (let ((subject result__1)) result__13) o28))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (= result18 true) (= result__15 (let ((subject result__1)) (mk_map__ref result__13))))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (= result18 true) (= result__16 result__13))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (not (= result18 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring1))) 1) (<= 1 (to_rep1 (last (rt thestring1))))) (and (<= (to_rep1 (first (rt thestring1))) 150) (<= 150 (to_rep1 (last (rt thestring1))))))))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (not (= result18 true)) (= temp___1717 thestring1))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (not (= result18 true)) (= o29 (elts temp___1717)))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (not (= result18 true)) (= result20 (let ((subject result__1)) (mk_map__ref result__12))))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (not (= result18 true)) (= (let ((subject result__1)) result__14) o29))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (not (= result18 true)) (= result__15 (let ((subject result__1)) (mk_map__ref result__14))))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (=> (not (= result18 true)) (= result__16 result__14))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= result21 c46b)))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= (let ((subject c46b)) c46b2) (map__content result__15))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (and (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true) (in_range4 auditalarm5))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= filestate6 (let ((subject filestate)) (mk___private__ref filestate5)))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= state6 (let ((subject state)) (mk___private__ref state5)))))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= result__17 result__15)))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= c46b3 (let ((subject c46b)) (mk_map__ref c46b2)))))
...
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= result__18 result__16)))
(assert (=> (= (select issystem (int__content retvalupd10)) true) (= c46b4 c46b2)))
...
(assert (=> (not (= (select issystem (int__content retvalupd10)) true)) (= result__17 result__1)))
(assert (=> (not (= (select issystem (int__content retvalupd10)) true)) (= c46b3 c46b)))
...
(assert (=> (not (= (select issystem (int__content retvalupd10)) true)) (= result__18 result__4)))
(assert (=> (not (= (select issystem (int__content retvalupd10)) true)) (= c46b4 c46b1)))
...
(assert (in_range14 c56b))
(assert (= result22 result__2))
(assert (= (let ((subject result__2)) result__19) nodescription))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c56b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c56b)))))) (= o30 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c56b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c56b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c56b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c56b))))))) (= o30 0)))
(assert (=> (<= 1 38) (= o31 (+ (- 38 1) 1))))
(assert (=> (not (<= 1 38)) (= o31 0)))
(assert (= o32 (+ o31 o30)))
(assert (= o33 (+ 1 o32)))
(assert (= o34 (- o33 1)))
(assert (not (in_range2 o34)))
(check-sat)
(exit)
