...
(assert (not (= (length (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thealarmsilentduration 10)))) 0)))
(assert (=> (<= 1 2) (= o (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o 0)))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thealarmsilentduration 10)))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thealarmsilentduration 10))))))) (= o1 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thealarmsilentduration 10)))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thealarmsilentduration 10))))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thealarmsilentduration 10)))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thealarmsilentduration 10)))))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE5 (div1 thealarmsilentduration 10)))))) o2)))
(assert (= o4 (- o3 1)))
