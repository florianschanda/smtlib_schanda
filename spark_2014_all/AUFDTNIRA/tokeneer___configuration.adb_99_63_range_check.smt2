...
(assert (not (= (length2 temp___1890) 0)))
(assert (=> (<= 1 2) (= o (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 temp___1890))) (to_rep1 (last4 (rt2 temp___1890)))) (= o1 (+ (- (to_rep1 (last4 (rt2 temp___1890))) (to_rep1 (first4 (rt2 temp___1890)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 temp___1890))) (to_rep1 (last4 (rt2 temp___1890))))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first4 (rt2 temp___1890))) o2)))
(assert (= o4 (- o3 1)))
