...
(assert (and (= o36 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (= (= o36 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields5)))))))
(assert (= o37 (ite (not (= o36 true)) true false)))
(assert (and (= result25 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (= (= result25 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields5)))))))
