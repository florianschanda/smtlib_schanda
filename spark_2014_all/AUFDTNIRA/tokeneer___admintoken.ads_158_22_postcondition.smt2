...
(assert (= (= (bool__content tokenok) true) (and (and (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields)) true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content10 authcert__split_fields)) true)) (in_range11 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content10 authcert__split_fields)))))))
(assert (and (and (and (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content2 logfilestate__split_fields7))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content2 logfilestate__split_fields7))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content2 logfilestate__split_fields7)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content2 logfilestate__split_fields7))) true) (in_range5 (int__content tokentry1))) (in_range6 (int__content auditalarm1))) (in_range4 (int__content tokenid1))))
(assert (= (bool__content tokenok) true))
(assert (not (= (isgood (us_split_fields__content11 idcert__split_fields)) true)))
(check-sat)
(exit)
