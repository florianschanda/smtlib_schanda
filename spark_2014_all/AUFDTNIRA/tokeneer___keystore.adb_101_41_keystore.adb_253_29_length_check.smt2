...
(assert (=> (<= 1 temp___1707) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1707) (<= temp___1707 150)))))
(assert (= o17 result__5))
(assert (= temp___1708 (mk___t1 o17 (mk1 1 temp___1707))))
(assert (not (= (ite (<= (to_rep1 (first2 (rt1 temp___1705))) (to_rep1 (last2 (rt1 temp___1705)))) (+ (- (to_rep1 (last2 (rt1 temp___1705))) (to_rep1 (first2 (rt1 temp___1705)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1708))) (to_rep1 (last2 (rt1 temp___1708)))) (+ (- (to_rep1 (last2 (rt1 temp___1708))) (to_rep1 (first2 (rt1 temp___1708)))) 1) 0))))
(check-sat)
(exit)
