...
(assert (and (and (<= 1 (to_rep4 logfilestate__split_fields12)) (= (to_rep3 logfilestate__split_fields8) (+ (* (- (to_rep4 logfilestate__split_fields12) 1) 1024) (to_rep5 (select logfilestate__split_fields13 (to_rep2 logfilestate__split_fields7)))))) (in_range6 auditalarm1)))
(assert (in_range6 auditalarm2))
(assert (not (= oldalarm1 auditalarm2)))
(assert (not (<= 1 (to_rep4 logfilestate__split_fields12))))
(check-sat)
(exit)
