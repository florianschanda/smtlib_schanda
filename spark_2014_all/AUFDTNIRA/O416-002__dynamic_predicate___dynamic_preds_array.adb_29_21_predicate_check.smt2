...
(define-fun dynamic_invariant ((temp___expr_137 Int) (temp___is_init_134 Bool) (temp___skip_constant_135 Bool) (temp___do_toplevel_136 Bool)) Bool (and (=> (or (= temp___is_init_134 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_137)) (=> (= temp___do_toplevel_136 true) (=> (= temp___is_init_134 true) (= (mod2 temp___expr_137 2) 0)))))
...
(assert (in_range2 dynamic_preds_array__init_even__x))
...
(assert (= result x))
(assert (= x1 o2))
(assert (and (and (in_range dynamic_preds_array__init_ok_even__x) (= (mod2 dynamic_preds_array__init_ok_even__x 2) 0)) (in_range2 dynamic_preds_array__init_ok_even__x)))
