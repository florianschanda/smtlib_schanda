...
(assert (=> (not (= currentlatch locallatch1)) (and (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields14)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields14)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields14)) true) (in_range4 auditalarm2))))
(assert (=> (= currentlatch locallatch1) (= state2 state)))
(assert (=> (= currentlatch locallatch1) (= filestate2 filestate)))
(assert (=> (= currentlatch locallatch1) (= auditsystemfault2 auditsystemfault)))
(assert (=> (= currentlatch locallatch1) (= auditalarm2 auditalarm)))
(assert (=> (= currentlatch locallatch1) (= logfilestate__split_fields14 (mk___split_fields2 logfilestate__split_fields logfilestate__split_fields1 (mk___rep1 (mk___split_fields1 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))))
(assert (=> (= currentlatch locallatch1) (= logfilesstatus2 logfilesstatus)))
(assert (=> (= currentlatch locallatch1) (= logfiles2 logfiles)))
(assert (=> (= currentlatch locallatch1) (= state2 state1)))
(assert (=> (= currentlatch locallatch1) (= filestate2 filestate1)))
(assert (=> (= currentlatch locallatch1) (= auditsystemfault2 auditsystemfault1)))
(assert (=> (= currentlatch locallatch1) (= auditalarm2 auditalarm1)))
...
(assert (=> (= currentlatch locallatch1) (= logfilesstatus2 logfilesstatus1)))
(assert (=> (= currentlatch locallatch1) (= logfiles2 logfiles1)))
