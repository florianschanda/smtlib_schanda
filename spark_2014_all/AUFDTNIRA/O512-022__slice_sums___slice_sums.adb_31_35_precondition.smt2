...
(assert (forall ((lo_index Int)) (=> (and (<= (to_rep (first (rt x))) lo_index) (<= lo_index (- lo2 1))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep (first (rt x))) hi_index1) (<= hi_index1 (to_rep (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index) (of_rep1 hi_index1)))) max_sum2))))))
...
(assert (and (forall ((lo_index Int)) (=> (and (<= (to_rep (first (rt x))) lo_index) (<= lo_index (- lo2 1))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep (first (rt x))) hi_index1) (<= hi_index1 (to_rep (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index) (of_rep1 hi_index1)))) max_sum3))))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep (first (rt x))) hi_index1) (<= hi_index1 (- hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index1)))) max_sum3)))))
...
(assert (and (= o (- hi2 1)) (in_range1 (- hi2 1))))
(assert (= o1 (ite (<= hi_index o) true false)))
(assert (= result4 (ite (<= (to_rep (first (rt x))) hi_index) o1 false)))
(assert (= result4 true))
(assert (= (extended_indexqtint o2) hi_index))
(assert (= (indexqtint o3) lo2))
(assert (= o4 (mk___split_fields o3 o2)))
(assert (= o5 (mk_slice_bounds o4)))
(assert (not (or (< (extended_indexqtint (rec__sums__slice_bounds__hi (us_split_fields1 o5))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 o5)))) (and (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 o5)))) (<= (extended_indexqtint (rec__sums__slice_bounds__hi (us_split_fields1 o5))) (to_rep (last (rt x))))))))
(check-sat)
(exit)
