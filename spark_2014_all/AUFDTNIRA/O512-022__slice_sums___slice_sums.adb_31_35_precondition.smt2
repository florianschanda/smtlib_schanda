...
(assert (= result6 true))
(assert (= (to_rep1 o22) hi_index2))
(assert (= (to_rep o23) lo3))
(assert (= o24 (mk___split_fields o23 o22)))
(assert (= o25 (mk_slice_bounds o24)))
(assert (not (or (< (to_rep1 (rec__sums__slice_bounds__hi (us_split_fields1 o25))) (to_rep (rec__sums__slice_bounds__lo (us_split_fields1 o25)))) (and (<= (to_rep3 (first (rt x))) (to_rep (rec__sums__slice_bounds__lo (us_split_fields1 o25)))) (<= (to_rep1 (rec__sums__slice_bounds__hi (us_split_fields1 o25))) (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
