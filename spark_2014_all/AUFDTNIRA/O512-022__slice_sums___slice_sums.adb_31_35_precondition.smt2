...
(assert (forall ((lo_index Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index) (<= lo_index (- lo2 1))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index1) (<= hi_index1 (to_rep3 (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index) (of_rep1 hi_index1)))) max_sum2))))))
...
(assert (and (forall ((lo_index Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index) (<= lo_index (- lo2 1))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index1) (<= hi_index1 (to_rep3 (last (rt x))))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index) (of_rep1 hi_index1)))) max_sum3))))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index1) (<= hi_index1 (- hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index1)))) max_sum3)))))
...
(assert (not (or (< (to_rep1 (rec__sums__slice_bounds__hi (us_split_fields1 o9))) (to_rep (rec__sums__slice_bounds__lo (us_split_fields1 o9)))) (and (<= (to_rep3 (first (rt x))) (to_rep (rec__sums__slice_bounds__lo (us_split_fields1 o9)))) (<= (to_rep1 (rec__sums__slice_bounds__hi (us_split_fields1 o9))) (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
