...
(assert (forall ((x filestatust)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun to_rep3 ((x yearst)) Int (yearstqtint x))
(declare-fun of_rep3 (Int) yearst)
(assert (forall ((x yearst)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x yearst)) (! (in_range6 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun to_rep4 ((x monthst)) Int (monthstqtint x))
(declare-fun of_rep4 (Int) monthst)
(assert (forall ((x monthst)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x monthst)) (! (in_range7 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun to_rep5 ((x dayst)) Int (daystqtint x))
(declare-fun of_rep5 (Int) dayst)
(assert (forall ((x dayst)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x dayst)) (! (in_range8 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun to_rep6 ((x millisecst)) Int (millisecstqtint x))
(declare-fun of_rep6 (Int) millisecst)
(assert (forall ((x millisecst)) (! (= (of_rep6 (to_rep6 x)) x) :pattern ((to_rep6 x)))))
(assert (forall ((x millisecst)) (! (in_range9 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(define-fun bool_eq3 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (= (to_rep3 (rec__clock__timet__year (us_split_fields3 a))) (to_rep3 (rec__clock__timet__year (us_split_fields3 b)))) (= (to_rep4 (rec__clock__timet__month (us_split_fields3 a))) (to_rep4 (rec__clock__timet__month (us_split_fields3 b))))) (= (to_rep5 (rec__clock__timet__day (us_split_fields3 a))) (to_rep5 (rec__clock__timet__day (us_split_fields3 b))))) (= (to_rep6 (rec__clock__timet__millisec (us_split_fields3 a))) (to_rep6 (rec__clock__timet__millisec (us_split_fields3 b))))) true false))
...
(declare-fun user_eq12 (namecountt namecountt) Bool)
(declare-const dummy12 namecountt)
...
(declare-fun user_eq13 (character character) Bool)
(declare-const dummy13 character)
(declare-datatypes () ((character__ref (mk_character__ref (character__content character)))))
(define-fun character__ref___projection ((a character__ref)) character (character__content a))
(declare-fun to_rep8 (character) Int)
(declare-fun of_rep8 (Int) character)
(assert (forall ((x character)) (! (= (of_rep8 (to_rep8 x)) x) :pattern ((to_rep8 x)))))
(assert (forall ((x character)) (! (in_range11 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(define-fun bool_eq4 ((a (Array Int character)) (a__first Int) (a__last Int) (b (Array Int character)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep8 (select a temp___idx_91)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_91))))))) true false))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep8 (select a temp___idx_91)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_91)))))))))))
...
(declare-fun user_eq15 (issueridt issueridt) Bool)
(declare-const dummy15 issueridt)
...
(define-fun to_rep9 ((x issueridt)) Int (issueridtqtint x))
(declare-fun of_rep9 (Int) issueridt)
(assert (forall ((x issueridt)) (! (= (of_rep9 (to_rep9 x)) x) :pattern ((to_rep9 x)))))
(assert (forall ((x issueridt)) (! (in_range12 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun bool_eq5 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep9 (rec__cryptotypes__issuert__id (us_split_fields5 a))) (to_rep9 (rec__cryptotypes__issuert__id (us_split_fields5 b)))) (= (to_rep7 (rec__cryptotypes__issuert__namelength (us_split_fields5 a))) (to_rep7 (rec__cryptotypes__issuert__namelength (us_split_fields5 b))))) (= (bool_eq4 (rec__cryptotypes__issuert__name (us_split_fields5 a)) 1 40 (rec__cryptotypes__issuert__name (us_split_fields5 b)) 1 40) true)) true false))
...
(declare-fun user_eq17 (serialnumbert serialnumbert) Bool)
(declare-const dummy17 serialnumbert)
...
(define-fun to_rep10 ((x serialnumbert)) Int (serialnumbertqtint x))
(declare-fun of_rep10 (Int) serialnumbert)
(assert (forall ((x serialnumbert)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x serialnumbert)) (! (in_range13 (to_rep10 x)) :pattern ((to_rep10 x)))))
(assert (forall ((x Int)) (! (=> (in_range13 x) (= (to_rep10 (of_rep10 x)) x)) :pattern ((to_rep10 (of_rep10 x))))))
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__certtypes__idt__issuer us_rep3) (rec__certtypes__idt__serialnumber serialnumbert)))))
(define-fun us_split_fields_Issuer__projection ((a us_split_fields6)) us_rep3 (rec__certtypes__idt__issuer a))
...
(define-fun bool_eq6 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (bool_eq5 (rec__certtypes__idt__issuer (us_split_fields7 a)) (rec__certtypes__idt__issuer (us_split_fields7 b))) true) (= (to_rep10 (rec__certtypes__idt__serialnumber (us_split_fields7 a))) (to_rep10 (rec__certtypes__idt__serialnumber (us_split_fields7 b))))) true false))
...
(define-fun us_rep___8__projection ((a us_rep5)) us_split_fields8 (us_split_fields9 a))
(define-fun bool_eq7 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (= (to_rep11 (rec__cryptotypes__keypartt__algorithmid (us_split_fields9 a))) (to_rep11 (rec__cryptotypes__keypartt__algorithmid (us_split_fields9 b)))) (= (to_rep12 (rec__cryptotypes__keypartt__keyid (us_split_fields9 a))) (to_rep12 (rec__cryptotypes__keypartt__keyid (us_split_fields9 b))))) (= (to_rep13 (rec__cryptotypes__keypartt__keylength (us_split_fields9 a))) (to_rep13 (rec__cryptotypes__keypartt__keylength (us_split_fields9 b))))) true false))
...
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__cert__id__contentst__id us_rep4) (rec__cert__id__contentst__notbefore us_rep2) (rec__cert__id__contentst__notafter us_rep2) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep3) (rec__cert__id__contentst__subjectpublickey us_rep5)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields10)) us_rep4 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields10)) us_rep2 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields10)) us_rep2 (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields10)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields10)) us_rep3 (rec__cert__id__contentst__subject a))
(define-fun us_split_fields_SubjectPublicKey__projection ((a us_split_fields10)) us_rep5 (rec__cert__id__contentst__subjectpublickey a))
...
(define-fun us_rep___19__projection ((a us_rep6)) us_split_fields10 (us_split_fields11 a))
(define-fun bool_eq8 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (and (and (= (bool_eq6 (rec__cert__id__contentst__id (us_split_fields11 a)) (rec__cert__id__contentst__id (us_split_fields11 b))) true) (= (bool_eq3 (rec__cert__id__contentst__notbefore (us_split_fields11 a)) (rec__cert__id__contentst__notbefore (us_split_fields11 b))) true)) (= (bool_eq3 (rec__cert__id__contentst__notafter (us_split_fields11 a)) (rec__cert__id__contentst__notafter (us_split_fields11 b))) true)) (= (to_rep11 (rec__cert__id__contentst__mechanism (us_split_fields11 a))) (to_rep11 (rec__cert__id__contentst__mechanism (us_split_fields11 b))))) (= (bool_eq5 (rec__cert__id__contentst__subject (us_split_fields11 a)) (rec__cert__id__contentst__subject (us_split_fields11 b))) true)) (= (bool_eq7 (rec__cert__id__contentst__subjectpublickey (us_split_fields11 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields11 b))) true)) true false))
...
(define-fun contentst__ref___4__projection ((a contentst__ref)) us_rep6 (contentst__content a))
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__admintoken__valididcertt__valid Bool) (rec__admintoken__valididcertt__contents us_rep6)))))
(define-fun us_split_fields_Valid__2__projection ((a us_split_fields12)) Bool (rec__admintoken__valididcertt__valid a))
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields12)) us_rep6 (rec__admintoken__valididcertt__contents a))
...
(define-fun us_rep___21__projection ((a us_rep7)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq9 ((a us_rep7) (b us_rep7)) Bool (ite (and (= (rec__admintoken__valididcertt__valid (us_split_fields13 a)) (rec__admintoken__valididcertt__valid (us_split_fields13 b))) (= (bool_eq8 (rec__admintoken__valididcertt__contents (us_split_fields13 a)) (rec__admintoken__valididcertt__contents (us_split_fields13 b))) true)) true false))
...
(declare-datatypes () ((valididcertt__ref (mk_valididcertt__ref (valididcertt__content us_rep7)))))
(define-fun valididcertt__ref___projection ((a valididcertt__ref)) us_rep7 (valididcertt__content a))
...
(define-fun in_range17 ((x Int)) Bool (and (<= 1 x) (<= x 17)))
...
(declare-fun user_eq25 (logfileindext logfileindext) Bool)
(declare-const dummy25 logfileindext)
...
(assert (forall ((x logfileindext)) (! (in_range17 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(define-fun in_range18 ((x Int)) Bool (and (<= 0 x) (<= x 17408)))
...
(declare-fun user_eq26 (logentrycountt logentrycountt) Bool)
(declare-const dummy26 logentrycountt)
...
(assert (forall ((x logentrycountt)) (! (in_range18 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(define-fun in_range19 ((x Int)) Bool (and (<= 0 x) (<= x 17)))
...
(declare-fun user_eq27 (logfilecountt logfilecountt) Bool)
(declare-const dummy27 logfilecountt)
...
(assert (forall ((x logfilecountt)) (! (in_range19 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun bool_eq10 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_195 Int)) (=> (and (<= a__first temp___idx_195) (<= temp___idx_195 a__last)) (= (to_rep14 (select a temp___idx_195)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_195))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_195 Int)) (=> (and (<= a__first temp___idx_195) (<= temp___idx_195 a__last)) (= (to_rep14 (select a temp___idx_195)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_195)))))))))))
(declare-const dummy28 (Array Int logfileindext))
(declare-const value__size9 Int)
(declare-fun object__size9 ((Array Int logfileindext)) Int)
(declare-const value__component__size1 Int)
(declare-fun object__component__size1 ((Array Int logfileindext)) Int)
(declare-const value__alignment9 Int)
(declare-fun object__alignment9 ((Array Int logfileindext)) Int)
(assert (<= 0 value__size9))
(assert (forall ((a (Array Int logfileindext))) (<= 0 (object__size9 a))))
(assert (<= 0 value__component__size1))
(assert (forall ((a (Array Int logfileindext))) (<= 0 (object__component__size1 a))))
(assert (<= 0 value__alignment9))
(assert (forall ((a (Array Int logfileindext))) (<= 0 (object__alignment9 a))))
(declare-fun user_eq28 ((Array Int logfileindext) (Array Int logfileindext)) Bool)
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__auditlog__logfilelistt__list (Array Int logfileindext)) (rec__auditlog__logfilelistt__head logfileindext) (rec__auditlog__logfilelistt__lasti logfileindext) (rec__auditlog__logfilelistt__length logfilecountt)))))
(define-fun us_split_fields_List__projection ((a us_split_fields14)) (Array Int logfileindext) (rec__auditlog__logfilelistt__list a))
(define-fun us_split_fields_Head__projection ((a us_split_fields14)) logfileindext (rec__auditlog__logfilelistt__head a))
(define-fun us_split_fields_LastI__projection ((a us_split_fields14)) logfileindext (rec__auditlog__logfilelistt__lasti a))
(define-fun us_split_fields_Length__3__projection ((a us_split_fields14)) logfilecountt (rec__auditlog__logfilelistt__length a))
...
(define-fun us_rep___10__projection ((a us_rep8)) us_split_fields14 (us_split_fields15 a))
(define-fun bool_eq11 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (= (bool_eq10 (rec__auditlog__logfilelistt__list (us_split_fields15 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields15 b)) 1 17) true) (= (to_rep14 (rec__auditlog__logfilelistt__head (us_split_fields15 a))) (to_rep14 (rec__auditlog__logfilelistt__head (us_split_fields15 b))))) (= (to_rep14 (rec__auditlog__logfilelistt__lasti (us_split_fields15 a))) (to_rep14 (rec__auditlog__logfilelistt__lasti (us_split_fields15 b))))) (= (to_rep16 (rec__auditlog__logfilelistt__length (us_split_fields15 a))) (to_rep16 (rec__auditlog__logfilelistt__length (us_split_fields15 b))))) true false))
...
(define-fun in_range20 ((x Int)) Bool (and (<= 0 x) (<= x 1024)))
...
(declare-fun user_eq30 (fileentrycountt fileentrycountt) Bool)
(declare-const dummy30 fileentrycountt)
...
(assert (forall ((x fileentrycountt)) (! (in_range20 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(define-fun bool_eq12 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep17 (select a temp___idx_196)) (to_rep17 (select b (+ (- b__first a__first) temp___idx_196))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq12 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep17 (select a temp___idx_196)) (to_rep17 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
(declare-const dummy31 (Array Int fileentrycountt))
(declare-const value__size11 Int)
(declare-fun object__size11 ((Array Int fileentrycountt)) Int)
(declare-const value__component__size2 Int)
(declare-fun object__component__size2 ((Array Int fileentrycountt)) Int)
(declare-const value__alignment11 Int)
(declare-fun object__alignment11 ((Array Int fileentrycountt)) Int)
(assert (<= 0 value__size11))
(assert (forall ((a (Array Int fileentrycountt))) (<= 0 (object__size11 a))))
(assert (<= 0 value__component__size2))
(assert (forall ((a (Array Int fileentrycountt))) (<= 0 (object__component__size2 a))))
(assert (<= 0 value__alignment11))
(assert (forall ((a (Array Int fileentrycountt))) (<= 0 (object__alignment11 a))))
(declare-fun user_eq31 ((Array Int fileentrycountt) (Array Int fileentrycountt)) Bool)
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__auditlog__logfilestatet__currentlogfile logfileindext) (rec__auditlog__logfilestatet__numberlogentries logentrycountt) (rec__auditlog__logfilestatet__usedlogfiles us_rep8) (rec__auditlog__logfilestatet__logfileentries (Array Int fileentrycountt))))))
(define-fun us_split_fields_CurrentLogFile__projection ((a us_split_fields16)) logfileindext (rec__auditlog__logfilestatet__currentlogfile a))
(define-fun us_split_fields_NumberLogEntries__projection ((a us_split_fields16)) logentrycountt (rec__auditlog__logfilestatet__numberlogentries a))
(define-fun us_split_fields_UsedLogFiles__projection ((a us_split_fields16)) us_rep8 (rec__auditlog__logfilestatet__usedlogfiles a))
(define-fun us_split_fields_LogFileEntries__projection ((a us_split_fields16)) (Array Int fileentrycountt) (rec__auditlog__logfilestatet__logfileentries a))
...
(define-fun us_rep___11__projection ((a us_rep9)) us_split_fields16 (us_split_fields17 a))
(define-fun bool_eq13 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (and (= (to_rep14 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields17 a))) (to_rep14 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields17 b)))) (= (to_rep15 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields17 a))) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields17 b))))) (= (bool_eq11 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields17 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields17 b))) true)) (= (bool_eq12 (rec__auditlog__logfilestatet__logfileentries (us_split_fields17 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields17 b)) 1 17) true)) true false))
...
(declare-datatypes () ((map__ref4 (mk_map__ref4 (map__content4 (Array Int us_rep1))))))
(declare-fun slide4 ((Array Int us_rep1) Int Int) (Array Int us_rep1))
(assert (forall ((a (Array Int us_rep1))) (forall ((first Int)) (! (= (slide4 a first first) a) :pattern ((slide4 a first first))))))
(assert (forall ((a (Array Int us_rep1))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide4 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide4 a old_first new_first) i))))))))
(define-fun bool_eq14 ((a (Array Int us_rep1)) (a__first Int) (a__last Int) (b (Array Int us_rep1)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq1 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true)))) true false))
(assert (forall ((a (Array Int us_rep1)) (b (Array Int us_rep1))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq14 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq1 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true))))))))
...
(declare-fun user_eq33 (classt classt) Bool)
(declare-const dummy33 classt)
...
(declare-fun to_rep18 (classt) Int)
(declare-fun of_rep18 (Int) classt)
(assert (forall ((x classt)) (! (= (of_rep18 (to_rep18 x)) x) :pattern ((to_rep18 x)))))
(assert (forall ((x classt)) (! (in_range21 (to_rep18 x)) :pattern ((to_rep18 x)))))
...
(define-fun bool_eq15 ((a us_rep10) (b us_rep10)) Bool (ite (= (to_rep18 (rec__privtypes__clearancet__class (us_split_fields19 a))) (to_rep18 (rec__privtypes__clearancet__class (us_split_fields19 b)))) true false))
...
(declare-datatypes () ((us_split_fields20 (mk___split_fields10 (rec__cert__attr__auth__contentst__id us_rep4) (rec__cert__attr__auth__contentst__notbefore us_rep2) (rec__cert__attr__auth__contentst__notafter us_rep2) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep4) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep10)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields20)) us_rep4 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields20)) us_rep2 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields20)) us_rep2 (rec__cert__attr__auth__contentst__notafter a))
...
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields20)) us_rep4 (rec__cert__attr__auth__contentst__basecertid a))
...
(define-fun bool_eq16 ((a us_rep11) (b us_rep11)) Bool (ite (and (and (and (and (and (and (= (bool_eq6 (rec__cert__attr__auth__contentst__id (us_split_fields21 a)) (rec__cert__attr__auth__contentst__id (us_split_fields21 b))) true) (= (bool_eq3 (rec__cert__attr__auth__contentst__notbefore (us_split_fields21 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields21 b))) true)) (= (bool_eq3 (rec__cert__attr__auth__contentst__notafter (us_split_fields21 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields21 b))) true)) (= (to_rep11 (rec__cert__attr__auth__contentst__mechanism (us_split_fields21 a))) (to_rep11 (rec__cert__attr__auth__contentst__mechanism (us_split_fields21 b))))) (= (bool_eq6 (rec__cert__attr__auth__contentst__basecertid (us_split_fields21 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields21 b))) true)) (= (to_rep (rec__cert__attr__auth__contentst__role (us_split_fields21 a))) (to_rep (rec__cert__attr__auth__contentst__role (us_split_fields21 b))))) (= (bool_eq15 (rec__cert__attr__auth__contentst__clearance (us_split_fields21 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields21 b))) true)) true false))
...
(define-fun bool_eq17 ((a us_rep12) (b us_rep12)) Bool (ite (and (= (rec__admintoken__validauthcertt__valid (us_split_fields23 a)) (rec__admintoken__validauthcertt__valid (us_split_fields23 b))) (= (bool_eq16 (rec__admintoken__validauthcertt__contents (us_split_fields23 a)) (rec__admintoken__validauthcertt__contents (us_split_fields23 b))) true)) true false))
...
(declare-fun user_eq36 (us_rep12 us_rep12) Bool)
(declare-const dummy36 us_rep12)
...
(declare-fun user_eq37 (statust statust) Bool)
(declare-const dummy37 statust)
...
(define-fun dynamic_invariant2 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range22 temp___expr_548)))
...
(define-fun dynamic_invariant3 ((temp___expr_1338 us_rep9) (temp___is_init_1334 Bool) (temp___skip_constant_1335 Bool) (temp___do_toplevel_1336 Bool) (temp___do_typ_inv_1337 Bool)) Bool (=> (= temp___do_typ_inv_1337 true) (= (valid_numberlogentries (to_rep14 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields17 temp___expr_1338))) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields17 temp___expr_1338))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields17 temp___expr_1338)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields17 temp___expr_1338))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1342 us_rep9) (temp___skip_top_level_1343 Bool)) Bool (and (and (and (= (to_rep14 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields17 temp___expr_1342))) 1) (= (to_rep15 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields17 temp___expr_1342))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields17 temp___expr_1342)) (mk___rep7 (mk___split_fields7 (temp_____aggregate_def_1344 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields17 temp___expr_1342)) (temp_____aggregate_def_1348 0))))
(define-fun type_invariant ((temp___1352 us_rep9)) Bool (= (valid_numberlogentries (to_rep14 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields17 temp___1352))) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields17 temp___1352))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields17 temp___1352)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields17 temp___1352))) true))
...
(define-fun dynamic_invariant5 ((temp___expr_1517 Int) (temp___is_init_1513 Bool) (temp___skip_constant_1514 Bool) (temp___do_toplevel_1515 Bool) (temp___do_typ_inv_1516 Bool)) Bool (=> (or (= temp___is_init_1513 true) (<= 0 4294967295)) (in_range24 temp___expr_1517)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant6 ((temp___expr_1524 Int) (temp___is_init_1520 Bool) (temp___skip_constant_1521 Bool) (temp___do_toplevel_1522 Bool) (temp___do_typ_inv_1523 Bool)) Bool (=> (or (= temp___is_init_1520 true) (<= 0 2)) (in_range25 temp___expr_1524)))
...
(define-fun dynamic_invariant8 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range11 temp___expr_74)))
...
(define-fun dynamic_invariant11 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range21 temp___expr_440)))
(define-fun dynamic_invariant12 ((temp___expr_1092 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool) (temp___do_typ_inv_1091 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 40)) (in_range10 temp___expr_1092)))
(define-fun dynamic_invariant13 ((temp___expr_1116 Int) (temp___is_init_1112 Bool) (temp___skip_constant_1113 Bool) (temp___do_toplevel_1114 Bool) (temp___do_typ_inv_1115 Bool)) Bool (=> (or (= temp___is_init_1112 true) (<= 0 4294967295)) (in_range12 temp___expr_1116)))
(define-fun dynamic_invariant14 ((temp___expr_1140 Int) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool) (temp___do_typ_inv_1139 Bool)) Bool (=> (or (= temp___is_init_1136 true) (<= 0 10)) (in_range14 temp___expr_1140)))
(define-fun dynamic_invariant15 ((temp___expr_1154 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool) (temp___do_typ_inv_1153 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 4294967295)) (in_range15 temp___expr_1154)))
(define-fun dynamic_invariant16 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 128)) (in_range16 temp___expr_1161)))
(define-fun dynamic_invariant17 ((temp___expr_1276 Int) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (or (= temp___is_init_1272 true) (<= 0 17)) (in_range19 temp___expr_1276)))
(define-fun dynamic_invariant18 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 1 17)) (in_range17 temp___expr_1283)))
(define-fun dynamic_invariant19 ((temp___expr_1409 Int) (temp___is_init_1405 Bool) (temp___skip_constant_1406 Bool) (temp___do_toplevel_1407 Bool) (temp___do_typ_inv_1408 Bool)) Bool (=> (or (= temp___is_init_1405 true) (<= 0 2)) (in_range5 temp___expr_1409)))
(define-fun dynamic_invariant20 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17408)) (in_range18 temp___expr_1290)))
(define-fun dynamic_invariant21 ((temp___expr_1321 Int) (temp___is_init_1317 Bool) (temp___skip_constant_1318 Bool) (temp___do_toplevel_1319 Bool) (temp___do_typ_inv_1320 Bool)) Bool (=> (or (= temp___is_init_1317 true) (<= 0 1024)) (in_range20 temp___expr_1321)))
(assert true)
(assert (forall ((currentlogfile Int) (numberlogentries Int)) (forall ((usedlogfiles us_rep8)) (forall ((logfileentries (Array Int fileentrycountt))) (! (= (= (valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries) true) (and (<= 1 (to_rep16 (rec__auditlog__logfilelistt__length (us_split_fields15 usedlogfiles)))) (= numberlogentries (+ (* (- (to_rep16 (rec__auditlog__logfilelistt__length (us_split_fields15 usedlogfiles))) 1) 1024) (to_rep17 (select logfileentries currentlogfile)))))) :pattern ((valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries)))))))
...
(define-fun dynamic_invariant22 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range6 temp___expr_625)))
(define-fun dynamic_invariant23 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range7 temp___expr_632)))
(define-fun dynamic_invariant24 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range8 temp___expr_639)))
(define-fun dynamic_invariant25 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range9 temp___expr_671)))
(define-fun dynamic_invariant26 ((temp___expr_1596 Int) (temp___is_init_1592 Bool) (temp___skip_constant_1593 Bool) (temp___do_toplevel_1594 Bool) (temp___do_typ_inv_1595 Bool)) Bool (=> (or (= temp___is_init_1592 true) (<= 0 4294967295)) (in_range13 temp___expr_1596)))
...
(declare-const logfilestate__split_fields7 us_split_fields16)
...
(declare-const logfilestate__split_fields8 us_split_fields16)
...
(declare-const logfilestate__split_fields9 us_split_fields16)
...
(declare-const logfilestate__split_fields10 us_split_fields16)
...
(declare-const logfilestate__split_fields11 us_split_fields16)
...
(declare-const logfilestate__split_fields12 us_split_fields__ref8)
...
(declare-const thecurrentfloppy4 t__ref1)
(declare-const configdataok3 bool__ref)
...
(declare-const logfilestate__split_fields13 us_split_fields16)
...
(assert (in_range23 tokenpresence))
(assert (in_range25 tokentry))
(assert (in_range24 tokenid))
(assert (= (valid_numberlogentries (to_rep14 logfilestate__split_fields) (to_rep15 logfilestate__split_fields1) (mk___rep7 (mk___split_fields7 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6) true))
...
(assert (=> (= status 6) (=> (= result true) (and (= (valid_numberlogentries (to_rep14 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true) (in_range22 auditalarm1)))))
(assert (=> (= status 6) (=> (= result true) (= result1 status6))))
(assert (=> (= status 6) (=> (= result true) (= status2 7))))
(assert (=> (= status 6) (=> (not (= result true)) (and (= (valid_numberlogentries (to_rep14 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range22 auditalarm2)))))
(assert (=> (= status 6) (=> (not (= result true)) (= (let ((subject state2)) (mk___private__ref state7)) (let ((subject state2)) (mk___private__ref state9))))))
(assert (=> (= status 6) (=> (not (= result true)) (= state5 state1))))
...
(assert (=> (= status 6) (=> (not (= result true)) (= auditsystemfault auditsystemfault1))))
(assert (=> (= status 6) (=> (not (= result true)) (= auditalarm1 auditalarm2))))
(assert (=> (= status 6) (=> (not (= result true)) (= logfilestate__split_fields7 logfilestate__split_fields8))))
(assert (=> (= status 6) (=> (not (= result true)) (= logfilesstatus logfilesstatus1))))
(assert (=> (= status 6) (=> (not (= result true)) (= logfiles logfiles1))))
(assert (=> (= status 6) (=> (not (= result true)) (= state7 state9))))
(assert (=> (= status 6) (=> (not (= result true)) (= state5 state4))))
(assert (=> (= status 6) (=> (not (= result true)) (= state6 state8))))
(assert (=> (= status 6) (=> (not (= result true)) (= filestate2 filestate3))))
...
(assert (=> (= status 6) (= state10 state3)))
...
(assert (=> (not (= status 6)) (= result2 (mk_t__ref1 thecurrentfloppy))))
(assert (=> (not (= status 6)) (= thecurrentfloppy2 o)))
(assert (=> (not (= status 6)) (and (= (valid_numberlogentries (to_rep14 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range22 auditalarm3))))
(assert (=> (not (= status 6)) (=> (= configdataok2 true) (and (= (valid_numberlogentries (to_rep14 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true) (in_range22 auditalarm4)))))
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (and (= (valid_numberlogentries (to_rep14 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true) (in_range22 auditalarm5)))))
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= (let ((subject state2)) (mk___private__ref state12)) (let ((subject state2)) (mk___private__ref state14))))))
...
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= auditsystemfault2 auditsystemfault3))))
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= auditalarm4 auditalarm5))))
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= logfilestate__split_fields10 logfilestate__split_fields11))))
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= logfilesstatus2 logfilesstatus3))))
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= logfiles2 logfiles3))))
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= state12 state14))))
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= state11 state13))))
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= filestate5 filestate6))))
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= auditsystemfault2 auditsystemfault3))))
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= auditalarm4 auditalarm5))))
...
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= logfilesstatus2 logfilesstatus3))))
(assert (=> (not (= status 6)) (=> (not (= configdataok2 true)) (= logfiles2 logfiles3))))
(assert (=> (not (= status 6)) (= result3 status6)))
(assert (=> (not (= status 6)) (= status3 3)))
(assert (=> (not (= status 6)) (and (and (not (= (isdoingop (mk___rep theadmin__split_fields3)) true)) (= (rolepresent (mk___rep theadmin__split_fields3)) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))) (= (ispresent (mk___rep theadmin__split_fields3)) true))))
(assert (=> (not (= status 6)) (= (let ((subject state2)) (mk___private__ref state7)) (let ((subject state2)) (mk___private__ref state12)))))
(assert (=> (not (= status 6)) (= state5 state1)))
(assert (=> (not (= status 6)) (= state6 state11)))
(assert (=> (not (= status 6)) (= filestate2 filestate5)))
(assert (=> (not (= status 6)) (= status2 status3)))
(assert (=> (not (= status 6)) (= auditsystemfault auditsystemfault2)))
(assert (=> (not (= status 6)) (= auditalarm1 auditalarm4)))
(assert (=> (not (= status 6)) (= logfilestate__split_fields7 logfilestate__split_fields10)))
(assert (=> (not (= status 6)) (= logfilesstatus logfilesstatus2)))
(assert (=> (not (= status 6)) (= logfiles logfiles2)))
(assert (=> (not (= status 6)) (= state7 state12)))
(assert (=> (not (= status 6)) (= state5 state4)))
(assert (=> (not (= status 6)) (= state6 state11)))
(assert (=> (not (= status 6)) (= filestate2 filestate5)))
(assert (=> (not (= status 6)) (= status2 status3)))
(assert (=> (not (= status 6)) (= auditsystemfault auditsystemfault2)))
...
(assert (=> (not (= status 6)) (= logfilesstatus logfilesstatus2)))
(assert (=> (not (= status 6)) (= logfiles logfiles2)))
(assert (= state18 (let ((subject state2)) (mk___private__ref state7))))
(assert (= state17 (mk___private__ref state5)))
(assert (= state16 (mk___private__ref state6)))
(assert (= filestate8 (mk___private__ref filestate2)))
(assert (= state15 (mk___private__ref state10)))
...
(assert (= auditalarm6 (mk_int__ref auditalarm1)))
(assert (= logfilestate__split_fields12 (mk___split_fields__ref8 logfilestate__split_fields7)))
(assert (= logfilesstatus4 (mk_map__ref logfilesstatus)))
(assert (= logfiles4 (mk_map__ref4 logfiles)))
(assert (= state22 state7))
(assert (= state21 state5))
...
(assert (= auditalarm7 auditalarm1))
(assert (= logfilestate__split_fields13 logfilestate__split_fields7))
(assert (= logfilesstatus5 logfilesstatus))
(assert (= logfiles5 logfiles))
(assert (not (or (or (= (int__content status4) 6) (= (int__content status4) 7)) (= (int__content status4) 3))))
(check-sat)
(exit)
