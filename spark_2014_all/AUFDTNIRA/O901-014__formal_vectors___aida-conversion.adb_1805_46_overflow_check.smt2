...
(assert (forall ((temp___2195 Int) (temp___2196 Int) (temp___2197 Int) (temp___2198 Int) (temp___2199 Int) (temp___2200 Int) (temp___2201 Int) (temp___2202 Int) (temp___2203 Int) (temp___2204 Int) (temp___2205 Int)) (let ((temp___2194 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def temp___2195 temp___2196 temp___2197 temp___2198 temp___2199 temp___2200 temp___2201 temp___2202 temp___2203 temp___2204 temp___2205))) (=> (and (and (and (and (and (and (and (and (dynamic_invariant temp___2195 true true true true) (dynamic_invariant temp___2196 true true true true)) (dynamic_invariant temp___2197 true true true true)) (dynamic_invariant temp___2198 true true true true)) (dynamic_invariant temp___2199 true true true true)) (dynamic_invariant temp___2200 true true true true)) (dynamic_invariant temp___2201 true true true true)) (dynamic_invariant temp___2202 true true true true)) (dynamic_invariant temp___2203 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 2) (+ (first1 source) 10) temp___2204 temp___2205) (and (= (first5 temp___2194) temp___2204) (= (last5 temp___2194) temp___2205))) (and (and (and (and (and (and (and (and (= (select (to_array2 temp___2194) (+ (+ (first1 source) 2) 0)) rliteral) (= (select (to_array2 temp___2194) (+ (+ (first1 source) 2) 1)) rliteral1)) (= (select (to_array2 temp___2194) (+ (+ (first1 source) 2) 2)) rliteral1)) (= (select (to_array2 temp___2194) (+ (+ (first1 source) 2) 3)) rliteral1)) (= (select (to_array2 temp___2194) (+ (+ (first1 source) 2) 4)) rliteral1)) (= (select (to_array2 temp___2194) (+ (+ (first1 source) 2) 5)) rliteral1)) (= (select (to_array2 temp___2194) (+ (+ (first1 source) 2) 6)) rliteral1)) (= (select (to_array2 temp___2194) (+ (+ (first1 source) 2) 7)) rliteral1)) (= (select (to_array2 temp___2194) (+ (+ (first1 source) 2) 8)) rliteral1)))))))
(define-fun dynamic_invariant4 ((temp___expr_734 us_t3) (temp___is_init_730 Bool) (temp___skip_constant_731 Bool) (temp___do_toplevel_732 Bool) (temp___do_typ_inv_733 Bool)) Bool (=> (not (= temp___skip_constant_731 true)) (and (dynamic_property6 (+ (first1 source) 2) (+ (first1 source) 10) (first7 temp___expr_734) (last7 temp___expr_734)) (and (= (first7 temp___expr_734) (+ (first1 source) 2)) (= (last7 temp___expr_734) (+ (first1 source) 10))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2211 Int) (temp___2212 Int) (temp___2213 Int)) (let ((temp___2210 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def temp___2211 temp___2212 temp___2213))) (=> (dynamic_invariant temp___2211 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 2) (+ (first1 source) 10) temp___2212 temp___2213) (and (= (first9 temp___2210) temp___2212) (= (last9 temp___2210) temp___2213))) (forall ((temp___2214 Int)) (= (select (to_array4 temp___2210) temp___2214) rliteral)))))))
...
(declare-const temp___2208 (Array Int integer))
(declare-const temp___22081 t2)
...
(declare-const temp___2216 (Array Int integer))
(declare-const temp___22161 t4)
...
(declare-const temp___2218 Int)
(declare-const temp___2219 Int)
(declare-const temp___2222 (Array Int integer))
(declare-const temp___2220 Int)
(declare-const o Int)
...
(declare-const temp___2224 Int)
(declare-const o9 Int)
(declare-const o10 integer)
(declare-const o11 Int)
(declare-const o12 Int)
(declare-const o13 Int)
(declare-const temp___2225 Int)
...
(assert (and (= (length source) 11) (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 48)) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) index7) (<= index7 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2208 temp___22081) (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def 0 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 2) (+ (+ (to_rep1 (first (rt source))) 2) 8))))
(assert (= (ite (<= (to_rep1 (first4 temp___22081)) (to_rep1 (last4 temp___22081))) (+ (- (to_rep1 (last4 temp___22081)) (to_rep1 (first4 temp___22081))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 2)) 1) 0)))
(assert (= (slide1 temp___2208 (to_rep1 (first4 temp___22081)) (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume))
...
(assert (= (mk___t4 temp___2216 temp___22161) (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___22161)) (to_rep1 (last8 temp___22161))) (+ (- (to_rep1 (last8 temp___22161)) (to_rep1 (first8 temp___22161))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 2)) 1) 0)))
(assert (= (slide1 temp___2216 (to_rep1 (first8 temp___22161)) (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume))
...
(assert (and (= temp___2218 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (= temp___2219 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2218))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= temp___2222 n1)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= temp___2220 index1)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= o index1)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= o3 index1)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= o7 index1)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= n1 result3)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= n2 o8)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (and (and (=> (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10) index2)) (forall ((temp___2223 Int)) (=> (and (<= (to_rep1 n__first) temp___2223) (<= temp___2223 (to_rep1 n__last))) (=> (or (< temp___2219 temp___2223) (or (< temp___2223 temp___2218) (< index2 temp___2223))) (= (select n3 temp___2223) (select temp___2222 temp___2223)))))) (and (<= (+ (to_rep1 (first (rt source))) 2) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= index2 temp___2219)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= index2 index3)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= n3 n4)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= index4 index2)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= n5 n3)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= index6 index4)))
(assert (=> (and (<= temp___2218 index1) (<= index1 temp___2219)) (= n7 n5)))
(assert (=> (not (and (<= temp___2218 index1) (<= index1 temp___2219))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2218 index1) (<= index1 temp___2219))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2218 index1) (<= index1 temp___2219))) (= index6 index1)))
(assert (=> (not (and (<= temp___2218 index1) (<= index1 temp___2219))) (= n7 n1)))
...
(assert (and (= temp___2224 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___2224) (<= temp___2224 (to_rep1 n__last))))
(assert (= o9 temp___2224))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2225 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___2225) (<= temp___2225 (to_rep1 n__last))))
(assert (= o14 temp___2225))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___2226 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2226) (<= temp___2226 (to_rep1 n__last))))
(assert (= o21 temp___2226))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___2227 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2227) (<= temp___2227 (to_rep1 n__last))))
(assert (= o28 temp___2227))
...
(assert (= target4 o34))
(assert (<= (- 9999) target4))
(assert (and (= temp___2228 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2228) (<= temp___2228 (to_rep1 n__last))))
(assert (= o35 temp___2228))
...
(assert (and (= temp___2229 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2229) (<= temp___2229 (to_rep1 n__last))))
(assert (= o42 temp___2229))
...
(assert (and (= temp___2230 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2230) (<= temp___2230 (to_rep1 n__last))))
(assert (= o49 temp___2230))
...
(assert (and (= temp___2231 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2231) (<= temp___2231 (to_rep1 n__last))))
(assert (= o56 temp___2231))
(assert (= o57 (select (map__content1 n6) o56)))
(assert (= o58 (to_rep1 o57)))
(assert (= o59 (* o58 10000000)))
(assert (not (in_range1 o59)))
(check-sat)
(exit)
