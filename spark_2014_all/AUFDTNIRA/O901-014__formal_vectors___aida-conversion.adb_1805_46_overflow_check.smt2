...
(define-fun tint_arrayD1__ref___17__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___17__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t586b__ref (mk_t586b__ref (t586b__content integer)))))
(define-fun t586b__ref___projection ((a t586b__ref)) integer (t586b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t587b__ref (mk_t587b__ref (t587b__content us_t2)))))
(define-fun t587b__ref___projection ((a t587b__ref)) us_t2 (t587b__content a))
...
(define-fun tnumber_array_typeD1__ref___26__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___26__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t590b__ref (mk_t590b__ref (t590b__content integer)))))
(define-fun t590b__ref___projection ((a t590b__ref)) integer (t590b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t591b__ref (mk_t591b__ref (t591b__content us_t4)))))
(define-fun t591b__ref___projection ((a t591b__ref)) us_t4 (t591b__content a))
...
(declare-datatypes () ((t592b__ref (mk_t592b__ref (t592b__content integer)))))
(define-fun t592b__ref___projection ((a t592b__ref)) integer (t592b__content a))
...
(define-fun tint_arrayB__ref___17__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___2093 Int) (temp___2094 Int) (temp___2095 Int) (temp___2096 Int) (temp___2097 Int) (temp___2098 Int) (temp___2099 Int) (temp___2100 Int) (temp___2101 Int) (temp___2102 Int) (temp___2103 Int)) (let ((temp___2092 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def temp___2093 temp___2094 temp___2095 temp___2096 temp___2097 temp___2098 temp___2099 temp___2100 temp___2101 temp___2102 temp___2103))) (and (=> (dynamic_property10 (+ (first1 source) 2) (+ (first1 source) 10) temp___2102 temp___2103) (and (= (first5 temp___2092) temp___2102) (= (last5 temp___2092) temp___2103))) (and (and (and (and (and (and (and (and (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 0)) (of_rep1 temp___2093)) (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 1)) (of_rep1 temp___2094))) (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 2)) (of_rep1 temp___2095))) (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 3)) (of_rep1 temp___2096))) (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 4)) (of_rep1 temp___2097))) (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 5)) (of_rep1 temp___2098))) (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 6)) (of_rep1 temp___2099))) (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 7)) (of_rep1 temp___2100))) (= (select (to_array2 temp___2092) (+ (+ (first1 source) 2) 8)) (of_rep1 temp___2101)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___26__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___2109 Int) (temp___2110 Int) (temp___2111 Int)) (let ((temp___2108 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def temp___2109 temp___2110 temp___2111))) (and (=> (dynamic_property11 (+ (first1 source) 2) (+ (first1 source) 10) temp___2110 temp___2111) (and (= (first9 temp___2108) temp___2110) (= (last9 temp___2108) temp___2111))) (forall ((temp___2112 Int)) (= (select (to_array4 temp___2108) temp___2112) (of_rep1 temp___2109)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_653 us_t3) (temp___is_init_650 Bool) (temp___skip_constant_651 Bool) (temp___do_toplevel_652 Bool)) Bool (=> (not (= temp___skip_constant_651 true)) (and (dynamic_property6 (+ (first1 source) 2) (+ (first1 source) 10) (first7 temp___expr_653) (last7 temp___expr_653)) (and (= (first7 temp___expr_653) (+ (first1 source) 2)) (= (last7 temp___expr_653) (+ (first1 source) 10))))))
...
(declare-const temp___2106 (Array Int integer))
(declare-const temp___21061 t2)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___2114 (Array Int integer))
(declare-const temp___21141 t4)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume1 t3)
(declare-const us2 Int)
(declare-const us3 Int)
(declare-const temp___2120 Int)
(declare-const temp___2121 Int)
(declare-const temp___2118 (Array Int integer))
...
(assert (and (= (length source) 11) (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 48)) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def 0 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 2) (+ (+ (to_rep1 (first (rt source))) 2) 8))))) (+ (to_rep1 (first (rt source))) 2)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def 0 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 2) (+ (+ (to_rep1 (first (rt source))) 2) 8))))) (+ (+ (to_rep1 (first (rt source))) 2) 8)))
(assert (= (mk___t2 temp___2106 temp___21061) (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__aggregate_def 0 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 2) (+ (+ (to_rep1 (first (rt source))) 2) 8))))
(assert (= (ite (<= (to_rep1 (first4 temp___21061)) (to_rep1 (last4 temp___21061))) (+ (- (to_rep1 (last4 temp___21061)) (to_rep1 (first4 temp___21061))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 2)) 1) 0)))
(assert (= (slide1 temp___2106 (to_rep1 (first4 temp___21061)) (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 2)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 2)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)))
(assert (= (mk___t4 temp___2114 temp___21141) (aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___21141)) (to_rep1 (last8 temp___21141))) (+ (- (to_rep1 (last8 temp___21141)) (to_rep1 (first8 temp___21141))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 2)) 1) 0)))
(assert (= (slide1 temp___2114 (to_rep1 (first8 temp___21141)) (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_2_0xx_xxx_xxx__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 2)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= temp___2120 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (= temp___2121 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___2120))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= temp___2118 n1)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= temp___2116 index2)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= o13 index2)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= o14 (select n1 o13))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= o15 (to_rep1 o14))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= o15 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= o16 index2)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= o17 (select (elts source) o16))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= o18 (to_rep o17))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o18))) (ite (= (= o18 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o18 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o18 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o18 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o18 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o18 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o18 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o18 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o18 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o18 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= (to_rep1 o19) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= o20 index2)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= o21 (store n1 o20 o19))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= n1 result4)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= n2 o21)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 2) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (and (and (=> (<= (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 2) (+ (to_rep1 (first (rt source))) 10) index3)) (forall ((temp___2119 Int)) (=> (and (<= (to_rep1 n__first) temp___2119) (<= temp___2119 (to_rep1 n__last))) (=> (< index3 temp___2119) (= (select n3 temp___2119) (select temp___2118 temp___2119)))))) (and (<= (+ (to_rep1 (first (rt source))) 2) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= index3 temp___2121)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= index3 index5)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= n3 n5)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= index6 index3)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= n6 n3)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= index8 index6)))
(assert (=> (and (<= temp___2120 index2) (<= index2 temp___2121)) (= n8 n6)))
(assert (=> (not (and (<= temp___2120 index2) (<= index2 temp___2121))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___2120 index2) (<= index2 temp___2121))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2120 index2) (<= index2 temp___2121))) (= index8 index2)))
(assert (=> (not (and (<= temp___2120 index2) (<= index2 temp___2121))) (= n8 n1)))
...
(assert (and (= temp___2122 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___2122) (<= temp___2122 (to_rep1 n__last))))
(assert (= o49 temp___2122))
(assert (= o50 (select (map__content1 n7) o49)))
(assert (= o51 (to_rep1 o50)))
(assert (= o52 (- o51)))
(assert (and (= o53 o52) (in_range1 o52)))
(assert (= result9 (mk_int__ref target)))
(assert (= target1 o53))
(assert (<= (- 9) target1))
(assert (and (= temp___2123 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___2123) (<= temp___2123 (to_rep1 n__last))))
(assert (= o54 temp___2123))
(assert (= o55 (select (map__content1 n7) o54)))
(assert (= o56 (to_rep1 o55)))
(assert (= o57 (* o56 10)))
(assert (and (= o58 o57) (in_range1 o57)))
(assert (= o59 (- target1 o58)))
(assert (and (= o60 o59) (in_range1 o59)))
(assert (= result10 (mk_int__ref target1)))
(assert (= target2 o60))
(assert (<= (- 99) target2))
(assert (and (= temp___2124 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2124) (<= temp___2124 (to_rep1 n__last))))
(assert (= o61 temp___2124))
(assert (= o62 (select (map__content1 n7) o61)))
(assert (= o63 (to_rep1 o62)))
(assert (= o64 (* o63 100)))
(assert (and (= o65 o64) (in_range1 o64)))
(assert (= o66 (- target2 o65)))
(assert (and (= o67 o66) (in_range1 o66)))
(assert (= result11 (mk_int__ref target2)))
(assert (= target3 o67))
(assert (<= (- 999) target3))
(assert (and (= temp___2125 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2125) (<= temp___2125 (to_rep1 n__last))))
(assert (= o68 temp___2125))
(assert (= o69 (select (map__content1 n7) o68)))
(assert (= o70 (to_rep1 o69)))
(assert (= o71 (* o70 1000)))
(assert (and (= o72 o71) (in_range1 o71)))
(assert (= o73 (- target3 o72)))
(assert (and (= o74 o73) (in_range1 o73)))
(assert (= result12 (mk_int__ref target3)))
(assert (= target4 o74))
(assert (<= (- 9999) target4))
(assert (and (= temp___2126 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2126) (<= temp___2126 (to_rep1 n__last))))
(assert (= o75 temp___2126))
(assert (= o76 (select (map__content1 n7) o75)))
(assert (= o77 (to_rep1 o76)))
(assert (= o78 (* o77 10000)))
(assert (and (= o79 o78) (in_range1 o78)))
(assert (= o80 (- target4 o79)))
(assert (and (= o81 o80) (in_range1 o80)))
(assert (= result13 (mk_int__ref target4)))
(assert (= target5 o81))
(assert (<= (- 99999) target5))
(assert (and (= temp___2127 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2127) (<= temp___2127 (to_rep1 n__last))))
(assert (= o82 temp___2127))
(assert (= o83 (select (map__content1 n7) o82)))
(assert (= o84 (to_rep1 o83)))
(assert (= o85 (* o84 100000)))
(assert (and (= o86 o85) (in_range1 o85)))
(assert (= o87 (- target5 o86)))
(assert (and (= o88 o87) (in_range1 o87)))
(assert (= result14 (mk_int__ref target5)))
(assert (= target6 o88))
(assert (<= (- 999999) target6))
(assert (and (= temp___2128 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2128) (<= temp___2128 (to_rep1 n__last))))
(assert (= o89 temp___2128))
(assert (= o90 (select (map__content1 n7) o89)))
(assert (= o91 (to_rep1 o90)))
(assert (= o92 (* o91 1000000)))
(assert (and (= o93 o92) (in_range1 o92)))
(assert (= o94 (- target6 o93)))
(assert (and (= o95 o94) (in_range1 o94)))
(assert (= result15 (mk_int__ref target6)))
(assert (= target7 o95))
(assert (<= (- 9999999) target7))
(assert (and (= temp___2129 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2129) (<= temp___2129 (to_rep1 n__last))))
(assert (= o96 temp___2129))
(assert (= o97 (select (map__content1 n7) o96)))
(assert (= o98 (to_rep1 o97)))
(assert (= o99 (* o98 10000000)))
(assert (not (in_range1 o99)))
(check-sat)
(exit)
