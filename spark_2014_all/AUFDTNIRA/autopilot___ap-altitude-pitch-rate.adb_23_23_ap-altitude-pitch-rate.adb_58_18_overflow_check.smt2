...
(assert (forall ((x pitchangle)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= (- 180) 180)) (in_range3 temp___expr_159)))
(define-fun dynamic_invariant2 ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= (- 10) 20)) (in_range2 temp___expr_201)))
...
(assert (in_range2 pitch))
(assert (=> (<= (- 180) 180) (in_range3 present_pitchrate)))
(assert (=> (<= (- 10) 20) (in_range2 average)))
(assert (=> (<= (- 10) 20) (in_range2 early_pitch)))
(assert (= (mk_int__ref result) (mk_int__ref sum)))
(assert (= sum1 0))
(assert (in_range1 sum1))
(assert (=> (<= (- 2147483648) 2147483647) (in_range1 gap)))
(assert (=> (<= (- 10) 20) (in_range2 average1)))
...
(assert (and (= o (* i2 (- 10))) (in_range1 (* i2 (- 10)))))
(assert (= o1 (ite (<= o sum2) true false)))
