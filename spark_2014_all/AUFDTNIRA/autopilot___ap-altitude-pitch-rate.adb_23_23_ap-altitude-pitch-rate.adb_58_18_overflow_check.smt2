...
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 sum2)) (=> (<= 1 10) (in_range4 i2))) (and (<= 1 i2) (<= i2 10))))
(assert (and (= o1 (* i2 (- 10))) (in_range1 (* i2 (- 10)))))
(assert (= o2 (ite (<= o1 sum2) true false)))
(assert (not (in_range1 (* i2 20))))
(check-sat)
(exit)
