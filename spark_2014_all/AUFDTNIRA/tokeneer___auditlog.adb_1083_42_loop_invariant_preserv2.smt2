...
(assert (not (= j2 (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields11))))))))
(assert (= logfilestate__split_fields13 logfilestate__split_fields11))
(assert (= logfilestate__split_fields14 logfilestate__split_fields12))
(assert (not (= j2 r76b)))
(assert (= result6 (mk_int__ref j2)))
(assert (= j3 (+ j2 1)))
(assert (= k3 k1))
(assert (= j4 (mk_int__ref j3)))
(assert (= logfilestate__split_fields15 logfilestate__split_fields13))
(assert (= k4 k2))
(assert (= j5 j3))
(assert (= logfilestate__split_fields16 logfilestate__split_fields14))
(assert (< 0 (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields15)))))))
(assert (not (< (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields15))))) i2)))
(check-sat)
(exit)
