...
(assert (forall ((temp___1410 Int) (temp___1411 Int) (temp___1412 Int) (temp___1413 Int) (temp___1414 Int) (temp___1415 Int) (temp___1416 Int) (temp___1417 Int) (temp___1418 Int) (temp___1419 Int) (temp___1420 Int) (temp___1421 Int)) (let ((temp___1409 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__aggregate_def temp___1410 temp___1411 temp___1412 temp___1413 temp___1414 temp___1415 temp___1416 temp___1417 temp___1418 temp___1419 temp___1420 temp___1421))) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1420 temp___1421) (and (= (first5 temp___1409) temp___1420) (= (last5 temp___1409) temp___1421))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1409) (+ (first1 source) 0)) (of_rep1 temp___1410)) (= (select (to_array2 temp___1409) (+ (first1 source) 1)) (of_rep1 temp___1411))) (= (select (to_array2 temp___1409) (+ (first1 source) 2)) (of_rep1 temp___1412))) (= (select (to_array2 temp___1409) (+ (first1 source) 3)) (of_rep1 temp___1413))) (= (select (to_array2 temp___1409) (+ (first1 source) 4)) (of_rep1 temp___1414))) (= (select (to_array2 temp___1409) (+ (first1 source) 5)) (of_rep1 temp___1415))) (= (select (to_array2 temp___1409) (+ (first1 source) 6)) (of_rep1 temp___1416))) (= (select (to_array2 temp___1409) (+ (first1 source) 7)) (of_rep1 temp___1417))) (= (select (to_array2 temp___1409) (+ (first1 source) 8)) (of_rep1 temp___1418))) (= (select (to_array2 temp___1409) (+ (first1 source) 9)) (of_rep1 temp___1419)))))))
(declare-sort t6 0)
...
(assert (forall ((temp___1427 Int) (temp___1428 Int) (temp___1429 Int)) (let ((temp___1426 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__aggregate_def temp___1427 temp___1428 temp___1429))) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1428 temp___1429) (and (= (first9 temp___1426) temp___1428) (= (last9 temp___1426) temp___1429))) (forall ((temp___1430 Int)) (= (select (to_array4 temp___1426) temp___1430) (of_rep1 temp___1427)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_275 us_t3) (temp___is_init_272 Bool) (temp___skip_constant_273 Bool) (temp___do_toplevel_274 Bool)) Bool (=> (not (= temp___skip_constant_273 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_275) (last7 temp___expr_275)) (and (= (first7 temp___expr_275) (first1 source)) (= (last7 temp___expr_275) (+ (first1 source) 9))))))
...
(declare-const temp___1435 (Array Int integer))
...
(assert (and (and (= (length source) 10) (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55))) (forall ((index11 Int)) (=> (and (<= (to_rep1 (first (rt source))) index11) (<= index11 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
...
(assert (= (mk___t2 temp___1424 temp___14241) (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__aggregate_def 2 1 4 6 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___14241)) (to_rep1 (last4 temp___14241))) (+ (- (to_rep1 (last4 temp___14241)) (to_rep1 (first4 temp___14241))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1424 (to_rep1 (first4 temp___14241)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__assume))
...
(assert (= (mk___t4 temp___1432 temp___14321) (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___14321)) (to_rep1 (last8 temp___14321))) (+ (- (to_rep1 (last8 temp___14321)) (to_rep1 (first8 temp___14321))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1432 (to_rep1 (first8 temp___14321)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__assume))
...
(assert (and (= temp___1439 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index2 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= temp___1437 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= temp___1435 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= o13 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= o14 (select n1 o13))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= o15 (to_rep1 o14))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= o15 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= o16 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= o17 (select (elts source) o16))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= o18 (to_rep o17))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o18))) (ite (= (= o18 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o18 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o18 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o18 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o18 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o18 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o18 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o18 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o18 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o18 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= (to_rep1 o19) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= o20 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= o21 (store n1 o20 o19))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= n2 o21)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (and (and (forall ((temp___1436 Int)) (=> (and (<= (to_rep1 n__first) temp___1436) (<= temp___1436 (to_rep1 n__last))) (=> (< index3 temp___1436) (= (select n3 temp___1436) (select temp___1435 temp___1436))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= index3 temp___1439)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= index3 index5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= n3 n5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= index6 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= n6 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= index8 index6)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (= n8 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439))) (= index8 index2)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439))) (= n8 n1)))
...
(assert (and (= temp___1440 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1440) (<= temp___1440 (to_rep1 n__last))))
(assert (= o45 temp___1440))
(assert (= o46 (select (map__content1 n7) o45)))
(assert (= o47 (to_rep1 o46)))
(assert (= result6 (mk_int__ref target)))
(assert (= target1 o47))
(assert (<= target1 9))
(assert (and (= temp___1441 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1441) (<= temp___1441 (to_rep1 n__last))))
(assert (= o48 temp___1441))
(assert (= o49 (select (map__content1 n7) o48)))
(assert (= o50 (to_rep1 o49)))
(assert (= o51 (* o50 10)))
(assert (and (= o52 o51) (in_range1 o51)))
(assert (= o53 (+ target1 o52)))
