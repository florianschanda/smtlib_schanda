...
(define-fun o22 () us_rep10 (mk___rep5 (mk___split_fields5 o4 o5 o6)))
(assert (and (= o20 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o20) (= o20 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
...
(assert (= o19 (* 2 o18)))
(assert (and (= o21 o19) (in_range10 o19)))
(assert (= result (ite (<= o21 o20) true false)))
(assert (= result true))
(assert (and (= o17 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o17) (<= o17 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= result1 (ite (<= o17 5000) true false)))
(assert (= result1 true))
...
(assert (= result2 true))
(assert (and (= o15 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1)) (= (= o15 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true))))
(assert (= o16 true))
...
(assert (= result3 true))
(assert (and (= o13 (has_key (positions x) c)) (= (= o13 true) (= (has_key (positions x) c) true))))
(assert (= o14 true))
...
(assert (and (= o22 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) o3)) (= (bool_eq9 o22 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) o3)) true)))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o6 o9))
(assert (= o10 o8))
