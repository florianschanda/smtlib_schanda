...
(define-fun dynamic_invariant2 ((temp___expr_332 Int) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool)) Bool (=> (or (= temp___is_init_329 true) (<= 0 2)) (in_range6 temp___expr_332)))
...
(define-fun dynamic_invariant4 ((temp___expr_1200 Int) (temp___is_init_1197 Bool) (temp___skip_constant_1198 Bool) (temp___do_toplevel_1199 Bool)) Bool (=> (or (= temp___is_init_1197 true) (<= 0 1)) (in_range17 temp___expr_1200)))
...
(define-fun dynamic_invariant5 ((temp___expr_1222 Int) (temp___is_init_1219 Bool) (temp___skip_constant_1220 Bool) (temp___do_toplevel_1221 Bool)) Bool (=> (or (= temp___is_init_1219 true) (<= 0 1)) (in_range18 temp___expr_1222)))
...
(define-fun dynamic_invariant10 ((temp___expr_1000 Int) (temp___is_init_997 Bool) (temp___skip_constant_998 Bool) (temp___do_toplevel_999 Bool)) Bool (=> (or (= temp___is_init_997 true) (<= 0 17)) (in_range14 temp___expr_1000)))
(define-fun dynamic_invariant11 ((temp___expr_979 Int) (temp___is_init_976 Bool) (temp___skip_constant_977 Bool) (temp___do_toplevel_978 Bool)) Bool (=> (or (= temp___is_init_976 true) (<= 1 17)) (in_range12 temp___expr_979)))
(define-fun dynamic_invariant12 ((temp___expr_1104 Int) (temp___is_init_1101 Bool) (temp___skip_constant_1102 Bool) (temp___do_toplevel_1103 Bool)) Bool (=> (or (= temp___is_init_1101 true) (<= 0 2)) (in_range16 temp___expr_1104)))
(define-fun dynamic_invariant13 ((temp___expr_985 Int) (temp___is_init_982 Bool) (temp___skip_constant_983 Bool) (temp___do_toplevel_984 Bool)) Bool (=> (or (= temp___is_init_982 true) (<= 0 17408)) (in_range13 temp___expr_985)))
(define-fun dynamic_invariant14 ((temp___expr_1019 Int) (temp___is_init_1016 Bool) (temp___skip_constant_1017 Bool) (temp___do_toplevel_1018 Bool)) Bool (=> (or (= temp___is_init_1016 true) (<= 0 1024)) (in_range15 temp___expr_1019)))
(assert true)
...
(define-fun dynamic_invariant15 ((temp___expr_338 Int) (temp___is_init_335 Bool) (temp___skip_constant_336 Bool) (temp___do_toplevel_337 Bool)) Bool (=> (or (= temp___is_init_335 true) (<= 1 150)) (in_range7 temp___expr_338)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_136 Tuple0)))
(define-fun dynamic_invariant16 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 1901 2099)) (in_range8 temp___expr_380)))
(define-fun dynamic_invariant17 ((temp___expr_386 Int) (temp___is_init_383 Bool) (temp___skip_constant_384 Bool) (temp___do_toplevel_385 Bool)) Bool (=> (or (= temp___is_init_383 true) (<= 1 12)) (in_range9 temp___expr_386)))
(define-fun dynamic_invariant18 ((temp___expr_392 Int) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool)) Bool (=> (or (= temp___is_init_389 true) (<= 1 31)) (in_range10 temp___expr_392)))
(define-fun dynamic_invariant19 ((temp___expr_416 Int) (temp___is_init_413 Bool) (temp___skip_constant_414 Bool) (temp___do_toplevel_415 Bool)) Bool (=> (or (= temp___is_init_413 true) (<= 0 86399999)) (in_range11 temp___expr_416)))
(assert true)
