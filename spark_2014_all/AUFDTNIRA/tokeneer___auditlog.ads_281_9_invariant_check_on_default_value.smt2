...
(define-fun dynamic_invariant ((temp___expr_1010 Int) (temp___is_init_1007 Bool) (temp___skip_constant_1008 Bool) (temp___do_toplevel_1009 Bool)) Bool (=> (or (= temp___is_init_1007 true) (<= 0 1)) (in_range temp___expr_1010)))
...
(assert (forall ((temp___1078 Int)) (forall ((temp___1079 Int)) (= (select (temp___1076 temp___1078) temp___1079) (of_rep temp___1078)))))
(declare-fun temp___1080 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1082 Int)) (forall ((temp___1083 Int)) (= (select (temp___1080 temp___1082) temp___1083) (of_rep3 temp___1082)))))
(define-fun default_initial_assumption ((temp___expr_1074 us_rep2) (temp___skip_top_level_1075 Bool)) Bool (and (and (and (= (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1074))) 1) (= (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1074))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1074)) (mk___rep (mk___split_fields (temp___1076 1) (of_rep 1) (of_rep 1) (of_rep2 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1074)) (temp___1080 0))))
(define-fun type_invariant ((temp___1084 us_rep2)) Bool (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1084))) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1084))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1084)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1084))) true))
...
(define-fun dynamic_invariant1 ((temp___expr_1016 Int) (temp___is_init_1013 Bool) (temp___skip_constant_1014 Bool) (temp___do_toplevel_1015 Bool)) Bool (=> (or (= temp___is_init_1013 true) (<= 1 17)) (in_range1 temp___expr_1016)))
(define-fun dynamic_invariant2 ((temp___expr_1022 Int) (temp___is_init_1019 Bool) (temp___skip_constant_1020 Bool) (temp___do_toplevel_1021 Bool)) Bool (=> (or (= temp___is_init_1019 true) (<= 0 17408)) (in_range2 temp___expr_1022)))
(assert true)
...
(assert (forall ((temp___1327 us_rep)) (forall ((temp___1328 Int)) (= (select (auditlog__logfiles__aggregate_def temp___1327) temp___1328) temp___1327))))
...
(define-fun dynamic_invariant4 ((temp___expr_1037 Int) (temp___is_init_1034 Bool) (temp___skip_constant_1035 Bool) (temp___do_toplevel_1036 Bool)) Bool (=> (or (= temp___is_init_1034 true) (<= 0 17)) (in_range3 temp___expr_1037)))
(define-fun dynamic_invariant5 ((temp___expr_1128 Int) (temp___is_init_1125 Bool) (temp___skip_constant_1126 Bool) (temp___do_toplevel_1127 Bool)) Bool (=> (or (= temp___is_init_1125 true) (<= 0 2)) (in_range5 temp___expr_1128)))
...
(define-fun dynamic_invariant6 ((temp___expr_1056 Int) (temp___is_init_1053 Bool) (temp___skip_constant_1054 Bool) (temp___do_toplevel_1055 Bool)) Bool (=> (or (= temp___is_init_1053 true) (<= 0 1024)) (in_range4 temp___expr_1056)))
...
(declare-const temp___1329 logfileindext)
(declare-const temp___13291 logentrycountt)
(declare-const temp___13292 (Array Int logfileindext))
(declare-const temp___13293 logfileindext)
(declare-const temp___13294 logfileindext)
(declare-const temp___13295 logfilecountt)
(declare-const temp___13296 (Array Int fileentrycountt))
(assert (= (to_rep2 o) 0))
(assert (= (to_rep o1) 1))
(assert (= (to_rep o2) 17))
...
(assert (and (and (and (= (to_rep temp___1329) 1) (= (to_rep1 temp___13291) 0)) (and (= temp___13292 (temp___1076 1)) (and (= temp___13293 (of_rep 1)) (and (= temp___13294 (of_rep 1)) (= temp___13295 (of_rep2 1)))))) (= temp___13296 (temp___1080 0))))
(assert (not (= (valid_numberlogentries (to_rep temp___1329) (to_rep1 temp___13291) (mk___rep (mk___split_fields temp___13292 temp___13293 temp___13294 temp___13295)) temp___13296) true)))
(check-sat)
(exit)
