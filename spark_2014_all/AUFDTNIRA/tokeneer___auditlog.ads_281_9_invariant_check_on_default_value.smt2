...
(declare-const dummy2 (Array Int logfileindext))
...
(declare-fun user_eq2 ((Array Int logfileindext) (Array Int logfileindext)) Bool)
...
(assert (forall ((x fileentrycountt)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert true)
(assert (forall ((currentlogfile Int) (numberlogentries Int)) (forall ((usedlogfiles us_rep)) (forall ((logfileentries (Array Int fileentrycountt))) (! (= (= (valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries) true) (and (<= 1 (to_rep (rec__auditlog__logfilelistt__length (us_split_fields1 usedlogfiles)))) (= numberlogentries (+ (* (- (to_rep (rec__auditlog__logfilelistt__length (us_split_fields1 usedlogfiles))) 1) 1024) (to_rep2 (select logfileentries currentlogfile)))))) :pattern ((valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries)))))))
...
(declare-const nullfile us_rep1)
...
(define-fun dynamic_invariant2 ((temp___expr_1190 Int) (temp___is_init_1186 Bool) (temp___skip_constant_1187 Bool) (temp___do_toplevel_1188 Bool) (temp___do_typ_inv_1189 Bool)) Bool (=> (or (= temp___is_init_1186 true) (<= 0 1)) (in_range4 temp___expr_1190)))
...
(assert (forall ((x logentrycountt)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(declare-fun auditlog__logfiles__aggregate_def (us_rep1) (Array Int us_rep1))
...
(define-fun dynamic_invariant4 ((temp___expr_1197 Int) (temp___is_init_1193 Bool) (temp___skip_constant_1194 Bool) (temp___do_toplevel_1195 Bool) (temp___do_typ_inv_1196 Bool)) Bool (=> (or (= temp___is_init_1193 true) (<= 0 17)) (in_range temp___expr_1197)))
(define-fun dynamic_invariant5 ((temp___expr_1317 Int) (temp___is_init_1313 Bool) (temp___skip_constant_1314 Bool) (temp___do_toplevel_1315 Bool) (temp___do_typ_inv_1316 Bool)) Bool (=> (or (= temp___is_init_1313 true) (<= 0 2)) (in_range5 temp___expr_1317)))
...
(assert (forall ((temp___179 Int)) (=> (dynamic_invariant temp___179 true true true true) (forall ((temp___180 Int)) (= (select (temp_____aggregate_def_177 temp___179) temp___180) rliteral)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1242 Int) (temp___is_init_1238 Bool) (temp___skip_constant_1239 Bool) (temp___do_toplevel_1240 Bool) (temp___do_typ_inv_1241 Bool)) Bool (=> (or (= temp___is_init_1238 true) (<= 0 1024)) (in_range2 temp___expr_1242)))
(declare-const rliteral4 fileentrycountt)
(assert (= (fileentrycounttqtint rliteral4) 0))
(assert (forall ((temp___1270 Int)) (=> (dynamic_invariant6 temp___1270 true true true true) (forall ((temp___1271 Int)) (= (select (temp_____aggregate_def_1268 temp___1270) temp___1271) rliteral4)))))
(assert (forall ((temp___1530 us_rep1)) (forall ((temp___1531 Int)) (= (select (auditlog__logfiles__aggregate_def temp___1530) temp___1531) temp___1530))))
...
(declare-const temp___1532 logfileindext)
(declare-const temp___15321 logentrycountt)
(declare-const temp___15322 (Array Int logfileindext))
(declare-const temp___15323 logfileindext)
(declare-const temp___15324 logfileindext)
(declare-const temp___15325 logfilecountt)
(declare-const temp___15326 (Array Int fileentrycountt))
...
(assert (and (and (and (= (to_rep1 temp___1532) 1) (= (to_rep3 temp___15321) 0)) (and (= temp___15322 (temp_____aggregate_def_1264 1)) (and (= temp___15323 rliteral) (and (= temp___15324 rliteral) (= temp___15325 rliteral1))))) (= temp___15326 (temp_____aggregate_def_1268 0))))
(assert (not (= (valid_numberlogentries (to_rep1 temp___1532) (to_rep3 temp___15321) (mk___rep (mk___split_fields temp___15322 temp___15323 temp___15324 temp___15325)) temp___15326) true)))
(check-sat)
(exit)
