...
(define-fun dynamic_invariant ((temp___expr_1010 Int) (temp___is_init_1007 Bool) (temp___skip_constant_1008 Bool) (temp___do_toplevel_1009 Bool)) Bool (=> (or (= temp___is_init_1007 true) (<= 0 1)) (in_range5 temp___expr_1010)))
...
(assert (forall ((value Int)) (! (=> (dynamic_invariant1 value true true true) (dynamic_invariant1 (nextlistindex value) true false true)) :pattern ((nextlistindex value)))))
(assert (forall ((value Int)) (! (=> (dynamic_invariant1 value true true true) (= (nextlistindex value) (ite (= value 17) 1 (+ value 1)))) :pattern ((nextlistindex value)))))
...
(define-fun dynamic_invariant8 ((temp___expr_1022 Int) (temp___is_init_1019 Bool) (temp___skip_constant_1020 Bool) (temp___do_toplevel_1021 Bool)) Bool (=> (or (= temp___is_init_1019 true) (<= 0 17408)) (in_range8 temp___expr_1022)))
(define-fun dynamic_invariant9 ((temp___expr_1056 Int) (temp___is_init_1053 Bool) (temp___skip_constant_1054 Bool) (temp___do_toplevel_1055 Bool)) Bool (=> (or (= temp___is_init_1053 true) (<= 0 1024)) (in_range10 temp___expr_1056)))
(assert true)
...
(define-fun dynamic_invariant10 ((temp___expr_455 Int) (temp___is_init_452 Bool) (temp___skip_constant_453 Bool) (temp___do_toplevel_454 Bool)) Bool (=> (or (= temp___is_init_452 true) (<= 1 150)) (in_range4 temp___expr_455)))
...
(declare-const temp___1487 (Array Int filestatust))
(declare-const temp___1486 Bool)
(declare-const temp___1485 (Array Int us_rep2))
(declare-const temp___1484 logfileindext)
(declare-const temp___14841 logentrycountt)
(declare-const temp___14842 (Array Int logfileindext))
(declare-const temp___14843 logfileindext)
(declare-const temp___14844 logfileindext)
(declare-const temp___14845 logfilecountt)
(declare-const temp___14846 (Array Int fileentrycountt))
(declare-const o Int)
...
(declare-const o7 (Array Int logfileindext))
(declare-const o8 logfileindext)
(declare-const o9 logfileindext)
(declare-const o10 logfilecountt)
...
(declare-const o15 logfileindext)
(declare-const o16 logentrycountt)
(declare-const o17 (Array Int logfileindext))
(declare-const o18 logfileindext)
(declare-const o19 logfileindext)
(declare-const o20 logfilecountt)
(declare-const o21 (Array Int fileentrycountt))
(declare-const temp___1478 logfileindext)
(declare-const temp___14781 logentrycountt)
(declare-const temp___14782 (Array Int logfileindext))
(declare-const temp___14783 logfileindext)
(declare-const temp___14784 logfileindext)
(declare-const temp___14785 logfilecountt)
(declare-const temp___14786 (Array Int fileentrycountt))
(declare-const o22 Int)
(declare-const o23 logfileindext)
(declare-const o24 us_split_fields)
(declare-const o25 us_rep)
(declare-const o26 us_split_fields2)
(declare-const temp___1481 us_rep1)
(declare-const o27 Int)
(declare-const o28 logentrycountt)
(declare-const o29 us_split_fields2)
(declare-const temp___1483 us_rep1)
...
(declare-const logfiles12 (Array Int us_rep2))
...
(declare-const logfiles13 map__ref3)
(declare-const logfilesstatus13 map__ref4)
(declare-const logfilestate__split_fields22 us_split_fields__ref1)
(declare-const auditalarm4 int__ref)
(declare-const auditsystemfault13 bool__ref)
(declare-const logfiles14 (Array Int us_rep2))
...
(declare-const logfiles15 (Array Int us_rep2))
...
(declare-const auditalarm7 int__ref)
(declare-const auditsystemfault16 bool__ref)
(declare-const oldalarm2 int__ref)
(declare-const logfiles17 (Array Int us_rep2))
...
(assert (=> (< 1 (to_rep4 logfilestate__split_fields5)) (and (and (= temp___1487 logfilesstatus) (and (= temp___1486 auditsystemfault) (and (= temp___1485 logfiles) (and (and (= logfilestate__split_fields temp___1484) (and (= logfilestate__split_fields1 temp___14841) (and (and (= logfilestate__split_fields2 temp___14842) (and (= logfilestate__split_fields3 temp___14843) (and (= logfilestate__split_fields4 temp___14844) (= logfilestate__split_fields5 temp___14845)))) (= logfilestate__split_fields6 temp___14846)))) (or (and (and (and (= auditsystemfault6 (mk_bool__ref auditsystemfault)) (and (= logfilestate__split_fields15 (mk___split_fields__ref1 (mk___split_fields1 logfilestate__split_fields logfilestate__split_fields1 (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))) (and (= logfilesstatus6 (mk_map__ref4 logfilesstatus)) (= logfiles6 (mk_map__ref3 logfiles))))) (and (= auditsystemfault7 auditsystemfault1) (and (= logfilestate__split_fields16 logfilestate__split_fields7) (and (= logfilesstatus7 logfilesstatus1) (= logfiles7 logfiles1))))) (not (= (to_rep6 (select logfilesstatus (to_rep2 (select logfilestate__split_fields2 (to_rep2 logfilestate__split_fields3))))) 1))) (and (= (to_rep6 (select logfilesstatus (to_rep2 (select logfilestate__split_fields2 (to_rep2 logfilestate__split_fields3))))) 1) (and (and (and (= auditsystemfault6 (mk_bool__ref auditsystemfault3)) (and (= logfilestate__split_fields15 (mk___split_fields__ref1 logfilestate__split_fields12)) (and (= logfilesstatus6 (mk_map__ref4 logfilesstatus3)) (= logfiles6 (mk_map__ref3 logfiles3))))) (and (= auditsystemfault7 auditsystemfault3) (and (= logfilestate__split_fields16 logfilestate__split_fields12) (and (= logfilesstatus7 logfilesstatus3) (= logfiles7 logfiles3))))) (and (and (and (< 1 (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))))) (= (to_rep6 (select logfilesstatus2 (to_rep2 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))))))) 1)) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (+ (* (- (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) 1) 1024) (to_rep5 (select (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8) (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8))))))) (and (and (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8) temp___1484) (and (= (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) temp___14842) (= (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) temp___14844))) (and (not (= (to_rep2 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))))) (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)))) (and (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 17)) (=> (not (= i (to_rep2 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))))))) (= (to_rep5 (select auditlog__deletelogfile__logfileentries i)) (to_rep5 (select (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8) i)))))) (and (= result (mk___split_fields__ref1 logfilestate__split_fields8)) (= logfilestate__split_fields9 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) auditlog__deletelogfile__logfileentries)))) (and (and (and (and (and (and (and (and (= o5 (- (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9)))) 1)) (in_range9 (- (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9)))) 1))) (= (to_rep4 o6) o5)) (and (= (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9))) o7) (and (= (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9))) o8) (and (= (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9))) o9) (= o6 o10))))) (and (= o11 o7) (and (= o12 o8) (and (= o13 o9) (= o14 o10))))) (and (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9) o15) (and (= (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9) o16) (and (and (= o17 o11) (and (= o18 o12) (and (= o19 o13) (= o20 o14)))) (= (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9) o21))))) (and (= temp___1478 o15) (and (= temp___14781 o16) (and (and (= temp___14782 o17) (and (= temp___14783 o18) (and (= temp___14784 o19) (= temp___14785 o20)))) (= temp___14786 o21))))) (and (= result1 (mk___split_fields__ref1 logfilestate__split_fields9)) (= logfilestate__split_fields10 (mk___split_fields1 temp___1478 temp___14781 (mk___rep (mk___split_fields temp___14782 temp___14783 temp___14784 temp___14785)) temp___14786)))) (and (and (and (and (and (and (and (and (= o22 (nextlistindex (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))))) (and (in_range6 o22) (= o22 (ite (= (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))) 17) 1 (+ (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))) 1))))) (= (to_rep2 o23) o22)) (= o24 (mk___split_fields (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10))) o23 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10))) (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))))) (= o25 (mk___rep o24))) (= o26 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10) o25 (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)))) (= temp___1481 (mk___rep1 o26))) (and (= result2 (mk___split_fields__ref1 logfilestate__split_fields10)) (= logfilestate__split_fields11 (us_split_fields3 temp___1481)))) (and (and (and (and (and (and (= o27 (- (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) 1024)) (in_range8 (- (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) 1024))) (= (to_rep3 o28) o27)) (= o29 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11) o28 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)))) (= temp___1483 (mk___rep1 o29))) (and (= result3 (mk___split_fields__ref1 logfilestate__split_fields11)) (= logfilestate__split_fields12 (us_split_fields3 temp___1483)))) (or (not (< 1 (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12)))))) (and (< 1 (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12))))) (not (= (to_rep6 (select logfilesstatus3 (to_rep2 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12))) (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12)))))))) 1)))))))))))))))))) (and (and (= auditsystemfault8 auditsystemfault6) (and (= logfilestate__split_fields17 logfilestate__split_fields15) (and (= logfilesstatus8 logfilesstatus6) (= logfiles8 logfiles6)))) (and (= auditsystemfault9 auditsystemfault7) (and (= logfilestate__split_fields18 logfilestate__split_fields16) (and (= logfilesstatus9 logfilesstatus7) (= logfiles9 logfiles7))))))))
(assert (=> (< 1 (to_rep4 logfilestate__split_fields5)) (= auditsystemfault10 auditsystemfault8)))
(assert (=> (< 1 (to_rep4 logfilestate__split_fields5)) (= logfilestate__split_fields19 logfilestate__split_fields17)))
(assert (=> (< 1 (to_rep4 logfilestate__split_fields5)) (= logfilesstatus10 logfilesstatus8)))
(assert (=> (< 1 (to_rep4 logfilestate__split_fields5)) (= logfiles10 logfiles8)))
(assert (=> (< 1 (to_rep4 logfilestate__split_fields5)) (= auditsystemfault11 auditsystemfault9)))
(assert (=> (< 1 (to_rep4 logfilestate__split_fields5)) (= logfilestate__split_fields20 logfilestate__split_fields18)))
(assert (=> (< 1 (to_rep4 logfilestate__split_fields5)) (= logfilesstatus11 logfilesstatus9)))
(assert (=> (< 1 (to_rep4 logfilestate__split_fields5)) (= logfiles11 logfiles9)))
(assert (=> (not (< 1 (to_rep4 logfilestate__split_fields5))) (= auditsystemfault10 (mk_bool__ref auditsystemfault))))
(assert (=> (not (< 1 (to_rep4 logfilestate__split_fields5))) (= logfilestate__split_fields19 (mk___split_fields__ref1 (mk___split_fields1 logfilestate__split_fields logfilestate__split_fields1 (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6)))))
(assert (=> (not (< 1 (to_rep4 logfilestate__split_fields5))) (= logfilesstatus10 (mk_map__ref4 logfilesstatus))))
(assert (=> (not (< 1 (to_rep4 logfilestate__split_fields5))) (= logfiles10 (mk_map__ref3 logfiles))))
(assert (=> (not (< 1 (to_rep4 logfilestate__split_fields5))) (= auditsystemfault11 auditsystemfault1)))
(assert (=> (not (< 1 (to_rep4 logfilestate__split_fields5))) (= logfilestate__split_fields20 logfilestate__split_fields7)))
(assert (=> (not (< 1 (to_rep4 logfilestate__split_fields5))) (= logfilesstatus11 logfilesstatus1)))
(assert (=> (not (< 1 (to_rep4 logfilestate__split_fields5))) (= logfiles11 logfiles1)))
...
(assert (=> (not (= oldalarm1 auditalarm2)) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields19))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content1 logfilestate__split_fields19))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields19)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields19))) true)))
(assert (=> (not (= oldalarm1 auditalarm2)) (and (and (<= 1 (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields21))))) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields21)) (+ (* (- (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields21)))) 1) 1024) (to_rep5 (select (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields21) (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields21))))))) (and (in_range5 auditalarm3) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields21)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields21)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields21) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields21)) true)))))
(assert (=> (not (= oldalarm1 auditalarm2)) (= auditsystemfault13 (mk_bool__ref auditsystemfault12))))
(assert (=> (not (= oldalarm1 auditalarm2)) (= auditalarm4 (mk_int__ref auditalarm3))))
(assert (=> (not (= oldalarm1 auditalarm2)) (= logfilestate__split_fields22 (mk___split_fields__ref1 logfilestate__split_fields21))))
(assert (=> (not (= oldalarm1 auditalarm2)) (= logfilesstatus13 (mk_map__ref4 logfilesstatus12))))
(assert (=> (not (= oldalarm1 auditalarm2)) (= logfiles13 (mk_map__ref3 logfiles12))))
(assert (=> (not (= oldalarm1 auditalarm2)) (= auditsystemfault14 auditsystemfault12)))
(assert (=> (not (= oldalarm1 auditalarm2)) (= auditalarm5 auditalarm3)))
(assert (=> (not (= oldalarm1 auditalarm2)) (= logfilestate__split_fields23 logfilestate__split_fields21)))
(assert (=> (not (= oldalarm1 auditalarm2)) (= logfilesstatus14 logfilesstatus12)))
(assert (=> (not (= oldalarm1 auditalarm2)) (= logfiles14 logfiles12)))
(assert (=> (= oldalarm1 auditalarm2) (= auditsystemfault13 auditsystemfault10)))
(assert (=> (= oldalarm1 auditalarm2) (= auditalarm4 (mk_int__ref auditalarm2))))
(assert (=> (= oldalarm1 auditalarm2) (= logfilestate__split_fields22 logfilestate__split_fields19)))
(assert (=> (= oldalarm1 auditalarm2) (= logfilesstatus13 logfilesstatus10)))
(assert (=> (= oldalarm1 auditalarm2) (= logfiles13 logfiles10)))
(assert (=> (= oldalarm1 auditalarm2) (= auditsystemfault14 auditsystemfault11)))
(assert (=> (= oldalarm1 auditalarm2) (= auditalarm5 auditalarm2)))
(assert (=> (= oldalarm1 auditalarm2) (= logfilestate__split_fields23 logfilestate__split_fields20)))
(assert (=> (= oldalarm1 auditalarm2) (= logfilesstatus14 logfilesstatus11)))
(assert (=> (= oldalarm1 auditalarm2) (= logfiles14 logfiles11)))
(assert (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields22))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content1 logfilestate__split_fields22))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields22))) true))
