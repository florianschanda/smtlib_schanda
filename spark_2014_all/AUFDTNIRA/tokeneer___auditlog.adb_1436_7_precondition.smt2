...
(define-fun dynamic_invariant ((temp___expr_1066 Int) (temp___is_init_1063 Bool) (temp___skip_constant_1064 Bool) (temp___do_toplevel_1065 Bool)) Bool (=> (or (= temp___is_init_1063 true) (<= 0 1)) (in_range5 temp___expr_1066)))
...
(define-fun dynamic_invariant8 ((temp___expr_1078 Int) (temp___is_init_1075 Bool) (temp___skip_constant_1076 Bool) (temp___do_toplevel_1077 Bool)) Bool (=> (or (= temp___is_init_1075 true) (<= 0 17408)) (in_range8 temp___expr_1078)))
(define-fun dynamic_invariant9 ((temp___expr_1112 Int) (temp___is_init_1109 Bool) (temp___skip_constant_1110 Bool) (temp___do_toplevel_1111 Bool)) Bool (=> (or (= temp___is_init_1109 true) (<= 0 1024)) (in_range10 temp___expr_1112)))
(assert true)
...
(define-fun dynamic_invariant10 ((temp___expr_499 Int) (temp___is_init_496 Bool) (temp___skip_constant_497 Bool) (temp___do_toplevel_498 Bool)) Bool (=> (or (= temp___is_init_496 true) (<= 1 150)) (in_range4 temp___expr_499)))
...
(declare-const temp___1543 (Array Int filestatust))
(declare-const temp___1542 Bool)
(declare-const temp___1541 (Array Int us_rep2))
(declare-const temp___1540 logfileindext)
(declare-const temp___15401 logentrycountt)
(declare-const temp___15402 (Array Int logfileindext))
(declare-const temp___15403 logfileindext)
(declare-const temp___15404 logfileindext)
(declare-const temp___15405 logfilecountt)
(declare-const temp___15406 (Array Int fileentrycountt))
(declare-const o Int)
...
(declare-const temp___1534 logfileindext)
(declare-const temp___15341 logentrycountt)
(declare-const temp___15342 (Array Int logfileindext))
(declare-const temp___15343 logfileindext)
(declare-const temp___15344 logfileindext)
(declare-const temp___15345 logfilecountt)
(declare-const temp___15346 (Array Int fileentrycountt))
