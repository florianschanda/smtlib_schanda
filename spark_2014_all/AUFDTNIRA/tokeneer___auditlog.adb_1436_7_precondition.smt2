...
(define-fun dynamic_invariant ((temp___expr_1197 Int) (temp___is_init_1193 Bool) (temp___skip_constant_1194 Bool) (temp___do_toplevel_1195 Bool) (temp___do_typ_inv_1196 Bool)) Bool (=> (or (= temp___is_init_1193 true) (<= 0 1)) (in_range5 temp___expr_1197)))
...
(define-fun dynamic_invariant8 ((temp___expr_1218 Int) (temp___is_init_1214 Bool) (temp___skip_constant_1215 Bool) (temp___do_toplevel_1216 Bool) (temp___do_typ_inv_1217 Bool)) Bool (=> (or (= temp___is_init_1214 true) (<= 0 17408)) (in_range9 temp___expr_1218)))
(define-fun dynamic_invariant9 ((temp___expr_1249 Int) (temp___is_init_1245 Bool) (temp___skip_constant_1246 Bool) (temp___do_toplevel_1247 Bool) (temp___do_typ_inv_1248 Bool)) Bool (=> (or (= temp___is_init_1245 true) (<= 0 1024)) (in_range10 temp___expr_1249)))
(assert true)
...
(assert (forall ((temp___1277 Int)) (=> (dynamic_invariant9 temp___1277 true true true true) (forall ((temp___1278 Int)) (= (to_rep5 (select (temp___1275 temp___1277) temp___1278)) temp___1277)))))
(define-fun dynamic_invariant10 ((temp___expr_556 Int) (temp___is_init_552 Bool) (temp___skip_constant_553 Bool) (temp___do_toplevel_554 Bool) (temp___do_typ_inv_555 Bool)) Bool (=> (or (= temp___is_init_552 true) (<= 1 150)) (in_range4 temp___expr_556)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___156 Int)) (=> (dynamic_invariant3 temp___156 true true true true) (forall ((temp___157 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___156) temp___157)) temp___156)))))
...
(declare-const oldalarm Int)
(declare-const temp___1697 (Array Int filestatust))
(declare-const temp___1696 Bool)
(declare-const temp___1695 (Array Int us_rep2))
(declare-const temp___1694 logfileindext)
(declare-const temp___16941 logentrycountt)
(declare-const temp___16942 (Array Int logfileindext))
(declare-const temp___16943 logfileindext)
(declare-const temp___16944 logfileindext)
(declare-const temp___16945 logfilecountt)
(declare-const temp___16946 (Array Int fileentrycountt))
(declare-const o Int)
(declare-const o1 logfilecountt)
...
(declare-const temp___1688 logfileindext)
(declare-const temp___16881 logentrycountt)
(declare-const temp___16882 (Array Int logfileindext))
(declare-const temp___16883 logfileindext)
(declare-const temp___16884 logfileindext)
(declare-const temp___16885 logfilecountt)
(declare-const temp___16886 (Array Int fileentrycountt))
...
(declare-const temp___1691 us_rep1)
(declare-const o22 Int)
(declare-const o23 logentrycountt)
(declare-const o24 us_split_fields2)
(declare-const temp___1693 us_rep1)
...
(declare-const logfilestate__split_fields13 us_split_fields__ref1)
...
(declare-const logfiles6 (Array Int us_rep2))
...
(declare-const logfilestate__split_fields17 us_split_fields__ref1)
(declare-const auditsystemfault7 bool__ref)
(declare-const logfiles8 (Array Int us_rep2))
...
(declare-const oldalarm1 Int)
(declare-const result5 int__ref)
(declare-const auditalarm1 Int)
(declare-const auditalarm2 Int)
(declare-const logfiles9 (Array Int us_rep2))
...
(declare-const logfilestate__split_fields20 us_split_fields__ref1)
(declare-const auditalarm4 int__ref)
(declare-const auditsystemfault10 bool__ref)
(declare-const logfiles11 (Array Int us_rep2))
...
(declare-const auditsystemfault11 Bool)
(define-fun auditsystemfault12 () bool__ref (mk_bool__ref auditsystemfault))
(define-fun logfilestate__split_fields22 () us_split_fields__ref1 (mk___split_fields__ref1 (mk___split_fields1 logfilestate__split_fields logfilestate__split_fields1 (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6)))
(define-fun logfilesstatus13 () map__ref4 (mk_map__ref4 logfilesstatus))
(define-fun logfiles12 () map__ref3 (mk_map__ref3 logfiles))
...
(assert (=> (<= 0 1) (in_range5 oldalarm)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= temp___1697 logfilesstatus)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= temp___1696 auditsystemfault)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= temp___1695 logfiles)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (and (= logfilestate__split_fields temp___1694) (and (= logfilestate__split_fields1 temp___16941) (and (and (= logfilestate__split_fields2 temp___16942) (and (= logfilestate__split_fields3 temp___16943) (and (= logfilestate__split_fields4 temp___16944) (= logfilestate__split_fields5 temp___16945)))) (= logfilestate__split_fields6 temp___16946))))))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (or (and (and (and (= auditsystemfault3 auditsystemfault12) (and (= logfilestate__split_fields13 logfilestate__split_fields22) (and (= logfilesstatus4 logfilesstatus13) (= logfiles3 logfiles12)))) (and (= auditsystemfault4 auditsystemfault1) (and (= logfilestate__split_fields14 logfilestate__split_fields7) (and (= logfilesstatus5 logfilesstatus1) (= logfiles4 logfiles1))))) (not (= (to_rep6 (select logfilesstatus (to_rep3 (select logfilestate__split_fields2 (to_rep3 logfilestate__split_fields3))))) 1))) (and (= (to_rep6 (select logfilesstatus (to_rep3 (select logfilestate__split_fields2 (to_rep3 logfilestate__split_fields3))))) 1) (and (and (and (= auditsystemfault3 (mk_bool__ref auditsystemfault2)) (and (= logfilestate__split_fields13 (mk___split_fields__ref1 logfilestate__split_fields12)) (and (= logfilesstatus4 (mk_map__ref4 logfilesstatus3)) (= logfiles3 (mk_map__ref3 logfiles2))))) (and (= auditsystemfault4 auditsystemfault2) (and (= logfilestate__split_fields14 logfilestate__split_fields12) (and (= logfilesstatus5 logfilesstatus3) (= logfiles4 logfiles2))))) (and (and (and (< 1 (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))))) (= (to_rep6 (select logfilesstatus2 (to_rep3 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))))))) 1)) (= (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (+ (* (- (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) 1) 1024) (to_rep5 (select (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8) (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8))))))) (and (and (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8) temp___1694) (and (= (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) temp___16942) (= (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) temp___16944))) (and (not (= (to_rep3 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))))) (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)))) (and (and (forall ((i Int)) (=> (and (<= 1 i) (<= i 17)) (=> (not (= i (to_rep3 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))))))) (= (to_rep5 (select auditlog__deletelogfile__logfileentries i)) (to_rep5 (select (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8) i)))))) (and (= result (mk___split_fields__ref1 logfilestate__split_fields8)) (= logfilestate__split_fields9 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) auditlog__deletelogfile__logfileentries)))) (and (and (and (and (and (and (and (and (= o (- (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9)))) 1)) (in_range6 (- (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9)))) 1))) (= (to_rep2 o1) o)) (and (= (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9))) o2) (and (= (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9))) o3) (and (= (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9))) o4) (= o1 o5))))) (and (= o6 o2) (and (= o7 o3) (and (= o8 o4) (= o9 o5))))) (and (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9) o10) (and (= (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9) o11) (and (and (= o12 o6) (and (= o13 o7) (and (= o14 o8) (= o15 o9)))) (= (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9) o16))))) (and (= temp___1688 o10) (and (= temp___16881 o11) (and (and (= temp___16882 o12) (and (= temp___16883 o13) (and (= temp___16884 o14) (= temp___16885 o15)))) (= temp___16886 o16))))) (and (= result1 (mk___split_fields__ref1 logfilestate__split_fields9)) (= logfilestate__split_fields10 (mk___split_fields1 temp___1688 temp___16881 (mk___rep (mk___split_fields temp___16882 temp___16883 temp___16884 temp___16885)) temp___16886)))) (and (and (and (and (and (and (and (and (= o17 (nextlistindex (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))))) (and (in_range7 o17) (= o17 (ite (= (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))) 17) 1 (+ (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))) 1))))) (= (to_rep3 o18) o17)) (= o19 (mk___split_fields (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10))) o18 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10))) (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))))) (= o20 (mk___rep o19))) (= o21 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10) o20 (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)))) (= temp___1691 (mk___rep1 o21))) (and (= result2 (mk___split_fields__ref1 logfilestate__split_fields10)) (= logfilestate__split_fields11 (us_split_fields3 temp___1691)))) (and (and (and (and (and (and (= o22 (- (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) 1024)) (in_range9 (- (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) 1024))) (= (to_rep4 o23) o22)) (= o24 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11) o23 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)))) (= temp___1693 (mk___rep1 o24))) (and (= result3 (mk___split_fields__ref1 logfilestate__split_fields11)) (= logfilestate__split_fields12 (us_split_fields3 temp___1693)))) (or (not (< 1 (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12)))))) (and (< 1 (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12))))) (not (= (to_rep6 (select logfilesstatus3 (to_rep3 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12))) (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12)))))))) 1))))))))))))))))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= auditsystemfault5 auditsystemfault3)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= logfilestate__split_fields15 logfilestate__split_fields13)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= logfilesstatus6 logfilesstatus4)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= logfiles5 logfiles3)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= auditsystemfault6 auditsystemfault4)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= logfilestate__split_fields16 logfilestate__split_fields14)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= logfilesstatus7 logfilesstatus5)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= logfiles6 logfiles4)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= auditsystemfault7 auditsystemfault5)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= logfilestate__split_fields17 logfilestate__split_fields15)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= logfilesstatus8 logfilesstatus6)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= logfiles7 logfiles5)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= auditsystemfault8 auditsystemfault6)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= logfilestate__split_fields18 logfilestate__split_fields16)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= logfilesstatus9 logfilesstatus7)))
(assert (=> (< 1 (to_rep2 logfilestate__split_fields5)) (= logfiles8 logfiles6)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= auditsystemfault7 auditsystemfault12)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= logfilestate__split_fields17 logfilestate__split_fields22)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= logfilesstatus8 logfilesstatus13)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= logfiles7 logfiles12)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= auditsystemfault8 auditsystemfault1)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= logfilestate__split_fields18 logfilestate__split_fields7)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= logfilesstatus9 logfilesstatus1)))
(assert (=> (not (< 1 (to_rep2 logfilestate__split_fields5))) (= logfiles8 logfiles1)))
(assert (= result4 (mk_int__ref oldalarm)))
(assert (= oldalarm1 auditalarm))
(assert (= result5 (mk_int__ref auditalarm)))
(assert (= auditalarm1 1))
(assert (in_range5 auditalarm2))
(assert (=> (not (= oldalarm1 auditalarm2)) (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields17))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content1 logfilestate__split_fields17))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields17)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields17))) true)))
(assert (=> (not (= oldalarm1 auditalarm2)) (and (and (<= 1 (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields19))))) (= (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields19)) (+ (* (- (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields19)))) 1) 1024) (to_rep5 (select (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields19) (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields19))))))) (and (in_range5 auditalarm3) (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields19)) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields19)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields19) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields19)) true)))))
(assert (=> (not (= oldalarm1 auditalarm2)) (= auditsystemfault10 (mk_bool__ref auditsystemfault9))))
(assert (=> (not (= oldalarm1 auditalarm2)) (= auditalarm4 (mk_int__ref auditalarm3))))
(assert (=> (not (= oldalarm1 auditalarm2)) (= logfilestate__split_fields20 (mk___split_fields__ref1 logfilestate__split_fields19))))
(assert (=> (not (= oldalarm1 auditalarm2)) (= logfilesstatus11 (mk_map__ref4 logfilesstatus10))))
(assert (=> (not (= oldalarm1 auditalarm2)) (= logfiles10 (mk_map__ref3 logfiles9))))
(assert (=> (not (= oldalarm1 auditalarm2)) (= auditsystemfault11 auditsystemfault9)))
(assert (=> (not (= oldalarm1 auditalarm2)) (= auditalarm5 auditalarm3)))
(assert (=> (not (= oldalarm1 auditalarm2)) (= logfilestate__split_fields21 logfilestate__split_fields19)))
(assert (=> (not (= oldalarm1 auditalarm2)) (= logfilesstatus12 logfilesstatus10)))
(assert (=> (not (= oldalarm1 auditalarm2)) (= logfiles11 logfiles9)))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= auditsystemfault10 auditsystemfault7)))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= auditalarm4 (mk_int__ref auditalarm2))))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= logfilestate__split_fields20 logfilestate__split_fields17)))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= logfilesstatus11 logfilesstatus8)))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= logfiles10 logfiles7)))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= auditsystemfault11 auditsystemfault8)))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= auditalarm5 auditalarm2)))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= logfilestate__split_fields21 logfilestate__split_fields18)))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= logfilesstatus12 logfilesstatus9)))
(assert (=> (not (not (= oldalarm1 auditalarm2))) (= logfiles11 logfiles8)))
(assert (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields20))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content1 logfilestate__split_fields20))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields20)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields20))) true))
