...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 6))))) (+ (to_rep1 (first (rt source))) 1)) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 6))))) (+ (+ (to_rep1 (first (rt source))) 1) 6)) (= (mk___t2 temp___2265 temp___22651) (aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 6))))) (and (= (ite (<= (to_rep1 (first4 temp___22651)) (to_rep1 (last4 temp___22651))) (+ (- (to_rep1 (last4 temp___22651)) (to_rep1 (first4 temp___22651))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) (+ (- (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 1)) 1) 0)) (and (= (slide1 temp___2265 (to_rep1 (first4 temp___22651)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_8__int_array__assume) (= (mk1 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) aida__conversion__calculate_negative_target_length_8__int_array__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_negative_target_length_8__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_length_8__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_length_8__int_array__assume1)))))) (and (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 7)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_length_8__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7))))) (+ (to_rep1 (first (rt source))) 1)) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_length_8__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7))))) (+ (to_rep1 (first (rt source))) 7)) (= (mk___t4 temp___2273 temp___22731) (aida__conversion__calculate_negative_target_length_8__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7))))) (and (= (ite (<= (to_rep1 (first8 temp___22731)) (to_rep1 (last8 temp___22731))) (+ (- (to_rep1 (last8 temp___22731)) (to_rep1 (first8 temp___22731))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) (+ (- (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 1)) 1) 0)) (and (= (slide1 temp___2273 (to_rep1 (first8 temp___22731)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_8__n__assume) (= (mk3 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) aida__conversion__calculate_negative_target_length_8__n__assume1)))) (and (and (= (mk_map__ref1 result2) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_negative_target_length_8__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_length_8__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_length_8__n__assume1)))))) (and (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 7)))) (and (and (and (= temp___2279 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (= temp___2280 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))) (and (and (= (mk_int__ref result3) (mk_int__ref index)) (= index2 temp___2279)) (ite (and (<= temp___2279 index2) (<= index2 temp___2280)) (and (and (and (= temp___2278 index2) (and (= temp___2276 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o5 index2)) (= o6 (select n1 o5))) (= o7 (to_rep1 o6))) (= o7 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o8 index2)) (= o9 (select (elts source) o8))) (= o10 (to_rep o9))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o10))) (ite (= (= o10 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o10 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o10 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o10 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o10 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o10 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o10 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o10 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o10 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o10 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o11) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o12 index2)) (= o13 (store n1 o12 o11)))) (and (= n1 result4) (= n2 o13))))) (and (and (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (forall ((temp___2277 Int)) (=> (and (<= (to_rep1 n__first) temp___2277) (<= temp___2277 (to_rep1 n__last))) (=> (< index3 temp___2277) (= (select n3 temp___2277) (select temp___2276 temp___2277))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7) index3))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 7)))) (= index3 temp___2280)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1))))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (and (and (= temp___2281 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))) (and (and (<= (to_rep1 n__first) temp___2281) (<= temp___2281 (to_rep1 n__last))) (= o41 temp___2281))) (= o42 (select (map__content1 n7) o41))) (= o43 (to_rep1 o42))) (= o44 (- o43))) (and (= o45 o44) (in_range1 o44))) (and (= result9 (mk_int__ref target)) (= target1 o45))) (and (<= (- 9) target1) (and (and (and (and (and (and (and (and (and (and (= temp___2282 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))) (and (and (<= (to_rep1 n__first) temp___2282) (<= temp___2282 (to_rep1 n__last))) (= o46 temp___2282))) (= o47 (select (map__content1 n7) o46))) (= o48 (to_rep1 o47))) (= o49 (* o48 10))) (and (= o50 o49) (in_range1 o49))) (= o51 (- target1 o50))) (and (= o52 o51) (in_range1 o51))) (and (= result10 (mk_int__ref target1)) (= target2 o52))) (and (<= (- 99) target2) (and (and (and (and (and (and (and (and (and (and (= temp___2283 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (<= (to_rep1 n__first) temp___2283) (<= temp___2283 (to_rep1 n__last))) (= o53 temp___2283))) (= o54 (select (map__content1 n7) o53))) (= o55 (to_rep1 o54))) (= o56 (* o55 100))) (and (= o57 o56) (in_range1 o56))) (= o58 (- target2 o57))) (and (= o59 o58) (in_range1 o58))) (and (= result11 (mk_int__ref target2)) (= target3 o59))) (and (<= (- 999) target3) (and (and (and (and (and (and (and (and (and (and (= temp___2284 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (<= (to_rep1 n__first) temp___2284) (<= temp___2284 (to_rep1 n__last))) (= o60 temp___2284))) (= o61 (select (map__content1 n7) o60))) (= o62 (to_rep1 o61))) (= o63 (* o62 1000))) (and (= o64 o63) (in_range1 o63))) (= o65 (- target3 o64))) (and (= o66 o65) (in_range1 o65))) (and (= result12 (mk_int__ref target3)) (= target4 o66))) (and (<= (- 9999) target4) (and (and (and (and (and (and (and (and (and (and (= temp___2285 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))) (and (and (<= (to_rep1 n__first) temp___2285) (<= temp___2285 (to_rep1 n__last))) (= o67 temp___2285))) (= o68 (select (map__content1 n7) o67))) (= o69 (to_rep1 o68))) (= o70 (* o69 10000))) (and (= o71 o70) (in_range1 o70))) (= o72 (- target4 o71))) (and (= o73 o72) (in_range1 o72))) (and (= result13 (mk_int__ref target4)) (= target5 o73))) (and (<= (- 99999) target5) (and (and (and (and (and (and (and (and (and (and (= temp___2286 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (<= (to_rep1 n__first) temp___2286) (<= temp___2286 (to_rep1 n__last))) (= o74 temp___2286))) (= o75 (select (map__content1 n7) o74))) (= o76 (to_rep1 o75))) (= o77 (* o76 100000))) (and (= o78 o77) (in_range1 o77))) (= o79 (- target5 o78))) (and (= o80 o79) (in_range1 o79))) (and (= result14 (mk_int__ref target5)) (= target6 o80))) (and (<= (- 999999) target6) (and (and (and (and (and (and (and (and (and (and (= temp___2287 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (<= (to_rep1 n__first) temp___2287) (<= temp___2287 (to_rep1 n__last))) (= o81 temp___2287))) (= o82 (select (map__content1 n7) o81))) (= o83 (to_rep1 o82))) (= o84 (* o83 1000000))) (and (= o85 o84) (in_range1 o84))) (= o86 (- target6 o85))) (and (= o87 o86) (in_range1 o86))) (and (= result15 (mk_int__ref target6)) (= target7 o87))) (and (<= (- 9999999) target7) (and (= result16 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target8 (mk_int__ref target7)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target9 target7))))))))
