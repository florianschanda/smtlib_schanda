...
(assert (forall ((i t44b)) (and (<= 0 (t44bqtint i)) (<= (t44bqtint i) 20))))
...
(define-fun dynamic_invariant2 ((temp___expr_606 Int) (temp___is_init_602 Bool) (temp___skip_constant_603 Bool) (temp___do_toplevel_604 Bool) (temp___do_typ_inv_605 Bool)) Bool (=> (or (= temp___is_init_602 true) (<= 0 10000)) (in_range3 temp___expr_606)))
