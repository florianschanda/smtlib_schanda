...
(define-fun tint_arrayD1__ref___13__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___13__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t486b__ref (mk_t486b__ref (t486b__content integer)))))
(define-fun t486b__ref___projection ((a t486b__ref)) integer (t486b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t487b__ref (mk_t487b__ref (t487b__content us_t2)))))
(define-fun t487b__ref___projection ((a t487b__ref)) us_t2 (t487b__content a))
...
(define-fun tnumber_array_typeD1__ref___22__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___22__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t490b__ref (mk_t490b__ref (t490b__content integer)))))
(define-fun t490b__ref___projection ((a t490b__ref)) integer (t490b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t491b__ref (mk_t491b__ref (t491b__content us_t4)))))
(define-fun t491b__ref___projection ((a t491b__ref)) us_t4 (t491b__content a))
...
(declare-datatypes () ((t492b__ref (mk_t492b__ref (t492b__content integer)))))
(define-fun t492b__ref___projection ((a t492b__ref)) integer (t492b__content a))
...
(define-fun tint_arrayB__ref___13__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__aggregate_def (Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___1935 Int) (temp___1936 Int) (temp___1937 Int) (temp___1938 Int) (temp___1939 Int) (temp___1940 Int) (temp___1941 Int)) (let ((temp___1934 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__aggregate_def temp___1935 temp___1936 temp___1937 temp___1938 temp___1939 temp___1940 temp___1941))) (and (=> (dynamic_property10 (+ (first1 source) 6) (+ (first1 source) 10) temp___1940 temp___1941) (and (= (first5 temp___1934) temp___1940) (= (last5 temp___1934) temp___1941))) (and (and (and (and (= (select (to_array2 temp___1934) (+ (+ (first1 source) 6) 0)) (of_rep1 temp___1935)) (= (select (to_array2 temp___1934) (+ (+ (first1 source) 6) 1)) (of_rep1 temp___1936))) (= (select (to_array2 temp___1934) (+ (+ (first1 source) 6) 2)) (of_rep1 temp___1937))) (= (select (to_array2 temp___1934) (+ (+ (first1 source) 6) 3)) (of_rep1 temp___1938))) (= (select (to_array2 temp___1934) (+ (+ (first1 source) 6) 4)) (of_rep1 temp___1939)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___22__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___1947 Int) (temp___1948 Int) (temp___1949 Int)) (let ((temp___1946 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__aggregate_def temp___1947 temp___1948 temp___1949))) (and (=> (dynamic_property11 (+ (first1 source) 6) (+ (first1 source) 10) temp___1948 temp___1949) (and (= (first9 temp___1946) temp___1948) (= (last9 temp___1946) temp___1949))) (forall ((temp___1950 Int)) (= (select (to_array4 temp___1946) temp___1950) (of_rep1 temp___1947)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_581 us_t3) (temp___is_init_578 Bool) (temp___skip_constant_579 Bool) (temp___do_toplevel_580 Bool)) Bool (=> (not (= temp___skip_constant_579 true)) (and (dynamic_property6 (+ (first1 source) 6) (+ (first1 source) 10) (first7 temp___expr_581) (last7 temp___expr_581)) (and (= (first7 temp___expr_581) (+ (first1 source) 6)) (= (last7 temp___expr_581) (+ (first1 source) 10))))))
...
(declare-const temp___1965 Int)
(declare-const temp___1966 Int)
(declare-const o Int)
(declare-const o1 character)
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const temp___1967 Int)
(declare-const o4 Int)
(declare-const o5 character)
(declare-const o6 Int)
(declare-const o7 Bool)
(declare-const temp___1968 Int)
...
(declare-const temp___1944 (Array Int integer))
(declare-const temp___19441 t2)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___1952 (Array Int integer))
(declare-const temp___19521 t4)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume1 t3)
(declare-const us2 Int)
(declare-const us3 Int)
(declare-const temp___1958 Int)
(declare-const temp___1959 Int)
(declare-const temp___1957 Int)
(declare-const temp___1955 (Array Int integer))
...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 6) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__aggregate_def 7 9 9 9 9 (+ (to_rep1 (first (rt source))) 6) (+ (+ (to_rep1 (first (rt source))) 6) 4))))) (+ (to_rep1 (first (rt source))) 6)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__aggregate_def 7 9 9 9 9 (+ (to_rep1 (first (rt source))) 6) (+ (+ (to_rep1 (first (rt source))) 6) 4))))) (+ (+ (to_rep1 (first (rt source))) 6) 4)))
(assert (= (mk___t2 temp___1944 temp___19441) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__aggregate_def 7 9 9 9 9 (+ (to_rep1 (first (rt source))) 6) (+ (+ (to_rep1 (first (rt source))) 6) 4))))
(assert (= (ite (<= (to_rep1 (first4 temp___19441)) (to_rep1 (last4 temp___19441))) (+ (- (to_rep1 (last4 temp___19441)) (to_rep1 (first4 temp___19441))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 6)) 1) 0)))
(assert (= (slide1 temp___1944 (to_rep1 (first4 temp___19441)) (+ (to_rep1 (first (rt source))) 6)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 6)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 6)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)))
(assert (= (mk___t4 temp___1952 temp___19521) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___19521)) (to_rep1 (last8 temp___19521))) (+ (- (to_rep1 (last8 temp___19521)) (to_rep1 (first8 temp___19521))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 6)) 1) 0)))
(assert (= (slide1 temp___1952 (to_rep1 (first8 temp___19521)) (+ (to_rep1 (first (rt source))) 6)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_47x_xxx__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 6)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= temp___1958 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (= temp___1959 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___1958))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= temp___1957 index2)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= temp___1955 n1)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= o29 index2)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= o30 (select n1 o29))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= o31 (to_rep1 o30))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= o31 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= o32 index2)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= o33 (select (elts source) o32))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= o34 (to_rep o33))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o34))) (ite (= (= o34 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o34 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o34 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o34 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o34 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o34 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o34 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o34 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o34 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o34 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= (to_rep1 o35) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= o36 index2)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= o37 (store n1 o36 o35))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= n1 result4)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= n2 o37)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 6) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 6) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (and (and (forall ((temp___1956 Int)) (=> (and (<= (to_rep1 n__first) temp___1956) (<= temp___1956 (to_rep1 n__last))) (=> (< index3 temp___1956) (= (select n3 temp___1956) (select temp___1955 temp___1956))))) (=> (<= (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 6) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= index3 temp___1959)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= index3 index5)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= n3 n5)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= index6 index3)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= n6 n3)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= index8 index6)))
(assert (=> (and (<= temp___1958 index2) (<= index2 temp___1959)) (= n8 n6)))
(assert (=> (not (and (<= temp___1958 index2) (<= index2 temp___1959))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___1958 index2) (<= index2 temp___1959))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___1958 index2) (<= index2 temp___1959))) (= index8 index2)))
(assert (=> (not (and (<= temp___1958 index2) (<= index2 temp___1959))) (= n8 n1)))
...
(assert (and (= temp___1960 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___1960) (<= temp___1960 (to_rep1 n__last))))
(assert (= o65 temp___1960))
...
(assert (= target1 o69))
(assert (<= (- 9) target1))
(assert (and (= temp___1961 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1961) (<= temp___1961 (to_rep1 n__last))))
(assert (= o70 temp___1961))
(assert (= o71 (select (map__content1 n7) o70)))
(assert (= o72 (to_rep1 o71)))
(assert (= o73 (* o72 10)))
(assert (and (= o74 o73) (in_range1 o73)))
(assert (= o75 (- target1 o74)))
(assert (and (= o76 o75) (in_range1 o75)))
(assert (= result10 (mk_int__ref target1)))
(assert (= target2 o76))
(assert (<= (- 99) target2))
(assert (and (= temp___1962 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1962) (<= temp___1962 (to_rep1 n__last))))
(assert (= o77 temp___1962))
(assert (= o78 (select (map__content1 n7) o77)))
(assert (= o79 (to_rep1 o78)))
(assert (= o80 (* o79 100)))
(assert (and (= o81 o80) (in_range1 o80)))
(assert (= o82 (- target2 o81)))
(assert (not (in_range1 o82)))
(check-sat)
(exit)
