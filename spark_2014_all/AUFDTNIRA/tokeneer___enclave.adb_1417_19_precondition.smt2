...
(assert (=> (= result3 true) (=> (= result4 true) (and (= o8 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o8)))))
...
(assert (= result5 true))
(assert (and (= o4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= o4 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6)))))))
(assert (= o5 (ite (not (= o4 true)) true false)))
(assert (and (= result6 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= result6 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6)))))))
(assert (= result6 true))
