...
(assert (and (= o69 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= o69 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6)))))))
(assert (= o70 (ite (not (= o69 true)) true false)))
(assert (and (= result12 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= result12 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6)))))))
