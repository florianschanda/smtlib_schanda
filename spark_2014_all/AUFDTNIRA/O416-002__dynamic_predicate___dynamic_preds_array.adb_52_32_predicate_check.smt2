...
(assert (forall ((us_void_param tuple0)) (! (let ((result (get_constant_even_pair us_void_param))) (and (and (= (to_rep (select result 1)) 0) (= (to_rep (select result 2)) 0)) (dynamic_invariant2 result true false true true))) :pattern ((get_constant_even_pair us_void_param)))))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const x (Array Int even))
(declare-const temp___296 (Array Int even))
...
(assert (and (= temp___296 (get_constant_even_pair Tuple0)) (and (dynamic_invariant2 temp___296 true false true true) (and (= (to_rep (select temp___296 1)) 0) (= (to_rep (select temp___296 2)) 0)))))
(assert (not (dynamic_predicate1 temp___296)))
(check-sat)
(exit)
