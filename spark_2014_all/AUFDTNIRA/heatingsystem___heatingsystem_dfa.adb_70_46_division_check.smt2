...
(declare-fun user_eq (displaydigits displaydigits) Bool)
(declare-const dummy displaydigits)
...
(assert (forall ((x displaydigits)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(declare-fun temp_____aggregate_def_295 (Int Int Int Int) (Array Int displaydigits))
(define-fun dynamic_invariant3 ((temp___expr_167 Int) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool) (temp___do_typ_inv_166 Bool)) Bool (=> (or (= temp___is_init_163 true) (<= 0 9)) (in_range temp___expr_167)))
(assert (forall ((temp___297 Int) (temp___298 Int) (temp___299 Int) (temp___300 Int)) (let ((temp___296 (temp_____aggregate_def_295 temp___297 temp___298 temp___299 temp___300))) (=> (and (and (and (dynamic_invariant3 temp___297 true true true true) (dynamic_invariant3 temp___298 true true true true)) (dynamic_invariant3 temp___299 true true true true)) (dynamic_invariant3 temp___300 true true true true)) (and (and (and (= (to_rep (select temp___296 0)) temp___297) (= (to_rep (select temp___296 1)) temp___298)) (= (to_rep (select temp___296 2)) temp___299)) (= (to_rep (select temp___296 3)) temp___300))))))
