...
(assert (and (<= 1 (to_rep4 logfilestate__split_fields26)) (= (to_rep3 logfilestate__split_fields22) (+ (* (- (to_rep4 logfilestate__split_fields26) 1) 1024) (to_rep5 (select logfilestate__split_fields27 (to_rep2 logfilestate__split_fields21)))))))
(assert (in_range6 (int__content auditalarm4)))
(assert (not (= (valid_numberlogentries (to_rep2 logfilestate__split_fields21) (to_rep3 logfilestate__split_fields22) (mk___rep (mk___split_fields logfilestate__split_fields23 logfilestate__split_fields24 logfilestate__split_fields25 logfilestate__split_fields26)) logfilestate__split_fields27) true)))
(check-sat)
(exit)
