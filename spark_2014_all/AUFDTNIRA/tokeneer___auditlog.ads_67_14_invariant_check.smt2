...
(assert (and (<= 1 (to_rep4 logfilestate__split_fields12)) (= (to_rep3 logfilestate__split_fields8) (+ (* (- (to_rep4 logfilestate__split_fields12) 1) 1024) (to_rep5 (select logfilestate__split_fields13 (to_rep2 logfilestate__split_fields7)))))))
(assert (in_range4 (int__content auditalarm1)))
(assert (not (= (valid_numberlogentries (to_rep2 logfilestate__split_fields7) (to_rep3 logfilestate__split_fields8) (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) true)))
(check-sat)
(exit)
