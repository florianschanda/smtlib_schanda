...
(assert (=> (= result8 true) (and (= o3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o3 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
...
(assert (=> (= result8 true) (=> (= result9 true) (and (= o2 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields)))) (in_range4 o2)))))
