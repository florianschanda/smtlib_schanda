...
(assert (= result_index9 (* (+ (- index12 (to_rep (first (rt array1)))) 1) (length array2))))
(assert (forall ((i5 Int)) (=> (and (<= (to_rep (first (rt array1))) i5) (<= i5 index12)) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 (to_rep (last (rt array2))))) (= (to_rep (select (select result__9 (+ (+ (* (- i5 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) i5))))))))
(assert (forall ((i5 Int)) (=> (and (<= (to_rep (first (rt array1))) i5) (<= i5 index12)) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 (to_rep (last (rt array2))))) (= (to_rep (select (select result__9 (+ (+ (* (- i5 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j9))))))))
(assert (and (and (=> (<= 0 2147483647) (in_range2 result_index9)) (=> (<= (to_rep (first (rt array1))) (to_rep (last (rt array1)))) (dynamic_property6 (to_rep (first (rt array1))) (to_rep (last (rt array1))) index12))) (and (<= (to_rep (first (rt array1))) index12) (<= index12 (to_rep (last (rt array1)))))))
(assert (<= (to_rep (first (rt array1))) i1))
(assert (<= i1 index12))
(assert (<= (to_rep (first (rt array2))) j3))
(assert (<= j3 (to_rep (last (rt array2)))))
(assert (and (<= (to_rep (first (rt array2))) j3) (<= j3 (to_rep (last (rt array2))))))
(assert (= o66 j3))
(assert (= o67 (select (elts array2) o66)))
(assert (= o68 (to_rep o67)))
(assert (and (= o61 (- j3 (to_rep (first (rt array2))))) (in_range1 (- j3 (to_rep (first (rt array2)))))))
