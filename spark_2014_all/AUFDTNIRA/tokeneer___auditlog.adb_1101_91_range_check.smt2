...
(assert (= j4 (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields24)))))))
(assert (and (= o51 (+ (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields24))))) 1)) (in_range6 (+ (to_rep2 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields24))))) 1))))
(assert (= (to_rep2 o52) o51))
(assert (= o53 (mk___split_fields (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields24)))) (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields24)))) o52 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields24)))))))
(assert (= o54 (mk___rep o53)))
(assert (= o55 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields24)) (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content1 logfilestate__split_fields24)) o54 (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields24)))))
(assert (= temp___1359 (mk___rep1 o55)))
(assert (= result15 logfilestate__split_fields24))
(assert (= logfilestate__split_fields26 (us_split_fields3 temp___1359)))
(assert (not (in_range9 (+ (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields26)))) 1))))
(check-sat)
(exit)
