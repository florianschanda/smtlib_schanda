...
(assert (= f2 o13))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields1)) k1) (<= k1 i2)) (= (to_rep2 (select f3 k1)) p_prime_index2))))
(assert (forall ((k1 Int)) (=> (and (<= 0 k1) (<= k1 (- (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1))) (= (to_rep2 (select f3 k1)) (to_rep2 (select f_loop_entry k1))))))
(assert (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 5)) (= (to_rep2 (select f3 k1)) (to_rep2 (select f_loop_entry k1))))))
(assert (and (and (forall ((temp___1294 Int)) (=> (and (<= 0 temp___1294) (<= temp___1294 5)) (=> (< i2 temp___1294) (= (select f3 temp___1294) (select f1 temp___1294))))) (=> (<= r54b r55b) (dynamic_property r54b r55b i2))) (and (<= r54b i2) (<= i2 r55b))))
(assert (and (= o14 (+ i2 1)) (in_range3 (+ i2 1))))
(assert (= o15 (ite (<= o14 k) true false)))
(assert (= result10 (ite (= o15 true) (ite (<= k 5) true false) false)))
(assert (= result10 true))
(assert (and (<= 0 k) (<= k 5)))
(assert (= o16 k))
(assert (= o17 (select f_loop_entry o16)))
