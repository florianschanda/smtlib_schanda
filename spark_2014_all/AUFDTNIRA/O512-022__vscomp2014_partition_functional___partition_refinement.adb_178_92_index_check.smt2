...
(assert (<= r54b i3))
(assert (<= i3 r55b))
(assert (= (to_rep2 o56) p_prime_index3))
(assert (= o57 (store f2 i3 o56)))
(assert (= result15 (mk_map__ref f2)))
(assert (= f3 o57))
(assert (forall ((k18 Int)) (=> (and (<= (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields5)) k18) (<= k18 i4)) (= (to_rep2 (select f4 k18)) p_prime_index3))))
(assert (forall ((k18 Int)) (=> (and (<= 0 k18) (<= k18 (- (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields5)) 1))) (= (to_rep2 (select f4 k18)) (to_rep2 (select f_loop_entry k18))))))
(assert (forall ((k18 Int)) (=> (and (<= (+ i4 1) k18) (<= k18 5)) (= (to_rep2 (select f4 k18)) (to_rep2 (select f_loop_entry k18))))))
(assert (and (and (forall ((temp___1221 Int)) (=> (and (<= 0 temp___1221) (<= temp___1221 5)) (=> (< i4 temp___1221) (= (select f4 temp___1221) (select f2 temp___1221))))) (=> (<= r54b r55b) (dynamic_property r54b r55b i4))) (and (<= r54b i4) (<= i4 r55b))))
(assert (and (= o61 (+ i4 1)) (in_range3 (+ i4 1))))
(assert (= o62 (ite (<= o61 k3) true false)))
(assert (= result16 (ite (= o62 true) (ite (<= k3 5) true false) false)))
(assert (= result16 true))
(assert (and (<= 0 k3) (<= k3 5)))
(assert (= o63 k3))
(assert (= o64 (select f_loop_entry o63)))
(assert (= o65 (to_rep2 o64)))
(assert (not (<= 0 k3)))
(check-sat)
(exit)
