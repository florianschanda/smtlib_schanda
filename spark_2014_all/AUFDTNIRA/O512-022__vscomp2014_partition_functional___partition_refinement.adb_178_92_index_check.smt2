...
(assert (and (and (forall ((temp___1221 Int)) (=> (and (<= 0 temp___1221) (<= temp___1221 5)) (=> (< i2 temp___1221) (= (select f3 temp___1221) (select f1 temp___1221))))) (=> (<= r54b r55b) (dynamic_property r54b r55b i2))) (and (<= r54b i2) (<= i2 r55b))))
