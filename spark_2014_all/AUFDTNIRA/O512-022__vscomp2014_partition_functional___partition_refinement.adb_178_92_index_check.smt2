...
(assert (and (= o11 (+ i2 1)) (in_range6 (+ i2 1))))
(assert (= o12 (ite (<= o11 k) true false)))
(assert (= result10 (ite (= o12 true) (ite (<= k 5) true false) false)))
(assert (= result10 true))
(assert (and (<= 0 k) (<= k 5)))
(assert (= o13 k))
(assert (= o14 (select f_loop_entry o13)))
