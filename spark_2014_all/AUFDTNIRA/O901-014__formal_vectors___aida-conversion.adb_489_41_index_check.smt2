...
(assert (forall ((temp___1368 Int) (temp___1369 Int) (temp___1370 Int) (temp___1371 Int) (temp___1372 Int) (temp___1373 Int) (temp___1374 Int) (temp___1375 Int) (temp___1376 Int) (temp___1377 Int) (temp___1378 Int) (temp___1379 Int)) (let ((temp___1367 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def temp___1368 temp___1369 temp___1370 temp___1371 temp___1372 temp___1373 temp___1374 temp___1375 temp___1376 temp___1377 temp___1378 temp___1379))) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1378 temp___1379) (and (= (first5 temp___1367) temp___1378) (= (last5 temp___1367) temp___1379))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1367) (+ (first1 source) 0)) (of_rep1 temp___1368)) (= (select (to_array2 temp___1367) (+ (first1 source) 1)) (of_rep1 temp___1369))) (= (select (to_array2 temp___1367) (+ (first1 source) 2)) (of_rep1 temp___1370))) (= (select (to_array2 temp___1367) (+ (first1 source) 3)) (of_rep1 temp___1371))) (= (select (to_array2 temp___1367) (+ (first1 source) 4)) (of_rep1 temp___1372))) (= (select (to_array2 temp___1367) (+ (first1 source) 5)) (of_rep1 temp___1373))) (= (select (to_array2 temp___1367) (+ (first1 source) 6)) (of_rep1 temp___1374))) (= (select (to_array2 temp___1367) (+ (first1 source) 7)) (of_rep1 temp___1375))) (= (select (to_array2 temp___1367) (+ (first1 source) 8)) (of_rep1 temp___1376))) (= (select (to_array2 temp___1367) (+ (first1 source) 9)) (of_rep1 temp___1377)))))))
(declare-sort t6 0)
...
(assert (forall ((temp___1385 Int) (temp___1386 Int) (temp___1387 Int)) (let ((temp___1384 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__aggregate_def temp___1385 temp___1386 temp___1387))) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1386 temp___1387) (and (= (first9 temp___1384) temp___1386) (= (last9 temp___1384) temp___1387))) (forall ((temp___1388 Int)) (= (select (to_array4 temp___1384) temp___1388) (of_rep1 temp___1385)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_257 us_t3) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool)) Bool (=> (not (= temp___skip_constant_255 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_257) (last7 temp___expr_257)) (and (= (first7 temp___expr_257) (first1 source)) (= (last7 temp___expr_257) (+ (first1 source) 9))))))
...
(declare-const temp___1382 (Array Int integer))
(declare-const temp___13821 t2)
...
(declare-const temp___1390 (Array Int integer))
(declare-const temp___13901 t4)
...
(declare-const temp___1393 (Array Int integer))
...
(assert (and (and (= (length source) 10) (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52))) (forall ((index11 Int)) (=> (and (<= (to_rep1 (first (rt source))) index11) (<= index11 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
...
(assert (= (mk___t2 temp___1382 temp___13821) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__aggregate_def 2 1 4 7 3 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___13821)) (to_rep1 (last4 temp___13821))) (+ (- (to_rep1 (last4 temp___13821)) (to_rep1 (first4 temp___13821))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1382 (to_rep1 (first4 temp___13821)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__int_array__assume))
...
(assert (= (mk___t4 temp___1390 temp___13901) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___13901)) (to_rep1 (last8 temp___13901))) (+ (- (to_rep1 (last8 temp___13901)) (to_rep1 (first8 temp___13901))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1390 (to_rep1 (first8 temp___13901)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_3xx_xxx__n__assume))
...
(assert (and (= temp___1397 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index2 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= temp___1395 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= temp___1393 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= o17 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= o18 (select n1 o17))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= o19 (to_rep1 o18))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= o19 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= o20 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= o21 (select (elts source) o20))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= o22 (to_rep o21))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o22))) (ite (= (= o22 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o22 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o22 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o22 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o22 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o22 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o22 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o22 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o22 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o22 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= (to_rep1 o23) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= o24 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= o25 (store n1 o24 o23))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= n2 o25)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (and (and (forall ((temp___1394 Int)) (=> (and (<= (to_rep1 n__first) temp___1394) (<= temp___1394 (to_rep1 n__last))) (=> (< index3 temp___1394) (= (select n3 temp___1394) (select temp___1393 temp___1394))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= index3 temp___1397)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= index3 index5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= n3 n5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= index6 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= n6 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= index8 index6)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397)) (= n8 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397))) (= index8 index2)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1397))) (= n8 n1)))
...
(assert (and (= temp___1398 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1398) (<= temp___1398 (to_rep1 n__last))))
(assert (= o49 temp___1398))
(assert (= o50 (select (map__content1 n7) o49)))
(assert (= o51 (to_rep1 o50)))
(assert (= result6 (mk_int__ref target)))
(assert (= target1 o51))
(assert (<= target1 9))
(assert (and (= temp___1399 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1399) (<= temp___1399 (to_rep1 n__last))))
(assert (= o52 temp___1399))
(assert (= o53 (select (map__content1 n7) o52)))
(assert (= o54 (to_rep1 o53)))
(assert (= o55 (* o54 10)))
(assert (and (= o56 o55) (in_range1 o55)))
(assert (= o57 (+ target1 o56)))
(assert (and (= o58 o57) (in_range1 o57)))
(assert (= result7 (mk_int__ref target1)))
(assert (= target2 o58))
(assert (<= target2 99))
(assert (and (= temp___1400 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1400) (<= temp___1400 (to_rep1 n__last))))
(assert (= o59 temp___1400))
(assert (= o60 (select (map__content1 n7) o59)))
(assert (= o61 (to_rep1 o60)))
(assert (= o62 (* o61 100)))
(assert (and (= o63 o62) (in_range1 o62)))
(assert (= o64 (+ target2 o63)))
(assert (and (= o65 o64) (in_range1 o64)))
(assert (= result8 (mk_int__ref target2)))
(assert (= target3 o65))
(assert (<= target3 999))
(assert (and (= temp___1401 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (not (<= (to_rep1 n__first) temp___1401)))
(check-sat)
(exit)
