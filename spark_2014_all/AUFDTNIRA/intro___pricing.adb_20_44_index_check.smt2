...
(assert (forall ((k1 Int)) (=> (and (<= (to_rep1 (first (rt bk))) k1) (<= k1 (- it2 1))) (<= (price_of_item (select (elts bk) k1)) total2))))
(assert (and (and (=> (<= 0 10000) (in_range3 total2)) (=> (<= (to_rep1 (first (rt bk))) (to_rep1 (last (rt bk)))) (dynamic_property1 (to_rep1 (first (rt bk))) (to_rep1 (last (rt bk))) it2))) (and (<= (to_rep1 (first (rt bk))) it2) (<= it2 (to_rep1 (last (rt bk)))))))
