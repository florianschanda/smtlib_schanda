...
(assert (and (and (=> (<= 1 2147483647) (in_range3 space2)) (=> (<= 0 2147483647) (in_range2 left1))) (=> (<= 0 2147483647) (in_range2 right1))))
(assert (= temp___205 result1))
(assert (= temp___2051 space2))
(assert (= left1 result2))
(assert (= left2 (- space2 1)))
(assert (=> (< left2 8) (= temp___179 a1)))
(assert (=> (< left2 8) (= temp___175 right1)))
(assert (=> (< left2 8) (= temp___173 a1)))
(assert (=> (< left2 8) (= temp___177 a1)))
(assert (=> (< left2 8) (= temp___172 left2)))
(assert (=> (< left2 8) (= temp___176 a1)))
(assert (=> (< left2 8) (= 0 temp___180)))
(assert (=> (< left2 8) (and (and (and (and (and (= (mod2 (+ left3 1) space2) 0) (= (all_left_elements_in a2 left3 (* (* space2 2) 1000000)) true)) (= (all_right_elements_in a2 (- left3 1) (* space2 1000000)) true)) (= (mod2 (+ left3 1) (* space2 2)) space2)) (=> (<= 8 left3) (or (= left3 8) (= left3 9)))) (forall ((k Int)) (=> (and (<= 0 k) (<= k 7)) (ite (and (and (<= 0 k) (<= k (- left3 space2))) (= (mod2 (+ k 1) (* 2 space2)) 0)) (= (to_rep (select a2 k)) (+ (to_rep (select temp___176 k)) (to_rep (select temp___177 (- k space2))))) (= (to_rep (select a2 k)) (to_rep (select temp___179 k)))))))))
(assert (=> (< left2 8) (and (and (=> (<= 0 2147483647) (in_range2 left3)) (=> (<= 0 2147483647) (in_range2 right2))) (< left3 8))))
(assert (=> (< left2 8) (= temp___1801 result3)))
(assert (=> (< left2 8) (= temp___1802 left3)))
...
(assert (=> (< left2 8) (= rho1 temp___1802)))
