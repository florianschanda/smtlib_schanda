...
(assert (= index1 0))
(assert (=> (and (<= 0 index1) (<= index1 100000)) (= temp___226 result__)))
(assert (=> (and (<= 0 index1) (<= index1 100000)) (= temp___225 index1)))
...
(assert (=> (and (<= 0 index1) (<= index1 100000)) (and (and (=> (<= 0 100000) (in_range3 index2)) (forall ((temp___227 Int)) (=> (and (<= 0 temp___227) (<= temp___227 100000)) (=> (< index2 temp___227) (= (select result__3 temp___227) (select temp___226 temp___227)))))) (and (<= 0 index2) (<= index2 100000)))))
