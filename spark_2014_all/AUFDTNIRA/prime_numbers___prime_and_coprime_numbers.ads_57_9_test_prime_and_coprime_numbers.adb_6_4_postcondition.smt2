...
(assert (= index1 0))
(assert (=> (and (<= 0 index1) (<= index1 100000)) (= temp___262 index1)))
(assert (=> (and (<= 0 index1) (<= index1 100000)) (= temp___260 result__)))
...
(assert (=> (and (<= 0 index1) (<= index1 100000)) (and (and (forall ((temp___261 Int)) (=> (and (<= 0 temp___261) (<= temp___261 100000)) (=> (< index2 temp___261) (= (select result__3 temp___261) (select temp___260 temp___261))))) (=> (<= 0 100000) (in_range3 index2))) (and (<= 0 index2) (<= index2 100000)))))
...
(assert (<= 0 v))
(assert (<= v 100000))
(assert (= (select test_prime_and_coprime_numbers__p__initialize_coprime_list__result4 v) true))
(assert (not (= (are_coprime value v) true)))
(check-sat)
(exit)
