...
(assert (and (= o58 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o58 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= o59 (ite (not (= o58 true)) true false)))
(assert (and (= result20 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result20 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
