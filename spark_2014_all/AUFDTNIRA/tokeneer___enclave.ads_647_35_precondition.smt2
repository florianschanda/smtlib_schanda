...
(assert (and (= result1 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result1 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result1 true))
