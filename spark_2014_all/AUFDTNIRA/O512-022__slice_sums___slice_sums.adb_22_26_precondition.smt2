...
(assert (=> (<= (to_rep3 (first (rt x))) (to_rep (rec__sums__slice_bounds__lo result____split_fields3))) (= result4 (ite (<= (to_rep1 (rec__sums__slice_bounds__hi result____split_fields3)) (to_rep3 (last (rt x)))) true false))))
(assert (=> (not (<= (to_rep3 (first (rt x))) (to_rep (rec__sums__slice_bounds__lo result____split_fields3)))) (= result4 false)))
(assert (= result4 true))
