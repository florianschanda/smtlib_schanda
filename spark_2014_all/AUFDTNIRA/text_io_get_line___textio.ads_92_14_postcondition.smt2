...
(assert (and (and (forall ((idx Int)) (=> (and (<= 1 idx) (<= idx num1)) (= (to_rep (select result__ idx)) (to_rep (select the_file1 (+ (- idx 1) cur_position_at_start)))))) (and (= cur_position1 (+ cur_position_at_start num1)) (or (= (to_rep (select the_file1 cur_position1)) eof_ch) (= (to_rep (select the_file1 cur_position1)) 10)))) (and (in_range4 num1) (in_range2 cur_position1))))
(assert (= num1 num2))
...
(assert (<= 1 idx))
(assert (<= idx num2))
(assert (not (= (to_rep (select result__1 idx)) (to_rep (select the_file2 (+ (- idx 1) cur_position))))))
(check-sat)
(exit)
