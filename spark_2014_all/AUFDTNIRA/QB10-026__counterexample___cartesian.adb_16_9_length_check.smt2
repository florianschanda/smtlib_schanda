...
(assert (not (= (ite (<= (to_rep (first6 temp___2351)) (to_rep (last6 temp___2351))) (+ (- (to_rep (last6 temp___2351)) (to_rep (first6 temp___2351))) 1) 0) (ite (<= 1 result_length) (+ (- result_length 1) 1) 0))))
(check-sat)
(exit)
