...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_150 Int)) (=> (and (<= a__first temp___idx_150) (<= temp___idx_150 a__last)) (= (to_rep (select a temp___idx_150)) (to_rep (select b (+ (- b__first a__first) temp___idx_150)))))))))))
...
(assert (forall ((temp___1098 Int)) (forall ((temp___1099 Int)) (= (select (temp___1096 temp___1098) temp___1099) (of_rep temp___1098)))))
(declare-fun temp___1100 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1102 Int)) (forall ((temp___1103 Int)) (= (select (temp___1100 temp___1102) temp___1103) (of_rep3 temp___1102)))))
(define-fun dynamic_invariant1 ((temp___expr_1090 us_rep1) (temp___is_init_1087 Bool) (temp___skip_constant_1088 Bool) (temp___do_toplevel_1089 Bool)) Bool (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1090))) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1090))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1090)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1090))) true))
(define-fun default_initial_assumption ((temp___expr_1094 us_rep1) (temp___skip_top_level_1095 Bool)) Bool (and (and (and (= (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1094))) 1) (= (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1094))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1094)) (mk___rep (mk___split_fields (temp___1096 1) (of_rep 1) (of_rep 1) (of_rep2 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1094)) (temp___1100 0))))
(define-fun type_invariant ((temp___1104 us_rep1)) Bool (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1104))) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1104))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1104)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1104))) true))
...
(declare-fun concat3 ((Array Int filestatust) Int Int (Array Int filestatust) Int Int) (Array Int filestatust))
...
(declare-fun singleton3 (filestatust Int) (Array Int filestatust))
(assert (forall ((v filestatust)) (forall ((i Int)) (! (= (select (singleton3 v i) i) v) :pattern ((select (singleton3 v i) i))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep4 (select a temp___idx_153)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
(declare-fun compare2 ((Array Int filestatust) Int Int (Array Int filestatust) Int Int) Int)
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare2 a a_first a_last b b_first b_last) 0) (= (bool_eq4 a a_first a_last b b_first b_last) true)) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq4 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep4 (select b (+ i 1))) (to_rep4 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant2 ((temp___expr_1056 Int) (temp___is_init_1053 Bool) (temp___skip_constant_1054 Bool) (temp___do_toplevel_1055 Bool)) Bool (=> (or (= temp___is_init_1053 true) (<= 0 17)) (in_range4 temp___expr_1056)))
(define-fun dynamic_invariant3 ((temp___expr_1035 Int) (temp___is_init_1032 Bool) (temp___skip_constant_1033 Bool) (temp___do_toplevel_1034 Bool)) Bool (=> (or (= temp___is_init_1032 true) (<= 1 17)) (in_range2 temp___expr_1035)))
(define-fun dynamic_invariant4 ((temp___expr_1160 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 2)) (in_range6 temp___expr_1160)))
(define-fun dynamic_invariant5 ((temp___expr_1041 Int) (temp___is_init_1038 Bool) (temp___skip_constant_1039 Bool) (temp___do_toplevel_1040 Bool)) Bool (=> (or (= temp___is_init_1038 true) (<= 0 17408)) (in_range3 temp___expr_1041)))
(define-fun dynamic_invariant6 ((temp___expr_1075 Int) (temp___is_init_1072 Bool) (temp___skip_constant_1073 Bool) (temp___do_toplevel_1074 Bool)) Bool (=> (or (= temp___is_init_1072 true) (<= 0 1024)) (in_range5 temp___expr_1075)))
(assert true)
...
(assert (and (= o1 (theauditalarm logfilesstatus state (mk___split_fields1 logfilestate__split_fields logfilestate__split_fields1 (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6) auditalarm auditsystemfault)) (in_range1 o1)))
...
(assert (not (= (isalarming1 Tuple0) true)))
(check-sat)
(exit)
