...
(assert (forall ((temp___1042 Int)) (forall ((temp___1043 Int)) (= (select (temp___1040 temp___1042) temp___1043) (of_rep temp___1042)))))
(declare-fun temp___1044 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1046 Int)) (forall ((temp___1047 Int)) (= (select (temp___1044 temp___1046) temp___1047) (of_rep3 temp___1046)))))
(define-fun dynamic_invariant1 ((temp___expr_1034 us_rep1) (temp___is_init_1031 Bool) (temp___skip_constant_1032 Bool) (temp___do_toplevel_1033 Bool)) Bool (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1034))) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1034))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1034)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1034))) true))
(define-fun default_initial_assumption ((temp___expr_1038 us_rep1) (temp___skip_top_level_1039 Bool)) Bool (and (and (and (= (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1038))) 1) (= (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1038))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1038)) (mk___rep (mk___split_fields (temp___1040 1) (of_rep 1) (of_rep 1) (of_rep2 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1038)) (temp___1044 0))))
(define-fun type_invariant ((temp___1048 us_rep1)) Bool (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1048))) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1048))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1048)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1048))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_1000 Int) (temp___is_init_997 Bool) (temp___skip_constant_998 Bool) (temp___do_toplevel_999 Bool)) Bool (=> (or (= temp___is_init_997 true) (<= 0 17)) (in_range4 temp___expr_1000)))
(define-fun dynamic_invariant3 ((temp___expr_979 Int) (temp___is_init_976 Bool) (temp___skip_constant_977 Bool) (temp___do_toplevel_978 Bool)) Bool (=> (or (= temp___is_init_976 true) (<= 1 17)) (in_range2 temp___expr_979)))
(define-fun dynamic_invariant4 ((temp___expr_1104 Int) (temp___is_init_1101 Bool) (temp___skip_constant_1102 Bool) (temp___do_toplevel_1103 Bool)) Bool (=> (or (= temp___is_init_1101 true) (<= 0 2)) (in_range6 temp___expr_1104)))
(define-fun dynamic_invariant5 ((temp___expr_985 Int) (temp___is_init_982 Bool) (temp___skip_constant_983 Bool) (temp___do_toplevel_984 Bool)) Bool (=> (or (= temp___is_init_982 true) (<= 0 17408)) (in_range3 temp___expr_985)))
(define-fun dynamic_invariant6 ((temp___expr_1019 Int) (temp___is_init_1016 Bool) (temp___skip_constant_1017 Bool) (temp___do_toplevel_1018 Bool)) Bool (=> (or (= temp___is_init_1016 true) (<= 0 1024)) (in_range5 temp___expr_1019)))
(assert true)
