...
(define-fun dynamic_invariant ((temp___expr_626 Int) (temp___is_init_622 Bool) (temp___skip_constant_623 Bool) (temp___do_toplevel_624 Bool) (temp___do_typ_inv_625 Bool)) Bool (=> (or (= temp___is_init_622 true) (<= 0 1)) (in_range5 temp___expr_626)))
...
(define-fun bool_eq4 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep8 (select a temp___idx_175)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_175))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep8 (select a temp___idx_175)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(define-fun bool_eq6 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep11 (select a temp___idx_176)) (to_rep11 (select b (+ (- b__first a__first) temp___idx_176))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep11 (select a temp___idx_176)) (to_rep11 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
...
(declare-fun temp___1343 (Int) (Array Int logfileindext))
(declare-fun temp___1347 (Int) (Array Int fileentrycountt))
(define-fun dynamic_invariant1 ((temp___expr_1337 us_rep4) (temp___is_init_1333 Bool) (temp___skip_constant_1334 Bool) (temp___do_toplevel_1335 Bool) (temp___do_typ_inv_1336 Bool)) Bool (=> (= temp___do_typ_inv_1336 true) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___expr_1337))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___expr_1337))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___expr_1337)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___expr_1337))) true)))
(define-fun default_initial_assumption ((temp___expr_1341 us_rep4) (temp___skip_top_level_1342 Bool)) Bool (and (and (and (= (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___expr_1341))) 1) (= (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___expr_1341))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___expr_1341)) (mk___rep3 (mk___split_fields3 (temp___1343 1) (of_rep8 1) (of_rep8 1) (of_rep10 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___expr_1341)) (temp___1347 0))))
(define-fun type_invariant ((temp___1351 us_rep4)) Bool (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields9 temp___1351))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields9 temp___1351))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields9 temp___1351)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields9 temp___1351))) true))
...
(define-fun bool_eq9 ((a (Array Int us_rep5)) (a__first Int) (a__last Int) (b (Array Int us_rep5)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq8 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true)))) true false))
...
(define-fun bool_eq10 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep12 (select a temp___idx_178)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_178))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep12 (select a temp___idx_178)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_178)))))))))))
...
(declare-fun temp___String_Literal_2949 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2949 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 2)) 38)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 3)) 65)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 5)) 67)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 10)) 102)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 17)) 78)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 21)) 67)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 22)) 117)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 24)) 114)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 26)) 110)) (= (to_rep (select (temp___String_Literal_2949 us_void_param) 27)) 116)) :pattern ((temp___String_Literal_2949 us_void_param)))))
(declare-fun temp___String_Literal_2954 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2954 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 2)) 38)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 3)) 65)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 5)) 67)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 10)) 102)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 17)) 78)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 21)) 86)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 22)) 101)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 24)) 105)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 25)) 102)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 26)) 105)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 27)) 97)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 28)) 98)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 29)) 108)) (= (to_rep (select (temp___String_Literal_2954 us_void_param) 30)) 101)) :pattern ((temp___String_Literal_2954 us_void_param)))))
(declare-fun temp___String_Literal_2959 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2959 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 2)) 38)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 3)) 65)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 5)) 67)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 10)) 102)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 17)) 66)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 18)) 97)) (= (to_rep (select (temp___String_Literal_2959 us_void_param) 19)) 100)) :pattern ((temp___String_Literal_2959 us_void_param)))))
...
(define-fun dynamic_invariant3 ((temp___expr_2414 Int) (temp___is_init_2410 Bool) (temp___skip_constant_2411 Bool) (temp___do_toplevel_2412 Bool) (temp___do_typ_inv_2413 Bool)) Bool (=> (or (= temp___is_init_2410 true) (<= 0 3)) (in_range22 temp___expr_2414)))
(define-fun dynamic_invariant4 ((temp___expr_1275 Int) (temp___is_init_1271 Bool) (temp___skip_constant_1272 Bool) (temp___do_toplevel_1273 Bool) (temp___do_typ_inv_1274 Bool)) Bool (=> (or (= temp___is_init_1271 true) (<= 0 17)) (in_range13 temp___expr_1275)))
(define-fun dynamic_invariant5 ((temp___expr_1282 Int) (temp___is_init_1278 Bool) (temp___skip_constant_1279 Bool) (temp___do_toplevel_1280 Bool) (temp___do_typ_inv_1281 Bool)) Bool (=> (or (= temp___is_init_1278 true) (<= 1 17)) (in_range11 temp___expr_1282)))
(define-fun dynamic_invariant6 ((temp___expr_1408 Int) (temp___is_init_1404 Bool) (temp___skip_constant_1405 Bool) (temp___do_toplevel_1406 Bool) (temp___do_typ_inv_1407 Bool)) Bool (=> (or (= temp___is_init_1404 true) (<= 0 2)) (in_range15 temp___expr_1408)))
(define-fun dynamic_invariant7 ((temp___expr_1289 Int) (temp___is_init_1285 Bool) (temp___skip_constant_1286 Bool) (temp___do_toplevel_1287 Bool) (temp___do_typ_inv_1288 Bool)) Bool (=> (or (= temp___is_init_1285 true) (<= 0 17408)) (in_range12 temp___expr_1289)))
(define-fun dynamic_invariant8 ((temp___expr_1320 Int) (temp___is_init_1316 Bool) (temp___skip_constant_1317 Bool) (temp___do_toplevel_1318 Bool) (temp___do_typ_inv_1319 Bool)) Bool (=> (or (= temp___is_init_1316 true) (<= 0 1024)) (in_range14 temp___expr_1320)))
(assert true)
...
(assert (forall ((temp___1349 Int)) (=> (dynamic_invariant8 temp___1349 true true true true) (forall ((temp___1350 Int)) (= (to_rep11 (select (temp___1347 temp___1349) temp___1350)) temp___1349)))))
(define-fun dynamic_invariant9 ((temp___expr_651 Int) (temp___is_init_647 Bool) (temp___skip_constant_648 Bool) (temp___do_toplevel_649 Bool) (temp___do_typ_inv_650 Bool)) Bool (=> (or (= temp___is_init_647 true) (<= 1 150)) (in_range6 temp___expr_651)))
...
(define-fun dynamic_invariant10 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 255)) (in_range20 temp___expr_214)))
(define-fun dynamic_invariant11 ((temp___expr_703 Int) (temp___is_init_699 Bool) (temp___skip_constant_700 Bool) (temp___do_toplevel_701 Bool) (temp___do_typ_inv_702 Bool)) Bool (=> (or (= temp___is_init_699 true) (<= 1901 2099)) (in_range7 temp___expr_703)))
(define-fun dynamic_invariant12 ((temp___expr_710 Int) (temp___is_init_706 Bool) (temp___skip_constant_707 Bool) (temp___do_toplevel_708 Bool) (temp___do_typ_inv_709 Bool)) Bool (=> (or (= temp___is_init_706 true) (<= 1 12)) (in_range8 temp___expr_710)))
(define-fun dynamic_invariant13 ((temp___expr_717 Int) (temp___is_init_713 Bool) (temp___skip_constant_714 Bool) (temp___do_toplevel_715 Bool) (temp___do_typ_inv_716 Bool)) Bool (=> (or (= temp___is_init_713 true) (<= 1 31)) (in_range9 temp___expr_717)))
(define-fun dynamic_invariant14 ((temp___expr_749 Int) (temp___is_init_745 Bool) (temp___skip_constant_746 Bool) (temp___do_toplevel_747 Bool) (temp___do_typ_inv_748 Bool)) Bool (=> (or (= temp___is_init_745 true) (<= 0 86399999)) (in_range10 temp___expr_749)))
(define-fun dynamic_invariant15 ((temp___expr_1177 Int) (temp___is_init_1173 Bool) (temp___skip_constant_1174 Bool) (temp___do_toplevel_1175 Bool) (temp___do_typ_inv_1176 Bool)) Bool (=> (or (= temp___is_init_1173 true) (<= 0 2147483647)) (in_range19 temp___expr_1177)))
(define-fun dynamic_invariant16 ((temp___expr_1212 Int) (temp___is_init_1208 Bool) (temp___skip_constant_1209 Bool) (temp___do_toplevel_1210 Bool) (temp___do_typ_inv_1211 Bool)) Bool (=> (or (= temp___is_init_1208 true) (<= 0 4294967295)) (in_range21 temp___expr_1212)))
(define-fun dynamic_invariant17 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range2 temp___expr_402)))
(define-fun dynamic_invariant18 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range3 temp___expr_426)))
(define-fun dynamic_invariant19 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range16 temp___expr_450)))
(define-fun dynamic_invariant20 ((temp___expr_464 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool) (temp___do_typ_inv_463 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 4294967295)) (in_range17 temp___expr_464)))
(define-fun dynamic_invariant21 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 0 128)) (in_range18 temp___expr_471)))
(define-fun dynamic_invariant22 ((temp___expr_567 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool) (temp___do_typ_inv_566 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 0 4294967295)) (in_range4 temp___expr_567)))
(assert (forall ((temp___1345 Int)) (=> (dynamic_invariant5 temp___1345 true true true true) (forall ((temp___1346 Int)) (= (to_rep8 (select (temp___1343 temp___1345) temp___1346)) temp___1345)))))
