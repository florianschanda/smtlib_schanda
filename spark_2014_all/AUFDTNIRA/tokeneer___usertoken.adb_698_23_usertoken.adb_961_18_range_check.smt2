...
(declare-fun theid (us_rep3) us_rep2)
(declare-fun theid__function_guard (us_rep2 us_rep3) Bool)
(assert true)
...
(assert (forall ((x logfileindext)) (! (in_range10 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range11 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range12 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(define-fun bool_eq5 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep9 (select a temp___idx_175)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_175))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep9 (select a temp___idx_175)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
(declare-const dummy17 (Array Int logfileindext))
(declare-const value__size5 Int)
(declare-fun object__size5 ((Array Int logfileindext)) Int)
(declare-const value__component__size1 Int)
(declare-fun object__component__size1 ((Array Int logfileindext)) Int)
(declare-const value__alignment5 Int)
(declare-fun object__alignment5 ((Array Int logfileindext)) Int)
(assert (<= 0 value__size5))
(assert (forall ((a (Array Int logfileindext))) (<= 0 (object__size5 a))))
(assert (<= 0 value__component__size1))
(assert (forall ((a (Array Int logfileindext))) (<= 0 (object__component__size1 a))))
(assert (<= 0 value__alignment5))
(assert (forall ((a (Array Int logfileindext))) (<= 0 (object__alignment5 a))))
(declare-fun user_eq17 ((Array Int logfileindext) (Array Int logfileindext)) Bool)
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__auditlog__logfilelistt__list (Array Int logfileindext)) (rec__auditlog__logfilelistt__head logfileindext) (rec__auditlog__logfilelistt__lasti logfileindext) (rec__auditlog__logfilelistt__length logfilecountt)))))
(define-fun us_split_fields_List__projection ((a us_split_fields8)) (Array Int logfileindext) (rec__auditlog__logfilelistt__list a))
(define-fun us_split_fields_Head__projection ((a us_split_fields8)) logfileindext (rec__auditlog__logfilelistt__head a))
(define-fun us_split_fields_LastI__projection ((a us_split_fields8)) logfileindext (rec__auditlog__logfilelistt__lasti a))
(define-fun us_split_fields_Length__2__projection ((a us_split_fields8)) logfilecountt (rec__auditlog__logfilelistt__length a))
...
(define-fun bool_eq6 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (= (bool_eq5 (rec__auditlog__logfilelistt__list (us_split_fields9 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields9 b)) 1 17) true) (= (to_rep9 (rec__auditlog__logfilelistt__head (us_split_fields9 a))) (to_rep9 (rec__auditlog__logfilelistt__head (us_split_fields9 b))))) (= (to_rep9 (rec__auditlog__logfilelistt__lasti (us_split_fields9 a))) (to_rep9 (rec__auditlog__logfilelistt__lasti (us_split_fields9 b))))) (= (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields9 a))) (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields9 b))))) true false))
...
(declare-datatypes () ((logfilelistt__ref (mk_logfilelistt__ref (logfilelistt__content us_rep4)))))
(define-fun logfilelistt__ref___projection ((a logfilelistt__ref)) us_rep4 (logfilelistt__content a))
...
(assert (forall ((x fileentrycountt)) (! (in_range13 (to_rep12 x)) :pattern ((to_rep12 x)))))
(assert (forall ((x Int)) (! (=> (in_range13 x) (= (to_rep12 (of_rep12 x)) x)) :pattern ((to_rep12 (of_rep12 x))))))
...
(define-fun bool_eq7 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep12 (select a temp___idx_176)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_176))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep12 (select a temp___idx_176)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
(declare-const dummy20 (Array Int fileentrycountt))
(declare-const value__size7 Int)
(declare-fun object__size7 ((Array Int fileentrycountt)) Int)
(declare-const value__component__size2 Int)
(declare-fun object__component__size2 ((Array Int fileentrycountt)) Int)
(declare-const value__alignment7 Int)
(declare-fun object__alignment7 ((Array Int fileentrycountt)) Int)
(assert (<= 0 value__size7))
(assert (forall ((a (Array Int fileentrycountt))) (<= 0 (object__size7 a))))
(assert (<= 0 value__component__size2))
(assert (forall ((a (Array Int fileentrycountt))) (<= 0 (object__component__size2 a))))
(assert (<= 0 value__alignment7))
(assert (forall ((a (Array Int fileentrycountt))) (<= 0 (object__alignment7 a))))
(declare-fun user_eq20 ((Array Int fileentrycountt) (Array Int fileentrycountt)) Bool)
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__auditlog__logfilestatet__currentlogfile logfileindext) (rec__auditlog__logfilestatet__numberlogentries logentrycountt) (rec__auditlog__logfilestatet__usedlogfiles us_rep4) (rec__auditlog__logfilestatet__logfileentries (Array Int fileentrycountt))))))
(define-fun us_split_fields_CurrentLogFile__projection ((a us_split_fields10)) logfileindext (rec__auditlog__logfilestatet__currentlogfile a))
(define-fun us_split_fields_NumberLogEntries__projection ((a us_split_fields10)) logentrycountt (rec__auditlog__logfilestatet__numberlogentries a))
(define-fun us_split_fields_UsedLogFiles__projection ((a us_split_fields10)) us_rep4 (rec__auditlog__logfilestatet__usedlogfiles a))
(define-fun us_split_fields_LogFileEntries__projection ((a us_split_fields10)) (Array Int fileentrycountt) (rec__auditlog__logfilestatet__logfileentries a))
...
(define-fun bool_eq8 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (= (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 a))) (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 b)))) (= (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 a))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 b))))) (= (bool_eq6 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 b))) true)) (= (bool_eq7 (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 b)) 1 17) true)) true false))
...
(declare-datatypes () ((logfilestatet__ref (mk_logfilestatet__ref (logfilestatet__content us_rep5)))))
(define-fun logfilestatet__ref___projection ((a logfilestatet__ref)) us_rep5 (logfilestatet__content a))
...
(declare-datatypes () ((t__ref (mk_t__ref (t__content us_rep6)))))
(define-fun t__ref___projection ((a t__ref)) us_rep6 (t__content a))
(declare-datatypes () ((map__ref3 (mk_map__ref3 (map__content3 (Array Int us_rep6))))))
(declare-fun slide3 ((Array Int us_rep6) Int Int) (Array Int us_rep6))
(assert (forall ((a (Array Int us_rep6))) (forall ((first Int)) (! (= (slide3 a first first) a) :pattern ((slide3 a first first))))))
(assert (forall ((a (Array Int us_rep6))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide3 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide3 a old_first new_first) i))))))))
(define-fun bool_eq10 ((a (Array Int us_rep6)) (a__first Int) (a__last Int) (b (Array Int us_rep6)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq9 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true)))) true false))
(assert (forall ((a (Array Int us_rep6)) (b (Array Int us_rep6))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq9 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true))))))))
...
(declare-fun to_rep13 (filestatust) Int)
(declare-fun of_rep13 (Int) filestatust)
(assert (forall ((x filestatust)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x filestatust)) (! (in_range14 (to_rep13 x)) :pattern ((to_rep13 x)))))
(assert (forall ((x Int)) (! (=> (in_range14 x) (= (to_rep13 (of_rep13 x)) x)) :pattern ((to_rep13 (of_rep13 x))))))
...
(define-fun bool_eq11 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep13 (select a temp___idx_178)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_178))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep13 (select a temp___idx_178)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_178)))))))))))
...
(define-fun dynamic_invariant ((temp___expr_626 Int) (temp___is_init_622 Bool) (temp___skip_constant_623 Bool) (temp___do_toplevel_624 Bool) (temp___do_typ_inv_625 Bool)) Bool (=> (or (= temp___is_init_622 true) (<= 0 1)) (in_range15 temp___expr_626)))
(declare-fun valid_numberlogentries (Int Int us_rep4 (Array Int fileentrycountt)) Bool)
(declare-fun valid_numberlogentries__function_guard (Bool Int Int us_rep4 (Array Int fileentrycountt)) Bool)
...
(define-fun dynamic_invariant1 ((temp___expr_1330 us_rep5) (temp___is_init_1326 Bool) (temp___skip_constant_1327 Bool) (temp___do_toplevel_1328 Bool) (temp___do_typ_inv_1329 Bool)) Bool (=> (= temp___do_typ_inv_1329 true) (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___expr_1330))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___expr_1330))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___expr_1330)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___expr_1330))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1334 us_rep5) (temp___skip_top_level_1335 Bool)) Bool (and (and (and (= (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___expr_1334))) 1) (= (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___expr_1334))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___expr_1334)) (mk___rep4 (mk___split_fields4 (temp_____aggregate_def_1336 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___expr_1334)) (temp_____aggregate_def_1340 0))))
(define-fun type_invariant ((temp___1344 us_rep5)) Bool (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___1344))) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___1344))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___1344)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___1344))) true))
...
(declare-fun user_eq25 (keyidt keyidt) Bool)
(declare-const dummy25 keyidt)
...
(define-fun to_rep14 ((x keyidt)) Int (keyidtqtint x))
(declare-fun of_rep14 (Int) keyidt)
(assert (forall ((x keyidt)) (! (= (of_rep14 (to_rep14 x)) x) :pattern ((to_rep14 x)))))
(assert (forall ((x keyidt)) (! (in_range16 (to_rep14 x)) :pattern ((to_rep14 x)))))
(assert (forall ((x Int)) (! (=> (in_range16 x) (= (to_rep14 (of_rep14 x)) x)) :pattern ((to_rep14 (of_rep14 x))))))
...
(declare-fun user_eq26 (keylengtht keylengtht) Bool)
(declare-const dummy26 keylengtht)
...
(define-fun to_rep15 ((x keylengtht)) Int (keylengthtqtint x))
(declare-fun of_rep15 (Int) keylengtht)
(assert (forall ((x keylengtht)) (! (= (of_rep15 (to_rep15 x)) x) :pattern ((to_rep15 x)))))
(assert (forall ((x keylengtht)) (! (in_range17 (to_rep15 x)) :pattern ((to_rep15 x)))))
(assert (forall ((x Int)) (! (=> (in_range17 x) (= (to_rep15 (of_rep15 x)) x)) :pattern ((to_rep15 (of_rep15 x))))))
...
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__cert__id__contentst__id us_rep2) (rec__cert__id__contentst__notbefore us_rep) (rec__cert__id__contentst__notafter us_rep) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep1) (rec__cert__id__contentst__subjectpublickey us_rep7)))))
(define-fun us_split_fields_ID__4__projection ((a us_split_fields14)) us_rep2 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__2__projection ((a us_split_fields14)) us_rep (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__2__projection ((a us_split_fields14)) us_rep (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__2__projection ((a us_split_fields14)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields14)) us_rep1 (rec__cert__id__contentst__subject a))
...
(define-fun bool_eq13 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__id__contentst__id (us_split_fields15 a)) (rec__cert__id__contentst__id (us_split_fields15 b))) true) (= (bool_eq1 (rec__cert__id__contentst__notbefore (us_split_fields15 a)) (rec__cert__id__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq1 (rec__cert__id__contentst__notafter (us_split_fields15 a)) (rec__cert__id__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep8 (rec__cert__id__contentst__mechanism (us_split_fields15 a))) (to_rep8 (rec__cert__id__contentst__mechanism (us_split_fields15 b))))) (= (bool_eq2 (rec__cert__id__contentst__subject (us_split_fields15 a)) (rec__cert__id__contentst__subject (us_split_fields15 b))) true)) (= (bool_eq12 (rec__cert__id__contentst__subjectpublickey (us_split_fields15 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields15 b))) true)) true false))
...
(assert true)
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__cert__attr__contentst__id us_rep2) (rec__cert__attr__contentst__notbefore us_rep) (rec__cert__attr__contentst__notafter us_rep) (rec__cert__attr__contentst__mechanism algorithmt) (rec__cert__attr__contentst__basecertid us_rep2)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields16)) us_rep2 (rec__cert__attr__contentst__id a))
(define-fun us_split_fields_NotBefore__3__projection ((a us_split_fields16)) us_rep (rec__cert__attr__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__3__projection ((a us_split_fields16)) us_rep (rec__cert__attr__contentst__notafter a))
...
(define-fun us_split_fields_BaseCertID__projection ((a us_split_fields16)) us_rep2 (rec__cert__attr__contentst__basecertid a))
...
(define-fun bool_eq14 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (and (and (= (bool_eq3 (rec__cert__attr__contentst__id (us_split_fields17 a)) (rec__cert__attr__contentst__id (us_split_fields17 b))) true) (= (bool_eq1 (rec__cert__attr__contentst__notbefore (us_split_fields17 a)) (rec__cert__attr__contentst__notbefore (us_split_fields17 b))) true)) (= (bool_eq1 (rec__cert__attr__contentst__notafter (us_split_fields17 a)) (rec__cert__attr__contentst__notafter (us_split_fields17 b))) true)) (= (to_rep8 (rec__cert__attr__contentst__mechanism (us_split_fields17 a))) (to_rep8 (rec__cert__attr__contentst__mechanism (us_split_fields17 b))))) (= (bool_eq3 (rec__cert__attr__contentst__basecertid (us_split_fields17 a)) (rec__cert__attr__contentst__basecertid (us_split_fields17 b))) true)) true false))
...
(declare-fun user_eq29 (us_rep9 us_rep9) Bool)
(declare-const dummy29 us_rep9)
...
(declare-fun thebasecert (us_rep9) us_rep2)
(declare-fun thebasecert__function_guard (us_rep2 us_rep9) Bool)
(assert true)
(declare-sort fart 0)
...
(declare-fun user_eq30 (fart fart) Bool)
(declare-const dummy30 fart)
...
(define-fun to_rep16 ((x fart)) Int (fartqtint x))
(declare-fun of_rep16 (Int) fart)
(assert (forall ((x fart)) (! (= (of_rep16 (to_rep16 x)) x) :pattern ((to_rep16 x)))))
(assert (forall ((x fart)) (! (in_range18 (to_rep16 x)) :pattern ((to_rep16 x)))))
(assert (forall ((x Int)) (! (=> (in_range18 x) (= (to_rep16 (of_rep16 x)) x)) :pattern ((to_rep16 (of_rep16 x))))))
...
(declare-fun user_eq31 (bytet bytet) Bool)
(declare-const dummy31 bytet)
...
(define-fun to_rep17 ((x bytet)) Int (bytetqtint x))
(declare-fun of_rep17 (Int) bytet)
(assert (forall ((x bytet)) (! (= (of_rep17 (to_rep17 x)) x) :pattern ((to_rep17 x)))))
(assert (forall ((x bytet)) (! (in_range19 (to_rep17 x)) :pattern ((to_rep17 x)))))
(assert (forall ((x Int)) (! (=> (in_range19 x) (= (to_rep17 (of_rep17 x)) x)) :pattern ((to_rep17 (of_rep17 x))))))
...
(define-fun bool_eq15 ((a (Array Int bytet)) (a__first Int) (a__last Int) (b (Array Int bytet)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_167 Int)) (=> (and (<= a__first temp___idx_167) (<= temp___idx_167 a__last)) (= (to_rep17 (select a temp___idx_167)) (to_rep17 (select b (+ (- b__first a__first) temp___idx_167))))))) true false))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq15 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_167 Int)) (=> (and (<= a__first temp___idx_167) (<= temp___idx_167 a__last)) (= (to_rep17 (select a temp___idx_167)) (to_rep17 (select b (+ (- b__first a__first) temp___idx_167)))))))))))
(declare-const dummy32 (Array Int bytet))
...
(declare-fun user_eq32 ((Array Int bytet) (Array Int bytet)) Bool)
(declare-sort templatelengtht 0)
(declare-fun templatelengthtqtint (templatelengtht) Int)
(assert (forall ((i templatelengtht)) (and (<= 0 (templatelengthtqtint i)) (<= (templatelengthtqtint i) 4294967295))))
...
(declare-fun user_eq33 (templatelengtht templatelengtht) Bool)
(declare-const dummy33 templatelengtht)
...
(define-fun to_rep18 ((x templatelengtht)) Int (templatelengthtqtint x))
(declare-fun of_rep18 (Int) templatelengtht)
(assert (forall ((x templatelengtht)) (! (= (of_rep18 (to_rep18 x)) x) :pattern ((to_rep18 x)))))
(assert (forall ((x templatelengtht)) (! (in_range20 (to_rep18 x)) :pattern ((to_rep18 x)))))
(assert (forall ((x Int)) (! (=> (in_range20 x) (= (to_rep18 (of_rep18 x)) x)) :pattern ((to_rep18 (of_rep18 x))))))
(declare-const dummy34 (Array Int character))
...
(declare-fun user_eq34 ((Array Int character) (Array Int character)) Bool)
...
(declare-datatypes () ((us_split_fields20 (mk___split_fields10 (rec__cert__attr__ianda__contentst__id us_rep2) (rec__cert__attr__ianda__contentst__notbefore us_rep) (rec__cert__attr__ianda__contentst__notafter us_rep) (rec__cert__attr__ianda__contentst__mechanism algorithmt) (rec__cert__attr__ianda__contentst__basecertid us_rep2) (rec__cert__attr__ianda__contentst__template us_rep10)))))
(define-fun us_split_fields_ID__8__projection ((a us_split_fields20)) us_rep2 (rec__cert__attr__ianda__contentst__id a))
(define-fun us_split_fields_NotBefore__6__projection ((a us_split_fields20)) us_rep (rec__cert__attr__ianda__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__6__projection ((a us_split_fields20)) us_rep (rec__cert__attr__ianda__contentst__notafter a))
...
(define-fun us_split_fields_BaseCertID__4__projection ((a us_split_fields20)) us_rep2 (rec__cert__attr__ianda__contentst__basecertid a))
...
(define-fun bool_eq17 ((a us_rep11) (b us_rep11)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__attr__ianda__contentst__id (us_split_fields21 a)) (rec__cert__attr__ianda__contentst__id (us_split_fields21 b))) true) (= (bool_eq1 (rec__cert__attr__ianda__contentst__notbefore (us_split_fields21 a)) (rec__cert__attr__ianda__contentst__notbefore (us_split_fields21 b))) true)) (= (bool_eq1 (rec__cert__attr__ianda__contentst__notafter (us_split_fields21 a)) (rec__cert__attr__ianda__contentst__notafter (us_split_fields21 b))) true)) (= (to_rep8 (rec__cert__attr__ianda__contentst__mechanism (us_split_fields21 a))) (to_rep8 (rec__cert__attr__ianda__contentst__mechanism (us_split_fields21 b))))) (= (bool_eq3 (rec__cert__attr__ianda__contentst__basecertid (us_split_fields21 a)) (rec__cert__attr__ianda__contentst__basecertid (us_split_fields21 b))) true)) (= (bool_eq16 (rec__cert__attr__ianda__contentst__template (us_split_fields21 a)) (rec__cert__attr__ianda__contentst__template (us_split_fields21 b))) true)) true false))
...
(declare-fun cert_attr_ianda_to_cert (us_rep11) us_rep3)
(declare-fun cert_attr_ianda_to_cert__function_guard (us_rep3 us_rep11) Bool)
(assert true)
...
(define-fun in_range21 ((x Int)) Bool (and (<= 1 x) (<= x 150)))
...
(declare-fun user_eq37 (descriptioni descriptioni) Bool)
(declare-const dummy37 descriptioni)
...
(declare-fun temp___String_Literal_2942 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2942 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 2)) 38)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 3)) 65)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 5)) 67)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 10)) 102)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 17)) 78)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 21)) 67)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 22)) 117)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 24)) 114)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 26)) 110)) (= (to_rep (select (temp___String_Literal_2942 us_void_param) 27)) 116)) :pattern ((temp___String_Literal_2942 us_void_param)))))
(declare-fun temp___String_Literal_2947 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2947 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 2)) 38)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 3)) 65)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 5)) 67)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 10)) 102)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 17)) 78)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 18)) 111)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 19)) 116)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 21)) 86)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 22)) 101)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 23)) 114)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 24)) 105)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 25)) 102)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 26)) 105)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 27)) 97)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 28)) 98)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 29)) 108)) (= (to_rep (select (temp___String_Literal_2947 us_void_param) 30)) 101)) :pattern ((temp___String_Literal_2947 us_void_param)))))
(declare-fun temp___String_Literal_2952 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2952 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 2)) 38)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 3)) 65)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 5)) 67)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 7)) 114)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 10)) 102)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 12)) 99)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 16)) 32)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 17)) 66)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 18)) 97)) (= (to_rep (select (temp___String_Literal_2952 us_void_param) 19)) 100)) :pattern ((temp___String_Literal_2952 us_void_param)))))
...
(define-fun dynamic_invariant3 ((temp___expr_2407 Int) (temp___is_init_2403 Bool) (temp___skip_constant_2404 Bool) (temp___do_toplevel_2405 Bool) (temp___do_typ_inv_2406 Bool)) Bool (=> (or (= temp___is_init_2403 true) (<= 0 3)) (in_range22 temp___expr_2407)))
(define-fun dynamic_invariant4 ((temp___expr_1268 Int) (temp___is_init_1264 Bool) (temp___skip_constant_1265 Bool) (temp___do_toplevel_1266 Bool) (temp___do_typ_inv_1267 Bool)) Bool (=> (or (= temp___is_init_1264 true) (<= 0 17)) (in_range12 temp___expr_1268)))
(define-fun dynamic_invariant5 ((temp___expr_1275 Int) (temp___is_init_1271 Bool) (temp___skip_constant_1272 Bool) (temp___do_toplevel_1273 Bool) (temp___do_typ_inv_1274 Bool)) Bool (=> (or (= temp___is_init_1271 true) (<= 1 17)) (in_range10 temp___expr_1275)))
(define-fun dynamic_invariant6 ((temp___expr_1401 Int) (temp___is_init_1397 Bool) (temp___skip_constant_1398 Bool) (temp___do_toplevel_1399 Bool) (temp___do_typ_inv_1400 Bool)) Bool (=> (or (= temp___is_init_1397 true) (<= 0 2)) (in_range14 temp___expr_1401)))
(define-fun dynamic_invariant7 ((temp___expr_1282 Int) (temp___is_init_1278 Bool) (temp___skip_constant_1279 Bool) (temp___do_toplevel_1280 Bool) (temp___do_typ_inv_1281 Bool)) Bool (=> (or (= temp___is_init_1278 true) (<= 0 17408)) (in_range11 temp___expr_1282)))
(define-fun dynamic_invariant8 ((temp___expr_1313 Int) (temp___is_init_1309 Bool) (temp___skip_constant_1310 Bool) (temp___do_toplevel_1311 Bool) (temp___do_typ_inv_1312 Bool)) Bool (=> (or (= temp___is_init_1309 true) (<= 0 1024)) (in_range13 temp___expr_1313)))
(assert true)
(assert (forall ((currentlogfile Int) (numberlogentries Int)) (forall ((usedlogfiles us_rep4)) (forall ((logfileentries (Array Int fileentrycountt))) (! (= (= (valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries) true) (and (<= 1 (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields9 usedlogfiles)))) (= numberlogentries (+ (* (- (to_rep11 (rec__auditlog__logfilelistt__length (us_split_fields9 usedlogfiles))) 1) 1024) (to_rep12 (select logfileentries currentlogfile)))))) :pattern ((valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries)))))))
(declare-const rliteral2 fileentrycountt)
(assert (= (fileentrycounttqtint rliteral2) 0))
(assert (forall ((temp___1342 Int)) (=> (dynamic_invariant8 temp___1342 true true true true) (forall ((temp___1343 Int)) (= (select (temp_____aggregate_def_1340 temp___1342) temp___1343) rliteral2)))))
(define-fun dynamic_invariant9 ((temp___expr_651 Int) (temp___is_init_647 Bool) (temp___skip_constant_648 Bool) (temp___do_toplevel_649 Bool) (temp___do_typ_inv_650 Bool)) Bool (=> (or (= temp___is_init_647 true) (<= 1 150)) (in_range21 temp___expr_651)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___162 Int)) (=> (dynamic_invariant2 temp___162 true true true true) (forall ((temp___163 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___162) temp___163)) temp___162)))))
(define-fun dynamic_invariant10 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 255)) (in_range19 temp___expr_214)))
(define-fun dynamic_invariant11 ((temp___expr_703 Int) (temp___is_init_699 Bool) (temp___skip_constant_700 Bool) (temp___do_toplevel_701 Bool) (temp___do_typ_inv_702 Bool)) Bool (=> (or (= temp___is_init_699 true) (<= 1901 2099)) (in_range2 temp___expr_703)))
(define-fun dynamic_invariant12 ((temp___expr_710 Int) (temp___is_init_706 Bool) (temp___skip_constant_707 Bool) (temp___do_toplevel_708 Bool) (temp___do_typ_inv_709 Bool)) Bool (=> (or (= temp___is_init_706 true) (<= 1 12)) (in_range3 temp___expr_710)))
(define-fun dynamic_invariant13 ((temp___expr_717 Int) (temp___is_init_713 Bool) (temp___skip_constant_714 Bool) (temp___do_toplevel_715 Bool) (temp___do_typ_inv_716 Bool)) Bool (=> (or (= temp___is_init_713 true) (<= 1 31)) (in_range4 temp___expr_717)))
(define-fun dynamic_invariant14 ((temp___expr_749 Int) (temp___is_init_745 Bool) (temp___skip_constant_746 Bool) (temp___do_toplevel_747 Bool) (temp___do_typ_inv_748 Bool)) Bool (=> (or (= temp___is_init_745 true) (<= 0 86399999)) (in_range5 temp___expr_749)))
(define-fun dynamic_invariant15 ((temp___expr_1170 Int) (temp___is_init_1166 Bool) (temp___skip_constant_1167 Bool) (temp___do_toplevel_1168 Bool) (temp___do_typ_inv_1169 Bool)) Bool (=> (or (= temp___is_init_1166 true) (<= 0 2147483647)) (in_range18 temp___expr_1170)))
(define-fun dynamic_invariant16 ((temp___expr_1205 Int) (temp___is_init_1201 Bool) (temp___skip_constant_1202 Bool) (temp___do_toplevel_1203 Bool) (temp___do_typ_inv_1204 Bool)) Bool (=> (or (= temp___is_init_1201 true) (<= 0 4294967295)) (in_range20 temp___expr_1205)))
(define-fun dynamic_invariant17 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range6 temp___expr_402)))
(define-fun dynamic_invariant18 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range7 temp___expr_426)))
(define-fun dynamic_invariant19 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range9 temp___expr_450)))
(define-fun dynamic_invariant20 ((temp___expr_464 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool) (temp___do_typ_inv_463 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 4294967295)) (in_range16 temp___expr_464)))
(define-fun dynamic_invariant21 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 0 128)) (in_range17 temp___expr_471)))
(define-fun dynamic_invariant22 ((temp___expr_567 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool) (temp___do_typ_inv_566 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 0 4294967295)) (in_range8 temp___expr_567)))
(assert (forall ((temp___1338 Int)) (=> (dynamic_invariant5 temp___1338 true true true true) (forall ((temp___1339 Int)) (= (select (temp_____aggregate_def_1336 temp___1338) temp___1339) rliteral)))))
...
(declare-const logfiles (Array Int us_rep6))
...
(declare-const logfiles1 (Array Int us_rep6))
(declare-const logfilesstatus1 (Array Int filestatust))
(declare-const logfilestate__split_fields7 us_split_fields10)
...
(declare-const logfiles2 (Array Int us_rep6))
(declare-const logfilesstatus2 (Array Int filestatust))
(declare-const logfilestate__split_fields8 us_split_fields10)
...
(assert (= (valid_numberlogentries (to_rep9 logfilestate__split_fields) (to_rep10 logfilestate__split_fields1) (mk___rep4 (mk___split_fields4 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6) true))
(assert (in_range15 auditalarm))
(assert (= result (mk_bool__ref extractok)))
(assert (= extractok1 (distinct 0 0)))
(assert (= result1 (mk_bool__ref verified)))
(assert (= verified1 (distinct 0 0)))
(assert (= result2 (mk_bool__ref current)))
(assert (= current1 (distinct 0 0)))
(assert (= result3 (mk_bool__ref baseidmatches)))
(assert (= baseidmatches1 (distinct 0 0)))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= o4 (bool_eq3 o3 o2)))))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (and (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range15 auditalarm2)))))
...
(assert (=> (= certfound true) (=> (= extractok2 true) (= o7 (iscurrent o6 (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime))))))
...
(assert (=> (= certfound true) (=> (not (= extractok2 true)) (= logfilestate__split_fields8 (mk___split_fields5 logfilestate__split_fields logfilestate__split_fields1 (mk___rep4 (mk___split_fields4 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6)))))
...
(assert (=> (not (= certfound true)) (= logfilestate__split_fields8 (mk___split_fields5 logfilestate__split_fields logfilestate__split_fields1 (mk___rep4 (mk___split_fields4 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))))
