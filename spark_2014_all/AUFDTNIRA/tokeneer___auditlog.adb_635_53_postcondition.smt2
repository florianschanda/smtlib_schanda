...
(assert (not (= (to_rep1 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields14))) (to_rep1 logfilestate__split_fields))))
(check-sat)
(exit)
