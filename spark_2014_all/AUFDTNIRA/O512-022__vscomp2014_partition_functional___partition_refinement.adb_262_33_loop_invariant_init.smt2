...
(assert (<= 0 j6))
(assert (<= j6 (- (length1 (mk___rep5 p__split_discrs p__split_fields2)) 1)))
(declare-const k2 Int)
(assert (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) j6)))) k2))
(assert (<= k2 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) j6))))))
