...
(assert (=> (not (= closedok true)) (= temp___1755 (mk___t (temp___String_Literal_1754 Tuple0) (mk 1 29)))))
(assert (=> (not (= closedok true)) (dynamic_predicate temp___1755)))
(assert (=> (not (= closedok true)) (= o10 temp___1755)))
