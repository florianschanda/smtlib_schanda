...
(assert (=> (not (= closedok true)) (= temp___1535 (mk___t (temp___String_Literal_1534 Tuple0) (mk 1 29)))))
(assert (=> (not (= closedok true)) (dynamic_predicate temp___1535)))
(assert (=> (not (= closedok true)) (= o10 temp___1535)))
...
(assert (=> (= closedok true) (= description11 description8)))
(assert (=> (= closedok true) (= dataok10 dataok7)))
(assert (=> (= closedok true) (= description12 description9)))
(assert (=> (= closedok true) (= dataok11 dataok8)))
...
(assert (=> (not (= (bool__content dataok10) true)) (= thistisinfo__split_fields14 (mk___split_fields__ref3 thistisinfo__split_fields13))))
...
(assert (=> (= (bool__content dataok10) true) (= store12 store9)))
(assert (=> (= (bool__content dataok10) true) (= state21 state17)))
(assert (=> (= (bool__content dataok10) true) (= thistisinfo__split_fields14 thistisinfo__split_fields11)))
(assert (=> (= (bool__content dataok10) true) (= store13 store10)))
(assert (=> (= (bool__content dataok10) true) (= state22 state19)))
(assert (=> (= (bool__content dataok10) true) (= thistisinfo__split_fields15 thistisinfo__split_fields12)))
...
(assert (not (= (privatekeypresent (us_split_fields__content3 thistisinfo__split_fields16) (us_private__content state24)) true)))
(check-sat)
(exit)
