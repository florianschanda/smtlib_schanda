...
(assert (=> (not (= closedok true)) (= temp___1591 (mk___t (temp___String_Literal_1590 Tuple0) (mk 1 29)))))
(assert (=> (not (= closedok true)) (dynamic_predicate temp___1591)))
(assert (=> (not (= closedok true)) (= o10 temp___1591)))
