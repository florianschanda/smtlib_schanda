...
(define-fun dynamic_invariant ((temp___expr_307 us_t1) (temp___is_init_303 Bool) (temp___skip_constant_304 Bool) (temp___do_toplevel_305 Bool) (temp___do_typ_inv_306 Bool)) Bool (and (=> (not (= temp___skip_constant_304 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_307) (last3 temp___expr_307))) (=> (= temp___do_toplevel_305 true) (=> (= temp___is_init_303 true) (and (= (first3 temp___expr_307) 1) (<= 0 (last3 temp___expr_307)))))))
(define-fun dynamic_predicate ((temp___310 us_t1)) Bool (and (= (first3 temp___310) 1) (<= 0 (last3 temp___310))))
...
(define-fun dynamic_invariant1 ((temp___expr_480 Int) (temp___is_init_476 Bool) (temp___skip_constant_477 Bool) (temp___do_toplevel_478 Bool) (temp___do_typ_inv_479 Bool)) Bool (=> (or (= temp___is_init_476 true) (<= 0 1)) (in_range4 temp___expr_480)))
...
(declare-fun temp___1246 (Int) (Array Int logfileindext))
(declare-fun temp___1250 (Int) (Array Int fileentrycountt))
(define-fun dynamic_invariant2 ((temp___expr_1240 us_rep2) (temp___is_init_1236 Bool) (temp___skip_constant_1237 Bool) (temp___do_toplevel_1238 Bool) (temp___do_typ_inv_1239 Bool)) Bool (=> (= temp___do_typ_inv_1239 true) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1240))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1240))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1240)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1240))) true)))
(define-fun default_initial_assumption ((temp___expr_1244 us_rep2) (temp___skip_top_level_1245 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1244))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1244))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1244)) (mk___rep (mk___split_fields (temp___1246 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1244)) (temp___1250 0))))
(define-fun type_invariant ((temp___1254 us_rep2)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1254))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1254))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1254)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1254))) true))
...
(define-fun dynamic_invariant3 ((temp___expr_1484 Int) (temp___is_init_1480 Bool) (temp___skip_constant_1481 Bool) (temp___do_toplevel_1482 Bool) (temp___do_typ_inv_1483 Bool)) Bool (=> (or (= temp___is_init_1480 true) (<= 0 4294967295)) (in_range10 temp___expr_1484)))
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-fun temp___String_Literal_1643 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1643 us_void_param) 1)) 46) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 2)) 47)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 3)) 83)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 4)) 121)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 5)) 115)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 8)) 109)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 9)) 47)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 10)) 99)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 14)) 46)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 15)) 100)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 16)) 97)) (= (to_rep (select (temp___String_Literal_1643 us_void_param) 17)) 116)) :pattern ((temp___String_Literal_1643 us_void_param)))))
(declare-fun temp___String_Literal_1645 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1645 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 13)) 83)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 15)) 111)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 19)) 114)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 20)) 101)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 21)) 97)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 22)) 100)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 25)) 114)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 27)) 111)) (= (to_rep (select (temp___String_Literal_1645 us_void_param) 28)) 114)) :pattern ((temp___String_Literal_1645 us_void_param)))))
...
(define-fun dynamic_invariant8 ((temp___expr_1178 Int) (temp___is_init_1174 Bool) (temp___skip_constant_1175 Bool) (temp___do_toplevel_1176 Bool) (temp___do_typ_inv_1177 Bool)) Bool (=> (or (= temp___is_init_1174 true) (<= 0 17)) (in_range7 temp___expr_1178)))
(define-fun dynamic_invariant9 ((temp___expr_1185 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool) (temp___do_typ_inv_1184 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 1 17)) (in_range5 temp___expr_1185)))
(define-fun dynamic_invariant10 ((temp___expr_1311 Int) (temp___is_init_1307 Bool) (temp___skip_constant_1308 Bool) (temp___do_toplevel_1309 Bool) (temp___do_typ_inv_1310 Bool)) Bool (=> (or (= temp___is_init_1307 true) (<= 0 2)) (in_range9 temp___expr_1311)))
(define-fun dynamic_invariant11 ((temp___expr_1192 Int) (temp___is_init_1188 Bool) (temp___skip_constant_1189 Bool) (temp___do_toplevel_1190 Bool) (temp___do_typ_inv_1191 Bool)) Bool (=> (or (= temp___is_init_1188 true) (<= 0 17408)) (in_range6 temp___expr_1192)))
(define-fun dynamic_invariant12 ((temp___expr_1223 Int) (temp___is_init_1219 Bool) (temp___skip_constant_1220 Bool) (temp___do_toplevel_1221 Bool) (temp___do_typ_inv_1222 Bool)) Bool (=> (or (= temp___is_init_1219 true) (<= 0 1024)) (in_range8 temp___expr_1223)))
(assert true)
...
(assert (forall ((temp___1252 Int)) (=> (dynamic_invariant12 temp___1252 true true true true) (forall ((temp___1253 Int)) (= (to_rep5 (select (temp___1250 temp___1252) temp___1253)) temp___1252)))))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(assert (forall ((temp___1248 Int)) (=> (dynamic_invariant9 temp___1248 true true true true) (forall ((temp___1249 Int)) (= (to_rep2 (select (temp___1246 temp___1248) temp___1249)) temp___1248)))))
...
(declare-const temp___1644 (Array Int character))
(declare-const temp___16441 t1)
...
(assert (= (temp___String_Literal_1643 Tuple0) temp___1644))
(assert (= (mk1 1 17) temp___16441))
(assert (dynamic_predicate (mk___t1 temp___1644 temp___16441)))
(assert (= o temp___1644))
(assert (= o1 temp___16441))
