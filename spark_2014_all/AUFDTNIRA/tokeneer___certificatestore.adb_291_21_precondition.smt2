...
(define-fun dynamic_invariant ((temp___expr_271 us_t1) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (and (=> (not (= temp___skip_constant_269 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_271) (last3 temp___expr_271))) (=> (= temp___do_toplevel_270 true) (=> (= temp___is_init_268 true) (and (= (first3 temp___expr_271) 1) (<= 0 (last3 temp___expr_271)))))))
(define-fun dynamic_predicate ((temp___274 us_t1)) Bool (and (= (first3 temp___274) 1) (<= 0 (last3 temp___274))))
...
(define-fun dynamic_invariant1 ((temp___expr_429 Int) (temp___is_init_426 Bool) (temp___skip_constant_427 Bool) (temp___do_toplevel_428 Bool)) Bool (=> (or (= temp___is_init_426 true) (<= 0 1)) (in_range4 temp___expr_429)))
...
(declare-fun temp___1107 (Int) (Array Int logfileindext))
(assert (forall ((temp___1109 Int)) (forall ((temp___1110 Int)) (= (select (temp___1107 temp___1109) temp___1110) (of_rep2 temp___1109)))))
(declare-fun temp___1111 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1113 Int)) (forall ((temp___1114 Int)) (= (select (temp___1111 temp___1113) temp___1114) (of_rep5 temp___1113)))))
(define-fun dynamic_invariant2 ((temp___expr_1101 us_rep2) (temp___is_init_1098 Bool) (temp___skip_constant_1099 Bool) (temp___do_toplevel_1100 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1101))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1101))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1101)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1101))) true))
(define-fun default_initial_assumption ((temp___expr_1105 us_rep2) (temp___skip_top_level_1106 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1105))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1105))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1105)) (mk___rep (mk___split_fields (temp___1107 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1105)) (temp___1111 0))))
(define-fun type_invariant ((temp___1115 us_rep2)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1115))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1115))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1115)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1115))) true))
...
(define-fun dynamic_invariant3 ((temp___expr_1325 Int) (temp___is_init_1322 Bool) (temp___skip_constant_1323 Bool) (temp___do_toplevel_1324 Bool)) Bool (=> (or (= temp___is_init_1322 true) (<= 0 4294967295)) (in_range10 temp___expr_1325)))
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-fun temp___String_Literal_1475 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1475 us_void_param) 1)) 46) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 2)) 47)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 3)) 83)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 4)) 121)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 5)) 115)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 6)) 116)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 8)) 109)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 9)) 47)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 10)) 99)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 14)) 46)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 15)) 100)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 16)) 97)) (= (to_rep (select (temp___String_Literal_1475 us_void_param) 17)) 116)) :pattern ((temp___String_Literal_1475 us_void_param)))))
(declare-fun temp___String_Literal_1477 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1477 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 13)) 83)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 15)) 111)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 19)) 114)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 20)) 101)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 21)) 97)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 22)) 100)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 24)) 101)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 25)) 114)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 27)) 111)) (= (to_rep (select (temp___String_Literal_1477 us_void_param) 28)) 114)) :pattern ((temp___String_Literal_1477 us_void_param)))))
...
(define-fun dynamic_invariant8 ((temp___expr_1067 Int) (temp___is_init_1064 Bool) (temp___skip_constant_1065 Bool) (temp___do_toplevel_1066 Bool)) Bool (=> (or (= temp___is_init_1064 true) (<= 0 17)) (in_range7 temp___expr_1067)))
(define-fun dynamic_invariant9 ((temp___expr_1046 Int) (temp___is_init_1043 Bool) (temp___skip_constant_1044 Bool) (temp___do_toplevel_1045 Bool)) Bool (=> (or (= temp___is_init_1043 true) (<= 1 17)) (in_range5 temp___expr_1046)))
(define-fun dynamic_invariant10 ((temp___expr_1171 Int) (temp___is_init_1168 Bool) (temp___skip_constant_1169 Bool) (temp___do_toplevel_1170 Bool)) Bool (=> (or (= temp___is_init_1168 true) (<= 0 2)) (in_range9 temp___expr_1171)))
(define-fun dynamic_invariant11 ((temp___expr_1052 Int) (temp___is_init_1049 Bool) (temp___skip_constant_1050 Bool) (temp___do_toplevel_1051 Bool)) Bool (=> (or (= temp___is_init_1049 true) (<= 0 17408)) (in_range6 temp___expr_1052)))
(define-fun dynamic_invariant12 ((temp___expr_1086 Int) (temp___is_init_1083 Bool) (temp___skip_constant_1084 Bool) (temp___do_toplevel_1085 Bool)) Bool (=> (or (= temp___is_init_1083 true) (<= 0 1024)) (in_range8 temp___expr_1086)))
(assert true)
...
(declare-const nextserialnumber Int)
(declare-const temp___1476 (Array Int character))
(declare-const temp___14761 t1)
(declare-const o (Array Int character))
(declare-const o1 t1)
(declare-const storefile us_rep)
(declare-const result Bool)
(declare-const nextserialnumber1 Int)
(declare-const readok Bool)
(assert (= (temp___String_Literal_136 Tuple0) nouser))
(assert (=> (<= 0 4294967295) (in_range10 nextserialnumber)))
...
(assert (= (temp___String_Literal_1475 Tuple0) temp___1476))
(assert (= (mk1 1 17) temp___14761))
(assert (dynamic_predicate (mk___t1 temp___1476 temp___14761)))
(assert (= o temp___1476))
(assert (= o1 temp___14761))
(assert (= result (exists__ storefile)))
(assert (= result true))
(assert (in_range10 nextserialnumber1))
(assert (not (= readok true)))
(assert (not (= (to_rep1 (first (mk 1 28))) 1)))
(check-sat)
(exit)
