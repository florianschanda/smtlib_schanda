...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (and (and (not (= (let ((subject shutdowncompleted)) shutdowncompleted1) true)) (not (= (let ((subject systemfault)) systemfault1) true))) (= (not (= (enrolmentisinprogress status3 (let ((subject state4)) state15)) true)) (= (privatekeypresent thistisinfo__split_fields2 (let ((subject state)) state13)) true))) (=> (and (and (= (islocked currentlatch3 (let ((subject state2)) state16) latchtimeout__split_fields2) true) (= (thecurrentdoor (let ((subject state3)) state17)) 0)) (= (greaterthanorequal (thecurrenttime currenttimevar__split_fields (let ((subject currenttime)) currenttime1)) (alarm_timeout (let ((subject state3)) state17))) true)) (or (= (isalarming Tuple0) true) (= (let ((subject systemfault)) systemfault1) true)))) (or (= (= (islocked currentlatch3 (let ((subject state2)) state16) latchtimeout__split_fields2) true) (= (latchislocked Tuple0) true)) (= (let ((subject systemfault)) systemfault1) true))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 1) (and (and (= (isgood tokenpresence3 (let ((subject state1)) state14) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) true) (= (authcertvalid tokenpresence3 (let ((subject state1)) state14) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) true)) (= (theauthcertrole tokenpresence3 (let ((subject state1)) state14) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) 1)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 3)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 1))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 1) (or (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 3)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true))))) (=> (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 4)) (= (statusiswaitingstartadminop status3 (let ((subject state4)) state15)) true))) (=> (or (= (statusisgotadmintoken status3 (let ((subject state4)) state15)) true) (= (statusiswaitingremoveadmintokenfail status3 (let ((subject state4)) state15)) true)) (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)))) (=> (or (= (statusiswaitingstartadminop status3 (let ((subject state4)) state15)) true) (= (statusiswaitingfinishadminop status3 (let ((subject state4)) state15)) true)) (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true) (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)))) (=> (= (statusisenclavequiescent status3 (let ((subject state4)) state15)) true) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)))) (=> (= (statusisshutdown status3 (let ((subject state4)) state15)) true) (and (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 0)))) (=> (= (enrolmentisinprogress status3 (let ((subject state4)) state15)) true) (and (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true))))))
...
(assert (not (= (enrolmentisinprogress status3 (let ((subject state4)) state15)) true)))
(assert (not (= (privatekeypresent thistisinfo__split_fields2 (let ((subject state)) state13)) true)))
(check-sat)
(exit)
