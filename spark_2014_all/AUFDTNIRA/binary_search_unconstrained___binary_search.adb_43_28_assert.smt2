...
(define-fun dynamic_invariant1 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 1 2147483646)) (in_range3 temp___expr_142)))
...
(define-fun dynamic_invariant2 ((temp___expr_148 us_t) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (not (= temp___skip_constant_146 true)) (dynamic_property 1 2147483646 (first1 temp___expr_148) (last1 temp___expr_148))))
...
(assert (= (mk_int__ref result2) (mk_int__ref left)))
(assert (= left2 o))
(assert (and (= o1 (to_rep1 (last (rt a)))) (in_range3 (to_rep1 (last (rt a))))))
(assert (= (mk_int__ref result3) (mk_int__ref right)))
(assert (= right2 o1))
(assert (and (<= (to_rep1 (first (rt a))) left2) (<= left2 (to_rep1 (last (rt a))))))
(assert (= o2 left2))
(assert (= o3 (select (elts a) o2)))
(assert (= o4 (to_rep o3)))
(assert (= o5 (ite (= o4 i) true false)))
(assert (= result4 (ite (= left2 right2) o5 false)))
(assert (not (= result4 true)))
(assert (and (<= (to_rep1 (first (rt a))) right2) (<= right2 (to_rep1 (last (rt a))))))
(assert (= o9 right2))
...
(assert (= result6 (ite (= o13 false) o12 true)))
...
(assert (<= left2 right2))
(assert (and (and (<= (to_rep1 (first (rt a))) left3) (<= left3 (to_rep1 (last (rt a))))) (and (<= (to_rep1 (first (rt a))) right3) (<= right3 (to_rep1 (last (rt a)))))))
(assert (forall ((index4 Int)) (=> (and (<= (to_rep1 (first (rt a))) index4) (<= index4 (- left3 1))) (< (to_rep (select (elts a) index4)) i))))
(assert (forall ((index4 Int)) (=> (and (<= (to_rep1 (first (rt a))) index4) (<= index4 (to_rep1 (last (rt a))))) (=> (< right3 index4) (< i (to_rep (select (elts a) index4)))))))
(assert (and (and (and (=> (<= 1 2147483646) (in_range3 left3)) (=> (<= 1 2147483646) (in_range3 right3))) (=> (<= 1 2147483646) (in_range3 med2))) (<= left3 right3)))
(assert (= temp___1701 result8))
(assert (= temp___1702 (- right3 left3)))
(assert (and (= o14 (+ left3 (div1 (- right3 left3) 2))) (in_range2 (+ left3 (div1 (- right3 left3) 2)))))
(assert (and (= o15 o14) (in_range3 o14)))
(assert (= med2 result9))
(assert (= med3 o15))
(assert (forall ((i12 Int)) (=> (and (<= (to_rep1 (first (rt a))) i12) (<= i12 (to_rep1 (last (rt a))))) (forall ((i22 Int)) (=> (and (<= i12 i22) (<= i22 (to_rep1 (last (rt a))))) (<= (to_rep (select (elts a) i12)) (to_rep (select (elts a) i22))))))))
(assert (and (<= (to_rep1 (first (rt a))) med3) (<= med3 (to_rep1 (last (rt a))))))
(assert (= o19 med3))
(assert (= o20 (select (elts a) o19)))
(assert (= o21 (to_rep o20)))
(assert (= result10 (ite (< o21 i) true false)))
(assert (not (= result10 true)))
(assert (and (<= (to_rep1 (first (rt a))) med3) (<= med3 (to_rep1 (last (rt a))))))
(assert (= o27 med3))
(assert (= o28 (select (elts a) o27)))
(assert (= o29 (to_rep o28)))
(assert (= result12 (ite (< i o29) true false)))
(assert (= result12 true))
(assert (and (= o30 (- med3 1)) (in_range3 (- med3 1))))
(assert (= right3 result13))
(assert (= right4 o30))
(assert (not (<= (to_rep1 (first (rt a))) med3)))
(check-sat)
(exit)
