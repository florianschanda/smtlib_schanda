...
(assert (forall ((index1 Int)) (=> (and (<= (to_rep1 (first (rt a))) index1) (<= index1 (- left2 1))) (< (to_rep (select (elts a) index1)) i))))
(assert (forall ((index1 Int)) (=> (and (<= (to_rep1 (first (rt a))) index1) (<= index1 (to_rep1 (last (rt a))))) (=> (< right2 index1) (< i (to_rep (select (elts a) index1)))))))
(assert (and (and (and (=> (<= 1 2147483646) (in_range3 left2)) (=> (<= 1 2147483646) (in_range3 right2))) (=> (<= 1 2147483646) (in_range3 med1))) (<= left2 right2)))
(assert (= temp___196 result5))
(assert (= temp___1961 (- right2 left2)))
(assert (and (= o14 (+ left2 (div1 (- right2 left2) 2))) (in_range2 (+ left2 (div1 (- right2 left2) 2)))))
(assert (and (= o15 o14) (in_range3 o14)))
(assert (= med1 result6))
(assert (= med2 o15))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (forall ((i2 Int)) (=> (and (<= i1 i2) (<= i2 (to_rep1 (last (rt a))))) (<= (to_rep (select (elts a) i1)) (to_rep (select (elts a) i2))))))))
(assert (and (<= (to_rep1 (first (rt a))) med2) (<= med2 (to_rep1 (last (rt a))))))
(assert (= o16 med2))
...
(assert (= result8 (ite (< i o21) true false)))
(assert (= result8 true))
(assert (and (= o22 (- med2 1)) (in_range3 (- med2 1))))
(assert (= right2 result9))
(assert (= right3 o22))
(assert (not (<= med2 (to_rep1 (last (rt a))))))
(check-sat)
(exit)
