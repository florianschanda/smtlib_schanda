...
(assert (=> (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b))))))) (and (and (= temp___1524 (let ((subject i1)) i13)) (and (= temp___1522 (mk___rep4 (let ((subject result____split_fields)) result____split_fields15))) (and (= temp___1525 c37b) (and (and (and (and (<= 1 (let ((subject i1)) i14)) (<= (let ((subject i1)) i14) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b))))))) (= (bool_eq10 c37b temp___1525) true)) (= (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))) (+ (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c37b))))) 3))) (and (and (and (= (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16)) (rec__display__scrollstrt__len (us_split_fields9 temp___1522))) (=> (<= 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))) (dynamic_property2 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b))))) (let ((subject i1)) i14)))) (and (<= 1 (let ((subject i1)) i14)) (<= (let ((subject i1)) i14) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))))) (and (and (and (and (and (= (to_rep o74) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))) (let ((subject i1)) i14)))) (and (and (and (= temp___1519 (+ (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))) (let ((subject i1)) i14))) (in_range1 (+ (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))) (let ((subject i1)) i14)))) (and (and (<= 1 temp___1519) (<= temp___1519 50)) (= o75 temp___1519))) (= o76 (store (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields16)) o75 o74)))) (= o77 (mk___split_fields4 o76 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))))) (= temp___1521 (mk___rep4 o77))) (and (= result13 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields16))) (= (let ((subject result____split_fields)) result____split_fields17) (us_split_fields9 temp___1521)))) (= (let ((subject i1)) i14) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))))))))) (and (and (= i20 (let ((subject i1)) (mk_int__ref i14))) (= result____split_fields22 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields17)))) (and (= i21 i14) (= result____split_fields23 result____split_fields17))))))
(assert (=> (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b))))))) (= i22 i20)))
(assert (=> (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b))))))) (= result____split_fields24 result____split_fields22)))
(assert (=> (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b))))))) (= i23 i21)))
(assert (=> (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b))))))) (= result____split_fields25 result____split_fields23)))
(assert (=> (not (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))))) (= i22 (let ((subject i1)) (mk_int__ref i13)))))
(assert (=> (not (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))))) (= result____split_fields24 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields15)))))
(assert (=> (not (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))))) (= i23 i13)))
(assert (=> (not (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))))) (= result____split_fields25 result____split_fields15)))
(assert (not (in_range13 (+ (to_rep9 (rec__display__scrollstrt__len (us_split_fields__content4 result____split_fields24))) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c37b)))))))))
(check-sat)
(exit)
