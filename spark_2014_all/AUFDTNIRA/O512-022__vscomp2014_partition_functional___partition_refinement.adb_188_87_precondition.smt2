...
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields7)) k7))
(assert (<= k7 (to_rep1 (rec__partition_refinement__interval__last p_elem__split_fields7))))
(assert (and (<= 0 k7) (<= k7 5)))
(assert (= o82 k7))
(assert (= o83 (select (map__content f8) o82)))
