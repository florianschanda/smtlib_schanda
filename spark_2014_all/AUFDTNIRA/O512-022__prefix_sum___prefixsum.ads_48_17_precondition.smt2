...
(assert (and (= result (all_elements_in ghost__ 1000000)) (= (= result true) (forall ((k Int)) (=> (and (<= 0 k) (<= k 7)) (and (<= (- 1000000) (to_rep (select ghost__ k))) (<= (to_rep (select ghost__ k)) 1000000)))))))
(assert (= result true))
(assert (and (= result1 (all_elements_in a 8000000)) (= (= result1 true) (forall ((k Int)) (=> (and (<= 0 k) (<= k 7)) (and (<= (- 8000000) (to_rep (select a k))) (<= (to_rep (select a k)) 8000000)))))))
(assert (= result1 true))
(assert (= input_space 8))
(assert (not (= (all_elements_in ghost__ 1000000) true)))
(check-sat)
(exit)
