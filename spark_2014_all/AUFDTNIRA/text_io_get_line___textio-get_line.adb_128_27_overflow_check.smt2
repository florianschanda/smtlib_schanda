...
(assert (ite (= (= (- n 1) 0) true) (= (bool_eq item1 (to_rep1 item__first) (to_rep1 item__last) item (to_rep1 item__first) (to_rep1 item__last)) true) (=> (= (not (= (- n 1) 0)) true) (forall ((idx Int)) (=> (and (<= (to_rep1 item__first) idx) (<= idx (to_rep1 item__last))) (ite (and (<= o7 idx) (<= idx (- (+ o7 (- n 1)) 1))) (= (to_rep (select item1 idx)) (to_rep (select buf3 (+ (- idx o7) 1)))) (= (to_rep (select item1 idx)) (to_rep (select item idx)))))))))
