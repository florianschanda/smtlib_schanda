...
(assert (forall ((k Int)) (=> (and (<= 0 k) (<= k (- j2 1))) (forall ((l1 Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) k)))) l1) (<= l1 (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs p__split_fields3)) k)))))) (= (to_rep3 (select (map__content f6) l1)) k))))))
(assert (and (= o12 j2) (in_range9 j2)))
(assert (and (= o13 (get (model__ (mk___rep p__split_discrs p__split_fields3)) o12)) (= (bool_eq o13 (get (model__ (mk___rep p__split_discrs p__split_fields3)) o12)) true)))
(assert (= o14 (us_split_fields3 o13)))
(assert (= o15 (rec__partition_refinement__interval__last o14)))
(assert (= o16 (to_rep2 o15)))
(assert (= o17 (ite (<= l o16) true false)))
(assert (and (= o11 j2) (in_range9 j2)))
(assert (not (<= o11 (last (model__ (mk___rep p__split_discrs p__split_fields3))))))
(check-sat)
(exit)
