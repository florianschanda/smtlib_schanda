...
(assert (and (= result4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result4 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result4 true))
