...
(assert (and (= o41 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o41 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= o42 (ite (not (= o41 true)) true false)))
(assert (and (= result14 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result14 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
