...
(define-fun dynamic_invariant ((temp___expr_407 Int) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool)) Bool (=> (or (= temp___is_init_404 true) (<= 0 864000)) (in_range4 temp___expr_407)))
...
(define-fun dynamic_invariant2 ((temp___expr_542 Int) (temp___is_init_539 Bool) (temp___skip_constant_540 Bool) (temp___do_toplevel_541 Bool)) Bool (=> (or (= temp___is_init_539 true) (<= 0 4194304)) (in_range6 temp___expr_542)))
...
(define-fun dynamic_invariant3 ((temp___expr_962 Int) (temp___is_init_959 Bool) (temp___skip_constant_960 Bool) (temp___do_toplevel_961 Bool)) Bool (=> (or (= temp___is_init_959 true) (<= 0 2147483647)) (in_range7 temp___expr_962)))
...
(define-fun dynamic_invariant4 ((temp___expr_1030 Int) (temp___is_init_1027 Bool) (temp___skip_constant_1028 Bool) (temp___do_toplevel_1029 Bool)) Bool (=> (or (= temp___is_init_1027 true) (<= 0 2000)) (in_range8 temp___expr_1030)))
...
(define-fun dynamic_invariant5 ((temp___expr_1040 Int) (temp___is_init_1037 Bool) (temp___skip_constant_1038 Bool) (temp___do_toplevel_1039 Bool)) Bool (=> (or (= temp___is_init_1037 true) (<= 0 1)) (in_range9 temp___expr_1040)))
...
(declare-fun temp___String_Literal_1346 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_1346 us_void_param) 1)) 48) (= (to_rep (select (temp___String_Literal_1346 us_void_param) 2)) 48)) (= (to_rep (select (temp___String_Literal_1346 us_void_param) 3)) 58)) (= (to_rep (select (temp___String_Literal_1346 us_void_param) 4)) 48)) (= (to_rep (select (temp___String_Literal_1346 us_void_param) 5)) 48)) :pattern ((temp___String_Literal_1346 us_void_param)))))
(declare-fun temp___String_Literal_1347 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_1347 us_void_param) 1)) 48) (= (to_rep (select (temp___String_Literal_1347 us_void_param) 2)) 48)) (= (to_rep (select (temp___String_Literal_1347 us_void_param) 3)) 58)) (= (to_rep (select (temp___String_Literal_1347 us_void_param) 4)) 48)) (= (to_rep (select (temp___String_Literal_1347 us_void_param) 5)) 48)) :pattern ((temp___String_Literal_1347 us_void_param)))))
(declare-fun temp___String_Literal_1348 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (= (to_rep (select (temp___String_Literal_1348 us_void_param) 1)) 48) (= (to_rep (select (temp___String_Literal_1348 us_void_param) 2)) 48)) (= (to_rep (select (temp___String_Literal_1348 us_void_param) 3)) 58)) (= (to_rep (select (temp___String_Literal_1348 us_void_param) 4)) 48)) (= (to_rep (select (temp___String_Literal_1348 us_void_param) 5)) 48)) :pattern ((temp___String_Literal_1348 us_void_param)))))
...
(define-fun dynamic_invariant10 ((temp___expr_1050 Int) (temp___is_init_1047 Bool) (temp___skip_constant_1048 Bool) (temp___do_toplevel_1049 Bool)) Bool (=> (or (= temp___is_init_1047 true) (<= 1 20)) (in_range10 temp___expr_1050)))
(define-fun dynamic_invariant11 ((temp___expr_1065 Int) (temp___is_init_1062 Bool) (temp___skip_constant_1063 Bool) (temp___do_toplevel_1064 Bool)) Bool (=> (or (= temp___is_init_1062 true) (<= 1 20)) (in_range11 temp___expr_1065)))
(define-fun dynamic_invariant12 ((temp___expr_1080 Int) (temp___is_init_1077 Bool) (temp___skip_constant_1078 Bool) (temp___do_toplevel_1079 Bool)) Bool (=> (or (= temp___is_init_1077 true) (<= 1 21)) (in_range12 temp___expr_1080)))
(define-fun dynamic_invariant13 ((temp___expr_1095 Int) (temp___is_init_1092 Bool) (temp___skip_constant_1093 Bool) (temp___do_toplevel_1094 Bool)) Bool (=> (or (= temp___is_init_1092 true) (<= 1 19)) (in_range13 temp___expr_1095)))
(define-fun dynamic_invariant14 ((temp___expr_1110 Int) (temp___is_init_1107 Bool) (temp___skip_constant_1108 Bool) (temp___do_toplevel_1109 Bool)) Bool (=> (or (= temp___is_init_1107 true) (<= 1 17)) (in_range14 temp___expr_1110)))
(define-fun dynamic_invariant15 ((temp___expr_1125 Int) (temp___is_init_1122 Bool) (temp___skip_constant_1123 Bool) (temp___do_toplevel_1124 Bool)) Bool (=> (or (= temp___is_init_1122 true) (<= 1 18)) (in_range15 temp___expr_1125)))
(define-fun dynamic_invariant16 ((temp___expr_1140 Int) (temp___is_init_1137 Bool) (temp___skip_constant_1138 Bool) (temp___do_toplevel_1139 Bool)) Bool (=> (or (= temp___is_init_1137 true) (<= 1 16)) (in_range16 temp___expr_1140)))
(define-fun dynamic_invariant17 ((temp___expr_1155 Int) (temp___is_init_1152 Bool) (temp___skip_constant_1153 Bool) (temp___do_toplevel_1154 Bool)) Bool (=> (or (= temp___is_init_1152 true) (<= 1 16)) (in_range17 temp___expr_1155)))
(define-fun dynamic_invariant18 ((temp___expr_1170 Int) (temp___is_init_1167 Bool) (temp___skip_constant_1168 Bool) (temp___do_toplevel_1169 Bool)) Bool (=> (or (= temp___is_init_1167 true) (<= 1 14)) (in_range18 temp___expr_1170)))
(define-fun dynamic_invariant19 ((temp___expr_1185 Int) (temp___is_init_1182 Bool) (temp___skip_constant_1183 Bool) (temp___do_toplevel_1184 Bool)) Bool (=> (or (= temp___is_init_1182 true) (<= 1 13)) (in_range19 temp___expr_1185)))
(define-fun dynamic_invariant20 ((temp___expr_1200 Int) (temp___is_init_1197 Bool) (temp___skip_constant_1198 Bool) (temp___do_toplevel_1199 Bool)) Bool (=> (or (= temp___is_init_1197 true) (<= 1 20)) (in_range20 temp___expr_1200)))
(define-fun dynamic_invariant21 ((temp___expr_1215 Int) (temp___is_init_1212 Bool) (temp___skip_constant_1213 Bool) (temp___do_toplevel_1214 Bool)) Bool (=> (or (= temp___is_init_1212 true) (<= 1 19)) (in_range21 temp___expr_1215)))
(define-fun dynamic_invariant22 ((temp___expr_1230 Int) (temp___is_init_1227 Bool) (temp___skip_constant_1228 Bool) (temp___do_toplevel_1229 Bool)) Bool (=> (or (= temp___is_init_1227 true) (<= 1 13)) (in_range22 temp___expr_1230)))
...
(define-fun dynamic_invariant23 ((temp___expr_1245 Int) (temp___is_init_1242 Bool) (temp___skip_constant_1243 Bool) (temp___do_toplevel_1244 Bool)) Bool (=> (or (= temp___is_init_1242 true) (<= 1 12)) (in_range23 temp___expr_1245)))
...
(define-fun dynamic_invariant24 ((temp___expr_1285 Int) (temp___is_init_1282 Bool) (temp___skip_constant_1283 Bool) (temp___do_toplevel_1284 Bool)) Bool (=> (or (= temp___is_init_1282 true) (<= 1 12)) (in_range24 temp___expr_1285)))
...
(define-fun dynamic_invariant25 ((temp___expr_1325 Int) (temp___is_init_1322 Bool) (temp___skip_constant_1323 Bool) (temp___do_toplevel_1324 Bool)) Bool (=> (or (= temp___is_init_1322 true) (<= 1 5)) (in_range25 temp___expr_1325)))
...
(declare-const temp___1363 (Array Int us_rep2))
...
(assert (= temp___1362 (configdata__classstringlookup__aggregate_def o25 o24 o23 o22 (mk___rep (mk___split_fields o20 o21)) (mk___rep (mk___split_fields o18 o19)))))
(assert (= temp___1362 classstringlookup))
...
(assert (= temp___1363 (configdata__accessstringlookup__aggregate_def o31 o30)))
(assert (= temp___1363 accessstringlookup))
...
(assert (= localtext3 (temp___String_Literal_1346 Tuple0)))
...
(assert (= localtext8 (temp___String_Literal_1347 Tuple0)))
...
(assert (= localtext13 (temp___String_Literal_1348 Tuple0)))
...
(assert (= result21 (mk_int__ref localvalue7)))
(assert (= localvalue8 (div1 (mod2 c48b 36000) 600)))
(assert (and (= o57 (+ 48 (div1 localvalue8 10))) (in_range3 (+ 48 (div1 localvalue8 10)))))
(assert (= (to_rep o58) o57))
(assert (= o59 (store localtext15 4 o58)))
(assert (= result22 (mk_map__ref localtext15)))
(assert (= localtext16 o59))
(assert (= (to_rep o60) (+ 48 (mod2 localvalue8 10))))
(assert (= o61 (store localtext16 5 o60)))
(assert (= result23 (mk_map__ref localtext16)))
(assert (= localtext17 o61))
(assert (= result24 (mk_map__ref c49b)))
(assert (= c49b1 localtext17))
