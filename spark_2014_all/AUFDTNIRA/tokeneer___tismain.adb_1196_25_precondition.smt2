...
(assert (=> (= result true) (and (= o21 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o21 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result true) (= o22 (ite (not (= o21 true)) true false))))
(assert (=> (= result true) (and (= o20 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o20 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3))))))))
...
(assert (=> (= result1 true) (and (= o16 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (and (in_range2 o16) (= o16 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result1 true) (= o17 (ite (= o16 0) true false))))
(assert (=> (= result1 true) (and (= o15 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o15 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
...
(assert (=> (= result2 true) (and (= o13 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o13 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
...
(assert (=> (= result3 true) (and (= o8 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (and (in_range2 o8) (= o8 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result3 true) (and (= o9 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (and (in_range2 o9) (= o9 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result3 true) (= o10 (ite (= o9 o8) true false))))
(assert (=> (= result3 true) (and (= o6 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o6 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result3 true) (and (= o7 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o7 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
...
(assert (=> (= result4 true) (and (= o2 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o2 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result4 true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (not (= result4 true)) (= o3 (distinct 1 0))))
(assert (and (= result5 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result5 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
(assert (= result5 true))
