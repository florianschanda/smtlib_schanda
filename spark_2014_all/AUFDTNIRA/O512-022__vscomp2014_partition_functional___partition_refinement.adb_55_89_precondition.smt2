...
(define-fun o19 () us_rep (mk___rep (mk___split_fields o5 o6 o7)))
(assert (and (= o17 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o17) (= o17 (ite (= (distinct 1 0) true) (to_rep3 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o15 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o15) (<= o15 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
(assert (= o16 (* 2 o15)))
(assert (and (= o18 o16) (in_range1 o16)))
...
(assert (= result4 true))
(assert (and (= o4 j) (in_range8 j)))
(assert (and (= o19 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) o4)) (= (bool_eq o19 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) o4)) true)))
(assert (= o5 o8))
(assert (= o6 o9))
(assert (= o7 o10))
(assert (= o11 o9))
