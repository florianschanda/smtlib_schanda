...
(assert (<= 0 k13))
(assert (<= k13 (- j6 1)))
(assert (and (= o147 k13) (in_range8 k13)))
(assert (and (= o148 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o147)) (= (bool_eq o148 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o147)) true)))
(assert (= o149 (us_split_fields1 o148)))
(assert (= o150 (rec__partition_refinement__interval__last o149)))
(assert (= o151 (to_rep1 o150)))
(assert (= o152 (ite (<= l o151) true false)))
(assert (and (= o142 k13) (in_range8 k13)))
(assert (and (= o143 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o142)) (= (bool_eq o143 (get (model__ (mk___rep1 p__split_discrs p__split_fields4)) o142)) true)))
(assert (= o144 (us_split_fields1 o143)))
(assert (= o145 (rec__partition_refinement__interval__first o144)))
(assert (= o146 (to_rep1 o145)))
(assert (= o153 (ite (<= o146 l) true false)))
(assert (= result19 (ite (= o153 true) o152 false)))
