...
(assert (<= 1 (let ((subject i)) i4)))
(assert (<= (let ((subject i)) i4) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b)))))))
(assert (not (<= 1 (let ((subject i)) i4))))
(check-sat)
(exit)
