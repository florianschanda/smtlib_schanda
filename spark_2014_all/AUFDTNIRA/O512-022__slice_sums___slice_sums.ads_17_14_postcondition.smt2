...
(assert (not (<= (extended_indexqtint (rec__sums__slice_bounds__hi (us_split_fields1 (slice_bounds__content slice_sums__maximal_sum_slice_bounds_2__result5)))) (to_rep (last (rt x))))))
(check-sat)
(exit)
