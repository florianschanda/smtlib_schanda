...
(define-fun tint_arrayD1__ref___21__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___21__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t686b__ref (mk_t686b__ref (t686b__content integer)))))
(define-fun t686b__ref___projection ((a t686b__ref)) integer (t686b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t687b__ref (mk_t687b__ref (t687b__content us_t2)))))
(define-fun t687b__ref___projection ((a t687b__ref)) us_t2 (t687b__content a))
...
(define-fun tnumber_array_typeD1__ref___30__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___30__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t690b__ref (mk_t690b__ref (t690b__content integer)))))
(define-fun t690b__ref___projection ((a t690b__ref)) integer (t690b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t691b__ref (mk_t691b__ref (t691b__content us_t4)))))
(define-fun t691b__ref___projection ((a t691b__ref)) us_t4 (t691b__content a))
...
(declare-datatypes () ((t692b__ref (mk_t692b__ref (t692b__content integer)))))
(define-fun t692b__ref___projection ((a t692b__ref)) integer (t692b__content a))
...
(define-fun tint_arrayB__ref___21__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___2254 Int) (temp___2255 Int) (temp___2256 Int) (temp___2257 Int) (temp___2258 Int) (temp___2259 Int) (temp___2260 Int) (temp___2261 Int) (temp___2262 Int)) (let ((temp___2253 (aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def temp___2254 temp___2255 temp___2256 temp___2257 temp___2258 temp___2259 temp___2260 temp___2261 temp___2262))) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 7) temp___2261 temp___2262) (and (= (first5 temp___2253) temp___2261) (= (last5 temp___2253) temp___2262))) (and (and (and (and (and (and (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 0)) (of_rep1 temp___2254)) (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 1)) (of_rep1 temp___2255))) (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 2)) (of_rep1 temp___2256))) (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 3)) (of_rep1 temp___2257))) (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 4)) (of_rep1 temp___2258))) (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 5)) (of_rep1 temp___2259))) (= (select (to_array2 temp___2253) (+ (+ (first1 source) 1) 6)) (of_rep1 temp___2260)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___30__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_length_8__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___2268 Int) (temp___2269 Int) (temp___2270 Int)) (let ((temp___2267 (aida__conversion__calculate_negative_target_length_8__n__aggregate_def temp___2268 temp___2269 temp___2270))) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 7) temp___2269 temp___2270) (and (= (first9 temp___2267) temp___2269) (= (last9 temp___2267) temp___2270))) (forall ((temp___2271 Int)) (= (select (to_array4 temp___2267) temp___2271) (of_rep1 temp___2268)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_725 us_t3) (temp___is_init_722 Bool) (temp___skip_constant_723 Bool) (temp___do_toplevel_724 Bool)) Bool (=> (not (= temp___skip_constant_723 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 7) (first7 temp___expr_725) (last7 temp___expr_725)) (and (= (first7 temp___expr_725) (+ (first1 source) 1)) (= (last7 temp___expr_725) (+ (first1 source) 7))))))
...
(declare-const temp___2265 (Array Int integer))
(declare-const temp___22651 t2)
(declare-const aida__conversion__calculate_negative_target_length_8__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_length_8__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___2273 (Array Int integer))
(declare-const temp___22731 t4)
(declare-const aida__conversion__calculate_negative_target_length_8__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_length_8__n__assume1 t3)
(declare-const us2 Int)
(declare-const us3 Int)
(declare-const temp___2279 Int)
(declare-const temp___2280 Int)
(declare-const temp___2278 Int)
(declare-const temp___2276 (Array Int integer))
...
(assert (and (= (length source) 8) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index11) (<= index11 (+ (to_rep1 (first (rt source))) 7))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 6))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 6))))) (+ (+ (to_rep1 (first (rt source))) 1) 6)))
(assert (= (mk___t2 temp___2265 temp___22651) (aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 6))))
(assert (= (ite (<= (to_rep1 (first4 temp___22651)) (to_rep1 (last4 temp___22651))) (+ (- (to_rep1 (last4 temp___22651)) (to_rep1 (first4 temp___22651))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) (+ (- (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2265 (to_rep1 (first4 temp___22651)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_8__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) aida__conversion__calculate_negative_target_length_8__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_length_8__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_length_8__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_length_8__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 7)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_length_8__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_length_8__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7))))) (+ (to_rep1 (first (rt source))) 7)))
(assert (= (mk___t4 temp___2273 temp___22731) (aida__conversion__calculate_negative_target_length_8__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7))))
(assert (= (ite (<= (to_rep1 (first8 temp___22731)) (to_rep1 (last8 temp___22731))) (+ (- (to_rep1 (last8 temp___22731)) (to_rep1 (first8 temp___22731))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) (+ (- (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2273 (to_rep1 (first8 temp___22731)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_8__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) aida__conversion__calculate_negative_target_length_8__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_length_8__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_length_8__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_length_8__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 7)))))
(assert (and (= temp___2279 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2280 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___2279))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= temp___2278 index2)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= temp___2276 n1)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= o5 index2)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= o6 (select n1 o5))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= o7 (to_rep1 o6))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= o7 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= o8 index2)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= o9 (select (elts source) o8))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= o10 (to_rep o9))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o10))) (ite (= (= o10 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o10 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o10 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o10 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o10 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o10 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o10 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o10 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o10 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o10 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= (to_rep1 o11) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= o12 index2)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= o13 (store n1 o12 o11))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= n1 result4)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= n2 o13)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (and (and (forall ((temp___2277 Int)) (=> (and (<= (to_rep1 n__first) temp___2277) (<= temp___2277 (to_rep1 n__last))) (=> (< index3 temp___2277) (= (select n3 temp___2277) (select temp___2276 temp___2277))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7) index3))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 7))))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= index3 temp___2280)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= index3 index5)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= n3 n5)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= index6 index3)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= n6 n3)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= index8 index6)))
(assert (=> (and (<= temp___2279 index2) (<= index2 temp___2280)) (= n8 n6)))
(assert (=> (not (and (<= temp___2279 index2) (<= index2 temp___2280))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___2279 index2) (<= index2 temp___2280))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2279 index2) (<= index2 temp___2280))) (= index8 index2)))
(assert (=> (not (and (<= temp___2279 index2) (<= index2 temp___2280))) (= n8 n1)))
...
(assert (and (= temp___2281 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2281) (<= temp___2281 (to_rep1 n__last))))
(assert (= o41 temp___2281))
...
(assert (= target1 o45))
(assert (<= (- 9) target1))
(assert (and (= temp___2282 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2282) (<= temp___2282 (to_rep1 n__last))))
(assert (= o46 temp___2282))
...
(assert (= target2 o52))
(assert (<= (- 99) target2))
(assert (and (= temp___2283 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2283) (<= temp___2283 (to_rep1 n__last))))
(assert (= o53 temp___2283))
...
(assert (= target3 o59))
(assert (<= (- 999) target3))
(assert (and (= temp___2284 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2284) (<= temp___2284 (to_rep1 n__last))))
(assert (= o60 temp___2284))
...
(assert (= target4 o66))
(assert (<= (- 9999) target4))
(assert (and (= temp___2285 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2285) (<= temp___2285 (to_rep1 n__last))))
(assert (= o67 temp___2285))
...
(assert (and (= temp___2286 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2286) (<= temp___2286 (to_rep1 n__last))))
(assert (= o74 temp___2286))
