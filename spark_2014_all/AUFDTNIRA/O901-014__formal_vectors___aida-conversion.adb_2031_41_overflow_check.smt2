...
(assert (forall ((temp___2356 Int) (temp___2357 Int) (temp___2358 Int) (temp___2359 Int) (temp___2360 Int) (temp___2361 Int) (temp___2362 Int) (temp___2363 Int) (temp___2364 Int)) (let ((temp___2355 (aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def temp___2356 temp___2357 temp___2358 temp___2359 temp___2360 temp___2361 temp___2362 temp___2363 temp___2364))) (=> (and (and (and (and (and (and (dynamic_invariant temp___2356 true true true true) (dynamic_invariant temp___2357 true true true true)) (dynamic_invariant temp___2358 true true true true)) (dynamic_invariant temp___2359 true true true true)) (dynamic_invariant temp___2360 true true true true)) (dynamic_invariant temp___2361 true true true true)) (dynamic_invariant temp___2362 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 7) temp___2363 temp___2364) (and (= (first5 temp___2355) temp___2363) (= (last5 temp___2355) temp___2364))) (and (and (and (and (and (and (= (select (to_array2 temp___2355) (+ (+ (first1 source) 1) 0)) rliteral) (= (select (to_array2 temp___2355) (+ (+ (first1 source) 1) 1)) rliteral)) (= (select (to_array2 temp___2355) (+ (+ (first1 source) 1) 2)) rliteral)) (= (select (to_array2 temp___2355) (+ (+ (first1 source) 1) 3)) rliteral)) (= (select (to_array2 temp___2355) (+ (+ (first1 source) 1) 4)) rliteral)) (= (select (to_array2 temp___2355) (+ (+ (first1 source) 1) 5)) rliteral)) (= (select (to_array2 temp___2355) (+ (+ (first1 source) 1) 6)) rliteral)))))))
(define-fun dynamic_invariant4 ((temp___expr_814 us_t3) (temp___is_init_810 Bool) (temp___skip_constant_811 Bool) (temp___do_toplevel_812 Bool) (temp___do_typ_inv_813 Bool)) Bool (=> (not (= temp___skip_constant_811 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 7) (first7 temp___expr_814) (last7 temp___expr_814)) (and (= (first7 temp___expr_814) (+ (first1 source) 1)) (= (last7 temp___expr_814) (+ (first1 source) 7))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2370 Int) (temp___2371 Int) (temp___2372 Int)) (let ((temp___2369 (aida__conversion__calculate_negative_target_length_8__n__aggregate_def temp___2370 temp___2371 temp___2372))) (=> (dynamic_invariant temp___2370 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 7) temp___2371 temp___2372) (and (= (first9 temp___2369) temp___2371) (= (last9 temp___2369) temp___2372))) (forall ((temp___2373 Int)) (= (select (to_array4 temp___2369) temp___2373) rliteral1)))))))
...
(declare-const temp___2367 (Array Int integer))
(declare-const temp___23671 t2)
...
(declare-const temp___2375 (Array Int integer))
(declare-const temp___23751 t4)
...
(declare-const temp___2377 Int)
(declare-const temp___2378 Int)
(declare-const temp___2382 Int)
(declare-const temp___2380 (Array Int integer))
(declare-const o Int)
...
(assert (and (= (length source) 8) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index7) (<= index7 (+ (to_rep1 (first (rt source))) 7))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2367 temp___23671) (aida__conversion__calculate_negative_target_length_8__int_array__aggregate_def 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 6))))
(assert (= (ite (<= (to_rep1 (first4 temp___23671)) (to_rep1 (last4 temp___23671))) (+ (- (to_rep1 (last4 temp___23671)) (to_rep1 (first4 temp___23671))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) (+ (- (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2367 (to_rep1 (first4 temp___23671)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_8__int_array__assume))
...
(assert (= (mk___t4 temp___2375 temp___23751) (aida__conversion__calculate_negative_target_length_8__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7))))
(assert (= (ite (<= (to_rep1 (first8 temp___23751)) (to_rep1 (last8 temp___23751))) (+ (- (to_rep1 (last8 temp___23751)) (to_rep1 (first8 temp___23751))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) (+ (- (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2375 (to_rep1 (first8 temp___23751)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_8__n__assume))
...
(assert (and (= temp___2377 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2378 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2377))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= temp___2382 index1)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= temp___2380 n1)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= o index1)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= o3 index1)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= o7 index1)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= n1 result3)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= n2 o8)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (and (and (forall ((temp___2381 Int)) (=> (and (<= (to_rep1 n__first) temp___2381) (<= temp___2381 (to_rep1 n__last))) (=> (or (< temp___2378 temp___2381) (or (< temp___2381 temp___2377) (< index2 temp___2381))) (= (select n3 temp___2381) (select temp___2380 temp___2381))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 7) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 7))))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= index2 temp___2378)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= index2 index3)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= n3 n4)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= index4 index2)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= n5 n3)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= index6 index4)))
(assert (=> (and (<= temp___2377 index1) (<= index1 temp___2378)) (= n7 n5)))
(assert (=> (not (and (<= temp___2377 index1) (<= index1 temp___2378))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2377 index1) (<= index1 temp___2378))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2377 index1) (<= index1 temp___2378))) (= index6 index1)))
(assert (=> (not (and (<= temp___2377 index1) (<= index1 temp___2378))) (= n7 n1)))
...
(assert (and (= temp___2383 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2383) (<= temp___2383 (to_rep1 n__last))))
(assert (= o9 temp___2383))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2384 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2384) (<= temp___2384 (to_rep1 n__last))))
(assert (= o14 temp___2384))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___2385 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2385) (<= temp___2385 (to_rep1 n__last))))
(assert (= o21 temp___2385))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___2386 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2386) (<= temp___2386 (to_rep1 n__last))))
(assert (= o28 temp___2386))
...
(assert (= target4 o34))
(assert (<= (- 9999) target4))
(assert (and (= temp___2387 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2387) (<= temp___2387 (to_rep1 n__last))))
(assert (= o35 temp___2387))
...
(assert (and (= temp___2388 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2388) (<= temp___2388 (to_rep1 n__last))))
(assert (= o42 temp___2388))
