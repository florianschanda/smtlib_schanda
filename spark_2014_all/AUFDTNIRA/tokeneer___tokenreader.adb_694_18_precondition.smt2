...
(declare-fun user_eq17 (readerstatet readerstatet) Bool)
(declare-const dummy17 readerstatet)
...
(define-fun dynamic_invariant3 ((temp___expr_1640 Int) (temp___is_init_1636 Bool) (temp___skip_constant_1637 Bool) (temp___do_toplevel_1638 Bool) (temp___do_typ_inv_1639 Bool)) Bool (=> (or (= temp___is_init_1636 true) (<= 0 6)) (in_range11 temp___expr_1640)))
(assert (forall ((readerstate Int)) (! (=> (dynamic_invariant2 readerstate true true true true) (dynamic_invariant3 (getreaderstate readerstate) true false true true)) :pattern ((getreaderstate readerstate)))))
(assert (forall ((readerstate Int)) (! (=> (dynamic_invariant2 readerstate true true true true) (= (getreaderstate readerstate) (ite (and (<= 0 readerstate) (<= readerstate 6)) readerstate 0))) :pattern ((getreaderstate readerstate)))))
...
(define-fun bool_eq10 ((x us_t2) (y us_t2)) Bool (bool_eq (elts2 x) (to_rep1 (first4 (rt2 x))) (to_rep1 (last4 (rt2 x))) (elts2 y) (to_rep1 (first4 (rt2 y))) (to_rep1 (last4 (rt2 y)))))
...
(assert (forall ((x tokenidt)) (! (in_range12 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(assert (forall ((x tryt)) (! (in_range13 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(assert (forall ((x cardhandlet)) (! (in_range14 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun in_range15 ((x Int)) Bool (and (<= 1 x) (<= x 6)))
(declare-fun attr__ATTRIBUTE_IMAGE15 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check15 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE15 (us_image) Int)
(declare-fun user_eq23 (validreaderstatet validreaderstatet) Bool)
(declare-const dummy23 validreaderstatet)
...
(assert (forall ((x validreaderstatet)) (! (in_range15 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(declare-fun user_eq26 (readert readert) Bool)
(declare-const dummy26 readert)
...
(define-fun dynamic_invariant5 ((temp___expr_1533 Int) (temp___is_init_1529 Bool) (temp___skip_constant_1530 Bool) (temp___do_toplevel_1531 Bool) (temp___do_typ_inv_1532 Bool)) Bool (=> (or (= temp___is_init_1529 true) (<= 0 1)) (in_range17 temp___expr_1533)))
(declare-const reader Int)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-fun temp___String_Literal_1791 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1791 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 3)) 107)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 7)) 82)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 8)) 101)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 10)) 100)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 12)) 114)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 14)) 115)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 15)) 116)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 16)) 97)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 17)) 116)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 18)) 117)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 19)) 115)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 21)) 99)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 22)) 104)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 24)) 110)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 25)) 103)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 28)) 102)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 29)) 97)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 30)) 105)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 31)) 108)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 32)) 117)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 33)) 114)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 34)) 101)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 36)) 58)) (= (to_rep (select (temp___String_Literal_1791 us_void_param) 37)) 32)) :pattern ((temp___String_Literal_1791 us_void_param)))))
...
(define-fun dynamic_invariant15 ((temp___expr_642 Int) (temp___is_init_638 Bool) (temp___skip_constant_639 Bool) (temp___do_toplevel_640 Bool) (temp___do_typ_inv_641 Bool)) Bool (=> (or (= temp___is_init_638 true) (<= 1 150)) (in_range16 temp___expr_642)))
...
(define-fun dynamic_invariant17 ((temp___expr_603 Int) (temp___is_init_599 Bool) (temp___skip_constant_600 Bool) (temp___do_toplevel_601 Bool) (temp___do_typ_inv_602 Bool)) Bool (=> (or (= temp___is_init_599 true) (<= 0 4294967295)) (in_range12 temp___expr_603)))
(define-fun dynamic_invariant18 ((temp___expr_610 Int) (temp___is_init_606 Bool) (temp___skip_constant_607 Bool) (temp___do_toplevel_608 Bool) (temp___do_typ_inv_609 Bool)) Bool (=> (or (= temp___is_init_606 true) (<= 0 2)) (in_range13 temp___expr_610)))
(define-fun dynamic_invariant19 ((temp___expr_1647 Int) (temp___is_init_1643 Bool) (temp___skip_constant_1644 Bool) (temp___do_toplevel_1645 Bool) (temp___do_typ_inv_1646 Bool)) Bool (=> (or (= temp___is_init_1643 true) (<= 1 6)) (in_range15 temp___expr_1647)))
(define-fun dynamic_invariant20 ((temp___expr_1580 Int) (temp___is_init_1576 Bool) (temp___skip_constant_1577 Bool) (temp___do_toplevel_1578 Bool) (temp___do_typ_inv_1579 Bool)) Bool (=> (or (= temp___is_init_1576 true) (<= 0 4294967295)) (in_range14 temp___expr_1580)))
