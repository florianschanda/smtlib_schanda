...
(assert (= result3 true))
(assert (and (= o22 (has_key (positions x) (mk___rep (mk___split_fields c)))) (= (= o22 true) (= (has_key (positions x) (mk___rep (mk___split_fields c))) true))))
(assert (= o23 true))
...
(assert (= result5 true))
(assert (= (= result7 true) (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 5)) (and (<= 0 (to_rep4 (select f j2))) (<= (to_rep4 (select f j2)) (- (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1)))))))
(assert (= result7 true))
(assert (<= 0 j1))
(assert (<= j1 5))
(assert (and (= (mk___rep4 (mk___split_fields4 o13 o14 o15)) (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j1)))) (= (bool_eq10 (mk___rep4 (mk___split_fields4 o13 o14 o15)) (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j1)))) true)))
(assert (= o13 o16))
(assert (= o14 o17))
(assert (= o15 o18))
(assert (= o19 o17))
(assert (= o20 (to_rep3 o19)))
(assert (= o21 (ite (<= j1 o20) true false)))
(assert (not (<= 0 (to_rep4 (select f j1)))))
(check-sat)
(exit)
