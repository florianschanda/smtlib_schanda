...
(assert (and (= o18 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o18) (= o18 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o16 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o16) (<= o16 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= o17 (* 2 o16)))
(assert (and (= o19 o17) (in_range2 o17)))
(assert (= result (ite (<= o19 o18) true false)))
(assert (= result true))
(assert (and (= o15 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o15) (<= o15 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
...
(assert (= result2 true))
(assert (and (= o13 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2)) (= (= o13 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2) true))))
(assert (= o14 true))
...
(assert (= result3 true))
(assert (and (= o11 (has_key (positions x) c3)) (= (= o11 true) (= (has_key (positions x) c3) true))))
(assert (= o12 true))
(assert (= result6 (ite (= o12 true) o11 false)))
(assert (= (= result5 true) (forall ((c4 us_rep)) (=> (= (has_key (positions x) c4) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x c4)) true)))))
(assert (= result5 true))
(assert (= (= result7 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= 0 (to_rep4 (select f j1))) (<= (to_rep4 (select f j1)) (- (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1)))))))
(assert (= result7 true))
(assert (<= 0 j))
(assert (<= j 5))
(assert (and (= o20 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j)))) (= (bool_eq10 o20 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j)))) true)))
(assert (= o2 o5))
(assert (= o3 o6))
(assert (= o4 o7))
(assert (= o8 o6))
