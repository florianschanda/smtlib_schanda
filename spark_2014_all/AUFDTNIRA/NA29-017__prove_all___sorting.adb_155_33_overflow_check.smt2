...
(assert (= result8 true))
(assert (and (= o71 (* j3 l2)) (in_range1 (* j3 l2))))
(assert (= o72 (* o71 2)))
(assert (and (= o73 o72) (in_range1 o72)))
(assert (= o74 (- length1 o73)))
(assert (and (= o75 o74) (in_range1 o74)))
(assert (and (= o76 (* l2 2)) (in_range1 (* l2 2))))
(assert (= o77 (ite (< o76 o75) o76 o75)))
(assert (and (= o78 o77) (in_range2 o77)))
(assert (and (= o65 (* j3 l2)) (in_range1 (* j3 l2))))
(assert (= o66 (* o65 2)))
(assert (and (= o67 o66) (in_range1 o66)))
(assert (= o68 (+ a_first o67)))
