...
(assert (= b7 b5))
(assert (= a8 a6))
(assert (= o17 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t (map__content a7) (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (<= 0 j))
(assert (<= j 2147483647))
