...
(assert (<= q_v21 r17b))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep h_v2__first) k1) (<= k1 (to_rep h_v2__last))) (ite (< k1 q_v22) (= (to_rep1 (select h_v21 k1)) (to_rep1 (select h_v2 (+ k1 m_v21)))) (ite (< (+ q_v22 m_v21) k1) (= (to_rep1 (select h_v21 k1)) (to_rep1 (select h_v2 (- k1 m_v21)))) (= (to_rep1 (select h_v21 k1)) (to_rep1 (select h_v2 k1))))))))
...
(assert (<= (to_rep h_v2__first) k))
(assert (<= k (to_rep h_v2__last)))
(assert (not (< k q_v22)))
(assert (< (+ q_v22 m_v21) k))
(assert (not (<= (to_rep h_v2__first) (- k m_v21))))
(check-sat)
(exit)
