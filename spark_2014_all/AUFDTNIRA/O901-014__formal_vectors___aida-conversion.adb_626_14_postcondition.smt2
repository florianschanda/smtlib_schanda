...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def 2 0 9 9 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def 2 0 9 9 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)) (= (mk___t2 temp___1508 temp___15081) (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def 2 0 9 9 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (and (= (ite (<= (to_rep1 (first4 temp___15081)) (to_rep1 (last4 temp___15081))) (+ (- (to_rep1 (last4 temp___15081)) (to_rep1 (first4 temp___15081))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1508 (to_rep1 (first4 temp___15081)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume) (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (to_rep1 (first (rt source)))) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 9)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)) (= (mk___t4 temp___1516 temp___15161) (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (and (= (ite (<= (to_rep1 (first8 temp___15161)) (to_rep1 (last8 temp___15161))) (+ (- (to_rep1 (last8 temp___15161)) (to_rep1 (first8 temp___15161))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1516 (to_rep1 (first8 temp___15161)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume) (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume1)))))) (and (and (dynamic_property6 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 9)))) (and (and (and (= temp___1523 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (= (mk_int__ref result2) (mk_int__ref index)) (= index2 (to_rep1 (first (rt source))))) (ite (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (and (and (and (= temp___1520 n1) (and (= temp___1518 index2) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o5 index2)) (= o6 (select n1 o5))) (= o7 (to_rep1 o6))) (= o7 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o8 index2)) (= o9 (select (elts source) o8))) (= o10 (to_rep o9))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o10))) (ite (= (= o10 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o10 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o10 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o10 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o10 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o10 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o10 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o10 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o10 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o10 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o11) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o12 index2)) (= o13 (store n1 o12 o11)))) (and (= n1 result3) (= n2 o13))))) (and (and (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3)) (forall ((temp___1521 Int)) (=> (and (<= (to_rep1 n__first) temp___1521) (<= temp___1521 (to_rep1 n__last))) (=> (< index3 temp___1521) (= (select n3 temp___1521) (select temp___1520 temp___1521)))))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9)))) (= index3 temp___1523)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1)))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (= temp___1524 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (<= (to_rep1 n__first) temp___1524) (<= temp___1524 (to_rep1 n__last))) (= o37 temp___1524))) (= o38 (select (map__content1 n7) o37))) (= o39 (to_rep1 o38))) (and (= result6 (mk_int__ref target)) (= target1 o39))) (and (<= target1 9) (and (and (and (and (and (and (and (and (and (and (= temp___1525 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (<= (to_rep1 n__first) temp___1525) (<= temp___1525 (to_rep1 n__last))) (= o40 temp___1525))) (= o41 (select (map__content1 n7) o40))) (= o42 (to_rep1 o41))) (= o43 (* o42 10))) (and (= o44 o43) (in_range1 o43))) (= o45 (+ target1 o44))) (and (= o46 o45) (in_range1 o45))) (and (= result7 (mk_int__ref target1)) (= target2 o46))) (and (<= target2 99) (and (and (and (and (and (and (and (and (and (and (= temp___1526 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))) (and (and (<= (to_rep1 n__first) temp___1526) (<= temp___1526 (to_rep1 n__last))) (= o47 temp___1526))) (= o48 (select (map__content1 n7) o47))) (= o49 (to_rep1 o48))) (= o50 (* o49 100))) (and (= o51 o50) (in_range1 o50))) (= o52 (+ target2 o51))) (and (= o53 o52) (in_range1 o52))) (and (= result8 (mk_int__ref target2)) (= target3 o53))) (and (<= target3 999) (and (and (and (and (and (and (and (and (and (and (= temp___1527 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))) (and (and (<= (to_rep1 n__first) temp___1527) (<= temp___1527 (to_rep1 n__last))) (= o54 temp___1527))) (= o55 (select (map__content1 n7) o54))) (= o56 (to_rep1 o55))) (= o57 (* o56 1000))) (and (= o58 o57) (in_range1 o57))) (= o59 (+ target3 o58))) (and (= o60 o59) (in_range1 o59))) (and (= result9 (mk_int__ref target3)) (= target4 o60))) (and (<= target4 9999) (and (and (and (and (and (and (and (and (and (and (= temp___1528 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (<= (to_rep1 n__first) temp___1528) (<= temp___1528 (to_rep1 n__last))) (= o61 temp___1528))) (= o62 (select (map__content1 n7) o61))) (= o63 (to_rep1 o62))) (= o64 (* o63 10000))) (and (= o65 o64) (in_range1 o64))) (= o66 (+ target4 o65))) (and (= o67 o66) (in_range1 o66))) (and (= result10 (mk_int__ref target4)) (= target5 o67))) (and (<= target5 99999) (and (and (and (and (and (and (and (and (and (and (= temp___1529 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (<= (to_rep1 n__first) temp___1529) (<= temp___1529 (to_rep1 n__last))) (= o68 temp___1529))) (= o69 (select (map__content1 n7) o68))) (= o70 (to_rep1 o69))) (= o71 (* o70 100000))) (and (= o72 o71) (in_range1 o71))) (= o73 (+ target5 o72))) (and (= o74 o73) (in_range1 o73))) (and (= result11 (mk_int__ref target5)) (= target6 o74))) (and (<= target6 999999) (and (and (and (and (and (and (and (and (and (and (= temp___1530 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))) (and (and (<= (to_rep1 n__first) temp___1530) (<= temp___1530 (to_rep1 n__last))) (= o75 temp___1530))) (= o76 (select (map__content1 n7) o75))) (= o77 (to_rep1 o76))) (= o78 (* o77 1000000))) (and (= o79 o78) (in_range1 o78))) (= o80 (+ target6 o79))) (and (= o81 o80) (in_range1 o80))) (and (= result12 (mk_int__ref target6)) (= target7 o81))) (and (<= target7 9999999) (and (and (and (and (and (and (and (and (and (and (= temp___1531 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (<= (to_rep1 n__first) temp___1531) (<= temp___1531 (to_rep1 n__last))) (= o82 temp___1531))) (= o83 (select (map__content1 n7) o82))) (= o84 (to_rep1 o83))) (= o85 (* o84 10000000))) (and (= o86 o85) (in_range1 o85))) (= o87 (+ target7 o86))) (and (= o88 o87) (in_range1 o87))) (and (= result13 (mk_int__ref target7)) (= target8 o88))) (and (<= target8 99999999) (and (and (and (= o89 (+ target8 2000000000)) (in_range1 (+ target8 2000000000))) (and (= result14 (mk_int__ref target8)) (= target9 o89))) (and (<= target9 2099999999) (and (= result15 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))))))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target10 (mk_int__ref target9)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target11 target9))))))))
