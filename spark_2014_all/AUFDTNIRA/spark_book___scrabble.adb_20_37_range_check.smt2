...
(define-fun to_rep1 ((x scrabble_value)) Int (scrabble_valueqtint x))
...
(declare-fun scrabble_scoreqtint (scrabble_score) Int)
(assert (forall ((i scrabble_score)) (and (<= 0 (scrabble_scoreqtint i)) (<= (scrabble_scoreqtint i) 100))))
