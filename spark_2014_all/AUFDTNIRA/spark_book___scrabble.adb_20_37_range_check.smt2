...
(declare-const total_score3 Int)
(declare-const result3 Int)
(declare-const letter_index3 Int)
...
(assert (and (= o3 (+ total_score2 (to_rep1 (select lookup_table (to_rep (select (elts word) letter_index2)))))) (in_range1 (+ total_score2 (to_rep1 (select lookup_table (to_rep (select (elts word) letter_index2))))))))
