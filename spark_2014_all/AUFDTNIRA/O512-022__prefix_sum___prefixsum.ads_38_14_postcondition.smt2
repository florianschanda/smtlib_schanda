...
(assert (=> (< space1 8) (and (and (= (all_elements_in a2 (* space2 1000000)) true) (or (or (= space2 1) (= space2 2)) (= space2 4))) (forall ((k Int)) (=> (and (<= 0 k) (<= k 7)) (ite (and (= (mod2 (+ k 1) 8) 0) (= space2 8)) (= (to_rep (select a2 k)) (+ (+ (+ (+ (+ (+ (+ (to_rep (select temp___186 0)) (to_rep (select temp___187 1))) (to_rep (select temp___188 2))) (to_rep (select temp___189 3))) (to_rep (select temp___190 4))) (to_rep (select temp___191 5))) (to_rep (select temp___192 6))) (to_rep (select temp___193 7)))) (ite (and (= (mod2 (+ k 1) 4) 0) (<= 4 space2)) (= (to_rep (select a2 k)) (+ (+ (+ (to_rep (select temp___194 k)) (to_rep (select temp___195 (- k 1)))) (to_rep (select temp___197 (- k 2)))) (to_rep (select temp___199 (- k 3))))) (ite (and (= (mod2 (+ k 1) 2) 0) (<= 2 space2)) (= (to_rep (select a2 k)) (+ (to_rep (select temp___201 k)) (to_rep (select temp___202 (- k 1))))) (= (to_rep (select a2 k)) (to_rep (select temp___204 k)))))))))))
(assert (=> (< space1 8) (and (and (=> (<= 1 2147483647) (in_range3 space2)) (=> (<= 0 2147483647) (in_range2 left2))) (=> (<= 0 2147483647) (in_range2 right2)))))
