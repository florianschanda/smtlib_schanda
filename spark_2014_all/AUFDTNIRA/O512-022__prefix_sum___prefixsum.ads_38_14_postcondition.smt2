...
(assert (=> (< space1 8) (and (and (= temp___188 a) (and (= temp___194 a) (and (= temp___187 a) (and (= temp___202 a) (and (= temp___186 a) (and (= temp___201 a) (and (= temp___193 a) (and (= temp___185 right) (and (= temp___183 a) (and (= temp___192 a) (and (= temp___182 left) (and (= temp___199 a) (and (= temp___191 a) (and (= temp___190 a) (and (= temp___197 a) (and (= temp___181 space1) (and (= temp___189 a) (and (= temp___204 a) (and (= temp___195 a) (and (= 0 temp___205) (and (and (and (= (all_elements_in a2 (* space2 1000000)) true) (or (or (= space2 1) (= space2 2)) (= space2 4))) (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 7)) (ite (and (= (mod2 (+ k2 1) 8) 0) (= space2 8)) (= (to_rep (select a2 k2)) (+ (+ (+ (+ (+ (+ (+ (to_rep (select temp___186 0)) (to_rep (select temp___187 1))) (to_rep (select temp___188 2))) (to_rep (select temp___189 3))) (to_rep (select temp___190 4))) (to_rep (select temp___191 5))) (to_rep (select temp___192 6))) (to_rep (select temp___193 7)))) (ite (and (= (mod2 (+ k2 1) 4) 0) (<= 4 space2)) (= (to_rep (select a2 k2)) (+ (+ (+ (to_rep (select temp___194 k2)) (to_rep (select temp___195 (- k2 1)))) (to_rep (select temp___197 (- k2 2)))) (to_rep (select temp___199 (- k2 3))))) (ite (and (= (mod2 (+ k2 1) 2) 0) (<= 2 space2)) (= (to_rep (select a2 k2)) (+ (to_rep (select temp___201 k2)) (to_rep (select temp___202 (- k2 1))))) (= (to_rep (select a2 k2)) (to_rep (select temp___204 k2))))))))) (and (and (and (and (=> (<= 1 2147483647) (in_range3 space2)) (=> (<= 0 2147483647) (in_range2 left2))) (=> (<= 0 2147483647) (in_range2 right2))) (< space2 8)) (and (and (= temp___2051 result2) (= temp___2052 space2)) (and (and (= left2 result3) (= left3 (- space2 1))) (and (ite (< left3 8) (and (and (and (= temp___179 a2) (and (= temp___175 right2) (and (= temp___173 a2) (and (= temp___177 a2) (and (= temp___172 left3) (and (= temp___176 a2) (and (= 0 temp___180) (and (and (and (and (and (and (= (mod2 (+ left4 1) space2) 0) (= (all_left_elements_in a3 left4 (* (* space2 2) 1000000)) true)) (= (all_right_elements_in a3 (- left4 1) (* space2 1000000)) true)) (= (mod2 (+ left4 1) (* space2 2)) space2)) (=> (<= 8 left4) (or (= left4 8) (= left4 9)))) (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 7)) (ite (and (and (<= 0 k2) (<= k2 (- left4 space2))) (= (mod2 (+ k2 1) (* 2 space2)) 0)) (= (to_rep (select a3 k2)) (+ (to_rep (select temp___176 k2)) (to_rep (select temp___177 (- k2 space2))))) (= (to_rep (select a3 k2)) (to_rep (select temp___179 k2))))))) (and (and (and (=> (<= 0 2147483647) (in_range2 left4)) (=> (<= 0 2147483647) (in_range2 right3))) (< left4 8)) (and (and (= temp___1801 result8) (= temp___1802 left4)) (and (and (and (= o12 (+ left4 space2)) (in_range1 (+ left4 space2))) (and (= right3 result9) (= right4 o12))) (and (and (and (and (and (and (and (and (and (and (<= 0 right4) (<= right4 7)) (= o15 right4)) (= o16 (select a3 o15))) (= o17 (to_rep o16))) (and (and (and (and (and (<= 0 left4) (<= left4 7)) (= o13 left4)) (= o14 (select a3 o13))) (= o18 (to_rep o14))) (= o19 (+ o18 o17)))) (and (= o20 o19) (in_range1 o19))) (= (to_rep o21) o20)) (and (and (and (<= 0 right4) (<= right4 7)) (= o22 right4)) (= o23 (store a3 o22 o21)))) (and (= a3 result10) (= a4 o23))) (and (and (and (and (and (and (= o24 (* space2 2)) (in_range1 (* space2 2))) (= o25 (+ left4 o24))) (and (= o26 o25) (in_range1 o25))) (and (= o27 o26) (in_range2 o26))) (and (= left4 result11) (= left5 o27))) (not (< left5 8))))))))))))))) (and (and (= right4 right7) (and (= left5 left8) (= a4 a7))) (and (= rho1 temp___1802) (and (= right8 right4) (and (= left9 left5) (= a8 a4)))))) (and (and (= right9 (mk_int__ref right7)) (and (= left10 (mk_int__ref left8)) (= a9 (mk_map__ref a7)))) (and (= rho2 rho1) (and (= right10 right8) (and (= left11 left9) (= a10 a8)))))) (and (and (= right9 (mk_int__ref right2)) (and (= left10 (mk_int__ref left3)) (= a9 (mk_map__ref a2)))) (and (= rho2 rho) (and (= right10 right2) (and (= left11 left3) (= a10 a2)))))) (and (and (and (and (= o28 (* space2 2)) (in_range1 (* space2 2))) (and (= o29 o28) (in_range3 o28))) (and (= result12 (mk_int__ref space2)) (= space3 o29))) (not (< space3 8)))))))))))))))))))))))))))) (and (and (= right15 right9) (and (= left16 left10) (and (= space8 (mk_int__ref space3)) (= a15 a9)))) (and (= right16 right10) (and (= left17 left11) (and (= space9 space3) (= a16 a10))))))))
(assert (=> (< space1 8) (= right17 right15)))
(assert (=> (< space1 8) (= left18 left16)))
(assert (=> (< space1 8) (= space10 space8)))
(assert (=> (< space1 8) (= a17 a15)))
(assert (=> (< space1 8) (= right18 right16)))
(assert (=> (< space1 8) (= left19 left17)))
(assert (=> (< space1 8) (= space11 space9)))
(assert (=> (< space1 8) (= a18 a16)))
(assert (=> (not (< space1 8)) (= right17 (mk_int__ref right))))
(assert (=> (not (< space1 8)) (= left18 (mk_int__ref left))))
(assert (=> (not (< space1 8)) (= space10 (mk_int__ref space1))))
(assert (=> (not (< space1 8)) (= a17 (mk_map__ref a))))
(assert (=> (not (< space1 8)) (= right18 right1)))
(assert (=> (not (< space1 8)) (= left19 left1)))
(assert (=> (not (< space1 8)) (= space11 space1)))
(assert (=> (not (< space1 8)) (= a18 a1)))
(assert (= result13 (mk_int__ref output_space)))
(assert (= output_space1 (int__content space10)))
(assert (= right19 right17))
(assert (= left20 left18))
(assert (= space12 space10))
(assert (= output_space2 (mk_int__ref output_space1)))
(assert (= a19 a17))
(assert (= right20 right18))
(assert (= left21 left19))
(assert (= space13 space11))
(assert (= output_space3 output_space1))
(assert (= a20 a18))
(assert (not (= (all_elements_in (map__content a19) 8000000) true)))
(check-sat)
(exit)
