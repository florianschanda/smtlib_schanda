...
(declare-fun initialize_coprime_list__function_guard ((Array Int Bool) Int) Bool)
...
(declare-fun nearest_prime_number__function_guard (Int Int Int (Array Int Bool)) Bool)
...
(assert (and (= o (nearest_prime_number 555 1 is_prime1)) (and (in_range2 o) (and (and (and (<= 0 o) (<= o 100000)) (= (is_prime o) true)) (ite (= (is_prime 555) true) (= o 555) (ite (= (ite (= (is_prime 555) false) (= 1 0) false) true) (and (< 555 o) (forall ((v Int)) (=> (and (<= 555 v) (<= v (- o 1))) (not (= (is_prime v) true))))) (ite (= (ite (= (is_prime 555) false) (= 1 1) false) true) (and (< o 555) (forall ((v Int)) (=> (and (<= (+ o 1) v) (<= v 555)) (not (= (is_prime v) true))))) (=> (= (ite (= (is_prime 555) false) (= 1 2) false) true) (and (forall ((v Int)) (=> (and (<= (ite (< 0 (+ (- 555 (abs (- 555 o))) 1)) (+ (- 555 (abs (- 555 o))) 1) 0) v) (<= v 555)) (not (= (is_prime v) true)))) (forall ((v Int)) (=> (and (<= 555 v) (<= v (ite (< 100000 (- (+ 555 (abs (- 555 o))) 1)) 100000 (- (+ 555 (abs (- 555 o))) 1)))) (not (= (is_prime v) true)))))))))))))
(assert (and (= o1 o) (in_range o)))
(assert (= result result__))
(assert (= result__1 o1))
(assert (and (= o2 (initialize_coprime_list 2000)) (forall ((v Int)) (=> (and (<= 0 v) (<= v 100000)) (= (= (select o2 v) true) (= (are_coprime 2000 v) true))))))
