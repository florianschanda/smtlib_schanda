...
(assert (= o53 temp___1609))
(assert (= o54 (select n9 o53)))
(assert (= o55 (to_rep1 o54)))
(assert (= o56 (* o55 100000)))
(assert (and (= o57 o56) (in_range1 o56)))
(assert (= o58 (+ target5 o57)))
