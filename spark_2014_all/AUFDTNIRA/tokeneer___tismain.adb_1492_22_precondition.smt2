...
(assert (=> (= result1 true) (and (= o29 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o29 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result1 true) (= o30 (ite (not (= o29 true)) true false))))
(assert (=> (= result1 true) (and (= o28 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o28 true) (in_range4 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result1 true) (= o31 (ite (not (= o28 true)) true false))))
(assert (=> (= result1 true) (= o32 (ite (= o31 true) o30 false))))
(assert (=> (not (= result1 true)) (= o32 (distinct 1 0))))
(assert (and (= result2 (statusisshutdown status3 (let ((subject state4)) state17))) (= (= result2 true) (= status3 8))))
(assert (=> (= result2 true) (and (= o24 (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (and (in_range1 o24) (= o24 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result2 true) (= o25 (ite (= o24 0) true false))))
(assert (=> (= result2 true) (and (= o23 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o23 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result2 true) (= o26 (ite (not (= o23 true)) true false))))
...
(assert (=> (= result3 true) (and (= o21 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o21 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result3 true) (= o22 (ite (not (= o21 true)) true false))))
(assert (=> (not (= result3 true)) (= o22 (distinct 1 0))))
(assert (and (= o16 (statusiswaitingfinishadminop status3 (let ((subject state4)) state17))) (= (= o16 true) (= status3 7))))
(assert (and (= o17 (statusiswaitingstartadminop status3 (let ((subject state4)) state17))) (= (= o17 true) (= status3 6))))
(assert (= result4 (ite (= o17 false) o16 true)))
(assert (=> (= result4 true) (and (= o18 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o18 true) (in_range4 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result4 true) (and (= o19 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o19 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result4 true) (= o20 (ite (= o19 true) o18 false))))
(assert (=> (not (= result4 true)) (= o20 (distinct 1 0))))
(assert (and (= o12 (statusiswaitingremoveadmintokenfail status3 (let ((subject state4)) state17))) (= (= o12 true) (= status3 4))))
(assert (and (= o13 (statusisgotadmintoken status3 (let ((subject state4)) state17))) (= (= o13 true) (= status3 5))))
(assert (= result5 (ite (= o13 false) o12 true)))
(assert (=> (= result5 true) (and (= o14 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o14 true) (in_range4 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result5 true) (= o15 (ite (not (= o14 true)) true false))))
(assert (=> (not (= result5 true)) (= o15 (distinct 1 0))))
...
(assert (=> (= result7 true) (and (= o10 (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (in_range3 o10))))
(assert (=> (= result7 true) (= result6 (ite (= o10 4) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (and (= o11 (statusiswaitingstartadminop status3 (let ((subject state4)) state17))) (= (= o11 true) (= status3 6)))))
(assert (=> (not (= result6 true)) (= o11 (distinct 1 0))))
(assert (and (= o7 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o7 true) (in_range4 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3)))))))
(assert (= result8 (ite (not (= o7 true)) true false)))
(assert (=> (= result8 true) (and (= o8 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o8 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result8 true) (= o9 (ite (not (= o8 true)) true false))))
(assert (=> (not (= result8 true)) (= o9 (distinct 1 0))))
...
(assert (=> (= result9 true) (and (= o3 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o3 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result9 true) (= o4 (ite (not (= o3 true)) true false))))
(assert (=> (= result9 true) (and (= result10 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= result10 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result9 true) (=> (= result10 true) (and (= o2 (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (in_range3 o2)))))
(assert (=> (= result9 true) (=> (= result10 true) (= o5 (ite (= o2 3) true false)))))
(assert (=> (= result9 true) (=> (not (= result10 true)) (= o5 false))))
(assert (=> (= result9 true) (= o6 (ite (= o5 false) o4 true))))
(assert (=> (not (= result9 true)) (= o6 (distinct 1 0))))
(assert (and (= result11 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= result11 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3)))))))
