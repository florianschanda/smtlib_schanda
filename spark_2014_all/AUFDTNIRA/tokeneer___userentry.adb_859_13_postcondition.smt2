...
(assert (=> (not (= result true)) (=> (= result2 true) (= result3 (mk_int__ref status)))))
...
(assert (= (islocked (int__content currentlatch3) (us_private__content state18) (us_split_fields__content latchtimeout__split_fields6)) true))
(assert (= (thecurrentdoor (us_private__content state19)) 0))
(assert (= (greaterthanorequal (thecurrenttime (mk___split_fields currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (alarm_timeout (us_private__content state19))) true))
(assert (not (= (thedooralarm (us_private__content state19)) 0)))
(check-sat)
(exit)
