...
(assert (= med1 result6))
(assert (= med2 o15))
(assert (forall ((i11 Int)) (=> (and (<= (to_rep1 (first (rt a))) i11) (<= i11 (to_rep1 (last (rt a))))) (forall ((i2 Int)) (=> (and (<= i11 i2) (<= i2 (to_rep1 (last (rt a))))) (<= (to_rep (select (elts a) i11)) (to_rep (select (elts a) i2))))))))
