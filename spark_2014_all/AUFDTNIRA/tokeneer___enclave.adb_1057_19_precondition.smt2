...
(assert (and (= o4 (islocked (int__content currentlatch2) (us_private__content state12) (us_split_fields__content1 latchtimeout__split_fields5))) (= (= o4 true) (= (int__content currentlatch2) 0))))
(assert (= o5 (ite (not (= o4 true)) true false)))
(assert (= result1 (ite (= o5 true) (islocked currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result1 true) (and (= o6 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range7 o6))))
(assert (=> (= result1 true) (= o7 (ite (= o6 3) true false))))
(assert (=> (= result1 true) (and (= o8 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o8 true) (in_range7 (to_rep3 theadmin__split_fields1))))))
(assert (=> (= result1 true) (= o9 (ite (= o8 true) o7 false))))
(assert (=> (not (= result1 true)) (= o9 (distinct 1 0))))
...
(assert (= result2 true))
(assert (and (= o2 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o2 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
(assert (= o3 (ite (not (= o2 true)) true false)))
(assert (and (= result3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result3 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
(assert (= result3 true))
