...
(assert (and (= o18 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o18 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
(assert (= o19 (ite (not (= o18 true)) true false)))
(assert (and (= result13 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result13 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
