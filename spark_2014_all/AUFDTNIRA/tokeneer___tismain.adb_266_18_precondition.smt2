...
(define-fun dynamic_invariant2 ((temp___expr_634 Int) (temp___is_init_630 Bool) (temp___skip_constant_631 Bool) (temp___do_toplevel_632 Bool) (temp___do_typ_inv_633 Bool)) Bool (=> (or (= temp___is_init_630 true) (<= 0 4294967295)) (in_range9 temp___expr_634)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant3 ((temp___expr_641 Int) (temp___is_init_637 Bool) (temp___skip_constant_638 Bool) (temp___do_toplevel_639 Bool) (temp___do_typ_inv_640 Bool)) Bool (=> (or (= temp___is_init_637 true) (<= 0 2)) (in_range10 temp___expr_641)))
...
(define-fun dynamic_invariant4 ((temp___expr_648 Int) (temp___is_init_644 Bool) (temp___skip_constant_645 Bool) (temp___do_toplevel_646 Bool) (temp___do_typ_inv_647 Bool)) Bool (=> (or (= temp___is_init_644 true) (<= 0 1)) (in_range11 temp___expr_648)))
...
(declare-fun user_eq21 (logfilecountt logfilecountt) Bool)
(declare-const dummy21 logfilecountt)
...
(declare-const dummy22 (Array Int logfileindext))
...
(declare-fun user_eq22 ((Array Int logfileindext) (Array Int logfileindext)) Bool)
...
(define-fun dynamic_invariant5 ((temp___expr_1359 us_rep3) (temp___is_init_1355 Bool) (temp___skip_constant_1356 Bool) (temp___do_toplevel_1357 Bool) (temp___do_typ_inv_1358 Bool)) Bool (=> (= temp___do_typ_inv_1358 true) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1359))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1359))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1359)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1359))) true)))
(define-fun default_initial_assumption ((temp___expr_1363 us_rep3) (temp___skip_top_level_1364 Bool)) Bool (and (and (and (= (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1363))) 1) (= (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1363))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1363)) (mk___rep2 (mk___split_fields2 (temp___1365 1) (of_rep8 1) (of_rep8 1) (of_rep10 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1363)) (temp___1369 0))))
(define-fun type_invariant ((temp___1373 us_rep3)) Bool (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1373))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1373))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1373)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1373))) true))
...
(define-fun dynamic_invariant6 ((temp___expr_2148 Int) (temp___is_init_2144 Bool) (temp___skip_constant_2145 Bool) (temp___do_toplevel_2146 Bool) (temp___do_typ_inv_2147 Bool)) Bool (=> (or (= temp___is_init_2144 true) (<= 0 1)) (in_range29 temp___expr_2148)))
...
(define-fun dynamic_invariant7 ((temp___expr_2887 Int) (temp___is_init_2883 Bool) (temp___skip_constant_2884 Bool) (temp___do_toplevel_2885 Bool) (temp___do_typ_inv_2886 Bool)) Bool (=> (or (= temp___is_init_2883 true) (<= 0 8)) (in_range31 temp___expr_2887)))
...
(define-fun dynamic_invariant12 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 4)) (in_range6 temp___expr_496)))
(define-fun dynamic_invariant13 ((temp___expr_503 Int) (temp___is_init_499 Bool) (temp___skip_constant_500 Bool) (temp___do_toplevel_501 Bool) (temp___do_typ_inv_502 Bool)) Bool (=> (or (= temp___is_init_499 true) (<= 1 4)) (in_range7 temp___expr_503)))
(define-fun dynamic_invariant14 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range8 temp___expr_433)))
...
(define-fun dynamic_invariant16 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 40)) (in_range22 temp___expr_548)))
(define-fun dynamic_invariant17 ((temp___expr_572 Int) (temp___is_init_568 Bool) (temp___skip_constant_569 Bool) (temp___do_toplevel_570 Bool) (temp___do_typ_inv_571 Bool)) Bool (=> (or (= temp___is_init_568 true) (<= 0 4294967295)) (in_range23 temp___expr_572)))
(define-fun dynamic_invariant18 ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= 0 10)) (in_range25 temp___expr_596)))
(define-fun dynamic_invariant19 ((temp___expr_610 Int) (temp___is_init_606 Bool) (temp___skip_constant_607 Bool) (temp___do_toplevel_608 Bool) (temp___do_typ_inv_609 Bool)) Bool (=> (or (= temp___is_init_606 true) (<= 0 4294967295)) (in_range27 temp___expr_610)))
(define-fun dynamic_invariant20 ((temp___expr_617 Int) (temp___is_init_613 Bool) (temp___skip_constant_614 Bool) (temp___do_toplevel_615 Bool) (temp___do_typ_inv_616 Bool)) Bool (=> (or (= temp___is_init_613 true) (<= 0 128)) (in_range28 temp___expr_617)))
(define-fun dynamic_invariant21 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 17)) (in_range19 temp___expr_1297)))
(define-fun dynamic_invariant22 ((temp___expr_1304 Int) (temp___is_init_1300 Bool) (temp___skip_constant_1301 Bool) (temp___do_toplevel_1302 Bool) (temp___do_typ_inv_1303 Bool)) Bool (=> (or (= temp___is_init_1300 true) (<= 1 17)) (in_range17 temp___expr_1304)))
(define-fun dynamic_invariant23 ((temp___expr_1430 Int) (temp___is_init_1426 Bool) (temp___skip_constant_1427 Bool) (temp___do_toplevel_1428 Bool) (temp___do_typ_inv_1429 Bool)) Bool (=> (or (= temp___is_init_1426 true) (<= 0 2)) (in_range21 temp___expr_1430)))
(define-fun dynamic_invariant24 ((temp___expr_1311 Int) (temp___is_init_1307 Bool) (temp___skip_constant_1308 Bool) (temp___do_toplevel_1309 Bool) (temp___do_typ_inv_1310 Bool)) Bool (=> (or (= temp___is_init_1307 true) (<= 0 17408)) (in_range18 temp___expr_1311)))
(define-fun dynamic_invariant25 ((temp___expr_1342 Int) (temp___is_init_1338 Bool) (temp___skip_constant_1339 Bool) (temp___do_toplevel_1340 Bool) (temp___do_typ_inv_1341 Bool)) Bool (=> (or (= temp___is_init_1338 true) (<= 0 1024)) (in_range20 temp___expr_1342)))
(assert true)
...
(assert (forall ((temp___1371 Int)) (=> (dynamic_invariant25 temp___1371 true true true true) (forall ((temp___1372 Int)) (= (to_rep11 (select (temp___1369 temp___1371) temp___1372)) temp___1371)))))
(define-fun dynamic_invariant26 ((temp___expr_673 Int) (temp___is_init_669 Bool) (temp___skip_constant_670 Bool) (temp___do_toplevel_671 Bool) (temp___do_typ_inv_672 Bool)) Bool (=> (or (= temp___is_init_669 true) (<= 1 150)) (in_range12 temp___expr_673)))
...
(define-fun dynamic_invariant27 ((temp___expr_725 Int) (temp___is_init_721 Bool) (temp___skip_constant_722 Bool) (temp___do_toplevel_723 Bool) (temp___do_typ_inv_724 Bool)) Bool (=> (or (= temp___is_init_721 true) (<= 1901 2099)) (in_range13 temp___expr_725)))
(define-fun dynamic_invariant28 ((temp___expr_732 Int) (temp___is_init_728 Bool) (temp___skip_constant_729 Bool) (temp___do_toplevel_730 Bool) (temp___do_typ_inv_731 Bool)) Bool (=> (or (= temp___is_init_728 true) (<= 1 12)) (in_range14 temp___expr_732)))
(define-fun dynamic_invariant29 ((temp___expr_739 Int) (temp___is_init_735 Bool) (temp___skip_constant_736 Bool) (temp___do_toplevel_737 Bool) (temp___do_typ_inv_738 Bool)) Bool (=> (or (= temp___is_init_735 true) (<= 1 31)) (in_range15 temp___expr_739)))
(define-fun dynamic_invariant30 ((temp___expr_771 Int) (temp___is_init_767 Bool) (temp___skip_constant_768 Bool) (temp___do_toplevel_769 Bool) (temp___do_typ_inv_770 Bool)) Bool (=> (or (= temp___is_init_767 true) (<= 0 86399999)) (in_range16 temp___expr_771)))
(define-fun dynamic_invariant31 ((temp___expr_1603 Int) (temp___is_init_1599 Bool) (temp___skip_constant_1600 Bool) (temp___do_toplevel_1601 Bool) (temp___do_typ_inv_1602 Bool)) Bool (=> (or (= temp___is_init_1599 true) (<= 0 4294967295)) (in_range26 temp___expr_1603)))
...
(define-fun dynamic_invariant32 ((temp___expr_2974 Int) (temp___is_init_2970 Bool) (temp___skip_constant_2971 Bool) (temp___do_toplevel_2972 Bool) (temp___do_typ_inv_2973 Bool)) Bool (=> (or (= temp___is_init_2970 true) (<= 0 2)) (in_range32 temp___expr_2974)))
(define-fun dynamic_invariant33 ((temp___expr_2376 Int) (temp___is_init_2372 Bool) (temp___skip_constant_2373 Bool) (temp___do_toplevel_2374 Bool) (temp___do_typ_inv_2375 Bool)) Bool (=> (or (= temp___is_init_2372 true) (<= 0 2147483647)) (in_range30 temp___expr_2376)))
(assert (forall ((temp___1367 Int)) (=> (dynamic_invariant22 temp___1367 true true true true) (forall ((temp___1368 Int)) (= (to_rep8 (select (temp___1365 temp___1367) temp___1368)) temp___1367)))))
...
(assert (and (in_range11 auditalarm1) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)))
(assert (and (in_range11 auditalarm2) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true)))
...
(assert (and (in_range11 auditalarm3) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true)))
(assert (in_range29 currentlatch1))
(assert (and (in_range11 auditalarm4) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true)))
(assert (and (in_range11 auditalarm5) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true)))
(assert (and (and (and (not (= (isgood tokenpresence1 (let ((subject state1)) state4) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true)) (not (= (authcertvalid tokenpresence1 (let ((subject state1)) state4) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true))) (not (in_range8 (theauthcertrole tokenpresence1 (let ((subject state1)) state4) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1))))) (and (and (in_range10 tokentry1) (in_range9 tokenid1)) (in_range4 tokenpresence1))))
(assert (and (and (= (= (privatekeypresent thistisinfo__split_fields (let ((subject state)) state3)) true) (not (= (enrolmentisinprogress status1 (let ((subject state2)) state5)) true))) (or (= (enrolmentisinprogress status1 (let ((subject state2)) state5)) true) (= (statusisenclavequiescent status1 (let ((subject state2)) state5)) true))) (in_range31 status1)))
