...
(define-fun dynamic_invariant2 ((temp___expr_568 Int) (temp___is_init_565 Bool) (temp___skip_constant_566 Bool) (temp___do_toplevel_567 Bool)) Bool (=> (or (= temp___is_init_565 true) (<= 0 4294967295)) (in_range9 temp___expr_568)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant3 ((temp___expr_574 Int) (temp___is_init_571 Bool) (temp___skip_constant_572 Bool) (temp___do_toplevel_573 Bool)) Bool (=> (or (= temp___is_init_571 true) (<= 0 2)) (in_range10 temp___expr_574)))
...
(define-fun dynamic_invariant4 ((temp___expr_580 Int) (temp___is_init_577 Bool) (temp___skip_constant_578 Bool) (temp___do_toplevel_579 Bool)) Bool (=> (or (= temp___is_init_577 true) (<= 0 1)) (in_range11 temp___expr_580)))
...
(assert (forall ((temp___1217 Int)) (forall ((temp___1218 Int)) (= (select (temp___1215 temp___1217) temp___1218) (of_rep8 temp___1217)))))
(declare-fun temp___1219 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1221 Int)) (forall ((temp___1222 Int)) (= (select (temp___1219 temp___1221) temp___1222) (of_rep11 temp___1221)))))
(define-fun dynamic_invariant5 ((temp___expr_1209 us_rep3) (temp___is_init_1206 Bool) (temp___skip_constant_1207 Bool) (temp___do_toplevel_1208 Bool)) Bool (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1209))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1209))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1209)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1209))) true))
(define-fun default_initial_assumption ((temp___expr_1213 us_rep3) (temp___skip_top_level_1214 Bool)) Bool (and (and (and (= (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1213))) 1) (= (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1213))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1213)) (mk___rep2 (mk___split_fields2 (temp___1215 1) (of_rep8 1) (of_rep8 1) (of_rep10 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1213)) (temp___1219 0))))
(define-fun type_invariant ((temp___1223 us_rep3)) Bool (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1223))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1223))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1223)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1223))) true))
...
(define-fun dynamic_invariant6 ((temp___expr_1969 Int) (temp___is_init_1966 Bool) (temp___skip_constant_1967 Bool) (temp___do_toplevel_1968 Bool)) Bool (=> (or (= temp___is_init_1966 true) (<= 0 1)) (in_range29 temp___expr_1969)))
...
(define-fun dynamic_invariant7 ((temp___expr_2683 Int) (temp___is_init_2680 Bool) (temp___skip_constant_2681 Bool) (temp___do_toplevel_2682 Bool)) Bool (=> (or (= temp___is_init_2680 true) (<= 0 8)) (in_range31 temp___expr_2683)))
...
(define-fun dynamic_invariant15 ((temp___expr_395 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 5)) (in_range24 temp___expr_395)))
(define-fun dynamic_invariant16 ((temp___expr_492 Int) (temp___is_init_489 Bool) (temp___skip_constant_490 Bool) (temp___do_toplevel_491 Bool)) Bool (=> (or (= temp___is_init_489 true) (<= 0 40)) (in_range22 temp___expr_492)))
(define-fun dynamic_invariant17 ((temp___expr_513 Int) (temp___is_init_510 Bool) (temp___skip_constant_511 Bool) (temp___do_toplevel_512 Bool)) Bool (=> (or (= temp___is_init_510 true) (<= 0 4294967295)) (in_range23 temp___expr_513)))
(define-fun dynamic_invariant18 ((temp___expr_535 Int) (temp___is_init_532 Bool) (temp___skip_constant_533 Bool) (temp___do_toplevel_534 Bool)) Bool (=> (or (= temp___is_init_532 true) (<= 0 10)) (in_range25 temp___expr_535)))
(define-fun dynamic_invariant19 ((temp___expr_547 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 4294967295)) (in_range27 temp___expr_547)))
(define-fun dynamic_invariant20 ((temp___expr_553 Int) (temp___is_init_550 Bool) (temp___skip_constant_551 Bool) (temp___do_toplevel_552 Bool)) Bool (=> (or (= temp___is_init_550 true) (<= 0 128)) (in_range28 temp___expr_553)))
(define-fun dynamic_invariant21 ((temp___expr_1175 Int) (temp___is_init_1172 Bool) (temp___skip_constant_1173 Bool) (temp___do_toplevel_1174 Bool)) Bool (=> (or (= temp___is_init_1172 true) (<= 0 17)) (in_range19 temp___expr_1175)))
(define-fun dynamic_invariant22 ((temp___expr_1154 Int) (temp___is_init_1151 Bool) (temp___skip_constant_1152 Bool) (temp___do_toplevel_1153 Bool)) Bool (=> (or (= temp___is_init_1151 true) (<= 1 17)) (in_range17 temp___expr_1154)))
(define-fun dynamic_invariant23 ((temp___expr_1279 Int) (temp___is_init_1276 Bool) (temp___skip_constant_1277 Bool) (temp___do_toplevel_1278 Bool)) Bool (=> (or (= temp___is_init_1276 true) (<= 0 2)) (in_range21 temp___expr_1279)))
(define-fun dynamic_invariant24 ((temp___expr_1160 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 17408)) (in_range18 temp___expr_1160)))
(define-fun dynamic_invariant25 ((temp___expr_1194 Int) (temp___is_init_1191 Bool) (temp___skip_constant_1192 Bool) (temp___do_toplevel_1193 Bool)) Bool (=> (or (= temp___is_init_1191 true) (<= 0 1024)) (in_range20 temp___expr_1194)))
(assert true)
...
(define-fun dynamic_invariant26 ((temp___expr_602 Int) (temp___is_init_599 Bool) (temp___skip_constant_600 Bool) (temp___do_toplevel_601 Bool)) Bool (=> (or (= temp___is_init_599 true) (<= 1 150)) (in_range12 temp___expr_602)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_162 Tuple0)))
(define-fun dynamic_invariant27 ((temp___expr_648 Int) (temp___is_init_645 Bool) (temp___skip_constant_646 Bool) (temp___do_toplevel_647 Bool)) Bool (=> (or (= temp___is_init_645 true) (<= 1901 2099)) (in_range13 temp___expr_648)))
(define-fun dynamic_invariant28 ((temp___expr_654 Int) (temp___is_init_651 Bool) (temp___skip_constant_652 Bool) (temp___do_toplevel_653 Bool)) Bool (=> (or (= temp___is_init_651 true) (<= 1 12)) (in_range14 temp___expr_654)))
(define-fun dynamic_invariant29 ((temp___expr_660 Int) (temp___is_init_657 Bool) (temp___skip_constant_658 Bool) (temp___do_toplevel_659 Bool)) Bool (=> (or (= temp___is_init_657 true) (<= 1 31)) (in_range15 temp___expr_660)))
(define-fun dynamic_invariant30 ((temp___expr_688 Int) (temp___is_init_685 Bool) (temp___skip_constant_686 Bool) (temp___do_toplevel_687 Bool)) Bool (=> (or (= temp___is_init_685 true) (<= 0 86399999)) (in_range16 temp___expr_688)))
...
(define-fun dynamic_invariant32 ((temp___expr_2769 Int) (temp___is_init_2766 Bool) (temp___skip_constant_2767 Bool) (temp___do_toplevel_2768 Bool)) Bool (=> (or (= temp___is_init_2766 true) (<= 0 2)) (in_range32 temp___expr_2769)))
(define-fun dynamic_invariant33 ((temp___expr_2185 Int) (temp___is_init_2182 Bool) (temp___skip_constant_2183 Bool) (temp___do_toplevel_2184 Bool)) Bool (=> (or (= temp___is_init_2182 true) (<= 0 2147483647)) (in_range30 temp___expr_2185)))
