...
(assert (= retvalini1 c32b))
(assert (in_range8 c32b))
(assert (= result11 (mk_map__ref result__)))
(assert (= result__1 nodescription))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b)))))) (= o9 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b))))))) (= o9 0)))
(assert (=> (<= 1 37) (= o10 (+ (- 37 1) 1))))
(assert (=> (not (<= 1 37)) (= o10 0)))
(assert (= o11 (+ o10 o9)))
(assert (= o12 (+ 1 o11)))
(assert (= o13 (- o12 1)))
(assert (and (= o14 o13) (in_range2 o13)))
(assert (= keystore__digest__B36b__thestring__assume (mk___t (concat1 (temp___String_Literal_1228 Tuple0) 1 37 (elts (to_string (attr__ATTRIBUTE_IMAGE8 c32b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE8 c32b)))))) (mk 1 o14))))
(assert (= keystore__digest__B36b__thestring__assume thestring))
(assert (dynamic_invariant1 thestring true false true))
(assert (and (= o15 (length thestring)) (in_range1 (length thestring))))
(assert (= result12 (ite (<= o15 150) true false)))
...
(assert (= temp___1222 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring)))))
(assert (and (= temp___1224 (length thestring)) (in_range1 (length thestring))))
(assert (=> (<= 1 temp___1224) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1224) (<= temp___1224 150)))))
(assert (= o16 result__1))
(assert (= temp___1225 (mk___t1 o16 (mk1 1 temp___1224))))
(assert (not (= (ite (<= (to_rep1 (first2 (rt1 temp___1222))) (to_rep1 (last2 (rt1 temp___1222)))) (+ (- (to_rep1 (last2 (rt1 temp___1222))) (to_rep1 (first2 (rt1 temp___1222)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1225))) (to_rep1 (last2 (rt1 temp___1225)))) (+ (- (to_rep1 (last2 (rt1 temp___1225))) (to_rep1 (first2 (rt1 temp___1225)))) 1) 0))))
(check-sat)
(exit)
