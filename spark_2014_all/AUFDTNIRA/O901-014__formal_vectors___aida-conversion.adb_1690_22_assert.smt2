...
(assert (forall ((temp___2114 Int) (temp___2115 Int) (temp___2116 Int) (temp___2117 Int) (temp___2118 Int) (temp___2119 Int) (temp___2120 Int) (temp___2121 Int) (temp___2122 Int)) (let ((temp___2113 (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__aggregate_def temp___2114 temp___2115 temp___2116 temp___2117 temp___2118 temp___2119 temp___2120 temp___2121 temp___2122))) (=> (and (and (and (and (and (and (dynamic_invariant temp___2114 true true true true) (dynamic_invariant temp___2115 true true true true)) (dynamic_invariant temp___2116 true true true true)) (dynamic_invariant temp___2117 true true true true)) (dynamic_invariant temp___2118 true true true true)) (dynamic_invariant temp___2119 true true true true)) (dynamic_invariant temp___2120 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 4) (+ (first1 source) 10) temp___2121 temp___2122) (and (= (first5 temp___2113) temp___2121) (= (last5 temp___2113) temp___2122))) (and (and (and (and (and (and (= (to_rep1 (select (to_array2 temp___2113) (+ (+ (first1 source) 4) 0))) temp___2114) (= (to_rep1 (select (to_array2 temp___2113) (+ (+ (first1 source) 4) 1))) temp___2115)) (= (to_rep1 (select (to_array2 temp___2113) (+ (+ (first1 source) 4) 2))) temp___2116)) (= (to_rep1 (select (to_array2 temp___2113) (+ (+ (first1 source) 4) 3))) temp___2117)) (= (to_rep1 (select (to_array2 temp___2113) (+ (+ (first1 source) 4) 4))) temp___2118)) (= (to_rep1 (select (to_array2 temp___2113) (+ (+ (first1 source) 4) 5))) temp___2119)) (= (to_rep1 (select (to_array2 temp___2113) (+ (+ (first1 source) 4) 6))) temp___2120)))))))
(define-fun dynamic_invariant4 ((temp___expr_694 us_t3) (temp___is_init_690 Bool) (temp___skip_constant_691 Bool) (temp___do_toplevel_692 Bool) (temp___do_typ_inv_693 Bool)) Bool (=> (not (= temp___skip_constant_691 true)) (and (dynamic_property6 (+ (first1 source) 4) (+ (first1 source) 10) (first7 temp___expr_694) (last7 temp___expr_694)) (and (= (first7 temp___expr_694) (+ (first1 source) 4)) (= (last7 temp___expr_694) (+ (first1 source) 10))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2128 Int) (temp___2129 Int) (temp___2130 Int)) (let ((temp___2127 (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__aggregate_def temp___2128 temp___2129 temp___2130))) (=> (dynamic_invariant temp___2128 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 4) (+ (first1 source) 10) temp___2129 temp___2130) (and (= (first9 temp___2127) temp___2129) (= (last9 temp___2127) temp___2130))) (forall ((temp___2131 Int)) (= (to_rep1 (select (to_array4 temp___2127) temp___2131)) temp___2128)))))))
...
(declare-const temp___2125 (Array Int integer))
(declare-const temp___21251 t2)
...
(declare-const temp___2133 (Array Int integer))
(declare-const temp___21331 t4)
...
(declare-const temp___2139 Int)
(declare-const temp___2140 Int)
(declare-const temp___2138 Int)
(declare-const temp___2136 (Array Int integer))
(declare-const o Int)
...
(declare-const temp___2141 Int)
(declare-const o9 Int)
(declare-const o10 integer)
(declare-const o11 Int)
(declare-const o12 Int)
(declare-const o13 Int)
(declare-const temp___2142 Int)
...
(assert (and (= (length source) 11) (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) index7) (<= index7 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2125 temp___21251) (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__aggregate_def 6 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 4) (+ (+ (to_rep1 (first (rt source))) 4) 6))))
(assert (= (ite (<= (to_rep1 (first4 temp___21251)) (to_rep1 (last4 temp___21251))) (+ (- (to_rep1 (last4 temp___21251)) (to_rep1 (first4 temp___21251))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 4)) 1) 0)))
(assert (= (slide1 temp___2125 (to_rep1 (first4 temp___21251)) (+ (to_rep1 (first (rt source))) 4)) aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__assume))
...
(assert (= (mk___t4 temp___2133 temp___21331) (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___21331)) (to_rep1 (last8 temp___21331))) (+ (- (to_rep1 (last8 temp___21331)) (to_rep1 (first8 temp___21331))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 4)) 1) 0)))
(assert (= (slide1 temp___2133 (to_rep1 (first8 temp___21331)) (+ (to_rep1 (first (rt source))) 4)) aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__assume))
...
(assert (and (= temp___2139 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (= temp___2140 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2139))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= temp___2138 index1)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= temp___2136 n1)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= o index1)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= o3 index1)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= o7 index1)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= n1 result3)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= n2 o8)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (and (and (forall ((temp___2137 Int)) (=> (and (<= (to_rep1 n__first) temp___2137) (<= temp___2137 (to_rep1 n__last))) (=> (< index2 temp___2137) (= (select n3 temp___2137) (select temp___2136 temp___2137))))) (=> (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 4) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= index2 temp___2140)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= index2 index3)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= n3 n4)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= index4 index2)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= n5 n3)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= index6 index4)))
(assert (=> (and (<= temp___2139 index1) (<= index1 temp___2140)) (= n7 n5)))
(assert (=> (not (and (<= temp___2139 index1) (<= index1 temp___2140))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2139 index1) (<= index1 temp___2140))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2139 index1) (<= index1 temp___2140))) (= index6 index1)))
(assert (=> (not (and (<= temp___2139 index1) (<= index1 temp___2140))) (= n7 n1)))
...
(assert (and (= temp___2141 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___2141) (<= temp___2141 (to_rep1 n__last))))
(assert (= o9 temp___2141))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2142 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___2142) (<= temp___2142 (to_rep1 n__last))))
(assert (= o14 temp___2142))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___2143 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2143) (<= temp___2143 (to_rep1 n__last))))
(assert (= o21 temp___2143))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___2144 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2144) (<= temp___2144 (to_rep1 n__last))))
(assert (= o28 temp___2144))
...
(assert (= target4 o34))
(assert (<= (- 9999) target4))
(assert (and (= temp___2145 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2145) (<= temp___2145 (to_rep1 n__last))))
(assert (= o35 temp___2145))
...
(assert (and (= temp___2146 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2146) (<= temp___2146 (to_rep1 n__last))))
(assert (= o42 temp___2146))
...
(assert (and (= temp___2147 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2147) (<= temp___2147 (to_rep1 n__last))))
(assert (= o49 temp___2147))
...
(assert (and (= o56 (- target7 2140000000)) (in_range1 (- target7 2140000000))))
