...
(define-fun tint_arrayD1__ref___15__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___15__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t536b__ref (mk_t536b__ref (t536b__content integer)))))
(define-fun t536b__ref___projection ((a t536b__ref)) integer (t536b__content a))
(declare-sort t2 0)
...
(define-fun tnumber_array_typeD1__ref___24__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___24__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t540b__ref (mk_t540b__ref (t540b__content integer)))))
(define-fun t540b__ref___projection ((a t540b__ref)) integer (t540b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t542b__ref (mk_t542b__ref (t542b__content integer)))))
(define-fun t542b__ref___projection ((a t542b__ref)) integer (t542b__content a))
...
(define-fun tint_arrayB__ref___15__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___2012 Int) (temp___2013 Int) (temp___2014 Int) (temp___2015 Int) (temp___2016 Int) (temp___2017 Int) (temp___2018 Int) (temp___2019 Int) (temp___2020 Int)) (let ((temp___2011 (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__aggregate_def temp___2012 temp___2013 temp___2014 temp___2015 temp___2016 temp___2017 temp___2018 temp___2019 temp___2020))) (and (=> (dynamic_property10 (+ (first1 source) 4) (+ (first1 source) 10) temp___2019 temp___2020) (and (= (first5 temp___2011) temp___2019) (= (last5 temp___2011) temp___2020))) (and (and (and (and (and (and (= (select (to_array2 temp___2011) (+ (+ (first1 source) 4) 0)) (of_rep1 temp___2012)) (= (select (to_array2 temp___2011) (+ (+ (first1 source) 4) 1)) (of_rep1 temp___2013))) (= (select (to_array2 temp___2011) (+ (+ (first1 source) 4) 2)) (of_rep1 temp___2014))) (= (select (to_array2 temp___2011) (+ (+ (first1 source) 4) 3)) (of_rep1 temp___2015))) (= (select (to_array2 temp___2011) (+ (+ (first1 source) 4) 4)) (of_rep1 temp___2016))) (= (select (to_array2 temp___2011) (+ (+ (first1 source) 4) 5)) (of_rep1 temp___2017))) (= (select (to_array2 temp___2011) (+ (+ (first1 source) 4) 6)) (of_rep1 temp___2018)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___24__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___2026 Int) (temp___2027 Int) (temp___2028 Int)) (let ((temp___2025 (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__aggregate_def temp___2026 temp___2027 temp___2028))) (and (=> (dynamic_property11 (+ (first1 source) 4) (+ (first1 source) 10) temp___2027 temp___2028) (and (= (first9 temp___2025) temp___2027) (= (last9 temp___2025) temp___2028))) (forall ((temp___2029 Int)) (= (select (to_array4 temp___2025) temp___2029) (of_rep1 temp___2026)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_617 us_t3) (temp___is_init_614 Bool) (temp___skip_constant_615 Bool) (temp___do_toplevel_616 Bool)) Bool (=> (not (= temp___skip_constant_615 true)) (and (dynamic_property6 (+ (first1 source) 4) (+ (first1 source) 10) (first7 temp___expr_617) (last7 temp___expr_617)) (and (= (first7 temp___expr_617) (+ (first1 source) 4)) (= (last7 temp___expr_617) (+ (first1 source) 10))))))
...
(declare-const temp___2046 Int)
(declare-const temp___2047 Int)
(declare-const o Int)
(declare-const o1 character)
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const temp___2048 Int)
(declare-const o4 Int)
(declare-const o5 character)
(declare-const o6 Int)
(declare-const o7 Bool)
(declare-const temp___2049 Int)
(declare-const o8 Int)
(declare-const o9 character)
(declare-const o10 Int)
(declare-const o11 Bool)
(declare-const temp___2050 Int)
...
(declare-const temp___2023 (Array Int integer))
(declare-const temp___20231 t2)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___2031 (Array Int integer))
(declare-const temp___20311 t4)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__assume1 t3)
(declare-const us2 Int)
(declare-const us3 Int)
(declare-const temp___2037 Int)
(declare-const temp___2038 Int)
(declare-const temp___2036 Int)
...
(assert (and (= (length source) 11) (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__aggregate_def 6 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 4) (+ (+ (to_rep1 (first (rt source))) 4) 6))))) (+ (to_rep1 (first (rt source))) 4)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__aggregate_def 6 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 4) (+ (+ (to_rep1 (first (rt source))) 4) 6))))) (+ (+ (to_rep1 (first (rt source))) 4) 6)))
(assert (= (mk___t2 temp___2023 temp___20231) (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__aggregate_def 6 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 4) (+ (+ (to_rep1 (first (rt source))) 4) 6))))
(assert (= (ite (<= (to_rep1 (first4 temp___20231)) (to_rep1 (last4 temp___20231))) (+ (- (to_rep1 (last4 temp___20231)) (to_rep1 (first4 temp___20231))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 4)) 1) 0)))
(assert (= (slide1 temp___2023 (to_rep1 (first4 temp___20231)) (+ (to_rep1 (first (rt source))) 4)) aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 4)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 4)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)))
(assert (= (mk___t4 temp___2031 temp___20311) (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___20311)) (to_rep1 (last8 temp___20311))) (+ (- (to_rep1 (last8 temp___20311)) (to_rep1 (first8 temp___20311))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 4)) 1) 0)))
(assert (= (slide1 temp___2031 (to_rep1 (first8 temp___20311)) (+ (to_rep1 (first (rt source))) 4)) aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 4)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= temp___2037 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (= temp___2038 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___2037))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= temp___2036 index2)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= temp___2034 n1)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= o21 index2)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= o22 (select n1 o21))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= o23 (to_rep1 o22))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= o23 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= o24 index2)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= o25 (select (elts source) o24))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= o26 (to_rep o25))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o26))) (ite (= (= o26 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o26 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o26 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o26 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o26 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o26 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o26 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o26 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o26 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o26 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= (to_rep1 o27) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= o28 index2)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= o29 (store n1 o28 o27))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= n1 result4)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= n2 o29)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (and (and (forall ((temp___2035 Int)) (=> (and (<= (to_rep1 n__first) temp___2035) (<= temp___2035 (to_rep1 n__last))) (=> (< index3 temp___2035) (= (select n3 temp___2035) (select temp___2034 temp___2035))))) (=> (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 4) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= index3 temp___2038)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= index3 index5)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= n3 n5)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= index6 index3)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= n6 n3)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= index8 index6)))
(assert (=> (and (<= temp___2037 index2) (<= index2 temp___2038)) (= n8 n6)))
(assert (=> (not (and (<= temp___2037 index2) (<= index2 temp___2038))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___2037 index2) (<= index2 temp___2038))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2037 index2) (<= index2 temp___2038))) (= index8 index2)))
(assert (=> (not (and (<= temp___2037 index2) (<= index2 temp___2038))) (= n8 n1)))
...
(assert (and (= temp___2039 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___2039) (<= temp___2039 (to_rep1 n__last))))
(assert (= o57 temp___2039))
...
(assert (= target1 o61))
(assert (<= (- 9) target1))
(assert (and (= temp___2040 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___2040) (<= temp___2040 (to_rep1 n__last))))
(assert (= o62 temp___2040))
(assert (= o63 (select (map__content1 n7) o62)))
(assert (= o64 (to_rep1 o63)))
(assert (= o65 (* o64 10)))
(assert (and (= o66 o65) (in_range1 o65)))
(assert (= o67 (- target1 o66)))
(assert (and (= o68 o67) (in_range1 o67)))
(assert (= result10 (mk_int__ref target1)))
(assert (= target2 o68))
(assert (<= (- 99) target2))
(assert (and (= temp___2041 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2041) (<= temp___2041 (to_rep1 n__last))))
(assert (= o69 temp___2041))
(assert (= o70 (select (map__content1 n7) o69)))
(assert (= o71 (to_rep1 o70)))
(assert (= o72 (* o71 100)))
(assert (and (= o73 o72) (in_range1 o72)))
(assert (= o74 (- target2 o73)))
(assert (and (= o75 o74) (in_range1 o74)))
(assert (= result11 (mk_int__ref target2)))
(assert (= target3 o75))
(assert (<= (- 999) target3))
(assert (and (= temp___2042 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2042) (<= temp___2042 (to_rep1 n__last))))
(assert (= o76 temp___2042))
(assert (= o77 (select (map__content1 n7) o76)))
(assert (= o78 (to_rep1 o77)))
(assert (= o79 (* o78 1000)))
(assert (and (= o80 o79) (in_range1 o79)))
(assert (= o81 (- target3 o80)))
(assert (and (= o82 o81) (in_range1 o81)))
(assert (= result12 (mk_int__ref target3)))
(assert (= target4 o82))
(assert (<= (- 9999) target4))
(assert (and (= temp___2043 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2043) (<= temp___2043 (to_rep1 n__last))))
(assert (= o83 temp___2043))
(assert (= o84 (select (map__content1 n7) o83)))
(assert (= o85 (to_rep1 o84)))
(assert (= o86 (* o85 10000)))
(assert (and (= o87 o86) (in_range1 o86)))
(assert (= o88 (- target4 o87)))
(assert (and (= o89 o88) (in_range1 o88)))
(assert (= result13 (mk_int__ref target4)))
(assert (= target5 o89))
(assert (<= (- 99999) target5))
(assert (and (= temp___2044 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2044) (<= temp___2044 (to_rep1 n__last))))
(assert (= o90 temp___2044))
(assert (= o91 (select (map__content1 n7) o90)))
(assert (= o92 (to_rep1 o91)))
(assert (= o93 (* o92 100000)))
(assert (and (= o94 o93) (in_range1 o93)))
(assert (= o95 (- target5 o94)))
(assert (and (= o96 o95) (in_range1 o95)))
(assert (= result14 (mk_int__ref target5)))
(assert (= target6 o96))
(assert (<= (- 999999) target6))
(assert (and (= temp___2045 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2045) (<= temp___2045 (to_rep1 n__last))))
(assert (= o97 temp___2045))
(assert (= o98 (select (map__content1 n7) o97)))
(assert (= o99 (to_rep1 o98)))
(assert (= o100 (* o99 1000000)))
(assert (and (= o101 o100) (in_range1 o100)))
(assert (= o102 (- target6 o101)))
(assert (and (= o103 o102) (in_range1 o102)))
(assert (= result15 (mk_int__ref target6)))
(assert (= target7 o103))
(assert (<= (- 6999999) target7))
(assert (and (= o104 (- target7 2140000000)) (in_range1 (- target7 2140000000))))
(assert (= result16 (mk_int__ref target7)))
(assert (= target8 o104))
(assert (not (<= (- 2146999999) target8)))
(check-sat)
(exit)
