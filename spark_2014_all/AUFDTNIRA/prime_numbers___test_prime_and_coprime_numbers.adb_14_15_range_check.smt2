...
(assert (= coprimes1 o2))
(assert (and (= o3 (nearest_number coprimes1 1 555)) (and (in_range2 o3) (and (and (and (<= 0 o3) (<= o3 100000)) (= (select coprimes1 o3) true)) (ite (= (= (to_int1 (select coprimes1 555)) (to_int1 (of_int 1))) true) (= o3 555) (ite (= (ite (= (= (to_int1 (select coprimes1 555)) (to_int1 (of_int 0))) true) (= 1 0) false) true) (and (< 555 o3) (forall ((v Int)) (=> (and (<= 555 v) (<= v (- o3 1))) (not (= (select coprimes1 v) true))))) (ite (= (ite (= (= (to_int1 (select coprimes1 555)) (to_int1 (of_int 0))) true) (= 1 1) false) true) (and (< o3 555) (forall ((v Int)) (=> (and (<= (+ o3 1) v) (<= v 555)) (not (= (select coprimes1 v) true))))) (=> (= (ite (= (= (to_int1 (select coprimes1 555)) (to_int1 (of_int 0))) true) (= 1 2) false) true) (and (forall ((v Int)) (=> (and (<= (ite (< 0 (+ (- 555 (abs (- 555 o3))) 1)) (+ (- 555 (abs (- 555 o3))) 1) 0) v) (<= v 555)) (not (= (select coprimes1 v) true)))) (forall ((v Int)) (=> (and (<= 555 v) (<= v (ite (< 100000 (- (+ 555 (abs (- 555 o3))) 1)) 100000 (- (+ 555 (abs (- 555 o3))) 1)))) (not (= (select coprimes1 v) true)))))))))))))
