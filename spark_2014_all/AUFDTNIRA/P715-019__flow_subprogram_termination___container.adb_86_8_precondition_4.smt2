...
(define-fun e10 () int__ref (mk_int__ref e))
...
(assert (=> (= result17 true) (and (= (has_element (mk___rep1 my_container__split_fields1) temp___6342) true) (= e5 (element (mk___rep1 my_container__split_fields1) temp___6342)))))
...
(assert (not (= (has_element (mk___rep1 my_container__split_fields1) (cursor__content temp___641)) true)))
(check-sat)
(exit)
