...
(assert (and (= o2 (price_of_item (select (elts bk) it3))) (and (in_range3 o2) (= o2 (mult (to_rep (rec__pricing__item__price (us_split_fields1 (select (elts bk) it3)))) (to_rep (rec__pricing__item__number (us_split_fields1 (select (elts bk) it3)))))))))
(assert (and (= o3 (add total2 o2)) (and (in_range3 o3) (ite (= (< (+ total2 o2) 10000) true) (= o3 (+ total2 o2)) (=> (= (>= (+ total2 o2) 10000) true) (= o3 10000))))))
(assert (= total2 result3))
(assert (= total3 o3))
(assert (not (= it3 (to_rep1 (last (rt bk))))))
(assert (= result4 it3))
(assert (= it4 (+ it3 1)))
(declare-const k1 Int)
(assert (<= (to_rep1 (first (rt bk))) k1))
(assert (<= k1 (- it4 1)))
(assert (not (<= (price_of_item (select (elts bk) k1)) total3)))
(check-sat)
(exit)
