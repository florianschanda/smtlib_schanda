...
(assert (and (= o (price_of_item (select (elts bk) it2))) (and (in_range3 o) (= o (mult (to_rep (rec__pricing__item__price (us_split_fields1 (select (elts bk) it2)))) (to_rep (rec__pricing__item__number (us_split_fields1 (select (elts bk) it2)))))))))
(assert (and (= o1 (add total2 o)) (and (in_range3 o1) (ite (= (< (+ total2 o) 10000) true) (= o1 (+ total2 o)) (=> (= (>= (+ total2 o) 10000) true) (= o1 10000))))))
...
(assert (<= k (- it3 1)))
(assert (not (<= (price_of_item (select (elts bk) k)) total3)))
(check-sat)
(exit)
