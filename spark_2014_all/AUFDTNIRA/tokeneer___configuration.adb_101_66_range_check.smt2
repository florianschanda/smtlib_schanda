...
(assert (=> (<= (to_rep1 (first (rt temp___1900))) (to_rep1 (last (rt temp___1900)))) (= o25 (+ (- (to_rep1 (last (rt temp___1900))) (to_rep1 (first (rt temp___1900)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1900))) (to_rep1 (last (rt temp___1900))))) (= o25 0)))
(assert (= o26 (+ o25 o24)))
(assert (= o27 (+ (to_rep1 (first (rt temp___1900))) o26)))
(assert (= o28 (- o27 1)))
