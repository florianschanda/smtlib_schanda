...
(assert (<= 0 k5))
(assert (<= k5 (- (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields5)) 1)))
(assert (and (= o72 (length (mk___rep1 p__split_discrs p__split_fields4))) (and (in_range9 o72) (<= o72 (capacity (mk___rep1 p__split_discrs p__split_fields4))))))
(assert (= o73 (- o72 1)))
(assert (not (<= 0 k5)))
(check-sat)
(exit)
