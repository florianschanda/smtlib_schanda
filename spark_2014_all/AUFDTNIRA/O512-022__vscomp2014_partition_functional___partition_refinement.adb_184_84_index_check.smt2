...
(assert (<= 0 k))
(assert (<= k (- (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1)))
(assert (and (= o14 (length (mk___rep1 p__split_discrs p__split_fields3))) (and (in_range9 o14) (<= o14 (capacity (mk___rep1 p__split_discrs p__split_fields3))))))
(assert (= o15 (- o14 1)))
(assert (not (<= 0 k)))
(check-sat)
(exit)
