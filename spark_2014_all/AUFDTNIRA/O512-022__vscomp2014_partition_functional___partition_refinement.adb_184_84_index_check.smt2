...
(assert (<= 0 k))
(assert (<= k (- (to_rep2 (rec__partition_refinement__interval__first p_prime__split_fields1)) 1)))
(assert (and (= o11 (length (mk___rep p__split_discrs p__split_fields3))) (and (in_range1 o11) (<= o11 (capacity (mk___rep p__split_discrs p__split_fields3))))))
(assert (= o12 (- o11 1)))
(assert (not (<= k 5)))
(check-sat)
(exit)
