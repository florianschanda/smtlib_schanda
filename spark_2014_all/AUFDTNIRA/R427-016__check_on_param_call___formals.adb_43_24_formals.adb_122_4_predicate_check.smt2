...
(declare-const temp___315 (Array Int natural))
...
(declare-const formals__p2__a2 (Array Int natural))
(declare-const result20 map__ref)
(declare-const u3 (Array Int natural))
(declare-const u4 (Array Int natural))
(declare-const result21 map__ref)
(declare-const u5 (Array Int natural))
...
(assert (= o26 (div1 o23 o25)))
(assert (and (= o27 o26) (in_range o26)))
(assert (= (to_rep o28) o27))
(assert (= o29 (store x7 1 o28)))
(assert (= result19 (mk_map__ref x7)))
(assert (= x8 o29))
(assert (not (= (to_rep (select u2 3)) 0)))
(assert (dynamic_predicate1 formals__p2__a2))
(assert (= o30 formals__p2__a2))
(assert (= result20 (mk_map__ref u2)))
(assert (= u3 o30))
(assert (not (= (to_rep (select u4 3)) 0)))
(assert (=> (= (to_rep (select u4 1)) 0) (dynamic_predicate1 (store u4 3 rliteral1))))
(assert (=> (= (to_rep (select u4 1)) 0) (= temp___315 (store u4 3 rliteral1))))
(assert (=> (= (to_rep (select u4 1)) 0) (dynamic_predicate1 temp___315)))
(assert (=> (= (to_rep (select u4 1)) 0) (= o31 temp___315)))
(assert (=> (= (to_rep (select u4 1)) 0) (= result21 (mk_map__ref u4))))
(assert (=> (= (to_rep (select u4 1)) 0) (= u5 o31)))
(assert (=> (not (= (to_rep (select u4 1)) 0)) (= u5 u4)))
(assert (not (dynamic_predicate1 x9)))
(check-sat)
(exit)
