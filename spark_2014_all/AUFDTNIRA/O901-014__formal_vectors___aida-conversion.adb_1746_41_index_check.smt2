...
(define-fun tint_arrayD1__ref___16__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___16__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t561b__ref (mk_t561b__ref (t561b__content integer)))))
(define-fun t561b__ref___projection ((a t561b__ref)) integer (t561b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t562b__ref (mk_t562b__ref (t562b__content us_t2)))))
(define-fun t562b__ref___projection ((a t562b__ref)) us_t2 (t562b__content a))
...
(define-fun tnumber_array_typeD1__ref___25__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___25__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t565b__ref (mk_t565b__ref (t565b__content integer)))))
(define-fun t565b__ref___projection ((a t565b__ref)) integer (t565b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t566b__ref (mk_t566b__ref (t566b__content us_t4)))))
(define-fun t566b__ref___projection ((a t566b__ref)) us_t4 (t566b__content a))
...
(declare-datatypes () ((t567b__ref (mk_t567b__ref (t567b__content integer)))))
(define-fun t567b__ref___projection ((a t567b__ref)) integer (t567b__content a))
...
(define-fun tint_arrayB__ref___16__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___2052 Int) (temp___2053 Int) (temp___2054 Int) (temp___2055 Int) (temp___2056 Int) (temp___2057 Int) (temp___2058 Int) (temp___2059 Int) (temp___2060 Int) (temp___2061 Int)) (let ((temp___2051 (aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__aggregate_def temp___2052 temp___2053 temp___2054 temp___2055 temp___2056 temp___2057 temp___2058 temp___2059 temp___2060 temp___2061))) (and (=> (dynamic_property10 (+ (first1 source) 3) (+ (first1 source) 10) temp___2060 temp___2061) (and (= (first5 temp___2051) temp___2060) (= (last5 temp___2051) temp___2061))) (and (and (and (and (and (and (and (= (select (to_array2 temp___2051) (+ (+ (first1 source) 3) 0)) (of_rep1 temp___2052)) (= (select (to_array2 temp___2051) (+ (+ (first1 source) 3) 1)) (of_rep1 temp___2053))) (= (select (to_array2 temp___2051) (+ (+ (first1 source) 3) 2)) (of_rep1 temp___2054))) (= (select (to_array2 temp___2051) (+ (+ (first1 source) 3) 3)) (of_rep1 temp___2055))) (= (select (to_array2 temp___2051) (+ (+ (first1 source) 3) 4)) (of_rep1 temp___2056))) (= (select (to_array2 temp___2051) (+ (+ (first1 source) 3) 5)) (of_rep1 temp___2057))) (= (select (to_array2 temp___2051) (+ (+ (first1 source) 3) 6)) (of_rep1 temp___2058))) (= (select (to_array2 temp___2051) (+ (+ (first1 source) 3) 7)) (of_rep1 temp___2059)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___25__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___2067 Int) (temp___2068 Int) (temp___2069 Int)) (let ((temp___2066 (aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__aggregate_def temp___2067 temp___2068 temp___2069))) (and (=> (dynamic_property11 (+ (first1 source) 3) (+ (first1 source) 10) temp___2068 temp___2069) (and (= (first9 temp___2066) temp___2068) (= (last9 temp___2066) temp___2069))) (forall ((temp___2070 Int)) (= (select (to_array4 temp___2066) temp___2070) (of_rep1 temp___2067)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_635 us_t3) (temp___is_init_632 Bool) (temp___skip_constant_633 Bool) (temp___do_toplevel_634 Bool)) Bool (=> (not (= temp___skip_constant_633 true)) (and (dynamic_property6 (+ (first1 source) 3) (+ (first1 source) 10) (first7 temp___expr_635) (last7 temp___expr_635)) (and (= (first7 temp___expr_635) (+ (first1 source) 3)) (= (last7 temp___expr_635) (+ (first1 source) 10))))))
...
(declare-const temp___2088 Int)
(declare-const temp___2089 Int)
(declare-const o Int)
(declare-const o1 character)
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const temp___2090 Int)
...
(declare-const temp___2064 (Array Int integer))
(declare-const temp___20641 t2)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___2072 (Array Int integer))
(declare-const temp___20721 t4)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__assume1 t3)
(declare-const us2 Int)
(declare-const us3 Int)
(declare-const temp___2078 Int)
(declare-const temp___2079 Int)
(declare-const temp___2077 Int)
(declare-const temp___2075 (Array Int integer))
...
(assert (and (= (length source) 11) (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__aggregate_def 3 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 3) (+ (+ (to_rep1 (first (rt source))) 3) 7))))) (+ (to_rep1 (first (rt source))) 3)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__aggregate_def 3 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 3) (+ (+ (to_rep1 (first (rt source))) 3) 7))))) (+ (+ (to_rep1 (first (rt source))) 3) 7)))
(assert (= (mk___t2 temp___2064 temp___20641) (aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__aggregate_def 3 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 3) (+ (+ (to_rep1 (first (rt source))) 3) 7))))
(assert (= (ite (<= (to_rep1 (first4 temp___20641)) (to_rep1 (last4 temp___20641))) (+ (- (to_rep1 (last4 temp___20641)) (to_rep1 (first4 temp___20641))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 3)) 1) 0)))
(assert (= (slide1 temp___2064 (to_rep1 (first4 temp___20641)) (+ (to_rep1 (first (rt source))) 3)) aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 3)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 3)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)))
(assert (= (mk___t4 temp___2072 temp___20721) (aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___20721)) (to_rep1 (last8 temp___20721))) (+ (- (to_rep1 (last8 temp___20721)) (to_rep1 (first8 temp___20721))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 3)) 1) 0)))
(assert (= (slide1 temp___2072 (to_rep1 (first8 temp___20721)) (+ (to_rep1 (first (rt source))) 3)) aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_2_13x_xxx_xxx__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 3)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= temp___2078 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (= temp___2079 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___2078))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= temp___2077 index2)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= temp___2075 n1)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= o17 index2)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= o18 (select n1 o17))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= o19 (to_rep1 o18))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= o19 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= o20 index2)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= o21 (select (elts source) o20))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= o22 (to_rep o21))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o22))) (ite (= (= o22 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o22 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o22 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o22 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o22 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o22 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o22 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o22 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o22 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o22 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= (to_rep1 o23) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= o24 index2)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= o25 (store n1 o24 o23))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= n1 result4)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= n2 o25)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 3) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (and (and (forall ((temp___2076 Int)) (=> (and (<= (to_rep1 n__first) temp___2076) (<= temp___2076 (to_rep1 n__last))) (=> (< index3 temp___2076) (= (select n3 temp___2076) (select temp___2075 temp___2076))))) (=> (<= (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 3) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= index3 temp___2079)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= index3 index5)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= n3 n5)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= index6 index3)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= n6 n3)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= index8 index6)))
(assert (=> (and (<= temp___2078 index2) (<= index2 temp___2079)) (= n8 n6)))
(assert (=> (not (and (<= temp___2078 index2) (<= index2 temp___2079))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___2078 index2) (<= index2 temp___2079))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2078 index2) (<= index2 temp___2079))) (= index8 index2)))
(assert (=> (not (and (<= temp___2078 index2) (<= index2 temp___2079))) (= n8 n1)))
...
(assert (and (= temp___2080 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___2080) (<= temp___2080 (to_rep1 n__last))))
(assert (= o53 temp___2080))
(assert (= o54 (select (map__content1 n7) o53)))
(assert (= o55 (to_rep1 o54)))
(assert (= o56 (- o55)))
(assert (and (= o57 o56) (in_range1 o56)))
(assert (= result9 (mk_int__ref target)))
(assert (= target1 o57))
(assert (<= (- 9) target1))
(assert (and (= temp___2081 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___2081) (<= temp___2081 (to_rep1 n__last))))
(assert (= o58 temp___2081))
(assert (= o59 (select (map__content1 n7) o58)))
(assert (= o60 (to_rep1 o59)))
(assert (= o61 (* o60 10)))
(assert (and (= o62 o61) (in_range1 o61)))
(assert (= o63 (- target1 o62)))
(assert (and (= o64 o63) (in_range1 o63)))
(assert (= result10 (mk_int__ref target1)))
(assert (= target2 o64))
(assert (<= (- 99) target2))
(assert (and (= temp___2082 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2082) (<= temp___2082 (to_rep1 n__last))))
(assert (= o65 temp___2082))
(assert (= o66 (select (map__content1 n7) o65)))
(assert (= o67 (to_rep1 o66)))
(assert (= o68 (* o67 100)))
(assert (and (= o69 o68) (in_range1 o68)))
(assert (= o70 (- target2 o69)))
(assert (and (= o71 o70) (in_range1 o70)))
(assert (= result11 (mk_int__ref target2)))
(assert (= target3 o71))
(assert (<= (- 999) target3))
(assert (and (= temp___2083 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2083) (<= temp___2083 (to_rep1 n__last))))
(assert (= o72 temp___2083))
(assert (= o73 (select (map__content1 n7) o72)))
(assert (= o74 (to_rep1 o73)))
(assert (= o75 (* o74 1000)))
(assert (and (= o76 o75) (in_range1 o75)))
(assert (= o77 (- target3 o76)))
(assert (and (= o78 o77) (in_range1 o77)))
(assert (= result12 (mk_int__ref target3)))
(assert (= target4 o78))
(assert (<= (- 9999) target4))
(assert (and (= temp___2084 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2084) (<= temp___2084 (to_rep1 n__last))))
(assert (= o79 temp___2084))
(assert (= o80 (select (map__content1 n7) o79)))
(assert (= o81 (to_rep1 o80)))
(assert (= o82 (* o81 10000)))
(assert (and (= o83 o82) (in_range1 o82)))
(assert (= o84 (- target4 o83)))
(assert (and (= o85 o84) (in_range1 o84)))
(assert (= result13 (mk_int__ref target4)))
(assert (= target5 o85))
(assert (<= (- 99999) target5))
(assert (and (= temp___2085 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2085) (<= temp___2085 (to_rep1 n__last))))
(assert (= o86 temp___2085))
(assert (= o87 (select (map__content1 n7) o86)))
(assert (= o88 (to_rep1 o87)))
(assert (= o89 (* o88 100000)))
(assert (and (= o90 o89) (in_range1 o89)))
(assert (= o91 (- target5 o90)))
(assert (and (= o92 o91) (in_range1 o91)))
(assert (= result14 (mk_int__ref target5)))
(assert (= target6 o92))
(assert (<= (- 999999) target6))
(assert (and (= temp___2086 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2086) (<= temp___2086 (to_rep1 n__last))))
(assert (= o93 temp___2086))
(assert (= o94 (select (map__content1 n7) o93)))
(assert (= o95 (to_rep1 o94)))
(assert (= o96 (* o95 1000000)))
(assert (and (= o97 o96) (in_range1 o96)))
(assert (= o98 (- target6 o97)))
(assert (and (= o99 o98) (in_range1 o98)))
(assert (= result15 (mk_int__ref target6)))
(assert (= target7 o99))
(assert (<= (- 9999999) target7))
(assert (and (= temp___2087 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (not (<= (to_rep1 n__first) temp___2087)))
(check-sat)
(exit)
