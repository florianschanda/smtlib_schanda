...
(assert (=> (= result true) (and (= o2 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o2 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
...
(assert (=> (= result true) (=> (= result1 true) (and (= o1 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o1)))))
...
(assert (and (= result2 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result2 true) (in_range4 (to_rep1 theadmin__split_fields1)))))
(assert (= result2 true))
