...
(assert (and (= o9 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o9) (= o9 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
...
(assert (= result2 true))
(assert (and (= o4 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2)) (= (= o4 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2) true))))
(assert (= o5 true))
...
(assert (= result3 true))
(assert (and (= o2 (has_key (positions x) c3)) (= (= o2 true) (= (has_key (positions x) c3) true))))
(assert (= o3 true))
