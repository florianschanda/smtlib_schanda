...
(define-fun tint_arrayD1__ref___5__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___5__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t128b__ref (mk_t128b__ref (t128b__content integer)))))
(define-fun t128b__ref___projection ((a t128b__ref)) integer (t128b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t129b__ref (mk_t129b__ref (t129b__content us_t2)))))
(define-fun t129b__ref___projection ((a t129b__ref)) us_t2 (t129b__content a))
...
(define-fun tnumber_array_typeD1__ref___5__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___5__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t132b__ref (mk_t132b__ref (t132b__content integer)))))
(define-fun t132b__ref___projection ((a t132b__ref)) integer (t132b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t134b__ref (mk_t134b__ref (t134b__content integer)))))
(define-fun t134b__ref___projection ((a t134b__ref)) integer (t134b__content a))
...
(define-fun tint_arrayB__ref___5__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___1326 Int) (temp___1327 Int) (temp___1328 Int) (temp___1329 Int) (temp___1330 Int) (temp___1331 Int) (temp___1332 Int) (temp___1333 Int) (temp___1334 Int) (temp___1335 Int) (temp___1336 Int) (temp___1337 Int)) (let ((temp___1325 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def temp___1326 temp___1327 temp___1328 temp___1329 temp___1330 temp___1331 temp___1332 temp___1333 temp___1334 temp___1335 temp___1336 temp___1337))) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1336 temp___1337) (and (= (first5 temp___1325) temp___1336) (= (last5 temp___1325) temp___1337))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1325) (+ (first1 source) 0)) (of_rep1 temp___1326)) (= (select (to_array2 temp___1325) (+ (first1 source) 1)) (of_rep1 temp___1327))) (= (select (to_array2 temp___1325) (+ (first1 source) 2)) (of_rep1 temp___1328))) (= (select (to_array2 temp___1325) (+ (first1 source) 3)) (of_rep1 temp___1329))) (= (select (to_array2 temp___1325) (+ (first1 source) 4)) (of_rep1 temp___1330))) (= (select (to_array2 temp___1325) (+ (first1 source) 5)) (of_rep1 temp___1331))) (= (select (to_array2 temp___1325) (+ (first1 source) 6)) (of_rep1 temp___1332))) (= (select (to_array2 temp___1325) (+ (first1 source) 7)) (of_rep1 temp___1333))) (= (select (to_array2 temp___1325) (+ (first1 source) 8)) (of_rep1 temp___1334))) (= (select (to_array2 temp___1325) (+ (first1 source) 9)) (of_rep1 temp___1335)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___5__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___1343 Int) (temp___1344 Int) (temp___1345 Int)) (let ((temp___1342 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def temp___1343 temp___1344 temp___1345))) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1344 temp___1345) (and (= (first9 temp___1342) temp___1344) (= (last9 temp___1342) temp___1345))) (forall ((temp___1346 Int)) (= (select (to_array4 temp___1342) temp___1346) (of_rep1 temp___1343)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_239 us_t3) (temp___is_init_236 Bool) (temp___skip_constant_237 Bool) (temp___do_toplevel_238 Bool)) Bool (=> (not (= temp___skip_constant_237 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_239) (last7 temp___expr_239)) (and (= (first7 temp___expr_239) (first1 source)) (= (last7 temp___expr_239) (+ (first1 source) 9))))))
...
(declare-const temp___1365 Int)
(declare-const o12 Int)
(declare-const o13 character)
(declare-const o14 Int)
(declare-const o15 Bool)
(declare-const temp___1366 Int)
...
(declare-const temp___1340 (Array Int integer))
(declare-const temp___13401 t2)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume1 t1)
(declare-const us Int)
(declare-const temp___1348 (Array Int integer))
(declare-const temp___13481 t4)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume1 t3)
(declare-const us1 Int)
(declare-const temp___1355 Int)
(declare-const temp___1352 (Array Int integer))
(declare-const temp___1350 Int)
...
(assert (and (and (= (length source) 10) (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 56))) (forall ((index11 Int)) (=> (and (<= (to_rep1 (first (rt source))) index11) (<= index11 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def 2 1 4 7 4 7 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def 2 1 4 7 4 7 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t2 temp___1340 temp___13401) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def 2 1 4 7 4 7 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___13401)) (to_rep1 (last4 temp___13401))) (+ (- (to_rep1 (last4 temp___13401)) (to_rep1 (first4 temp___13401))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1340 (to_rep1 (first4 temp___13401)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume))
(assert (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume1))))
...
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t4 temp___1348 temp___13481) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___13481)) (to_rep1 (last8 temp___13481))) (+ (- (to_rep1 (last8 temp___13481)) (to_rep1 (first8 temp___13481))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1348 (to_rep1 (first8 temp___13481)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume))
(assert (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume1))))
...
(assert (and (= temp___1355 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index2 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= temp___1352 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= temp___1350 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= o21 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= o22 (select n1 o21))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= o23 (to_rep1 o22))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= o23 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= o24 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= o25 (select (elts source) o24))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= o26 (to_rep o25))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o26))) (ite (= (= o26 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o26 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o26 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o26 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o26 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o26 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o26 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o26 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o26 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o26 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= (to_rep1 o27) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= o28 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= o29 (store n1 o28 o27))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= n2 o29)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3)) (forall ((temp___1353 Int)) (=> (and (<= (to_rep1 n__first) temp___1353) (<= temp___1353 (to_rep1 n__last))) (=> (< index3 temp___1353) (= (select n3 temp___1353) (select temp___1352 temp___1353)))))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= index3 temp___1355)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= index3 index5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= n3 n5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= index6 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= n6 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= index8 index6)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (= n8 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355))) (= index8 index2)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355))) (= n8 n1)))
...
(assert (and (= temp___1356 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1356) (<= temp___1356 (to_rep1 n__last))))
(assert (= o53 temp___1356))
(assert (= o54 (select (map__content1 n7) o53)))
(assert (= o55 (to_rep1 o54)))
(assert (= result6 (mk_int__ref target)))
(assert (= target1 o55))
(assert (<= target1 9))
(assert (and (= temp___1357 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1357) (<= temp___1357 (to_rep1 n__last))))
(assert (= o56 temp___1357))
(assert (= o57 (select (map__content1 n7) o56)))
(assert (= o58 (to_rep1 o57)))
(assert (= o59 (* o58 10)))
(assert (and (= o60 o59) (in_range1 o59)))
(assert (= o61 (+ target1 o60)))
(assert (and (= o62 o61) (in_range1 o61)))
(assert (= result7 (mk_int__ref target1)))
(assert (= target2 o62))
(assert (<= target2 99))
(assert (and (= temp___1358 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1358) (<= temp___1358 (to_rep1 n__last))))
(assert (= o63 temp___1358))
(assert (= o64 (select (map__content1 n7) o63)))
(assert (= o65 (to_rep1 o64)))
(assert (= o66 (* o65 100)))
(assert (and (= o67 o66) (in_range1 o66)))
(assert (= o68 (+ target2 o67)))
(assert (and (= o69 o68) (in_range1 o68)))
(assert (= result8 (mk_int__ref target2)))
(assert (= target3 o69))
(assert (<= target3 999))
(assert (and (= temp___1359 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___1359) (<= temp___1359 (to_rep1 n__last))))
(assert (= o70 temp___1359))
(assert (= o71 (select (map__content1 n7) o70)))
(assert (= o72 (to_rep1 o71)))
(assert (= o73 (* o72 1000)))
(assert (and (= o74 o73) (in_range1 o73)))
(assert (= o75 (+ target3 o74)))
(assert (not (in_range1 o75)))
(check-sat)
(exit)
