...
(assert (=> (= rest3 0) (= n3 result4)))
(assert (=> (= rest3 0) (= n4 0)))
(assert (=> (not (= rest3 0)) (and (= o10 (+ (- n3 80) 1)) (in_range4 (+ (- n3 80) 1)))))
(assert (=> (not (= rest3 0)) (= n3 result5)))
(assert (=> (not (= rest3 0)) (= n5 o10)))
(assert (=> (not (= rest3 0)) (= n4 n5)))
(assert (<= 80 n4))
(assert (not (<= (to_rep1 item__first) (+ last7 1))))
(check-sat)
(exit)
