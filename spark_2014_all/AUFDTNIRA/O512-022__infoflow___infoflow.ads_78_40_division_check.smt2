...
(assert (in_range1 i))
(assert (=> (and (<= (to_rep h_v1__first) i) (<= i (to_rep h_v1__last))) (= result2 (ite (= (to_rep h_v1__first) 1) true false))))
(assert (=> (not (and (<= (to_rep h_v1__first) i) (<= i (to_rep h_v1__last)))) (= result2 false)))
(assert (=> (= result2 true) (= result1 (ite (= (to_rep h_v2__first) 1) true false))))
(assert (=> (not (= result2 true)) (= result1 false)))
(assert (=> (= result1 true) (= result (ite (= (to_rep h_v1__last) (to_rep h_v2__last)) true false))))
