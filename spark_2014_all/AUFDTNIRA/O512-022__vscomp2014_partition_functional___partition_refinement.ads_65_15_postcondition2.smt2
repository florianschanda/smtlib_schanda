...
(assert (=> (= result1 true) (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (to_rep (select a3 j))) true)))))
...
(assert (=> (= result1 true) (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= 0 (to_rep5 (select f j))) (<= (to_rep5 (select f j)) (- (length1 (mk___rep4 p__split_discrs p__split_fields3)) 1)))))))
(assert (=> (= result1 true) (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields3)) (to_rep5 (select f j)))))) j) (<= j (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields3)) (to_rep5 (select f j))))))))))))
(assert (=> (= result1 true) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (length1 (mk___rep4 p__split_discrs p__split_fields3)) 1))) (forall ((k Int)) (=> (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields3)) j)))) k) (<= k (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields3)) j)))))) (= (to_rep5 (select f k)) j)))))))
...
(assert (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= 0 (to_rep5 (select f1 j))) (<= (to_rep5 (select f1 j)) (- (length1 (mk___rep4 p__split_discrs p__split_fields8)) 1))))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields8)) (to_rep5 (select f1 j)))))) j) (<= j (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields8)) (to_rep5 (select f1 j)))))))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (length1 (mk___rep4 p__split_discrs p__split_fields8)) 1))) (forall ((k Int)) (=> (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields8)) j)))) k) (<= k (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields8)) j)))))) (= (to_rep5 (select f1 k)) j))))))))
