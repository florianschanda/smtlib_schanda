...
(define-fun dynamic_invariant3 ((temp___expr_1256 Int) (temp___is_init_1253 Bool) (temp___skip_constant_1254 Bool) (temp___do_toplevel_1255 Bool)) Bool (=> (or (= temp___is_init_1253 true) (<= 0 1)) (in_range16 temp___expr_1256)))
...
(define-fun dynamic_invariant4 ((temp___expr_1278 Int) (temp___is_init_1275 Bool) (temp___skip_constant_1276 Bool) (temp___do_toplevel_1277 Bool)) Bool (=> (or (= temp___is_init_1275 true) (<= 0 1)) (in_range17 temp___expr_1278)))
...
(assert (forall ((door__currentdoor Int)) (! (=> (dynamic_invariant4 door__currentdoor true true true) (dynamic_invariant4 (thecurrentdoor door__currentdoor) true false true)) :pattern ((thecurrentdoor door__currentdoor)))))
(assert (forall ((door__currentdoor Int)) (! (=> (dynamic_invariant4 door__currentdoor true true true) (= (thecurrentdoor door__currentdoor) door__currentdoor)) :pattern ((thecurrentdoor door__currentdoor)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1315 us_void_param) 1)) 68) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 2)) 79)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 3)) 79)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 4)) 82)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 6)) 83)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 7)) 84)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 8)) 65)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 9)) 84)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 10)) 69)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 12)) 67)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 13)) 65)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 14)) 78)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 15)) 78)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 16)) 79)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 17)) 84)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 19)) 66)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 20)) 69)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 22)) 68)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 23)) 69)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 24)) 84)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 25)) 69)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 26)) 82)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 27)) 77)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 28)) 73)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 29)) 78)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 30)) 69)) (= (to_rep (select (temp___String_Literal_1315 us_void_param) 31)) 68)) :pattern ((temp___String_Literal_1315 us_void_param)))))
...
(define-fun dynamic_invariant9 ((temp___expr_1056 Int) (temp___is_init_1053 Bool) (temp___skip_constant_1054 Bool) (temp___do_toplevel_1055 Bool)) Bool (=> (or (= temp___is_init_1053 true) (<= 0 17)) (in_range13 temp___expr_1056)))
(define-fun dynamic_invariant10 ((temp___expr_1035 Int) (temp___is_init_1032 Bool) (temp___skip_constant_1033 Bool) (temp___do_toplevel_1034 Bool)) Bool (=> (or (= temp___is_init_1032 true) (<= 1 17)) (in_range11 temp___expr_1035)))
(define-fun dynamic_invariant11 ((temp___expr_1160 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 2)) (in_range15 temp___expr_1160)))
(define-fun dynamic_invariant12 ((temp___expr_1041 Int) (temp___is_init_1038 Bool) (temp___skip_constant_1039 Bool) (temp___do_toplevel_1040 Bool)) Bool (=> (or (= temp___is_init_1038 true) (<= 0 17408)) (in_range12 temp___expr_1041)))
(define-fun dynamic_invariant13 ((temp___expr_1075 Int) (temp___is_init_1072 Bool) (temp___skip_constant_1073 Bool) (temp___do_toplevel_1074 Bool)) Bool (=> (or (= temp___is_init_1072 true) (<= 0 1024)) (in_range14 temp___expr_1075)))
(assert true)
...
(define-fun dynamic_invariant14 ((temp___expr_378 Int) (temp___is_init_375 Bool) (temp___skip_constant_376 Bool) (temp___do_toplevel_377 Bool)) Bool (=> (or (= temp___is_init_375 true) (<= 1 150)) (in_range6 temp___expr_378)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_136 Tuple0)))
(define-fun dynamic_invariant15 ((temp___expr_424 Int) (temp___is_init_421 Bool) (temp___skip_constant_422 Bool) (temp___do_toplevel_423 Bool)) Bool (=> (or (= temp___is_init_421 true) (<= 1901 2099)) (in_range7 temp___expr_424)))
(define-fun dynamic_invariant16 ((temp___expr_430 Int) (temp___is_init_427 Bool) (temp___skip_constant_428 Bool) (temp___do_toplevel_429 Bool)) Bool (=> (or (= temp___is_init_427 true) (<= 1 12)) (in_range8 temp___expr_430)))
(define-fun dynamic_invariant17 ((temp___expr_436 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 1 31)) (in_range9 temp___expr_436)))
(define-fun dynamic_invariant18 ((temp___expr_464 Int) (temp___is_init_461 Bool) (temp___skip_constant_462 Bool) (temp___do_toplevel_463 Bool)) Bool (=> (or (= temp___is_init_461 true) (<= 0 86399999)) (in_range10 temp___expr_464)))
(assert true)
...
(declare-const currentdoor1 Int)
...
(declare-const currentdoor2 Int)
...
(declare-const logfilestate__split_fields12 us_split_fields__ref2)
...
(declare-const currentdoor3 int__ref)
(declare-const dooralarm2 int__ref)
(declare-const newdoor2 int__ref)
...
(declare-const currentdoor4 Int)
(declare-const dooralarm3 Int)
(declare-const newdoor3 Int)
