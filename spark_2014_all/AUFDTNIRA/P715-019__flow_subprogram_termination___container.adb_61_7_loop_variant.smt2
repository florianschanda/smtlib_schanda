...
(assert (= result8 (mk_int__ref temp___5591)))
(assert (= temp___5592 i2))
(assert (= result9 (mk_int__ref temp___5581)))
(assert (= temp___5582 r2))
(assert (and (= o6 (- r2 i2)) (in_range3 (- r2 i2))))
(assert (= result10 (mk_int__ref r2)))
(assert (= r3 o6))
(assert (and (= o7 (+ i2 1)) (in_range4 (+ i2 1))))
(assert (= result11 (mk_int__ref i2)))
(assert (= i3 o7))
(assert (< i3 10))
(assert (not (or (< temp___5592 i3) (and (= i3 temp___5592) (< r3 temp___5582)))))
(check-sat)
(exit)
