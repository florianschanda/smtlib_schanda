...
(assert (= result8 (mk_int__ref temp___634)))
(assert (= temp___6341 i2))
(assert (= result9 (mk_int__ref temp___633)))
(assert (= temp___6331 r2))
...
(assert (= i3 o4))
(assert (< i3 10))
(assert (not (or (< temp___6341 i3) (and (= i3 temp___6341) (< r3 temp___6331)))))
(check-sat)
(exit)
