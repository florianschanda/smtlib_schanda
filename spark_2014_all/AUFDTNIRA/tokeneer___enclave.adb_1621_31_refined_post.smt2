...
(assert (=> (= result true) (=> (= status 3) (= o (extractuser tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))))))
(assert (=> (= result true) (=> (= status 3) (and (= (valid_numberlogentries (to_rep4 logfilestate__split_fields14) (to_rep5 logfilestate__split_fields15) (mk___rep1 (mk___split_fields1 logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20) true) (in_range9 auditalarm2)))))
(assert (=> (= result true) (=> (= status 3) (and (and (in_range4 tokenpresence2) (in_range17 tokentry2)) (in_range16 tokenid2)))))
(assert (=> (= result true) (=> (= status 3) (= status2 status))))
(assert (=> (= result true) (=> (= status 3) (= status2 status1))))
(assert (=> (= result true) (=> (not (= status 3)) (=> (=> (not (= status 6)) (= status 7)) (and (= status2 3) (and (and (and (and (and (in_range4 tokenpresence3) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields21)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields21)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields21) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields21)) true)) (in_range9 auditalarm3)) (in_range17 tokentry3)) (in_range29 status2)) (in_range16 tokenid3)))))))
...
(assert (=> (= result true) (=> (not (= status 3)) (=> (not (=> (not (= status 6)) (= status 7))) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref11 idcert__split_fields3)) idcert__split_fields)))))
(assert (=> (= result true) (=> (not (= status 3)) (=> (not (=> (not (= status 6)) (= status 7))) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref8 authcert__split_fields3)) authcert__split_fields)))))
...
(assert (=> (= result true) (=> (not (= status 3)) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref11 idcert__split_fields2)) (let ((subject idcert__split_fields)) (mk___split_fields__ref11 idcert__split_fields3))))))
(assert (=> (= result true) (=> (not (= status 3)) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref8 authcert__split_fields2)) (let ((subject authcert__split_fields)) (mk___split_fields__ref8 authcert__split_fields3))))))
...
(assert (=> (= result true) (=> (not (= status 3)) (= (mk___split_fields2 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep1 (mk___split_fields1 logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20) logfilestate__split_fields21))))
...
(assert (=> (= result true) (=> (not (= status 3)) (= logfilesstatus2 logfilesstatus3))))
(assert (=> (= result true) (=> (not (= status 3)) (= logfiles2 logfiles3))))
(assert (=> (not (= result true)) (= o1 (extractuser tokenpresence state1 tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)))))
(assert (=> (not (= result true)) (and (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields22)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields22)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields22) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields22)) true) (in_range9 auditalarm4))))
...
(assert (=> (not (= result true)) (= (mk___split_fields2 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep1 (mk___split_fields1 logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20) logfilestate__split_fields22)))
...
(assert (= idcert__split_fields4 (let ((subject idcert__split_fields)) (mk___split_fields__ref11 idcert__split_fields2))))
(assert (= authcert__split_fields4 (let ((subject authcert__split_fields)) (mk___split_fields__ref8 authcert__split_fields2))))
...
(assert (= logfilestate__split_fields23 (mk___split_fields__ref2 (mk___split_fields2 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep1 (mk___split_fields1 logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20))))
(assert (= logfilesstatus5 (mk_map__ref4 logfilesstatus2)))
(assert (= logfiles5 (mk_map__ref3 logfiles2)))
...
(assert (= logfilestate__split_fields24 (mk___split_fields2 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep1 (mk___split_fields1 logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20)))
