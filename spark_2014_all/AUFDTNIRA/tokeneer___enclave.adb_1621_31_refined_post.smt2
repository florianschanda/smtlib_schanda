...
(assert (=> (= result true) (=> (= status 3) (and (in_range9 auditalarm2) (= (valid_numberlogentries (to_rep4 logfilestate__split_fields14) (to_rep5 logfilestate__split_fields15) (mk___rep1 (mk___split_fields1 logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20) true)))))
(assert (=> (= result true) (=> (= status 3) (and (and (in_range17 tokentry2) (in_range16 tokenid2)) (in_range4 tokenpresence2)))))
(assert (=> (= result true) (=> (= status 3) (= status2 status))))
(assert (=> (= result true) (=> (= status 3) (= status2 status1))))
(assert (=> (= result true) (=> (not (= status 3)) (=> (=> (not (= status 6)) (= status 7)) (and (= status2 3) (and (and (and (and (and (in_range9 auditalarm3) (in_range17 tokentry3)) (in_range16 tokenid3)) (in_range29 status2)) (in_range4 tokenpresence3)) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields21)) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields21)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields21) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields21)) true)))))))
