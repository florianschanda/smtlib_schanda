...
(assert (<= 0 k))
(assert (<= k 5))
(assert (and (= o14 (get (model__ (mk___rep1 p__split_discrs (us_split_fields__content1 p__split_fields4))) (to_rep2 (select (map__content f8) k)))) (= (bool_eq o14 (get (model__ (mk___rep1 p__split_discrs (us_split_fields__content1 p__split_fields4))) (to_rep2 (select (map__content f8) k)))) true)))
...
(assert (not (<= 0 (to_rep2 (select (map__content f8) k)))))
(check-sat)
(exit)
