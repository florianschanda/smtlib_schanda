...
(assert (= o14 (extractuser tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))))
...
(assert (= result10 (mk_int__ref status)))
(assert (= status1 3))
