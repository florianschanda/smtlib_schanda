...
(assert (=> (< max_sum2 current_sum3) (and (= o5 current_sum3) (in_range2 current_sum3))))
(assert (=> (< max_sum2 current_sum3) (= result6 (mk_int__ref max_sum2))))
(assert (=> (< max_sum2 current_sum3) (= max_sum3 o5)))
(assert (=> (< max_sum2 current_sum3) (= (indexqtint o6) current_lo2)))
(assert (=> (< max_sum2 current_sum3) (= o7 (mk___split_fields o6 (rec__sums__slice_bounds__hi result____split_fields3)))))
(assert (=> (< max_sum2 current_sum3) (= temp___204 (mk_slice_bounds o7))))
(assert (=> (< max_sum2 current_sum3) (= result7 (mk___split_fields__ref result____split_fields3))))
(assert (=> (< max_sum2 current_sum3) (= result____split_fields4 (us_split_fields1 temp___204))))
(assert (=> (< max_sum2 current_sum3) (and (= o8 current_hi2) (in_range4 current_hi2))))
(assert (=> (< max_sum2 current_sum3) (= (extended_indexqtint o9) o8)))
(assert (=> (< max_sum2 current_sum3) (= o10 (mk___split_fields (rec__sums__slice_bounds__lo result____split_fields4) o9))))
(assert (=> (< max_sum2 current_sum3) (= temp___206 (mk_slice_bounds o10))))
(assert (=> (< max_sum2 current_sum3) (= result8 (mk___split_fields__ref result____split_fields4))))
(assert (=> (< max_sum2 current_sum3) (= result____split_fields5 (us_split_fields1 temp___206))))
(assert (=> (< max_sum2 current_sum3) (= current_lo3 current_lo2)))
(assert (=> (< max_sum2 current_sum3) (= current_sum4 current_sum3)))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi2 65536)) (and (= o11 (+ current_hi2 1)) (in_range1 (+ current_hi2 1)))))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi2 65536)) (and (= o12 o11) (in_range3 o11))))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi2 65536)) (= result9 (mk_int__ref current_lo2))))))
(assert (=> (not (< max_sum2 current_sum3)) (=> (< current_sum3 0) (=> (not (= current_hi2 65536)) (= current_lo3 o12)))))
...
(assert (not (= current_hi2 (to_rep (last (rt x))))))
(assert (= result11 (mk_int__ref current_hi2)))
(assert (= current_hi3 (+ current_hi2 1)))
(assert (not (<= (to_rep (first (rt x))) current_lo3)))
(check-sat)
(exit)
