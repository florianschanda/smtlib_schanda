...
(declare-fun user_eq4 (tlogentrycounttB tlogentrycounttB) Bool)
(declare-const dummy4 tlogentrycounttB)
...
(assert (forall ((x logentrycountt)) (! (in_range6 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x logfilecountt)) (! (in_range7 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x fileentrycountt)) (! (in_range8 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x filestatust)) (! (in_range9 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_1093 Int) (temp___is_init_1090 Bool) (temp___skip_constant_1091 Bool) (temp___do_toplevel_1092 Bool)) Bool (=> (or (= temp___is_init_1090 true) (<= 0 17)) (in_range7 temp___expr_1093)))
(define-fun dynamic_invariant4 ((temp___expr_1072 Int) (temp___is_init_1069 Bool) (temp___skip_constant_1070 Bool) (temp___do_toplevel_1071 Bool)) Bool (=> (or (= temp___is_init_1069 true) (<= 1 17)) (in_range4 temp___expr_1072)))
(define-fun dynamic_invariant5 ((temp___expr_1184 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 0 2)) (in_range9 temp___expr_1184)))
(define-fun dynamic_invariant6 ((temp___expr_1078 Int) (temp___is_init_1075 Bool) (temp___skip_constant_1076 Bool) (temp___do_toplevel_1077 Bool)) Bool (=> (or (= temp___is_init_1075 true) (<= 0 17408)) (in_range6 temp___expr_1078)))
(define-fun dynamic_invariant7 ((temp___expr_1112 Int) (temp___is_init_1109 Bool) (temp___skip_constant_1110 Bool) (temp___do_toplevel_1111 Bool)) Bool (=> (or (= temp___is_init_1109 true) (<= 0 1024)) (in_range8 temp___expr_1112)))
(assert true)
...
(declare-const o6 logentrycountt)
(declare-const o7 logfileindext)
(declare-const o8 logentrycountt)
(declare-const o9 (Array Int logfileindext))
(declare-const o10 logfileindext)
(declare-const o11 logfileindext)
(declare-const o12 logfilecountt)
(declare-const o13 (Array Int fileentrycountt))
(declare-const temp___1635 logfileindext)
(declare-const temp___16351 logentrycountt)
(declare-const temp___16352 (Array Int logfileindext))
(declare-const temp___16353 logfileindext)
(declare-const temp___16354 logfileindext)
(declare-const temp___16355 logfilecountt)
(declare-const temp___16356 (Array Int fileentrycountt))
...
(declare-const result2 logentrycountt)
(declare-const result3 (Array Int logfileindext))
(declare-const result4 logfileindext)
(declare-const result5 logfileindext)
(declare-const result6 logfilecountt)
(declare-const result7 (Array Int fileentrycountt))
...
(assert (and (= (valid_numberlogentries__2 (mk___rep1 (mk___split_fields1 logfilestate__split_fields logfilestate__split_fields1 (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))) true) (and (< (to_rep2 logfilestate__split_fields1) 17408) (and (or (< (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024) (< (to_rep3 logfilestate__split_fields5) 17)) (= (to_rep2 logfilestate__split_fields1) (+ (* (- (to_rep3 logfilestate__split_fields5) 1) 1024) (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields)))))))))
(assert (=> (< (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024) (and (= (to_rep4 (select logfilestate__split_fields13 (to_rep1 logfilestate__split_fields7))) (+ (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields7))) 1)) (and (= (to_rep1 logfilestate__split_fields7) (to_rep1 logfilestate__split_fields)) (and (= (bool_eq2 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5))) true) (= (to_rep2 logfilestate__split_fields8) (to_rep2 logfilestate__split_fields1)))))))
(assert (=> (< (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024) (= logfilesstatus2 logfilesstatus)))
(assert (=> (< (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024) (= logfilesstatus2 logfilesstatus1)))
(assert (=> (not (< (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024)) (and (and (= (to_rep3 logfilestate__split_fields19) (+ (to_rep3 logfilestate__split_fields5) 1)) (= (to_rep4 (select logfilestate__split_fields20 (to_rep1 logfilestate__split_fields14))) 1)) (= (to_rep2 logfilestate__split_fields15) (to_rep2 logfilestate__split_fields1)))))
(assert (=> (not (< (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024)) (= (mk___split_fields1 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) (mk___split_fields1 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20))))
(assert (=> (not (< (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024)) (= auditsystemfault auditsystemfault1)))
(assert (=> (not (< (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024)) (= logfiles logfiles1)))
(assert (not (in_range6 (+ (to_rep2 logfilestate__split_fields8) 1))))
(check-sat)
(exit)
