...
(define-fun to_rep ((x logfileindext)) Int (logfileindextqtint x))
...
(declare-fun user_eq1 (logentrycountt logentrycountt) Bool)
(declare-const dummy1 logentrycountt)
...
(define-fun to_rep1 ((x logentrycountt)) Int (logentrycounttqtint x))
...
(define-fun to_rep2 ((x logfilecountt)) Int (logfilecounttqtint x))
...
(define-fun to_rep3 ((x fileentrycountt)) Int (fileentrycounttqtint x))
...
(declare-const dummy6 (Array Int fileentrycountt))
...
(declare-fun user_eq6 ((Array Int fileentrycountt) (Array Int fileentrycountt)) Bool)
...
(define-fun bool_eq5 ((a (Array Int us_rep2)) (a__first Int) (a__last Int) (b (Array Int us_rep2)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq4 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true)))) true false))
...
(assert (forall ((x character)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x character)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
(assert (forall ((x Int)) (! (=> (in_range5 x) (= (to_rep4 (of_rep4 x)) x)) :pattern ((to_rep4 (of_rep4 x))))))
(declare-datatypes () ((map__ref3 (mk_map__ref3 (map__content3 (Array Int character))))))
(declare-fun slide3 ((Array Int character) Int Int) (Array Int character))
(assert (forall ((a (Array Int character))) (forall ((first Int)) (! (= (slide3 a first first) a) :pattern ((slide3 a first first))))))
(assert (forall ((a (Array Int character))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide3 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide3 a old_first new_first) i))))))))
(define-fun bool_eq6 ((a (Array Int character)) (a__first Int) (a__last Int) (b (Array Int character)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep4 (select a temp___idx_91)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_91))))))) true false))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep4 (select a temp___idx_91)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_91)))))))))))
...
(assert (forall ((x filestatust)) (! (in_range6 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun in_range7 ((x Int)) Bool (and (<= 0 x) (<= x 43)))
(declare-fun attr__ATTRIBUTE_IMAGE7 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check7 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE7 (us_image) Int)
(declare-fun user_eq11 (elementt elementt) Bool)
(declare-const dummy11 elementt)
...
(define-fun dynamic_invariant ((temp___expr_538 Int) (temp___is_init_534 Bool) (temp___skip_constant_535 Bool) (temp___do_toplevel_536 Bool) (temp___do_typ_inv_537 Bool)) Bool (=> (or (= temp___is_init_534 true) (<= 0 43)) (in_range7 temp___expr_538)))
(declare-sort severityt 0)
(define-fun in_range8 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
(declare-fun attr__ATTRIBUTE_IMAGE8 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check8 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE8 (us_image) Int)
(declare-fun user_eq12 (severityt severityt) Bool)
(declare-const dummy12 severityt)
...
(define-fun dynamic_invariant1 ((temp___expr_549 Int) (temp___is_init_545 Bool) (temp___skip_constant_546 Bool) (temp___do_toplevel_547 Bool) (temp___do_typ_inv_548 Bool)) Bool (=> (or (= temp___is_init_545 true) (<= 0 2)) (in_range8 temp___expr_549)))
...
(declare-fun user_eq13 (tlogentrycounttB tlogentrycounttB) Bool)
(declare-const dummy13 tlogentrycounttB)
...
(define-fun dynamic_invariant2 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range5 temp___expr_74)))
(define-fun dynamic_invariant3 ((temp___expr_1197 Int) (temp___is_init_1193 Bool) (temp___skip_constant_1194 Bool) (temp___do_toplevel_1195 Bool) (temp___do_typ_inv_1196 Bool)) Bool (=> (or (= temp___is_init_1193 true) (<= 0 17)) (in_range3 temp___expr_1197)))
(define-fun dynamic_invariant4 ((temp___expr_1204 Int) (temp___is_init_1200 Bool) (temp___skip_constant_1201 Bool) (temp___do_toplevel_1202 Bool) (temp___do_typ_inv_1203 Bool)) Bool (=> (or (= temp___is_init_1200 true) (<= 1 17)) (in_range1 temp___expr_1204)))
(define-fun dynamic_invariant5 ((temp___expr_1317 Int) (temp___is_init_1313 Bool) (temp___skip_constant_1314 Bool) (temp___do_toplevel_1315 Bool) (temp___do_typ_inv_1316 Bool)) Bool (=> (or (= temp___is_init_1313 true) (<= 0 2)) (in_range6 temp___expr_1317)))
(define-fun dynamic_invariant6 ((temp___expr_1211 Int) (temp___is_init_1207 Bool) (temp___skip_constant_1208 Bool) (temp___do_toplevel_1209 Bool) (temp___do_typ_inv_1210 Bool)) Bool (=> (or (= temp___is_init_1207 true) (<= 0 17408)) (in_range2 temp___expr_1211)))
(define-fun dynamic_invariant7 ((temp___expr_1242 Int) (temp___is_init_1238 Bool) (temp___skip_constant_1239 Bool) (temp___do_toplevel_1240 Bool) (temp___do_typ_inv_1241 Bool)) Bool (=> (or (= temp___is_init_1238 true) (<= 0 1024)) (in_range4 temp___expr_1242)))
(assert true)
...
(assert (forall ((temp___1266 Int)) (=> (dynamic_invariant4 temp___1266 true true true true) (forall ((temp___1267 Int)) (= (select (temp_____aggregate_def_1264 temp___1266) temp___1267) rliteral)))))
...
(assert (in_range7 elementid))
(assert (in_range8 severity))
(assert (and (= (valid_numberlogentries__2 (mk___rep1 (mk___split_fields1 logfilestate__split_fields logfilestate__split_fields1 (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))) true) (and (< (to_rep1 logfilestate__split_fields1) 17408) (and (or (< (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024) (< (to_rep2 logfilestate__split_fields5) 17)) (= (to_rep1 logfilestate__split_fields1) (+ (* (- (to_rep2 logfilestate__split_fields5) 1) 1024) (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields)))))))))
(assert (=> (< (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024) (and (= (to_rep3 (select logfilestate__split_fields13 (to_rep logfilestate__split_fields7))) (+ (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields7))) 1)) (and (= (to_rep logfilestate__split_fields7) (to_rep logfilestate__split_fields)) (and (= (bool_eq1 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5))) true) (= (to_rep1 logfilestate__split_fields8) (to_rep1 logfilestate__split_fields1)))))))
(assert (=> (< (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024) (= logfilesstatus2 logfilesstatus)))
(assert (=> (< (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024) (= logfilesstatus2 logfilesstatus1)))
(assert (=> (not (< (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024)) (and (and (= (to_rep2 logfilestate__split_fields19) (+ (to_rep2 logfilestate__split_fields5) 1)) (= (to_rep3 (select logfilestate__split_fields20 (to_rep logfilestate__split_fields14))) 1)) (= (to_rep1 logfilestate__split_fields15) (to_rep1 logfilestate__split_fields1)))))
(assert (=> (not (< (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024)) (= (mk___split_fields1 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) (mk___split_fields1 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20))))
(assert (=> (not (< (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024)) (= auditsystemfault auditsystemfault1)))
(assert (=> (not (< (to_rep3 (select logfilestate__split_fields6 (to_rep logfilestate__split_fields))) 1024)) (= logfiles logfiles1)))
(assert (not (in_range2 (+ (to_rep1 logfilestate__split_fields8) 1))))
(check-sat)
(exit)
