...
(define-fun dynamic_invariant3 ((temp___expr_1204 Int) (temp___is_init_1200 Bool) (temp___skip_constant_1201 Bool) (temp___do_toplevel_1202 Bool) (temp___do_typ_inv_1203 Bool)) Bool (=> (or (= temp___is_init_1200 true) (<= 0 17)) (in_range4 temp___expr_1204)))
(define-fun dynamic_invariant4 ((temp___expr_1211 Int) (temp___is_init_1207 Bool) (temp___skip_constant_1208 Bool) (temp___do_toplevel_1209 Bool) (temp___do_typ_inv_1210 Bool)) Bool (=> (or (= temp___is_init_1207 true) (<= 1 17)) (in_range5 temp___expr_1211)))
(define-fun dynamic_invariant5 ((temp___expr_1324 Int) (temp___is_init_1320 Bool) (temp___skip_constant_1321 Bool) (temp___do_toplevel_1322 Bool) (temp___do_typ_inv_1323 Bool)) Bool (=> (or (= temp___is_init_1320 true) (<= 0 2)) (in_range9 temp___expr_1324)))
(define-fun dynamic_invariant6 ((temp___expr_1218 Int) (temp___is_init_1214 Bool) (temp___skip_constant_1215 Bool) (temp___do_toplevel_1216 Bool) (temp___do_typ_inv_1217 Bool)) Bool (=> (or (= temp___is_init_1214 true) (<= 0 17408)) (in_range7 temp___expr_1218)))
(define-fun dynamic_invariant7 ((temp___expr_1249 Int) (temp___is_init_1245 Bool) (temp___skip_constant_1246 Bool) (temp___do_toplevel_1247 Bool) (temp___do_typ_inv_1248 Bool)) Bool (=> (or (= temp___is_init_1245 true) (<= 0 1024)) (in_range8 temp___expr_1249)))
(assert true)
...
(assert (forall ((temp___1273 Int)) (=> (dynamic_invariant4 temp___1273 true true true true) (forall ((temp___1274 Int)) (= (to_rep2 (select (temp___1271 temp___1273) temp___1274)) temp___1273)))))
...
(assert (and (= (valid_numberlogentries__2 (mk___rep1 (mk___split_fields1 logfilestate__split_fields logfilestate__split_fields1 (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6))) true) (and (< (to_rep3 logfilestate__split_fields1) 17408) (and (or (< (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (< (to_rep1 logfilestate__split_fields5) 17)) (= (to_rep3 logfilestate__split_fields1) (+ (* (- (to_rep1 logfilestate__split_fields5) 1) 1024) (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields)))))))))
(assert (=> (< (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (and (= (to_rep4 (select logfilestate__split_fields13 (to_rep2 logfilestate__split_fields7))) (+ (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields7))) 1)) (and (= (to_rep2 logfilestate__split_fields7) (to_rep2 logfilestate__split_fields)) (and (= (bool_eq2 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5))) true) (= (to_rep3 logfilestate__split_fields8) (to_rep3 logfilestate__split_fields1)))))))
(assert (=> (< (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= logfilesstatus2 logfilesstatus)))
(assert (=> (< (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= logfilesstatus2 logfilesstatus1)))
(assert (=> (not (< (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024)) (and (and (= (to_rep1 logfilestate__split_fields19) (+ (to_rep1 logfilestate__split_fields5) 1)) (= (to_rep4 (select logfilestate__split_fields20 (to_rep2 logfilestate__split_fields14))) 1)) (= (to_rep3 logfilestate__split_fields15) (to_rep3 logfilestate__split_fields1)))))
(assert (=> (not (< (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024)) (= (mk___split_fields1 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) (mk___split_fields1 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20))))
(assert (=> (not (< (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024)) (= auditsystemfault auditsystemfault1)))
(assert (=> (not (< (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024)) (= logfiles logfiles1)))
(assert (not (in_range7 (+ (to_rep3 logfilestate__split_fields8) 1))))
(check-sat)
(exit)
