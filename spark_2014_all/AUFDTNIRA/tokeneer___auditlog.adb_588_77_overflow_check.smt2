...
(assert (and (= o5 (+ (to_rep2 logfilestate__split_fields8) 1)) (in_range6 (+ (to_rep2 logfilestate__split_fields8) 1))))
(assert (= (to_rep2 o6) o5))
(assert (= logfilestate__split_fields7 o7))
(assert (= o6 o8))
(assert (= logfilestate__split_fields9 o9))
(assert (= logfilestate__split_fields10 o10))
(assert (= logfilestate__split_fields11 o11))
(assert (= logfilestate__split_fields12 o12))
(assert (= logfilestate__split_fields13 o13))
(assert (= temp___1579 o7))
(assert (= temp___15791 o8))
(assert (= temp___15792 o9))
(assert (= temp___15793 o10))
(assert (= temp___15794 o11))
(assert (= temp___15795 o12))
(assert (= temp___15796 o13))
(assert (= result1 logfilestate__split_fields7))
(assert (= result2 logfilestate__split_fields8))
(assert (= result3 logfilestate__split_fields9))
(assert (= result4 logfilestate__split_fields10))
(assert (= result5 logfilestate__split_fields11))
(assert (= result6 logfilestate__split_fields12))
(assert (= result7 logfilestate__split_fields13))
(assert (= logfilestate__split_fields21 (mk___split_fields1 temp___1579 temp___15791 (mk___rep (mk___split_fields temp___15792 temp___15793 temp___15794 temp___15795)) temp___15796)))
...
(assert (=> (< (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024) (= o20 (ite (= (to_rep4 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields22)) (to_rep1 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields22))))) (+ (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1)) (ite (= (to_rep3 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) (to_rep3 logfilestate__split_fields5)) true false) false))))
(assert (=> (not (< (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024)) (= o20 (of_int 1))))
(assert (=> (= (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024) (= o19 (ite (= (to_rep4 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields22)) (to_rep1 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields22))))) 1) (ite (= (to_rep3 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) (+ (to_rep3 logfilestate__split_fields5) 1)) true false) false))))
(assert (=> (not (= (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024)) (= o19 (of_int 1))))
(assert (and (= o14 (- (to_rep3 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) 1)) (in_range6 (- (to_rep3 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) 1))))
(assert (= o15 (* o14 1024)))
(assert (not (in_range5 o15)))
(check-sat)
(exit)
