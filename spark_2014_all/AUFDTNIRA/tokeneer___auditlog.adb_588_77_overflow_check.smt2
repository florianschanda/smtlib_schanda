...
(declare-const temp___1789 logfileindext)
(declare-const temp___17891 logentrycountt)
(declare-const temp___17892 (Array Int logfileindext))
(declare-const temp___17893 logfileindext)
(declare-const temp___17894 logfileindext)
(declare-const temp___17895 logfilecountt)
(declare-const temp___17896 (Array Int fileentrycountt))
...
(assert (and (= o (+ (to_rep3 logfilestate__split_fields8) 1)) (in_range7 (+ (to_rep3 logfilestate__split_fields8) 1))))
(assert (= (to_rep3 o1) o))
...
(assert (= temp___1789 o2))
(assert (= temp___17891 o3))
(assert (= temp___17892 o4))
(assert (= temp___17893 o5))
(assert (= temp___17894 o6))
(assert (= temp___17895 o7))
(assert (= temp___17896 o8))
...
(assert (= logfilestate__split_fields21 (mk___split_fields1 temp___1789 temp___17891 (mk___rep (mk___split_fields temp___17892 temp___17893 temp___17894 temp___17895)) temp___17896)))
...
(assert (=> (< (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= o12 (ite (= (to_rep4 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields22)) (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields22))))) (+ (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1)) (ite (= (to_rep1 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) (to_rep1 logfilestate__split_fields5)) true false) false))))
(assert (=> (not (< (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024)) (= o12 (distinct 1 0))))
(assert (=> (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024) (= o11 (ite (= (to_rep4 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields22)) (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields22))))) 1) (ite (= (to_rep1 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) (+ (to_rep1 logfilestate__split_fields5) 1)) true false) false))))
(assert (=> (not (= (to_rep4 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))) 1024)) (= o11 (distinct 1 0))))
(assert (and (= o9 (- (to_rep1 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) 1)) (in_range7 (- (to_rep1 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields22))))) 1))))
(assert (= o10 (* o9 1024)))
