...
(assert (= i5 (+ i4 1)))
(assert (= (to_rep2 o66) p_prime_index3))
(assert (= o67 (store f4 i5 o66)))
(assert (= result18 (mk_map__ref f4)))
(assert (= f5 o67))
(declare-const k18 Int)
(assert (<= 0 k18))
(assert (<= k18 (- (to_rep1 (rec__partition_refinement__interval__first p_prime__split_fields5)) 1)))
(assert (not (= (to_rep2 (select f5 k18)) (to_rep2 (select f_loop_entry k18)))))
(check-sat)
(exit)
