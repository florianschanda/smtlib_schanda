...
(assert (=> (= result13 true) (= (ite (<= (to_rep1 (first (rt thestring))) (to_rep1 (last (rt thestring)))) (+ (- (to_rep1 (last (rt thestring))) (to_rep1 (first (rt thestring)))) 1) 0) (ite (<= 1 (length thestring)) (+ (- (length thestring) 1) 1) 0))))
(assert (=> (= result13 true) (= temp___1705 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring))))))
(assert (=> (= result13 true) (and (= temp___1707 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= result13 true) (=> (<= 1 temp___1707) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1707) (<= temp___1707 150))))))
(assert (=> (= result13 true) (= o17 result__5)))
(assert (=> (= result13 true) (= temp___1708 (mk___t1 o17 (mk1 1 temp___1707)))))
(assert (=> (= result13 true) (= (ite (<= (to_rep1 (first2 (rt1 temp___1705))) (to_rep1 (last2 (rt1 temp___1705)))) (+ (- (to_rep1 (last2 (rt1 temp___1705))) (to_rep1 (first2 (rt1 temp___1705)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1708))) (to_rep1 (last2 (rt1 temp___1708)))) (+ (- (to_rep1 (last2 (rt1 temp___1708))) (to_rep1 (first2 (rt1 temp___1708)))) 1) 0))))
(assert (=> (= result13 true) (= temp___1709 temp___1705)))
(assert (=> (= result13 true) (forall ((temp___1710 Int)) (ite (and (<= 1 temp___1710) (<= temp___1710 (length thestring))) (= (select o18 temp___1710) (select (elts1 temp___1709) temp___1710)) (= (select o18 temp___1710) (select result__5 temp___1710))))))
(assert (=> (= result13 true) (= result14 (mk_map__ref result__5))))
(assert (=> (= result13 true) (= result__6 o18)))
(assert (=> (= result13 true) (= result__8 (mk_map__ref result__6))))
(assert (=> (= result13 true) (= result__9 result__6)))
(assert (=> (not (= result13 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring))) 1) (<= 1 (to_rep1 (last (rt thestring))))) (and (<= (to_rep1 (first (rt thestring))) 150) (<= 150 (to_rep1 (last (rt thestring)))))))))
(assert (=> (not (= result13 true)) (= temp___1704 thestring)))
(assert (=> (not (= result13 true)) (= o19 (elts temp___1704))))
(assert (=> (not (= result13 true)) (= result15 (mk_map__ref result__5))))
(assert (=> (not (= result13 true)) (= result__7 o19)))
(assert (=> (not (= result13 true)) (= result__8 (mk_map__ref result__7))))
(assert (=> (not (= result13 true)) (= result__9 result__7)))
(assert (= result16 (mk_map__ref c34b)))
(assert (= c34b2 (map__content result__8)))
