...
(declare-const o3 (Array Int content))
(declare-const o4 (Array Int content))
...
(assert (in_range1 i))
(assert (forall ((k Int)) (=> (and (<= (to_rep h_v1__first) k) (<= k (to_rep h_v1__last))) (ite (<= k (div1 (to_rep h_v1__last) 2)) (= (to_rep1 (select o3 k)) (to_rep1 (select h_v1 (+ k (div1 (to_rep h_v1__last) 2))))) (= (to_rep1 (select o3 k)) (to_rep1 (select h_v1 (- k (div1 (to_rep h_v1__last) 2)))))))))
(assert (forall ((k Int)) (=> (and (<= (to_rep h_v2__first) k) (<= k (to_rep h_v2__last))) (ite (<= k (div1 (to_rep h_v2__last) 2)) (= (to_rep1 (select o4 k)) (to_rep1 (select h_v2 (+ k (div1 (to_rep h_v2__last) 2))))) (= (to_rep1 (select o4 k)) (to_rep1 (select h_v2 (- k (div1 (to_rep h_v2__last) 2)))))))))
(assert (= o4 h_v21))
(assert (= o3 h_v11))
(assert (= h_v22 o4))
(assert (= h_v12 o3))
