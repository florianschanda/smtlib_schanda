...
(assert (not (= (enrolmentisinprogress status1 (let ((subject state7)) state11)) true)))
(assert (not (= (privatekeypresent thistisinfo__split_fields (let ((subject state1)) state8)) true)))
(check-sat)
(exit)
