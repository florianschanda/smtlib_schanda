...
(assert (= (privatekeypresent thistisinfo__split_fields (let ((subject state)) state4)) true))
(assert (not (not (= (enrolmentisinprogress status1 (let ((subject state3)) state7)) true))))
(check-sat)
(exit)
