...
(assert (and (= o1 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range5 o1) (= o1 (to_rep2 theadmin__split_fields)))))
(assert (= result (ite (= o1 1) true false)))
(assert (=> (= result true) (and (= o3 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o3 true) (in_range7 (to_rep3 theadmin__split_fields1))))))
(assert (=> (= result true) (= o4 (ite (not (= o3 true)) true false))))
...
(assert (=> (= result true) (=> (= result1 true) (and (= o2 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range7 o2)))))
(assert (=> (= result true) (=> (= result1 true) (= o5 (ite (= o2 3) true false)))))
(assert (=> (= result true) (=> (not (= result1 true)) (= o5 false))))
(assert (=> (= result true) (= o6 (ite (= o5 false) o4 true))))
(assert (=> (not (= result true)) (= o6 (of_int 1))))
