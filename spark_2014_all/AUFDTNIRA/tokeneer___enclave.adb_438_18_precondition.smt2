...
(assert (=> (= result true) (and (= o2 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o2 true) (in_range7 (to_rep3 theadmin__split_fields1))))))
(assert (=> (= result true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (= result true) (and (= result1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result1 true) (in_range7 (to_rep3 theadmin__split_fields1))))))
(assert (=> (= result true) (=> (= result1 true) (and (= o1 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range7 o1)))))
(assert (=> (= result true) (=> (= result1 true) (= o4 (ite (= o1 3) true false)))))
(assert (=> (= result true) (=> (not (= result1 true)) (= o4 false))))
(assert (=> (= result true) (= o5 (ite (= o4 false) o3 true))))
(assert (=> (not (= result true)) (= o5 (distinct 1 0))))
(assert (and (= result2 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result2 true) (in_range7 (to_rep3 theadmin__split_fields1)))))
(assert (= result2 true))
