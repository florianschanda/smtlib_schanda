...
(define-fun tint_arrayD1__ref___3__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___3__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(define-fun tnumber_array_typeD1__ref___3__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___3__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t85b__ref (mk_t85b__ref (t85b__content us_t4)))))
(define-fun t85b__ref___projection ((a t85b__ref)) us_t4 (t85b__content a))
...
(declare-datatypes () ((t86b__ref (mk_t86b__ref (t86b__content integer)))))
(define-fun t86b__ref___projection ((a t86b__ref)) integer (t86b__content a))
...
(define-fun tint_arrayB__ref___3__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___1242 Int) (temp___1243 Int) (temp___1244 Int) (temp___1245 Int) (temp___1246 Int) (temp___1247 Int) (temp___1248 Int) (temp___1249 Int) (temp___1250 Int) (temp___1251 Int) (temp___1252 Int) (temp___1253 Int)) (let ((temp___1241 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def temp___1242 temp___1243 temp___1244 temp___1245 temp___1246 temp___1247 temp___1248 temp___1249 temp___1250 temp___1251 temp___1252 temp___1253))) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1252 temp___1253) (and (= (first5 temp___1241) temp___1252) (= (last5 temp___1241) temp___1253))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1241) (+ (first1 source) 0)) (of_rep1 temp___1242)) (= (select (to_array2 temp___1241) (+ (first1 source) 1)) (of_rep1 temp___1243))) (= (select (to_array2 temp___1241) (+ (first1 source) 2)) (of_rep1 temp___1244))) (= (select (to_array2 temp___1241) (+ (first1 source) 3)) (of_rep1 temp___1245))) (= (select (to_array2 temp___1241) (+ (first1 source) 4)) (of_rep1 temp___1246))) (= (select (to_array2 temp___1241) (+ (first1 source) 5)) (of_rep1 temp___1247))) (= (select (to_array2 temp___1241) (+ (first1 source) 6)) (of_rep1 temp___1248))) (= (select (to_array2 temp___1241) (+ (first1 source) 7)) (of_rep1 temp___1249))) (= (select (to_array2 temp___1241) (+ (first1 source) 8)) (of_rep1 temp___1250))) (= (select (to_array2 temp___1241) (+ (first1 source) 9)) (of_rep1 temp___1251)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___3__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___1259 Int) (temp___1260 Int) (temp___1261 Int)) (let ((temp___1258 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def temp___1259 temp___1260 temp___1261))) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1260 temp___1261) (and (= (first9 temp___1258) temp___1260) (= (last9 temp___1258) temp___1261))) (forall ((temp___1262 Int)) (= (select (to_array4 temp___1258) temp___1262) (of_rep1 temp___1259)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_203 us_t3) (temp___is_init_200 Bool) (temp___skip_constant_201 Bool) (temp___do_toplevel_202 Bool)) Bool (=> (not (= temp___skip_constant_201 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_203) (last7 temp___expr_203)) (and (= (first7 temp___expr_203) (first1 source)) (= (last7 temp___expr_203) (+ (first1 source) 9))))))
...
(declare-const temp___1276 Int)
(declare-const o Int)
(declare-const o1 character)
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const temp___1277 Int)
...
(declare-const temp___1256 (Array Int integer))
(declare-const temp___12561 t2)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume1 t1)
(declare-const us Int)
(declare-const temp___1264 (Array Int integer))
(declare-const temp___12641 t4)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume1 t3)
(declare-const us1 Int)
(declare-const temp___1271 Int)
(declare-const temp___1269 Int)
(declare-const temp___1267 (Array Int integer))
...
(declare-const target5 int__ref)
...
(assert (and (and (= (length source) 10) (and (and (and (and (and (and (and (<= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 51)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 54))) (forall ((index11 Int)) (=> (and (<= (to_rep1 (first (rt source))) index11) (<= index11 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def 2 1 4 7 4 8 3 5 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def 2 1 4 7 4 8 3 5 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t2 temp___1256 temp___12561) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__aggregate_def 2 1 4 7 4 8 3 5 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___12561)) (to_rep1 (last4 temp___12561))) (+ (- (to_rep1 (last4 temp___12561)) (to_rep1 (first4 temp___12561))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1256 (to_rep1 (first4 temp___12561)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume))
(assert (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__int_array__assume1))))
...
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t4 temp___1264 temp___12641) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___12641)) (to_rep1 (last8 temp___12641))) (+ (- (to_rep1 (last8 temp___12641)) (to_rep1 (first8 temp___12641))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1264 (to_rep1 (first8 temp___12641)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume))
(assert (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_5xx__n__assume1))))
...
(assert (and (= temp___1271 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index2 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= temp___1269 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= temp___1267 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= o29 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= o30 (select n1 o29))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= o31 (to_rep1 o30))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= o31 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= o32 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= o33 (select (elts source) o32))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= o34 (to_rep o33))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o34))) (ite (= (= o34 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o34 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o34 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o34 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o34 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o34 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o34 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o34 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o34 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o34 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= (to_rep1 o35) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= o36 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= o37 (store n1 o36 o35))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= n2 o37)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (and (and (forall ((temp___1268 Int)) (=> (and (<= (to_rep1 n__first) temp___1268) (<= temp___1268 (to_rep1 n__last))) (=> (< index3 temp___1268) (= (select n3 temp___1268) (select temp___1267 temp___1268))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= index3 temp___1271)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= index3 index5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= n3 n5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= index6 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= n6 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= index8 index6)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271)) (= n8 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271))) (= index8 index2)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1271))) (= n8 n1)))
...
(assert (and (= temp___1272 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1272) (<= temp___1272 (to_rep1 n__last))))
(assert (= o61 temp___1272))
(assert (= o62 (select (map__content1 n7) o61)))
(assert (= o63 (to_rep1 o62)))
(assert (= result6 (mk_int__ref target)))
(assert (= target1 o63))
(assert (<= target1 9))
(assert (and (= temp___1273 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1273) (<= temp___1273 (to_rep1 n__last))))
(assert (= o64 temp___1273))
(assert (= o65 (select (map__content1 n7) o64)))
(assert (= o66 (to_rep1 o65)))
(assert (= o67 (* o66 10)))
(assert (and (= o68 o67) (in_range1 o67)))
(assert (= o69 (+ target1 o68)))
(assert (and (= o70 o69) (in_range1 o69)))
(assert (= result7 (mk_int__ref target1)))
(assert (= target2 o70))
(assert (<= target2 99))
(assert (and (= temp___1274 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1274) (<= temp___1274 (to_rep1 n__last))))
(assert (= o71 temp___1274))
(assert (= o72 (select (map__content1 n7) o71)))
(assert (= o73 (to_rep1 o72)))
(assert (= o74 (* o73 100)))
(assert (and (= o75 o74) (in_range1 o74)))
(assert (= o76 (+ target2 o75)))
(assert (and (= o77 o76) (in_range1 o76)))
(assert (= result8 (mk_int__ref target2)))
(assert (= target3 o77))
(assert (<= target3 599))
(assert (and (= o78 (+ target3 2147483000)) (in_range1 (+ target3 2147483000))))
(assert (= result9 (mk_int__ref target3)))
(assert (= target4 o78))
(assert (not (<= target4 2147483599)))
(check-sat)
(exit)
