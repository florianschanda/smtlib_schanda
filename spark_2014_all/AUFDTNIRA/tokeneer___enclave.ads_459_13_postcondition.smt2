...
(assert (= (islocked (int__content currentlatch1) (us_private__content state4) (us_split_fields__content1 latchtimeout__split_fields4)) true))
(assert (= (thecurrentdoor (us_private__content state5)) 0))
(assert (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime)) (alarm_timeout (us_private__content state5))) true))
