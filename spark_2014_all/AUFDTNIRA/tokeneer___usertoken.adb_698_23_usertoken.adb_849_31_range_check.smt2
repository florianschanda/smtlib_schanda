...
(assert (forall ((x classt)) (! (in_range18 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun bool_eq15 ((a us_rep10) (b us_rep10)) Bool (ite (= (to_rep16 (rec__privtypes__clearancet__class (us_split_fields19 a))) (to_rep16 (rec__privtypes__clearancet__class (us_split_fields19 b)))) true false))
...
(declare-fun user_eq32 (privileget privileget) Bool)
(declare-const dummy32 privileget)
...
(declare-fun to_rep17 (privileget) Int)
(declare-fun of_rep17 (Int) privileget)
(assert (forall ((x privileget)) (! (= (of_rep17 (to_rep17 x)) x) :pattern ((to_rep17 x)))))
(assert (forall ((x privileget)) (! (in_range19 (to_rep17 x)) :pattern ((to_rep17 x)))))
(assert (forall ((x Int)) (! (=> (in_range19 x) (= (to_rep17 (of_rep17 x)) x)) :pattern ((to_rep17 (of_rep17 x))))))
(declare-datatypes () ((us_split_fields20 (mk___split_fields10 (rec__cert__attr__priv__contentst__id us_rep2) (rec__cert__attr__priv__contentst__notbefore us_rep) (rec__cert__attr__priv__contentst__notafter us_rep) (rec__cert__attr__priv__contentst__mechanism algorithmt) (rec__cert__attr__priv__contentst__basecertid us_rep2) (rec__cert__attr__priv__contentst__role privileget) (rec__cert__attr__priv__contentst__clearance us_rep10)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields20)) us_rep2 (rec__cert__attr__priv__contentst__id a))
...
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields20)) us_rep2 (rec__cert__attr__priv__contentst__basecertid a))
...
(define-fun bool_eq16 ((a us_rep11) (b us_rep11)) Bool (ite (and (and (and (and (and (and (= (bool_eq3 (rec__cert__attr__priv__contentst__id (us_split_fields21 a)) (rec__cert__attr__priv__contentst__id (us_split_fields21 b))) true) (= (bool_eq1 (rec__cert__attr__priv__contentst__notbefore (us_split_fields21 a)) (rec__cert__attr__priv__contentst__notbefore (us_split_fields21 b))) true)) (= (bool_eq1 (rec__cert__attr__priv__contentst__notafter (us_split_fields21 a)) (rec__cert__attr__priv__contentst__notafter (us_split_fields21 b))) true)) (= (to_rep8 (rec__cert__attr__priv__contentst__mechanism (us_split_fields21 a))) (to_rep8 (rec__cert__attr__priv__contentst__mechanism (us_split_fields21 b))))) (= (bool_eq3 (rec__cert__attr__priv__contentst__basecertid (us_split_fields21 a)) (rec__cert__attr__priv__contentst__basecertid (us_split_fields21 b))) true)) (= (to_rep17 (rec__cert__attr__priv__contentst__role (us_split_fields21 a))) (to_rep17 (rec__cert__attr__priv__contentst__role (us_split_fields21 b))))) (= (bool_eq15 (rec__cert__attr__priv__contentst__clearance (us_split_fields21 a)) (rec__cert__attr__priv__contentst__clearance (us_split_fields21 b))) true)) true false))
...
(declare-fun cert_attr_priv_to_cert (us_rep11) us_rep3)
(declare-fun cert_attr_priv_to_cert__function_guard (us_rep3 us_rep11) Bool)
(assert true)
...
(define-fun in_range20 ((x Int)) Bool (and (<= 1 x) (<= x 150)))
...
(declare-fun user_eq34 (descriptioni descriptioni) Bool)
(declare-const dummy34 descriptioni)
...
(declare-fun temp___String_Literal_2907 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2907 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 4)) 118)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 6)) 108)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 8)) 103)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 11)) 67)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 16)) 102)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 17)) 105)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 18)) 99)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 20)) 116)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 23)) 78)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 25)) 116)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 27)) 67)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 28)) 117)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 29)) 114)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 30)) 114)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 31)) 101)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 32)) 110)) (= (to_rep (select (temp___String_Literal_2907 us_void_param) 33)) 116)) :pattern ((temp___String_Literal_2907 us_void_param)))))
(declare-fun temp___String_Literal_2912 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2912 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 4)) 118)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 6)) 108)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 8)) 103)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 11)) 67)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 16)) 102)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 17)) 105)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 18)) 99)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 20)) 116)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 23)) 78)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 24)) 111)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 25)) 116)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 26)) 32)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 27)) 86)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 28)) 101)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 29)) 114)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 30)) 105)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 31)) 102)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 32)) 105)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 33)) 97)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 34)) 98)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 35)) 108)) (= (to_rep (select (temp___String_Literal_2912 us_void_param) 36)) 101)) :pattern ((temp___String_Literal_2912 us_void_param)))))
(declare-fun temp___String_Literal_2917 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2917 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 4)) 118)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 6)) 108)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 7)) 101)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 8)) 103)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 9)) 101)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 11)) 67)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 12)) 101)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 16)) 102)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 17)) 105)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 18)) 99)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 20)) 116)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 21)) 101)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 23)) 66)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 24)) 97)) (= (to_rep (select (temp___String_Literal_2917 us_void_param) 25)) 100)) :pattern ((temp___String_Literal_2917 us_void_param)))))
...
(define-fun dynamic_invariant3 ((temp___expr_2407 Int) (temp___is_init_2403 Bool) (temp___skip_constant_2404 Bool) (temp___do_toplevel_2405 Bool) (temp___do_typ_inv_2406 Bool)) Bool (=> (or (= temp___is_init_2403 true) (<= 0 3)) (in_range21 temp___expr_2407)))
...
(define-fun dynamic_invariant9 ((temp___expr_651 Int) (temp___is_init_647 Bool) (temp___skip_constant_648 Bool) (temp___do_toplevel_649 Bool) (temp___do_typ_inv_650 Bool)) Bool (=> (or (= temp___is_init_647 true) (<= 1 150)) (in_range20 temp___expr_651)))
...
(define-fun dynamic_invariant10 ((temp___expr_703 Int) (temp___is_init_699 Bool) (temp___skip_constant_700 Bool) (temp___do_toplevel_701 Bool) (temp___do_typ_inv_702 Bool)) Bool (=> (or (= temp___is_init_699 true) (<= 1901 2099)) (in_range2 temp___expr_703)))
(define-fun dynamic_invariant11 ((temp___expr_710 Int) (temp___is_init_706 Bool) (temp___skip_constant_707 Bool) (temp___do_toplevel_708 Bool) (temp___do_typ_inv_709 Bool)) Bool (=> (or (= temp___is_init_706 true) (<= 1 12)) (in_range3 temp___expr_710)))
(define-fun dynamic_invariant12 ((temp___expr_717 Int) (temp___is_init_713 Bool) (temp___skip_constant_714 Bool) (temp___do_toplevel_715 Bool) (temp___do_typ_inv_716 Bool)) Bool (=> (or (= temp___is_init_713 true) (<= 1 31)) (in_range4 temp___expr_717)))
(define-fun dynamic_invariant13 ((temp___expr_749 Int) (temp___is_init_745 Bool) (temp___skip_constant_746 Bool) (temp___do_toplevel_747 Bool) (temp___do_typ_inv_748 Bool)) Bool (=> (or (= temp___is_init_745 true) (<= 0 86399999)) (in_range5 temp___expr_749)))
(define-fun dynamic_invariant14 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range6 temp___expr_402)))
(define-fun dynamic_invariant15 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range7 temp___expr_426)))
(define-fun dynamic_invariant16 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range9 temp___expr_450)))
(define-fun dynamic_invariant17 ((temp___expr_464 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool) (temp___do_typ_inv_463 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 4294967295)) (in_range16 temp___expr_464)))
(define-fun dynamic_invariant18 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 0 128)) (in_range17 temp___expr_471)))
(define-fun dynamic_invariant19 ((temp___expr_593 Int) (temp___is_init_589 Bool) (temp___skip_constant_590 Bool) (temp___do_toplevel_591 Bool) (temp___do_typ_inv_592 Bool)) Bool (=> (or (= temp___is_init_589 true) (<= 0 3)) (in_range19 temp___expr_593)))
(define-fun dynamic_invariant20 ((temp___expr_607 Int) (temp___is_init_603 Bool) (temp___skip_constant_604 Bool) (temp___do_toplevel_605 Bool) (temp___do_typ_inv_606 Bool)) Bool (=> (or (= temp___is_init_603 true) (<= 0 5)) (in_range18 temp___expr_607)))
(define-fun dynamic_invariant21 ((temp___expr_567 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool) (temp___do_typ_inv_566 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 0 4294967295)) (in_range8 temp___expr_567)))
