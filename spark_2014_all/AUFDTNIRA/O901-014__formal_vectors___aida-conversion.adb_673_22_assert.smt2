...
(assert (forall ((temp___1596 Int) (temp___1597 Int) (temp___1598 Int) (temp___1599 Int) (temp___1600 Int) (temp___1601 Int) (temp___1602 Int) (temp___1603 Int) (temp___1604 Int) (temp___1605 Int) (temp___1606 Int) (temp___1607 Int)) (let ((temp___1595 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def temp___1596 temp___1597 temp___1598 temp___1599 temp___1600 temp___1601 temp___1602 temp___1603 temp___1604 temp___1605 temp___1606 temp___1607))) (=> (and (and (and (and (and (and (and (and (and (dynamic_invariant temp___1596 true true true true) (dynamic_invariant temp___1597 true true true true)) (dynamic_invariant temp___1598 true true true true)) (dynamic_invariant temp___1599 true true true true)) (dynamic_invariant temp___1600 true true true true)) (dynamic_invariant temp___1601 true true true true)) (dynamic_invariant temp___1602 true true true true)) (dynamic_invariant temp___1603 true true true true)) (dynamic_invariant temp___1604 true true true true)) (dynamic_invariant temp___1605 true true true true)) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1606 temp___1607) (and (= (first5 temp___1595) temp___1606) (= (last5 temp___1595) temp___1607))) (and (and (and (and (and (and (and (and (and (= (to_rep1 (select (to_array2 temp___1595) (+ (first1 source) 0))) temp___1596) (= (to_rep1 (select (to_array2 temp___1595) (+ (first1 source) 1))) temp___1597)) (= (to_rep1 (select (to_array2 temp___1595) (+ (first1 source) 2))) temp___1598)) (= (to_rep1 (select (to_array2 temp___1595) (+ (first1 source) 3))) temp___1599)) (= (to_rep1 (select (to_array2 temp___1595) (+ (first1 source) 4))) temp___1600)) (= (to_rep1 (select (to_array2 temp___1595) (+ (first1 source) 5))) temp___1601)) (= (to_rep1 (select (to_array2 temp___1595) (+ (first1 source) 6))) temp___1602)) (= (to_rep1 (select (to_array2 temp___1595) (+ (first1 source) 7))) temp___1603)) (= (to_rep1 (select (to_array2 temp___1595) (+ (first1 source) 8))) temp___1604)) (= (to_rep1 (select (to_array2 temp___1595) (+ (first1 source) 9))) temp___1605)))))))
(define-fun dynamic_invariant4 ((temp___expr_354 us_t3) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool) (temp___do_typ_inv_353 Bool)) Bool (=> (not (= temp___skip_constant_351 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_354) (last7 temp___expr_354)) (and (= (first7 temp___expr_354) (first1 source)) (= (last7 temp___expr_354) (+ (first1 source) 9))))))
(declare-sort t6 0)
...
(assert (forall ((temp___1613 Int) (temp___1614 Int) (temp___1615 Int)) (let ((temp___1612 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def temp___1613 temp___1614 temp___1615))) (=> (dynamic_invariant temp___1613 true true true true) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1614 temp___1615) (and (= (first9 temp___1612) temp___1614) (= (last9 temp___1612) temp___1615))) (forall ((temp___1616 Int)) (= (to_rep1 (select (to_array4 temp___1612) temp___1616)) temp___1613)))))))
...
(declare-const temp___1610 (Array Int integer))
(declare-const temp___16101 t2)
...
(declare-const temp___1618 (Array Int integer))
(declare-const temp___16181 t4)
...
(declare-const temp___1622 (Array Int integer))
...
(assert (and (and (= (length source) 10) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 48))) (forall ((index7 Int)) (=> (and (<= (to_rep1 (first (rt source))) index7) (<= index7 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index7))) true)))))
...
(assert (= (mk___t2 temp___1610 temp___16101) (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def 2 0 9 9 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___16101)) (to_rep1 (last4 temp___16101))) (+ (- (to_rep1 (last4 temp___16101)) (to_rep1 (first4 temp___16101))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1610 (to_rep1 (first4 temp___16101)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume))
...
(assert (= (mk___t4 temp___1618 temp___16181) (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___16181)) (to_rep1 (last8 temp___16181))) (+ (- (to_rep1 (last8 temp___16181)) (to_rep1 (first8 temp___16181))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1618 (to_rep1 (first8 temp___16181)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume))
...
(assert (and (= temp___1625 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= temp___1622 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= temp___1620 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= o index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= o1 (select n1 o))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= o3 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= o7 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= n2 o8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt source))) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index2)) (forall ((temp___1623 Int)) (=> (and (<= (to_rep1 n__first) temp___1623) (<= temp___1623 (to_rep1 n__last))) (=> (< index2 temp___1623) (= (select n3 temp___1623) (select temp___1622 temp___1623)))))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= index2 temp___1625)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= index2 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= n3 n4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= index4 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= n5 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= index6 index4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625)) (= n7 n5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1625))) (= n7 n1)))
...
(assert (and (= temp___1626 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1626) (<= temp___1626 (to_rep1 n__last))))
(assert (= o9 temp___1626))
(assert (= o10 (select (map__content1 n6) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= result4 (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 9))
(assert (and (= temp___1627 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1627) (<= temp___1627 (to_rep1 n__last))))
(assert (= o12 temp___1627))
...
(assert (= target2 o18))
(assert (<= target2 99))
(assert (and (= temp___1628 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1628) (<= temp___1628 (to_rep1 n__last))))
(assert (= o19 temp___1628))
...
(assert (= target3 o25))
(assert (<= target3 999))
(assert (and (= temp___1629 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___1629) (<= temp___1629 (to_rep1 n__last))))
(assert (= o26 temp___1629))
...
(assert (= target4 o32))
(assert (<= target4 9999))
(assert (and (= temp___1630 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___1630) (<= temp___1630 (to_rep1 n__last))))
(assert (= o33 temp___1630))
...
(assert (and (= temp___1631 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___1631) (<= temp___1631 (to_rep1 n__last))))
(assert (= o40 temp___1631))
...
(assert (and (= temp___1632 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___1632) (<= temp___1632 (to_rep1 n__last))))
(assert (= o47 temp___1632))
...
(assert (and (= temp___1633 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___1633) (<= temp___1633 (to_rep1 n__last))))
(assert (= o54 temp___1633))
(assert (= o55 (select (map__content1 n6) o54)))
...
(assert (and (= o61 (+ target8 2000000000)) (in_range1 (+ target8 2000000000))))
(assert (= result12 (mk_int__ref target8)))
(assert (= target9 o61))
