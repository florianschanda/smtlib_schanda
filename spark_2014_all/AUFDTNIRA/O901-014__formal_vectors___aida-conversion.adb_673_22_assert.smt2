...
(define-fun tint_arrayD1__ref___9__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___9__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t224b__ref (mk_t224b__ref (t224b__content integer)))))
(define-fun t224b__ref___projection ((a t224b__ref)) integer (t224b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t225b__ref (mk_t225b__ref (t225b__content us_t2)))))
(define-fun t225b__ref___projection ((a t225b__ref)) us_t2 (t225b__content a))
...
(define-fun tnumber_array_typeD1__ref___9__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___9__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t228b__ref (mk_t228b__ref (t228b__content integer)))))
(define-fun t228b__ref___projection ((a t228b__ref)) integer (t228b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t229b__ref (mk_t229b__ref (t229b__content us_t4)))))
(define-fun t229b__ref___projection ((a t229b__ref)) us_t4 (t229b__content a))
...
(declare-datatypes () ((t230b__ref (mk_t230b__ref (t230b__content integer)))))
(define-fun t230b__ref___projection ((a t230b__ref)) integer (t230b__content a))
...
(define-fun tint_arrayB__ref___9__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___1494 Int) (temp___1495 Int) (temp___1496 Int) (temp___1497 Int) (temp___1498 Int) (temp___1499 Int) (temp___1500 Int) (temp___1501 Int) (temp___1502 Int) (temp___1503 Int) (temp___1504 Int) (temp___1505 Int)) (let ((temp___1493 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def temp___1494 temp___1495 temp___1496 temp___1497 temp___1498 temp___1499 temp___1500 temp___1501 temp___1502 temp___1503 temp___1504 temp___1505))) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1504 temp___1505) (and (= (first5 temp___1493) temp___1504) (= (last5 temp___1493) temp___1505))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1493) (+ (first1 source) 0)) (of_rep1 temp___1494)) (= (select (to_array2 temp___1493) (+ (first1 source) 1)) (of_rep1 temp___1495))) (= (select (to_array2 temp___1493) (+ (first1 source) 2)) (of_rep1 temp___1496))) (= (select (to_array2 temp___1493) (+ (first1 source) 3)) (of_rep1 temp___1497))) (= (select (to_array2 temp___1493) (+ (first1 source) 4)) (of_rep1 temp___1498))) (= (select (to_array2 temp___1493) (+ (first1 source) 5)) (of_rep1 temp___1499))) (= (select (to_array2 temp___1493) (+ (first1 source) 6)) (of_rep1 temp___1500))) (= (select (to_array2 temp___1493) (+ (first1 source) 7)) (of_rep1 temp___1501))) (= (select (to_array2 temp___1493) (+ (first1 source) 8)) (of_rep1 temp___1502))) (= (select (to_array2 temp___1493) (+ (first1 source) 9)) (of_rep1 temp___1503)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___9__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___1511 Int) (temp___1512 Int) (temp___1513 Int)) (let ((temp___1510 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def temp___1511 temp___1512 temp___1513))) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1512 temp___1513) (and (= (first9 temp___1510) temp___1512) (= (last9 temp___1510) temp___1513))) (forall ((temp___1514 Int)) (= (select (to_array4 temp___1510) temp___1514) (of_rep1 temp___1511)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_311 us_t3) (temp___is_init_308 Bool) (temp___skip_constant_309 Bool) (temp___do_toplevel_310 Bool)) Bool (=> (not (= temp___skip_constant_309 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_311) (last7 temp___expr_311)) (and (= (first7 temp___expr_311) (first1 source)) (= (last7 temp___expr_311) (+ (first1 source) 9))))))
...
(declare-const temp___1508 (Array Int integer))
(declare-const temp___15081 t2)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume1 t1)
(declare-const us Int)
(declare-const temp___1516 (Array Int integer))
(declare-const temp___15161 t4)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume1 t3)
(declare-const us1 Int)
(declare-const temp___1523 Int)
(declare-const temp___1520 (Array Int integer))
(declare-const temp___1518 Int)
...
(assert (and (and (= (length source) 10) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 48))) (forall ((index11 Int)) (=> (and (<= (to_rep1 (first (rt source))) index11) (<= index11 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def 2 0 9 9 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def 2 0 9 9 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t2 temp___1508 temp___15081) (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__aggregate_def 2 0 9 9 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___15081)) (to_rep1 (last4 temp___15081))) (+ (- (to_rep1 (last4 temp___15081)) (to_rep1 (first4 temp___15081))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1508 (to_rep1 (first4 temp___15081)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume))
(assert (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__int_array__assume1))))
...
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t4 temp___1516 temp___15161) (aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___15161)) (to_rep1 (last8 temp___15161))) (+ (- (to_rep1 (last8 temp___15161)) (to_rep1 (first8 temp___15161))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1516 (to_rep1 (first8 temp___15161)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume))
(assert (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_0xx_xxx_xxx__n__assume1))))
...
(assert (and (= temp___1523 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index2 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= temp___1520 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= temp___1518 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= o5 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= o6 (select n1 o5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= o7 (to_rep1 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= o7 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= o8 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= o9 (select (elts source) o8))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= o10 (to_rep o9))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o10))) (ite (= (= o10 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o10 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o10 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o10 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o10 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o10 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o10 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o10 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o10 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o10 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= (to_rep1 o11) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= o12 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= o13 (store n1 o12 o11))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= n2 o13)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3)) (forall ((temp___1521 Int)) (=> (and (<= (to_rep1 n__first) temp___1521) (<= temp___1521 (to_rep1 n__last))) (=> (< index3 temp___1521) (= (select n3 temp___1521) (select temp___1520 temp___1521)))))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= index3 temp___1523)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= index3 index5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= n3 n5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= index6 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= n6 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= index8 index6)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523)) (= n8 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523))) (= index8 index2)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1523))) (= n8 n1)))
...
(assert (and (= temp___1524 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1524) (<= temp___1524 (to_rep1 n__last))))
(assert (= o37 temp___1524))
(assert (= o38 (select (map__content1 n7) o37)))
(assert (= o39 (to_rep1 o38)))
(assert (= result6 (mk_int__ref target)))
(assert (= target1 o39))
(assert (<= target1 9))
(assert (and (= temp___1525 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1525) (<= temp___1525 (to_rep1 n__last))))
(assert (= o40 temp___1525))
(assert (= o41 (select (map__content1 n7) o40)))
(assert (= o42 (to_rep1 o41)))
(assert (= o43 (* o42 10)))
(assert (and (= o44 o43) (in_range1 o43)))
(assert (= o45 (+ target1 o44)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (= result7 (mk_int__ref target1)))
(assert (= target2 o46))
(assert (<= target2 99))
(assert (and (= temp___1526 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1526) (<= temp___1526 (to_rep1 n__last))))
(assert (= o47 temp___1526))
(assert (= o48 (select (map__content1 n7) o47)))
(assert (= o49 (to_rep1 o48)))
(assert (= o50 (* o49 100)))
(assert (and (= o51 o50) (in_range1 o50)))
(assert (= o52 (+ target2 o51)))
(assert (and (= o53 o52) (in_range1 o52)))
(assert (= result8 (mk_int__ref target2)))
(assert (= target3 o53))
(assert (<= target3 999))
(assert (and (= temp___1527 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___1527) (<= temp___1527 (to_rep1 n__last))))
(assert (= o54 temp___1527))
(assert (= o55 (select (map__content1 n7) o54)))
(assert (= o56 (to_rep1 o55)))
(assert (= o57 (* o56 1000)))
(assert (and (= o58 o57) (in_range1 o57)))
(assert (= o59 (+ target3 o58)))
(assert (and (= o60 o59) (in_range1 o59)))
(assert (= result9 (mk_int__ref target3)))
(assert (= target4 o60))
(assert (<= target4 9999))
(assert (and (= temp___1528 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___1528) (<= temp___1528 (to_rep1 n__last))))
(assert (= o61 temp___1528))
(assert (= o62 (select (map__content1 n7) o61)))
(assert (= o63 (to_rep1 o62)))
(assert (= o64 (* o63 10000)))
(assert (and (= o65 o64) (in_range1 o64)))
(assert (= o66 (+ target4 o65)))
(assert (and (= o67 o66) (in_range1 o66)))
(assert (= result10 (mk_int__ref target4)))
(assert (= target5 o67))
(assert (<= target5 99999))
(assert (and (= temp___1529 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___1529) (<= temp___1529 (to_rep1 n__last))))
(assert (= o68 temp___1529))
(assert (= o69 (select (map__content1 n7) o68)))
(assert (= o70 (to_rep1 o69)))
(assert (= o71 (* o70 100000)))
(assert (and (= o72 o71) (in_range1 o71)))
(assert (= o73 (+ target5 o72)))
(assert (and (= o74 o73) (in_range1 o73)))
(assert (= result11 (mk_int__ref target5)))
(assert (= target6 o74))
(assert (<= target6 999999))
(assert (and (= temp___1530 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___1530) (<= temp___1530 (to_rep1 n__last))))
(assert (= o75 temp___1530))
(assert (= o76 (select (map__content1 n7) o75)))
(assert (= o77 (to_rep1 o76)))
(assert (= o78 (* o77 1000000)))
(assert (and (= o79 o78) (in_range1 o78)))
(assert (= o80 (+ target6 o79)))
(assert (and (= o81 o80) (in_range1 o80)))
(assert (= result12 (mk_int__ref target6)))
(assert (= target7 o81))
(assert (<= target7 9999999))
(assert (and (= temp___1531 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___1531) (<= temp___1531 (to_rep1 n__last))))
(assert (= o82 temp___1531))
(assert (= o83 (select (map__content1 n7) o82)))
(assert (= o84 (to_rep1 o83)))
(assert (= o85 (* o84 10000000)))
(assert (and (= o86 o85) (in_range1 o85)))
(assert (= o87 (+ target7 o86)))
(assert (and (= o88 o87) (in_range1 o87)))
(assert (= result13 (mk_int__ref target7)))
(assert (= target8 o88))
(assert (<= target8 99999999))
(assert (and (= o89 (+ target8 2000000000)) (in_range1 (+ target8 2000000000))))
(assert (= result14 (mk_int__ref target8)))
(assert (= target9 o89))
(assert (not (<= target9 2099999999)))
(check-sat)
(exit)
