...
(declare-const logfiles2 map__ref1)
(declare-const logfilesstatus2 map__ref2)
...
(assert (and (and (and (not (= (isgood tokenpresence1 (let ((subject state3)) state21) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true)) (not (= (authcertvalid tokenpresence1 (let ((subject state3)) state21) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true))) (not (in_range7 (theauthcertrole tokenpresence1 (let ((subject state3)) state21) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1))))) (and (and (in_range26 tokenid1) (in_range25 tokenpresence1)) (in_range27 tokentry1))))
(assert (and (and (= (= (privatekeypresent thistisinfo__split_fields (let ((subject state2)) state14)) true) (not (= (enrolmentisinprogress status5 (let ((subject state11)) state22)) true))) (or (= (enrolmentisinprogress status5 (let ((subject state11)) state22)) true) (= (statusisenclavequiescent status5 (let ((subject state11)) state22)) true))) (in_range30 status5)))
...
(assert (=> (= result true) (and (in_range17 auditalarm6) (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields12)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields12)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields12)) true))))
(assert (=> (not (= result true)) (and (in_range17 auditalarm7) (= (valid_numberlogentries (to_rep9 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields13)) (to_rep10 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields13)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields13)) true))))
(assert (=> (not (= result true)) (= (let ((subject state1)) (mk___private__ref state23)) (let ((subject state1)) (mk___private__ref state24)))))
...
(assert (=> (not (= result true)) (= auditalarm6 auditalarm7)))
(assert (=> (not (= result true)) (= logfilestate__split_fields12 logfilestate__split_fields13)))
(assert (=> (not (= result true)) (= logfilesstatus logfilesstatus1)))
(assert (=> (not (= result true)) (= logfiles logfiles1)))
(assert (=> (not (= result true)) (= state23 state24)))
...
(assert (=> (not (= result true)) (= logfilesstatus logfilesstatus1)))
(assert (=> (not (= result true)) (= logfiles logfiles1)))
(assert (= state36 (let ((subject state11)) (mk___private__ref state22))))
(assert (= status8 (let ((subject status2)) (mk___private__ref status3))))
(assert (= state35 (let ((subject state10)) (mk___private__ref state20))))
(assert (= output2 (let ((subject output)) (mk___private__ref output1))))
(assert (= state34 (let ((subject state9)) (mk___private__ref state16))))
(assert (= writtenstate2 (let ((subject writtenstate)) (mk___private__ref writtenstate1))))
(assert (= state33 (let ((subject state8)) (mk___private__ref state12))))
(assert (= state32 (let ((subject state7)) (mk___private__ref state15))))
(assert (= state31 (let ((subject state6)) (mk___private__ref state19))))
(assert (= filestate9 (let ((subject filestate2)) (mk___private__ref filestate4))))
(assert (= state30 (let ((subject state5)) (mk___private__ref state18))))
(assert (= state29 (let ((subject state4)) (mk___private__ref state17))))
(assert (= status7 (let ((subject status1)) (mk___private__ref status4))))
(assert (= state28 (let ((subject state3)) (mk___private__ref state21))))
(assert (= state27 (let ((subject state2)) (mk___private__ref state14))))
(assert (= state26 (let ((subject state1)) (mk___private__ref state23))))
(assert (= filestate8 (let ((subject filestate1)) (mk___private__ref filestate5))))
(assert (= state25 (let ((subject state)) (mk___private__ref state13))))
(assert (= filestate7 (let ((subject filestate)) (mk___private__ref filestate3))))
(assert (= theadmin__split_fields2 (let ((subject theadmin__split_fields)) (mk___split_fields__ref theadmin__split_fields1))))
(assert (= thestats__split_fields1 (mk___split_fields__ref13 thestats__split_fields)))
(assert (= status6 (mk_int__ref status5)))
...
(assert (= idcert__split_fields2 (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields1))))
(assert (= authcert__split_fields2 (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields1))))
...
(assert (= thistisinfo__split_fields1 (mk___split_fields__ref5 thistisinfo__split_fields)))
(assert (= auditsystemfault2 (mk_bool__ref auditsystemfault)))
(assert (= auditalarm8 (mk_int__ref auditalarm6)))
(assert (= logfilestate__split_fields14 (mk___split_fields__ref3 logfilestate__split_fields12)))
(assert (= logfilesstatus2 (mk_map__ref2 logfilesstatus)))
(assert (= logfiles2 (mk_map__ref1 logfiles)))
(assert (= state48 state22))
(assert (= status11 status3))
(assert (= state47 state20))
(assert (= output3 output1))
(assert (= state46 state16))
(assert (= writtenstate3 writtenstate1))
(assert (= state45 state12))
(assert (= state44 state15))
(assert (= state43 state19))
(assert (= filestate12 filestate4))
(assert (= state42 state18))
(assert (= state41 state17))
(assert (= status10 status4))
(assert (= state40 state21))
(assert (= state39 state14))
(assert (= state38 state23))
(assert (= filestate11 filestate5))
(assert (= state37 state13))
(assert (= filestate10 filestate3))
(assert (= theadmin__split_fields3 theadmin__split_fields1))
(assert (= thestats__split_fields2 thestats__split_fields))
(assert (= status9 status5))
...
(assert (= thistisinfo__split_fields2 thistisinfo__split_fields))
(assert (= auditsystemfault3 auditsystemfault))
(assert (= auditalarm9 auditalarm6))
(assert (= logfilestate__split_fields15 logfilestate__split_fields12))
(assert (= logfilesstatus3 logfilesstatus))
(assert (= logfiles3 logfiles))
(assert (not (= (enrolmentisinprogress (int__content status6) (us_private__content state36)) true)))
(assert (not (= (privatekeypresent (us_split_fields__content5 thistisinfo__split_fields1) (us_private__content state27)) true)))
(check-sat)
(exit)
