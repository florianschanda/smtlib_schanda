...
(declare-const temp___1210 us_rep10)
(declare-const temp___1209 us_rep5)
...
(assert (=> (= result1 true) (= temp___1210 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))
...
(assert (=> (= result1 true) (= temp___1212 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))))))
(assert (=> (= result1 true) (= temp___1207 (mk___rep c__split_fields1))))
(assert (=> (= result1 true) (= temp___1211 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))))))
...
(assert (=> (= result1 true) (= (capacity (mk___rep5 p__split_discrs p__split_fields3)) temp___1211)))
(assert (=> (= result1 true) (= (length1 (mk___rep5 p__split_discrs p__split_fields3)) temp___1212)))
