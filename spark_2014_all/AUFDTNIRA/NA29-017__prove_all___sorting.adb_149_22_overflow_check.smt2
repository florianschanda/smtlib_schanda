...
(assert (= o56 (ite (< l2 o55) l2 o55)))
(assert (and (= o57 o56) (in_range2 o56)))
(assert (= k2 result6))
(assert (= k3 o57))
(assert (and (= o58 (+ a_first i3)) (in_range1 (+ a_first i3))))
(assert (and (and (= (sorted (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) o58 (+ l2 k3)) true) (= (perm (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) o58 (+ l2 k3)) true)) (forall ((k22 Int)) (=> (and (<= (to_rep a__first) k22) (<= k22 (to_rep a__last))) (=> (=> (<= o58 k22) (not (<= k22 (- (+ (+ o58 l2) k3) 1)))) (= (to_rep (select a3 k22)) (to_rep (select a2 k22))))))))
(assert (not (in_range1 (+ l2 k3))))
(check-sat)
(exit)
