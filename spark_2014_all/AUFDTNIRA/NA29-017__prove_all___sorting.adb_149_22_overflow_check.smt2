...
(assert (and (and (= (sorted (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) o7 (+ l2 k3)) true) (= (perm (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) o7 (+ l2 k3)) true)) (forall ((k4 Int)) (=> (and (<= (to_rep a__first) k4) (<= k4 (to_rep a__last))) (=> (=> (<= o7 k4) (not (<= k4 (- (+ (+ o7 l2) k3) 1)))) (= (to_rep (select a3 k4)) (to_rep (select a2 k4))))))))
