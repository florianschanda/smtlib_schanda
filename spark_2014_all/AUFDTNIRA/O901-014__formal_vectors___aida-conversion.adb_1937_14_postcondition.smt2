...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 7))))) (+ (to_rep1 (first (rt source))) 1)) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 7))))) (+ (+ (to_rep1 (first (rt source))) 1) 7)) (= (mk___t2 temp___2228 temp___22281) (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 7))))) (and (= (ite (<= (to_rep1 (first4 temp___22281)) (to_rep1 (last4 temp___22281))) (+ (- (to_rep1 (last4 temp___22281)) (to_rep1 (first4 temp___22281))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) (+ (- (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 1)) 1) 0)) (and (= (slide1 temp___2228 (to_rep1 (first4 temp___22281)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_9__int_array__assume) (= (mk1 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) aida__conversion__calculate_negative_target_length_9__int_array__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_negative_target_length_9__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_length_9__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_length_9__int_array__assume1)))))) (and (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 8)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_length_9__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8))))) (+ (to_rep1 (first (rt source))) 1)) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_length_9__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8))))) (+ (to_rep1 (first (rt source))) 8)) (= (mk___t4 temp___2236 temp___22361) (aida__conversion__calculate_negative_target_length_9__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8))))) (and (= (ite (<= (to_rep1 (first8 temp___22361)) (to_rep1 (last8 temp___22361))) (+ (- (to_rep1 (last8 temp___22361)) (to_rep1 (first8 temp___22361))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) (+ (- (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 1)) 1) 0)) (and (= (slide1 temp___2236 (to_rep1 (first8 temp___22361)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_9__n__assume) (= (mk3 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) aida__conversion__calculate_negative_target_length_9__n__assume1)))) (and (and (= (mk_map__ref1 result2) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_negative_target_length_9__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_length_9__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_length_9__n__assume1)))))) (and (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 8)))) (and (and (and (= temp___2242 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (= temp___2243 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (= (mk_int__ref result3) (mk_int__ref index)) (= index2 temp___2242)) (ite (and (<= temp___2242 index2) (<= index2 temp___2243)) (and (and (and (= temp___2240 n1) (and (= temp___2238 index2) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o5 index2)) (= o6 (select n1 o5))) (= o7 (to_rep1 o6))) (= o7 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o8 index2)) (= o9 (select (elts source) o8))) (= o10 (to_rep o9))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o10))) (ite (= (= o10 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o10 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o10 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o10 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o10 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o10 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o10 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o10 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o10 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o10 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o11) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o12 index2)) (= o13 (store n1 o12 o11)))) (and (= n1 result4) (= n2 o13))))) (and (and (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8) index3)) (forall ((temp___2241 Int)) (=> (and (<= (to_rep1 n__first) temp___2241) (<= temp___2241 (to_rep1 n__last))) (=> (< index3 temp___2241) (= (select n3 temp___2241) (select temp___2240 temp___2241)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 8)))) (= index3 temp___2243)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1))))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (and (and (= temp___2244 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (<= (to_rep1 n__first) temp___2244) (<= temp___2244 (to_rep1 n__last))) (= o41 temp___2244))) (= o42 (select (map__content1 n7) o41))) (= o43 (to_rep1 o42))) (= o44 (- o43))) (and (= o45 o44) (in_range1 o44))) (and (= result9 (mk_int__ref target)) (= target1 o45))) (and (<= (- 9) target1) (and (and (and (and (and (and (and (and (and (and (= temp___2245 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))) (and (and (<= (to_rep1 n__first) temp___2245) (<= temp___2245 (to_rep1 n__last))) (= o46 temp___2245))) (= o47 (select (map__content1 n7) o46))) (= o48 (to_rep1 o47))) (= o49 (* o48 10))) (and (= o50 o49) (in_range1 o49))) (= o51 (- target1 o50))) (and (= o52 o51) (in_range1 o51))) (and (= result10 (mk_int__ref target1)) (= target2 o52))) (and (<= (- 99) target2) (and (and (and (and (and (and (and (and (and (and (= temp___2246 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))) (and (and (<= (to_rep1 n__first) temp___2246) (<= temp___2246 (to_rep1 n__last))) (= o53 temp___2246))) (= o54 (select (map__content1 n7) o53))) (= o55 (to_rep1 o54))) (= o56 (* o55 100))) (and (= o57 o56) (in_range1 o56))) (= o58 (- target2 o57))) (and (= o59 o58) (in_range1 o58))) (and (= result11 (mk_int__ref target2)) (= target3 o59))) (and (<= (- 999) target3) (and (and (and (and (and (and (and (and (and (and (= temp___2247 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (<= (to_rep1 n__first) temp___2247) (<= temp___2247 (to_rep1 n__last))) (= o60 temp___2247))) (= o61 (select (map__content1 n7) o60))) (= o62 (to_rep1 o61))) (= o63 (* o62 1000))) (and (= o64 o63) (in_range1 o63))) (= o65 (- target3 o64))) (and (= o66 o65) (in_range1 o65))) (and (= result12 (mk_int__ref target3)) (= target4 o66))) (and (<= (- 9999) target4) (and (and (and (and (and (and (and (and (and (and (= temp___2248 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (<= (to_rep1 n__first) temp___2248) (<= temp___2248 (to_rep1 n__last))) (= o67 temp___2248))) (= o68 (select (map__content1 n7) o67))) (= o69 (to_rep1 o68))) (= o70 (* o69 10000))) (and (= o71 o70) (in_range1 o70))) (= o72 (- target4 o71))) (and (= o73 o72) (in_range1 o72))) (and (= result13 (mk_int__ref target4)) (= target5 o73))) (and (<= (- 99999) target5) (and (and (and (and (and (and (and (and (and (and (= temp___2249 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))) (and (and (<= (to_rep1 n__first) temp___2249) (<= temp___2249 (to_rep1 n__last))) (= o74 temp___2249))) (= o75 (select (map__content1 n7) o74))) (= o76 (to_rep1 o75))) (= o77 (* o76 100000))) (and (= o78 o77) (in_range1 o77))) (= o79 (- target5 o78))) (and (= o80 o79) (in_range1 o79))) (and (= result14 (mk_int__ref target5)) (= target6 o80))) (and (<= (- 999999) target6) (and (and (and (and (and (and (and (and (and (and (= temp___2250 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (<= (to_rep1 n__first) temp___2250) (<= temp___2250 (to_rep1 n__last))) (= o81 temp___2250))) (= o82 (select (map__content1 n7) o81))) (= o83 (to_rep1 o82))) (= o84 (* o83 1000000))) (and (= o85 o84) (in_range1 o84))) (= o86 (- target6 o85))) (and (= o87 o86) (in_range1 o86))) (and (= result15 (mk_int__ref target6)) (= target7 o87))) (and (<= (- 9999999) target7) (and (and (and (and (and (and (and (and (and (and (= temp___2251 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (<= (to_rep1 n__first) temp___2251) (<= temp___2251 (to_rep1 n__last))) (= o88 temp___2251))) (= o89 (select (map__content1 n7) o88))) (= o90 (to_rep1 o89))) (= o91 (* o90 10000000))) (and (= o92 o91) (in_range1 o91))) (= o93 (- target7 o92))) (and (= o94 o93) (in_range1 o93))) (and (= result16 (mk_int__ref target7)) (= target8 o94))) (and (<= (- 99999999) target8) (and (= result17 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target9 (mk_int__ref target8)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target10 target8))))))))
