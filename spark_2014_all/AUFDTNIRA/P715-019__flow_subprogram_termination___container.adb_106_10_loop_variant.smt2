...
(assert (= x18 x16))
(assert (= x19 x17))
(assert (and (= o21 (first (mk___rep my_container__split_fields1))) (= (of_rep 1) o7)))
...
(assert (= x32 o19))
(assert (and (and (=> (<= 1 200) (in_range3 i10)) (=> (<= 1 200) (in_range3 x33))) (and (<= 1 i10) (<= i10 200))))
