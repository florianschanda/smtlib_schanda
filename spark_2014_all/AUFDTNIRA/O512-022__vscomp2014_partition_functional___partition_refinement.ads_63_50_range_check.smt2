...
(assert (= result8 true))
(assert (and (= o1 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o1) (<= o1 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= o2 (- o1 1)))
(assert (= o3 (ite (<= j o2) true false)))
(assert (= result10 (ite (<= 0 j) o3 false)))
(assert (= (= result9 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j1)))) k) (<= k (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j1)))))) (= (to_rep4 (select f k)) j1)))))))
(assert (= result9 true))
