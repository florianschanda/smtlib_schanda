...
(assert (and (= (length source) 10) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index9 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index9) (<= index9 (+ (to_rep1 (first (rt source))) 9))) (= (is_digit (to_rep (select (elts source) index9))) true))))))
...
(assert (and (= temp___2314 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2314) (<= temp___2314 (to_rep1 n__last))))
(assert (= o56 temp___2314))
...
(assert (and (= temp___2315 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___2315) (<= temp___2315 (to_rep1 n__last))))
(assert (= o63 temp___2315))
