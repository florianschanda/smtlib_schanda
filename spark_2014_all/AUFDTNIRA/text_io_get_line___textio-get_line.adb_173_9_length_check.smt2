...
(assert (not (= (ite (<= (to_rep1 (first temp___6061)) (to_rep1 (last temp___6061))) (+ (- (to_rep1 (last temp___6061)) (to_rep1 (first temp___6061))) 1) 0) (ite (<= (to_rep1 item__first) (to_rep1 item__last)) (+ (- (to_rep1 item__last) (to_rep1 item__first)) 1) 0))))
(check-sat)
(exit)
