...
(assert (= i1 result1))
(assert (= i2 0))
(assert (= temp___217 k1))
(assert (= temp___216 a1))
(assert (= temp___214 i2))
(assert (= temp___213 b))
...
(assert (= b7 b5))
(assert (= a8 a6))
(assert (= o2 (perm (mk___t a (mk (to_rep a__first) (to_rep a__last))) (mk___t (map__content a7) (mk (to_rep a__first) (to_rep a__last))) a_first length1)))
(assert (<= 0 j))
(assert (<= j 2147483647))
(assert (not (in_range1 (* j l2))))
(check-sat)
(exit)
