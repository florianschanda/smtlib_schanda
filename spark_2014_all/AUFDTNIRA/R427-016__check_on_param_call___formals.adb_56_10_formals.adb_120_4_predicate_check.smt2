...
(assert (= (to_rep (select u4 1)) 0))
(assert (dynamic_predicate1 (store u4 3 rliteral1)))
(assert (= temp___315 (store u4 3 rliteral1)))
(assert (not (dynamic_predicate1 temp___315)))
(check-sat)
(exit)
