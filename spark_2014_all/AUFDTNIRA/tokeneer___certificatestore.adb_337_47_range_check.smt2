...
(define-fun dynamic_invariant ((temp___expr_480 Int) (temp___is_init_476 Bool) (temp___skip_constant_477 Bool) (temp___do_toplevel_478 Bool) (temp___do_typ_inv_479 Bool)) Bool (=> (or (= temp___is_init_476 true) (<= 0 1)) (in_range9 temp___expr_480)))
...
(declare-fun temp_____aggregate_def_1239 (Int) (Array Int logfileindext))
(declare-fun temp_____aggregate_def_1243 (Int) (Array Int fileentrycountt))
(define-fun dynamic_invariant1 ((temp___expr_1233 us_rep2) (temp___is_init_1229 Bool) (temp___skip_constant_1230 Bool) (temp___do_toplevel_1231 Bool) (temp___do_typ_inv_1232 Bool)) Bool (=> (= temp___do_typ_inv_1232 true) (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1233))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1233))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1233)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1233))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1237 us_rep2) (temp___skip_top_level_1238 Bool)) Bool (and (and (and (= (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1237))) 1) (= (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1237))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1237)) (mk___rep (mk___split_fields (temp_____aggregate_def_1239 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1237)) (temp_____aggregate_def_1243 0))))
(define-fun type_invariant ((temp___1247 us_rep2)) Bool (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1247))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1247))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1247)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1247))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_1477 Int) (temp___is_init_1473 Bool) (temp___skip_constant_1474 Bool) (temp___do_toplevel_1475 Bool) (temp___do_typ_inv_1476 Bool)) Bool (=> (or (= temp___is_init_1473 true) (<= 0 4294967295)) (in_range10 temp___expr_1477)))
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-fun temp___String_Literal_1648 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1648 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 13)) 83)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 15)) 111)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 19)) 119)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 22)) 116)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 23)) 101)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 27)) 114)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 29)) 114)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 31)) 45)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 33)) 115)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 34)) 116)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 35)) 97)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 36)) 116)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 37)) 101)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 39)) 119)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 40)) 105)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 41)) 108)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 42)) 108)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 44)) 98)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 45)) 101)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 47)) 108)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 48)) 111)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 49)) 115)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 50)) 116)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 51)) 32)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 52)) 97)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 53)) 116)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 54)) 32)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 55)) 80)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 56)) 111)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 57)) 119)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 58)) 101)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 59)) 114)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 60)) 32)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 61)) 68)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 62)) 111)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 63)) 119)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 64)) 110)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 65)) 46)) :pattern ((temp___String_Literal_1648 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1171 Int) (temp___is_init_1167 Bool) (temp___skip_constant_1168 Bool) (temp___do_toplevel_1169 Bool) (temp___do_typ_inv_1170 Bool)) Bool (=> (or (= temp___is_init_1167 true) (<= 0 17)) (in_range7 temp___expr_1171)))
(define-fun dynamic_invariant8 ((temp___expr_1178 Int) (temp___is_init_1174 Bool) (temp___skip_constant_1175 Bool) (temp___do_toplevel_1176 Bool) (temp___do_typ_inv_1177 Bool)) Bool (=> (or (= temp___is_init_1174 true) (<= 1 17)) (in_range5 temp___expr_1178)))
(define-fun dynamic_invariant9 ((temp___expr_1304 Int) (temp___is_init_1300 Bool) (temp___skip_constant_1301 Bool) (temp___do_toplevel_1302 Bool) (temp___do_typ_inv_1303 Bool)) Bool (=> (or (= temp___is_init_1300 true) (<= 0 2)) (in_range4 temp___expr_1304)))
(define-fun dynamic_invariant10 ((temp___expr_1185 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool) (temp___do_typ_inv_1184 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 0 17408)) (in_range6 temp___expr_1185)))
(define-fun dynamic_invariant11 ((temp___expr_1216 Int) (temp___is_init_1212 Bool) (temp___skip_constant_1213 Bool) (temp___do_toplevel_1214 Bool) (temp___do_typ_inv_1215 Bool)) Bool (=> (or (= temp___is_init_1212 true) (<= 0 1024)) (in_range8 temp___expr_1216)))
(assert true)
...
(assert (forall ((temp___1245 Int)) (=> (dynamic_invariant11 temp___1245 true true true true) (forall ((temp___1246 Int)) (= (select (temp_____aggregate_def_1243 temp___1245) temp___1246) rliteral2)))))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(assert (forall ((temp___1241 Int)) (=> (dynamic_invariant8 temp___1241 true true true true) (forall ((temp___1242 Int)) (= (select (temp_____aggregate_def_1239 temp___1241) temp___1242) rliteral)))))
...
(declare-const exists__1 Bool)
(declare-const result Bool)
(declare-const written1 Bool)
(declare-const result1 Bool)
(declare-const exists__2 Bool)
(assert (= (temp___String_Literal_158 Tuple0) nouser))
(assert (in_range10 nextserialnumber))
...
(assert (= written1 (distinct 0 0)))
(assert (= result1 exists__1))
(assert (= exists__2 (distinct 1 0)))
(assert (< nextserialnumber 4294967295))
(assert (not (in_range10 (+ nextserialnumber 1))))
(check-sat)
(exit)
