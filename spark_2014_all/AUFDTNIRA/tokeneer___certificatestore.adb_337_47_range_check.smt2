...
(define-fun dynamic_invariant ((temp___expr_480 Int) (temp___is_init_476 Bool) (temp___skip_constant_477 Bool) (temp___do_toplevel_478 Bool) (temp___do_typ_inv_479 Bool)) Bool (=> (or (= temp___is_init_476 true) (<= 0 1)) (in_range4 temp___expr_480)))
...
(define-fun dynamic_invariant2 ((temp___expr_1484 Int) (temp___is_init_1480 Bool) (temp___skip_constant_1481 Bool) (temp___do_toplevel_1482 Bool) (temp___do_typ_inv_1483 Bool)) Bool (=> (or (= temp___is_init_1480 true) (<= 0 4294967295)) (in_range10 temp___expr_1484)))
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-fun temp___String_Literal_1655 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1655 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 13)) 83)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 15)) 111)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 19)) 119)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 22)) 116)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 23)) 101)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 27)) 114)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 29)) 114)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 31)) 45)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 33)) 115)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 34)) 116)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 35)) 97)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 36)) 116)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 37)) 101)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 39)) 119)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 40)) 105)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 41)) 108)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 42)) 108)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 44)) 98)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 45)) 101)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 47)) 108)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 48)) 111)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 49)) 115)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 50)) 116)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 51)) 32)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 52)) 97)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 53)) 116)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 54)) 32)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 55)) 80)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 56)) 111)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 57)) 119)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 58)) 101)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 59)) 114)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 60)) 32)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 61)) 68)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 62)) 111)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 63)) 119)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 64)) 110)) (= (to_rep (select (temp___String_Literal_1655 us_void_param) 65)) 46)) :pattern ((temp___String_Literal_1655 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1178 Int) (temp___is_init_1174 Bool) (temp___skip_constant_1175 Bool) (temp___do_toplevel_1176 Bool) (temp___do_typ_inv_1177 Bool)) Bool (=> (or (= temp___is_init_1174 true) (<= 0 17)) (in_range7 temp___expr_1178)))
(define-fun dynamic_invariant8 ((temp___expr_1185 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool) (temp___do_typ_inv_1184 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 1 17)) (in_range5 temp___expr_1185)))
(define-fun dynamic_invariant9 ((temp___expr_1311 Int) (temp___is_init_1307 Bool) (temp___skip_constant_1308 Bool) (temp___do_toplevel_1309 Bool) (temp___do_typ_inv_1310 Bool)) Bool (=> (or (= temp___is_init_1307 true) (<= 0 2)) (in_range9 temp___expr_1311)))
(define-fun dynamic_invariant10 ((temp___expr_1192 Int) (temp___is_init_1188 Bool) (temp___skip_constant_1189 Bool) (temp___do_toplevel_1190 Bool) (temp___do_typ_inv_1191 Bool)) Bool (=> (or (= temp___is_init_1188 true) (<= 0 17408)) (in_range6 temp___expr_1192)))
(define-fun dynamic_invariant11 ((temp___expr_1223 Int) (temp___is_init_1219 Bool) (temp___skip_constant_1220 Bool) (temp___do_toplevel_1221 Bool) (temp___do_typ_inv_1222 Bool)) Bool (=> (or (= temp___is_init_1219 true) (<= 0 1024)) (in_range8 temp___expr_1223)))
(assert true)
...
(assert (forall ((temp___1252 Int)) (=> (dynamic_invariant11 temp___1252 true true true true) (forall ((temp___1253 Int)) (= (to_rep5 (select (temp___1250 temp___1252) temp___1253)) temp___1252)))))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(assert (forall ((temp___1248 Int)) (=> (dynamic_invariant8 temp___1248 true true true true) (forall ((temp___1249 Int)) (= (to_rep2 (select (temp___1246 temp___1248) temp___1249)) temp___1248)))))
