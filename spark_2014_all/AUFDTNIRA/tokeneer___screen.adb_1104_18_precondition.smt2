...
(assert (forall ((temp___1098 Int)) (forall ((temp___1099 Int)) (= (select (temp___1096 temp___1098) temp___1099) (of_rep7 temp___1098)))))
(declare-fun temp___1100 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1102 Int)) (forall ((temp___1103 Int)) (= (select (temp___1100 temp___1102) temp___1103) (of_rep10 temp___1102)))))
(define-fun dynamic_invariant1 ((temp___expr_1090 us_rep1) (temp___is_init_1087 Bool) (temp___skip_constant_1088 Bool) (temp___do_toplevel_1089 Bool)) Bool (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1090))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1090))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1090)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1090))) true))
(define-fun default_initial_assumption ((temp___expr_1094 us_rep1) (temp___skip_top_level_1095 Bool)) Bool (and (and (and (= (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1094))) 1) (= (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1094))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1094)) (mk___rep (mk___split_fields (temp___1096 1) (of_rep7 1) (of_rep7 1) (of_rep9 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1094)) (temp___1100 0))))
(define-fun type_invariant ((temp___1104 us_rep1)) Bool (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1104))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1104))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1104)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1104))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_1406 Int) (temp___is_init_1403 Bool) (temp___skip_constant_1404 Bool) (temp___do_toplevel_1405 Bool)) Bool (=> (or (= temp___is_init_1403 true) (<= 0 14)) (in_range16 temp___expr_1406)))
...
(declare-fun temp___String_Literal_1688 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1688 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 2)) 99)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 8)) 73)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 9)) 110)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 12)) 105)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 16)) 115)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 20)) 111)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 21)) 110)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 23)) 70)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 24)) 97)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 26)) 108)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 27)) 117)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 28)) 114)) (= (to_rep (select (temp___String_Literal_1688 us_void_param) 29)) 101)) :pattern ((temp___String_Literal_1688 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1006 Int) (temp___is_init_1003 Bool) (temp___skip_constant_1004 Bool) (temp___do_toplevel_1005 Bool)) Bool (=> (or (= temp___is_init_1003 true) (<= 0 5)) (in_range8 temp___expr_1006)))
(define-fun dynamic_invariant8 ((temp___expr_1056 Int) (temp___is_init_1053 Bool) (temp___skip_constant_1054 Bool) (temp___do_toplevel_1055 Bool)) Bool (=> (or (= temp___is_init_1053 true) (<= 0 17)) (in_range12 temp___expr_1056)))
(define-fun dynamic_invariant9 ((temp___expr_1035 Int) (temp___is_init_1032 Bool) (temp___skip_constant_1033 Bool) (temp___do_toplevel_1034 Bool)) Bool (=> (or (= temp___is_init_1032 true) (<= 1 17)) (in_range10 temp___expr_1035)))
(define-fun dynamic_invariant10 ((temp___expr_1160 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 2)) (in_range14 temp___expr_1160)))
(define-fun dynamic_invariant11 ((temp___expr_1041 Int) (temp___is_init_1038 Bool) (temp___skip_constant_1039 Bool) (temp___do_toplevel_1040 Bool)) Bool (=> (or (= temp___is_init_1038 true) (<= 0 17408)) (in_range11 temp___expr_1041)))
(define-fun dynamic_invariant12 ((temp___expr_1075 Int) (temp___is_init_1072 Bool) (temp___skip_constant_1073 Bool) (temp___do_toplevel_1074 Bool)) Bool (=> (or (= temp___is_init_1072 true) (<= 0 1024)) (in_range13 temp___expr_1075)))
(assert true)
...
(define-fun dynamic_invariant13 ((temp___expr_424 Int) (temp___is_init_421 Bool) (temp___skip_constant_422 Bool) (temp___do_toplevel_423 Bool)) Bool (=> (or (= temp___is_init_421 true) (<= 0 4194304)) (in_range5 temp___expr_424)))
(define-fun dynamic_invariant14 ((temp___expr_466 Int) (temp___is_init_463 Bool) (temp___skip_constant_464 Bool) (temp___do_toplevel_465 Bool)) Bool (=> (or (= temp___is_init_463 true) (<= 0 864000)) (in_range6 temp___expr_466)))
(define-fun dynamic_invariant15 ((temp___expr_1029 Int) (temp___is_init_1026 Bool) (temp___skip_constant_1027 Bool) (temp___do_toplevel_1028 Bool)) Bool (=> (or (= temp___is_init_1026 true) (<= 0 1)) (in_range9 temp___expr_1029)))
(define-fun dynamic_invariant16 ((temp___expr_926 Int) (temp___is_init_923 Bool) (temp___skip_constant_924 Bool) (temp___do_toplevel_925 Bool)) Bool (=> (or (= temp___is_init_923 true) (<= 0 2147483647)) (in_range7 temp___expr_926)))
(define-fun dynamic_invariant17 ((temp___expr_1308 Int) (temp___is_init_1305 Bool) (temp___skip_constant_1306 Bool) (temp___do_toplevel_1307 Bool)) Bool (=> (or (= temp___is_init_1305 true) (<= 0 2147483647)) (in_range15 temp___expr_1308)))
...
(declare-const temp___1697 us_rep5)
...
(assert (= temp___1697 (mk___rep4 o13)))
(assert (= temp___1697 nullconfigdata))
