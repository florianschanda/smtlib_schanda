...
(assert (and (and (= (to_rep (select dynamic_preds_array__update_constant_even_pair__x 1)) 0) (= (to_rep (select dynamic_preds_array__update_constant_even_pair__x 2)) 2)) (dynamic_invariant2 dynamic_preds_array__update_constant_even_pair__x true true true true)))
(assert (= result1 x1))
