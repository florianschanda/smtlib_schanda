...
(define-fun dynamic_invariant3 ((temp___expr_932 Int) (temp___is_init_929 Bool) (temp___skip_constant_930 Bool) (temp___do_toplevel_931 Bool)) Bool (=> (or (= temp___is_init_929 true) (<= 0 10)) (in_range9 temp___expr_932)))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_150 Int)) (=> (and (<= a__first temp___idx_150) (<= temp___idx_150 a__last)) (= (to_rep4 (select a temp___idx_150)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_150)))))))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq5 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep4 (select a (+ i 1))) (to_rep4 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq5 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep4 (select b (+ i 1))) (to_rep4 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq8 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (= (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 a))) (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 b)))) (= (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 a))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 b))))) (= (bool_eq6 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 b))) true)) (= (bool_eq7 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 b)) 1 17) true)) true false))
...
(assert (forall ((temp___1145 Int)) (forall ((temp___1146 Int)) (= (select (temp___1143 temp___1145) temp___1146) (of_rep4 temp___1145)))))
(declare-fun temp___1147 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1149 Int)) (forall ((temp___1150 Int)) (= (select (temp___1147 temp___1149) temp___1150) (of_rep7 temp___1149)))))
(define-fun dynamic_invariant4 ((temp___expr_1137 us_rep2) (temp___is_init_1134 Bool) (temp___skip_constant_1135 Bool) (temp___do_toplevel_1136 Bool)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1137))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1137))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1137)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1137))) true))
(define-fun default_initial_assumption ((temp___expr_1141 us_rep2) (temp___skip_top_level_1142 Bool)) Bool (and (and (and (= (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1141))) 1) (= (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1141))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1141)) (mk___rep1 (mk___split_fields1 (temp___1143 1) (of_rep4 1) (of_rep4 1) (of_rep6 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1141)) (temp___1147 0))))
(define-fun type_invariant ((temp___1151 us_rep2)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1151))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1151))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1151)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1151))) true))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep8 (select a temp___idx_153)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare3 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq11 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep8 (select a (+ i 1))) (to_rep8 (select b (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare3 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq11 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep8 (select b (+ i 1))) (to_rep8 (select a (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq12 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (bool_eq (rec__certtypes__rawdatat__rawdata (us_split_fields7 a)) 1 4096 (rec__certtypes__rawdatat__rawdata (us_split_fields7 b)) 1 4096) true) (= (to_rep9 (rec__certtypes__rawdatat__datalength (us_split_fields7 a))) (to_rep9 (rec__certtypes__rawdatat__datalength (us_split_fields7 b))))) true false))
...
(declare-fun user_eq27 (sigdatai sigdatai) Bool)
(declare-const dummy27 sigdatai)
...
(define-fun dynamic_invariant5 ((temp___expr_1519 Int) (temp___is_init_1516 Bool) (temp___skip_constant_1517 Bool) (temp___do_toplevel_1518 Bool)) Bool (=> (or (= temp___is_init_1516 true) (<= 0 28)) (in_range17 temp___expr_1519)))
...
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq14 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_142 Int)) (=> (and (<= a__first temp___idx_142) (<= temp___idx_142 a__last)) (= (to_rep13 (select a temp___idx_142)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_142)))))))))))
(declare-fun compare4 ((Array Int bytet) Int Int (Array Int bytet) Int Int) Int)
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare4 a a_first a_last b b_first b_last) 0) (= (bool_eq14 a a_first a_last b b_first b_last) true)) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare4 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq14 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep13 (select a (+ i 1))) (to_rep13 (select b (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare4 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq14 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep13 (select b (+ i 1))) (to_rep13 (select a (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(declare-const dummy32 (Array Int bytet))
(declare-const value__size14 Int)
(declare-fun object__size14 ((Array Int bytet)) Int)
(declare-const value__component__size8 Int)
(declare-fun object__component__size8 ((Array Int bytet)) Int)
(declare-const value__alignment14 Int)
(declare-fun object__alignment14 ((Array Int bytet)) Int)
(assert (<= 0 value__size14))
(assert (forall ((a (Array Int bytet))) (<= 0 (object__size14 a))))
(assert (<= 0 value__component__size8))
(assert (forall ((a (Array Int bytet))) (<= 0 (object__component__size8 a))))
(assert (<= 0 value__alignment14))
(assert (forall ((a (Array Int bytet))) (<= 0 (object__alignment14 a))))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq16 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (select a temp___idx_172) (select b (+ (- b__first a__first) temp___idx_172))))))))))
(declare-fun compare5 ((Array Int Bool) Int Int (Array Int Bool) Int Int) Int)
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare5 a a_first a_last b b_first b_last) 0) (= (bool_eq16 a a_first a_last b b_first b_last) true)) :pattern ((compare5 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare5 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq16 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_int1 (select a (+ i 1))) (to_int1 (select b (+ j 1))))))))))) :pattern ((compare5 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare5 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq16 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_int1 (select b (+ i 1))) (to_int1 (select a (+ j 1))))))))))) :pattern ((compare5 a a_first a_last b b_first b_last))))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1648 us_void_param) 1)) 86) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 4)) 105)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 5)) 102)) (= (to_rep (select (temp___String_Literal_1648 us_void_param) 6)) 121)) :pattern ((temp___String_Literal_1648 us_void_param)))))
...
(define-fun dynamic_invariant10 ((temp___expr_238 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 0 255)) (in_range18 temp___expr_238)))
...
(define-fun dynamic_invariant12 ((temp___expr_1303 Int) (temp___is_init_1300 Bool) (temp___skip_constant_1301 Bool) (temp___do_toplevel_1302 Bool)) Bool (=> (or (= temp___is_init_1300 true) (<= 1 4096)) (in_range15 temp___expr_1303)))
(define-fun dynamic_invariant13 ((temp___expr_1335 Int) (temp___is_init_1332 Bool) (temp___skip_constant_1333 Bool) (temp___do_toplevel_1334 Bool)) Bool (=> (or (= temp___is_init_1332 true) (<= 1 4096)) (in_range16 temp___expr_1335)))
(define-fun dynamic_invariant14 ((temp___expr_889 Int) (temp___is_init_886 Bool) (temp___skip_constant_887 Bool) (temp___do_toplevel_888 Bool)) Bool (=> (or (= temp___is_init_886 true) (<= 0 40)) (in_range7 temp___expr_889)))
(define-fun dynamic_invariant15 ((temp___expr_910 Int) (temp___is_init_907 Bool) (temp___skip_constant_908 Bool) (temp___do_toplevel_909 Bool)) Bool (=> (or (= temp___is_init_907 true) (<= 0 4294967295)) (in_range8 temp___expr_910)))
(define-fun dynamic_invariant16 ((temp___expr_425 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 1 150)) (in_range6 temp___expr_425)))
(assert (= nouser (temp___String_Literal_136 Tuple0)))
(define-fun dynamic_invariant17 ((temp___expr_1103 Int) (temp___is_init_1100 Bool) (temp___skip_constant_1101 Bool) (temp___do_toplevel_1102 Bool)) Bool (=> (or (= temp___is_init_1100 true) (<= 0 17)) (in_range12 temp___expr_1103)))
(define-fun dynamic_invariant18 ((temp___expr_1082 Int) (temp___is_init_1079 Bool) (temp___skip_constant_1080 Bool) (temp___do_toplevel_1081 Bool)) Bool (=> (or (= temp___is_init_1079 true) (<= 1 17)) (in_range10 temp___expr_1082)))
(define-fun dynamic_invariant19 ((temp___expr_1207 Int) (temp___is_init_1204 Bool) (temp___skip_constant_1205 Bool) (temp___do_toplevel_1206 Bool)) Bool (=> (or (= temp___is_init_1204 true) (<= 0 2)) (in_range14 temp___expr_1207)))
(define-fun dynamic_invariant20 ((temp___expr_1088 Int) (temp___is_init_1085 Bool) (temp___skip_constant_1086 Bool) (temp___do_toplevel_1087 Bool)) Bool (=> (or (= temp___is_init_1085 true) (<= 0 17408)) (in_range11 temp___expr_1088)))
(define-fun dynamic_invariant21 ((temp___expr_1122 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 1024)) (in_range13 temp___expr_1122)))
(assert true)
...
(declare-const temp___1649 (Array Int character))
(declare-const temp___16491 t1)
...
(assert (and (in_range4 auditalarm1) (= (valid_numberlogentries (to_rep4 logfilestate__split_fields7) (to_rep5 logfilestate__split_fields8) (mk___rep1 (mk___split_fields1 logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) true)))
(assert (= digested true))
(assert (and (and (in_range5 theissuerkey1) (in_range4 auditalarm2)) (= (valid_numberlogentries (to_rep4 logfilestate__split_fields14) (to_rep5 logfilestate__split_fields15) (mk___rep1 (mk___split_fields1 logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20) true)))
