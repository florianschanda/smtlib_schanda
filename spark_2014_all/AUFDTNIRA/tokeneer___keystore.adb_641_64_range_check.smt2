...
(define-fun dynamic_invariant3 ((temp___expr_1045 Int) (temp___is_init_1041 Bool) (temp___skip_constant_1042 Bool) (temp___do_toplevel_1043 Bool) (temp___do_typ_inv_1044 Bool)) Bool (=> (or (= temp___is_init_1041 true) (<= 0 10)) (in_range9 temp___expr_1045)))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep7 (select a temp___idx_173)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_1276 us_rep2) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (= temp___do_typ_inv_1275 true) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1276))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1276))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1276)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1276))) true)))
(define-fun default_initial_assumption ((temp___expr_1280 us_rep2) (temp___skip_top_level_1281 Bool)) Bool (and (and (and (= (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1280))) 1) (= (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1280))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1280)) (mk___rep1 (mk___split_fields1 (temp___1282 1) (of_rep4 1) (of_rep4 1) (of_rep6 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1280)) (temp___1286 0))))
(define-fun type_invariant ((temp___1290 us_rep2)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1290))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1290))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1290)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1290))) true))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep8 (select a temp___idx_175)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_1688 Int) (temp___is_init_1684 Bool) (temp___skip_constant_1685 Bool) (temp___do_toplevel_1686 Bool) (temp___do_typ_inv_1687 Bool)) Bool (=> (or (= temp___is_init_1684 true) (<= 0 28)) (in_range17 temp___expr_1688)))
...
(define-fun bool_eq14 ((a (Array Int bytet)) (a__first Int) (a__last Int) (b (Array Int bytet)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_164 Int)) (=> (and (<= a__first temp___idx_164) (<= temp___idx_164 a__last)) (= (to_rep13 (select a temp___idx_164)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_164))))))) true false))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq14 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_164 Int)) (=> (and (<= a__first temp___idx_164) (<= temp___idx_164 a__last)) (= (to_rep13 (select a temp___idx_164)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_164)))))))))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1822 us_void_param) 1)) 86) (= (to_rep (select (temp___String_Literal_1822 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1822 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1822 us_void_param) 4)) 105)) (= (to_rep (select (temp___String_Literal_1822 us_void_param) 5)) 102)) (= (to_rep (select (temp___String_Literal_1822 us_void_param) 6)) 121)) :pattern ((temp___String_Literal_1822 us_void_param)))))
...
(define-fun dynamic_invariant10 ((temp___expr_265 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool (=> (or (= temp___is_init_261 true) (<= 0 255)) (in_range18 temp___expr_265)))
...
(define-fun dynamic_invariant12 ((temp___expr_1455 Int) (temp___is_init_1451 Bool) (temp___skip_constant_1452 Bool) (temp___do_toplevel_1453 Bool) (temp___do_typ_inv_1454 Bool)) Bool (=> (or (= temp___is_init_1451 true) (<= 1 4096)) (in_range15 temp___expr_1455)))
(define-fun dynamic_invariant13 ((temp___expr_1491 Int) (temp___is_init_1487 Bool) (temp___skip_constant_1488 Bool) (temp___do_toplevel_1489 Bool) (temp___do_typ_inv_1490 Bool)) Bool (=> (or (= temp___is_init_1487 true) (<= 1 4096)) (in_range16 temp___expr_1491)))
(define-fun dynamic_invariant14 ((temp___expr_997 Int) (temp___is_init_993 Bool) (temp___skip_constant_994 Bool) (temp___do_toplevel_995 Bool) (temp___do_typ_inv_996 Bool)) Bool (=> (or (= temp___is_init_993 true) (<= 0 40)) (in_range7 temp___expr_997)))
(define-fun dynamic_invariant15 ((temp___expr_1021 Int) (temp___is_init_1017 Bool) (temp___skip_constant_1018 Bool) (temp___do_toplevel_1019 Bool) (temp___do_typ_inv_1020 Bool)) Bool (=> (or (= temp___is_init_1017 true) (<= 0 4294967295)) (in_range8 temp___expr_1021)))
(define-fun dynamic_invariant16 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 1 150)) (in_range6 temp___expr_471)))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant17 ((temp___expr_1214 Int) (temp___is_init_1210 Bool) (temp___skip_constant_1211 Bool) (temp___do_toplevel_1212 Bool) (temp___do_typ_inv_1213 Bool)) Bool (=> (or (= temp___is_init_1210 true) (<= 0 17)) (in_range12 temp___expr_1214)))
(define-fun dynamic_invariant18 ((temp___expr_1221 Int) (temp___is_init_1217 Bool) (temp___skip_constant_1218 Bool) (temp___do_toplevel_1219 Bool) (temp___do_typ_inv_1220 Bool)) Bool (=> (or (= temp___is_init_1217 true) (<= 1 17)) (in_range10 temp___expr_1221)))
(define-fun dynamic_invariant19 ((temp___expr_1347 Int) (temp___is_init_1343 Bool) (temp___skip_constant_1344 Bool) (temp___do_toplevel_1345 Bool) (temp___do_typ_inv_1346 Bool)) Bool (=> (or (= temp___is_init_1343 true) (<= 0 2)) (in_range14 temp___expr_1347)))
(define-fun dynamic_invariant20 ((temp___expr_1228 Int) (temp___is_init_1224 Bool) (temp___skip_constant_1225 Bool) (temp___do_toplevel_1226 Bool) (temp___do_typ_inv_1227 Bool)) Bool (=> (or (= temp___is_init_1224 true) (<= 0 17408)) (in_range11 temp___expr_1228)))
(define-fun dynamic_invariant21 ((temp___expr_1259 Int) (temp___is_init_1255 Bool) (temp___skip_constant_1256 Bool) (temp___do_toplevel_1257 Bool) (temp___do_typ_inv_1258 Bool)) Bool (=> (or (= temp___is_init_1255 true) (<= 0 1024)) (in_range13 temp___expr_1259)))
(assert true)
...
(assert (forall ((temp___1288 Int)) (=> (dynamic_invariant21 temp___1288 true true true true) (forall ((temp___1289 Int)) (= (to_rep7 (select (temp___1286 temp___1288) temp___1289)) temp___1288)))))
(assert (forall ((temp___1284 Int)) (=> (dynamic_invariant18 temp___1284 true true true true) (forall ((temp___1285 Int)) (= (to_rep4 (select (temp___1282 temp___1284) temp___1285)) temp___1284)))))
