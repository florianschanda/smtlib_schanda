...
(define-fun tint_arrayD1__ref___22__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___22__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t711b__ref (mk_t711b__ref (t711b__content integer)))))
(define-fun t711b__ref___projection ((a t711b__ref)) integer (t711b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t712b__ref (mk_t712b__ref (t712b__content us_t2)))))
(define-fun t712b__ref___projection ((a t712b__ref)) us_t2 (t712b__content a))
...
(define-fun tnumber_array_typeD1__ref___31__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___31__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t715b__ref (mk_t715b__ref (t715b__content integer)))))
(define-fun t715b__ref___projection ((a t715b__ref)) integer (t715b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t716b__ref (mk_t716b__ref (t716b__content us_t4)))))
(define-fun t716b__ref___projection ((a t716b__ref)) us_t4 (t716b__content a))
...
(declare-datatypes () ((t717b__ref (mk_t717b__ref (t717b__content integer)))))
(define-fun t717b__ref___projection ((a t717b__ref)) integer (t717b__content a))
...
(define-fun tint_arrayB__ref___22__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_length_7__int_array__aggregate_def (Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___2290 Int) (temp___2291 Int) (temp___2292 Int) (temp___2293 Int) (temp___2294 Int) (temp___2295 Int) (temp___2296 Int) (temp___2297 Int)) (let ((temp___2289 (aida__conversion__calculate_negative_target_length_7__int_array__aggregate_def temp___2290 temp___2291 temp___2292 temp___2293 temp___2294 temp___2295 temp___2296 temp___2297))) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 6) temp___2296 temp___2297) (and (= (first5 temp___2289) temp___2296) (= (last5 temp___2289) temp___2297))) (and (and (and (and (and (= (select (to_array2 temp___2289) (+ (+ (first1 source) 1) 0)) (of_rep1 temp___2290)) (= (select (to_array2 temp___2289) (+ (+ (first1 source) 1) 1)) (of_rep1 temp___2291))) (= (select (to_array2 temp___2289) (+ (+ (first1 source) 1) 2)) (of_rep1 temp___2292))) (= (select (to_array2 temp___2289) (+ (+ (first1 source) 1) 3)) (of_rep1 temp___2293))) (= (select (to_array2 temp___2289) (+ (+ (first1 source) 1) 4)) (of_rep1 temp___2294))) (= (select (to_array2 temp___2289) (+ (+ (first1 source) 1) 5)) (of_rep1 temp___2295)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___31__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_length_7__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___2303 Int) (temp___2304 Int) (temp___2305 Int)) (let ((temp___2302 (aida__conversion__calculate_negative_target_length_7__n__aggregate_def temp___2303 temp___2304 temp___2305))) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 6) temp___2304 temp___2305) (and (= (first9 temp___2302) temp___2304) (= (last9 temp___2302) temp___2305))) (forall ((temp___2306 Int)) (= (select (to_array4 temp___2302) temp___2306) (of_rep1 temp___2303)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_743 us_t3) (temp___is_init_740 Bool) (temp___skip_constant_741 Bool) (temp___do_toplevel_742 Bool)) Bool (=> (not (= temp___skip_constant_741 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 6) (first7 temp___expr_743) (last7 temp___expr_743)) (and (= (first7 temp___expr_743) (+ (first1 source) 1)) (= (last7 temp___expr_743) (+ (first1 source) 6))))))
...
(declare-const temp___2300 (Array Int integer))
(declare-const temp___23001 t2)
(declare-const aida__conversion__calculate_negative_target_length_7__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_length_7__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___2308 (Array Int integer))
(declare-const temp___23081 t4)
(declare-const aida__conversion__calculate_negative_target_length_7__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_length_7__n__assume1 t3)
(declare-const us2 Int)
(declare-const us3 Int)
(declare-const temp___2314 Int)
(declare-const temp___2315 Int)
(declare-const temp___2313 Int)
(declare-const temp___2311 (Array Int integer))
...
(assert (and (= (length source) 7) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index11) (<= index11 (+ (to_rep1 (first (rt source))) 6))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_length_7__int_array__aggregate_def 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 5))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_length_7__int_array__aggregate_def 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 5))))) (+ (+ (to_rep1 (first (rt source))) 1) 5)))
(assert (= (mk___t2 temp___2300 temp___23001) (aida__conversion__calculate_negative_target_length_7__int_array__aggregate_def 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 5))))
(assert (= (ite (<= (to_rep1 (first4 temp___23001)) (to_rep1 (last4 temp___23001))) (+ (- (to_rep1 (last4 temp___23001)) (to_rep1 (first4 temp___23001))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) (+ (- (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2300 (to_rep1 (first4 temp___23001)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_7__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) aida__conversion__calculate_negative_target_length_7__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_length_7__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_length_7__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_length_7__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 6)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_length_7__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_length_7__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6))))) (+ (to_rep1 (first (rt source))) 6)))
(assert (= (mk___t4 temp___2308 temp___23081) (aida__conversion__calculate_negative_target_length_7__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6))))
(assert (= (ite (<= (to_rep1 (first8 temp___23081)) (to_rep1 (last8 temp___23081))) (+ (- (to_rep1 (last8 temp___23081)) (to_rep1 (first8 temp___23081))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) (+ (- (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2308 (to_rep1 (first8 temp___23081)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_7__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) aida__conversion__calculate_negative_target_length_7__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_length_7__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_length_7__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_length_7__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 6)))))
(assert (and (= temp___2314 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2315 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___2314))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= temp___2313 index2)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= temp___2311 n1)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= o5 index2)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= o6 (select n1 o5))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= o7 (to_rep1 o6))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= o7 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= o8 index2)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= o9 (select (elts source) o8))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= o10 (to_rep o9))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o10))) (ite (= (= o10 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o10 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o10 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o10 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o10 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o10 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o10 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o10 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o10 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o10 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= (to_rep1 o11) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= o12 index2)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= o13 (store n1 o12 o11))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= n1 result4)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= n2 o13)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (and (and (forall ((temp___2312 Int)) (=> (and (<= (to_rep1 n__first) temp___2312) (<= temp___2312 (to_rep1 n__last))) (=> (< index3 temp___2312) (= (select n3 temp___2312) (select temp___2311 temp___2312))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6) index3))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 6))))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= index3 temp___2315)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= index3 index5)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= n3 n5)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= index6 index3)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= n6 n3)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= index8 index6)))
(assert (=> (and (<= temp___2314 index2) (<= index2 temp___2315)) (= n8 n6)))
(assert (=> (not (and (<= temp___2314 index2) (<= index2 temp___2315))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___2314 index2) (<= index2 temp___2315))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2314 index2) (<= index2 temp___2315))) (= index8 index2)))
(assert (=> (not (and (<= temp___2314 index2) (<= index2 temp___2315))) (= n8 n1)))
...
(assert (and (= temp___2316 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2316) (<= temp___2316 (to_rep1 n__last))))
(assert (= o41 temp___2316))
...
(assert (= target1 o45))
(assert (<= (- 9) target1))
(assert (and (= temp___2317 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2317) (<= temp___2317 (to_rep1 n__last))))
(assert (= o46 temp___2317))
...
(assert (= target2 o52))
(assert (<= (- 99) target2))
(assert (and (= temp___2318 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2318) (<= temp___2318 (to_rep1 n__last))))
(assert (= o53 temp___2318))
...
(assert (= target3 o59))
(assert (<= (- 999) target3))
(assert (and (= temp___2319 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2319) (<= temp___2319 (to_rep1 n__last))))
(assert (= o60 temp___2319))
...
(assert (= target4 o66))
(assert (<= (- 9999) target4))
(assert (and (= temp___2320 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2320) (<= temp___2320 (to_rep1 n__last))))
(assert (= o67 temp___2320))
...
(assert (and (= temp___2321 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___2321) (<= temp___2321 (to_rep1 n__last))))
(assert (= o74 temp___2321))
