...
(assert (forall ((temp___2392 Int) (temp___2393 Int) (temp___2394 Int) (temp___2395 Int) (temp___2396 Int) (temp___2397 Int) (temp___2398 Int) (temp___2399 Int)) (let ((temp___2391 (aida__conversion__calculate_negative_target_length_7__int_array__aggregate_def temp___2392 temp___2393 temp___2394 temp___2395 temp___2396 temp___2397 temp___2398 temp___2399))) (=> (and (and (and (and (and (dynamic_invariant temp___2392 true true true true) (dynamic_invariant temp___2393 true true true true)) (dynamic_invariant temp___2394 true true true true)) (dynamic_invariant temp___2395 true true true true)) (dynamic_invariant temp___2396 true true true true)) (dynamic_invariant temp___2397 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 6) temp___2398 temp___2399) (and (= (first5 temp___2391) temp___2398) (= (last5 temp___2391) temp___2399))) (and (and (and (and (and (= (to_rep1 (select (to_array2 temp___2391) (+ (+ (first1 source) 1) 0))) temp___2392) (= (to_rep1 (select (to_array2 temp___2391) (+ (+ (first1 source) 1) 1))) temp___2393)) (= (to_rep1 (select (to_array2 temp___2391) (+ (+ (first1 source) 1) 2))) temp___2394)) (= (to_rep1 (select (to_array2 temp___2391) (+ (+ (first1 source) 1) 3))) temp___2395)) (= (to_rep1 (select (to_array2 temp___2391) (+ (+ (first1 source) 1) 4))) temp___2396)) (= (to_rep1 (select (to_array2 temp___2391) (+ (+ (first1 source) 1) 5))) temp___2397)))))))
(define-fun dynamic_invariant4 ((temp___expr_834 us_t3) (temp___is_init_830 Bool) (temp___skip_constant_831 Bool) (temp___do_toplevel_832 Bool) (temp___do_typ_inv_833 Bool)) Bool (=> (not (= temp___skip_constant_831 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 6) (first7 temp___expr_834) (last7 temp___expr_834)) (and (= (first7 temp___expr_834) (+ (first1 source) 1)) (= (last7 temp___expr_834) (+ (first1 source) 6))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2405 Int) (temp___2406 Int) (temp___2407 Int)) (let ((temp___2404 (aida__conversion__calculate_negative_target_length_7__n__aggregate_def temp___2405 temp___2406 temp___2407))) (=> (dynamic_invariant temp___2405 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 6) temp___2406 temp___2407) (and (= (first9 temp___2404) temp___2406) (= (last9 temp___2404) temp___2407))) (forall ((temp___2408 Int)) (= (to_rep1 (select (to_array4 temp___2404) temp___2408)) temp___2405)))))))
...
(declare-const temp___2402 (Array Int integer))
(declare-const temp___24021 t2)
...
(declare-const temp___2410 (Array Int integer))
(declare-const temp___24101 t4)
...
(declare-const temp___2416 Int)
(declare-const temp___2417 Int)
(declare-const temp___2415 Int)
(declare-const temp___2413 (Array Int integer))
(declare-const o Int)
...
(declare-const temp___2418 Int)
(declare-const o9 Int)
(declare-const o10 integer)
(declare-const o11 Int)
(declare-const o12 Int)
(declare-const o13 Int)
(declare-const temp___2419 Int)
...
(assert (and (= (length source) 7) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index7) (<= index7 (+ (to_rep1 (first (rt source))) 6))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2402 temp___24021) (aida__conversion__calculate_negative_target_length_7__int_array__aggregate_def 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 5))))
(assert (= (ite (<= (to_rep1 (first4 temp___24021)) (to_rep1 (last4 temp___24021))) (+ (- (to_rep1 (last4 temp___24021)) (to_rep1 (first4 temp___24021))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) (+ (- (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2402 (to_rep1 (first4 temp___24021)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_7__int_array__assume))
...
(assert (= (mk___t4 temp___2410 temp___24101) (aida__conversion__calculate_negative_target_length_7__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6))))
(assert (= (ite (<= (to_rep1 (first8 temp___24101)) (to_rep1 (last8 temp___24101))) (+ (- (to_rep1 (last8 temp___24101)) (to_rep1 (first8 temp___24101))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) (+ (- (+ (to_rep1 (first (rt source))) 6) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2410 (to_rep1 (first8 temp___24101)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_7__n__assume))
...
(assert (and (= temp___2416 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2417 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2416))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= temp___2415 index1)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= temp___2413 n1)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= o index1)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= o3 index1)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= o7 index1)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= n1 result3)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= n2 o8)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (and (and (forall ((temp___2414 Int)) (=> (and (<= (to_rep1 n__first) temp___2414) (<= temp___2414 (to_rep1 n__last))) (=> (< index2 temp___2414) (= (select n3 temp___2414) (select temp___2413 temp___2414))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 6) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 6))))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= index2 temp___2417)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= index2 index3)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= n3 n4)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= index4 index2)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= n5 n3)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= index6 index4)))
(assert (=> (and (<= temp___2416 index1) (<= index1 temp___2417)) (= n7 n5)))
(assert (=> (not (and (<= temp___2416 index1) (<= index1 temp___2417))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2416 index1) (<= index1 temp___2417))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2416 index1) (<= index1 temp___2417))) (= index6 index1)))
(assert (=> (not (and (<= temp___2416 index1) (<= index1 temp___2417))) (= n7 n1)))
...
(assert (and (= temp___2418 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2418) (<= temp___2418 (to_rep1 n__last))))
(assert (= o9 temp___2418))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2419 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2419) (<= temp___2419 (to_rep1 n__last))))
(assert (= o14 temp___2419))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___2420 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2420) (<= temp___2420 (to_rep1 n__last))))
(assert (= o21 temp___2420))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___2421 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2421) (<= temp___2421 (to_rep1 n__last))))
(assert (= o28 temp___2421))
...
(assert (= target4 o34))
(assert (<= (- 9999) target4))
(assert (and (= temp___2422 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2422) (<= temp___2422 (to_rep1 n__last))))
(assert (= o35 temp___2422))
...
(assert (and (= temp___2423 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___2423) (<= temp___2423 (to_rep1 n__last))))
(assert (= o42 temp___2423))
