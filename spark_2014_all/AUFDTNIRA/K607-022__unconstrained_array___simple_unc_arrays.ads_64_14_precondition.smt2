...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (= temp___963 sum1)))
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (and (=> (<= (- 2147483648) 2147483647) (in_range3 sum2)) (and (<= 1 i2) (<= i2 r43b)))))
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))))
