...
(assert (forall ((a us_rep)) (! (=> (and (dynamic_invariant1 a true true true true) (not (= (empty a) true))) (let ((result (min a))) (and (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= result (to_rep2 (let ((temp___646 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___646) j)))))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= result (to_rep2 (let ((temp___645 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___645) j))))))) (dynamic_invariant2 result true false true true)))) :pattern ((min a)))))
(declare-fun max (us_rep) Int)
(declare-fun max__function_guard (Int us_rep) Bool)
(assert (forall ((a us_rep)) (! (=> (and (dynamic_invariant1 a true true true true) (not (= (empty a) true))) (let ((result (max a))) (and (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= (to_rep2 (let ((temp___654 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___654) j))) result))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= result (to_rep2 (let ((temp___653 (rec__simple_unc_arrays__table__v (us_split_fields1 a)))) (select (to_array temp___653) j))))))) (dynamic_invariant2 result true false true true)))) :pattern ((max a)))))
...
(assert (= (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) r43b))
(assert (in_range1 r43b))
(assert (= (mk_int__ref result1) (mk_int__ref i)))
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (= temp___958 sum1)))
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (and (=> (<= (- 2147483648) 2147483647) (in_range3 sum2)) (and (<= 1 i2) (<= i2 r43b)))))
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (and (<= (to_rep1 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep1 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a)))))))))
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (= o i2)))
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (= o1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o))))
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (= o2 (to_rep2 o1))))
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (= o3 (+ sum2 o2))))
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (and (= o4 o3) (in_range4 o3))))
...
(assert (= simple_unc_arrays__average__result1 simple_unc_arrays__average__result2))
(assert (= simple_unc_arrays__average__result3 simple_unc_arrays__average__result1))
(assert (= (mk_int__ref result3) (mk_int__ref simple_unc_arrays__average__result)))
(assert (= simple_unc_arrays__average__result1 (div1 sum6 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))))
(assert (= (mk_int__ref simple_unc_arrays__average__result4) (mk_int__ref simple_unc_arrays__average__result2)))
(assert (= (mk_int__ref i7) i9))
(assert (= (mk_int__ref sum8) sum10))
(assert (= simple_unc_arrays__average__result5 simple_unc_arrays__average__result3))
(assert (= i8 i6))
(assert (= sum9 sum7))
(assert (not (not (= (empty a) true))))
(check-sat)
(exit)
