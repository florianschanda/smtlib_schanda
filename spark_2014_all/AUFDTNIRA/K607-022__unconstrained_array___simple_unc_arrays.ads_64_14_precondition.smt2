...
(assert (and (and (and (= us (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))) (in_range1 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (and (and (= (mk_int__ref result) (mk_int__ref sum)) (= sum1 0)) (and (in_range3 sum1) (and (and (= (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) r43b) (in_range1 r43b)) (and (and (and (= (mk_int__ref result1) (mk_int__ref i)) (= i1 1)) (ite (and (<= 1 i1) (<= i1 r43b)) (and (and (and (= temp___878 sum1) (and (and (=> (<= (- 2147483648) 2147483647) (in_range3 sum2)) (and (<= 1 i2) (<= i2 r43b))) (and (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))) i2) (<= i2 (to_rep2 (last (rt (rec__simple_unc_arrays__table__v (us_split_fields1 a))))))) (= o i2)) (= o1 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) o))) (= o2 (to_rep1 o1))) (= o3 (+ sum2 o2))) (and (= o4 o3) (in_range2 o3))) (and (= sum2 result2) (= sum3 o4))) (= i2 r43b)))) (and (and (= i2 i3) (= sum3 sum4)) (and (= i4 i2) (= sum5 sum3)))) (and (and (= (mk_int__ref i5) (mk_int__ref i3)) (= (mk_int__ref sum6) (mk_int__ref sum4))) (and (= i6 i4) (= sum7 sum5)))) (and (and (= i1 i5) (= sum1 sum6)) (and (= i6 i1) (= sum7 sum1))))) (and (and (= simple_unc_arrays__average__result1 simple_unc_arrays__average__result2) (= simple_unc_arrays__average__result3 simple_unc_arrays__average__result1)) (and (= (mk_int__ref result3) (mk_int__ref simple_unc_arrays__average__result)) (= simple_unc_arrays__average__result1 (div1 sum6 (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a)))))))))))) (and (and (= (mk_int__ref simple_unc_arrays__average__result4) (mk_int__ref simple_unc_arrays__average__result2)) (and (= (mk_int__ref i7) (mk_int__ref i5)) (= (mk_int__ref sum8) (mk_int__ref sum6)))) (and (= simple_unc_arrays__average__result5 simple_unc_arrays__average__result3) (and (= i8 i6) (= sum9 sum7))))))
