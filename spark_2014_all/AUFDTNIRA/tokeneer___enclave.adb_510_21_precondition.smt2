...
(assert (not (= tokenok2 true)))
(assert (= o11 (extractuser tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2))))
