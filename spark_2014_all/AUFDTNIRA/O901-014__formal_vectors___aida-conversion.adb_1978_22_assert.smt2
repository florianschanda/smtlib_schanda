...
(define-fun tint_arrayD1__ref___20__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___20__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t661b__ref (mk_t661b__ref (t661b__content integer)))))
(define-fun t661b__ref___projection ((a t661b__ref)) integer (t661b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t662b__ref (mk_t662b__ref (t662b__content us_t2)))))
(define-fun t662b__ref___projection ((a t662b__ref)) us_t2 (t662b__content a))
...
(define-fun tnumber_array_typeD1__ref___29__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___29__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t665b__ref (mk_t665b__ref (t665b__content integer)))))
(define-fun t665b__ref___projection ((a t665b__ref)) integer (t665b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t666b__ref (mk_t666b__ref (t666b__content us_t4)))))
(define-fun t666b__ref___projection ((a t666b__ref)) us_t4 (t666b__content a))
...
(declare-datatypes () ((t667b__ref (mk_t667b__ref (t667b__content integer)))))
(define-fun t667b__ref___projection ((a t667b__ref)) integer (t667b__content a))
...
(define-fun tint_arrayB__ref___20__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___2216 Int) (temp___2217 Int) (temp___2218 Int) (temp___2219 Int) (temp___2220 Int) (temp___2221 Int) (temp___2222 Int) (temp___2223 Int) (temp___2224 Int) (temp___2225 Int)) (let ((temp___2215 (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def temp___2216 temp___2217 temp___2218 temp___2219 temp___2220 temp___2221 temp___2222 temp___2223 temp___2224 temp___2225))) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 8) temp___2224 temp___2225) (and (= (first5 temp___2215) temp___2224) (= (last5 temp___2215) temp___2225))) (and (and (and (and (and (and (and (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 0)) (of_rep1 temp___2216)) (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 1)) (of_rep1 temp___2217))) (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 2)) (of_rep1 temp___2218))) (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 3)) (of_rep1 temp___2219))) (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 4)) (of_rep1 temp___2220))) (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 5)) (of_rep1 temp___2221))) (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 6)) (of_rep1 temp___2222))) (= (select (to_array2 temp___2215) (+ (+ (first1 source) 1) 7)) (of_rep1 temp___2223)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___29__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_length_9__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___2231 Int) (temp___2232 Int) (temp___2233 Int)) (let ((temp___2230 (aida__conversion__calculate_negative_target_length_9__n__aggregate_def temp___2231 temp___2232 temp___2233))) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 8) temp___2232 temp___2233) (and (= (first9 temp___2230) temp___2232) (= (last9 temp___2230) temp___2233))) (forall ((temp___2234 Int)) (= (select (to_array4 temp___2230) temp___2234) (of_rep1 temp___2231)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_707 us_t3) (temp___is_init_704 Bool) (temp___skip_constant_705 Bool) (temp___do_toplevel_706 Bool)) Bool (=> (not (= temp___skip_constant_705 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 8) (first7 temp___expr_707) (last7 temp___expr_707)) (and (= (first7 temp___expr_707) (+ (first1 source) 1)) (= (last7 temp___expr_707) (+ (first1 source) 8))))))
...
(declare-const temp___2228 (Array Int integer))
(declare-const temp___22281 t2)
(declare-const aida__conversion__calculate_negative_target_length_9__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_length_9__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___2236 (Array Int integer))
(declare-const temp___22361 t4)
(declare-const aida__conversion__calculate_negative_target_length_9__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_length_9__n__assume1 t3)
(declare-const us2 Int)
(declare-const us3 Int)
(declare-const temp___2242 Int)
(declare-const temp___2243 Int)
(declare-const temp___2240 (Array Int integer))
(declare-const temp___2238 Int)
...
(assert (and (= (length source) 9) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index11) (<= index11 (+ (to_rep1 (first (rt source))) 8))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 7))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 7))))) (+ (+ (to_rep1 (first (rt source))) 1) 7)))
(assert (= (mk___t2 temp___2228 temp___22281) (aida__conversion__calculate_negative_target_length_9__int_array__aggregate_def 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 7))))
(assert (= (ite (<= (to_rep1 (first4 temp___22281)) (to_rep1 (last4 temp___22281))) (+ (- (to_rep1 (last4 temp___22281)) (to_rep1 (first4 temp___22281))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) (+ (- (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2228 (to_rep1 (first4 temp___22281)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_9__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) aida__conversion__calculate_negative_target_length_9__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_length_9__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_length_9__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_length_9__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 8)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_length_9__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_length_9__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8))))) (+ (to_rep1 (first (rt source))) 8)))
(assert (= (mk___t4 temp___2236 temp___22361) (aida__conversion__calculate_negative_target_length_9__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8))))
(assert (= (ite (<= (to_rep1 (first8 temp___22361)) (to_rep1 (last8 temp___22361))) (+ (- (to_rep1 (last8 temp___22361)) (to_rep1 (first8 temp___22361))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) (+ (- (+ (to_rep1 (first (rt source))) 8) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2236 (to_rep1 (first8 temp___22361)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_9__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) aida__conversion__calculate_negative_target_length_9__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_length_9__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_length_9__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_length_9__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 8)))))
(assert (and (= temp___2242 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2243 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___2242))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= temp___2240 n1)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= temp___2238 index2)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= o5 index2)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= o6 (select n1 o5))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= o7 (to_rep1 o6))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= o7 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= o8 index2)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= o9 (select (elts source) o8))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= o10 (to_rep o9))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o10))) (ite (= (= o10 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o10 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o10 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o10 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o10 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o10 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o10 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o10 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o10 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o10 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= (to_rep1 o11) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= o12 index2)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= o13 (store n1 o12 o11))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= n1 result4)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= n2 o13)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 8) index3)) (forall ((temp___2241 Int)) (=> (and (<= (to_rep1 n__first) temp___2241) (<= temp___2241 (to_rep1 n__last))) (=> (< index3 temp___2241) (= (select n3 temp___2241) (select temp___2240 temp___2241)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 8))))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= index3 temp___2243)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= index3 index5)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= n3 n5)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= index6 index3)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= n6 n3)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= index8 index6)))
(assert (=> (and (<= temp___2242 index2) (<= index2 temp___2243)) (= n8 n6)))
(assert (=> (not (and (<= temp___2242 index2) (<= index2 temp___2243))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___2242 index2) (<= index2 temp___2243))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2242 index2) (<= index2 temp___2243))) (= index8 index2)))
(assert (=> (not (and (<= temp___2242 index2) (<= index2 temp___2243))) (= n8 n1)))
...
(assert (and (= temp___2244 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2244) (<= temp___2244 (to_rep1 n__last))))
(assert (= o41 temp___2244))
(assert (= o42 (select (map__content1 n7) o41)))
...
(assert (= target1 o45))
(assert (<= (- 9) target1))
(assert (and (= temp___2245 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2245) (<= temp___2245 (to_rep1 n__last))))
(assert (= o46 temp___2245))
(assert (= o47 (select (map__content1 n7) o46)))
(assert (= o48 (to_rep1 o47)))
(assert (= o49 (* o48 10)))
(assert (and (= o50 o49) (in_range1 o49)))
(assert (= o51 (- target1 o50)))
(assert (and (= o52 o51) (in_range1 o51)))
(assert (= result10 (mk_int__ref target1)))
(assert (= target2 o52))
(assert (<= (- 99) target2))
(assert (and (= temp___2246 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2246) (<= temp___2246 (to_rep1 n__last))))
(assert (= o53 temp___2246))
(assert (= o54 (select (map__content1 n7) o53)))
(assert (= o55 (to_rep1 o54)))
(assert (= o56 (* o55 100)))
(assert (and (= o57 o56) (in_range1 o56)))
(assert (= o58 (- target2 o57)))
(assert (and (= o59 o58) (in_range1 o58)))
(assert (= result11 (mk_int__ref target2)))
(assert (= target3 o59))
(assert (<= (- 999) target3))
(assert (and (= temp___2247 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2247) (<= temp___2247 (to_rep1 n__last))))
(assert (= o60 temp___2247))
(assert (= o61 (select (map__content1 n7) o60)))
(assert (= o62 (to_rep1 o61)))
(assert (= o63 (* o62 1000)))
(assert (and (= o64 o63) (in_range1 o63)))
(assert (= o65 (- target3 o64)))
(assert (and (= o66 o65) (in_range1 o65)))
(assert (= result12 (mk_int__ref target3)))
(assert (= target4 o66))
(assert (<= (- 9999) target4))
(assert (and (= temp___2248 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2248) (<= temp___2248 (to_rep1 n__last))))
(assert (= o67 temp___2248))
(assert (= o68 (select (map__content1 n7) o67)))
(assert (= o69 (to_rep1 o68)))
(assert (= o70 (* o69 10000)))
(assert (and (= o71 o70) (in_range1 o70)))
(assert (= o72 (- target4 o71)))
(assert (and (= o73 o72) (in_range1 o72)))
(assert (= result13 (mk_int__ref target4)))
(assert (= target5 o73))
(assert (<= (- 99999) target5))
(assert (and (= temp___2249 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2249) (<= temp___2249 (to_rep1 n__last))))
(assert (= o74 temp___2249))
(assert (= o75 (select (map__content1 n7) o74)))
(assert (= o76 (to_rep1 o75)))
(assert (= o77 (* o76 100000)))
(assert (and (= o78 o77) (in_range1 o77)))
(assert (= o79 (- target5 o78)))
(assert (and (= o80 o79) (in_range1 o79)))
(assert (= result14 (mk_int__ref target5)))
(assert (= target6 o80))
(assert (<= (- 999999) target6))
(assert (and (= temp___2250 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2250) (<= temp___2250 (to_rep1 n__last))))
(assert (= o81 temp___2250))
(assert (= o82 (select (map__content1 n7) o81)))
(assert (= o83 (to_rep1 o82)))
(assert (= o84 (* o83 1000000)))
(assert (and (= o85 o84) (in_range1 o84)))
(assert (= o86 (- target6 o85)))
(assert (and (= o87 o86) (in_range1 o86)))
(assert (= result15 (mk_int__ref target6)))
(assert (= target7 o87))
(assert (not (<= (- 9999999) target7)))
(check-sat)
(exit)
