...
(assert (= (thedooralarm (us_private__content state5)) 0))
(assert (not (= (islocked (int__content currentlatch1) (us_private__content state4) (us_split_fields__content latchtimeout__split_fields4)) true)))
(check-sat)
(exit)
