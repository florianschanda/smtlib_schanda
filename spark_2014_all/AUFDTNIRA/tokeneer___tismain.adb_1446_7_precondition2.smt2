...
(assert (not (= (enrolmentisinprogress status2 (let ((subject state3)) state11)) true)))
(assert (not (= (privatekeypresent thistisinfo__split_fields1 (let ((subject state)) state8)) true)))
(check-sat)
(exit)
