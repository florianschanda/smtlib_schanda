...
(assert (<= left1 right1))
(assert (and (forall ((index2 Int)) (=> (and (<= 1 index2) (<= index2 (- left2 1))) (< (to_rep (select a index2)) i))) (forall ((index2 Int)) (=> (and (<= (+ right2 1) index2) (<= index2 10)) (< i (to_rep (select a index2)))))))
(assert (and (and (and (=> (<= 1 10) (in_range2 left2)) (=> (<= 1 10) (in_range2 right2))) (=> (<= 1 10) (in_range2 med2))) (<= left2 right2)))
(assert (= temp___1591 result4))
(assert (= temp___1592 (- right2 left2)))
(assert (and (= o (+ left2 (div1 (- right2 left2) 2))) (in_range2 (+ left2 (div1 (- right2 left2) 2)))))
(assert (= med2 result5))
(assert (= med3 o))
(assert (=> (< (to_rep (select a med3)) i) (and (= o1 (+ med3 1)) (in_range2 (+ med3 1)))))
(assert (=> (< (to_rep (select a med3)) i) (= left2 result6)))
(assert (=> (< (to_rep (select a med3)) i) (= left3 o1)))
(assert (=> (< (to_rep (select a med3)) i) (= binary_search__search__result4 binary_search__search__result3)))
(assert (=> (< (to_rep (select a med3)) i) (= right3 right2)))
(assert (=> (not (< (to_rep (select a med3)) i)) (< i (to_rep (select a med3)))))
(assert (=> (not (< (to_rep (select a med3)) i)) (and (= o2 (- med3 1)) (in_range2 (- med3 1)))))
(assert (=> (not (< (to_rep (select a med3)) i)) (= right2 result7)))
(assert (=> (not (< (to_rep (select a med3)) i)) (= right3 o2)))
(assert (=> (not (< (to_rep (select a med3)) i)) (= binary_search__search__result4 binary_search__search__result3)))
(assert (=> (not (< (to_rep (select a med3)) i)) (= left3 left2)))
(assert (<= left3 right3))
(assert (not (< (- right3 left3) temp___1592)))
(check-sat)
(exit)
