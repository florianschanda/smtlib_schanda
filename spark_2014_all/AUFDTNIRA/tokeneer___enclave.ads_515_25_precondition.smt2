...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (not (= (enrolmentisinprogress (int__content status8)) true)) (= (and (and (= (islocked (int__content currentlatch3) (us_private__content state36) (us_split_fields__content1 latchtimeout__split_fields6)) true) (= (thecurrentdoor (us_private__content state37)) 0)) (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime)) (alarm_timeout (us_private__content state37))) true)) (= (thedooralarm (us_private__content state37)) 0))) (=> (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5))) 1) (and (and (= (isgood (int__content tokenpresence5) (us_private__content state35) (int__content tokentry5) (int__content tokenid5) (us_split_fields__content9 authcert__split_fields5) (us_split_fields__content12 idcert__split_fields5)) true) (= (authcertvalid (int__content tokenpresence5) (us_private__content state35) (int__content tokentry5) (int__content tokenid5) (us_split_fields__content9 authcert__split_fields5) (us_split_fields__content12 idcert__split_fields5)) true)) (= (theauthcertrole (int__content tokenpresence5) (us_private__content state35) (int__content tokentry5) (int__content tokenid5) (us_split_fields__content9 authcert__split_fields5) (us_split_fields__content12 idcert__split_fields5)) 1)))) (=> (and (not (= (islocked (int__content currentlatch3) (us_private__content state36) (us_split_fields__content1 latchtimeout__split_fields6)) true)) (= (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) true)) (and (and (= (isgood (int__content tokenpresence5) (us_private__content state35) (int__content tokentry5) (int__content tokenid5) (us_split_fields__content9 authcert__split_fields5) (us_split_fields__content12 idcert__split_fields5)) true) (= (authcertvalid (int__content tokenpresence5) (us_private__content state35) (int__content tokentry5) (int__content tokenid5) (us_split_fields__content9 authcert__split_fields5) (us_split_fields__content12 idcert__split_fields5)) true)) (= (theauthcertrole (int__content tokenpresence5) (us_private__content state35) (int__content tokentry5) (int__content tokenid5) (us_split_fields__content9 authcert__split_fields5) (us_split_fields__content12 idcert__split_fields5)) 1)))) (=> (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5))) true) (= (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields5))) 3)) (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5))) 1))) (=> (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5))) 1) (or (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5))) true) (= (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields5))) 3)) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5))) true))))) (=> (not (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields5))) true)) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5))) true)))) (=> (or (= (int__content status8) 5) (= (int__content status8) 4)) (not (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields5))) true)))) (=> (or (= (int__content status8) 6) (= (int__content status8) 7)) (and (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5))) true) (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields5))) true)) (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5))) (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))))))) (=> (= (int__content status8) 3) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5))) true)))) (=> (= (int__content status8) 8) (and (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5))) true)) (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5))) 0)))) (=> (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5))) true) (= (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields5))) 4)) (= (int__content status8) 6))) (=> (and (not (= (islocked (int__content currentlatch3) (us_private__content state36) (us_split_fields__content1 latchtimeout__split_fields6)) true)) (= (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) true)) (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)))))
(assert (and (and (and (and (and (and (in_range1 (int__content tokenpresence5)) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content3 logfilestate__split_fields11))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content3 logfilestate__split_fields11))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content3 logfilestate__split_fields11)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content3 logfilestate__split_fields11))) true)) (in_range6 (int__content auditalarm5))) (in_range17 (int__content tokentry5))) (in_range28 (int__content status8))) (in_range26 (int__content currentlatch3))) (in_range16 (int__content tokenid5))))
(assert (and (= o80 (islocked (int__content currentlatch3) (us_private__content state36) (us_split_fields__content1 latchtimeout__split_fields6))) (= (= o80 true) (= (int__content currentlatch3) 0))))
(assert (= o81 (ite (not (= o80 true)) true false)))
(assert (= result14 (ite (= o81 true) (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
