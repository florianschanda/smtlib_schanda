...
(declare-fun to_rep3 (twenty_four) Int)
...
(declare-fun to_rep4 (thousand) Int)
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_151 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_151 us_void_param) 2)) 32)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 8)) 32)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 9)) 32)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 11)) 32)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 13)) 32)) (= (to_rep (select (temp___String_Literal_151 us_void_param) 14)) 32)) :pattern ((temp___String_Literal_151 us_void_param)))))
(define-fun default_initial_assumption ((temp___expr_293 us_rep2) (temp___skip_top_level_294 Bool)) Bool (and (= (attr__tag2 temp___expr_293) us_tag3) (and (and (and (and (= (to_rep4 (rec__instr__child__accurate_clock__millisec (us_split_fields5 temp___expr_293))) 0) (= (rec__instr__instrument__name2 (us_split_fields5 temp___expr_293)) (temp___String_Literal_151 Tuple0))) (= (to_rep2 (rec__instr__clock__seconds1 (us_split_fields5 temp___expr_293))) 0)) (= (to_rep2 (rec__instr__clock__minutes1 (us_split_fields5 temp___expr_293))) 0)) (= (to_rep3 (rec__instr__clock__hours1 (us_split_fields5 temp___expr_293))) 0))))
(declare-const x us_rep2)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun temp___String_Literal_306 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (= (to_rep (select (temp___String_Literal_306 us_void_param) 1)) 58) :pattern ((temp___String_Literal_306 us_void_param)))))
...
(define-fun dynamic_invariant4 ((temp___expr_285 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 0 1000)) (in_range5 temp___expr_285)))
(define-fun dynamic_invariant5 ((temp___expr_225 Int) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool)) Bool (=> (or (= temp___is_init_222 true) (<= 0 60)) (in_range3 temp___expr_225)))
(define-fun dynamic_invariant6 ((temp___expr_231 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 24)) (in_range4 temp___expr_231)))
(define-fun default_initial_assumption1 ((temp___expr_149 us_rep) (temp___skip_top_level_150 Bool)) Bool (and (= (attr__tag temp___expr_149) us_tag) (= (rec__instr__instrument__name (us_split_fields1 temp___expr_149)) (temp___String_Literal_151 Tuple0))))
(define-fun default_initial_assumption2 ((temp___expr_239 us_rep1) (temp___skip_top_level_240 Bool)) Bool (and (= (attr__tag1 temp___expr_239) us_tag1) (and (and (and (= (to_rep2 (rec__instr__clock__seconds (us_split_fields3 temp___expr_239))) 0) (= (to_rep2 (rec__instr__clock__minutes (us_split_fields3 temp___expr_239))) 0)) (= (to_rep3 (rec__instr__clock__hours (us_split_fields3 temp___expr_239))) 0)) (= (rec__instr__instrument__name1 (us_split_fields3 temp___expr_239)) (temp___String_Literal_151 Tuple0)))))
(define-fun default_initial_assumption3 ((temp___expr_263 us_rep1) (temp___skip_top_level_264 Bool)) Bool (and (= (attr__tag1 temp___expr_263) us_tag2) (and (and (and (= (rec__instr__instrument__name1 (us_split_fields3 temp___expr_263)) (temp___String_Literal_151 Tuple0)) (= (to_rep2 (rec__instr__clock__seconds (us_split_fields3 temp___expr_263))) 0)) (= (to_rep2 (rec__instr__clock__minutes (us_split_fields3 temp___expr_263))) 0)) (= (to_rep3 (rec__instr__clock__hours (us_split_fields3 temp___expr_263))) 0))))
