...
(assert (< 1 (to_rep4 logfilestate__split_fields5)))
(assert (= (to_rep6 (select logfilesstatus (to_rep2 (select logfilestate__split_fields2 (to_rep2 logfilestate__split_fields3))))) 1))
(assert (and (and (< 1 (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))))) (= (to_rep6 (select logfilesstatus2 (to_rep2 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))))))) 1)) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (+ (* (- (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) 1) 1024) (to_rep5 (select (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8) (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8))))))))
(assert (and (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8) logfilestate__split_fields) (and (= (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) logfilestate__split_fields2) (= (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) logfilestate__split_fields4))))
(assert (not (= (to_rep2 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))))) (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)))))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 17)) (=> (not (= i (to_rep2 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))))))) (= (to_rep5 (select auditlog__deletelogfile__logfileentries i)) (to_rep5 (select (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8) i)))))))
(assert (= result (mk___split_fields__ref1 logfilestate__split_fields8)))
(assert (= logfilestate__split_fields9 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) auditlog__deletelogfile__logfileentries)))
(assert (not (in_range9 (- (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9)))) 1))))
(check-sat)
(exit)
