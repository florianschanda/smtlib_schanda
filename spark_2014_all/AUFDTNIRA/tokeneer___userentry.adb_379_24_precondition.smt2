...
(define-fun dynamic_invariant1 ((temp___expr_464 Int) (temp___is_init_461 Bool) (temp___skip_constant_462 Bool) (temp___do_toplevel_463 Bool)) Bool (=> (or (= temp___is_init_461 true) (<= 0 1)) (in_range4 temp___expr_464)))
...
(define-fun dynamic_invariant3 ((temp___expr_2310 Int) (temp___is_init_2307 Bool) (temp___skip_constant_2308 Bool) (temp___do_toplevel_2309 Bool)) Bool (=> (or (= temp___is_init_2307 true) (<= 0 7)) (in_range16 temp___expr_2310)))
...
(define-fun dynamic_invariant13 ((temp___expr_486 Int) (temp___is_init_483 Bool) (temp___skip_constant_484 Bool) (temp___do_toplevel_485 Bool)) Bool (=> (or (= temp___is_init_483 true) (<= 1 150)) (in_range5 temp___expr_486)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant14 ((temp___expr_528 Int) (temp___is_init_525 Bool) (temp___skip_constant_526 Bool) (temp___do_toplevel_527 Bool)) Bool (=> (or (= temp___is_init_525 true) (<= 1901 2099)) (in_range6 temp___expr_528)))
(define-fun dynamic_invariant15 ((temp___expr_534 Int) (temp___is_init_531 Bool) (temp___skip_constant_532 Bool) (temp___do_toplevel_533 Bool)) Bool (=> (or (= temp___is_init_531 true) (<= 1 12)) (in_range7 temp___expr_534)))
(define-fun dynamic_invariant16 ((temp___expr_540 Int) (temp___is_init_537 Bool) (temp___skip_constant_538 Bool) (temp___do_toplevel_539 Bool)) Bool (=> (or (= temp___is_init_537 true) (<= 1 31)) (in_range8 temp___expr_540)))
(define-fun dynamic_invariant17 ((temp___expr_564 Int) (temp___is_init_561 Bool) (temp___skip_constant_562 Bool) (temp___do_toplevel_563 Bool)) Bool (=> (or (= temp___is_init_561 true) (<= 0 86399999)) (in_range9 temp___expr_564)))
(define-fun dynamic_invariant18 ((temp___expr_1551 Int) (temp___is_init_1548 Bool) (temp___skip_constant_1549 Bool) (temp___do_toplevel_1550 Bool)) Bool (=> (or (= temp___is_init_1548 true) (<= 0 2147483647)) (in_range15 temp___expr_1551)))
