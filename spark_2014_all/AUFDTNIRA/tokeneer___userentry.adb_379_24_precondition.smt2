...
(define-fun dynamic_invariant ((temp___expr_195 Int) (temp___is_init_192 Bool) (temp___skip_constant_193 Bool) (temp___do_toplevel_194 Bool)) Bool (=> (or (= temp___is_init_192 true) (<= 0 1)) (in_range3 temp___expr_195)))
...
(define-fun dynamic_invariant1 ((temp___expr_504 Int) (temp___is_init_501 Bool) (temp___skip_constant_502 Bool) (temp___do_toplevel_503 Bool)) Bool (=> (or (= temp___is_init_501 true) (<= 0 1)) (in_range4 temp___expr_504)))
...
(define-fun dynamic_invariant3 ((temp___expr_2366 Int) (temp___is_init_2363 Bool) (temp___skip_constant_2364 Bool) (temp___do_toplevel_2365 Bool)) Bool (=> (or (= temp___is_init_2363 true) (<= 0 7)) (in_range16 temp___expr_2366)))
...
(define-fun dynamic_invariant13 ((temp___expr_526 Int) (temp___is_init_523 Bool) (temp___skip_constant_524 Bool) (temp___do_toplevel_525 Bool)) Bool (=> (or (= temp___is_init_523 true) (<= 1 150)) (in_range5 temp___expr_526)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant14 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1901 2099)) (in_range6 temp___expr_572)))
(define-fun dynamic_invariant15 ((temp___expr_578 Int) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (or (= temp___is_init_575 true) (<= 1 12)) (in_range7 temp___expr_578)))
(define-fun dynamic_invariant16 ((temp___expr_584 Int) (temp___is_init_581 Bool) (temp___skip_constant_582 Bool) (temp___do_toplevel_583 Bool)) Bool (=> (or (= temp___is_init_581 true) (<= 1 31)) (in_range8 temp___expr_584)))
(define-fun dynamic_invariant17 ((temp___expr_612 Int) (temp___is_init_609 Bool) (temp___skip_constant_610 Bool) (temp___do_toplevel_611 Bool)) Bool (=> (or (= temp___is_init_609 true) (<= 0 86399999)) (in_range9 temp___expr_612)))
(define-fun dynamic_invariant18 ((temp___expr_1607 Int) (temp___is_init_1604 Bool) (temp___skip_constant_1605 Bool) (temp___do_toplevel_1606 Bool)) Bool (=> (or (= temp___is_init_1604 true) (<= 0 2147483647)) (in_range15 temp___expr_1607)))
