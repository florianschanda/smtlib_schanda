...
(assert (and (= o (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (and (in_range9 o) (= o (to_rep3 theadmin__split_fields)))))
(assert (= result (ite (= o 1) true false)))
(assert (=> (= result true) (and (= o2 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (= (= o2 true) (in_range8 (to_rep4 theadmin__split_fields1))))))
(assert (=> (= result true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (= result true) (and (= result1 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (= (= result1 true) (in_range8 (to_rep4 theadmin__split_fields1))))))
(assert (=> (= result true) (=> (= result1 true) (and (= o1 (thecurrentop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (in_range8 o1)))))
...
(assert (and (= result2 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (= (= result2 true) (in_range8 (to_rep4 theadmin__split_fields1)))))
(assert (= result2 true))
