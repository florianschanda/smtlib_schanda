...
(assert (and (= o1 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (and (in_range9 o1) (= o1 (to_rep3 theadmin__split_fields)))))
(assert (= result (ite (= o1 1) true false)))
(assert (=> (= result true) (and (= o3 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (= (= o3 true) (in_range8 (to_rep4 theadmin__split_fields1))))))
...
(assert (=> (= result true) (=> (= result1 true) (and (= o2 (thecurrentop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (in_range8 o2)))))
