...
(assert (=> (= result true) (and (= o13 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o13 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result true) (= o14 (ite (not (= o13 true)) true false))))
...
(assert (=> (= result true) (=> (= result1 true) (and (= o12 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o12)))))
(assert (=> (= result true) (=> (= result1 true) (= o15 (ite (= o12 3) true false)))))
(assert (=> (= result true) (=> (not (= result1 true)) (= o15 false))))
(assert (=> (= result true) (= o16 (ite (= o15 false) o14 true))))
(assert (=> (not (= result true)) (= o16 (of_int 1))))
