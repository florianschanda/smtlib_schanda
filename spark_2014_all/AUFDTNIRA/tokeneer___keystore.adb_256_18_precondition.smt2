...
(declare-const temp___1904 us_t1)
...
(assert (= temp___1904 (mk___t1 (temp___String_Literal_1903 Tuple0) (mk1 1 12))))
(assert (dynamic_predicate temp___1904))
(assert (= o8 temp___1904))
(assert (= o9 (convertretvaltotext (int__content retvalupd8) o8)))
