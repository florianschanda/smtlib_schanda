...
(declare-const result17 (Array Int (Array Int integer)))
(declare-const result18 t1)
...
(assert (= (mk___t1 result17 result18) (integer_product_type__content cartesian__cartesian_product__result5)))
...
(assert (not (= (in_array__2 (temp___173 (to_rep (select (elts array1) i5)) (to_rep (select (elts array2) j9))) (integer_product_type__content cartesian__cartesian_product__result5)) true)))
(check-sat)
(exit)
