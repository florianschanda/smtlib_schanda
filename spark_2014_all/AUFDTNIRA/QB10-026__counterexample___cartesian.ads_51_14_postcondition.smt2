...
(assert (forall ((i Int)) (=> (and (<= (to_rep (first (rt array1))) i) (<= i (to_rep (last (rt array1))))) (forall ((j Int)) (=> (and (<= (to_rep (first (rt array2))) j) (<= j (to_rep (last (rt array2))))) (= (to_rep (select (select (map__content1 result__11) (+ (+ (* (- i (to_rep (first (rt array1)))) (length array2)) (- j (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j))))))))
...
(assert (= (mk___t1 result7 result8) (integer_product_type__content cartesian__cartesian_product__result5)))
(declare-const i Int)
...
(assert (not (= (in_array__2 (temp___198 (to_rep (select (elts array1) i)) (to_rep (select (elts array2) j))) (integer_product_type__content cartesian__cartesian_product__result5)) true)))
(check-sat)
(exit)
