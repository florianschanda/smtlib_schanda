...
(assert (= (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) temp___1601))
(assert (= (mk1 1 (length thestring)) temp___16011))
(assert (and (= temp___1603 (length thestring)) (in_range1 (length thestring))))
(assert (=> (<= 1 temp___1603) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1603) (<= temp___1603 150)))))
(assert (= o7 result__1))
(assert (= o7 temp___1604))
(assert (= (mk1 1 temp___1603) temp___16041))
(assert (not (= (ite (<= (to_rep1 (first2 temp___16011)) (to_rep1 (last2 temp___16011))) (+ (- (to_rep1 (last2 temp___16011)) (to_rep1 (first2 temp___16011))) 1) 0) (ite (<= (to_rep1 (first2 temp___16041)) (to_rep1 (last2 temp___16041))) (+ (- (to_rep1 (last2 temp___16041)) (to_rep1 (first2 temp___16041))) 1) 0))))
(check-sat)
(exit)
