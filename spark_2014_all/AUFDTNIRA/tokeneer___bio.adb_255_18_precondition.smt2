...
(assert (dynamic_predicate (mk___t1 temp___1336 temp___13361)))
(assert (= (mk___t1 o1 o2) (mk___t1 temp___1336 temp___13361)))
(assert (= o3 (makedescription (mk___t1 o1 o2) numericreturn1)))
(assert (= o3 o4))
(assert (= (mk 1 150) o5))
