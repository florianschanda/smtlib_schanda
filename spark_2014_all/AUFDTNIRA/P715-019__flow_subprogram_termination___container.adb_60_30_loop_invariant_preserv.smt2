...
(declare-const temp___6272 int__ref)
(declare-const temp___6262 int__ref)
(declare-const r5 Int)
(declare-const i5 Int)
(declare-const temp___6273 Int)
(declare-const temp___6263 Int)
...
(assert (= r3 o1))
(assert (and (= o2 (+ i2 1)) (in_range5 (+ i2 1))))
(assert (= result11 (mk_int__ref i2)))
(assert (= i3 o2))
(assert (< i3 10))
(assert (= temp___6262 (mk_int__ref temp___6261)))
(assert (= temp___6272 (mk_int__ref temp___6271)))
(assert (= i4 (mk_int__ref i3)))
(assert (= r4 (mk_int__ref r3)))
(assert (= temp___6263 temp___6261))
(assert (= temp___6273 temp___6271))
(assert (= i5 i3))
(assert (= r5 r3))
