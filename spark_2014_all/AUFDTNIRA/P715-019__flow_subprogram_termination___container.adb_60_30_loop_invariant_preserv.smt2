...
(declare-const temp___6342 int__ref)
(declare-const temp___6332 int__ref)
(declare-const r5 Int)
(declare-const i5 Int)
(declare-const temp___6343 Int)
(declare-const temp___6333 Int)
...
(assert (= i3 o4))
(assert (< i3 10))
(assert (= temp___6332 (mk_int__ref temp___6331)))
(assert (= temp___6342 (mk_int__ref temp___6341)))
(assert (= i4 (mk_int__ref i3)))
(assert (= r4 (mk_int__ref r3)))
(assert (= temp___6333 temp___6331))
(assert (= temp___6343 temp___6341))
(assert (= i5 i3))
(assert (= r5 r3))
