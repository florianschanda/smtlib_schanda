...
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1645)) (= index9 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1645)) (= n10 (mk_map__ref1 n4))))
