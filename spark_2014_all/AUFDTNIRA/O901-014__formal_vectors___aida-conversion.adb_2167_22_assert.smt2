...
(assert (= target1 o45))
(assert (<= (- 9) target1))
(assert (and (= temp___2381 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2381) (<= temp___2381 (to_rep1 n__last))))
(assert (= o46 temp___2381))
...
(assert (= target2 o52))
(assert (<= (- 99) target2))
(assert (and (= temp___2382 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2382) (<= temp___2382 (to_rep1 n__last))))
(assert (= o53 temp___2382))
...
(assert (= target3 o59))
(assert (<= (- 999) target3))
(assert (and (= temp___2383 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___2383) (<= temp___2383 (to_rep1 n__last))))
(assert (= o60 temp___2383))
