...
(assert (forall ((temp___1066 Int)) (forall ((temp___1067 Int)) (= (select (temp___1064 temp___1066) temp___1067) (of_rep3 temp___1066)))))
(declare-fun temp___1068 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1070 Int)) (forall ((temp___1071 Int)) (= (select (temp___1068 temp___1070) temp___1071) (of_rep6 temp___1070)))))
(define-fun dynamic_invariant1 ((temp___expr_1058 us_rep1) (temp___is_init_1055 Bool) (temp___skip_constant_1056 Bool) (temp___do_toplevel_1057 Bool)) Bool (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1058))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1058))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1058)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1058))) true))
(define-fun default_initial_assumption ((temp___expr_1062 us_rep1) (temp___skip_top_level_1063 Bool)) Bool (and (and (and (= (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1062))) 1) (= (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1062))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1062)) (mk___rep (mk___split_fields (temp___1064 1) (of_rep3 1) (of_rep3 1) (of_rep5 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1062)) (temp___1068 0))))
(define-fun type_invariant ((temp___1072 us_rep1)) Bool (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1072))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1072))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1072)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1072))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_1224 Int) (temp___is_init_1221 Bool) (temp___skip_constant_1222 Bool) (temp___do_toplevel_1223 Bool)) Bool (=> (or (= temp___is_init_1221 true) (<= 0 7)) (in_range11 temp___expr_1224)))
...
(declare-fun temp___1475 (Int) (Array Int character))
(assert (forall ((temp___1477 Int)) (forall ((temp___1478 Int)) (= (select (temp___1475 temp___1477) temp___1478) (of_rep temp___1477)))))
(declare-fun temp___String_Literal_1479 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1479 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 3)) 117)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 4)) 108)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 5)) 100)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 7)) 110)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 8)) 111)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 9)) 116)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 11)) 117)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 12)) 112)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 13)) 100)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 14)) 97)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 15)) 116)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 17)) 32)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 18)) 68)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 20)) 115)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 21)) 112)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 22)) 108)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_1479 us_void_param) 24)) 121)) :pattern ((temp___String_Literal_1479 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1230 Int) (temp___is_init_1227 Bool) (temp___skip_constant_1228 Bool) (temp___do_toplevel_1229 Bool)) Bool (=> (or (= temp___is_init_1227 true) (<= 0 23)) (in_range12 temp___expr_1230)))
...
(define-fun dynamic_invariant8 ((temp___expr_1280 Int) (temp___is_init_1277 Bool) (temp___skip_constant_1278 Bool) (temp___do_toplevel_1279 Bool)) Bool (=> (or (= temp___is_init_1277 true) (<= 0 50)) (in_range13 temp___expr_1280)))
(define-fun dynamic_invariant9 ((temp___expr_1286 Int) (temp___is_init_1283 Bool) (temp___skip_constant_1284 Bool) (temp___do_toplevel_1285 Bool)) Bool (=> (or (= temp___is_init_1283 true) (<= 1 50)) (in_range14 temp___expr_1286)))
(define-fun dynamic_invariant10 ((temp___expr_1024 Int) (temp___is_init_1021 Bool) (temp___skip_constant_1022 Bool) (temp___do_toplevel_1023 Bool)) Bool (=> (or (= temp___is_init_1021 true) (<= 0 17)) (in_range8 temp___expr_1024)))
(define-fun dynamic_invariant11 ((temp___expr_1003 Int) (temp___is_init_1000 Bool) (temp___skip_constant_1001 Bool) (temp___do_toplevel_1002 Bool)) Bool (=> (or (= temp___is_init_1000 true) (<= 1 17)) (in_range6 temp___expr_1003)))
(define-fun dynamic_invariant12 ((temp___expr_1128 Int) (temp___is_init_1125 Bool) (temp___skip_constant_1126 Bool) (temp___do_toplevel_1127 Bool)) Bool (=> (or (= temp___is_init_1125 true) (<= 0 2)) (in_range10 temp___expr_1128)))
(define-fun dynamic_invariant13 ((temp___expr_1009 Int) (temp___is_init_1006 Bool) (temp___skip_constant_1007 Bool) (temp___do_toplevel_1008 Bool)) Bool (=> (or (= temp___is_init_1006 true) (<= 0 17408)) (in_range7 temp___expr_1009)))
(define-fun dynamic_invariant14 ((temp___expr_1043 Int) (temp___is_init_1040 Bool) (temp___skip_constant_1041 Bool) (temp___do_toplevel_1042 Bool)) Bool (=> (or (= temp___is_init_1040 true) (<= 0 1024)) (in_range9 temp___expr_1043)))
(assert true)
...
(declare-const c36b__split_fields3 us_split_fields8)
...
(declare-const c36b__split_fields4 us_split_fields__ref4)
...
(declare-const c36b__split_fields5 us_split_fields8)
...
(assert (= temp___1488 (display__msgtostrings__aggregate_def o51 o50 o49 o48 o47 o46 o45 o44)))
(assert (= temp___1488 msgtostrings))
...
(assert (= (mk___rep3 themsg__split_fields4) c35b))
(assert (= (to_rep9 o52) 0))
(assert (= o53 (mk___split_fields4 (temp___1475 32) o52)))
(assert (= display__updatedevice__B38b__result__assume (mk___rep4 o53)))
(assert (= result3 result____split_fields))
(assert (= (let ((subject result____split_fields)) result____split_fields2) (us_split_fields9 display__updatedevice__B38b__result__assume)))
(assert (= result4 i))
(assert (= (let ((subject i)) i4) 1))
(assert (=> (and (<= 1 (let ((subject i)) i4)) (<= (let ((subject i)) i4) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b))))))) (and (and (= temp___1441 (let ((subject i)) i4)) (and (= temp___1439 (mk___rep4 (let ((subject result____split_fields)) result____split_fields2))) (and (= temp___1442 c35b) (and (and (and (<= 1 (let ((subject i)) i5)) (<= (let ((subject i)) i5) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b))))))) (= (bool_eq10 c35b temp___1442) true)) (and (and (and (and (forall ((temp___1440 Int)) (=> (and (<= 1 temp___1440) (<= temp___1440 50)) (=> (<= (let ((subject i)) i5) temp___1440) (= (select (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields3)) temp___1440) (select (rec__display__scrollstrt__text (us_split_fields9 temp___1439)) temp___1440))))) (= (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields3)) (rec__display__scrollstrt__len (us_split_fields9 temp___1439)))) (=> (<= 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b)))))) (dynamic_property1 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b))))) (let ((subject i)) i5)))) (and (<= 1 (let ((subject i)) i5)) (<= (let ((subject i)) i5) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b)))))))) (and (and (and (and (and (= (to_rep o54) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b)))) (let ((subject i)) i5)))) (= o55 (store (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields3)) (let ((subject i)) i5) o54))) (= o56 (mk___split_fields4 o55 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields3))))) (= temp___1438 (mk___rep4 o56))) (and (= result5 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields3))) (= (let ((subject result____split_fields)) result____split_fields4) (us_split_fields9 temp___1438)))) (= (let ((subject i)) i5) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b)))))))))))) (and (and (= i9 (let ((subject i)) (mk_int__ref i5))) (= result____split_fields7 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields4)))) (and (= i10 i5) (= result____split_fields8 result____split_fields4))))))
(assert (=> (and (<= 1 (let ((subject i)) i4)) (<= (let ((subject i)) i4) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b))))))) (= i11 i9)))
(assert (=> (and (<= 1 (let ((subject i)) i4)) (<= (let ((subject i)) i4) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b))))))) (= result____split_fields9 result____split_fields7)))
(assert (=> (and (<= 1 (let ((subject i)) i4)) (<= (let ((subject i)) i4) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b))))))) (= i12 i10)))
(assert (=> (and (<= 1 (let ((subject i)) i4)) (<= (let ((subject i)) i4) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b))))))) (= result____split_fields10 result____split_fields8)))
(assert (=> (not (and (<= 1 (let ((subject i)) i4)) (<= (let ((subject i)) i4) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b)))))))) (= i11 (let ((subject i)) (mk_int__ref i4)))))
(assert (=> (not (and (<= 1 (let ((subject i)) i4)) (<= (let ((subject i)) i4) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b)))))))) (= result____split_fields9 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields2)))))
(assert (=> (not (and (<= 1 (let ((subject i)) i4)) (<= (let ((subject i)) i4) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b)))))))) (= i12 i4)))
(assert (=> (not (and (<= 1 (let ((subject i)) i4)) (<= (let ((subject i)) i4) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b)))))))) (= result____split_fields10 result____split_fields2)))
(assert (= (to_rep9 o57) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b)))))))
(assert (= o58 (mk___split_fields4 (rec__display__scrollstrt__text (us_split_fields__content4 result____split_fields9)) o57)))
(assert (= temp___1446 (mk___rep4 o58)))
(assert (= result7 result____split_fields9))
(assert (= (let ((subject result____split_fields)) result____split_fields11) (us_split_fields9 temp___1446)))
...
(assert (= temp___1450 (mk___rep4 o62)))
(assert (= result8 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields11))))
(assert (= (let ((subject result____split_fields)) result____split_fields12) (us_split_fields9 temp___1450)))
...
(assert (= temp___1454 (mk___rep4 o66)))
(assert (= result9 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields12))))
(assert (= (let ((subject result____split_fields)) result____split_fields13) (us_split_fields9 temp___1454)))
...
(assert (= temp___1458 (mk___rep4 o70)))
(assert (= result10 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields13))))
(assert (= (let ((subject result____split_fields)) result____split_fields14) (us_split_fields9 temp___1458)))
...
(assert (= temp___1460 (mk___rep4 o73)))
(assert (= result11 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields14))))
(assert (= (let ((subject result____split_fields)) result____split_fields15) (us_split_fields9 temp___1460)))
(assert (= result12 i1))
(assert (= (let ((subject i1)) i13) 1))
(assert (=> (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b))))))) (and (and (= temp___1468 (let ((subject i1)) i13)) (and (= temp___1466 (mk___rep4 (let ((subject result____split_fields)) result____split_fields15))) (and (= temp___1469 c35b) (and (and (and (and (<= 1 (let ((subject i1)) i14)) (<= (let ((subject i1)) i14) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b))))))) (= (bool_eq10 c35b temp___1469) true)) (= (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))) (+ (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b))))) 3))) (and (and (and (= (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16)) (rec__display__scrollstrt__len (us_split_fields9 temp___1466))) (=> (<= 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b)))))) (dynamic_property2 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b))))) (let ((subject i1)) i14)))) (and (<= 1 (let ((subject i1)) i14)) (<= (let ((subject i1)) i14) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b)))))))) (and (and (and (and (and (= (to_rep o74) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b)))) (let ((subject i1)) i14)))) (and (and (and (= temp___1463 (+ (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))) (let ((subject i1)) i14))) (in_range1 (+ (to_rep9 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))) (let ((subject i1)) i14)))) (and (and (<= 1 temp___1463) (<= temp___1463 50)) (= o75 temp___1463))) (= o76 (store (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields16)) o75 o74)))) (= o77 (mk___split_fields4 o76 (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields16))))) (= temp___1465 (mk___rep4 o77))) (and (= result13 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields16))) (= (let ((subject result____split_fields)) result____split_fields17) (us_split_fields9 temp___1465)))) (= (let ((subject i1)) i14) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b)))))))))))) (and (and (= i20 (let ((subject i1)) (mk_int__ref i14))) (= result____split_fields22 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields17)))) (and (= i21 i14) (= result____split_fields23 result____split_fields17))))))
(assert (=> (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b))))))) (= i22 i20)))
(assert (=> (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b))))))) (= result____split_fields24 result____split_fields22)))
(assert (=> (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b))))))) (= i23 i21)))
(assert (=> (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b))))))) (= result____split_fields25 result____split_fields23)))
(assert (=> (not (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b)))))))) (= i22 (let ((subject i1)) (mk_int__ref i13)))))
(assert (=> (not (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b)))))))) (= result____split_fields24 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields15)))))
(assert (=> (not (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b)))))))) (= i23 i13)))
(assert (=> (not (and (<= 1 (let ((subject i1)) i13)) (<= (let ((subject i1)) i13) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b)))))))) (= result____split_fields25 result____split_fields15)))
(assert (not (in_range13 (+ (to_rep9 (rec__display__scrollstrt__len (us_split_fields__content4 result____split_fields24))) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c35b)))))))))
(check-sat)
(exit)
