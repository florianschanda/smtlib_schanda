...
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= temp___245 result__1)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= temp___243 index22)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= temp___242 result_index1)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (and (= o4 (+ result_index1 1)) (in_range1 (+ result_index1 1)))))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index1 result4)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index2 o4)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (and (<= (to_rep result____first) result_index2) (<= result_index2 (to_rep result____last)))))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= o5 result_index2)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= o6 (store result__1 o5 (temp___237 (to_rep (select (elts array1) index11)) (to_rep (select (elts array2) index22)))))))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__1 result5)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__2 o6)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- index23 (to_rep (first (rt array2))))) 1))))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 index23)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) index11)))))))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 index23)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j9)))))))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (and (and (=> (<= 0 2147483647) (in_range2 result_index3)) (=> (<= (to_rep (first (rt array2))) (to_rep (last (rt array2)))) (dynamic_property7 (to_rep (first (rt array2))) (to_rep (last (rt array2))) index23))) (and (<= (to_rep (first (rt array2))) index23) (<= index23 (to_rep (last (rt array2))))))))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= index23 (to_rep (last (rt array2))))))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= index25 (mk_int__ref index23))))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index5 (mk_int__ref result_index3))))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__3 result__5)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= index26 index23)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index6 result_index3)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__6 result__3)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= index27 index25)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index7 result_index5)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__7 (mk_map__ref1 result__5))))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= index28 index26)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index8 result_index6)))
(assert (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__8 result__6)))
(assert (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= index27 (mk_int__ref index22))))
(assert (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= result_index7 (mk_int__ref result_index1))))
(assert (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= result__7 (mk_map__ref1 result__1))))
(assert (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= index28 index22)))
(assert (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= result_index8 result_index1)))
(assert (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= result__8 result__1)))
(declare-const i5 Int)
(assert (<= (to_rep (first (rt array1))) i5))
(assert (<= i5 index11))
(declare-const j9 Int)
(assert (<= (to_rep (first (rt array2))) j9))
(assert (<= j9 (to_rep (last (rt array2)))))
(assert (not (= (to_rep (select (select (map__content1 result__7) (+ (+ (* (- i5 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) i5)))))
(check-sat)
(exit)
