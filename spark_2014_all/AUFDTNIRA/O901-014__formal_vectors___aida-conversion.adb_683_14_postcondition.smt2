...
(assert (and (and (= (length source) 10) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50)) (forall ((index10 Int)) (=> (and (<= (to_rep1 (first (rt source))) index10) (<= index10 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index10))) true)))))
...
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1649)) (= index9 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1649)) (= n10 (mk_map__ref1 n4))))
...
(assert (and (<= (to_rep1 n__first) temp___1657) (<= temp___1657 (to_rep1 n__last))))
(assert (= o54 temp___1657))
...
(assert (and (= temp___1658 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___1658) (<= temp___1658 (to_rep1 n__last))))
(assert (= o61 temp___1658))
...
(assert (and (= o68 (+ target9 1000000000)) (in_range1 (+ target9 1000000000))))
(assert (= result12 (mk_int__ref target9)))
(assert (= target10 o68))
(assert (<= target10 1999999999))
...
(assert (= target11 (mk_int__ref target10)))
(assert (= index8 index6))
(assert (= n9 n7))
(assert (= has_failed3 has_failed1))
(assert (= target12 target10))
