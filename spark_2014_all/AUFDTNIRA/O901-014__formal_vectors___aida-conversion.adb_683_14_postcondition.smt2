...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)) (= (mk___t2 temp___1540 temp___15401) (aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (and (= (ite (<= (to_rep1 (first4 temp___15401)) (to_rep1 (last4 temp___15401))) (+ (- (to_rep1 (last4 temp___15401)) (to_rep1 (first4 temp___15401))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1540 (to_rep1 (first4 temp___15401)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__assume) (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 9)))) (and (and (and (= temp___1547 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (= (mk_int__ref result1) (mk_int__ref index)) (= index2 (to_rep1 (first (rt source))))) (ite (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1547)) (and (and (and (= temp___1545 index2) (and (= temp___1543 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o1 index2)) (= o2 (select n1 o1))) (= o3 (to_rep1 o2))) (= o3 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o4 index2)) (= o5 (select (elts source) o4))) (= o6 (to_rep o5))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o6))) (ite (= (= o6 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o6 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o6 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o6 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o6 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o6 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o6 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o6 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o6 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o6 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o7) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o8 index2)) (= o9 (store n1 o8 o7)))) (and (= n1 result2) (= n2 o9))))) (and (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (= (to_rep1 (select n3 j1)) (convert_character_digit_to_integer (to_rep (select (elts source) j1)))))) (and (and (and (forall ((temp___1544 Int)) (=> (and (<= (to_rep1 n__first) temp___1544) (<= temp___1544 (to_rep1 n__last))) (=> (< index3 temp___1544) (= (select n3 temp___1544) (select temp___1543 temp___1544))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9)))) (= index3 temp___1547)))))) (and (and (= index3 index7) (= n3 n7)) (and (= index8 index3) (= n8 n3)))) (and (and (= (mk_int__ref index9) (mk_int__ref index7)) (= (mk_map__ref1 n9) (mk_map__ref1 n7))) (and (= index10 index8) (= n10 n8)))) (and (and (= index2 index9) (= n1 n9)) (and (= index10 index2) (= n10 n1)))))) (and (and (and (and (and (and (= temp___1548 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (<= (to_rep1 n__first) temp___1548) (<= temp___1548 (to_rep1 n__last))) (= o23 temp___1548))) (= o24 (select n9 o23))) (= o25 (to_rep1 o24))) (and (= (mk_int__ref result5) (mk_int__ref target)) (= target1 o25))) (and (<= target1 9) (and (and (and (and (and (and (and (and (and (and (= temp___1549 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (<= (to_rep1 n__first) temp___1549) (<= temp___1549 (to_rep1 n__last))) (= o26 temp___1549))) (= o27 (select n9 o26))) (= o28 (to_rep1 o27))) (= o29 (* o28 10))) (and (= o30 o29) (in_range1 o29))) (= o31 (+ target1 o30))) (and (= o32 o31) (in_range1 o31))) (and (= target1 result6) (= target2 o32))) (and (<= target2 99) (and (and (and (and (and (and (and (and (and (and (= temp___1550 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))) (and (and (<= (to_rep1 n__first) temp___1550) (<= temp___1550 (to_rep1 n__last))) (= o33 temp___1550))) (= o34 (select n9 o33))) (= o35 (to_rep1 o34))) (= o36 (* o35 100))) (and (= o37 o36) (in_range1 o36))) (= o38 (+ target2 o37))) (and (= o39 o38) (in_range1 o38))) (and (= result7 (mk_int__ref target2)) (= target3 o39))) (and (<= target3 999) (and (and (and (and (and (and (and (and (and (and (= temp___1551 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))) (and (and (<= (to_rep1 n__first) temp___1551) (<= temp___1551 (to_rep1 n__last))) (= o40 temp___1551))) (= o41 (select n9 o40))) (= o42 (to_rep1 o41))) (= o43 (* o42 1000))) (and (= o44 o43) (in_range1 o43))) (= o45 (+ target3 o44))) (and (= o46 o45) (in_range1 o45))) (and (= result8 (mk_int__ref target3)) (= target4 o46))) (and (<= target4 9999) (and (and (and (and (and (and (and (and (and (and (= temp___1552 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (<= (to_rep1 n__first) temp___1552) (<= temp___1552 (to_rep1 n__last))) (= o47 temp___1552))) (= o48 (select n9 o47))) (= o49 (to_rep1 o48))) (= o50 (* o49 10000))) (and (= o51 o50) (in_range1 o50))) (= o52 (+ target4 o51))) (and (= o53 o52) (in_range1 o52))) (and (= result9 (mk_int__ref target4)) (= target5 o53))) (and (<= target5 99999) (and (and (and (and (and (and (and (and (and (and (= temp___1553 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (<= (to_rep1 n__first) temp___1553) (<= temp___1553 (to_rep1 n__last))) (= o54 temp___1553))) (= o55 (select n9 o54))) (= o56 (to_rep1 o55))) (= o57 (* o56 100000))) (and (= o58 o57) (in_range1 o57))) (= o59 (+ target5 o58))) (and (= o60 o59) (in_range1 o59))) (and (= result10 (mk_int__ref target5)) (= target6 o60))) (and (<= target6 999999) (and (and (and (and (and (and (and (and (and (and (= temp___1554 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))) (and (and (<= (to_rep1 n__first) temp___1554) (<= temp___1554 (to_rep1 n__last))) (= o61 temp___1554))) (= o62 (select n9 o61))) (= o63 (to_rep1 o62))) (= o64 (* o63 1000000))) (and (= o65 o64) (in_range1 o64))) (= o66 (+ target6 o65))) (and (= o67 o66) (in_range1 o66))) (and (= result11 (mk_int__ref target6)) (= target7 o67))) (and (<= target7 9999999) (and (and (and (and (and (and (and (and (and (and (= temp___1555 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (<= (to_rep1 n__first) temp___1555) (<= temp___1555 (to_rep1 n__last))) (= o68 temp___1555))) (= o69 (select n9 o68))) (= o70 (to_rep1 o69))) (= o71 (* o70 10000000))) (and (= o72 o71) (in_range1 o71))) (= o73 (+ target7 o72))) (and (= o74 o73) (in_range1 o73))) (and (= result12 (mk_int__ref target7)) (= target8 o74))) (and (<= target8 99999999) (and (and (and (and (and (and (and (and (and (and (= temp___1556 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (<= (to_rep1 n__first) temp___1556) (<= temp___1556 (to_rep1 n__last))) (= o75 temp___1556))) (= o76 (select n9 o75))) (= o77 (to_rep1 o76))) (= o78 (* o77 100000000))) (and (= o79 o78) (in_range1 o78))) (= o80 (+ target8 o79))) (and (= o81 o80) (in_range1 o80))) (and (= result13 (mk_int__ref target8)) (= target9 o81))) (and (<= target9 999999999) (and (and (and (= o82 (+ target9 1000000000)) (in_range1 (+ target9 1000000000))) (and (= result14 (mk_int__ref target9)) (= target10 o82))) (and (<= target10 1999999999) (and (= result15 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0)))))))))))))))))))))))))) (and (and (= index11 (mk_int__ref index9)) (and (= n11 (mk_map__ref1 n9)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target11 (mk_int__ref target10))))) (and (= index12 index10) (and (= n12 n10) (and (= has_failed3 has_failed1) (= target12 target10)))))))
