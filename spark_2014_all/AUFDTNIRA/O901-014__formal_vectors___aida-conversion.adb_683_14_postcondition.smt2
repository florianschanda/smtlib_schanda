...
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1547)) (= index9 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1547)) (= n10 (mk_map__ref1 n4))))
...
(assert (and (= temp___1555 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___1555) (<= temp___1555 (to_rep1 n__last))))
...
(assert (and (= temp___1556 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___1556) (<= temp___1556 (to_rep1 n__last))))
(assert (= o61 temp___1556))
