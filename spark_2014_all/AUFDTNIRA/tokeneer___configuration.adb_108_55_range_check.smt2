...
(assert (not (= (length temp___1944) 0)))
(assert (=> (<= 1 2) (= o108 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o108 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1944))) (to_rep1 (last (rt temp___1944)))) (= o109 (+ (- (to_rep1 (last (rt temp___1944))) (to_rep1 (first (rt temp___1944)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1944))) (to_rep1 (last (rt temp___1944))))) (= o109 0)))
(assert (= o110 (+ o109 o108)))
(assert (= o111 (+ (to_rep1 (first (rt temp___1944))) o110)))
(assert (= o112 (- o111 1)))
