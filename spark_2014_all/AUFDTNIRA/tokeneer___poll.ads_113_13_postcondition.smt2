...
(define-fun dynamic_invariant ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 1)) (in_range1 temp___expr_222)))
...
(define-fun dynamic_invariant1 ((temp___expr_489 Int) (temp___is_init_485 Bool) (temp___skip_constant_486 Bool) (temp___do_toplevel_487 Bool) (temp___do_typ_inv_488 Bool)) Bool (=> (or (= temp___is_init_485 true) (<= 0 4294967295)) (in_range2 temp___expr_489)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant2 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 2)) (in_range3 temp___expr_496)))
...
(define-fun dynamic_invariant3 ((temp___expr_503 Int) (temp___is_init_499 Bool) (temp___skip_constant_500 Bool) (temp___do_toplevel_501 Bool) (temp___do_typ_inv_502 Bool)) Bool (=> (or (= temp___is_init_499 true) (<= 0 1)) (in_range4 temp___expr_503)))
...
(declare-fun temp___1253 (Int) (Array Int logfileindext))
(declare-fun temp___1257 (Int) (Array Int fileentrycountt))
(define-fun dynamic_invariant4 ((temp___expr_1247 us_rep2) (temp___is_init_1243 Bool) (temp___skip_constant_1244 Bool) (temp___do_toplevel_1245 Bool) (temp___do_typ_inv_1246 Bool)) Bool (=> (= temp___do_typ_inv_1246 true) (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1247))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1247))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1247)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1247))) true)))
(define-fun default_initial_assumption ((temp___expr_1251 us_rep2) (temp___skip_top_level_1252 Bool)) Bool (and (and (and (= (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1251))) 1) (= (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1251))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1251)) (mk___rep1 (mk___split_fields1 (temp___1253 1) (of_rep4 1) (of_rep4 1) (of_rep6 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1251)) (temp___1257 0))))
(define-fun type_invariant ((temp___1261 us_rep2)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1261))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1261))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1261)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1261))) true))
...
(define-fun bool_eq9 ((a (Array Int character)) (a__first Int) (a__last Int) (b (Array Int character)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep13 (select a temp___idx_91)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_91))))))) true false))
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq9 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep13 (select a temp___idx_91)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_91)))))))))))
...
(define-fun dynamic_invariant6 ((temp___expr_2158 Int) (temp___is_init_2154 Bool) (temp___skip_constant_2155 Bool) (temp___do_toplevel_2156 Bool) (temp___do_typ_inv_2157 Bool)) Bool (=> (or (= temp___is_init_2154 true) (<= 0 1)) (in_range23 temp___expr_2158)))
...
(define-fun dynamic_invariant7 ((temp___expr_2181 Int) (temp___is_init_2177 Bool) (temp___skip_constant_2178 Bool) (temp___do_toplevel_2179 Bool) (temp___do_typ_inv_2180 Bool)) Bool (=> (or (= temp___is_init_2177 true) (<= 0 1)) (in_range24 temp___expr_2181)))
...
(define-fun dynamic_invariant8 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range18 temp___expr_74)))
(define-fun dynamic_invariant9 ((temp___expr_403 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 40)) (in_range17 temp___expr_403)))
(define-fun dynamic_invariant10 ((temp___expr_427 Int) (temp___is_init_423 Bool) (temp___skip_constant_424 Bool) (temp___do_toplevel_425 Bool) (temp___do_typ_inv_426 Bool)) Bool (=> (or (= temp___is_init_423 true) (<= 0 4294967295)) (in_range19 temp___expr_427)))
(define-fun dynamic_invariant11 ((temp___expr_451 Int) (temp___is_init_447 Bool) (temp___skip_constant_448 Bool) (temp___do_toplevel_449 Bool) (temp___do_typ_inv_450 Bool)) Bool (=> (or (= temp___is_init_447 true) (<= 0 10)) (in_range14 temp___expr_451)))
(define-fun dynamic_invariant12 ((temp___expr_465 Int) (temp___is_init_461 Bool) (temp___skip_constant_462 Bool) (temp___do_toplevel_463 Bool) (temp___do_typ_inv_464 Bool)) Bool (=> (or (= temp___is_init_461 true) (<= 0 4294967295)) (in_range21 temp___expr_465)))
(define-fun dynamic_invariant13 ((temp___expr_472 Int) (temp___is_init_468 Bool) (temp___skip_constant_469 Bool) (temp___do_toplevel_470 Bool) (temp___do_typ_inv_471 Bool)) Bool (=> (or (= temp___is_init_468 true) (<= 0 128)) (in_range22 temp___expr_472)))
(define-fun dynamic_invariant14 ((temp___expr_1185 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool) (temp___do_typ_inv_1184 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 0 17)) (in_range11 temp___expr_1185)))
(define-fun dynamic_invariant15 ((temp___expr_1192 Int) (temp___is_init_1188 Bool) (temp___skip_constant_1189 Bool) (temp___do_toplevel_1190 Bool) (temp___do_typ_inv_1191 Bool)) Bool (=> (or (= temp___is_init_1188 true) (<= 1 17)) (in_range9 temp___expr_1192)))
(define-fun dynamic_invariant16 ((temp___expr_1318 Int) (temp___is_init_1314 Bool) (temp___skip_constant_1315 Bool) (temp___do_toplevel_1316 Bool) (temp___do_typ_inv_1317 Bool)) Bool (=> (or (= temp___is_init_1314 true) (<= 0 2)) (in_range13 temp___expr_1318)))
(define-fun dynamic_invariant17 ((temp___expr_1199 Int) (temp___is_init_1195 Bool) (temp___skip_constant_1196 Bool) (temp___do_toplevel_1197 Bool) (temp___do_typ_inv_1198 Bool)) Bool (=> (or (= temp___is_init_1195 true) (<= 0 17408)) (in_range10 temp___expr_1199)))
(define-fun dynamic_invariant18 ((temp___expr_1230 Int) (temp___is_init_1226 Bool) (temp___skip_constant_1227 Bool) (temp___do_toplevel_1228 Bool) (temp___do_typ_inv_1229 Bool)) Bool (=> (or (= temp___is_init_1226 true) (<= 0 1024)) (in_range12 temp___expr_1230)))
(assert true)
...
(assert (forall ((temp___1259 Int)) (=> (dynamic_invariant18 temp___1259 true true true true) (forall ((temp___1260 Int)) (= (to_rep7 (select (temp___1257 temp___1259) temp___1260)) temp___1259)))))
(define-fun dynamic_invariant19 ((temp___expr_580 Int) (temp___is_init_576 Bool) (temp___skip_constant_577 Bool) (temp___do_toplevel_578 Bool) (temp___do_typ_inv_579 Bool)) Bool (=> (or (= temp___is_init_576 true) (<= 1901 2099)) (in_range5 temp___expr_580)))
(define-fun dynamic_invariant20 ((temp___expr_587 Int) (temp___is_init_583 Bool) (temp___skip_constant_584 Bool) (temp___do_toplevel_585 Bool) (temp___do_typ_inv_586 Bool)) Bool (=> (or (= temp___is_init_583 true) (<= 1 12)) (in_range6 temp___expr_587)))
(define-fun dynamic_invariant21 ((temp___expr_594 Int) (temp___is_init_590 Bool) (temp___skip_constant_591 Bool) (temp___do_toplevel_592 Bool) (temp___do_typ_inv_593 Bool)) Bool (=> (or (= temp___is_init_590 true) (<= 1 31)) (in_range7 temp___expr_594)))
(define-fun dynamic_invariant22 ((temp___expr_626 Int) (temp___is_init_622 Bool) (temp___skip_constant_623 Bool) (temp___do_toplevel_624 Bool) (temp___do_typ_inv_625 Bool)) Bool (=> (or (= temp___is_init_622 true) (<= 0 86399999)) (in_range8 temp___expr_626)))
(assert true)
...
(define-fun dynamic_invariant23 ((temp___expr_1144 Int) (temp___is_init_1140 Bool) (temp___skip_constant_1141 Bool) (temp___do_toplevel_1142 Bool) (temp___do_typ_inv_1143 Bool)) Bool (=> (or (= temp___is_init_1140 true) (<= 0 5)) (in_range16 temp___expr_1144)))
(define-fun dynamic_invariant24 ((temp___expr_1491 Int) (temp___is_init_1487 Bool) (temp___skip_constant_1488 Bool) (temp___do_toplevel_1489 Bool) (temp___do_typ_inv_1490 Bool)) Bool (=> (or (= temp___is_init_1487 true) (<= 0 4294967295)) (in_range20 temp___expr_1491)))
(assert (forall ((contents us_rep7)) (! (dynamic_invariant5 (therole contents) true false true true) :pattern ((therole contents)))))
...
(assert (forall ((temp___1255 Int)) (=> (dynamic_invariant15 temp___1255 true true true true) (forall ((temp___1256 Int)) (= (to_rep4 (select (temp___1253 temp___1255) temp___1256)) temp___1255)))))
