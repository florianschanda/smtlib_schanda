...
(define-fun dynamic_invariant1 ((temp___expr_436 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 0 4294967295)) (in_range2 temp___expr_436)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant2 ((temp___expr_442 Int) (temp___is_init_439 Bool) (temp___skip_constant_440 Bool) (temp___do_toplevel_441 Bool)) Bool (=> (or (= temp___is_init_439 true) (<= 0 2)) (in_range3 temp___expr_442)))
...
(define-fun dynamic_invariant3 ((temp___expr_448 Int) (temp___is_init_445 Bool) (temp___skip_constant_446 Bool) (temp___do_toplevel_447 Bool)) Bool (=> (or (= temp___is_init_445 true) (<= 0 1)) (in_range4 temp___expr_448)))
...
(declare-fun temp___1112 (Int) (Array Int logfileindext))
(assert (forall ((temp___1114 Int)) (forall ((temp___1115 Int)) (= (select (temp___1112 temp___1114) temp___1115) (of_rep4 temp___1114)))))
(declare-fun temp___1116 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1118 Int)) (forall ((temp___1119 Int)) (= (select (temp___1116 temp___1118) temp___1119) (of_rep7 temp___1118)))))
(define-fun dynamic_invariant4 ((temp___expr_1106 us_rep2) (temp___is_init_1103 Bool) (temp___skip_constant_1104 Bool) (temp___do_toplevel_1105 Bool)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1106))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1106))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1106)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1106))) true))
(define-fun default_initial_assumption ((temp___expr_1110 us_rep2) (temp___skip_top_level_1111 Bool)) Bool (and (and (and (= (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1110))) 1) (= (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1110))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1110)) (mk___rep1 (mk___split_fields1 (temp___1112 1) (of_rep4 1) (of_rep4 1) (of_rep6 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1110)) (temp___1116 0))))
(define-fun type_invariant ((temp___1120 us_rep2)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1120))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1120))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1120)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1120))) true))
...
(define-fun dynamic_invariant5 ((temp___expr_1002 Int) (temp___is_init_999 Bool) (temp___skip_constant_1000 Bool) (temp___do_toplevel_1001 Bool)) Bool (=> (or (= temp___is_init_999 true) (<= 0 3)) (in_range15 temp___expr_1002)))
...
(define-fun dynamic_invariant6 ((temp___expr_1978 Int) (temp___is_init_1975 Bool) (temp___skip_constant_1976 Bool) (temp___do_toplevel_1977 Bool)) Bool (=> (or (= temp___is_init_1975 true) (<= 0 1)) (in_range23 temp___expr_1978)))
...
(define-fun dynamic_invariant7 ((temp___expr_2000 Int) (temp___is_init_1997 Bool) (temp___skip_constant_1998 Bool) (temp___do_toplevel_1999 Bool)) Bool (=> (or (= temp___is_init_1997 true) (<= 0 1)) (in_range24 temp___expr_2000)))
...
(define-fun dynamic_invariant9 ((temp___expr_360 Int) (temp___is_init_357 Bool) (temp___skip_constant_358 Bool) (temp___do_toplevel_359 Bool)) Bool (=> (or (= temp___is_init_357 true) (<= 0 40)) (in_range17 temp___expr_360)))
(define-fun dynamic_invariant10 ((temp___expr_381 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= 0 4294967295)) (in_range19 temp___expr_381)))
(define-fun dynamic_invariant11 ((temp___expr_403 Int) (temp___is_init_400 Bool) (temp___skip_constant_401 Bool) (temp___do_toplevel_402 Bool)) Bool (=> (or (= temp___is_init_400 true) (<= 0 10)) (in_range14 temp___expr_403)))
(define-fun dynamic_invariant12 ((temp___expr_415 Int) (temp___is_init_412 Bool) (temp___skip_constant_413 Bool) (temp___do_toplevel_414 Bool)) Bool (=> (or (= temp___is_init_412 true) (<= 0 4294967295)) (in_range21 temp___expr_415)))
(define-fun dynamic_invariant13 ((temp___expr_421 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 0 128)) (in_range22 temp___expr_421)))
(define-fun dynamic_invariant14 ((temp___expr_1072 Int) (temp___is_init_1069 Bool) (temp___skip_constant_1070 Bool) (temp___do_toplevel_1071 Bool)) Bool (=> (or (= temp___is_init_1069 true) (<= 0 17)) (in_range11 temp___expr_1072)))
(define-fun dynamic_invariant15 ((temp___expr_1051 Int) (temp___is_init_1048 Bool) (temp___skip_constant_1049 Bool) (temp___do_toplevel_1050 Bool)) Bool (=> (or (= temp___is_init_1048 true) (<= 1 17)) (in_range9 temp___expr_1051)))
(define-fun dynamic_invariant16 ((temp___expr_1176 Int) (temp___is_init_1173 Bool) (temp___skip_constant_1174 Bool) (temp___do_toplevel_1175 Bool)) Bool (=> (or (= temp___is_init_1173 true) (<= 0 2)) (in_range13 temp___expr_1176)))
(define-fun dynamic_invariant17 ((temp___expr_1057 Int) (temp___is_init_1054 Bool) (temp___skip_constant_1055 Bool) (temp___do_toplevel_1056 Bool)) Bool (=> (or (= temp___is_init_1054 true) (<= 0 17408)) (in_range10 temp___expr_1057)))
(define-fun dynamic_invariant18 ((temp___expr_1091 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 1024)) (in_range12 temp___expr_1091)))
(assert true)
...
(define-fun dynamic_invariant19 ((temp___expr_516 Int) (temp___is_init_513 Bool) (temp___skip_constant_514 Bool) (temp___do_toplevel_515 Bool)) Bool (=> (or (= temp___is_init_513 true) (<= 1901 2099)) (in_range5 temp___expr_516)))
(define-fun dynamic_invariant20 ((temp___expr_522 Int) (temp___is_init_519 Bool) (temp___skip_constant_520 Bool) (temp___do_toplevel_521 Bool)) Bool (=> (or (= temp___is_init_519 true) (<= 1 12)) (in_range6 temp___expr_522)))
(define-fun dynamic_invariant21 ((temp___expr_528 Int) (temp___is_init_525 Bool) (temp___skip_constant_526 Bool) (temp___do_toplevel_527 Bool)) Bool (=> (or (= temp___is_init_525 true) (<= 1 31)) (in_range7 temp___expr_528)))
(define-fun dynamic_invariant22 ((temp___expr_556 Int) (temp___is_init_553 Bool) (temp___skip_constant_554 Bool) (temp___do_toplevel_555 Bool)) Bool (=> (or (= temp___is_init_553 true) (<= 0 86399999)) (in_range8 temp___expr_556)))
(assert true)
...
(define-fun dynamic_invariant23 ((temp___expr_1014 Int) (temp___is_init_1011 Bool) (temp___skip_constant_1012 Bool) (temp___do_toplevel_1013 Bool)) Bool (=> (or (= temp___is_init_1011 true) (<= 0 5)) (in_range16 temp___expr_1014)))
(define-fun dynamic_invariant24 ((temp___expr_1330 Int) (temp___is_init_1327 Bool) (temp___skip_constant_1328 Bool) (temp___do_toplevel_1329 Bool)) Bool (=> (or (= temp___is_init_1327 true) (<= 0 4294967295)) (in_range20 temp___expr_1330)))
