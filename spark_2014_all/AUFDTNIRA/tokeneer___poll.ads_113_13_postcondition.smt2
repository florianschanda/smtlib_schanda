...
(declare-fun theauthcertrole (Int us_private Int Int us_split_fields10 us_split_fields16) Int)
(declare-fun theauthcertrole__function_guard (Int Int us_private Int Int us_split_fields10 us_split_fields16) Bool)
...
(define-fun dynamic_invariant ((temp___expr_222 Int) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool) (temp___do_typ_inv_221 Bool)) Bool (=> (or (= temp___is_init_218 true) (<= 0 1)) (in_range14 temp___expr_222)))
...
(define-fun dynamic_invariant1 ((temp___expr_489 Int) (temp___is_init_485 Bool) (temp___skip_constant_486 Bool) (temp___do_toplevel_487 Bool) (temp___do_typ_inv_488 Bool)) Bool (=> (or (= temp___is_init_485 true) (<= 0 4294967295)) (in_range15 temp___expr_489)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant2 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 2)) (in_range16 temp___expr_496)))
(define-fun dynamic_invariant3 ((temp___expr_1123 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool) (temp___do_typ_inv_1122 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 3)) (in_range11 temp___expr_1123)))
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields10)) (forall ((admintoken__idcert__fields us_split_fields16)) (! (=> (and (and (dynamic_invariant admintoken__tokenpresence true true true true) (dynamic_invariant2 admintoken__tokentry true true true true)) (dynamic_invariant1 admintoken__tokenid true true true true)) (dynamic_invariant3 (theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true false true true)) :pattern ((theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields10)) (forall ((admintoken__idcert__fields us_split_fields16)) (! (=> (and (and (dynamic_invariant admintoken__tokenpresence true true true true) (dynamic_invariant2 admintoken__tokentry true true true true)) (dynamic_invariant1 admintoken__tokenid true true true true)) (= (theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) (therole (rec__admintoken__validauthcertt__contents (us_split_fields11 (mk___rep5 admintoken__authcert__fields)))))) :pattern ((theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(declare-fun isgood (Int us_private Int Int us_split_fields10 us_split_fields16) Bool)
(declare-fun isgood__function_guard (Bool Int us_private Int Int us_split_fields10 us_split_fields16) Bool)
(assert true)
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields10)) (forall ((admintoken__idcert__fields us_split_fields16)) (! (= (= (isgood admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (= (rec__admintoken__valididcertt__valid (us_split_fields17 (mk___rep8 admintoken__idcert__fields))) true)) :pattern ((isgood admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(declare-fun authcertvalid (Int us_private Int Int us_split_fields10 us_split_fields16) Bool)
(declare-fun authcertvalid__function_guard (Bool Int us_private Int Int us_split_fields10 us_split_fields16) Bool)
(assert true)
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields10)) (forall ((admintoken__idcert__fields us_split_fields16)) (! (= (= (authcertvalid admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (= (rec__admintoken__validauthcertt__valid (us_split_fields11 (mk___rep5 admintoken__authcert__fields))) true)) :pattern ((authcertvalid admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
...
(define-fun bool_eq10 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep13 (select a temp___idx_175)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_175))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep13 (select a temp___idx_175)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(declare-fun user_eq27 (logfileindext logfileindext) Bool)
(declare-const dummy27 logfileindext)
...
(assert (forall ((x logfileindext)) (! (in_range18 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(declare-fun user_eq28 (logentrycountt logentrycountt) Bool)
(declare-const dummy28 logentrycountt)
...
(assert (forall ((x logentrycountt)) (! (in_range19 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(declare-fun user_eq29 (logfilecountt logfilecountt) Bool)
(declare-const dummy29 logfilecountt)
...
(assert (forall ((x logfilecountt)) (! (in_range20 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun bool_eq11 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep14 (select a temp___idx_172)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_172))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep14 (select a temp___idx_172)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
(declare-const dummy30 (Array Int logfileindext))
...
(declare-fun user_eq30 ((Array Int logfileindext) (Array Int logfileindext)) Bool)
...
(define-fun us_rep___8__projection ((a us_rep9)) us_split_fields18 (us_split_fields19 a))
...
(declare-fun user_eq32 (fileentrycountt fileentrycountt) Bool)
(declare-const dummy32 fileentrycountt)
...
(assert (forall ((x fileentrycountt)) (! (in_range21 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(define-fun bool_eq13 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep17 (select a temp___idx_173)) (to_rep17 (select b (+ (- b__first a__first) temp___idx_173))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq13 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep17 (select a temp___idx_173)) (to_rep17 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
(declare-const dummy33 (Array Int fileentrycountt))
...
(declare-fun user_eq33 ((Array Int fileentrycountt) (Array Int fileentrycountt)) Bool)
...
(define-fun us_rep___9__projection ((a us_rep10)) us_split_fields20 (us_split_fields21 a))
...
(define-fun bool_eq16 ((a (Array Int us_rep11)) (a__first Int) (a__last Int) (b (Array Int us_rep11)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq15 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true)))) true false))
(assert (forall ((a (Array Int us_rep11)) (b (Array Int us_rep11))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq16 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq15 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true))))))))
...
(declare-fun user_eq36 (statust statust) Bool)
(declare-const dummy36 statust)
...
(define-fun dynamic_invariant4 ((temp___expr_503 Int) (temp___is_init_499 Bool) (temp___skip_constant_500 Bool) (temp___do_toplevel_501 Bool) (temp___do_typ_inv_502 Bool)) Bool (=> (or (= temp___is_init_499 true) (<= 0 1)) (in_range22 temp___expr_503)))
...
(declare-fun temp_____aggregate_def_1246 (Int) (Array Int logfileindext))
(declare-fun temp_____aggregate_def_1250 (Int) (Array Int fileentrycountt))
(define-fun dynamic_invariant5 ((temp___expr_1240 us_rep10) (temp___is_init_1236 Bool) (temp___skip_constant_1237 Bool) (temp___do_toplevel_1238 Bool) (temp___do_typ_inv_1239 Bool)) Bool (=> (= temp___do_typ_inv_1239 true) (= (valid_numberlogentries (to_rep14 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields21 temp___expr_1240))) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields21 temp___expr_1240))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields21 temp___expr_1240)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields21 temp___expr_1240))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1244 us_rep10) (temp___skip_top_level_1245 Bool)) Bool (and (and (and (= (to_rep14 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields21 temp___expr_1244))) 1) (= (to_rep15 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields21 temp___expr_1244))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields21 temp___expr_1244)) (mk___rep9 (mk___split_fields9 (temp_____aggregate_def_1246 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields21 temp___expr_1244)) (temp_____aggregate_def_1250 0))))
(define-fun type_invariant ((temp___1254 us_rep10)) Bool (= (valid_numberlogentries (to_rep14 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields21 temp___1254))) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields21 temp___1254))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields21 temp___1254)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields21 temp___1254))) true))
...
(define-fun dynamic_invariant7 ((temp___expr_2174 Int) (temp___is_init_2170 Bool) (temp___skip_constant_2171 Bool) (temp___do_toplevel_2172 Bool) (temp___do_typ_inv_2173 Bool)) Bool (=> (or (= temp___is_init_2170 true) (<= 0 1)) (in_range24 temp___expr_2174)))
(assert (forall ((door__state us_private)) (! (dynamic_invariant7 (thecurrentdoor door__state) true false true true) :pattern ((thecurrentdoor door__state)))))
(declare-fun thedooralarm (us_private) Int)
(declare-fun thedooralarm__function_guard (Int us_private) Bool)
(assert (forall ((door__state us_private)) (! (dynamic_invariant4 (thedooralarm door__state) true false true true) :pattern ((thedooralarm door__state)))))
(declare-const attr__ATTRIBUTE_ADDRESS13 Int)
(define-fun dynamic_invariant8 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range6 temp___expr_74)))
(define-fun dynamic_invariant9 ((temp___expr_403 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 40)) (in_range5 temp___expr_403)))
(define-fun dynamic_invariant10 ((temp___expr_427 Int) (temp___is_init_423 Bool) (temp___skip_constant_424 Bool) (temp___do_toplevel_425 Bool) (temp___do_typ_inv_426 Bool)) Bool (=> (or (= temp___is_init_423 true) (<= 0 4294967295)) (in_range7 temp___expr_427)))
(define-fun dynamic_invariant11 ((temp___expr_451 Int) (temp___is_init_447 Bool) (temp___skip_constant_448 Bool) (temp___do_toplevel_449 Bool) (temp___do_typ_inv_450 Bool)) Bool (=> (or (= temp___is_init_447 true) (<= 0 10)) (in_range10 temp___expr_451)))
(define-fun dynamic_invariant12 ((temp___expr_465 Int) (temp___is_init_461 Bool) (temp___skip_constant_462 Bool) (temp___do_toplevel_463 Bool) (temp___do_typ_inv_464 Bool)) Bool (=> (or (= temp___is_init_461 true) (<= 0 4294967295)) (in_range12 temp___expr_465)))
(define-fun dynamic_invariant13 ((temp___expr_472 Int) (temp___is_init_468 Bool) (temp___skip_constant_469 Bool) (temp___do_toplevel_470 Bool) (temp___do_typ_inv_471 Bool)) Bool (=> (or (= temp___is_init_468 true) (<= 0 128)) (in_range13 temp___expr_472)))
(define-fun dynamic_invariant14 ((temp___expr_1178 Int) (temp___is_init_1174 Bool) (temp___skip_constant_1175 Bool) (temp___do_toplevel_1176 Bool) (temp___do_typ_inv_1177 Bool)) Bool (=> (or (= temp___is_init_1174 true) (<= 0 17)) (in_range20 temp___expr_1178)))
(define-fun dynamic_invariant15 ((temp___expr_1185 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool) (temp___do_typ_inv_1184 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 1 17)) (in_range18 temp___expr_1185)))
(define-fun dynamic_invariant16 ((temp___expr_1311 Int) (temp___is_init_1307 Bool) (temp___skip_constant_1308 Bool) (temp___do_toplevel_1309 Bool) (temp___do_typ_inv_1310 Bool)) Bool (=> (or (= temp___is_init_1307 true) (<= 0 2)) (in_range17 temp___expr_1311)))
(define-fun dynamic_invariant17 ((temp___expr_1192 Int) (temp___is_init_1188 Bool) (temp___skip_constant_1189 Bool) (temp___do_toplevel_1190 Bool) (temp___do_typ_inv_1191 Bool)) Bool (=> (or (= temp___is_init_1188 true) (<= 0 17408)) (in_range19 temp___expr_1192)))
(define-fun dynamic_invariant18 ((temp___expr_1223 Int) (temp___is_init_1219 Bool) (temp___skip_constant_1220 Bool) (temp___do_toplevel_1221 Bool) (temp___do_typ_inv_1222 Bool)) Bool (=> (or (= temp___is_init_1219 true) (<= 0 1024)) (in_range21 temp___expr_1223)))
(assert true)
...
(assert (forall ((temp___1252 Int)) (=> (dynamic_invariant18 temp___1252 true true true true) (forall ((temp___1253 Int)) (= (select (temp_____aggregate_def_1250 temp___1252) temp___1253) rliteral2)))))
(define-fun dynamic_invariant19 ((temp___expr_580 Int) (temp___is_init_576 Bool) (temp___skip_constant_577 Bool) (temp___do_toplevel_578 Bool) (temp___do_typ_inv_579 Bool)) Bool (=> (or (= temp___is_init_576 true) (<= 1901 2099)) (in_range1 temp___expr_580)))
(define-fun dynamic_invariant20 ((temp___expr_587 Int) (temp___is_init_583 Bool) (temp___skip_constant_584 Bool) (temp___do_toplevel_585 Bool) (temp___do_typ_inv_586 Bool)) Bool (=> (or (= temp___is_init_583 true) (<= 1 12)) (in_range2 temp___expr_587)))
(define-fun dynamic_invariant21 ((temp___expr_594 Int) (temp___is_init_590 Bool) (temp___skip_constant_591 Bool) (temp___do_toplevel_592 Bool) (temp___do_typ_inv_593 Bool)) Bool (=> (or (= temp___is_init_590 true) (<= 1 31)) (in_range3 temp___expr_594)))
(define-fun dynamic_invariant22 ((temp___expr_626 Int) (temp___is_init_622 Bool) (temp___skip_constant_623 Bool) (temp___do_toplevel_624 Bool) (temp___do_typ_inv_625 Bool)) Bool (=> (or (= temp___is_init_622 true) (<= 0 86399999)) (in_range4 temp___expr_626)))
(assert true)
...
(define-fun dynamic_invariant23 ((temp___expr_1137 Int) (temp___is_init_1133 Bool) (temp___skip_constant_1134 Bool) (temp___do_toplevel_1135 Bool) (temp___do_typ_inv_1136 Bool)) Bool (=> (or (= temp___is_init_1133 true) (<= 0 5)) (in_range9 temp___expr_1137)))
(define-fun dynamic_invariant24 ((temp___expr_1484 Int) (temp___is_init_1480 Bool) (temp___skip_constant_1481 Bool) (temp___do_toplevel_1482 Bool) (temp___do_typ_inv_1483 Bool)) Bool (=> (or (= temp___is_init_1480 true) (<= 0 4294967295)) (in_range8 temp___expr_1484)))
...
(assert (forall ((temp___1248 Int)) (=> (dynamic_invariant15 temp___1248 true true true true) (forall ((temp___1249 Int)) (= (select (temp_____aggregate_def_1246 temp___1248) temp___1249) rliteral)))))
...
(declare-const logfilestate__split_fields10 us_split_fields20)
...
(declare-const logfilestate__split_fields11 us_split_fields__ref10)
...
(declare-const logfilestate__split_fields12 us_split_fields20)
...
(assert (and (and (and (= (= (isgood tokenpresence state tokentry tokenid (us_split_fields__content5 authcert__split_fields) (us_split_fields__content8 idcert__split_fields)) true) (= (isgood tokenpresence1 state8 tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true)) (= (= (authcertvalid tokenpresence state tokentry tokenid (us_split_fields__content5 authcert__split_fields) (us_split_fields__content8 idcert__split_fields)) true) (= (authcertvalid tokenpresence1 state8 tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true))) (= (= (theauthcertrole tokenpresence state tokentry tokenid (us_split_fields__content5 authcert__split_fields) (us_split_fields__content8 idcert__split_fields)) 1) (= (theauthcertrole tokenpresence1 state8 tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) 1))) (and (and (and (and (in_range14 tokenpresence1) (= (valid_numberlogentries (to_rep14 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep15 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true)) (in_range16 tokentry1)) (in_range22 auditalarm3)) (in_range15 tokenid1))))
...
(assert (= logfilestate__split_fields11 (mk___split_fields__ref10 logfilestate__split_fields10)))
...
(assert (= (thedooralarm (us_private__content state15)) 0))
(assert (not (= (islocked (int__content currentlatch2) (us_private__content state14) (us_split_fields__content latchtimeout__split_fields5)) true)))
(check-sat)
(exit)
