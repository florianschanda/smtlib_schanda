...
(assert (= right1 10))
(assert (or (and (and (and (= binary_search__search__result16 (mk_int__ref binary_search__search__result2)) (and (= med12 (mk_int__ref med)) (and (= right12 (mk_int__ref right1)) (= left12 (mk_int__ref left1))))) (and (= binary_search__search__result17 binary_search__search__result2) (and (= med13 med1) (and (= right13 right1) (= left13 left1))))) (and (or (< i (to_rep (select a left1))) (< (to_rep (select a right1)) i)) (and (= (mk_int__ref result2) (mk_int__ref binary_search__search__result)) (= binary_search__search__result2 0)))) (and (and (not (or (< i (to_rep (select a left1))) (< (to_rep (select a right1)) i))) (and (= binary_search__search__result2 binary_search__search__result) (= binary_search__search__result2 binary_search__search__result1))) (and (and (and (= binary_search__search__result16 binary_search__search__result14) (and (= med12 med10) (and (= right12 right10) (= left12 left10)))) (and (= binary_search__search__result17 binary_search__search__result15) (and (= med13 med11) (and (= right13 right11) (= left13 left11))))) (or (and (and (and (= binary_search__search__result14 (mk_int__ref binary_search__search__result4)) (and (= med10 (mk_int__ref med3)) (and (= right10 (mk_int__ref right2)) (= left10 (mk_int__ref left2))))) (and (= binary_search__search__result15 binary_search__search__result4) (and (= med11 med3) (and (= right11 right2) (= left11 left2))))) (and (<= left1 right1) (and (= temp___158 med) (and (= temp___157 right1) (and (= temp___156 left1) (and (= 0 temp___159) (and (and (forall ((index2 Int)) (=> (and (<= 1 index2) (<= index2 (- left2 1))) (< (to_rep (select a index2)) i))) (forall ((index2 Int)) (=> (and (<= (+ right2 1) index2) (<= index2 10)) (< i (to_rep (select a index2)))))) (and (and (and (and (=> (<= 1 10) (in_range2 left2)) (=> (<= 1 10) (in_range2 right2))) (=> (<= 1 10) (in_range2 med2))) (<= left2 right2)) (and (and (= temp___1591 result4) (= temp___1592 (- right2 left2))) (and (and (and (= o (+ left2 (div1 (- right2 left2) 2))) (in_range2 (+ left2 (div1 (- right2 left2) 2)))) (and (= med2 result5) (= med3 o))) (and (not (< (to_rep (select a med3)) i)) (and (not (< i (to_rep (select a med3)))) (and (= binary_search__search__result3 result8) (= binary_search__search__result4 med3)))))))))))))) (and (ite (<= left1 right1) (and (and (and (= temp___158 med) (and (= temp___157 right1) (and (= temp___156 left1) (and (= 0 temp___159) (and (and (forall ((index2 Int)) (=> (and (<= 1 index2) (<= index2 (- left2 1))) (< (to_rep (select a index2)) i))) (forall ((index2 Int)) (=> (and (<= (+ right2 1) index2) (<= index2 10)) (< i (to_rep (select a index2)))))) (and (and (and (and (=> (<= 1 10) (in_range2 left2)) (=> (<= 1 10) (in_range2 right2))) (=> (<= 1 10) (in_range2 med2))) (<= left2 right2)) (and (and (= temp___1591 result4) (= temp___1592 (- right2 left2))) (and (and (and (= o (+ left2 (div1 (- right2 left2) 2))) (in_range2 (+ left2 (div1 (- right2 left2) 2)))) (and (= med2 result5) (= med3 o))) (and (ite (< (to_rep (select a med3)) i) (and (and (and (= o1 (+ med3 1)) (in_range2 (+ med3 1))) (and (= left2 result6) (= left3 o1))) (and (= binary_search__search__result4 binary_search__search__result3) (= right3 right2))) (and (and (< i (to_rep (select a med3))) (and (and (and (= o2 (- med3 1)) (in_range2 (- med3 1))) (and (= right2 result7) (= right3 o2))) (= binary_search__search__result4 binary_search__search__result3))) (= left3 left2))) (not (<= left3 right3))))))))))) (and (and (= binary_search__search__result7 (mk_int__ref binary_search__search__result4)) (and (= med3 med6) (and (= right3 right6) (= left3 left6)))) (and (= binary_search__search__result8 binary_search__search__result4) (and (= med7 med3) (and (= right7 right3) (= left7 left3)))))) (and (and (= binary_search__search__result9 binary_search__search__result7) (and (= med8 (mk_int__ref med6)) (and (= right8 (mk_int__ref right6)) (= left8 (mk_int__ref left6))))) (and (= binary_search__search__result10 binary_search__search__result8) (and (= med9 med7) (and (= right9 right7) (= left9 left7)))))) (and (and (= binary_search__search__result9 (mk_int__ref binary_search__search__result2)) (and (= med8 (mk_int__ref med)) (and (= right8 (mk_int__ref right1)) (= left8 (mk_int__ref left1))))) (and (= binary_search__search__result10 binary_search__search__result2) (and (= med9 med1) (and (= right9 right1) (= left9 left1)))))) (and (and (and (= binary_search__search__result14 binary_search__search__result12) (and (= med10 med8) (and (= right10 right8) (= left10 left8)))) (and (= binary_search__search__result15 binary_search__search__result13) (and (= med11 med9) (and (= right11 right9) (= left11 left9))))) (and (and (= binary_search__search__result12 (mk_int__ref binary_search__search__result11)) (= binary_search__search__result13 binary_search__search__result11)) (and (= result9 binary_search__search__result9) (= binary_search__search__result11 0))))))))))
(assert (= binary_search__search__result18 binary_search__search__result16))
(assert (= med14 med12))
(assert (= right14 right12))
(assert (= left14 left12))
(assert (= binary_search__search__result19 binary_search__search__result17))
(assert (= med15 med13))
(assert (= right15 right13))
(assert (= left15 left13))
(assert (= result10 (int__content binary_search__search__result18)))
(assert (<= 1 (int__content binary_search__search__result18)))
(assert (<= (int__content binary_search__search__result18) 10))
(assert (not (= (to_rep (select a (int__content binary_search__search__result18))) i)))
(check-sat)
(exit)
