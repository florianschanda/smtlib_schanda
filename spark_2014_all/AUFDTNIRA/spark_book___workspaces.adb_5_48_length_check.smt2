...
(assert (not (= (ite (<= (to_rep1 (first4 temp___1791)) (to_rep1 (last4 temp___1791))) (+ (- (to_rep1 (last4 temp___1791)) (to_rep1 (first4 temp___1791))) 1) 0) (ite (<= 1 size) (+ (- size 1) 1) 0))))
(check-sat)
(exit)
