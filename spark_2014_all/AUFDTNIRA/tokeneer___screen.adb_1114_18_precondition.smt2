...
(define-fun dynamic_invariant ((temp___expr_246 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 0 1)) (in_range4 temp___expr_246)))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep7 (select a temp___idx_172)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep10 (select a temp___idx_173)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(declare-fun temp___1291 (Int) (Array Int logfileindext))
(declare-fun temp___1295 (Int) (Array Int fileentrycountt))
(define-fun dynamic_invariant1 ((temp___expr_1285 us_rep1) (temp___is_init_1281 Bool) (temp___skip_constant_1282 Bool) (temp___do_toplevel_1283 Bool) (temp___do_typ_inv_1284 Bool)) Bool (=> (= temp___do_typ_inv_1284 true) (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1285))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1285))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1285)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1285))) true)))
(define-fun default_initial_assumption ((temp___expr_1289 us_rep1) (temp___skip_top_level_1290 Bool)) Bool (and (and (and (= (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1289))) 1) (= (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1289))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1289)) (mk___rep (mk___split_fields (temp___1291 1) (of_rep7 1) (of_rep7 1) (of_rep9 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1289)) (temp___1295 0))))
(define-fun type_invariant ((temp___1299 us_rep1)) Bool (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1299))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1299))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1299)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1299))) true))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep11 (select a temp___idx_175)) (to_rep11 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_1629 Int) (temp___is_init_1625 Bool) (temp___skip_constant_1626 Bool) (temp___do_toplevel_1627 Bool) (temp___do_typ_inv_1628 Bool)) Bool (=> (or (= temp___is_init_1625 true) (<= 0 14)) (in_range16 temp___expr_1629)))
...
(declare-fun temp___String_Literal_1937 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1937 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 2)) 99)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 8)) 73)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 9)) 110)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 12)) 105)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 16)) 115)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 20)) 111)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 21)) 110)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 23)) 70)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 24)) 97)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 26)) 108)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 27)) 117)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 28)) 114)) (= (to_rep (select (temp___String_Literal_1937 us_void_param) 29)) 101)) :pattern ((temp___String_Literal_1937 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1182 Int) (temp___is_init_1178 Bool) (temp___skip_constant_1179 Bool) (temp___do_toplevel_1180 Bool) (temp___do_typ_inv_1181 Bool)) Bool (=> (or (= temp___is_init_1178 true) (<= 0 5)) (in_range8 temp___expr_1182)))
(define-fun dynamic_invariant8 ((temp___expr_1223 Int) (temp___is_init_1219 Bool) (temp___skip_constant_1220 Bool) (temp___do_toplevel_1221 Bool) (temp___do_typ_inv_1222 Bool)) Bool (=> (or (= temp___is_init_1219 true) (<= 0 17)) (in_range12 temp___expr_1223)))
(define-fun dynamic_invariant9 ((temp___expr_1230 Int) (temp___is_init_1226 Bool) (temp___skip_constant_1227 Bool) (temp___do_toplevel_1228 Bool) (temp___do_typ_inv_1229 Bool)) Bool (=> (or (= temp___is_init_1226 true) (<= 1 17)) (in_range10 temp___expr_1230)))
(define-fun dynamic_invariant10 ((temp___expr_1356 Int) (temp___is_init_1352 Bool) (temp___skip_constant_1353 Bool) (temp___do_toplevel_1354 Bool) (temp___do_typ_inv_1355 Bool)) Bool (=> (or (= temp___is_init_1352 true) (<= 0 2)) (in_range14 temp___expr_1356)))
(define-fun dynamic_invariant11 ((temp___expr_1237 Int) (temp___is_init_1233 Bool) (temp___skip_constant_1234 Bool) (temp___do_toplevel_1235 Bool) (temp___do_typ_inv_1236 Bool)) Bool (=> (or (= temp___is_init_1233 true) (<= 0 17408)) (in_range11 temp___expr_1237)))
(define-fun dynamic_invariant12 ((temp___expr_1268 Int) (temp___is_init_1264 Bool) (temp___skip_constant_1265 Bool) (temp___do_toplevel_1266 Bool) (temp___do_typ_inv_1267 Bool)) Bool (=> (or (= temp___is_init_1264 true) (<= 0 1024)) (in_range13 temp___expr_1268)))
(assert true)
...
(assert (forall ((temp___1297 Int)) (=> (dynamic_invariant12 temp___1297 true true true true) (forall ((temp___1298 Int)) (= (to_rep10 (select (temp___1295 temp___1297) temp___1298)) temp___1297)))))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant13 ((temp___expr_514 Int) (temp___is_init_510 Bool) (temp___skip_constant_511 Bool) (temp___do_toplevel_512 Bool) (temp___do_typ_inv_513 Bool)) Bool (=> (or (= temp___is_init_510 true) (<= 0 4194304)) (in_range5 temp___expr_514)))
(define-fun dynamic_invariant14 ((temp___expr_567 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool) (temp___do_typ_inv_566 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 0 864000)) (in_range6 temp___expr_567)))
(define-fun dynamic_invariant15 ((temp___expr_1212 Int) (temp___is_init_1208 Bool) (temp___skip_constant_1209 Bool) (temp___do_toplevel_1210 Bool) (temp___do_typ_inv_1211 Bool)) Bool (=> (or (= temp___is_init_1208 true) (<= 0 1)) (in_range9 temp___expr_1212)))
(define-fun dynamic_invariant16 ((temp___expr_1092 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool) (temp___do_typ_inv_1091 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 2147483647)) (in_range7 temp___expr_1092)))
(define-fun dynamic_invariant17 ((temp___expr_1518 Int) (temp___is_init_1514 Bool) (temp___skip_constant_1515 Bool) (temp___do_toplevel_1516 Bool) (temp___do_typ_inv_1517 Bool)) Bool (=> (or (= temp___is_init_1514 true) (<= 0 2147483647)) (in_range15 temp___expr_1518)))
(assert (forall ((temp___1293 Int)) (=> (dynamic_invariant9 temp___1293 true true true true) (forall ((temp___1294 Int)) (= (to_rep7 (select (temp___1291 temp___1293) temp___1294)) temp___1293)))))
...
(declare-const temp___1946 us_rep5)
...
(assert (= temp___1946 (mk___rep4 o13)))
(assert (= temp___1946 nullconfigdata))
