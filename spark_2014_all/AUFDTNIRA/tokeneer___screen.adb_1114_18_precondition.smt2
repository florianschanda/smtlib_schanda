...
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq2 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true))))))))
...
(assert (forall ((a (Array Int filestatust))) (forall ((first2 Int)) (! (= (slide2 a first2 first2) a) :pattern ((slide2 a first2 first2))))))
...
(assert (forall ((a (Array Int logfileindext))) (forall ((first2 Int)) (! (= (slide3 a first2 first2) a) :pattern ((slide3 a first2 first2))))))
...
(assert (forall ((a (Array Int fileentrycountt))) (forall ((first2 Int)) (! (= (slide4 a first2 first2) a) :pattern ((slide4 a first2 first2))))))
...
(define-fun dynamic_invariant ((temp___expr_246 Int) (temp___is_init_242 Bool) (temp___skip_constant_243 Bool) (temp___do_toplevel_244 Bool) (temp___do_typ_inv_245 Bool)) Bool (=> (or (= temp___is_init_242 true) (<= 0 1)) (in_range9 temp___expr_246)))
...
(declare-fun temp_____aggregate_def_1284 (Int) (Array Int logfileindext))
(declare-fun temp_____aggregate_def_1288 (Int) (Array Int fileentrycountt))
(define-fun dynamic_invariant1 ((temp___expr_1278 us_rep2) (temp___is_init_1274 Bool) (temp___skip_constant_1275 Bool) (temp___do_toplevel_1276 Bool) (temp___do_typ_inv_1277 Bool)) Bool (=> (= temp___do_typ_inv_1277 true) (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1278))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1278))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1278)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1278))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1282 us_rep2) (temp___skip_top_level_1283 Bool)) Bool (and (and (and (= (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1282))) 1) (= (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1282))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1282)) (mk___rep (mk___split_fields (temp_____aggregate_def_1284 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1282)) (temp_____aggregate_def_1288 0))))
(define-fun type_invariant ((temp___1292 us_rep2)) Bool (= (valid_numberlogentries (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1292))) (to_rep4 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1292))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1292)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1292))) true))
...
(declare-fun user_eq15 (statscount statscount) Bool)
(declare-const dummy15 statscount)
...
(define-fun to_rep7 ((x statscount)) Int (statscountqtint x))
...
(define-fun bool_eq9 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (to_rep7 (rec__stats__t__successentry (us_split_fields5 a))) (to_rep7 (rec__stats__t__successentry (us_split_fields5 b)))) (= (to_rep7 (rec__stats__t__failentry (us_split_fields5 a))) (to_rep7 (rec__stats__t__failentry (us_split_fields5 b))))) (= (to_rep7 (rec__stats__t__successbio (us_split_fields5 a))) (to_rep7 (rec__stats__t__successbio (us_split_fields5 b))))) (= (to_rep7 (rec__stats__t__failbio (us_split_fields5 a))) (to_rep7 (rec__stats__t__failbio (us_split_fields5 b))))) true false))
...
(declare-fun user_eq17 (msgtextt msgtextt) Bool)
(declare-const dummy17 msgtextt)
...
(define-fun dynamic_invariant2 ((temp___expr_1622 Int) (temp___is_init_1618 Bool) (temp___skip_constant_1619 Bool) (temp___do_toplevel_1620 Bool) (temp___do_typ_inv_1621 Bool)) Bool (=> (or (= temp___is_init_1618 true) (<= 0 14)) (in_range11 temp___expr_1622)))
...
(define-fun in_range12 ((x Int)) Bool (and (<= 0 x) (<= x 4194304)))
(declare-fun attr__ATTRIBUTE_IMAGE12 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check12 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE12 (us_image) Int)
(declare-fun user_eq18 (filesizet filesizet) Bool)
(declare-const dummy18 filesizet)
...
(define-fun in_range13 ((x Int)) Bool (and (<= 0 x) (<= x 864000)))
(declare-fun attr__ATTRIBUTE_IMAGE13 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check13 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE13 (us_image) Int)
(declare-fun user_eq19 (durationt durationt) Bool)
(declare-const dummy19 durationt)
...
(declare-fun user_eq20 (fart fart) Bool)
(declare-const dummy20 fart)
...
(assert (forall ((x classt)) (! (in_range15 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(declare-fun user_eq22 (accesspolicyt accesspolicyt) Bool)
(declare-const dummy22 accesspolicyt)
...
(assert (forall ((x accesspolicyt)) (! (in_range16 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun to_rep10 ((x filesizet)) Int (filesizetqtint x))
(declare-fun of_rep10 (Int) filesizet)
(assert (forall ((x filesizet)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x filesizet)) (! (in_range12 (to_rep10 x)) :pattern ((to_rep10 x)))))
(assert (forall ((x Int)) (! (=> (in_range12 x) (= (to_rep10 (of_rep10 x)) x)) :pattern ((to_rep10 (of_rep10 x))))))
(define-fun to_rep11 ((x durationt)) Int (durationtqtint x))
(declare-fun of_rep11 (Int) durationt)
(assert (forall ((x durationt)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x durationt)) (! (in_range13 (to_rep11 x)) :pattern ((to_rep11 x)))))
(assert (forall ((x Int)) (! (=> (in_range13 x) (= (to_rep11 (of_rep11 x)) x)) :pattern ((to_rep11 (of_rep11 x))))))
(define-fun to_rep12 ((x fart)) Int (fartqtint x))
(declare-fun of_rep12 (Int) fart)
(assert (forall ((x fart)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x fart)) (! (in_range14 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun bool_eq11 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep11 (rec__screen__displayedconfigt__latchunlock (us_split_fields9 a))) (to_rep11 (rec__screen__displayedconfigt__latchunlock (us_split_fields9 b)))) (= (to_rep11 (rec__screen__displayedconfigt__alarmsilent (us_split_fields9 a))) (to_rep11 (rec__screen__displayedconfigt__alarmsilent (us_split_fields9 b))))) (= (to_rep11 (rec__screen__displayedconfigt__fingerwait (us_split_fields9 a))) (to_rep11 (rec__screen__displayedconfigt__fingerwait (us_split_fields9 b))))) (= (to_rep11 (rec__screen__displayedconfigt__tokenremove (us_split_fields9 a))) (to_rep11 (rec__screen__displayedconfigt__tokenremove (us_split_fields9 b))))) (= (to_rep11 (rec__screen__displayedconfigt__workstart (us_split_fields9 a))) (to_rep11 (rec__screen__displayedconfigt__workstart (us_split_fields9 b))))) (= (to_rep11 (rec__screen__displayedconfigt__workend (us_split_fields9 a))) (to_rep11 (rec__screen__displayedconfigt__workend (us_split_fields9 b))))) (= (to_rep11 (rec__screen__displayedconfigt__authduration (us_split_fields9 a))) (to_rep11 (rec__screen__displayedconfigt__authduration (us_split_fields9 b))))) (= (to_rep9 (rec__screen__displayedconfigt__policy (us_split_fields9 a))) (to_rep9 (rec__screen__displayedconfigt__policy (us_split_fields9 b))))) (= (to_rep10 (rec__screen__displayedconfigt__minpreservedlog (us_split_fields9 a))) (to_rep10 (rec__screen__displayedconfigt__minpreservedlog (us_split_fields9 b))))) (= (to_rep10 (rec__screen__displayedconfigt__alarmthreshold (us_split_fields9 a))) (to_rep10 (rec__screen__displayedconfigt__alarmthreshold (us_split_fields9 b))))) (= (to_rep8 (rec__screen__displayedconfigt__minentry (us_split_fields9 a))) (to_rep8 (rec__screen__displayedconfigt__minentry (us_split_fields9 b))))) (= (to_rep8 (rec__screen__displayedconfigt__clearance (us_split_fields9 a))) (to_rep8 (rec__screen__displayedconfigt__clearance (us_split_fields9 b))))) (= (to_rep12 (rec__screen__displayedconfigt__maxfar (us_split_fields9 a))) (to_rep12 (rec__screen__displayedconfigt__maxfar (us_split_fields9 b))))) true false))
...
(declare-fun temp___String_Literal_1930 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1930 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 2)) 99)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 8)) 73)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 9)) 110)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 12)) 105)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 16)) 115)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 20)) 111)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 21)) 110)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 23)) 70)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 24)) 97)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 26)) 108)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 27)) 117)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 28)) 114)) (= (to_rep (select (temp___String_Literal_1930 us_void_param) 29)) 101)) :pattern ((temp___String_Literal_1930 us_void_param)))))
...
(declare-const rliteral2 durationt)
(assert (= (durationtqtint rliteral2) 0))
(declare-const rliteral3 filesizet)
(assert (= (filesizetqtint rliteral3) 0))
(declare-const rliteral4 fart)
(assert (= (fartqtint rliteral4) 0))
(assert (= nullconfigdata (mk___rep4 (mk___split_fields4 rliteral2 rliteral2 rliteral2 rliteral2 rliteral2 rliteral2 rliteral2 (of_rep9 0) rliteral3 rliteral3 (of_rep8 0) (of_rep8 0) rliteral4))))
(define-fun dynamic_invariant7 ((temp___expr_1175 Int) (temp___is_init_1171 Bool) (temp___skip_constant_1172 Bool) (temp___do_toplevel_1173 Bool) (temp___do_typ_inv_1174 Bool)) Bool (=> (or (= temp___is_init_1171 true) (<= 0 5)) (in_range15 temp___expr_1175)))
(define-fun dynamic_invariant8 ((temp___expr_1216 Int) (temp___is_init_1212 Bool) (temp___skip_constant_1213 Bool) (temp___do_toplevel_1214 Bool) (temp___do_typ_inv_1215 Bool)) Bool (=> (or (= temp___is_init_1212 true) (<= 0 17)) (in_range7 temp___expr_1216)))
(define-fun dynamic_invariant9 ((temp___expr_1223 Int) (temp___is_init_1219 Bool) (temp___skip_constant_1220 Bool) (temp___do_toplevel_1221 Bool) (temp___do_typ_inv_1222 Bool)) Bool (=> (or (= temp___is_init_1219 true) (<= 1 17)) (in_range5 temp___expr_1223)))
(define-fun dynamic_invariant10 ((temp___expr_1349 Int) (temp___is_init_1345 Bool) (temp___skip_constant_1346 Bool) (temp___do_toplevel_1347 Bool) (temp___do_typ_inv_1348 Bool)) Bool (=> (or (= temp___is_init_1345 true) (<= 0 2)) (in_range4 temp___expr_1349)))
(define-fun dynamic_invariant11 ((temp___expr_1230 Int) (temp___is_init_1226 Bool) (temp___skip_constant_1227 Bool) (temp___do_toplevel_1228 Bool) (temp___do_typ_inv_1229 Bool)) Bool (=> (or (= temp___is_init_1226 true) (<= 0 17408)) (in_range6 temp___expr_1230)))
(define-fun dynamic_invariant12 ((temp___expr_1261 Int) (temp___is_init_1257 Bool) (temp___skip_constant_1258 Bool) (temp___do_toplevel_1259 Bool) (temp___do_typ_inv_1260 Bool)) Bool (=> (or (= temp___is_init_1257 true) (<= 0 1024)) (in_range8 temp___expr_1261)))
(assert true)
...
(declare-const rliteral5 fileentrycountt)
(assert (= (fileentrycounttqtint rliteral5) 0))
(assert (forall ((temp___1290 Int)) (=> (dynamic_invariant12 temp___1290 true true true true) (forall ((temp___1291 Int)) (= (select (temp_____aggregate_def_1288 temp___1290) temp___1291) rliteral5)))))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant13 ((temp___expr_514 Int) (temp___is_init_510 Bool) (temp___skip_constant_511 Bool) (temp___do_toplevel_512 Bool) (temp___do_typ_inv_513 Bool)) Bool (=> (or (= temp___is_init_510 true) (<= 0 4194304)) (in_range12 temp___expr_514)))
(define-fun dynamic_invariant14 ((temp___expr_567 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool) (temp___do_typ_inv_566 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 0 864000)) (in_range13 temp___expr_567)))
(define-fun dynamic_invariant15 ((temp___expr_1205 Int) (temp___is_init_1201 Bool) (temp___skip_constant_1202 Bool) (temp___do_toplevel_1203 Bool) (temp___do_typ_inv_1204 Bool)) Bool (=> (or (= temp___is_init_1201 true) (<= 0 1)) (in_range16 temp___expr_1205)))
(define-fun dynamic_invariant16 ((temp___expr_1085 Int) (temp___is_init_1081 Bool) (temp___skip_constant_1082 Bool) (temp___do_toplevel_1083 Bool) (temp___do_typ_inv_1084 Bool)) Bool (=> (or (= temp___is_init_1081 true) (<= 0 2147483647)) (in_range14 temp___expr_1085)))
(define-fun dynamic_invariant17 ((temp___expr_1511 Int) (temp___is_init_1507 Bool) (temp___skip_constant_1508 Bool) (temp___do_toplevel_1509 Bool) (temp___do_typ_inv_1510 Bool)) Bool (=> (or (= temp___is_init_1507 true) (<= 0 2147483647)) (in_range10 temp___expr_1511)))
(assert (forall ((temp___1286 Int)) (=> (dynamic_invariant9 temp___1286 true true true true) (forall ((temp___1287 Int)) (= (select (temp_____aggregate_def_1284 temp___1286) temp___1287) rliteral)))))
...
(declare-const o2 accesspolicyt)
(declare-const o3 us_split_fields8)
(declare-const temp___1939 us_rep5)
...
(assert (= (to_rep8 o1) 0))
(assert (= (to_rep9 o2) 0))
(assert (= o3 (mk___split_fields4 rliteral2 rliteral2 rliteral2 rliteral2 rliteral2 rliteral2 rliteral2 o2 rliteral3 rliteral3 o1 o rliteral4)))
(assert (= temp___1939 (mk___rep4 o3)))
(assert (= temp___1939 nullconfigdata))
(assert (= (temp___String_Literal_158 Tuple0) nouser))
(assert (=> (<= 0 14) (in_range11 themsg)))
(assert (=> (<= 0 14) (in_range11 currentmsg)))
(assert (=> (<= 0 1) (in_range9 currentdooralarm)))
(assert (=> (<= 0 1) (in_range9 currentlogalarm)))
...
(assert (= currentstats__split_fields5 (mk___split_fields3 (distinct 0 0) (mk___rep2 (let ((subject localstats__split_fields)) localstats__split_fields1)))))
...
(assert (= currentconfig__split_fields14 (mk___split_fields5 (distinct 0 0) nullconfigdata)))
...
(assert (and (in_range9 currentdooralarm2) (in_range9 currentlogalarm2)))
