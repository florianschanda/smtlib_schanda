...
(define-fun dynamic_invariant ((temp___expr_223 Int) (temp___is_init_220 Bool) (temp___skip_constant_221 Bool) (temp___do_toplevel_222 Bool)) Bool (=> (or (= temp___is_init_220 true) (<= 0 1)) (in_range4 temp___expr_223)))
...
(assert (forall ((x logfileindext)) (! (in_range10 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range11 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_150 Int)) (=> (and (<= a__first temp___idx_150) (<= temp___idx_150 a__last)) (= (to_rep7 (select a temp___idx_150)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_150)))))))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep7 (select a (+ i 1))) (to_rep7 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep7 (select b (+ i 1))) (to_rep7 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((x logfilecountt)) (! (in_range12 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (bool_eq2 (rec__auditlog__logfilelistt__list (us_split_fields1 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields1 b)) 1 17) true) (= (to_rep7 (rec__auditlog__logfilelistt__head (us_split_fields1 a))) (to_rep7 (rec__auditlog__logfilelistt__head (us_split_fields1 b))))) (= (to_rep7 (rec__auditlog__logfilelistt__lasti (us_split_fields1 a))) (to_rep7 (rec__auditlog__logfilelistt__lasti (us_split_fields1 b))))) (= (to_rep9 (rec__auditlog__logfilelistt__length (us_split_fields1 a))) (to_rep9 (rec__auditlog__logfilelistt__length (us_split_fields1 b))))) true false))
...
(assert (forall ((x fileentrycountt)) (! (in_range13 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq4 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep10 (select a (+ i 1))) (to_rep10 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq4 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep10 (select b (+ i 1))) (to_rep10 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq5 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (= (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 a))) (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 b)))) (= (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 a))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 b))))) (= (bool_eq3 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 b))) true)) (= (bool_eq4 (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 b)) 1 17) true)) true false))
...
(declare-fun temp___1152 (Int) (Array Int logfileindext))
(assert (forall ((temp___1154 Int)) (forall ((temp___1155 Int)) (= (select (temp___1152 temp___1154) temp___1155) (of_rep7 temp___1154)))))
(declare-fun temp___1156 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1158 Int)) (forall ((temp___1159 Int)) (= (select (temp___1156 temp___1158) temp___1159) (of_rep10 temp___1158)))))
(define-fun dynamic_invariant1 ((temp___expr_1146 us_rep1) (temp___is_init_1143 Bool) (temp___skip_constant_1144 Bool) (temp___do_toplevel_1145 Bool)) Bool (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1146))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1146))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1146)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1146))) true))
(define-fun default_initial_assumption ((temp___expr_1150 us_rep1) (temp___skip_top_level_1151 Bool)) Bool (and (and (and (= (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1150))) 1) (= (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1150))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1150)) (mk___rep (mk___split_fields (temp___1152 1) (of_rep7 1) (of_rep7 1) (of_rep9 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1150)) (temp___1156 0))))
(define-fun type_invariant ((temp___1160 us_rep1)) Bool (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1160))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1160))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1160)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1160))) true))
...
(assert (forall ((x filestatust)) (! (in_range14 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep11 (select a temp___idx_153)) (to_rep11 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare3 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq8 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep11 (select a (+ i 1))) (to_rep11 (select b (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare3 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq8 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep11 (select b (+ i 1))) (to_rep11 (select a (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
...
(assert (forall ((x statscount)) (! (in_range15 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun bool_eq9 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (to_rep12 (rec__stats__t__successentry (us_split_fields5 a))) (to_rep12 (rec__stats__t__successentry (us_split_fields5 b)))) (= (to_rep12 (rec__stats__t__failentry (us_split_fields5 a))) (to_rep12 (rec__stats__t__failentry (us_split_fields5 b))))) (= (to_rep12 (rec__stats__t__successbio (us_split_fields5 a))) (to_rep12 (rec__stats__t__successbio (us_split_fields5 b))))) (= (to_rep12 (rec__stats__t__failbio (us_split_fields5 a))) (to_rep12 (rec__stats__t__failbio (us_split_fields5 b))))) true false))
...
(define-fun t__ref___4__projection ((a t__ref1)) us_rep3 (t__content1 a))
(declare-sort msgtextt 0)
(define-fun in_range16 ((x Int)) Bool (and (<= 0 x) (<= x 14)))
...
(declare-fun user_eq22 (msgtextt msgtextt) Bool)
(declare-const dummy22 msgtextt)
...
(define-fun dynamic_invariant2 ((temp___expr_1464 Int) (temp___is_init_1461 Bool) (temp___skip_constant_1462 Bool) (temp___do_toplevel_1463 Bool)) Bool (=> (or (= temp___is_init_1461 true) (<= 0 14)) (in_range16 temp___expr_1464)))
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-datatypes () ((us_split_fields6 (mk___split_fields3 (rec__screen__screenstatst__isdisplayed Bool) (rec__screen__screenstatst__data us_rep3)))))
(define-fun us_split_fields_IsDisplayed__projection ((a us_split_fields6)) Bool (rec__screen__screenstatst__isdisplayed a))
(define-fun us_split_fields_Data__projection ((a us_split_fields6)) us_rep3 (rec__screen__screenstatst__data a))
...
(define-fun bool_eq10 ((a us_rep4) (b us_rep4)) Bool (ite (and (= (rec__screen__screenstatst__isdisplayed (us_split_fields7 a)) (rec__screen__screenstatst__isdisplayed (us_split_fields7 b))) (= (bool_eq9 (rec__screen__screenstatst__data (us_split_fields7 a)) (rec__screen__screenstatst__data (us_split_fields7 b))) true)) true false))
...
(declare-datatypes () ((screenstatst__ref (mk_screenstatst__ref (screenstatst__content us_rep4)))))
(define-fun screenstatst__ref___projection ((a screenstatst__ref)) us_rep4 (screenstatst__content a))
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__screen__displayedconfigt__latchunlock durationt) (rec__screen__displayedconfigt__alarmsilent durationt) (rec__screen__displayedconfigt__fingerwait durationt) (rec__screen__displayedconfigt__tokenremove durationt) (rec__screen__displayedconfigt__workstart durationt) (rec__screen__displayedconfigt__workend durationt) (rec__screen__displayedconfigt__authduration durationt) (rec__screen__displayedconfigt__policy accesspolicyt) (rec__screen__displayedconfigt__minpreservedlog filesizet) (rec__screen__displayedconfigt__alarmthreshold filesizet) (rec__screen__displayedconfigt__minentry classt) (rec__screen__displayedconfigt__clearance classt) (rec__screen__displayedconfigt__maxfar fart)))))
(define-fun us_split_fields_LatchUnlock__projection ((a us_split_fields8)) durationt (rec__screen__displayedconfigt__latchunlock a))
(define-fun us_split_fields_AlarmSilent__projection ((a us_split_fields8)) durationt (rec__screen__displayedconfigt__alarmsilent a))
(define-fun us_split_fields_FingerWait__projection ((a us_split_fields8)) durationt (rec__screen__displayedconfigt__fingerwait a))
(define-fun us_split_fields_TokenRemove__projection ((a us_split_fields8)) durationt (rec__screen__displayedconfigt__tokenremove a))
(define-fun us_split_fields_WorkStart__projection ((a us_split_fields8)) durationt (rec__screen__displayedconfigt__workstart a))
(define-fun us_split_fields_WorkEnd__projection ((a us_split_fields8)) durationt (rec__screen__displayedconfigt__workend a))
(define-fun us_split_fields_AuthDuration__projection ((a us_split_fields8)) durationt (rec__screen__displayedconfigt__authduration a))
(define-fun us_split_fields_Policy__projection ((a us_split_fields8)) accesspolicyt (rec__screen__displayedconfigt__policy a))
(define-fun us_split_fields_MinPreservedLog__projection ((a us_split_fields8)) filesizet (rec__screen__displayedconfigt__minpreservedlog a))
(define-fun us_split_fields_AlarmThreshold__projection ((a us_split_fields8)) filesizet (rec__screen__displayedconfigt__alarmthreshold a))
(define-fun us_split_fields_MinEntry__projection ((a us_split_fields8)) classt (rec__screen__displayedconfigt__minentry a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields8)) classt (rec__screen__displayedconfigt__clearance a))
(define-fun us_split_fields_MaxFAR__projection ((a us_split_fields8)) fart (rec__screen__displayedconfigt__maxfar a))
...
(define-fun bool_eq11 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep3 (rec__screen__displayedconfigt__latchunlock (us_split_fields9 a))) (to_rep3 (rec__screen__displayedconfigt__latchunlock (us_split_fields9 b)))) (= (to_rep3 (rec__screen__displayedconfigt__alarmsilent (us_split_fields9 a))) (to_rep3 (rec__screen__displayedconfigt__alarmsilent (us_split_fields9 b))))) (= (to_rep3 (rec__screen__displayedconfigt__fingerwait (us_split_fields9 a))) (to_rep3 (rec__screen__displayedconfigt__fingerwait (us_split_fields9 b))))) (= (to_rep3 (rec__screen__displayedconfigt__tokenremove (us_split_fields9 a))) (to_rep3 (rec__screen__displayedconfigt__tokenremove (us_split_fields9 b))))) (= (to_rep3 (rec__screen__displayedconfigt__workstart (us_split_fields9 a))) (to_rep3 (rec__screen__displayedconfigt__workstart (us_split_fields9 b))))) (= (to_rep3 (rec__screen__displayedconfigt__workend (us_split_fields9 a))) (to_rep3 (rec__screen__displayedconfigt__workend (us_split_fields9 b))))) (= (to_rep3 (rec__screen__displayedconfigt__authduration (us_split_fields9 a))) (to_rep3 (rec__screen__displayedconfigt__authduration (us_split_fields9 b))))) (= (to_rep6 (rec__screen__displayedconfigt__policy (us_split_fields9 a))) (to_rep6 (rec__screen__displayedconfigt__policy (us_split_fields9 b))))) (= (to_rep2 (rec__screen__displayedconfigt__minpreservedlog (us_split_fields9 a))) (to_rep2 (rec__screen__displayedconfigt__minpreservedlog (us_split_fields9 b))))) (= (to_rep2 (rec__screen__displayedconfigt__alarmthreshold (us_split_fields9 a))) (to_rep2 (rec__screen__displayedconfigt__alarmthreshold (us_split_fields9 b))))) (= (to_rep5 (rec__screen__displayedconfigt__minentry (us_split_fields9 a))) (to_rep5 (rec__screen__displayedconfigt__minentry (us_split_fields9 b))))) (= (to_rep5 (rec__screen__displayedconfigt__clearance (us_split_fields9 a))) (to_rep5 (rec__screen__displayedconfigt__clearance (us_split_fields9 b))))) (= (to_rep4 (rec__screen__displayedconfigt__maxfar (us_split_fields9 a))) (to_rep4 (rec__screen__displayedconfigt__maxfar (us_split_fields9 b))))) true false))
...
(declare-datatypes () ((displayedconfigt__ref (mk_displayedconfigt__ref (displayedconfigt__content us_rep5)))))
(define-fun displayedconfigt__ref___projection ((a displayedconfigt__ref)) us_rep5 (displayedconfigt__content a))
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__screen__screenconfigt__isdisplayed Bool) (rec__screen__screenconfigt__data us_rep5)))))
(define-fun us_split_fields_IsDisplayed__2__projection ((a us_split_fields10)) Bool (rec__screen__screenconfigt__isdisplayed a))
(define-fun us_split_fields_Data__2__projection ((a us_split_fields10)) us_rep5 (rec__screen__screenconfigt__data a))
...
(define-fun bool_eq12 ((a us_rep6) (b us_rep6)) Bool (ite (and (= (rec__screen__screenconfigt__isdisplayed (us_split_fields11 a)) (rec__screen__screenconfigt__isdisplayed (us_split_fields11 b))) (= (bool_eq11 (rec__screen__screenconfigt__data (us_split_fields11 a)) (rec__screen__screenconfigt__data (us_split_fields11 b))) true)) true false))
...
(declare-datatypes () ((screenconfigt__ref (mk_screenconfigt__ref (screenconfigt__content us_rep6)))))
(define-fun screenconfigt__ref___projection ((a screenconfigt__ref)) us_rep6 (screenconfigt__content a))
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-const attr__ATTRIBUTE_ADDRESS11 Int)
(declare-const isenrolled Bool)
(declare-const attr__ATTRIBUTE_ADDRESS12 Int)
(declare-const nullconfigdata us_rep5)
(declare-const attr__ATTRIBUTE_ADDRESS13 Int)
(declare-const attr__ATTRIBUTE_ADDRESS14 Int)
(declare-const attr__ATTRIBUTE_ADDRESS15 Int)
(declare-const attr__ATTRIBUTE_ADDRESS16 Int)
(declare-fun temp___String_Literal_1746 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1746 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 2)) 99)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 8)) 73)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 9)) 110)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 10)) 105)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 12)) 105)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 13)) 97)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 14)) 108)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 15)) 105)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 16)) 115)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 17)) 97)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 19)) 105)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 20)) 111)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 21)) 110)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 22)) 32)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 23)) 70)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 24)) 97)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 26)) 108)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 27)) 117)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 28)) 114)) (= (to_rep (select (temp___String_Literal_1746 us_void_param) 29)) 101)) :pattern ((temp___String_Literal_1746 us_void_param)))))
...
(assert (= nullconfigdata (mk___rep4 (mk___split_fields4 (of_rep3 0) (of_rep3 0) (of_rep3 0) (of_rep3 0) (of_rep3 0) (of_rep3 0) (of_rep3 0) (of_rep6 0) (of_rep2 0) (of_rep2 0) (of_rep5 0) (of_rep5 0) (of_rep4 0)))))
(define-fun dynamic_invariant7 ((temp___expr_1054 Int) (temp___is_init_1051 Bool) (temp___skip_constant_1052 Bool) (temp___do_toplevel_1053 Bool)) Bool (=> (or (= temp___is_init_1051 true) (<= 0 5)) (in_range8 temp___expr_1054)))
(define-fun dynamic_invariant8 ((temp___expr_1112 Int) (temp___is_init_1109 Bool) (temp___skip_constant_1110 Bool) (temp___do_toplevel_1111 Bool)) Bool (=> (or (= temp___is_init_1109 true) (<= 0 17)) (in_range12 temp___expr_1112)))
(define-fun dynamic_invariant9 ((temp___expr_1091 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 1 17)) (in_range10 temp___expr_1091)))
(define-fun dynamic_invariant10 ((temp___expr_1216 Int) (temp___is_init_1213 Bool) (temp___skip_constant_1214 Bool) (temp___do_toplevel_1215 Bool)) Bool (=> (or (= temp___is_init_1213 true) (<= 0 2)) (in_range14 temp___expr_1216)))
(define-fun dynamic_invariant11 ((temp___expr_1097 Int) (temp___is_init_1094 Bool) (temp___skip_constant_1095 Bool) (temp___do_toplevel_1096 Bool)) Bool (=> (or (= temp___is_init_1094 true) (<= 0 17408)) (in_range11 temp___expr_1097)))
(define-fun dynamic_invariant12 ((temp___expr_1131 Int) (temp___is_init_1128 Bool) (temp___skip_constant_1129 Bool) (temp___do_toplevel_1130 Bool)) Bool (=> (or (= temp___is_init_1128 true) (<= 0 1024)) (in_range13 temp___expr_1131)))
(assert true)
(assert (forall ((currentlogfile Int) (numberlogentries Int)) (forall ((usedlogfiles us_rep)) (forall ((logfileentries (Array Int fileentrycountt))) (! (= (= (valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries) true) (and (<= 1 (to_rep9 (rec__auditlog__logfilelistt__length (us_split_fields1 usedlogfiles)))) (= numberlogentries (+ (* (- (to_rep9 (rec__auditlog__logfilelistt__length (us_split_fields1 usedlogfiles))) 1) 1024) (to_rep10 (select logfileentries currentlogfile)))))) :pattern ((valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries)))))))
(assert (= nouser (temp___String_Literal_136 Tuple0)))
(define-fun dynamic_invariant13 ((temp___expr_464 Int) (temp___is_init_461 Bool) (temp___skip_constant_462 Bool) (temp___do_toplevel_463 Bool)) Bool (=> (or (= temp___is_init_461 true) (<= 0 4194304)) (in_range5 temp___expr_464)))
(define-fun dynamic_invariant14 ((temp___expr_510 Int) (temp___is_init_507 Bool) (temp___skip_constant_508 Bool) (temp___do_toplevel_509 Bool)) Bool (=> (or (= temp___is_init_507 true) (<= 0 864000)) (in_range6 temp___expr_510)))
(define-fun dynamic_invariant15 ((temp___expr_1081 Int) (temp___is_init_1078 Bool) (temp___skip_constant_1079 Bool) (temp___do_toplevel_1080 Bool)) Bool (=> (or (= temp___is_init_1078 true) (<= 0 1)) (in_range9 temp___expr_1081)))
(define-fun dynamic_invariant16 ((temp___expr_974 Int) (temp___is_init_971 Bool) (temp___skip_constant_972 Bool) (temp___do_toplevel_973 Bool)) Bool (=> (or (= temp___is_init_971 true) (<= 0 2147483647)) (in_range7 temp___expr_974)))
(define-fun dynamic_invariant17 ((temp___expr_1364 Int) (temp___is_init_1361 Bool) (temp___skip_constant_1362 Bool) (temp___do_toplevel_1363 Bool)) Bool (=> (or (= temp___is_init_1361 true) (<= 0 2147483647)) (in_range15 temp___expr_1364)))
...
(declare-const localstats__split_fields us_split_fields__ref2)
...
(declare-const temp___1755 us_rep5)
(declare-const screenok Bool)
(declare-const localstats__split_fields1 us_split_fields4)
(declare-const result us_split_fields__ref3)
(declare-const currentstats__split_fields5 us_split_fields6)
(declare-const result1 us_split_fields__ref5)
(declare-const currentconfig__split_fields14 us_split_fields10)
...
(assert (= o13 (mk___split_fields4 o12 o11 o10 o9 o8 o7 o6 o5 o4 o3 o2 o1 o)))
(assert (= temp___1755 (mk___rep4 o13)))
(assert (= temp___1755 nullconfigdata))
(assert (= (temp___String_Literal_136 Tuple0) nouser))
(assert (=> (<= 0 14) (in_range16 themsg)))
(assert (=> (<= 0 14) (in_range16 currentmsg)))
(assert (=> (<= 0 1) (in_range4 currentdooralarm)))
(assert (=> (<= 0 1) (in_range4 currentlogalarm)))
(assert (= (valid_numberlogentries (to_rep7 logfilestate__split_fields) (to_rep8 logfilestate__split_fields1) (mk___rep (mk___split_fields logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6) true))
(assert (in_range4 auditalarm))
(assert (= result (mk___split_fields__ref3 (mk___split_fields3 currentstats__split_fields (mk___rep2 (mk___split_fields2 currentstats__split_fields1 currentstats__split_fields2 currentstats__split_fields3 currentstats__split_fields4))))))
(assert (= currentstats__split_fields5 (mk___split_fields3 (of_int 0) (mk___rep2 (let ((subject localstats__split_fields)) localstats__split_fields1)))))
(assert (= result1 (mk___split_fields__ref5 (mk___split_fields5 currentconfig__split_fields (mk___rep4 (mk___split_fields4 currentconfig__split_fields1 currentconfig__split_fields2 currentconfig__split_fields3 currentconfig__split_fields4 currentconfig__split_fields5 currentconfig__split_fields6 currentconfig__split_fields7 currentconfig__split_fields8 currentconfig__split_fields9 currentconfig__split_fields10 currentconfig__split_fields11 currentconfig__split_fields12 currentconfig__split_fields13))))))
(assert (= currentconfig__split_fields14 (mk___split_fields5 (of_int 0) nullconfigdata)))
...
(assert (=> (= isenrolled true) (= result6 (mk_int__ref themsg))))
(assert (=> (= isenrolled true) (= themsg1 1)))
(assert (=> (not (= isenrolled true)) (= result7 (mk_int__ref themsg))))
(assert (=> (not (= isenrolled true)) (= themsg2 0)))
(assert (=> (not (= isenrolled true)) (= themsg1 themsg2)))
(assert (in_range16 currentmsg2))
