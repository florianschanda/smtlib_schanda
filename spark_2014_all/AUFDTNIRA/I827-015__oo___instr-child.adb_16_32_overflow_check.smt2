...
(assert (forall ((x sixty)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x sixty)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x twenty_four)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x twenty_four)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (= (to_rep1 (rec__instr__clock__seconds (us_split_fields3 a))) (to_rep1 (rec__instr__clock__seconds (us_split_fields3 b)))) (= (to_rep1 (rec__instr__clock__minutes (us_split_fields3 a))) (to_rep1 (rec__instr__clock__minutes (us_split_fields3 b))))) (= (to_rep2 (rec__instr__clock__hours (us_split_fields3 a))) (to_rep2 (rec__instr__clock__hours (us_split_fields3 b))))) (= (bool_eq (rec__instr__instrument__name1 (us_split_fields3 a)) 1 14 (rec__instr__instrument__name1 (us_split_fields3 b)) 1 14) true)) true false))
...
(define-fun default_initial_assumption ((temp___expr_239 us_rep1) (temp___skip_top_level_240 Bool)) Bool (and (= (attr__tag1 temp___expr_239) us_tag1) (and (and (and (= (to_rep1 (rec__instr__clock__seconds (us_split_fields3 temp___expr_239))) 0) (= (to_rep1 (rec__instr__clock__minutes (us_split_fields3 temp___expr_239))) 0)) (= (to_rep2 (rec__instr__clock__hours (us_split_fields3 temp___expr_239))) 0)) (= (rec__instr__instrument__name1 (us_split_fields3 temp___expr_239)) (temp___String_Literal_151 Tuple0)))))
...
(assert (forall ((x thousand)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x thousand)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun bool_eq3 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (and (= (to_rep3 (rec__instr__child__accurate_clock__millisec (us_split_fields5 a))) (to_rep3 (rec__instr__child__accurate_clock__millisec (us_split_fields5 b)))) (= (bool_eq (rec__instr__instrument__name2 (us_split_fields5 a)) 1 14 (rec__instr__instrument__name2 (us_split_fields5 b)) 1 14) true)) (= (to_rep1 (rec__instr__clock__seconds1 (us_split_fields5 a))) (to_rep1 (rec__instr__clock__seconds1 (us_split_fields5 b))))) (= (to_rep1 (rec__instr__clock__minutes1 (us_split_fields5 a))) (to_rep1 (rec__instr__clock__minutes1 (us_split_fields5 b))))) (= (to_rep2 (rec__instr__clock__hours1 (us_split_fields5 a))) (to_rep2 (rec__instr__clock__hours1 (us_split_fields5 b))))) true false))
...
(declare-fun increment__specific_post (Int us_split_fields2 Int Int us_split_fields2) Bool)
(assert true)
(assert true)
(assert true)
(define-fun default_initial_assumption1 ((temp___expr_293 us_rep2) (temp___skip_top_level_294 Bool)) Bool (and (= (attr__tag2 temp___expr_293) us_tag3) (and (and (and (and (= (to_rep3 (rec__instr__child__accurate_clock__millisec (us_split_fields5 temp___expr_293))) 0) (= (rec__instr__instrument__name2 (us_split_fields5 temp___expr_293)) (temp___String_Literal_151 Tuple0))) (= (to_rep1 (rec__instr__clock__seconds1 (us_split_fields5 temp___expr_293))) 0)) (= (to_rep1 (rec__instr__clock__minutes1 (us_split_fields5 temp___expr_293))) 0)) (= (to_rep2 (rec__instr__clock__hours1 (us_split_fields5 temp___expr_293))) 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_285 Int) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool)) Bool (=> (or (= temp___is_init_282 true) (<= 0 1000)) (in_range4 temp___expr_285)))
(define-fun dynamic_invariant3 ((temp___expr_225 Int) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool)) Bool (=> (or (= temp___is_init_222 true) (<= 0 60)) (in_range2 temp___expr_225)))
(define-fun dynamic_invariant4 ((temp___expr_231 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 24)) (in_range3 temp___expr_231)))
(define-fun default_initial_assumption2 ((temp___expr_149 us_rep) (temp___skip_top_level_150 Bool)) Bool (and (= (attr__tag temp___expr_149) us_tag) (= (rec__instr__instrument__name (us_split_fields1 temp___expr_149)) (temp___String_Literal_151 Tuple0))))
(define-fun default_initial_assumption3 ((temp___expr_263 us_rep1) (temp___skip_top_level_264 Bool)) Bool (and (= (attr__tag1 temp___expr_263) us_tag2) (and (and (and (= (rec__instr__instrument__name1 (us_split_fields3 temp___expr_263)) (temp___String_Literal_151 Tuple0)) (= (to_rep1 (rec__instr__clock__seconds (us_split_fields3 temp___expr_263))) 0)) (= (to_rep1 (rec__instr__clock__minutes (us_split_fields3 temp___expr_263))) 0)) (= (to_rep2 (rec__instr__clock__hours (us_split_fields3 temp___expr_263))) 0))))
(declare-const x__split_fields thousand)
(declare-const x__split_fields1 (Array Int character))
(declare-const x__split_fields2 sixty)
(declare-const x__split_fields3 sixty)
(declare-const x__split_fields4 twenty_four)
...
(declare-const instr__increment__x__fields3 (Array Int character))
(declare-const instr__increment__x__fields4 us_private)
(declare-const result thousand)
(declare-const result1 (Array Int character))
(declare-const result2 sixty)
(declare-const result3 sixty)
(declare-const result4 twenty_four)
(declare-const result5 us_private)
(declare-const x__split_fields6 thousand)
(declare-const x__split_fields7 (Array Int character))
(declare-const x__split_fields8 sixty)
(declare-const x__split_fields9 sixty)
(declare-const x__split_fields10 twenty_four)
(declare-const x__split_fields11 us_private)
(assert (in_range inc))
(assert (and (= o (+ (to_rep3 x__split_fields) inc)) (in_range (+ (to_rep3 x__split_fields) inc))))
(assert (= o1 (div1 o 1000)))
...
(assert (= (mk___split_fields2 x__split_fields6 x__split_fields7 x__split_fields8 x__split_fields9 x__split_fields10 x__split_fields11) (us_split_fields5 (of_base1 (mk___rep (mk___split_fields instr__increment__x__fields3 (hide_ext__ instr__increment__x__fields instr__increment__x__fields1 instr__increment__x__fields2 instr__increment__x__fields4)) (attr__tag1 (of_base (mk___rep (mk___split_fields x__split_fields1 (hide_ext__1 x__split_fields x__split_fields2 x__split_fields3 x__split_fields4 x__split_fields5)) x__attr__tag))))))))
(assert (not (in_range (+ (to_rep3 x__split_fields6) inc))))
(check-sat)
(exit)
