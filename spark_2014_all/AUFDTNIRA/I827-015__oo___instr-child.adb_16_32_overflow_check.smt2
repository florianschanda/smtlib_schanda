...
(define-fun default_initial_assumption ((temp___expr_273 us_rep1) (temp___skip_top_level_274 Bool)) Bool (and (= (attr__tag1 temp___expr_273) us_tag1) (and (and (and (= (to_rep1 (rec__instr__clock__seconds (us_split_fields3 temp___expr_273))) 0) (= (to_rep1 (rec__instr__clock__minutes (us_split_fields3 temp___expr_273))) 0)) (= (to_rep2 (rec__instr__clock__hours (us_split_fields3 temp___expr_273))) 0)) (= (rec__instr__instrument__name1 (us_split_fields3 temp___expr_273)) (temp___String_Literal_175 Tuple0)))))
...
(assert true)
(assert true)
(define-fun default_initial_assumption1 ((temp___expr_316 us_rep2) (temp___skip_top_level_317 Bool)) Bool (and (= (attr__tag2 temp___expr_316) us_tag3) (and (and (and (and (= (to_rep3 (rec__instr__child__accurate_clock__millisec (us_split_fields5 temp___expr_316))) 0) (= (rec__instr__instrument__name2 (us_split_fields5 temp___expr_316)) (temp___String_Literal_175 Tuple0))) (= (to_rep1 (rec__instr__clock__seconds1 (us_split_fields5 temp___expr_316))) 0)) (= (to_rep1 (rec__instr__clock__minutes1 (us_split_fields5 temp___expr_316))) 0)) (= (to_rep2 (rec__instr__clock__hours1 (us_split_fields5 temp___expr_316))) 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_307 Int) (temp___is_init_303 Bool) (temp___skip_constant_304 Bool) (temp___do_toplevel_305 Bool) (temp___do_typ_inv_306 Bool)) Bool (=> (or (= temp___is_init_303 true) (<= 0 1000)) (in_range4 temp___expr_307)))
(define-fun dynamic_invariant3 ((temp___expr_257 Int) (temp___is_init_253 Bool) (temp___skip_constant_254 Bool) (temp___do_toplevel_255 Bool) (temp___do_typ_inv_256 Bool)) Bool (=> (or (= temp___is_init_253 true) (<= 0 60)) (in_range2 temp___expr_257)))
(define-fun dynamic_invariant4 ((temp___expr_264 Int) (temp___is_init_260 Bool) (temp___skip_constant_261 Bool) (temp___do_toplevel_262 Bool) (temp___do_typ_inv_263 Bool)) Bool (=> (or (= temp___is_init_260 true) (<= 0 24)) (in_range3 temp___expr_264)))
(define-fun default_initial_assumption2 ((temp___expr_173 us_rep) (temp___skip_top_level_174 Bool)) Bool (and (= (attr__tag temp___expr_173) us_tag) (= (rec__instr__instrument__name (us_split_fields1 temp___expr_173)) (temp___String_Literal_175 Tuple0))))
(define-fun default_initial_assumption3 ((temp___expr_299 us_rep1) (temp___skip_top_level_300 Bool)) Bool (and (= (attr__tag1 temp___expr_299) us_tag2) (and (and (and (= (rec__instr__instrument__name1 (us_split_fields3 temp___expr_299)) (temp___String_Literal_175 Tuple0)) (= (to_rep1 (rec__instr__clock__seconds (us_split_fields3 temp___expr_299))) 0)) (= (to_rep1 (rec__instr__clock__minutes (us_split_fields3 temp___expr_299))) 0)) (= (to_rep2 (rec__instr__clock__hours (us_split_fields3 temp___expr_299))) 0))))
