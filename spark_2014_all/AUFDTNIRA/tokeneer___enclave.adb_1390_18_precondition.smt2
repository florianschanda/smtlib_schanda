...
(assert (=> (= result9 true) (and (= result10 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result10 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result9 true) (=> (= result10 true) (and (= o75 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o75)))))
(assert (=> (= result9 true) (=> (= result10 true) (= o76 (ite (= o75 3) true false)))))
(assert (=> (= result9 true) (=> (not (= result10 true)) (= o76 false))))
(assert (=> (not (= result9 true)) (= o76 (of_int 1))))
(assert (and (= o67 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields6)))) (and (in_range2 o67) (= o67 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields6)))))))
(assert (= result11 (ite (= o67 1) true false)))
(assert (=> (= result11 true) (and (= o69 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= o69 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6))))))))
(assert (=> (= result11 true) (= o70 (ite (not (= o69 true)) true false))))
(assert (=> (= result11 true) (and (= result12 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= result12 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6))))))))
(assert (=> (= result11 true) (=> (= result12 true) (and (= o68 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (in_range4 o68)))))
(assert (=> (= result11 true) (=> (= result12 true) (= o71 (ite (= o68 3) true false)))))
(assert (=> (= result11 true) (=> (not (= result12 true)) (= o71 false))))
(assert (=> (= result11 true) (= o72 (ite (= o71 false) o70 true))))
(assert (=> (not (= result11 true)) (= o72 (of_int 1))))
(assert (and (= result14 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= result14 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6)))))))
(assert (=> (= result14 true) (and (= o64 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (in_range4 o64))))
(assert (=> (= result14 true) (= result13 (ite (= o64 3) true false))))
(assert (=> (not (= result14 true)) (= result13 false)))
(assert (=> (= result13 true) (and (= o65 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields6)))) (and (in_range2 o65) (= o65 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields6))))))))
(assert (=> (= result13 true) (= o66 (ite (= o65 1) true false))))
(assert (=> (not (= result13 true)) (= o66 (of_int 1))))
(assert (and (= o56 (islocked (int__content currentlatch4) (us_private__content state38) (us_split_fields__content1 latchtimeout__split_fields7))) (= (= o56 true) (= (int__content currentlatch4) 0))))
(assert (= o57 (ite (not (= o56 true)) true false)))
(assert (= result15 (ite (= o57 true) (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result15 true) (and (= o60 (theauthcertrole (int__content tokenpresence3) (us_private__content state37) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content8 authcert__split_fields3) (us_split_fields__content11 idcert__split_fields3))) (and (in_range2 o60) (= o60 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields3))))))))
(assert (=> (= result15 true) (= o61 (ite (= o60 1) true false))))
(assert (=> (= result15 true) (and (= o58 (authcertvalid (int__content tokenpresence3) (us_private__content state37) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content8 authcert__split_fields3) (us_split_fields__content11 idcert__split_fields3))) (= (= o58 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields3)) true)))))
(assert (=> (= result15 true) (and (= o59 (isgood (int__content tokenpresence3) (us_private__content state37) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content8 authcert__split_fields3) (us_split_fields__content11 idcert__split_fields3))) (= (= o59 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields3)) true)))))
(assert (=> (= result15 true) (= o62 (ite (= o59 true) o58 false))))
(assert (=> (= result15 true) (= o63 (ite (= o62 true) o61 false))))
(assert (=> (not (= result15 true)) (= o63 (of_int 1))))
(assert (and (= o49 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields6)))) (and (in_range2 o49) (= o49 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields6)))))))
(assert (= result16 (ite (= o49 1) true false)))
(assert (=> (= result16 true) (and (= o52 (theauthcertrole (int__content tokenpresence3) (us_private__content state37) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content8 authcert__split_fields3) (us_split_fields__content11 idcert__split_fields3))) (and (in_range2 o52) (= o52 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields3))))))))
(assert (=> (= result16 true) (= o53 (ite (= o52 1) true false))))
(assert (=> (= result16 true) (and (= o50 (authcertvalid (int__content tokenpresence3) (us_private__content state37) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content8 authcert__split_fields3) (us_split_fields__content11 idcert__split_fields3))) (= (= o50 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields3)) true)))))
(assert (=> (= result16 true) (and (= o51 (isgood (int__content tokenpresence3) (us_private__content state37) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content8 authcert__split_fields3) (us_split_fields__content11 idcert__split_fields3))) (= (= o51 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields3)) true)))))
(assert (=> (= result16 true) (= o54 (ite (= o51 true) o50 false))))
(assert (=> (= result16 true) (= o55 (ite (= o54 true) o53 false))))
(assert (=> (not (= result16 true)) (= o55 (of_int 1))))
(assert (and (= o44 (thedooralarm (us_private__content state39))) (in_range6 o44)))
(assert (= o45 (ite (= o44 0) true false)))
(assert (= o46 (to_int1 o45)))
(assert (= o40 (alarm_timeout (us_private__content state39))))
(assert (and (= o39 (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime)) (= o39 (mk___rep1 (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3)))))
(assert (and (= o41 (greaterthanorequal o39 o40)) (= (= o41 true) (or (= (greaterthan o39 o40) true) (= (bool_eq1 o39 o40) true)))))
(assert (and (= o36 (thecurrentdoor (us_private__content state39))) (in_range27 o36)))
(assert (= o37 (ite (= o36 0) true false)))
(assert (and (= o38 (islocked (int__content currentlatch4) (us_private__content state38) (us_split_fields__content1 latchtimeout__split_fields7))) (= (= o38 true) (= (int__content currentlatch4) 0))))
(assert (= o42 (ite (= o38 true) o37 false)))
(assert (= o43 (ite (= o42 true) o41 false)))
(assert (= o47 (to_int1 o43)))
(assert (= o48 (ite (= o47 o46) true false)))
(assert (and (= result17 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= result17 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6)))))))
