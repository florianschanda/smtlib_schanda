...
(assert (= i2 0))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= temp___726 i2)))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= temp___725 total1)))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (and (and (and (=> (< 0 i3) (<= (to_rep2 (select counters 0)) total2)) (<= last_candidate 20)) (and (<= 0 i3) (<= i3 20))) (<= total2 (* i3 10000)))))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (and (and (=> (<= 0 210000) (in_range8 total2)) (=> (<= 0 last_candidate) (dynamic_property1 0 last_candidate i3))) (and (<= 0 i3) (<= i3 last_candidate)))))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (and (= o (+ total2 (to_rep2 (select counters i3)))) (in_range8 (+ total2 (to_rep2 (select counters i3)))))))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= total2 result2)))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= total3 o)))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= i3 last_candidate)))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= i3 i4)))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= total3 total4)))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= i5 i3)))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= total5 total3)))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= (mk_int__ref i6) (mk_int__ref i4))))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= (mk_int__ref total6) (mk_int__ref total4))))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= i7 i5)))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= total7 total5)))
(assert (=> (not (and (<= 0 i2) (<= i2 last_candidate))) (= i2 i6)))
(assert (=> (not (and (<= 0 i2) (<= i2 last_candidate))) (= total1 total6)))
(assert (=> (not (and (<= 0 i2) (<= i2 last_candidate))) (= i7 i2)))
(assert (=> (not (and (<= 0 i2) (<= i2 last_candidate))) (= total7 total1)))
(assert (and (= o1 (- total6 (to_rep2 (select counters 0)))) (in_range8 (- total6 (to_rep2 (select counters 0))))))
(assert (= result3 valid_total))
(assert (= valid_total1 o1))
(assert (= result4 i1))
(assert (= i8 0))
(assert (=> (and (<= 0 i8) (<= i8 last_candidate)) (and (<= 0 i9) (<= i9 last_candidate))))
(assert (=> (and (<= 0 i8) (<= i8 last_candidate)) (= i9 last_candidate)))
(assert (=> (and (<= 0 i8) (<= i8 last_candidate)) (= i9 i10)))
(assert (=> (and (<= 0 i8) (<= i8 last_candidate)) (= i11 i9)))
(assert (=> (and (<= 0 i8) (<= i8 last_candidate)) (= (mk_int__ref i12) (mk_int__ref i10))))
(assert (=> (and (<= 0 i8) (<= i8 last_candidate)) (= i13 i11)))
(assert (=> (not (and (<= 0 i8) (<= i8 last_candidate))) (= i8 i12)))
(assert (=> (not (and (<= 0 i8) (<= i8 last_candidate))) (= i13 i8)))
(assert (not (= program_phase 2)))
(check-sat)
(exit)
