...
(assert (= i2 0))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (and (and (= temp___720 i2) (and (= temp___719 total1) (and (and (and (and (=> (< 0 i3) (<= (to_rep2 (select counters 0)) total2)) (<= last_candidate 20)) (and (<= 0 i3) (<= i3 20))) (<= total2 (* i3 10000))) (and (and (and (=> (<= 0 210000) (in_range8 total2)) (=> (<= 0 last_candidate) (dynamic_property1 0 last_candidate i3))) (and (<= 0 i3) (<= i3 last_candidate))) (and (and (and (= o1 (+ total2 (to_rep2 (select counters i3)))) (in_range8 (+ total2 (to_rep2 (select counters i3))))) (and (= total2 result2) (= total3 o1))) (= i3 last_candidate)))))) (and (and (= i3 i7) (= total3 total6)) (and (= i8 i3) (= total7 total3))))))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= (mk_int__ref i9) (mk_int__ref i7))))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= (mk_int__ref total8) (mk_int__ref total6))))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= i10 i8)))
(assert (=> (and (<= 0 i2) (<= i2 last_candidate)) (= total9 total7)))
(assert (=> (not (and (<= 0 i2) (<= i2 last_candidate))) (= i2 i9)))
(assert (=> (not (and (<= 0 i2) (<= i2 last_candidate))) (= total1 total8)))
(assert (=> (not (and (<= 0 i2) (<= i2 last_candidate))) (= i10 i2)))
(assert (=> (not (and (<= 0 i2) (<= i2 last_candidate))) (= total9 total1)))
(assert (and (= o2 (- total8 (to_rep2 (select counters 0)))) (in_range8 (- total8 (to_rep2 (select counters 0))))))
(assert (= result4 valid_total))
(assert (= valid_total1 o2))
(assert (= result5 i1))
(assert (= i11 0))
(assert (=> (and (<= 0 i11) (<= i11 last_candidate)) (and (<= 0 i12) (<= i12 last_candidate))))
(assert (=> (and (<= 0 i11) (<= i11 last_candidate)) (= i12 last_candidate)))
(assert (=> (and (<= 0 i11) (<= i11 last_candidate)) (= i12 i13)))
(assert (=> (and (<= 0 i11) (<= i11 last_candidate)) (= i14 i12)))
(assert (=> (and (<= 0 i11) (<= i11 last_candidate)) (= (mk_int__ref i15) (mk_int__ref i13))))
(assert (=> (and (<= 0 i11) (<= i11 last_candidate)) (= i16 i14)))
(assert (=> (not (and (<= 0 i11) (<= i11 last_candidate))) (= i11 i15)))
(assert (=> (not (and (<= 0 i11) (<= i11 last_candidate))) (= i16 i11)))
