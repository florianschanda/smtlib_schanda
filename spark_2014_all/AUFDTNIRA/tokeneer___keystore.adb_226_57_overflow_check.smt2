...
(assert (<= 1 j1))
(assert (<= j1 r29b))
(assert (and (and (and (and (and (and (= loopmax1 (+ (div1 (- (to_rep3 (rec__certtypes__rawdatat__datalength (us_split_fields1 rawcertdata))) 1) 100) 1)) (and (<= 1 j2) (<= j2 loopmax1))) (= bytesleft2 (- (to_rep3 (rec__certtypes__rawdatat__datalength (us_split_fields1 rawcertdata))) (* (- j2 1) 100)))) (and (<= 1 (to_rep3 (rec__certtypes__rawdatat__datalength (us_split_fields1 rawcertdata)))) (<= (to_rep3 (rec__certtypes__rawdatat__datalength (us_split_fields1 rawcertdata))) 4096))) (and (<= 1 size2) (<= size2 100))) (= retvalini1 0)) (= retvalfin1 0)))
(assert (and (and (and (and (=> (<= 1 2147483647) (in_range2 bytesleft2)) (=> (<= 0 28) (in_range8 retvalupd2))) (=> (<= 0 4294967295) (in_range5 size2))) (=> (<= 1 r29b) (dynamic_property1 1 r29b j2))) (and (<= 1 j2) (<= j2 r29b))))
(assert (and (= o7 (* (- j2 1) 100)) (in_range1 (* (- j2 1) 100))))
(assert (= o8 (- (to_rep3 (rec__certtypes__rawdatat__datalength (us_split_fields1 rawcertdata))) o7)))
