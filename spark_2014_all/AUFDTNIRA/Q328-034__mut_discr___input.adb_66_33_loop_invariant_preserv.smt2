...
(define-fun dynamic_invariant1 ((temp___expr_577 Int) (temp___is_init_574 Bool) (temp___skip_constant_575 Bool) (temp___do_toplevel_576 Bool)) Bool (=> (or (= temp___is_init_574 true) (<= 1 1025)) (in_range3 temp___expr_577)))
...
(define-fun dynamic_invariant2 ((temp___expr_593 Int) (temp___is_init_590 Bool) (temp___skip_constant_591 Bool) (temp___do_toplevel_592 Bool)) Bool (=> (or (= temp___is_init_590 true) (<= 0 8192)) (in_range4 temp___expr_593)))
...
(assert (=> (not (= (to_rep (select line i2)) 9)) (and (= o1 (+ col2 1)) (in_range4 (+ col2 1)))))
(assert (=> (not (= (to_rep (select line i2)) 9)) (= result2 col2)))
(assert (=> (not (= (to_rep (select line i2)) 9)) (= col3 o1)))
(assert (=> (= (to_rep (select line i2)) 9) (and (= o2 (- (+ col2 8) (mod2 col2 8))) (in_range4 (- (+ col2 8) (mod2 col2 8))))))
(assert (=> (= (to_rep (select line i2)) 9) (= result3 col2)))
(assert (=> (= (to_rep (select line i2)) 9) (= col4 o2)))
(assert (=> (= (to_rep (select line i2)) 9) (= col3 col4)))
(assert (not (= i2 r2b)))
(assert (= result4 i2))
(assert (= i3 (+ i2 1)))
