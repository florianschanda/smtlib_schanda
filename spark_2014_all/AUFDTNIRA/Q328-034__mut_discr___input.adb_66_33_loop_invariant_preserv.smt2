...
(define-fun dynamic_invariant1 ((temp___expr_583 Int) (temp___is_init_580 Bool) (temp___skip_constant_581 Bool) (temp___do_toplevel_582 Bool)) Bool (=> (or (= temp___is_init_580 true) (<= 1 1025)) (in_range3 temp___expr_583)))
...
(define-fun dynamic_invariant2 ((temp___expr_599 Int) (temp___is_init_596 Bool) (temp___skip_constant_597 Bool) (temp___do_toplevel_598 Bool)) Bool (=> (or (= temp___is_init_596 true) (<= 0 8192)) (in_range4 temp___expr_599)))
