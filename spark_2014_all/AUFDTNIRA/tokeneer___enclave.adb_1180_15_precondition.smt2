...
(assert (=> (= result12 true) (and (= o69 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range7 o69))))
(assert (=> (= result12 true) (= result11 (ite (= o69 3) true false))))
(assert (=> (not (= result12 true)) (= result11 false)))
(assert (=> (= result11 true) (and (= o70 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range5 o70) (= o70 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= result11 true) (= o71 (ite (= o70 1) true false))))
(assert (=> (not (= result11 true)) (= o71 (of_int 1))))
(assert (and (= o61 (islocked (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6))) (= (= o61 true) (= (int__content currentlatch3) 0))))
(assert (= o62 (ite (not (= o61 true)) true false)))
(assert (= result13 (ite (= o62 true) (islocked currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result13 true) (and (= o65 (theauthcertrole (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content8 authcert__split_fields3) (us_split_fields__content11 idcert__split_fields3))) (and (in_range5 o65) (= o65 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields3))))))))
(assert (=> (= result13 true) (= o66 (ite (= o65 1) true false))))
(assert (=> (= result13 true) (and (= o63 (authcertvalid (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content8 authcert__split_fields3) (us_split_fields__content11 idcert__split_fields3))) (= (= o63 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields3)) true)))))
(assert (=> (= result13 true) (and (= o64 (isgood (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content8 authcert__split_fields3) (us_split_fields__content11 idcert__split_fields3))) (= (= o64 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields3)) true)))))
(assert (=> (= result13 true) (= o67 (ite (= o64 true) o63 false))))
(assert (=> (= result13 true) (= o68 (ite (= o67 true) o66 false))))
(assert (=> (not (= result13 true)) (= o68 (of_int 1))))
(assert (and (= o54 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range5 o54) (= o54 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result14 (ite (= o54 1) true false)))
(assert (=> (= result14 true) (and (= o57 (theauthcertrole (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content8 authcert__split_fields3) (us_split_fields__content11 idcert__split_fields3))) (and (in_range5 o57) (= o57 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields3))))))))
(assert (=> (= result14 true) (= o58 (ite (= o57 1) true false))))
(assert (=> (= result14 true) (and (= o55 (authcertvalid (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content8 authcert__split_fields3) (us_split_fields__content11 idcert__split_fields3))) (= (= o55 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields3)) true)))))
(assert (=> (= result14 true) (and (= o56 (isgood (int__content tokenpresence3) (us_private__content state22) (int__content tokentry3) (int__content tokenid3) (us_split_fields__content8 authcert__split_fields3) (us_split_fields__content11 idcert__split_fields3))) (= (= o56 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields3)) true)))))
(assert (=> (= result14 true) (= o59 (ite (= o56 true) o55 false))))
(assert (=> (= result14 true) (= o60 (ite (= o59 true) o58 false))))
(assert (=> (not (= result14 true)) (= o60 (of_int 1))))
(assert (and (= o49 (thedooralarm (us_private__content state24))) (in_range9 o49)))
(assert (= o50 (ite (= o49 0) true false)))
(assert (= o51 (to_int1 o50)))
(assert (= o45 (alarm_timeout (us_private__content state24))))
(assert (and (= o44 (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime)) (= o44 (mk___rep1 (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3)))))
(assert (and (= o46 (greaterthanorequal o44 o45)) (= (= o46 true) (or (= (greaterthan o44 o45) true) (= (bool_eq3 o44 o45) true)))))
(assert (and (= o41 (thecurrentdoor (us_private__content state24))) (in_range30 o41)))
(assert (= o42 (ite (= o41 0) true false)))
(assert (and (= o43 (islocked (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6))) (= (= o43 true) (= (int__content currentlatch3) 0))))
(assert (= o47 (ite (= o43 true) o42 false)))
(assert (= o48 (ite (= o47 true) o46 false)))
(assert (= o52 (to_int1 o48)))
(assert (= o53 (ite (= o52 o51) true false)))
(assert (and (= result15 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result15 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
