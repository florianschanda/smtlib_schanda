...
(assert (not (= (length temp___1902) 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 temp___1903))) (to_rep1 (last4 (rt2 temp___1903)))) (= o30 (+ (- (to_rep1 (last4 (rt2 temp___1903))) (to_rep1 (first4 (rt2 temp___1903)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 temp___1903))) (to_rep1 (last4 (rt2 temp___1903))))) (= o30 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1902))) (to_rep1 (last (rt temp___1902)))) (= o31 (+ (- (to_rep1 (last (rt temp___1902))) (to_rep1 (first (rt temp___1902)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1902))) (to_rep1 (last (rt temp___1902))))) (= o31 0)))
(assert (= o32 (+ o31 o30)))
(assert (= o33 (+ (to_rep1 (first (rt temp___1902))) o32)))
(assert (= o34 (- o33 1)))
