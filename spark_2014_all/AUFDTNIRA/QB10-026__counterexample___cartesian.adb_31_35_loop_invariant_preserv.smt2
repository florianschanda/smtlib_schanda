...
(assert (forall ((j Int)) (=> (and (<= (to_rep (first (rt array2))) j) (<= j index22)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) index11))))))
(assert (forall ((j Int)) (=> (and (<= (to_rep (first (rt array2))) j) (<= j index22)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j))))))
...
(assert (not (= index22 (to_rep (last (rt array2))))))
(assert (= index22 result6))
(assert (= index23 (+ index22 1)))
(assert (and (= o7 (+ result_index3 1)) (in_range1 (+ result_index3 1))))
(assert (= result_index3 result7))
(assert (= result_index4 o7))
(assert (and (<= (to_rep result____first) result_index4) (<= result_index4 (to_rep result____last))))
(assert (= o8 result_index4))
(assert (= o9 (store result__3 o8 (temp___265 (to_rep (select (elts array1) index11)) (to_rep (select (elts array2) index23))))))
(assert (= result8 result__3))
(assert (= result__4 o9))
(declare-const j Int)
(assert (<= (to_rep (first (rt array2))) j))
(assert (<= j index23))
(assert (not (= (to_rep (select (select result__4 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) index11)))))
(check-sat)
(exit)
