...
(assert (=> (= (int__content status3) 8) (and (= o18 (rolepresent (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (and (in_range9 o18) (= o18 (to_rep3 (rec__admin__t__rolepresent (us_split_fields__content1 theadmin__split_fields4))))))))
...
(assert (=> (= (int__content status3) 3) (and (= o12 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (and (in_range9 o12) (= o12 (to_rep3 theadmin__split_fields))))))
(assert (=> (= (int__content status3) 3) (and (= o13 (rolepresent (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (and (in_range9 o13) (= o13 (to_rep3 (rec__admin__t__rolepresent (us_split_fields__content1 theadmin__split_fields4))))))))
...
(assert (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7)) (and (= o6 (rolepresent (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (and (in_range9 o6) (= o6 (to_rep3 theadmin__split_fields))))))
(assert (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7)) (and (= o7 (rolepresent (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (and (in_range9 o7) (= o7 (to_rep3 (rec__admin__t__rolepresent (us_split_fields__content1 theadmin__split_fields4))))))))
(assert (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7)) (= o8 (ite (= o7 o6) true false))))
(assert (=> (=> (not (= (int__content status3) 6)) (= (int__content status3) 7)) (and (= o4 (ispresent (mk___rep1 (us_split_fields__content1 theadmin__split_fields4)))) (= (= o4 true) (in_range10 (to_rep3 (rec__admin__t__rolepresent (us_split_fields__content1 theadmin__split_fields4))))))))
