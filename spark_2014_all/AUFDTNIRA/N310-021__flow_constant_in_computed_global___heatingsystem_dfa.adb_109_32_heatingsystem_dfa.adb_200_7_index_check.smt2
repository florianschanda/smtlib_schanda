...
(declare-fun temp___311 (Int Int Int Int) (Array Int times))
(declare-fun temp___318 (Int Int Int Int) (Array Int displaydigits))
...
(assert (forall ((temp___313 Int) (temp___314 Int) (temp___315 Int) (temp___316 Int)) (let ((temp___312 (temp___311 temp___313 temp___314 temp___315 temp___316))) (=> (and (and (and (dynamic_invariant temp___313 true true true true) (dynamic_invariant temp___314 true true true true)) (dynamic_invariant temp___315 true true true true)) (dynamic_invariant temp___316 true true true true)) (and (and (and (= (to_rep (select temp___312 2)) temp___313) (= (to_rep (select temp___312 3)) temp___314)) (= (to_rep (select temp___312 4)) temp___315)) (= (to_rep (select temp___312 5)) temp___316))))))
...
(assert (forall ((temp___320 Int) (temp___321 Int) (temp___322 Int) (temp___323 Int)) (let ((temp___319 (temp___318 temp___320 temp___321 temp___322 temp___323))) (=> (and (and (and (dynamic_invariant6 temp___320 true true true true) (dynamic_invariant6 temp___321 true true true true)) (dynamic_invariant6 temp___322 true true true true)) (dynamic_invariant6 temp___323 true true true true)) (and (and (and (= (to_rep1 (select temp___319 0)) temp___320) (= (to_rep1 (select temp___319 1)) temp___321)) (= (to_rep1 (select temp___319 2)) temp___322)) (= (to_rep1 (select temp___319 3)) temp___323))))))
...
(assert (= onofftime1 (temp___311 0 0 0 0)))
