...
(declare-const c Int)
(declare-const j Int)
(declare-const arrays__count_even__result Int)
...
(declare-const arrays__count_even__result1 Int)
(declare-const arrays__count_even__result2 Int)
(declare-const arrays__count_even__result3 Int)
(declare-const c8 Int)
(declare-const j7 Int)
(declare-const arrays__count_even__result4 Int)
(declare-const c9 Int)
(declare-const j8 Int)
(declare-const arrays__count_even__result5 Int)
...
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= temp___169 c1)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (and (=> (<= 0 2147483647) (in_range2 c2)) (and (<= (to_rep1 (first (rt x))) j2) (<= j2 (to_rep1 (last (rt x))))))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (=> (= (mod2 (to_rep (select (elts x) j2)) 2) 0) (and (= o (+ c2 1)) (in_range1 (+ c2 1))))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (=> (= (mod2 (to_rep (select (elts x) j2)) 2) 0) (= c2 result2))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (=> (= (mod2 (to_rep (select (elts x) j2)) 2) 0) (= c3 o))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (=> (not (= (mod2 (to_rep (select (elts x) j2)) 2) 0)) (= c3 c2))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= j2 (to_rep1 (last (rt x))))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= j2 j3)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= c3 c4)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= j4 j2)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= c5 c3)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= (mk_int__ref j5) (mk_int__ref j3))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= (mk_int__ref c6) (mk_int__ref c4))))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= j6 j4)))
(assert (=> (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x))))) (= c7 c5)))
(assert (=> (not (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))) (= j1 j5)))
(assert (=> (not (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))) (= c1 c6)))
(assert (=> (not (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))) (= j6 j1)))
(assert (=> (not (and (<= (to_rep1 (first (rt x))) j1) (<= j1 (to_rep1 (last (rt x)))))) (= c7 c1)))
...
(assert (= (mk_int__ref arrays__count_even__result4) (mk_int__ref arrays__count_even__result2)))
(assert (= (mk_int__ref j7) (mk_int__ref j5)))
(assert (= (mk_int__ref c8) (mk_int__ref c6)))
(assert (= arrays__count_even__result5 arrays__count_even__result3))
(assert (= j8 j6))
(assert (= c9 c7))
(assert (not (in_range1 (length x))))
(check-sat)
(exit)
