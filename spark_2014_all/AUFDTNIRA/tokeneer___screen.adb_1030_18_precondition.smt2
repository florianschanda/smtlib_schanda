...
(assert (forall ((temp___1154 Int)) (forall ((temp___1155 Int)) (= (select (temp___1152 temp___1154) temp___1155) (of_rep2 temp___1154)))))
(declare-fun temp___1156 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1158 Int)) (forall ((temp___1159 Int)) (= (select (temp___1156 temp___1158) temp___1159) (of_rep5 temp___1158)))))
(define-fun dynamic_invariant1 ((temp___expr_1146 us_rep1) (temp___is_init_1143 Bool) (temp___skip_constant_1144 Bool) (temp___do_toplevel_1145 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1146))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1146))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1146)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1146))) true))
(define-fun default_initial_assumption ((temp___expr_1150 us_rep1) (temp___skip_top_level_1151 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1150))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1150))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1150)) (mk___rep (mk___split_fields (temp___1152 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1150)) (temp___1156 0))))
(define-fun type_invariant ((temp___1160 us_rep1)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1160))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1160))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1160)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1160))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_1464 Int) (temp___is_init_1461 Bool) (temp___skip_constant_1462 Bool) (temp___do_toplevel_1463 Bool)) Bool (=> (or (= temp___is_init_1461 true) (<= 0 14)) (in_range14 temp___expr_1464)))
...
(declare-fun temp___String_Literal_1732 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1732 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 2)) 99)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 6)) 110)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 8)) 85)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 9)) 112)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 10)) 100)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 11)) 97)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 12)) 116)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 13)) 101)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 15)) 70)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 16)) 97)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 17)) 105)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 18)) 108)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 19)) 117)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1732 us_void_param) 21)) 101)) :pattern ((temp___String_Literal_1732 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1417 Int) (temp___is_init_1414 Bool) (temp___skip_constant_1415 Bool) (temp___do_toplevel_1416 Bool)) Bool (=> (or (= temp___is_init_1414 true) (<= 0 4)) (in_range12 temp___expr_1417)))
(define-fun dynamic_invariant8 ((temp___expr_1042 Int) (temp___is_init_1039 Bool) (temp___skip_constant_1040 Bool) (temp___do_toplevel_1041 Bool)) Bool (=> (or (= temp___is_init_1039 true) (<= 0 3)) (in_range11 temp___expr_1042)))
(define-fun dynamic_invariant9 ((temp___expr_1048 Int) (temp___is_init_1045 Bool) (temp___skip_constant_1046 Bool) (temp___do_toplevel_1047 Bool)) Bool (=> (or (= temp___is_init_1045 true) (<= 1 3)) (in_range13 temp___expr_1048)))
(define-fun dynamic_invariant10 ((temp___expr_1054 Int) (temp___is_init_1051 Bool) (temp___skip_constant_1052 Bool) (temp___do_toplevel_1053 Bool)) Bool (=> (or (= temp___is_init_1051 true) (<= 0 5)) (in_range18 temp___expr_1054)))
(define-fun dynamic_invariant11 ((temp___expr_1112 Int) (temp___is_init_1109 Bool) (temp___skip_constant_1110 Bool) (temp___do_toplevel_1111 Bool)) Bool (=> (or (= temp___is_init_1109 true) (<= 0 17)) (in_range7 temp___expr_1112)))
(define-fun dynamic_invariant12 ((temp___expr_1091 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 1 17)) (in_range5 temp___expr_1091)))
(define-fun dynamic_invariant13 ((temp___expr_1216 Int) (temp___is_init_1213 Bool) (temp___skip_constant_1214 Bool) (temp___do_toplevel_1215 Bool)) Bool (=> (or (= temp___is_init_1213 true) (<= 0 2)) (in_range9 temp___expr_1216)))
(define-fun dynamic_invariant14 ((temp___expr_1097 Int) (temp___is_init_1094 Bool) (temp___skip_constant_1095 Bool) (temp___do_toplevel_1096 Bool)) Bool (=> (or (= temp___is_init_1094 true) (<= 0 17408)) (in_range6 temp___expr_1097)))
(define-fun dynamic_invariant15 ((temp___expr_1131 Int) (temp___is_init_1128 Bool) (temp___skip_constant_1129 Bool) (temp___do_toplevel_1130 Bool)) Bool (=> (or (= temp___is_init_1128 true) (<= 0 1024)) (in_range8 temp___expr_1131)))
(assert true)
...
(define-fun dynamic_invariant16 ((temp___expr_464 Int) (temp___is_init_461 Bool) (temp___skip_constant_462 Bool) (temp___do_toplevel_463 Bool)) Bool (=> (or (= temp___is_init_461 true) (<= 0 4194304)) (in_range15 temp___expr_464)))
(define-fun dynamic_invariant17 ((temp___expr_510 Int) (temp___is_init_507 Bool) (temp___skip_constant_508 Bool) (temp___do_toplevel_509 Bool)) Bool (=> (or (= temp___is_init_507 true) (<= 0 864000)) (in_range16 temp___expr_510)))
(define-fun dynamic_invariant18 ((temp___expr_1081 Int) (temp___is_init_1078 Bool) (temp___skip_constant_1079 Bool) (temp___do_toplevel_1080 Bool)) Bool (=> (or (= temp___is_init_1078 true) (<= 0 1)) (in_range19 temp___expr_1081)))
(define-fun dynamic_invariant19 ((temp___expr_974 Int) (temp___is_init_971 Bool) (temp___skip_constant_972 Bool) (temp___do_toplevel_973 Bool)) Bool (=> (or (= temp___is_init_971 true) (<= 0 2147483647)) (in_range17 temp___expr_974)))
(define-fun dynamic_invariant20 ((temp___expr_1364 Int) (temp___is_init_1361 Bool) (temp___skip_constant_1362 Bool) (temp___do_toplevel_1363 Bool)) Bool (=> (or (= temp___is_init_1361 true) (<= 0 2147483647)) (in_range10 temp___expr_1364)))
...
(assert (=> (= (let ((subject shoulddisplaystats)) shoulddisplaystats1) true) (=> (= currentstats__split_fields true) (= (let ((subject output)) (mk___private__ref output2)) (let ((subject output)) (mk___private__ref output1))))))
(assert (=> (= (let ((subject shoulddisplaystats)) shoulddisplaystats1) true) (=> (= currentstats__split_fields true) (= (let ((subject writeok)) (mk_bool__ref writeok3)) (let ((subject writeok)) (mk_bool__ref writeok2))))))
(assert (=> (= (let ((subject shoulddisplaystats)) shoulddisplaystats1) true) (=> (= currentstats__split_fields true) (= screenok3 screenok2))))
(assert (=> (= (let ((subject shoulddisplaystats)) shoulddisplaystats1) true) (=> (= currentstats__split_fields true) (= output2 output1))))
(assert (=> (= (let ((subject shoulddisplaystats)) shoulddisplaystats1) true) (=> (= currentstats__split_fields true) (= writeok3 writeok2))))
(assert (=> (= (let ((subject shoulddisplaystats)) shoulddisplaystats1) true) (=> (= currentstats__split_fields true) (= screenok3 screenok2))))
...
(assert (=> (= (let ((subject shoulddisplayconfig)) shoulddisplayconfig1) true) (=> (= currentconfig__split_fields true) (= (let ((subject output)) (mk___private__ref output5)) (let ((subject output)) (mk___private__ref output3))))))
(assert (=> (= (let ((subject shoulddisplayconfig)) shoulddisplayconfig1) true) (=> (= currentconfig__split_fields true) (= (let ((subject writeok)) (mk_bool__ref writeok6)) (let ((subject writeok)) (mk_bool__ref writeok4))))))
(assert (=> (= (let ((subject shoulddisplayconfig)) shoulddisplayconfig1) true) (=> (= currentconfig__split_fields true) (= screenok6 screenok4))))
(assert (=> (= (let ((subject shoulddisplayconfig)) shoulddisplayconfig1) true) (=> (= currentconfig__split_fields true) (= output5 output3))))
(assert (=> (= (let ((subject shoulddisplayconfig)) shoulddisplayconfig1) true) (=> (= currentconfig__split_fields true) (= writeok6 writeok4))))
(assert (=> (= (let ((subject shoulddisplayconfig)) shoulddisplayconfig1) true) (=> (= currentconfig__split_fields true) (= screenok6 screenok4))))
