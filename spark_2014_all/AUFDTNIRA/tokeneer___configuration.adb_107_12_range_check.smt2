...
(assert (not (= (length temp___1936) 0)))
(assert (=> (<= (to_rep1 (first2 temp___19371)) (to_rep1 (last2 temp___19371))) (= o90 (+ (- (to_rep1 (last2 temp___19371)) (to_rep1 (first2 temp___19371))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___19371)) (to_rep1 (last2 temp___19371)))) (= o90 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1936))) (to_rep1 (last (rt temp___1936)))) (= o91 (+ (- (to_rep1 (last (rt temp___1936))) (to_rep1 (first (rt temp___1936)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1936))) (to_rep1 (last (rt temp___1936))))) (= o91 0)))
(assert (= o92 (+ o91 o90)))
(assert (= o93 (+ (to_rep1 (first (rt temp___1936))) o92)))
(assert (= o94 (- o93 1)))
