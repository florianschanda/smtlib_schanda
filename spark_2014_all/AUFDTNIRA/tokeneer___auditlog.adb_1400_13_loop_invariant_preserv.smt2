...
(assert (and (= o (- (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) 1)) (in_range6 (- (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) 1))))
(assert (= (to_rep2 o1) o))
...
(assert (= temp___1688 o10))
(assert (= temp___16881 o11))
(assert (= temp___16882 o12))
(assert (= temp___16883 o13))
(assert (= temp___16884 o14))
(assert (= temp___16885 o15))
(assert (= temp___16886 o16))
(assert (= result1 (mk___split_fields__ref1 logfilestate__split_fields8)))
(assert (= logfilestate__split_fields9 (mk___split_fields1 temp___1688 temp___16881 (mk___rep (mk___split_fields temp___16882 temp___16883 temp___16884 temp___16885)) temp___16886)))
(assert (and (= o17 (nextlistindex (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9)))))) (and (in_range7 o17) (= o17 (ite (= (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9)))) 17) 1 (+ (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9)))) 1))))))
...
(assert (= temp___1691 (mk___rep1 o21)))
(assert (= result2 (mk___split_fields__ref1 logfilestate__split_fields9)))
(assert (= logfilestate__split_fields10 (us_split_fields3 temp___1691)))
(assert (and (= o22 (- (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) 1024)) (in_range9 (- (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) 1024))))
...
(assert (= temp___1693 (mk___rep1 o24)))
(assert (= result3 (mk___split_fields__ref1 logfilestate__split_fields10)))
(assert (= logfilestate__split_fields11 (us_split_fields3 temp___1693)))
(assert (< 1 (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11))))))
(assert (= (to_rep6 (select logfilesstatus2 (to_rep3 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11))) (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11)))))))) 1))
(assert (not (< 1 (to_rep2 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11)))))))
(check-sat)
(exit)
