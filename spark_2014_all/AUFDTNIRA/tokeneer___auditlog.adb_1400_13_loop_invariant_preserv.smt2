...
(assert (and (= o5 (- (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9)))) 1)) (in_range9 (- (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9)))) 1))))
(assert (= (to_rep4 o6) o5))
(assert (= (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9))) o7))
(assert (= (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9))) o8))
(assert (= (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9))) o9))
(assert (= o6 o10))
(assert (= o11 o7))
(assert (= o12 o8))
(assert (= o13 o9))
(assert (= o14 o10))
(assert (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9) o15))
(assert (= (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9) o16))
(assert (= o17 o11))
(assert (= o18 o12))
(assert (= o19 o13))
(assert (= o20 o14))
(assert (= (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9) o21))
(assert (= temp___1478 o15))
(assert (= temp___14781 o16))
(assert (= temp___14782 o17))
(assert (= temp___14783 o18))
(assert (= temp___14784 o19))
(assert (= temp___14785 o20))
(assert (= temp___14786 o21))
(assert (= result1 (mk___split_fields__ref1 logfilestate__split_fields9)))
(assert (= logfilestate__split_fields10 (mk___split_fields1 temp___1478 temp___14781 (mk___rep (mk___split_fields temp___14782 temp___14783 temp___14784 temp___14785)) temp___14786)))
(assert (and (= o22 (nextlistindex (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))))) (and (in_range6 o22) (= o22 (ite (= (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))) 17) 1 (+ (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10)))) 1))))))
(assert (= (to_rep2 o23) o22))
(assert (= o24 (mk___split_fields (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10))) o23 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10))) (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10))))))
(assert (= o25 (mk___rep o24)))
(assert (= o26 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10) o25 (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10))))
(assert (= temp___1481 (mk___rep1 o26)))
(assert (= result2 (mk___split_fields__ref1 logfilestate__split_fields10)))
(assert (= logfilestate__split_fields11 (us_split_fields3 temp___1481)))
(assert (and (= o27 (- (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) 1024)) (in_range8 (- (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) 1024))))
(assert (= (to_rep3 o28) o27))
(assert (= o29 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11) o28 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11))))
(assert (= temp___1483 (mk___rep1 o29)))
(assert (= result3 (mk___split_fields__ref1 logfilestate__split_fields11)))
(assert (= logfilestate__split_fields12 (us_split_fields3 temp___1483)))
(assert (< 1 (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12))))))
(assert (= (to_rep6 (select logfilesstatus3 (to_rep2 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12))) (to_rep2 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12)))))))) 1))
(assert (not (< 1 (to_rep4 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12)))))))
(check-sat)
(exit)
