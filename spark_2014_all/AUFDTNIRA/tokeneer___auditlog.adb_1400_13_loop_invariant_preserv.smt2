...
(assert (= temp___1534 o15))
(assert (= temp___15341 o16))
(assert (= temp___15342 o17))
(assert (= temp___15343 o18))
(assert (= temp___15344 o19))
(assert (= temp___15345 o20))
(assert (= temp___15346 o21))
(assert (= result1 (mk___split_fields__ref1 logfilestate__split_fields9)))
(assert (= logfilestate__split_fields10 (mk___split_fields1 temp___1534 temp___15341 (mk___rep (mk___split_fields temp___15342 temp___15343 temp___15344 temp___15345)) temp___15346)))
...
(assert (= temp___1537 (mk___rep1 o26)))
(assert (= result2 (mk___split_fields__ref1 logfilestate__split_fields10)))
(assert (= logfilestate__split_fields11 (us_split_fields3 temp___1537)))
...
(assert (= temp___1539 (mk___rep1 o29)))
(assert (= result3 (mk___split_fields__ref1 logfilestate__split_fields11)))
(assert (= logfilestate__split_fields12 (us_split_fields3 temp___1539)))
