...
(define-fun dynamic_invariant ((temp___expr_483 Int) (temp___is_init_480 Bool) (temp___skip_constant_481 Bool) (temp___do_toplevel_482 Bool)) Bool (=> (or (= temp___is_init_480 true) (<= 0 43)) (in_range temp___expr_483)))
...
(define-fun dynamic_invariant1 ((temp___expr_493 Int) (temp___is_init_490 Bool) (temp___skip_constant_491 Bool) (temp___do_toplevel_492 Bool)) Bool (=> (or (= temp___is_init_490 true) (<= 0 2)) (in_range1 temp___expr_493)))
...
(define-fun dynamic_invariant3 ((temp___expr_1093 Int) (temp___is_init_1090 Bool) (temp___skip_constant_1091 Bool) (temp___do_toplevel_1092 Bool)) Bool (=> (or (= temp___is_init_1090 true) (<= 0 17)) (in_range5 temp___expr_1093)))
(define-fun dynamic_invariant4 ((temp___expr_1072 Int) (temp___is_init_1069 Bool) (temp___skip_constant_1070 Bool) (temp___do_toplevel_1071 Bool)) Bool (=> (or (= temp___is_init_1069 true) (<= 1 17)) (in_range3 temp___expr_1072)))
(define-fun dynamic_invariant5 ((temp___expr_1078 Int) (temp___is_init_1075 Bool) (temp___skip_constant_1076 Bool) (temp___do_toplevel_1077 Bool)) Bool (=> (or (= temp___is_init_1075 true) (<= 0 17408)) (in_range4 temp___expr_1078)))
(define-fun dynamic_invariant6 ((temp___expr_1112 Int) (temp___is_init_1109 Bool) (temp___skip_constant_1110 Bool) (temp___do_toplevel_1111 Bool)) Bool (=> (or (= temp___is_init_1109 true) (<= 0 1024)) (in_range6 temp___expr_1112)))
(assert true)
...
(declare-const temp___1669 logfileindext)
(declare-const temp___16691 logentrycountt)
(declare-const temp___16692 (Array Int logfileindext))
(declare-const temp___16693 logfileindext)
(declare-const temp___16694 logfileindext)
(declare-const temp___16695 logfilecountt)
(declare-const temp___16696 (Array Int fileentrycountt))
