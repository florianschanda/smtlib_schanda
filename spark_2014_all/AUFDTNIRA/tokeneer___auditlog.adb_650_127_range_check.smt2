...
(define-fun dynamic_invariant ((temp___expr_538 Int) (temp___is_init_534 Bool) (temp___skip_constant_535 Bool) (temp___do_toplevel_536 Bool) (temp___do_typ_inv_537 Bool)) Bool (=> (or (= temp___is_init_534 true) (<= 0 43)) (in_range temp___expr_538)))
...
(define-fun dynamic_invariant1 ((temp___expr_549 Int) (temp___is_init_545 Bool) (temp___skip_constant_546 Bool) (temp___do_toplevel_547 Bool) (temp___do_typ_inv_548 Bool)) Bool (=> (or (= temp___is_init_545 true) (<= 0 2)) (in_range1 temp___expr_549)))
...
(define-fun default_initial_assumption ((temp___expr_1269 us_rep2) (temp___skip_top_level_1270 Bool)) Bool (and (and (and (= (to_rep1 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1269))) 1) (= (to_rep2 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1269))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1269)) (mk___rep (mk___split_fields (temp___1271 1) (of_rep1 1) (of_rep1 1) (of_rep3 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1269)) (temp___1275 0))))
...
(define-fun dynamic_invariant3 ((temp___expr_1204 Int) (temp___is_init_1200 Bool) (temp___skip_constant_1201 Bool) (temp___do_toplevel_1202 Bool) (temp___do_typ_inv_1203 Bool)) Bool (=> (or (= temp___is_init_1200 true) (<= 0 17)) (in_range5 temp___expr_1204)))
(define-fun dynamic_invariant4 ((temp___expr_1211 Int) (temp___is_init_1207 Bool) (temp___skip_constant_1208 Bool) (temp___do_toplevel_1209 Bool) (temp___do_typ_inv_1210 Bool)) Bool (=> (or (= temp___is_init_1207 true) (<= 1 17)) (in_range3 temp___expr_1211)))
(define-fun dynamic_invariant5 ((temp___expr_1218 Int) (temp___is_init_1214 Bool) (temp___skip_constant_1215 Bool) (temp___do_toplevel_1216 Bool) (temp___do_typ_inv_1217 Bool)) Bool (=> (or (= temp___is_init_1214 true) (<= 0 17408)) (in_range4 temp___expr_1218)))
(define-fun dynamic_invariant6 ((temp___expr_1249 Int) (temp___is_init_1245 Bool) (temp___skip_constant_1246 Bool) (temp___do_toplevel_1247 Bool) (temp___do_typ_inv_1248 Bool)) Bool (=> (or (= temp___is_init_1245 true) (<= 0 1024)) (in_range6 temp___expr_1249)))
(assert true)
...
(assert (forall ((temp___1273 Int)) (=> (dynamic_invariant4 temp___1273 true true true true) (forall ((temp___1274 Int)) (= (to_rep1 (select (temp___1271 temp___1273) temp___1274)) temp___1273)))))
