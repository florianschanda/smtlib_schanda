...
(define-fun in_range ((x Int)) Bool (and (<= 0 x) (<= x 43)))
...
(define-fun dynamic_invariant ((temp___expr_439 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 43)) (in_range temp___expr_439)))
...
(define-fun dynamic_invariant1 ((temp___expr_449 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 2)) (in_range1 temp___expr_449)))
...
(assert (forall ((x logfileindext)) (! (in_range3 (to_rep1 x)) :pattern ((to_rep1 x)))))
(assert (forall ((x Int)) (! (=> (in_range3 x) (= (to_rep1 (of_rep1 x)) x)) :pattern ((to_rep1 (of_rep1 x))))))
(declare-sort logentrycountt 0)
(define-fun in_range4 ((x Int)) Bool (and (<= 0 x) (<= x 17408)))
...
(assert (forall ((x logentrycountt)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(declare-fun user_eq6 ((Array Int logfileindext) (Array Int logfileindext)) Bool)
...
(assert (forall ((x logfilecountt)) (! (in_range5 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x fileentrycountt)) (! (in_range6 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_1037 Int) (temp___is_init_1034 Bool) (temp___skip_constant_1035 Bool) (temp___do_toplevel_1036 Bool)) Bool (=> (or (= temp___is_init_1034 true) (<= 0 17)) (in_range5 temp___expr_1037)))
(define-fun dynamic_invariant4 ((temp___expr_1016 Int) (temp___is_init_1013 Bool) (temp___skip_constant_1014 Bool) (temp___do_toplevel_1015 Bool)) Bool (=> (or (= temp___is_init_1013 true) (<= 1 17)) (in_range3 temp___expr_1016)))
(define-fun dynamic_invariant5 ((temp___expr_1022 Int) (temp___is_init_1019 Bool) (temp___skip_constant_1020 Bool) (temp___do_toplevel_1021 Bool)) Bool (=> (or (= temp___is_init_1019 true) (<= 0 17408)) (in_range4 temp___expr_1022)))
(define-fun dynamic_invariant6 ((temp___expr_1056 Int) (temp___is_init_1053 Bool) (temp___skip_constant_1054 Bool) (temp___do_toplevel_1055 Bool)) Bool (=> (or (= temp___is_init_1053 true) (<= 0 1024)) (in_range6 temp___expr_1056)))
(assert true)
...
(declare-const o Int)
(declare-const o1 fileentrycountt)
(declare-const o2 (Array Int fileentrycountt))
(declare-const o3 logfileindext)
(declare-const o4 logentrycountt)
(declare-const o5 (Array Int logfileindext))
(declare-const o6 logfileindext)
(declare-const o7 logfileindext)
(declare-const o8 logfilecountt)
(declare-const o9 (Array Int fileentrycountt))
(declare-const temp___1613 logfileindext)
(declare-const temp___16131 logentrycountt)
(declare-const temp___16132 (Array Int logfileindext))
(declare-const temp___16133 logfileindext)
(declare-const temp___16134 logfileindext)
(declare-const temp___16135 logfilecountt)
(declare-const temp___16136 (Array Int fileentrycountt))
...
(declare-const result3 logentrycountt)
(declare-const result4 (Array Int logfileindext))
(declare-const result5 logfileindext)
(declare-const result6 logfileindext)
(declare-const result7 logfilecountt)
(declare-const result8 (Array Int fileentrycountt))
...
(assert (in_range elementid))
(assert (in_range1 severity))
(assert (< (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1024))
(assert (= (mk_t__ref result) (mk_t__ref thefile)))
(assert (= thefile1 (select logfiles (to_rep1 logfilestate__split_fields))))
(assert (= (mk_map__ref3 result1) (mk_map__ref3 logfiles)))
(assert (= logfiles1 (store logfiles (to_rep1 logfilestate__split_fields) thefile2)))
(assert (not (in_range6 (+ (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))) 1))))
(check-sat)
(exit)
