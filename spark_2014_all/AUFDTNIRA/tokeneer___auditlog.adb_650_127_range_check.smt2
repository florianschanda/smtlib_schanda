...
(declare-fun user_eq2 (elementt elementt) Bool)
(declare-const dummy2 elementt)
...
(declare-fun user_eq3 (severityt severityt) Bool)
(declare-const dummy3 severityt)
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep1 (select a temp___idx_172)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(define-fun dynamic_invariant3 ((temp___expr_1197 Int) (temp___is_init_1193 Bool) (temp___skip_constant_1194 Bool) (temp___do_toplevel_1195 Bool) (temp___do_typ_inv_1196 Bool)) Bool (=> (or (= temp___is_init_1193 true) (<= 0 17)) (in_range5 temp___expr_1197)))
(define-fun dynamic_invariant4 ((temp___expr_1204 Int) (temp___is_init_1200 Bool) (temp___skip_constant_1201 Bool) (temp___do_toplevel_1202 Bool) (temp___do_typ_inv_1203 Bool)) Bool (=> (or (= temp___is_init_1200 true) (<= 1 17)) (in_range3 temp___expr_1204)))
(define-fun dynamic_invariant5 ((temp___expr_1211 Int) (temp___is_init_1207 Bool) (temp___skip_constant_1208 Bool) (temp___do_toplevel_1209 Bool) (temp___do_typ_inv_1210 Bool)) Bool (=> (or (= temp___is_init_1207 true) (<= 0 17408)) (in_range4 temp___expr_1211)))
(define-fun dynamic_invariant6 ((temp___expr_1242 Int) (temp___is_init_1238 Bool) (temp___skip_constant_1239 Bool) (temp___do_toplevel_1240 Bool) (temp___do_typ_inv_1241 Bool)) Bool (=> (or (= temp___is_init_1238 true) (<= 0 1024)) (in_range6 temp___expr_1242)))
(assert true)
...
(declare-const logfilestate__split_fields1 (Array Int fileentrycountt))
...
(assert (< (to_rep4 (select logfilestate__split_fields1 (to_rep1 logfilestate__split_fields))) 1024))
...
(assert (not (in_range6 (+ (to_rep4 (select logfilestate__split_fields1 (to_rep1 logfilestate__split_fields))) 1))))
(check-sat)
(exit)
