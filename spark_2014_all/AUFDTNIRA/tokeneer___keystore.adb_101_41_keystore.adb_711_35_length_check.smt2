...
(assert (=> (<= 1 temp___1637) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1637) (<= temp___1637 150)))))
(assert (= o7 result__1))
(assert (= o7 temp___1638))
(assert (= (mk1 1 temp___1637) temp___16381))
(assert (not (= (ite (<= (to_rep1 (first2 temp___16351)) (to_rep1 (last2 temp___16351))) (+ (- (to_rep1 (last2 temp___16351)) (to_rep1 (first2 temp___16351))) 1) 0) (ite (<= (to_rep1 (first2 temp___16381)) (to_rep1 (last2 temp___16381))) (+ (- (to_rep1 (last2 temp___16381)) (to_rep1 (first2 temp___16381))) 1) 0))))
(check-sat)
(exit)
