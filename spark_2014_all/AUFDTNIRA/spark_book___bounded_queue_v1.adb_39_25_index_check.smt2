...
(assert (not (<= (to_rep3 (first (rt (rec__bounded_queue_v1__queue_type__items queue__split_fields5)))) (to_rep1 (rec__bounded_queue_v1__queue_type__rear queue__split_fields5)))))
(check-sat)
(exit)
