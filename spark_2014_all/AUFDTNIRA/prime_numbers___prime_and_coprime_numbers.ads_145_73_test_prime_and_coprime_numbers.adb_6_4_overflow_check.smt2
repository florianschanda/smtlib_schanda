...
(assert (and (= o (nearest_number is_prime1 mode value)) (and (in_range2 o) (and (and (and (<= 0 o) (<= o 100000)) (= (select is_prime1 o) true)) (ite (= (= (ite (select is_prime1 value) 1 0) (ite (distinct 1 0) 1 0)) true) (= o value) (ite (= (ite (= (= (ite (select is_prime1 value) 1 0) (ite (distinct 0 0) 1 0)) true) (= mode 0) false) true) (and (< value o) (forall ((v Int)) (=> (and (<= value v) (<= v (- o 1))) (not (= (select is_prime1 v) true))))) (ite (= (ite (= (= (ite (select is_prime1 value) 1 0) (ite (distinct 0 0) 1 0)) true) (= mode 1) false) true) (and (< o value) (forall ((v Int)) (=> (and (<= (+ o 1) v) (<= v value)) (not (= (select is_prime1 v) true))))) (=> (= (ite (= (= (ite (select is_prime1 value) 1 0) (ite (distinct 0 0) 1 0)) true) (= mode 2) false) true) (and (forall ((v Int)) (=> (and (<= (ite (< 0 (+ (- value (abs (- value o))) 1)) (+ (- value (abs (- value o))) 1) 0) v) (<= v value)) (not (= (select is_prime1 v) true)))) (forall ((v Int)) (=> (and (<= value v) (<= v (ite (< 100000 (- (+ value (abs (- value o))) 1)) 100000 (- (+ value (abs (- value o))) 1)))) (not (= (select is_prime1 v) true)))))))))))))
