...
(assert (and (= o (nearest_number is_prime1 mode value)) (and (in_range2 o) (and (and (and (<= 0 o) (<= o 100000)) (= (select is_prime1 o) true)) (ite (= (= (to_int1 (select is_prime1 value)) (to_int1 (of_int 1))) true) (= o value) (ite (= (ite (= (= (to_int1 (select is_prime1 value)) (to_int1 (of_int 0))) true) (= mode 0) false) true) (and (< value o) (forall ((v Int)) (=> (and (<= value v) (<= v (- o 1))) (not (= (select is_prime1 v) true))))) (ite (= (ite (= (= (to_int1 (select is_prime1 value)) (to_int1 (of_int 0))) true) (= mode 1) false) true) (and (< o value) (forall ((v Int)) (=> (and (<= (+ o 1) v) (<= v value)) (not (= (select is_prime1 v) true))))) (=> (= (ite (= (= (to_int1 (select is_prime1 value)) (to_int1 (of_int 0))) true) (= mode 2) false) true) (and (forall ((v Int)) (=> (and (<= (ite (< 0 (+ (- value (abs (- value o))) 1)) (+ (- value (abs (- value o))) 1) 0) v) (<= v value)) (not (= (select is_prime1 v) true)))) (forall ((v Int)) (=> (and (<= value v) (<= v (ite (< 100000 (- (+ value (abs (- value o))) 1)) 100000 (- (+ value (abs (- value o))) 1)))) (not (= (select is_prime1 v) true)))))))))))))
...
(assert (=> (= (ite (= (is_prime value) false) (= mode 0) false) true) (and (< value test_prime_and_coprime_numbers__p__nearest_prime_number__result4) (forall ((v Int)) (=> (and (<= value v) (<= v (- test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1))) (not (= (is_prime v) true)))))))
(assert (=> (= (ite (= (is_prime value) false) (= mode 1) false) true) (and (< test_prime_and_coprime_numbers__p__nearest_prime_number__result4 value) (forall ((v Int)) (=> (and (<= (+ test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1) v) (<= v value)) (not (= (is_prime v) true)))))))
