...
(define-fun dynamic_invariant ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 2147483647)) (in_range2 temp___expr_178)))
...
(define-fun dynamic_invariant1 ((temp___expr_193 Int) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool)) Bool (=> (or (= temp___is_init_190 true) (<= 0 2)) (in_range3 temp___expr_193)))
...
(assert (and (= o (nearest_number is_prime1 mode value)) (and (in_range2 o) (and (and (and (<= 0 o) (<= o 100000)) (= (select is_prime1 o) true)) (ite (= (= (to_int1 (select is_prime1 value)) (to_int1 (of_int 1))) true) (= o value) (ite (= (ite (= (= (to_int1 (select is_prime1 value)) (to_int1 (of_int 0))) true) (= mode 0) false) true) (and (< value o) (forall ((v4 Int)) (=> (and (<= value v4) (<= v4 (- o 1))) (not (= (select is_prime1 v4) true))))) (ite (= (ite (= (= (to_int1 (select is_prime1 value)) (to_int1 (of_int 0))) true) (= mode 1) false) true) (and (< o value) (forall ((v4 Int)) (=> (and (<= (+ o 1) v4) (<= v4 value)) (not (= (select is_prime1 v4) true))))) (=> (= (ite (= (= (to_int1 (select is_prime1 value)) (to_int1 (of_int 0))) true) (= mode 2) false) true) (and (forall ((v4 Int)) (=> (and (<= (ite (< 0 (+ (- value (abs (- value o))) 1)) (+ (- value (abs (- value o))) 1) 0) v4) (<= v4 value)) (not (= (select is_prime1 v4) true)))) (forall ((v4 Int)) (=> (and (<= value v4) (<= v4 (ite (< 100000 (- (+ value (abs (- value o))) 1)) 100000 (- (+ value (abs (- value o))) 1)))) (not (= (select is_prime1 v4) true)))))))))))))
...
(assert (=> (= (ite (= (is_prime value) false) (= mode 0) false) true) (and (< value test_prime_and_coprime_numbers__p__nearest_prime_number__result4) (forall ((v4 Int)) (=> (and (<= value v4) (<= v4 (- test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1))) (not (= (is_prime v4) true)))))))
(assert (=> (= (ite (= (is_prime value) false) (= mode 1) false) true) (and (< test_prime_and_coprime_numbers__p__nearest_prime_number__result4 value) (forall ((v4 Int)) (=> (and (<= (+ test_prime_and_coprime_numbers__p__nearest_prime_number__result4 1) v4) (<= v4 value)) (not (= (is_prime v4) true)))))))
(assert (= (ite (= (is_prime value) false) (= mode 2) false) true))
(assert (and (= o15 (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4)) (in_range1 (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))))
(assert (= o16 (abs o15)))
