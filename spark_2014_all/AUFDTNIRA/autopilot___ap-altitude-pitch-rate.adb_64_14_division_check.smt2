...
(define-fun dynamic_invariant1 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= (- 180) 180)) (in_range2 temp___expr_159)))
...
(define-fun dynamic_invariant2 ((temp___expr_201 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= (- 10) 20)) (in_range3 temp___expr_201)))
...
(define-fun dynamic_invariant3 ((temp___expr_244 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool) (temp___do_typ_inv_243 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 1 10)) (in_range4 temp___expr_244)))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___262 i1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (= temp___261 sum1)))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (<= sum2 (* i2 20)) (<= (* i2 (- 10)) sum2))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (and (=> (<= (- 2147483648) 2147483647) (in_range1 sum2)) (=> (<= 1 10) (in_range4 i2))) (and (<= 1 i2) (<= i2 10)))))
(assert (=> (and (<= 1 i1) (<= i1 10)) (and (= o (+ sum2 (to_rep (select pitch_history_c i2)))) (in_range1 (+ sum2 (to_rep (select pitch_history_c i2)))))))
...
(assert (=> (and (<= 1 i1) (<= i1 10)) (= (mk_int__ref sum6) (mk_int__ref sum4))))
...
(assert (and (= o3 (* (- pitch early_pitch1) 20)) (in_range1 (* (- pitch early_pitch1) 20))))
(assert (not (not (= 10 0))))
(check-sat)
(exit)
