...
(assert (< 0 space2))
(assert (and (and (or (or (= space3 4) (= space3 2)) (= space3 1)) (= (all_elements_in a2 (* (* (div1 4 space3) 8) 1000000)) true)) (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 7)) (ite (= space3 4) (= (to_rep (select a2 k2)) (to_rep (select a1 k2))) (ite (and (= space3 2) (= (mod2 (+ k2 1) 8) 0)) (= (to_rep (select a2 k2)) (+ (to_rep (select a1 k2)) (to_rep (select a1 (- k2 (* 2 space3)))))) (ite (and (= space3 2) (= (mod2 (+ k2 1) 4) 0)) (= (to_rep (select a2 k2)) (to_rep (select a1 (+ k2 (* 2 space3))))) (ite (= space3 2) (= (to_rep (select a2 k2)) (to_rep (select a1 k2))) (ite (and (= space3 1) (= (mod2 (+ k2 1) 2) 0)) (and (and (and (= (to_rep (select a2 1)) (to_rep (select a1 7))) (= (to_rep (select a2 3)) (+ (to_rep (select a1 1)) (to_rep (select a1 7))))) (= (to_rep (select a2 5)) (+ (to_rep (select a1 7)) (to_rep (select a1 3))))) (= (to_rep (select a2 7)) (+ (+ (to_rep (select a1 5)) (to_rep (select a1 7))) (to_rep (select a1 3))))) (= (to_rep (select a2 k2)) (to_rep (select a1 k2))))))))))))
(assert (and (and (and (and (=> (<= 0 2147483647) (in_range2 space3)) (=> (<= 0 2147483647) (in_range2 left2))) (=> (<= 0 2147483647) (in_range2 right2))) (=> (<= (- 2147483648) 2147483647) (in_range1 temp2))) (< 0 space3)))
(assert (= temp___2441 result8))
(assert (= temp___2442 space3))
(assert (and (= o4 (* space3 2)) (in_range1 (* space3 2))))
(assert (= o5 (- o4 1)))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (and (= o7 o6) (in_range2 o6)))
(assert (= right2 result9))
(assert (= right3 o7))
(assert (< right3 8))
(assert (and (and (forall ((k2 Int)) (=> (and (<= 0 k2) (<= k2 7)) (ite (and (<= 0 k2) (<= k2 (- right4 (* space3 2)))) (ite (= (mod2 (+ k2 1) (* 2 space3)) 0) (= (to_rep (select a3 k2)) (+ (to_rep (select a2 k2)) (to_rep (select a2 (- k2 space3))))) (ite (= (mod2 (+ k2 1) space3) 0) (= (to_rep (select a3 k2)) (to_rep (select a2 (+ k2 space3)))) (= (to_rep (select a3 k2)) (to_rep (select a2 k2))))) (= (to_rep (select a3 k2)) (to_rep (select a2 k2)))))) (= (mod2 (+ right4 1) (* space3 2)) 0)) (not (<= 8 right4))))
(assert (and (and (and (=> (<= 0 2147483647) (in_range2 left3)) (=> (<= 0 2147483647) (in_range2 right4))) (=> (<= (- 2147483648) 2147483647) (in_range1 temp3))) (< right4 8)))
(assert (= temp___2211 result11))
(assert (= temp___2212 right4))
(assert (and (= o8 (- right4 space3)) (in_range1 (- right4 space3))))
(assert (and (= o9 o8) (in_range2 o8)))
(assert (= left3 result12))
(assert (= left4 o9))
(assert (and (<= 0 right4) (<= right4 7)))
(assert (= o10 right4))
(assert (= o11 (select a3 o10)))
(assert (= o12 (to_rep o11)))
(assert (= temp3 result13))
(assert (= temp4 o12))
(assert (and (<= 0 right4) (<= right4 7)))
(assert (= o15 right4))
(assert (= o16 (select a3 o15)))
(assert (= o17 (to_rep o16)))
(assert (and (<= 0 left4) (<= left4 7)))
(assert (= o13 left4))
(assert (= o14 (select a3 o13)))
(assert (= o18 (to_rep o14)))
(assert (= o19 (+ o18 o17)))
(assert (and (= o20 o19) (in_range1 o19)))
(assert (= (to_rep o21) o20))
(assert (and (<= 0 right4) (<= right4 7)))
(assert (= o22 right4))
(assert (= o23 (store a3 o22 o21)))
(assert (= a3 result14))
(assert (= a4 o23))
(assert (= (to_rep o24) temp4))
(assert (and (<= 0 left4) (<= left4 7)))
(assert (= o25 left4))
(assert (= o26 (store a4 o25 o24)))
(assert (= a4 result15))
(assert (= a5 o26))
(assert (and (= o27 (* space3 2)) (in_range1 (* space3 2))))
(assert (= o28 (+ right4 o27)))
(assert (and (= o29 o28) (in_range1 o28)))
(assert (and (= o30 o29) (in_range2 o29)))
(assert (= right4 result16))
(assert (= right5 o30))
(assert (< right5 8))
...
(assert (<= k2 7))
(assert (<= 0 k2))
(assert (<= k2 (- right5 (* space3 2))))
(assert (= (mod2 (+ k2 1) (* 2 space3)) 0))
(assert (not (= (to_rep (select a5 k2)) (+ (to_rep (select a2 k2)) (to_rep (select a2 (- k2 space3)))))))
(check-sat)
(exit)
