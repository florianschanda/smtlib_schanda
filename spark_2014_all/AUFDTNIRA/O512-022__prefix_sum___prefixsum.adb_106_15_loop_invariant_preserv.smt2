...
(assert (and (<= 0 right3) (<= right3 7)))
(assert (= o19 right3))
(assert (= o20 (store a3 o19 o18)))
(assert (= a3 result8))
(assert (= a4 o20))
(assert (= (to_rep o21) temp3))
(assert (and (<= 0 left3) (<= left3 7)))
(assert (= o22 left3))
(assert (= o23 (store a4 o22 o21)))
(assert (= a4 result9))
(assert (= a5 o23))
(assert (and (= o24 (* space3 2)) (in_range1 (* space3 2))))
(assert (= o25 (+ right3 o24)))
...
(assert (not (= (to_rep (select a5 k)) (to_rep (select a2 (+ k space3))))))
(check-sat)
(exit)
