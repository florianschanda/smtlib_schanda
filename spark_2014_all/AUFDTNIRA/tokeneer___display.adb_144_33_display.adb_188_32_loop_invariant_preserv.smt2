...
(assert (and (= temp___1394 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields16)) i12)) (in_range1 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields16)) i12))))
(assert (and (<= 1 temp___1394) (<= temp___1394 50)))
(assert (= o80 temp___1394))
...
(assert (= temp___1396 (mk___rep4 o82)))
(assert (= result10 (mk___split_fields__ref4 result____split_fields16)))
(assert (= result____split_fields17 (us_split_fields9 temp___1396)))
