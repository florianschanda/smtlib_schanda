...
(assert (and (and (and (<= 1 i12) (<= i12 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))))) (= (bool_eq10 c27b c27b) true)) (= (to_rep8 (rec__display__scrollstrt__len result____split_fields16)) (+ (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))) 3))))
(assert (and (and (= (rec__display__scrollstrt__len result____split_fields16) (rec__display__scrollstrt__len result____split_fields15)) (=> (<= 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))) (dynamic_property2 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))) i12))) (and (<= 1 i12) (<= i12 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))))))))
(assert (= (to_rep o79) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b)))) i12))))
(assert (and (= temp___1450 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields16)) i12)) (in_range1 (+ (to_rep8 (rec__display__scrollstrt__len result____split_fields16)) i12))))
(assert (and (<= 1 temp___1450) (<= temp___1450 50)))
(assert (= o80 temp___1450))
(assert (= o81 (store (rec__display__scrollstrt__text result____split_fields16) o80 o79)))
(assert (= o82 (mk___split_fields4 o81 (rec__display__scrollstrt__len result____split_fields16))))
(assert (= temp___1452 (mk___rep4 o82)))
(assert (= result10 (mk___split_fields__ref4 result____split_fields16)))
(assert (= result____split_fields17 (us_split_fields9 temp___1452)))
(assert (not (= i12 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__bottom (us_split_fields7 c27b))))))))
(assert (= result11 (mk_int__ref i12)))
(assert (= i13 (+ i12 1)))
(assert (= i14 (mk_int__ref i13)))
(assert (= result____split_fields18 (mk___split_fields__ref4 result____split_fields17)))
(assert (= i15 i13))
