...
(assert (and (= o15 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o15) (= o15 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o13 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o13) (<= o13 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= o14 (* 2 o13)))
(assert (and (= o16 o14) (in_range2 o14)))
(assert (= result (ite (<= o16 o15) true false)))
(assert (= result true))
...
(assert (= result1 (ite (<= o12 5000) true false)))
(assert (= result1 true))
...
(assert (= result2 true))
(assert (and (= o10 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1)) (= (= o10 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true))))
(assert (= o11 true))
...
(assert (= result3 true))
(assert (and (= o8 (has_key (positions x) c)) (= (= o8 true) (= (has_key (positions x) c) true))))
(assert (= o9 true))
...
(assert (= o6 (- o5 1)))
(assert (= o7 (ite (<= j1 o6) true false)))
(assert (= result10 (ite (<= 0 j1) o7 false)))
