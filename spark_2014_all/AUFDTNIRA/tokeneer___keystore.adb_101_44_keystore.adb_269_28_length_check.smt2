...
(assert (= keystore__digest__B60b__thestring__assume (mk___t (concat1 (temp___String_Literal_1737 Tuple0) 1 38 (elts (to_string (attr__ATTRIBUTE_IMAGE14 c56b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE14 c56b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE14 c56b)))))) (mk 1 o35))))
(assert (= keystore__digest__B60b__thestring__assume thestring2))
(assert (dynamic_invariant1 thestring2 true false true))
(assert (and (= o36 (length thestring2)) (in_range1 (length thestring2))))
(assert (= result23 (ite (<= o36 150) true false)))
(assert (= result23 true))
(assert (not (= (ite (<= (to_rep1 (first (rt thestring2))) (to_rep1 (last (rt thestring2)))) (+ (- (to_rep1 (last (rt thestring2))) (to_rep1 (first (rt thestring2)))) 1) 0) (ite (<= 1 (length thestring2)) (+ (- (length thestring2) 1) 1) 0))))
(check-sat)
(exit)
