...
(define-fun dynamic_invariant3 ((temp___expr_1045 Int) (temp___is_init_1041 Bool) (temp___skip_constant_1042 Bool) (temp___do_toplevel_1043 Bool) (temp___do_typ_inv_1044 Bool)) Bool (=> (or (= temp___is_init_1041 true) (<= 0 10)) (in_range7 temp___expr_1045)))
...
(define-fun dynamic_invariant4 ((temp___expr_1276 us_rep1) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (= temp___do_typ_inv_1275 true) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1276))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1276))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1276)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1276))) true)))
...
(declare-fun user_eq23 (sigdatai sigdatai) Bool)
(declare-const dummy23 sigdatai)
...
(define-fun dynamic_invariant5 ((temp___expr_1688 Int) (temp___is_init_1684 Bool) (temp___skip_constant_1685 Bool) (temp___do_toplevel_1686 Bool) (temp___do_typ_inv_1687 Bool)) Bool (=> (or (= temp___is_init_1684 true) (<= 0 28)) (in_range15 temp___expr_1688)))
...
(declare-fun user_eq27 (bytet bytet) Bool)
(declare-const dummy27 bytet)
...
(define-fun bool_eq13 ((a (Array Int bytet)) (a__first Int) (a__last Int) (b (Array Int bytet)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_164 Int)) (=> (and (<= a__first temp___idx_164) (<= temp___idx_164 a__last)) (= (to_rep11 (select a temp___idx_164)) (to_rep11 (select b (+ (- b__first a__first) temp___idx_164))))))) true false))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq13 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_164 Int)) (=> (and (<= a__first temp___idx_164) (<= temp___idx_164 a__last)) (= (to_rep11 (select a temp___idx_164)) (to_rep11 (select b (+ (- b__first a__first) temp___idx_164)))))))))))
(declare-const dummy28 (Array Int bytet))
(declare-const value__size12 Int)
(declare-fun object__size12 ((Array Int bytet)) Int)
(declare-const value__component__size7 Int)
(declare-fun object__component__size7 ((Array Int bytet)) Int)
...
(assert (forall ((a (Array Int bytet))) (<= 0 (object__component__size7 a))))
(assert (<= 0 value__alignment12))
(assert (forall ((a (Array Int bytet))) (<= 0 (object__alignment12 a))))
(declare-fun user_eq28 ((Array Int bytet) (Array Int bytet)) Bool)
...
(declare-fun temp___1839 (Int) (Array Int character))
(declare-fun temp___String_Literal_1844 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_1844 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_1844 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1844 us_void_param) 3)) 103)) (= (to_rep (select (temp___String_Literal_1844 us_void_param) 4)) 110)) :pattern ((temp___String_Literal_1844 us_void_param)))))
...
(assert (= mechanism 8))
(assert (forall ((temp___1841 Int)) (=> (dynamic_invariant7 temp___1841 true true true true) (forall ((temp___1842 Int)) (= (to_rep (select (temp___1839 temp___1841) temp___1842)) temp___1841)))))
(define-fun dynamic_invariant10 ((temp___expr_265 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool) (temp___do_typ_inv_264 Bool)) Bool (=> (or (= temp___is_init_261 true) (<= 0 255)) (in_range16 temp___expr_265)))
...
(define-fun dynamic_invariant13 ((temp___expr_1491 Int) (temp___is_init_1487 Bool) (temp___skip_constant_1488 Bool) (temp___do_toplevel_1489 Bool) (temp___do_typ_inv_1490 Bool)) Bool (=> (or (= temp___is_init_1487 true) (<= 1 4096)) (in_range14 temp___expr_1491)))
(define-fun dynamic_invariant14 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 1 150)) (in_range6 temp___expr_471)))
(assert (= nouser (temp___String_Literal_158 Tuple0)))
(define-fun dynamic_invariant15 ((temp___expr_1214 Int) (temp___is_init_1210 Bool) (temp___skip_constant_1211 Bool) (temp___do_toplevel_1212 Bool) (temp___do_typ_inv_1213 Bool)) Bool (=> (or (= temp___is_init_1210 true) (<= 0 17)) (in_range10 temp___expr_1214)))
(define-fun dynamic_invariant16 ((temp___expr_1221 Int) (temp___is_init_1217 Bool) (temp___skip_constant_1218 Bool) (temp___do_toplevel_1219 Bool) (temp___do_typ_inv_1220 Bool)) Bool (=> (or (= temp___is_init_1217 true) (<= 1 17)) (in_range8 temp___expr_1221)))
(define-fun dynamic_invariant17 ((temp___expr_1347 Int) (temp___is_init_1343 Bool) (temp___skip_constant_1344 Bool) (temp___do_toplevel_1345 Bool) (temp___do_typ_inv_1346 Bool)) Bool (=> (or (= temp___is_init_1343 true) (<= 0 2)) (in_range12 temp___expr_1347)))
(define-fun dynamic_invariant18 ((temp___expr_1228 Int) (temp___is_init_1224 Bool) (temp___skip_constant_1225 Bool) (temp___do_toplevel_1226 Bool) (temp___do_typ_inv_1227 Bool)) Bool (=> (or (= temp___is_init_1224 true) (<= 0 17408)) (in_range9 temp___expr_1228)))
(define-fun dynamic_invariant19 ((temp___expr_1259 Int) (temp___is_init_1255 Bool) (temp___skip_constant_1256 Bool) (temp___do_toplevel_1257 Bool) (temp___do_typ_inv_1258 Bool)) Bool (=> (or (= temp___is_init_1255 true) (<= 0 1024)) (in_range11 temp___expr_1259)))
(assert true)
...
(assert (forall ((temp___1288 Int)) (=> (dynamic_invariant19 temp___1288 true true true true) (forall ((temp___1289 Int)) (= (to_rep5 (select (temp___1286 temp___1288) temp___1289)) temp___1288)))))
(assert (forall ((temp___1284 Int)) (=> (dynamic_invariant16 temp___1284 true true true true) (forall ((temp___1285 Int)) (= (to_rep2 (select (temp___1282 temp___1284) temp___1285)) temp___1284)))))
...
(assert (and (in_range4 auditalarm1) (= (valid_numberlogentries (to_rep2 logfilestate__split_fields7) (to_rep3 logfilestate__split_fields8) (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) true)))
(assert (= digested true))
(assert (and (and (in_range5 theprivatekeyh1) (in_range4 auditalarm2)) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields14)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields14)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields14)) true)))
...
(assert (dynamic_property1 1 2147483647 1 4))
(assert (= (temp___String_Literal_1844 Tuple0) temp___1845))
(assert (= (mk1 1 4) temp___18451))
(assert (not (dynamic_predicate (mk___t1 temp___1845 temp___18451))))
(check-sat)
(exit)
