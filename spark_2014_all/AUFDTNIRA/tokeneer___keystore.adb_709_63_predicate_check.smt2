...
(define-fun dynamic_invariant3 ((temp___expr_932 Int) (temp___is_init_929 Bool) (temp___skip_constant_930 Bool) (temp___do_toplevel_931 Bool)) Bool (=> (or (= temp___is_init_929 true) (<= 0 10)) (in_range7 temp___expr_932)))
...
(define-fun dynamic_invariant5 ((temp___expr_1519 Int) (temp___is_init_1516 Bool) (temp___skip_constant_1517 Bool) (temp___do_toplevel_1518 Bool)) Bool (=> (or (= temp___is_init_1516 true) (<= 0 28)) (in_range15 temp___expr_1519)))
...
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq13 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_142 Int)) (=> (and (<= a__first temp___idx_142) (<= temp___idx_142 a__last)) (= (to_rep11 (select a temp___idx_142)) (to_rep11 (select b (+ (- b__first a__first) temp___idx_142)))))))))))
(declare-fun compare4 ((Array Int bytet) Int Int (Array Int bytet) Int Int) Int)
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare4 a a_first a_last b b_first b_last) 0) (= (bool_eq13 a a_first a_last b b_first b_last) true)) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare4 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq13 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep11 (select a (+ i 1))) (to_rep11 (select b (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare4 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq13 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep11 (select b (+ i 1))) (to_rep11 (select a (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare5 a a_first a_last b b_first b_last) 0) (= (bool_eq15 a a_first a_last b b_first b_last) true)) :pattern ((compare5 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare5 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq15 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_int1 (select a (+ i 1))) (to_int1 (select b (+ j 1))))))))))) :pattern ((compare5 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare5 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq15 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_int1 (select b (+ i 1))) (to_int1 (select a (+ j 1))))))))))) :pattern ((compare5 a a_first a_last b b_first b_last))))))
...
(declare-fun temp___1665 (Int) (Array Int character))
(assert (forall ((temp___1667 Int)) (forall ((temp___1668 Int)) (= (select (temp___1665 temp___1667) temp___1668) (of_rep temp___1667)))))
(declare-fun temp___String_Literal_1670 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_1670 us_void_param) 1)) 83) (= (to_rep (select (temp___String_Literal_1670 us_void_param) 2)) 105)) (= (to_rep (select (temp___String_Literal_1670 us_void_param) 3)) 103)) (= (to_rep (select (temp___String_Literal_1670 us_void_param) 4)) 110)) :pattern ((temp___String_Literal_1670 us_void_param)))))
...
(assert (= mechanism 8))
(define-fun dynamic_invariant10 ((temp___expr_238 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 0 255)) (in_range16 temp___expr_238)))
...
(define-fun dynamic_invariant13 ((temp___expr_1335 Int) (temp___is_init_1332 Bool) (temp___skip_constant_1333 Bool) (temp___do_toplevel_1334 Bool)) Bool (=> (or (= temp___is_init_1332 true) (<= 1 4096)) (in_range14 temp___expr_1335)))
(define-fun dynamic_invariant14 ((temp___expr_425 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 1 150)) (in_range6 temp___expr_425)))
(assert (= nouser (temp___String_Literal_136 Tuple0)))
(define-fun dynamic_invariant15 ((temp___expr_1103 Int) (temp___is_init_1100 Bool) (temp___skip_constant_1101 Bool) (temp___do_toplevel_1102 Bool)) Bool (=> (or (= temp___is_init_1100 true) (<= 0 17)) (in_range10 temp___expr_1103)))
(define-fun dynamic_invariant16 ((temp___expr_1082 Int) (temp___is_init_1079 Bool) (temp___skip_constant_1080 Bool) (temp___do_toplevel_1081 Bool)) Bool (=> (or (= temp___is_init_1079 true) (<= 1 17)) (in_range8 temp___expr_1082)))
(define-fun dynamic_invariant17 ((temp___expr_1207 Int) (temp___is_init_1204 Bool) (temp___skip_constant_1205 Bool) (temp___do_toplevel_1206 Bool)) Bool (=> (or (= temp___is_init_1204 true) (<= 0 2)) (in_range12 temp___expr_1207)))
(define-fun dynamic_invariant18 ((temp___expr_1088 Int) (temp___is_init_1085 Bool) (temp___skip_constant_1086 Bool) (temp___do_toplevel_1087 Bool)) Bool (=> (or (= temp___is_init_1085 true) (<= 0 17408)) (in_range9 temp___expr_1088)))
(define-fun dynamic_invariant19 ((temp___expr_1122 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 1024)) (in_range11 temp___expr_1122)))
(assert true)
...
(declare-const temp___1671 (Array Int character))
(declare-const temp___16711 t1)
...
(assert (= (temp___String_Literal_1670 Tuple0) temp___1671))
(assert (= (mk1 1 4) temp___16711))
(assert (not (dynamic_predicate (mk___t1 temp___1671 temp___16711))))
(check-sat)
(exit)
