...
(assert (and (= o7 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o7) (= o7 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o5 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o5) (<= o5 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= o6 (* 2 o5)))
...
(assert (<= 0 j))
(assert (<= j 5))
(assert (not (<= (to_rep5 (select f j)) (last (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(check-sat)
(exit)
