...
(assert (and (= o7 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o7) (= o7 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o5 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o5) (<= o5 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= o6 (* 2 o5)))
(assert (and (= o8 o6) (in_range2 o6)))
(assert (= result (ite (<= o8 o7) true false)))
(assert (= result true))
...
(assert (= result1 (ite (<= o4 5000) true false)))
(assert (= result1 true))
(assert (= (= result2 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (to_rep (select a j1))) true)))))
(assert (= result2 true))
(assert (and (= o2 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1)) (= (= o2 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true))))
(assert (= o3 true))
(assert (= result4 (ite (= o3 true) o2 false)))
...
(assert (= result3 true))
(assert (and (= o (has_key (positions x) c)) (= (= o true) (= (has_key (positions x) c) true))))
(assert (= o1 true))
(assert (= result6 (ite (= o1 true) o false)))
...
(assert (= result5 true))
(assert (= (= result7 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= 0 (to_rep4 (select f j1))) (<= (to_rep4 (select f j1)) (- (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1)))))))
(assert (= result7 true))
(assert (<= 0 j))
(assert (<= j 5))
