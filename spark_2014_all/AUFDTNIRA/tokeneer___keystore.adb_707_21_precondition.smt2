...
(assert (=> (= result2 true) (= (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) temp___1635)))
(assert (=> (= result2 true) (= (mk1 1 (length thestring)) temp___16351)))
(assert (=> (= result2 true) (and (= temp___1637 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= result2 true) (=> (<= 1 temp___1637) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1637) (<= temp___1637 150))))))
(assert (=> (= result2 true) (= o7 result__1)))
(assert (=> (= result2 true) (= o7 temp___1638)))
(assert (=> (= result2 true) (= (mk1 1 temp___1637) temp___16381)))
(assert (=> (= result2 true) (= (ite (<= (to_rep1 (first2 temp___16351)) (to_rep1 (last2 temp___16351))) (+ (- (to_rep1 (last2 temp___16351)) (to_rep1 (first2 temp___16351))) 1) 0) (ite (<= (to_rep1 (first2 temp___16381)) (to_rep1 (last2 temp___16381))) (+ (- (to_rep1 (last2 temp___16381)) (to_rep1 (first2 temp___16381))) 1) 0))))
(assert (=> (= result2 true) (= (mk___t1 temp___1639 temp___16391) (mk___t1 temp___1635 temp___16351))))
(assert (=> (= result2 true) (forall ((temp___1640 Int)) (ite (and (<= 1 temp___1640) (<= temp___1640 (length thestring))) (= (select o8 temp___1640) (select temp___1639 temp___1640)) (= (select o8 temp___1640) (select result__1 temp___1640))))))
...
(assert (=> (not (= result2 true)) (= temp___1634 thestring)))
(assert (=> (not (= result2 true)) (= o9 (elts temp___1634))))
...
(assert (= result5 (mk_map__ref c134b)))
(assert (= c134b1 result__2))
