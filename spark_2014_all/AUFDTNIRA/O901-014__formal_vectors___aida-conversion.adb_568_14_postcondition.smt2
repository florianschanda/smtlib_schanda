...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__aggregate_def 2 1 3 9 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__aggregate_def 2 1 3 9 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)) (= (mk___t2 temp___1466 temp___14661) (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__aggregate_def 2 1 3 9 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (and (= (ite (<= (to_rep1 (first4 temp___14661)) (to_rep1 (last4 temp___14661))) (+ (- (to_rep1 (last4 temp___14661)) (to_rep1 (first4 temp___14661))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1466 (to_rep1 (first4 temp___14661)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__assume) (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__int_array__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (to_rep1 (first (rt source)))) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 9)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)) (= (mk___t4 temp___1474 temp___14741) (aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (and (= (ite (<= (to_rep1 (first8 temp___14741)) (to_rep1 (last8 temp___14741))) (+ (- (to_rep1 (last8 temp___14741)) (to_rep1 (first8 temp___14741))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1474 (to_rep1 (first8 temp___14741)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__assume) (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_13x_xxx_xxx__n__assume1)))))) (and (and (dynamic_property6 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 9)))) (and (and (and (= temp___1481 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (= (mk_int__ref result2) (mk_int__ref index)) (= index2 (to_rep1 (first (rt source))))) (ite (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1481)) (and (and (and (= temp___1479 index2) (and (= temp___1477 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o9 index2)) (= o10 (select n1 o9))) (= o11 (to_rep1 o10))) (= o11 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o12 index2)) (= o13 (select (elts source) o12))) (= o14 (to_rep o13))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o14))) (ite (= (= o14 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o14 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o14 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o14 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o14 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o14 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o14 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o14 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o14 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o14 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o15) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o16 index2)) (= o17 (store n1 o16 o15)))) (and (= n1 result3) (= n2 o17))))) (and (and (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (forall ((temp___1478 Int)) (=> (and (<= (to_rep1 n__first) temp___1478) (<= temp___1478 (to_rep1 n__last))) (=> (< index3 temp___1478) (= (select n3 temp___1478) (select temp___1477 temp___1478))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9)))) (= index3 temp___1481)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1)))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (= temp___1482 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (<= (to_rep1 n__first) temp___1482) (<= temp___1482 (to_rep1 n__last))) (= o41 temp___1482))) (= o42 (select (map__content1 n7) o41))) (= o43 (to_rep1 o42))) (and (= result6 (mk_int__ref target)) (= target1 o43))) (and (<= target1 9) (and (and (and (and (and (and (and (and (and (and (= temp___1483 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (<= (to_rep1 n__first) temp___1483) (<= temp___1483 (to_rep1 n__last))) (= o44 temp___1483))) (= o45 (select (map__content1 n7) o44))) (= o46 (to_rep1 o45))) (= o47 (* o46 10))) (and (= o48 o47) (in_range1 o47))) (= o49 (+ target1 o48))) (and (= o50 o49) (in_range1 o49))) (and (= result7 (mk_int__ref target1)) (= target2 o50))) (and (<= target2 99) (and (and (and (and (and (and (and (and (and (and (= temp___1484 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))) (and (and (<= (to_rep1 n__first) temp___1484) (<= temp___1484 (to_rep1 n__last))) (= o51 temp___1484))) (= o52 (select (map__content1 n7) o51))) (= o53 (to_rep1 o52))) (= o54 (* o53 100))) (and (= o55 o54) (in_range1 o54))) (= o56 (+ target2 o55))) (and (= o57 o56) (in_range1 o56))) (and (= result8 (mk_int__ref target2)) (= target3 o57))) (and (<= target3 999) (and (and (and (and (and (and (and (and (and (and (= temp___1485 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))) (and (and (<= (to_rep1 n__first) temp___1485) (<= temp___1485 (to_rep1 n__last))) (= o58 temp___1485))) (= o59 (select (map__content1 n7) o58))) (= o60 (to_rep1 o59))) (= o61 (* o60 1000))) (and (= o62 o61) (in_range1 o61))) (= o63 (+ target3 o62))) (and (= o64 o63) (in_range1 o63))) (and (= result9 (mk_int__ref target3)) (= target4 o64))) (and (<= target4 9999) (and (and (and (and (and (and (and (and (and (and (= temp___1486 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (<= (to_rep1 n__first) temp___1486) (<= temp___1486 (to_rep1 n__last))) (= o65 temp___1486))) (= o66 (select (map__content1 n7) o65))) (= o67 (to_rep1 o66))) (= o68 (* o67 10000))) (and (= o69 o68) (in_range1 o68))) (= o70 (+ target4 o69))) (and (= o71 o70) (in_range1 o70))) (and (= result10 (mk_int__ref target4)) (= target5 o71))) (and (<= target5 99999) (and (and (and (and (and (and (and (and (and (and (= temp___1487 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (<= (to_rep1 n__first) temp___1487) (<= temp___1487 (to_rep1 n__last))) (= o72 temp___1487))) (= o73 (select (map__content1 n7) o72))) (= o74 (to_rep1 o73))) (= o75 (* o74 100000))) (and (= o76 o75) (in_range1 o75))) (= o77 (+ target5 o76))) (and (= o78 o77) (in_range1 o77))) (and (= result11 (mk_int__ref target5)) (= target6 o78))) (and (<= target6 999999) (and (and (and (and (and (and (and (and (and (and (= temp___1488 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))) (and (and (<= (to_rep1 n__first) temp___1488) (<= temp___1488 (to_rep1 n__last))) (= o79 temp___1488))) (= o80 (select (map__content1 n7) o79))) (= o81 (to_rep1 o80))) (= o82 (* o81 1000000))) (and (= o83 o82) (in_range1 o82))) (= o84 (+ target6 o83))) (and (= o85 o84) (in_range1 o84))) (and (= result12 (mk_int__ref target6)) (= target7 o85))) (and (<= target7 9999999) (and (and (and (and (and (and (and (and (and (and (= temp___1489 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (<= (to_rep1 n__first) temp___1489) (<= temp___1489 (to_rep1 n__last))) (= o86 temp___1489))) (= o87 (select (map__content1 n7) o86))) (= o88 (to_rep1 o87))) (= o89 (* o88 10000000))) (and (= o90 o89) (in_range1 o89))) (= o91 (+ target7 o90))) (and (= o92 o91) (in_range1 o91))) (and (= result13 (mk_int__ref target7)) (= target8 o92))) (and (<= target8 39999999) (and (and (and (= o93 (+ target8 2100000000)) (in_range1 (+ target8 2100000000))) (and (= result14 (mk_int__ref target8)) (= target9 o93))) (and (<= target9 2139999999) (and (= result15 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))))))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target10 (mk_int__ref target9)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target11 target9))))))))
