...
(define-fun dynamic_invariant ((temp___expr_243 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 0 1)) (in_range1 temp___expr_243)))
...
(define-fun dynamic_invariant1 ((temp___expr_194 Int) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool)) Bool (=> (or (= temp___is_init_191 true) (<= 0 3)) (in_range2 temp___expr_194)))
...
(define-fun dynamic_invariant2 ((temp___expr_407 Int) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool)) Bool (=> (or (= temp___is_init_404 true) (<= 1 4)) (in_range4 temp___expr_407)))
...
(define-fun dynamic_invariant3 ((temp___expr_522 Int) (temp___is_init_519 Bool) (temp___skip_constant_520 Bool) (temp___do_toplevel_521 Bool)) Bool (=> (or (= temp___is_init_519 true) (<= 0 4294967295)) (in_range6 temp___expr_522)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant4 ((temp___expr_528 Int) (temp___is_init_525 Bool) (temp___skip_constant_526 Bool) (temp___do_toplevel_527 Bool)) Bool (=> (or (= temp___is_init_525 true) (<= 0 2)) (in_range7 temp___expr_528)))
...
(define-fun dynamic_invariant5 ((temp___expr_534 Int) (temp___is_init_531 Bool) (temp___skip_constant_532 Bool) (temp___do_toplevel_533 Bool)) Bool (=> (or (= temp___is_init_531 true) (<= 0 1)) (in_range8 temp___expr_534)))
...
(declare-fun temp___1157 (Int) (Array Int logfileindext))
(assert (forall ((temp___1159 Int)) (forall ((temp___1160 Int)) (= (select (temp___1157 temp___1159) temp___1160) (of_rep6 temp___1159)))))
(declare-fun temp___1161 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1163 Int)) (forall ((temp___1164 Int)) (= (select (temp___1161 temp___1163) temp___1164) (of_rep9 temp___1163)))))
(define-fun dynamic_invariant6 ((temp___expr_1151 us_rep3) (temp___is_init_1148 Bool) (temp___skip_constant_1149 Bool) (temp___do_toplevel_1150 Bool)) Bool (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1151))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1151))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1151)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1151))) true))
(define-fun default_initial_assumption ((temp___expr_1155 us_rep3) (temp___skip_top_level_1156 Bool)) Bool (and (and (and (= (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1155))) 1) (= (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1155))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1155)) (mk___rep2 (mk___split_fields2 (temp___1157 1) (of_rep6 1) (of_rep6 1) (of_rep8 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1155)) (temp___1161 0))))
(define-fun type_invariant ((temp___1165 us_rep3)) Bool (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1165))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1165))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1165)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1165))) true))
...
(define-fun dynamic_invariant7 ((temp___expr_1911 Int) (temp___is_init_1908 Bool) (temp___skip_constant_1909 Bool) (temp___do_toplevel_1910 Bool)) Bool (=> (or (= temp___is_init_1908 true) (<= 0 1)) (in_range26 temp___expr_1911)))
...
(define-fun dynamic_invariant8 ((temp___expr_1933 Int) (temp___is_init_1930 Bool) (temp___skip_constant_1931 Bool) (temp___do_toplevel_1932 Bool)) Bool (=> (or (= temp___is_init_1930 true) (<= 0 1)) (in_range27 temp___expr_1933)))
...
(define-fun dynamic_invariant9 ((temp___expr_2625 Int) (temp___is_init_2622 Bool) (temp___skip_constant_2623 Bool) (temp___do_toplevel_2624 Bool)) Bool (=> (or (= temp___is_init_2622 true) (<= 0 8)) (in_range29 temp___expr_2625)))
...
(define-fun dynamic_invariant11 ((temp___expr_401 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 4)) (in_range3 temp___expr_401)))
(define-fun dynamic_invariant12 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 1 3)) (in_range5 temp___expr_200)))
(define-fun dynamic_invariant13 ((temp___expr_206 Int) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool (=> (or (= temp___is_init_203 true) (<= 0 5)) (in_range21 temp___expr_206)))
(define-fun dynamic_invariant14 ((temp___expr_446 Int) (temp___is_init_443 Bool) (temp___skip_constant_444 Bool) (temp___do_toplevel_445 Bool)) Bool (=> (or (= temp___is_init_443 true) (<= 0 40)) (in_range18 temp___expr_446)))
(define-fun dynamic_invariant15 ((temp___expr_467 Int) (temp___is_init_464 Bool) (temp___skip_constant_465 Bool) (temp___do_toplevel_466 Bool)) Bool (=> (or (= temp___is_init_464 true) (<= 0 4294967295)) (in_range20 temp___expr_467)))
(define-fun dynamic_invariant16 ((temp___expr_489 Int) (temp___is_init_486 Bool) (temp___skip_constant_487 Bool) (temp___do_toplevel_488 Bool)) Bool (=> (or (= temp___is_init_486 true) (<= 0 10)) (in_range22 temp___expr_489)))
(define-fun dynamic_invariant17 ((temp___expr_501 Int) (temp___is_init_498 Bool) (temp___skip_constant_499 Bool) (temp___do_toplevel_500 Bool)) Bool (=> (or (= temp___is_init_498 true) (<= 0 4294967295)) (in_range24 temp___expr_501)))
(define-fun dynamic_invariant18 ((temp___expr_507 Int) (temp___is_init_504 Bool) (temp___skip_constant_505 Bool) (temp___do_toplevel_506 Bool)) Bool (=> (or (= temp___is_init_504 true) (<= 0 128)) (in_range25 temp___expr_507)))
(define-fun dynamic_invariant19 ((temp___expr_1117 Int) (temp___is_init_1114 Bool) (temp___skip_constant_1115 Bool) (temp___do_toplevel_1116 Bool)) Bool (=> (or (= temp___is_init_1114 true) (<= 0 17)) (in_range15 temp___expr_1117)))
(define-fun dynamic_invariant20 ((temp___expr_1096 Int) (temp___is_init_1093 Bool) (temp___skip_constant_1094 Bool) (temp___do_toplevel_1095 Bool)) Bool (=> (or (= temp___is_init_1093 true) (<= 1 17)) (in_range13 temp___expr_1096)))
(define-fun dynamic_invariant21 ((temp___expr_1221 Int) (temp___is_init_1218 Bool) (temp___skip_constant_1219 Bool) (temp___do_toplevel_1220 Bool)) Bool (=> (or (= temp___is_init_1218 true) (<= 0 2)) (in_range17 temp___expr_1221)))
(define-fun dynamic_invariant22 ((temp___expr_1102 Int) (temp___is_init_1099 Bool) (temp___skip_constant_1100 Bool) (temp___do_toplevel_1101 Bool)) Bool (=> (or (= temp___is_init_1099 true) (<= 0 17408)) (in_range14 temp___expr_1102)))
(define-fun dynamic_invariant23 ((temp___expr_1136 Int) (temp___is_init_1133 Bool) (temp___skip_constant_1134 Bool) (temp___do_toplevel_1135 Bool)) Bool (=> (or (= temp___is_init_1133 true) (<= 0 1024)) (in_range16 temp___expr_1136)))
(assert true)
...
(define-fun dynamic_invariant24 ((temp___expr_598 Int) (temp___is_init_595 Bool) (temp___skip_constant_596 Bool) (temp___do_toplevel_597 Bool)) Bool (=> (or (= temp___is_init_595 true) (<= 1901 2099)) (in_range9 temp___expr_598)))
(define-fun dynamic_invariant25 ((temp___expr_604 Int) (temp___is_init_601 Bool) (temp___skip_constant_602 Bool) (temp___do_toplevel_603 Bool)) Bool (=> (or (= temp___is_init_601 true) (<= 1 12)) (in_range10 temp___expr_604)))
(define-fun dynamic_invariant26 ((temp___expr_610 Int) (temp___is_init_607 Bool) (temp___skip_constant_608 Bool) (temp___do_toplevel_609 Bool)) Bool (=> (or (= temp___is_init_607 true) (<= 1 31)) (in_range11 temp___expr_610)))
(define-fun dynamic_invariant27 ((temp___expr_634 Int) (temp___is_init_631 Bool) (temp___skip_constant_632 Bool) (temp___do_toplevel_633 Bool)) Bool (=> (or (= temp___is_init_631 true) (<= 0 86399999)) (in_range12 temp___expr_634)))
(assert true)
...
(define-fun dynamic_invariant28 ((temp___expr_1375 Int) (temp___is_init_1372 Bool) (temp___skip_constant_1373 Bool) (temp___do_toplevel_1374 Bool)) Bool (=> (or (= temp___is_init_1372 true) (<= 0 4294967295)) (in_range23 temp___expr_1375)))
...
(assert (forall ((door__state us_private)) (! (dynamic_invariant5 (thedooralarm door__state) true false true) :pattern ((thedooralarm door__state)))))
(assert true)
(assert (forall ((latch__currentlatch Int)) (forall ((latch__state us_private)) (forall ((latch__latchtimeout__fields us_split_fields2)) (! (=> (dynamic_invariant7 latch__currentlatch true true true) (= (latch_timeout latch__currentlatch latch__state latch__latchtimeout__fields) (mk___rep1 latch__latchtimeout__fields))) :pattern ((latch_timeout latch__currentlatch latch__state latch__latchtimeout__fields)))))))
(define-fun dynamic_invariant29 ((temp___expr_2711 Int) (temp___is_init_2708 Bool) (temp___skip_constant_2709 Bool) (temp___do_toplevel_2710 Bool)) Bool (=> (or (= temp___is_init_2708 true) (<= 0 2)) (in_range30 temp___expr_2711)))
(define-fun dynamic_invariant30 ((temp___expr_2127 Int) (temp___is_init_2124 Bool) (temp___skip_constant_2125 Bool) (temp___do_toplevel_2126 Bool)) Bool (=> (or (= temp___is_init_2124 true) (<= 0 2147483647)) (in_range28 temp___expr_2127)))
...
(declare-const thestats__split_fields us_split_fields__ref13)
...
(declare-const status2 us_private__ref)
...
(declare-const thistisinfo__split_fields4 us_split_fields10)
(declare-const status3 Int)
(declare-const thestats__split_fields1 us_split_fields26)
...
(declare-const thistisinfo__split_fields5 us_split_fields10)
...
(declare-const latchtimeout__split_fields5 us_split_fields2)
(declare-const status6 Int)
(declare-const thestats__split_fields2 us_split_fields26)
...
(declare-const currenttimevar__split_fields1 us_split_fields__ref1)
...
(declare-const thistisinfo__split_fields6 us_split_fields__ref5)
(declare-const tokenpresence3 int__ref)
(declare-const tokentry3 int__ref)
(declare-const tokenid3 int__ref)
(declare-const authcert__split_fields3 us_split_fields__ref9)
(declare-const idcert__split_fields3 us_split_fields__ref12)
(declare-const currentlatch3 int__ref)
(declare-const latchtimeout__split_fields6 us_split_fields__ref1)
(declare-const status9 int__ref)
(declare-const systemfault4 bool__ref)
(declare-const thestats__split_fields3 us_split_fields__ref13)
(declare-const theadmin__split_fields3 us_split_fields__ref)
(declare-const currenttime2 us_private__ref)
...
(declare-const status10 us_private__ref)
...
(declare-const state50 us_private__ref)
(declare-const status11 us_private__ref)
(declare-const output25 us_private__ref)
(declare-const state51 us_private__ref)
(declare-const state52 us_private__ref)
(declare-const currenttimevar__split_fields2 us_split_fields2)
...
(declare-const thistisinfo__split_fields7 us_split_fields10)
(declare-const tokenpresence4 Int)
(declare-const tokentry4 Int)
(declare-const tokenid4 Int)
(declare-const authcert__split_fields4 us_split_fields18)
(declare-const idcert__split_fields4 us_split_fields24)
(declare-const currentlatch4 Int)
(declare-const latchtimeout__split_fields7 us_split_fields2)
(declare-const status12 Int)
(declare-const systemfault5 Bool)
(declare-const thestats__split_fields4 us_split_fields26)
(declare-const theadmin__split_fields4 us_split_fields)
(declare-const currenttime3 us_private)
...
(declare-const status13 us_private)
...
(declare-const state63 us_private)
(declare-const status14 us_private)
(declare-const output31 us_private)
(declare-const state64 us_private)
(declare-const state65 us_private)
...
(assert (in_range7 tokentry))
(assert (in_range6 tokenid))
...
(assert (in_range26 currentlatch))
(assert (in_range29 status))
(assert (and (and (and (and (and (and (and (and (and (and (and (= (not (= (enrolmentisinprogress status (us_private__content state11)) true)) (= (privatekeypresent (mk___split_fields5 thistisinfo__split_fields (mk___rep4 (mk___split_fields4 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state2)) true)) (= (= (islocked currentlatch (us_private__content state4) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) true) (= (latchislocked Tuple0) true))) (=> (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields))) 1) (and (and (= (isgood tokenpresence (us_private__content state3) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) true) (= (authcertvalid tokenpresence (us_private__content state3) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence (us_private__content state3) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) 1)))) (=> (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true) (= (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields))) 3)) (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields))) 1))) (=> (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields))) 1) (or (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true) (= (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields))) 3)) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true))))) (=> (not (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields))) true)) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true)))) (=> (and (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true) (= (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields))) 4)) (= (statusiswaitingstartadminop status (us_private__content state11)) true))) (=> (or (= (statusisgotadmintoken status (us_private__content state11)) true) (= (statusiswaitingremoveadmintokenfail status (us_private__content state11)) true)) (not (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields))) true)))) (=> (or (= (statusiswaitingstartadminop status (us_private__content state11)) true) (= (statusiswaitingfinishadminop status (us_private__content state11)) true)) (and (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields))) true) (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true)))) (=> (= (statusisenclavequiescent status (us_private__content state11)) true) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true)))) (=> (= (statusisshutdown status (us_private__content state11)) true) (and (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true)) (= (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields))) 0)))) (=> (= (enrolmentisinprogress status (us_private__content state11)) true) (and (not (= (ispresent (mk___rep (us_split_fields__content theadmin__split_fields))) true)) (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields))) true))))))
(assert (and (and (and (and (and (and (= (and (and (= (islocked currentlatch1 (let ((subject state4)) state22) latchtimeout__split_fields4) true) (= (thecurrentdoor (let ((subject state5)) state23)) 0)) (= (greaterthanorequal (thecurrenttime currenttimevar__split_fields (let ((subject currenttime)) currenttime1)) (alarm_timeout (let ((subject state5)) state23))) true)) (= (thedooralarm (let ((subject state5)) state23)) 0)) (= (= (isgood tokenpresence (us_private__content state3) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) true) (= (isgood tokenpresence1 (let ((subject state3)) state21) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true))) (= (= (authcertvalid tokenpresence (us_private__content state3) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) true) (= (authcertvalid tokenpresence1 (let ((subject state3)) state21) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true))) (= (= (theauthcertrole tokenpresence (us_private__content state3) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) 1) (= (theauthcertrole tokenpresence1 (let ((subject state3)) state21) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) 1))) (= (= (islocked currentlatch1 (let ((subject state4)) state22) latchtimeout__split_fields4) true) (= (greaterthanorequal (thecurrenttime currenttimevar__split_fields (let ((subject currenttime)) currenttime1)) (latch_timeout currentlatch1 (let ((subject state4)) state22) latchtimeout__split_fields4)) true))) (= (bool_eq1 (latch_timeout currentlatch1 (let ((subject state4)) state22) latchtimeout__split_fields4) (latch_timeout currentlatch (us_private__content state4) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) true)) (and (and (and (and (and (in_range1 tokenpresence1) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true)) (in_range8 auditalarm1)) (in_range7 tokentry1)) (in_range6 tokenid1)) (in_range26 currentlatch1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (and (and (=> (= (thedooralarm (let ((subject state5)) state23)) 0) (= (isalarming Tuple0) true)) (or (= (= (islocked currentlatch1 (let ((subject state4)) state22) latchtimeout__split_fields4) true) (= (latchislocked Tuple0) true)) (= (let ((subject systemfault)) systemfault2) true))) (and (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range8 auditalarm2)))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (not (= (let ((subject systemfault)) systemfault2) true)) (and (and (and (and (and (and (and (and (and (and (and (and (= (not (= (enrolmentisinprogress status6 (let ((subject state11)) state35)) true)) (= (privatekeypresent thistisinfo__split_fields5 (let ((subject state2)) state28)) true)) (= (and (and (= (islocked currentlatch2 (let ((subject state4)) state30) latchtimeout__split_fields5) true) (= (thecurrentdoor (let ((subject state5)) state31)) 0)) (= (greaterthanorequal (thecurrenttime currenttimevar__split_fields (let ((subject currenttime)) currenttime1)) (alarm_timeout (let ((subject state5)) state31))) true)) (= (thedooralarm (let ((subject state5)) state31)) 0))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 1) (and (and (= (isgood tokenpresence2 (let ((subject state3)) state29) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true) (= (authcertvalid tokenpresence2 (let ((subject state3)) state29) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true)) (= (theauthcertrole tokenpresence2 (let ((subject state3)) state29) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) 1)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 3)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 1))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 1) (or (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 3)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true))))) (=> (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 4)) (= (statusiswaitingstartadminop status6 (let ((subject state11)) state35)) true))) (=> (or (= (statusisgotadmintoken status6 (let ((subject state11)) state35)) true) (= (statusiswaitingremoveadmintokenfail status6 (let ((subject state11)) state35)) true)) (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)))) (=> (or (= (statusiswaitingstartadminop status6 (let ((subject state11)) state35)) true) (= (statusiswaitingfinishadminop status6 (let ((subject state11)) state35)) true)) (and (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true) (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields))))))) (=> (= (statusisenclavequiescent status6 (let ((subject state11)) state35)) true) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)))) (=> (= (statusisshutdown status6 (let ((subject state11)) state35)) true) (and (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 0)))) (=> (= (enrolmentisinprogress status6 (let ((subject state11)) state35)) true) (and (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true))))) (and (and (and (and (and (and (in_range29 status6) (in_range1 tokenpresence2)) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true)) (in_range8 auditalarm3)) (in_range7 tokentry2)) (in_range6 tokenid2)) (in_range26 currentlatch2))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (not (= (let ((subject systemfault)) systemfault2) true)) (and (and (=> (= (thedooralarm (let ((subject state5)) state31)) 0) (= (isalarming Tuple0) true)) (or (= (= (islocked currentlatch2 (let ((subject state4)) state30) latchtimeout__split_fields5) true) (= (latchislocked Tuple0) true)) (= (let ((subject systemfault)) systemfault3) true))) (and (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true) (in_range8 auditalarm4))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject state12)) (mk___private__ref state36)) state12))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject state11)) (mk___private__ref state35)) state11))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject output5)) (mk___private__ref output15)) output5))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject status2)) (mk___private__ref status8)) (let ((subject status2)) (mk___private__ref status5))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject state10)) (mk___private__ref state34)) (let ((subject state10)) (mk___private__ref state25))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject output4)) (mk___private__ref output19)) output4))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject state9)) (mk___private__ref state39)) state9))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject output3)) (mk___private__ref output14)) output3))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject writtenstate)) (mk___private__ref writtenstate2)) writtenstate))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject state8)) (mk___private__ref state33)) state8))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject output2)) (mk___private__ref output18)) output2))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject state7)) (mk___private__ref state38)) (let ((subject state7)) (mk___private__ref state24))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject state6)) (mk___private__ref state32)) state6))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject filestate2)) (mk___private__ref filestate8)) filestate2))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject output1)) (mk___private__ref output17)) (let ((subject output1)) (mk___private__ref output13))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject state5)) (mk___private__ref state31)) (let ((subject state5)) (mk___private__ref state23))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject output)) (mk___private__ref output16)) (let ((subject output)) (mk___private__ref output12))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject state4)) (mk___private__ref state30)) (let ((subject state4)) (mk___private__ref state22))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject status1)) (mk___private__ref status7)) (let ((subject status1)) (mk___private__ref status4))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject state3)) (mk___private__ref state29)) (let ((subject state3)) (mk___private__ref state21))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject store1)) (mk___private__ref store3)) store1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject state2)) (mk___private__ref state28)) state2))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject state1)) (mk___private__ref state37)) (let ((subject state1)) (mk___private__ref state26))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject filestate1)) (mk___private__ref filestate9)) (let ((subject filestate1)) (mk___private__ref filestate6))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject state)) (mk___private__ref state27)) state))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject filestate)) (mk___private__ref filestate7)) filestate))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject theadmin__split_fields)) (mk___split_fields__ref theadmin__split_fields2)) theadmin__split_fields))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject thestats__split_fields)) (mk___split_fields__ref13 thestats__split_fields2)) thestats__split_fields))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject systemfault)) (mk_bool__ref systemfault3)) (let ((subject systemfault)) (mk_bool__ref systemfault2))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= status6 status))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= latchtimeout__split_fields5 latchtimeout__split_fields4))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= currentlatch2 currentlatch1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields2)) (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields1))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields2)) (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields1))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= tokenid2 tokenid1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= tokentry2 tokentry1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= tokenpresence2 tokenpresence1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= thistisinfo__split_fields5 (mk___split_fields5 thistisinfo__split_fields (mk___rep4 (mk___split_fields4 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3)))))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= auditsystemfault2 auditsystemfault1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= auditalarm4 auditalarm2))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= logfilestate__split_fields10 logfilestate__split_fields8))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= logfilesstatus2 logfilesstatus1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= logfiles2 logfiles1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= state36 state19))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= state35 state18))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= output15 output11))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= status8 status5))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= state34 state25))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= output19 output10))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= state39 state17))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= output14 output9))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= writtenstate2 writtenstate1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= state33 state16))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= output18 output8))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= state38 state24))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= state32 state15))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= filestate8 filestate4))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= output17 output13))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= state31 state23))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= output16 output12))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= state30 state22))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= status7 status4))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= state29 state21))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= store3 store2))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= state28 state14))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= state37 state26))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= filestate9 filestate6))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= state27 state13))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= filestate7 filestate3))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= theadmin__split_fields2 theadmin__split_fields1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= thestats__split_fields2 thestats__split_fields1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= systemfault3 systemfault2))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= status6 status3))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= latchtimeout__split_fields5 latchtimeout__split_fields4))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= currentlatch2 currentlatch1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= idcert__split_fields2 idcert__split_fields1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= authcert__split_fields2 authcert__split_fields1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= tokenid2 tokenid1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= tokentry2 tokentry1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= tokenpresence2 tokenpresence1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= thistisinfo__split_fields5 thistisinfo__split_fields4))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= auditsystemfault2 auditsystemfault1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= auditalarm4 auditalarm2))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= logfilestate__split_fields10 logfilestate__split_fields8))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= logfilesstatus2 logfilesstatus1))))
(assert (=> (not (= (let ((subject systemfault)) systemfault1) true)) (=> (= (let ((subject systemfault)) systemfault2) true) (= logfiles2 logfiles1))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject state12)) (mk___private__ref state36)) state12)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject state11)) (mk___private__ref state35)) state11)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject output5)) (mk___private__ref output15)) output5)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject status2)) (mk___private__ref status8)) (let ((subject status2)) (mk___private__ref status5)))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject state10)) (mk___private__ref state34)) (let ((subject state10)) (mk___private__ref state25)))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject output4)) (mk___private__ref output19)) output4)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject state9)) (mk___private__ref state39)) state9)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject output3)) (mk___private__ref output14)) output3)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject writtenstate)) (mk___private__ref writtenstate2)) writtenstate)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject state8)) (mk___private__ref state33)) state8)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject output2)) (mk___private__ref output18)) output2)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject state7)) (mk___private__ref state38)) (let ((subject state7)) (mk___private__ref state24)))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject state6)) (mk___private__ref state32)) state6)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject filestate2)) (mk___private__ref filestate8)) filestate2)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject output1)) (mk___private__ref output17)) output1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject state5)) (mk___private__ref state31)) (let ((subject state5)) (mk___private__ref state23)))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject output)) (mk___private__ref output16)) output)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject state4)) (mk___private__ref state30)) (let ((subject state4)) (mk___private__ref state22)))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject status1)) (mk___private__ref status7)) (let ((subject status1)) (mk___private__ref status4)))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject state3)) (mk___private__ref state29)) (let ((subject state3)) (mk___private__ref state21)))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject store1)) (mk___private__ref store3)) store1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject state2)) (mk___private__ref state28)) state2)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject state1)) (mk___private__ref state37)) (let ((subject state1)) (mk___private__ref state20)))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject filestate1)) (mk___private__ref filestate9)) (let ((subject filestate1)) (mk___private__ref filestate5)))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject state)) (mk___private__ref state27)) state)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject filestate)) (mk___private__ref filestate7)) filestate)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject theadmin__split_fields)) (mk___split_fields__ref theadmin__split_fields2)) theadmin__split_fields)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject thestats__split_fields)) (mk___split_fields__ref13 thestats__split_fields2)) thestats__split_fields)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject systemfault)) (mk_bool__ref systemfault3)) (let ((subject systemfault)) (mk_bool__ref systemfault1)))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= status6 status)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= latchtimeout__split_fields5 latchtimeout__split_fields4)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= currentlatch2 currentlatch1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields2)) (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields1)))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields2)) (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields1)))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= tokenid2 tokenid1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= tokentry2 tokentry1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= tokenpresence2 tokenpresence1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= thistisinfo__split_fields5 (mk___split_fields5 thistisinfo__split_fields (mk___rep4 (mk___split_fields4 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))))))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= auditsystemfault2 auditsystemfault)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= auditalarm4 auditalarm1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= logfilestate__split_fields10 logfilestate__split_fields7)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= logfilesstatus2 logfilesstatus)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= logfiles2 logfiles)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= state36 state19)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= state35 state18)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= output15 output11)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= status8 status5)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= state34 state25)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= output19 output10)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= state39 state17)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= output14 output9)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= writtenstate2 writtenstate1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= state33 state16)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= output18 output8)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= state38 state24)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= state32 state15)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= filestate8 filestate4)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= output17 output7)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= state31 state23)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= output16 output6)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= state30 state22)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= status7 status4)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= state29 state21)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= store3 store2)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= state28 state14)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= state37 state20)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= filestate9 filestate5)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= state27 state13)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= filestate7 filestate3)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= theadmin__split_fields2 theadmin__split_fields1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= thestats__split_fields2 thestats__split_fields1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= systemfault3 systemfault1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= status6 status3)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= latchtimeout__split_fields5 latchtimeout__split_fields4)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= currentlatch2 currentlatch1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= idcert__split_fields2 idcert__split_fields1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= authcert__split_fields2 authcert__split_fields1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= tokenid2 tokenid1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= tokentry2 tokentry1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= tokenpresence2 tokenpresence1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= thistisinfo__split_fields5 thistisinfo__split_fields4)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= auditsystemfault2 auditsystemfault)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= auditalarm4 auditalarm1)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= logfilestate__split_fields10 logfilestate__split_fields7)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= logfilesstatus2 logfilesstatus)))
(assert (=> (= (let ((subject systemfault)) systemfault1) true) (= logfiles2 logfiles)))
(assert (= state52 (let ((subject state12)) (mk___private__ref state36))))
(assert (= state51 (let ((subject state11)) (mk___private__ref state35))))
(assert (= output25 (let ((subject output5)) (mk___private__ref output15))))
(assert (= status11 (let ((subject status2)) (mk___private__ref status8))))
(assert (= state50 (let ((subject state10)) (mk___private__ref state34))))
(assert (= output24 (let ((subject output4)) (mk___private__ref output19))))
(assert (= state49 (let ((subject state9)) (mk___private__ref state39))))
...
(assert (= state48 (let ((subject state8)) (mk___private__ref state33))))
(assert (= output22 (let ((subject output2)) (mk___private__ref output18))))
(assert (= state47 (let ((subject state7)) (mk___private__ref state38))))
(assert (= state46 (let ((subject state6)) (mk___private__ref state32))))
(assert (= filestate12 (let ((subject filestate2)) (mk___private__ref filestate8))))
(assert (= output21 (let ((subject output1)) (mk___private__ref output17))))
(assert (= state45 (let ((subject state5)) (mk___private__ref state31))))
(assert (= output20 (let ((subject output)) (mk___private__ref output16))))
(assert (= state44 (let ((subject state4)) (mk___private__ref state30))))
(assert (= status10 (let ((subject status1)) (mk___private__ref status7))))
(assert (= state43 (let ((subject state3)) (mk___private__ref state29))))
(assert (= store4 (let ((subject store1)) (mk___private__ref store3))))
(assert (= state42 (let ((subject state2)) (mk___private__ref state28))))
(assert (= state41 (let ((subject state1)) (mk___private__ref state37))))
(assert (= filestate11 (let ((subject filestate1)) (mk___private__ref filestate9))))
(assert (= state40 (let ((subject state)) (mk___private__ref state27))))
(assert (= filestate10 (let ((subject filestate)) (mk___private__ref filestate7))))
(assert (= currenttime2 (let ((subject currenttime)) (mk___private__ref currenttime1))))
(assert (= theadmin__split_fields3 (let ((subject theadmin__split_fields)) (mk___split_fields__ref theadmin__split_fields2))))
(assert (= thestats__split_fields3 (let ((subject thestats__split_fields)) (mk___split_fields__ref13 thestats__split_fields2))))
(assert (= systemfault4 (let ((subject systemfault)) (mk_bool__ref systemfault3))))
(assert (= status9 (mk_int__ref status6)))
(assert (= latchtimeout__split_fields6 (mk___split_fields__ref1 latchtimeout__split_fields5)))
(assert (= currentlatch3 (mk_int__ref currentlatch2)))
(assert (= idcert__split_fields3 (let ((subject idcert__split_fields)) (mk___split_fields__ref12 idcert__split_fields2))))
(assert (= authcert__split_fields3 (let ((subject authcert__split_fields)) (mk___split_fields__ref9 authcert__split_fields2))))
(assert (= tokenid3 (mk_int__ref tokenid2)))
(assert (= tokentry3 (mk_int__ref tokentry2)))
(assert (= tokenpresence3 (mk_int__ref tokenpresence2)))
(assert (= thistisinfo__split_fields6 (mk___split_fields__ref5 thistisinfo__split_fields5)))
(assert (= auditsystemfault3 (mk_bool__ref auditsystemfault2)))
(assert (= auditalarm5 (mk_int__ref auditalarm4)))
(assert (= logfilestate__split_fields11 (mk___split_fields__ref3 logfilestate__split_fields10)))
(assert (= logfilesstatus3 (mk_map__ref3 logfilesstatus2)))
(assert (= logfiles3 (mk_map__ref2 logfiles2)))
(assert (= currenttimevar__split_fields1 (mk___split_fields__ref1 currenttimevar__split_fields)))
(assert (= state65 state36))
(assert (= state64 state35))
(assert (= output31 output15))
(assert (= status14 status8))
(assert (= state63 state34))
(assert (= output30 output19))
(assert (= state62 state39))
(assert (= output29 output14))
(assert (= writtenstate4 writtenstate2))
(assert (= state61 state33))
(assert (= output28 output18))
(assert (= state60 state38))
(assert (= state59 state32))
(assert (= filestate15 filestate8))
(assert (= output27 output17))
(assert (= state58 state31))
(assert (= output26 output16))
(assert (= state57 state30))
(assert (= status13 status7))
(assert (= state56 state29))
(assert (= store5 store3))
(assert (= state55 state28))
(assert (= state54 state37))
(assert (= filestate14 filestate9))
(assert (= state53 state27))
(assert (= filestate13 filestate7))
(assert (= currenttime3 currenttime1))
...
(assert (= status12 status6))
(assert (= latchtimeout__split_fields7 latchtimeout__split_fields5))
(assert (= currentlatch4 currentlatch2))
(assert (= idcert__split_fields4 idcert__split_fields2))
(assert (= authcert__split_fields4 authcert__split_fields2))
(assert (= tokenid4 tokenid2))
(assert (= tokentry4 tokentry2))
(assert (= tokenpresence4 tokenpresence2))
...
(assert (and (= result11 (enrolmentisinprogress (int__content status9) (us_private__content state51))) (= (= result11 true) (in_range30 (int__content status9)))))
(assert (=> (= result11 true) (and (= o66 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o66 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result11 true) (= o67 (ite (not (= o66 true)) true false))))
(assert (=> (= result11 true) (and (= o65 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o65 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result11 true) (= o68 (ite (not (= o65 true)) true false))))
(assert (=> (= result11 true) (= o69 (ite (= o68 true) o67 false))))
(assert (=> (not (= result11 true)) (= o69 (of_int 1))))
(assert (and (= result12 (statusisshutdown (int__content status9) (us_private__content state51))) (= (= result12 true) (= (int__content status9) 8))))
(assert (=> (= result12 true) (and (= o61 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (and (in_range2 o61) (= o61 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result12 true) (= o62 (ite (= o61 0) true false))))
(assert (=> (= result12 true) (and (= o60 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o60 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result12 true) (= o63 (ite (not (= o60 true)) true false))))
(assert (=> (= result12 true) (= o64 (ite (= o63 true) o62 false))))
(assert (=> (not (= result12 true)) (= o64 (of_int 1))))
(assert (and (= result13 (statusisenclavequiescent (int__content status9) (us_private__content state51))) (= (= result13 true) (= (int__content status9) 3))))
(assert (=> (= result13 true) (and (= o58 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o58 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result13 true) (= o59 (ite (not (= o58 true)) true false))))
(assert (=> (not (= result13 true)) (= o59 (of_int 1))))
(assert (and (= o49 (statusiswaitingfinishadminop (int__content status9) (us_private__content state51))) (= (= o49 true) (= (int__content status9) 7))))
(assert (and (= o50 (statusiswaitingstartadminop (int__content status9) (us_private__content state51))) (= (= o50 true) (= (int__content status9) 6))))
(assert (= result14 (ite (= o50 false) o49 true)))
(assert (=> (= result14 true) (and (= o53 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (and (in_range2 o53) (= o53 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result14 true) (and (= o54 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (and (in_range2 o54) (= o54 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result14 true) (= o55 (ite (= o54 o53) true false))))
(assert (=> (= result14 true) (and (= o51 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o51 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result14 true) (and (= o52 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o52 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result14 true) (= o56 (ite (= o52 true) o51 false))))
(assert (=> (= result14 true) (= o57 (ite (= o56 true) o55 false))))
(assert (=> (not (= result14 true)) (= o57 (of_int 1))))
(assert (and (= o45 (statusiswaitingremoveadmintokenfail (int__content status9) (us_private__content state51))) (= (= o45 true) (= (int__content status9) 4))))
(assert (and (= o46 (statusisgotadmintoken (int__content status9) (us_private__content state51))) (= (= o46 true) (= (int__content status9) 5))))
(assert (= result15 (ite (= o46 false) o45 true)))
(assert (=> (= result15 true) (and (= o47 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o47 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result15 true) (= o48 (ite (not (= o47 true)) true false))))
(assert (=> (not (= result15 true)) (= o48 (of_int 1))))
(assert (and (= result17 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result17 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
(assert (=> (= result17 true) (and (= o43 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (in_range4 o43))))
(assert (=> (= result17 true) (= result16 (ite (= o43 4) true false))))
(assert (=> (not (= result17 true)) (= result16 false)))
(assert (=> (= result16 true) (and (= o44 (statusiswaitingstartadminop (int__content status9) (us_private__content state51))) (= (= o44 true) (= (int__content status9) 6)))))
(assert (=> (not (= result16 true)) (= o44 (of_int 1))))
(assert (and (= o40 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o40 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3)))))))
(assert (= result18 (ite (not (= o40 true)) true false)))
(assert (=> (= result18 true) (and (= o41 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o41 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result18 true) (= o42 (ite (not (= o41 true)) true false))))
(assert (=> (not (= result18 true)) (= o42 (of_int 1))))
(assert (and (= o34 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields3)))) (and (in_range2 o34) (= o34 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields3)))))))
(assert (= result19 (ite (= o34 1) true false)))
(assert (=> (= result19 true) (and (= o36 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o36 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result19 true) (= o37 (ite (not (= o36 true)) true false))))
(assert (=> (= result19 true) (and (= result20 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result20 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3))))))))
(assert (=> (= result19 true) (=> (= result20 true) (and (= o35 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (in_range4 o35)))))
(assert (=> (= result19 true) (=> (= result20 true) (= o38 (ite (= o35 3) true false)))))
(assert (=> (= result19 true) (=> (not (= result20 true)) (= o38 false))))
(assert (=> (= result19 true) (= o39 (ite (= o38 false) o37 true))))
(assert (=> (not (= result19 true)) (= o39 (of_int 1))))
(assert (and (= result21 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result21 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
(assert (= result21 true))
(assert (not (= (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3))) true)))
(check-sat)
(exit)
