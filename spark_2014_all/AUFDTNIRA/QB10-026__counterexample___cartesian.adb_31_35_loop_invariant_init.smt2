...
(assert (<= j index28))
(assert (not (= (to_rep (select (select result__9 (+ (+ (* (- index13 (to_rep (first2 (rt1 array1)))) (length1 array2)) (- j (to_rep (first2 (rt1 array2))))) 1)) 1)) (to_rep (select (elts1 array1) index13)))))
(check-sat)
(exit)
