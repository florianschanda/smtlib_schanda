...
(declare-const o4 small_int)
(declare-const temp___397 Int)
(declare-const o5 Int)
(declare-const o6 element_2)
(declare-const o7 Int)
(declare-const o8 Int)
(declare-const o9 Int)
(declare-const o10 Int)
(declare-const o11 element_2)
...
(assert (and (= o (+ (to_rep1 (select (elts2 a) i1)) acc1)) (in_range1 (+ (to_rep1 (select (elts2 a) i1)) acc1))))
(assert (= (to_rep2 o1) o))
(assert (= o2 (store r i1 o1)))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 r)))
(assert (= r1 o2))
(assert (forall ((k1 Int)) (=> (and (<= (to_rep (first4 (rt2 a))) k1) (<= k1 i2)) (and (= (in_range5 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) (to_rep2 (select r2 k1)) (+ (- k1 (to_rep (first4 (rt2 a)))) 1)) true) (= (to_rep2 (select r2 k1)) (+ (to_rep1 (select (elts2 a) k1)) (ite (= k1 (to_rep (first4 (rt2 a)))) init (to_rep2 (select r2 (- k1 1))))))))))
(assert (and (and (and (forall ((temp___394 Int)) (=> (and (<= (to_rep r__first) temp___394) (<= temp___394 (to_rep r__last))) (=> (or (< (to_rep (last4 (rt2 a))) temp___394) (or (< temp___394 (to_rep (first4 (rt2 a)))) (< i2 temp___394))) (= (select r2 temp___394) (select r temp___394))))) (=> (<= (- 2147483648) 2147483647) (in_range7 acc2))) (=> (<= (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))) (dynamic_property5 (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))) i2))) (and (<= (to_rep (first4 (rt2 a))) i2) (<= i2 (to_rep (last4 (rt2 a)))))))
(assert (<= (to_rep (first4 (rt2 a))) k))
(assert (<= k i2))
(assert (and (= o13 (- k (to_rep (first4 (rt2 a))))) (in_range1 (- k (to_rep (first4 (rt2 a)))))))
(assert (and (= o14 o13) (in_range2 o13)))
(assert (= o15 (+ o14 1)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (and (<= (to_rep r__first) k) (<= k (to_rep r__last))))
(assert (= o10 k))
(assert (= o11 (select r2 o10)))
(assert (= o12 (to_rep2 o11)))
(assert (and (= result3 (in_range5 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) o12 o16)) (= (= result3 true) (and (<= (+ (- 2147483648) (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o16))) o12) (<= o12 (- 2147483647 (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o16))))))))
(assert (= result3 true))
(assert (=> (= k (to_rep (first4 (rt2 a)))) (= o7 init)))
(assert (=> (not (= k (to_rep (first4 (rt2 a))))) (and (= temp___397 (- k 1)) (in_range1 (- k 1)))))
(assert (=> (not (= k (to_rep (first4 (rt2 a))))) (and (<= (to_rep r__first) temp___397) (<= temp___397 (to_rep r__last)))))
(assert (=> (not (= k (to_rep (first4 (rt2 a))))) (= o5 temp___397)))
(assert (=> (not (= k (to_rep (first4 (rt2 a))))) (= o6 (select r2 o5))))
(assert (=> (not (= k (to_rep (first4 (rt2 a))))) (= o7 (to_rep2 o6))))
(assert (and (<= (to_rep (first4 (rt2 a))) k) (<= k (to_rep (last4 (rt2 a))))))
(assert (= o3 k))
(assert (= o4 (select (elts2 a) o3)))
(assert (= o8 (to_rep1 o4)))
(assert (= o9 (+ o8 o7)))
