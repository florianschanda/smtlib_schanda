...
(define-fun a__split_fields5 () us_split_fields (mk___split_fields (mk___t1 a__split_fields2 a__split_fields3)))
...
(assert (= right1 last4))
(assert (and (and (dynamic_invariant2 (mk___rep a__split_discrs a__split_fields5) true true true true) (=> (<= 0 2147483647) (in_range2 right2))) (=> (<= 0 2147483647) (in_range2 left2))))
...
(assert (=> (= result4 true) (= temp___1049 left2)))
...
(assert (=> (= result7 true) (= temp___1052 right2)))
