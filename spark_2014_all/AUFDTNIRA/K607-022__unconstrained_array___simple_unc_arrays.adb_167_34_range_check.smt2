...
(assert (= right1 last4))
(assert (and (and (dynamic_invariant2 (mk___rep a__split_discrs (mk___split_fields (mk___t1 a__split_fields2 a__split_fields3))) true true true) (=> (<= 0 2147483647) (in_range2 right2))) (=> (<= 0 2147483647) (in_range2 left2))))
...
(assert (=> (= result4 true) (= temp___964 left2)))
(assert (=> (= result4 true) (and (=> (<= 0 2147483647) (in_range2 left3)) (and (< left3 last4) (< (to_rep2 (select a__split_fields2 left3)) pivot_value1)))))
(assert (=> (= result4 true) (and (= o10 (+ left3 1)) (in_range1 (+ left3 1)))))
(assert (=> (= result4 true) (= left3 result5)))
(assert (=> (= result4 true) (= left4 o10)))
(assert (=> (= result4 true) (=> (< left4 last4) (and (<= (to_rep1 (first2 a__split_fields3)) left4) (<= left4 (to_rep1 (last2 a__split_fields3)))))))
(assert (=> (= result4 true) (=> (< left4 last4) (= o11 left4))))
(assert (=> (= result4 true) (=> (< left4 last4) (= o12 (select a__split_fields2 o11)))))
(assert (=> (= result4 true) (=> (< left4 last4) (= o13 (to_rep2 o12)))))
(assert (=> (= result4 true) (=> (< left4 last4) (= o14 (ite (< o13 pivot_value1) true false)))))
(assert (=> (= result4 true) (=> (not (< left4 last4)) (= o14 false))))
(assert (=> (= result4 true) (= result6 (ite (not (= o14 true)) true false))))
...
(assert (=> (< first4 right2) (and (<= (to_rep1 (first2 a__split_fields3)) right2) (<= right2 (to_rep1 (last2 a__split_fields3))))))
(assert (=> (< first4 right2) (= o15 right2)))
(assert (=> (< first4 right2) (= o16 (select a__split_fields2 o15))))
(assert (=> (< first4 right2) (= o17 (to_rep2 o16))))
(assert (=> (< first4 right2) (= result7 (ite (< pivot_value1 o17) true false))))
(assert (=> (not (< first4 right2)) (= result7 false)))
(assert (=> (= result7 true) (= temp___967 right2)))
(assert (=> (= result7 true) (and (=> (<= 0 2147483647) (in_range2 right3)) (and (< first4 right3) (< pivot_value1 (to_rep2 (select a__split_fields2 right3)))))))
(assert (=> (= result7 true) (and (= o18 (- right3 1)) (in_range2 (- right3 1)))))
(assert (=> (= result7 true) (= result8 (mk_int__ref right3))))
(assert (=> (= result7 true) (= right4 o18)))
(assert (=> (= result7 true) (=> (< first4 right4) (and (<= (to_rep1 (first2 a__split_fields3)) right4) (<= right4 (to_rep1 (last2 a__split_fields3)))))))
(assert (=> (= result7 true) (=> (< first4 right4) (= o19 right4))))
(assert (=> (= result7 true) (=> (< first4 right4) (= o20 (select a__split_fields2 o19)))))
(assert (=> (= result7 true) (=> (< first4 right4) (= o21 (to_rep2 o20)))))
(assert (=> (= result7 true) (=> (< first4 right4) (= o22 (ite (< pivot_value1 o21) true false)))))
(assert (=> (= result7 true) (=> (not (< first4 right4)) (= o22 false))))
(assert (=> (= result7 true) (= result9 (ite (not (= o22 true)) true false))))
...
(assert (= (to_rep (rec__simple_unc_arrays__table__last a__split_discrs)) r63b))
(assert (in_range2 r63b))
(assert (= (ite (<= (to_rep1 (first2 a__split_fields3)) (to_rep1 (last2 a__split_fields3))) (+ (- (to_rep1 (last2 a__split_fields3)) (to_rep1 (first2 a__split_fields3))) 1) 0) (ite (<= 1 r63b) (+ (- r63b 1) 1) 0)))
(assert (= a__split_fields2 simple_unc_arrays__swap_cells__a__compl))
(assert (= (mk2 (to_rep1 (first2 a__split_fields3)) (to_rep1 (last2 a__split_fields3))) simple_unc_arrays__swap_cells__a__compl1))
(assert (and (= o26 (int__content right7)) (in_range3 (int__content right7))))
(assert (and (= o25 (int__content left7)) (in_range3 (int__content left7))))
(assert (= (to_rep1 o24) (to_rep1 (last5 simple_unc_arrays__swap_cells__a__compl1))))
(assert (= (to_rep1 o23) (to_rep1 (first5 simple_unc_arrays__swap_cells__a__compl1))))
(assert (and (and (= (to_rep2 (select simple_unc_arrays__swap_cells__a o25)) (to_rep2 (select simple_unc_arrays__swap_cells__a__compl o26))) (= (to_rep2 (select simple_unc_arrays__swap_cells__a o26)) (to_rep2 (select simple_unc_arrays__swap_cells__a__compl o25)))) (forall ((k Int)) (=> (and (<= (to_rep1 o23) k) (<= k (to_rep1 o24))) (=> (and (not (= k o25)) (not (= k o26))) (= (to_rep2 (select simple_unc_arrays__swap_cells__a k)) (to_rep2 (select simple_unc_arrays__swap_cells__a__compl k))))))))
(assert (= result10 (mk___split_fields__ref (mk___split_fields (mk___t1 a__split_fields2 a__split_fields3)))))
(assert (= a__split_fields4 (mk___split_fields (mk___t1 (slide simple_unc_arrays__swap_cells__a (to_rep1 (first (mk (to_rep1 (first5 simple_unc_arrays__swap_cells__a__compl1)) (to_rep1 (last5 simple_unc_arrays__swap_cells__a__compl1))))) 1) (mk1 (to_rep1 (first5 (mk2 1 r63b))) (to_rep1 (last5 (mk2 1 r63b))))))))
(assert (< (int__content left7) last4))
(assert (< first4 (int__content right7)))
(assert (and (= o27 (+ (int__content left7) 1)) (in_range1 (+ (int__content left7) 1))))
(assert (= result11 left7))
(assert (= left9 o27))
(assert (not (in_range2 (- (int__content right7) 1))))
(check-sat)
(exit)
