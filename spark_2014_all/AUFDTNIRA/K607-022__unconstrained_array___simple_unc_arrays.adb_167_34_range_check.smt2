...
(define-fun a__split_fields5 () us_split_fields (mk___split_fields (mk___t a__split_fields2 a__split_fields3)))
...
(assert (= right1 last4))
(assert (and (and (dynamic_invariant1 (mk___rep a__split_discrs a__split_fields5) true true true true) (=> (<= 0 2147483647) (in_range2 right2))) (=> (<= 0 2147483647) (in_range2 left2))))
...
(assert (=> (= result4 true) (= temp___1042 left2)))
...
(assert (=> (= result4 true) (=> (< left4 last4) (and (<= (to_rep1 (first a__split_fields3)) left4) (<= left4 (to_rep1 (last a__split_fields3)))))))
...
(assert (=> (< first4 right2) (and (<= (to_rep1 (first a__split_fields3)) right2) (<= right2 (to_rep1 (last a__split_fields3))))))
...
(assert (=> (= result7 true) (= temp___1045 right2)))
...
(assert (=> (= result7 true) (=> (< first4 right4) (and (<= (to_rep1 (first a__split_fields3)) right4) (<= right4 (to_rep1 (last a__split_fields3)))))))
...
(assert (= (ite (<= (to_rep1 (first a__split_fields3)) (to_rep1 (last a__split_fields3))) (+ (- (to_rep1 (last a__split_fields3)) (to_rep1 (first a__split_fields3))) 1) 0) (ite (<= 1 r63b) (+ (- r63b 1) 1) 0)))
(assert (= a__split_fields2 simple_unc_arrays__swap_cells__a__compl))
(assert (= (mk2 (to_rep1 (first a__split_fields3)) (to_rep1 (last a__split_fields3))) simple_unc_arrays__swap_cells__a__compl1))
...
(assert (= a__split_fields4 (mk___split_fields (mk___t (slide simple_unc_arrays__swap_cells__a (to_rep1 (first2 (mk1 (to_rep1 (first5 simple_unc_arrays__swap_cells__a__compl1)) (to_rep1 (last5 simple_unc_arrays__swap_cells__a__compl1))))) 1) (mk (to_rep1 (first5 (mk2 1 r63b))) (to_rep1 (last5 (mk2 1 r63b))))))))
