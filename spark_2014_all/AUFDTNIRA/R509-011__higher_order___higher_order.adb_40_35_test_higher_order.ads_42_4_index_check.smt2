...
(assert (<= k i2))
(assert (and (= o9 (- k (to_rep (first4 (rt2 a))))) (in_range1 (- k (to_rep (first4 (rt2 a)))))))
(assert (and (= o10 o9) (in_range2 o9)))
(assert (= o11 (+ o10 1)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (and (<= (to_rep r__first) k) (<= k (to_rep r__last))))
(assert (= o6 k))
(assert (= o7 (select r2 o6)))
(assert (= o8 (to_rep2 o7)))
(assert (and (= result3 (in_range5 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) o8 o12)) (= (= result3 true) (and (<= (+ (- 2147483648) (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o12))) o8) (<= o8 (- 2147483647 (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o12))))))))
(assert (= result3 true))
(assert (=> (= k (to_rep (first4 (rt2 a)))) (= o5 init)))
...
(assert (=> (not (= k (to_rep (first4 (rt2 a))))) (= o3 temp___397)))
(assert (=> (not (= k (to_rep (first4 (rt2 a))))) (= o4 (select r2 o3))))
(assert (=> (not (= k (to_rep (first4 (rt2 a))))) (= o5 (to_rep2 o4))))
(assert (not (<= k (to_rep (last4 (rt2 a))))))
(check-sat)
(exit)
