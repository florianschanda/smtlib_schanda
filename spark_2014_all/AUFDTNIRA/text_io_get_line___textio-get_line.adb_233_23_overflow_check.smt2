...
(assert (forall ((temp___541 Int) (temp___542 Int) (temp___543 Int)) (let ((temp___540 (temp___539 temp___541 temp___542 temp___543))) (and (=> (dynamic_property 1 2147483647 temp___542 temp___543) (and (= (first3 temp___540) temp___542) (= (last3 temp___540) temp___543))) (forall ((temp___544 Int)) (= (select (to_array1 temp___540) temp___544) (of_rep temp___541)))))))
...
(declare-const temp___554 Int)
(declare-const temp___553 (Array Int character))
...
(assert (= (to_rep1 (first2 (rt1 (temp___539 32 (to_rep1 item__first) (to_rep1 item__last))))) (to_rep1 item__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___539 32 (to_rep1 item__first) (to_rep1 item__last))))) (to_rep1 item__last)))
(assert (= (mk___t1 temp___546 temp___5461) (temp___539 32 (to_rep1 item__first) (to_rep1 item__last))))
(assert (= temp___546 temp___547))
(assert (= (mk (to_rep1 (first2 temp___5461)) (to_rep1 (last2 temp___5461))) temp___5471))
(assert (= (ite (<= (to_rep1 (first temp___5471)) (to_rep1 (last temp___5471))) (+ (- (to_rep1 (last temp___5471)) (to_rep1 (first temp___5471))) 1) 0) (ite (<= (to_rep1 item__first) (to_rep1 item__last)) (+ (- (to_rep1 item__last) (to_rep1 item__first)) 1) 0)))
(assert (= (mk___t temp___548 temp___5481) (mk___t temp___547 temp___5471)))
(assert (= o (slide temp___548 (to_rep1 (first temp___5481)) (to_rep1 item__first))))
...
(assert (= n1 o6))
(assert (=> (<= 80 n1) (= temp___554 cur_position)))
(assert (=> (<= 80 n1) (= temp___553 item1)))
(assert (=> (<= 80 n1) (= temp___555 cur_position)))
(assert (=> (<= 80 n1) (= temp___551 n1)))
(assert (=> (<= 80 n1) (= temp___550 rest)))
(assert (=> (<= 80 n1) (= temp___549 last5)))
(assert (=> (<= 80 n1) (= temp___557 cur_position)))
(assert (=> (<= 80 n1) (and (<= (to_rep1 item__first) (+ last6 1)) (= (+ last6 n2) (to_rep1 item__last)))))
(assert (=> (<= 80 n1) (forall ((idx Int)) (=> (and (<= (to_rep1 item__first) idx) (<= idx last6)) (= (to_rep (select item2 idx)) (to_rep (select the_file (+ (- idx (to_rep1 item__first)) temp___555))))))))
(assert (=> (<= 80 n1) (= cur_position2 (+ (- (+ temp___557 last6) (to_rep1 item__first)) 1))))
(assert (=> (<= 80 n1) (and (and (and (and (=> (<= 0 2147483647) (in_range4 last6)) (=> (<= (- 2147483648) 2147483647) (in_range1 rest2))) (=> (<= 0 2147483647) (in_range4 n2))) (in_range2 cur_position2)) (<= 80 n2))))
