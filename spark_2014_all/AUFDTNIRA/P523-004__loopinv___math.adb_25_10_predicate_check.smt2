...
(define-fun dynamic_invariant ((temp___expr_159 (Array Int value)) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool)) Bool (=> (= temp___do_toplevel_158 true) (=> (= temp___is_init_156 true) (= (sorted temp___expr_159) true))))
...
(define-fun dynamic_invariant1 ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 10000)) (in_range1 temp___expr_136)))
...
(assert (<= 1 j1))
(assert (<= j1 100))
(assert (and (and (= (sorted v1) true) (forall ((temp___194 Int)) (=> (and (<= 1 temp___194) (<= temp___194 100)) (=> (<= j2 temp___194) (= (select v1 temp___194) (select v temp___194)))))) (and (<= 1 j2) (<= j2 100))))
(assert (= (sorted v1) true))
(assert (= (to_rep o) (div1 (to_rep (select v1 j2)) 2)))
(assert (= temp___192 (store v1 j2 o)))
(assert (not (dynamic_predicate temp___192)))
(check-sat)
(exit)
