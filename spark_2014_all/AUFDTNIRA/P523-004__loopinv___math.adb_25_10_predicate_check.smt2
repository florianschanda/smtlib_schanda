...
(declare-const temp___220 (Array Int value))
...
(assert (<= 1 j1))
(assert (<= j1 100))
(assert (and (and (= (sorted v1) true) (forall ((temp___222 Int)) (=> (and (<= 1 temp___222) (<= temp___222 100)) (=> (or (< 100 temp___222) (or (< temp___222 1) (<= j2 temp___222))) (= (select v1 temp___222) (select v temp___222)))))) (and (<= 1 j2) (<= j2 100))))
(assert (= (sorted v1) true))
(assert (= (to_rep o) (div1 (to_rep (select v1 j2)) 2)))
(assert (= temp___220 (store v1 j2 o)))
(assert (not (dynamic_predicate temp___220)))
(check-sat)
(exit)
