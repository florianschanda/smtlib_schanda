...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (= (bool_eq3 (rec__auditlog__logfilelistt__list (us_split_fields5 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields5 b)) 1 17) true) (= (to_rep7 (rec__auditlog__logfilelistt__head (us_split_fields5 a))) (to_rep7 (rec__auditlog__logfilelistt__head (us_split_fields5 b))))) (= (to_rep7 (rec__auditlog__logfilelistt__lasti (us_split_fields5 a))) (to_rep7 (rec__auditlog__logfilelistt__lasti (us_split_fields5 b))))) (= (to_rep9 (rec__auditlog__logfilelistt__length (us_split_fields5 a))) (to_rep9 (rec__auditlog__logfilelistt__length (us_split_fields5 b))))) true false))
...
(define-fun bool_eq5 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep10 (select a temp___idx_196)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_196))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep10 (select a temp___idx_196)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
...
(define-fun bool_eq6 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 a))) (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 b)))) (= (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 a))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 b))))) (= (bool_eq4 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 b))) true)) (= (bool_eq5 (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 b)) 1 17) true)) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_648 Int) (temp___is_init_644 Bool) (temp___skip_constant_645 Bool) (temp___do_toplevel_646 Bool) (temp___do_typ_inv_647 Bool)) Bool (=> (or (= temp___is_init_644 true) (<= 0 1)) (in_range14 temp___expr_648)))
...
(define-fun dynamic_invariant3 ((temp___expr_1352 us_rep3) (temp___is_init_1348 Bool) (temp___skip_constant_1349 Bool) (temp___do_toplevel_1350 Bool) (temp___do_typ_inv_1351 Bool)) Bool (=> (= temp___do_typ_inv_1351 true) (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1352))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1352))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1352)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1352))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1356 us_rep3) (temp___skip_top_level_1357 Bool)) Bool (and (and (and (= (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1356))) 1) (= (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1356))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1356)) (mk___rep2 (mk___split_fields2 (temp_____aggregate_def_1358 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1356)) (temp_____aggregate_def_1362 0))))
(define-fun type_invariant ((temp___1366 us_rep3)) Bool (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1366))) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1366))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1366)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1366))) true))
(assert true)
...
(declare-fun user_eq21 (character character) Bool)
(declare-const dummy21 character)
...
(assert (forall ((x character)) (! (in_range16 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep12 (select a temp___idx_91)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_91)))))))))))
...
(assert (forall ((x issueridt)) (! (in_range17 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun bool_eq8 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (= (to_rep13 (rec__cryptotypes__issuert__id (us_split_fields9 a))) (to_rep13 (rec__cryptotypes__issuert__id (us_split_fields9 b)))) (= (to_rep11 (rec__cryptotypes__issuert__namelength (us_split_fields9 a))) (to_rep11 (rec__cryptotypes__issuert__namelength (us_split_fields9 b))))) (= (bool_eq7 (rec__cryptotypes__issuert__name (us_split_fields9 a)) 1 40 (rec__cryptotypes__issuert__name (us_split_fields9 b)) 1 40) true)) true false))
...
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__keystore__optionalprivatekeyt__ispresent Bool) (rec__keystore__optionalprivatekeyt__owner us_rep4)))))
...
(define-fun us_split_fields_Owner__projection ((a us_split_fields10)) us_rep4 (rec__keystore__optionalprivatekeyt__owner a))
...
(define-fun bool_eq9 ((a us_rep5) (b us_rep5)) Bool (ite (and (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields11 a)) (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields11 b))) (= (bool_eq8 (rec__keystore__optionalprivatekeyt__owner (us_split_fields11 a)) (rec__keystore__optionalprivatekeyt__owner (us_split_fields11 b))) true)) true false))
...
(define-fun to_rep14 ((x serialnumbert)) Int (serialnumbertqtint x))
(declare-fun of_rep14 (Int) serialnumbert)
(assert (forall ((x serialnumbert)) (! (= (of_rep14 (to_rep14 x)) x) :pattern ((to_rep14 x)))))
(assert (forall ((x serialnumbert)) (! (in_range18 (to_rep14 x)) :pattern ((to_rep14 x)))))
(assert (forall ((x Int)) (! (=> (in_range18 x) (= (to_rep14 (of_rep14 x)) x)) :pattern ((to_rep14 (of_rep14 x))))))
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__certtypes__idt__issuer us_rep4) (rec__certtypes__idt__serialnumber serialnumbert)))))
(define-fun us_split_fields_Issuer__projection ((a us_split_fields12)) us_rep4 (rec__certtypes__idt__issuer a))
...
(define-fun bool_eq10 ((a us_rep6) (b us_rep6)) Bool (ite (and (= (bool_eq8 (rec__certtypes__idt__issuer (us_split_fields13 a)) (rec__certtypes__idt__issuer (us_split_fields13 b))) true) (= (to_rep14 (rec__certtypes__idt__serialnumber (us_split_fields13 a))) (to_rep14 (rec__certtypes__idt__serialnumber (us_split_fields13 b))))) true false))
...
(assert (forall ((x classt)) (! (in_range19 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(define-fun bool_eq11 ((a us_rep7) (b us_rep7)) Bool (ite (= (to_rep15 (rec__privtypes__clearancet__class (us_split_fields15 a))) (to_rep15 (rec__privtypes__clearancet__class (us_split_fields15 b)))) true false))
...
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__cert__attr__auth__contentst__id us_rep6) (rec__cert__attr__auth__contentst__notbefore us_rep1) (rec__cert__attr__auth__contentst__notafter us_rep1) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep6) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep7)))))
(define-fun us_split_fields_ID__5__projection ((a us_split_fields16)) us_rep6 (rec__cert__attr__auth__contentst__id a))
...
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields16)) us_rep6 (rec__cert__attr__auth__contentst__basecertid a))
...
(define-fun bool_eq13 ((a us_rep9) (b us_rep9)) Bool (ite (and (= (rec__admintoken__validauthcertt__valid (us_split_fields19 a)) (rec__admintoken__validauthcertt__valid (us_split_fields19 b))) (= (bool_eq12 (rec__admintoken__validauthcertt__contents (us_split_fields19 a)) (rec__admintoken__validauthcertt__contents (us_split_fields19 b))) true)) true false))
...
(declare-fun user_eq32 (us_rep9 us_rep9) Bool)
(declare-const dummy32 us_rep9)
...
(declare-fun user_eq33 (keyidt keyidt) Bool)
(declare-const dummy33 keyidt)
...
(declare-fun user_eq34 (keylengtht keylengtht) Bool)
(declare-const dummy34 keylengtht)
...
(define-fun us_rep___5__projection ((a us_rep10)) us_split_fields20 (us_split_fields21 a))
(define-fun bool_eq14 ((a us_rep10) (b us_rep10)) Bool (ite (and (and (= (to_rep16 (rec__cryptotypes__keypartt__algorithmid (us_split_fields21 a))) (to_rep16 (rec__cryptotypes__keypartt__algorithmid (us_split_fields21 b)))) (= (to_rep17 (rec__cryptotypes__keypartt__keyid (us_split_fields21 a))) (to_rep17 (rec__cryptotypes__keypartt__keyid (us_split_fields21 b))))) (= (to_rep18 (rec__cryptotypes__keypartt__keylength (us_split_fields21 a))) (to_rep18 (rec__cryptotypes__keypartt__keylength (us_split_fields21 b))))) true false))
...
(declare-datatypes () ((us_split_fields22 (mk___split_fields11 (rec__cert__id__contentst__id us_rep6) (rec__cert__id__contentst__notbefore us_rep1) (rec__cert__id__contentst__notafter us_rep1) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep4) (rec__cert__id__contentst__subjectpublickey us_rep10)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields22)) us_rep6 (rec__cert__id__contentst__id a))
...
(define-fun us_split_fields_Subject__projection ((a us_split_fields22)) us_rep4 (rec__cert__id__contentst__subject a))
(define-fun us_split_fields_SubjectPublicKey__projection ((a us_split_fields22)) us_rep10 (rec__cert__id__contentst__subjectpublickey a))
...
(define-fun us_rep___19__projection ((a us_rep11)) us_split_fields22 (us_split_fields23 a))
(define-fun bool_eq15 ((a us_rep11) (b us_rep11)) Bool (ite (and (and (and (and (and (= (bool_eq10 (rec__cert__id__contentst__id (us_split_fields23 a)) (rec__cert__id__contentst__id (us_split_fields23 b))) true) (= (bool_eq1 (rec__cert__id__contentst__notbefore (us_split_fields23 a)) (rec__cert__id__contentst__notbefore (us_split_fields23 b))) true)) (= (bool_eq1 (rec__cert__id__contentst__notafter (us_split_fields23 a)) (rec__cert__id__contentst__notafter (us_split_fields23 b))) true)) (= (to_rep16 (rec__cert__id__contentst__mechanism (us_split_fields23 a))) (to_rep16 (rec__cert__id__contentst__mechanism (us_split_fields23 b))))) (= (bool_eq8 (rec__cert__id__contentst__subject (us_split_fields23 a)) (rec__cert__id__contentst__subject (us_split_fields23 b))) true)) (= (bool_eq14 (rec__cert__id__contentst__subjectpublickey (us_split_fields23 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields23 b))) true)) true false))
...
(declare-datatypes () ((us_split_fields24 (mk___split_fields12 (rec__admintoken__valididcertt__valid Bool) (rec__admintoken__valididcertt__contents us_rep11)))))
(define-fun us_split_fields_Valid__2__projection ((a us_split_fields24)) Bool (rec__admintoken__valididcertt__valid a))
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields24)) us_rep11 (rec__admintoken__valididcertt__contents a))
...
(declare-datatypes () ((us_rep12 (mk___rep12 (us_split_fields25 us_split_fields24)))))
(define-fun us_rep___21__projection ((a us_rep12)) us_split_fields24 (us_split_fields25 a))
(define-fun bool_eq16 ((a us_rep12) (b us_rep12)) Bool (ite (and (= (rec__admintoken__valididcertt__valid (us_split_fields25 a)) (rec__admintoken__valididcertt__valid (us_split_fields25 b))) (= (bool_eq15 (rec__admintoken__valididcertt__contents (us_split_fields25 a)) (rec__admintoken__valididcertt__contents (us_split_fields25 b))) true)) true false))
...
(declare-fun user_eq38 (presencet presencet) Bool)
(declare-const dummy38 presencet)
...
(define-fun dynamic_invariant4 ((temp___expr_245 Int) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool) (temp___do_typ_inv_244 Bool)) Bool (=> (or (= temp___is_init_241 true) (<= 0 1)) (in_range23 temp___expr_245)))
...
(declare-fun user_eq39 (tokenidt tokenidt) Bool)
(declare-const dummy39 tokenidt)
...
(define-fun dynamic_invariant5 ((temp___expr_634 Int) (temp___is_init_630 Bool) (temp___skip_constant_631 Bool) (temp___do_toplevel_632 Bool) (temp___do_typ_inv_633 Bool)) Bool (=> (or (= temp___is_init_630 true) (<= 0 4294967295)) (in_range24 temp___expr_634)))
(declare-sort tryt 0)
...
(declare-fun user_eq40 (tryt tryt) Bool)
(declare-const dummy40 tryt)
...
(define-fun dynamic_invariant7 ((temp___expr_2141 Int) (temp___is_init_2137 Bool) (temp___skip_constant_2138 Bool) (temp___do_toplevel_2139 Bool) (temp___do_typ_inv_2140 Bool)) Bool (=> (or (= temp___is_init_2137 true) (<= 0 1)) (in_range26 temp___expr_2141)))
(assert true)
...
(define-fun dynamic_invariant8 ((temp___expr_2164 Int) (temp___is_init_2160 Bool) (temp___skip_constant_2161 Bool) (temp___do_toplevel_2162 Bool) (temp___do_typ_inv_2163 Bool)) Bool (=> (or (= temp___is_init_2160 true) (<= 0 1)) (in_range27 temp___expr_2164)))
...
(define-fun dynamic_invariant9 ((temp___expr_2880 Int) (temp___is_init_2876 Bool) (temp___skip_constant_2877 Bool) (temp___do_toplevel_2878 Bool) (temp___do_typ_inv_2879 Bool)) Bool (=> (or (= temp___is_init_2876 true) (<= 0 8)) (in_range28 temp___expr_2880)))
(assert true)
...
(declare-fun user_eq44 (enrolmentstates enrolmentstates) Bool)
(declare-const dummy44 enrolmentstates)
...
(assert true)
(assert (forall ((enclave__status Int)) (forall ((enclave__state us_private)) (! (= (= (enrolmentisinprogress enclave__status enclave__state) true) (in_range29 enclave__status)) :pattern ((enrolmentisinprogress enclave__status enclave__state))))))
...
(declare-fun bool_eq17 (us_rep13 us_rep13) Bool)
...
(declare-datatypes () ((t__ref3 (mk_t__ref3 (t__content3 us_rep13)))))
(define-fun t__ref___2__projection ((a t__ref3)) us_rep13 (t__content3 a))
(declare-datatypes () ((map__ref4 (mk_map__ref4 (map__content4 (Array Int us_rep13))))))
(declare-fun slide4 ((Array Int us_rep13) Int Int) (Array Int us_rep13))
(assert (forall ((a (Array Int us_rep13))) (forall ((first Int)) (! (= (slide4 a first first) a) :pattern ((slide4 a first first))))))
(assert (forall ((a (Array Int us_rep13))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide4 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide4 a old_first new_first) i))))))))
(define-fun bool_eq18 ((a (Array Int us_rep13)) (a__first Int) (a__last Int) (b (Array Int us_rep13)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq17 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true)))) true false))
(assert (forall ((a (Array Int us_rep13)) (b (Array Int us_rep13))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq18 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq17 (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true))))))))
...
(define-fun dynamic_invariant10 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range16 temp___expr_74)))
...
(define-fun dynamic_invariant13 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range19 temp___expr_440)))
(define-fun dynamic_invariant14 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 40)) (in_range15 temp___expr_548)))
(define-fun dynamic_invariant15 ((temp___expr_572 Int) (temp___is_init_568 Bool) (temp___skip_constant_569 Bool) (temp___do_toplevel_570 Bool) (temp___do_typ_inv_571 Bool)) Bool (=> (or (= temp___is_init_568 true) (<= 0 4294967295)) (in_range17 temp___expr_572)))
(define-fun dynamic_invariant16 ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= 0 10)) (in_range20 temp___expr_596)))
(define-fun dynamic_invariant17 ((temp___expr_610 Int) (temp___is_init_606 Bool) (temp___skip_constant_607 Bool) (temp___do_toplevel_608 Bool) (temp___do_typ_inv_609 Bool)) Bool (=> (or (= temp___is_init_606 true) (<= 0 4294967295)) (in_range21 temp___expr_610)))
(define-fun dynamic_invariant18 ((temp___expr_617 Int) (temp___is_init_613 Bool) (temp___skip_constant_614 Bool) (temp___do_toplevel_615 Bool) (temp___do_typ_inv_616 Bool)) Bool (=> (or (= temp___is_init_613 true) (<= 0 128)) (in_range22 temp___expr_617)))
(define-fun dynamic_invariant19 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17)) (in_range12 temp___expr_1290)))
(define-fun dynamic_invariant20 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 1 17)) (in_range10 temp___expr_1297)))
(define-fun dynamic_invariant21 ((temp___expr_1423 Int) (temp___is_init_1419 Bool) (temp___skip_constant_1420 Bool) (temp___do_toplevel_1421 Bool) (temp___do_typ_inv_1422 Bool)) Bool (=> (or (= temp___is_init_1419 true) (<= 0 2)) (in_range9 temp___expr_1423)))
(define-fun dynamic_invariant22 ((temp___expr_1304 Int) (temp___is_init_1300 Bool) (temp___skip_constant_1301 Bool) (temp___do_toplevel_1302 Bool) (temp___do_typ_inv_1303 Bool)) Bool (=> (or (= temp___is_init_1300 true) (<= 0 17408)) (in_range11 temp___expr_1304)))
(define-fun dynamic_invariant23 ((temp___expr_1335 Int) (temp___is_init_1331 Bool) (temp___skip_constant_1332 Bool) (temp___do_toplevel_1333 Bool) (temp___do_typ_inv_1334 Bool)) Bool (=> (or (= temp___is_init_1331 true) (<= 0 1024)) (in_range13 temp___expr_1335)))
(assert true)
...
(define-fun dynamic_invariant28 ((temp___expr_1596 Int) (temp___is_init_1592 Bool) (temp___skip_constant_1593 Bool) (temp___do_toplevel_1594 Bool) (temp___do_typ_inv_1595 Bool)) Bool (=> (or (= temp___is_init_1592 true) (<= 0 4294967295)) (in_range18 temp___expr_1596)))
...
(define-fun dynamic_invariant29 ((temp___expr_2967 Int) (temp___is_init_2963 Bool) (temp___skip_constant_2964 Bool) (temp___do_toplevel_2965 Bool) (temp___do_typ_inv_2966 Bool)) Bool (=> (or (= temp___is_init_2963 true) (<= 0 2)) (in_range29 temp___expr_2967)))
...
(declare-const logfiles (Array Int us_rep13))
...
(declare-const logfiles1 (Array Int us_rep13))
...
(declare-const logfiles2 (Array Int us_rep13))
...
(assert (=> (<= 0 1) (in_range23 tokenpresence)))
(assert (=> (<= 0 2) (in_range25 tokentry)))
(assert (=> (<= 0 4294967295) (in_range24 tokenid)))
...
(assert (= logfilesstatus1 logfilesstatus))
(assert (= logfiles1 logfiles))
(assert (= result (systemfaultoccurred logfilesstatus1 (let ((subject state)) state24) logfilestate__split_fields10 auditalarm4 auditsystemfault1)))
...
(assert (= logfilesstatus2 logfilesstatus1))
(assert (= logfiles2 logfiles1))
(assert (and (= result1 (enrolmentisinprogress status3 (let ((subject state7)) state23))) (= (= result1 true) (in_range29 status3))))
(assert (=> (= result1 true) (and (= o17 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o17 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result1 true) (= o18 (ite (not (= o17 true)) true false))))
(assert (=> (= result1 true) (and (= o16 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o16 true) (in_range4 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result1 true) (= o19 (ite (not (= o16 true)) true false))))
(assert (=> (= result1 true) (= o20 (ite (= o19 true) o18 false))))
(assert (=> (not (= result1 true)) (= o20 (distinct 1 0))))
(assert (and (= result2 (statusisshutdown status3 (let ((subject state7)) state23))) (= (= result2 true) (= status3 8))))
(assert (=> (= result2 true) (and (= o12 (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (and (in_range1 o12) (= o12 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result2 true) (= o13 (ite (= o12 0) true false))))
(assert (=> (= result2 true) (and (= o11 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o11 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result2 true) (= o14 (ite (not (= o11 true)) true false))))
(assert (=> (= result2 true) (= o15 (ite (= o14 true) o13 false))))
(assert (=> (not (= result2 true)) (= o15 (distinct 1 0))))
(assert (and (= result3 (statusisenclavequiescent status3 (let ((subject state7)) state23))) (= (= result3 true) (= status3 3))))
(assert (=> (= result3 true) (and (= o9 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o9 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result3 true) (= o10 (ite (not (= o9 true)) true false))))
(assert (=> (not (= result3 true)) (= o10 (distinct 1 0))))
(assert (and (= o4 (statusiswaitingfinishadminop status3 (let ((subject state7)) state23))) (= (= o4 true) (= status3 7))))
(assert (and (= o5 (statusiswaitingstartadminop status3 (let ((subject state7)) state23))) (= (= o5 true) (= status3 6))))
(assert (= result4 (ite (= o5 false) o4 true)))
(assert (=> (= result4 true) (and (= o6 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o6 true) (in_range4 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result4 true) (and (= o7 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o7 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result4 true) (= o8 (ite (= o7 true) o6 false))))
(assert (=> (not (= result4 true)) (= o8 (distinct 1 0))))
(assert (and (= o (statusiswaitingremoveadmintokenfail status3 (let ((subject state7)) state23))) (= (= o true) (= status3 4))))
(assert (and (= o1 (statusisgotadmintoken status3 (let ((subject state7)) state23))) (= (= o1 true) (= status3 5))))
(assert (= result5 (ite (= o1 false) o true)))
(assert (=> (= result5 true) (and (= o2 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= o2 true) (in_range4 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields5))))))))
(assert (=> (= result5 true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (not (= result5 true)) (= o3 (distinct 1 0))))
(assert (and (= result6 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5)))) (= (= result6 true) (in_range3 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields5)))))))
(assert (= result6 true))
