...
(assert (dynamic_predicate temp___1732))
(assert (= o10 temp___1732))
(assert (= o11 (convertretvaltotext retvalini1 o10)))
(assert (= o12 (mk___t o11 (mk 1 150))))
(assert (not (= (to_rep1 (first (rt o12))) 1)))
(check-sat)
(exit)
