...
(define-fun dynamic_invariant ((temp___expr_355 Int) (temp___is_init_352 Bool) (temp___skip_constant_353 Bool) (temp___do_toplevel_354 Bool)) Bool (=> (or (= temp___is_init_352 true) (<= 0 864000)) (in_range3 temp___expr_355)))
...
(define-fun dynamic_invariant1 ((temp___expr_381 Int) (temp___is_init_378 Bool) (temp___skip_constant_379 Bool) (temp___do_toplevel_380 Bool)) Bool (=> (or (= temp___is_init_378 true) (<= 1 21)) (in_range4 temp___expr_381)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_430 us_void_param) 1)) 104) (= (to_rep (select (temp___String_Literal_430 us_void_param) 2)) 104)) (= (to_rep (select (temp___String_Literal_430 us_void_param) 3)) 58)) (= (to_rep (select (temp___String_Literal_430 us_void_param) 4)) 109)) (= (to_rep (select (temp___String_Literal_430 us_void_param) 5)) 109)) (= (to_rep (select (temp___String_Literal_430 us_void_param) 6)) 58)) (= (to_rep (select (temp___String_Literal_430 us_void_param) 7)) 115)) (= (to_rep (select (temp___String_Literal_430 us_void_param) 8)) 115)) (= (to_rep (select (temp___String_Literal_430 us_void_param) 9)) 46)) (= (to_rep (select (temp___String_Literal_430 us_void_param) 10)) 115)) :pattern ((temp___String_Literal_430 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_396 Int) (temp___is_init_393 Bool) (temp___skip_constant_394 Bool) (temp___do_toplevel_395 Bool)) Bool (=> (or (= temp___is_init_393 true) (<= 1 10)) (in_range5 temp___expr_396)))
...
(assert (= localtext1 (temp___String_Literal_430 Tuple0)))
