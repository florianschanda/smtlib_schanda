...
(define-fun dynamic_invariant2 ((temp___expr_493 Int) (temp___is_init_490 Bool) (temp___skip_constant_491 Bool) (temp___do_toplevel_492 Bool)) Bool (=> (or (= temp___is_init_490 true) (<= 0 2)) (in_range5 temp___expr_493)))
...
(define-fun dynamic_invariant3 ((temp___expr_1066 Int) (temp___is_init_1063 Bool) (temp___skip_constant_1064 Bool) (temp___do_toplevel_1065 Bool)) Bool (=> (or (= temp___is_init_1063 true) (<= 0 1)) (in_range6 temp___expr_1066)))
...
(define-fun dynamic_invariant7 ((temp___expr_1093 Int) (temp___is_init_1090 Bool) (temp___skip_constant_1091 Bool) (temp___do_toplevel_1092 Bool)) Bool (=> (or (= temp___is_init_1090 true) (<= 0 17)) (in_range10 temp___expr_1093)))
(define-fun dynamic_invariant8 ((temp___expr_1072 Int) (temp___is_init_1069 Bool) (temp___skip_constant_1070 Bool) (temp___do_toplevel_1071 Bool)) Bool (=> (or (= temp___is_init_1069 true) (<= 1 17)) (in_range7 temp___expr_1072)))
(define-fun dynamic_invariant9 ((temp___expr_1184 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 0 2)) (in_range12 temp___expr_1184)))
(define-fun dynamic_invariant10 ((temp___expr_1078 Int) (temp___is_init_1075 Bool) (temp___skip_constant_1076 Bool) (temp___do_toplevel_1077 Bool)) Bool (=> (or (= temp___is_init_1075 true) (<= 0 17408)) (in_range9 temp___expr_1078)))
(define-fun dynamic_invariant11 ((temp___expr_1112 Int) (temp___is_init_1109 Bool) (temp___skip_constant_1110 Bool) (temp___do_toplevel_1111 Bool)) Bool (=> (or (= temp___is_init_1109 true) (<= 0 1024)) (in_range11 temp___expr_1112)))
(assert true)
...
(assert (and (and (=> (<= 0 1) (in_range6 oldalarm)) (and (and (= (mk_int__ref result) (mk_int__ref oldalarm)) (= oldalarm1 auditalarm)) (and (and (= o (converttoauditdescription description)) (and (and (<= 1 (to_rep4 logfilestate__split_fields12)) (= (to_rep3 logfilestate__split_fields8) (+ (* (- (to_rep4 logfilestate__split_fields12) 1) 1024) (to_rep5 (select logfilestate__split_fields13 (to_rep2 logfilestate__split_fields7)))))) (in_range6 auditalarm1))) (and (in_range6 auditalarm2) (ite (not (= oldalarm1 auditalarm2)) (and (and (<= 1 (to_rep4 logfilestate__split_fields19)) (= (to_rep3 logfilestate__split_fields15) (+ (* (- (to_rep4 logfilestate__split_fields19) 1) 1024) (to_rep5 (select logfilestate__split_fields20 (to_rep2 logfilestate__split_fields14)))))) (in_range6 auditalarm3)) (and (= auditsystemfault1 auditsystemfault) (and (= auditalarm3 auditalarm2) (and (= (mk___split_fields1 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20) (mk___split_fields1 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13)) (and (= logfilesstatus1 logfilesstatus) (= logfiles1 logfiles)))))))))) (and (and (= oldalarm2 (mk_int__ref oldalarm1)) (and (= auditsystemfault2 (mk_bool__ref auditsystemfault1)) (and (= auditalarm4 (mk_int__ref auditalarm3)) (and (and (= logfilestate__split_fields21 logfilestate__split_fields14) (and (= logfilestate__split_fields22 logfilestate__split_fields15) (and (and (= logfilestate__split_fields23 logfilestate__split_fields16) (and (= logfilestate__split_fields24 logfilestate__split_fields17) (and (= logfilestate__split_fields25 logfilestate__split_fields18) (= logfilestate__split_fields26 logfilestate__split_fields19)))) (= logfilestate__split_fields27 logfilestate__split_fields20)))) (and (= logfilesstatus1 logfilesstatus2) (= logfiles1 logfiles2)))))) (and (= oldalarm3 oldalarm1) (and (= auditsystemfault3 auditsystemfault1) (and (= auditalarm5 auditalarm3) (and (= logfilestate__split_fields28 (mk___split_fields1 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20)) (and (= logfilesstatus3 logfilesstatus1) (= logfiles3 logfiles1)))))))))
(assert (not (<= 1 (to_rep4 logfilestate__split_fields26))))
(check-sat)
(exit)
