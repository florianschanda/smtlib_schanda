...
(define-fun dynamic_invariant2 ((temp___expr_549 Int) (temp___is_init_545 Bool) (temp___skip_constant_546 Bool) (temp___do_toplevel_547 Bool) (temp___do_typ_inv_548 Bool)) Bool (=> (or (= temp___is_init_545 true) (<= 0 2)) (in_range5 temp___expr_549)))
...
(define-fun dynamic_invariant3 ((temp___expr_1197 Int) (temp___is_init_1193 Bool) (temp___skip_constant_1194 Bool) (temp___do_toplevel_1195 Bool) (temp___do_typ_inv_1196 Bool)) Bool (=> (or (= temp___is_init_1193 true) (<= 0 1)) (in_range6 temp___expr_1197)))
...
(assert (forall ((x logfilecountt)) (! (in_range7 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range10 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1204 Int) (temp___is_init_1200 Bool) (temp___skip_constant_1201 Bool) (temp___do_toplevel_1202 Bool) (temp___do_typ_inv_1203 Bool)) Bool (=> (or (= temp___is_init_1200 true) (<= 0 17)) (in_range7 temp___expr_1204)))
(define-fun dynamic_invariant8 ((temp___expr_1211 Int) (temp___is_init_1207 Bool) (temp___skip_constant_1208 Bool) (temp___do_toplevel_1209 Bool) (temp___do_typ_inv_1210 Bool)) Bool (=> (or (= temp___is_init_1207 true) (<= 1 17)) (in_range8 temp___expr_1211)))
(define-fun dynamic_invariant9 ((temp___expr_1324 Int) (temp___is_init_1320 Bool) (temp___skip_constant_1321 Bool) (temp___do_toplevel_1322 Bool) (temp___do_typ_inv_1323 Bool)) Bool (=> (or (= temp___is_init_1320 true) (<= 0 2)) (in_range12 temp___expr_1324)))
(define-fun dynamic_invariant10 ((temp___expr_1218 Int) (temp___is_init_1214 Bool) (temp___skip_constant_1215 Bool) (temp___do_toplevel_1216 Bool) (temp___do_typ_inv_1217 Bool)) Bool (=> (or (= temp___is_init_1214 true) (<= 0 17408)) (in_range10 temp___expr_1218)))
(define-fun dynamic_invariant11 ((temp___expr_1249 Int) (temp___is_init_1245 Bool) (temp___skip_constant_1246 Bool) (temp___do_toplevel_1247 Bool) (temp___do_typ_inv_1248 Bool)) Bool (=> (or (= temp___is_init_1245 true) (<= 0 1024)) (in_range11 temp___expr_1249)))
(assert true)
...
(assert (forall ((temp___1273 Int)) (=> (dynamic_invariant8 temp___1273 true true true true) (forall ((temp___1274 Int)) (= (to_rep3 (select (temp___1271 temp___1273) temp___1274)) temp___1273)))))
...
(assert (and (and (<= 1 (to_rep2 logfilestate__split_fields12)) (= (to_rep4 logfilestate__split_fields8) (+ (* (- (to_rep2 logfilestate__split_fields12) 1) 1024) (to_rep5 (select logfilestate__split_fields13 (to_rep3 logfilestate__split_fields7)))))) (in_range6 auditalarm1)))
(assert (in_range6 auditalarm2))
(assert (=> (not (= oldalarm1 auditalarm2)) (and (and (<= 1 (to_rep2 logfilestate__split_fields19)) (= (to_rep4 logfilestate__split_fields15) (+ (* (- (to_rep2 logfilestate__split_fields19) 1) 1024) (to_rep5 (select logfilestate__split_fields20 (to_rep3 logfilestate__split_fields14)))))) (in_range6 auditalarm3))))
...
(assert (not (<= 1 (to_rep2 logfilestate__split_fields26))))
(check-sat)
(exit)
