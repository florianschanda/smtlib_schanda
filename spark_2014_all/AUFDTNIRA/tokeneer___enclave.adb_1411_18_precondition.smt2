...
(assert (=> (= result3 true) (=> (= result4 true) (and (= o11 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range3 o11)))))
...
(assert (=> (= result5 true) (and (= o5 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= o5 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6))))))))
...
(assert (=> (= result5 true) (=> (= result6 true) (and (= o4 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (in_range3 o4)))))
...
(assert (and (= result7 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= result7 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6)))))))
(assert (= result7 true))
