...
(assert (and (= o9 (islocked (int__content currentlatch4) (us_private__content state38) (us_split_fields__content1 latchtimeout__split_fields7))) (= (= o9 true) (= (int__content currentlatch4) 0))))
(assert (= o10 (ite (not (= o9 true)) true false)))
(assert (= result3 (ite (= o10 true) (islocked currentlatch (us_private__content state3) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
...
(assert (=> (= result3 true) (=> (= result4 true) (and (= o11 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o11)))))
(assert (=> (= result3 true) (=> (= result4 true) (= o12 (ite (= o11 3) true false)))))
(assert (=> (= result3 true) (=> (not (= result4 true)) (= o12 false))))
(assert (=> (not (= result3 true)) (= o12 (distinct 1 0))))
(assert (and (= o3 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields6)))) (and (in_range2 o3) (= o3 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields6)))))))
(assert (= result5 (ite (= o3 1) true false)))
(assert (=> (= result5 true) (and (= o5 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= o5 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6))))))))
...
(assert (=> (= result5 true) (=> (= result6 true) (and (= o4 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (in_range4 o4)))))
(assert (=> (= result5 true) (=> (= result6 true) (= o7 (ite (= o4 3) true false)))))
(assert (=> (= result5 true) (=> (not (= result6 true)) (= o7 false))))
(assert (=> (= result5 true) (= o8 (ite (= o7 false) o6 true))))
(assert (=> (not (= result5 true)) (= o8 (distinct 1 0))))
(assert (and (= result7 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields6)))) (= (= result7 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields6)))))))
(assert (= result7 true))
