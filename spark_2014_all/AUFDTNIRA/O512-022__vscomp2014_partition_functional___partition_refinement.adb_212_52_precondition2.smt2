...
(assert (<= 0 k))
(assert (<= k 5))
(assert (and (= o11 (get (model__ (mk___rep p__split_discrs (us_split_fields__content p__split_fields4))) (to_rep3 (select (map__content f8) k)))) (= (bool_eq o11 (get (model__ (mk___rep p__split_discrs (us_split_fields__content p__split_fields4))) (to_rep3 (select (map__content f8) k)))) true)))
...
(assert (not (<= 0 (to_rep3 (select (map__content f8) k)))))
(check-sat)
(exit)
