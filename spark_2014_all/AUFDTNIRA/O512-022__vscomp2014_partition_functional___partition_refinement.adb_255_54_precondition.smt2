...
(assert (= result2 true))
(assert (and (= o3 (key (mk___rep3 d__split_discrs d__split_fields2) c)) (and (in_range4 o3) (= o3 (get2 (keys (mk___rep3 d__split_discrs d__split_fields2)) (get3 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c))))))
