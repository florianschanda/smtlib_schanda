...
(assert (ite (= (= k3 0) true) (= (bool_eq item3 (to_rep1 item__first) (to_rep1 item__last) item (to_rep1 item__first) (to_rep1 item__last)) true) (=> (= (not (= k3 0)) true) (forall ((idx5 Int)) (=> (and (<= (to_rep1 item__first) idx5) (<= idx5 (to_rep1 item__last))) (ite (and (<= o19 idx5) (<= idx5 (- (+ o19 k3) 1))) (= (to_rep (select item3 idx5)) (to_rep (select buf3 (+ (- idx5 o19) 1)))) (= (to_rep (select item3 idx5)) (to_rep (select item idx5)))))))))
(assert (not (in_range1 (+ last2 k3))))
(check-sat)
(exit)
