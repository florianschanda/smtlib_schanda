...
(declare-datatypes () ((us_split_fields8 (mk___split_fields4 (rec__cert__attr__priv__contentst__id us_rep2) (rec__cert__attr__priv__contentst__notbefore us_rep) (rec__cert__attr__priv__contentst__notafter us_rep) (rec__cert__attr__priv__contentst__mechanism algorithmt) (rec__cert__attr__priv__contentst__basecertid us_rep2) (rec__cert__attr__priv__contentst__role privileget) (rec__cert__attr__priv__contentst__clearance us_rep3)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields8)) us_rep2 (rec__cert__attr__priv__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields8)) us_rep (rec__cert__attr__priv__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields8)) us_rep (rec__cert__attr__priv__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields8)) algorithmt (rec__cert__attr__priv__contentst__mechanism a))
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields8)) us_rep2 (rec__cert__attr__priv__contentst__basecertid a))
(define-fun us_split_fields_Role__projection ((a us_split_fields8)) privileget (rec__cert__attr__priv__contentst__role a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields8)) us_rep3 (rec__cert__attr__priv__contentst__clearance a))
(declare-datatypes () ((us_split_fields__ref4 (mk___split_fields__ref4 (us_split_fields__content4 us_split_fields8)))))
(define-fun us_split_fields__ref___16__projection ((a us_split_fields__ref4)) us_split_fields8 (us_split_fields__content4 a))
...
(define-fun bool_eq5 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (and (and (and (= (bool_eq3 (rec__cert__attr__priv__contentst__id (us_split_fields9 a)) (rec__cert__attr__priv__contentst__id (us_split_fields9 b))) true) (= (bool_eq1 (rec__cert__attr__priv__contentst__notbefore (us_split_fields9 a)) (rec__cert__attr__priv__contentst__notbefore (us_split_fields9 b))) true)) (= (bool_eq1 (rec__cert__attr__priv__contentst__notafter (us_split_fields9 a)) (rec__cert__attr__priv__contentst__notafter (us_split_fields9 b))) true)) (= (to_rep9 (rec__cert__attr__priv__contentst__mechanism (us_split_fields9 a))) (to_rep9 (rec__cert__attr__priv__contentst__mechanism (us_split_fields9 b))))) (= (bool_eq3 (rec__cert__attr__priv__contentst__basecertid (us_split_fields9 a)) (rec__cert__attr__priv__contentst__basecertid (us_split_fields9 b))) true)) (= (to_rep10 (rec__cert__attr__priv__contentst__role (us_split_fields9 a))) (to_rep10 (rec__cert__attr__priv__contentst__role (us_split_fields9 b))))) (= (bool_eq4 (rec__cert__attr__priv__contentst__clearance (us_split_fields9 a)) (rec__cert__attr__priv__contentst__clearance (us_split_fields9 b))) true)) true false))
...
(define-fun contentst__ref___4__projection ((a contentst__ref)) us_rep4 (contentst__content a))
(declare-sort fart 0)
...
(define-fun to_rep11 ((x fart)) Int (fartqtint x))
(declare-fun of_rep11 (Int) fart)
(assert (forall ((x fart)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x fart)) (! (in_range12 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(define-fun to_rep12 ((x bytet)) Int (bytetqtint x))
(declare-fun of_rep12 (Int) bytet)
(assert (forall ((x bytet)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x bytet)) (! (in_range13 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun bool_eq6 ((a (Array Int bytet)) (a__first Int) (a__last Int) (b (Array Int bytet)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_167 Int)) (=> (and (<= a__first temp___idx_167) (<= temp___idx_167 a__last)) (= (to_rep12 (select a temp___idx_167)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_167))))))) true false))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_167 Int)) (=> (and (<= a__first temp___idx_167) (<= temp___idx_167 a__last)) (= (to_rep12 (select a temp___idx_167)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_167)))))))))))
...
(declare-fun user_eq20 (templatelengtht templatelengtht) Bool)
(declare-const dummy20 templatelengtht)
...
(define-fun to_rep13 ((x templatelengtht)) Int (templatelengthtqtint x))
(declare-fun of_rep13 (Int) templatelengtht)
(assert (forall ((x templatelengtht)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x templatelengtht)) (! (in_range14 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(declare-datatypes () ((us_split_fields10 (mk___split_fields5 (rec__iandatypes__templatet__length templatelengtht) (rec__iandatypes__templatet__requiredmaxfar fart) (rec__iandatypes__templatet__id (Array Int character)) (rec__iandatypes__templatet__pad (Array Int bytet))))))
(define-fun us_split_fields_Length__projection ((a us_split_fields10)) templatelengtht (rec__iandatypes__templatet__length a))
(define-fun us_split_fields_RequiredMaxFAR__projection ((a us_split_fields10)) fart (rec__iandatypes__templatet__requiredmaxfar a))
(define-fun us_split_fields_ID__2__projection ((a us_split_fields10)) (Array Int character) (rec__iandatypes__templatet__id a))
(define-fun us_split_fields_Pad__projection ((a us_split_fields10)) (Array Int bytet) (rec__iandatypes__templatet__pad a))
...
(define-fun bool_eq7 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (= (to_rep13 (rec__iandatypes__templatet__length (us_split_fields11 a))) (to_rep13 (rec__iandatypes__templatet__length (us_split_fields11 b)))) (= (to_rep11 (rec__iandatypes__templatet__requiredmaxfar (us_split_fields11 a))) (to_rep11 (rec__iandatypes__templatet__requiredmaxfar (us_split_fields11 b))))) (= (bool_eq (rec__iandatypes__templatet__id (us_split_fields11 a)) 1 40 (rec__iandatypes__templatet__id (us_split_fields11 b)) 1 40) true)) (= (bool_eq6 (rec__iandatypes__templatet__pad (us_split_fields11 a)) 1 452 (rec__iandatypes__templatet__pad (us_split_fields11 b)) 1 452) true)) true false))
...
(declare-datatypes () ((templatet__ref (mk_templatet__ref (templatet__content us_rep5)))))
(define-fun templatet__ref___projection ((a templatet__ref)) us_rep5 (templatet__content a))
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__attr__ianda__contentst__id us_rep2) (rec__cert__attr__ianda__contentst__notbefore us_rep) (rec__cert__attr__ianda__contentst__notafter us_rep) (rec__cert__attr__ianda__contentst__mechanism algorithmt) (rec__cert__attr__ianda__contentst__basecertid us_rep2) (rec__cert__attr__ianda__contentst__template us_rep5)))))
(define-fun us_split_fields_ID__8__projection ((a us_split_fields12)) us_rep2 (rec__cert__attr__ianda__contentst__id a))
(define-fun us_split_fields_NotBefore__6__projection ((a us_split_fields12)) us_rep (rec__cert__attr__ianda__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__6__projection ((a us_split_fields12)) us_rep (rec__cert__attr__ianda__contentst__notafter a))
(define-fun us_split_fields_Mechanism__6__projection ((a us_split_fields12)) algorithmt (rec__cert__attr__ianda__contentst__mechanism a))
(define-fun us_split_fields_BaseCertID__4__projection ((a us_split_fields12)) us_rep2 (rec__cert__attr__ianda__contentst__basecertid a))
(define-fun us_split_fields_Template__projection ((a us_split_fields12)) us_rep5 (rec__cert__attr__ianda__contentst__template a))
...
(define-fun bool_eq8 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__attr__ianda__contentst__id (us_split_fields13 a)) (rec__cert__attr__ianda__contentst__id (us_split_fields13 b))) true) (= (bool_eq1 (rec__cert__attr__ianda__contentst__notbefore (us_split_fields13 a)) (rec__cert__attr__ianda__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq1 (rec__cert__attr__ianda__contentst__notafter (us_split_fields13 a)) (rec__cert__attr__ianda__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep9 (rec__cert__attr__ianda__contentst__mechanism (us_split_fields13 a))) (to_rep9 (rec__cert__attr__ianda__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq3 (rec__cert__attr__ianda__contentst__basecertid (us_split_fields13 a)) (rec__cert__attr__ianda__contentst__basecertid (us_split_fields13 b))) true)) (= (bool_eq7 (rec__cert__attr__ianda__contentst__template (us_split_fields13 a)) (rec__cert__attr__ianda__contentst__template (us_split_fields13 b))) true)) true false))
...
(define-fun contentst__ref___6__projection ((a contentst__ref1)) us_rep6 (contentst__content1 a))
...
(declare-fun user_eq24 (keyidt keyidt) Bool)
(declare-const dummy24 keyidt)
...
(assert (forall ((x keyidt)) (! (in_range15 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(declare-fun user_eq25 (keylengtht keylengtht) Bool)
(declare-const dummy25 keylengtht)
...
(assert (forall ((x keylengtht)) (! (in_range16 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(define-fun bool_eq9 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (= (to_rep9 (rec__cryptotypes__keypartt__algorithmid (us_split_fields15 a))) (to_rep9 (rec__cryptotypes__keypartt__algorithmid (us_split_fields15 b)))) (= (to_rep14 (rec__cryptotypes__keypartt__keyid (us_split_fields15 a))) (to_rep14 (rec__cryptotypes__keypartt__keyid (us_split_fields15 b))))) (= (to_rep15 (rec__cryptotypes__keypartt__keylength (us_split_fields15 a))) (to_rep15 (rec__cryptotypes__keypartt__keylength (us_split_fields15 b))))) true false))
...
(declare-fun user_eq26 (us_rep7 us_rep7) Bool)
(declare-const dummy26 us_rep7)
...
(define-fun bool_eq10 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__id__contentst__id (us_split_fields17 a)) (rec__cert__id__contentst__id (us_split_fields17 b))) true) (= (bool_eq1 (rec__cert__id__contentst__notbefore (us_split_fields17 a)) (rec__cert__id__contentst__notbefore (us_split_fields17 b))) true)) (= (bool_eq1 (rec__cert__id__contentst__notafter (us_split_fields17 a)) (rec__cert__id__contentst__notafter (us_split_fields17 b))) true)) (= (to_rep9 (rec__cert__id__contentst__mechanism (us_split_fields17 a))) (to_rep9 (rec__cert__id__contentst__mechanism (us_split_fields17 b))))) (= (bool_eq2 (rec__cert__id__contentst__subject (us_split_fields17 a)) (rec__cert__id__contentst__subject (us_split_fields17 b))) true)) (= (bool_eq9 (rec__cert__id__contentst__subjectpublickey (us_split_fields17 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields17 b))) true)) true false))
...
(declare-fun user_eq27 (us_rep8 us_rep8) Bool)
(declare-const dummy27 us_rep8)
(declare-datatypes () ((contentst__ref2 (mk_contentst__ref2 (contentst__content2 us_rep8)))))
(define-fun contentst__ref___2__projection ((a contentst__ref2)) us_rep8 (contentst__content2 a))
...
(declare-fun user_eq28 (certificatestatus certificatestatus) Bool)
(declare-const dummy28 certificatestatus)
...
(assert (forall ((x certificatestatus)) (! (= (of_rep16 (to_rep16 x)) x) :pattern ((to_rep16 x)))))
(assert (forall ((x certificatestatus)) (! (in_range17 (to_rep16 x)) :pattern ((to_rep16 x)))))
(assert (forall ((x Int)) (! (=> (in_range17 x) (= (to_rep16 (of_rep16 x)) x)) :pattern ((to_rep16 (of_rep16 x))))))
(declare-datatypes () ((us_split_fields18 (mk___split_fields9 (rec__usertoken__valididcertt__valid Bool) (rec__usertoken__valididcertt__idstatus certificatestatus) (rec__usertoken__valididcertt__contents us_rep8)))))
...
(define-fun us_split_fields_Contents__projection ((a us_split_fields18)) us_rep8 (rec__usertoken__valididcertt__contents a))
(declare-datatypes () ((us_split_fields__ref9 (mk___split_fields__ref9 (us_split_fields__content9 us_split_fields18)))))
(define-fun us_split_fields__ref___27__projection ((a us_split_fields__ref9)) us_split_fields18 (us_split_fields__content9 a))
...
(define-fun bool_eq11 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (= (rec__usertoken__valididcertt__valid (us_split_fields19 a)) (rec__usertoken__valididcertt__valid (us_split_fields19 b))) (= (to_rep16 (rec__usertoken__valididcertt__idstatus (us_split_fields19 a))) (to_rep16 (rec__usertoken__valididcertt__idstatus (us_split_fields19 b))))) (= (bool_eq10 (rec__usertoken__valididcertt__contents (us_split_fields19 a)) (rec__usertoken__valididcertt__contents (us_split_fields19 b))) true)) true false))
...
(define-fun in_range18 ((x Int)) Bool (and (<= 1 x) (<= x 17)))
...
(declare-fun user_eq30 (logfileindext logfileindext) Bool)
(declare-const dummy30 logfileindext)
...
(define-fun to_rep17 ((x logfileindext)) Int (logfileindextqtint x))
(declare-fun of_rep17 (Int) logfileindext)
(assert (forall ((x logfileindext)) (! (= (of_rep17 (to_rep17 x)) x) :pattern ((to_rep17 x)))))
(assert (forall ((x logfileindext)) (! (in_range18 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(define-fun in_range19 ((x Int)) Bool (and (<= 0 x) (<= x 17408)))
...
(declare-fun user_eq31 (logentrycountt logentrycountt) Bool)
(declare-const dummy31 logentrycountt)
...
(define-fun to_rep18 ((x logentrycountt)) Int (logentrycounttqtint x))
(declare-fun of_rep18 (Int) logentrycountt)
(assert (forall ((x logentrycountt)) (! (= (of_rep18 (to_rep18 x)) x) :pattern ((to_rep18 x)))))
(assert (forall ((x logentrycountt)) (! (in_range19 (to_rep18 x)) :pattern ((to_rep18 x)))))
(assert (forall ((x Int)) (! (=> (in_range19 x) (= (to_rep18 (of_rep18 x)) x)) :pattern ((to_rep18 (of_rep18 x))))))
...
(define-fun in_range20 ((x Int)) Bool (and (<= 0 x) (<= x 17)))
...
(declare-fun user_eq32 (logfilecountt logfilecountt) Bool)
(declare-const dummy32 logfilecountt)
...
(define-fun to_rep19 ((x logfilecountt)) Int (logfilecounttqtint x))
(declare-fun of_rep19 (Int) logfilecountt)
(assert (forall ((x logfilecountt)) (! (= (of_rep19 (to_rep19 x)) x) :pattern ((to_rep19 x)))))
(assert (forall ((x logfilecountt)) (! (in_range20 (to_rep19 x)) :pattern ((to_rep19 x)))))
(assert (forall ((x Int)) (! (=> (in_range20 x) (= (to_rep19 (of_rep19 x)) x)) :pattern ((to_rep19 (of_rep19 x))))))
...
(define-fun bool_eq12 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep17 (select a temp___idx_175)) (to_rep17 (select b (+ (- b__first a__first) temp___idx_175))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq12 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep17 (select a temp___idx_175)) (to_rep17 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
(declare-const dummy33 (Array Int logfileindext))
...
(declare-fun user_eq33 ((Array Int logfileindext) (Array Int logfileindext)) Bool)
...
(define-fun us_split_fields_Length__2__projection ((a us_split_fields20)) logfilecountt (rec__auditlog__logfilelistt__length a))
...
(define-fun bool_eq13 ((a us_rep10) (b us_rep10)) Bool (ite (and (and (and (= (bool_eq12 (rec__auditlog__logfilelistt__list (us_split_fields21 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields21 b)) 1 17) true) (= (to_rep17 (rec__auditlog__logfilelistt__head (us_split_fields21 a))) (to_rep17 (rec__auditlog__logfilelistt__head (us_split_fields21 b))))) (= (to_rep17 (rec__auditlog__logfilelistt__lasti (us_split_fields21 a))) (to_rep17 (rec__auditlog__logfilelistt__lasti (us_split_fields21 b))))) (= (to_rep19 (rec__auditlog__logfilelistt__length (us_split_fields21 a))) (to_rep19 (rec__auditlog__logfilelistt__length (us_split_fields21 b))))) true false))
...
(define-fun in_range21 ((x Int)) Bool (and (<= 0 x) (<= x 1024)))
...
(declare-fun user_eq35 (fileentrycountt fileentrycountt) Bool)
(declare-const dummy35 fileentrycountt)
...
(define-fun to_rep20 ((x fileentrycountt)) Int (fileentrycounttqtint x))
(declare-fun of_rep20 (Int) fileentrycountt)
(assert (forall ((x fileentrycountt)) (! (= (of_rep20 (to_rep20 x)) x) :pattern ((to_rep20 x)))))
(assert (forall ((x fileentrycountt)) (! (in_range21 (to_rep20 x)) :pattern ((to_rep20 x)))))
(assert (forall ((x Int)) (! (=> (in_range21 x) (= (to_rep20 (of_rep20 x)) x)) :pattern ((to_rep20 (of_rep20 x))))))
...
(define-fun bool_eq14 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep20 (select a temp___idx_176)) (to_rep20 (select b (+ (- b__first a__first) temp___idx_176))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq14 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep20 (select a temp___idx_176)) (to_rep20 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
(declare-const dummy36 (Array Int fileentrycountt))
...
(declare-fun user_eq36 ((Array Int fileentrycountt) (Array Int fileentrycountt)) Bool)
...
(define-fun us_split_fields__ref___11__projection ((a us_split_fields__ref11)) us_split_fields22 (us_split_fields__content11 a))
(declare-datatypes () ((us_rep11 (mk___rep11 (us_split_fields23 us_split_fields22)))))
(define-fun us_rep___12__projection ((a us_rep11)) us_split_fields22 (us_split_fields23 a))
(define-fun bool_eq15 ((a us_rep11) (b us_rep11)) Bool (ite (and (and (and (= (to_rep17 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields23 a))) (to_rep17 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields23 b)))) (= (to_rep18 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields23 a))) (to_rep18 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields23 b))))) (= (bool_eq13 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields23 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields23 b))) true)) (= (bool_eq14 (rec__auditlog__logfilestatet__logfileentries (us_split_fields23 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields23 b)) 1 17) true)) true false))
...
(declare-datatypes () ((t__ref (mk_t__ref (t__content us_rep12)))))
(define-fun t__ref___projection ((a t__ref)) us_rep12 (t__content a))
...
(define-fun bool_eq17 ((a (Array Int us_rep12)) (a__first Int) (a__last Int) (b (Array Int us_rep12)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq16 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true)))) true false))
...
(declare-fun user_eq39 (filestatust filestatust) Bool)
(declare-const dummy39 filestatust)
...
(declare-fun to_rep21 (filestatust) Int)
(declare-fun of_rep21 (Int) filestatust)
(assert (forall ((x filestatust)) (! (= (of_rep21 (to_rep21 x)) x) :pattern ((to_rep21 x)))))
(assert (forall ((x filestatust)) (! (in_range22 (to_rep21 x)) :pattern ((to_rep21 x)))))
(assert (forall ((x Int)) (! (=> (in_range22 x) (= (to_rep21 (of_rep21 x)) x)) :pattern ((to_rep21 (of_rep21 x))))))
...
(assert (forall ((a (Array Int filestatust))) (forall ((first Int)) (! (= (slide5 a first first) a) :pattern ((slide5 a first first))))))
...
(define-fun bool_eq18 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep21 (select a temp___idx_178)) (to_rep21 (select b (+ (- b__first a__first) temp___idx_178))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq18 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep21 (select a temp___idx_178)) (to_rep21 (select b (+ (- b__first a__first) temp___idx_178)))))))))))
...
(define-fun dynamic_invariant ((temp___expr_626 Int) (temp___is_init_622 Bool) (temp___skip_constant_623 Bool) (temp___do_toplevel_624 Bool) (temp___do_typ_inv_625 Bool)) Bool (=> (or (= temp___is_init_622 true) (<= 0 1)) (in_range23 temp___expr_626)))
...
(define-fun dynamic_invariant1 ((temp___expr_1330 us_rep11) (temp___is_init_1326 Bool) (temp___skip_constant_1327 Bool) (temp___do_toplevel_1328 Bool) (temp___do_typ_inv_1329 Bool)) Bool (=> (= temp___do_typ_inv_1329 true) (= (valid_numberlogentries (to_rep17 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields23 temp___expr_1330))) (to_rep18 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields23 temp___expr_1330))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields23 temp___expr_1330)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields23 temp___expr_1330))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1334 us_rep11) (temp___skip_top_level_1335 Bool)) Bool (and (and (and (= (to_rep17 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields23 temp___expr_1334))) 1) (= (to_rep18 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields23 temp___expr_1334))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields23 temp___expr_1334)) (mk___rep10 (mk___split_fields10 (temp_____aggregate_def_1336 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields23 temp___expr_1334)) (temp_____aggregate_def_1340 0))))
(define-fun type_invariant ((temp___1344 us_rep11)) Bool (= (valid_numberlogentries (to_rep17 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields23 temp___1344))) (to_rep18 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields23 temp___1344))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields23 temp___1344)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields23 temp___1344))) true))
...
(declare-fun user_eq41 (tryt tryt) Bool)
(declare-const dummy41 tryt)
...
(define-fun dynamic_invariant2 ((temp___expr_495 Int) (temp___is_init_491 Bool) (temp___skip_constant_492 Bool) (temp___do_toplevel_493 Bool) (temp___do_typ_inv_494 Bool)) Bool (=> (or (= temp___is_init_491 true) (<= 0 2)) (in_range24 temp___expr_495)))
...
(declare-fun user_eq42 (descriptioni descriptioni) Bool)
(declare-const dummy42 descriptioni)
...
(declare-datatypes () ((us_split_fields24 (mk___split_fields12 (rec__usertoken__validiandacertt__valid Bool) (rec__usertoken__validiandacertt__contents us_rep6)))))
(define-fun us_split_fields_Valid__4__projection ((a us_split_fields24)) Bool (rec__usertoken__validiandacertt__valid a))
(define-fun us_split_fields_Contents__4__projection ((a us_split_fields24)) us_rep6 (rec__usertoken__validiandacertt__contents a))
(declare-datatypes () ((us_split_fields__ref12 (mk___split_fields__ref12 (us_split_fields__content12 us_split_fields24)))))
(define-fun us_split_fields__ref___30__projection ((a us_split_fields__ref12)) us_split_fields24 (us_split_fields__content12 a))
(declare-datatypes () ((us_rep13 (mk___rep12 (us_split_fields25 us_split_fields24)))))
(define-fun us_rep___31__projection ((a us_rep13)) us_split_fields24 (us_split_fields25 a))
(define-fun bool_eq19 ((a us_rep13) (b us_rep13)) Bool (ite (and (= (rec__usertoken__validiandacertt__valid (us_split_fields25 a)) (rec__usertoken__validiandacertt__valid (us_split_fields25 b))) (= (bool_eq8 (rec__usertoken__validiandacertt__contents (us_split_fields25 a)) (rec__usertoken__validiandacertt__contents (us_split_fields25 b))) true)) true false))
...
(assert (< usertoken__validiandacertt__valid__first__bit usertoken__validiandacertt__valid__last__bit))
...
(assert (< usertoken__validiandacertt__contents__first__bit usertoken__validiandacertt__contents__last__bit))
(assert (<= 0 usertoken__validiandacertt__contents__position))
(declare-fun user_eq43 (us_rep13 us_rep13) Bool)
(declare-const dummy43 us_rep13)
(declare-datatypes () ((validiandacertt__ref (mk_validiandacertt__ref (validiandacertt__content us_rep13)))))
(define-fun validiandacertt__ref___projection ((a validiandacertt__ref)) us_rep13 (validiandacertt__content a))
(declare-const attr__ATTRIBUTE_ADDRESS14 Int)
(declare-datatypes () ((us_split_fields26 (mk___split_fields13 (rec__usertoken__validprivcertt__valid Bool) (rec__usertoken__validprivcertt__contents us_rep4)))))
(define-fun us_split_fields_Valid__2__projection ((a us_split_fields26)) Bool (rec__usertoken__validprivcertt__valid a))
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields26)) us_rep4 (rec__usertoken__validprivcertt__contents a))
(declare-datatypes () ((us_split_fields__ref13 (mk___split_fields__ref13 (us_split_fields__content13 us_split_fields26)))))
(define-fun us_split_fields__ref___28__projection ((a us_split_fields__ref13)) us_split_fields26 (us_split_fields__content13 a))
(declare-datatypes () ((us_rep14 (mk___rep13 (us_split_fields27 us_split_fields26)))))
(define-fun us_rep___29__projection ((a us_rep14)) us_split_fields26 (us_split_fields27 a))
(define-fun bool_eq20 ((a us_rep14) (b us_rep14)) Bool (ite (and (= (rec__usertoken__validprivcertt__valid (us_split_fields27 a)) (rec__usertoken__validprivcertt__valid (us_split_fields27 b))) (= (bool_eq5 (rec__usertoken__validprivcertt__contents (us_split_fields27 a)) (rec__usertoken__validprivcertt__contents (us_split_fields27 b))) true)) true false))
(declare-const value__size19 Int)
(declare-fun object__size19 (us_rep14) Int)
(declare-const value__alignment19 Int)
(declare-fun object__alignment19 (us_rep14) Int)
(assert (<= 0 value__size19))
(assert (forall ((a us_rep14)) (<= 0 (object__size19 a))))
(assert (<= 0 value__alignment19))
(assert (forall ((a us_rep14)) (<= 0 (object__alignment19 a))))
...
(declare-fun user_eq44 (us_rep14 us_rep14) Bool)
(declare-const dummy44 us_rep14)
(declare-datatypes () ((validprivcertt__ref (mk_validprivcertt__ref (validprivcertt__content us_rep14)))))
(define-fun validprivcertt__ref___projection ((a validprivcertt__ref)) us_rep14 (validprivcertt__content a))
(declare-const attr__ATTRIBUTE_ADDRESS15 Int)
(declare-const attr__ATTRIBUTE_ADDRESS16 Int)
(declare-const c88b (Array Int character))
(declare-const attr__ATTRIBUTE_ADDRESS17 Int)
(declare-const attr__ATTRIBUTE_ADDRESS18 Int)
(declare-fun temp___String_Literal_2745 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2745 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_2745 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_2745 us_void_param) 3)) 107)) (= (to_rep (select (temp___String_Literal_2745 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_2745 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_2745 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_2745 us_void_param) 7)) 66)) (= (to_rep (select (temp___String_Literal_2745 us_void_param) 8)) 97)) (= (to_rep (select (temp___String_Literal_2745 us_void_param) 9)) 100)) :pattern ((temp___String_Literal_2745 us_void_param)))))
...
(define-fun dynamic_invariant4 ((temp___expr_2407 Int) (temp___is_init_2403 Bool) (temp___skip_constant_2404 Bool) (temp___do_toplevel_2405 Bool) (temp___do_typ_inv_2406 Bool)) Bool (=> (or (= temp___is_init_2403 true) (<= 0 3)) (in_range17 temp___expr_2407)))
(define-fun dynamic_invariant5 ((temp___expr_1268 Int) (temp___is_init_1264 Bool) (temp___skip_constant_1265 Bool) (temp___do_toplevel_1266 Bool) (temp___do_typ_inv_1267 Bool)) Bool (=> (or (= temp___is_init_1264 true) (<= 0 17)) (in_range20 temp___expr_1268)))
(define-fun dynamic_invariant6 ((temp___expr_1275 Int) (temp___is_init_1271 Bool) (temp___skip_constant_1272 Bool) (temp___do_toplevel_1273 Bool) (temp___do_typ_inv_1274 Bool)) Bool (=> (or (= temp___is_init_1271 true) (<= 1 17)) (in_range18 temp___expr_1275)))
(define-fun dynamic_invariant7 ((temp___expr_1401 Int) (temp___is_init_1397 Bool) (temp___skip_constant_1398 Bool) (temp___do_toplevel_1399 Bool) (temp___do_typ_inv_1400 Bool)) Bool (=> (or (= temp___is_init_1397 true) (<= 0 2)) (in_range22 temp___expr_1401)))
(define-fun dynamic_invariant8 ((temp___expr_1282 Int) (temp___is_init_1278 Bool) (temp___skip_constant_1279 Bool) (temp___do_toplevel_1280 Bool) (temp___do_typ_inv_1281 Bool)) Bool (=> (or (= temp___is_init_1278 true) (<= 0 17408)) (in_range19 temp___expr_1282)))
(define-fun dynamic_invariant9 ((temp___expr_1313 Int) (temp___is_init_1309 Bool) (temp___skip_constant_1310 Bool) (temp___do_toplevel_1311 Bool) (temp___do_typ_inv_1312 Bool)) Bool (=> (or (= temp___is_init_1309 true) (<= 0 1024)) (in_range21 temp___expr_1313)))
(assert true)
(assert (forall ((currentlogfile Int) (numberlogentries Int)) (forall ((usedlogfiles us_rep10)) (forall ((logfileentries (Array Int fileentrycountt))) (! (= (= (valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries) true) (and (<= 1 (to_rep19 (rec__auditlog__logfilelistt__length (us_split_fields21 usedlogfiles)))) (= numberlogentries (+ (* (- (to_rep19 (rec__auditlog__logfilelistt__length (us_split_fields21 usedlogfiles))) 1) 1024) (to_rep20 (select logfileentries currentlogfile)))))) :pattern ((valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries)))))))
(declare-const rliteral2 fileentrycountt)
(assert (= (fileentrycounttqtint rliteral2) 0))
(assert (forall ((temp___1342 Int)) (=> (dynamic_invariant9 temp___1342 true true true true) (forall ((temp___1343 Int)) (= (select (temp_____aggregate_def_1340 temp___1342) temp___1343) rliteral2)))))
(define-fun dynamic_invariant10 ((temp___expr_651 Int) (temp___is_init_647 Bool) (temp___skip_constant_648 Bool) (temp___do_toplevel_649 Bool) (temp___do_typ_inv_650 Bool)) Bool (=> (or (= temp___is_init_647 true) (<= 1 150)) (in_range25 temp___expr_651)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (forall ((temp___162 Int)) (=> (dynamic_invariant3 temp___162 true true true true) (forall ((temp___163 Int)) (= (to_rep (select (audittypes__nodescription__aggregate_def temp___162) temp___163)) temp___162)))))
(define-fun dynamic_invariant11 ((temp___expr_214 Int) (temp___is_init_210 Bool) (temp___skip_constant_211 Bool) (temp___do_toplevel_212 Bool) (temp___do_typ_inv_213 Bool)) Bool (=> (or (= temp___is_init_210 true) (<= 0 255)) (in_range13 temp___expr_214)))
(define-fun dynamic_invariant12 ((temp___expr_703 Int) (temp___is_init_699 Bool) (temp___skip_constant_700 Bool) (temp___do_toplevel_701 Bool) (temp___do_typ_inv_702 Bool)) Bool (=> (or (= temp___is_init_699 true) (<= 1901 2099)) (in_range2 temp___expr_703)))
(define-fun dynamic_invariant13 ((temp___expr_710 Int) (temp___is_init_706 Bool) (temp___skip_constant_707 Bool) (temp___do_toplevel_708 Bool) (temp___do_typ_inv_709 Bool)) Bool (=> (or (= temp___is_init_706 true) (<= 1 12)) (in_range3 temp___expr_710)))
(define-fun dynamic_invariant14 ((temp___expr_717 Int) (temp___is_init_713 Bool) (temp___skip_constant_714 Bool) (temp___do_toplevel_715 Bool) (temp___do_typ_inv_716 Bool)) Bool (=> (or (= temp___is_init_713 true) (<= 1 31)) (in_range4 temp___expr_717)))
(define-fun dynamic_invariant15 ((temp___expr_749 Int) (temp___is_init_745 Bool) (temp___skip_constant_746 Bool) (temp___do_toplevel_747 Bool) (temp___do_typ_inv_748 Bool)) Bool (=> (or (= temp___is_init_745 true) (<= 0 86399999)) (in_range5 temp___expr_749)))
(define-fun dynamic_invariant16 ((temp___expr_1170 Int) (temp___is_init_1166 Bool) (temp___skip_constant_1167 Bool) (temp___do_toplevel_1168 Bool) (temp___do_typ_inv_1169 Bool)) Bool (=> (or (= temp___is_init_1166 true) (<= 0 2147483647)) (in_range12 temp___expr_1170)))
(define-fun dynamic_invariant17 ((temp___expr_1205 Int) (temp___is_init_1201 Bool) (temp___skip_constant_1202 Bool) (temp___do_toplevel_1203 Bool) (temp___do_typ_inv_1204 Bool)) Bool (=> (or (= temp___is_init_1201 true) (<= 0 4294967295)) (in_range14 temp___expr_1205)))
(define-fun dynamic_invariant18 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range6 temp___expr_402)))
(define-fun dynamic_invariant19 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range7 temp___expr_426)))
(define-fun dynamic_invariant20 ((temp___expr_450 Int) (temp___is_init_446 Bool) (temp___skip_constant_447 Bool) (temp___do_toplevel_448 Bool) (temp___do_typ_inv_449 Bool)) Bool (=> (or (= temp___is_init_446 true) (<= 0 10)) (in_range10 temp___expr_450)))
(define-fun dynamic_invariant21 ((temp___expr_464 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool) (temp___do_typ_inv_463 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 4294967295)) (in_range15 temp___expr_464)))
(define-fun dynamic_invariant22 ((temp___expr_471 Int) (temp___is_init_467 Bool) (temp___skip_constant_468 Bool) (temp___do_toplevel_469 Bool) (temp___do_typ_inv_470 Bool)) Bool (=> (or (= temp___is_init_467 true) (<= 0 128)) (in_range16 temp___expr_471)))
(define-fun dynamic_invariant23 ((temp___expr_593 Int) (temp___is_init_589 Bool) (temp___skip_constant_590 Bool) (temp___do_toplevel_591 Bool) (temp___do_typ_inv_592 Bool)) Bool (=> (or (= temp___is_init_589 true) (<= 0 3)) (in_range11 temp___expr_593)))
(define-fun dynamic_invariant24 ((temp___expr_607 Int) (temp___is_init_603 Bool) (temp___skip_constant_604 Bool) (temp___do_toplevel_605 Bool) (temp___do_typ_inv_606 Bool)) Bool (=> (or (= temp___is_init_603 true) (<= 0 5)) (in_range9 temp___expr_607)))
(define-fun dynamic_invariant25 ((temp___expr_567 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool) (temp___do_typ_inv_566 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 0 4294967295)) (in_range8 temp___expr_567)))
(assert (forall ((temp___1338 Int)) (=> (dynamic_invariant6 temp___1338 true true true true) (forall ((temp___1339 Int)) (= (select (temp_____aggregate_def_1336 temp___1338) temp___1339) rliteral)))))
...
(assert (in_range24 tokentry))
(assert (= (valid_numberlogentries (to_rep17 logfilestate__split_fields) (to_rep18 logfilestate__split_fields1) (mk___rep10 (mk___split_fields10 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6) true))
(assert (in_range23 auditalarm))
(assert (not (= tokentry 2)))
(assert (= result privvalid))
(assert (= privvalid1 (distinct 0 0)))
(assert (= result1 iandavalid))
(assert (= iandavalid1 (distinct 0 0)))
