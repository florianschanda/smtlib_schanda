...
(define-fun dynamic_invariant ((temp___expr_441 Int) (temp___is_init_438 Bool) (temp___skip_constant_439 Bool) (temp___do_toplevel_440 Bool)) Bool (=> (or (= temp___is_init_438 true) (<= 0 2)) (in_range2 temp___expr_441)))
...
(define-fun dynamic_invariant1 ((temp___expr_558 Int) (temp___is_init_555 Bool) (temp___skip_constant_556 Bool) (temp___do_toplevel_557 Bool)) Bool (=> (or (= temp___is_init_555 true) (<= 0 1)) (in_range3 temp___expr_558)))
(declare-sort descriptioni 0)
(define-fun in_range4 ((x Int)) Bool (and (<= 1 x) (<= x 150)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq3 (descriptioni descriptioni) Bool)
(declare-const dummy3 descriptioni)
...
(assert (forall ((x yearst)) (! (in_range5 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x monthst)) (! (in_range6 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x dayst)) (! (in_range7 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x millisecst)) (! (in_range8 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep5 (select a temp___idx_153)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep5 (select a (+ i 1))) (to_rep5 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep5 (select b (+ i 1))) (to_rep5 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep8 (select a temp___idx_154)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_154)))))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq4 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep8 (select a (+ i 1))) (to_rep8 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq4 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep8 (select b (+ i 1))) (to_rep8 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant2 ((temp___expr_1187 us_rep2) (temp___is_init_1184 Bool) (temp___skip_constant_1185 Bool) (temp___do_toplevel_1186 Bool)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1187))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1187))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1187)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1187))) true))
(define-fun default_initial_assumption ((temp___expr_1191 us_rep2) (temp___skip_top_level_1192 Bool)) Bool (and (and (and (= (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1191))) 1) (= (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1191))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1191)) (mk___rep1 (mk___split_fields1 (temp___1193 1) (of_rep5 1) (of_rep5 1) (of_rep7 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1191)) (temp___1197 0))))
(define-fun type_invariant ((temp___1201 us_rep2)) Bool (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1201))) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1201))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1201)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1201))) true))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep9 (select a temp___idx_156)) (to_rep9 (select b (+ (- b__first a__first) temp___idx_156)))))))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare3 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq8 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep9 (select a (+ i 1))) (to_rep9 (select b (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare3 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq8 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep9 (select b (+ i 1))) (to_rep9 (select a (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
...
(declare-fun to_rep13 (serialnumbert) Int)
...
(define-fun bool_eq10 ((a us_rep5) (b us_rep5)) Bool (ite (and (= (bool_eq9 (rec__certtypes__idt__issuer (us_split_fields9 a)) (rec__certtypes__idt__issuer (us_split_fields9 b))) true) (= (to_rep13 (rec__certtypes__idt__serialnumber (us_split_fields9 a))) (to_rep13 (rec__certtypes__idt__serialnumber (us_split_fields9 b))))) true false))
...
(define-fun in_range18 ((x Int)) Bool (and (<= 0 x) (<= x 3)))
...
(declare-fun user_eq26 (privileget privileget) Bool)
(declare-const dummy26 privileget)
...
(assert (forall ((x privileget)) (! (in_range18 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__attr__priv__contentst__id us_rep5) (rec__cert__attr__priv__contentst__notbefore us_rep) (rec__cert__attr__priv__contentst__notafter us_rep) (rec__cert__attr__priv__contentst__mechanism algorithmt) (rec__cert__attr__priv__contentst__basecertid us_rep5) (rec__cert__attr__priv__contentst__role privileget) (rec__cert__attr__priv__contentst__clearance us_rep6)))))
(define-fun us_split_fields_ID__6__projection ((a us_split_fields12)) us_rep5 (rec__cert__attr__priv__contentst__id a))
(define-fun us_split_fields_NotBefore__4__projection ((a us_split_fields12)) us_rep (rec__cert__attr__priv__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__4__projection ((a us_split_fields12)) us_rep (rec__cert__attr__priv__contentst__notafter a))
(define-fun us_split_fields_Mechanism__4__projection ((a us_split_fields12)) algorithmt (rec__cert__attr__priv__contentst__mechanism a))
(define-fun us_split_fields_BaseCertID__2__projection ((a us_split_fields12)) us_rep5 (rec__cert__attr__priv__contentst__basecertid a))
(define-fun us_split_fields_Role__projection ((a us_split_fields12)) privileget (rec__cert__attr__priv__contentst__role a))
(define-fun us_split_fields_Clearance__projection ((a us_split_fields12)) us_rep6 (rec__cert__attr__priv__contentst__clearance a))
...
(define-fun us_rep___17__projection ((a us_rep7)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq12 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (and (and (= (bool_eq10 (rec__cert__attr__priv__contentst__id (us_split_fields13 a)) (rec__cert__attr__priv__contentst__id (us_split_fields13 b))) true) (= (bool_eq1 (rec__cert__attr__priv__contentst__notbefore (us_split_fields13 a)) (rec__cert__attr__priv__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq1 (rec__cert__attr__priv__contentst__notafter (us_split_fields13 a)) (rec__cert__attr__priv__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep10 (rec__cert__attr__priv__contentst__mechanism (us_split_fields13 a))) (to_rep10 (rec__cert__attr__priv__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq10 (rec__cert__attr__priv__contentst__basecertid (us_split_fields13 a)) (rec__cert__attr__priv__contentst__basecertid (us_split_fields13 b))) true)) (= (to_rep14 (rec__cert__attr__priv__contentst__role (us_split_fields13 a))) (to_rep14 (rec__cert__attr__priv__contentst__role (us_split_fields13 b))))) (= (bool_eq11 (rec__cert__attr__priv__contentst__clearance (us_split_fields13 a)) (rec__cert__attr__priv__contentst__clearance (us_split_fields13 b))) true)) true false))
...
(assert (forall ((x fart)) (! (in_range20 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(assert (forall ((x bytet)) (! (in_range21 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq13 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_145 Int)) (=> (and (<= a__first temp___idx_145) (<= temp___idx_145 a__last)) (= (to_rep17 (select a temp___idx_145)) (to_rep17 (select b (+ (- b__first a__first) temp___idx_145)))))))))))
...
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare4 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq13 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep17 (select a (+ i 1))) (to_rep17 (select b (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bytet)) (b (Array Int bytet))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare4 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq13 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep17 (select b (+ i 1))) (to_rep17 (select a (+ j 1))))))))))) :pattern ((compare4 a a_first a_last b b_first b_last))))))
(declare-const dummy32 (Array Int bytet))
(declare-const value__size11 Int)
(declare-fun object__size11 ((Array Int bytet)) Int)
(declare-const value__component__size3 Int)
(declare-fun object__component__size3 ((Array Int bytet)) Int)
(declare-const value__alignment11 Int)
(declare-fun object__alignment11 ((Array Int bytet)) Int)
(assert (<= 0 value__size11))
(assert (forall ((a (Array Int bytet))) (<= 0 (object__size11 a))))
(assert (<= 0 value__component__size3))
(assert (forall ((a (Array Int bytet))) (<= 0 (object__component__size3 a))))
(assert (<= 0 value__alignment11))
(assert (forall ((a (Array Int bytet))) (<= 0 (object__alignment11 a))))
...
(assert (forall ((x templatelengtht)) (! (in_range22 (to_rep18 x)) :pattern ((to_rep18 x)))))
...
(define-fun bool_eq14 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (= (to_rep18 (rec__iandatypes__templatet__length (us_split_fields15 a))) (to_rep18 (rec__iandatypes__templatet__length (us_split_fields15 b)))) (= (to_rep16 (rec__iandatypes__templatet__requiredmaxfar (us_split_fields15 a))) (to_rep16 (rec__iandatypes__templatet__requiredmaxfar (us_split_fields15 b))))) (= (bool_eq (rec__iandatypes__templatet__id (us_split_fields15 a)) 1 40 (rec__iandatypes__templatet__id (us_split_fields15 b)) 1 40) true)) (= (bool_eq13 (rec__iandatypes__templatet__pad (us_split_fields15 a)) 1 452 (rec__iandatypes__templatet__pad (us_split_fields15 b)) 1 452) true)) true false))
...
(declare-datatypes () ((templatet__ref (mk_templatet__ref (templatet__content us_rep8)))))
(define-fun templatet__ref___projection ((a templatet__ref)) us_rep8 (templatet__content a))
(declare-datatypes () ((us_split_fields16 (mk___split_fields8 (rec__cert__attr__ianda__contentst__id us_rep5) (rec__cert__attr__ianda__contentst__notbefore us_rep) (rec__cert__attr__ianda__contentst__notafter us_rep) (rec__cert__attr__ianda__contentst__mechanism algorithmt) (rec__cert__attr__ianda__contentst__basecertid us_rep5) (rec__cert__attr__ianda__contentst__template us_rep8)))))
(define-fun us_split_fields_ID__8__projection ((a us_split_fields16)) us_rep5 (rec__cert__attr__ianda__contentst__id a))
(define-fun us_split_fields_NotBefore__6__projection ((a us_split_fields16)) us_rep (rec__cert__attr__ianda__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__6__projection ((a us_split_fields16)) us_rep (rec__cert__attr__ianda__contentst__notafter a))
...
(define-fun us_split_fields_BaseCertID__4__projection ((a us_split_fields16)) us_rep5 (rec__cert__attr__ianda__contentst__basecertid a))
(define-fun us_split_fields_Template__projection ((a us_split_fields16)) us_rep8 (rec__cert__attr__ianda__contentst__template a))
...
(define-fun bool_eq15 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (and (and (and (= (bool_eq10 (rec__cert__attr__ianda__contentst__id (us_split_fields17 a)) (rec__cert__attr__ianda__contentst__id (us_split_fields17 b))) true) (= (bool_eq1 (rec__cert__attr__ianda__contentst__notbefore (us_split_fields17 a)) (rec__cert__attr__ianda__contentst__notbefore (us_split_fields17 b))) true)) (= (bool_eq1 (rec__cert__attr__ianda__contentst__notafter (us_split_fields17 a)) (rec__cert__attr__ianda__contentst__notafter (us_split_fields17 b))) true)) (= (to_rep10 (rec__cert__attr__ianda__contentst__mechanism (us_split_fields17 a))) (to_rep10 (rec__cert__attr__ianda__contentst__mechanism (us_split_fields17 b))))) (= (bool_eq10 (rec__cert__attr__ianda__contentst__basecertid (us_split_fields17 a)) (rec__cert__attr__ianda__contentst__basecertid (us_split_fields17 b))) true)) (= (bool_eq14 (rec__cert__attr__ianda__contentst__template (us_split_fields17 a)) (rec__cert__attr__ianda__contentst__template (us_split_fields17 b))) true)) true false))
...
(define-fun contentst__ref___6__projection ((a contentst__ref1)) us_rep9 (contentst__content1 a))
...
(assert (forall ((x keyidt)) (! (in_range23 (to_rep19 x)) :pattern ((to_rep19 x)))))
...
(assert (forall ((x keylengtht)) (! (in_range24 (to_rep20 x)) :pattern ((to_rep20 x)))))
(assert (forall ((x Int)) (! (=> (in_range24 x) (= (to_rep20 (of_rep20 x)) x)) :pattern ((to_rep20 (of_rep20 x))))))
...
(define-fun us_split_fields__ref___2__projection ((a us_split_fields__ref9)) us_split_fields18 (us_split_fields__content9 a))
(declare-datatypes () ((us_rep10 (mk___rep9 (us_split_fields19 us_split_fields18)))))
(define-fun us_rep___2__projection ((a us_rep10)) us_split_fields18 (us_split_fields19 a))
(define-fun bool_eq16 ((a us_rep10) (b us_rep10)) Bool (ite (and (and (= (to_rep10 (rec__cryptotypes__keypartt__algorithmid (us_split_fields19 a))) (to_rep10 (rec__cryptotypes__keypartt__algorithmid (us_split_fields19 b)))) (= (to_rep19 (rec__cryptotypes__keypartt__keyid (us_split_fields19 a))) (to_rep19 (rec__cryptotypes__keypartt__keyid (us_split_fields19 b))))) (= (to_rep20 (rec__cryptotypes__keypartt__keylength (us_split_fields19 a))) (to_rep20 (rec__cryptotypes__keypartt__keylength (us_split_fields19 b))))) true false))
...
(declare-datatypes () ((us_split_fields20 (mk___split_fields10 (rec__cert__id__contentst__id us_rep5) (rec__cert__id__contentst__notbefore us_rep) (rec__cert__id__contentst__notafter us_rep) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep4) (rec__cert__id__contentst__subjectpublickey us_rep10)))))
(define-fun us_split_fields_ID__4__projection ((a us_split_fields20)) us_rep5 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__2__projection ((a us_split_fields20)) us_rep (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__2__projection ((a us_split_fields20)) us_rep (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__2__projection ((a us_split_fields20)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields20)) us_rep4 (rec__cert__id__contentst__subject a))
...
(define-fun us_split_fields__ref___14__projection ((a us_split_fields__ref10)) us_split_fields20 (us_split_fields__content10 a))
(declare-datatypes () ((us_rep11 (mk___rep10 (us_split_fields21 us_split_fields20)))))
(define-fun us_rep___15__projection ((a us_rep11)) us_split_fields20 (us_split_fields21 a))
(define-fun bool_eq17 ((a us_rep11) (b us_rep11)) Bool (ite (and (and (and (and (and (= (bool_eq10 (rec__cert__id__contentst__id (us_split_fields21 a)) (rec__cert__id__contentst__id (us_split_fields21 b))) true) (= (bool_eq1 (rec__cert__id__contentst__notbefore (us_split_fields21 a)) (rec__cert__id__contentst__notbefore (us_split_fields21 b))) true)) (= (bool_eq1 (rec__cert__id__contentst__notafter (us_split_fields21 a)) (rec__cert__id__contentst__notafter (us_split_fields21 b))) true)) (= (to_rep10 (rec__cert__id__contentst__mechanism (us_split_fields21 a))) (to_rep10 (rec__cert__id__contentst__mechanism (us_split_fields21 b))))) (= (bool_eq9 (rec__cert__id__contentst__subject (us_split_fields21 a)) (rec__cert__id__contentst__subject (us_split_fields21 b))) true)) (= (bool_eq16 (rec__cert__id__contentst__subjectpublickey (us_split_fields21 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields21 b))) true)) true false))
...
(define-fun contentst__ref___2__projection ((a contentst__ref2)) us_rep11 (contentst__content2 a))
(declare-sort certificatestatus 0)
(define-fun in_range25 ((x Int)) Bool (and (<= 0 x) (<= x 3)))
...
(declare-fun user_eq41 (certificatestatus certificatestatus) Bool)
(declare-const dummy41 certificatestatus)
...
(declare-fun to_rep21 (certificatestatus) Int)
(declare-fun of_rep21 (Int) certificatestatus)
(assert (forall ((x certificatestatus)) (! (= (of_rep21 (to_rep21 x)) x) :pattern ((to_rep21 x)))))
(assert (forall ((x certificatestatus)) (! (in_range25 (to_rep21 x)) :pattern ((to_rep21 x)))))
(assert (forall ((x Int)) (! (=> (in_range25 x) (= (to_rep21 (of_rep21 x)) x)) :pattern ((to_rep21 (of_rep21 x))))))
(declare-datatypes () ((us_split_fields22 (mk___split_fields11 (rec__usertoken__valididcertt__valid Bool) (rec__usertoken__valididcertt__idstatus certificatestatus) (rec__usertoken__valididcertt__contents us_rep11)))))
...
(define-fun us_split_fields_Contents__projection ((a us_split_fields22)) us_rep11 (rec__usertoken__valididcertt__contents a))
...
(define-fun bool_eq18 ((a us_rep12) (b us_rep12)) Bool (ite (and (and (= (rec__usertoken__valididcertt__valid (us_split_fields23 a)) (rec__usertoken__valididcertt__valid (us_split_fields23 b))) (= (to_rep21 (rec__usertoken__valididcertt__idstatus (us_split_fields23 a))) (to_rep21 (rec__usertoken__valididcertt__idstatus (us_split_fields23 b))))) (= (bool_eq17 (rec__usertoken__valididcertt__contents (us_split_fields23 a)) (rec__usertoken__valididcertt__contents (us_split_fields23 b))) true)) true false))
...
(declare-datatypes () ((us_split_fields24 (mk___split_fields12 (rec__usertoken__validiandacertt__valid Bool) (rec__usertoken__validiandacertt__contents us_rep9)))))
(define-fun us_split_fields_Valid__4__projection ((a us_split_fields24)) Bool (rec__usertoken__validiandacertt__valid a))
(define-fun us_split_fields_Contents__4__projection ((a us_split_fields24)) us_rep9 (rec__usertoken__validiandacertt__contents a))
...
(define-fun bool_eq19 ((a us_rep13) (b us_rep13)) Bool (ite (and (= (rec__usertoken__validiandacertt__valid (us_split_fields25 a)) (rec__usertoken__validiandacertt__valid (us_split_fields25 b))) (= (bool_eq15 (rec__usertoken__validiandacertt__contents (us_split_fields25 a)) (rec__usertoken__validiandacertt__contents (us_split_fields25 b))) true)) true false))
...
(declare-datatypes () ((us_split_fields26 (mk___split_fields13 (rec__usertoken__validprivcertt__valid Bool) (rec__usertoken__validprivcertt__contents us_rep7)))))
(define-fun us_split_fields_Valid__2__projection ((a us_split_fields26)) Bool (rec__usertoken__validprivcertt__valid a))
(define-fun us_split_fields_Contents__2__projection ((a us_split_fields26)) us_rep7 (rec__usertoken__validprivcertt__contents a))
...
(declare-fun temp___String_Literal_2569 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2569 us_void_param) 1)) 84) (= (to_rep (select (temp___String_Literal_2569 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_2569 us_void_param) 3)) 107)) (= (to_rep (select (temp___String_Literal_2569 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_2569 us_void_param) 5)) 110)) (= (to_rep (select (temp___String_Literal_2569 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_2569 us_void_param) 7)) 66)) (= (to_rep (select (temp___String_Literal_2569 us_void_param) 8)) 97)) (= (to_rep (select (temp___String_Literal_2569 us_void_param) 9)) 100)) :pattern ((temp___String_Literal_2569 us_void_param)))))
...
(define-fun dynamic_invariant4 ((temp___expr_2236 Int) (temp___is_init_2233 Bool) (temp___skip_constant_2234 Bool) (temp___do_toplevel_2235 Bool)) Bool (=> (or (= temp___is_init_2233 true) (<= 0 3)) (in_range25 temp___expr_2236)))
(define-fun dynamic_invariant5 ((temp___expr_1153 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 17)) (in_range11 temp___expr_1153)))
(define-fun dynamic_invariant6 ((temp___expr_1132 Int) (temp___is_init_1129 Bool) (temp___skip_constant_1130 Bool) (temp___do_toplevel_1131 Bool)) Bool (=> (or (= temp___is_init_1129 true) (<= 1 17)) (in_range9 temp___expr_1132)))
(define-fun dynamic_invariant7 ((temp___expr_1257 Int) (temp___is_init_1254 Bool) (temp___skip_constant_1255 Bool) (temp___do_toplevel_1256 Bool)) Bool (=> (or (= temp___is_init_1254 true) (<= 0 2)) (in_range13 temp___expr_1257)))
(define-fun dynamic_invariant8 ((temp___expr_1138 Int) (temp___is_init_1135 Bool) (temp___skip_constant_1136 Bool) (temp___do_toplevel_1137 Bool)) Bool (=> (or (= temp___is_init_1135 true) (<= 0 17408)) (in_range10 temp___expr_1138)))
(define-fun dynamic_invariant9 ((temp___expr_1172 Int) (temp___is_init_1169 Bool) (temp___skip_constant_1170 Bool) (temp___do_toplevel_1171 Bool)) Bool (=> (or (= temp___is_init_1169 true) (<= 0 1024)) (in_range12 temp___expr_1172)))
(assert true)
...
(define-fun dynamic_invariant10 ((temp___expr_580 Int) (temp___is_init_577 Bool) (temp___skip_constant_578 Bool) (temp___do_toplevel_579 Bool)) Bool (=> (or (= temp___is_init_577 true) (<= 1 150)) (in_range4 temp___expr_580)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant11 ((temp___expr_188 Int) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool)) Bool (=> (or (= temp___is_init_185 true) (<= 0 255)) (in_range21 temp___expr_188)))
(define-fun dynamic_invariant12 ((temp___expr_626 Int) (temp___is_init_623 Bool) (temp___skip_constant_624 Bool) (temp___do_toplevel_625 Bool)) Bool (=> (or (= temp___is_init_623 true) (<= 1901 2099)) (in_range5 temp___expr_626)))
(define-fun dynamic_invariant13 ((temp___expr_632 Int) (temp___is_init_629 Bool) (temp___skip_constant_630 Bool) (temp___do_toplevel_631 Bool)) Bool (=> (or (= temp___is_init_629 true) (<= 1 12)) (in_range6 temp___expr_632)))
(define-fun dynamic_invariant14 ((temp___expr_638 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range7 temp___expr_638)))
(define-fun dynamic_invariant15 ((temp___expr_666 Int) (temp___is_init_663 Bool) (temp___skip_constant_664 Bool) (temp___do_toplevel_665 Bool)) Bool (=> (or (= temp___is_init_663 true) (<= 0 86399999)) (in_range8 temp___expr_666)))
(define-fun dynamic_invariant16 ((temp___expr_1044 Int) (temp___is_init_1041 Bool) (temp___skip_constant_1042 Bool) (temp___do_toplevel_1043 Bool)) Bool (=> (or (= temp___is_init_1041 true) (<= 0 2147483647)) (in_range20 temp___expr_1044)))
(define-fun dynamic_invariant17 ((temp___expr_1075 Int) (temp___is_init_1072 Bool) (temp___skip_constant_1073 Bool) (temp___do_toplevel_1074 Bool)) Bool (=> (or (= temp___is_init_1072 true) (<= 0 4294967295)) (in_range22 temp___expr_1075)))
(define-fun dynamic_invariant18 ((temp___expr_359 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 40)) (in_range15 temp___expr_359)))
(define-fun dynamic_invariant19 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 4294967295)) (in_range16 temp___expr_380)))
(define-fun dynamic_invariant20 ((temp___expr_402 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 10)) (in_range14 temp___expr_402)))
(define-fun dynamic_invariant21 ((temp___expr_414 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 0 4294967295)) (in_range23 temp___expr_414)))
(define-fun dynamic_invariant22 ((temp___expr_420 Int) (temp___is_init_417 Bool) (temp___skip_constant_418 Bool) (temp___do_toplevel_419 Bool)) Bool (=> (or (= temp___is_init_417 true) (<= 0 128)) (in_range24 temp___expr_420)))
(define-fun dynamic_invariant23 ((temp___expr_529 Int) (temp___is_init_526 Bool) (temp___skip_constant_527 Bool) (temp___do_toplevel_528 Bool)) Bool (=> (or (= temp___is_init_526 true) (<= 0 3)) (in_range18 temp___expr_529)))
(define-fun dynamic_invariant24 ((temp___expr_541 Int) (temp___is_init_538 Bool) (temp___skip_constant_539 Bool) (temp___do_toplevel_540 Bool)) Bool (=> (or (= temp___is_init_538 true) (<= 0 5)) (in_range19 temp___expr_541)))
(define-fun dynamic_invariant25 ((temp___expr_505 Int) (temp___is_init_502 Bool) (temp___skip_constant_503 Bool) (temp___do_toplevel_504 Bool)) Bool (=> (or (= temp___is_init_502 true) (<= 0 4294967295)) (in_range17 temp___expr_505)))
