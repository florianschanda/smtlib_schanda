...
(assert (<= 0 j))
(assert (<= j 5))
(assert (not (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) (to_rep4 (select f j)))))) j)))
(check-sat)
(exit)
