...
(define-fun tint_arrayD1__ref___10__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___10__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t411b__ref (mk_t411b__ref (t411b__content integer)))))
(define-fun t411b__ref___projection ((a t411b__ref)) integer (t411b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t412b__ref (mk_t412b__ref (t412b__content us_t2)))))
(define-fun t412b__ref___projection ((a t412b__ref)) us_t2 (t412b__content a))
...
(define-fun tnumber_array_typeD1__ref___19__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___19__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t415b__ref (mk_t415b__ref (t415b__content integer)))))
(define-fun t415b__ref___projection ((a t415b__ref)) integer (t415b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t416b__ref (mk_t416b__ref (t416b__content us_t4)))))
(define-fun t416b__ref___projection ((a t416b__ref)) us_t4 (t416b__content a))
...
(declare-datatypes () ((t417b__ref (mk_t417b__ref (t417b__content integer)))))
(define-fun t417b__ref___projection ((a t417b__ref)) integer (t417b__content a))
...
(define-fun tint_arrayB__ref___10__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def (Int Int Int Int) us_t2)
(assert (forall ((temp___1827 Int) (temp___1828 Int) (temp___1829 Int) (temp___1830 Int)) (let ((temp___1826 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def temp___1827 temp___1828 temp___1829 temp___1830))) (and (=> (dynamic_property10 (+ (first1 source) 9) (+ (first1 source) 10) temp___1829 temp___1830) (and (= (first5 temp___1826) temp___1829) (= (last5 temp___1826) temp___1830))) (and (= (select (to_array2 temp___1826) (+ (+ (first1 source) 9) 0)) (of_rep1 temp___1827)) (= (select (to_array2 temp___1826) (+ (+ (first1 source) 9) 1)) (of_rep1 temp___1828)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___19__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___1836 Int) (temp___1837 Int) (temp___1838 Int)) (let ((temp___1835 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def temp___1836 temp___1837 temp___1838))) (and (=> (dynamic_property11 (+ (first1 source) 9) (+ (first1 source) 10) temp___1837 temp___1838) (and (= (first9 temp___1835) temp___1837) (= (last9 temp___1835) temp___1838))) (forall ((temp___1839 Int)) (= (select (to_array4 temp___1835) temp___1839) (of_rep1 temp___1836)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_527 us_t3) (temp___is_init_524 Bool) (temp___skip_constant_525 Bool) (temp___do_toplevel_526 Bool)) Bool (=> (not (= temp___skip_constant_525 true)) (and (dynamic_property6 (+ (first1 source) 9) (+ (first1 source) 10) (first7 temp___expr_527) (last7 temp___expr_527)) (and (= (first7 temp___expr_527) (+ (first1 source) 9)) (= (last7 temp___expr_527) (+ (first1 source) 10))))))
...
(declare-const temp___1853 Int)
(declare-const o4 Int)
(declare-const o5 character)
(declare-const o6 Int)
(declare-const o7 Bool)
(declare-const temp___1854 Int)
...
(declare-const temp___1833 (Array Int integer))
(declare-const temp___18331 t2)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___1841 (Array Int integer))
(declare-const temp___18411 t4)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume1 t3)
...
(declare-const temp___1844 (Array Int integer))
...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 51)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 8))) 54)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 9))) 52)) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def 3 9 (+ (to_rep1 (first (rt source))) 9) (+ (+ (to_rep1 (first (rt source))) 9) 1))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def 3 9 (+ (to_rep1 (first (rt source))) 9) (+ (+ (to_rep1 (first (rt source))) 9) 1))))) (+ (+ (to_rep1 (first (rt source))) 9) 1)))
(assert (= (mk___t2 temp___1833 temp___18331) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def 3 9 (+ (to_rep1 (first (rt source))) 9) (+ (+ (to_rep1 (first (rt source))) 9) 1))))
(assert (= (ite (<= (to_rep1 (first4 temp___18331)) (to_rep1 (last4 temp___18331))) (+ (- (to_rep1 (last4 temp___18331)) (to_rep1 (first4 temp___18331))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 9)) 1) 0)))
(assert (= (slide1 temp___1833 (to_rep1 (first4 temp___18331)) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 9)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)))
(assert (= (mk___t4 temp___1841 temp___18411) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___18411)) (to_rep1 (last8 temp___18411))) (+ (- (to_rep1 (last8 temp___18411)) (to_rep1 (first8 temp___18411))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 9)) 1) 0)))
(assert (= (slide1 temp___1841 (to_rep1 (first8 temp___18411)) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 9)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= temp___1847 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (= temp___1848 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___1847))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= temp___1846 index2)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= temp___1844 n1)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= o41 index2)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= o42 (select n1 o41))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= o43 (to_rep1 o42))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= o43 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= o44 index2)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= o45 (select (elts source) o44))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= o46 (to_rep o45))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o46))) (ite (= (= o46 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o46 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o46 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o46 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o46 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o46 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o46 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o46 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o46 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o46 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= (to_rep1 o47) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= o48 index2)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= o49 (store n1 o48 o47))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= n1 result4)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= n2 o49)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (and (and (forall ((temp___1845 Int)) (=> (and (<= (to_rep1 n__first) temp___1845) (<= temp___1845 (to_rep1 n__last))) (=> (< index3 temp___1845) (= (select n3 temp___1845) (select temp___1844 temp___1845))))) (=> (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 9) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= index3 temp___1848)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= index3 index5)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= n3 n5)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= index6 index3)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= n6 n3)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= index8 index6)))
(assert (=> (and (<= temp___1847 index2) (<= index2 temp___1848)) (= n8 n6)))
(assert (=> (not (and (<= temp___1847 index2) (<= index2 temp___1848))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___1847 index2) (<= index2 temp___1848))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___1847 index2) (<= index2 temp___1848))) (= index8 index2)))
(assert (=> (not (and (<= temp___1847 index2) (<= index2 temp___1848))) (= n8 n1)))
...
(assert (and (= temp___1849 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___1849) (<= temp___1849 (to_rep1 n__last))))
(assert (= o77 temp___1849))
...
(assert (= target1 o81))
(assert (<= (- 9) target1))
(assert (and (= temp___1850 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1850) (<= temp___1850 (to_rep1 n__last))))
(assert (= o82 temp___1850))
(assert (= o83 (select (map__content1 n7) o82)))
(assert (= o84 (to_rep1 o83)))
(assert (= o85 (* o84 10)))
(assert (and (= o86 o85) (in_range1 o85)))
(assert (= o87 (- target1 o86)))
(assert (and (= o88 o87) (in_range1 o87)))
(assert (= result10 (mk_int__ref target1)))
(assert (= target2 o88))
(assert (<= (- 39) target2))
(assert (not (in_range1 (- target2 2147483600))))
(check-sat)
(exit)
