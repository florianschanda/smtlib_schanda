...
(assert (not (<= (to_rep2 (rec__partition_refinement__interval__last (us_split_fields3 (get (model__ (mk___rep p__split_discrs (us_split_fields__content p__split_fields4))) k)))) 5)))
(check-sat)
(exit)
