...
(define-fun dynamic_invariant ((temp___expr_385 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 0 1)) (in_range4 temp___expr_385)))
...
(define-fun dynamic_invariant1 ((temp___expr_1045 us_rep2) (temp___is_init_1042 Bool) (temp___skip_constant_1043 Bool) (temp___do_toplevel_1044 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1045))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1045))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1045)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1045))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_1269 Int) (temp___is_init_1266 Bool) (temp___skip_constant_1267 Bool) (temp___do_toplevel_1268 Bool)) Bool (=> (or (= temp___is_init_1266 true) (<= 0 4294967295)) (in_range10 temp___expr_1269)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1431 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 8)) 99)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 11)) 101)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 13)) 83)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 14)) 116)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 15)) 111)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 17)) 101)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 19)) 119)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 21)) 105)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 22)) 116)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 23)) 101)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 25)) 101)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 26)) 114)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 27)) 114)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 28)) 111)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 29)) 114)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 31)) 45)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 33)) 115)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 34)) 116)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 35)) 97)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 36)) 116)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 37)) 101)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 38)) 32)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 39)) 119)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 40)) 105)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 41)) 108)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 42)) 108)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 43)) 32)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 44)) 98)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 45)) 101)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 46)) 32)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 47)) 108)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 48)) 111)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 49)) 115)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 50)) 116)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 51)) 32)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 52)) 97)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 53)) 116)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 54)) 32)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 55)) 80)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 56)) 111)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 57)) 119)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 58)) 101)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 59)) 114)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 60)) 32)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 61)) 68)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 62)) 111)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 63)) 119)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 64)) 110)) (= (to_rep (select (temp___String_Literal_1431 us_void_param) 65)) 46)) :pattern ((temp___String_Literal_1431 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_1011 Int) (temp___is_init_1008 Bool) (temp___skip_constant_1009 Bool) (temp___do_toplevel_1010 Bool)) Bool (=> (or (= temp___is_init_1008 true) (<= 0 17)) (in_range7 temp___expr_1011)))
(define-fun dynamic_invariant8 ((temp___expr_990 Int) (temp___is_init_987 Bool) (temp___skip_constant_988 Bool) (temp___do_toplevel_989 Bool)) Bool (=> (or (= temp___is_init_987 true) (<= 1 17)) (in_range5 temp___expr_990)))
(define-fun dynamic_invariant9 ((temp___expr_1115 Int) (temp___is_init_1112 Bool) (temp___skip_constant_1113 Bool) (temp___do_toplevel_1114 Bool)) Bool (=> (or (= temp___is_init_1112 true) (<= 0 2)) (in_range9 temp___expr_1115)))
(define-fun dynamic_invariant10 ((temp___expr_996 Int) (temp___is_init_993 Bool) (temp___skip_constant_994 Bool) (temp___do_toplevel_995 Bool)) Bool (=> (or (= temp___is_init_993 true) (<= 0 17408)) (in_range6 temp___expr_996)))
(define-fun dynamic_invariant11 ((temp___expr_1030 Int) (temp___is_init_1027 Bool) (temp___skip_constant_1028 Bool) (temp___do_toplevel_1029 Bool)) Bool (=> (or (= temp___is_init_1027 true) (<= 0 1024)) (in_range8 temp___expr_1030)))
(assert true)
