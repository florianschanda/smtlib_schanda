...
(assert (not (not (not (= (to_rep5 logfilestate__split_fields5) 0)))))
(assert (not (and (= (to_rep5 logfilestate__split_fields5) 1) (< (to_rep6 (select logfilestate__split_fields6 (to_rep3 (select logfilestate__split_fields2 (to_rep3 logfilestate__split_fields3))))) 1024))))
...
(assert (< archivedfilecount1 (to_rep5 logfilestate__split_fields5)))
(assert (= (to_rep4 logfilestate__split_fields1) (+ (* (- (to_rep5 logfilestate__split_fields5) 1) 1024) (to_rep6 (select logfilestate__split_fields6 (to_rep3 logfilestate__split_fields))))))
(assert (and (and (and (=> (<= 1 17) (in_range5 fileindex1)) (=> (<= 1 17) (in_range5 fileindexinusedlist2))) (=> (<= 0 17) (in_range7 archivedfilecount2))) (and (< archivedfilecount2 4) (< archivedfilecount2 (to_rep5 logfilestate__split_fields5)))))
(assert (and (= o4 (- (to_rep5 logfilestate__split_fields5) 1)) (in_range6 (- (to_rep5 logfilestate__split_fields5) 1))))
(assert (= o5 (* o4 1024)))
(assert (and (= o6 o5) (in_range11 o5)))
(assert (= o7 (+ o6 (to_rep6 (select logfilestate__split_fields6 (to_rep3 logfilestate__split_fields))))))
(assert (not (in_range11 o7)))
(check-sat)
(exit)
