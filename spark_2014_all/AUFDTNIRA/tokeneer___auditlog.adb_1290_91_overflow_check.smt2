...
(assert (= (to_rep3 logfilestate__split_fields1) (+ (* (- (to_rep4 logfilestate__split_fields5) 1) 1024) (to_rep5 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))))))
(assert (and (and (and (=> (<= 0 17) (in_range9 archivedfilecount3)) (=> (<= 1 17) (in_range6 fileindex2))) (=> (<= 1 17) (in_range6 fileindexinusedlist3))) (and (< archivedfilecount3 4) (< archivedfilecount3 (to_rep4 logfilestate__split_fields5)))))
(assert (and (= o4 (- (to_rep4 logfilestate__split_fields5) 1)) (in_range8 (- (to_rep4 logfilestate__split_fields5) 1))))
(assert (= o5 (* o4 1024)))
(assert (and (= o6 o5) (in_range7 o5)))
(assert (= o7 (+ o6 (to_rep5 (select logfilestate__split_fields6 (to_rep2 logfilestate__split_fields))))))
(assert (not (in_range7 o7)))
(check-sat)
(exit)
