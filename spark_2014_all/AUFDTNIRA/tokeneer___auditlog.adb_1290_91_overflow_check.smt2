...
(assert (and (= o4 (- (to_rep2 logfilestate__split_fields5) 1)) (in_range9 (- (to_rep2 logfilestate__split_fields5) 1))))
(assert (= o5 (* o4 1024)))
(assert (and (= o6 o5) (in_range8 o5)))
(assert (= o7 (+ o6 (to_rep5 (select logfilestate__split_fields6 (to_rep3 logfilestate__split_fields))))))
