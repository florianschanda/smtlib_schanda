...
(assert (< (* (* j4 l2) 2) length1))
(assert (not (= (sorted (mk___t (map__content a10) (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* (* j4 l2) 2)) (ite (< (* l2 2) (- length1 (* (* j4 l2) 2))) (* l2 2) (- length1 (* (* j4 l2) 2)))) true)))
(check-sat)
(exit)
