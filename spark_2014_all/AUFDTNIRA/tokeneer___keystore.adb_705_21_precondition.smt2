...
(assert (dynamic_predicate (mk___t1 temp___1671 temp___16711)))
(assert (= (mk___t1 o o1) (mk___t1 temp___1671 temp___16711)))
(assert (= o2 (convertretvaltotext retval1 (mk___t1 o o1))))
(assert (= o2 o3))
(assert (= (mk 1 150) o4))
