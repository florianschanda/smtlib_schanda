...
(assert (and (= result (enrolmentisinprogress status (us_private__content state))) (= (= result true) (in_range24 status))))
(assert (=> (= result true) (and (= o25 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o25 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result true) (= o26 (ite (not (= o25 true)) true false))))
(assert (=> (= result true) (and (= o24 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o24 true) (in_range4 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result true) (= o27 (ite (not (= o24 true)) true false))))
(assert (=> (= result true) (= o28 (ite (= o27 true) o26 false))))
(assert (=> (not (= result true)) (= o28 (distinct 1 0))))
(assert (and (= result1 (statusisshutdown status (us_private__content state))) (= (= result1 true) (= status 8))))
(assert (=> (= result1 true) (and (= o20 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (and (in_range1 o20) (= o20 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result1 true) (= o21 (ite (= o20 0) true false))))
(assert (=> (= result1 true) (and (= o19 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o19 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result1 true) (= o22 (ite (not (= o19 true)) true false))))
(assert (=> (= result1 true) (= o23 (ite (= o22 true) o21 false))))
(assert (=> (not (= result1 true)) (= o23 (distinct 1 0))))
(assert (and (= result2 (statusisenclavequiescent status (us_private__content state))) (= (= result2 true) (= status 3))))
(assert (=> (= result2 true) (and (= o17 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o17 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result2 true) (= o18 (ite (not (= o17 true)) true false))))
(assert (=> (not (= result2 true)) (= o18 (distinct 1 0))))
(assert (and (= o12 (statusiswaitingfinishadminop status (us_private__content state))) (= (= o12 true) (= status 7))))
(assert (and (= o13 (statusiswaitingstartadminop status (us_private__content state))) (= (= o13 true) (= status 6))))
(assert (= result3 (ite (= o13 false) o12 true)))
(assert (=> (= result3 true) (and (= o14 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o14 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result3 true) (and (= o15 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o15 true) (in_range4 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result3 true) (= o16 (ite (= o15 true) o14 false))))
(assert (=> (not (= result3 true)) (= o16 (distinct 1 0))))
(assert (and (= o8 (statusiswaitingremoveadmintokenfail status (us_private__content state))) (= (= o8 true) (= status 4))))
(assert (and (= o9 (statusisgotadmintoken status (us_private__content state))) (= (= o9 true) (= status 5))))
(assert (= result4 (ite (= o9 false) o8 true)))
(assert (=> (= result4 true) (and (= o10 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o10 true) (in_range4 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result4 true) (= o11 (ite (not (= o10 true)) true false))))
(assert (=> (not (= result4 true)) (= o11 (distinct 1 0))))
(assert (and (= result6 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= result6 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields)))))))
(assert (=> (= result6 true) (and (= o6 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields)))) (in_range3 o6))))
(assert (=> (= result6 true) (= result5 (ite (= o6 4) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o7 (statusiswaitingstartadminop status (us_private__content state))) (= (= o7 true) (= status 6)))))
(assert (=> (not (= result5 true)) (= o7 (distinct 1 0))))
(assert (and (= o3 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o3 true) (in_range4 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields)))))))
(assert (= result7 (ite (not (= o3 true)) true false)))
(assert (=> (= result7 true) (and (= o4 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o4 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields))))))))
(assert (=> (= result7 true) (= o5 (ite (not (= o4 true)) true false))))
(assert (=> (not (= result7 true)) (= o5 (distinct 1 0))))
(assert (and (= o (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields)))) (and (in_range1 o) (= o (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields)))))))
(assert (= result8 (ite (= o 1) true false)))
(assert (= result8 true))
(assert (and (= o1 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= o1 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields)))))))
(assert (= o2 (ite (not (= o1 true)) true false)))
(assert (and (= result9 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields)))) (= (= result9 true) (in_range3 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields)))))))
(assert (= result9 true))
