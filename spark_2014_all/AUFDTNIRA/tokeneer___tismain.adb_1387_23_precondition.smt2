...
(assert (and (and (and (and (and (and (=> (<= 0 8) (in_range29 status2)) (=> (<= 0 1) (in_range1 tokenpresence2))) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true)) (=> (<= 0 1) (in_range8 auditalarm2))) (=> (<= 0 2) (in_range7 tokentry2))) (=> (<= 0 4294967295) (in_range6 tokenid2))) (=> (<= 0 1) (in_range26 currentlatch2))))
(assert (and (= result (enrolmentisinprogress status2 (let ((subject state7)) state15))) (= (= result true) (in_range30 status2))))
(assert (=> (= result true) (and (= o29 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o29 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result true) (= o30 (ite (not (= o29 true)) true false))))
(assert (=> (= result true) (and (= o28 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o28 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
...
(assert (and (= result1 (statusisshutdown status2 (let ((subject state7)) state15))) (= (= result1 true) (= status2 8))))
(assert (=> (= result1 true) (and (= o24 (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (and (in_range2 o24) (= o24 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result1 true) (= o25 (ite (= o24 0) true false))))
(assert (=> (= result1 true) (and (= o23 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o23 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
...
(assert (and (= result2 (statusisenclavequiescent status2 (let ((subject state7)) state15))) (= (= result2 true) (= status2 3))))
(assert (=> (= result2 true) (and (= o21 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o21 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result2 true) (= o22 (ite (not (= o21 true)) true false))))
(assert (=> (not (= result2 true)) (= o22 (of_int 1))))
(assert (and (= o16 (statusiswaitingfinishadminop status2 (let ((subject state7)) state15))) (= (= o16 true) (= status2 7))))
(assert (and (= o17 (statusiswaitingstartadminop status2 (let ((subject state7)) state15))) (= (= o17 true) (= status2 6))))
(assert (= result3 (ite (= o17 false) o16 true)))
(assert (=> (= result3 true) (and (= o18 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o18 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result3 true) (and (= o19 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o19 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result3 true) (= o20 (ite (= o19 true) o18 false))))
(assert (=> (not (= result3 true)) (= o20 (of_int 1))))
(assert (and (= o12 (statusiswaitingremoveadmintokenfail status2 (let ((subject state7)) state15))) (= (= o12 true) (= status2 4))))
(assert (and (= o13 (statusisgotadmintoken status2 (let ((subject state7)) state15))) (= (= o13 true) (= status2 5))))
(assert (= result4 (ite (= o13 false) o12 true)))
(assert (=> (= result4 true) (and (= o14 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o14 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result4 true) (= o15 (ite (not (= o14 true)) true false))))
(assert (=> (not (= result4 true)) (= o15 (of_int 1))))
(assert (and (= result6 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= result6 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2)))))))
(assert (=> (= result6 true) (and (= o10 (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (in_range4 o10))))
(assert (=> (= result6 true) (= result5 (ite (= o10 4) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o11 (statusiswaitingstartadminop status2 (let ((subject state7)) state15))) (= (= o11 true) (= status2 6)))))
(assert (=> (not (= result5 true)) (= o11 (of_int 1))))
(assert (and (= o7 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o7 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2)))))))
(assert (= result7 (ite (not (= o7 true)) true false)))
(assert (=> (= result7 true) (and (= o8 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o8 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result7 true) (= o9 (ite (not (= o8 true)) true false))))
(assert (=> (not (= result7 true)) (= o9 (of_int 1))))
(assert (and (= o1 (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (and (in_range2 o1) (= o1 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2)))))))
(assert (= result8 (ite (= o1 1) true false)))
(assert (= result8 true))
(assert (and (= o3 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o3 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2)))))))
(assert (= o4 (ite (not (= o3 true)) true false)))
(assert (and (= result9 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= result9 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2)))))))
(assert (= result9 true))
(assert (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)))
(check-sat)
(exit)
