...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__aggregate_def 2 1 4 6 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__aggregate_def 2 1 4 6 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)) (= (mk___t2 temp___1424 temp___14241) (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__aggregate_def 2 1 4 6 9 9 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (and (= (ite (<= (to_rep1 (first4 temp___14241)) (to_rep1 (last4 temp___14241))) (+ (- (to_rep1 (last4 temp___14241)) (to_rep1 (first4 temp___14241))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1424 (to_rep1 (first4 temp___14241)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__assume) (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__int_array__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (to_rep1 (first (rt source)))) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 9)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)) (= (mk___t4 temp___1432 temp___14321) (aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (and (= (ite (<= (to_rep1 (first8 temp___14321)) (to_rep1 (last8 temp___14321))) (+ (- (to_rep1 (last8 temp___14321)) (to_rep1 (first8 temp___14321))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1432 (to_rep1 (first8 temp___14321)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__assume) (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_146_xxx_xxx__n__assume1)))))) (and (and (dynamic_property6 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 9)))) (and (and (and (= temp___1439 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (= (mk_int__ref result2) (mk_int__ref index)) (= index2 (to_rep1 (first (rt source))))) (ite (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1439)) (and (and (and (= temp___1437 index2) (and (= temp___1435 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o13 index2)) (= o14 (select n1 o13))) (= o15 (to_rep1 o14))) (= o15 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o16 index2)) (= o17 (select (elts source) o16))) (= o18 (to_rep o17))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o18))) (ite (= (= o18 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o18 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o18 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o18 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o18 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o18 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o18 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o18 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o18 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o18 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o19) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o20 index2)) (= o21 (store n1 o20 o19)))) (and (= n1 result3) (= n2 o21))))) (and (and (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (forall ((temp___1436 Int)) (=> (and (<= (to_rep1 n__first) temp___1436) (<= temp___1436 (to_rep1 n__last))) (=> (< index3 temp___1436) (= (select n3 temp___1436) (select temp___1435 temp___1436))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9)))) (= index3 temp___1439)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1)))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (= temp___1440 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (<= (to_rep1 n__first) temp___1440) (<= temp___1440 (to_rep1 n__last))) (= o45 temp___1440))) (= o46 (select (map__content1 n7) o45))) (= o47 (to_rep1 o46))) (and (= result6 (mk_int__ref target)) (= target1 o47))) (and (<= target1 9) (and (and (and (and (and (and (and (and (and (and (= temp___1441 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (<= (to_rep1 n__first) temp___1441) (<= temp___1441 (to_rep1 n__last))) (= o48 temp___1441))) (= o49 (select (map__content1 n7) o48))) (= o50 (to_rep1 o49))) (= o51 (* o50 10))) (and (= o52 o51) (in_range1 o51))) (= o53 (+ target1 o52))) (and (= o54 o53) (in_range1 o53))) (and (= result7 (mk_int__ref target1)) (= target2 o54))) (and (<= target2 99) (and (and (and (and (and (and (and (and (and (and (= temp___1442 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))) (and (and (<= (to_rep1 n__first) temp___1442) (<= temp___1442 (to_rep1 n__last))) (= o55 temp___1442))) (= o56 (select (map__content1 n7) o55))) (= o57 (to_rep1 o56))) (= o58 (* o57 100))) (and (= o59 o58) (in_range1 o58))) (= o60 (+ target2 o59))) (and (= o61 o60) (in_range1 o60))) (and (= result8 (mk_int__ref target2)) (= target3 o61))) (and (<= target3 999) (and (and (and (and (and (and (and (and (and (and (= temp___1443 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))) (and (and (<= (to_rep1 n__first) temp___1443) (<= temp___1443 (to_rep1 n__last))) (= o62 temp___1443))) (= o63 (select (map__content1 n7) o62))) (= o64 (to_rep1 o63))) (= o65 (* o64 1000))) (and (= o66 o65) (in_range1 o65))) (= o67 (+ target3 o66))) (and (= o68 o67) (in_range1 o67))) (and (= result9 (mk_int__ref target3)) (= target4 o68))) (and (<= target4 9999) (and (and (and (and (and (and (and (and (and (and (= temp___1444 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (<= (to_rep1 n__first) temp___1444) (<= temp___1444 (to_rep1 n__last))) (= o69 temp___1444))) (= o70 (select (map__content1 n7) o69))) (= o71 (to_rep1 o70))) (= o72 (* o71 10000))) (and (= o73 o72) (in_range1 o72))) (= o74 (+ target4 o73))) (and (= o75 o74) (in_range1 o74))) (and (= result10 (mk_int__ref target4)) (= target5 o75))) (and (<= target5 99999) (and (and (and (and (and (and (and (and (and (and (= temp___1445 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (<= (to_rep1 n__first) temp___1445) (<= temp___1445 (to_rep1 n__last))) (= o76 temp___1445))) (= o77 (select (map__content1 n7) o76))) (= o78 (to_rep1 o77))) (= o79 (* o78 100000))) (and (= o80 o79) (in_range1 o79))) (= o81 (+ target5 o80))) (and (= o82 o81) (in_range1 o81))) (and (= result11 (mk_int__ref target5)) (= target6 o82))) (and (<= target6 999999) (and (and (and (and (and (and (and (and (and (and (= temp___1446 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))) (and (and (<= (to_rep1 n__first) temp___1446) (<= temp___1446 (to_rep1 n__last))) (= o83 temp___1446))) (= o84 (select (map__content1 n7) o83))) (= o85 (to_rep1 o84))) (= o86 (* o85 1000000))) (and (= o87 o86) (in_range1 o86))) (= o88 (+ target6 o87))) (and (= o89 o88) (in_range1 o88))) (and (= result12 (mk_int__ref target6)) (= target7 o89))) (and (<= target7 6999999) (and (and (and (= o90 (+ target7 2140000000)) (in_range1 (+ target7 2140000000))) (and (= result13 (mk_int__ref target7)) (= target8 o90))) (and (<= target8 2146999999) (and (= result14 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target9 (mk_int__ref target8)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target10 target8))))))))
