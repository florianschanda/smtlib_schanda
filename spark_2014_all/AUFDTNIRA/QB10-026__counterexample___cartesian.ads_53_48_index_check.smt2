...
(declare-const temp___288 (Array Int (Array Int integer)))
...
(declare-const result__9 map__ref1)
(declare-const result_index9 int__ref)
(declare-const index13 int__ref)
(declare-const index29 int__ref)
...
(declare-const index15 int__ref)
(declare-const index211 int__ref)
...
(declare-const result6 integer_product_type__ref)
...
(declare-const index17 int__ref)
...
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= temp___288 result__1)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= temp___286 index11)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= temp___285 result_index1)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= (mk_int__ref result3) index215)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index22 (to_rep (first (rt array2))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= temp___273 result__1))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= temp___271 index22))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= temp___270 result_index1))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (and (= o4 (+ result_index1 1)) (in_range1 (+ result_index1 1))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index1 result4))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index2 o4))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (and (<= (to_rep result____first) result_index2) (<= result_index2 (to_rep result____last))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= o5 result_index2))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= o6 (store result__1 o5 (temp___265 (to_rep (select (elts array1) index11)) (to_rep (select (elts array2) index22))))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__1 result5))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__2 o6))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- index23 (to_rep (first (rt array2))))) 1)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt array2))) j1) (<= j1 index23)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j1 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) index11))))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt array2))) j1) (<= j1 index23)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j1 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j1))))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (and (and (=> (<= 0 2147483647) (in_range2 result_index3)) (=> (<= (to_rep (first (rt array2))) (to_rep (last (rt array2)))) (dynamic_property7 (to_rep (first (rt array2))) (to_rep (last (rt array2))) index23))) (and (<= (to_rep (first (rt array2))) index23) (<= index23 (to_rep (last (rt array2)))))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= index23 (to_rep (last (rt array2)))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= index24 (mk_int__ref index23)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index4 (mk_int__ref result_index3)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__3 result__4))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= index25 index23))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index5 result_index3))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__5 result__3))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= index26 index24))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index6 result_index4))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__6 (mk_map__ref1 result__4)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= index27 index25))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result_index7 result_index5))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (= result__7 result__5))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= index26 (mk_int__ref index22)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= result_index6 (mk_int__ref result_index1)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= result__6 (mk_map__ref1 result__1)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= index27 index22))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= result_index7 result_index1))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (=> (not (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2)))))) (= result__7 result__1))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result_index8 (* (+ (- index12 (to_rep (first (rt array1)))) 1) (length array2)))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (forall ((i1 Int)) (=> (and (<= (to_rep (first (rt array1))) i1) (<= i1 index12)) (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt array2))) j1) (<= j1 (to_rep (last (rt array2))))) (= (to_rep (select (select result__8 (+ (+ (* (- i1 (to_rep (first (rt array1)))) (length array2)) (- j1 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) i1)))))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (forall ((i1 Int)) (=> (and (<= (to_rep (first (rt array1))) i1) (<= i1 index12)) (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt array2))) j1) (<= j1 (to_rep (last (rt array2))))) (= (to_rep (select (select result__8 (+ (+ (* (- i1 (to_rep (first (rt array1)))) (length array2)) (- j1 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j1)))))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (and (and (=> (<= 0 2147483647) (in_range2 result_index8)) (=> (<= (to_rep (first (rt array1))) (to_rep (last (rt array1)))) (dynamic_property6 (to_rep (first (rt array1))) (to_rep (last (rt array1))) index12))) (and (<= (to_rep (first (rt array1))) index12) (<= index12 (to_rep (last (rt array1))))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index12 (to_rep (last (rt array1))))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index29 (mk_int__ref index28))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index13 (mk_int__ref index12))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result_index9 (mk_int__ref result_index8))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result__9 (mk_map__ref1 result__8))))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index210 index28)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index14 index12)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result_index10 result_index8)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result__10 result__8)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index211 index29)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index15 index13)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result_index11 result_index9)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result__11 result__9)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index212 index210)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= index16 index14)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result_index12 result_index10)))
(assert (=> (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (= result__12 result__10)))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= index211 index215)))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= index15 (mk_int__ref index11))))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= result_index11 (mk_int__ref result_index1))))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= result__11 (mk_map__ref1 result__1))))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= index212 index21)))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= index16 index11)))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= result_index12 result_index1)))
(assert (=> (not (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1)))))) (= result__12 result__1)))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep (first (rt array1))) i1) (<= i1 (to_rep (last (rt array1))))) (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt array2))) j1) (<= j1 (to_rep (last (rt array2))))) (= (to_rep (select (select (map__content1 result__11) (+ (+ (* (- i1 (to_rep (first (rt array1)))) (length array2)) (- j1 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) i1))))))))
(assert (forall ((i1 Int)) (=> (and (<= (to_rep (first (rt array1))) i1) (<= i1 (to_rep (last (rt array1))))) (forall ((j1 Int)) (=> (and (<= (to_rep (first (rt array2))) j1) (<= j1 (to_rep (last (rt array2))))) (= (to_rep (select (select (map__content1 result__11) (+ (+ (* (- i1 (to_rep (first (rt array1)))) (length array2)) (- j1 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j1))))))))
(assert (= cartesian__cartesian_product__result3 (mk_integer_product_type__ref cartesian__cartesian_product__result2)))
(assert (= cartesian__cartesian_product__result4 cartesian__cartesian_product__result2))
(assert (= result6 (mk_integer_product_type__ref (mk___t1 cartesian__cartesian_product__result cartesian__cartesian_product__result1))))
(assert (= cartesian__cartesian_product__result2 (mk___t1 (map__content1 result__11) (mk1 (to_rep result____first) (to_rep result____last)))))
(assert (= cartesian__cartesian_product__result5 cartesian__cartesian_product__result3))
(assert (= index213 index211))
(assert (= index17 index15))
(assert (= result_index13 result_index11))
(assert (= result__13 result__11))
(assert (= cartesian__cartesian_product__result6 cartesian__cartesian_product__result4))
(assert (= index214 index212))
(assert (= index18 index16))
(assert (= result_index14 result_index12))
(assert (= result__14 result__12))
(assert (<= (to_rep (first (rt array1))) i))
(assert (<= i (to_rep (last (rt array1)))))
(assert (<= (to_rep (first (rt array2))) j))
(assert (<= j (to_rep (last (rt array2)))))
(assert (and (<= (to_rep (first (rt array2))) j) (<= j (to_rep (last (rt array2))))))
(assert (= o7 j))
(assert (= o8 (select (elts array2) o7)))
(assert (= o9 (to_rep o8)))
(assert (not (<= (to_rep (first (rt array1))) i)))
(check-sat)
(exit)
