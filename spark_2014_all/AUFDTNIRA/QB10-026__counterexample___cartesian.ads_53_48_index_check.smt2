...
(assert (and (and (and (and (and (and (and (= o (length array2)) (in_range1 (length array2))) (and (and (= o1 (length array1)) (in_range1 (length array1))) (= o2 (* o1 o)))) (and (= o3 o2) (in_range1 o2))) (and (= cartesian__cartesian_product__result_length__assume o3) (in_range2 o3))) (= cartesian__cartesian_product__result_length__assume result_length)) (and (in_range2 result_length) (and (and (and (and (= (to_rep (first6 (rt3 (cartesian__cartesian_product__result__aggregate_def (temp___229 0 0) 1 result_length)))) 1) (and (= (to_rep (last6 (rt3 (cartesian__cartesian_product__result__aggregate_def (temp___229 0 0) 1 result_length)))) result_length) (= (mk___t3 temp___235 temp___2351) (cartesian__cartesian_product__result__aggregate_def (temp___229 0 0) 1 result_length)))) (and (= (ite (<= (to_rep (first6 temp___2351)) (to_rep (last6 temp___2351))) (+ (- (to_rep (last6 temp___2351)) (to_rep (first6 temp___2351))) 1) 0) (ite (<= 1 result_length) (+ (- result_length 1) 1) 0)) (and (= temp___235 cartesian__cartesian_product__result__assume) (= (mk2 (to_rep (first6 temp___2351)) (to_rep (last6 temp___2351))) cartesian__cartesian_product__result__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 result__)) (= result__1 cartesian__cartesian_product__result__assume)) (and (= (to_rep result____first) (to_rep (first4 cartesian__cartesian_product__result__assume1))) (= (to_rep result____last) (to_rep (last4 cartesian__cartesian_product__result__assume1)))))) (and (and (dynamic_property3 1 result_length (to_rep result____first) (to_rep result____last)) (and (= (to_rep result____first) 1) (= (to_rep result____last) result_length))) (and (and (= (mk_int__ref result1) (mk_int__ref result_index)) (= result_index1 0)) (and (in_range2 result_index1) (and (and (and (= (mk_int__ref result2) (mk_int__ref index1)) (= index11 (to_rep (first (rt array1))))) (ite (and (<= (to_rep (first (rt array1))) index11) (<= index11 (to_rep (last (rt array1))))) (and (and (and (= temp___260 result__1) (and (= temp___258 index11) (and (= temp___257 result_index1) (and (and (and (= (mk_int__ref result3) (mk_int__ref index2)) (= index22 (to_rep (first (rt array2))))) (ite (and (<= (to_rep (first (rt array2))) index22) (<= index22 (to_rep (last (rt array2))))) (and (and (and (= temp___245 result__1) (and (= temp___243 index22) (and (= temp___242 result_index1) (and (and (and (= o4 (+ result_index1 1)) (in_range1 (+ result_index1 1))) (and (= result_index1 result4) (= result_index2 o4))) (and (and (and (and (and (<= (to_rep result____first) result_index2) (<= result_index2 (to_rep result____last))) (= o5 result_index2)) (= o6 (store result__1 o5 (temp___237 (to_rep (select (elts array1) index11)) (to_rep (select (elts array2) index22)))))) (and (= result__1 result5) (= result__2 o6))) (and (and (= result_index3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- index23 (to_rep (first (rt array2))))) 1)) (and (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 index23)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) index11))))) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 index23)) (= (to_rep (select (select result__3 (+ (+ (* (- index11 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j9))))))) (and (and (and (=> (<= 0 2147483647) (in_range2 result_index3)) (=> (<= (to_rep (first (rt array2))) (to_rep (last (rt array2)))) (dynamic_property7 (to_rep (first (rt array2))) (to_rep (last (rt array2))) index23))) (and (<= (to_rep (first (rt array2))) index23) (<= index23 (to_rep (last (rt array2)))))) (= index23 (to_rep (last (rt array2))))))))))) (and (and (= index25 (mk_int__ref index23)) (and (= result_index5 (mk_int__ref result_index3)) (= result__3 result__5))) (and (= index26 index23) (and (= result_index6 result_index3) (= result__6 result__3))))) (and (and (= index27 index25) (and (= result_index7 result_index5) (= result__7 (mk_map__ref1 result__5)))) (and (= index28 index26) (and (= result_index8 result_index6) (= result__8 result__6))))) (and (and (= index27 (mk_int__ref index22)) (and (= result_index7 (mk_int__ref result_index1)) (= result__7 (mk_map__ref1 result__1)))) (and (= index28 index22) (and (= result_index8 result_index1) (= result__8 result__1)))))) (and (and (= result_index9 (* (+ (- index12 (to_rep (first (rt array1)))) 1) (length array2))) (and (forall ((i5 Int)) (=> (and (<= (to_rep (first (rt array1))) i5) (<= i5 index12)) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 (to_rep (last (rt array2))))) (= (to_rep (select (select result__9 (+ (+ (* (- i5 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) i5))))))) (forall ((i5 Int)) (=> (and (<= (to_rep (first (rt array1))) i5) (<= i5 index12)) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 (to_rep (last (rt array2))))) (= (to_rep (select (select result__9 (+ (+ (* (- i5 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j9))))))))) (and (and (and (=> (<= 0 2147483647) (in_range2 result_index9)) (=> (<= (to_rep (first (rt array1))) (to_rep (last (rt array1)))) (dynamic_property6 (to_rep (first (rt array1))) (to_rep (last (rt array1))) index12))) (and (<= (to_rep (first (rt array1))) index12) (<= index12 (to_rep (last (rt array1)))))) (= index12 (to_rep (last (rt array1)))))))))) (and (and (= index221 (mk_int__ref index29)) (and (= index16 (mk_int__ref index12)) (and (= result_index21 (mk_int__ref result_index9)) (= result__21 (mk_map__ref1 result__9))))) (and (= index222 index29) (and (= index17 index12) (and (= result_index22 result_index9) (= result__22 result__9)))))) (and (and (= index223 index221) (and (= index18 index16) (and (= result_index23 result_index21) (= result__23 result__21)))) (and (= index224 index222) (and (= index19 index17) (and (= result_index24 result_index22) (= result__24 result__22)))))) (and (and (= index223 (mk_int__ref index2)) (and (= index18 (mk_int__ref index11)) (and (= result_index23 (mk_int__ref result_index1)) (= result__23 (mk_map__ref1 result__1))))) (and (= index224 index21) (and (= index19 index11) (and (= result_index24 result_index1) (= result__24 result__1))))))) (and (forall ((i5 Int)) (=> (and (<= (to_rep (first (rt array1))) i5) (<= i5 (to_rep (last (rt array1))))) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 (to_rep (last (rt array2))))) (= (to_rep (select (select (map__content1 result__23) (+ (+ (* (- i5 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 1)) (to_rep (select (elts array1) i5))))))) (and (forall ((i5 Int)) (=> (and (<= (to_rep (first (rt array1))) i5) (<= i5 (to_rep (last (rt array1))))) (forall ((j9 Int)) (=> (and (<= (to_rep (first (rt array2))) j9) (<= j9 (to_rep (last (rt array2))))) (= (to_rep (select (select (map__content1 result__23) (+ (+ (* (- i5 (to_rep (first (rt array1)))) (length array2)) (- j9 (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j9))))))) (and (and (= cartesian__cartesian_product__result3 (mk_integer_product_type__ref cartesian__cartesian_product__result2)) (= cartesian__cartesian_product__result4 cartesian__cartesian_product__result2)) (and (= result16 (mk_integer_product_type__ref (mk___t1 cartesian__cartesian_product__result cartesian__cartesian_product__result1))) (= cartesian__cartesian_product__result2 (mk___t1 (map__content1 result__23) (mk1 (to_rep result____first) (to_rep result____last))))))))))))))) (and (and (= cartesian__cartesian_product__result5 cartesian__cartesian_product__result3) (and (= index225 index223) (and (= index110 index18) (and (= result_index25 result_index23) (= result__25 result__23))))) (and (= cartesian__cartesian_product__result6 cartesian__cartesian_product__result4) (and (= index226 index224) (and (= index111 index19) (and (= result_index26 result_index24) (= result__26 result__24))))))))
(assert (<= (to_rep (first (rt array1))) i4))
(assert (<= i4 (to_rep (last (rt array1)))))
(assert (<= (to_rep (first (rt array2))) j8))
(assert (<= j8 (to_rep (last (rt array2)))))
(assert (and (<= (to_rep (first (rt array2))) j8) (<= j8 (to_rep (last (rt array2))))))
(assert (= o128 j8))
(assert (= o129 (select (elts array2) o128)))
(assert (= o130 (to_rep o129)))
(assert (not (<= (to_rep (first (rt array1))) i4)))
(check-sat)
(exit)
