...
(define-fun dynamic_invariant2 ((temp___expr_332 Int) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool)) Bool (=> (or (= temp___is_init_329 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_332)))
...
(define-fun dynamic_invariant3 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_380)))
...
(define-fun dynamic_invariant4 ((temp___expr_417 Int) (temp___is_init_414 Bool) (temp___skip_constant_415 Bool) (temp___do_toplevel_416 Bool)) Bool (=> (or (= temp___is_init_414 true) (<= 0 2147483647)) (in_range4 temp___expr_417)))
