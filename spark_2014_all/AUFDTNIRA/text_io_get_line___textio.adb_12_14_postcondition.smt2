...
(define-fun dynamic_invariant2 ((temp___expr_338 Int) (temp___is_init_335 Bool) (temp___skip_constant_336 Bool) (temp___do_toplevel_337 Bool)) Bool (=> (or (= temp___is_init_335 true) (<= (- 2147483648) 2147483647)) (in_range2 temp___expr_338)))
...
(define-fun dynamic_invariant3 ((temp___expr_386 Int) (temp___is_init_383 Bool) (temp___skip_constant_384 Bool) (temp___do_toplevel_385 Bool)) Bool (=> (or (= temp___is_init_383 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_386)))
(declare-fun ferror (Int) Int)
(declare-fun ferror__function_guard (Int Int) Bool)
(assert (forall ((stream Int)) (! (=> (dynamic_invariant3 stream true true true) (dynamic_invariant2 (ferror stream) true false true)) :pattern ((ferror stream)))))
...
(define-fun dynamic_invariant4 ((temp___expr_423 Int) (temp___is_init_420 Bool) (temp___skip_constant_421 Bool) (temp___do_toplevel_422 Bool)) Bool (=> (or (= temp___is_init_420 true) (<= 0 2147483647)) (in_range4 temp___expr_423)))
...
(assert (not (= cur_position2 cur_position)))
(check-sat)
(exit)
