...
(assert (and (= o36 (- current_hi3 1)) (in_range1 (- current_hi3 1))))
(assert (= o37 (ite (<= hi_index1 o36) true false)))
(assert (= result9 (ite (<= current_lo3 hi_index1) o37 false)))
(assert (= result9 true))
(assert (= (to_rep2 o38) hi_index1))
(assert (= (to_rep1 o39) current_lo3))
(assert (= o40 (mk___split_fields o39 o38)))
(assert (= o41 (mk_slice_bounds o40)))
(assert (not (or (< (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o41))) (to_rep1 (rec__sums__slice_bounds__lo (us_split_fields1 o41)))) (and (<= (to_rep3 (first (rt x))) (to_rep1 (rec__sums__slice_bounds__lo (us_split_fields1 o41)))) (<= (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o41))) (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
