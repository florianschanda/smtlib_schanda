...
(assert (forall ((lo_index Int)) (=> (and (<= (to_rep (first (rt x))) lo_index) (<= lo_index (- current_hi2 1))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep (first (rt x))) hi_index1) (<= hi_index1 (- current_hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index) (of_rep1 hi_index1)))) max_sum2))))))
...
(assert (= result5 (ite (<= current_lo2 hi_index) o5 false)))
(assert (= result5 true))
(assert (= (extended_indexqtint o6) hi_index))
(assert (= (indexqtint o7) current_lo2))
(assert (= o8 (mk___split_fields o7 o6)))
(assert (= o9 (mk_slice_bounds o8)))
(assert (not (or (< (extended_indexqtint (rec__sums__slice_bounds__hi (us_split_fields1 o9))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 o9)))) (and (<= (to_rep (first (rt x))) (indexqtint (rec__sums__slice_bounds__lo (us_split_fields1 o9)))) (<= (extended_indexqtint (rec__sums__slice_bounds__hi (us_split_fields1 o9))) (to_rep (last (rt x))))))))
(check-sat)
(exit)
