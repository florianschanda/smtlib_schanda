...
(assert (forall ((lo_index Int)) (=> (and (<= (to_rep3 (first (rt x))) lo_index) (<= lo_index (- current_hi2 1))) (forall ((hi_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index1) (<= hi_index1 (- current_hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep1 lo_index) (of_rep2 hi_index1)))) max_sum2))))))
...
(assert (not (or (< (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o10))) (to_rep1 (rec__sums__slice_bounds__lo (us_split_fields1 o10)))) (and (<= (to_rep3 (first (rt x))) (to_rep1 (rec__sums__slice_bounds__lo (us_split_fields1 o10)))) (<= (to_rep2 (rec__sums__slice_bounds__hi (us_split_fields1 o10))) (to_rep3 (last (rt x))))))))
(check-sat)
(exit)
