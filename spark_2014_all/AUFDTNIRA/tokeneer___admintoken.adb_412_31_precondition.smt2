...
(assert (and (= o (thetokentry (us_private__content state))) (in_range5 o)))
...
(assert (= tokentry1 2))
(assert (and (= o1 (thetokenid (us_private__content state))) (in_range4 o1)))
...
(assert (and (= o2 (therole (mk___rep7 (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields2)))) (and (in_range21 o2) (= o2 (to_rep15 (rec__cert__attr__auth__contentst__role (let ((subject authcertcontents__split_fields)) authcertcontents__split_fields2)))))))
(assert (= result2 (ite (in_range11 o2) true false)))
