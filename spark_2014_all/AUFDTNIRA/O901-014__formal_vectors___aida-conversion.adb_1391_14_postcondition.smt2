...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def 3 9 (+ (to_rep1 (first (rt source))) 9) (+ (+ (to_rep1 (first (rt source))) 9) 1))))) (+ (to_rep1 (first (rt source))) 9)) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def 3 9 (+ (to_rep1 (first (rt source))) 9) (+ (+ (to_rep1 (first (rt source))) 9) 1))))) (+ (+ (to_rep1 (first (rt source))) 9) 1)) (= (mk___t2 temp___1833 temp___18331) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__aggregate_def 3 9 (+ (to_rep1 (first (rt source))) 9) (+ (+ (to_rep1 (first (rt source))) 9) 1))))) (and (= (ite (<= (to_rep1 (first4 temp___18331)) (to_rep1 (last4 temp___18331))) (+ (- (to_rep1 (last4 temp___18331)) (to_rep1 (first4 temp___18331))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 9)) 1) 0)) (and (= (slide1 temp___1833 (to_rep1 (first4 temp___18331)) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume) (= (mk1 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__int_array__assume1)))))) (and (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 9)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 9)) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)) (= (mk___t4 temp___1841 temp___18411) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10))))) (and (= (ite (<= (to_rep1 (first8 temp___18411)) (to_rep1 (last8 temp___18411))) (+ (- (to_rep1 (last8 temp___18411)) (to_rep1 (first8 temp___18411))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 9)) 1) 0)) (and (= (slide1 temp___1841 (to_rep1 (first8 temp___18411)) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume) (= (mk3 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume1)))) (and (and (= (mk_map__ref1 result2) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_483_63x__n__assume1)))))) (and (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 9)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))) (and (and (and (= temp___1847 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (= temp___1848 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))) (and (and (= (mk_int__ref result3) (mk_int__ref index)) (= index2 temp___1847)) (ite (and (<= temp___1847 index2) (<= index2 temp___1848)) (and (and (and (= temp___1846 index2) (and (= temp___1844 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o41 index2)) (= o42 (select n1 o41))) (= o43 (to_rep1 o42))) (= o43 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o44 index2)) (= o45 (select (elts source) o44))) (= o46 (to_rep o45))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o46))) (ite (= (= o46 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o46 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o46 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o46 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o46 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o46 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o46 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o46 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o46 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o46 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o47) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o48 index2)) (= o49 (store n1 o48 o47)))) (and (= n1 result4) (= n2 o49))))) (and (and (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 9) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (forall ((temp___1845 Int)) (=> (and (<= (to_rep1 n__first) temp___1845) (<= temp___1845 (to_rep1 n__last))) (=> (< index3 temp___1845) (= (select n3 temp___1845) (select temp___1844 temp___1845))))) (=> (<= (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 9) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 9) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10)))) (= index3 temp___1848)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1))))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (and (and (= temp___1849 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))) (and (and (<= (to_rep1 n__first) temp___1849) (<= temp___1849 (to_rep1 n__last))) (= o77 temp___1849))) (= o78 (select (map__content1 n7) o77))) (= o79 (to_rep1 o78))) (= o80 (- o79))) (and (= o81 o80) (in_range1 o80))) (and (= result9 (mk_int__ref target)) (= target1 o81))) (and (<= (- 9) target1) (and (and (and (and (and (and (and (and (and (and (= temp___1850 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (<= (to_rep1 n__first) temp___1850) (<= temp___1850 (to_rep1 n__last))) (= o82 temp___1850))) (= o83 (select (map__content1 n7) o82))) (= o84 (to_rep1 o83))) (= o85 (* o84 10))) (and (= o86 o85) (in_range1 o85))) (= o87 (- target1 o86))) (and (= o88 o87) (in_range1 o87))) (and (= result10 (mk_int__ref target1)) (= target2 o88))) (and (<= (- 39) target2) (and (and (and (= o89 (- target2 2147483600)) (in_range1 (- target2 2147483600))) (and (= result11 (mk_int__ref target2)) (= target3 o89))) (and (<= (- 2147483639) target3) (and (= result12 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target4 (mk_int__ref target3)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target5 target3))))))))
