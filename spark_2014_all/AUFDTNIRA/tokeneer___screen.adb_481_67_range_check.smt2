...
(assert (not (= (length1 temp___19942) 0)))
(assert (=> (<= 1 7) (= o (+ (- 7 1) 1))))
(assert (=> (not (<= 1 7)) (= o 0)))
(assert (=> (<= (to_rep1 (first2 temp___19941)) (to_rep1 (last2 temp___19941))) (= o1 (+ (- (to_rep1 (last2 temp___19941)) (to_rep1 (first2 temp___19941))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___19941)) (to_rep1 (last2 temp___19941)))) (= o1 0)))
(assert (= o2 (+ o1 o)))
(assert (= o3 (+ (to_rep1 (first2 temp___19941)) o2)))
(assert (= o4 (- o3 1)))
