...
(assert (and (and (<= 1 (let ((subject i)) i5)) (<= (let ((subject i)) i5) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b))))))) (= (bool_eq10 c35b c35b) true)))
(assert (and (and (and (forall ((temp___1440 Int)) (=> (and (<= 1 temp___1440) (<= temp___1440 50)) (=> (<= (let ((subject i)) i5) temp___1440) (= (select (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields3)) temp___1440) (select (rec__display__scrollstrt__text (let ((subject result____split_fields)) result____split_fields2)) temp___1440))))) (= (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields3)) (rec__display__scrollstrt__len (let ((subject result____split_fields)) result____split_fields2)))) (=> (<= 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b)))))) (dynamic_property1 1 (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b))))) (let ((subject i)) i5)))) (and (<= 1 (let ((subject i)) i5)) (<= (let ((subject i)) i5) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b)))))))))
(assert (= (to_rep o54) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b)))) (let ((subject i)) i5)))))
...
(assert (= temp___1438 (mk___rep4 o56)))
(assert (= result5 (let ((subject result____split_fields)) (mk___split_fields__ref4 result____split_fields3))))
(assert (= (let ((subject result____split_fields)) result____split_fields4) (us_split_fields9 temp___1438)))
(assert (not (= (let ((subject i)) i5) (to_rep8 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c35b))))))))
