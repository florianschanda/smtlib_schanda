...
(assert (not (= (privatekeypresent (mk___split_fields5 thistisinfo__split_fields (mk___rep4 (mk___split_fields4 thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state)) true)))
(check-sat)
(exit)
