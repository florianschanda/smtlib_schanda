...
(assert (not (< (to_rep6 (select logfilestate__split_fields6 fileindex2)) 1024)))
...
(assert (= result8 (mk_map__ref1 logfilesstatus)))
...
(assert (= result9 (mk_map__ref4 logfiles)))
(assert (= logfiles1 (store logfiles fileindex2 thefile2)))
(assert (not (in_range7 (+ archivedfilecount2 1))))
(check-sat)
(exit)
