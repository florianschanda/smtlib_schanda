...
(assert (not (= (to_rep (select (select (map__content1 result__6) (+ (+ (* (- i (to_rep (first (rt array1)))) (length array2)) (- j (to_rep (first (rt array2))))) 1)) 2)) (to_rep (select (elts array2) j)))))
(check-sat)
(exit)
