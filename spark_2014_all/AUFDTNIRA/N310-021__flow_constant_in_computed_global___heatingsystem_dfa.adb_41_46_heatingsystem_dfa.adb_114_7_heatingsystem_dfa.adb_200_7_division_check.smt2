...
(assert (=> (not (= switchposition1 0)) (=> (not (= switchposition1 1)) (= o3 (to_rep o2)))))
...
(assert (=> (not (= switchposition1 0)) (=> (not (= switchposition1 1)) (= (to_rep o5) timer6))))
(assert (=> (not (= switchposition1 0)) (=> (not (= switchposition1 1)) (and (<= 2 switchposition1) (<= switchposition1 5)))))
...
(assert (= result14 (mk_int__ref minute)))
(assert (= minute1 (div1 (mod2 c40b 3600) 60)))
(assert (not (not (= 10 0))))
(check-sat)
(exit)
