...
(define-fun dynamic_invariant1 ((temp___expr_176 us_t) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (not (= temp___skip_constant_173 true)) (dynamic_property 1 2147483647 (first1 temp___expr_176) (last1 temp___expr_176))))
(declare-sort t1 0)
...
(declare-datatypes () ((vector_t__ref (mk_vector_t__ref (vector_t__content us_t1)))))
(define-fun vector_t__ref___projection ((a vector_t__ref)) us_t1 (vector_t__content a))
...
(define-fun dynamic_invariant3 ((temp___expr_189 us_t1) (temp___is_init_185 Bool) (temp___skip_constant_186 Bool) (temp___do_toplevel_187 Bool) (temp___do_typ_inv_188 Bool)) Bool (=> (not (= temp___skip_constant_186 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_189) (last3 temp___expr_189))))
(declare-const i Int)
...
(assert (dynamic_property1 1 2147483647 (to_rep (first (rt b))) (to_rep (last (rt b)))))
(assert (= (elts b) o2))
