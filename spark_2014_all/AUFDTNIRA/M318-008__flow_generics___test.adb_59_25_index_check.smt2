...
(define-fun dynamic_invariant3 ((temp___expr_162 us_t1) (temp___is_init_159 Bool) (temp___skip_constant_160 Bool) (temp___do_toplevel_161 Bool)) Bool (=> (not (= temp___skip_constant_160 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_162) (last3 temp___expr_162))))
(declare-const i Int)
