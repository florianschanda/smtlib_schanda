...
(assert (= (mk___t2 temp___1746 temp___17461) (aida__conversion__calculate_positive_target_length_2__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1))))
(assert (= (ite (<= (to_rep1 (first4 temp___17461)) (to_rep1 (last4 temp___17461))) (+ (- (to_rep1 (last4 temp___17461)) (to_rep1 (first4 temp___17461))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1)) (+ (- (+ (to_rep1 (first (rt source))) 1) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1746 (to_rep1 (first4 temp___17461)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_length_2__n__assume))
...
(assert (and (= temp___1753 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (= (mk_int__ref result1) (mk_int__ref index)))
(assert (= index1 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= temp___1751 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= temp___1749 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= o index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= o1 (select n1 o))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= o3 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= o7 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= n1 result2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= n2 o8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (= (to_rep1 (select n3 j)) (convert_character_digit_to_integer (to_rep (select (elts source) j))))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (and (and (forall ((temp___1750 Int)) (=> (and (<= (to_rep1 n__first) temp___1750) (<= temp___1750 (to_rep1 n__last))) (=> (< index2 temp___1750) (= (select n3 temp___1750) (select temp___1749 temp___1750))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 1) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 1))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= index2 temp___1753)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= index2 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= n3 n4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= index4 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= n5 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= index9 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= n10 (mk_map__ref1 n4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= index6 index4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753)) (= n7 n5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753))) (= index1 index5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753))) (= n1 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1753))) (= n7 n1)))
(assert (and (= temp___1754 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___1754) (<= temp___1754 (to_rep1 n__last))))
(assert (= o9 temp___1754))
(assert (= o10 (select n6 o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= (mk_int__ref result3) (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 9))
(assert (and (= temp___1755 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 n__first) temp___1755) (<= temp___1755 (to_rep1 n__last))))
(assert (= o12 temp___1755))
...
(assert (= o22 temp___1757))
(assert (= o23 (select (elts source) o22)))
(assert (= o24 (to_rep o23)))
(assert (and (= o25 (convert_character_digit_to_integer o24)) (and (in_range1 o25) (and (and (<= 0 o25) (<= o25 9)) (ite (= (= o24 48) true) (= o25 0) (ite (= (= o24 49) true) (= o25 1) (ite (= (= o24 50) true) (= o25 2) (ite (= (= o24 51) true) (= o25 3) (ite (= (= o24 52) true) (= o25 4) (ite (= (= o24 53) true) (= o25 5) (ite (= (= o24 54) true) (= o25 6) (ite (= (= o24 55) true) (= o25 7) (ite (= (= o24 56) true) (= o25 8) (=> (= (= o24 57) true) (= o25 9)))))))))))))))
