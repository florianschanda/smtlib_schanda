...
(declare-const temp___6552 us_rep)
...
(declare-const temp___6553 cursor__ref)
(declare-const temp___6542 int__ref)
(declare-const x39 Int)
(declare-const r12 Int)
(declare-const b24 Bool)
(declare-const e30 Int)
(declare-const i16 Int)
(declare-const temp___6554 us_rep)
(declare-const temp___6543 Int)
...
(assert (and (= o20 (next (mk___rep1 my_container__split_fields1) (let ((subject temp___655)) temp___6551))) (= o20 (ite (< (to_rep (rec__container__cursor__index (us_split_fields1 (let ((subject temp___655)) temp___6551)))) 200) (mk___rep (mk___split_fields (of_rep (+ (to_rep (rec__container__cursor__index (us_split_fields1 (let ((subject temp___655)) temp___6551)))) 1)))) (mk___rep (mk___split_fields rliteral1))))))
(assert (= result38 (let ((subject temp___655)) (mk_cursor__ref temp___6551))))
(assert (= (let ((subject temp___655)) temp___6552) o20))
(assert (and (= result39 (has_element (mk___rep1 my_container__split_fields1) (let ((subject temp___655)) temp___6552))) (= (= result39 true) (and (<= 1 (to_rep (rec__container__cursor__index (us_split_fields1 (let ((subject temp___655)) temp___6552))))) (<= (to_rep (rec__container__cursor__index (us_split_fields1 (let ((subject temp___655)) temp___6552)))) 200)))))
(assert (=> (= result39 true) (and (= o21 (element (mk___rep1 my_container__split_fields1) (let ((subject temp___655)) temp___6552))) (and (in_range1 o21) (= o21 (to_rep1 (select (rec__container__container__a my_container__split_fields1) (to_rep (rec__container__cursor__index (us_split_fields1 (let ((subject temp___655)) temp___6552)))))))))))
(assert (=> (= result39 true) (= result40 (mk_int__ref e25))))
(assert (=> (= result39 true) (= e26 o21)))
...
(assert (and (= o22 (- r9 1)) (in_range4 (- r9 1))))
(assert (= result42 (mk_int__ref r9)))
(assert (= r10 o22))
(assert (= temp___6542 (mk_int__ref temp___6541)))
(assert (= temp___6553 (let ((subject temp___655)) (mk_cursor__ref temp___6552))))
(assert (= i15 i13))
(assert (= e29 e27))
...
(assert (= rho9 rho7))
(assert (= rho8 rho6))
(assert (= temp___6543 temp___6541))
(assert (= temp___6554 temp___6552))
(assert (= i16 i14))
(assert (= e30 e28))
(assert (= b24 b22))
(assert (= r12 r10))
