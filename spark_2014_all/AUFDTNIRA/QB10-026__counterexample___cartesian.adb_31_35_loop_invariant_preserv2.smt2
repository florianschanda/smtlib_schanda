...
(assert (not (= index22 (to_rep (last2 (rt1 array2))))))
...
(assert (= o9 (store result__3 o8 (temp_____aggregate_def_269 (to_rep (select (elts1 array1) index11)) (to_rep (select (elts1 array2) index23))))))
(assert (= result8 result__3))
(assert (= result__4 o9))
(declare-const j Int)
(assert (<= (to_rep (first2 (rt1 array2))) j))
(assert (<= j index23))
(assert (not (= (to_rep (select (select result__4 (+ (+ (* (- index11 (to_rep (first2 (rt1 array1)))) (length1 array2)) (- j (to_rep (first2 (rt1 array2))))) 1)) 1)) (to_rep (select (elts1 array1) index11)))))
(check-sat)
(exit)
