...
(assert (=> (= result true) (=> (= writeok2 true) (= o (extractuser tokenpresence state tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))))))
(assert (=> (= result true) (=> (= writeok2 true) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true) (in_range13 auditalarm1)))))
(assert (=> (= result true) (=> (= writeok2 true) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range13 auditalarm2)))))
(assert (=> (= result true) (=> (not (= writeok2 true)) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range13 auditalarm3)))))
(assert (=> (= result true) (=> (not (= writeok2 true)) (= o1 (extractuser tokenpresence state tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields))))))
(assert (=> (= result true) (=> (not (= writeok2 true)) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true) (in_range13 auditalarm4)))))
(assert (=> (= result true) (=> (not (= writeok2 true)) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true) (in_range13 auditalarm5)))))
(assert (=> (= result true) (=> (not (= writeok2 true)) (= state5 state7))))
(assert (=> (= result true) (=> (not (= writeok2 true)) (= state4 state6))))
(assert (=> (= result true) (=> (not (= writeok2 true)) (= filestate filestate1))))
(assert (=> (= result true) (=> (not (= writeok2 true)) (= auditsystemfault auditsystemfault1))))
(assert (=> (= result true) (=> (not (= writeok2 true)) (= auditalarm2 auditalarm5))))
(assert (=> (= result true) (=> (not (= writeok2 true)) (= logfilestate__split_fields8 logfilestate__split_fields11))))
(assert (=> (= result true) (=> (not (= writeok2 true)) (= logfilesstatus logfilesstatus1))))
(assert (=> (= result true) (=> (not (= writeok2 true)) (= logfiles logfiles1))))
(assert (=> (not (= result true)) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields12)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields12)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields12) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields12)) true) (in_range13 auditalarm6))))
(assert (=> (not (= result true)) (= o2 (extractuser tokenpresence state tokentry tokenid (us_split_fields__content11 authcert__split_fields) (us_split_fields__content8 idcert__split_fields)))))
(assert (=> (not (= result true)) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields13)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields13)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields13) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields13)) true) (in_range13 auditalarm7))))
(assert (=> (not (= result true)) (and (= (valid_numberlogentries (to_rep5 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields14)) (to_rep6 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields14)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields14)) true) (in_range13 auditalarm8))))
(assert (=> (not (= result true)) (= state5 state9)))
...
(assert (=> (not (= result true)) (= auditsystemfault auditsystemfault2)))
(assert (=> (not (= result true)) (= auditalarm2 auditalarm8)))
(assert (=> (not (= result true)) (= logfilestate__split_fields8 logfilestate__split_fields14)))
(assert (=> (not (= result true)) (= logfilesstatus logfilesstatus2)))
(assert (=> (not (= result true)) (= logfiles logfiles2)))
(assert (=> (not (= result true)) (= state5 state9)))
...
(assert (= state10 (mk___private__ref state4)))
(assert (= filestate3 (mk___private__ref filestate)))
(assert (= writeok3 (mk_bool__ref writeok2)))
...
(assert (= auditalarm9 (mk_int__ref auditalarm2)))
(assert (= logfilestate__split_fields15 (mk___split_fields__ref2 logfilestate__split_fields8)))
...
(assert (= auditalarm10 auditalarm2))
(assert (= logfilestate__split_fields16 logfilestate__split_fields8))
