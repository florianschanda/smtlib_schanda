...
(assert (=> (not (= (select issystem retvalini1) true)) (= result__8 result__15)))
...
(assert (=> (= result17 true) (= (ite (<= (to_rep1 (first (rt thestring1))) (to_rep1 (last (rt thestring1)))) (+ (- (to_rep1 (last (rt thestring1))) (to_rep1 (first (rt thestring1)))) 1) 0) (ite (<= 1 (length thestring1)) (+ (- (length thestring1) 1) 1) 0))))
(assert (=> (= result17 true) (= temp___1235 (mk___t2 (slide (elts thestring1) (to_rep1 (first (rt thestring1))) 1) (mk2 1 (length thestring1))))))
(assert (=> (= result17 true) (and (= temp___1237 (length thestring1)) (in_range1 (length thestring1)))))
(assert (=> (= result17 true) (=> (<= 1 temp___1237) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1237) (<= temp___1237 150))))))
(assert (=> (= result17 true) (= o26 result__10)))
(assert (=> (= result17 true) (= temp___1238 (mk___t2 o26 (mk2 1 temp___1237)))))
(assert (=> (= result17 true) (= (ite (<= (to_rep1 (first4 (rt2 temp___1235))) (to_rep1 (last4 (rt2 temp___1235)))) (+ (- (to_rep1 (last4 (rt2 temp___1235))) (to_rep1 (first4 (rt2 temp___1235)))) 1) 0) (ite (<= (to_rep1 (first4 (rt2 temp___1238))) (to_rep1 (last4 (rt2 temp___1238)))) (+ (- (to_rep1 (last4 (rt2 temp___1238))) (to_rep1 (first4 (rt2 temp___1238)))) 1) 0))))
(assert (=> (= result17 true) (= temp___1239 temp___1235)))
(assert (=> (= result17 true) (forall ((temp___1240 Int)) (ite (and (<= 1 temp___1240) (<= temp___1240 (length thestring1))) (= (select o27 temp___1240) (select (elts2 temp___1239) temp___1240)) (= (select o27 temp___1240) (select result__10 temp___1240))))))
(assert (=> (= result17 true) (= result18 (mk_map__ref result__10))))
(assert (=> (= result17 true) (= result__11 o27)))
(assert (=> (= result17 true) (= result__13 (mk_map__ref result__11))))
(assert (=> (= result17 true) (= result__14 result__11)))
(assert (=> (not (= result17 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring1))) 1) (<= 1 (to_rep1 (last (rt thestring1))))) (and (<= (to_rep1 (first (rt thestring1))) 150) (<= 150 (to_rep1 (last (rt thestring1)))))))))
(assert (=> (not (= result17 true)) (= temp___1234 thestring1)))
(assert (=> (not (= result17 true)) (= o28 (elts temp___1234))))
(assert (=> (not (= result17 true)) (= result19 (mk_map__ref result__10))))
(assert (=> (not (= result17 true)) (= result__12 o28)))
(assert (=> (not (= result17 true)) (= result__13 (mk_map__ref result__12))))
