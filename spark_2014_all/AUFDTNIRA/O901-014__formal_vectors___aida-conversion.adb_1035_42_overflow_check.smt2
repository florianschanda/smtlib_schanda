...
(assert (forall ((temp___1721 Int) (temp___1722 Int) (temp___1723 Int)) (let ((temp___1720 (aida__conversion__calculate_positive_target_length_3__n__aggregate_def temp___1721 temp___1722 temp___1723))) (and (=> (dynamic_property6 (first1 source) (+ (first1 source) 2) temp___1722 temp___1723) (and (= (first5 temp___1720) temp___1722) (= (last5 temp___1720) temp___1723))) (forall ((temp___1724 Int)) (= (select (to_array2 temp___1720) temp___1724) (of_rep1 temp___1721)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_455 us_t1) (temp___is_init_452 Bool) (temp___skip_constant_453 Bool) (temp___do_toplevel_454 Bool)) Bool (=> (not (= temp___skip_constant_453 true)) (and (dynamic_property2 (first1 source) (+ (first1 source) 2) (first3 temp___expr_455) (last3 temp___expr_455)) (and (= (first3 temp___expr_455) (first1 source)) (= (last3 temp___expr_455) (+ (first1 source) 2))))))
...
(assert (and (= (length source) 3) (forall ((index13 Int)) (=> (and (<= (to_rep1 (first (rt source))) index13) (<= index13 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index13))) true)))))
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_length_3__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_length_3__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2))))) (+ (to_rep1 (first (rt source))) 2)) (= (mk___t2 temp___1726 temp___17261) (aida__conversion__calculate_positive_target_length_3__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2))))) (and (= (ite (<= (to_rep1 (first4 temp___17261)) (to_rep1 (last4 temp___17261))) (+ (- (to_rep1 (last4 temp___17261)) (to_rep1 (first4 temp___17261))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2)) (+ (- (+ (to_rep1 (first (rt source))) 2) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1726 (to_rep1 (first4 temp___17261)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_length_3__n__assume) (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2)) aida__conversion__calculate_positive_target_length_3__n__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_positive_target_length_3__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_length_3__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_length_3__n__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 2)))) (and (and (and (= temp___1733 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (= (mk_int__ref result1) (mk_int__ref index)) (= index2 (to_rep1 (first (rt source))))) (ite (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1733)) (and (and (and (= temp___1730 n1) (and (= temp___1728 index2) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o index2)) (= o1 (select n1 o))) (= o2 (to_rep1 o1))) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o3 index2)) (= o4 (select (elts source) o3))) (= o5 (to_rep o4))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o7 index2)) (= o8 (store n1 o7 o6)))) (and (= n1 result2) (= n2 o8))))) (and (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (= (to_rep1 (select n3 j1)) (convert_character_digit_to_integer (to_rep (select (elts source) j1)))))) (and (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 2) index3)) (forall ((temp___1731 Int)) (=> (and (<= (to_rep1 n__first) temp___1731) (<= temp___1731 (to_rep1 n__last))) (=> (< index3 temp___1731) (= (select n3 temp___1731) (select temp___1730 temp___1731)))))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 2)))) (= index3 temp___1733)))))) (and (and (= index3 index7) (= n3 n7)) (and (= index8 index3) (= n8 n3)))) (and (and (= (mk_int__ref index9) (mk_int__ref index7)) (= (mk_map__ref1 n9) (mk_map__ref1 n7))) (and (= index10 index8) (= n10 n8)))) (and (and (= index2 index9) (= n1 n9)) (and (= index10 index2) (= n10 n1)))))) (and (and (and (and (and (and (= temp___1734 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (<= (to_rep1 n__first) temp___1734) (<= temp___1734 (to_rep1 n__last))) (= o22 temp___1734))) (= o23 (select n9 o22))) (= o24 (to_rep1 o23))) (and (= (mk_int__ref result5) (mk_int__ref target)) (= target1 o24))) (and (<= target1 9) (and (and (and (and (and (and (and (and (and (and (= temp___1735 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (<= (to_rep1 n__first) temp___1735) (<= temp___1735 (to_rep1 n__last))) (= o25 temp___1735))) (= o26 (select n9 o25))) (= o27 (to_rep1 o26))) (= o28 (* o27 10))) (and (= o29 o28) (in_range1 o28))) (= o30 (+ target1 o29))) (and (= o31 o30) (in_range1 o30))) (and (= target1 result6) (= target2 o31))) (and (<= target2 99) (and (and (and (and (and (and (and (and (and (and (= temp___1736 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))) (and (and (<= (to_rep1 n__first) temp___1736) (<= temp___1736 (to_rep1 n__last))) (= o32 temp___1736))) (= o33 (select n9 o32))) (= o34 (to_rep1 o33))) (= o35 (* o34 100))) (and (= o36 o35) (in_range1 o35))) (= o37 (+ target2 o36))) (and (= o38 o37) (in_range1 o37))) (and (= result7 (mk_int__ref target2)) (= target3 o38))) (and (<= target3 999) (and (= result8 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0)))))))))))) (and (and (= index11 (mk_int__ref index9)) (and (= n11 (mk_map__ref1 n9)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target4 (mk_int__ref target3))))) (and (= index12 index10) (and (= n12 n10) (and (= has_failed3 has_failed1) (= target5 target3)))))))
(assert (and (= temp___1739 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1739) (<= temp___1739 (to_rep1 (last (rt source))))))
(assert (= o52 temp___1739))
