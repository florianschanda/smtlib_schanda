...
(assert (not (= (length temp___1915) 0)))
(assert (=> (<= 1 5) (= o54 (+ (- 5 1) 1))))
(assert (=> (not (<= 1 5)) (= o54 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1915))) (to_rep1 (last (rt temp___1915)))) (= o55 (+ (- (to_rep1 (last (rt temp___1915))) (to_rep1 (first (rt temp___1915)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1915))) (to_rep1 (last (rt temp___1915))))) (= o55 0)))
(assert (= o56 (+ o55 o54)))
(assert (= o57 (+ (to_rep1 (first (rt temp___1915))) o56)))
(assert (= o58 (- o57 1)))
