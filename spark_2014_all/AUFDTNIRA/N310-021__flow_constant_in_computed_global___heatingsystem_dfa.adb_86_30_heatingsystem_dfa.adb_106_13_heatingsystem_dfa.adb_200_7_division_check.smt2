...
(assert (=> (= result3 true) (=> (= slowadvance1 true) (= result4 (mk_int__ref clockoffset2)))))
(assert (=> (= result3 true) (=> (= slowadvance1 true) (= clockoffset3 (mod2 (+ clockoffset2 60) 86400)))))
(assert (=> (= result3 true) (=> (not (= slowadvance1 true)) (= clockoffset3 clockoffset2))))
(assert (=> (= result3 true) (=> (not (= changetofastmode1 true)) (= advancemode1 advancemode))))
(assert (=> (= result3 true) (= changetoslowmode1 changetoslowmode)))
(assert (=> (= result3 true) (= fastadvance1 fastadvance)))
(assert (=> (not (= result3 true)) (=> (= fastadvance1 true) (= result5 (mk_int__ref clockoffset2)))))
(assert (=> (not (= result3 true)) (=> (= fastadvance1 true) (= clockoffset4 (mod2 (+ clockoffset2 600) 86400)))))
(assert (=> (not (= result3 true)) (=> (not (= fastadvance1 true)) (= clockoffset4 clockoffset2))))
(assert (=> (not (= result3 true)) (=> (not (= changetoslowmode1 true)) (= advancemode2 advancemode))))
