...
(assert (<= 1 j2))
(assert (<= j2 r29b))
(assert (and (and (and (and (and (= loopmax2 (+ (div1 (- (to_rep8 (rec__certtypes__rawdatat__datalength (us_split_fields5 rawcertdata))) 1) 100) 1)) (and (<= 1 j3) (<= j3 loopmax2))) (= bytesleft3 (- (to_rep8 (rec__certtypes__rawdatat__datalength (us_split_fields5 rawcertdata))) (* (- j3 1) 100)))) (and (<= 1 size2) (<= size2 100))) (= retvalini1 0)) (= retvalfin1 0)))
(assert (and (and (and (and (=> (<= 1 2147483647) (in_range2 bytesleft3)) (=> (<= 0 28) (in_range14 retvalupd2))) (=> (<= 0 4294967295) (in_range5 size2))) (=> (<= 1 r29b) (dynamic_property3 1 r29b j3))) (and (<= 1 j3) (<= j3 r29b))))
