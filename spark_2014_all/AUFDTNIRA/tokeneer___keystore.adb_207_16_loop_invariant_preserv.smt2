...
(assert (= loopmax1 (+ (div1 (- (to_rep8 (rec__certtypes__rawdatat__datalength (us_split_fields5 rawcertdata))) 1) 100) 1)))
(assert (= result5 (mk_int__ref bytesleft)))
(assert (= bytesleft1 (to_rep8 (rec__certtypes__rawdatat__datalength (us_split_fields5 rawcertdata)))))
...
(assert (<= 1 j1))
(assert (<= j1 r29b))
(assert (and (and (and (and (and (= loopmax1 (+ (div1 (- (to_rep8 (rec__certtypes__rawdatat__datalength (us_split_fields5 rawcertdata))) 1) 100) 1)) (and (<= 1 j2) (<= j2 loopmax1))) (= bytesleft2 (- (to_rep8 (rec__certtypes__rawdatat__datalength (us_split_fields5 rawcertdata))) (* (- j2 1) 100)))) (and (<= 1 size2) (<= size2 100))) (= retvalini1 0)) (= retvalfin1 0)))
(assert (and (and (and (and (=> (<= 1 2147483647) (in_range2 bytesleft2)) (=> (<= 0 28) (in_range14 retvalupd2))) (=> (<= 0 4294967295) (in_range5 size2))) (=> (<= 1 r29b) (dynamic_property3 1 r29b j2))) (and (<= 1 j2) (<= j2 r29b))))
...
(assert (= o4 (getblock (rec__certtypes__rawdatat__rawdata (us_split_fields5 rawcertdata)) j2 size3)))
(assert (= result8 (mk_map__ref block)))
(assert (= block1 o4))
(assert (in_range14 retvalupd3))
(assert (not (not (= retvalupd3 0))))
(assert (not (= j2 loopmax1)))
(assert (and (= o5 (- bytesleft2 100)) (in_range2 (- bytesleft2 100))))
(assert (= result9 (mk_int__ref bytesleft2)))
(assert (= bytesleft3 o5))
(assert (not (= j2 r29b)))
(assert (= result10 (mk_int__ref j2)))
(assert (= j3 (+ j2 1)))
(assert (not (= loopmax1 (+ (div1 (- (to_rep8 (rec__certtypes__rawdatat__datalength (us_split_fields5 rawcertdata))) 1) 100) 1))))
(check-sat)
(exit)
