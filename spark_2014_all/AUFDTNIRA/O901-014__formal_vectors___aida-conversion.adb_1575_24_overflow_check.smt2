...
(assert (= o84 temp___1963))
(assert (= o85 (select (map__content1 n7) o84)))
(assert (= o86 (to_rep1 o85)))
(assert (= o87 (* o86 1000)))
(assert (and (= o88 o87) (in_range1 o87)))
(assert (= o89 (- target3 o88)))
...
(assert (= o91 temp___1964))
(assert (= o92 (select (map__content1 n7) o91)))
(assert (= o93 (to_rep1 o92)))
(assert (= o94 (* o93 10000)))
(assert (and (= o95 o94) (in_range1 o94)))
(assert (= o96 (- target4 o95)))
(assert (and (= o97 o96) (in_range1 o96)))
(assert (= result13 (mk_int__ref target4)))
(assert (= target5 o97))
(assert (<= (- 79999) target5))
(assert (not (in_range1 (- target5 2147400000))))
(check-sat)
(exit)
