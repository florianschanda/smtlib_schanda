...
(assert (=> (not (= systemfault true)) (=> (not (= currentdoor newdoor1)) (and (= (valid_numberlogentries (to_rep7 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep8 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range13 auditalarm3)))))
...
(assert (= logfilesstatus5 (mk_map__ref1 logfilesstatus4)))
(assert (= logfiles5 (mk_map__ref4 logfiles4)))
...
(assert (not (= (int__content currentdoor3) 0)))
(check-sat)
(exit)
