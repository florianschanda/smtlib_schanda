...
(assert (=> (= systemfault true) (= systemfault1 systemfault)))
(assert (=> (not (= systemfault true)) (=> (not (= currentdoor newdoor1)) (=> (= newdoor1 1) (= result (mk_int__ref id))))))
(assert (=> (not (= systemfault true)) (=> (not (= currentdoor newdoor1)) (=> (= newdoor1 1) (= id2 6)))))
(assert (=> (not (= systemfault true)) (=> (not (= currentdoor newdoor1)) (=> (not (= newdoor1 1)) (= result1 (mk_int__ref id))))))
...
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= (let ((subject state)) (mk___private__ref state4)) state))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= (let ((subject filestate)) (mk___private__ref filestate3)) filestate))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= id2 id))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= currentdoor2 currentdoor))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= auditsystemfault3 auditsystemfault))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= auditalarm3 auditalarm))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= logfilestate__split_fields9 (mk___split_fields2 logfilestate__split_fields logfilestate__split_fields1 (mk___rep1 (mk___split_fields1 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6)))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= logfilesstatus3 logfilesstatus))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= logfiles3 logfiles))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= state4 state2))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= filestate3 filestate1))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= id2 id1))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= currentdoor2 currentdoor1))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= auditsystemfault3 auditsystemfault1))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= auditalarm3 auditalarm1))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= logfilestate__split_fields9 logfilestate__split_fields7))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= logfilesstatus3 logfilesstatus1))))
(assert (=> (not (= systemfault true)) (=> (= currentdoor newdoor1) (= logfiles3 logfiles1))))
(assert (=> (not (= systemfault true)) (= result3 (mk_bool__ref systemfault))))
(assert (=> (not (= systemfault true)) (= systemfault1 (of_int 0))))
