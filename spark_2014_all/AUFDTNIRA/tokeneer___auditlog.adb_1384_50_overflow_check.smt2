...
(assert (= o28 (+ o27 (to_rep5 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields23)) (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields23))))))))
(assert (not (in_range8 o28)))
(check-sat)
(exit)
