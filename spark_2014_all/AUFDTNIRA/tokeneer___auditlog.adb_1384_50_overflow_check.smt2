...
(assert (= o31 (* o30 1024)))
(assert (and (= o32 o31) (in_range7 o31)))
(assert (= o33 (+ o32 (to_rep5 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields25)) (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields25))))))))
(assert (not (in_range7 o33)))
(check-sat)
(exit)
