...
(assert (and (= o25 (- (to_rep5 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields23))))) 1)) (in_range6 (- (to_rep5 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content1 logfilestate__split_fields23))))) 1))))
(assert (= o26 (* o25 1024)))
(assert (and (= o27 o26) (in_range11 o26)))
(assert (= o28 (+ o27 (to_rep6 (select (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content1 logfilestate__split_fields23)) (to_rep3 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content1 logfilestate__split_fields23))))))))
(assert (not (in_range11 o28)))
(check-sat)
(exit)
