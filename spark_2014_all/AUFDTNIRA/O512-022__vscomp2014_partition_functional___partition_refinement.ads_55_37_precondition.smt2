...
(assert (= result4 true))
(assert (and (= o53 (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c1)) (and (in_range7 o53) (= o53 (get2 (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (get3 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1))))))
