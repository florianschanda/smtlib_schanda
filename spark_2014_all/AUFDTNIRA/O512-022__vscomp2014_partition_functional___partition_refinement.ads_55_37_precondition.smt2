...
(assert (and (= o6 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o6) (= o6 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
...
(assert (= result true))
(assert (and (= o3 (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range11 o3) (<= o3 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
...
(assert (= result3 true))
(assert (and (= o2 (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c)) (and (in_range7 o2) (= o2 (get2 (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (get3 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c))))))
