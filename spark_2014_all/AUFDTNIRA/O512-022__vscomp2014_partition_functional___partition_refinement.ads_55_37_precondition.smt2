...
(assert (and (= o6 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o6) (= o6 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
...
(assert (= o5 (* 2 o4)))
(assert (and (= o7 o5) (in_range10 o5)))
...
(assert (= result3 true))
(assert (and (= o2 (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c)) (and (in_range4 o2) (= o2 (get2 (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (get3 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c))))))
