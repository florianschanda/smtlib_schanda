...
(declare-const temp___227 (Array Int value))
...
(assert (= temp___227 (store v j1 o)))
(assert (dynamic_predicate temp___227))
(assert (= o1 temp___227))
(assert (= result1 v))
(assert (= v1 o1))
(assert (and (and (and (= (sorted v2) true) (forall ((temp___229 Int)) (=> (and (<= 1 temp___229) (<= temp___229 100)) (=> (or (< 100 temp___229) (or (< temp___229 1) (< j2 temp___229))) (= (select v2 temp___229) (select v temp___229)))))) (=> (<= 1 100) (in_range2 j2))) (and (<= 1 j2) (<= j2 100))))
(assert (not (= j2 100)))
(assert (= result2 j2))
(assert (= j3 (+ j2 1)))
(assert (not (= (sorted v2) true)))
(check-sat)
(exit)
