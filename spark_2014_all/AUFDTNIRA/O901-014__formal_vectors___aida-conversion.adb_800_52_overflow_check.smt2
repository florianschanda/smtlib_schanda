...
(define-fun dynamic_invariant4 ((temp___expr_414 us_t1) (temp___is_init_410 Bool) (temp___skip_constant_411 Bool) (temp___do_toplevel_412 Bool) (temp___do_typ_inv_413 Bool)) Bool (=> (not (= temp___skip_constant_411 true)) (and (dynamic_property2 (first1 source) (+ (first1 source) 7) (first3 temp___expr_414) (last3 temp___expr_414)) (and (= (first3 temp___expr_414) (first1 source)) (= (last3 temp___expr_414) (+ (first1 source) 7))))))
(declare-sort t3 0)
...
(assert (forall ((temp___1693 Int) (temp___1694 Int) (temp___1695 Int)) (let ((temp___1692 (aida__conversion__calculate_positive_target_length_8__n__aggregate_def temp___1693 temp___1694 temp___1695))) (=> (dynamic_invariant temp___1693 true true true true) (and (=> (dynamic_property6 (first1 source) (+ (first1 source) 7) temp___1694 temp___1695) (and (= (first5 temp___1692) temp___1694) (= (last5 temp___1692) temp___1695))) (forall ((temp___1696 Int)) (= (select (to_array2 temp___1692) temp___1696) rliteral)))))))
(declare-const target Int)
(declare-const has_failed Bool)
(declare-const n (Array Int integer))
(declare-const index Int)
(declare-const temp___1698 (Array Int integer))
(declare-const temp___16981 t2)
...
(declare-const temp___1703 (Array Int integer))
(declare-const o Int)
...
(assert (= (mk___t2 temp___1698 temp___16981) (aida__conversion__calculate_positive_target_length_8__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 7))))
(assert (= (ite (<= (to_rep1 (first4 temp___16981)) (to_rep1 (last4 temp___16981))) (+ (- (to_rep1 (last4 temp___16981)) (to_rep1 (first4 temp___16981))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 7)) (+ (- (+ (to_rep1 (first (rt source))) 7) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1698 (to_rep1 (first4 temp___16981)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_length_8__n__assume))
...
(assert (and (= temp___1701 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (= (mk_int__ref result1) (mk_int__ref index)))
(assert (= index1 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= temp___1705 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= temp___1703 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= o index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= o1 (select n1 o))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= o3 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= o7 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= n1 result2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= n2 o8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (= (to_rep1 (select n3 j)) (convert_character_digit_to_integer (to_rep (select (elts source) j))))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (and (and (forall ((temp___1704 Int)) (=> (and (<= (to_rep1 n__first) temp___1704) (<= temp___1704 (to_rep1 n__last))) (=> (or (< temp___1701 temp___1704) (or (< temp___1704 (to_rep1 (first (rt source)))) (< index2 temp___1704))) (= (select n3 temp___1704) (select temp___1703 temp___1704))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 7)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 7) index2))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 7))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= index2 temp___1701)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= index2 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= n3 n4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= index4 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= n5 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= index9 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= n10 (mk_map__ref1 n4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= index6 index4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701)) (= n7 n5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701))) (= index1 index5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701))) (= n1 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1701))) (= n7 n1)))
(assert (and (= temp___1706 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1706) (<= temp___1706 (to_rep1 n__last))))
(assert (= o9 temp___1706))
(assert (= o10 (select n6 o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= (mk_int__ref result3) (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 9))
(assert (and (= temp___1707 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___1707) (<= temp___1707 (to_rep1 n__last))))
(assert (= o12 temp___1707))
...
(assert (= target2 o18))
(assert (<= target2 99))
(assert (and (= temp___1708 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___1708) (<= temp___1708 (to_rep1 n__last))))
(assert (= o19 temp___1708))
...
(assert (= target3 o25))
(assert (<= target3 999))
(assert (and (= temp___1709 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___1709) (<= temp___1709 (to_rep1 n__last))))
(assert (= o26 temp___1709))
...
(assert (= target4 o32))
(assert (<= target4 9999))
(assert (and (= temp___1710 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___1710) (<= temp___1710 (to_rep1 n__last))))
(assert (= o33 temp___1710))
...
(assert (and (= temp___1711 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___1711) (<= temp___1711 (to_rep1 n__last))))
(assert (= o40 temp___1711))
...
(assert (and (= temp___1712 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___1712) (<= temp___1712 (to_rep1 n__last))))
(assert (= o47 temp___1712))
...
(assert (and (= temp___1713 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 n__first) temp___1713) (<= temp___1713 (to_rep1 n__last))))
(assert (= o54 temp___1713))
...
(assert (and (= temp___1721 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1721) (<= temp___1721 (to_rep1 (last (rt source))))))
(assert (= o108 temp___1721))
(assert (= o109 (select (elts source) o108)))
(assert (= o110 (to_rep o109)))
(assert (and (= o111 (convert_character_digit_to_integer o110)) (and (in_range1 o111) (and (and (<= 0 o111) (<= o111 9)) (ite (= (= o110 48) true) (= o111 0) (ite (= (= o110 49) true) (= o111 1) (ite (= (= o110 50) true) (= o111 2) (ite (= (= o110 51) true) (= o111 3) (ite (= (= o110 52) true) (= o111 4) (ite (= (= o110 53) true) (= o111 5) (ite (= (= o110 54) true) (= o111 6) (ite (= (= o110 55) true) (= o111 7) (ite (= (= o110 56) true) (= o111 8) (=> (= (= o110 57) true) (= o111 9)))))))))))))))
(assert (= o112 (* o111 1)))
(assert (and (= o113 o112) (in_range1 o112)))
(assert (and (= temp___1720 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1720) (<= temp___1720 (to_rep1 (last (rt source))))))
(assert (= o102 temp___1720))
...
(assert (and (= temp___1719 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1719) (<= temp___1719 (to_rep1 (last (rt source))))))
(assert (= o96 temp___1719))
(assert (= o97 (select (elts source) o96)))
(assert (= o98 (to_rep o97)))
(assert (and (= o99 (convert_character_digit_to_integer o98)) (and (in_range1 o99) (and (and (<= 0 o99) (<= o99 9)) (ite (= (= o98 48) true) (= o99 0) (ite (= (= o98 49) true) (= o99 1) (ite (= (= o98 50) true) (= o99 2) (ite (= (= o98 51) true) (= o99 3) (ite (= (= o98 52) true) (= o99 4) (ite (= (= o98 53) true) (= o99 5) (ite (= (= o98 54) true) (= o99 6) (ite (= (= o98 55) true) (= o99 7) (ite (= (= o98 56) true) (= o99 8) (=> (= (= o98 57) true) (= o99 9)))))))))))))))
(assert (= o100 (* o99 100)))
(assert (and (= o101 o100) (in_range1 o100)))
(assert (and (= temp___1718 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1718) (<= temp___1718 (to_rep1 (last (rt source))))))
(assert (= o90 temp___1718))
(assert (= o91 (select (elts source) o90)))
(assert (= o92 (to_rep o91)))
(assert (and (= o93 (convert_character_digit_to_integer o92)) (and (in_range1 o93) (and (and (<= 0 o93) (<= o93 9)) (ite (= (= o92 48) true) (= o93 0) (ite (= (= o92 49) true) (= o93 1) (ite (= (= o92 50) true) (= o93 2) (ite (= (= o92 51) true) (= o93 3) (ite (= (= o92 52) true) (= o93 4) (ite (= (= o92 53) true) (= o93 5) (ite (= (= o92 54) true) (= o93 6) (ite (= (= o92 55) true) (= o93 7) (ite (= (= o92 56) true) (= o93 8) (=> (= (= o92 57) true) (= o93 9)))))))))))))))
(assert (= o94 (* o93 1000)))
(assert (and (= o95 o94) (in_range1 o94)))
(assert (and (= temp___1717 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1717) (<= temp___1717 (to_rep1 (last (rt source))))))
(assert (= o82 temp___1717))
...
(assert (and (= temp___1716 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1716) (<= temp___1716 (to_rep1 (last (rt source))))))
(assert (= o74 temp___1716))
...
(assert (and (= temp___1715 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1715) (<= temp___1715 (to_rep1 (last (rt source))))))
(assert (= o66 temp___1715))
(assert (= o67 (select (elts source) o66)))
(assert (= o68 (to_rep o67)))
(assert (and (= o69 (convert_character_digit_to_integer o68)) (and (in_range1 o69) (and (and (<= 0 o69) (<= o69 9)) (ite (= (= o68 48) true) (= o69 0) (ite (= (= o68 49) true) (= o69 1) (ite (= (= o68 50) true) (= o69 2) (ite (= (= o68 51) true) (= o69 3) (ite (= (= o68 52) true) (= o69 4) (ite (= (= o68 53) true) (= o69 5) (ite (= (= o68 54) true) (= o69 6) (ite (= (= o68 55) true) (= o69 7) (ite (= (= o68 56) true) (= o69 8) (=> (= (= o68 57) true) (= o69 9)))))))))))))))
(assert (= o70 (* o69 1000000)))
(assert (and (= o71 o70) (in_range1 o70)))
(assert (and (= temp___1714 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1714) (<= temp___1714 (to_rep1 (last (rt source))))))
(assert (= o61 temp___1714))
...
(assert (= o73 (+ o72 o71)))
(assert (and (= o80 o73) (in_range1 o73)))
(assert (= o81 (+ o80 o79)))
(assert (and (= o88 o81) (in_range1 o81)))
(assert (= o89 (+ o88 o87)))
(assert (not (in_range1 o89)))
(check-sat)
(exit)
