...
(define-fun tnumber_array_typeD1__ref___15__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t1 0)
...
(define-fun number_array_type__ref___15__projection ((a number_array_type__ref)) us_t1 (number_array_type__content a))
...
(declare-datatypes () ((t318b__ref (mk_t318b__ref (t318b__content integer)))))
(define-fun t318b__ref___projection ((a t318b__ref)) integer (t318b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t319b__ref (mk_t319b__ref (t319b__content us_t2)))))
(define-fun t319b__ref___projection ((a t319b__ref)) us_t2 (t319b__content a))
...
(declare-datatypes () ((t320b__ref (mk_t320b__ref (t320b__content integer)))))
(define-fun t320b__ref___projection ((a t320b__ref)) integer (t320b__content a))
...
(define-fun tnumber_array_typeB__ref___15__projection ((a tnumber_array_typeB__ref)) us_t3 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_positive_target_length_5__n__aggregate_def (Int Int Int) us_t2)
(assert (forall ((temp___1675 Int) (temp___1676 Int) (temp___1677 Int)) (let ((temp___1674 (aida__conversion__calculate_positive_target_length_5__n__aggregate_def temp___1675 temp___1676 temp___1677))) (and (=> (dynamic_property6 (first1 source) (+ (first1 source) 4) temp___1676 temp___1677) (and (= (first5 temp___1674) temp___1676) (= (last5 temp___1674) temp___1677))) (forall ((temp___1678 Int)) (= (select (to_array2 temp___1674) temp___1678) (of_rep1 temp___1675)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_419 us_t1) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool)) Bool (=> (not (= temp___skip_constant_417 true)) (and (dynamic_property2 (first1 source) (+ (first1 source) 4) (first3 temp___expr_419) (last3 temp___expr_419)) (and (= (first3 temp___expr_419) (first1 source)) (= (last3 temp___expr_419) (+ (first1 source) 4))))))
...
(declare-const temp___1680 (Array Int integer))
(declare-const temp___16801 t2)
(declare-const aida__conversion__calculate_positive_target_length_5__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_length_5__n__assume1 t1)
(declare-const us1 Int)
(declare-const temp___1687 Int)
(declare-const temp___1684 (Array Int integer))
...
(assert (and (= (length source) 5) (forall ((index13 Int)) (=> (and (<= (to_rep1 (first (rt source))) index13) (<= index13 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index13))) true)))))
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_length_5__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_length_5__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4))))) (+ (to_rep1 (first (rt source))) 4)) (= (mk___t2 temp___1680 temp___16801) (aida__conversion__calculate_positive_target_length_5__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4))))) (and (= (ite (<= (to_rep1 (first4 temp___16801)) (to_rep1 (last4 temp___16801))) (+ (- (to_rep1 (last4 temp___16801)) (to_rep1 (first4 temp___16801))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4)) (+ (- (+ (to_rep1 (first (rt source))) 4) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1680 (to_rep1 (first4 temp___16801)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_length_5__n__assume) (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4)) aida__conversion__calculate_positive_target_length_5__n__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_positive_target_length_5__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_length_5__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_length_5__n__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 4)))) (and (and (and (= temp___1687 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (= (mk_int__ref result1) (mk_int__ref index)) (= index2 (to_rep1 (first (rt source))))) (ite (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1687)) (and (and (and (= temp___1684 n1) (and (= temp___1682 index2) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o index2)) (= o1 (select n1 o))) (= o2 (to_rep1 o1))) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o3 index2)) (= o4 (select (elts source) o3))) (= o5 (to_rep o4))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o7 index2)) (= o8 (store n1 o7 o6)))) (and (= n1 result2) (= n2 o8))))) (and (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (= (to_rep1 (select n3 j1)) (convert_character_digit_to_integer (to_rep (select (elts source) j1)))))) (and (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4) index3)) (forall ((temp___1685 Int)) (=> (and (<= (to_rep1 n__first) temp___1685) (<= temp___1685 (to_rep1 n__last))) (=> (< index3 temp___1685) (= (select n3 temp___1685) (select temp___1684 temp___1685)))))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 4)))) (= index3 temp___1687)))))) (and (and (= index3 index7) (= n3 n7)) (and (= index8 index3) (= n8 n3)))) (and (and (= (mk_int__ref index9) (mk_int__ref index7)) (= (mk_map__ref1 n9) (mk_map__ref1 n7))) (and (= index10 index8) (= n10 n8)))) (and (and (= index2 index9) (= n1 n9)) (and (= index10 index2) (= n10 n1)))))) (and (and (and (and (and (and (= temp___1688 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (<= (to_rep1 n__first) temp___1688) (<= temp___1688 (to_rep1 n__last))) (= o22 temp___1688))) (= o23 (select n9 o22))) (= o24 (to_rep1 o23))) (and (= (mk_int__ref result5) (mk_int__ref target)) (= target1 o24))) (and (<= target1 9) (and (and (and (and (and (and (and (and (and (and (= temp___1689 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))) (and (and (<= (to_rep1 n__first) temp___1689) (<= temp___1689 (to_rep1 n__last))) (= o25 temp___1689))) (= o26 (select n9 o25))) (= o27 (to_rep1 o26))) (= o28 (* o27 10))) (and (= o29 o28) (in_range1 o28))) (= o30 (+ target1 o29))) (and (= o31 o30) (in_range1 o30))) (and (= target1 result6) (= target2 o31))) (and (<= target2 99) (and (and (and (and (and (and (and (and (and (and (= temp___1690 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))) (and (and (<= (to_rep1 n__first) temp___1690) (<= temp___1690 (to_rep1 n__last))) (= o32 temp___1690))) (= o33 (select n9 o32))) (= o34 (to_rep1 o33))) (= o35 (* o34 100))) (and (= o36 o35) (in_range1 o35))) (= o37 (+ target2 o36))) (and (= o38 o37) (in_range1 o37))) (and (= result7 (mk_int__ref target2)) (= target3 o38))) (and (<= target3 999) (and (and (and (and (and (and (and (and (and (and (= temp___1691 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))) (and (and (<= (to_rep1 n__first) temp___1691) (<= temp___1691 (to_rep1 n__last))) (= o39 temp___1691))) (= o40 (select n9 o39))) (= o41 (to_rep1 o40))) (= o42 (* o41 1000))) (and (= o43 o42) (in_range1 o42))) (= o44 (+ target3 o43))) (and (= o45 o44) (in_range1 o44))) (and (= result8 (mk_int__ref target3)) (= target4 o45))) (and (<= target4 9999) (and (and (and (and (and (and (and (and (and (and (= temp___1692 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))) (and (and (<= (to_rep1 n__first) temp___1692) (<= temp___1692 (to_rep1 n__last))) (= o46 temp___1692))) (= o47 (select n9 o46))) (= o48 (to_rep1 o47))) (= o49 (* o48 10000))) (and (= o50 o49) (in_range1 o49))) (= o51 (+ target4 o50))) (and (= o52 o51) (in_range1 o51))) (and (= result9 (mk_int__ref target4)) (= target5 o52))) (and (<= target5 99999) (and (= result10 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0)))))))))))))))) (and (and (= index11 (mk_int__ref index9)) (and (= n11 (mk_map__ref1 n9)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target6 (mk_int__ref target5))))) (and (= index12 index10) (and (= n12 n10) (and (= has_failed3 has_failed1) (= target7 target5)))))))
(assert (and (= temp___1697 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1697) (<= temp___1697 (to_rep1 (last (rt source))))))
(assert (= o82 temp___1697))
...
(assert (and (= temp___1696 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1696) (<= temp___1696 (to_rep1 (last (rt source))))))
(assert (= o74 temp___1696))
...
(assert (and (= temp___1695 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1695) (<= temp___1695 (to_rep1 (last (rt source))))))
(assert (= o66 temp___1695))
...
(assert (and (= temp___1694 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1694) (<= temp___1694 (to_rep1 (last (rt source))))))
(assert (= o58 temp___1694))
(assert (= o59 (select (elts source) o58)))
(assert (= o60 (to_rep o59)))
(assert (and (= o61 (convert_character_digit_to_integer o60)) (and (in_range1 o61) (and (and (<= 0 o61) (<= o61 9)) (ite (= (= o60 48) true) (= o61 0) (ite (= (= o60 49) true) (= o61 1) (ite (= (= o60 50) true) (= o61 2) (ite (= (= o60 51) true) (= o61 3) (ite (= (= o60 52) true) (= o61 4) (ite (= (= o60 53) true) (= o61 5) (ite (= (= o60 54) true) (= o61 6) (ite (= (= o60 55) true) (= o61 7) (ite (= (= o60 56) true) (= o61 8) (=> (= (= o60 57) true) (= o61 9)))))))))))))))
(assert (= o62 (* o61 1000)))
(assert (and (= o63 o62) (in_range1 o62)))
(assert (and (= temp___1693 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1693)))
(check-sat)
(exit)
