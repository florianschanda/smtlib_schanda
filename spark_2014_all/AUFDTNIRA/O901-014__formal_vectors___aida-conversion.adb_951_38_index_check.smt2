...
(define-fun dynamic_invariant4 ((temp___expr_474 us_t1) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool) (temp___do_typ_inv_473 Bool)) Bool (=> (not (= temp___skip_constant_471 true)) (and (dynamic_property2 (first1 source) (+ (first1 source) 4) (first3 temp___expr_474) (last3 temp___expr_474)) (and (= (first3 temp___expr_474) (first1 source)) (= (last3 temp___expr_474) (+ (first1 source) 4))))))
(declare-sort t3 0)
...
(assert (forall ((temp___1777 Int) (temp___1778 Int) (temp___1779 Int)) (let ((temp___1776 (aida__conversion__calculate_positive_target_length_5__n__aggregate_def temp___1777 temp___1778 temp___1779))) (=> (dynamic_invariant temp___1777 true true true true) (and (=> (dynamic_property6 (first1 source) (+ (first1 source) 4) temp___1778 temp___1779) (and (= (first5 temp___1776) temp___1778) (= (last5 temp___1776) temp___1779))) (forall ((temp___1780 Int)) (= (to_rep1 (select (to_array2 temp___1776) temp___1780)) temp___1777)))))))
(declare-const target Int)
(declare-const has_failed Bool)
(declare-const n (Array Int integer))
(declare-const index Int)
(declare-const temp___1782 (Array Int integer))
(declare-const temp___17821 t2)
...
(declare-const temp___1786 (Array Int integer))
...
(assert (and (= (length source) 5) (forall ((index10 Int)) (=> (and (<= (to_rep1 (first (rt source))) index10) (<= index10 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index10))) true)))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_length_5__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_length_5__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4))))) (+ (to_rep1 (first (rt source))) 4)))
(assert (= (mk___t2 temp___1782 temp___17821) (aida__conversion__calculate_positive_target_length_5__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4))))
(assert (= (ite (<= (to_rep1 (first4 temp___17821)) (to_rep1 (last4 temp___17821))) (+ (- (to_rep1 (last4 temp___17821)) (to_rep1 (first4 temp___17821))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4)) (+ (- (+ (to_rep1 (first (rt source))) 4) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1782 (to_rep1 (first4 temp___17821)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_length_5__n__assume))
(assert (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4)) aida__conversion__calculate_positive_target_length_5__n__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_positive_target_length_5__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_length_5__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_length_5__n__assume1))))
(assert (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 4)))))
(assert (and (= temp___1789 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (= (mk_int__ref result1) (mk_int__ref index)))
(assert (= index1 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= temp___1786 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= temp___1784 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= o index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= o1 (select n1 o))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= o3 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= o5 (to_rep o4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= o7 index1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= n1 result2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= n2 o8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (forall ((j Int)) (=> (and (<= (to_rep1 (first (rt source))) j) (<= j index2)) (= (to_rep1 (select n3 j)) (convert_character_digit_to_integer (to_rep (select (elts source) j))))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 4) index2)) (forall ((temp___1787 Int)) (=> (and (<= (to_rep1 n__first) temp___1787) (<= temp___1787 (to_rep1 n__last))) (=> (< index2 temp___1787) (= (select n3 temp___1787) (select temp___1786 temp___1787)))))) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (+ (to_rep1 (first (rt source))) 4))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= index2 temp___1789)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= index2 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= n3 n4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= index4 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= n5 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= index9 (mk_int__ref index3))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= n10 (mk_map__ref1 n4))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= index6 index4)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789)) (= n7 n5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789))) (= index1 index5)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789))) (= n1 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789))) (= index6 index1)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index1) (<= index1 temp___1789))) (= n7 n1)))
(assert (and (= temp___1790 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___1790) (<= temp___1790 (to_rep1 n__last))))
(assert (= o9 temp___1790))
(assert (= o10 (select n6 o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= (mk_int__ref result3) (mk_int__ref target)))
(assert (= target1 o11))
(assert (<= target1 9))
(assert (and (= temp___1791 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___1791) (<= temp___1791 (to_rep1 n__last))))
(assert (= o12 temp___1791))
...
(assert (= target2 o18))
(assert (<= target2 99))
(assert (and (= temp___1792 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___1792) (<= temp___1792 (to_rep1 n__last))))
(assert (= o19 temp___1792))
...
(assert (= target3 o25))
(assert (<= target3 999))
(assert (and (= temp___1793 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___1793) (<= temp___1793 (to_rep1 n__last))))
(assert (= o26 temp___1793))
...
(assert (= target4 o32))
(assert (<= target4 9999))
(assert (and (= temp___1794 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 n__first) temp___1794) (<= temp___1794 (to_rep1 n__last))))
(assert (= o33 temp___1794))
...
(assert (= target6 (mk_int__ref target5)))
(assert (= index8 index6))
(assert (= n9 n7))
(assert (= has_failed3 has_failed1))
(assert (= target7 target5))
(assert (and (= temp___1799 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1799) (<= temp___1799 (to_rep1 (last (rt source))))))
(assert (= o58 temp___1799))
...
(assert (and (= temp___1798 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1798) (<= temp___1798 (to_rep1 (last (rt source))))))
(assert (= o52 temp___1798))
...
(assert (and (= temp___1797 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1797) (<= temp___1797 (to_rep1 (last (rt source))))))
(assert (= o46 temp___1797))
(assert (= o47 (select (elts source) o46)))
(assert (= o48 (to_rep o47)))
(assert (and (= o49 (convert_character_digit_to_integer o48)) (and (in_range1 o49) (and (and (<= 0 o49) (<= o49 9)) (ite (= (= o48 48) true) (= o49 0) (ite (= (= o48 49) true) (= o49 1) (ite (= (= o48 50) true) (= o49 2) (ite (= (= o48 51) true) (= o49 3) (ite (= (= o48 52) true) (= o49 4) (ite (= (= o48 53) true) (= o49 5) (ite (= (= o48 54) true) (= o49 6) (ite (= (= o48 55) true) (= o49 7) (ite (= (= o48 56) true) (= o49 8) (=> (= (= o48 57) true) (= o49 9)))))))))))))))
(assert (= o50 (* o49 100)))
(assert (and (= o51 o50) (in_range1 o50)))
(assert (and (= temp___1796 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1796) (<= temp___1796 (to_rep1 (last (rt source))))))
(assert (= o40 temp___1796))
(assert (= o41 (select (elts source) o40)))
(assert (= o42 (to_rep o41)))
(assert (and (= o43 (convert_character_digit_to_integer o42)) (and (in_range1 o43) (and (and (<= 0 o43) (<= o43 9)) (ite (= (= o42 48) true) (= o43 0) (ite (= (= o42 49) true) (= o43 1) (ite (= (= o42 50) true) (= o43 2) (ite (= (= o42 51) true) (= o43 3) (ite (= (= o42 52) true) (= o43 4) (ite (= (= o42 53) true) (= o43 5) (ite (= (= o42 54) true) (= o43 6) (ite (= (= o42 55) true) (= o43 7) (ite (= (= o42 56) true) (= o43 8) (=> (= (= o42 57) true) (= o43 9)))))))))))))))
(assert (= o44 (* o43 1000)))
(assert (and (= o45 o44) (in_range1 o44)))
(assert (and (= temp___1795 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1795)))
(check-sat)
(exit)
