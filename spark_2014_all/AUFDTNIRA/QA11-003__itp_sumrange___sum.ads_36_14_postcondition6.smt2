...
(assert (= k1 i))
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (= temp___159 k1)))
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (= temp___158 s1)))
...
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (and (= o4 (+ s2 (to_rep (select a k2)))) (in_range1 (+ s2 (to_rep (select a k2)))))))
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (= s2 result2)))
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (= s3 o4)))
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (= k2 (- j 1))))
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (= k2 k4)))
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (= s3 s4)))
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (= k5 k2)))
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (= s5 s3)))
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (= (mk_int__ref k6) (mk_int__ref k4))))
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (= (mk_int__ref s6) (mk_int__ref s4))))
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (= k7 k5)))
(assert (=> (and (<= i k1) (<= k1 (- j 1))) (= s7 s5)))
(assert (=> (not (and (<= i k1) (<= k1 (- j 1)))) (= k1 k6)))
(assert (=> (not (and (<= i k1) (<= k1 (- j 1)))) (= s1 s6)))
(assert (=> (not (and (<= i k1) (<= k1 (- j 1)))) (= k7 k1)))
