...
(assert (and (and (and (= o (extractuser tokenpresence state tokentry tokenid (us_split_fields__content7 authcert__split_fields) (us_split_fields__content10 idcert__split_fields))) (and (= (valid_numberlogentries (to_rep2 logfilestate__split_fields7) (to_rep3 logfilestate__split_fields8) (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) true) (in_range4 auditalarm1))) (and (and (= (mk_int__ref result) (mk_int__ref status)) (= status1 3)) (and (and (in_range3 tokenpresence1) (in_range12 tokentry1)) (in_range11 tokenid1)))) (and (and (= state4 (mk___private__ref state2)) (and (= state3 (mk___private__ref state1)) (and (= filestate1 (mk___private__ref filestate)) (and (= status2 (mk_int__ref status1)) (and (= idcert__split_fields2 (let ((subject idcert__split_fields)) (mk___split_fields__ref10 idcert__split_fields1))) (and (= authcert__split_fields2 (let ((subject authcert__split_fields)) (mk___split_fields__ref7 authcert__split_fields1))) (and (= tokenid2 (mk_int__ref tokenid1)) (and (= tokentry2 (mk_int__ref tokentry1)) (and (= tokenpresence2 (mk_int__ref tokenpresence1)) (and (= auditsystemfault1 (mk_bool__ref auditsystemfault)) (and (= auditalarm2 (mk_int__ref auditalarm1)) (and (= logfilestate__split_fields14 (mk___split_fields__ref1 (mk___split_fields1 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13))) (and (= logfilesstatus logfilesstatus1) (= logfiles logfiles1)))))))))))))) (and (= state6 state2) (and (= state5 state1) (and (= filestate2 filestate) (and (= status3 status1) (and (= idcert__split_fields3 idcert__split_fields1) (and (= authcert__split_fields3 authcert__split_fields1) (and (= tokenid3 tokenid1) (and (= tokentry3 tokentry1) (and (= tokenpresence3 tokenpresence1) (and (= auditsystemfault2 auditsystemfault) (and (= auditalarm3 auditalarm1) (and (= logfilestate__split_fields15 (mk___split_fields1 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13)) (and (= logfilesstatus2 logfilesstatus) (= logfiles2 logfiles)))))))))))))))))
