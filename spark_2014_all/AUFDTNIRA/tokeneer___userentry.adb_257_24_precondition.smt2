...
(define-fun dynamic_invariant1 ((temp___expr_1149 Int) (temp___is_init_1145 Bool) (temp___skip_constant_1146 Bool) (temp___do_toplevel_1147 Bool) (temp___do_typ_inv_1148 Bool)) Bool (=> (or (= temp___is_init_1145 true) (<= 0 2000)) (in_range9 temp___expr_1149)))
(declare-fun thefingerwaitduration (us_private) Int)
(declare-fun thefingerwaitduration__function_guard (Int us_private) Bool)
(assert (forall ((configdata__state us_private)) (! (dynamic_invariant1 (thefingerwaitduration configdata__state) true false true true) :pattern ((thefingerwaitduration configdata__state)))))
...
(define-fun dynamic_invariant3 ((temp___expr_2558 Int) (temp___is_init_2554 Bool) (temp___skip_constant_2555 Bool) (temp___do_toplevel_2556 Bool) (temp___do_typ_inv_2557 Bool)) Bool (=> (or (= temp___is_init_2554 true) (<= 0 7)) (in_range18 temp___expr_2558)))
...
(define-fun dynamic_invariant8 ((temp___expr_1171 Int) (temp___is_init_1167 Bool) (temp___skip_constant_1168 Bool) (temp___do_toplevel_1169 Bool) (temp___do_typ_inv_1170 Bool)) Bool (=> (or (= temp___is_init_1167 true) (<= 0 17)) (in_range12 temp___expr_1171)))
(define-fun dynamic_invariant9 ((temp___expr_1178 Int) (temp___is_init_1174 Bool) (temp___skip_constant_1175 Bool) (temp___do_toplevel_1176 Bool) (temp___do_typ_inv_1177 Bool)) Bool (=> (or (= temp___is_init_1174 true) (<= 1 17)) (in_range10 temp___expr_1178)))
(define-fun dynamic_invariant10 ((temp___expr_1304 Int) (temp___is_init_1300 Bool) (temp___skip_constant_1301 Bool) (temp___do_toplevel_1302 Bool) (temp___do_typ_inv_1303 Bool)) Bool (=> (or (= temp___is_init_1300 true) (<= 0 2)) (in_range14 temp___expr_1304)))
(define-fun dynamic_invariant11 ((temp___expr_1185 Int) (temp___is_init_1181 Bool) (temp___skip_constant_1182 Bool) (temp___do_toplevel_1183 Bool) (temp___do_typ_inv_1184 Bool)) Bool (=> (or (= temp___is_init_1181 true) (<= 0 17408)) (in_range11 temp___expr_1185)))
(define-fun dynamic_invariant12 ((temp___expr_1216 Int) (temp___is_init_1212 Bool) (temp___skip_constant_1213 Bool) (temp___do_toplevel_1214 Bool) (temp___do_typ_inv_1215 Bool)) Bool (=> (or (= temp___is_init_1212 true) (<= 0 1024)) (in_range13 temp___expr_1216)))
(assert true)
...
(assert (forall ((temp___1245 Int)) (=> (dynamic_invariant12 temp___1245 true true true true) (forall ((temp___1246 Int)) (= (to_rep9 (select (temp___1243 temp___1245) temp___1246)) temp___1245)))))
(define-fun dynamic_invariant13 ((temp___expr_590 Int) (temp___is_init_586 Bool) (temp___skip_constant_587 Bool) (temp___do_toplevel_588 Bool) (temp___do_typ_inv_589 Bool)) Bool (=> (or (= temp___is_init_586 true) (<= 1 150)) (in_range4 temp___expr_590)))
...
(define-fun dynamic_invariant14 ((temp___expr_642 Int) (temp___is_init_638 Bool) (temp___skip_constant_639 Bool) (temp___do_toplevel_640 Bool) (temp___do_typ_inv_641 Bool)) Bool (=> (or (= temp___is_init_638 true) (<= 1901 2099)) (in_range5 temp___expr_642)))
(define-fun dynamic_invariant15 ((temp___expr_649 Int) (temp___is_init_645 Bool) (temp___skip_constant_646 Bool) (temp___do_toplevel_647 Bool) (temp___do_typ_inv_648 Bool)) Bool (=> (or (= temp___is_init_645 true) (<= 1 12)) (in_range6 temp___expr_649)))
(define-fun dynamic_invariant16 ((temp___expr_656 Int) (temp___is_init_652 Bool) (temp___skip_constant_653 Bool) (temp___do_toplevel_654 Bool) (temp___do_typ_inv_655 Bool)) Bool (=> (or (= temp___is_init_652 true) (<= 1 31)) (in_range7 temp___expr_656)))
(define-fun dynamic_invariant17 ((temp___expr_688 Int) (temp___is_init_684 Bool) (temp___skip_constant_685 Bool) (temp___do_toplevel_686 Bool) (temp___do_typ_inv_687 Bool)) Bool (=> (or (= temp___is_init_684 true) (<= 0 86399999)) (in_range8 temp___expr_688)))
(define-fun dynamic_invariant18 ((temp___expr_403 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool) (temp___do_typ_inv_402 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 40)) (in_range15 temp___expr_403)))
(define-fun dynamic_invariant19 ((temp___expr_427 Int) (temp___is_init_423 Bool) (temp___skip_constant_424 Bool) (temp___do_toplevel_425 Bool) (temp___do_typ_inv_426 Bool)) Bool (=> (or (= temp___is_init_423 true) (<= 0 4294967295)) (in_range16 temp___expr_427)))
(define-fun dynamic_invariant20 ((temp___expr_1781 Int) (temp___is_init_1777 Bool) (temp___skip_constant_1778 Bool) (temp___do_toplevel_1779 Bool) (temp___do_typ_inv_1780 Bool)) Bool (=> (or (= temp___is_init_1777 true) (<= 0 2147483647)) (in_range17 temp___expr_1781)))
(assert (forall ((temp___1241 Int)) (=> (dynamic_invariant9 temp___1241 true true true true) (forall ((temp___1242 Int)) (= (to_rep6 (select (temp___1239 temp___1241) temp___1242)) temp___1241)))))
...
(assert (= o2 (extractuser (let ((subject state)) state1))))
