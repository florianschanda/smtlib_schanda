...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def 3 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 5) (+ (+ (to_rep1 (first (rt source))) 5) 5))))) (+ (to_rep1 (first (rt source))) 5)) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def 3 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 5) (+ (+ (to_rep1 (first (rt source))) 5) 5))))) (+ (+ (to_rep1 (first (rt source))) 5) 5)) (= (mk___t2 temp___1983 temp___19831) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__aggregate_def 3 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 5) (+ (+ (to_rep1 (first (rt source))) 5) 5))))) (and (= (ite (<= (to_rep1 (first4 temp___19831)) (to_rep1 (last4 temp___19831))) (+ (- (to_rep1 (last4 temp___19831)) (to_rep1 (first4 temp___19831))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 5)) 1) 0)) (and (= (slide1 temp___1983 (to_rep1 (first4 temp___19831)) (+ (to_rep1 (first (rt source))) 5)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume) (= (mk1 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__int_array__assume1)))))) (and (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 5)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 5)) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)) (= (mk___t4 temp___1991 temp___19911) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10))))) (and (= (ite (<= (to_rep1 (first8 temp___19911)) (to_rep1 (last8 temp___19911))) (+ (- (to_rep1 (last8 temp___19911)) (to_rep1 (first8 temp___19911))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 5)) 1) 0)) (and (= (slide1 temp___1991 (to_rep1 (first8 temp___19911)) (+ (to_rep1 (first (rt source))) 5)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume) (= (mk3 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume1)))) (and (and (= (mk_map__ref1 result2) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_3xx_xxx__n__assume1)))))) (and (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 5)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))) (and (and (and (= temp___1997 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (= temp___1998 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))) (and (and (= (mk_int__ref result3) (mk_int__ref index)) (= index2 temp___1997)) (ite (and (<= temp___1997 index2) (<= index2 temp___1998)) (and (and (and (= temp___1996 index2) (and (= temp___1994 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o25 index2)) (= o26 (select n1 o25))) (= o27 (to_rep1 o26))) (= o27 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o28 index2)) (= o29 (select (elts source) o28))) (= o30 (to_rep o29))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o30))) (ite (= (= o30 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o30 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o30 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o30 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o30 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o30 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o30 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o30 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o30 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o30 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o31) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o32 index2)) (= o33 (store n1 o32 o31)))) (and (= n1 result4) (= n2 o33))))) (and (and (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 5) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (forall ((temp___1995 Int)) (=> (and (<= (to_rep1 n__first) temp___1995) (<= temp___1995 (to_rep1 n__last))) (=> (< index3 temp___1995) (= (select n3 temp___1995) (select temp___1994 temp___1995))))) (=> (<= (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 5) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 5) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10)))) (= index3 temp___1998)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1))))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (and (and (= temp___1999 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))) (and (and (<= (to_rep1 n__first) temp___1999) (<= temp___1999 (to_rep1 n__last))) (= o61 temp___1999))) (= o62 (select (map__content1 n7) o61))) (= o63 (to_rep1 o62))) (= o64 (- o63))) (and (= o65 o64) (in_range1 o64))) (and (= result9 (mk_int__ref target)) (= target1 o65))) (and (<= (- 9) target1) (and (and (and (and (and (and (and (and (and (and (= temp___2000 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (<= (to_rep1 n__first) temp___2000) (<= temp___2000 (to_rep1 n__last))) (= o66 temp___2000))) (= o67 (select (map__content1 n7) o66))) (= o68 (to_rep1 o67))) (= o69 (* o68 10))) (and (= o70 o69) (in_range1 o69))) (= o71 (- target1 o70))) (and (= o72 o71) (in_range1 o71))) (and (= result10 (mk_int__ref target1)) (= target2 o72))) (and (<= (- 99) target2) (and (and (and (and (and (and (and (and (and (and (= temp___2001 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (<= (to_rep1 n__first) temp___2001) (<= temp___2001 (to_rep1 n__last))) (= o73 temp___2001))) (= o74 (select (map__content1 n7) o73))) (= o75 (to_rep1 o74))) (= o76 (* o75 100))) (and (= o77 o76) (in_range1 o76))) (= o78 (- target2 o77))) (and (= o79 o78) (in_range1 o78))) (and (= result11 (mk_int__ref target2)) (= target3 o79))) (and (<= (- 999) target3) (and (and (and (and (and (and (and (and (and (and (= temp___2002 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))) (and (and (<= (to_rep1 n__first) temp___2002) (<= temp___2002 (to_rep1 n__last))) (= o80 temp___2002))) (= o81 (select (map__content1 n7) o80))) (= o82 (to_rep1 o81))) (= o83 (* o82 1000))) (and (= o84 o83) (in_range1 o83))) (= o85 (- target3 o84))) (and (= o86 o85) (in_range1 o85))) (and (= result12 (mk_int__ref target3)) (= target4 o86))) (and (<= (- 9999) target4) (and (and (and (and (and (and (and (and (and (and (= temp___2003 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))) (and (and (<= (to_rep1 n__first) temp___2003) (<= temp___2003 (to_rep1 n__last))) (= o87 temp___2003))) (= o88 (select (map__content1 n7) o87))) (= o89 (to_rep1 o88))) (= o90 (* o89 10000))) (and (= o91 o90) (in_range1 o90))) (= o92 (- target4 o91))) (and (= o93 o92) (in_range1 o92))) (and (= result13 (mk_int__ref target4)) (= target5 o93))) (and (<= (- 99999) target5) (and (and (and (and (and (and (and (and (and (and (= temp___2004 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (<= (to_rep1 n__first) temp___2004) (<= temp___2004 (to_rep1 n__last))) (= o94 temp___2004))) (= o95 (select (map__content1 n7) o94))) (= o96 (to_rep1 o95))) (= o97 (* o96 100000))) (and (= o98 o97) (in_range1 o97))) (= o99 (- target5 o98))) (and (= o100 o99) (in_range1 o99))) (and (= result14 (mk_int__ref target5)) (= target6 o100))) (and (<= (- 399999) target6) (and (and (and (= o101 (- target6 2147000000)) (in_range1 (- target6 2147000000))) (and (= result15 (mk_int__ref target6)) (= target7 o101))) (and (<= (- 2147399999) target7) (and (= result16 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target8 (mk_int__ref target7)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target9 target7))))))))
