...
(assert (and (= temp___1641 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1641) (<= temp___1641 (to_rep1 (last (rt source))))))
(assert (= o67 temp___1641))
...
(assert (= o71 (* o70 1000000)))
(assert (and (= o78 o71) (in_range1 o71)))
(assert (= o79 (+ o78 o77)))
