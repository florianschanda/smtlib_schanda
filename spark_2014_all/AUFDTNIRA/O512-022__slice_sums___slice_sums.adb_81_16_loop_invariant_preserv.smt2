...
(assert (<= lo_index2 (- current_hi4 1)))
(declare-const hi_index2 Int)
(assert (<= (to_rep3 (first (rt x))) hi_index2))
(assert (<= hi_index2 (- current_hi4 1)))
(assert (not (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep1 lo_index2) (of_rep2 hi_index2)))) max_sum3)))
(check-sat)
(exit)
