...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep2 (select a (+ i 1))) (to_rep2 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep2 (select b (+ i 1))) (to_rep2 (select a (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq4 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep5 (select a (+ i 1))) (to_rep5 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq4 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep5 (select b (+ i 1))) (to_rep5 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq5 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 a))) (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 b)))) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 a))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 b))))) (= (bool_eq3 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 b))) true)) (= (bool_eq4 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 b)) 1 17) true)) true false))
...
(define-fun bool_eq6 ((a (Array Int us_rep1)) (a__first Int) (a__last Int) (b (Array Int us_rep1)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (bool_eq1 (select a temp___idx_175) (select b (+ (- b__first a__first) temp___idx_175))) true)))) true false))
(assert (forall ((a (Array Int us_rep1)) (b (Array Int us_rep1))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (bool_eq1 (select a temp___idx_175) (select b (+ (- b__first a__first) temp___idx_175))) true))))))))
...
(assert (not (= status 6)))
(assert (= o1 (currentfloppy state1)))
(assert (= result4 (mk_t__ref1 thecurrentfloppy)))
(assert (= thecurrentfloppy2 o1))
(assert (and (in_range6 auditalarm3) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true)))
(assert (=> (= configdataok2 true) (and (in_range6 auditalarm4) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true))))
(assert (=> (not (= configdataok2 true)) (and (in_range6 auditalarm5) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true))))
(assert (=> (not (= configdataok2 true)) (= (let ((subject state2)) (mk___private__ref state12)) (let ((subject state2)) (mk___private__ref state14)))))
(assert (=> (not (= configdataok2 true)) (= state11 state13)))
(assert (=> (not (= configdataok2 true)) (= filestate5 filestate6)))
(assert (=> (not (= configdataok2 true)) (= auditsystemfault2 auditsystemfault3)))
(assert (=> (not (= configdataok2 true)) (= auditalarm4 auditalarm5)))
(assert (=> (not (= configdataok2 true)) (= logfilestate__split_fields10 logfilestate__split_fields11)))
(assert (=> (not (= configdataok2 true)) (= logfilesstatus2 logfilesstatus3)))
(assert (=> (not (= configdataok2 true)) (= logfiles2 logfiles3)))
(assert (=> (not (= configdataok2 true)) (= state12 state14)))
(assert (=> (not (= configdataok2 true)) (= state11 state13)))
(assert (=> (not (= configdataok2 true)) (= filestate5 filestate6)))
(assert (=> (not (= configdataok2 true)) (= auditsystemfault2 auditsystemfault3)))
(assert (=> (not (= configdataok2 true)) (= auditalarm4 auditalarm5)))
...
(assert (=> (not (= configdataok2 true)) (= logfilesstatus2 logfilesstatus3)))
(assert (=> (not (= configdataok2 true)) (= logfiles2 logfiles3)))
(assert (= result5 (mk_int__ref status)))
(assert (= status3 3))
