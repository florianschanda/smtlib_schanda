...
(assert (forall ((temp___1535 Int) (temp___1536 Int) (temp___1537 Int)) (let ((temp___1534 (aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__aggregate_def temp___1535 temp___1536 temp___1537))) (and (=> (dynamic_property6 (first1 source) (+ (first1 source) 9) temp___1536 temp___1537) (and (= (first5 temp___1534) temp___1536) (= (last5 temp___1534) temp___1537))) (forall ((temp___1538 Int)) (= (select (to_array2 temp___1534) temp___1538) (of_rep1 temp___1535)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_329 us_t1) (temp___is_init_326 Bool) (temp___skip_constant_327 Bool) (temp___do_toplevel_328 Bool)) Bool (=> (not (= temp___skip_constant_327 true)) (and (dynamic_property2 (first1 source) (+ (first1 source) 9) (first3 temp___expr_329) (last3 temp___expr_329)) (and (= (first3 temp___expr_329) (first1 source)) (= (last3 temp___expr_329) (+ (first1 source) 9))))))
...
(declare-const temp___1540 (Array Int integer))
(declare-const temp___15401 t2)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__assume1 t1)
(declare-const us1 Int)
(declare-const temp___1547 Int)
(declare-const temp___1545 Int)
(declare-const temp___1543 (Array Int integer))
...
(assert (and (and (= (length source) 10) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50)) (forall ((index13 Int)) (=> (and (<= (to_rep1 (first (rt source))) index13) (<= index13 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index13))) true)))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t2 temp___1540 temp___15401) (aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___15401)) (to_rep1 (last4 temp___15401))) (+ (- (to_rep1 (last4 temp___15401)) (to_rep1 (first4 temp___15401))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1540 (to_rep1 (first4 temp___15401)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__assume))
(assert (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_1_xxx_xxx_xxx__n__assume1))))
(assert (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 9)))))
(assert (and (= temp___1547 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result1) (mk_int__ref index)))
(assert (= index2 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1547)) (and (and (= temp___1545 index2) (and (= temp___1543 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o1 index2)) (= o2 (select n1 o1))) (= o3 (to_rep1 o2))) (= o3 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o4 index2)) (= o5 (select (elts source) o4))) (= o6 (to_rep o5))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o6))) (ite (= (= o6 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o6 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o6 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o6 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o6 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o6 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o6 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o6 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o6 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o6 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o7) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o8 index2)) (= o9 (store n1 o8 o7)))) (and (= n1 result2) (= n2 o9))))) (and (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (= (to_rep1 (select n3 j1)) (convert_character_digit_to_integer (to_rep (select (elts source) j1)))))) (and (and (and (forall ((temp___1544 Int)) (=> (and (<= (to_rep1 n__first) temp___1544) (<= temp___1544 (to_rep1 n__last))) (=> (< index3 temp___1544) (= (select n3 temp___1544) (select temp___1543 temp___1544))))) (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property5 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9)))) (= index3 temp___1547)))))) (and (and (= index3 index7) (= n3 n7)) (and (= index8 index3) (= n8 n3))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1547)) (= (mk_int__ref index9) (mk_int__ref index7))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1547)) (= (mk_map__ref1 n9) (mk_map__ref1 n7))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1547)) (= index10 index8)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1547)) (= n10 n8)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1547))) (= index2 index9)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1547))) (= n1 n9)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1547))) (= index10 index2)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1547))) (= n10 n1)))
(assert (and (= temp___1548 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1548) (<= temp___1548 (to_rep1 n__last))))
(assert (= o23 temp___1548))
(assert (= o24 (select n9 o23)))
(assert (= o25 (to_rep1 o24)))
(assert (= (mk_int__ref result5) (mk_int__ref target)))
(assert (= target1 o25))
(assert (<= target1 9))
(assert (and (= temp___1549 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1549) (<= temp___1549 (to_rep1 n__last))))
(assert (= o26 temp___1549))
(assert (= o27 (select n9 o26)))
(assert (= o28 (to_rep1 o27)))
(assert (= o29 (* o28 10)))
(assert (and (= o30 o29) (in_range1 o29)))
(assert (= o31 (+ target1 o30)))
(assert (and (= o32 o31) (in_range1 o31)))
(assert (= target1 result6))
(assert (= target2 o32))
(assert (<= target2 99))
(assert (and (= temp___1550 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1550) (<= temp___1550 (to_rep1 n__last))))
(assert (= o33 temp___1550))
(assert (= o34 (select n9 o33)))
(assert (= o35 (to_rep1 o34)))
(assert (= o36 (* o35 100)))
(assert (and (= o37 o36) (in_range1 o36)))
(assert (= o38 (+ target2 o37)))
(assert (and (= o39 o38) (in_range1 o38)))
(assert (= result7 (mk_int__ref target2)))
(assert (= target3 o39))
(assert (<= target3 999))
(assert (and (= temp___1551 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___1551) (<= temp___1551 (to_rep1 n__last))))
(assert (= o40 temp___1551))
(assert (= o41 (select n9 o40)))
(assert (= o42 (to_rep1 o41)))
(assert (= o43 (* o42 1000)))
(assert (and (= o44 o43) (in_range1 o43)))
(assert (= o45 (+ target3 o44)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (= result8 (mk_int__ref target3)))
(assert (= target4 o46))
(assert (<= target4 9999))
(assert (and (= temp___1552 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___1552) (<= temp___1552 (to_rep1 n__last))))
(assert (= o47 temp___1552))
(assert (= o48 (select n9 o47)))
(assert (= o49 (to_rep1 o48)))
(assert (= o50 (* o49 10000)))
(assert (and (= o51 o50) (in_range1 o50)))
(assert (= o52 (+ target4 o51)))
(assert (and (= o53 o52) (in_range1 o52)))
(assert (= result9 (mk_int__ref target4)))
(assert (= target5 o53))
(assert (<= target5 99999))
(assert (and (= temp___1553 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___1553) (<= temp___1553 (to_rep1 n__last))))
(assert (= o54 temp___1553))
(assert (= o55 (select n9 o54)))
(assert (= o56 (to_rep1 o55)))
(assert (= o57 (* o56 100000)))
(assert (and (= o58 o57) (in_range1 o57)))
(assert (= o59 (+ target5 o58)))
(assert (and (= o60 o59) (in_range1 o59)))
(assert (= result10 (mk_int__ref target5)))
(assert (= target6 o60))
(assert (<= target6 999999))
(assert (and (= temp___1554 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___1554) (<= temp___1554 (to_rep1 n__last))))
(assert (= o61 temp___1554))
(assert (= o62 (select n9 o61)))
(assert (= o63 (to_rep1 o62)))
(assert (= o64 (* o63 1000000)))
(assert (and (= o65 o64) (in_range1 o64)))
(assert (= o66 (+ target6 o65)))
(assert (and (= o67 o66) (in_range1 o66)))
(assert (= result11 (mk_int__ref target6)))
(assert (= target7 o67))
