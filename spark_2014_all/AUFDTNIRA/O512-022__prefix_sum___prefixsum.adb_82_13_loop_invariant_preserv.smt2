...
(declare-const temp___2682 int__ref)
...
(assert (< 0 space4))
(assert (= temp___2682 (mk_int__ref temp___2681)))
(assert (= temp8 temp6))
...
(assert (= a10 a8))
(assert (= rho3 rho2))
(assert (= temp___2683 temp___2681))
(assert (= temp9 temp7))
(assert (= right10 right8))
(assert (= left9 left7))
(assert (= space6 space4))
(assert (= a11 a9))
(assert (not (= (all_elements_in (map__content a10) (* (* (div1 4 (int__content space5)) 8) 1000000)) true)))
(check-sat)
(exit)
