...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (forall ((index9 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 6) index9) (<= index9 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index9))) true))))))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___1963 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___1963) (<= temp___1963 (to_rep1 n__last))))
...
(assert (= target4 o34))
(assert (<= (- 9999) target4))
(assert (and (= temp___1964 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___1964) (<= temp___1964 (to_rep1 n__last))))
...
(assert (and (= o42 (- target5 2147400000)) (in_range1 (- target5 2147400000))))
(assert (= result9 (mk_int__ref target5)))
(assert (= target6 o42))
(assert (<= (- 2147479999) target6))
