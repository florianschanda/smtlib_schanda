...
(assert (=> (= result true) (and (= o17 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o17 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result true) (= o18 (ite (not (= o17 true)) true false))))
(assert (=> (= result true) (and (= o16 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o16 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
...
(assert (=> (= result1 true) (and (= o12 (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (and (in_range2 o12) (= o12 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result1 true) (= o13 (ite (= o12 0) true false))))
(assert (=> (= result1 true) (and (= o11 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o11 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
...
(assert (=> (= result2 true) (and (= o9 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o9 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result2 true) (= o10 (ite (not (= o9 true)) true false))))
(assert (=> (not (= result2 true)) (= o10 (distinct 1 0))))
(assert (and (= o4 (statusiswaitingfinishadminop status2 (let ((subject state3)) state11))) (= (= o4 true) (= status2 7))))
(assert (and (= o5 (statusiswaitingstartadminop status2 (let ((subject state3)) state11))) (= (= o5 true) (= status2 6))))
(assert (= result3 (ite (= o5 false) o4 true)))
(assert (=> (= result3 true) (and (= o6 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o6 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result3 true) (and (= o7 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o7 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result3 true) (= o8 (ite (= o7 true) o6 false))))
(assert (=> (not (= result3 true)) (= o8 (distinct 1 0))))
(assert (and (= o (statusiswaitingremoveadmintokenfail status2 (let ((subject state3)) state11))) (= (= o true) (= status2 4))))
(assert (and (= o1 (statusisgotadmintoken status2 (let ((subject state3)) state11))) (= (= o1 true) (= status2 5))))
(assert (= result4 (ite (= o1 false) o true)))
(assert (=> (= result4 true) (and (= o2 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= o2 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))))
(assert (=> (= result4 true) (= o3 (ite (not (= o2 true)) true false))))
(assert (=> (not (= result4 true)) (= o3 (distinct 1 0))))
(assert (and (= result5 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2)))) (= (= result5 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields2)))))))
(assert (= result5 true))
