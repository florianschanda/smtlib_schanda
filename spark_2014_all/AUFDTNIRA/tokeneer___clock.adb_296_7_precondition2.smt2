...
(assert (= (to_rep1 o11) 21))
(assert (= (to_rep1 o10) 1))
(assert (= result6 localtext6))
(assert (= localtext7 (slide clock__setstringsegment__s5 (to_rep1 (first (mk 1 21))) 1)))
(assert (= (to_rep1 o13) 21))
(assert (= (to_rep1 o12) 1))
(assert (not (<= 21 (to_rep1 o13))))
(check-sat)
(exit)
