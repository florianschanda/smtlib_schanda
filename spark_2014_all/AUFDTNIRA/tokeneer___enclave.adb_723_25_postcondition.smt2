...
(declare-fun user_eq1 (filestatust filestatust) Bool)
(declare-const dummy1 filestatust)
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep4 (select a temp___idx_196)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
...
(define-fun bool_eq6 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true))))))))
...
(assert (forall ((x character)) (! (in_range7 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun to_rep6 ((x yearst)) Int (yearstqtint x))
...
(define-fun to_rep7 ((x monthst)) Int (monthstqtint x))
...
(define-fun to_rep8 ((x dayst)) Int (daystqtint x))
...
(define-fun to_rep9 ((x millisecst)) Int (millisecstqtint x))
...
(define-fun to_rep10 ((x namecountt)) Int (namecounttqtint x))
(declare-fun of_rep10 (Int) namecountt)
(assert (forall ((x namecountt)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x namecountt)) (! (in_range12 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(define-fun to_rep11 ((x issueridt)) Int (issueridtqtint x))
(declare-fun of_rep11 (Int) issueridt)
(assert (forall ((x issueridt)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x issueridt)) (! (in_range13 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(define-fun bool_eq9 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (= (to_rep11 (rec__cryptotypes__issuert__id (us_split_fields7 a))) (to_rep11 (rec__cryptotypes__issuert__id (us_split_fields7 b)))) (= (to_rep10 (rec__cryptotypes__issuert__namelength (us_split_fields7 a))) (to_rep10 (rec__cryptotypes__issuert__namelength (us_split_fields7 b))))) (= (bool_eq7 (rec__cryptotypes__issuert__name (us_split_fields7 a)) 1 40 (rec__cryptotypes__issuert__name (us_split_fields7 b)) 1 40) true)) true false))
...
(define-fun to_rep12 ((x serialnumbert)) Int (serialnumbertqtint x))
(declare-fun of_rep12 (Int) serialnumbert)
(assert (forall ((x serialnumbert)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x serialnumbert)) (! (in_range14 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun bool_eq10 ((a us_rep5) (b us_rep5)) Bool (ite (and (= (bool_eq9 (rec__certtypes__idt__issuer (us_split_fields9 a)) (rec__certtypes__idt__issuer (us_split_fields9 b))) true) (= (to_rep12 (rec__certtypes__idt__serialnumber (us_split_fields9 a))) (to_rep12 (rec__certtypes__idt__serialnumber (us_split_fields9 b))))) true false))
...
(define-fun in_range15 ((x Int)) Bool (and (<= 0 x) (<= x 10)))
...
(assert (forall ((x algorithmt)) (! (in_range15 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun bool_eq11 ((a us_rep6) (b us_rep6)) Bool (ite (and (and (= (to_rep13 (rec__cryptotypes__keypartt__algorithmid (us_split_fields11 a))) (to_rep13 (rec__cryptotypes__keypartt__algorithmid (us_split_fields11 b)))) (= (to_rep14 (rec__cryptotypes__keypartt__keyid (us_split_fields11 a))) (to_rep14 (rec__cryptotypes__keypartt__keyid (us_split_fields11 b))))) (= (to_rep15 (rec__cryptotypes__keypartt__keylength (us_split_fields11 a))) (to_rep15 (rec__cryptotypes__keypartt__keylength (us_split_fields11 b))))) true false))
...
(define-fun bool_eq12 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (and (= (bool_eq10 (rec__cert__id__contentst__id (us_split_fields13 a)) (rec__cert__id__contentst__id (us_split_fields13 b))) true) (= (bool_eq8 (rec__cert__id__contentst__notbefore (us_split_fields13 a)) (rec__cert__id__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq8 (rec__cert__id__contentst__notafter (us_split_fields13 a)) (rec__cert__id__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep13 (rec__cert__id__contentst__mechanism (us_split_fields13 a))) (to_rep13 (rec__cert__id__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq9 (rec__cert__id__contentst__subject (us_split_fields13 a)) (rec__cert__id__contentst__subject (us_split_fields13 b))) true)) (= (bool_eq11 (rec__cert__id__contentst__subjectpublickey (us_split_fields13 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields13 b))) true)) true false))
...
(define-fun bool_eq13 ((a us_rep8) (b us_rep8)) Bool (ite (and (= (rec__admintoken__valididcertt__valid (us_split_fields15 a)) (rec__admintoken__valididcertt__valid (us_split_fields15 b))) (= (bool_eq12 (rec__admintoken__valididcertt__contents (us_split_fields15 a)) (rec__admintoken__valididcertt__contents (us_split_fields15 b))) true)) true false))
...
(define-fun bool_eq14 ((a us_rep9) (b us_rep9)) Bool (ite (= (to_rep16 (rec__privtypes__clearancet__class (us_split_fields17 a))) (to_rep16 (rec__privtypes__clearancet__class (us_split_fields17 b)))) true false))
...
(define-fun bool_eq15 ((a us_rep10) (b us_rep10)) Bool (ite (and (and (and (and (and (and (= (bool_eq10 (rec__cert__attr__auth__contentst__id (us_split_fields19 a)) (rec__cert__attr__auth__contentst__id (us_split_fields19 b))) true) (= (bool_eq8 (rec__cert__attr__auth__contentst__notbefore (us_split_fields19 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields19 b))) true)) (= (bool_eq8 (rec__cert__attr__auth__contentst__notafter (us_split_fields19 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields19 b))) true)) (= (to_rep13 (rec__cert__attr__auth__contentst__mechanism (us_split_fields19 a))) (to_rep13 (rec__cert__attr__auth__contentst__mechanism (us_split_fields19 b))))) (= (bool_eq10 (rec__cert__attr__auth__contentst__basecertid (us_split_fields19 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields19 b))) true)) (= (to_rep17 (rec__cert__attr__auth__contentst__role (us_split_fields19 a))) (to_rep17 (rec__cert__attr__auth__contentst__role (us_split_fields19 b))))) (= (bool_eq14 (rec__cert__attr__auth__contentst__clearance (us_split_fields19 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields19 b))) true)) true false))
...
(define-fun bool_eq16 ((a us_rep11) (b us_rep11)) Bool (ite (and (= (rec__admintoken__validauthcertt__valid (us_split_fields21 a)) (rec__admintoken__validauthcertt__valid (us_split_fields21 b))) (= (bool_eq15 (rec__admintoken__validauthcertt__contents (us_split_fields21 a)) (rec__admintoken__validauthcertt__contents (us_split_fields21 b))) true)) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_245 Int) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool) (temp___do_typ_inv_244 Bool)) Bool (=> (or (= temp___is_init_241 true) (<= 0 1)) (in_range20 temp___expr_245)))
...
(declare-fun user_eq35 (tokenidt tokenidt) Bool)
(declare-const dummy35 tokenidt)
...
(define-fun dynamic_invariant3 ((temp___expr_1517 Int) (temp___is_init_1513 Bool) (temp___skip_constant_1514 Bool) (temp___do_toplevel_1515 Bool) (temp___do_typ_inv_1516 Bool)) Bool (=> (or (= temp___is_init_1513 true) (<= 0 4294967295)) (in_range21 temp___expr_1517)))
(declare-sort tryt 0)
...
(declare-fun user_eq36 (tryt tryt) Bool)
(declare-const dummy36 tryt)
...
(define-fun dynamic_invariant4 ((temp___expr_1524 Int) (temp___is_init_1520 Bool) (temp___skip_constant_1521 Bool) (temp___do_toplevel_1522 Bool) (temp___do_typ_inv_1523 Bool)) Bool (=> (or (= temp___is_init_1520 true) (<= 0 2)) (in_range22 temp___expr_1524)))
(assert true)
...
(declare-fun user_eq37 (statust1 statust1) Bool)
(declare-const dummy37 statust1)
...
(define-fun dynamic_invariant5 ((temp___expr_2867 Int) (temp___is_init_2863 Bool) (temp___skip_constant_2864 Bool) (temp___do_toplevel_2865 Bool) (temp___do_typ_inv_2866 Bool)) Bool (=> (or (= temp___is_init_2863 true) (<= 0 8)) (in_range23 temp___expr_2867)))
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-const attr__ATTRIBUTE_ADDRESS11 Int)
(define-fun dynamic_invariant6 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range7 temp___expr_74)))
(define-fun dynamic_invariant7 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 3)) (in_range19 temp___expr_426)))
(define-fun dynamic_invariant8 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range18 temp___expr_440)))
(define-fun dynamic_invariant9 ((temp___expr_1092 Int) (temp___is_init_1088 Bool) (temp___skip_constant_1089 Bool) (temp___do_toplevel_1090 Bool) (temp___do_typ_inv_1091 Bool)) Bool (=> (or (= temp___is_init_1088 true) (<= 0 40)) (in_range12 temp___expr_1092)))
(define-fun dynamic_invariant10 ((temp___expr_1116 Int) (temp___is_init_1112 Bool) (temp___skip_constant_1113 Bool) (temp___do_toplevel_1114 Bool) (temp___do_typ_inv_1115 Bool)) Bool (=> (or (= temp___is_init_1112 true) (<= 0 4294967295)) (in_range13 temp___expr_1116)))
(define-fun dynamic_invariant11 ((temp___expr_1140 Int) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool) (temp___do_typ_inv_1139 Bool)) Bool (=> (or (= temp___is_init_1136 true) (<= 0 10)) (in_range15 temp___expr_1140)))
(define-fun dynamic_invariant12 ((temp___expr_1154 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool) (temp___do_typ_inv_1153 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 4294967295)) (in_range16 temp___expr_1154)))
(define-fun dynamic_invariant13 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 128)) (in_range17 temp___expr_1161)))
(define-fun dynamic_invariant14 ((temp___expr_1276 Int) (temp___is_init_1272 Bool) (temp___skip_constant_1273 Bool) (temp___do_toplevel_1274 Bool) (temp___do_typ_inv_1275 Bool)) Bool (=> (or (= temp___is_init_1272 true) (<= 0 17)) (in_range4 temp___expr_1276)))
(define-fun dynamic_invariant15 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 1 17)) (in_range2 temp___expr_1283)))
(define-fun dynamic_invariant16 ((temp___expr_1409 Int) (temp___is_init_1405 Bool) (temp___skip_constant_1406 Bool) (temp___do_toplevel_1407 Bool) (temp___do_typ_inv_1408 Bool)) Bool (=> (or (= temp___is_init_1405 true) (<= 0 2)) (in_range1 temp___expr_1409)))
(define-fun dynamic_invariant17 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 0 17408)) (in_range3 temp___expr_1290)))
(define-fun dynamic_invariant18 ((temp___expr_1321 Int) (temp___is_init_1317 Bool) (temp___skip_constant_1318 Bool) (temp___do_toplevel_1319 Bool) (temp___do_typ_inv_1320 Bool)) Bool (=> (or (= temp___is_init_1317 true) (<= 0 1024)) (in_range5 temp___expr_1321)))
(assert true)
...
(assert (forall ((temp___1350 Int)) (=> (dynamic_invariant18 temp___1350 true true true true) (forall ((temp___1351 Int)) (= (select (temp_____aggregate_def_1348 temp___1350) temp___1351) rliteral2)))))
(define-fun dynamic_invariant19 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range8 temp___expr_625)))
(define-fun dynamic_invariant20 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range9 temp___expr_632)))
(define-fun dynamic_invariant21 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range10 temp___expr_639)))
(define-fun dynamic_invariant22 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range11 temp___expr_671)))
(define-fun dynamic_invariant23 ((temp___expr_1596 Int) (temp___is_init_1592 Bool) (temp___skip_constant_1593 Bool) (temp___do_toplevel_1594 Bool) (temp___do_typ_inv_1595 Bool)) Bool (=> (or (= temp___is_init_1592 true) (<= 0 4294967295)) (in_range14 temp___expr_1596)))
(assert (forall ((temp___1346 Int)) (=> (dynamic_invariant15 temp___1346 true true true true) (forall ((temp___1347 Int)) (= (select (temp_____aggregate_def_1344 temp___1346) temp___1347) rliteral)))))
...
(assert (in_range20 tokenpresence))
(assert (in_range22 tokentry))
(assert (in_range21 tokenid))
...
(assert (=> (= result true) (= o (extractuser tokenpresence state tokentry tokenid (us_split_fields__content10 authcert__split_fields) (us_split_fields__content7 idcert__split_fields)))))
(assert (=> (= result true) (and (= (valid_numberlogentries (to_rep1 logfilestate__split_fields7) (to_rep2 logfilestate__split_fields8) (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) true) (in_range6 auditalarm1))))
(assert (=> (= result true) (and (= (valid_numberlogentries (to_rep1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields14)) (to_rep2 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields14)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields14)) true) (in_range6 auditalarm2))))
(assert (=> (= result true) (= result1 (mk_int__ref status))))
(assert (=> (= result true) (= status2 7)))
(assert (=> (not (= result true)) (and (= (valid_numberlogentries (to_rep1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields15)) (to_rep2 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields15)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields15) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields15)) true) (in_range6 auditalarm3))))
...
(assert (=> (not (= result true)) (= auditalarm2 auditalarm3)))
(assert (=> (not (= result true)) (= logfilestate__split_fields14 logfilestate__split_fields15)))
...
(assert (=> (not (= result true)) (= state5 state2)))
(assert (=> (not (= result true)) (= state3 state6)))
(assert (=> (not (= result true)) (= filestate filestate1)))
...
(assert (= state9 (mk___private__ref state5)))
(assert (= state8 (mk___private__ref state3)))
(assert (= filestate2 (mk___private__ref filestate)))
(assert (= thelog3 (mk_t__ref thelog2)))
(assert (= status3 (mk_int__ref status2)))
(assert (= auditsystemfault2 (mk_bool__ref auditsystemfault)))
(assert (= auditalarm4 (mk_int__ref auditalarm2)))
(assert (= logfilestate__split_fields16 (mk___split_fields__ref1 logfilestate__split_fields14)))
...
(assert (= state11 state3))
(assert (= filestate3 filestate))
(assert (= thelog4 thelog2))
(assert (= status4 status2))
(assert (= auditsystemfault3 auditsystemfault))
(assert (= auditalarm5 auditalarm2))
(assert (= logfilestate__split_fields17 logfilestate__split_fields14))
(assert (= logfilesstatus3 logfilesstatus))
(assert (= logfiles3 logfiles))
(assert (not (or (= (int__content status3) 6) (= (int__content status3) 7))))
(check-sat)
(exit)
