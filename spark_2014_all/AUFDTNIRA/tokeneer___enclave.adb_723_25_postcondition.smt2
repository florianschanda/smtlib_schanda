...
(define-fun dynamic_invariant1 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 1)) (in_range2 temp___expr_548)))
...
(declare-fun user_eq8 (fileentrycountt fileentrycountt) Bool)
(declare-const dummy8 fileentrycountt)
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_196 Int)) (=> (and (<= a__first temp___idx_196) (<= temp___idx_196 a__last)) (= (to_rep3 (select a temp___idx_196)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_196)))))))))))
(declare-const dummy9 (Array Int fileentrycountt))
...
(declare-fun user_eq9 ((Array Int fileentrycountt) (Array Int fileentrycountt)) Bool)
...
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq (select a temp___idx_197) (select b (+ (- b__first a__first) temp___idx_197))) true))))))))
...
(assert (forall ((x character)) (! (in_range8 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(declare-fun user_eq13 (tokenidt tokenidt) Bool)
(declare-const dummy13 tokenidt)
...
(define-fun dynamic_invariant3 ((temp___expr_1524 Int) (temp___is_init_1520 Bool) (temp___skip_constant_1521 Bool) (temp___do_toplevel_1522 Bool) (temp___do_typ_inv_1523 Bool)) Bool (=> (or (= temp___is_init_1520 true) (<= 0 4294967295)) (in_range9 temp___expr_1524)))
(declare-sort tryt 0)
(define-fun in_range10 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
(declare-fun attr__ATTRIBUTE_IMAGE10 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check10 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE10 (us_image) Int)
(declare-fun user_eq14 (tryt tryt) Bool)
(declare-const dummy14 tryt)
...
(define-fun dynamic_invariant4 ((temp___expr_1531 Int) (temp___is_init_1527 Bool) (temp___skip_constant_1528 Bool) (temp___do_toplevel_1529 Bool) (temp___do_typ_inv_1530 Bool)) Bool (=> (or (= temp___is_init_1527 true) (<= 0 2)) (in_range10 temp___expr_1531)))
...
(declare-fun to_rep6 (privileget) Int)
(declare-fun of_rep6 (Int) privileget)
(assert (forall ((x privileget)) (! (= (of_rep6 (to_rep6 x)) x) :pattern ((to_rep6 x)))))
(assert (forall ((x privileget)) (! (in_range11 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(declare-fun user_eq16 (classt classt) Bool)
(declare-const dummy16 classt)
...
(assert (forall ((x classt)) (! (in_range12 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(define-fun bool_eq8 ((a us_rep3) (b us_rep3)) Bool (ite (= (to_rep7 (rec__privtypes__clearancet__class (us_split_fields5 a))) (to_rep7 (rec__privtypes__clearancet__class (us_split_fields5 b)))) true false))
...
(declare-fun user_eq18 (yearst yearst) Bool)
(declare-const dummy18 yearst)
...
(assert (forall ((x yearst)) (! (in_range13 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(declare-fun user_eq19 (monthst monthst) Bool)
(declare-const dummy19 monthst)
...
(assert (forall ((x monthst)) (! (in_range14 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(declare-fun user_eq20 (dayst dayst) Bool)
(declare-const dummy20 dayst)
...
(assert (forall ((x dayst)) (! (in_range15 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(declare-fun user_eq21 (millisecst millisecst) Bool)
(declare-const dummy21 millisecst)
...
(assert (forall ((x millisecst)) (! (in_range16 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(define-fun bool_eq9 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (= (to_rep8 (rec__clock__timet__year (us_split_fields7 a))) (to_rep8 (rec__clock__timet__year (us_split_fields7 b)))) (= (to_rep9 (rec__clock__timet__month (us_split_fields7 a))) (to_rep9 (rec__clock__timet__month (us_split_fields7 b))))) (= (to_rep10 (rec__clock__timet__day (us_split_fields7 a))) (to_rep10 (rec__clock__timet__day (us_split_fields7 b))))) (= (to_rep11 (rec__clock__timet__millisec (us_split_fields7 a))) (to_rep11 (rec__clock__timet__millisec (us_split_fields7 b))))) true false))
...
(define-fun in_range17 ((x Int)) Bool (and (<= 0 x) (<= x 10)))
...
(assert (forall ((x algorithmt)) (! (in_range17 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun bool_eq10 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (= (to_rep14 (rec__cryptotypes__issuert__id (us_split_fields9 a))) (to_rep14 (rec__cryptotypes__issuert__id (us_split_fields9 b)))) (= (to_rep13 (rec__cryptotypes__issuert__namelength (us_split_fields9 a))) (to_rep13 (rec__cryptotypes__issuert__namelength (us_split_fields9 b))))) (= (bool_eq7 (rec__cryptotypes__issuert__name (us_split_fields9 a)) 1 40 (rec__cryptotypes__issuert__name (us_split_fields9 b)) 1 40) true)) true false))
...
(define-fun bool_eq12 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (and (and (= (bool_eq11 (rec__cert__attr__auth__contentst__id (us_split_fields13 a)) (rec__cert__attr__auth__contentst__id (us_split_fields13 b))) true) (= (bool_eq9 (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq9 (rec__cert__attr__auth__contentst__notafter (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep12 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 a))) (to_rep12 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq11 (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 b))) true)) (= (to_rep6 (rec__cert__attr__auth__contentst__role (us_split_fields13 a))) (to_rep6 (rec__cert__attr__auth__contentst__role (us_split_fields13 b))))) (= (bool_eq8 (rec__cert__attr__auth__contentst__clearance (us_split_fields13 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields13 b))) true)) true false))
...
(define-fun dynamic_invariant5 ((temp___expr_2874 Int) (temp___is_init_2870 Bool) (temp___skip_constant_2871 Bool) (temp___do_toplevel_2872 Bool) (temp___do_typ_inv_2873 Bool)) Bool (=> (or (= temp___is_init_2870 true) (<= 0 8)) (in_range23 temp___expr_2874)))
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(declare-const attr__ATTRIBUTE_ADDRESS11 Int)
(define-fun dynamic_invariant6 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range8 temp___expr_74)))
(define-fun dynamic_invariant7 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 3)) (in_range11 temp___expr_426)))
...
(define-fun dynamic_invariant9 ((temp___expr_1099 Int) (temp___is_init_1095 Bool) (temp___skip_constant_1096 Bool) (temp___do_toplevel_1097 Bool) (temp___do_typ_inv_1098 Bool)) Bool (=> (or (= temp___is_init_1095 true) (<= 0 40)) (in_range18 temp___expr_1099)))
(define-fun dynamic_invariant10 ((temp___expr_1123 Int) (temp___is_init_1119 Bool) (temp___skip_constant_1120 Bool) (temp___do_toplevel_1121 Bool) (temp___do_typ_inv_1122 Bool)) Bool (=> (or (= temp___is_init_1119 true) (<= 0 4294967295)) (in_range19 temp___expr_1123)))
(define-fun dynamic_invariant11 ((temp___expr_1147 Int) (temp___is_init_1143 Bool) (temp___skip_constant_1144 Bool) (temp___do_toplevel_1145 Bool) (temp___do_typ_inv_1146 Bool)) Bool (=> (or (= temp___is_init_1143 true) (<= 0 10)) (in_range17 temp___expr_1147)))
(define-fun dynamic_invariant12 ((temp___expr_1161 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool) (temp___do_typ_inv_1160 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 4294967295)) (in_range21 temp___expr_1161)))
(define-fun dynamic_invariant13 ((temp___expr_1168 Int) (temp___is_init_1164 Bool) (temp___skip_constant_1165 Bool) (temp___do_toplevel_1166 Bool) (temp___do_typ_inv_1167 Bool)) Bool (=> (or (= temp___is_init_1164 true) (<= 0 128)) (in_range22 temp___expr_1168)))
(define-fun dynamic_invariant14 ((temp___expr_1283 Int) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (or (= temp___is_init_1279 true) (<= 0 17)) (in_range5 temp___expr_1283)))
(define-fun dynamic_invariant15 ((temp___expr_1290 Int) (temp___is_init_1286 Bool) (temp___skip_constant_1287 Bool) (temp___do_toplevel_1288 Bool) (temp___do_typ_inv_1289 Bool)) Bool (=> (or (= temp___is_init_1286 true) (<= 1 17)) (in_range3 temp___expr_1290)))
(define-fun dynamic_invariant16 ((temp___expr_1416 Int) (temp___is_init_1412 Bool) (temp___skip_constant_1413 Bool) (temp___do_toplevel_1414 Bool) (temp___do_typ_inv_1415 Bool)) Bool (=> (or (= temp___is_init_1412 true) (<= 0 2)) (in_range7 temp___expr_1416)))
(define-fun dynamic_invariant17 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 17408)) (in_range4 temp___expr_1297)))
(define-fun dynamic_invariant18 ((temp___expr_1328 Int) (temp___is_init_1324 Bool) (temp___skip_constant_1325 Bool) (temp___do_toplevel_1326 Bool) (temp___do_typ_inv_1327 Bool)) Bool (=> (or (= temp___is_init_1324 true) (<= 0 1024)) (in_range6 temp___expr_1328)))
(assert true)
...
(assert (forall ((temp___1357 Int)) (=> (dynamic_invariant18 temp___1357 true true true true) (forall ((temp___1358 Int)) (= (to_rep3 (select (temp___1355 temp___1357) temp___1358)) temp___1357)))))
(define-fun dynamic_invariant19 ((temp___expr_625 Int) (temp___is_init_621 Bool) (temp___skip_constant_622 Bool) (temp___do_toplevel_623 Bool) (temp___do_typ_inv_624 Bool)) Bool (=> (or (= temp___is_init_621 true) (<= 1901 2099)) (in_range13 temp___expr_625)))
(define-fun dynamic_invariant20 ((temp___expr_632 Int) (temp___is_init_628 Bool) (temp___skip_constant_629 Bool) (temp___do_toplevel_630 Bool) (temp___do_typ_inv_631 Bool)) Bool (=> (or (= temp___is_init_628 true) (<= 1 12)) (in_range14 temp___expr_632)))
(define-fun dynamic_invariant21 ((temp___expr_639 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range15 temp___expr_639)))
(define-fun dynamic_invariant22 ((temp___expr_671 Int) (temp___is_init_667 Bool) (temp___skip_constant_668 Bool) (temp___do_toplevel_669 Bool) (temp___do_typ_inv_670 Bool)) Bool (=> (or (= temp___is_init_667 true) (<= 0 86399999)) (in_range16 temp___expr_671)))
(define-fun dynamic_invariant23 ((temp___expr_1603 Int) (temp___is_init_1599 Bool) (temp___skip_constant_1600 Bool) (temp___do_toplevel_1601 Bool) (temp___do_typ_inv_1602 Bool)) Bool (=> (or (= temp___is_init_1599 true) (<= 0 4294967295)) (in_range20 temp___expr_1603)))
(assert (forall ((temp___1353 Int)) (=> (dynamic_invariant15 temp___1353 true true true true) (forall ((temp___1354 Int)) (= (to_rep (select (temp___1351 temp___1353) temp___1354)) temp___1353)))))
...
(assert (in_range10 tokentry))
(assert (in_range9 tokenid))
...
(assert (=> (= result true) (= o (extractuser tokenpresence state tokentry tokenid (us_split_fields__content7 authcert__split_fields) (us_split_fields__content10 idcert__split_fields)))))
(assert (=> (= result true) (and (in_range2 auditalarm1) (= (valid_numberlogentries (to_rep logfilestate__split_fields7) (to_rep1 logfilestate__split_fields8) (mk___rep (mk___split_fields logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13) true))))
(assert (=> (= result true) (and (in_range2 auditalarm2) (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields14)) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields14)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields14) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields14)) true))))
(assert (=> (= result true) (= result1 (mk_int__ref status))))
(assert (=> (= result true) (= status2 7)))
(assert (=> (not (= result true)) (and (in_range2 auditalarm3) (= (valid_numberlogentries (to_rep (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields15)) (to_rep1 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields15)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields15) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields15)) true))))
