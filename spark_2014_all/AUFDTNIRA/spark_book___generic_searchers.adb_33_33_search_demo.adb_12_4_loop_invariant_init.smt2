...
(define-fun dynamic_invariant ((temp___expr_589 Int) (temp___is_init_585 Bool) (temp___skip_constant_586 Bool) (temp___do_toplevel_587 Bool) (temp___do_typ_inv_588 Bool)) Bool (=> (or (= temp___is_init_585 true) (<= 0 2147483647)) (in_range3 temp___expr_589)))
...
(define-fun dynamic_invariant1 ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= 1 10)) (in_range4 temp___expr_596)))
...
(define-fun dynamic_invariant3 ((temp___expr_572 Int) (temp___is_init_568 Bool) (temp___skip_constant_569 Bool) (temp___do_toplevel_570 Bool) (temp___do_typ_inv_571 Bool)) Bool (=> (or (= temp___is_init_568 true) (<= 1 10)) (in_range2 temp___expr_572)))
...
(assert (not (or (< search_item (to_rep (select items high_index1))) (= search_item (to_rep (select items high_index1))))))
(check-sat)
(exit)
