...
(assert (and (and (<= 1 i3) (<= i3 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))))) (= (bool_eq10 c27b c27b) true)))
(assert (and (and (and (forall ((temp___1371 Int)) (=> (and (<= 1 temp___1371) (<= temp___1371 50)) (=> (<= i3 temp___1371) (= (select (rec__display__scrollstrt__text result____split_fields3) temp___1371) (select (rec__display__scrollstrt__text result____split_fields2) temp___1371))))) (= (rec__display__scrollstrt__len result____split_fields3) (rec__display__scrollstrt__len result____split_fields2))) (=> (<= 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))) (dynamic_property1 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))) i3))) (and (<= 1 i3) (<= i3 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))))))
(assert (= (to_rep o59) (to_rep (select (rec__display__msglinet__text (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))) i3))))
(assert (= o60 (store (rec__display__scrollstrt__text result____split_fields3) i3 o59)))
(assert (= o61 (mk___split_fields4 o60 (rec__display__scrollstrt__len result____split_fields3))))
(assert (= temp___1369 (mk___rep4 o61)))
(assert (= result2 (mk___split_fields__ref4 result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields9 temp___1369)))
(assert (not (= i3 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))))))
