...
(assert (and (and (and (forall ((temp___1427 Int)) (=> (and (<= 1 temp___1427) (<= temp___1427 50)) (=> (<= i3 temp___1427) (= (select (rec__display__scrollstrt__text result____split_fields3) temp___1427) (select (rec__display__scrollstrt__text result____split_fields2) temp___1427))))) (= (rec__display__scrollstrt__len result____split_fields3) (rec__display__scrollstrt__len result____split_fields2))) (=> (<= 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))) (dynamic_property1 1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b))))) i3))) (and (<= 1 i3) (<= i3 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c27b)))))))))
...
(assert (= temp___1425 (mk___rep4 o61)))
(assert (= result2 (mk___split_fields__ref4 result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields9 temp___1425)))
