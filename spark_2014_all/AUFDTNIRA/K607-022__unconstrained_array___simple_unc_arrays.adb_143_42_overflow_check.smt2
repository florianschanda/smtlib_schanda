...
(define-fun dynamic_invariant1 ((temp___expr_525 Int) (temp___is_init_522 Bool) (temp___skip_constant_523 Bool) (temp___do_toplevel_524 Bool)) Bool (=> (or (= temp___is_init_522 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_525)))
...
(define-fun dynamic_invariant6 ((temp___expr_751 us_t2) (temp___is_init_748 Bool) (temp___skip_constant_749 Bool) (temp___do_toplevel_750 Bool)) Bool (=> (not (= temp___skip_constant_749 true)) (and (dynamic_property4 1 r63b (first6 temp___expr_751) (last6 temp___expr_751)) (and (= (first6 temp___expr_751) 1) (= (last6 temp___expr_751) r63b)))))
...
(declare-const temp___975 natural)
(declare-const temp___9751 (Array Int value))
...
(declare-const a__split_fields5 us_split_fields__ref)
...
(declare-const a__split_fields11 us_split_fields)
(declare-const a__split_fields12 us_split_fields__ref)
(declare-const a__split_fields13 us_split_fields)
