...
(define-fun dynamic_invariant1 ((temp___expr_531 Int) (temp___is_init_528 Bool) (temp___skip_constant_529 Bool) (temp___do_toplevel_530 Bool)) Bool (=> (or (= temp___is_init_528 true) (<= (- 2147483648) 2147483647)) (in_range4 temp___expr_531)))
...
(define-fun dynamic_invariant6 ((temp___expr_757 us_t2) (temp___is_init_754 Bool) (temp___skip_constant_755 Bool) (temp___do_toplevel_756 Bool)) Bool (=> (not (= temp___skip_constant_755 true)) (and (dynamic_property4 1 r63b (first6 temp___expr_757) (last6 temp___expr_757)) (and (= (first6 temp___expr_757) 1) (= (last6 temp___expr_757) r63b)))))
