...
(assert (=> (= result20 true) (and (= o60 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range4 o60))))
(assert (=> (= result20 true) (= result19 (ite (= o60 3) true false))))
(assert (=> (not (= result20 true)) (= result19 false)))
(assert (=> (= result19 true) (and (= o61 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5)))) (and (in_range2 o61) (= o61 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields5))))))))
(assert (=> (= result19 true) (= o62 (ite (= o61 1) true false))))
(assert (=> (not (= result19 true)) (= o62 (of_int 1))))
(assert (and (= o53 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields5)))) (and (in_range2 o53) (= o53 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields5)))))))
(assert (= result21 (ite (= o53 1) true false)))
(assert (=> (= result21 true) (and (= o56 (theauthcertrole (int__content tokenpresence5) (us_private__content state35) (int__content tokentry5) (int__content tokenid5) (us_split_fields__content9 authcert__split_fields5) (us_split_fields__content12 idcert__split_fields5))) (and (in_range2 o56) (= o56 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content9 authcert__split_fields5))))))))
(assert (=> (= result21 true) (= o57 (ite (= o56 1) true false))))
(assert (=> (= result21 true) (and (= o54 (authcertvalid (int__content tokenpresence5) (us_private__content state35) (int__content tokentry5) (int__content tokenid5) (us_split_fields__content9 authcert__split_fields5) (us_split_fields__content12 idcert__split_fields5))) (= (= o54 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content9 authcert__split_fields5)) true)))))
(assert (=> (= result21 true) (and (= o55 (isgood (int__content tokenpresence5) (us_private__content state35) (int__content tokentry5) (int__content tokenid5) (us_split_fields__content9 authcert__split_fields5) (us_split_fields__content12 idcert__split_fields5))) (= (= o55 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content12 idcert__split_fields5)) true)))))
(assert (=> (= result21 true) (= o58 (ite (= o55 true) o54 false))))
(assert (=> (= result21 true) (= o59 (ite (= o58 true) o57 false))))
(assert (=> (not (= result21 true)) (= o59 (of_int 1))))
