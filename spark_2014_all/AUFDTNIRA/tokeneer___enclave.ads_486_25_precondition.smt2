...
(assert (and (= o27 (islocked (int__content currentlatch1) (us_private__content state4) (us_split_fields__content1 latchtimeout__split_fields4))) (= (= o27 true) (= (int__content currentlatch1) 0))))
(assert (= o28 (ite (not (= o27 true)) true false)))
(assert (= result (ite (= o28 true) (islocked currentlatch (us_private__content state1) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result true) (and (= o29 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o29))))
(assert (=> (= result true) (= o30 (ite (= o29 3) true false))))
(assert (=> (= result true) (and (= o31 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o31 true) (in_range4 (to_rep1 theadmin__split_fields1))))))
(assert (=> (= result true) (= o32 (ite (= o31 true) o30 false))))
(assert (=> (not (= result true)) (= o32 (distinct 1 0))))
(assert (and (= o19 (islocked (int__content currentlatch1) (us_private__content state4) (us_split_fields__content1 latchtimeout__split_fields4))) (= (= o19 true) (= (int__content currentlatch1) 0))))
(assert (= o20 (ite (not (= o19 true)) true false)))
(assert (= result1 (ite (= o20 true) (islocked currentlatch (us_private__content state1) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3)) false)))
(assert (=> (= result1 true) (and (= o23 (theauthcertrole (int__content tokenpresence1) (us_private__content state3) (int__content tokentry1) (int__content tokenid1) (us_split_fields__content9 authcert__split_fields1) (us_split_fields__content12 idcert__split_fields1))) (and (in_range2 o23) (= o23 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content9 authcert__split_fields1))))))))
(assert (=> (= result1 true) (= o24 (ite (= o23 1) true false))))
(assert (=> (= result1 true) (and (= o21 (authcertvalid (int__content tokenpresence1) (us_private__content state3) (int__content tokentry1) (int__content tokenid1) (us_split_fields__content9 authcert__split_fields1) (us_split_fields__content12 idcert__split_fields1))) (= (= o21 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content9 authcert__split_fields1)) true)))))
(assert (=> (= result1 true) (and (= o22 (isgood (int__content tokenpresence1) (us_private__content state3) (int__content tokentry1) (int__content tokenid1) (us_split_fields__content9 authcert__split_fields1) (us_split_fields__content12 idcert__split_fields1))) (= (= o22 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content12 idcert__split_fields1)) true)))))
(assert (=> (= result1 true) (= o25 (ite (= o22 true) o21 false))))
(assert (=> (= result1 true) (= o26 (ite (= o25 true) o24 false))))
(assert (=> (not (= result1 true)) (= o26 (distinct 1 0))))
(assert (and (= o16 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o16 true) (in_range5 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result2 (ite (not (= o16 true)) true false)))
(assert (=> (= result2 true) (and (= o17 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o17 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
(assert (=> (= result2 true) (= o18 (ite (not (= o17 true)) true false))))
(assert (=> (not (= result2 true)) (= o18 (distinct 1 0))))
(assert (and (= o10 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (and (in_range2 o10) (= o10 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result3 (ite (= o10 1) true false)))
(assert (=> (= result3 true) (and (= o12 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= o12 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2))))))))
...
(assert (=> (= result3 true) (=> (= result4 true) (and (= o11 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range4 o11)))))
...
(assert (and (= result6 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result6 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2)))))))
(assert (=> (= result6 true) (and (= o7 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (in_range4 o7))))
(assert (=> (= result6 true) (= result5 (ite (= o7 3) true false))))
(assert (=> (not (= result6 true)) (= result5 false)))
(assert (=> (= result5 true) (and (= o8 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields2)))) (and (in_range2 o8) (= o8 (to_rep (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields2))))))))
...
(assert (=> (= result7 true) (and (= o3 (theauthcertrole (int__content tokenpresence1) (us_private__content state3) (int__content tokentry1) (int__content tokenid1) (us_split_fields__content9 authcert__split_fields1) (us_split_fields__content12 idcert__split_fields1))) (and (in_range2 o3) (= o3 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content9 authcert__split_fields1))))))))
(assert (=> (= result7 true) (= o4 (ite (= o3 1) true false))))
(assert (=> (= result7 true) (and (= o1 (authcertvalid (int__content tokenpresence1) (us_private__content state3) (int__content tokentry1) (int__content tokenid1) (us_split_fields__content9 authcert__split_fields1) (us_split_fields__content12 idcert__split_fields1))) (= (= o1 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content9 authcert__split_fields1)) true)))))
(assert (=> (= result7 true) (and (= o2 (isgood (int__content tokenpresence1) (us_private__content state3) (int__content tokentry1) (int__content tokenid1) (us_split_fields__content9 authcert__split_fields1) (us_split_fields__content12 idcert__split_fields1))) (= (= o2 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content12 idcert__split_fields1)) true)))))
...
(assert (and (= result8 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields2)))) (= (= result8 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields2)))))))
(assert (= result8 true))
