...
(assert (= result14 (currentadminactivitypossible status (us_private__content state11) tokenpresence (us_private__content state3) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields))))
