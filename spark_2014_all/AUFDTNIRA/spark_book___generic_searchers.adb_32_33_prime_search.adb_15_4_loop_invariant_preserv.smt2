...
(define-fun dynamic_invariant ((temp___expr_163 Int) (temp___is_init_160 Bool) (temp___skip_constant_161 Bool) (temp___do_toplevel_162 Bool)) Bool (=> (or (= temp___is_init_160 true) (<= 0 2147483647)) (in_range3 temp___expr_163)))
...
(define-fun dynamic_invariant1 ((temp___expr_169 Int) (temp___is_init_166 Bool) (temp___skip_constant_167 Bool) (temp___do_toplevel_168 Bool)) Bool (=> (or (= temp___is_init_166 true) (<= 1 10)) (in_range4 temp___expr_169)))
...
(define-fun dynamic_invariant3 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 1 10)) (in_range2 temp___expr_148)))
...
(assert (and (and (and (=> (<= 1 10) (in_range4 result__3)) (=> (<= 1 10) (in_range4 low_index2))) (=> (<= 1 10) (in_range4 mid_index3))) (=> (<= 1 10) (in_range4 high_index2))))
(assert (= temp___1892 result7))
(assert (= temp___1893 low_index2))
(assert (= temp___1882 result8))
(assert (= temp___1883 high_index2))
...
(assert (not (or (< (to_rep (select items low_index3)) search_item) (= (to_rep (select items low_index3)) search_item))))
(check-sat)
(exit)
