...
(declare-const latchtimeout__split_fields1 us_split_fields__ref1)
...
(assert (= latchtimeout__split_fields1 (mk___split_fields__ref1 latchtimeout__split_fields)))
...
(assert (= latchtimeout__split_fields2 latchtimeout__split_fields))
