...
(define-fun dynamic_invariant ((temp___expr_443 Int) (temp___is_init_440 Bool) (temp___skip_constant_441 Bool) (temp___do_toplevel_442 Bool)) Bool (=> (or (= temp___is_init_440 true) (<= 0 1)) (in_range1 temp___expr_443)))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep4 (select a temp___idx_173)) (to_rep4 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (to_rep7 (select a temp___idx_174)) (to_rep7 (select b (+ (- b__first a__first) temp___idx_174)))))))))))
...
(declare-fun temp___1142 (Int) (Array Int logfileindext))
(assert (forall ((temp___1144 Int)) (forall ((temp___1145 Int)) (= (select (temp___1142 temp___1144) temp___1145) (of_rep4 temp___1144)))))
(declare-fun temp___1146 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1148 Int)) (forall ((temp___1149 Int)) (= (select (temp___1146 temp___1148) temp___1149) (of_rep7 temp___1148)))))
(define-fun dynamic_invariant1 ((temp___expr_1136 us_rep2) (temp___is_init_1133 Bool) (temp___skip_constant_1134 Bool) (temp___do_toplevel_1135 Bool)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1136))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1136))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1136)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1136))) true))
(define-fun default_initial_assumption ((temp___expr_1140 us_rep2) (temp___skip_top_level_1141 Bool)) Bool (and (and (and (= (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1140))) 1) (= (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1140))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1140)) (mk___rep1 (mk___split_fields1 (temp___1142 1) (of_rep4 1) (of_rep4 1) (of_rep6 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1140)) (temp___1146 0))))
(define-fun type_invariant ((temp___1150 us_rep2)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1150))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1150))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1150)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1150))) true))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep8 (select a temp___idx_176)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_1302 Int) (temp___is_init_1299 Bool) (temp___skip_constant_1300 Bool) (temp___do_toplevel_1301 Bool)) Bool (=> (or (= temp___is_init_1299 true) (<= 0 1)) (in_range11 temp___expr_1302)))
...
(define-fun dynamic_invariant3 ((temp___expr_1102 Int) (temp___is_init_1099 Bool) (temp___skip_constant_1100 Bool) (temp___do_toplevel_1101 Bool)) Bool (=> (or (= temp___is_init_1099 true) (<= 0 17)) (in_range8 temp___expr_1102)))
(define-fun dynamic_invariant4 ((temp___expr_1081 Int) (temp___is_init_1078 Bool) (temp___skip_constant_1079 Bool) (temp___do_toplevel_1080 Bool)) Bool (=> (or (= temp___is_init_1078 true) (<= 1 17)) (in_range6 temp___expr_1081)))
(define-fun dynamic_invariant5 ((temp___expr_1206 Int) (temp___is_init_1203 Bool) (temp___skip_constant_1204 Bool) (temp___do_toplevel_1205 Bool)) Bool (=> (or (= temp___is_init_1203 true) (<= 0 2)) (in_range10 temp___expr_1206)))
(define-fun dynamic_invariant6 ((temp___expr_1087 Int) (temp___is_init_1084 Bool) (temp___skip_constant_1085 Bool) (temp___do_toplevel_1086 Bool)) Bool (=> (or (= temp___is_init_1084 true) (<= 0 17408)) (in_range7 temp___expr_1087)))
(define-fun dynamic_invariant7 ((temp___expr_1121 Int) (temp___is_init_1118 Bool) (temp___skip_constant_1119 Bool) (temp___do_toplevel_1120 Bool)) Bool (=> (or (= temp___is_init_1118 true) (<= 0 1024)) (in_range9 temp___expr_1121)))
(assert true)
...
(define-fun dynamic_invariant8 ((temp___expr_507 Int) (temp___is_init_504 Bool) (temp___skip_constant_505 Bool) (temp___do_toplevel_506 Bool)) Bool (=> (or (= temp___is_init_504 true) (<= 1901 2099)) (in_range2 temp___expr_507)))
(define-fun dynamic_invariant9 ((temp___expr_513 Int) (temp___is_init_510 Bool) (temp___skip_constant_511 Bool) (temp___do_toplevel_512 Bool)) Bool (=> (or (= temp___is_init_510 true) (<= 1 12)) (in_range3 temp___expr_513)))
(define-fun dynamic_invariant10 ((temp___expr_519 Int) (temp___is_init_516 Bool) (temp___skip_constant_517 Bool) (temp___do_toplevel_518 Bool)) Bool (=> (or (= temp___is_init_516 true) (<= 1 31)) (in_range4 temp___expr_519)))
(define-fun dynamic_invariant11 ((temp___expr_543 Int) (temp___is_init_540 Bool) (temp___skip_constant_541 Bool) (temp___do_toplevel_542 Bool)) Bool (=> (or (= temp___is_init_540 true) (<= 0 86399999)) (in_range5 temp___expr_543)))
...
(assert (= logfilestate__split_fields14 (mk___split_fields__ref2 (mk___split_fields2 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep1 (mk___split_fields1 logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13))))
...
(assert (= logfilestate__split_fields15 (mk___split_fields2 logfilestate__split_fields7 logfilestate__split_fields8 (mk___rep1 (mk___split_fields1 logfilestate__split_fields9 logfilestate__split_fields10 logfilestate__split_fields11 logfilestate__split_fields12)) logfilestate__split_fields13)))
