...
(define-fun dynamic_invariant ((temp___expr_489 Int) (temp___is_init_486 Bool) (temp___skip_constant_487 Bool) (temp___do_toplevel_488 Bool)) Bool (=> (or (= temp___is_init_486 true) (<= 0 1)) (in_range1 temp___expr_489)))
...
(declare-fun temp___1200 (Int) (Array Int logfileindext))
(assert (forall ((temp___1202 Int)) (forall ((temp___1203 Int)) (= (select (temp___1200 temp___1202) temp___1203) (of_rep4 temp___1202)))))
(declare-fun temp___1204 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1206 Int)) (forall ((temp___1207 Int)) (= (select (temp___1204 temp___1206) temp___1207) (of_rep7 temp___1206)))))
(define-fun dynamic_invariant1 ((temp___expr_1194 us_rep2) (temp___is_init_1191 Bool) (temp___skip_constant_1192 Bool) (temp___do_toplevel_1193 Bool)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1194))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1194))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1194)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1194))) true))
(define-fun default_initial_assumption ((temp___expr_1198 us_rep2) (temp___skip_top_level_1199 Bool)) Bool (and (and (and (= (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___expr_1198))) 1) (= (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___expr_1198))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___expr_1198)) (mk___rep1 (mk___split_fields1 (temp___1200 1) (of_rep4 1) (of_rep4 1) (of_rep6 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___expr_1198)) (temp___1204 0))))
(define-fun type_invariant ((temp___1208 us_rep2)) Bool (= (valid_numberlogentries (to_rep4 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields5 temp___1208))) (to_rep5 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields5 temp___1208))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields5 temp___1208)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields5 temp___1208))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_1360 Int) (temp___is_init_1357 Bool) (temp___skip_constant_1358 Bool) (temp___do_toplevel_1359 Bool)) Bool (=> (or (= temp___is_init_1357 true) (<= 0 1)) (in_range11 temp___expr_1360)))
...
(define-fun dynamic_invariant3 ((temp___expr_1160 Int) (temp___is_init_1157 Bool) (temp___skip_constant_1158 Bool) (temp___do_toplevel_1159 Bool)) Bool (=> (or (= temp___is_init_1157 true) (<= 0 17)) (in_range8 temp___expr_1160)))
(define-fun dynamic_invariant4 ((temp___expr_1139 Int) (temp___is_init_1136 Bool) (temp___skip_constant_1137 Bool) (temp___do_toplevel_1138 Bool)) Bool (=> (or (= temp___is_init_1136 true) (<= 1 17)) (in_range6 temp___expr_1139)))
(define-fun dynamic_invariant5 ((temp___expr_1264 Int) (temp___is_init_1261 Bool) (temp___skip_constant_1262 Bool) (temp___do_toplevel_1263 Bool)) Bool (=> (or (= temp___is_init_1261 true) (<= 0 2)) (in_range10 temp___expr_1264)))
(define-fun dynamic_invariant6 ((temp___expr_1145 Int) (temp___is_init_1142 Bool) (temp___skip_constant_1143 Bool) (temp___do_toplevel_1144 Bool)) Bool (=> (or (= temp___is_init_1142 true) (<= 0 17408)) (in_range7 temp___expr_1145)))
(define-fun dynamic_invariant7 ((temp___expr_1179 Int) (temp___is_init_1176 Bool) (temp___skip_constant_1177 Bool) (temp___do_toplevel_1178 Bool)) Bool (=> (or (= temp___is_init_1176 true) (<= 0 1024)) (in_range9 temp___expr_1179)))
(assert true)
...
(define-fun dynamic_invariant8 ((temp___expr_557 Int) (temp___is_init_554 Bool) (temp___skip_constant_555 Bool) (temp___do_toplevel_556 Bool)) Bool (=> (or (= temp___is_init_554 true) (<= 1901 2099)) (in_range2 temp___expr_557)))
(define-fun dynamic_invariant9 ((temp___expr_563 Int) (temp___is_init_560 Bool) (temp___skip_constant_561 Bool) (temp___do_toplevel_562 Bool)) Bool (=> (or (= temp___is_init_560 true) (<= 1 12)) (in_range3 temp___expr_563)))
(define-fun dynamic_invariant10 ((temp___expr_569 Int) (temp___is_init_566 Bool) (temp___skip_constant_567 Bool) (temp___do_toplevel_568 Bool)) Bool (=> (or (= temp___is_init_566 true) (<= 1 31)) (in_range4 temp___expr_569)))
(define-fun dynamic_invariant11 ((temp___expr_597 Int) (temp___is_init_594 Bool) (temp___skip_constant_595 Bool) (temp___do_toplevel_596 Bool)) Bool (=> (or (= temp___is_init_594 true) (<= 0 86399999)) (in_range5 temp___expr_597)))
