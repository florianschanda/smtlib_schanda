...
(assert (not (= (length temp___1941) 0)))
(assert (=> (<= (to_rep1 (first2 temp___19421)) (to_rep1 (last2 temp___19421))) (= o102 (+ (- (to_rep1 (last2 temp___19421)) (to_rep1 (first2 temp___19421))) 1))))
(assert (=> (not (<= (to_rep1 (first2 temp___19421)) (to_rep1 (last2 temp___19421)))) (= o102 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1941))) (to_rep1 (last (rt temp___1941)))) (= o103 (+ (- (to_rep1 (last (rt temp___1941))) (to_rep1 (first (rt temp___1941)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1941))) (to_rep1 (last (rt temp___1941))))) (= o103 0)))
(assert (= o104 (+ o103 o102)))
(assert (= o105 (+ (to_rep1 (first (rt temp___1941))) o104)))
(assert (= o106 (- o105 1)))
