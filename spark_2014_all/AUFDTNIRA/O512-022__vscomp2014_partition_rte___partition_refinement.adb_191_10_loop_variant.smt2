...
(define-fun dynamic_invariant ((temp___expr_176 Int) (temp___is_init_172 Bool) (temp___skip_constant_173 Bool) (temp___do_toplevel_174 Bool) (temp___do_typ_inv_175 Bool)) Bool (=> (or (= temp___is_init_172 true) (<= 0 2147483647)) (in_range3 temp___expr_176)))
(assert (forall ((container us_rep1)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant1 ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 1 2147483647)) (in_range6 temp___expr_415)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption1 ((temp___expr_423 us_rep2) (temp___skip_top_level_424 Bool)) Bool (=> (not (= temp___skip_top_level_424 true)) (and (= (is_empty temp___expr_423) true) (= (length1 temp___expr_423) 0))))
...
(define-fun default_initial_assumption2 ((temp___expr_409 us_rep) (temp___skip_top_level_410 Bool)) Bool (= (to_rep1 (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields1 temp___expr_409))) 0))
(assert (forall ((container us_rep2)) (forall ((key us_rep)) (! (=> (= (has_key container key) true) (let ((result (get container key))) (and (=> (= (distinct 0 0) true) (and (= result (w_get container (witness container key))) (forall ((k us_rep)) (=> (= (has_key container k) true) (= (= (bool_eq1 k key) true) (= (witness container key) (witness container k))))))) (dynamic_invariant1 result true false true true)))) :pattern ((get container key))))))
...
(define-fun dynamic_invariant2 ((temp___expr_350 Int) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool) (temp___do_typ_inv_349 Bool)) Bool (=> (or (= temp___is_init_346 true) (<= 1 2147483647)) (in_range7 temp___expr_350)))
...
(define-fun dynamic_invariant3 ((temp___expr_540 Int) (temp___is_init_536 Bool) (temp___skip_constant_537 Bool) (temp___do_toplevel_538 Bool) (temp___do_typ_inv_539 Bool)) Bool (=> (or (= temp___is_init_536 true) (<= 1 2147483647)) (in_range8 temp___expr_540)))
(assert (forall ((attr__tag Int)) (forall ((container us_rep5)) (forall ((position us_rep4)) (! (dynamic_invariant3 (key1 attr__tag container position) true false true true) :pattern ((key1 attr__tag container position)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_547 Int) (temp___is_init_543 Bool) (temp___skip_constant_544 Bool) (temp___do_toplevel_545 Bool) (temp___do_typ_inv_546 Bool)) Bool (=> (or (= temp___is_init_543 true) (<= 0 5)) (in_range9 temp___expr_547)))
(assert (forall ((attr__tag Int)) (forall ((container us_rep5)) (forall ((position us_rep4)) (! (dynamic_invariant4 (element2 attr__tag container position) true false true true) :pattern ((element2 attr__tag container position)))))))
...
(define-fun dynamic_invariant5 ((temp___expr_799 Int) (temp___is_init_795 Bool) (temp___skip_constant_796 Bool) (temp___do_toplevel_797 Bool) (temp___do_typ_inv_798 Bool)) Bool (=> (or (= temp___is_init_795 true) (<= 0 10001)) (in_range12 temp___expr_799)))
(declare-fun length2 (us_rep10) Int)
(declare-fun length__function_guard2 (Int us_rep10) Bool)
(assert (forall ((container us_rep10)) (! (let ((result (length2 container))) (and (<= result (capacity container)) (dynamic_invariant5 result true false true true))) :pattern ((length2 container)))))
...
(define-fun dynamic_invariant7 ((temp___expr_326 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool) (temp___do_typ_inv_325 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 0 6)) (in_range4 temp___expr_326)))
(define-fun dynamic_invariant8 ((temp___expr_333 Int) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool) (temp___do_typ_inv_332 Bool)) Bool (=> (or (= temp___is_init_329 true) (<= 0 5)) (in_range5 temp___expr_333)))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key2 us_rep)) (! (=> (= (has_key container key2) true) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness container key2))))))
...
(assert (forall ((container us_rep5)) (! (let ((result (length6 container))) (and (<= result (to_rep1 (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs3 container)))) (dynamic_invariant result true false true true))) :pattern ((length6 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep5)) (! (dynamic_invariant (length7 attr__tag container) true false true true) :pattern ((length7 attr__tag container))))))
...
(define-fun k_is_find ((container us_rep7) (key2 Int) (position Int)) Bool (and (ite (< 0 position) (k_bigger_than_range container 1 (- position 1) key2) (distinct 1 0)) (ite (< position (length4 container)) (k_smaller_than_range container (+ position 1) (length4 container) key2) (distinct 1 0))))
...
(assert (forall ((container us_rep7)) (forall ((key2 Int)) (! (=> (dynamic_invariant3 key2 true true true true) (let ((result (find container key2))) (and (=> (< 0 result) (and (<= result (length4 container)) (= (equivalent_keys key2 (get2 container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container key2))))))
...
(assert true)
(assert (forall ((attr__tag Int) (key2 Int)) (forall ((container us_rep5)) (! (=> (dynamic_invariant3 key2 true true true true) (dynamic_invariant4 (element__21 attr__tag container key2) true false true true)) :pattern ((element__21 attr__tag container key2))))))
...
(assert (forall ((container us_rep8)) (! (dynamic_invariant (length8 container) true false true true) :pattern ((length8 container)))))
...
(assert true)
(assert (forall ((container us_rep8)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant12 key2 true true true true) (= (has_key2 container key2) true)) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness1 container key2))))))
...
(assert (forall ((container us_rep6)) (! (dynamic_invariant (length9 container) true false true true) :pattern ((length9 container)))))
...
(assert true)
(assert (forall ((container us_rep6)) (forall ((key2 us_rep4)) (! (=> (= (has_key1 container key2) true) (let ((result (witness2 container key2))) (and (= (has_witness2 container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness2 container key2))))))
(assert (forall ((container us_rep6)) (forall ((witness3 Int)) (! (=> (and (dynamic_invariant witness3 true true true true) (= (has_witness2 container witness3) true)) (dynamic_invariant16 (w_get2 container witness3) true false true true)) :pattern ((w_get2 container witness3))))))
...
(declare-const temp___1228 count_type)
...
(assert (= (to_rep1 o) 0))
(assert (= o o1))
(assert (= temp___1228 o1))
(assert (= (mk___rep (mk___split_fields temp___1228)) no_element))
(assert (and (<= (* 2 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (<= (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 5000) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (to_rep (select a j))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c) true) (= (to_rep (select a (element1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c))) (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c)))) (and (forall ((c us_rep)) (=> (= (has_key (positions x) c) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x c)) true))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= 0 (to_rep4 (select f j))) (<= (to_rep4 (select f j)) (- (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j)))))) j) (<= j (to_rep3 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j)))))))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))) (= (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j)))) 0)))))))))))
(assert (and (= partition_refinement__refine__c__assume (first x)) (ite (= (= (length x) 0) true) (= (bool_eq1 partition_refinement__refine__c__assume no_element) true) (and (= (has_key (positions x) partition_refinement__refine__c__assume) true) (= (get (positions x) partition_refinement__refine__c__assume) 1)))))
...
(assert (and (= o2 (element x (mk___rep c__split_fields1))) (and (in_range7 o2) (= o2 (get1 (model__ x) (get (positions x) (mk___rep c__split_fields1)))))))
(assert (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a1 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2)) (to_rep (select a (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2)))))))))) (ite (= k (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2))))))))) (to_rep (select a (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o2))) (to_rep (select a k))))))) (and (= (capacity (mk___rep5 p__split_discrs p__split_fields1)) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (= (length2 (mk___rep5 p__split_discrs p__split_fields1)) (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields1)) (to_rep (select a1 j))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields1)) c) true) (= (to_rep (select a1 (element1 (mk___rep3 d__split_discrs d__split_fields1) c))) (key (mk___rep3 d__split_discrs d__split_fields1) c)))) (= (oeq2 (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (keys (mk___rep3 d__split_discrs d__split_fields1))) true)))))))
(assert (ite (= (ite (= (bool_eq1 (mk___rep c__split_fields1) no_element) false) (= (get (positions x) (mk___rep c__split_fields1)) (length x)) true) true) (= (bool_eq1 (mk___rep c__split_fields2) no_element) true) (and (= (has_key (positions x) (mk___rep c__split_fields2)) true) (= (get (positions x) (mk___rep c__split_fields2)) (+ (get (positions x) (mk___rep c__split_fields1)) 1)))))
...
(assert (= (length2 (mk___rep5 p__split_discrs p__split_fields2)) (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))
...
(assert (forall ((c us_rep)) (=> (= (has_key (positions x) c) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) (element x c)) true))))
(assert (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) (to_rep (select a2 j))) true))))
(assert (=> (= (bool_eq1 (mk___rep c__split_fields3) no_element) true) (= o3 (length x))))
(assert (=> (not (= (bool_eq1 (mk___rep c__split_fields3) no_element) true)) (= o3 (- (get (positions x) (mk___rep c__split_fields3)) 1))))
(assert (= result2 (mk_int__ref temp___1215)))
(assert (= temp___12151 o3))
(assert (and (= o4 (has_key (positions x) (mk___rep c__split_fields3))) (= (= o4 true) (= (has_key (positions x) (mk___rep c__split_fields3)) true))))
...
(assert (and (= o5 (element x (mk___rep c__split_fields3))) (and (in_range7 o5) (= o5 (get1 (model__ x) (get (positions x) (mk___rep c__split_fields3)))))))
(assert (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a3 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o5)) (to_rep (select a2 (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o5))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o5)))))))))) (ite (= k (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o5))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o5))))))))) (to_rep (select a2 (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o5))) (to_rep (select a2 k))))))) (and (= (capacity (mk___rep5 p__split_discrs p__split_fields3)) (capacity (mk___rep5 p__split_discrs p__split_fields2))) (and (= (length2 (mk___rep5 p__split_discrs p__split_fields3)) (length2 (mk___rep5 p__split_discrs p__split_fields2))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (to_rep (select a3 j))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c) true) (= (to_rep (select a3 (element1 (mk___rep3 d__split_discrs d__split_fields3) c))) (key (mk___rep3 d__split_discrs d__split_fields3) c)))) (= (oeq2 (keys (mk___rep3 d__split_discrs d__split_fields2)) (keys (mk___rep3 d__split_discrs d__split_fields3))) true)))))))
(assert (ite (= (ite (= (bool_eq1 (mk___rep c__split_fields3) no_element) false) (= (get (positions x) (mk___rep c__split_fields3)) (length x)) true) true) (= (bool_eq1 (mk___rep c__split_fields4) no_element) true) (and (= (has_key (positions x) (mk___rep c__split_fields4)) true) (= (get (positions x) (mk___rep c__split_fields4)) (+ (get (positions x) (mk___rep c__split_fields3)) 1)))))
(assert (not (< temp___12151 (ite (= (bool_eq1 (mk___rep c__split_fields4) no_element) true) (length x) (- (get (positions x) (mk___rep c__split_fields4)) 1)))))
(check-sat)
(exit)
