...
(assert (= result2 (mk_int__ref temp___1142)))
(assert (= temp___11421 o3))
...
(assert (not (< temp___11421 (ite (= (bool_eq1 (mk___rep c__split_fields4) no_element) true) (length x) (- (get (positions x) (mk___rep c__split_fields4)) 1)))))
(check-sat)
(exit)
