...
(assert (and (<= (* 2 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (<= (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 5000) (and (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (to_rep (select a j2))) true))) (and (forall ((c4 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c4) true) (= (to_rep (select a (element1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c4))) (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c4)))) (and (forall ((c4 us_rep)) (=> (= (has_key (positions x) c4) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x c4)) true))) (and (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 5)) (and (<= 0 (to_rep4 (select f j2))) (<= (to_rep4 (select f j2)) (- (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))))) (and (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 5)) (and (<= (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j2)))))) j2) (<= j2 (to_rep3 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j2)))))))))) (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 (- (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) 1))) (= (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) j2)))) 0)))))))))))
...
(assert (= result10 (mk___split_fields__ref (mk___split_fields c__split_fields))))
...
(assert (and (= result11 (has_key (positions x) (mk___rep c__split_fields1))) (= (= result11 true) (= (has_key (positions x) (mk___rep c__split_fields1)) true))))
...
(assert (and (= o35 (element x (mk___rep c__split_fields1))) (and (in_range7 o35) (= o35 (get1 (model__ x) (get (positions x) (mk___rep c__split_fields1)))))))
(assert (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a2 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o35)) (to_rep (select a (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o35))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o35)))))))))) (ite (= k (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o35))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o35))))))))) (to_rep (select a (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o35))) (to_rep (select a k))))))) (and (= (capacity (mk___rep5 p__split_discrs p__split_fields2)) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (= (length2 (mk___rep5 p__split_discrs p__split_fields2)) (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) (to_rep (select a2 j2))) true))) (and (forall ((c4 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c4) true) (= (to_rep (select a2 (element1 (mk___rep3 d__split_discrs d__split_fields2) c4))) (key (mk___rep3 d__split_discrs d__split_fields2) c4)))) (= (oeq2 (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (keys (mk___rep3 d__split_discrs d__split_fields2))) true)))))))
...
(assert (= (length2 (mk___rep5 p__split_discrs p__split_fields3)) (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))
(assert (forall ((c4 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c4) true) (= (to_rep (select a3 (element1 (mk___rep3 d__split_discrs d__split_fields3) c4))) (key (mk___rep3 d__split_discrs d__split_fields3) c4)))))
(assert (forall ((c4 us_rep)) (=> (= (has_key (positions x) c4) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (element x c4)) true))))
(assert (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (to_rep (select a3 j2))) true))))
(assert (=> (= (bool_eq1 (mk___rep c__split_fields3) no_element) true) (= o43 (length x))))
(assert (=> (not (= (bool_eq1 (mk___rep c__split_fields3) no_element) true)) (= o43 (- (get (positions x) (mk___rep c__split_fields3)) 1))))
(assert (= result14 (mk_int__ref temp___11421)))
(assert (= temp___11422 o43))
(assert (and (= o44 (has_key (positions x) (mk___rep c__split_fields3))) (= (= o44 true) (= (has_key (positions x) (mk___rep c__split_fields3)) true))))
(assert (= result15 (ite (not (= o44 true)) true false)))
...
(assert (and (= o46 (element x (mk___rep c__split_fields3))) (and (in_range7 o46) (= o46 (get1 (model__ x) (get (positions x) (mk___rep c__split_fields3)))))))
(assert (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a4 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) o46)) (to_rep (select a3 (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) o46))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) o46)))))))))) (ite (= k (+ (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) o46))))))) (to_rep2 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) o46))))))))) (to_rep (select a3 (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) o46))) (to_rep (select a3 k))))))) (and (= (capacity (mk___rep5 p__split_discrs p__split_fields4)) (capacity (mk___rep5 p__split_discrs p__split_fields3))) (and (= (length2 (mk___rep5 p__split_discrs p__split_fields4)) (length2 (mk___rep5 p__split_discrs p__split_fields3))) (and (forall ((j2 Int)) (=> (and (<= 0 j2) (<= j2 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields4)) (to_rep (select a4 j2))) true))) (and (forall ((c4 us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields4)) c4) true) (= (to_rep (select a4 (element1 (mk___rep3 d__split_discrs d__split_fields4) c4))) (key (mk___rep3 d__split_discrs d__split_fields4) c4)))) (= (oeq2 (keys (mk___rep3 d__split_discrs d__split_fields3)) (keys (mk___rep3 d__split_discrs d__split_fields4))) true)))))))
...
(assert (not (< temp___11422 (ite (= (bool_eq1 (mk___rep c__split_fields4) no_element) true) (length x) (- (get (positions x) (mk___rep c__split_fields4)) 1)))))
(check-sat)
(exit)
