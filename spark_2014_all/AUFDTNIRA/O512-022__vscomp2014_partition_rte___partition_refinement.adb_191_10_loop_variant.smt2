...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__partition_refinement__partitioning_sets__list us_main_type)))))
(define-fun us_split_fields_List__projection ((a us_split_fields)) us_main_type (rec__partition_refinement__partitioning_sets__list a))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep1 (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 a))) (to_rep1 (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 b)))) (= (us_main_eq (rec__partition_refinement__partitioning_sets__list (us_split_fields1 a)) (rec__partition_refinement__partitioning_sets__list (us_split_fields1 b))) true)) true false))
...
(assert (forall ((container us_rep)) (! (let ((result (length container))) (and (<= result (to_rep1 (rec__partition_refinement__partitioning_sets__list__capacity (us_split_discrs1 container)))) (dynamic_invariant result true false true true))) :pattern ((length container)))))
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__partition_refinement__partitioning_sets__cursor__node count_type)))))
(define-fun us_split_fields_Node__projection ((a us_split_fields2)) count_type (rec__partition_refinement__partitioning_sets__cursor__node a))
...
(define-fun bool_eq1 ((a us_rep1) (b us_rep1)) Bool (ite (= (to_rep1 (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 a))) (to_rep1 (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_415 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool) (temp___do_typ_inv_414 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 1 2147483647)) (in_range3 temp___expr_415)))
(declare-fun length1 (us_rep2) Int)
(declare-fun length__function_guard1 (Int us_rep2) Bool)
(declare-fun is_empty (us_rep2) Bool)
(declare-fun is_empty__function_guard (Bool us_rep2) Bool)
(define-fun default_initial_assumption ((temp___expr_423 us_rep2) (temp___skip_top_level_424 Bool)) Bool (=> (not (= temp___skip_top_level_424 true)) (and (= (is_empty temp___expr_423) true) (= (length1 temp___expr_423) 0))))
(define-fun default_initial_assumption1 ((temp___expr_409 us_rep1) (temp___skip_top_level_410 Bool)) Bool (= (to_rep1 (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 temp___expr_409))) 0))
...
(define-fun element ((container us_rep) (position us_rep1)) Int (get1 (model__ container) (get (positions container) position)))
...
(define-fun dynamic_invariant2 ((temp___expr_350 Int) (temp___is_init_346 Bool) (temp___skip_constant_347 Bool) (temp___do_toplevel_348 Bool) (temp___do_typ_inv_349 Bool)) Bool (=> (or (= temp___is_init_346 true) (<= 1 2147483647)) (in_range4 temp___expr_350)))
(declare-fun first (us_rep) us_rep1)
(declare-fun first__function_guard (us_rep1 us_rep) Bool)
(define-fun default_initial_assumption2 ((temp___expr_364 us_rep1) (temp___skip_top_level_365 Bool)) Bool (= (to_rep1 (rec__partition_refinement__partitioning_sets__cursor__node (us_split_fields3 temp___expr_364))) 0))
...
(define-fun dynamic_invariant3 ((temp___expr_540 Int) (temp___is_init_536 Bool) (temp___skip_constant_537 Bool) (temp___do_toplevel_538 Bool) (temp___do_typ_inv_539 Bool)) Bool (=> (or (= temp___is_init_536 true) (<= 1 2147483647)) (in_range5 temp___expr_540)))
...
(assert (forall ((i element_type2)) (and (<= 0 (element_typeqtint2 i)) (<= (element_typeqtint2 i) 5))))
...
(define-fun dynamic_invariant4 ((temp___expr_547 Int) (temp___is_init_543 Bool) (temp___skip_constant_544 Bool) (temp___do_toplevel_545 Bool) (temp___do_typ_inv_546 Bool)) Bool (=> (or (= temp___is_init_543 true) (<= 0 5)) (in_range6 temp___expr_547)))
...
(define-fun in_range7 ((x Int)) Bool (and (<= 0 x) (<= x 10001)))
...
(assert (forall ((x capacity_range)) (! (in_range7 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun dynamic_invariant5 ((temp___expr_799 Int) (temp___is_init_795 Bool) (temp___skip_constant_796 Bool) (temp___do_toplevel_797 Bool) (temp___do_typ_inv_798 Bool)) Bool (=> (or (= temp___is_init_795 true) (<= 0 10001)) (in_range7 temp___expr_799)))
(declare-fun length2 (us_rep9) Int)
(declare-fun length__function_guard2 (Int us_rep9) Bool)
(assert (forall ((container us_rep9)) (! (let ((result (length2 container))) (and (<= result (capacity container)) (dynamic_invariant5 result true false true true))) :pattern ((length2 container)))))
...
(assert (forall ((x index_count)) (! (in_range8 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x index)) (! (in_range9 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun element_type__ref___8__projection ((a element_type__ref3)) us_rep10 (element_type__content3 a))
(declare-datatypes () ((element_type__ref4 (mk_element_type__ref4 (element_type__content4 us_rep10)))))
(define-fun element_type__ref___9__projection ((a element_type__ref4)) us_rep10 (element_type__content4 a))
...
(define-fun oeq ((left us_rep7) (right us_rep7)) Bool (and (= (length4 left) (length4 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last1 left))) (= (get2 left n) (get2 right n)))) true false)))
...
(declare-fun oeq1 (us_rep6 us_rep6) Bool)
(declare-fun oeq__function_guard1 (Bool us_rep6 us_rep6) Bool)
(assert (forall ((a us_rep6) (b us_rep6)) (! (= (user_eq21 a b) (oeq1 a b)) :pattern ((user_eq21 a b)))))
...
(declare-fun user_eq22 (partition_index partition_index) Bool)
(declare-const dummy22 partition_index)
...
(assert (forall ((x partition_index)) (! (in_range10 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(declare-fun user_eq24 (tcount_typeB tcount_typeB) Bool)
(declare-const dummy24 tcount_typeB)
...
(declare-datatypes () ((partitioning_set__ref (mk_partitioning_set__ref (partitioning_set__content us_rep)))))
(define-fun partitioning_set__ref___projection ((a partitioning_set__ref)) us_rep (partitioning_set__content a))
...
(define-fun dynamic_invariant7 ((temp___expr_326 Int) (temp___is_init_322 Bool) (temp___skip_constant_323 Bool) (temp___do_toplevel_324 Bool) (temp___do_typ_inv_325 Bool)) Bool (=> (or (= temp___is_init_322 true) (<= 0 6)) (in_range8 temp___expr_326)))
(define-fun dynamic_invariant8 ((temp___expr_333 Int) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool) (temp___do_typ_inv_332 Bool)) Bool (=> (or (= temp___is_init_329 true) (<= 0 5)) (in_range9 temp___expr_333)))
(define-fun dynamic_invariant9 ((temp___expr_768 Int) (temp___is_init_764 Bool) (temp___skip_constant_765 Bool) (temp___do_toplevel_766 Bool) (temp___do_typ_inv_767 Bool)) Bool (=> (or (= temp___is_init_764 true) (<= 0 10000)) (in_range10 temp___expr_768)))
...
(define-fun oeq2 ((left us_rep3) (right us_rep3)) Bool (and (= (length5 left) (length5 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last2 left))) (= (get1 left n) (get1 right n)))) true false)))
...
(define-fun default_initial_assumption3 ((temp___expr_401 us_rep3) (temp___skip_top_level_402 Bool)) Bool (=> (not (= temp___skip_top_level_402 true)) (= (length5 temp___expr_401) 0)))
(assert (forall ((container us_rep)) (! (= (length5 (model__ container)) (length container)) :pattern ((model__ container)))))
...
(define-fun dynamic_invariant10 ((temp___expr_393 Int) (temp___is_init_389 Bool) (temp___skip_constant_390 Bool) (temp___do_toplevel_391 Bool) (temp___do_typ_inv_392 Bool)) Bool (=> (or (= temp___is_init_389 true) (<= 0 2147483647)) (in_range13 temp___expr_393)))
(assert (forall ((container us_rep3)) (! (let ((result (length5 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant result true false true true))) :pattern ((length5 container)))))
...
(define-fun dynamic_invariant11 ((temp___expr_386 Int) (temp___is_init_382 Bool) (temp___skip_constant_383 Bool) (temp___do_toplevel_384 Bool) (temp___do_typ_inv_385 Bool)) Bool (=> (or (= temp___is_init_382 true) (<= 1 2147483647)) (in_range14 temp___expr_386)))
(assert (forall ((container us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant10 position true true true true) (and (<= 1 position) (<= position (last2 container)))) (dynamic_invariant11 (get1 container position) true false true true)) :pattern ((get1 container position))))))
...
(assert true)
(assert (forall ((container us_rep2)) (forall ((key1 us_rep1)) (! (=> (= (has_key container key1) true) (let ((result (witness container key1))) (and (= (has_witness container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness container key1))))))
...
(assert (forall ((a us_rep6) (b us_rep6)) (! (= (user_eq10 a b) (oeq1 a b)) :pattern ((user_eq10 a b)))))
...
(assert (forall ((container us_rep6)) (! (let ((result (length6 container))) (and (<= result (to_rep1 (rec__partition_refinement__inverse_sets__map__capacity (us_split_discrs3 container)))) (dynamic_invariant result true false true true))) :pattern ((length6 container)))))
...
(define-fun k_is_find ((container us_rep7) (key1 Int) (position Int)) Bool (and (ite (< 0 position) (k_bigger_than_range container 1 (- position 1) key1) (distinct 1 0)) (ite (< position (length4 container)) (k_smaller_than_range container (+ position 1) (length4 container) key1) (distinct 1 0))))
...
(assert (forall ((a us_rep7) (b us_rep7)) (! (= (user_eq11 a b) (oeq a b)) :pattern ((user_eq11 a b)))))
(define-fun default_initial_assumption4 ((temp___expr_628 us_rep7) (temp___skip_top_level_629 Bool)) Bool (=> (not (= temp___skip_top_level_629 true)) (= (length4 temp___expr_628) 0)))
(assert (forall ((container us_rep7)) (forall ((key1 Int)) (! (=> (dynamic_invariant3 key1 true true true true) (let ((result (find container key1))) (and (=> (< 0 result) (and (<= result (length4 container)) (= (equivalent_keys key1 (get2 container result)) true))) (dynamic_invariant result true false true true)))) :pattern ((find container key1))))))
...
(assert (forall ((container us_rep6)) (! (let ((result (keys container))) (and (and (and (= (length4 result) (length6 container)) (forall ((temp___666 Int)) (=> (and (in_range16 temp___666) (= (iter_has_element result temp___666) true)) (= (has_key2 (model__1 container) (get2 result temp___666)) true)))) (forall ((key1 Int)) (=> (and (in_range15 key1) (= (has_key2 (model__1 container) key1) true)) (and (< 0 (find result key1)) (= (equivalent_keys (get2 result (find result key1)) key1) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length6 container))) (and (= (find result (get2 result i)) i) (= (k_is_find result (get2 result i) i) true)))))) :pattern ((keys container)))))
...
(assert (forall ((container us_rep6)) (! (let ((result (positions1 container))) (and (not (= (has_key1 result no_element1) true)) (forall ((i us_rep4)) (=> (= (has_key1 result i) true) (and (and (<= 1 (get3 result i)) (<= (get3 result i) (length6 container))) (forall ((j us_rep4)) (=> (= (has_key1 result j) true) (=> (= (get3 result i) (get3 result j)) (= (bool_eq4 i j) true))))))))) :pattern ((positions1 container)))))
(declare-fun oeq3 (us_rep8 us_rep8) Bool)
(declare-fun oeq__function_guard3 (Bool us_rep8 us_rep8) Bool)
(assert (forall ((left us_rep6) (right us_rep6)) (! (= (= (oeq1 left right) true) (= (oeq3 (model__1 left) (model__1 right)) true)) :pattern ((oeq1 left right)))))
...
(assert (forall ((container us_rep8)) (! (dynamic_invariant (length7 container) true false true true) :pattern ((length7 container)))))
...
(assert true)
(assert (forall ((container us_rep8)) (forall ((key1 Int)) (! (=> (and (dynamic_invariant12 key1 true true true true) (= (has_key2 container key1) true)) (let ((result (witness1 container key1))) (and (= (has_witness1 container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness1 container key1))))))
(assert (forall ((container us_rep8)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant13 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
...
(assert (forall ((container us_rep7)) (! (let ((result (length4 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant result true false true true))) :pattern ((length4 container)))))
...
(assert (forall ((container us_rep7)) (forall ((position Int)) (! (=> (and (dynamic_invariant14 position true true true true) (and (<= 1 position) (<= position (last1 container)))) (dynamic_invariant15 (get2 container position) true false true true)) :pattern ((get2 container position))))))
...
(assert (forall ((container us_rep5)) (! (dynamic_invariant (length8 container) true false true true) :pattern ((length8 container)))))
...
(assert true)
(assert (forall ((container us_rep5)) (forall ((key1 us_rep4)) (! (=> (= (has_key1 container key1) true) (let ((result (witness2 container key1))) (and (= (has_witness2 container result) true) (dynamic_invariant result true false true true)))) :pattern ((witness2 container key1))))))
(assert (forall ((container us_rep5)) (forall ((witness3 Int)) (! (=> (and (dynamic_invariant witness3 true true true true) (= (has_witness2 container witness3) true)) (dynamic_invariant16 (w_get2 container witness3) true false true true)) :pattern ((w_get2 container witness3))))))
...
(define-fun oeq4 ((left us_rep11) (right us_rep11)) Bool (and (= (length3 left) (length3 right)) (ite (forall ((n Int)) (=> (and (<= 0 n) (<= n (last left))) (= (bool_eq9 (get5 left n) (get5 right n)) true))) true false)))
(declare-fun oeq__function_guard4 (Bool us_rep11 us_rep11) Bool)
(assert (forall ((a us_rep11) (b us_rep11)) (! (= (user_eq20 a b) (oeq4 a b)) :pattern ((user_eq20 a b)))))
(define-fun default_initial_assumption7 ((temp___expr_841 us_rep11) (temp___skip_top_level_842 Bool)) Bool (=> (not (= temp___skip_top_level_842 true)) (= (length3 temp___expr_841) 0)))
(assert (forall ((container us_rep9)) (! (= (length3 (model__2 container)) (length2 container)) :pattern ((model__2 container)))))
(define-fun dynamic_invariant18 ((temp___expr_775 Int) (temp___is_init_771 Bool) (temp___skip_constant_772 Bool) (temp___do_toplevel_773 Bool) (temp___do_typ_inv_774 Bool)) Bool (=> (or (= temp___is_init_771 true) (<= 0 10000)) (in_range12 temp___expr_775)))
...
(assert (forall ((container us_rep11)) (! (let ((result (length3 container))) (and (<= (+ (- 1) result) 10000) (dynamic_invariant result true false true true))) :pattern ((length3 container)))))
(assert true)
...
(declare-const partition_refinement__refine__c__assume count_type)
(declare-const o Int)
...
(declare-const temp___12151 Int)
...
(define-fun partition_refinement__refine__c__assume1 () us_rep1 (mk___rep1 (mk___split_fields1 partition_refinement__refine__c__assume)))
(assert (= (mk___rep1 (mk___split_fields1 rliteral)) no_element))
(assert (and (<= (* 2 (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (<= (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 5000) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (to_rep (select a j))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c) true) (= (to_rep (select a (element1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c))) (key (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) c)))) (and (forall ((c us_rep1)) (=> (= (has_key (positions x) c) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x c)) true))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= 0 (to_rep5 (select f j))) (<= (to_rep5 (select f j)) (- (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1))))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j)))))) j) (<= j (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j)))))))))) (forall ((j Int)) (=> (and (<= 0 j) (<= j (- (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1))) (= (to_rep3 (rec__partition_refinement__interval__count (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) j)))) 0)))))))))))
(assert (and (= partition_refinement__refine__c__assume1 (first x)) (ite (= (= (length x) 0) true) (= (bool_eq1 partition_refinement__refine__c__assume1 no_element) true) (and (= (has_key (positions x) partition_refinement__refine__c__assume1) true) (= (get (positions x) partition_refinement__refine__c__assume1) 1)))))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 c__split_fields))))
(assert (= c__split_fields1 (mk___split_fields1 partition_refinement__refine__c__assume)))
(assert (= (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields)) d_old))
(assert (and (= result1 (has_key (positions x) (mk___rep1 c__split_fields1))) (= (= result1 true) (= (has_key (positions x) (mk___rep1 c__split_fields1)) true))))
(assert (= result1 true))
(assert (= (has_key2 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (element x (mk___rep1 c__split_fields1))) true))
(assert (and (= o (element x (mk___rep1 c__split_fields1))) (and (in_range4 o) (= o (get1 (model__ x) (get (positions x) (mk___rep1 c__split_fields1)))))))
(assert (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a1 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o)) (to_rep (select a (+ (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))) (to_rep3 (rec__partition_refinement__interval__count (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o)))))))))) (ite (= k (+ (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))) (to_rep3 (rec__partition_refinement__interval__count (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))))) (to_rep (select a (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))) (to_rep (select a k))))))) (and (= (capacity (mk___rep4 p__split_discrs p__split_fields1)) (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (= (length2 (mk___rep4 p__split_discrs p__split_fields1)) (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields1)) (to_rep (select a1 j))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields1)) c) true) (= (to_rep (select a1 (element1 (mk___rep3 d__split_discrs d__split_fields1) c))) (key (mk___rep3 d__split_discrs d__split_fields1) c)))) (= (oeq (keys (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) (keys (mk___rep3 d__split_discrs d__split_fields1))) true)))))))
(assert (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields1) no_element) false) (= (get (positions x) (mk___rep1 c__split_fields1)) (length x)) true) true) (= (bool_eq1 (mk___rep1 c__split_fields2) no_element) true) (and (= (has_key (positions x) (mk___rep1 c__split_fields2)) true) (= (get (positions x) (mk___rep1 c__split_fields2)) (+ (get (positions x) (mk___rep1 c__split_fields1)) 1)))))
...
(assert (= (length2 (mk___rep4 p__split_discrs p__split_fields2)) (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))
...
(assert (forall ((c us_rep1)) (=> (= (has_key (positions x) c) true) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) (element x c)) true))))
(assert (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) (to_rep (select a2 j))) true))))
(assert (=> (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) true) (= o1 (length x))))
(assert (=> (not (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) true)) (= o1 (- (get (positions x) (mk___rep1 c__split_fields3)) 1))))
(assert (= result2 (mk_int__ref temp___1215)))
(assert (= temp___12151 o1))
(assert (and (= o2 (has_key (positions x) (mk___rep1 c__split_fields3))) (= (= o2 true) (= (has_key (positions x) (mk___rep1 c__split_fields3)) true))))
(assert (= result3 (ite (not (= o2 true)) true false)))
(assert (not (= result3 true)))
(assert (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) (element x (mk___rep1 c__split_fields3))) true))
(assert (and (= o3 (element x (mk___rep1 c__split_fields3))) (and (in_range4 o3) (= o3 (get1 (model__ x) (get (positions x) (mk___rep1 c__split_fields3)))))))
(assert (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a3 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o3)) (to_rep (select a2 (+ (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields2)) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o3))))))) (to_rep3 (rec__partition_refinement__interval__count (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields2)) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o3)))))))))) (ite (= k (+ (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields2)) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o3))))))) (to_rep3 (rec__partition_refinement__interval__count (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs p__split_fields2)) (to_rep5 (select f (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o3))))))))) (to_rep (select a2 (get4 (model__1 (mk___rep3 d__split_discrs d__split_fields2)) o3))) (to_rep (select a2 k))))))) (and (= (capacity (mk___rep4 p__split_discrs p__split_fields3)) (capacity (mk___rep4 p__split_discrs p__split_fields2))) (and (= (length2 (mk___rep4 p__split_discrs p__split_fields3)) (length2 (mk___rep4 p__split_discrs p__split_fields2))) (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields3)) (to_rep (select a3 j))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields3)) c) true) (= (to_rep (select a3 (element1 (mk___rep3 d__split_discrs d__split_fields3) c))) (key (mk___rep3 d__split_discrs d__split_fields3) c)))) (= (oeq (keys (mk___rep3 d__split_discrs d__split_fields2)) (keys (mk___rep3 d__split_discrs d__split_fields3))) true)))))))
(assert (ite (= (ite (= (bool_eq1 (mk___rep1 c__split_fields3) no_element) false) (= (get (positions x) (mk___rep1 c__split_fields3)) (length x)) true) true) (= (bool_eq1 (mk___rep1 c__split_fields4) no_element) true) (and (= (has_key (positions x) (mk___rep1 c__split_fields4)) true) (= (get (positions x) (mk___rep1 c__split_fields4)) (+ (get (positions x) (mk___rep1 c__split_fields3)) 1)))))
(assert (not (< temp___12151 (ite (= (bool_eq1 (mk___rep1 c__split_fields4) no_element) true) (length x) (- (get (positions x) (mk___rep1 c__split_fields4)) 1)))))
(check-sat)
(exit)
