...
(assert (=> (<= 1 temp___1733) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1733) (<= temp___1733 150)))))
(assert (= o37 (let ((subject result__2)) result__19)))
(assert (= temp___1734 (mk___t3 o37 (mk3 1 temp___1733))))
(assert (not (= (ite (<= (to_rep1 (first6 (rt3 temp___1731))) (to_rep1 (last6 (rt3 temp___1731)))) (+ (- (to_rep1 (last6 (rt3 temp___1731))) (to_rep1 (first6 (rt3 temp___1731)))) 1) 0) (ite (<= (to_rep1 (first6 (rt3 temp___1734))) (to_rep1 (last6 (rt3 temp___1734)))) (+ (- (to_rep1 (last6 (rt3 temp___1734))) (to_rep1 (first6 (rt3 temp___1734)))) 1) 0))))
(check-sat)
(exit)
