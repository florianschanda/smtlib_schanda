...
(assert (forall ((r us_rep)) (! (= (head r) (to_rep (let ((temp___174 (rec__ring_buf__ring_buffer__data (us_split_fields1 r)))) (select temp___174 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))))) :pattern ((head r)))))
