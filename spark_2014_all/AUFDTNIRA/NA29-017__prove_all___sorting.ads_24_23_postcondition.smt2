...
(assert (= temp___228 a))
(assert (= temp___227 k))
(assert (= temp___226 l1))
(assert (= temp___225 a))
(assert (= temp___223 i))
(assert (= temp___218 a))
(assert (= temp___222 b))
(assert (and (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 2147483647)) (=> (< (* j l2) length1) (= (sorted (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* j l2)) (ite (< l2 (- length1 (* j l2))) l2 (- length1 (* j l2)))) true)))) (= (perm (mk___t temp___228 (mk (to_rep a__first) (to_rep a__last))) (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)) (<= 1 l2)))
(assert (and (and (=> (<= 0 2147483647) (in_range2 i1)) (=> (<= 0 2147483647) (in_range2 l2))) (=> (<= 0 2147483647) (in_range2 k1))))
(assert (and (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 2147483647)) (=> (< (* (* j l2) 2) length1) (= (sorted (mk___t (map__content a2) (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* (* j l2) 2)) (ite (< (* l2 2) (- length1 (* (* j l2) 2))) (* l2 2) (- length1 (* (* j l2) 2)))) true)))) (= (perm (mk___t temp___219 (mk (to_rep a__first) (to_rep a__last))) (mk___t (map__content a2) (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)) (<= 1 l2)))
