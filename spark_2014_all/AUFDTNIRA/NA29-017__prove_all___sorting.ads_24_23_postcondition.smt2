...
(assert (= l1 1))
(assert (and (and (= temp___219 a) (and (= temp___228 a) (and (= temp___227 k) (and (= temp___226 l1) (and (= temp___225 a) (and (= temp___223 i) (and (= temp___218 a) (and (= temp___222 b) (and (and (and (forall ((j4 Int)) (=> (and (<= 0 j4) (<= j4 2147483647)) (=> (< (* j4 l2) length1) (= (sorted (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* j4 l2)) (ite (< l2 (- length1 (* j4 l2))) l2 (- length1 (* j4 l2)))) true)))) (= (perm (mk___t temp___228 (mk (to_rep a__first) (to_rep a__last))) (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)) (<= 1 l2)) (and (and (and (=> (<= 0 2147483647) (in_range2 i1)) (=> (<= 0 2147483647) (in_range2 l2))) (=> (<= 0 2147483647) (in_range2 k1))) (and (and (and (forall ((j4 Int)) (=> (and (<= 0 j4) (<= j4 2147483647)) (=> (< (* (* j4 l2) 2) length1) (= (sorted (mk___t (map__content a10) (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* (* j4 l2) 2)) (ite (< (* l2 2) (- length1 (* (* j4 l2) 2))) (* l2 2) (- length1 (* (* j4 l2) 2)))) true)))) (= (perm (mk___t temp___219 (mk (to_rep a__first) (to_rep a__last))) (mk___t (map__content a10) (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)) (<= 1 l2)) (and (=> (<= 0 2147483647) (in_range2 l2)) (and (and (= l4 (mk_int__ref l2)) (= l5 l2)) (and (and (and (= o80 (- length1 l2)) (in_range1 (- length1 l2))) (= result9 (ite (<= o80 l2) true false))) (= result9 true))))))))))))))) (and (and (= k16 k10) (and (= l10 l4) (and (= i17 i11) (and (= b16 b10) (= a16 a10))))) (and (= k17 k11) (and (= l11 l5) (and (= i18 i12) (and (= b17 b11) (= a17 a11))))))))
(assert (= k18 k16))
(assert (= l12 l10))
(assert (= i19 i17))
(assert (= b18 b16))
...
(assert (= b21 b19))
(assert (= a21 a19))
(assert (not (= (sorted (mk___t (map__content a20) (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)))
(check-sat)
(exit)
