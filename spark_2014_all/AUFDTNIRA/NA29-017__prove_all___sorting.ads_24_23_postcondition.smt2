...
(declare-const temp___257 (Array Int integer))
...
(declare-const b5 map__ref)
(declare-const i6 int__ref)
(declare-const l7 int__ref)
...
(declare-const b7 map__ref)
(declare-const i8 int__ref)
(declare-const l9 int__ref)
...
(assert (= temp___257 a))
(assert (= temp___256 k))
(assert (= temp___255 l1))
(assert (= temp___254 a))
(assert (= temp___252 i))
(assert (= temp___247 a))
(assert (= temp___251 b))
(assert (and (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 2147483647)) (=> (< (* j l2) length1) (= (sorted (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* j l2)) (ite (< l2 (- length1 (* j l2))) l2 (- length1 (* j l2)))) true)))) (= (perm (mk___t temp___257 (mk (to_rep a__first) (to_rep a__last))) (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)) (<= 1 l2)))
(assert (and (and (=> (<= 0 2147483647) (in_range2 i1)) (=> (<= 0 2147483647) (in_range2 l2))) (=> (<= 0 2147483647) (in_range2 k1))))
(assert (and (and (forall ((j Int)) (=> (and (<= 0 j) (<= j 2147483647)) (=> (< (* (* j l2) 2) length1) (= (sorted (mk___t (map__content a2) (mk (to_rep a__first) (to_rep a__last))) (+ a_first (* (* j l2) 2)) (ite (< (* l2 2) (- length1 (* (* j l2) 2))) (* l2 2) (- length1 (* (* j l2) 2)))) true)))) (= (perm (mk___t temp___248 (mk (to_rep a__first) (to_rep a__last))) (mk___t (map__content a2) (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)) (<= 1 l2)))
(assert (=> (<= 0 2147483647) (in_range2 l2)))
(assert (= l3 (mk_int__ref l2)))
(assert (= l4 l2))
(assert (and (= o (- length1 l2)) (in_range1 (- length1 l2))))
(assert (= result1 (ite (<= o l2) true false)))
(assert (= result1 true))
(assert (= k4 k2))
(assert (= l5 l3))
(assert (= i4 i2))
...
(assert (= b8 b6))
(assert (= a9 a7))
(assert (not (= (sorted (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last))) a_first length1) true)))
(check-sat)
(exit)
