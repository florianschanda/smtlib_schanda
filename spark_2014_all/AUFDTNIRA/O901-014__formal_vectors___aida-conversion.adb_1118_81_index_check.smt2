...
(assert (= (= (length source) 3) true))
(assert (and (= temp___1876 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1876) (<= temp___1876 (to_rep1 (last (rt source))))))
(assert (= o6 temp___1876))
...
(assert (and (= temp___1875 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1875) (<= temp___1875 (to_rep1 (last (rt source))))))
(assert (= o temp___1875))
...
(assert (and (= temp___1874 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (not (<= (to_rep1 (first (rt source))) temp___1874)))
(check-sat)
(exit)
