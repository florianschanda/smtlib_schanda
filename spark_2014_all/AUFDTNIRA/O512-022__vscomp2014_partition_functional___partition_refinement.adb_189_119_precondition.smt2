...
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields3)) k))
(assert (<= k (to_rep1 (rec__partition_refinement__interval__last p_elem__split_fields3))))
(assert (and (<= 0 k) (<= k 5)))
(assert (= o14 k))
