...
(assert (<= (to_rep1 (rec__partition_refinement__interval__first p_elem__split_fields7)) k8))
(assert (<= k8 (to_rep1 (rec__partition_refinement__interval__last p_elem__split_fields7))))
(assert (and (<= 0 k8) (<= k8 5)))
(assert (= o90 k8))
(assert (= o91 (select (map__content f8) o90)))
(assert (= o92 (to_rep2 o91)))
(assert (not (<= 0 o92)))
(check-sat)
(exit)
