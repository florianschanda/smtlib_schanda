...
(assert (in_range1 i))
(assert (and (and (forall ((k Int)) (=> (and (<= (to_rep h_v1__first) k) (<= k (to_rep h_v1__last))) (ite (<= k (div1 (to_rep h_v1__last) 2)) (= (to_rep1 (select h_v11 k)) (to_rep1 (select h_v1 (+ k (div1 (to_rep h_v1__last) 2))))) (= (to_rep1 (select h_v11 k)) (to_rep1 (select h_v1 (- k (div1 (to_rep h_v1__last) 2)))))))) (forall ((k Int)) (=> (and (<= (to_rep h_v2__first) k) (<= k (to_rep h_v2__last))) (ite (<= k (div1 (to_rep h_v2__last) 2)) (= (to_rep1 (select h_v21 k)) (to_rep1 (select h_v2 (+ k (div1 (to_rep h_v2__last) 2))))) (= (to_rep1 (select h_v21 k)) (to_rep1 (select h_v2 (- k (div1 (to_rep h_v2__last) 2))))))))) (and (and (= h_v21 h_v22) (= h_v11 h_v12)) (and (= h_v23 h_v21) (= h_v13 h_v11)))))
...
(assert (not (= (to_rep1 (select h_v12 i)) (to_rep1 (select h_v22 i)))))
(check-sat)
(exit)
