...
(assert (in_range1 i))
(assert (forall ((k Int)) (=> (and (<= (to_rep h_v1__first) k) (<= k (to_rep h_v1__last))) (ite (<= k (div1 (to_rep h_v1__last) 2)) (= (to_rep1 (select h_v11 k)) (to_rep1 (select h_v1 (+ k (div1 (to_rep h_v1__last) 2))))) (= (to_rep1 (select h_v11 k)) (to_rep1 (select h_v1 (- k (div1 (to_rep h_v1__last) 2)))))))))
(assert (forall ((k Int)) (=> (and (<= (to_rep h_v2__first) k) (<= k (to_rep h_v2__last))) (ite (<= k (div1 (to_rep h_v2__last) 2)) (= (to_rep1 (select h_v21 k)) (to_rep1 (select h_v2 (+ k (div1 (to_rep h_v2__last) 2))))) (= (to_rep1 (select h_v21 k)) (to_rep1 (select h_v2 (- k (div1 (to_rep h_v2__last) 2)))))))))
(assert (= h_v21 h_v22))
(assert (= h_v11 h_v12))
(assert (= h_v23 h_v21))
(assert (= h_v13 h_v11))
