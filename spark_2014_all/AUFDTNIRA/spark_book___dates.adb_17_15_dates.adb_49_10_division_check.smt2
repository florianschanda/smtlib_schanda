...
(assert (forall ((temp___156 Int) (temp___157 Int) (temp___158 Int) (temp___159 Int) (temp___160 Int) (temp___161 Int) (temp___162 Int) (temp___163 Int) (temp___164 Int) (temp___165 Int) (temp___166 Int) (temp___167 Int)) (let ((temp___155 (dates__get_month_length__month_length__aggregate_def temp___156 temp___157 temp___158 temp___159 temp___160 temp___161 temp___162 temp___163 temp___164 temp___165 temp___166 temp___167))) (=> (and (and (and (and (and (and (and (and (and (and (and (dynamic_invariant2 temp___156 true true true true) (dynamic_invariant2 temp___157 true true true true)) (dynamic_invariant2 temp___158 true true true true)) (dynamic_invariant2 temp___159 true true true true)) (dynamic_invariant2 temp___160 true true true true)) (dynamic_invariant2 temp___161 true true true true)) (dynamic_invariant2 temp___162 true true true true)) (dynamic_invariant2 temp___163 true true true true)) (dynamic_invariant2 temp___164 true true true true)) (dynamic_invariant2 temp___165 true true true true)) (dynamic_invariant2 temp___166 true true true true)) (dynamic_invariant2 temp___167 true true true true)) (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select temp___155 1)) temp___156) (= (to_rep (select temp___155 2)) temp___157)) (= (to_rep (select temp___155 3)) temp___158)) (= (to_rep (select temp___155 4)) temp___159)) (= (to_rep (select temp___155 5)) temp___160)) (= (to_rep (select temp___155 6)) temp___161)) (= (to_rep (select temp___155 7)) temp___162)) (= (to_rep (select temp___155 8)) temp___163)) (= (to_rep (select temp___155 9)) temp___164)) (= (to_rep (select temp___155 10)) temp___165)) (= (to_rep (select temp___155 11)) temp___166)) (= (to_rep (select temp___155 12)) temp___167))))))
