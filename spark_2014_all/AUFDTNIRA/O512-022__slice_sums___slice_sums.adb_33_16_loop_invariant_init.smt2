...
(assert (<= (to_rep (rec__sums__slice_bounds__lo result____split_fields3)) (to_rep1 (rec__sums__slice_bounds__hi result____split_fields3))))
(assert (not (<= (to_rep3 (first (rt x))) (to_rep (rec__sums__slice_bounds__lo result____split_fields3)))))
(check-sat)
(exit)
