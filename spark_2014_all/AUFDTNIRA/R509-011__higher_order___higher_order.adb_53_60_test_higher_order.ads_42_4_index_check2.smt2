...
(declare-fun user_eq1 (small_int small_int) Bool)
(declare-const dummy1 small_int)
...
(assert (forall ((x small_int)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(declare-fun in_range4 (us_t Int Int) Bool)
...
(assert true)
(assert (forall ((a us_t)) (forall ((x Int) (c Int)) (! (= (= (in_range4 a x c) true) (and (<= (+ (- 2147483648) (* 100 (- (length a) c))) x) (<= x (- 2147483647 (* 100 (- (length a) c)))))) :pattern ((in_range4 a x c))))))
...
(declare-fun acc_f (us_t2 Int) us_t1)
(declare-fun acc_f__function_guard (us_t1 us_t2 Int) Bool)
...
(define-fun dynamic_invariant5 ((temp___expr_324 us_t1) (temp___is_init_320 Bool) (temp___skip_constant_321 Bool) (temp___do_toplevel_322 Bool) (temp___do_typ_inv_323 Bool)) Bool (=> (not (= temp___skip_constant_321 true)) (dynamic_property1 1 100 (first3 temp___expr_324) (last3 temp___expr_324))))
(assert (forall ((a us_t2)) (forall ((init Int)) (! (=> (and (and (dynamic_invariant3 a true true true true) (dynamic_invariant4 init true true true true)) (= (in_range4 (of_array (to_array2 a) (first5 a) (last5 a)) init 0) true)) (let ((result (acc_f a init))) (and (and (= (first3 result) (first5 a)) (and (= (last3 result) (last5 a)) (forall ((i Int)) (=> (and (<= (first5 a) i) (<= i (last5 a))) (and (= (in_range4 (of_array (to_array2 a) (first5 a) (last5 a)) (to_rep2 (select (to_array1 result) i)) (+ (- i (first5 a)) 1)) true) (= (to_rep2 (select (to_array1 result) i)) (+ (to_rep1 (select (to_array2 a) i)) (ite (= i (first5 a)) init (to_rep2 (select (to_array1 result) (- i 1))))))))))) (dynamic_invariant5 result true false true true)))) :pattern ((acc_f a init))))))
...
(define-fun dynamic_invariant6 ((temp___expr_275 Int) (temp___is_init_271 Bool) (temp___skip_constant_272 Bool) (temp___do_toplevel_273 Bool) (temp___do_typ_inv_274 Bool)) Bool (=> (or (= temp___is_init_271 true) (<= (- 100) 100)) (in_range2 temp___expr_275)))
(define-fun dynamic_invariant7 ((temp___expr_282 Int) (temp___is_init_278 Bool) (temp___skip_constant_279 Bool) (temp___do_toplevel_280 Bool) (temp___do_typ_inv_281 Bool)) Bool (=> (or (= temp___is_init_278 true) (<= 1 100)) (in_range3 temp___expr_282)))
(define-fun dynamic_invariant8 ((temp___expr_297 Int) (temp___is_init_293 Bool) (temp___skip_constant_294 Bool) (temp___do_toplevel_295 Bool) (temp___do_typ_inv_296 Bool)) Bool (=> (or (= temp___is_init_293 true) (<= 1 100)) (in_range6 temp___expr_297)))
(declare-const r Int)
(declare-const i Int)
(declare-const o Int)
(declare-const temp___405 (Array Int element_2))
(declare-const temp___4051 t1)
...
(define-fun temp___4052 () us_t1 (mk___t1 temp___405 temp___4051))
(assert (dynamic_invariant3 a true false true true))
(assert (in_range7 init))
(assert (= (in_range4 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) init 0) true))
(assert (= (mk_int__ref result) (mk_int__ref r)))
(assert (= r1 init))
(assert (in_range7 r1))
(assert (= (mk_int__ref result1) (mk_int__ref i)))
(assert (= i1 (to_rep (first4 (rt2 a)))))
(assert (<= (to_rep (first4 (rt2 a))) i1))
(assert (<= i1 (to_rep (last4 (rt2 a)))))
(assert (and (= o (+ (to_rep1 (select (elts2 a) i1)) r1)) (in_range1 (+ (to_rep1 (select (elts2 a) i1)) r1))))
(assert (= r1 result2))
(assert (= r2 o))
(assert (= r3 (to_rep2 (select (elts1 (acc_f a init)) i2))))
(assert (and (and (=> (<= (- 2147483648) 2147483647) (in_range7 r3)) (=> (<= (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))) (dynamic_property3 (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))) i2))) (and (<= (to_rep (first4 (rt2 a))) i2) (<= i2 (to_rep (last4 (rt2 a)))))))
(assert (and (= temp___4052 (acc_f a init)) (and (dynamic_invariant5 temp___4052 true false true true) (and (= (to_rep (first2 temp___4051)) (to_rep (first4 (rt2 a)))) (and (= (to_rep (last2 temp___4051)) (to_rep (last4 (rt2 a)))) (forall ((i3 Int)) (=> (and (<= (to_rep (first4 (rt2 a))) i3) (<= i3 (to_rep (last4 (rt2 a))))) (and (= (in_range4 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) (to_rep2 (select temp___405 i3)) (+ (- i3 (to_rep (first4 (rt2 a)))) 1)) true) (= (to_rep2 (select temp___405 i3)) (+ (to_rep1 (select (elts2 a) i3)) (ite (= i3 (to_rep (first4 (rt2 a)))) init (to_rep2 (select temp___405 (- i3 1))))))))))))))
(assert (not (<= (to_rep (first2 temp___4051)) i2)))
(check-sat)
(exit)
