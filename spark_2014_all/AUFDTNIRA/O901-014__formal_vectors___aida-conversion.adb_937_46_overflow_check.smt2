...
(assert (= o39 temp___1665))
(assert (= o40 (select n9 o39)))
(assert (= o41 (to_rep1 o40)))
(assert (= o42 (* o41 1000)))
(assert (and (= o43 o42) (in_range1 o42)))
(assert (= o44 (+ target3 o43)))
...
(assert (= o46 temp___1666))
(assert (= o47 (select n9 o46)))
(assert (= o48 (to_rep1 o47)))
(assert (= o49 (* o48 10000)))
