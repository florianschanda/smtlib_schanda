...
(assert (not (not (= (end_of_file (mk___rep (mk___split_fields file__split_fields7 file__split_fields8 file__split_fields9 file__split_fields10 file__split_fields11 file__split_fields12 file__split_fields13)) cur_position1 the_file) true))))
(check-sat)
(exit)
