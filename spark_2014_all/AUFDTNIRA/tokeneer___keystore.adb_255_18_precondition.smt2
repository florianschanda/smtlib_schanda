...
(assert (dynamic_predicate temp___1734))
(assert (= o13 temp___1734))
(assert (= o14 (convertretvaltotext (int__content retvalupd10) o13)))
(assert (= o15 (mk___t o14 (mk 1 150))))
(assert (not (= (to_rep1 (first (rt o15))) 1)))
(check-sat)
(exit)
