...
(assert (= k2 o9))
(assert (in_range4 k2))
(assert (and (= o10 (- (+ cur_position_at_start n) 2)) (in_range2 (- (+ cur_position_at_start n) 2))))
(assert (and (= result10 (no_char_in_slice eof_ch cur_position_at_start o10 the_file)) (= (= result10 true) (forall ((idx5 Int)) (=> (and (<= cur_position_at_start idx5) (<= idx5 o10)) (not (= (to_rep (select the_file idx5)) eof_ch)))))))
