...
(assert (=> (= (ite (= (is_prime value) false) (= mode 2) false) true) (and (forall ((v4 Int)) (=> (and (<= (ite (< 0 (+ (- value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1)) (+ (- value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1) 0) v4) (<= v4 value)) (not (= (is_prime v4) true)))) (forall ((v4 Int)) (=> (and (<= value v4) (<= v4 (ite (< 100000 (- (+ value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1)) 100000 (- (+ value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1)))) (not (= (is_prime v4) true)))))))
(assert (= result5 test_prime_and_coprime_numbers__p__nearest_prime_number__result4))
(assert (not (<= 0 test_prime_and_coprime_numbers__p__nearest_prime_number__result4)))
(check-sat)
(exit)
