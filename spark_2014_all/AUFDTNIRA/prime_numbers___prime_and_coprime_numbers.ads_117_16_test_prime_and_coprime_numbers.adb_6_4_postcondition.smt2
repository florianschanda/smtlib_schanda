...
(assert (=> (= (ite (= (is_prime value) false) (= mode 2) false) true) (and (forall ((v Int)) (=> (and (<= (ite (< 0 (+ (- value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1)) (+ (- value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1) 0) v) (<= v value)) (not (= (is_prime v) true)))) (forall ((v Int)) (=> (and (<= value v) (<= v (ite (< 100000 (- (+ value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1)) 100000 (- (+ value (abs (- value test_prime_and_coprime_numbers__p__nearest_prime_number__result4))) 1)))) (not (= (is_prime v) true)))))))
(assert (= result1 test_prime_and_coprime_numbers__p__nearest_prime_number__result4))
(assert (not (<= test_prime_and_coprime_numbers__p__nearest_prime_number__result4 100000)))
(check-sat)
(exit)
