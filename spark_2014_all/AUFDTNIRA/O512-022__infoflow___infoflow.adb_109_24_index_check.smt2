...
(assert (= t_v12 o2))
(assert (and (= temp___421 (+ q_v12 m_v11)) (in_range1 (+ q_v12 m_v11))))
(assert (and (<= (to_rep h_v1__first) temp___421) (<= temp___421 (to_rep h_v1__last))))
(assert (= o3 temp___421))
...
(assert (and (= temp___422 (+ q_v12 m_v11)) (in_range1 (+ q_v12 m_v11))))
(assert (not (<= (to_rep h_v1__first) temp___422)))
(check-sat)
(exit)
