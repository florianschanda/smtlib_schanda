...
(assert (= t_v12 o2))
(assert (and (= temp___423 (+ q_v12 m_v11)) (in_range1 (+ q_v12 m_v11))))
(assert (and (<= (to_rep h_v1__first) temp___423) (<= temp___423 (to_rep h_v1__last))))
(assert (= o3 temp___423))
...
(assert (and (= temp___424 (+ q_v12 m_v11)) (in_range1 (+ q_v12 m_v11))))
(assert (not (<= temp___424 (to_rep h_v1__last))))
(check-sat)
(exit)
