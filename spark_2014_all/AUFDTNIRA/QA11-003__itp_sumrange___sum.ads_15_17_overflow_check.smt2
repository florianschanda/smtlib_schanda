...
(define-fun in_range1 ((x Int)) Bool (and (<= 0 x) (<= x 300)))
...
(define-fun dynamic_invariant ((temp___expr_136 Int) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool (=> (or (= temp___is_init_133 true) (<= 0 300)) (in_range1 temp___expr_136)))
...
(assert (forall ((a1 (Array Int bounded_integer))) (forall ((i1 Int) (j1 Int)) (! (=> (and (dynamic_invariant i1 true true true) (dynamic_invariant j1 true true true)) (= (sum a1 i1 j1) (ite (<= j1 i1) 0 (+ (to_rep (select a1 i1)) (sum a1 (+ i1 1) j1))))) :pattern ((sum a1 i1 j1))))))
(define-fun dynamic_invariant2 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= (- 2000) 2000)) (in_range2 temp___expr_142)))
...
(assert (and (= o1 (sum a o j)) (and (in_range o1) (and (= o1 (ite (<= j o) 0 (+ (to_rep (select a o)) (sum a (+ o 1) j)))) (<= (abs o1) (* (- j o) 3000))))))
(assert (= o2 (+ (to_rep (select a i)) o1)))
