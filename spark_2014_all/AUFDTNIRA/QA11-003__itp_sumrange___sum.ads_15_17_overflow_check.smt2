...
(define-fun dynamic_invariant ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 300)) (in_range1 temp___expr_159)))
...
(assert (forall ((a1 (Array Int bounded_integer))) (forall ((i1 Int) (j1 Int)) (! (=> (and (dynamic_invariant i1 true true true true) (dynamic_invariant j1 true true true true)) (= (sum a1 i1 j1) (ite (<= j1 i1) 0 (+ (to_rep (select a1 i1)) (sum a1 (+ i1 1) j1))))) :pattern ((sum a1 i1 j1))))))
