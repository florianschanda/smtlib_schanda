...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (and (and (not (= (let ((subject shutdowncompleted)) shutdowncompleted2) true)) (not (= (let ((subject systemfault)) systemfault1) true))) (= (not (= (enrolmentisinprogress status3 (let ((subject state7)) state23)) true)) (= (privatekeypresent thistisinfo__split_fields2 (let ((subject state1)) state17)) true))) (=> (and (and (= (islocked currentlatch5 (let ((subject state3)) state30) latchtimeout__split_fields4) true) (= (thecurrentdoor (let ((subject state4)) state31)) 0)) (= (greaterthanorequal (thecurrenttime currenttimevar__split_fields (let ((subject currenttime)) currenttime1)) (alarm_timeout (let ((subject state4)) state31))) true)) (or (= (isalarming Tuple0) true) (= (let ((subject systemfault)) systemfault1) true)))) (or (= (= (islocked currentlatch5 (let ((subject state3)) state30) latchtimeout__split_fields4) true) (= (latchislocked Tuple0) true)) (= (let ((subject systemfault)) systemfault1) true))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) 1) (and (and (= (isgood tokenpresence3 (let ((subject state2)) state18) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) true) (= (authcertvalid tokenpresence3 (let ((subject state2)) state18) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) true)) (= (theauthcertrole tokenpresence3 (let ((subject state2)) state18) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) 1)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) 3)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) 1))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) 1) (or (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) 3)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true))))) (=> (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) 4)) (= (statusiswaitingstartadminop status3 (let ((subject state7)) state23)) true))) (=> (or (= (statusisgotadmintoken status3 (let ((subject state7)) state23)) true) (= (statusiswaitingremoveadmintokenfail status3 (let ((subject state7)) state23)) true)) (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true)))) (=> (or (= (statusiswaitingstartadminop status3 (let ((subject state7)) state23)) true) (= (statusiswaitingfinishadminop status3 (let ((subject state7)) state23)) true)) (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true) (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true)))) (=> (= (statusisenclavequiescent status3 (let ((subject state7)) state23)) true) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true)))) (=> (= (statusisshutdown status3 (let ((subject state7)) state23)) true) (and (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) 0)))) (=> (= (enrolmentisinprogress status3 (let ((subject state7)) state23)) true) (and (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields5))) true))))))
(assert (=> (<= 0 1) (in_range1 tokenpresence3)))
(assert (=> (<= 0 2) (in_range7 tokentry3)))
(assert (=> (<= 0 4294967295) (in_range6 tokenid3)))
(assert (=> (<= 0 1) (in_range26 currentlatch5)))
(assert (=> (<= 0 8) (in_range29 status3)))
(assert (not (= (enrolmentisinprogress status3 (let ((subject state7)) state23)) true)))
(assert (not (= (privatekeypresent thistisinfo__split_fields2 (let ((subject state1)) state17)) true)))
(check-sat)
(exit)
