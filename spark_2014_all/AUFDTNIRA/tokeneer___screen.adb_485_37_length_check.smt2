...
(define-fun dynamic_invariant ((temp___expr_464 Int) (temp___is_init_461 Bool) (temp___skip_constant_462 Bool) (temp___do_toplevel_463 Bool)) Bool (=> (or (= temp___is_init_461 true) (<= 0 4194304)) (in_range3 temp___expr_464)))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_356 us_t1) (temp___is_init_353 Bool) (temp___skip_constant_354 Bool) (temp___do_toplevel_355 Bool)) Bool (and (=> (not (= temp___skip_constant_354 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_356) (last3 temp___expr_356))) (=> (= temp___do_toplevel_355 true) (=> (= temp___is_init_353 true) (and (let ((temp___358 (of_array2 (to_array1 temp___expr_356) (first3 temp___expr_356) (last3 temp___expr_356)))) (and (= (first5 temp___358) 1) (<= 0 (last5 temp___358)))) (<= (last3 temp___expr_356) 1000))))))
(define-fun dynamic_predicate ((temp___360 us_t1)) Bool (and (let ((temp___362 (of_array2 (to_array1 temp___360) (first3 temp___360) (last3 temp___360)))) (and (= (first5 temp___362) 1) (<= 0 (last5 temp___362)))) (<= (last3 temp___360) 1000)))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true) (= (filesizet_image x) (let ((temp___470 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___470) (first1 temp___470) (last1 temp___470))))) :pattern ((filesizet_image x)))))
...
(declare-fun temp___String_Literal_1802 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1802 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1802 us_void_param) 2)) 107)) (= (to_rep (select (temp___String_Literal_1802 us_void_param) 3)) 66)) (= (to_rep (select (temp___String_Literal_1802 us_void_param) 4)) 121)) (= (to_rep (select (temp___String_Literal_1802 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1802 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_1802 us_void_param) 7)) 115)) :pattern ((temp___String_Literal_1802 us_void_param)))))
(declare-fun screen__writeconfigdata__filesizestring__result__aggregate_def (Int) (Array Int character))
(assert (forall ((temp___1807 Int)) (forall ((temp___1808 Int)) (= (select (screen__writeconfigdata__filesizestring__result__aggregate_def temp___1807) temp___1808) (of_rep temp___1807)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1656 Int) (temp___is_init_1653 Bool) (temp___skip_constant_1654 Bool) (temp___do_toplevel_1655 Bool)) Bool (=> (or (= temp___is_init_1653 true) (<= 1 15)) (in_range4 temp___expr_1656)))
...
(declare-const temp___1803 (Array Int character))
(declare-const temp___18031 t1)
(declare-const o Int)
...
(declare-const temp___1811 (Array Int character))
(declare-const temp___18111 t4)
(declare-const temp___1812 (Array Int character))
(declare-const temp___18121 t3)
(declare-const temp___1814 Int)
(declare-const o7 (Array Int character))
(declare-const temp___1815 (Array Int character))
(declare-const temp___18151 t3)
...
(assert (and (= (mk___t1 temp___1803 temp___18031) (filesizet_image (div1 value 1024))) (and (dynamic_invariant1 (mk___t1 temp___1803 temp___18031) true false true) (= (mk___t1 temp___1803 temp___18031) (let ((temp___468 (to_string (attr__ATTRIBUTE_IMAGE3 (div1 value 1024))))) (mk___t1 (elts temp___468) (mk1 (to_rep1 (first (rt temp___468))) (to_rep1 (last (rt temp___468))))))))))
(assert (=> (= (length1 (mk___t1 temp___1803 temp___18031)) 0) (= (temp___String_Literal_1802 Tuple0) screen__writeconfigdata__filesizestring__data__assume)))
(assert (=> (= (length1 (mk___t1 temp___1803 temp___18031)) 0) (= (mk 1 7) screen__writeconfigdata__filesizestring__data__assume1)))
(assert (=> (not (= (length1 (mk___t1 temp___1803 temp___18031)) 0)) (=> (<= 1 7) (= o (+ (- 7 1) 1)))))
(assert (=> (not (= (length1 (mk___t1 temp___1803 temp___18031)) 0)) (=> (not (<= 1 7)) (= o 0))))
(assert (=> (not (= (length1 (mk___t1 temp___1803 temp___18031)) 0)) (=> (<= (to_rep1 (first2 temp___18031)) (to_rep1 (last2 temp___18031))) (= o1 (+ (- (to_rep1 (last2 temp___18031)) (to_rep1 (first2 temp___18031))) 1)))))
(assert (=> (not (= (length1 (mk___t1 temp___1803 temp___18031)) 0)) (=> (not (<= (to_rep1 (first2 temp___18031)) (to_rep1 (last2 temp___18031)))) (= o1 0))))
(assert (=> (not (= (length1 (mk___t1 temp___1803 temp___18031)) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length1 (mk___t1 temp___1803 temp___18031)) 0)) (= o3 (+ (to_rep1 (first2 temp___18031)) o2))))
(assert (=> (not (= (length1 (mk___t1 temp___1803 temp___18031)) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length1 (mk___t1 temp___1803 temp___18031)) 0)) (and (= o5 o4) (in_range1 o4))))
(assert (=> (not (= (length1 (mk___t1 temp___1803 temp___18031)) 0)) (= (concat1 temp___1803 (to_rep1 (first2 temp___18031)) (to_rep1 (last2 temp___18031)) (temp___String_Literal_1802 Tuple0) 1 7) screen__writeconfigdata__filesizestring__data__assume)))
(assert (=> (not (= (length1 (mk___t1 temp___1803 temp___18031)) 0)) (= (mk (to_rep1 (first2 temp___18031)) o5) screen__writeconfigdata__filesizestring__data__assume1)))
(assert (= result data))
...
(assert (= o6 data1))
(assert (= o6 temp___1811))
(assert (= (mk4 2 (to_rep1 data__last)) temp___18111))
(assert (= (ite (<= (to_rep1 (first8 temp___18111)) (to_rep1 (last8 temp___18111))) (+ (- (to_rep1 (last8 temp___18111)) (to_rep1 (first8 temp___18111))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0)))
(assert (= (slide temp___1811 (to_rep1 (first8 temp___18111)) 1) temp___1812))
(assert (= (mk3 1 (- (to_rep1 data__last) 1)) temp___18121))
(assert (and (= temp___1814 (- (to_rep1 data__last) 1)) (in_range (- (to_rep1 data__last) 1))))
(assert (=> (<= 1 temp___1814) (and (and (<= 1 1) (<= 1 15)) (and (<= 1 temp___1814) (<= temp___1814 15)))))
(assert (= o7 result__1))
(assert (= o7 temp___1815))
(assert (= (mk3 1 temp___1814) temp___18151))
(assert (not (= (ite (<= (to_rep1 (first6 temp___18121)) (to_rep1 (last6 temp___18121))) (+ (- (to_rep1 (last6 temp___18121)) (to_rep1 (first6 temp___18121))) 1) 0) (ite (<= (to_rep1 (first6 temp___18151)) (to_rep1 (last6 temp___18151))) (+ (- (to_rep1 (last6 temp___18151)) (to_rep1 (first6 temp___18151))) 1) 0))))
(check-sat)
(exit)
