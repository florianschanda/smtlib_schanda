...
(define-fun dynamic_invariant ((temp___expr_514 Int) (temp___is_init_510 Bool) (temp___skip_constant_511 Bool) (temp___do_toplevel_512 Bool) (temp___do_typ_inv_513 Bool)) Bool (=> (or (= temp___is_init_510 true) (<= 0 4194304)) (in_range3 temp___expr_514)))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_396 us_t1) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool) (temp___do_typ_inv_395 Bool)) Bool (and (=> (not (= temp___skip_constant_393 true)) (dynamic_property1 1 2147483647 (first3 temp___expr_396) (last3 temp___expr_396))) (=> (= temp___do_toplevel_394 true) (=> (= temp___is_init_392 true) (and (let ((temp___398 (of_array2 (to_array1 temp___expr_396) (first3 temp___expr_396) (last3 temp___expr_396)))) (and (= (first5 temp___398) 1) (<= 0 (last5 temp___398)))) (<= (last3 temp___expr_396) 1000))))))
...
(assert (forall ((x Int)) (! (=> (dynamic_invariant x true true true true) (= (filesizet_image x) (let ((temp___520 (to_string (attr__ATTRIBUTE_IMAGE3 x)))) (of_array1 (to_array temp___520) (first1 temp___520) (last1 temp___520))))) :pattern ((filesizet_image x)))))
...
(declare-fun temp___String_Literal_1993 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1993 us_void_param) 1)) 32) (= (to_rep (select (temp___String_Literal_1993 us_void_param) 2)) 107)) (= (to_rep (select (temp___String_Literal_1993 us_void_param) 3)) 66)) (= (to_rep (select (temp___String_Literal_1993 us_void_param) 4)) 121)) (= (to_rep (select (temp___String_Literal_1993 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1993 us_void_param) 6)) 101)) (= (to_rep (select (temp___String_Literal_1993 us_void_param) 7)) 115)) :pattern ((temp___String_Literal_1993 us_void_param)))))
...
(define-fun dynamic_invariant6 ((temp___expr_1840 Int) (temp___is_init_1836 Bool) (temp___skip_constant_1837 Bool) (temp___do_toplevel_1838 Bool) (temp___do_typ_inv_1839 Bool)) Bool (=> (or (= temp___is_init_1836 true) (<= 1 15)) (in_range4 temp___expr_1840)))
(assert (forall ((temp___1998 Int)) (=> (dynamic_invariant3 temp___1998 true true true true) (forall ((temp___1999 Int)) (= (to_rep (select (screen__writeconfigdata__filesizestring__result__aggregate_def temp___1998) temp___1999)) temp___1998)))))
...
(declare-const temp___1994 (Array Int character))
(declare-const temp___19941 t1)
(declare-const o Int)
...
(declare-const screen__writeconfigdata__filesizestring__data__assume (Array Int character))
(declare-const screen__writeconfigdata__filesizestring__data__assume1 t)
(declare-const o6 (Array Int character))
(declare-const temp___2002 (Array Int character))
(declare-const temp___20021 t4)
(declare-const temp___2003 (Array Int character))
(declare-const temp___20031 t3)
(declare-const temp___2005 Int)
(declare-const o7 (Array Int character))
(declare-const temp___2006 (Array Int character))
(declare-const temp___20061 t3)
...
(define-fun temp___19942 () us_t1 (mk___t1 temp___1994 temp___19941))
(assert (in_range3 value))
(assert (and (= temp___19942 (filesizet_image (div1 value 1024))) (and (dynamic_invariant1 temp___19942 true false true true) (= temp___19942 (let ((temp___518 (to_string (attr__ATTRIBUTE_IMAGE3 (div1 value 1024))))) (mk___t1 (elts temp___518) (mk1 (to_rep1 (first (rt temp___518))) (to_rep1 (last (rt temp___518))))))))))
(assert (=> (= (length1 temp___19942) 0) (= (temp___String_Literal_1993 Tuple0) screen__writeconfigdata__filesizestring__data__assume)))
(assert (=> (= (length1 temp___19942) 0) (= (mk 1 7) screen__writeconfigdata__filesizestring__data__assume1)))
(assert (=> (not (= (length1 temp___19942) 0)) (=> (<= 1 7) (= o (+ (- 7 1) 1)))))
(assert (=> (not (= (length1 temp___19942) 0)) (=> (not (<= 1 7)) (= o 0))))
(assert (=> (not (= (length1 temp___19942) 0)) (=> (<= (to_rep1 (first2 temp___19941)) (to_rep1 (last2 temp___19941))) (= o1 (+ (- (to_rep1 (last2 temp___19941)) (to_rep1 (first2 temp___19941))) 1)))))
(assert (=> (not (= (length1 temp___19942) 0)) (=> (not (<= (to_rep1 (first2 temp___19941)) (to_rep1 (last2 temp___19941)))) (= o1 0))))
(assert (=> (not (= (length1 temp___19942) 0)) (= o2 (+ o1 o))))
(assert (=> (not (= (length1 temp___19942) 0)) (= o3 (+ (to_rep1 (first2 temp___19941)) o2))))
(assert (=> (not (= (length1 temp___19942) 0)) (= o4 (- o3 1))))
(assert (=> (not (= (length1 temp___19942) 0)) (and (= o5 o4) (in_range1 o4))))
(assert (=> (not (= (length1 temp___19942) 0)) (= (concat1 temp___1994 (to_rep1 (first2 temp___19941)) (to_rep1 (last2 temp___19941)) (temp___String_Literal_1993 Tuple0) 1 7) screen__writeconfigdata__filesizestring__data__assume)))
(assert (=> (not (= (length1 temp___19942) 0)) (= (mk (to_rep1 (first2 temp___19941)) o5) screen__writeconfigdata__filesizestring__data__assume1)))
(assert (= result data))
(assert (= data1 screen__writeconfigdata__filesizestring__data__assume))
(assert (= (to_rep1 data__first) (to_rep1 (first screen__writeconfigdata__filesizestring__data__assume1))))
(assert (= (to_rep1 data__last) (to_rep1 (last screen__writeconfigdata__filesizestring__data__assume1))))
(assert (dynamic_property 1 2147483647 (to_rep1 data__first) (to_rep1 data__last)))
(assert (= result1 result__))
(assert (= result__1 (screen__writeconfigdata__filesizestring__result__aggregate_def 32)))
(assert (<= (ite (<= (to_rep1 data__first) (to_rep1 data__last)) (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1) 0) 16))
(assert (=> (<= 2 (to_rep1 data__last)) (and (and (<= (to_rep1 data__first) 2) (<= 2 (to_rep1 data__last))) (and (<= (to_rep1 data__first) (to_rep1 data__last)) (<= (to_rep1 data__last) (to_rep1 data__last))))))
(assert (= o6 data1))
(assert (= o6 temp___2002))
(assert (= (mk4 2 (to_rep1 data__last)) temp___20021))
(assert (= (ite (<= (to_rep1 (first8 temp___20021)) (to_rep1 (last8 temp___20021))) (+ (- (to_rep1 (last8 temp___20021)) (to_rep1 (first8 temp___20021))) 1) 0) (ite (<= 1 (- (to_rep1 data__last) 1)) (+ (- (- (to_rep1 data__last) 1) 1) 1) 0)))
(assert (= (slide temp___2002 (to_rep1 (first8 temp___20021)) 1) temp___2003))
(assert (= (mk3 1 (- (to_rep1 data__last) 1)) temp___20031))
(assert (and (= temp___2005 (- (to_rep1 data__last) 1)) (in_range (- (to_rep1 data__last) 1))))
(assert (=> (<= 1 temp___2005) (and (and (<= 1 1) (<= 1 15)) (and (<= 1 temp___2005) (<= temp___2005 15)))))
(assert (= o7 result__1))
(assert (= o7 temp___2006))
(assert (= (mk3 1 temp___2005) temp___20061))
(assert (not (= (ite (<= (to_rep1 (first6 temp___20031)) (to_rep1 (last6 temp___20031))) (+ (- (to_rep1 (last6 temp___20031)) (to_rep1 (first6 temp___20031))) 1) 0) (ite (<= (to_rep1 (first6 temp___20061)) (to_rep1 (last6 temp___20061))) (+ (- (to_rep1 (last6 temp___20061)) (to_rep1 (first6 temp___20061))) 1) 0))))
(check-sat)
(exit)
