...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__aggregate_def 6 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 4) (+ (+ (to_rep1 (first (rt source))) 4) 6))))) (+ (to_rep1 (first (rt source))) 4)) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__aggregate_def 6 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 4) (+ (+ (to_rep1 (first (rt source))) 4) 6))))) (+ (+ (to_rep1 (first (rt source))) 4) 6)) (= (mk___t2 temp___2023 temp___20231) (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__aggregate_def 6 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 4) (+ (+ (to_rep1 (first (rt source))) 4) 6))))) (and (= (ite (<= (to_rep1 (first4 temp___20231)) (to_rep1 (last4 temp___20231))) (+ (- (to_rep1 (last4 temp___20231)) (to_rep1 (first4 temp___20231))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 4)) 1) 0)) (and (= (slide1 temp___2023 (to_rep1 (first4 temp___20231)) (+ (to_rep1 (first (rt source))) 4)) aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__assume) (= (mk1 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__int_array__assume1)))))) (and (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 4)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 4)) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)) (= (mk___t4 temp___2031 temp___20311) (aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10))))) (and (= (ite (<= (to_rep1 (first8 temp___20311)) (to_rep1 (last8 temp___20311))) (+ (- (to_rep1 (last8 temp___20311)) (to_rep1 (first8 temp___20311))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 4)) 1) 0)) (and (= (slide1 temp___2031 (to_rep1 (first8 temp___20311)) (+ (to_rep1 (first (rt source))) 4)) aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__assume) (= (mk3 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__assume1)))) (and (and (= (mk_map__ref1 result2) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_2_146_xxx_xxx__n__assume1)))))) (and (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 4)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))) (and (and (and (= temp___2037 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (= temp___2038 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))) (and (and (= (mk_int__ref result3) (mk_int__ref index)) (= index2 temp___2037)) (ite (and (<= temp___2037 index2) (<= index2 temp___2038)) (and (and (and (= temp___2036 index2) (and (= temp___2034 n1) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o21 index2)) (= o22 (select n1 o21))) (= o23 (to_rep1 o22))) (= o23 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o24 index2)) (= o25 (select (elts source) o24))) (= o26 (to_rep o25))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o26))) (ite (= (= o26 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o26 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o26 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o26 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o26 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o26 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o26 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o26 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o26 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o26 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o27) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o28 index2)) (= o29 (store n1 o28 o27)))) (and (= n1 result4) (= n2 o29))))) (and (and (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 4) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (forall ((temp___2035 Int)) (=> (and (<= (to_rep1 n__first) temp___2035) (<= temp___2035 (to_rep1 n__last))) (=> (< index3 temp___2035) (= (select n3 temp___2035) (select temp___2034 temp___2035))))) (=> (<= (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 4) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 4) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10)))) (= index3 temp___2038)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1))))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (and (and (= temp___2039 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))) (and (and (<= (to_rep1 n__first) temp___2039) (<= temp___2039 (to_rep1 n__last))) (= o57 temp___2039))) (= o58 (select (map__content1 n7) o57))) (= o59 (to_rep1 o58))) (= o60 (- o59))) (and (= o61 o60) (in_range1 o60))) (and (= result9 (mk_int__ref target)) (= target1 o61))) (and (<= (- 9) target1) (and (and (and (and (and (and (and (and (and (and (= temp___2040 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (<= (to_rep1 n__first) temp___2040) (<= temp___2040 (to_rep1 n__last))) (= o62 temp___2040))) (= o63 (select (map__content1 n7) o62))) (= o64 (to_rep1 o63))) (= o65 (* o64 10))) (and (= o66 o65) (in_range1 o65))) (= o67 (- target1 o66))) (and (= o68 o67) (in_range1 o67))) (and (= result10 (mk_int__ref target1)) (= target2 o68))) (and (<= (- 99) target2) (and (and (and (and (and (and (and (and (and (and (= temp___2041 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (<= (to_rep1 n__first) temp___2041) (<= temp___2041 (to_rep1 n__last))) (= o69 temp___2041))) (= o70 (select (map__content1 n7) o69))) (= o71 (to_rep1 o70))) (= o72 (* o71 100))) (and (= o73 o72) (in_range1 o72))) (= o74 (- target2 o73))) (and (= o75 o74) (in_range1 o74))) (and (= result11 (mk_int__ref target2)) (= target3 o75))) (and (<= (- 999) target3) (and (and (and (and (and (and (and (and (and (and (= temp___2042 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))) (and (and (<= (to_rep1 n__first) temp___2042) (<= temp___2042 (to_rep1 n__last))) (= o76 temp___2042))) (= o77 (select (map__content1 n7) o76))) (= o78 (to_rep1 o77))) (= o79 (* o78 1000))) (and (= o80 o79) (in_range1 o79))) (= o81 (- target3 o80))) (and (= o82 o81) (in_range1 o81))) (and (= result12 (mk_int__ref target3)) (= target4 o82))) (and (<= (- 9999) target4) (and (and (and (and (and (and (and (and (and (and (= temp___2043 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))) (and (and (<= (to_rep1 n__first) temp___2043) (<= temp___2043 (to_rep1 n__last))) (= o83 temp___2043))) (= o84 (select (map__content1 n7) o83))) (= o85 (to_rep1 o84))) (= o86 (* o85 10000))) (and (= o87 o86) (in_range1 o86))) (= o88 (- target4 o87))) (and (= o89 o88) (in_range1 o88))) (and (= result13 (mk_int__ref target4)) (= target5 o89))) (and (<= (- 99999) target5) (and (and (and (and (and (and (and (and (and (and (= temp___2044 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (<= (to_rep1 n__first) temp___2044) (<= temp___2044 (to_rep1 n__last))) (= o90 temp___2044))) (= o91 (select (map__content1 n7) o90))) (= o92 (to_rep1 o91))) (= o93 (* o92 100000))) (and (= o94 o93) (in_range1 o93))) (= o95 (- target5 o94))) (and (= o96 o95) (in_range1 o95))) (and (= result14 (mk_int__ref target5)) (= target6 o96))) (and (<= (- 999999) target6) (and (and (and (and (and (and (and (and (and (and (= temp___2045 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))) (and (and (<= (to_rep1 n__first) temp___2045) (<= temp___2045 (to_rep1 n__last))) (= o97 temp___2045))) (= o98 (select (map__content1 n7) o97))) (= o99 (to_rep1 o98))) (= o100 (* o99 1000000))) (and (= o101 o100) (in_range1 o100))) (= o102 (- target6 o101))) (and (= o103 o102) (in_range1 o102))) (and (= result15 (mk_int__ref target6)) (= target7 o103))) (and (<= (- 6999999) target7) (and (and (and (= o104 (- target7 2140000000)) (in_range1 (- target7 2140000000))) (and (= result16 (mk_int__ref target7)) (= target8 o104))) (and (<= (- 2146999999) target8) (and (= result17 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target9 (mk_int__ref target8)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target10 target8))))))))
