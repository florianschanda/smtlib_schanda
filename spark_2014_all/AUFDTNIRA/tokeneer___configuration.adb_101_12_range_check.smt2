...
(assert (not (= (length temp___1897) 0)))
(assert (=> (<= (to_rep1 (first4 (rt2 temp___1898))) (to_rep1 (last4 (rt2 temp___1898)))) (= o18 (+ (- (to_rep1 (last4 (rt2 temp___1898))) (to_rep1 (first4 (rt2 temp___1898)))) 1))))
(assert (=> (not (<= (to_rep1 (first4 (rt2 temp___1898))) (to_rep1 (last4 (rt2 temp___1898))))) (= o18 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1897))) (to_rep1 (last (rt temp___1897)))) (= o19 (+ (- (to_rep1 (last (rt temp___1897))) (to_rep1 (first (rt temp___1897)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1897))) (to_rep1 (last (rt temp___1897))))) (= o19 0)))
(assert (= o20 (+ o19 o18)))
(assert (= o21 (+ (to_rep1 (first (rt temp___1897))) o20)))
(assert (= o22 (- o21 1)))
