...
(assert (= result1 (mk_bool__ref authvalid)))
(assert (= authvalid1 (distinct 0 0)))
(assert (= result2 (mk_bool__ref idvalid)))
(assert (= idvalid1 (distinct 0 0)))
(assert (= result3 (mk_bool__ref roleok)))
(assert (= roleok1 (distinct 0 0)))
(assert (not (= (to_rep1 (first (mk 1 9))) 1)))
(check-sat)
(exit)
