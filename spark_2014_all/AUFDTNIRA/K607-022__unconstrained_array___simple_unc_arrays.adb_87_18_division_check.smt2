...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (= temp___878 sum1)))
...
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= 1 i1) (<= i1 r43b)) (= (mk_int__ref sum6) (mk_int__ref sum4))))
...
(assert (not (not (= (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))) 0))))
(check-sat)
(exit)
