...
(assert (and (= o5 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o5) (= o5 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
...
(assert (= o4 (* 2 o3)))
(assert (and (= o6 o4) (in_range11 o4)))
(assert (= result (ite (<= o6 o5) true false)))
(assert (= result true))
(assert (and (= o2 (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o2) (<= o2 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
