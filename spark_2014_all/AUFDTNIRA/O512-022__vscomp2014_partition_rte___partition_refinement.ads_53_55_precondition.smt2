...
(assert (and (= o7 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o7) (= o7 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
...
(assert (= result true))
(assert (and (= o4 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o4) (<= o4 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
