...
(define-fun dynamic_invariant3 ((temp___expr_332 Int) (temp___is_init_329 Bool) (temp___skip_constant_330 Bool) (temp___do_toplevel_331 Bool)) Bool (=> (or (= temp___is_init_329 true) (<= (- 2147483648) 2147483647)) (in_range5 temp___expr_332)))
...
(assert (and (and (= cur_position cur_position_at_start) (and (in_range2 cur_position_at_start) (and (and (forall ((idx1 Int)) (=> (and (<= 1 idx1) (<= idx1 num1)) (= (to_rep (select result__ idx1)) (to_rep (select the_file1 (+ (- idx1 1) cur_position_at_start)))))) (and (= cur_position1 (+ cur_position_at_start num1)) (or (= (to_rep (select the_file1 cur_position1)) eof_ch) (= (to_rep (select the_file1 cur_position1)) 10)))) (and (in_range4 num1) (in_range2 cur_position1))))) (and (and (= num1 num2) (and (= result__ result__1) (and (and (= file__split_fields14 file__split_fields7) (and (= file__split_fields15 file__split_fields8) (and (= file__split_fields16 file__split_fields9) (and (= file__split_fields17 file__split_fields10) (and (= file__split_fields18 file__split_fields11) (and (= file__split_fields19 file__split_fields12) (= file__split_fields20 file__split_fields13))))))) (and (= cur_position1 cur_position2) (= the_file1 the_file2))))) (and (= num3 num1) (and (= result__2 result__) (and (= (mk___split_fields file__split_fields21 file__split_fields22 file__split_fields23 file__split_fields24 file__split_fields25 file__split_fields26 file__split_fields27) (mk___split_fields file__split_fields7 file__split_fields8 file__split_fields9 file__split_fields10 file__split_fields11 file__split_fields12 file__split_fields13)) (and (= cur_position3 cur_position1) (= the_file3 the_file1))))))))
(assert (<= 1 idx))
(assert (<= idx num2))
