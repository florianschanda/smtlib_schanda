...
(declare-const c58b (Array Int character))
...
(declare-const temp___1252 us_t3)
(declare-const o37 (Array Int character))
(declare-const temp___1247 us_t)
...
(define-fun result__24 () map__ref (mk_map__ref result__1))
(define-fun c46b5 () map__ref (mk_map__ref c46b))
(define-fun result__25 () map__ref (mk_map__ref result__))
...
(assert (=> (= (select issystem retvalini1) true) (= result11 result__25)))
...
(assert (=> (not (= (select issystem retvalini1) true)) (= result__10 result__25)))
...
(assert (=> (= (select issystem (int__content retvalupd8)) true) (= result16 result__24)))
...
(assert (=> (not (= (select issystem (int__content retvalupd8)) true)) (= result__17 result__24)))
...
(assert (=> (= result22 true) (= (ite (<= (to_rep1 (first (rt thestring2))) (to_rep1 (last (rt thestring2)))) (+ (- (to_rep1 (last (rt thestring2))) (to_rep1 (first (rt thestring2)))) 1) 0) (ite (<= 1 (length thestring2)) (+ (- (length thestring2) 1) 1) 0))))
(assert (=> (= result22 true) (= temp___1248 (mk___t3 (slide (elts thestring2) (to_rep1 (first (rt thestring2))) 1) (mk3 1 (length thestring2))))))
(assert (=> (= result22 true) (and (= temp___1250 (length thestring2)) (in_range1 (length thestring2)))))
(assert (=> (= result22 true) (=> (<= 1 temp___1250) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1250) (<= temp___1250 150))))))
(assert (=> (= result22 true) (= o36 result__19)))
(assert (=> (= result22 true) (= temp___1251 (mk___t3 o36 (mk3 1 temp___1250)))))
(assert (=> (= result22 true) (= (ite (<= (to_rep1 (first6 (rt3 temp___1248))) (to_rep1 (last6 (rt3 temp___1248)))) (+ (- (to_rep1 (last6 (rt3 temp___1248))) (to_rep1 (first6 (rt3 temp___1248)))) 1) 0) (ite (<= (to_rep1 (first6 (rt3 temp___1251))) (to_rep1 (last6 (rt3 temp___1251)))) (+ (- (to_rep1 (last6 (rt3 temp___1251))) (to_rep1 (first6 (rt3 temp___1251)))) 1) 0))))
(assert (=> (= result22 true) (= temp___1252 temp___1248)))
(assert (=> (= result22 true) (forall ((temp___1253 Int)) (ite (and (<= 1 temp___1253) (<= temp___1253 (length thestring2))) (= (select o37 temp___1253) (select (elts3 temp___1252) temp___1253)) (= (select o37 temp___1253) (select result__19 temp___1253))))))
(assert (=> (= result22 true) (= result23 (mk_map__ref result__19))))
(assert (=> (= result22 true) (= result__20 o37)))
(assert (=> (= result22 true) (= result__22 (mk_map__ref result__20))))
(assert (=> (= result22 true) (= result__23 result__20)))
(assert (=> (not (= result22 true)) (=> (<= 1 150) (and (and (<= (to_rep1 (first (rt thestring2))) 1) (<= 1 (to_rep1 (last (rt thestring2))))) (and (<= (to_rep1 (first (rt thestring2))) 150) (<= 150 (to_rep1 (last (rt thestring2)))))))))
(assert (=> (not (= result22 true)) (= temp___1247 thestring2)))
(assert (=> (not (= result22 true)) (= o38 (elts temp___1247))))
(assert (=> (not (= result22 true)) (= result24 (mk_map__ref result__19))))
(assert (=> (not (= result22 true)) (= result__21 o38)))
(assert (=> (not (= result22 true)) (= result__22 (mk_map__ref result__21))))
(assert (=> (not (= result22 true)) (= result__23 result__21)))
(assert (= result25 (mk_map__ref c58b)))
(assert (= c58b1 (map__content result__22)))
(assert (not (= (valid_numberlogentries (us_private__content state6)) true)))
(check-sat)
(exit)
