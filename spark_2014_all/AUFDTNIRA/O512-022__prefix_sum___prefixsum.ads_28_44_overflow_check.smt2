...
(define-fun dynamic_invariant2 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 7)) (in_range2 temp___expr_159)))
(declare-const k Int)
(declare-const o Int)
...
(assert (<= k 7))
(assert (= (mod2 (+ k 1) 8) 0))
(assert (and (= o (+ (to_rep (select b 0)) (to_rep (select b 1)))) (in_range1 (+ (to_rep (select b 0)) (to_rep (select b 1))))))
(assert (= o1 (+ o (to_rep (select b 2)))))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (= o3 (+ o2 (to_rep (select b 3)))))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (= o5 (+ o4 (to_rep (select b 4)))))
(assert (and (= o6 o5) (in_range1 o5)))
(assert (= o7 (+ o6 (to_rep (select b 5)))))
(assert (and (= o8 o7) (in_range1 o7)))
(assert (= o9 (+ o8 (to_rep (select b 6)))))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (= o11 (+ o10 (to_rep (select b 7)))))
