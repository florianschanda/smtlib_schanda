...
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c31b)))))))
(assert (not (<= i1 (to_rep7 (rec__display__msglinet__len (us_split_fields5 (rec__display__msgstrt__top (us_split_fields7 c31b))))))))
(check-sat)
(exit)
