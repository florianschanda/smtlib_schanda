...
(define-fun tint_arrayD1__ref___2__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___2__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(define-fun tnumber_array_typeD1__ref___2__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___2__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(define-fun tint_arrayB__ref___2__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___1200 Int) (temp___1201 Int) (temp___1202 Int) (temp___1203 Int) (temp___1204 Int) (temp___1205 Int) (temp___1206 Int) (temp___1207 Int) (temp___1208 Int) (temp___1209 Int) (temp___1210 Int) (temp___1211 Int)) (let ((temp___1199 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__aggregate_def temp___1200 temp___1201 temp___1202 temp___1203 temp___1204 temp___1205 temp___1206 temp___1207 temp___1208 temp___1209 temp___1210 temp___1211))) (and (=> (dynamic_property10 (first1 source) (+ (first1 source) 9) temp___1210 temp___1211) (and (= (first5 temp___1199) temp___1210) (= (last5 temp___1199) temp___1211))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___1199) (+ (first1 source) 0)) (of_rep1 temp___1200)) (= (select (to_array2 temp___1199) (+ (first1 source) 1)) (of_rep1 temp___1201))) (= (select (to_array2 temp___1199) (+ (first1 source) 2)) (of_rep1 temp___1202))) (= (select (to_array2 temp___1199) (+ (first1 source) 3)) (of_rep1 temp___1203))) (= (select (to_array2 temp___1199) (+ (first1 source) 4)) (of_rep1 temp___1204))) (= (select (to_array2 temp___1199) (+ (first1 source) 5)) (of_rep1 temp___1205))) (= (select (to_array2 temp___1199) (+ (first1 source) 6)) (of_rep1 temp___1206))) (= (select (to_array2 temp___1199) (+ (first1 source) 7)) (of_rep1 temp___1207))) (= (select (to_array2 temp___1199) (+ (first1 source) 8)) (of_rep1 temp___1208))) (= (select (to_array2 temp___1199) (+ (first1 source) 9)) (of_rep1 temp___1209)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___2__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___1217 Int) (temp___1218 Int) (temp___1219 Int)) (let ((temp___1216 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__aggregate_def temp___1217 temp___1218 temp___1219))) (and (=> (dynamic_property11 (first1 source) (+ (first1 source) 9) temp___1218 temp___1219) (and (= (first9 temp___1216) temp___1218) (= (last9 temp___1216) temp___1219))) (forall ((temp___1220 Int)) (= (select (to_array4 temp___1216) temp___1220) (of_rep1 temp___1217)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_185 us_t3) (temp___is_init_182 Bool) (temp___skip_constant_183 Bool) (temp___do_toplevel_184 Bool)) Bool (=> (not (= temp___skip_constant_183 true)) (and (dynamic_property6 (first1 source) (+ (first1 source) 9) (first7 temp___expr_185) (last7 temp___expr_185)) (and (= (first7 temp___expr_185) (first1 source)) (= (last7 temp___expr_185) (+ (first1 source) 9))))))
...
(declare-const temp___1214 (Array Int integer))
(declare-const temp___12141 t2)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__assume1 t1)
(declare-const us Int)
(declare-const temp___1222 (Array Int integer))
(declare-const temp___12221 t4)
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__assume1 t3)
(declare-const us1 Int)
(declare-const temp___1229 Int)
(declare-const temp___1226 (Array Int integer))
...
(assert (and (and (= (length source) 10) (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 50) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 56)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 51)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 54)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 8))) 52))) (forall ((index11 Int)) (=> (and (<= (to_rep1 (first (rt source))) index11) (<= index11 (to_rep1 (last (rt source))))) (= (is_digit (to_rep (select (elts source) index11))) true)))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__aggregate_def 2 1 4 7 4 8 3 6 3 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__aggregate_def 2 1 4 7 4 8 3 6 3 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t2 temp___1214 temp___12141) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__aggregate_def 2 1 4 7 4 8 3 6 3 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___12141)) (to_rep1 (last4 temp___12141))) (+ (- (to_rep1 (last4 temp___12141)) (to_rep1 (first4 temp___12141))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1214 (to_rep1 (first4 temp___12141)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__assume))
(assert (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__int_array__assume1))))
...
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)))
(assert (= (mk___t4 temp___1222 temp___12221) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))
(assert (= (ite (<= (to_rep1 (first8 temp___12221)) (to_rep1 (last8 temp___12221))) (+ (- (to_rep1 (last8 temp___12221)) (to_rep1 (first8 temp___12221))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)))
(assert (= (slide1 temp___1222 (to_rep1 (first8 temp___12221)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__assume))
(assert (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_483_63x__n__assume1))))
...
(assert (and (= temp___1229 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index2 (to_rep1 (first (rt source)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= temp___1226 n1)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= temp___1224 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= o33 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= o34 (select n1 o33))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= o35 (to_rep1 o34))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= o35 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= o36 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= o37 (select (elts source) o36))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= o38 (to_rep o37))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o38))) (ite (= (= o38 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o38 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o38 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o38 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o38 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o38 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o38 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o38 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o38 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o38 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= (to_rep1 o39) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= o40 index2)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= o41 (store n1 o40 o39))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= n1 result3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= n2 o41)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3)) (forall ((temp___1227 Int)) (=> (and (<= (to_rep1 n__first) temp___1227) (<= temp___1227 (to_rep1 n__last))) (=> (< index3 temp___1227) (= (select n3 temp___1227) (select temp___1226 temp___1227)))))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9))))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= index3 temp___1229)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= index3 index5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= n3 n5)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= index6 index3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= n6 n3)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= index8 index6)))
(assert (=> (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229)) (= n8 n6)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229))) (= index8 index2)))
(assert (=> (not (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1229))) (= n8 n1)))
...
(assert (and (= temp___1230 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1230) (<= temp___1230 (to_rep1 n__last))))
(assert (= o65 temp___1230))
(assert (= o66 (select (map__content1 n7) o65)))
(assert (= o67 (to_rep1 o66)))
(assert (= result6 (mk_int__ref target)))
(assert (= target1 o67))
(assert (<= target1 9))
(assert (and (= temp___1231 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1231) (<= temp___1231 (to_rep1 n__last))))
(assert (= o68 temp___1231))
(assert (= o69 (select (map__content1 n7) o68)))
(assert (= o70 (to_rep1 o69)))
(assert (= o71 (* o70 10)))
(assert (and (= o72 o71) (in_range1 o71)))
(assert (= o73 (+ target1 o72)))
(assert (and (= o74 o73) (in_range1 o73)))
(assert (= result7 (mk_int__ref target1)))
(assert (= target2 o74))
(assert (not (<= target2 39)))
(check-sat)
(exit)
