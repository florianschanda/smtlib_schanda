...
(assert (= (= o6 true) (forall ((hi_index1 Int)) (=> (and (<= (to_rep3 (first (rt x))) hi_index1) (<= hi_index1 (- hi2 1))) (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo2) (of_rep1 hi_index1)))) max_sum3)))))
(assert (not (in_range1 (- lo2 1))))
(check-sat)
(exit)
