...
(assert (=> (< max_sum3 current_sum4) (= result11 (mk___split_fields__ref result____split_fields4))))
(assert (=> (< max_sum3 current_sum4) (= result____split_fields5 current_slice__split_fields5)))
(assert (=> (< max_sum3 current_sum4) (and (= o33 current_sum4) (in_range2 current_sum4))))
(assert (=> (< max_sum3 current_sum4) (= result12 (mk_int__ref max_sum3))))
(assert (=> (< max_sum3 current_sum4) (= max_sum4 o33)))
(assert (=> (not (< max_sum3 current_sum4)) (= result____split_fields5 result____split_fields4)))
(assert (=> (not (< max_sum3 current_sum4)) (= max_sum4 max_sum3)))
(assert (not (= hi5 (to_rep3 (last (rt x))))))
(assert (= result13 (mk_int__ref hi5)))
(assert (= hi6 (+ hi5 1)))
...
(assert (not (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index2) (of_rep1 hi_index3)))) max_sum4)))
(check-sat)
(exit)
