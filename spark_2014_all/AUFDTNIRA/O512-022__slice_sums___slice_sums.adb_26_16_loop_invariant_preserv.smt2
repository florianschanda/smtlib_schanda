...
(assert (=> (< max_sum3 current_sum3) (and (= o9 current_sum3) (in_range2 current_sum3))))
...
(assert (not (<= (sum__logic x (mk_slice_bounds (mk___split_fields (of_rep lo_index) (of_rep1 hi_index)))) max_sum4)))
(check-sat)
(exit)
