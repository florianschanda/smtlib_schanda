...
(assert (<= k i2))
(assert (and (= o14 (- k (to_rep (first4 (rt2 a))))) (in_range1 (- k (to_rep (first4 (rt2 a)))))))
(assert (and (= o15 o14) (in_range2 o14)))
(assert (= o16 (+ o15 1)))
(assert (and (= o17 o16) (in_range1 o16)))
(assert (and (<= (to_rep r__first) k) (<= k (to_rep r__last))))
(assert (= o11 k))
(assert (= o12 (select r2 o11)))
(assert (= o13 (to_rep2 o12)))
(assert (and (= result3 (in_range5 (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a))))) o13 o17)) (= (= result3 true) (and (<= (+ (- 2147483648) (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o17))) o13) (<= o13 (- 2147483647 (* 100 (- (length (mk___t (elts2 a) (mk (to_rep (first4 (rt2 a))) (to_rep (last4 (rt2 a)))))) o17))))))))
(assert (= result3 true))
