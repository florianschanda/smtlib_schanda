...
(assert (<= left1 right1))
(assert (and (forall ((index1 Int)) (=> (and (<= 1 index1) (<= index1 (- left2 1))) (< (to_rep (select a index1)) i))) (forall ((index1 Int)) (=> (and (<= (+ right2 1) index1) (<= index1 10)) (< i (to_rep (select a index1)))))))
(assert (and (and (and (=> (<= 1 10) (in_range2 left2)) (=> (<= 1 10) (in_range2 right2))) (=> (<= 1 10) (in_range2 med1))) (<= left2 right2)))
(assert (<= 1 index))
(assert (<= index (- left2 1)))
(assert (not (<= 1 index)))
(check-sat)
(exit)
