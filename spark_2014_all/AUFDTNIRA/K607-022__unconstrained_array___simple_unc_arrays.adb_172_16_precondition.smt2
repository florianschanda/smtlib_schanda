...
(assert (and (and (and (dynamic_invariant2 (mk___rep a__split_discrs a__split_fields10) true true true) (= (rec__simple_unc_arrays__table__last a__split_discrs) temp___981)) (=> (<= 0 2147483647) (in_range2 right2))) (=> (<= 0 2147483647) (in_range2 left2))))
