...
(define-fun a__split_fields10 () us_split_fields (mk___split_fields (mk___t1 a__split_fields2 a__split_fields3)))
...
(assert (and (and (and (dynamic_invariant2 (mk___rep a__split_discrs a__split_fields10) true true true true) (= (rec__simple_unc_arrays__table__last a__split_discrs) temp___1060)) (=> (<= 0 2147483647) (in_range2 right2))) (=> (<= 0 2147483647) (in_range2 left2))))
