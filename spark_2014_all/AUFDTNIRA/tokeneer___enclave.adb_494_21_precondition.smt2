...
(define-fun dynamic_invariant ((temp___expr_218 Int) (temp___is_init_215 Bool) (temp___skip_constant_216 Bool) (temp___do_toplevel_217 Bool)) Bool (=> (or (= temp___is_init_215 true) (<= 0 1)) (in_range4 temp___expr_218)))
...
(define-fun dynamic_invariant1 ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 0 3)) (in_range5 temp___expr_383)))
...
(define-fun dynamic_invariant2 ((temp___expr_451 Int) (temp___is_init_448 Bool) (temp___skip_constant_449 Bool) (temp___do_toplevel_450 Bool)) Bool (=> (or (= temp___is_init_448 true) (<= 1 4)) (in_range7 temp___expr_451)))
...
(assert true)
(assert (forall ((theadmin us_rep)) (! (= (= (ispresent theadmin) true) (in_range8 (to_rep2 (rec__admin__t__rolepresent (us_split_fields1 theadmin))))) :pattern ((ispresent theadmin)))))
...
(define-fun dynamic_invariant3 ((temp___expr_492 Int) (temp___is_init_489 Bool) (temp___skip_constant_490 Bool) (temp___do_toplevel_491 Bool)) Bool (=> (or (= temp___is_init_489 true) (<= 0 1)) (in_range9 temp___expr_492)))
...
(assert (forall ((temp___157 Int)) (forall ((temp___158 Int)) (= (select (audittypes__nodescription__aggregate_def temp___157) temp___158) (of_rep temp___157)))))
...
(assert (forall ((x yearst)) (! (in_range11 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x monthst)) (! (in_range12 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x dayst)) (! (in_range13 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(assert (forall ((x millisecst)) (! (in_range14 (to_rep7 x)) :pattern ((to_rep7 x)))))
...
(assert (forall ((x logfileindext)) (! (in_range15 (to_rep8 x)) :pattern ((to_rep8 x)))))
...
(assert (forall ((x logentrycountt)) (! (in_range16 (to_rep9 x)) :pattern ((to_rep9 x)))))
...
(define-fun bool_eq4 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep8 (select a temp___idx_173)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_173))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep8 (select a temp___idx_173)) (to_rep8 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(assert (forall ((x logfilecountt)) (! (in_range17 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(assert (forall ((x fileentrycountt)) (! (in_range18 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(define-fun bool_eq6 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (to_rep11 (select a temp___idx_174)) (to_rep11 (select b (+ (- b__first a__first) temp___idx_174))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (to_rep11 (select a temp___idx_174)) (to_rep11 (select b (+ (- b__first a__first) temp___idx_174)))))))))))
...
(assert (forall ((temp___1205 Int)) (forall ((temp___1206 Int)) (= (select (temp___1203 temp___1205) temp___1206) (of_rep8 temp___1205)))))
(declare-fun temp___1207 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1209 Int)) (forall ((temp___1210 Int)) (= (select (temp___1207 temp___1209) temp___1210) (of_rep11 temp___1209)))))
(define-fun dynamic_invariant4 ((temp___expr_1197 us_rep3) (temp___is_init_1194 Bool) (temp___skip_constant_1195 Bool) (temp___do_toplevel_1196 Bool)) Bool (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1197))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1197))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1197)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1197))) true))
(define-fun default_initial_assumption ((temp___expr_1201 us_rep3) (temp___skip_top_level_1202 Bool)) Bool (and (and (and (= (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1201))) 1) (= (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1201))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1201)) (mk___rep2 (mk___split_fields2 (temp___1203 1) (of_rep8 1) (of_rep8 1) (of_rep10 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1201)) (temp___1207 0))))
(define-fun type_invariant ((temp___1211 us_rep3)) Bool (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1211))) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1211))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1211)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1211))) true))
...
(assert (forall ((x filestatust)) (! (in_range19 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun bool_eq10 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep12 (select a temp___idx_176)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_176))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq10 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep12 (select a temp___idx_176)) (to_rep12 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
...
(declare-fun user_eq27 (tokenidt tokenidt) Bool)
(declare-const dummy27 tokenidt)
...
(define-fun dynamic_invariant5 ((temp___expr_1363 Int) (temp___is_init_1360 Bool) (temp___skip_constant_1361 Bool) (temp___do_toplevel_1362 Bool)) Bool (=> (or (= temp___is_init_1360 true) (<= 0 4294967295)) (in_range20 temp___expr_1363)))
(declare-sort tryt 0)
(define-fun in_range21 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
...
(declare-fun user_eq28 (tryt tryt) Bool)
(declare-const dummy28 tryt)
...
(define-fun dynamic_invariant6 ((temp___expr_1369 Int) (temp___is_init_1366 Bool) (temp___skip_constant_1367 Bool) (temp___do_toplevel_1368 Bool)) Bool (=> (or (= temp___is_init_1366 true) (<= 0 2)) (in_range21 temp___expr_1369)))
(declare-sort namecountt 0)
(define-fun in_range22 ((x Int)) Bool (and (<= 0 x) (<= x 40)))
...
(assert (forall ((x namecountt)) (! (in_range22 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(assert (forall ((x issueridt)) (! (in_range23 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(declare-fun user_eq32 (us_rep5 us_rep5) Bool)
(declare-const dummy32 us_rep5)
...
(define-fun bool_eq12 ((a us_rep6) (b us_rep6)) Bool (ite (and (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields11 a)) (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields11 b))) (= (bool_eq11 (rec__keystore__optionalprivatekeyt__owner (us_split_fields11 a)) (rec__keystore__optionalprivatekeyt__owner (us_split_fields11 b))) true)) true false))
...
(declare-fun user_eq34 (classt classt) Bool)
(declare-const dummy34 classt)
...
(declare-fun to_rep15 (classt) Int)
(declare-fun of_rep15 (Int) classt)
(assert (forall ((x classt)) (! (= (of_rep15 (to_rep15 x)) x) :pattern ((to_rep15 x)))))
(assert (forall ((x classt)) (! (in_range24 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(define-fun bool_eq13 ((a us_rep7) (b us_rep7)) Bool (ite (= (to_rep15 (rec__privtypes__clearancet__class (us_split_fields13 a))) (to_rep15 (rec__privtypes__clearancet__class (us_split_fields13 b)))) true false))
...
(define-fun in_range25 ((x Int)) Bool (and (<= 0 x) (<= x 10)))
...
(declare-fun user_eq36 (algorithmt algorithmt) Bool)
(declare-const dummy36 algorithmt)
...
(assert (forall ((x algorithmt)) (! (in_range25 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(declare-fun user_eq37 (serialnumbert serialnumbert) Bool)
(declare-const dummy37 serialnumbert)
...
(assert (forall ((x serialnumbert)) (! (in_range26 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(define-fun bool_eq14 ((a us_rep8) (b us_rep8)) Bool (ite (and (= (bool_eq11 (rec__certtypes__idt__issuer (us_split_fields15 a)) (rec__certtypes__idt__issuer (us_split_fields15 b))) true) (= (to_rep17 (rec__certtypes__idt__serialnumber (us_split_fields15 a))) (to_rep17 (rec__certtypes__idt__serialnumber (us_split_fields15 b))))) true false))
...
(define-fun bool_eq15 ((a us_rep9) (b us_rep9)) Bool (ite (and (and (and (and (and (and (= (bool_eq14 (rec__cert__attr__auth__contentst__id (us_split_fields17 a)) (rec__cert__attr__auth__contentst__id (us_split_fields17 b))) true) (= (bool_eq3 (rec__cert__attr__auth__contentst__notbefore (us_split_fields17 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields17 b))) true)) (= (bool_eq3 (rec__cert__attr__auth__contentst__notafter (us_split_fields17 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields17 b))) true)) (= (to_rep16 (rec__cert__attr__auth__contentst__mechanism (us_split_fields17 a))) (to_rep16 (rec__cert__attr__auth__contentst__mechanism (us_split_fields17 b))))) (= (bool_eq14 (rec__cert__attr__auth__contentst__basecertid (us_split_fields17 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields17 b))) true)) (= (to_rep2 (rec__cert__attr__auth__contentst__role (us_split_fields17 a))) (to_rep2 (rec__cert__attr__auth__contentst__role (us_split_fields17 b))))) (= (bool_eq13 (rec__cert__attr__auth__contentst__clearance (us_split_fields17 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields17 b))) true)) true false))
...
(declare-fun user_eq41 (keyidt keyidt) Bool)
(declare-const dummy41 keyidt)
...
(assert (forall ((x keyidt)) (! (in_range27 (to_rep18 x)) :pattern ((to_rep18 x)))))
(assert (forall ((x Int)) (! (=> (in_range27 x) (= (to_rep18 (of_rep18 x)) x)) :pattern ((to_rep18 (of_rep18 x))))))
(declare-sort keylengtht 0)
(define-fun in_range28 ((x Int)) Bool (and (<= 0 x) (<= x 128)))
...
(declare-fun user_eq42 (keylengtht keylengtht) Bool)
(declare-const dummy42 keylengtht)
...
(assert (forall ((x keylengtht)) (! (in_range28 (to_rep19 x)) :pattern ((to_rep19 x)))))
...
(define-fun bool_eq17 ((a us_rep11) (b us_rep11)) Bool (ite (and (and (= (to_rep16 (rec__cryptotypes__keypartt__algorithmid (us_split_fields21 a))) (to_rep16 (rec__cryptotypes__keypartt__algorithmid (us_split_fields21 b)))) (= (to_rep18 (rec__cryptotypes__keypartt__keyid (us_split_fields21 a))) (to_rep18 (rec__cryptotypes__keypartt__keyid (us_split_fields21 b))))) (= (to_rep19 (rec__cryptotypes__keypartt__keylength (us_split_fields21 a))) (to_rep19 (rec__cryptotypes__keypartt__keylength (us_split_fields21 b))))) true false))
...
(declare-const dummy43 us_rep11)
...
(define-fun bool_eq18 ((a us_rep12) (b us_rep12)) Bool (ite (and (and (and (and (and (= (bool_eq14 (rec__cert__id__contentst__id (us_split_fields23 a)) (rec__cert__id__contentst__id (us_split_fields23 b))) true) (= (bool_eq3 (rec__cert__id__contentst__notbefore (us_split_fields23 a)) (rec__cert__id__contentst__notbefore (us_split_fields23 b))) true)) (= (bool_eq3 (rec__cert__id__contentst__notafter (us_split_fields23 a)) (rec__cert__id__contentst__notafter (us_split_fields23 b))) true)) (= (to_rep16 (rec__cert__id__contentst__mechanism (us_split_fields23 a))) (to_rep16 (rec__cert__id__contentst__mechanism (us_split_fields23 b))))) (= (bool_eq11 (rec__cert__id__contentst__subject (us_split_fields23 a)) (rec__cert__id__contentst__subject (us_split_fields23 b))) true)) (= (bool_eq17 (rec__cert__id__contentst__subjectpublickey (us_split_fields23 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields23 b))) true)) true false))
...
(declare-fun user_eq44 (us_rep12 us_rep12) Bool)
(declare-const dummy44 us_rep12)
...
(assert true)
(define-fun dynamic_invariant7 ((temp___expr_389 Int) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (or (= temp___is_init_386 true) (<= 1 3)) (in_range8 temp___expr_389)))
(declare-fun getrole (Int us_private Int Int us_split_fields18 us_split_fields24) Int)
(declare-fun getrole__function_guard (Int Int us_private Int Int us_split_fields18 us_split_fields24) Bool)
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields18)) (forall ((admintoken__idcert__fields us_split_fields24)) (! (=> (and (and (and (dynamic_invariant admintoken__tokenpresence true true true) (dynamic_invariant6 admintoken__tokentry true true true)) (dynamic_invariant5 admintoken__tokenid true true true)) (and (= (isgood admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (and (= (authcertvalid admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true) (in_range8 (theauthcertrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))) (dynamic_invariant7 (getrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) true false true)) :pattern ((getrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
(assert (forall ((admintoken__tokenpresence Int) (admintoken__tokentry Int) (admintoken__tokenid Int)) (forall ((admintoken__state us_private)) (forall ((admintoken__authcert__fields us_split_fields18)) (forall ((admintoken__idcert__fields us_split_fields24)) (! (=> (and (and (dynamic_invariant admintoken__tokenpresence true true true) (dynamic_invariant6 admintoken__tokentry true true true)) (dynamic_invariant5 admintoken__tokenid true true true)) (= (getrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields) (therole (rec__admintoken__validauthcertt__contents (us_split_fields19 (mk___rep9 admintoken__authcert__fields)))))) :pattern ((getrole admintoken__tokenpresence admintoken__state admintoken__tokentry admintoken__tokenid admintoken__authcert__fields admintoken__idcert__fields))))))))
...
(define-fun dynamic_invariant8 ((temp___expr_2670 Int) (temp___is_init_2667 Bool) (temp___skip_constant_2668 Bool) (temp___do_toplevel_2669 Bool)) Bool (=> (or (= temp___is_init_2667 true) (<= 0 8)) (in_range29 temp___expr_2670)))
...
(define-fun dynamic_invariant13 ((temp___expr_445 Int) (temp___is_init_442 Bool) (temp___skip_constant_443 Bool) (temp___do_toplevel_444 Bool)) Bool (=> (or (= temp___is_init_442 true) (<= 0 4)) (in_range6 temp___expr_445)))
(define-fun dynamic_invariant14 ((temp___expr_395 Int) (temp___is_init_392 Bool) (temp___skip_constant_393 Bool) (temp___do_toplevel_394 Bool)) Bool (=> (or (= temp___is_init_392 true) (<= 0 5)) (in_range24 temp___expr_395)))
(define-fun dynamic_invariant15 ((temp___expr_978 Int) (temp___is_init_975 Bool) (temp___skip_constant_976 Bool) (temp___do_toplevel_977 Bool)) Bool (=> (or (= temp___is_init_975 true) (<= 0 40)) (in_range22 temp___expr_978)))
(define-fun dynamic_invariant16 ((temp___expr_999 Int) (temp___is_init_996 Bool) (temp___skip_constant_997 Bool) (temp___do_toplevel_998 Bool)) Bool (=> (or (= temp___is_init_996 true) (<= 0 4294967295)) (in_range23 temp___expr_999)))
(define-fun dynamic_invariant17 ((temp___expr_1021 Int) (temp___is_init_1018 Bool) (temp___skip_constant_1019 Bool) (temp___do_toplevel_1020 Bool)) Bool (=> (or (= temp___is_init_1018 true) (<= 0 10)) (in_range25 temp___expr_1021)))
(define-fun dynamic_invariant18 ((temp___expr_1033 Int) (temp___is_init_1030 Bool) (temp___skip_constant_1031 Bool) (temp___do_toplevel_1032 Bool)) Bool (=> (or (= temp___is_init_1030 true) (<= 0 4294967295)) (in_range27 temp___expr_1033)))
(define-fun dynamic_invariant19 ((temp___expr_1039 Int) (temp___is_init_1036 Bool) (temp___skip_constant_1037 Bool) (temp___do_toplevel_1038 Bool)) Bool (=> (or (= temp___is_init_1036 true) (<= 0 128)) (in_range28 temp___expr_1039)))
(define-fun dynamic_invariant20 ((temp___expr_1163 Int) (temp___is_init_1160 Bool) (temp___skip_constant_1161 Bool) (temp___do_toplevel_1162 Bool)) Bool (=> (or (= temp___is_init_1160 true) (<= 0 17)) (in_range17 temp___expr_1163)))
(define-fun dynamic_invariant21 ((temp___expr_1142 Int) (temp___is_init_1139 Bool) (temp___skip_constant_1140 Bool) (temp___do_toplevel_1141 Bool)) Bool (=> (or (= temp___is_init_1139 true) (<= 1 17)) (in_range15 temp___expr_1142)))
(define-fun dynamic_invariant22 ((temp___expr_1267 Int) (temp___is_init_1264 Bool) (temp___skip_constant_1265 Bool) (temp___do_toplevel_1266 Bool)) Bool (=> (or (= temp___is_init_1264 true) (<= 0 2)) (in_range19 temp___expr_1267)))
(define-fun dynamic_invariant23 ((temp___expr_1148 Int) (temp___is_init_1145 Bool) (temp___skip_constant_1146 Bool) (temp___do_toplevel_1147 Bool)) Bool (=> (or (= temp___is_init_1145 true) (<= 0 17408)) (in_range16 temp___expr_1148)))
(define-fun dynamic_invariant24 ((temp___expr_1182 Int) (temp___is_init_1179 Bool) (temp___skip_constant_1180 Bool) (temp___do_toplevel_1181 Bool)) Bool (=> (or (= temp___is_init_1179 true) (<= 0 1024)) (in_range18 temp___expr_1182)))
(assert true)
...
(define-fun dynamic_invariant25 ((temp___expr_514 Int) (temp___is_init_511 Bool) (temp___skip_constant_512 Bool) (temp___do_toplevel_513 Bool)) Bool (=> (or (= temp___is_init_511 true) (<= 1 150)) (in_range10 temp___expr_514)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(define-fun dynamic_invariant26 ((temp___expr_560 Int) (temp___is_init_557 Bool) (temp___skip_constant_558 Bool) (temp___do_toplevel_559 Bool)) Bool (=> (or (= temp___is_init_557 true) (<= 1901 2099)) (in_range11 temp___expr_560)))
(define-fun dynamic_invariant27 ((temp___expr_566 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 1 12)) (in_range12 temp___expr_566)))
(define-fun dynamic_invariant28 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 1 31)) (in_range13 temp___expr_572)))
(define-fun dynamic_invariant29 ((temp___expr_600 Int) (temp___is_init_597 Bool) (temp___skip_constant_598 Bool) (temp___do_toplevel_599 Bool)) Bool (=> (or (= temp___is_init_597 true) (<= 0 86399999)) (in_range14 temp___expr_600)))
(define-fun dynamic_invariant30 ((temp___expr_1433 Int) (temp___is_init_1430 Bool) (temp___skip_constant_1431 Bool) (temp___do_toplevel_1432 Bool)) Bool (=> (or (= temp___is_init_1430 true) (<= 0 4294967295)) (in_range26 temp___expr_1433)))
(assert (forall ((contents us_rep9)) (! (dynamic_invariant1 (therole contents) true false true) :pattern ((therole contents)))))
(assert (forall ((contents us_rep9)) (! (= (therole contents) (to_rep2 (rec__cert__attr__auth__contentst__role (us_split_fields17 contents)))) :pattern ((therole contents)))))
...
(declare-const description map__ref)
...
(declare-const status7 int__ref)
...
(declare-const status8 us_private__ref)
...
(declare-const status10 us_private)
...
(assert (and (and (and (and (not (= (ispresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true))) (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (and (and (= (isgood tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) true) (= (authcertvalid tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) true)) (= (theauthcertrole tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields)) 1)))) (=> (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)) (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1))) (=> (= (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 1) (or (and (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true) (= (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) 3)) (not (= (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1))) true))))))
(assert (= o7 (ispresent1 tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields))))
(assert (= result3 (ite (not (= o7 true)) true false)))
(assert (not (= result3 true)))
(assert (and (= (= tokenok2 true) (and (and (= (isgood tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true) (= (authcertvalid tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true)) (in_range8 (theauthcertrole tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2))))) (and (and (and (and (in_range9 auditalarm2) (in_range21 tokentry2)) (in_range20 tokenid2)) (in_range4 tokenpresence2)) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true))))
(assert (= o8 (extractuser tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2))))
(assert (and (in_range9 auditalarm3) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true)))
(assert (= tokenok2 true))
(assert (= o9 (extractuser tokenpresence2 (let ((subject state1)) state6) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2))))
