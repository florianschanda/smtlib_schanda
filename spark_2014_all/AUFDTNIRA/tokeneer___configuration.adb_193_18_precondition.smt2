...
(define-fun dynamic_invariant ((temp___expr_194 Int) (temp___is_init_191 Bool) (temp___skip_constant_192 Bool) (temp___do_toplevel_193 Bool)) Bool (=> (or (= temp___is_init_191 true) (<= 0 1)) (in_range3 temp___expr_194)))
...
(define-fun dynamic_invariant1 ((temp___expr_365 Int) (temp___is_init_362 Bool) (temp___skip_constant_363 Bool) (temp___do_toplevel_364 Bool)) Bool (=> (or (= temp___is_init_362 true) (<= 0 4194304)) (in_range5 temp___expr_365)))
...
(define-fun dynamic_invariant2 ((temp___expr_407 Int) (temp___is_init_404 Bool) (temp___skip_constant_405 Bool) (temp___do_toplevel_406 Bool)) Bool (=> (or (= temp___is_init_404 true) (<= 0 864000)) (in_range6 temp___expr_407)))
(declare-sort tokenidt 0)
(define-fun in_range7 ((x Int)) Bool (and (<= 0 x) (<= x 4294967295)))
(declare-fun attr__ATTRIBUTE_IMAGE7 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check7 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE7 (us_image) Int)
(declare-fun user_eq8 (tokenidt tokenidt) Bool)
(declare-const dummy8 tokenidt)
...
(define-fun dynamic_invariant3 ((temp___expr_539 Int) (temp___is_init_536 Bool) (temp___skip_constant_537 Bool) (temp___do_toplevel_538 Bool)) Bool (=> (or (= temp___is_init_536 true) (<= 0 4294967295)) (in_range7 temp___expr_539)))
(declare-sort tryt 0)
(define-fun in_range8 ((x Int)) Bool (and (<= 0 x) (<= x 2)))
(declare-fun attr__ATTRIBUTE_IMAGE8 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check8 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE8 (us_image) Int)
(declare-fun user_eq9 (tryt tryt) Bool)
(declare-const dummy9 tryt)
...
(define-fun dynamic_invariant4 ((temp___expr_545 Int) (temp___is_init_542 Bool) (temp___skip_constant_543 Bool) (temp___do_toplevel_544 Bool)) Bool (=> (or (= temp___is_init_542 true) (<= 0 2)) (in_range8 temp___expr_545)))
...
(define-fun dynamic_invariant5 ((temp___expr_551 Int) (temp___is_init_548 Bool) (temp___skip_constant_549 Bool) (temp___do_toplevel_550 Bool)) Bool (=> (or (= temp___is_init_548 true) (<= 0 1)) (in_range9 temp___expr_551)))
...
(declare-fun user_eq12 (fart fart) Bool)
(declare-const dummy12 fart)
...
(define-fun dynamic_invariant6 ((temp___expr_885 Int) (temp___is_init_882 Bool) (temp___skip_constant_883 Bool) (temp___do_toplevel_884 Bool)) Bool (=> (or (= temp___is_init_882 true) (<= 0 2147483647)) (in_range10 temp___expr_885)))
(declare-sort classt 0)
(define-fun in_range11 ((x Int)) Bool (and (<= 0 x) (<= x 5)))
(declare-fun attr__ATTRIBUTE_IMAGE11 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check11 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE11 (us_image) Int)
(declare-fun user_eq13 (classt classt) Bool)
(declare-const dummy13 classt)
...
(define-fun dynamic_invariant7 ((temp___expr_965 Int) (temp___is_init_962 Bool) (temp___skip_constant_963 Bool) (temp___do_toplevel_964 Bool)) Bool (=> (or (= temp___is_init_962 true) (<= 0 5)) (in_range11 temp___expr_965)))
(declare-sort durationt1 0)
(define-fun in_range12 ((x Int)) Bool (and (<= 0 x) (<= x 2000)))
...
(define-fun dynamic_invariant8 ((temp___expr_978 Int) (temp___is_init_975 Bool) (temp___skip_constant_976 Bool) (temp___do_toplevel_977 Bool)) Bool (=> (or (= temp___is_init_975 true) (<= 0 2000)) (in_range12 temp___expr_978)))
(declare-sort accesspolicyt 0)
(define-fun in_range13 ((x Int)) Bool (and (<= 0 x) (<= x 1)))
(declare-fun attr__ATTRIBUTE_IMAGE13 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check13 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE13 (us_image) Int)
(declare-fun user_eq15 (accesspolicyt accesspolicyt) Bool)
(declare-const dummy15 accesspolicyt)
...
(define-fun dynamic_invariant9 ((temp___expr_988 Int) (temp___is_init_985 Bool) (temp___skip_constant_986 Bool) (temp___do_toplevel_987 Bool)) Bool (=> (or (= temp___is_init_985 true) (<= 0 1)) (in_range13 temp___expr_988)))
...
(assert (forall ((x logfileindext)) (! (in_range14 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x Int)) (! (=> (in_range14 x) (= (to_rep2 (of_rep2 x)) x)) :pattern ((to_rep2 (of_rep2 x))))))
...
(assert (forall ((x logentrycountt)) (! (in_range15 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x Int)) (! (=> (in_range15 x) (= (to_rep3 (of_rep3 x)) x)) :pattern ((to_rep3 (of_rep3 x))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_150 Int)) (=> (and (<= a__first temp___idx_150) (<= temp___idx_150 a__last)) (= (to_rep2 (select a temp___idx_150)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_150)))))))))))
...
(assert (forall ((x logfilecountt)) (! (in_range16 (to_rep4 x)) :pattern ((to_rep4 x)))))
(assert (forall ((x Int)) (! (=> (in_range16 x) (= (to_rep4 (of_rep4 x)) x)) :pattern ((to_rep4 (of_rep4 x))))))
...
(assert (forall ((x fileentrycountt)) (! (in_range17 (to_rep5 x)) :pattern ((to_rep5 x)))))
(assert (forall ((x Int)) (! (=> (in_range17 x) (= (to_rep5 (of_rep5 x)) x)) :pattern ((to_rep5 (of_rep5 x))))))
...
(declare-fun temp___1055 (Int) (Array Int logfileindext))
(assert (forall ((temp___1057 Int)) (forall ((temp___1058 Int)) (= (select (temp___1055 temp___1057) temp___1058) (of_rep2 temp___1057)))))
(declare-fun temp___1059 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1061 Int)) (forall ((temp___1062 Int)) (= (select (temp___1059 temp___1061) temp___1062) (of_rep5 temp___1061)))))
(define-fun dynamic_invariant10 ((temp___expr_1049 us_rep2) (temp___is_init_1046 Bool) (temp___skip_constant_1047 Bool) (temp___do_toplevel_1048 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1049))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1049))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1049)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1049))) true))
(define-fun default_initial_assumption ((temp___expr_1053 us_rep2) (temp___skip_top_level_1054 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1053))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1053))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1053)) (mk___rep (mk___split_fields (temp___1055 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1053)) (temp___1059 0))))
(define-fun type_invariant ((temp___1063 us_rep2)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1063))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1063))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1063)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1063))) true))
...
(define-fun bool_eq7 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_152 Int)) (=> (and (<= a__first temp___idx_152) (<= temp___idx_152 a__last)) (= (bool_eq2 (select a temp___idx_152) (select b (+ (- b__first a__first) temp___idx_152))) true)))) true false))
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_152 Int)) (=> (and (<= a__first temp___idx_152) (<= temp___idx_152 a__last)) (= (bool_eq2 (select a temp___idx_152) (select b (+ (- b__first a__first) temp___idx_152))) true))))))))
...
(assert (forall ((x filestatust)) (! (in_range18 (to_rep6 x)) :pattern ((to_rep6 x)))))
(assert (forall ((x Int)) (! (=> (in_range18 x) (= (to_rep6 (of_rep6 x)) x)) :pattern ((to_rep6 (of_rep6 x))))))
...
(define-fun in_range19 ((x Int)) Bool (and (<= 1901 x) (<= x 2099)))
...
(declare-fun user_eq25 (yearst yearst) Bool)
(declare-const dummy25 yearst)
...
(assert (forall ((x yearst)) (! (in_range19 (to_rep7 x)) :pattern ((to_rep7 x)))))
(assert (forall ((x Int)) (! (=> (in_range19 x) (= (to_rep7 (of_rep7 x)) x)) :pattern ((to_rep7 (of_rep7 x))))))
(declare-sort monthst 0)
(define-fun in_range20 ((x Int)) Bool (and (<= 1 x) (<= x 12)))
...
(declare-fun user_eq26 (monthst monthst) Bool)
(declare-const dummy26 monthst)
...
(assert (forall ((x monthst)) (! (in_range20 (to_rep8 x)) :pattern ((to_rep8 x)))))
(assert (forall ((x Int)) (! (=> (in_range20 x) (= (to_rep8 (of_rep8 x)) x)) :pattern ((to_rep8 (of_rep8 x))))))
(declare-sort dayst 0)
(define-fun in_range21 ((x Int)) Bool (and (<= 1 x) (<= x 31)))
...
(declare-fun user_eq27 (dayst dayst) Bool)
(declare-const dummy27 dayst)
...
(assert (forall ((x dayst)) (! (in_range21 (to_rep9 x)) :pattern ((to_rep9 x)))))
(assert (forall ((x Int)) (! (=> (in_range21 x) (= (to_rep9 (of_rep9 x)) x)) :pattern ((to_rep9 (of_rep9 x))))))
(declare-sort millisecst 0)
(define-fun in_range22 ((x Int)) Bool (and (<= 0 x) (<= x 86399999)))
...
(declare-fun user_eq28 (millisecst millisecst) Bool)
(declare-const dummy28 millisecst)
...
(assert (forall ((x millisecst)) (! (in_range22 (to_rep10 x)) :pattern ((to_rep10 x)))))
(assert (forall ((x Int)) (! (=> (in_range22 x) (= (to_rep10 (of_rep10 x)) x)) :pattern ((to_rep10 (of_rep10 x))))))
...
(assert (forall ((x algorithmt)) (! (in_range23 (to_rep11 x)) :pattern ((to_rep11 x)))))
(assert (forall ((x Int)) (! (=> (in_range23 x) (= (to_rep11 (of_rep11 x)) x)) :pattern ((to_rep11 (of_rep11 x))))))
(declare-sort privileget 0)
(define-fun in_range24 ((x Int)) Bool (and (<= 0 x) (<= x 3)))
...
(declare-fun user_eq31 (privileget privileget) Bool)
(declare-const dummy31 privileget)
...
(declare-fun to_rep12 (privileget) Int)
(declare-fun of_rep12 (Int) privileget)
(assert (forall ((x privileget)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x privileget)) (! (in_range24 (to_rep12 x)) :pattern ((to_rep12 x)))))
(assert (forall ((x Int)) (! (=> (in_range24 x) (= (to_rep12 (of_rep12 x)) x)) :pattern ((to_rep12 (of_rep12 x))))))
...
(assert (forall ((x classt)) (! (in_range11 (to_rep13 x)) :pattern ((to_rep13 x)))))
(assert (forall ((x Int)) (! (=> (in_range11 x) (= (to_rep13 (of_rep13 x)) x)) :pattern ((to_rep13 (of_rep13 x))))))
...
(define-fun bool_eq10 ((a us_rep4) (b us_rep4)) Bool (ite (= (to_rep13 (rec__privtypes__clearancet__class (us_split_fields7 a))) (to_rep13 (rec__privtypes__clearancet__class (us_split_fields7 b)))) true false))
...
(declare-fun user_eq32 (us_rep4 us_rep4) Bool)
(declare-const dummy32 us_rep4)
...
(declare-fun user_eq33 (namecountt namecountt) Bool)
(declare-const dummy33 namecountt)
...
(declare-fun to_rep14 (namecountt) Int)
(declare-fun of_rep14 (Int) namecountt)
(assert (forall ((x namecountt)) (! (= (of_rep14 (to_rep14 x)) x) :pattern ((to_rep14 x)))))
(assert (forall ((x namecountt)) (! (in_range25 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(declare-fun user_eq35 (issueridt issueridt) Bool)
(declare-const dummy35 issueridt)
...
(assert (forall ((x issueridt)) (! (in_range26 (to_rep15 x)) :pattern ((to_rep15 x)))))
...
(define-fun us_rep___2__projection ((a us_rep5)) us_split_fields8 (us_split_fields9 a))
(define-fun bool_eq11 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (= (to_rep15 (rec__cryptotypes__issuert__id (us_split_fields9 a))) (to_rep15 (rec__cryptotypes__issuert__id (us_split_fields9 b)))) (= (to_rep14 (rec__cryptotypes__issuert__namelength (us_split_fields9 a))) (to_rep14 (rec__cryptotypes__issuert__namelength (us_split_fields9 b))))) (= (bool_eq (rec__cryptotypes__issuert__name (us_split_fields9 a)) 1 40 (rec__cryptotypes__issuert__name (us_split_fields9 b)) 1 40) true)) true false))
...
(declare-fun user_eq36 (us_rep5 us_rep5) Bool)
(declare-const dummy36 us_rep5)
...
(assert (forall ((x serialnumbert)) (! (in_range27 (to_rep16 x)) :pattern ((to_rep16 x)))))
...
(define-fun bool_eq12 ((a us_rep6) (b us_rep6)) Bool (ite (and (= (bool_eq11 (rec__certtypes__idt__issuer (us_split_fields11 a)) (rec__certtypes__idt__issuer (us_split_fields11 b))) true) (= (to_rep16 (rec__certtypes__idt__serialnumber (us_split_fields11 a))) (to_rep16 (rec__certtypes__idt__serialnumber (us_split_fields11 b))))) true false))
...
(declare-fun user_eq38 (us_rep6 us_rep6) Bool)
(declare-const dummy38 us_rep6)
...
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__cert__attr__auth__contentst__id us_rep6) (rec__cert__attr__auth__contentst__notbefore us_rep3) (rec__cert__attr__auth__contentst__notafter us_rep3) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep6) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep4)))))
...
(define-fun bool_eq13 ((a us_rep7) (b us_rep7)) Bool (ite (and (and (and (and (and (and (= (bool_eq12 (rec__cert__attr__auth__contentst__id (us_split_fields13 a)) (rec__cert__attr__auth__contentst__id (us_split_fields13 b))) true) (= (bool_eq9 (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields13 b))) true)) (= (bool_eq9 (rec__cert__attr__auth__contentst__notafter (us_split_fields13 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields13 b))) true)) (= (to_rep11 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 a))) (to_rep11 (rec__cert__attr__auth__contentst__mechanism (us_split_fields13 b))))) (= (bool_eq12 (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields13 b))) true)) (= (to_rep12 (rec__cert__attr__auth__contentst__role (us_split_fields13 a))) (to_rep12 (rec__cert__attr__auth__contentst__role (us_split_fields13 b))))) (= (bool_eq10 (rec__cert__attr__auth__contentst__clearance (us_split_fields13 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields13 b))) true)) true false))
...
(declare-fun user_eq39 (us_rep7 us_rep7) Bool)
(declare-const dummy39 us_rep7)
...
(assert (forall ((x keyidt)) (! (in_range28 (to_rep17 x)) :pattern ((to_rep17 x)))))
...
(assert (forall ((x keylengtht)) (! (in_range29 (to_rep18 x)) :pattern ((to_rep18 x)))))
...
(declare-fun user_eq43 (us_rep9 us_rep9) Bool)
(declare-const dummy43 us_rep9)
...
(declare-datatypes () ((us_split_fields18 (mk___split_fields9 (rec__cert__id__contentst__id us_rep6) (rec__cert__id__contentst__notbefore us_rep3) (rec__cert__id__contentst__notafter us_rep3) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep5) (rec__cert__id__contentst__subjectpublickey us_rep9)))))
...
(declare-fun user_eq44 (us_rep10 us_rep10) Bool)
(declare-const dummy44 us_rep10)
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1818 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 4)) 111)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 7)) 87)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 12)) 110)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 13)) 103)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 15)) 78)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 17)) 119)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 19)) 67)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 20)) 111)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 21)) 110)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 22)) 102)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 24)) 103)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 26)) 68)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 27)) 97)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 28)) 116)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 29)) 97)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 31)) 116)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 32)) 111)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 34)) 102)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 35)) 105)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 36)) 108)) (= (to_rep (select (temp___String_Literal_1818 us_void_param) 37)) 101)) :pattern ((temp___String_Literal_1818 us_void_param)))))
(define-fun dynamic_invariant11 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range1 temp___expr_39)))
(define-fun dynamic_invariant12 ((temp___expr_63 Int) (temp___is_init_60 Bool) (temp___skip_constant_61 Bool) (temp___do_toplevel_62 Bool)) Bool (=> (or (= temp___is_init_60 true) (<= 0 255)) (in_range2 temp___expr_63)))
(define-fun dynamic_invariant13 ((temp___expr_82 us_t) (temp___is_init_79 Bool) (temp___skip_constant_80 Bool) (temp___do_toplevel_81 Bool)) Bool (=> (not (= temp___skip_constant_80 true)) (dynamic_property 1 2147483647 (first1 temp___expr_82) (last1 temp___expr_82))))
(define-fun dynamic_invariant14 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range temp___expr_15)))
(define-fun dynamic_invariant15 ((temp___expr_463 Int) (temp___is_init_460 Bool) (temp___skip_constant_461 Bool) (temp___do_toplevel_462 Bool)) Bool (=> (or (= temp___is_init_460 true) (<= 0 40)) (in_range25 temp___expr_463)))
(define-fun dynamic_invariant16 ((temp___expr_484 Int) (temp___is_init_481 Bool) (temp___skip_constant_482 Bool) (temp___do_toplevel_483 Bool)) Bool (=> (or (= temp___is_init_481 true) (<= 0 4294967295)) (in_range26 temp___expr_484)))
(define-fun dynamic_invariant17 ((temp___expr_506 Int) (temp___is_init_503 Bool) (temp___skip_constant_504 Bool) (temp___do_toplevel_505 Bool)) Bool (=> (or (= temp___is_init_503 true) (<= 0 10)) (in_range23 temp___expr_506)))
(define-fun dynamic_invariant18 ((temp___expr_518 Int) (temp___is_init_515 Bool) (temp___skip_constant_516 Bool) (temp___do_toplevel_517 Bool)) Bool (=> (or (= temp___is_init_515 true) (<= 0 4294967295)) (in_range28 temp___expr_518)))
(define-fun dynamic_invariant19 ((temp___expr_524 Int) (temp___is_init_521 Bool) (temp___skip_constant_522 Bool) (temp___do_toplevel_523 Bool)) Bool (=> (or (= temp___is_init_521 true) (<= 0 128)) (in_range29 temp___expr_524)))
(define-fun dynamic_invariant20 ((temp___expr_1015 Int) (temp___is_init_1012 Bool) (temp___skip_constant_1013 Bool) (temp___do_toplevel_1014 Bool)) Bool (=> (or (= temp___is_init_1012 true) (<= 0 17)) (in_range16 temp___expr_1015)))
(define-fun dynamic_invariant21 ((temp___expr_994 Int) (temp___is_init_991 Bool) (temp___skip_constant_992 Bool) (temp___do_toplevel_993 Bool)) Bool (=> (or (= temp___is_init_991 true) (<= 1 17)) (in_range14 temp___expr_994)))
(define-fun dynamic_invariant22 ((temp___expr_1119 Int) (temp___is_init_1116 Bool) (temp___skip_constant_1117 Bool) (temp___do_toplevel_1118 Bool)) Bool (=> (or (= temp___is_init_1116 true) (<= 0 2)) (in_range18 temp___expr_1119)))
(define-fun dynamic_invariant23 ((temp___expr_1000 Int) (temp___is_init_997 Bool) (temp___skip_constant_998 Bool) (temp___do_toplevel_999 Bool)) Bool (=> (or (= temp___is_init_997 true) (<= 0 17408)) (in_range15 temp___expr_1000)))
(define-fun dynamic_invariant24 ((temp___expr_1034 Int) (temp___is_init_1031 Bool) (temp___skip_constant_1032 Bool) (temp___do_toplevel_1033 Bool)) Bool (=> (or (= temp___is_init_1031 true) (<= 0 1024)) (in_range17 temp___expr_1034)))
(assert true)
...
(define-fun dynamic_invariant25 ((temp___expr_335 Int) (temp___is_init_332 Bool) (temp___skip_constant_333 Bool) (temp___do_toplevel_334 Bool)) Bool (=> (or (= temp___is_init_332 true) (<= 1 150)) (in_range4 temp___expr_335)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_136 Tuple0)))
(define-fun dynamic_invariant26 ((temp___expr_377 Int) (temp___is_init_374 Bool) (temp___skip_constant_375 Bool) (temp___do_toplevel_376 Bool)) Bool (=> (or (= temp___is_init_374 true) (<= 1901 2099)) (in_range19 temp___expr_377)))
(define-fun dynamic_invariant27 ((temp___expr_383 Int) (temp___is_init_380 Bool) (temp___skip_constant_381 Bool) (temp___do_toplevel_382 Bool)) Bool (=> (or (= temp___is_init_380 true) (<= 1 12)) (in_range20 temp___expr_383)))
(define-fun dynamic_invariant28 ((temp___expr_389 Int) (temp___is_init_386 Bool) (temp___skip_constant_387 Bool) (temp___do_toplevel_388 Bool)) Bool (=> (or (= temp___is_init_386 true) (<= 1 31)) (in_range21 temp___expr_389)))
(define-fun dynamic_invariant29 ((temp___expr_413 Int) (temp___is_init_410 Bool) (temp___skip_constant_411 Bool) (temp___do_toplevel_412 Bool)) Bool (=> (or (= temp___is_init_410 true) (<= 0 86399999)) (in_range22 temp___expr_413)))
(define-fun dynamic_invariant30 ((temp___expr_953 Int) (temp___is_init_950 Bool) (temp___skip_constant_951 Bool) (temp___do_toplevel_952 Bool)) Bool (=> (or (= temp___is_init_950 true) (<= 0 3)) (in_range24 temp___expr_953)))
(define-fun dynamic_invariant31 ((temp___expr_1273 Int) (temp___is_init_1270 Bool) (temp___skip_constant_1271 Bool) (temp___do_toplevel_1272 Bool)) Bool (=> (or (= temp___is_init_1270 true) (<= 0 4294967295)) (in_range27 temp___expr_1273)))
...
(assert (in_range3 tokenpresence))
(assert (in_range8 tokentry))
(assert (in_range7 tokenid))
...
(assert (=> (<= 0 2000) (in_range12 thelatchunlockduration)))
(assert (=> (<= 0 2000) (in_range12 thealarmsilentduration)))
(assert (=> (<= 0 2000) (in_range12 thefingerwaitduration)))
(assert (=> (<= 0 2000) (in_range12 thetokenremovalduration)))
(assert (=> (<= 0 5) (in_range11 theenclaveclearance)))
(assert (=> (<= 0 864000) (in_range6 theworkinghoursstart)))
(assert (=> (<= 0 864000) (in_range6 theworkinghoursend)))
(assert (=> (<= 0 864000) (in_range6 themaxauthduration)))
(assert (=> (<= 0 1) (in_range13 theaccesspolicy)))
(assert (=> (<= 0 5) (in_range11 (int__content theminentryclass))))
(assert (=> (<= 0 4194304) (in_range5 (int__content theminpreservedlogsize))))
(assert (=> (<= 0 4194304) (in_range5 (int__content thealarmthresholdsize))))
(assert (=> (<= 0 2147483647) (in_range10 (int__content thesystemmaxfar))))
(assert (and (and (and (and (and (and (and (and (and (and (and (and (in_range12 thelatchunlockduration1) (in_range12 thealarmsilentduration1)) (in_range12 thefingerwaitduration1)) (in_range12 thetokenremovalduration1)) (in_range11 theenclaveclearance1)) (in_range6 theworkinghoursstart1)) (in_range6 theworkinghoursend1)) (in_range6 themaxauthduration1)) (in_range13 theaccesspolicy1)) (in_range11 (let ((subject theminentryclass)) theminentryclass1))) (in_range5 (let ((subject theminpreservedlogsize)) theminpreservedlogsize1))) (in_range5 (let ((subject thealarmthresholdsize)) thealarmthresholdsize1))) (in_range10 (let ((subject thesystemmaxfar)) thesystemmaxfar1))))
(assert (not (= datavalid true)))
(assert (= o3 (extractuser tokenpresence (us_private__content state) tokentry tokenid (us_split_fields__content7 authcert__split_fields) (us_split_fields__content10 idcert__split_fields))))
