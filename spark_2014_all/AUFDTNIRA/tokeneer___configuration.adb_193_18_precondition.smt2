...
(define-fun dynamic_invariant ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 1)) (in_range3 temp___expr_221)))
...
(define-fun dynamic_invariant1 ((temp___expr_454 Int) (temp___is_init_450 Bool) (temp___skip_constant_451 Bool) (temp___do_toplevel_452 Bool) (temp___do_typ_inv_453 Bool)) Bool (=> (or (= temp___is_init_450 true) (<= 0 4194304)) (in_range5 temp___expr_454)))
...
(define-fun dynamic_invariant2 ((temp___expr_507 Int) (temp___is_init_503 Bool) (temp___skip_constant_504 Bool) (temp___do_toplevel_505 Bool) (temp___do_typ_inv_506 Bool)) Bool (=> (or (= temp___is_init_503 true) (<= 0 864000)) (in_range6 temp___expr_507)))
...
(define-fun dynamic_invariant3 ((temp___expr_660 Int) (temp___is_init_656 Bool) (temp___skip_constant_657 Bool) (temp___do_toplevel_658 Bool) (temp___do_typ_inv_659 Bool)) Bool (=> (or (= temp___is_init_656 true) (<= 0 4294967295)) (in_range7 temp___expr_660)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant4 ((temp___expr_667 Int) (temp___is_init_663 Bool) (temp___skip_constant_664 Bool) (temp___do_toplevel_665 Bool) (temp___do_typ_inv_666 Bool)) Bool (=> (or (= temp___is_init_663 true) (<= 0 2)) (in_range8 temp___expr_667)))
...
(define-fun dynamic_invariant5 ((temp___expr_674 Int) (temp___is_init_670 Bool) (temp___skip_constant_671 Bool) (temp___do_toplevel_672 Bool) (temp___do_typ_inv_673 Bool)) Bool (=> (or (= temp___is_init_670 true) (<= 0 1)) (in_range9 temp___expr_674)))
...
(define-fun dynamic_invariant6 ((temp___expr_1053 Int) (temp___is_init_1049 Bool) (temp___skip_constant_1050 Bool) (temp___do_toplevel_1051 Bool) (temp___do_typ_inv_1052 Bool)) Bool (=> (or (= temp___is_init_1049 true) (<= 0 2147483647)) (in_range10 temp___expr_1053)))
...
(define-fun dynamic_invariant7 ((temp___expr_1143 Int) (temp___is_init_1139 Bool) (temp___skip_constant_1140 Bool) (temp___do_toplevel_1141 Bool) (temp___do_typ_inv_1142 Bool)) Bool (=> (or (= temp___is_init_1139 true) (<= 0 5)) (in_range11 temp___expr_1143)))
...
(define-fun dynamic_invariant8 ((temp___expr_1162 Int) (temp___is_init_1158 Bool) (temp___skip_constant_1159 Bool) (temp___do_toplevel_1160 Bool) (temp___do_typ_inv_1161 Bool)) Bool (=> (or (= temp___is_init_1158 true) (<= 0 2000)) (in_range12 temp___expr_1162)))
...
(define-fun dynamic_invariant9 ((temp___expr_1173 Int) (temp___is_init_1169 Bool) (temp___skip_constant_1170 Bool) (temp___do_toplevel_1171 Bool) (temp___do_typ_inv_1172 Bool)) Bool (=> (or (= temp___is_init_1169 true) (<= 0 1)) (in_range13 temp___expr_1173)))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_172 Int)) (=> (and (<= a__first temp___idx_172) (<= temp___idx_172 a__last)) (= (to_rep2 (select a temp___idx_172)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_172)))))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_173 Int)) (=> (and (<= a__first temp___idx_173) (<= temp___idx_173 a__last)) (= (to_rep5 (select a temp___idx_173)) (to_rep5 (select b (+ (- b__first a__first) temp___idx_173)))))))))))
...
(declare-fun temp___1252 (Int) (Array Int logfileindext))
(declare-fun temp___1256 (Int) (Array Int fileentrycountt))
(define-fun dynamic_invariant10 ((temp___expr_1246 us_rep2) (temp___is_init_1242 Bool) (temp___skip_constant_1243 Bool) (temp___do_toplevel_1244 Bool) (temp___do_typ_inv_1245 Bool)) Bool (=> (= temp___do_typ_inv_1245 true) (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1246))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1246))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1246)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1246))) true)))
(define-fun default_initial_assumption ((temp___expr_1250 us_rep2) (temp___skip_top_level_1251 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1250))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1250))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1250)) (mk___rep (mk___split_fields (temp___1252 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1250)) (temp___1256 0))))
(define-fun type_invariant ((temp___1260 us_rep2)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1260))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1260))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1260)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1260))) true))
...
(assert (forall ((a (Array Int us_rep)) (b (Array Int us_rep))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq7 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_174 Int)) (=> (and (<= a__first temp___idx_174) (<= temp___idx_174 a__last)) (= (bool_eq2 (select a temp___idx_174) (select b (+ (- b__first a__first) temp___idx_174))) true))))))))
...
(assert true)
(declare-fun temp___String_Literal_2043 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2043 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 4)) 111)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 7)) 87)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 12)) 110)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 13)) 103)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 15)) 78)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 17)) 119)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 19)) 67)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 20)) 111)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 21)) 110)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 22)) 102)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 24)) 103)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 26)) 68)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 27)) 97)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 28)) 116)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 29)) 97)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 31)) 116)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 32)) 111)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 34)) 102)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 35)) 105)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 36)) 108)) (= (to_rep (select (temp___String_Literal_2043 us_void_param) 37)) 101)) :pattern ((temp___String_Literal_2043 us_void_param)))))
...
(define-fun dynamic_invariant15 ((temp___expr_574 Int) (temp___is_init_570 Bool) (temp___skip_constant_571 Bool) (temp___do_toplevel_572 Bool) (temp___do_typ_inv_573 Bool)) Bool (=> (or (= temp___is_init_570 true) (<= 0 40)) (in_range25 temp___expr_574)))
(define-fun dynamic_invariant16 ((temp___expr_598 Int) (temp___is_init_594 Bool) (temp___skip_constant_595 Bool) (temp___do_toplevel_596 Bool) (temp___do_typ_inv_597 Bool)) Bool (=> (or (= temp___is_init_594 true) (<= 0 4294967295)) (in_range26 temp___expr_598)))
(define-fun dynamic_invariant17 ((temp___expr_622 Int) (temp___is_init_618 Bool) (temp___skip_constant_619 Bool) (temp___do_toplevel_620 Bool) (temp___do_typ_inv_621 Bool)) Bool (=> (or (= temp___is_init_618 true) (<= 0 10)) (in_range23 temp___expr_622)))
(define-fun dynamic_invariant18 ((temp___expr_636 Int) (temp___is_init_632 Bool) (temp___skip_constant_633 Bool) (temp___do_toplevel_634 Bool) (temp___do_typ_inv_635 Bool)) Bool (=> (or (= temp___is_init_632 true) (<= 0 4294967295)) (in_range28 temp___expr_636)))
(define-fun dynamic_invariant19 ((temp___expr_643 Int) (temp___is_init_639 Bool) (temp___skip_constant_640 Bool) (temp___do_toplevel_641 Bool) (temp___do_typ_inv_642 Bool)) Bool (=> (or (= temp___is_init_639 true) (<= 0 128)) (in_range29 temp___expr_643)))
(define-fun dynamic_invariant20 ((temp___expr_1184 Int) (temp___is_init_1180 Bool) (temp___skip_constant_1181 Bool) (temp___do_toplevel_1182 Bool) (temp___do_typ_inv_1183 Bool)) Bool (=> (or (= temp___is_init_1180 true) (<= 0 17)) (in_range16 temp___expr_1184)))
(define-fun dynamic_invariant21 ((temp___expr_1191 Int) (temp___is_init_1187 Bool) (temp___skip_constant_1188 Bool) (temp___do_toplevel_1189 Bool) (temp___do_typ_inv_1190 Bool)) Bool (=> (or (= temp___is_init_1187 true) (<= 1 17)) (in_range14 temp___expr_1191)))
(define-fun dynamic_invariant22 ((temp___expr_1317 Int) (temp___is_init_1313 Bool) (temp___skip_constant_1314 Bool) (temp___do_toplevel_1315 Bool) (temp___do_typ_inv_1316 Bool)) Bool (=> (or (= temp___is_init_1313 true) (<= 0 2)) (in_range18 temp___expr_1317)))
(define-fun dynamic_invariant23 ((temp___expr_1198 Int) (temp___is_init_1194 Bool) (temp___skip_constant_1195 Bool) (temp___do_toplevel_1196 Bool) (temp___do_typ_inv_1197 Bool)) Bool (=> (or (= temp___is_init_1194 true) (<= 0 17408)) (in_range15 temp___expr_1198)))
(define-fun dynamic_invariant24 ((temp___expr_1229 Int) (temp___is_init_1225 Bool) (temp___skip_constant_1226 Bool) (temp___do_toplevel_1227 Bool) (temp___do_typ_inv_1228 Bool)) Bool (=> (or (= temp___is_init_1225 true) (<= 0 1024)) (in_range17 temp___expr_1229)))
(assert true)
...
(assert (forall ((temp___1258 Int)) (=> (dynamic_invariant24 temp___1258 true true true true) (forall ((temp___1259 Int)) (= (to_rep5 (select (temp___1256 temp___1258) temp___1259)) temp___1258)))))
(define-fun dynamic_invariant25 ((temp___expr_420 Int) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (or (= temp___is_init_416 true) (<= 1 150)) (in_range4 temp___expr_420)))
...
(define-fun dynamic_invariant26 ((temp___expr_472 Int) (temp___is_init_468 Bool) (temp___skip_constant_469 Bool) (temp___do_toplevel_470 Bool) (temp___do_typ_inv_471 Bool)) Bool (=> (or (= temp___is_init_468 true) (<= 1901 2099)) (in_range19 temp___expr_472)))
(define-fun dynamic_invariant27 ((temp___expr_479 Int) (temp___is_init_475 Bool) (temp___skip_constant_476 Bool) (temp___do_toplevel_477 Bool) (temp___do_typ_inv_478 Bool)) Bool (=> (or (= temp___is_init_475 true) (<= 1 12)) (in_range20 temp___expr_479)))
(define-fun dynamic_invariant28 ((temp___expr_486 Int) (temp___is_init_482 Bool) (temp___skip_constant_483 Bool) (temp___do_toplevel_484 Bool) (temp___do_typ_inv_485 Bool)) Bool (=> (or (= temp___is_init_482 true) (<= 1 31)) (in_range21 temp___expr_486)))
(define-fun dynamic_invariant29 ((temp___expr_518 Int) (temp___is_init_514 Bool) (temp___skip_constant_515 Bool) (temp___do_toplevel_516 Bool) (temp___do_typ_inv_517 Bool)) Bool (=> (or (= temp___is_init_514 true) (<= 0 86399999)) (in_range22 temp___expr_518)))
(define-fun dynamic_invariant30 ((temp___expr_1129 Int) (temp___is_init_1125 Bool) (temp___skip_constant_1126 Bool) (temp___do_toplevel_1127 Bool) (temp___do_typ_inv_1128 Bool)) Bool (=> (or (= temp___is_init_1125 true) (<= 0 3)) (in_range24 temp___expr_1129)))
(define-fun dynamic_invariant31 ((temp___expr_1490 Int) (temp___is_init_1486 Bool) (temp___skip_constant_1487 Bool) (temp___do_toplevel_1488 Bool) (temp___do_typ_inv_1489 Bool)) Bool (=> (or (= temp___is_init_1486 true) (<= 0 4294967295)) (in_range27 temp___expr_1490)))
(assert (forall ((temp___1254 Int)) (=> (dynamic_invariant21 temp___1254 true true true true) (forall ((temp___1255 Int)) (= (to_rep2 (select (temp___1252 temp___1254) temp___1255)) temp___1254)))))
