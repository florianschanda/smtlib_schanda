...
(define-fun dynamic_invariant1 ((temp___expr_405 Int) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool)) Bool (=> (or (= temp___is_init_402 true) (<= 0 4194304)) (in_range5 temp___expr_405)))
...
(define-fun dynamic_invariant2 ((temp___expr_451 Int) (temp___is_init_448 Bool) (temp___skip_constant_449 Bool) (temp___do_toplevel_450 Bool)) Bool (=> (or (= temp___is_init_448 true) (<= 0 864000)) (in_range6 temp___expr_451)))
...
(define-fun dynamic_invariant3 ((temp___expr_587 Int) (temp___is_init_584 Bool) (temp___skip_constant_585 Bool) (temp___do_toplevel_586 Bool)) Bool (=> (or (= temp___is_init_584 true) (<= 0 4294967295)) (in_range7 temp___expr_587)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant4 ((temp___expr_593 Int) (temp___is_init_590 Bool) (temp___skip_constant_591 Bool) (temp___do_toplevel_592 Bool)) Bool (=> (or (= temp___is_init_590 true) (<= 0 2)) (in_range8 temp___expr_593)))
...
(define-fun dynamic_invariant5 ((temp___expr_599 Int) (temp___is_init_596 Bool) (temp___skip_constant_597 Bool) (temp___do_toplevel_598 Bool)) Bool (=> (or (= temp___is_init_596 true) (<= 0 1)) (in_range9 temp___expr_599)))
...
(define-fun dynamic_invariant6 ((temp___expr_933 Int) (temp___is_init_930 Bool) (temp___skip_constant_931 Bool) (temp___do_toplevel_932 Bool)) Bool (=> (or (= temp___is_init_930 true) (<= 0 2147483647)) (in_range10 temp___expr_933)))
...
(define-fun dynamic_invariant7 ((temp___expr_1013 Int) (temp___is_init_1010 Bool) (temp___skip_constant_1011 Bool) (temp___do_toplevel_1012 Bool)) Bool (=> (or (= temp___is_init_1010 true) (<= 0 5)) (in_range11 temp___expr_1013)))
...
(define-fun dynamic_invariant8 ((temp___expr_1030 Int) (temp___is_init_1027 Bool) (temp___skip_constant_1028 Bool) (temp___do_toplevel_1029 Bool)) Bool (=> (or (= temp___is_init_1027 true) (<= 0 2000)) (in_range12 temp___expr_1030)))
...
(define-fun dynamic_invariant9 ((temp___expr_1040 Int) (temp___is_init_1037 Bool) (temp___skip_constant_1038 Bool) (temp___do_toplevel_1039 Bool)) Bool (=> (or (= temp___is_init_1037 true) (<= 0 1)) (in_range13 temp___expr_1040)))
...
(declare-fun temp___1111 (Int) (Array Int logfileindext))
(assert (forall ((temp___1113 Int)) (forall ((temp___1114 Int)) (= (select (temp___1111 temp___1113) temp___1114) (of_rep2 temp___1113)))))
(declare-fun temp___1115 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1117 Int)) (forall ((temp___1118 Int)) (= (select (temp___1115 temp___1117) temp___1118) (of_rep5 temp___1117)))))
(define-fun dynamic_invariant10 ((temp___expr_1105 us_rep2) (temp___is_init_1102 Bool) (temp___skip_constant_1103 Bool) (temp___do_toplevel_1104 Bool)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1105))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1105))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1105)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1105))) true))
(define-fun default_initial_assumption ((temp___expr_1109 us_rep2) (temp___skip_top_level_1110 Bool)) Bool (and (and (and (= (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1109))) 1) (= (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1109))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1109)) (mk___rep (mk___split_fields (temp___1111 1) (of_rep2 1) (of_rep2 1) (of_rep4 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1109)) (temp___1115 0))))
(define-fun type_invariant ((temp___1119 us_rep2)) Bool (= (valid_numberlogentries (to_rep2 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1119))) (to_rep3 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1119))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1119)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1119))) true))
...
(assert true)
(declare-fun temp___String_Literal_1874 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1874 us_void_param) 1)) 69) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 4)) 111)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 5)) 114)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 6)) 32)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 7)) 87)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 8)) 114)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 11)) 105)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 12)) 110)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 13)) 103)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 14)) 32)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 15)) 78)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 16)) 101)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 17)) 119)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 19)) 67)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 20)) 111)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 21)) 110)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 22)) 102)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 23)) 105)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 24)) 103)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 25)) 32)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 26)) 68)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 27)) 97)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 28)) 116)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 29)) 97)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 30)) 32)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 31)) 116)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 32)) 111)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 33)) 32)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 34)) 102)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 35)) 105)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 36)) 108)) (= (to_rep (select (temp___String_Literal_1874 us_void_param) 37)) 101)) :pattern ((temp___String_Literal_1874 us_void_param)))))
...
(define-fun dynamic_invariant15 ((temp___expr_511 Int) (temp___is_init_508 Bool) (temp___skip_constant_509 Bool) (temp___do_toplevel_510 Bool)) Bool (=> (or (= temp___is_init_508 true) (<= 0 40)) (in_range25 temp___expr_511)))
(define-fun dynamic_invariant16 ((temp___expr_532 Int) (temp___is_init_529 Bool) (temp___skip_constant_530 Bool) (temp___do_toplevel_531 Bool)) Bool (=> (or (= temp___is_init_529 true) (<= 0 4294967295)) (in_range26 temp___expr_532)))
(define-fun dynamic_invariant17 ((temp___expr_554 Int) (temp___is_init_551 Bool) (temp___skip_constant_552 Bool) (temp___do_toplevel_553 Bool)) Bool (=> (or (= temp___is_init_551 true) (<= 0 10)) (in_range23 temp___expr_554)))
(define-fun dynamic_invariant18 ((temp___expr_566 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 0 4294967295)) (in_range28 temp___expr_566)))
(define-fun dynamic_invariant19 ((temp___expr_572 Int) (temp___is_init_569 Bool) (temp___skip_constant_570 Bool) (temp___do_toplevel_571 Bool)) Bool (=> (or (= temp___is_init_569 true) (<= 0 128)) (in_range29 temp___expr_572)))
(define-fun dynamic_invariant20 ((temp___expr_1071 Int) (temp___is_init_1068 Bool) (temp___skip_constant_1069 Bool) (temp___do_toplevel_1070 Bool)) Bool (=> (or (= temp___is_init_1068 true) (<= 0 17)) (in_range16 temp___expr_1071)))
(define-fun dynamic_invariant21 ((temp___expr_1050 Int) (temp___is_init_1047 Bool) (temp___skip_constant_1048 Bool) (temp___do_toplevel_1049 Bool)) Bool (=> (or (= temp___is_init_1047 true) (<= 1 17)) (in_range14 temp___expr_1050)))
(define-fun dynamic_invariant22 ((temp___expr_1175 Int) (temp___is_init_1172 Bool) (temp___skip_constant_1173 Bool) (temp___do_toplevel_1174 Bool)) Bool (=> (or (= temp___is_init_1172 true) (<= 0 2)) (in_range18 temp___expr_1175)))
(define-fun dynamic_invariant23 ((temp___expr_1056 Int) (temp___is_init_1053 Bool) (temp___skip_constant_1054 Bool) (temp___do_toplevel_1055 Bool)) Bool (=> (or (= temp___is_init_1053 true) (<= 0 17408)) (in_range15 temp___expr_1056)))
(define-fun dynamic_invariant24 ((temp___expr_1090 Int) (temp___is_init_1087 Bool) (temp___skip_constant_1088 Bool) (temp___do_toplevel_1089 Bool)) Bool (=> (or (= temp___is_init_1087 true) (<= 0 1024)) (in_range17 temp___expr_1090)))
(assert true)
...
(define-fun dynamic_invariant25 ((temp___expr_375 Int) (temp___is_init_372 Bool) (temp___skip_constant_373 Bool) (temp___do_toplevel_374 Bool)) Bool (=> (or (= temp___is_init_372 true) (<= 1 150)) (in_range4 temp___expr_375)))
(assert (= nodescription (audittypes__nodescription__aggregate_def 32)))
(assert (= nouser (temp___String_Literal_136 Tuple0)))
(define-fun dynamic_invariant26 ((temp___expr_421 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1901 2099)) (in_range19 temp___expr_421)))
(define-fun dynamic_invariant27 ((temp___expr_427 Int) (temp___is_init_424 Bool) (temp___skip_constant_425 Bool) (temp___do_toplevel_426 Bool)) Bool (=> (or (= temp___is_init_424 true) (<= 1 12)) (in_range20 temp___expr_427)))
(define-fun dynamic_invariant28 ((temp___expr_433 Int) (temp___is_init_430 Bool) (temp___skip_constant_431 Bool) (temp___do_toplevel_432 Bool)) Bool (=> (or (= temp___is_init_430 true) (<= 1 31)) (in_range21 temp___expr_433)))
(define-fun dynamic_invariant29 ((temp___expr_461 Int) (temp___is_init_458 Bool) (temp___skip_constant_459 Bool) (temp___do_toplevel_460 Bool)) Bool (=> (or (= temp___is_init_458 true) (<= 0 86399999)) (in_range22 temp___expr_461)))
(define-fun dynamic_invariant30 ((temp___expr_1001 Int) (temp___is_init_998 Bool) (temp___skip_constant_999 Bool) (temp___do_toplevel_1000 Bool)) Bool (=> (or (= temp___is_init_998 true) (<= 0 3)) (in_range24 temp___expr_1001)))
(define-fun dynamic_invariant31 ((temp___expr_1329 Int) (temp___is_init_1326 Bool) (temp___skip_constant_1327 Bool) (temp___do_toplevel_1328 Bool)) Bool (=> (or (= temp___is_init_1326 true) (<= 0 4294967295)) (in_range27 temp___expr_1329)))
