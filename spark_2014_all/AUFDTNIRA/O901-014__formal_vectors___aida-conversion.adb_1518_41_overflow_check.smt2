...
(define-fun tint_arrayD1__ref___12__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___12__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t461b__ref (mk_t461b__ref (t461b__content integer)))))
(define-fun t461b__ref___projection ((a t461b__ref)) integer (t461b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t462b__ref (mk_t462b__ref (t462b__content us_t2)))))
(define-fun t462b__ref___projection ((a t462b__ref)) us_t2 (t462b__content a))
...
(define-fun tnumber_array_typeD1__ref___21__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___21__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t465b__ref (mk_t465b__ref (t465b__content integer)))))
(define-fun t465b__ref___projection ((a t465b__ref)) integer (t465b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t466b__ref (mk_t466b__ref (t466b__content us_t4)))))
(define-fun t466b__ref___projection ((a t466b__ref)) us_t4 (t466b__content a))
...
(declare-datatypes () ((t467b__ref (mk_t467b__ref (t467b__content integer)))))
(define-fun t467b__ref___projection ((a t467b__ref)) integer (t467b__content a))
...
(define-fun tint_arrayB__ref___12__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__aggregate_def (Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___1898 Int) (temp___1899 Int) (temp___1900 Int) (temp___1901 Int) (temp___1902 Int) (temp___1903 Int)) (let ((temp___1897 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__aggregate_def temp___1898 temp___1899 temp___1900 temp___1901 temp___1902 temp___1903))) (and (=> (dynamic_property10 (+ (first1 source) 7) (+ (first1 source) 10) temp___1902 temp___1903) (and (= (first5 temp___1897) temp___1902) (= (last5 temp___1897) temp___1903))) (and (and (and (= (select (to_array2 temp___1897) (+ (+ (first1 source) 7) 0)) (of_rep1 temp___1898)) (= (select (to_array2 temp___1897) (+ (+ (first1 source) 7) 1)) (of_rep1 temp___1899))) (= (select (to_array2 temp___1897) (+ (+ (first1 source) 7) 2)) (of_rep1 temp___1900))) (= (select (to_array2 temp___1897) (+ (+ (first1 source) 7) 3)) (of_rep1 temp___1901)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___21__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___1909 Int) (temp___1910 Int) (temp___1911 Int)) (let ((temp___1908 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__aggregate_def temp___1909 temp___1910 temp___1911))) (and (=> (dynamic_property11 (+ (first1 source) 7) (+ (first1 source) 10) temp___1910 temp___1911) (and (= (first9 temp___1908) temp___1910) (= (last9 temp___1908) temp___1911))) (forall ((temp___1912 Int)) (= (select (to_array4 temp___1908) temp___1912) (of_rep1 temp___1909)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_563 us_t3) (temp___is_init_560 Bool) (temp___skip_constant_561 Bool) (temp___do_toplevel_562 Bool)) Bool (=> (not (= temp___skip_constant_561 true)) (and (dynamic_property6 (+ (first1 source) 7) (+ (first1 source) 10) (first7 temp___expr_563) (last7 temp___expr_563)) (and (= (first7 temp___expr_563) (+ (first1 source) 7)) (= (last7 temp___expr_563) (+ (first1 source) 10))))))
...
(declare-const temp___1926 Int)
(declare-const temp___1927 Int)
(declare-const o Int)
(declare-const o1 character)
(declare-const o2 Int)
(declare-const o3 Bool)
(declare-const temp___1928 Int)
(declare-const o4 Int)
(declare-const o5 character)
(declare-const o6 Int)
(declare-const o7 Bool)
(declare-const temp___1929 Int)
(declare-const o8 Int)
(declare-const o9 character)
(declare-const o10 Int)
(declare-const o11 Bool)
(declare-const temp___1930 Int)
...
(declare-const temp___1906 (Array Int integer))
(declare-const temp___19061 t2)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___1914 (Array Int integer))
(declare-const temp___19141 t4)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__assume1 t3)
(declare-const us2 Int)
(declare-const us3 Int)
(declare-const temp___1920 Int)
(declare-const temp___1921 Int)
(declare-const temp___1918 (Array Int integer))
(declare-const temp___1916 Int)
...
(assert (and (= (length source) 11) (and (and (and (and (and (and (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 2))) 49)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 3))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 4))) 55)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 5))) 52)) (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 6))) 56)) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 7))) 51)) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__aggregate_def 2 9 9 9 (+ (to_rep1 (first (rt source))) 7) (+ (+ (to_rep1 (first (rt source))) 7) 3))))) (+ (to_rep1 (first (rt source))) 7)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__aggregate_def 2 9 9 9 (+ (to_rep1 (first (rt source))) 7) (+ (+ (to_rep1 (first (rt source))) 7) 3))))) (+ (+ (to_rep1 (first (rt source))) 7) 3)))
(assert (= (mk___t2 temp___1906 temp___19061) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__aggregate_def 2 9 9 9 (+ (to_rep1 (first (rt source))) 7) (+ (+ (to_rep1 (first (rt source))) 7) 3))))
(assert (= (ite (<= (to_rep1 (first4 temp___19061)) (to_rep1 (last4 temp___19061))) (+ (- (to_rep1 (last4 temp___19061)) (to_rep1 (first4 temp___19061))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 7)) 1) 0)))
(assert (= (slide1 temp___1906 (to_rep1 (first4 temp___19061)) (+ (to_rep1 (first (rt source))) 7)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 7)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 7)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)))
(assert (= (mk___t4 temp___1914 temp___19141) (aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___19141)) (to_rep1 (last8 temp___19141))) (+ (- (to_rep1 (last8 temp___19141)) (to_rep1 (first8 temp___19141))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 7)) 1) 0)))
(assert (= (slide1 temp___1914 (to_rep1 (first8 temp___19141)) (+ (to_rep1 (first (rt source))) 7)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_2_147_482_xxx__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 7)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= temp___1920 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (= temp___1921 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___1920))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= temp___1918 n1)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= temp___1916 index2)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= o33 index2)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= o34 (select n1 o33))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= o35 (to_rep1 o34))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= o35 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= o36 index2)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= o37 (select (elts source) o36))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= o38 (to_rep o37))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o38))) (ite (= (= o38 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o38 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o38 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o38 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o38 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o38 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o38 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o38 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o38 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o38 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= (to_rep1 o39) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= o40 index2)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= o41 (store n1 o40 o39))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= n1 result4)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= n2 o41)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 7) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (and (and (=> (<= (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 7) (+ (to_rep1 (first (rt source))) 10) index3)) (forall ((temp___1919 Int)) (=> (and (<= (to_rep1 n__first) temp___1919) (<= temp___1919 (to_rep1 n__last))) (=> (< index3 temp___1919) (= (select n3 temp___1919) (select temp___1918 temp___1919)))))) (and (<= (+ (to_rep1 (first (rt source))) 7) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= index3 temp___1921)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= index3 index5)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= n3 n5)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= index6 index3)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= n6 n3)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= index8 index6)))
(assert (=> (and (<= temp___1920 index2) (<= index2 temp___1921)) (= n8 n6)))
(assert (=> (not (and (<= temp___1920 index2) (<= index2 temp___1921))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___1920 index2) (<= index2 temp___1921))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___1920 index2) (<= index2 temp___1921))) (= index8 index2)))
(assert (=> (not (and (<= temp___1920 index2) (<= index2 temp___1921))) (= n8 n1)))
...
(assert (and (= temp___1922 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___1922) (<= temp___1922 (to_rep1 n__last))))
(assert (= o69 temp___1922))
...
(assert (= target1 o73))
(assert (<= (- 9) target1))
(assert (and (= temp___1923 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___1923) (<= temp___1923 (to_rep1 n__last))))
(assert (= o74 temp___1923))
(assert (= o75 (select (map__content1 n7) o74)))
(assert (= o76 (to_rep1 o75)))
(assert (= o77 (* o76 10)))
(assert (and (= o78 o77) (in_range1 o77)))
(assert (= o79 (- target1 o78)))
(assert (and (= o80 o79) (in_range1 o79)))
(assert (= result10 (mk_int__ref target1)))
(assert (= target2 o80))
(assert (<= (- 99) target2))
(assert (and (= temp___1924 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___1924) (<= temp___1924 (to_rep1 n__last))))
(assert (= o81 temp___1924))
(assert (= o82 (select (map__content1 n7) o81)))
(assert (= o83 (to_rep1 o82)))
(assert (= o84 (* o83 100)))
(assert (and (= o85 o84) (in_range1 o84)))
(assert (= o86 (- target2 o85)))
