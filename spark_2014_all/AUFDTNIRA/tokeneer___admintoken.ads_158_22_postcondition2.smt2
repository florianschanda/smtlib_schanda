...
(declare-const logfilestate__split_fields7 us_split_fields__ref10)
(declare-const auditalarm1 int__ref)
(declare-const tokenok bool__ref)
(declare-const tokentry1 int__ref)
(declare-const tokenid1 int__ref)
...
(assert (= (= (bool__content tokenok) true) (and (and (= (rec__admintoken__valididcertt__valid (us_split_fields__content8 idcert__split_fields)) true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content7 authcert__split_fields)) true)) (in_range24 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content7 authcert__split_fields)))))))
(assert (and (and (and (= (valid_numberlogentries (to_rep15 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields__content10 logfilestate__split_fields7))) (to_rep16 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields__content10 logfilestate__split_fields7))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields__content10 logfilestate__split_fields7)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields__content10 logfilestate__split_fields7))) true) (in_range17 (int__content tokentry1))) (in_range23 (int__content auditalarm1))) (in_range16 (int__content tokenid1))))
(assert (= (bool__content tokenok) true))
(assert (not (= (isgood (us_split_fields__content8 idcert__split_fields)) true)))
(check-sat)
(exit)
