...
(assert (forall ((temp___2236 Int) (temp___2237 Int) (temp___2238 Int) (temp___2239 Int) (temp___2240 Int) (temp___2241 Int) (temp___2242 Int) (temp___2243 Int) (temp___2244 Int) (temp___2245 Int) (temp___2246 Int) (temp___2247 Int)) (let ((temp___2235 (aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__aggregate_def temp___2236 temp___2237 temp___2238 temp___2239 temp___2240 temp___2241 temp___2242 temp___2243 temp___2244 temp___2245 temp___2246 temp___2247))) (=> (and (and (and (and (and (and (and (and (and (dynamic_invariant temp___2236 true true true true) (dynamic_invariant temp___2237 true true true true)) (dynamic_invariant temp___2238 true true true true)) (dynamic_invariant temp___2239 true true true true)) (dynamic_invariant temp___2240 true true true true)) (dynamic_invariant temp___2241 true true true true)) (dynamic_invariant temp___2242 true true true true)) (dynamic_invariant temp___2243 true true true true)) (dynamic_invariant temp___2244 true true true true)) (dynamic_invariant temp___2245 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 10) temp___2246 temp___2247) (and (= (first5 temp___2235) temp___2246) (= (last5 temp___2235) temp___2247))) (and (and (and (and (and (and (and (and (and (= (to_rep1 (select (to_array2 temp___2235) (+ (+ (first1 source) 1) 0))) temp___2236) (= (to_rep1 (select (to_array2 temp___2235) (+ (+ (first1 source) 1) 1))) temp___2237)) (= (to_rep1 (select (to_array2 temp___2235) (+ (+ (first1 source) 1) 2))) temp___2238)) (= (to_rep1 (select (to_array2 temp___2235) (+ (+ (first1 source) 1) 3))) temp___2239)) (= (to_rep1 (select (to_array2 temp___2235) (+ (+ (first1 source) 1) 4))) temp___2240)) (= (to_rep1 (select (to_array2 temp___2235) (+ (+ (first1 source) 1) 5))) temp___2241)) (= (to_rep1 (select (to_array2 temp___2235) (+ (+ (first1 source) 1) 6))) temp___2242)) (= (to_rep1 (select (to_array2 temp___2235) (+ (+ (first1 source) 1) 7))) temp___2243)) (= (to_rep1 (select (to_array2 temp___2235) (+ (+ (first1 source) 1) 8))) temp___2244)) (= (to_rep1 (select (to_array2 temp___2235) (+ (+ (first1 source) 1) 9))) temp___2245)))))))
(define-fun dynamic_invariant4 ((temp___expr_754 us_t3) (temp___is_init_750 Bool) (temp___skip_constant_751 Bool) (temp___do_toplevel_752 Bool) (temp___do_typ_inv_753 Bool)) Bool (=> (not (= temp___skip_constant_751 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 10) (first7 temp___expr_754) (last7 temp___expr_754)) (and (= (first7 temp___expr_754) (+ (first1 source) 1)) (= (last7 temp___expr_754) (+ (first1 source) 10))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2253 Int) (temp___2254 Int) (temp___2255 Int)) (let ((temp___2252 (aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__aggregate_def temp___2253 temp___2254 temp___2255))) (=> (dynamic_invariant temp___2253 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 10) temp___2254 temp___2255) (and (= (first9 temp___2252) temp___2254) (= (last9 temp___2252) temp___2255))) (forall ((temp___2256 Int)) (= (to_rep1 (select (to_array4 temp___2252) temp___2256)) temp___2253)))))))
...
(declare-const temp___2250 (Array Int integer))
(declare-const temp___22501 t2)
...
(declare-const temp___2258 (Array Int integer))
(declare-const temp___22581 t4)
...
(declare-const temp___2264 Int)
(declare-const temp___2265 Int)
(declare-const temp___2263 Int)
(declare-const temp___2261 (Array Int integer))
(declare-const o Int)
...
(declare-const temp___2266 Int)
(declare-const o9 Int)
(declare-const o10 integer)
(declare-const o11 Int)
(declare-const o12 Int)
(declare-const o13 Int)
(declare-const temp___2267 Int)
...
(assert (and (= (length source) 11) (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index7) (<= index7 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2250 temp___22501) (aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__aggregate_def 1 9 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___22501)) (to_rep1 (last4 temp___22501))) (+ (- (to_rep1 (last4 temp___22501)) (to_rep1 (first4 temp___22501))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2250 (to_rep1 (first4 temp___22501)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__assume))
...
(assert (= (mk___t4 temp___2258 temp___22581) (aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___22581)) (to_rep1 (last8 temp___22581))) (+ (- (to_rep1 (last8 temp___22581)) (to_rep1 (first8 temp___22581))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2258 (to_rep1 (first8 temp___22581)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__assume))
...
(assert (and (= temp___2264 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2265 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2264))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= temp___2263 index1)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= temp___2261 n1)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= o index1)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= o3 index1)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= o7 index1)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= n1 result3)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= n2 o8)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (and (and (forall ((temp___2262 Int)) (=> (and (<= (to_rep1 n__first) temp___2262) (<= temp___2262 (to_rep1 n__last))) (=> (< index2 temp___2262) (= (select n3 temp___2262) (select temp___2261 temp___2262))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10) index2))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= index2 temp___2265)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= index2 index3)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= n3 n4)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= index4 index2)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= n5 n3)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= index6 index4)))
(assert (=> (and (<= temp___2264 index1) (<= index1 temp___2265)) (= n7 n5)))
(assert (=> (not (and (<= temp___2264 index1) (<= index1 temp___2265))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2264 index1) (<= index1 temp___2265))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2264 index1) (<= index1 temp___2265))) (= index6 index1)))
(assert (=> (not (and (<= temp___2264 index1) (<= index1 temp___2265))) (= n7 n1)))
...
(assert (and (= temp___2266 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___2266) (<= temp___2266 (to_rep1 n__last))))
(assert (= o9 temp___2266))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2267 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___2267) (<= temp___2267 (to_rep1 n__last))))
(assert (= o14 temp___2267))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___2268 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2268) (<= temp___2268 (to_rep1 n__last))))
(assert (= o21 temp___2268))
...
(assert (= target3 o27))
(assert (<= (- 999) target3))
(assert (and (= temp___2269 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2269) (<= temp___2269 (to_rep1 n__last))))
(assert (= o28 temp___2269))
...
(assert (= target4 o34))
(assert (<= (- 9999) target4))
(assert (and (= temp___2270 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2270) (<= temp___2270 (to_rep1 n__last))))
(assert (= o35 temp___2270))
...
(assert (and (= o41 o40) (in_range1 o40)))
(assert (= result8 (mk_int__ref target4)))
(assert (= target5 o41))
(assert (<= (- 99999) target5))
(assert (and (= temp___2271 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2271) (<= temp___2271 (to_rep1 n__last))))
(assert (= o42 temp___2271))
(assert (= o43 (select (map__content1 n6) o42)))
(assert (= o44 (to_rep1 o43)))
(assert (= o45 (* o44 100000)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (= o47 (- target5 o46)))
(assert (and (= o48 o47) (in_range1 o47)))
(assert (= result9 (mk_int__ref target5)))
(assert (= target6 o48))
(assert (<= (- 999999) target6))
(assert (and (= temp___2272 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2272) (<= temp___2272 (to_rep1 n__last))))
(assert (= o49 temp___2272))
(assert (= o50 (select (map__content1 n6) o49)))
(assert (= o51 (to_rep1 o50)))
(assert (= o52 (* o51 1000000)))
(assert (and (= o53 o52) (in_range1 o52)))
(assert (= o54 (- target6 o53)))
(assert (and (= o55 o54) (in_range1 o54)))
(assert (= result10 (mk_int__ref target6)))
(assert (= target7 o55))
(assert (<= (- 9999999) target7))
(assert (and (= temp___2273 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2273) (<= temp___2273 (to_rep1 n__last))))
(assert (= o56 temp___2273))
(assert (= o57 (select (map__content1 n6) o56)))
(assert (= o58 (to_rep1 o57)))
(assert (= o59 (* o58 10000000)))
(assert (and (= o60 o59) (in_range1 o59)))
(assert (= o61 (- target7 o60)))
(assert (and (= o62 o61) (in_range1 o61)))
(assert (= result11 (mk_int__ref target7)))
(assert (= target8 o62))
(assert (<= (- 99999999) target8))
(assert (and (= temp___2274 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2274) (<= temp___2274 (to_rep1 n__last))))
(assert (= o63 temp___2274))
(assert (= o64 (select (map__content1 n6) o63)))
(assert (= o65 (to_rep1 o64)))
(assert (= o66 (* o65 100000000)))
(assert (and (= o67 o66) (in_range1 o66)))
(assert (= o68 (- target8 o67)))
(assert (not (in_range1 o68)))
(check-sat)
(exit)
