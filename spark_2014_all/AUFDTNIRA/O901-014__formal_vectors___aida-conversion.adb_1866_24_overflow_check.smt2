...
(define-fun tint_arrayD1__ref___18__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___18__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t611b__ref (mk_t611b__ref (t611b__content integer)))))
(define-fun t611b__ref___projection ((a t611b__ref)) integer (t611b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t612b__ref (mk_t612b__ref (t612b__content us_t2)))))
(define-fun t612b__ref___projection ((a t612b__ref)) us_t2 (t612b__content a))
...
(define-fun tnumber_array_typeD1__ref___27__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___27__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t615b__ref (mk_t615b__ref (t615b__content integer)))))
(define-fun t615b__ref___projection ((a t615b__ref)) integer (t615b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t616b__ref (mk_t616b__ref (t616b__content us_t4)))))
(define-fun t616b__ref___projection ((a t616b__ref)) us_t4 (t616b__content a))
...
(declare-datatypes () ((t617b__ref (mk_t617b__ref (t617b__content integer)))))
(define-fun t617b__ref___projection ((a t617b__ref)) integer (t617b__content a))
...
(define-fun tint_arrayB__ref___18__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__aggregate_def (Int Int Int Int Int Int Int Int Int Int Int Int) us_t2)
(assert (forall ((temp___2134 Int) (temp___2135 Int) (temp___2136 Int) (temp___2137 Int) (temp___2138 Int) (temp___2139 Int) (temp___2140 Int) (temp___2141 Int) (temp___2142 Int) (temp___2143 Int) (temp___2144 Int) (temp___2145 Int)) (let ((temp___2133 (aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__aggregate_def temp___2134 temp___2135 temp___2136 temp___2137 temp___2138 temp___2139 temp___2140 temp___2141 temp___2142 temp___2143 temp___2144 temp___2145))) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 10) temp___2144 temp___2145) (and (= (first5 temp___2133) temp___2144) (= (last5 temp___2133) temp___2145))) (and (and (and (and (and (and (and (and (and (= (select (to_array2 temp___2133) (+ (+ (first1 source) 1) 0)) (of_rep1 temp___2134)) (= (select (to_array2 temp___2133) (+ (+ (first1 source) 1) 1)) (of_rep1 temp___2135))) (= (select (to_array2 temp___2133) (+ (+ (first1 source) 1) 2)) (of_rep1 temp___2136))) (= (select (to_array2 temp___2133) (+ (+ (first1 source) 1) 3)) (of_rep1 temp___2137))) (= (select (to_array2 temp___2133) (+ (+ (first1 source) 1) 4)) (of_rep1 temp___2138))) (= (select (to_array2 temp___2133) (+ (+ (first1 source) 1) 5)) (of_rep1 temp___2139))) (= (select (to_array2 temp___2133) (+ (+ (first1 source) 1) 6)) (of_rep1 temp___2140))) (= (select (to_array2 temp___2133) (+ (+ (first1 source) 1) 7)) (of_rep1 temp___2141))) (= (select (to_array2 temp___2133) (+ (+ (first1 source) 1) 8)) (of_rep1 temp___2142))) (= (select (to_array2 temp___2133) (+ (+ (first1 source) 1) 9)) (of_rep1 temp___2143)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___27__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___2151 Int) (temp___2152 Int) (temp___2153 Int)) (let ((temp___2150 (aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__aggregate_def temp___2151 temp___2152 temp___2153))) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 10) temp___2152 temp___2153) (and (= (first9 temp___2150) temp___2152) (= (last9 temp___2150) temp___2153))) (forall ((temp___2154 Int)) (= (select (to_array4 temp___2150) temp___2154) (of_rep1 temp___2151)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_671 us_t3) (temp___is_init_668 Bool) (temp___skip_constant_669 Bool) (temp___do_toplevel_670 Bool)) Bool (=> (not (= temp___skip_constant_669 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 10) (first7 temp___expr_671) (last7 temp___expr_671)) (and (= (first7 temp___expr_671) (+ (first1 source) 1)) (= (last7 temp___expr_671) (+ (first1 source) 10))))))
...
(declare-const temp___2173 Int)
(declare-const temp___2174 Int)
(declare-const o Int)
...
(declare-const temp___2148 (Array Int integer))
(declare-const temp___21481 t2)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___2156 (Array Int integer))
(declare-const temp___21561 t4)
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__assume1 t3)
(declare-const us2 Int)
(declare-const us3 Int)
(declare-const temp___2162 Int)
(declare-const temp___2163 Int)
(declare-const temp___2161 Int)
(declare-const temp___2159 (Array Int integer))
...
(declare-const target11 int__ref)
...
(assert (and (= (length source) 11) (and (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (< (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 1))) 50)) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index11) (<= index11 (+ (to_rep1 (first (rt source))) 10))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__aggregate_def 1 9 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 9))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__aggregate_def 1 9 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 9))))) (+ (+ (to_rep1 (first (rt source))) 1) 9)))
(assert (= (mk___t2 temp___2148 temp___21481) (aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__aggregate_def 1 9 9 9 9 9 9 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 9))))
(assert (= (ite (<= (to_rep1 (first4 temp___21481)) (to_rep1 (last4 temp___21481))) (+ (- (to_rep1 (last4 temp___21481)) (to_rep1 (first4 temp___21481))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2148 (to_rep1 (first4 temp___21481)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10))))) (+ (to_rep1 (first (rt source))) 10)))
(assert (= (mk___t4 temp___2156 temp___21561) (aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10))))
(assert (= (ite (<= (to_rep1 (first8 temp___21561)) (to_rep1 (last8 temp___21561))) (+ (- (to_rep1 (last8 temp___21561)) (to_rep1 (first8 temp___21561))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10)) (+ (- (+ (to_rep1 (first (rt source))) 10) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2156 (to_rep1 (first8 temp___21561)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10)) aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_for_length_11_case_1_xxx_xxx_xxx__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 10)))))
(assert (and (= temp___2162 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2163 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___2162))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= temp___2161 index2)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= temp___2159 n1)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= o9 index2)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= o10 (select n1 o9))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= o11 (to_rep1 o10))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= o11 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= o12 index2)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= o13 (select (elts source) o12))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= o14 (to_rep o13))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o14))) (ite (= (= o14 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o14 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o14 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o14 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o14 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o14 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o14 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o14 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o14 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o14 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= (to_rep1 o15) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= o16 index2)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= o17 (store n1 o16 o15))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= n1 result4)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= n2 o17)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (and (and (forall ((temp___2160 Int)) (=> (and (<= (to_rep1 n__first) temp___2160) (<= temp___2160 (to_rep1 n__last))) (=> (< index3 temp___2160) (= (select n3 temp___2160) (select temp___2159 temp___2160))))) (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 10) index3))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 10))))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= index3 temp___2163)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= index3 index5)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= n3 n5)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= index6 index3)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= n6 n3)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= index8 index6)))
(assert (=> (and (<= temp___2162 index2) (<= index2 temp___2163)) (= n8 n6)))
(assert (=> (not (and (<= temp___2162 index2) (<= index2 temp___2163))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___2162 index2) (<= index2 temp___2163))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2162 index2) (<= index2 temp___2163))) (= index8 index2)))
(assert (=> (not (and (<= temp___2162 index2) (<= index2 temp___2163))) (= n8 n1)))
(assert (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))))
(assert (and (= temp___2164 (+ (to_rep1 (first (rt source))) 10)) (in_range1 (+ (to_rep1 (first (rt source))) 10))))
(assert (and (<= (to_rep1 n__first) temp___2164) (<= temp___2164 (to_rep1 n__last))))
(assert (= o45 temp___2164))
(assert (= o46 (select (map__content1 n7) o45)))
(assert (= o47 (to_rep1 o46)))
(assert (= o48 (- o47)))
(assert (and (= o49 o48) (in_range1 o48)))
(assert (= result9 (mk_int__ref target)))
(assert (= target1 o49))
(assert (<= (- 9) target1))
(assert (and (= temp___2165 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))))
(assert (and (<= (to_rep1 n__first) temp___2165) (<= temp___2165 (to_rep1 n__last))))
(assert (= o50 temp___2165))
(assert (= o51 (select (map__content1 n7) o50)))
(assert (= o52 (to_rep1 o51)))
(assert (= o53 (* o52 10)))
(assert (and (= o54 o53) (in_range1 o53)))
(assert (= o55 (- target1 o54)))
(assert (and (= o56 o55) (in_range1 o55)))
(assert (= result10 (mk_int__ref target1)))
(assert (= target2 o56))
(assert (<= (- 99) target2))
(assert (and (= temp___2166 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 n__first) temp___2166) (<= temp___2166 (to_rep1 n__last))))
(assert (= o57 temp___2166))
(assert (= o58 (select (map__content1 n7) o57)))
(assert (= o59 (to_rep1 o58)))
(assert (= o60 (* o59 100)))
(assert (and (= o61 o60) (in_range1 o60)))
(assert (= o62 (- target2 o61)))
(assert (and (= o63 o62) (in_range1 o62)))
(assert (= result11 (mk_int__ref target2)))
(assert (= target3 o63))
(assert (<= (- 999) target3))
(assert (and (= temp___2167 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 n__first) temp___2167) (<= temp___2167 (to_rep1 n__last))))
(assert (= o64 temp___2167))
(assert (= o65 (select (map__content1 n7) o64)))
(assert (= o66 (to_rep1 o65)))
(assert (= o67 (* o66 1000)))
(assert (and (= o68 o67) (in_range1 o67)))
(assert (= o69 (- target3 o68)))
(assert (and (= o70 o69) (in_range1 o69)))
(assert (= result12 (mk_int__ref target3)))
(assert (= target4 o70))
(assert (<= (- 9999) target4))
(assert (and (= temp___2168 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 n__first) temp___2168) (<= temp___2168 (to_rep1 n__last))))
(assert (= o71 temp___2168))
(assert (= o72 (select (map__content1 n7) o71)))
(assert (= o73 (to_rep1 o72)))
(assert (= o74 (* o73 10000)))
(assert (and (= o75 o74) (in_range1 o74)))
(assert (= o76 (- target4 o75)))
(assert (and (= o77 o76) (in_range1 o76)))
(assert (= result13 (mk_int__ref target4)))
(assert (= target5 o77))
(assert (<= (- 99999) target5))
(assert (and (= temp___2169 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 n__first) temp___2169) (<= temp___2169 (to_rep1 n__last))))
(assert (= o78 temp___2169))
(assert (= o79 (select (map__content1 n7) o78)))
(assert (= o80 (to_rep1 o79)))
(assert (= o81 (* o80 100000)))
(assert (and (= o82 o81) (in_range1 o81)))
(assert (= o83 (- target5 o82)))
(assert (and (= o84 o83) (in_range1 o83)))
(assert (= result14 (mk_int__ref target5)))
(assert (= target6 o84))
(assert (<= (- 999999) target6))
(assert (and (= temp___2170 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 n__first) temp___2170) (<= temp___2170 (to_rep1 n__last))))
(assert (= o85 temp___2170))
(assert (= o86 (select (map__content1 n7) o85)))
(assert (= o87 (to_rep1 o86)))
(assert (= o88 (* o87 1000000)))
(assert (and (= o89 o88) (in_range1 o88)))
(assert (= o90 (- target6 o89)))
(assert (and (= o91 o90) (in_range1 o90)))
(assert (= result15 (mk_int__ref target6)))
(assert (= target7 o91))
(assert (<= (- 9999999) target7))
(assert (and (= temp___2171 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2171) (<= temp___2171 (to_rep1 n__last))))
(assert (= o92 temp___2171))
(assert (= o93 (select (map__content1 n7) o92)))
(assert (= o94 (to_rep1 o93)))
(assert (= o95 (* o94 10000000)))
(assert (and (= o96 o95) (in_range1 o95)))
(assert (= o97 (- target7 o96)))
(assert (and (= o98 o97) (in_range1 o97)))
(assert (= result16 (mk_int__ref target7)))
(assert (= target8 o98))
(assert (<= (- 99999999) target8))
(assert (and (= temp___2172 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2172) (<= temp___2172 (to_rep1 n__last))))
(assert (= o99 temp___2172))
(assert (= o100 (select (map__content1 n7) o99)))
(assert (= o101 (to_rep1 o100)))
(assert (= o102 (* o101 100000000)))
(assert (and (= o103 o102) (in_range1 o102)))
(assert (= o104 (- target8 o103)))
(assert (not (in_range1 o104)))
(check-sat)
(exit)
