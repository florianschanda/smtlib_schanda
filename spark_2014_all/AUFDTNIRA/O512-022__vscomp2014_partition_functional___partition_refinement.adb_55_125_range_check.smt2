...
(assert (and (= o6 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o6) (= o6 (ite (= (distinct 1 0) true) (to_rep3 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
...
(assert (= result true))
(assert (and (= o3 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o3) (<= o3 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
