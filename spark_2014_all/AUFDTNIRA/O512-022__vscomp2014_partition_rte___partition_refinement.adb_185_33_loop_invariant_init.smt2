...
(declare-const c4 us_rep4)
(assert (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields2)) c4) true))
(assert (not (= (to_rep (select a2 (element1 (mk___rep3 d__split_discrs d__split_fields2) c4))) (key (mk___rep3 d__split_discrs d__split_fields2) c4))))
(check-sat)
(exit)
