...
(assert (=> (and (<= early_pitch1 average3) (<= average3 pitch)) (and (= o6 (* (- pitch early_pitch1) 20)) (in_range1 (* (- pitch early_pitch1) 20)))))
(assert (=> (and (<= early_pitch1 average3) (<= average3 pitch)) (= o7 (div1 o6 10))))
(assert (=> (and (<= early_pitch1 average3) (<= average3 pitch)) (and (= o8 o7) (in_range2 o7))))
(assert (=> (and (<= early_pitch1 average3) (<= average3 pitch)) (= result8 (mk_int__ref present_pitchrate))))
(assert (=> (and (<= early_pitch1 average3) (<= average3 pitch)) (= present_pitchrate1 o8)))
(assert (=> (and (<= early_pitch1 average3) (<= average3 pitch)) (= present_pitchrate6 (mk_int__ref present_pitchrate1))))
(assert (=> (and (<= early_pitch1 average3) (<= average3 pitch)) (= present_pitchrate7 present_pitchrate1)))
(assert (=> (not (and (<= early_pitch1 average3) (<= average3 pitch))) (=> (and (<= average3 early_pitch1) (<= pitch average3)) (and (= o9 (* (- pitch early_pitch1) 10)) (in_range1 (* (- pitch early_pitch1) 10))))))
(assert (=> (not (and (<= early_pitch1 average3) (<= average3 pitch))) (=> (and (<= average3 early_pitch1) (<= pitch average3)) (= o10 (div1 o9 20)))))
(assert (=> (not (and (<= early_pitch1 average3) (<= average3 pitch))) (=> (and (<= average3 early_pitch1) (<= pitch average3)) (and (= o11 o10) (in_range2 o10)))))
(assert (=> (not (and (<= early_pitch1 average3) (<= average3 pitch))) (=> (and (<= average3 early_pitch1) (<= pitch average3)) (= result9 (mk_int__ref present_pitchrate)))))
(assert (=> (not (and (<= early_pitch1 average3) (<= average3 pitch))) (=> (and (<= average3 early_pitch1) (<= pitch average3)) (= present_pitchrate2 o11))))
(assert (=> (not (and (<= early_pitch1 average3) (<= average3 pitch))) (=> (and (<= average3 early_pitch1) (<= pitch average3)) (= present_pitchrate4 (mk_int__ref present_pitchrate2)))))
(assert (=> (not (and (<= early_pitch1 average3) (<= average3 pitch))) (=> (and (<= average3 early_pitch1) (<= pitch average3)) (= present_pitchrate5 present_pitchrate2))))
(assert (=> (not (and (<= early_pitch1 average3) (<= average3 pitch))) (=> (not (and (<= average3 early_pitch1) (<= pitch average3))) (= result10 (mk_int__ref present_pitchrate)))))
(assert (=> (not (and (<= early_pitch1 average3) (<= average3 pitch))) (=> (not (and (<= average3 early_pitch1) (<= pitch average3))) (= present_pitchrate3 0))))
(assert (=> (not (and (<= early_pitch1 average3) (<= average3 pitch))) (=> (not (and (<= average3 early_pitch1) (<= pitch average3))) (= present_pitchrate4 (mk_int__ref present_pitchrate3)))))
(assert (=> (not (and (<= early_pitch1 average3) (<= average3 pitch))) (=> (not (and (<= average3 early_pitch1) (<= pitch average3))) (= present_pitchrate5 present_pitchrate3))))
(assert (=> (not (and (<= early_pitch1 average3) (<= average3 pitch))) (= present_pitchrate6 present_pitchrate4)))
(assert (=> (not (and (<= early_pitch1 average3) (<= average3 pitch))) (= present_pitchrate7 present_pitchrate5)))
(assert (not (not (= 2 0))))
(check-sat)
(exit)
