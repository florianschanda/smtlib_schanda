...
(define-fun dynamic_invariant3 ((temp___expr_634 Int) (temp___is_init_630 Bool) (temp___skip_constant_631 Bool) (temp___do_toplevel_632 Bool) (temp___do_typ_inv_633 Bool)) Bool (=> (or (= temp___is_init_630 true) (<= 0 4294967295)) (in_range6 temp___expr_634)))
(declare-sort tryt 0)
...
(define-fun dynamic_invariant4 ((temp___expr_641 Int) (temp___is_init_637 Bool) (temp___skip_constant_638 Bool) (temp___do_toplevel_639 Bool) (temp___do_typ_inv_640 Bool)) Bool (=> (or (= temp___is_init_637 true) (<= 0 2)) (in_range7 temp___expr_641)))
...
(define-fun dynamic_invariant5 ((temp___expr_648 Int) (temp___is_init_644 Bool) (temp___skip_constant_645 Bool) (temp___do_toplevel_646 Bool) (temp___do_typ_inv_647 Bool)) Bool (=> (or (= temp___is_init_644 true) (<= 0 1)) (in_range8 temp___expr_648)))
...
(declare-fun temp___1365 (Int) (Array Int logfileindext))
(declare-fun temp___1369 (Int) (Array Int fileentrycountt))
(define-fun dynamic_invariant6 ((temp___expr_1359 us_rep3) (temp___is_init_1355 Bool) (temp___skip_constant_1356 Bool) (temp___do_toplevel_1357 Bool) (temp___do_typ_inv_1358 Bool)) Bool (=> (= temp___do_typ_inv_1358 true) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1359))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1359))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1359)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1359))) true)))
(define-fun default_initial_assumption ((temp___expr_1363 us_rep3) (temp___skip_top_level_1364 Bool)) Bool (and (and (and (= (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___expr_1363))) 1) (= (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___expr_1363))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___expr_1363)) (mk___rep2 (mk___split_fields2 (temp___1365 1) (of_rep6 1) (of_rep6 1) (of_rep8 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___expr_1363)) (temp___1369 0))))
(define-fun type_invariant ((temp___1373 us_rep3)) Bool (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields7 temp___1373))) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields7 temp___1373))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields7 temp___1373)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields7 temp___1373))) true))
...
(define-fun dynamic_invariant7 ((temp___expr_2148 Int) (temp___is_init_2144 Bool) (temp___skip_constant_2145 Bool) (temp___do_toplevel_2146 Bool) (temp___do_typ_inv_2147 Bool)) Bool (=> (or (= temp___is_init_2144 true) (<= 0 1)) (in_range26 temp___expr_2148)))
...
(define-fun dynamic_invariant8 ((temp___expr_2171 Int) (temp___is_init_2167 Bool) (temp___skip_constant_2168 Bool) (temp___do_toplevel_2169 Bool) (temp___do_typ_inv_2170 Bool)) Bool (=> (or (= temp___is_init_2167 true) (<= 0 1)) (in_range27 temp___expr_2171)))
...
(define-fun dynamic_invariant9 ((temp___expr_2887 Int) (temp___is_init_2883 Bool) (temp___skip_constant_2884 Bool) (temp___do_toplevel_2885 Bool) (temp___do_typ_inv_2886 Bool)) Bool (=> (or (= temp___is_init_2883 true) (<= 0 8)) (in_range29 temp___expr_2887)))
...
(define-fun dynamic_invariant10 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range19 temp___expr_74)))
(define-fun dynamic_invariant11 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 4)) (in_range3 temp___expr_496)))
(define-fun dynamic_invariant12 ((temp___expr_433 Int) (temp___is_init_429 Bool) (temp___skip_constant_430 Bool) (temp___do_toplevel_431 Bool) (temp___do_typ_inv_432 Bool)) Bool (=> (or (= temp___is_init_429 true) (<= 1 3)) (in_range5 temp___expr_433)))
(define-fun dynamic_invariant13 ((temp___expr_440 Int) (temp___is_init_436 Bool) (temp___skip_constant_437 Bool) (temp___do_toplevel_438 Bool) (temp___do_typ_inv_439 Bool)) Bool (=> (or (= temp___is_init_436 true) (<= 0 5)) (in_range21 temp___expr_440)))
(define-fun dynamic_invariant14 ((temp___expr_548 Int) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool) (temp___do_typ_inv_547 Bool)) Bool (=> (or (= temp___is_init_544 true) (<= 0 40)) (in_range18 temp___expr_548)))
(define-fun dynamic_invariant15 ((temp___expr_572 Int) (temp___is_init_568 Bool) (temp___skip_constant_569 Bool) (temp___do_toplevel_570 Bool) (temp___do_typ_inv_571 Bool)) Bool (=> (or (= temp___is_init_568 true) (<= 0 4294967295)) (in_range20 temp___expr_572)))
(define-fun dynamic_invariant16 ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= 0 10)) (in_range22 temp___expr_596)))
(define-fun dynamic_invariant17 ((temp___expr_610 Int) (temp___is_init_606 Bool) (temp___skip_constant_607 Bool) (temp___do_toplevel_608 Bool) (temp___do_typ_inv_609 Bool)) Bool (=> (or (= temp___is_init_606 true) (<= 0 4294967295)) (in_range24 temp___expr_610)))
(define-fun dynamic_invariant18 ((temp___expr_617 Int) (temp___is_init_613 Bool) (temp___skip_constant_614 Bool) (temp___do_toplevel_615 Bool) (temp___do_typ_inv_616 Bool)) Bool (=> (or (= temp___is_init_613 true) (<= 0 128)) (in_range25 temp___expr_617)))
(define-fun dynamic_invariant19 ((temp___expr_1297 Int) (temp___is_init_1293 Bool) (temp___skip_constant_1294 Bool) (temp___do_toplevel_1295 Bool) (temp___do_typ_inv_1296 Bool)) Bool (=> (or (= temp___is_init_1293 true) (<= 0 17)) (in_range15 temp___expr_1297)))
(define-fun dynamic_invariant20 ((temp___expr_1304 Int) (temp___is_init_1300 Bool) (temp___skip_constant_1301 Bool) (temp___do_toplevel_1302 Bool) (temp___do_typ_inv_1303 Bool)) Bool (=> (or (= temp___is_init_1300 true) (<= 1 17)) (in_range13 temp___expr_1304)))
(define-fun dynamic_invariant21 ((temp___expr_1430 Int) (temp___is_init_1426 Bool) (temp___skip_constant_1427 Bool) (temp___do_toplevel_1428 Bool) (temp___do_typ_inv_1429 Bool)) Bool (=> (or (= temp___is_init_1426 true) (<= 0 2)) (in_range17 temp___expr_1430)))
(define-fun dynamic_invariant22 ((temp___expr_1311 Int) (temp___is_init_1307 Bool) (temp___skip_constant_1308 Bool) (temp___do_toplevel_1309 Bool) (temp___do_typ_inv_1310 Bool)) Bool (=> (or (= temp___is_init_1307 true) (<= 0 17408)) (in_range14 temp___expr_1311)))
(define-fun dynamic_invariant23 ((temp___expr_1342 Int) (temp___is_init_1338 Bool) (temp___skip_constant_1339 Bool) (temp___do_toplevel_1340 Bool) (temp___do_typ_inv_1341 Bool)) Bool (=> (or (= temp___is_init_1338 true) (<= 0 1024)) (in_range16 temp___expr_1342)))
(assert true)
...
(assert (forall ((temp___1371 Int)) (=> (dynamic_invariant23 temp___1371 true true true true) (forall ((temp___1372 Int)) (= (to_rep9 (select (temp___1369 temp___1371) temp___1372)) temp___1371)))))
(define-fun dynamic_invariant24 ((temp___expr_725 Int) (temp___is_init_721 Bool) (temp___skip_constant_722 Bool) (temp___do_toplevel_723 Bool) (temp___do_typ_inv_724 Bool)) Bool (=> (or (= temp___is_init_721 true) (<= 1901 2099)) (in_range9 temp___expr_725)))
(define-fun dynamic_invariant25 ((temp___expr_732 Int) (temp___is_init_728 Bool) (temp___skip_constant_729 Bool) (temp___do_toplevel_730 Bool) (temp___do_typ_inv_731 Bool)) Bool (=> (or (= temp___is_init_728 true) (<= 1 12)) (in_range10 temp___expr_732)))
(define-fun dynamic_invariant26 ((temp___expr_739 Int) (temp___is_init_735 Bool) (temp___skip_constant_736 Bool) (temp___do_toplevel_737 Bool) (temp___do_typ_inv_738 Bool)) Bool (=> (or (= temp___is_init_735 true) (<= 1 31)) (in_range11 temp___expr_739)))
(define-fun dynamic_invariant27 ((temp___expr_771 Int) (temp___is_init_767 Bool) (temp___skip_constant_768 Bool) (temp___do_toplevel_769 Bool) (temp___do_typ_inv_770 Bool)) Bool (=> (or (= temp___is_init_767 true) (<= 0 86399999)) (in_range12 temp___expr_771)))
(assert true)
...
(define-fun dynamic_invariant28 ((temp___expr_1603 Int) (temp___is_init_1599 Bool) (temp___skip_constant_1600 Bool) (temp___do_toplevel_1601 Bool) (temp___do_typ_inv_1602 Bool)) Bool (=> (or (= temp___is_init_1599 true) (<= 0 4294967295)) (in_range23 temp___expr_1603)))
...
(define-fun dynamic_invariant29 ((temp___expr_2974 Int) (temp___is_init_2970 Bool) (temp___skip_constant_2971 Bool) (temp___do_toplevel_2972 Bool) (temp___do_typ_inv_2973 Bool)) Bool (=> (or (= temp___is_init_2970 true) (<= 0 2)) (in_range30 temp___expr_2974)))
(define-fun dynamic_invariant30 ((temp___expr_2376 Int) (temp___is_init_2372 Bool) (temp___skip_constant_2373 Bool) (temp___do_toplevel_2374 Bool) (temp___do_typ_inv_2375 Bool)) Bool (=> (or (= temp___is_init_2372 true) (<= 0 2147483647)) (in_range28 temp___expr_2376)))
(assert (forall ((temp___1367 Int)) (=> (dynamic_invariant20 temp___1367 true true true true) (forall ((temp___1368 Int)) (= (to_rep6 (select (temp___1365 temp___1367) temp___1368)) temp___1367)))))
...
(assert (and (and (and (and (and (and (and (and (and (and (and (= (not (= (enrolmentisinprogress status1 (let ((subject state4)) state8)) true)) (= (privatekeypresent thistisinfo__split_fields (let ((subject state)) state5)) true)) (or (= (enrolmentisinprogress status1 (let ((subject state4)) state8)) true) (= (statusisenclavequiescent status1 (let ((subject state4)) state8)) true))) (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields1))) true))) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields1))) true))) (not (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields1))) 1))) (not (= (statusiswaitingstartadminop status1 (let ((subject state4)) state8)) true))) (not (= (statusiswaitingfinishadminop status1 (let ((subject state4)) state8)) true))) (not (= (statusisshutdown status1 (let ((subject state4)) state8)) true))) (not (= (isgood tokenpresence1 (let ((subject state1)) state6) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true))) (not (= (authcertvalid tokenpresence1 (let ((subject state1)) state6) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) true))) (not (= (theauthcertrole tokenpresence1 (let ((subject state1)) state6) tokentry1 tokenid1 (let ((subject authcert__split_fields)) authcert__split_fields1) (let ((subject idcert__split_fields)) idcert__split_fields1)) 1))) (and (and (and (and (and (and (in_range8 auditalarm1) (in_range26 currentlatch1)) (in_range7 tokentry1)) (in_range29 status1)) (in_range6 tokenid1)) (in_range1 tokenpresence1)) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true))))
(assert (= (= (islocked currentlatch1 (let ((subject state2)) state7) latchtimeout__split_fields) true) (= (latchislocked Tuple0) true)))
(assert (and (and (and (and (and (and (and (and (and (and (and (= (not (= (enrolmentisinprogress status2 (let ((subject state4)) state12)) true)) (= (privatekeypresent thistisinfo__split_fields1 (let ((subject state)) state9)) true)) (= (= (islocked currentlatch2 (let ((subject state2)) state11) latchtimeout__split_fields1) true) (= (latchislocked Tuple0) true))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 1) (and (and (= (isgood tokenpresence2 (let ((subject state1)) state10) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true) (= (authcertvalid tokenpresence2 (let ((subject state1)) state10) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true)) (= (theauthcertrole tokenpresence2 (let ((subject state1)) state10) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) 1)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 3)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 1))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 1) (or (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 3)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true))))) (=> (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 4)) (= (statusiswaitingstartadminop status2 (let ((subject state4)) state12)) true))) (=> (or (= (statusisgotadmintoken status2 (let ((subject state4)) state12)) true) (= (statusiswaitingremoveadmintokenfail status2 (let ((subject state4)) state12)) true)) (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)))) (=> (or (= (statusiswaitingstartadminop status2 (let ((subject state4)) state12)) true) (= (statusiswaitingfinishadminop status2 (let ((subject state4)) state12)) true)) (and (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true) (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)))) (=> (= (statusisenclavequiescent status2 (let ((subject state4)) state12)) true) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)))) (=> (= (statusisshutdown status2 (let ((subject state4)) state12)) true) (and (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) 0)))) (=> (= (enrolmentisinprogress status2 (let ((subject state4)) state12)) true) (and (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))) true))))))
...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (not (= (enrolmentisinprogress status3 (let ((subject state4)) state17)) true)) (= (privatekeypresent thistisinfo__split_fields2 (let ((subject state)) state13)) true)) (or (= (= (islocked currentlatch3 (let ((subject state2)) state15) latchtimeout__split_fields2) true) (= (latchislocked Tuple0) true)) (= (let ((subject systemfault)) systemfault1) true))) (=> (and (and (= (islocked currentlatch3 (let ((subject state2)) state15) latchtimeout__split_fields2) true) (= (thecurrentdoor (let ((subject state3)) state16)) 0)) (= (greaterthanorequal (thecurrenttime currenttimevar__split_fields (let ((subject currenttime)) currenttime1)) (alarm_timeout (let ((subject state3)) state16))) true)) (or (= (isalarming Tuple0) true) (= (let ((subject systemfault)) systemfault1) true)))) (or (not (and (and (and (= (latchislocked Tuple0) true) (not (= (latchislocked Tuple0) true))) (not (= (islocked currentlatch3 (let ((subject state2)) state15) latchtimeout__split_fields2) true))) (= (= (islocked currentlatch2 (let ((subject state2)) state11) latchtimeout__split_fields1) true) (= (latchislocked Tuple0) true)))) (or (or (or (= (islocked currentlatch2 (let ((subject state2)) state11) latchtimeout__split_fields1) true) (not (= (islocked currentlatch3 (let ((subject state2)) state15) latchtimeout__split_fields2) true))) (and (and (= (isgood tokenpresence3 (let ((subject state1)) state14) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) true) (= (authcertvalid tokenpresence3 (let ((subject state1)) state14) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) true)) (= (theauthcertrole tokenpresence3 (let ((subject state1)) state14) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) 1))) (= (let ((subject systemfault)) systemfault1) true)))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 1) (and (and (= (isgood tokenpresence3 (let ((subject state1)) state14) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) true) (= (authcertvalid tokenpresence3 (let ((subject state1)) state14) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) true)) (= (theauthcertrole tokenpresence3 (let ((subject state1)) state14) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) 1)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 3)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 1))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 1) (or (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 3)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true))))) (=> (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 4)) (= (statusiswaitingstartadminop status3 (let ((subject state4)) state17)) true))) (=> (or (= (statusisgotadmintoken status3 (let ((subject state4)) state17)) true) (= (statusiswaitingremoveadmintokenfail status3 (let ((subject state4)) state17)) true)) (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)))) (=> (or (= (statusiswaitingstartadminop status3 (let ((subject state4)) state17)) true) (= (statusiswaitingfinishadminop status3 (let ((subject state4)) state17)) true)) (and (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true) (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))) (=> (= (statusisenclavequiescent status3 (let ((subject state4)) state17)) true) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)))) (=> (= (statusisshutdown status3 (let ((subject state4)) state17)) true) (and (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 0)))) (=> (= (enrolmentisinprogress status3 (let ((subject state4)) state17)) true) (and (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true))))) (and (and (and (and (and (and (in_range8 auditalarm3) (in_range26 currentlatch3)) (in_range7 tokentry3)) (in_range29 status3)) (in_range6 tokenid3)) (in_range1 tokenpresence3)) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true))))
(assert (= o (hasshutdown status3 (let ((subject state4)) state17))))
(assert (= result (let ((subject shutdowncompleted)) (mk_bool__ref shutdowncompleted1))))
(assert (= (let ((subject shutdowncompleted)) shutdowncompleted2) o))
(assert (not (= (let ((subject shutdowncompleted)) shutdowncompleted2) true)))
(assert (and (= result1 (enrolmentisinprogress status3 (let ((subject state4)) state17))) (= (= result1 true) (in_range30 status3))))
(assert (=> (= result1 true) (and (= o18 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o18 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result1 true) (= o19 (ite (not (= o18 true)) true false))))
(assert (=> (= result1 true) (and (= o17 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o17 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result1 true) (= o20 (ite (not (= o17 true)) true false))))
(assert (=> (= result1 true) (= o21 (ite (= o20 true) o19 false))))
(assert (=> (not (= result1 true)) (= o21 (distinct 1 0))))
(assert (and (= result2 (statusisshutdown status3 (let ((subject state4)) state17))) (= (= result2 true) (= status3 8))))
(assert (=> (= result2 true) (and (= o13 (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (and (in_range2 o13) (= o13 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result2 true) (= o14 (ite (= o13 0) true false))))
(assert (=> (= result2 true) (and (= o12 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o12 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result2 true) (= o15 (ite (not (= o12 true)) true false))))
(assert (=> (= result2 true) (= o16 (ite (= o15 true) o14 false))))
(assert (=> (not (= result2 true)) (= o16 (distinct 1 0))))
(assert (and (= result3 (statusisenclavequiescent status3 (let ((subject state4)) state17))) (= (= result3 true) (= status3 3))))
(assert (=> (= result3 true) (and (= o10 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o10 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result3 true) (= o11 (ite (not (= o10 true)) true false))))
(assert (=> (not (= result3 true)) (= o11 (distinct 1 0))))
(assert (and (= o5 (statusiswaitingfinishadminop status3 (let ((subject state4)) state17))) (= (= o5 true) (= status3 7))))
(assert (and (= o6 (statusiswaitingstartadminop status3 (let ((subject state4)) state17))) (= (= o6 true) (= status3 6))))
(assert (= result4 (ite (= o6 false) o5 true)))
(assert (=> (= result4 true) (and (= o7 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o7 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result4 true) (and (= o8 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o8 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result4 true) (= o9 (ite (= o8 true) o7 false))))
(assert (=> (not (= result4 true)) (= o9 (distinct 1 0))))
(assert (and (= o1 (statusiswaitingremoveadmintokenfail status3 (let ((subject state4)) state17))) (= (= o1 true) (= status3 4))))
(assert (and (= o2 (statusisgotadmintoken status3 (let ((subject state4)) state17))) (= (= o2 true) (= status3 5))))
(assert (= result5 (ite (= o2 false) o1 true)))
(assert (=> (= result5 true) (and (= o3 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o3 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result5 true) (= o4 (ite (not (= o3 true)) true false))))
(assert (=> (not (= result5 true)) (= o4 (distinct 1 0))))
(assert (and (= result6 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= result6 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3)))))))
(assert (= result6 true))
(assert (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)))
(check-sat)
(exit)
