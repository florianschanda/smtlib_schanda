...
(assert (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (not (= (enrolmentisinprogress status3 (let ((subject state7)) state23)) true)) (= (privatekeypresent thistisinfo__split_fields2 (let ((subject state1)) state17)) true)) (or (= (= (islocked currentlatch3 (let ((subject state3)) state19) latchtimeout__split_fields2) true) (= (latchislocked Tuple0) true)) (= (let ((subject systemfault)) systemfault1) true))) (=> (and (and (= (islocked currentlatch3 (let ((subject state3)) state19) latchtimeout__split_fields2) true) (= (thecurrentdoor (let ((subject state4)) state20)) 0)) (= (greaterthanorequal (thecurrenttime currenttimevar__split_fields (let ((subject currenttime)) currenttime1)) (alarm_timeout (let ((subject state4)) state20))) true)) (or (= (isalarming Tuple0) true) (= (let ((subject systemfault)) systemfault1) true)))) (or (not (and (and (and (= (latchislocked Tuple0) true) (not (= (latchislocked Tuple0) true))) (not (= (islocked currentlatch3 (let ((subject state3)) state19) latchtimeout__split_fields2) true))) (= (= (islocked currentlatch2 (let ((subject state3)) state14) latchtimeout__split_fields1) true) (= (latchislocked Tuple0) true)))) (or (or (or (= (islocked currentlatch2 (let ((subject state3)) state14) latchtimeout__split_fields1) true) (not (= (islocked currentlatch3 (let ((subject state3)) state19) latchtimeout__split_fields2) true))) (and (and (= (isgood tokenpresence3 (let ((subject state2)) state18) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) true) (= (authcertvalid tokenpresence3 (let ((subject state2)) state18) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) true)) (= (theauthcertrole tokenpresence3 (let ((subject state2)) state18) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) 1))) (= (let ((subject systemfault)) systemfault1) true)))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 1) (and (and (= (isgood tokenpresence3 (let ((subject state2)) state18) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) true) (= (authcertvalid tokenpresence3 (let ((subject state2)) state18) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) true)) (= (theauthcertrole tokenpresence3 (let ((subject state2)) state18) tokentry3 tokenid3 (let ((subject authcert__split_fields)) authcert__split_fields3) (let ((subject idcert__split_fields)) idcert__split_fields3)) 1)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 3)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 1))) (=> (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 1) (or (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 3)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true))))) (=> (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)))) (=> (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true) (= (thecurrentop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 4)) (= (statusiswaitingstartadminop status3 (let ((subject state7)) state23)) true))) (=> (or (= (statusisgotadmintoken status3 (let ((subject state7)) state23)) true) (= (statusiswaitingremoveadmintokenfail status3 (let ((subject state7)) state23)) true)) (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)))) (=> (or (= (statusiswaitingstartadminop status3 (let ((subject state7)) state23)) true) (= (statusiswaitingfinishadminop status3 (let ((subject state7)) state23)) true)) (and (and (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true) (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields2))))))) (=> (= (statusisenclavequiescent status3 (let ((subject state7)) state23)) true) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)))) (=> (= (statusisshutdown status3 (let ((subject state7)) state23)) true) (and (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)) (= (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) 0)))) (=> (= (enrolmentisinprogress status3 (let ((subject state7)) state23)) true) (and (not (= (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true)) (not (= (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3))) true))))) (and (and (and (and (and (and (in_range8 auditalarm3) (in_range26 currentlatch3)) (in_range7 tokentry3)) (in_range29 status3)) (in_range6 tokenid3)) (in_range1 tokenpresence3)) (= (valid_numberlogentries (to_rep6 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep7 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true))))
(assert (= o33 (hasshutdown status3 (let ((subject state7)) state23))))
(assert (= result11 (let ((subject shutdowncompleted)) (mk_bool__ref shutdowncompleted1))))
(assert (= (let ((subject shutdowncompleted)) shutdowncompleted2) o33))
(assert (not (= (let ((subject shutdowncompleted)) shutdowncompleted2) true)))
(assert (and (= result12 (enrolmentisinprogress status3 (let ((subject state7)) state23))) (= (= result12 true) (in_range30 status3))))
(assert (=> (= result12 true) (and (= o63 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o63 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result12 true) (= o64 (ite (not (= o63 true)) true false))))
(assert (=> (= result12 true) (and (= o62 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o62 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result12 true) (= o65 (ite (not (= o62 true)) true false))))
(assert (=> (= result12 true) (= o66 (ite (= o65 true) o64 false))))
(assert (=> (not (= result12 true)) (= o66 (of_int 1))))
(assert (and (= result13 (statusisshutdown status3 (let ((subject state7)) state23))) (= (= result13 true) (= status3 8))))
(assert (=> (= result13 true) (and (= o58 (rolepresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (and (in_range2 o58) (= o58 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result13 true) (= o59 (ite (= o58 0) true false))))
(assert (=> (= result13 true) (and (= o57 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o57 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result13 true) (= o60 (ite (not (= o57 true)) true false))))
(assert (=> (= result13 true) (= o61 (ite (= o60 true) o59 false))))
(assert (=> (not (= result13 true)) (= o61 (of_int 1))))
(assert (and (= result14 (statusisenclavequiescent status3 (let ((subject state7)) state23))) (= (= result14 true) (= status3 3))))
(assert (=> (= result14 true) (and (= o55 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o55 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result14 true) (= o56 (ite (not (= o55 true)) true false))))
(assert (=> (not (= result14 true)) (= o56 (of_int 1))))
(assert (and (= o50 (statusiswaitingfinishadminop status3 (let ((subject state7)) state23))) (= (= o50 true) (= status3 7))))
(assert (and (= o51 (statusiswaitingstartadminop status3 (let ((subject state7)) state23))) (= (= o51 true) (= status3 6))))
(assert (= result15 (ite (= o51 false) o50 true)))
(assert (=> (= result15 true) (and (= o52 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o52 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result15 true) (and (= o53 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o53 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result15 true) (= o54 (ite (= o53 true) o52 false))))
(assert (=> (not (= result15 true)) (= o54 (of_int 1))))
(assert (and (= o46 (statusiswaitingremoveadmintokenfail status3 (let ((subject state7)) state23))) (= (= o46 true) (= status3 4))))
(assert (and (= o47 (statusisgotadmintoken status3 (let ((subject state7)) state23))) (= (= o47 true) (= status3 5))))
(assert (= result16 (ite (= o47 false) o46 true)))
(assert (=> (= result16 true) (and (= o48 (ispresent (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= o48 true) (in_range5 (to_rep (rec__admin__t__rolepresent (let ((subject theadmin__split_fields)) theadmin__split_fields3))))))))
(assert (=> (= result16 true) (= o49 (ite (not (= o48 true)) true false))))
(assert (=> (not (= result16 true)) (= o49 (of_int 1))))
(assert (and (= result18 (isdoingop (mk___rep (let ((subject theadmin__split_fields)) theadmin__split_fields3)))) (= (= result18 true) (in_range4 (to_rep1 (rec__admin__t__currentop (let ((subject theadmin__split_fields)) theadmin__split_fields3)))))))
