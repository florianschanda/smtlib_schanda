...
(declare-const temp___1907 Int)
(declare-const o Int)
(declare-const o1 character)
(declare-const o2 Int)
(declare-const o3 Int)
(declare-const o4 Int)
(declare-const temp___1908 Int)
...
(assert (=> (not (= (length source) 1)) (=> (not (= (length source) 2)) (=> (not (= (length source) 3)) (=> (not (= (length source) 4)) (=> (not (= (length source) 5)) (=> (not (= (length source) 6)) (=> (not (= (length source) 7)) (=> (not (= (length source) 8)) (=> (not (= (length source) 9)) (= has_failed10 (distinct 1 0))))))))))))
...
(assert (and (= temp___1915 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1915) (<= temp___1915 (to_rep1 (last (rt source))))))
(assert (= o47 temp___1915))
...
(assert (and (= temp___1914 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1914) (<= temp___1914 (to_rep1 (last (rt source))))))
(assert (= o41 temp___1914))
(assert (= o42 (select (elts source) o41)))
(assert (= o43 (to_rep o42)))
(assert (and (= o44 (convert_character_digit_to_integer o43)) (and (in_range1 o44) (and (and (<= 0 o44) (<= o44 9)) (ite (= (= o43 48) true) (= o44 0) (ite (= (= o43 49) true) (= o44 1) (ite (= (= o43 50) true) (= o44 2) (ite (= (= o43 51) true) (= o44 3) (ite (= (= o43 52) true) (= o44 4) (ite (= (= o43 53) true) (= o44 5) (ite (= (= o43 54) true) (= o44 6) (ite (= (= o43 55) true) (= o44 7) (ite (= (= o43 56) true) (= o44 8) (=> (= (= o43 57) true) (= o44 9)))))))))))))))
(assert (= o45 (* o44 10)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (and (= temp___1913 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1913) (<= temp___1913 (to_rep1 (last (rt source))))))
(assert (= o35 temp___1913))
(assert (= o36 (select (elts source) o35)))
(assert (= o37 (to_rep o36)))
(assert (and (= o38 (convert_character_digit_to_integer o37)) (and (in_range1 o38) (and (and (<= 0 o38) (<= o38 9)) (ite (= (= o37 48) true) (= o38 0) (ite (= (= o37 49) true) (= o38 1) (ite (= (= o37 50) true) (= o38 2) (ite (= (= o37 51) true) (= o38 3) (ite (= (= o37 52) true) (= o38 4) (ite (= (= o37 53) true) (= o38 5) (ite (= (= o37 54) true) (= o38 6) (ite (= (= o37 55) true) (= o38 7) (ite (= (= o37 56) true) (= o38 8) (=> (= (= o37 57) true) (= o38 9)))))))))))))))
(assert (= o39 (* o38 100)))
(assert (and (= o40 o39) (in_range1 o39)))
(assert (and (= temp___1912 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1912) (<= temp___1912 (to_rep1 (last (rt source))))))
(assert (= o29 temp___1912))
(assert (= o30 (select (elts source) o29)))
(assert (= o31 (to_rep o30)))
(assert (and (= o32 (convert_character_digit_to_integer o31)) (and (in_range1 o32) (and (and (<= 0 o32) (<= o32 9)) (ite (= (= o31 48) true) (= o32 0) (ite (= (= o31 49) true) (= o32 1) (ite (= (= o31 50) true) (= o32 2) (ite (= (= o31 51) true) (= o32 3) (ite (= (= o31 52) true) (= o32 4) (ite (= (= o31 53) true) (= o32 5) (ite (= (= o31 54) true) (= o32 6) (ite (= (= o31 55) true) (= o32 7) (ite (= (= o31 56) true) (= o32 8) (=> (= (= o31 57) true) (= o32 9)))))))))))))))
(assert (= o33 (* o32 1000)))
(assert (and (= o34 o33) (in_range1 o33)))
(assert (and (= temp___1911 (+ (to_rep1 (first (rt source))) 4)) (in_range1 (+ (to_rep1 (first (rt source))) 4))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1911) (<= temp___1911 (to_rep1 (last (rt source))))))
(assert (= o23 temp___1911))
(assert (= o24 (select (elts source) o23)))
(assert (= o25 (to_rep o24)))
(assert (and (= o26 (convert_character_digit_to_integer o25)) (and (in_range1 o26) (and (and (<= 0 o26) (<= o26 9)) (ite (= (= o25 48) true) (= o26 0) (ite (= (= o25 49) true) (= o26 1) (ite (= (= o25 50) true) (= o26 2) (ite (= (= o25 51) true) (= o26 3) (ite (= (= o25 52) true) (= o26 4) (ite (= (= o25 53) true) (= o26 5) (ite (= (= o25 54) true) (= o26 6) (ite (= (= o25 55) true) (= o26 7) (ite (= (= o25 56) true) (= o26 8) (=> (= (= o25 57) true) (= o26 9)))))))))))))))
(assert (= o27 (* o26 10000)))
(assert (and (= o28 o27) (in_range1 o27)))
(assert (and (= temp___1910 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1910) (<= temp___1910 (to_rep1 (last (rt source))))))
(assert (= o17 temp___1910))
(assert (= o18 (select (elts source) o17)))
(assert (= o19 (to_rep o18)))
(assert (and (= o20 (convert_character_digit_to_integer o19)) (and (in_range1 o20) (and (and (<= 0 o20) (<= o20 9)) (ite (= (= o19 48) true) (= o20 0) (ite (= (= o19 49) true) (= o20 1) (ite (= (= o19 50) true) (= o20 2) (ite (= (= o19 51) true) (= o20 3) (ite (= (= o19 52) true) (= o20 4) (ite (= (= o19 53) true) (= o20 5) (ite (= (= o19 54) true) (= o20 6) (ite (= (= o19 55) true) (= o20 7) (ite (= (= o19 56) true) (= o20 8) (=> (= (= o19 57) true) (= o20 9)))))))))))))))
(assert (= o21 (* o20 100000)))
(assert (and (= o22 o21) (in_range1 o21)))
(assert (and (= temp___1909 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1909) (<= temp___1909 (to_rep1 (last (rt source))))))
(assert (= o11 temp___1909))
(assert (= o12 (select (elts source) o11)))
(assert (= o13 (to_rep o12)))
(assert (and (= o14 (convert_character_digit_to_integer o13)) (and (in_range1 o14) (and (and (<= 0 o14) (<= o14 9)) (ite (= (= o13 48) true) (= o14 0) (ite (= (= o13 49) true) (= o14 1) (ite (= (= o13 50) true) (= o14 2) (ite (= (= o13 51) true) (= o14 3) (ite (= (= o13 52) true) (= o14 4) (ite (= (= o13 53) true) (= o14 5) (ite (= (= o13 54) true) (= o14 6) (ite (= (= o13 55) true) (= o14 7) (ite (= (= o13 56) true) (= o14 8) (=> (= (= o13 57) true) (= o14 9)))))))))))))))
(assert (= o15 (* o14 1000000)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (and (= temp___1908 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1908) (<= temp___1908 (to_rep1 (last (rt source))))))
(assert (= o5 temp___1908))
...
(assert (= o9 (* o8 10000000)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (and (= temp___1907 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1907) (<= temp___1907 (to_rep1 (last (rt source))))))
(assert (= o temp___1907))
