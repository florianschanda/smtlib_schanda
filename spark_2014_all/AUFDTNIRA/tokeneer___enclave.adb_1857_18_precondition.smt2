...
(assert (=> (= result11 true) (and (= o21 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (= (= o21 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields5))))))))
(assert (=> (= result11 true) (= o22 (ite (not (= o21 true)) true false))))
(assert (=> (= result11 true) (and (= result12 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (= (= result12 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields5))))))))
(assert (=> (= result11 true) (=> (= result12 true) (and (= o20 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (in_range4 o20)))))
(assert (=> (= result11 true) (=> (= result12 true) (= o23 (ite (= o20 3) true false)))))
(assert (=> (= result11 true) (=> (not (= result12 true)) (= o23 false))))
(assert (=> (= result11 true) (= o24 (ite (= o23 false) o22 true))))
(assert (=> (not (= result11 true)) (= o24 (of_int 1))))
(assert (and (= result13 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields5)))) (= (= result13 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields5)))))))
