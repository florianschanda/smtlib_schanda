...
(assert (and (= temp___1791 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1791) (<= temp___1791 (to_rep1 (last (rt source))))))
(assert (= o157 temp___1791))
(assert (= o158 (select (elts source) o157)))
(assert (= o159 (to_rep o158)))
(assert (and (= o160 (convert_character_digit_to_integer o159)) (and (in_range1 o160) (and (and (<= 0 o160) (<= o160 9)) (ite (= (= o159 48) true) (= o160 0) (ite (= (= o159 49) true) (= o160 1) (ite (= (= o159 50) true) (= o160 2) (ite (= (= o159 51) true) (= o160 3) (ite (= (= o159 52) true) (= o160 4) (ite (= (= o159 53) true) (= o160 5) (ite (= (= o159 54) true) (= o160 6) (ite (= (= o159 55) true) (= o160 7) (ite (= (= o159 56) true) (= o160 8) (=> (= (= o159 57) true) (= o160 9)))))))))))))))
(assert (= o161 (* o160 100000)))
(assert (and (= o162 o161) (in_range1 o161)))
(assert (and (= temp___1790 (+ (to_rep1 (first (rt source))) 0)) (in_range1 (+ (to_rep1 (first (rt source))) 0))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1790) (<= temp___1790 (to_rep1 (last (rt source))))))
(assert (= o152 temp___1790))
(assert (= o153 (select (elts source) o152)))
(assert (= o154 (to_rep o153)))
(assert (and (= o155 (convert_character_digit_to_integer o154)) (and (in_range1 o155) (and (and (<= 0 o155) (<= o155 9)) (ite (= (= o154 48) true) (= o155 0) (ite (= (= o154 49) true) (= o155 1) (ite (= (= o154 50) true) (= o155 2) (ite (= (= o154 51) true) (= o155 3) (ite (= (= o154 52) true) (= o155 4) (ite (= (= o154 53) true) (= o155 5) (ite (= (= o154 54) true) (= o155 6) (ite (= (= o154 55) true) (= o155 7) (ite (= (= o154 56) true) (= o155 8) (=> (= (= o154 57) true) (= o155 9)))))))))))))))
(assert (= o156 (* o155 1000000)))
(assert (and (= o163 o156) (in_range1 o156)))
(assert (= o164 (+ o163 o162)))
(assert (and (= o171 o164) (in_range1 o164)))
(assert (= o172 (+ o171 o170)))
(assert (and (= o179 o172) (in_range1 o172)))
(assert (= o180 (+ o179 o178)))
(assert (and (= o187 o180) (in_range1 o180)))
(assert (= o188 (+ o187 o186)))
(assert (and (= o195 o188) (in_range1 o188)))
(assert (= o196 (+ o195 o194)))
(assert (and (= o203 o196) (in_range1 o196)))
(assert (= o204 (+ o203 o202)))
(assert (not (in_range1 o204)))
(check-sat)
(exit)
