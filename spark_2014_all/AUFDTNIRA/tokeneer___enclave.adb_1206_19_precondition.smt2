...
(assert (=> (= result8 true) (and (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true) (in_range9 auditalarm1))))
(assert (=> (= result8 true) (and (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true) (in_range9 auditalarm2))))
(assert (=> (= result8 true) (= result9 (mk_int__ref status))))
(assert (=> (= result8 true) (= status2 8)))
(assert (=> (= result8 true) (and (and (= (and (and (= (islocked currentlatch2 (let ((subject state2)) state14) latchtimeout__split_fields5) true) (= (thecurrentdoor (let ((subject state3)) state15)) 0)) (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (alarm_timeout (let ((subject state3)) state15))) true)) (= (thedooralarm (let ((subject state3)) state15)) 0)) (= (islocked currentlatch2 (let ((subject state2)) state14) latchtimeout__split_fields5) true)) (and (and (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true) (in_range9 auditalarm3)) (in_range29 currentlatch2)))))
