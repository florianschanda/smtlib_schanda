...
(assert (and (= o23 (thecurrentdoor (us_private__content state3))) (in_range30 o23)))
(assert (= result8 (ite (= o23 1) true false)))
(assert (=> (= result8 true) (and (in_range9 auditalarm1) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true))))
(assert (=> (= result8 true) (and (in_range9 auditalarm2) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true))))
(assert (=> (= result8 true) (= result9 (mk_int__ref status))))
(assert (=> (= result8 true) (= status2 8)))
(assert (=> (= result8 true) (and (and (= (and (and (= (islocked currentlatch2 (let ((subject state2)) state14) latchtimeout__split_fields5) true) (= (thecurrentdoor (let ((subject state3)) state15)) 0)) (= (greaterthanorequal (thecurrenttime (mk___split_fields1 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) currenttime) (alarm_timeout (let ((subject state3)) state15))) true)) (= (thedooralarm (let ((subject state3)) state15)) 0)) (= (islocked currentlatch2 (let ((subject state2)) state14) latchtimeout__split_fields5) true)) (and (and (in_range9 auditalarm3) (in_range29 currentlatch2)) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9)) true)))))
(assert (=> (= result8 true) (and (not (= (ispresent (mk___rep theadmin__split_fields3)) true)) (not (= (isdoingop (mk___rep theadmin__split_fields3)) true)))))
(assert (=> (= result8 true) (= o24 (extractuser tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)))))
(assert (=> (= result8 true) (and (in_range9 auditalarm4) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true))))
(assert (=> (= result8 true) (and (and (not (= (isgood tokenpresence2 (let ((subject state1)) state18) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true)) (and (not (= (authcertvalid tokenpresence2 (let ((subject state1)) state18) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)) true)) (not (in_range8 (theauthcertrole tokenpresence2 (let ((subject state1)) state18) tokentry2 tokenid2 (let ((subject authcert__split_fields)) authcert__split_fields2) (let ((subject idcert__split_fields)) idcert__split_fields2)))))) (and (and (in_range21 tokentry2) (in_range20 tokenid2)) (in_range4 tokenpresence2)))))
(assert (=> (not (= result8 true)) (and (in_range9 auditalarm5) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields11)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields11)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields11)) true))))
(assert (=> (not (= result8 true)) (= (let ((subject state6)) (mk___private__ref state17)) state6)))
(assert (=> (not (= result8 true)) (= (let ((subject state5)) (mk___private__ref state12)) (let ((subject state5)) (mk___private__ref state20)))))
(assert (=> (not (= result8 true)) (= (let ((subject state4)) (mk___private__ref state13)) state4)))
(assert (=> (not (= result8 true)) (= (let ((subject state3)) (mk___private__ref state15)) state3)))
(assert (=> (not (= result8 true)) (= (let ((subject state2)) (mk___private__ref state14)) state2)))
(assert (=> (not (= result8 true)) (= (let ((subject state1)) (mk___private__ref state18)) state1)))
(assert (=> (not (= result8 true)) (= (let ((subject state)) (mk___private__ref state16)) (let ((subject state)) (mk___private__ref state19)))))
(assert (=> (not (= result8 true)) (= filestate filestate1)))
(assert (=> (not (= result8 true)) (= theadmin__split_fields3 (mk___split_fields theadmin__split_fields theadmin__split_fields1))))
(assert (=> (not (= result8 true)) (= status2 status)))
(assert (=> (not (= result8 true)) (= latchtimeout__split_fields5 (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))))
(assert (=> (not (= result8 true)) (= currentlatch2 currentlatch)))
(assert (=> (not (= result8 true)) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref11 idcert__split_fields2)) idcert__split_fields)))
(assert (=> (not (= result8 true)) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref8 authcert__split_fields2)) authcert__split_fields)))
(assert (=> (not (= result8 true)) (= tokenid2 tokenid)))
(assert (=> (not (= result8 true)) (= tokentry2 tokentry)))
(assert (=> (not (= result8 true)) (= tokenpresence2 tokenpresence)))
(assert (=> (not (= result8 true)) (= auditsystemfault auditsystemfault1)))
(assert (=> (not (= result8 true)) (= auditalarm4 auditalarm5)))
(assert (=> (not (= result8 true)) (= logfilestate__split_fields10 logfilestate__split_fields11)))
(assert (=> (not (= result8 true)) (= logfilesstatus logfilesstatus1)))
(assert (=> (not (= result8 true)) (= logfiles logfiles1)))
(assert (=> (not (= result8 true)) (= state17 state11)))
(assert (=> (not (= result8 true)) (= state12 state20)))
(assert (=> (not (= result8 true)) (= state13 state10)))
(assert (=> (not (= result8 true)) (= state15 state9)))
(assert (=> (not (= result8 true)) (= state14 state8)))
(assert (=> (not (= result8 true)) (= state18 state7)))
(assert (=> (not (= result8 true)) (= state16 state19)))
(assert (=> (not (= result8 true)) (= filestate filestate1)))
(assert (=> (not (= result8 true)) (= theadmin__split_fields3 theadmin__split_fields2)))
(assert (=> (not (= result8 true)) (= status2 status1)))
(assert (=> (not (= result8 true)) (= latchtimeout__split_fields5 latchtimeout__split_fields4)))
(assert (=> (not (= result8 true)) (= currentlatch2 currentlatch1)))
(assert (=> (not (= result8 true)) (= idcert__split_fields2 idcert__split_fields1)))
(assert (=> (not (= result8 true)) (= authcert__split_fields2 authcert__split_fields1)))
(assert (=> (not (= result8 true)) (= tokenid2 tokenid1)))
(assert (=> (not (= result8 true)) (= tokentry2 tokentry1)))
(assert (=> (not (= result8 true)) (= tokenpresence2 tokenpresence1)))
(assert (=> (not (= result8 true)) (= auditsystemfault auditsystemfault1)))
(assert (=> (not (= result8 true)) (= auditalarm4 auditalarm5)))
(assert (=> (not (= result8 true)) (= logfilestate__split_fields10 logfilestate__split_fields11)))
(assert (=> (not (= result8 true)) (= logfilesstatus logfilesstatus1)))
...
(assert (and (= o72 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range5 o72) (= o72 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result10 (ite (= o72 1) true false)))
(assert (= result10 true))
(assert (and (= o76 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o76 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
(assert (= o77 (ite (not (= o76 true)) true false)))
