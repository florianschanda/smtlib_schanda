...
(assert (and (= o (thecurrentdoor (us_private__content state3))) (in_range30 o)))
(assert (= result (ite (= o 1) true false)))
(assert (=> (= result true) (and (in_range9 auditalarm1) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7)) true))))
(assert (=> (= result true) (and (in_range9 auditalarm2) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8)) true))))
...
(assert (=> (= result true) (= o1 (extractuser tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields)))))
(assert (=> (= result true) (and (in_range9 auditalarm4) (= (valid_numberlogentries (to_rep8 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10)) (to_rep9 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10)) true))))
...
(assert (=> (not (= result true)) (= (let ((subject idcert__split_fields)) (mk___split_fields__ref11 idcert__split_fields2)) idcert__split_fields)))
(assert (=> (not (= result true)) (= (let ((subject authcert__split_fields)) (mk___split_fields__ref8 authcert__split_fields2)) authcert__split_fields)))
...
(assert (and (= o2 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range5 o2) (= o2 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result2 (ite (= o2 1) true false)))
(assert (= result2 true))
(assert (and (= o3 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o3 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4)))))))
