...
(assert (= i8 i6))
(assert (= sum9 sum7))
(assert (and (= o5 (min a)) (and (in_range3 o5) (and (forall ((j Int)) (=> (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (<= o5 (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j))))) (exists ((j Int)) (and (and (<= 1 j) (<= j (to_rep (rec__simple_unc_arrays__table__last (us_split_discrs1 a))))) (= o5 (to_rep2 (select (elts (rec__simple_unc_arrays__table__v (us_split_fields1 a))) j)))))))))
(assert (= result4 (ite (<= o5 simple_unc_arrays__average__result4) true false)))
(assert (= result4 true))
