...
(define-fun dynamic_invariant1 ((temp___expr_539 Int) (temp___is_init_536 Bool) (temp___skip_constant_537 Bool) (temp___do_toplevel_538 Bool)) Bool (=> (or (= temp___is_init_536 true) (<= 0 2)) (in_range5 temp___expr_539)))
...
(define-fun dynamic_invariant2 ((temp___expr_551 Int) (temp___is_init_548 Bool) (temp___skip_constant_549 Bool) (temp___do_toplevel_550 Bool)) Bool (=> (or (= temp___is_init_548 true) (<= 0 20)) (in_range7 temp___expr_551)))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_685 us_void_param) 1)) 42) (= (to_rep (select (temp___String_Literal_685 us_void_param) 2)) 42)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 3)) 42)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 4)) 42)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 6)) 86)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 7)) 111)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 8)) 116)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 10)) 110)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 11)) 103)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 13)) 42)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 14)) 42)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 15)) 42)) (= (to_rep (select (temp___String_Literal_685 us_void_param) 16)) 42)) :pattern ((temp___String_Literal_685 us_void_param)))))
(declare-fun temp___String_Literal_686 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_686 us_void_param) 1)) 68) (= (to_rep (select (temp___String_Literal_686 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 4)) 121)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 6)) 117)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 8)) 119)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 9)) 97)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 10)) 110)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 11)) 116)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 12)) 32)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 13)) 116)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 14)) 111)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 16)) 118)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 17)) 111)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 18)) 116)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 19)) 101)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 20)) 32)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 21)) 111)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 22)) 114)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 24)) 115)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 25)) 116)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 26)) 111)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 27)) 112)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 28)) 32)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 29)) 116)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 30)) 104)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 31)) 101)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 32)) 32)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 33)) 118)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 34)) 111)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 35)) 116)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 36)) 101)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 38)) 40)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 39)) 118)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 40)) 47)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 41)) 39)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 42)) 101)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 43)) 110)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 44)) 100)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 45)) 32)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 46)) 111)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 47)) 102)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 48)) 32)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 49)) 118)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 50)) 111)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 51)) 116)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 52)) 101)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 53)) 39)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 54)) 41)) (= (to_rep (select (temp___String_Literal_686 us_void_param) 55)) 63)) :pattern ((temp___String_Literal_686 us_void_param)))))
(declare-fun temp___String_Literal_690 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_690 us_void_param) 1)) 101) (= (to_rep (select (temp___String_Literal_690 us_void_param) 2)) 110)) (= (to_rep (select (temp___String_Literal_690 us_void_param) 3)) 100)) (= (to_rep (select (temp___String_Literal_690 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_690 us_void_param) 5)) 111)) (= (to_rep (select (temp___String_Literal_690 us_void_param) 6)) 102)) (= (to_rep (select (temp___String_Literal_690 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_690 us_void_param) 8)) 118)) (= (to_rep (select (temp___String_Literal_690 us_void_param) 9)) 111)) (= (to_rep (select (temp___String_Literal_690 us_void_param) 10)) 116)) (= (to_rep (select (temp___String_Literal_690 us_void_param) 11)) 101)) :pattern ((temp___String_Literal_690 us_void_param)))))
(declare-fun temp___String_Literal_693 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_693 us_void_param) 1)) 86) (= (to_rep (select (temp___String_Literal_693 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_693 us_void_param) 3)) 116)) (= (to_rep (select (temp___String_Literal_693 us_void_param) 4)) 101)) (= (to_rep (select (temp___String_Literal_693 us_void_param) 5)) 32)) (= (to_rep (select (temp___String_Literal_693 us_void_param) 6)) 115)) (= (to_rep (select (temp___String_Literal_693 us_void_param) 7)) 116)) (= (to_rep (select (temp___String_Literal_693 us_void_param) 8)) 111)) (= (to_rep (select (temp___String_Literal_693 us_void_param) 9)) 114)) (= (to_rep (select (temp___String_Literal_693 us_void_param) 10)) 101)) (= (to_rep (select (temp___String_Literal_693 us_void_param) 11)) 100)) (= (to_rep (select (temp___String_Literal_693 us_void_param) 12)) 58)) (= (to_rep (select (temp___String_Literal_693 us_void_param) 13)) 32)) :pattern ((temp___String_Literal_693 us_void_param)))))
...
(define-fun dynamic_invariant7 ((temp___expr_545 Int) (temp___is_init_542 Bool) (temp___skip_constant_543 Bool) (temp___do_toplevel_544 Bool)) Bool (=> (or (= temp___is_init_542 true) (<= 0 10000)) (in_range6 temp___expr_545)))
