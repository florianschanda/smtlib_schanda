...
(assert (= o19 (- o18 1)))
(assert (and (= const__l__assume o19) (in_range o19)))
(assert (= const__l__assume l))
(assert (in_range l))
(assert (and (= const__m__assume (fm 1)) (and (in_range const__m__assume) (= const__m__assume 1))))
(assert (= const__m__assume m))
(assert (in_range m))
(assert (and (= o20 (fm 1)) (and (in_range o20) (= o20 1))))
(assert (= o21 (* 2 o20)))
