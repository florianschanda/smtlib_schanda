...
(assert (and (= o13 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o13) (= o13 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
...
(assert (= result true))
(assert (and (= o10 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o10) (<= o10 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
...
(assert (= result2 true))
(assert (and (= o8 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2)) (= (= o8 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2) true))))
(assert (= o9 true))
...
(assert (= result3 true))
(assert (and (= o6 (has_key (positions x) c3)) (= (= o6 true) (= (has_key (positions x) c3) true))))
(assert (= o7 true))
