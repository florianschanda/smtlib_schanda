...
(assert (and (= o11 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o11) (= o11 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
...
(assert (= o10 (* 2 o9)))
(assert (and (= o12 o10) (in_range11 o10)))
(assert (= result (ite (<= o12 o11) true false)))
(assert (= result true))
(assert (and (= o8 (length2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range7 o8) (<= o8 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
...
(assert (= result2 true))
(assert (and (= o6 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2)) (= (= o6 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2) true))))
(assert (= o7 true))
...
(assert (= result3 true))
(assert (and (= o4 (has_key (positions x) c3)) (= (= o4 true) (= (has_key (positions x) c3) true))))
(assert (= o5 true))
