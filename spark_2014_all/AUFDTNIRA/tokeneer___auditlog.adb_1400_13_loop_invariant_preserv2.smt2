...
(declare-fun user_eq16 (tlogentrycounttB tlogentrycounttB) Bool)
(declare-const dummy16 tlogentrycounttB)
...
(define-fun dynamic_invariant6 ((temp___expr_1197 Int) (temp___is_init_1193 Bool) (temp___skip_constant_1194 Bool) (temp___do_toplevel_1195 Bool) (temp___do_typ_inv_1196 Bool)) Bool (=> (or (= temp___is_init_1193 true) (<= 0 17)) (in_range7 temp___expr_1197)))
(define-fun dynamic_invariant7 ((temp___expr_1317 Int) (temp___is_init_1313 Bool) (temp___skip_constant_1314 Bool) (temp___do_toplevel_1315 Bool) (temp___do_typ_inv_1316 Bool)) Bool (=> (or (= temp___is_init_1313 true) (<= 0 2)) (in_range4 temp___expr_1317)))
(define-fun dynamic_invariant8 ((temp___expr_1211 Int) (temp___is_init_1207 Bool) (temp___skip_constant_1208 Bool) (temp___do_toplevel_1209 Bool) (temp___do_typ_inv_1210 Bool)) Bool (=> (or (= temp___is_init_1207 true) (<= 0 17408)) (in_range6 temp___expr_1211)))
(define-fun dynamic_invariant9 ((temp___expr_1242 Int) (temp___is_init_1238 Bool) (temp___skip_constant_1239 Bool) (temp___do_toplevel_1240 Bool) (temp___do_typ_inv_1241 Bool)) Bool (=> (or (= temp___is_init_1238 true) (<= 0 1024)) (in_range8 temp___expr_1242)))
(assert true)
...
(assert (forall ((temp___1270 Int)) (=> (dynamic_invariant9 temp___1270 true true true true) (forall ((temp___1271 Int)) (= (select (temp_____aggregate_def_1268 temp___1270) temp___1271) rliteral2)))))
(define-fun dynamic_invariant10 ((temp___expr_556 Int) (temp___is_init_552 Bool) (temp___skip_constant_553 Bool) (temp___do_toplevel_554 Bool) (temp___do_typ_inv_555 Bool)) Bool (=> (or (= temp___is_init_552 true) (<= 1 150)) (in_range10 temp___expr_556)))
...
(declare-const temp___1681 logfileindext)
(declare-const temp___16811 logentrycountt)
(declare-const temp___16812 (Array Int logfileindext))
(declare-const temp___16813 logfileindext)
(declare-const temp___16814 logfileindext)
(declare-const temp___16815 logfilecountt)
(declare-const temp___16816 (Array Int fileentrycountt))
...
(assert (=> (<= 0 1) (in_range9 oldalarm)))
(assert (< 1 (to_rep5 logfilestate__split_fields5)))
(assert (= (to_rep2 (select logfilesstatus (to_rep3 (select logfilestate__split_fields2 (to_rep3 logfilestate__split_fields3))))) 1))
(assert (and (and (< 1 (to_rep5 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7))))) (= (to_rep2 (select logfilesstatus1 (to_rep3 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7))) (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7)))))))) 1)) (= (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7)) (+ (* (- (to_rep5 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7)))) 1) 1024) (to_rep6 (select (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7) (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7))))))))
(assert (and (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7) logfilestate__split_fields) (and (= (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7))) logfilestate__split_fields2) (= (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7))) logfilestate__split_fields4))))
(assert (not (= (to_rep3 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7))) (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7)))))) (to_rep3 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7)))))
(assert (forall ((i Int)) (=> (and (<= 1 i) (<= i 17)) (=> (not (= i (to_rep3 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7))) (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7)))))))) (= (to_rep6 (select auditlog__deletelogfile__logfileentries i)) (to_rep6 (select (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields7) i)))))))
(assert (= result (mk___split_fields__ref1 logfilestate__split_fields7)))
(assert (= logfilestate__split_fields8 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields7) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields7) (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields7) auditlog__deletelogfile__logfileentries)))
(assert (and (= o (- (to_rep5 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) 1)) (in_range7 (- (to_rep5 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8)))) 1))))
(assert (= (to_rep5 o1) o))
(assert (= (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) o2))
(assert (= (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) o3))
(assert (= (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields8))) o4))
(assert (= o1 o5))
(assert (= o6 o2))
(assert (= o7 o3))
(assert (= o8 o4))
(assert (= o9 o5))
(assert (= (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields8) o10))
(assert (= (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields8) o11))
(assert (= o12 o6))
(assert (= o13 o7))
(assert (= o14 o8))
(assert (= o15 o9))
(assert (= (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields8) o16))
(assert (= temp___1681 o10))
(assert (= temp___16811 o11))
(assert (= temp___16812 o12))
(assert (= temp___16813 o13))
(assert (= temp___16814 o14))
(assert (= temp___16815 o15))
(assert (= temp___16816 o16))
(assert (= result1 (mk___split_fields__ref1 logfilestate__split_fields8)))
(assert (= logfilestate__split_fields9 (mk___split_fields1 temp___1681 temp___16811 (mk___rep (mk___split_fields temp___16812 temp___16813 temp___16814 temp___16815)) temp___16816)))
(assert (and (= o17 (nextlistindex (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9)))))) (and (in_range5 o17) (= o17 (ite (= (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9)))) 17) 1 (+ (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9)))) 1))))))
(assert (= (to_rep3 o18) o17))
(assert (= o19 (mk___split_fields (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9))) o18 (rec__auditlog__logfilelistt__lasti (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9))) (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields9))))))
(assert (= o20 (mk___rep o19)))
(assert (= o21 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields9) (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields9) o20 (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields9))))
(assert (= temp___1684 (mk___rep1 o21)))
(assert (= result2 (mk___split_fields__ref1 logfilestate__split_fields9)))
(assert (= logfilestate__split_fields10 (us_split_fields3 temp___1684)))
(assert (and (= o22 (- (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) 1024)) (in_range6 (- (to_rep4 (rec__auditlog__logfilestatet__numberlogentries logfilestate__split_fields10)) 1024))))
(assert (= (to_rep4 o23) o22))
(assert (= o24 (mk___split_fields1 (rec__auditlog__logfilestatet__currentlogfile logfilestate__split_fields10) o23 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields10) (rec__auditlog__logfilestatet__logfileentries logfilestate__split_fields10))))
(assert (= temp___1686 (mk___rep1 o24)))
(assert (= result3 (mk___split_fields__ref1 logfilestate__split_fields10)))
(assert (= logfilestate__split_fields11 (us_split_fields3 temp___1686)))
(assert (< 1 (to_rep5 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11))))))
(assert (= (to_rep2 (select logfilesstatus2 (to_rep3 (select (rec__auditlog__logfilelistt__list (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11))) (to_rep3 (rec__auditlog__logfilelistt__head (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11)))))))) 1))
(assert (not (< 1 (to_rep5 (rec__auditlog__logfilelistt__length (us_split_fields1 (rec__auditlog__logfilestatet__usedlogfiles logfilestate__split_fields11)))))))
(check-sat)
(exit)
