...
(define-fun tint_arrayD1__ref___25__projection ((a tint_arrayD1__ref)) integer (tint_arrayD1__content a))
(declare-sort t1 0)
...
(define-fun tint_arrayT__ref___25__projection ((a tint_arrayT__ref)) us_t1 (tint_arrayT__content a))
...
(declare-datatypes () ((t786b__ref (mk_t786b__ref (t786b__content integer)))))
(define-fun t786b__ref___projection ((a t786b__ref)) integer (t786b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t787b__ref (mk_t787b__ref (t787b__content us_t2)))))
(define-fun t787b__ref___projection ((a t787b__ref)) us_t2 (t787b__content a))
...
(define-fun tnumber_array_typeD1__ref___34__projection ((a tnumber_array_typeD1__ref)) integer (tnumber_array_typeD1__content a))
(declare-sort t3 0)
...
(define-fun number_array_type__ref___34__projection ((a number_array_type__ref)) us_t3 (number_array_type__content a))
...
(declare-datatypes () ((t790b__ref (mk_t790b__ref (t790b__content integer)))))
(define-fun t790b__ref___projection ((a t790b__ref)) integer (t790b__content a))
(declare-sort t4 0)
...
(declare-datatypes () ((t791b__ref (mk_t791b__ref (t791b__content us_t4)))))
(define-fun t791b__ref___projection ((a t791b__ref)) us_t4 (t791b__content a))
...
(declare-datatypes () ((t792b__ref (mk_t792b__ref (t792b__content integer)))))
(define-fun t792b__ref___projection ((a t792b__ref)) integer (t792b__content a))
...
(define-fun tint_arrayB__ref___25__projection ((a tint_arrayB__ref)) us_t5 (tint_arrayB__content a))
(declare-fun aida__conversion__calculate_negative_target_length_4__int_array__aggregate_def (Int Int Int Int Int) us_t2)
(assert (forall ((temp___2386 Int) (temp___2387 Int) (temp___2388 Int) (temp___2389 Int) (temp___2390 Int)) (let ((temp___2385 (aida__conversion__calculate_negative_target_length_4__int_array__aggregate_def temp___2386 temp___2387 temp___2388 temp___2389 temp___2390))) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 3) temp___2389 temp___2390) (and (= (first5 temp___2385) temp___2389) (= (last5 temp___2385) temp___2390))) (and (and (= (select (to_array2 temp___2385) (+ (+ (first1 source) 1) 0)) (of_rep1 temp___2386)) (= (select (to_array2 temp___2385) (+ (+ (first1 source) 1) 1)) (of_rep1 temp___2387))) (= (select (to_array2 temp___2385) (+ (+ (first1 source) 1) 2)) (of_rep1 temp___2388)))))))
(declare-sort t6 0)
...
(define-fun tnumber_array_typeB__ref___34__projection ((a tnumber_array_typeB__ref)) us_t6 (tnumber_array_typeB__content a))
(declare-fun aida__conversion__calculate_negative_target_length_4__n__aggregate_def (Int Int Int) us_t4)
(assert (forall ((temp___2396 Int) (temp___2397 Int) (temp___2398 Int)) (let ((temp___2395 (aida__conversion__calculate_negative_target_length_4__n__aggregate_def temp___2396 temp___2397 temp___2398))) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 3) temp___2397 temp___2398) (and (= (first9 temp___2395) temp___2397) (= (last9 temp___2395) temp___2398))) (forall ((temp___2399 Int)) (= (select (to_array4 temp___2395) temp___2399) (of_rep1 temp___2396)))))))
...
(define-fun dynamic_invariant4 ((temp___expr_797 us_t3) (temp___is_init_794 Bool) (temp___skip_constant_795 Bool) (temp___do_toplevel_796 Bool)) Bool (=> (not (= temp___skip_constant_795 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 3) (first7 temp___expr_797) (last7 temp___expr_797)) (and (= (first7 temp___expr_797) (+ (first1 source) 1)) (= (last7 temp___expr_797) (+ (first1 source) 3))))))
...
(declare-const temp___2393 (Array Int integer))
(declare-const temp___23931 t2)
(declare-const aida__conversion__calculate_negative_target_length_4__int_array__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_length_4__int_array__assume1 t1)
(declare-const us Int)
(declare-const us1 Int)
(declare-const temp___2401 (Array Int integer))
(declare-const temp___24011 t4)
(declare-const aida__conversion__calculate_negative_target_length_4__n__assume (Array Int integer))
(declare-const aida__conversion__calculate_negative_target_length_4__n__assume1 t3)
(declare-const us2 Int)
(declare-const us3 Int)
(declare-const temp___2407 Int)
(declare-const temp___2408 Int)
(declare-const temp___2405 (Array Int integer))
(declare-const temp___2403 Int)
...
(assert (and (= (length source) 4) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index11 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index11) (<= index11 (+ (to_rep1 (first (rt source))) 3))) (= (is_digit (to_rep (select (elts source) index11))) true))))))
(assert (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_negative_target_length_4__int_array__aggregate_def 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 2))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_negative_target_length_4__int_array__aggregate_def 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 2))))) (+ (+ (to_rep1 (first (rt source))) 1) 2)))
(assert (= (mk___t2 temp___2393 temp___23931) (aida__conversion__calculate_negative_target_length_4__int_array__aggregate_def 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 2))))
(assert (= (ite (<= (to_rep1 (first4 temp___23931)) (to_rep1 (last4 temp___23931))) (+ (- (to_rep1 (last4 temp___23931)) (to_rep1 (first4 temp___23931))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) (+ (- (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2393 (to_rep1 (first4 temp___23931)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_4__int_array__assume))
(assert (= (mk1 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) aida__conversion__calculate_negative_target_length_4__int_array__assume1))
(assert (= (mk_map__ref1 result1) (mk_map__ref1 int_array)))
(assert (= int_array1 aida__conversion__calculate_negative_target_length_4__int_array__assume))
(assert (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_negative_target_length_4__int_array__assume1))))
(assert (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_negative_target_length_4__int_array__assume1))))
(assert (and (dynamic_property2 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 3)))))
(assert (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_negative_target_length_4__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3))))) (+ (to_rep1 (first (rt source))) 1)))
(assert (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_negative_target_length_4__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3))))) (+ (to_rep1 (first (rt source))) 3)))
(assert (= (mk___t4 temp___2401 temp___24011) (aida__conversion__calculate_negative_target_length_4__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3))))
(assert (= (ite (<= (to_rep1 (first8 temp___24011)) (to_rep1 (last8 temp___24011))) (+ (- (to_rep1 (last8 temp___24011)) (to_rep1 (first8 temp___24011))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) (+ (- (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2401 (to_rep1 (first8 temp___24011)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_4__n__assume))
(assert (= (mk3 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) aida__conversion__calculate_negative_target_length_4__n__assume1))
(assert (= (mk_map__ref1 result2) (mk_map__ref1 n)))
(assert (= n1 aida__conversion__calculate_negative_target_length_4__n__assume))
(assert (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_negative_target_length_4__n__assume1))))
(assert (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_negative_target_length_4__n__assume1))))
(assert (and (dynamic_property6 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (+ (to_rep1 (first (rt source))) 1)) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 3)))))
(assert (and (= temp___2407 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2408 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (= (mk_int__ref result3) (mk_int__ref index)))
(assert (= index2 temp___2407))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= temp___2405 n1)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= temp___2403 index2)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= o5 index2)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= o6 (select n1 o5))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= o7 (to_rep1 o6))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= o7 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= o8 index2)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= o9 (select (elts source) o8))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= o10 (to_rep o9))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o10))) (ite (= (= o10 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o10 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o10 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o10 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o10 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o10 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o10 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o10 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o10 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o10 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= (to_rep1 o11) aida__conversion__convert_character_digit_to_integer__2__target2)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= o12 index2)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= o13 (store n1 o12 o11))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= n1 result4)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= n2 o13)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (forall ((i2 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9))))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (forall ((j1 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3) index3)) (forall ((temp___2406 Int)) (=> (and (<= (to_rep1 n__first) temp___2406) (<= temp___2406 (to_rep1 n__last))) (=> (< index3 temp___2406) (= (select n3 temp___2406) (select temp___2405 temp___2406)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index3) (<= index3 (+ (to_rep1 (first (rt source))) 3))))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= index3 temp___2408)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= index3 index5)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= n3 n5)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= index6 index3)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= n6 n3)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= index7 (mk_int__ref index5))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= n7 (mk_map__ref1 n5))))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= index8 index6)))
(assert (=> (and (<= temp___2407 index2) (<= index2 temp___2408)) (= n8 n6)))
(assert (=> (not (and (<= temp___2407 index2) (<= index2 temp___2408))) (= index7 (mk_int__ref index2))))
(assert (=> (not (and (<= temp___2407 index2) (<= index2 temp___2408))) (= n7 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2407 index2) (<= index2 temp___2408))) (= index8 index2)))
(assert (=> (not (and (<= temp___2407 index2) (<= index2 temp___2408))) (= n8 n1)))
...
(assert (and (= temp___2409 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2409) (<= temp___2409 (to_rep1 n__last))))
(assert (= o41 temp___2409))
...
(assert (= target1 o45))
(assert (<= (- 9) target1))
(assert (and (= temp___2410 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2410) (<= temp___2410 (to_rep1 n__last))))
(assert (= o46 temp___2410))
...
(assert (= target2 o52))
(assert (<= (- 99) target2))
(assert (and (= temp___2411 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___2411) (<= temp___2411 (to_rep1 n__last))))
(assert (= o53 temp___2411))
