...
(assert (forall ((temp___2488 Int) (temp___2489 Int) (temp___2490 Int) (temp___2491 Int) (temp___2492 Int)) (let ((temp___2487 (aida__conversion__calculate_negative_target_length_4__int_array__aggregate_def temp___2488 temp___2489 temp___2490 temp___2491 temp___2492))) (=> (and (and (dynamic_invariant temp___2488 true true true true) (dynamic_invariant temp___2489 true true true true)) (dynamic_invariant temp___2490 true true true true)) (and (=> (dynamic_property10 (+ (first1 source) 1) (+ (first1 source) 3) temp___2491 temp___2492) (and (= (first5 temp___2487) temp___2491) (= (last5 temp___2487) temp___2492))) (and (and (= (to_rep1 (select (to_array2 temp___2487) (+ (+ (first1 source) 1) 0))) temp___2488) (= (to_rep1 (select (to_array2 temp___2487) (+ (+ (first1 source) 1) 1))) temp___2489)) (= (to_rep1 (select (to_array2 temp___2487) (+ (+ (first1 source) 1) 2))) temp___2490)))))))
(define-fun dynamic_invariant4 ((temp___expr_894 us_t3) (temp___is_init_890 Bool) (temp___skip_constant_891 Bool) (temp___do_toplevel_892 Bool) (temp___do_typ_inv_893 Bool)) Bool (=> (not (= temp___skip_constant_891 true)) (and (dynamic_property6 (+ (first1 source) 1) (+ (first1 source) 3) (first7 temp___expr_894) (last7 temp___expr_894)) (and (= (first7 temp___expr_894) (+ (first1 source) 1)) (= (last7 temp___expr_894) (+ (first1 source) 3))))))
(declare-sort t6 0)
...
(assert (forall ((temp___2498 Int) (temp___2499 Int) (temp___2500 Int)) (let ((temp___2497 (aida__conversion__calculate_negative_target_length_4__n__aggregate_def temp___2498 temp___2499 temp___2500))) (=> (dynamic_invariant temp___2498 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 3) temp___2499 temp___2500) (and (= (first9 temp___2497) temp___2499) (= (last9 temp___2497) temp___2500))) (forall ((temp___2501 Int)) (= (to_rep1 (select (to_array4 temp___2497) temp___2501)) temp___2498)))))))
...
(declare-const temp___2495 (Array Int integer))
(declare-const temp___24951 t2)
...
(declare-const temp___2503 (Array Int integer))
(declare-const temp___25031 t4)
...
(declare-const temp___2509 Int)
(declare-const temp___2510 Int)
(declare-const temp___2507 (Array Int integer))
(declare-const temp___2505 Int)
(declare-const o Int)
...
(assert (and (= (length source) 4) (and (= (to_rep (select (elts source) (+ (to_rep1 (first (rt source))) 0))) 45) (forall ((index7 Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) index7) (<= index7 (+ (to_rep1 (first (rt source))) 3))) (= (is_digit (to_rep (select (elts source) index7))) true))))))
...
(assert (= (mk___t2 temp___2495 temp___24951) (aida__conversion__calculate_negative_target_length_4__int_array__aggregate_def 9 9 9 (+ (to_rep1 (first (rt source))) 1) (+ (+ (to_rep1 (first (rt source))) 1) 2))))
(assert (= (ite (<= (to_rep1 (first4 temp___24951)) (to_rep1 (last4 temp___24951))) (+ (- (to_rep1 (last4 temp___24951)) (to_rep1 (first4 temp___24951))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) (+ (- (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2495 (to_rep1 (first4 temp___24951)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_4__int_array__assume))
...
(assert (= (mk___t4 temp___2503 temp___25031) (aida__conversion__calculate_negative_target_length_4__n__aggregate_def 0 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3))))
(assert (= (ite (<= (to_rep1 (first8 temp___25031)) (to_rep1 (last8 temp___25031))) (+ (- (to_rep1 (last8 temp___25031)) (to_rep1 (first8 temp___25031))) 1) 0) (ite (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) (+ (- (+ (to_rep1 (first (rt source))) 3) (+ (to_rep1 (first (rt source))) 1)) 1) 0)))
(assert (= (slide1 temp___2503 (to_rep1 (first8 temp___25031)) (+ (to_rep1 (first (rt source))) 1)) aida__conversion__calculate_negative_target_length_4__n__assume))
...
(assert (and (= temp___2509 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2510 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2509))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= temp___2507 n1)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= temp___2505 index1)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= o index1)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= o3 index1)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= o7 index1)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= n1 result3)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= n2 o8)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3) index2)) (forall ((temp___2508 Int)) (=> (and (<= (to_rep1 n__first) temp___2508) (<= temp___2508 (to_rep1 n__last))) (=> (< index2 temp___2508) (= (select n3 temp___2508) (select temp___2507 temp___2508)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 3))))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= index2 temp___2510)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= index2 index3)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= n3 n4)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= index4 index2)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= n5 n3)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= index6 index4)))
(assert (=> (and (<= temp___2509 index1) (<= index1 temp___2510)) (= n7 n5)))
(assert (=> (not (and (<= temp___2509 index1) (<= index1 temp___2510))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2509 index1) (<= index1 temp___2510))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2509 index1) (<= index1 temp___2510))) (= index6 index1)))
(assert (=> (not (and (<= temp___2509 index1) (<= index1 temp___2510))) (= n7 n1)))
...
(assert (and (= temp___2511 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (and (<= (to_rep1 n__first) temp___2511) (<= temp___2511 (to_rep1 n__last))))
(assert (= o9 temp___2511))
...
(assert (= target1 o13))
(assert (<= (- 9) target1))
(assert (and (= temp___2512 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 n__first) temp___2512) (<= temp___2512 (to_rep1 n__last))))
(assert (= o14 temp___2512))
...
(assert (= target2 o20))
(assert (<= (- 99) target2))
(assert (and (= temp___2513 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 n__first) temp___2513) (<= temp___2513 (to_rep1 n__last))))
(assert (= o21 temp___2513))
