...
(assert (forall ((temp___2498 Int) (temp___2499 Int) (temp___2500 Int)) (let ((temp___2497 (aida__conversion__calculate_negative_target_length_4__n__aggregate_def temp___2498 temp___2499 temp___2500))) (=> (dynamic_invariant temp___2498 true true true true) (and (=> (dynamic_property11 (+ (first1 source) 1) (+ (first1 source) 3) temp___2499 temp___2500) (and (= (first9 temp___2497) temp___2499) (= (last9 temp___2497) temp___2500))) (forall ((temp___2501 Int)) (= (select (to_array4 temp___2497) temp___2501) rliteral1)))))))
...
(declare-const temp___2506 Int)
(declare-const temp___2509 (Array Int integer))
(declare-const temp___2507 Int)
(declare-const o Int)
...
(assert (and (= temp___2505 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (= temp___2506 (+ (to_rep1 (first (rt source))) 3)) (in_range1 (+ (to_rep1 (first (rt source))) 3))))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 temp___2505))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= temp___2509 n1)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= temp___2507 index1)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= o index1)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= o1 (select n1 o))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= o2 (to_rep1 o1))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= o2 aida__conversion__convert_character_digit_to_integer__2__target)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (and (<= (to_rep1 (first (rt source))) index1) (<= index1 (to_rep1 (last (rt source)))))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= o3 index1)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= o4 (select (elts source) o3))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= o5 (to_rep o4))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target1) (<= aida__conversion__convert_character_digit_to_integer__2__target1 9)) (= aida__conversion__convert_character_digit_to_integer__2__target1 (convert_character_digit_to_integer o5))) (ite (= (= o5 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 0) (ite (= (= o5 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 1) (ite (= (= o5 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 2) (ite (= (= o5 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 3) (ite (= (= o5 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 4) (ite (= (= o5 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 5) (ite (= (= o5 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 6) (ite (= (= o5 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 7) (ite (= (= o5 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 8) (=> (= (= o5 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target1 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target1))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= (to_rep1 o6) aida__conversion__convert_character_digit_to_integer__2__target1)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (and (<= (to_rep1 n__first) index1) (<= index1 (to_rep1 n__last)))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= o7 index1)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= o8 (store n1 o7 o6))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= n1 result3)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= n2 o8)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (forall ((i Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) i) (<= i index2)) (and (<= 0 (to_rep1 (select n3 i))) (<= (to_rep1 (select n3 i)) 9))))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (forall ((j Int)) (=> (and (<= (+ (to_rep1 (first (rt source))) 1) j) (<= j index2)) (<= (to_rep1 (select n3 j)) (to_rep1 (select int_array1 j)))))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (and (and (=> (<= (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3)) (dynamic_property9 (+ (to_rep1 (first (rt source))) 1) (+ (to_rep1 (first (rt source))) 3) index2)) (forall ((temp___2510 Int)) (=> (and (<= (to_rep1 n__first) temp___2510) (<= temp___2510 (to_rep1 n__last))) (=> (or (< temp___2506 temp___2510) (or (< temp___2510 temp___2505) (< index2 temp___2510))) (= (select n3 temp___2510) (select temp___2509 temp___2510)))))) (and (<= (+ (to_rep1 (first (rt source))) 1) index2) (<= index2 (+ (to_rep1 (first (rt source))) 3))))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= index2 temp___2506)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= index2 index3)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= n3 n4)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= index4 index2)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= n5 n3)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= index5 (mk_int__ref index3))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= n6 (mk_map__ref1 n4))))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= index6 index4)))
(assert (=> (and (<= temp___2505 index1) (<= index1 temp___2506)) (= n7 n5)))
(assert (=> (not (and (<= temp___2505 index1) (<= index1 temp___2506))) (= index5 (mk_int__ref index1))))
(assert (=> (not (and (<= temp___2505 index1) (<= index1 temp___2506))) (= n6 (mk_map__ref1 n1))))
(assert (=> (not (and (<= temp___2505 index1) (<= index1 temp___2506))) (= index6 index1)))
(assert (=> (not (and (<= temp___2505 index1) (<= index1 temp___2506))) (= n7 n1)))
