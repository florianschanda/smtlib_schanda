...
(assert (=> (= result3 true) (and (= o8 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range4 o8))))
(assert (=> (= result3 true) (= result2 (ite (= o8 3) true false))))
(assert (=> (not (= result3 true)) (= result2 false)))
(assert (=> (= result2 true) (and (= o9 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o9) (= o9 (to_rep theadmin__split_fields))))))
(assert (=> (= result2 true) (= o10 (ite (= o9 1) true false))))
(assert (=> (not (= result2 true)) (= o10 (of_int 1))))
(assert (and (= o1 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o1) (= o1 (to_rep theadmin__split_fields)))))
(assert (= result4 (ite (= o1 1) true false)))
(assert (=> (= result4 true) (and (= o4 (theauthcertrole tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields))) (and (in_range2 o4) (= o4 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content9 authcert__split_fields))))))))
(assert (=> (= result4 true) (= o5 (ite (= o4 1) true false))))
(assert (=> (= result4 true) (and (= o2 (authcertvalid tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields))) (= (= o2 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content9 authcert__split_fields)) true)))))
(assert (=> (= result4 true) (and (= o3 (isgood tokenpresence (us_private__content state2) tokentry tokenid (us_split_fields__content9 authcert__split_fields) (us_split_fields__content12 idcert__split_fields))) (= (= o3 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content12 idcert__split_fields)) true)))))
(assert (=> (= result4 true) (= o6 (ite (= o3 true) o2 false))))
(assert (=> (= result4 true) (= o7 (ite (= o6 true) o5 false))))
(assert (=> (not (= result4 true)) (= o7 (of_int 1))))
