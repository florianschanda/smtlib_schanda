...
(assert (not (= (length temp___1910) 0)))
(assert (=> (<= 1 2) (= o48 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o48 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1910))) (to_rep1 (last (rt temp___1910)))) (= o49 (+ (- (to_rep1 (last (rt temp___1910))) (to_rep1 (first (rt temp___1910)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1910))) (to_rep1 (last (rt temp___1910))))) (= o49 0)))
(assert (= o50 (+ o49 o48)))
(assert (= o51 (+ (to_rep1 (first (rt temp___1910))) o50)))
(assert (= o52 (- o51 1)))
