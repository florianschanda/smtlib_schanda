...
(assert (= (mk___t2 temp___349 temp___3491) (instr__display_value__4__s1__aggregate_def (to_rep (rec__instr__graphic_gauge__fill (us_split_fields7 x))) 1 lg)))
(assert (= (ite (<= (to_rep1 (first4 temp___3491)) (to_rep1 (last4 temp___3491))) (+ (- (to_rep1 (last4 temp___3491)) (to_rep1 (first4 temp___3491))) 1) 0) (ite (<= 1 lg) (+ (- lg 1) 1) 0)))
(assert (= temp___349 instr__display_value__4__s1__assume))
(assert (= (mk1 (to_rep1 (first4 temp___3491)) (to_rep1 (last4 temp___3491))) instr__display_value__4__s1__assume1))
