...
(declare-const o19 serialnumbert)
(declare-const o20 us_split_fields2)
(declare-const temp___2800 us_rep1)
...
(assert (= (to_rep4 o19) 0))
(assert (= o20 (mk___split_fields1 (rec__certtypes__idt__issuer id__split_fields4) o19)))
(assert (= temp___2800 (mk___rep1 o20)))
(assert (= result8 (mk___split_fields__ref1 id__split_fields4)))
(assert (= id__split_fields5 (us_split_fields3 temp___2800)))
