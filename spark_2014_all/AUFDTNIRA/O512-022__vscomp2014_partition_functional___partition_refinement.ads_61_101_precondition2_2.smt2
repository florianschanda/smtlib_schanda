...
(assert (and (= o11 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o11) (= o11 (ite (= (distinct 1 0) true) (to_rep2 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o9 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o9) (<= o9 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= o10 (* 2 o9)))
(assert (and (= o12 o10) (in_range10 o10)))
(assert (= result (ite (<= o12 o11) true false)))
(assert (= result true))
(assert (and (= o8 (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))) (and (in_range6 o8) (<= o8 (capacity (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields)))))))
(assert (= result1 (ite (<= o8 5000) true false)))
(assert (= result1 true))
...
(assert (= result2 true))
(assert (and (= o6 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1)) (= (= o6 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c1) true))))
(assert (= o7 true))
...
(assert (= result3 true))
(assert (and (= o4 (has_key (positions x) c)) (= (= o4 true) (= (has_key (positions x) c) true))))
(assert (= o5 true))
...
(assert (= result5 true))
(assert (= (= result7 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= 0 (to_rep5 (select f j1))) (<= (to_rep5 (select f j1)) (- (length1 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) 1)))))))
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= (to_rep4 (rec__partition_refinement__interval__first (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j1)))))) j1) (<= j1 (to_rep4 (rec__partition_refinement__interval__last (us_split_fields11 (get5 (model__2 (mk___rep4 p__split_discrs (mk___split_fields4 p__split_fields))) (to_rep5 (select f j1))))))))))))
(assert (= result8 true))
