...
(assert (= result true))
(assert (and (= o13 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range7 o13)))
(assert (= result1 (ite (= o13 3) true false)))
(assert (= result1 true))
(assert (and (= o12 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range5 o12) (= o12 (to_rep2 theadmin__split_fields)))))
(assert (= result2 (ite (= o12 1) true false)))
(assert (= result2 true))
(assert (and (= o6 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range5 o6) (= o6 (to_rep2 theadmin__split_fields)))))
(assert (= result4 (ite (= o6 1) true false)))
(assert (=> (= result4 true) (and (= o9 (theauthcertrole tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (and (in_range5 o9) (= o9 (therole (rec__admintoken__validauthcertt__contents (us_split_fields__content8 authcert__split_fields))))))))
(assert (=> (= result4 true) (= o10 (ite (= o9 1) true false))))
(assert (=> (= result4 true) (and (= o7 (authcertvalid tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o7 true) (= (rec__admintoken__validauthcertt__valid (us_split_fields__content8 authcert__split_fields)) true)))))
(assert (=> (= result4 true) (and (= o8 (isgood tokenpresence (us_private__content state1) tokentry tokenid (us_split_fields__content8 authcert__split_fields) (us_split_fields__content11 idcert__split_fields))) (= (= o8 true) (= (rec__admintoken__valididcertt__valid (us_split_fields__content11 idcert__split_fields)) true)))))
(assert (=> (= result4 true) (= o11 (ite (= o8 true) o7 false))))
(assert (=> (= result4 true) (= result3 (ite (= o11 true) o10 false))))
(assert (=> (not (= result4 true)) (= result3 (of_int 1))))
(assert (= result3 true))
...
(assert (=> (= result7 true) (and (= o4 (thecurrentop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (in_range7 o4))))
(assert (=> (= result7 true) (= result6 (ite (= o4 3) true false))))
(assert (=> (not (= result7 true)) (= result6 false)))
(assert (=> (= result6 true) (and (= o5 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range5 o5) (= o5 (to_rep2 theadmin__split_fields))))))
(assert (=> (= result6 true) (= result5 (ite (= o5 1) true false))))
(assert (=> (not (= result6 true)) (= result5 (of_int 1))))
(assert (= result5 true))
...
(assert (= result8 true))
(assert (and (= o2 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o2 true) (in_range7 (to_rep3 theadmin__split_fields1)))))
