...
(declare-const logfilestate__split_fields6 logfilecountt)
(declare-const logfilestate__split_fields7 (Array Int fileentrycountt))
...
(assert (and (and (and (and (<= 1 (to_rep3 logfilestate__split_fields6)) (= (to_rep4 (select logfilestate__split_fields7 (to_rep1 logfilestate__split_fields4))) (to_rep4 (select logfilestate__split_fields3 (to_rep1 logfilestate__split_fields))))) (= (to_rep3 logfilestate__split_fields6) 16)) (= (to_rep2 logfilestate__split_fields5) (* (to_rep3 logfilestate__split_fields6) 1024))) (in_range7 auditalarm1)))
(assert (not (< (to_rep2 logfilestate__split_fields5) 17408)))
(check-sat)
(exit)
