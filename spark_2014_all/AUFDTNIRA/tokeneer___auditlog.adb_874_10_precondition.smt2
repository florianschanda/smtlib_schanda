...
(assert (and (and (and (and (<= 1 (to_rep3 logfilestate__split_fields19)) (= (to_rep4 (select logfilestate__split_fields20 (to_rep1 logfilestate__split_fields14))) (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))))) (= (to_rep3 logfilestate__split_fields19) 16)) (= (to_rep2 logfilestate__split_fields15) (* (to_rep3 logfilestate__split_fields19) 1024))) (in_range4 auditalarm2)))
(assert (not (= (valid_numberlogentries__2 (mk___rep1 (mk___split_fields1 logfilestate__split_fields14 logfilestate__split_fields15 (mk___rep (mk___split_fields logfilestate__split_fields16 logfilestate__split_fields17 logfilestate__split_fields18 logfilestate__split_fields19)) logfilestate__split_fields20))) true)))
(check-sat)
(exit)
