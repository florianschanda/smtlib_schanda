...
(declare-const logfilestate__split_fields5 logentrycountt)
(declare-const logfilestate__split_fields6 (Array Int logfileindext))
(declare-const logfilestate__split_fields7 logfileindext)
(declare-const logfilestate__split_fields8 logfileindext)
...
(assert (and (<= 1 (to_rep1 logfilestate__split_fields2)) (= (to_rep3 logfilestate__split_fields1) (+ (* (- (to_rep1 logfilestate__split_fields2) 1) 1024) (to_rep4 (select logfilestate__split_fields3 (to_rep2 logfilestate__split_fields)))))))
(assert (= (to_rep4 (select logfilestate__split_fields3 (to_rep2 logfilestate__split_fields))) 1024))
(assert (= (to_rep1 logfilestate__split_fields2) 17))
(assert (and (and (and (and (<= 1 (to_rep1 logfilestate__split_fields9)) (= (to_rep4 (select logfilestate__split_fields10 (to_rep2 logfilestate__split_fields4))) (to_rep4 (select logfilestate__split_fields3 (to_rep2 logfilestate__split_fields))))) (= (to_rep1 logfilestate__split_fields9) 16)) (= (to_rep3 logfilestate__split_fields5) (* (to_rep1 logfilestate__split_fields9) 1024))) (in_range4 auditalarm1)))
(assert (not (= (valid_numberlogentries__2 (mk___rep1 (mk___split_fields1 logfilestate__split_fields4 logfilestate__split_fields5 (mk___rep (mk___split_fields logfilestate__split_fields6 logfilestate__split_fields7 logfilestate__split_fields8 logfilestate__split_fields9)) logfilestate__split_fields10))) true)))
(check-sat)
(exit)
