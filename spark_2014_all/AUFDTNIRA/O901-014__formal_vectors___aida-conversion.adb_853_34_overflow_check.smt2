...
(assert (and (= temp___1643 (+ (to_rep1 (first (rt source))) 2)) (in_range1 (+ (to_rep1 (first (rt source))) 2))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1643) (<= temp___1643 (to_rep1 (last (rt source))))))
(assert (= o60 temp___1643))
...
(assert (and (= temp___1642 (+ (to_rep1 (first (rt source))) 1)) (in_range1 (+ (to_rep1 (first (rt source))) 1))))
(assert (and (<= (to_rep1 (first (rt source))) temp___1642) (<= temp___1642 (to_rep1 (last (rt source))))))
