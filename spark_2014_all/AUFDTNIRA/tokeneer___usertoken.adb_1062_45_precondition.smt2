...
(define-fun dynamic_invariant ((temp___expr_558 Int) (temp___is_init_555 Bool) (temp___skip_constant_556 Bool) (temp___do_toplevel_557 Bool)) Bool (=> (or (= temp___is_init_555 true) (<= 0 1)) (in_range8 temp___expr_558)))
...
(declare-fun thecurrenttime (us_split_fields6 us_private) us_rep3)
(declare-fun thecurrenttime__function_guard (us_rep3 us_split_fields6 us_private) Bool)
(assert true)
(assert (forall ((clock__currenttimevar__fields us_split_fields6)) (forall ((clock__currenttime us_private)) (! (= (thecurrenttime clock__currenttimevar__fields clock__currenttime) (mk___rep3 clock__currenttimevar__fields)) :pattern ((thecurrenttime clock__currenttimevar__fields clock__currenttime))))))
(declare-fun authperiodisempty (us_private) Bool)
(declare-fun authperiodisempty__function_guard (Bool us_private) Bool)
(assert true)
(define-fun dynamic_invariant1 ((temp___expr_541 Int) (temp___is_init_538 Bool) (temp___skip_constant_539 Bool) (temp___do_toplevel_540 Bool)) Bool (=> (or (= temp___is_init_538 true) (<= 0 5)) (in_range7 temp___expr_541)))
(declare-fun theenclaveclearance (us_private) Int)
(declare-fun theenclaveclearance__function_guard (Int us_private) Bool)
(assert (forall ((configdata__state us_private)) (! (dynamic_invariant1 (theenclaveclearance configdata__state) true false true) :pattern ((theenclaveclearance configdata__state)))))
...
(declare-fun to_rep10 (logfileindext) Int)
(declare-fun of_rep10 (Int) logfileindext)
(assert (forall ((x logfileindext)) (! (= (of_rep10 (to_rep10 x)) x) :pattern ((to_rep10 x)))))
(assert (forall ((x logfileindext)) (! (in_range13 (to_rep10 x)) :pattern ((to_rep10 x)))))
...
(declare-fun to_rep11 (logentrycountt) Int)
(declare-fun of_rep11 (Int) logentrycountt)
(assert (forall ((x logentrycountt)) (! (= (of_rep11 (to_rep11 x)) x) :pattern ((to_rep11 x)))))
(assert (forall ((x logentrycountt)) (! (in_range14 (to_rep11 x)) :pattern ((to_rep11 x)))))
...
(define-fun bool_eq6 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep10 (select a temp___idx_153)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_153))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_153 Int)) (=> (and (<= a__first temp___idx_153) (<= temp___idx_153 a__last)) (= (to_rep10 (select a temp___idx_153)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_153)))))))))))
...
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq6 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep10 (select a (+ i 1))) (to_rep10 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq6 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep10 (select b (+ i 1))) (to_rep10 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(declare-fun to_rep12 (logfilecountt) Int)
(declare-fun of_rep12 (Int) logfilecountt)
(assert (forall ((x logfilecountt)) (! (= (of_rep12 (to_rep12 x)) x) :pattern ((to_rep12 x)))))
(assert (forall ((x logfilecountt)) (! (in_range15 (to_rep12 x)) :pattern ((to_rep12 x)))))
...
(define-fun bool_eq7 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (and (= (bool_eq6 (rec__auditlog__logfilelistt__list (us_split_fields9 a)) 1 17 (rec__auditlog__logfilelistt__list (us_split_fields9 b)) 1 17) true) (= (to_rep10 (rec__auditlog__logfilelistt__head (us_split_fields9 a))) (to_rep10 (rec__auditlog__logfilelistt__head (us_split_fields9 b))))) (= (to_rep10 (rec__auditlog__logfilelistt__lasti (us_split_fields9 a))) (to_rep10 (rec__auditlog__logfilelistt__lasti (us_split_fields9 b))))) (= (to_rep12 (rec__auditlog__logfilelistt__length (us_split_fields9 a))) (to_rep12 (rec__auditlog__logfilelistt__length (us_split_fields9 b))))) true false))
...
(declare-fun to_rep13 (fileentrycountt) Int)
(declare-fun of_rep13 (Int) fileentrycountt)
(assert (forall ((x fileentrycountt)) (! (= (of_rep13 (to_rep13 x)) x) :pattern ((to_rep13 x)))))
(assert (forall ((x fileentrycountt)) (! (in_range16 (to_rep13 x)) :pattern ((to_rep13 x)))))
...
(define-fun bool_eq8 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep13 (select a temp___idx_154)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep13 (select a temp___idx_154)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_154)))))))))))
...
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq8 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep13 (select a (+ i 1))) (to_rep13 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq8 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep13 (select b (+ i 1))) (to_rep13 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(define-fun bool_eq9 ((a us_rep5) (b us_rep5)) Bool (ite (and (and (and (= (to_rep10 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 a))) (to_rep10 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 b)))) (= (to_rep11 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 a))) (to_rep11 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 b))))) (= (bool_eq7 (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 a)) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 b))) true)) (= (bool_eq8 (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 a)) 1 17 (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 b)) 1 17) true)) true false))
...
(assert (forall ((temp___1195 Int)) (forall ((temp___1196 Int)) (= (select (temp___1193 temp___1195) temp___1196) (of_rep10 temp___1195)))))
(declare-fun temp___1197 (Int) (Array Int fileentrycountt))
(assert (forall ((temp___1199 Int)) (forall ((temp___1200 Int)) (= (select (temp___1197 temp___1199) temp___1200) (of_rep13 temp___1199)))))
(define-fun dynamic_invariant2 ((temp___expr_1187 us_rep5) (temp___is_init_1184 Bool) (temp___skip_constant_1185 Bool) (temp___do_toplevel_1186 Bool)) Bool (= (valid_numberlogentries (to_rep10 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___expr_1187))) (to_rep11 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___expr_1187))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___expr_1187)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___expr_1187))) true))
(define-fun default_initial_assumption ((temp___expr_1191 us_rep5) (temp___skip_top_level_1192 Bool)) Bool (and (and (and (= (to_rep10 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___expr_1191))) 1) (= (to_rep11 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___expr_1191))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___expr_1191)) (mk___rep4 (mk___split_fields4 (temp___1193 1) (of_rep10 1) (of_rep10 1) (of_rep12 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___expr_1191)) (temp___1197 0))))
(define-fun type_invariant ((temp___1201 us_rep5)) Bool (= (valid_numberlogentries (to_rep10 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___1201))) (to_rep11 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___1201))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___1201)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___1201))) true))
...
(assert (forall ((a (Array Int us_rep6))) (forall ((first2 Int)) (! (= (slide3 a first2 first2) a) :pattern ((slide3 a first2 first2))))))
...
(declare-fun concat4 ((Array Int us_rep6) Int Int (Array Int us_rep6) Int Int) (Array Int us_rep6))
...
(declare-fun singleton4 (us_rep6 Int) (Array Int us_rep6))
(assert (forall ((v us_rep6)) (forall ((i Int)) (! (= (select (singleton4 v i) i) v) :pattern ((select (singleton4 v i) i))))))
...
(declare-fun user_eq27 (filestatust filestatust) Bool)
(declare-const dummy27 filestatust)
...
(assert (forall ((x filestatust)) (! (in_range17 (to_rep14 x)) :pattern ((to_rep14 x)))))
...
(define-fun bool_eq12 ((a (Array Int filestatust)) (a__first Int) (a__last Int) (b (Array Int filestatust)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep14 (select a temp___idx_156)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_156))))))) true false))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq12 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep14 (select a temp___idx_156)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_156)))))))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare3 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq12 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_rep14 (select a (+ i 1))) (to_rep14 (select b (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare3 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq12 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_rep14 (select b (+ i 1))) (to_rep14 (select a (+ j 1))))))))))) :pattern ((compare3 a a_first a_last b b_first b_last))))))
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-datatypes () ((us_split_fields12 (mk___split_fields6 (rec__keystore__optionalprivatekeyt__ispresent Bool) (rec__keystore__optionalprivatekeyt__owner us_rep)))))
(define-fun us_split_fields_IsPresent__projection ((a us_split_fields12)) Bool (rec__keystore__optionalprivatekeyt__ispresent a))
(define-fun us_split_fields_Owner__projection ((a us_split_fields12)) us_rep (rec__keystore__optionalprivatekeyt__owner a))
...
(define-fun us_rep___13__projection ((a us_rep7)) us_split_fields12 (us_split_fields13 a))
(define-fun bool_eq13 ((a us_rep7) (b us_rep7)) Bool (ite (and (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields13 a)) (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields13 b))) (= (bool_eq2 (rec__keystore__optionalprivatekeyt__owner (us_split_fields13 a)) (rec__keystore__optionalprivatekeyt__owner (us_split_fields13 b))) true)) true false))
...
(declare-fun privatekeypresent (us_split_fields12 us_private) Bool)
(declare-fun privatekeypresent__function_guard (Bool us_split_fields12 us_private) Bool)
(assert true)
(assert (forall ((keystore__thistisinfo__fields us_split_fields12)) (forall ((keystore__state us_private)) (! (= (= (privatekeypresent keystore__thistisinfo__fields keystore__state) true) (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields13 (mk___rep6 keystore__thistisinfo__fields))) true)) :pattern ((privatekeypresent keystore__thistisinfo__fields keystore__state))))))
(declare-fun thistis (us_split_fields12 us_private) us_rep)
(declare-fun thistis__function_guard (us_rep us_split_fields12 us_private) Bool)
(assert true)
(assert (forall ((keystore__thistisinfo__fields us_split_fields12)) (forall ((keystore__state us_private)) (! (= (thistis keystore__thistisinfo__fields keystore__state) (rec__keystore__optionalprivatekeyt__owner (us_split_fields13 (mk___rep6 keystore__thistisinfo__fields)))) :pattern ((thistis keystore__thistisinfo__fields keystore__state))))))
...
(assert (forall ((x algorithmt)) (! (in_range18 (to_rep15 x)) :pattern ((to_rep15 x)))))
(assert (forall ((x Int)) (! (=> (in_range18 x) (= (to_rep15 (of_rep15 x)) x)) :pattern ((to_rep15 (of_rep15 x))))))
(declare-datatypes () ((us_split_fields14 (mk___split_fields7 (rec__cert__contentst__id us_rep1) (rec__cert__contentst__notbefore us_rep3) (rec__cert__contentst__notafter us_rep3) (rec__cert__contentst__mechanism algorithmt)))))
(define-fun us_split_fields_ID__3__projection ((a us_split_fields14)) us_rep1 (rec__cert__contentst__id a))
(define-fun us_split_fields_NotBefore__projection ((a us_split_fields14)) us_rep3 (rec__cert__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__projection ((a us_split_fields14)) us_rep3 (rec__cert__contentst__notafter a))
...
(define-fun bool_eq14 ((a us_rep8) (b us_rep8)) Bool (ite (and (and (and (= (bool_eq3 (rec__cert__contentst__id (us_split_fields15 a)) (rec__cert__contentst__id (us_split_fields15 b))) true) (= (bool_eq5 (rec__cert__contentst__notbefore (us_split_fields15 a)) (rec__cert__contentst__notbefore (us_split_fields15 b))) true)) (= (bool_eq5 (rec__cert__contentst__notafter (us_split_fields15 a)) (rec__cert__contentst__notafter (us_split_fields15 b))) true)) (= (to_rep15 (rec__cert__contentst__mechanism (us_split_fields15 a))) (to_rep15 (rec__cert__contentst__mechanism (us_split_fields15 b))))) true false))
...
(declare-fun user_eq30 (us_rep8 us_rep8) Bool)
(declare-const dummy30 us_rep8)
...
(declare-fun theid (us_rep8) us_rep1)
(declare-fun theid__function_guard (us_rep1 us_rep8) Bool)
(assert true)
...
(declare-datatypes () ((us_split_fields18 (mk___split_fields9 (rec__cert__id__contentst__id us_rep1) (rec__cert__id__contentst__notbefore us_rep3) (rec__cert__id__contentst__notafter us_rep3) (rec__cert__id__contentst__mechanism algorithmt) (rec__cert__id__contentst__subject us_rep) (rec__cert__id__contentst__subjectpublickey us_rep9)))))
(define-fun us_split_fields_ID__4__projection ((a us_split_fields18)) us_rep1 (rec__cert__id__contentst__id a))
(define-fun us_split_fields_NotBefore__2__projection ((a us_split_fields18)) us_rep3 (rec__cert__id__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__2__projection ((a us_split_fields18)) us_rep3 (rec__cert__id__contentst__notafter a))
(define-fun us_split_fields_Mechanism__2__projection ((a us_split_fields18)) algorithmt (rec__cert__id__contentst__mechanism a))
(define-fun us_split_fields_Subject__projection ((a us_split_fields18)) us_rep (rec__cert__id__contentst__subject a))
...
(define-fun us_split_fields__ref___14__projection ((a us_split_fields__ref9)) us_split_fields18 (us_split_fields__content9 a))
(declare-datatypes () ((us_rep10 (mk___rep9 (us_split_fields19 us_split_fields18)))))
(define-fun us_rep___15__projection ((a us_rep10)) us_split_fields18 (us_split_fields19 a))
(define-fun bool_eq16 ((a us_rep10) (b us_rep10)) Bool (ite (and (and (and (and (and (= (bool_eq3 (rec__cert__id__contentst__id (us_split_fields19 a)) (rec__cert__id__contentst__id (us_split_fields19 b))) true) (= (bool_eq5 (rec__cert__id__contentst__notbefore (us_split_fields19 a)) (rec__cert__id__contentst__notbefore (us_split_fields19 b))) true)) (= (bool_eq5 (rec__cert__id__contentst__notafter (us_split_fields19 a)) (rec__cert__id__contentst__notafter (us_split_fields19 b))) true)) (= (to_rep15 (rec__cert__id__contentst__mechanism (us_split_fields19 a))) (to_rep15 (rec__cert__id__contentst__mechanism (us_split_fields19 b))))) (= (bool_eq2 (rec__cert__id__contentst__subject (us_split_fields19 a)) (rec__cert__id__contentst__subject (us_split_fields19 b))) true)) (= (bool_eq15 (rec__cert__id__contentst__subjectpublickey (us_split_fields19 a)) (rec__cert__id__contentst__subjectpublickey (us_split_fields19 b))) true)) true false))
...
(define-fun contentst__ref___2__projection ((a contentst__ref1)) us_rep10 (contentst__content1 a))
(declare-fun cert_id_to_cert (us_rep10) us_rep8)
(declare-fun cert_id_to_cert__function_guard (us_rep8 us_rep10) Bool)
(assert true)
...
(define-fun us_split_fields_Clearance__projection ((a us_split_fields20)) us_rep2 (rec__cert__attr__priv__contentst__clearance a))
...
(define-fun bool_eq17 ((a us_rep11) (b us_rep11)) Bool (ite (and (and (and (and (and (and (= (bool_eq3 (rec__cert__attr__priv__contentst__id (us_split_fields21 a)) (rec__cert__attr__priv__contentst__id (us_split_fields21 b))) true) (= (bool_eq5 (rec__cert__attr__priv__contentst__notbefore (us_split_fields21 a)) (rec__cert__attr__priv__contentst__notbefore (us_split_fields21 b))) true)) (= (bool_eq5 (rec__cert__attr__priv__contentst__notafter (us_split_fields21 a)) (rec__cert__attr__priv__contentst__notafter (us_split_fields21 b))) true)) (= (to_rep15 (rec__cert__attr__priv__contentst__mechanism (us_split_fields21 a))) (to_rep15 (rec__cert__attr__priv__contentst__mechanism (us_split_fields21 b))))) (= (bool_eq3 (rec__cert__attr__priv__contentst__basecertid (us_split_fields21 a)) (rec__cert__attr__priv__contentst__basecertid (us_split_fields21 b))) true)) (= (to_rep18 (rec__cert__attr__priv__contentst__role (us_split_fields21 a))) (to_rep18 (rec__cert__attr__priv__contentst__role (us_split_fields21 b))))) (= (bool_eq4 (rec__cert__attr__priv__contentst__clearance (us_split_fields21 a)) (rec__cert__attr__priv__contentst__clearance (us_split_fields21 b))) true)) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_529 Int) (temp___is_init_526 Bool) (temp___skip_constant_527 Bool) (temp___do_toplevel_528 Bool)) Bool (=> (or (= temp___is_init_526 true) (<= 0 3)) (in_range21 temp___expr_529)))
(declare-fun therole (us_rep11) Int)
(declare-fun therole__function_guard (Int us_rep11) Bool)
(assert (forall ((contents us_rep11)) (! (dynamic_invariant3 (therole contents) true false true) :pattern ((therole contents)))))
(declare-fun theclearance (us_rep11) us_rep2)
(declare-fun theclearance__function_guard (us_rep2 us_rep11) Bool)
(assert true)
(declare-datatypes () ((us_split_fields22 (mk___split_fields11 (rec__cert__attr__auth__contentst__id us_rep1) (rec__cert__attr__auth__contentst__notbefore us_rep3) (rec__cert__attr__auth__contentst__notafter us_rep3) (rec__cert__attr__auth__contentst__mechanism algorithmt) (rec__cert__attr__auth__contentst__basecertid us_rep1) (rec__cert__attr__auth__contentst__role privileget) (rec__cert__attr__auth__contentst__clearance us_rep2)))))
(define-fun us_split_fields_ID__7__projection ((a us_split_fields22)) us_rep1 (rec__cert__attr__auth__contentst__id a))
(define-fun us_split_fields_NotBefore__5__projection ((a us_split_fields22)) us_rep3 (rec__cert__attr__auth__contentst__notbefore a))
(define-fun us_split_fields_NotAfter__5__projection ((a us_split_fields22)) us_rep3 (rec__cert__attr__auth__contentst__notafter a))
...
(define-fun us_split_fields_BaseCertID__3__projection ((a us_split_fields22)) us_rep1 (rec__cert__attr__auth__contentst__basecertid a))
(define-fun us_split_fields_Role__2__projection ((a us_split_fields22)) privileget (rec__cert__attr__auth__contentst__role a))
(define-fun us_split_fields_Clearance__2__projection ((a us_split_fields22)) us_rep2 (rec__cert__attr__auth__contentst__clearance a))
...
(define-fun bool_eq18 ((a us_rep12) (b us_rep12)) Bool (ite (and (and (and (and (and (and (= (bool_eq3 (rec__cert__attr__auth__contentst__id (us_split_fields23 a)) (rec__cert__attr__auth__contentst__id (us_split_fields23 b))) true) (= (bool_eq5 (rec__cert__attr__auth__contentst__notbefore (us_split_fields23 a)) (rec__cert__attr__auth__contentst__notbefore (us_split_fields23 b))) true)) (= (bool_eq5 (rec__cert__attr__auth__contentst__notafter (us_split_fields23 a)) (rec__cert__attr__auth__contentst__notafter (us_split_fields23 b))) true)) (= (to_rep15 (rec__cert__attr__auth__contentst__mechanism (us_split_fields23 a))) (to_rep15 (rec__cert__attr__auth__contentst__mechanism (us_split_fields23 b))))) (= (bool_eq3 (rec__cert__attr__auth__contentst__basecertid (us_split_fields23 a)) (rec__cert__attr__auth__contentst__basecertid (us_split_fields23 b))) true)) (= (to_rep18 (rec__cert__attr__auth__contentst__role (us_split_fields23 a))) (to_rep18 (rec__cert__attr__auth__contentst__role (us_split_fields23 b))))) (= (bool_eq4 (rec__cert__attr__auth__contentst__clearance (us_split_fields23 a)) (rec__cert__attr__auth__contentst__clearance (us_split_fields23 b))) true)) true false))
...
(assert true)
(define-fun dynamic_invariant4 ((temp___expr_505 Int) (temp___is_init_502 Bool) (temp___skip_constant_503 Bool) (temp___do_toplevel_504 Bool)) Bool (=> (or (= temp___is_init_502 true) (<= 0 4294967295)) (in_range6 temp___expr_505)))
(declare-fun serialnumber (us_private) Int)
(declare-fun serialnumber__function_guard (Int us_private) Bool)
(assert (forall ((certificatestore__state us_private)) (! (=> (not (= (serialnumberhasoverflowed certificatestore__state) true)) (dynamic_invariant4 (serialnumber certificatestore__state) true false true)) :pattern ((serialnumber certificatestore__state)))))
...
(declare-datatypes () ((us_split_fields24 (mk___split_fields12 (rec__usertoken__valididcertt__valid Bool) (rec__usertoken__valididcertt__idstatus certificatestatus) (rec__usertoken__valididcertt__contents us_rep10)))))
...
(define-fun us_split_fields_Contents__projection ((a us_split_fields24)) us_rep10 (rec__usertoken__valididcertt__contents a))
...
(define-fun bool_eq19 ((a us_rep13) (b us_rep13)) Bool (ite (and (and (= (rec__usertoken__valididcertt__valid (us_split_fields25 a)) (rec__usertoken__valididcertt__valid (us_split_fields25 b))) (= (to_rep19 (rec__usertoken__valididcertt__idstatus (us_split_fields25 a))) (to_rep19 (rec__usertoken__valididcertt__idstatus (us_split_fields25 b))))) (= (bool_eq16 (rec__usertoken__valididcertt__contents (us_split_fields25 a)) (rec__usertoken__valididcertt__contents (us_split_fields25 b))) true)) true false))
...
(declare-fun temp___String_Literal_2618 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2618 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 4)) 83)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 8)) 97)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 9)) 108)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 11)) 78)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 12)) 117)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 13)) 109)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 14)) 98)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 17)) 115)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 20)) 118)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 21)) 97)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 24)) 98)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 25)) 108)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 28)) 102)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 29)) 111)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 30)) 114)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 32)) 105)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 33)) 115)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 34)) 115)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 35)) 117)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 36)) 101)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 38)) 111)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 39)) 102)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 41)) 65)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 42)) 117)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 43)) 116)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 44)) 104)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 45)) 111)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 46)) 114)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 47)) 105)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 48)) 115)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 49)) 97)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 50)) 116)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 51)) 105)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 52)) 111)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 53)) 110)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 54)) 32)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 55)) 67)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 56)) 101)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 57)) 114)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 58)) 116)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 59)) 105)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 60)) 102)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 61)) 105)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 62)) 99)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 63)) 97)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 64)) 116)) (= (to_rep (select (temp___String_Literal_2618 us_void_param) 65)) 101)) :pattern ((temp___String_Literal_2618 us_void_param)))))
...
(define-fun dynamic_invariant9 ((temp___expr_2236 Int) (temp___is_init_2233 Bool) (temp___skip_constant_2234 Bool) (temp___do_toplevel_2235 Bool)) Bool (=> (or (= temp___is_init_2233 true) (<= 0 3)) (in_range22 temp___expr_2236)))
(define-fun dynamic_invariant10 ((temp___expr_1153 Int) (temp___is_init_1150 Bool) (temp___skip_constant_1151 Bool) (temp___do_toplevel_1152 Bool)) Bool (=> (or (= temp___is_init_1150 true) (<= 0 17)) (in_range15 temp___expr_1153)))
(define-fun dynamic_invariant11 ((temp___expr_1132 Int) (temp___is_init_1129 Bool) (temp___skip_constant_1130 Bool) (temp___do_toplevel_1131 Bool)) Bool (=> (or (= temp___is_init_1129 true) (<= 1 17)) (in_range13 temp___expr_1132)))
(define-fun dynamic_invariant12 ((temp___expr_1257 Int) (temp___is_init_1254 Bool) (temp___skip_constant_1255 Bool) (temp___do_toplevel_1256 Bool)) Bool (=> (or (= temp___is_init_1254 true) (<= 0 2)) (in_range17 temp___expr_1257)))
(define-fun dynamic_invariant13 ((temp___expr_1138 Int) (temp___is_init_1135 Bool) (temp___skip_constant_1136 Bool) (temp___do_toplevel_1137 Bool)) Bool (=> (or (= temp___is_init_1135 true) (<= 0 17408)) (in_range14 temp___expr_1138)))
(define-fun dynamic_invariant14 ((temp___expr_1172 Int) (temp___is_init_1169 Bool) (temp___skip_constant_1170 Bool) (temp___do_toplevel_1171 Bool)) Bool (=> (or (= temp___is_init_1169 true) (<= 0 1024)) (in_range16 temp___expr_1172)))
(assert true)
(assert (forall ((currentlogfile Int) (numberlogentries Int)) (forall ((usedlogfiles us_rep4)) (forall ((logfileentries (Array Int fileentrycountt))) (! (= (= (valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries) true) (and (<= 1 (to_rep12 (rec__auditlog__logfilelistt__length (us_split_fields9 usedlogfiles)))) (= numberlogentries (+ (* (- (to_rep12 (rec__auditlog__logfilelistt__length (us_split_fields9 usedlogfiles))) 1) 1024) (to_rep13 (select logfileentries currentlogfile)))))) :pattern ((valid_numberlogentries currentlogfile numberlogentries usedlogfiles logfileentries)))))))
(assert (= nouser (temp___String_Literal_142 Tuple0)))
(define-fun dynamic_invariant15 ((temp___expr_626 Int) (temp___is_init_623 Bool) (temp___skip_constant_624 Bool) (temp___do_toplevel_625 Bool)) Bool (=> (or (= temp___is_init_623 true) (<= 1901 2099)) (in_range9 temp___expr_626)))
(define-fun dynamic_invariant16 ((temp___expr_632 Int) (temp___is_init_629 Bool) (temp___skip_constant_630 Bool) (temp___do_toplevel_631 Bool)) Bool (=> (or (= temp___is_init_629 true) (<= 1 12)) (in_range10 temp___expr_632)))
(define-fun dynamic_invariant17 ((temp___expr_638 Int) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool)) Bool (=> (or (= temp___is_init_635 true) (<= 1 31)) (in_range11 temp___expr_638)))
(define-fun dynamic_invariant18 ((temp___expr_666 Int) (temp___is_init_663 Bool) (temp___skip_constant_664 Bool) (temp___do_toplevel_665 Bool)) Bool (=> (or (= temp___is_init_663 true) (<= 0 86399999)) (in_range12 temp___expr_666)))
(assert (= zerotime (mk___rep3 (mk___split_fields3 (of_rep6 1901) (of_rep7 1) (of_rep8 1) (of_rep9 0)))))
(define-fun dynamic_invariant19 ((temp___expr_359 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 40)) (in_range4 temp___expr_359)))
(define-fun dynamic_invariant20 ((temp___expr_380 Int) (temp___is_init_377 Bool) (temp___skip_constant_378 Bool) (temp___do_toplevel_379 Bool)) Bool (=> (or (= temp___is_init_377 true) (<= 0 4294967295)) (in_range5 temp___expr_380)))
(define-fun dynamic_invariant21 ((temp___expr_402 Int) (temp___is_init_399 Bool) (temp___skip_constant_400 Bool) (temp___do_toplevel_401 Bool)) Bool (=> (or (= temp___is_init_399 true) (<= 0 10)) (in_range18 temp___expr_402)))
(define-fun dynamic_invariant22 ((temp___expr_414 Int) (temp___is_init_411 Bool) (temp___skip_constant_412 Bool) (temp___do_toplevel_413 Bool)) Bool (=> (or (= temp___is_init_411 true) (<= 0 4294967295)) (in_range19 temp___expr_414)))
(define-fun dynamic_invariant23 ((temp___expr_420 Int) (temp___is_init_417 Bool) (temp___skip_constant_418 Bool) (temp___do_toplevel_419 Bool)) Bool (=> (or (= temp___is_init_417 true) (<= 0 128)) (in_range20 temp___expr_420)))
...
(declare-const clearance__split_fields us_split_fields__ref2)
...
(declare-const id__split_fields5 us_split_fields2)
...
(assert (= o4 (mk___split_fields3 o3 o2 o1 o)))
(assert (= temp___2639 (mk___rep3 o4)))
(assert (= temp___2639 zerotime))
(assert (= (valid_numberlogentries (to_rep10 logfilestate__split_fields) (to_rep11 logfilestate__split_fields1) (mk___rep4 (mk___split_fields4 logfilestate__split_fields2 logfilestate__split_fields3 logfilestate__split_fields4 logfilestate__split_fields5)) logfilestate__split_fields6) true))
(assert (in_range8 auditalarm))
(assert (= (privatekeypresent (mk___split_fields6 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state1)) true))
(assert (= o5 (theclearance (rec__usertoken__validprivcertt__contents (us_split_fields__content14 privcert__split_fields)))))
(assert (= o6 (us_split_fields5 o5)))
(assert (= o7 (rec__privtypes__clearancet__class o6)))
(assert (= o8 (to_rep5 o7)))
(assert (= (to_rep5 o9) o8))
(assert (= o10 (mk___split_fields2 o9)))
(assert (= temp___2610 (mk___rep2 o10)))
(assert (= result clearance__split_fields))
(assert (= (let ((subject clearance__split_fields)) clearance__split_fields1) (us_split_fields5 temp___2610)))
(assert (and (= o11 (theenclaveclearance (us_private__content state))) (in_range7 o11)))
(assert (= result1 (ite (< o11 (to_rep5 (rec__privtypes__clearancet__class (let ((subject clearance__split_fields)) clearance__split_fields1)))) true false)))
(assert (=> (= result1 true) (and (= o12 (theenclaveclearance (us_private__content state))) (in_range7 o12))))
(assert (=> (= result1 true) (= (to_rep5 o13) o12)))
(assert (=> (= result1 true) (= o14 (mk___split_fields2 o13))))
(assert (=> (= result1 true) (= temp___2612 (mk___rep2 o14))))
(assert (=> (= result1 true) (= result2 (let ((subject clearance__split_fields)) (mk___split_fields__ref2 clearance__split_fields1)))))
(assert (=> (= result1 true) (= (let ((subject clearance__split_fields)) clearance__split_fields2) (us_split_fields5 temp___2612))))
(assert (=> (not (= result1 true)) (= (let ((subject clearance__split_fields)) (mk___split_fields__ref2 clearance__split_fields2)) (let ((subject clearance__split_fields)) (mk___split_fields__ref2 clearance__split_fields1)))))
...
(assert (=> (= result3 true) (and (= temp___2613 (thecurrenttime (mk___split_fields3 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime))) (= temp___2613 (mk___rep3 (mk___split_fields3 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3))))))
...
(assert (=> (= result3 true) (= notbefore__split_fields4 (us_split_fields7 temp___2613))))
...
(assert (=> (not (= result3 true)) (and (= o15 (thecurrenttime (mk___split_fields3 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime))) (= o15 (mk___rep3 (mk___split_fields3 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3))))))
...
(assert (and (= o16 (thistis (mk___split_fields6 thistisinfo__split_fields (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3))) (us_private__content state1))) (= o16 (mk___rep (mk___split_fields thistisinfo__split_fields1 thistisinfo__split_fields2 thistisinfo__split_fields3)))))
(assert (= o17 (mk___split_fields1 o16 id__split_fields3)))
(assert (= temp___2615 (mk___rep1 o17)))
...
(assert (= id__split_fields4 (us_split_fields3 temp___2615)))
(assert (= o18 (serialnumberhasoverflowed (us_private__content state2))))
(assert (= result7 (ite (not (= o18 true)) true false)))
(assert (= result7 true))
(assert (not (not (= (serialnumberhasoverflowed (us_private__content state2)) true))))
(check-sat)
(exit)
