...
(define-fun dynamic_invariant ((temp___expr_626 Int) (temp___is_init_622 Bool) (temp___skip_constant_623 Bool) (temp___do_toplevel_624 Bool) (temp___do_typ_inv_625 Bool)) Bool (=> (or (= temp___is_init_622 true) (<= 0 1)) (in_range8 temp___expr_626)))
...
(assert true)
(define-fun dynamic_invariant1 ((temp___expr_607 Int) (temp___is_init_603 Bool) (temp___skip_constant_604 Bool) (temp___do_toplevel_605 Bool) (temp___do_typ_inv_606 Bool)) Bool (=> (or (= temp___is_init_603 true) (<= 0 5)) (in_range7 temp___expr_607)))
(declare-fun theenclaveclearance (us_private) Int)
(declare-fun theenclaveclearance__function_guard (Int us_private) Bool)
(assert (forall ((configdata__state us_private)) (! (dynamic_invariant1 (theenclaveclearance configdata__state) true false true true) :pattern ((theenclaveclearance configdata__state)))))
...
(define-fun bool_eq6 ((a (Array Int logfileindext)) (a__first Int) (a__last Int) (b (Array Int logfileindext)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep10 (select a temp___idx_175)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_175))))))) true false))
(assert (forall ((a (Array Int logfileindext)) (b (Array Int logfileindext))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_175 Int)) (=> (and (<= a__first temp___idx_175) (<= temp___idx_175 a__last)) (= (to_rep10 (select a temp___idx_175)) (to_rep10 (select b (+ (- b__first a__first) temp___idx_175)))))))))))
...
(define-fun bool_eq8 ((a (Array Int fileentrycountt)) (a__first Int) (a__last Int) (b (Array Int fileentrycountt)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep13 (select a temp___idx_176)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_176))))))) true false))
(assert (forall ((a (Array Int fileentrycountt)) (b (Array Int fileentrycountt))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq8 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_176 Int)) (=> (and (<= a__first temp___idx_176) (<= temp___idx_176 a__last)) (= (to_rep13 (select a temp___idx_176)) (to_rep13 (select b (+ (- b__first a__first) temp___idx_176)))))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_1337 us_rep5) (temp___is_init_1333 Bool) (temp___skip_constant_1334 Bool) (temp___do_toplevel_1335 Bool) (temp___do_typ_inv_1336 Bool)) Bool (=> (= temp___do_typ_inv_1336 true) (= (valid_numberlogentries (to_rep10 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___expr_1337))) (to_rep11 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___expr_1337))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___expr_1337)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___expr_1337))) true)))
(define-fun default_initial_assumption ((temp___expr_1341 us_rep5) (temp___skip_top_level_1342 Bool)) Bool (and (and (and (= (to_rep10 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___expr_1341))) 1) (= (to_rep11 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___expr_1341))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___expr_1341)) (mk___rep4 (mk___split_fields4 (temp___1343 1) (of_rep10 1) (of_rep10 1) (of_rep12 1))))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___expr_1341)) (temp___1347 0))))
(define-fun type_invariant ((temp___1351 us_rep5)) Bool (= (valid_numberlogentries (to_rep10 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields11 temp___1351))) (to_rep11 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields11 temp___1351))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields11 temp___1351)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields11 temp___1351))) true))
...
(define-fun bool_eq11 ((a (Array Int us_rep6)) (a__first Int) (a__last Int) (b (Array Int us_rep6)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq10 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true)))) true false))
(assert (forall ((a (Array Int us_rep6)) (b (Array Int us_rep6))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq11 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_177 Int)) (=> (and (<= a__first temp___idx_177) (<= temp___idx_177 a__last)) (= (bool_eq10 (select a temp___idx_177) (select b (+ (- b__first a__first) temp___idx_177))) true))))))))
...
(assert (forall ((a (Array Int filestatust)) (b (Array Int filestatust))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq12 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_178 Int)) (=> (and (<= a__first temp___idx_178) (<= temp___idx_178 a__last)) (= (to_rep14 (select a temp___idx_178)) (to_rep14 (select b (+ (- b__first a__first) temp___idx_178)))))))))))
...
(assert true)
(define-fun dynamic_invariant4 ((temp___expr_567 Int) (temp___is_init_563 Bool) (temp___skip_constant_564 Bool) (temp___do_toplevel_565 Bool) (temp___do_typ_inv_566 Bool)) Bool (=> (or (= temp___is_init_563 true) (<= 0 4294967295)) (in_range6 temp___expr_567)))
...
(declare-fun temp___String_Literal_2801 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_2801 us_void_param) 1)) 78) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 3)) 32)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 4)) 83)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 5)) 101)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 6)) 114)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 7)) 105)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 8)) 97)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 9)) 108)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 10)) 32)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 11)) 78)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 12)) 117)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 13)) 109)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 14)) 98)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 15)) 101)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 16)) 114)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 17)) 115)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 18)) 32)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 19)) 97)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 20)) 118)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 21)) 97)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 23)) 97)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 24)) 98)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 25)) 108)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 26)) 101)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 27)) 32)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 28)) 102)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 29)) 111)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 30)) 114)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 32)) 105)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 33)) 115)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 34)) 115)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 35)) 117)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 36)) 101)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 38)) 111)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 39)) 102)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 40)) 32)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 41)) 65)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 42)) 117)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 43)) 116)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 44)) 104)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 45)) 111)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 46)) 114)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 47)) 105)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 48)) 115)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 49)) 97)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 50)) 116)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 51)) 105)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 52)) 111)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 53)) 110)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 54)) 32)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 55)) 67)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 56)) 101)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 57)) 114)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 58)) 116)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 59)) 105)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 60)) 102)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 61)) 105)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 62)) 99)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 63)) 97)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 64)) 116)) (= (to_rep (select (temp___String_Literal_2801 us_void_param) 65)) 101)) :pattern ((temp___String_Literal_2801 us_void_param)))))
...
(define-fun dynamic_invariant9 ((temp___expr_2414 Int) (temp___is_init_2410 Bool) (temp___skip_constant_2411 Bool) (temp___do_toplevel_2412 Bool) (temp___do_typ_inv_2413 Bool)) Bool (=> (or (= temp___is_init_2410 true) (<= 0 3)) (in_range22 temp___expr_2414)))
(define-fun dynamic_invariant10 ((temp___expr_1275 Int) (temp___is_init_1271 Bool) (temp___skip_constant_1272 Bool) (temp___do_toplevel_1273 Bool) (temp___do_typ_inv_1274 Bool)) Bool (=> (or (= temp___is_init_1271 true) (<= 0 17)) (in_range15 temp___expr_1275)))
(define-fun dynamic_invariant11 ((temp___expr_1282 Int) (temp___is_init_1278 Bool) (temp___skip_constant_1279 Bool) (temp___do_toplevel_1280 Bool) (temp___do_typ_inv_1281 Bool)) Bool (=> (or (= temp___is_init_1278 true) (<= 1 17)) (in_range13 temp___expr_1282)))
(define-fun dynamic_invariant12 ((temp___expr_1408 Int) (temp___is_init_1404 Bool) (temp___skip_constant_1405 Bool) (temp___do_toplevel_1406 Bool) (temp___do_typ_inv_1407 Bool)) Bool (=> (or (= temp___is_init_1404 true) (<= 0 2)) (in_range17 temp___expr_1408)))
(define-fun dynamic_invariant13 ((temp___expr_1289 Int) (temp___is_init_1285 Bool) (temp___skip_constant_1286 Bool) (temp___do_toplevel_1287 Bool) (temp___do_typ_inv_1288 Bool)) Bool (=> (or (= temp___is_init_1285 true) (<= 0 17408)) (in_range14 temp___expr_1289)))
(define-fun dynamic_invariant14 ((temp___expr_1320 Int) (temp___is_init_1316 Bool) (temp___skip_constant_1317 Bool) (temp___do_toplevel_1318 Bool) (temp___do_typ_inv_1319 Bool)) Bool (=> (or (= temp___is_init_1316 true) (<= 0 1024)) (in_range16 temp___expr_1320)))
(assert true)
...
(assert (forall ((temp___1349 Int)) (=> (dynamic_invariant14 temp___1349 true true true true) (forall ((temp___1350 Int)) (= (to_rep13 (select (temp___1347 temp___1349) temp___1350)) temp___1349)))))
(assert (= nouser (temp___String_Literal_164 Tuple0)))
(define-fun dynamic_invariant15 ((temp___expr_703 Int) (temp___is_init_699 Bool) (temp___skip_constant_700 Bool) (temp___do_toplevel_701 Bool) (temp___do_typ_inv_702 Bool)) Bool (=> (or (= temp___is_init_699 true) (<= 1901 2099)) (in_range9 temp___expr_703)))
(define-fun dynamic_invariant16 ((temp___expr_710 Int) (temp___is_init_706 Bool) (temp___skip_constant_707 Bool) (temp___do_toplevel_708 Bool) (temp___do_typ_inv_709 Bool)) Bool (=> (or (= temp___is_init_706 true) (<= 1 12)) (in_range10 temp___expr_710)))
(define-fun dynamic_invariant17 ((temp___expr_717 Int) (temp___is_init_713 Bool) (temp___skip_constant_714 Bool) (temp___do_toplevel_715 Bool) (temp___do_typ_inv_716 Bool)) Bool (=> (or (= temp___is_init_713 true) (<= 1 31)) (in_range11 temp___expr_717)))
(define-fun dynamic_invariant18 ((temp___expr_749 Int) (temp___is_init_745 Bool) (temp___skip_constant_746 Bool) (temp___do_toplevel_747 Bool) (temp___do_typ_inv_748 Bool)) Bool (=> (or (= temp___is_init_745 true) (<= 0 86399999)) (in_range12 temp___expr_749)))
(assert (= zerotime (mk___rep3 (mk___split_fields3 (of_rep6 1901) (of_rep7 1) (of_rep8 1) (of_rep9 0)))))
(define-fun dynamic_invariant19 ((temp___expr_402 Int) (temp___is_init_398 Bool) (temp___skip_constant_399 Bool) (temp___do_toplevel_400 Bool) (temp___do_typ_inv_401 Bool)) Bool (=> (or (= temp___is_init_398 true) (<= 0 40)) (in_range4 temp___expr_402)))
(define-fun dynamic_invariant20 ((temp___expr_426 Int) (temp___is_init_422 Bool) (temp___skip_constant_423 Bool) (temp___do_toplevel_424 Bool) (temp___do_typ_inv_425 Bool)) Bool (=> (or (= temp___is_init_422 true) (<= 0 4294967295)) (in_range5 temp___expr_426)))
...
(assert (forall ((temp___1345 Int)) (=> (dynamic_invariant11 temp___1345 true true true true) (forall ((temp___1346 Int)) (= (to_rep10 (select (temp___1343 temp___1345) temp___1346)) temp___1345)))))
...
(declare-const temp___2822 us_rep3)
...
(assert (= temp___2822 (mk___rep3 o4)))
(assert (= temp___2822 zerotime))
...
(assert (= temp___2793 (mk___rep2 o10)))
(assert (= result clearance__split_fields))
(assert (= (let ((subject clearance__split_fields)) clearance__split_fields1) (us_split_fields5 temp___2793)))
...
(assert (=> (= result1 true) (= temp___2795 (mk___rep2 o14))))
(assert (=> (= result1 true) (= result2 (let ((subject clearance__split_fields)) (mk___split_fields__ref2 clearance__split_fields1)))))
(assert (=> (= result1 true) (= (let ((subject clearance__split_fields)) clearance__split_fields2) (us_split_fields5 temp___2795))))
...
(assert (=> (= result3 true) (and (= temp___2796 (thecurrenttime (mk___split_fields3 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3) (us_private__content currenttime))) (= temp___2796 (mk___rep3 (mk___split_fields3 currenttimevar__split_fields currenttimevar__split_fields1 currenttimevar__split_fields2 currenttimevar__split_fields3))))))
...
(assert (=> (= result3 true) (= notbefore__split_fields4 (us_split_fields7 temp___2796))))
...
(assert (= temp___2798 (mk___rep1 o17)))
...
(assert (= id__split_fields4 (us_split_fields3 temp___2798)))
