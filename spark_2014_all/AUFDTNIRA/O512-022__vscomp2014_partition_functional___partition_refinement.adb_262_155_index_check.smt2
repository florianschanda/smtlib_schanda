...
(assert (= result2 true))
(assert (and (= o9 j) (in_range10 j)))
(assert (and (= o10 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) o9)) (= (bool_eq10 o10 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) o9)) true)))
(assert (= o11 (us_split_fields9 o10)))
