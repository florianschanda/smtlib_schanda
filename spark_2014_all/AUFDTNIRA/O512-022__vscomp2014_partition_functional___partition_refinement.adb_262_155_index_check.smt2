...
(assert (and (= o80 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) o79)) (= (bool_eq10 o80 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) o79)) true)))
(assert (= o81 (us_split_fields9 o80)))
(assert (= o82 (rec__partition_refinement__interval__first o81)))
(assert (= o83 (to_rep2 o82)))
(assert (= o90 (ite (<= o83 k1) true false)))
(assert (= result18 (ite (= o90 true) o89 false)))
