...
(assert (= result3 true))
(assert (and (= o43 (* j2 l2)) (in_range1 (* j2 l2))))
(assert (and (= o44 (- length1 i3)) (in_range1 (- length1 i3))))
(assert (= o45 (- o44 o43)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (= o47 (ite (< l2 o46) l2 o46)))
(assert (and (= o48 o47) (in_range2 o47)))
(assert (and (= o38 (* j2 l2)) (in_range1 (* j2 l2))))
(assert (and (= o39 (+ a_first i3)) (in_range1 (+ a_first i3))))
(assert (= o40 (+ o39 o38)))
(assert (not (in_range1 o40)))
(check-sat)
(exit)
