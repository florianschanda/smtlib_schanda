...
(declare-const o2 us_split_fields8)
...
(assert (and (forall ((k Int)) (=> (and (<= 0 k) (<= k 5)) (= (to_rep (select a1 k)) (ite (= k (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o)) (to_rep (select a (+ (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))) (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o)))))))))) (ite (= k (+ (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))) (to_rep1 (rec__partition_refinement__interval__count (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))))))))) (to_rep (select a (get4 (model__1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) o))) (to_rep (select a k))))))) (and (= (capacity (mk___rep5 p__split_discrs p__split_fields1)) (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (= (length1 (mk___rep5 p__split_discrs p__split_fields1)) (length1 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (= (has_key2 (model__1 (mk___rep3 d__split_discrs d__split_fields1)) (to_rep (select a1 j1))) true))) (and (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields1)) c) true) (= (to_rep (select a1 (element1 (mk___rep3 d__split_discrs d__split_fields1) c))) (key (mk___rep3 d__split_discrs d__split_fields1) c)))) (forall ((c us_rep4)) (=> (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c) true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs d__split_fields1)) c) true)))))))))
...
(assert (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 (- (length1 (mk___rep5 p__split_discrs p__split_fields2)) 1))) (forall ((k Int)) (=> (and (<= (to_rep2 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) j1)))) k) (<= k (to_rep2 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) j1)))))) (= (to_rep4 (select f k)) j1))))))
(assert (<= 0 j))
(assert (<= j 5))
(assert (and (= o1 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) (to_rep4 (select f j)))) (= (bool_eq10 o1 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields2)) (to_rep4 (select f j)))) true)))
(assert (= o2 (us_split_fields9 o1)))
(assert (= o3 (rec__partition_refinement__interval__last o2)))
(assert (= o4 (to_rep2 o3)))
