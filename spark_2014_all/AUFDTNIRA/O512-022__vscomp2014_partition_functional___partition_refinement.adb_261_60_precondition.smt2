...
(assert (<= 0 j3))
(assert (<= j3 5))
(assert (and (= o71 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) (to_rep4 (select f j3)))) (= (bool_eq10 o71 (get5 (model__2 (mk___rep5 p__split_discrs p__split_fields3)) (to_rep4 (select f j3)))) true)))
(assert (= o72 (us_split_fields9 o71)))
(assert (= o73 (rec__partition_refinement__interval__last o72)))
(assert (= o74 (to_rep2 o73)))
(assert (= o75 (ite (<= j3 o74) true false)))
(assert (not (<= 0 (to_rep4 (select f j3)))))
(check-sat)
(exit)
