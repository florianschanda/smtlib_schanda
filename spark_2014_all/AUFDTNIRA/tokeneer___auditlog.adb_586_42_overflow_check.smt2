...
(assert (and (= o (- (to_rep3 logfilestate__split_fields5) 1)) (in_range6 (- (to_rep3 logfilestate__split_fields5) 1))))
(assert (= o1 (* o 1024)))
(assert (and (= o2 o1) (in_range5 o1)))
(assert (= o3 (+ o2 (to_rep4 (select logfilestate__split_fields6 (to_rep1 logfilestate__split_fields))))))
