...
(assert (and (and (and (and (and (= (to_rep1 (first4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def 2 1 4 7 4 7 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last4 (rt2 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def 2 1 4 7 4 7 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)) (= (mk___t2 temp___1340 temp___13401) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__aggregate_def 2 1 4 7 4 7 9 9 9 9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (and (= (ite (<= (to_rep1 (first4 temp___13401)) (to_rep1 (last4 temp___13401))) (+ (- (to_rep1 (last4 temp___13401)) (to_rep1 (first4 temp___13401))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1340 (to_rep1 (first4 temp___13401)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume) (= (mk1 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume1)))) (and (and (= (mk_map__ref1 result) (mk_map__ref1 int_array)) (= int_array1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume)) (and (= (to_rep1 int_array__first) (to_rep1 (first2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume1))) (= (to_rep1 int_array__last) (to_rep1 (last2 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__int_array__assume1)))))) (and (and (dynamic_property2 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 int_array__first) (to_rep1 int_array__last)) (and (= (to_rep1 int_array__first) (to_rep1 (first (rt source)))) (= (to_rep1 int_array__last) (+ (to_rep1 (first (rt source))) 9)))) (and (and (and (and (= (to_rep1 (first8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (to_rep1 (first (rt source)))) (and (= (to_rep1 (last8 (rt4 (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (+ (to_rep1 (first (rt source))) 9)) (= (mk___t4 temp___1348 temp___13481) (aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__aggregate_def 0 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9))))) (and (= (ite (<= (to_rep1 (first8 temp___13481)) (to_rep1 (last8 temp___13481))) (+ (- (to_rep1 (last8 temp___13481)) (to_rep1 (first8 temp___13481))) 1) 0) (ite (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (+ (- (+ (to_rep1 (first (rt source))) 9) (to_rep1 (first (rt source)))) 1) 0)) (and (= (slide1 temp___1348 (to_rep1 (first8 temp___13481)) (to_rep1 (first (rt source)))) aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume) (= (mk3 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume1)))) (and (and (= (mk_map__ref1 result1) (mk_map__ref1 n)) (= n1 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume)) (and (= (to_rep1 n__first) (to_rep1 (first6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume1))) (= (to_rep1 n__last) (to_rep1 (last6 aida__conversion__calculate_positive_target_for_length_10_case_2_147_47x_xxx__n__assume1)))))) (and (and (dynamic_property6 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) (to_rep1 n__first) (to_rep1 n__last)) (and (= (to_rep1 n__first) (to_rep1 (first (rt source)))) (= (to_rep1 n__last) (+ (to_rep1 (first (rt source))) 9)))) (and (and (and (= temp___1355 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (= (mk_int__ref result2) (mk_int__ref index)) (= index2 (to_rep1 (first (rt source))))) (ite (and (<= (to_rep1 (first (rt source))) index2) (<= index2 temp___1355)) (and (and (and (= temp___1352 n1) (and (= temp___1350 index2) (and (and (and (and (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o21 index2)) (= o22 (select n1 o21))) (= o23 (to_rep1 o22))) (= o23 aida__conversion__convert_character_digit_to_integer__2__target)) (and (and (and (and (and (and (<= (to_rep1 (first (rt source))) index2) (<= index2 (to_rep1 (last (rt source))))) (= o24 index2)) (= o25 (select (elts source) o24))) (= o26 (to_rep o25))) (and (and (and (and (<= 0 aida__conversion__convert_character_digit_to_integer__2__target2) (<= aida__conversion__convert_character_digit_to_integer__2__target2 9)) (= aida__conversion__convert_character_digit_to_integer__2__target2 (convert_character_digit_to_integer o26))) (ite (= (= o26 48) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 0) (ite (= (= o26 49) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 1) (ite (= (= o26 50) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 2) (ite (= (= o26 51) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 3) (ite (= (= o26 52) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 4) (ite (= (= o26 53) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 5) (ite (= (= o26 54) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 6) (ite (= (= o26 55) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 7) (ite (= (= o26 56) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 8) (=> (= (= o26 57) true) (= aida__conversion__convert_character_digit_to_integer__2__target2 9)))))))))))) (in_range1 aida__conversion__convert_character_digit_to_integer__2__target2))) (and (and (= (to_rep1 o27) aida__conversion__convert_character_digit_to_integer__2__target2) (and (and (and (<= (to_rep1 n__first) index2) (<= index2 (to_rep1 n__last))) (= o28 index2)) (= o29 (store n1 o28 o27)))) (and (= n1 result3) (= n2 o29))))) (and (and (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt source))) i2) (<= i2 index3)) (and (<= 0 (to_rep1 (select n3 i2))) (<= (to_rep1 (select n3 i2)) 9)))) (forall ((j1 Int)) (=> (and (<= (to_rep1 (first (rt source))) j1) (<= j1 index3)) (<= (to_rep1 (select n3 j1)) (to_rep1 (select int_array1 j1)))))) (and (and (and (=> (<= (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9)) (dynamic_property9 (to_rep1 (first (rt source))) (+ (to_rep1 (first (rt source))) 9) index3)) (forall ((temp___1353 Int)) (=> (and (<= (to_rep1 n__first) temp___1353) (<= temp___1353 (to_rep1 n__last))) (=> (< index3 temp___1353) (= (select n3 temp___1353) (select temp___1352 temp___1353)))))) (and (<= (to_rep1 (first (rt source))) index3) (<= index3 (+ (to_rep1 (first (rt source))) 9)))) (= index3 temp___1355)))))) (and (and (= index3 index5) (= n3 n5)) (and (= index6 index3) (= n6 n3)))) (and (and (= index7 (mk_int__ref index5)) (= n7 (mk_map__ref1 n5))) (and (= index8 index6) (= n8 n6)))) (and (and (= index7 (mk_int__ref index2)) (= n7 (mk_map__ref1 n1))) (and (= index8 index2) (= n8 n1)))))) (and (forall ((i2 Int)) (=> (and (<= (to_rep1 n__first) i2) (<= i2 (to_rep1 n__last))) (and (<= 0 (to_rep1 (select (map__content1 n7) i2))) (<= (to_rep1 (select (map__content1 n7) i2)) (to_rep1 (select int_array1 i2)))))) (and (and (and (and (and (and (= temp___1356 (+ (to_rep1 (first (rt source))) 9)) (in_range1 (+ (to_rep1 (first (rt source))) 9))) (and (and (<= (to_rep1 n__first) temp___1356) (<= temp___1356 (to_rep1 n__last))) (= o53 temp___1356))) (= o54 (select (map__content1 n7) o53))) (= o55 (to_rep1 o54))) (and (= result6 (mk_int__ref target)) (= target1 o55))) (and (<= target1 9) (and (and (and (and (and (and (and (and (and (and (= temp___1357 (+ (to_rep1 (first (rt source))) 8)) (in_range1 (+ (to_rep1 (first (rt source))) 8))) (and (and (<= (to_rep1 n__first) temp___1357) (<= temp___1357 (to_rep1 n__last))) (= o56 temp___1357))) (= o57 (select (map__content1 n7) o56))) (= o58 (to_rep1 o57))) (= o59 (* o58 10))) (and (= o60 o59) (in_range1 o59))) (= o61 (+ target1 o60))) (and (= o62 o61) (in_range1 o61))) (and (= result7 (mk_int__ref target1)) (= target2 o62))) (and (<= target2 99) (and (and (and (and (and (and (and (and (and (and (= temp___1358 (+ (to_rep1 (first (rt source))) 7)) (in_range1 (+ (to_rep1 (first (rt source))) 7))) (and (and (<= (to_rep1 n__first) temp___1358) (<= temp___1358 (to_rep1 n__last))) (= o63 temp___1358))) (= o64 (select (map__content1 n7) o63))) (= o65 (to_rep1 o64))) (= o66 (* o65 100))) (and (= o67 o66) (in_range1 o66))) (= o68 (+ target2 o67))) (and (= o69 o68) (in_range1 o68))) (and (= result8 (mk_int__ref target2)) (= target3 o69))) (and (<= target3 999) (and (and (and (and (and (and (and (and (and (and (= temp___1359 (+ (to_rep1 (first (rt source))) 6)) (in_range1 (+ (to_rep1 (first (rt source))) 6))) (and (and (<= (to_rep1 n__first) temp___1359) (<= temp___1359 (to_rep1 n__last))) (= o70 temp___1359))) (= o71 (select (map__content1 n7) o70))) (= o72 (to_rep1 o71))) (= o73 (* o72 1000))) (and (= o74 o73) (in_range1 o73))) (= o75 (+ target3 o74))) (and (= o76 o75) (in_range1 o75))) (and (= result9 (mk_int__ref target3)) (= target4 o76))) (and (<= target4 9999) (and (and (and (and (and (and (and (and (and (and (= temp___1360 (+ (to_rep1 (first (rt source))) 5)) (in_range1 (+ (to_rep1 (first (rt source))) 5))) (and (and (<= (to_rep1 n__first) temp___1360) (<= temp___1360 (to_rep1 n__last))) (= o77 temp___1360))) (= o78 (select (map__content1 n7) o77))) (= o79 (to_rep1 o78))) (= o80 (* o79 10000))) (and (= o81 o80) (in_range1 o80))) (= o82 (+ target4 o81))) (and (= o83 o82) (in_range1 o82))) (and (= result10 (mk_int__ref target4)) (= target5 o83))) (and (<= target5 79999) (and (and (and (= o84 (+ target5 2147400000)) (in_range1 (+ target5 2147400000))) (and (= result11 (mk_int__ref target5)) (= target6 o84))) (and (<= target6 2147479999) (and (= result12 (mk_bool__ref has_failed)) (= has_failed1 (of_int 0))))))))))))))))))))) (and (and (= index9 index7) (and (= n9 n7) (and (= int_array2 (mk_map__ref1 int_array1)) (and (= has_failed2 (mk_bool__ref has_failed1)) (= target7 (mk_int__ref target6)))))) (and (= index10 index8) (and (= n10 n8) (and (= int_array3 int_array1) (and (= has_failed3 has_failed1) (= target8 target6))))))))
