...
(assert (and (= o14 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o14) (= o14 (ite (= (distinct 1 0) true) (to_rep5 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o12 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o12) (<= o12 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
(assert (= o13 (* 2 o12)))
(assert (and (= o15 o13) (in_range2 o13)))
(assert (= result (ite (<= o15 o14) true false)))
(assert (= result true))
(assert (and (= o11 (length2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))) (and (in_range12 o11) (<= o11 (capacity (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields)))))))
...
(assert (= result2 true))
(assert (and (= o9 (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2)) (= (= o9 true) (= (has_key1 (positions1 (mk___rep3 d__split_discrs (mk___split_fields3 d__split_fields))) c2) true))))
(assert (= o10 true))
...
(assert (= result3 true))
(assert (and (= o7 (has_key (positions x) c3)) (= (= o7 true) (= (has_key (positions x) c3) true))))
(assert (= o8 true))
...
(assert (= result7 true))
(assert (= (= result8 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= (to_rep3 (rec__partition_refinement__interval__first (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j1)))))) j1) (<= j1 (to_rep3 (rec__partition_refinement__interval__last (us_split_fields9 (get5 (model__2 (mk___rep5 p__split_discrs (mk___split_fields5 p__split_fields))) (to_rep4 (select f j1))))))))))))
(assert (= result8 true))
