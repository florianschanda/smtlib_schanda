...
(assert (and (= o (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o) (= o (to_rep theadmin__split_fields)))))
(assert (= result (ite (= o 1) true false)))
(assert (= result true))
(assert (and (= o1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o1 true) (in_range4 (to_rep1 theadmin__split_fields1)))))
