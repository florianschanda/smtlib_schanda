...
(assert (and (= o (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range1 o) (= o (to_rep theadmin__split_fields)))))
(assert (= result (ite (= o 1) true false)))
(assert (= result true))
(assert (and (= o1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o1 true) (in_range3 (to_rep1 theadmin__split_fields1)))))
(assert (= o2 (ite (not (= o1 true)) true false)))
(assert (and (= result1 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= result1 true) (in_range3 (to_rep1 theadmin__split_fields1)))))
(assert (= result1 true))
