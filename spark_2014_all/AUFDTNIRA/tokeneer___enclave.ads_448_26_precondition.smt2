...
(assert (and (= o11 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range2 o11) (= o11 (to_rep theadmin__split_fields)))))
(assert (= result (ite (= o11 1) true false)))
(assert (= result true))
(assert (and (= o13 (isdoingop (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (= (= o13 true) (in_range4 (to_rep1 theadmin__split_fields1)))))
