...
(assert (= o32 temp___1736))
(assert (= o33 (select n9 o32)))
(assert (= o34 (to_rep1 o33)))
(assert (= o35 (* o34 100)))
(assert (not (in_range1 o35)))
(check-sat)
(exit)
