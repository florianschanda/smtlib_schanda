...
(assert (=> (= result15 true) (and (= o37 (thecurrentop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (in_range7 o37))))
(assert (=> (= result15 true) (= o38 (ite (= o37 4) true false))))
(assert (=> (not (= result15 true)) (= o38 false)))
(assert (= o39 (to_int1 o38)))
(assert (= o40 (ite (= o39 (to_int1 (ite (= (int__content status3) 6) true false))) true false)))
(assert (=> (= (int__content status3) 8) (and (= o33 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= o33 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= (int__content status3) 8) (= o34 (ite (not (= o33 true)) true false))))
(assert (=> (= (int__content status3) 8) (and (= o31 (islocked (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6))) (= (= o31 true) (= (int__content currentlatch3) 0)))))
(assert (=> (= (int__content status3) 8) (and (= o30 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range5 o30) (= o30 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (= (int__content status3) 8) (= o32 (ite (= o30 0) true false))))
(assert (=> (= (int__content status3) 8) (= o35 (ite (= o32 true) o31 false))))
(assert (=> (= (int__content status3) 8) (= o36 (ite (= o35 true) o34 false))))
(assert (=> (not (= (int__content status3) 8)) (= o36 (of_int 1))))
(assert (and (= o28 (rolepresent (mk___rep (mk___split_fields theadmin__split_fields theadmin__split_fields1)))) (and (in_range5 o28) (= o28 (to_rep2 theadmin__split_fields)))))
(assert (and (= o29 (rolepresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (and (in_range5 o29) (= o29 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4)))))))
(assert (= result20 (ite (= o29 o28) true false)))
(assert (=> (= result20 true) (and (= result19 (ispresent (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result19 true) (in_range8 (to_rep2 (rec__admin__t__rolepresent (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (not (= result20 true)) (= result19 false)))
(assert (=> (= result19 true) (and (= result18 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields4)))) (= (= result18 true) (in_range7 (to_rep3 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields4))))))))
(assert (=> (not (= result19 true)) (= result18 false)))
(assert (=> (= result18 true) (and (= o27 (current_latch (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6))) (and (in_range29 o27) (= o27 (int__content currentlatch3))))))
(assert (=> (= result18 true) (= result17 (ite (= o27 (current_latch currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))) true false))))
(assert (=> (not (= result18 true)) (= result17 false)))
(assert (=> (= result17 true) (and (= o26 (latch_timeout (int__content currentlatch3) (us_private__content state23) (us_split_fields__content1 latchtimeout__split_fields6))) (= o26 (mk___rep1 (us_split_fields__content1 latchtimeout__split_fields6))))))
(assert (=> (= result17 true) (= result16 (bool_eq3 o26 (latch_timeout currentlatch (us_private__content state2) (mk___split_fields1 latchtimeout__split_fields latchtimeout__split_fields1 latchtimeout__split_fields2 latchtimeout__split_fields3))))))
