...
(define-fun o18 () us_rep1 (mk___rep1 (mk___split_fields1 o4 o5 o6)))
(assert (and (= o16 (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (and (in_range1 o16) (= o16 (ite (= (distinct 1 0) true) (to_rep (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
...
(assert (= o15 (* 2 o14)))
(assert (and (= o17 o15) (in_range4 o15)))
(assert (= result (ite (<= o17 o16) true false)))
(assert (= result true))
(assert (and (= o13 (length (mk___rep p__split_discrs (mk___split_fields p__split_fields)))) (and (in_range1 o13) (<= o13 (capacity (mk___rep p__split_discrs (mk___split_fields p__split_fields)))))))
...
(assert (and (= o18 (get (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields))) o3)) (= (bool_eq o18 (get (model__ (mk___rep p__split_discrs (mk___split_fields p__split_fields))) o3)) true)))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o6 o9))
(assert (= o10 o8))
