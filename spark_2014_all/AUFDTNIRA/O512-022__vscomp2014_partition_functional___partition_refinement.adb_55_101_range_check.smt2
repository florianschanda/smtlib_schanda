...
(define-fun o18 () us_rep (mk___rep (mk___split_fields o4 o5 o6)))
(assert (and (= o16 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o16) (= o16 (ite (= (of_int 1) true) (to_rep3 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o14 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o14) (<= o14 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
(assert (= o15 (* 2 o14)))
(assert (and (= o17 o15) (in_range1 o15)))
(assert (= result (ite (<= o17 o16) true false)))
(assert (= result true))
(assert (and (= o13 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o13) (<= o13 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
(assert (= result1 (ite (<= o13 5000) true false)))
(assert (= result1 true))
(assert (= (= result2 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= 0 (to_rep2 (select f j1))) (<= (to_rep2 (select f j1)) (- (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) 1)))))))
(assert (= result2 true))
(assert (= (= result3 true) (forall ((j1 Int)) (=> (and (<= 0 j1) (<= j1 5)) (and (<= (to_rep1 (rec__partition_refinement__interval__first (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) (to_rep2 (select f j1)))))) j1) (<= j1 (to_rep1 (rec__partition_refinement__interval__last (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) (to_rep2 (select f j1))))))))))))
(assert (= result3 true))
...
(assert (= result4 (ite (<= 0 j) o2 false)))
(assert (= result4 true))
(assert (and (= o3 j) (in_range8 j)))
(assert (and (= o18 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) o3)) (= (bool_eq o18 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) o3)) true)))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o6 o9))
(assert (= o10 o8))
