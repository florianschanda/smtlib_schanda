...
(assert (and (= o38 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o38) (= o38 (ite (= (of_int 1) true) (to_rep3 (rec__partition_refinement__partitions__vector__capacity p__split_discrs)) 10001)))))
(assert (and (= o36 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o36) (<= o36 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
(assert (= o37 (* 2 o36)))
(assert (and (= o39 o37) (in_range1 o37)))
(assert (= result (ite (<= o39 o38) true false)))
(assert (= result true))
(assert (and (= o35 (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))) (and (in_range9 o35) (<= o35 (capacity (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields)))))))
(assert (= result1 (ite (<= o35 5000) true false)))
(assert (= result1 true))
(assert (= (= result2 true) (forall ((j13 Int)) (=> (and (<= 0 j13) (<= j13 5)) (and (<= 0 (to_rep2 (select f j13))) (<= (to_rep2 (select f j13)) (- (length (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) 1)))))))
(assert (= result2 true))
(assert (= (= result3 true) (forall ((j13 Int)) (=> (and (<= 0 j13) (<= j13 5)) (and (<= (to_rep1 (rec__partition_refinement__interval__first (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) (to_rep2 (select f j13)))))) j13) (<= j13 (to_rep1 (rec__partition_refinement__interval__last (us_split_fields1 (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) (to_rep2 (select f j13))))))))))))
(assert (= result3 true))
...
(assert (= o1 (- o 1)))
(assert (= o2 (ite (<= j1 o1) true false)))
(assert (= result4 (ite (<= 0 j1) o2 false)))
(assert (= result4 true))
(assert (and (= o12 j1) (in_range8 j1)))
(assert (and (= (mk___rep (mk___split_fields o13 o14 o15)) (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) o12)) (= (bool_eq (mk___rep (mk___split_fields o13 o14 o15)) (get (model__ (mk___rep1 p__split_discrs (mk___split_fields1 p__split_fields))) o12)) true)))
(assert (= o13 o16))
(assert (= o14 o17))
(assert (= o15 o18))
(assert (= o19 o17))
(assert (= o20 (to_rep1 o19)))
(assert (= o21 (ite (<= k o20) true false)))
(assert (not (in_range8 j1)))
(check-sat)
(exit)
