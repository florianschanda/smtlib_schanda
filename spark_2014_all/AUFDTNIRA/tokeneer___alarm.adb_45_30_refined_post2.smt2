...
(define-fun dynamic_invariant ((temp___expr_190 Int) (temp___is_init_186 Bool) (temp___skip_constant_187 Bool) (temp___do_toplevel_188 Bool) (temp___do_typ_inv_189 Bool)) Bool (=> (or (= temp___is_init_186 true) (<= 0 1)) (in_range6 temp___expr_190)))
...
(define-fun dynamic_invariant1 ((temp___expr_1222 us_rep1) (temp___is_init_1218 Bool) (temp___skip_constant_1219 Bool) (temp___do_toplevel_1220 Bool) (temp___do_typ_inv_1221 Bool)) Bool (=> (= temp___do_typ_inv_1221 true) (= (valid_numberlogentries (to_rep1 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1222))) (to_rep2 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1222))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1222)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1222))) true)))
...
(define-fun default_initial_assumption ((temp___expr_1226 us_rep1) (temp___skip_top_level_1227 Bool)) Bool (and (and (and (= (to_rep1 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___expr_1226))) 1) (= (to_rep2 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___expr_1226))) 0)) (= (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___expr_1226)) (mk___rep (mk___split_fields (temp_____aggregate_def_1228 1) rliteral rliteral rliteral1)))) (= (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___expr_1226)) (temp_____aggregate_def_1232 0))))
(define-fun type_invariant ((temp___1236 us_rep1)) Bool (= (valid_numberlogentries (to_rep1 (rec__auditlog__logfilestatet__currentlogfile (us_split_fields3 temp___1236))) (to_rep2 (rec__auditlog__logfilestatet__numberlogentries (us_split_fields3 temp___1236))) (rec__auditlog__logfilestatet__usedlogfiles (us_split_fields3 temp___1236)) (rec__auditlog__logfilestatet__logfileentries (us_split_fields3 temp___1236))) true))
...
(define-fun dynamic_invariant2 ((temp___expr_1160 Int) (temp___is_init_1156 Bool) (temp___skip_constant_1157 Bool) (temp___do_toplevel_1158 Bool) (temp___do_typ_inv_1159 Bool)) Bool (=> (or (= temp___is_init_1156 true) (<= 0 17)) (in_range4 temp___expr_1160)))
(define-fun dynamic_invariant3 ((temp___expr_1167 Int) (temp___is_init_1163 Bool) (temp___skip_constant_1164 Bool) (temp___do_toplevel_1165 Bool) (temp___do_typ_inv_1166 Bool)) Bool (=> (or (= temp___is_init_1163 true) (<= 1 17)) (in_range2 temp___expr_1167)))
(define-fun dynamic_invariant4 ((temp___expr_1293 Int) (temp___is_init_1289 Bool) (temp___skip_constant_1290 Bool) (temp___do_toplevel_1291 Bool) (temp___do_typ_inv_1292 Bool)) Bool (=> (or (= temp___is_init_1289 true) (<= 0 2)) (in_range1 temp___expr_1293)))
(define-fun dynamic_invariant5 ((temp___expr_1174 Int) (temp___is_init_1170 Bool) (temp___skip_constant_1171 Bool) (temp___do_toplevel_1172 Bool) (temp___do_typ_inv_1173 Bool)) Bool (=> (or (= temp___is_init_1170 true) (<= 0 17408)) (in_range3 temp___expr_1174)))
(define-fun dynamic_invariant6 ((temp___expr_1205 Int) (temp___is_init_1201 Bool) (temp___skip_constant_1202 Bool) (temp___do_toplevel_1203 Bool) (temp___do_typ_inv_1204 Bool)) Bool (=> (or (= temp___is_init_1201 true) (<= 0 1024)) (in_range5 temp___expr_1205)))
(assert true)
...
(assert (forall ((temp___1234 Int)) (=> (dynamic_invariant6 temp___1234 true true true true) (forall ((temp___1235 Int)) (= (select (temp_____aggregate_def_1232 temp___1234) temp___1235) rliteral2)))))
(assert (forall ((temp___1230 Int)) (=> (dynamic_invariant3 temp___1230 true true true true) (forall ((temp___1231 Int)) (= (select (temp_____aggregate_def_1228 temp___1230) temp___1231) rliteral)))))
