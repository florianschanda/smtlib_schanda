...
(assert (= o60 temp___1578))
(assert (= o61 (select n9 o60)))
(assert (= o62 (to_rep1 o61)))
(assert (= o63 (* o62 1000000)))
(assert (and (= o64 o63) (in_range1 o63)))
(assert (= o65 (+ target6 o64)))
...
(assert (= o67 temp___1579))
(assert (= o68 (select n9 o67)))
(assert (= o69 (to_rep1 o68)))
(assert (= o70 (* o69 10000000)))
(assert (and (= o71 o70) (in_range1 o70)))
(assert (= o72 (+ target7 o71)))
...
(assert (= o74 temp___1580))
(assert (= o75 (select n9 o74)))
(assert (= o76 (to_rep1 o75)))
(assert (= o77 (* o76 100000000)))
