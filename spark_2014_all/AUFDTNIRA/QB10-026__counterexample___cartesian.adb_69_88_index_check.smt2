...
(assert (and (= o109 (- j6 (to_rep (first (rt array2))))) (in_range1 (- j6 (to_rep (first (rt array2)))))))
(assert (and (= o106 (length array2)) (in_range1 (length array2))))
(assert (and (= o107 (- i2 (to_rep (first (rt array1))))) (in_range1 (- i2 (to_rep (first (rt array1)))))))
(assert (= o108 (* o107 o106)))
(assert (and (= o110 o108) (in_range1 o108)))
(assert (= o111 (+ o110 o109)))
(assert (and (= o112 o111) (in_range1 o111)))
(assert (= o113 (+ o112 1)))
(assert (and (= temp___274 o113) (in_range1 o113)))
(assert (not (<= (to_rep result____first) temp___274)))
(check-sat)
(exit)
