...
(assert (= result true))
(assert (and (= o1 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (= (= o1 true) (in_range8 (to_rep4 theadmin__split_fields1)))))
(assert (= o2 (ite (not (= o1 true)) true false)))
(assert (and (= result1 (isdoingop (mk___rep1 (mk___split_fields1 theadmin__split_fields theadmin__split_fields1)))) (= (= result1 true) (in_range8 (to_rep4 theadmin__split_fields1)))))
(assert (= result1 true))
