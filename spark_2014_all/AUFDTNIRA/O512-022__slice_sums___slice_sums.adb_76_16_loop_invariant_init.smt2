...
(assert (<= (to_rep1 (rec__sums__slice_bounds__lo result____split_fields2)) (to_rep2 (rec__sums__slice_bounds__hi result____split_fields2))))
(assert (not (<= (to_rep3 (first (rt x))) (to_rep1 (rec__sums__slice_bounds__lo result____split_fields2)))))
(check-sat)
(exit)
