...
(assert (<= (+ (to_rep1 (rec__partition_refinement__interval__last p_prime__split_fields5)) 1) k6))
(assert (<= k6 5))
(assert (and (= o78 (length (mk___rep1 p__split_discrs p__split_fields4))) (and (in_range9 o78) (<= o78 (capacity (mk___rep1 p__split_discrs p__split_fields4))))))
(assert (= o79 (- o78 1)))
(assert (not (<= 0 k6)))
(check-sat)
(exit)
