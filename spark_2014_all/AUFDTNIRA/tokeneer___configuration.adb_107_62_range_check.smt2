...
(assert (not (= (length temp___1939) 0)))
(assert (=> (<= 1 2) (= o96 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o96 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1939))) (to_rep1 (last (rt temp___1939)))) (= o97 (+ (- (to_rep1 (last (rt temp___1939))) (to_rep1 (first (rt temp___1939)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1939))) (to_rep1 (last (rt temp___1939))))) (= o97 0)))
(assert (= o98 (+ o97 o96)))
(assert (= o99 (+ (to_rep1 (first (rt temp___1939))) o98)))
(assert (= o100 (- o99 1)))
