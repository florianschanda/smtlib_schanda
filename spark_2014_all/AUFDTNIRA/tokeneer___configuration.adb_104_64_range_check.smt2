...
(assert (not (= (length temp___1918) 0)))
(assert (=> (<= 1 2) (= o60 (+ (- 2 1) 1))))
(assert (=> (not (<= 1 2)) (= o60 0)))
(assert (=> (<= (to_rep1 (first (rt temp___1918))) (to_rep1 (last (rt temp___1918)))) (= o61 (+ (- (to_rep1 (last (rt temp___1918))) (to_rep1 (first (rt temp___1918)))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt temp___1918))) (to_rep1 (last (rt temp___1918))))) (= o61 0)))
(assert (= o62 (+ o61 o60)))
(assert (= o63 (+ (to_rep1 (first (rt temp___1918))) o62)))
(assert (= o64 (- o63 1)))
