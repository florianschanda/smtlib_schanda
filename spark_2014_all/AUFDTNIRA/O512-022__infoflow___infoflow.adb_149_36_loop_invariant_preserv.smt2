...
(assert (and (<= (to_rep h__first) temp___476) (<= temp___476 (to_rep h__last))))
(assert (= o12 temp___476))
(assert (= o13 (select h2 o12)))
(assert (= o14 (to_rep1 o13)))
(assert (= (to_rep1 o15) o14))
(assert (and (<= (to_rep h__first) q2) (<= q2 (to_rep h__last))))
(assert (= o16 q2))
(assert (= o17 (store h2 o16 o15)))
(assert (= h2 result3))
(assert (= h3 o17))
(assert (= (to_rep1 o18) t4))
(assert (and (= temp___477 (+ q2 m1)) (in_range1 (+ q2 m1))))
(assert (and (<= (to_rep h__first) temp___477) (<= temp___477 (to_rep h__last))))
(assert (= o19 temp___477))
(assert (= o20 (store h3 o19 o18)))
(assert (= h3 result4))
(assert (= h4 o20))
(assert (not (= q2 r30b)))
(assert (= result5 q2))
...
(assert (<= (to_rep h__first) k2))
(assert (<= k2 (to_rep h__last)))
(assert (< k2 q3))
(assert (not (= (to_rep1 (select h4 k2)) (to_rep1 (select h (+ k2 m1))))))
(check-sat)
(exit)
