...
(assert (and (= o36 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= o36 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
(assert (= o37 (ite (not (= o36 true)) true false)))
(assert (and (= result20 (isdoingop (mk___rep (us_split_fields__content theadmin__split_fields3)))) (= (= result20 true) (in_range4 (to_rep1 (rec__admin__t__currentop (us_split_fields__content theadmin__split_fields3)))))))
