...
(assert (= (ite (<= (to_rep (first4 temp___88271)) (to_rep (last4 temp___88271))) (+ (- (to_rep (last4 temp___88271)) (to_rep (first4 temp___88271))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8827 temp___8828))
(assert (= (mk1 (to_rep (first4 temp___88271)) (to_rep (last4 temp___88271))) temp___88281))
(assert (not (= (ite (<= (to_rep (first2 temp___88281)) (to_rep (last2 temp___88281))) (+ (- (to_rep (last2 temp___88281)) (to_rep (first2 temp___88281))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
