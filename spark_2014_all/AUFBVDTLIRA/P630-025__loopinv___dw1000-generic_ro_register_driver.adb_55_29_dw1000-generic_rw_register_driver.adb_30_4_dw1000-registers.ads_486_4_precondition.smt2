...
(define-fun dynamic_invariant ((temp___expr_5761 us_t1) (temp___is_init_5758 Bool) (temp___skip_constant_5759 Bool) (temp___do_toplevel_5760 Bool)) Bool (=> (not (= temp___skip_constant_5759 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5761) (last3 temp___expr_5761)) (and (= (first3 temp___expr_5761) 1) (= (last3 temp___expr_5761) 1)))))
