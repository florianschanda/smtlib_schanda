...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1113 carry1)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1110 (mk___rep1 result____split_discrs result____split_fields3))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1109 temp)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1108 t_digit)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1107 r_digit)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1106 l_digit)))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1101 (- o12 1))))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o13 temp___1101)))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1103 (- o17 1))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1103) (<= temp___1103 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4))))))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o20 temp___1103)))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1105 (mk___rep1 result____split_discrs o23))))
...
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result____split_fields5 (us_split_fields3 temp___1105))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= result____split_discrs (us_split_discrs2 temp___1105))))
