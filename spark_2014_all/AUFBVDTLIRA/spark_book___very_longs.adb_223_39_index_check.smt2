...
(define-fun dynamic_invariant ((temp___expr_221 Int) (temp___is_init_217 Bool) (temp___skip_constant_218 Bool) (temp___do_toplevel_219 Bool) (temp___do_typ_inv_220 Bool)) Bool (=> (or (= temp___is_init_217 true) (<= 0 65536)) (in_range1 temp___expr_221)))
...
(assert true)
(assert (forall ((number us_rep)) (! (= (= (is_zero number) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) (= (to_rep1 (let ((temp___295 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___295) j))) #x00)))) :pattern ((is_zero number)))))
...
(define-fun dynamic_invariant2 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 65536)) (in_range2 temp___expr_228)))
...
(assert (and (= o (is_zero number)) (= (= o true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j1)) #x00))))))
(assert (= result1 (ite (not (= o true)) true false)))
(assert (= result1 true))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index1 1))
(assert (<= 1 index1))
(assert (<= index1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) index1) (<= index1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o1 index1))
(assert (= o2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) o1)))
(assert (= o3 (to_rep1 o2)))
(assert (= o4 (ite (= o3 #x00) true false)))
(assert (= result3 (ite (not (= o4 true)) true false)))
(assert (=> (= result3 true) (and (= o5 index1) (in_range1 index1))))
