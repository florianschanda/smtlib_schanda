...
(declare-fun user_eq (digit_count_type digit_count_type) Bool)
(declare-const dummy digit_count_type)
...
(define-fun dynamic_invariant ((temp___expr_198 Int) (temp___is_init_195 Bool) (temp___skip_constant_196 Bool) (temp___do_toplevel_197 Bool)) Bool (=> (or (= temp___is_init_195 true) (<= 0 65536)) (in_range1 temp___expr_198)))
...
(assert (forall ((x tdigit_count_typeB)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert true)
(assert (forall ((number us_rep)) (! (= (= (is_zero number) true) (forall ((j Int)) (=> (and (<= 1 j) (<= j (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) (= (to_rep1 (let ((temp___268 (rec__very_longs__very_long__long_digits (us_split_fields1 number)))) (select (to_array temp___268) j))) ((_ int2bv 8) 0))))) :pattern ((is_zero number)))))
...
(declare-datatypes () ((t60b__ref (mk_t60b__ref (t60b__content tdigit_count_typeB)))))
(define-fun t60b__ref___projection ((a t60b__ref)) tdigit_count_typeB (t60b__content a))
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(define-fun dynamic_invariant2 ((temp___expr_204 Int) (temp___is_init_201 Bool) (temp___skip_constant_202 Bool) (temp___do_toplevel_203 Bool)) Bool (=> (or (= temp___is_init_201 true) (<= 1 65536)) (in_range2 temp___expr_204)))
...
(declare-const digit_count12 Int)
...
(assert (and (= us (to_rep (rec__very_longs__very_long__length (us_split_discrs1 number)))) (in_range2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 number))))))
(assert (= (mk_int__ref result) (mk_int__ref digit_count)))
(assert (= digit_count1 0))
(assert (in_range1 digit_count1))
(assert (and (= o (is_zero number)) (= (= o true) (forall ((j2 Int)) (=> (and (<= 1 j2) (<= j2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j2)) ((_ int2bv 8) 0)))))))
(assert (= result1 (ite (not (= o true)) true false)))
(assert (= result1 true))
(assert (= (mk_int__ref result2) (mk_int__ref index)))
(assert (= index2 1))
(assert (<= 1 index2))
(assert (<= index2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) index2) (<= index2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o1 index2))
(assert (= o2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) o1)))
(assert (= o3 (to_rep1 o2)))
(assert (= o4 (ite (= o3 ((_ int2bv 8) 0)) true false)))
(assert (= result3 (ite (not (= o4 true)) true false)))
(assert (=> (= result3 true) (and (= o5 index2) (in_range1 index2))))
(assert (=> (= result3 true) (= digit_count1 result4)))
(assert (=> (= result3 true) (= digit_count2 o5)))
(assert (=> (not (= result3 true)) (= digit_count2 digit_count1)))
(assert (and (=> (< 0 digit_count3) (and (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) digit_count3)) ((_ int2bv 8) 0))) (and (<= 1 digit_count3) (<= digit_count3 index3)))) (=> (< digit_count3 index3) (forall ((j2 Int)) (=> (and (<= (+ digit_count3 1) j2) (<= j2 index3)) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j2)) ((_ int2bv 8) 0)))))))
(assert (and (and (=> (<= 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))) (dynamic_property2 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) index3)) (=> (<= 0 65536) (in_range1 digit_count3))) (and (<= 1 index3) (<= index3 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
(assert (< digit_count3 index3))
(assert (<= (+ digit_count3 1) j))
(assert (<= j index3))
(assert (not (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) j)))
(check-sat)
(exit)
