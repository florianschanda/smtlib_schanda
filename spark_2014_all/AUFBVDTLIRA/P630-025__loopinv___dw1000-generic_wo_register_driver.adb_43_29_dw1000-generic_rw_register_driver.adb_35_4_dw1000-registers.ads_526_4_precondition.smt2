...
(define-fun tregister_byte_arrayP1__ref___127__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___55__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-fun user_eq6 (bits_5 bits_5) Bool)
(declare-const dummy6 bits_5)
...
(declare-fun to_rep2 (bits_5) (_ BitVec 8))
(declare-fun of_rep2 ((_ BitVec 8)) bits_5)
(assert (forall ((x bits_5)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x bits_5)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x20))) (=> (in_range2 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun to_int4 ((x bits_5)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x bits_5)) (! (in_range_int (to_int4 x)) :pattern ((to_int4 x)))))
...
(declare-fun user_eq7 (bits_11 bits_11) Bool)
(declare-const dummy7 bits_11)
...
(assert (forall ((x bits_11)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x bits_11)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x0800))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int5 ((x bits_11)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x bits_11)) (! (in_range_int1 (to_int5 x)) :pattern ((to_int5 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__otp_addr_type__otp_addr bits_11) (rec__dw1000__register_types__otp_addr_type__reserved bits_5)))))
(define-fun us_split_fields_OTP_ADDR__projection ((a us_split_fields)) bits_11 (rec__dw1000__register_types__otp_addr_type__otp_addr a))
(define-fun us_split_fields_Reserved__20__projection ((a us_split_fields)) bits_5 (rec__dw1000__register_types__otp_addr_type__reserved a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___74__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___74__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep3 (rec__dw1000__register_types__otp_addr_type__otp_addr (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__otp_addr_type__otp_addr (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__otp_addr_type__reserved (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__otp_addr_type__reserved (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__otp_addr_type__otp_addr__first__bit Int)
(declare-const dw1000__register_types__otp_addr_type__otp_addr__last__bit Int)
(declare-const dw1000__register_types__otp_addr_type__otp_addr__position Int)
(assert (<= 0 dw1000__register_types__otp_addr_type__otp_addr__first__bit))
(assert (< dw1000__register_types__otp_addr_type__otp_addr__first__bit dw1000__register_types__otp_addr_type__otp_addr__last__bit))
(assert (<= 0 dw1000__register_types__otp_addr_type__otp_addr__position))
(declare-const dw1000__register_types__otp_addr_type__reserved__first__bit Int)
(declare-const dw1000__register_types__otp_addr_type__reserved__last__bit Int)
(declare-const dw1000__register_types__otp_addr_type__reserved__position Int)
(assert (<= 0 dw1000__register_types__otp_addr_type__reserved__first__bit))
(assert (< dw1000__register_types__otp_addr_type__reserved__first__bit dw1000__register_types__otp_addr_type__reserved__last__bit))
(assert (<= 0 dw1000__register_types__otp_addr_type__reserved__position))
(declare-fun user_eq8 (us_rep us_rep) Bool)
(declare-const dummy8 us_rep)
(declare-datatypes () ((otp_addr_type__ref (mk_otp_addr_type__ref (otp_addr_type__content us_rep)))))
(define-fun otp_addr_type__ref___projection ((a otp_addr_type__ref)) us_rep (otp_addr_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___55__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_6990 us_t1) (temp___is_init_6986 Bool) (temp___skip_constant_6987 Bool) (temp___do_toplevel_6988 Bool) (temp___do_typ_inv_6989 Bool)) Bool (=> (not (= temp___skip_constant_6987 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6990) (last3 temp___expr_6990)) (and (= (first3 temp___expr_6990) 1) (= (last3 temp___expr_6990) 2)))))
...
(define-fun register_type__ref___181__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___127__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_6971 us_t2) (temp___is_init_6967 Bool) (temp___skip_constant_6968 Bool) (temp___do_toplevel_6969 Bool) (temp___do_typ_inv_6970 Bool)) Bool (=> (not (= temp___skip_constant_6968 true)) (and (dynamic_property3 1 2 (first5 temp___expr_6971) (last5 temp___expr_6971)) (and (= (first5 temp___expr_6971) 1) (= (last5 temp___expr_6971) 2)))))
...
(declare-const temp___8883 (Array Int bits_8))
(declare-const temp___88831 t1)
(declare-const temp___8884 (Array Int bits_8))
(declare-const temp___88841 t2)
...
(define-fun temp___88832 () us_t1 (mk___t1 temp___8883 temp___88831))
...
(assert (and (= temp___88832 (register_to_bytes reg)) (dynamic_invariant temp___88832 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___88831)) (to_rep (last2 temp___88831))) (+ (- (to_rep (last2 temp___88831)) (to_rep (first2 temp___88831))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8883 temp___8884))
(assert (= (mk2 (to_rep (first2 temp___88831)) (to_rep (last2 temp___88831))) temp___88841))
(assert (= (ite (<= (to_rep (first4 temp___88841)) (to_rep (last4 temp___88841))) (+ (- (to_rep (last4 temp___88841)) (to_rep (first4 temp___88841))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8884 temp___88841)))
(assert (= o2 o))
