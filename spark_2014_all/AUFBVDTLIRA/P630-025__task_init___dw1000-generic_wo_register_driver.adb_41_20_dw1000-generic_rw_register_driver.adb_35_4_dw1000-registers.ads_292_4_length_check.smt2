...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__agc_ctrl1_type__dis_am bits_1) (rec__dw1000__register_types__agc_ctrl1_type__reserved bits_15)))))
(define-fun us_split_fields_DIS_AM__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__agc_ctrl1_type__dis_am a))
(define-fun us_split_fields_Reserved__4__projection ((a us_split_fields)) bits_15 (rec__dw1000__register_types__agc_ctrl1_type__reserved a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___26__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___26__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__dw1000__register_types__agc_ctrl1_type__dis_am (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__agc_ctrl1_type__dis_am (us_split_fields1 b)))) (= (to_rep3 (rec__dw1000__register_types__agc_ctrl1_type__reserved (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__agc_ctrl1_type__reserved (us_split_fields1 b))))) true false))
...
(assert (< dw1000__register_types__agc_ctrl1_type__dis_am__first__bit dw1000__register_types__agc_ctrl1_type__dis_am__last__bit))
...
(assert (<= 0 dw1000__register_types__agc_ctrl1_type__reserved__first__bit))
(assert (< dw1000__register_types__agc_ctrl1_type__reserved__first__bit dw1000__register_types__agc_ctrl1_type__reserved__last__bit))
(assert (<= 0 dw1000__register_types__agc_ctrl1_type__reserved__position))
(declare-fun user_eq6 (us_rep us_rep) Bool)
(declare-const dummy6 us_rep)
(declare-datatypes () ((agc_ctrl1_type__ref (mk_agc_ctrl1_type__ref (agc_ctrl1_type__content us_rep)))))
(define-fun agc_ctrl1_type__ref___projection ((a agc_ctrl1_type__ref)) us_rep (agc_ctrl1_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___58__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___42__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___42__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3791 us_t1) (temp___is_init_3787 Bool) (temp___skip_constant_3788 Bool) (temp___do_toplevel_3789 Bool) (temp___do_typ_inv_3790 Bool)) Bool (=> (not (= temp___skip_constant_3788 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3791) (last3 temp___expr_3791)) (and (= (first3 temp___expr_3791) 1) (= (last3 temp___expr_3791) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___17__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___17__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_3810 us_t2) (temp___is_init_3806 Bool) (temp___skip_constant_3807 Bool) (temp___do_toplevel_3808 Bool) (temp___do_typ_inv_3809 Bool)) Bool (=> (not (= temp___skip_constant_3807 true)) (and (dynamic_property3 1 2 (first5 temp___expr_3810) (last5 temp___expr_3810)) (and (= (first5 temp___expr_3810) 1) (= (last5 temp___expr_3810) 2)))))
...
(declare-const temp___8598 (Array Int bits_8))
(declare-const temp___85981 t2)
(define-fun temp___85982 () us_t2 (mk___t2 temp___8598 temp___85981))
...
(assert (and (= temp___85982 (register_to_bytes reg)) (dynamic_invariant1 temp___85982 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___85981)) (to_rep (last4 temp___85981))) (+ (- (to_rep (last4 temp___85981)) (to_rep (first4 temp___85981))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
