...
(assert (and (forall ((i2 (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i2) (bvule i2 (bvsub rcx_start rcx))) (=> (not (= i2 (bvsub rcx_start rcx))) (= (hasmem64 mem (bvadd rdi_start (bvmul i2 #x0000000000000008)) rax) true)))) (and (= rdi (bvadd rdi_start (bvmul (bvsub rcx_start rcx) #x0000000000000008))) (and (bvule rcx rcx_start) (and (bvult rcx_start #x1FFFFFFFFFFFFFFF) (and (= (nooverlap8equal memory mem rdi) true) (forall ((i2 (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i2) (bvule i2 (bvsub rcx_start rcx))) (=> (not (= i2 (bvsub rcx_start rcx))) (= (nooverlap8 (bvadd rdi_start (bvmul i2 #x0000000000000008)) rdi) true))))))))))
