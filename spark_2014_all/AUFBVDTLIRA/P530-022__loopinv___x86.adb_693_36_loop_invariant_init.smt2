...
(assert (and (forall ((i2 (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i2) (bvule i2 (bvsub rcx_start rcx))) (=> (not (= i2 (bvsub rcx_start rcx))) (= (hasmem64 mem (bvadd rdi_start (bvmul i2 ((_ int2bv 64) 8))) rax) true)))) (and (= rdi (bvadd rdi_start (bvmul (bvsub rcx_start rcx) ((_ int2bv 64) 8)))) (and (bvule rcx rcx_start) (and (bvult rcx_start ((_ int2bv 64) 2305843009213693951)) (and (= (nooverlap8equal memory mem rdi) true) (forall ((i2 (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i2) (bvule i2 (bvsub rcx_start rcx))) (=> (not (= i2 (bvsub rcx_start rcx))) (= (nooverlap8 (bvadd rdi_start (bvmul i2 ((_ int2bv 64) 8))) rdi) true))))))))))
...
(assert (=> (not (= i1 (bvsub rcx_start rcx))) (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j ((_ int2bv 64) 7))) (= (to_rep (select memory (bvadd (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) j))) (to_rep (select mem (bvadd (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) j))))))))
(assert (=> (not (= i1 (bvsub rcx_start rcx))) (= (hasmem64 memory (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) rax) true)))
(declare-const j (_ BitVec 64))
(assert (bvule ((_ int2bv 64) 0) j))
(assert (bvule j i1))
(assert (not (= j (bvsub rcx_start rcx))))
(assert (not (= (hasmem64 memory (bvadd rdi_start (bvmul j ((_ int2bv 64) 8))) rax) true)))
(check-sat)
(exit)
