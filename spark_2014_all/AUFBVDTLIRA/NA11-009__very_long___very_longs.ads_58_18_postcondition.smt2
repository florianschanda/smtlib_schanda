...
(assert (and (and (and (= us (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) (in_range2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))) (and (and (= us1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (in_range2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))) (and (and (= us2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (in_range2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))) (and (= (to_rep (rec__very_longs__very_long__length result____split_discrs)) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (and (dynamic_invariant4 (mk___rep1 result____split_discrs (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1))) false false true) (and (and (and (and (and (and (and (= (to_rep2 (first4 (rt2 (temp___962 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) 1) (and (= (to_rep2 (last4 (rt2 (temp___962 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (= (mk___t2 temp___969 temp___9691) (temp___962 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (and (= (ite (<= (to_rep2 (first4 temp___9691)) (to_rep2 (last4 temp___9691))) (+ (- (to_rep2 (last4 temp___9691)) (to_rep2 (first4 temp___9691))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0)) (and (= temp___969 temp___970) (= (mk1 (to_rep2 (first4 temp___9691)) (to_rep2 (last4 temp___9691))) temp___9701)))) (and (= (ite (<= (to_rep2 (first2 temp___9701)) (to_rep2 (last2 temp___9701))) (+ (- (to_rep2 (last2 temp___9701)) (to_rep2 (first2 temp___9701))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)) (= (mk___t1 o o1) (mk___t1 temp___970 temp___9701)))) (and (= o2 o) (= o3 o1))) (and (= result____split_discrs (mk___split_discrs temp___973)) (and (= temp___9731 o2) (= temp___9732 o3)))) (and (and (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))) (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___9731 temp___9732)))) (= result____split_discrs (mk___split_discrs temp___973)))) (and (and (and (= result1 (mk_int__ref j)) (= j1 1)) (ite (and (<= 1 j1) (<= j1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (and (and (and (= temp___999 t_digit) (and (= temp___998 r_digit) (and (= temp___997 l_digit) (and (= temp___994 (mk___rep1 result____split_discrs result____split_fields2)) (and (= temp___993 carry) (and (= temp___992 temp) (and (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields3) false true true) (and (<= 1 j2) (<= j2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))) (and (and (= result2 (mk_t__ref1 carry2)) (= carry3 ((_ int2bv 16) 0))) (and (and (and (= result3 (mk_int__ref i2)) (= i3 1)) (ite (and (<= 1 i3) (<= i3 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (and (and (and (= temp___989 t_digit2) (and (= temp___988 r_digit2) (and (= temp___987 l_digit2) (and (= temp___984 (mk___rep1 result____split_discrs result____split_fields3)) (and (= temp___983 carry3) (and (= temp___982 temp2) (and (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields4) false true true) (and (<= 1 i4) (<= i4 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))) (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) i4) (<= i4 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o4 i4)) (= o5 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 l))) o4))) (= o6 (to_rep1 o5))) (= o7 ((_ zero_extend 8) o6))) (and (= result4 (mk_t__ref1 l_digit3)) (= l_digit4 o7))) (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))) j2) (<= j2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= o8 j2)) (= o9 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 r))) o8))) (= o10 (to_rep1 o9))) (= o11 ((_ zero_extend 8) o10))) (and (= result5 (mk_t__ref1 r_digit3)) (= r_digit4 o11))) (and (and (= (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) r92b) (in_range1 r92b)) (and (and (and (and (and (and (= o14 (+ i4 j2)) (in_range1 (+ i4 j2))) (= o15 (- o14 1))) (= o16 (ite (<= o15 r92b) true false))) (and (and (and (and (= o12 (+ i4 j2)) (in_range1 (+ i4 j2))) (= o13 (- o12 1))) (= o17 (ite (<= 1 o13) true false))) (= result6 (ite (= o17 true) o16 false)))) (ite (= result6 true) (and (and (and (and (and (and (and (and (= o18 (+ i4 j2)) (in_range1 (+ i4 j2))) (= temp___977 (- o18 1))) (and (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___977) (<= temp___977 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))) (= o19 temp___977))) (= o20 (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields4)) o19))) (= o21 (to_rep1 o20))) (= o22 ((_ zero_extend 8) o21))) (and (= result7 (mk_t__ref1 t_digit3)) (= t_digit4 o22))) (and (and (= result8 (mk_t__ref1 temp3)) (= temp4 (bvadd (bvadd (bvmul l_digit4 r_digit4) t_digit4) carry4))) (and (and (and (and (and (and (and (= o24 (takelsb_from16 temp4)) (= (to_rep1 o25) o24)) (and (and (and (and (= o23 (+ i4 j2)) (in_range1 (+ i4 j2))) (= temp___979 (- o23 1))) (and (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___979) (<= temp___979 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))) (= o26 temp___979))) (= o27 (store (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields4)) o26 o25)))) (= o28 (mk___t1 o27 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4))))) (= o29 (mk___split_fields1 o28))) (= temp___981 (mk___rep1 result____split_discrs o29))) (and (and (= result9 (mk___split_fields__ref1 result____split_fields4)) (= result____split_fields5 (us_split_fields3 temp___981))) (= result____split_discrs (us_split_discrs2 temp___981)))) (and (and (= o30 (shift_right temp4 8)) (= o30 (bvudiv temp4 (ite (< 8 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) 8)) ((_ int2bv 16) 0))))) (and (= result10 (mk_t__ref1 carry4)) (= carry5 o30)))))) (and (= carry5 carry4) (and (= temp4 temp3) (and (= t_digit4 t_digit3) (= result____split_fields5 result____split_fields4)))))) (= i4 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))))))))))))) (and (and (= i5 (mk_int__ref i4)) (and (= carry6 (mk_t__ref1 carry5)) (and (= temp5 (mk_t__ref1 temp4)) (and (= t_digit5 (mk_t__ref1 t_digit4)) (and (= r_digit5 (mk_t__ref1 r_digit4)) (and (= l_digit5 (mk_t__ref1 l_digit4)) (= result____split_fields6 (mk___split_fields__ref1 result____split_fields5)))))))) (and (= i6 i4) (and (= carry7 carry5) (and (= temp6 temp4) (and (= t_digit6 t_digit4) (and (= r_digit6 r_digit4) (and (= l_digit6 l_digit4) (= result____split_fields7 result____split_fields5))))))))) (and (and (= i7 i5) (and (= carry8 carry6) (and (= temp7 temp5) (and (= t_digit7 t_digit5) (and (= r_digit7 r_digit5) (and (= l_digit7 l_digit5) (= result____split_fields8 result____split_fields6))))))) (and (= i8 i6) (and (= carry9 carry7) (and (= temp8 temp6) (and (= t_digit8 t_digit6) (and (= r_digit8 r_digit6) (and (= l_digit8 l_digit6) (= result____split_fields9 result____split_fields7))))))))) (and (and (= i7 (mk_int__ref i3)) (and (= carry8 (mk_t__ref1 carry3)) (and (= temp7 (mk_t__ref1 temp2)) (and (= t_digit7 (mk_t__ref1 t_digit2)) (and (= r_digit7 (mk_t__ref1 r_digit2)) (and (= l_digit7 (mk_t__ref1 l_digit2)) (= result____split_fields8 (mk___split_fields__ref1 result____split_fields3)))))))) (and (= i8 i3) (and (= carry9 carry3) (and (= temp8 temp2) (and (= t_digit8 t_digit2) (and (= r_digit8 r_digit2) (and (= l_digit8 l_digit2) (= result____split_fields9 result____split_fields3)))))))))) (= j2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))))))))))) (and (and (= i9 i7) (and (= j3 (mk_int__ref j2)) (and (= carry10 carry8) (and (= temp9 temp7) (and (= t_digit9 t_digit7) (and (= r_digit9 r_digit7) (and (= l_digit9 l_digit7) (= result____split_fields10 result____split_fields8)))))))) (and (= i10 i8) (and (= j4 j2) (and (= carry11 carry9) (and (= temp10 temp8) (and (= t_digit10 t_digit8) (and (= r_digit10 r_digit8) (and (= l_digit10 l_digit8) (= result____split_fields11 result____split_fields9)))))))))) (and (and (= i11 i9) (and (= j5 j3) (and (= carry12 carry10) (and (= temp11 temp9) (and (= t_digit11 t_digit9) (and (= r_digit11 r_digit9) (and (= l_digit11 l_digit9) (= result____split_fields12 result____split_fields10)))))))) (and (= i12 i10) (and (= j6 j4) (and (= carry13 carry11) (and (= temp12 temp10) (and (= t_digit12 t_digit10) (and (= r_digit12 r_digit10) (and (= l_digit12 l_digit10) (= result____split_fields13 result____split_fields11)))))))))) (and (and (= i11 (mk_int__ref i)) (and (= j5 (mk_int__ref j1)) (and (= carry12 (mk_t__ref1 carry)) (and (= temp11 (mk_t__ref1 temp)) (and (= t_digit11 (mk_t__ref1 t_digit)) (and (= r_digit11 (mk_t__ref1 r_digit)) (and (= l_digit11 (mk_t__ref1 l_digit)) (= result____split_fields12 (mk___split_fields__ref1 result____split_fields2))))))))) (and (= i12 i1) (and (= j6 j1) (and (= carry13 carry1) (and (= temp12 temp1) (and (= t_digit12 t_digit1) (and (= r_digit12 r_digit1) (and (= l_digit12 l_digit1) (= result____split_fields13 result____split_fields2))))))))))) (and (and (= very_longs__modmultiply__result4 (mk_very_long__ref very_longs__modmultiply__result3)) (= very_longs__modmultiply__result5 very_longs__modmultiply__result3)) (and (= result11 (mk_very_long__ref (mk___rep (mk___split_discrs very_longs__modmultiply__result) (mk___split_fields (mk___t very_longs__modmultiply__result1 very_longs__modmultiply__result2))))) (= very_longs__modmultiply__result3 (to_base (mk___rep1 result____split_discrs (us_split_fields__content1 result____split_fields12))))))))))))) (and (and (= very_longs__modmultiply__result6 very_longs__modmultiply__result4) (and (= i13 i11) (and (= j7 j5) (and (= carry14 carry12) (and (= temp13 temp11) (and (= t_digit13 t_digit11) (and (= r_digit13 r_digit11) (and (= l_digit13 l_digit11) (= result____split_fields14 result____split_fields12))))))))) (and (= very_longs__modmultiply__result7 very_longs__modmultiply__result5) (and (= i14 i12) (and (= j8 j6) (and (= carry15 carry13) (and (= temp14 temp12) (and (= t_digit14 t_digit12) (and (= r_digit14 r_digit12) (and (= l_digit14 l_digit12) (= result____split_fields15 result____split_fields13))))))))))))
