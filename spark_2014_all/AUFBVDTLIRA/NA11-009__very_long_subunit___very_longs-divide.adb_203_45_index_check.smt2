...
(assert (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields2) true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r127b))))
...
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1304) (<= temp___1304 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))
...
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1307)))
(check-sat)
(exit)
