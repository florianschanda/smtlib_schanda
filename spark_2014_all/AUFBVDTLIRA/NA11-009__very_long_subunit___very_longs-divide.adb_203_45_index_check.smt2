...
(assert (= temp___1373 (- o16 1)))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1373) (<= temp___1373 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o17 temp___1373))
...
(assert (= temp___1376 (- o27 1)))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1376)))
(check-sat)
(exit)
