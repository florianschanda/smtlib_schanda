...
(assert (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields3) true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r127b))))
...
(assert (and (= o16 (+ j divisor_index2)) (in_range1 (+ j divisor_index2))))
(assert (= temp___1304 (- o16 1)))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1304) (<= temp___1304 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))))))
(assert (= o17 temp___1304))
(assert (= o18 (select (elts1 (rec__very_longs__very_long__long_digits1 u__split_fields3)) o17)))
(assert (= o19 (to_rep o18)))
(assert (= o24 ((_ zero_extend 8) o19)))
(assert (= o25 (bvadd o24 o23)))
(assert (= o26 (bvadd o25 carry2)))
(assert (= result4 (mk_t__ref1 sum2)))
(assert (= sum3 o26))
(assert (= o28 (takelsb_from16 sum3)))
(assert (= (to_rep o29) o28))
(assert (and (= o27 (+ j divisor_index2)) (in_range1 (+ j divisor_index2))))
(assert (= temp___1307 (- o27 1)))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1307)))
(check-sat)
(exit)
