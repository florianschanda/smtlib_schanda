...
(declare-const temp___1316 (_ BitVec 16))
(declare-const temp___1313 us_rep1)
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= temp___1316 carry1)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= temp___1313 (mk___rep1 u__split_discrs (mk___split_fields1 (mk___t1 u__split_fields u__split_fields1))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= temp___1312 sum)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields3) true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r128b)))))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= temp___1306 (- o16 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1306) (<= temp___1306 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= o17 temp___1306)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= temp___1309 (- o27 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1309) (<= temp___1309 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= o30 temp___1309)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= temp___1311 (mk___rep1 u__split_discrs o33))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= result5 (mk___split_fields__ref1 u__split_fields3))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= u__split_fields4 (us_split_fields3 temp___1311))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (= u__split_discrs (us_split_discrs2 temp___1311))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r128b)) (and (= o34 (shift_right sum3 8)) (= o34 (bvudiv sum3 (ite (< 8 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) 8)) ((_ int2bv 16) 0)))))))
...
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields7))))) temp___1320)))
(check-sat)
(exit)
