...
(assert (and (<= (to_rep1 (first (rt s))) c344b2) (<= c344b2 (to_rep1 (last (rt s))))))
(assert (not (< (length1 (mk___rep1 char_table__split_discrs char_table__split_fields1)) (capacity (mk___rep1 char_table__split_discrs char_table__split_fields1)))))
(check-sat)
(exit)
