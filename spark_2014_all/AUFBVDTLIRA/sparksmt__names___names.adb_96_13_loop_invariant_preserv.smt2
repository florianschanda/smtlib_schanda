...
(assert (= o6 (+ i3 o5)))
(assert (and (= temp___7461 o6) (in_range1 o6)))
(assert (and (<= (to_rep1 (first (rt s))) temp___7461) (<= temp___7461 (to_rep1 (last (rt s))))))
(assert (= o7 temp___7461))
...
(assert (not (= (length1 (mk___rep char_table__split_discrs char_table__split_fields3)) (+ (length1 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) i3))))
(check-sat)
(exit)
