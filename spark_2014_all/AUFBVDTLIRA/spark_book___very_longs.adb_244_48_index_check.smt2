...
(assert (forall ((temp___896 (_ BitVec 8))) (forall ((temp___897 Int) (temp___898 Int)) (let ((temp___895 (temp___894 temp___896 temp___897 temp___898))) (and (=> (dynamic_property6 1 65536 temp___897 temp___898) (and (= (first5 temp___895) temp___897) (= (last5 temp___895) temp___898))) (forall ((temp___899 Int)) (= (select (to_array2 temp___895) temp___899) (of_rep1 temp___896))))))))
...
(declare-const temp___901 (Array Int octet))
(declare-const temp___9011 t2)
(declare-const temp___902 (Array Int octet))
(declare-const temp___9021 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___905 digit_index_type)
(declare-const temp___9051 (Array Int octet))
(declare-const temp___9052 t1)
(declare-const temp___917 (_ BitVec 16))
(declare-const temp___916 (_ BitVec 16))
(declare-const temp___915 (_ BitVec 16))
(declare-const temp___914 (_ BitVec 16))
(declare-const temp___911 us_rep1)
...
(assert true)
(assert true)
(assert (= (to_rep2 (first4 (rt2 (temp___894 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___894 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___901 temp___9011) (temp___894 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep2 (first4 temp___9011)) (to_rep2 (last4 temp___9011))) (+ (- (to_rep2 (last4 temp___9011)) (to_rep2 (first4 temp___9011))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___901 temp___902))
(assert (= (mk1 (to_rep2 (first4 temp___9011)) (to_rep2 (last4 temp___9011))) temp___9021))
(assert (= (ite (<= (to_rep2 (first2 temp___9021)) (to_rep2 (last2 temp___9021))) (+ (- (to_rep2 (last2 temp___9021)) (to_rep2 (first2 temp___9021))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___902 temp___9021)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___905)))
(assert (= temp___9051 o2))
(assert (= temp___9052 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___9051 temp___9052))))
(assert (= result____split_discrs (mk___split_discrs temp___905)))
...
(assert (and (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields3) false true true) (forall ((temp___913 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___913) (<= temp___913 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= i2 temp___913) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___913) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___913)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
