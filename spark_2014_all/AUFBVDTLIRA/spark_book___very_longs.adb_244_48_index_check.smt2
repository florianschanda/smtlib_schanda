...
(declare-fun temp___963 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___965 (_ BitVec 8))) (forall ((temp___966 Int) (temp___967 Int)) (let ((temp___964 (temp___963 temp___965 temp___966 temp___967))) (=> (dynamic_invariant2 temp___965 true true true true) (and (=> (dynamic_property6 1 65536 temp___966 temp___967) (and (= (first5 temp___964) temp___966) (= (last5 temp___964) temp___967))) (forall ((temp___968 Int)) (= (to_rep1 (select (to_array2 temp___964) temp___968)) temp___965))))))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___963 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___963 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___970 temp___9701) (temp___963 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep2 (first4 temp___9701)) (to_rep2 (last4 temp___9701))) (+ (- (to_rep2 (last4 temp___9701)) (to_rep2 (first4 temp___9701))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___970 temp___971))
(assert (= (mk1 (to_rep2 (first4 temp___9701)) (to_rep2 (last4 temp___9701))) temp___9711))
(assert (= (ite (<= (to_rep2 (first2 temp___9711)) (to_rep2 (last2 temp___9711))) (+ (- (to_rep2 (last2 temp___9711)) (to_rep2 (first2 temp___9711))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
...
(assert (and (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___982 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___982) (<= temp___982 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= i2 temp___982) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___982) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___982)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
