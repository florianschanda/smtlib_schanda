...
(declare-const blockindex4 int__ref)
...
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (and (and (and (and (and (<= 0 endidx2) (< endidx2 256)) (<= 1 numberofrecordtypes3)) (< numberofrecordtypes3 32)) (= numberofblocks2 1)) (forall ((j6 (_ BitVec 8))) (=> (and (bvule #x00 j6) (bvule j6 #xFF)) (and (<= 1 (to_rep3 (select blocklengthmap3 j6))) (<= (to_rep3 (select blocklengthmap3 j6)) 32)))))))
...
(assert (and (and (and (= numberofblocks2 1) (forall ((j6 (_ BitVec 8))) (=> (and (bvule #x00 j6) (bvule j6 #xFF)) (and (<= 1 (to_rep3 (select (map__content6 blocklengthmap7) j6))) (<= (to_rep3 (select (map__content6 blocklengthmap7) j6)) 32))))) (<= 1 (int__content numberofrecordtypes7))) (<= (int__content numberofrecordtypes7) 32)))
...
(assert (=> (and (bvule #x00 i2) (bvule i2 #xFF)) (and (and (and (and (<= 1 numberofblocks3) (< numberofblocks3 32)) (forall ((j6 (_ BitVec 8))) (=> (and (bvule #x00 j6) (bvule j6 #xFF)) (and (<= 1 (to_rep3 (select (map__content6 blocklengthmap7) j6))) (<= (to_rep3 (select (map__content6 blocklengthmap7) j6)) 32))))) (<= 1 (int__content numberofrecordtypes7))) (<= (int__content numberofrecordtypes7) 32))))
...
(assert (<= 1 j1))
(assert (<= j1 r62b))
(assert (and (and (and (and (and (<= 1 (int__content numberofrecordtypes7)) (<= (int__content numberofrecordtypes7) 32)) (<= 1 (int__content numberofblocks9))) (<= (int__content numberofblocks9) 32)) (<= 1 blockindex3)) (<= blockindex3 32)))
(assert (and (and (=> (<= 1 r62b) (dynamic_property1 1 r62b j2)) (=> (<= 0 32) (in_range8 blockindex3))) (and (<= 1 j2) (<= j2 r62b))))
(assert (= o50 (from_query_type (to_rep2 (select (map__content2 recordtypes7) i9)))))
(assert (= o51 (bvudiv o50 #x0100)))
(assert (= o52 (bvurem o51 #x0100)))
(assert (= o53 o52))
(assert (= o54 ((_ extract 7 0) o53)))
(assert (= result32 (ite (= (to_rep1 (select (map__content1 blocknumbers8) j2)) o54) true false)))
(assert (not (= result32 true)))
(assert (= blockindex4 (mk_int__ref blockindex3)))
(assert (= blockindex5 blockindex3))
(assert (not (= j2 r62b)))
(assert (= result33 (mk_int__ref j2)))
(assert (= j3 (+ j2 1)))
(assert (= j4 (mk_int__ref j3)))
(assert (= blockindex6 blockindex4))
(assert (= j5 j3))
(assert (= blockindex7 blockindex5))
