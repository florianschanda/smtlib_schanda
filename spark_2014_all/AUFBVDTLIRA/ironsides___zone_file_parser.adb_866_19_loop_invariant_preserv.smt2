...
(assert (<= 1 j3))
(assert (<= j3 r62b))
(assert (and (and (and (and (and (<= 1 (int__content numberofrecordtypes9)) (<= (int__content numberofrecordtypes9) 32)) (<= 1 (int__content numberofblocks13))) (<= (int__content numberofblocks13) 32)) (<= 1 blockindex4)) (<= blockindex4 32)))
(assert (and (and (=> (<= 1 r62b) (dynamic_property1 1 r62b j4)) (=> (<= 0 32) (in_range8 blockindex4))) (and (<= 1 j4) (<= j4 r62b))))
(assert (= o50 (from_query_type (to_rep2 (select (map__content2 recordtypes9) i16)))))
(assert (= o51 (bvudiv o50 ((_ int2bv 16) 256))))
(assert (= o52 (bvurem o51 ((_ int2bv 16) 256))))
(assert (= o53 o52))
(assert (= o54 ((_ extract 7 0) o53)))
(assert (= result34 (ite (= (to_rep1 (select (map__content1 blocknumbers12) j4)) o54) true false)))
(assert (not (= result34 true)))
(assert (= blockindex6 (mk_int__ref blockindex4)))
(assert (= blockindex7 blockindex4))
(assert (not (= j4 r62b)))
(assert (= result36 (mk_int__ref j4)))
(assert (= j5 (+ j4 1)))
(assert (= j6 (mk_int__ref j5)))
(assert (= blockindex10 blockindex6))
(assert (= j7 j5))
(assert (= blockindex11 blockindex7))
