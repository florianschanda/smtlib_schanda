...
(assert (= (ite (<= (to_rep (first2 temp___89481)) (to_rep (last2 temp___89481))) (+ (- (to_rep (last2 temp___89481)) (to_rep (first2 temp___89481))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8948 temp___89481)))
(assert (= o2 o))
