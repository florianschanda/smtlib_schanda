...
(define-fun register_type__ref___29__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___20__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___20__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3021 us_t1) (temp___is_init_3017 Bool) (temp___skip_constant_3018 Bool) (temp___do_toplevel_3019 Bool) (temp___do_typ_inv_3020 Bool)) Bool (=> (not (= temp___skip_constant_3018 true)) (and (dynamic_property2 1 5 (first3 temp___expr_3021) (last3 temp___expr_3021)) (and (= (first3 temp___expr_3021) 1) (= (last3 temp___expr_3021) 5)))))
