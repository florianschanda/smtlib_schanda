...
(define-fun dynamic_invariant ((temp___expr_2737 us_t1) (temp___is_init_2734 Bool) (temp___skip_constant_2735 Bool) (temp___do_toplevel_2736 Bool)) Bool (=> (not (= temp___skip_constant_2735 true)) (and (dynamic_property2 1 5 (first3 temp___expr_2737) (last3 temp___expr_2737)) (and (= (first3 temp___expr_2737) 1) (= (last3 temp___expr_2737) 5)))))
