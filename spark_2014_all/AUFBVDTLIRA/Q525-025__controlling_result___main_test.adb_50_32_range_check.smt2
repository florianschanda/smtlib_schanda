...
(assert (=> (<= (to_rep1 total_string__first) (to_rep1 total_string__last)) (= o35 (+ (- (to_rep1 total_string__last) (to_rep1 total_string__first)) 1))))
(assert (=> (not (<= (to_rep1 total_string__first) (to_rep1 total_string__last))) (= o35 0)))
(assert (not (in_range o35)))
(check-sat)
(exit)
