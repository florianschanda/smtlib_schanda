...
(assert (= o7 (- o6 1)))
(assert (and (= temp___347 o7) (in_range1 o7)))
(assert (and (<= (to_rep1 (first (rt text))) temp___347) (<= temp___347 (to_rep1 (last (rt text))))))
(assert (= o8 temp___347))
(assert (= o9 (select (elts text) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 ((_ int2bv 8) o10)))
(assert (= (to_rep2 o12) o11))
(assert (not (in_range1 (+ (to_rep1 data__first) i2))))
(check-sat)
(exit)
