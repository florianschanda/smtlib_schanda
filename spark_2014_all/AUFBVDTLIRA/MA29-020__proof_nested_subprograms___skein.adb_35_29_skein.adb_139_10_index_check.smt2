...
(assert (and (bvule ((_ int2bv 64) 0) n7) (bvule n7 (bvsub c29b ((_ int2bv 64) 1)))))
(assert (and (= o45 (bv2nat (bvmul ((_ int2bv 64) 8) (bvand n7 ((_ int2bv 64) 7))))) (in_range1 (bv2nat (bvmul ((_ int2bv 64) 8) (bvand n7 ((_ int2bv 64) 7)))))))
...
(assert (= o43 (bvudiv n7 ((_ int2bv 64) 8))))
