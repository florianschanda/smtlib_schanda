...
(assert (forall ((x message_index)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x message_index)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x message_count)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x message_count)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun bool_eq1 ((a (Array (_ BitVec 8) us_rep)) (a__first (_ BitVec 8)) (a__last (_ BitVec 8)) (b (Array (_ BitVec 8) us_rep)) (b__first (_ BitVec 8)) (b__last (_ BitVec 8))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 8))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (bool_eq (select a temp___idx_132) (select b (bvadd (bvsub b__first a__first) temp___idx_132))) true)))) true false))
(assert (forall ((a (Array (_ BitVec 8) us_rep)) (b (Array (_ BitVec 8) us_rep))) (forall ((a__first (_ BitVec 8)) (a__last (_ BitVec 8)) (b__first (_ BitVec 8)) (b__last (_ BitVec 8))) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 8))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (bool_eq (select a temp___idx_132) (select b (bvadd (bvsub b__first a__first) temp___idx_132))) true))))))))
...
(assert (forall ((temp___209 us_rep)) (forall ((temp___210 (_ BitVec 8))) (= (select (temp___207 temp___209) temp___210) temp___209))))
(define-fun default_initial_assumption ((temp___expr_205 us_rep1) (temp___skip_top_level_206 Bool)) Bool (and (and (and (= (rec__core__mailboxT__messages (us_split_fields3 temp___expr_205)) (temp___207 (mk___rep (mk___split_fields (of_rep 0) (of_rep1 0))))) (= (to_rep2 (rec__core__mailboxT__next_in (us_split_fields3 temp___expr_205))) ((_ int2bv 8) 0))) (= (to_rep2 (rec__core__mailboxT__next_out (us_split_fields3 temp___expr_205))) ((_ int2bv 8) 0))) (= (to_rep3 (rec__core__mailboxT__count (us_split_fields3 temp___expr_205))) 0)))
(declare-fun item_count (us_rep1) Int)
(declare-fun item_count__function_guard (Int us_rep1) Bool)
(define-fun dynamic_invariant1 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 16)) (in_range3 temp___expr_178)))
(assert (forall ((self__ us_rep1)) (! (dynamic_invariant1 (item_count self__) true false true) :pattern ((item_count self__)))))
(assert (forall ((self__ us_rep1)) (! (= (item_count self__) (to_rep3 (rec__core__mailboxT__count (us_split_fields3 self__)))) :pattern ((item_count self__)))))
(declare-const n Int)
...
(define-fun dynamic_invariant3 ((temp___expr_172 (_ BitVec 8)) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 15))) (in_range2 temp___expr_172)))
...
(assert (=> (< (to_rep3 self__3) 16) (= (rec__core__message_record__size (us_split_fields1 (select self__ (to_rep2 self__1)))) o2)))
(assert (=> (< (to_rep3 self__3) 16) (= o3 o1)))
(assert (=> (< (to_rep3 self__3) 16) (= o4 o2)))
(assert (=> (< (to_rep3 self__3) 16) (= o5 (store self__ (to_rep2 self__1) (mk___rep (mk___split_fields o3 o4))))))
...
(assert (=> (< (to_rep3 self__3) 16) (= result (mk_mailboxT__ref (mk___rep1 (mk___split_fields1 self__ self__1 self__2 self__3))))))
(assert (=> (< (to_rep3 self__3) 16) (= self__5 (mk___rep1 (mk___split_fields1 o10 o11 o12 o13)))))
(assert (=> (< (to_rep3 self__3) 16) (= (to_rep1 o14) 0)))
(assert (=> (< (to_rep3 self__3) 16) (= (rec__core__message_record__value (us_split_fields1 (select (rec__core__mailboxT__messages (us_split_fields3 self__5)) (to_rep2 (rec__core__mailboxT__next_in (us_split_fields3 self__5)))))) o15)))
(assert (=> (< (to_rep3 self__3) 16) (= o14 o16)))
(assert (=> (< (to_rep3 self__3) 16) (= o17 o15)))
(assert (=> (< (to_rep3 self__3) 16) (= o18 o16)))
(assert (=> (< (to_rep3 self__3) 16) (= o19 (store (rec__core__mailboxT__messages (us_split_fields3 self__5)) (to_rep2 (rec__core__mailboxT__next_in (us_split_fields3 self__5))) (mk___rep (mk___split_fields o17 o18))))))
(assert (=> (< (to_rep3 self__3) 16) (= o19 o20)))
(assert (=> (< (to_rep3 self__3) 16) (= (rec__core__mailboxT__next_in (us_split_fields3 self__5)) o21)))
(assert (=> (< (to_rep3 self__3) 16) (= (rec__core__mailboxT__next_out (us_split_fields3 self__5)) o22)))
(assert (=> (< (to_rep3 self__3) 16) (= (rec__core__mailboxT__count (us_split_fields3 self__5)) o23)))
...
(assert (=> (< (to_rep3 self__3) 16) (= result1 (mk_mailboxT__ref self__5))))
(assert (=> (< (to_rep3 self__3) 16) (= self__6 (mk___rep1 (mk___split_fields1 o24 o25 o26 o27)))))
(assert (=> (< (to_rep3 self__3) 16) (= (to_rep2 o28) (bvurem (bvadd (to_rep2 (rec__core__mailboxT__next_in (us_split_fields3 self__6))) ((_ int2bv 8) 1)) ((_ int2bv 8) 16)))))
(assert (=> (< (to_rep3 self__3) 16) (= (rec__core__mailboxT__messages (us_split_fields3 self__6)) o29)))
(assert (=> (< (to_rep3 self__3) 16) (= o28 o30)))
(assert (=> (< (to_rep3 self__3) 16) (= (rec__core__mailboxT__next_out (us_split_fields3 self__6)) o31)))
(assert (=> (< (to_rep3 self__3) 16) (= (rec__core__mailboxT__count (us_split_fields3 self__6)) o32)))
...
(assert (=> (< (to_rep3 self__3) 16) (= result2 (mk_mailboxT__ref self__6))))
(assert (=> (< (to_rep3 self__3) 16) (= self__7 (mk___rep1 (mk___split_fields1 o33 o34 o35 o36)))))
(assert (=> (< (to_rep3 self__3) 16) (and (= o37 (+ (to_rep3 (rec__core__mailboxT__count (us_split_fields3 self__7))) 1)) (in_range3 (+ (to_rep3 (rec__core__mailboxT__count (us_split_fields3 self__7))) 1)))))
(assert (=> (< (to_rep3 self__3) 16) (= (to_rep3 o38) o37)))
(assert (=> (< (to_rep3 self__3) 16) (= (rec__core__mailboxT__messages (us_split_fields3 self__7)) o39)))
(assert (=> (< (to_rep3 self__3) 16) (= (rec__core__mailboxT__next_in (us_split_fields3 self__7)) o40)))
(assert (=> (< (to_rep3 self__3) 16) (= (rec__core__mailboxT__next_out (us_split_fields3 self__7)) o41)))
...
(assert (=> (< (to_rep3 self__3) 16) (= result3 (mk_mailboxT__ref self__7))))
(assert (=> (< (to_rep3 self__3) 16) (= self__8 (mk___rep1 (mk___split_fields1 o43 o44 o45 o46)))))
(assert (=> (not (< (to_rep3 self__3) 16)) (= self__8 (mk___rep1 (mk___split_fields1 self__ self__1 self__2 self__3)))))
(assert (=> (not (< (to_rep3 self__3) 16)) (= self__8 self__4)))
(assert (= self__9 (mk_mailboxT__ref self__8)))
(assert (= self__10 self__8))
(assert (not (< 0 (item_count (mailboxT__content self__9)))))
(check-sat)
(exit)
