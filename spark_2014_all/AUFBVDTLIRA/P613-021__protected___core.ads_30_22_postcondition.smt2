...
(declare-fun temp___240 (us_rep) (Array (_ BitVec 8) us_rep))
(define-fun default_initial_assumption ((temp___expr_238 us_rep1) (temp___skip_top_level_239 Bool)) Bool (and (and (and (= (rec__core__mailboxT__messages (us_split_fields3 temp___expr_238)) (temp___240 (mk___rep (mk___split_fields (of_rep 0) (of_rep1 0))))) (= (to_rep2 (rec__core__mailboxT__next_in (us_split_fields3 temp___expr_238))) #x00)) (= (to_rep2 (rec__core__mailboxT__next_out (us_split_fields3 temp___expr_238))) #x00)) (= (to_rep3 (rec__core__mailboxT__count (us_split_fields3 temp___expr_238))) 0)))
...
(assert (forall ((temp___242 us_rep)) (forall ((temp___243 (_ BitVec 8))) (= (select (temp___240 temp___242) temp___243) temp___242))))
...
(assert (=> (< (to_rep3 self__3) 16) (= (to_rep2 o28) (bvurem (bvadd (to_rep2 (rec__core__mailboxT__next_in (us_split_fields3 self__6))) #x01) #x10))))
