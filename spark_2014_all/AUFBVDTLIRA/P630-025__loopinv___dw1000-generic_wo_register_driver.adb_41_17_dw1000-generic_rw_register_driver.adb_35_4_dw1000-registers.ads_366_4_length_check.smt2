...
(define-fun register_type__ref___95__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___68__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___68__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_4491 us_t1) (temp___is_init_4488 Bool) (temp___skip_constant_4489 Bool) (temp___do_toplevel_4490 Bool)) Bool (=> (not (= temp___skip_constant_4489 true)) (and (dynamic_property2 1 4 (first3 temp___expr_4491) (last3 temp___expr_4491)) (and (= (first3 temp___expr_4491) 1) (= (last3 temp___expr_4491) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___28__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___28__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_4516 us_t2) (temp___is_init_4513 Bool) (temp___skip_constant_4514 Bool) (temp___do_toplevel_4515 Bool)) Bool (=> (not (= temp___skip_constant_4514 true)) (and (dynamic_property3 1 4 (first5 temp___expr_4516) (last5 temp___expr_4516)) (and (= (first5 temp___expr_4516) 1) (= (last5 temp___expr_4516) 4)))))
...
(assert (and (= (mk___t2 temp___7912 temp___79121) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7912 temp___79121) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___79121)) (to_rep (last4 temp___79121))) (+ (- (to_rep (last4 temp___79121)) (to_rep (first4 temp___79121))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7912 temp___7913))
(assert (= (mk1 (to_rep (first4 temp___79121)) (to_rep (last4 temp___79121))) temp___79131))
(assert (not (= (ite (<= (to_rep (first2 temp___79131)) (to_rep (last2 temp___79131))) (+ (- (to_rep (last2 temp___79131)) (to_rep (first2 temp___79131))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
