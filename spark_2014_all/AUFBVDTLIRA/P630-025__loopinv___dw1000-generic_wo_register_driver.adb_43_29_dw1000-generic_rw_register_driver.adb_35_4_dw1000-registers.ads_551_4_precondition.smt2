...
(assert (= (ite (<= (to_rep (first2 temp___89141)) (to_rep (last2 temp___89141))) (+ (- (to_rep (last2 temp___89141)) (to_rep (first2 temp___89141))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8914 temp___89141)))
(assert (= o2 o))
