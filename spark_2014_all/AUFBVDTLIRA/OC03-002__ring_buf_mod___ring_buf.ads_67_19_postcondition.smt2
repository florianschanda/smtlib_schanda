...
(assert (not (= (let ((temp___291 (func_push (to_model (mk___rep (mk___split_fields r__split_fields r__split_fields1 r__split_fields2))) x))) (let ((temp___290 (to_model (mk___rep (mk___split_fields r__split_fields9 r__split_fields10 r__split_fields11))))) (bool_eq (elts temp___290) (to_rep1 (first (rt temp___290))) (to_rep1 (last (rt temp___290))) (elts temp___291) (to_rep1 (first (rt temp___291))) (to_rep1 (last (rt temp___291)))))) true)))
(check-sat)
(exit)
