...
(assert (= o7 (bvurem o6 ((_ int2bv 64) 16))))
(assert (= o8 (ite (= o7 ((_ int2bv 64) 0)) true false)))
(assert (= o1 (physical ep)))
(assert (= o2 (bvsub pointer o1)))
(assert (= o3 (ite (bvult o2 ((_ int2bv 64) 1024)) true false)))
...
(assert (= o12 (bvudiv o11 ((_ int2bv 64) 16))))
(assert (not (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) o12)))
(check-sat)
(exit)
