...
(define-fun dynamic_invariant ((temp___expr_3357 us_t1) (temp___is_init_3354 Bool) (temp___skip_constant_3355 Bool) (temp___do_toplevel_3356 Bool)) Bool (=> (not (= temp___skip_constant_3355 true)) (and (dynamic_property2 1 41 (first3 temp___expr_3357) (last3 temp___expr_3357)) (and (= (first3 temp___expr_3357) 1) (= (last3 temp___expr_3357) 41)))))
