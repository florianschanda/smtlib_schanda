...
(define-fun dynamic_invariant ((temp___expr_7019 us_t1) (temp___is_init_7016 Bool) (temp___skip_constant_7017 Bool) (temp___do_toplevel_7018 Bool)) Bool (=> (not (= temp___skip_constant_7017 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7019) (last3 temp___expr_7019)) (and (= (first3 temp___expr_7019) 1) (= (last3 temp___expr_7019) 2)))))
