...
(define-fun dynamic_invariant ((temp___expr_6658 us_t1) (temp___is_init_6654 Bool) (temp___skip_constant_6655 Bool) (temp___do_toplevel_6656 Bool) (temp___do_typ_inv_6657 Bool)) Bool (=> (not (= temp___skip_constant_6655 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6658) (last3 temp___expr_6658)) (and (= (first3 temp___expr_6658) 1) (= (last3 temp___expr_6658) 1)))))
