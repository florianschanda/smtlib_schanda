...
(define-fun register_byte_array__ref___19__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_2596 us_t1) (temp___is_init_2593 Bool) (temp___skip_constant_2594 Bool) (temp___do_toplevel_2595 Bool)) Bool (=> (not (= temp___skip_constant_2594 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2596) (last3 temp___expr_2596)) (and (= (first3 temp___expr_2596) 1) (= (last3 temp___expr_2596) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___9__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_2642 us_t2) (temp___is_init_2639 Bool) (temp___skip_constant_2640 Bool) (temp___do_toplevel_2641 Bool)) Bool (=> (not (= temp___skip_constant_2640 true)) (and (dynamic_property3 1 4 (first5 temp___expr_2642) (last5 temp___expr_2642)) (and (= (first5 temp___expr_2642) 1) (= (last5 temp___expr_2642) 4)))))
...
(assert (and (= temp___77502 (register_to_bytes reg)) (dynamic_invariant1 temp___77502 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___77501)) (to_rep (last4 temp___77501))) (+ (- (to_rep (last4 temp___77501)) (to_rep (first4 temp___77501))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7750 temp___7751))
(assert (= (mk1 (to_rep (first4 temp___77501)) (to_rep (last4 temp___77501))) temp___77511))
(assert (not (= (ite (<= (to_rep (first2 temp___77511)) (to_rep (last2 temp___77511))) (+ (- (to_rep (last2 temp___77511)) (to_rep (first2 temp___77511))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
