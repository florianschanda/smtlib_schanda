...
(define-fun dynamic_invariant ((temp___expr_7104 us_t1) (temp___is_init_7101 Bool) (temp___skip_constant_7102 Bool) (temp___do_toplevel_7103 Bool)) Bool (=> (not (= temp___skip_constant_7102 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7104) (last3 temp___expr_7104)) (and (= (first3 temp___expr_7104) 1) (= (last3 temp___expr_7104) 2)))))
