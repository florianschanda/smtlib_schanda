...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__otp_sf_type__ops_kick bits_1) (rec__dw1000__register_types__otp_sf_type__ldo_kick bits_1) (rec__dw1000__register_types__otp_sf_type__ops_sel bits_1) (rec__dw1000__register_types__otp_sf_type__reserved_1 bits_3) (rec__dw1000__register_types__otp_sf_type__reserved_2 bits_2)))))
(define-fun us_split_fields_OPS_KICK__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__otp_sf_type__ops_kick a))
(define-fun us_split_fields_LDO_KICK__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__otp_sf_type__ldo_kick a))
(define-fun us_split_fields_OPS_SEL__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__otp_sf_type__ops_sel a))
(define-fun us_split_fields_Reserved_1__14__projection ((a us_split_fields)) bits_3 (rec__dw1000__register_types__otp_sf_type__reserved_1 a))
(define-fun us_split_fields_Reserved_2__14__projection ((a us_split_fields)) bits_2 (rec__dw1000__register_types__otp_sf_type__reserved_2 a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___79__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___79__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (= (to_rep2 (rec__dw1000__register_types__otp_sf_type__ops_kick (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__otp_sf_type__ops_kick (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__otp_sf_type__ldo_kick (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__otp_sf_type__ldo_kick (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__otp_sf_type__ops_sel (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__otp_sf_type__ops_sel (us_split_fields1 b))))) (= (to_rep4 (rec__dw1000__register_types__otp_sf_type__reserved_1 (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__otp_sf_type__reserved_1 (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__otp_sf_type__reserved_2 (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__otp_sf_type__reserved_2 (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__otp_sf_type__ops_kick__first__bit Int)
(declare-const dw1000__register_types__otp_sf_type__ops_kick__last__bit Int)
(declare-const dw1000__register_types__otp_sf_type__ops_kick__position Int)
(assert (<= 0 dw1000__register_types__otp_sf_type__ops_kick__first__bit))
(assert (< dw1000__register_types__otp_sf_type__ops_kick__first__bit dw1000__register_types__otp_sf_type__ops_kick__last__bit))
(assert (<= 0 dw1000__register_types__otp_sf_type__ops_kick__position))
(declare-const dw1000__register_types__otp_sf_type__ldo_kick__first__bit Int)
(declare-const dw1000__register_types__otp_sf_type__ldo_kick__last__bit Int)
(declare-const dw1000__register_types__otp_sf_type__ldo_kick__position Int)
(assert (<= 0 dw1000__register_types__otp_sf_type__ldo_kick__first__bit))
(assert (< dw1000__register_types__otp_sf_type__ldo_kick__first__bit dw1000__register_types__otp_sf_type__ldo_kick__last__bit))
(assert (<= 0 dw1000__register_types__otp_sf_type__ldo_kick__position))
(declare-const dw1000__register_types__otp_sf_type__ops_sel__first__bit Int)
(declare-const dw1000__register_types__otp_sf_type__ops_sel__last__bit Int)
(declare-const dw1000__register_types__otp_sf_type__ops_sel__position Int)
(assert (<= 0 dw1000__register_types__otp_sf_type__ops_sel__first__bit))
(assert (< dw1000__register_types__otp_sf_type__ops_sel__first__bit dw1000__register_types__otp_sf_type__ops_sel__last__bit))
(assert (<= 0 dw1000__register_types__otp_sf_type__ops_sel__position))
(declare-const dw1000__register_types__otp_sf_type__reserved_1__first__bit Int)
(declare-const dw1000__register_types__otp_sf_type__reserved_1__last__bit Int)
(declare-const dw1000__register_types__otp_sf_type__reserved_1__position Int)
(assert (<= 0 dw1000__register_types__otp_sf_type__reserved_1__first__bit))
(assert (< dw1000__register_types__otp_sf_type__reserved_1__first__bit dw1000__register_types__otp_sf_type__reserved_1__last__bit))
(assert (<= 0 dw1000__register_types__otp_sf_type__reserved_1__position))
(declare-const dw1000__register_types__otp_sf_type__reserved_2__first__bit Int)
(declare-const dw1000__register_types__otp_sf_type__reserved_2__last__bit Int)
(declare-const dw1000__register_types__otp_sf_type__reserved_2__position Int)
(assert (<= 0 dw1000__register_types__otp_sf_type__reserved_2__first__bit))
(assert (< dw1000__register_types__otp_sf_type__reserved_2__first__bit dw1000__register_types__otp_sf_type__reserved_2__last__bit))
(assert (<= 0 dw1000__register_types__otp_sf_type__reserved_2__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((otp_sf_type__ref (mk_otp_sf_type__ref (otp_sf_type__content us_rep)))))
(define-fun otp_sf_type__ref___projection ((a otp_sf_type__ref)) us_rep (otp_sf_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___193__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___135__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___135__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6615 us_t1) (temp___is_init_6612 Bool) (temp___skip_constant_6613 Bool) (temp___do_toplevel_6614 Bool)) Bool (=> (not (= temp___skip_constant_6613 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6615) (last3 temp___expr_6615)) (and (= (first3 temp___expr_6615) 1) (= (last3 temp___expr_6615) 1)))))
...
(assert (and (dynamic_property2 1 1 (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 1))))
