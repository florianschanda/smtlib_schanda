...
(define-fun dynamic_invariant ((temp___expr_7276 us_t1) (temp___is_init_7272 Bool) (temp___skip_constant_7273 Bool) (temp___do_toplevel_7274 Bool) (temp___do_typ_inv_7275 Bool)) Bool (=> (not (= temp___skip_constant_7273 true)) (and (dynamic_property2 1 1 (first3 temp___expr_7276) (last3 temp___expr_7276)) (and (= (first3 temp___expr_7276) 1) (= (last3 temp___expr_7276) 1)))))
