...
(assert (= o7 (store xcx3 3 o6)))
(assert (= xcx3 result3))
(assert (= xcx4 o7))
(assert (= (bvadd ((_ zero_extend 24) (to_rep (select xcx4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 1))) ((_ int2bv 32) 256))) (bvurem val__ ((_ int2bv 32) 65536))))
(assert (= (bvadd ((_ zero_extend 24) (to_rep (select xcx4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) ((_ int2bv 32) 256))) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536))))
...
(assert (not (not (= ((_ int2bv 32) 65536) #x00000000))))
(check-sat)
(exit)
