...
(assert (<= 1 i1))
(assert (<= i1 r120b))
(assert (and (and (dynamic_invariant1 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true) (forall ((temp___1223 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1223) (<= temp___1223 (to_rep1 (last number__split_fields3)))) (=> (<= i2 temp___1223) (= (select number__split_fields2 temp___1223) (select number__split_fields temp___1223)))))) (and (<= 1 i2) (<= i2 r120b))))
...
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___12161 temp___12162))))
(assert (= number__split_discrs (mk___split_discrs temp___1216)))
