...
(define-fun dynamic_invariant ((temp___expr_3856 us_t1) (temp___is_init_3852 Bool) (temp___skip_constant_3853 Bool) (temp___do_toplevel_3854 Bool) (temp___do_typ_inv_3855 Bool)) Bool (=> (not (= temp___skip_constant_3853 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3856) (last3 temp___expr_3856)) (and (= (first3 temp___expr_3856) 1) (= (last3 temp___expr_3856) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_3874 us_t2) (temp___is_init_3870 Bool) (temp___skip_constant_3871 Bool) (temp___do_toplevel_3872 Bool) (temp___do_typ_inv_3873 Bool)) Bool (=> (not (= temp___skip_constant_3871 true)) (and (dynamic_property3 1 2 (first5 temp___expr_3874) (last5 temp___expr_3874)) (and (= (first5 temp___expr_3874) 1) (= (last5 temp___expr_3874) 2)))))
...
(declare-const temp___86051 t2)
(declare-const temp___8606 (Array Int bits_8))
(declare-const temp___86061 t1)
(define-fun temp___86052 () us_t2 (mk___t2 temp___8605 temp___86051))
...
(assert (and (= temp___86052 (register_to_bytes reg)) (dynamic_invariant1 temp___86052 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___86051)) (to_rep (last4 temp___86051))) (+ (- (to_rep (last4 temp___86051)) (to_rep (first4 temp___86051))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8605 temp___8606))
(assert (= (mk1 (to_rep (first4 temp___86051)) (to_rep (last4 temp___86051))) temp___86061))
(assert (not (= (ite (<= (to_rep (first2 temp___86061)) (to_rep (last2 temp___86061))) (+ (- (to_rep (last2 temp___86061)) (to_rep (first2 temp___86061))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
