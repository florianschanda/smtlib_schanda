...
(assert (forall ((x message_index)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x10))) (=> (in_range2 y) (= (to_rep1 (of_rep1 x)) y))) :pattern ((to_rep1 (of_rep1 x))))))
...
(declare-fun temp___229 (Int) (Array (_ BitVec 8) integer))
(define-fun default_initial_assumption ((temp___expr_227 us_rep) (temp___skip_top_level_228 Bool)) Bool (and (and (and (= (rec__communications__mailboxT__messages (us_split_fields1 temp___expr_227)) (temp___229 0)) (= (to_rep1 (rec__communications__mailboxT__next_in (us_split_fields1 temp___expr_227))) #x00)) (= (to_rep1 (rec__communications__mailboxT__next_out (us_split_fields1 temp___expr_227))) #x00)) (= (to_rep2 (rec__communications__mailboxT__count (us_split_fields1 temp___expr_227))) 0)))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-fun item_count (us_rep) Int)
(declare-fun item_count__function_guard (Int us_rep) Bool)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(define-fun dynamic_invariant1 ((temp___expr_201 (_ BitVec 8)) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool) (temp___do_typ_inv_200 Bool)) Bool (=> (or (= temp___is_init_197 true) (bvule #x00 #x0F)) (in_range2 temp___expr_201)))
(define-fun dynamic_invariant2 ((temp___expr_208 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool) (temp___do_typ_inv_207 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 16)) (in_range3 temp___expr_208)))
...
(assert (forall ((temp___231 Int)) (=> (dynamic_invariant temp___231 true true true true) (forall ((temp___232 (_ BitVec 8))) (= (to_rep (select (temp___229 temp___231) temp___232)) temp___231)))))
(define-fun dynamic_invariant3 ((temp___expr_187 Int) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool) (temp___do_typ_inv_186 Bool)) Bool (=> (or (= temp___is_init_183 true) (<= 0 97)) (in_range1 temp___expr_187)))
(assert (not (<= 97 97)))
(check-sat)
(exit)
