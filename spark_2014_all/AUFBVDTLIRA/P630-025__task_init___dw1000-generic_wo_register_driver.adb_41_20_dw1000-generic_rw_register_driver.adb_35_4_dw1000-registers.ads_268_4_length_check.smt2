...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__tx_antd_type__tx_antd (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__tx_antd_type__tx_antd (us_split_fields1 b)))) true false))
...
(define-fun register_byte_array__ref___30__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3015 us_t1) (temp___is_init_3012 Bool) (temp___skip_constant_3013 Bool) (temp___do_toplevel_3014 Bool)) Bool (=> (not (= temp___skip_constant_3013 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3015) (last3 temp___expr_3015)) (and (= (first3 temp___expr_3015) 1) (= (last3 temp___expr_3015) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___11__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_3031 us_t2) (temp___is_init_3028 Bool) (temp___skip_constant_3029 Bool) (temp___do_toplevel_3030 Bool)) Bool (=> (not (= temp___skip_constant_3029 true)) (and (dynamic_property3 1 2 (first5 temp___expr_3031) (last5 temp___expr_3031)) (and (= (first5 temp___expr_3031) 1) (= (last5 temp___expr_3031) 2)))))
...
(declare-const temp___7779 (Array Int bits_8))
(declare-const temp___77791 t2)
(declare-const temp___7780 (Array Int bits_8))
(declare-const temp___77801 t1)
...
(assert (and (= (mk___t2 temp___7779 temp___77791) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7779 temp___77791) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___77791)) (to_rep (last4 temp___77791))) (+ (- (to_rep (last4 temp___77791)) (to_rep (first4 temp___77791))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
