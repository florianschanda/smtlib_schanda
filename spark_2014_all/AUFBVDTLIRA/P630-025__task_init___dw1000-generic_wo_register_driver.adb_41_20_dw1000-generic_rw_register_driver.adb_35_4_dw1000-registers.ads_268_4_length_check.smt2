...
(define-fun tregister_byte_arrayP1__ref___30__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___11__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__tx_antd_type__tx_antd bits_16)))))
(define-fun us_split_fields_TX_ANTD__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__tx_antd_type__tx_antd a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__tx_antd_type__tx_antd (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__tx_antd_type__tx_antd (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__tx_antd_type__tx_antd__first__bit Int)
(declare-const dw1000__register_types__tx_antd_type__tx_antd__last__bit Int)
(declare-const dw1000__register_types__tx_antd_type__tx_antd__position Int)
(assert (<= 0 dw1000__register_types__tx_antd_type__tx_antd__first__bit))
(assert (< dw1000__register_types__tx_antd_type__tx_antd__first__bit dw1000__register_types__tx_antd_type__tx_antd__last__bit))
(assert (<= 0 dw1000__register_types__tx_antd_type__tx_antd__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((tx_antd_type__ref (mk_tx_antd_type__ref (tx_antd_type__content us_rep)))))
(define-fun tx_antd_type__ref___projection ((a tx_antd_type__ref)) us_rep (tx_antd_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___11__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_3340 us_t1) (temp___is_init_3336 Bool) (temp___skip_constant_3337 Bool) (temp___do_toplevel_3338 Bool) (temp___do_typ_inv_3339 Bool)) Bool (=> (not (= temp___skip_constant_3337 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3340) (last3 temp___expr_3340)) (and (= (first3 temp___expr_3340) 1) (= (last3 temp___expr_3340) 2)))))
...
(define-fun register_type__ref___40__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___30__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_3322 us_t2) (temp___is_init_3318 Bool) (temp___skip_constant_3319 Bool) (temp___do_toplevel_3320 Bool) (temp___do_typ_inv_3321 Bool)) Bool (=> (not (= temp___skip_constant_3319 true)) (and (dynamic_property3 1 2 (first5 temp___expr_3322) (last5 temp___expr_3322)) (and (= (first5 temp___expr_3322) 1) (= (last5 temp___expr_3322) 2)))))
...
(declare-const temp___8551 (Array Int bits_8))
(declare-const temp___85511 t1)
(define-fun temp___85512 () us_t1 (mk___t1 temp___8551 temp___85511))
...
(assert (and (= temp___85512 (register_to_bytes reg)) (dynamic_invariant temp___85512 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___85511)) (to_rep (last2 temp___85511))) (+ (- (to_rep (last2 temp___85511)) (to_rep (first2 temp___85511))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
