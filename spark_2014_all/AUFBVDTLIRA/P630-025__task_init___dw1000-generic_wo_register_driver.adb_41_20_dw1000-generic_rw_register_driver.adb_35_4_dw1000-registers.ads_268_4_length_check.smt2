...
(define-fun dynamic_invariant ((temp___expr_3322 us_t1) (temp___is_init_3318 Bool) (temp___skip_constant_3319 Bool) (temp___do_toplevel_3320 Bool) (temp___do_typ_inv_3321 Bool)) Bool (=> (not (= temp___skip_constant_3319 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3322) (last3 temp___expr_3322)) (and (= (first3 temp___expr_3322) 1) (= (last3 temp___expr_3322) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_3340 us_t2) (temp___is_init_3336 Bool) (temp___skip_constant_3337 Bool) (temp___do_toplevel_3338 Bool) (temp___do_typ_inv_3339 Bool)) Bool (=> (not (= temp___skip_constant_3337 true)) (and (dynamic_property3 1 2 (first5 temp___expr_3340) (last5 temp___expr_3340)) (and (= (first5 temp___expr_3340) 1) (= (last5 temp___expr_3340) 2)))))
...
(declare-const temp___85511 t2)
(define-fun temp___85512 () us_t2 (mk___t2 temp___8551 temp___85511))
...
(assert (and (= temp___85512 (register_to_bytes reg)) (dynamic_invariant1 temp___85512 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___85511)) (to_rep (last4 temp___85511))) (+ (- (to_rep (last4 temp___85511)) (to_rep (first4 temp___85511))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
