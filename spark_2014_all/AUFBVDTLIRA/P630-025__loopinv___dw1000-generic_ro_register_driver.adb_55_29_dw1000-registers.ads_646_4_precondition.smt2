...
(define-fun in_range3 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x0FFF)))
...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x1000))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(define-fun dynamic_invariant ((temp___expr_7917 us_t1) (temp___is_init_7913 Bool) (temp___skip_constant_7914 Bool) (temp___do_toplevel_7915 Bool) (temp___do_typ_inv_7916 Bool)) Bool (=> (not (= temp___skip_constant_7914 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7917) (last3 temp___expr_7917)) (and (= (first3 temp___expr_7917) 1) (= (last3 temp___expr_7917) 2)))))
