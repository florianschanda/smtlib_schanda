...
(define-fun dynamic_invariant7 ((temp___expr_291 Int) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool) (temp___do_typ_inv_290 Bool)) Bool (=> (or (= temp___is_init_287 true) (<= 0 3)) (in_range3 temp___expr_291)))
...
(declare-const temp___1539 Bool)
...
(declare-const success4 bool__ref)
...
(declare-const success10 bool__ref)
...
(assert (= begidx1 1))
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i14 Int)) (=> (and (<= begidx2 i14) (<= i14 endidx1)) (and (<= 48 (to_rep (select zonefileline i14))) (<= (to_rep (select zonefileline i14)) 57)))))) (and (and (in_range5 begidx2) (in_range5 endidx1)) (in_range4 foundtype1))))
...
(assert (= i2 1))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= temp___1531 timestring1)))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= temp___1535 zlength)))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= temp___1534 endidx1)))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= temp___1533 begidx2)))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= temp___1530 i2)))
(assert (=> (and (<= 1 i2) (<= i2 14)) (and (and (and (and (and (= begidx2 temp___1533) (= endidx1 temp___1534)) (= zlength temp___1535)) (<= endidx1 zlength)) (= (- endidx1 begidx2) 13)) (<= i3 14))))
(assert (=> (and (<= 1 i2) (<= i2 14)) (and (and (=> (<= 1 14) (in_range8 i3)) (forall ((temp___1532 Int)) (=> (and (<= 1 temp___1532) (<= temp___1532 14)) (=> (<= i3 temp___1532) (= (select timestring2 temp___1532) (select temp___1531 temp___1532)))))) (and (<= 1 i3) (<= i3 14)))))
(assert (=> (and (<= 1 i2) (<= i2 14)) (and (<= 1 (- (+ begidx2 i3) 1)) (<= (- (+ begidx2 i3) 1) 256))))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= o (- (+ begidx2 i3) 1))))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= o1 (select zonefileline o))))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= o2 (to_rep o1))))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= (to_rep o3) o2)))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= o4 (store timestring2 i3 o3))))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= result4 (mk_map__ref timestring2))))
(assert (=> (and (<= 1 i2) (<= i2 14)) (= timestring3 o4)))
...
(assert (= i8 1))
(assert (=> (and (<= 1 i8) (<= i8 14)) (= temp___1539 success1)))
(assert (=> (and (<= 1 i8) (<= i8 14)) (= temp___1538 i8)))
(assert (=> (and (<= 1 i8) (<= i8 14)) (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i9 1))) (and (<= 48 (to_rep (select (map__content timestring6) j))) (<= (to_rep (select (map__content timestring6) j)) 57))))))
(assert (=> (and (<= 1 i8) (<= i8 14)) (and (=> (<= 1 14) (in_range8 i9)) (and (<= 1 i9) (<= i9 14)))))
(assert (=> (and (<= 1 i8) (<= i8 14)) (or (and (and (= success6 (mk_bool__ref success3)) (= success7 success3)) (and (=> (not (< (to_rep (select (map__content timestring6) i9)) 48)) (< 57 (to_rep (select (map__content timestring6) i9)))) (and (= result6 (mk_bool__ref success2)) (= success3 (distinct 0 0))))) (and (and (not (=> (not (< (to_rep (select (map__content timestring6) i9)) 48)) (< 57 (to_rep (select (map__content timestring6) i9))))) (and (= success4 (mk_bool__ref success2)) (= success5 success2))) (and (and (= success6 success4) (= success7 success5)) (= i9 14))))))
(assert (=> (and (<= 1 i8) (<= i8 14)) (= i10 (mk_int__ref i9))))
(assert (=> (and (<= 1 i8) (<= i8 14)) (= success8 success6)))
(assert (=> (and (<= 1 i8) (<= i8 14)) (= i11 i9)))
(assert (=> (and (<= 1 i8) (<= i8 14)) (= success9 success7)))
(assert (=> (and (<= 1 i8) (<= i8 14)) (= i12 i10)))
(assert (=> (and (<= 1 i8) (<= i8 14)) (= success10 success8)))
(assert (=> (and (<= 1 i8) (<= i8 14)) (= i13 i11)))
(assert (=> (and (<= 1 i8) (<= i8 14)) (= success11 success9)))
(assert (=> (not (and (<= 1 i8) (<= i8 14))) (= i12 (mk_int__ref i8))))
(assert (=> (not (and (<= 1 i8) (<= i8 14))) (= success10 (mk_bool__ref success1))))
(assert (=> (not (and (<= 1 i8) (<= i8 14))) (= i13 i8)))
(assert (=> (not (and (<= 1 i8) (<= i8 14))) (= success11 success1)))
(assert (= (bool__content success10) true))
(declare-const i14 Int)
(assert (<= 1 i14))
(assert (<= i14 14))
(assert (not (<= 48 (to_rep (select (map__content timestring6) i14)))))
(check-sat)
(exit)
