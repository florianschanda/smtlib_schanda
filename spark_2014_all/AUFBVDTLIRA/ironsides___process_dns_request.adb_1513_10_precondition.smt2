...
(assert (and (<= 1 (+ current_byte1 4)) (<= (+ current_byte1 4) 8180)))
(assert (= o22 (+ current_byte1 4)))
(assert (= o23 (store (rec__dns_types__dns_packet__bytes output_packet__split_fields17) o22 o21)))
(assert (= (rec__dns_types__dns_packet__header output_packet__split_fields17) (mk___rep (mk___split_fields o24 o25 o26 o27 o28 o29 o30 o31 o32 o33 o34 o35 o36 o37 o38))))
(assert (= o23 o39))
(assert (= temp___7119 o24))
(assert (= temp___71191 o25))
(assert (= temp___71192 o26))
(assert (= temp___71193 o27))
(assert (= temp___71194 o28))
(assert (= temp___71195 o29))
(assert (= temp___71196 o30))
(assert (= temp___71197 o31))
(assert (= temp___71198 o32))
(assert (= temp___71199 o33))
(assert (= temp___711910 o34))
(assert (= temp___711911 o35))
(assert (= temp___711912 o36))
(assert (= temp___711913 o37))
(assert (= temp___711914 o38))
(assert (= temp___711915 o39))
(assert (= result5 (mk___split_fields__ref1 output_packet__split_fields17)))
(assert (= output_packet__split_fields18 (mk___split_fields1 (mk___rep (mk___split_fields temp___7119 temp___71191 temp___71192 temp___71193 temp___71194 temp___71195 temp___71196 temp___71197 temp___71198 temp___71199 temp___711910 temp___711911 temp___711912 temp___711913 temp___711914)) temp___711915)))
(assert (= (to_rep1 o40) #x00))
(assert (and (<= 1 (+ current_byte1 5)) (<= (+ current_byte1 5) 8180)))
(assert (= o41 (+ current_byte1 5)))
(assert (= o42 (store (rec__dns_types__dns_packet__bytes output_packet__split_fields18) o41 o40)))
(assert (= o43 (mk___split_fields1 (rec__dns_types__dns_packet__header output_packet__split_fields18) o42)))
(assert (= temp___7123 (mk___rep1 o43)))
(assert (= result6 (mk___split_fields__ref1 output_packet__split_fields18)))
(assert (= output_packet__split_fields19 (us_split_fields3 temp___7123)))
(assert (= (to_rep1 o44) #x01))
(assert (and (<= 1 (+ current_byte1 6)) (<= (+ current_byte1 6) 8180)))
(assert (= o45 (+ current_byte1 6)))
(assert (= o46 (store (rec__dns_types__dns_packet__bytes output_packet__split_fields19) o45 o44)))
(assert (= o47 (mk___split_fields1 (rec__dns_types__dns_packet__header output_packet__split_fields19) o46)))
(assert (= temp___7127 (mk___rep1 o47)))
(assert (= result7 (mk___split_fields__ref1 output_packet__split_fields19)))
(assert (= output_packet__split_fields20 (us_split_fields3 temp___7127)))
(assert (and (= o48 (+ current_byte1 7)) (in_range4 (+ current_byte1 7))))
(assert (not (<= o48 8177)))
(check-sat)
(exit)
