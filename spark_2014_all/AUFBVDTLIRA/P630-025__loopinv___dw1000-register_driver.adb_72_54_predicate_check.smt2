...
(assert (= (to_rep2 o13) ((_ extract 7 0) sub_address)))
(assert (= (to_rep4 o14) 0))
(assert (= (to_rep5 o15) 1))
(assert (= (to_rep1 o16) register_id))
(assert (= o16 o17))
(assert (= o15 o18))
(assert (= o14 o19))
(assert (= o13 o20))
(assert (= o12 o21))
(assert (= temp___749 o17))
(assert (= temp___7491 o18))
(assert (= temp___7492 o19))
(assert (= temp___7493 o20))
(assert (= temp___7494 o21))
(assert (and (= (to_rep5 temp___7491) 1) (= (to_rep6 temp___7494) 0)))
(assert (= (mk___rep1 (mk___split_fields1 dw1000__register_driver__read_register__B_2__header__assume dw1000__register_driver__read_register__B_2__header__assume1 dw1000__register_driver__read_register__B_2__header__assume2 dw1000__register_driver__read_register__B_2__header__assume3 dw1000__register_driver__read_register__B_2__header__assume4)) (mk___rep1 (mk___split_fields1 temp___749 temp___7491 temp___7492 temp___7493 temp___7494))))
(assert (= (mk___rep1 (mk___split_fields1 dw1000__register_driver__read_register__B_2__header__assume dw1000__register_driver__read_register__B_2__header__assume1 dw1000__register_driver__read_register__B_2__header__assume2 dw1000__register_driver__read_register__B_2__header__assume3 dw1000__register_driver__read_register__B_2__header__assume4)) header1))
