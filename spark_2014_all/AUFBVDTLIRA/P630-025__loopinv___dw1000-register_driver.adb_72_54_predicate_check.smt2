...
(assert (= dw1000__register_driver__read_register__B_2__header__assume5 (mk___rep1 (mk___split_fields1 temp___749 temp___7491 temp___7492 temp___7493 temp___7494))))
(assert (= dw1000__register_driver__read_register__B_2__header__assume5 header1))
(assert (let ((temp___624 header1)) (and (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___624))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___624))) 0))))
(assert (not (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 header1))) 1)))
(check-sat)
(exit)
