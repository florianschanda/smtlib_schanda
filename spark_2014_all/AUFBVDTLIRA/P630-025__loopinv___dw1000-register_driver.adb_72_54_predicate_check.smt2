...
(define-fun dw1000__register_driver__read_register__B_2__header__assume5 () us_rep1 (mk___rep1 (mk___split_fields1 dw1000__register_driver__read_register__B_2__header__assume dw1000__register_driver__read_register__B_2__header__assume1 dw1000__register_driver__read_register__B_2__header__assume2 dw1000__register_driver__read_register__B_2__header__assume3 dw1000__register_driver__read_register__B_2__header__assume4)))
...
(assert (and (= (to_rep4 temp___8641) 1) (= (to_rep6 temp___8644) 0)))
(assert (= dw1000__register_driver__read_register__B_2__header__assume5 (mk___rep1 (mk___split_fields1 temp___864 temp___8641 temp___8642 temp___8643 temp___8644))))
(assert (= dw1000__register_driver__read_register__B_2__header__assume5 header1))
(assert (let ((temp___727 header1)) (and (= (to_rep4 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___727))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___727))) 0))))
(assert (not (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 header1))) 0)))
(check-sat)
(exit)
