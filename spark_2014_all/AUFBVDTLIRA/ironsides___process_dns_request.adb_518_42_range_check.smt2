...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__rr_type__srv_record_type__srvrecordtype__pref unsigned16) (rec__rr_type__srv_record_type__srvrecordtype__weight unsigned16) (rec__rr_type__srv_record_type__srvrecordtype__portnum unsigned16) (rec__rr_type__srv_record_type__srvrecordtype__servername (Array Int character)) (rec__rr_type__resourcerecordtype__ttlinseconds1 unsigned32) (rec__rr_type__resourcerecordtype__class1 classtype) (rec__ext__1 us_private)))))
(define-fun us_split_fields_Pref__2__projection ((a us_split_fields2)) unsigned16 (rec__rr_type__srv_record_type__srvrecordtype__pref a))
(define-fun us_split_fields_Weight__projection ((a us_split_fields2)) unsigned16 (rec__rr_type__srv_record_type__srvrecordtype__weight a))
(define-fun us_split_fields_PortNum__projection ((a us_split_fields2)) unsigned16 (rec__rr_type__srv_record_type__srvrecordtype__portnum a))
(define-fun us_split_fields_ServerName__projection ((a us_split_fields2)) (Array Int character) (rec__rr_type__srv_record_type__srvrecordtype__servername a))
(define-fun us_split_fields_TTLInSeconds__12__projection ((a us_split_fields2)) unsigned32 (rec__rr_type__resourcerecordtype__ttlinseconds1 a))
(define-fun us_split_fields_Class__12__projection ((a us_split_fields2)) classtype (rec__rr_type__resourcerecordtype__class1 a))
(define-fun us_split_fields___13__projection ((a us_split_fields2)) us_private (rec__ext__1 a))
...
(define-fun us_rep___29__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
(define-fun us_rep___30__projection ((a us_rep1)) Int (attr__tag1 a))
(declare-fun hide_ext__ (unsigned16 unsigned16 unsigned16 (Array Int character) us_private) us_private)
(declare-fun extract__pref (us_private) unsigned16)
(assert (forall ((pref unsigned16) (weight unsigned16) (portnum unsigned16)) (forall ((servername (Array Int character))) (forall ((rec__ext__2 us_private)) (= (extract__pref (hide_ext__ pref weight portnum servername rec__ext__2)) pref)))))
(declare-fun extract__weight (us_private) unsigned16)
(assert (forall ((pref unsigned16) (weight unsigned16) (portnum unsigned16)) (forall ((servername (Array Int character))) (forall ((rec__ext__2 us_private)) (= (extract__weight (hide_ext__ pref weight portnum servername rec__ext__2)) weight)))))
(declare-fun extract__portnum (us_private) unsigned16)
(assert (forall ((pref unsigned16) (weight unsigned16) (portnum unsigned16)) (forall ((servername (Array Int character))) (forall ((rec__ext__2 us_private)) (= (extract__portnum (hide_ext__ pref weight portnum servername rec__ext__2)) portnum)))))
(declare-fun extract__servername (us_private) (Array Int character))
(assert (forall ((pref unsigned16) (weight unsigned16) (portnum unsigned16)) (forall ((servername (Array Int character))) (forall ((rec__ext__2 us_private)) (= (extract__servername (hide_ext__ pref weight portnum servername rec__ext__2)) servername)))))
(declare-fun extract__ext__ (us_private) us_private)
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (mk___split_fields (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 a)) (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 a)) (hide_ext__ (rec__rr_type__srv_record_type__srvrecordtype__pref (us_split_fields3 a)) (rec__rr_type__srv_record_type__srvrecordtype__weight (us_split_fields3 a)) (rec__rr_type__srv_record_type__srvrecordtype__portnum (us_split_fields3 a)) (rec__rr_type__srv_record_type__srvrecordtype__servername (us_split_fields3 a)) (rec__ext__1 (us_split_fields3 a)))) (attr__tag1 a)))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (mk___split_fields1 (extract__pref (rec__ext__ (us_split_fields1 r))) (extract__weight (rec__ext__ (us_split_fields1 r))) (extract__portnum (rec__ext__ (us_split_fields1 r))) (extract__servername (rec__ext__ (us_split_fields1 r))) (rec__rr_type__resourcerecordtype__ttlinseconds (us_split_fields1 r)) (rec__rr_type__resourcerecordtype__class (us_split_fields1 r)) (extract__ext__ (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (and (and (= (to_rep2 (rec__rr_type__srv_record_type__srvrecordtype__pref (us_split_fields3 a))) (to_rep2 (rec__rr_type__srv_record_type__srvrecordtype__pref (us_split_fields3 b)))) (= (to_rep2 (rec__rr_type__srv_record_type__srvrecordtype__weight (us_split_fields3 a))) (to_rep2 (rec__rr_type__srv_record_type__srvrecordtype__weight (us_split_fields3 b))))) (= (to_rep2 (rec__rr_type__srv_record_type__srvrecordtype__portnum (us_split_fields3 a))) (to_rep2 (rec__rr_type__srv_record_type__srvrecordtype__portnum (us_split_fields3 b))))) (= (bool_eq (rec__rr_type__srv_record_type__srvrecordtype__servername (us_split_fields3 a)) 1 129 (rec__rr_type__srv_record_type__srvrecordtype__servername (us_split_fields3 b)) 1 129) true)) (= (to_rep3 (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 a))) (to_rep3 (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 b))))) (= (to_rep4 (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 a))) (to_rep4 (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 b))))) true false))
...
(declare-const rr_type__srv_record_type__srvrecordtype__pref__first__bit Int)
(declare-const rr_type__srv_record_type__srvrecordtype__pref__last__bit Int)
(declare-const rr_type__srv_record_type__srvrecordtype__pref__position Int)
(assert (<= 0 rr_type__srv_record_type__srvrecordtype__pref__first__bit))
(assert (< rr_type__srv_record_type__srvrecordtype__pref__first__bit rr_type__srv_record_type__srvrecordtype__pref__last__bit))
(assert (<= 0 rr_type__srv_record_type__srvrecordtype__pref__position))
(declare-const rr_type__srv_record_type__srvrecordtype__weight__first__bit Int)
(declare-const rr_type__srv_record_type__srvrecordtype__weight__last__bit Int)
(declare-const rr_type__srv_record_type__srvrecordtype__weight__position Int)
(assert (<= 0 rr_type__srv_record_type__srvrecordtype__weight__first__bit))
(assert (< rr_type__srv_record_type__srvrecordtype__weight__first__bit rr_type__srv_record_type__srvrecordtype__weight__last__bit))
(assert (<= 0 rr_type__srv_record_type__srvrecordtype__weight__position))
(declare-const rr_type__srv_record_type__srvrecordtype__portnum__first__bit Int)
(declare-const rr_type__srv_record_type__srvrecordtype__portnum__last__bit Int)
(declare-const rr_type__srv_record_type__srvrecordtype__portnum__position Int)
(assert (<= 0 rr_type__srv_record_type__srvrecordtype__portnum__first__bit))
(assert (< rr_type__srv_record_type__srvrecordtype__portnum__first__bit rr_type__srv_record_type__srvrecordtype__portnum__last__bit))
(assert (<= 0 rr_type__srv_record_type__srvrecordtype__portnum__position))
(declare-const rr_type__srv_record_type__srvrecordtype__servername__first__bit Int)
(declare-const rr_type__srv_record_type__srvrecordtype__servername__last__bit Int)
(declare-const rr_type__srv_record_type__srvrecordtype__servername__position Int)
(assert (<= 0 rr_type__srv_record_type__srvrecordtype__servername__first__bit))
(assert (< rr_type__srv_record_type__srvrecordtype__servername__first__bit rr_type__srv_record_type__srvrecordtype__servername__last__bit))
(assert (<= 0 rr_type__srv_record_type__srvrecordtype__servername__position))
...
(declare-datatypes () ((srvrecordtype__ref (mk_srvrecordtype__ref (srvrecordtype__content us_rep1)))))
(define-fun srvrecordtype__ref___projection ((a srvrecordtype__ref)) us_rep1 (srvrecordtype__content a))
(define-fun default_initial_assumption ((temp___expr_1910 us_rep1) (temp___skip_top_level_1911 Bool)) Bool (= (attr__tag1 temp___expr_1910) us_tag1))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const start_byte Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const srv_record us_rep1)
...
(assert (and (and (<= 0 current_name_length) (<= current_name_length 129)) (<= start_byte (- 8168 current_name_length))))
(assert (and (= o1 (+ current_name_length 6)) (uint_in_range1 (+ current_name_length 6))))
...
(assert (and (= o4 (+ start_byte 8)) (in_range2 (+ start_byte 8))))
(assert (not (in_range2 (+ start_byte 10))))
(check-sat)
(exit)
