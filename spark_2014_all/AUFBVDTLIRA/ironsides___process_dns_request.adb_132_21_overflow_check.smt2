...
(assert (and (= o9 (to_rep5 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__keylength (us_split_fields3 dnskey_record)))) (in_range3 (to_rep5 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__keylength (us_split_fields3 dnskey_record))))))
(assert (= o10 (- 8170 o9)))
(assert (= o11 (ite (<= start_byte o10) true false)))
