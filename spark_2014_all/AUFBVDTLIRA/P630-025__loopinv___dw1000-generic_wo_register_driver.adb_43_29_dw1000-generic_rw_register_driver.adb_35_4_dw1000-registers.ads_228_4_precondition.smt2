...
(define-fun dynamic_invariant ((temp___expr_2710 us_t1) (temp___is_init_2706 Bool) (temp___skip_constant_2707 Bool) (temp___do_toplevel_2708 Bool) (temp___do_typ_inv_2709 Bool)) Bool (=> (not (= temp___skip_constant_2707 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2710) (last3 temp___expr_2710)) (and (= (first3 temp___expr_2710) 1) (= (last3 temp___expr_2710) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_2739 us_t2) (temp___is_init_2735 Bool) (temp___skip_constant_2736 Bool) (temp___do_toplevel_2737 Bool) (temp___do_typ_inv_2738 Bool)) Bool (=> (not (= temp___skip_constant_2736 true)) (and (dynamic_property3 1 4 (first5 temp___expr_2739) (last5 temp___expr_2739)) (and (= (first5 temp___expr_2739) 1) (= (last5 temp___expr_2739) 4)))))
...
(declare-const temp___85151 t2)
(declare-const temp___8516 (Array Int bits_8))
(declare-const temp___85161 t1)
...
(define-fun temp___85152 () us_t2 (mk___t2 temp___8515 temp___85151))
...
(assert (and (= temp___85152 (register_to_bytes reg)) (dynamic_invariant1 temp___85152 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___85151)) (to_rep (last4 temp___85151))) (+ (- (to_rep (last4 temp___85151)) (to_rep (first4 temp___85151))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8515 temp___8516))
(assert (= (mk1 (to_rep (first4 temp___85151)) (to_rep (last4 temp___85151))) temp___85161))
(assert (= (ite (<= (to_rep (first2 temp___85161)) (to_rep (last2 temp___85161))) (+ (- (to_rep (last2 temp___85161)) (to_rep (first2 temp___85161))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8516 temp___85161)))
(assert (= o2 o))
