...
(define-fun dynamic_invariant ((temp___expr_7598 us_t1) (temp___is_init_7594 Bool) (temp___skip_constant_7595 Bool) (temp___do_toplevel_7596 Bool) (temp___do_typ_inv_7597 Bool)) Bool (=> (not (= temp___skip_constant_7595 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7598) (last3 temp___expr_7598)) (and (= (first3 temp___expr_7598) 1) (= (last3 temp___expr_7598) 2)))))
