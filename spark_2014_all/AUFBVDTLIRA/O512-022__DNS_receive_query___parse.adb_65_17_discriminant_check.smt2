...
(assert (= (to_rep2 o33) 1))
(assert (= o34 (mk___split_discrs o33)))
(assert (= temp___335 (mk___rep2 o34 (mk___split_fields2 dummy6) true)))
(assert (= result____attr__constrained true))
(assert (not (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___335)) (rec__parse__parse_result_t__return_code result____split_discrs6))))
(check-sat)
(exit)
