...
(assert (and (= (to_rep (select memory1 addr)) ((_ extract 7 0) (bvand val__ ((_ int2bv 32) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i addr)) (= (to_rep (select memory1 i)) (to_rep (select memory i))))))))
(assert (and (= (to_rep (select memory2 (bvadd addr ((_ int2bv 64) 1)))) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 8)) ((_ int2bv 32) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 1)))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))
(assert (and (= (to_rep (select memory3 (bvadd addr ((_ int2bv 64) 2)))) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 16)) ((_ int2bv 32) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 2)))) (= (to_rep (select memory3 i)) (to_rep (select memory2 i))))))))
(assert (not (bvule ((_ zero_extend 24) ((_ int2bv 8) 0)) (bvand (bvlshr val__ ((_ int2bv 32) 24)) ((_ int2bv 32) 255)))))
(check-sat)
(exit)
