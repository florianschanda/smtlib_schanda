...
(assert (= o19 o17))
(assert (= o20 o18))
(assert (= temp___1208 (mk___rep result____split_discrs (mk___split_fields (mk___t o19 o20)))))
(assert (= result7 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1208)))
(assert (= result____split_discrs (us_split_discrs1 temp___1208)))
