...
(declare-fun temp___1288 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1290 (_ BitVec 8))) (forall ((temp___1291 Int) (temp___1292 Int)) (let ((temp___1289 (temp___1288 temp___1290 temp___1291 temp___1292))) (=> (dynamic_invariant1 temp___1290 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1291 temp___1292) (and (= (first5 temp___1289) temp___1291) (= (last5 temp___1289) temp___1292))) (forall ((temp___1293 Int)) (= (to_rep1 (select (to_array2 temp___1289) temp___1293)) temp___1290))))))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1288 #x00 1 r124b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1288 #x00 1 r124b)))) r124b))
(assert (= (mk___t2 temp___1295 temp___12951) (temp___1288 #x00 1 r124b)))
(assert (= (ite (<= (to_rep2 (first4 temp___12951)) (to_rep2 (last4 temp___12951))) (+ (- (to_rep2 (last4 temp___12951)) (to_rep2 (first4 temp___12951))) 1) 0) (ite (<= 1 r124b) (+ (- r124b 1) 1) 0)))
(assert (= temp___1295 temp___1296))
(assert (= (mk1 (to_rep2 (first4 temp___12951)) (to_rep2 (last4 temp___12951))) temp___12961))
(assert (= (ite (<= (to_rep2 (first2 temp___12961)) (to_rep2 (last2 temp___12961))) (+ (- (to_rep2 (last2 temp___12961)) (to_rep2 (first2 temp___12961))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1298 temp___12981) (mk___t1 temp___1296 temp___12961)))
(assert (= temp___1298 o))
(assert (= (mk (to_rep2 (first2 temp___12981)) (to_rep2 (last2 temp___12981))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (and (and (dynamic_invariant2 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1313 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1313) (<= temp___1313 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1313) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1313) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1313)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
