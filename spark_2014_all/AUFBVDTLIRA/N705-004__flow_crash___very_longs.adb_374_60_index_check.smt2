...
(define-fun dynamic_invariant1 ((temp___expr_206 (_ BitVec 8)) (temp___is_init_203 Bool) (temp___skip_constant_204 Bool) (temp___do_toplevel_205 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_217 us_rep) (temp___is_init_214 Bool) (temp___skip_constant_215 Bool) (temp___do_toplevel_216 Bool)) Bool (let ((temp___218 (rec__very_longs__very_long__octet_length (us_split_discrs1 temp___expr_217)))) (and (dynamic_property1 1 (to_rep temp___218) (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217))) (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217)))) (and (= (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217))) 1) (= (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_217))) (to_rep temp___218))))))
...
(define-fun dynamic_invariant4 ((temp___expr_698 Int) (temp___is_init_695 Bool) (temp___skip_constant_696 Bool) (temp___do_toplevel_697 Bool)) Bool (=> (or (= temp___is_init_695 true) (<= 0 7)) (in_range4 temp___expr_698)))
...
(declare-fun temp___1217 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___1219 (_ BitVec 8))) (forall ((temp___1220 Int) (temp___1221 Int)) (let ((temp___1218 (temp___1217 temp___1219 temp___1220 temp___1221))) (and (=> (dynamic_property6 1 2147483647 temp___1220 temp___1221) (and (= (first5 temp___1218) temp___1220) (= (last5 temp___1218) temp___1221))) (forall ((temp___1222 Int)) (= (select (to_array2 temp___1218) temp___1222) (of_rep1 temp___1219))))))))
(define-fun dynamic_invariant5 ((temp___expr_756 us_t1) (temp___is_init_753 Bool) (temp___skip_constant_754 Bool) (temp___do_toplevel_755 Bool)) Bool (=> (not (= temp___skip_constant_754 true)) (and (dynamic_property3 1 r124b (first3 temp___expr_756) (last3 temp___expr_756)) (and (= (first3 temp___expr_756) 1) (= (last3 temp___expr_756) r124b)))))
...
(declare-const temp___1224 (Array Int octet))
(declare-const temp___12241 t2)
(declare-const temp___1225 (Array Int octet))
(declare-const temp___12251 t1)
(declare-const temp___1227 (Array Int octet))
(declare-const temp___12271 t1)
(declare-const o1 (Array Int octet))
(declare-const o2 t)
(declare-const o3 (Array Int octet))
(declare-const o4 t)
(declare-const temp___1229 digit_index_type)
(declare-const temp___12291 (Array Int octet))
(declare-const temp___12292 t)
(declare-const o5 (_ BitVec 8))
(declare-const temp___1243 (_ BitVec 8))
(declare-const temp___1240 digit_index_type)
(declare-const temp___12401 (Array Int octet))
(declare-const temp___12402 t)
(declare-const temp___1239 (_ BitVec 8))
...
(declare-const temp___1234 us_rep)
...
(declare-const temp___1238 us_rep)
...
(assert (= (to_rep2 (first4 (rt2 (temp___1217 ((_ int2bv 8) 0) 1 r124b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1217 ((_ int2bv 8) 0) 1 r124b)))) r124b))
(assert (= (mk___t2 temp___1224 temp___12241) (temp___1217 ((_ int2bv 8) 0) 1 r124b)))
(assert (= (ite (<= (to_rep2 (first4 temp___12241)) (to_rep2 (last4 temp___12241))) (+ (- (to_rep2 (last4 temp___12241)) (to_rep2 (first4 temp___12241))) 1) 0) (ite (<= 1 r124b) (+ (- r124b 1) 1) 0)))
(assert (= temp___1224 temp___1225))
(assert (= (mk1 (to_rep2 (first4 temp___12241)) (to_rep2 (last4 temp___12241))) temp___12251))
(assert (= (ite (<= (to_rep2 (first2 temp___12251)) (to_rep2 (last2 temp___12251))) (+ (- (to_rep2 (last2 temp___12251)) (to_rep2 (first2 temp___12251))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1227 temp___12271) (mk___t1 temp___1225 temp___12251)))
(assert (= temp___1227 o1))
(assert (= (mk (to_rep2 (first2 temp___12271)) (to_rep2 (last2 temp___12271))) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= result____split_discrs (mk___split_discrs temp___1229)))
(assert (= temp___12291 o3))
(assert (= temp___12292 o4))
(assert (= result1 (mk___split_fields__ref (mk___split_fields (mk___t result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___12291 temp___12292))))
(assert (= result____split_discrs (mk___split_discrs temp___1229)))
(assert (=> (< (- 8 distance) 8) (= o5 (bvshl ((_ int2bv 8) 255) ((_ int2bv 8) (- 8 distance))))))
(assert (=> (not (< (- 8 distance) 8)) (= o5 ((_ int2bv 8) 0))))
(assert (= result2 (mk_t__ref overflow_mask)))
(assert (= overflow_mask1 o5))
(assert (= result3 (mk_int__ref i)))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))
(assert (and (and (dynamic_invariant2 (mk___rep result____split_discrs result____split_fields3) false true true) (forall ((temp___1242 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1242) (<= temp___1242 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1242) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1242) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1242)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
(assert (not (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i2)))
(check-sat)
(exit)
