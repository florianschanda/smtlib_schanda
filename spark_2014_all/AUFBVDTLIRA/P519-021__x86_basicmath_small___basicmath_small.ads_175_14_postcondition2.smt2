...
(declare-const temp___611 (_ BitVec 64))
(declare-const temp___610 (_ BitVec 64))
(declare-const temp___609 (Array (_ BitVec 64) unsigned8))
(declare-const temp___608 (_ BitVec 64))
(declare-const temp___607 (_ BitVec 64))
(declare-const temp___606 (_ BitVec 64))
(declare-const temp___612 (_ BitVec 64))
(declare-const temp___605 (_ BitVec 64))
(declare-const temp___604 (_ BitVec 64))
(declare-const temp___603 Bool)
(declare-const temp___613 (Array (_ BitVec 64) unsigned8))
...
(assert (= temp___611 rbx))
(assert (= temp___610 rsp))
(assert (= temp___609 memory))
(assert (= temp___608 xmm2))
(assert (= temp___607 xmm1))
(assert (= temp___606 rax))
(assert (= temp___612 rsp))
(assert (= temp___605 xmm0))
(assert (= temp___604 rdi))
(assert (= temp___603 zeroflag))
(assert (= temp___613 memory))
(assert (= rsp1 temp___612))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (and (and (and (and (and (and (and (not (= i rsp1)) (not (= i (bvadd rsp1 #x0000000000000001)))) (not (= i (bvadd rsp1 #x0000000000000002)))) (not (= i (bvadd rsp1 #x0000000000000003)))) (not (= i (bvadd rsp1 #x0000000000000004)))) (not (= i (bvadd rsp1 #x0000000000000005)))) (not (= i (bvadd rsp1 #x0000000000000006)))) (not (= i (bvadd rsp1 #x0000000000000007)))) (= (to_rep (select memory1 i)) (to_rep (select temp___613 i)))))))
(assert (and (= o (readmem64 #x00000000004011D8 memory1)) (and (and (and (and (and (and (and (= (bvand o #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory1 #x00000000004011D8)))) (= (bvand o #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x00000000004011D8 #x0000000000000001)))) #x0000000000000100))) (= (bvand o #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x00000000004011D8 #x0000000000000002)))) #x0000000000010000))) (= (bvand o #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x00000000004011D8 #x0000000000000003)))) #x0000000001000000))) (= (bvand o #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x00000000004011D8 #x0000000000000004)))) #x0000000100000000))) (= (bvand o #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x00000000004011D8 #x0000000000000005)))) #x0000010000000000))) (= (bvand o #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x00000000004011D8 #x0000000000000006)))) #x0001000000000000))) (= (bvand o #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x00000000004011D8 #x0000000000000007)))) #x0100000000000000)))))
(assert (= xmm11 result))
(assert (= xmm12 o))
(assert (= xmm01 result1))
(assert (= xmm02 xmm21))
(assert (= (writereg32post rdi1 #x00401100) true))
(assert (= (writereg32post rax1 #x00000002) true))
(assert (and (and (and (and (and (and (and (and (= (bvand xmm21 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory2 rsp1)))) (= (bvand xmm21 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp1 #x0000000000000001)))) #x0000000000000100))) (= (bvand xmm21 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp1 #x0000000000000002)))) #x0000000000010000))) (= (bvand xmm21 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp1 #x0000000000000003)))) #x0000000001000000))) (= (bvand xmm21 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp1 #x0000000000000004)))) #x0000000100000000))) (= (bvand xmm21 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp1 #x0000000000000005)))) #x0000010000000000))) (= (bvand xmm21 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp1 #x0000000000000006)))) #x0001000000000000))) (= (bvand xmm21 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp1 #x0000000000000007)))) #x0100000000000000))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (and (and (and (and (and (and (and (not (= i rsp1)) (not (= i (bvadd rsp1 #x0000000000000001)))) (not (= i (bvadd rsp1 #x0000000000000002)))) (not (= i (bvadd rsp1 #x0000000000000003)))) (not (= i (bvadd rsp1 #x0000000000000004)))) (not (= i (bvadd rsp1 #x0000000000000005)))) (not (= i (bvadd rsp1 #x0000000000000006)))) (not (= i (bvadd rsp1 #x0000000000000007)))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))
(assert (= xmm12 result2))
(assert (= xmm13 (bvmul xmm12 xmm21)))
(assert (and (= o1 (readmem64 #x00000000004011D0 memory2)) (and (and (and (and (and (and (and (= (bvand o1 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory2 #x00000000004011D0)))) (= (bvand o1 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011D0 #x0000000000000001)))) #x0000000000000100))) (= (bvand o1 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011D0 #x0000000000000002)))) #x0000000000010000))) (= (bvand o1 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011D0 #x0000000000000003)))) #x0000000001000000))) (= (bvand o1 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011D0 #x0000000000000004)))) #x0000000100000000))) (= (bvand o1 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011D0 #x0000000000000005)))) #x0000010000000000))) (= (bvand o1 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011D0 #x0000000000000006)))) #x0001000000000000))) (= (bvand o1 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011D0 #x0000000000000007)))) #x0100000000000000)))))
...
(assert (= zeroflag2 o7))
(assert (and (= o8 (readmem64 #x00000000004011E0 memory2)) (and (and (and (and (and (and (and (= (bvand o8 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory2 #x00000000004011E0)))) (= (bvand o8 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011E0 #x0000000000000001)))) #x0000000000000100))) (= (bvand o8 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011E0 #x0000000000000002)))) #x0000000000010000))) (= (bvand o8 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011E0 #x0000000000000003)))) #x0000000001000000))) (= (bvand o8 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011E0 #x0000000000000004)))) #x0000000100000000))) (= (bvand o8 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011E0 #x0000000000000005)))) #x0000010000000000))) (= (bvand o8 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011E0 #x0000000000000006)))) #x0001000000000000))) (= (bvand o8 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd #x00000000004011E0 #x0000000000000007)))) #x0100000000000000)))))
...
(assert (not (= i (bvadd (t__content2 rsp8) #x0000000000000001))))
(assert (not (= i (bvadd (t__content2 rsp8) #x0000000000000002))))
(assert (not (= i (bvadd (t__content2 rsp8) #x0000000000000003))))
(assert (not (= i (bvadd (t__content2 rsp8) #x0000000000000004))))
(assert (not (= i (bvadd (t__content2 rsp8) #x0000000000000005))))
(assert (not (= i (bvadd (t__content2 rsp8) #x0000000000000006))))
(assert (not (= i (bvadd (t__content2 rsp8) #x0000000000000007))))
