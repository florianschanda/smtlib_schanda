...
(define-fun dynamic_invariant1 ((temp___expr_179 (_ BitVec 32)) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool)) Bool true)
...
(define-fun dynamic_invariant3 ((temp___expr_251 (_ BitVec 32)) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool true)
(declare-fun c (Int) (_ BitVec 32))
(declare-fun c__function_guard ((_ BitVec 32) Int) Bool)
(assert (forall ((s Int)) (! (=> (dynamic_invariant2 s true true true) (dynamic_invariant3 (c s) true false true)) :pattern ((c s)))))
