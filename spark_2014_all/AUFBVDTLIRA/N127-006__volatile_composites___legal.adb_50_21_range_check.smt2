...
(define-fun dynamic_invariant1 ((temp___expr_290 (_ BitVec 32)) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool) (temp___do_typ_inv_289 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_283 Int) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool) (temp___do_typ_inv_282 Bool)) Bool (=> (or (= temp___is_init_279 true) (<= (- 2147483648) 2147483647)) (in_range1 temp___expr_283)))
(declare-fun c (Int) (_ BitVec 32))
(declare-fun c__function_guard ((_ BitVec 32) Int) Bool)
(assert (forall ((s Int)) (! (=> (dynamic_invariant2 s true true true true) (dynamic_invariant1 (c s) true false true true)) :pattern ((c s)))))
