...
(assert (= i1 r75b))
(assert (=> (and (<= r75b i1) (<= i1 r76b)) (= temp___1737 i1)))
(assert (=> (and (<= r75b i1) (<= i1 r76b)) (= temp___1736 tmpval1)))
(assert (=> (and (<= r75b i1) (<= i1 r76b)) (= temp___1735 digitval)))
...
(assert (not (in_range4 (+ (- endidx9 begidx13) 1))))
(check-sat)
(exit)
