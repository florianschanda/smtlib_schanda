...
(assert (= length14 o40))
(assert (and (= o46 (length buffer)) (in_range1 (length buffer))))
...
(assert (= result12 (ite (not (= o48 true)) true false)))
(assert (not (= result12 true)))
(assert (= ethernet_dissector__match__result4 ethernet_dissector__match__result3))
(assert (not (= (length (mk___t length14 (mk 1 2))) 2)))
(check-sat)
(exit)
