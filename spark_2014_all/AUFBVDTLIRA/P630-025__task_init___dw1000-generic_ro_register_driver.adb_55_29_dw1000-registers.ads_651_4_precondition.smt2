...
(define-fun dynamic_invariant ((temp___expr_7206 us_t1) (temp___is_init_7203 Bool) (temp___skip_constant_7204 Bool) (temp___do_toplevel_7205 Bool)) Bool (=> (not (= temp___skip_constant_7204 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7206) (last3 temp___expr_7206)) (and (= (first3 temp___expr_7206) 1) (= (last3 temp___expr_7206) 2)))))
