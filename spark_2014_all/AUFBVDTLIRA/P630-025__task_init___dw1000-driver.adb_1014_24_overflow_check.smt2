...
(assert (forall ((temp___3377 (_ BitVec 8))) (forall ((temp___3378 Int) (temp___3379 Int)) (let ((temp___3376 (temp___3375 temp___3377 temp___3378 temp___3379))) (and (=> (dynamic_property 0 2147483647 temp___3378 temp___3379) (and (= (first3 temp___3376) temp___3378) (= (last3 temp___3376) temp___3379))) (forall ((temp___3380 Int)) (= (select (to_array1 temp___3376) temp___3380) (of_rep3 temp___3377))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_316 (_ BitVec 8)) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool)) Bool true)
...
(assert (= (to_rep (first2 (rt1 (temp___3375 ((_ int2bv 8) 0) (to_rep data__first) (to_rep data__last))))) (to_rep data__first)))
(assert (= (to_rep (last2 (rt1 (temp___3375 ((_ int2bv 8) 0) (to_rep data__first) (to_rep data__last))))) (to_rep data__last)))
(assert (= (mk___t1 temp___3382 temp___33821) (temp___3375 ((_ int2bv 8) 0) (to_rep data__first) (to_rep data__last))))
(assert (= temp___3382 temp___3383))
(assert (= (mk (to_rep (first2 temp___33821)) (to_rep (last2 temp___33821))) temp___33831))
(assert (= (ite (<= (to_rep (first temp___33831)) (to_rep (last temp___33831))) (+ (- (to_rep (last temp___33831)) (to_rep (first temp___33831))) 1) 0) (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0)))
(assert (= (mk___t temp___3384 temp___33841) (mk___t temp___3383 temp___33831)))
(assert (= o (slide temp___3384 (to_rep (first temp___33841)) (to_rep data__first))))
(assert (= result data))
(assert (= data1 o))
...
(assert (and (<= 0 i2) (<= i2 (- (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0) 1))))
(assert (and (= temp___3385 (+ a_first i2)) (in_range1 (+ a_first i2))))
(assert (and (<= (to_rep (first (rt addresses))) temp___3385) (<= temp___3385 (to_rep (last (rt addresses))))))
...
(assert (= aon_rdat_reg__split_fields1 (mk___split_fields1 dw1000__registers__aon_rdat__read__reg__fields)))
(assert (= (to_rep3 o43) (to_rep3 (rec__dw1000__register_types__aon_rdat_type__aon_rdat aon_rdat_reg__split_fields1))))
(assert (not (in_range1 (+ d_first i2))))
(check-sat)
(exit)
