...
(declare-fun temp___3713 ((_ BitVec 8) Int Int) us_t1)
...
(declare-const temp___3731 Int)
(declare-const temp___3723 Int)
...
(assert (= (to_rep (first2 (rt1 (temp___3713 #x00 (to_rep data__first) (to_rep data__last))))) (to_rep data__first)))
(assert (= (to_rep (last2 (rt1 (temp___3713 #x00 (to_rep data__first) (to_rep data__last))))) (to_rep data__last)))
(assert (= (mk___t1 temp___3720 temp___37201) (temp___3713 #x00 (to_rep data__first) (to_rep data__last))))
...
(assert (= temp___3731 (- o2 1)))
(assert (= result1 i))
(assert (= i1 0))
(assert (<= 0 i1))
(assert (<= i1 temp___3731))
(assert (and (<= 0 i2) (<= i2 (- (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0) 1))))
(assert (and (= temp___3723 (+ a_first i2)) (in_range1 (+ a_first i2))))
(assert (and (<= (to_rep (first (rt addresses))) temp___3723) (<= temp___3723 (to_rep (last (rt addresses))))))
(assert (= o3 temp___3723))
(assert (= o4 (select (elts addresses) o3)))
(assert (= o4 o5))
(assert (= o6 o5))
(assert (= (to_rep2 o7) #x00))
(assert (= (to_rep1 o8) #x01))
(assert (= (to_rep1 o9) #x00))
(assert (= (to_rep1 o10) #x00))
(assert (= (to_rep1 o11) #x00))
(assert (= (to_rep1 o12) #x00))
(assert (= o12 o13))
(assert (= o11 o14))
(assert (= o10 o15))
(assert (= o9 o16))
...
(assert (= o23 o17))
(assert (= o24 o18))
(assert (= (to_rep2 o25) #x00))
(assert (= (to_rep1 o26) #x01))
(assert (= (to_rep1 o27) #x01))
(assert (= (to_rep1 o28) #x00))
(assert (= (to_rep1 o29) #x00))
(assert (= (to_rep1 o30) #x00))
(assert (= o30 o31))
(assert (= o29 o32))
(assert (= o28 o33))
(assert (= o27 o34))
