...
(define-fun register_type__ref___186__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___130__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___130__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_7118 us_t1) (temp___is_init_7114 Bool) (temp___skip_constant_7115 Bool) (temp___do_toplevel_7116 Bool) (temp___do_typ_inv_7117 Bool)) Bool (=> (not (= temp___skip_constant_7115 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7118) (last3 temp___expr_7118)) (and (= (first3 temp___expr_7118) 1) (= (last3 temp___expr_7118) 2)))))
