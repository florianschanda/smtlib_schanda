...
(define-fun dynamic_invariant ((temp___expr_6473 us_t1) (temp___is_init_6470 Bool) (temp___skip_constant_6471 Bool) (temp___do_toplevel_6472 Bool)) Bool (=> (not (= temp___skip_constant_6471 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6473) (last3 temp___expr_6473)) (and (= (first3 temp___expr_6473) 1) (= (last3 temp___expr_6473) 2)))))
