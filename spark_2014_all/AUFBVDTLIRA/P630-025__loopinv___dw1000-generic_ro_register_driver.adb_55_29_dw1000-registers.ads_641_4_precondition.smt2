...
(define-fun dynamic_invariant ((temp___expr_7172 us_t1) (temp___is_init_7169 Bool) (temp___skip_constant_7170 Bool) (temp___do_toplevel_7171 Bool)) Bool (=> (not (= temp___skip_constant_7170 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7172) (last3 temp___expr_7172)) (and (= (first3 temp___expr_7172) 1) (= (last3 temp___expr_7172) 2)))))
