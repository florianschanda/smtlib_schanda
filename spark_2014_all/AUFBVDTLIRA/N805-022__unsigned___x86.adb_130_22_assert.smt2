...
(assert (= memory4 o7))
(assert (not (= (bvadd ((_ zero_extend 24) (to_rep (select memory4 addr))) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr ((_ int2bv 64) 1))))) ((_ int2bv 32) 256))) (bvurem val__ ((_ int2bv 32) 65536)))))
(check-sat)
(exit)
