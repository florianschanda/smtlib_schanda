...
(assert (= memory4 o7))
(assert (not (= (bvadd ((_ zero_extend 24) (to_rep (select memory4 addr))) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000001)))) #x00000100)) (bvurem val__ #x00010000))))
(check-sat)
(exit)
