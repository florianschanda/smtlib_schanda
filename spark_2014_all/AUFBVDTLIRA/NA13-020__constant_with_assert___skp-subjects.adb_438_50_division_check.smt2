...
(assert (forall ((subject1 Int)) (=> (and (<= 5 subject1) (<= subject1 5)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject1)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (<= 6 subject))
(assert (<= subject 6))
