...
(assert (=> (= result1 true) (and (= o1 (get (model__ m) e)) (and (in_range6 o1) (= o1 (get (model__ m) e))))))
(assert (=> (= result1 true) (= o2 (ite (<= o1 (to_rep1 (last (rt a)))) true false))))
(assert (=> (= result1 true) (and (= o (get (model__ m) e)) (and (in_range6 o) (= o (get (model__ m) e))))))
(assert (=> (= result1 true) (= o3 (ite (<= (to_rep1 (first (rt a))) o) true false))))
