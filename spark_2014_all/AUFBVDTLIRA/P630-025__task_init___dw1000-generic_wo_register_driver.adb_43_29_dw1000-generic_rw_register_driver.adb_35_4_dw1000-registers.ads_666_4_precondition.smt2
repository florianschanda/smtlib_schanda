...
(define-fun dynamic_invariant ((temp___expr_7463 us_t1) (temp___is_init_7460 Bool) (temp___skip_constant_7461 Bool) (temp___do_toplevel_7462 Bool)) Bool (=> (not (= temp___skip_constant_7461 true)) (and (dynamic_property2 1 4 (first3 temp___expr_7463) (last3 temp___expr_7463)) (and (= (first3 temp___expr_7463) 1) (= (last3 temp___expr_7463) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_7491 us_t2) (temp___is_init_7488 Bool) (temp___skip_constant_7489 Bool) (temp___do_toplevel_7490 Bool)) Bool (=> (not (= temp___skip_constant_7489 true)) (and (dynamic_property3 1 4 (first5 temp___expr_7491) (last5 temp___expr_7491)) (and (= (first5 temp___expr_7491) 1) (= (last5 temp___expr_7491) 4)))))
...
(assert (and (= (mk___t2 temp___8227 temp___82271) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8227 temp___82271) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___82271)) (to_rep (last4 temp___82271))) (+ (- (to_rep (last4 temp___82271)) (to_rep (first4 temp___82271))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8227 temp___8228))
(assert (= (mk1 (to_rep (first4 temp___82271)) (to_rep (last4 temp___82271))) temp___82281))
(assert (= (ite (<= (to_rep (first2 temp___82281)) (to_rep (last2 temp___82281))) (+ (- (to_rep (last2 temp___82281)) (to_rep (first2 temp___82281))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
