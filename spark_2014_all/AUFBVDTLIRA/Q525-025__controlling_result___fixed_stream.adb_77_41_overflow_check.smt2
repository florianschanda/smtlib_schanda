...
(define-fun to_int3 ((x stream_element)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x stream_element)) (! (uint_in_range (to_int3 x)) :pattern ((to_int3 x)))))
...
(define-fun default_initial_assumption ((temp___expr_176 us_rep) (temp___skip_top_level_177 Bool)) Bool (and (= (attr__tag temp___expr_176) us_tag) (and (= (to_rep2 (rec__fixed_stream__object__width (us_split_fields1 temp___expr_176))) 0) (= (rec__fixed_stream__object__name (us_split_fields1 temp___expr_176)) (temp___178 0)))))
...
(assert (forall ((this us_rep)) (! (dynamic_invariant1 (elements this) true false true) :pattern ((elements this)))))
(assert (forall ((attr__tag1 Int)) (forall ((this us_rep)) (! (dynamic_invariant1 (elements1 attr__tag1 this) true false true) :pattern ((elements1 attr__tag1 this))))))
...
(define-fun dynamic_invariant3 ((temp___expr_160 us_t1) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool (=> (not (= temp___skip_constant_158 true)) (dynamic_property1 (- 9223372036854775808) 9223372036854775807 (first3 temp___expr_160) (last3 temp___expr_160))))
...
(assert (forall ((this us_rep)) (! (let ((result (null_string this))) (and (= (length1 result) (elements this)) (dynamic_invariant3 result true false true))) :pattern ((null_string this)))))
...
(define-fun dynamic_invariant6 ((temp___expr_142 (_ BitVec 8)) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool true)
(define-fun dynamic_invariant7 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range6 temp___expr_148)))
...
(declare-const temp___277 (Array Int stream_element))
...
(assert (and (= (mk___t1 fixed_stream__convert__out_stream__assume fixed_stream__convert__out_stream__assume1) (null_string this)) (and (dynamic_invariant3 (mk___t1 fixed_stream__convert__out_stream__assume fixed_stream__convert__out_stream__assume1) true false true) (= (length1 (mk___t1 fixed_stream__convert__out_stream__assume fixed_stream__convert__out_stream__assume1)) (elements this)))))
...
(assert (and (= temp___274 (+ (to_rep1 (first (rt in_string))) i2)) (in_range1 (+ (to_rep1 (first (rt in_string))) i2))))
(assert (and (<= (to_rep1 (first (rt in_string))) temp___274) (<= temp___274 (to_rep1 (last (rt in_string))))))
(assert (= o3 temp___274))
(assert (= o4 (select (elts in_string) o3)))
(assert (= o5 (to_rep o4)))
(assert (and (= o6 o5) (uint_in_range o5)))
(assert (= o7 ((_ int2bv 8) o6)))
(assert (= (to_rep3 o8) o7))
(assert (not (in_range5 (+ (to_rep4 out_stream__first) i2))))
(check-sat)
(exit)
