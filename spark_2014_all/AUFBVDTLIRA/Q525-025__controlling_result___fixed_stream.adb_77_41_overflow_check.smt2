...
(assert (and (= fixed_stream__convert__out_stream__assume2 (null_string this)) (and (dynamic_invariant3 fixed_stream__convert__out_stream__assume2 true false true) (= (length1 fixed_stream__convert__out_stream__assume2) (elements this)))))
