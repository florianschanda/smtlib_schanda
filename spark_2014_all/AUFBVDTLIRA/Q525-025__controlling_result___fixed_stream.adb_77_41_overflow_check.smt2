...
(assert (and (= temp___298 (+ (to_rep1 (first (rt in_string))) i2)) (in_range1 (+ (to_rep1 (first (rt in_string))) i2))))
(assert (and (<= (to_rep1 (first (rt in_string))) temp___298) (<= temp___298 (to_rep1 (last (rt in_string))))))
(assert (= o3 temp___298))
