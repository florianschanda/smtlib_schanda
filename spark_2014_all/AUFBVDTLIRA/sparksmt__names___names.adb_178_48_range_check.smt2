...
(assert (<= 1 i1))
(assert (<= i1 l))
(assert (and (= o1 (+ (to_rep6 (rec__names__data__name_entry__table_index (us_split_fields5 e))) (- i1 1))) (in_range9 (+ (to_rep6 (rec__names__data__name_entry__table_index (us_split_fields5 e))) (- i1 1)))))
