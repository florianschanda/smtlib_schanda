...
(assert (and (= (oeq (osubtract (num_of_big_int (mk___t a (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (num_of_big_int b b_first (- (+ i2 1) a_first))) (osubtract (num_of_big_int (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (omultiply (oexpon (base Tuple0) (- (+ i2 1) a_first)) (num_of_boolean carry3)))) true) (forall ((k2 Int)) (=> (and (<= (+ i2 1) k2) (<= k2 a_last)) (= (to_rep1 (select a3 k2)) (to_rep1 (select a k2)))))))
(assert (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)))
(assert (not (= i2 a_last)))
(assert (= result8 i2))
(assert (= i3 (+ i2 1)))
(assert (not (= (oeq (osubtract (num_of_big_int (mk___t a (mk (to_rep a__first) (to_rep a__last))) a_first (- i3 a_first)) (num_of_big_int b b_first (- i3 a_first))) (osubtract (num_of_big_int (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) a_first (- i3 a_first)) (omultiply (oexpon (base Tuple0) (- i3 a_first)) (num_of_boolean carry3)))) true)))
(check-sat)
(exit)
