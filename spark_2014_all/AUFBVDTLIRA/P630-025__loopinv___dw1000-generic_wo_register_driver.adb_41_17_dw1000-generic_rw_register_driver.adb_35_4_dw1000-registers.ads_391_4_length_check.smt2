...
(define-fun tregister_byte_arrayP1__ref___77__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___32__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__drx_tune1a_type__drx_tune1a bits_16)))))
(define-fun us_split_fields_DRX_TUNE1a__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__drx_tune1a_type__drx_tune1a a))
...
(define-fun us_rep___47__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__drx_tune1a_type__drx_tune1a (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__drx_tune1a_type__drx_tune1a (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__drx_tune1a_type__drx_tune1a__first__bit Int)
(declare-const dw1000__register_types__drx_tune1a_type__drx_tune1a__last__bit Int)
(declare-const dw1000__register_types__drx_tune1a_type__drx_tune1a__position Int)
(assert (<= 0 dw1000__register_types__drx_tune1a_type__drx_tune1a__first__bit))
(assert (< dw1000__register_types__drx_tune1a_type__drx_tune1a__first__bit dw1000__register_types__drx_tune1a_type__drx_tune1a__last__bit))
(assert (<= 0 dw1000__register_types__drx_tune1a_type__drx_tune1a__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((drx_tune1a_type__ref (mk_drx_tune1a_type__ref (drx_tune1a_type__content us_rep)))))
(define-fun drx_tune1a_type__ref___projection ((a drx_tune1a_type__ref)) us_rep (drx_tune1a_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___32__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_5307 us_t1) (temp___is_init_5303 Bool) (temp___skip_constant_5304 Bool) (temp___do_toplevel_5305 Bool) (temp___do_typ_inv_5306 Bool)) Bool (=> (not (= temp___skip_constant_5304 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5307) (last3 temp___expr_5307)) (and (= (first3 temp___expr_5307) 1) (= (last3 temp___expr_5307) 2)))))
...
(define-fun register_type__ref___108__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___77__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_5289 us_t2) (temp___is_init_5285 Bool) (temp___skip_constant_5286 Bool) (temp___do_toplevel_5287 Bool) (temp___do_typ_inv_5288 Bool)) Bool (=> (not (= temp___skip_constant_5286 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5289) (last5 temp___expr_5289)) (and (= (first5 temp___expr_5289) 1) (= (last5 temp___expr_5289) 2)))))
...
(declare-const temp___8714 (Array Int bits_8))
(declare-const temp___87141 t1)
(declare-const temp___8715 (Array Int bits_8))
(declare-const temp___87151 t2)
(define-fun temp___87142 () us_t1 (mk___t1 temp___8714 temp___87141))
...
(assert (and (= temp___87142 (register_to_bytes reg)) (dynamic_invariant temp___87142 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___87141)) (to_rep (last2 temp___87141))) (+ (- (to_rep (last2 temp___87141)) (to_rep (first2 temp___87141))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8714 temp___8715))
(assert (= (mk2 (to_rep (first2 temp___87141)) (to_rep (last2 temp___87141))) temp___87151))
(assert (not (= (ite (<= (to_rep (first4 temp___87151)) (to_rep (last4 temp___87151))) (+ (- (to_rep (last4 temp___87151)) (to_rep (first4 temp___87151))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
