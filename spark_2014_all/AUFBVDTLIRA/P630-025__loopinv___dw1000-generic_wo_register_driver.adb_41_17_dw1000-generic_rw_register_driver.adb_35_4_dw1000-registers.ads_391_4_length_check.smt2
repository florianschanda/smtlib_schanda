...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__drx_tune1a_type__drx_tune1a (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__drx_tune1a_type__drx_tune1a (us_split_fields1 b)))) true false))
...
(define-fun register_byte_array__ref___77__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_4825 us_t1) (temp___is_init_4822 Bool) (temp___skip_constant_4823 Bool) (temp___do_toplevel_4824 Bool)) Bool (=> (not (= temp___skip_constant_4823 true)) (and (dynamic_property2 1 2 (first3 temp___expr_4825) (last3 temp___expr_4825)) (and (= (first3 temp___expr_4825) 1) (= (last3 temp___expr_4825) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___32__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_4841 us_t2) (temp___is_init_4838 Bool) (temp___skip_constant_4839 Bool) (temp___do_toplevel_4840 Bool)) Bool (=> (not (= temp___skip_constant_4839 true)) (and (dynamic_property3 1 2 (first5 temp___expr_4841) (last5 temp___expr_4841)) (and (= (first5 temp___expr_4841) 1) (= (last5 temp___expr_4841) 2)))))
...
(declare-const temp___7942 (Array Int bits_8))
(declare-const temp___79421 t2)
(declare-const temp___7943 (Array Int bits_8))
(declare-const temp___79431 t1)
(define-fun temp___79422 () us_t2 (mk___t2 temp___7942 temp___79421))
...
(assert (and (= temp___79422 (register_to_bytes reg)) (dynamic_invariant1 temp___79422 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___79421)) (to_rep (last4 temp___79421))) (+ (- (to_rep (last4 temp___79421)) (to_rep (first4 temp___79421))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___7942 temp___7943))
(assert (= (mk1 (to_rep (first4 temp___79421)) (to_rep (last4 temp___79421))) temp___79431))
(assert (not (= (ite (<= (to_rep (first2 temp___79431)) (to_rep (last2 temp___79431))) (+ (- (to_rep (last2 temp___79431)) (to_rep (first2 temp___79431))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
