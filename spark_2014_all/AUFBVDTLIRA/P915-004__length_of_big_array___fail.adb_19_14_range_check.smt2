...
(declare-fun concat2 ((Array (_ BitVec 64) Bool) (_ BitVec 64) (_ BitVec 64) (Array (_ BitVec 64) Bool) (_ BitVec 64) (_ BitVec 64)) (Array (_ BitVec 64) Bool))
(assert (forall ((a (Array (_ BitVec 64) Bool)) (b (Array (_ BitVec 64) Bool))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (forall ((i (_ BitVec 64))) (! (and (=> (and (bvule a_first i) (bvule i a_last)) (= (select (concat2 a a_first a_last b b_first b_last) i) (select a i))) (=> (bvugt i a_last) (= (select (concat2 a a_first a_last b b_first b_last) i) (select b (bvadd (bvsub i a_last) (bvsub b_first #x0000000000000001)))))) :pattern ((select (concat2 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton2 (Bool (_ BitVec 64)) (Array (_ BitVec 64) Bool))
(assert (forall ((v Bool)) (forall ((i (_ BitVec 64))) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
(define-fun bool_eq2 ((a (Array (_ BitVec 64) Bool)) (a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b (Array (_ BitVec 64) Bool)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_133 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_133) (bvule temp___idx_133 a__last)) (= (select a temp___idx_133) (select b (bvadd (bvsub b__first a__first) temp___idx_133)))))) true false))
(assert (forall ((a (Array (_ BitVec 64) Bool)) (b (Array (_ BitVec 64) Bool))) (forall ((a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_133 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_133) (bvule temp___idx_133 a__last)) (= (select a temp___idx_133) (select b (bvadd (bvsub b__first a__first) temp___idx_133))))))))))
(declare-fun compare1 ((Array (_ BitVec 64) Bool) (_ BitVec 64) (_ BitVec 64) (Array (_ BitVec 64) Bool) (_ BitVec 64) (_ BitVec 64)) Int)
(assert (forall ((a (Array (_ BitVec 64) Bool)) (b (Array (_ BitVec 64) Bool))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq2 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 64) Bool)) (b (Array (_ BitVec 64) Bool))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (< (to_int2 (select a (bvadd i #x0000000000000001))) (to_int2 (select b (bvadd j #x0000000000000001))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 64) Bool)) (b (Array (_ BitVec 64) Bool))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (< (to_int2 (select b (bvadd i #x0000000000000001))) (to_int2 (select a (bvadd j #x0000000000000001))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant ((temp___expr_292 us_t1) (temp___is_init_289 Bool) (temp___skip_constant_290 Bool) (temp___do_toplevel_291 Bool)) Bool (=> (not (= temp___skip_constant_290 true)) (dynamic_property1 ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551615) (first3 temp___expr_292) (last3 temp___expr_292))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_634 us_void_param) 1)) 122) (= (to_rep (select (temp___String_Literal_634 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_634 us_void_param) 4)) 111)) :pattern ((temp___String_Literal_634 us_void_param)))))
(declare-fun temp___String_Literal_635 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_635 us_void_param) 1)) 109) (= (to_rep (select (temp___String_Literal_635 us_void_param) 2)) 97)) (= (to_rep (select (temp___String_Literal_635 us_void_param) 3)) 120)) :pattern ((temp___String_Literal_635 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_286 (_ BitVec 64)) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool)) Bool true)
(assert (forall ((last4 (_ BitVec 64))) (! (=> (dynamic_invariant5 last4 true true true) (let ((result (create last4))) (and (and (= (last3 result) last4) (= (first3 result) ((_ int2bv 64) 0))) (dynamic_invariant result true false true)))) :pattern ((create last4)))))
...
(assert (and (= (to_rep2 (first2 (rt1 c))) ((_ int2bv 64) 0)) (= (to_rep2 (last2 (rt1 c))) ((_ int2bv 64) 18446744073709551615))))
(assert (and (= o (length1 c)) (uint_in_range (length1 c))))
(assert (= o1 ((_ int2bv 64) o)))
(assert (= result (ite (bvugt o1 ((_ int2bv 64) 18446744073709551615)) true false)))
(assert (not (= result true)))
(assert (not (uint_in_range (length1 c))))
(check-sat)
(exit)
