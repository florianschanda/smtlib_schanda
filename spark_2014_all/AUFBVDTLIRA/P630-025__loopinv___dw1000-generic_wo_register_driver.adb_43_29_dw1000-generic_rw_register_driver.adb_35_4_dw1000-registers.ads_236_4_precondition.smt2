...
(define-fun dynamic_invariant ((temp___expr_2788 us_t1) (temp___is_init_2785 Bool) (temp___skip_constant_2786 Bool) (temp___do_toplevel_2787 Bool)) Bool (=> (not (= temp___skip_constant_2786 true)) (and (dynamic_property2 1 5 (first3 temp___expr_2788) (last3 temp___expr_2788)) (and (= (first3 temp___expr_2788) 1) (= (last3 temp___expr_2788) 5)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_2839 us_t2) (temp___is_init_2836 Bool) (temp___skip_constant_2837 Bool) (temp___do_toplevel_2838 Bool)) Bool (=> (not (= temp___skip_constant_2837 true)) (and (dynamic_property3 1 5 (first5 temp___expr_2839) (last5 temp___expr_2839)) (and (= (first5 temp___expr_2839) 1) (= (last5 temp___expr_2839) 5)))))
...
(declare-const temp___7758 (Array Int bits_8))
(declare-const temp___77581 t1)
...
(assert (and (= temp___77572 (register_to_bytes reg)) (dynamic_invariant1 temp___77572 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___77571)) (to_rep (last4 temp___77571))) (+ (- (to_rep (last4 temp___77571)) (to_rep (first4 temp___77571))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
(assert (= temp___7757 temp___7758))
(assert (= (mk1 (to_rep (first4 temp___77571)) (to_rep (last4 temp___77571))) temp___77581))
(assert (= (ite (<= (to_rep (first2 temp___77581)) (to_rep (last2 temp___77581))) (+ (- (to_rep (last2 temp___77581)) (to_rep (first2 temp___77581))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___7758 temp___77581)))
(assert (= o2 o))
