...
(assert (= begidx1 1))
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i26 Int)) (=> (and (<= begidx2 i26) (<= i26 endidx1)) (and (<= 48 (to_rep (select zonefileline i26))) (<= (to_rep (select zonefileline i26)) 57)))))) (and (and (in_range5 begidx2) (in_range5 endidx1)) (in_range4 foundtype1))))
...
(assert (=> (= success1 true) (=> (not (not (= (+ (- endidx1 begidx2) 1) 14))) (=> (and (<= 1 i4) (<= i4 14)) (= temp___1531 timestring1)))))
(assert (=> (= success1 true) (=> (not (not (= (+ (- endidx1 begidx2) 1) 14))) (=> (and (<= 1 i4) (<= i4 14)) (= temp___1535 zlength)))))
(assert (=> (= success1 true) (=> (not (not (= (+ (- endidx1 begidx2) 1) 14))) (=> (and (<= 1 i4) (<= i4 14)) (= temp___1534 endidx1)))))
(assert (=> (= success1 true) (=> (not (not (= (+ (- endidx1 begidx2) 1) 14))) (=> (and (<= 1 i4) (<= i4 14)) (= temp___1533 begidx2)))))
(assert (=> (= success1 true) (=> (not (not (= (+ (- endidx1 begidx2) 1) 14))) (=> (and (<= 1 i4) (<= i4 14)) (= temp___1530 i4)))))
(assert (=> (= success1 true) (=> (not (not (= (+ (- endidx1 begidx2) 1) 14))) (=> (and (<= 1 i4) (<= i4 14)) (and (and (and (and (and (= begidx2 temp___1533) (= endidx1 temp___1534)) (= zlength temp___1535)) (<= endidx1 zlength)) (= (- endidx1 begidx2) 13)) (<= i5 14))))))
(assert (=> (= success1 true) (=> (not (not (= (+ (- endidx1 begidx2) 1) 14))) (=> (and (<= 1 i4) (<= i4 14)) (and (and (=> (<= 1 14) (in_range8 i5)) (forall ((temp___1532 Int)) (=> (and (<= 1 temp___1532) (<= temp___1532 14)) (=> (<= i5 temp___1532) (= (select timestring2 temp___1532) (select temp___1531 temp___1532)))))) (and (<= 1 i5) (<= i5 14)))))))
...
(assert (=> (= success1 true) (=> (not (not (= (+ (- endidx1 begidx2) 1) 14))) (=> (and (<= 1 i10) (<= i10 14)) (= temp___1539 success1)))))
(assert (=> (= success1 true) (=> (not (not (= (+ (- endidx1 begidx2) 1) 14))) (=> (and (<= 1 i10) (<= i10 14)) (= temp___1538 i10)))))
...
(assert (=> (= success20 true) (and (= o33 (+ endidx1 1)) (in_range5 (+ endidx1 1)))))
(assert (=> (= success20 true) (= result10 (mk_int__ref begidx2))))
(assert (=> (= success20 true) (= begidx3 o33)))
(assert (=> (= success20 true) (and (and (and (and (<= begidx4 endidx2) (<= begidx4 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i26 Int)) (=> (and (<= begidx4 i26) (<= i26 endidx2)) (and (<= 48 (to_rep (select zonefileline i26))) (<= (to_rep (select zonefileline i26)) 57)))))) (and (and (in_range5 begidx4) (in_range5 endidx2)) (in_range4 foundtype2)))))
...
(assert (and (= o48 (+ (int__content endidx3) 1)) (in_range5 (+ (int__content endidx3) 1))))
