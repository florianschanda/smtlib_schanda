...
(assert (and (= (to_rep (select memory5 (bvadd addr ((_ int2bv 64) 4)))) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 32)) ((_ int2bv 64) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 4)))) (= (to_rep (select memory5 i)) (to_rep (select memory4 i))))))))
(assert (and (= (to_rep (select memory6 (bvadd addr ((_ int2bv 64) 5)))) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 40)) ((_ int2bv 64) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 5)))) (= (to_rep (select memory6 i)) (to_rep (select memory5 i))))))))
(assert (not (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) (bvand (bvlshr val__ ((_ int2bv 64) 48)) ((_ int2bv 64) 255)))))
(check-sat)
(exit)
