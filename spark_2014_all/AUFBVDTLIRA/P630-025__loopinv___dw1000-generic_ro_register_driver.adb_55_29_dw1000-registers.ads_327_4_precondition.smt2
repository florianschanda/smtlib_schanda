...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 64)))) (=> (in_range2 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun to_int5 ((x bits_6)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x bits_6)) (! (in_range_int (to_int5 x)) :pattern ((to_int5 x)))))
(declare-sort bits_26 0)
(define-fun in_range3 ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 0) x) (bvule x ((_ int2bv 32) 67108863))))
(define-fun in_range_int1 ((x Int)) Bool (and (<= 0 x) (<= x 67108863)))
...
(declare-fun user_eq5 (bits_26 bits_26) Bool)
(declare-const dummy5 bits_26)
(declare-datatypes () ((bits_26__ref (mk_bits_26__ref (bits_26__content bits_26)))))
(define-fun bits_26__ref___projection ((a bits_26__ref)) bits_26 (bits_26__content a))
(declare-fun to_rep3 (bits_26) (_ BitVec 32))
(declare-fun of_rep3 ((_ BitVec 32)) bits_26)
(assert (forall ((x bits_26)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x bits_26)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x ((_ int2bv 32) 67108864)))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int6 ((x bits_26)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x bits_26)) (! (in_range_int1 (to_int6 x)) :pattern ((to_int6 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__ec_golp_type__offset_ext bits_6) (rec__dw1000__register_types__ec_golp_type__reserved bits_26)))))
(define-fun us_split_fields_OFFSET_EXT__projection ((a us_split_fields)) bits_6 (rec__dw1000__register_types__ec_golp_type__offset_ext a))
(define-fun us_split_fields_Reserved__6__projection ((a us_split_fields)) bits_26 (rec__dw1000__register_types__ec_golp_type__reserved a))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__dw1000__register_types__ec_golp_type__offset_ext (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__ec_golp_type__offset_ext (us_split_fields1 b)))) (= (to_rep3 (rec__dw1000__register_types__ec_golp_type__reserved (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__ec_golp_type__reserved (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__ec_golp_type__offset_ext__first__bit Int)
(declare-const dw1000__register_types__ec_golp_type__offset_ext__last__bit Int)
(declare-const dw1000__register_types__ec_golp_type__offset_ext__position Int)
(assert (<= 0 dw1000__register_types__ec_golp_type__offset_ext__first__bit))
(assert (< dw1000__register_types__ec_golp_type__offset_ext__first__bit dw1000__register_types__ec_golp_type__offset_ext__last__bit))
(assert (<= 0 dw1000__register_types__ec_golp_type__offset_ext__position))
(declare-const dw1000__register_types__ec_golp_type__reserved__first__bit Int)
(declare-const dw1000__register_types__ec_golp_type__reserved__last__bit Int)
(declare-const dw1000__register_types__ec_golp_type__reserved__position Int)
(assert (<= 0 dw1000__register_types__ec_golp_type__reserved__first__bit))
(assert (< dw1000__register_types__ec_golp_type__reserved__first__bit dw1000__register_types__ec_golp_type__reserved__last__bit))
(assert (<= 0 dw1000__register_types__ec_golp_type__reserved__position))
(declare-fun user_eq6 (us_rep us_rep) Bool)
(declare-const dummy6 us_rep)
(declare-datatypes () ((ec_golp_type__ref (mk_ec_golp_type__ref (ec_golp_type__content us_rep)))))
(define-fun ec_golp_type__ref___projection ((a ec_golp_type__ref)) us_rep (ec_golp_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___73__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___53__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___53__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3761 us_t1) (temp___is_init_3758 Bool) (temp___skip_constant_3759 Bool) (temp___do_toplevel_3760 Bool)) Bool (=> (not (= temp___skip_constant_3759 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3761) (last3 temp___expr_3761)) (and (= (first3 temp___expr_3761) 1) (= (last3 temp___expr_3761) 4)))))
