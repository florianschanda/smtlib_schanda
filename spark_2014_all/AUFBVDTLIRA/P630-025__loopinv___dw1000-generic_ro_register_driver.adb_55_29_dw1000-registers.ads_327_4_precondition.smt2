...
(define-fun in_range3 ((x (_ BitVec 32))) Bool (and (bvule #x00000000 x) (bvule x #x03FFFFFF)))
...
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x #x04000000))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(define-fun dynamic_invariant ((temp___expr_4146 us_t1) (temp___is_init_4142 Bool) (temp___skip_constant_4143 Bool) (temp___do_toplevel_4144 Bool) (temp___do_typ_inv_4145 Bool)) Bool (=> (not (= temp___skip_constant_4143 true)) (and (dynamic_property2 1 4 (first3 temp___expr_4146) (last3 temp___expr_4146)) (and (= (first3 temp___expr_4146) 1) (= (last3 temp___expr_4146) 4)))))
