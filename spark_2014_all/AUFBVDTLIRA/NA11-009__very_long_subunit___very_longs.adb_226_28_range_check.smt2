...
(declare-datatypes () ((tT69bP1__ref (mk_tT69bP1__ref (tT69bP1__content tdigit_count_typeB)))))
(define-fun tT69bP1__ref___projection ((a tT69bP1__ref)) tdigit_count_typeB (tT69bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t69b__ref (mk_t69b__ref (t69b__content us_t1)))))
(define-fun t69b__ref___projection ((a t69b__ref)) us_t1 (t69b__content a))
...
(declare-datatypes () ((t70b__ref (mk_t70b__ref (t70b__content tdigit_count_typeB)))))
(define-fun t70b__ref___projection ((a t70b__ref)) tdigit_count_typeB (t70b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t71b__ref (mk_t71b__ref (t71b__content us_t2)))))
(define-fun t71b__ref___projection ((a t71b__ref)) us_t2 (t71b__content a))
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-fun temp___961 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___963 (_ BitVec 8))) (forall ((temp___964 Int) (temp___965 Int)) (let ((temp___962 (temp___961 temp___963 temp___964 temp___965))) (=> (dynamic_invariant2 temp___963 true true true true) (and (=> (dynamic_property6 1 65536 temp___964 temp___965) (and (= (first5 temp___962) temp___964) (= (last5 temp___962) temp___965))) (forall ((temp___966 Int)) (= (to_rep1 (select (to_array2 temp___962) temp___966)) temp___963))))))))
