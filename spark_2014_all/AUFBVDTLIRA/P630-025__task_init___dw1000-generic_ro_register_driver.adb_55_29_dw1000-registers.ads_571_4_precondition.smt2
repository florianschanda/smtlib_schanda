...
(define-fun dynamic_invariant ((temp___expr_6766 us_t1) (temp___is_init_6763 Bool) (temp___skip_constant_6764 Bool) (temp___do_toplevel_6765 Bool)) Bool (=> (not (= temp___skip_constant_6764 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6766) (last3 temp___expr_6766)) (and (= (first3 temp___expr_6766) 1) (= (last3 temp___expr_6766) 2)))))
