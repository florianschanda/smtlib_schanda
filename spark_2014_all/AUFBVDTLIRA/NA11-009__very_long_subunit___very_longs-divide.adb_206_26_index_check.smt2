...
(declare-const temp___1379 (_ BitVec 16))
...
(declare-const temp___1378 us_rep1)
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1383 carry1)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1380 (mk___rep1 u__split_discrs (mk___split_fields1 (mk___t1 u__split_fields u__split_fields1))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1379 sum)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields3) true true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r127b)))))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1373 (- o16 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1373) (<= temp___1373 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= o17 temp___1373)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1376 (- o27 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1376) (<= temp___1376 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= o30 temp___1376)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1378 (mk___rep1 u__split_discrs o33))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= result5 (mk___split_fields__ref1 u__split_fields3))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= u__split_fields4 (us_split_fields3 temp___1378))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= u__split_discrs (us_split_discrs2 temp___1378))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (and (= o34 (shift_right sum3 8)) (= o34 (bvudiv sum3 (ite (< 8 65536) (bvshl #x0001 ((_ int2bv 16) 8)) #x0000))))))
...
(assert (and (= temp___1387 (+ j n)) (in_range1 (+ j n))))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields7))))) temp___1387) (<= temp___1387 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields7))))))))
(assert (= o35 temp___1387))
