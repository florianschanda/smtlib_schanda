...
(assert (= o53 (from_word32 ((_ int2bv 32) 1))))
...
(assert (and (= o37 (base Tuple0)) (= o37 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
(assert (= o36 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first o35)))
