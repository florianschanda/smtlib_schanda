...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o56 k)) #x00000000))))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (omod (oadd (num_of_big_int (mk___t o57 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o57 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true)))
(assert (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (and (<= a_first i2) (<= i2 a_last))))
(assert (= o53 (from_word32 #x00000001)))
(assert (and (= o47 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o48 (+ o47 1)))
(assert (and (= o49 o48) (in_range1 o48)))
(assert (and (= o50 o49) (in_range2 o49)))
(assert (= o51 (num_of_big_int m m_first o50)))
(assert (= o46 (from_word32 #x00000002)))
(assert (= o52 (omultiply o46 o51)))
(assert (= o54 (osubtract o52 o53)))
(assert (= o43 (from_word32 a_msw2)))
(assert (and (= o38 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o39 (+ o38 1)))
(assert (and (= o40 o39) (in_range1 o39)))
(assert (and (= o41 o40) (in_range2 o40)))
(assert (and (= o37 (base Tuple0)) (= o37 (oexpon (from_word32 #x00000002) 32))))
(assert (= o42 (oexpon o37 o41)))
...
(assert (= o36 (num_of_big_int (mk___t o57 (mk (to_rep a__first) (to_rep a__last))) a_first o35)))
(assert (= o45 (oadd o36 o44)))
(assert (= o55 (olt o45 o54)))
...
(assert (= o25 (omultiply o14 o24)))
(assert (= o31 (omod o25 o30)))
