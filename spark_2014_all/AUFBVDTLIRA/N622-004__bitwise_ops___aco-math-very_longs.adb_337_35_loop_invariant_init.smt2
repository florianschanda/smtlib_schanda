...
(assert (< digit_index2 i2))
(declare-const j2 Int)
(assert (<= (+ digit_index2 1) j2))
(assert (<= j2 i2))
(assert (not (= (to_rep (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) j2)) ((_ int2bv 8) 0))))
(check-sat)
(exit)
