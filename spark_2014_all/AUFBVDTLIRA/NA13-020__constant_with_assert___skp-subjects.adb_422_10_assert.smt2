...
(declare-const subject7 Int)
(assert (<= 1 subject7))
(assert (<= subject7 1))
(assert (not (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject7)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0))))
(check-sat)
(exit)
