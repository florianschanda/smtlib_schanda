...
(assert (= o20 (omultiply o14 o19)))
(assert (= o22 (osubtract o20 o21)))
(assert (= o11 (from_word32 a_msw2)))
...
(assert (= o4 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first o3)))
(assert (= o13 (oadd o4 o12)))
(assert (= o23 (olt o13 o22)))
