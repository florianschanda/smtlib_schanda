...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= tokentype1 1) (forall ((i7 Int)) (=> (and (<= begidx2 i7) (<= i7 endidx1)) (and (<= 48 (to_rep (select zonefileline i7))) (<= (to_rep (select zonefileline i7)) 57)))))) (and (and (in_range5 begidx2) (in_range5 endidx1)) (in_range4 tokentype1))))
...
(assert (= i1 r109b))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= temp___1830 token1)))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= temp___1832 i1)))
...
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (and (= temp___1829 o2) (in_range1 o2))))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (and (<= 1 temp___1829) (<= temp___1829 256))))
(assert (=> (and (<= r109b i1) (<= i1 r110b)) (= o4 temp___1829)))
