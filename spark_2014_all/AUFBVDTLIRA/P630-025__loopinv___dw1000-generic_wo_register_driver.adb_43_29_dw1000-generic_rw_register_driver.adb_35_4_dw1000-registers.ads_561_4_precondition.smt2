...
(define-fun tregister_byte_arrayP1__ref___139__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___60__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__lde_cfg1_type__ntm bits_5) (rec__dw1000__register_types__lde_cfg1_type__pmult bits_3)))))
(define-fun us_split_fields_NTM__projection ((a us_split_fields)) bits_5 (rec__dw1000__register_types__lde_cfg1_type__ntm a))
(define-fun us_split_fields_PMULT__projection ((a us_split_fields)) bits_3 (rec__dw1000__register_types__lde_cfg1_type__pmult a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___81__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___81__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep3 (rec__dw1000__register_types__lde_cfg1_type__ntm (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__lde_cfg1_type__ntm (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__lde_cfg1_type__pmult (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__lde_cfg1_type__pmult (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__lde_cfg1_type__ntm__first__bit Int)
(declare-const dw1000__register_types__lde_cfg1_type__ntm__last__bit Int)
(declare-const dw1000__register_types__lde_cfg1_type__ntm__position Int)
(assert (<= 0 dw1000__register_types__lde_cfg1_type__ntm__first__bit))
(assert (< dw1000__register_types__lde_cfg1_type__ntm__first__bit dw1000__register_types__lde_cfg1_type__ntm__last__bit))
(assert (<= 0 dw1000__register_types__lde_cfg1_type__ntm__position))
(declare-const dw1000__register_types__lde_cfg1_type__pmult__first__bit Int)
(declare-const dw1000__register_types__lde_cfg1_type__pmult__last__bit Int)
(declare-const dw1000__register_types__lde_cfg1_type__pmult__position Int)
(assert (<= 0 dw1000__register_types__lde_cfg1_type__pmult__first__bit))
(assert (< dw1000__register_types__lde_cfg1_type__pmult__first__bit dw1000__register_types__lde_cfg1_type__pmult__last__bit))
(assert (<= 0 dw1000__register_types__lde_cfg1_type__pmult__position))
(declare-fun user_eq8 (us_rep us_rep) Bool)
(declare-const dummy8 us_rep)
(declare-datatypes () ((lde_cfg1_type__ref (mk_lde_cfg1_type__ref (lde_cfg1_type__content us_rep)))))
(define-fun lde_cfg1_type__ref___projection ((a lde_cfg1_type__ref)) us_rep (lde_cfg1_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___60__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_7406 us_t1) (temp___is_init_7402 Bool) (temp___skip_constant_7403 Bool) (temp___do_toplevel_7404 Bool) (temp___do_typ_inv_7405 Bool)) Bool (=> (not (= temp___skip_constant_7403 true)) (and (dynamic_property2 1 1 (first3 temp___expr_7406) (last3 temp___expr_7406)) (and (= (first3 temp___expr_7406) 1) (= (last3 temp___expr_7406) 1)))))
...
(define-fun register_type__ref___198__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___139__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_7387 us_t2) (temp___is_init_7383 Bool) (temp___skip_constant_7384 Bool) (temp___do_toplevel_7385 Bool) (temp___do_typ_inv_7386 Bool)) Bool (=> (not (= temp___skip_constant_7384 true)) (and (dynamic_property3 1 1 (first5 temp___expr_7387) (last5 temp___expr_7387)) (and (= (first5 temp___expr_7387) 1) (= (last5 temp___expr_7387) 1)))))
...
(declare-const temp___8922 (Array Int bits_8))
(declare-const temp___89221 t1)
(declare-const temp___8923 (Array Int bits_8))
(declare-const temp___89231 t2)
...
(define-fun temp___89222 () us_t1 (mk___t1 temp___8922 temp___89221))
...
(assert (and (= temp___89222 (register_to_bytes reg)) (dynamic_invariant temp___89222 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___89221)) (to_rep (last2 temp___89221))) (+ (- (to_rep (last2 temp___89221)) (to_rep (first2 temp___89221))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8922 temp___8923))
(assert (= (mk2 (to_rep (first2 temp___89221)) (to_rep (last2 temp___89221))) temp___89231))
(assert (= (ite (<= (to_rep (first4 temp___89231)) (to_rep (last4 temp___89231))) (+ (- (to_rep (last4 temp___89231)) (to_rep (first4 temp___89231))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8923 temp___89231)))
(assert (= o2 o))
