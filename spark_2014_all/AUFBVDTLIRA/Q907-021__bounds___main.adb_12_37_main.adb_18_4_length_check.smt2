...
(define-fun dynamic_invariant ((temp___expr_154 us_t) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (not (= temp___skip_constant_152 true)) (dynamic_property 1 2147483647 (first1 temp___expr_154) (last1 temp___expr_154))))
...
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (serialize us_void_param) true false true) :pattern ((serialize us_void_param)))))
...
(assert (forall ((temp___225 (_ BitVec 8))) (forall ((temp___226 Int)) (= (select (main__payload_bytes__aggregate_def temp___225) temp___226) (of_rep temp___225)))))
...
(define-fun dynamic_invariant3 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 1 2147483647)) (in_range1 temp___expr_148)))
(define-fun dynamic_invariant4 ((temp___expr_165 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 1 100)) (in_range2 temp___expr_165)))
...
(declare-const temp___227 (Array Int byte))
(declare-const temp___2271 t1)
(declare-const o (Array Int byte))
(declare-const temp___230 (Array Int byte))
(declare-const temp___2301 t1)
...
(assert (= payload_bytes1 (main__payload_bytes__aggregate_def ((_ int2bv 8) 0))))
(assert (and (= main__C8b__assume2 (serialize Tuple0)) (dynamic_invariant main__C8b__assume2 true false true)))
(assert (= main__C8b__assume2 c8b))
(assert (dynamic_invariant c8b true false true))
(assert (= (slide (elts c8b) (to_rep1 (first (rt c8b))) (to_rep1 (first (rt c8b)))) temp___227))
(assert (= (mk1 (to_rep1 (first (rt c8b))) (to_rep1 (last (rt c8b)))) temp___2271))
...
(assert (= o temp___230))
(assert (= (mk1 (to_rep1 (first (rt c8b))) (to_rep1 (last (rt c8b)))) temp___2301))
(assert (not (= (ite (<= (to_rep1 (first2 temp___2271)) (to_rep1 (last2 temp___2271))) (+ (- (to_rep1 (last2 temp___2271)) (to_rep1 (first2 temp___2271))) 1) 0) (ite (<= (to_rep1 (first2 temp___2301)) (to_rep1 (last2 temp___2301))) (+ (- (to_rep1 (last2 temp___2301)) (to_rep1 (first2 temp___2301))) 1) 0))))
(check-sat)
(exit)
