...
(assert (forall ((temp___261 (_ BitVec 8))) (=> (dynamic_invariant2 temp___261 true true true true) (forall ((temp___262 Int)) (= (to_rep (select (main__payload_bytes__aggregate_def temp___261) temp___262)) temp___261)))))
...
(assert (= (slide (elts c8b) (to_rep1 (first (rt c8b))) (to_rep1 (first (rt c8b)))) temp___263))
(assert (= (mk1 (to_rep1 (first (rt c8b))) (to_rep1 (last (rt c8b)))) temp___2631))
(assert (=> (<= (to_rep1 (first (rt c8b))) (to_rep1 (last (rt c8b)))) (and (and (<= 1 (to_rep1 (first (rt c8b)))) (<= (to_rep1 (first (rt c8b))) 100)) (and (<= 1 (to_rep1 (last (rt c8b)))) (<= (to_rep1 (last (rt c8b))) 100)))))
(assert (= o payload_bytes1))
(assert (= o temp___266))
(assert (= (mk1 (to_rep1 (first (rt c8b))) (to_rep1 (last (rt c8b)))) temp___2661))
(assert (not (= (ite (<= (to_rep1 (first2 temp___2631)) (to_rep1 (last2 temp___2631))) (+ (- (to_rep1 (last2 temp___2631)) (to_rep1 (first2 temp___2631))) 1) 0) (ite (<= (to_rep1 (first2 temp___2661)) (to_rep1 (last2 temp___2661))) (+ (- (to_rep1 (last2 temp___2661)) (to_rep1 (first2 temp___2661))) 1) 0))))
(check-sat)
(exit)
