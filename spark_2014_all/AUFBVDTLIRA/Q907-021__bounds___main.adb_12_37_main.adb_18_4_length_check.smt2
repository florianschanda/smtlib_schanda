...
(assert (and (= (mk___t main__C8b__assume main__C8b__assume1) (serialize Tuple0)) (dynamic_invariant (mk___t main__C8b__assume main__C8b__assume1) true false true)))
(assert (= (mk___t main__C8b__assume main__C8b__assume1) c8b))
