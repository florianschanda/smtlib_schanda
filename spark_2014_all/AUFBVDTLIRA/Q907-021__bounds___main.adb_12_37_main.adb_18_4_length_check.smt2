...
(assert (forall ((i byte_index)) (and (<= 1 (byte_indexqtint i)) (<= (byte_indexqtint i) 2147483647))))
...
(define-fun dynamic_invariant ((temp___expr_180 us_t) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (not (= temp___skip_constant_177 true)) (dynamic_property 1 2147483647 (first1 temp___expr_180) (last1 temp___expr_180))))
(assert (forall ((us_void_param tuple0)) (! (dynamic_invariant (serialize us_void_param) true false true true) :pattern ((serialize us_void_param)))))
(declare-sort payload_byte_index 0)
(declare-fun payload_byte_indexqtint (payload_byte_index) Int)
(assert (forall ((i payload_byte_index)) (and (<= 1 (payload_byte_indexqtint i)) (<= (payload_byte_indexqtint i) 100))))
...
(declare-datatypes () ((payload_byte_index__ref (mk_payload_byte_index__ref (payload_byte_index__content payload_byte_index)))))
(define-fun payload_byte_index__ref___projection ((a payload_byte_index__ref)) payload_byte_index (payload_byte_index__content a))
...
(assert (forall ((temp___261 (_ BitVec 8))) (=> (dynamic_invariant2 temp___261 true true true true) (forall ((temp___262 Int)) (= (to_rep1 (select (main__payload_bytes__aggregate_def temp___261) temp___262)) temp___261)))))
(define-fun dynamic_invariant3 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 1 2147483647)) (in_range1 temp___expr_173)))
(define-fun dynamic_invariant4 ((temp___expr_193 Int) (temp___is_init_189 Bool) (temp___skip_constant_190 Bool) (temp___do_toplevel_191 Bool) (temp___do_typ_inv_192 Bool)) Bool (=> (or (= temp___is_init_189 true) (<= 1 100)) (in_range2 temp___expr_193)))
(declare-const payload_bytes (Array Int byte))
(declare-const main__C8b__assume (Array Int byte))
(declare-const main__C8b__assume1 t)
(declare-const temp___263 (Array Int byte))
(declare-const temp___2631 t1)
(declare-const o (Array Int byte))
(declare-const temp___266 (Array Int byte))
(declare-const temp___2661 t1)
(declare-const result (Array Int byte))
(declare-const payload_bytes1 (Array Int byte))
(define-fun main__C8b__assume2 () us_t (mk___t main__C8b__assume main__C8b__assume1))
(assert (= result payload_bytes))
(assert (= payload_bytes1 (main__payload_bytes__aggregate_def #x00)))
(assert (and (= main__C8b__assume2 (serialize Tuple0)) (dynamic_invariant main__C8b__assume2 true false true true)))
(assert (= main__C8b__assume2 c8b))
(assert (dynamic_invariant c8b true false true true))
(assert (= (slide (elts c8b) (to_rep (first (rt c8b))) (to_rep (first (rt c8b)))) temp___263))
(assert (= (mk1 (to_rep (first (rt c8b))) (to_rep (last (rt c8b)))) temp___2631))
(assert (=> (<= (to_rep (first (rt c8b))) (to_rep (last (rt c8b)))) (and (and (<= 1 (to_rep (first (rt c8b)))) (<= (to_rep (first (rt c8b))) 100)) (and (<= 1 (to_rep (last (rt c8b)))) (<= (to_rep (last (rt c8b))) 100)))))
(assert (= o payload_bytes1))
(assert (= o temp___266))
(assert (= (mk1 (to_rep (first (rt c8b))) (to_rep (last (rt c8b)))) temp___2661))
(assert (not (= (ite (<= (to_rep (first2 temp___2631)) (to_rep (last2 temp___2631))) (+ (- (to_rep (last2 temp___2631)) (to_rep (first2 temp___2631))) 1) 0) (ite (<= (to_rep (first2 temp___2661)) (to_rep (last2 temp___2661))) (+ (- (to_rep (last2 temp___2661)) (to_rep (first2 temp___2661))) 1) 0))))
(check-sat)
(exit)
