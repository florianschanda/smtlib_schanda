...
(declare-datatypes () ((tT99bP1__ref (mk_tT99bP1__ref (tT99bP1__content tdigit_count_typeB)))))
(define-fun tT99bP1__ref___projection ((a tT99bP1__ref)) tdigit_count_typeB (tT99bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t99b__ref (mk_t99b__ref (t99b__content us_t1)))))
(define-fun t99b__ref___projection ((a t99b__ref)) us_t1 (t99b__content a))
...
(declare-datatypes () ((t100b__ref (mk_t100b__ref (t100b__content tdigit_count_typeB)))))
(define-fun t100b__ref___projection ((a t100b__ref)) tdigit_count_typeB (t100b__content a))
(declare-sort t2 0)
...
(declare-fun temp___1013 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___1015 (_ BitVec 8))) (forall ((temp___1016 Int) (temp___1017 Int)) (let ((temp___1014 (temp___1013 temp___1015 temp___1016 temp___1017))) (and (=> (dynamic_property6 1 65536 temp___1016 temp___1017) (and (= (first5 temp___1014) temp___1016) (= (last5 temp___1014) temp___1017))) (forall ((temp___1018 Int)) (= (select (to_array2 temp___1014) temp___1018) (of_rep1 temp___1015))))))))
...
(declare-const temp___1020 (Array Int octet))
(declare-const temp___10201 t2)
(declare-const temp___1021 (Array Int octet))
(declare-const temp___10211 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___1024 digit_index_type)
(declare-const temp___10241 (Array Int octet))
(declare-const temp___10242 t1)
(declare-const temp___1054 (_ BitVec 16))
(declare-const temp___1051 us_rep1)
(declare-const temp___1050 (_ BitVec 16))
(declare-const temp___1049 (_ BitVec 16))
(declare-const temp___1048 (_ BitVec 16))
(declare-const temp___1047 (_ BitVec 16))
(declare-const temp___1040 (_ BitVec 16))
(declare-const temp___1037 us_rep1)
(declare-const temp___1036 (_ BitVec 16))
(declare-const temp___1035 (_ BitVec 16))
...
(declare-const temp___1032 us_rep1)
...
(declare-const temp___1046 us_rep1)
...
(assert true)
(assert true)
(assert (= (to_rep2 (first4 (rt2 (temp___1013 ((_ int2bv 8) 0) 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1013 ((_ int2bv 8) 0) 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))) (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))))
(assert (= (mk___t2 temp___1020 temp___10201) (temp___1013 ((_ int2bv 8) 0) 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))
(assert (not (= (ite (<= (to_rep2 (first4 temp___10201)) (to_rep2 (last4 temp___10201))) (+ (- (to_rep2 (last4 temp___10201)) (to_rep2 (first4 temp___10201))) 1) 0) (ite (<= 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))) (+ (- (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) 1) 1) 0))))
(check-sat)
(exit)
