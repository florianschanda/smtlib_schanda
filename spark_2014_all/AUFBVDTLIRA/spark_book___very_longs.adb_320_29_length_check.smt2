...
(declare-fun temp___1082 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1084 (_ BitVec 8))) (forall ((temp___1085 Int) (temp___1086 Int)) (let ((temp___1083 (temp___1082 temp___1084 temp___1085 temp___1086))) (=> (dynamic_invariant2 temp___1084 true true true true) (and (=> (dynamic_property6 1 65536 temp___1085 temp___1086) (and (= (first5 temp___1083) temp___1085) (= (last5 temp___1083) temp___1086))) (forall ((temp___1087 Int)) (= (to_rep1 (select (to_array2 temp___1083) temp___1087)) temp___1084))))))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1082 #x00 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1082 #x00 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))) (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))))
(assert (= (mk___t2 temp___1089 temp___10891) (temp___1082 #x00 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))
(assert (not (= (ite (<= (to_rep2 (first4 temp___10891)) (to_rep2 (last4 temp___10891))) (+ (- (to_rep2 (last4 temp___10891)) (to_rep2 (first4 temp___10891))) 1) 0) (ite (<= 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))) (+ (- (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) 1) 1) 0))))
(check-sat)
(exit)
