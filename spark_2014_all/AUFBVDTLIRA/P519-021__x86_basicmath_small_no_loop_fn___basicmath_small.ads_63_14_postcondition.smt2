...
(declare-const temp___421 (Array (_ BitVec 64) unsigned8))
(declare-const temp___418 (_ BitVec 64))
(declare-const temp___417 (Array (_ BitVec 64) unsigned8))
...
(assert (= temp___419 rbx))
(assert (= temp___421 memory))
(assert (= temp___418 rsp))
(assert (= temp___417 memory))
(assert (= temp___416 xmm2))
(assert (= temp___415 xmm1))
(assert (= temp___414 rax))
(assert (= temp___413 xmm0))
(assert (= temp___412 rdi))
(assert (= temp___420 rsp))
(assert (= temp___411 zeroflag))
(assert (= rsp1 temp___420))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (and (and (and (and (and (and (and (not (= i rsp1)) (not (= i (bvadd rsp1 #x0000000000000001)))) (not (= i (bvadd rsp1 #x0000000000000002)))) (not (= i (bvadd rsp1 #x0000000000000003)))) (not (= i (bvadd rsp1 #x0000000000000004)))) (not (= i (bvadd rsp1 #x0000000000000005)))) (not (= i (bvadd rsp1 #x0000000000000006)))) (not (= i (bvadd rsp1 #x0000000000000007)))) (= (to_rep (select memory1 i)) (to_rep (select temp___421 i)))))))
