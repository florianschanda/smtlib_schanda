...
(define-fun dynamic_invariant3 ((temp___expr_882 Int) (temp___is_init_878 Bool) (temp___skip_constant_879 Bool) (temp___do_toplevel_880 Bool) (temp___do_typ_inv_881 Bool)) Bool (=> (or (= temp___is_init_878 true) (<= 0 7)) (in_range4 temp___expr_882)))
...
(define-fun dynamic_invariant4 ((temp___expr_302 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 1 2147483647)) (in_range2 temp___expr_302)))
...
(declare-const o15 t)
(declare-const temp___1594 digit_index_type)
(declare-const temp___15941 (Array Int octet))
(declare-const temp___15942 t)
...
(assert (and (= o (shift_right #xFF (- 8 distance))) (= o (bvudiv #xFF (ite (< (- 8 distance) 256) (bvshl #x01 ((_ int2bv 8) (- 8 distance))) #x00)))))
(assert (= result1 overflow_mask))
(assert (= overflow_mask1 o))
(assert (= (to_rep2 (last number__split_fields1)) r128b))
(assert (in_range3 r128b))
(assert (= result2 i))
(assert (= i1 r128b))
(assert (<= 1 i1))
(assert (<= i1 r128b))
(assert (and (and (dynamic_invariant2 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true true) (forall ((temp___1602 Int)) (=> (and (<= (to_rep2 (first number__split_fields3)) temp___1602) (<= temp___1602 (to_rep2 (last number__split_fields3)))) (=> (or (< r128b temp___1602) (or (< temp___1602 1) (<= temp___1602 i2))) (= (select number__split_fields2 temp___1602) (select number__split_fields temp___1602)))))) (and (<= 1 i2) (<= i2 r128b))))
(assert (and (<= (to_rep2 (first number__split_fields3)) i2) (<= i2 (to_rep2 (last number__split_fields3)))))
(assert (= o1 i2))
(assert (= o2 (select number__split_fields2 o1)))
(assert (= o3 (to_rep1 o2)))
...
(assert (and (= o8 (shift_right o7 distance)) (= o8 (bvudiv o7 (ite (< distance 256) (bvshl #x01 ((_ int2bv 8) distance)) #x00)))))
...
(assert (= o14 o12))
(assert (= o15 o13))
(assert (= number__split_discrs (mk___split_discrs temp___1594)))
(assert (= temp___15941 o14))
(assert (= temp___15942 o15))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___15941 temp___15942))))
(assert (= number__split_discrs (mk___split_discrs temp___1594)))
(assert (=> (< (- 8 distance) 8) (= o18 (bvshl old_overflow2 ((_ int2bv 8) (- 8 distance))))))
(assert (=> (not (< (- 8 distance) 8)) (= o18 #x00)))
(assert (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits number__split_fields4)))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits number__split_fields4)))))))
(assert (= o16 i2))
(assert (= o17 (select (elts (rec__aco__math__very_longs__very_long__long_digits number__split_fields4)) o16)))
(assert (= o19 (to_rep1 o17)))
(assert (= o20 (bvor o19 o18)))
(assert (= (to_rep1 o21) o20))
(assert (not (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits number__split_fields4)))) i2)))
(check-sat)
(exit)
