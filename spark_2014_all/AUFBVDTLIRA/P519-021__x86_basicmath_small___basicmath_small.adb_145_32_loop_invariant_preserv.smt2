...
(assert (= zeroflag2 result3))
(assert (= zeroflag3 o6))
(assert (and (= o7 (ebx rbx3)) (= o7 (readreg32 rbx3))))
...
(assert (= o10 (ite (bvugt o9 ((_ int2bv 32) 2147483647)) true false)))
(assert (= signflag2 result4))
(assert (= signflag3 o10))
(assert (and (= o11 (ebx rbx3)) (= o11 (readreg32 rbx3))))
...
(assert (=> (= result7 true) (= o19 (ite (bvule o14 ((_ int2bv 32) 2147483647)) true false))))
(assert (=> (not (= result7 true)) (= o19 false)))
(assert (= o20 (ite (= o19 false) o18 true)))
(assert (= overflowflag2 result8))
(assert (= overflowflag3 o20))
(assert (not (= zeroflag3 true)))
(assert (= (to_int3 signflag3) (to_int3 overflowflag3)))
(assert (not (= rsp4 rsp)))
(check-sat)
(exit)
