...
(assert (= a_msw3 o37))
(assert (= o76 (from_word32 #x00000001)))
...
(assert (and (= o60 (base Tuple0)) (= o60 (oexpon (from_word32 #x00000002) 32))))
...
(assert (= o59 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first o58)))
