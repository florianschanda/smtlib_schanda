...
(declare-fun user_eq4 (bits_64 bits_64) Bool)
(declare-const dummy4 bits_64)
(declare-datatypes () ((bits_64__ref (mk_bits_64__ref (bits_64__content bits_64)))))
(define-fun bits_64__ref___projection ((a bits_64__ref)) bits_64 (bits_64__content a))
(declare-fun to_rep2 (bits_64) (_ BitVec 64))
(declare-fun of_rep2 ((_ BitVec 64)) bits_64)
(assert (forall ((x bits_64)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert true)
(assert (forall ((x (_ BitVec 64))) (! (= (to_rep2 (of_rep2 x)) x) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun to_int5 ((x bits_64)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x bits_64)) (! (uint_in_range2 (to_int5 x)) :pattern ((to_int5 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__eui_type__eui bits_64)))))
(define-fun us_split_fields_EUI__projection ((a us_split_fields)) bits_64 (rec__dw1000__register_types__eui_type__eui a))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__eui_type__eui (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__eui_type__eui (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__eui_type__eui__first__bit Int)
(declare-const dw1000__register_types__eui_type__eui__last__bit Int)
(declare-const dw1000__register_types__eui_type__eui__position Int)
(assert (<= 0 dw1000__register_types__eui_type__eui__first__bit))
(assert (< dw1000__register_types__eui_type__eui__first__bit dw1000__register_types__eui_type__eui__last__bit))
(assert (<= 0 dw1000__register_types__eui_type__eui__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((eui_type__ref (mk_eui_type__ref (eui_type__content us_rep)))))
(define-fun eui_type__ref___projection ((a eui_type__ref)) us_rep (eui_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___3__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___3__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_2092 us_t1) (temp___is_init_2088 Bool) (temp___skip_constant_2089 Bool) (temp___do_toplevel_2090 Bool) (temp___do_typ_inv_2091 Bool)) Bool (=> (not (= temp___skip_constant_2089 true)) (and (dynamic_property2 1 8 (first3 temp___expr_2092) (last3 temp___expr_2092)) (and (= (first3 temp___expr_2092) 1) (= (last3 temp___expr_2092) 8)))))
(declare-sort t2 0)
...
(define-fun target__ref___projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_2110 us_t2) (temp___is_init_2106 Bool) (temp___skip_constant_2107 Bool) (temp___do_toplevel_2108 Bool) (temp___do_typ_inv_2109 Bool)) Bool (=> (not (= temp___skip_constant_2107 true)) (and (dynamic_property3 1 8 (first5 temp___expr_2110) (last5 temp___expr_2110)) (and (= (first5 temp___expr_2110) 1) (= (last5 temp___expr_2110) 8)))))
...
(declare-const temp___8465 (Array Int bits_8))
(declare-const temp___84651 t2)
(declare-const temp___8466 (Array Int bits_8))
(declare-const temp___84661 t1)
(define-fun temp___84652 () us_t2 (mk___t2 temp___8465 temp___84651))
(assert (and (dynamic_property2 1 8 (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 8))))
(assert (and (= temp___84652 (register_to_bytes reg)) (dynamic_invariant1 temp___84652 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___84651)) (to_rep (last4 temp___84651))) (+ (- (to_rep (last4 temp___84651)) (to_rep (first4 temp___84651))) 1) 0) (ite (<= 1 8) (+ (- 8 1) 1) 0)))
(assert (= temp___8465 temp___8466))
(assert (= (mk1 (to_rep (first4 temp___84651)) (to_rep (last4 temp___84651))) temp___84661))
(assert (not (= (ite (<= (to_rep (first2 temp___84661)) (to_rep (last2 temp___84661))) (+ (- (to_rep (last2 temp___84661)) (to_rep (first2 temp___84661))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
