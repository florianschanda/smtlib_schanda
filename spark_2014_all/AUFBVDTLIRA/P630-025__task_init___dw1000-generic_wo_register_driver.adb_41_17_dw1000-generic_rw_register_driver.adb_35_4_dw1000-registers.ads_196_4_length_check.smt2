...
(define-fun dynamic_invariant ((temp___expr_1868 us_t1) (temp___is_init_1865 Bool) (temp___skip_constant_1866 Bool) (temp___do_toplevel_1867 Bool)) Bool (=> (not (= temp___skip_constant_1866 true)) (and (dynamic_property2 1 8 (first3 temp___expr_1868) (last3 temp___expr_1868)) (and (= (first3 temp___expr_1868) 1) (= (last3 temp___expr_1868) 8)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_1884 us_t2) (temp___is_init_1881 Bool) (temp___skip_constant_1882 Bool) (temp___do_toplevel_1883 Bool)) Bool (=> (not (= temp___skip_constant_1882 true)) (and (dynamic_property3 1 8 (first5 temp___expr_1884) (last5 temp___expr_1884)) (and (= (first5 temp___expr_1884) 1) (= (last5 temp___expr_1884) 8)))))
...
(assert (and (= (mk___t2 temp___7693 temp___76931) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7693 temp___76931) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___76931)) (to_rep (last4 temp___76931))) (+ (- (to_rep (last4 temp___76931)) (to_rep (first4 temp___76931))) 1) 0) (ite (<= 1 8) (+ (- 8 1) 1) 0)))
(assert (= temp___7693 temp___7694))
(assert (= (mk1 (to_rep (first4 temp___76931)) (to_rep (last4 temp___76931))) temp___76941))
(assert (not (= (ite (<= (to_rep (first2 temp___76941)) (to_rep (last2 temp___76941))) (+ (- (to_rep (last2 temp___76941)) (to_rep (first2 temp___76941))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
