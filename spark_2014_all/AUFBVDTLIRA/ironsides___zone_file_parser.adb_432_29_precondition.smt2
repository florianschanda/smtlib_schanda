...
(assert (= begidx3 o37))
(assert (and (and (and (and (<= begidx4 endidx2) (<= begidx4 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i50 Int)) (=> (and (<= begidx4 i50) (<= i50 endidx2)) (and (<= 48 (to_rep (select zonefileline i50))) (<= (to_rep (select zonefileline i50)) 57)))))) (and (and (in_range5 begidx4) (in_range5 endidx2)) (in_range4 foundtype2))))
(assert (= result13 (mk_bool__ref success24)))
(assert (= success25 (ite (= foundtype2 1) true false)))
(assert (= success25 true))
(declare-const i50 Int)
(assert (<= begidx4 i50))
(assert (<= i50 endidx2))
(assert (not (<= 48 (to_rep (select zonefileline i50)))))
(check-sat)
(exit)
