...
(assert (= begidx3 o33))
(assert (and (and (and (and (<= begidx4 endidx2) (<= begidx4 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i26 Int)) (=> (and (<= begidx4 i26) (<= i26 endidx2)) (and (<= 48 (to_rep (select zonefileline i26))) (<= (to_rep (select zonefileline i26)) 57)))))) (and (and (in_range5 begidx4) (in_range5 endidx2)) (in_range4 foundtype2))))
