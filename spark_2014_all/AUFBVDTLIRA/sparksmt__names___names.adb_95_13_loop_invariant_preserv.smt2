...
(assert (not (= i2 temp___686)))
(assert (= i2 result2))
(assert (= i3 (+ i2 1)))
(assert (and (= o5 (- (to_rep1 (first (rt s))) 1)) (in_range1 (- (to_rep1 (first (rt s))) 1))))
(assert (= o6 (+ i3 o5)))
(assert (and (= temp___6801 o6) (in_range1 o6)))
(assert (and (<= (to_rep1 (first (rt s))) temp___6801) (<= temp___6801 (to_rep1 (last (rt s))))))
(assert (= o7 temp___6801))
