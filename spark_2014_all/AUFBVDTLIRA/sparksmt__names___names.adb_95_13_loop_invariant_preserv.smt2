...
(assert (= i2 result2))
(assert (= i3 (+ i2 1)))
(assert (and (= o7 (- (to_rep1 (first (rt s))) 1)) (in_range1 (- (to_rep1 (first (rt s))) 1))))
(assert (= o8 (+ i3 o7)))
(assert (and (= temp___6801 o8) (in_range1 o8)))
(assert (and (<= (to_rep1 (first (rt s))) temp___6801) (<= temp___6801 (to_rep1 (last (rt s))))))
(assert (= o9 temp___6801))
(assert (= o10 (select (elts s) o9)))
(assert (= o11 (to_rep o10)))
(assert (and (and (= (length1 (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1)) (+ (length1 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields3))) 1)) (= (olt (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields3))) (model__ (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1))) true)) (= (get (model__ (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1)) (+ (last2 (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields3)))) 1)) o11)))
(assert (= result3 (mk___split_fields__ref (mk___split_fields char_table__split_fields3))))
(assert (= char_table__split_fields4 names__data__char_tables__append__2__container__fields1))
(assert (not (= (invariant__ hash_table char_table__split_fields4 (mk___split_fields1 entry_table__split_fields)) true)))
(check-sat)
(exit)
