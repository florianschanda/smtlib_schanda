...
(declare-const temp___261 (Array Int unsigned_8))
...
(assert (forall ((j Int)) (=> (and (<= i2 j) (<= j (to_rep sq__last))) (= (to_rep1 (select sq1 j)) (to_rep1 (select sq j))))))
(assert (and (and (and (=> (<= 0 (to_rep sq__last)) (dynamic_property1 0 (to_rep sq__last) i2)) (= (to_rep sq__first) 0)) (forall ((temp___267 Int)) (=> (and (<= (to_rep sq__first) temp___267) (<= temp___267 (to_rep sq__last))) (=> (<= i2 temp___267) (= (select sq1 temp___267) (select sq temp___267)))))) (and (<= 0 i2) (<= i2 (to_rep sq__last)))))
(assert (= (to_rep1 o) #x00))
(assert (and (<= (to_rep sq__first) i2) (<= i2 (to_rep sq__last))))
(assert (= o1 i2))
(assert (= temp___261 (store sq1 o1 o)))
(assert (= (to_rep sq__first) 0))
(assert (= o2 temp___261))
(assert (= result1 sq1))
(assert (= sq2 o2))
...
(assert (not (= (to_rep1 (select sq2 j)) (to_rep1 (select sq j)))))
(check-sat)
(exit)
