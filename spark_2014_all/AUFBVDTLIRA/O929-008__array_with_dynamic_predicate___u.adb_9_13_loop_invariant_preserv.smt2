...
(assert (and (and (and (=> (<= 0 (to_rep sq__last)) (dynamic_property1 0 (to_rep sq__last) i2)) (= (to_rep sq__first) 0)) (forall ((temp___232 Int)) (=> (and (<= (to_rep sq__first) temp___232) (<= temp___232 (to_rep sq__last))) (=> (<= i2 temp___232) (= (select sq1 temp___232) (select sq temp___232)))))) (and (<= 0 i2) (<= i2 (to_rep sq__last)))))
