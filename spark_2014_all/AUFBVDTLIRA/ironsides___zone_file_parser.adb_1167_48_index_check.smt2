...
(assert (= i2 r75b))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= temp___1739 i2)))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= temp___1738 tmpval1)))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= temp___1737 digitval)))
...
(assert (and (= temp___1742 o5) (in_range1 o5)))
(assert (not (<= temp___1742 128)))
(check-sat)
(exit)
