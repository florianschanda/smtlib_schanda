...
(assert (= (ite (<= (to_rep (first4 temp___89221)) (to_rep (last4 temp___89221))) (+ (- (to_rep (last4 temp___89221)) (to_rep (first4 temp___89221))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8922 temp___8923))
(assert (= (mk1 (to_rep (first4 temp___89221)) (to_rep (last4 temp___89221))) temp___89231))
(assert (= (ite (<= (to_rep (first2 temp___89231)) (to_rep (last2 temp___89231))) (+ (- (to_rep (last2 temp___89231)) (to_rep (first2 temp___89231))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8923 temp___89231)))
(assert (= o2 o))
