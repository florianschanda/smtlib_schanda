...
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1265) (<= temp___1265 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))))))
...
(assert (not (bvule ((_ zero_extend 8) ((_ int2bv 8) 0)) o20)))
(check-sat)
(exit)
