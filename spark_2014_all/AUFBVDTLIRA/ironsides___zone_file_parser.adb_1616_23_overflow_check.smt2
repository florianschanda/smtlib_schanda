...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= tokentype1 1) (forall ((i3 Int)) (=> (and (<= begidx2 i3) (<= i3 endidx1)) (and (<= 48 (to_rep (select zonefileline i3))) (<= (to_rep (select zonefileline i3)) 57)))))) (and (and (in_range5 begidx2) (in_range5 endidx1)) (in_range4 tokentype1))))
