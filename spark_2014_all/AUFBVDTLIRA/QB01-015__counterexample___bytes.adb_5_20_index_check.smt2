...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__bytes__record_struct__id (us_split_fields1 a))) (to_rep1 (rec__bytes__record_struct__id (us_split_fields1 b)))) (= (to_rep (rec__bytes__record_struct__length (us_split_fields1 a))) (to_rep (rec__bytes__record_struct__length (us_split_fields1 b))))) (= (bool_eq (rec__bytes__record_struct__payload (us_split_fields1 a)) #x0001 #x0100 (rec__bytes__record_struct__payload (us_split_fields1 b)) #x0001 #x0100) true)) true false))
