...
(define-fun dynamic_invariant ((temp___expr_6288 us_t1) (temp___is_init_6284 Bool) (temp___skip_constant_6285 Bool) (temp___do_toplevel_6286 Bool) (temp___do_typ_inv_6287 Bool)) Bool (=> (not (= temp___skip_constant_6285 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6288) (last3 temp___expr_6288)) (and (= (first3 temp___expr_6288) 1) (= (last3 temp___expr_6288) 1)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_6306 us_t2) (temp___is_init_6302 Bool) (temp___skip_constant_6303 Bool) (temp___do_toplevel_6304 Bool) (temp___do_typ_inv_6305 Bool)) Bool (=> (not (= temp___skip_constant_6303 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6306) (last5 temp___expr_6306)) (and (= (first5 temp___expr_6306) 1) (= (last5 temp___expr_6306) 1)))))
...
(declare-const temp___88201 t2)
(define-fun temp___88202 () us_t2 (mk___t2 temp___8820 temp___88201))
...
(assert (and (= temp___88202 (register_to_bytes reg)) (dynamic_invariant1 temp___88202 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___88201)) (to_rep (last4 temp___88201))) (+ (- (to_rep (last4 temp___88201)) (to_rep (first4 temp___88201))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
