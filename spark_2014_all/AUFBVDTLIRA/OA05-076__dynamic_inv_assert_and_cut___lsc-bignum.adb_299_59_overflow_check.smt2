...
(assert (= a1 result2))
(assert (= a2 o15))
(assert (and (= o53 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o54 (ite (<= k o53) true false)))
(assert (and (= o52 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o55 (ite (<= o52 k) true false)))
(assert (= result3 (ite (= o55 true) o54 false)))
(assert (= (= o56 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
...
(assert (= o38 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o37)))
(assert (= o51 (oadd o38 o50)))
(assert (= o32 (from_word32 carry2)))
(assert (and (= o31 (base Tuple0)) (= o31 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o33 (omultiply o31 o32)))
(assert (= o30 (from_word32 carry1)))
(assert (= o28 (from_word32 y)))
(assert (and (= o23 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o24 (- o23 a_first)))
(assert (and (= o25 o24) (in_range1 o24)))
(assert (and (= o26 o25) (in_range2 o25)))
(assert (= o27 (num_of_big_int c c_first o26)))
(assert (= o29 (omultiply o27 o28)))
(assert (= o21 (from_word32 x)))
