...
(declare-const temp___3142 (Array Int unsigned_32))
(declare-const temp___3143 state_range)
...
(declare-const temp___3182 (Array Int unsigned_32))
(declare-const temp___3183 state_range)
...
(assert (=> (= i1 623) (= (to_rep o20) (to_rep (select (rec__random__generator__state g__split_fields3) 623)))))
...
(assert (=> (= i1 623) (= temp___318 o22)))
(assert (=> (= i1 623) (= temp___3181 o23)))
(assert (=> (= i1 623) (= result5 (mk___split_fields__ref g__split_fields3))))
(assert (=> (= i1 623) (= g__split_fields4 (mk___split_fields temp___318 temp___3181))))
...
(assert (= o38 (bvxor (to_rep (select (rec__random__generator__state g__split_fields5) i4)) o34)))
...
(assert (= temp___3142 o44))
(assert (= temp___3143 o45))
(assert (= result10 (mk___split_fields__ref g__split_fields5)))
(assert (= g__split_fields6 (mk___split_fields temp___3142 temp___3143)))
(assert (=> (= i4 623) (= (to_rep o46) (to_rep (select (rec__random__generator__state g__split_fields6) 623)))))
...
(assert (=> (= i4 623) (= temp___3182 o48)))
(assert (=> (= i4 623) (= temp___3183 o49)))
(assert (=> (= i4 623) (= result11 (mk___split_fields__ref g__split_fields6))))
(assert (=> (= i4 623) (= g__split_fields7 (mk___split_fields temp___3182 temp___3183))))
