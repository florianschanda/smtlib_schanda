...
(assert (=> (= i1 623) (= g__split_fields4 (mk___split_fields temp___280 temp___2801))))
...
(assert (and (and (and (and (= (rec__random__generator__index g__split_fields5) (rec__random__generator__index g__split_fields2)) (=> (<= 1 (ite (< 624 (length initiator)) (length initiator) 624)) (dynamic_property1 1 (ite (< 624 (length initiator)) (length initiator) 624) k3))) (=> (<= 0 623) (in_range4 i4))) (=> (<= 0 2147483647) (in_range3 j3))) (and (<= 1 k3) (<= k3 (ite (< 624 (length initiator)) (length initiator) 624)))))
(assert (not (= k3 (ite (< 624 (length initiator)) (length initiator) 624))))
(assert (= result9 (mk_int__ref k3)))
(assert (= k4 (+ k3 1)))
...
(assert (=> (= i4 623) (= g__split_fields7 (mk___split_fields temp___2802 temp___2803))))
