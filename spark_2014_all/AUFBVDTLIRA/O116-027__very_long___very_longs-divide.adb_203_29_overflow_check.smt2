...
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1306) (<= temp___1306 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))))))
