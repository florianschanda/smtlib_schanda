...
(assert (=> (= (select issystem retvalini1) true) (= result__3 nodescription)))
...
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (= o7 result__3))))
...
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (forall ((temp___1283 Int)) (ite (and (<= 1 temp___1283) (<= temp___1283 (length thestring))) (= (select o8 temp___1283) (select temp___1282 temp___1283)) (= (select o8 temp___1283) (select result__3 temp___1283)))))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (= result5 (mk_map__ref result__3)))))
(assert (=> (= (select issystem retvalini1) true) (=> (= result4 true) (= result__4 o8))))
...
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result4 true)) (= result6 (mk_map__ref result__3)))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result4 true)) (= result__5 o9))))
(assert (=> (= (select issystem retvalini1) true) (=> (not (= result4 true)) (= result__4 result__5))))
(assert (=> (= (select issystem retvalini1) true) (= result7 (mk_map__ref c72b))))
(assert (=> (= (select issystem retvalini1) true) (= c72b2 result__4)))
...
(assert (=> (not (= (select issystem retvalini1) true)) (= result__4 result__)))
...
(assert (=> (not (= (select issystem retvalini1) true)) (= result__4 result__2)))
(assert (=> (not (= (select issystem retvalini1) true)) (= c72b2 c72b1)))
(assert (= (select issystem retvaldo2) true))
(assert (= retvaldo2 c82b))
(assert (in_range9 c82b))
(assert (= result8 (mk_map__ref result__1)))
(assert (= result__6 nodescription))
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b)))))) (= o10 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b))))))) (= o10 0)))
(assert (=> (<= 1 39) (= o11 (+ (- 39 1) 1))))
(assert (=> (not (<= 1 39)) (= o11 0)))
(assert (= o12 (+ o11 o10)))
(assert (= o13 (+ 1 o12)))
(assert (= o14 (- o13 1)))
(assert (and (= o15 o14) (in_range2 o14)))
(assert (= (concat1 (temp___String_Literal_1297 Tuple0) 1 39 (elts (to_string (attr__ATTRIBUTE_IMAGE9 c82b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c82b)))))) keystore__dofind__B86b__thestring__assume))
(assert (= (mk 1 o15) keystore__dofind__B86b__thestring__assume1))
(assert (= (mk___t keystore__dofind__B86b__thestring__assume keystore__dofind__B86b__thestring__assume1) thestring1))
(assert (dynamic_invariant thestring1 true false true))
(assert (and (= o16 (length thestring1)) (in_range1 (length thestring1))))
(assert (= result9 (ite (<= o16 150) true false)))
(assert (= result9 true))
(assert (= (ite (<= (to_rep1 (first (rt thestring1))) (to_rep1 (last (rt thestring1)))) (+ (- (to_rep1 (last (rt thestring1))) (to_rep1 (first (rt thestring1)))) 1) 0) (ite (<= 1 (length thestring1)) (+ (- (length thestring1) 1) 1) 0)))
(assert (= (slide (elts thestring1) (to_rep1 (first (rt thestring1))) 1) temp___1291))
(assert (= (mk2 1 (length thestring1)) temp___12911))
(assert (and (= temp___1293 (length thestring1)) (in_range1 (length thestring1))))
(assert (=> (<= 1 temp___1293) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1293) (<= temp___1293 150)))))
(assert (= o17 result__6))
(assert (= o17 temp___1294))
(assert (= (mk2 1 temp___1293) temp___12941))
(assert (not (= (ite (<= (to_rep1 (first4 temp___12911)) (to_rep1 (last4 temp___12911))) (+ (- (to_rep1 (last4 temp___12911)) (to_rep1 (first4 temp___12911))) 1) 0) (ite (<= (to_rep1 (first4 temp___12941)) (to_rep1 (last4 temp___12941))) (+ (- (to_rep1 (last4 temp___12941)) (to_rep1 (first4 temp___12941))) 1) 0))))
(check-sat)
(exit)
