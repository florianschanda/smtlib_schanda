...
(assert (=> (not (= rcx #x0000000000000000)) (= (mk_map__ref result) mem9)))
...
(assert (=> (not (= rcx #x0000000000000000)) (= mem8 (mk_map__ref mem4))))
(assert (=> (not (= rcx #x0000000000000000)) (= memory8 (mk_map__ref memory4))))
(assert (=> (not (= rcx #x0000000000000000)) (= rdi8 (mk_t__ref1 rdi4))))
(assert (=> (not (= rcx #x0000000000000000)) (= rcx8 (mk_t__ref1 rcx4))))
...
(assert (=> (not (not (= rcx #x0000000000000000))) (= mem8 mem9)))
(assert (=> (not (not (= rcx #x0000000000000000))) (= memory8 (mk_map__ref memory))))
(assert (=> (not (not (= rcx #x0000000000000000))) (= rdi8 (mk_t__ref1 rdi))))
(assert (=> (not (not (= rcx #x0000000000000000))) (= rcx8 (mk_t__ref1 rcx))))
...
(assert (not (= rcx_start #x0000000000000000)))
(assert (not (= (all_equal_rax rdi_start (bvsub rcx_start #x0000000000000001) memory6 rax) true)))
(check-sat)
(exit)
