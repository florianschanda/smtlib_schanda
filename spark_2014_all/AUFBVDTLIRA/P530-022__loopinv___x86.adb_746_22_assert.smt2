...
(define-fun mem8 () map__ref (mk_map__ref mem6))
(define-fun memory8 () map__ref (mk_map__ref memory6))
(define-fun rdi8 () t__ref1 (mk_t__ref1 rdi6))
(define-fun rcx8 () t__ref1 (mk_t__ref1 rcx6))
(define-fun mem9 () map__ref (mk_map__ref mem))
...
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub temp___337 rcx))) (=> (not (= i (bvsub temp___339 rcx))) (= (readmem64 (bvadd temp___338 (bvmul i ((_ int2bv 64) 8))) memory) rax))))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= (mk_map__ref result) mem9)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= mem2 memory)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (and (= (hasmem64 memory2 rdi rax) true) (= (nooverlap8equal memory2 memory rdi) true))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub rcx_start rcx))) (=> (not (= i (bvsub rcx_start rcx))) (= (hasmem64 mem2 (bvadd rdi_start (bvmul i ((_ int2bv 64) 8))) rax) true))))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub rcx_start rcx))) (=> (not (= i (bvsub rcx_start rcx))) (= (readmem64 (bvadd rdi_start (bvmul i ((_ int2bv 64) 8))) memory2) rax))))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= (readmem64 (bvadd rdi_start (bvmul (bvsub rcx_start rcx) ((_ int2bv 64) 8))) memory2) rax)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= (inrange64 i temp___345 (bvmul temp___346 ((_ int2bv 64) 8))) true)) (= (to_rep (select temp___344 i)) (to_rep (select memory3 i))))))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rdi2 (bvadd temp___347 (bvmul (bvsub temp___348 rcx2) ((_ int2bv 64) 8))))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= (inrange64 rdi2 temp___349 (bvmul temp___350 ((_ int2bv 64) 8))) true)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (bvule rcx2 temp___351)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= (readmem64 rdi2 memory3) rax)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= (readmem64 (bvadd temp___352 (bvmul (bvsub temp___353 rcx2) ((_ int2bv 64) 8))) memory3) rax)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i (bvsub temp___354 rcx2))) (= (readmem64 (bvadd temp___355 (bvmul i ((_ int2bv 64) 8))) memory3) rax)))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rdi2 result1)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rdi3 (bvadd rdi2 ((_ int2bv 64) 8)))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rcx2 result2)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rcx3 (bvsub rcx2 ((_ int2bv 64) 1)))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rcx3 ((_ int2bv 64) 0))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= mem3 mem4)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= memory3 memory4)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rdi3 rdi4)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rcx3 rcx4)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= mem5 mem3)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= memory5 memory3)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rdi5 rdi3)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rcx5 rcx3)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= mem8 (mk_map__ref mem4))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= memory8 (mk_map__ref memory4))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rdi8 (mk_t__ref1 rdi4))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rcx8 (mk_t__ref1 rcx4))))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= mem7 mem5)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= memory7 memory5)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rdi7 rdi5)))
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= rcx7 rcx5)))
(assert (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= mem8 mem9)))
(assert (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= memory8 (mk_map__ref memory))))
(assert (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= rdi8 (mk_t__ref1 rdi))))
(assert (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= rcx8 (mk_t__ref1 rcx))))
(assert (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= mem7 mem1)))
(assert (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= memory7 memory1)))
(assert (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= rdi7 rdi1)))
(assert (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= rcx7 rcx1)))
(assert (not (= rcx_start ((_ int2bv 64) 0))))
(assert (not (= (all_equal_rax rdi_start (bvsub rcx_start ((_ int2bv 64) 1)) memory6 rax) true)))
(check-sat)
(exit)
