...
(define-fun o12 () us_rep4 (mk___rep2 (mk___split_fields2 o3 o4 o5)))
...
(assert (and (= o12 (get1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) (= (bool_eq4 o12 (get1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) true)))
(assert (= o3 o6))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o9 o8))
...
(assert (and (= o11 ptr3) (in_range15 ptr3)))
(assert (not (<= o11 (last3 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields)))))))
(check-sat)
(exit)
