...
(assert (and (= (mk___rep2 (mk___split_fields2 o3 o4 o5)) (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o2)) (= (bool_eq4 (mk___rep2 (mk___split_fields2 o3 o4 o5)) (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o2)) true)))
(assert (= o3 o6))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o9 o8))
...
(assert (and (= o11 ptr3) (in_range14 ptr3)))
(assert (not (<= 1 o11)))
(check-sat)
(exit)
