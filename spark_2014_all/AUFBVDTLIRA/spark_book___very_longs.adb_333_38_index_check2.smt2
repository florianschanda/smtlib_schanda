...
(assert (and (= temp___1115 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) j2)) (in_range2 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) j2))))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 result____split_fields8))))) temp___1115)))
(check-sat)
(exit)
