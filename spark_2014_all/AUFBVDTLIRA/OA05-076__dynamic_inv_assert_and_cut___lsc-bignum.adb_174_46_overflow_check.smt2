...
(assert (and (and (=> (<= 0 2147483647) (in_range2 j1)) (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2))) (and (<= a_first i2) (<= i2 a_last))))
(assert (and (= o6 (- a_last i2)) (in_range1 (- a_last i2))))
...
(assert (= o8 (num_of_big_int b o5 o7)))
(assert (not (in_range1 (- a_last i2))))
(check-sat)
(exit)
