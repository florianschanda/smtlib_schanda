...
(define-fun dynamic_invariant3 ((temp___expr_349 (_ BitVec 16)) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool) (temp___do_typ_inv_348 Bool)) Bool true)
...
(declare-datatypes () ((tS20bP1__ref (mk_tS20bP1__ref (tS20bP1__content tdigit_index_typeB)))))
(define-fun tS20bP1__ref___projection ((a tS20bP1__ref)) tdigit_index_typeB (tS20bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((s20b__ref (mk_s20b__ref (s20b__content us_t1)))))
(define-fun s20b__ref___projection ((a s20b__ref)) us_t1 (s20b__content a))
...
(declare-datatypes () ((t22b__ref (mk_t22b__ref (t22b__content tdigit_index_typeB)))))
(define-fun t22b__ref___projection ((a t22b__ref)) tdigit_index_typeB (t22b__content a))
(declare-sort t2 0)
...
(declare-fun temp_____aggregate_def_1240 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1242 (_ BitVec 8))) (forall ((temp___1243 Int) (temp___1244 Int)) (let ((temp___1241 (temp_____aggregate_def_1240 temp___1242 temp___1243 temp___1244))) (=> (dynamic_invariant temp___1242 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1243 temp___1244) (and (= (first5 temp___1241) temp___1243) (= (last5 temp___1241) temp___1244))) (forall ((temp___1245 Int)) (= (to_rep2 (select (to_array2 temp___1241) temp___1245)) temp___1242))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_418 us_t1) (temp___is_init_414 Bool) (temp___skip_constant_415 Bool) (temp___do_toplevel_416 Bool) (temp___do_typ_inv_417 Bool)) Bool (=> (not (= temp___skip_constant_415 true)) (and (dynamic_property3 1 r21b (first3 temp___expr_418) (last3 temp___expr_418)) (and (= (first3 temp___expr_418) 1) (= (last3 temp___expr_418) r21b)))))
...
(declare-const i Int)
(declare-const temp___1247 (Array Int octet))
(declare-const temp___12471 t2)
(declare-const temp___1248 (Array Int octet))
(declare-const temp___12481 t1)
(declare-const temp___1250 (Array Int octet))
(declare-const temp___12501 t1)
(declare-const o (Array Int octet))
(declare-const o1 t)
(declare-const o2 (Array Int octet))
(declare-const o3 t)
(declare-const temp___1252 digit_index_type)
(declare-const temp___12521 (Array Int octet))
(declare-const temp___12522 t)
...
(assert (= (to_rep (rec__very_longs__very_long__octet_length result____split_discrs)) r21b))
(assert (in_range1 r21b))
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_1240 #x00 1 r21b)))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_1240 #x00 1 r21b)))) r21b))
(assert (= (mk___t2 temp___1247 temp___12471) (temp_____aggregate_def_1240 #x00 1 r21b)))
(assert (= (ite (<= (to_rep1 (first4 temp___12471)) (to_rep1 (last4 temp___12471))) (+ (- (to_rep1 (last4 temp___12471)) (to_rep1 (first4 temp___12471))) 1) 0) (ite (<= 1 r21b) (+ (- r21b 1) 1) 0)))
(assert (= temp___1247 temp___1248))
(assert (= (mk1 (to_rep1 (first4 temp___12471)) (to_rep1 (last4 temp___12471))) temp___12481))
(assert (= (ite (<= (to_rep1 (first2 temp___12481)) (to_rep1 (last2 temp___12481))) (+ (- (to_rep1 (last2 temp___12481)) (to_rep1 (first2 temp___12481))) 1) 0) (ite (<= (to_rep1 (first result____split_fields1)) (to_rep1 (last result____split_fields1))) (+ (- (to_rep1 (last result____split_fields1)) (to_rep1 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1250 temp___12501) (mk___t1 temp___1248 temp___12481)))
(assert (= temp___1250 o))
(assert (= (mk (to_rep1 (first2 temp___12501)) (to_rep1 (last2 temp___12501))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1252)))
(assert (= temp___12521 o2))
(assert (= temp___12522 o3))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___12521 temp___12522))))
(assert (= result____split_discrs (mk___split_discrs temp___1252)))
...
(assert (and (and (dynamic_invariant2 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1265 Int)) (=> (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1265) (<= temp___1265 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (or (< (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) temp___1265) (or (< temp___1265 1) (<= i2 temp___1265))) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1265) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1265)))))) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
