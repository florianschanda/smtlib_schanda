...
(define-fun dynamic_invariant3 ((temp___expr_751 us_rep1) (temp___is_init_747 Bool) (temp___skip_constant_748 Bool) (temp___do_toplevel_749 Bool) (temp___do_typ_inv_750 Bool)) Bool (and (=> (not (= temp___skip_constant_748 true)) (in_range3 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_751))) (and (dynamic_property3 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_751))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_751)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_751))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_751))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_754 us_rep1) (temp___skip_top_level_755 Bool)) Bool (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_754))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
...
(declare-fun temp___1232 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1234 (_ BitVec 8))) (forall ((temp___1235 Int) (temp___1236 Int)) (let ((temp___1233 (temp___1232 temp___1234 temp___1235 temp___1236))) (=> (dynamic_invariant1 temp___1234 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1235 temp___1236) (and (= (first5 temp___1233) temp___1235) (= (last5 temp___1233) temp___1236))) (forall ((temp___1237 Int)) (= (to_rep (select (to_array2 temp___1233) temp___1237)) temp___1234))))))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1232 #x00 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1232 #x00 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___1239 temp___12391) (temp___1232 #x00 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep2 (first4 temp___12391)) (to_rep2 (last4 temp___12391))) (+ (- (to_rep2 (last4 temp___12391)) (to_rep2 (first4 temp___12391))) 1) 0) (ite (<= 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0)))
...
(assert (and (and (dynamic_invariant3 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___1251 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))) temp___1251) (<= temp___1251 (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= i2 temp___1251) (= (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)) temp___1251) (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields2)) temp___1251)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
