...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___173 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___173) (first3 temp___173) (last3 temp___173))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___172 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___172) (first1 temp___172) (last1 temp___172))))))
...
(define-fun dynamic_invariant3 ((temp___expr_693 us_rep1) (temp___is_init_690 Bool) (temp___skip_constant_691 Bool) (temp___do_toplevel_692 Bool)) Bool (and (=> (not (= temp___skip_constant_691 true)) (in_range3 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_693))) (and (dynamic_property3 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_693))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_693)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_693))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_693))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_696 us_rep1) (temp___skip_top_level_697 Bool)) Bool (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_696))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
...
(assert (forall ((temp___1149 (_ BitVec 8))) (forall ((temp___1150 Int) (temp___1151 Int)) (let ((temp___1148 (temp___1147 temp___1149 temp___1150 temp___1151))) (and (=> (dynamic_property6 1 2147483647 temp___1150 temp___1151) (and (= (first5 temp___1148) temp___1150) (= (last5 temp___1148) temp___1151))) (forall ((temp___1152 Int)) (= (select (to_array2 temp___1148) temp___1152) (of_rep temp___1149))))))))
(define-fun dynamic_invariant4 ((temp___expr_271 Int) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (=> (or (= temp___is_init_268 true) (<= 1 2147483647)) (in_range1 temp___expr_271)))
...
(declare-const i Int)
(declare-const aco__math__very_longs__modsubtract__result digit_index_type)
(declare-const aco__math__very_longs__modsubtract__result1 (Array Int octet))
(declare-const aco__math__very_longs__modsubtract__result2 t)
...
(declare-const temp___1170 (_ BitVec 16))
(declare-const temp___1169 (_ BitVec 16))
(declare-const temp___1168 (_ BitVec 16))
(declare-const temp___1167 (_ BitVec 16))
(declare-const temp___1164 us_rep1)
...
(declare-const temp___1163 us_rep1)
...
(declare-const aco__math__very_longs__modsubtract__result3 us_rep)
(declare-const aco__math__very_longs__modsubtract__result4 very_long__ref)
(declare-const aco__math__very_longs__modsubtract__result5 us_rep)
...
(declare-const aco__math__very_longs__modsubtract__result6 very_long__ref)
...
(declare-const aco__math__very_longs__modsubtract__result7 us_rep)
...
(assert (and (= us2 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
...
(assert true)
(assert true)
(assert (= (to_rep2 (first4 (rt2 (temp___1147 ((_ int2bv 8) 0) 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1147 ((_ int2bv 8) 0) 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___1154 temp___11541) (temp___1147 ((_ int2bv 8) 0) 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep2 (first4 temp___11541)) (to_rep2 (last4 temp___11541))) (+ (- (to_rep2 (last4 temp___11541)) (to_rep2 (first4 temp___11541))) 1) 0) (ite (<= 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___1154 temp___1155))
(assert (= (mk1 (to_rep2 (first4 temp___11541)) (to_rep2 (last4 temp___11541))) temp___11551))
(assert (= (ite (<= (to_rep2 (first2 temp___11551)) (to_rep2 (last2 temp___11551))) (+ (- (to_rep2 (last2 temp___11551)) (to_rep2 (first2 temp___11551))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
...
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___11581 temp___11582))))
(assert (= result____split_discrs (mk___split_discrs temp___1158)))
...
(assert (and (and (dynamic_invariant3 (mk___rep1 result____split_discrs result____split_fields3) false true true) (forall ((temp___1166 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))) temp___1166) (<= temp___1166 (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= i2 temp___1166) (= (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields3)) temp___1166) (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields2)) temp___1166)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
