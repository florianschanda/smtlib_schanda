...
(assert (= (let ((temp___223 (to_model (mk___rep r__split_fields19)))) (bool_eq (elts temp___223) (to_rep (first (rt temp___223))) (to_rep (last (rt temp___223))) (temp___219 0) ((_ int2bv 16) 1) ((_ int2bv 16) 0))) true))
(assert (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields19)) x))) (let ((temp___230 (to_model (mk___rep r__split_fields18)))) (bool_eq (elts temp___230) (to_rep (first (rt temp___230))) (to_rep (last (rt temp___230))) (elts temp___231) (to_rep (first (rt temp___231))) (to_rep (last (rt temp___231)))))) true))
(assert (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields18)) y))) (let ((temp___230 (to_model (mk___rep r__split_fields17)))) (bool_eq (elts temp___230) (to_rep (first (rt temp___230))) (to_rep (last (rt temp___230))) (elts temp___231) (to_rep (first (rt temp___231))) (to_rep (last (rt temp___231)))))) true))
(assert (and (and (= (let ((temp___235 (func_pop (to_model (mk___rep r__split_fields17))))) (let ((temp___234 (to_model (mk___rep r__split_fields16)))) (bool_eq (elts temp___234) (to_rep (first (rt temp___234))) (to_rep (last (rt temp___234))) (elts temp___235) (to_rep (first (rt temp___235))) (to_rep (last (rt temp___235)))))) true) (= h1 (func_head (to_model (mk___rep r__split_fields17))))) (in_range h1)))
(assert (= h1 x))
(assert (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields16)) z))) (let ((temp___230 (to_model (mk___rep r__split_fields15)))) (bool_eq (elts temp___230) (to_rep (first (rt temp___230))) (to_rep (last (rt temp___230))) (elts temp___231) (to_rep (first (rt temp___231))) (to_rep (last (rt temp___231)))))) true))
