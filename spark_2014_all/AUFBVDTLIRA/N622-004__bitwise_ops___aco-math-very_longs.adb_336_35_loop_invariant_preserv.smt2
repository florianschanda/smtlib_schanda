...
(assert (not (or (not (= (to_rep (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) digit_index4)) ((_ int2bv 8) 0))) (exists ((j Int)) (and (and (<= (+ i3 1) j) (<= j (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))))) (not (= (to_rep (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) j)) ((_ int2bv 8) 0))))))))
(check-sat)
(exit)
