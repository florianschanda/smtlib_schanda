...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= tokentype1 1) (forall ((i4 Int)) (=> (and (<= begidx2 i4) (<= i4 endidx1)) (and (<= 48 (to_rep (select zonefileline i4))) (<= (to_rep (select zonefileline i4)) 57)))))) (and (and (in_range5 begidx2) (in_range5 endidx1)) (in_range4 tokentype1))))
...
(assert (and (= temp___1829 o2) (in_range1 o2)))
(assert (and (<= 1 temp___1829) (<= temp___1829 256)))
(assert (= o4 temp___1829))
