...
(assert true)
(assert true)
(assert (and (= (readmem64 rdi memory) rax) (= rdi (bvadd rdi_start (bvmul (bvsub rcx_start rcx) ((_ int2bv 64) 8))))))
(assert (not (= (readmem64 (bvadd rdi_start (bvmul (bvsub rcx_start rcx) ((_ int2bv 64) 8))) memory) rax)))
(check-sat)
(exit)
