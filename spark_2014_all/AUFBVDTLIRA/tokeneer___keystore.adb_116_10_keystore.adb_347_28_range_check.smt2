...
(assert (= (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) temp___1278))
(assert (= (mk1 1 (length thestring)) temp___12781))
(assert (and (= temp___1280 (length thestring)) (in_range1 (length thestring))))
(assert (<= 1 temp___1280))
(assert (not (<= 1 1)))
(check-sat)
(exit)
