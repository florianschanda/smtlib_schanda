...
(assert (and (and (and (= us (to_rep (rec__very_longs__very_long__length (us_split_discrs1 number)))) (in_range2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 number))))) (and (and (= (mk_int__ref result) (mk_int__ref digit_count)) (= digit_count1 0)) (and (in_range1 digit_count1) (and (and (and (and (= o (is_zero number)) (= (= o true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j1)) ((_ int2bv 8) 0)))))) (= result1 (ite (not (= o true)) true false))) (ite (= result1 true) (and (and (and (= (mk_int__ref result2) (mk_int__ref i)) (= i3 1)) (ite (and (<= 1 i3) (<= i3 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (and (and (and (= temp___876 i3) (and (= temp___875 digit_count1) (and (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i3) (<= i3 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= o1 i3)) (= o2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) o1))) (= o3 (to_rep1 o2))) (= o4 (ite (= o3 ((_ int2bv 8) 0)) true false))) (= result3 (ite (not (= o4 true)) true false))) (ite (= result3 true) (and (and (= o5 i3) (in_range1 i3)) (and (= digit_count1 result4) (= digit_count2 o5))) (= digit_count2 digit_count1))) (and (=> (< digit_count3 i4) (forall ((j1 Int)) (=> (and (<= (+ digit_count3 1) j1) (<= j1 i4)) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j1)) ((_ int2bv 8) 0))))) (and (and (and (=> (<= 0 65536) (in_range1 digit_count3)) (=> (<= 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))) (dynamic_property2 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i4))) (and (<= 1 i4) (<= i4 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))) (= i4 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))))) (and (and (= i4 i8) (= digit_count3 digit_count7)) (and (= i9 i4) (= digit_count8 digit_count3)))) (and (and (= (mk_int__ref i10) (mk_int__ref i8)) (= (mk_int__ref digit_count9) (mk_int__ref digit_count7))) (and (= i11 i9) (= digit_count10 digit_count8)))) (and (and (= i3 i10) (= digit_count1 digit_count9)) (and (= i11 i3) (= digit_count10 digit_count1))))) (and (and (= (mk_int__ref i12) (mk_int__ref i10)) (= (mk_int__ref digit_count11) (mk_int__ref digit_count9))) (and (= i13 i11) (= digit_count12 digit_count10)))) (and (and (= (mk_int__ref i12) (mk_int__ref i)) (= digit_count1 digit_count11)) (and (= i13 i2) (= digit_count12 digit_count1))))) (and (and (= very_longs__number_of_digits__result1 very_longs__number_of_digits__result2) (= very_longs__number_of_digits__result3 very_longs__number_of_digits__result1)) (and (= (mk_int__ref result8) (mk_int__ref very_longs__number_of_digits__result)) (= very_longs__number_of_digits__result1 digit_count11))))))) (and (and (= (mk_int__ref very_longs__number_of_digits__result4) (mk_int__ref very_longs__number_of_digits__result2)) (and (= (mk_int__ref i14) (mk_int__ref i12)) (= (mk_int__ref digit_count13) (mk_int__ref digit_count11)))) (and (= very_longs__number_of_digits__result5 very_longs__number_of_digits__result3) (and (= i15 i13) (= digit_count14 digit_count12))))))
(assert (= (= o11 true) (forall ((i16 Int)) (=> (and (<= (+ very_longs__number_of_digits__result4 1) i16) (<= i16 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) i16)) ((_ int2bv 8) 0))))))
