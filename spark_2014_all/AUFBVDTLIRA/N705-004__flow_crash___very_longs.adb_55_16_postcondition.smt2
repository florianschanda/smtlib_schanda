...
(assert (and (and (and (= us (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))) (in_range1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r))))) (and (and (= us1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))) (and (and (= (to_rep (rec__very_longs__very_long__octet_length result____split_discrs)) r10b) (in_range1 r10b)) (and (and (and (and (and (and (and (and (= (to_rep2 (first4 (rt2 (temp___1142 ((_ int2bv 8) 0) 1 r10b)))) 1) (and (= (to_rep2 (last4 (rt2 (temp___1142 ((_ int2bv 8) 0) 1 r10b)))) r10b) (= (mk___t2 temp___1149 temp___11491) (temp___1142 ((_ int2bv 8) 0) 1 r10b)))) (and (= (ite (<= (to_rep2 (first4 temp___11491)) (to_rep2 (last4 temp___11491))) (+ (- (to_rep2 (last4 temp___11491)) (to_rep2 (first4 temp___11491))) 1) 0) (ite (<= 1 r10b) (+ (- r10b 1) 1) 0)) (and (= temp___1149 temp___1150) (= (mk1 (to_rep2 (first4 temp___11491)) (to_rep2 (last4 temp___11491))) temp___11501)))) (and (= (ite (<= (to_rep2 (first2 temp___11501)) (to_rep2 (last2 temp___11501))) (+ (- (to_rep2 (last2 temp___11501)) (to_rep2 (first2 temp___11501))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)) (= (mk___t1 temp___1152 temp___11521) (mk___t1 temp___1150 temp___11501)))) (and (= temp___1152 o) (= (mk (to_rep2 (first2 temp___11521)) (to_rep2 (last2 temp___11521))) o1))) (and (= o2 o) (= o3 o1))) (and (= result____split_discrs (mk___split_discrs temp___1154)) (and (= temp___11541 o2) (= temp___11542 o3)))) (and (and (= result (mk___split_fields__ref (mk___split_fields (mk___t result____split_fields result____split_fields1)))) (= result____split_fields2 (mk___split_fields (mk___t temp___11541 temp___11542)))) (= result____split_discrs (mk___split_discrs temp___1154)))) (and (and (= result1 (mk_t__ref1 carry)) (= carry1 ((_ int2bv 16) 0))) (and (and (= result2 (mk_int__ref i)) (= i1 1)) (ite (and (<= 1 i1) (<= i1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (and (and (and (= temp___1166 sum) (and (= temp___1165 r_digit) (and (= temp___1164 carry1) (and (= temp___1163 l_digit) (and (and (= result____split_discrs (mk___split_discrs temp___1160)) (= result____split_fields2 (mk___split_fields (mk___t temp___11601 temp___11602)))) (and (and (and (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true) (and (= (rec__very_longs__very_long__octet_length result____split_discrs) temp___1160) (forall ((temp___1162 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1162) (<= temp___1162 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1162) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1162) (select temp___11601 temp___1162))))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))) (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o4 i2)) (= o5 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 l))) o4))) (= o6 (to_rep1 o5))) (= o7 ((_ zero_extend 8) o6))) (and (= result3 (mk_t__ref1 l_digit2)) (= l_digit3 o7))) (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))) i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= o8 i2)) (= o9 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 r))) o8))) (= o10 (to_rep1 o9))) (= o11 ((_ zero_extend 8) o10))) (and (= result4 (mk_t__ref1 r_digit2)) (= r_digit3 o11))) (and (and (= result5 (mk_t__ref1 sum2)) (= sum3 (bvadd (bvadd l_digit3 r_digit3) carry2))) (and (and (and (= o12 (shift_right sum3 8)) (= o12 (bvudiv sum3 (ite (< 8 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) 8)) ((_ int2bv 16) 0))))) (and (= result6 (mk_t__ref1 carry2)) (= carry3 o12))) (and (and (and (and (and (and (and (= o13 (takelsb_from16 sum3)) (= (to_rep1 o14) o13)) (and (and (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (= o15 i2)) (= o16 (store (elts (rec__very_longs__very_long__long_digits result____split_fields3)) o15 o14)))) (= o17 (mk___t o16 (rt (rec__very_longs__very_long__long_digits result____split_fields3))))) (= o18 (mk___split_fields o17))) (= temp___1159 (mk___rep result____split_discrs o18))) (and (and (= result7 (mk___split_fields__ref result____split_fields3)) (= result____split_fields4 (us_split_fields1 temp___1159))) (= result____split_discrs (us_split_discrs1 temp___1159)))) (= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))))))))))))) (and (and (= i3 (mk_int__ref i2)) (and (= sum4 (mk_t__ref1 sum3)) (and (= r_digit4 (mk_t__ref1 r_digit3)) (and (= l_digit4 (mk_t__ref1 l_digit3)) (and (= carry4 (mk_t__ref1 carry3)) (= result____split_fields5 (mk___split_fields__ref result____split_fields4))))))) (and (= i4 i2) (and (= sum5 sum3) (and (= r_digit5 r_digit3) (and (= l_digit5 l_digit3) (and (= carry5 carry3) (= result____split_fields6 result____split_fields4)))))))) (and (and (= i5 i3) (and (= sum6 sum4) (and (= r_digit6 r_digit4) (and (= l_digit6 l_digit4) (and (= carry6 carry4) (= result____split_fields7 result____split_fields5)))))) (and (= i6 i4) (and (= sum7 sum5) (and (= r_digit7 r_digit5) (and (= l_digit7 l_digit5) (and (= carry7 carry5) (= result____split_fields8 result____split_fields6)))))))) (and (and (= i5 (mk_int__ref i1)) (and (= sum6 (mk_t__ref1 sum)) (and (= r_digit6 (mk_t__ref1 r_digit)) (and (= l_digit6 (mk_t__ref1 l_digit)) (and (= carry6 (mk_t__ref1 carry1)) (= result____split_fields7 (mk___split_fields__ref result____split_fields2))))))) (and (= i6 i1) (and (= sum7 sum1) (and (= r_digit7 r_digit1) (and (= l_digit7 l_digit1) (and (= carry7 carry1) (= result____split_fields8 result____split_fields2)))))))))))))) (and (and (= i7 i5) (and (= sum8 sum6) (and (= r_digit8 r_digit6) (and (= l_digit8 l_digit6) (and (= carry8 carry6) (= result____split_fields9 result____split_fields7)))))) (and (= i8 i6) (and (= sum9 sum7) (and (= r_digit9 r_digit7) (and (= l_digit9 l_digit7) (and (= carry9 carry7) (= result____split_fields10 result____split_fields8)))))))))
