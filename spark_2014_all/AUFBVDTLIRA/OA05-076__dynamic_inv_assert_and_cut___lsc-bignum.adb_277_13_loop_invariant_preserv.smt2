...
(assert (= result5 i2))
(assert (= i3 (+ i2 1)))
(assert (not (= (oeq (oadd (oadd (oadd (oadd (num_of_big_int (mk___t a (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1) (- i3 a_first)) (omultiply (num_of_big_int b b_first (- i3 a_first)) (from_word32 x))) (omultiply (num_of_big_int c c_first (- i3 a_first)) (from_word32 y))) (from_word32 carry1)) (omultiply (base Tuple0) (from_word32 carry2))) (oadd (num_of_big_int (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) a_first (- i3 a_first)) (omultiply (oexpon (base Tuple0) (- i3 a_first)) (oadd (from_word32 carry13) (omultiply (base Tuple0) (from_word32 carry23)))))) true)))
(check-sat)
(exit)
