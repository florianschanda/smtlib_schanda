...
(assert (= (ite (<= (to_rep (first2 temp___88761)) (to_rep (last2 temp___88761))) (+ (- (to_rep (last2 temp___88761)) (to_rep (first2 temp___88761))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8876 temp___8877))
(assert (= (mk2 (to_rep (first2 temp___88761)) (to_rep (last2 temp___88761))) temp___88771))
(assert (not (= (ite (<= (to_rep (first4 temp___88771)) (to_rep (last4 temp___88771))) (+ (- (to_rep (last4 temp___88771)) (to_rep (first4 temp___88771))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
