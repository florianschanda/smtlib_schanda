...
(assert (= o7 (to_rep o6)))
(assert (and (= result4 (has_key (model__ (mk___rep result____split_discrs result____split_fields4)) o7)) (= (= result4 true) (= (has_key (model__ (mk___rep result____split_discrs result____split_fields4)) o7) true))))
(assert (= result4 true))
(assert (and (<= (to_rep1 (first (rt a))) i) (<= i (to_rep1 (last (rt a))))))
(assert (= o2 i))
