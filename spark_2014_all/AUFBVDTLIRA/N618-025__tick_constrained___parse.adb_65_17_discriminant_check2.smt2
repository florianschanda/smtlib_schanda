...
(declare-const o23 return_code_t)
(declare-const o24 us_split_discrs)
(declare-const temp___383 us_rep2)
...
(assert (= count2 o22))
(assert (not (= count2 #x0000)))
(assert (= (to_rep2 (rec__parse__parse_result_t__return_code result____split_discrs6)) r22b))
(assert (in_range3 r22b))
(assert (= (to_rep2 o23) 1))
(assert (= o24 (mk___split_discrs o23)))
(assert (= temp___383 (mk___rep2 o24 (mk___split_fields2 dummy8) true)))
(assert (= result____attr__constrained true))
(assert (not (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___383)) (rec__parse__parse_result_t__return_code result____split_discrs6))))
(check-sat)
(exit)
