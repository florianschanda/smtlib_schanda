...
(assert (and (= (readmem8 (bvadd addr ((_ int2bv 64) 1)) memory2) o3) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 1)))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))
(assert (= tmp2 tmp1))
