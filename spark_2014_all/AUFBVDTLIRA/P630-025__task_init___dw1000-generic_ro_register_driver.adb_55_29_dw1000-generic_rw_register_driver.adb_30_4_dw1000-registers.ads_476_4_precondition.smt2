...
(define-fun dynamic_invariant ((temp___expr_5645 us_t1) (temp___is_init_5642 Bool) (temp___skip_constant_5643 Bool) (temp___do_toplevel_5644 Bool)) Bool (=> (not (= temp___skip_constant_5643 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5645) (last3 temp___expr_5645)) (and (= (first3 temp___expr_5645) 1) (= (last3 temp___expr_5645) 4)))))
