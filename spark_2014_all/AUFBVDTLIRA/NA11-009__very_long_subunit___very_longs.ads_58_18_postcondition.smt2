...
(declare-const temp___1057 us_rep1)
...
(assert (= j1 1))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1070 t_digit)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1069 r_digit)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1068 l_digit)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1065 (mk___rep1 result____split_discrs result____split_fields2))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1064 carry)))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= temp___1063 temp)))
...
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1062 t_digit2))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1061 r_digit2))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1060 l_digit2))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1057 (mk___rep1 result____split_discrs result____split_fields3)))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1056 carry3))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1055 temp2))))
...
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) r92b))))
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (in_range2 r92b))))
...
(assert (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))) (=> (and (<= 1 i3) (<= i3 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o16 (ite (<= o15 r92b) true false)))))
