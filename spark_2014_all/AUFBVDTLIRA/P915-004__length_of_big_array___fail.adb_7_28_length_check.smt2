...
(assert (forall ((temp___626 Bool)) (forall ((temp___627 (_ BitVec 64)) (temp___628 (_ BitVec 64))) (let ((temp___625 (fail__create__r__aggregate_def temp___626 temp___627 temp___628))) (and (=> (dynamic_property ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551615) temp___627 temp___628) (and (= (first5 temp___625) temp___627) (= (last6 temp___625) temp___628))) (forall ((temp___629 (_ BitVec 64))) (= (select (to_array2 temp___625) temp___629) temp___626)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_619 us_t1) (temp___is_init_616 Bool) (temp___skip_constant_617 Bool) (temp___do_toplevel_618 Bool)) Bool (=> (not (= temp___skip_constant_617 true)) (and (dynamic_property2 ((_ int2bv 64) 0) last2 (first3 temp___expr_619) (last4 temp___expr_619)) (and (= (first3 temp___expr_619) ((_ int2bv 64) 0)) (= (last4 temp___expr_619) last2)))))
...
(declare-const temp___631 (Array (_ BitVec 64) Bool))
(declare-const temp___6311 t2)
...
(assert (= (mk___t2 temp___631 temp___6311) (fail__create__r__aggregate_def (of_int 0) ((_ int2bv 64) 0) last2)))
(assert (not (= (ite (<= (bv2nat (to_rep (first4 temp___6311))) (bv2nat (to_rep (last5 temp___6311)))) (+ (- (bv2nat (to_rep (last5 temp___6311))) (bv2nat (to_rep (first4 temp___6311)))) 1) 0) (ite (<= (bv2nat ((_ int2bv 64) 0)) (bv2nat last2)) (+ (- (bv2nat last2) (bv2nat ((_ int2bv 64) 0))) 1) 0))))
(check-sat)
(exit)
