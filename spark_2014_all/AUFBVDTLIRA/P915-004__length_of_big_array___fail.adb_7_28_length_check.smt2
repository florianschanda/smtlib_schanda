...
(assert (forall ((temp___715 Bool)) (forall ((temp___716 (_ BitVec 64)) (temp___717 (_ BitVec 64))) (let ((temp___714 (fail__create__r__aggregate_def temp___715 temp___716 temp___717))) (and (=> (dynamic_property #x0000000000000000 #xFFFFFFFFFFFFFFFF temp___716 temp___717) (and (= (first5 temp___714) temp___716) (= (last6 temp___714) temp___717))) (forall ((temp___718 (_ BitVec 64))) (= (select (to_array2 temp___714) temp___718) temp___715)))))))
...
(define-fun dynamic_invariant2 ((temp___expr_708 us_t1) (temp___is_init_704 Bool) (temp___skip_constant_705 Bool) (temp___do_toplevel_706 Bool) (temp___do_typ_inv_707 Bool)) Bool (=> (not (= temp___skip_constant_705 true)) (and (dynamic_property2 #x0000000000000000 last2 (first3 temp___expr_708) (last4 temp___expr_708)) (and (= (first3 temp___expr_708) #x0000000000000000) (= (last4 temp___expr_708) last2)))))
(declare-const temp___720 (Array (_ BitVec 64) Bool))
...
(assert (= (mk___t2 temp___720 temp___7201) (fail__create__r__aggregate_def (distinct 0 0) #x0000000000000000 last2)))
(assert (not (= (ite (<= (bv2nat (to_rep (first4 temp___7201))) (bv2nat (to_rep (last5 temp___7201)))) (+ (- (bv2nat (to_rep (last5 temp___7201))) (bv2nat (to_rep (first4 temp___7201)))) 1) 0) (ite (<= (bv2nat #x0000000000000000) (bv2nat last2)) (+ (- (bv2nat last2) (bv2nat #x0000000000000000)) 1) 0))))
(check-sat)
(exit)
