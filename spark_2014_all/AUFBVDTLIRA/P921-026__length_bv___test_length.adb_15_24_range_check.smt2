...
(assert (forall ((c (_ BitVec 16))) (! (=> (dynamic_invariant c true true true true) (let ((result (create c))) (and (and (= (first1 result) #x0000) (= (last1 result) c)) (dynamic_invariant1 result true false true true)))) :pattern ((create c)))))
...
(assert (and (= test_length__p2__a1__assume2 (create #xFFFF)) (and (dynamic_invariant1 test_length__p2__a1__assume2 true false true true) (and (= (to_rep (first test_length__p2__a1__assume1)) #x0000) (= (to_rep (last test_length__p2__a1__assume1)) #xFFFF)))))
(assert (= result a1))
...
(assert (dynamic_property #x0000 #xFFFF (to_rep a1__first) (to_rep a1__last)))
