...
(assert (forall ((c (_ BitVec 16))) (! (=> (dynamic_invariant c true true true) (let ((result (create c))) (and (and (= (first1 result) ((_ int2bv 16) 0)) (= (last1 result) c)) (dynamic_invariant1 result true false true)))) :pattern ((create c)))))
...
(declare-const test_length__p2__a1__assume (Array (_ BitVec 16) natural))
(declare-const test_length__p2__a1__assume1 t)
(declare-const o Int)
(declare-const result (Array (_ BitVec 16) natural))
(declare-const a11 (Array (_ BitVec 16) natural))
(define-fun test_length__p2__a1__assume2 () us_t (mk___t test_length__p2__a1__assume test_length__p2__a1__assume1))
(assert (and (= test_length__p2__a1__assume2 (create ((_ int2bv 16) 65535))) (and (dynamic_invariant1 test_length__p2__a1__assume2 true false true) (and (= (to_rep (first test_length__p2__a1__assume1)) ((_ int2bv 16) 0)) (= (to_rep (last test_length__p2__a1__assume1)) ((_ int2bv 16) 65535))))))
(assert (= result a1))
(assert (= a11 test_length__p2__a1__assume))
(assert (= (to_rep a1__first) (to_rep (first test_length__p2__a1__assume1))))
(assert (= (to_rep a1__last) (to_rep (last test_length__p2__a1__assume1))))
(assert (dynamic_property ((_ int2bv 16) 0) ((_ int2bv 16) 65535) (to_rep a1__first) (to_rep a1__last)))
(assert (=> (<= (bv2nat (to_rep a1__first)) (bv2nat (to_rep a1__last))) (= o (+ (- (bv2nat (to_rep a1__last)) (bv2nat (to_rep a1__first))) 1))))
(assert (=> (not (<= (bv2nat (to_rep a1__first)) (bv2nat (to_rep a1__last)))) (= o 0)))
(assert (not (uint_in_range o)))
(check-sat)
(exit)
