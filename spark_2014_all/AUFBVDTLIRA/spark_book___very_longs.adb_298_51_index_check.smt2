...
(assert (= (ite (<= (to_rep2 (first4 temp___10401)) (to_rep2 (last4 temp___10401))) (+ (- (to_rep2 (last4 temp___10401)) (to_rep2 (first4 temp___10401))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___1040 temp___1041))
(assert (= (mk1 (to_rep2 (first4 temp___10401)) (to_rep2 (last4 temp___10401))) temp___10411))
(assert (= (ite (<= (to_rep2 (first2 temp___10411)) (to_rep2 (last2 temp___10411))) (+ (- (to_rep2 (last2 temp___10411)) (to_rep2 (first2 temp___10411))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
