...
(assert (= (ite (<= (to_rep2 (first4 temp___9711)) (to_rep2 (last4 temp___9711))) (+ (- (to_rep2 (last4 temp___9711)) (to_rep2 (first4 temp___9711))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___971 temp___972))
(assert (= (mk1 (to_rep2 (first4 temp___9711)) (to_rep2 (last4 temp___9711))) temp___9721))
(assert (= (ite (<= (to_rep2 (first2 temp___9721)) (to_rep2 (last2 temp___9721))) (+ (- (to_rep2 (last2 temp___9721)) (to_rep2 (first2 temp___9721))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
...
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___9751 temp___9752))))
(assert (= result____split_discrs (mk___split_discrs temp___975)))
