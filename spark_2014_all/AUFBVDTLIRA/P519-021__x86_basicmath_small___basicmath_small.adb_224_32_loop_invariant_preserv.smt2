...
(assert (= rsi result))
(assert (= rsi1 (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000058)))
(assert (= rdi result1))
(assert (= rdi1 (bvsub (bvadd rsp1 #x0000000000000098) #x000000000000006C)))
(assert (= (writereg32post rbx #x00000000) true))
(assert (and (= o (readmem64 rsp1 memory1)) (and (and (and (and (and (and (and (= (bvand o #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory1 rsp1)))) (= (bvand o #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp1 #x0000000000000001)))) #x0000000000000100))) (= (bvand o #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp1 #x0000000000000002)))) #x0000000000010000))) (= (bvand o #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp1 #x0000000000000003)))) #x0000000001000000))) (= (bvand o #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp1 #x0000000000000004)))) #x0000000100000000))) (= (bvand o #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp1 #x0000000000000005)))) #x0000010000000000))) (= (bvand o #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp1 #x0000000000000006)))) #x0001000000000000))) (= (bvand o #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp1 #x0000000000000007)))) #x0100000000000000)))))
(assert (= xmm3 result2))
(assert (= xmm31 o))
(assert (= rbp result3))
(assert (= rbp1 (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000058)))
(assert (and (= o1 (readmem64 (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000090) memory1)) (and (and (and (and (and (and (and (= (bvand o1 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory1 (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000090))))) (= (bvand o1 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000090) #x0000000000000001)))) #x0000000000000100))) (= (bvand o1 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000090) #x0000000000000002)))) #x0000000000010000))) (= (bvand o1 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000090) #x0000000000000003)))) #x0000000001000000))) (= (bvand o1 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000090) #x0000000000000004)))) #x0000000100000000))) (= (bvand o1 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000090) #x0000000000000005)))) #x0000010000000000))) (= (bvand o1 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000090) #x0000000000000006)))) #x0001000000000000))) (= (bvand o1 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000090) #x0000000000000007)))) #x0100000000000000)))))
(assert (= result4 (mk_t__ref2 xmm2)))
(assert (= xmm21 o1))
(assert (and (= o2 (readmem64 (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000088) memory1)) (and (and (and (and (and (and (and (= (bvand o2 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory1 (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000088))))) (= (bvand o2 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000088) #x0000000000000001)))) #x0000000000000100))) (= (bvand o2 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000088) #x0000000000000002)))) #x0000000000010000))) (= (bvand o2 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000088) #x0000000000000003)))) #x0000000001000000))) (= (bvand o2 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000088) #x0000000000000004)))) #x0000000100000000))) (= (bvand o2 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000088) #x0000000000000005)))) #x0000010000000000))) (= (bvand o2 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000088) #x0000000000000006)))) #x0001000000000000))) (= (bvand o2 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000088) #x0000000000000007)))) #x0100000000000000)))))
(assert (= result5 (mk_t__ref2 xmm1)))
(assert (= xmm11 o2))
(assert (and (= o3 (readmem64 (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000080) memory1)) (and (and (and (and (and (and (and (= (bvand o3 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory1 (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000080))))) (= (bvand o3 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000080) #x0000000000000001)))) #x0000000000000100))) (= (bvand o3 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000080) #x0000000000000002)))) #x0000000000010000))) (= (bvand o3 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000080) #x0000000000000003)))) #x0000000001000000))) (= (bvand o3 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000080) #x0000000000000004)))) #x0000000100000000))) (= (bvand o3 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000080) #x0000000000000005)))) #x0000010000000000))) (= (bvand o3 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000080) #x0000000000000006)))) #x0001000000000000))) (= (bvand o3 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp1 #x0000000000000098) #x0000000000000080) #x0000000000000007)))) #x0100000000000000)))))
...
(assert (= (writereg32post rdi2 #x00401120) true))
(assert (= result8 (mk_t__ref2 rsp3)))
(assert (= rsp4 (bvsub rsp3 #x0000000000000008)))
(assert (= rsp5 (bvadd rsp4 #x0000000000000008)))
(assert (and (= o4 (readmem32 (bvsub (bvadd rsp5 #x0000000000000098) #x000000000000006C) memory1)) (and (and (and (= (bvand o4 #x000000FF) ((_ zero_extend 24) (to_rep (select memory1 (bvsub (bvadd rsp5 #x0000000000000098) #x000000000000006C))))) (= (bvand o4 #x0000FF00) (bvmul ((_ zero_extend 24) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp5 #x0000000000000098) #x000000000000006C) #x0000000000000001)))) #x00000100))) (= (bvand o4 #x00FF0000) (bvmul ((_ zero_extend 24) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp5 #x0000000000000098) #x000000000000006C) #x0000000000000002)))) #x00010000))) (= (bvand o4 #xFF000000) (bvmul ((_ zero_extend 24) (to_rep (select memory1 (bvadd (bvsub (bvadd rsp5 #x0000000000000098) #x000000000000006C) #x0000000000000003)))) #x01000000)))))
(assert (= (writereg32post rax1 o4) true))
(assert (and (= o5 (eax rax1)) (= o5 ((_ extract 31 0) (bvand rax1 #x00000000FFFFFFFF)))))
(assert (= o6 (ite (= o5 #x00000000) true false)))
(assert (= result9 (mk_bool__ref zeroflag)))
(assert (= zeroflag1 o6))
(assert (and (= o7 (eax rax1)) (= o7 ((_ extract 31 0) (bvand rax1 #x00000000FFFFFFFF)))))
(assert (= o8 (ite (bvugt o7 #x7FFFFFFF) true false)))
...
(assert (= rsp6 rsp5))
(assert (= (writereg32post rdi3 #x0000000A) true))
(assert (= result13 (mk_t__ref2 rsp6)))
(assert (= rsp7 (bvsub rsp6 #x0000000000000008)))
(assert (= rsp8 (bvadd rsp7 #x0000000000000008)))
(assert (and (= o9 (readmem64 rsp8 memory1)) (and (and (and (and (and (and (and (= (bvand o9 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory1 rsp8)))) (= (bvand o9 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp8 #x0000000000000001)))) #x0000000000000100))) (= (bvand o9 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp8 #x0000000000000002)))) #x0000000000010000))) (= (bvand o9 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp8 #x0000000000000003)))) #x0000000001000000))) (= (bvand o9 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp8 #x0000000000000004)))) #x0000000100000000))) (= (bvand o9 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp8 #x0000000000000005)))) #x0000010000000000))) (= (bvand o9 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp8 #x0000000000000006)))) #x0001000000000000))) (= (bvand o9 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsp8 #x0000000000000007)))) #x0100000000000000)))))
(assert (= result14 (mk_t__ref2 xmm4)))
(assert (= xmm41 o9))
(assert (= result15 (mk_t__ref2 r12)))
(assert (= r121 (bvsub r12 #x0000000000000001)))
(assert (= result16 (mk_bool__ref zeroflag2)))
(assert (= zeroflag3 (ite (= r121 #x0000000000000000) true false)))
(assert (and (= o10 (readmem64 #x0000000000401170 memory1)) (and (and (and (and (and (and (and (= (bvand o10 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory1 #x0000000000401170)))) (= (bvand o10 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x0000000000401170 #x0000000000000001)))) #x0000000000000100))) (= (bvand o10 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x0000000000401170 #x0000000000000002)))) #x0000000000010000))) (= (bvand o10 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x0000000000401170 #x0000000000000003)))) #x0000000001000000))) (= (bvand o10 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x0000000000401170 #x0000000000000004)))) #x0000000100000000))) (= (bvand o10 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x0000000000401170 #x0000000000000005)))) #x0000010000000000))) (= (bvand o10 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x0000000000401170 #x0000000000000006)))) #x0001000000000000))) (= (bvand o10 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd #x0000000000401170 #x0000000000000007)))) #x0100000000000000)))))
(assert (= o11 (bvsub xmm41 o10)))
(assert (= result17 (mk_t__ref2 xmm41)))
(assert (= xmm42 o11))
(assert (and (and (and (and (and (and (and (and (= (bvand xmm42 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory2 rsp8)))) (= (bvand xmm42 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp8 #x0000000000000001)))) #x0000000000000100))) (= (bvand xmm42 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp8 #x0000000000000002)))) #x0000000000010000))) (= (bvand xmm42 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp8 #x0000000000000003)))) #x0000000001000000))) (= (bvand xmm42 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp8 #x0000000000000004)))) #x0000000100000000))) (= (bvand xmm42 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp8 #x0000000000000005)))) #x0000010000000000))) (= (bvand xmm42 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp8 #x0000000000000006)))) #x0001000000000000))) (= (bvand xmm42 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory2 (bvadd rsp8 #x0000000000000007)))) #x0100000000000000))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (and (and (and (and (and (and (and (not (= i rsp8)) (not (= i (bvadd rsp8 #x0000000000000001)))) (not (= i (bvadd rsp8 #x0000000000000002)))) (not (= i (bvadd rsp8 #x0000000000000003)))) (not (= i (bvadd rsp8 #x0000000000000004)))) (not (= i (bvadd rsp8 #x0000000000000005)))) (not (= i (bvadd rsp8 #x0000000000000006)))) (not (= i (bvadd rsp8 #x0000000000000007)))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))
