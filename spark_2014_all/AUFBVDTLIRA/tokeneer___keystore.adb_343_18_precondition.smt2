...
(assert (=> (= result4 true) (= (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) temp___1278)))
(assert (=> (= result4 true) (= (mk1 1 (length thestring)) temp___12781)))
(assert (=> (= result4 true) (and (= temp___1280 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= result4 true) (=> (<= 1 temp___1280) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1280) (<= temp___1280 150))))))
(assert (=> (= result4 true) (= o7 result__1)))
(assert (=> (= result4 true) (= o7 temp___1281)))
(assert (=> (= result4 true) (= (mk1 1 temp___1280) temp___12811)))
(assert (=> (= result4 true) (= (ite (<= (to_rep1 (first2 temp___12781)) (to_rep1 (last2 temp___12781))) (+ (- (to_rep1 (last2 temp___12781)) (to_rep1 (first2 temp___12781))) 1) 0) (ite (<= (to_rep1 (first2 temp___12811)) (to_rep1 (last2 temp___12811))) (+ (- (to_rep1 (last2 temp___12811)) (to_rep1 (first2 temp___12811))) 1) 0))))
(assert (=> (= result4 true) (= (mk___t1 temp___1282 temp___12821) (mk___t1 temp___1278 temp___12781))))
(assert (=> (= result4 true) (forall ((temp___1283 Int)) (ite (and (<= 1 temp___1283) (<= temp___1283 (length thestring))) (= (select o8 temp___1283) (select temp___1282 temp___1283)) (= (select o8 temp___1283) (select result__1 temp___1283))))))
(assert (=> (= result4 true) (= result5 (mk_map__ref result__1))))
(assert (=> (= result4 true) (= result__2 o8)))
...
(assert (=> (not (= result4 true)) (= (mk___t temp___1277 temp___12771) thestring)))
(assert (=> (not (= result4 true)) (= o9 temp___1277)))
(assert (=> (not (= result4 true)) (= result6 (mk_map__ref result__1))))
(assert (=> (not (= result4 true)) (= result__3 o9)))
(assert (=> (not (= result4 true)) (= result__2 result__3)))
(assert (= result7 (mk_map__ref c72b)))
(assert (= c72b1 result__2))
