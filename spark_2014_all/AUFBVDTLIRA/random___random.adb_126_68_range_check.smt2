...
(define-fun dynamic_invariant ((temp___expr_213 (_ BitVec 32)) (temp___is_init_209 Bool) (temp___skip_constant_210 Bool) (temp___do_toplevel_211 Bool) (temp___do_typ_inv_212 Bool)) Bool true)
...
(define-fun dynamic_invariant1 ((temp___expr_241 Int) (temp___is_init_237 Bool) (temp___skip_constant_238 Bool) (temp___do_toplevel_239 Bool) (temp___do_typ_inv_240 Bool)) Bool (=> (or (= temp___is_init_237 true) (<= 0 623)) (in_range1 temp___expr_241)))
(declare-fun next (Int) Int)
(declare-fun next__function_guard (Int Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true true) (dynamic_invariant1 (next x) true false true true)) :pattern ((next x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true true) (= (next x) (ite (= x 623) 0 (+ x 1)))) :pattern ((next x)))))
...
(assert (forall ((temp___157 (_ BitVec 32)) (temp___158 (_ BitVec 32))) (let ((temp___156 (random__random__mat__aggregate_def temp___157 temp___158))) (=> (and (dynamic_invariant temp___157 true true true true) (dynamic_invariant temp___158 true true true true)) (and (= (to_rep (select temp___156 #x00000000)) temp___157) (= (to_rep (select temp___156 #x00000001)) temp___158))))))
...
(assert (= o4 (bvor (bvand (to_rep (select g__split_fields (to_rep1 g__split_fields1))) #x80000000) o3)))
(assert (= result value))
(assert (= value1 o4))
