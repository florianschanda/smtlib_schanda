...
(define-fun dynamic_invariant ((temp___expr_183 (_ BitVec 32)) (temp___is_init_180 Bool) (temp___skip_constant_181 Bool) (temp___do_toplevel_182 Bool)) Bool true)
...
(assert (forall ((x state_range)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_207 Int) (temp___is_init_204 Bool) (temp___skip_constant_205 Bool) (temp___do_toplevel_206 Bool)) Bool (=> (or (= temp___is_init_204 true) (<= 0 623)) (in_range1 temp___expr_207)))
(declare-fun next (Int) Int)
(declare-fun next__function_guard (Int Int) Bool)
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (dynamic_invariant1 (next x) true false true)) :pattern ((next x)))))
(assert (forall ((x Int)) (! (=> (dynamic_invariant1 x true true true) (= (next x) (ite (= x 623) 0 (+ x 1)))) :pattern ((next x)))))
(declare-sort tmatD1 0)
(declare-const attr__ATTRIBUTE_MODULUS1 (_ BitVec 32))
(define-fun in_range2 ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 0) x) (bvule x ((_ int2bv 32) 1))))
...
(declare-fun concat2 ((Array (_ BitVec 32) unsigned_32) (_ BitVec 32) (_ BitVec 32) (Array (_ BitVec 32) unsigned_32) (_ BitVec 32) (_ BitVec 32)) (Array (_ BitVec 32) unsigned_32))
(assert (forall ((a (Array (_ BitVec 32) unsigned_32)) (b (Array (_ BitVec 32) unsigned_32))) (forall ((a_first (_ BitVec 32)) (a_last (_ BitVec 32)) (b_first (_ BitVec 32)) (b_last (_ BitVec 32))) (forall ((i (_ BitVec 32))) (! (and (=> (and (bvule a_first i) (bvule i a_last)) (= (select (concat2 a a_first a_last b b_first b_last) i) (select a i))) (=> (bvugt i a_last) (= (select (concat2 a a_first a_last b b_first b_last) i) (select b (bvadd (bvsub i a_last) (bvsub b_first #x00000001)))))) :pattern ((select (concat2 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton2 (unsigned_32 (_ BitVec 32)) (Array (_ BitVec 32) unsigned_32))
(assert (forall ((v unsigned_32)) (forall ((i (_ BitVec 32))) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
(define-fun bool_eq2 ((a (Array (_ BitVec 32) unsigned_32)) (a__first (_ BitVec 32)) (a__last (_ BitVec 32)) (b (Array (_ BitVec 32) unsigned_32)) (b__first (_ BitVec 32)) (b__last (_ BitVec 32))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_133 (_ BitVec 32))) (=> (and (bvule a__first temp___idx_133) (bvule temp___idx_133 a__last)) (= (to_rep (select a temp___idx_133)) (to_rep (select b (bvadd (bvsub b__first a__first) temp___idx_133))))))) true false))
(assert (forall ((a (Array (_ BitVec 32) unsigned_32)) (b (Array (_ BitVec 32) unsigned_32))) (forall ((a__first (_ BitVec 32)) (a__last (_ BitVec 32)) (b__first (_ BitVec 32)) (b__last (_ BitVec 32))) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_133 (_ BitVec 32))) (=> (and (bvule a__first temp___idx_133) (bvule temp___idx_133 a__last)) (= (to_rep (select a temp___idx_133)) (to_rep (select b (bvadd (bvsub b__first a__first) temp___idx_133)))))))))))
(declare-fun compare1 ((Array (_ BitVec 32) unsigned_32) (_ BitVec 32) (_ BitVec 32) (Array (_ BitVec 32) unsigned_32) (_ BitVec 32) (_ BitVec 32)) Int)
(assert (forall ((a (Array (_ BitVec 32) unsigned_32)) (b (Array (_ BitVec 32) unsigned_32))) (forall ((a_first (_ BitVec 32)) (a_last (_ BitVec 32)) (b_first (_ BitVec 32)) (b_last (_ BitVec 32))) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq2 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 32) unsigned_32)) (b (Array (_ BitVec 32) unsigned_32))) (forall ((a_first (_ BitVec 32)) (a_last (_ BitVec 32)) (b_first (_ BitVec 32)) (b_last (_ BitVec 32))) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 32)) (j (_ BitVec 32))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (bvult (to_rep (select a (bvadd i #x00000001))) (to_rep (select b (bvadd j #x00000001))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 32) unsigned_32)) (b (Array (_ BitVec 32) unsigned_32))) (forall ((a_first (_ BitVec 32)) (a_last (_ BitVec 32)) (b_first (_ BitVec 32)) (b_last (_ BitVec 32))) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 32)) (j (_ BitVec 32))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (bvugt (to_rep (select a (bvadd j #x00000001))) (to_rep (select b (bvadd i #x00000001))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((temp___135 (_ BitVec 32)) (temp___136 (_ BitVec 32))) (let ((temp___134 (random__random__mat__aggregate_def temp___135 temp___136))) (and (= (select temp___134 ((_ int2bv 32) 0)) (of_rep temp___135)) (= (select temp___134 ((_ int2bv 32) 1)) (of_rep temp___136))))))
(declare-const upper_mask (_ BitVec 32))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const lower_mask (_ BitVec 32))
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(assert (= mat (random__random__mat__aggregate_def ((_ int2bv 32) 0) ((_ int2bv 32) 2567483615))))
...
(declare-const o9 (Array Int unsigned_32))
(declare-const o10 (Array Int unsigned_32))
(declare-const o11 state_range)
(declare-const temp___317 (Array Int unsigned_32))
(declare-const temp___3171 state_range)
(declare-const result (_ BitVec 32))
(declare-const value1 (_ BitVec 32))
(declare-const result1 (Array Int unsigned_32))
(declare-const result2 state_range)
(declare-const g__split_fields2 (Array Int unsigned_32))
(declare-const g__split_fields3 state_range)
(assert true)
(assert (= (random__random__mat__aggregate_def ((_ int2bv 32) 0) ((_ int2bv 32) 2567483615)) mat))
(assert true)
(assert true)
(assert (and (= o (next (to_rep1 g__split_fields1))) (and (in_range1 o) (= o (ite (= (to_rep1 g__split_fields1) 623) 0 (+ (to_rep1 g__split_fields1) 1))))))
(assert (= o1 (select g__split_fields o)))
(assert (= o2 (to_rep o1)))
(assert (= o3 (bvand o2 ((_ int2bv 32) 2147483647))))
(assert (= o4 (bvor (bvand (to_rep (select g__split_fields (to_rep1 g__split_fields1))) ((_ int2bv 32) 2147483648)) o3)))
(assert (= result value))
(assert (= value1 o4))
(assert (<= 0 (to_rep1 g__split_fields1)))
(assert (<= (to_rep1 g__split_fields1) 226))
(assert (not (in_range1 (+ (to_rep1 g__split_fields1) 397))))
(check-sat)
(exit)
