...
(assert (not (in_range7 (bvudiv (bvadd (to_rep5 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields__content2 local_ctx__split_fields20))))) #x0000000000000007) #x0000000000000008))))
(check-sat)
(exit)
