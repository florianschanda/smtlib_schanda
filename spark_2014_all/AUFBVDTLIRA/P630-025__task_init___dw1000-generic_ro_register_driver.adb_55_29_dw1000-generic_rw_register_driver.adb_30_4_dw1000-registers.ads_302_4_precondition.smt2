...
(define-fun dynamic_invariant ((temp___expr_3541 us_t1) (temp___is_init_3538 Bool) (temp___skip_constant_3539 Bool) (temp___do_toplevel_3540 Bool)) Bool (=> (not (= temp___skip_constant_3539 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3541) (last3 temp___expr_3541)) (and (= (first3 temp___expr_3541) 1) (= (last3 temp___expr_3541) 4)))))
