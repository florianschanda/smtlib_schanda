...
(define-fun register_type__ref___63__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___45__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___45__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_3902 us_t1) (temp___is_init_3898 Bool) (temp___skip_constant_3899 Bool) (temp___do_toplevel_3900 Bool) (temp___do_typ_inv_3901 Bool)) Bool (=> (not (= temp___skip_constant_3899 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3902) (last3 temp___expr_3902)) (and (= (first3 temp___expr_3902) 1) (= (last3 temp___expr_3902) 4)))))
