...
(define-fun dynamic_invariant4 ((temp___expr_790 us_rep1) (temp___is_init_786 Bool) (temp___skip_constant_787 Bool) (temp___do_toplevel_788 Bool) (temp___do_typ_inv_789 Bool)) Bool (and (=> (not (= temp___skip_constant_787 true)) (in_range4 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_790))) (and (dynamic_property3 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_790))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_790)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_790))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_790))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_793 us_rep1) (temp___skip_top_level_794 Bool)) Bool (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_793))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
...
(declare-fun temp___1267 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1269 (_ BitVec 8))) (forall ((temp___1270 Int) (temp___1271 Int)) (let ((temp___1268 (temp___1267 temp___1269 temp___1270 temp___1271))) (=> (dynamic_invariant1 temp___1269 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1270 temp___1271) (and (= (first5 temp___1268) temp___1270) (= (last5 temp___1268) temp___1271))) (forall ((temp___1272 Int)) (= (to_rep (select (to_array2 temp___1268) temp___1272)) temp___1269))))))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1267 #x00 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1267 #x00 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___1274 temp___12741) (temp___1267 #x00 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep2 (first4 temp___12741)) (to_rep2 (last4 temp___12741))) (+ (- (to_rep2 (last4 temp___12741)) (to_rep2 (first4 temp___12741))) 1) 0) (ite (<= 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0)))
...
(assert (and (= o14 (+ i2 j2)) (in_range2 (+ i2 j2))))
(assert (= o15 (- o14 1)))
(assert (= o16 (ite (<= o15 r82b) true false)))
(assert (and (= o12 (+ i2 j2)) (in_range2 (+ i2 j2))))
(assert (= o13 (- o12 1)))
(assert (= o17 (ite (<= 1 o13) true false)))
(assert (= result6 (ite (= o17 true) o16 false)))
(assert (= result6 true))
(assert (and (= o18 (+ i2 j2)) (in_range2 (+ i2 j2))))
(assert (= temp___1282 (- o18 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1282)))
(check-sat)
(exit)
