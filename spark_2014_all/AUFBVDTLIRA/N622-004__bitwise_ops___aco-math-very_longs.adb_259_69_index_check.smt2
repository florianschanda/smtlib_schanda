...
(declare-datatypes () ((tT77bP1__ref (mk_tT77bP1__ref (tT77bP1__content tdigit_index_typeB)))))
(define-fun tT77bP1__ref___projection ((a tT77bP1__ref)) tdigit_index_typeB (tT77bP1__content a))
(declare-sort t1 0)
...
(define-fun us_split_fields_Long_Digits__23__projection ((a us_split_fields2)) us_t1 (rec__aco__math__very_longs__very_long__long_digits1 a))
...
(define-fun us_rep___45__projection ((a us_rep1)) us_split_discrs (us_split_discrs2 a))
(define-fun us_rep___46__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___179 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___179) (first3 temp___179) (last3 temp___179))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___178 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___178) (first1 temp___178) (last1 temp___178))))))
...
(define-fun dynamic_invariant4 ((temp___expr_729 us_rep1) (temp___is_init_726 Bool) (temp___skip_constant_727 Bool) (temp___do_toplevel_728 Bool)) Bool (and (=> (not (= temp___skip_constant_727 true)) (in_range4 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_729))) (and (dynamic_property3 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_729))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_729)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_729))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_729))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_732 us_rep1) (temp___skip_top_level_733 Bool)) Bool (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_732))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
...
(declare-datatypes () ((t78b__ref (mk_t78b__ref (t78b__content tdigit_index_typeB)))))
(define-fun t78b__ref___projection ((a t78b__ref)) tdigit_index_typeB (t78b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t79b__ref (mk_t79b__ref (t79b__content us_t2)))))
(define-fun t79b__ref___projection ((a t79b__ref)) us_t2 (t79b__content a))
...
(declare-fun temp___1182 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___1184 (_ BitVec 8))) (forall ((temp___1185 Int) (temp___1186 Int)) (let ((temp___1183 (temp___1182 temp___1184 temp___1185 temp___1186))) (and (=> (dynamic_property6 1 2147483647 temp___1185 temp___1186) (and (= (first5 temp___1183) temp___1185) (= (last5 temp___1183) temp___1186))) (forall ((temp___1187 Int)) (= (select (to_array2 temp___1183) temp___1187) (of_rep temp___1184))))))))
...
(declare-const j Int)
(declare-const i Int)
(declare-const aco__math__very_longs__modmultiply__result digit_index_type)
(declare-const aco__math__very_longs__modmultiply__result1 (Array Int octet))
(declare-const aco__math__very_longs__modmultiply__result2 t)
(declare-const us Int)
(declare-const us1 Int)
(declare-const us2 Int)
(declare-const temp___1189 (Array Int octet))
(declare-const temp___11891 t2)
(declare-const temp___1190 (Array Int octet))
(declare-const temp___11901 t1)
...
(declare-const temp___1213 us_rep1)
(declare-const temp___1212 (_ BitVec 16))
(declare-const temp___1209 (_ BitVec 16))
(declare-const temp___1208 (_ BitVec 16))
(declare-const temp___1207 (_ BitVec 16))
(declare-const temp___1206 (_ BitVec 16))
(declare-const temp___1203 us_rep1)
(declare-const temp___1202 (_ BitVec 16))
...
(declare-const temp___1201 us_rep1)
...
(declare-const aco__math__very_longs__modmultiply__result3 us_rep)
(declare-const aco__math__very_longs__modmultiply__result4 very_long__ref)
(declare-const aco__math__very_longs__modmultiply__result5 us_rep)
...
(declare-const aco__math__very_longs__modmultiply__result6 very_long__ref)
...
(declare-const aco__math__very_longs__modmultiply__result7 us_rep)
...
(assert (and (= us2 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range3 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
...
(assert true)
(assert true)
(assert (= (to_rep2 (first4 (rt2 (temp___1182 ((_ int2bv 8) 0) 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1182 ((_ int2bv 8) 0) 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___1189 temp___11891) (temp___1182 ((_ int2bv 8) 0) 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep2 (first4 temp___11891)) (to_rep2 (last4 temp___11891))) (+ (- (to_rep2 (last4 temp___11891)) (to_rep2 (first4 temp___11891))) 1) 0) (ite (<= 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___1189 temp___1190))
(assert (= (mk1 (to_rep2 (first4 temp___11891)) (to_rep2 (last4 temp___11891))) temp___11901))
(assert (= (ite (<= (to_rep2 (first2 temp___11901)) (to_rep2 (last2 temp___11901))) (+ (- (to_rep2 (last2 temp___11901)) (to_rep2 (first2 temp___11901))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___1190 temp___11901)))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___11931 temp___11932))))
(assert (= result____split_discrs (mk___split_discrs temp___1193)))
...
(assert (= o4 i4))
(assert (= o5 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))) o4)))
(assert (= o6 (to_rep o5)))
...
(assert (= o8 j2))
(assert (= o9 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))) o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 ((_ zero_extend 8) o10)))
(assert (= result5 (mk_t__ref1 r_digit3)))
(assert (= r_digit4 o11))
(assert (= (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))) r82b))
(assert (in_range2 r82b))
(assert (and (= o14 (+ i4 j2)) (in_range2 (+ i4 j2))))
(assert (= o15 (- o14 1)))
(assert (= o16 (ite (<= o15 r82b) true false)))
(assert (and (= o12 (+ i4 j2)) (in_range2 (+ i4 j2))))
(assert (= o13 (- o12 1)))
(assert (= o17 (ite (<= 1 o13) true false)))
(assert (= result6 (ite (= o17 true) o16 false)))
(assert (= result6 true))
(assert (and (= o18 (+ i4 j2)) (in_range2 (+ i4 j2))))
(assert (= temp___1197 (- o18 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1197)))
(check-sat)
(exit)
