...
(define-fun dynamic_invariant2 ((temp___expr_2185 Int) (temp___is_init_2181 Bool) (temp___skip_constant_2182 Bool) (temp___do_toplevel_2183 Bool) (temp___do_typ_inv_2184 Bool)) Bool (=> (or (= temp___is_init_2181 true) (<= 0 4)) (in_range8 temp___expr_2185)))
...
(declare-fun temp___2455 ((Array Int cell)) (Array Int (Array Int cell)))
(declare-fun temp___2459 (Int) (Array Int cell))
...
(assert (forall ((temp___2457 (Array Int cell))) (forall ((temp___2458 Int)) (= (select (temp___2455 temp___2457) temp___2458) temp___2457))))
(define-fun dynamic_invariant4 ((temp___expr_2087 Int) (temp___is_init_2083 Bool) (temp___skip_constant_2084 Bool) (temp___do_toplevel_2085 Bool) (temp___do_typ_inv_2086 Bool)) Bool (=> (or (= temp___is_init_2083 true) (<= 0 7)) (in_range4 temp___expr_2087)))
(assert (forall ((temp___2461 Int)) (=> (dynamic_invariant4 temp___2461 true true true true) (forall ((temp___2462 Int)) (= (to_rep1 (select (temp___2459 temp___2461) temp___2462)) temp___2461)))))
(define-fun dynamic_invariant5 ((temp___expr_2094 Int) (temp___is_init_2090 Bool) (temp___skip_constant_2091 Bool) (temp___do_toplevel_2092 Bool) (temp___do_typ_inv_2093 Bool)) Bool (=> (or (= temp___is_init_2090 true) (<= 1 7)) (in_range3 temp___expr_2094)))
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range10 x) (in_range11 y)) (= (to_rep1 (let ((temp___2231 (select b y))) (select temp___2231 x))) 0))) :pattern ((is_empty b y x))))))
...
(declare-const temp___2463 shape)
(declare-const temp___24631 direction)
(declare-const temp___24632 px_coord)
(declare-const temp___24633 py_coord)
...
(declare-const temp___2464 shape)
(declare-const temp___24641 direction)
(declare-const temp___24642 px_coord)
(declare-const temp___24643 py_coord)
...
(assert (=> (bvule #x00000000 #x0001869F) (in_range2 score_nbr)))
(assert (=> (bvule #x00000000 #x0001869F) (in_range2 level_nbr)))
(assert (=> (bvule #x00000000 #x0001869F) (in_range2 line_counter)))
...
(assert (= cur_board1 (temp___2455 (temp___2459 0))))
(assert (= (to_rep3 o) 0))
(assert (= (to_rep2 o1) 0))
(assert (= (to_rep4 o2) 0))
(assert (= (to_rep o3) 1))
...
(assert (= temp___24631 o5))
(assert (= temp___24632 o6))
(assert (= temp___24633 o7))
...
(assert (= cur_piece__split_fields4 (mk___split_fields temp___2463 temp___24631 temp___24632 temp___24633)))
(assert (= (to_rep3 o8) 0))
(assert (= (to_rep2 o9) 0))
...
(assert (= o9 o14))
(assert (= o8 o15))
(assert (= temp___2464 o12))
(assert (= temp___24641 o13))
(assert (= temp___24642 o14))
(assert (= temp___24643 o15))
...
(assert (= next_piece__split_fields4 (mk___split_fields temp___2464 temp___24641 temp___24642 temp___24643)))
