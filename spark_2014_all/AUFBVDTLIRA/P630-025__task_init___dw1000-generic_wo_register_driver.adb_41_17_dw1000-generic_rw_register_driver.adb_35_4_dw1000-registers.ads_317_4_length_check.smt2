...
(define-fun in_range3 ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 0) x) (bvule x ((_ int2bv 32) 1048575))))
...
(declare-fun user_eq5 (bits_20 bits_20) Bool)
(declare-const dummy5 bits_20)
...
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x ((_ int2bv 32) 1048576)))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(define-fun register_byte_array__ref___51__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3705 us_t1) (temp___is_init_3702 Bool) (temp___skip_constant_3703 Bool) (temp___do_toplevel_3704 Bool)) Bool (=> (not (= temp___skip_constant_3703 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3705) (last3 temp___expr_3705)) (and (= (first3 temp___expr_3705) 1) (= (last3 temp___expr_3705) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___21__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_3726 us_t2) (temp___is_init_3723 Bool) (temp___skip_constant_3724 Bool) (temp___do_toplevel_3725 Bool)) Bool (=> (not (= temp___skip_constant_3724 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3726) (last5 temp___expr_3726)) (and (= (first5 temp___expr_3726) 1) (= (last5 temp___expr_3726) 4)))))
...
(declare-const temp___7856 (Array Int bits_8))
(declare-const temp___78561 t2)
(declare-const temp___7857 (Array Int bits_8))
(declare-const temp___78571 t1)
...
(assert (and (= (mk___t2 temp___7856 temp___78561) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7856 temp___78561) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___78561)) (to_rep (last4 temp___78561))) (+ (- (to_rep (last4 temp___78561)) (to_rep (first4 temp___78561))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7856 temp___7857))
(assert (= (mk1 (to_rep (first4 temp___78561)) (to_rep (last4 temp___78561))) temp___78571))
(assert (not (= (ite (<= (to_rep (first2 temp___78571)) (to_rep (last2 temp___78571))) (+ (- (to_rep (last2 temp___78571)) (to_rep (first2 temp___78571))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
