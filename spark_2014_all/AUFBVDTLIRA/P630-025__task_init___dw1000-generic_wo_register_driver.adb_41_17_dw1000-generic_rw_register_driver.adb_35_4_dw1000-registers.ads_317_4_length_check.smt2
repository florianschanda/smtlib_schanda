...
(define-fun tregister_byte_arrayP1__ref___51__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___21__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-sort bits_20 0)
(define-fun in_range3 ((x (_ BitVec 32))) Bool (and (bvule #x00000000 x) (bvule x #x000FFFFF)))
(define-fun in_range_int1 ((x Int)) Bool (and (<= 0 x) (<= x 1048575)))
...
(declare-fun user_eq7 (bits_20 bits_20) Bool)
(declare-const dummy7 bits_20)
(declare-datatypes () ((bits_20__ref (mk_bits_20__ref (bits_20__content bits_20)))))
(define-fun bits_20__ref___projection ((a bits_20__ref)) bits_20 (bits_20__content a))
(declare-fun to_rep3 (bits_20) (_ BitVec 32))
(declare-fun of_rep3 ((_ BitVec 32)) bits_20)
(assert (forall ((x bits_20)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x bits_20)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x #x00100000))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int6 ((x bits_20)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x bits_20)) (! (in_range_int1 (to_int6 x)) :pattern ((to_int6 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__ec_ctrl_type__ostsm bits_1) (rec__dw1000__register_types__ec_ctrl_type__osrsm bits_1) (rec__dw1000__register_types__ec_ctrl_type__pllldt bits_1) (rec__dw1000__register_types__ec_ctrl_type__wait bits_8) (rec__dw1000__register_types__ec_ctrl_type__ostrm bits_1) (rec__dw1000__register_types__ec_ctrl_type__reserved bits_20)))))
(define-fun us_split_fields_OSTSM__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__ec_ctrl_type__ostsm a))
(define-fun us_split_fields_OSRSM__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__ec_ctrl_type__osrsm a))
(define-fun us_split_fields_PLLLDT__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__ec_ctrl_type__pllldt a))
(define-fun us_split_fields_WAIT__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__ec_ctrl_type__wait a))
(define-fun us_split_fields_OSTRM__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__ec_ctrl_type__ostrm a))
(define-fun us_split_fields_Reserved__5__projection ((a us_split_fields)) bits_20 (rec__dw1000__register_types__ec_ctrl_type__reserved a))
...
(define-fun us_rep___31__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (= (to_rep2 (rec__dw1000__register_types__ec_ctrl_type__ostsm (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__ec_ctrl_type__ostsm (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__ec_ctrl_type__osrsm (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__ec_ctrl_type__osrsm (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__ec_ctrl_type__pllldt (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__ec_ctrl_type__pllldt (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__ec_ctrl_type__wait (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__ec_ctrl_type__wait (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__ec_ctrl_type__ostrm (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__ec_ctrl_type__ostrm (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__ec_ctrl_type__reserved (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__ec_ctrl_type__reserved (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__ec_ctrl_type__ostsm__first__bit Int)
(declare-const dw1000__register_types__ec_ctrl_type__ostsm__last__bit Int)
(declare-const dw1000__register_types__ec_ctrl_type__ostsm__position Int)
(assert (<= 0 dw1000__register_types__ec_ctrl_type__ostsm__first__bit))
(assert (< dw1000__register_types__ec_ctrl_type__ostsm__first__bit dw1000__register_types__ec_ctrl_type__ostsm__last__bit))
(assert (<= 0 dw1000__register_types__ec_ctrl_type__ostsm__position))
(declare-const dw1000__register_types__ec_ctrl_type__osrsm__first__bit Int)
(declare-const dw1000__register_types__ec_ctrl_type__osrsm__last__bit Int)
(declare-const dw1000__register_types__ec_ctrl_type__osrsm__position Int)
(assert (<= 0 dw1000__register_types__ec_ctrl_type__osrsm__first__bit))
(assert (< dw1000__register_types__ec_ctrl_type__osrsm__first__bit dw1000__register_types__ec_ctrl_type__osrsm__last__bit))
(assert (<= 0 dw1000__register_types__ec_ctrl_type__osrsm__position))
(declare-const dw1000__register_types__ec_ctrl_type__pllldt__first__bit Int)
(declare-const dw1000__register_types__ec_ctrl_type__pllldt__last__bit Int)
(declare-const dw1000__register_types__ec_ctrl_type__pllldt__position Int)
(assert (<= 0 dw1000__register_types__ec_ctrl_type__pllldt__first__bit))
(assert (< dw1000__register_types__ec_ctrl_type__pllldt__first__bit dw1000__register_types__ec_ctrl_type__pllldt__last__bit))
(assert (<= 0 dw1000__register_types__ec_ctrl_type__pllldt__position))
(declare-const dw1000__register_types__ec_ctrl_type__wait__first__bit Int)
(declare-const dw1000__register_types__ec_ctrl_type__wait__last__bit Int)
(declare-const dw1000__register_types__ec_ctrl_type__wait__position Int)
(assert (<= 0 dw1000__register_types__ec_ctrl_type__wait__first__bit))
(assert (< dw1000__register_types__ec_ctrl_type__wait__first__bit dw1000__register_types__ec_ctrl_type__wait__last__bit))
(assert (<= 0 dw1000__register_types__ec_ctrl_type__wait__position))
(declare-const dw1000__register_types__ec_ctrl_type__ostrm__first__bit Int)
(declare-const dw1000__register_types__ec_ctrl_type__ostrm__last__bit Int)
(declare-const dw1000__register_types__ec_ctrl_type__ostrm__position Int)
(assert (<= 0 dw1000__register_types__ec_ctrl_type__ostrm__first__bit))
(assert (< dw1000__register_types__ec_ctrl_type__ostrm__first__bit dw1000__register_types__ec_ctrl_type__ostrm__last__bit))
(assert (<= 0 dw1000__register_types__ec_ctrl_type__ostrm__position))
(declare-const dw1000__register_types__ec_ctrl_type__reserved__first__bit Int)
(declare-const dw1000__register_types__ec_ctrl_type__reserved__last__bit Int)
(declare-const dw1000__register_types__ec_ctrl_type__reserved__position Int)
(assert (<= 0 dw1000__register_types__ec_ctrl_type__reserved__first__bit))
(assert (< dw1000__register_types__ec_ctrl_type__reserved__first__bit dw1000__register_types__ec_ctrl_type__reserved__last__bit))
(assert (<= 0 dw1000__register_types__ec_ctrl_type__reserved__position))
(declare-fun user_eq8 (us_rep us_rep) Bool)
(declare-const dummy8 us_rep)
(declare-datatypes () ((ec_ctrl_type__ref (mk_ec_ctrl_type__ref (ec_ctrl_type__content us_rep)))))
(define-fun ec_ctrl_type__ref___projection ((a ec_ctrl_type__ref)) us_rep (ec_ctrl_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___21__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_4107 us_t1) (temp___is_init_4103 Bool) (temp___skip_constant_4104 Bool) (temp___do_toplevel_4105 Bool) (temp___do_typ_inv_4106 Bool)) Bool (=> (not (= temp___skip_constant_4104 true)) (and (dynamic_property2 1 4 (first3 temp___expr_4107) (last3 temp___expr_4107)) (and (= (first3 temp___expr_4107) 1) (= (last3 temp___expr_4107) 4)))))
...
(define-fun register_byte_array__ref___51__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_4084 us_t2) (temp___is_init_4080 Bool) (temp___skip_constant_4081 Bool) (temp___do_toplevel_4082 Bool) (temp___do_typ_inv_4083 Bool)) Bool (=> (not (= temp___skip_constant_4081 true)) (and (dynamic_property3 1 4 (first5 temp___expr_4084) (last5 temp___expr_4084)) (and (= (first5 temp___expr_4084) 1) (= (last5 temp___expr_4084) 4)))))
...
(declare-const temp___8628 (Array Int bits_8))
(declare-const temp___86281 t1)
(declare-const temp___8629 (Array Int bits_8))
(declare-const temp___86291 t2)
(define-fun temp___86282 () us_t1 (mk___t1 temp___8628 temp___86281))
...
(assert (and (= temp___86282 (register_to_bytes reg)) (dynamic_invariant temp___86282 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___86281)) (to_rep (last2 temp___86281))) (+ (- (to_rep (last2 temp___86281)) (to_rep (first2 temp___86281))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8628 temp___8629))
(assert (= (mk2 (to_rep (first2 temp___86281)) (to_rep (last2 temp___86281))) temp___86291))
(assert (not (= (ite (<= (to_rep (first4 temp___86291)) (to_rep (last4 temp___86291))) (+ (- (to_rep (last4 temp___86291)) (to_rep (first4 temp___86291))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
