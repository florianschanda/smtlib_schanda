...
(assert (= ptr2 n3))
(assert (and (=> (<= 0 2147483647) (in_range4 ptr3)) (=> (<= 0 2147483647) (in_range4 n4))))
(assert (and (= (mk___t temp___604 temp___6041) (to_string1 ptr3 (mk___split_fields entry_table__split_fields) (mk___split_fields1 char_table__split_fields))) (dynamic_invariant (mk___t temp___604 temp___6041) true false true)))
(assert (= result4 (bool_eq temp___604 (to_rep1 (first temp___6041)) (to_rep1 (last temp___6041)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s))))))
