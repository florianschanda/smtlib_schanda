...
(assert (in_range12 n3))
(assert (= result2 (mk_int__ref ptr1)))
(assert (= ptr2 n3))
(assert (and (=> (<= 0 2147483647) (in_range8 ptr3)) (=> (<= 0 2147483647) (in_range8 n4))))
(assert (and (= temp___6672 (to_string1 ptr3 (mk___split_fields1 entry_table__split_fields) (mk___split_fields char_table__split_fields))) (dynamic_invariant temp___6672 true false true true)))
(assert (= result3 (bool_eq temp___667 (to_rep1 (first temp___6671)) (to_rep1 (last temp___6671)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s))))))
(assert (not (= result3 true)))
(assert (= n5 n4))
(assert (and (= o2 ptr3) (in_range15 ptr3)))
(assert (not (<= o2 (last3 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields)))))))
(check-sat)
(exit)
