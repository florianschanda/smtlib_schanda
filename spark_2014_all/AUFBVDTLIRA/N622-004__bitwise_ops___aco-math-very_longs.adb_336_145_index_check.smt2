...
(assert (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))) i1) (<= i1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o i1))
...
(assert (or (not (= (to_rep (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) digit_index3)) #x00)) (exists ((j1 Int)) (and (and (<= (+ i2 1) j1) (<= j1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))))) (not (= (to_rep (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) j1)) #x00))))))
(assert (=> (< digit_index3 i2) (forall ((j1 Int)) (=> (and (<= (+ digit_index3 1) j1) (<= j1 i2)) (= (to_rep (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) j1)) #x00)))))
(assert (and (and (=> (<= 1 2147483647) (in_range2 digit_index3)) (=> (<= 1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number)))))) (dynamic_property2 1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))) i2))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
