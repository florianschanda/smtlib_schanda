...
(assert (= i2 1))
(assert (<= 1 i2))
(assert (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number)))))))
...
(assert (= o i2))
(assert (= o1 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) o)))
(assert (= o2 (to_rep o1)))
...
(assert (and (= o4 (+ i3 1)) (in_range1 (+ i3 1))))
(assert (= o5 (ite (<= o4 j) true false)))
(assert (= result4 (ite (= o5 true) (ite (<= j (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number)))))) true false) false)))
(assert (= result4 true))
(assert (not (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))))) j)))
(check-sat)
(exit)
