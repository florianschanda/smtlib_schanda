...
(assert (=> (= result1 true) (=> (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= temp___876 i2))))
(assert (=> (= result1 true) (=> (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= temp___875 digit_count1))))
...
(assert (=> (= result1 true) (=> (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= o4 (ite (= o3 ((_ int2bv 8) 0)) true false)))))
...
(assert (=> (= result1 true) (=> (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (=> (< digit_count3 i3) (forall ((j Int)) (=> (and (<= (+ digit_count3 1) j) (<= j i3)) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j)) ((_ int2bv 8) 0))))))))
...
(assert (= (= o6 true) (forall ((i15 Int)) (=> (and (<= (+ very_longs__number_of_digits__result4 1) i15) (<= i15 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) i15)) ((_ int2bv 8) 0))))))
