...
(declare-datatypes () ((tT100bP1__ref (mk_tT100bP1__ref (tT100bP1__content tdigit_count_typeB)))))
(define-fun tT100bP1__ref___projection ((a tT100bP1__ref)) tdigit_count_typeB (tT100bP1__content a))
(declare-sort t1 0)
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___184 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___184) (first3 temp___184) (last3 temp___184))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___183 (rec__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___183) (first1 temp___183) (last1 temp___183))))))
...
(define-fun dynamic_invariant4 ((temp___expr_654 us_rep1) (temp___is_init_651 Bool) (temp___skip_constant_652 Bool) (temp___do_toplevel_653 Bool)) Bool (and (=> (not (= temp___skip_constant_652 true)) (in_range4 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) (to_base temp___expr_654))) (and (dynamic_property3 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_654))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_654)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_654))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_654))) (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))))
(define-fun default_initial_assumption ((temp___expr_657 us_rep1) (temp___skip_top_level_658 Bool)) Bool (= (to_rep (rec__very_longs__very_long__length (us_split_discrs2 temp___expr_657))) (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))))
...
(declare-datatypes () ((t101b__ref (mk_t101b__ref (t101b__content tdigit_count_typeB)))))
(define-fun t101b__ref___projection ((a t101b__ref)) tdigit_count_typeB (t101b__content a))
(declare-sort t2 0)
...
(declare-datatypes () ((t102b__ref (mk_t102b__ref (t102b__content us_t2)))))
(define-fun t102b__ref___projection ((a t102b__ref)) us_t2 (t102b__content a))
...
(declare-fun temp___1011 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___1013 (_ BitVec 8))) (forall ((temp___1014 Int) (temp___1015 Int)) (let ((temp___1012 (temp___1011 temp___1013 temp___1014 temp___1015))) (and (=> (dynamic_property6 1 65536 temp___1014 temp___1015) (and (= (first5 temp___1012) temp___1014) (= (last5 temp___1012) temp___1015))) (forall ((temp___1016 Int)) (= (select (to_array2 temp___1012) temp___1016) (of_rep1 temp___1013))))))))
...
(declare-const temp___1018 (Array Int octet))
(declare-const temp___10181 t2)
(declare-const temp___1019 (Array Int octet))
(declare-const temp___10191 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___1022 digit_index_type)
(declare-const temp___10221 (Array Int octet))
(declare-const temp___10222 t1)
(declare-const temp___1052 (_ BitVec 16))
(declare-const temp___1049 us_rep1)
(declare-const temp___1048 (_ BitVec 16))
(declare-const temp___1047 (_ BitVec 16))
(declare-const temp___1046 (_ BitVec 16))
(declare-const temp___1045 (_ BitVec 16))
(declare-const temp___1038 (_ BitVec 16))
(declare-const temp___1035 us_rep1)
(declare-const temp___1034 (_ BitVec 16))
(declare-const temp___1033 (_ BitVec 16))
...
(declare-const temp___1030 us_rep1)
...
(declare-const temp___1044 us_rep1)
...
(assert (and (= us2 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))) (in_range2 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))
...
(assert true)
(assert true)
(assert (= (to_rep2 (first4 (rt2 (temp___1011 ((_ int2bv 8) 0) 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1011 ((_ int2bv 8) 0) 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))) (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))))
(assert (= (mk___t2 temp___1018 temp___10181) (temp___1011 ((_ int2bv 8) 0) 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))
(assert (= (ite (<= (to_rep2 (first4 temp___10181)) (to_rep2 (last4 temp___10181))) (+ (- (to_rep2 (last4 temp___10181)) (to_rep2 (first4 temp___10181))) 1) 0) (ite (<= 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))) (+ (- (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) 1) 1) 0)))
(assert (= temp___1018 temp___1019))
(assert (= (mk1 (to_rep2 (first4 temp___10181)) (to_rep2 (last4 temp___10181))) temp___10191))
(assert (= (ite (<= (to_rep2 (first2 temp___10191)) (to_rep2 (last2 temp___10191))) (+ (- (to_rep2 (last2 temp___10191)) (to_rep2 (first2 temp___10191))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___1019 temp___10191)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1022)))
(assert (= temp___10221 o2))
(assert (= temp___10222 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___10221 temp___10222))))
(assert (= result____split_discrs (mk___split_discrs temp___1022)))
...
(assert (= o8 j2))
(assert (= o9 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 r))) o8)))
(assert (= o10 (to_rep1 o9)))
(assert (= o11 ((_ zero_extend 8) o10)))
(assert (= result5 (mk_t__ref1 r_digit3)))
(assert (= r_digit4 o11))
(assert (and (= o12 (+ i4 j2)) (in_range1 (+ i4 j2))))
(assert (= temp___1026 (- o12 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1026) (<= temp___1026 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
(assert (= o13 temp___1026))
(assert (= o14 (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields4)) o13)))
...
(assert (= o18 (takelsb_from16 temp4)))
(assert (= (to_rep1 o19) o18))
(assert (and (= o17 (+ i4 j2)) (in_range1 (+ i4 j2))))
(assert (= temp___1028 (- o17 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1028)))
(check-sat)
(exit)
