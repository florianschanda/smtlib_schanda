...
(declare-fun temp___1080 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1082 (_ BitVec 8))) (forall ((temp___1083 Int) (temp___1084 Int)) (let ((temp___1081 (temp___1080 temp___1082 temp___1083 temp___1084))) (=> (dynamic_invariant2 temp___1082 true true true true) (and (=> (dynamic_property6 1 65536 temp___1083 temp___1084) (and (= (first5 temp___1081) temp___1083) (= (last5 temp___1081) temp___1084))) (forall ((temp___1085 Int)) (= (to_rep1 (select (to_array2 temp___1081) temp___1085)) temp___1082))))))))
(define-fun dynamic_invariant5 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 65536)) (in_range2 temp___expr_228)))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1080 #x00 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1080 #x00 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))) (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))))
(assert (= (mk___t2 temp___1087 temp___10871) (temp___1080 #x00 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))))))
(assert (= (ite (<= (to_rep2 (first4 temp___10871)) (to_rep2 (last4 temp___10871))) (+ (- (to_rep2 (last4 temp___10871)) (to_rep2 (first4 temp___10871))) 1) 0) (ite (<= 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))) (+ (- (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) 1) 1) 0)))
(assert (= temp___1087 temp___1088))
(assert (= (mk1 (to_rep2 (first4 temp___10871)) (to_rep2 (last4 temp___10871))) temp___10881))
(assert (= (ite (<= (to_rep2 (first2 temp___10881)) (to_rep2 (last2 temp___10881))) (+ (- (to_rep2 (last2 temp___10881)) (to_rep2 (first2 temp___10881))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
...
(assert (= temp___1095 (- o12 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1095) (<= temp___1095 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
(assert (= o13 temp___1095))
...
(assert (= temp___1097 (- o17 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1097)))
(check-sat)
(exit)
