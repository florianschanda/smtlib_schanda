...
(assert (= (to_rep o) ((_ extract 7 0) (bvurem (bvand val__ #x00000000000000FF) ((_ int2bv 64) 256)))))
(assert (= o1 (store memory addr o)))
(assert (= result memory))
(assert (= memory1 o1))
(assert (= (to_rep o2) ((_ extract 7 0) (bvurem (bvand (bvlshr val__ ((_ int2bv 64) 8)) #x00000000000000FF) ((_ int2bv 64) 256)))))
(assert (= o3 (store memory1 (bvadd addr #x0000000000000001) o2)))
(assert (= result1 memory1))
(assert (= memory2 o3))
(assert (= (to_rep o4) ((_ extract 7 0) (bvurem (bvand (bvlshr val__ ((_ int2bv 64) 16)) #x00000000000000FF) ((_ int2bv 64) 256)))))
(assert (= o5 (store memory2 (bvadd addr #x0000000000000002) o4)))
(assert (= result2 memory2))
(assert (= memory3 o5))
(assert (= (to_rep o6) ((_ extract 7 0) (bvurem (bvand (bvlshr val__ ((_ int2bv 64) 24)) #x00000000000000FF) ((_ int2bv 64) 256)))))
(assert (= o7 (store memory3 (bvadd addr #x0000000000000003) o6)))
(assert (= result3 memory3))
(assert (= memory4 o7))
(assert (= (to_rep o8) ((_ extract 7 0) (bvurem (bvand (bvlshr val__ ((_ int2bv 64) 32)) #x00000000000000FF) ((_ int2bv 64) 256)))))
(assert (= o9 (store memory4 (bvadd addr #x0000000000000004) o8)))
(assert (= result4 memory4))
(assert (= memory5 o9))
(assert (= (to_rep o10) ((_ extract 7 0) (bvurem (bvand (bvlshr val__ ((_ int2bv 64) 40)) #x00000000000000FF) ((_ int2bv 64) 256)))))
(assert (= o11 (store memory5 (bvadd addr #x0000000000000005) o10)))
(assert (= result5 memory5))
(assert (= memory6 o11))
(assert (= (to_rep o12) ((_ extract 7 0) (bvurem (bvand (bvlshr val__ ((_ int2bv 64) 48)) #x00000000000000FF) ((_ int2bv 64) 256)))))
(assert (= o13 (store memory6 (bvadd addr #x0000000000000006) o12)))
(assert (= result6 memory6))
(assert (= memory7 o13))
(assert (= (to_rep o14) ((_ extract 7 0) (bvurem (bvand (bvlshr val__ ((_ int2bv 64) 56)) #x00000000000000FF) ((_ int2bv 64) 256)))))
(assert (= o15 (store memory7 (bvadd addr #x0000000000000007) o14)))
(assert (= result7 memory7))
(assert (= memory8 o15))
(assert (= memory8 memory9))
(assert (= memory10 memory8))
(assert (not (= (bvor (bvor (bvor (bvor (bvor (bvor (bvor ((_ zero_extend 56) (to_rep (select memory9 addr))) (bvshl ((_ zero_extend 56) (to_rep (select memory9 (bvadd addr #x0000000000000001)))) ((_ int2bv 64) 8))) (bvshl ((_ zero_extend 56) (to_rep (select memory9 (bvadd addr #x0000000000000002)))) ((_ int2bv 64) 16))) (bvshl ((_ zero_extend 56) (to_rep (select memory9 (bvadd addr #x0000000000000003)))) ((_ int2bv 64) 24))) (bvshl ((_ zero_extend 56) (to_rep (select memory9 (bvadd addr #x0000000000000004)))) ((_ int2bv 64) 32))) (bvshl ((_ zero_extend 56) (to_rep (select memory9 (bvadd addr #x0000000000000005)))) ((_ int2bv 64) 40))) (bvshl ((_ zero_extend 56) (to_rep (select memory9 (bvadd addr #x0000000000000006)))) ((_ int2bv 64) 48))) (bvshl ((_ zero_extend 56) (to_rep (select memory9 (bvadd addr #x0000000000000007)))) ((_ int2bv 64) 56))) val__)))
(check-sat)
(exit)
