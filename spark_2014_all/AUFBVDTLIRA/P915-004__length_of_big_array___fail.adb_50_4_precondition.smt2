...
(assert (and (= fail__c__assume2 (create ((_ int2bv 64) 18446744073709551615))) (and (dynamic_invariant fail__c__assume2 true false true) (and (= (to_rep (last fail__c__assume1)) ((_ int2bv 64) 18446744073709551615)) (= (to_rep (first fail__c__assume1)) ((_ int2bv 64) 0))))))
