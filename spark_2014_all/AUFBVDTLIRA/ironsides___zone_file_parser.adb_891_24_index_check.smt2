...
(assert (= begidx1 1))
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 256)) (<= endidx1 256)) (=> (= foundtype1 1) (forall ((i10 Int)) (=> (and (<= begidx2 i10) (<= i10 endidx1)) (and (<= 48 (to_rep (select rrstring i10))) (<= (to_rep (select rrstring i10)) 57)))))) (and (and (in_range3 begidx2) (in_range3 endidx1)) (in_range2 foundtype1))))
(assert (= foundtype1 3))
...
(assert (=> (< temp___1705 256) (= o67 (bvshl #x01 ((_ int2bv 8) temp___1705)))))
(assert (=> (not (< temp___1705 256)) (= o67 #x00)))
(assert (not (<= 1 (int__content blockindex11))))
(check-sat)
(exit)
