...
(define-fun tregister_byte_arrayP1__ref___109__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___46__projection ((a target__ref)) us_t1 (target__content a))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__fs_plltune_type__fs_plltune bits_8)))))
(define-fun us_split_fields_FS_PLLTUNE__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__fs_plltune_type__fs_plltune a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___65__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___65__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__fs_plltune_type__fs_plltune (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__fs_plltune_type__fs_plltune (us_split_fields1 b)))) true false))
...
(assert (<= 0 dw1000__register_types__fs_plltune_type__fs_plltune__first__bit))
(assert (< dw1000__register_types__fs_plltune_type__fs_plltune__first__bit dw1000__register_types__fs_plltune_type__fs_plltune__last__bit))
(assert (<= 0 dw1000__register_types__fs_plltune_type__fs_plltune__position))
(declare-fun user_eq6 (us_rep us_rep) Bool)
(declare-const dummy6 us_rep)
(declare-datatypes () ((fs_plltune_type__ref (mk_fs_plltune_type__ref (fs_plltune_type__content us_rep)))))
(define-fun fs_plltune_type__ref___projection ((a fs_plltune_type__ref)) us_rep (fs_plltune_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___46__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_6306 us_t1) (temp___is_init_6302 Bool) (temp___skip_constant_6303 Bool) (temp___do_toplevel_6304 Bool) (temp___do_typ_inv_6305 Bool)) Bool (=> (not (= temp___skip_constant_6303 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6306) (last3 temp___expr_6306)) (and (= (first3 temp___expr_6306) 1) (= (last3 temp___expr_6306) 1)))))
...
(define-fun register_type__ref___154__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___109__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_6288 us_t2) (temp___is_init_6284 Bool) (temp___skip_constant_6285 Bool) (temp___do_toplevel_6286 Bool) (temp___do_typ_inv_6287 Bool)) Bool (=> (not (= temp___skip_constant_6285 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6288) (last5 temp___expr_6288)) (and (= (first5 temp___expr_6288) 1) (= (last5 temp___expr_6288) 1)))))
...
(declare-const temp___8820 (Array Int bits_8))
(declare-const temp___88201 t1)
(declare-const temp___8821 (Array Int bits_8))
(declare-const temp___88211 t2)
(define-fun temp___88202 () us_t1 (mk___t1 temp___8820 temp___88201))
...
(assert (and (= temp___88202 (register_to_bytes reg)) (dynamic_invariant temp___88202 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___88201)) (to_rep (last2 temp___88201))) (+ (- (to_rep (last2 temp___88201)) (to_rep (first2 temp___88201))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8820 temp___8821))
(assert (= (mk2 (to_rep (first2 temp___88201)) (to_rep (last2 temp___88201))) temp___88211))
(assert (not (= (ite (<= (to_rep (first4 temp___88211)) (to_rep (last4 temp___88211))) (+ (- (to_rep (last4 temp___88211)) (to_rep (first4 temp___88211))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
