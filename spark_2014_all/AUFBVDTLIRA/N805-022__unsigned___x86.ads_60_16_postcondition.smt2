...
(assert (= x86__edi__result1 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xdi 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xdi 3))) #x01000000))))
(assert (= (mk_t__ref1 x86__edi__result4) (mk_t__ref1 x86__edi__result2)))
(assert (= x86__edi__result5 x86__edi__result3))
(assert (= result1 x86__edi__result4))
(assert (not (= x86__edi__result4 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xdi 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xdi 3))) #x01000000)))))
(check-sat)
(exit)
