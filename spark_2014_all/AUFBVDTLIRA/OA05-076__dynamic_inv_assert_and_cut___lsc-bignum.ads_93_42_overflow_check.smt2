...
(assert (=> (= result1 true) (= o8 (select b o7))))
(assert (=> (= result1 true) (= o9 (to_rep1 o8))))
(assert (=> (= result1 true) (and (<= (to_rep b__first) k) (<= k (to_rep b__last)))))
(assert (=> (= result1 true) (= o5 k)))
(assert (=> (= result1 true) (= o6 (select b8 o5))))
(assert (=> (= result1 true) (= o10 (to_rep1 o6))))
(assert (=> (= result1 true) (= o11 (ite (= o10 o9) true false))))
(assert (=> (not (= result1 true)) (= o11 (distinct 1 0))))
(assert (not (in_range1 (+ b_first a_last))))
(check-sat)
(exit)
