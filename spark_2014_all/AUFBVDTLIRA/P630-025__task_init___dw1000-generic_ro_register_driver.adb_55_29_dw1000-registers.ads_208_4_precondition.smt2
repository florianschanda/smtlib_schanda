...
(define-fun dynamic_invariant ((temp___expr_2358 us_t1) (temp___is_init_2354 Bool) (temp___skip_constant_2355 Bool) (temp___do_toplevel_2356 Bool) (temp___do_typ_inv_2357 Bool)) Bool (=> (not (= temp___skip_constant_2355 true)) (and (dynamic_property2 1 5 (first3 temp___expr_2358) (last3 temp___expr_2358)) (and (= (first3 temp___expr_2358) 1) (= (last3 temp___expr_2358) 5)))))
