...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= tokentype1 1) (forall ((i3 Int)) (=> (and (<= begidx2 i3) (<= i3 endidx1)) (and (<= 48 (to_rep (select zonefileline i3))) (<= (to_rep (select zonefileline i3)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 tokentype1))))
...
(assert (<= r109b i1))
(assert (<= i1 r110b))
(assert (and (<= 1 begidx2) (<= begidx2 endidx1)))
(assert (and (=> (<= r109b r110b) (dynamic_property r109b r110b i2)) (and (<= r109b i2) (<= i2 r110b))))
(assert (= (to_rep o3) (to_rep (select zonefileline i2))))
(assert (and (= o1 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o2 (- o1 begidx2)))
(assert (and (= temp___1831 o2) (in_range1 o2)))
(assert (not (<= 1 temp___1831)))
(check-sat)
(exit)
