...
(assert (not (= (oeq (osubtract (num_of_big_int (mk___t a (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (num_of_big_int b b_first (- (+ i2 1) a_first))) (osubtract (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (omultiply (oexpon (base Tuple0) (- (+ i2 1) a_first)) (num_of_boolean carry3)))) true)))
(check-sat)
(exit)
