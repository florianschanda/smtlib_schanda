...
(declare-fun temp___1539 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1541 (_ BitVec 8))) (forall ((temp___1542 Int) (temp___1543 Int)) (let ((temp___1540 (temp___1539 temp___1541 temp___1542 temp___1543))) (=> (dynamic_invariant temp___1541 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1542 temp___1543) (and (= (first5 temp___1540) temp___1542) (= (last5 temp___1540) temp___1543))) (forall ((temp___1544 Int)) (= (to_rep (select (to_array2 temp___1540) temp___1544)) temp___1541))))))))
...
(declare-const temp___1556 us_rep)
...
(assert (= (to_rep2 (first4 (rt2 (temp___1539 #x00 1 r122b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1539 #x00 1 r122b)))) r122b))
(assert (= (mk___t2 temp___1546 temp___15461) (temp___1539 #x00 1 r122b)))
...
(assert (and (and (dynamic_invariant3 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1565 Int)) (=> (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) temp___1565) (<= temp___1565 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1565) (= (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) temp___1565) (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields2)) temp___1565)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
...
(assert (= temp___1556 (mk___rep result____split_discrs o18)))
(assert (= result5 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1556)))
(assert (= result____split_discrs (us_split_discrs1 temp___1556)))
