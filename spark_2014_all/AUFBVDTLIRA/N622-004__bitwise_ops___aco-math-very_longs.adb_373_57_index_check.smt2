...
(define-fun dynamic_invariant4 ((temp___expr_813 Int) (temp___is_init_810 Bool) (temp___skip_constant_811 Bool) (temp___do_toplevel_812 Bool)) Bool (=> (or (= temp___is_init_810 true) (<= 0 7)) (in_range4 temp___expr_813)))
...
(assert (forall ((temp___1456 (_ BitVec 8))) (forall ((temp___1457 Int) (temp___1458 Int)) (let ((temp___1455 (temp___1454 temp___1456 temp___1457 temp___1458))) (and (=> (dynamic_property6 1 2147483647 temp___1457 temp___1458) (and (= (first5 temp___1455) temp___1457) (= (last5 temp___1455) temp___1458))) (forall ((temp___1459 Int)) (= (select (to_array2 temp___1455) temp___1459) (of_rep temp___1456))))))))
(define-fun dynamic_invariant5 ((temp___expr_871 us_t1) (temp___is_init_868 Bool) (temp___skip_constant_869 Bool) (temp___do_toplevel_870 Bool)) Bool (=> (not (= temp___skip_constant_869 true)) (and (dynamic_property3 1 r122b (first3 temp___expr_871) (last3 temp___expr_871)) (and (= (first3 temp___expr_871) 1) (= (last3 temp___expr_871) r122b)))))
...
(declare-const temp___1478 digit_index_type)
(declare-const temp___14781 (Array Int octet))
(declare-const temp___14782 t)
(declare-const temp___1477 (_ BitVec 8))
(declare-const temp___1476 (_ BitVec 8))
...
(declare-const temp___1471 us_rep)
...
(declare-const temp___1475 us_rep)
...
(assert (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 number))) 1)))
(assert (and (= us (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 number)))) (in_range3 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 number))))))
(assert (= result (mk_t__ref old_overflow)))
(assert (= old_overflow1 ((_ int2bv 8) 0)))
(assert true)
(assert true)
(assert true)
(assert (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) r122b))
(assert (in_range3 r122b))
(assert (= (to_rep2 (first4 (rt2 (temp___1454 ((_ int2bv 8) 0) 1 r122b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1454 ((_ int2bv 8) 0) 1 r122b)))) r122b))
(assert (= (mk___t2 temp___1461 temp___14611) (temp___1454 ((_ int2bv 8) 0) 1 r122b)))
(assert (= (ite (<= (to_rep2 (first4 temp___14611)) (to_rep2 (last4 temp___14611))) (+ (- (to_rep2 (last4 temp___14611)) (to_rep2 (first4 temp___14611))) 1) 0) (ite (<= 1 r122b) (+ (- r122b 1) 1) 0)))
(assert (= temp___1461 temp___1462))
(assert (= (mk1 (to_rep2 (first4 temp___14611)) (to_rep2 (last4 temp___14611))) temp___14621))
(assert (= (ite (<= (to_rep2 (first2 temp___14621)) (to_rep2 (last2 temp___14621))) (+ (- (to_rep2 (last2 temp___14621)) (to_rep2 (first2 temp___14621))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1464 temp___14641) (mk___t1 temp___1462 temp___14621)))
(assert (= temp___1464 o1))
(assert (= (mk (to_rep2 (first2 temp___14641)) (to_rep2 (last2 temp___14641))) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= result____split_discrs (mk___split_discrs temp___1466)))
(assert (= temp___14661 o3))
(assert (= temp___14662 o4))
(assert (= result1 (mk___split_fields__ref (mk___split_fields (mk___t result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___14661 temp___14662))))
(assert (= result____split_discrs (mk___split_discrs temp___1466)))
...
(assert (and (and (dynamic_invariant3 (mk___rep result____split_discrs result____split_fields3) false true true) (forall ((temp___1480 Int)) (=> (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) temp___1480) (<= temp___1480 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1480) (= (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) temp___1480) (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields2)) temp___1480)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
...
(assert (= o6 i2))
(assert (= o7 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) o6)))
(assert (= o8 (to_rep o7)))
(assert (= o9 (bvand o8 overflow_mask1)))
(assert (and (= o10 (shift_right o9 (- 8 distance))) (= o10 (bvudiv o9 (ite (< (- 8 distance) 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (- 8 distance))) ((_ int2bv 8) 0))))))
(assert (= result4 (mk_t__ref new_overflow2)))
(assert (= new_overflow3 o10))
...
(assert (=> (< distance 8) (= o11 i2)))
(assert (=> (< distance 8) (= o12 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 number))) o11))))
(assert (=> (< distance 8) (= o13 (to_rep o12))))
(assert (=> (< distance 8) (= o14 (bvshl o13 ((_ int2bv 8) distance)))))
(assert (=> (not (< distance 8)) (= o14 ((_ int2bv 8) 0))))
...
(assert (= o16 i2))
(assert (= o17 (store (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) o16 o15)))
(assert (= o18 (mk___t o17 (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))
(assert (= o19 (mk___split_fields o18)))
(assert (= temp___1471 (mk___rep result____split_discrs o19)))
(assert (= result5 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1471)))
(assert (= result____split_discrs (us_split_discrs1 temp___1471)))
