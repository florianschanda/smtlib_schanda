...
(assert (= (mk (to_rep2 (first2 temp___14641)) (to_rep2 (last2 temp___14641))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (and (= o9 (shift_right o8 (- 8 distance))) (= o9 (bvudiv o8 (ite (< (- 8 distance) 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (- 8 distance))) ((_ int2bv 8) 0))))))
...
(assert (=> (< distance 8) (= o12 (to_rep o11))))
...
(assert (= temp___1471 (mk___rep result____split_discrs o18)))
