...
(assert (not (= (ite (<= (to_rep2 (first2 temp___10191)) (to_rep2 (last2 temp___10191))) (+ (- (to_rep2 (last2 temp___10191)) (to_rep2 (first2 temp___10191))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0))))
(check-sat)
(exit)
