...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i16 Int)) (=> (and (<= begidx2 i16) (<= i16 endidx1)) (and (<= 48 (to_rep (select zonefileline i16))) (<= (to_rep (select zonefileline i16)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i16 Int)) (=> (and (<= begidx5 i16) (<= i16 endidx3)) (and (<= 48 (to_rep (select zonefileline i16))) (<= (to_rep (select zonefileline i16)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (= begidx10 o1))
(assert (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i16 Int)) (=> (and (<= begidx11 i16) (<= i16 endidx8)) (and (<= 48 (to_rep (select zonefileline i16))) (<= (to_rep (select zonefileline i16)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8))))
(assert (= foundtype8 1))
...
(assert (= begidx12 o2))
(assert (and (and (and (and (<= begidx13 endidx9) (<= begidx13 zlength)) (<= endidx9 zlength)) (=> (= foundtype9 1) (forall ((i16 Int)) (=> (and (<= begidx13 i16) (<= i16 endidx9)) (and (<= 48 (to_rep (select zonefileline i16))) (<= (to_rep (select zonefileline i16)) 57)))))) (and (and (in_range4 begidx13) (in_range4 endidx9)) (in_range3 foundtype9))))
(assert (= foundtype9 1))
...
(assert (= begidx14 o3))
(assert (and (and (and (and (<= begidx15 endidx10) (<= begidx15 zlength)) (<= endidx10 zlength)) (=> (= foundtype10 1) (forall ((i16 Int)) (=> (and (<= begidx15 i16) (<= i16 endidx10)) (and (<= 48 (to_rep (select zonefileline i16))) (<= (to_rep (select zonefileline i16)) 57)))))) (and (and (in_range4 begidx15) (in_range4 endidx10)) (in_range3 foundtype10))))
