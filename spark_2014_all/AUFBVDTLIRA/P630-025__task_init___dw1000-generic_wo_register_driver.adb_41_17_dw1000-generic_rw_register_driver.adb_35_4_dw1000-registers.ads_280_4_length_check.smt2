...
(assert (= (ite (<= (to_rep (first4 temp___78001)) (to_rep (last4 temp___78001))) (+ (- (to_rep (last4 temp___78001)) (to_rep (first4 temp___78001))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7800 temp___7801))
(assert (= (mk1 (to_rep (first4 temp___78001)) (to_rep (last4 temp___78001))) temp___78011))
(assert (not (= (ite (<= (to_rep (first2 temp___78011)) (to_rep (last2 temp___78011))) (+ (- (to_rep (last2 temp___78011)) (to_rep (first2 temp___78011))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
