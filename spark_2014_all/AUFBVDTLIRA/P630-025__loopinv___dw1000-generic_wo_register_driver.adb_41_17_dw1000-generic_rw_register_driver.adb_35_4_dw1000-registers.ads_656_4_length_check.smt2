...
(define-fun dynamic_invariant ((temp___expr_7251 us_t1) (temp___is_init_7248 Bool) (temp___skip_constant_7249 Bool) (temp___do_toplevel_7250 Bool)) Bool (=> (not (= temp___skip_constant_7249 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7251) (last3 temp___expr_7251)) (and (= (first3 temp___expr_7251) 1) (= (last3 temp___expr_7251) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_7269 us_t2) (temp___is_init_7266 Bool) (temp___skip_constant_7267 Bool) (temp___do_toplevel_7268 Bool)) Bool (=> (not (= temp___skip_constant_7267 true)) (and (dynamic_property3 1 2 (first5 temp___expr_7269) (last5 temp___expr_7269)) (and (= (first5 temp___expr_7269) 1) (= (last5 temp___expr_7269) 2)))))
...
(declare-const temp___8213 (Array Int bits_8))
(declare-const temp___82131 t2)
(declare-const temp___8214 (Array Int bits_8))
(declare-const temp___82141 t1)
(define-fun temp___82132 () us_t2 (mk___t2 temp___8213 temp___82131))
...
(assert (and (= temp___82132 (register_to_bytes reg)) (dynamic_invariant1 temp___82132 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___82131)) (to_rep (last4 temp___82131))) (+ (- (to_rep (last4 temp___82131)) (to_rep (first4 temp___82131))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8213 temp___8214))
(assert (= (mk1 (to_rep (first4 temp___82131)) (to_rep (last4 temp___82131))) temp___82141))
(assert (not (= (ite (<= (to_rep (first2 temp___82141)) (to_rep (last2 temp___82141))) (+ (- (to_rep (last2 temp___82141)) (to_rep (first2 temp___82141))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
