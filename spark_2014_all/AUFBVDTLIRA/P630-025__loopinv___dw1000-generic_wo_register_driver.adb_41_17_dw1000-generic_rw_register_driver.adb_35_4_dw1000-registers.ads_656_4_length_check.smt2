...
(define-fun in_range4 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x07FF)))
...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x0800))) (=> (in_range4 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
(define-fun to_int6 ((x bits_11)) Int (bv2nat (to_rep4 x)))
(assert (forall ((x bits_11)) (! (in_range_int2 (to_int6 x)) :pattern ((to_int6 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__diag_tmc_type__tx_pstm bits_1) (rec__dw1000__register_types__diag_tmc_type__reserved_1 bits_4) (rec__dw1000__register_types__diag_tmc_type__reserved_2 bits_11)))))
(define-fun us_split_fields_TX_PSTM__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__diag_tmc_type__tx_pstm a))
(define-fun us_split_fields_Reserved_1__15__projection ((a us_split_fields)) bits_4 (rec__dw1000__register_types__diag_tmc_type__reserved_1 a))
(define-fun us_split_fields_Reserved_2__15__projection ((a us_split_fields)) bits_11 (rec__dw1000__register_types__diag_tmc_type__reserved_2 a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___100__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___100__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep2 (rec__dw1000__register_types__diag_tmc_type__tx_pstm (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__diag_tmc_type__tx_pstm (us_split_fields1 b)))) (= (to_rep3 (rec__dw1000__register_types__diag_tmc_type__reserved_1 (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__diag_tmc_type__reserved_1 (us_split_fields1 b))))) (= (to_rep4 (rec__dw1000__register_types__diag_tmc_type__reserved_2 (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__diag_tmc_type__reserved_2 (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__diag_tmc_type__tx_pstm__first__bit Int)
(declare-const dw1000__register_types__diag_tmc_type__tx_pstm__last__bit Int)
(declare-const dw1000__register_types__diag_tmc_type__tx_pstm__position Int)
(assert (<= 0 dw1000__register_types__diag_tmc_type__tx_pstm__first__bit))
(assert (< dw1000__register_types__diag_tmc_type__tx_pstm__first__bit dw1000__register_types__diag_tmc_type__tx_pstm__last__bit))
(assert (<= 0 dw1000__register_types__diag_tmc_type__tx_pstm__position))
(declare-const dw1000__register_types__diag_tmc_type__reserved_1__first__bit Int)
(declare-const dw1000__register_types__diag_tmc_type__reserved_1__last__bit Int)
(declare-const dw1000__register_types__diag_tmc_type__reserved_1__position Int)
(assert (<= 0 dw1000__register_types__diag_tmc_type__reserved_1__first__bit))
(assert (< dw1000__register_types__diag_tmc_type__reserved_1__first__bit dw1000__register_types__diag_tmc_type__reserved_1__last__bit))
(assert (<= 0 dw1000__register_types__diag_tmc_type__reserved_1__position))
(declare-const dw1000__register_types__diag_tmc_type__reserved_2__first__bit Int)
(declare-const dw1000__register_types__diag_tmc_type__reserved_2__last__bit Int)
(declare-const dw1000__register_types__diag_tmc_type__reserved_2__position Int)
(assert (<= 0 dw1000__register_types__diag_tmc_type__reserved_2__first__bit))
(assert (< dw1000__register_types__diag_tmc_type__reserved_2__first__bit dw1000__register_types__diag_tmc_type__reserved_2__last__bit))
(assert (<= 0 dw1000__register_types__diag_tmc_type__reserved_2__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((diag_tmc_type__ref (mk_diag_tmc_type__ref (diag_tmc_type__content us_rep)))))
(define-fun diag_tmc_type__ref___projection ((a diag_tmc_type__ref)) us_rep (diag_tmc_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___227__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___163__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___163__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_7986 us_t1) (temp___is_init_7982 Bool) (temp___skip_constant_7983 Bool) (temp___do_toplevel_7984 Bool) (temp___do_typ_inv_7985 Bool)) Bool (=> (not (= temp___skip_constant_7983 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7986) (last3 temp___expr_7986)) (and (= (first3 temp___expr_7986) 1) (= (last3 temp___expr_7986) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___65__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___65__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_8006 us_t2) (temp___is_init_8002 Bool) (temp___skip_constant_8003 Bool) (temp___do_toplevel_8004 Bool) (temp___do_typ_inv_8005 Bool)) Bool (=> (not (= temp___skip_constant_8003 true)) (and (dynamic_property3 1 2 (first5 temp___expr_8006) (last5 temp___expr_8006)) (and (= (first5 temp___expr_8006) 1) (= (last5 temp___expr_8006) 2)))))
...
(declare-const temp___8985 (Array Int bits_8))
(declare-const temp___89851 t2)
(declare-const temp___8986 (Array Int bits_8))
(declare-const temp___89861 t1)
(define-fun temp___89852 () us_t2 (mk___t2 temp___8985 temp___89851))
...
(assert (and (= temp___89852 (register_to_bytes reg)) (dynamic_invariant1 temp___89852 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___89851)) (to_rep (last4 temp___89851))) (+ (- (to_rep (last4 temp___89851)) (to_rep (first4 temp___89851))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8985 temp___8986))
(assert (= (mk1 (to_rep (first4 temp___89851)) (to_rep (last4 temp___89851))) temp___89861))
(assert (not (= (ite (<= (to_rep (first2 temp___89861)) (to_rep (last2 temp___89861))) (+ (- (to_rep (last2 temp___89861)) (to_rep (first2 temp___89861))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
