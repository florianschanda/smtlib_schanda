...
(define-fun dynamic_invariant ((temp___expr_3425 us_t1) (temp___is_init_3422 Bool) (temp___skip_constant_3423 Bool) (temp___do_toplevel_3424 Bool)) Bool (=> (not (= temp___skip_constant_3423 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3425) (last3 temp___expr_3425)) (and (= (first3 temp___expr_3425) 1) (= (last3 temp___expr_3425) 2)))))
