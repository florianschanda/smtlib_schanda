...
(declare-const dummy3 unsigned81)
...
(define-fun dynamic_invariant3 ((temp___expr_335 (_ BitVec 8)) (temp___is_init_331 Bool) (temp___skip_constant_332 Bool) (temp___do_toplevel_333 Bool) (temp___do_typ_inv_334 Bool)) Bool true)
...
(define-fun dynamic_invariant4 ((temp___expr_243 (_ BitVec 32)) (temp___is_init_239 Bool) (temp___skip_constant_240 Bool) (temp___do_toplevel_241 Bool) (temp___do_typ_inv_242 Bool)) Bool true)
(declare-fun readreg32 ((_ BitVec 64)) (_ BitVec 32))
(declare-fun readreg32__function_guard ((_ BitVec 32) (_ BitVec 64)) Bool)
(assert (forall ((reg (_ BitVec 64))) (! (=> (dynamic_invariant reg true true true true) (let ((result (readreg32 reg))) (and (= result ((_ extract 31 0) (bvand reg #x00000000FFFFFFFF))) (dynamic_invariant4 result true false true true)))) :pattern ((readreg32 reg)))))
(assert (forall ((regnew (_ BitVec 64))) (forall ((val__ (_ BitVec 32))) (! (=> (and (dynamic_invariant regnew true true true true) (dynamic_invariant4 val__ true true true true)) (= (= (writereg32post regnew val__) true) (and (= (readreg32 regnew) val__) (= (bvand regnew #xFFFFFFFF00000000) #x0000000000000000)))) :pattern ((writereg32post regnew val__))))))
...
(declare-const savestackptr (_ BitVec 64))
(declare-const ra0 (_ BitVec 8))
(declare-const ra1 (_ BitVec 8))
(declare-const ra2 (_ BitVec 8))
(declare-const ra3 (_ BitVec 8))
(declare-const ra4 (_ BitVec 8))
(declare-const ra5 (_ BitVec 8))
(declare-const ra6 (_ BitVec 8))
(declare-const ra7 (_ BitVec 8))
...
(declare-const result10 t__ref2)
(declare-const rsp2 (_ BitVec 64))
(declare-const zeroflag1 bool__ref)
(declare-const carryflag1 bool__ref)
(declare-const signflag1 bool__ref)
(declare-const overflowflag1 bool__ref)
(declare-const rax2 t__ref2)
(declare-const rcx1 t__ref2)
(declare-const rdx2 t__ref2)
(declare-const rsp3 t__ref2)
(declare-const rdi1 t__ref2)
(declare-const r83 t__ref2)
(declare-const memory2 map__ref)
(declare-const savestackptr2 t__ref2)
...
(assert (not (= (inrange64 rsi (bvsub rsp #x0000000000000007) #x000000000000000F) true)))
(assert (= o rsp))
(assert (= result (mk_t__ref2 savestackptr)))
(assert (= savestackptr1 o))
(assert (and (= o1 (readmem8 rsp memory)) (= o1 (to_rep (select memory rsp)))))
(assert (= o2 o1))
(assert (= result1 (mk_t__ref ra0)))
(assert (= ra01 o2))
(assert (and (= o3 (readmem8 (bvadd rsp #x0000000000000001) memory)) (= o3 (to_rep (select memory (bvadd rsp #x0000000000000001))))))
(assert (= o4 o3))
(assert (= result2 (mk_t__ref ra1)))
(assert (= ra11 o4))
(assert (and (= o5 (readmem8 (bvadd rsp #x0000000000000002) memory)) (= o5 (to_rep (select memory (bvadd rsp #x0000000000000002))))))
(assert (= o6 o5))
(assert (= result3 (mk_t__ref ra2)))
(assert (= ra21 o6))
(assert (and (= o7 (readmem8 (bvadd rsp #x0000000000000003) memory)) (= o7 (to_rep (select memory (bvadd rsp #x0000000000000003))))))
(assert (= o8 o7))
(assert (= result4 (mk_t__ref ra3)))
(assert (= ra31 o8))
(assert (and (= o9 (readmem8 (bvadd rsp #x0000000000000004) memory)) (= o9 (to_rep (select memory (bvadd rsp #x0000000000000004))))))
(assert (= o10 o9))
(assert (= result5 (mk_t__ref ra4)))
(assert (= ra41 o10))
(assert (and (= o11 (readmem8 (bvadd rsp #x0000000000000005) memory)) (= o11 (to_rep (select memory (bvadd rsp #x0000000000000005))))))
(assert (= o12 o11))
(assert (= result6 (mk_t__ref ra5)))
(assert (= ra51 o12))
(assert (and (= o13 (readmem8 (bvadd rsp #x0000000000000006) memory)) (= o13 (to_rep (select memory (bvadd rsp #x0000000000000006))))))
(assert (= o14 o13))
(assert (= result7 (mk_t__ref ra6)))
(assert (= ra61 o14))
(assert (and (= o15 (readmem8 (bvadd rsp #x0000000000000007) memory)) (= o15 (to_rep (select memory (bvadd rsp #x0000000000000007))))))
(assert (= o16 o15))
(assert (= result8 (mk_t__ref ra7)))
(assert (= ra71 o16))
(assert (= rsp #xA7FFFFFFFFFFFFFF))
(assert (= result9 (mk_t__ref2 r8)))
(assert (= r81 #x0000000000000020))
(assert (= (writereg32post rax #x00000000) true))
(assert (= (writereg32post rdx #x00000000) true))
(assert (= rsp1 rsp))
(assert (and (and (and (and (and (and (and (and (= (bvand rax1 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory1 rsi)))) (= (bvand rax1 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi #x0000000000000001)))) #x0000000000000100))) (= (bvand rax1 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi #x0000000000000002)))) #x0000000000010000))) (= (bvand rax1 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi #x0000000000000003)))) #x0000000001000000))) (= (bvand rax1 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi #x0000000000000004)))) #x0000000100000000))) (= (bvand rax1 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi #x0000000000000005)))) #x0000010000000000))) (= (bvand rax1 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi #x0000000000000006)))) #x0001000000000000))) (= (bvand rax1 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi #x0000000000000007)))) #x0100000000000000))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (and (and (and (and (and (and (and (not (= i rsi)) (not (= i (bvadd rsi #x0000000000000001)))) (not (= i (bvadd rsi #x0000000000000002)))) (not (= i (bvadd rsi #x0000000000000003)))) (not (= i (bvadd rsi #x0000000000000004)))) (not (= i (bvadd rsi #x0000000000000005)))) (not (= i (bvadd rsi #x0000000000000006)))) (not (= i (bvadd rsi #x0000000000000007)))) (= (to_rep (select memory1 i)) (to_rep (select memory i))))))))
(assert (= result10 (mk_t__ref2 rsp1)))
(assert (= rsp2 (bvadd rsp1 #x0000000000000008)))
(assert (= ra72 (mk_t__ref ra71)))
(assert (= ra62 (mk_t__ref ra61)))
(assert (= ra52 (mk_t__ref ra51)))
(assert (= ra42 (mk_t__ref ra41)))
(assert (= ra32 (mk_t__ref ra31)))
(assert (= ra22 (mk_t__ref ra21)))
(assert (= ra12 (mk_t__ref ra11)))
(assert (= ra02 (mk_t__ref ra01)))
(assert (= savestackptr2 (mk_t__ref2 savestackptr1)))
(assert (= memory2 (mk_map__ref memory1)))
(assert (= r83 (mk_t__ref2 r82)))
(assert (= rdi1 (mk_t__ref2 rdi)))
(assert (= rsp3 (mk_t__ref2 rsp2)))
(assert (= rdx2 (mk_t__ref2 rdx1)))
(assert (= rcx1 (mk_t__ref2 rcx)))
(assert (= rax2 (mk_t__ref2 rax1)))
(assert (= overflowflag1 (mk_bool__ref overflowflag)))
(assert (= signflag1 (mk_bool__ref signflag)))
(assert (= carryflag1 (mk_bool__ref carryflag)))
(assert (= zeroflag1 (mk_bool__ref zeroflag)))
(assert (= ra73 ra71))
(assert (= ra63 ra61))
(assert (= ra53 ra51))
(assert (= ra43 ra41))
...
(assert (= signflag2 signflag))
(assert (= carryflag2 carryflag))
(assert (= zeroflag2 zeroflag))
(assert (not (= (t__content2 rsp3) (bvadd rsp #x0000000000000008))))
(check-sat)
(exit)
