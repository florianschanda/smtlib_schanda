...
(define-fun dynamic_invariant ((temp___expr_4409 us_rep) (temp___is_init_4406 Bool) (temp___skip_constant_4407 Bool) (temp___do_toplevel_4408 Bool)) Bool (=> (= temp___do_toplevel_4408 true) (=> (= temp___is_init_4406 true) (ite (= (to_rep1 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___expr_4409))) 0) (< 0 (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4409)))) (= (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4409))) 0)))))
(define-fun dynamic_predicate ((temp___4420 us_rep)) Bool (ite (= (to_rep1 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___4420))) 0) (< 0 (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4420)))) (= (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4420))) 0)))
...
(define-fun in_range4 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 1))))
...
(define-fun dynamic_invariant2 ((temp___expr_4397 Int) (temp___is_init_4394 Bool) (temp___skip_constant_4395 Bool) (temp___do_toplevel_4396 Bool)) Bool (=> (or (= temp___is_init_4394 true) (<= 0 1024)) (in_range1 temp___expr_4397)))
(define-fun dynamic_invariant3 ((temp___expr_4403 Int) (temp___is_init_4400 Bool) (temp___skip_constant_4401 Bool) (temp___do_toplevel_4402 Bool)) Bool (=> (or (= temp___is_init_4400 true) (<= 0 5)) (in_range2 temp___expr_4403)))
(define-fun dynamic_invariant4 ((temp___expr_4427 (_ BitVec 8)) (temp___is_init_4424 Bool) (temp___skip_constant_4425 Bool) (temp___do_toplevel_4426 Bool)) Bool (=> (or (= temp___is_init_4424 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range4 temp___expr_4427)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 2)))) (=> (in_range4 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
...
(define-fun dynamic_invariant5 ((temp___expr_4459 us_rep1) (temp___is_init_4456 Bool) (temp___skip_constant_4457 Bool) (temp___do_toplevel_4458 Bool)) Bool (forall ((temp___4460 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) temp___4460) (bvule temp___4460 ((_ int2bv 8) 1))) (let ((temp___4461 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_4459)) temp___4460))) (ite (= (to_rep1 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___4461))) 0) (< 0 (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4461)))) (= (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4461))) 0))))))
(define-fun default_initial_assumption ((temp___expr_4463 us_rep1) (temp___skip_top_level_4464 Bool)) Bool (and (and (and (and (= (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_4463)) (temp___4465 (mk___rep (mk___split_fields (of_rep 0) (temp___4469 ((_ int2bv 8) 0)) (of_rep1 0) (of_int 0))))) (= (to_rep4 (rec__decadriver__receiver_type__queue_head (us_split_fields3 temp___expr_4463))) ((_ int2bv 8) 1))) (= (to_rep3 (rec__decadriver__receiver_type__rx_count (us_split_fields3 temp___expr_4463))) 0)) (= (rec__decadriver__receiver_type__overrun_occurred (us_split_fields3 temp___expr_4463)) (of_int 0))) (= (rec__decadriver__receiver_type__frame_ready (us_split_fields3 temp___expr_4463)) (of_int 0))))
...
(declare-const temp___4527 frame_length)
(declare-const temp___45271 (Array Int bits_8))
(declare-const temp___45272 rx_errors)
(declare-const temp___45273 Bool)
(assert (= (to_rep1 o) 0))
(assert (= (to_rep o1) 0))
(assert (= o1 o2))
(assert (= (temp___4469 ((_ int2bv 8) 0)) o3))
(assert (= o o4))
(assert (= (of_int 0) o5))
(assert (= temp___4527 o2))
(assert (= temp___45271 o3))
(assert (= temp___45272 o4))
(assert (= temp___45273 o5))
(assert (not (dynamic_predicate (mk___rep (mk___split_fields temp___4527 temp___45271 temp___45272 temp___45273)))))
(check-sat)
(exit)
