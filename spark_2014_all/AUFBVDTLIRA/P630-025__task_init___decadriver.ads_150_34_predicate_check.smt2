...
(define-fun dynamic_invariant ((temp___expr_4419 us_rep) (temp___is_init_4416 Bool) (temp___skip_constant_4417 Bool) (temp___do_toplevel_4418 Bool)) Bool (=> (= temp___do_toplevel_4418 true) (=> (= temp___is_init_4416 true) (ite (= (to_rep1 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___expr_4419))) 0) (< 0 (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4419)))) (= (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4419))) 0)))))
(define-fun dynamic_predicate ((temp___4430 us_rep)) Bool (ite (= (to_rep1 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___4430))) 0) (< 0 (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4430)))) (= (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4430))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_4407 Int) (temp___is_init_4404 Bool) (temp___skip_constant_4405 Bool) (temp___do_toplevel_4406 Bool)) Bool (=> (or (= temp___is_init_4404 true) (<= 0 1024)) (in_range1 temp___expr_4407)))
(define-fun dynamic_invariant3 ((temp___expr_4413 Int) (temp___is_init_4410 Bool) (temp___skip_constant_4411 Bool) (temp___do_toplevel_4412 Bool)) Bool (=> (or (= temp___is_init_4410 true) (<= 0 5)) (in_range2 temp___expr_4413)))
(define-fun dynamic_invariant4 ((temp___expr_4437 (_ BitVec 8)) (temp___is_init_4434 Bool) (temp___skip_constant_4435 Bool) (temp___do_toplevel_4436 Bool)) Bool (=> (or (= temp___is_init_4434 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range4 temp___expr_4437)))
...
(define-fun dynamic_invariant5 ((temp___expr_4469 us_rep1) (temp___is_init_4466 Bool) (temp___skip_constant_4467 Bool) (temp___do_toplevel_4468 Bool)) Bool (forall ((temp___4470 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) temp___4470) (bvule temp___4470 ((_ int2bv 8) 1))) (let ((temp___4471 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_4469)) temp___4470))) (ite (= (to_rep1 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___4471))) 0) (< 0 (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4471)))) (= (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4471))) 0))))))
(define-fun default_initial_assumption ((temp___expr_4473 us_rep1) (temp___skip_top_level_4474 Bool)) Bool (and (and (and (and (= (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_4473)) (temp___4475 (mk___rep (mk___split_fields (of_rep 0) (temp___4479 ((_ int2bv 8) 0)) (of_rep1 0) (of_int 0))))) (= (to_rep4 (rec__decadriver__receiver_type__queue_head (us_split_fields3 temp___expr_4473))) ((_ int2bv 8) 1))) (= (to_rep3 (rec__decadriver__receiver_type__rx_count (us_split_fields3 temp___expr_4473))) 0)) (= (rec__decadriver__receiver_type__overrun_occurred (us_split_fields3 temp___expr_4473)) (of_int 0))) (= (rec__decadriver__receiver_type__frame_ready (us_split_fields3 temp___expr_4473)) (of_int 0))))
...
(declare-const temp___4537 frame_length)
(declare-const temp___45371 (Array Int bits_8))
(declare-const temp___45372 rx_errors)
(declare-const temp___45373 Bool)
(assert (= (to_rep1 o) 0))
(assert (= (to_rep o1) 0))
(assert (= o1 o2))
(assert (= (temp___4479 ((_ int2bv 8) 0)) o3))
(assert (= o o4))
(assert (= (of_int 0) o5))
(assert (= temp___4537 o2))
(assert (= temp___45371 o3))
(assert (= temp___45372 o4))
(assert (= temp___45373 o5))
(assert (not (dynamic_predicate (mk___rep (mk___split_fields temp___4537 temp___45371 temp___45372 temp___45373)))))
(check-sat)
(exit)
