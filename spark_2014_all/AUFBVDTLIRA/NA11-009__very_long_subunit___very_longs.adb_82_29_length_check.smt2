...
(assert (not (= (ite (<= (to_rep1 (first4 temp___12251)) (to_rep1 (last4 temp___12251))) (+ (- (to_rep1 (last4 temp___12251)) (to_rep1 (first4 temp___12251))) 1) 0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0))))
(check-sat)
(exit)
