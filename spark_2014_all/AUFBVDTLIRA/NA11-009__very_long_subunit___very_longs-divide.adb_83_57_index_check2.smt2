...
(assert (in_range2 r120b))
(assert (= result2 i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 r120b))
(assert (and (and (dynamic_invariant2 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true true) (forall ((temp___1294 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1294) (<= temp___1294 (to_rep1 (last number__split_fields3)))) (=> (or (< r120b temp___1294) (or (< temp___1294 1) (<= i2 temp___1294))) (= (select number__split_fields2 temp___1294) (select number__split_fields temp___1294)))))) (and (<= 1 i2) (<= i2 r120b))))
