...
(define-fun dynamic_invariant2 ((temp___expr_231 Int) (temp___is_init_228 Bool) (temp___skip_constant_229 Bool) (temp___do_toplevel_230 Bool)) Bool (=> (or (= temp___is_init_228 true) (<= 0 2)) (in_range4 temp___expr_231)))
...
(define-fun dynamic_invariant3 ((temp___expr_237 Int) (temp___is_init_234 Bool) (temp___skip_constant_235 Bool) (temp___do_toplevel_236 Bool)) Bool (=> (or (= temp___is_init_234 true) (<= 0 2)) (in_range5 temp___expr_237)))
...
(declare-fun temp___251 (Int Int Int) us_t1)
(assert (forall ((temp___253 Int) (temp___254 Int) (temp___255 Int)) (let ((temp___252 (temp___251 temp___253 temp___254 temp___255))) (and (=> (dynamic_property 1 2147483647 temp___254 temp___255) (and (= (first3 temp___252) temp___254) (= (last3 temp___252) temp___255))) (forall ((temp___256 Int)) (= (select (to_array1 temp___252) temp___256) (of_rep temp___253)))))))
...
(declare-const temp___258 (Array Int character))
(declare-const temp___2581 t1)
(declare-const temp___259 (Array Int character))
(declare-const temp___2591 t)
(declare-const temp___260 (Array Int character))
(declare-const temp___2601 t)
...
(assert (= (to_rep1 (first2 (rt1 (temp___251 32 (to_rep1 buffer__first) (to_rep1 buffer__last))))) (to_rep1 buffer__first)))
(assert (= (to_rep1 (last2 (rt1 (temp___251 32 (to_rep1 buffer__first) (to_rep1 buffer__last))))) (to_rep1 buffer__last)))
(assert (= (mk___t1 temp___258 temp___2581) (temp___251 32 (to_rep1 buffer__first) (to_rep1 buffer__last))))
(assert (= temp___258 temp___259))
(assert (= (mk (to_rep1 (first2 temp___2581)) (to_rep1 (last2 temp___2581))) temp___2591))
(assert (= (ite (<= (to_rep1 (first temp___2591)) (to_rep1 (last temp___2591))) (+ (- (to_rep1 (last temp___2591)) (to_rep1 (first temp___2591))) 1) 0) (ite (<= (to_rep1 buffer__first) (to_rep1 buffer__last)) (+ (- (to_rep1 buffer__last) (to_rep1 buffer__first)) 1) 0)))
(assert (= (mk___t temp___260 temp___2601) (mk___t temp___259 temp___2591)))
(assert (= o (slide temp___260 (to_rep1 (first temp___2601)) (to_rep1 buffer__first))))
...
(assert (=> (<= (to_rep1 buffer__first) (to_rep1 buffer__last)) (= o3 (+ (- (to_rep1 buffer__last) (to_rep1 buffer__first)) 1))))
(assert (=> (not (<= (to_rep1 buffer__first) (to_rep1 buffer__last))) (= o3 0)))
(assert (and (= o4 o3) (in_range o3)))
(assert (= result3 (ite (= count2 o4) true false)))
(assert (not (= result3 true)))
(assert (= status3 status2))
(assert (in_range4 port_status2))
(assert (= port_status2 0))
(assert (= status4 status3))
(assert (not (= (bv2nat value2) 13)))
(assert (= (to_rep o5) (bv2nat value2)))
(assert (and (= temp___261 (+ (to_rep1 buffer__first) count2)) (in_range (+ (to_rep1 buffer__first) count2))))
(assert (not (<= (to_rep1 buffer__first) temp___261)))
(check-sat)
(exit)
