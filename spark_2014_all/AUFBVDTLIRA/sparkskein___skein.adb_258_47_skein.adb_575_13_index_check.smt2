...
(assert (= o67 (bvadd src_index1 #x0000000000000007)))
(assert (= o68 (select (elts block) o67)))
(assert (= o69 (to_rep o68)))
(assert (= o70 ((_ zero_extend 56) o69)))
(assert (= o71 (bvshl o70 ((_ int2bv 64) 56))))
(assert (and (bvule (to_rep2 (first (rt block))) (bvadd src_index1 #x0000000000000006)) (bvule (bvadd src_index1 #x0000000000000006) (to_rep2 (last (rt block))))))
(assert (= o62 (bvadd src_index1 #x0000000000000006)))
(assert (= o63 (select (elts block) o62)))
(assert (= o64 (to_rep o63)))
(assert (= o65 ((_ zero_extend 56) o64)))
(assert (= o66 (bvshl o65 ((_ int2bv 64) 48))))
(assert (and (bvule (to_rep2 (first (rt block))) (bvadd src_index1 #x0000000000000005)) (bvule (bvadd src_index1 #x0000000000000005) (to_rep2 (last (rt block))))))
(assert (= o57 (bvadd src_index1 #x0000000000000005)))
(assert (= o58 (select (elts block) o57)))
(assert (= o59 (to_rep o58)))
(assert (= o60 ((_ zero_extend 56) o59)))
(assert (= o61 (bvshl o60 ((_ int2bv 64) 40))))
(assert (and (bvule (to_rep2 (first (rt block))) (bvadd src_index1 #x0000000000000004)) (bvule (bvadd src_index1 #x0000000000000004) (to_rep2 (last (rt block))))))
(assert (= o52 (bvadd src_index1 #x0000000000000004)))
(assert (= o53 (select (elts block) o52)))
(assert (= o54 (to_rep o53)))
(assert (= o55 ((_ zero_extend 56) o54)))
(assert (= o56 (bvshl o55 ((_ int2bv 64) 32))))
(assert (and (bvule (to_rep2 (first (rt block))) (bvadd src_index1 #x0000000000000003)) (bvule (bvadd src_index1 #x0000000000000003) (to_rep2 (last (rt block))))))
(assert (= o47 (bvadd src_index1 #x0000000000000003)))
(assert (= o48 (select (elts block) o47)))
(assert (= o49 (to_rep o48)))
(assert (= o50 ((_ zero_extend 56) o49)))
(assert (= o51 (bvshl o50 ((_ int2bv 64) 24))))
(assert (not (bvule (to_rep2 (first (rt block))) (bvadd src_index1 #x0000000000000002))))
(check-sat)
(exit)
