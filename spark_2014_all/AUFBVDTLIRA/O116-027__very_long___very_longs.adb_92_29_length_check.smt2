...
(assert (not (= (ite (<= (to_rep2 (first4 temp___11571)) (to_rep2 (last4 temp___11571))) (+ (- (to_rep2 (last4 temp___11571)) (to_rep2 (first4 temp___11571))) 1) 0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0))))
(check-sat)
(exit)
