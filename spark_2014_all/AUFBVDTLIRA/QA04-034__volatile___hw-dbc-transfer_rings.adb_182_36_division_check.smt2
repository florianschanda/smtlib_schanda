...
(define-fun dynamic_invariant2 ((temp___expr_589 Int) (temp___is_init_585 Bool) (temp___skip_constant_586 Bool) (temp___do_toplevel_587 Bool) (temp___do_typ_inv_588 Bool)) Bool (=> (or (= temp___is_init_585 true) (<= 0 19)) (in_range2 temp___expr_589)))
...
(define-fun dynamic_invariant3 ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= 2 3)) (in_range3 temp___expr_596)))
...
(define-fun dynamic_invariant4 ((temp___expr_873 (_ BitVec 8)) (temp___is_init_869 Bool) (temp___skip_constant_870 Bool) (temp___do_toplevel_871 Bool) (temp___do_typ_inv_872 Bool)) Bool (=> (or (= temp___is_init_869 true) (bvule #x00 #x3F)) (in_range4 temp___expr_873)))
...
(assert (forall ((ep Int)) (! (=> (dynamic_invariant3 ep true true true true) (dynamic_invariant1 (physical ep) true false true true)) :pattern ((physical ep)))))
...
(assert (= o1 (bvsub pointer o)))
(assert (not (not (= #x0000000000000010 #x0000000000000000))))
(check-sat)
(exit)
