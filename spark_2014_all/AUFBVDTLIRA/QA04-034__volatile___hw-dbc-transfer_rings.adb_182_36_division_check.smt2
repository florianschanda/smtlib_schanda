...
(define-fun in_range2 ((x Int)) Bool (and (<= 0 x) (<= x 19)))
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun user_eq2 (error error) Bool)
(declare-const dummy2 error)
...
(define-fun dynamic_invariant2 ((temp___expr_518 Int) (temp___is_init_515 Bool) (temp___skip_constant_516 Bool) (temp___do_toplevel_517 Bool)) Bool (=> (or (= temp___is_init_515 true) (<= 0 19)) (in_range2 temp___expr_518)))
...
(define-fun dynamic_invariant3 ((temp___expr_524 Int) (temp___is_init_521 Bool) (temp___skip_constant_522 Bool) (temp___do_toplevel_523 Bool)) Bool (=> (or (= temp___is_init_521 true) (<= 2 3)) (in_range3 temp___expr_524)))
...
(define-fun to_int5 ((x word32)) Int (bv2nat (to_rep x)))
...
(define-fun to_int6 ((x word64)) Int (bv2nat (to_rep1 x)))
...
(define-fun dynamic_invariant4 ((temp___expr_772 (_ BitVec 8)) (temp___is_init_769 Bool) (temp___skip_constant_770 Bool) (temp___do_toplevel_771 Bool)) Bool (=> (or (= temp___is_init_769 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 63))) (in_range4 temp___expr_772)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 64)))) (=> (in_range4 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun to_int7 ((x ring_range)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x ring_range)) (! (in_range_int (to_int7 x)) :pattern ((to_int7 x)))))
...
(assert (forall ((ep Int)) (! (=> (dynamic_invariant3 ep true true true) (dynamic_invariant1 (physical ep) true false true)) :pattern ((physical ep)))))
...
(declare-fun concat3 ((Array Int (Array (_ BitVec 8) us_rep)) Int Int (Array Int (Array (_ BitVec 8) us_rep)) Int Int) (Array Int (Array (_ BitVec 8) us_rep)))
...
(declare-fun singleton3 ((Array (_ BitVec 8) us_rep) Int) (Array Int (Array (_ BitVec 8) us_rep)))
(assert (forall ((v (Array (_ BitVec 8) us_rep))) (forall ((i Int)) (! (= (select (singleton3 v i) i) v) :pattern ((select (singleton3 v i) i))))))
...
(assert (forall ((a (Array Int (Array (_ BitVec 8) us_rep))) (b (Array Int (Array (_ BitVec 8) us_rep)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq1 (select a temp___idx_197) ((_ int2bv 8) 0) ((_ int2bv 8) 63) (select b (+ (- b__first a__first) temp___idx_197)) ((_ int2bv 8) 0) ((_ int2bv 8) 63)) true))))))))
...
(assert (=> (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 63)) (in_range4 current)))
(assert (= o5 (physical ep)))
(assert (= o6 (bvsub pointer o5)))
(assert (not (not (= ((_ int2bv 64) 16) #x0000000000000000))))
(check-sat)
(exit)
