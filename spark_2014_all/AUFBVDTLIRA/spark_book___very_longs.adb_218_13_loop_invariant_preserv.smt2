...
(assert (not (= index3 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= index3 result5))
(assert (= index4 (+ index3 1)))
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) index4) (<= index4 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o7 index4))
(assert (= o8 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) o7)))
(assert (= o9 (to_rep1 o8)))
(assert (= o10 (ite (= o9 ((_ int2bv 8) 0)) true false)))
(assert (= result6 (ite (not (= o10 true)) true false)))
(assert (=> (= result6 true) (and (= o11 index4) (in_range1 index4))))
(assert (=> (= result6 true) (= result7 digit_count3)))
(assert (=> (= result6 true) (= digit_count4 o11)))
(assert (=> (not (= result6 true)) (= digit_count4 digit_count3)))
(assert (< 0 digit_count4))
(assert (not (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) digit_count4)) ((_ int2bv 8) 0)))))
(check-sat)
(exit)
