...
(assert (and (= (mk___t2 temp___8069 temp___80691) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8069 temp___80691) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___80691)) (to_rep (last4 temp___80691))) (+ (- (to_rep (last4 temp___80691)) (to_rep (first4 temp___80691))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8069 temp___8070))
(assert (= (mk1 (to_rep (first4 temp___80691)) (to_rep (last4 temp___80691))) temp___80701))
(assert (= (ite (<= (to_rep (first2 temp___80701)) (to_rep (last2 temp___80701))) (+ (- (to_rep (last2 temp___80701)) (to_rep (first2 temp___80701))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
