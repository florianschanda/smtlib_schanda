...
(assert true)
(assert (= (bvadd (bvurem ((_ int2bv 32) 4294967295) n) ((_ int2bv 32) 1)) slop))
(assert true)
(assert (and (= g__split_fields temp___329) (= g__split_fields1 temp___3291)))
(assert (= temp___328 x))
(assert true)
(assert true)
(assert (or (= slop n) (bvule x3 (bvsub ((_ int2bv 32) 4294967295) slop))))
(assert (= x3 x4))
(assert (= g__split_fields6 g__split_fields4))
(assert (= g__split_fields7 g__split_fields5))
(assert (= x5 x3))
(assert (= (mk___split_fields g__split_fields8 g__split_fields9) (mk___split_fields g__split_fields4 g__split_fields5)))
(assert (= (mk_t__ref x6) (mk_t__ref x4)))
(assert (= (mk___split_fields__ref (mk___split_fields g__split_fields10 g__split_fields11)) (mk___split_fields__ref (mk___split_fields g__split_fields6 g__split_fields7))))
(assert (= x7 x5))
(assert (= g__split_fields12 (mk___split_fields g__split_fields8 g__split_fields9)))
(assert (not (not (= n #x00000000))))
(check-sat)
(exit)
