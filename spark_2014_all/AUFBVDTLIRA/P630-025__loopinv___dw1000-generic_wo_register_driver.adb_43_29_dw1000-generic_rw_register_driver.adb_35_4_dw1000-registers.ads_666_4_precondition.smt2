...
(define-fun register_byte_array__ref___167__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_8212 us_t1) (temp___is_init_8208 Bool) (temp___skip_constant_8209 Bool) (temp___do_toplevel_8210 Bool) (temp___do_typ_inv_8211 Bool)) Bool (=> (not (= temp___skip_constant_8209 true)) (and (dynamic_property2 1 4 (first3 temp___expr_8212) (last3 temp___expr_8212)) (and (= (first3 temp___expr_8212) 1) (= (last3 temp___expr_8212) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___67__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_8242 us_t2) (temp___is_init_8238 Bool) (temp___skip_constant_8239 Bool) (temp___do_toplevel_8240 Bool) (temp___do_typ_inv_8241 Bool)) Bool (=> (not (= temp___skip_constant_8239 true)) (and (dynamic_property3 1 4 (first5 temp___expr_8242) (last5 temp___expr_8242)) (and (= (first5 temp___expr_8242) 1) (= (last5 temp___expr_8242) 4)))))
...
(declare-const temp___89991 t2)
(declare-const temp___9000 (Array Int bits_8))
(declare-const temp___90001 t1)
...
(define-fun temp___89992 () us_t2 (mk___t2 temp___8999 temp___89991))
...
(assert (and (= temp___89992 (register_to_bytes reg)) (dynamic_invariant1 temp___89992 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___89991)) (to_rep (last4 temp___89991))) (+ (- (to_rep (last4 temp___89991)) (to_rep (first4 temp___89991))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8999 temp___9000))
(assert (= (mk1 (to_rep (first4 temp___89991)) (to_rep (last4 temp___89991))) temp___90001))
(assert (= (ite (<= (to_rep (first2 temp___90001)) (to_rep (last2 temp___90001))) (+ (- (to_rep (last2 temp___90001)) (to_rep (first2 temp___90001))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___9000 temp___90001)))
(assert (= o2 o))
