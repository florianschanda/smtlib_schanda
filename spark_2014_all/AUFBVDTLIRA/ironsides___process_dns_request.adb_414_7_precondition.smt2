...
(assert (and (= o50 (- dstbytes8 6)) (in_range10 (- dstbytes8 6))))
(assert (= o51 (from_bytes_range o50)))
(assert (= o52 (bvurem o51 #x00010000)))
(assert (= o53 o52))
(assert (= o54 ((_ extract 15 0) o53)))
(assert (and (= o49 (+ start_byte 4)) (in_range3 (+ start_byte 4))))
(assert (not (<= o49 8179)))
(check-sat)
(exit)
