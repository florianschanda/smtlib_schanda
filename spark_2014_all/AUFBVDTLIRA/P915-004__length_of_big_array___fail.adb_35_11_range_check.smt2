...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_647 us_void_param) 1)) 122) (= (to_rep (select (temp___String_Literal_647 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_647 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_647 us_void_param) 4)) 111)) :pattern ((temp___String_Literal_647 us_void_param)))))
(declare-fun temp___String_Literal_648 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_648 us_void_param) 1)) 109) (= (to_rep (select (temp___String_Literal_648 us_void_param) 2)) 97)) (= (to_rep (select (temp___String_Literal_648 us_void_param) 3)) 120)) :pattern ((temp___String_Literal_648 us_void_param)))))
