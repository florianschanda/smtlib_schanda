...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (= (to_rep (select (temp___String_Literal_641 us_void_param) 1)) 122) (= (to_rep (select (temp___String_Literal_641 us_void_param) 2)) 101)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 3)) 114)) (= (to_rep (select (temp___String_Literal_641 us_void_param) 4)) 111)) :pattern ((temp___String_Literal_641 us_void_param)))))
(declare-fun temp___String_Literal_642 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_642 us_void_param) 1)) 109) (= (to_rep (select (temp___String_Literal_642 us_void_param) 2)) 97)) (= (to_rep (select (temp___String_Literal_642 us_void_param) 3)) 120)) :pattern ((temp___String_Literal_642 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_27 Int) (temp___is_init_24 Bool) (temp___skip_constant_25 Bool) (temp___do_toplevel_26 Bool)) Bool (=> (or (= temp___is_init_24 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range4 temp___expr_27)))
(define-fun dynamic_invariant6 ((temp___expr_286 (_ BitVec 64)) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool)) Bool true)
(assert (forall ((last4 (_ BitVec 64))) (! (=> (dynamic_invariant6 last4 true true true) (let ((result (create last4))) (and (and (= (last3 result) last4) (= (first3 result) ((_ int2bv 64) 0))) (dynamic_invariant result true false true)))) :pattern ((create last4)))))
