...
(define-fun dynamic_invariant ((temp___expr_4584 us_t1) (temp___is_init_4581 Bool) (temp___skip_constant_4582 Bool) (temp___do_toplevel_4583 Bool)) Bool (=> (not (= temp___skip_constant_4582 true)) (and (dynamic_property2 1 4 (first3 temp___expr_4584) (last3 temp___expr_4584)) (and (= (first3 temp___expr_4584) 1) (= (last3 temp___expr_4584) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_4609 us_t2) (temp___is_init_4606 Bool) (temp___skip_constant_4607 Bool) (temp___do_toplevel_4608 Bool)) Bool (=> (not (= temp___skip_constant_4607 true)) (and (dynamic_property3 1 4 (first5 temp___expr_4609) (last5 temp___expr_4609)) (and (= (first5 temp___expr_4609) 1) (= (last5 temp___expr_4609) 4)))))
...
(declare-const temp___7919 (Array Int bits_8))
(declare-const temp___79191 t2)
(declare-const temp___7920 (Array Int bits_8))
(declare-const temp___79201 t1)
(define-fun temp___79192 () us_t2 (mk___t2 temp___7919 temp___79191))
...
(assert (and (= temp___79192 (register_to_bytes reg)) (dynamic_invariant1 temp___79192 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___79191)) (to_rep (last4 temp___79191))) (+ (- (to_rep (last4 temp___79191)) (to_rep (first4 temp___79191))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7919 temp___7920))
(assert (= (mk1 (to_rep (first4 temp___79191)) (to_rep (last4 temp___79191))) temp___79201))
(assert (not (= (ite (<= (to_rep (first2 temp___79201)) (to_rep (last2 temp___79201))) (+ (- (to_rep (last2 temp___79201)) (to_rep (first2 temp___79201))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
