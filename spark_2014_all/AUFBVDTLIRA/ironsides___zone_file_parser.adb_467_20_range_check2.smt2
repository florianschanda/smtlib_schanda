...
(assert (=> (= success20 true) (and (and (and (and (<= begidx4 endidx2) (<= begidx4 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i33 Int)) (=> (and (<= begidx4 i33) (<= i33 endidx2)) (and (<= 48 (to_rep (select zonefileline i33))) (<= (to_rep (select zonefileline i33)) 57)))))) (and (and (in_range4 begidx4) (in_range4 endidx2)) (in_range3 foundtype2)))))
...
(assert (= begidx7 o48))
(assert (and (and (and (and (<= begidx8 endidx5) (<= begidx8 zlength)) (<= endidx5 zlength)) (=> (= foundtype5 1) (forall ((i33 Int)) (=> (and (<= begidx8 i33) (<= i33 endidx5)) (and (<= 48 (to_rep (select zonefileline i33))) (<= (to_rep (select zonefileline i33)) 57)))))) (and (and (in_range4 begidx8) (in_range4 endidx5)) (in_range3 foundtype5))))
...
(assert (=> (and (<= r13b i25) (<= i25 r14b)) (and (= temp___1551 o51) (in_range1 o51))))
(assert (=> (and (<= r13b i25) (<= i25 r14b)) (and (<= 1 temp___1551) (<= temp___1551 128))))
(assert (=> (and (<= r13b i25) (<= i25 r14b)) (= o53 temp___1551)))
...
(assert (=> (and (<= r13b i25) (<= i25 r14b)) (= temp___1553 (mk___rep1 o55 rrsig_rec__attr__tag))))
(assert (=> (and (<= r13b i25) (<= i25 r14b)) (= result18 (mk___split_fields__ref1 rrsig_rec__split_fields27))))
(assert (=> (and (<= r13b i25) (<= i25 r14b)) (= rrsig_rec__split_fields28 (us_split_fields3 temp___1553))))
