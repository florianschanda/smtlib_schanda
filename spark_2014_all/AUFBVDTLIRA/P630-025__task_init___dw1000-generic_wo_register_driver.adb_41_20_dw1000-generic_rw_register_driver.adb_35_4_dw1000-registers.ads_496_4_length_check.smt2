...
(define-fun register_byte_array__ref___115__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6543 us_t1) (temp___is_init_6539 Bool) (temp___skip_constant_6540 Bool) (temp___do_toplevel_6541 Bool) (temp___do_typ_inv_6542 Bool)) Bool (=> (not (= temp___skip_constant_6540 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6543) (last3 temp___expr_6543)) (and (= (first3 temp___expr_6543) 1) (= (last3 temp___expr_6543) 1)))))
(declare-sort t2 0)
...
(define-fun target__ref___49__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_6566 us_t2) (temp___is_init_6562 Bool) (temp___skip_constant_6563 Bool) (temp___do_toplevel_6564 Bool) (temp___do_typ_inv_6565 Bool)) Bool (=> (not (= temp___skip_constant_6563 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6566) (last5 temp___expr_6566)) (and (= (first5 temp___expr_6566) 1) (= (last5 temp___expr_6566) 1)))))
...
(declare-const temp___88411 t2)
(define-fun temp___88412 () us_t2 (mk___t2 temp___8841 temp___88411))
...
(assert (and (= temp___88412 (register_to_bytes reg)) (dynamic_invariant1 temp___88412 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___88411)) (to_rep (last4 temp___88411))) (+ (- (to_rep (last4 temp___88411)) (to_rep (first4 temp___88411))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
