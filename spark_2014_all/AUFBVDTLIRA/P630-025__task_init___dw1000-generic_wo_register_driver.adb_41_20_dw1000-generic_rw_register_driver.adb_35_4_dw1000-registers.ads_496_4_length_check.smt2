...
(define-fun dynamic_invariant ((temp___expr_5952 us_t1) (temp___is_init_5949 Bool) (temp___skip_constant_5950 Bool) (temp___do_toplevel_5951 Bool)) Bool (=> (not (= temp___skip_constant_5950 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5952) (last3 temp___expr_5952)) (and (= (first3 temp___expr_5952) 1) (= (last3 temp___expr_5952) 1)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_5973 us_t2) (temp___is_init_5970 Bool) (temp___skip_constant_5971 Bool) (temp___do_toplevel_5972 Bool)) Bool (=> (not (= temp___skip_constant_5971 true)) (and (dynamic_property3 1 1 (first5 temp___expr_5973) (last5 temp___expr_5973)) (and (= (first5 temp___expr_5973) 1) (= (last5 temp___expr_5973) 1)))))
...
(assert (and (= temp___80692 (register_to_bytes reg)) (dynamic_invariant1 temp___80692 true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___80691)) (to_rep (last4 temp___80691))) (+ (- (to_rep (last4 temp___80691)) (to_rep (first4 temp___80691))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
