...
(assert (= keystore__addkey__B153b__thestring__assume (mk___t (concat1 (temp___String_Literal_1197 Tuple0) 1 33 (elts (to_string (attr__ATTRIBUTE_IMAGE12 c149b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b)))))) (mk 1 o15))))
