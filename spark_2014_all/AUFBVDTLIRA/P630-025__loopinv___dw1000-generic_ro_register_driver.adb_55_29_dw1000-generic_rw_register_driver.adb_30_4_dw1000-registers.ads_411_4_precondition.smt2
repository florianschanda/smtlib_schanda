...
(define-fun dynamic_invariant ((temp___expr_5037 us_t1) (temp___is_init_5034 Bool) (temp___skip_constant_5035 Bool) (temp___do_toplevel_5036 Bool)) Bool (=> (not (= temp___skip_constant_5035 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5037) (last3 temp___expr_5037)) (and (= (first3 temp___expr_5037) 1) (= (last3 temp___expr_5037) 2)))))
