...
(assert (and (= o10 (shift_right__2 o9 (- 8 distance))) (= o10 (bvudiv o9 (ite (< (- 8 distance) 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (- 8 distance))) ((_ int2bv 8) 0))))))
...
(assert (=> (< distance 8) (= o12 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) o11))))
(assert (=> (< distance 8) (= o13 (to_rep1 o12))))
...
(assert (= o16 i2))
(assert (= o17 (store (elts (rec__very_longs__very_long__long_digits result____split_fields3)) o16 o15)))
(assert (= o18 (mk___t o17 (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))
(assert (= o19 (mk___split_fields o18)))
(assert (= temp___1234 (mk___rep result____split_discrs o19)))
(assert (= result5 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1234)))
(assert (= result____split_discrs (us_split_discrs1 temp___1234)))
