...
(define-fun us_rep___138__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
...
(define-fun us_rep___139__projection ((a us_rep2)) us_split_fields4 (us_split_fields5 a))
...
(assert (forall ((temp___4477 us_rep1)) (forall ((temp___4478 (_ BitVec 8))) (= (select (temp___4475 temp___4477) temp___4478) temp___4477))))
(declare-fun temp___4479 ((_ BitVec 8)) (Array Int bits_8))
(assert (forall ((temp___4481 (_ BitVec 8))) (forall ((temp___4482 Int)) (= (select (temp___4479 temp___4481) temp___4482) (of_rep4 temp___4481)))))
(define-fun dynamic_invariant ((temp___expr_4469 us_rep2) (temp___is_init_4466 Bool) (temp___skip_constant_4467 Bool) (temp___do_toplevel_4468 Bool)) Bool (forall ((temp___4470 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) temp___4470) (bvule temp___4470 ((_ int2bv 8) 1))) (let ((temp___4471 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields5 temp___expr_4469)) temp___4470))) (ite (= (to_rep3 (rec__decadriver__rx_frame_type__error (us_split_fields3 temp___4471))) 0) (< 0 (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4471)))) (= (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4471))) 0))))))
(define-fun default_initial_assumption ((temp___expr_4473 us_rep2) (temp___skip_top_level_4474 Bool)) Bool (and (and (and (and (= (rec__decadriver__receiver_type__frame_queue (us_split_fields5 temp___expr_4473)) (temp___4475 (mk___rep1 (mk___split_fields1 (of_rep2 0) (temp___4479 ((_ int2bv 8) 0)) (of_rep3 0) (of_int 0))))) (= (to_rep6 (rec__decadriver__receiver_type__queue_head (us_split_fields5 temp___expr_4473))) ((_ int2bv 8) 1))) (= (to_rep5 (rec__decadriver__receiver_type__rx_count (us_split_fields5 temp___expr_4473))) 0)) (= (rec__decadriver__receiver_type__overrun_occurred (us_split_fields5 temp___expr_4473)) (of_int 0))) (= (rec__decadriver__receiver_type__frame_ready (us_split_fields5 temp___expr_4473)) (of_int 0))))
...
(define-fun us_rep___140__projection ((a us_rep3)) us_split_fields6 (us_split_fields7 a))
...
(define-fun default_initial_assumption1 ((temp___expr_4490 us_rep3) (temp___skip_top_level_4491 Bool)) Bool (= (rec__decadriver__transmitter_type__tx_idle (us_split_fields7 temp___expr_4490)) (of_int 1)))
...
(define-fun us_rep___141__projection ((a us_rep5)) us_split_fields10 (us_split_fields11 a))
...
(assert (forall ((temp___4502 (_ BitVec 32))) (forall ((temp___4503 Int)) (= (select (temp___4500 temp___4502) temp___4503) (of_rep9 temp___4502)))))
(define-fun default_initial_assumption2 ((temp___expr_4498 us_rep5) (temp___skip_top_level_4499 Bool)) Bool (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep9 (rec__decadriver__driver_type__part_id (us_split_fields11 temp___expr_4498))) ((_ int2bv 32) 0)) (= (to_rep9 (rec__decadriver__driver_type__lot_id (us_split_fields11 temp___expr_4498))) ((_ int2bv 32) 0))) (= (to_rep10 (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields11 temp___expr_4498))) ((_ int2bv 16) 0))) (= (to_rep10 (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields11 temp___expr_4498))) ((_ int2bv 16) 0))) (= (to_rep1 (rec__decadriver__driver_type__xtal_trim (us_split_fields11 temp___expr_4498))) ((_ int2bv 8) 16))) (= (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields11 temp___expr_4498)) (temp___4500 ((_ int2bv 32) 0)))) (= (rec__decadriver__driver_type__long_frames (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields11 temp___expr_4498)) (mk___rep4 (mk___split_fields4 (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep7 ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep8 ((_ int2bv 8) 0)) (of_rep1 ((_ int2bv 8) 0)))))) (= (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_phr_error (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_rs_error (us_split_fields11 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_fcs_error (us_split_fields11 temp___expr_4498)) (of_int 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_4407 Int) (temp___is_init_4404 Bool) (temp___skip_constant_4405 Bool) (temp___do_toplevel_4406 Bool)) Bool (=> (or (= temp___is_init_4404 true) (<= 0 1024)) (in_range6 temp___expr_4407)))
(define-fun dynamic_invariant3 ((temp___expr_4413 Int) (temp___is_init_4410 Bool) (temp___skip_constant_4411 Bool) (temp___do_toplevel_4412 Bool)) Bool (=> (or (= temp___is_init_4410 true) (<= 0 5)) (in_range7 temp___expr_4413)))
(define-fun dynamic_invariant4 ((temp___expr_4419 us_rep1) (temp___is_init_4416 Bool) (temp___skip_constant_4417 Bool) (temp___do_toplevel_4418 Bool)) Bool (=> (= temp___do_toplevel_4418 true) (=> (= temp___is_init_4416 true) (ite (= (to_rep3 (rec__decadriver__rx_frame_type__error (us_split_fields3 temp___expr_4419))) 0) (< 0 (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___expr_4419)))) (= (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___expr_4419))) 0)))))
(define-fun dynamic_predicate ((temp___4430 us_rep1)) Bool (ite (= (to_rep3 (rec__decadriver__rx_frame_type__error (us_split_fields3 temp___4430))) 0) (< 0 (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4430)))) (= (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4430))) 0)))
(define-fun dynamic_invariant5 ((temp___expr_4437 (_ BitVec 8)) (temp___is_init_4434 Bool) (temp___skip_constant_4435 Bool) (temp___do_toplevel_4436 Bool)) Bool (=> (or (= temp___is_init_4434 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range5 temp___expr_4437)))
...
(declare-const temp___4605 us_rep)
...
(declare-const temp___4607 us_rep)
...
(declare-const temp___4609 us_rep)
...
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) ((_ int2bv 8) 1)) (= temp___4605 (mk___rep o43))))
...
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) ((_ int2bv 8) 1)) (= (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields2) (us_split_fields1 temp___4605))))
...
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxsfdto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) ((_ int2bv 8) 1)) (= temp___4607 (mk___rep o50))))
...
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxsfdto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) ((_ int2bv 8) 1)) (= (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields3) (us_split_fields1 temp___4607))))
...
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfsl (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) ((_ int2bv 8) 1)) (= temp___4609 (mk___rep o57))))
...
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfsl (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) ((_ int2bv 8) 1)) (= (let ((subject sys_status_clear__split_fields)) sys_status_clear__split_fields4) (us_split_fields1 temp___4609))))
