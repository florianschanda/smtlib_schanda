...
(define-fun target__ref___68__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__pmsc_snozt_type__snoz_tim (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__pmsc_snozt_type__snoz_tim (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_8306 us_t1) (temp___is_init_8302 Bool) (temp___skip_constant_8303 Bool) (temp___do_toplevel_8304 Bool) (temp___do_typ_inv_8305 Bool)) Bool (=> (not (= temp___skip_constant_8303 true)) (and (dynamic_property2 1 1 (first3 temp___expr_8306) (last3 temp___expr_8306)) (and (= (first3 temp___expr_8306) 1) (= (last3 temp___expr_8306) 1)))))
...
(define-fun register_byte_array__ref___169__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_8288 us_t2) (temp___is_init_8284 Bool) (temp___skip_constant_8285 Bool) (temp___do_toplevel_8286 Bool) (temp___do_typ_inv_8287 Bool)) Bool (=> (not (= temp___skip_constant_8285 true)) (and (dynamic_property3 1 1 (first5 temp___expr_8288) (last5 temp___expr_8288)) (and (= (first5 temp___expr_8288) 1) (= (last5 temp___expr_8288) 1)))))
...
(declare-const temp___90061 t1)
(define-fun temp___90062 () us_t1 (mk___t1 temp___9006 temp___90061))
...
(assert (and (= temp___90062 (register_to_bytes reg)) (dynamic_invariant temp___90062 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___90061)) (to_rep (last2 temp___90061))) (+ (- (to_rep (last2 temp___90061)) (to_rep (first2 temp___90061))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
