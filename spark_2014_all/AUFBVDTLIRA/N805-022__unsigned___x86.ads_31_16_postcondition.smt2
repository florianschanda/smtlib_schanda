...
(assert (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) #x01000000)) val__))
(assert (= xcx4 xcx5))
(assert (= xcx6 xcx4))
(declare-const i Int)
(assert (<= 4 i))
(assert (<= i 7))
(assert (not (= (to_rep (select xcx5 i)) (to_rep (select xcx i)))))
(check-sat)
(exit)
