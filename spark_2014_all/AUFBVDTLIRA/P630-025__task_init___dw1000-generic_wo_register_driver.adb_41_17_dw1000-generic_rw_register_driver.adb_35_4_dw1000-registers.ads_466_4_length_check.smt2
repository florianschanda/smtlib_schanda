...
(define-fun dynamic_invariant ((temp___expr_5547 us_t1) (temp___is_init_5544 Bool) (temp___skip_constant_5545 Bool) (temp___do_toplevel_5546 Bool)) Bool (=> (not (= temp___skip_constant_5545 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5547) (last3 temp___expr_5547)) (and (= (first3 temp___expr_5547) 1) (= (last3 temp___expr_5547) 1)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_5563 us_t2) (temp___is_init_5560 Bool) (temp___skip_constant_5561 Bool) (temp___do_toplevel_5562 Bool)) Bool (=> (not (= temp___skip_constant_5561 true)) (and (dynamic_property3 1 1 (first5 temp___expr_5563) (last5 temp___expr_5563)) (and (= (first5 temp___expr_5563) 1) (= (last5 temp___expr_5563) 1)))))
...
(declare-const temp___8028 (Array Int bits_8))
(declare-const temp___80281 t1)
...
(assert (and (= (mk___t2 temp___8027 temp___80271) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8027 temp___80271) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___80271)) (to_rep (last4 temp___80271))) (+ (- (to_rep (last4 temp___80271)) (to_rep (first4 temp___80271))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8027 temp___8028))
(assert (= (mk1 (to_rep (first4 temp___80271)) (to_rep (last4 temp___80271))) temp___80281))
(assert (not (= (ite (<= (to_rep (first2 temp___80281)) (to_rep (last2 temp___80281))) (+ (- (to_rep (last2 temp___80281)) (to_rep (first2 temp___80281))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
