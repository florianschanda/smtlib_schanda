...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__tc_pgdelay_type__tc_pgdelay bits_8)))))
(define-fun us_split_fields_TC_PGDELAY__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__tc_pgdelay_type__tc_pgdelay a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___62__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___62__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__tc_pgdelay_type__tc_pgdelay (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tc_pgdelay_type__tc_pgdelay (us_split_fields1 b)))) true false))
...
(assert (<= 0 dw1000__register_types__tc_pgdelay_type__tc_pgdelay__first__bit))
(assert (< dw1000__register_types__tc_pgdelay_type__tc_pgdelay__first__bit dw1000__register_types__tc_pgdelay_type__tc_pgdelay__last__bit))
(assert (<= 0 dw1000__register_types__tc_pgdelay_type__tc_pgdelay__position))
(declare-fun user_eq4 (us_rep us_rep) Bool)
(declare-const dummy4 us_rep)
(declare-datatypes () ((tc_pgdelay_type__ref (mk_tc_pgdelay_type__ref (tc_pgdelay_type__content us_rep)))))
(define-fun tc_pgdelay_type__ref___projection ((a tc_pgdelay_type__ref)) us_rep (tc_pgdelay_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___145__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___103__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___103__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6096 us_t1) (temp___is_init_6092 Bool) (temp___skip_constant_6093 Bool) (temp___do_toplevel_6094 Bool) (temp___do_typ_inv_6095 Bool)) Bool (=> (not (= temp___skip_constant_6093 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6096) (last3 temp___expr_6096)) (and (= (first3 temp___expr_6096) 1) (= (last3 temp___expr_6096) 1)))))
(declare-sort t2 0)
...
(define-fun target__ref___43__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___43__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_6114 us_t2) (temp___is_init_6110 Bool) (temp___skip_constant_6111 Bool) (temp___do_toplevel_6112 Bool) (temp___do_typ_inv_6113 Bool)) Bool (=> (not (= temp___skip_constant_6111 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6114) (last5 temp___expr_6114)) (and (= (first5 temp___expr_6114) 1) (= (last5 temp___expr_6114) 1)))))
...
(declare-const temp___8799 (Array Int bits_8))
(declare-const temp___87991 t2)
(declare-const temp___8800 (Array Int bits_8))
(declare-const temp___88001 t1)
(define-fun temp___87992 () us_t2 (mk___t2 temp___8799 temp___87991))
...
(assert (and (= temp___87992 (register_to_bytes reg)) (dynamic_invariant1 temp___87992 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___87991)) (to_rep (last4 temp___87991))) (+ (- (to_rep (last4 temp___87991)) (to_rep (first4 temp___87991))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8799 temp___8800))
(assert (= (mk1 (to_rep (first4 temp___87991)) (to_rep (last4 temp___87991))) temp___88001))
(assert (not (= (ite (<= (to_rep (first2 temp___88001)) (to_rep (last2 temp___88001))) (+ (- (to_rep (last2 temp___88001)) (to_rep (first2 temp___88001))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
