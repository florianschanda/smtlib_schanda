...
(assert (forall ((last2 (_ BitVec 64))) (! (=> (dynamic_invariant last2 true true true true) (let ((result (create last2))) (and (and (= (last1 result) last2) (= (first1 result) #x0000000000000000)) (dynamic_invariant1 result true false true true)))) :pattern ((create last2)))))
...
(assert (and (= fail__c__assume2 (create #xFFFFFFFFFFFFFFFF)) (and (dynamic_invariant1 fail__c__assume2 true false true true) (and (= (to_rep (last fail__c__assume1)) #xFFFFFFFFFFFFFFFF) (= (to_rep (first fail__c__assume1)) #x0000000000000000)))))
