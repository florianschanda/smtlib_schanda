...
(assert (= (ite (<= (to_rep1 (first2 temp___3101)) (to_rep1 (last2 temp___3101))) (+ (- (to_rep1 (last2 temp___3101)) (to_rep1 (first2 temp___3101))) 1) 0) (ite (<= (to_rep1 data__first) (to_rep1 data__last)) (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1) 0)))
(assert (= (mk___t1 temp___311 temp___3111) (mk___t1 temp___310 temp___3101)))
(assert (= o (slide1 temp___311 (to_rep1 (first2 temp___3111)) (to_rep1 data__first))))
(assert (= result data))
(assert (= data1 o))
...
(assert (and (= o8 (+ (to_rep1 (first (rt text))) i2)) (in_range1 (+ (to_rep1 (first (rt text))) i2))))
(assert (= o9 (- o8 1)))
