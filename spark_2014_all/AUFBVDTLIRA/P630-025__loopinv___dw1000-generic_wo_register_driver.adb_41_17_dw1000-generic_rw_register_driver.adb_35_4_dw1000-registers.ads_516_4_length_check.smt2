...
(assert (= (ite (<= (to_rep (first4 temp___88691)) (to_rep (last4 temp___88691))) (+ (- (to_rep (last4 temp___88691)) (to_rep (first4 temp___88691))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8869 temp___8870))
(assert (= (mk1 (to_rep (first4 temp___88691)) (to_rep (last4 temp___88691))) temp___88701))
(assert (not (= (ite (<= (to_rep (first2 temp___88701)) (to_rep (last2 temp___88701))) (+ (- (to_rep (last2 temp___88701)) (to_rep (first2 temp___88701))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
