...
(assert (and (= temp___81342 (register_to_bytes reg)) (dynamic_invariant1 temp___81342 true false true)))
...
(assert (= (ite (<= (to_rep (first2 temp___81351)) (to_rep (last2 temp___81351))) (+ (- (to_rep (last2 temp___81351)) (to_rep (first2 temp___81351))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
