...
(assert (forall ((k3 Int)) (=> (and (<= (to_rep b__first) k3) (<= k3 (to_rep b__last))) (and (=> (and (<= b_first k3) (<= k3 (- (- (+ b_first (+ i2 1)) a_first) 1))) (= (to_rep1 (select b3 k3)) (to_rep1 (select (elts a) (- (+ a_first k3) b_first))))) (=> (=> (<= b_first k3) (not (<= k3 (- (- (+ b_first (+ i2 1)) a_first) 1)))) (= (to_rep1 (select b3 k3)) (to_rep1 (select b k3))))))))
...
(assert (<= b_first k3))
(assert (<= k3 (- (- (+ b_first i3) a_first) 1)))
