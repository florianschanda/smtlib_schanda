...
(assert (= o6 (concat1 (temp___String_Literal_513 Tuple0) 1 7 (elts (to_string (attr__ATTRIBUTE_IMAGE off_c1))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE off_c1))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE off_c1))))))))
(assert (= o7 (mk 1 o5)))
