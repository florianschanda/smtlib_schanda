...
(assert (= result2 true))
(assert (and (= temp___722 (+ (to_rep (first (rt buffer))) 15)) (in_range1 (+ (to_rep (first (rt buffer))) 15))))
(assert (and (= temp___721 (+ (to_rep (first (rt buffer))) 12)) (in_range1 (+ (to_rep (first (rt buffer))) 12))))
(assert (<= temp___721 temp___722))
(assert (not (<= (to_rep (first (rt buffer))) temp___721)))
(check-sat)
(exit)
