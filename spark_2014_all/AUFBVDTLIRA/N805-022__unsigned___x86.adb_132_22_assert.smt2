...
(assert (not (= (bvadd ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000002)))) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr #x0000000000000003)))) #x00000100)) (bvurem (bvudiv val__ #x00010000) #x00010000))))
(check-sat)
(exit)
