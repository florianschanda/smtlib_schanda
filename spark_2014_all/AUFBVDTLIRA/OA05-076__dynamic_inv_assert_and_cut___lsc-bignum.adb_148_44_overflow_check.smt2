...
(assert (and (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (forall ((temp___653 Int)) (=> (and (<= (to_rep a__first) temp___653) (<= temp___653 (to_rep a__last))) (=> (<= i2 temp___653) (= (select a1 temp___653) (select a temp___653)))))) (=> (<= 0 2147483647) (in_range2 j1))) (and (<= a_first i2) (<= i2 a_last))))
