...
(assert (= o45 (ite (<= o44 k) true false)))
(assert (= result7 (ite (= o45 true) (ite (<= k a_last) true false) false)))
(assert (= (= o46 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 a_last)) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
(assert (= o41 (num_of_boolean carry3)))
...
(assert (= o34 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o33)))
(assert (= o43 (osubtract o34 o42)))
