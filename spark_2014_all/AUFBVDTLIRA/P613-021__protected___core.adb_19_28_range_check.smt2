...
(assert (= (rec__core__message_record__value (us_split_fields1 (select (rec__core__mailboxT__messages (us_split_fields3 self__4)) (to_rep2 (rec__core__mailboxT__next_in (us_split_fields3 self__4)))))) o15))
(assert (= o14 o16))
(assert (= o17 o15))
(assert (= o18 o16))
(assert (= o19 (store (rec__core__mailboxT__messages (us_split_fields3 self__4)) (to_rep2 (rec__core__mailboxT__next_in (us_split_fields3 self__4))) (mk___rep (mk___split_fields o17 o18)))))
(assert (= o19 o20))
(assert (= (rec__core__mailboxT__next_in (us_split_fields3 self__4)) o21))
(assert (= (rec__core__mailboxT__next_out (us_split_fields3 self__4)) o22))
...
(assert (= (to_rep2 o28) (bvurem (bvadd (to_rep2 (rec__core__mailboxT__next_in (us_split_fields3 self__5))) ((_ int2bv 8) 1)) ((_ int2bv 8) 16))))
(assert (= (rec__core__mailboxT__messages (us_split_fields3 self__5)) o29))
(assert (= o28 o30))
(assert (= (rec__core__mailboxT__next_out (us_split_fields3 self__5)) o31))
...
(assert (not (in_range3 (+ (to_rep3 (rec__core__mailboxT__count (us_split_fields3 self__6))) 1))))
(check-sat)
(exit)
