...
(assert (= (to_rep o) n))
(assert (= o o1))
(assert (= (rec__core__message_record__size (us_split_fields1 (select self__ (to_rep2 self__1)))) o2))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= o5 (store self__ (to_rep2 self__1) (mk___rep (mk___split_fields o3 o4)))))
(assert (= o5 o6))
(assert (= self__1 o7))
(assert (= self__2 o8))
(assert (= self__3 o9))
...
(assert (= o12 o8))
(assert (= o13 o9))
(assert (= result (mk_mailboxT__ref (mk___rep1 (mk___split_fields1 self__ self__1 self__2 self__3)))))
(assert (= self__5 (mk___rep1 (mk___split_fields1 o10 o11 o12 o13))))
(assert (= (to_rep1 o14) 0))
(assert (= (rec__core__message_record__value (us_split_fields1 (select (rec__core__mailboxT__messages (us_split_fields3 self__5)) (to_rep2 (rec__core__mailboxT__next_in (us_split_fields3 self__5)))))) o15))
(assert (= o14 o16))
(assert (= o17 o15))
(assert (= o18 o16))
(assert (= o19 (store (rec__core__mailboxT__messages (us_split_fields3 self__5)) (to_rep2 (rec__core__mailboxT__next_in (us_split_fields3 self__5))) (mk___rep (mk___split_fields o17 o18)))))
(assert (= o19 o20))
(assert (= (rec__core__mailboxT__next_in (us_split_fields3 self__5)) o21))
(assert (= (rec__core__mailboxT__next_out (us_split_fields3 self__5)) o22))
(assert (= (rec__core__mailboxT__count (us_split_fields3 self__5)) o23))
(assert (= o24 o20))
(assert (= o25 o21))
(assert (= o26 o22))
(assert (= o27 o23))
(assert (= result1 (mk_mailboxT__ref self__5)))
(assert (= self__6 (mk___rep1 (mk___split_fields1 o24 o25 o26 o27))))
(assert (= (to_rep2 o28) (bvurem (bvadd (to_rep2 (rec__core__mailboxT__next_in (us_split_fields3 self__6))) ((_ int2bv 8) 1)) ((_ int2bv 8) 16))))
(assert (= (rec__core__mailboxT__messages (us_split_fields3 self__6)) o29))
(assert (= o28 o30))
(assert (= (rec__core__mailboxT__next_out (us_split_fields3 self__6)) o31))
(assert (= (rec__core__mailboxT__count (us_split_fields3 self__6)) o32))
(assert (= o33 o29))
(assert (= o34 o30))
(assert (= o35 o31))
(assert (= o36 o32))
(assert (= result2 (mk_mailboxT__ref self__6)))
(assert (= self__7 (mk___rep1 (mk___split_fields1 o33 o34 o35 o36))))
(assert (not (in_range3 (+ (to_rep3 (rec__core__mailboxT__count (us_split_fields3 self__7))) 1))))
(check-sat)
(exit)
