...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__fs_pllcfg_type__fs_pllcfg bits_32)))))
(define-fun us_split_fields_FS_PLLCFG__projection ((a us_split_fields)) bits_32 (rec__dw1000__register_types__fs_pllcfg_type__fs_pllcfg a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___64__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___64__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__fs_pllcfg_type__fs_pllcfg (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__fs_pllcfg_type__fs_pllcfg (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__fs_pllcfg_type__fs_pllcfg__first__bit Int)
(declare-const dw1000__register_types__fs_pllcfg_type__fs_pllcfg__last__bit Int)
(declare-const dw1000__register_types__fs_pllcfg_type__fs_pllcfg__position Int)
(assert (<= 0 dw1000__register_types__fs_pllcfg_type__fs_pllcfg__first__bit))
(assert (< dw1000__register_types__fs_pllcfg_type__fs_pllcfg__first__bit dw1000__register_types__fs_pllcfg_type__fs_pllcfg__last__bit))
(assert (<= 0 dw1000__register_types__fs_pllcfg_type__fs_pllcfg__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((fs_pllcfg_type__ref (mk_fs_pllcfg_type__ref (fs_pllcfg_type__content us_rep)))))
(define-fun fs_pllcfg_type__ref___projection ((a fs_pllcfg_type__ref)) us_rep (fs_pllcfg_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___150__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___106__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___106__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_6206 us_t1) (temp___is_init_6202 Bool) (temp___skip_constant_6203 Bool) (temp___do_toplevel_6204 Bool) (temp___do_typ_inv_6205 Bool)) Bool (=> (not (= temp___skip_constant_6203 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6206) (last3 temp___expr_6206)) (and (= (first3 temp___expr_6206) 1) (= (last3 temp___expr_6206) 4)))))
