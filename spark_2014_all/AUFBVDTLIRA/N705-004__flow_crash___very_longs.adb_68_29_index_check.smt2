...
(declare-fun temp___1213 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1215 (_ BitVec 8))) (forall ((temp___1216 Int) (temp___1217 Int)) (let ((temp___1214 (temp___1213 temp___1215 temp___1216 temp___1217))) (=> (dynamic_invariant3 temp___1215 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1216 temp___1217) (and (= (first5 temp___1214) temp___1216) (= (last5 temp___1214) temp___1217))) (forall ((temp___1218 Int)) (= (to_rep1 (select (to_array2 temp___1214) temp___1218)) temp___1215))))))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1213 #x00 1 r10b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1213 #x00 1 r10b)))) r10b))
(assert (= (mk___t2 temp___1220 temp___12201) (temp___1213 #x00 1 r10b)))
(assert (= (ite (<= (to_rep2 (first4 temp___12201)) (to_rep2 (last4 temp___12201))) (+ (- (to_rep2 (last4 temp___12201)) (to_rep2 (first4 temp___12201))) 1) 0) (ite (<= 1 r10b) (+ (- r10b 1) 1) 0)))
(assert (= temp___1220 temp___1221))
(assert (= (mk1 (to_rep2 (first4 temp___12201)) (to_rep2 (last4 temp___12201))) temp___12211))
(assert (= (ite (<= (to_rep2 (first2 temp___12211)) (to_rep2 (last2 temp___12211))) (+ (- (to_rep2 (last2 temp___12211)) (to_rep2 (first2 temp___12211))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1223 temp___12231) (mk___t1 temp___1221 temp___12211)))
(assert (= temp___1223 o))
(assert (= (mk (to_rep2 (first2 temp___12231)) (to_rep2 (last2 temp___12231))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (and (and (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1233 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1233) (<= temp___1233 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1233) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1233) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1233)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
