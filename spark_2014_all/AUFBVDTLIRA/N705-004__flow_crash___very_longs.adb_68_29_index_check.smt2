...
(define-fun dynamic_invariant ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 1 2147483647)) (in_range1 temp___expr_200)))
...
(assert (forall ((temp___1144 (_ BitVec 8))) (forall ((temp___1145 Int) (temp___1146 Int)) (let ((temp___1143 (temp___1142 temp___1144 temp___1145 temp___1146))) (and (=> (dynamic_property6 1 2147483647 temp___1145 temp___1146) (and (= (first5 temp___1143) temp___1145) (= (last5 temp___1143) temp___1146))) (forall ((temp___1147 Int)) (= (select (to_array2 temp___1143) temp___1147) (of_rep1 temp___1144))))))))
(define-fun dynamic_invariant5 ((temp___expr_350 us_t1) (temp___is_init_347 Bool) (temp___skip_constant_348 Bool) (temp___do_toplevel_349 Bool)) Bool (=> (not (= temp___skip_constant_348 true)) (and (dynamic_property3 1 r10b (first3 temp___expr_350) (last3 temp___expr_350)) (and (= (first3 temp___expr_350) 1) (= (last3 temp___expr_350) r10b)))))
...
(declare-const temp___1166 (_ BitVec 16))
(declare-const temp___1165 (_ BitVec 16))
(declare-const temp___1164 (_ BitVec 16))
(declare-const temp___1163 (_ BitVec 16))
(declare-const temp___1160 digit_index_type)
(declare-const temp___11601 (Array Int octet))
(declare-const temp___11602 t)
...
(assert (= (to_rep2 (first4 (rt2 (temp___1142 ((_ int2bv 8) 0) 1 r10b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1142 ((_ int2bv 8) 0) 1 r10b)))) r10b))
(assert (= (mk___t2 temp___1149 temp___11491) (temp___1142 ((_ int2bv 8) 0) 1 r10b)))
(assert (= (ite (<= (to_rep2 (first4 temp___11491)) (to_rep2 (last4 temp___11491))) (+ (- (to_rep2 (last4 temp___11491)) (to_rep2 (first4 temp___11491))) 1) 0) (ite (<= 1 r10b) (+ (- r10b 1) 1) 0)))
(assert (= temp___1149 temp___1150))
(assert (= (mk1 (to_rep2 (first4 temp___11491)) (to_rep2 (last4 temp___11491))) temp___11501))
(assert (= (ite (<= (to_rep2 (first2 temp___11501)) (to_rep2 (last2 temp___11501))) (+ (- (to_rep2 (last2 temp___11501)) (to_rep2 (first2 temp___11501))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1152 temp___11521) (mk___t1 temp___1150 temp___11501)))
(assert (= temp___1152 o))
(assert (= (mk (to_rep2 (first2 temp___11521)) (to_rep2 (last2 temp___11521))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___11541 temp___11542))))
(assert (= result____split_discrs (mk___split_discrs temp___1154)))
...
(assert (and (and (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true) (forall ((temp___1162 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1162) (<= temp___1162 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1162) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1162) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1162)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
