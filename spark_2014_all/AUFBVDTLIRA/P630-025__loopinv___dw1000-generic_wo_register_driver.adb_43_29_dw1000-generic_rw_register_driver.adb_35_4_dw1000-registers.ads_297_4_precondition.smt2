...
(assert (and (= temp___78332 (register_to_bytes reg)) (dynamic_invariant1 temp___78332 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___78331)) (to_rep (last4 temp___78331))) (+ (- (to_rep (last4 temp___78331)) (to_rep (first4 temp___78331))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___7833 temp___7834))
(assert (= (mk1 (to_rep (first4 temp___78331)) (to_rep (last4 temp___78331))) temp___78341))
(assert (= (ite (<= (to_rep (first2 temp___78341)) (to_rep (last2 temp___78341))) (+ (- (to_rep (last2 temp___78341)) (to_rep (first2 temp___78341))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___7834 temp___78341)))
(assert (= o2 o))
