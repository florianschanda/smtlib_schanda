...
(define-fun in_range3 ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 0) x) (bvule x ((_ int2bv 32) 8388607))))
...
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x ((_ int2bv 32) 8388608)))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(define-fun dynamic_invariant ((temp___expr_4677 us_t1) (temp___is_init_4674 Bool) (temp___skip_constant_4675 Bool) (temp___do_toplevel_4676 Bool)) Bool (=> (not (= temp___skip_constant_4675 true)) (and (dynamic_property2 1 4 (first3 temp___expr_4677) (last3 temp___expr_4677)) (and (= (first3 temp___expr_4677) 1) (= (last3 temp___expr_4677) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_4702 us_t2) (temp___is_init_4699 Bool) (temp___skip_constant_4700 Bool) (temp___do_toplevel_4701 Bool)) Bool (=> (not (= temp___skip_constant_4700 true)) (and (dynamic_property3 1 4 (first5 temp___expr_4702) (last5 temp___expr_4702)) (and (= (first5 temp___expr_4702) 1) (= (last5 temp___expr_4702) 4)))))
...
(declare-const temp___7926 (Array Int bits_8))
(declare-const temp___79261 t2)
(declare-const temp___7927 (Array Int bits_8))
(declare-const temp___79271 t1)
(define-fun temp___79262 () us_t2 (mk___t2 temp___7926 temp___79261))
...
(assert (and (= temp___79262 (register_to_bytes reg)) (dynamic_invariant1 temp___79262 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___79261)) (to_rep (last4 temp___79261))) (+ (- (to_rep (last4 temp___79261)) (to_rep (first4 temp___79261))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7926 temp___7927))
(assert (= (mk1 (to_rep (first4 temp___79261)) (to_rep (last4 temp___79261))) temp___79271))
(assert (not (= (ite (<= (to_rep (first2 temp___79271)) (to_rep (last2 temp___79271))) (+ (- (to_rep (last2 temp___79271)) (to_rep (first2 temp___79271))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
