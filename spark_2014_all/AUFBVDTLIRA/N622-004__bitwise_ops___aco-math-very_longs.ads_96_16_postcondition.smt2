...
(define-fun o6 () us_rep (mk___rep (mk___split_discrs o3) (mk___split_fields (mk___t o4 o5))))
(define-fun o7 () us_rep (mk___rep (mk___split_discrs o) (mk___split_fields (mk___t o1 o2))))
...
(assert (and (= us (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 p)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 p))))))
(assert (and (= us1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))))
(assert (and (= us2 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (and (= us3 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
...
(assert (and (= (to_rep (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (dynamic_invariant1 (mk___rep result____split_discrs aco__math__very_longs__modsubtract_and_borrow__result__fields) true true true)))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (us_split_fields3 (of_base (mk___rep result____split_discrs aco__math__very_longs__modsubtract_and_borrow__result__fields)))))
(assert (= result____split_discrs (us_split_discrs2 (of_base (mk___rep result____split_discrs aco__math__very_longs__modsubtract_and_borrow__result__fields)))))
(assert (=> (= borrow ((_ int2bv 16) 1)) (and (= o7 (modadd (to_base (mk___rep1 result____split_discrs result____split_fields2)) p)) (and (dynamic_invariant1 o7 true false true) (= (to_rep o) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 (to_base (mk___rep1 result____split_discrs result____split_fields2))))))))))
(assert (=> (= borrow ((_ int2bv 16) 1)) (= o6 o7)))
(assert (=> (= borrow ((_ int2bv 16) 1)) (= (mk___rep1 (mk___split_discrs temp___1359) (mk___split_fields1 (mk___t1 temp___13591 temp___13592))) (of_base o6))))
(assert (=> (= borrow ((_ int2bv 16) 1)) (= result1 (mk___split_fields__ref1 result____split_fields2))))
(assert (=> (= borrow ((_ int2bv 16) 1)) (= result____split_fields3 (mk___split_fields1 (mk___t1 temp___13591 temp___13592)))))
(assert (=> (= borrow ((_ int2bv 16) 1)) (= result____split_discrs (mk___split_discrs temp___1359))))
(assert (=> (not (= borrow ((_ int2bv 16) 1))) (= result____split_fields3 result____split_fields2)))
(assert (= aco__math__very_longs__subtract_fp__result4 (mk_very_long__ref aco__math__very_longs__subtract_fp__result3)))
(assert (= aco__math__very_longs__subtract_fp__result5 aco__math__very_longs__subtract_fp__result3))
(assert (= result2 (mk_very_long__ref (mk___rep (mk___split_discrs aco__math__very_longs__subtract_fp__result) (mk___split_fields (mk___t aco__math__very_longs__subtract_fp__result1 aco__math__very_longs__subtract_fp__result2))))))
(assert (= aco__math__very_longs__subtract_fp__result3 (to_base (mk___rep1 result____split_discrs result____split_fields3))))
(assert (= aco__math__very_longs__subtract_fp__result6 aco__math__very_longs__subtract_fp__result4))
(assert (= borrow1 (mk_t__ref borrow)))
(assert (= result____split_fields4 (mk___split_fields__ref1 result____split_fields3)))
(assert (= aco__math__very_longs__subtract_fp__result7 aco__math__very_longs__subtract_fp__result5))
