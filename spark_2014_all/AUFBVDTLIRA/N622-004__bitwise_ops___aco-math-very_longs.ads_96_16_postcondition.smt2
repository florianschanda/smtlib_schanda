...
(assert (forall ((x octet)) (! (uint_in_range1 (to_int4 x)) :pattern ((to_int4 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_282 us_rep) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool)) Bool (let ((temp___283 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 temp___expr_282)))) (and (dynamic_property1 1 (to_rep temp___283) (first1 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_282))) (last1 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_282)))) (and (= (first1 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_282))) 1) (= (last1 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 temp___expr_282))) (to_rep temp___283))))))
(declare-fun modadd (us_rep us_rep) us_rep)
(declare-fun modadd__function_guard (us_rep us_rep us_rep) Bool)
(assert (forall ((l us_rep) (r us_rep)) (! (=> (and (and (dynamic_invariant1 l true true true) (dynamic_invariant1 r true true true)) (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))) (let ((result (modadd l r))) (and (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 result))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (dynamic_invariant1 result true false true)))) :pattern ((modadd l r)))))
...
(declare-datatypes () ((tT158bP1__ref (mk_tT158bP1__ref (tT158bP1__content tdigit_index_typeB)))))
(define-fun tT158bP1__ref___projection ((a tT158bP1__ref)) tdigit_index_typeB (tT158bP1__content a))
(declare-sort t1 0)
...
(define-fun us_split_fields_Long_Digits__40__projection ((a us_split_fields2)) us_t1 (rec__aco__math__very_longs__very_long__long_digits1 a))
(declare-datatypes () ((us_split_fields__ref1 (mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___40__projection ((a us_split_fields__ref1)) us_split_fields2 (us_split_fields__content1 a))
(declare-datatypes () ((us_rep1 (mk___rep1 (us_split_discrs2 us_split_discrs) (us_split_fields3 us_split_fields2)))))
(define-fun us_rep___79__projection ((a us_rep1)) us_split_discrs (us_split_discrs2 a))
(define-fun us_rep___80__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
...
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___212 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___212) (first1 temp___212) (last1 temp___212))))))
...
(define-fun tresultS__ref___7__projection ((a tresultS__ref)) us_rep1 (tresultS__content a))
(define-fun dynamic_invariant2 ((temp___expr_1002 us_rep1) (temp___is_init_999 Bool) (temp___skip_constant_1000 Bool) (temp___do_toplevel_1001 Bool)) Bool (and (=> (not (= temp___skip_constant_1000 true)) (in_range3 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_1002))) (and (dynamic_property3 1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_1002))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_1002)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_1002))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_1002))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_1005 us_rep1) (temp___skip_top_level_1006 Bool)) Bool (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_1005))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
(declare-const result____split_discrs us_split_discrs)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(define-fun dynamic_invariant3 ((temp___expr_271 Int) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (=> (or (= temp___is_init_268 true) (<= 1 2147483647)) (in_range1 temp___expr_271)))
...
(assert (and (and (and (= us (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 p)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 p))))) (and (and (= us1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))) (and (and (= us2 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))) (and (and (= us3 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))) (and (= (to_rep (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (and (dynamic_invariant2 (mk___rep1 result____split_discrs (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1))) false false true) (and (and (and (= (to_rep (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (dynamic_invariant1 (mk___rep result____split_discrs aco__math__very_longs__modsubtract_and_borrow__result__fields) true true true)) (and (and (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))) (= result____split_fields2 (us_split_fields3 (of_base (mk___rep result____split_discrs aco__math__very_longs__modsubtract_and_borrow__result__fields))))) (= result____split_discrs (us_split_discrs2 (of_base (mk___rep result____split_discrs aco__math__very_longs__modsubtract_and_borrow__result__fields)))))) (and (ite (= borrow1 ((_ int2bv 16) 1)) (and (and (and (and (= (mk___rep (mk___split_discrs o) (mk___split_fields (mk___t o1 o2))) (modadd (to_base (mk___rep1 result____split_discrs result____split_fields2)) p)) (and (dynamic_invariant1 (mk___rep (mk___split_discrs o) (mk___split_fields (mk___t o1 o2))) true false true) (= (to_rep o) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 (to_base (mk___rep1 result____split_discrs result____split_fields2)))))))) (= (mk___rep (mk___split_discrs o3) (mk___split_fields (mk___t o4 o5))) (mk___rep (mk___split_discrs o) (mk___split_fields (mk___t o1 o2))))) (= (mk___rep1 (mk___split_discrs temp___1359) (mk___split_fields1 (mk___t1 temp___13591 temp___13592))) (of_base (mk___rep (mk___split_discrs o3) (mk___split_fields (mk___t o4 o5)))))) (and (and (= result1 (mk___split_fields__ref1 result____split_fields2)) (= result____split_fields3 (mk___split_fields1 (mk___t1 temp___13591 temp___13592)))) (= result____split_discrs (mk___split_discrs temp___1359)))) (= result____split_fields3 result____split_fields2)) (and (and (= aco__math__very_longs__subtract_fp__result4 (mk_very_long__ref aco__math__very_longs__subtract_fp__result3)) (= aco__math__very_longs__subtract_fp__result5 aco__math__very_longs__subtract_fp__result3)) (and (= result2 (mk_very_long__ref (mk___rep (mk___split_discrs aco__math__very_longs__subtract_fp__result) (mk___split_fields (mk___t aco__math__very_longs__subtract_fp__result1 aco__math__very_longs__subtract_fp__result2))))) (= aco__math__very_longs__subtract_fp__result3 (to_base (mk___rep1 result____split_discrs result____split_fields3))))))))))))) (and (and (= aco__math__very_longs__subtract_fp__result6 aco__math__very_longs__subtract_fp__result4) (and (= borrow2 (mk_t__ref borrow1)) (= result____split_fields4 (mk___split_fields__ref1 result____split_fields3)))) (and (= aco__math__very_longs__subtract_fp__result7 aco__math__very_longs__subtract_fp__result5) (and (= borrow3 borrow1) (= result____split_fields5 result____split_fields3))))))
(assert (= (mk___rep (mk___split_discrs result3) (mk___split_fields (mk___t result4 result5))) (very_long__content aco__math__very_longs__subtract_fp__result6)))
(assert (not (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 (very_long__content aco__math__very_longs__subtract_fp__result6)))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(check-sat)
(exit)
