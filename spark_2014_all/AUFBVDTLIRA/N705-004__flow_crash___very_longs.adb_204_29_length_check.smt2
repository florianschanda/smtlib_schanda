...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___164 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___164) (first3 temp___164) (last3 temp___164))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___163 (rec__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___163) (first1 temp___163) (last1 temp___163))))))
...
(define-fun dynamic_invariant4 ((temp___expr_542 us_rep1) (temp___is_init_539 Bool) (temp___skip_constant_540 Bool) (temp___do_toplevel_541 Bool)) Bool (and (=> (not (= temp___skip_constant_540 true)) (in_range4 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_542))) (and (dynamic_property3 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_542))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_542)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_542))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_542))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_545 us_rep1) (temp___skip_top_level_546 Bool)) Bool (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_545))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))))
...
(declare-fun temp___901 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___903 (_ BitVec 8))) (forall ((temp___904 Int) (temp___905 Int)) (let ((temp___902 (temp___901 temp___903 temp___904 temp___905))) (and (=> (dynamic_property6 1 2147483647 temp___904 temp___905) (and (= (first5 temp___902) temp___904) (= (last5 temp___902) temp___905))) (forall ((temp___906 Int)) (= (select (to_array2 temp___902) temp___906) (of_rep1 temp___903))))))))
(define-fun dynamic_invariant5 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 1 2147483647)) (in_range1 temp___expr_200)))
...
(declare-const temp___908 (Array Int octet))
(declare-const temp___9081 t2)
(declare-const temp___909 (Array Int octet))
(declare-const temp___9091 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___912 digit_index_type)
(declare-const temp___9121 (Array Int octet))
(declare-const temp___9122 t1)
(declare-const temp___924 (_ BitVec 16))
(declare-const temp___921 us_rep1)
(declare-const temp___920 (_ BitVec 16))
(declare-const temp___919 (_ BitVec 16))
(declare-const temp___918 (_ BitVec 16))
...
(declare-const temp___917 us_rep1)
...
(assert true)
(assert true)
(assert (= (to_rep2 (first4 (rt2 (temp___901 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___901 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___908 temp___9081) (temp___901 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (not (= (ite (<= (to_rep2 (first4 temp___9081)) (to_rep2 (last4 temp___9081))) (+ (- (to_rep2 (last4 temp___9081)) (to_rep2 (first4 temp___9081))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0))))
(check-sat)
(exit)
