...
(declare-fun temp___972 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___974 (_ BitVec 8))) (forall ((temp___975 Int) (temp___976 Int)) (let ((temp___973 (temp___972 temp___974 temp___975 temp___976))) (=> (dynamic_invariant2 temp___974 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___975 temp___976) (and (= (first5 temp___973) temp___975) (= (last5 temp___973) temp___976))) (forall ((temp___977 Int)) (= (to_rep1 (select (to_array2 temp___973) temp___977)) temp___974))))))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___972 #x00 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___972 #x00 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___979 temp___9791) (temp___972 #x00 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (not (= (ite (<= (to_rep2 (first4 temp___9791)) (to_rep2 (last4 temp___9791))) (+ (- (to_rep2 (last4 temp___9791)) (to_rep2 (first4 temp___9791))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0))))
(check-sat)
(exit)
