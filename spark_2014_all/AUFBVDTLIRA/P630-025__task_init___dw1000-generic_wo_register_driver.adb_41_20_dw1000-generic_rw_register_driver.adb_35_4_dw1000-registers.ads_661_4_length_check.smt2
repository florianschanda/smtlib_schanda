...
(define-fun dynamic_invariant ((temp___expr_8097 us_t1) (temp___is_init_8093 Bool) (temp___skip_constant_8094 Bool) (temp___do_toplevel_8095 Bool) (temp___do_typ_inv_8096 Bool)) Bool (=> (not (= temp___skip_constant_8094 true)) (and (dynamic_property2 1 4 (first3 temp___expr_8097) (last3 temp___expr_8097)) (and (= (first3 temp___expr_8097) 1) (= (last3 temp___expr_8097) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_8130 us_t2) (temp___is_init_8126 Bool) (temp___skip_constant_8127 Bool) (temp___do_toplevel_8128 Bool) (temp___do_typ_inv_8129 Bool)) Bool (=> (not (= temp___skip_constant_8127 true)) (and (dynamic_property3 1 4 (first5 temp___expr_8130) (last5 temp___expr_8130)) (and (= (first5 temp___expr_8130) 1) (= (last5 temp___expr_8130) 4)))))
...
(declare-const temp___89921 t2)
(define-fun temp___89922 () us_t2 (mk___t2 temp___8992 temp___89921))
...
(assert (and (= temp___89922 (register_to_bytes reg)) (dynamic_invariant1 temp___89922 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___89921)) (to_rep (last4 temp___89921))) (+ (- (to_rep (last4 temp___89921)) (to_rep (first4 temp___89921))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
