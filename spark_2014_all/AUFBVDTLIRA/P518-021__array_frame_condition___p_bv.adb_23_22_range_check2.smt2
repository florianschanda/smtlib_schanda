...
(declare-const o (Array (_ BitVec 32) map1))
(declare-const temp___321 (Array (_ BitVec 32) map1))
(declare-const temp___3211 t1)
...
(assert (= o y))
(assert (= temp___321 o))
(assert (= temp___3211 (mk1 (bvadd i31 #x00000001) #x00000003)))
