...
(assert (<= 1 i8))
(assert (<= i8 14))
(assert (forall ((j Int)) (=> (and (<= 1 j) (<= j (- i9 1))) (and (<= 48 (to_rep (select (map__content timestring6) j))) (<= (to_rep (select (map__content timestring6) j)) 57)))))
(assert (and (=> (<= 1 14) (in_range8 i9)) (and (<= 1 i9) (<= i9 14))))
(assert (<= 1 (- i9 1)))
