...
(declare-sort acc_mem_number_type 0)
(define-fun in_range2 ((x Int)) Bool (and (<= (- 32768) x) (<= x 32767)))
(declare-fun attr__ATTRIBUTE_IMAGE3 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check3 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE3 (us_image) Int)
(declare-fun user_eq4 (acc_mem_number_type acc_mem_number_type) Bool)
(declare-const dummy4 acc_mem_number_type)
(declare-datatypes () ((acc_mem_number_type__ref (mk_acc_mem_number_type__ref (acc_mem_number_type__content acc_mem_number_type)))))
(define-fun acc_mem_number_type__ref___projection ((a acc_mem_number_type__ref)) acc_mem_number_type (acc_mem_number_type__content a))
(declare-fun to_rep2 (acc_mem_number_type) Int)
(declare-fun of_rep2 (Int) acc_mem_number_type)
(assert (forall ((x acc_mem_number_type)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x acc_mem_number_type)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x Int)) (! (=> (in_range2 x) (= (to_rep2 (of_rep2 x)) x)) :pattern ((to_rep2 (of_rep2 x))))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__acc_mem_sample_type__real acc_mem_number_type) (rec__dw1000__register_types__acc_mem_sample_type__imag acc_mem_number_type)))))
(define-fun us_split_fields_Real__projection ((a us_split_fields)) acc_mem_number_type (rec__dw1000__register_types__acc_mem_sample_type__real a))
(define-fun us_split_fields_Imag__projection ((a us_split_fields)) acc_mem_number_type (rec__dw1000__register_types__acc_mem_sample_type__imag a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___34__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___34__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__dw1000__register_types__acc_mem_sample_type__real (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__acc_mem_sample_type__real (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__acc_mem_sample_type__imag (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__acc_mem_sample_type__imag (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__acc_mem_sample_type__real__first__bit Int)
(declare-const dw1000__register_types__acc_mem_sample_type__real__last__bit Int)
(declare-const dw1000__register_types__acc_mem_sample_type__real__position Int)
(assert (<= 0 dw1000__register_types__acc_mem_sample_type__real__first__bit))
(assert (< dw1000__register_types__acc_mem_sample_type__real__first__bit dw1000__register_types__acc_mem_sample_type__real__last__bit))
(assert (<= 0 dw1000__register_types__acc_mem_sample_type__real__position))
(declare-const dw1000__register_types__acc_mem_sample_type__imag__first__bit Int)
(declare-const dw1000__register_types__acc_mem_sample_type__imag__last__bit Int)
(declare-const dw1000__register_types__acc_mem_sample_type__imag__position Int)
(assert (<= 0 dw1000__register_types__acc_mem_sample_type__imag__first__bit))
(assert (< dw1000__register_types__acc_mem_sample_type__imag__first__bit dw1000__register_types__acc_mem_sample_type__imag__last__bit))
(assert (<= 0 dw1000__register_types__acc_mem_sample_type__imag__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((acc_mem_sample_type__ref (mk_acc_mem_sample_type__ref (acc_mem_sample_type__content us_rep)))))
(define-fun acc_mem_sample_type__ref___projection ((a acc_mem_sample_type__ref)) us_rep (acc_mem_sample_type__content a))
...
(define-fun bool_eq3 ((a (Array Int us_rep)) (a__first Int) (a__last Int) (b (Array Int us_rep)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_133 Int)) (=> (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (= (bool_eq2 (select a temp___idx_133) (select b (+ (- b__first a__first) temp___idx_133))) true)))) true false))
...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__dw1000__register_types__acc_mem_type__cir (Array Int us_rep))))))
(define-fun us_split_fields_CIR__projection ((a us_split_fields2)) (Array Int us_rep) (rec__dw1000__register_types__acc_mem_type__cir a))
(declare-datatypes () ((us_split_fields__ref1 (mk___split_fields__ref1 (us_split_fields__content1 us_split_fields2)))))
(define-fun us_split_fields__ref___35__projection ((a us_split_fields__ref1)) us_split_fields2 (us_split_fields__content1 a))
(declare-datatypes () ((us_rep1 (mk___rep1 (us_split_fields3 us_split_fields2)))))
(define-fun us_rep___35__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
(define-fun bool_eq4 ((a us_rep1) (b us_rep1)) Bool (ite (= (bool_eq3 (rec__dw1000__register_types__acc_mem_type__cir (us_split_fields3 a)) 0 1015 (rec__dw1000__register_types__acc_mem_type__cir (us_split_fields3 b)) 0 1015) true) true false))
...
(declare-const dw1000__register_types__acc_mem_type__cir__first__bit Int)
(declare-const dw1000__register_types__acc_mem_type__cir__last__bit Int)
(declare-const dw1000__register_types__acc_mem_type__cir__position Int)
(assert (<= 0 dw1000__register_types__acc_mem_type__cir__first__bit))
(assert (< dw1000__register_types__acc_mem_type__cir__first__bit dw1000__register_types__acc_mem_type__cir__last__bit))
(assert (<= 0 dw1000__register_types__acc_mem_type__cir__position))
(declare-fun user_eq7 (us_rep1 us_rep1) Bool)
(declare-const dummy7 us_rep1)
(declare-datatypes () ((acc_mem_type__ref (mk_acc_mem_type__ref (acc_mem_type__content us_rep1)))))
(define-fun acc_mem_type__ref___projection ((a acc_mem_type__ref)) us_rep1 (acc_mem_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep1)))))
(define-fun register_type__ref___74__projection ((a register_type__ref)) us_rep1 (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___54__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___54__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3783 us_t1) (temp___is_init_3780 Bool) (temp___skip_constant_3781 Bool) (temp___do_toplevel_3782 Bool)) Bool (=> (not (= temp___skip_constant_3781 true)) (and (dynamic_property2 1 4064 (first3 temp___expr_3783) (last3 temp___expr_3783)) (and (= (first3 temp___expr_3783) 1) (= (last3 temp___expr_3783) 4064)))))
...
(assert (and (dynamic_property2 1 4064 (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 4064))))
