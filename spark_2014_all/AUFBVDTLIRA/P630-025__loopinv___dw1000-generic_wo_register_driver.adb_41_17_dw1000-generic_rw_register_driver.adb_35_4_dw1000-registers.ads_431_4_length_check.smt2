...
(assert (not (= (ite (<= (to_rep (first2 temp___79941)) (to_rep (last2 temp___79941))) (+ (- (to_rep (last2 temp___79941)) (to_rep (first2 temp___79941))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
