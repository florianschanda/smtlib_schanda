...
(declare-fun temp___1151 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___1153 (_ BitVec 8))) (forall ((temp___1154 Int) (temp___1155 Int)) (let ((temp___1152 (temp___1151 temp___1153 temp___1154 temp___1155))) (and (=> (dynamic_property6 1 65536 temp___1154 temp___1155) (and (= (first5 temp___1152) temp___1154) (= (last5 temp___1152) temp___1155))) (forall ((temp___1156 Int)) (= (select (to_array2 temp___1152) temp___1156) (of_rep1 temp___1153))))))))
...
(declare-const temp___11581 t2)
(declare-const temp___1159 (Array Int octet))
(declare-const temp___11591 t1)
(declare-const temp___1161 (Array Int octet))
(declare-const temp___11611 t1)
(declare-const o (Array Int octet))
(declare-const o1 t)
(declare-const o2 (Array Int octet))
(declare-const o3 t)
(declare-const temp___1163 digit_index_type)
(declare-const temp___11631 (Array Int octet))
(declare-const temp___11632 t)
