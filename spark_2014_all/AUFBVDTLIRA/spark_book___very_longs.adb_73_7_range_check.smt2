...
(declare-fun temp___1220 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1222 (_ BitVec 8))) (forall ((temp___1223 Int) (temp___1224 Int)) (let ((temp___1221 (temp___1220 temp___1222 temp___1223 temp___1224))) (=> (dynamic_invariant3 temp___1222 true true true true) (and (=> (dynamic_property6 1 65536 temp___1223 temp___1224) (and (= (first5 temp___1221) temp___1223) (= (last5 temp___1221) temp___1224))) (forall ((temp___1225 Int)) (= (to_rep1 (select (to_array2 temp___1221) temp___1225)) temp___1222))))))))
