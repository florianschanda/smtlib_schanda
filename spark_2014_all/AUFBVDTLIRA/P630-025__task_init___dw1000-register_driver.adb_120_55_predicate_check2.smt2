...
(assert (and (= (to_rep4 temp___8721) 1) (= (to_rep6 temp___8724) 0)))
...
(assert (not (= (to_rep4 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 header1))) 1)))
(check-sat)
(exit)
