...
(define-fun dynamic_invariant4 ((temp___expr_302 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 1 2147483647)) (in_range3 temp___expr_302)))
...
(assert (= (to_rep1 (last number__split_fields1)) r126b))
(assert (in_range2 r126b))
(assert (= result2 i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 r126b))
(assert (and (and (dynamic_invariant2 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true true) (forall ((temp___1585 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1585) (<= temp___1585 (to_rep1 (last number__split_fields3)))) (=> (<= i2 temp___1585) (= (select number__split_fields2 temp___1585) (select number__split_fields temp___1585)))))) (and (<= 1 i2) (<= i2 r126b))))
...
(assert (= o15 o13))
(assert (= o16 o14))
(assert (= number__split_discrs (mk___split_discrs temp___1576)))
(assert (= temp___15761 o15))
(assert (= temp___15762 o16))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___15761 temp___15762))))
(assert (= number__split_discrs (mk___split_discrs temp___1576)))
(assert (and (<= (to_rep1 (first (rt (rec__aco__math__very_longs__very_long__long_digits number__split_fields4)))) i2) (<= i2 (to_rep1 (last (rt (rec__aco__math__very_longs__very_long__long_digits number__split_fields4)))))))
(assert (= o17 i2))
(assert (= o18 (select (elts (rec__aco__math__very_longs__very_long__long_digits number__split_fields4)) o17)))
(assert (= o19 (to_rep o18)))
(assert (= o20 (bvor o19 old_overflow2)))
(assert (= (to_rep o21) o20))
(assert (not (<= (to_rep1 (first (rt (rec__aco__math__very_longs__very_long__long_digits number__split_fields4)))) i2)))
(check-sat)
(exit)
