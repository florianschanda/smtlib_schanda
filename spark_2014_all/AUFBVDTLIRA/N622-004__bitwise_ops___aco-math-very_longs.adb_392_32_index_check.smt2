...
(define-fun dynamic_invariant3 ((temp___expr_813 Int) (temp___is_init_810 Bool) (temp___skip_constant_811 Bool) (temp___do_toplevel_812 Bool)) Bool (=> (or (= temp___is_init_810 true) (<= 0 7)) (in_range4 temp___expr_813)))
...
(define-fun dynamic_invariant4 ((temp___expr_271 Int) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (=> (or (= temp___is_init_268 true) (<= 1 2147483647)) (in_range3 temp___expr_271)))
...
(declare-const o16 t)
(declare-const temp___1491 digit_index_type)
(declare-const temp___14911 (Array Int octet))
(declare-const temp___14912 t)
...
(assert true)
(assert true)
(assert (=> (< (- 8 distance) 8) (= o (bvshl ((_ int2bv 8) 255) ((_ int2bv 8) (- 8 distance))))))
(assert (=> (not (< (- 8 distance) 8)) (= o ((_ int2bv 8) 0))))
...
(assert (<= 1 i1))
(assert (<= i1 r126b))
(assert (and (and (dynamic_invariant2 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true) (forall ((temp___1500 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1500) (<= temp___1500 (to_rep1 (last number__split_fields3)))) (=> (<= i2 temp___1500) (= (select number__split_fields2 temp___1500) (select number__split_fields temp___1500)))))) (and (<= 1 i2) (<= i2 r126b))))
...
(assert (and (= o5 (shift_right o4 (- 8 distance))) (= o5 (bvudiv o4 (ite (< (- 8 distance) 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (- 8 distance))) ((_ int2bv 8) 0))))))
(assert (= result3 new_overflow1))
(assert (= new_overflow2 o5))
...
(assert (=> (not (< distance 8)) (= o9 ((_ int2bv 8) 0))))
...
(assert (= o15 o13))
(assert (= o16 o14))
(assert (= number__split_discrs (mk___split_discrs temp___1491)))
(assert (= temp___14911 o15))
(assert (= temp___14912 o16))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___14911 temp___14912))))
(assert (= number__split_discrs (mk___split_discrs temp___1491)))
