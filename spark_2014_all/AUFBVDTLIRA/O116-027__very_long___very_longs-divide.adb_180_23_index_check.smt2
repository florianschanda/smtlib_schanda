...
(assert (and (= temp___1358 (+ j n)) (in_range2 (+ j n))))
(assert (not (<= temp___1358 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields7))))))))
(check-sat)
(exit)
