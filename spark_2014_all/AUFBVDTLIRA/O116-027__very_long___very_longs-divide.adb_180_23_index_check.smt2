...
(assert (and (= temp___1358 (+ j n)) (in_range1 (+ j n))))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields7))))) temp___1358)))
(check-sat)
(exit)
