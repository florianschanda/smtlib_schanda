...
(assert (=> (= success20 true) (and (and (and (and (<= begidx4 endidx2) (<= begidx4 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i28 Int)) (=> (and (<= begidx4 i28) (<= i28 endidx2)) (and (<= 48 (to_rep (select zonefileline i28))) (<= (to_rep (select zonefileline i28)) 57)))))) (and (and (in_range4 begidx4) (in_range4 endidx2)) (in_range3 foundtype2)))))
...
(assert (= begidx7 o48))
(assert (and (and (and (and (<= begidx8 endidx5) (<= begidx8 zlength)) (<= endidx5 zlength)) (=> (= foundtype5 1) (forall ((i28 Int)) (=> (and (<= begidx8 i28) (<= i28 endidx5)) (and (<= 48 (to_rep (select zonefileline i28))) (<= (to_rep (select zonefileline i28)) 57)))))) (and (and (in_range4 begidx8) (in_range4 endidx5)) (in_range3 foundtype5))))
