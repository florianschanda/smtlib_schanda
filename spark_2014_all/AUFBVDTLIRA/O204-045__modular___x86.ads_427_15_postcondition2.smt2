...
(assert (not (= x86__readmem32__result4 (bvadd ((_ zero_extend 16) (readmem16 addr memory)) (bvmul ((_ zero_extend 16) (readmem16 (bvadd addr #x0000000000000002) memory)) #x00010000)))))
(check-sat)
(exit)
