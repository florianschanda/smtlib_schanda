...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 32)))) (=> (in_range4 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
...
(define-fun in_range5 ((x (_ BitVec 16))) Bool (and (bvule ((_ int2bv 16) 0) x) (bvule x ((_ int2bv 16) 511))))
...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x ((_ int2bv 16) 512)))) (=> (in_range5 y) (= (to_rep5 (of_rep5 x)) y))) :pattern ((to_rep5 (of_rep5 x))))))
...
(define-fun dynamic_invariant ((temp___expr_5198 us_t1) (temp___is_init_5195 Bool) (temp___skip_constant_5196 Bool) (temp___do_toplevel_5197 Bool)) Bool (=> (not (= temp___skip_constant_5196 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5198) (last3 temp___expr_5198)) (and (= (first3 temp___expr_5198) 1) (= (last3 temp___expr_5198) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_5219 us_t2) (temp___is_init_5216 Bool) (temp___skip_constant_5217 Bool) (temp___do_toplevel_5218 Bool)) Bool (=> (not (= temp___skip_constant_5217 true)) (and (dynamic_property3 1 4 (first5 temp___expr_5219) (last5 temp___expr_5219)) (and (= (first5 temp___expr_5219) 1) (= (last5 temp___expr_5219) 4)))))
...
(assert (and (= temp___79862 (register_to_bytes reg)) (dynamic_invariant1 temp___79862 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___79861)) (to_rep (last4 temp___79861))) (+ (- (to_rep (last4 temp___79861)) (to_rep (first4 temp___79861))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7986 temp___7987))
(assert (= (mk1 (to_rep (first4 temp___79861)) (to_rep (last4 temp___79861))) temp___79871))
(assert (= (ite (<= (to_rep (first2 temp___79871)) (to_rep (last2 temp___79871))) (+ (- (to_rep (last2 temp___79871)) (to_rep (first2 temp___79871))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
