...
(declare-const temp___8759 (Array Int bits_8))
(declare-const temp___87591 t1)
...
(assert (= (ite (<= (to_rep (first4 temp___87581)) (to_rep (last4 temp___87581))) (+ (- (to_rep (last4 temp___87581)) (to_rep (first4 temp___87581))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8758 temp___8759))
(assert (= (mk1 (to_rep (first4 temp___87581)) (to_rep (last4 temp___87581))) temp___87591))
(assert (= (ite (<= (to_rep (first2 temp___87591)) (to_rep (last2 temp___87591))) (+ (- (to_rep (last2 temp___87591)) (to_rep (first2 temp___87591))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8759 temp___87591)))
(assert (= o2 o))
