...
(define-fun dynamic_invariant ((temp___expr_7036 us_t1) (temp___is_init_7033 Bool) (temp___skip_constant_7034 Bool) (temp___do_toplevel_7035 Bool)) Bool (=> (not (= temp___skip_constant_7034 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7036) (last3 temp___expr_7036)) (and (= (first3 temp___expr_7036) 1) (= (last3 temp___expr_7036) 2)))))
