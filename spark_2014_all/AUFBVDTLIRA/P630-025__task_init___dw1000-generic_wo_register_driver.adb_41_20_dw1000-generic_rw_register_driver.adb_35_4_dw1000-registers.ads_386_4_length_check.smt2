...
(define-fun dynamic_invariant ((temp___expr_4768 us_t1) (temp___is_init_4765 Bool) (temp___skip_constant_4766 Bool) (temp___do_toplevel_4767 Bool)) Bool (=> (not (= temp___skip_constant_4766 true)) (and (dynamic_property2 1 2 (first3 temp___expr_4768) (last3 temp___expr_4768)) (and (= (first3 temp___expr_4768) 1) (= (last3 temp___expr_4768) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_4784 us_t2) (temp___is_init_4781 Bool) (temp___skip_constant_4782 Bool) (temp___do_toplevel_4783 Bool)) Bool (=> (not (= temp___skip_constant_4782 true)) (and (dynamic_property3 1 2 (first5 temp___expr_4784) (last5 temp___expr_4784)) (and (= (first5 temp___expr_4784) 1) (= (last5 temp___expr_4784) 2)))))
...
(declare-const temp___7935 (Array Int bits_8))
(declare-const temp___79351 t2)
(declare-const temp___7936 (Array Int bits_8))
(declare-const temp___79361 t1)
...
(assert (and (= (mk___t2 temp___7935 temp___79351) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7935 temp___79351) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___79351)) (to_rep (last4 temp___79351))) (+ (- (to_rep (last4 temp___79351)) (to_rep (first4 temp___79351))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
