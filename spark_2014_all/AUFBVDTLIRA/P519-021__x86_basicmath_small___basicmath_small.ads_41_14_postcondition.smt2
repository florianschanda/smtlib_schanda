...
(assert (=> (and (not (= zeroflag true)) (= (to_int3 signflag) (to_int3 overflowflag))) (= temp___370 rbx)))
(assert (=> (and (not (= zeroflag true)) (= (to_int3 signflag) (to_int3 overflowflag))) (= temp___369 rsp)))
(assert (=> (and (not (= zeroflag true)) (= (to_int3 signflag) (to_int3 overflowflag))) (= temp___368 overflowflag)))
(assert (=> (and (not (= zeroflag true)) (= (to_int3 signflag) (to_int3 overflowflag))) (= temp___367 signflag)))
(assert (=> (and (not (= zeroflag true)) (= (to_int3 signflag) (to_int3 overflowflag))) (= temp___366 rax)))
(assert (=> (and (not (= zeroflag true)) (= (to_int3 signflag) (to_int3 overflowflag))) (= temp___364 carryflag)))
(assert (=> (and (not (= zeroflag true)) (= (to_int3 signflag) (to_int3 overflowflag))) (= temp___365 xmm0)))
(assert (=> (and (not (= zeroflag true)) (= (to_int3 signflag) (to_int3 overflowflag))) (= temp___363 rbp)))
(assert (=> (and (not (= zeroflag true)) (= (to_int3 signflag) (to_int3 overflowflag))) (= temp___362 rdi)))
(assert (=> (and (not (= zeroflag true)) (= (to_int3 signflag) (to_int3 overflowflag))) (= temp___371 rsp)))
(assert (=> (and (not (= zeroflag true)) (= (to_int3 signflag) (to_int3 overflowflag))) (= temp___361 zeroflag)))
(assert (=> (and (not (= zeroflag true)) (= (to_int3 signflag) (to_int3 overflowflag))) (= rsp2 temp___371)))
