...
(assert (and (and (and (= us (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 number)))) (in_range2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 number))))) (and (and (= (mk_int__ref result) (mk_int__ref digit_index)) (= digit_index1 1)) (and (in_range2 digit_index1) (and (and (and (= (mk_int__ref result1) (mk_int__ref i)) (= i2 1)) (ite (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (and (and (and (= temp___1198 i2) (and (= temp___1197 digit_index1) (and (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= o i2)) (= o1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) o))) (= o2 (to_rep1 o1))) (= o3 (ite (= o2 ((_ int2bv 8) 0)) true false))) (= result2 (ite (not (= o3 true)) true false))) (ite (= result2 true) (and (= digit_index1 result3) (= digit_index2 i2)) (= digit_index2 digit_index1))) (and (and (or (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) digit_index3)) ((_ int2bv 8) 0))) (exists ((j2 Int)) (and (and (<= (+ i3 1) j2) (<= j2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j2)) ((_ int2bv 8) 0)))))) (=> (< digit_index3 i3) (forall ((j2 Int)) (=> (and (<= (+ digit_index3 1) j2) (<= j2 i3)) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j2)) ((_ int2bv 8) 0)))))) (and (and (and (=> (<= 1 2147483647) (in_range2 digit_index3)) (=> (<= 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))) (dynamic_property2 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i3))) (and (<= 1 i3) (<= i3 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))) (= i3 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))))) (and (and (= i3 i5) (= digit_index3 digit_index5)) (and (= i6 i3) (= digit_index6 digit_index3)))) (and (and (= (mk_int__ref i7) (mk_int__ref i5)) (= (mk_int__ref digit_index7) (mk_int__ref digit_index5))) (and (= i8 i6) (= digit_index8 digit_index6)))) (and (and (= i2 i7) (= digit_index1 digit_index7)) (and (= i8 i2) (= digit_index8 digit_index1))))) (and (and (= very_longs__divide__get_msd__result1 very_longs__divide__get_msd__result2) (= very_longs__divide__get_msd__result3 very_longs__divide__get_msd__result1)) (and (= (mk_int__ref result9) (mk_int__ref very_longs__divide__get_msd__result)) (= very_longs__divide__get_msd__result1 digit_index7))))))) (and (and (= (mk_int__ref very_longs__divide__get_msd__result4) (mk_int__ref very_longs__divide__get_msd__result2)) (and (= (mk_int__ref i9) (mk_int__ref i7)) (= (mk_int__ref digit_index9) (mk_int__ref digit_index7)))) (and (= very_longs__divide__get_msd__result5 very_longs__divide__get_msd__result3) (and (= i10 i8) (= digit_index10 digit_index8))))))
(assert (= result11 very_longs__divide__get_msd__result4))
