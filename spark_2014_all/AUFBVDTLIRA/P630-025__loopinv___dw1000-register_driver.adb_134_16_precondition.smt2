...
(define-fun in_range ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x3F)))
...
(define-fun dynamic_invariant ((temp___expr_271 (_ BitVec 8)) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool) (temp___do_typ_inv_270 Bool)) Bool (=> (or (= temp___is_init_267 true) (bvule #x00 #x3F)) (in_range temp___expr_271)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x40))) (=> (in_range y) (= (to_rep (of_rep x)) y))) :pattern ((to_rep (of_rep x))))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x80))) (=> (in_range1 y) (= (to_rep1 (of_rep1 x)) y))) :pattern ((to_rep1 (of_rep1 x))))))
...
(define-fun in_range2 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x7FFF)))
...
(define-fun dynamic_invariant1 ((temp___expr_334 (_ BitVec 16)) (temp___is_init_330 Bool) (temp___skip_constant_331 Bool) (temp___do_toplevel_332 Bool) (temp___do_typ_inv_333 Bool)) Bool (=> (or (= temp___is_init_330 true) (bvule #x0000 #x7FFF)) (in_range2 temp___expr_334)))
...
(define-fun bool_eq ((a (Array Int bits_8)) (a__first Int) (a__last Int) (b (Array Int bits_8)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep2 (select a temp___idx_154)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(define-fun dynamic_invariant2 ((temp___expr_684 us_t) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool) (temp___do_typ_inv_683 Bool)) Bool (=> (not (= temp___skip_constant_681 true)) (dynamic_property 0 2147483647 (first1 temp___expr_684) (last1 temp___expr_684))))
...
(define-fun dynamic_invariant3 ((temp___expr_716 us_rep) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool) (temp___do_typ_inv_715 Bool)) Bool (=> (= temp___do_toplevel_714 true) (=> (= temp___is_init_712 true) (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___expr_716))) 0))))
(define-fun default_initial_assumption ((temp___expr_718 us_rep) (temp___skip_top_level_719 Bool)) Bool (and (and (= (to_rep (rec__dw1000__register_driver__non_indexed_header__register_id (us_split_fields1 temp___expr_718))) #x00) (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___expr_718))) 0)) (= (to_rep4 (rec__dw1000__register_driver__non_indexed_header__operation (us_split_fields1 temp___expr_718))) 0)))
(define-fun dynamic_predicate ((temp___720 us_rep)) Bool (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___720))) 0))
...
(define-fun dynamic_invariant4 ((temp___expr_726 us_rep1) (temp___is_init_722 Bool) (temp___skip_constant_723 Bool) (temp___do_toplevel_724 Bool) (temp___do_typ_inv_725 Bool)) Bool (=> (= temp___do_toplevel_724 true) (=> (= temp___is_init_722 true) (and (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___expr_726))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___expr_726))) 0)))))
(define-fun default_initial_assumption1 ((temp___expr_728 us_rep1) (temp___skip_top_level_729 Bool)) Bool (and (and (and (and (= (to_rep (rec__dw1000__register_driver__short_indexed_header__register_id (us_split_fields3 temp___expr_728))) #x00) (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___expr_728))) 1)) (= (to_rep4 (rec__dw1000__register_driver__short_indexed_header__operation (us_split_fields3 temp___expr_728))) 0)) (= (to_rep1 (rec__dw1000__register_driver__short_indexed_header__register_sub_address (us_split_fields3 temp___expr_728))) #x00)) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___expr_728))) 0)))
(define-fun dynamic_predicate1 ((temp___730 us_rep1)) Bool (and (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___730))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___730))) 0)))
...
(define-fun dynamic_invariant5 ((temp___expr_736 us_rep2) (temp___is_init_732 Bool) (temp___skip_constant_733 Bool) (temp___do_toplevel_734 Bool) (temp___do_typ_inv_735 Bool)) Bool (=> (= temp___do_toplevel_734 true) (=> (= temp___is_init_732 true) (and (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___expr_736))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___expr_736))) 1)))))
(define-fun default_initial_assumption2 ((temp___expr_738 us_rep2) (temp___skip_top_level_739 Bool)) Bool (and (and (and (and (and (= (to_rep (rec__dw1000__register_driver__long_indexed_header__register_id (us_split_fields5 temp___expr_738))) #x00) (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___expr_738))) 1)) (= (to_rep4 (rec__dw1000__register_driver__long_indexed_header__operation (us_split_fields5 temp___expr_738))) 0)) (= (to_rep1 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_lsb (us_split_fields5 temp___expr_738))) #x00)) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___expr_738))) 1)) (= (to_rep2 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_msb (us_split_fields5 temp___expr_738))) #x00)))
(define-fun dynamic_predicate2 ((temp___740 us_rep2)) Bool (and (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___740))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___740))) 1)))
...
(define-fun dynamic_invariant6 ((temp___expr_779 us_rep) (temp___is_init_775 Bool) (temp___skip_constant_776 Bool) (temp___do_toplevel_777 Bool) (temp___do_typ_inv_778 Bool)) Bool (=> (= temp___do_toplevel_777 true) (=> (= temp___is_init_775 true) (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___expr_779))) 0))))
(define-fun default_initial_assumption3 ((temp___expr_781 us_rep) (temp___skip_top_level_782 Bool)) Bool (and (and (= (to_rep (rec__dw1000__register_driver__non_indexed_header__register_id (us_split_fields1 temp___expr_781))) #x00) (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___expr_781))) 0)) (= (to_rep4 (rec__dw1000__register_driver__non_indexed_header__operation (us_split_fields1 temp___expr_781))) 0)))
(define-fun dynamic_predicate3 ((temp___783 us_rep)) Bool (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___783))) 0))
(assert true)
...
(define-fun dynamic_invariant7 ((temp___expr_801 us_rep1) (temp___is_init_797 Bool) (temp___skip_constant_798 Bool) (temp___do_toplevel_799 Bool) (temp___do_typ_inv_800 Bool)) Bool (=> (= temp___do_toplevel_799 true) (=> (= temp___is_init_797 true) (and (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___expr_801))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___expr_801))) 0)))))
(define-fun default_initial_assumption4 ((temp___expr_803 us_rep1) (temp___skip_top_level_804 Bool)) Bool (and (and (and (and (= (to_rep (rec__dw1000__register_driver__short_indexed_header__register_id (us_split_fields3 temp___expr_803))) #x00) (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___expr_803))) 1)) (= (to_rep4 (rec__dw1000__register_driver__short_indexed_header__operation (us_split_fields3 temp___expr_803))) 0)) (= (to_rep1 (rec__dw1000__register_driver__short_indexed_header__register_sub_address (us_split_fields3 temp___expr_803))) #x00)) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___expr_803))) 0)))
(define-fun dynamic_predicate4 ((temp___805 us_rep1)) Bool (and (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___805))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___805))) 0)))
(assert true)
...
(define-fun dynamic_invariant8 ((temp___expr_823 us_rep2) (temp___is_init_819 Bool) (temp___skip_constant_820 Bool) (temp___do_toplevel_821 Bool) (temp___do_typ_inv_822 Bool)) Bool (=> (= temp___do_toplevel_821 true) (=> (= temp___is_init_819 true) (and (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___expr_823))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___expr_823))) 1)))))
(define-fun default_initial_assumption5 ((temp___expr_825 us_rep2) (temp___skip_top_level_826 Bool)) Bool (and (and (and (and (and (= (to_rep (rec__dw1000__register_driver__long_indexed_header__register_id (us_split_fields5 temp___expr_825))) #x00) (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___expr_825))) 1)) (= (to_rep4 (rec__dw1000__register_driver__long_indexed_header__operation (us_split_fields5 temp___expr_825))) 0)) (= (to_rep1 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_lsb (us_split_fields5 temp___expr_825))) #x00)) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___expr_825))) 1)) (= (to_rep2 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_msb (us_split_fields5 temp___expr_825))) #x00)))
(define-fun dynamic_predicate5 ((temp___827 us_rep2)) Bool (and (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___827))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___827))) 1)))
(assert true)
...
(define-fun dynamic_invariant9 ((temp___expr_39 Int) (temp___is_init_35 Bool) (temp___skip_constant_36 Bool) (temp___do_toplevel_37 Bool) (temp___do_typ_inv_38 Bool)) Bool (=> (or (= temp___is_init_35 true) (<= 0 2147483647)) (in_range4 temp___expr_39)))
(define-fun dynamic_invariant10 ((temp___expr_18 Int) (temp___is_init_14 Bool) (temp___skip_constant_15 Bool) (temp___do_toplevel_16 Bool) (temp___do_typ_inv_17 Bool)) Bool (=> (or (= temp___is_init_14 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_18)))
...
(assert (= header2 (mk___rep2 (mk___split_fields2 (of_rep register_id) (of_rep5 1) (of_rep4 1) (of_rep1 ((_ extract 7 0) (bvand sub_address #x007F))) (of_rep6 1) (of_rep2 ((_ extract 7 0) (bvudiv sub_address #x0080)))))))
(define-fun dynamic_invariant11 ((temp___expr_695 Int) (temp___is_init_691 Bool) (temp___skip_constant_692 Bool) (temp___do_toplevel_693 Bool) (temp___do_typ_inv_694 Bool)) Bool (=> (or (= temp___is_init_691 true) (<= 0 1)) (in_range5 temp___expr_695)))
(define-fun dynamic_invariant12 ((temp___expr_702 Int) (temp___is_init_698 Bool) (temp___skip_constant_699 Bool) (temp___do_toplevel_700 Bool) (temp___do_typ_inv_701 Bool)) Bool (=> (or (= temp___is_init_698 true) (<= 0 1)) (in_range6 temp___expr_702)))
(define-fun dynamic_invariant13 ((temp___expr_709 Int) (temp___is_init_705 Bool) (temp___skip_constant_706 Bool) (temp___do_toplevel_707 Bool) (temp___do_typ_inv_708 Bool)) Bool (=> (or (= temp___is_init_705 true) (<= 0 1)) (in_range7 temp___expr_709)))
(define-fun dynamic_invariant14 ((temp___expr_278 (_ BitVec 8)) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool (=> (or (= temp___is_init_274 true) (bvule #x00 #x7F)) (in_range1 temp___expr_278)))
(define-fun dynamic_invariant15 ((temp___expr_285 (_ BitVec 8)) (temp___is_init_281 Bool) (temp___skip_constant_282 Bool) (temp___do_toplevel_283 Bool) (temp___do_typ_inv_284 Bool)) Bool true)
...
(declare-const temp___870 bits_6)
(declare-const temp___8701 sub_index_type)
(declare-const temp___8702 operation_type)
(declare-const temp___8703 bits_7)
(declare-const temp___8704 extended_address_type)
(declare-const temp___8705 bits_8)
...
(assert (= (to_rep2 o) ((_ extract 7 0) (bvudiv sub_address #x0080))))
(assert (= (to_rep6 o1) 1))
(assert (= (to_rep1 o2) ((_ extract 7 0) (bvand sub_address #x007F))))
(assert (= (to_rep4 o3) 1))
(assert (= (to_rep5 o4) 1))
...
(assert (= o1 o10))
(assert (= o o11))
(assert (= temp___870 o6))
(assert (= temp___8701 o7))
(assert (= temp___8702 o8))
(assert (= temp___8703 o9))
(assert (= temp___8704 o10))
(assert (= temp___8705 o11))
(assert (and (= (to_rep5 temp___8701) 1) (= (to_rep6 temp___8704) 1)))
(assert (= dw1000__register_driver__write_register__B_6__header__assume6 (mk___rep2 (mk___split_fields2 temp___870 temp___8701 temp___8702 temp___8703 temp___8704 temp___8705))))
(assert (= dw1000__register_driver__write_register__B_6__header__assume6 header2))
(assert (let ((temp___737 header2)) (and (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___737))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___737))) 1))))
(assert (let ((temp___828 header2)) (and (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___828))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___828))) 1))))
(assert (= o12 header2))
