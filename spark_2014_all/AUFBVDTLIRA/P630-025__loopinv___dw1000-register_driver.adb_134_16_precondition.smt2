...
(define-fun dynamic_invariant5 ((temp___expr_684 us_t) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool) (temp___do_typ_inv_683 Bool)) Bool (=> (not (= temp___skip_constant_681 true)) (dynamic_property 0 2147483647 (first1 temp___expr_684) (last1 temp___expr_684))))
(define-fun dynamic_invariant6 ((temp___expr_716 us_rep) (temp___is_init_712 Bool) (temp___skip_constant_713 Bool) (temp___do_toplevel_714 Bool) (temp___do_typ_inv_715 Bool)) Bool (=> (= temp___do_toplevel_714 true) (=> (= temp___is_init_712 true) (= (to_rep4 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___expr_716))) 0))))
...
(assert (= header (mk___rep (mk___split_fields (of_rep2 register_id) (of_rep4 0) (of_rep3 1)))))
(assert (= header1 (mk___rep1 (mk___split_fields1 (of_rep2 register_id) (of_rep4 1) (of_rep3 1) (of_rep5 ((_ extract 7 0) sub_address)) (of_rep6 0)))))
(assert (= header2 (mk___rep2 (mk___split_fields2 (of_rep2 register_id) (of_rep4 1) (of_rep3 1) (of_rep5 ((_ extract 7 0) (bvand sub_address #x007F))) (of_rep6 1) (of_rep1 ((_ extract 7 0) (bvudiv sub_address #x0080)))))))
(define-fun dynamic_invariant11 ((temp___expr_695 Int) (temp___is_init_691 Bool) (temp___skip_constant_692 Bool) (temp___do_toplevel_693 Bool) (temp___do_typ_inv_694 Bool)) Bool (=> (or (= temp___is_init_691 true) (<= 0 1)) (in_range3 temp___expr_695)))
(define-fun dynamic_invariant12 ((temp___expr_702 Int) (temp___is_init_698 Bool) (temp___skip_constant_699 Bool) (temp___do_toplevel_700 Bool) (temp___do_typ_inv_701 Bool)) Bool (=> (or (= temp___is_init_698 true) (<= 0 1)) (in_range4 temp___expr_702)))
(define-fun dynamic_invariant13 ((temp___expr_709 Int) (temp___is_init_705 Bool) (temp___skip_constant_706 Bool) (temp___do_toplevel_707 Bool) (temp___do_typ_inv_708 Bool)) Bool (=> (or (= temp___is_init_705 true) (<= 0 1)) (in_range6 temp___expr_709)))
(define-fun dynamic_invariant14 ((temp___expr_278 (_ BitVec 8)) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool (=> (or (= temp___is_init_274 true) (bvule #x00 #x7F)) (in_range5 temp___expr_278)))
...
(assert (and (= (to_rep4 temp___8701) 1) (= (to_rep6 temp___8704) 1)))
...
(assert (let ((temp___828 header2)) (and (= (to_rep4 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___828))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___828))) 1))))
(assert (= o12 header2))
(assert (= o13 (to_bytes2 o12)))
(assert (= o14 (mk___t o13 (mk 1 3))))
(assert (not (<= (length o14) 3)))
(check-sat)
(exit)
