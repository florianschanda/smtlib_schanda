...
(define-fun in_range ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 63))))
...
(define-fun dynamic_invariant ((temp___expr_232 (_ BitVec 8)) (temp___is_init_229 Bool) (temp___skip_constant_230 Bool) (temp___do_toplevel_231 Bool)) Bool (=> (or (= temp___is_init_229 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 63))) (in_range temp___expr_232)))
(declare-fun to_rep (bits_6) (_ BitVec 8))
(declare-fun of_rep ((_ BitVec 8)) bits_6)
(assert (forall ((x bits_6)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x bits_6)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 64)))) (=> (in_range y) (= (to_rep (of_rep x)) y))) :pattern ((to_rep (of_rep x))))))
(define-fun to_int3 ((x bits_6)) Int (bv2nat (to_rep x)))
(assert (forall ((x bits_6)) (! (in_range_int (to_int3 x)) :pattern ((to_int3 x)))))
(declare-sort bits_7 0)
(define-fun in_range1 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 127))))
(define-fun in_range_int1 ((x Int)) Bool (and (<= 0 x) (<= x 127)))
(declare-fun attr__ATTRIBUTE_IMAGE1 ((_ BitVec 8)) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check1 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE1 (us_image) (_ BitVec 8))
(declare-fun user_eq1 (bits_7 bits_7) Bool)
(declare-const dummy1 bits_7)
...
(assert (forall ((x bits_7)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 128)))) (=> (in_range1 y) (= (to_rep1 (of_rep1 x)) y))) :pattern ((to_rep1 (of_rep1 x))))))
...
(define-fun in_range2 ((x (_ BitVec 16))) Bool (and (bvule ((_ int2bv 16) 0) x) (bvule x ((_ int2bv 16) 32767))))
...
(define-fun dynamic_invariant1 ((temp___expr_286 (_ BitVec 16)) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool)) Bool (=> (or (= temp___is_init_283 true) (bvule ((_ int2bv 16) 0) ((_ int2bv 16) 32767))) (in_range2 temp___expr_286)))
...
(define-fun dynamic_invariant2 ((temp___expr_586 us_t) (temp___is_init_583 Bool) (temp___skip_constant_584 Bool) (temp___do_toplevel_585 Bool)) Bool (=> (not (= temp___skip_constant_584 true)) (dynamic_property 0 2147483647 (first1 temp___expr_586) (last1 temp___expr_586))))
...
(assert (forall ((x operation_type)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x operation_type)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(assert (forall ((x sub_index_type)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x sub_index_type)) (! (in_range6 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x extended_address_type)) (! (in_range7 (to_rep6 x)) :pattern ((to_rep6 x)))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep (rec__dw1000__register_driver__non_indexed_header__register_id (us_split_fields1 a))) (to_rep (rec__dw1000__register_driver__non_indexed_header__register_id (us_split_fields1 b)))) (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 a))) (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 b))))) (= (to_rep4 (rec__dw1000__register_driver__non_indexed_header__operation (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_driver__non_indexed_header__operation (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_614 us_rep) (temp___is_init_611 Bool) (temp___skip_constant_612 Bool) (temp___do_toplevel_613 Bool)) Bool (=> (= temp___do_toplevel_613 true) (=> (= temp___is_init_611 true) (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___expr_614))) 0))))
(define-fun default_initial_assumption ((temp___expr_616 us_rep) (temp___skip_top_level_617 Bool)) Bool (and (and (= (to_rep (rec__dw1000__register_driver__non_indexed_header__register_id (us_split_fields1 temp___expr_616))) ((_ int2bv 8) 0)) (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___expr_616))) 0)) (= (to_rep4 (rec__dw1000__register_driver__non_indexed_header__operation (us_split_fields1 temp___expr_616))) 0)))
(define-fun dynamic_predicate ((temp___618 us_rep)) Bool (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___618))) 0))
...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (and (= (to_rep (rec__dw1000__register_driver__short_indexed_header__register_id (us_split_fields3 a))) (to_rep (rec__dw1000__register_driver__short_indexed_header__register_id (us_split_fields3 b)))) (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 a))) (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 b))))) (= (to_rep4 (rec__dw1000__register_driver__short_indexed_header__operation (us_split_fields3 a))) (to_rep4 (rec__dw1000__register_driver__short_indexed_header__operation (us_split_fields3 b))))) (= (to_rep1 (rec__dw1000__register_driver__short_indexed_header__register_sub_address (us_split_fields3 a))) (to_rep1 (rec__dw1000__register_driver__short_indexed_header__register_sub_address (us_split_fields3 b))))) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 a))) (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 b))))) true false))
...
(define-fun dynamic_invariant4 ((temp___expr_623 us_rep1) (temp___is_init_620 Bool) (temp___skip_constant_621 Bool) (temp___do_toplevel_622 Bool)) Bool (=> (= temp___do_toplevel_622 true) (=> (= temp___is_init_620 true) (and (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___expr_623))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___expr_623))) 0)))))
(define-fun default_initial_assumption1 ((temp___expr_625 us_rep1) (temp___skip_top_level_626 Bool)) Bool (and (and (and (and (= (to_rep (rec__dw1000__register_driver__short_indexed_header__register_id (us_split_fields3 temp___expr_625))) ((_ int2bv 8) 0)) (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___expr_625))) 1)) (= (to_rep4 (rec__dw1000__register_driver__short_indexed_header__operation (us_split_fields3 temp___expr_625))) 0)) (= (to_rep1 (rec__dw1000__register_driver__short_indexed_header__register_sub_address (us_split_fields3 temp___expr_625))) ((_ int2bv 8) 0))) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___expr_625))) 0)))
(define-fun dynamic_predicate1 ((temp___627 us_rep1)) Bool (and (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___627))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___627))) 0)))
...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (and (and (= (to_rep (rec__dw1000__register_driver__long_indexed_header__register_id (us_split_fields5 a))) (to_rep (rec__dw1000__register_driver__long_indexed_header__register_id (us_split_fields5 b)))) (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 a))) (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 b))))) (= (to_rep4 (rec__dw1000__register_driver__long_indexed_header__operation (us_split_fields5 a))) (to_rep4 (rec__dw1000__register_driver__long_indexed_header__operation (us_split_fields5 b))))) (= (to_rep1 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_lsb (us_split_fields5 a))) (to_rep1 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_lsb (us_split_fields5 b))))) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 a))) (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 b))))) (= (to_rep2 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_msb (us_split_fields5 a))) (to_rep2 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_msb (us_split_fields5 b))))) true false))
...
(define-fun dynamic_invariant5 ((temp___expr_632 us_rep2) (temp___is_init_629 Bool) (temp___skip_constant_630 Bool) (temp___do_toplevel_631 Bool)) Bool (=> (= temp___do_toplevel_631 true) (=> (= temp___is_init_629 true) (and (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___expr_632))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___expr_632))) 1)))))
(define-fun default_initial_assumption2 ((temp___expr_634 us_rep2) (temp___skip_top_level_635 Bool)) Bool (and (and (and (and (and (= (to_rep (rec__dw1000__register_driver__long_indexed_header__register_id (us_split_fields5 temp___expr_634))) ((_ int2bv 8) 0)) (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___expr_634))) 1)) (= (to_rep4 (rec__dw1000__register_driver__long_indexed_header__operation (us_split_fields5 temp___expr_634))) 0)) (= (to_rep1 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_lsb (us_split_fields5 temp___expr_634))) ((_ int2bv 8) 0))) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___expr_634))) 1)) (= (to_rep2 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_msb (us_split_fields5 temp___expr_634))) ((_ int2bv 8) 0))))
(define-fun dynamic_predicate2 ((temp___636 us_rep2)) Bool (and (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___636))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___636))) 1)))
...
(define-fun dynamic_invariant6 ((temp___expr_671 us_rep) (temp___is_init_668 Bool) (temp___skip_constant_669 Bool) (temp___do_toplevel_670 Bool)) Bool (=> (= temp___do_toplevel_670 true) (=> (= temp___is_init_668 true) (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___expr_671))) 0))))
(define-fun default_initial_assumption3 ((temp___expr_673 us_rep) (temp___skip_top_level_674 Bool)) Bool (and (and (= (to_rep (rec__dw1000__register_driver__non_indexed_header__register_id (us_split_fields1 temp___expr_673))) ((_ int2bv 8) 0)) (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___expr_673))) 0)) (= (to_rep4 (rec__dw1000__register_driver__non_indexed_header__operation (us_split_fields1 temp___expr_673))) 0)))
(define-fun dynamic_predicate3 ((temp___675 us_rep)) Bool (= (to_rep5 (rec__dw1000__register_driver__non_indexed_header__sub_index (us_split_fields1 temp___675))) 0))
(assert true)
...
(define-fun dynamic_invariant7 ((temp___expr_691 us_rep1) (temp___is_init_688 Bool) (temp___skip_constant_689 Bool) (temp___do_toplevel_690 Bool)) Bool (=> (= temp___do_toplevel_690 true) (=> (= temp___is_init_688 true) (and (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___expr_691))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___expr_691))) 0)))))
(define-fun default_initial_assumption4 ((temp___expr_693 us_rep1) (temp___skip_top_level_694 Bool)) Bool (and (and (and (and (= (to_rep (rec__dw1000__register_driver__short_indexed_header__register_id (us_split_fields3 temp___expr_693))) ((_ int2bv 8) 0)) (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___expr_693))) 1)) (= (to_rep4 (rec__dw1000__register_driver__short_indexed_header__operation (us_split_fields3 temp___expr_693))) 0)) (= (to_rep1 (rec__dw1000__register_driver__short_indexed_header__register_sub_address (us_split_fields3 temp___expr_693))) ((_ int2bv 8) 0))) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___expr_693))) 0)))
(define-fun dynamic_predicate4 ((temp___695 us_rep1)) Bool (and (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___695))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___695))) 0)))
(assert true)
...
(define-fun dynamic_invariant8 ((temp___expr_711 us_rep2) (temp___is_init_708 Bool) (temp___skip_constant_709 Bool) (temp___do_toplevel_710 Bool)) Bool (=> (= temp___do_toplevel_710 true) (=> (= temp___is_init_708 true) (and (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___expr_711))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___expr_711))) 1)))))
(define-fun default_initial_assumption5 ((temp___expr_713 us_rep2) (temp___skip_top_level_714 Bool)) Bool (and (and (and (and (and (= (to_rep (rec__dw1000__register_driver__long_indexed_header__register_id (us_split_fields5 temp___expr_713))) ((_ int2bv 8) 0)) (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___expr_713))) 1)) (= (to_rep4 (rec__dw1000__register_driver__long_indexed_header__operation (us_split_fields5 temp___expr_713))) 0)) (= (to_rep1 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_lsb (us_split_fields5 temp___expr_713))) ((_ int2bv 8) 0))) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___expr_713))) 1)) (= (to_rep2 (rec__dw1000__register_driver__long_indexed_header__register_sub_address_msb (us_split_fields5 temp___expr_713))) ((_ int2bv 8) 0))))
(define-fun dynamic_predicate5 ((temp___715 us_rep2)) Bool (and (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___715))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___715))) 1)))
(assert true)
...
(define-fun dynamic_invariant9 ((temp___expr_33 Int) (temp___is_init_30 Bool) (temp___skip_constant_31 Bool) (temp___do_toplevel_32 Bool)) Bool (=> (or (= temp___is_init_30 true) (<= 0 2147483647)) (in_range4 temp___expr_33)))
(define-fun dynamic_invariant10 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_15)))
(assert (= header (mk___rep (mk___split_fields (of_rep register_id) (of_rep5 0) (of_rep4 1)))))
(assert (= header1 (mk___rep1 (mk___split_fields1 (of_rep register_id) (of_rep5 1) (of_rep4 1) (of_rep1 ((_ extract 7 0) sub_address)) (of_rep6 0)))))
(assert (= header2 (mk___rep2 (mk___split_fields2 (of_rep register_id) (of_rep5 1) (of_rep4 1) (of_rep1 ((_ extract 7 0) (bvand sub_address ((_ int2bv 16) 127)))) (of_rep6 1) (of_rep2 ((_ extract 7 0) (bvudiv sub_address ((_ int2bv 16) 128))))))))
(define-fun dynamic_invariant11 ((temp___expr_596 Int) (temp___is_init_593 Bool) (temp___skip_constant_594 Bool) (temp___do_toplevel_595 Bool)) Bool (=> (or (= temp___is_init_593 true) (<= 0 1)) (in_range5 temp___expr_596)))
(define-fun dynamic_invariant12 ((temp___expr_602 Int) (temp___is_init_599 Bool) (temp___skip_constant_600 Bool) (temp___do_toplevel_601 Bool)) Bool (=> (or (= temp___is_init_599 true) (<= 0 1)) (in_range6 temp___expr_602)))
(define-fun dynamic_invariant13 ((temp___expr_608 Int) (temp___is_init_605 Bool) (temp___skip_constant_606 Bool) (temp___do_toplevel_607 Bool)) Bool (=> (or (= temp___is_init_605 true) (<= 0 1)) (in_range7 temp___expr_608)))
(define-fun dynamic_invariant14 ((temp___expr_238 (_ BitVec 8)) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool)) Bool (=> (or (= temp___is_init_235 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 127))) (in_range1 temp___expr_238)))
(define-fun dynamic_invariant15 ((temp___expr_244 (_ BitVec 8)) (temp___is_init_241 Bool) (temp___skip_constant_242 Bool) (temp___do_toplevel_243 Bool)) Bool true)
(declare-const o operation_type)
(declare-const o1 sub_index_type)
(declare-const o2 bits_6)
(declare-const o3 bits_6)
(declare-const o4 sub_index_type)
(declare-const o5 operation_type)
(declare-const temp___759 bits_6)
(declare-const temp___7591 sub_index_type)
(declare-const temp___7592 operation_type)
(declare-const dw1000__register_driver__write_register__B_4__header__assume bits_6)
(declare-const dw1000__register_driver__write_register__B_4__header__assume1 sub_index_type)
(declare-const dw1000__register_driver__write_register__B_4__header__assume2 operation_type)
(declare-const o6 bits_6)
(declare-const o7 sub_index_type)
(declare-const o8 operation_type)
(declare-const o9 (Array Int bits_8))
(declare-const o10 (Array Int bits_8))
(declare-const o11 t)
(declare-const o12 extended_address_type)
(declare-const o13 bits_7)
(declare-const o14 operation_type)
(declare-const o15 sub_index_type)
(declare-const o16 bits_6)
(declare-const o17 bits_6)
(declare-const o18 sub_index_type)
(declare-const o19 operation_type)
(declare-const o20 bits_7)
(declare-const o21 extended_address_type)
(declare-const temp___757 bits_6)
(declare-const temp___7571 sub_index_type)
(declare-const temp___7572 operation_type)
(declare-const temp___7573 bits_7)
(declare-const temp___7574 extended_address_type)
(declare-const dw1000__register_driver__write_register__B_5__header__assume bits_6)
(declare-const dw1000__register_driver__write_register__B_5__header__assume1 sub_index_type)
(declare-const dw1000__register_driver__write_register__B_5__header__assume2 operation_type)
(declare-const dw1000__register_driver__write_register__B_5__header__assume3 bits_7)
(declare-const dw1000__register_driver__write_register__B_5__header__assume4 extended_address_type)
(declare-const o22 bits_6)
(declare-const o23 sub_index_type)
(declare-const o24 operation_type)
(declare-const o25 bits_7)
(declare-const o26 extended_address_type)
(declare-const o27 (Array Int bits_8))
(declare-const o28 (Array Int bits_8))
(declare-const o29 t)
(declare-const o30 bits_8)
(declare-const o31 extended_address_type)
(declare-const o32 bits_7)
(declare-const o33 operation_type)
(declare-const o34 sub_index_type)
(declare-const o35 bits_6)
(declare-const o36 bits_6)
(declare-const o37 sub_index_type)
(declare-const o38 operation_type)
(declare-const o39 bits_7)
(declare-const o40 extended_address_type)
(declare-const o41 bits_8)
(declare-const temp___755 bits_6)
(declare-const temp___7551 sub_index_type)
(declare-const temp___7552 operation_type)
(declare-const temp___7553 bits_7)
(declare-const temp___7554 extended_address_type)
(declare-const temp___7555 bits_8)
(declare-const dw1000__register_driver__write_register__B_6__header__assume bits_6)
(declare-const dw1000__register_driver__write_register__B_6__header__assume1 sub_index_type)
(declare-const dw1000__register_driver__write_register__B_6__header__assume2 operation_type)
(declare-const dw1000__register_driver__write_register__B_6__header__assume3 bits_7)
(declare-const dw1000__register_driver__write_register__B_6__header__assume4 extended_address_type)
(declare-const dw1000__register_driver__write_register__B_6__header__assume5 bits_8)
(declare-const o42 us_rep2)
(declare-const o43 (Array Int bits_8))
...
(assert (= (to_rep2 o30) ((_ extract 7 0) (bvudiv sub_address ((_ int2bv 16) 128)))))
(assert (= (to_rep6 o31) 1))
(assert (= (to_rep1 o32) ((_ extract 7 0) (bvand sub_address ((_ int2bv 16) 127)))))
(assert (= (to_rep4 o33) 1))
(assert (= (to_rep5 o34) 1))
(assert (= (to_rep o35) register_id))
(assert (= o35 o36))
(assert (= o34 o37))
(assert (= o33 o38))
(assert (= o32 o39))
(assert (= o31 o40))
(assert (= o30 o41))
(assert (= temp___755 o36))
(assert (= temp___7551 o37))
(assert (= temp___7552 o38))
(assert (= temp___7553 o39))
(assert (= temp___7554 o40))
(assert (= temp___7555 o41))
(assert (and (= (to_rep5 temp___7551) 1) (= (to_rep6 temp___7554) 1)))
(assert (= (mk___rep2 (mk___split_fields2 dw1000__register_driver__write_register__B_6__header__assume dw1000__register_driver__write_register__B_6__header__assume1 dw1000__register_driver__write_register__B_6__header__assume2 dw1000__register_driver__write_register__B_6__header__assume3 dw1000__register_driver__write_register__B_6__header__assume4 dw1000__register_driver__write_register__B_6__header__assume5)) (mk___rep2 (mk___split_fields2 temp___755 temp___7551 temp___7552 temp___7553 temp___7554 temp___7555))))
(assert (= (mk___rep2 (mk___split_fields2 dw1000__register_driver__write_register__B_6__header__assume dw1000__register_driver__write_register__B_6__header__assume1 dw1000__register_driver__write_register__B_6__header__assume2 dw1000__register_driver__write_register__B_6__header__assume3 dw1000__register_driver__write_register__B_6__header__assume4 dw1000__register_driver__write_register__B_6__header__assume5)) header2))
(assert (let ((temp___633 header2)) (and (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___633))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___633))) 1))))
(assert (let ((temp___716 header2)) (and (= (to_rep5 (rec__dw1000__register_driver__long_indexed_header__sub_index (us_split_fields5 temp___716))) 1) (= (to_rep6 (rec__dw1000__register_driver__long_indexed_header__extended_address (us_split_fields5 temp___716))) 1))))
(assert (= o42 header2))
(assert (= o43 (to_bytes2 o42)))
(assert (= o44 (mk___t o43 (mk 1 3))))
(assert (not (<= 1 (length o44))))
(check-sat)
(exit)
