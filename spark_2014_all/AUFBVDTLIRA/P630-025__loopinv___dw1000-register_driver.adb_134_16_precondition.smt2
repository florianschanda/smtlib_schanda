...
(assert (= (to_rep2 o) ((_ extract 7 0) (bvudiv sub_address ((_ int2bv 16) 128)))))
(assert (= (to_rep6 o1) 1))
(assert (= (to_rep1 o2) ((_ extract 7 0) (bvand sub_address ((_ int2bv 16) 127)))))
(assert (= (to_rep4 o3) 1))
(assert (= (to_rep5 o4) 1))
(assert (= (to_rep o5) register_id))
(assert (= o5 o6))
(assert (= o4 o7))
(assert (= o3 o8))
(assert (= o2 o9))
(assert (= o1 o10))
(assert (= o o11))
(assert (= temp___755 o6))
(assert (= temp___7551 o7))
(assert (= temp___7552 o8))
(assert (= temp___7553 o9))
(assert (= temp___7554 o10))
(assert (= temp___7555 o11))
(assert (and (= (to_rep5 temp___7551) 1) (= (to_rep6 temp___7554) 1)))
(assert (= dw1000__register_driver__write_register__B_6__header__assume6 (mk___rep2 (mk___split_fields2 temp___755 temp___7551 temp___7552 temp___7553 temp___7554 temp___7555))))
(assert (= dw1000__register_driver__write_register__B_6__header__assume6 header2))
