...
(declare-const temp___566 (Array Int word32))
(declare-const temp___564 Int)
(declare-const temp___562 (Array Int word32))
(declare-const temp___558 (Array Int word32))
(declare-const k Int)
...
(declare-const o35 word32)
(declare-const o36 (_ BitVec 32))
(declare-const o37 word32)
...
(declare-const o63 word32)
(declare-const o64 Int)
(declare-const o65 word32)
...
(declare-const o84 word32)
(declare-const o85 Int)
(declare-const o86 word32)
...
(declare-const b3 (Array Int word32))
(declare-const result4 Bool)
(declare-const result5 Bool)
(declare-const result6 Int)
(declare-const i3 Int)
(declare-const b4 (Array Int word32))
(declare-const i4 Int)
(declare-const b5 (Array Int word32))
(declare-const i5 Int)
(declare-const b6 (Array Int word32))
(declare-const i6 Int)
(declare-const b7 (Array Int word32))
(declare-const i7 Int)
(declare-const b8 (Array Int word32))
(declare-const i8 Int)
(declare-const b9 (Array Int word32))
(declare-const i9 Int)
(declare-const b10 (Array Int word32))
(declare-const i10 Int)
(declare-const b11 (Array Int word32))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (forall ((k3 Int)) (=> (and (<= (to_rep b__first) k3) (<= k3 (to_rep b__last))) (and (=> (and (<= b_first k3) (<= k3 (- (- (+ b_first i2) a_first) 1))) (= (to_rep1 (select b2 k3)) (to_rep1 (select (elts a) (- (+ a_first k3) b_first))))) (=> (=> (<= b_first k3) (not (<= k3 (- (- (+ b_first i2) a_first) 1)))) (= (to_rep1 (select b2 k3)) (to_rep1 (select b k3))))))))
...
(assert (= o34 i2))
(assert (= o35 (select (elts a) o34)))
(assert (= o36 (to_rep1 o35)))
(assert (= (to_rep1 o37) o36))
(assert (and (= o32 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (= o33 (+ b_first o32)))
(assert (and (= temp___556 o33) (in_range1 o33)))
(assert (and (<= (to_rep b__first) temp___556) (<= temp___556 (to_rep b__last))))
(assert (= o38 temp___556))
(assert (= o39 (store b2 o38 o37)))
(assert (= b2 result3))
(assert (= b3 o39))
(assert (<= (to_rep b__first) k1))
(assert (<= k1 (to_rep b__last)))
(assert (and (= o53 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o54 (+ b_first o53)))
(assert (and (= o55 o54) (in_range1 o54)))
(assert (= o56 (- o55 a_first)))
(assert (and (= o57 o56) (in_range1 o56)))
(assert (= o58 (- o57 1)))
(assert (and (= o59 o58) (in_range1 o58)))
(assert (= o60 (ite (<= k1 o59) true false)))
(assert (= o61 (ite (<= b_first k1) o60 false)))
(assert (= result4 (ite (not (= o61 true)) true false)))
(assert (=> (= result4 true) (and (<= (to_rep b__first) k1) (<= k1 (to_rep b__last)))))
(assert (=> (= result4 true) (= o64 k1)))
(assert (=> (= result4 true) (= o65 (select b o64))))
(assert (=> (= result4 true) (= o66 (to_rep1 o65))))
(assert (=> (= result4 true) (and (<= (to_rep b__first) k1) (<= k1 (to_rep b__last)))))
(assert (=> (= result4 true) (= o62 k1)))
(assert (=> (= result4 true) (= o63 (select b3 o62))))
(assert (=> (= result4 true) (= o67 (to_rep1 o63))))
(assert (=> (= result4 true) (= o68 (ite (= o67 o66) true false))))
(assert (=> (not (= result4 true)) (= o68 (of_int 1))))
(assert (and (= o40 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o41 (+ b_first o40)))
(assert (and (= o42 o41) (in_range1 o41)))
(assert (= o43 (- o42 a_first)))
(assert (and (= o44 o43) (in_range1 o43)))
(assert (= o45 (- o44 1)))
(assert (and (= o46 o45) (in_range1 o45)))
(assert (= o47 (ite (<= k1 o46) true false)))
(assert (= result5 (ite (<= b_first k1) o47 false)))
(assert (= result5 true))
(assert (and (= o48 (+ a_first k1)) (in_range1 (+ a_first k1))))
(assert (= o49 (- o48 b_first)))
(assert (and (= temp___559 o49) (in_range1 o49)))
(assert (and (<= (to_rep (first (rt a))) temp___559) (<= temp___559 (to_rep (last (rt a))))))
(assert (= o50 temp___559))
(assert (= o51 (select (elts a) o50)))
(assert (= o52 (to_rep1 o51)))
(assert (not (<= (to_rep b__first) k1)))
(check-sat)
(exit)
