...
(assert (= o1 (+ b_first o)))
(assert (and (= temp___626 o1) (in_range1 o1)))
(assert (and (<= (to_rep b__first) temp___626) (<= temp___626 (to_rep b__last))))
(assert (= o6 temp___626))
...
(assert (= o28 (ite (<= k o27) true false)))
(assert (= o29 (ite (<= b_first k) o28 false)))
(assert (= result2 (ite (not (= o29 true)) true false)))
(assert (=> (= result2 true) (and (<= (to_rep b__first) k) (<= k (to_rep b__last)))))
(assert (=> (= result2 true) (= o32 k)))
(assert (=> (= result2 true) (= o33 (select b o32))))
(assert (=> (= result2 true) (= o34 (to_rep1 o33))))
(assert (=> (= result2 true) (and (<= (to_rep b__first) k) (<= k (to_rep b__last)))))
(assert (=> (= result2 true) (= o30 k)))
(assert (=> (= result2 true) (= o31 (select b2 o30))))
(assert (=> (= result2 true) (= o35 (to_rep1 o31))))
(assert (=> (= result2 true) (= o36 (ite (= o35 o34) true false))))
(assert (=> (not (= result2 true)) (= o36 (distinct 1 0))))
...
(assert (= o15 (ite (<= k o14) true false)))
(assert (= result3 (ite (<= b_first k) o15 false)))
(assert (= result3 true))
(assert (and (= o16 (+ a_first k)) (in_range1 (+ a_first k))))
(assert (= o17 (- o16 b_first)))
(assert (and (= temp___629 o17) (in_range1 o17)))
(assert (and (<= (to_rep (first (rt a))) temp___629) (<= temp___629 (to_rep (last (rt a))))))
(assert (= o18 temp___629))
