...
(assert (=> (<= (to_rep2 (first2 (rt1 temp___308))) (to_rep2 (last2 (rt1 temp___308)))) (= o6 (+ (- (to_rep2 (last2 (rt1 temp___308))) (to_rep2 (first2 (rt1 temp___308)))) 1))))
(assert (=> (not (<= (to_rep2 (first2 (rt1 temp___308))) (to_rep2 (last2 (rt1 temp___308))))) (= o6 0)))
(assert (=> (<= (to_rep2 (first2 (rt1 temp___307))) (to_rep2 (last2 (rt1 temp___307)))) (= o7 (+ (- (to_rep2 (last2 (rt1 temp___307))) (to_rep2 (first2 (rt1 temp___307)))) 1))))
(assert (=> (not (<= (to_rep2 (first2 (rt1 temp___307))) (to_rep2 (last2 (rt1 temp___307))))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (to_rep2 (first2 (rt1 temp___307))) o8)))
(assert (= o10 (- o9 1)))
