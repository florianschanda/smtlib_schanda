...
(assert (not (= i3 (bvsub rcx_start rcx))))
(declare-const j (_ BitVec 64))
(assert (bvule #x0000000000000000 j))
(assert (bvule j #x0000000000000007))
(assert (not (= (to_rep (select memory (bvadd (bvadd rdi_start (bvmul i3 #x0000000000000008)) j))) (to_rep (select mem (bvadd (bvadd rdi_start (bvmul i3 #x0000000000000008)) j))))))
(check-sat)
(exit)
