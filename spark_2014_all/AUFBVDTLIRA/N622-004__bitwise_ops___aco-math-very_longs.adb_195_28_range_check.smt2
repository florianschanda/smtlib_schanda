...
(define-fun dynamic_invariant4 ((temp___expr_712 us_rep1) (temp___is_init_708 Bool) (temp___skip_constant_709 Bool) (temp___do_toplevel_710 Bool) (temp___do_typ_inv_711 Bool)) Bool (and (=> (not (= temp___skip_constant_709 true)) (in_range4 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_712))) (and (dynamic_property3 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_712))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_712)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_712))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_712))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_715 us_rep1) (temp___skip_top_level_716 Bool)) Bool (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_715))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
...
(declare-fun temp___1197 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1199 (_ BitVec 8))) (forall ((temp___1200 Int) (temp___1201 Int)) (let ((temp___1198 (temp___1197 temp___1199 temp___1200 temp___1201))) (=> (dynamic_invariant1 temp___1199 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1200 temp___1201) (and (= (first5 temp___1198) temp___1200) (= (last5 temp___1198) temp___1201))) (forall ((temp___1202 Int)) (= (to_rep (select (to_array2 temp___1198) temp___1202)) temp___1199))))))))
