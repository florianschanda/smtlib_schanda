...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___167 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___167) (first3 temp___167) (last3 temp___167))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___166 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___166) (first1 temp___166) (last1 temp___166))))))
...
(define-fun dynamic_invariant4 ((temp___expr_657 us_rep1) (temp___is_init_654 Bool) (temp___skip_constant_655 Bool) (temp___do_toplevel_656 Bool)) Bool (and (=> (not (= temp___skip_constant_655 true)) (in_range4 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_657))) (and (dynamic_property3 1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_657))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_657)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_657))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_657))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_660 us_rep1) (temp___skip_top_level_661 Bool)) Bool (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_660))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))))
...
(declare-fun temp___1112 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___1114 (_ BitVec 8))) (forall ((temp___1115 Int) (temp___1116 Int)) (let ((temp___1113 (temp___1112 temp___1114 temp___1115 temp___1116))) (and (=> (dynamic_property6 1 2147483647 temp___1115 temp___1116) (and (= (first5 temp___1113) temp___1115) (= (last5 temp___1113) temp___1116))) (forall ((temp___1117 Int)) (= (select (to_array2 temp___1113) temp___1117) (of_rep temp___1114))))))))
(define-fun dynamic_invariant5 ((temp___expr_271 Int) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (=> (or (= temp___is_init_268 true) (<= 1 2147483647)) (in_range2 temp___expr_271)))
...
(declare-const temp___1119 (Array Int octet))
(declare-const temp___11191 t2)
(declare-const temp___1120 (Array Int octet))
(declare-const temp___11201 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___1123 digit_index_type)
(declare-const temp___11231 (Array Int octet))
(declare-const temp___11232 t1)
(declare-const temp___1133 us_rep1)
(declare-const temp___1132 (_ BitVec 16))
(declare-const temp___1131 (_ BitVec 16))
(declare-const temp___1130 (_ BitVec 16))
(declare-const temp___1129 (_ BitVec 16))
...
(declare-const temp___1128 us_rep1)
...
(assert (not (in_range2 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(check-sat)
(exit)
