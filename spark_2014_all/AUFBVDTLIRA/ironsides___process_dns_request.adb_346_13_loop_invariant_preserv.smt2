...
(assert (and (= o16 (convertdomainnametowire (rec__rr_type__rrsig_record_type__rrsigrecordtype__signername (us_split_fields3 rrsig_record)))) (forall ((i4 Int)) (=> (and (<= 1 i4) (<= i4 128)) (and (<= 0 (to_rep (select o16 i4))) (<= (to_rep (select o16 i4)) 255))))))
...
(assert (and (= o18 (to_rep (select wireversion1 i2))) (uint_in_range (to_rep (select wireversion1 i2)))))
(assert (= o19 ((_ int2bv 8) o18)))
(assert (= (to_rep1 o20) o19))
(assert (and (<= 1 (+ (- (+ start_byte 24) 1) i2)) (<= (+ (- (+ start_byte 24) 1) i2) 8180)))
(assert (= o21 (+ (- (+ start_byte 24) 1) i2)))
(assert (= o22 (store bytes3 o21 o20)))
(assert (= result5 (mk_map__ref1 bytes3)))
(assert (= bytes4 o22))
(assert (not (= i2 r21b)))
