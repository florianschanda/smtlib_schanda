...
(assert (and (= temp___77072 (register_to_bytes reg)) (dynamic_invariant1 temp___77072 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___77071)) (to_rep (last4 temp___77071))) (+ (- (to_rep (last4 temp___77071)) (to_rep (first4 temp___77071))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7707 temp___7708))
(assert (= (mk1 (to_rep (first4 temp___77071)) (to_rep (last4 temp___77071))) temp___77081))
(assert (= (ite (<= (to_rep (first2 temp___77081)) (to_rep (last2 temp___77081))) (+ (- (to_rep (last2 temp___77081)) (to_rep (first2 temp___77081))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
