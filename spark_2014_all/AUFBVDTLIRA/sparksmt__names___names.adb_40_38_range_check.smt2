...
(define-fun dynamic_invariant1 ((temp___expr_629 us_rep) (temp___is_init_625 Bool) (temp___skip_constant_626 Bool) (temp___do_toplevel_627 Bool) (temp___do_typ_inv_628 Bool)) Bool (=> (not (= temp___skip_constant_626 true)) (in_range2 1024 temp___expr_629)))
(define-fun default_initial_assumption ((temp___expr_631 us_rep) (temp___skip_top_level_632 Bool)) Bool (and (= (to_rep1 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 temp___expr_631))) 1024) (=> (not (= temp___skip_top_level_632 true)) (= (is_empty temp___expr_631) true))))
...
(define-fun dynamic_invariant2 ((temp___expr_639 us_rep1) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (not (= temp___skip_constant_636 true)) (in_range4 256 temp___expr_639)))
(define-fun default_initial_assumption1 ((temp___expr_641 us_rep1) (temp___skip_top_level_642 Bool)) Bool (and (= (to_rep2 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 temp___expr_641))) 256) (=> (not (= temp___skip_top_level_642 true)) (= (is_empty1 temp___expr_641) true))))
...
(assert (forall ((temp___703 Int)) (=> (dynamic_invariant temp___703 true true true true) (forall ((temp___704 (_ BitVec 32))) (= (to_rep (select (names__hash_table__aggregate_def temp___703) temp___704)) temp___703)))))
...
(assert true)
(assert (forall ((names__hash_table (Array (_ BitVec 32) name_id))) (forall ((names__entry_table__fields us_split_fields2)) (! (= (= (valid_hashes names__hash_table names__entry_table__fields) true) (forall ((h (_ BitVec 32))) (=> (and (bvule #x00000000 h) (bvule h #x000000FF)) (<= (to_rep (select names__hash_table h)) (last_index1 (mk___rep1 entry_table__split_discrs names__entry_table__fields)))))) :pattern ((valid_hashes names__hash_table names__entry_table__fields))))))
...
(define-fun dynamic_invariant7 ((temp___expr_332 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool) (temp___do_typ_inv_331 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 0 2147483647)) (in_range1 temp___expr_332)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (distinct 0 0) true) (to_rep1 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(define-fun dynamic_invariant11 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 2147483647)) (in_range3 temp___expr_496)))
(define-fun capacity1 ((container us_rep1)) Int (ite (= (distinct 0 0) true) (to_rep2 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
