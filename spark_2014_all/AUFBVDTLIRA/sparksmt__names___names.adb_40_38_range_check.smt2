...
(define-fun dynamic_invariant ((temp___expr_180 Int) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (or (= temp___is_init_177 true) (<= 0 2147483647)) (in_range temp___expr_180)))
...
(declare-fun to_rep (name_id) Int)
(declare-fun of_rep (Int) name_id)
(assert (forall ((x name_id)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x name_id)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(declare-fun concat1 ((Array (_ BitVec 32) name_id) (_ BitVec 32) (_ BitVec 32) (Array (_ BitVec 32) name_id) (_ BitVec 32) (_ BitVec 32)) (Array (_ BitVec 32) name_id))
(assert (forall ((a (Array (_ BitVec 32) name_id)) (b (Array (_ BitVec 32) name_id))) (forall ((a_first (_ BitVec 32)) (a_last (_ BitVec 32)) (b_first (_ BitVec 32)) (b_last (_ BitVec 32))) (forall ((i (_ BitVec 32))) (! (and (=> (and (bvule a_first i) (bvule i a_last)) (= (select (concat1 a a_first a_last b b_first b_last) i) (select a i))) (=> (bvugt i a_last) (= (select (concat1 a a_first a_last b b_first b_last) i) (select b (bvadd (bvsub i a_last) (bvsub b_first #x00000001)))))) :pattern ((select (concat1 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton1 (name_id (_ BitVec 32)) (Array (_ BitVec 32) name_id))
(assert (forall ((v name_id)) (forall ((i (_ BitVec 32))) (! (= (select (singleton1 v i) i) v) :pattern ((select (singleton1 v i) i))))))
(define-fun bool_eq ((a (Array (_ BitVec 32) name_id)) (a__first (_ BitVec 32)) (a__last (_ BitVec 32)) (b (Array (_ BitVec 32) name_id)) (b__first (_ BitVec 32)) (b__last (_ BitVec 32))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 32))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep (select a temp___idx_132)) (to_rep (select b (bvadd (bvsub b__first a__first) temp___idx_132))))))) true false))
(assert (forall ((a (Array (_ BitVec 32) name_id)) (b (Array (_ BitVec 32) name_id))) (forall ((a__first (_ BitVec 32)) (a__last (_ BitVec 32)) (b__first (_ BitVec 32)) (b__last (_ BitVec 32))) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 32))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep (select a temp___idx_132)) (to_rep (select b (bvadd (bvsub b__first a__first) temp___idx_132)))))))))))
(declare-fun compare ((Array (_ BitVec 32) name_id) (_ BitVec 32) (_ BitVec 32) (Array (_ BitVec 32) name_id) (_ BitVec 32) (_ BitVec 32)) Int)
(assert (forall ((a (Array (_ BitVec 32) name_id)) (b (Array (_ BitVec 32) name_id))) (forall ((a_first (_ BitVec 32)) (a_last (_ BitVec 32)) (b_first (_ BitVec 32)) (b_last (_ BitVec 32))) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 32) name_id)) (b (Array (_ BitVec 32) name_id))) (forall ((a_first (_ BitVec 32)) (a_last (_ BitVec 32)) (b_first (_ BitVec 32)) (b_last (_ BitVec 32))) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 32)) (j (_ BitVec 32))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (< (to_rep (select a (bvadd i #x00000001))) (to_rep (select b (bvadd j #x00000001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 32) name_id)) (b (Array (_ BitVec 32) name_id))) (forall ((a_first (_ BitVec 32)) (a_last (_ BitVec 32)) (b_first (_ BitVec 32)) (b_last (_ BitVec 32))) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 32)) (j (_ BitVec 32))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (< (to_rep (select b (bvadd i #x00000001))) (to_rep (select a (bvadd j #x00000001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun in_range2 ((rec__names__data__char_tables__vector__capacity1 Int) (a us_rep)) Bool (= rec__names__data__char_tables__vector__capacity1 (to_rep1 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant1 ((temp___expr_569 us_rep) (temp___is_init_566 Bool) (temp___skip_constant_567 Bool) (temp___do_toplevel_568 Bool)) Bool (=> (not (= temp___skip_constant_567 true)) (in_range2 1024 temp___expr_569)))
(define-fun default_initial_assumption ((temp___expr_571 us_rep) (temp___skip_top_level_572 Bool)) Bool (and (= (to_rep1 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 temp___expr_571))) 1024) (=> (not (= temp___skip_top_level_572 true)) (= (is_empty temp___expr_571) true))))
...
(define-fun in_range4 ((rec__names__data__entry_tables__vector__capacity1 Int) (a us_rep1)) Bool (= rec__names__data__entry_tables__vector__capacity1 (to_rep2 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 a)))))
...
(define-fun dynamic_invariant2 ((temp___expr_578 us_rep1) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (not (= temp___skip_constant_576 true)) (in_range4 256 temp___expr_578)))
(define-fun default_initial_assumption1 ((temp___expr_580 us_rep1) (temp___skip_top_level_581 Bool)) Bool (and (= (to_rep2 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 temp___expr_580))) 256) (=> (not (= temp___skip_top_level_581 true)) (= (is_empty1 temp___expr_580) true))))
...
(assert (forall ((temp___639 Int)) (forall ((temp___640 (_ BitVec 32))) (= (select (names__hash_table__aggregate_def temp___639) temp___640) (of_rep temp___639)))))
...
(define-fun dynamic_invariant3 ((temp___expr_39 Int) (temp___is_init_36 Bool) (temp___skip_constant_37 Bool) (temp___do_toplevel_38 Bool)) Bool (=> (or (= temp___is_init_36 true) (<= 1 2147483647)) (in_range5 temp___expr_39)))
...
(assert true)
(assert (forall ((names__hash_table (Array (_ BitVec 32) name_id))) (forall ((names__entry_table__fields us_split_fields2)) (! (= (= (valid_hashes names__hash_table names__entry_table__fields) true) (forall ((h (_ BitVec 32))) (=> (and (bvule ((_ int2bv 32) 0) h) (bvule h ((_ int2bv 32) 255))) (<= (to_rep (select names__hash_table h)) (last_index1 (mk___rep1 entry_table__split_discrs names__entry_table__fields)))))) :pattern ((valid_hashes names__hash_table names__entry_table__fields))))))
...
(define-fun bool_eq3 ((a us_rep4) (b us_rep4)) Bool (ite (and (and (= (to_rep4 (rec__names__data__name_entry__table_index (us_split_fields5 a))) (to_rep4 (rec__names__data__name_entry__table_index (us_split_fields5 b)))) (= (to_rep3 (rec__names__data__name_entry__length (us_split_fields5 a))) (to_rep3 (rec__names__data__name_entry__length (us_split_fields5 b))))) (= (to_rep (rec__names__data__name_entry__next_hash (us_split_fields5 a))) (to_rep (rec__names__data__name_entry__next_hash (us_split_fields5 b))))) true false))
...
(define-fun dynamic_invariant4 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range7 temp___expr_142)))
(define-fun dynamic_invariant5 ((temp___expr_264 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool)) Bool (=> (or (= temp___is_init_261 true) (<= 0 2147483646)) (in_range6 temp___expr_264)))
...
(define-fun dynamic_invariant6 ((temp___expr_282 Int) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool)) Bool (=> (or (= temp___is_init_279 true) (<= (- 1) 2147483647)) (in_range8 temp___expr_282)))
(define-fun dynamic_invariant7 ((temp___expr_288 Int) (temp___is_init_285 Bool) (temp___skip_constant_286 Bool) (temp___do_toplevel_287 Bool)) Bool (=> (or (= temp___is_init_285 true) (<= 0 2147483647)) (in_range1 temp___expr_288)))
...
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 0) true) (to_rep1 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(declare-fun length2 (us_rep) Int)
(declare-fun length__function_guard2 (Int us_rep) Bool)
(assert (forall ((container us_rep)) (! (let ((result (length2 container))) (and (<= result (capacity container)) (dynamic_invariant7 result true false true))) :pattern ((length2 container)))))
...
(define-fun default_initial_assumption2 ((temp___expr_322 us_rep2) (temp___skip_top_level_323 Bool)) Bool (=> (not (= temp___skip_top_level_323 true)) (= (length temp___expr_322) 0)))
...
(define-fun dynamic_invariant8 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= (- 1) 2147483646)) (in_range10 temp___expr_315)))
(assert (forall ((container us_rep2)) (! (let ((result (length container))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant4 result true false true))) :pattern ((length container)))))
...
(define-fun dynamic_invariant9 ((temp___expr_309 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 255)) (in_range11 temp___expr_309)))
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant8 position true true true) (and (<= 0 position) (<= position (last container)))) (dynamic_invariant9 (get1 container position) true false true)) :pattern ((get1 container position))))))
...
(define-fun dynamic_invariant10 ((temp___expr_436 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 0 2147483647)) (in_range12 temp___expr_436)))
(define-fun dynamic_invariant11 ((temp___expr_442 Int) (temp___is_init_439 Bool) (temp___skip_constant_440 Bool) (temp___do_toplevel_441 Bool)) Bool (=> (or (= temp___is_init_439 true) (<= 0 2147483647)) (in_range3 temp___expr_442)))
(define-fun capacity1 ((container us_rep1)) Int (ite (= (of_int 0) true) (to_rep2 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
...
(assert (forall ((container us_rep1)) (! (let ((result (length3 container))) (and (<= result (capacity1 container)) (dynamic_invariant11 result true false true))) :pattern ((length3 container)))))
...
(define-fun dynamic_invariant12 ((temp___expr_421 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1 2147483647)) (in_range13 temp___expr_421)))
...
(define-fun dynamic_invariant13 ((temp___expr_472 Int) (temp___is_init_469 Bool) (temp___skip_constant_470 Bool) (temp___do_toplevel_471 Bool)) Bool (=> (or (= temp___is_init_469 true) (<= 0 2147483647)) (in_range14 temp___expr_472)))
