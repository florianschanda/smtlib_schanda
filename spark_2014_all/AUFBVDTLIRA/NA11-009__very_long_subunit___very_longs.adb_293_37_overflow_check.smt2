...
(declare-datatypes () ((tT87bP1__ref (mk_tT87bP1__ref (tT87bP1__content tdigit_count_typeB)))))
(define-fun tT87bP1__ref___projection ((a tT87bP1__ref)) tdigit_count_typeB (tT87bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t87b__ref (mk_t87b__ref (t87b__content us_t1)))))
(define-fun t87b__ref___projection ((a t87b__ref)) us_t1 (t87b__content a))
...
(declare-datatypes () ((t88b__ref (mk_t88b__ref (t88b__content tdigit_count_typeB)))))
(define-fun t88b__ref___projection ((a t88b__ref)) tdigit_count_typeB (t88b__content a))
(declare-sort t2 0)
...
(declare-const temp___994 us_rep1)
(declare-const temp___993 (_ BitVec 16))
(declare-const temp___992 (_ BitVec 16))
(declare-const temp___989 (_ BitVec 16))
(declare-const temp___988 (_ BitVec 16))
(declare-const temp___987 (_ BitVec 16))
(declare-const temp___984 us_rep1)
(declare-const temp___983 (_ BitVec 16))
(declare-const temp___982 (_ BitVec 16))
...
(assert (= r_digit4 o11))
(assert (= (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) r92b))
(assert (in_range1 r92b))
(assert (and (= o14 (+ i4 j2)) (in_range1 (+ i4 j2))))
(assert (= o15 (- o14 1)))
(assert (= o16 (ite (<= o15 r92b) true false)))
(assert (and (= o12 (+ i4 j2)) (in_range1 (+ i4 j2))))
(assert (= o13 (- o12 1)))
(assert (= o17 (ite (<= 1 o13) true false)))
(assert (= result6 (ite (= o17 true) o16 false)))
(assert (= result6 true))
(assert (and (= o18 (+ i4 j2)) (in_range1 (+ i4 j2))))
(assert (= temp___977 (- o18 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___977) (<= temp___977 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
(assert (= o19 temp___977))
(assert (= o20 (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields4)) o19)))
(assert (= o21 (to_rep1 o20)))
(assert (= o22 ((_ zero_extend 8) o21)))
(assert (= result7 (mk_t__ref1 t_digit3)))
(assert (= t_digit4 o22))
(assert (= result8 (mk_t__ref1 temp3)))
(assert (= temp4 (bvadd (bvadd (bvmul l_digit4 r_digit4) t_digit4) carry4)))
(assert (= o24 (takelsb_from16 temp4)))
