...
(declare-const o15 t)
(declare-const temp___1305 digit_index_type)
(declare-const temp___13051 (Array Int octet))
(declare-const temp___13052 t)
...
(assert (in_range2 r123b))
(assert (= result2 i))
(assert (= i1 r123b))
(assert (<= 1 i1))
(assert (<= i1 r123b))
(assert (and (and (dynamic_invariant2 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true true) (forall ((temp___1314 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1314) (<= temp___1314 (to_rep1 (last number__split_fields3)))) (=> (or (< r123b temp___1314) (or (< temp___1314 1) (<= temp___1314 i2))) (= (select number__split_fields2 temp___1314) (select number__split_fields temp___1314)))))) (and (<= 1 i2) (<= i2 r123b))))
...
(assert (= o14 o12))
(assert (= o15 o13))
(assert (= number__split_discrs (mk___split_discrs temp___1305)))
(assert (= temp___13051 o14))
(assert (= temp___13052 o15))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___13051 temp___13052))))
(assert (= number__split_discrs (mk___split_discrs temp___1305)))
