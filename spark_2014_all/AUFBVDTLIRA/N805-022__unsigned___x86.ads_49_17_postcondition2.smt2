...
(define-fun dynamic_invariant1 ((temp___expr_181 (_ BitVec 8)) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool) (temp___do_typ_inv_180 Bool)) Bool true)
...
(declare-const xsi6 (Array Int unsigned_8))
(assert (= (to_rep o) ((_ extract 7 0) (bvurem val__ #x00000100))))
(assert (= o1 (store xsi 0 o)))
(assert (= (mk_map__ref result) (mk_map__ref xsi)))
(assert (= xsi1 o1))
...
(assert (= o5 (store xsi2 2 o4)))
(assert (= xsi2 result2))
(assert (= xsi3 o5))
(assert (= (to_rep o6) ((_ extract 7 0) (bvurem (bvudiv val__ #x01000000) #x00000100))))
(assert (= o7 (store xsi3 3 o6)))
(assert (= xsi3 result3))
(assert (= xsi4 o7))
(assert (= (bvadd ((_ zero_extend 24) (to_rep (select xsi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 1))) #x00000100)) (bvurem val__ #x00010000)))
(assert (= (bvadd ((_ zero_extend 24) (to_rep (select xsi4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 3))) #x00000100)) (bvurem (bvudiv val__ #x00010000) #x00010000)))
(assert (= (bvadd (bvurem val__ #x00010000) (bvmul (bvurem (bvudiv val__ #x00010000) #x00010000) #x00010000)) val__))
(assert (=> (and (= (bvadd ((_ zero_extend 24) (to_rep (select xsi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 1))) #x00000100)) (bvurem val__ #x00010000)) (= (bvadd ((_ zero_extend 24) (to_rep (select xsi4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 3))) #x00000100)) (bvurem (bvudiv val__ #x00010000) #x00010000))) (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 3))) #x01000000)) val__)))
(assert (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 3))) #x01000000)) val__))
(assert (= xsi4 xsi5))
(assert (= xsi6 xsi4))
(assert (not (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi5 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi5 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xsi5 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xsi5 3))) #x01000000)) val__)))
(check-sat)
(exit)
