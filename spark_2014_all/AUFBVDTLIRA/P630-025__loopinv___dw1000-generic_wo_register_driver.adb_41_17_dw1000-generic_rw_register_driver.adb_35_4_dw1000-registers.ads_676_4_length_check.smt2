...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__pmsc_txfseq_type__txfineseq bits_16)))))
(define-fun us_split_fields_TXFINESEQ__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__pmsc_txfseq_type__txfineseq a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___104__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___104__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__pmsc_txfseq_type__txfineseq (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__pmsc_txfseq_type__txfineseq (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__pmsc_txfseq_type__txfineseq__first__bit Int)
(declare-const dw1000__register_types__pmsc_txfseq_type__txfineseq__last__bit Int)
(declare-const dw1000__register_types__pmsc_txfseq_type__txfineseq__position Int)
(assert (<= 0 dw1000__register_types__pmsc_txfseq_type__txfineseq__first__bit))
(assert (< dw1000__register_types__pmsc_txfseq_type__txfineseq__first__bit dw1000__register_types__pmsc_txfseq_type__txfineseq__last__bit))
(assert (<= 0 dw1000__register_types__pmsc_txfseq_type__txfineseq__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((pmsc_txfseq_type__ref (mk_pmsc_txfseq_type__ref (pmsc_txfseq_type__content us_rep)))))
(define-fun pmsc_txfseq_type__ref___projection ((a pmsc_txfseq_type__ref)) us_rep (pmsc_txfseq_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___239__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___171__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___171__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_8352 us_t1) (temp___is_init_8348 Bool) (temp___skip_constant_8349 Bool) (temp___do_toplevel_8350 Bool) (temp___do_typ_inv_8351 Bool)) Bool (=> (not (= temp___skip_constant_8349 true)) (and (dynamic_property2 1 2 (first3 temp___expr_8352) (last3 temp___expr_8352)) (and (= (first3 temp___expr_8352) 1) (= (last3 temp___expr_8352) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___69__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___69__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_8370 us_t2) (temp___is_init_8366 Bool) (temp___skip_constant_8367 Bool) (temp___do_toplevel_8368 Bool) (temp___do_typ_inv_8369 Bool)) Bool (=> (not (= temp___skip_constant_8367 true)) (and (dynamic_property3 1 2 (first5 temp___expr_8370) (last5 temp___expr_8370)) (and (= (first5 temp___expr_8370) 1) (= (last5 temp___expr_8370) 2)))))
...
(declare-const temp___9013 (Array Int bits_8))
(declare-const temp___90131 t2)
(declare-const temp___9014 (Array Int bits_8))
(declare-const temp___90141 t1)
(define-fun temp___90132 () us_t2 (mk___t2 temp___9013 temp___90131))
...
(assert (and (= temp___90132 (register_to_bytes reg)) (dynamic_invariant1 temp___90132 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___90131)) (to_rep (last4 temp___90131))) (+ (- (to_rep (last4 temp___90131)) (to_rep (first4 temp___90131))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___9013 temp___9014))
(assert (= (mk1 (to_rep (first4 temp___90131)) (to_rep (last4 temp___90131))) temp___90141))
(assert (not (= (ite (<= (to_rep (first2 temp___90141)) (to_rep (last2 temp___90141))) (+ (- (to_rep (last2 temp___90141)) (to_rep (first2 temp___90141))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
