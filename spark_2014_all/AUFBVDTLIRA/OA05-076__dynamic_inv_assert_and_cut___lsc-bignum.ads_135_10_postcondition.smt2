...
(define-fun to_int2 ((x word32)) Int (bv2nat (to_rep x)))
...
(define-fun bool_eq ((a (Array Int word32)) (a__first Int) (a__last Int) (b (Array Int word32)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_156 Int)) (=> (and (<= a__first temp___idx_156) (<= temp___idx_156 a__last)) (= (to_rep (select a temp___idx_156)) (to_rep (select b (+ (- b__first a__first) temp___idx_156))))))) true false))
...
(assert (= i1 a_last))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___668 i1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___667 result__1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___666 j)))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (or (and (and (= result__3 result__4) (= result__5 result__3)) (and (and (and (and (and (and (<= (to_rep1 (first (rt b))) j3) (<= j3 (to_rep1 (last (rt b))))) (= o6 j3)) (= o7 (select (elts b) o6))) (= o8 (to_rep o7))) (and (and (and (and (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a))))) (= o4 i2)) (= o5 (select (elts a) o4))) (= o9 (to_rep o5))) (= result3 (ite (bvult o9 o8) true false)))) (and (= result3 true) (and (= result__2 result4) (= result__3 (distinct 1 0)))))) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt b))) j3) (<= j3 (to_rep1 (last (rt b))))) (= o6 j3)) (= o7 (select (elts b) o6))) (= o8 (to_rep o7))) (and (and (and (and (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a))))) (= o4 i2)) (= o5 (select (elts a) o4))) (= o9 (to_rep o5))) (= result3 (ite (bvult o9 o8) true false)))) (and (not (= result3 true)) (= result__3 result__2))) (and (and (= result__3 result__4) (= result__5 result__3)) (or (and (and (and (and (and (and (<= (to_rep1 (first (rt b))) j3) (<= j3 (to_rep1 (last (rt b))))) (= o12 j3)) (= o13 (select (elts b) o12))) (= o14 (to_rep o13))) (and (and (and (and (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a))))) (= o10 i2)) (= o11 (select (elts a) o10))) (= o15 (to_rep o11))) (= result5 (ite (bvugt o15 o14) true false)))) (= result5 true)) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt b))) j3) (<= j3 (to_rep1 (last (rt b))))) (= o12 j3)) (= o13 (select (elts b) o12))) (= o14 (to_rep o13))) (and (and (and (and (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a))))) (= o10 i2)) (= o11 (select (elts a) o10))) (= o15 (to_rep o11))) (= result5 (ite (bvugt o15 o14) true false)))) (not (= result5 true))) (= i2 a_first))))))))
...
(assert (= j9 j7))
(assert (= result7 (bool__content lsc__bignum__less__result4)))
