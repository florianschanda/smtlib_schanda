...
(assert (= (olt (num_of_big_int a a_first (+ (- a_last a_first) 1)) (num_of_big_int b b_first (+ (- a_last a_first) 1))) true))
(assert (not (= (bool__content lsc__bignum__less__result4) true)))
(check-sat)
(exit)
