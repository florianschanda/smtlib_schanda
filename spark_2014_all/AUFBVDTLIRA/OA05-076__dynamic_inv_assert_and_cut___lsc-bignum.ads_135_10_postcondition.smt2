...
(assert (= i1 a_last))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (and (= temp___598 i1) (and (= temp___597 result__1) (and (= temp___596 j) (and (and (= (oeq (num_of_big_int a (+ i2 1) (- a_last i2)) (num_of_big_int b (+ (+ b_first (- i2 a_first)) 1) (- a_last i2))) true) (not (= result__2 true))) (and (and (and (=> (<= 0 2147483647) (in_range2 j2)) (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2))) (and (<= a_first i2) (<= i2 a_last))) (and (and (and (and (and (and (= o20 (- i2 a_first)) (in_range1 (- i2 a_first))) (= o21 (+ b_first o20))) (and (= o22 o21) (in_range1 o21))) (and (= o23 o22) (in_range2 o22))) (and (= j2 result2) (= j3 o23))) (or (and (and (= result__3 result__4) (= result__5 result__3)) (and (and (and (and (and (and (<= (to_rep1 (first (rt b))) j3) (<= j3 (to_rep1 (last (rt b))))) (= o26 j3)) (= o27 (select (elts b) o26))) (= o28 (to_rep o27))) (and (and (and (and (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a))))) (= o24 i2)) (= o25 (select (elts a) o24))) (= o29 (to_rep o25))) (= result3 (ite (bvult o29 o28) true false)))) (and (= result3 true) (and (= result__2 result4) (= result__3 (of_int 1)))))) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt b))) j3) (<= j3 (to_rep1 (last (rt b))))) (= o26 j3)) (= o27 (select (elts b) o26))) (= o28 (to_rep o27))) (and (and (and (and (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a))))) (= o24 i2)) (= o25 (select (elts a) o24))) (= o29 (to_rep o25))) (= result3 (ite (bvult o29 o28) true false)))) (and (not (= result3 true)) (= result__3 result__2))) (and (and (= result__3 result__4) (= result__5 result__3)) (or (and (and (and (and (and (and (<= (to_rep1 (first (rt b))) j3) (<= j3 (to_rep1 (last (rt b))))) (= o32 j3)) (= o33 (select (elts b) o32))) (= o34 (to_rep o33))) (and (and (and (and (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a))))) (= o30 i2)) (= o31 (select (elts a) o30))) (= o35 (to_rep o31))) (= result5 (ite (bvugt o35 o34) true false)))) (= result5 true)) (and (and (and (and (and (and (and (<= (to_rep1 (first (rt b))) j3) (<= j3 (to_rep1 (last (rt b))))) (= o32 j3)) (= o33 (select (elts b) o32))) (= o34 (to_rep o33))) (and (and (and (and (and (<= (to_rep1 (first (rt a))) i2) (<= i2 (to_rep1 (last (rt a))))) (= o30 i2)) (= o31 (select (elts a) o30))) (= o35 (to_rep o31))) (= result5 (ite (bvugt o35 o34) true false)))) (not (= result5 true))) (= i2 a_first)))))))))))) (and (and (= i2 i6) (and (= (mk_bool__ref result__8) (mk_bool__ref result__4)) (= j3 j6))) (and (= i7 i2) (and (= result__9 result__5) (= j7 j3)))))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= (mk_int__ref i8) (mk_int__ref i6))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= (mk_bool__ref result__10) (mk_bool__ref result__8))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= (mk_int__ref j8) (mk_int__ref j6))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= result__1 result__10)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= (mk_int__ref j8) (mk_int__ref j))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= i9 i1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= result__11 result__1)))
...
(assert (= (mk_bool__ref result7) (mk_bool__ref lsc__bignum__less__result)))
(assert (= lsc__bignum__less__result1 result__10))
(assert (= lsc__bignum__less__result4 (mk_bool__ref lsc__bignum__less__result2)))
(assert (= i10 (mk_int__ref i8)))
(assert (= result__12 (mk_bool__ref result__10)))
(assert (= j10 (mk_int__ref j8)))
(assert (= lsc__bignum__less__result5 lsc__bignum__less__result3))
(assert (= i11 i9))
(assert (= result__13 result__11))
(assert (= j11 j9))
(assert (= result8 (bool__content lsc__bignum__less__result4)))
(assert (= (bool__content lsc__bignum__less__result4) true))
(assert (not (= (olt (num_of_big_int a a_first (+ (- a_last a_first) 1)) (num_of_big_int b b_first (+ (- a_last a_first) 1))) true)))
(check-sat)
(exit)
