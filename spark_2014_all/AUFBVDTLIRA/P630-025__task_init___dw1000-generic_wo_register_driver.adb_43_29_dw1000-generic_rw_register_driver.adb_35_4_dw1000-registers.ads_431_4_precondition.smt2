...
(assert (= (ite (<= (to_rep (first4 temp___79931)) (to_rep (last4 temp___79931))) (+ (- (to_rep (last4 temp___79931)) (to_rep (first4 temp___79931))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___7993 temp___7994))
(assert (= (mk1 (to_rep (first4 temp___79931)) (to_rep (last4 temp___79931))) temp___79941))
(assert (= (ite (<= (to_rep (first2 temp___79941)) (to_rep (last2 temp___79941))) (+ (- (to_rep (last2 temp___79941)) (to_rep (first2 temp___79941))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___7994 temp___79941)))
(assert (= o2 o))
