...
(assert (not (= (last2 (model__ (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6)))) (- (length1 (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6))) 1))))
(check-sat)
(exit)
