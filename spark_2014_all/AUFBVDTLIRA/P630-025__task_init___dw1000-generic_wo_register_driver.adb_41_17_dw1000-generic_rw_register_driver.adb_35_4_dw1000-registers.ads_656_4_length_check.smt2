...
(define-fun target__ref___65__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep2 (rec__dw1000__register_types__diag_tmc_type__tx_pstm (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__diag_tmc_type__tx_pstm (us_split_fields1 b)))) (= (to_rep3 (rec__dw1000__register_types__diag_tmc_type__reserved_1 (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__diag_tmc_type__reserved_1 (us_split_fields1 b))))) (= (to_rep4 (rec__dw1000__register_types__diag_tmc_type__reserved_2 (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__diag_tmc_type__reserved_2 (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_8006 us_t1) (temp___is_init_8002 Bool) (temp___skip_constant_8003 Bool) (temp___do_toplevel_8004 Bool) (temp___do_typ_inv_8005 Bool)) Bool (=> (not (= temp___skip_constant_8003 true)) (and (dynamic_property2 1 2 (first3 temp___expr_8006) (last3 temp___expr_8006)) (and (= (first3 temp___expr_8006) 1) (= (last3 temp___expr_8006) 2)))))
...
(define-fun register_byte_array__ref___163__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_7986 us_t2) (temp___is_init_7982 Bool) (temp___skip_constant_7983 Bool) (temp___do_toplevel_7984 Bool) (temp___do_typ_inv_7985 Bool)) Bool (=> (not (= temp___skip_constant_7983 true)) (and (dynamic_property3 1 2 (first5 temp___expr_7986) (last5 temp___expr_7986)) (and (= (first5 temp___expr_7986) 1) (= (last5 temp___expr_7986) 2)))))
...
(declare-const temp___89851 t1)
(declare-const temp___8986 (Array Int bits_8))
(declare-const temp___89861 t2)
(define-fun temp___89852 () us_t1 (mk___t1 temp___8985 temp___89851))
...
(assert (and (= temp___89852 (register_to_bytes reg)) (dynamic_invariant temp___89852 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___89851)) (to_rep (last2 temp___89851))) (+ (- (to_rep (last2 temp___89851)) (to_rep (first2 temp___89851))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8985 temp___8986))
(assert (= (mk2 (to_rep (first2 temp___89851)) (to_rep (last2 temp___89851))) temp___89861))
(assert (not (= (ite (<= (to_rep (first4 temp___89861)) (to_rep (last4 temp___89861))) (+ (- (to_rep (last4 temp___89861)) (to_rep (first4 temp___89861))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
