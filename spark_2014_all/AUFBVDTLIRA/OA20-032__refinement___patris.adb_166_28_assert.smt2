...
(assert (= cur_board2 (store cur_board del_line1 empty_line)))
(assert (= to_line1 result5))
(assert (= to_line2 del_line1))
(assert (=> (bvule (bvsub ((_ int2bv 32) 100000) complete_lines1) ((_ int2bv 32) 1)) (= o (bvsub (bvadd complete_lines1 ((_ int2bv 32) 1)) ((_ int2bv 32) 100000)))))
(assert (=> (not (bvule (bvsub ((_ int2bv 32) 100000) complete_lines1) ((_ int2bv 32) 1))) (= o (bvadd complete_lines1 ((_ int2bv 32) 1)))))
(assert (= complete_lines1 result6))
(assert (= complete_lines2 o))
(assert (not (= (to_rep (select (select cur_board2 del_line1) 1)) 0)))
(check-sat)
(exit)
