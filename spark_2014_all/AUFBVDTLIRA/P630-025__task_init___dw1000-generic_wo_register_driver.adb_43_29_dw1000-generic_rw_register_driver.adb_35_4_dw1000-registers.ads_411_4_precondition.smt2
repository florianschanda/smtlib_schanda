...
(assert (= (ite (<= (to_rep (first4 temp___87421)) (to_rep (last4 temp___87421))) (+ (- (to_rep (last4 temp___87421)) (to_rep (first4 temp___87421))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8742 temp___8743))
(assert (= (mk1 (to_rep (first4 temp___87421)) (to_rep (last4 temp___87421))) temp___87431))
(assert (= (ite (<= (to_rep (first2 temp___87431)) (to_rep (last2 temp___87431))) (+ (- (to_rep (last2 temp___87431)) (to_rep (first2 temp___87431))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8743 temp___87431)))
(assert (= o2 o))
