...
(define-fun target__ref___54__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__otp_wdat_type__otp_wdat (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__otp_wdat_type__otp_wdat (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_6922 us_t1) (temp___is_init_6918 Bool) (temp___skip_constant_6919 Bool) (temp___do_toplevel_6920 Bool) (temp___do_typ_inv_6921 Bool)) Bool (=> (not (= temp___skip_constant_6919 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6922) (last3 temp___expr_6922)) (and (= (first3 temp___expr_6922) 1) (= (last3 temp___expr_6922) 4)))))
...
(define-fun register_byte_array__ref___125__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_6904 us_t2) (temp___is_init_6900 Bool) (temp___skip_constant_6901 Bool) (temp___do_toplevel_6902 Bool) (temp___do_typ_inv_6903 Bool)) Bool (=> (not (= temp___skip_constant_6901 true)) (and (dynamic_property3 1 4 (first5 temp___expr_6904) (last5 temp___expr_6904)) (and (= (first5 temp___expr_6904) 1) (= (last5 temp___expr_6904) 4)))))
...
(declare-const temp___88761 t1)
(define-fun temp___88762 () us_t1 (mk___t1 temp___8876 temp___88761))
...
(assert (and (= temp___88762 (register_to_bytes reg)) (dynamic_invariant temp___88762 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___88761)) (to_rep (last2 temp___88761))) (+ (- (to_rep (last2 temp___88761)) (to_rep (first2 temp___88761))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
