...
(assert (and (= (mk___t2 temp___8104 temp___81041) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8104 temp___81041) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___81041)) (to_rep (last4 temp___81041))) (+ (- (to_rep (last4 temp___81041)) (to_rep (first4 temp___81041))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
