...
(assert (=> (and (= (bvadd ((_ zero_extend 24) (to_rep (select xcx4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 1))) ((_ int2bv 32) 256))) (bvurem val__ ((_ int2bv 32) 65536))) (= (bvadd ((_ zero_extend 24) (to_rep (select xcx4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) ((_ int2bv 32) 256))) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)))) (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) ((_ int2bv 32) 16777216))) val__)))
(assert (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) ((_ int2bv 32) 16777216))) val__))
(assert (= xcx4 xcx5))
(assert (= xcx6 xcx4))
