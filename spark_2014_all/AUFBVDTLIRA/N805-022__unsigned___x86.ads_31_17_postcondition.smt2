...
(assert true)
(assert (and (and (and (and (= (to_rep o) ((_ extract 7 0) (bvurem val__ ((_ int2bv 32) 256)))) (= o1 (store xcx 0 o))) (and (= (mk_map__ref result) (mk_map__ref xcx)) (= xcx1 o1))) (and (and (and (= (to_rep o2) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 32) 256)) ((_ int2bv 32) 256)))) (= o3 (store xcx1 1 o2))) (and (= xcx1 result1) (= xcx2 o3))) (and (and (and (= (to_rep o4) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 256)))) (= o5 (store xcx2 2 o4))) (and (= xcx2 result2) (= xcx3 o5))) (and (and (and (= (to_rep o6) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 32) 16777216)) ((_ int2bv 32) 256)))) (= o7 (store xcx3 3 o6))) (and (= xcx3 result3) (= xcx4 o7))) (and (= (bvadd ((_ zero_extend 24) (to_rep (select xcx4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 1))) ((_ int2bv 32) 256))) (bvurem val__ ((_ int2bv 32) 65536))) (and (= (bvadd ((_ zero_extend 24) (to_rep (select xcx4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) ((_ int2bv 32) 256))) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536))) (and (= (bvadd (bvurem val__ ((_ int2bv 32) 65536)) (bvmul (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536))) val__) (and (=> (and (= (bvadd ((_ zero_extend 24) (to_rep (select xcx4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 1))) ((_ int2bv 32) 256))) (bvurem val__ ((_ int2bv 32) 65536))) (= (bvadd ((_ zero_extend 24) (to_rep (select xcx4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) ((_ int2bv 32) 256))) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)))) (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) ((_ int2bv 32) 16777216))) val__)) (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xcx4 3))) ((_ int2bv 32) 16777216))) val__))))))))) (and (= xcx4 xcx5) (= xcx6 xcx4))))
(assert (not (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx5 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx5 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xcx5 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xcx5 3))) ((_ int2bv 32) 16777216))) val__)))
(check-sat)
(exit)
