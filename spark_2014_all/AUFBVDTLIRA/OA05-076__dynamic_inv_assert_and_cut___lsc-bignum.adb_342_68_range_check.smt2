...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o35 k)) #x00000000))))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (omod (oadd (num_of_big_int (mk___t o36 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o36 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true)))
...
(assert (= o31 (omultiply o25 o30)))
(assert (= o33 (osubtract o31 o32)))
(assert (= o22 (from_word32 a_msw2)))
...
(assert (= o15 (num_of_big_int (mk___t o36 (mk (to_rep a__first) (to_rep a__last))) a_first o14)))
(assert (= o24 (oadd o15 o23)))
(assert (= o34 (olt o24 o33)))
...
(assert (and (= o4 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o5 o4) (in_range2 o4)))
(assert (and (= o3 (base Tuple0)) (= o3 (oexpon (from_word32 #x00000002) 32))))
