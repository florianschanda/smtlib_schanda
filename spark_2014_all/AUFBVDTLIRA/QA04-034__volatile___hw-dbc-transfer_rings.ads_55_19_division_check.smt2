...
(define-fun to_int3 ((x bit)) Int (bv2nat (to_rep x)))
(assert (forall ((x bit)) (! (in_range_int (to_int3 x)) :pattern ((to_int3 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_424 (_ BitVec 64)) (temp___is_init_420 Bool) (temp___skip_constant_421 Bool) (temp___do_toplevel_422 Bool) (temp___do_typ_inv_423 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_596 Int) (temp___is_init_592 Bool) (temp___skip_constant_593 Bool) (temp___do_toplevel_594 Bool) (temp___do_typ_inv_595 Bool)) Bool (=> (or (= temp___is_init_592 true) (<= 2 3)) (in_range3 temp___expr_596)))
...
(define-fun to_int6 ((x word64)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x word64)) (! (uint_in_range1 (to_int6 x)) :pattern ((to_int6 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_873 (_ BitVec 8)) (temp___is_init_869 Bool) (temp___skip_constant_870 Bool) (temp___do_toplevel_871 Bool) (temp___do_typ_inv_872 Bool)) Bool (=> (or (= temp___is_init_869 true) (bvule #x00 #x3F)) (in_range4 temp___expr_873)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x40))) (=> (in_range4 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int7 ((x ring_range)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x ring_range)) (! (in_range_int1 (to_int7 x)) :pattern ((to_int7 x)))))
...
(define-fun bool_eq4 ((a (Array Int bit)) (a__first Int) (a__last Int) (b (Array Int bit)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_220 Int)) (=> (and (<= a__first temp___idx_220) (<= temp___idx_220 a__last)) (= (to_rep (select a temp___idx_220)) (to_rep (select b (+ (- b__first a__first) temp___idx_220))))))) true false))
(assert (forall ((a (Array Int bit)) (b (Array Int bit))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_220 Int)) (=> (and (<= a__first temp___idx_220) (<= temp___idx_220 a__last)) (= (to_rep (select a temp___idx_220)) (to_rep (select b (+ (- b__first a__first) temp___idx_220)))))))))))
...
(assert (forall ((a (Array Int (Array (_ BitVec 8) us_rep))) (b (Array Int (Array (_ BitVec 8) us_rep)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_219 Int)) (=> (and (<= a__first temp___idx_219) (<= temp___idx_219 a__last)) (= (bool_eq1 (select a temp___idx_219) #x00 #x3F (select b (+ (- b__first a__first) temp___idx_219)) #x00 #x3F) true))))))))
...
(define-fun dynamic_invariant4 ((temp___expr_389 (_ BitVec 8)) (temp___is_init_385 Bool) (temp___skip_constant_386 Bool) (temp___do_toplevel_387 Bool) (temp___do_typ_inv_388 Bool)) Bool (=> (or (= temp___is_init_385 true) (bvule #x00 #x01)) (in_range2 temp___expr_389)))
(define-fun dynamic_invariant5 ((temp___expr_417 (_ BitVec 32)) (temp___is_init_413 Bool) (temp___skip_constant_414 Bool) (temp___do_toplevel_415 Bool) (temp___do_typ_inv_416 Bool)) Bool true)
(assert (in_range3 ep))
