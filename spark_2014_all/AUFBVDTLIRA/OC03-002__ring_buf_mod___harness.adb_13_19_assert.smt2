...
(assert (= (let ((temp___250 (to_model (mk___rep r__split_fields14)))) (bool_eq (elts temp___250) (to_rep (first (rt temp___250))) (to_rep (last (rt temp___250))) (temp_____aggregate_def_246 0) #x0001 #x0000)) true))
(assert (= (let ((temp___258 (func_push (to_model (mk___rep r__split_fields14)) x))) (let ((temp___257 (to_model (mk___rep r__split_fields13)))) (bool_eq (elts temp___257) (to_rep (first (rt temp___257))) (to_rep (last (rt temp___257))) (elts temp___258) (to_rep (first (rt temp___258))) (to_rep (last (rt temp___258)))))) true))
(assert (= (let ((temp___258 (func_push (to_model (mk___rep r__split_fields13)) y))) (let ((temp___257 (to_model (mk___rep r__split_fields12)))) (bool_eq (elts temp___257) (to_rep (first (rt temp___257))) (to_rep (last (rt temp___257))) (elts temp___258) (to_rep (first (rt temp___258))) (to_rep (last (rt temp___258)))))) true))
(assert (and (and (= (let ((temp___262 (func_pop (to_model (mk___rep r__split_fields12))))) (let ((temp___261 (to_model (mk___rep (mk___split_fields r__split_fields9 r__split_fields10 r__split_fields11))))) (bool_eq (elts temp___261) (to_rep (first (rt temp___261))) (to_rep (last (rt temp___261))) (elts temp___262) (to_rep (first (rt temp___262))) (to_rep (last (rt temp___262)))))) true) (= h1 (func_head (to_model (mk___rep r__split_fields12))))) (in_range h1)))
(assert (not (= h1 x)))
(check-sat)
(exit)
