...
(assert (and (= temp___79492 (register_to_bytes reg)) (dynamic_invariant1 temp___79492 true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___79491)) (to_rep (last4 temp___79491))) (+ (- (to_rep (last4 temp___79491)) (to_rep (first4 temp___79491))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
