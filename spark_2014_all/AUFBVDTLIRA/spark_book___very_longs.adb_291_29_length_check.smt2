...
(declare-fun temp___1033 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1035 (_ BitVec 8))) (forall ((temp___1036 Int) (temp___1037 Int)) (let ((temp___1034 (temp___1033 temp___1035 temp___1036 temp___1037))) (=> (dynamic_invariant2 temp___1035 true true true true) (and (=> (dynamic_property6 1 65536 temp___1036 temp___1037) (and (= (first5 temp___1034) temp___1036) (= (last5 temp___1034) temp___1037))) (forall ((temp___1038 Int)) (= (to_rep1 (select (to_array2 temp___1034) temp___1038)) temp___1035))))))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1033 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1033 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___1040 temp___10401) (temp___1033 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(assert (not (= (ite (<= (to_rep2 (first4 temp___10401)) (to_rep2 (last4 temp___10401))) (+ (- (to_rep2 (last4 temp___10401)) (to_rep2 (first4 temp___10401))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0))))
(check-sat)
(exit)
