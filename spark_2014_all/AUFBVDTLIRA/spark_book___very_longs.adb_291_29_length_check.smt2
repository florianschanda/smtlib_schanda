...
(declare-fun temp___964 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___966 (_ BitVec 8))) (forall ((temp___967 Int) (temp___968 Int)) (let ((temp___965 (temp___964 temp___966 temp___967 temp___968))) (and (=> (dynamic_property6 1 65536 temp___967 temp___968) (and (= (first5 temp___965) temp___967) (= (last5 temp___965) temp___968))) (forall ((temp___969 Int)) (= (select (to_array2 temp___965) temp___969) (of_rep1 temp___966))))))))
...
(declare-const temp___9711 t2)
(declare-const temp___972 (Array Int octet))
(declare-const temp___9721 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___975 digit_index_type)
(declare-const temp___9751 (Array Int octet))
(declare-const temp___9752 t1)
(declare-const temp___999 us_rep1)
...
(declare-const temp___994 (_ BitVec 16))
(declare-const temp___989 us_rep1)
...
(declare-const temp___984 (_ BitVec 16))
...
(declare-const temp___983 us_rep1)
...
(assert true)
(assert true)
(assert (= (to_rep2 (first4 (rt2 (temp___964 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___964 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___971 temp___9711) (temp___964 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(assert (not (= (ite (<= (to_rep2 (first4 temp___9711)) (to_rep2 (last4 temp___9711))) (+ (- (to_rep2 (last4 temp___9711)) (to_rep2 (first4 temp___9711))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0))))
(check-sat)
(exit)
