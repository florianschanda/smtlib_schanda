...
(declare-const temp___8766 (Array Int bits_8))
(declare-const temp___87661 t1)
...
(assert (= (ite (<= (to_rep (first4 temp___87651)) (to_rep (last4 temp___87651))) (+ (- (to_rep (last4 temp___87651)) (to_rep (first4 temp___87651))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8765 temp___8766))
(assert (= (mk1 (to_rep (first4 temp___87651)) (to_rep (last4 temp___87651))) temp___87661))
(assert (= (ite (<= (to_rep (first2 temp___87661)) (to_rep (last2 temp___87661))) (+ (- (to_rep (last2 temp___87661)) (to_rep (first2 temp___87661))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8766 temp___87661)))
(assert (= o2 o))
