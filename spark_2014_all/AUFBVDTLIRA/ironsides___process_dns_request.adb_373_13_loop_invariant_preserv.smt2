...
(declare-const srcnum02 t__ref)
(declare-const srcnum12 t__ref)
(declare-const srcnum22 t__ref)
(declare-const srcnum32 t__ref)
(declare-const dstnum02 t__ref)
(declare-const dstnum12 t__ref)
(declare-const dstnum22 t__ref)
(declare-const ans68 t__ref)
(declare-const ans69 t__ref)
(declare-const ans70 t__ref)
(declare-const ans71 t__ref)
...
(declare-const ans72 (_ BitVec 8))
(declare-const ans73 (_ BitVec 8))
(declare-const ans74 (_ BitVec 8))
...
(assert (and (<= 1 (+ sigoffset1 (+ dstbytes2 2))) (<= (+ sigoffset1 (+ dstbytes2 2)) 8180)))
(assert (= o40 (+ sigoffset1 (+ dstbytes2 2))))
(assert (= o41 (store bytes12 o40 o39)))
(assert (= result44 (mk_map__ref1 bytes12)))
(assert (= bytes13 o41))
(assert (and (= o42 (+ srcbyte2 4)) (in_range1 (+ srcbyte2 4))))
(assert (= result45 (mk_int__ref srcbyte2)))
(assert (= srcbyte3 o42))
(assert (and (= o43 (+ dstbytes2 3)) (in_range3 (+ dstbytes2 3))))
(assert (= result46 (mk_int__ref dstbytes2)))
(assert (= dstbytes3 o43))
(assert (and (= o44 (+ srcbyte3 3)) (in_range1 (+ srcbyte3 3))))
(assert (= o45 (ite (<= o44 siglength1) true false)))
(assert (= result47 (ite (not (= o45 true)) true false)))
(assert (not (= result47 true)))
(assert (= ans71 ans66))
(assert (= ans70 ans50))
(assert (= ans69 ans34))
(assert (= ans68 ans18))
(assert (= dstnum22 (mk_t__ref dstnum21)))
(assert (= dstnum12 (mk_t__ref dstnum11)))
(assert (= dstnum02 (mk_t__ref dstnum01)))
(assert (= srcnum32 (mk_t__ref srcnum31)))
(assert (= srcnum22 (mk_t__ref srcnum21)))
(assert (= srcnum12 (mk_t__ref srcnum11)))
(assert (= srcnum02 (mk_t__ref srcnum01)))
(assert (= srcbyte4 (mk_int__ref srcbyte3)))
(assert (= dstbytes4 (mk_int__ref dstbytes3)))
(assert (= bytes14 (mk_map__ref1 bytes13)))
(assert (= ans75 ans67))
(assert (= ans74 ans51))
(assert (= ans73 ans35))
(assert (= ans72 ans19))
(assert (= dstnum23 dstnum21))
(assert (= dstnum13 dstnum11))
(assert (= dstnum03 dstnum01))
(assert (= srcnum33 srcnum31))
(assert (= srcnum23 srcnum21))
(assert (= srcnum13 srcnum11))
(assert (= srcnum03 srcnum01))
(assert (= srcbyte5 srcbyte3))
(assert (= dstbytes5 dstbytes3))
(assert (= bytes15 bytes13))
(assert (not (<= (+ (int__content srcbyte4) 3) siglength1)))
(check-sat)
(exit)
