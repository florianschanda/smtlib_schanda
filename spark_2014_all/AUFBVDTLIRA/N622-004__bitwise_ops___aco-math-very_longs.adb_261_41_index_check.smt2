...
(assert (and (= o23 (+ i4 j2)) (in_range2 (+ i4 j2))))
(assert (= temp___1199 (- o23 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1199)))
(check-sat)
(exit)
