...
(define-fun dynamic_invariant ((temp___expr_3744 us_t1) (temp___is_init_3741 Bool) (temp___skip_constant_3742 Bool) (temp___do_toplevel_3743 Bool)) Bool (=> (not (= temp___skip_constant_3742 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3744) (last3 temp___expr_3744)) (and (= (first3 temp___expr_3744) 1) (= (last3 temp___expr_3744) 4)))))
