...
(define-fun dynamic_invariant ((temp___expr_284 (_ BitVec 32)) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool) (temp___do_typ_inv_283 Bool)) Bool true)
...
(declare-const tmpline2 (Array Int character))
(declare-const i2 Int)
(declare-const result5 (Array Int character))
(declare-const tmpline3 (Array Int character))
...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i4 Int)) (=> (and (<= begidx2 i4) (<= i4 endidx1)) (and (<= 48 (to_rep (select zonefileline i4))) (<= (to_rep (select zonefileline i4)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
(assert (= foundtype1 8))
(assert (<= begidx2 (- endidx1 6)))
(assert (and (<= 1 (+ begidx2 6)) (<= (+ begidx2 6) 256)))
(assert (= o23 (+ begidx2 6)))
(assert (= o24 (select zonefileline o23)))
(assert (= o25 (to_rep o24)))
(assert (= o26 (ite (= o25 78) true false)))
(assert (and (<= 1 (+ begidx2 5)) (<= (+ begidx2 5) 256)))
(assert (= o18 (+ begidx2 5)))
(assert (= o19 (select zonefileline o18)))
(assert (= o20 (to_rep o19)))
(assert (= o21 (ite (= o20 73) true false)))
(assert (and (<= 1 (+ begidx2 4)) (<= (+ begidx2 4) 256)))
(assert (= o13 (+ begidx2 4)))
(assert (= o14 (select zonefileline o13)))
(assert (= o15 (to_rep o14)))
(assert (= o16 (ite (= o15 71) true false)))
(assert (and (<= 1 (+ begidx2 3)) (<= (+ begidx2 3) 256)))
(assert (= o8 (+ begidx2 3)))
(assert (= o9 (select zonefileline o8)))
(assert (= o10 (to_rep o9)))
(assert (= o11 (ite (= o10 73) true false)))
(assert (and (<= 1 (+ begidx2 2)) (<= (+ begidx2 2) 256)))
(assert (= o3 (+ begidx2 2)))
(assert (= o4 (select zonefileline o3)))
(assert (= o5 (to_rep o4)))
(assert (= o6 (ite (= o5 82) true false)))
(assert (and (<= 1 (+ begidx2 1)) (<= (+ begidx2 1) 256)))
(assert (= o (+ begidx2 1)))
(assert (= o1 (select zonefileline o)))
(assert (= o2 (to_rep o1)))
(assert (= o7 (ite (= o2 79) true false)))
(assert (= o12 (ite (= o7 true) o6 false)))
(assert (= o17 (ite (= o12 true) o11 false)))
(assert (= o22 (ite (= o17 true) o16 false)))
(assert (= o27 (ite (= o22 true) o21 false)))
(assert (= result2 (ite (= o27 true) o26 false)))
(assert (= result2 true))
(assert (=> (and (< begidx2 zlength) (< endidx1 zlength)) (and (= o28 (+ endidx1 1)) (in_range4 (+ endidx1 1)))))
(assert (=> (and (< begidx2 zlength) (< endidx1 zlength)) (= begidx2 result3)))
(assert (=> (and (< begidx2 zlength) (< endidx1 zlength)) (= begidx3 o28)))
(assert (=> (and (< begidx2 zlength) (< endidx1 zlength)) (and (and (and (and (<= begidx4 endidx2) (<= begidx4 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i4 Int)) (=> (and (<= begidx4 i4) (<= i4 endidx2)) (and (<= 48 (to_rep (select zonefileline i4))) (<= (to_rep (select zonefileline i4)) 57)))))) (and (and (in_range4 begidx4) (in_range4 endidx2)) (in_range3 foundtype2)))))
(assert (=> (not (and (< begidx2 zlength) (< endidx1 zlength))) (= foundtype2 foundtype1)))
(assert (=> (not (and (< begidx2 zlength) (< endidx1 zlength))) (= endidx2 endidx1)))
(assert (=> (not (and (< begidx2 zlength) (< endidx1 zlength))) (= begidx4 begidx2)))
(assert (= foundtype2 0))
(assert (= (to_rep (select zonefileline endidx2)) 46))
(assert (= begidx4 r66b))
(assert (in_range4 r66b))
(assert (= endidx2 r67b))
(assert (in_range4 r67b))
(assert (= result4 i))
(assert (= i1 r66b))
(assert (<= r66b i1))
(assert (<= i1 r67b))
(assert (and (<= 1 begidx4) (<= begidx4 endidx2)))
(assert (and (and (forall ((temp___1588 Int)) (=> (and (<= 1 temp___1588) (<= temp___1588 256)) (=> (<= i2 temp___1588) (= (select tmpline2 temp___1588) (select tmpline1 temp___1588))))) (=> (<= r66b r67b) (dynamic_property r66b r67b i2))) (and (<= r66b i2) (<= i2 r67b))))
(assert (= (to_rep o29) (to_rep (select zonefileline i2))))
(assert (= o30 (store tmpline2 i2 o29)))
(assert (= result5 tmpline2))
(assert (= tmpline3 o30))
(assert (not (= i2 r67b)))
(assert (= result6 i2))
(assert (= i3 (+ i2 1)))
(assert (not (<= 1 begidx4)))
(check-sat)
(exit)
