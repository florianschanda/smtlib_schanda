...
(assert (forall ((temp___1513 Int)) (forall ((temp___1514 Int)) (= (select (zone_file_parser__parsecontrolline__tmpline__aggregate_def temp___1513) temp___1514) (of_rep temp___1513)))))
...
(assert (and (and (forall ((temp___1529 Int)) (=> (and (<= 1 temp___1529) (<= temp___1529 256)) (=> (<= i2 temp___1529) (= (select tmpline2 temp___1529) (select tmpline1 temp___1529))))) (=> (<= r66b r67b) (dynamic_property r66b r67b i2))) (and (<= r66b i2) (<= i2 r67b))))
