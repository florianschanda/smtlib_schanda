...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 128)))) (=> (in_range4 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
...
(define-fun in_range5 ((x (_ BitVec 16))) Bool (and (bvule ((_ int2bv 16) 0) x) (bvule x ((_ int2bv 16) 16383))))
...
(assert (forall ((x bits_14)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x bits_14)) (! (in_range5 (to_rep5 x)) :pattern ((to_rep5 x)))))
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x ((_ int2bv 16) 16384)))) (=> (in_range5 y) (= (to_rep5 (of_rep5 x)) y))) :pattern ((to_rep5 (of_rep5 x))))))
(define-fun to_int7 ((x bits_14)) Int (bv2nat (to_rep5 x)))
(assert (forall ((x bits_14)) (! (in_range_int3 (to_int7 x)) :pattern ((to_int7 x)))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (and (and (and (and (and (and (= (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__sfcst (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__sfcst (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__txstrt (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__txstrt (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__txdlys (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__txdlys (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__cansfcs (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__cansfcs (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__trxoff (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__trxoff (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__wait4resp (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__wait4resp (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__rxenab (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__rxenab (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__rxdlye (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__rxdlye (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__hrbpt (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__sys_ctrl_type__hrbpt (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__sys_ctrl_type__reserved_1 (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__sys_ctrl_type__reserved_1 (us_split_fields1 b))))) (= (to_rep5 (rec__dw1000__register_types__sys_ctrl_type__reserved_2 (us_split_fields1 a))) (to_rep5 (rec__dw1000__register_types__sys_ctrl_type__reserved_2 (us_split_fields1 b))))) (= (to_rep4 (rec__dw1000__register_types__sys_ctrl_type__reserved_3 (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__sys_ctrl_type__reserved_3 (us_split_fields1 b))))) true false))
...
(define-fun register_type__ref___24__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___17__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___17__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_2438 us_t1) (temp___is_init_2435 Bool) (temp___skip_constant_2436 Bool) (temp___do_toplevel_2437 Bool)) Bool (=> (not (= temp___skip_constant_2436 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2438) (last3 temp___expr_2438)) (and (= (first3 temp___expr_2438) 1) (= (last3 temp___expr_2438) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___8__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___8__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_2465 us_t2) (temp___is_init_2462 Bool) (temp___skip_constant_2463 Bool) (temp___do_toplevel_2464 Bool)) Bool (=> (not (= temp___skip_constant_2463 true)) (and (dynamic_property3 1 4 (first5 temp___expr_2465) (last5 temp___expr_2465)) (and (= (first5 temp___expr_2465) 1) (= (last5 temp___expr_2465) 4)))))
...
(declare-const temp___7743 (Array Int bits_8))
(declare-const temp___77431 t2)
(declare-const temp___7744 (Array Int bits_8))
(declare-const temp___77441 t1)
...
(assert (and (= (mk___t2 temp___7743 temp___77431) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7743 temp___77431) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___77431)) (to_rep (last4 temp___77431))) (+ (- (to_rep (last4 temp___77431)) (to_rep (first4 temp___77431))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7743 temp___7744))
(assert (= (mk1 (to_rep (first4 temp___77431)) (to_rep (last4 temp___77431))) temp___77441))
(assert (= (ite (<= (to_rep (first2 temp___77441)) (to_rep (last2 temp___77441))) (+ (- (to_rep (last2 temp___77441)) (to_rep (first2 temp___77441))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___7744 temp___77441)))
(assert (= o2 o))
