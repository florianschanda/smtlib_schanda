...
(assert (forall ((x bits_32)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert true)
...
(assert (forall ((x bits_32)) (! (uint_in_range2 (to_int5 x)) :pattern ((to_int5 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__otp_wdat_type__otp_wdat bits_32)))))
(define-fun us_split_fields_OTP_WDAT__projection ((a us_split_fields)) bits_32 (rec__dw1000__register_types__otp_wdat_type__otp_wdat a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___73__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___73__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__otp_wdat_type__otp_wdat (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__otp_wdat_type__otp_wdat (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__otp_wdat_type__otp_wdat__first__bit Int)
(declare-const dw1000__register_types__otp_wdat_type__otp_wdat__last__bit Int)
(declare-const dw1000__register_types__otp_wdat_type__otp_wdat__position Int)
(assert (<= 0 dw1000__register_types__otp_wdat_type__otp_wdat__first__bit))
(assert (< dw1000__register_types__otp_wdat_type__otp_wdat__first__bit dw1000__register_types__otp_wdat_type__otp_wdat__last__bit))
(assert (<= 0 dw1000__register_types__otp_wdat_type__otp_wdat__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((otp_wdat_type__ref (mk_otp_wdat_type__ref (otp_wdat_type__content us_rep)))))
(define-fun otp_wdat_type__ref___projection ((a otp_wdat_type__ref)) us_rep (otp_wdat_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___178__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___125__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___125__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6904 us_t1) (temp___is_init_6900 Bool) (temp___skip_constant_6901 Bool) (temp___do_toplevel_6902 Bool) (temp___do_typ_inv_6903 Bool)) Bool (=> (not (= temp___skip_constant_6901 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6904) (last3 temp___expr_6904)) (and (= (first3 temp___expr_6904) 1) (= (last3 temp___expr_6904) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___54__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___54__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_6922 us_t2) (temp___is_init_6918 Bool) (temp___skip_constant_6919 Bool) (temp___do_toplevel_6920 Bool) (temp___do_typ_inv_6921 Bool)) Bool (=> (not (= temp___skip_constant_6919 true)) (and (dynamic_property3 1 4 (first5 temp___expr_6922) (last5 temp___expr_6922)) (and (= (first5 temp___expr_6922) 1) (= (last5 temp___expr_6922) 4)))))
...
(declare-const temp___8876 (Array Int bits_8))
(declare-const temp___88761 t2)
(declare-const temp___8877 (Array Int bits_8))
(declare-const temp___88771 t1)
...
(define-fun temp___88762 () us_t2 (mk___t2 temp___8876 temp___88761))
...
(assert (and (= temp___88762 (register_to_bytes reg)) (dynamic_invariant1 temp___88762 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___88761)) (to_rep (last4 temp___88761))) (+ (- (to_rep (last4 temp___88761)) (to_rep (first4 temp___88761))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8876 temp___8877))
(assert (= (mk1 (to_rep (first4 temp___88761)) (to_rep (last4 temp___88761))) temp___88771))
(assert (= (ite (<= (to_rep (first2 temp___88771)) (to_rep (last2 temp___88771))) (+ (- (to_rep (last2 temp___88771)) (to_rep (first2 temp___88771))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8877 temp___88771)))
(assert (= o2 o))
