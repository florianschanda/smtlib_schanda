...
(define-fun dynamic_invariant ((temp___expr_6278 us_t1) (temp___is_init_6275 Bool) (temp___skip_constant_6276 Bool) (temp___do_toplevel_6277 Bool)) Bool (=> (not (= temp___skip_constant_6276 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6278) (last3 temp___expr_6278)) (and (= (first3 temp___expr_6278) 1) (= (last3 temp___expr_6278) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_6294 us_t2) (temp___is_init_6291 Bool) (temp___skip_constant_6292 Bool) (temp___do_toplevel_6293 Bool)) Bool (=> (not (= temp___skip_constant_6292 true)) (and (dynamic_property3 1 4 (first5 temp___expr_6294) (last5 temp___expr_6294)) (and (= (first5 temp___expr_6294) 1) (= (last5 temp___expr_6294) 4)))))
...
(declare-const temp___8104 (Array Int bits_8))
(declare-const temp___81041 t2)
(declare-const temp___8105 (Array Int bits_8))
(declare-const temp___81051 t1)
...
(define-fun temp___81042 () us_t2 (mk___t2 temp___8104 temp___81041))
...
(assert (and (= temp___81042 (register_to_bytes reg)) (dynamic_invariant1 temp___81042 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___81041)) (to_rep (last4 temp___81041))) (+ (- (to_rep (last4 temp___81041)) (to_rep (first4 temp___81041))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8104 temp___8105))
(assert (= (mk1 (to_rep (first4 temp___81041)) (to_rep (last4 temp___81041))) temp___81051))
(assert (= (ite (<= (to_rep (first2 temp___81051)) (to_rep (last2 temp___81051))) (+ (- (to_rep (last2 temp___81051)) (to_rep (first2 temp___81051))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8105 temp___81051)))
(assert (= o2 o))
