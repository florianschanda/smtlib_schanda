...
(assert (not (= x86__readmem16__result4 (bvor ((_ zero_extend 8) (to_rep (select memory addr))) (ite (< 8 16) (bvshl ((_ zero_extend 8) (to_rep (select memory (bvadd addr ((_ int2bv 64) 1))))) ((_ int2bv 16) 8)) ((_ int2bv 16) 0))))))
(check-sat)
(exit)
