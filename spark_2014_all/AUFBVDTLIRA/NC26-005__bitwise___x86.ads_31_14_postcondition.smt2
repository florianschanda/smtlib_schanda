...
(assert (=> (< 8 16) (and (= o1 (readmem8 (bvadd addr #x0000000000000001) memory)) (= o1 (to_rep (select memory (bvadd addr #x0000000000000001)))))))
(assert (=> (< 8 16) (= o2 ((_ zero_extend 8) o1))))
(assert (=> (< 8 16) (= o3 (bvshl o2 ((_ int2bv 16) 8)))))
(assert (=> (not (< 8 16)) (= o3 #x0000)))
...
(assert (not (= x86__readmem16__result4 (bvor ((_ zero_extend 8) (to_rep (select memory addr))) (ite (< 8 16) (bvshl ((_ zero_extend 8) (to_rep (select memory (bvadd addr #x0000000000000001)))) ((_ int2bv 16) 8)) #x0000)))))
(check-sat)
(exit)
