...
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) ((_ int2bv 8) 1)) (=> (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true) (dynamic_invariant us_self__compl15 true true true))))
...
(assert (=> (= (to_rep (rec__dw1000__register_types__sys_status_type__rxsfdto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) ((_ int2bv 8) 1)) (=> (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields11 (driver_type__content self__))) true) (= receiver__split_fields9 (us_split_fields5 us_self__compl16)))))
...
(assert (=> (not (= (to_rep (rec__dw1000__register_types__sys_status_type__rxsfdto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) ((_ int2bv 8) 1))) (= receiver__split_fields9 receiver__split_fields7)))
(assert (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfsl (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) ((_ int2bv 8) 1)))
(assert (= (rec__decadriver__driver_type__detect_rs_error (us_split_fields11 (driver_type__content self__))) true))
(assert (dynamic_invariant (mk___rep2 receiver__split_fields10) true true true))
