...
(declare-const o16 t)
(declare-const temp___1218 digit_index_type)
(declare-const temp___12181 (Array Int octet))
(declare-const temp___12182 t)
...
(assert (= (to_rep1 (last number__split_fields1)) r121b))
(assert (in_range1 r121b))
(assert (= result2 i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 r121b))
(assert (and (and (dynamic_invariant1 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true) (forall ((temp___1225 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1225) (<= temp___1225 (to_rep1 (last number__split_fields3)))) (=> (<= i2 temp___1225) (= (select number__split_fields2 temp___1225) (select number__split_fields temp___1225)))))) (and (<= 1 i2) (<= i2 r121b))))
