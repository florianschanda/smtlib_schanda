...
(define-fun dynamic_invariant ((temp___expr_6262 us_t1) (temp___is_init_6259 Bool) (temp___skip_constant_6260 Bool) (temp___do_toplevel_6261 Bool)) Bool (=> (not (= temp___skip_constant_6260 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6262) (last3 temp___expr_6262)) (and (= (first3 temp___expr_6262) 1) (= (last3 temp___expr_6262) 4)))))
