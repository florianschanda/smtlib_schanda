...
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= (mk___split_fields__ref (mk___split_fields result1)) char_table__split_fields11)))
...
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (and (= (invariant__ hash_table char_table__split_fields10 (mk___split_fields1 entry_table__split_fields)) true) (= (length1 (mk___rep char_table__split_discrs char_table__split_fields10)) (+ temp___684 i2)))))
...
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= char_table__split_fields4 (mk___split_fields__ref char_table__split_fields10))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= i4 i2)))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= char_table__split_fields5 char_table__split_fields10)))
...
(assert (=> (not (and (<= 1 i1) (<= i1 temp___686))) (= char_table__split_fields6 char_table__split_fields11)))
