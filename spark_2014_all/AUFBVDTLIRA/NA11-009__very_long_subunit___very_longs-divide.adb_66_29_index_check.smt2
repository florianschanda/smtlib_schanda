...
(declare-fun temp___1248 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1250 (_ BitVec 8))) (forall ((temp___1251 Int) (temp___1252 Int)) (let ((temp___1249 (temp___1248 temp___1250 temp___1251 temp___1252))) (=> (dynamic_invariant1 temp___1250 true true true true) (and (=> (dynamic_property6 1 65536 temp___1251 temp___1252) (and (= (first5 temp___1249) temp___1251) (= (last5 temp___1249) temp___1252))) (forall ((temp___1253 Int)) (= (to_rep1 (select (to_array2 temp___1249) temp___1253)) temp___1250))))))))
...
(declare-const temp___1265 us_rep)
...
(assert (= (to_rep2 (first4 (rt2 (temp___1248 #x00 1 r116b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1248 #x00 1 r116b)))) r116b))
(assert (= (mk___t2 temp___1255 temp___12551) (temp___1248 #x00 1 r116b)))
(assert (= (ite (<= (to_rep2 (first4 temp___12551)) (to_rep2 (last4 temp___12551))) (+ (- (to_rep2 (last4 temp___12551)) (to_rep2 (first4 temp___12551))) 1) 0) (ite (<= 1 r116b) (+ (- r116b 1) 1) 0)))
(assert (= temp___1255 temp___1256))
(assert (= (mk1 (to_rep2 (first4 temp___12551)) (to_rep2 (last4 temp___12551))) temp___12561))
(assert (= (ite (<= (to_rep2 (first2 temp___12561)) (to_rep2 (last2 temp___12561))) (+ (- (to_rep2 (last2 temp___12561)) (to_rep2 (first2 temp___12561))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1258 temp___12581) (mk___t1 temp___1256 temp___12561)))
(assert (= temp___1258 o))
(assert (= (mk (to_rep2 (first2 temp___12581)) (to_rep2 (last2 temp___12581))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (and (and (dynamic_invariant2 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1273 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1273) (<= temp___1273 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1273) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1273) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1273)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
...
(assert (= temp___1265 (mk___rep result____split_discrs o18)))
(assert (= result5 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1265)))
(assert (= result____split_discrs (us_split_discrs1 temp___1265)))
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields4)))) i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields4)))))))
(assert (= o19 i2))
...
(assert (not (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields4)))) i2)))
(check-sat)
(exit)
