...
(assert (= temp___1267 (mk___rep result____split_discrs o18)))
(assert (= result5 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1267)))
(assert (= result____split_discrs (us_split_discrs1 temp___1267)))
