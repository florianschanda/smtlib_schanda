...
(assert (and (= o16 (convertdomainnametowire (rec__rr_type__rrsig_record_type__rrsigrecordtype__signername (us_split_fields3 rrsig_record)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i 128)) (and (<= 0 (to_rep (select o16 i))) (<= (to_rep (select o16 i)) 255))))))
