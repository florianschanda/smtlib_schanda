...
(assert (=> (< temp___195 4294967296) (= o (bvshl #x00000001 ((_ int2bv 32) temp___195)))))
(assert (=> (not (< temp___195 4294967296)) (= o #x00000000)))
(assert (not (in_range1 (bv2nat (bvudiv i #x0000000000000020)))))
(check-sat)
(exit)
