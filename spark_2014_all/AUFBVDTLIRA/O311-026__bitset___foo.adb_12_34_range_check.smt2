...
(define-fun dynamic_invariant2 ((temp___expr_154 us_t) (temp___is_init_151 Bool) (temp___skip_constant_152 Bool) (temp___do_toplevel_153 Bool)) Bool (=> (not (= temp___skip_constant_152 true)) (dynamic_property 0 2147483646 (first1 temp___expr_154) (last1 temp___expr_154))))
...
(define-fun dynamic_invariant4 ((temp___expr_136 (_ BitVec 32)) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool true)
(define-fun dynamic_invariant5 ((temp___expr_148 Int) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (or (= temp___is_init_145 true) (<= 0 2147483646)) (in_range2 temp___expr_148)))
...
(assert (=> (< temp___168 4294967296) (= o (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___168)))))
(assert (=> (not (< temp___168 4294967296)) (= o ((_ int2bv 32) 0))))
(assert (not (in_range1 (bv2nat (bvudiv i ((_ int2bv 64) 32))))))
(check-sat)
(exit)
