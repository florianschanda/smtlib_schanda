...
(assert (= begidx1 1))
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 256)) (<= endidx1 256)) (=> (= foundtype1 1) (forall ((i7 Int)) (=> (and (<= begidx2 i7) (<= i7 endidx1)) (and (<= 48 (to_rep (select rrstring i7))) (<= (to_rep (select rrstring i7)) 57)))))) (and (and (in_range3 begidx2) (in_range3 endidx1)) (in_range2 foundtype1))))
(assert (= foundtype1 3))
...
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (and (and (and (and (<= begidx4 endidx3) (<= begidx4 256)) (<= endidx3 256)) (=> (= foundtype3 1) (forall ((i7 Int)) (=> (and (<= begidx4 i7) (<= i7 endidx3)) (and (<= 48 (to_rep (select rrstring i7))) (<= (to_rep (select rrstring i7)) 57)))))) (and (and (in_range3 begidx4) (in_range3 endidx3)) (in_range2 foundtype3)))))
...
(assert (= i1 #x00))
(assert (=> (and (bvule #x00 i1) (bvule i1 #xFF)) (= temp___1688 blocklengths1)))
(assert (=> (and (bvule #x00 i1) (bvule i1 #xFF)) (= temp___1686 blocknumbers1)))
(assert (=> (and (bvule #x00 i1) (bvule i1 #xFF)) (= temp___1685 numberofblocks2)))
(assert (=> (and (bvule #x00 i1) (bvule i1 #xFF)) (= temp___1684 i1)))
...
(assert (=> (and (bvule #x00 i1) (bvule i1 #xFF)) (and (=> (<= 0 32) (in_range8 numberofblocks3)) (and (bvule #x00 i2) (bvule i2 #xFF)))))
(assert (=> (and (bvule #x00 i1) (bvule i1 #xFF)) (=> (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) false) (and (= o43 (+ numberofblocks3 1)) (in_range8 (+ numberofblocks3 1))))))
