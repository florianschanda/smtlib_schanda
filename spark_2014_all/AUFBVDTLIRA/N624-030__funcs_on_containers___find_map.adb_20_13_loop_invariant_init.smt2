...
(assert (= (has_key (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields2))) e2) true))
(assert (not (<= (to_rep1 (first (rt a))) (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields2))) e2))))
(check-sat)
(exit)
