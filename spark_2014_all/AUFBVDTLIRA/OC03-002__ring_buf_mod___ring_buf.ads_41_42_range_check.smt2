...
(assert (=> (bvule ((_ int2bv 16) 0) temp___242) (and (and (bvule ((_ int2bv 16) 0) ((_ int2bv 16) 0)) (bvule ((_ int2bv 16) 0) ((_ int2bv 16) 65535))) (and (bvule ((_ int2bv 16) 0) temp___242) (bvule temp___242 ((_ int2bv 16) 65535))))))
...
(assert (=> (bvule (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) 65535)) (and (and (bvule ((_ int2bv 16) 0) (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))) (bvule (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) 65535))) (and (bvule ((_ int2bv 16) 0) ((_ int2bv 16) 65535)) (bvule ((_ int2bv 16) 65535) ((_ int2bv 16) 65535))))))
(assert (= o5 (rec__ring_buf__ring_buffer__data (us_split_fields1 r))))
(assert (= o5 temp___244))
(assert (= (mk1 (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) 65535)) temp___2441))
(assert (not (= (length1 (mk___t1 temp___244 temp___2441)) 0)))
(assert (=> (<= (bv2nat (to_rep (first4 temp___2451))) (bv2nat (to_rep (last4 temp___2451)))) (= o6 (+ (- (bv2nat (to_rep (last4 temp___2451))) (bv2nat (to_rep (first4 temp___2451)))) 1))))
(assert (=> (not (<= (bv2nat (to_rep (first4 temp___2451))) (bv2nat (to_rep (last4 temp___2451))))) (= o6 0)))
(assert (=> (<= (bv2nat (to_rep (first2 temp___2441))) (bv2nat (to_rep (last2 temp___2441)))) (= o7 (+ (- (bv2nat (to_rep (last2 temp___2441))) (bv2nat (to_rep (first2 temp___2441)))) 1))))
(assert (=> (not (<= (bv2nat (to_rep (first2 temp___2441))) (bv2nat (to_rep (last2 temp___2441))))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (bv2nat (to_rep (first2 temp___2441))) o8)))
(assert (= o10 (- o9 1)))
(assert (not (uint_in_range o10)))
(check-sat)
(exit)
