...
(declare-const temp___271 (Array (_ BitVec 16) integer))
...
(assert (=> (bvule (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) #xFFFF) (and (and (bvule #x0000 (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))) (bvule (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) #xFFFF)) (and (bvule #x0000 #xFFFF) (bvule #xFFFF #xFFFF)))))
(assert (= o5 (rec__ring_buf__ring_buffer__data (us_split_fields1 r))))
(assert (= o5 temp___271))
(assert (= (mk1 (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) #xFFFF) temp___2711))
(assert (not (= (length1 (mk___t1 temp___271 temp___2711)) 0)))
(assert (=> (<= (bv2nat (to_rep (first4 temp___2721))) (bv2nat (to_rep (last4 temp___2721)))) (= o6 (+ (- (bv2nat (to_rep (last4 temp___2721))) (bv2nat (to_rep (first4 temp___2721)))) 1))))
(assert (=> (not (<= (bv2nat (to_rep (first4 temp___2721))) (bv2nat (to_rep (last4 temp___2721))))) (= o6 0)))
(assert (=> (<= (bv2nat (to_rep (first2 temp___2711))) (bv2nat (to_rep (last2 temp___2711)))) (= o7 (+ (- (bv2nat (to_rep (last2 temp___2711))) (bv2nat (to_rep (first2 temp___2711)))) 1))))
(assert (=> (not (<= (bv2nat (to_rep (first2 temp___2711))) (bv2nat (to_rep (last2 temp___2711))))) (= o7 0)))
(assert (= o8 (+ o7 o6)))
(assert (= o9 (+ (bv2nat (to_rep (first2 temp___2711))) o8)))
(assert (= o10 (- o9 1)))
