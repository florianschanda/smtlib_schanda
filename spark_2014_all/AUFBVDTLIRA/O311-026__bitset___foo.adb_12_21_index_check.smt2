...
(assert (and (= o (bv2nat (bvudiv i ((_ int2bv 64) 32)))) (in_range1 (bv2nat (bvudiv i ((_ int2bv 64) 32))))))
(assert (= o1 (+ a_first o)))
(assert (and (= temp___167 o1) (in_range o1)))
(assert (not (<= (to_rep1 (first (rt a))) temp___167)))
(check-sat)
(exit)
