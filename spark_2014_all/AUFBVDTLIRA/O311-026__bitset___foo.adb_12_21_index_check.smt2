...
(define-fun dynamic_invariant1 ((temp___expr_166 (_ BitVec 64)) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_180 us_t) (temp___is_init_176 Bool) (temp___skip_constant_177 Bool) (temp___do_toplevel_178 Bool) (temp___do_typ_inv_179 Bool)) Bool (=> (not (= temp___skip_constant_177 true)) (dynamic_property 0 2147483646 (first1 temp___expr_180) (last1 temp___expr_180))))
...
(define-fun dynamic_invariant4 ((temp___expr_159 (_ BitVec 32)) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool true)
(define-fun dynamic_invariant5 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= 0 2147483646)) (in_range2 temp___expr_173)))
(declare-const o Int)
...
(assert (and (= temp___195 (bv2nat (bvurem i #x0000000000000020))) (in_range1 (bv2nat (bvurem i #x0000000000000020)))))
(assert (=> (< temp___195 4294967296) (= o2 (bvshl #x00000001 ((_ int2bv 32) temp___195)))))
(assert (=> (not (< temp___195 4294967296)) (= o2 #x00000000)))
(assert (and (= o (bv2nat (bvudiv i #x0000000000000020))) (in_range1 (bv2nat (bvudiv i #x0000000000000020)))))
(assert (= o1 (+ a_first o)))
(assert (and (= temp___194 o1) (in_range o1)))
(assert (not (<= (to_rep1 (first (rt a))) temp___194)))
(check-sat)
(exit)
