...
(assert (and (= (mk___t2 temp___7986 temp___79861) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7986 temp___79861) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___79861)) (to_rep (last4 temp___79861))) (+ (- (to_rep (last4 temp___79861)) (to_rep (first4 temp___79861))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
