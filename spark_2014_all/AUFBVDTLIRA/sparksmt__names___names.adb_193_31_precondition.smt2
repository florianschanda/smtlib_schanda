...
(assert (forall ((x name_id)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(define-fun in_range3 ((rec__names__data__char_tables__vector__capacity1 Int) (a us_rep)) Bool (= rec__names__data__char_tables__vector__capacity1 (to_rep1 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 a)))))
...
(assert (forall ((x capacity_range1)) (! (in_range4 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x Int)) (! (=> (in_range4 x) (= (to_rep2 (of_rep2 x)) x)) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun in_range5 ((rec__names__data__entry_tables__vector__capacity1 Int) (a us_rep1)) Bool (= rec__names__data__entry_tables__vector__capacity1 (to_rep2 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 a)))))
...
(assert (forall ((x positive)) (! (in_range6 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 2147483647)) (in_range1 temp___expr_210)))
...
(define-fun dynamic_invariant4 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range8 temp___expr_166)))
(define-fun dynamic_invariant5 ((temp___expr_304 Int) (temp___is_init_300 Bool) (temp___skip_constant_301 Bool) (temp___do_toplevel_302 Bool) (temp___do_typ_inv_303 Bool)) Bool (=> (or (= temp___is_init_300 true) (<= 0 2147483646)) (in_range7 temp___expr_304)))
...
(define-fun dynamic_invariant6 ((temp___expr_325 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool) (temp___do_typ_inv_324 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= (- 1) 2147483647)) (in_range9 temp___expr_325)))
(define-fun dynamic_invariant7 ((temp___expr_332 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool) (temp___do_typ_inv_331 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 0 2147483647)) (in_range2 temp___expr_332)))
...
(define-fun dynamic_invariant11 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 2147483647)) (in_range4 temp___expr_496)))
...
(assert (= 1024 (to_rep1 (rec__names__data__char_tables__vector__capacity char_table__split_discrs))))
(assert (= 256 (to_rep2 (rec__names__data__entry_tables__vector__capacity entry_table__split_discrs))))
(assert (and (= o (valid_hashes hash_table (mk___split_fields1 entry_table__split_fields))) (= (= o true) (forall ((h (_ BitVec 32))) (=> (and (bvule #x00000000 h) (bvule h #x000000FF)) (<= (to_rep (select hash_table h)) (last1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))))))))))
(assert (and (= result (valid_tables (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (= (= result true) (and (<= (last1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields)))) 2147483647) (<= (last (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields)))) 2147483646)))))
(assert (= result true))
