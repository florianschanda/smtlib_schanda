...
(define-fun dynamic_invariant3 ((temp___expr_180 Int) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (or (= temp___is_init_177 true) (<= 0 2147483647)) (in_range1 temp___expr_180)))
...
(define-fun dynamic_invariant4 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range8 temp___expr_142)))
(define-fun dynamic_invariant5 ((temp___expr_264 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool)) Bool (=> (or (= temp___is_init_261 true) (<= 0 2147483646)) (in_range7 temp___expr_264)))
...
(define-fun dynamic_invariant6 ((temp___expr_282 Int) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool)) Bool (=> (or (= temp___is_init_279 true) (<= (- 1) 2147483647)) (in_range9 temp___expr_282)))
(define-fun dynamic_invariant7 ((temp___expr_288 Int) (temp___is_init_285 Bool) (temp___skip_constant_286 Bool) (temp___do_toplevel_287 Bool)) Bool (=> (or (= temp___is_init_285 true) (<= 0 2147483647)) (in_range2 temp___expr_288)))
...
(define-fun dynamic_invariant11 ((temp___expr_442 Int) (temp___is_init_439 Bool) (temp___skip_constant_440 Bool) (temp___do_toplevel_441 Bool)) Bool (=> (or (= temp___is_init_439 true) (<= 0 2147483647)) (in_range4 temp___expr_442)))
...
(assert (and (= o (valid_hashes hash_table (mk___split_fields1 entry_table__split_fields))) (= (= o true) (forall ((h (_ BitVec 32))) (=> (and (bvule ((_ int2bv 32) 0) h) (bvule h ((_ int2bv 32) 255))) (<= (to_rep (select hash_table h)) (last1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))))))))))
