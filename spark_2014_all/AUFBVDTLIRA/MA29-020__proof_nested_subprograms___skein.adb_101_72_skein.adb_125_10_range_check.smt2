...
(define-fun dynamic_invariant ((temp___expr_288 (_ BitVec 64)) (temp___is_init_285 Bool) (temp___skip_constant_286 Bool) (temp___do_toplevel_287 Bool)) Bool true)
...
(define-fun in_range3 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 7))))
...
(define-fun in_range4 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 63))))
...
(declare-sort u7 0)
(define-fun in_range5 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 127))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 128)))) (=> (in_range5 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
(define-fun to_int12 ((x u7)) Int (bv2nat (to_rep6 x)))
(assert (forall ((x u7)) (! (in_range_int3 (to_int12 x)) :pattern ((to_int12 x)))))
(declare-sort u6 0)
(define-fun in_range6 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 63))))
...
(define-fun dynamic_invariant1 ((temp___expr_541 (_ BitVec 8)) (temp___is_init_538 Bool) (temp___skip_constant_539 Bool) (temp___do_toplevel_540 Bool)) Bool (=> (or (= temp___is_init_538 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 63))) (in_range6 temp___expr_541)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 64)))) (=> (in_range6 y) (= (to_rep7 (of_rep7 x)) y))) :pattern ((to_rep7 (of_rep7 x))))))
(define-fun to_int13 ((x u6)) Int (bv2nat (to_rep7 x)))
(assert (forall ((x u6)) (! (in_range_int4 (to_int13 x)) :pattern ((to_int13 x)))))
...
(define-fun in_range7 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 1) x) (bvule x ((_ int2bv 64) 2305843009213693951))))
...
(define-fun dynamic_invariant2 ((temp___expr_671 (_ BitVec 64)) (temp___is_init_668 Bool) (temp___skip_constant_669 Bool) (temp___do_toplevel_670 Bool)) Bool (=> (or (= temp___is_init_668 true) (bvule ((_ int2bv 64) 1) ((_ int2bv 64) 2305843009213693951))) (in_range7 temp___expr_671)))
(declare-sort output_block_count_t 0)
(declare-const attr__ATTRIBUTE_MODULUS9 (_ BitVec 64))
(define-fun in_range8 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 36028797018963968))))
...
(define-fun dynamic_invariant3 ((temp___expr_677 (_ BitVec 64)) (temp___is_init_674 Bool) (temp___skip_constant_675 Bool) (temp___do_toplevel_676 Bool)) Bool (=> (or (= temp___is_init_674 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 36028797018963968))) (in_range8 temp___expr_677)))
(declare-sort positive_output_block_count_t 0)
(declare-const attr__ATTRIBUTE_MODULUS10 (_ BitVec 64))
(define-fun in_range9 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 1) x) (bvule x ((_ int2bv 64) 36028797018963968))))
...
(define-fun dynamic_invariant4 ((temp___expr_683 (_ BitVec 64)) (temp___is_init_680 Bool) (temp___skip_constant_681 Bool) (temp___do_toplevel_682 Bool)) Bool (=> (or (= temp___is_init_680 true) (bvule ((_ int2bv 64) 1) ((_ int2bv 64) 36028797018963968))) (in_range9 temp___expr_683)))
...
(assert (forall ((temp___693 (_ BitVec 8))) (forall ((temp___694 (_ BitVec 64)) (temp___695 (_ BitVec 64))) (let ((temp___692 (temp___691 temp___693 temp___694 temp___695))) (and (=> (dynamic_property ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551615) temp___694 temp___695) (and (= (first3 temp___692) temp___694) (= (last3 temp___692) temp___695))) (forall ((temp___696 (_ BitVec 64))) (= (select (to_array1 temp___692) temp___696) (of_rep1 temp___693))))))))
(declare-fun temp___712 ((_ BitVec 8)) (Array (_ BitVec 64) byte))
(assert (forall ((temp___714 (_ BitVec 8))) (forall ((temp___715 (_ BitVec 64))) (= (select (temp___712 temp___714) temp___715) (of_rep1 temp___714)))))
...
(define-fun dynamic_invariant6 ((temp___expr_270 (_ BitVec 8)) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool)) Bool true)
(define-fun dynamic_invariant7 ((temp___expr_276 (_ BitVec 16)) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool)) Bool true)
(define-fun dynamic_invariant8 ((temp___expr_282 (_ BitVec 32)) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool)) Bool true)
(define-fun dynamic_invariant9 ((temp___expr_348 us_t) (temp___is_init_345 Bool) (temp___skip_constant_346 Bool) (temp___do_toplevel_347 Bool)) Bool (=> (not (= temp___skip_constant_346 true)) (dynamic_property ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551615) (first1 temp___expr_348) (last1 temp___expr_348))))
(define-fun dynamic_invariant10 ((temp___expr_460 (_ BitVec 64)) (temp___is_init_457 Bool) (temp___skip_constant_458 Bool) (temp___do_toplevel_459 Bool)) Bool (=> (or (= temp___is_init_457 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551608))) (in_range2 temp___expr_460)))
(define-fun dynamic_invariant11 ((temp___expr_472 (_ BitVec 64)) (temp___is_init_469 Bool) (temp___skip_constant_470 Bool) (temp___do_toplevel_471 Bool)) Bool (=> (or (= temp___is_init_469 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 7))) (in_range3 temp___expr_472)))
(define-fun dynamic_invariant12 ((temp___expr_493 (_ BitVec 64)) (temp___is_init_490 Bool) (temp___skip_constant_491 Bool) (temp___do_toplevel_492 Bool)) Bool (=> (or (= temp___is_init_490 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 63))) (in_range4 temp___expr_493)))
(define-fun dynamic_invariant13 ((temp___expr_535 (_ BitVec 8)) (temp___is_init_532 Bool) (temp___skip_constant_533 Bool) (temp___do_toplevel_534 Bool)) Bool (=> (or (= temp___is_init_532 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 127))) (in_range5 temp___expr_535)))
(define-fun dynamic_invariant14 ((temp___expr_246 (_ BitVec 64)) (temp___is_init_243 Bool) (temp___skip_constant_244 Bool) (temp___do_toplevel_245 Bool)) Bool true)
...
(declare-const o54 (Array (_ BitVec 64) byte))
...
(assert true)
(assert (=> (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 36028797018963968)) (in_range8 blocks_done)))
(assert (=> (bvule ((_ int2bv 64) 1) ((_ int2bv 64) 36028797018963968)) (in_range9 blocks_required)))
(assert (=> (bvule ((_ int2bv 64) 1) ((_ int2bv 64) 2305843009213693951)) (in_range7 byte_count)))
...
(assert (= (to_rep (first2 (rt1 (temp___691 ((_ int2bv 8) 0) (to_rep hash__first) (to_rep hash__last))))) (to_rep hash__first)))
(assert (= (to_rep (last2 (rt1 (temp___691 ((_ int2bv 8) 0) (to_rep hash__first) (to_rep hash__last))))) (to_rep hash__last)))
(assert (= (mk___t1 temp___698 temp___6981) (temp___691 ((_ int2bv 8) 0) (to_rep hash__first) (to_rep hash__last))))
(assert (= temp___698 temp___699))
(assert (= (mk (to_rep (first2 temp___6981)) (to_rep (last2 temp___6981))) temp___6991))
(assert (= (ite (<= (bv2nat (to_rep (first temp___6991))) (bv2nat (to_rep (last temp___6991)))) (+ (- (bv2nat (to_rep (last temp___6991))) (bv2nat (to_rep (first temp___6991)))) 1) 0) (ite (<= (bv2nat (to_rep hash__first)) (bv2nat (to_rep hash__last))) (+ (- (bv2nat (to_rep hash__last)) (bv2nat (to_rep hash__first))) 1) 0)))
(assert (= (mk___t temp___700 temp___7001) (mk___t temp___699 temp___6991)))
(assert (= o (slide temp___700 (to_rep (first temp___7001)) (to_rep hash__first))))
...
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (= (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) r14b)))
(assert true)
...
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (= i2 r14b)))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= local_ctx__split_fields13 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields temp___708 temp___7081 temp___7082 temp___7083 temp___7084 temp___7085 temp___7086 temp___7087)) temp___7088 temp___7089)) temp___70810 temp___70811)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (and (and (and (= (rec__skein__skein_512_context__h local_ctx__split_fields14) (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields temp___708 temp___7081 temp___7082 temp___7083 temp___7084 temp___7085 temp___7086 temp___7087)) temp___7088 temp___7089))) (= (rec__skein__skein_512_context__x local_ctx__split_fields14) temp___70810)) (forall ((temp___709 (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) temp___709) (bvule temp___709 ((_ int2bv 64) 63))) (=> (bvule i3 temp___709) (= (select (rec__skein__skein_512_context__b local_ctx__split_fields14) temp___709) (select temp___70811 temp___709)))))) (and (bvule r14b i3) (bvule i3 ((_ int2bv 64) 63)))))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= (to_rep1 o1) ((_ int2bv 8) 0)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= o2 (store (rec__skein__skein_512_context__b local_ctx__split_fields14) i3 o1)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= o3 (mk___split_fields2 (rec__skein__skein_512_context__h local_ctx__split_fields14) (rec__skein__skein_512_context__x local_ctx__split_fields14) o2)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= temp___707 (mk___rep2 o3)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= result4 (mk___split_fields__ref2 local_ctx__split_fields14)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= local_ctx__split_fields15 (us_split_fields5 temp___707)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= i3 ((_ int2bv 64) 63)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= i4 (mk_t__ref3 i3)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= local_ctx__split_fields16 (mk___split_fields__ref2 local_ctx__split_fields15)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= i5 i3))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= local_ctx__split_fields17 local_ctx__split_fields15))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= i6 i4))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= local_ctx__split_fields18 local_ctx__split_fields16))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= i7 i5))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63))) (= local_ctx__split_fields19 local_ctx__split_fields17))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (not (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63)))) (= i6 (mk_t__ref3 i2)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (not (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63)))) (= local_ctx__split_fields18 (mk___split_fields__ref2 local_ctx__split_fields13)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (not (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63)))) (= i7 i2))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (not (and (bvule r14b i2) (bvule i2 ((_ int2bv 64) 63)))) (= local_ctx__split_fields19 local_ctx__split_fields13))))
...
(assert (and (= o4 (bvudiv (bvadd (to_rep5 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields__content2 local_ctx__split_fields20))))) ((_ int2bv 64) 7)) ((_ int2bv 64) 8))) (in_range7 (bvudiv (bvadd (to_rep5 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields__content2 local_ctx__split_fields20))))) ((_ int2bv 64) 7)) ((_ int2bv 64) 8)))))
(assert (= result5 (mk_t__ref3 byte_count)))
(assert (= byte_count1 o4))
(assert (= result6 local_ctx__split_fields20))
(assert (= local_ctx__split_fields22 (mk___split_fields2 (rec__skein__skein_512_context__h (us_split_fields__content2 local_ctx__split_fields20)) (rec__skein__skein_512_context__x (us_split_fields__content2 local_ctx__split_fields20)) (temp___712 ((_ int2bv 8) 0)))))
...
(assert (and (and (= (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields23))) (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields22)))) (forall ((temp___759 (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) temp___759) (bvule temp___759 ((_ int2bv 64) 63))) (=> (and (not (= ((_ int2bv 64) 1) temp___759)) (and (not (= ((_ int2bv 64) 4) temp___759)) (and (not (= ((_ int2bv 64) 7) temp___759)) (and (not (= ((_ int2bv 64) 0) temp___759)) (and (not (= ((_ int2bv 64) 3) temp___759)) (and (not (= ((_ int2bv 64) 6) temp___759)) (and (not (= ((_ int2bv 64) 2) temp___759)) (not (= ((_ int2bv 64) 5) temp___759))))))))) (= (select (rec__skein__skein_512_context__b local_ctx__split_fields23) temp___759) (select (rec__skein__skein_512_context__b local_ctx__split_fields22) temp___759)))))) (=> (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 36028797018963968)) (in_range8 blocks_done2))))
(assert (= blocks_done2 c18b))
(assert true)
(assert (= (to_rep1 o5) ((_ extract 7 0) (bvand c18b ((_ int2bv 64) 255)))))
(assert (= o6 (store (rec__skein__skein_512_context__b local_ctx__split_fields23) ((_ int2bv 64) 0) o5)))
...
(assert (= (to_rep1 o8) ((_ extract 7 0) (bvand (bvlshr c18b ((_ int2bv 64) 8)) ((_ int2bv 64) 255)))))
(assert (= o9 (store (rec__skein__skein_512_context__b local_ctx__split_fields24) ((_ int2bv 64) 1) o8)))
...
(assert (= (to_rep1 o11) ((_ extract 7 0) (bvand (bvlshr c18b ((_ int2bv 64) 16)) ((_ int2bv 64) 255)))))
(assert (= o12 (store (rec__skein__skein_512_context__b local_ctx__split_fields25) ((_ int2bv 64) 2) o11)))
...
(assert (= (to_rep1 o14) ((_ extract 7 0) (bvand (bvlshr c18b ((_ int2bv 64) 24)) ((_ int2bv 64) 255)))))
(assert (= o15 (store (rec__skein__skein_512_context__b local_ctx__split_fields26) ((_ int2bv 64) 3) o14)))
...
(assert (= temp___729 (mk___rep2 o16)))
(assert (= result13 (mk___split_fields__ref2 local_ctx__split_fields26)))
(assert (= local_ctx__split_fields27 (us_split_fields5 temp___729)))
(assert (= (to_rep1 o17) ((_ extract 7 0) (bvand (bvlshr c18b ((_ int2bv 64) 32)) ((_ int2bv 64) 255)))))
(assert (= o18 (store (rec__skein__skein_512_context__b local_ctx__split_fields27) ((_ int2bv 64) 4) o17)))
...
(assert (= temp___732 (mk___rep2 o19)))
(assert (= result14 (mk___split_fields__ref2 local_ctx__split_fields27)))
(assert (= local_ctx__split_fields28 (us_split_fields5 temp___732)))
(assert (= (to_rep1 o20) ((_ extract 7 0) (bvand (bvlshr c18b ((_ int2bv 64) 40)) ((_ int2bv 64) 255)))))
(assert (= o21 (store (rec__skein__skein_512_context__b local_ctx__split_fields28) ((_ int2bv 64) 5) o20)))
...
(assert (= temp___735 (mk___rep2 o22)))
(assert (= result15 (mk___split_fields__ref2 local_ctx__split_fields28)))
(assert (= local_ctx__split_fields29 (us_split_fields5 temp___735)))
(assert (not (bvule ((_ zero_extend 56) ((_ int2bv 8) 0)) (bvand (bvlshr c18b ((_ int2bv 64) 48)) ((_ int2bv 64) 255)))))
(check-sat)
(exit)
