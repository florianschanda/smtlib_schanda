...
(declare-fun temp___785 ((_ BitVec 8) (_ BitVec 64) (_ BitVec 64)) us_t1)
(declare-fun temp___806 ((_ BitVec 8)) (Array (_ BitVec 64) byte))
...
(assert (forall ((temp___787 (_ BitVec 8))) (forall ((temp___788 (_ BitVec 64)) (temp___789 (_ BitVec 64))) (let ((temp___786 (temp___785 temp___787 temp___788 temp___789))) (=> (dynamic_invariant6 temp___787 true true true true) (and (=> (dynamic_property #x0000000000000000 #xFFFFFFFFFFFFFFFF temp___788 temp___789) (and (= (first3 temp___786) temp___788) (= (last3 temp___786) temp___789))) (forall ((temp___790 (_ BitVec 64))) (= (to_rep1 (select (to_array1 temp___786) temp___790)) temp___787))))))))
(assert (forall ((temp___808 (_ BitVec 8))) (=> (dynamic_invariant6 temp___808 true true true true) (forall ((temp___809 (_ BitVec 64))) (= (to_rep1 (select (temp___806 temp___808) temp___809)) temp___808)))))
...
(declare-const temp___802 u64)
(declare-const temp___8021 u32)
(declare-const temp___8022 u16)
(declare-const temp___8023 u7)
(declare-const temp___8024 Bool)
(declare-const temp___8025 u6)
(declare-const temp___8026 Bool)
(declare-const temp___8027 Bool)
(declare-const temp___8028 hash_bit_length)
(declare-const temp___8029 u64)
(declare-const temp___80210 (Array (_ BitVec 64) u64))
(declare-const temp___80211 (Array (_ BitVec 64) byte))
(declare-const o1 byte)
(declare-const o2 (Array (_ BitVec 64) byte))
(declare-const o3 us_split_fields4)
(declare-const temp___801 us_rep2)
...
(assert (= (to_rep (first2 (rt1 (temp___785 #x00 (to_rep hash__first) (to_rep hash__last))))) (to_rep hash__first)))
(assert (= (to_rep (last2 (rt1 (temp___785 #x00 (to_rep hash__first) (to_rep hash__last))))) (to_rep hash__last)))
(assert (= (mk___t1 temp___792 temp___7921) (temp___785 #x00 (to_rep hash__first) (to_rep hash__last))))
...
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) #x0000000000000040) (=> (and (bvule r14b i2) (bvule i2 #x000000000000003F)) (= local_ctx__split_fields13 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields temp___802 temp___8021 temp___8022 temp___8023 temp___8024 temp___8025 temp___8026 temp___8027)) temp___8028 temp___8029)) temp___80210 temp___80211)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) #x0000000000000040) (=> (and (bvule r14b i2) (bvule i2 #x000000000000003F)) (and (and (and (= (rec__skein__skein_512_context__h local_ctx__split_fields14) (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields temp___802 temp___8021 temp___8022 temp___8023 temp___8024 temp___8025 temp___8026 temp___8027)) temp___8028 temp___8029))) (= (rec__skein__skein_512_context__x local_ctx__split_fields14) temp___80210)) (forall ((temp___803 (_ BitVec 64))) (=> (and (bvule #x0000000000000000 temp___803) (bvule temp___803 #x000000000000003F)) (=> (bvule i3 temp___803) (= (select (rec__skein__skein_512_context__b local_ctx__split_fields14) temp___803) (select temp___80211 temp___803)))))) (and (bvule r14b i3) (bvule i3 #x000000000000003F))))))
...
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) #x0000000000000040) (=> (and (bvule r14b i2) (bvule i2 #x000000000000003F)) (= temp___801 (mk___rep2 o3)))))
...
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) #x0000000000000040) (=> (and (bvule r14b i2) (bvule i2 #x000000000000003F)) (= local_ctx__split_fields15 (us_split_fields5 temp___801)))))
...
(assert (= local_ctx__split_fields22 (mk___split_fields2 (rec__skein__skein_512_context__h (us_split_fields__content2 local_ctx__split_fields20)) (rec__skein__skein_512_context__x (us_split_fields__content2 local_ctx__split_fields20)) (temp___806 #x00))))
...
(assert (not (bvule ((_ zero_extend 56) #x00) (bvand (bvlshr c18b ((_ int2bv 64) 48)) #x00000000000000FF))))
(check-sat)
(exit)
