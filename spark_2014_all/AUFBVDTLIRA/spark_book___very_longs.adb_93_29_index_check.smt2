...
(assert (= (to_rep2 (first4 (rt2 (temp___1220 #x00 1 r19b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1220 #x00 1 r19b)))) r19b))
(assert (= (mk___t2 temp___1227 temp___12271) (temp___1220 #x00 1 r19b)))
(assert (= (ite (<= (to_rep2 (first4 temp___12271)) (to_rep2 (last4 temp___12271))) (+ (- (to_rep2 (last4 temp___12271)) (to_rep2 (first4 temp___12271))) 1) 0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))
(assert (= temp___1227 temp___1228))
(assert (= (mk1 (to_rep2 (first4 temp___12271)) (to_rep2 (last4 temp___12271))) temp___12281))
(assert (= (ite (<= (to_rep2 (first2 temp___12281)) (to_rep2 (last2 temp___12281))) (+ (- (to_rep2 (last2 temp___12281)) (to_rep2 (first2 temp___12281))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1230 temp___12301) (mk___t1 temp___1228 temp___12281)))
(assert (= temp___1230 o))
(assert (= (mk (to_rep2 (first2 temp___12301)) (to_rep2 (last2 temp___12301))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (and (and (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1240 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1240) (<= temp___1240 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1240) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1240) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1240)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
