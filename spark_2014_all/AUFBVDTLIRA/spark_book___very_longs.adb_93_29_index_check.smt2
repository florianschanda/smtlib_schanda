...
(assert (= (to_rep2 (first4 (rt2 (temp___1151 ((_ int2bv 8) 0) 1 r19b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1151 ((_ int2bv 8) 0) 1 r19b)))) r19b))
(assert (= (mk___t2 temp___1158 temp___11581) (temp___1151 ((_ int2bv 8) 0) 1 r19b)))
(assert (= (ite (<= (to_rep2 (first4 temp___11581)) (to_rep2 (last4 temp___11581))) (+ (- (to_rep2 (last4 temp___11581)) (to_rep2 (first4 temp___11581))) 1) 0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))
(assert (= temp___1158 temp___1159))
(assert (= (mk1 (to_rep2 (first4 temp___11581)) (to_rep2 (last4 temp___11581))) temp___11591))
(assert (= (ite (<= (to_rep2 (first2 temp___11591)) (to_rep2 (last2 temp___11591))) (+ (- (to_rep2 (last2 temp___11591)) (to_rep2 (first2 temp___11591))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1161 temp___11611) (mk___t1 temp___1159 temp___11591)))
(assert (= temp___1161 o))
(assert (= (mk (to_rep2 (first2 temp___11611)) (to_rep2 (last2 temp___11611))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1163)))
(assert (= temp___11631 o2))
(assert (= temp___11632 o3))
(assert (= result result____split_fields))
(assert (= result1 result____split_fields1))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___11631 temp___11632))))
(assert (= result____split_discrs (mk___split_discrs temp___1163)))
...
(assert (and (and (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true) (forall ((temp___1171 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1171) (<= temp___1171 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1171) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1171) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1171)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (= result5 (mk_t__ref1 r_digit1)))
(assert (= r_digit2 o11))
(assert (= result6 (mk_t__ref1 difference2)))
(assert (= difference3 (bvsub (bvsub l_digit2 r_digit2) borrow2)))
(assert (=> (not (= (bvand difference3 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0))) (= result7 (mk_t__ref1 borrow2))))
(assert (=> (not (= (bvand difference3 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0))) (= borrow3 ((_ int2bv 16) 1))))
(assert (=> (= (bvand difference3 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0)) (= result8 (mk_t__ref1 borrow2))))
