...
(assert (and (and (dynamic_invariant4 (mk___rep result____split_discrs result____split_fields3) false true true) (forall ((temp___1399 Int)) (=> (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) temp___1399) (<= temp___1399 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1399) (= (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) temp___1399) (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields2)) temp___1399)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (= r_digit3 o11))
(assert (= result5 (mk_t__ref1 sum2)))
(assert (= sum3 (bvadd (bvadd l_digit3 r_digit3) carry2)))
(assert (and (= o12 (shift_right sum3 8)) (= o12 (bvudiv sum3 (ite (< 8 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) 8)) ((_ int2bv 16) 0))))))
(assert (= result6 (mk_t__ref1 carry2)))
(assert (= carry3 o12))
(assert (= o13 (takelsb_from16 sum3)))
(assert (= (to_rep o14) o13))
(assert (not (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) i2)))
(check-sat)
(exit)
