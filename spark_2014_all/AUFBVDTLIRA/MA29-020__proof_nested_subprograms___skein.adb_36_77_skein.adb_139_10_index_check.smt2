...
(assert (and (= o43 (bv2nat (bvmul ((_ int2bv 64) 8) (bvand n7 ((_ int2bv 64) 7))))) (in_range1 (bv2nat (bvmul ((_ int2bv 64) 8) (bvand n7 ((_ int2bv 64) 7)))))))
(assert (= o44 ((_ int2bv 64) o43)))
(assert (not (bvule ((_ int2bv 64) 0) (bvudiv n7 ((_ int2bv 64) 8)))))
(check-sat)
(exit)
