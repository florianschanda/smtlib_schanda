...
(assert (forall ((temp___4502 (_ BitVec 32))) (forall ((temp___4503 Int)) (= (select (temp___4500 temp___4502) temp___4503) (of_rep3 temp___4502)))))
(define-fun default_initial_assumption ((temp___expr_4498 us_rep3) (temp___skip_top_level_4499 Bool)) Bool (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep3 (rec__decadriver__driver_type__part_id (us_split_fields7 temp___expr_4498))) ((_ int2bv 32) 0)) (= (to_rep3 (rec__decadriver__driver_type__lot_id (us_split_fields7 temp___expr_4498))) ((_ int2bv 32) 0))) (= (to_rep2 (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields7 temp___expr_4498))) ((_ int2bv 16) 0))) (= (to_rep2 (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields7 temp___expr_4498))) ((_ int2bv 16) 0))) (= (to_rep1 (rec__decadriver__driver_type__xtal_trim (us_split_fields7 temp___expr_4498))) ((_ int2bv 8) 16))) (= (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields7 temp___expr_4498)) (temp___4500 ((_ int2bv 32) 0)))) (= (rec__decadriver__driver_type__long_frames (us_split_fields7 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields7 temp___expr_4498)) (mk___rep (mk___split_fields (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep4 ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep5 ((_ int2bv 8) 0)) (of_rep1 ((_ int2bv 8) 0)))))) (= (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields7 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields7 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields7 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields7 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_phr_error (us_split_fields7 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_rs_error (us_split_fields7 temp___expr_4498)) (of_int 0))) (= (rec__decadriver__driver_type__detect_fcs_error (us_split_fields7 temp___expr_4498)) (of_int 0))))
...
(assert (forall ((temp___4628 (_ BitVec 32))) (forall ((temp___4629 Int)) (= (select (temp___4626 temp___4628) temp___4629) (of_rep3 temp___4628)))))
...
(assert (= (to_rep2 o6) ((_ extract 15 0) (bvand word ((_ int2bv 32) 65535)))))
...
(assert (not (bvule ((_ zero_extend 16) ((_ int2bv 16) 0)) (bvand word1 ((_ int2bv 32) 65535)))))
(check-sat)
(exit)
