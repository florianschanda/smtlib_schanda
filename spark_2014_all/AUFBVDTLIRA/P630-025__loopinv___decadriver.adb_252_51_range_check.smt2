...
(define-fun in_range2 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 31))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 32)))) (=> (in_range2 y) (= (to_rep1 (of_rep1 x)) y))) :pattern ((to_rep1 (of_rep1 x))))))
(define-fun to_int6 ((x bits_5)) Int (bv2nat (to_rep1 x)))
(assert (forall ((x bits_5)) (! (in_range_int1 (to_int6 x)) :pattern ((to_int6 x)))))
(declare-sort bits_11 0)
(define-fun in_range3 ((x (_ BitVec 16))) Bool (and (bvule ((_ int2bv 16) 0) x) (bvule x ((_ int2bv 16) 2047))))
...
(assert (forall ((x bits_16)) (! (uint_in_range1 (to_int7 x)) :pattern ((to_int7 x)))))
...
(define-fun dynamic_invariant ((temp___expr_467 (_ BitVec 32)) (temp___is_init_464 Bool) (temp___skip_constant_465 Bool) (temp___do_toplevel_466 Bool)) Bool true)
...
(assert (forall ((x bits_32)) (! (uint_in_range2 (to_int8 x)) :pattern ((to_int8 x)))))
(declare-sort bits_2 0)
(define-fun in_range4 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 3))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 4)))) (=> (in_range4 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
...
(define-fun in_range5 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 7))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 8)))) (=> (in_range5 y) (= (to_rep5 (of_rep5 x)) y))) :pattern ((to_rep5 (of_rep5 x))))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 64)))) (=> (in_range6 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
(define-fun to_int11 ((x bits_6)) Int (bv2nat (to_rep6 x)))
(assert (forall ((x bits_6)) (! (in_range_int5 (to_int11 x)) :pattern ((to_int11 x)))))
...
(assert (forall ((x bits_8)) (! (uint_in_range (to_int12 x)) :pattern ((to_int12 x)))))
...
(define-fun bool_eq3 ((a (Array Int bits_32)) (a__first Int) (a__last Int) (b (Array Int bits_32)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_184 Int)) (=> (and (<= a__first temp___idx_184) (<= temp___idx_184 a__last)) (= (to_rep3 (select a temp___idx_184)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_184))))))) true false))
(assert (forall ((a (Array Int bits_32)) (b (Array Int bits_32))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_184 Int)) (=> (and (<= a__first temp___idx_184) (<= temp___idx_184 a__last)) (= (to_rep3 (select a temp___idx_184)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_184)))))))))))
(declare-fun compare ((Array Int bits_32) Int Int (Array Int bits_32) Int Int) Int)
(assert (forall ((a (Array Int bits_32)) (b (Array Int bits_32))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq3 a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bits_32)) (b (Array Int bits_32))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq3 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (bvult (to_rep3 (select a (+ i 1))) (to_rep3 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bits_32)) (b (Array Int bits_32))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq3 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (bvugt (to_rep3 (select a (+ j 1))) (to_rep3 (select b (+ i 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(assert (forall ((temp___4492 (_ BitVec 32))) (forall ((temp___4493 Int)) (= (select (temp___4490 temp___4492) temp___4493) (of_rep3 temp___4492)))))
(define-fun default_initial_assumption ((temp___expr_4488 us_rep3) (temp___skip_top_level_4489 Bool)) Bool (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep3 (rec__decadriver__driver_type__part_id (us_split_fields7 temp___expr_4488))) ((_ int2bv 32) 0)) (= (to_rep3 (rec__decadriver__driver_type__lot_id (us_split_fields7 temp___expr_4488))) ((_ int2bv 32) 0))) (= (to_rep2 (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields7 temp___expr_4488))) ((_ int2bv 16) 0))) (= (to_rep2 (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields7 temp___expr_4488))) ((_ int2bv 16) 0))) (= (to_rep1 (rec__decadriver__driver_type__xtal_trim (us_split_fields7 temp___expr_4488))) ((_ int2bv 8) 16))) (= (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields7 temp___expr_4488)) (temp___4490 ((_ int2bv 32) 0)))) (= (rec__decadriver__driver_type__long_frames (us_split_fields7 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields7 temp___expr_4488)) (mk___rep (mk___split_fields (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep4 ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep ((_ int2bv 8) 0)) (of_rep5 ((_ int2bv 8) 0)) (of_rep1 ((_ int2bv 8) 0)))))) (= (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields7 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields7 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields7 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields7 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__detect_phr_error (us_split_fields7 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__detect_rs_error (us_split_fields7 temp___expr_4488)) (of_int 0))) (= (rec__decadriver__driver_type__detect_fcs_error (us_split_fields7 temp___expr_4488)) (of_int 0))))
...
(declare-fun temp___4616 ((_ BitVec 32)) (Array Int bits_32))
(assert (forall ((temp___4618 (_ BitVec 32))) (forall ((temp___4619 Int)) (= (select (temp___4616 temp___4618) temp___4619) (of_rep3 temp___4618)))))
(define-fun dynamic_invariant1 ((temp___expr_281 (_ BitVec 8)) (temp___is_init_278 Bool) (temp___skip_constant_279 Bool) (temp___do_toplevel_280 Bool)) Bool (=> (or (= temp___is_init_278 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range1 temp___expr_281)))
(define-fun dynamic_invariant2 ((temp___expr_287 (_ BitVec 8)) (temp___is_init_284 Bool) (temp___skip_constant_285 Bool) (temp___do_toplevel_286 Bool)) Bool (=> (or (= temp___is_init_284 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 3))) (in_range4 temp___expr_287)))
(define-fun dynamic_invariant3 ((temp___expr_293 (_ BitVec 8)) (temp___is_init_290 Bool) (temp___skip_constant_291 Bool) (temp___do_toplevel_292 Bool)) Bool (=> (or (= temp___is_init_290 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 7))) (in_range5 temp___expr_293)))
(define-fun dynamic_invariant4 ((temp___expr_305 (_ BitVec 8)) (temp___is_init_302 Bool) (temp___skip_constant_303 Bool) (temp___do_toplevel_304 Bool)) Bool (=> (or (= temp___is_init_302 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 31))) (in_range2 temp___expr_305)))
(define-fun dynamic_invariant5 ((temp___expr_311 (_ BitVec 8)) (temp___is_init_308 Bool) (temp___skip_constant_309 Bool) (temp___do_toplevel_310 Bool)) Bool (=> (or (= temp___is_init_308 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 63))) (in_range6 temp___expr_311)))
(define-fun dynamic_invariant6 ((temp___expr_323 (_ BitVec 8)) (temp___is_init_320 Bool) (temp___skip_constant_321 Bool) (temp___do_toplevel_322 Bool)) Bool true)
(define-fun dynamic_invariant7 ((temp___expr_341 (_ BitVec 16)) (temp___is_init_338 Bool) (temp___skip_constant_339 Bool) (temp___do_toplevel_340 Bool)) Bool (=> (or (= temp___is_init_338 true) (bvule ((_ int2bv 16) 0) ((_ int2bv 16) 2047))) (in_range3 temp___expr_341)))
(define-fun dynamic_invariant8 ((temp___expr_371 (_ BitVec 16)) (temp___is_init_368 Bool) (temp___skip_constant_369 Bool) (temp___do_toplevel_370 Bool)) Bool true)
