...
(assert (not (< 65535 (- (+ (bv2nat (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))) (to_rep1 (rec__ring_buf__ring_buffer__length (us_split_fields1 r)))) 1))))
(assert (and (= o12 (to_rep1 (rec__ring_buf__ring_buffer__length (us_split_fields1 r)))) (uint_in_range (to_rep1 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))))
(assert (= o13 ((_ int2bv 16) o12)))
(assert (= o14 (bvadd (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) o13)))
(assert (= temp___247 (bvsub o14 ((_ int2bv 16) 1))))
(assert (bvule (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) temp___247))
(assert (not (bvule ((_ int2bv 16) 0) (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))))
(check-sat)
(exit)
