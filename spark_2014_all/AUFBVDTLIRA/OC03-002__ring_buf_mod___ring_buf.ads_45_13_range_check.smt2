...
(assert (not (< 65535 (- (+ (bv2nat (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r)))) 1))))
...
(assert (= o2 (bvadd (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) o1)))
(assert (= temp___274 (bvsub o2 #x0001)))
(assert (bvule (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) temp___274))
(assert (not (bvule (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) #xFFFF)))
(check-sat)
(exit)
