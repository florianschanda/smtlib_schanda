...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (= temp___1675 foundtype1) (and (= temp___1674 endidx1) (and (= temp___1673 begidx2) (and (< endidx2 zlength) (and (and (and (and (=> (<= 1 256) (in_range4 begidx3)) (=> (<= 1 256) (in_range4 endidx2))) (=> (<= 0 10) (in_range3 foundtype2))) (and (not (= foundtype2 3)) (< endidx2 zlength))) (and (and (and (= o (+ endidx2 1)) (in_range4 (+ endidx2 1))) (and (= begidx3 result3) (= begidx4 o))) (and (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i30 Int)) (=> (and (<= begidx5 i30) (<= i30 endidx3)) (and (<= 48 (to_rep (select zonefileline i30))) (<= (to_rep (select zonefileline i30)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3))) (not (and (not (= foundtype3 3)) (< endidx3 zlength)))))))))) (and (and (= foundtype3 foundtype6) (and (= endidx3 endidx6) (= begidx5 begidx8))) (and (= foundtype7 foundtype3) (and (= endidx7 endidx3) (= begidx9 begidx5)))))))
...
(assert (= begidx12 o1))
(assert (and (and (and (and (<= begidx13 endidx10) (<= begidx13 zlength)) (<= endidx10 zlength)) (=> (= foundtype10 1) (forall ((i30 Int)) (=> (and (<= begidx13 i30) (<= i30 endidx10)) (and (<= 48 (to_rep (select zonefileline i30))) (<= (to_rep (select zonefileline i30)) 57)))))) (and (and (in_range4 begidx13) (in_range4 endidx10)) (in_range3 foundtype10))))
(assert (= foundtype10 1))
(assert (= result5 (mk_t__ref tmpval)))
(assert (= tmpval1 ((_ int2bv 16) 0)))
(assert (= begidx13 r75b))
(assert (in_range4 r75b))
(assert (= endidx10 r76b))
(assert (in_range4 r76b))
(assert (= result6 (mk_int__ref i)))
(assert (= i3 r75b))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (and (and (= temp___1678 i3) (and (= temp___1677 tmpval1) (and (= temp___1676 digitval) (and (and (<= 1 begidx13) (bvule tmpval2 ((_ int2bv 16) 32767))) (and (and (=> (<= r75b r76b) (dynamic_property r75b r76b i4)) (and (<= r75b i4) (<= i4 r76b))) (and (and (= result7 (mk_t__ref digitval2)) (= digitval3 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i4))) ((_ int2bv 16) 48)))) (and (and (= result8 (mk_t__ref tmpval2)) (= tmpval3 (bvadd (bvmul ((_ int2bv 16) 10) tmpval2) digitval3))) (or (bvugt tmpval3 ((_ int2bv 16) 32767)) (and (not (bvugt tmpval3 ((_ int2bv 16) 32767))) (= i4 r76b)))))))))) (and (and (= i10 (mk_int__ref i4)) (and (= tmpval8 (mk_t__ref tmpval3)) (= digitval8 (mk_t__ref digitval3)))) (and (= i11 i4) (and (= tmpval9 tmpval3) (= digitval9 digitval3)))))))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= i12 i10)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= tmpval10 tmpval8)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= digitval10 digitval8)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= i13 i11)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= tmpval11 tmpval9)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= digitval11 digitval9)))
(assert (=> (not (and (<= r75b i3) (<= i3 r76b))) (= i12 (mk_int__ref i3))))
(assert (=> (not (and (<= r75b i3) (<= i3 r76b))) (= tmpval10 (mk_t__ref tmpval1))))
(assert (=> (not (and (<= r75b i3) (<= i3 r76b))) (= digitval10 (mk_t__ref digitval))))
(assert (=> (not (and (<= r75b i3) (<= i3 r76b))) (= i13 i3)))
(assert (=> (not (and (<= r75b i3) (<= i3 r76b))) (= tmpval11 tmpval1)))
(assert (=> (not (and (<= r75b i3) (<= i3 r76b))) (= digitval11 digitval1)))
(assert (not (bvugt (t__content tmpval10) ((_ int2bv 16) 32767))))
(assert (= result10 (mk_t__ref newpref1)))
(assert (= newpref2 (t__content tmpval10)))
(assert (not (<= zlength endidx10)))
(assert (and (= o2 (+ endidx10 1)) (in_range4 (+ endidx10 1))))
(assert (= result11 (mk_int__ref begidx13)))
(assert (= begidx14 o2))
(assert (and (and (and (and (<= begidx15 endidx11) (<= begidx15 zlength)) (<= endidx11 zlength)) (=> (= foundtype11 1) (forall ((i30 Int)) (=> (and (<= begidx15 i30) (<= i30 endidx11)) (and (<= 48 (to_rep (select zonefileline i30))) (<= (to_rep (select zonefileline i30)) 57)))))) (and (and (in_range4 begidx15) (in_range4 endidx11)) (in_range3 foundtype11))))
(assert (and (= o3 (+ (- endidx11 begidx15) 1)) (in_range4 (+ (- endidx11 begidx15) 1))))
(assert (= result12 (mk_int__ref lengthoftoken)))
(assert (= lengthoftoken1 o3))
(assert (= foundtype11 0))
(assert (not (< 128 lengthoftoken1)))
(assert (= begidx15 r78b))
(assert (in_range4 r78b))
(assert (= endidx11 r79b))
(assert (in_range4 r79b))
(assert (= result13 (mk_int__ref i1)))
(assert (= i14 r78b))
(assert (=> (and (<= r78b i14) (<= i14 r79b)) (and (and (= temp___1683 newdomainname1) (and (= temp___1682 i14) (and (= temp___1685 endidx11) (and (and (and (<= 1 begidx15) (<= (+ (- endidx11 begidx15) 1) 128)) (= endidx11 temp___1685)) (and (and (=> (<= r78b r79b) (dynamic_property1 r78b r79b i15)) (and (<= r78b i15) (<= i15 r79b))) (and (and (and (= (to_rep o6) (to_rep (select zonefileline i15))) (and (and (and (and (and (= o4 (+ i15 1)) (in_range1 (+ i15 1))) (= o5 (- o4 begidx15))) (and (= temp___1681 o5) (in_range1 o5))) (and (and (<= 1 temp___1681) (<= temp___1681 128)) (= o7 temp___1681))) (= o8 (store newdomainname2 o7 o6)))) (and (= result14 (mk_map__ref newdomainname2)) (= newdomainname3 o8))) (= i15 r79b))))))) (and (and (= i21 (mk_int__ref i15)) (= newdomainname8 (mk_map__ref newdomainname3))) (and (= i22 i15) (= newdomainname9 newdomainname3))))))
(assert (=> (and (<= r78b i14) (<= i14 r79b)) (= i23 i21)))
(assert (=> (and (<= r78b i14) (<= i14 r79b)) (= newdomainname10 newdomainname8)))
(assert (=> (and (<= r78b i14) (<= i14 r79b)) (= i24 i22)))
(assert (=> (and (<= r78b i14) (<= i14 r79b)) (= newdomainname11 newdomainname9)))
(assert (=> (not (and (<= r78b i14) (<= i14 r79b))) (= i23 (mk_int__ref i14))))
(assert (=> (not (and (<= r78b i14) (<= i14 r79b))) (= newdomainname10 (mk_map__ref newdomainname1))))
(assert (=> (not (and (<= r78b i14) (<= i14 r79b))) (= i24 i14)))
(assert (=> (not (and (<= r78b i14) (<= i14 r79b))) (= newdomainname11 newdomainname1)))
(assert (= (+ endidx11 1) r81b))
(assert (in_range1 r81b))
(assert (= result16 (mk_int__ref i2)))
(assert (= i25 r81b))
(assert (<= r81b i25))
(assert (<= i25 128))
(assert (not (<= 1 endidx11)))
(check-sat)
(exit)
