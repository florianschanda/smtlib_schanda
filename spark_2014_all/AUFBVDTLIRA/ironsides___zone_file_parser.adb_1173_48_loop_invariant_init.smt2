...
(declare-const temp___1736 (_ BitVec 16))
(declare-const temp___1735 (_ BitVec 16))
...
(assert (= i3 r75b))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= temp___1737 i3)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= temp___1736 tmpval1)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= temp___1735 digitval)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (and (<= 1 begidx11) (bvule tmpval2 #x7FFF))))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (and (=> (<= r75b r76b) (dynamic_property r75b r76b i4)) (and (<= r75b i4) (<= i4 r76b)))))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= result7 (mk_t__ref digitval2))))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= digitval3 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i4))) #x0030))))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= result8 (mk_t__ref tmpval2))))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= tmpval3 (bvadd (bvmul #x000A tmpval2) digitval3))))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (or (bvugt tmpval3 #x7FFF) (and (not (bvugt tmpval3 #x7FFF)) (= i4 r76b)))))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= i5 (mk_int__ref i4))))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= tmpval4 (mk_t__ref tmpval3))))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= digitval4 (mk_t__ref digitval3))))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= i6 i4)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= tmpval5 tmpval3)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= digitval5 digitval3)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= i7 i5)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= tmpval6 tmpval4)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= digitval6 digitval4)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= i8 i6)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= tmpval7 tmpval5)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= digitval7 digitval5)))
(assert (=> (not (and (<= r75b i3) (<= i3 r76b))) (= i7 (mk_int__ref i3))))
(assert (=> (not (and (<= r75b i3) (<= i3 r76b))) (= tmpval6 (mk_t__ref tmpval1))))
(assert (=> (not (and (<= r75b i3) (<= i3 r76b))) (= digitval6 (mk_t__ref digitval))))
(assert (=> (not (and (<= r75b i3) (<= i3 r76b))) (= i8 i3)))
(assert (=> (not (and (<= r75b i3) (<= i3 r76b))) (= tmpval7 tmpval1)))
(assert (=> (not (and (<= r75b i3) (<= i3 r76b))) (= digitval7 digitval1)))
...
(assert (= i9 r78b))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= temp___1742 newdomainname1)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= temp___1741 i9)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= temp___1744 endidx9)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (and (and (<= 1 begidx13) (<= (+ (- endidx9 begidx13) 1) 128)) (= endidx9 temp___1744))))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (and (=> (<= r78b r79b) (dynamic_property1 r78b r79b i10)) (and (<= r78b i10) (<= i10 r79b)))))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= (to_rep o6) (to_rep (select zonefileline i10)))))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (and (= o4 (+ i10 1)) (in_range1 (+ i10 1)))))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= o5 (- o4 begidx13))))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (and (= temp___1740 o5) (in_range1 o5))))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (and (<= 1 temp___1740) (<= temp___1740 128))))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= o7 temp___1740)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= o8 (store newdomainname2 o7 o6))))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= result13 (mk_map__ref newdomainname2))))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= newdomainname3 o8)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= i10 r79b)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= i11 (mk_int__ref i10))))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= newdomainname4 (mk_map__ref newdomainname3))))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= i12 i10)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= newdomainname5 newdomainname3)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= i13 i11)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= newdomainname6 newdomainname4)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= i14 i12)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= newdomainname7 newdomainname5)))
(assert (=> (not (and (<= r78b i9) (<= i9 r79b))) (= i13 (mk_int__ref i9))))
(assert (=> (not (and (<= r78b i9) (<= i9 r79b))) (= newdomainname6 (mk_map__ref newdomainname1))))
(assert (=> (not (and (<= r78b i9) (<= i9 r79b))) (= i14 i9)))
(assert (=> (not (and (<= r78b i9) (<= i9 r79b))) (= newdomainname7 newdomainname1)))
(assert (= (+ endidx9 1) r81b))
(assert (in_range1 r81b))
(assert (= result14 (mk_int__ref i2)))
(assert (= i15 r81b))
(assert (<= r81b i15))
(assert (<= i15 128))
(assert (not (<= 1 endidx9)))
(check-sat)
(exit)
