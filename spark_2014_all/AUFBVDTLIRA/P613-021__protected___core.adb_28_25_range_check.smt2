...
(define-fun default_initial_assumption ((temp___expr_238 us_rep1) (temp___skip_top_level_239 Bool)) Bool (and (and (and (= (rec__core__mailboxT__messages (us_split_fields3 temp___expr_238)) (temp___240 (mk___rep (mk___split_fields (of_rep 0) (of_rep3 0))))) (= (to_rep1 (rec__core__mailboxT__next_in (us_split_fields3 temp___expr_238))) #x00)) (= (to_rep1 (rec__core__mailboxT__next_out (us_split_fields3 temp___expr_238))) #x00)) (= (to_rep2 (rec__core__mailboxT__count (us_split_fields3 temp___expr_238))) 0)))
