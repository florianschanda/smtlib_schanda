...
(define-fun default_initial_assumption ((temp___expr_205 us_rep1) (temp___skip_top_level_206 Bool)) Bool (and (and (and (= (rec__core__mailboxT__messages (us_split_fields3 temp___expr_205)) (temp___207 (mk___rep (mk___split_fields (of_rep 0) (of_rep3 0))))) (= (to_rep1 (rec__core__mailboxT__next_in (us_split_fields3 temp___expr_205))) ((_ int2bv 8) 0))) (= (to_rep1 (rec__core__mailboxT__next_out (us_split_fields3 temp___expr_205))) ((_ int2bv 8) 0))) (= (to_rep2 (rec__core__mailboxT__count (us_split_fields3 temp___expr_205))) 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 16)) (in_range2 temp___expr_178)))
(declare-const n Int)
