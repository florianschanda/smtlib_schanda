...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__tc_sarl_type__sar_lvbat bits_8) (rec__dw1000__register_types__tc_sarl_type__sar_ltemp bits_8) (rec__dw1000__register_types__tc_sarl_type__reserved bits_8)))))
(define-fun us_split_fields_SAR_LVBAT__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__tc_sarl_type__sar_lvbat a))
(define-fun us_split_fields_SAR_LTEMP__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__tc_sarl_type__sar_ltemp a))
(define-fun us_split_fields_Reserved__16__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__tc_sarl_type__reserved a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___60__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___60__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__dw1000__register_types__tc_sarl_type__sar_lvbat (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tc_sarl_type__sar_lvbat (us_split_fields1 b)))) (= (to_rep1 (rec__dw1000__register_types__tc_sarl_type__sar_ltemp (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tc_sarl_type__sar_ltemp (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__tc_sarl_type__reserved (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tc_sarl_type__reserved (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__tc_sarl_type__sar_lvbat__first__bit Int)
(declare-const dw1000__register_types__tc_sarl_type__sar_lvbat__last__bit Int)
(declare-const dw1000__register_types__tc_sarl_type__sar_lvbat__position Int)
(assert (<= 0 dw1000__register_types__tc_sarl_type__sar_lvbat__first__bit))
(assert (< dw1000__register_types__tc_sarl_type__sar_lvbat__first__bit dw1000__register_types__tc_sarl_type__sar_lvbat__last__bit))
(assert (<= 0 dw1000__register_types__tc_sarl_type__sar_lvbat__position))
(declare-const dw1000__register_types__tc_sarl_type__sar_ltemp__first__bit Int)
(declare-const dw1000__register_types__tc_sarl_type__sar_ltemp__last__bit Int)
(declare-const dw1000__register_types__tc_sarl_type__sar_ltemp__position Int)
(assert (<= 0 dw1000__register_types__tc_sarl_type__sar_ltemp__first__bit))
(assert (< dw1000__register_types__tc_sarl_type__sar_ltemp__first__bit dw1000__register_types__tc_sarl_type__sar_ltemp__last__bit))
(assert (<= 0 dw1000__register_types__tc_sarl_type__sar_ltemp__position))
(declare-const dw1000__register_types__tc_sarl_type__reserved__first__bit Int)
(declare-const dw1000__register_types__tc_sarl_type__reserved__last__bit Int)
(declare-const dw1000__register_types__tc_sarl_type__reserved__position Int)
(assert (<= 0 dw1000__register_types__tc_sarl_type__reserved__first__bit))
(assert (< dw1000__register_types__tc_sarl_type__reserved__first__bit dw1000__register_types__tc_sarl_type__reserved__last__bit))
(assert (<= 0 dw1000__register_types__tc_sarl_type__reserved__position))
(declare-fun user_eq4 (us_rep us_rep) Bool)
(declare-const dummy4 us_rep)
(declare-datatypes () ((tc_sarl_type__ref (mk_tc_sarl_type__ref (tc_sarl_type__content us_rep)))))
(define-fun tc_sarl_type__ref___projection ((a tc_sarl_type__ref)) us_rep (tc_sarl_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___141__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___100__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___100__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5491 us_t1) (temp___is_init_5488 Bool) (temp___skip_constant_5489 Bool) (temp___do_toplevel_5490 Bool)) Bool (=> (not (= temp___skip_constant_5489 true)) (and (dynamic_property2 1 3 (first3 temp___expr_5491) (last3 temp___expr_5491)) (and (= (first3 temp___expr_5491) 1) (= (last3 temp___expr_5491) 3)))))
...
(assert (and (dynamic_property2 1 3 (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 3))))
