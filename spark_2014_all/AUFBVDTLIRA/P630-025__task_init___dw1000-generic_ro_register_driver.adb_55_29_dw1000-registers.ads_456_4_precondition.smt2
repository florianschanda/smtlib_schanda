...
(define-fun dynamic_invariant ((temp___expr_6033 us_t1) (temp___is_init_6029 Bool) (temp___skip_constant_6030 Bool) (temp___do_toplevel_6031 Bool) (temp___do_typ_inv_6032 Bool)) Bool (=> (not (= temp___skip_constant_6030 true)) (and (dynamic_property2 1 3 (first3 temp___expr_6033) (last3 temp___expr_6033)) (and (= (first3 temp___expr_6033) 1) (= (last3 temp___expr_6033) 3)))))
