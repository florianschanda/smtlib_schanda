...
(assert (and (= o10 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o11 (ite (<= k o10) true false)))
(assert (= result1 (ite (<= i2 k) o11 false)))
(assert (= (= o12 true) (forall ((k1 Int)) (=> (and (<= i2 k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a1 k1)) (to_rep1 (select a k1)))))))
(assert (= o6 (from_word32 carry21)))
(assert (and (= o5 (base Tuple0)) (= o5 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o7 (omultiply o5 o6)))
(assert (= o4 (from_word32 carry11)))
(assert (= o8 (oadd o4 o7)))
(assert (and (= o1 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o2 o1) (in_range2 o1)))
(assert (and (= o (base Tuple0)) (= o (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o3 (oexpon o o2)))
(assert (= o9 (omultiply o3 o8)))
