...
(define-fun to_rep ((x bit_absorption_number)) Int (bit_absorption_numberqtint x))
(declare-fun of_rep (Int) bit_absorption_number)
(assert (forall ((x bit_absorption_number)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x bit_absorption_number)) (! (in_range (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x states)) (! (in_range1 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x byte_absorption_number)) (! (in_range2 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x rate_number)) (! (in_range3 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (= (bool_eq (rec__keccak__keccak_1600__sponge__context__state (us_split_fields1 a)) #x00 #x04 #x00 #x04 (rec__keccak__keccak_1600__sponge__context__state (us_split_fields1 b)) #x00 #x04 #x00 #x04) true) (= (bool_eq1 (rec__keccak__keccak_1600__sponge__context__block (us_split_fields1 a)) 0 199 (rec__keccak__keccak_1600__sponge__context__block (us_split_fields1 b)) 0 199) true)) (= (to_rep (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields1 a))) (to_rep (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields1 b))))) (= (to_rep3 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed (us_split_fields1 a))) (to_rep3 (rec__keccak__keccak_1600__sponge__context__bytes_squeezed (us_split_fields1 b))))) (= (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields1 a))) (to_rep5 (rec__keccak__keccak_1600__sponge__context__rate (us_split_fields1 b))))) (= (to_rep2 (rec__keccak__keccak_1600__sponge__context__curr_state (us_split_fields1 a))) (to_rep2 (rec__keccak__keccak_1600__sponge__context__curr_state (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant ((temp___expr_286 (_ BitVec 8)) (temp___is_init_282 Bool) (temp___skip_constant_283 Bool) (temp___do_toplevel_284 Bool) (temp___do_typ_inv_285 Bool)) Bool true)
(define-fun dynamic_invariant1 ((temp___expr_413 Int) (temp___is_init_409 Bool) (temp___skip_constant_410 Bool) (temp___do_toplevel_411 Bool) (temp___do_typ_inv_412 Bool)) Bool (=> (or (= temp___is_init_409 true) (<= 0 1)) (in_range1 temp___expr_413)))
(define-fun dynamic_invariant2 ((temp___expr_444 Int) (temp___is_init_440 Bool) (temp___skip_constant_441 Bool) (temp___do_toplevel_442 Bool) (temp___do_typ_inv_443 Bool)) Bool (=> (or (= temp___is_init_440 true) (<= 1 199)) (in_range3 temp___expr_444)))
(define-fun dynamic_invariant3 ((temp___expr_420 Int) (temp___is_init_416 Bool) (temp___skip_constant_417 Bool) (temp___do_toplevel_418 Bool) (temp___do_typ_inv_419 Bool)) Bool (=> (or (= temp___is_init_416 true) (<= 0 199)) (in_range2 temp___expr_420)))
(define-fun dynamic_invariant4 ((temp___expr_437 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool) (temp___do_typ_inv_436 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 0 1599)) (in_range temp___expr_437)))
...
(assert (= keccak__keccak_1600__sponge__in_queue_bit_length__result1 keccak__keccak_1600__sponge__in_queue_bit_length__result2))
(assert (= keccak__keccak_1600__sponge__in_queue_bit_length__result3 keccak__keccak_1600__sponge__in_queue_bit_length__result1))
(assert (= result keccak__keccak_1600__sponge__in_queue_bit_length__result))
(assert (= keccak__keccak_1600__sponge__in_queue_bit_length__result1 (to_rep (rec__keccak__keccak_1600__sponge__context__bits_absorbed (us_split_fields1 ctx)))))
(assert (= (mk_int__ref keccak__keccak_1600__sponge__in_queue_bit_length__result4) (mk_int__ref keccak__keccak_1600__sponge__in_queue_bit_length__result2)))
(assert (= keccak__keccak_1600__sponge__in_queue_bit_length__result5 keccak__keccak_1600__sponge__in_queue_bit_length__result3))
(assert (= result1 keccak__keccak_1600__sponge__in_queue_bit_length__result4))
(assert (not (< keccak__keccak_1600__sponge__in_queue_bit_length__result4 1600)))
(check-sat)
(exit)
