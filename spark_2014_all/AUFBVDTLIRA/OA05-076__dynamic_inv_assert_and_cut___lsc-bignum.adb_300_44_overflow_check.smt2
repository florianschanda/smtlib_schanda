...
(assert (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (forall ((temp___739 Int)) (=> (and (<= (to_rep a__first) temp___739) (<= temp___739 (to_rep a__last))) (=> (<= i2 temp___739) (= (select a1 temp___739) (select a temp___739)))))) (and (<= a_first i2) (<= i2 a_last))))
(assert (and (= temp___725 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (and (<= (to_rep a__first) temp___725) (<= temp___725 (to_rep a__last))))
(assert (= o temp___725))
...
(assert (and (= temp___727 o9) (in_range1 o9)))
(assert (and (<= (to_rep (first (rt c))) temp___727) (<= temp___727 (to_rep (last (rt c))))))
(assert (= o10 temp___727))
(assert (= o11 (select (elts c) o10)))
(assert (= o12 (to_rep1 o11)))
(assert (and (= o3 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (= o4 (+ b_first o3)))
(assert (and (= temp___726 o4) (in_range1 o4)))
(assert (and (<= (to_rep (first (rt b))) temp___726) (<= temp___726 (to_rep (last (rt b))))))
(assert (= o5 temp___726))
...
(assert (= a1 result2))
(assert (= a2 o15))
(assert (and (= o47 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o48 (ite (<= k o47) true false)))
(assert (and (= o46 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o49 (ite (<= o46 k) true false)))
(assert (= result3 (ite (= o49 true) o48 false)))
(assert (= (= o50 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
(assert (= o41 (from_word32 carry22)))
(assert (and (= o40 (base Tuple0)) (= o40 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o42 (omultiply o40 o41)))
(assert (= o39 (from_word32 carry12)))
(assert (= o43 (oadd o39 o42)))
(assert (and (= o34 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o35 (- o34 a_first)))
...
(assert (= o38 (oexpon o33 o37)))
(assert (= o44 (omultiply o38 o43)))
(assert (and (= o28 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o29 (- o28 a_first)))
(assert (and (= o30 o29) (in_range1 o29)))
(assert (and (= o31 o30) (in_range2 o30)))
(assert (= o32 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o31)))
(assert (= o45 (oadd o32 o44)))
(assert (= o26 (from_word32 carry2)))
(assert (and (= o25 (base Tuple0)) (= o25 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o27 (omultiply o25 o26)))
(assert (= o24 (from_word32 carry1)))
(assert (= o22 (from_word32 y)))
(assert (and (= o17 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o18 (- o17 a_first)))
(assert (and (= o19 o18) (in_range1 o18)))
(assert (and (= o20 o19) (in_range2 o19)))
(assert (= o21 (num_of_big_int c c_first o20)))
(assert (= o23 (omultiply o21 o22)))
(assert (= o16 (from_word32 x)))
