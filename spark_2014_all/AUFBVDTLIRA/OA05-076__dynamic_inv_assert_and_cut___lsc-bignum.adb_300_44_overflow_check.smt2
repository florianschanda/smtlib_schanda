...
(assert (= (oeq (oadd (oadd (oadd (oadd (from_word32 temp3) (omultiply (from_word32 o65) (from_word32 x))) (omultiply (from_word32 o70) (from_word32 y))) (from_word32 carry12)) (omultiply (base Tuple0) (from_word32 carry22))) (oadd (from_word32 temp4) (omultiply (base Tuple0) (oadd (from_word32 carry13) (omultiply (base Tuple0) (from_word32 carry23)))))) true))
...
(assert (= (= o122 true) (forall ((k2 Int)) (=> (and (<= (+ i2 1) k2) (<= k2 (+ a_last 1))) (= (to_rep1 (select a3 k2)) (to_rep1 (select a k2)))))))
(assert (= o110 (from_word32 carry23)))
(assert (and (= o109 (base Tuple0)) (= o109 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
(assert (and (= o102 (base Tuple0)) (= o102 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
(assert (= o101 (num_of_big_int (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) a_first o100)))
(assert (= o114 (oadd o101 o113)))
(assert (= o95 (from_word32 carry2)))
(assert (and (= o94 (base Tuple0)) (= o94 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
(assert (= o90 (num_of_big_int c c_first o89)))
(assert (= o92 (omultiply o90 o91)))
(assert (= o84 (from_word32 x)))
