...
(assert (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (forall ((temp___809 Int)) (=> (and (<= (to_rep a__first) temp___809) (<= temp___809 (to_rep a__last))) (=> (<= i2 temp___809) (= (select a1 temp___809) (select a temp___809)))))) (and (<= a_first i2) (<= i2 a_last))))
(assert (and (= temp___795 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (and (<= (to_rep a__first) temp___795) (<= temp___795 (to_rep a__last))))
(assert (= o temp___795))
...
(assert (and (= temp___797 o9) (in_range1 o9)))
(assert (and (<= (to_rep (first (rt c))) temp___797) (<= temp___797 (to_rep (last (rt c))))))
(assert (= o10 temp___797))
(assert (= o11 (select (elts c) o10)))
(assert (= o12 (to_rep1 o11)))
(assert (and (= o3 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (= o4 (+ b_first o3)))
(assert (and (= temp___796 o4) (in_range1 o4)))
(assert (and (<= (to_rep (first (rt b))) temp___796) (<= temp___796 (to_rep (last (rt b))))))
(assert (= o5 temp___796))
...
(assert (and (= o40 (base Tuple0)) (= o40 (oexpon (from_word32 #x00000002) 32))))
