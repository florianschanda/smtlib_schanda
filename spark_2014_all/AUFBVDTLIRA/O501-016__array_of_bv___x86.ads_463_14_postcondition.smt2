...
(assert (and (= (readmem8 (bvadd addr #x0000000000000007) memory8) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 56)) #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000007))) (= (to_rep (select memory8 i)) (to_rep (select memory7 i))))))))
(assert (= (readmem64 addr memory8) val__))
...
(assert (not (= i addr)))
(assert (not (= i (bvadd addr #x0000000000000001))))
(assert (not (= i (bvadd addr #x0000000000000002))))
(assert (not (= i (bvadd addr #x0000000000000003))))
(assert (not (= i (bvadd addr #x0000000000000004))))
(assert (not (= i (bvadd addr #x0000000000000005))))
(assert (not (= i (bvadd addr #x0000000000000006))))
(assert (not (= i (bvadd addr #x0000000000000007))))
(assert (not (= (to_rep (select memory9 i)) (to_rep (select memory i)))))
(check-sat)
(exit)
