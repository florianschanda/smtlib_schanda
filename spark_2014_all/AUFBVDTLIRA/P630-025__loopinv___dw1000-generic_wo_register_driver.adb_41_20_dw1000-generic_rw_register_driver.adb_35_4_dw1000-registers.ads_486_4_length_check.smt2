...
(define-fun dynamic_invariant ((temp___expr_6355 us_t1) (temp___is_init_6351 Bool) (temp___skip_constant_6352 Bool) (temp___do_toplevel_6353 Bool) (temp___do_typ_inv_6354 Bool)) Bool (=> (not (= temp___skip_constant_6352 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6355) (last3 temp___expr_6355)) (and (= (first3 temp___expr_6355) 1) (= (last3 temp___expr_6355) 1)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_6374 us_t2) (temp___is_init_6370 Bool) (temp___skip_constant_6371 Bool) (temp___do_toplevel_6372 Bool) (temp___do_typ_inv_6373 Bool)) Bool (=> (not (= temp___skip_constant_6371 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6374) (last5 temp___expr_6374)) (and (= (first5 temp___expr_6374) 1) (= (last5 temp___expr_6374) 1)))))
...
(declare-const temp___88271 t2)
(define-fun temp___88272 () us_t2 (mk___t2 temp___8827 temp___88271))
...
(assert (and (= temp___88272 (register_to_bytes reg)) (dynamic_invariant1 temp___88272 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___88271)) (to_rep (last4 temp___88271))) (+ (- (to_rep (last4 temp___88271)) (to_rep (first4 temp___88271))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
