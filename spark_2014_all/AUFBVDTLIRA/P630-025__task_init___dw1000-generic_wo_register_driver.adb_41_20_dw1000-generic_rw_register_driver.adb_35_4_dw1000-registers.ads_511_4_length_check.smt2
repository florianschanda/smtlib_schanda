...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x ((_ int2bv 16) 2048)))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(define-fun dynamic_invariant ((temp___expr_6146 us_t1) (temp___is_init_6143 Bool) (temp___skip_constant_6144 Bool) (temp___do_toplevel_6145 Bool)) Bool (=> (not (= temp___skip_constant_6144 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6146) (last3 temp___expr_6146)) (and (= (first3 temp___expr_6146) 1) (= (last3 temp___expr_6146) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_6168 us_t2) (temp___is_init_6165 Bool) (temp___skip_constant_6166 Bool) (temp___do_toplevel_6167 Bool)) Bool (=> (not (= temp___skip_constant_6166 true)) (and (dynamic_property3 1 4 (first5 temp___expr_6168) (last5 temp___expr_6168)) (and (= (first5 temp___expr_6168) 1) (= (last5 temp___expr_6168) 4)))))
...
(assert (and (= (mk___t2 temp___8090 temp___80901) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8090 temp___80901) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___80901)) (to_rep (last4 temp___80901))) (+ (- (to_rep (last4 temp___80901)) (to_rep (first4 temp___80901))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
