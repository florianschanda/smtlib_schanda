...
(assert (and (= (mk___t2 temp___7757 temp___77571) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7757 temp___77571) true false true)))
...
(assert (not (= (ite (<= (to_rep (first2 temp___77581)) (to_rep (last2 temp___77581))) (+ (- (to_rep (last2 temp___77581)) (to_rep (first2 temp___77581))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
