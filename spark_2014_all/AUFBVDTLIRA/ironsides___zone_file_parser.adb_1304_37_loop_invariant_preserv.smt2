...
(assert (<= r89b i27))
(assert (<= i27 r90b))
(assert (and (<= 1 begidx17) (bvule tmpval24 ((_ int2bv 16) 32767))))
(assert (and (=> (<= r89b r90b) (dynamic_property2 r89b r90b i28)) (and (<= r89b i28) (<= i28 r90b))))
(assert (= result23 (mk_t__ref digitval22)))
(assert (= digitval23 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i28))) ((_ int2bv 16) 48))))
(assert (= result24 (mk_t__ref tmpval24)))
(assert (= tmpval25 (bvadd (bvmul ((_ int2bv 16) 10) tmpval24) digitval23)))
(assert (not (bvugt tmpval25 ((_ int2bv 16) 32767))))
(assert (not (= i28 r90b)))
(assert (= result25 (mk_int__ref i28)))
(assert (= i29 (+ i28 1)))
(assert (= i30 (mk_int__ref i29)))
(assert (= tmpval26 (mk_t__ref tmpval25)))
(assert (= digitval24 (mk_t__ref digitval23)))
(assert (= i31 i29))
(assert (= tmpval27 tmpval25))
(assert (= digitval25 digitval23))
