...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i20 Int)) (=> (and (<= begidx2 i20) (<= i20 endidx1)) (and (<= 48 (to_rep (select zonefileline i20))) (<= (to_rep (select zonefileline i20)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i20 Int)) (=> (and (<= begidx5 i20) (<= i20 endidx3)) (and (<= 48 (to_rep (select zonefileline i20))) (<= (to_rep (select zonefileline i20)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (= begidx10 o1))
(assert (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i20 Int)) (=> (and (<= begidx11 i20) (<= i20 endidx8)) (and (<= 48 (to_rep (select zonefileline i20))) (<= (to_rep (select zonefileline i20)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8))))
(assert (= foundtype8 1))
...
(assert (= begidx12 o2))
(assert (and (and (and (and (<= begidx13 endidx9) (<= begidx13 zlength)) (<= endidx9 zlength)) (=> (= foundtype9 1) (forall ((i20 Int)) (=> (and (<= begidx13 i20) (<= i20 endidx9)) (and (<= 48 (to_rep (select zonefileline i20))) (<= (to_rep (select zonefileline i20)) 57)))))) (and (and (in_range4 begidx13) (in_range4 endidx9)) (in_range3 foundtype9))))
(assert (= foundtype9 1))
...
(assert (= begidx14 o3))
(assert (and (and (and (and (<= begidx15 endidx10) (<= begidx15 zlength)) (<= endidx10 zlength)) (=> (= foundtype10 1) (forall ((i20 Int)) (=> (and (<= begidx15 i20) (<= i20 endidx10)) (and (<= 48 (to_rep (select zonefileline i20))) (<= (to_rep (select zonefileline i20)) 57)))))) (and (and (in_range4 begidx15) (in_range4 endidx10)) (in_range3 foundtype10))))
...
(assert (<= r89b i15))
(assert (<= i15 r90b))
(assert (and (<= 1 begidx15) (bvule tmpval16 #x7FFF)))
(assert (and (=> (<= r89b r90b) (dynamic_property2 r89b r90b i16)) (and (<= r89b i16) (<= i16 r90b))))
(assert (= result21 (mk_t__ref digitval14)))
(assert (= digitval15 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i16))) #x0030)))
(assert (= result22 (mk_t__ref tmpval16)))
(assert (= tmpval17 (bvadd (bvmul #x000A tmpval16) digitval15)))
(assert (not (bvugt tmpval17 #x7FFF)))
(assert (not (= i16 r90b)))
(assert (= result23 (mk_int__ref i16)))
(assert (= i17 (+ i16 1)))
(assert (= i18 (mk_int__ref i17)))
(assert (= tmpval18 (mk_t__ref tmpval17)))
(assert (= digitval16 (mk_t__ref digitval15)))
(assert (= i19 i17))
(assert (= tmpval19 tmpval17))
(assert (= digitval17 digitval15))
