...
(assert (= s1 o5))
(assert (= (invariant__ hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields)) true))
(assert (and (and (=> (<= 1 l) (dynamic_property3 1 l i2)) (forall ((temp___665 Int)) (=> (and (<= (to_rep1 s__first) temp___665) (<= temp___665 (to_rep1 s__last))) (=> (< i2 temp___665) (= (select s2 temp___665) (select s temp___665)))))) (and (<= 1 i2) (<= i2 l))))
(assert (not (= i2 l)))
(assert (= i2 result2))
(assert (= i3 (+ i2 1)))
