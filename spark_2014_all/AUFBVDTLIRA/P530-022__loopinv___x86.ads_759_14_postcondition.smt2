...
(declare-const x86__readmem64ghost__result (_ BitVec 64))
(declare-const result (_ BitVec 64))
(declare-const x86__readmem64ghost__result1 (_ BitVec 64))
(declare-const x86__readmem64ghost__result2 (_ BitVec 64))
(declare-const x86__readmem64ghost__result3 (_ BitVec 64))
(declare-const x86__readmem64ghost__result4 (_ BitVec 64))
(declare-const x86__readmem64ghost__result5 (_ BitVec 64))
(declare-const result1 (_ BitVec 64))
(assert (= x86__readmem64ghost__result1 x86__readmem64ghost__result2))
(assert (= x86__readmem64ghost__result3 x86__readmem64ghost__result1))
(assert (= result x86__readmem64ghost__result))
(assert (= x86__readmem64ghost__result1 (bvor (bvor (bvor (bvor (bvor (bvor (bvor ((_ zero_extend 56) (to_rep (select mem addr))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000001)))) ((_ int2bv 64) 8))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000002)))) ((_ int2bv 64) 16))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000003)))) ((_ int2bv 64) 24))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000004)))) ((_ int2bv 64) 32))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000005)))) ((_ int2bv 64) 40))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000006)))) ((_ int2bv 64) 48))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000007)))) ((_ int2bv 64) 56)))))
(assert (= (mk_t__ref1 x86__readmem64ghost__result4) (mk_t__ref1 x86__readmem64ghost__result2)))
(assert (= x86__readmem64ghost__result5 x86__readmem64ghost__result3))
(assert (= result1 x86__readmem64ghost__result4))
(assert (not (= x86__readmem64ghost__result4 (bvor (bvor (bvor (bvor (bvor (bvor (bvor ((_ zero_extend 56) (to_rep (select mem addr))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000001)))) ((_ int2bv 64) 8))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000002)))) ((_ int2bv 64) 16))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000003)))) ((_ int2bv 64) 24))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000004)))) ((_ int2bv 64) 32))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000005)))) ((_ int2bv 64) 40))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000006)))) ((_ int2bv 64) 48))) (bvshl ((_ zero_extend 56) (to_rep (select mem (bvadd addr #x0000000000000007)))) ((_ int2bv 64) 56))))))
(check-sat)
(exit)
