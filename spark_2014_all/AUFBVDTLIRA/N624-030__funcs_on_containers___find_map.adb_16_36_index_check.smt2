...
(assert (and (= (length1 (mk___rep result____split_discrs find_map__index_maps__clear__container__fields1)) 0) (= (is_empty (model__ (mk___rep result____split_discrs find_map__index_maps__clear__container__fields1))) true)))
