...
(define-fun bool_eq ((a (Array Int natural)) (a__first Int) (a__last Int) (b (Array Int natural)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_164 Int)) (=> (and (<= a__first temp___idx_164) (<= temp___idx_164 a__last)) (= (to_rep (select a temp___idx_164)) (to_rep (select b (+ (- b__first a__first) temp___idx_164))))))) true false))
(assert (forall ((a (Array Int natural)) (b (Array Int natural))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_164 Int)) (=> (and (<= a__first temp___idx_164) (<= temp___idx_164 a__last)) (= (to_rep (select a temp___idx_164)) (to_rep (select b (+ (- b__first a__first) temp___idx_164)))))))))))
...
(define-fun dynamic_invariant ((temp___expr_326 us_t) (temp___is_init_323 Bool) (temp___skip_constant_324 Bool) (temp___do_toplevel_325 Bool)) Bool (=> (not (= temp___skip_constant_324 true)) (dynamic_property 1 100 (first1 temp___expr_326) (last1 temp___expr_326))))
...
(assert (forall ((x count_type)) (! (in_range2 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_174 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 0 2147483647)) (in_range2 temp___expr_174)))
(declare-fun oeq (us_rep us_rep) Bool)
(declare-fun oeq__function_guard (Bool us_rep us_rep) Bool)
(declare-fun oeq1 (Int us_rep us_rep) Bool)
(declare-fun oeq__function_guard1 (Bool Int us_rep us_rep) Bool)
(assert (forall ((a us_rep) (b us_rep)) (! (= (user_eq7 a b) (oeq a b)) :pattern ((user_eq7 a b)))))
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep3 (rec__find_map__index_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant2 result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant3 ((temp___expr_331 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 0 2147483647)) (in_range6 temp___expr_331)))
(assert true)
...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (= (to_rep3 (rec__find_map__index_maps__cursor__node (us_split_fields3 a))) (to_rep3 (rec__find_map__index_maps__cursor__node (us_split_fields3 b)))) true false))
...
(define-fun map__ref___3__projection ((a map__ref3)) us_rep4 (map__content3 a))
...
(define-fun key ((container us_rep) (position us_rep2)) Int (get1 (keys container) (get2 (positions container) position)))
...
(define-fun dynamic_invariant4 ((temp___expr_337 Int) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool)) Bool (=> (or (= temp___is_init_334 true) (<= 1 100)) (in_range5 temp___expr_337)))
(assert (forall ((attr__tag Int) (key2 Int)) (forall ((container us_rep)) (! (=> (dynamic_invariant3 key2 true true true) (dynamic_invariant4 (element__21 attr__tag container key2) true false true)) :pattern ((element__21 attr__tag container key2))))))
...
(define-fun dynamic_invariant5 ((temp___expr_575 us_rep) (temp___is_init_572 Bool) (temp___skip_constant_573 Bool) (temp___do_toplevel_574 Bool)) Bool (=> (not (= temp___skip_constant_573 true)) (in_range7 100 r258s temp___expr_575)))
(define-fun default_initial_assumption ((temp___expr_578 us_rep) (temp___skip_top_level_579 Bool)) Bool (and (and (= (to_rep3 (rec__find_map__index_maps__map__capacity (us_split_discrs1 temp___expr_578))) 100) (= (to_rep2 (rec__find_map__index_maps__map__modulus (us_split_discrs1 temp___expr_578))) r258s)) (=> (not (= temp___skip_top_level_579 true)) (= (is_empty1 temp___expr_578) true))))
...
(define-fun dynamic_invariant6 ((temp___expr_15 Int) (temp___is_init_12 Bool) (temp___skip_constant_13 Bool) (temp___do_toplevel_14 Bool)) Bool (=> (or (= temp___is_init_12 true) (<= (- 2147483648) 2147483647)) (in_range3 temp___expr_15)))
(define-fun dynamic_invariant7 ((temp___expr_320 Int) (temp___is_init_317 Bool) (temp___skip_constant_318 Bool) (temp___do_toplevel_319 Bool)) Bool (=> (or (= temp___is_init_317 true) (<= 1 100)) (in_range4 temp___expr_320)))
(define-fun dynamic_invariant8 ((temp___expr_168 (_ BitVec 32)) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool true)
...
(define-fun oeq2 ((left us_rep3) (right us_rep3)) Bool (and (= (length3 left) (length3 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last2 left))) (= (get1 left n) (get1 right n)))) true false)))
(declare-fun oeq__function_guard2 (Bool us_rep3 us_rep3) Bool)
(assert (forall ((a1 us_rep3) (b us_rep3)) (! (= (user_eq11 a1 b) (oeq2 a1 b)) :pattern ((user_eq11 a1 b)))))
(define-fun default_initial_assumption1 ((temp___expr_410 us_rep3) (temp___skip_top_level_411 Bool)) Bool (=> (not (= temp___skip_top_level_411 true)) (= (length3 temp___expr_410) 0)))
(declare-fun find2 (us_rep3 Int) Int)
(declare-fun find__function_guard2 (Int us_rep3 Int) Bool)
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant3 key2 true true true) (let ((result (find2 container key2))) (and (=> (< 0 result) (and (<= result (length3 container)) (= (equivalent_keys key2 (get1 container result)) true))) (dynamic_invariant2 result true false true)))) :pattern ((find2 container key2))))))
(declare-fun k_keys_included (us_rep3 us_rep3) Bool)
(declare-fun k_keys_included__function_guard (Bool us_rep3 us_rep3) Bool)
(assert (forall ((left us_rep3) (right us_rep3)) (! (= (= (k_keys_included left right) true) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length3 left))) (and (< 0 (find2 right (get1 left i))) (= (get1 right (find2 right (get1 left i))) (get1 left i)))))) :pattern ((k_keys_included left right)))))
...
(define-fun default_initial_assumption2 ((temp___expr_430 us_rep4) (temp___skip_top_level_431 Bool)) Bool (=> (not (= temp___skip_top_level_431 true)) (and (= (is_empty3 temp___expr_430) true) (= (length4 temp___expr_430) 0))))
...
(assert (forall ((k_left us_rep3) (k_right us_rep3)) (forall ((p_left us_rep4) (p_right us_rep4)) (! (=> (= (mapping_preserved k_left k_right p_left p_right) true) (and (and (= (keys_included p_left p_right) true) (= (k_keys_included k_left k_right) true)) (forall ((c us_rep2)) (=> (= (has_key1 p_left c) true) (= (get1 k_left (get2 p_left c)) (get1 k_right (get2 p_right c))))))) :pattern ((mapping_preserved k_left k_right p_left p_right))))))
(declare-fun length5 (us_rep1) Int)
(declare-fun length__function_guard4 (Int us_rep1) Bool)
(define-fun default_initial_assumption3 ((temp___expr_379 us_rep1) (temp___skip_top_level_380 Bool)) Bool (=> (not (= temp___skip_top_level_380 true)) (and (= (is_empty temp___expr_379) true) (= (length5 temp___expr_379) 0))))
(assert true)
...
(define-fun iter_has_element ((container us_rep3) (position Int)) Bool (and (ite (<= 1 position) true false) (ite (<= position (last2 container)) true false)))
(declare-fun iter_has_element__function_guard (Bool us_rep3 Int) Bool)
(assert (forall ((container us_rep)) (! (let ((result (keys container))) (and (and (and (and (= (length3 result) (length1 container)) (forall ((temp___447 Int)) (=> (and (in_range9 temp___447) (= (iter_has_element result temp___447) true)) (= (has_key (model__ container) (get1 result temp___447)) true)))) (forall ((key2 Int)) (=> (and (in_range8 key2) (= (has_key (model__ container) key2) true)) (and (< 0 (find2 result key2)) (= (equivalent_keys (get1 result (find2 result key2)) key2) true))))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (= (find2 result (get1 result i)) i)))) (forall ((i Int)) (=> (and (<= 1 i) (<= i (length1 container))) (forall ((j Int)) (=> (and (<= 1 j) (<= j (length1 container))) (=> (= (equivalent_keys (get1 result i) (get1 result j)) true) (= i j)))))))) :pattern ((keys container)))))
(assert (forall ((container us_rep)) (! (let ((result (positions container))) (and (not (= (has_key1 result no_element) true)) (forall ((i us_rep2)) (=> (= (has_key1 result i) true) (and (and (<= 1 (get2 result i)) (<= (get2 result i) (length1 container))) (forall ((j us_rep2)) (=> (= (has_key1 result j) true) (=> (= (get2 result i) (get2 result j)) (= (bool_eq4 i j) true))))))))) :pattern ((positions container)))))
...
(assert true)
(define-fun has_element ((container us_rep) (position us_rep2)) Bool (has_key1 (positions container) position))
...
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (forall ((position us_rep2)) (! (dynamic_invariant3 (key1 attr__tag container position) true false true) :pattern ((key1 attr__tag container position)))))))
(assert (forall ((container us_rep)) (forall ((key2 Int)) (! (=> (dynamic_invariant3 key2 true true true) (let ((result (find container key2))) (ite (not (= (has_key (model__ container) key2) true)) (= (bool_eq4 result no_element) true) (and (and (= (has_key1 (positions container) result) true) (= (get2 (positions container) result) (find2 (keys container) key2))) (= (equivalent_keys (key container result) key2) true))))) :pattern ((find container key2))))))
(assert true)
(assert true)
(define-fun dynamic_invariant9 ((temp___expr_366 Int) (temp___is_init_363 Bool) (temp___skip_constant_364 Bool) (temp___do_toplevel_365 Bool)) Bool (=> (or (= temp___is_init_363 true) (<= 0 2147483647)) (in_range8 temp___expr_366)))
(assert (forall ((container us_rep1)) (forall ((key2 Int)) (! (=> (dynamic_invariant9 key2 true true true) (=> (= (of_int 1) true) (=> (exists ((k Int)) (and (and (in_range8 k) (= (has_key container k) true)) (= (equivalent_keys k key2) true))) (= (has_key container key2) true)))) :pattern ((has_key container key2))))))
...
(define-fun dynamic_invariant10 ((temp___expr_372 Int) (temp___is_init_369 Bool) (temp___skip_constant_370 Bool) (temp___do_toplevel_371 Bool)) Bool (=> (or (= temp___is_init_369 true) (<= 1 100)) (in_range10 temp___expr_372)))
...
(assert (forall ((container us_rep1)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant9 key2 true true true) (= (has_key container key2) true)) (let ((result (get container key2))) (and (=> (= (of_int 1) true) (and (= result (w_get container (witness container key2))) (forall ((k Int)) (=> (and (in_range8 k) (= (has_key container k) true)) (= (= (equivalent_keys k key2) true) (= (witness container key2) (witness container k))))))) (dynamic_invariant10 result true false true)))) :pattern ((get container key2))))))
(assert (forall ((container us_rep1)) (! (dynamic_invariant2 (length5 container) true false true) :pattern ((length5 container)))))
(assert (forall ((left us_rep1) (right us_rep1)) (! (= (= (ole left right) true) (forall ((key2 Int)) (=> (and (in_range8 key2) (= (has_key left key2) true)) (and (= (has_key right key2) true) (= (get right key2) (get left key2)))))) :pattern ((ole left right)))))
(assert (forall ((left us_rep1) (right us_rep1)) (! (= (= (oeq3 left right) true) (and (forall ((key2 Int)) (=> (and (in_range8 key2) (= (has_key left key2) true)) (and (= (has_key right key2) true) (= (get right key2) (get left key2))))) (forall ((key2 Int)) (=> (and (in_range8 key2) (= (has_key right key2) true)) (= (has_key left key2) true))))) :pattern ((oeq3 left right)))))
(assert (forall ((container us_rep1)) (! (= (= (is_empty container) true) (forall ((key2 Int)) (not (and (in_range8 key2) (= (has_key container key2) true))))) :pattern ((is_empty container)))))
(assert (forall ((left us_rep1) (right us_rep1)) (forall ((new_key Int)) (! (=> (dynamic_invariant9 new_key true true true) (= (= (keys_included_except left right new_key) true) (forall ((key2 Int)) (=> (and (in_range8 key2) (= (has_key left key2) true)) (=> (not (= (equivalent_keys key2 new_key) true)) (= (has_key right key2) true)))))) :pattern ((keys_included_except left right new_key))))))
(declare-fun has_witness (us_rep1 Int) Bool)
(declare-fun has_witness__function_guard (Bool us_rep1 Int) Bool)
(assert true)
(assert (forall ((container us_rep1)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant9 key2 true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant2 result true false true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep1)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant2 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant10 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
(define-fun dynamic_invariant11 ((temp___expr_403 Int) (temp___is_init_400 Bool) (temp___skip_constant_401 Bool) (temp___do_toplevel_402 Bool)) Bool (=> (or (= temp___is_init_400 true) (<= 0 2147483647)) (in_range9 temp___expr_403)))
(assert (forall ((container us_rep3)) (! (let ((result (length3 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant2 result true false true))) :pattern ((length3 container)))))
...
(define-fun dynamic_invariant12 ((temp___expr_397 Int) (temp___is_init_394 Bool) (temp___skip_constant_395 Bool) (temp___do_toplevel_396 Bool)) Bool (=> (or (= temp___is_init_394 true) (<= 0 2147483647)) (in_range11 temp___expr_397)))
(assert (forall ((container us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant11 position true true true) (and (<= 1 position) (<= position (last2 container)))) (dynamic_invariant12 (get1 container position) true false true)) :pattern ((get1 container position))))))
(assert (forall ((container us_rep4)) (forall ((key2 us_rep2)) (! (=> (= (of_int 0) true) (=> (exists ((k us_rep2)) (and (= (has_key1 container k) true) (= (bool_eq4 k key2) true))) (= (has_key1 container key2) true))) :pattern ((has_key1 container key2))))))
...
(define-fun dynamic_invariant13 ((temp___expr_423 Int) (temp___is_init_420 Bool) (temp___skip_constant_421 Bool) (temp___do_toplevel_422 Bool)) Bool (=> (or (= temp___is_init_420 true) (<= 1 2147483647)) (in_range12 temp___expr_423)))
...
(assert (forall ((container us_rep4)) (forall ((key2 us_rep2)) (! (=> (= (has_key1 container key2) true) (let ((result (get2 container key2))) (and (=> (= (of_int 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k us_rep2)) (=> (= (has_key1 container k) true) (= (= (bool_eq4 k key2) true) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant13 result true false true)))) :pattern ((get2 container key2))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant2 (length4 container) true false true) :pattern ((length4 container)))))
(assert (forall ((container us_rep4)) (! (= (= (is_empty3 container) true) (forall ((key2 us_rep2)) (not (= (has_key1 container key2) true)))) :pattern ((is_empty3 container)))))
(assert (forall ((left us_rep4) (right us_rep4)) (! (= (= (keys_included left right) true) (forall ((key2 us_rep2)) (=> (= (has_key1 left key2) true) (= (has_key1 right key2) true)))) :pattern ((keys_included left right)))))
(assert (forall ((left us_rep4) (right us_rep4)) (forall ((new_key us_rep2)) (! (= (= (keys_included_except1 left right new_key) true) (forall ((key2 us_rep2)) (=> (= (has_key1 left key2) true) (=> (not (= (bool_eq4 key2 new_key) true)) (= (has_key1 right key2) true))))) :pattern ((keys_included_except1 left right new_key))))))
(declare-fun has_witness1 (us_rep4 Int) Bool)
(declare-fun has_witness__function_guard1 (Bool us_rep4 Int) Bool)
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 us_rep2)) (! (=> (= (has_key1 container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant2 result true false true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant2 witness2 true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant13 (w_get1 container witness2) true false true)) :pattern ((w_get1 container witness2))))))
(declare-const result____split_fields us_main_type)
(declare-const k Int)
(declare-const find_map__find_all__result count_type)
(declare-const find_map__find_all__result1 hash_type)
(declare-const find_map__find_all__result2 us_main_type)
(declare-const temp___706 Int)
(declare-const temp___705 count_type)
(declare-const temp___7051 hash_type)
(declare-const temp___7052 us_main_type)
...
(declare-const result11 index_map__ref)
(declare-const find_map__find_all__result3 us_rep)
(declare-const find_map__find_all__result4 index_map__ref)
(declare-const find_map__find_all__result5 us_rep)
(declare-const result____split_fields9 us_split_fields__ref)
(declare-const k8 int__ref)
(declare-const find_map__find_all__result6 index_map__ref)
(declare-const result____split_fields10 us_split_fields)
(declare-const k9 Int)
(declare-const find_map__find_all__result7 us_rep)
...
(assert (and (= 100 (to_rep3 (rec__find_map__index_maps__map__capacity result____split_discrs))) (= r258s (to_rep2 (rec__find_map__index_maps__map__modulus result____split_discrs)))))
(assert (and (= (length1 (mk___rep result____split_discrs (mk___split_fields find_map__index_maps__clear__container__fields))) 0) (= (is_empty (model__ (mk___rep result____split_discrs (mk___split_fields find_map__index_maps__clear__container__fields)))) true)))
(assert (= (mk___split_fields__ref (mk___split_fields result)) (mk___split_fields__ref (mk___split_fields result____split_fields))))
(assert (= (mk___split_fields result____split_fields1) (mk___split_fields find_map__index_maps__clear__container__fields)))
...
(assert (and (= o (has_key (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields1))) (to_rep (select (elts a) k1)))) (= (= o true) (= (has_key (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields1))) (to_rep (select (elts a) k1))) true))))
(assert (= result2 (ite (not (= o true)) true false)))
(assert (=> (= result2 true) (and (= o1 k1) (in_range5 k1))))
(assert (=> (= result2 true) (and (and (and (and (and (and (and (= (length1 (mk___rep result____split_discrs (mk___split_fields find_map__index_maps__insert__2__container__fields))) (+ (length1 (mk___rep result____split_discrs (mk___split_fields result____split_fields1))) 1)) (= (has_key (model__ (mk___rep result____split_discrs (mk___split_fields find_map__index_maps__insert__2__container__fields))) (to_rep (select (elts a) k1))) true)) (= (key (mk___rep result____split_discrs (mk___split_fields find_map__index_maps__insert__2__container__fields)) (find (mk___rep result____split_discrs (mk___split_fields find_map__index_maps__insert__2__container__fields)) (to_rep (select (elts a) k1)))) (to_rep (select (elts a) k1)))) (= (get (model__ (mk___rep result____split_discrs (mk___split_fields find_map__index_maps__insert__2__container__fields))) (to_rep (select (elts a) k1))) o1)) (= (ole (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields1))) (model__ (mk___rep result____split_discrs (mk___split_fields find_map__index_maps__insert__2__container__fields)))) true)) (= (keys_included_except (model__ (mk___rep result____split_discrs (mk___split_fields find_map__index_maps__insert__2__container__fields))) (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields1))) (to_rep (select (elts a) k1))) true)) (= (mapping_preserved (keys (mk___rep result____split_discrs (mk___split_fields result____split_fields1))) (keys (mk___rep result____split_discrs (mk___split_fields find_map__index_maps__insert__2__container__fields))) (positions (mk___rep result____split_discrs (mk___split_fields result____split_fields1))) (positions (mk___rep result____split_discrs (mk___split_fields find_map__index_maps__insert__2__container__fields)))) true)) (= (keys_included_except1 (positions (mk___rep result____split_discrs (mk___split_fields find_map__index_maps__insert__2__container__fields))) (positions (mk___rep result____split_discrs (mk___split_fields result____split_fields1))) (find (mk___rep result____split_discrs (mk___split_fields find_map__index_maps__insert__2__container__fields)) (to_rep (select (elts a) k1)))) true))))
(assert (=> (= result2 true) (= result3 result____split_fields1)))
(assert (=> (= result2 true) (= (mk___split_fields result____split_fields2) (mk___split_fields find_map__index_maps__insert__2__container__fields))))
(assert (=> (not (= result2 true)) (= (mk___split_fields result____split_fields2) (mk___split_fields result____split_fields1))))
(assert (<= (length1 (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) k2))
(assert (forall ((i2 Int)) (=> (and (<= (to_rep1 (first (rt a))) i2) (<= i2 k2)) (and (and (= (has_key (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) (to_rep (select (elts a) i2))) true) (and (<= (to_rep1 (first (rt a))) (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) (to_rep (select (elts a) i2)))) (<= (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) (to_rep (select (elts a) i2))) i2))) (= (to_rep (select (elts a) (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) (to_rep (select (elts a) i2))))) (to_rep (select (elts a) i2)))))))
(assert (forall ((e2 Int)) (=> (and (<= 0 e2) (<= e2 2147483647)) (=> (= (has_key (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) e2) true) (and (and (<= (to_rep1 (first (rt a))) (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) e2)) (<= (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) e2) k2)) (= (equivalent_keys (to_rep (select (elts a) (get (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) e2))) e2) true))))))
(assert (and (=> (<= (to_rep1 (first (rt a))) (to_rep1 (last (rt a)))) (dynamic_property1 (to_rep1 (first (rt a))) (to_rep1 (last (rt a))) k2)) (and (<= (to_rep1 (first (rt a))) k2) (<= k2 (to_rep1 (last (rt a)))))))
