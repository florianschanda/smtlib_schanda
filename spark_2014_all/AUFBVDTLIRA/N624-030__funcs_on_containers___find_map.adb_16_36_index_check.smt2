...
(define-fun dynamic_invariant ((temp___expr_354 us_t) (temp___is_init_350 Bool) (temp___skip_constant_351 Bool) (temp___do_toplevel_352 Bool) (temp___do_typ_inv_353 Bool)) Bool (=> (not (= temp___skip_constant_351 true)) (dynamic_property 1 100 (first1 temp___expr_354) (last1 temp___expr_354))))
...
(define-fun dynamic_invariant2 ((temp___expr_198 Int) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (<= 0 2147483647)) (in_range2 temp___expr_198)))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep3 (rec__find_map__index_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant2 result true false true true))) :pattern ((length1 container)))))
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (! (dynamic_invariant2 (length2 attr__tag container) true false true true) :pattern ((length2 attr__tag container))))))
...
(define-fun dynamic_invariant3 ((temp___expr_360 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool) (temp___do_typ_inv_359 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 2147483647)) (in_range6 temp___expr_360)))
(assert true)
...
(define-fun dynamic_invariant4 ((temp___expr_367 Int) (temp___is_init_363 Bool) (temp___skip_constant_364 Bool) (temp___do_toplevel_365 Bool) (temp___do_typ_inv_366 Bool)) Bool (=> (or (= temp___is_init_363 true) (<= 1 100)) (in_range5 temp___expr_367)))
(assert (forall ((attr__tag Int) (key2 Int)) (forall ((container us_rep)) (! (=> (dynamic_invariant3 key2 true true true true) (dynamic_invariant4 (element__21 attr__tag container key2) true false true true)) :pattern ((element__21 attr__tag container key2))))))
...
(define-fun dynamic_invariant7 ((temp___expr_347 Int) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool) (temp___do_typ_inv_346 Bool)) Bool (=> (or (= temp___is_init_343 true) (<= 1 100)) (in_range4 temp___expr_347)))
(define-fun dynamic_invariant8 ((temp___expr_191 (_ BitVec 32)) (temp___is_init_187 Bool) (temp___skip_constant_188 Bool) (temp___do_toplevel_189 Bool) (temp___do_typ_inv_190 Bool)) Bool true)
...
(define-fun default_initial_assumption1 ((temp___expr_451 us_rep3) (temp___skip_top_level_452 Bool)) Bool (=> (not (= temp___skip_top_level_452 true)) (= (length3 temp___expr_451) 0)))
(declare-fun find2 (us_rep3 Int) Int)
(declare-fun find__function_guard2 (Int us_rep3 Int) Bool)
(assert (forall ((container us_rep3)) (forall ((key2 Int)) (! (=> (dynamic_invariant3 key2 true true true true) (let ((result (find2 container key2))) (and (=> (< 0 result) (and (<= result (length3 container)) (= (equivalent_keys key2 (get1 container result)) true))) (dynamic_invariant2 result true false true true)))) :pattern ((find2 container key2))))))
...
(define-fun default_initial_assumption2 ((temp___expr_474 us_rep4) (temp___skip_top_level_475 Bool)) Bool (=> (not (= temp___skip_top_level_475 true)) (and (= (is_empty3 temp___expr_474) true) (= (length4 temp___expr_474) 0))))
...
(define-fun default_initial_assumption3 ((temp___expr_415 us_rep1) (temp___skip_top_level_416 Bool)) Bool (=> (not (= temp___skip_top_level_416 true)) (and (= (is_empty temp___expr_415) true) (= (length5 temp___expr_415) 0))))
(assert true)
...
(assert (forall ((attr__tag Int)) (forall ((container us_rep)) (forall ((position us_rep2)) (! (dynamic_invariant3 (key1 attr__tag container position) true false true true) :pattern ((key1 attr__tag container position)))))))
...
(assert (forall ((container us_rep1)) (forall ((key2 Int)) (! (=> (dynamic_invariant9 key2 true true true true) (=> (= (distinct 1 0) true) (=> (exists ((k Int)) (and (and (in_range8 k) (= (has_key container k) true)) (= (equivalent_keys k key2) true))) (= (has_key container key2) true)))) :pattern ((has_key container key2))))))
...
(assert (forall ((container us_rep1)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant9 key2 true true true true) (= (has_key container key2) true)) (let ((result (get container key2))) (and (=> (= (distinct 1 0) true) (and (= result (w_get container (witness container key2))) (forall ((k Int)) (=> (and (in_range8 k) (= (has_key container k) true)) (= (= (equivalent_keys k key2) true) (= (witness container key2) (witness container k))))))) (dynamic_invariant10 result true false true true)))) :pattern ((get container key2))))))
(assert (forall ((container us_rep1)) (! (dynamic_invariant2 (length5 container) true false true true) :pattern ((length5 container)))))
...
(assert true)
(assert (forall ((container us_rep1)) (forall ((key2 Int)) (! (=> (and (dynamic_invariant9 key2 true true true true) (= (has_key container key2) true)) (let ((result (witness container key2))) (and (= (has_witness container result) true) (dynamic_invariant2 result true false true true)))) :pattern ((witness container key2))))))
(assert (forall ((container us_rep1)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant2 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant10 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
...
(assert (forall ((container us_rep3)) (! (let ((result (length3 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant2 result true false true true))) :pattern ((length3 container)))))
...
(assert (forall ((container us_rep3)) (forall ((position Int)) (! (=> (and (dynamic_invariant11 position true true true true) (and (<= 1 position) (<= position (last2 container)))) (dynamic_invariant12 (get1 container position) true false true true)) :pattern ((get1 container position))))))
(assert (forall ((container us_rep4)) (forall ((key2 us_rep2)) (! (=> (= (distinct 0 0) true) (=> (exists ((k us_rep2)) (and (= (has_key1 container k) true) (= (bool_eq4 k key2) true))) (= (has_key1 container key2) true))) :pattern ((has_key1 container key2))))))
...
(assert (forall ((container us_rep4)) (forall ((key2 us_rep2)) (! (=> (= (has_key1 container key2) true) (let ((result (get2 container key2))) (and (=> (= (distinct 0 0) true) (and (= result (w_get1 container (witness1 container key2))) (forall ((k us_rep2)) (=> (= (has_key1 container k) true) (= (= (bool_eq4 k key2) true) (= (witness1 container key2) (witness1 container k))))))) (dynamic_invariant13 result true false true true)))) :pattern ((get2 container key2))))))
(assert (forall ((container us_rep4)) (! (dynamic_invariant2 (length4 container) true false true true) :pattern ((length4 container)))))
...
(assert true)
(assert (forall ((container us_rep4)) (forall ((key2 us_rep2)) (! (=> (= (has_key1 container key2) true) (let ((result (witness1 container key2))) (and (= (has_witness1 container result) true) (dynamic_invariant2 result true false true true)))) :pattern ((witness1 container key2))))))
(assert (forall ((container us_rep4)) (forall ((witness2 Int)) (! (=> (and (dynamic_invariant2 witness2 true true true true) (= (has_witness1 container witness2) true)) (dynamic_invariant13 (w_get1 container witness2) true false true true)) :pattern ((w_get1 container witness2))))))
