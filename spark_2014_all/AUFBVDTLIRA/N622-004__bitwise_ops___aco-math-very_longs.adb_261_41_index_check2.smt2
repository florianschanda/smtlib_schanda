...
(assert (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1286) (<= temp___1286 (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))))))
(assert (= o19 temp___1286))
(assert (= o20 (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)) o19)))
...
(assert (and (= o23 (+ i2 j2)) (in_range3 (+ i2 j2))))
(assert (= temp___1288 (- o23 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1288)))
(check-sat)
(exit)
