...
(declare-const o13 (Array (_ BitVec 64) unsigned8))
(declare-const o14 unsigned8)
(declare-const o15 (Array (_ BitVec 64) unsigned8))
...
(declare-const result6 (Array (_ BitVec 64) unsigned8))
(declare-const memory7 (Array (_ BitVec 64) unsigned8))
(declare-const result7 (Array (_ BitVec 64) unsigned8))
...
(assert (= memory1 o1))
(assert (= (to_rep o2) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 64) 256)) ((_ int2bv 64) 256)))))
(assert (= o3 (store memory1 (bvadd addr ((_ int2bv 64) 1)) o2)))
(assert (= memory1 result1))
(assert (= memory2 o3))
(assert (= (to_rep o4) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 64) 65536)) ((_ int2bv 64) 256)))))
(assert (= o5 (store memory2 (bvadd addr ((_ int2bv 64) 2)) o4)))
(assert (= memory2 result2))
(assert (= memory3 o5))
(assert (= (to_rep o6) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 64) 16777216)) ((_ int2bv 64) 256)))))
(assert (= o7 (store memory3 (bvadd addr ((_ int2bv 64) 3)) o6)))
(assert (= memory3 result3))
(assert (= memory4 o7))
(assert (= (to_rep o8) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 64) 4294967296)) ((_ int2bv 64) 256)))))
(assert (= o9 (store memory4 (bvadd addr ((_ int2bv 64) 4)) o8)))
(assert (= memory4 result4))
(assert (= memory5 o9))
(assert (= (to_rep o10) ((_ extract 7 0) (bvurem (bvudiv val__ ((_ int2bv 64) 1099511627776)) ((_ int2bv 64) 256)))))
