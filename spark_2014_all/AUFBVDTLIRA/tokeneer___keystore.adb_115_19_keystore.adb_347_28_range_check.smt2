...
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c70b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c70b)))))) (= o (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c70b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c70b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c70b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c70b))))))) (= o 0)))
...
(assert (= (concat1 (temp___String_Literal_1284 Tuple0) 1 43 (elts (to_string (attr__ATTRIBUTE_IMAGE9 c70b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c70b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c70b)))))) keystore__dofind__B74b__thestring__assume))
(assert (= (mk 1 o5) keystore__dofind__B74b__thestring__assume1))
(assert (= (mk___t keystore__dofind__B74b__thestring__assume keystore__dofind__B74b__thestring__assume1) thestring))
