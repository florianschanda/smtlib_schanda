...
(assert (= (ite (<= (to_rep (first4 temp___88061)) (to_rep (last4 temp___88061))) (+ (- (to_rep (last4 temp___88061)) (to_rep (first4 temp___88061))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8806 temp___8807))
(assert (= (mk1 (to_rep (first4 temp___88061)) (to_rep (last4 temp___88061))) temp___88071))
(assert (= (ite (<= (to_rep (first2 temp___88071)) (to_rep (last2 temp___88071))) (+ (- (to_rep (last2 temp___88071)) (to_rep (first2 temp___88071))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8807 temp___88071)))
(assert (= o2 o))
