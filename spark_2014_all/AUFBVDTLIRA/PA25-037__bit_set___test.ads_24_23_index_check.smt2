...
(assert (=> (< temp___224 4294967296) (= o4 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___224)))))
...
(assert (and (<= (to_rep1 (first (rt a))) temp___223) (<= temp___223 (to_rep1 (last (rt a))))))
...
(assert (and (= temp___226 (bv2nat (bvurem i ((_ int2bv 64) 32)))) (in_range2 (bv2nat (bvurem i ((_ int2bv 64) 32))))))
(assert (=> (< temp___226 4294967296) (= o11 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___226)))))
(assert (=> (not (< temp___226 4294967296)) (= o11 ((_ int2bv 32) 0))))
(assert (and (= o9 (bv2nat (bvudiv i ((_ int2bv 64) 32)))) (in_range2 (bv2nat (bvudiv i ((_ int2bv 64) 32))))))
(assert (= o10 (+ a_first o9)))
(assert (and (= temp___225 o10) (in_range1 o10)))
(assert (not (<= (to_rep1 (first (rt a))) temp___225)))
(check-sat)
(exit)
