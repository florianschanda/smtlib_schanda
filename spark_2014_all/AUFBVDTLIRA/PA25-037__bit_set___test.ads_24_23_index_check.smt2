...
(assert (=> (< temp___226 4294967296) (= o14 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___226)))))
(assert (=> (not (< temp___226 4294967296)) (= o14 ((_ int2bv 32) 0))))
(assert (and (= o12 (bv2nat (bvudiv i ((_ int2bv 64) 32)))) (in_range2 (bv2nat (bvudiv i ((_ int2bv 64) 32))))))
(assert (= o13 (+ a_first o12)))
(assert (and (= temp___225 o13) (in_range1 o13)))
