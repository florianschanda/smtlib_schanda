...
(assert (= test__bit_set__result1 test__bit_set__result2))
(assert (= test__bit_set__result3 test__bit_set__result1))
(assert (and (= temp___260 (bv2nat (bvurem i #x0000000000000020))) (in_range2 (bv2nat (bvurem i #x0000000000000020)))))
(assert (=> (< temp___260 4294967296) (= o4 (bvshl #x00000001 ((_ int2bv 32) temp___260)))))
(assert (=> (not (< temp___260 4294967296)) (= o4 #x00000000)))
...
(assert (and (<= (to_rep1 (first (rt a))) temp___259) (<= temp___259 (to_rep1 (last (rt a))))))
(assert (= o2 temp___259))
(assert (= o3 (select (elts a) o2)))
(assert (= o5 (to_rep o3)))
(assert (= o6 (bvand o5 o4)))
(assert (= o7 (ite (= o6 #x00000000) true false)))
(assert (= o8 (ite (not (= o7 true)) true false)))
(assert (= (mk_bool__ref result) (mk_bool__ref test__bit_set__result)))
(assert (= test__bit_set__result1 o8))
(assert (= (mk_bool__ref test__bit_set__result4) (mk_bool__ref test__bit_set__result2)))
(assert (= test__bit_set__result5 test__bit_set__result3))
(assert (and (= temp___262 (bv2nat (bvurem i #x0000000000000020))) (in_range2 (bv2nat (bvurem i #x0000000000000020)))))
(assert (=> (< temp___262 4294967296) (= o11 (bvshl #x00000001 ((_ int2bv 32) temp___262)))))
(assert (=> (not (< temp___262 4294967296)) (= o11 #x00000000)))
(assert (and (= o9 (bv2nat (bvudiv i #x0000000000000020))) (in_range2 (bv2nat (bvudiv i #x0000000000000020)))))
(assert (= o10 (+ a_first o9)))
(assert (and (= temp___261 o10) (in_range1 o10)))
(assert (not (<= (to_rep1 (first (rt a))) temp___261)))
(check-sat)
(exit)
