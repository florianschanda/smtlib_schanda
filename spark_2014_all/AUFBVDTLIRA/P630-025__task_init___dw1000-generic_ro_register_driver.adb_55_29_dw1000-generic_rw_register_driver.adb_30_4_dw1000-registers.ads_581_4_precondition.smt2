...
(define-fun dynamic_invariant ((temp___expr_6846 us_t1) (temp___is_init_6843 Bool) (temp___skip_constant_6844 Bool) (temp___do_toplevel_6845 Bool)) Bool (=> (not (= temp___skip_constant_6844 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6846) (last3 temp___expr_6846)) (and (= (first3 temp___expr_6846) 1) (= (last3 temp___expr_6846) 2)))))
