...
(define-fun dynamic_invariant ((temp___expr_7435 us_t1) (temp___is_init_7432 Bool) (temp___skip_constant_7433 Bool) (temp___do_toplevel_7434 Bool)) Bool (=> (not (= temp___skip_constant_7433 true)) (and (dynamic_property2 1 4 (first3 temp___expr_7435) (last3 temp___expr_7435)) (and (= (first3 temp___expr_7435) 1) (= (last3 temp___expr_7435) 4)))))
