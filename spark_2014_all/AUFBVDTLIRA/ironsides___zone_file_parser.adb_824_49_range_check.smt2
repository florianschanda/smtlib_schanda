...
(assert (= begidx1 1))
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 256)) (<= endidx1 256)) (=> (= foundtype1 1) (forall ((i3 Int)) (=> (and (<= begidx2 i3) (<= i3 endidx1)) (and (<= 48 (to_rep (select rrstring i3))) (<= (to_rep (select rrstring i3)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
(assert (= foundtype1 3))
...
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (and (and (and (and (<= begidx4 endidx3) (<= begidx4 256)) (<= endidx3 256)) (=> (= foundtype3 1) (forall ((i3 Int)) (=> (and (<= begidx4 i3) (<= i3 endidx3)) (and (<= 48 (to_rep (select rrstring i3))) (<= (to_rep (select rrstring i3)) 57)))))) (and (and (in_range4 begidx4) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (not (in_range9 (+ numberofblocks3 1))))
(check-sat)
(exit)
