...
(assert (= begidx1 1))
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 256)) (<= endidx1 256)) (=> (= foundtype1 1) (forall ((i3 Int)) (=> (and (<= begidx2 i3) (<= i3 endidx1)) (and (<= 48 (to_rep (select rrstring i3))) (<= (to_rep (select rrstring i3)) 57)))))) (and (and (in_range3 begidx2) (in_range3 endidx1)) (in_range2 foundtype1))))
(assert (= foundtype1 3))
...
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (and (and (and (and (<= begidx4 endidx3) (<= begidx4 256)) (<= endidx3 256)) (=> (= foundtype3 1) (forall ((i3 Int)) (=> (and (<= begidx4 i3) (<= i3 endidx3)) (and (<= 48 (to_rep (select rrstring i3))) (<= (to_rep (select rrstring i3)) 57)))))) (and (and (in_range3 begidx4) (in_range3 endidx3)) (in_range2 foundtype3)))))
...
(assert (and (=> (<= 0 32) (in_range8 numberofblocks3)) (and (bvule #x00 i2) (bvule i2 #xFF))))
(assert (ite (= (select (map__content5 blockmap7) i2) true) (not (= i2 blocknumberoffirstrecordtype1)) true))
(assert (ite (= (select (map__content5 blockmap7) i2) true) true false))
(assert (and (= o43 (+ numberofblocks3 1)) (in_range8 (+ numberofblocks3 1))))
(assert (= result25 (mk_int__ref numberofblocks3)))
(assert (= numberofblocks4 o43))
(assert (= (to_rep1 o44) i2))
(assert (and (<= 1 numberofblocks4) (<= numberofblocks4 32)))
(assert (= o45 numberofblocks4))
(assert (= o46 (store blocknumbers2 o45 o44)))
(assert (= result26 (mk_map__ref1 blocknumbers2)))
(assert (= blocknumbers3 o46))
(assert (= (to_rep3 o47) (to_rep3 (select (map__content6 blocklengthmap7) i2))))
(assert (not (<= 1 numberofblocks4)))
(check-sat)
(exit)
