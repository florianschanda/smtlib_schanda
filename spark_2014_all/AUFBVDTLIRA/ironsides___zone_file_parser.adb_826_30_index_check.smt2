...
(assert (bvule ((_ int2bv 8) 0) i4))
(assert (bvule i4 ((_ int2bv 8) 255)))
(assert (and (and (and (and (<= 1 numberofblocks3) (< numberofblocks3 32)) (forall ((j26 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) j26) (bvule j26 ((_ int2bv 8) 255))) (and (<= 1 (to_rep3 (select (map__content6 blocklengthmap9) j26))) (<= (to_rep3 (select (map__content6 blocklengthmap9) j26)) 32))))) (<= 1 (int__content numberofrecordtypes9))) (<= (int__content numberofrecordtypes9) 32)))
(assert (and (=> (<= 0 32) (in_range8 numberofblocks3)) (and (bvule ((_ int2bv 8) 0) i5) (bvule i5 ((_ int2bv 8) 255)))))
(assert (ite (= (select (map__content5 blockmap9) i5) true) (not (= i5 blocknumberoffirstrecordtype2)) true))
(assert (ite (= (select (map__content5 blockmap9) i5) true) true false))
(assert (and (= o43 (+ numberofblocks3 1)) (in_range8 (+ numberofblocks3 1))))
(assert (= result26 (mk_int__ref numberofblocks3)))
(assert (= numberofblocks4 o43))
(assert (= (to_rep1 o44) i5))
(assert (and (<= 1 numberofblocks4) (<= numberofblocks4 32)))
(assert (= o45 numberofblocks4))
(assert (= o46 (store blocknumbers2 o45 o44)))
(assert (= result27 (mk_map__ref1 blocknumbers2)))
(assert (= blocknumbers3 o46))
(assert (= (to_rep3 o47) (to_rep3 (select (map__content6 blocklengthmap9) i5))))
