...
(assert (= x86__ecx__result1 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xcx 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xcx 3))) ((_ int2bv 32) 16777216)))))
...
(assert (not (= x86__ecx__result4 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xcx 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xcx 3))) ((_ int2bv 32) 16777216))))))
(check-sat)
(exit)
