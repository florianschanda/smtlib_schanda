...
(assert (= x86__ecx__result1 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xcx 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xcx 3))) #x01000000))))
...
(assert (not (= x86__ecx__result4 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select xcx 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select xcx 3))) #x01000000)))))
(check-sat)
(exit)
