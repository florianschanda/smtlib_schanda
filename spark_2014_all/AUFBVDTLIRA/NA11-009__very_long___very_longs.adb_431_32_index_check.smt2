...
(declare-const o15 t)
(declare-const temp___1303 digit_index_type)
(declare-const temp___13031 (Array Int octet))
(declare-const temp___13032 t)
...
(assert (<= 1 i1))
(assert (<= i1 r122b))
(assert (and (and (dynamic_invariant2 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true true) (forall ((temp___1312 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1312) (<= temp___1312 (to_rep1 (last number__split_fields3)))) (=> (or (< r122b temp___1312) (or (< temp___1312 1) (<= temp___1312 i2))) (= (select number__split_fields2 temp___1312) (select number__split_fields temp___1312)))))) (and (<= 1 i2) (<= i2 r122b))))
...
(assert (= o14 o12))
(assert (= o15 o13))
(assert (= number__split_discrs (mk___split_discrs temp___1303)))
(assert (= temp___13031 o14))
(assert (= temp___13032 o15))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___13031 temp___13032))))
(assert (= number__split_discrs (mk___split_discrs temp___1303)))
