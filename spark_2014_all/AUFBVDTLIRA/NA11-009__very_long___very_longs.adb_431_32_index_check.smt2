...
(define-fun dynamic_invariant4 ((temp___expr_228 Int) (temp___is_init_224 Bool) (temp___skip_constant_225 Bool) (temp___do_toplevel_226 Bool) (temp___do_typ_inv_227 Bool)) Bool (=> (or (= temp___is_init_224 true) (<= 1 65536)) (in_range2 temp___expr_228)))
...
(declare-const o15 t)
(declare-const temp___1301 digit_index_type)
(declare-const temp___13011 (Array Int octet))
(declare-const temp___13012 t)
...
(assert (and (= o (shift_right__2 #xFF (- 8 distance))) (= o (bvudiv #xFF (ite (< (- 8 distance) 256) (bvshl #x01 ((_ int2bv 8) (- 8 distance))) #x00)))))
(assert (= result1 overflow_mask))
(assert (= overflow_mask1 o))
(assert (= (to_rep1 (last number__split_fields1)) r122b))
(assert (in_range1 r122b))
(assert (= result2 i))
(assert (= i1 r122b))
(assert (<= 1 i1))
(assert (<= i1 r122b))
(assert (and (and (dynamic_invariant1 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true true) (forall ((temp___1310 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1310) (<= temp___1310 (to_rep1 (last number__split_fields3)))) (=> (<= temp___1310 i2) (= (select number__split_fields2 temp___1310) (select number__split_fields temp___1310)))))) (and (<= 1 i2) (<= i2 r122b))))
...
(assert (= o7 (to_rep o6)))
(assert (and (= o8 (shift_right__2 o7 distance)) (= o8 (bvudiv o7 (ite (< distance 256) (bvshl #x01 ((_ int2bv 8) distance)) #x00)))))
(assert (= (to_rep o9) o8))
(assert (and (<= (to_rep1 (first number__split_fields3)) i2) (<= i2 (to_rep1 (last number__split_fields3)))))
(assert (= o10 i2))
...
(assert (= o14 o12))
(assert (= o15 o13))
(assert (= number__split_discrs (mk___split_discrs temp___1301)))
(assert (= temp___13011 o14))
(assert (= temp___13012 o15))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___13011 temp___13012))))
(assert (= number__split_discrs (mk___split_discrs temp___1301)))
...
(assert (= o16 i2))
(assert (= o17 (select (elts (rec__very_longs__very_long__long_digits number__split_fields4)) o16)))
