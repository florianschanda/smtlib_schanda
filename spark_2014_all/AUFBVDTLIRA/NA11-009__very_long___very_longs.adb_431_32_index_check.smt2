...
(define-fun dynamic_invariant ((temp___expr_210 (_ BitVec 8)) (temp___is_init_207 Bool) (temp___skip_constant_208 Bool) (temp___do_toplevel_209 Bool)) Bool true)
...
(define-fun dynamic_invariant3 ((temp___expr_702 Int) (temp___is_init_699 Bool) (temp___skip_constant_700 Bool) (temp___do_toplevel_701 Bool)) Bool (=> (or (= temp___is_init_699 true) (<= 0 7)) (in_range4 temp___expr_702)))
...
(define-fun dynamic_invariant4 ((temp___expr_204 Int) (temp___is_init_201 Bool) (temp___skip_constant_202 Bool) (temp___do_toplevel_203 Bool)) Bool (=> (or (= temp___is_init_201 true) (<= 1 65536)) (in_range2 temp___expr_204)))
...
(assert (<= 1 i1))
(assert (<= i1 r122b))
(assert (and (and (dynamic_invariant1 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true) (forall ((temp___1241 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1241) (<= temp___1241 (to_rep1 (last number__split_fields3)))) (=> (<= temp___1241 i2) (= (select number__split_fields2 temp___1241) (select number__split_fields temp___1241)))))) (and (<= 1 i2) (<= i2 r122b))))
...
(assert (= o14 o12))
(assert (= o15 o13))
(assert (= number__split_discrs (mk___split_discrs temp___1232)))
(assert (= temp___12321 o14))
(assert (= temp___12322 o15))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___12321 temp___12322))))
(assert (= number__split_discrs (mk___split_discrs temp___1232)))
