...
(define-fun dynamic_invariant1 ((temp___expr_204 Int) (temp___is_init_201 Bool) (temp___skip_constant_202 Bool) (temp___do_toplevel_203 Bool)) Bool (=> (or (= temp___is_init_201 true) (<= 1 65536)) (in_range1 temp___expr_204)))
...
(assert (<= 1 i1))
(assert (<= i1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
(assert (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))))
...
(assert (= o2 i2))
(assert (= o3 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 r))) o2)))
...
(assert (= o i2))
(assert (= o1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 l))) o)))
