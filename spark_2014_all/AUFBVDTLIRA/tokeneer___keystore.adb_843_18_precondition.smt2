...
(assert (=> (= result4 true) (= temp___1191 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring))))))
(assert (=> (= result4 true) (and (= temp___1193 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= result4 true) (=> (<= 1 temp___1193) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1193) (<= temp___1193 150))))))
(assert (=> (= result4 true) (= o17 result__1)))
(assert (=> (= result4 true) (= temp___1194 (mk___t1 o17 (mk1 1 temp___1193)))))
(assert (=> (= result4 true) (= (ite (<= (to_rep1 (first2 (rt1 temp___1191))) (to_rep1 (last2 (rt1 temp___1191)))) (+ (- (to_rep1 (last2 (rt1 temp___1191))) (to_rep1 (first2 (rt1 temp___1191)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1194))) (to_rep1 (last2 (rt1 temp___1194)))) (+ (- (to_rep1 (last2 (rt1 temp___1194))) (to_rep1 (first2 (rt1 temp___1194)))) 1) 0))))
(assert (=> (= result4 true) (= temp___1195 temp___1191)))
(assert (=> (= result4 true) (forall ((temp___1196 Int)) (ite (and (<= 1 temp___1196) (<= temp___1196 (length thestring))) (= (select o18 temp___1196) (select (elts1 temp___1195) temp___1196)) (= (select o18 temp___1196) (select result__1 temp___1196))))))
