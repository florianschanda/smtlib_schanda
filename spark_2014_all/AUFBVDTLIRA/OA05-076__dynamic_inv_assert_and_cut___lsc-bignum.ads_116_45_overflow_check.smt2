...
(assert (= a9 a7))
(assert (= o11 (num_of_boolean (bool__content carry8))))
...
(assert (= o10 (oexpon o5 o9)))
(assert (= o12 (omultiply o10 o11)))
(assert (and (= o (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o1 (+ o 1)))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (and (= o3 o2) (in_range2 o2)))
(assert (= o4 (num_of_big_int (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last))) a_first o3)))
(assert (= o13 (osubtract o4 o12)))
