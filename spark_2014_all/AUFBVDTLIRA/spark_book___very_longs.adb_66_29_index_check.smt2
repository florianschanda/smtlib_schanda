...
(assert (= (to_rep2 (first4 (rt2 (temp___1124 ((_ int2bv 8) 0) 1 r9b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1124 ((_ int2bv 8) 0) 1 r9b)))) r9b))
(assert (= (mk___t2 temp___1131 temp___11311) (temp___1124 ((_ int2bv 8) 0) 1 r9b)))
(assert (= (ite (<= (to_rep2 (first4 temp___11311)) (to_rep2 (last4 temp___11311))) (+ (- (to_rep2 (last4 temp___11311)) (to_rep2 (first4 temp___11311))) 1) 0) (ite (<= 1 r9b) (+ (- r9b 1) 1) 0)))
(assert (= temp___1131 temp___1132))
(assert (= (mk1 (to_rep2 (first4 temp___11311)) (to_rep2 (last4 temp___11311))) temp___11321))
(assert (= (ite (<= (to_rep2 (first2 temp___11321)) (to_rep2 (last2 temp___11321))) (+ (- (to_rep2 (last2 temp___11321)) (to_rep2 (first2 temp___11321))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1134 temp___11341) (mk___t1 temp___1132 temp___11321)))
(assert (= temp___1134 o))
(assert (= (mk (to_rep2 (first2 temp___11341)) (to_rep2 (last2 temp___11341))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1136)))
(assert (= temp___11361 o2))
(assert (= temp___11362 o3))
(assert (= result result____split_fields))
(assert (= result1 result____split_fields1))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___11361 temp___11362))))
(assert (= result____split_discrs (mk___split_discrs temp___1136)))
...
(assert (and (and (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true) (forall ((temp___1144 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1144) (<= temp___1144 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1144) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1144) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1144)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (= r_digit2 o11))
(assert (= result6 (mk_t__ref1 sum1)))
