...
(assert (= (to_rep2 (first4 (rt2 (temp___1193 #x00 1 r9b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1193 #x00 1 r9b)))) r9b))
(assert (= (mk___t2 temp___1200 temp___12001) (temp___1193 #x00 1 r9b)))
(assert (= (ite (<= (to_rep2 (first4 temp___12001)) (to_rep2 (last4 temp___12001))) (+ (- (to_rep2 (last4 temp___12001)) (to_rep2 (first4 temp___12001))) 1) 0) (ite (<= 1 r9b) (+ (- r9b 1) 1) 0)))
(assert (= temp___1200 temp___1201))
(assert (= (mk1 (to_rep2 (first4 temp___12001)) (to_rep2 (last4 temp___12001))) temp___12011))
(assert (= (ite (<= (to_rep2 (first2 temp___12011)) (to_rep2 (last2 temp___12011))) (+ (- (to_rep2 (last2 temp___12011)) (to_rep2 (first2 temp___12011))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1203 temp___12031) (mk___t1 temp___1201 temp___12011)))
(assert (= temp___1203 o))
(assert (= (mk (to_rep2 (first2 temp___12031)) (to_rep2 (last2 temp___12031))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (and (and (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1213 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1213) (<= temp___1213 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1213) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1213) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1213)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
