...
(define-fun dynamic_invariant ((temp___expr_5931 us_t1) (temp___is_init_5928 Bool) (temp___skip_constant_5929 Bool) (temp___do_toplevel_5930 Bool)) Bool (=> (not (= temp___skip_constant_5929 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5931) (last3 temp___expr_5931)) (and (= (first3 temp___expr_5931) 1) (= (last3 temp___expr_5931) 1)))))
