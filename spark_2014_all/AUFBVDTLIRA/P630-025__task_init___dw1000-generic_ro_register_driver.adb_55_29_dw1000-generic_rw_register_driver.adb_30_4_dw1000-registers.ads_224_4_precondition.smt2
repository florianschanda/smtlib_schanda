...
(define-fun dynamic_invariant ((temp___expr_2332 us_t1) (temp___is_init_2329 Bool) (temp___skip_constant_2330 Bool) (temp___do_toplevel_2331 Bool)) Bool (=> (not (= temp___skip_constant_2330 true)) (and (dynamic_property2 1 2 (first3 temp___expr_2332) (last3 temp___expr_2332)) (and (= (first3 temp___expr_2332) 1) (= (last3 temp___expr_2332) 2)))))
