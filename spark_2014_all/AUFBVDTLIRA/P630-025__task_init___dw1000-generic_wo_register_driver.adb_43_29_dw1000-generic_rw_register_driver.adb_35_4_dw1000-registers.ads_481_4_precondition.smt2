...
(assert (= (ite (<= (to_rep (first4 temp___80481)) (to_rep (last4 temp___80481))) (+ (- (to_rep (last4 temp___80481)) (to_rep (first4 temp___80481))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8048 temp___8049))
(assert (= (mk1 (to_rep (first4 temp___80481)) (to_rep (last4 temp___80481))) temp___80491))
(assert (= (ite (<= (to_rep (first2 temp___80491)) (to_rep (last2 temp___80491))) (+ (- (to_rep (last2 temp___80491)) (to_rep (first2 temp___80491))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
