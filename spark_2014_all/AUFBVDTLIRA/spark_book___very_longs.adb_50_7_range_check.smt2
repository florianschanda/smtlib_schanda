...
(declare-fun temp___1193 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1195 (_ BitVec 8))) (forall ((temp___1196 Int) (temp___1197 Int)) (let ((temp___1194 (temp___1193 temp___1195 temp___1196 temp___1197))) (=> (dynamic_invariant3 temp___1195 true true true true) (and (=> (dynamic_property6 1 65536 temp___1196 temp___1197) (and (= (first5 temp___1194) temp___1196) (= (last5 temp___1194) temp___1197))) (forall ((temp___1198 Int)) (= (to_rep1 (select (to_array2 temp___1194) temp___1198)) temp___1195))))))))
