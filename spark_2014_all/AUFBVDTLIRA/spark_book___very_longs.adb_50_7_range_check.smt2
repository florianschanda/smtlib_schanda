...
(declare-fun temp___1124 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___1126 (_ BitVec 8))) (forall ((temp___1127 Int) (temp___1128 Int)) (let ((temp___1125 (temp___1124 temp___1126 temp___1127 temp___1128))) (and (=> (dynamic_property6 1 65536 temp___1127 temp___1128) (and (= (first5 temp___1125) temp___1127) (= (last5 temp___1125) temp___1128))) (forall ((temp___1129 Int)) (= (select (to_array2 temp___1125) temp___1129) (of_rep1 temp___1126))))))))
...
(declare-const temp___1131 (Array Int octet))
(declare-const temp___11311 t2)
(declare-const temp___1132 (Array Int octet))
(declare-const temp___11321 t1)
(declare-const temp___1134 (Array Int octet))
(declare-const temp___11341 t1)
(declare-const o (Array Int octet))
(declare-const o1 t)
(declare-const o2 (Array Int octet))
(declare-const o3 t)
(declare-const temp___1136 digit_index_type)
(declare-const temp___11361 (Array Int octet))
(declare-const temp___11362 t)
