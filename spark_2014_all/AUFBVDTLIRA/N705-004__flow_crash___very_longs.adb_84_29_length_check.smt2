...
(assert (not (= (ite (<= (to_rep2 (first4 temp___11761)) (to_rep2 (last4 temp___11761))) (+ (- (to_rep2 (last4 temp___11761)) (to_rep2 (first4 temp___11761))) 1) 0) (ite (<= 1 r21b) (+ (- r21b 1) 1) 0))))
(check-sat)
(exit)
