...
(define-fun dynamic_invariant ((temp___expr_7784 us_t1) (temp___is_init_7780 Bool) (temp___skip_constant_7781 Bool) (temp___do_toplevel_7782 Bool) (temp___do_typ_inv_7783 Bool)) Bool (=> (not (= temp___skip_constant_7781 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7784) (last3 temp___expr_7784)) (and (= (first3 temp___expr_7784) 1) (= (last3 temp___expr_7784) 2)))))
