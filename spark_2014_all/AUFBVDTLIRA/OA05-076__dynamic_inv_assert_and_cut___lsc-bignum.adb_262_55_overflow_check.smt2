...
(assert (= a9 a7))
(assert (= o27 (from_word32 (t__content carry28))))
(assert (and (= o26 (base Tuple0)) (= o26 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o28 (omultiply o26 o27)))
(assert (= o25 (from_word32 (t__content carry18))))
(assert (= o29 (oadd o25 o28)))
...
(assert (= o30 (omultiply o24 o29)))
(assert (and (= o14 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o15 (+ o14 1)))
(assert (and (= o16 o15) (in_range1 o15)))
(assert (and (= o17 o16) (in_range2 o16)))
(assert (= o18 (num_of_big_int (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last))) a_first o17)))
(assert (= o31 (oadd o18 o30)))
