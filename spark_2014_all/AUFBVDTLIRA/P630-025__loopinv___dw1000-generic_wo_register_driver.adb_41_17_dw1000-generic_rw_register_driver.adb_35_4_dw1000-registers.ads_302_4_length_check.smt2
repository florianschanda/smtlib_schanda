...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__agc_tune2_type__agc_tune2 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__agc_tune2_type__agc_tune2 (us_split_fields1 b)))) true false))
...
(define-fun register_byte_array__ref___46__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3920 us_t1) (temp___is_init_3916 Bool) (temp___skip_constant_3917 Bool) (temp___do_toplevel_3918 Bool) (temp___do_typ_inv_3919 Bool)) Bool (=> (not (= temp___skip_constant_3917 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3920) (last3 temp___expr_3920)) (and (= (first3 temp___expr_3920) 1) (= (last3 temp___expr_3920) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___19__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_3938 us_t2) (temp___is_init_3934 Bool) (temp___skip_constant_3935 Bool) (temp___do_toplevel_3936 Bool) (temp___do_typ_inv_3937 Bool)) Bool (=> (not (= temp___skip_constant_3935 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3938) (last5 temp___expr_3938)) (and (= (first5 temp___expr_3938) 1) (= (last5 temp___expr_3938) 4)))))
...
(declare-const temp___86121 t2)
(declare-const temp___8613 (Array Int bits_8))
(declare-const temp___86131 t1)
(define-fun temp___86122 () us_t2 (mk___t2 temp___8612 temp___86121))
...
(assert (and (= temp___86122 (register_to_bytes reg)) (dynamic_invariant1 temp___86122 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___86121)) (to_rep (last4 temp___86121))) (+ (- (to_rep (last4 temp___86121)) (to_rep (first4 temp___86121))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8612 temp___8613))
(assert (= (mk1 (to_rep (first4 temp___86121)) (to_rep (last4 temp___86121))) temp___86131))
(assert (not (= (ite (<= (to_rep (first2 temp___86131)) (to_rep (last2 temp___86131))) (+ (- (to_rep (last2 temp___86131)) (to_rep (first2 temp___86131))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
