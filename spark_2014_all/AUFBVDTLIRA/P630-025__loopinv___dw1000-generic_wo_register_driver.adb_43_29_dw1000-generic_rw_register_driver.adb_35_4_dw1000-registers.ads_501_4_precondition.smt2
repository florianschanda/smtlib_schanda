...
(define-fun dynamic_invariant ((temp___expr_6612 us_t1) (temp___is_init_6608 Bool) (temp___skip_constant_6609 Bool) (temp___do_toplevel_6610 Bool) (temp___do_typ_inv_6611 Bool)) Bool (=> (not (= temp___skip_constant_6609 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6612) (last3 temp___expr_6612)) (and (= (first3 temp___expr_6612) 1) (= (last3 temp___expr_6612) 1)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_6630 us_t2) (temp___is_init_6626 Bool) (temp___skip_constant_6627 Bool) (temp___do_toplevel_6628 Bool) (temp___do_typ_inv_6629 Bool)) Bool (=> (not (= temp___skip_constant_6627 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6630) (last5 temp___expr_6630)) (and (= (first5 temp___expr_6630) 1) (= (last5 temp___expr_6630) 1)))))
...
(declare-const temp___88481 t2)
(declare-const temp___8849 (Array Int bits_8))
(declare-const temp___88491 t1)
...
(define-fun temp___88482 () us_t2 (mk___t2 temp___8848 temp___88481))
...
(assert (and (= temp___88482 (register_to_bytes reg)) (dynamic_invariant1 temp___88482 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___88481)) (to_rep (last4 temp___88481))) (+ (- (to_rep (last4 temp___88481)) (to_rep (first4 temp___88481))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8848 temp___8849))
(assert (= (mk1 (to_rep (first4 temp___88481)) (to_rep (last4 temp___88481))) temp___88491))
(assert (= (ite (<= (to_rep (first2 temp___88491)) (to_rep (last2 temp___88491))) (+ (- (to_rep (last2 temp___88491)) (to_rep (first2 temp___88491))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8849 temp___88491)))
(assert (= o2 o))
