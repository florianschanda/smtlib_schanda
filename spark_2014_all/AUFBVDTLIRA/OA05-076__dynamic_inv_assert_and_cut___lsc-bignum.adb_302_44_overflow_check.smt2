...
(assert (= (= o43 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
...
(assert (= o25 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o24)))
