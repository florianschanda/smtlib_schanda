...
(assert (= begidx4 o16))
(assert (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i Int)) (=> (and (<= begidx5 i) (<= i endidx3)) (and (<= 48 (to_rep1 (select zonefileline i))) (<= (to_rep1 (select zonefileline i)) 57)))))) (and (and (in_range2 begidx5) (in_range2 endidx3)) (in_range1 foundtype3))))
(assert (= result18 (mk_bool__ref success3)))
(assert (= success4 (ite (= foundtype3 1) true false)))
(assert (= success4 true))
(declare-const i Int)
(assert (<= begidx5 i))
(assert (<= i endidx3))
(assert (not (<= 48 (to_rep1 (select zonefileline i)))))
(check-sat)
(exit)
