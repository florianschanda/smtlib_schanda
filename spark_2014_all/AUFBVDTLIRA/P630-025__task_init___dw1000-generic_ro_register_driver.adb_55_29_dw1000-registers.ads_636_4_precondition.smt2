...
(define-fun dynamic_invariant ((temp___expr_7155 us_t1) (temp___is_init_7152 Bool) (temp___skip_constant_7153 Bool) (temp___do_toplevel_7154 Bool)) Bool (=> (not (= temp___skip_constant_7153 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7155) (last3 temp___expr_7155)) (and (= (first3 temp___expr_7155) 1) (= (last3 temp___expr_7155) 2)))))
