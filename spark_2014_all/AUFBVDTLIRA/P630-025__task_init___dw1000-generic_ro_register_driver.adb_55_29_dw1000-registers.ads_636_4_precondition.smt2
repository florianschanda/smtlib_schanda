...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__evc_fwto_type__evc_fwto bits_12) (rec__dw1000__register_types__evc_fwto_type__reserved bits_4)))))
(define-fun us_split_fields_EVC_FWTO__projection ((a us_split_fields)) bits_12 (rec__dw1000__register_types__evc_fwto_type__evc_fwto a))
(define-fun us_split_fields_Reserved__31__projection ((a us_split_fields)) bits_4 (rec__dw1000__register_types__evc_fwto_type__reserved a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___96__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___96__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep3 (rec__dw1000__register_types__evc_fwto_type__evc_fwto (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__evc_fwto_type__evc_fwto (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__evc_fwto_type__reserved (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__evc_fwto_type__reserved (us_split_fields1 b))))) true false))
...
(assert (< dw1000__register_types__evc_fwto_type__evc_fwto__first__bit dw1000__register_types__evc_fwto_type__evc_fwto__last__bit))
...
(assert (< dw1000__register_types__evc_fwto_type__reserved__first__bit dw1000__register_types__evc_fwto_type__reserved__last__bit))
(assert (<= 0 dw1000__register_types__evc_fwto_type__reserved__position))
(declare-fun user_eq6 (us_rep us_rep) Bool)
(declare-const dummy6 us_rep)
(declare-datatypes () ((evc_fwto_type__ref (mk_evc_fwto_type__ref (evc_fwto_type__content us_rep)))))
(define-fun evc_fwto_type__ref___projection ((a evc_fwto_type__ref)) us_rep (evc_fwto_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___221__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___158__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___158__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_7879 us_t1) (temp___is_init_7875 Bool) (temp___skip_constant_7876 Bool) (temp___do_toplevel_7877 Bool) (temp___do_typ_inv_7878 Bool)) Bool (=> (not (= temp___skip_constant_7876 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7879) (last3 temp___expr_7879)) (and (= (first3 temp___expr_7879) 1) (= (last3 temp___expr_7879) 2)))))
