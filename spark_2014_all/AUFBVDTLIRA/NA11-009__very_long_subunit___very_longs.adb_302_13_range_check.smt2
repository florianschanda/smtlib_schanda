...
(declare-const temp___1051 (_ BitVec 16))
...
(declare-const temp___1037 (_ BitVec 16))
...
(assert (not (in_range2 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))))
(check-sat)
(exit)
