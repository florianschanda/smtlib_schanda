...
(assert (= begidx4 o))
(assert (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i54 Int)) (=> (and (<= begidx5 i54) (<= i54 endidx3)) (and (<= 48 (to_rep (select zonefileline i54))) (<= (to_rep (select zonefileline i54)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3))))
