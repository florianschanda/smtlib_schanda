...
(assert true)
(assert true)
(assert (and (= o (shift_right ((_ int2bv 8) 255) (- 8 distance))) (= o (bvudiv ((_ int2bv 8) 255) (ite (< (- 8 distance) 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (- 8 distance))) ((_ int2bv 8) 0))))))
...
(assert (<= 1 i1))
(assert (<= i1 r128b))
(assert (and (and (dynamic_invariant2 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true) (forall ((temp___1515 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1515) (<= temp___1515 (to_rep1 (last number__split_fields3)))) (=> (<= temp___1515 i2) (= (select number__split_fields2 temp___1515) (select number__split_fields temp___1515)))))) (and (<= 1 i2) (<= i2 r128b))))
