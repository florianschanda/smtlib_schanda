...
(define-fun default_initial_assumption ((temp___expr_509 us_rep) (temp___skip_top_level_510 Bool)) Bool (and (= (to_rep2 (rec__main2__some_record__c1 (us_split_fields1 temp___expr_509))) ((_ int2bv 8) 0)) (= (to_rep2 (rec__main2__some_record__c2 (us_split_fields1 temp___expr_509))) ((_ int2bv 8) 0))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_513 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_513 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_513 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_513 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_513 us_void_param) 5)) 99)) (= (to_rep (select (temp___String_Literal_513 us_void_param) 6)) 49)) (= (to_rep (select (temp___String_Literal_513 us_void_param) 7)) 61)) :pattern ((temp___String_Literal_513 us_void_param)))))
(declare-fun temp___String_Literal_516 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_516 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_516 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_516 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_516 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_516 us_void_param) 5)) 99)) (= (to_rep (select (temp___String_Literal_516 us_void_param) 6)) 50)) (= (to_rep (select (temp___String_Literal_516 us_void_param) 7)) 61)) :pattern ((temp___String_Literal_516 us_void_param)))))
...
(assert (= off_c1 0))
(assert (= off_c2 1))
(define-fun dynamic_invariant4 ((temp___expr_178 (_ BitVec 8)) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool true)
...
(assert (and (= (to_rep2 foo__split_fields) ((_ int2bv 8) 0)) (= (to_rep2 foo__split_fields1) ((_ int2bv 8) 0))))
