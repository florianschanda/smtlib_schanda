...
(define-fun default_initial_assumption ((temp___expr_515 us_rep) (temp___skip_top_level_516 Bool)) Bool (and (= (to_rep2 (rec__main2__some_record__c1 (us_split_fields1 temp___expr_515))) ((_ int2bv 8) 0)) (= (to_rep2 (rec__main2__some_record__c2 (us_split_fields1 temp___expr_515))) ((_ int2bv 8) 0))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_519 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_519 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_519 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_519 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_519 us_void_param) 5)) 99)) (= (to_rep (select (temp___String_Literal_519 us_void_param) 6)) 49)) (= (to_rep (select (temp___String_Literal_519 us_void_param) 7)) 61)) :pattern ((temp___String_Literal_519 us_void_param)))))
(declare-fun temp___String_Literal_522 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_522 us_void_param) 1)) 80) (= (to_rep (select (temp___String_Literal_522 us_void_param) 2)) 111)) (= (to_rep (select (temp___String_Literal_522 us_void_param) 3)) 115)) (= (to_rep (select (temp___String_Literal_522 us_void_param) 4)) 32)) (= (to_rep (select (temp___String_Literal_522 us_void_param) 5)) 99)) (= (to_rep (select (temp___String_Literal_522 us_void_param) 6)) 50)) (= (to_rep (select (temp___String_Literal_522 us_void_param) 7)) 61)) :pattern ((temp___String_Literal_522 us_void_param)))))
