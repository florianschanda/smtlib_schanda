...
(assert (= o9 (- o8 1)))
(assert (and (= temp___349 o9) (in_range1 o9)))
(assert (and (<= (to_rep1 (first (rt text))) temp___349) (<= temp___349 (to_rep1 (last (rt text))))))
(assert (= o10 temp___349))
(assert (= o11 (select (elts text) o10)))
(assert (= o12 (to_rep o11)))
(assert (= o13 ((_ int2bv 8) o12)))
(assert (= (to_rep2 o14) o13))
(assert (and (= o6 (+ (to_rep1 data__first) i2)) (in_range1 (+ (to_rep1 data__first) i2))))
(assert (= o7 (- o6 1)))
(assert (and (= temp___350 o7) (in_range1 o7)))
(assert (not (<= (to_rep1 data__first) temp___350)))
(check-sat)
(exit)
