...
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___684 o)))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o3 (mk_map__ref o2))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a (mk_map__ref o2))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o4 o2)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o5 o3)))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o6 o4)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o5 (mk_map__ref o))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a1 (mk_map__ref o))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o6 o)))
(assert (= (t__content a_msw6) #x00000000))
