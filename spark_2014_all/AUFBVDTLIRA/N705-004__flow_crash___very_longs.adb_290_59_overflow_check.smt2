...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___182 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___182) (first3 temp___182) (last3 temp___182))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___181 (rec__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___181) (first1 temp___181) (last1 temp___181))))))
...
(define-fun dynamic_invariant4 ((temp___expr_650 us_rep1) (temp___is_init_647 Bool) (temp___skip_constant_648 Bool) (temp___do_toplevel_649 Bool)) Bool (and (=> (not (= temp___skip_constant_648 true)) (in_range4 (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))) (to_base temp___expr_650))) (and (dynamic_property3 1 (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))) (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_650))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_650)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_650))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_650))) (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))))))))
(define-fun default_initial_assumption ((temp___expr_653 us_rep1) (temp___skip_top_level_654 Bool)) Bool (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_653))) (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r))))))
...
(assert (forall ((temp___1022 (_ BitVec 8))) (forall ((temp___1023 Int) (temp___1024 Int)) (let ((temp___1021 (temp___1020 temp___1022 temp___1023 temp___1024))) (and (=> (dynamic_property6 1 2147483647 temp___1023 temp___1024) (and (= (first5 temp___1021) temp___1023) (= (last5 temp___1021) temp___1024))) (forall ((temp___1025 Int)) (= (select (to_array2 temp___1021) temp___1025) (of_rep1 temp___1022))))))))
(define-fun dynamic_invariant5 ((temp___expr_200 Int) (temp___is_init_197 Bool) (temp___skip_constant_198 Bool) (temp___do_toplevel_199 Bool)) Bool (=> (or (= temp___is_init_197 true) (<= 1 2147483647)) (in_range2 temp___expr_200)))
...
(declare-const temp___1027 (Array Int octet))
(declare-const temp___10271 t2)
(declare-const temp___1028 (Array Int octet))
(declare-const temp___10281 t1)
(declare-const o1 (Array Int octet))
(declare-const o2 t1)
(declare-const o3 (Array Int octet))
(declare-const o4 t1)
(declare-const temp___1031 digit_index_type)
(declare-const temp___10311 (Array Int octet))
(declare-const temp___10312 t1)
...
(declare-const temp___1055 us_rep1)
(declare-const temp___1054 (_ BitVec 16))
(declare-const temp___1047 (_ BitVec 16))
(declare-const temp___1046 (_ BitVec 16))
(declare-const temp___1045 (_ BitVec 16))
(declare-const temp___1044 (_ BitVec 16))
(declare-const temp___1041 us_rep1)
(declare-const temp___1040 (_ BitVec 16))
...
(declare-const temp___1039 us_rep1)
...
(declare-const temp___1053 us_rep1)
...
(assert (and (= us (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))) (in_range2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r))))))
(assert (and (= us1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (and (= o (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r))))) (in_range1 (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))))))
...
(assert true)
(assert true)
(assert (= (to_rep2 (first4 (rt2 (temp___1020 ((_ int2bv 8) 0) 1 (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1020 ((_ int2bv 8) 0) 1 (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))))))) (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r))))))
(assert (= (mk___t2 temp___1027 temp___10271) (temp___1020 ((_ int2bv 8) 0) 1 (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))))))
(assert (= (ite (<= (to_rep2 (first4 temp___10271)) (to_rep2 (last4 temp___10271))) (+ (- (to_rep2 (last4 temp___10271)) (to_rep2 (first4 temp___10271))) 1) 0) (ite (<= 1 (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r))))) (+ (- (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))) 1) 1) 0)))
(assert (= temp___1027 temp___1028))
(assert (= (mk1 (to_rep2 (first4 temp___10271)) (to_rep2 (last4 temp___10271))) temp___10281))
(assert (= (ite (<= (to_rep2 (first2 temp___10281)) (to_rep2 (last2 temp___10281))) (+ (- (to_rep2 (last2 temp___10281)) (to_rep2 (first2 temp___10281))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
...
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___10311 temp___10312))))
(assert (= result____split_discrs (mk___split_discrs temp___1031)))
...
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) i4) (<= i4 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))))
(assert (= o5 i4))
(assert (= o6 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 l))) o5)))
(assert (= o7 (to_rep1 o6)))
(assert (= o8 ((_ zero_extend 8) o7)))
(assert (= result4 (mk_t__ref1 l_digit3)))
(assert (= l_digit4 o8))
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))) j2) (<= j2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))))
(assert (= o9 j2))
(assert (= o10 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 r))) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (= o12 ((_ zero_extend 8) o11)))
(assert (= result5 (mk_t__ref1 r_digit3)))
(assert (= r_digit4 o12))
(assert (not (in_range1 (+ i4 j2))))
(check-sat)
(exit)
