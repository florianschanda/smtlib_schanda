...
(declare-fun temp___1091 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1093 (_ BitVec 8))) (forall ((temp___1094 Int) (temp___1095 Int)) (let ((temp___1092 (temp___1091 temp___1093 temp___1094 temp___1095))) (=> (dynamic_invariant2 temp___1093 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1094 temp___1095) (and (= (first5 temp___1092) temp___1094) (= (last5 temp___1092) temp___1095))) (forall ((temp___1096 Int)) (= (to_rep1 (select (to_array2 temp___1092) temp___1096)) temp___1093))))))))
(define-fun dynamic_invariant5 ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 1 2147483647)) (in_range2 temp___expr_223)))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1091 #x00 1 (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1091 #x00 1 (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))))))) (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r))))))
(assert (= (mk___t2 temp___1098 temp___10981) (temp___1091 #x00 1 (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))))))
(assert (= (ite (<= (to_rep2 (first4 temp___10981)) (to_rep2 (last4 temp___10981))) (+ (- (to_rep2 (last4 temp___10981)) (to_rep2 (first4 temp___10981))) 1) 0) (ite (<= 1 (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r))))) (+ (- (+ (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))) 1) 1) 0)))
(assert (= temp___1098 temp___1099))
(assert (= (mk1 (to_rep2 (first4 temp___10981)) (to_rep2 (last4 temp___10981))) temp___10991))
(assert (= (ite (<= (to_rep2 (first2 temp___10991)) (to_rep2 (last2 temp___10991))) (+ (- (to_rep2 (last2 temp___10991)) (to_rep2 (first2 temp___10991))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
...
(assert (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (and (<= 1 j2) (<= j2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))))))
...
(assert (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields4) false true true true) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
