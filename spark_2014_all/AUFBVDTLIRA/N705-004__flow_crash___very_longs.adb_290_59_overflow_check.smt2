...
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))
(assert (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields4) false true true true) (and (<= 1 i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
(assert (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))))
(assert (= o5 i2))
(assert (= o6 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 l))) o5)))
(assert (= o7 (to_rep2 o6)))
(assert (= o8 ((_ zero_extend 8) o7)))
(assert (= result4 (mk_t__ref1 l_digit)))
(assert (= l_digit1 o8))
(assert (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))) j2) (<= j2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))))
(assert (= o9 j2))
(assert (= o10 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 r))) o9)))
(assert (= o11 (to_rep2 o10)))
(assert (= o12 ((_ zero_extend 8) o11)))
(assert (= result5 (mk_t__ref1 r_digit)))
(assert (= r_digit1 o12))
(assert (not (in_range2 (+ i2 j2))))
(check-sat)
(exit)
