...
(assert (and (= us2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1042 #x00 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1042 #x00 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___1049 temp___10491) (temp___1042 #x00 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep2 (first4 temp___10491)) (to_rep2 (last4 temp___10491))) (+ (- (to_rep2 (last4 temp___10491)) (to_rep2 (first4 temp___10491))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___1049 temp___1050))
(assert (= (mk1 (to_rep2 (first4 temp___10491)) (to_rep2 (last4 temp___10491))) temp___10501))
(assert (= (ite (<= (to_rep2 (first2 temp___10501)) (to_rep2 (last2 temp___10501))) (+ (- (to_rep2 (last2 temp___10501)) (to_rep2 (first2 temp___10501))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
...
(assert (= r_digit1 o11))
(assert (= (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) r84b))
...
(assert (= temp___1057 (- o18 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1057)))
(check-sat)
(exit)
