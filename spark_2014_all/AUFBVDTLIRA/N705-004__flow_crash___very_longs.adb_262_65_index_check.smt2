...
(assert true)
(assert true)
(assert (= (to_rep2 (first4 (rt2 (temp___971 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___971 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___978 temp___9781) (temp___971 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep2 (first4 temp___9781)) (to_rep2 (last4 temp___9781))) (+ (- (to_rep2 (last4 temp___9781)) (to_rep2 (first4 temp___9781))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___978 temp___979))
(assert (= (mk1 (to_rep2 (first4 temp___9781)) (to_rep2 (last4 temp___9781))) temp___9791))
(assert (= (ite (<= (to_rep2 (first2 temp___9791)) (to_rep2 (last2 temp___9791))) (+ (- (to_rep2 (last2 temp___9791)) (to_rep2 (first2 temp___9791))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
...
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___9821 temp___9822))))
(assert (= result____split_discrs (mk___split_discrs temp___982)))
...
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___986)))
(check-sat)
(exit)
