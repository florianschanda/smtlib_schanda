...
(define-fun dynamic_invariant ((temp___expr_2229 us_t1) (temp___is_init_2226 Bool) (temp___skip_constant_2227 Bool) (temp___do_toplevel_2228 Bool)) Bool (=> (not (= temp___skip_constant_2227 true)) (and (dynamic_property2 1 1024 (first3 temp___expr_2229) (last3 temp___expr_2229)) (and (= (first3 temp___expr_2229) 1) (= (last3 temp___expr_2229) 1024)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_2248 us_t2) (temp___is_init_2245 Bool) (temp___skip_constant_2246 Bool) (temp___do_toplevel_2247 Bool)) Bool (=> (not (= temp___skip_constant_2246 true)) (and (dynamic_property3 1 1024 (first5 temp___expr_2248) (last5 temp___expr_2248)) (and (= (first5 temp___expr_2248) 1) (= (last5 temp___expr_2248) 1024)))))
...
(assert (and (= temp___77202 (register_to_bytes reg)) (dynamic_invariant1 temp___77202 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___77201)) (to_rep (last4 temp___77201))) (+ (- (to_rep (last4 temp___77201)) (to_rep (first4 temp___77201))) 1) 0) (ite (<= 1 1024) (+ (- 1024 1) 1) 0)))
(assert (= temp___7720 temp___7721))
(assert (= (mk1 (to_rep (first4 temp___77201)) (to_rep (last4 temp___77201))) temp___77211))
(assert (= (ite (<= (to_rep (first2 temp___77211)) (to_rep (last2 temp___77211))) (+ (- (to_rep (last2 temp___77211)) (to_rep (first2 temp___77211))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
