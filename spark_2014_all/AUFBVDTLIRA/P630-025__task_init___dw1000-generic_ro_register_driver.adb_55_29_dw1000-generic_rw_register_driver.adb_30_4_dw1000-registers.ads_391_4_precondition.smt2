...
(define-fun dynamic_invariant ((temp___expr_4809 us_t1) (temp___is_init_4806 Bool) (temp___skip_constant_4807 Bool) (temp___do_toplevel_4808 Bool)) Bool (=> (not (= temp___skip_constant_4807 true)) (and (dynamic_property2 1 2 (first3 temp___expr_4809) (last3 temp___expr_4809)) (and (= (first3 temp___expr_4809) 1) (= (last3 temp___expr_4809) 2)))))
