...
(declare-const temp___1343 (_ BitVec 16))
(declare-const o Int)
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1350 temporary_digit)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1349 product)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1348 carry1)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (and (= (mk___split_discrs temp___1345) u__split_discrs) (and (= temp___13451 u__split_fields) (= temp___13452 u__split_fields1)))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1344 current_borrow1)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1343 future_borrow)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (and (= o6 (shift_right product3 8)) (= o6 (bvudiv product3 (ite (< 8 65536) (bvshl #x0001 ((_ int2bv 16) 8)) #x0000))))))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temporary_digit3 (bvand product3 #x00FF))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (and (= o7 (+ j divisor_index2)) (in_range1 (+ j divisor_index2)))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1336 (- o7 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1336) (<= temp___1336 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= o8 temp___1336)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1338 (- o13 1))))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= o14 temp___1338)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1340 (- o12 1))))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= o24 temp___1340)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1342 (mk___rep1 u__split_discrs (mk___split_fields1 (mk___t1 o28 o29))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= result9 (mk___split_fields__ref1 u__split_fields3))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= u__split_fields4 (us_split_fields3 temp___1342))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= u__split_discrs (us_split_discrs2 temp___1342))))
...
(assert (and (= temp___1354 (+ j n)) (in_range1 (+ j n))))
...
(assert (and (= temp___1356 (+ j n)) (in_range1 (+ j n))))
...
(assert (not (bvule ((_ zero_extend 8) #x00) o40)))
(check-sat)
(exit)
