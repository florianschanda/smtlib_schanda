...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1281 temporary_digit)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1280 product)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1279 carry1)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (and (= (mk___split_discrs temp___1276) u__split_discrs) (and (= temp___12761 u__split_fields) (= temp___12762 u__split_fields1)))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1275 current_borrow1)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1274 future_borrow)))
