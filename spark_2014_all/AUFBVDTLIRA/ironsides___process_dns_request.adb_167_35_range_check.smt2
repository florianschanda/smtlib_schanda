...
(assert (and (= o33 (- (int__content dstbytes6) 1)) (in_range4 (- (int__content dstbytes6) 1))))
(assert (= result43 dstbytes6))
(assert (= dstbytes8 o33))
(assert (not (in_range3 (+ start_byte 4))))
(check-sat)
(exit)
