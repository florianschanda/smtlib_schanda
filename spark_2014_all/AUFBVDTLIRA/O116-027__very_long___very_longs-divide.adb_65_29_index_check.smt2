...
(declare-datatypes () ((tS117bP1__ref (mk_tS117bP1__ref (tS117bP1__content tdigit_count_typeB)))))
(define-fun tS117bP1__ref___projection ((a tS117bP1__ref)) tdigit_count_typeB (tS117bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t119b__ref (mk_t119b__ref (t119b__content tdigit_count_typeB)))))
(define-fun t119b__ref___projection ((a t119b__ref)) tdigit_count_typeB (t119b__content a))
(declare-sort t2 0)
...
(assert true)
(assert true)
(assert (= (to_rep (rec__very_longs__very_long__length result____split_discrs)) r118b))
(assert (in_range1 r118b))
(assert (= (to_rep2 (first4 (rt2 (temp___1181 ((_ int2bv 8) 0) 1 r118b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1181 ((_ int2bv 8) 0) 1 r118b)))) r118b))
(assert (= (mk___t2 temp___1188 temp___11881) (temp___1181 ((_ int2bv 8) 0) 1 r118b)))
(assert (= (ite (<= (to_rep2 (first4 temp___11881)) (to_rep2 (last4 temp___11881))) (+ (- (to_rep2 (last4 temp___11881)) (to_rep2 (first4 temp___11881))) 1) 0) (ite (<= 1 r118b) (+ (- r118b 1) 1) 0)))
...
(assert (and (and (dynamic_invariant2 (mk___rep result____split_discrs result____split_fields3) false true true) (forall ((temp___1206 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1206) (<= temp___1206 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1206) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1206) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1206)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o5 i2))
...
(assert (and (= o9 (shift_right__2 o8 (- 8 distance))) (= o9 (bvudiv o8 (ite (< (- 8 distance) 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (- 8 distance))) ((_ int2bv 8) 0))))))
(assert (= result4 (mk_t__ref new_overflow2)))
(assert (= new_overflow3 o9))
(assert (=> (< distance 8) (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
...
(assert (=> (not (< distance 8)) (= o13 ((_ int2bv 8) 0))))
(assert (= (to_rep1 o14) o13))
(assert (not (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) i2)))
(check-sat)
(exit)
