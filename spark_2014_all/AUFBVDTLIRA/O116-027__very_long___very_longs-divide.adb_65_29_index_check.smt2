...
(define-fun dynamic_invariant6 ((temp___expr_811 us_t1) (temp___is_init_807 Bool) (temp___skip_constant_808 Bool) (temp___do_toplevel_809 Bool) (temp___do_typ_inv_810 Bool)) Bool (=> (not (= temp___skip_constant_808 true)) (and (dynamic_property3 1 r118b (first3 temp___expr_811) (last3 temp___expr_811)) (and (= (first3 temp___expr_811) 1) (= (last3 temp___expr_811) r118b)))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1250 #x00 1 r118b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1250 #x00 1 r118b)))) r118b))
(assert (= (mk___t2 temp___1257 temp___12571) (temp___1250 #x00 1 r118b)))
(assert (= (ite (<= (to_rep2 (first4 temp___12571)) (to_rep2 (last4 temp___12571))) (+ (- (to_rep2 (last4 temp___12571)) (to_rep2 (first4 temp___12571))) 1) 0) (ite (<= 1 r118b) (+ (- r118b 1) 1) 0)))
