...
(assert (<= r86b i16))
(assert (<= i16 r87b))
(assert (and (<= 1 begidx15) (bvule tmpval13 ((_ int2bv 16) 32767))))
(assert (and (=> (<= r86b r87b) (dynamic_property1 r86b r87b i17)) (and (<= r86b i17) (<= i17 r87b))))
(assert (= result16 (mk_t__ref digitval12)))
(assert (= digitval13 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i17))) ((_ int2bv 16) 48))))
(assert (= result17 (mk_t__ref tmpval13)))
(assert (= tmpval14 (bvadd (bvmul ((_ int2bv 16) 10) tmpval13) digitval13)))
(assert (not (bvugt tmpval14 ((_ int2bv 16) 32767))))
(assert (not (= i17 r87b)))
(assert (= result18 (mk_int__ref i17)))
(assert (= i18 (+ i17 1)))
(assert (= i19 (mk_int__ref i18)))
(assert (= tmpval15 (mk_t__ref tmpval14)))
(assert (= digitval14 (mk_t__ref digitval13)))
(assert (= i20 i18))
(assert (= tmpval16 tmpval14))
(assert (= digitval15 digitval13))
