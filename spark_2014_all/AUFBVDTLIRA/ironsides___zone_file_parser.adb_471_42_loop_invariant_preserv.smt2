...
(assert (<= i45 128))
(assert (<= 1 endidx5))
(assert (and (and (and (and (and (and (and (and (and (and (and (and (and (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__typecovered rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__typecovered (us_split_fields__content1 rrsig_rec__split_fields35))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__algorithm rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__algorithm (us_split_fields__content1 rrsig_rec__split_fields35)))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__numlabels rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__numlabels (us_split_fields__content1 rrsig_rec__split_fields35)))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__origttl rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__origttl (us_split_fields__content1 rrsig_rec__split_fields35)))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__sigexpiration rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__sigexpiration (us_split_fields__content1 rrsig_rec__split_fields35)))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__siginception rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__siginception (us_split_fields__content1 rrsig_rec__split_fields35)))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__keytag rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__keytag (us_split_fields__content1 rrsig_rec__split_fields35)))) (forall ((temp___1503 Int)) (=> (and (<= 1 temp___1503) (<= temp___1503 128)) (=> (<= i46 temp___1503) (= (select (rec__rr_type__rrsig_record_type__rrsigrecordtype__signername rrsig_rec__split_fields37) temp___1503) (select (rec__rr_type__rrsig_record_type__rrsigrecordtype__signername (us_split_fields__content1 rrsig_rec__split_fields35)) temp___1503)))))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__signature rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__signature (us_split_fields__content1 rrsig_rec__split_fields35)))) (= (rec__rr_type__rrsig_record_type__rrsigrecordtype__signaturelength rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__signaturelength (us_split_fields__content1 rrsig_rec__split_fields35)))) (= (rec__rr_type__resourcerecordtype__ttlinseconds1 rrsig_rec__split_fields37) (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields__content1 rrsig_rec__split_fields35)))) (= (rec__rr_type__resourcerecordtype__class1 rrsig_rec__split_fields37) (rec__rr_type__resourcerecordtype__class1 (us_split_fields__content1 rrsig_rec__split_fields35)))) (=> (<= r16b 128) (dynamic_property1 r16b 128 i46))) (and (<= r16b i46) (<= i46 128))))
(assert (= (to_rep o60) 32))
(assert (= o61 (store (rec__rr_type__rrsig_record_type__rrsigrecordtype__signername rrsig_rec__split_fields37) i46 o60)))
(assert (= o62 (mk___split_fields1 (rec__rr_type__rrsig_record_type__rrsigrecordtype__typecovered rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__algorithm rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__numlabels rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__origttl rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__sigexpiration rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__siginception rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__keytag rrsig_rec__split_fields37) o61 (rec__rr_type__rrsig_record_type__rrsigrecordtype__signature rrsig_rec__split_fields37) (rec__rr_type__rrsig_record_type__rrsigrecordtype__signaturelength rrsig_rec__split_fields37) (rec__rr_type__resourcerecordtype__ttlinseconds1 rrsig_rec__split_fields37) (rec__rr_type__resourcerecordtype__class1 rrsig_rec__split_fields37) (rec__ext__1 rrsig_rec__split_fields37))))
(assert (= temp___1501 (mk___rep1 o62 rrsig_rec__attr__tag)))
(assert (= result23 (mk___split_fields__ref1 rrsig_rec__split_fields37)))
(assert (= rrsig_rec__split_fields38 (us_split_fields3 temp___1501)))
(assert (not (= i46 128)))
(assert (= result24 (mk_int__ref i46)))
(assert (= i47 (+ i46 1)))
(assert (= i48 (mk_int__ref i47)))
(assert (= rrsig_rec__split_fields39 (mk___split_fields__ref1 rrsig_rec__split_fields38)))
(assert (= i49 i47))
(assert (= rrsig_rec__split_fields40 rrsig_rec__split_fields38))
