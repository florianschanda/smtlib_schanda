...
(declare-const temp___1560 us_rep1)
...
(assert (= begidx1 1))
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i39 Int)) (=> (and (<= begidx2 i39) (<= i39 endidx1)) (and (<= 48 (to_rep (select zonefileline i39))) (<= (to_rep (select zonefileline i39)) 57)))))) (and (and (in_range5 begidx2) (in_range5 endidx1)) (in_range4 foundtype1))))
...
(assert (=> (= success20 true) (and (and (and (and (<= begidx4 endidx2) (<= begidx4 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i39 Int)) (=> (and (<= begidx4 i39) (<= i39 endidx2)) (and (<= 48 (to_rep (select zonefileline i39))) (<= (to_rep (select zonefileline i39)) 57)))))) (and (and (in_range5 begidx4) (in_range5 endidx2)) (in_range4 foundtype2)))))
...
(assert (= begidx7 o48))
(assert (and (and (and (and (<= begidx8 endidx5) (<= begidx8 zlength)) (<= endidx5 zlength)) (=> (= foundtype5 1) (forall ((i39 Int)) (=> (and (<= begidx8 i39) (<= i39 endidx5)) (and (<= 48 (to_rep (select zonefileline i39))) (<= (to_rep (select zonefileline i39)) 57)))))) (and (and (in_range5 begidx8) (in_range5 endidx5)) (in_range4 foundtype5))))
...
(assert (= temp___1560 (mk___rep1 o58 rrsig_rec__attr__tag)))
(assert (= result20 (mk___split_fields__ref1 rrsig_rec__split_fields33)))
(assert (= rrsig_rec__split_fields34 (us_split_fields3 temp___1560)))
(assert (not (= i33 128)))
