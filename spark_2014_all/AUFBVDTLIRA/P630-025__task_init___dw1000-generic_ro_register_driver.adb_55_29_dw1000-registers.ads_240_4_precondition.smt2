...
(define-fun in_range6 ((x (_ BitVec 16))) Bool (and (bvule ((_ int2bv 16) 0) x) (bvule x ((_ int2bv 16) 4095))))
...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x ((_ int2bv 16) 4096)))) (=> (in_range6 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
...
(define-fun dynamic_invariant ((temp___expr_2865 us_t1) (temp___is_init_2862 Bool) (temp___skip_constant_2863 Bool) (temp___do_toplevel_2864 Bool)) Bool (=> (not (= temp___skip_constant_2863 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2865) (last3 temp___expr_2865)) (and (= (first3 temp___expr_2865) 1) (= (last3 temp___expr_2865) 4)))))
