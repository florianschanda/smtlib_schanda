...
(define-fun ctx__split_fields12 () us_split_fields4 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5 ctx__split_fields6 ctx__split_fields7)) ctx__split_fields8 ctx__split_fields9)) ctx__split_fields10 ctx__split_fields11))
...
(assert (and (and (and (and (in_range4 (hash_bit_len_of (mk___rep2 ctx__split_fields12))) (= (hash_bit_len_of (mk___rep2 ctx__split_fields12)) #x0000000000000200)) (= (byte_count_of (mk___rep2 ctx__split_fields12)) #x0000000000000000)) (in_range5 (byte_count_of (mk___rep2 ctx__split_fields12)))) (bvult (to_rep7 (last (mk #x0000000000000000 #x000000000000003F))) #xFFFFFFFFFFFFFFFF)))
(assert (not (in_range4 (hash_bit_len_of (mk___rep2 ctx__split_fields12)))))
(check-sat)
(exit)
