...
(declare-const temp___1112 us_t1)
(declare-const o23 (Array Int character))
(declare-const temp___1107 us_t)
...
(assert (=> (= result2 true) (= temp___1108 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring))))))
(assert (=> (= result2 true) (and (= temp___1110 (length thestring)) (in_range1 (length thestring)))))
(assert (=> (= result2 true) (=> (<= 1 temp___1110) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1110) (<= temp___1110 150))))))
(assert (=> (= result2 true) (= o22 result__1)))
(assert (=> (= result2 true) (= temp___1111 (mk___t1 o22 (mk1 1 temp___1110)))))
(assert (=> (= result2 true) (= (ite (<= (to_rep1 (first2 (rt1 temp___1108))) (to_rep1 (last2 (rt1 temp___1108)))) (+ (- (to_rep1 (last2 (rt1 temp___1108))) (to_rep1 (first2 (rt1 temp___1108)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1111))) (to_rep1 (last2 (rt1 temp___1111)))) (+ (- (to_rep1 (last2 (rt1 temp___1111))) (to_rep1 (first2 (rt1 temp___1111)))) 1) 0))))
(assert (=> (= result2 true) (= temp___1112 temp___1108)))
(assert (=> (= result2 true) (forall ((temp___1113 Int)) (ite (and (<= 1 temp___1113) (<= temp___1113 (length thestring))) (= (select o23 temp___1113) (select (elts1 temp___1112) temp___1113)) (= (select o23 temp___1113) (select result__1 temp___1113))))))
(assert (=> (= result2 true) (= result3 (mk_map__ref result__1))))
(assert (=> (= result2 true) (= result__2 o23)))
...
(assert (=> (not (= result2 true)) (= o24 (elts temp___1107))))
(assert (=> (not (= result2 true)) (= result4 (mk_map__ref result__1))))
(assert (=> (not (= result2 true)) (= result__3 o24)))
