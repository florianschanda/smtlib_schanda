...
(define-fun dw1000__register_driver__write_register__B_5__header__assume5 () us_rep1 (mk___rep1 (mk___split_fields1 dw1000__register_driver__write_register__B_5__header__assume dw1000__register_driver__write_register__B_5__header__assume1 dw1000__register_driver__write_register__B_5__header__assume2 dw1000__register_driver__write_register__B_5__header__assume3 dw1000__register_driver__write_register__B_5__header__assume4)))
...
(assert (and (= (to_rep5 temp___8721) 1) (= (to_rep6 temp___8724) 0)))
(assert (= dw1000__register_driver__write_register__B_5__header__assume5 (mk___rep1 (mk___split_fields1 temp___872 temp___8721 temp___8722 temp___8723 temp___8724))))
(assert (= dw1000__register_driver__write_register__B_5__header__assume5 header1))
(assert (let ((temp___727 header1)) (and (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___727))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___727))) 0))))
