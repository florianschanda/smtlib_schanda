...
(assert (= (ite (<= (to_rep (first2 temp___85081)) (to_rep (last2 temp___85081))) (+ (- (to_rep (last2 temp___85081)) (to_rep (first2 temp___85081))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8508 temp___8509))
(assert (= (mk2 (to_rep (first2 temp___85081)) (to_rep (last2 temp___85081))) temp___85091))
(assert (not (= (ite (<= (to_rep (first4 temp___85091)) (to_rep (last4 temp___85091))) (+ (- (to_rep (last4 temp___85091)) (to_rep (first4 temp___85091))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
