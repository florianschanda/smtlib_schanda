...
(assert (and (= temp___81612 (register_to_bytes reg)) (dynamic_invariant1 temp___81612 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___81611)) (to_rep (last4 temp___81611))) (+ (- (to_rep (last4 temp___81611)) (to_rep (first4 temp___81611))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8161 temp___8162))
(assert (= (mk1 (to_rep (first4 temp___81611)) (to_rep (last4 temp___81611))) temp___81621))
(assert (not (= (ite (<= (to_rep (first2 temp___81621)) (to_rep (last2 temp___81621))) (+ (- (to_rep (last2 temp___81621)) (to_rep (first2 temp___81621))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
