...
(declare-datatypes () ((t22b__ref (mk_t22b__ref (t22b__content tdigit_count_typeB)))))
(define-fun t22b__ref___projection ((a t22b__ref)) tdigit_count_typeB (t22b__content a))
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-const r23b Int)
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-fun temp___1219 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1221 (_ BitVec 8))) (forall ((temp___1222 Int) (temp___1223 Int)) (let ((temp___1220 (temp___1219 temp___1221 temp___1222 temp___1223))) (=> (dynamic_invariant3 temp___1221 true true true true) (and (=> (dynamic_property7 1 65536 temp___1222 temp___1223) (and (= (first5 temp___1220) temp___1222) (= (last5 temp___1220) temp___1223))) (forall ((temp___1224 Int)) (= (to_rep1 (select (to_array2 temp___1220) temp___1224)) temp___1221))))))))
(define-fun dynamic_invariant4 ((temp___expr_242 us_t3) (temp___is_init_238 Bool) (temp___skip_constant_239 Bool) (temp___do_toplevel_240 Bool) (temp___do_typ_inv_241 Bool)) Bool (=> (not (= temp___skip_constant_239 true)) (dynamic_property7 1 65536 (first7 temp___expr_242) (last7 temp___expr_242))))
...
(declare-const temp___12261 t2)
(declare-const temp___1227 (Array Int octet))
(declare-const temp___12271 t1)
(declare-const temp___1229 (Array Int octet))
(declare-const temp___12291 t1)
(declare-const o (Array Int octet))
(declare-const o1 t)
(declare-const o2 (Array Int octet))
(declare-const o3 t)
(declare-const temp___1231 digit_index_type)
(declare-const temp___12311 (Array Int octet))
(declare-const temp___12312 t)
...
(declare-const o17 t)
(declare-const o18 (Array Int octet))
(declare-const o19 t)
(declare-const temp___1236 us_rep)
...
(assert (= (to_rep2 (first4 (rt2 (temp___1219 #x00 1 r19b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1219 #x00 1 r19b)))) r19b))
(assert (= (mk___t2 temp___1226 temp___12261) (temp___1219 #x00 1 r19b)))
(assert (= (ite (<= (to_rep2 (first4 temp___12261)) (to_rep2 (last4 temp___12261))) (+ (- (to_rep2 (last4 temp___12261)) (to_rep2 (first4 temp___12261))) 1) 0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))
(assert (= temp___1226 temp___1227))
(assert (= (mk1 (to_rep2 (first4 temp___12261)) (to_rep2 (last4 temp___12261))) temp___12271))
(assert (= (ite (<= (to_rep2 (first2 temp___12271)) (to_rep2 (last2 temp___12271))) (+ (- (to_rep2 (last2 temp___12271)) (to_rep2 (first2 temp___12271))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1229 temp___12291) (mk___t1 temp___1227 temp___12271)))
(assert (= temp___1229 o))
(assert (= (mk (to_rep2 (first2 temp___12291)) (to_rep2 (last2 temp___12291))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1231)))
(assert (= temp___12311 o2))
(assert (= temp___12312 o3))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___12311 temp___12312))))
(assert (= result____split_discrs (mk___split_discrs temp___1231)))
...
(assert (and (and (and (=> (<= 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))) (dynamic_property6 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) i2)) (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true true)) (forall ((temp___1243 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1243) (<= temp___1243 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1243) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1243) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1243)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (= (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) r23b))
(assert (in_range1 r23b))
(assert (and (<= 1 i2) (<= i2 r23b)))
...
(assert (= o14 i2))
(assert (= o15 (store (elts (rec__very_longs__very_long__long_digits result____split_fields3)) o14 o13)))
(assert (= o15 o16))
(assert (= (rt (rec__very_longs__very_long__long_digits result____split_fields3)) o17))
(assert (= o18 o16))
(assert (= o19 o17))
(assert (= temp___1236 (mk___rep result____split_discrs (mk___split_fields (mk___t o18 o19)))))
(assert (= result8 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1236)))
(assert (= result____split_discrs (us_split_discrs1 temp___1236)))
(assert (not (= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))))
(assert (= result9 (mk_int__ref i2)))
(assert (= i3 (+ i2 1)))
(assert (not (= (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))))
(check-sat)
(exit)
