...
(assert (forall ((temp___1152 (_ BitVec 8))) (forall ((temp___1153 Int) (temp___1154 Int)) (let ((temp___1151 (temp___1150 temp___1152 temp___1153 temp___1154))) (and (=> (dynamic_property7 1 65536 temp___1153 temp___1154) (and (= (first5 temp___1151) temp___1153) (= (last5 temp___1151) temp___1154))) (forall ((temp___1155 Int)) (= (select (to_array2 temp___1151) temp___1155) (of_rep1 temp___1152))))))))
...
(declare-const o19 t)
(declare-const temp___1167 us_rep)
...
(assert (= (to_rep2 (first4 (rt2 (temp___1150 ((_ int2bv 8) 0) 1 r19b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1150 ((_ int2bv 8) 0) 1 r19b)))) r19b))
(assert (= (mk___t2 temp___1157 temp___11571) (temp___1150 ((_ int2bv 8) 0) 1 r19b)))
(assert (= (ite (<= (to_rep2 (first4 temp___11571)) (to_rep2 (last4 temp___11571))) (+ (- (to_rep2 (last4 temp___11571)) (to_rep2 (first4 temp___11571))) 1) 0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)))
(assert (= temp___1157 temp___1158))
(assert (= (mk1 (to_rep2 (first4 temp___11571)) (to_rep2 (last4 temp___11571))) temp___11581))
(assert (= (ite (<= (to_rep2 (first2 temp___11581)) (to_rep2 (last2 temp___11581))) (+ (- (to_rep2 (last2 temp___11581)) (to_rep2 (first2 temp___11581))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1160 temp___11601) (mk___t1 temp___1158 temp___11581)))
(assert (= temp___1160 o))
(assert (= (mk (to_rep2 (first2 temp___11601)) (to_rep2 (last2 temp___11601))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___11621 temp___11622))))
(assert (= result____split_discrs (mk___split_discrs temp___1162)))
...
(assert (and (and (and (=> (<= 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))) (dynamic_property6 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) i2)) (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true)) (forall ((temp___1174 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1174) (<= temp___1174 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1174) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1174) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1174)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (= r_digit2 o11))
(assert (= result5 (mk_t__ref1 difference2)))
(assert (= difference3 (bvsub (bvsub l_digit2 r_digit2) borrow2)))
(assert (=> (not (= (bvand difference3 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0))) (= result6 (mk_t__ref1 borrow2))))
(assert (=> (not (= (bvand difference3 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0))) (= borrow3 ((_ int2bv 16) 1))))
(assert (=> (= (bvand difference3 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0)) (= result7 (mk_t__ref1 borrow2))))
(assert (=> (= (bvand difference3 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0)) (= borrow4 ((_ int2bv 16) 0))))
(assert (=> (= (bvand difference3 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0)) (= borrow3 borrow4)))
...
(assert (= o12 (takelsb_from16 difference3)))
...
(assert (= o18 o16))
(assert (= o19 o17))
(assert (= temp___1167 (mk___rep result____split_discrs (mk___split_fields (mk___t o18 o19)))))
(assert (= result8 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1167)))
(assert (= result____split_discrs (us_split_discrs1 temp___1167)))
