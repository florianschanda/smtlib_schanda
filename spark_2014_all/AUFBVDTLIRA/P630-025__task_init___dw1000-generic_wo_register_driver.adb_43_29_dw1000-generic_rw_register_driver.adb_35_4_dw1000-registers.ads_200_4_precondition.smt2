...
(define-fun register_byte_array__ref___5__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_1928 us_t1) (temp___is_init_1925 Bool) (temp___skip_constant_1926 Bool) (temp___do_toplevel_1927 Bool)) Bool (=> (not (= temp___skip_constant_1926 true)) (and (dynamic_property2 1 4 (first3 temp___expr_1928) (last3 temp___expr_1928)) (and (= (first3 temp___expr_1928) 1) (= (last3 temp___expr_1928) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___2__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_1945 us_t2) (temp___is_init_1942 Bool) (temp___skip_constant_1943 Bool) (temp___do_toplevel_1944 Bool)) Bool (=> (not (= temp___skip_constant_1943 true)) (and (dynamic_property3 1 4 (first5 temp___expr_1945) (last5 temp___expr_1945)) (and (= (first5 temp___expr_1945) 1) (= (last5 temp___expr_1945) 4)))))
...
(assert (and (= (mk___t2 temp___7700 temp___77001) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7700 temp___77001) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___77001)) (to_rep (last4 temp___77001))) (+ (- (to_rep (last4 temp___77001)) (to_rep (first4 temp___77001))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7700 temp___7701))
(assert (= (mk1 (to_rep (first4 temp___77001)) (to_rep (last4 temp___77001))) temp___77011))
(assert (= (ite (<= (to_rep (first2 temp___77011)) (to_rep (last2 temp___77011))) (+ (- (to_rep (last2 temp___77011)) (to_rep (first2 temp___77011))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___7701 temp___77011)))
(assert (= o2 o))
