...
(define-fun dynamic_invariant ((temp___expr_5545 us_t1) (temp___is_init_5541 Bool) (temp___skip_constant_5542 Bool) (temp___do_toplevel_5543 Bool) (temp___do_typ_inv_5544 Bool)) Bool (=> (not (= temp___skip_constant_5542 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5545) (last3 temp___expr_5545)) (and (= (first3 temp___expr_5545) 1) (= (last3 temp___expr_5545) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_5563 us_t2) (temp___is_init_5559 Bool) (temp___skip_constant_5560 Bool) (temp___do_toplevel_5561 Bool) (temp___do_typ_inv_5562 Bool)) Bool (=> (not (= temp___skip_constant_5560 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5563) (last5 temp___expr_5563)) (and (= (first5 temp___expr_5563) 1) (= (last5 temp___expr_5563) 2)))))
...
(declare-const temp___87421 t2)
(define-fun temp___87422 () us_t2 (mk___t2 temp___8742 temp___87421))
...
(assert (and (= temp___87422 (register_to_bytes reg)) (dynamic_invariant1 temp___87422 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___87421)) (to_rep (last4 temp___87421))) (+ (- (to_rep (last4 temp___87421)) (to_rep (first4 temp___87421))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
