...
(define-fun dynamic_invariant3 ((temp___expr_292 (_ BitVec 8)) (temp___is_init_289 Bool) (temp___skip_constant_290 Bool) (temp___do_toplevel_291 Bool)) Bool true)
...
(define-fun dynamic_invariant4 ((temp___expr_208 (_ BitVec 32)) (temp___is_init_205 Bool) (temp___skip_constant_206 Bool) (temp___do_toplevel_207 Bool)) Bool true)
(declare-fun readreg32 ((_ BitVec 64)) (_ BitVec 32))
(declare-fun readreg32__function_guard ((_ BitVec 32) (_ BitVec 64)) Bool)
(assert (forall ((reg (_ BitVec 64))) (! (=> (dynamic_invariant reg true true true) (let ((result (readreg32 reg))) (and (= result ((_ extract 31 0) (bvand reg ((_ int2bv 64) 4294967295)))) (dynamic_invariant4 result true false true)))) :pattern ((readreg32 reg)))))
(assert (forall ((regnew (_ BitVec 64))) (forall ((val__ (_ BitVec 32))) (! (=> (and (dynamic_invariant regnew true true true) (dynamic_invariant4 val__ true true true)) (= (= (writereg32post regnew val__) true) (and (= (readreg32 regnew) val__) (= (bvand regnew ((_ int2bv 64) 18446744069414584320)) ((_ int2bv 64) 0))))) :pattern ((writereg32post regnew val__))))))
...
(assert (not (= (inrange64 rsi (bvsub rsp ((_ int2bv 64) 7)) ((_ int2bv 64) 15)) true)))
(assert (= o rsp))
...
(assert (= ra01 o2))
(assert (and (= o3 (readmem8 (bvadd rsp ((_ int2bv 64) 1)) memory)) (= o3 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 1)))))))
(assert (= o4 o3))
(assert (= result2 (mk_t__ref ra1)))
(assert (= ra11 o4))
(assert (and (= o5 (readmem8 (bvadd rsp ((_ int2bv 64) 2)) memory)) (= o5 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 2)))))))
(assert (= o6 o5))
(assert (= result3 (mk_t__ref ra2)))
(assert (= ra21 o6))
(assert (and (= o7 (readmem8 (bvadd rsp ((_ int2bv 64) 3)) memory)) (= o7 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 3)))))))
(assert (= o8 o7))
(assert (= result4 (mk_t__ref ra3)))
(assert (= ra31 o8))
(assert (and (= o9 (readmem8 (bvadd rsp ((_ int2bv 64) 4)) memory)) (= o9 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 4)))))))
(assert (= o10 o9))
(assert (= result5 (mk_t__ref ra4)))
(assert (= ra41 o10))
(assert (and (= o11 (readmem8 (bvadd rsp ((_ int2bv 64) 5)) memory)) (= o11 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 5)))))))
(assert (= o12 o11))
(assert (= result6 (mk_t__ref ra5)))
(assert (= ra51 o12))
(assert (and (= o13 (readmem8 (bvadd rsp ((_ int2bv 64) 6)) memory)) (= o13 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 6)))))))
(assert (= o14 o13))
(assert (= result7 (mk_t__ref ra6)))
(assert (= ra61 o14))
(assert (and (= o15 (readmem8 (bvadd rsp ((_ int2bv 64) 7)) memory)) (= o15 (to_rep (select memory (bvadd rsp ((_ int2bv 64) 7)))))))
(assert (= o16 o15))
(assert (= result8 (mk_t__ref ra7)))
(assert (= ra71 o16))
(assert (= rsp ((_ int2bv 64) 12105675798371893247)))
(assert (= result9 (mk_t__ref2 r8)))
(assert (= r81 ((_ int2bv 64) 32)))
(assert (= (writereg32post rax ((_ int2bv 32) 0)) true))
(assert (= (writereg32post rdx ((_ int2bv 32) 0)) true))
(assert (= rsp1 rsp))
(assert (and (and (and (and (and (and (and (and (= (bvand rax1 ((_ int2bv 64) 255)) ((_ zero_extend 56) (to_rep (select memory1 rsi)))) (= (bvand rax1 ((_ int2bv 64) 65280)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 1))))) ((_ int2bv 64) 256)))) (= (bvand rax1 ((_ int2bv 64) 16711680)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 2))))) ((_ int2bv 64) 65536)))) (= (bvand rax1 ((_ int2bv 64) 4278190080)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 3))))) ((_ int2bv 64) 16777216)))) (= (bvand rax1 ((_ int2bv 64) 1095216660480)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 4))))) ((_ int2bv 64) 4294967296)))) (= (bvand rax1 ((_ int2bv 64) 280375465082880)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 5))))) ((_ int2bv 64) 1099511627776)))) (= (bvand rax1 ((_ int2bv 64) 71776119061217280)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 6))))) ((_ int2bv 64) 281474976710656)))) (= (bvand rax1 ((_ int2bv 64) 18374686479671623680)) (bvmul ((_ zero_extend 56) (to_rep (select memory1 (bvadd rsi ((_ int2bv 64) 7))))) ((_ int2bv 64) 72057594037927936)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (and (and (and (and (and (and (and (not (= i rsi)) (not (= i (bvadd rsi ((_ int2bv 64) 1))))) (not (= i (bvadd rsi ((_ int2bv 64) 2))))) (not (= i (bvadd rsi ((_ int2bv 64) 3))))) (not (= i (bvadd rsi ((_ int2bv 64) 4))))) (not (= i (bvadd rsi ((_ int2bv 64) 5))))) (not (= i (bvadd rsi ((_ int2bv 64) 6))))) (not (= i (bvadd rsi ((_ int2bv 64) 7))))) (= (to_rep (select memory1 i)) (to_rep (select memory i))))))))
...
(assert (not (= (t__content2 rsp3) (bvadd rsp ((_ int2bv 64) 8)))))
(check-sat)
(exit)
