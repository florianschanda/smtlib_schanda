...
(define-fun dynamic_invariant2 ((temp___expr_357 (_ BitVec 8)) (temp___is_init_353 Bool) (temp___skip_constant_354 Bool) (temp___do_toplevel_355 Bool) (temp___do_typ_inv_356 Bool)) Bool true)
(define-fun dynamic_invariant3 ((temp___expr_406 (_ BitVec 16)) (temp___is_init_402 Bool) (temp___skip_constant_403 Bool) (temp___do_toplevel_404 Bool) (temp___do_typ_inv_405 Bool)) Bool (=> (or (= temp___is_init_402 true) (bvule #x0000 #x7FFF)) (in_range2 temp___expr_406)))
(define-fun dynamic_invariant4 ((temp___expr_756 us_t) (temp___is_init_752 Bool) (temp___skip_constant_753 Bool) (temp___do_toplevel_754 Bool) (temp___do_typ_inv_755 Bool)) Bool (=> (not (= temp___skip_constant_753 true)) (dynamic_property 0 2147483647 (first1 temp___expr_756) (last1 temp___expr_756))))
(declare-const o Int)
...
(assert (= result (ite (< 0 o2) true false)))
(assert (= result true))
...
(assert (= result1 (ite (<= o1 1024) true false)))
(assert (= result1 true))
(assert (< offset 1024))
