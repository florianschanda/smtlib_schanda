...
(assert (=> (= result2 true) (= o23 (to_rep1 o22))))
(assert (=> (= result2 true) (and (<= (to_rep b__first) k) (<= k (to_rep b__last)))))
(assert (=> (= result2 true) (= o19 k)))
(assert (=> (= result2 true) (= o20 (select b2 o19))))
(assert (=> (= result2 true) (= o24 (to_rep1 o20))))
