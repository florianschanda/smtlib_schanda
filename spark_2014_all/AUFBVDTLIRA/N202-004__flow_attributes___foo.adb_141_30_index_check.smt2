...
(assert (and (<= (to_rep1 (first (rt text))) temp___312) (<= temp___312 (to_rep1 (last (rt text))))))
...
(assert (= o7 (- o6 1)))
(assert (and (= temp___313 o7) (in_range1 o7)))
(assert (not (<= (to_rep1 data__first) temp___313)))
(check-sat)
(exit)
