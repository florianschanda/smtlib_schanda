...
(define-fun dynamic_invariant3 ((temp___expr_690 Int) (temp___is_init_687 Bool) (temp___skip_constant_688 Bool) (temp___do_toplevel_689 Bool)) Bool (=> (or (= temp___is_init_687 true) (<= 1 last2)) (dynamic_property2 1 last2 temp___expr_690)))
...
(define-fun dynamic_invariant6 ((temp___expr_210 (_ BitVec 8)) (temp___is_init_207 Bool) (temp___skip_constant_208 Bool) (temp___do_toplevel_209 Bool)) Bool true)
(declare-const n Int)
...
(assert (= temp___1247 (- o4 1)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1247) (<= temp___1247 (to_rep2 (last3 u__split_fields1)))))
(assert (= o5 temp___1247))
...
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1245) (<= temp___1245 (to_rep2 (last3 u__split_fields1)))))
(assert (= o temp___1245))
(assert (= o1 (select u__split_fields o)))
(assert (= o2 (to_rep1 o1)))
(assert (= o3 ((_ zero_extend 8) o2)))
(assert (= o9 (bvmul ((_ int2bv 16) 256) o3)))
(assert (= o10 (bvadd o9 o8)))
(assert (= result temporary_digit))
(assert (= temporary_digit1 o10))
(assert (and (<= (to_rep2 (first4 v__split_fields1)) n) (<= n (to_rep2 (last5 v__split_fields1)))))
(assert (= o11 n))
(assert (= o12 (select v__split_fields o11)))
(assert (= o13 (to_rep1 o12)))
(assert (= o14 ((_ zero_extend 8) o13)))
(assert (= o15 (bvudiv temporary_digit1 o14)))
(assert (= result1 q_hat))
(assert (= q_hat1 o15))
(assert (and (<= (to_rep2 (first4 v__split_fields1)) n) (<= n (to_rep2 (last5 v__split_fields1)))))
(assert (= o16 n))
(assert (= o17 (select v__split_fields o16)))
(assert (= o18 (to_rep1 o17)))
(assert (= o19 ((_ zero_extend 8) o18)))
(assert (= o20 (bvurem temporary_digit1 o19)))
(assert (= result2 r_hat))
(assert (= r_hat1 o20))
(assert (and (= o25 (+ j n)) (in_range1 (+ j n))))
(assert (= temp___1253 (- o25 2)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1253) (<= temp___1253 (to_rep2 (last3 u__split_fields1)))))
(assert (= o26 temp___1253))
(assert (= o27 (select u__split_fields o26)))
(assert (= o28 (to_rep1 o27)))
(assert (= o29 ((_ zero_extend 8) o28)))
(assert (= o30 (bvadd (bvmul ((_ int2bv 16) 256) r_hat1) o29)))
(assert (and (<= (to_rep2 (first4 v__split_fields1)) (- n 1)) (<= (- n 1) (to_rep2 (last5 v__split_fields1)))))
(assert (= o21 (- n 1)))
(assert (= o22 (select v__split_fields o21)))
(assert (= o23 (to_rep1 o22)))
(assert (= o24 ((_ zero_extend 8) o23)))
(assert (= o31 (bvmul q_hat1 o24)))
(assert (= o32 (ite (bvugt o31 o30) true false)))
(assert (= result3 (ite (= q_hat1 ((_ int2bv 16) 256)) true o32)))
(assert (=> (= result3 true) (= q_hat1 result4)))
(assert (=> (= result3 true) (= q_hat2 (bvsub q_hat1 ((_ int2bv 16) 1)))))
(assert (=> (= result3 true) (and (<= (to_rep2 (first4 v__split_fields1)) n) (<= n (to_rep2 (last5 v__split_fields1))))))
(assert (=> (= result3 true) (= o33 n)))
(assert (=> (= result3 true) (= o34 (select v__split_fields o33))))
(assert (=> (= result3 true) (= o35 (to_rep1 o34))))
(assert (=> (= result3 true) (= o36 ((_ zero_extend 8) o35))))
(assert (=> (= result3 true) (= o37 (bvadd r_hat1 o36))))
(assert (=> (= result3 true) (= result5 r_hat1)))
(assert (=> (= result3 true) (= r_hat2 o37)))
(assert (=> (not (= result3 true)) (= r_hat2 r_hat1)))
(assert (=> (not (= result3 true)) (= q_hat2 q_hat1)))
(assert (bvult r_hat2 ((_ int2bv 16) 256)))
(assert (and (= o38 (+ j n)) (in_range1 (+ j n))))
(assert (= temp___1258 (- o38 2)))
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1258) (<= temp___1258 (to_rep2 (last3 u__split_fields1)))))
(assert (= o39 temp___1258))
(assert (= o40 (select u__split_fields o39)))
(assert (= o41 (to_rep1 o40)))
(assert (= o42 ((_ zero_extend 8) o41)))
(assert (= o43 (bvadd (bvmul ((_ int2bv 16) 256) r_hat2) o42)))
(assert (not (<= (to_rep2 (first4 v__split_fields1)) (- n 1))))
(check-sat)
(exit)
