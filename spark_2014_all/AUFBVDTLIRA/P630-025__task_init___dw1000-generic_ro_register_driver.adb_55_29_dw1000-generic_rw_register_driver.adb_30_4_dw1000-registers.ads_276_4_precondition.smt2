...
(define-fun dynamic_invariant ((temp___expr_3127 us_t1) (temp___is_init_3124 Bool) (temp___skip_constant_3125 Bool) (temp___do_toplevel_3126 Bool)) Bool (=> (not (= temp___skip_constant_3125 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3127) (last3 temp___expr_3127)) (and (= (first3 temp___expr_3127) 1) (= (last3 temp___expr_3127) 4)))))
