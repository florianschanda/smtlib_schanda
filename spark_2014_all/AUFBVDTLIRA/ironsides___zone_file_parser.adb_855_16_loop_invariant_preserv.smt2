...
(assert (= o17 (bvurem o16 ((_ int2bv 16) 32))))
(assert (= o18 (bvadd o17 ((_ int2bv 16) 1))))
(assert (= o19 (bv2nat o18)))
(assert (= result16 (mk_int__ref bytenumber)))
(assert (= bytenumber2 o19))
(assert (= (to_rep3 o20) bytenumber2))
(assert (= o21 (store blocklengthmap1 blocknumberoffirstrecordtype2 o20)))
(assert (= result17 (mk_map__ref6 blocklengthmap1)))
(assert (= blocklengthmap2 o21))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (and (and (= temp___1623 bytenumber2) (and (= temp___1624 foundtype1) (and (= temp___1621 blockmap2) (and (= temp___1620 endidx1) (and (= temp___1619 begidx2) (and (= temp___1618 blocknumber) (and (= temp___1616 recordtypes2) (and (= temp___1615 recordtype2) (and (= temp___1613 blocklengthmap2) (and (= temp___1612 numberofrecordtypes2) (and (and (and (and (and (and (<= 0 endidx2) (< endidx2 256)) (<= 1 numberofrecordtypes3)) (< numberofrecordtypes3 32)) (= numberofblocks2 1)) (forall ((j26 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) j26) (bvule j26 ((_ int2bv 8) 255))) (and (<= 1 (to_rep3 (select blocklengthmap3 j26))) (<= (to_rep3 (select blocklengthmap3 j26)) 32))))) (and (and (and (and (and (and (and (=> (<= 0 32) (in_range6 numberofrecordtypes3)) (=> (<= 0 18) (in_range5 recordtype3))) (=> (<= 1 256) (in_range3 begidx3))) (=> (<= 1 256) (in_range3 endidx2))) (=> (<= 1 32) (in_range10 bytenumber3))) (=> (<= 0 10) (in_range2 foundtype2))) (and (and (= foundtype2 3) (< endidx2 256)) (< numberofrecordtypes3 32))) (and (and (and (and (and (<= begidx4 endidx3) (<= begidx4 256)) (<= endidx3 256)) (=> (= foundtype3 1) (forall ((i34 Int)) (=> (and (<= begidx4 i34) (<= i34 endidx3)) (and (<= 48 (to_rep (select rrstring i34))) (<= (to_rep (select rrstring i34)) 57)))))) (and (and (in_range3 begidx4) (in_range3 endidx3)) (in_range2 foundtype3))) (and (ite (= foundtype3 3) (and (and (and (= o22 (getrecordtype rrstring begidx4 endidx3)) (in_range5 o22)) (and (= result18 (mk_int__ref recordtype3)) (= recordtype4 o22))) (and (and (and (= o23 (+ numberofrecordtypes3 1)) (in_range6 (+ numberofrecordtypes3 1))) (and (= result19 (mk_int__ref numberofrecordtypes3)) (= numberofrecordtypes4 o23))) (and (and (and (= (to_rep2 o24) recordtype4) (and (and (and (<= 1 numberofrecordtypes4) (<= numberofrecordtypes4 32)) (= o25 numberofrecordtypes4)) (= o26 (store recordtypes3 o25 o24)))) (and (= result20 (mk_map__ref2 recordtypes3)) (= recordtypes4 o26))) (and (and (and (and (and (and (= o27 (from_query_type recordtype4)) (= o28 (bvudiv o27 ((_ int2bv 16) 256)))) (= o29 (bvurem o28 ((_ int2bv 16) 256)))) (= o30 o29)) (= o31 ((_ extract 7 0) o30))) (and (= result21 (mk_t__ref blocknumber2)) (= blocknumber3 o31))) (and (and (= result22 (mk_map__ref5 blockmap3)) (= blockmap4 (store blockmap3 blocknumber3 (of_int 1)))) (and (and (and (and (and (and (and (and (and (= o32 (from_query_type recordtype4)) (= o33 (bvudiv o32 ((_ int2bv 16) 256)))) (= o34 (bvmul ((_ int2bv 16) 256) o33))) (and (= o35 (from_query_type recordtype4)) (= o36 (bvsub o35 o34)))) (= o37 (bvudiv o36 ((_ int2bv 16) 8)))) (= o38 (bvurem o37 ((_ int2bv 16) 32)))) (= o39 (bvadd o38 ((_ int2bv 16) 1)))) (= o40 (bv2nat o39))) (and (= result23 (mk_int__ref bytenumber3)) (= bytenumber4 o40))) (ite (< (to_rep3 (select blocklengthmap3 blocknumber3)) bytenumber4) (and (and (= (to_rep3 o41) bytenumber4) (= o42 (store blocklengthmap3 blocknumber3 o41))) (and (= result24 (mk_map__ref6 blocklengthmap3)) (= blocklengthmap4 o42))) (= blocklengthmap4 blocklengthmap3)))))))) (and (= bytenumber4 bytenumber3) (and (= blocknumber3 blocknumber2) (and (= recordtype4 recordtype3) (and (= blocklengthmap4 blocklengthmap3) (and (= blockmap4 blockmap3) (and (= recordtypes4 recordtypes3) (= numberofrecordtypes4 numberofrecordtypes3)))))))) (not (and (= foundtype3 3) (and (< endidx3 256) (< numberofrecordtypes4 32)))))))))))))))))) (and (and (= bytenumber7 (mk_int__ref bytenumber4)) (and (= blocknumber6 (mk_t__ref blocknumber3)) (and (= recordtype7 (mk_int__ref recordtype4)) (and (= foundtype6 (mk_int__ref foundtype3)) (and (= endidx6 (mk_int__ref endidx3)) (and (= begidx7 (mk_int__ref begidx4)) (and (= blocklengthmap7 (mk_map__ref6 blocklengthmap4)) (and (= blockmap7 (mk_map__ref5 blockmap4)) (and (= recordtypes7 (mk_map__ref2 recordtypes4)) (= numberofrecordtypes7 (mk_int__ref numberofrecordtypes4))))))))))) (and (= bytenumber8 bytenumber4) (and (= blocknumber7 blocknumber3) (and (= recordtype8 recordtype4) (and (= foundtype7 foundtype3) (and (= endidx7 endidx3) (and (= begidx8 begidx4) (and (= blocklengthmap8 blocklengthmap4) (and (= blockmap8 blockmap4) (and (= recordtypes8 recordtypes4) (= numberofrecordtypes8 numberofrecordtypes4))))))))))))))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= bytenumber9 bytenumber7)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= blocknumber8 blocknumber6)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= recordtype9 recordtype7)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= foundtype8 foundtype6)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= endidx8 endidx6)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= begidx9 begidx7)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= blocklengthmap9 blocklengthmap7)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= blockmap9 blockmap7)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= recordtypes9 recordtypes7)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= numberofrecordtypes9 numberofrecordtypes7)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= bytenumber10 bytenumber8)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= blocknumber9 blocknumber7)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= recordtype10 recordtype8)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= foundtype9 foundtype7)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= endidx9 endidx7)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= begidx10 begidx8)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= blocklengthmap10 blocklengthmap8)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= blockmap10 blockmap8)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= recordtypes10 recordtypes8)))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (= numberofrecordtypes10 numberofrecordtypes8)))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= bytenumber9 (mk_int__ref bytenumber2))))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= blocknumber8 (mk_t__ref blocknumber))))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= recordtype9 (mk_int__ref recordtype2))))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= foundtype8 (mk_int__ref foundtype1))))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= endidx8 (mk_int__ref endidx1))))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= begidx9 (mk_int__ref begidx2))))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= blocklengthmap9 (mk_map__ref6 blocklengthmap2))))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= blockmap9 (mk_map__ref5 blockmap2))))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= recordtypes9 (mk_map__ref2 recordtypes2))))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= numberofrecordtypes9 (mk_int__ref numberofrecordtypes2))))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= bytenumber10 bytenumber2)))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= blocknumber9 blocknumber1)))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= recordtype10 recordtype2)))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= foundtype9 foundtype1)))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= endidx9 endidx1)))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= begidx10 begidx2)))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= blocklengthmap10 blocklengthmap2)))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= blockmap10 blockmap2)))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= recordtypes10 recordtypes2)))
(assert (=> (not (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32)))) (= numberofrecordtypes10 numberofrecordtypes2)))
(assert (and (and (and (= numberofblocks2 1) (forall ((j26 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) j26) (bvule j26 ((_ int2bv 8) 255))) (and (<= 1 (to_rep3 (select (map__content6 blocklengthmap9) j26))) (<= (to_rep3 (select (map__content6 blocklengthmap9) j26)) 32))))) (<= 1 (int__content numberofrecordtypes9))) (<= (int__content numberofrecordtypes9) 32)))
(assert (= result25 (mk_t__ref i)))
(assert (= i4 ((_ int2bv 8) 0)))
(assert (=> (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255))) (and (and (= temp___1629 blocklengths1) (and (= temp___1627 blocknumbers1) (and (= temp___1626 numberofblocks2) (and (= temp___1625 i4) (and (and (and (and (and (<= 1 numberofblocks3) (< numberofblocks3 32)) (forall ((j26 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) j26) (bvule j26 ((_ int2bv 8) 255))) (and (<= 1 (to_rep3 (select (map__content6 blocklengthmap9) j26))) (<= (to_rep3 (select (map__content6 blocklengthmap9) j26)) 32))))) (<= 1 (int__content numberofrecordtypes9))) (<= (int__content numberofrecordtypes9) 32)) (and (and (=> (<= 0 32) (in_range8 numberofblocks3)) (and (bvule ((_ int2bv 8) 0) i5) (bvule i5 ((_ int2bv 8) 255)))) (and (ite (ite (= (select (map__content5 blockmap9) i5) true) (not (= i5 blocknumberoffirstrecordtype2)) false) (and (and (and (and (= o43 (+ numberofblocks3 1)) (in_range8 (+ numberofblocks3 1))) (and (= result26 (mk_int__ref numberofblocks3)) (= numberofblocks4 o43))) (and (and (and (= (to_rep1 o44) i5) (and (and (and (<= 1 numberofblocks4) (<= numberofblocks4 32)) (= o45 numberofblocks4)) (= o46 (store blocknumbers2 o45 o44)))) (and (= result27 (mk_map__ref1 blocknumbers2)) (= blocknumbers3 o46))) (and (and (= (to_rep3 o47) (to_rep3 (select (map__content6 blocklengthmap9) i5))) (and (and (and (<= 1 numberofblocks4) (<= numberofblocks4 32)) (= o48 numberofblocks4)) (= o49 (store blocklengths2 o48 o47)))) (and (= result28 (mk_map__ref3 blocklengths2)) (= blocklengths3 o49))))) (and (and (= blocklengths4 (mk_map__ref3 blocklengths3)) (and (= blocknumbers4 (mk_map__ref1 blocknumbers3)) (= numberofblocks5 (mk_int__ref numberofblocks4)))) (and (= blocklengths5 blocklengths3) (and (= blocknumbers5 blocknumbers3) (= numberofblocks6 numberofblocks4))))) (and (and (= blocklengths4 (mk_map__ref3 blocklengths2)) (and (= blocknumbers4 (mk_map__ref1 blocknumbers2)) (= numberofblocks5 (mk_int__ref numberofblocks3)))) (and (= blocklengths5 blocklengths2) (and (= blocknumbers5 blocknumbers2) (= numberofblocks6 numberofblocks3))))) (or (= (int__content numberofblocks5) 32) (and (not (= (int__content numberofblocks5) 32)) (= i5 ((_ int2bv 8) 255))))))))))) (and (and (= i11 (mk_t__ref i5)) (and (= blocklengths10 blocklengths4) (and (= blocknumbers10 blocknumbers4) (= numberofblocks11 numberofblocks5)))) (and (= i12 i5) (and (= blocklengths11 blocklengths5) (and (= blocknumbers11 blocknumbers5) (= numberofblocks12 numberofblocks6))))))))
(assert (=> (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255))) (= i13 i11)))
(assert (=> (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255))) (= blocklengths12 blocklengths10)))
(assert (=> (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255))) (= blocknumbers12 blocknumbers10)))
(assert (=> (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255))) (= numberofblocks13 numberofblocks11)))
(assert (=> (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255))) (= i14 i12)))
(assert (=> (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255))) (= blocklengths13 blocklengths11)))
(assert (=> (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255))) (= blocknumbers13 blocknumbers11)))
(assert (=> (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255))) (= numberofblocks14 numberofblocks12)))
(assert (=> (not (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255)))) (= i13 (mk_t__ref i4))))
(assert (=> (not (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255)))) (= blocklengths12 (mk_map__ref3 blocklengths1))))
(assert (=> (not (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255)))) (= blocknumbers12 (mk_map__ref1 blocknumbers1))))
(assert (=> (not (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255)))) (= numberofblocks13 (mk_int__ref numberofblocks2))))
(assert (=> (not (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255)))) (= i14 i4)))
(assert (=> (not (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255)))) (= blocklengths13 blocklengths1)))
(assert (=> (not (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255)))) (= blocknumbers13 blocknumbers1)))
(assert (=> (not (and (bvule ((_ int2bv 8) 0) i4) (bvule i4 ((_ int2bv 8) 255)))) (= numberofblocks14 numberofblocks2)))
(assert (and (and (and (<= 1 (int__content numberofrecordtypes9)) (<= (int__content numberofrecordtypes9) 32)) (<= 1 (int__content numberofblocks13))) (<= (int__content numberofblocks13) 32)))
(assert (= result30 (mk_map__ref4 bitmaps1)))
(assert (= bitmaps2 (temp___1633 (temp___1637 ((_ int2bv 8) 0)))))
(assert (= (int__content numberofrecordtypes9) r60b))
...
(assert (<= i15 r60b))
(assert (and (and (and (<= 1 (int__content numberofrecordtypes9)) (<= (int__content numberofrecordtypes9) 32)) (<= 1 (int__content numberofblocks13))) (<= (int__content numberofblocks13) 32)))
(assert (and (and (and (and (=> (<= 0 2147483647) (in_range1 bitnumber2)) (=> (<= 1 r60b) (dynamic_property 1 r60b i16))) (=> (<= 0 32) (in_range8 blockindex2))) (=> (<= 1 32) (in_range10 bytenumber11))) (and (<= 1 i16) (<= i16 r60b))))
(assert (= result32 (mk_int__ref blockindex2)))
(assert (= blockindex3 1))
(assert (= (int__content numberofblocks13) r62b))
(assert (in_range8 r62b))
(assert (= result33 (mk_int__ref j2)))
(assert (= j3 1))
(assert (=> (and (<= 1 j3) (<= j3 r62b)) (and (and (= temp___1642 blockindex3) (and (= temp___1641 j3) (and (and (and (and (and (and (<= 1 (int__content numberofrecordtypes9)) (<= (int__content numberofrecordtypes9) 32)) (<= 1 (int__content numberofblocks13))) (<= (int__content numberofblocks13) 32)) (<= 1 blockindex4)) (<= blockindex4 32)) (and (and (and (=> (<= 1 r62b) (dynamic_property1 1 r62b j4)) (=> (<= 0 32) (in_range8 blockindex4))) (and (<= 1 j4) (<= j4 r62b))) (or (and (and (= blockindex8 (mk_int__ref blockindex5)) (= blockindex9 blockindex5)) (and (and (and (and (and (and (= o50 (from_query_type (to_rep2 (select (map__content2 recordtypes9) i16)))) (= o51 (bvudiv o50 ((_ int2bv 16) 256)))) (= o52 (bvurem o51 ((_ int2bv 16) 256)))) (= o53 o52)) (= o54 ((_ extract 7 0) o53))) (= result34 (ite (= (to_rep1 (select (map__content1 blocknumbers12) j4)) o54) true false))) (and (= result34 true) (and (= result35 (mk_int__ref blockindex4)) (= blockindex5 j4))))) (and (and (and (and (and (and (and (= o50 (from_query_type (to_rep2 (select (map__content2 recordtypes9) i16)))) (= o51 (bvudiv o50 ((_ int2bv 16) 256)))) (= o52 (bvurem o51 ((_ int2bv 16) 256)))) (= o53 o52)) (= o54 ((_ extract 7 0) o53))) (= result34 (ite (= (to_rep1 (select (map__content1 blocknumbers12) j4)) o54) true false))) (and (not (= result34 true)) (and (= blockindex6 (mk_int__ref blockindex4)) (= blockindex7 blockindex4)))) (and (and (= blockindex8 blockindex6) (= blockindex9 blockindex7)) (= j4 r62b)))))))) (and (and (= j10 (mk_int__ref j4)) (= blockindex14 blockindex8)) (and (= j11 j4) (= blockindex15 blockindex9))))))
(assert (=> (and (<= 1 j3) (<= j3 r62b)) (= j12 j10)))
(assert (=> (and (<= 1 j3) (<= j3 r62b)) (= blockindex16 blockindex14)))
(assert (=> (and (<= 1 j3) (<= j3 r62b)) (= j13 j11)))
(assert (=> (and (<= 1 j3) (<= j3 r62b)) (= blockindex17 blockindex15)))
(assert (=> (not (and (<= 1 j3) (<= j3 r62b))) (= j12 (mk_int__ref j3))))
(assert (=> (not (and (<= 1 j3) (<= j3 r62b))) (= blockindex16 (mk_int__ref blockindex3))))
(assert (=> (not (and (<= 1 j3) (<= j3 r62b))) (= j13 j3)))
(assert (=> (not (and (<= 1 j3) (<= j3 r62b))) (= blockindex17 blockindex3)))
(assert (= o55 (from_query_type (int__content recordtype9))))
(assert (= o56 (bvudiv o55 ((_ int2bv 16) 256))))
(assert (= o57 (bvmul ((_ int2bv 16) 256) o56)))
(assert (= o58 (from_query_type (int__content recordtype9))))
(assert (= o59 (bvsub o58 o57)))
(assert (= o60 (bvudiv o59 ((_ int2bv 16) 8))))
(assert (= o61 (bvurem o60 ((_ int2bv 16) 32))))
(assert (= o62 (bvadd o61 ((_ int2bv 16) 1))))
(assert (= o63 (bv2nat o62)))
(assert (= result37 (mk_int__ref bytenumber11)))
(assert (= bytenumber12 o63))
(assert (= o64 (from_query_type (to_rep2 (select (map__content2 recordtypes9) i16)))))
(assert (= o65 (bvurem o64 ((_ int2bv 16) 8))))
(assert (= o66 (bv2nat o65)))
(assert (= result38 (mk_int__ref bitnumber2)))
(assert (= bitnumber3 o66))
(assert (and (= temp___1646 (- 7 bitnumber3)) (in_range1 (- 7 bitnumber3))))
(assert (=> (< temp___1646 256) (= o69 (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) temp___1646)))))
(assert (=> (not (< temp___1646 256)) (= o69 ((_ int2bv 8) 0))))
(assert (and (<= 1 (int__content blockindex16)) (<= (int__content blockindex16) 32)))
(assert (= o67 (int__content blockindex16)))
(assert (= temp___1645 (select bitmaps3 o67)))
(assert (= o68 (select temp___1645 bytenumber12)))
(assert (= o70 (to_rep1 o68)))
(assert (= o71 (bvadd o70 o69)))
(assert (= (to_rep1 o72) o71))
(assert (= o73 (store (select bitmaps3 (int__content blockindex16)) bytenumber12 o72)))
(assert (and (<= 1 (int__content blockindex16)) (<= (int__content blockindex16) 32)))
(assert (= o74 (int__content blockindex16)))
(assert (= o75 (store bitmaps3 o74 o73)))
(assert (= result39 (mk_map__ref4 bitmaps3)))
(assert (= bitmaps4 o75))
(assert (not (= i16 r60b)))
(assert (= result40 (mk_int__ref i16)))
(assert (= i17 (+ i16 1)))
(assert (= j14 j12))
(assert (= i18 (mk_int__ref i17)))
(assert (= bitnumber4 (mk_int__ref bitnumber3)))
(assert (= bytenumber13 (mk_int__ref bytenumber12)))
(assert (= blockindex18 blockindex16))
(assert (= bitmaps5 (mk_map__ref4 bitmaps4)))
(assert (= j15 j13))
(assert (= i19 i17))
(assert (= bitnumber5 bitnumber3))
(assert (= bytenumber14 bytenumber12))
(assert (= blockindex19 blockindex17))
(assert (= bitmaps6 bitmaps4))
(assert (not (<= 1 (int__content numberofrecordtypes9))))
(check-sat)
(exit)
