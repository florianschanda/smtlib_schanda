...
(declare-const temp___1688 (Array Int blocklengthvalue))
(declare-const temp___1686 (Array Int byte))
(declare-const temp___1685 Int)
(declare-const temp___1684 (_ BitVec 8))
...
(declare-const temp___1704 (Array Int byte))
...
(assert (= begidx1 1))
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 256)) (<= endidx1 256)) (=> (= foundtype1 1) (forall ((i13 Int)) (=> (and (<= begidx2 i13) (<= i13 endidx1)) (and (<= 48 (to_rep (select rrstring i13))) (<= (to_rep (select rrstring i13)) 57)))))) (and (and (in_range3 begidx2) (in_range3 endidx1)) (in_range2 foundtype1))))
(assert (= foundtype1 3))
...
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (and (and (and (and (and (<= 0 endidx2) (< endidx2 256)) (<= 1 numberofrecordtypes3)) (< numberofrecordtypes3 32)) (= numberofblocks2 1)) (forall ((j9 (_ BitVec 8))) (=> (and (bvule #x00 j9) (bvule j9 #xFF)) (and (<= 1 (to_rep3 (select blocklengthmap3 j9))) (<= (to_rep3 (select blocklengthmap3 j9)) 32)))))))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (and (and (and (and (and (and (=> (<= 0 32) (in_range6 numberofrecordtypes3)) (=> (<= 0 18) (in_range5 recordtype2))) (=> (<= 1 256) (in_range3 begidx3))) (=> (<= 1 256) (in_range3 endidx2))) (=> (<= 1 32) (in_range10 bytenumber2))) (=> (<= 0 10) (in_range2 foundtype2))) (and (and (= foundtype2 3) (< endidx2 256)) (< numberofrecordtypes3 32)))))
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (and (and (and (and (<= begidx4 endidx3) (<= begidx4 256)) (<= endidx3 256)) (=> (= foundtype3 1) (forall ((i13 Int)) (=> (and (<= begidx4 i13) (<= i13 endidx3)) (and (<= 48 (to_rep (select rrstring i13))) (<= (to_rep (select rrstring i13)) 57)))))) (and (and (in_range3 begidx4) (in_range3 endidx3)) (in_range2 foundtype3)))))
...
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (=> (= foundtype3 3) (and (= o23 (+ numberofrecordtypes3 1)) (in_range6 (+ numberofrecordtypes3 1))))))
...
(assert (and (and (and (= numberofblocks2 1) (forall ((j9 (_ BitVec 8))) (=> (and (bvule #x00 j9) (bvule j9 #xFF)) (and (<= 1 (to_rep3 (select (map__content6 blocklengthmap7) j9))) (<= (to_rep3 (select (map__content6 blocklengthmap7) j9)) 32))))) (<= 1 (int__content numberofrecordtypes7))) (<= (int__content numberofrecordtypes7) 32)))
(assert (= result24 (mk_t__ref i)))
(assert (= i2 #x00))
(assert (=> (and (bvule #x00 i2) (bvule i2 #xFF)) (= temp___1688 blocklengths1)))
(assert (=> (and (bvule #x00 i2) (bvule i2 #xFF)) (= temp___1686 blocknumbers1)))
(assert (=> (and (bvule #x00 i2) (bvule i2 #xFF)) (= temp___1685 numberofblocks2)))
(assert (=> (and (bvule #x00 i2) (bvule i2 #xFF)) (= temp___1684 i2)))
(assert (=> (and (bvule #x00 i2) (bvule i2 #xFF)) (and (and (and (and (<= 1 numberofblocks3) (< numberofblocks3 32)) (forall ((j9 (_ BitVec 8))) (=> (and (bvule #x00 j9) (bvule j9 #xFF)) (and (<= 1 (to_rep3 (select (map__content6 blocklengthmap7) j9))) (<= (to_rep3 (select (map__content6 blocklengthmap7) j9)) 32))))) (<= 1 (int__content numberofrecordtypes7))) (<= (int__content numberofrecordtypes7) 32))))
(assert (=> (and (bvule #x00 i2) (bvule i2 #xFF)) (and (=> (<= 0 32) (in_range8 numberofblocks3)) (and (bvule #x00 i3) (bvule i3 #xFF)))))
(assert (=> (and (bvule #x00 i2) (bvule i2 #xFF)) (=> (ite (= (select (map__content5 blockmap7) i3) true) (not (= i3 blocknumberoffirstrecordtype1)) false) (and (= o43 (+ numberofblocks3 1)) (in_range8 (+ numberofblocks3 1))))))
...
(assert (= bitmaps2 (temp___1692 (temp___1696 #x00))))
(assert (= (int__content numberofrecordtypes7) r60b))
(assert (in_range6 r60b))
(assert (= result29 (mk_int__ref i1)))
(assert (= i8 1))
(assert (<= 1 i8))
(assert (<= i8 r60b))
(assert (and (and (and (<= 1 (int__content numberofrecordtypes7)) (<= (int__content numberofrecordtypes7) 32)) (<= 1 (int__content numberofblocks9))) (<= (int__content numberofblocks9) 32)))
(assert (and (and (and (and (=> (<= 0 2147483647) (in_range1 bitnumber1)) (=> (<= 1 r60b) (dynamic_property 1 r60b i9))) (=> (<= 0 32) (in_range8 blockindex1))) (=> (<= 1 32) (in_range10 bytenumber8))) (and (<= 1 i9) (<= i9 r60b))))
(assert (= result30 (mk_int__ref blockindex1)))
(assert (= blockindex2 1))
(assert (= (int__content numberofblocks9) r62b))
(assert (in_range8 r62b))
(assert (= result31 (mk_int__ref j)))
(assert (= j1 1))
(assert (=> (and (<= 1 j1) (<= j1 r62b)) (= temp___1701 blockindex2)))
(assert (=> (and (<= 1 j1) (<= j1 r62b)) (= temp___1700 j1)))
...
(assert (=> (and (<= 1 j1) (<= j1 r62b)) (and (and (=> (<= 1 r62b) (dynamic_property1 1 r62b j2)) (=> (<= 0 32) (in_range8 blockindex3))) (and (<= 1 j2) (<= j2 r62b)))))
...
(assert (and (= temp___1705 (- 7 bitnumber2)) (in_range1 (- 7 bitnumber2))))
(assert (=> (< temp___1705 256) (= o69 (bvshl #x01 ((_ int2bv 8) temp___1705)))))
(assert (=> (not (< temp___1705 256)) (= o69 #x00)))
(assert (and (<= 1 (int__content blockindex11)) (<= (int__content blockindex11) 32)))
(assert (= o67 (int__content blockindex11)))
(assert (= temp___1704 (select bitmaps3 o67)))
(assert (= o68 (select temp___1704 bytenumber9)))
(assert (= o70 (to_rep1 o68)))
(assert (= o71 (bvadd o70 o69)))
(assert (= (to_rep1 o72) o71))
(assert (= o73 (store (select bitmaps3 (int__content blockindex11)) bytenumber9 o72)))
(assert (and (<= 1 (int__content blockindex11)) (<= (int__content blockindex11) 32)))
(assert (= o74 (int__content blockindex11)))
(assert (= o75 (store bitmaps3 o74 o73)))
(assert (= result36 (mk_map__ref4 bitmaps3)))
(assert (= bitmaps4 o75))
(assert (not (= i9 r60b)))
(assert (= result37 (mk_int__ref i9)))
(assert (= i10 (+ i9 1)))
(assert (= j7 j5))
(assert (= i11 (mk_int__ref i10)))
(assert (= bitnumber3 (mk_int__ref bitnumber2)))
(assert (= bytenumber10 (mk_int__ref bytenumber9)))
(assert (= blockindex13 blockindex11))
(assert (= bitmaps5 (mk_map__ref4 bitmaps4)))
(assert (= j8 j6))
(assert (= i12 i10))
(assert (= bitnumber4 bitnumber2))
(assert (= bytenumber11 bytenumber9))
(assert (= blockindex14 blockindex12))
(assert (= bitmaps6 bitmaps4))
