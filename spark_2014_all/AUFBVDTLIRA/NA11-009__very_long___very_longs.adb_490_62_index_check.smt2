...
(assert (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields2) true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r125b))))
...
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1265)))
(check-sat)
(exit)
