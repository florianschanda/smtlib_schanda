...
(assert (= (ite (<= (to_rep (first4 temp___88201)) (to_rep (last4 temp___88201))) (+ (- (to_rep (last4 temp___88201)) (to_rep (first4 temp___88201))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8820 temp___8821))
(assert (= (mk1 (to_rep (first4 temp___88201)) (to_rep (last4 temp___88201))) temp___88211))
(assert (= (ite (<= (to_rep (first2 temp___88211)) (to_rep (last2 temp___88211))) (+ (- (to_rep (last2 temp___88211)) (to_rep (first2 temp___88211))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8821 temp___88211)))
(assert (= o2 o))
