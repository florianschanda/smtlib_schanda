...
(define-fun dynamic_invariant ((temp___expr_4170 us_t1) (temp___is_init_4166 Bool) (temp___skip_constant_4167 Bool) (temp___do_toplevel_4168 Bool) (temp___do_typ_inv_4169 Bool)) Bool (=> (not (= temp___skip_constant_4167 true)) (and (dynamic_property2 1 4064 (first3 temp___expr_4170) (last3 temp___expr_4170)) (and (= (first3 temp___expr_4170) 1) (= (last3 temp___expr_4170) 4064)))))
