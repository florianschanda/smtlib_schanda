...
(assert (=> (= carry1 ((_ int2bv 16) 1)) (= result1 true)))
(assert (=> (not (= carry1 ((_ int2bv 16) 1))) (= result1 (oge (to_base (mk___rep1 result____split_discrs result____split_fields2)) p))))
(assert (= result1 true))
