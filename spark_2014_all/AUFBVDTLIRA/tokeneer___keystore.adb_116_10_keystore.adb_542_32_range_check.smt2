...
(define-fun us_split_fields_Owner__2__projection ((a us_split_fields2)) us_rep (rec__keystore__optionalprivatekeyt__owner a))
...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields3 a)) (rec__keystore__optionalprivatekeyt__ispresent (us_split_fields3 b))) (= (bool_eq2 (rec__keystore__optionalprivatekeyt__owner (us_split_fields3 a)) (rec__keystore__optionalprivatekeyt__owner (us_split_fields3 b))) true)) true false))
...
(declare-datatypes () ((us_split_fields4 (mk___split_fields2 (rec__keystore__interfac__keytemplatet__attrmask maskt) (rec__keystore__interfac__keytemplatet__owner us_rep) (rec__keystore__interfac__keytemplatet__keyid unsigned32t) (rec__keystore__interfac__keytemplatet__keylength unsigned32t) (rec__keystore__interfac__keytemplatet__ispublic Bool)))))
(define-fun us_split_fields_AttrMask__projection ((a us_split_fields4)) maskt (rec__keystore__interfac__keytemplatet__attrmask a))
(define-fun us_split_fields_Owner__projection ((a us_split_fields4)) us_rep (rec__keystore__interfac__keytemplatet__owner a))
(define-fun us_split_fields_KeyID__2__projection ((a us_split_fields4)) unsigned32t (rec__keystore__interfac__keytemplatet__keyid a))
(define-fun us_split_fields_KeyLength__2__projection ((a us_split_fields4)) unsigned32t (rec__keystore__interfac__keytemplatet__keylength a))
(define-fun us_split_fields_IsPublic__projection ((a us_split_fields4)) Bool (rec__keystore__interfac__keytemplatet__ispublic a))
...
(define-fun bool_eq4 ((a us_rep2) (b us_rep2)) Bool (ite (and (and (and (and (= (to_rep5 (rec__keystore__interfac__keytemplatet__attrmask (us_split_fields5 a))) (to_rep5 (rec__keystore__interfac__keytemplatet__attrmask (us_split_fields5 b)))) (= (bool_eq2 (rec__keystore__interfac__keytemplatet__owner (us_split_fields5 a)) (rec__keystore__interfac__keytemplatet__owner (us_split_fields5 b))) true)) (= (to_rep2 (rec__keystore__interfac__keytemplatet__keyid (us_split_fields5 a))) (to_rep2 (rec__keystore__interfac__keytemplatet__keyid (us_split_fields5 b))))) (= (to_rep2 (rec__keystore__interfac__keytemplatet__keylength (us_split_fields5 a))) (to_rep2 (rec__keystore__interfac__keytemplatet__keylength (us_split_fields5 b))))) (= (rec__keystore__interfac__keytemplatet__ispublic (us_split_fields5 a)) (rec__keystore__interfac__keytemplatet__ispublic (us_split_fields5 b)))) true false))
...
(declare-datatypes () ((keytemplatet__ref (mk_keytemplatet__ref (keytemplatet__content us_rep2)))))
(define-fun keytemplatet__ref___projection ((a keytemplatet__ref)) us_rep2 (keytemplatet__content a))
...
(assert (forall ((a (Array Int Bool))) (forall ((first2 Int)) (! (= (slide1 a first2 first2) a) :pattern ((slide1 a first2 first2))))))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq5 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_int2 (select a (+ i 1))) (to_int2 (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq5 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_int2 (select b (+ i 1))) (to_int2 (select a (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(declare-datatypes () ((t114b__ref (mk_t114b__ref (t114b__content integer)))))
(define-fun t114b__ref___projection ((a t114b__ref)) integer (t114b__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t115b__ref (mk_t115b__ref (t115b__content us_t1)))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1104 us_void_param) 1)) 73) (= (to_rep (select (temp___String_Literal_1104 us_void_param) 2)) 110)) (= (to_rep (select (temp___String_Literal_1104 us_void_param) 3)) 105)) (= (to_rep (select (temp___String_Literal_1104 us_void_param) 4)) 116)) (= (to_rep (select (temp___String_Literal_1104 us_void_param) 5)) 105)) (= (to_rep (select (temp___String_Literal_1104 us_void_param) 6)) 97)) (= (to_rep (select (temp___String_Literal_1104 us_void_param) 7)) 108)) (= (to_rep (select (temp___String_Literal_1104 us_void_param) 8)) 105)) (= (to_rep (select (temp___String_Literal_1104 us_void_param) 9)) 122)) (= (to_rep (select (temp___String_Literal_1104 us_void_param) 10)) 101)) :pattern ((temp___String_Literal_1104 us_void_param)))))
(declare-fun temp___String_Literal_1114 (tuple0) (Array Int character))
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1114 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 22)) 105)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 23)) 110)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 24)) 32)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 25)) 73)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 26)) 110)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 27)) 105)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 28)) 116)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 29)) 105)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 30)) 97)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 31)) 108)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 32)) 105)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 33)) 122)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 34)) 101)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 35)) 32)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 36)) 58)) (= (to_rep (select (temp___String_Literal_1114 us_void_param) 37)) 32)) :pattern ((temp___String_Literal_1114 us_void_param)))))
...
(assert (forall ((temp___139 Int)) (forall ((temp___140 Int)) (= (select (cryptotypes__blankname__aggregate_def temp___139) temp___140) (of_rep temp___139)))))
...
(assert (= nullissuer (mk___rep (mk___split_fields (of_rep4 0) (of_rep3 0) blankname))))
...
(assert (= (mk___rep (mk___split_fields temp___1127 temp___11271 temp___11272)) nullissuer))
...
(assert (= result (mk___split_fields__ref2 (mk___split_fields2 theprivatekey__split_fields (mk___rep (mk___split_fields theprivatekey__split_fields1 theprivatekey__split_fields2 theprivatekey__split_fields3)) theprivatekey__split_fields4 theprivatekey__split_fields5 theprivatekey__split_fields6))))
(assert (= theprivatekey__split_fields7 (mk___split_fields2 keystore__init__theprivatekey__assume (mk___rep (mk___split_fields keystore__init__theprivatekey__assume1 keystore__init__theprivatekey__assume2 keystore__init__theprivatekey__assume3)) keystore__init__theprivatekey__assume4 keystore__init__theprivatekey__assume5 keystore__init__theprivatekey__assume6)))
...
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c108b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c108b)))))) (= o15 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c108b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c108b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c108b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c108b))))))) (= o15 0)))
...
(assert (= keystore__init__B112b__thestring__assume (mk___t (concat1 (temp___String_Literal_1114 Tuple0) 1 37 (elts (to_string (attr__ATTRIBUTE_IMAGE9 c108b))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE9 c108b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE9 c108b)))))) (mk 1 o20))))
...
(assert (= temp___1108 (mk___t1 (slide (elts thestring) (to_rep1 (first (rt thestring))) 1) (mk1 1 (length thestring)))))
(assert (and (= temp___1110 (length thestring)) (in_range1 (length thestring))))
(assert (<= 1 temp___1110))
(assert (not (<= 1 1)))
(check-sat)
(exit)
