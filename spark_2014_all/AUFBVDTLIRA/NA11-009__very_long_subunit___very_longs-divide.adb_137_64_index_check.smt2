...
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1322) (<= temp___1322 (to_rep2 (last3 u__split_fields1)))))
...
(assert (not (<= (to_rep2 (first2 u__split_fields1)) temp___1327)))
(check-sat)
(exit)
