...
(define-fun bool_eq ((a (Array Int stream_element)) (a__first Int) (a__last Int) (b (Array Int stream_element)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_154 Int)) (=> (and (<= a__first temp___idx_154) (<= temp___idx_154 a__last)) (= (to_rep2 (select a temp___idx_154)) (to_rep2 (select b (+ (- b__first a__first) temp___idx_154))))))) true false))
...
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep3 (select a temp___idx_91)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_91)))))))))))
...
(define-fun default_initial_assumption ((temp___expr_200 us_rep) (temp___skip_top_level_201 Bool)) Bool (and (= (attr__tag temp___expr_200) us_tag) (and (= (to_rep (rec__fixed_stream__object__width (us_split_fields1 temp___expr_200))) 0) (= (rec__fixed_stream__object__name (us_split_fields1 temp___expr_200)) (temp___202 0)))))
...
(define-fun dynamic_invariant1 ((temp___expr_74 Int) (temp___is_init_70 Bool) (temp___skip_constant_71 Bool) (temp___do_toplevel_72 Bool) (temp___do_typ_inv_73 Bool)) Bool (=> (or (= temp___is_init_70 true) (<= 0 255)) (in_range4 temp___expr_74)))
...
(assert (forall ((temp___288 (_ BitVec 8))) (forall ((temp___289 Int) (temp___290 Int)) (let ((temp___287 (fixed_stream__null_string__value__aggregate_def temp___288 temp___289 temp___290))) (=> (dynamic_invariant3 temp___288 true true true true) (and (=> (dynamic_property (- 9223372036854775808) 9223372036854775807 temp___289 temp___290) (and (= (first5 temp___287) temp___289) (= (last5 temp___287) temp___290))) (forall ((temp___291 Int)) (= (to_rep2 (select (to_array2 temp___287) temp___291)) temp___288))))))))
(assert (forall ((temp___204 Int)) (=> (dynamic_invariant1 temp___204 true true true true) (forall ((temp___205 Int)) (= (to_rep3 (select (temp___202 temp___204) temp___205)) temp___204)))))
(define-fun dynamic_invariant4 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range3 temp___expr_173)))
...
(assert (= (to_rep1 (first4 (rt2 (fixed_stream__null_string__value__aggregate_def #x00 1 (to_rep (rec__fixed_stream__object__width (us_split_fields1 this))))))) 1))
(assert (= (to_rep1 (last4 (rt2 (fixed_stream__null_string__value__aggregate_def #x00 1 (to_rep (rec__fixed_stream__object__width (us_split_fields1 this))))))) (to_rep (rec__fixed_stream__object__width (us_split_fields1 this)))))
...
(assert (= (ite (<= (to_rep1 (first4 temp___2931)) (to_rep1 (last4 temp___2931))) (+ (- (to_rep1 (last4 temp___2931)) (to_rep1 (first4 temp___2931))) 1) 0) (ite (<= 1 (to_rep (rec__fixed_stream__object__width (us_split_fields1 this)))) (+ (- (to_rep (rec__fixed_stream__object__width (us_split_fields1 this))) 1) 1) 0)))
(assert (= temp___293 fixed_stream__null_string__value__assume))
(assert (= (mk1 (to_rep1 (first4 temp___2931)) (to_rep1 (last4 temp___2931))) fixed_stream__null_string__value__assume1))
