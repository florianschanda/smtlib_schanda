...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep (rec__fixed_stream__object__width (us_split_fields1 a))) (to_rep (rec__fixed_stream__object__width (us_split_fields1 b)))) (= (bool_eq (rec__fixed_stream__object__name (us_split_fields1 a)) 1 20 (rec__fixed_stream__object__name (us_split_fields1 b)) 1 20) true)) true false))
...
(define-fun default_initial_assumption ((temp___expr_200 us_rep) (temp___skip_top_level_201 Bool)) Bool (and (= (attr__tag temp___expr_200) us_tag) (and (= (to_rep (rec__fixed_stream__object__width (us_split_fields1 temp___expr_200))) 0) (= (rec__fixed_stream__object__name (us_split_fields1 temp___expr_200)) (temp_____aggregate_def_202 0)))))
...
(define-fun to_rep2 ((x tstream_element_offsetB)) Int (tstream_element_offsetBqtint x))
...
(assert (forall ((x tstream_element_offsetB)) (! (in_range3 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((a (Array Int stream_element))) (forall ((first Int)) (! (= (slide1 a first first) a) :pattern ((slide1 a first first))))))
...
(declare-fun object__size2 ((Array Int stream_element)) Int)
(declare-const value__component__size1 Int)
(declare-fun object__component__size1 ((Array Int stream_element)) Int)
(declare-const value__alignment2 Int)
(declare-fun object__alignment2 ((Array Int stream_element)) Int)
(assert (<= 0 value__size2))
(assert (forall ((a (Array Int stream_element))) (<= 0 (object__size2 a))))
(assert (<= 0 value__component__size1))
(assert (forall ((a (Array Int stream_element))) (<= 0 (object__component__size1 a))))
(assert (<= 0 value__alignment2))
(assert (forall ((a (Array Int stream_element))) (<= 0 (object__alignment2 a))))
...
(define-fun bool_eq4 ((x us_t1) (y us_t1)) Bool (bool_eq2 (elts1 x) (to_rep2 (first2 (rt1 x))) (to_rep2 (last2 (rt1 x))) (elts1 y) (to_rep2 (first2 (rt1 y))) (to_rep2 (last2 (rt1 y)))))
...
(define-fun bool_eq5 ((x us_t2) (y us_t2)) Bool (bool_eq2 (elts2 x) (to_rep2 (first4 (rt2 x))) (to_rep2 (last4 (rt2 x))) (elts2 y) (to_rep2 (first4 (rt2 y))) (to_rep2 (last4 (rt2 y)))))
...
(define-fun dynamic_invariant3 ((temp___expr_166 (_ BitVec 8)) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool true)
(assert (forall ((temp___288 (_ BitVec 8))) (forall ((temp___289 Int) (temp___290 Int)) (let ((temp___287 (fixed_stream__null_string__value__aggregate_def temp___288 temp___289 temp___290))) (=> (dynamic_invariant3 temp___288 true true true true) (and (=> (dynamic_property (- 9223372036854775808) 9223372036854775807 temp___289 temp___290) (and (= (first5 temp___287) temp___289) (= (last5 temp___287) temp___290))) (forall ((temp___291 Int)) (= (to_rep3 (select (to_array2 temp___287) temp___291)) temp___288))))))))
(assert (forall ((temp___204 Int)) (=> (dynamic_invariant1 temp___204 true true true true) (forall ((temp___205 Int)) (= (to_rep1 (select (temp_____aggregate_def_202 temp___204) temp___205)) temp___204)))))
(define-fun dynamic_invariant4 ((temp___expr_173 Int) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (or (= temp___is_init_169 true) (<= (- 9223372036854775808) 9223372036854775807)) (in_range4 temp___expr_173)))
(define-fun dynamic_invariant5 ((temp___expr_187 us_t) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool) (temp___do_typ_inv_186 Bool)) Bool (=> (not (= temp___skip_constant_184 true)) (dynamic_property (- 9223372036854775808) 9223372036854775807 (first1 temp___expr_187) (last1 temp___expr_187))))
(define-fun dynamic_invariant6 ((temp___expr_259 us_t1) (temp___is_init_255 Bool) (temp___skip_constant_256 Bool) (temp___do_toplevel_257 Bool) (temp___do_typ_inv_258 Bool)) Bool (=> (not (= temp___skip_constant_256 true)) (and (dynamic_property2 1 (to_rep (rec__fixed_stream__object__width (us_split_fields1 this))) (first3 temp___expr_259) (last3 temp___expr_259)) (and (= (first3 temp___expr_259) 1) (= (last3 temp___expr_259) (to_rep (rec__fixed_stream__object__width (us_split_fields1 this))))))))
...
(declare-const temp___293 (Array Int stream_element))
(declare-const temp___2931 t2)
...
(assert (= (to_rep2 (first4 (rt2 (fixed_stream__null_string__value__aggregate_def #x00 1 (to_rep (rec__fixed_stream__object__width (us_split_fields1 this))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (fixed_stream__null_string__value__aggregate_def #x00 1 (to_rep (rec__fixed_stream__object__width (us_split_fields1 this))))))) (to_rep (rec__fixed_stream__object__width (us_split_fields1 this)))))
(assert (= (mk___t2 temp___293 temp___2931) (fixed_stream__null_string__value__aggregate_def #x00 1 (to_rep (rec__fixed_stream__object__width (us_split_fields1 this))))))
(assert (= (ite (<= (to_rep2 (first4 temp___2931)) (to_rep2 (last4 temp___2931))) (+ (- (to_rep2 (last4 temp___2931)) (to_rep2 (first4 temp___2931))) 1) 0) (ite (<= 1 (to_rep (rec__fixed_stream__object__width (us_split_fields1 this)))) (+ (- (to_rep (rec__fixed_stream__object__width (us_split_fields1 this))) 1) 1) 0)))
(assert (= temp___293 fixed_stream__null_string__value__assume))
(assert (= (mk1 (to_rep2 (first4 temp___2931)) (to_rep2 (last4 temp___2931))) fixed_stream__null_string__value__assume1))
(assert (= (mk_map__ref1 result) (mk_map__ref1 value)))
(assert (= value1 fixed_stream__null_string__value__assume))
(assert (= (to_rep2 value__first) (to_rep2 (first2 fixed_stream__null_string__value__assume1))))
(assert (= (to_rep2 value__last) (to_rep2 (last2 fixed_stream__null_string__value__assume1))))
(assert (and (dynamic_property2 1 (to_rep (rec__fixed_stream__object__width (us_split_fields1 this))) (to_rep2 value__first) (to_rep2 value__last)) (and (= (to_rep2 value__first) 1) (= (to_rep2 value__last) (to_rep (rec__fixed_stream__object__width (us_split_fields1 this)))))))
...
(assert (= (mk (to_rep2 value__first) (to_rep2 value__last)) fixed_stream__null_string__result3))
...
(assert (and (= o (elements this)) (and (in_range1 o) (= o (to_rep (rec__fixed_stream__object__width (us_split_fields1 this)))))))
(assert (not (in_range (length (mk___t fixed_stream__null_string__result8 fixed_stream__null_string__result9)))))
(check-sat)
(exit)
