...
(assert (= temp___1097 (- o12 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1097) (<= temp___1097 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
...
(assert (= temp___1099 (- o17 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1099)))
(check-sat)
(exit)
