...
(assert (= o2 temp___4540))
(assert (= (mk2 1 r9b) temp___45401))
(assert (= (ite (<= (to_rep1 (first4 temp___45401)) (to_rep1 (last4 temp___45401))) (+ (- (to_rep1 (last4 temp___45401)) (to_rep1 (first4 temp___45401))) 1) 0) (ite (<= (to_rep1 frame__first) r6b) (+ (- r6b (to_rep1 frame__first)) 1) 0)))
(assert (= (slide temp___4540 (to_rep1 (first4 temp___45401)) (to_rep1 frame__first)) temp___4541))
(assert (= (mk1 (to_rep1 frame__first) r6b) temp___45411))
