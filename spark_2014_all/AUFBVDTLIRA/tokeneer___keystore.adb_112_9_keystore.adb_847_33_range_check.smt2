...
(assert (=> (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b)))))) (= o10 (+ (- (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b))))) (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b)))))) 1))))
(assert (=> (not (<= (to_rep1 (first (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b))))) (to_rep1 (last (rt (to_string (attr__ATTRIBUTE_IMAGE12 c149b))))))) (= o10 0)))
