...
(assert (= (= o10 true) (forall ((k Int)) (=> (and (<= i2 k) (<= k a_last)) (= (to_rep1 (select a1 k)) (to_rep1 (select a k)))))))
(assert (= o7 (num_of_boolean carry2)))
...
(assert (= o6 (oexpon o3 o5)))
(assert (= o8 (omultiply o6 o7)))
(assert (and (= o (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o1 o) (in_range2 o)))
(assert (= o2 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first o1)))
(assert (= o9 (osubtract o2 o8)))
