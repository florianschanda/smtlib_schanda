...
(define-fun dynamic_invariant ((temp___expr_352 Int) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool) (temp___do_typ_inv_351 Bool)) Bool (=> (or (= temp___is_init_348 true) (<= 0 6)) (in_range3 temp___expr_352)))
...
(assert (in_range3 subject_id))
(assert (in_range4 event_nr))
(assert (forall ((subject Int)) (=> (and (<= 0 subject) (<= subject 6)) (forall ((event Int)) (=> (and (<= 0 event) (<= event 31)) (not (= (to_rep (rec__skp__subjects__event_entry_type__dst_subject (us_split_fields1 (select (rec__skp__subjects__subject_spec_type__event_table (us_split_fields7 (select subject_specs subject))) event)))) subject)))))))
