...
(assert (<= r86b i8))
(assert (<= i8 r87b))
(assert (and (<= 1 begidx13) (bvule tmpval9 #x7FFF)))
(assert (and (=> (<= r86b r87b) (dynamic_property1 r86b r87b i9)) (and (<= r86b i9) (<= i9 r87b))))
(assert (= result15 (mk_t__ref digitval8)))
(assert (= digitval9 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i9))) #x0030)))
(assert (= result16 (mk_t__ref tmpval9)))
(assert (= tmpval10 (bvadd (bvmul #x000A tmpval9) digitval9)))
(assert (not (bvugt tmpval10 #x7FFF)))
(assert (not (= i9 r87b)))
(assert (= result17 (mk_int__ref i9)))
(assert (= i10 (+ i9 1)))
(assert (= i11 (mk_int__ref i10)))
(assert (= tmpval11 (mk_t__ref tmpval10)))
(assert (= digitval10 (mk_t__ref digitval9)))
(assert (= i12 i10))
(assert (= tmpval12 tmpval10))
(assert (= digitval11 digitval9))
