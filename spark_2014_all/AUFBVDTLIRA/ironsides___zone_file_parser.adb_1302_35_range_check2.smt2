...
(assert (= begidx14 o3))
(assert (and (and (and (and (<= begidx15 endidx10) (<= begidx15 zlength)) (<= endidx10 zlength)) (=> (= foundtype10 1) (forall ((i14 Int)) (=> (and (<= begidx15 i14) (<= i14 endidx10)) (and (<= 48 (to_rep (select zonefileline i14))) (<= (to_rep (select zonefileline i14)) 57)))))) (and (and (in_range4 begidx15) (in_range4 endidx10)) (in_range3 foundtype10))))
