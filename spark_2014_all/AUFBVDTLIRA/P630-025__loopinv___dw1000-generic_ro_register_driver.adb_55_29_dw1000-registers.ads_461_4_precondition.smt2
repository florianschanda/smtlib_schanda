...
(define-fun dynamic_invariant ((temp___expr_5508 us_t1) (temp___is_init_5505 Bool) (temp___skip_constant_5506 Bool) (temp___do_toplevel_5507 Bool)) Bool (=> (not (= temp___skip_constant_5506 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5508) (last3 temp___expr_5508)) (and (= (first3 temp___expr_5508) 1) (= (last3 temp___expr_5508) 2)))))
