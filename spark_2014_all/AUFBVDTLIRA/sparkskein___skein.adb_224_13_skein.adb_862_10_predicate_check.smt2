...
(define-fun dynamic_invariant6 ((temp___expr_1271 (_ BitVec 64)) (temp___is_init_1268 Bool) (temp___skip_constant_1269 Bool) (temp___do_toplevel_1270 Bool)) Bool (=> (or (= temp___is_init_1268 true) (bvule ((_ int2bv 64) 1) ((_ int2bv 64) 2305843009213693951))) (in_range9 temp___expr_1271)))
...
(define-fun dynamic_invariant7 ((temp___expr_1283 (_ BitVec 64)) (temp___is_init_1280 Bool) (temp___skip_constant_1281 Bool) (temp___do_toplevel_1282 Bool)) Bool (=> (or (= temp___is_init_1280 true) (bvule ((_ int2bv 64) 1) ((_ int2bv 64) 36028797018963968))) (in_range10 temp___expr_1283)))
...
(assert (forall ((temp___1408 (_ BitVec 8))) (forall ((temp___1409 (_ BitVec 64)) (temp___1410 (_ BitVec 64))) (let ((temp___1407 (temp___1406 temp___1408 temp___1409 temp___1410))) (and (=> (dynamic_property ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551615) temp___1409 temp___1410) (and (= (first3 temp___1407) temp___1409) (= (last3 temp___1407) temp___1410))) (forall ((temp___1411 (_ BitVec 64))) (= (select (to_array1 temp___1407) temp___1411) (of_rep1 temp___1408))))))))
(declare-fun temp___1428 ((_ BitVec 8)) (Array (_ BitVec 64) byte))
(assert (forall ((temp___1430 (_ BitVec 8))) (forall ((temp___1431 (_ BitVec 64))) (= (select (temp___1428 temp___1430) temp___1431) (of_rep1 temp___1430)))))
...
(declare-const temp___1424 u64)
(declare-const temp___14241 u32)
(declare-const temp___14242 u16)
(declare-const temp___14243 u7)
(declare-const temp___14244 Bool)
(declare-const temp___14245 u6)
(declare-const temp___14246 Bool)
(declare-const temp___14247 Bool)
(declare-const temp___14248 hash_bit_length)
(declare-const temp___14249 u64)
(declare-const temp___142410 (Array (_ BitVec 64) u64))
(declare-const temp___142411 (Array (_ BitVec 64) byte))
...
(declare-const temp___1476 (Array (_ BitVec 64) byte))
...
(assert (= (to_rep (first2 (rt1 (temp___1406 ((_ int2bv 8) 0) (to_rep hash__first) (to_rep hash__last))))) (to_rep hash__first)))
(assert (= (to_rep (last2 (rt1 (temp___1406 ((_ int2bv 8) 0) (to_rep hash__first) (to_rep hash__last))))) (to_rep hash__last)))
(assert (= (mk___t1 temp___1413 temp___14131) (temp___1406 ((_ int2bv 8) 0) (to_rep hash__first) (to_rep hash__last))))
(assert (= temp___1413 temp___1414))
(assert (= (mk (to_rep (first2 temp___14131)) (to_rep (last2 temp___14131))) temp___14141))
(assert (= (ite (<= (bv2nat (to_rep (first temp___14141))) (bv2nat (to_rep (last temp___14141)))) (+ (- (bv2nat (to_rep (last temp___14141))) (bv2nat (to_rep (first temp___14141)))) 1) 0) (ite (<= (bv2nat (to_rep hash__first)) (bv2nat (to_rep hash__last))) (+ (- (bv2nat (to_rep hash__last)) (bv2nat (to_rep hash__first))) 1) 0)))
(assert (= (mk___t temp___1415 temp___14151) (mk___t temp___1414 temp___14141)))
(assert (= o (slide temp___1415 (to_rep (first temp___14151)) (to_rep hash__first))))
...
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (= result3 i10)))
...
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))) (= local_ctx__split_fields13 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields temp___1424 temp___14241 temp___14242 temp___14243 temp___14244 temp___14245 temp___14246 temp___14247)) temp___14248 temp___14249)) temp___142410 temp___142411)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))) (and (and (and (= (rec__skein__skein_512_context__h local_ctx__split_fields14) (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields temp___1424 temp___14241 temp___14242 temp___14243 temp___14244 temp___14245 temp___14246 temp___14247)) temp___14248 temp___14249))) (= (rec__skein__skein_512_context__x local_ctx__split_fields14) temp___142410)) (forall ((temp___1425 (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) temp___1425) (bvule temp___1425 ((_ int2bv 64) 63))) (=> (bvule i3 temp___1425) (= (select (rec__skein__skein_512_context__b local_ctx__split_fields14) temp___1425) (select temp___142411 temp___1425)))))) (and (bvule r250b i3) (bvule i3 ((_ int2bv 64) 63)))))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))) (= (to_rep1 o1) ((_ int2bv 8) 0)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))) (= temp___1421 (store (rec__skein__skein_512_context__b local_ctx__split_fields14) i3 o1)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))) (dynamic_predicate temp___1421))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))) (= o2 temp___1421))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))) (= o3 (mk___split_fields2 (rec__skein__skein_512_context__h local_ctx__split_fields14) (rec__skein__skein_512_context__x local_ctx__split_fields14) o2)))))
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))) (= temp___1423 (mk___rep2 o3)))))
...
(assert (=> (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)) (=> (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63))) (= local_ctx__split_fields15 (us_split_fields5 temp___1423)))))
...
(assert (=> (not (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64))) (= i8 i10)))
...
(assert (dynamic_predicate (temp___1428 ((_ int2bv 8) 0))))
(assert (= o5 (temp___1428 ((_ int2bv 8) 0))))
...
(assert (= temp___1434 (mk___rep2 o6)))
(assert (= result8 (mk___split_fields__ref2 local_ctx__split_fields22)))
(assert (= local_ctx__split_fields23 (us_split_fields5 temp___1434)))
...
(assert (= (to_rep1 o7) ((_ extract 7 0) (bvand c256b ((_ int2bv 64) 255)))))
(assert (= temp___1436 (store (rec__skein__skein_512_context__b local_ctx__split_fields24) ((_ int2bv 64) 0) o7)))
(assert (dynamic_predicate temp___1436))
(assert (= o8 temp___1436))
...
(assert (= temp___1438 (mk___rep2 o9)))
(assert (= result12 (mk___split_fields__ref2 local_ctx__split_fields24)))
(assert (= local_ctx__split_fields25 (us_split_fields5 temp___1438)))
(assert (= (to_rep1 o10) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 8)) ((_ int2bv 64) 255)))))
(assert (= temp___1440 (store (rec__skein__skein_512_context__b local_ctx__split_fields25) ((_ int2bv 64) 1) o10)))
(assert (dynamic_predicate temp___1440))
(assert (= o11 temp___1440))
...
(assert (= temp___1442 (mk___rep2 o12)))
(assert (= result13 (mk___split_fields__ref2 local_ctx__split_fields25)))
(assert (= local_ctx__split_fields26 (us_split_fields5 temp___1442)))
(assert (= (to_rep1 o13) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 16)) ((_ int2bv 64) 255)))))
(assert (= temp___1444 (store (rec__skein__skein_512_context__b local_ctx__split_fields26) ((_ int2bv 64) 2) o13)))
(assert (dynamic_predicate temp___1444))
(assert (= o14 temp___1444))
...
(assert (= temp___1446 (mk___rep2 o15)))
(assert (= result14 (mk___split_fields__ref2 local_ctx__split_fields26)))
(assert (= local_ctx__split_fields27 (us_split_fields5 temp___1446)))
(assert (= (to_rep1 o16) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 24)) ((_ int2bv 64) 255)))))
(assert (= temp___1448 (store (rec__skein__skein_512_context__b local_ctx__split_fields27) ((_ int2bv 64) 3) o16)))
(assert (dynamic_predicate temp___1448))
(assert (= o17 temp___1448))
(assert (= o18 (mk___split_fields2 (rec__skein__skein_512_context__h local_ctx__split_fields27) (rec__skein__skein_512_context__x local_ctx__split_fields27) o17)))
(assert (= temp___1450 (mk___rep2 o18)))
(assert (= result15 (mk___split_fields__ref2 local_ctx__split_fields27)))
(assert (= local_ctx__split_fields28 (us_split_fields5 temp___1450)))
(assert (= (to_rep1 o19) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 32)) ((_ int2bv 64) 255)))))
(assert (= temp___1452 (store (rec__skein__skein_512_context__b local_ctx__split_fields28) ((_ int2bv 64) 4) o19)))
(assert (dynamic_predicate temp___1452))
(assert (= o20 temp___1452))
(assert (= o21 (mk___split_fields2 (rec__skein__skein_512_context__h local_ctx__split_fields28) (rec__skein__skein_512_context__x local_ctx__split_fields28) o20)))
(assert (= temp___1454 (mk___rep2 o21)))
(assert (= result16 (mk___split_fields__ref2 local_ctx__split_fields28)))
(assert (= local_ctx__split_fields29 (us_split_fields5 temp___1454)))
(assert (= (to_rep1 o22) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 40)) ((_ int2bv 64) 255)))))
(assert (= temp___1456 (store (rec__skein__skein_512_context__b local_ctx__split_fields29) ((_ int2bv 64) 5) o22)))
(assert (dynamic_predicate temp___1456))
(assert (= o23 temp___1456))
(assert (= o24 (mk___split_fields2 (rec__skein__skein_512_context__h local_ctx__split_fields29) (rec__skein__skein_512_context__x local_ctx__split_fields29) o23)))
(assert (= temp___1458 (mk___rep2 o24)))
(assert (= result17 (mk___split_fields__ref2 local_ctx__split_fields29)))
(assert (= local_ctx__split_fields30 (us_split_fields5 temp___1458)))
(assert (= (to_rep1 o25) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 48)) ((_ int2bv 64) 255)))))
(assert (= temp___1460 (store (rec__skein__skein_512_context__b local_ctx__split_fields30) ((_ int2bv 64) 6) o25)))
(assert (dynamic_predicate temp___1460))
(assert (= o26 temp___1460))
(assert (= o27 (mk___split_fields2 (rec__skein__skein_512_context__h local_ctx__split_fields30) (rec__skein__skein_512_context__x local_ctx__split_fields30) o26)))
(assert (= temp___1462 (mk___rep2 o27)))
(assert (= result18 (mk___split_fields__ref2 local_ctx__split_fields30)))
(assert (= local_ctx__split_fields31 (us_split_fields5 temp___1462)))
(assert (= (to_rep1 o28) ((_ extract 7 0) (bvand (bvlshr c256b ((_ int2bv 64) 56)) ((_ int2bv 64) 255)))))
(assert (= temp___1464 (store (rec__skein__skein_512_context__b local_ctx__split_fields31) ((_ int2bv 64) 7) o28)))
(assert (dynamic_predicate temp___1464))
(assert (= o29 temp___1464))
(assert (= o30 (mk___split_fields2 (rec__skein__skein_512_context__h local_ctx__split_fields31) (rec__skein__skein_512_context__x local_ctx__split_fields31) o29)))
(assert (= temp___1466 (mk___rep2 o30)))
(assert (= result19 (mk___split_fields__ref2 local_ctx__split_fields31)))
(assert (= local_ctx__split_fields32 (us_split_fields5 temp___1466)))
(assert (in_range8 c258b))
(assert (= (to_rep7 o31) ((_ int2bv 8) 63)))
(assert (= (to_rep6 o32) ((_ int2bv 8) 0)))
(assert (= (to_rep2 o33) ((_ int2bv 16) 0)))
(assert (= (to_rep3 o34) ((_ int2bv 32) 0)))
(assert (= (to_rep4 o35) ((_ int2bv 64) 0)))
(assert (= o36 (mk___split_fields o35 o34 o33 o32 (of_int 0) o31 (of_int 1) (of_int 1))))
(assert (= o37 (mk___rep o36)))
(assert (= o38 (mk___split_fields1 o37 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields32))) (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields32))))))
(assert (= o39 (mk___rep1 o38)))
(assert (= o40 (mk___split_fields2 o39 (rec__skein__skein_512_context__x local_ctx__split_fields32) (rec__skein__skein_512_context__b local_ctx__split_fields32))))
(assert (= temp___1469 (mk___rep2 o40)))
(assert (= result20 (mk___split_fields__ref2 local_ctx__split_fields32)))
(assert (= local_ctx__split_fields33 (us_split_fields5 temp___1469)))
(assert (= (to_rep4 o41) ((_ int2bv 64) 0)))
(assert (= o42 (mk___split_fields1 (rec__skein__context_header__tweak_words (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields33))) (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields33))) o41)))
(assert (= o43 (mk___rep1 o42)))
(assert (= o44 (mk___split_fields2 o43 (rec__skein__skein_512_context__x local_ctx__split_fields33) (rec__skein__skein_512_context__b local_ctx__split_fields33))))
(assert (= temp___1472 (mk___rep2 o44)))
(assert (= result21 (mk___split_fields__ref2 local_ctx__split_fields33)))
(assert (= local_ctx__split_fields34 (us_split_fields5 temp___1472)))
...
(assert (= result23 (mk_t__ref3 n)))
(assert (= n2 (bvsub byte_count1 (bvmul blocks_done2 ((_ int2bv 64) 64)))))
(assert (=> (bvuge n2 ((_ int2bv 64) 64)) (= result24 (mk_t__ref3 n2))))
(assert (=> (bvuge n2 ((_ int2bv 64) 64)) (= n3 ((_ int2bv 64) 64))))
(assert (=> (bvuge n2 ((_ int2bv 64) 64)) (= n4 (mk_t__ref3 n3))))
(assert (=> (bvuge n2 ((_ int2bv 64) 64)) (= n5 n3)))
(assert (=> (not (bvuge n2 ((_ int2bv 64) 64))) (= n4 (mk_t__ref3 n2))))
(assert (=> (not (bvuge n2 ((_ int2bv 64) 64))) (= n5 n2)))
(assert (= (bvmul blocks_done2 ((_ int2bv 64) 64)) c264b))
(assert (= (rec__skein__skein_512_context__x local_ctx__split_fields35) c266b))
(assert (= (t__content3 n4) c267b))
(assert (bvuge c267b ((_ int2bv 64) 1)))
(assert (= result25 (mk_t__ref3 n1)))
(assert (= n6 ((_ int2bv 64) 0)))
(assert (bvule ((_ int2bv 64) 0) n6))
(assert (bvule n6 (bvsub c267b ((_ int2bv 64) 1))))
(assert (and (bvule ((_ int2bv 64) 0) n7) (bvule n7 (bvsub c267b ((_ int2bv 64) 1)))))
(assert (and (= o47 (bv2nat (bvmul ((_ int2bv 64) 8) (bvand n7 ((_ int2bv 64) 7))))) (in_range1 (bv2nat (bvmul ((_ int2bv 64) 8) (bvand n7 ((_ int2bv 64) 7)))))))
(assert (= o48 ((_ int2bv 64) o47)))
(assert (and (bvule ((_ int2bv 64) 0) (bvudiv n7 ((_ int2bv 64) 8))) (bvule (bvudiv n7 ((_ int2bv 64) 8)) ((_ int2bv 64) 7))))
(assert (= o45 (bvudiv n7 ((_ int2bv 64) 8))))
(assert (= o46 (select (rec__skein__skein_512_context__x local_ctx__split_fields35) o45)))
(assert (= o49 (to_rep4 o46)))
(assert (= o50 (bvlshr o49 o48)))
(assert (= o51 (bvand o50 ((_ int2bv 64) 255))))
(assert (= o52 o51))
(assert (= o53 ((_ extract 7 0) o52)))
(assert (= (to_rep1 o54) o53))
(assert (and (bvule (to_rep hash__first) (bvadd c264b n7)) (bvule (bvadd c264b n7) (to_rep hash__last))))
(assert (= o55 (bvadd c264b n7)))
(assert (= temp___1476 (store hash2 o55 o54)))
