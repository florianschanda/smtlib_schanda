...
(assert (<= 1 i1))
(assert (<= i1 r124b))
(assert (and (and (dynamic_invariant1 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true) (forall ((temp___1241 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1241) (<= temp___1241 (to_rep1 (last number__split_fields3)))) (=> (<= temp___1241 i2) (= (select number__split_fields2 temp___1241) (select number__split_fields temp___1241)))))) (and (<= 1 i2) (<= i2 r124b))))
