...
(define-fun dynamic_invariant1 ((temp___expr_173 us_t) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool) (temp___do_typ_inv_172 Bool)) Bool (=> (not (= temp___skip_constant_170 true)) (dynamic_property #x0000 #xFFFF (first1 temp___expr_173) (last1 temp___expr_173))))
...
(assert (forall ((f (_ BitVec 16)) (l (_ BitVec 16))) (! (and (= (to_rep1 (first2 (mk1 f l))) f) (= (to_rep1 (last2 (mk1 f l))) l)) :pattern ((mk1 f l)))))
...
(assert (forall ((f (_ BitVec 16)) (l (_ BitVec 16))) (! (and (= (to_rep1 (first4 (mk2 f l))) f) (= (to_rep1 (last4 (mk2 f l))) l)) :pattern ((mk2 f l)))))
...
(assert (forall ((f (_ BitVec 16)) (l (_ BitVec 16))) (! (and (= (to_rep1 (first6 (mk3 f l))) f) (= (to_rep1 (last6 (mk3 f l))) l)) :pattern ((mk3 f l)))))
...
(assert (forall ((r us_rep)) (! (dynamic_invariant1 (to_model r) true false true true) :pattern ((to_model r)))))
(assert (forall ((r us_rep)) (! (= (to_model r) (ite (< 65535 (- (+ (bv2nat (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r)))) 1)) (let ((temp___221 (let ((temp___218 (bvsub (bvsub (bvadd #x0000 ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub #xFFFF (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) #x0001))) (let ((temp___217 #x0000)) (let ((temp___219 (rec__ring_buf__ring_buffer__data (us_split_fields1 r)))) (of_array2 temp___219 temp___217 temp___218)))))) (let ((temp___220 (let ((temp___215 #xFFFF)) (let ((temp___214 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) (let ((temp___216 (rec__ring_buf__ring_buffer__data (us_split_fields1 r)))) (of_array1 temp___216 temp___214 temp___215)))))) (ite (= (length1 temp___220) 0) (of_array (to_array2 temp___221) (first5 temp___221) (last5 temp___221)) (of_array (concat1 (to_array1 temp___220) (first3 temp___220) (last3 temp___220) (to_array2 temp___221) (first5 temp___221) (last5 temp___221)) (first3 temp___220) ((_ int2bv 16) (- (+ (bv2nat (first3 temp___220)) (+ (ite (<= (bv2nat (first3 temp___220)) (bv2nat (last3 temp___220))) (+ (- (bv2nat (last3 temp___220)) (bv2nat (first3 temp___220))) 1) 0) (ite (<= (bv2nat (first5 temp___221)) (bv2nat (last5 temp___221))) (+ (- (bv2nat (last5 temp___221)) (bv2nat (first5 temp___221))) 1) 0))) 1)))))) (let ((temp___225 (let ((temp___223 (bvsub (bvadd (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) #x0001))) (let ((temp___222 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) (let ((temp___224 (rec__ring_buf__ring_buffer__data (us_split_fields1 r)))) (of_array3 temp___224 temp___222 temp___223)))))) (of_array (to_array3 temp___225) (first7 temp___225) (last7 temp___225))))) :pattern ((to_model r)))))
(declare-fun func_head (us_t) Int)
(declare-fun func_head__function_guard (Int us_t) Bool)
(assert (forall ((m us_t)) (! (=> (and (dynamic_invariant1 m true true true true) (< 0 (length m))) (dynamic_invariant (func_head m) true false true true)) :pattern ((func_head m)))))
(assert (forall ((m us_t)) (! (=> (dynamic_invariant1 m true true true true) (= (func_head m) (to_rep (select (to_array m) (first1 m))))) :pattern ((func_head m)))))
...
(assert (forall ((f (_ BitVec 16)) (l (_ BitVec 16))) (! (and (= (to_rep1 (first8 (mk4 f l))) f) (= (to_rep1 (last8 (mk4 f l))) l)) :pattern ((mk4 f l)))))
...
(assert (forall ((m us_t)) (! (=> (and (dynamic_invariant1 m true true true true) (< 0 (length m))) (dynamic_invariant1 (func_pop m) true false true true)) :pattern ((func_pop m)))))
(assert (forall ((m us_t)) (! (=> (dynamic_invariant1 m true true true true) (= (func_pop m) (let ((temp___241 (let ((temp___240 (bvsub (last1 m) #x0001))) (let ((temp___239 (first1 m))) (of_array4 (to_array m) temp___239 temp___240))))) (of_array (to_array4 temp___241) (first9 temp___241) (last9 temp___241))))) :pattern ((func_pop m)))))
...
(define-fun dynamic_invariant3 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 65536)) (in_range2 temp___expr_166)))
...
(declare-const temp___321 (Array (_ BitVec 16) integer))
(declare-const temp___3211 ar_index)
(declare-const temp___3212 length_type)
...
(declare-const temp___323 (Array (_ BitVec 16) integer))
(declare-const temp___3231 ar_index)
(declare-const temp___3232 length_type)
...
(assert (= (to_rep1 o) (bvadd (to_rep1 r__split_fields1) #x0001)))
(assert (= r__split_fields o1))
(assert (= o o2))
(assert (= r__split_fields2 o3))
(assert (= temp___321 o1))
(assert (= temp___3211 o2))
(assert (= temp___3212 o3))
...
(assert (= temp___321 r__split_fields3))
(assert (= temp___3211 r__split_fields4))
(assert (= temp___3212 r__split_fields5))
...
(assert (= o5 o8))
(assert (= temp___323 o6))
(assert (= temp___3231 o7))
(assert (= temp___3232 o8))
(assert (= result4 r__split_fields3))
(assert (= result5 r__split_fields4))
(assert (= result6 r__split_fields5))
(assert (= temp___323 r__split_fields6))
(assert (= temp___3231 r__split_fields7))
(assert (= temp___3232 r__split_fields8))
...
(assert (not (= (let ((temp___331 (func_pop (to_model (mk___rep (mk___split_fields r__split_fields r__split_fields1 r__split_fields2)))))) (let ((temp___330 (to_model (mk___rep (mk___split_fields r__split_fields9 r__split_fields10 r__split_fields11))))) (bool_eq (elts temp___330) (to_rep1 (first (rt temp___330))) (to_rep1 (last (rt temp___330))) (elts temp___331) (to_rep1 (first (rt temp___331))) (to_rep1 (last (rt temp___331)))))) true)))
(check-sat)
(exit)
