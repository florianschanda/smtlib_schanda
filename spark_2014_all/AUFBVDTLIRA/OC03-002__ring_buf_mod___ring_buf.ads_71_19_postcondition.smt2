...
(assert (forall ((x ar_index)) (! (uint_in_range (to_int3 x)) :pattern ((to_int3 x)))))
...
(assert (forall ((a (Array (_ BitVec 16) integer)) (b (Array (_ BitVec 16) integer))) (forall ((a_first (_ BitVec 16)) (a_last (_ BitVec 16)) (b_first (_ BitVec 16)) (b_last (_ BitVec 16))) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 16)) (j (_ BitVec 16))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (< (to_rep (select a (bvadd i #x0001))) (to_rep (select b (bvadd j #x0001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 16) integer)) (b (Array (_ BitVec 16) integer))) (forall ((a_first (_ BitVec 16)) (a_last (_ BitVec 16)) (b_first (_ BitVec 16)) (b_last (_ BitVec 16))) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 16)) (j (_ BitVec 16))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (< (to_rep (select b (bvadd i #x0001))) (to_rep (select a (bvadd j #x0001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(declare-sort t 0)
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (bool_eq (rec__ring_buf__ring_buffer__data (us_split_fields1 a)) ((_ int2bv 16) 0) ((_ int2bv 16) 65535) (rec__ring_buf__ring_buffer__data (us_split_fields1 b)) ((_ int2bv 16) 0) ((_ int2bv 16) 65535)) true) (= (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 a))) (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 b))))) (= (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 a))) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 b))))) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_148 us_t) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (not (= temp___skip_constant_146 true)) (dynamic_property ((_ int2bv 16) 0) ((_ int2bv 16) 65535) (first1 temp___expr_148) (last1 temp___expr_148))))
...
(assert (forall ((m us_t)) (! (=> (and (dynamic_invariant1 m true true true) (< 0 (length m))) (dynamic_invariant1 (func_pop m) true false true)) :pattern ((func_pop m)))))
(assert (forall ((m us_t)) (! (=> (dynamic_invariant1 m true true true) (= (func_pop m) (let ((temp___214 (let ((temp___213 (bvsub (last1 m) ((_ int2bv 16) 1)))) (let ((temp___212 (first1 m))) (of_array4 (to_array m) temp___212 temp___213))))) (of_array (to_array4 temp___214) (first9 temp___214) (last9 temp___214))))) :pattern ((func_pop m)))))
...
(define-fun dynamic_invariant2 ((temp___expr_136 (_ BitVec 16)) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool true)
(define-fun dynamic_invariant3 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 65536)) (in_range2 temp___expr_142)))
...
(assert (= (to_rep1 o) (bvadd (to_rep1 r__split_fields1) ((_ int2bv 16) 1))))
...
(assert (not (= (let ((temp___304 (func_pop (to_model (mk___rep (mk___split_fields r__split_fields r__split_fields1 r__split_fields2)))))) (let ((temp___303 (to_model (mk___rep (mk___split_fields r__split_fields9 r__split_fields10 r__split_fields11))))) (bool_eq (elts temp___303) (to_rep1 (first (rt temp___303))) (to_rep1 (last (rt temp___303))) (elts temp___304) (to_rep1 (first (rt temp___304))) (to_rep1 (last (rt temp___304)))))) true)))
(check-sat)
(exit)
