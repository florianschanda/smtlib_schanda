...
(assert (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j ((_ int2bv 64) 7))) (= (to_rep (select memory (bvadd (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) j))) (to_rep (select mem (bvadd (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) j)))))))
(assert (not (= (hasmem64 mem (bvadd rdi_start (bvmul i1 ((_ int2bv 64) 8))) rax) true)))
(check-sat)
(exit)
