...
(assert (forall ((j (_ BitVec 64))) (=> (and (bvule #x0000000000000000 j) (bvule j #x0000000000000007)) (= (to_rep (select memory (bvadd (bvadd rdi_start (bvmul i1 #x0000000000000008)) j))) (to_rep (select mem (bvadd (bvadd rdi_start (bvmul i1 #x0000000000000008)) j)))))))
(assert (not (= (hasmem64 mem (bvadd rdi_start (bvmul i1 #x0000000000000008)) rax) true)))
(check-sat)
(exit)
