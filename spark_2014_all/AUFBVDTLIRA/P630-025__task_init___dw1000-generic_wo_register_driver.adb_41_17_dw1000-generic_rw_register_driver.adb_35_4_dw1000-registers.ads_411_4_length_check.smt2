...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__drx_pretoc_type__drx_pretoc bits_16)))))
(define-fun us_split_fields_DRX_PRETOC__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__drx_pretoc_type__drx_pretoc a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___51__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___51__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__drx_pretoc_type__drx_pretoc (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__drx_pretoc_type__drx_pretoc (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__drx_pretoc_type__drx_pretoc__first__bit Int)
(declare-const dw1000__register_types__drx_pretoc_type__drx_pretoc__last__bit Int)
(declare-const dw1000__register_types__drx_pretoc_type__drx_pretoc__position Int)
(assert (<= 0 dw1000__register_types__drx_pretoc_type__drx_pretoc__first__bit))
(assert (< dw1000__register_types__drx_pretoc_type__drx_pretoc__first__bit dw1000__register_types__drx_pretoc_type__drx_pretoc__last__bit))
(assert (<= 0 dw1000__register_types__drx_pretoc_type__drx_pretoc__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((drx_pretoc_type__ref (mk_drx_pretoc_type__ref (drx_pretoc_type__content us_rep)))))
(define-fun drx_pretoc_type__ref___projection ((a drx_pretoc_type__ref)) us_rep (drx_pretoc_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___120__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___85__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___85__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5053 us_t1) (temp___is_init_5050 Bool) (temp___skip_constant_5051 Bool) (temp___do_toplevel_5052 Bool)) Bool (=> (not (= temp___skip_constant_5051 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5053) (last3 temp___expr_5053)) (and (= (first3 temp___expr_5053) 1) (= (last3 temp___expr_5053) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___36__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___36__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_5069 us_t2) (temp___is_init_5066 Bool) (temp___skip_constant_5067 Bool) (temp___do_toplevel_5068 Bool)) Bool (=> (not (= temp___skip_constant_5067 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5069) (last5 temp___expr_5069)) (and (= (first5 temp___expr_5069) 1) (= (last5 temp___expr_5069) 2)))))
...
(declare-const temp___7970 (Array Int bits_8))
(declare-const temp___79701 t2)
(declare-const temp___7971 (Array Int bits_8))
(declare-const temp___79711 t1)
(define-fun temp___79702 () us_t2 (mk___t2 temp___7970 temp___79701))
...
(assert (and (= temp___79702 (register_to_bytes reg)) (dynamic_invariant1 temp___79702 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___79701)) (to_rep (last4 temp___79701))) (+ (- (to_rep (last4 temp___79701)) (to_rep (first4 temp___79701))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___7970 temp___7971))
(assert (= (mk1 (to_rep (first4 temp___79701)) (to_rep (last4 temp___79701))) temp___79711))
(assert (not (= (ite (<= (to_rep (first2 temp___79711)) (to_rep (last2 temp___79711))) (+ (- (to_rep (last2 temp___79711)) (to_rep (first2 temp___79711))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
