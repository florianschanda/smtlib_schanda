...
(define-fun dynamic_invariant ((temp___expr_5702 us_t1) (temp___is_init_5699 Bool) (temp___skip_constant_5700 Bool) (temp___do_toplevel_5701 Bool)) Bool (=> (not (= temp___skip_constant_5700 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5702) (last3 temp___expr_5702)) (and (= (first3 temp___expr_5702) 1) (= (last3 temp___expr_5702) 1)))))
