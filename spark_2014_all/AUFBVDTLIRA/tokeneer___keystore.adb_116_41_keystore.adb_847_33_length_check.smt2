...
(assert (and (= temp___1193 (length thestring)) (in_range1 (length thestring))))
(assert (=> (<= 1 temp___1193) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1193) (<= temp___1193 150)))))
(assert (= o17 result__1))
(assert (= temp___1194 (mk___t1 o17 (mk1 1 temp___1193))))
(assert (not (= (ite (<= (to_rep1 (first2 (rt1 temp___1191))) (to_rep1 (last2 (rt1 temp___1191)))) (+ (- (to_rep1 (last2 (rt1 temp___1191))) (to_rep1 (first2 (rt1 temp___1191)))) 1) 0) (ite (<= (to_rep1 (first2 (rt1 temp___1194))) (to_rep1 (last2 (rt1 temp___1194)))) (+ (- (to_rep1 (last2 (rt1 temp___1194))) (to_rep1 (first2 (rt1 temp___1194)))) 1) 0))))
(check-sat)
(exit)
