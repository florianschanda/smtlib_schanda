...
(define-fun dynamic_invariant ((temp___expr_2159 us_t1) (temp___is_init_2155 Bool) (temp___skip_constant_2156 Bool) (temp___do_toplevel_2157 Bool) (temp___do_typ_inv_2158 Bool)) Bool (=> (not (= temp___skip_constant_2156 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2159) (last3 temp___expr_2159)) (and (= (first3 temp___expr_2159) 1) (= (last3 temp___expr_2159) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_2178 us_t2) (temp___is_init_2174 Bool) (temp___skip_constant_2175 Bool) (temp___do_toplevel_2176 Bool) (temp___do_typ_inv_2177 Bool)) Bool (=> (not (= temp___skip_constant_2175 true)) (and (dynamic_property3 1 4 (first5 temp___expr_2178) (last5 temp___expr_2178)) (and (= (first5 temp___expr_2178) 1) (= (last5 temp___expr_2178) 4)))))
...
(declare-const temp___84721 t2)
(define-fun temp___84722 () us_t2 (mk___t2 temp___8472 temp___84721))
...
(assert (and (= temp___84722 (register_to_bytes reg)) (dynamic_invariant1 temp___84722 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___84721)) (to_rep (last4 temp___84721))) (+ (- (to_rep (last4 temp___84721)) (to_rep (first4 temp___84721))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
