...
(assert (= result data))
(assert (= data1 o))
(assert (<= 0 (- (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0) 1)))
(assert (not (<= (- (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0) 1) 2147483647)))
(check-sat)
(exit)
