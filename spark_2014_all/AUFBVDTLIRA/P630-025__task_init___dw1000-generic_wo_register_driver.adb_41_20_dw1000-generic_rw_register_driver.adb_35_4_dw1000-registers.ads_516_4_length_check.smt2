...
(define-fun tregister_byte_arrayP1__ref___123__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___53__projection ((a target__ref)) us_t1 (target__content a))
...
(declare-fun user_eq7 (bits_13 bits_13) Bool)
(declare-const dummy7 bits_13)
...
(define-fun source__ref___53__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_6858 us_t1) (temp___is_init_6854 Bool) (temp___skip_constant_6855 Bool) (temp___do_toplevel_6856 Bool) (temp___do_typ_inv_6857 Bool)) Bool (=> (not (= temp___skip_constant_6855 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6858) (last3 temp___expr_6858)) (and (= (first3 temp___expr_6858) 1) (= (last3 temp___expr_6858) 2)))))
...
(define-fun register_type__ref___175__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___123__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_6837 us_t2) (temp___is_init_6833 Bool) (temp___skip_constant_6834 Bool) (temp___do_toplevel_6835 Bool) (temp___do_typ_inv_6836 Bool)) Bool (=> (not (= temp___skip_constant_6834 true)) (and (dynamic_property3 1 2 (first5 temp___expr_6837) (last5 temp___expr_6837)) (and (= (first5 temp___expr_6837) 1) (= (last5 temp___expr_6837) 2)))))
...
(declare-const temp___8869 (Array Int bits_8))
(declare-const temp___88691 t1)
(define-fun temp___88692 () us_t1 (mk___t1 temp___8869 temp___88691))
...
(assert (and (= temp___88692 (register_to_bytes reg)) (dynamic_invariant temp___88692 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___88691)) (to_rep (last2 temp___88691))) (+ (- (to_rep (last2 temp___88691)) (to_rep (first2 temp___88691))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
