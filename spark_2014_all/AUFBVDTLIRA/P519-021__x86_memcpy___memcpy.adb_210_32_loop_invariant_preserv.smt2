...
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (and (not (= (inrange64 i saved_rbp_161 saved_rbp_721) true)) (not (= (inrange64 i (bvsub rbp ((_ int2bv 64) 8)) ((_ int2bv 64) 8)) true))) (= (to_rep (select memory2 i)) (to_rep (select memory i)))))))
(assert (= saved_rbp_161 (readmem64 (bvsub rbp ((_ int2bv 64) 16)) memory2)))
(assert (= saved_rbp_721 (readmem64 (bvsub rbp ((_ int2bv 64) 72)) memory2)))
...
(assert (= saved_rbp_721 (readmem64 (bvsub rbp ((_ int2bv 64) 72)) memory2)))
(assert (bvult tmp_register2 (bvudiv saved_rbp_721 ((_ int2bv 64) 8))))
(assert (= (inrange64 rdx4 saved_rbp_161 saved_rbp_721) true))
(assert (= (inrange64 (bvadd rdx4 ((_ int2bv 64) 1)) saved_rbp_161 saved_rbp_721) true))
(assert (= (inrange64 (bvadd rdx4 ((_ int2bv 64) 2)) saved_rbp_161 saved_rbp_721) true))
(assert (= (inrange64 (bvadd rdx4 ((_ int2bv 64) 3)) saved_rbp_161 saved_rbp_721) true))
(assert (= (inrange64 (bvadd rdx4 ((_ int2bv 64) 4)) saved_rbp_161 saved_rbp_721) true))
(assert (= (inrange64 (bvadd rdx4 ((_ int2bv 64) 5)) saved_rbp_161 saved_rbp_721) true))
(assert (= (inrange64 (bvadd rdx4 ((_ int2bv 64) 6)) saved_rbp_161 saved_rbp_721) true))
(assert (= (inrange64 (bvadd rdx4 ((_ int2bv 64) 7)) saved_rbp_161 saved_rbp_721) true))
...
(assert (not (= (to_rep (select memory3 i)) (to_rep (select memory i)))))
(check-sat)
(exit)
