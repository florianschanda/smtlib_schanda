...
(assert (and (= test_length__p3__a2__assume2 (create ((_ int2bv 16) 65532))) (and (dynamic_invariant2 test_length__p3__a2__assume2 true false true) (and (= (to_rep (first test_length__p3__a2__assume1)) ((_ int2bv 16) 0)) (= (to_rep (last test_length__p3__a2__assume1)) ((_ int2bv 16) 65532))))))
(assert (= result a2))
