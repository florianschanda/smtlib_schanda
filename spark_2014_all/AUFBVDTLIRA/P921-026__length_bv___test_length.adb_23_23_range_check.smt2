...
(assert (and (= test_length__p3__a2__assume2 (create #xFFFC)) (and (dynamic_invariant2 test_length__p3__a2__assume2 true false true true) (and (= (to_rep (first test_length__p3__a2__assume1)) #x0000) (= (to_rep (last test_length__p3__a2__assume1)) #xFFFC)))))
(assert (= result a2))
