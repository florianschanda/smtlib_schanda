...
(assert (forall ((x mod_16)) (! (uint_in_range1 (to_int4 x)) :pattern ((to_int4 x)))))
...
(assert (and (= (mk___t test_length__p3__a2__assume test_length__p3__a2__assume1) (create ((_ int2bv 16) 65532))) (and (dynamic_invariant2 (mk___t test_length__p3__a2__assume test_length__p3__a2__assume1) true false true) (and (= (to_rep (first test_length__p3__a2__assume1)) ((_ int2bv 16) 0)) (= (to_rep (last test_length__p3__a2__assume1)) ((_ int2bv 16) 65532))))))
(assert (= result a2))
...
(assert (dynamic_property ((_ int2bv 16) 0) ((_ int2bv 16) 65535) (to_rep a2__first) (to_rep a2__last)))
