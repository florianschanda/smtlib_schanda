...
(declare-fun temp___1031 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1033 (_ BitVec 8))) (forall ((temp___1034 Int) (temp___1035 Int)) (let ((temp___1032 (temp___1031 temp___1033 temp___1034 temp___1035))) (=> (dynamic_invariant2 temp___1033 true true true true) (and (=> (dynamic_property6 1 65536 temp___1034 temp___1035) (and (= (first5 temp___1032) temp___1034) (= (last5 temp___1032) temp___1035))) (forall ((temp___1036 Int)) (= (to_rep1 (select (to_array2 temp___1032) temp___1036)) temp___1033))))))))
...
(declare-const temp___1038 (Array Int octet))
(declare-const temp___10381 t2)
(declare-const temp___1039 (Array Int octet))
(declare-const temp___10391 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___1042 digit_index_type)
(declare-const temp___10421 (Array Int octet))
(declare-const temp___10422 t1)
...
(assert (= (to_rep2 (first4 (rt2 (temp___1031 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1031 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___1038 temp___10381) (temp___1031 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep2 (first4 temp___10381)) (to_rep2 (last4 temp___10381))) (+ (- (to_rep2 (last4 temp___10381)) (to_rep2 (first4 temp___10381))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___1038 temp___1039))
(assert (= (mk1 (to_rep2 (first4 temp___10381)) (to_rep2 (last4 temp___10381))) temp___10391))
(assert (= (ite (<= (to_rep2 (first2 temp___10391)) (to_rep2 (last2 temp___10391))) (+ (- (to_rep2 (last2 temp___10391)) (to_rep2 (first2 temp___10391))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___1039 temp___10391)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1042)))
(assert (= temp___10421 o2))
(assert (= temp___10422 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___10421 temp___10422))))
(assert (= result____split_discrs (mk___split_discrs temp___1042)))
