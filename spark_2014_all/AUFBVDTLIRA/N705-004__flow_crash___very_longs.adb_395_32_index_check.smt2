...
(declare-const o16 t)
(declare-const temp___1254 digit_index_type)
(declare-const temp___12541 (Array Int octet))
(declare-const temp___12542 t)
...
(assert (<= 1 i1))
(assert (<= i1 r128b))
(assert (and (and (dynamic_invariant1 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true) (forall ((temp___1263 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1263) (<= temp___1263 (to_rep1 (last number__split_fields3)))) (=> (<= i2 temp___1263) (= (select number__split_fields2 temp___1263) (select number__split_fields temp___1263)))))) (and (<= 1 i2) (<= i2 r128b))))
...
(assert (and (= o5 (shift_right__2 o4 (- 8 distance))) (= o5 (bvudiv o4 (ite (< (- 8 distance) 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) (- 8 distance))) ((_ int2bv 8) 0))))))
...
(assert (= o15 o13))
(assert (= o16 o14))
(assert (= number__split_discrs (mk___split_discrs temp___1254)))
(assert (= temp___12541 o15))
(assert (= temp___12542 o16))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___12541 temp___12542))))
(assert (= number__split_discrs (mk___split_discrs temp___1254)))
