...
(assert (<= 1 i1))
(assert (<= i1 r128b))
(assert (and (and (dynamic_invariant2 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true true) (forall ((temp___1336 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1336) (<= temp___1336 (to_rep1 (last number__split_fields3)))) (=> (or (< r128b temp___1336) (or (< temp___1336 1) (<= i2 temp___1336))) (= (select number__split_fields2 temp___1336) (select number__split_fields temp___1336)))))) (and (<= 1 i2) (<= i2 r128b))))
...
(assert (= o15 o13))
(assert (= o16 o14))
(assert (= number__split_discrs (mk___split_discrs temp___1327)))
(assert (= temp___13271 o15))
(assert (= temp___13272 o16))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___13271 temp___13272))))
(assert (= number__split_discrs (mk___split_discrs temp___1327)))
...
(assert (= (to_rep2 o21) o20))
(assert (not (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits number__split_fields4)))))))
(check-sat)
(exit)
