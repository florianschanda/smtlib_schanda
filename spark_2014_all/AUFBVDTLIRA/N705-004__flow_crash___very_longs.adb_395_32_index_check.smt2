...
(define-fun dynamic_invariant3 ((temp___expr_761 Int) (temp___is_init_757 Bool) (temp___skip_constant_758 Bool) (temp___do_toplevel_759 Bool) (temp___do_typ_inv_760 Bool)) Bool (=> (or (= temp___is_init_757 true) (<= 0 7)) (in_range4 temp___expr_761)))
...
(define-fun dynamic_invariant4 ((temp___expr_223 Int) (temp___is_init_219 Bool) (temp___skip_constant_220 Bool) (temp___do_toplevel_221 Bool) (temp___do_typ_inv_222 Bool)) Bool (=> (or (= temp___is_init_219 true) (<= 1 2147483647)) (in_range2 temp___expr_223)))
...
(declare-const o16 t)
(declare-const temp___1325 digit_index_type)
(declare-const temp___13251 (Array Int octet))
(declare-const temp___13252 t)
...
(assert (dynamic_invariant1 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields number__split_fields1))) true false true true))
...
(assert (in_range1 r128b))
(assert (= result2 i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 r128b))
(assert (and (and (dynamic_invariant1 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true true) (forall ((temp___1334 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1334) (<= temp___1334 (to_rep1 (last number__split_fields3)))) (=> (<= i2 temp___1334) (= (select number__split_fields2 temp___1334) (select number__split_fields temp___1334)))))) (and (<= 1 i2) (<= i2 r128b))))
...
(assert (=> (< distance 8) (= o8 (to_rep o7))))
...
(assert (= o15 o13))
(assert (= o16 o14))
(assert (= number__split_discrs (mk___split_discrs temp___1325)))
(assert (= temp___13251 o15))
(assert (= temp___13252 o16))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___13251 temp___13252))))
(assert (= number__split_discrs (mk___split_discrs temp___1325)))
(assert (and (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits number__split_fields4)))) i2) (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits number__split_fields4)))))))
(assert (= o17 i2))
(assert (= o18 (select (elts (rec__very_longs__very_long__long_digits number__split_fields4)) o17)))
(assert (= o19 (to_rep o18)))
(assert (= o20 (bvor o19 old_overflow2)))
