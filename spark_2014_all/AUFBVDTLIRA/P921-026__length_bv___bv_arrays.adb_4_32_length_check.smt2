...
(assert (not (= (ite (<= (bv2nat (to_rep (first4 temp___1931))) (bv2nat (to_rep (last4 temp___1931)))) (+ (- (bv2nat (to_rep (last4 temp___1931))) (bv2nat (to_rep (first4 temp___1931)))) 1) 0) (ite (<= (bv2nat #x0000) (bv2nat c)) (+ (- (bv2nat c) (bv2nat #x0000)) 1) 0))))
(check-sat)
(exit)
