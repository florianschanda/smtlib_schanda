...
(assert (=> (<= temp___730 temp___731) (and (and (<= (to_rep (first (rt buffer))) temp___730) (<= temp___730 (to_rep (last (rt buffer))))) (and (<= (to_rep (first (rt buffer))) temp___731) (<= temp___731 (to_rep (last (rt buffer))))))))
(assert (= o17 (elts buffer)))
(assert (= o17 temp___732))
(assert (= (mk7 temp___730 temp___731) temp___7321))
(assert (= temp___732 o18))
(assert (= (mk (to_rep (first14 temp___7321)) (to_rep (last14 temp___7321))) o19))
(assert (not (in_range1 (+ offset2 4))))
(check-sat)
(exit)
