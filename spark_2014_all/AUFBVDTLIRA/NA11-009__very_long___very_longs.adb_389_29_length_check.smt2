...
(assert (not (= (ite (<= (to_rep2 (first2 temp___12561)) (to_rep2 (last2 temp___12561))) (+ (- (to_rep2 (last2 temp___12561)) (to_rep2 (first2 temp___12561))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0))))
(check-sat)
(exit)
