...
(assert (not (= i2 (to_rep result____last))))
(assert (= i2 result2))
(assert (= i3 (+ i2 1)))
(assert (and (<= (to_rep (first (rt right))) i3) (<= i3 (to_rep (last (rt right))))))
(assert (= o12 i3))
(assert (= o13 (select (elts right) o12)))
(assert (= o14 (to_rep1 o13)))
(assert (and (<= (to_rep (first (rt left))) i3) (<= i3 (to_rep (last (rt left))))))
(assert (= o9 i3))
(assert (= o10 (select (elts left) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (and (= o15 (xor2 o11 o14)) (= o15 (bvxor o11 o14))))
(assert (= (to_rep1 o16) o15))
(assert (= o17 (store result__2 i3 o16)))
(assert (= result3 result__2))
(assert (= result__3 o17))
(declare-const pos Int)
(assert (<= (to_rep result____first) pos))
(assert (<= pos i3))
(assert (not (= (to_rep1 (select result__3 pos)) (xor2 (to_rep1 (select (elts left) pos)) (to_rep1 (select (elts right) pos))))))
(check-sat)
(exit)
