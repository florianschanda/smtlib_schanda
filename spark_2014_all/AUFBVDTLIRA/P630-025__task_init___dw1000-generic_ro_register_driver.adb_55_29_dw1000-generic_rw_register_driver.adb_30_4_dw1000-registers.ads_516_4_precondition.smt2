...
(assert (forall ((x bits_13)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x bits_13)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x2000))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int5 ((x bits_13)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x bits_13)) (! (in_range_int1 (to_int5 x)) :pattern ((to_int5 x)))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep2 (rec__dw1000__register_types__aon_cfg1_type__sleep_ce (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_cfg1_type__sleep_ce (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__aon_cfg1_type__smxx (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_cfg1_type__smxx (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__aon_cfg1_type__lposc_c (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_cfg1_type__lposc_c (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__aon_cfg1_type__reserved (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__aon_cfg1_type__reserved (us_split_fields1 b))))) true false))
...
(define-fun register_type__ref___174__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___122__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___122__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6816 us_t1) (temp___is_init_6812 Bool) (temp___skip_constant_6813 Bool) (temp___do_toplevel_6814 Bool) (temp___do_typ_inv_6815 Bool)) Bool (=> (not (= temp___skip_constant_6813 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6816) (last3 temp___expr_6816)) (and (= (first3 temp___expr_6816) 1) (= (last3 temp___expr_6816) 2)))))
