...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x ((_ int2bv 16) 8192)))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(define-fun dynamic_invariant ((temp___expr_6199 us_t1) (temp___is_init_6196 Bool) (temp___skip_constant_6197 Bool) (temp___do_toplevel_6198 Bool)) Bool (=> (not (= temp___skip_constant_6197 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6199) (last3 temp___expr_6199)) (and (= (first3 temp___expr_6199) 1) (= (last3 temp___expr_6199) 2)))))
