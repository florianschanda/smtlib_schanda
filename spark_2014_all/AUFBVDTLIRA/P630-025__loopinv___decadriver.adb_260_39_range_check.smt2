...
(assert (=> (= load_antenna_delay true) (= (to_rep2 o6) ((_ extract 15 0) (bvand word2 ((_ int2bv 32) 65535))))))
...
(assert (=> (= load_antenna_delay true) (= (to_rep2 o9) ((_ extract 15 0) (bvand word3 ((_ int2bv 32) 65535))))))
...
(assert (=> (not (= load_antenna_delay true)) (= (to_rep2 o12) ((_ int2bv 16) 0))))
...
(assert (=> (not (= load_antenna_delay true)) (= (to_rep2 o15) ((_ int2bv 16) 0))))
...
(assert (not (bvule ((_ zero_extend 24) ((_ int2bv 8) 0)) (bvand word4 ((_ int2bv 32) 31)))))
(check-sat)
(exit)
