...
(assert (=> (= load_antenna_delay true) (= (to_rep2 o6) ((_ extract 15 0) (bvand word2 #x0000FFFF)))))
...
(assert (=> (= load_antenna_delay true) (= (to_rep2 o9) ((_ extract 15 0) (bvand word3 #x0000FFFF)))))
...
(assert (=> (not (= load_antenna_delay true)) (= (to_rep2 o12) #x0000)))
...
(assert (=> (not (= load_antenna_delay true)) (= (to_rep2 o15) #x0000)))
...
(assert (not (bvule ((_ zero_extend 24) #x00) (bvand word4 #x0000001F))))
(check-sat)
(exit)
