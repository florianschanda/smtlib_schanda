...
(define-fun dynamic_invariant ((temp___expr_5110 us_t1) (temp___is_init_5107 Bool) (temp___skip_constant_5108 Bool) (temp___do_toplevel_5109 Bool)) Bool (=> (not (= temp___skip_constant_5108 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5110) (last3 temp___expr_5110)) (and (= (first3 temp___expr_5110) 1) (= (last3 temp___expr_5110) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_5126 us_t2) (temp___is_init_5123 Bool) (temp___skip_constant_5124 Bool) (temp___do_toplevel_5125 Bool)) Bool (=> (not (= temp___skip_constant_5124 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5126) (last5 temp___expr_5126)) (and (= (first5 temp___expr_5126) 1) (= (last5 temp___expr_5126) 2)))))
...
(declare-const temp___7977 (Array Int bits_8))
(declare-const temp___79771 t2)
(declare-const temp___7978 (Array Int bits_8))
(declare-const temp___79781 t1)
...
(define-fun temp___79772 () us_t2 (mk___t2 temp___7977 temp___79771))
...
(assert (and (= temp___79772 (register_to_bytes reg)) (dynamic_invariant1 temp___79772 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___79771)) (to_rep (last4 temp___79771))) (+ (- (to_rep (last4 temp___79771)) (to_rep (first4 temp___79771))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___7977 temp___7978))
(assert (= (mk1 (to_rep (first4 temp___79771)) (to_rep (last4 temp___79771))) temp___79781))
(assert (= (ite (<= (to_rep (first2 temp___79781)) (to_rep (last2 temp___79781))) (+ (- (to_rep (last2 temp___79781)) (to_rep (first2 temp___79781))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___7978 temp___79781)))
(assert (= o2 o))
