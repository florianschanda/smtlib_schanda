...
(declare-fun user_eq4 (bits_16 bits_16) Bool)
(declare-const dummy4 bits_16)
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__drx_tune4h_type__drx_tune4h bits_16)))))
(define-fun us_split_fields_DRX_TUNE4H__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__drx_tune4h_type__drx_tune4h a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___52__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___52__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__drx_tune4h_type__drx_tune4h (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__drx_tune4h_type__drx_tune4h (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__drx_tune4h_type__drx_tune4h__first__bit Int)
(declare-const dw1000__register_types__drx_tune4h_type__drx_tune4h__last__bit Int)
(declare-const dw1000__register_types__drx_tune4h_type__drx_tune4h__position Int)
(assert (<= 0 dw1000__register_types__drx_tune4h_type__drx_tune4h__first__bit))
(assert (< dw1000__register_types__drx_tune4h_type__drx_tune4h__first__bit dw1000__register_types__drx_tune4h_type__drx_tune4h__last__bit))
(assert (<= 0 dw1000__register_types__drx_tune4h_type__drx_tune4h__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((drx_tune4h_type__ref (mk_drx_tune4h_type__ref (drx_tune4h_type__content us_rep)))))
(define-fun drx_tune4h_type__ref___projection ((a drx_tune4h_type__ref)) us_rep (drx_tune4h_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___123__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___87__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___87__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5609 us_t1) (temp___is_init_5605 Bool) (temp___skip_constant_5606 Bool) (temp___do_toplevel_5607 Bool) (temp___do_typ_inv_5608 Bool)) Bool (=> (not (= temp___skip_constant_5606 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5609) (last3 temp___expr_5609)) (and (= (first3 temp___expr_5609) 1) (= (last3 temp___expr_5609) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___37__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___37__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_5627 us_t2) (temp___is_init_5623 Bool) (temp___skip_constant_5624 Bool) (temp___do_toplevel_5625 Bool) (temp___do_typ_inv_5626 Bool)) Bool (=> (not (= temp___skip_constant_5624 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5627) (last5 temp___expr_5627)) (and (= (first5 temp___expr_5627) 1) (= (last5 temp___expr_5627) 2)))))
...
(declare-const temp___8749 (Array Int bits_8))
(declare-const temp___87491 t2)
(declare-const temp___8750 (Array Int bits_8))
(declare-const temp___87501 t1)
...
(define-fun temp___87492 () us_t2 (mk___t2 temp___8749 temp___87491))
...
(assert (and (= temp___87492 (register_to_bytes reg)) (dynamic_invariant1 temp___87492 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___87491)) (to_rep (last4 temp___87491))) (+ (- (to_rep (last4 temp___87491)) (to_rep (first4 temp___87491))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8749 temp___8750))
(assert (= (mk1 (to_rep (first4 temp___87491)) (to_rep (last4 temp___87491))) temp___87501))
(assert (= (ite (<= (to_rep (first2 temp___87501)) (to_rep (last2 temp___87501))) (+ (- (to_rep (last2 temp___87501)) (to_rep (first2 temp___87501))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8750 temp___87501)))
(assert (= o2 o))
