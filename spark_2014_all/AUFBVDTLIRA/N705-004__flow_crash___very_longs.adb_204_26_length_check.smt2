...
(assert (not (= (ite (<= (to_rep1 (first2 temp___9801)) (to_rep1 (last2 temp___9801))) (+ (- (to_rep1 (last2 temp___9801)) (to_rep1 (first2 temp___9801))) 1) 0) (ite (<= (to_rep1 (first2 result____split_fields1)) (to_rep1 (last2 result____split_fields1))) (+ (- (to_rep1 (last2 result____split_fields1)) (to_rep1 (first2 result____split_fields1))) 1) 0))))
(check-sat)
(exit)
