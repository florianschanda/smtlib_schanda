...
(assert (= (ite (<= (to_rep2 (first4 temp___9081)) (to_rep2 (last4 temp___9081))) (+ (- (to_rep2 (last4 temp___9081)) (to_rep2 (first4 temp___9081))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___908 temp___909))
(assert (= (mk1 (to_rep2 (first4 temp___9081)) (to_rep2 (last4 temp___9081))) temp___9091))
(assert (not (= (ite (<= (to_rep2 (first2 temp___9091)) (to_rep2 (last2 temp___9091))) (+ (- (to_rep2 (last2 temp___9091)) (to_rep2 (first2 temp___9091))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0))))
(check-sat)
(exit)
