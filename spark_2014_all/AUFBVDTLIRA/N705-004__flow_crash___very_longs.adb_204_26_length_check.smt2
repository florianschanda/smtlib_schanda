...
(assert (= (ite (<= (to_rep2 (first4 temp___9791)) (to_rep2 (last4 temp___9791))) (+ (- (to_rep2 (last4 temp___9791)) (to_rep2 (first4 temp___9791))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___979 temp___980))
(assert (= (mk1 (to_rep2 (first4 temp___9791)) (to_rep2 (last4 temp___9791))) temp___9801))
(assert (not (= (ite (<= (to_rep2 (first2 temp___9801)) (to_rep2 (last2 temp___9801))) (+ (- (to_rep2 (last2 temp___9801)) (to_rep2 (first2 temp___9801))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0))))
(check-sat)
(exit)
