...
(define-fun tregister_byte_arrayP1__ref___9__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___9__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_2402 us_t1) (temp___is_init_2398 Bool) (temp___skip_constant_2399 Bool) (temp___do_toplevel_2400 Bool) (temp___do_typ_inv_2401 Bool)) Bool (=> (not (= temp___skip_constant_2399 true)) (and (dynamic_property2 1 5 (first3 temp___expr_2402) (last3 temp___expr_2402)) (and (= (first3 temp___expr_2402) 1) (= (last3 temp___expr_2402) 5)))))
