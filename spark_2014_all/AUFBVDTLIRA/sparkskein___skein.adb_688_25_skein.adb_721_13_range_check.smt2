...
(define-fun to_int5 ((x hash_bit_length)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x hash_bit_length)) (! (in_range_int (to_int5 x)) :pattern ((to_int5 x)))))
...
(assert (forall ((x u16)) (! (uint_in_range2 (to_int8 x)) :pattern ((to_int8 x)))))
(declare-sort u32 0)
...
(assert (forall ((x u32)) (! (uint_in_range3 (to_int9 x)) :pattern ((to_int9 x)))))
(declare-sort u7 0)
...
(define-fun dynamic_invariant1 ((temp___expr_588 (_ BitVec 64)) (temp___is_init_584 Bool) (temp___skip_constant_585 Bool) (temp___do_toplevel_586 Bool) (temp___do_typ_inv_587 Bool)) Bool (=> (or (= temp___is_init_584 true) (bvule #x0000000000000000 #xFFFFFFFFFFFFFFF8)) (in_range1 temp___expr_588)))
...
(assert (forall ((x unsigned_64)) (! (uint_in_range1 (to_int12 x)) :pattern ((to_int12 x)))))
(declare-sort t 0)
...
(define-fun dynamic_invariant2 ((temp___expr_735 us_rep2) (temp___is_init_731 Bool) (temp___skip_constant_732 Bool) (temp___do_toplevel_733 Bool) (temp___do_typ_inv_734 Bool)) Bool (=> (= temp___is_init_731 true) (bvult (last1 (of_array (rec__skein__skein_512_context__b (us_split_fields5 temp___expr_735)) #x0000000000000000 #x000000000000003F)) #xFFFFFFFFFFFFFFFF)))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant2 ctx true true true true) (dynamic_invariant1 (hash_bit_len_of ctx) true false true true)) :pattern ((hash_bit_len_of ctx)))))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant2 ctx true true true true) (= (hash_bit_len_of ctx) (to_rep2 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields5 ctx))))))) :pattern ((hash_bit_len_of ctx)))))
(declare-fun byte_count_of (us_rep2) (_ BitVec 64))
(declare-fun byte_count_of__function_guard ((_ BitVec 64) us_rep2) Bool)
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant2 ctx true true true true) (dynamic_invariant (byte_count_of ctx) true false true true)) :pattern ((byte_count_of ctx)))))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant2 ctx true true true true) (= (byte_count_of ctx) (to_rep (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields5 ctx))))))) :pattern ((byte_count_of ctx)))))
(declare-sort initialized_hash_bit_length 0)
(declare-const attr__ATTRIBUTE_MODULUS7 (_ BitVec 64))
(define-fun in_range5 ((x (_ BitVec 64))) Bool (and (bvule #x0000000000000001 x) (bvule x #xFFFFFFFFFFFFFFF8)))
...
(declare-fun user_eq15 (initialized_hash_bit_length initialized_hash_bit_length) Bool)
(declare-const dummy15 initialized_hash_bit_length)
...
(define-fun in_range6 ((x (_ BitVec 64))) Bool (and (bvule #x0000000000000000 x) (bvule x #x0000000000000040)))
...
(declare-fun user_eq16 (skein_512_block_bytes_count skein_512_block_bytes_count) Bool)
(declare-const dummy16 skein_512_block_bytes_count)
...
(declare-fun user_eq17 (positive_block_512_count_t positive_block_512_count_t) Bool)
(declare-const dummy17 positive_block_512_count_t)
...
(define-fun dynamic_invariant6 ((temp___expr_681 (_ BitVec 64)) (temp___is_init_677 Bool) (temp___skip_constant_678 Bool) (temp___do_toplevel_679 Bool) (temp___do_typ_inv_680 Bool)) Bool (=> (or (= temp___is_init_677 true) (bvule #x0000000000000001 #x03FFFFFFFFFFFFFF)) (in_range7 temp___expr_681)))
...
(define-fun dynamic_invariant10 ((temp___expr_595 (_ BitVec 64)) (temp___is_init_591 Bool) (temp___skip_constant_592 Bool) (temp___do_toplevel_593 Bool) (temp___do_typ_inv_594 Bool)) Bool (=> (or (= temp___is_init_591 true) (bvule #x0000000000000001 #xFFFFFFFFFFFFFFF8)) (in_range5 temp___expr_595)))
(define-fun dynamic_invariant11 ((temp___expr_619 (_ BitVec 64)) (temp___is_init_615 Bool) (temp___skip_constant_616 Bool) (temp___do_toplevel_617 Bool) (temp___do_typ_inv_618 Bool)) Bool (=> (or (= temp___is_init_615 true) (bvule #x0000000000000000 #x0000000000000040)) (in_range6 temp___expr_619)))
(define-fun dynamic_invariant12 ((temp___expr_695 (_ BitVec 8)) (temp___is_init_691 Bool) (temp___skip_constant_692 Bool) (temp___do_toplevel_693 Bool) (temp___do_typ_inv_694 Bool)) Bool (=> (or (= temp___is_init_691 true) (bvule #x00 #x3F)) (in_range3 temp___expr_695)))
(define-fun dynamic_invariant13 ((temp___expr_688 (_ BitVec 8)) (temp___is_init_684 Bool) (temp___skip_constant_685 Bool) (temp___do_toplevel_686 Bool) (temp___do_typ_inv_687 Bool)) Bool (=> (or (= temp___is_init_684 true) (bvule #x00 #x7F)) (in_range2 temp___expr_688)))
...
(assert (bvult (to_rep7 (last (mk #x0000000000000000 #x000000000000003F))) #xFFFFFFFFFFFFFFFF))
(assert (dynamic_invariant3 msg true false true true))
(assert (and (and (and (and (and (in_range5 (hash_bit_len_of (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5 ctx__split_fields6 ctx__split_fields7)) ctx__split_fields8 ctx__split_fields9)) ctx__split_fields10 ctx__split_fields11)))) (in_range6 (byte_count_of (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5 ctx__split_fields6 ctx__split_fields7)) ctx__split_fields8 ctx__split_fields9)) ctx__split_fields10 ctx__split_fields11))))) (= (to_rep7 (first (rt msg))) #x0000000000000000)) (bvult (to_rep7 (last (rt msg))) #xFFFFFFFFFFFFFFFF)) (= (add_in_range (to_rep7 (last (rt msg))) #x0000000000000040) true)) (bvult (bvadd (to_rep7 (last (rt msg))) #x0000000000000040) #xFFFFFFFFFFFFFFFF)))
(assert (=> (bvule #x0000000000000000 #x000000000000003F) (in_range4 n)))
(assert (=> (bvule #x0000000000000001 #x03FFFFFFFFFFFFFF) (in_range7 block_count)))
(assert (= result (mk_t__ref1 msg_byte_count)))
(assert (= msg_byte_count1 (bvadd (to_rep7 (last (rt msg))) #x0000000000000001)))
(assert (= result1 (mk_t__ref1 current_msg_offset)))
(assert (= current_msg_offset1 #x0000000000000000))
(assert (bvugt (bvadd msg_byte_count1 (to_rep ctx__split_fields9)) #x0000000000000040))
(assert (bvugt (to_rep ctx__split_fields9) #x0000000000000000))
(assert (and (= o (bvsub #x0000000000000040 (to_rep ctx__split_fields9))) (in_range4 (bvsub #x0000000000000040 (to_rep ctx__split_fields9)))))
(assert (= result2 (mk_t__ref1 n)))
(assert (= n1 o))
(assert (= current_msg_offset1 c237b))
(assert (= n1 c238b))
(assert (=> (bvule #x0000000000000000 #x000000000000003F) (in_range4 dst)))
(assert (=> (bvule #x0000000000000000 #x000000000000003F) (in_range4 final_dst)))
(assert (bvugt c238b #x0000000000000000))
(assert (= result3 (mk_t__ref1 src)))
(assert (= src1 c237b))
(assert (not (in_range4 (to_rep ctx__split_fields9))))
(check-sat)
(exit)
