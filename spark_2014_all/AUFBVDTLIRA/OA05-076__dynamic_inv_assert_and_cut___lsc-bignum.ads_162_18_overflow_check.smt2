...
(assert (= o16 (ite (<= o15 (to_rep (last (rt b)))) true false)))
(assert (and (= o10 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o11 (+ b_first o10)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (= o17 (ite (<= (to_rep (first (rt b))) o12) true false)))
...
(assert (= o8 (ite (<= o7 (to_rep (last (rt c)))) true false)))
(assert (and (= o2 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o3 (+ c_first o2)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (= o9 (ite (<= (to_rep (first (rt c))) o4) true false)))
