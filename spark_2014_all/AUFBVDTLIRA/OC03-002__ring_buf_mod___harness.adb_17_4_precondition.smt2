...
(assert (= (let ((temp___250 (to_model (mk___rep r__split_fields23)))) (bool_eq (elts temp___250) (to_rep (first (rt temp___250))) (to_rep (last (rt temp___250))) (temp_____aggregate_def_246 0) #x0001 #x0000)) true))
(assert (= (let ((temp___258 (func_push (to_model (mk___rep r__split_fields23)) x))) (let ((temp___257 (to_model (mk___rep r__split_fields22)))) (bool_eq (elts temp___257) (to_rep (first (rt temp___257))) (to_rep (last (rt temp___257))) (elts temp___258) (to_rep (first (rt temp___258))) (to_rep (last (rt temp___258)))))) true))
(assert (= (let ((temp___258 (func_push (to_model (mk___rep r__split_fields22)) y))) (let ((temp___257 (to_model (mk___rep r__split_fields21)))) (bool_eq (elts temp___257) (to_rep (first (rt temp___257))) (to_rep (last (rt temp___257))) (elts temp___258) (to_rep (first (rt temp___258))) (to_rep (last (rt temp___258)))))) true))
(assert (and (and (= (let ((temp___262 (func_pop (to_model (mk___rep r__split_fields21))))) (let ((temp___261 (to_model (mk___rep r__split_fields20)))) (bool_eq (elts temp___261) (to_rep (first (rt temp___261))) (to_rep (last (rt temp___261))) (elts temp___262) (to_rep (first (rt temp___262))) (to_rep (last (rt temp___262)))))) true) (= h1 (func_head (to_model (mk___rep r__split_fields21))))) (in_range h1)))
(assert (= h1 x))
(assert (= (let ((temp___258 (func_push (to_model (mk___rep r__split_fields20)) z))) (let ((temp___257 (to_model (mk___rep r__split_fields19)))) (bool_eq (elts temp___257) (to_rep (first (rt temp___257))) (to_rep (last (rt temp___257))) (elts temp___258) (to_rep (first (rt temp___258))) (to_rep (last (rt temp___258)))))) true))
(assert (and (and (= (let ((temp___262 (func_pop (to_model (mk___rep r__split_fields19))))) (let ((temp___261 (to_model (mk___rep r__split_fields18)))) (bool_eq (elts temp___261) (to_rep (first (rt temp___261))) (to_rep (last (rt temp___261))) (elts temp___262) (to_rep (first (rt temp___262))) (to_rep (last (rt temp___262)))))) true) (= h2 (func_head (to_model (mk___rep r__split_fields19))))) (in_range h2)))
(assert (= h2 y))
