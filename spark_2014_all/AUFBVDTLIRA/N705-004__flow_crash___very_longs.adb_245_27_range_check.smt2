...
(declare-datatypes () ((tT79bP1__ref (mk_tT79bP1__ref (tT79bP1__content tdigit_index_typeB)))))
(define-fun tT79bP1__ref___projection ((a tT79bP1__ref)) tdigit_index_typeB (tT79bP1__content a))
(declare-sort t1 0)
...
(define-fun us_split_fields_Long_Digits__23__projection ((a us_split_fields2)) us_t1 (rec__very_longs__very_long__long_digits1 a))
...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___198 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___198) (first3 temp___198) (last3 temp___198))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___197 (rec__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___197) (first1 temp___197) (last1 temp___197))))))
...
(define-fun dynamic_invariant4 ((temp___expr_669 us_rep1) (temp___is_init_665 Bool) (temp___skip_constant_666 Bool) (temp___do_toplevel_667 Bool) (temp___do_typ_inv_668 Bool)) Bool (and (=> (not (= temp___skip_constant_666 true)) (in_range4 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_669))) (and (dynamic_property3 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_669))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_669)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_669))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_669))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_672 us_rep1) (temp___skip_top_level_673 Bool)) Bool (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_672))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))))
...
(declare-datatypes () ((t80b__ref (mk_t80b__ref (t80b__content tdigit_index_typeB)))))
(define-fun t80b__ref___projection ((a t80b__ref)) tdigit_index_typeB (t80b__content a))
(declare-sort t2 0)
...
(declare-fun temp___1042 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1044 (_ BitVec 8))) (forall ((temp___1045 Int) (temp___1046 Int)) (let ((temp___1043 (temp___1042 temp___1044 temp___1045 temp___1046))) (=> (dynamic_invariant2 temp___1044 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1045 temp___1046) (and (= (first5 temp___1043) temp___1045) (= (last5 temp___1043) temp___1046))) (forall ((temp___1047 Int)) (= (to_rep1 (select (to_array2 temp___1043) temp___1047)) temp___1044))))))))
...
(assert (not (in_range2 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(check-sat)
(exit)
