...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___176 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___176) (first3 temp___176) (last3 temp___176))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___175 (rec__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___175) (first1 temp___175) (last1 temp___175))))))
...
(define-fun dynamic_invariant4 ((temp___expr_614 us_rep1) (temp___is_init_611 Bool) (temp___skip_constant_612 Bool) (temp___do_toplevel_613 Bool)) Bool (and (=> (not (= temp___skip_constant_612 true)) (in_range4 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_base temp___expr_614))) (and (dynamic_property3 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_614))) (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_614)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_614))) 1) (= (last3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_614))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))))
(define-fun default_initial_assumption ((temp___expr_617 us_rep1) (temp___skip_top_level_618 Bool)) Bool (= (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_617))) (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))))
...
(declare-fun temp___971 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___973 (_ BitVec 8))) (forall ((temp___974 Int) (temp___975 Int)) (let ((temp___972 (temp___971 temp___973 temp___974 temp___975))) (and (=> (dynamic_property6 1 2147483647 temp___974 temp___975) (and (= (first5 temp___972) temp___974) (= (last5 temp___972) temp___975))) (forall ((temp___976 Int)) (= (select (to_array2 temp___972) temp___976) (of_rep1 temp___973))))))))
...
(declare-const temp___978 (Array Int octet))
(declare-const temp___9781 t2)
(declare-const temp___979 (Array Int octet))
(declare-const temp___9791 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___982 digit_index_type)
(declare-const temp___9821 (Array Int octet))
(declare-const temp___9822 t1)
(declare-const temp___1008 (_ BitVec 16))
(declare-const temp___1007 (_ BitVec 16))
(declare-const temp___1006 (_ BitVec 16))
(declare-const temp___1003 us_rep1)
(declare-const temp___1002 (_ BitVec 16))
(declare-const temp___1001 (_ BitVec 16))
(declare-const temp___998 (_ BitVec 16))
(declare-const temp___997 (_ BitVec 16))
(declare-const temp___996 (_ BitVec 16))
(declare-const temp___993 us_rep1)
(declare-const temp___992 (_ BitVec 16))
(declare-const temp___991 (_ BitVec 16))
...
(declare-const temp___990 us_rep1)
