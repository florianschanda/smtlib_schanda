...
(assert (and (= (to_rep (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (dynamic_invariant1 (mk___rep result____split_discrs aco__math__very_longs__modadd_and_carry__result__fields) true true true true)))
