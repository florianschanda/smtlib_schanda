...
(assert (forall ((subject7 Int)) (=> (and (<= 5 subject7) (<= subject7 5)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject7)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
