...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o34 k)) #x00000000))))
(assert (= (mk_t__ref result) (mk_t__ref a_msw)))
(assert (= a_msw1 #x00000000))
(assert (= (mk_int__ref result1) (mk_int__ref i)))
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___684 o34)))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (omod (oadd (num_of_big_int (mk___t o35 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o35 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (and (<= a_first i2) (<= i2 a_last)))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (omod (oadd (num_of_big_int (mk___t o36 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw3))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- (+ i2 1) a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- (+ i2 1) a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o36 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw3))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o37 (mk_map__ref o36))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a (mk_map__ref o36))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o38 o36)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o39 o37)))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o40 o38)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o39 (mk_map__ref o34))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a1 (mk_map__ref o34))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o40 o34)))
...
(assert (= o13 (num_of_big_int c c_first o12)))
...
(assert (= o27 (omultiply o14 o26)))
(assert (= o33 (omod o27 o32)))
