...
(assert (= o227 (+ o226 1)))
(assert (and (= o228 o227) (in_range1 o227)))
(assert (and (= o229 o228) (in_range2 o228)))
(assert (= o230 (num_of_big_int c c_first o229)))
(assert (and (= o221 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o222 (+ o221 1)))
(assert (and (= o223 o222) (in_range1 o222)))
(assert (and (= o224 o223) (in_range2 o223)))
(assert (= o225 (num_of_big_int b b_first o224)))
(assert (= o231 (omultiply o225 o230)))
(assert (= o244 (omultiply o231 o243)))
(assert (= o250 (omod o244 o249)))
(assert (and (= o217 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o218 (+ o217 1)))
(assert (and (= o219 o218) (in_range1 o218)))
(assert (not (in_range2 o219)))
(check-sat)
(exit)
