...
(declare-const temp___309 (Array (_ BitVec 16) integer))
(declare-const temp___3091 ar_index)
(declare-const temp___3092 length_type)
...
(assert (= (to_rep o2) x))
(assert (and (= o (to_rep2 r__split_fields2)) (uint_in_range (to_rep2 r__split_fields2))))
...
(assert (= temp___309 o5))
(assert (= temp___3091 o6))
(assert (= temp___3092 o7))
...
(assert (= temp___309 r__split_fields3))
(assert (= temp___3091 r__split_fields4))
(assert (= temp___3092 r__split_fields5))
(assert (not (in_range1 (+ (to_rep2 r__split_fields5) 1))))
(check-sat)
(exit)
