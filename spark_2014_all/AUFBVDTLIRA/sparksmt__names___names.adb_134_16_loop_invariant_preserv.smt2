...
(assert (and (= (mk___rep2 (mk___split_fields2 o12 o13 o14)) (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o11)) (= (bool_eq3 (mk___rep2 (mk___split_fields2 o12 o13 o14)) (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o11)) true)))
(assert (= o12 o15))
(assert (= o13 o16))
(assert (= o14 o17))
(assert (= o18 o17))
(assert (= o19 (to_rep2 o18)))
(assert (= result7 (mk_int__ref ptr3)))
(assert (= ptr4 o19))
(assert (and (= (mk___t temp___6472 temp___6473) (to_string1 ptr4 hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (dynamic_invariant (mk___t temp___6472 temp___6473) true false true)))
(assert (= result8 (bool_eq temp___6472 (to_rep1 (first temp___6473)) (to_rep1 (last temp___6473)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s))))))
