...
(define-fun temp___6474 () us_t (mk___t temp___6472 temp___6473))
(define-fun o20 () us_rep2 (mk___rep2 (mk___split_fields2 o12 o13 o14)))
(define-fun o21 () us_rep2 (mk___rep2 (mk___split_fields2 o3 o4 o5)))
(define-fun temp___6475 () us_t (mk___t temp___647 temp___6471))
...
(assert (= ptr2 n3))
(assert (and (= temp___6475 (to_string1 ptr2 hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (dynamic_invariant temp___6475 true false true)))
...
(assert (and (= o21 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) (= (bool_eq3 o21 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) true)))
(assert (= o3 o6))
(assert (= o4 o7))
(assert (= o5 o8))
(assert (= o9 o8))
...
(assert (and (= o20 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o11)) (= (bool_eq3 o20 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o11)) true)))
(assert (= o12 o15))
(assert (= o13 o16))
(assert (= o14 o17))
(assert (= o18 o17))
...
(assert (= ptr4 o19))
(assert (and (= temp___6474 (to_string1 ptr4 hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (dynamic_invariant temp___6474 true false true)))
(assert (= result6 (bool_eq temp___6472 (to_rep1 (first temp___6473)) (to_rep1 (last temp___6473)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s))))))
(assert (not (= result6 true)))
(assert (= n6 n5))
(assert (not (in_range9 ptr4)))
(check-sat)
(exit)
