...
(declare-fun temp_____aggregate_def_294 (Int) (Array (_ BitVec 16) integer))
...
(assert (forall ((temp___296 Int)) (=> (dynamic_invariant1 temp___296 true true true true) (forall ((temp___297 (_ BitVec 16))) (= (select (temp_____aggregate_def_294 temp___296) temp___297) rliteral)))))
...
(assert (forall ((temp___248 Int)) (=> (dynamic_invariant1 temp___248 true true true true) (forall ((temp___249 (_ BitVec 16))) (= (select (temp_____aggregate_def_246 temp___248) temp___249) rliteral)))))
...
(assert (= (to_rep o) #x0000))
(assert (= r__split_fields3 o1))
(assert (= o o2))
(assert (= r__split_fields5 o3))
(assert (= temp___293 o1))
(assert (= temp___2931 o2))
(assert (= temp___2932 o3))
...
(assert (= (temp_____aggregate_def_294 0) r__split_fields9))
...
(assert (not (= (let ((temp___303 (to_model (mk___rep (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14))))) (bool_eq (elts temp___303) (to_rep (first (rt temp___303))) (to_rep (last (rt temp___303))) (temp_____aggregate_def_246 0) #x0001 #x0000)) true)))
(check-sat)
(exit)
