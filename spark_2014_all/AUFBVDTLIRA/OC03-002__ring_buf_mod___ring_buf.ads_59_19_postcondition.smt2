...
(assert (forall ((temp___269 Int)) (forall ((temp___270 (_ BitVec 16))) (= (select (temp___267 temp___269) temp___270) (of_rep2 temp___269)))))
...
(assert (not (= (let ((temp___276 (to_model (mk___rep (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14))))) (bool_eq (elts temp___276) (to_rep (first (rt temp___276))) (to_rep (last (rt temp___276))) (temp___219 0) ((_ int2bv 16) 1) ((_ int2bv 16) 0))) true)))
(check-sat)
(exit)
