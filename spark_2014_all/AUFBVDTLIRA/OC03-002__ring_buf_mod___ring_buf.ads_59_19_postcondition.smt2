...
(declare-fun temp___294 (Int) (Array (_ BitVec 16) integer))
...
(assert (forall ((temp___296 Int)) (=> (dynamic_invariant1 temp___296 true true true true) (forall ((temp___297 (_ BitVec 16))) (= (to_rep2 (select (temp___294 temp___296) temp___297)) temp___296)))))
...
(assert (forall ((temp___248 Int)) (=> (dynamic_invariant1 temp___248 true true true true) (forall ((temp___249 (_ BitVec 16))) (= (to_rep2 (select (temp___246 temp___248) temp___249)) temp___248)))))
...
(declare-const temp___291 (Array (_ BitVec 16) integer))
(declare-const temp___2911 ar_index)
(declare-const temp___2912 length_type)
(declare-const o4 ar_index)
(declare-const o5 (Array (_ BitVec 16) integer))
(declare-const o6 ar_index)
(declare-const o7 length_type)
(declare-const temp___293 (Array (_ BitVec 16) integer))
(declare-const temp___2931 ar_index)
(declare-const temp___2932 length_type)
...
(assert (= o o3))
(assert (= temp___291 o1))
(assert (= temp___2911 o2))
(assert (= temp___2912 o3))
(assert (= result r__split_fields))
(assert (= result1 r__split_fields1))
(assert (= result2 r__split_fields2))
(assert (= temp___291 r__split_fields3))
(assert (= temp___2911 r__split_fields4))
(assert (= temp___2912 r__split_fields5))
(assert (= (to_rep o4) #x0000))
(assert (= r__split_fields3 o5))
(assert (= o4 o6))
(assert (= r__split_fields5 o7))
(assert (= temp___293 o5))
(assert (= temp___2931 o6))
(assert (= temp___2932 o7))
(assert (= result3 r__split_fields3))
(assert (= result4 r__split_fields4))
(assert (= result5 r__split_fields5))
(assert (= temp___293 r__split_fields6))
(assert (= temp___2931 r__split_fields7))
(assert (= temp___2932 r__split_fields8))
(assert (= result6 r__split_fields6))
(assert (= result7 r__split_fields7))
(assert (= result8 r__split_fields8))
(assert (= (temp___294 0) r__split_fields9))
...
(assert (not (= (let ((temp___303 (to_model (mk___rep (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14))))) (bool_eq (elts temp___303) (to_rep (first (rt temp___303))) (to_rep (last (rt temp___303))) (temp___246 0) #x0001 #x0000)) true)))
(check-sat)
(exit)
