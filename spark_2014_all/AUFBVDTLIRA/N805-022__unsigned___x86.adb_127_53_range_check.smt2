...
(define-fun dynamic_invariant1 ((temp___expr_143 (_ BitVec 32)) (temp___is_init_140 Bool) (temp___skip_constant_141 Bool) (temp___do_toplevel_142 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_155 (_ BitVec 8)) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool true)
...
(declare-const o7 (Array (_ BitVec 64) unsigned_8))
...
(declare-const result3 (Array (_ BitVec 64) unsigned_8))
(declare-const memory4 (Array (_ BitVec 64) unsigned_8))
(declare-const memory5 (Array (_ BitVec 64) unsigned_8))
(declare-const memory6 (Array (_ BitVec 64) unsigned_8))
(assert true)
(assert true)
...
(assert (= memory1 o1))
(assert (not (bvule ((_ zero_extend 24) ((_ int2bv 8) 0)) (bvurem (bvudiv val__ ((_ int2bv 32) 256)) ((_ int2bv 32) 256)))))
(check-sat)
(exit)
