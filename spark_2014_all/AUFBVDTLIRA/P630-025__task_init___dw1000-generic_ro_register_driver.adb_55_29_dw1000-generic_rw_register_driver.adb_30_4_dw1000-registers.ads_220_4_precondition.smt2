...
(define-fun dynamic_invariant ((temp___expr_2275 us_t1) (temp___is_init_2272 Bool) (temp___skip_constant_2273 Bool) (temp___do_toplevel_2274 Bool)) Bool (=> (not (= temp___skip_constant_2273 true)) (and (dynamic_property2 1 5 (first3 temp___expr_2275) (last3 temp___expr_2275)) (and (= (first3 temp___expr_2275) 1) (= (last3 temp___expr_2275) 5)))))
