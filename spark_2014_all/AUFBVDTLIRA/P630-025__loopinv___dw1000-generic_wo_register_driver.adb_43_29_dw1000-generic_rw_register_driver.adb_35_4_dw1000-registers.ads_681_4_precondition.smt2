...
(define-fun register_byte_array__ref___173__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_8428 us_t1) (temp___is_init_8424 Bool) (temp___skip_constant_8425 Bool) (temp___do_toplevel_8426 Bool) (temp___do_typ_inv_8427 Bool)) Bool (=> (not (= temp___skip_constant_8425 true)) (and (dynamic_property2 1 4 (first3 temp___expr_8428) (last3 temp___expr_8428)) (and (= (first3 temp___expr_8428) 1) (= (last3 temp___expr_8428) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___70__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_8450 us_t2) (temp___is_init_8446 Bool) (temp___skip_constant_8447 Bool) (temp___do_toplevel_8448 Bool) (temp___do_typ_inv_8449 Bool)) Bool (=> (not (= temp___skip_constant_8447 true)) (and (dynamic_property3 1 4 (first5 temp___expr_8450) (last5 temp___expr_8450)) (and (= (first5 temp___expr_8450) 1) (= (last5 temp___expr_8450) 4)))))
...
(declare-const temp___90201 t2)
(declare-const temp___9021 (Array Int bits_8))
(declare-const temp___90211 t1)
...
(define-fun temp___90202 () us_t2 (mk___t2 temp___9020 temp___90201))
...
(assert (and (= temp___90202 (register_to_bytes reg)) (dynamic_invariant1 temp___90202 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___90201)) (to_rep (last4 temp___90201))) (+ (- (to_rep (last4 temp___90201)) (to_rep (first4 temp___90201))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___9020 temp___9021))
(assert (= (mk1 (to_rep (first4 temp___90201)) (to_rep (last4 temp___90201))) temp___90211))
(assert (= (ite (<= (to_rep (first2 temp___90211)) (to_rep (last2 temp___90211))) (+ (- (to_rep (last2 temp___90211)) (to_rep (first2 temp___90211))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___9021 temp___90211)))
(assert (= o2 o))
