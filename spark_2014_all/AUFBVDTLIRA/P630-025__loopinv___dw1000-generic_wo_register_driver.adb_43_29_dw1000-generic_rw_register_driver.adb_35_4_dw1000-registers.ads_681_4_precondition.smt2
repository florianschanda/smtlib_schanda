...
(define-fun in_range3 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 15))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 16)))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(define-fun in_range5 ((x (_ BitVec 16))) Bool (and (bvule ((_ int2bv 16) 0) x) (bvule x ((_ int2bv 16) 4095))))
...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x ((_ int2bv 16) 4096)))) (=> (in_range5 y) (= (to_rep5 (of_rep5 x)) y))) :pattern ((to_rep5 (of_rep5 x))))))
...
(define-fun dynamic_invariant ((temp___expr_7658 us_t1) (temp___is_init_7655 Bool) (temp___skip_constant_7656 Bool) (temp___do_toplevel_7657 Bool)) Bool (=> (not (= temp___skip_constant_7656 true)) (and (dynamic_property2 1 4 (first3 temp___expr_7658) (last3 temp___expr_7658)) (and (= (first3 temp___expr_7658) 1) (= (last3 temp___expr_7658) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_7678 us_t2) (temp___is_init_7675 Bool) (temp___skip_constant_7676 Bool) (temp___do_toplevel_7677 Bool)) Bool (=> (not (= temp___skip_constant_7676 true)) (and (dynamic_property3 1 4 (first5 temp___expr_7678) (last5 temp___expr_7678)) (and (= (first5 temp___expr_7678) 1) (= (last5 temp___expr_7678) 4)))))
...
(declare-const temp___8248 (Array Int bits_8))
(declare-const temp___82481 t2)
(declare-const temp___8249 (Array Int bits_8))
(declare-const temp___82491 t1)
...
(assert (and (= (mk___t2 temp___8248 temp___82481) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8248 temp___82481) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___82481)) (to_rep (last4 temp___82481))) (+ (- (to_rep (last4 temp___82481)) (to_rep (first4 temp___82481))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8248 temp___8249))
(assert (= (mk1 (to_rep (first4 temp___82481)) (to_rep (last4 temp___82481))) temp___82491))
(assert (= (ite (<= (to_rep (first2 temp___82491)) (to_rep (last2 temp___82491))) (+ (- (to_rep (last2 temp___82491)) (to_rep (first2 temp___82491))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8249 temp___82491)))
(assert (= o2 o))
