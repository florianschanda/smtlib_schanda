...
(assert (and (= o4 (to_rep (select (rec__rr_type__mx_record_type__mxrecordtype__mailexchanger (us_split_fields3 mx_record)) i2))) (uint_in_range (to_rep (select (rec__rr_type__mx_record_type__mxrecordtype__mailexchanger (us_split_fields3 mx_record)) i2)))))
(assert (= o5 ((_ int2bv 8) o4)))
(assert (= (to_rep1 o6) o5))
(assert (and (<= 1 (+ (+ start_byte 7) i2)) (<= (+ (+ start_byte 7) i2) 8180)))
(assert (= o7 (+ (+ start_byte 7) i2)))
...
(assert (= result2 i2))
(assert (= i3 (+ i2 1)))
(assert (not (<= start_byte (- 8172 current_name_length))))
(check-sat)
(exit)
