...
(define-fun dynamic_invariant ((temp___expr_137 (_ BitVec 64)) (temp___is_init_134 Bool) (temp___skip_constant_135 Bool) (temp___do_toplevel_136 Bool)) Bool true)
...
(declare-fun concat1 ((Array (_ BitVec 64) unsigned_8) (_ BitVec 64) (_ BitVec 64) (Array (_ BitVec 64) unsigned_8) (_ BitVec 64) (_ BitVec 64)) (Array (_ BitVec 64) unsigned_8))
(assert (forall ((a (Array (_ BitVec 64) unsigned_8)) (b (Array (_ BitVec 64) unsigned_8))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (forall ((i (_ BitVec 64))) (! (and (=> (and (bvule a_first i) (bvule i a_last)) (= (select (concat1 a a_first a_last b b_first b_last) i) (select a i))) (=> (bvugt i a_last) (= (select (concat1 a a_first a_last b b_first b_last) i) (select b (bvadd (bvsub i a_last) (bvsub b_first #x0000000000000001)))))) :pattern ((select (concat1 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton1 (unsigned_8 (_ BitVec 64)) (Array (_ BitVec 64) unsigned_8))
(assert (forall ((v unsigned_8)) (forall ((i (_ BitVec 64))) (! (= (select (singleton1 v i) i) v) :pattern ((select (singleton1 v i) i))))))
(define-fun bool_eq ((a (Array (_ BitVec 64) unsigned_8)) (a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b (Array (_ BitVec 64) unsigned_8)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep (select a temp___idx_132)) (to_rep (select b (bvadd (bvsub b__first a__first) temp___idx_132))))))) true false))
...
(declare-fun compare ((Array (_ BitVec 64) unsigned_8) (_ BitVec 64) (_ BitVec 64) (Array (_ BitVec 64) unsigned_8) (_ BitVec 64) (_ BitVec 64)) Int)
(assert (forall ((a (Array (_ BitVec 64) unsigned_8)) (b (Array (_ BitVec 64) unsigned_8))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 64) unsigned_8)) (b (Array (_ BitVec 64) unsigned_8))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (bvult (to_rep (select a (bvadd i #x0000000000000001))) (to_rep (select b (bvadd j #x0000000000000001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 64) unsigned_8)) (b (Array (_ BitVec 64) unsigned_8))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (bvugt (to_rep (select a (bvadd j #x0000000000000001))) (to_rep (select b (bvadd i #x0000000000000001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant1 ((temp___expr_155 (_ BitVec 8)) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool true)
...
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned_8))) (! (=> (dynamic_invariant addr true true true) (let ((result (readmem8 addr x86__memory))) (and (and (= result (to_rep (select x86__memory addr))) (bvuge result ((_ int2bv 8) 0))) (dynamic_invariant1 result true false true)))) :pattern ((readmem8 addr x86__memory))))))
(declare-const addr (_ BitVec 64))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const memory (Array (_ BitVec 64) unsigned_8))
(declare-const x86__readmem16__result (_ BitVec 16))
...
(declare-const x86__readmem16__result1 (_ BitVec 16))
(declare-const x86__readmem16__result2 (_ BitVec 16))
(declare-const x86__readmem16__result3 (_ BitVec 16))
...
(assert (and (= o1 (readmem8 (bvadd addr ((_ int2bv 64) 1)) memory)) (and (= o1 (to_rep (select memory (bvadd addr ((_ int2bv 64) 1))))) (bvuge o1 ((_ int2bv 8) 0)))))
(assert (= o2 ((_ zero_extend 8) o1)))
(assert (= o3 (bvmul o2 ((_ int2bv 16) 256))))
(assert (and (= o (readmem8 addr memory)) (and (= o (to_rep (select memory addr))) (bvuge o ((_ int2bv 8) 0)))))
(assert (= o4 ((_ zero_extend 8) o)))
(assert (= o5 (bvadd o4 o3)))
(assert (= result x86__readmem16__result))
(assert (= x86__readmem16__result1 o5))
(assert (= (mk_t__ref1 x86__readmem16__result4) (mk_t__ref1 x86__readmem16__result2)))
(assert (= x86__readmem16__result5 x86__readmem16__result3))
(assert (= result1 x86__readmem16__result4))
(assert (not (= x86__readmem16__result4 (bvadd ((_ zero_extend 8) (to_rep (select memory addr))) (bvmul ((_ zero_extend 8) (to_rep (select memory (bvadd addr ((_ int2bv 64) 1))))) ((_ int2bv 16) 256))))))
(check-sat)
(exit)
