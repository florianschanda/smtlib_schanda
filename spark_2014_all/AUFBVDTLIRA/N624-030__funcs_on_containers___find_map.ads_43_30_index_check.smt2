...
(define-fun dynamic_invariant3 ((temp___expr_331 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 0 2147483647)) (in_range4 temp___expr_331)))
...
(assert true)
(define-fun in_range6 ((rec__find_map__index_maps__map__capacity1 Int) (rec__find_map__index_maps__map__modulus1 (_ BitVec 32)) (a us_rep)) Bool (and (= rec__find_map__index_maps__map__capacity1 (to_rep3 (rec__find_map__index_maps__map__capacity (us_split_discrs1 a)))) (= rec__find_map__index_maps__map__modulus1 (to_rep2 (rec__find_map__index_maps__map__modulus (us_split_discrs1 a))))))
...
(define-fun dynamic_invariant4 ((temp___expr_575 us_rep) (temp___is_init_572 Bool) (temp___skip_constant_573 Bool) (temp___do_toplevel_574 Bool)) Bool (=> (not (= temp___skip_constant_573 true)) (in_range6 100 r258s temp___expr_575)))
...
(assert (forall ((a us_t)) (! (=> (dynamic_invariant2 a true true true) (let ((result (find_all a))) (and (and (forall ((i Int)) (=> (and (<= (first1 a) i) (<= i (last1 a))) (and (and (= (contains result (to_rep (select (to_array a) i))) true) (and (<= (first1 a) (element__2 result (to_rep (select (to_array a) i)))) (<= (element__2 result (to_rep (select (to_array a) i))) i))) (= (to_rep (select (to_array a) (element__2 result (to_rep (select (to_array a) i))))) (to_rep (select (to_array a) i)))))) (forall ((e Int)) (=> (and (<= 0 e) (<= e 2147483647)) (=> (= (contains result e) true) (and (and (<= (first1 a) (element__2 result e)) (<= (element__2 result e) (last1 a))) (= (to_rep (select (to_array a) (element__2 result e))) e)))))) (dynamic_invariant4 result true false true)))) :pattern ((find_all a)))))
...
(assert (forall ((m us_rep)) (! (=> (and (dynamic_invariant4 m true true true) (and (< 0 (length a)) (and (=> (= (contains m e) true) (and (<= (first1 a) (element__2 m e)) (<= (element__2 m e) (last1 a)))) (and (forall ((i Int)) (=> (and (<= (first1 a) i) (<= i (- (element__2 m e) 1))) (not (= (to_rep (select (to_array a) i)) e)))) (= (contains m e) true))))) (let ((result (find_map_bad m))) (and (=> (= result 0) (forall ((i Int)) (=> (and (<= (first1 a) i) (<= i last2)) (not (= (to_rep (select (to_array a) i)) e))))) (dynamic_invariant result true false true)))) :pattern ((find_map_bad m)))))
(assert (forall ((m us_rep)) (! (=> (dynamic_invariant4 m true true true) (= (find_map_bad m) (ite (<= (element__2 m e) last2) (element__2 m e) 0))) :pattern ((find_map_bad m)))))
...
(define-fun dynamic_invariant6 ((temp___expr_168 (_ BitVec 32)) (temp___is_init_165 Bool) (temp___skip_constant_166 Bool) (temp___do_toplevel_167 Bool)) Bool true)
(define-fun dynamic_invariant7 ((temp___expr_174 Int) (temp___is_init_171 Bool) (temp___skip_constant_172 Bool) (temp___do_toplevel_173 Bool)) Bool (=> (or (= temp___is_init_171 true) (<= 0 2147483647)) (in_range5 temp___expr_174)))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep3 (rec__find_map__index_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant7 result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant8 ((temp___expr_337 Int) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool)) Bool (=> (or (= temp___is_init_334 true) (<= 1 100)) (in_range7 temp___expr_337)))
(assert (forall ((attr__tag Int) (key Int)) (forall ((container us_rep)) (! (=> (dynamic_invariant3 key true true true) (dynamic_invariant8 (element__21 attr__tag container key) true false true)) :pattern ((element__21 attr__tag container key))))))
...
(assert (forall ((container us_rep1)) (! (dynamic_invariant7 (length3 container) true false true) :pattern ((length3 container)))))
...
(assert true)
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (and (dynamic_invariant9 key true true true) (= (has_key container key) true)) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant7 result true false true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep1)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant7 witness1 true true true) (= (has_witness container witness1) true)) (dynamic_invariant10 (w_get container witness1) true false true)) :pattern ((w_get container witness1))))))
...
(declare-const find_map__find_upto__m__assume2 us_main_type)
(declare-const o Int)
(declare-const i Int)
...
(assert (and (<= (to_rep1 (first (rt a))) last2) (<= last2 (to_rep1 (last (rt a))))))
(assert (and (= (mk___rep (mk___split_discrs find_map__find_upto__m__assume find_map__find_upto__m__assume1) (mk___split_fields find_map__find_upto__m__assume2)) (find_all a)) (and (and (= 100 (to_rep3 find_map__find_upto__m__assume)) (= r258s (to_rep2 find_map__find_upto__m__assume1))) (and (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 (to_rep1 (last (rt a))))) (and (and (= (has_key (model__ (mk___rep (mk___split_discrs find_map__find_upto__m__assume find_map__find_upto__m__assume1) (mk___split_fields find_map__find_upto__m__assume2))) (to_rep (select (elts a) i1))) true) (and (<= (to_rep1 (first (rt a))) (get (model__ (mk___rep (mk___split_discrs find_map__find_upto__m__assume find_map__find_upto__m__assume1) (mk___split_fields find_map__find_upto__m__assume2))) (to_rep (select (elts a) i1)))) (<= (get (model__ (mk___rep (mk___split_discrs find_map__find_upto__m__assume find_map__find_upto__m__assume1) (mk___split_fields find_map__find_upto__m__assume2))) (to_rep (select (elts a) i1))) i1))) (= (to_rep (select (elts a) (get (model__ (mk___rep (mk___split_discrs find_map__find_upto__m__assume find_map__find_upto__m__assume1) (mk___split_fields find_map__find_upto__m__assume2))) (to_rep (select (elts a) i1))))) (to_rep (select (elts a) i1)))))) (forall ((e1 Int)) (=> (and (<= 0 e1) (<= e1 2147483647)) (=> (= (has_key (model__ (mk___rep (mk___split_discrs find_map__find_upto__m__assume find_map__find_upto__m__assume1) (mk___split_fields find_map__find_upto__m__assume2))) e1) true) (and (and (<= (to_rep1 (first (rt a))) (get (model__ (mk___rep (mk___split_discrs find_map__find_upto__m__assume find_map__find_upto__m__assume1) (mk___split_fields find_map__find_upto__m__assume2))) e1)) (<= (get (model__ (mk___rep (mk___split_discrs find_map__find_upto__m__assume find_map__find_upto__m__assume1) (mk___split_fields find_map__find_upto__m__assume2))) e1) (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) (get (model__ (mk___rep (mk___split_discrs find_map__find_upto__m__assume find_map__find_upto__m__assume1) (mk___split_fields find_map__find_upto__m__assume2))) e1))) e1)))))))))
(assert (= (mk___rep (mk___split_discrs find_map__find_upto__m__assume find_map__find_upto__m__assume1) (mk___split_fields find_map__find_upto__m__assume2)) m))
...
(assert (and (and (= (mk_int__ref find_map__find_upto__result5) (mk_int__ref find_map__find_upto__result3)) (= find_map__find_upto__result6 find_map__find_upto__result4)) (and (and (= result (has_key (model__ m) e)) (= (= result true) (= (has_key (model__ m) e) true))) (ite (= result true) (and (and (= find_map__find_upto__result1 find_map__find_upto__result3) (= find_map__find_upto__result4 find_map__find_upto__result1)) (and (and (= o (find_map_bad m)) (and (in_range1 o) (and (= o (ite (<= (get (model__ m) e) last2) (get (model__ m) e) 0)) (=> (= o 0) (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 last2)) (not (= (to_rep (select (elts a) i1)) e)))))))) (and (= (mk_int__ref result1) (mk_int__ref find_map__find_upto__result)) (= find_map__find_upto__result1 o)))) (and (and (= find_map__find_upto__result2 find_map__find_upto__result3) (= find_map__find_upto__result4 find_map__find_upto__result2)) (and (= (mk_int__ref result2) (mk_int__ref find_map__find_upto__result)) (= find_map__find_upto__result2 0)))))))
(assert (= (mk_int__ref find_map__find_upto__result7) (mk_int__ref find_map__find_upto__result5)))
(assert (= find_map__find_upto__result8 find_map__find_upto__result6))
(assert (not (= find_map__find_upto__result7 0)))
(assert (<= (to_rep1 (first (rt a))) find_map__find_upto__result7))
(assert (<= find_map__find_upto__result7 last2))
(assert (not (<= (to_rep1 (first (rt a))) find_map__find_upto__result7)))
(check-sat)
(exit)
