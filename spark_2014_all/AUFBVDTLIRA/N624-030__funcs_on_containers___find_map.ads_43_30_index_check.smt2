...
(define-fun find_map__find_upto__m__assume3 () us_rep (mk___rep (mk___split_discrs find_map__find_upto__m__assume find_map__find_upto__m__assume1) (mk___split_fields find_map__find_upto__m__assume2)))
...
(assert (and (= find_map__find_upto__m__assume3 (find_all a)) (and (and (= 100 (to_rep3 find_map__find_upto__m__assume)) (= r258s (to_rep2 find_map__find_upto__m__assume1))) (and (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt a))) i) (<= i (to_rep1 (last (rt a))))) (and (and (= (has_key (model__ find_map__find_upto__m__assume3) (to_rep (select (elts a) i))) true) (and (<= (to_rep1 (first (rt a))) (get (model__ find_map__find_upto__m__assume3) (to_rep (select (elts a) i)))) (<= (get (model__ find_map__find_upto__m__assume3) (to_rep (select (elts a) i))) i))) (= (to_rep (select (elts a) (get (model__ find_map__find_upto__m__assume3) (to_rep (select (elts a) i))))) (to_rep (select (elts a) i)))))) (forall ((e1 Int)) (=> (and (<= 0 e1) (<= e1 2147483647)) (=> (= (has_key (model__ find_map__find_upto__m__assume3) e1) true) (and (and (<= (to_rep1 (first (rt a))) (get (model__ find_map__find_upto__m__assume3) e1)) (<= (get (model__ find_map__find_upto__m__assume3) e1) (to_rep1 (last (rt a))))) (= (to_rep (select (elts a) (get (model__ find_map__find_upto__m__assume3) e1))) e1)))))))))
...
(assert (=> (= result true) (and (= o (find_map_bad m)) (and (in_range1 o) (and (= o (ite (<= (get (model__ m) e) last2) (get (model__ m) e) 0)) (=> (= o 0) (forall ((i Int)) (=> (and (<= (to_rep1 (first (rt a))) i) (<= i last2)) (not (= (to_rep (select (elts a) i)) e))))))))))
