...
(define-fun dynamic_invariant3 ((temp___expr_360 Int) (temp___is_init_356 Bool) (temp___skip_constant_357 Bool) (temp___do_toplevel_358 Bool) (temp___do_typ_inv_359 Bool)) Bool (=> (or (= temp___is_init_356 true) (<= 0 2147483647)) (in_range4 temp___expr_360)))
...
(define-fun dynamic_invariant4 ((temp___expr_621 us_rep) (temp___is_init_617 Bool) (temp___skip_constant_618 Bool) (temp___do_toplevel_619 Bool) (temp___do_typ_inv_620 Bool)) Bool (=> (not (= temp___skip_constant_618 true)) (in_range6 100 r258s temp___expr_621)))
...
(assert (forall ((a us_t)) (! (=> (dynamic_invariant2 a true true true true) (let ((result (find_all a))) (and (and (forall ((i Int)) (=> (and (<= (first1 a) i) (<= i (last1 a))) (and (and (= (contains result (to_rep (select (to_array a) i))) true) (and (<= (first1 a) (element__2 result (to_rep (select (to_array a) i)))) (<= (element__2 result (to_rep (select (to_array a) i))) i))) (= (to_rep (select (to_array a) (element__2 result (to_rep (select (to_array a) i))))) (to_rep (select (to_array a) i)))))) (forall ((e Int)) (=> (and (<= 0 e) (<= e 2147483647)) (=> (= (contains result e) true) (and (and (<= (first1 a) (element__2 result e)) (<= (element__2 result e) (last1 a))) (= (to_rep (select (to_array a) (element__2 result e))) e)))))) (dynamic_invariant4 result true false true true)))) :pattern ((find_all a)))))
...
(define-fun dynamic_invariant7 ((temp___expr_198 Int) (temp___is_init_194 Bool) (temp___skip_constant_195 Bool) (temp___do_toplevel_196 Bool) (temp___do_typ_inv_197 Bool)) Bool (=> (or (= temp___is_init_194 true) (<= 0 2147483647)) (in_range5 temp___expr_198)))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (to_rep3 (rec__find_map__index_maps__map__capacity (us_split_discrs1 container)))) (dynamic_invariant7 result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant8 ((temp___expr_367 Int) (temp___is_init_363 Bool) (temp___skip_constant_364 Bool) (temp___do_toplevel_365 Bool) (temp___do_typ_inv_366 Bool)) Bool (=> (or (= temp___is_init_363 true) (<= 1 100)) (in_range7 temp___expr_367)))
(assert (forall ((attr__tag Int) (key Int)) (forall ((container us_rep)) (! (=> (dynamic_invariant3 key true true true true) (dynamic_invariant8 (element__21 attr__tag container key) true false true true)) :pattern ((element__21 attr__tag container key))))))
...
(assert (forall ((container us_rep1)) (! (dynamic_invariant7 (length3 container) true false true true) :pattern ((length3 container)))))
...
(assert true)
(assert (forall ((container us_rep1)) (forall ((key Int)) (! (=> (and (dynamic_invariant9 key true true true true) (= (has_key container key) true)) (let ((result (witness container key))) (and (= (has_witness container result) true) (dynamic_invariant7 result true false true true)))) :pattern ((witness container key))))))
(assert (forall ((container us_rep1)) (forall ((witness1 Int)) (! (=> (and (dynamic_invariant7 witness1 true true true true) (= (has_witness container witness1) true)) (dynamic_invariant10 (w_get container witness1) true false true true)) :pattern ((w_get container witness1))))))
