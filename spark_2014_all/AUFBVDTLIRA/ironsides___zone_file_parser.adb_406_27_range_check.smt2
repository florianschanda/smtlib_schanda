...
(assert (<= 1 i15))
(assert (<= i15 14))
(assert (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (- i16 1))) (and (<= 48 (to_rep (select (map__content timestring8) j1))) (<= (to_rep (select (map__content timestring8) j1)) 57)))))
(assert (and (=> (<= 1 14) (in_range8 i16)) (and (<= 1 i16) (<= i16 14))))
(assert (<= 1 (- i16 1)))
