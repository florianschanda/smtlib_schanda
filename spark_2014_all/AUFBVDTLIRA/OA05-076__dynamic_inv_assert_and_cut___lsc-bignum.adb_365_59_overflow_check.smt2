...
(assert (= a_msw3 o37))
(assert (= o104 (from_word32 #x00000001)))
...
(assert (= o97 (from_word32 #x00000002)))
...
(assert (and (= o88 (base Tuple0)) (= o88 (oexpon (from_word32 #x00000002) 32))))
...
(assert (= o87 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first o86)))
...
(assert (and (= o69 (base Tuple0)) (= o69 (oexpon (from_word32 #x00000002) 32))))
