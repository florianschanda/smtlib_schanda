...
(assert (and (= o153 o152) (in_range2 o152)))
(assert (and (= o149 (base Tuple0)) (= o149 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o154 (oexpon o149 o153)))
(assert (= o156 (omultiply o154 o155)))
(assert (and (= o145 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o146 (+ o145 1)))
