...
(define-fun to_int5 ((x (_ BitVec 8))) Int (ite (bvsge x (_ bv0 8)) (bv2nat x) (- (- 256 (bv2nat x)))))
...
(assert (forall ((x unsigned8)) (! (uint_in_range3 (to_int6 x)) :pattern ((to_int6 x)))))
...
(assert true)
(assert true)
(assert (and (and (bvugt rsp ((_ int2bv 64) 18446744069414584320)) (bvult rsp ((_ int2bv 64) 18446744073709551360))) (or (and (bvugt rsi (bvadd rsp ((_ int2bv 64) 8))) (bvult rsp ((_ int2bv 64) 18446744073709551360))) (and (bvult rsi ((_ int2bv 64) 18446462598732840960)) (bvugt rsi ((_ int2bv 64) 256))))))
(assert (and (= (readmem64 (bvsub rsp ((_ int2bv 64) 8)) memory1) rbp) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (and (and (and (and (and (and (and (not (= i (bvsub rsp ((_ int2bv 64) 8)))) (not (= i (bvadd (bvsub rsp ((_ int2bv 64) 8)) ((_ int2bv 64) 1))))) (not (= i (bvadd (bvsub rsp ((_ int2bv 64) 8)) ((_ int2bv 64) 2))))) (not (= i (bvadd (bvsub rsp ((_ int2bv 64) 8)) ((_ int2bv 64) 3))))) (not (= i (bvadd (bvsub rsp ((_ int2bv 64) 8)) ((_ int2bv 64) 4))))) (not (= i (bvadd (bvsub rsp ((_ int2bv 64) 8)) ((_ int2bv 64) 5))))) (not (= i (bvadd (bvsub rsp ((_ int2bv 64) 8)) ((_ int2bv 64) 6))))) (not (= i (bvadd (bvsub rsp ((_ int2bv 64) 8)) ((_ int2bv 64) 7))))) (= (to_rep (select memory1 i)) (to_rep (select memory i))))))))
(assert (= result rsp))
(assert (= rsp1 (bvsub rsp ((_ int2bv 64) 8))))
(assert (= result1 rbp))
(assert (= rbp1 rsp1))
(assert (and (= (readmem64 (bvsub rbp1 ((_ int2bv 64) 16)) memory2) rsi) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (and (and (and (and (and (and (and (not (= i (bvsub rbp1 ((_ int2bv 64) 16)))) (not (= i (bvadd (bvsub rbp1 ((_ int2bv 64) 16)) ((_ int2bv 64) 1))))) (not (= i (bvadd (bvsub rbp1 ((_ int2bv 64) 16)) ((_ int2bv 64) 2))))) (not (= i (bvadd (bvsub rbp1 ((_ int2bv 64) 16)) ((_ int2bv 64) 3))))) (not (= i (bvadd (bvsub rbp1 ((_ int2bv 64) 16)) ((_ int2bv 64) 4))))) (not (= i (bvadd (bvsub rbp1 ((_ int2bv 64) 16)) ((_ int2bv 64) 5))))) (not (= i (bvadd (bvsub rbp1 ((_ int2bv 64) 16)) ((_ int2bv 64) 6))))) (not (= i (bvadd (bvsub rbp1 ((_ int2bv 64) 16)) ((_ int2bv 64) 7))))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))
(assert (= (readmem64 (bvsub rbp1 ((_ int2bv 64) 16)) memory2) rsi))
(assert (and (= (readmem32 (bvsub rbp1 ((_ int2bv 64) 52)) memory3) ((_ int2bv 32) 0)) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (and (and (and (not (= i (bvsub rbp1 ((_ int2bv 64) 52)))) (not (= i (bvadd (bvsub rbp1 ((_ int2bv 64) 52)) ((_ int2bv 64) 1))))) (not (= i (bvadd (bvsub rbp1 ((_ int2bv 64) 52)) ((_ int2bv 64) 2))))) (not (= i (bvadd (bvsub rbp1 ((_ int2bv 64) 52)) ((_ int2bv 64) 3))))) (= (to_rep (select memory3 i)) (to_rep (select memory2 i))))))))
(assert (not (= (readmem64 (bvsub rbp1 ((_ int2bv 64) 16)) memory3) rsi)))
(check-sat)
(exit)
