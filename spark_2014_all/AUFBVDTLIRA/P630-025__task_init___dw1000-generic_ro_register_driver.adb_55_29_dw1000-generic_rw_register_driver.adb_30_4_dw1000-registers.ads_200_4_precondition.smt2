...
(define-fun tregister_byte_arrayP1__ref___4__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___4__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_2140 us_t1) (temp___is_init_2136 Bool) (temp___skip_constant_2137 Bool) (temp___do_toplevel_2138 Bool) (temp___do_typ_inv_2139 Bool)) Bool (=> (not (= temp___skip_constant_2137 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2140) (last3 temp___expr_2140)) (and (= (first3 temp___expr_2140) 1) (= (last3 temp___expr_2140) 4)))))
