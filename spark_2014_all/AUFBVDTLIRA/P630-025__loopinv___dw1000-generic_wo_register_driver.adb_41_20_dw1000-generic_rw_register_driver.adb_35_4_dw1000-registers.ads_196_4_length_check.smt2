...
(define-fun target__ref___projection ((a target__ref)) us_t1 (target__content a))
...
(declare-fun user_eq6 (bits_64 bits_64) Bool)
(declare-const dummy6 bits_64)
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__eui_type__eui (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__eui_type__eui (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_2110 us_t1) (temp___is_init_2106 Bool) (temp___skip_constant_2107 Bool) (temp___do_toplevel_2108 Bool) (temp___do_typ_inv_2109 Bool)) Bool (=> (not (= temp___skip_constant_2107 true)) (and (dynamic_property2 1 8 (first3 temp___expr_2110) (last3 temp___expr_2110)) (and (= (first3 temp___expr_2110) 1) (= (last3 temp___expr_2110) 8)))))
...
(define-fun register_byte_array__ref___3__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_2092 us_t2) (temp___is_init_2088 Bool) (temp___skip_constant_2089 Bool) (temp___do_toplevel_2090 Bool) (temp___do_typ_inv_2091 Bool)) Bool (=> (not (= temp___skip_constant_2089 true)) (and (dynamic_property3 1 8 (first5 temp___expr_2092) (last5 temp___expr_2092)) (and (= (first5 temp___expr_2092) 1) (= (last5 temp___expr_2092) 8)))))
...
(declare-const temp___84651 t1)
(define-fun temp___84652 () us_t1 (mk___t1 temp___8465 temp___84651))
(assert (and (dynamic_property3 1 8 (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 8))))
(assert (and (= temp___84652 (register_to_bytes reg)) (dynamic_invariant temp___84652 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___84651)) (to_rep (last2 temp___84651))) (+ (- (to_rep (last2 temp___84651)) (to_rep (first2 temp___84651))) 1) 0) (ite (<= 1 8) (+ (- 8 1) 1) 0))))
(check-sat)
(exit)
