...
(assert (and (= temp___76932 (register_to_bytes reg)) (dynamic_invariant1 temp___76932 true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___76931)) (to_rep (last4 temp___76931))) (+ (- (to_rep (last4 temp___76931)) (to_rep (first4 temp___76931))) 1) 0) (ite (<= 1 8) (+ (- 8 1) 1) 0))))
(check-sat)
(exit)
