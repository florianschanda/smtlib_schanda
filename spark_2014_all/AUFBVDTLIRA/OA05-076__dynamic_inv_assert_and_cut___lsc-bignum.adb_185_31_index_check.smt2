...
(assert (= o21 (+ b_first o20)))
(assert (and (= o22 o21) (in_range1 o21)))
(assert (and (= o23 o22) (in_range2 o22)))
(assert (= j2 result2))
(assert (= j3 o23))
(assert (and (<= (to_rep1 (first (rt b))) j3) (<= j3 (to_rep1 (last (rt b))))))
(assert (= o26 j3))
(assert (= o27 (select (elts b) o26)))
...
(assert (= result3 (ite (bvult o29 o28) true false)))
(assert (not (= result3 true)))
(assert (= result__3 result__2))
(assert (not (<= (to_rep1 (first (rt b))) j3)))
(check-sat)
(exit)
