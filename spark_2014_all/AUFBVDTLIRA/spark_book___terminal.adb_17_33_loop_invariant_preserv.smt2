...
(assert (= buffer3 o7))
(assert (and (= o8 (+ count2 1)) (in_range (+ count2 1))))
(assert (= result5 count2))
(assert (= count3 o8))
(assert (not (<= count3 (ite (<= (to_rep1 buffer__first) (to_rep1 buffer__last)) (+ (- (to_rep1 buffer__last) (to_rep1 buffer__first)) 1) 0))))
(check-sat)
(exit)
