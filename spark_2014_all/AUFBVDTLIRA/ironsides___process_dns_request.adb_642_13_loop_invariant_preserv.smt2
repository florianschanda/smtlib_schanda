...
(assert (<= byte2 (- input_bytes 5)))
(assert (not (= (to_rep1 (select (rec__dns_types__dns_packet__bytes (us_split_fields3 input_packet)) byte2)) #x00)))
(assert (< i1 129))
(assert (and (and (and (<= 1 i2) (< i2 129)) (<= 1 byte3)) (<= byte3 (- input_bytes 5))))
(assert (and (and (=> (<= 1 8180) (in_range5 byte3)) (=> (<= 0 2147483647) (in_range2 i2))) (and (and (<= byte3 (- input_bytes 5)) (not (= (to_rep1 (select (rec__dns_types__dns_packet__bytes (us_split_fields3 input_packet)) byte3)) #x00))) (< i2 129))))
(assert (= (to_rep o) (bv2nat (to_rep1 (select (rec__dns_types__dns_packet__bytes (us_split_fields3 input_packet)) byte3)))))
(assert (and (<= 1 i2) (<= i2 129)))
(assert (= o1 i2))
(assert (= o2 (store domainname2 o1 o)))
(assert (= domainname2 result3))
(assert (= domainname3 o2))
(assert (and (= o3 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= i2 result4))
(assert (= i3 o3))
(assert (and (= o4 (+ byte3 1)) (in_range5 (+ byte3 1))))
(assert (= byte3 result5))
(assert (= byte4 o4))
(assert (<= byte4 (- input_bytes 5)))
(assert (not (= (to_rep1 (select (rec__dns_types__dns_packet__bytes (us_split_fields3 input_packet)) byte4)) #x00)))
(assert (< i3 129))
(assert (not (<= 1 i3)))
(check-sat)
(exit)
