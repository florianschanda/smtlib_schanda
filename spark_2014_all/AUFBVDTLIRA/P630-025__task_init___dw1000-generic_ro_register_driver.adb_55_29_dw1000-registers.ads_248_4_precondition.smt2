...
(define-fun dynamic_invariant ((temp___expr_2904 us_t1) (temp___is_init_2901 Bool) (temp___skip_constant_2902 Bool) (temp___do_toplevel_2903 Bool)) Bool (=> (not (= temp___skip_constant_2902 true)) (and (dynamic_property2 1 8 (first3 temp___expr_2904) (last3 temp___expr_2904)) (and (= (first3 temp___expr_2904) 1) (= (last3 temp___expr_2904) 8)))))
