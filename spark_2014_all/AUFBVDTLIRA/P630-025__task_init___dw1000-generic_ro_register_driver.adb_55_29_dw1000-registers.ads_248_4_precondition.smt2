...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__rx_fqual_type__std_noise bits_16) (rec__dw1000__register_types__rx_fqual_type__fp_ampl2 bits_16) (rec__dw1000__register_types__rx_fqual_type__fp_ampl3 bits_16) (rec__dw1000__register_types__rx_fqual_type__cir_pwr bits_16)))))
(define-fun us_split_fields_STD_NOISE__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__rx_fqual_type__std_noise a))
(define-fun us_split_fields_FP_AMPL2__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__rx_fqual_type__fp_ampl2 a))
(define-fun us_split_fields_FP_AMPL3__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__rx_fqual_type__fp_ampl3 a))
(define-fun us_split_fields_CIR_PWR__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__rx_fqual_type__cir_pwr a))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep2 (rec__dw1000__register_types__rx_fqual_type__std_noise (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_fqual_type__std_noise (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__rx_fqual_type__fp_ampl2 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_fqual_type__fp_ampl2 (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__rx_fqual_type__fp_ampl3 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_fqual_type__fp_ampl3 (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__rx_fqual_type__cir_pwr (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_fqual_type__cir_pwr (us_split_fields1 b))))) true false))
...
(assert (<= 0 dw1000__register_types__rx_fqual_type__std_noise__first__bit))
(assert (< dw1000__register_types__rx_fqual_type__std_noise__first__bit dw1000__register_types__rx_fqual_type__std_noise__last__bit))
...
(assert (< dw1000__register_types__rx_fqual_type__fp_ampl2__first__bit dw1000__register_types__rx_fqual_type__fp_ampl2__last__bit))
...
(assert (< dw1000__register_types__rx_fqual_type__fp_ampl3__first__bit dw1000__register_types__rx_fqual_type__fp_ampl3__last__bit))
...
(assert (< dw1000__register_types__rx_fqual_type__cir_pwr__first__bit dw1000__register_types__rx_fqual_type__cir_pwr__last__bit))
(assert (<= 0 dw1000__register_types__rx_fqual_type__cir_pwr__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((rx_fqual_type__ref (mk_rx_fqual_type__ref (rx_fqual_type__content us_rep)))))
(define-fun rx_fqual_type__ref___projection ((a rx_fqual_type__ref)) us_rep (rx_fqual_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___33__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___24__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___24__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3198 us_t1) (temp___is_init_3194 Bool) (temp___skip_constant_3195 Bool) (temp___do_toplevel_3196 Bool) (temp___do_typ_inv_3197 Bool)) Bool (=> (not (= temp___skip_constant_3195 true)) (and (dynamic_property2 1 8 (first3 temp___expr_3198) (last3 temp___expr_3198)) (and (= (first3 temp___expr_3198) 1) (= (last3 temp___expr_3198) 8)))))
