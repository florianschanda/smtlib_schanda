...
(define-fun register_type__ref___238__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___170__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___170__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_8334 us_t1) (temp___is_init_8330 Bool) (temp___skip_constant_8331 Bool) (temp___do_toplevel_8332 Bool) (temp___do_typ_inv_8333 Bool)) Bool (=> (not (= temp___skip_constant_8331 true)) (and (dynamic_property2 1 2 (first3 temp___expr_8334) (last3 temp___expr_8334)) (and (= (first3 temp___expr_8334) 1) (= (last3 temp___expr_8334) 2)))))
