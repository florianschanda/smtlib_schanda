...
(assert (= (ite signflag15 1 0) (ite overflowflag15 1 0)))
...
(assert (= xmm017 o113))
(assert (= (writereg32post (let ((subject rdi)) rdi21) #x0040112B) true))
(assert (= (writereg32post rax13 #x00000001) true))
(assert (and (= o114 (ebx (let ((subject rbx)) rbx16))) (= o114 (readreg32 (let ((subject rbx)) rbx16)))))
(assert (= o115 (bvadd o114 #x00000001)))
(assert (= (writereg32post (let ((subject rbx)) rbx17) o115) true))
(assert (= result83 (let ((subject rbp)) (mk_t__ref3 rbp16))))
(assert (= (let ((subject rbp)) rbp17) (bvadd (let ((subject rbp)) rbp16) #x0000000000000008)))
(assert (= result84 (let ((subject rsp)) (mk_t__ref3 rsp40))))
(assert (= (let ((subject rsp)) rsp41) (bvsub (let ((subject rsp)) rsp40) #x0000000000000008)))
(assert (= (let ((subject rsp)) rsp42) (bvadd (let ((subject rsp)) rsp41) #x0000000000000008)))
...
(assert (= o119 (ite (= o118 #x00000000) true false)))
...
(assert (= o123 (ite (bvugt o122 #x7FFFFFFF) true false)))
...
(assert (=> (not (= signflag17 true)) (= result88 (ite (bvugt o130 #x7FFFFFFF) true false))))
...
(assert (=> (= result88 true) (= o131 (ite (bvule o129 #x7FFFFFFF) true false))))
...
(assert (=> (= signflag17 true) (= result89 (ite (bvugt o128 #x7FFFFFFF) true false))))
...
(assert (=> (= result89 true) (= o132 (ite (bvule o127 #x7FFFFFFF) true false))))
...
(assert (= (ite signflag17 1 0) (ite overflowflag17 1 0)))
