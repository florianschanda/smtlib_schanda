...
(assert (and (and (and (and (in_range6 (hash_bit_len_of (mk___rep2 ctx__split_fields12))) (= (hash_bit_len_of (mk___rep2 ctx__split_fields12)) #x0000000000000200)) (= (byte_count_of (mk___rep2 ctx__split_fields12)) #x0000000000000000)) (in_range7 (byte_count_of (mk___rep2 ctx__split_fields12)))) (bvult (to_rep (last (mk #x0000000000000000 #x000000000000003F))) #xFFFFFFFFFFFFFFFF)))
(assert (not (in_range6 (hash_bit_len_of (mk___rep2 ctx__split_fields12)))))
(check-sat)
(exit)
