...
(define-fun register_byte_array__ref___109__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5718 us_t1) (temp___is_init_5715 Bool) (temp___skip_constant_5716 Bool) (temp___do_toplevel_5717 Bool)) Bool (=> (not (= temp___skip_constant_5716 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5718) (last3 temp___expr_5718)) (and (= (first3 temp___expr_5718) 1) (= (last3 temp___expr_5718) 1)))))
(declare-sort t2 0)
...
(define-fun target__ref___46__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_5734 us_t2) (temp___is_init_5731 Bool) (temp___skip_constant_5732 Bool) (temp___do_toplevel_5733 Bool)) Bool (=> (not (= temp___skip_constant_5732 true)) (and (dynamic_property3 1 1 (first5 temp___expr_5734) (last5 temp___expr_5734)) (and (= (first5 temp___expr_5734) 1) (= (last5 temp___expr_5734) 1)))))
...
(assert (and (= (mk___t2 temp___8048 temp___80481) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8048 temp___80481) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___80481)) (to_rep (last4 temp___80481))) (+ (- (to_rep (last4 temp___80481)) (to_rep (first4 temp___80481))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
