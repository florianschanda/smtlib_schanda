...
(assert (<= i25 128))
(assert (<= 1 endidx11))
(assert (and (and (=> (<= r81b 128) (dynamic_property2 r81b 128 i26)) (forall ((temp___1690 Int)) (=> (and (<= 1 temp___1690) (<= temp___1690 128)) (=> (<= i26 temp___1690) (= (select newdomainname12 temp___1690) (select (map__content newdomainname10) temp___1690)))))) (and (<= r81b i26) (<= i26 128))))
(assert (= (to_rep o9) 32))
(assert (= o10 (store newdomainname12 i26 o9)))
(assert (= result17 (mk_map__ref newdomainname12)))
(assert (= newdomainname13 o10))
(assert (not (= i26 128)))
(assert (= result18 (mk_int__ref i26)))
(assert (= i27 (+ i26 1)))
