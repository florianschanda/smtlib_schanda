...
(assert (<= i15 128))
(assert (<= 1 endidx9))
(assert (and (and (=> (<= r81b 128) (dynamic_property2 r81b 128 i16)) (forall ((temp___1749 Int)) (=> (and (<= 1 temp___1749) (<= temp___1749 128)) (=> (<= i16 temp___1749) (= (select newdomainname8 temp___1749) (select (map__content newdomainname6) temp___1749)))))) (and (<= r81b i16) (<= i16 128))))
(assert (= (to_rep o9) 32))
