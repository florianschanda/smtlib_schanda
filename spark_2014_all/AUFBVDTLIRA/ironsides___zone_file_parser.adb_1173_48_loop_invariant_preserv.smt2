...
(assert (= i3 r75b))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= temp___1739 i3)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= temp___1738 tmpval1)))
(assert (=> (and (<= r75b i3) (<= i3 r76b)) (= temp___1737 digitval)))
...
(assert (= i9 r78b))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= temp___1744 newdomainname1)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= temp___1743 i9)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= temp___1746 endidx9)))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (and (and (<= 1 begidx13) (<= (+ (- endidx9 begidx13) 1) 128)) (= endidx9 temp___1746))))
...
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (and (= temp___1742 o5) (in_range1 o5))))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (and (<= 1 temp___1742) (<= temp___1742 128))))
(assert (=> (and (<= r78b i9) (<= i9 r79b)) (= o7 temp___1742)))
...
(assert (<= i15 128))
(assert (<= 1 endidx9))
(assert (and (and (=> (<= r81b 128) (dynamic_property2 r81b 128 i16)) (forall ((temp___1751 Int)) (=> (and (<= 1 temp___1751) (<= temp___1751 128)) (=> (or (< 128 temp___1751) (or (< temp___1751 r81b) (<= i16 temp___1751))) (= (select newdomainname8 temp___1751) (select (map__content newdomainname6) temp___1751)))))) (and (<= r81b i16) (<= i16 128))))
(assert (= (to_rep o9) 32))
(assert (= o10 (store newdomainname8 i16 o9)))
(assert (= result15 (mk_map__ref newdomainname8)))
(assert (= newdomainname9 o10))
(assert (not (= i16 128)))
(assert (= result16 (mk_int__ref i16)))
(assert (= i17 (+ i16 1)))
