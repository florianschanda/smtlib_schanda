...
(assert (= result value))
(assert (= value1 o4))
(assert (not (and (<= 0 (to_rep1 g__split_fields1)) (<= (to_rep1 g__split_fields1) 226))))
(assert (<= 227 (to_rep1 g__split_fields1)))
(assert (<= (to_rep1 g__split_fields1) 622))
(assert (not (in_range1 (+ (to_rep1 g__split_fields1) (- 227)))))
(check-sat)
(exit)
