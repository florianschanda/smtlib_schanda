...
(assert (=> (= error1 0) (=> (= result2 true) (= o2 temp___4540))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk2 1 r9b) temp___45401))))
(assert (=> (= error1 0) (=> (= result2 true) (= (ite (<= (to_rep1 (first4 temp___45401)) (to_rep1 (last4 temp___45401))) (+ (- (to_rep1 (last4 temp___45401)) (to_rep1 (first4 temp___45401))) 1) 0) (ite (<= (to_rep1 frame__first) r6b) (+ (- r6b (to_rep1 frame__first)) 1) 0)))))
(assert (=> (= error1 0) (=> (= result2 true) (= (slide temp___4540 (to_rep1 (first4 temp___45401)) (to_rep1 frame__first)) temp___4541))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk1 (to_rep1 frame__first) r6b) temp___45411))))
...
(assert (=> (= error1 0) (=> (= result2 true) (= o3 temp___4543))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk1 (to_rep1 frame__first) r6b) temp___45431))))
(assert (=> (= error1 0) (=> (= result2 true) (= (ite (<= (to_rep1 (first2 temp___45411)) (to_rep1 (last2 temp___45411))) (+ (- (to_rep1 (last2 temp___45411)) (to_rep1 (first2 temp___45411))) 1) 0) (ite (<= (to_rep1 (first2 temp___45431)) (to_rep1 (last2 temp___45431))) (+ (- (to_rep1 (last2 temp___45431)) (to_rep1 (first2 temp___45431))) 1) 0)))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk___t1 temp___4544 temp___45441) (mk___t1 temp___4541 temp___45411)))))
(assert (=> (= error1 0) (=> (= result2 true) (forall ((temp___4545 Int)) (ite (and (<= (to_rep1 frame__first) temp___4545) (<= temp___4545 r6b)) (= (select o4 temp___4545) (select temp___4544 temp___4545)) (= (select o4 temp___4545) (select frame temp___4545)))))))
(assert (=> (= error1 0) (=> (= result2 true) (= result3 (mk_map__ref frame)))))
...
(assert (=> (= error1 0) (=> (not (= result2 true)) (and (= temp___4531 o5) (in_range1 o5)))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (=> (<= 1 temp___4531) (and (and (<= 0 1) (<= 1 1024)) (and (<= 0 temp___4531) (<= temp___4531 1024)))))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= o6 (rec__decadriver__rx_frame_type__frame (us_split_fields1 (select self__ (to_rep5 self__1))))))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= o6 temp___4534))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (mk3 1 temp___4531) temp___45341))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= temp___4534 temp___4535))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (mk (to_rep1 (first6 temp___45341)) (to_rep1 (last6 temp___45341))) temp___45351))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (ite (<= (to_rep1 (first temp___45351)) (to_rep1 (last temp___45351))) (+ (- (to_rep1 (last temp___45351)) (to_rep1 (first temp___45351))) 1) 0) (ite (<= (to_rep1 frame__first) (to_rep1 frame__last)) (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1) 0)))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (mk___t temp___4536 temp___45361) (mk___t temp___4535 temp___45351)))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= o7 (slide temp___4536 (to_rep1 (first temp___45361)) (to_rep1 frame__first))))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= result4 (mk_map__ref frame)))))
