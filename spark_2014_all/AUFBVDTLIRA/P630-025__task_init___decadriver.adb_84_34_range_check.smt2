...
(declare-const temp___5037 (Array Int bits_8))
(declare-const temp___50371 t1)
(declare-const o4 (Array Int bits_8))
(declare-const o5 Int)
(declare-const temp___5024 Int)
(declare-const o6 (Array Int bits_8))
(declare-const temp___5027 (Array Int bits_8))
(declare-const temp___50271 t3)
(declare-const temp___5028 (Array Int bits_8))
(declare-const temp___50281 t)
(declare-const temp___5029 (Array Int bits_8))
(declare-const temp___50291 t)
...
(assert (=> (= error1 0) (=> (= result2 true) (= o2 temp___5033))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk2 1 r9b) temp___50331))))
(assert (=> (= error1 0) (=> (= result2 true) (= (ite (<= (to_rep1 (first4 temp___50331)) (to_rep1 (last4 temp___50331))) (+ (- (to_rep1 (last4 temp___50331)) (to_rep1 (first4 temp___50331))) 1) 0) (ite (<= (to_rep1 frame__first) r6b) (+ (- r6b (to_rep1 frame__first)) 1) 0)))))
(assert (=> (= error1 0) (=> (= result2 true) (= (slide temp___5033 (to_rep1 (first4 temp___50331)) (to_rep1 frame__first)) temp___5034))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk1 (to_rep1 frame__first) r6b) temp___50341))))
...
(assert (=> (= error1 0) (=> (= result2 true) (= o3 temp___5036))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk1 (to_rep1 frame__first) r6b) temp___50361))))
(assert (=> (= error1 0) (=> (= result2 true) (= (ite (<= (to_rep1 (first2 temp___50341)) (to_rep1 (last2 temp___50341))) (+ (- (to_rep1 (last2 temp___50341)) (to_rep1 (first2 temp___50341))) 1) 0) (ite (<= (to_rep1 (first2 temp___50361)) (to_rep1 (last2 temp___50361))) (+ (- (to_rep1 (last2 temp___50361)) (to_rep1 (first2 temp___50361))) 1) 0)))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk___t1 temp___5037 temp___50371) (mk___t1 temp___5034 temp___50341)))))
(assert (=> (= error1 0) (=> (= result2 true) (forall ((temp___5038 Int)) (ite (and (<= (to_rep1 frame__first) temp___5038) (<= temp___5038 r6b)) (= (select o4 temp___5038) (select temp___5037 temp___5038)) (= (select o4 temp___5038) (select frame temp___5038)))))))
...
(assert (=> (= error1 0) (=> (not (= result2 true)) (and (= temp___5024 o5) (in_range1 o5)))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (=> (<= 1 temp___5024) (and (and (<= 0 1) (<= 1 1024)) (and (<= 0 temp___5024) (<= temp___5024 1024)))))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= o6 (rec__decadriver__rx_frame_type__frame (us_split_fields1 (select self__ (to_rep5 self__1))))))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= o6 temp___5027))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (mk3 1 temp___5024) temp___50271))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= temp___5027 temp___5028))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (mk (to_rep1 (first6 temp___50271)) (to_rep1 (last6 temp___50271))) temp___50281))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (ite (<= (to_rep1 (first temp___50281)) (to_rep1 (last temp___50281))) (+ (- (to_rep1 (last temp___50281)) (to_rep1 (first temp___50281))) 1) 0) (ite (<= (to_rep1 frame__first) (to_rep1 frame__last)) (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1) 0)))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (mk___t temp___5029 temp___50291) (mk___t temp___5028 temp___50281)))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= o7 (slide temp___5029 (to_rep1 (first temp___50291)) (to_rep1 frame__first))))))
