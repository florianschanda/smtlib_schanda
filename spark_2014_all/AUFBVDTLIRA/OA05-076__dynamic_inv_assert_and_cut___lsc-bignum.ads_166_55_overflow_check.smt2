...
(assert (= o32 (+ b_first o31)))
(assert (and (= o33 o32) (in_range1 o32)))
(assert (= o34 (ite (<= o33 (to_rep (last (rt b)))) true false)))
(assert (and (= o28 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o29 (+ b_first o28)))
(assert (and (= o30 o29) (in_range1 o29)))
(assert (= o35 (ite (<= (to_rep (first (rt b))) o30) true false)))
