...
(define-fun in_range5 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x03)))
...
(define-fun in_range7 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x03)))
...
(define-fun dynamic_invariant3 ((temp___expr_3671 us_rep1) (temp___is_init_3667 Bool) (temp___skip_constant_3668 Bool) (temp___do_toplevel_3669 Bool) (temp___do_typ_inv_3670 Bool)) Bool (= (attr__constrained (rec__crtp_pack__crtp_packet_handler__packet (us_split_fields3 temp___expr_3671))) false))
(define-fun default_initial_assumption ((temp___expr_3676 us_rep1) (temp___skip_top_level_3677 Bool)) Bool (and (= (attr__constrained (rec__crtp_pack__crtp_packet_handler__packet (us_split_fields3 temp___expr_3676))) false) (= (to_rep5 (rec__crtp_pack__crtp_packet__repr (us_split_discrs1 (rec__crtp_pack__crtp_packet_handler__packet (us_split_fields3 temp___expr_3676))))) 0)))
...
(define-fun dynamic_invariant4 ((temp___expr_4081 Int) (temp___is_init_4077 Bool) (temp___skip_constant_4078 Bool) (temp___do_toplevel_4079 Bool) (temp___do_typ_inv_4080 Bool)) Bool (=> (or (= temp___is_init_4077 true) (<= 0 255)) (in_range9 temp___expr_4081)))
...
(define-fun dynamic_invariant5 ((temp___expr_4106 Int) (temp___is_init_4102 Bool) (temp___skip_constant_4103 Bool) (temp___do_toplevel_4104 Bool) (temp___do_typ_inv_4105 Bool)) Bool (=> (or (= temp___is_init_4102 true) (<= 0 255)) (in_range11 temp___expr_4106)))
...
(define-fun dynamic_invariant6 ((temp___expr_3597 (_ BitVec 8)) (temp___is_init_3593 Bool) (temp___skip_constant_3594 Bool) (temp___do_toplevel_3595 Bool) (temp___do_typ_inv_3596 Bool)) Bool (=> (or (= temp___is_init_3593 true) (bvule #x00 #x03)) (in_range5 temp___expr_3597)))
(define-fun dynamic_invariant7 ((temp___expr_3604 Int) (temp___is_init_3600 Bool) (temp___skip_constant_3601 Bool) (temp___do_toplevel_3602 Bool) (temp___do_typ_inv_3603 Bool)) Bool (=> (or (= temp___is_init_3600 true) (<= 0 6)) (in_range6 temp___expr_3604)))
(define-fun dynamic_invariant8 ((temp___expr_3611 (_ BitVec 8)) (temp___is_init_3607 Bool) (temp___skip_constant_3608 Bool) (temp___do_toplevel_3609 Bool) (temp___do_typ_inv_3610 Bool)) Bool (=> (or (= temp___is_init_3607 true) (bvule #x00 #x03)) (in_range7 temp___expr_3611)))
(define-fun dynamic_invariant9 ((temp___expr_3638 Int) (temp___is_init_3634 Bool) (temp___skip_constant_3635 Bool) (temp___do_toplevel_3636 Bool) (temp___do_typ_inv_3637 Bool)) Bool (=> (or (= temp___is_init_3634 true) (<= 0 2)) (in_range8 temp___expr_3638)))
(define-fun default_initial_assumption1 ((temp___expr_3650 us_rep) (temp___skip_top_level_3651 Bool)) Bool (and (= (attr__constrained temp___expr_3650) false) (= (to_rep5 (rec__crtp_pack__crtp_packet__repr (us_split_discrs1 temp___expr_3650))) 0)))
(define-fun dynamic_invariant10 ((temp___expr_2026 (_ BitVec 8)) (temp___is_init_2022 Bool) (temp___skip_constant_2023 Bool) (temp___do_toplevel_2024 Bool) (temp___do_typ_inv_2025 Bool)) Bool true)
(assert (= data_size 1))
(declare-const handler__split_fields crpt_packet_representation)
(declare-const handler__split_fields1 Bool)
(declare-const handler__split_fields2 positive)
(declare-const o Int)
(declare-const o1 Int)
(declare-const o2 Int)
(declare-const console_pack__console_put_line__crtp_append_character_data__R7b__assume Int)
(declare-const temp___4187 (Array Int t_uint8))
(declare-const temp___4188 (Array Int t_uint8))
(declare-const temp___41881 t)
(declare-const result Bool)
(assert (= handler__split_fields1 false))
(assert (in_range9 data))
(assert (in_range2 data_size))
(assert (and (= o (+ (to_rep handler__split_fields2) 1)) (in_range1 (+ (to_rep handler__split_fields2) 1))))
(assert (= o1 (- o 1)))
(assert (= result (ite (<= o1 30) true false)))
(assert (= result true))
(assert (= (to_rep handler__split_fields2) r6b))
(assert (in_range3 r6b))
(assert (and (= o2 (+ (to_rep handler__split_fields2) 1)) (in_range1 (+ (to_rep handler__split_fields2) 1))))
...
(assert (= temp___4187 (data_to_byte_array data)))
(assert (= (ite (<= 1 1) (+ (- 1 1) 1) 0) (ite (<= r6b r7b) (+ (- r7b r6b) 1) 0)))
(assert (= (slide temp___4187 1 r6b) temp___4188))
(assert (= (mk r6b r7b) temp___41881))
