...
(define-fun to_int3 ((x t_uint8)) Int (bv2nat (to_rep1 x)))
(assert (forall ((x t_uint8)) (! (uint_in_range (to_int3 x)) :pattern ((to_int3 x)))))
...
(declare-fun concat1 ((Array Int t_uint8) Int Int (Array Int t_uint8) Int Int) (Array Int t_uint8))
(assert (forall ((a (Array Int t_uint8)) (b (Array Int t_uint8))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (forall ((i Int)) (! (and (=> (and (<= a_first i) (<= i a_last)) (= (select (concat1 a a_first a_last b b_first b_last) i) (select a i))) (=> (< a_last i) (= (select (concat1 a a_first a_last b b_first b_last) i) (select b (+ (- i a_last) (- b_first 1)))))) :pattern ((select (concat1 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton1 (t_uint8 Int) (Array Int t_uint8))
(assert (forall ((v t_uint8)) (forall ((i Int)) (! (= (select (singleton1 v i) i) v) :pattern ((select (singleton1 v i) i))))))
(define-fun bool_eq ((a (Array Int t_uint8)) (a__first Int) (a__last Int) (b (Array Int t_uint8)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_181 Int)) (=> (and (<= a__first temp___idx_181) (<= temp___idx_181 a__last)) (= (to_rep1 (select a temp___idx_181)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_181))))))) true false))
(assert (forall ((a (Array Int t_uint8)) (b (Array Int t_uint8))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_181 Int)) (=> (and (<= a__first temp___idx_181) (<= temp___idx_181 a__last)) (= (to_rep1 (select a temp___idx_181)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_181)))))))))))
(declare-fun compare ((Array Int t_uint8) Int Int (Array Int t_uint8) Int Int) Int)
(assert (forall ((a (Array Int t_uint8)) (b (Array Int t_uint8))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int t_uint8)) (b (Array Int t_uint8))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (bvult (to_rep1 (select a (+ i 1))) (to_rep1 (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int t_uint8)) (b (Array Int t_uint8))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (bvugt (to_rep1 (select a (+ j 1))) (to_rep1 (select b (+ i 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(declare-sort tcrtp_dataP1 0)
(define-fun in_range4 ((x Int)) Bool (and (<= 1 x) (<= x 30)))
(declare-fun attr__ATTRIBUTE_IMAGE5 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check5 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE5 (us_image) Int)
(declare-fun user_eq4 (tcrtp_dataP1 tcrtp_dataP1) Bool)
(declare-const dummy4 tcrtp_dataP1)
...
(define-fun in_range5 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 3))))
...
(assert (forall ((x crtp_channel)) (! (in_range5 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x (_ BitVec 8))) (! (=> (in_range5 x) (= (to_rep2 (of_rep2 x)) x)) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun to_int4 ((x crtp_channel)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x crtp_channel)) (! (in_range_int (to_int4 x)) :pattern ((to_int4 x)))))
(declare-sort crtp_port 0)
(define-fun in_range6 ((x Int)) Bool (and (<= 0 x) (<= x 6)))
(declare-fun attr__ATTRIBUTE_IMAGE7 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check7 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE7 (us_image) Int)
(declare-fun user_eq6 (crtp_port crtp_port) Bool)
(declare-const dummy6 crtp_port)
...
(assert (forall ((x crtp_port)) (! (in_range6 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(define-fun in_range7 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 3))))
...
(declare-fun user_eq7 (crtp_reserved crtp_reserved) Bool)
(declare-const dummy7 crtp_reserved)
...
(assert (forall ((x crtp_reserved)) (! (in_range7 (to_rep4 x)) :pattern ((to_rep4 x)))))
(assert (forall ((x (_ BitVec 8))) (! (=> (in_range7 x) (= (to_rep4 (of_rep4 x)) x)) :pattern ((to_rep4 (of_rep4 x))))))
(define-fun to_int5 ((x crtp_reserved)) Int (bv2nat (to_rep4 x)))
(assert (forall ((x crtp_reserved)) (! (in_range_int1 (to_int5 x)) :pattern ((to_int5 x)))))
...
(declare-fun user_eq10 (crpt_packet_representation crpt_packet_representation) Bool)
(declare-const dummy10 crpt_packet_representation)
...
(assert (forall ((x crpt_packet_representation)) (! (in_range8 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(define-fun us_split_fields_Size__2__projection ((a us_split_fields)) t_uint8 (rec__crtp_pack__crtp_packet__size a))
...
(define-fun us_rep___45__projection ((a us_rep)) us_split_discrs (us_split_discrs1 a))
(define-fun us_rep___46__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun us_rep___47__projection ((a us_rep)) Bool (attr__constrained a))
...
(define-fun us_split_fields__ref___45__projection ((a us_split_fields__ref1)) us_split_fields2 (us_split_fields__content1 a))
...
(define-fun dynamic_invariant3 ((temp___expr_3329 us_rep1) (temp___is_init_3326 Bool) (temp___skip_constant_3327 Bool) (temp___do_toplevel_3328 Bool)) Bool (= (attr__constrained (rec__crtp_pack__crtp_packet_handler__packet (us_split_fields3 temp___expr_3329))) false))
(define-fun default_initial_assumption ((temp___expr_3334 us_rep1) (temp___skip_top_level_3335 Bool)) Bool (and (= (attr__constrained (rec__crtp_pack__crtp_packet_handler__packet (us_split_fields3 temp___expr_3334))) false) (= (to_rep5 (rec__crtp_pack__crtp_packet__repr (us_split_discrs1 (rec__crtp_pack__crtp_packet_handler__packet (us_split_fields3 temp___expr_3334))))) 0)))
(declare-sort t_data 0)
(define-fun in_range9 ((x Int)) Bool (and (<= 0 x) (<= x 255)))
(declare-fun attr__ATTRIBUTE_IMAGE10 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check10 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE10 (us_image) Int)
(declare-fun user_eq13 (t_data t_data) Bool)
(declare-const dummy13 t_data)
...
(define-fun dynamic_invariant4 ((temp___expr_3736 Int) (temp___is_init_3733 Bool) (temp___skip_constant_3734 Bool) (temp___do_toplevel_3735 Bool)) Bool (=> (or (= temp___is_init_3733 true) (<= 0 255)) (in_range9 temp___expr_3736)))
...
(define-fun dynamic_invariant5 ((temp___expr_3759 Int) (temp___is_init_3756 Bool) (temp___skip_constant_3757 Bool) (temp___do_toplevel_3758 Bool)) Bool (=> (or (= temp___is_init_3756 true) (<= 0 255)) (in_range11 temp___expr_3759)))
...
(declare-fun to_rep6 (integer) Int)
...
(define-fun dynamic_invariant6 ((temp___expr_3262 (_ BitVec 8)) (temp___is_init_3259 Bool) (temp___skip_constant_3260 Bool) (temp___do_toplevel_3261 Bool)) Bool (=> (or (= temp___is_init_3259 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 3))) (in_range5 temp___expr_3262)))
(define-fun dynamic_invariant7 ((temp___expr_3268 Int) (temp___is_init_3265 Bool) (temp___skip_constant_3266 Bool) (temp___do_toplevel_3267 Bool)) Bool (=> (or (= temp___is_init_3265 true) (<= 0 6)) (in_range6 temp___expr_3268)))
(define-fun dynamic_invariant8 ((temp___expr_3274 (_ BitVec 8)) (temp___is_init_3271 Bool) (temp___skip_constant_3272 Bool) (temp___do_toplevel_3273 Bool)) Bool (=> (or (= temp___is_init_3271 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 3))) (in_range7 temp___expr_3274)))
(define-fun dynamic_invariant9 ((temp___expr_3298 Int) (temp___is_init_3295 Bool) (temp___skip_constant_3296 Bool) (temp___do_toplevel_3297 Bool)) Bool (=> (or (= temp___is_init_3295 true) (<= 0 2)) (in_range8 temp___expr_3298)))
(define-fun default_initial_assumption1 ((temp___expr_3309 us_rep) (temp___skip_top_level_3310 Bool)) Bool (and (= (attr__constrained temp___expr_3309) false) (= (to_rep5 (rec__crtp_pack__crtp_packet__repr (us_split_discrs1 temp___expr_3309))) 0)))
(define-fun dynamic_invariant10 ((temp___expr_1834 (_ BitVec 8)) (temp___is_init_1831 Bool) (temp___skip_constant_1832 Bool) (temp___do_toplevel_1833 Bool)) Bool true)
(assert (= data_size 1))
(declare-const handler__split_fields crpt_packet_representation)
(declare-const handler__split_fields1 t_uint8)
(declare-const handler__split_fields2 crtp_channel)
(declare-const handler__split_fields3 crtp_reserved)
(declare-const handler__split_fields4 crtp_port)
(declare-const handler__split_fields5 (Array Int t_uint8))
(declare-const handler__split_fields6 t_uint8)
(declare-const handler__split_fields7 (Array Int t_uint8))
(declare-const handler__split_fields8 (Array Int t_uint8))
(declare-const handler__split_fields9 Bool)
(declare-const handler__split_fields10 positive)
(declare-const o Int)
(declare-const o1 Int)
(declare-const o2 Int)
(declare-const console_pack__console_put_line__crtp_append_character_data__R7b__assume Int)
(declare-const temp___3839 (Array Int t_uint8))
(declare-const temp___3840 (Array Int t_uint8))
(declare-const temp___38401 t)
(declare-const o3 (Array Int t_uint8))
(declare-const temp___3842 (Array Int t_uint8))
(declare-const temp___38421 t)
(declare-const temp___3844 (Array Int t_uint8))
(declare-const temp___38441 t)
(declare-const o4 (Array Int t_uint8))
(declare-const o5 t_uint8)
(declare-const o6 crtp_channel)
(declare-const o7 crtp_reserved)
(declare-const o8 crtp_port)
(declare-const o9 (Array Int t_uint8))
(declare-const o10 t_uint8)
(declare-const o11 (Array Int t_uint8))
(declare-const o12 (Array Int t_uint8))
(declare-const o13 crpt_packet_representation)
(declare-const o14 t_uint8)
(declare-const o15 crtp_channel)
(declare-const o16 crtp_reserved)
(declare-const o17 crtp_port)
(declare-const o18 (Array Int t_uint8))
(declare-const o19 t_uint8)
(declare-const o20 (Array Int t_uint8))
(declare-const o21 (Array Int t_uint8))
(declare-const o22 Bool)
(declare-const o23 crpt_packet_representation)
(declare-const o24 t_uint8)
(declare-const o25 crtp_channel)
(declare-const o26 crtp_reserved)
(declare-const o27 crtp_port)
(declare-const o28 (Array Int t_uint8))
(declare-const o29 t_uint8)
(declare-const o30 (Array Int t_uint8))
(declare-const o31 (Array Int t_uint8))
(declare-const o32 Bool)
(declare-const o33 positive)
(declare-const temp___3848 crpt_packet_representation)
(declare-const temp___38481 t_uint8)
(declare-const temp___38482 crtp_channel)
(declare-const temp___38483 crtp_reserved)
(declare-const temp___38484 crtp_port)
(declare-const temp___38485 (Array Int t_uint8))
(declare-const temp___38486 t_uint8)
(declare-const temp___38487 (Array Int t_uint8))
(declare-const temp___38488 (Array Int t_uint8))
(declare-const temp___38489 Bool)
(declare-const temp___384810 positive)
(declare-const o34 t_uint8)
(declare-const o35 us_split_fields)
(declare-const o36 us_rep)
(declare-const o37 us_split_fields2)
(declare-const temp___3851 us_rep1)
(declare-const o38 Int)
(declare-const result Bool)
(declare-const result1 us_split_fields__ref1)
(declare-const handler__split_fields11 us_split_fields2)
(declare-const result2 us_split_fields__ref1)
(declare-const handler__split_fields12 us_split_fields2)
(assert (= handler__split_fields9 false))
(assert (in_range9 data))
(assert (in_range2 data_size))
(assert (and (= o (+ (to_rep handler__split_fields10) 1)) (in_range1 (+ (to_rep handler__split_fields10) 1))))
(assert (= o1 (- o 1)))
(assert (= result (ite (<= o1 30) true false)))
(assert (= result true))
(assert (= (to_rep handler__split_fields10) r6b))
(assert (in_range3 r6b))
(assert (and (= o2 (+ (to_rep handler__split_fields10) 1)) (in_range1 (+ (to_rep handler__split_fields10) 1))))
(assert (= console_pack__console_put_line__crtp_append_character_data__R7b__assume (- o2 1)))
(assert (= console_pack__console_put_line__crtp_append_character_data__R7b__assume r7b))
(assert (in_range1 r7b))
(assert (= temp___3839 (data_to_byte_array data)))
(assert (= (ite (<= 1 1) (+ (- 1 1) 1) 0) (ite (<= r6b r7b) (+ (- r7b r6b) 1) 0)))
(assert (= (slide temp___3839 1 r6b) temp___3840))
(assert (= (mk r6b r7b) temp___38401))
(assert (not (= (to_rep5 handler__split_fields) 0)))
(check-sat)
(exit)
