...
(assert (= n1 (bvsub byte_count1 (bvmul blocks_done2 ((_ int2bv 64) 64)))))
(assert (=> (bvuge n1 ((_ int2bv 64) 64)) (= result21 (mk_t__ref3 n1))))
(assert (=> (bvuge n1 ((_ int2bv 64) 64)) (= n2 ((_ int2bv 64) 64))))
(assert (=> (bvuge n1 ((_ int2bv 64) 64)) (= n3 (mk_t__ref3 n2))))
(assert (=> (bvuge n1 ((_ int2bv 64) 64)) (= n4 n2)))
(assert (=> (not (bvuge n1 ((_ int2bv 64) 64))) (= n3 (mk_t__ref3 n1))))
(assert (=> (not (bvuge n1 ((_ int2bv 64) 64))) (= n4 n1)))
(assert (= (bvmul blocks_done2 ((_ int2bv 64) 64)) c26b))
(assert (= (rec__skein__skein_512_context__x local_ctx__split_fields33) c28b))
(assert (= (t__content3 n3) c29b))
(assert (bvuge c29b ((_ int2bv 64) 1)))
(assert (bvule ((_ int2bv 64) 0) (bvsub c29b ((_ int2bv 64) 1))))
