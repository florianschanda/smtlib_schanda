...
(assert (=> (bvuge n1 #x0000000000000040) (= result21 (mk_t__ref3 n1))))
...
(assert (bvule #x0000000000000000 (bvsub c29b #x0000000000000001)))
(assert (not (bvule (bvsub c29b #x0000000000000001) #xFFFFFFFFFFFFFFFF)))
(check-sat)
(exit)
