...
(define-fun dynamic_invariant ((temp___expr_7053 us_t1) (temp___is_init_7050 Bool) (temp___skip_constant_7051 Bool) (temp___do_toplevel_7052 Bool)) Bool (=> (not (= temp___skip_constant_7051 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7053) (last3 temp___expr_7053)) (and (= (first3 temp___expr_7053) 1) (= (last3 temp___expr_7053) 2)))))
