...
(assert (= o9 (- o8 a_first)))
(assert (and (= o10 o9) (in_range1 o9)))
(assert (= o11 (- o10 1)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (= o13 (ite (<= k o12) true false)))
(assert (= o14 (ite (<= b_first k) o13 false)))
(assert (= result1 (ite (not (= o14 true)) true false)))
(assert (=> (= result1 true) (and (<= (to_rep b__first) k) (<= k (to_rep b__last)))))
(assert (=> (= result1 true) (= o17 k)))
(assert (=> (= result1 true) (= o18 (select b o17))))
(assert (=> (= result1 true) (= o19 (to_rep1 o18))))
(assert (=> (= result1 true) (and (<= (to_rep b__first) k) (<= k (to_rep b__last)))))
(assert (=> (= result1 true) (= o15 k)))
(assert (=> (= result1 true) (= o16 (select b1 o15))))
(assert (=> (= result1 true) (= o20 (to_rep1 o16))))
(assert (=> (= result1 true) (= o21 (ite (= o20 o19) true false))))
...
(assert (not (<= (to_rep (first (rt a))) temp___637)))
(check-sat)
(exit)
