...
(assert (=> (= result1 true) (=> (and (<= 1 index2) (<= index2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= temp___876 index2))))
(assert (=> (= result1 true) (=> (and (<= 1 index2) (<= index2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= temp___875 digit_count1))))
...
(assert (=> (= result1 true) (=> (and (<= 1 index2) (<= index2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (=> (< digit_count3 index3) (forall ((j Int)) (=> (and (<= (+ digit_count3 1) j) (<= j index3)) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j)) ((_ int2bv 8) 0))))))))
