...
(define-fun register_byte_array__ref___97__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5925 us_t1) (temp___is_init_5921 Bool) (temp___skip_constant_5922 Bool) (temp___do_toplevel_5923 Bool) (temp___do_typ_inv_5924 Bool)) Bool (=> (not (= temp___skip_constant_5922 true)) (and (dynamic_property2 1 5 (first3 temp___expr_5925) (last3 temp___expr_5925)) (and (= (first3 temp___expr_5925) 1) (= (last3 temp___expr_5925) 5)))))
(declare-sort t2 0)
...
(define-fun target__ref___41__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_5943 us_t2) (temp___is_init_5939 Bool) (temp___skip_constant_5940 Bool) (temp___do_toplevel_5941 Bool) (temp___do_typ_inv_5942 Bool)) Bool (=> (not (= temp___skip_constant_5940 true)) (and (dynamic_property3 1 5 (first5 temp___expr_5943) (last5 temp___expr_5943)) (and (= (first5 temp___expr_5943) 1) (= (last5 temp___expr_5943) 5)))))
...
(declare-const temp___87811 t2)
(define-fun temp___87812 () us_t2 (mk___t2 temp___8781 temp___87811))
...
(assert (and (= temp___87812 (register_to_bytes reg)) (dynamic_invariant1 temp___87812 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___87811)) (to_rep (last4 temp___87811))) (+ (- (to_rep (last4 temp___87811)) (to_rep (first4 temp___87811))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0))))
(check-sat)
(exit)
