...
(define-fun dynamic_invariant ((temp___expr_5394 us_t1) (temp___is_init_5391 Bool) (temp___skip_constant_5392 Bool) (temp___do_toplevel_5393 Bool)) Bool (=> (not (= temp___skip_constant_5392 true)) (and (dynamic_property2 1 5 (first3 temp___expr_5394) (last3 temp___expr_5394)) (and (= (first3 temp___expr_5394) 1) (= (last3 temp___expr_5394) 5)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_5410 us_t2) (temp___is_init_5407 Bool) (temp___skip_constant_5408 Bool) (temp___do_toplevel_5409 Bool)) Bool (=> (not (= temp___skip_constant_5408 true)) (and (dynamic_property3 1 5 (first5 temp___expr_5410) (last5 temp___expr_5410)) (and (= (first5 temp___expr_5410) 1) (= (last5 temp___expr_5410) 5)))))
...
(assert (and (= (mk___t2 temp___8009 temp___80091) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8009 temp___80091) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___80091)) (to_rep (last4 temp___80091))) (+ (- (to_rep (last4 temp___80091)) (to_rep (first4 temp___80091))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0))))
(check-sat)
(exit)
