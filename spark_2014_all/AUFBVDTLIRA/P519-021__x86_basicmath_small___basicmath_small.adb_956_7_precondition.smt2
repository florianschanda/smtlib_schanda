...
(assert (= (writereg32post (let ((subject rdi)) rdi6) ((_ int2bv 32) 10)) true))
...
(assert (= (let ((subject rdi)) rdi7) (bvadd (let ((subject rsp)) rsp16) ((_ int2bv 64) 44))))
...
(assert (= (writereg32post (let ((subject rdi)) rdi8) ((_ int2bv 32) 4198688)) true))
...
(assert (= (let ((subject rdi)) rdi11) (bvadd (let ((subject rsp)) rsp23) ((_ int2bv 64) 44))))
...
(assert (= (writereg32post (let ((subject rbx)) rbx7) ((_ int2bv 32) 0)) true))
...
(assert (= (let ((subject rdi)) rdi15) (bvadd (let ((subject rsp)) rsp30) ((_ int2bv 64) 44))))
...
(assert (= (writereg32post (let ((subject rdi)) rdi16) ((_ int2bv 32) 4198688)) true))
...
(assert (= (writereg32post (let ((subject rdi)) rdi20) ((_ int2bv 32) 4198544)) true))
...
(assert (= (let ((subject rsi)) rsi8) (bvadd (let ((subject rsp)) rsp39) ((_ int2bv 64) 48))))
(assert (= (writereg32post (let ((subject rdi)) rdi22) ((_ int2bv 32) 1072497001)) true))
(assert (= (writereg16post (let ((subject rbx)) rbx11) (let ((subject rbx)) rbx12) ((_ int2bv 16) 361)) true))
(assert (= result82 (let ((subject rsp)) (mk_t__ref3 rsp39))))
(assert (= (let ((subject rsp)) rsp40) (bvsub (let ((subject rsp)) rsp39) ((_ int2bv 64) 8))))
(assert (not (not (= (inrange64 (let ((subject rsi)) rsi8) (bvsub (let ((subject rsp)) rsp40) ((_ int2bv 64) 7)) ((_ int2bv 64) 15)) true))))
(check-sat)
(exit)
