...
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= temp___334 result__)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= temp___332 i1)))
...
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (and (and (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i2)) (forall ((temp___335 Int)) (=> (and (<= (to_rep result____first) temp___335) (<= temp___335 (to_rep result____last))) (=> (or (< (to_rep result____last) temp___335) (or (< temp___335 (to_rep result____first)) (< i2 temp___335))) (= (select result__3 temp___335) (select temp___334 temp___335)))))) (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))))))
