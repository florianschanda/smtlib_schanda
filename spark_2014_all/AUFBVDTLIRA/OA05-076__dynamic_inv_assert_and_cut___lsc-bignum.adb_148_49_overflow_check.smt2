...
(assert (= result7 (ite (= o47 true) (ite (<= k a_last) true false) false)))
(assert (= (= o48 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 a_last)) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
...
(assert (= o36 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o35)))
