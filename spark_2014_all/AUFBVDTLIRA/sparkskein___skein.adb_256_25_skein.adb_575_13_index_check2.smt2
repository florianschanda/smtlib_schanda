...
(assert (= o77 (bvadd src_index1 #x0000000000000007)))
(assert (= o78 (select (elts block) o77)))
(assert (= o79 (to_rep5 o78)))
(assert (= o80 ((_ zero_extend 56) o79)))
(assert (= o81 (bvshl o80 ((_ int2bv 64) 56))))
...
(assert (= o52 (bvadd src_index1 #x0000000000000002)))
(assert (= o53 (select (elts block) o52)))
(assert (= o54 (to_rep5 o53)))
(assert (= o55 ((_ zero_extend 56) o54)))
(assert (= o56 (bvshl o55 ((_ int2bv 64) 16))))
(assert (and (bvule (to_rep6 (first (rt block))) (bvadd src_index1 #x0000000000000001)) (bvule (bvadd src_index1 #x0000000000000001) (to_rep6 (last (rt block))))))
(assert (= o47 (bvadd src_index1 #x0000000000000001)))
(assert (= o48 (select (elts block) o47)))
(assert (= o49 (to_rep5 o48)))
(assert (= o50 ((_ zero_extend 56) o49)))
(assert (= o51 (bvshl o50 ((_ int2bv 64) 8))))
(assert (not (bvule (to_rep6 (first (rt block))) src_index1)))
(check-sat)
(exit)
