...
(assert (not (= (ite (<= (to_rep1 (first (rt temp___291))) (to_rep1 (last (rt temp___291)))) (+ (- (to_rep1 (last (rt temp___291))) (to_rep1 (first (rt temp___291)))) 1) 0) (ite (<= (to_rep1 total_string__first) (to_rep1 total_string__last)) (+ (- (to_rep1 total_string__last) (to_rep1 total_string__first)) 1) 0))))
(check-sat)
(exit)
