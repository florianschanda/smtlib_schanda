...
(assert (= r_digit1 o11))
(assert (= result5 (mk_t__ref1 difference1)))
(assert (= difference2 (bvsub (bvsub l_digit1 r_digit1) borrow2)))
(assert (=> (not (= (bvand difference2 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0))) (= result6 (mk_t__ref1 borrow2))))
(assert (=> (not (= (bvand difference2 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0))) (= borrow3 ((_ int2bv 16) 1))))
(assert (=> (not (not (= (bvand difference2 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0)))) (= result7 (mk_t__ref1 borrow2))))
(assert (=> (not (not (= (bvand difference2 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0)))) (= borrow4 ((_ int2bv 16) 0))))
(assert (=> (not (not (= (bvand difference2 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0)))) (= borrow3 borrow4)))
