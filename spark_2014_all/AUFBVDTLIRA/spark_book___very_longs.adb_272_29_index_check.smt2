...
(declare-datatypes () ((tT79bP1__ref (mk_tT79bP1__ref (tT79bP1__content tdigit_count_typeB)))))
(define-fun tT79bP1__ref___projection ((a tT79bP1__ref)) tdigit_count_typeB (tT79bP1__content a))
(declare-sort t1 0)
...
(declare-datatypes () ((t79b__ref (mk_t79b__ref (t79b__content us_t1)))))
(define-fun t79b__ref___projection ((a t79b__ref)) us_t1 (t79b__content a))
...
(declare-datatypes () ((t80b__ref (mk_t80b__ref (t80b__content tdigit_count_typeB)))))
(define-fun t80b__ref___projection ((a t80b__ref)) tdigit_count_typeB (t80b__content a))
(declare-sort t2 0)
...
(declare-fun temp___929 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___931 (_ BitVec 8))) (forall ((temp___932 Int) (temp___933 Int)) (let ((temp___930 (temp___929 temp___931 temp___932 temp___933))) (and (=> (dynamic_property6 1 65536 temp___932 temp___933) (and (= (first5 temp___930) temp___932) (= (last5 temp___930) temp___933))) (forall ((temp___934 Int)) (= (select (to_array2 temp___930) temp___934) (of_rep1 temp___931))))))))
...
(declare-const temp___936 (Array Int octet))
(declare-const temp___9361 t2)
(declare-const temp___937 (Array Int octet))
(declare-const temp___9371 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___940 digit_index_type)
(declare-const temp___9401 (Array Int octet))
(declare-const temp___9402 t1)
(declare-const temp___950 us_rep1)
(declare-const temp___949 (_ BitVec 16))
(declare-const temp___948 (_ BitVec 16))
(declare-const temp___947 (_ BitVec 16))
(declare-const temp___946 (_ BitVec 16))
...
(assert true)
(assert true)
(assert (= (to_rep2 (first4 (rt2 (temp___929 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___929 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___936 temp___9361) (temp___929 ((_ int2bv 8) 0) 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep2 (first4 temp___9361)) (to_rep2 (last4 temp___9361))) (+ (- (to_rep2 (last4 temp___9361)) (to_rep2 (first4 temp___9361))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___936 temp___937))
(assert (= (mk1 (to_rep2 (first4 temp___9361)) (to_rep2 (last4 temp___9361))) temp___9371))
(assert (= (ite (<= (to_rep2 (first2 temp___9371)) (to_rep2 (last2 temp___9371))) (+ (- (to_rep2 (last2 temp___9371)) (to_rep2 (first2 temp___9371))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___937 temp___9371)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___940)))
(assert (= temp___9401 o2))
(assert (= temp___9402 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___9401 temp___9402))))
(assert (= result____split_discrs (mk___split_discrs temp___940)))
...
(assert (and (and (dynamic_invariant3 (mk___rep1 result____split_discrs result____split_fields3) false true true) (forall ((temp___952 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___952) (<= temp___952 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= i2 temp___952) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___952) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___952)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (= l_digit3 o7))
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))) i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))))
(assert (= o8 i2))
...
(assert (= result4 (mk_t__ref1 r_digit2)))
(assert (= r_digit3 o11))
(assert (= result5 (mk_t__ref1 difference3)))
(assert (= difference4 (bvsub (bvsub l_digit3 r_digit3) borrow2)))
(assert (=> (not (= (bvand difference4 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0))) (= result6 (mk_t__ref1 borrow2))))
(assert (=> (not (= (bvand difference4 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0))) (= borrow3 ((_ int2bv 16) 1))))
(assert (=> (= (bvand difference4 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0)) (= result7 (mk_t__ref1 borrow2))))
(assert (=> (= (bvand difference4 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0)) (= borrow4 ((_ int2bv 16) 0))))
(assert (=> (= (bvand difference4 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0)) (= borrow3 borrow4)))
(assert (= o12 (takelsb_from16 difference4)))
(assert (= (to_rep1 o13) o12))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) i2)))
(check-sat)
(exit)
