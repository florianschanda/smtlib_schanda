...
(declare-fun temp___998 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1000 (_ BitVec 8))) (forall ((temp___1001 Int) (temp___1002 Int)) (let ((temp___999 (temp___998 temp___1000 temp___1001 temp___1002))) (=> (dynamic_invariant2 temp___1000 true true true true) (and (=> (dynamic_property6 1 65536 temp___1001 temp___1002) (and (= (first5 temp___999) temp___1001) (= (last5 temp___999) temp___1002))) (forall ((temp___1003 Int)) (= (to_rep1 (select (to_array2 temp___999) temp___1003)) temp___1000))))))))
...
(declare-const temp___1005 (Array Int octet))
(declare-const temp___10051 t2)
(declare-const temp___1006 (Array Int octet))
(declare-const temp___10061 t1)
(declare-const o (Array Int octet))
(declare-const o1 t1)
(declare-const o2 (Array Int octet))
(declare-const o3 t1)
(declare-const temp___1009 digit_index_type)
(declare-const temp___10091 (Array Int octet))
(declare-const temp___10092 t1)
...
(assert (= (to_rep2 (first4 (rt2 (temp___998 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___998 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))))
(assert (= (mk___t2 temp___1005 temp___10051) (temp___998 #x00 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))))))
(assert (= (ite (<= (to_rep2 (first4 temp___10051)) (to_rep2 (last4 temp___10051))) (+ (- (to_rep2 (last4 temp___10051)) (to_rep2 (first4 temp___10051))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0)))
(assert (= temp___1005 temp___1006))
(assert (= (mk1 (to_rep2 (first4 temp___10051)) (to_rep2 (last4 temp___10051))) temp___10061))
(assert (= (ite (<= (to_rep2 (first2 temp___10061)) (to_rep2 (last2 temp___10061))) (+ (- (to_rep2 (last2 temp___10061)) (to_rep2 (first2 temp___10061))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___1006 temp___10061)))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1009)))
(assert (= temp___10091 o2))
(assert (= temp___10092 o3))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___10091 temp___10092))))
(assert (= result____split_discrs (mk___split_discrs temp___1009)))
...
(assert (and (and (dynamic_invariant3 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (forall ((temp___1021 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___1021) (<= temp___1021 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= i2 temp___1021) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___1021) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___1021)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (=> (not (= (bvand difference2 #xFF00) #x0000)) (= result6 (mk_t__ref1 borrow2))))
(assert (=> (not (= (bvand difference2 #xFF00) #x0000)) (= borrow3 #x0001)))
(assert (=> (not (not (= (bvand difference2 #xFF00) #x0000))) (= result7 (mk_t__ref1 borrow2))))
