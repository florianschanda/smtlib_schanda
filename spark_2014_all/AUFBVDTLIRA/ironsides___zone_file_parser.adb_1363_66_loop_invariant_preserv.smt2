...
(assert (<= i49 128))
(assert (<= 1 endidx13))
(assert (and (and (=> (<= r95b 128) (dynamic_property4 r95b 128 i50)) (forall ((temp___1723 Int)) (=> (and (<= 1 temp___1723) (<= temp___1723 128)) (=> (<= i50 temp___1723) (= (select newdomainname12 temp___1723) (select (map__content newdomainname10) temp___1723)))))) (and (<= r95b i50) (<= i50 128))))
(assert (= (to_rep o11) 32))
(assert (= o12 (store newdomainname12 i50 o11)))
(assert (= result33 (mk_map__ref newdomainname12)))
(assert (= newdomainname13 o12))
(assert (not (= i50 128)))
(assert (= result34 (mk_int__ref i50)))
(assert (= i51 (+ i50 1)))
(assert (= i52 (mk_int__ref i51)))
