...
(define-fun dynamic_invariant1 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 2147483647)) (in_range5 temp___expr_210)))
...
(define-fun in_range7 ((rec__names__data__char_tables__vector__capacity1 Int) (a us_rep)) Bool (= rec__names__data__char_tables__vector__capacity1 (to_rep4 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant2 ((temp___expr_629 us_rep) (temp___is_init_625 Bool) (temp___skip_constant_626 Bool) (temp___do_toplevel_627 Bool) (temp___do_typ_inv_628 Bool)) Bool (=> (not (= temp___skip_constant_626 true)) (in_range7 1024 temp___expr_629)))
(define-fun default_initial_assumption ((temp___expr_631 us_rep) (temp___skip_top_level_632 Bool)) Bool (and (= (to_rep4 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 temp___expr_631))) 1024) (=> (not (= temp___skip_top_level_632 true)) (= (is_empty temp___expr_631) true))))
...
(assert (forall ((x capacity_range1)) (! (in_range8 (to_rep5 x)) :pattern ((to_rep5 x)))))
(assert (forall ((x Int)) (! (=> (in_range8 x) (= (to_rep5 (of_rep5 x)) x)) :pattern ((to_rep5 (of_rep5 x))))))
(define-fun in_range9 ((rec__names__data__entry_tables__vector__capacity1 Int) (a us_rep1)) Bool (= rec__names__data__entry_tables__vector__capacity1 (to_rep5 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 a)))))
...
(define-fun dynamic_invariant3 ((temp___expr_639 us_rep1) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (not (= temp___skip_constant_636 true)) (in_range9 256 temp___expr_639)))
(define-fun default_initial_assumption1 ((temp___expr_641 us_rep1) (temp___skip_top_level_642 Bool)) Bool (and (= (to_rep5 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 temp___expr_641))) 256) (=> (not (= temp___skip_top_level_642 true)) (= (is_empty1 temp___expr_641) true))))
...
(declare-fun user_eq12 (tchar_table_indexB tchar_table_indexB) Bool)
(declare-const dummy12 tchar_table_indexB)
...
(define-fun dynamic_invariant4 ((temp___expr_332 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool) (temp___do_typ_inv_331 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 0 2147483647)) (in_range6 temp___expr_332)))
(define-fun capacity ((container us_rep)) Int (ite (= (distinct 0 0) true) (to_rep4 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep) Bool)
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (capacity container)) (dynamic_invariant4 result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant5 ((temp___expr_325 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool) (temp___do_typ_inv_324 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= (- 1) 2147483647)) (in_range12 temp___expr_325)))
...
(define-fun bool_eq4 ((a us_rep3) (b us_rep3)) Bool (ite (and (and (= (to_rep6 (rec__names__data__name_entry__table_index (us_split_fields5 a))) (to_rep6 (rec__names__data__name_entry__table_index (us_split_fields5 b)))) (= (to_rep2 (rec__names__data__name_entry__length (us_split_fields5 a))) (to_rep2 (rec__names__data__name_entry__length (us_split_fields5 b))))) (= (to_rep3 (rec__names__data__name_entry__next_hash (us_split_fields5 a))) (to_rep3 (rec__names__data__name_entry__next_hash (us_split_fields5 b))))) true false))
...
(define-fun dynamic_invariant6 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 2147483647)) (in_range8 temp___expr_496)))
(define-fun capacity1 ((container us_rep1)) Int (ite (= (distinct 0 0) true) (to_rep5 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
(declare-fun capacity__function_guard1 (Int us_rep1) Bool)
(assert (forall ((container us_rep1)) (! (let ((result (length3 container))) (and (<= result (capacity1 container)) (dynamic_invariant6 result true false true true))) :pattern ((length3 container)))))
...
(declare-fun model__1 (us_rep1) us_rep4)
(declare-fun model____function_guard1 (us_rep4 us_rep1) Bool)
...
(declare-fun user_eq18 (extended_index1 extended_index1) Bool)
(declare-const dummy18 extended_index1)
...
(define-fun dynamic_invariant7 ((temp___expr_489 Int) (temp___is_init_485 Bool) (temp___skip_constant_486 Bool) (temp___do_toplevel_487 Bool) (temp___do_typ_inv_488 Bool)) Bool (=> (or (= temp___is_init_485 true) (<= 0 2147483647)) (in_range13 temp___expr_489)))
...
(define-fun olt1 ((left us_rep4) (right us_rep4)) Bool (and (< (length4 left) (length4 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last3 left))) (= (bool_eq4 (get1 left n) (get1 right n)) true))) true false)))
...
(assert true)
(assert (forall ((names__hash_table (Array (_ BitVec 32) name_id))) (forall ((names__entry_table__fields us_split_fields2)) (! (= (= (valid_hashes names__hash_table names__entry_table__fields) true) (forall ((h (_ BitVec 32))) (=> (and (bvule #x00000000 h) (bvule h #x000000FF)) (<= (to_rep3 (select names__hash_table h)) (last_index1 (mk___rep1 entry_table__split_discrs names__entry_table__fields)))))) :pattern ((valid_hashes names__hash_table names__entry_table__fields))))))
...
(assert true)
(assert (forall ((e us_rep3)) (forall ((names__char_table__fields us_split_fields)) (forall ((names__entry_table__fields us_split_fields2)) (! (= (= (valid_entry e names__char_table__fields names__entry_table__fields) true) (and (<= (to_rep3 (rec__names__data__name_entry__next_hash (us_split_fields5 e))) (last_index1 (mk___rep1 entry_table__split_discrs names__entry_table__fields))) (<= (- (to_rep2 (rec__names__data__name_entry__length (us_split_fields5 e))) 1) (- (last_index (mk___rep char_table__split_discrs names__char_table__fields)) (to_rep6 (rec__names__data__name_entry__table_index (us_split_fields5 e))))))) :pattern ((valid_entry e names__char_table__fields names__entry_table__fields)))))))
(declare-fun first_index__function_guard (Int us_rep1) Bool)
(define-fun element ((container us_rep1) (index Int)) us_rep3 (get1 (model__1 container) index))
...
(define-fun dynamic_invariant11 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 2147483647)) (in_range14 temp___expr_166)))
(define-fun dynamic_invariant12 ((temp___expr_304 Int) (temp___is_init_300 Bool) (temp___skip_constant_301 Bool) (temp___do_toplevel_302 Bool) (temp___do_typ_inv_303 Bool)) Bool (=> (or (= temp___is_init_300 true) (<= 0 2147483646)) (in_range11 temp___expr_304)))
...
(assert (forall ((a us_rep2) (b us_rep2)) (! (= (user_eq14 a b) (oeq a b)) :pattern ((user_eq14 a b)))))
(define-fun default_initial_assumption2 ((temp___expr_371 us_rep2) (temp___skip_top_level_372 Bool)) Bool (=> (not (= temp___skip_top_level_372 true)) (= (length2 temp___expr_371) 0)))
...
(define-fun dynamic_invariant13 ((temp___expr_363 Int) (temp___is_init_359 Bool) (temp___skip_constant_360 Bool) (temp___do_toplevel_361 Bool) (temp___do_typ_inv_362 Bool)) Bool (=> (or (= temp___is_init_359 true) (<= (- 1) 2147483646)) (in_range15 temp___expr_363)))
(assert (forall ((container us_rep2)) (! (let ((result (length2 container))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant11 result true false true true))) :pattern ((length2 container)))))
...
(define-fun dynamic_invariant14 ((temp___expr_356 Int) (temp___is_init_352 Bool) (temp___skip_constant_353 Bool) (temp___do_toplevel_354 Bool) (temp___do_typ_inv_355 Bool)) Bool (=> (or (= temp___is_init_352 true) (<= 0 255)) (in_range16 temp___expr_356)))
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant13 position true true true true) (and (<= 0 position) (<= position (last2 container)))) (dynamic_invariant14 (get container position) true false true true)) :pattern ((get container position))))))
(define-fun oeq1 ((left us_rep4) (right us_rep4)) Bool (and (= (length4 left) (length4 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last3 left))) (= (bool_eq4 (get1 left n) (get1 right n)) true))) true false)))
(declare-fun oeq__function_guard1 (Bool us_rep4 us_rep4) Bool)
(assert (forall ((a us_rep4) (b us_rep4)) (! (= (user_eq17 a b) (oeq1 a b)) :pattern ((user_eq17 a b)))))
(define-fun default_initial_assumption3 ((temp___expr_538 us_rep4) (temp___skip_top_level_539 Bool)) Bool (=> (not (= temp___skip_top_level_539 true)) (= (length4 temp___expr_538) 0)))
(assert (forall ((container us_rep1)) (! (= (length4 (model__1 container)) (length3 container)) :pattern ((model__1 container)))))
...
(define-fun dynamic_invariant15 ((temp___expr_472 Int) (temp___is_init_468 Bool) (temp___skip_constant_469 Bool) (temp___do_toplevel_470 Bool) (temp___do_typ_inv_471 Bool)) Bool (=> (or (= temp___is_init_468 true) (<= 1 2147483647)) (in_range17 temp___expr_472)))
...
(define-fun dynamic_invariant16 ((temp___expr_530 Int) (temp___is_init_526 Bool) (temp___skip_constant_527 Bool) (temp___do_toplevel_528 Bool) (temp___do_typ_inv_529 Bool)) Bool (=> (or (= temp___is_init_526 true) (<= 0 2147483647)) (in_range18 temp___expr_530)))
(assert (forall ((container us_rep4)) (! (let ((result (length4 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant11 result true false true true))) :pattern ((length4 container)))))
(assert true)
...
(declare-const temp___746 capacity_range)
(declare-const temp___7461 us_main_type)
(declare-const o Int)
(declare-const o1 Int)
(declare-const temp___744 Int)
...
(declare-const o14 char_table_index)
(declare-const o15 char_table_index)
(declare-const o16 positive)
(declare-const o17 name_id)
(declare-const o18 char_table_index)
(declare-const o19 positive)
(declare-const o20 name_id)
(declare-const char_table__split_fields1 us_main_type)
(declare-const result Int)
(declare-const i1 Int)
(declare-const names__data__char_tables__append__2__container__fields us_main_type)
(declare-const result1 us_main_type)
(declare-const char_table__split_fields2 us_main_type)
(declare-const char_table__split_fields3 us_main_type)
...
(define-fun char_table__split_fields8 () us_split_fields (mk___split_fields char_table__split_fields3))
(define-fun names__data__char_tables__append__2__container__fields1 () us_split_fields (mk___split_fields names__data__char_tables__append__2__container__fields))
(define-fun char_table__split_fields9 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields char_table__split_fields)))
(assert (= 1024 (to_rep4 (rec__names__data__char_tables__vector__capacity char_table__split_discrs))))
(assert (= 256 (to_rep5 (rec__names__data__entry_tables__vector__capacity entry_table__split_discrs))))
(assert (dynamic_invariant s true false true true))
(assert (=> (<= 0 2147483647) (in_range5 n)))
(assert (and (< 0 (length s)) (= (invariant__ hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields)) true)))
(assert (< (last2 (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields)))) (- 2147483646 (length s))))
(assert (< (last3 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields)))) 2147483647))
(assert (and (= temp___750 (length s)) (in_range1 (length s))))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= temp___747 i1)))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= temp___748 (length1 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))))))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (and (= char_table__split_discrs (mk___split_discrs temp___746)) (= char_table__split_fields temp___7461))))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (and (= o (- (to_rep1 (first (rt s))) 1)) (in_range1 (- (to_rep1 (first (rt s))) 1)))))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= o1 (+ i1 o))))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (and (= temp___744 o1) (in_range1 o1))))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (and (<= (to_rep1 (first (rt s))) temp___744) (<= temp___744 (to_rep1 (last (rt s)))))))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= o2 temp___744)))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= o3 (select (elts s) o2))))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= o4 (to_rep o3))))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (and (and (= (length1 (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1)) (+ (length1 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) 1)) (= (olt (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) (model__ (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1))) true)) (= (get (model__ (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1)) (+ (last2 (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields)))) 1)) o4))))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= (mk___split_fields__ref (mk___split_fields result1)) char_table__split_fields9)))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= (mk___split_fields char_table__split_fields2) names__data__char_tables__append__2__container__fields1)))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (and (= (invariant__ hash_table char_table__split_fields8 (mk___split_fields1 entry_table__split_fields)) true) (= (length1 (mk___rep char_table__split_discrs char_table__split_fields8)) (+ temp___748 i2)))))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (and (=> (<= 1 (length s)) (dynamic_property1 1 (length s) i2)) (and (<= 1 i2) (<= i2 (length s))))))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= i2 temp___750)))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= char_table__split_fields4 (mk___split_fields__ref char_table__split_fields8))))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= i4 i2)))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= char_table__split_fields5 char_table__split_fields8)))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= i5 i3)))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= char_table__split_fields6 char_table__split_fields4)))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= i6 i4)))
(assert (=> (and (<= 1 i1) (<= i1 temp___750)) (= char_table__split_fields7 char_table__split_fields5)))
(assert (=> (not (and (<= 1 i1) (<= i1 temp___750))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= 1 i1) (<= i1 temp___750))) (= char_table__split_fields6 char_table__split_fields9)))
(assert (=> (not (and (<= 1 i1) (<= i1 temp___750))) (= i6 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 temp___750))) (= char_table__split_fields7 (mk___split_fields char_table__split_fields1))))
(assert (= (to_rep3 o12) 0))
(assert (and (= o11 (length s)) (in_range2 (length s))))
(assert (= (to_rep2 o13) o11))
(assert (and (= o5 (length s)) (in_range10 (length s))))
(assert (= o6 (- o5 1)))
(assert (and (= o7 (last2 (model__ (mk___rep char_table__split_discrs (us_split_fields__content char_table__split_fields6))))) (and (in_range12 o7) (= o7 (last2 (model__ (mk___rep char_table__split_discrs (us_split_fields__content char_table__split_fields6))))))))
(assert (= o8 (- o7 o6)))
(assert (and (= o9 o8) (in_range10 o8)))
(assert (and (= o10 o9) (in_range11 o9)))
(assert (= (to_rep6 o14) o10))
(assert (= o14 o15))
(assert (= o13 o16))
(assert (= o12 o17))
(assert (= o18 o15))
(assert (= o19 o16))
(assert (= o20 o17))
(assert (not (< (length3 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) (capacity1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))))))
(check-sat)
(exit)
