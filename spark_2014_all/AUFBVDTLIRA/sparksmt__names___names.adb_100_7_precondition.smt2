...
(define-fun dynamic_invariant3 ((temp___expr_332 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool) (temp___do_typ_inv_331 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 0 2147483647)) (in_range4 temp___expr_332)))
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (capacity container)) (dynamic_invariant3 result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant4 ((temp___expr_325 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool) (temp___do_typ_inv_324 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= (- 1) 2147483647)) (in_range9 temp___expr_325)))
...
(define-fun dynamic_invariant5 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 2147483647)) (in_range6 temp___expr_496)))
(assert (forall ((container us_rep1)) (! (let ((result (length3 container))) (and (<= result (capacity1 container)) (dynamic_invariant5 result true false true true))) :pattern ((length3 container)))))
...
(define-fun last3 ((container us_rep3)) Int (+ 0 (length4 container)))
...
(define-fun dynamic_invariant6 ((temp___expr_489 Int) (temp___is_init_485 Bool) (temp___skip_constant_486 Bool) (temp___do_toplevel_487 Bool) (temp___do_typ_inv_488 Bool)) Bool (=> (or (= temp___is_init_485 true) (<= 0 2147483647)) (in_range10 temp___expr_489)))
...
(define-fun olt1 ((left us_rep3) (right us_rep3)) Bool (and (< (length4 left) (length4 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last3 left))) (= (bool_eq5 (get1 left n) (get1 right n)) true))) true false)))
...
(define-fun dynamic_invariant7 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 2147483647)) (in_range8 temp___expr_210)))
...
(define-fun in_range13 ((x Int)) Bool (and (<= (- 2147483648) x) (<= x 2147483647)))
...
(define-fun oeq1 ((left us_rep3) (right us_rep3)) Bool (and (= (length4 left) (length4 right)) (ite (forall ((n Int)) (=> (and (<= 1 n) (<= n (last3 left))) (= (bool_eq5 (get1 left n) (get1 right n)) true))) true false)))
...
(define-fun default_initial_assumption3 ((temp___expr_538 us_rep3) (temp___skip_top_level_539 Bool)) Bool (=> (not (= temp___skip_top_level_539 true)) (= (length4 temp___expr_538) 0)))
...
(assert (forall ((container us_rep3)) (! (let ((result (length4 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant11 result true false true true))) :pattern ((length4 container)))))
(assert true)
...
(declare-const temp___748 capacity_range)
(declare-const temp___7481 us_main_type)
(declare-const o Int)
...
(assert (and (= temp___745 (length s)) (in_range1 (length s))))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= temp___749 i1)))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= temp___750 (length1 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))))))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (and (= char_table__split_discrs (mk___split_discrs temp___748)) (= char_table__split_fields temp___7481))))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (and (= o (- (to_rep1 (first (rt s))) 1)) (in_range1 (- (to_rep1 (first (rt s))) 1)))))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= o1 (+ i1 o))))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (and (= temp___746 o1) (in_range1 o1))))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (and (<= (to_rep1 (first (rt s))) temp___746) (<= temp___746 (to_rep1 (last (rt s)))))))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= o2 temp___746)))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= o3 (select (elts s) o2))))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= o4 (to_rep o3))))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (and (and (= (length1 (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1)) (+ (length1 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) 1)) (= (olt (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) (model__ (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1))) true)) (= (get (model__ (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1)) (+ (last2 (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields)))) 1)) o4))))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= (mk___split_fields__ref (mk___split_fields result1)) char_table__split_fields9)))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= (mk___split_fields char_table__split_fields2) names__data__char_tables__append__2__container__fields1)))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (and (= (invariant__ hash_table char_table__split_fields8 (mk___split_fields1 entry_table__split_fields)) true) (= (length1 (mk___rep char_table__split_discrs char_table__split_fields8)) (+ temp___750 i2)))))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (and (=> (<= 1 (length s)) (dynamic_property1 1 (length s) i2)) (and (<= 1 i2) (<= i2 (length s))))))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= i2 temp___745)))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= char_table__split_fields4 (mk___split_fields__ref char_table__split_fields8))))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= i4 i2)))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= char_table__split_fields5 char_table__split_fields8)))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= i5 i3)))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= char_table__split_fields6 char_table__split_fields4)))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= i6 i4)))
(assert (=> (and (<= 1 i1) (<= i1 temp___745)) (= char_table__split_fields7 char_table__split_fields5)))
(assert (=> (not (and (<= 1 i1) (<= i1 temp___745))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= 1 i1) (<= i1 temp___745))) (= char_table__split_fields6 char_table__split_fields9)))
(assert (=> (not (and (<= 1 i1) (<= i1 temp___745))) (= i6 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 temp___745))) (= char_table__split_fields7 (mk___split_fields char_table__split_fields1))))
(assert (and (= o11 (length s)) (in_range2 (length s))))
(assert (= (to_rep2 o12) o11))
(assert (and (= o5 (length s)) (in_range13 (length s))))
(assert (= o6 (- o5 1)))
(assert (and (= o7 (last2 (model__ (mk___rep char_table__split_discrs (us_split_fields__content char_table__split_fields6))))) (and (in_range9 o7) (= o7 (last2 (model__ (mk___rep char_table__split_discrs (us_split_fields__content char_table__split_fields6))))))))
(assert (= o8 (- o7 o6)))
(assert (and (= o9 o8) (in_range13 o8)))
(assert (and (= o10 o9) (in_range11 o9)))
(assert (= (to_rep6 o13) o10))
(assert (= o13 o14))
(assert (= o12 o15))
(assert (= rliteral o16))
(assert (= o17 o14))
