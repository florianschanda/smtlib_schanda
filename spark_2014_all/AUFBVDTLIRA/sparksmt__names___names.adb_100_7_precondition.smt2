...
(define-fun dynamic_invariant1 ((temp___expr_180 Int) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (or (= temp___is_init_177 true) (<= 0 2147483647)) (in_range5 temp___expr_180)))
...
(define-fun dynamic_invariant2 ((temp___expr_569 us_rep) (temp___is_init_566 Bool) (temp___skip_constant_567 Bool) (temp___do_toplevel_568 Bool)) Bool (=> (not (= temp___skip_constant_567 true)) (in_range7 1024 temp___expr_569)))
(define-fun default_initial_assumption ((temp___expr_571 us_rep) (temp___skip_top_level_572 Bool)) Bool (and (= (to_rep4 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 temp___expr_571))) 1024) (=> (not (= temp___skip_top_level_572 true)) (= (is_empty temp___expr_571) true))))
...
(define-fun dynamic_invariant3 ((temp___expr_578 us_rep1) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (not (= temp___skip_constant_576 true)) (in_range9 256 temp___expr_578)))
(define-fun default_initial_assumption1 ((temp___expr_580 us_rep1) (temp___skip_top_level_581 Bool)) Bool (and (= (to_rep5 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 temp___expr_580))) 256) (=> (not (= temp___skip_top_level_581 true)) (= (is_empty1 temp___expr_580) true))))
...
(define-fun dynamic_invariant4 ((temp___expr_288 Int) (temp___is_init_285 Bool) (temp___skip_constant_286 Bool) (temp___do_toplevel_287 Bool)) Bool (=> (or (= temp___is_init_285 true) (<= 0 2147483647)) (in_range6 temp___expr_288)))
(define-fun capacity ((container us_rep)) Int (ite (= (of_int 0) true) (to_rep4 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(define-fun dynamic_invariant5 ((temp___expr_282 Int) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool)) Bool (=> (or (= temp___is_init_279 true) (<= (- 1) 2147483647)) (in_range12 temp___expr_282)))
...
(define-fun dynamic_invariant6 ((temp___expr_442 Int) (temp___is_init_439 Bool) (temp___skip_constant_440 Bool) (temp___do_toplevel_441 Bool)) Bool (=> (or (= temp___is_init_439 true) (<= 0 2147483647)) (in_range8 temp___expr_442)))
(define-fun capacity1 ((container us_rep1)) Int (ite (= (of_int 0) true) (to_rep5 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
(declare-fun capacity__function_guard1 (Int us_rep1) Bool)
(assert (forall ((container us_rep1)) (! (let ((result (length3 container))) (and (<= result (capacity1 container)) (dynamic_invariant6 result true false true))) :pattern ((length3 container)))))
...
(define-fun dynamic_invariant7 ((temp___expr_436 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 0 2147483647)) (in_range13 temp___expr_436)))
...
(assert true)
(assert (forall ((names__hash_table (Array (_ BitVec 32) name_id))) (forall ((names__entry_table__fields us_split_fields2)) (! (= (= (valid_hashes names__hash_table names__entry_table__fields) true) (forall ((h (_ BitVec 32))) (=> (and (bvule ((_ int2bv 32) 0) h) (bvule h ((_ int2bv 32) 255))) (<= (to_rep3 (select names__hash_table h)) (last_index1 (mk___rep1 entry_table__split_discrs names__entry_table__fields)))))) :pattern ((valid_hashes names__hash_table names__entry_table__fields))))))
...
(define-fun dynamic_invariant11 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range14 temp___expr_142)))
(define-fun dynamic_invariant12 ((temp___expr_264 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool)) Bool (=> (or (= temp___is_init_261 true) (<= 0 2147483646)) (in_range11 temp___expr_264)))
...
(define-fun default_initial_assumption2 ((temp___expr_322 us_rep2) (temp___skip_top_level_323 Bool)) Bool (=> (not (= temp___skip_top_level_323 true)) (= (length2 temp___expr_322) 0)))
...
(define-fun dynamic_invariant13 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= (- 1) 2147483646)) (in_range15 temp___expr_315)))
(assert (forall ((container us_rep2)) (! (let ((result (length2 container))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant11 result true false true))) :pattern ((length2 container)))))
...
(define-fun dynamic_invariant14 ((temp___expr_309 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 255)) (in_range16 temp___expr_309)))
(assert (forall ((container us_rep2)) (forall ((position Int)) (! (=> (and (dynamic_invariant13 position true true true) (and (<= 0 position) (<= position (last2 container)))) (dynamic_invariant14 (get container position) true false true)) :pattern ((get container position))))))
...
(define-fun default_initial_assumption3 ((temp___expr_479 us_rep4) (temp___skip_top_level_480 Bool)) Bool (=> (not (= temp___skip_top_level_480 true)) (= (length4 temp___expr_479) 0)))
...
(define-fun dynamic_invariant15 ((temp___expr_421 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1 2147483647)) (in_range17 temp___expr_421)))
...
(define-fun dynamic_invariant16 ((temp___expr_472 Int) (temp___is_init_469 Bool) (temp___skip_constant_470 Bool) (temp___do_toplevel_471 Bool)) Bool (=> (or (= temp___is_init_469 true) (<= 0 2147483647)) (in_range18 temp___expr_472)))
(assert (forall ((container us_rep4)) (! (let ((result (length4 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant11 result true false true))) :pattern ((length4 container)))))
(assert true)
...
(declare-const n Int)
(declare-const i Int)
(declare-const temp___686 Int)
(declare-const temp___684 Int)
(declare-const temp___683 capacity_range)
(declare-const temp___6831 us_main_type)
(declare-const temp___682 Int)
(declare-const o Int)
(declare-const o1 Int)
(declare-const temp___680 Int)
...
(assert (and (= temp___686 (length s)) (in_range1 (length s))))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= temp___684 (length1 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (and (= char_table__split_discrs (mk___split_discrs temp___683)) (= char_table__split_fields temp___6831))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= temp___682 i1)))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (and (= o (- (to_rep1 (first (rt s))) 1)) (in_range1 (- (to_rep1 (first (rt s))) 1)))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= o1 (+ i1 o))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (and (= temp___680 o1) (in_range1 o1))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (and (<= (to_rep1 (first (rt s))) temp___680) (<= temp___680 (to_rep1 (last (rt s)))))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= o2 temp___680)))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= o3 (select (elts s) o2))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= o4 (to_rep o3))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (and (and (= (length1 (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1)) (+ (length1 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) 1)) (= (olt (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) (model__ (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1))) true)) (= (get (model__ (mk___rep char_table__split_discrs names__data__char_tables__append__2__container__fields1)) (+ (last2 (model__ (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields)))) 1)) o4))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= (mk___split_fields__ref (mk___split_fields result1)) char_table__split_fields9)))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= (mk___split_fields char_table__split_fields2) names__data__char_tables__append__2__container__fields1)))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (and (= (invariant__ hash_table char_table__split_fields8 (mk___split_fields1 entry_table__split_fields)) true) (= (length1 (mk___rep char_table__split_discrs char_table__split_fields8)) (+ temp___684 i2)))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (and (=> (<= 1 (length s)) (dynamic_property1 1 (length s) i2)) (and (<= 1 i2) (<= i2 (length s))))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= i2 temp___686)))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= char_table__split_fields4 (mk___split_fields__ref char_table__split_fields8))))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= i4 i2)))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= char_table__split_fields5 char_table__split_fields8)))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= i5 i3)))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= char_table__split_fields6 char_table__split_fields4)))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= i6 i4)))
(assert (=> (and (<= 1 i1) (<= i1 temp___686)) (= char_table__split_fields7 char_table__split_fields5)))
(assert (=> (not (and (<= 1 i1) (<= i1 temp___686))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= 1 i1) (<= i1 temp___686))) (= char_table__split_fields6 char_table__split_fields9)))
(assert (=> (not (and (<= 1 i1) (<= i1 temp___686))) (= i6 i1)))
(assert (=> (not (and (<= 1 i1) (<= i1 temp___686))) (= char_table__split_fields7 (mk___split_fields char_table__split_fields1))))
