...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (forall ((k Int)) (=> (and (<= a_first k) (<= k (- i2 1))) (= (to_rep1 (select a2 k)) ((_ int2bv 32) 0))))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (and (forall ((temp___550 Int)) (=> (and (<= (to_rep a__first) temp___550) (<= temp___550 (to_rep a__last))) (=> (<= i2 temp___550) (= (select a2 temp___550) (select temp___549 temp___550))))) (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2))) (and (<= a_first i2) (<= i2 a_last)))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= (to_rep1 o) ((_ int2bv 32) 0))))
...
(assert (<= a_first k))
(assert (<= k a_last))
(assert (not (= (to_rep1 (select a8 k)) ((_ int2bv 32) 0))))
(check-sat)
(exit)
