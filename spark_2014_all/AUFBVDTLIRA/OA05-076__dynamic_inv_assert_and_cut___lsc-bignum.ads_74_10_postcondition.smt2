...
(declare-const temp___619 (Array Int word32))
...
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___621 i1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___619 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (forall ((k Int)) (=> (and (<= a_first k) (<= k (- i2 1))) (= (to_rep1 (select a2 k)) #x00000000)))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (and (forall ((temp___620 Int)) (=> (and (<= (to_rep a__first) temp___620) (<= temp___620 (to_rep a__last))) (=> (<= i2 temp___620) (= (select a2 temp___620) (select temp___619 temp___620))))) (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2))) (and (<= a_first i2) (<= i2 a_last)))))
