...
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (and (= temp___551 i1) (and (= temp___549 a) (and (forall ((k2 Int)) (=> (and (<= a_first k2) (<= k2 (- i2 1))) (= (to_rep1 (select a2 k2)) ((_ int2bv 32) 0)))) (and (and (and (forall ((temp___550 Int)) (=> (and (<= (to_rep a__first) temp___550) (<= temp___550 (to_rep a__last))) (=> (<= i2 temp___550) (= (select a2 temp___550) (select temp___549 temp___550))))) (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2))) (and (<= a_first i2) (<= i2 a_last))) (and (and (and (= (to_rep1 o2) ((_ int2bv 32) 0)) (and (and (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))) (= o3 i2)) (= o4 (store a2 o3 o2)))) (and (= a2 result2) (= a3 o4))) (= i2 a_last)))))) (and (and (= i2 i6) (= a3 a6)) (and (= i7 i2) (= a7 a3))))))
...
(assert (<= a_first k2))
(assert (<= k2 a_last))
(assert (not (= (to_rep1 (select a10 k2)) ((_ int2bv 32) 0))))
(check-sat)
(exit)
