...
(declare-const temp___621 (Array Int word32))
...
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___623 i1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___621 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (forall ((k Int)) (=> (and (<= a_first k) (<= k (- i2 1))) (= (to_rep1 (select a2 k)) #x00000000)))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (and (forall ((temp___622 Int)) (=> (and (<= (to_rep a__first) temp___622) (<= temp___622 (to_rep a__last))) (=> (or (< a_last temp___622) (or (< temp___622 a_first) (<= i2 temp___622))) (= (select a2 temp___622) (select temp___621 temp___622))))) (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2))) (and (<= a_first i2) (<= i2 a_last)))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= (to_rep1 o) #x00000000)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last)))))
...
(assert (<= a_first k))
(assert (<= k a_last))
(assert (not (= (to_rep1 (select a8 k)) #x00000000)))
(check-sat)
(exit)
