...
(define-fun dynamic_invariant ((temp___expr_6805 us_t1) (temp___is_init_6802 Bool) (temp___skip_constant_6803 Bool) (temp___do_toplevel_6804 Bool)) Bool (=> (not (= temp___skip_constant_6803 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6805) (last3 temp___expr_6805)) (and (= (first3 temp___expr_6805) 1) (= (last3 temp___expr_6805) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_6821 us_t2) (temp___is_init_6818 Bool) (temp___skip_constant_6819 Bool) (temp___do_toplevel_6820 Bool)) Bool (=> (not (= temp___skip_constant_6819 true)) (and (dynamic_property3 1 2 (first5 temp___expr_6821) (last5 temp___expr_6821)) (and (= (first5 temp___expr_6821) 1) (= (last5 temp___expr_6821) 2)))))
...
(assert (and (= (mk___t2 temp___8161 temp___81611) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8161 temp___81611) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___81611)) (to_rep (last4 temp___81611))) (+ (- (to_rep (last4 temp___81611)) (to_rep (first4 temp___81611))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
