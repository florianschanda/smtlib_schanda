...
(assert (and (= us (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (in_range (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))))
(assert (and (= us1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
