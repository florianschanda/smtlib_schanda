...
(assert (= (to_rep2 (rec__parse__parse_result_t__return_code result____split_discrs2)) r6b))
(assert (in_range1 r6b))
(assert (= (to_rep2 o16) 1))
(assert (= o17 (mk___split_discrs o16)))
(assert (= temp___321 (mk___rep2 o17 (mk___split_fields2 dummy6) true)))
(assert (= result____attr__constrained true))
(assert (not (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___321)) (rec__parse__parse_result_t__return_code result____split_discrs2))))
(check-sat)
(exit)
