...
(define-fun dynamic_invariant ((temp___expr_187 (_ BitVec 8)) (temp___is_init_183 Bool) (temp___skip_constant_184 Bool) (temp___do_toplevel_185 Bool) (temp___do_typ_inv_186 Bool)) Bool true)
...
(define-fun dynamic_invariant1 ((temp___expr_194 (_ BitVec 16)) (temp___is_init_190 Bool) (temp___skip_constant_191 Bool) (temp___do_toplevel_192 Bool) (temp___do_typ_inv_193 Bool)) Bool true)
...
(define-fun dynamic_invariant2 ((temp___expr_278 Int) (temp___is_init_274 Bool) (temp___skip_constant_275 Bool) (temp___do_toplevel_276 Bool) (temp___do_typ_inv_277 Bool)) Bool (=> (or (= temp___is_init_274 true) (<= 0 1)) (in_range1 temp___expr_278)))
...
(define-fun dynamic_invariant3 ((temp___expr_300 Int) (temp___is_init_296 Bool) (temp___skip_constant_297 Bool) (temp___do_toplevel_298 Bool) (temp___do_typ_inv_299 Bool)) Bool (=> (or (= temp___is_init_296 true) (<= 0 512)) (in_range4 temp___expr_300)))
...
(assert (forall ((query (Array Int us_rep))) (forall ((offset Int)) (! (=> (and (dynamic_invariant3 offset true true true true) (<= offset 511)) (dynamic_invariant1 (extract_unsigned_16 query offset) true false true true)) :pattern ((extract_unsigned_16 query offset))))))
...
(define-fun dynamic_invariant4 ((temp___expr_293 Int) (temp___is_init_289 Bool) (temp___skip_constant_290 Bool) (temp___do_toplevel_291 Bool) (temp___do_typ_inv_292 Bool)) Bool (=> (or (= temp___is_init_289 true) (<= 0 7)) (in_range5 temp___expr_293)))
...
(assert (forall ((query (Array Int us_rep))) (forall ((offset Int) (bit_shift_right Int)) (forall ((bit_mask (_ BitVec 8))) (! (=> (and (and (dynamic_invariant3 offset true true true true) (dynamic_invariant4 bit_shift_right true true true true)) (dynamic_invariant bit_mask true true true true)) (dynamic_invariant (extract_bits_of_octet query offset bit_shift_right bit_mask) true false true true)) :pattern ((extract_bits_of_octet query offset bit_shift_right bit_mask)))))))
...
(define-fun dynamic_invariant5 ((temp___expr_318 Int) (temp___is_init_314 Bool) (temp___skip_constant_315 Bool) (temp___do_toplevel_316 Bool) (temp___do_typ_inv_317 Bool)) Bool (=> (or (= temp___is_init_314 true) (<= 0 1)) (in_range2 temp___expr_318)))
(define-fun dynamic_invariant6 ((temp___expr_325 Int) (temp___is_init_321 Bool) (temp___skip_constant_322 Bool) (temp___do_toplevel_323 Bool) (temp___do_typ_inv_324 Bool)) Bool (=> (or (= temp___is_init_321 true) (<= 1 16)) (in_range3 temp___expr_325)))
...
(declare-const temp___369 us_rep2)
...
(assert (= opcode1 o7))
(assert (not (= opcode1 #x00)))
(assert (not (= opcode1 #x01)))
...
(assert (= temp___369 (mk___rep2 o9 (mk___split_fields2 dummy6) true)))
(assert (= result____attr__constrained true))
(assert (not (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___369)) (rec__parse__parse_result_t__return_code result____split_discrs2))))
(check-sat)
(exit)
