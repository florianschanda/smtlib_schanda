...
(assert (= a_msw3 o37))
(assert (= o83 (from_word32 #x00000001)))
...
(assert (= o76 (from_word32 #x00000002)))
...
(assert (and (= o67 (base Tuple0)) (= o67 (oexpon (from_word32 #x00000002) 32))))
...
(assert (= o66 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first o65)))
