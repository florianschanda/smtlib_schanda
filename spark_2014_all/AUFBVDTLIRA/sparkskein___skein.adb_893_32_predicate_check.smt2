...
(define-fun dynamic_invariant1 ((temp___expr_657 (Array (_ BitVec 64) byte)) (temp___is_init_653 Bool) (temp___skip_constant_654 Bool) (temp___do_toplevel_655 Bool) (temp___do_typ_inv_656 Bool)) Bool (=> (= temp___do_toplevel_655 true) (=> (= temp___is_init_653 true) (bvult (last1 (of_array temp___expr_657 #x0000000000000000 #x000000000000003F)) #xFFFFFFFFFFFFFFFF))))
(define-fun dynamic_predicate1 ((temp___665 (Array (_ BitVec 64) byte))) Bool (bvult (last1 (of_array temp___665 #x0000000000000000 #x000000000000003F)) #xFFFFFFFFFFFFFFFF))
...
(define-fun to_int5 ((x u64)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x u64)) (! (uint_in_range (to_int5 x)) :pattern ((to_int5 x)))))
...
(assert (forall ((x hash_bit_length)) (! (in_range_int1 (to_int6 x)) :pattern ((to_int6 x)))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x80))) (=> (in_range3 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
(define-fun to_int11 ((x u7)) Int (bv2nat (to_rep6 x)))
(assert (forall ((x u7)) (! (in_range_int2 (to_int11 x)) :pattern ((to_int11 x)))))
(declare-sort u6 0)
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x40))) (=> (in_range4 y) (= (to_rep7 (of_rep7 x)) y))) :pattern ((to_rep7 (of_rep7 x))))))
(define-fun to_int12 ((x u6)) Int (bv2nat (to_rep7 x)))
(assert (forall ((x u6)) (! (in_range_int3 (to_int12 x)) :pattern ((to_int12 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_352 (_ BitVec 64)) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool) (temp___do_typ_inv_351 Bool)) Bool true)
(assert true)
...
(define-fun dynamic_invariant4 ((temp___expr_331 (_ BitVec 8)) (temp___is_init_327 Bool) (temp___skip_constant_328 Bool) (temp___do_toplevel_329 Bool) (temp___do_typ_inv_330 Bool)) Bool true)
(define-fun dynamic_invariant5 ((temp___expr_338 (_ BitVec 16)) (temp___is_init_334 Bool) (temp___skip_constant_335 Bool) (temp___do_toplevel_336 Bool) (temp___do_typ_inv_337 Bool)) Bool true)
(define-fun dynamic_invariant6 ((temp___expr_345 (_ BitVec 32)) (temp___is_init_341 Bool) (temp___skip_constant_342 Bool) (temp___do_toplevel_343 Bool) (temp___do_typ_inv_344 Bool)) Bool true)
(define-fun dynamic_invariant7 ((temp___expr_588 (_ BitVec 64)) (temp___is_init_584 Bool) (temp___skip_constant_585 Bool) (temp___do_toplevel_586 Bool) (temp___do_typ_inv_587 Bool)) Bool (=> (or (= temp___is_init_584 true) (bvule #x0000000000000000 #xFFFFFFFFFFFFFFF8)) (in_range2 temp___expr_588)))
(define-fun dynamic_invariant8 ((temp___expr_595 (_ BitVec 64)) (temp___is_init_591 Bool) (temp___skip_constant_592 Bool) (temp___do_toplevel_593 Bool) (temp___do_typ_inv_594 Bool)) Bool (=> (or (= temp___is_init_591 true) (bvule #x0000000000000001 #xFFFFFFFFFFFFFFF8)) (in_range6 temp___expr_595)))
(define-fun dynamic_invariant9 ((temp___expr_619 (_ BitVec 64)) (temp___is_init_615 Bool) (temp___skip_constant_616 Bool) (temp___do_toplevel_617 Bool) (temp___do_typ_inv_618 Bool)) Bool (=> (or (= temp___is_init_615 true) (bvule #x0000000000000000 #x0000000000000040)) (in_range7 temp___expr_619)))
(define-fun dynamic_invariant10 ((temp___expr_626 (_ BitVec 64)) (temp___is_init_622 Bool) (temp___skip_constant_623 Bool) (temp___do_toplevel_624 Bool) (temp___do_typ_inv_625 Bool)) Bool (=> (or (= temp___is_init_622 true) (bvule #x0000000000000000 #x000000000000003F)) (in_range5 temp___expr_626)))
(define-fun dynamic_invariant11 ((temp___expr_633 (Array (_ BitVec 64) byte)) (temp___is_init_629 Bool) (temp___skip_constant_630 Bool) (temp___do_toplevel_631 Bool) (temp___do_typ_inv_632 Bool)) Bool (=> (= temp___do_toplevel_631 true) (=> (= temp___is_init_629 true) (bvult (last1 (of_array temp___expr_633 #x0000000000000000 #x000000000000003F)) #xFFFFFFFFFFFFFFFF))))
(define-fun dynamic_predicate2 ((temp___641 (Array (_ BitVec 64) byte))) Bool (bvult (last1 (of_array temp___641 #x0000000000000000 #x000000000000003F)) #xFFFFFFFFFFFFFFFF))
(define-fun dynamic_invariant12 ((temp___expr_650 (_ BitVec 64)) (temp___is_init_646 Bool) (temp___skip_constant_647 Bool) (temp___do_toplevel_648 Bool) (temp___do_typ_inv_649 Bool)) Bool (=> (or (= temp___is_init_646 true) (bvule #x0000000000000000 #x000000000000003F)) (in_range1 temp___expr_650)))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant2 ctx true true true true) (dynamic_invariant7 (hash_bit_len_of ctx) true false true true)) :pattern ((hash_bit_len_of ctx)))))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant2 ctx true true true true) (= (hash_bit_len_of ctx) (to_rep3 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields5 ctx))))))) :pattern ((hash_bit_len_of ctx)))))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant2 ctx true true true true) (dynamic_invariant3 (byte_count_of ctx) true false true true)) :pattern ((byte_count_of ctx)))))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant2 ctx true true true true) (= (byte_count_of ctx) (to_rep2 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields5 ctx))))))) :pattern ((byte_count_of ctx)))))
(define-fun dynamic_invariant13 ((temp___expr_695 (_ BitVec 8)) (temp___is_init_691 Bool) (temp___skip_constant_692 Bool) (temp___do_toplevel_693 Bool) (temp___do_typ_inv_694 Bool)) Bool (=> (or (= temp___is_init_691 true) (bvule #x00 #x3F)) (in_range4 temp___expr_695)))
(define-fun dynamic_invariant14 ((temp___expr_688 (_ BitVec 8)) (temp___is_init_684 Bool) (temp___skip_constant_685 Bool) (temp___do_toplevel_686 Bool) (temp___do_typ_inv_687 Bool)) Bool (=> (or (= temp___is_init_684 true) (bvule #x00 #x7F)) (in_range3 temp___expr_688)))
(define-fun dynamic_invariant15 ((temp___expr_303 (_ BitVec 64)) (temp___is_init_299 Bool) (temp___skip_constant_300 Bool) (temp___do_toplevel_301 Bool) (temp___do_typ_inv_302 Bool)) Bool true)
...
(assert (and (and (= (to_rep (first (rt data))) #x0000000000000000) (= (add_in_range (to_rep (last (rt data))) #x0000000000000040) true)) (bvult (bvadd (to_rep (last (rt data))) #x0000000000000040) #xFFFFFFFFFFFFFFFF)))
(assert (and (and (and (and (in_range6 (hash_bit_len_of (mk___rep2 ctx__split_fields25))) (= (hash_bit_len_of (mk___rep2 ctx__split_fields25)) #x0000000000000200)) (= (byte_count_of (mk___rep2 ctx__split_fields25)) #x0000000000000000)) (in_range7 (byte_count_of (mk___rep2 ctx__split_fields25)))) (bvult (to_rep (last (mk #x0000000000000000 #x000000000000003F))) #xFFFFFFFFFFFFFFFF)))
(assert (and (and (and (in_range6 (hash_bit_len_of (mk___rep2 ctx__split_fields24))) (= (hash_bit_len_of (mk___rep2 ctx__split_fields24)) (hash_bit_len_of (mk___rep2 ctx__split_fields25)))) (in_range7 (byte_count_of (mk___rep2 ctx__split_fields24)))) (bvult (to_rep (last (mk #x0000000000000000 #x000000000000003F))) #xFFFFFFFFFFFFFFFF)))
(assert (= (to_rep o1) #x000000000000003F))
(assert (= (to_rep o) #x0000000000000000))
(assert (bvult (to_rep o1) #xFFFFFFFFFFFFFFFF))
(assert (= result result__))
(assert (= result__1 (slide skein__skein_512_final__hash (to_rep (first (mk #x0000000000000000 #x000000000000003F))) #x0000000000000000)))
