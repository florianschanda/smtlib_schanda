...
(declare-fun user_eq4 (skein_512_state_bytes_index skein_512_state_bytes_index) Bool)
(declare-const dummy4 skein_512_state_bytes_index)
...
(define-fun dynamic_invariant1 ((temp___expr_581 (Array (_ BitVec 64) byte)) (temp___is_init_578 Bool) (temp___skip_constant_579 Bool) (temp___do_toplevel_580 Bool)) Bool (=> (= temp___do_toplevel_580 true) (=> (= temp___is_init_578 true) (bvult (last1 (of_array temp___expr_581 ((_ int2bv 64) 0) ((_ int2bv 64) 63))) ((_ int2bv 64) 18446744073709551615)))))
(define-fun dynamic_predicate1 ((temp___589 (Array (_ BitVec 64) byte))) Bool (bvult (last1 (of_array temp___589 ((_ int2bv 64) 0) ((_ int2bv 64) 63))) ((_ int2bv 64) 18446744073709551615)))
(declare-fun to_rep2 (u64) (_ BitVec 64))
(declare-fun of_rep2 ((_ BitVec 64)) u64)
(assert (forall ((x u64)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert true)
(assert (forall ((x (_ BitVec 64))) (! (= (to_rep2 (of_rep2 x)) x) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun to_int6 ((x u64)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x u64)) (! (uint_in_range (to_int6 x)) :pattern ((to_int6 x)))))
...
(define-fun bool_eq2 ((a (Array (_ BitVec 64) u64)) (a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b (Array (_ BitVec 64) u64)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_133 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_133) (bvule temp___idx_133 a__last)) (= (to_rep2 (select a temp___idx_133)) (to_rep2 (select b (bvadd (bvsub b__first a__first) temp___idx_133))))))) true false))
(assert (forall ((a (Array (_ BitVec 64) u64)) (b (Array (_ BitVec 64) u64))) (forall ((a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_133 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_133) (bvule temp___idx_133 a__last)) (= (to_rep2 (select a temp___idx_133)) (to_rep2 (select b (bvadd (bvsub b__first a__first) temp___idx_133)))))))))))
...
(assert (forall ((a (Array (_ BitVec 64) u64)) (b (Array (_ BitVec 64) u64))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (bvult (to_rep2 (select a (bvadd i #x0000000000000001))) (to_rep2 (select b (bvadd j #x0000000000000001))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 64) u64)) (b (Array (_ BitVec 64) u64))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (bvugt (to_rep2 (select a (bvadd j #x0000000000000001))) (to_rep2 (select b (bvadd i #x0000000000000001))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(declare-const dummy5 (Array (_ BitVec 64) u64))
...
(declare-fun user_eq5 ((Array (_ BitVec 64) u64) (Array (_ BitVec 64) u64)) Bool)
(declare-const dummy6 (Array (_ BitVec 64) byte))
(declare-const value__size2 Int)
(declare-fun object__size2 ((Array (_ BitVec 64) byte)) Int)
(declare-const value__component__size2 Int)
(declare-fun object__component__size2 ((Array (_ BitVec 64) byte)) Int)
(declare-const value__alignment2 Int)
(declare-fun object__alignment2 ((Array (_ BitVec 64) byte)) Int)
(assert (<= 0 value__size2))
(assert (forall ((a (Array (_ BitVec 64) byte))) (<= 0 (object__size2 a))))
(assert (<= 0 value__component__size2))
(assert (forall ((a (Array (_ BitVec 64) byte))) (<= 0 (object__component__size2 a))))
(assert (<= 0 value__alignment2))
(assert (forall ((a (Array (_ BitVec 64) byte))) (<= 0 (object__alignment2 a))))
(declare-fun user_eq6 ((Array (_ BitVec 64) byte) (Array (_ BitVec 64) byte)) Bool)
...
(define-fun in_range_int1 ((x Int)) Bool (and (<= 0 x) (<= x 18446744073709551608)))
...
(assert (forall ((x hash_bit_length)) (! (in_range2 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 64))) (! (=> (in_range2 x) (= (to_rep3 (of_rep3 x)) x)) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int7 ((x hash_bit_length)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x hash_bit_length)) (! (in_range_int1 (to_int7 x)) :pattern ((to_int7 x)))))
...
(declare-sort u16 0)
(declare-const attr__ATTRIBUTE_MODULUS5 (_ BitVec 16))
...
(declare-fun user_eq8 (u16 u16) Bool)
(declare-const dummy8 u16)
...
(declare-sort u32 0)
(declare-const attr__ATTRIBUTE_MODULUS6 (_ BitVec 32))
...
(assert (forall ((x u7)) (! (in_range3 (to_rep6 x)) :pattern ((to_rep6 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 128)))) (=> (in_range3 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
(define-fun to_int12 ((x u7)) Int (bv2nat (to_rep6 x)))
(assert (forall ((x u7)) (! (in_range_int2 (to_int12 x)) :pattern ((to_int12 x)))))
(declare-sort u6 0)
...
(assert (forall ((x u6)) (! (in_range4 (to_rep7 x)) :pattern ((to_rep7 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 64)))) (=> (in_range4 y) (= (to_rep7 (of_rep7 x)) y))) :pattern ((to_rep7 (of_rep7 x))))))
(define-fun to_int13 ((x u6)) Int (bv2nat (to_rep7 x)))
(assert (forall ((x u6)) (! (in_range_int3 (to_int13 x)) :pattern ((to_int13 x)))))
...
(define-fun in_range5 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 63))))
...
(define-fun dynamic_invariant2 ((temp___expr_652 us_rep2) (temp___is_init_649 Bool) (temp___skip_constant_650 Bool) (temp___do_toplevel_651 Bool)) Bool (=> (= temp___is_init_649 true) (bvult (last1 (of_array (rec__skein__skein_512_context__b (us_split_fields5 temp___expr_652)) ((_ int2bv 64) 0) ((_ int2bv 64) 63))) ((_ int2bv 64) 18446744073709551615))))
...
(define-fun dynamic_invariant3 ((temp___expr_308 (_ BitVec 64)) (temp___is_init_305 Bool) (temp___skip_constant_306 Bool) (temp___do_toplevel_307 Bool)) Bool true)
(assert true)
...
(define-fun in_range6 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 1) x) (bvule x ((_ int2bv 64) 18446744073709551608))))
...
(define-fun in_range7 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 64))))
...
(define-fun dynamic_invariant4 ((temp___expr_290 (_ BitVec 8)) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool)) Bool true)
(define-fun dynamic_invariant5 ((temp___expr_296 (_ BitVec 16)) (temp___is_init_293 Bool) (temp___skip_constant_294 Bool) (temp___do_toplevel_295 Bool)) Bool true)
(define-fun dynamic_invariant6 ((temp___expr_302 (_ BitVec 32)) (temp___is_init_299 Bool) (temp___skip_constant_300 Bool) (temp___do_toplevel_301 Bool)) Bool true)
(define-fun dynamic_invariant7 ((temp___expr_520 (_ BitVec 64)) (temp___is_init_517 Bool) (temp___skip_constant_518 Bool) (temp___do_toplevel_519 Bool)) Bool (=> (or (= temp___is_init_517 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551608))) (in_range2 temp___expr_520)))
(define-fun dynamic_invariant8 ((temp___expr_526 (_ BitVec 64)) (temp___is_init_523 Bool) (temp___skip_constant_524 Bool) (temp___do_toplevel_525 Bool)) Bool (=> (or (= temp___is_init_523 true) (bvule ((_ int2bv 64) 1) ((_ int2bv 64) 18446744073709551608))) (in_range6 temp___expr_526)))
(define-fun dynamic_invariant9 ((temp___expr_547 (_ BitVec 64)) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool)) Bool (=> (or (= temp___is_init_544 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 64))) (in_range7 temp___expr_547)))
(define-fun dynamic_invariant10 ((temp___expr_553 (_ BitVec 64)) (temp___is_init_550 Bool) (temp___skip_constant_551 Bool) (temp___do_toplevel_552 Bool)) Bool (=> (or (= temp___is_init_550 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 63))) (in_range5 temp___expr_553)))
(define-fun dynamic_invariant11 ((temp___expr_559 (Array (_ BitVec 64) byte)) (temp___is_init_556 Bool) (temp___skip_constant_557 Bool) (temp___do_toplevel_558 Bool)) Bool (=> (= temp___do_toplevel_558 true) (=> (= temp___is_init_556 true) (bvult (last1 (of_array temp___expr_559 ((_ int2bv 64) 0) ((_ int2bv 64) 63))) ((_ int2bv 64) 18446744073709551615)))))
(define-fun dynamic_predicate2 ((temp___567 (Array (_ BitVec 64) byte))) Bool (bvult (last1 (of_array temp___567 ((_ int2bv 64) 0) ((_ int2bv 64) 63))) ((_ int2bv 64) 18446744073709551615)))
(define-fun dynamic_invariant12 ((temp___expr_575 (_ BitVec 64)) (temp___is_init_572 Bool) (temp___skip_constant_573 Bool) (temp___do_toplevel_574 Bool)) Bool (=> (or (= temp___is_init_572 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 63))) (in_range1 temp___expr_575)))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant2 ctx true true true) (dynamic_invariant7 (hash_bit_len_of ctx) true false true)) :pattern ((hash_bit_len_of ctx)))))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant2 ctx true true true) (= (hash_bit_len_of ctx) (to_rep3 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields5 ctx))))))) :pattern ((hash_bit_len_of ctx)))))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant2 ctx true true true) (dynamic_invariant3 (byte_count_of ctx) true false true)) :pattern ((byte_count_of ctx)))))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant2 ctx true true true) (= (byte_count_of ctx) (to_rep2 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields5 ctx))))))) :pattern ((byte_count_of ctx)))))
(define-fun dynamic_invariant13 ((temp___expr_615 (_ BitVec 8)) (temp___is_init_612 Bool) (temp___skip_constant_613 Bool) (temp___do_toplevel_614 Bool)) Bool (=> (or (= temp___is_init_612 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 63))) (in_range4 temp___expr_615)))
(define-fun dynamic_invariant14 ((temp___expr_609 (_ BitVec 8)) (temp___is_init_606 Bool) (temp___skip_constant_607 Bool) (temp___do_toplevel_608 Bool)) Bool (=> (or (= temp___is_init_606 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 127))) (in_range3 temp___expr_609)))
(define-fun dynamic_invariant15 ((temp___expr_266 (_ BitVec 64)) (temp___is_init_263 Bool) (temp___skip_constant_264 Bool) (temp___do_toplevel_265 Bool)) Bool true)
(declare-const result__ (Array (_ BitVec 64) byte))
...
(declare-const ctx__split_fields12 u64)
(declare-const ctx__split_fields13 u32)
(declare-const ctx__split_fields14 u16)
(declare-const ctx__split_fields15 u7)
(declare-const ctx__split_fields16 Bool)
(declare-const ctx__split_fields17 u6)
(declare-const ctx__split_fields18 Bool)
(declare-const ctx__split_fields19 Bool)
(declare-const ctx__split_fields20 hash_bit_length)
(declare-const ctx__split_fields21 u64)
(declare-const ctx__split_fields22 (Array (_ BitVec 64) u64))
(declare-const ctx__split_fields23 (Array (_ BitVec 64) byte))
(declare-const skein__skein_512_final__hash (Array (_ BitVec 64) byte))
(declare-const result (Array (_ BitVec 64) byte))
(declare-const result__1 (Array (_ BitVec 64) byte))
(assert (dynamic_invariant data true false true))
(assert (and (and (= (to_rep (first (rt data))) ((_ int2bv 64) 0)) (= (add_in_range (to_rep (last (rt data))) ((_ int2bv 64) 64)) true)) (bvult (bvadd (to_rep (last (rt data))) ((_ int2bv 64) 64)) ((_ int2bv 64) 18446744073709551615))))
(assert (and (and (and (and (in_range6 (hash_bit_len_of (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5 ctx__split_fields6 ctx__split_fields7)) ctx__split_fields8 ctx__split_fields9)) ctx__split_fields10 ctx__split_fields11)))) (= (hash_bit_len_of (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5 ctx__split_fields6 ctx__split_fields7)) ctx__split_fields8 ctx__split_fields9)) ctx__split_fields10 ctx__split_fields11))) ((_ int2bv 64) 512))) (= (byte_count_of (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5 ctx__split_fields6 ctx__split_fields7)) ctx__split_fields8 ctx__split_fields9)) ctx__split_fields10 ctx__split_fields11))) ((_ int2bv 64) 0))) (in_range7 (byte_count_of (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5 ctx__split_fields6 ctx__split_fields7)) ctx__split_fields8 ctx__split_fields9)) ctx__split_fields10 ctx__split_fields11))))) (bvult (to_rep (last (mk ((_ int2bv 64) 0) ((_ int2bv 64) 63)))) ((_ int2bv 64) 18446744073709551615))))
(assert (and (and (and (in_range6 (hash_bit_len_of (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17 ctx__split_fields18 ctx__split_fields19)) ctx__split_fields20 ctx__split_fields21)) ctx__split_fields22 ctx__split_fields23)))) (= (hash_bit_len_of (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17 ctx__split_fields18 ctx__split_fields19)) ctx__split_fields20 ctx__split_fields21)) ctx__split_fields22 ctx__split_fields23))) (hash_bit_len_of (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5 ctx__split_fields6 ctx__split_fields7)) ctx__split_fields8 ctx__split_fields9)) ctx__split_fields10 ctx__split_fields11))))) (in_range7 (byte_count_of (mk___rep2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields ctx__split_fields12 ctx__split_fields13 ctx__split_fields14 ctx__split_fields15 ctx__split_fields16 ctx__split_fields17 ctx__split_fields18 ctx__split_fields19)) ctx__split_fields20 ctx__split_fields21)) ctx__split_fields22 ctx__split_fields23))))) (bvult (to_rep (last (mk ((_ int2bv 64) 0) ((_ int2bv 64) 63)))) ((_ int2bv 64) 18446744073709551615))))
(assert (= (to_rep o1) ((_ int2bv 64) 63)))
(assert (= (to_rep o) ((_ int2bv 64) 0)))
(assert (bvult (to_rep o1) ((_ int2bv 64) 18446744073709551615)))
(assert (= result result__))
(assert (= result__1 (slide skein__skein_512_final__hash (to_rep (first (mk ((_ int2bv 64) 0) ((_ int2bv 64) 63)))) ((_ int2bv 64) 0))))
(assert (not (dynamic_predicate1 result__1)))
(check-sat)
(exit)
