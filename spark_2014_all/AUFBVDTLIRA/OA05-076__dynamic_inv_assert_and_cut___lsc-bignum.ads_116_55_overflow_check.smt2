...
(assert (= a9 a7))
(assert (= o13 (num_of_boolean (bool__content carry8))))
...
(assert (= o6 (num_of_big_int (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last))) a_first o5)))
(assert (= o15 (osubtract o6 o14)))
