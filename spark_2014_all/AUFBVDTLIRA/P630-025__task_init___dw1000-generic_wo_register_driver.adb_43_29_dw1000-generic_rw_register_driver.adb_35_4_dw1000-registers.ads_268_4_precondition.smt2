...
(assert (and (= temp___77792 (register_to_bytes reg)) (dynamic_invariant1 temp___77792 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___77791)) (to_rep (last4 temp___77791))) (+ (- (to_rep (last4 temp___77791)) (to_rep (first4 temp___77791))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___7779 temp___7780))
(assert (= (mk1 (to_rep (first4 temp___77791)) (to_rep (last4 temp___77791))) temp___77801))
(assert (= (ite (<= (to_rep (first2 temp___77801)) (to_rep (last2 temp___77801))) (+ (- (to_rep (last2 temp___77801)) (to_rep (first2 temp___77801))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
