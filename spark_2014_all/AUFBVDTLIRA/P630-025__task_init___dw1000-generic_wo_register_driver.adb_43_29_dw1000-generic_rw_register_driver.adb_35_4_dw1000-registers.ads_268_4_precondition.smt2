...
(declare-const temp___8552 (Array Int bits_8))
(declare-const temp___85521 t1)
...
(assert (= (ite (<= (to_rep (first4 temp___85511)) (to_rep (last4 temp___85511))) (+ (- (to_rep (last4 temp___85511)) (to_rep (first4 temp___85511))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8551 temp___8552))
(assert (= (mk1 (to_rep (first4 temp___85511)) (to_rep (last4 temp___85511))) temp___85521))
(assert (= (ite (<= (to_rep (first2 temp___85521)) (to_rep (last2 temp___85521))) (+ (- (to_rep (last2 temp___85521)) (to_rep (first2 temp___85521))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8552 temp___85521)))
(assert (= o2 o))
