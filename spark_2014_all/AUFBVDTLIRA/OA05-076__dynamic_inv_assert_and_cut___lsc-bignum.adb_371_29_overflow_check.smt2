...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o67 k)) #x00000000))))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (omod (oadd (num_of_big_int (mk___t o68 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o68 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true)))
...
(assert (= a_msw3 o37))
(assert (= o64 (from_word32 #x00000001)))
...
(assert (= o63 (omultiply o57 o62)))
(assert (= o65 (osubtract o63 o64)))
(assert (= o54 (from_word32 a_msw3)))
(assert (and (= o49 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o50 (+ o49 1)))
(assert (and (= o51 o50) (in_range1 o50)))
(assert (and (= o52 o51) (in_range2 o51)))
(assert (and (= o48 (base Tuple0)) (= o48 (oexpon (from_word32 #x00000002) 32))))
(assert (= o53 (oexpon o48 o52)))
(assert (= o55 (omultiply o53 o54)))
(assert (and (= o43 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o44 (+ o43 1)))
(assert (and (= o45 o44) (in_range1 o44)))
(assert (and (= o46 o45) (in_range2 o45)))
(assert (= o47 (num_of_big_int (mk___t o71 (mk (to_rep a__first) (to_rep a__last))) a_first o46)))
(assert (= o56 (oadd o47 o55)))
(assert (= o66 (olt o56 o65)))
