...
(assert (= o53 (from_word32 ((_ int2bv 32) 2))))
(assert (= o59 (omultiply o53 o58)))
(assert (= o61 (osubtract o59 o60)))
(assert (= o50 (from_word32 a_msw2)))
...
(assert (= o43 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first o42)))
(assert (= o52 (oadd o43 o51)))
(assert (= o62 (olt o52 o61)))
...
(assert (= o28 (inverse o26 o27)))
(assert (= o31 (oexpon o28 o30)))
(assert (and (= o16 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o17 (+ o16 1)))
(assert (and (= o18 o17) (in_range1 o17)))
(assert (and (= o19 o18) (in_range2 o18)))
(assert (= o20 (num_of_big_int c c_first o19)))
(assert (and (= o13 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o14 o13) (in_range2 o13)))
(assert (= o15 (num_of_big_int b b_first o14)))
(assert (= o21 (omultiply o15 o20)))
(assert (= o32 (omultiply o21 o31)))
(assert (= o38 (omod o32 o37)))
