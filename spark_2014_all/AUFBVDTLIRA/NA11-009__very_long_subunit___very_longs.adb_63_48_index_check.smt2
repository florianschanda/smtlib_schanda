...
(declare-fun temp___1191 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1193 (_ BitVec 8))) (forall ((temp___1194 Int) (temp___1195 Int)) (let ((temp___1192 (temp___1191 temp___1193 temp___1194 temp___1195))) (=> (dynamic_invariant3 temp___1193 true true true true) (and (=> (dynamic_property6 1 65536 temp___1194 temp___1195) (and (= (first5 temp___1192) temp___1194) (= (last5 temp___1192) temp___1195))) (forall ((temp___1196 Int)) (= (to_rep1 (select (to_array2 temp___1192) temp___1196)) temp___1193))))))))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1191 #x00 1 r9b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1191 #x00 1 r9b)))) r9b))
(assert (= (mk___t2 temp___1198 temp___11981) (temp___1191 #x00 1 r9b)))
(assert (= (ite (<= (to_rep2 (first4 temp___11981)) (to_rep2 (last4 temp___11981))) (+ (- (to_rep2 (last4 temp___11981)) (to_rep2 (first4 temp___11981))) 1) 0) (ite (<= 1 r9b) (+ (- r9b 1) 1) 0)))
(assert (= temp___1198 temp___1199))
(assert (= (mk1 (to_rep2 (first4 temp___11981)) (to_rep2 (last4 temp___11981))) temp___11991))
(assert (= (ite (<= (to_rep2 (first2 temp___11991)) (to_rep2 (last2 temp___11991))) (+ (- (to_rep2 (last2 temp___11991)) (to_rep2 (first2 temp___11991))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1201 temp___12011) (mk___t1 temp___1199 temp___11991)))
(assert (= temp___1201 o))
(assert (= (mk (to_rep2 (first2 temp___12011)) (to_rep2 (last2 temp___12011))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (and (and (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true true) (forall ((temp___1211 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1211) (<= temp___1211 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1211) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1211) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1211)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
