...
(assert (forall ((temp___1124 (_ BitVec 8))) (forall ((temp___1125 Int) (temp___1126 Int)) (let ((temp___1123 (temp___1122 temp___1124 temp___1125 temp___1126))) (and (=> (dynamic_property6 1 65536 temp___1125 temp___1126) (and (= (first5 temp___1123) temp___1125) (= (last5 temp___1123) temp___1126))) (forall ((temp___1127 Int)) (= (select (to_array2 temp___1123) temp___1127) (of_rep1 temp___1124))))))))
...
(assert (and (and (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true) (forall ((temp___1142 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1142) (<= temp___1142 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1142) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1142) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1142)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (= result4 (mk_t__ref1 l_digit1)))
(assert (= l_digit2 o7))
