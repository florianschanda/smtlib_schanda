...
(define-fun dynamic_invariant ((temp___expr_7233 us_t1) (temp___is_init_7230 Bool) (temp___skip_constant_7231 Bool) (temp___do_toplevel_7232 Bool)) Bool (=> (not (= temp___skip_constant_7231 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7233) (last3 temp___expr_7233)) (and (= (first3 temp___expr_7233) 1) (= (last3 temp___expr_7233) 2)))))
