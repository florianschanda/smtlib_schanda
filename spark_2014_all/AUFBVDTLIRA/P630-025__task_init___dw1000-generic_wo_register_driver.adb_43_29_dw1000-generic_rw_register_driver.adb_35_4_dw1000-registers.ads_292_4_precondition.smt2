...
(define-fun dynamic_invariant ((temp___expr_3442 us_t1) (temp___is_init_3439 Bool) (temp___skip_constant_3440 Bool) (temp___do_toplevel_3441 Bool)) Bool (=> (not (= temp___skip_constant_3440 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3442) (last3 temp___expr_3442)) (and (= (first3 temp___expr_3442) 1) (= (last3 temp___expr_3442) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_3459 us_t2) (temp___is_init_3456 Bool) (temp___skip_constant_3457 Bool) (temp___do_toplevel_3458 Bool)) Bool (=> (not (= temp___skip_constant_3457 true)) (and (dynamic_property3 1 2 (first5 temp___expr_3459) (last5 temp___expr_3459)) (and (= (first5 temp___expr_3459) 1) (= (last5 temp___expr_3459) 2)))))
...
(assert (and (= (mk___t2 temp___7826 temp___78261) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7826 temp___78261) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___78261)) (to_rep (last4 temp___78261))) (+ (- (to_rep (last4 temp___78261)) (to_rep (first4 temp___78261))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___7826 temp___7827))
(assert (= (mk1 (to_rep (first4 temp___78261)) (to_rep (last4 temp___78261))) temp___78271))
(assert (= (ite (<= (to_rep (first2 temp___78271)) (to_rep (last2 temp___78271))) (+ (- (to_rep (last2 temp___78271)) (to_rep (first2 temp___78271))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___7827 temp___78271)))
(assert (= o2 o))
