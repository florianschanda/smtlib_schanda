...
(assert (= (let ((temp___250 (to_model (mk___rep r__split_fields3)))) (bool_eq (elts temp___250) (to_rep (first (rt temp___250))) (to_rep (last (rt temp___250))) (temp___246 0) #x0001 #x0000)) true))
