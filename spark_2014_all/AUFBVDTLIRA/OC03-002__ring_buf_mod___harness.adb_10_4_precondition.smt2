...
(assert (= (let ((temp___223 (to_model (mk___rep r__split_fields3)))) (bool_eq (elts temp___223) (to_rep (first (rt temp___223))) (to_rep (last (rt temp___223))) (temp___219 0) ((_ int2bv 16) 1) ((_ int2bv 16) 0))) true))
