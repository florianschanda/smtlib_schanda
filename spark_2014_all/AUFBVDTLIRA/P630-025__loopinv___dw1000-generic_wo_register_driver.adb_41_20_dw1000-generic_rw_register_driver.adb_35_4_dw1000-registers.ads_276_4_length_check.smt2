...
(define-fun temp___77932 () us_t2 (mk___t2 temp___7793 temp___77931))
...
(assert (and (= temp___77932 (register_to_bytes reg)) (dynamic_invariant1 temp___77932 true false true)))
