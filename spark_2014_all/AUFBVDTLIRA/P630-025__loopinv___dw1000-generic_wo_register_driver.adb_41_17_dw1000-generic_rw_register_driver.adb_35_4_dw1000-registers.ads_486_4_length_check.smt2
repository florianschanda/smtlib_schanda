...
(assert (and (= (mk___t2 temp___8055 temp___80551) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8055 temp___80551) true false true)))
...
(assert (not (= (ite (<= (to_rep (first2 temp___80561)) (to_rep (last2 temp___80561))) (+ (- (to_rep (last2 temp___80561)) (to_rep (first2 temp___80561))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
