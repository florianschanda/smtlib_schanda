...
(assert (and (and (and (= us (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 p)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 p))))) (and (and (= us1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))) (and (and (= us2 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))) (and (and (= us3 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))) (and (= (to_rep (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (and (dynamic_invariant2 (mk___rep1 result____split_discrs (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1))) false false true) (and (and (and (= (to_rep (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (dynamic_invariant1 (mk___rep result____split_discrs aco__math__very_longs__modadd_and_carry__result__fields) true true true)) (and (and (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))) (= result____split_fields2 (us_split_fields3 (of_base (mk___rep result____split_discrs aco__math__very_longs__modadd_and_carry__result__fields))))) (= result____split_discrs (us_split_discrs2 (of_base (mk___rep result____split_discrs aco__math__very_longs__modadd_and_carry__result__fields)))))) (and (and (ite (= carry1 ((_ int2bv 16) 1)) (= result1 true) (= result1 (oge (to_base (mk___rep1 result____split_discrs result____split_fields2)) p))) (ite (= result1 true) (and (and (and (and (= (mk___rep (mk___split_discrs o) (mk___split_fields (mk___t o1 o2))) (modsubtract (to_base (mk___rep1 result____split_discrs result____split_fields2)) p)) (and (dynamic_invariant1 (mk___rep (mk___split_discrs o) (mk___split_fields (mk___t o1 o2))) true false true) (= (to_rep o) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 (to_base (mk___rep1 result____split_discrs result____split_fields2)))))))) (= (mk___rep (mk___split_discrs o3) (mk___split_fields (mk___t o4 o5))) (mk___rep (mk___split_discrs o) (mk___split_fields (mk___t o1 o2))))) (= (mk___rep1 (mk___split_discrs temp___1346) (mk___split_fields1 (mk___t1 temp___13461 temp___13462))) (of_base (mk___rep (mk___split_discrs o3) (mk___split_fields (mk___t o4 o5)))))) (and (and (= result2 (mk___split_fields__ref1 result____split_fields2)) (= result____split_fields3 (mk___split_fields1 (mk___t1 temp___13461 temp___13462)))) (= result____split_discrs (mk___split_discrs temp___1346)))) (= result____split_fields3 result____split_fields2))) (and (and (= aco__math__very_longs__add_fp__result4 (mk_very_long__ref aco__math__very_longs__add_fp__result3)) (= aco__math__very_longs__add_fp__result5 aco__math__very_longs__add_fp__result3)) (and (= result3 (mk_very_long__ref (mk___rep (mk___split_discrs aco__math__very_longs__add_fp__result) (mk___split_fields (mk___t aco__math__very_longs__add_fp__result1 aco__math__very_longs__add_fp__result2))))) (= aco__math__very_longs__add_fp__result3 (to_base (mk___rep1 result____split_discrs result____split_fields3))))))))))))) (and (and (= aco__math__very_longs__add_fp__result6 aco__math__very_longs__add_fp__result4) (and (= carry2 (mk_t__ref carry1)) (= result____split_fields4 (mk___split_fields__ref1 result____split_fields3)))) (and (= aco__math__very_longs__add_fp__result7 aco__math__very_longs__add_fp__result5) (and (= carry3 carry1) (= result____split_fields5 result____split_fields3))))))
(assert (= (mk___rep (mk___split_discrs result4) (mk___split_fields (mk___t result5 result6))) (very_long__content aco__math__very_longs__add_fp__result6)))
(assert (not (= (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 (very_long__content aco__math__very_longs__add_fp__result6)))) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(check-sat)
(exit)
