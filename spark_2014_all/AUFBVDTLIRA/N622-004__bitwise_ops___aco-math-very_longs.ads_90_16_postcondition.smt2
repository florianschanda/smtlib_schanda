...
(assert (=> (= result1 true) (and (= o7 (modsubtract (to_base (mk___rep1 result____split_discrs result____split_fields2)) p)) (and (dynamic_invariant1 o7 true false true) (= (to_rep o) (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 (to_base (mk___rep1 result____split_discrs result____split_fields2))))))))))
(assert (=> (= result1 true) (= o6 o7)))
(assert (=> (= result1 true) (= (mk___rep1 (mk___split_discrs temp___1346) (mk___split_fields1 (mk___t1 temp___13461 temp___13462))) (of_base o6))))
(assert (=> (= result1 true) (= result2 (mk___split_fields__ref1 result____split_fields2))))
(assert (=> (= result1 true) (= result____split_fields3 (mk___split_fields1 (mk___t1 temp___13461 temp___13462)))))
(assert (=> (= result1 true) (= result____split_discrs (mk___split_discrs temp___1346))))
