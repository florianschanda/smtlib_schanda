...
(define-fun register_type__ref___111__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___79__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___79__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5353 us_t1) (temp___is_init_5349 Bool) (temp___skip_constant_5350 Bool) (temp___do_toplevel_5351 Bool) (temp___do_typ_inv_5352 Bool)) Bool (=> (not (= temp___skip_constant_5350 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5353) (last3 temp___expr_5353)) (and (= (first3 temp___expr_5353) 1) (= (last3 temp___expr_5353) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___33__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___33__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_5371 us_t2) (temp___is_init_5367 Bool) (temp___skip_constant_5368 Bool) (temp___do_toplevel_5369 Bool) (temp___do_typ_inv_5370 Bool)) Bool (=> (not (= temp___skip_constant_5368 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5371) (last5 temp___expr_5371)) (and (= (first5 temp___expr_5371) 1) (= (last5 temp___expr_5371) 2)))))
...
(declare-const temp___8721 (Array Int bits_8))
(declare-const temp___87211 t2)
(declare-const temp___8722 (Array Int bits_8))
(declare-const temp___87221 t1)
(define-fun temp___87212 () us_t2 (mk___t2 temp___8721 temp___87211))
...
(assert (and (= temp___87212 (register_to_bytes reg)) (dynamic_invariant1 temp___87212 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___87211)) (to_rep (last4 temp___87211))) (+ (- (to_rep (last4 temp___87211)) (to_rep (first4 temp___87211))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8721 temp___8722))
(assert (= (mk1 (to_rep (first4 temp___87211)) (to_rep (last4 temp___87211))) temp___87221))
(assert (not (= (ite (<= (to_rep (first2 temp___87221)) (to_rep (last2 temp___87221))) (+ (- (to_rep (last2 temp___87221)) (to_rep (first2 temp___87221))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
