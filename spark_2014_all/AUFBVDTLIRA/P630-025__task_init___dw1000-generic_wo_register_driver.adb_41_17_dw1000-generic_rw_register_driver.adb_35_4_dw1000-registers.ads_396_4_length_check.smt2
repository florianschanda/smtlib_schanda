...
(define-fun dynamic_invariant ((temp___expr_4882 us_t1) (temp___is_init_4879 Bool) (temp___skip_constant_4880 Bool) (temp___do_toplevel_4881 Bool)) Bool (=> (not (= temp___skip_constant_4880 true)) (and (dynamic_property2 1 2 (first3 temp___expr_4882) (last3 temp___expr_4882)) (and (= (first3 temp___expr_4882) 1) (= (last3 temp___expr_4882) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_4898 us_t2) (temp___is_init_4895 Bool) (temp___skip_constant_4896 Bool) (temp___do_toplevel_4897 Bool)) Bool (=> (not (= temp___skip_constant_4896 true)) (and (dynamic_property3 1 2 (first5 temp___expr_4898) (last5 temp___expr_4898)) (and (= (first5 temp___expr_4898) 1) (= (last5 temp___expr_4898) 2)))))
...
(assert (and (= (mk___t2 temp___7949 temp___79491) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7949 temp___79491) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___79491)) (to_rep (last4 temp___79491))) (+ (- (to_rep (last4 temp___79491)) (to_rep (first4 temp___79491))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___7949 temp___7950))
(assert (= (mk1 (to_rep (first4 temp___79491)) (to_rep (last4 temp___79491))) temp___79501))
(assert (not (= (ite (<= (to_rep (first2 temp___79501)) (to_rep (last2 temp___79501))) (+ (- (to_rep (last2 temp___79501)) (to_rep (first2 temp___79501))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
