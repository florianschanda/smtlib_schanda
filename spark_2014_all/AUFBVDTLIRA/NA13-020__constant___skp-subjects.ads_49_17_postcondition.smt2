...
(assert (= (bvurem skp__subjects__get_pml4_address__result ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))
(assert (= result skp__subjects__get_pml4_address__result))
(assert (not (= (bvurem skp__subjects__get_pml4_address__result ((_ int2bv 64) 4096)) ((_ int2bv 64) 0))))
(check-sat)
(exit)
