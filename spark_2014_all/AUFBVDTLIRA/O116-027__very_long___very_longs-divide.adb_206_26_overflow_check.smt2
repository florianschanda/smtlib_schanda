...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1385 (mk___rep1 u__split_discrs (mk___split_fields1 (mk___t1 u__split_fields u__split_fields1))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1384 sum)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1383 carry1)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o22 (to_rep2 o21))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o23 ((_ zero_extend 8) o22))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (= o16 (+ j divisor_index2)) (in_range2 (+ j divisor_index2)))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1377 (- o16 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1377) (<= temp___1377 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o17 temp___1377)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o19 (to_rep2 o18))))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= (to_rep2 o29) o28)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (= o27 (+ j divisor_index2)) (in_range2 (+ j divisor_index2)))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1380 (- o27 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1380) (<= temp___1380 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o30 temp___1380)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1382 (mk___rep1 u__split_discrs o33))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= result5 (mk___split_fields__ref1 u__split_fields3))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= u__split_fields4 (us_split_fields3 temp___1382))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= u__split_discrs (us_split_discrs2 temp___1382))))
