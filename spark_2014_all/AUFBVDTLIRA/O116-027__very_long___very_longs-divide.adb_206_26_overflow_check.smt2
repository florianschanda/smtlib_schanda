...
(declare-fun to_rep1 (tdigit_count_typeB) Int)
(declare-fun of_rep1 (Int) tdigit_count_typeB)
(assert (forall ((x tdigit_count_typeB)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x tdigit_count_typeB)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 a))) (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 b)))) (= (bool_eq1 (rec__very_longs__very_long__long_digits (us_split_fields1 a)) (rec__very_longs__very_long__long_digits (us_split_fields1 b))) true)) true false))
...
(define-fun dynamic_invariant1 ((temp___expr_248 us_rep) (temp___is_init_244 Bool) (temp___skip_constant_245 Bool) (temp___do_toplevel_246 Bool) (temp___do_typ_inv_247 Bool)) Bool (let ((temp___249 (rec__very_longs__very_long__length (us_split_discrs1 temp___expr_248)))) (and (dynamic_property1 1 (to_rep2 temp___249) (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_248))) (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_248)))) (and (= (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_248))) 1) (= (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_248))) (to_rep2 temp___249))))))
...
(define-fun dynamic_invariant3 ((temp___expr_235 (_ BitVec 8)) (temp___is_init_231 Bool) (temp___skip_constant_232 Bool) (temp___do_toplevel_233 Bool) (temp___do_typ_inv_234 Bool)) Bool true)
...
(define-fun dynamic_invariant5 ((temp___expr_751 Int) (temp___is_init_747 Bool) (temp___skip_constant_748 Bool) (temp___do_toplevel_749 Bool) (temp___do_typ_inv_750 Bool)) Bool (=> (or (= temp___is_init_747 true) (<= 1 last2)) (dynamic_property2 1 last2 temp___expr_751)))
(assert (= last2 (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 divisor)))))
...
(define-fun bool_eq4 ((a us_rep1) (b us_rep1)) Bool (ite (and (= (to_rep2 (rec__very_longs__very_long__length (us_split_discrs2 a))) (to_rep2 (rec__very_longs__very_long__length (us_split_discrs2 b)))) (= (bool_eq3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 a)) (rec__very_longs__very_long__long_digits1 (us_split_fields3 b))) true)) true false))
(define-fun in_range4 ((rec__very_longs__very_long__length1 Int) (a us_rep)) Bool (= rec__very_longs__very_long__length1 (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant6 ((temp___expr_772 us_rep1) (temp___is_init_768 Bool) (temp___skip_constant_769 Bool) (temp___do_toplevel_770 Bool) (temp___do_typ_inv_771 Bool)) Bool (and (=> (not (= temp___skip_constant_769 true)) (in_range4 (+ (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1) (to_base temp___expr_772))) (and (dynamic_property4 1 (+ (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1) (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_772))) (last4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_772)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_772))) 1) (= (last4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_772))) (+ (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1))))))
(define-fun default_initial_assumption ((temp___expr_775 us_rep1) (temp___skip_top_level_776 Bool)) Bool (= (to_rep2 (rec__very_longs__very_long__length (us_split_discrs2 temp___expr_775))) (+ (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1)))
...
(define-fun bool_eq6 ((a us_rep2) (b us_rep2)) Bool (ite (and (= (to_rep2 (rec__very_longs__very_long__length (us_split_discrs3 a))) (to_rep2 (rec__very_longs__very_long__length (us_split_discrs3 b)))) (= (bool_eq5 (rec__very_longs__very_long__long_digits2 (us_split_fields5 a)) (rec__very_longs__very_long__long_digits2 (us_split_fields5 b))) true)) true false))
(define-fun in_range5 ((rec__very_longs__very_long__length1 Int) (a us_rep)) Bool (= rec__very_longs__very_long__length1 (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant7 ((temp___expr_785 us_rep2) (temp___is_init_781 Bool) (temp___skip_constant_782 Bool) (temp___do_toplevel_783 Bool) (temp___do_typ_inv_784 Bool)) Bool (and (=> (not (= temp___skip_constant_782 true)) (in_range5 (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 divisor))) (to_base1 temp___expr_785))) (and (dynamic_property6 1 (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 divisor))) (first5 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_785))) (last6 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_785)))) (and (= (first5 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_785))) 1) (= (last6 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_785))) (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 divisor))))))))
(define-fun default_initial_assumption1 ((temp___expr_788 us_rep2) (temp___skip_top_level_789 Bool)) Bool (= (to_rep2 (rec__very_longs__very_long__length (us_split_discrs3 temp___expr_788))) (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 divisor)))))
...
(declare-const o6 t)
(declare-const temp___1369 digit_index_type)
(declare-const temp___13691 (Array Int octet))
(declare-const temp___13692 t)
...
(declare-const temp___1373 us_rep)
(declare-const temp___1383 us_rep1)
(declare-const temp___1382 (_ BitVec 16))
(declare-const temp___1381 (_ BitVec 16))
(declare-const o16 Int)
(declare-const temp___1375 Int)
...
(assert (= o5 o3))
(assert (= o6 o4))
(assert (= quotient__split_discrs (mk___split_discrs temp___1369)))
(assert (= temp___13691 o5))
(assert (= temp___13692 o6))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t quotient__split_fields quotient__split_fields1)))))
(assert (= quotient__split_fields2 (mk___split_fields (mk___t temp___13691 temp___13692))))
(assert (= quotient__split_discrs (mk___split_discrs temp___1369)))
...
(assert (= temp___1373 (mk___rep quotient__split_discrs o15)))
(assert (= result1 (mk___split_fields__ref quotient__split_fields2)))
(assert (= quotient__split_fields3 (us_split_fields1 temp___1373)))
(assert (= quotient__split_discrs (us_split_discrs1 temp___1373)))
(assert (= result2 (mk_t__ref1 carry)))
(assert (= carry1 #x0000))
(assert (= n r129b))
(assert (dynamic_property2 1 last2 r129b))
(assert (= result3 (mk_int__ref divisor_index)))
(assert (= divisor_index1 1))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1383 (mk___rep1 u__split_discrs (mk___split_fields1 (mk___t1 u__split_fields u__split_fields1))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1382 sum)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1381 carry1)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields3) true true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r129b)))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (<= (to_rep1 (first4 v__split_fields1)) divisor_index2) (<= divisor_index2 (to_rep1 (last5 v__split_fields1))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o20 divisor_index2)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o21 (select v__split_fields o20))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o22 (to_rep o21))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o23 ((_ zero_extend 8) o22))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (= o16 (+ j divisor_index2)) (in_range1 (+ j divisor_index2)))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1375 (- o16 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1375) (<= temp___1375 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o17 temp___1375)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o18 (select (elts1 (rec__very_longs__very_long__long_digits1 u__split_fields3)) o17))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o19 (to_rep o18))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o24 ((_ zero_extend 8) o19))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o25 (bvadd o24 o23))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o26 (bvadd o25 carry2))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= result4 (mk_t__ref1 sum2))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= sum3 o26)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o28 (takelsb_from16 sum3))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= (to_rep o29) o28)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (= o27 (+ j divisor_index2)) (in_range1 (+ j divisor_index2)))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1378 (- o27 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1378) (<= temp___1378 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o30 temp___1378)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o31 (store (elts1 (rec__very_longs__very_long__long_digits1 u__split_fields3)) o30 o29))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o32 (mk___t1 o31 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o33 (mk___split_fields1 o32))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1380 (mk___rep1 u__split_discrs o33))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= result5 (mk___split_fields__ref1 u__split_fields3))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= u__split_fields4 (us_split_fields3 temp___1380))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= u__split_discrs (us_split_discrs2 temp___1380))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (= o34 (shift_right sum3 8)) (= o34 (bvudiv sum3 (ite (< 8 65536) (bvshl #x0001 ((_ int2bv 16) 8)) #x0000))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= result6 (mk_t__ref1 carry2))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= carry3 o34)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= divisor_index2 r129b)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= divisor_index3 (mk_int__ref divisor_index2))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= sum4 (mk_t__ref1 sum3))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= carry4 (mk_t__ref1 carry3))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= u__split_fields5 (mk___split_fields__ref1 u__split_fields4))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= divisor_index4 divisor_index2)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= sum5 sum3)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= carry5 carry3)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= u__split_fields6 u__split_fields4)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= divisor_index5 divisor_index3)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= sum6 sum4)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= carry6 carry4)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= u__split_fields7 u__split_fields5)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= divisor_index6 divisor_index4)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= sum7 sum5)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= carry7 carry5)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= u__split_fields8 u__split_fields6)))
(assert (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r129b))) (= divisor_index5 (mk_int__ref divisor_index1))))
(assert (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r129b))) (= sum6 (mk_t__ref1 sum))))
(assert (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r129b))) (= carry6 (mk_t__ref1 carry1))))
(assert (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r129b))) (= u__split_fields7 (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 u__split_fields u__split_fields1))))))
(assert (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r129b))) (= divisor_index6 divisor_index1)))
(assert (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r129b))) (= sum7 sum1)))
(assert (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r129b))) (= carry7 carry1)))
(assert (=> (not (and (<= 1 divisor_index1) (<= divisor_index1 r129b))) (= u__split_fields8 u__split_fields2)))
(assert (= o37 (takelsb_from16 (t__content1 carry6))))
(assert (and (= temp___1389 (+ j n)) (in_range1 (+ j n))))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields7))))) temp___1389) (<= temp___1389 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields7))))))))
(assert (= o35 temp___1389))
(assert (= o36 (select (elts1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields7))) o35)))
(assert (= o38 (to_rep o36)))
(assert (= o39 (bvadd o38 o37)))
