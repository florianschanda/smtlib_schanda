...
(define-fun dynamic_invariant1 ((temp___expr_221 us_rep) (temp___is_init_218 Bool) (temp___skip_constant_219 Bool) (temp___do_toplevel_220 Bool)) Bool (let ((temp___222 (rec__very_longs__very_long__length (us_split_discrs1 temp___expr_221)))) (and (dynamic_property1 1 (to_rep2 temp___222) (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_221))) (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_221)))) (and (= (first1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_221))) 1) (= (last1 (rec__very_longs__very_long__long_digits (us_split_fields1 temp___expr_221))) (to_rep2 temp___222))))))
...
(define-fun dynamic_invariant5 ((temp___expr_690 Int) (temp___is_init_687 Bool) (temp___skip_constant_688 Bool) (temp___do_toplevel_689 Bool)) Bool (=> (or (= temp___is_init_687 true) (<= 1 last2)) (dynamic_property2 1 last2 temp___expr_690)))
...
(define-fun dynamic_invariant6 ((temp___expr_708 us_rep1) (temp___is_init_705 Bool) (temp___skip_constant_706 Bool) (temp___do_toplevel_707 Bool)) Bool (and (=> (not (= temp___skip_constant_706 true)) (in_range4 (+ (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1) (to_base temp___expr_708))) (and (dynamic_property4 1 (+ (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1) (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_708))) (last4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_708)))) (and (= (first3 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_708))) 1) (= (last4 (rec__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_708))) (+ (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1))))))
(define-fun default_initial_assumption ((temp___expr_711 us_rep1) (temp___skip_top_level_712 Bool)) Bool (= (to_rep2 (rec__very_longs__very_long__length (us_split_discrs2 temp___expr_711))) (+ (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 dividend))) 1)))
...
(define-fun dynamic_invariant7 ((temp___expr_720 us_rep2) (temp___is_init_717 Bool) (temp___skip_constant_718 Bool) (temp___do_toplevel_719 Bool)) Bool (and (=> (not (= temp___skip_constant_718 true)) (in_range5 (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 divisor))) (to_base1 temp___expr_720))) (and (dynamic_property6 1 (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 divisor))) (first5 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_720))) (last6 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_720)))) (and (= (first5 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_720))) 1) (= (last6 (rec__very_longs__very_long__long_digits2 (us_split_fields5 temp___expr_720))) (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 divisor))))))))
(define-fun default_initial_assumption1 ((temp___expr_723 us_rep2) (temp___skip_top_level_724 Bool)) Bool (= (to_rep2 (rec__very_longs__very_long__length (us_split_discrs3 temp___expr_723))) (to_rep2 (rec__very_longs__very_long__length (us_split_discrs1 divisor)))))
...
(declare-const o6 t)
(declare-const temp___1300 digit_index_type)
(declare-const temp___13001 (Array Int octet))
(declare-const temp___13002 t)
...
(declare-const temp___1314 us_rep1)
(declare-const temp___1313 (_ BitVec 16))
(declare-const temp___1312 (_ BitVec 16))
...
(declare-const temp___1311 us_rep1)
...
(assert (= o5 o3))
(assert (= o6 o4))
(assert (= quotient__split_discrs (mk___split_discrs temp___1300)))
(assert (= temp___13001 o5))
(assert (= temp___13002 o6))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t quotient__split_fields quotient__split_fields1)))))
(assert (= quotient__split_fields2 (mk___split_fields (mk___t temp___13001 temp___13002))))
(assert (= quotient__split_discrs (mk___split_discrs temp___1300)))
...
(assert (= temp___1304 (mk___rep quotient__split_discrs o15)))
(assert (= result1 (mk___split_fields__ref quotient__split_fields2)))
(assert (= quotient__split_fields3 (us_split_fields1 temp___1304)))
(assert (= quotient__split_discrs (us_split_discrs1 temp___1304)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1314 (mk___rep1 u__split_discrs (mk___split_fields1 (mk___t1 u__split_fields u__split_fields1))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1313 sum)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1312 carry1)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields3) true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r129b)))))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1306 (- o16 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1306) (<= temp___1306 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o17 temp___1306)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1309 (- o27 1))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3)))) temp___1309) (<= temp___1309 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields3))))))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= o30 temp___1309)))
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= temp___1311 (mk___rep1 u__split_discrs o33))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= result5 (mk___split_fields__ref1 u__split_fields3))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= u__split_fields4 (us_split_fields3 temp___1311))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (= u__split_discrs (us_split_discrs2 temp___1311))))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r129b)) (and (= o34 (shift_right sum3 8)) (= o34 (bvudiv sum3 (ite (< 8 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) 8)) ((_ int2bv 16) 0)))))))
...
(assert (and (= temp___1320 (+ j n)) (in_range1 (+ j n))))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields7))))) temp___1320) (<= temp___1320 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 u__split_fields7))))))))
(assert (= o35 temp___1320))
