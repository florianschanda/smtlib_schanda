...
(assert (= i4 r109b))
(assert (=> (and (<= r109b i4) (<= i4 r110b)) (and (and (= temp___1771 token1) (and (= temp___1773 i4) (and (and (<= 1 begidx2) (<= begidx2 endidx2)) (and (and (=> (<= r109b r110b) (dynamic_property r109b r110b i5)) (and (<= r109b i5) (<= i5 r110b))) (and (and (and (= (to_rep o3) (to_rep (select zonefileline i5))) (and (and (and (and (and (= o1 (+ i5 1)) (in_range1 (+ i5 1))) (= o2 (- o1 begidx2))) (and (= temp___1770 o2) (in_range1 o2))) (and (and (<= 1 temp___1770) (<= temp___1770 256)) (= o4 temp___1770))) (= o5 (store token2 o4 o3)))) (and (= result5 (mk_map__ref token2)) (= token3 o5))) (= i5 r110b)))))) (and (and (= i9 (mk_int__ref i5)) (= token6 (mk_map__ref token3))) (and (= i10 i5) (= token7 token3))))))
(assert (=> (and (<= r109b i4) (<= i4 r110b)) (= i11 i9)))
(assert (=> (and (<= r109b i4) (<= i4 r110b)) (= token8 token6)))
(assert (=> (and (<= r109b i4) (<= i4 r110b)) (= i12 i10)))
(assert (=> (and (<= r109b i4) (<= i4 r110b)) (= token9 token7)))
(assert (=> (not (and (<= r109b i4) (<= i4 r110b))) (= i11 (mk_int__ref i4))))
(assert (=> (not (and (<= r109b i4) (<= i4 r110b))) (= token8 (mk_map__ref token1))))
(assert (=> (not (and (<= r109b i4) (<= i4 r110b))) (= i12 i4)))
(assert (=> (not (and (<= r109b i4) (<= i4 r110b))) (= token9 token1)))
(assert (not (<= 128 lengthoftoken2)))
(assert (= result8 (mk_map__ref newowner)))
(assert (= newowner2 blankdomainname))
(assert (= lengthoftoken2 r112b))
(assert (in_range5 r112b))
(assert (= result9 (mk_int__ref i1)))
(assert (= i13 1))
(assert (<= 1 i13))
(assert (<= i13 r112b))
(assert (< lengthoftoken2 128))
(assert (and (and (=> (<= 1 r112b) (dynamic_property1 1 r112b i14)) (forall ((temp___1778 Int)) (=> (and (<= 1 temp___1778) (<= temp___1778 128)) (=> (<= i14 temp___1778) (= (select newowner3 temp___1778) (select newowner2 temp___1778)))))) (and (<= 1 i14) (<= i14 r112b))))
(assert (= (to_rep o6) (to_rep (select (map__content token8) i14))))
(assert (and (<= 1 i14) (<= i14 128)))
(assert (= o7 i14))
(assert (= o8 (store newowner3 o7 o6)))
(assert (= result10 (mk_map__ref newowner3)))
(assert (= newowner4 o8))
(assert (not (= i14 r112b)))
(assert (= result11 (mk_int__ref i14)))
(assert (= i15 (+ i14 1)))
(assert (= i16 (mk_int__ref i15)))
(assert (= newowner5 (mk_map__ref newowner4)))
(assert (= i17 i15))
(assert (= newowner6 newowner4))
(assert (not true))
(check-sat)
(exit)
