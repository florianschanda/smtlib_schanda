...
(assert (= o80 (- o79 a_first)))
(assert (and (= o81 o80) (in_range1 o80)))
(assert (and (= o82 o81) (in_range2 o81)))
(assert (= o83 (num_of_big_int b b_first o82)))
(assert (= o85 (omultiply o83 o84)))
(assert (and (= o75 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o76 (- o75 a_first)))
(assert (not (in_range1 o76)))
(check-sat)
(exit)
