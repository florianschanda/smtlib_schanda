...
(assert (= a1 result2))
(assert (= a2 o15))
(assert (and (= o55 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o56 (ite (<= k o55) true false)))
(assert (and (= o54 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o57 (ite (<= o54 k) true false)))
(assert (= result3 (ite (= o57 true) o56 false)))
(assert (= (= o58 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
(assert (= o49 (from_word32 carry22)))
(assert (and (= o48 (base Tuple0)) (= o48 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o50 (omultiply o48 o49)))
(assert (= o47 (from_word32 carry12)))
(assert (= o51 (oadd o47 o50)))
(assert (and (= o42 (+ i2 1)) (in_range1 (+ i2 1))))
...
(assert (= o46 (oexpon o41 o45)))
(assert (= o52 (omultiply o46 o51)))
...
(assert (= o53 (oadd o40 o52)))
(assert (= o34 (from_word32 carry2)))
(assert (and (= o33 (base Tuple0)) (= o33 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o35 (omultiply o33 o34)))
(assert (= o32 (from_word32 carry1)))
(assert (= o30 (from_word32 y)))
(assert (and (= o25 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o26 (- o25 a_first)))
(assert (and (= o27 o26) (in_range1 o26)))
(assert (and (= o28 o27) (in_range2 o27)))
(assert (= o29 (num_of_big_int c c_first o28)))
(assert (= o31 (omultiply o29 o30)))
(assert (= o23 (from_word32 x)))
(assert (and (= o18 (+ i2 1)) (in_range1 (+ i2 1))))
