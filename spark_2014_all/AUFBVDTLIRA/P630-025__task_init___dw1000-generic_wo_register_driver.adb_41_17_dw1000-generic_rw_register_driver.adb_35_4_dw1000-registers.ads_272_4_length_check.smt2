...
(define-fun to_int5 ((x bits_4)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x bits_4)) (! (in_range_int (to_int5 x)) :pattern ((to_int5 x)))))
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__ack_resp_t_type__w4d_tim bits_20) (rec__dw1000__register_types__ack_resp_t_type__ack_tim bits_8) (rec__dw1000__register_types__ack_resp_t_type__reserved bits_4)))))
(define-fun us_split_fields_W4D_TIM__projection ((a us_split_fields)) bits_20 (rec__dw1000__register_types__ack_resp_t_type__w4d_tim a))
(define-fun us_split_fields_ACK_TIM__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__ack_resp_t_type__ack_tim a))
(define-fun us_split_fields_Reserved__2__projection ((a us_split_fields)) bits_4 (rec__dw1000__register_types__ack_resp_t_type__reserved a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___21__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___21__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep3 (rec__dw1000__register_types__ack_resp_t_type__w4d_tim (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__ack_resp_t_type__w4d_tim (us_split_fields1 b)))) (= (to_rep1 (rec__dw1000__register_types__ack_resp_t_type__ack_tim (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__ack_resp_t_type__ack_tim (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__ack_resp_t_type__reserved (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__ack_resp_t_type__reserved (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__ack_resp_t_type__w4d_tim__first__bit Int)
(declare-const dw1000__register_types__ack_resp_t_type__w4d_tim__last__bit Int)
(declare-const dw1000__register_types__ack_resp_t_type__w4d_tim__position Int)
(assert (<= 0 dw1000__register_types__ack_resp_t_type__w4d_tim__first__bit))
(assert (< dw1000__register_types__ack_resp_t_type__w4d_tim__first__bit dw1000__register_types__ack_resp_t_type__w4d_tim__last__bit))
(assert (<= 0 dw1000__register_types__ack_resp_t_type__w4d_tim__position))
(declare-const dw1000__register_types__ack_resp_t_type__ack_tim__first__bit Int)
(declare-const dw1000__register_types__ack_resp_t_type__ack_tim__last__bit Int)
(declare-const dw1000__register_types__ack_resp_t_type__ack_tim__position Int)
(assert (<= 0 dw1000__register_types__ack_resp_t_type__ack_tim__first__bit))
(assert (< dw1000__register_types__ack_resp_t_type__ack_tim__first__bit dw1000__register_types__ack_resp_t_type__ack_tim__last__bit))
(assert (<= 0 dw1000__register_types__ack_resp_t_type__ack_tim__position))
(declare-const dw1000__register_types__ack_resp_t_type__reserved__first__bit Int)
(declare-const dw1000__register_types__ack_resp_t_type__reserved__last__bit Int)
(declare-const dw1000__register_types__ack_resp_t_type__reserved__position Int)
(assert (<= 0 dw1000__register_types__ack_resp_t_type__reserved__first__bit))
(assert (< dw1000__register_types__ack_resp_t_type__reserved__first__bit dw1000__register_types__ack_resp_t_type__reserved__last__bit))
(assert (<= 0 dw1000__register_types__ack_resp_t_type__reserved__position))
(declare-fun user_eq6 (us_rep us_rep) Bool)
(declare-const dummy6 us_rep)
(declare-datatypes () ((ack_resp_t_type__ref (mk_ack_resp_t_type__ref (ack_resp_t_type__content us_rep)))))
(define-fun ack_resp_t_type__ref___projection ((a ack_resp_t_type__ref)) us_rep (ack_resp_t_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___43__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___32__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___32__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3078 us_t1) (temp___is_init_3075 Bool) (temp___skip_constant_3076 Bool) (temp___do_toplevel_3077 Bool)) Bool (=> (not (= temp___skip_constant_3076 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3078) (last3 temp___expr_3078)) (and (= (first3 temp___expr_3078) 1) (= (last3 temp___expr_3078) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___12__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___12__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_3096 us_t2) (temp___is_init_3093 Bool) (temp___skip_constant_3094 Bool) (temp___do_toplevel_3095 Bool)) Bool (=> (not (= temp___skip_constant_3094 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3096) (last5 temp___expr_3096)) (and (= (first5 temp___expr_3096) 1) (= (last5 temp___expr_3096) 4)))))
...
(declare-const temp___7786 (Array Int bits_8))
(declare-const temp___77861 t2)
(declare-const temp___7787 (Array Int bits_8))
(declare-const temp___77871 t1)
...
(assert (and (= (mk___t2 temp___7786 temp___77861) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7786 temp___77861) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___77861)) (to_rep (last4 temp___77861))) (+ (- (to_rep (last4 temp___77861)) (to_rep (first4 temp___77861))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7786 temp___7787))
(assert (= (mk1 (to_rep (first4 temp___77861)) (to_rep (last4 temp___77861))) temp___77871))
(assert (not (= (ite (<= (to_rep (first2 temp___77871)) (to_rep (last2 temp___77871))) (+ (- (to_rep (last2 temp___77871)) (to_rep (first2 temp___77871))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
