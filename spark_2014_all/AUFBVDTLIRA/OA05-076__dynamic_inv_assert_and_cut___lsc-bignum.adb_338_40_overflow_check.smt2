...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o58 k)) #x00000000))))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (omod (oadd (num_of_big_int (mk___t o59 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o59 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true)))
...
(assert (= o45 (from_word32 a_msw2)))
(assert (and (= o40 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o41 (+ o40 1)))
(assert (and (= o42 o41) (in_range1 o41)))
(assert (and (= o43 o42) (in_range2 o42)))
(assert (and (= o39 (base Tuple0)) (= o39 (oexpon (from_word32 #x00000002) 32))))
(assert (= o44 (oexpon o39 o43)))
(assert (= o46 (omultiply o44 o45)))
(assert (and (= o34 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o35 (+ o34 1)))
(assert (and (= o36 o35) (in_range1 o35)))
(assert (and (= o37 o36) (in_range2 o36)))
(assert (= o38 (num_of_big_int (mk___t o59 (mk (to_rep a__first) (to_rep a__last))) a_first o37)))
(assert (= o47 (oadd o38 o46)))
(assert (= o57 (olt o47 o56)))
...
(assert (= o23 (inverse o21 o22)))
(assert (= o26 (oexpon o23 o25)))
...
(assert (= o10 (num_of_big_int b b_first o9)))
(assert (= o16 (omultiply o10 o15)))
(assert (= o27 (omultiply o16 o26)))
