...
(define-fun in_range2 ((x (_ BitVec 32))) Bool (and (bvule #x00000000 x) (bvule x #x0001869F)))
...
(define-fun dynamic_invariant1 ((temp___expr_2080 (_ BitVec 32)) (temp___is_init_2076 Bool) (temp___skip_constant_2077 Bool) (temp___do_toplevel_2078 Bool) (temp___do_typ_inv_2079 Bool)) Bool (=> (or (= temp___is_init_2076 true) (bvule #x00000000 #x0001869F)) (in_range2 temp___expr_2080)))
(declare-sort cell 0)
...
(define-fun dynamic_invariant2 ((temp___expr_2115 Int) (temp___is_init_2111 Bool) (temp___skip_constant_2112 Bool) (temp___do_toplevel_2113 Bool) (temp___do_typ_inv_2114 Bool)) Bool (=> (or (= temp___is_init_2111 true) (<= 1 20)) (in_range4 temp___expr_2115)))
...
(define-fun dynamic_invariant3 ((temp___expr_2185 Int) (temp___is_init_2181 Bool) (temp___skip_constant_2182 Bool) (temp___do_toplevel_2183 Bool) (temp___do_typ_inv_2184 Bool)) Bool (=> (or (= temp___is_init_2181 true) (<= 0 4)) (in_range9 temp___expr_2185)))
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun get_state (Int) Int)
(declare-fun get_state__function_guard (Int Int) Bool)
(assert (forall ((patris__cur_state Int)) (! (=> (dynamic_invariant3 patris__cur_state true true true true) (dynamic_invariant3 (get_state patris__cur_state) true false true true)) :pattern ((get_state patris__cur_state)))))
(assert (forall ((patris__cur_state Int)) (! (=> (dynamic_invariant3 patris__cur_state true true true true) (= (get_state patris__cur_state) patris__cur_state)) :pattern ((get_state patris__cur_state)))))
...
(define-fun dynamic_invariant4 ((temp___expr_2087 Int) (temp___is_init_2083 Bool) (temp___skip_constant_2084 Bool) (temp___do_toplevel_2085 Bool) (temp___do_typ_inv_2086 Bool)) Bool (=> (or (= temp___is_init_2083 true) (<= 0 7)) (in_range3 temp___expr_2087)))
(assert (forall ((temp___538 Int)) (=> (dynamic_invariant4 temp___538 true true true true) (forall ((temp___539 Int)) (= (to_rep (select (patris__delete_complete_lines__empty_line__aggregate_def temp___538) temp___539)) temp___538)))))
(define-fun dynamic_invariant5 ((temp___expr_2094 Int) (temp___is_init_2090 Bool) (temp___skip_constant_2091 Bool) (temp___do_toplevel_2092 Bool) (temp___do_typ_inv_2093 Bool)) Bool (=> (or (= temp___is_init_2090 true) (<= 1 7)) (in_range5 temp___expr_2094)))
...
(define-fun dynamic_invariant6 ((temp___expr_2108 Int) (temp___is_init_2104 Bool) (temp___skip_constant_2105 Bool) (temp___do_toplevel_2106 Bool) (temp___do_typ_inv_2107 Bool)) Bool (=> (or (= temp___is_init_2104 true) (<= 1 10)) (in_range10 temp___expr_2108)))
(assert true)
...
(define-fun dynamic_invariant7 ((temp___expr_2153 Int) (temp___is_init_2149 Bool) (temp___skip_constant_2150 Bool) (temp___do_toplevel_2151 Bool) (temp___do_typ_inv_2152 Bool)) Bool (=> (or (= temp___is_init_2149 true) (<= (- 1) 9)) (in_range6 temp___expr_2153)))
(define-fun dynamic_invariant8 ((temp___expr_2160 Int) (temp___is_init_2156 Bool) (temp___skip_constant_2157 Bool) (temp___do_toplevel_2158 Bool) (temp___do_typ_inv_2159 Bool)) Bool (=> (or (= temp___is_init_2156 true) (<= (- 1) 19)) (in_range7 temp___expr_2160)))
(define-fun dynamic_invariant9 ((temp___expr_2167 Int) (temp___is_init_2163 Bool) (temp___skip_constant_2164 Bool) (temp___do_toplevel_2165 Bool) (temp___do_typ_inv_2166 Bool)) Bool (=> (or (= temp___is_init_2163 true) (<= 0 3)) (in_range8 temp___expr_2167)))
(assert true)
...
(assert true)
(assert (forall ((b (Array Int (Array Int cell)))) (forall ((y Int) (x Int)) (! (= (= (is_empty b y x) true) (and (and (in_range10 x) (in_range4 y)) (= (to_rep (let ((temp___2231 (select b y))) (select temp___2231 x))) 0))) :pattern ((is_empty b y x))))))
...
(declare-const temp___2429 Int)
(declare-const temp___2428 (_ BitVec 32))
(declare-const temp___2427 Int)
(declare-const temp___2425 (Array Int (Array Int cell)))
...
(assert (= del_line1 1))
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (= temp___2429 del_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (= temp___2428 complete_lines1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (= temp___2427 to_line1)))
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (= temp___2425 cur_board)))
...
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (=> (= result3 true) (=> (bvule (bvsub #x000186A0 complete_lines1) #x00000001) (= o (bvsub (bvadd complete_lines1 #x00000001) #x000186A0))))))
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (=> (= result3 true) (=> (not (bvule (bvsub #x000186A0 complete_lines1) #x00000001)) (= o (bvadd complete_lines1 #x00000001))))))
...
(assert (=> (and (<= 1 del_line1) (<= del_line1 20)) (and (and (and (and (forall ((temp___2426 Int)) (=> (and (<= 1 temp___2426) (<= temp___2426 20)) (=> (< del_line2 temp___2426) (= (select cur_board3 temp___2426) (select temp___2425 temp___2426))))) (=> (<= 1 20) (in_range4 to_line3))) (=> (bvule #x00000000 #x0001869F) (in_range2 complete_lines3))) (=> (<= 1 20) (in_range4 del_line2))) (and (<= 1 del_line2) (<= del_line2 20)))))
...
(assert (not (= (t__content complete_lines6) #x00000000)))
