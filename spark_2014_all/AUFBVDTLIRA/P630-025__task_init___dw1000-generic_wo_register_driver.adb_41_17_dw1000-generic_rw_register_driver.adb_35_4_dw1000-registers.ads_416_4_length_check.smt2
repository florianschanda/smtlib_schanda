...
(define-fun target__ref___37__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__drx_tune4h_type__drx_tune4h (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__drx_tune4h_type__drx_tune4h (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_5627 us_t1) (temp___is_init_5623 Bool) (temp___skip_constant_5624 Bool) (temp___do_toplevel_5625 Bool) (temp___do_typ_inv_5626 Bool)) Bool (=> (not (= temp___skip_constant_5624 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5627) (last3 temp___expr_5627)) (and (= (first3 temp___expr_5627) 1) (= (last3 temp___expr_5627) 2)))))
...
(define-fun register_byte_array__ref___87__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_5609 us_t2) (temp___is_init_5605 Bool) (temp___skip_constant_5606 Bool) (temp___do_toplevel_5607 Bool) (temp___do_typ_inv_5608 Bool)) Bool (=> (not (= temp___skip_constant_5606 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5609) (last5 temp___expr_5609)) (and (= (first5 temp___expr_5609) 1) (= (last5 temp___expr_5609) 2)))))
...
(declare-const temp___87491 t1)
(declare-const temp___8750 (Array Int bits_8))
(declare-const temp___87501 t2)
(define-fun temp___87492 () us_t1 (mk___t1 temp___8749 temp___87491))
...
(assert (and (= temp___87492 (register_to_bytes reg)) (dynamic_invariant temp___87492 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___87491)) (to_rep (last2 temp___87491))) (+ (- (to_rep (last2 temp___87491)) (to_rep (first2 temp___87491))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8749 temp___8750))
(assert (= (mk2 (to_rep (first2 temp___87491)) (to_rep (last2 temp___87491))) temp___87501))
(assert (not (= (ite (<= (to_rep (first4 temp___87501)) (to_rep (last4 temp___87501))) (+ (- (to_rep (last4 temp___87501)) (to_rep (first4 temp___87501))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
