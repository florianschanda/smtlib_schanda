...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 16)))) (=> (in_range4 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
...
(define-fun register_byte_array__ref___129__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6420 us_t1) (temp___is_init_6417 Bool) (temp___skip_constant_6418 Bool) (temp___do_toplevel_6419 Bool)) Bool (=> (not (= temp___skip_constant_6418 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6420) (last3 temp___expr_6420)) (and (= (first3 temp___expr_6420) 1) (= (last3 temp___expr_6420) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___56__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_6444 us_t2) (temp___is_init_6441 Bool) (temp___skip_constant_6442 Bool) (temp___do_toplevel_6443 Bool)) Bool (=> (not (= temp___skip_constant_6442 true)) (and (dynamic_property3 1 2 (first5 temp___expr_6444) (last5 temp___expr_6444)) (and (= (first5 temp___expr_6444) 1) (= (last5 temp___expr_6444) 2)))))
...
(declare-const temp___8118 (Array Int bits_8))
(declare-const temp___81181 t2)
(declare-const temp___8119 (Array Int bits_8))
(declare-const temp___81191 t1)
...
(assert (and (= (mk___t2 temp___8118 temp___81181) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8118 temp___81181) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___81181)) (to_rep (last4 temp___81181))) (+ (- (to_rep (last4 temp___81181)) (to_rep (first4 temp___81181))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8118 temp___8119))
(assert (= (mk1 (to_rep (first4 temp___81181)) (to_rep (last4 temp___81181))) temp___81191))
(assert (= (ite (<= (to_rep (first2 temp___81191)) (to_rep (last2 temp___81191))) (+ (- (to_rep (last2 temp___81191)) (to_rep (first2 temp___81191))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8119 temp___81191)))
(assert (= o2 o))
