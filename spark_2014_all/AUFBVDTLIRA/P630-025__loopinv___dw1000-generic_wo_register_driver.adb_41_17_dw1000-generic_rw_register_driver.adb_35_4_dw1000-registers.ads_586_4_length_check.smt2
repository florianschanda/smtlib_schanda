...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__lde_repc_type__lde_repc bits_16)))))
(define-fun us_split_fields_LDE_REPC__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__lde_repc_type__lde_repc a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___86__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___86__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__lde_repc_type__lde_repc (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__lde_repc_type__lde_repc (us_split_fields1 b)))) true false))
...
(declare-datatypes () ((lde_repc_type__ref (mk_lde_repc_type__ref (lde_repc_type__content us_rep)))))
(define-fun lde_repc_type__ref___projection ((a lde_repc_type__ref)) us_rep (lde_repc_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___209__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___147__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___147__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_7616 us_t1) (temp___is_init_7612 Bool) (temp___skip_constant_7613 Bool) (temp___do_toplevel_7614 Bool) (temp___do_typ_inv_7615 Bool)) Bool (=> (not (= temp___skip_constant_7613 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7616) (last3 temp___expr_7616)) (and (= (first3 temp___expr_7616) 1) (= (last3 temp___expr_7616) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___63__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___63__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_7634 us_t2) (temp___is_init_7630 Bool) (temp___skip_constant_7631 Bool) (temp___do_toplevel_7632 Bool) (temp___do_typ_inv_7633 Bool)) Bool (=> (not (= temp___skip_constant_7631 true)) (and (dynamic_property3 1 2 (first5 temp___expr_7634) (last5 temp___expr_7634)) (and (= (first5 temp___expr_7634) 1) (= (last5 temp___expr_7634) 2)))))
...
(declare-const temp___8947 (Array Int bits_8))
(declare-const temp___89471 t2)
(declare-const temp___8948 (Array Int bits_8))
(declare-const temp___89481 t1)
(define-fun temp___89472 () us_t2 (mk___t2 temp___8947 temp___89471))
...
(assert (and (= temp___89472 (register_to_bytes reg)) (dynamic_invariant1 temp___89472 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___89471)) (to_rep (last4 temp___89471))) (+ (- (to_rep (last4 temp___89471)) (to_rep (first4 temp___89471))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8947 temp___8948))
(assert (= (mk1 (to_rep (first4 temp___89471)) (to_rep (last4 temp___89471))) temp___89481))
(assert (not (= (ite (<= (to_rep (first2 temp___89481)) (to_rep (last2 temp___89481))) (+ (- (to_rep (last2 temp___89481)) (to_rep (first2 temp___89481))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
