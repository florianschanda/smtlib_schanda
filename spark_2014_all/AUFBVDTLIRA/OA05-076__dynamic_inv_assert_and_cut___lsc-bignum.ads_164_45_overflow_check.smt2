...
(assert (= o6 (ite (<= o5 (to_rep (last (rt m)))) true false)))
(assert (and (= o (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o1 (+ m_first o)))
(assert (and (= o2 o1) (in_range1 o1)))
(assert (= o7 (ite (<= (to_rep (first (rt m))) o2) true false)))
