...
(assert (= o29 (ite (<= o28 (to_rep (last (rt b)))) true false)))
(assert (and (= o23 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o24 (+ b_first o23)))
(assert (and (= o25 o24) (in_range1 o24)))
(assert (= o30 (ite (<= (to_rep (first (rt b))) o25) true false)))
(assert (= result (ite (= o30 true) o29 false)))
(assert (= result true))
...
(assert (= o21 (ite (<= o20 (to_rep (last (rt c)))) true false)))
(assert (and (= o15 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o16 (+ c_first o15)))
(assert (and (= o17 o16) (in_range1 o16)))
(assert (= o22 (ite (<= (to_rep (first (rt c))) o17) true false)))
(assert (= result1 (ite (= o22 true) o21 false)))
(assert (= result1 true))
