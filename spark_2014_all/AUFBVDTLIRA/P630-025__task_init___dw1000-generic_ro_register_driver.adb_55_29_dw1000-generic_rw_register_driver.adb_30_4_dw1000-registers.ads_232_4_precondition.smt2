...
(define-fun dynamic_invariant ((temp___expr_2827 us_t1) (temp___is_init_2823 Bool) (temp___skip_constant_2824 Bool) (temp___do_toplevel_2825 Bool) (temp___do_typ_inv_2826 Bool)) Bool (=> (not (= temp___skip_constant_2824 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2827) (last3 temp___expr_2827)) (and (= (first3 temp___expr_2827) 1) (= (last3 temp___expr_2827) 4)))))
