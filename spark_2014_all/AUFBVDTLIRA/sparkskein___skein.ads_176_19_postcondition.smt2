...
(assert (forall ((x u16)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert true)
(assert (forall ((x (_ BitVec 16))) (! (= (to_rep (of_rep x)) x) :pattern ((to_rep (of_rep x))))))
(define-fun to_int6 ((x u16)) Int (bv2nat (to_rep x)))
(assert (forall ((x u16)) (! (uint_in_range1 (to_int6 x)) :pattern ((to_int6 x)))))
(declare-sort u32 0)
...
(assert (forall ((x u32)) (! (uint_in_range2 (to_int7 x)) :pattern ((to_int7 x)))))
(declare-sort u64 0)
...
(assert (forall ((x u64)) (! (uint_in_range3 (to_int8 x)) :pattern ((to_int8 x)))))
...
(assert (forall ((x unsigned_64)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert true)
...
(assert (forall ((x unsigned_64)) (! (uint_in_range3 (to_int9 x)) :pattern ((to_int9 x)))))
(declare-sort byte 0)
...
(define-fun bool_eq ((a (Array (_ BitVec 64) byte)) (a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b (Array (_ BitVec 64) byte)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep4 (select a temp___idx_132)) (to_rep4 (select b (bvadd (bvsub b__first a__first) temp___idx_132))))))) true false))
(assert (forall ((a (Array (_ BitVec 64) byte)) (b (Array (_ BitVec 64) byte))) (forall ((a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep4 (select a temp___idx_132)) (to_rep4 (select b (bvadd (bvsub b__first a__first) temp___idx_132)))))))))))
...
(assert (forall ((a (Array (_ BitVec 64) byte)) (b (Array (_ BitVec 64) byte))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (bvult (to_rep4 (select a (bvadd i #x0000000000000001))) (to_rep4 (select b (bvadd j #x0000000000000001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 64) byte)) (b (Array (_ BitVec 64) byte))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (bvugt (to_rep4 (select a (bvadd j #x0000000000000001))) (to_rep4 (select b (bvadd i #x0000000000000001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(declare-sort t 0)
(declare-fun first (t) unsigned_64)
(declare-fun last (t) unsigned_64)
(declare-fun mk ((_ BitVec 64) (_ BitVec 64)) t)
(assert (forall ((f (_ BitVec 64)) (l (_ BitVec 64))) (! (and (= (to_rep3 (first (mk f l))) f) (= (to_rep3 (last (mk f l))) l)) :pattern ((mk f l)))))
...
(define-fun in_range1 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 18446744073709551608))))
...
(assert (forall ((x hash_bit_length)) (! (in_range1 (to_rep5 x)) :pattern ((to_rep5 x)))))
(assert (forall ((x (_ BitVec 64))) (! (=> (in_range1 x) (= (to_rep5 (of_rep5 x)) x)) :pattern ((to_rep5 (of_rep5 x))))))
...
(define-fun in_range2 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 1) x) (bvule x ((_ int2bv 64) 18446744073709551608))))
...
(declare-fun user_eq7 (initialized_hash_bit_length initialized_hash_bit_length) Bool)
...
(define-fun dynamic_invariant ((temp___expr_526 (_ BitVec 64)) (temp___is_init_523 Bool) (temp___skip_constant_524 Bool) (temp___do_toplevel_525 Bool)) Bool (=> (or (= temp___is_init_523 true) (bvule ((_ int2bv 64) 1) ((_ int2bv 64) 18446744073709551608))) (in_range2 temp___expr_526)))
...
(define-fun in_range3 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 64))))
...
(declare-fun user_eq8 (skein_512_block_bytes_count skein_512_block_bytes_count) Bool)
...
(define-fun dynamic_invariant1 ((temp___expr_559 (Array (_ BitVec 64) byte)) (temp___is_init_556 Bool) (temp___skip_constant_557 Bool) (temp___do_toplevel_558 Bool)) Bool (=> (= temp___do_toplevel_558 true) (=> (= temp___is_init_556 true) (bvult (last1 (of_array temp___expr_559 ((_ int2bv 64) 0) ((_ int2bv 64) 63))) ((_ int2bv 64) 18446744073709551615)))))
...
(declare-fun user_eq10 (skein_512_state_bytes_index skein_512_state_bytes_index) Bool)
...
(define-fun dynamic_invariant2 ((temp___expr_615 (_ BitVec 8)) (temp___is_init_612 Bool) (temp___skip_constant_613 Bool) (temp___do_toplevel_614 Bool)) Bool (=> (or (= temp___is_init_612 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 63))) (in_range7 temp___expr_615)))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (and (and (= (to_rep2 (rec__skein__tweak_value__byte_count_lsb (us_split_fields1 a))) (to_rep2 (rec__skein__tweak_value__byte_count_lsb (us_split_fields1 b)))) (= (to_rep1 (rec__skein__tweak_value__byte_count_msb (us_split_fields1 a))) (to_rep1 (rec__skein__tweak_value__byte_count_msb (us_split_fields1 b))))) (= (to_rep (rec__skein__tweak_value__reserved (us_split_fields1 a))) (to_rep (rec__skein__tweak_value__reserved (us_split_fields1 b))))) (= (to_rep6 (rec__skein__tweak_value__tree_level (us_split_fields1 a))) (to_rep6 (rec__skein__tweak_value__tree_level (us_split_fields1 b))))) (= (rec__skein__tweak_value__bit_pad (us_split_fields1 a)) (rec__skein__tweak_value__bit_pad (us_split_fields1 b)))) (= (to_rep7 (rec__skein__tweak_value__field_type (us_split_fields1 a))) (to_rep7 (rec__skein__tweak_value__field_type (us_split_fields1 b))))) (= (rec__skein__tweak_value__first_block (us_split_fields1 a)) (rec__skein__tweak_value__first_block (us_split_fields1 b)))) (= (rec__skein__tweak_value__final_block (us_split_fields1 a)) (rec__skein__tweak_value__final_block (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_652 us_rep2) (temp___is_init_649 Bool) (temp___skip_constant_650 Bool) (temp___do_toplevel_651 Bool)) Bool (=> (= temp___is_init_649 true) (bvult (last1 (of_array (rec__skein__skein_512_context__b (us_split_fields5 temp___expr_652)) ((_ int2bv 64) 0) ((_ int2bv 64) 63))) ((_ int2bv 64) 18446744073709551615))))
(declare-fun hash_bit_len_of (us_rep2) (_ BitVec 64))
(declare-fun hash_bit_len_of__function_guard ((_ BitVec 64) us_rep2) Bool)
(define-fun dynamic_invariant4 ((temp___expr_520 (_ BitVec 64)) (temp___is_init_517 Bool) (temp___skip_constant_518 Bool) (temp___do_toplevel_519 Bool)) Bool (=> (or (= temp___is_init_517 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551608))) (in_range1 temp___expr_520)))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant3 ctx true true true) (dynamic_invariant4 (hash_bit_len_of ctx) true false true)) :pattern ((hash_bit_len_of ctx)))))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant3 ctx true true true) (= (hash_bit_len_of ctx) (to_rep5 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields5 ctx))))))) :pattern ((hash_bit_len_of ctx)))))
(declare-fun byte_count_of (us_rep2) (_ BitVec 64))
(declare-fun byte_count_of__function_guard ((_ BitVec 64) us_rep2) Bool)
(define-fun dynamic_invariant5 ((temp___expr_308 (_ BitVec 64)) (temp___is_init_305 Bool) (temp___skip_constant_306 Bool) (temp___do_toplevel_307 Bool)) Bool true)
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant3 ctx true true true) (dynamic_invariant5 (byte_count_of ctx) true false true)) :pattern ((byte_count_of ctx)))))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant3 ctx true true true) (= (byte_count_of ctx) (to_rep2 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields5 ctx))))))) :pattern ((byte_count_of ctx)))))
...
(assert (forall ((temp___153 (_ BitVec 64))) (forall ((temp___154 (_ BitVec 64))) (= (select (temp___151 temp___153) temp___154) (of_rep2 temp___153)))))
(declare-fun temp___155 ((_ BitVec 8)) (Array (_ BitVec 64) byte))
(assert (forall ((temp___157 (_ BitVec 8))) (forall ((temp___158 (_ BitVec 64))) (= (select (temp___155 temp___157) temp___158) (of_rep4 temp___157)))))
(define-fun dynamic_invariant6 ((temp___expr_1141 (Array (_ BitVec 64) byte)) (temp___is_init_1138 Bool) (temp___skip_constant_1139 Bool) (temp___do_toplevel_1140 Bool)) Bool (=> (= temp___do_toplevel_1140 true) (=> (= temp___is_init_1138 true) (bvult (last1 (of_array temp___expr_1141 ((_ int2bv 64) 0) ((_ int2bv 64) 63))) ((_ int2bv 64) 18446744073709551615)))))
(define-fun dynamic_predicate1 ((temp___1149 (Array (_ BitVec 64) byte))) Bool (bvult (last1 (of_array temp___1149 ((_ int2bv 64) 0) ((_ int2bv 64) 63))) ((_ int2bv 64) 18446744073709551615)))
...
(assert (forall ((s (Array (_ BitVec 64) u64))) (! (dynamic_invariant6 (skein_512_state_words_to_bytes s) true false true) :pattern ((skein_512_state_words_to_bytes s)))))
...
(declare-fun temp___1345 ((_ BitVec 64) (_ BitVec 64) (_ BitVec 64) (_ BitVec 64)) (Array (_ BitVec 64) u64))
(assert (forall ((temp___1347 (_ BitVec 64)) (temp___1348 (_ BitVec 64)) (temp___1349 (_ BitVec 64)) (temp___1350 (_ BitVec 64))) (let ((temp___1346 (temp___1345 temp___1347 temp___1348 temp___1349 temp___1350))) (forall ((temp___1351 (_ BitVec 64))) (ite (= temp___1351 ((_ int2bv 64) 2)) (= (select temp___1346 temp___1351) (of_rep2 temp___1349)) (ite (= temp___1351 ((_ int2bv 64) 1)) (= (select temp___1346 temp___1351) (of_rep2 temp___1348)) (ite (= temp___1351 ((_ int2bv 64) 0)) (= (select temp___1346 temp___1351) (of_rep2 temp___1347)) (= (select temp___1346 temp___1351) (of_rep2 temp___1350)))))))))
(declare-fun temp___1352 ((_ BitVec 64)) (Array (_ BitVec 64) u64))
(assert (forall ((temp___1354 (_ BitVec 64))) (forall ((temp___1355 (_ BitVec 64))) (= (select (temp___1352 temp___1354) temp___1355) (of_rep2 temp___1354)))))
(define-fun dynamic_invariant8 ((temp___expr_290 (_ BitVec 8)) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool)) Bool true)
(define-fun dynamic_invariant9 ((temp___expr_296 (_ BitVec 16)) (temp___is_init_293 Bool) (temp___skip_constant_294 Bool) (temp___do_toplevel_295 Bool)) Bool true)
(define-fun dynamic_invariant10 ((temp___expr_302 (_ BitVec 32)) (temp___is_init_299 Bool) (temp___skip_constant_300 Bool) (temp___do_toplevel_301 Bool)) Bool true)
(define-fun dynamic_invariant11 ((temp___expr_368 us_t) (temp___is_init_365 Bool) (temp___skip_constant_366 Bool) (temp___do_toplevel_367 Bool)) Bool (and (=> (not (= temp___skip_constant_366 true)) (dynamic_property ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551615) (first1 temp___expr_368) (last1 temp___expr_368))) (=> (= temp___do_toplevel_367 true) (=> (= temp___is_init_365 true) (bvult (last1 temp___expr_368) ((_ int2bv 64) 18446744073709551615))))))
(define-fun dynamic_predicate2 ((temp___371 us_t)) Bool (bvult (last1 temp___371) ((_ int2bv 64) 18446744073709551615)))
(define-fun dynamic_invariant12 ((temp___expr_547 (_ BitVec 64)) (temp___is_init_544 Bool) (temp___skip_constant_545 Bool) (temp___do_toplevel_546 Bool)) Bool (=> (or (= temp___is_init_544 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 64))) (in_range3 temp___expr_547)))
(define-fun dynamic_invariant13 ((temp___expr_553 (_ BitVec 64)) (temp___is_init_550 Bool) (temp___skip_constant_551 Bool) (temp___do_toplevel_552 Bool)) Bool (=> (or (= temp___is_init_550 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 63))) (in_range4 temp___expr_553)))
(define-fun dynamic_invariant14 ((temp___expr_575 (_ BitVec 64)) (temp___is_init_572 Bool) (temp___skip_constant_573 Bool) (temp___do_toplevel_574 Bool)) Bool (=> (or (= temp___is_init_572 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 63))) (in_range5 temp___expr_575)))
(assert true)
...
(define-fun dynamic_invariant15 ((temp___expr_609 (_ BitVec 8)) (temp___is_init_606 Bool) (temp___skip_constant_607 Bool) (temp___do_toplevel_608 Bool)) Bool (=> (or (= temp___is_init_606 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 127))) (in_range6 temp___expr_609)))
(declare-const null_tweak_value us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(assert (= null_tweak_value (mk___rep (mk___split_fields (of_rep2 ((_ int2bv 64) 0)) (of_rep1 ((_ int2bv 32) 0)) (of_rep ((_ int2bv 16) 0)) (of_rep6 ((_ int2bv 8) 0)) (of_int 0) (of_rep7 ((_ int2bv 8) 0)) (of_int 0) (of_int 0)))))
(assert (= null_context_header (mk___rep1 (mk___split_fields1 null_tweak_value (of_rep5 ((_ int2bv 64) 0)) (of_rep2 ((_ int2bv 64) 0))))))
(assert (= null_skein_512_context (mk___rep2 (mk___split_fields2 null_context_header (temp___151 ((_ int2bv 64) 0)) (temp___155 ((_ int2bv 8) 0))))))
...
(assert (bvult (to_rep3 (last (mk ((_ int2bv 64) 0) ((_ int2bv 64) 63)))) ((_ int2bv 64) 18446744073709551615)))
(assert (= (mk___rep2 (mk___split_fields2 null_context_header (temp___151 ((_ int2bv 64) 0)) (temp___155 ((_ int2bv 8) 0)))) null_skein_512_context))
(assert (bvult (to_rep3 (last (mk ((_ int2bv 64) 0) ((_ int2bv 64) 63)))) ((_ int2bv 64) 18446744073709551615)))
(assert (in_range2 hashbitlen))
(assert (and (and (and (= result (mk___split_fields__ref2 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields ctx__split_fields ctx__split_fields1 ctx__split_fields2 ctx__split_fields3 ctx__split_fields4 ctx__split_fields5 ctx__split_fields6 ctx__split_fields7)) ctx__split_fields8 ctx__split_fields9)) ctx__split_fields10 ctx__split_fields11))) (= ctx__split_fields12 (us_split_fields5 null_skein_512_context))) (and (and (and (and (and (and (= (to_rep5 o) hashbitlen) (and (= (rec__skein__context_header__tweak_words (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields12))) (mk___rep (mk___split_fields o1 o2 o3 o4 o5 o6 o7 o8))) (and (= o o9) (= (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields12))) o10)))) (and (and (= o11 o1) (and (= o12 o2) (and (= o13 o3) (and (= o14 o4) (and (= o15 o5) (and (= o16 o6) (and (= o17 o7) (= o18 o8)))))))) (and (= o19 o9) (= o20 o10)))) (and (and (and (= o21 o11) (and (= o22 o12) (and (= o23 o13) (and (= o24 o14) (and (= o25 o15) (and (= o26 o16) (and (= o27 o17) (= o28 o18)))))))) (and (= o29 o19) (= o30 o20))) (and (= (rec__skein__skein_512_context__x ctx__split_fields12) o31) (= (rec__skein__skein_512_context__b ctx__split_fields12) o32)))) (and (and (and (= temp___1338 o21) (and (= temp___13381 o22) (and (= temp___13382 o23) (and (= temp___13383 o24) (and (= temp___13384 o25) (and (= temp___13385 o26) (and (= temp___13386 o27) (= temp___13387 o28)))))))) (and (= temp___13388 o29) (= temp___13389 o30))) (and (= temp___133810 o31) (= temp___133811 o32)))) (and (= result1 (mk___split_fields__ref2 ctx__split_fields12)) (= ctx__split_fields13 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields temp___1338 temp___13381 temp___13382 temp___13383 temp___13384 temp___13385 temp___13386 temp___13387)) temp___13388 temp___13389)) temp___133810 temp___133811)))) (and (in_range7 c222b) (and (and (and (and (and (and (and (and (= (to_rep7 o33) ((_ int2bv 8) 4)) (and (= (to_rep6 o34) ((_ int2bv 8) 0)) (and (= (to_rep o35) ((_ int2bv 16) 0)) (and (= (to_rep1 o36) ((_ int2bv 32) 0)) (and (= (to_rep2 o37) ((_ int2bv 64) 0)) (= o38 (mk___split_fields o37 o36 o35 o34 (of_int 0) o33 (of_int 1) (of_int 1)))))))) (= o39 (mk___rep o38))) (= o40 (mk___split_fields1 o39 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields13))) (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields13)))))) (= o41 (mk___rep1 o40))) (= o42 (mk___split_fields2 o41 (rec__skein__skein_512_context__x ctx__split_fields13) (rec__skein__skein_512_context__b ctx__split_fields13)))) (= temp___1341 (mk___rep2 o42))) (and (= result2 (mk___split_fields__ref2 ctx__split_fields13)) (= ctx__split_fields14 (us_split_fields5 temp___1341)))) (and (and (and (and (and (and (= (to_rep2 o43) ((_ int2bv 64) 0)) (= o44 (mk___split_fields1 (rec__skein__context_header__tweak_words (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields14))) (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields14))) o43))) (= o45 (mk___rep1 o44))) (= o46 (mk___split_fields2 o45 (rec__skein__skein_512_context__x ctx__split_fields14) (rec__skein__skein_512_context__b ctx__split_fields14)))) (= temp___1344 (mk___rep2 o46))) (and (= result3 (mk___split_fields__ref2 ctx__split_fields14)) (= ctx__split_fields15 (us_split_fields5 temp___1344)))) (and (and (and (= o47 (to_littleendian ((_ int2bv 64) 0))) (and (= o48 (to_littleendian hashbitlen)) (and (= o49 (to_littleendian ((_ int2bv 64) 5154883667))) (= o50 (temp___1345 o49 o48 o47 ((_ int2bv 64) 0)))))) (and (= result4 (mk_map__ref1 cfg)) (= cfg1 o50))) (and (and (= result5 (mk___split_fields__ref2 ctx__split_fields15)) (= ctx__split_fields16 (mk___split_fields2 (rec__skein__skein_512_context__h ctx__split_fields15) (temp___1352 ((_ int2bv 64) 0)) (rec__skein__skein_512_context__b ctx__split_fields15)))) (and (and (and (and (= o51 (skein_512_state_words_to_bytes cfg1)) (bvult (to_rep3 (last (mk ((_ int2bv 64) 0) ((_ int2bv 64) 63)))) ((_ int2bv 64) 18446744073709551615))) (= o52 (mk___t o51 (mk ((_ int2bv 64) 0) ((_ int2bv 64) 63))))) (and (and (and (and (in_range2 (to_rep5 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields17))))) (= (to_rep5 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields17)))) (to_rep5 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields16)))))) (in_range3 (to_rep2 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields17)))))) (= (to_rep2 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields17)))) (to_rep2 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields16)))))) (bvult (to_rep3 (last (mk ((_ int2bv 64) 0) ((_ int2bv 64) 63)))) ((_ int2bv 64) 18446744073709551615)))) (and (in_range7 c231b) (and (and (and (and (and (and (and (and (= (to_rep7 o53) ((_ int2bv 8) 48)) (and (= (to_rep6 o54) ((_ int2bv 8) 0)) (and (= (to_rep o55) ((_ int2bv 16) 0)) (and (= (to_rep1 o56) ((_ int2bv 32) 0)) (and (= (to_rep2 o57) ((_ int2bv 64) 0)) (= o58 (mk___split_fields o57 o56 o55 o54 (of_int 0) o53 (of_int 1) (of_int 0)))))))) (= o59 (mk___rep o58))) (= o60 (mk___split_fields1 o59 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields17))) (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields17)))))) (= o61 (mk___rep1 o60))) (= o62 (mk___split_fields2 o61 (rec__skein__skein_512_context__x ctx__split_fields17) (rec__skein__skein_512_context__b ctx__split_fields17)))) (= temp___1360 (mk___rep2 o62))) (and (= result6 (mk___split_fields__ref2 ctx__split_fields17)) (= ctx__split_fields18 (us_split_fields5 temp___1360)))) (and (and (and (and (and (= (to_rep2 o63) ((_ int2bv 64) 0)) (= o64 (mk___split_fields1 (rec__skein__context_header__tweak_words (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields18))) (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields18))) o63))) (= o65 (mk___rep1 o64))) (= o66 (mk___split_fields2 o65 (rec__skein__skein_512_context__x ctx__split_fields18) (rec__skein__skein_512_context__b ctx__split_fields18)))) (= temp___1363 (mk___rep2 o66))) (and (= result7 (mk___split_fields__ref2 ctx__split_fields18)) (= ctx__split_fields19 (us_split_fields5 temp___1363)))))))))))))) (and (and (= cfg2 (mk_map__ref1 cfg1)) (= ctx__split_fields20 (mk___split_fields__ref2 ctx__split_fields19))) (and (= cfg3 cfg1) (= ctx__split_fields21 ctx__split_fields19)))))
(assert (not (in_range2 (hash_bit_len_of (mk___rep2 (us_split_fields__content2 ctx__split_fields20))))))
(check-sat)
(exit)
