...
(assert (forall ((x u16)) (! (uint_in_range1 (to_int5 x)) :pattern ((to_int5 x)))))
(declare-sort u32 0)
...
(assert (forall ((x u32)) (! (uint_in_range2 (to_int6 x)) :pattern ((to_int6 x)))))
(declare-sort u64 0)
...
(assert (forall ((x u64)) (! (uint_in_range3 (to_int7 x)) :pattern ((to_int7 x)))))
...
(define-fun to_int8 ((x unsigned_64)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x unsigned_64)) (! (uint_in_range3 (to_int8 x)) :pattern ((to_int8 x)))))
(declare-sort byte 0)
...
(define-fun to_int9 ((x byte)) Int (bv2nat (to_rep4 x)))
(assert (forall ((x byte)) (! (uint_in_range (to_int9 x)) :pattern ((to_int9 x)))))
...
(define-fun in_range2 ((x (_ BitVec 64))) Bool (and (bvule #x0000000000000001 x) (bvule x #xFFFFFFFFFFFFFFF8)))
...
(define-fun dynamic_invariant ((temp___expr_595 (_ BitVec 64)) (temp___is_init_591 Bool) (temp___skip_constant_592 Bool) (temp___do_toplevel_593 Bool) (temp___do_typ_inv_594 Bool)) Bool (=> (or (= temp___is_init_591 true) (bvule #x0000000000000001 #xFFFFFFFFFFFFFFF8)) (in_range2 temp___expr_595)))
...
(define-fun in_range3 ((x (_ BitVec 64))) Bool (and (bvule #x0000000000000000 x) (bvule x #x0000000000000040)))
...
(define-fun dynamic_invariant2 ((temp___expr_695 (_ BitVec 8)) (temp___is_init_691 Bool) (temp___skip_constant_692 Bool) (temp___do_toplevel_693 Bool) (temp___do_typ_inv_694 Bool)) Bool (=> (or (= temp___is_init_691 true) (bvule #x00 #x3F)) (in_range7 temp___expr_695)))
...
(define-fun dynamic_invariant3 ((temp___expr_735 us_rep2) (temp___is_init_731 Bool) (temp___skip_constant_732 Bool) (temp___do_toplevel_733 Bool) (temp___do_typ_inv_734 Bool)) Bool (=> (= temp___is_init_731 true) (bvult (last1 (of_array (rec__skein__skein_512_context__b (us_split_fields5 temp___expr_735)) #x0000000000000000 #x000000000000003F)) #xFFFFFFFFFFFFFFFF)))
(declare-fun hash_bit_len_of (us_rep2) (_ BitVec 64))
(declare-fun hash_bit_len_of__function_guard ((_ BitVec 64) us_rep2) Bool)
(define-fun dynamic_invariant4 ((temp___expr_588 (_ BitVec 64)) (temp___is_init_584 Bool) (temp___skip_constant_585 Bool) (temp___do_toplevel_586 Bool) (temp___do_typ_inv_587 Bool)) Bool (=> (or (= temp___is_init_584 true) (bvule #x0000000000000000 #xFFFFFFFFFFFFFFF8)) (in_range1 temp___expr_588)))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant3 ctx true true true true) (dynamic_invariant4 (hash_bit_len_of ctx) true false true true)) :pattern ((hash_bit_len_of ctx)))))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant3 ctx true true true true) (= (hash_bit_len_of ctx) (to_rep5 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields5 ctx))))))) :pattern ((hash_bit_len_of ctx)))))
(declare-fun byte_count_of (us_rep2) (_ BitVec 64))
(declare-fun byte_count_of__function_guard ((_ BitVec 64) us_rep2) Bool)
(define-fun dynamic_invariant5 ((temp___expr_352 (_ BitVec 64)) (temp___is_init_348 Bool) (temp___skip_constant_349 Bool) (temp___do_toplevel_350 Bool) (temp___do_typ_inv_351 Bool)) Bool true)
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant3 ctx true true true true) (dynamic_invariant5 (byte_count_of ctx) true false true true)) :pattern ((byte_count_of ctx)))))
(assert (forall ((ctx us_rep2)) (! (=> (dynamic_invariant3 ctx true true true true) (= (byte_count_of ctx) (to_rep2 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h (us_split_fields5 ctx))))))) :pattern ((byte_count_of ctx)))))
...
(declare-fun temp___173 ((_ BitVec 64)) (Array (_ BitVec 64) u64))
(declare-fun temp___177 ((_ BitVec 8)) (Array (_ BitVec 64) byte))
(define-fun dynamic_invariant6 ((temp___expr_1283 (Array (_ BitVec 64) byte)) (temp___is_init_1279 Bool) (temp___skip_constant_1280 Bool) (temp___do_toplevel_1281 Bool) (temp___do_typ_inv_1282 Bool)) Bool (=> (= temp___do_toplevel_1281 true) (=> (= temp___is_init_1279 true) (bvult (last1 (of_array temp___expr_1283 #x0000000000000000 #x000000000000003F)) #xFFFFFFFFFFFFFFFF))))
(define-fun dynamic_predicate1 ((temp___1291 (Array (_ BitVec 64) byte))) Bool (bvult (last1 (of_array temp___1291 #x0000000000000000 #x000000000000003F)) #xFFFFFFFFFFFFFFFF))
...
(assert (forall ((s (Array (_ BitVec 64) u64))) (! (dynamic_invariant6 (skein_512_state_words_to_bytes s) true false true true) :pattern ((skein_512_state_words_to_bytes s)))))
...
(declare-fun temp___1504 ((_ BitVec 64) (_ BitVec 64) (_ BitVec 64) (_ BitVec 64)) (Array (_ BitVec 64) u64))
(declare-fun temp___1511 ((_ BitVec 64)) (Array (_ BitVec 64) u64))
(assert (forall ((temp___1506 (_ BitVec 64)) (temp___1507 (_ BitVec 64)) (temp___1508 (_ BitVec 64)) (temp___1509 (_ BitVec 64))) (let ((temp___1505 (temp___1504 temp___1506 temp___1507 temp___1508 temp___1509))) (=> (and (and (and (dynamic_invariant5 temp___1506 true true true true) (dynamic_invariant5 temp___1507 true true true true)) (dynamic_invariant5 temp___1508 true true true true)) (dynamic_invariant5 temp___1509 true true true true)) (forall ((temp___1510 (_ BitVec 64))) (ite (= temp___1510 #x0000000000000002) (= (to_rep2 (select temp___1505 temp___1510)) temp___1508) (ite (= temp___1510 #x0000000000000001) (= (to_rep2 (select temp___1505 temp___1510)) temp___1507) (ite (= temp___1510 #x0000000000000000) (= (to_rep2 (select temp___1505 temp___1510)) temp___1506) (= (to_rep2 (select temp___1505 temp___1510)) temp___1509)))))))))
(assert (forall ((temp___1513 (_ BitVec 64))) (=> (dynamic_invariant5 temp___1513 true true true true) (forall ((temp___1514 (_ BitVec 64))) (= (to_rep2 (select (temp___1511 temp___1513) temp___1514)) temp___1513)))))
...
(define-fun dynamic_invariant12 ((temp___expr_619 (_ BitVec 64)) (temp___is_init_615 Bool) (temp___skip_constant_616 Bool) (temp___do_toplevel_617 Bool) (temp___do_typ_inv_618 Bool)) Bool (=> (or (= temp___is_init_615 true) (bvule #x0000000000000000 #x0000000000000040)) (in_range3 temp___expr_619)))
...
(define-fun dynamic_invariant15 ((temp___expr_688 (_ BitVec 8)) (temp___is_init_684 Bool) (temp___skip_constant_685 Bool) (temp___do_toplevel_686 Bool) (temp___do_typ_inv_687 Bool)) Bool (=> (or (= temp___is_init_684 true) (bvule #x00 #x7F)) (in_range6 temp___expr_688)))
(declare-const null_tweak_value us_rep)
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(assert (= null_tweak_value (mk___rep (mk___split_fields (of_rep2 #x0000000000000000) (of_rep1 #x00000000) (of_rep #x0000) (of_rep6 #x00) (distinct 0 0) (of_rep7 #x00) (distinct 0 0) (distinct 0 0)))))
(assert (= null_context_header (mk___rep1 (mk___split_fields1 null_tweak_value (of_rep5 #x0000000000000000) (of_rep2 #x0000000000000000)))))
(assert (= null_skein_512_context (mk___rep2 (mk___split_fields2 null_context_header (temp___173 #x0000000000000000) (temp___177 #x00)))))
(assert (forall ((temp___175 (_ BitVec 64))) (=> (dynamic_invariant5 temp___175 true true true true) (forall ((temp___176 (_ BitVec 64))) (= (to_rep2 (select (temp___173 temp___175) temp___176)) temp___175)))))
(assert (forall ((temp___179 (_ BitVec 8))) (=> (dynamic_invariant8 temp___179 true true true true) (forall ((temp___180 (_ BitVec 64))) (= (to_rep4 (select (temp___177 temp___179) temp___180)) temp___179)))))
...
(declare-const temp___1497 u64)
(declare-const temp___14971 u32)
(declare-const temp___14972 u16)
(declare-const temp___14973 u7)
(declare-const temp___14974 Bool)
(declare-const temp___14975 u6)
(declare-const temp___14976 Bool)
(declare-const temp___14977 Bool)
(declare-const temp___14978 hash_bit_length)
(declare-const temp___14979 u64)
(declare-const temp___149710 (Array (_ BitVec 64) u64))
(declare-const temp___149711 (Array (_ BitVec 64) byte))
...
(declare-const temp___1519 us_rep2)
...
(assert (bvult (to_rep3 (last (mk #x0000000000000000 #x000000000000003F))) #xFFFFFFFFFFFFFFFF))
(assert (= (mk___rep2 (mk___split_fields2 null_context_header (temp___173 #x0000000000000000) (temp___177 #x00))) null_skein_512_context))
(assert (bvult (to_rep3 (last (mk #x0000000000000000 #x000000000000003F))) #xFFFFFFFFFFFFFFFF))
...
(assert (= temp___1497 o21))
(assert (= temp___14971 o22))
(assert (= temp___14972 o23))
(assert (= temp___14973 o24))
(assert (= temp___14974 o25))
(assert (= temp___14975 o26))
(assert (= temp___14976 o27))
(assert (= temp___14977 o28))
(assert (= temp___14978 o29))
(assert (= temp___14979 o30))
(assert (= temp___149710 o31))
(assert (= temp___149711 o32))
(assert (= result1 (mk___split_fields__ref2 ctx__split_fields12)))
(assert (= ctx__split_fields13 (mk___split_fields2 (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields temp___1497 temp___14971 temp___14972 temp___14973 temp___14974 temp___14975 temp___14976 temp___14977)) temp___14978 temp___14979)) temp___149710 temp___149711)))
(assert (in_range7 c222b))
(assert (= (to_rep7 o33) #x04))
(assert (= (to_rep6 o34) #x00))
(assert (= (to_rep o35) #x0000))
(assert (= (to_rep1 o36) #x00000000))
(assert (= (to_rep2 o37) #x0000000000000000))
...
(assert (= temp___1500 (mk___rep2 o42)))
(assert (= result2 (mk___split_fields__ref2 ctx__split_fields13)))
(assert (= ctx__split_fields14 (us_split_fields5 temp___1500)))
(assert (= (to_rep2 o43) #x0000000000000000))
...
(assert (= temp___1503 (mk___rep2 o46)))
(assert (= result3 (mk___split_fields__ref2 ctx__split_fields14)))
(assert (= ctx__split_fields15 (us_split_fields5 temp___1503)))
...
(assert (= o50 (temp___1504 o49 o48 o47 #x0000000000000000)))
(assert (= result4 (mk_map__ref1 cfg)))
(assert (= cfg1 o50))
(assert (= result5 (mk___split_fields__ref2 ctx__split_fields15)))
(assert (= ctx__split_fields16 (mk___split_fields2 (rec__skein__skein_512_context__h ctx__split_fields15) (temp___1511 #x0000000000000000) (rec__skein__skein_512_context__b ctx__split_fields15))))
(assert (and (= o51 (skein_512_state_words_to_bytes cfg1)) (bvult (to_rep3 (last (mk #x0000000000000000 #x000000000000003F))) #xFFFFFFFFFFFFFFFF)))
(assert (= o52 (mk___t o51 (mk #x0000000000000000 #x000000000000003F))))
(assert (and (and (and (and (in_range2 (to_rep5 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields17))))) (= (to_rep5 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields17)))) (to_rep5 (rec__skein__context_header__hash_bit_len (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields16)))))) (in_range3 (to_rep2 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields17)))))) (= (to_rep2 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields17)))) (to_rep2 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h ctx__split_fields16)))))) (bvult (to_rep3 (last (mk #x0000000000000000 #x000000000000003F))) #xFFFFFFFFFFFFFFFF)))
(assert (in_range7 c231b))
(assert (= (to_rep7 o53) #x30))
(assert (= (to_rep6 o54) #x00))
(assert (= (to_rep o55) #x0000))
(assert (= (to_rep1 o56) #x00000000))
(assert (= (to_rep2 o57) #x0000000000000000))
...
(assert (= temp___1519 (mk___rep2 o62)))
(assert (= result6 (mk___split_fields__ref2 ctx__split_fields17)))
(assert (= ctx__split_fields18 (us_split_fields5 temp___1519)))
(assert (= (to_rep2 o63) #x0000000000000000))
...
(assert (= temp___1522 (mk___rep2 o66)))
(assert (= result7 (mk___split_fields__ref2 ctx__split_fields18)))
(assert (= ctx__split_fields19 (us_split_fields5 temp___1522)))
