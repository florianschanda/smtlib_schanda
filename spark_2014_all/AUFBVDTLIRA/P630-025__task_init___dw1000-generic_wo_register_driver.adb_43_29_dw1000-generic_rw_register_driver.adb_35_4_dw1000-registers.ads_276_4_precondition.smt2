...
(define-fun in_range2 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 15))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 16)))) (=> (in_range2 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep2 (rec__dw1000__register_types__rx_sniff_type__sniff_ont (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_sniff_type__sniff_ont (us_split_fields1 b)))) (= (to_rep1 (rec__dw1000__register_types__rx_sniff_type__sniff_offt (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__rx_sniff_type__sniff_offt (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__rx_sniff_type__reserved_1 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_sniff_type__reserved_1 (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__rx_sniff_type__reserved_2 (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__rx_sniff_type__reserved_2 (us_split_fields1 b))))) true false))
...
(define-fun register_byte_array__ref___34__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3146 us_t1) (temp___is_init_3143 Bool) (temp___skip_constant_3144 Bool) (temp___do_toplevel_3145 Bool)) Bool (=> (not (= temp___skip_constant_3144 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3146) (last3 temp___expr_3146)) (and (= (first3 temp___expr_3146) 1) (= (last3 temp___expr_3146) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___13__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_3165 us_t2) (temp___is_init_3162 Bool) (temp___skip_constant_3163 Bool) (temp___do_toplevel_3164 Bool)) Bool (=> (not (= temp___skip_constant_3163 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3165) (last5 temp___expr_3165)) (and (= (first5 temp___expr_3165) 1) (= (last5 temp___expr_3165) 4)))))
...
(declare-const temp___7793 (Array Int bits_8))
(declare-const temp___77931 t2)
(declare-const temp___7794 (Array Int bits_8))
(declare-const temp___77941 t1)
...
(assert (and (= (mk___t2 temp___7793 temp___77931) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7793 temp___77931) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___77931)) (to_rep (last4 temp___77931))) (+ (- (to_rep (last4 temp___77931)) (to_rep (first4 temp___77931))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7793 temp___7794))
(assert (= (mk1 (to_rep (first4 temp___77931)) (to_rep (last4 temp___77931))) temp___77941))
(assert (= (ite (<= (to_rep (first2 temp___77941)) (to_rep (last2 temp___77941))) (+ (- (to_rep (last2 temp___77941)) (to_rep (first2 temp___77941))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___7794 temp___77941)))
(assert (= o2 o))
