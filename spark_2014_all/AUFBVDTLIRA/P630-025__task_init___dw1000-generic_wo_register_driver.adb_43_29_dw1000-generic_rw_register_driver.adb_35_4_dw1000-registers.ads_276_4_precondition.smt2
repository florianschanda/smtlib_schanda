...
(define-fun dynamic_invariant ((temp___expr_3467 us_t1) (temp___is_init_3463 Bool) (temp___skip_constant_3464 Bool) (temp___do_toplevel_3465 Bool) (temp___do_typ_inv_3466 Bool)) Bool (=> (not (= temp___skip_constant_3464 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3467) (last3 temp___expr_3467)) (and (= (first3 temp___expr_3467) 1) (= (last3 temp___expr_3467) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_3488 us_t2) (temp___is_init_3484 Bool) (temp___skip_constant_3485 Bool) (temp___do_toplevel_3486 Bool) (temp___do_typ_inv_3487 Bool)) Bool (=> (not (= temp___skip_constant_3485 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3488) (last5 temp___expr_3488)) (and (= (first5 temp___expr_3488) 1) (= (last5 temp___expr_3488) 4)))))
...
(declare-const temp___85651 t2)
(declare-const temp___8566 (Array Int bits_8))
(declare-const temp___85661 t1)
...
(define-fun temp___85652 () us_t2 (mk___t2 temp___8565 temp___85651))
...
(assert (and (= temp___85652 (register_to_bytes reg)) (dynamic_invariant1 temp___85652 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___85651)) (to_rep (last4 temp___85651))) (+ (- (to_rep (last4 temp___85651)) (to_rep (first4 temp___85651))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8565 temp___8566))
(assert (= (mk1 (to_rep (first4 temp___85651)) (to_rep (last4 temp___85651))) temp___85661))
(assert (= (ite (<= (to_rep (first2 temp___85661)) (to_rep (last2 temp___85661))) (+ (- (to_rep (last2 temp___85661)) (to_rep (first2 temp___85661))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8566 temp___85661)))
(assert (= o2 o))
