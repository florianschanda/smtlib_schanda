...
(define-fun tregister_byte_arrayP1__ref___34__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun target__ref___13__projection ((a target__ref)) us_t1 (target__content a))
...
(assert (forall ((x bits_4)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x bits_4)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x10))) (=> (in_range2 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun to_int4 ((x bits_4)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x bits_4)) (! (in_range_int (to_int4 x)) :pattern ((to_int4 x)))))
...
(declare-fun to_rep3 (bits_16) (_ BitVec 16))
(declare-fun of_rep3 ((_ BitVec 16)) bits_16)
(assert (forall ((x bits_16)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert true)
(assert (forall ((x (_ BitVec 16))) (! (= (to_rep3 (of_rep3 x)) x) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int5 ((x bits_16)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x bits_16)) (! (uint_in_range1 (to_int5 x)) :pattern ((to_int5 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__rx_sniff_type__sniff_ont bits_4) (rec__dw1000__register_types__rx_sniff_type__sniff_offt bits_8) (rec__dw1000__register_types__rx_sniff_type__reserved_1 bits_4) (rec__dw1000__register_types__rx_sniff_type__reserved_2 bits_16)))))
(define-fun us_split_fields_SNIFF_ONT__projection ((a us_split_fields)) bits_4 (rec__dw1000__register_types__rx_sniff_type__sniff_ont a))
(define-fun us_split_fields_SNIFF_OFFT__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__rx_sniff_type__sniff_offt a))
(define-fun us_split_fields_Reserved_1__6__projection ((a us_split_fields)) bits_4 (rec__dw1000__register_types__rx_sniff_type__reserved_1 a))
(define-fun us_split_fields_Reserved_2__6__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__rx_sniff_type__reserved_2 a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep2 (rec__dw1000__register_types__rx_sniff_type__sniff_ont (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_sniff_type__sniff_ont (us_split_fields1 b)))) (= (to_rep1 (rec__dw1000__register_types__rx_sniff_type__sniff_offt (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__rx_sniff_type__sniff_offt (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__rx_sniff_type__reserved_1 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_sniff_type__reserved_1 (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__rx_sniff_type__reserved_2 (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__rx_sniff_type__reserved_2 (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__rx_sniff_type__sniff_ont__first__bit Int)
(declare-const dw1000__register_types__rx_sniff_type__sniff_ont__last__bit Int)
(declare-const dw1000__register_types__rx_sniff_type__sniff_ont__position Int)
(assert (<= 0 dw1000__register_types__rx_sniff_type__sniff_ont__first__bit))
(assert (< dw1000__register_types__rx_sniff_type__sniff_ont__first__bit dw1000__register_types__rx_sniff_type__sniff_ont__last__bit))
(assert (<= 0 dw1000__register_types__rx_sniff_type__sniff_ont__position))
(declare-const dw1000__register_types__rx_sniff_type__sniff_offt__first__bit Int)
(declare-const dw1000__register_types__rx_sniff_type__sniff_offt__last__bit Int)
(declare-const dw1000__register_types__rx_sniff_type__sniff_offt__position Int)
(assert (<= 0 dw1000__register_types__rx_sniff_type__sniff_offt__first__bit))
(assert (< dw1000__register_types__rx_sniff_type__sniff_offt__first__bit dw1000__register_types__rx_sniff_type__sniff_offt__last__bit))
(assert (<= 0 dw1000__register_types__rx_sniff_type__sniff_offt__position))
(declare-const dw1000__register_types__rx_sniff_type__reserved_1__first__bit Int)
(declare-const dw1000__register_types__rx_sniff_type__reserved_1__last__bit Int)
(declare-const dw1000__register_types__rx_sniff_type__reserved_1__position Int)
(assert (<= 0 dw1000__register_types__rx_sniff_type__reserved_1__first__bit))
(assert (< dw1000__register_types__rx_sniff_type__reserved_1__first__bit dw1000__register_types__rx_sniff_type__reserved_1__last__bit))
(assert (<= 0 dw1000__register_types__rx_sniff_type__reserved_1__position))
(declare-const dw1000__register_types__rx_sniff_type__reserved_2__first__bit Int)
(declare-const dw1000__register_types__rx_sniff_type__reserved_2__last__bit Int)
(declare-const dw1000__register_types__rx_sniff_type__reserved_2__position Int)
(assert (<= 0 dw1000__register_types__rx_sniff_type__reserved_2__first__bit))
(assert (< dw1000__register_types__rx_sniff_type__reserved_2__first__bit dw1000__register_types__rx_sniff_type__reserved_2__last__bit))
(assert (<= 0 dw1000__register_types__rx_sniff_type__reserved_2__position))
(declare-fun user_eq8 (us_rep us_rep) Bool)
(declare-const dummy8 us_rep)
(declare-datatypes () ((rx_sniff_type__ref (mk_rx_sniff_type__ref (rx_sniff_type__content us_rep)))))
(define-fun rx_sniff_type__ref___projection ((a rx_sniff_type__ref)) us_rep (rx_sniff_type__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___13__projection ((a source__ref)) us_rep (source__content a))
(declare-fun register_to_bytes (us_rep) us_t1)
(declare-fun register_to_bytes__function_guard (us_t1 us_rep) Bool)
(define-fun dynamic_invariant ((temp___expr_3488 us_t1) (temp___is_init_3484 Bool) (temp___skip_constant_3485 Bool) (temp___do_toplevel_3486 Bool) (temp___do_typ_inv_3487 Bool)) Bool (=> (not (= temp___skip_constant_3485 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3488) (last3 temp___expr_3488)) (and (= (first3 temp___expr_3488) 1) (= (last3 temp___expr_3488) 4)))))
...
(define-fun register_type__ref___46__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun register_byte_array__ref___34__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_3467 us_t2) (temp___is_init_3463 Bool) (temp___skip_constant_3464 Bool) (temp___do_toplevel_3465 Bool) (temp___do_typ_inv_3466 Bool)) Bool (=> (not (= temp___skip_constant_3464 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3467) (last5 temp___expr_3467)) (and (= (first5 temp___expr_3467) 1) (= (last5 temp___expr_3467) 4)))))
...
(declare-const temp___8565 (Array Int bits_8))
(declare-const temp___85651 t1)
(declare-const temp___8566 (Array Int bits_8))
(declare-const temp___85661 t2)
...
(define-fun temp___85652 () us_t1 (mk___t1 temp___8565 temp___85651))
...
(assert (and (= temp___85652 (register_to_bytes reg)) (dynamic_invariant temp___85652 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___85651)) (to_rep (last2 temp___85651))) (+ (- (to_rep (last2 temp___85651)) (to_rep (first2 temp___85651))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8565 temp___8566))
(assert (= (mk2 (to_rep (first2 temp___85651)) (to_rep (last2 temp___85651))) temp___85661))
(assert (= (ite (<= (to_rep (first4 temp___85661)) (to_rep (last4 temp___85661))) (+ (- (to_rep (last4 temp___85661)) (to_rep (first4 temp___85661))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8566 temp___85661)))
(assert (= o2 o))
