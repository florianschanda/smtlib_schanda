...
(define-fun register_byte_array__ref___139__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6715 us_t1) (temp___is_init_6712 Bool) (temp___skip_constant_6713 Bool) (temp___do_toplevel_6714 Bool)) Bool (=> (not (= temp___skip_constant_6713 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6715) (last3 temp___expr_6715)) (and (= (first3 temp___expr_6715) 1) (= (last3 temp___expr_6715) 1)))))
(declare-sort t2 0)
...
(define-fun target__ref___60__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_6732 us_t2) (temp___is_init_6729 Bool) (temp___skip_constant_6730 Bool) (temp___do_toplevel_6731 Bool)) Bool (=> (not (= temp___skip_constant_6730 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6732) (last5 temp___expr_6732)) (and (= (first5 temp___expr_6732) 1) (= (last5 temp___expr_6732) 1)))))
...
(assert (and (= temp___81502 (register_to_bytes reg)) (dynamic_invariant1 temp___81502 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___81501)) (to_rep (last4 temp___81501))) (+ (- (to_rep (last4 temp___81501)) (to_rep (first4 temp___81501))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8150 temp___8151))
(assert (= (mk1 (to_rep (first4 temp___81501)) (to_rep (last4 temp___81501))) temp___81511))
(assert (not (= (ite (<= (to_rep (first2 temp___81511)) (to_rep (last2 temp___81511))) (+ (- (to_rep (last2 temp___81511)) (to_rep (first2 temp___81511))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
