...
(assert (forall ((temp___1181 (_ BitVec 8))) (forall ((temp___1182 Int) (temp___1183 Int)) (let ((temp___1180 (temp___1179 temp___1181 temp___1182 temp___1183))) (and (=> (dynamic_property6 1 65536 temp___1182 temp___1183) (and (= (first5 temp___1180) temp___1182) (= (last5 temp___1180) temp___1183))) (forall ((temp___1184 Int)) (= (select (to_array2 temp___1180) temp___1184) (of_rep1 temp___1181))))))))
(define-fun dynamic_invariant5 ((temp___expr_744 us_t1) (temp___is_init_741 Bool) (temp___skip_constant_742 Bool) (temp___do_toplevel_743 Bool)) Bool (=> (not (= temp___skip_constant_742 true)) (and (dynamic_property3 1 r116b (first3 temp___expr_744) (last3 temp___expr_744)) (and (= (first3 temp___expr_744) 1) (= (last3 temp___expr_744) r116b)))))
...
(declare-const temp___1205 (_ BitVec 8))
(declare-const temp___1202 digit_index_type)
(declare-const temp___12021 (Array Int octet))
(declare-const temp___12022 t)
(declare-const temp___1201 (_ BitVec 8))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1179 ((_ int2bv 8) 0) 1 r116b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1179 ((_ int2bv 8) 0) 1 r116b)))) r116b))
(assert (= (mk___t2 temp___1186 temp___11861) (temp___1179 ((_ int2bv 8) 0) 1 r116b)))
(assert (= (ite (<= (to_rep2 (first4 temp___11861)) (to_rep2 (last4 temp___11861))) (+ (- (to_rep2 (last4 temp___11861)) (to_rep2 (first4 temp___11861))) 1) 0) (ite (<= 1 r116b) (+ (- r116b 1) 1) 0)))
(assert (= temp___1186 temp___1187))
(assert (= (mk1 (to_rep2 (first4 temp___11861)) (to_rep2 (last4 temp___11861))) temp___11871))
(assert (= (ite (<= (to_rep2 (first2 temp___11871)) (to_rep2 (last2 temp___11871))) (+ (- (to_rep2 (last2 temp___11871)) (to_rep2 (first2 temp___11871))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1189 temp___11891) (mk___t1 temp___1187 temp___11871)))
(assert (= temp___1189 o))
(assert (= (mk (to_rep2 (first2 temp___11891)) (to_rep2 (last2 temp___11891))) o1))
(assert (= o2 o))
(assert (= o3 o1))
...
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___11911 temp___11912))))
(assert (= result____split_discrs (mk___split_discrs temp___1191)))
...
(assert (and (and (dynamic_invariant2 (mk___rep result____split_discrs result____split_fields3) false true true) (forall ((temp___1204 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1204) (<= temp___1204 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1204) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1204) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1204)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
