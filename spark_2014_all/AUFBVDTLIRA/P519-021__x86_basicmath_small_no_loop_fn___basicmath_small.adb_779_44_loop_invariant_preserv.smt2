...
(assert (= xmm032 o186))
(assert (= (writereg32post (let ((subject rdi)) rdi38) ((_ int2bv 32) 4198699)) true))
...
(assert (= (let ((subject rbp)) rbp32) (bvadd (let ((subject rbp)) rbp31) ((_ int2bv 64) 8))))
(assert (= result138 (let ((subject rsp)) (mk_t__ref3 rsp70))))
(assert (= (let ((subject rsp)) rsp71) (bvsub (let ((subject rsp)) rsp70) ((_ int2bv 64) 8))))
(assert (= (let ((subject rsp)) rsp72) (bvadd (let ((subject rsp)) rsp71) ((_ int2bv 64) 8))))
...
(assert (=> (not (= signflag32 true)) (= result142 (ite (bvugt o203 ((_ int2bv 32) 2147483647)) true false))))
...
(assert (=> (= signflag32 true) (= result143 (ite (bvugt o201 ((_ int2bv 32) 2147483647)) true false))))
