...
(declare-const o15 t)
(declare-const temp___1592 digit_index_type)
(declare-const temp___15921 (Array Int octet))
(declare-const temp___15922 t)
...
(assert (= o14 o12))
(assert (= o15 o13))
(assert (= number__split_discrs (mk___split_discrs temp___1592)))
(assert (= temp___15921 o14))
(assert (= temp___15922 o15))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___15921 temp___15922))))
(assert (= number__split_discrs (mk___split_discrs temp___1592)))
