...
(assert (= o7 (to_rep o6)))
(assert (and (= o8 (shift_right o7 distance)) (= o8 (bvudiv o7 (ite (< distance 256) (bvshl ((_ int2bv 8) 1) ((_ int2bv 8) distance)) ((_ int2bv 8) 0))))))
(assert (= (to_rep o9) o8))
(assert (and (<= (to_rep1 (first number__split_fields3)) i2) (<= i2 (to_rep1 (last number__split_fields3)))))
(assert (= o10 i2))
...
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___15071 temp___15072))))
(assert (= number__split_discrs (mk___split_discrs temp___1507)))
