...
(declare-const result6 (Array Int stream_element))
...
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (= temp___274 (+ (to_rep1 (first (rt in_string))) i2)) (in_range1 (+ (to_rep1 (first (rt in_string))) i2)))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (<= (to_rep1 (first (rt in_string))) temp___274) (<= temp___274 (to_rep1 (last (rt in_string)))))))
...
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (= temp___275 (+ (to_rep4 out_stream__first) i2)) (in_range5 (+ (to_rep4 out_stream__first) i2)))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (<= (to_rep4 out_stream__first) temp___275) (<= temp___275 (to_rep4 out_stream__last)))))
...
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= (mk_int__ref i5) (mk_int__ref i3))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= (mk_map__ref1 out_stream6) (mk_map__ref1 out_stream4))))
...
(assert (= (mk1 (to_rep4 out_stream__first) (to_rep4 out_stream__last)) fixed_stream__convert__result3))
...
(assert (= i7 (mk_int__ref i5)))
(assert (= out_stream8 (mk_map__ref1 out_stream6)))
...
(assert (= len3 len1))
(assert (= (mk___t1 result6 result7) (stream_element_array__content fixed_stream__convert__result7)))
(assert (not (= (length1 (stream_element_array__content fixed_stream__convert__result7)) (elements this))))
(check-sat)
(exit)
