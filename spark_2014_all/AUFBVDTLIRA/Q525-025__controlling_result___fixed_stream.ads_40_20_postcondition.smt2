...
(declare-const temp___301 (Array Int stream_element))
...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= temp___301 out_stream1)))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (<= 1 i2) (<= i2 r19b))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (= temp___298 (+ (to_rep1 (first (rt in_string))) i2)) (in_range1 (+ (to_rep1 (first (rt in_string))) i2)))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (<= (to_rep1 (first (rt in_string))) temp___298) (<= temp___298 (to_rep1 (last (rt in_string)))))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= o3 temp___298)))
...
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (= temp___299 (+ (to_rep4 out_stream__first) i2)) (in_range5 (+ (to_rep4 out_stream__first) i2)))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (and (<= (to_rep4 out_stream__first) temp___299) (<= temp___299 (to_rep4 out_stream__last)))))
(assert (=> (and (<= 1 i1) (<= i1 r19b)) (= o9 temp___299)))
