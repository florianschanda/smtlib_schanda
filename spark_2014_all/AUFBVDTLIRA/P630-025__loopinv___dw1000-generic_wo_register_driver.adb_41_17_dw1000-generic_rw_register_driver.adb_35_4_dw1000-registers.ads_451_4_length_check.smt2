...
(define-fun in_range3 ((x (_ BitVec 16))) Bool (and (bvule ((_ int2bv 16) 0) x) (bvule x ((_ int2bv 16) 32767))))
...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x ((_ int2bv 16) 32768)))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(define-fun dynamic_invariant ((temp___expr_5454 us_t1) (temp___is_init_5451 Bool) (temp___skip_constant_5452 Bool) (temp___do_toplevel_5453 Bool)) Bool (=> (not (= temp___skip_constant_5452 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5454) (last3 temp___expr_5454)) (and (= (first3 temp___expr_5454) 1) (= (last3 temp___expr_5454) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_5471 us_t2) (temp___is_init_5468 Bool) (temp___skip_constant_5469 Bool) (temp___do_toplevel_5470 Bool)) Bool (=> (not (= temp___skip_constant_5469 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5471) (last5 temp___expr_5471)) (and (= (first5 temp___expr_5471) 1) (= (last5 temp___expr_5471) 2)))))
...
(assert (and (= (mk___t2 temp___8016 temp___80161) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8016 temp___80161) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___80161)) (to_rep (last4 temp___80161))) (+ (- (to_rep (last4 temp___80161)) (to_rep (first4 temp___80161))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8016 temp___8017))
(assert (= (mk1 (to_rep (first4 temp___80161)) (to_rep (last4 temp___80161))) temp___80171))
(assert (not (= (ite (<= (to_rep (first2 temp___80171)) (to_rep (last2 temp___80171))) (+ (- (to_rep (last2 temp___80171)) (to_rep (first2 temp___80171))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
