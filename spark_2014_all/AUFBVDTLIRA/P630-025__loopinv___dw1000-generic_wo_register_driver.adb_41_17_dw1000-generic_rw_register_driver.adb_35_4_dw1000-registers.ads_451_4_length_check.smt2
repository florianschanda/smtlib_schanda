...
(define-fun register_byte_array__ref___99__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5992 us_t1) (temp___is_init_5988 Bool) (temp___skip_constant_5989 Bool) (temp___do_toplevel_5990 Bool) (temp___do_typ_inv_5991 Bool)) Bool (=> (not (= temp___skip_constant_5989 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5992) (last3 temp___expr_5992)) (and (= (first3 temp___expr_5992) 1) (= (last3 temp___expr_5992) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___42__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_6011 us_t2) (temp___is_init_6007 Bool) (temp___skip_constant_6008 Bool) (temp___do_toplevel_6009 Bool) (temp___do_typ_inv_6010 Bool)) Bool (=> (not (= temp___skip_constant_6008 true)) (and (dynamic_property3 1 2 (first5 temp___expr_6011) (last5 temp___expr_6011)) (and (= (first5 temp___expr_6011) 1) (= (last5 temp___expr_6011) 2)))))
...
(declare-const temp___87881 t2)
(declare-const temp___8789 (Array Int bits_8))
(declare-const temp___87891 t1)
(define-fun temp___87882 () us_t2 (mk___t2 temp___8788 temp___87881))
...
(assert (and (= temp___87882 (register_to_bytes reg)) (dynamic_invariant1 temp___87882 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___87881)) (to_rep (last4 temp___87881))) (+ (- (to_rep (last4 temp___87881)) (to_rep (first4 temp___87881))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8788 temp___8789))
(assert (= (mk1 (to_rep (first4 temp___87881)) (to_rep (last4 temp___87881))) temp___87891))
(assert (not (= (ite (<= (to_rep (first2 temp___87891)) (to_rep (last2 temp___87891))) (+ (- (to_rep (last2 temp___87891)) (to_rep (first2 temp___87891))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
