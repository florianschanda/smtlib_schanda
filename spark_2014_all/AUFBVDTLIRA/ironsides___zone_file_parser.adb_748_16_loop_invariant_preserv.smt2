...
(assert (=> (= foundtype3 3) (= result18 (mk_int__ref recordtype3))))
(assert (=> (= foundtype3 3) (= recordtype4 o22)))
(assert (=> (= foundtype3 3) (and (= o23 (+ numberofrecordtypes3 1)) (in_range6 (+ numberofrecordtypes3 1)))))
(assert (=> (= foundtype3 3) (= result19 (mk_int__ref numberofrecordtypes3))))
(assert (=> (= foundtype3 3) (= numberofrecordtypes4 o23)))
(assert (=> (= foundtype3 3) (= (to_rep2 o24) recordtype4)))
...
(assert (=> (= foundtype3 3) (= result20 (mk_map__ref2 recordtypes3))))
(assert (=> (= foundtype3 3) (= recordtypes4 o26)))
(assert (=> (= foundtype3 3) (= o27 (from_query_type recordtype4))))
(assert (=> (= foundtype3 3) (= o28 (bvudiv o27 ((_ int2bv 16) 256)))))
(assert (=> (= foundtype3 3) (= o29 (bvurem o28 ((_ int2bv 16) 256)))))
(assert (=> (= foundtype3 3) (= o30 o29)))
(assert (=> (= foundtype3 3) (= o31 ((_ extract 7 0) o30))))
(assert (=> (= foundtype3 3) (= result21 (mk_t__ref blocknumber2))))
(assert (=> (= foundtype3 3) (= blocknumber3 o31)))
(assert (=> (= foundtype3 3) (= result22 (mk_map__ref5 blockmap3))))
(assert (=> (= foundtype3 3) (= blockmap4 (store blockmap3 blocknumber3 (of_int 1)))))
(assert (=> (= foundtype3 3) (= o32 (from_query_type recordtype4))))
(assert (=> (= foundtype3 3) (= o33 (bvudiv o32 ((_ int2bv 16) 256)))))
(assert (=> (= foundtype3 3) (= o34 (bvmul ((_ int2bv 16) 256) o33))))
(assert (=> (= foundtype3 3) (= o35 (from_query_type recordtype4))))
(assert (=> (= foundtype3 3) (= o36 (bvsub o35 o34))))
(assert (=> (= foundtype3 3) (= o37 (bvudiv o36 ((_ int2bv 16) 8)))))
(assert (=> (= foundtype3 3) (= o38 (bvurem o37 ((_ int2bv 16) 32)))))
(assert (=> (= foundtype3 3) (= o39 (bvadd o38 ((_ int2bv 16) 1)))))
(assert (=> (= foundtype3 3) (= o40 (bv2nat o39))))
(assert (=> (= foundtype3 3) (= result23 (mk_int__ref bytenumber3))))
(assert (=> (= foundtype3 3) (= bytenumber4 o40)))
(assert (=> (= foundtype3 3) (=> (< (to_rep3 (select blocklengthmap3 blocknumber3)) bytenumber4) (= (to_rep3 o41) bytenumber4))))
(assert (=> (= foundtype3 3) (=> (< (to_rep3 (select blocklengthmap3 blocknumber3)) bytenumber4) (= o42 (store blocklengthmap3 blocknumber3 o41)))))
(assert (=> (= foundtype3 3) (=> (< (to_rep3 (select blocklengthmap3 blocknumber3)) bytenumber4) (= result24 (mk_map__ref6 blocklengthmap3)))))
(assert (=> (= foundtype3 3) (=> (< (to_rep3 (select blocklengthmap3 blocknumber3)) bytenumber4) (= blocklengthmap4 o42))))
(assert (=> (= foundtype3 3) (=> (not (< (to_rep3 (select blocklengthmap3 blocknumber3)) bytenumber4)) (= blocklengthmap4 blocklengthmap3))))
(assert (=> (not (= foundtype3 3)) (= bytenumber4 bytenumber3)))
(assert (=> (not (= foundtype3 3)) (= blocknumber3 blocknumber2)))
(assert (=> (not (= foundtype3 3)) (= recordtype4 recordtype3)))
