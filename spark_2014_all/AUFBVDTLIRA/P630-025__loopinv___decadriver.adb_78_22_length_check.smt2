...
(assert (=> (<= 1 temp___4531) (and (and (<= 0 1) (<= 1 1024)) (and (<= 0 temp___4531) (<= temp___4531 1024)))))
(assert (= o6 (rec__decadriver__rx_frame_type__frame (us_split_fields1 (select self__ (to_rep5 self__1))))))
(assert (= o6 temp___4534))
(assert (= (mk3 1 temp___4531) temp___45341))
(assert (= temp___4534 temp___4535))
(assert (= (mk (to_rep1 (first6 temp___45341)) (to_rep1 (last6 temp___45341))) temp___45351))
(assert (not (= (ite (<= (to_rep1 (first temp___45351)) (to_rep1 (last temp___45351))) (+ (- (to_rep1 (last temp___45351)) (to_rep1 (first temp___45351))) 1) 0) (ite (<= (to_rep1 frame__first) (to_rep1 frame__last)) (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1) 0))))
(check-sat)
(exit)
