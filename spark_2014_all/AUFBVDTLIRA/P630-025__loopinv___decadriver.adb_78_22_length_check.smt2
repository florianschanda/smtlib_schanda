...
(assert (=> (<= 1 temp___4541) (and (and (<= 0 1) (<= 1 1024)) (and (<= 0 temp___4541) (<= temp___4541 1024)))))
(assert (= o3 (rec__decadriver__rx_frame_type__frame (us_split_fields1 (select self__ (to_rep5 self__1))))))
(assert (= o3 temp___4544))
(assert (= (mk3 1 temp___4541) temp___45441))
(assert (= temp___4544 temp___4545))
(assert (= (mk (to_rep1 (first6 temp___45441)) (to_rep1 (last6 temp___45441))) temp___45451))
(assert (not (= (ite (<= (to_rep1 (first temp___45451)) (to_rep1 (last temp___45451))) (+ (- (to_rep1 (last temp___45451)) (to_rep1 (first temp___45451))) 1) 0) (ite (<= (to_rep1 frame__first) (to_rep1 frame__last)) (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1) 0))))
(check-sat)
(exit)
