...
(assert (=> (<= 1 temp___5084) (and (and (<= 0 1) (<= 1 1024)) (and (<= 0 temp___5084) (<= temp___5084 1024)))))
(assert (= o3 (rec__decadriver__rx_frame_type__frame (us_split_fields1 (select self__ (to_rep5 self__1))))))
(assert (= o3 temp___5087))
(assert (= (mk3 1 temp___5084) temp___50871))
(assert (= temp___5087 temp___5088))
(assert (= (mk (to_rep1 (first6 temp___50871)) (to_rep1 (last6 temp___50871))) temp___50881))
(assert (not (= (ite (<= (to_rep1 (first temp___50881)) (to_rep1 (last temp___50881))) (+ (- (to_rep1 (last temp___50881)) (to_rep1 (first temp___50881))) 1) 0) (ite (<= (to_rep1 frame__first) (to_rep1 frame__last)) (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1) 0))))
(check-sat)
(exit)
