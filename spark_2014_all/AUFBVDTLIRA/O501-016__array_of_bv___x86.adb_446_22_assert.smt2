...
(assert (not (= (bvor ((_ zero_extend 8) (readmem8 addr memory)) (ite (< 8 16) (bvshl ((_ zero_extend 8) (readmem8 (bvadd addr #x0000000000000001) memory)) ((_ int2bv 16) 8)) #x0000)) (readmem16 addr memory))))
(check-sat)
(exit)
