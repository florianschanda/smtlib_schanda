...
(assert true)
(assert (not (= (bvor ((_ zero_extend 8) (readmem8 addr memory)) (ite (< 8 16) (bvshl ((_ zero_extend 8) (readmem8 (bvadd addr ((_ int2bv 64) 1)) memory)) ((_ int2bv 16) 8)) ((_ int2bv 16) 0))) (readmem16 addr memory))))
(check-sat)
(exit)
