...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__fs_plltune_type__fs_plltune (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__fs_plltune_type__fs_plltune (us_split_fields1 b)))) true false))
...
(define-fun register_type__ref___153__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___108__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___108__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_6270 us_t1) (temp___is_init_6266 Bool) (temp___skip_constant_6267 Bool) (temp___do_toplevel_6268 Bool) (temp___do_typ_inv_6269 Bool)) Bool (=> (not (= temp___skip_constant_6267 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6270) (last3 temp___expr_6270)) (and (= (first3 temp___expr_6270) 1) (= (last3 temp___expr_6270) 1)))))
