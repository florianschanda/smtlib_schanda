...
(assert (= i1 1))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1111 t_digit)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1110 r_digit)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1109 l_digit)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1108 carry1)))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1105 (mk___rep1 result____split_discrs result____split_fields3))))
(assert (=> (and (<= 1 i1) (<= i1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= temp___1104 temp)))
...
(assert (not (<= temp___1113 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 (us_split_fields__content1 result____split_fields8))))))))
(check-sat)
(exit)
