...
(assert (=> (<= 1 temp___1280) (and (and (<= 1 1) (<= 1 150)) (and (<= 1 temp___1280) (<= temp___1280 150)))))
(assert (= o7 result__1))
(assert (= o7 temp___1281))
(assert (= (mk1 1 temp___1280) temp___12811))
(assert (not (= (ite (<= (to_rep1 (first2 temp___12781)) (to_rep1 (last2 temp___12781))) (+ (- (to_rep1 (last2 temp___12781)) (to_rep1 (first2 temp___12781))) 1) 0) (ite (<= (to_rep1 (first2 temp___12811)) (to_rep1 (last2 temp___12811))) (+ (- (to_rep1 (last2 temp___12811)) (to_rep1 (first2 temp___12811))) 1) 0))))
(check-sat)
(exit)
