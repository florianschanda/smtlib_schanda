...
(declare-fun object__size1 ((Array (_ BitVec 8) us_rep)) Int)
(declare-const value__component__size Int)
(declare-fun object__component__size ((Array (_ BitVec 8) us_rep)) Int)
(declare-const value__alignment1 Int)
(declare-fun object__alignment1 ((Array (_ BitVec 8) us_rep)) Int)
(assert (<= 0 value__size1))
(assert (forall ((a (Array (_ BitVec 8) us_rep))) (<= 0 (object__size1 a))))
(assert (<= 0 value__component__size))
(assert (forall ((a (Array (_ BitVec 8) us_rep))) (<= 0 (object__component__size a))))
(assert (<= 0 value__alignment1))
(assert (forall ((a (Array (_ BitVec 8) us_rep))) (<= 0 (object__alignment1 a))))
(declare-fun user_eq4 ((Array (_ BitVec 8) us_rep) (Array (_ BitVec 8) us_rep)) Bool)
(declare-datatypes () ((map__ref1 (mk_map__ref1 (map__content1 (Array Int (Array (_ BitVec 8) us_rep)))))))
(declare-fun slide1 ((Array Int (Array (_ BitVec 8) us_rep)) Int Int) (Array Int (Array (_ BitVec 8) us_rep)))
(assert (forall ((a (Array Int (Array (_ BitVec 8) us_rep)))) (forall ((first Int)) (! (= (slide1 a first first) a) :pattern ((slide1 a first first))))))
(assert (forall ((a (Array Int (Array (_ BitVec 8) us_rep)))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide1 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide1 a old_first new_first) i))))))))
...
(assert (forall ((a (Array Int (Array (_ BitVec 8) us_rep))) (b (Array Int (Array (_ BitVec 8) us_rep)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_219 Int)) (=> (and (<= a__first temp___idx_219) (<= temp___idx_219 a__last)) (= (bool_eq1 (select a temp___idx_219) #x00 #x3F (select b (+ (- b__first a__first) temp___idx_219)) #x00 #x3F) true))))))))
...
(declare-fun user_eq5 (ring_range ring_range) Bool)
(declare-const dummy5 ring_range)
...
(assert (forall ((x ring_range)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(define-fun bool_eq4 ((a (Array Int us_rep1)) (a__first Int) (a__last Int) (b (Array Int us_rep1)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_221 Int)) (=> (and (<= a__first temp___idx_221) (<= temp___idx_221 a__last)) (= (bool_eq3 (select a temp___idx_221) (select b (+ (- b__first a__first) temp___idx_221))) true)))) true false))
(assert (forall ((a (Array Int us_rep1)) (b (Array Int us_rep1))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_221 Int)) (=> (and (<= a__first temp___idx_221) (<= temp___idx_221 a__last)) (= (bool_eq3 (select a temp___idx_221) (select b (+ (- b__first a__first) temp___idx_221))) true))))))))
...
(declare-fun user_eq7 (bit bit) Bool)
(declare-const dummy7 bit)
(declare-datatypes () ((bit__ref (mk_bit__ref (bit__content bit)))))
(define-fun bit__ref___projection ((a bit__ref)) bit (bit__content a))
(declare-fun to_rep3 (bit) (_ BitVec 8))
(declare-fun of_rep3 ((_ BitVec 8)) bit)
(assert (forall ((x bit)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x bit)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x02))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int7 ((x bit)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x bit)) (! (in_range_int1 (to_int7 x)) :pattern ((to_int7 x)))))
(declare-datatypes () ((map__ref3 (mk_map__ref3 (map__content3 (Array Int bit))))))
(declare-fun slide3 ((Array Int bit) Int Int) (Array Int bit))
(assert (forall ((a (Array Int bit))) (forall ((first Int)) (! (= (slide3 a first first) a) :pattern ((slide3 a first first))))))
(assert (forall ((a (Array Int bit))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide3 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide3 a old_first new_first) i))))))))
(define-fun bool_eq5 ((a (Array Int bit)) (a__first Int) (a__last Int) (b (Array Int bit)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_220 Int)) (=> (and (<= a__first temp___idx_220) (<= temp___idx_220 a__last)) (= (to_rep3 (select a temp___idx_220)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_220))))))) true false))
(assert (forall ((a (Array Int bit)) (b (Array Int bit))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_220 Int)) (=> (and (<= a__first temp___idx_220) (<= temp___idx_220 a__last)) (= (to_rep3 (select a temp___idx_220)) (to_rep3 (select b (+ (- b__first a__first) temp___idx_220)))))))))))
...
(define-fun dynamic_invariant2 ((temp___expr_586 Int) (temp___is_init_582 Bool) (temp___skip_constant_583 Bool) (temp___do_toplevel_584 Bool) (temp___do_typ_inv_585 Bool)) Bool (=> (or (= temp___is_init_582 true) (<= 2 3)) (in_range4 temp___expr_586)))
(define-fun dynamic_invariant3 ((temp___expr_863 (_ BitVec 8)) (temp___is_init_859 Bool) (temp___skip_constant_860 Bool) (temp___do_toplevel_861 Bool) (temp___do_typ_inv_862 Bool)) Bool (=> (or (= temp___is_init_859 true) (bvule #x00 #x3F)) (in_range2 temp___expr_863)))
...
(define-fun dynamic_invariant4 ((temp___expr_379 (_ BitVec 8)) (temp___is_init_375 Bool) (temp___skip_constant_376 Bool) (temp___do_toplevel_377 Bool) (temp___do_typ_inv_378 Bool)) Bool (=> (or (= temp___is_init_375 true) (bvule #x00 #x01)) (in_range3 temp___expr_379)))
...
(assert (not (not (= #x0000000000010000 #x0000000000000000))))
(check-sat)
(exit)
