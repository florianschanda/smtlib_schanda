...
(declare-fun to_rep (bit) (_ BitVec 8))
(declare-fun of_rep ((_ BitVec 8)) bit)
(assert (forall ((x bit)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x bit)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 2)))) (=> (in_range2 y) (= (to_rep (of_rep x)) y))) :pattern ((to_rep (of_rep x))))))
(define-fun to_int4 ((x bit)) Int (bv2nat (to_rep x)))
(assert (forall ((x bit)) (! (in_range_int (to_int4 x)) :pattern ((to_int4 x)))))
...
(define-fun dynamic_invariant1 ((temp___expr_374 (_ BitVec 64)) (temp___is_init_371 Bool) (temp___skip_constant_372 Bool) (temp___do_toplevel_373 Bool)) Bool true)
(declare-sort endpoint_range 0)
(define-fun in_range3 ((x Int)) Bool (and (<= 2 x) (<= x 3)))
(declare-fun attr__ATTRIBUTE_IMAGE4 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check4 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE4 (us_image) Int)
(declare-fun user_eq3 (endpoint_range endpoint_range) Bool)
(declare-const dummy3 endpoint_range)
...
(define-fun dynamic_invariant2 ((temp___expr_524 Int) (temp___is_init_521 Bool) (temp___skip_constant_522 Bool) (temp___do_toplevel_523 Bool)) Bool (=> (or (= temp___is_init_521 true) (<= 2 3)) (in_range3 temp___expr_524)))
...
(define-fun to_int6 ((x word32)) Int (bv2nat (to_rep1 x)))
(assert (forall ((x word32)) (! (uint_in_range2 (to_int6 x)) :pattern ((to_int6 x)))))
(declare-fun to_rep2 (word64) (_ BitVec 64))
(declare-fun of_rep2 ((_ BitVec 64)) word64)
(assert (forall ((x word64)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert true)
(assert (forall ((x (_ BitVec 64))) (! (= (to_rep2 (of_rep2 x)) x) :pattern ((to_rep2 (of_rep2 x))))))
(define-fun to_int7 ((x word64)) Int (bv2nat (to_rep2 x)))
(assert (forall ((x word64)) (! (uint_in_range1 (to_int7 x)) :pattern ((to_int7 x)))))
...
(define-fun bool_eq ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep2 (rec__hw__dbc__trbs__t__parameter (us_split_fields1 a))) (to_rep2 (rec__hw__dbc__trbs__t__parameter (us_split_fields1 b)))) (= (to_rep1 (rec__hw__dbc__trbs__t__status (us_split_fields1 a))) (to_rep1 (rec__hw__dbc__trbs__t__status (us_split_fields1 b))))) (= (to_rep1 (rec__hw__dbc__trbs__t__control (us_split_fields1 a))) (to_rep1 (rec__hw__dbc__trbs__t__control (us_split_fields1 b))))) true false))
...
(define-fun in_range4 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 63))))
...
(define-fun dynamic_invariant3 ((temp___expr_772 (_ BitVec 8)) (temp___is_init_769 Bool) (temp___skip_constant_770 Bool) (temp___do_toplevel_771 Bool)) Bool (=> (or (= temp___is_init_769 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 63))) (in_range4 temp___expr_772)))
(declare-fun to_rep3 (ring_range) (_ BitVec 8))
(declare-fun of_rep3 ((_ BitVec 8)) ring_range)
(assert (forall ((x ring_range)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x ring_range)) (! (in_range4 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 64)))) (=> (in_range4 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int8 ((x ring_range)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x ring_range)) (! (in_range_int1 (to_int8 x)) :pattern ((to_int8 x)))))
...
(declare-fun concat1 ((Array (_ BitVec 8) us_rep) (_ BitVec 8) (_ BitVec 8) (Array (_ BitVec 8) us_rep) (_ BitVec 8) (_ BitVec 8)) (Array (_ BitVec 8) us_rep))
(assert (forall ((a (Array (_ BitVec 8) us_rep)) (b (Array (_ BitVec 8) us_rep))) (forall ((a_first (_ BitVec 8)) (a_last (_ BitVec 8)) (b_first (_ BitVec 8)) (b_last (_ BitVec 8))) (forall ((i (_ BitVec 8))) (! (and (=> (and (bvule a_first i) (bvule i a_last)) (= (select (concat1 a a_first a_last b b_first b_last) i) (select a i))) (=> (bvugt i a_last) (= (select (concat1 a a_first a_last b b_first b_last) i) (select b (bvadd (bvsub i a_last) (bvsub b_first #x01)))))) :pattern ((select (concat1 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton1 (us_rep (_ BitVec 8)) (Array (_ BitVec 8) us_rep))
(assert (forall ((v us_rep)) (forall ((i (_ BitVec 8))) (! (= (select (singleton1 v i) i) v) :pattern ((select (singleton1 v i) i))))))
(define-fun bool_eq1 ((a (Array (_ BitVec 8) us_rep)) (a__first (_ BitVec 8)) (a__last (_ BitVec 8)) (b (Array (_ BitVec 8) us_rep)) (b__first (_ BitVec 8)) (b__last (_ BitVec 8))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_196 (_ BitVec 8))) (=> (and (bvule a__first temp___idx_196) (bvule temp___idx_196 a__last)) (= (bool_eq (select a temp___idx_196) (select b (bvadd (bvsub b__first a__first) temp___idx_196))) true)))) true false))
(assert (forall ((a (Array (_ BitVec 8) us_rep)) (b (Array (_ BitVec 8) us_rep))) (forall ((a__first (_ BitVec 8)) (a__last (_ BitVec 8)) (b__first (_ BitVec 8)) (b__last (_ BitVec 8))) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_196 (_ BitVec 8))) (=> (and (bvule a__first temp___idx_196) (bvule temp___idx_196 a__last)) (= (bool_eq (select a temp___idx_196) (select b (bvadd (bvsub b__first a__first) temp___idx_196))) true))))))))
...
(define-fun bool_eq2 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (and (= (to_rep3 (rec__hw__dbc__transfer_rings__transfer_pointers__enqueue (us_split_fields3 a))) (to_rep3 (rec__hw__dbc__transfer_rings__transfer_pointers__enqueue (us_split_fields3 b)))) (= (to_rep3 (rec__hw__dbc__transfer_rings__transfer_pointers__dequeue (us_split_fields3 a))) (to_rep3 (rec__hw__dbc__transfer_rings__transfer_pointers__dequeue (us_split_fields3 b))))) (= (rec__hw__dbc__transfer_rings__transfer_pointers__full (us_split_fields3 a)) (rec__hw__dbc__transfer_rings__transfer_pointers__full (us_split_fields3 b)))) (= (to_rep3 (rec__hw__dbc__transfer_rings__transfer_pointers__toggle (us_split_fields3 a))) (to_rep3 (rec__hw__dbc__transfer_rings__transfer_pointers__toggle (us_split_fields3 b))))) (= (rec__hw__dbc__transfer_rings__transfer_pointers__overrun (us_split_fields3 a)) (rec__hw__dbc__transfer_rings__transfer_pointers__overrun (us_split_fields3 b)))) true false))
...
(define-fun bool_eq3 ((a (Array Int us_rep1)) (a__first Int) (a__last Int) (b (Array Int us_rep1)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_199 Int)) (=> (and (<= a__first temp___idx_199) (<= temp___idx_199 a__last)) (= (bool_eq2 (select a temp___idx_199) (select b (+ (- b__first a__first) temp___idx_199))) true)))) true false))
(assert (forall ((a (Array Int us_rep1)) (b (Array Int us_rep1))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq3 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_199 Int)) (=> (and (<= a__first temp___idx_199) (<= temp___idx_199 a__last)) (= (bool_eq2 (select a temp___idx_199) (select b (+ (- b__first a__first) temp___idx_199))) true))))))))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-datatypes () ((map__ref2 (mk_map__ref2 (map__content2 (Array Int bit))))))
(declare-fun slide2 ((Array Int bit) Int Int) (Array Int bit))
(assert (forall ((a (Array Int bit))) (forall ((first Int)) (! (= (slide2 a first first) a) :pattern ((slide2 a first first))))))
(assert (forall ((a (Array Int bit))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide2 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide2 a old_first new_first) i))))))))
(declare-fun concat3 ((Array Int bit) Int Int (Array Int bit) Int Int) (Array Int bit))
...
(declare-fun singleton3 (bit Int) (Array Int bit))
(assert (forall ((v bit)) (forall ((i Int)) (! (= (select (singleton3 v i) i) v) :pattern ((select (singleton3 v i) i))))))
(define-fun bool_eq4 ((a (Array Int bit)) (a__first Int) (a__last Int) (b (Array Int bit)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_198 Int)) (=> (and (<= a__first temp___idx_198) (<= temp___idx_198 a__last)) (= (to_rep (select a temp___idx_198)) (to_rep (select b (+ (- b__first a__first) temp___idx_198))))))) true false))
...
(assert (forall ((a (Array Int bit)) (b (Array Int bit))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq4 a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bit)) (b (Array Int bit))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq4 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (bvult (to_rep (select a (+ i 1))) (to_rep (select b (+ j 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int bit)) (b (Array Int bit))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq4 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (bvugt (to_rep (select a (+ j 1))) (to_rep (select b (+ i 1))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(declare-datatypes () ((map__ref3 (mk_map__ref3 (map__content3 (Array Int (Array (_ BitVec 8) us_rep)))))))
(declare-fun slide3 ((Array Int (Array (_ BitVec 8) us_rep)) Int Int) (Array Int (Array (_ BitVec 8) us_rep)))
(assert (forall ((a (Array Int (Array (_ BitVec 8) us_rep)))) (forall ((first Int)) (! (= (slide3 a first first) a) :pattern ((slide3 a first first))))))
(assert (forall ((a (Array Int (Array (_ BitVec 8) us_rep)))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide3 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide3 a old_first new_first) i))))))))
(declare-fun concat4 ((Array Int (Array (_ BitVec 8) us_rep)) Int Int (Array Int (Array (_ BitVec 8) us_rep)) Int Int) (Array Int (Array (_ BitVec 8) us_rep)))
(assert (forall ((a (Array Int (Array (_ BitVec 8) us_rep))) (b (Array Int (Array (_ BitVec 8) us_rep)))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (forall ((i Int)) (! (and (=> (and (<= a_first i) (<= i a_last)) (= (select (concat4 a a_first a_last b b_first b_last) i) (select a i))) (=> (< a_last i) (= (select (concat4 a a_first a_last b b_first b_last) i) (select b (+ (- i a_last) (- b_first 1)))))) :pattern ((select (concat4 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton4 ((Array (_ BitVec 8) us_rep) Int) (Array Int (Array (_ BitVec 8) us_rep)))
(assert (forall ((v (Array (_ BitVec 8) us_rep))) (forall ((i Int)) (! (= (select (singleton4 v i) i) v) :pattern ((select (singleton4 v i) i))))))
(define-fun bool_eq5 ((a (Array Int (Array (_ BitVec 8) us_rep))) (a__first Int) (a__last Int) (b (Array Int (Array (_ BitVec 8) us_rep))) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq1 (select a temp___idx_197) ((_ int2bv 8) 0) ((_ int2bv 8) 63) (select b (+ (- b__first a__first) temp___idx_197)) ((_ int2bv 8) 0) ((_ int2bv 8) 63)) true)))) true false))
(assert (forall ((a (Array Int (Array (_ BitVec 8) us_rep))) (b (Array Int (Array (_ BitVec 8) us_rep)))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq5 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_197 Int)) (=> (and (<= a__first temp___idx_197) (<= temp___idx_197 a__last)) (= (bool_eq1 (select a temp___idx_197) ((_ int2bv 8) 0) ((_ int2bv 8) 63) (select b (+ (- b__first a__first) temp___idx_197)) ((_ int2bv 8) 0) ((_ int2bv 8) 63)) true))))))))
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-const ep Int)
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-const data_length Int)
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-const data_buf (_ BitVec 64))
(declare-const attr__ATTRIBUTE_ADDRESS5 Int)
(declare-const toggle_cs Bool)
(declare-const attr__ATTRIBUTE_ADDRESS6 Int)
(declare-const attr__ATTRIBUTE_ADDRESS7 Int)
(declare-const c59b Int)
(declare-const attr__ATTRIBUTE_ADDRESS8 Int)
(declare-const c61b (_ BitVec 8))
(declare-const attr__ATTRIBUTE_ADDRESS9 Int)
(declare-const attr__ATTRIBUTE_ADDRESS10 Int)
(define-fun dynamic_invariant4 ((temp___expr_344 (_ BitVec 8)) (temp___is_init_341 Bool) (temp___skip_constant_342 Bool) (temp___do_toplevel_343 Bool)) Bool (=> (or (= temp___is_init_341 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range2 temp___expr_344)))
(define-fun dynamic_invariant5 ((temp___expr_368 (_ BitVec 32)) (temp___is_init_365 Bool) (temp___skip_constant_366 Bool) (temp___do_toplevel_367 Bool)) Bool true)
(assert (in_range3 ep))
(assert (in_range1 data_length))
(assert true)
(assert (not (not (= ((_ int2bv 64) 65536) #x0000000000000000))))
(check-sat)
(exit)
