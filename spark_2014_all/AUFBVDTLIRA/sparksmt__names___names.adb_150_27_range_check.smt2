...
(define-fun temp___6503 () us_rep2 (mk___rep2 (mk___split_fields2 temp___650 temp___6501 temp___6502)))
...
(assert (=> (in_range9 n3) (and (= temp___6472 (to_string1 ptr2 hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (dynamic_invariant temp___6472 true false true))))
(assert (=> (in_range9 n3) (= result3 (bool_eq temp___647 (to_rep1 (first temp___6471)) (to_rep1 (last temp___6471)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))))
...
(assert (and (= temp___6503 (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields1)) o11)) (= (bool_eq3 temp___6503 (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields1)) o11)) true)))
(assert (= (to_rep2 o12) n12))
(assert (= temp___650 o13))
(assert (= temp___6501 o14))
(assert (= o12 o15))
(assert (= o16 o13))
(assert (= o17 o14))
(assert (= o18 o15))
