...
(define-fun temp___7143 () us_rep2 (mk___rep2 (mk___split_fields2 temp___714 temp___7141 temp___7142)))
(define-fun o19 () us_rep2 (mk___rep2 (mk___split_fields2 o3 o4 o5)))
...
(assert (=> (in_range9 n3) (= temp___713 n3)))
(assert (=> (in_range9 n3) (= temp___712 ptr2)))
(assert (=> (in_range9 n3) (and (= temp___7112 (to_string1 ptr2 hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (dynamic_invariant temp___7112 true false true true))))
(assert (=> (in_range9 n3) (= result3 (bool_eq temp___711 (to_rep1 (first temp___7111)) (to_rep1 (last temp___7111)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))))
(assert (=> (in_range9 n3) (not (= result3 true))))
(assert (=> (in_range9 n3) (= n4 n3)))
(assert (=> (in_range9 n3) (and (and (in_range9 ptr3) (<= ptr3 (last2 (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields)))))) (= (invariant__ hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields)) true))))
(assert (=> (in_range9 n3) (and (=> (<= 0 2147483647) (in_range4 ptr3)) (=> (<= 0 2147483647) (in_range4 n5)))))
(assert (=> (in_range9 n3) (= ptr4 (mk_int__ref ptr3))))
(assert (=> (in_range9 n3) (= ptr5 ptr3)))
(assert (=> (in_range9 n3) (and (= o2 ptr3) (in_range11 ptr3))))
(assert (=> (in_range9 n3) (and (= o19 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) (= (bool_eq3 o19 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) true))))
...
(assert (= o17 o14))
(assert (= o18 o15))
(assert (not (in_range11 (int__content ptr10))))
(check-sat)
(exit)
