...
(assert (and (= temp___78072 (register_to_bytes reg)) (dynamic_invariant1 temp___78072 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___78071)) (to_rep (last4 temp___78071))) (+ (- (to_rep (last4 temp___78071)) (to_rep (first4 temp___78071))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7807 temp___7808))
(assert (= (mk1 (to_rep (first4 temp___78071)) (to_rep (last4 temp___78071))) temp___78081))
(assert (= (ite (<= (to_rep (first2 temp___78081)) (to_rep (last2 temp___78081))) (+ (- (to_rep (last2 temp___78081)) (to_rep (first2 temp___78081))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___7808 temp___78081)))
(assert (= o2 o))
