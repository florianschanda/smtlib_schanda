...
(define-fun target__ref___15__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun dynamic_invariant ((temp___expr_3660 us_t1) (temp___is_init_3656 Bool) (temp___skip_constant_3657 Bool) (temp___do_toplevel_3658 Bool) (temp___do_typ_inv_3659 Bool)) Bool (=> (not (= temp___skip_constant_3657 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3660) (last3 temp___expr_3660)) (and (= (first3 temp___expr_3660) 1) (= (last3 temp___expr_3660) 4)))))
...
(define-fun register_byte_array__ref___38__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_3634 us_t2) (temp___is_init_3630 Bool) (temp___skip_constant_3631 Bool) (temp___do_toplevel_3632 Bool) (temp___do_typ_inv_3633 Bool)) Bool (=> (not (= temp___skip_constant_3631 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3634) (last5 temp___expr_3634)) (and (= (first5 temp___expr_3634) 1) (= (last5 temp___expr_3634) 4)))))
...
(declare-const temp___85791 t1)
(declare-const temp___8580 (Array Int bits_8))
(declare-const temp___85801 t2)
...
(define-fun temp___85792 () us_t1 (mk___t1 temp___8579 temp___85791))
...
(assert (and (= temp___85792 (register_to_bytes reg)) (dynamic_invariant temp___85792 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___85791)) (to_rep (last2 temp___85791))) (+ (- (to_rep (last2 temp___85791)) (to_rep (first2 temp___85791))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8579 temp___8580))
(assert (= (mk2 (to_rep (first2 temp___85791)) (to_rep (last2 temp___85791))) temp___85801))
(assert (= (ite (<= (to_rep (first4 temp___85801)) (to_rep (last4 temp___85801))) (+ (- (to_rep (last4 temp___85801)) (to_rep (first4 temp___85801))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8580 temp___85801)))
(assert (= o2 o))
