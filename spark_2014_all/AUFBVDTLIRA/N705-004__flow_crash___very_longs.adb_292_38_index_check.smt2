...
(assert (= temp___1110 (- o13 1)))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1110) (<= temp___1110 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
(assert (= o14 temp___1110))
...
(assert (= (to_rep2 o20) o19))
(assert (and (= o18 (+ i2 j2)) (in_range2 (+ i2 j2))))
(assert (= temp___1112 (- o18 1)))
(assert (not (<= temp___1112 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
(check-sat)
(exit)
