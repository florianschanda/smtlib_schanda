...
(assert (= r_digit4 o12))
(assert (and (= o13 (+ i4 j2)) (in_range1 (+ i4 j2))))
(assert (= temp___1035 (- o13 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1035) (<= temp___1035 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
(assert (= o14 temp___1035))
(assert (= o15 (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields4)) o14)))
...
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1037)))
(check-sat)
(exit)
