...
(assert (= (to_rep3 o) ((_ extract 7 0) (bvudiv sub_address ((_ int2bv 16) 128)))))
(assert (= (to_rep6 o1) 1))
(assert (= (to_rep2 o2) ((_ extract 7 0) (bvand sub_address ((_ int2bv 16) 127)))))
(assert (= (to_rep4 o3) 0))
(assert (= (to_rep5 o4) 1))
(assert (= (to_rep1 o5) register_id))
(assert (= o5 o6))
(assert (= o4 o7))
(assert (= o3 o8))
(assert (= o2 o9))
(assert (= o1 o10))
(assert (= o o11))
(assert (= temp___747 o6))
(assert (= temp___7471 o7))
(assert (= temp___7472 o8))
(assert (= temp___7473 o9))
(assert (= temp___7474 o10))
(assert (= temp___7475 o11))
(assert (and (= (to_rep5 temp___7471) 1) (= (to_rep6 temp___7474) 1)))
(assert (= dw1000__register_driver__read_register__B_3__header__assume6 (mk___rep2 (mk___split_fields2 temp___747 temp___7471 temp___7472 temp___7473 temp___7474 temp___7475))))
