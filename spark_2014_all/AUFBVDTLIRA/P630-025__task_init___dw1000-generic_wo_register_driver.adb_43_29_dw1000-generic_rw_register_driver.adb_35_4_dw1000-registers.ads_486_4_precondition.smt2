...
(assert (forall ((x bits_3)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 8)))) (=> (in_range2 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
...
(define-fun in_range3 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 31))))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 32)))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int5 ((x bits_5)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x bits_5)) (! (in_range_int1 (to_int5 x)) :pattern ((to_int5 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__fs_xtalt_type__xtalt bits_5) (rec__dw1000__register_types__fs_xtalt_type__reserved bits_3)))))
(define-fun us_split_fields_XTALT__projection ((a us_split_fields)) bits_5 (rec__dw1000__register_types__fs_xtalt_type__xtalt a))
(define-fun us_split_fields_Reserved__17__projection ((a us_split_fields)) bits_3 (rec__dw1000__register_types__fs_xtalt_type__reserved a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___66__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___66__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep3 (rec__dw1000__register_types__fs_xtalt_type__xtalt (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__fs_xtalt_type__xtalt (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__fs_xtalt_type__reserved (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__fs_xtalt_type__reserved (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__fs_xtalt_type__xtalt__first__bit Int)
(declare-const dw1000__register_types__fs_xtalt_type__xtalt__last__bit Int)
(declare-const dw1000__register_types__fs_xtalt_type__xtalt__position Int)
(assert (<= 0 dw1000__register_types__fs_xtalt_type__xtalt__first__bit))
(assert (< dw1000__register_types__fs_xtalt_type__xtalt__first__bit dw1000__register_types__fs_xtalt_type__xtalt__last__bit))
(assert (<= 0 dw1000__register_types__fs_xtalt_type__xtalt__position))
(declare-const dw1000__register_types__fs_xtalt_type__reserved__first__bit Int)
(declare-const dw1000__register_types__fs_xtalt_type__reserved__last__bit Int)
(declare-const dw1000__register_types__fs_xtalt_type__reserved__position Int)
(assert (<= 0 dw1000__register_types__fs_xtalt_type__reserved__first__bit))
(assert (< dw1000__register_types__fs_xtalt_type__reserved__first__bit dw1000__register_types__fs_xtalt_type__reserved__last__bit))
(assert (<= 0 dw1000__register_types__fs_xtalt_type__reserved__position))
(declare-fun user_eq6 (us_rep us_rep) Bool)
(declare-const dummy6 us_rep)
(declare-datatypes () ((fs_xtalt_type__ref (mk_fs_xtalt_type__ref (fs_xtalt_type__content us_rep)))))
(define-fun fs_xtalt_type__ref___projection ((a fs_xtalt_type__ref)) us_rep (fs_xtalt_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___157__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___111__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___111__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5778 us_t1) (temp___is_init_5775 Bool) (temp___skip_constant_5776 Bool) (temp___do_toplevel_5777 Bool)) Bool (=> (not (= temp___skip_constant_5776 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5778) (last3 temp___expr_5778)) (and (= (first3 temp___expr_5778) 1) (= (last3 temp___expr_5778) 1)))))
(declare-sort t2 0)
...
(define-fun target__ref___47__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___47__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_5795 us_t2) (temp___is_init_5792 Bool) (temp___skip_constant_5793 Bool) (temp___do_toplevel_5794 Bool)) Bool (=> (not (= temp___skip_constant_5793 true)) (and (dynamic_property3 1 1 (first5 temp___expr_5795) (last5 temp___expr_5795)) (and (= (first5 temp___expr_5795) 1) (= (last5 temp___expr_5795) 1)))))
...
(declare-const temp___8055 (Array Int bits_8))
(declare-const temp___80551 t2)
(declare-const temp___8056 (Array Int bits_8))
(declare-const temp___80561 t1)
...
(define-fun temp___80552 () us_t2 (mk___t2 temp___8055 temp___80551))
...
(assert (and (= temp___80552 (register_to_bytes reg)) (dynamic_invariant1 temp___80552 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___80551)) (to_rep (last4 temp___80551))) (+ (- (to_rep (last4 temp___80551)) (to_rep (first4 temp___80551))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8055 temp___8056))
(assert (= (mk1 (to_rep (first4 temp___80551)) (to_rep (last4 temp___80551))) temp___80561))
(assert (= (ite (<= (to_rep (first2 temp___80561)) (to_rep (last2 temp___80561))) (+ (- (to_rep (last2 temp___80561)) (to_rep (first2 temp___80561))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8056 temp___80561)))
(assert (= o2 o))
