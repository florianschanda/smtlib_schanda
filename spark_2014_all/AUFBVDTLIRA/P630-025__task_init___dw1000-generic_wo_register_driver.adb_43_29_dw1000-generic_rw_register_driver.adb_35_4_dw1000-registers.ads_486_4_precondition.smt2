...
(define-fun target__ref___47__projection ((a target__ref)) us_t1 (target__content a))
(declare-sort bits_3 0)
(define-fun in_range2 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x07)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x08))) (=> (in_range2 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
...
(define-fun dynamic_invariant ((temp___expr_6374 us_t1) (temp___is_init_6370 Bool) (temp___skip_constant_6371 Bool) (temp___do_toplevel_6372 Bool) (temp___do_typ_inv_6373 Bool)) Bool (=> (not (= temp___skip_constant_6371 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6374) (last3 temp___expr_6374)) (and (= (first3 temp___expr_6374) 1) (= (last3 temp___expr_6374) 1)))))
...
(define-fun register_byte_array__ref___111__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_6355 us_t2) (temp___is_init_6351 Bool) (temp___skip_constant_6352 Bool) (temp___do_toplevel_6353 Bool) (temp___do_typ_inv_6354 Bool)) Bool (=> (not (= temp___skip_constant_6352 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6355) (last5 temp___expr_6355)) (and (= (first5 temp___expr_6355) 1) (= (last5 temp___expr_6355) 1)))))
...
(declare-const temp___8827 (Array Int bits_8))
(declare-const temp___88271 t1)
(declare-const temp___8828 (Array Int bits_8))
(declare-const temp___88281 t2)
...
(define-fun temp___88272 () us_t1 (mk___t1 temp___8827 temp___88271))
(assert (and (dynamic_property3 1 1 (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (and (= (to_rep reg_bytes__first) 1) (= (to_rep reg_bytes__last) 1))))
(assert (and (= temp___88272 (register_to_bytes reg)) (dynamic_invariant temp___88272 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___88271)) (to_rep (last2 temp___88271))) (+ (- (to_rep (last2 temp___88271)) (to_rep (first2 temp___88271))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8827 temp___8828))
(assert (= (mk2 (to_rep (first2 temp___88271)) (to_rep (last2 temp___88271))) temp___88281))
(assert (= (ite (<= (to_rep (first4 temp___88281)) (to_rep (last4 temp___88281))) (+ (- (to_rep (last4 temp___88281)) (to_rep (first4 temp___88281))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8828 temp___88281)))
(assert (= o2 o))
