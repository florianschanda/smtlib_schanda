...
(assert (not (= (ite (<= (to_rep1 (first4 temp___9681)) (to_rep1 (last4 temp___9681))) (+ (- (to_rep1 (last4 temp___9681)) (to_rep1 (first4 temp___9681))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) 1) 1) 0))))
(check-sat)
(exit)
