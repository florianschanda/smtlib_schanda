...
(define-fun dynamic_invariant ((temp___expr_1829 us_t1) (temp___is_init_1826 Bool) (temp___skip_constant_1827 Bool) (temp___do_toplevel_1828 Bool)) Bool (=> (not (= temp___skip_constant_1827 true)) (and (dynamic_property2 1 4 (first3 temp___expr_1829) (last3 temp___expr_1829)) (and (= (first3 temp___expr_1829) 1) (= (last3 temp___expr_1829) 4)))))
