...
(assert true)
(assert (<= (to_rep1 (first (rt a))) a_first))
(assert (<= a_first (to_rep1 (last (rt a)))))
(assert (and (= o (- (to_rep1 (last (rt a))) a_first)) (in_range1 (- (to_rep1 (last (rt a))) a_first))))
(assert (and (= o1 o) (uint_in_range1 o)))
(assert (= o2 ((_ int2bv 64) o1)))
(assert (not (not (= ((_ int2bv 64) 32) #x0000000000000000))))
(check-sat)
(exit)
