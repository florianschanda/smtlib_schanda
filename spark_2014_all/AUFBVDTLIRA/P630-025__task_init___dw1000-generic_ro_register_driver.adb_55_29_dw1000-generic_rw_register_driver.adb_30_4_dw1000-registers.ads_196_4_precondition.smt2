...
(define-fun dynamic_invariant ((temp___expr_1852 us_t1) (temp___is_init_1849 Bool) (temp___skip_constant_1850 Bool) (temp___do_toplevel_1851 Bool)) Bool (=> (not (= temp___skip_constant_1850 true)) (and (dynamic_property2 1 8 (first3 temp___expr_1852) (last3 temp___expr_1852)) (and (= (first3 temp___expr_1852) 1) (= (last3 temp___expr_1852) 8)))))
