...
(declare-const bytes18 (Array Int byte))
(declare-const bytes19 map__ref1)
(declare-const dstbytes9 int__ref)
(declare-const wireversion2 map__ref)
(declare-const current_name_length2 int__ref)
(declare-const srcbyte8 int__ref)
(declare-const siglength2 int__ref)
(declare-const sigoffset2 int__ref)
(declare-const srcnum08 t__ref)
(declare-const srcnum18 t__ref)
(declare-const srcnum28 t__ref)
(declare-const srcnum38 t__ref)
(declare-const dstnum08 t__ref)
(declare-const dstnum18 t__ref)
(declare-const dstnum28 t__ref)
(declare-const i7 int__ref)
(declare-const ans92 t__ref)
(declare-const ans93 t__ref)
(declare-const ans94 t__ref)
(declare-const ans95 t__ref)
(declare-const bytes20 (Array Int byte))
(declare-const dstbytes10 Int)
(declare-const wireversion3 (Array Int character))
(declare-const current_name_length3 Int)
(declare-const srcbyte9 Int)
(declare-const siglength3 Int)
(declare-const sigoffset3 Int)
(declare-const srcnum09 (_ BitVec 8))
(declare-const srcnum19 (_ BitVec 8))
(declare-const srcnum29 (_ BitVec 8))
(declare-const srcnum39 (_ BitVec 8))
(declare-const dstnum09 (_ BitVec 8))
(declare-const dstnum19 (_ BitVec 8))
(declare-const dstnum29 (_ BitVec 8))
(declare-const i8 Int)
(declare-const ans96 (_ BitVec 8))
(declare-const ans97 (_ BitVec 8))
(declare-const ans98 (_ BitVec 8))
(declare-const ans99 (_ BitVec 8))
...
(assert (and (= o16 (convertdomainnametowire (rec__rr_type__rrsig_record_type__rrsigrecordtype__signername (us_split_fields3 rrsig_record)))) (forall ((i9 Int)) (=> (and (<= 1 i9) (<= i9 128)) (and (<= 0 (to_rep (select o16 i9))) (<= (to_rep (select o16 i9)) 255))))))
...
(assert (= ans92 ans84))
(assert (= i7 i5))
(assert (= dstnum28 dstnum26))
(assert (= dstnum18 dstnum16))
(assert (= dstnum08 dstnum06))
(assert (= srcnum38 srcnum36))
(assert (= srcnum28 srcnum26))
(assert (= srcnum18 srcnum16))
(assert (= srcnum08 srcnum06))
(assert (= sigoffset2 (mk_int__ref sigoffset1)))
(assert (= siglength2 (mk_int__ref siglength1)))
(assert (= srcbyte8 srcbyte6))
(assert (= current_name_length2 (mk_int__ref current_name_length1)))
(assert (= wireversion2 (mk_map__ref wireversion1)))
(assert (= dstbytes9 (mk_int__ref dstbytes8)))
(assert (= bytes19 (mk_map__ref1 bytes18)))
(assert (= ans99 ans91))
(assert (= ans98 ans90))
(assert (= ans97 ans89))
(assert (= ans96 ans88))
(assert (= i8 i6))
(assert (= dstnum29 dstnum27))
(assert (= dstnum19 dstnum17))
(assert (= dstnum09 dstnum07))
(assert (= srcnum39 srcnum37))
(assert (= srcnum29 srcnum27))
(assert (= srcnum19 srcnum17))
(assert (= srcnum09 srcnum07))
(assert (= sigoffset3 sigoffset1))
(assert (= siglength3 siglength1))
(assert (= srcbyte9 srcbyte7))
(assert (= current_name_length3 current_name_length1))
(assert (= wireversion3 wireversion1))
(assert (= dstbytes10 dstbytes8))
(assert (= bytes20 bytes18))
(assert (not (<= (int__content dstbytes9) 1517)))
(check-sat)
(exit)
