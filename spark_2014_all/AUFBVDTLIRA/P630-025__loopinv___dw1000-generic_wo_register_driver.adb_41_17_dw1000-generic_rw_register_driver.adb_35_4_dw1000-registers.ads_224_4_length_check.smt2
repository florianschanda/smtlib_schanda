...
(assert (and (= temp___77362 (register_to_bytes reg)) (dynamic_invariant1 temp___77362 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___77361)) (to_rep (last4 temp___77361))) (+ (- (to_rep (last4 temp___77361)) (to_rep (first4 temp___77361))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___7736 temp___7737))
(assert (= (mk1 (to_rep (first4 temp___77361)) (to_rep (last4 temp___77361))) temp___77371))
(assert (not (= (ite (<= (to_rep (first2 temp___77371)) (to_rep (last2 temp___77371))) (+ (- (to_rep (last2 temp___77371)) (to_rep (first2 temp___77371))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
