...
(assert (= o24 (oadd o11 o23)))
(assert (= o5 (from_word32 carry2)))
(assert (and (= o4 (base Tuple0)) (= o4 (oexpon (from_word32 #x00000002) 32))))
(assert (= o6 (omultiply o4 o5)))
(assert (= o3 (from_word32 carry1)))
(assert (= o2 (from_word32 y)))
