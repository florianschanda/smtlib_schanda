...
(assert (not (<= (ite (<= (to_rep payload_as_bytes__first) (to_rep payload_as_bytes__last)) (+ (- (to_rep payload_as_bytes__last) (to_rep payload_as_bytes__first)) 1) 0) 2147483647)))
(check-sat)
(exit)
