...
(assert (not (= (ite (<= (to_rep1 (first4 temp___45401)) (to_rep1 (last4 temp___45401))) (+ (- (to_rep1 (last4 temp___45401)) (to_rep1 (first4 temp___45401))) 1) 0) (ite (<= (to_rep1 frame__first) r6b) (+ (- r6b (to_rep1 frame__first)) 1) 0))))
(check-sat)
(exit)
