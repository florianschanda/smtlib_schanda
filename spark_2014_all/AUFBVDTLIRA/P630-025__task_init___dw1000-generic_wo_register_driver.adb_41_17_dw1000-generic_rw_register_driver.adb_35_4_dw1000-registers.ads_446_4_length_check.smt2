...
(assert (and (= temp___80092 (register_to_bytes reg)) (dynamic_invariant1 temp___80092 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___80091)) (to_rep (last4 temp___80091))) (+ (- (to_rep (last4 temp___80091)) (to_rep (first4 temp___80091))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
(assert (= temp___8009 temp___8010))
(assert (= (mk1 (to_rep (first4 temp___80091)) (to_rep (last4 temp___80091))) temp___80101))
(assert (not (= (ite (<= (to_rep (first2 temp___80101)) (to_rep (last2 temp___80101))) (+ (- (to_rep (last2 temp___80101)) (to_rep (first2 temp___80101))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
