...
(declare-fun to_rep (rx_errors) Int)
(declare-fun of_rep (Int) rx_errors)
(assert (forall ((x rx_errors)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x rx_errors)) (! (in_range2 (to_rep x)) :pattern ((to_rep x)))))
(assert (forall ((x Int)) (! (=> (in_range2 x) (= (to_rep (of_rep x)) x)) :pattern ((to_rep (of_rep x))))))
(define-fun to_rep1 ((x frame_length)) Int (frame_lengthqtint x))
(declare-fun of_rep1 (Int) frame_length)
(assert (forall ((x frame_length)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x frame_length)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant ((temp___expr_4954 us_rep) (temp___is_init_4950 Bool) (temp___skip_constant_4951 Bool) (temp___do_toplevel_4952 Bool) (temp___do_typ_inv_4953 Bool)) Bool (=> (= temp___do_toplevel_4952 true) (=> (= temp___is_init_4950 true) (ite (= (to_rep (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___expr_4954))) 0) (< 0 (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4954)))) (= (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4954))) 0)))))
(define-fun dynamic_predicate ((temp___4965 us_rep)) Bool (ite (= (to_rep (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___4965))) 0) (< 0 (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4965)))) (= (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4965))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_4940 Int) (temp___is_init_4936 Bool) (temp___skip_constant_4937 Bool) (temp___do_toplevel_4938 Bool) (temp___do_typ_inv_4939 Bool)) Bool (=> (or (= temp___is_init_4936 true) (<= 0 1024)) (in_range1 temp___expr_4940)))
(define-fun dynamic_invariant3 ((temp___expr_4947 Int) (temp___is_init_4943 Bool) (temp___skip_constant_4944 Bool) (temp___do_toplevel_4945 Bool) (temp___do_typ_inv_4946 Bool)) Bool (=> (or (= temp___is_init_4943 true) (<= 0 5)) (in_range2 temp___expr_4947)))
(define-fun dynamic_invariant4 ((temp___expr_4973 (_ BitVec 8)) (temp___is_init_4969 Bool) (temp___skip_constant_4970 Bool) (temp___do_toplevel_4971 Bool) (temp___do_typ_inv_4972 Bool)) Bool (=> (or (= temp___is_init_4969 true) (bvule #x00 #x01)) (in_range4 temp___expr_4973)))
...
(define-fun dynamic_invariant5 ((temp___expr_5008 us_rep1) (temp___is_init_5004 Bool) (temp___skip_constant_5005 Bool) (temp___do_toplevel_5006 Bool) (temp___do_typ_inv_5007 Bool)) Bool (forall ((temp___5009 (_ BitVec 8))) (=> (and (bvule #x00 temp___5009) (bvule temp___5009 #x01)) (let ((temp___5010 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_5008)) temp___5009))) (ite (= (to_rep (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___5010))) 0) (< 0 (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___5010)))) (= (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___5010))) 0))))))
(declare-const rliteral frame_length)
(assert (= (frame_lengthqtint rliteral) 0))
(define-fun default_initial_assumption ((temp___expr_5012 us_rep1) (temp___skip_top_level_5013 Bool)) Bool (and (and (and (and (= (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_5012)) (temp_____aggregate_def_5014 (mk___rep (mk___split_fields rliteral (temp_____aggregate_def_5018 #x00) (of_rep 0) (distinct 0 0))))) (= (to_rep4 (rec__decadriver__receiver_type__queue_head (us_split_fields3 temp___expr_5012))) #x01)) (= (to_rep3 (rec__decadriver__receiver_type__rx_count (us_split_fields3 temp___expr_5012))) 0)) (= (rec__decadriver__receiver_type__overrun_occurred (us_split_fields3 temp___expr_5012)) (distinct 0 0))) (= (rec__decadriver__receiver_type__frame_ready (us_split_fields3 temp___expr_5012)) (distinct 0 0))))
(assert (forall ((temp___5016 us_rep)) (=> (dynamic_invariant temp___5016 true true true true) (forall ((temp___5017 (_ BitVec 8))) (= (select (temp_____aggregate_def_5014 temp___5016) temp___5017) temp___5016)))))
...
(assert (forall ((temp___5020 (_ BitVec 8))) (=> (dynamic_invariant6 temp___5020 true true true true) (forall ((temp___5021 Int)) (= (to_rep2 (select (temp_____aggregate_def_5018 temp___5020) temp___5021)) temp___5020)))))
(declare-const self__ us_rep1)
(declare-const o rx_errors)
(declare-const o1 frame_length)
(declare-const o2 (Array Int bits_8))
(declare-const o3 rx_errors)
(declare-const o4 Bool)
(declare-const temp___5080 frame_length)
(declare-const temp___50801 (Array Int bits_8))
(declare-const temp___50802 rx_errors)
(declare-const temp___50803 Bool)
(assert (= (to_rep o) 0))
(assert (= rliteral o1))
(assert (= (temp_____aggregate_def_5018 #x00) o2))
(assert (= o o3))
(assert (= (distinct 0 0) o4))
(assert (= temp___5080 o1))
(assert (= temp___50801 o2))
(assert (= temp___50802 o3))
(assert (= temp___50803 o4))
(assert (not (dynamic_predicate (mk___rep (mk___split_fields temp___5080 temp___50801 temp___50802 temp___50803)))))
(check-sat)
(exit)
