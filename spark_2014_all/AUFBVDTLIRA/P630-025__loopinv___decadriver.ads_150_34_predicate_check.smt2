...
(declare-fun to_rep (frame_length) Int)
(declare-fun of_rep (Int) frame_length)
(assert (forall ((x frame_length)) (! (= (of_rep (to_rep x)) x) :pattern ((to_rep x)))))
(assert (forall ((x frame_length)) (! (in_range1 (to_rep x)) :pattern ((to_rep x)))))
...
(assert (forall ((x rx_errors)) (! (in_range2 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(define-fun dynamic_invariant ((temp___expr_4894 us_rep) (temp___is_init_4890 Bool) (temp___skip_constant_4891 Bool) (temp___do_toplevel_4892 Bool) (temp___do_typ_inv_4893 Bool)) Bool (=> (= temp___do_toplevel_4892 true) (=> (= temp___is_init_4890 true) (ite (= (to_rep1 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___expr_4894))) 0) (< 0 (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4894)))) (= (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4894))) 0)))))
(define-fun dynamic_predicate ((temp___4905 us_rep)) Bool (ite (= (to_rep1 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___4905))) 0) (< 0 (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4905)))) (= (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4905))) 0)))
...
(define-fun in_range4 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x01)))
...
(define-fun dynamic_invariant2 ((temp___expr_4880 Int) (temp___is_init_4876 Bool) (temp___skip_constant_4877 Bool) (temp___do_toplevel_4878 Bool) (temp___do_typ_inv_4879 Bool)) Bool (=> (or (= temp___is_init_4876 true) (<= 0 1024)) (in_range1 temp___expr_4880)))
(define-fun dynamic_invariant3 ((temp___expr_4887 Int) (temp___is_init_4883 Bool) (temp___skip_constant_4884 Bool) (temp___do_toplevel_4885 Bool) (temp___do_typ_inv_4886 Bool)) Bool (=> (or (= temp___is_init_4883 true) (<= 0 5)) (in_range2 temp___expr_4887)))
(define-fun dynamic_invariant4 ((temp___expr_4913 (_ BitVec 8)) (temp___is_init_4909 Bool) (temp___skip_constant_4910 Bool) (temp___do_toplevel_4911 Bool) (temp___do_typ_inv_4912 Bool)) Bool (=> (or (= temp___is_init_4909 true) (bvule #x00 #x01)) (in_range4 temp___expr_4913)))
...
(assert (forall ((x rx_frame_queue_index)) (! (in_range4 (to_rep4 x)) :pattern ((to_rep4 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x02))) (=> (in_range4 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
...
(define-fun dynamic_invariant5 ((temp___expr_4948 us_rep1) (temp___is_init_4944 Bool) (temp___skip_constant_4945 Bool) (temp___do_toplevel_4946 Bool) (temp___do_typ_inv_4947 Bool)) Bool (forall ((temp___4949 (_ BitVec 8))) (=> (and (bvule #x00 temp___4949) (bvule temp___4949 #x01)) (let ((temp___4950 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_4948)) temp___4949))) (ite (= (to_rep1 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___4950))) 0) (< 0 (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4950)))) (= (to_rep (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4950))) 0))))))
(define-fun default_initial_assumption ((temp___expr_4952 us_rep1) (temp___skip_top_level_4953 Bool)) Bool (and (and (and (and (= (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_4952)) (temp___4954 (mk___rep (mk___split_fields (of_rep 0) (temp___4958 #x00) (of_rep1 0) (distinct 0 0))))) (= (to_rep4 (rec__decadriver__receiver_type__queue_head (us_split_fields3 temp___expr_4952))) #x01)) (= (to_rep3 (rec__decadriver__receiver_type__rx_count (us_split_fields3 temp___expr_4952))) 0)) (= (rec__decadriver__receiver_type__overrun_occurred (us_split_fields3 temp___expr_4952)) (distinct 0 0))) (= (rec__decadriver__receiver_type__frame_ready (us_split_fields3 temp___expr_4952)) (distinct 0 0))))
(assert (forall ((temp___4956 us_rep)) (=> (dynamic_invariant temp___4956 true true true true) (forall ((temp___4957 (_ BitVec 8))) (= (select (temp___4954 temp___4956) temp___4957) temp___4956)))))
...
(assert (forall ((temp___4960 (_ BitVec 8))) (=> (dynamic_invariant6 temp___4960 true true true true) (forall ((temp___4961 Int)) (= (to_rep2 (select (temp___4958 temp___4960) temp___4961)) temp___4960)))))
(declare-const self__ us_rep1)
(declare-const o rx_errors)
(declare-const o1 frame_length)
(declare-const o2 frame_length)
(declare-const o3 (Array Int bits_8))
(declare-const o4 rx_errors)
(declare-const o5 Bool)
(declare-const temp___5020 frame_length)
(declare-const temp___50201 (Array Int bits_8))
(declare-const temp___50202 rx_errors)
(declare-const temp___50203 Bool)
(assert (= (to_rep1 o) 0))
(assert (= (to_rep o1) 0))
(assert (= o1 o2))
(assert (= (temp___4958 #x00) o3))
(assert (= o o4))
(assert (= (distinct 0 0) o5))
(assert (= temp___5020 o2))
(assert (= temp___50201 o3))
(assert (= temp___50202 o4))
(assert (= temp___50203 o5))
(assert (not (dynamic_predicate (mk___rep (mk___split_fields temp___5020 temp___50201 temp___50202 temp___50203)))))
(check-sat)
(exit)
