...
(assert (or (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) digit_index3)) ((_ int2bv 8) 0))) (exists ((j1 Int)) (and (and (<= (+ i2 1) j1) (<= j1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j1)) ((_ int2bv 8) 0)))))))
(assert (=> (< digit_index3 i2) (forall ((j1 Int)) (=> (and (<= (+ digit_index3 1) j1) (<= j1 i2)) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j1)) ((_ int2bv 8) 0))))))
...
(assert (and (= o4 (+ digit_index3 1)) (in_range1 (+ digit_index3 1))))
(assert (= o5 (ite (<= o4 j) true false)))
(assert (= result4 (ite (= o5 true) (ite (<= j i2) true false) false)))
(assert (= result4 true))
