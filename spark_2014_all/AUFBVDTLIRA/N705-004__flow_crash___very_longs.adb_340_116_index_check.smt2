...
(assert (and (= o7 (+ digit_index3 1)) (in_range1 (+ digit_index3 1))))
(assert (= o8 (ite (<= o7 j1) true false)))
(assert (= result5 (ite (= o8 true) (ite (<= j1 i3) true false) false)))
(assert (= result5 true))
(assert (not (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) j1)))
(check-sat)
(exit)
