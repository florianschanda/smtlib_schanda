...
(assert (forall ((subject Int)) (=> (and (<= 0 subject) (<= subject 0)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject Int)) (=> (and (<= 1 subject) (<= subject 1)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject Int)) (=> (and (<= 2 subject) (<= subject 2)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject Int)) (=> (and (<= 3 subject) (<= subject 3)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject Int)) (=> (and (<= 4 subject) (<= subject 4)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject Int)) (=> (and (<= 5 subject) (<= subject 5)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
(assert (forall ((subject Int)) (=> (and (<= 6 subject) (<= subject 6)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))))
