...
(assert (= (ite (<= (to_rep2 (first2 temp___9091)) (to_rep2 (last2 temp___9091))) (+ (- (to_rep2 (last2 temp___9091)) (to_rep2 (first2 temp___9091))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
...
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___9121 temp___9122))))
(assert (= result____split_discrs (mk___split_discrs temp___912)))
...
(assert (and (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields3) false true true) (forall ((temp___923 Int)) (=> (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))) temp___923) (<= temp___923 (to_rep2 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields3)))))) (=> (<= i2 temp___923) (= (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields3)) temp___923) (select (elts1 (rec__very_longs__very_long__long_digits1 result____split_fields2)) temp___923)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
