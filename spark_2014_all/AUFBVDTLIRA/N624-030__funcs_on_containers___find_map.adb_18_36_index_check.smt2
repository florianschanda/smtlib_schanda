...
(assert (=> (= result5 true) (and (= o12 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o11)) (and (in_range5 o12) (= o12 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o11))))))
...
(assert (=> (= result5 true) (and (= o8 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o7)) (and (in_range5 o8) (= o8 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o7))))))
(assert (=> (= result5 true) (= o14 (ite (<= (to_rep1 (first (rt a))) o8) true false))))
