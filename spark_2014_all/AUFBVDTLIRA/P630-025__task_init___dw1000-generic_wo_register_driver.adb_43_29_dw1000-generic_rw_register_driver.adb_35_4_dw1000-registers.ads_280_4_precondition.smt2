...
(assert (= (ite (<= (to_rep (first4 temp___85721)) (to_rep (last4 temp___85721))) (+ (- (to_rep (last4 temp___85721)) (to_rep (first4 temp___85721))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8572 temp___8573))
(assert (= (mk1 (to_rep (first4 temp___85721)) (to_rep (last4 temp___85721))) temp___85731))
(assert (= (ite (<= (to_rep (first2 temp___85731)) (to_rep (last2 temp___85731))) (+ (- (to_rep (last2 temp___85731)) (to_rep (first2 temp___85731))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8573 temp___85731)))
(assert (= o2 o))
