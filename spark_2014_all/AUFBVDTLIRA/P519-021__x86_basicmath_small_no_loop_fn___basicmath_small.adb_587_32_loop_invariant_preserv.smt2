...
(assert (= result108 (mk_bool__ref zeroflag23)))
(assert (= zeroflag24 o155))
(assert (and (= o156 (ebx (let ((subject rbx)) rbx24))) (= o156 (readreg32 (let ((subject rbx)) rbx24)))))
...
(assert (= result109 (mk_bool__ref signflag23)))
(assert (= signflag24 o159))
(assert (and (= o160 (ebx (let ((subject rbx)) rbx24))) (= o160 (readreg32 (let ((subject rbx)) rbx24)))))
...
(assert (= result113 (mk_bool__ref overflowflag23)))
(assert (= overflowflag24 o169))
(assert (not (= zeroflag24 true)))
(assert (= (to_int5 signflag24) (to_int5 overflowflag24)))
(assert (= rdi30 (let ((subject rdi)) (mk_t__ref3 rdi29))))
(assert (= rbp25 (let ((subject rbp)) (mk_t__ref3 rbp24))))
(assert (= rsp56 (let ((subject rsp)) (mk_t__ref3 rsp55))))
(assert (= rbx25 (let ((subject rbx)) (mk_t__ref3 rbx24))))
(assert (= rax20 (mk_t__ref3 rax19)))
(assert (= xmm025 (mk_t__ref3 xmm024)))
(assert (= overflowflag25 (mk_bool__ref overflowflag24)))
(assert (= signflag25 (mk_bool__ref signflag24)))
(assert (= carryflag25 (mk_bool__ref carryflag24)))
(assert (= zeroflag25 (mk_bool__ref zeroflag24)))
(assert (= rdi31 rdi29))
(assert (= rbp26 rbp24))
(assert (= rsp57 rsp55))
(assert (= rbx26 rbx24))
(assert (= rax21 rax19))
(assert (= xmm026 xmm024))
(assert (= overflowflag26 overflowflag24))
(assert (= signflag26 signflag24))
(assert (= carryflag26 carryflag24))
(assert (= zeroflag26 zeroflag24))
(assert (not (= (t__content3 rsp56) (let ((subject rsp)) rsp52))))
(check-sat)
(exit)
