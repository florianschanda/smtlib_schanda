...
(assert (and (= o93 (readmem32 o92 (let ((subject memory)) memory10))) (and (and (and (= (bvand o93 ((_ int2bv 32) 255)) ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory10) o92)))) (= (bvand o93 ((_ int2bv 32) 65280)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory10) (bvadd o92 ((_ int2bv 64) 1))))) ((_ int2bv 32) 256)))) (= (bvand o93 ((_ int2bv 32) 16711680)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory10) (bvadd o92 ((_ int2bv 64) 2))))) ((_ int2bv 32) 65536)))) (= (bvand o93 ((_ int2bv 32) 4278190080)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory10) (bvadd o92 ((_ int2bv 64) 3))))) ((_ int2bv 32) 16777216))))))
(assert (= (writereg32post rdx1 o93) true))
(assert (= (writereg32post (let ((subject rsi)) rsi8) ((_ int2bv 32) 1072497001)) true))
(assert (= (writereg32post (let ((subject rdi)) rdi17) ((_ int2bv 32) 4198720)) true))
...
(assert (= (writereg32post (let ((subject rdi)) rdi18) ((_ int2bv 32) 4198584)) true))
...
(assert (and (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (and (and (and (and (and (and (and (not (= i (let ((subject rsp)) rsp46))) (not (= i (bvadd (let ((subject rsp)) rsp46) ((_ int2bv 64) 1))))) (not (= i (bvadd (let ((subject rsp)) rsp46) ((_ int2bv 64) 2))))) (not (= i (bvadd (let ((subject rsp)) rsp46) ((_ int2bv 64) 3))))) (not (= i (bvadd (let ((subject rsp)) rsp46) ((_ int2bv 64) 4))))) (not (= i (bvadd (let ((subject rsp)) rsp46) ((_ int2bv 64) 5))))) (not (= i (bvadd (let ((subject rsp)) rsp46) ((_ int2bv 64) 6))))) (not (= i (bvadd (let ((subject rsp)) rsp46) ((_ int2bv 64) 7))))) (= (to_rep (select (let ((subject memory)) memory11) i)) (to_rep (select (let ((subject memory)) memory10) i)))))) (= (let ((subject rsp)) rsp46) (let ((subject rsp)) rsp45))))
(assert (= (writereg32post (let ((subject rdi)) rdi19) ((_ int2bv 32) 4198736)) true))
(assert (= (writereg32post (let ((subject rbx)) rbx8) ((_ int2bv 32) 361)) true))
(assert (= result86 (let ((subject rsp)) (mk_t__ref3 rsp46))))
(assert (= (let ((subject rsp)) rsp47) (bvsub (let ((subject rsp)) rsp46) ((_ int2bv 64) 8))))
...
(assert (= (let ((subject rsp)) rsp51) (bvadd (let ((subject rsp)) rsp50) ((_ int2bv 64) 8))))
...
(assert (= (let ((subject rsp)) rsp56) (bvadd (let ((subject rsp)) rsp55) ((_ int2bv 64) 8))))
(assert (= result101 (let ((subject rsp)) (mk_t__ref3 rsp56))))
(assert (= (let ((subject rsp)) rsp57) (bvadd (let ((subject rsp)) rsp56) ((_ int2bv 64) 8))))
