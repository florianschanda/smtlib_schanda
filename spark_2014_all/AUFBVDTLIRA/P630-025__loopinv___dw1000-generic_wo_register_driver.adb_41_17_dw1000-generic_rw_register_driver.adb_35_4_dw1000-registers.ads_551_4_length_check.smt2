...
(define-fun dynamic_invariant ((temp___expr_6635 us_t1) (temp___is_init_6632 Bool) (temp___skip_constant_6633 Bool) (temp___do_toplevel_6634 Bool)) Bool (=> (not (= temp___skip_constant_6633 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6635) (last3 temp___expr_6635)) (and (= (first3 temp___expr_6635) 1) (= (last3 temp___expr_6635) 1)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_6655 us_t2) (temp___is_init_6652 Bool) (temp___skip_constant_6653 Bool) (temp___do_toplevel_6654 Bool)) Bool (=> (not (= temp___skip_constant_6653 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6655) (last5 temp___expr_6655)) (and (= (first5 temp___expr_6655) 1) (= (last5 temp___expr_6655) 1)))))
...
(assert (and (= temp___81412 (register_to_bytes reg)) (dynamic_invariant1 temp___81412 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___81411)) (to_rep (last4 temp___81411))) (+ (- (to_rep (last4 temp___81411)) (to_rep (first4 temp___81411))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8141 temp___8142))
(assert (= (mk1 (to_rep (first4 temp___81411)) (to_rep (last4 temp___81411))) temp___81421))
(assert (not (= (ite (<= (to_rep (first2 temp___81421)) (to_rep (last2 temp___81421))) (+ (- (to_rep (last2 temp___81421)) (to_rep (first2 temp___81421))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
