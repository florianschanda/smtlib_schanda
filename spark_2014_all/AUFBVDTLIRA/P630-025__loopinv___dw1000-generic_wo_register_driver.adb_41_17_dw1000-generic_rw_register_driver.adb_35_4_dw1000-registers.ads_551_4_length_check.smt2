...
(define-fun register_type__ref___194__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___136__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___136__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_7298 us_t1) (temp___is_init_7294 Bool) (temp___skip_constant_7295 Bool) (temp___do_toplevel_7296 Bool) (temp___do_typ_inv_7297 Bool)) Bool (=> (not (= temp___skip_constant_7295 true)) (and (dynamic_property2 1 1 (first3 temp___expr_7298) (last3 temp___expr_7298)) (and (= (first3 temp___expr_7298) 1) (= (last3 temp___expr_7298) 1)))))
(declare-sort t2 0)
...
(define-fun target__ref___59__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___59__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_7320 us_t2) (temp___is_init_7316 Bool) (temp___skip_constant_7317 Bool) (temp___do_toplevel_7318 Bool) (temp___do_typ_inv_7319 Bool)) Bool (=> (not (= temp___skip_constant_7317 true)) (and (dynamic_property3 1 1 (first5 temp___expr_7320) (last5 temp___expr_7320)) (and (= (first5 temp___expr_7320) 1) (= (last5 temp___expr_7320) 1)))))
...
(declare-const temp___8913 (Array Int bits_8))
(declare-const temp___89131 t2)
(declare-const temp___8914 (Array Int bits_8))
(declare-const temp___89141 t1)
(define-fun temp___89132 () us_t2 (mk___t2 temp___8913 temp___89131))
...
(assert (and (= temp___89132 (register_to_bytes reg)) (dynamic_invariant1 temp___89132 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___89131)) (to_rep (last4 temp___89131))) (+ (- (to_rep (last4 temp___89131)) (to_rep (first4 temp___89131))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8913 temp___8914))
(assert (= (mk1 (to_rep (first4 temp___89131)) (to_rep (last4 temp___89131))) temp___89141))
(assert (not (= (ite (<= (to_rep (first2 temp___89141)) (to_rep (last2 temp___89141))) (+ (- (to_rep (last2 temp___89141)) (to_rep (first2 temp___89141))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
