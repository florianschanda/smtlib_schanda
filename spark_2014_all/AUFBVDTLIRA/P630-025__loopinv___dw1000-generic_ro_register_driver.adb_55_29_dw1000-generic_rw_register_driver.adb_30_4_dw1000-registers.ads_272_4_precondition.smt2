...
(define-fun dynamic_invariant ((temp___expr_3060 us_t1) (temp___is_init_3057 Bool) (temp___skip_constant_3058 Bool) (temp___do_toplevel_3059 Bool)) Bool (=> (not (= temp___skip_constant_3058 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3060) (last3 temp___expr_3060)) (and (= (first3 temp___expr_3060) 1) (= (last3 temp___expr_3060) 4)))))
