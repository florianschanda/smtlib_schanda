...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o101 k)) #x00000000))))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (omod (oadd (num_of_big_int (mk___t o102 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o102 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true)))
...
(assert (= a_msw3 o37))
(assert (= o98 (from_word32 #x00000001)))
(assert (and (= o92 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o93 (+ o92 1)))
(assert (and (= o94 o93) (in_range1 o93)))
(assert (and (= o95 o94) (in_range2 o94)))
(assert (= o96 (num_of_big_int m m_first o95)))
(assert (= o91 (from_word32 #x00000002)))
(assert (= o97 (omultiply o91 o96)))
(assert (= o99 (osubtract o97 o98)))
(assert (= o88 (from_word32 a_msw3)))
(assert (and (= o83 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o84 (+ o83 1)))
(assert (and (= o85 o84) (in_range1 o84)))
(assert (and (= o86 o85) (in_range2 o85)))
(assert (and (= o82 (base Tuple0)) (= o82 (oexpon (from_word32 #x00000002) 32))))
(assert (= o87 (oexpon o82 o86)))
(assert (= o89 (omultiply o87 o88)))
(assert (and (= o77 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o78 (+ o77 1)))
(assert (and (= o79 o78) (in_range1 o78)))
(assert (and (= o80 o79) (in_range2 o79)))
(assert (= o81 (num_of_big_int (mk___t o105 (mk (to_rep a__first) (to_rep a__last))) a_first o80)))
(assert (= o90 (oadd o81 o89)))
(assert (= o100 (olt o90 o99)))
(assert (and (= o71 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o72 (+ o71 1)))
(assert (and (= o73 o72) (in_range1 o72)))
(assert (and (= o74 o73) (in_range2 o73)))
(assert (= o75 (num_of_big_int m m_first o74)))
(assert (and (= o65 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o66 (- o65 a_first)))
(assert (and (= o67 o66) (in_range1 o66)))
(assert (and (= o68 o67) (in_range2 o67)))
(assert (and (= o63 (base Tuple0)) (= o63 (oexpon (from_word32 #x00000002) 32))))
