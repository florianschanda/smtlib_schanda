...
(assert (= a_msw3 o37))
(assert (= o98 (from_word32 ((_ int2bv 32) 1))))
...
(assert (= o91 (from_word32 ((_ int2bv 32) 2))))
...
(assert (and (= o82 (base Tuple0)) (= o82 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
(assert (= o81 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first o80)))
...
(assert (and (= o63 (base Tuple0)) (= o63 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
