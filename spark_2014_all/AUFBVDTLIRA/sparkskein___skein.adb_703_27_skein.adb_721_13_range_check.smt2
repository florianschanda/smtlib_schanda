...
(assert (= o5 (to_rep o4)))
(assert (= (to_rep o6) o5))
(assert (= temp___1527 (store ctx__split_fields11 dst1 o6)))
(assert (dynamic_predicate1 temp___1527))
(assert (= o7 temp___1527))
...
(assert (= temp___1529 (mk___rep2 o8)))
