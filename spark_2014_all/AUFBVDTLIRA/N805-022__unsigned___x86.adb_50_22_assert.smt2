...
(assert (= xsi3 result3))
(assert (= xsi4 o7))
(assert (= (bvadd ((_ zero_extend 24) (to_rep (select xsi4 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 1))) ((_ int2bv 32) 256))) (bvurem val__ ((_ int2bv 32) 65536))))
(assert (not (= (bvadd ((_ zero_extend 24) (to_rep (select xsi4 2))) (bvmul ((_ zero_extend 24) (to_rep (select xsi4 3))) ((_ int2bv 32) 256))) (bvurem (bvudiv val__ ((_ int2bv 32) 65536)) ((_ int2bv 32) 65536)))))
(check-sat)
(exit)
