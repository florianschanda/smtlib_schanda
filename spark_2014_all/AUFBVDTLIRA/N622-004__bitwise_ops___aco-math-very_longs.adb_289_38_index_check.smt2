...
(define-fun dynamic_invariant4 ((temp___expr_829 us_rep1) (temp___is_init_825 Bool) (temp___skip_constant_826 Bool) (temp___do_toplevel_827 Bool) (temp___do_typ_inv_828 Bool)) Bool (and (=> (not (= temp___skip_constant_826 true)) (in_range4 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (to_base temp___expr_829))) (and (dynamic_property3 1 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_829))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_829)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_829))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_829))) (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))))))))
(define-fun default_initial_assumption ((temp___expr_832 us_rep1) (temp___skip_top_level_833 Bool)) Bool (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_832))) (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))))
...
(declare-fun temp___1316 ((_ BitVec 8) Int Int) us_t2)
(declare-sort t3 0)
...
(assert (forall ((temp___1318 (_ BitVec 8))) (forall ((temp___1319 Int) (temp___1320 Int)) (let ((temp___1317 (temp___1316 temp___1318 temp___1319 temp___1320))) (=> (dynamic_invariant1 temp___1318 true true true true) (and (=> (dynamic_property6 1 2147483647 temp___1319 temp___1320) (and (= (first5 temp___1317) temp___1319) (= (last5 temp___1317) temp___1320))) (forall ((temp___1321 Int)) (= (to_rep (select (to_array2 temp___1317) temp___1321)) temp___1318))))))))
(define-fun dynamic_invariant5 ((temp___expr_302 Int) (temp___is_init_298 Bool) (temp___skip_constant_299 Bool) (temp___do_toplevel_300 Bool) (temp___do_typ_inv_301 Bool)) Bool (=> (or (= temp___is_init_298 true) (<= 1 2147483647)) (in_range3 temp___expr_302)))
...
(assert (= (to_rep2 (first4 (rt2 (temp___1316 #x00 1 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1316 #x00 1 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))))))) (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))))
(assert (= (mk___t2 temp___1323 temp___13231) (temp___1316 #x00 1 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))))))
(assert (= (ite (<= (to_rep2 (first4 temp___13231)) (to_rep2 (last4 temp___13231))) (+ (- (to_rep2 (last4 temp___13231)) (to_rep2 (first4 temp___13231))) 1) 0) (ite (<= 1 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))) (+ (- (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) 1) 1) 0)))
...
(assert (= r_digit1 o12))
(assert (and (= o13 (+ i2 j2)) (in_range2 (+ i2 j2))))
(assert (= temp___1331 (- o13 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1331) (<= temp___1331 (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))))))
(assert (= o14 temp___1331))
...
(assert (and (= o18 (+ i2 j2)) (in_range2 (+ i2 j2))))
(assert (= temp___1333 (- o18 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1333)))
(check-sat)
(exit)
