...
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (us_split_discrs2 a) (mk___split_fields (let ((temp___185 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 a)))) (of_array (to_array1 temp___185) (first3 temp___185) (last3 temp___185))))))
(define-fun of_base ((r1 us_rep)) us_rep1 (mk___rep1 (us_split_discrs1 r1) (mk___split_fields1 (let ((temp___184 (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r1)))) (of_array1 (to_array temp___184) (first1 temp___184) (last1 temp___184))))))
...
(define-fun dynamic_invariant4 ((temp___expr_765 us_rep1) (temp___is_init_762 Bool) (temp___skip_constant_763 Bool) (temp___do_toplevel_764 Bool)) Bool (and (=> (not (= temp___skip_constant_763 true)) (in_range4 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (to_base temp___expr_765))) (and (dynamic_property3 1 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_765))) (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_765)))) (and (= (first3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_765))) 1) (= (last3 (rec__aco__math__very_longs__very_long__long_digits1 (us_split_fields3 temp___expr_765))) (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))))))))
(define-fun default_initial_assumption ((temp___expr_768 us_rep1) (temp___skip_top_level_769 Bool)) Bool (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs2 temp___expr_768))) (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))))
...
(declare-fun temp___1231 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___1233 (_ BitVec 8))) (forall ((temp___1234 Int) (temp___1235 Int)) (let ((temp___1232 (temp___1231 temp___1233 temp___1234 temp___1235))) (and (=> (dynamic_property6 1 2147483647 temp___1234 temp___1235) (and (= (first5 temp___1232) temp___1234) (= (last5 temp___1232) temp___1235))) (forall ((temp___1236 Int)) (= (select (to_array2 temp___1232) temp___1236) (of_rep temp___1233))))))))
(define-fun dynamic_invariant5 ((temp___expr_271 Int) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (=> (or (= temp___is_init_268 true) (<= 1 2147483647)) (in_range3 temp___expr_271)))
...
(declare-const temp___1238 (Array Int octet))
(declare-const temp___12381 t2)
(declare-const temp___1239 (Array Int octet))
(declare-const temp___12391 t1)
(declare-const o1 (Array Int octet))
(declare-const o2 t1)
(declare-const o3 (Array Int octet))
(declare-const o4 t1)
(declare-const temp___1242 digit_index_type)
(declare-const temp___12421 (Array Int octet))
(declare-const temp___12422 t1)
(declare-const temp___1272 (_ BitVec 16))
(declare-const temp___1271 (_ BitVec 16))
(declare-const temp___1270 (_ BitVec 16))
(declare-const temp___1267 us_rep1)
(declare-const temp___1266 (_ BitVec 16))
(declare-const temp___1265 (_ BitVec 16))
(declare-const temp___1258 (_ BitVec 16))
(declare-const temp___1257 (_ BitVec 16))
(declare-const temp___1256 (_ BitVec 16))
(declare-const temp___1253 us_rep1)
(declare-const temp___1252 (_ BitVec 16))
(declare-const temp___1251 (_ BitVec 16))
...
(declare-const temp___1250 us_rep1)
(declare-const o25 (_ BitVec 16))
(declare-const temp___1262 Int)
...
(declare-const temp___1264 us_rep1)
...
(assert (dynamic_invariant3 l true false true))
(assert (dynamic_invariant3 r true false true))
(assert (and (= us (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (in_range3 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))))
(assert (and (= us1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range3 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(assert (and (= o (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))) (in_range2 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))))))
(assert (and (= us2 o) (in_range3 o)))
(assert (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))))
...
(assert true)
(assert true)
(assert (= (to_rep2 (first4 (rt2 (temp___1231 ((_ int2bv 8) 0) 1 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))))))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1231 ((_ int2bv 8) 0) 1 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))))))) (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))))
(assert (= (mk___t2 temp___1238 temp___12381) (temp___1231 ((_ int2bv 8) 0) 1 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))))))
(assert (= (ite (<= (to_rep2 (first4 temp___12381)) (to_rep2 (last4 temp___12381))) (+ (- (to_rep2 (last4 temp___12381)) (to_rep2 (first4 temp___12381))) 1) 0) (ite (<= 1 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))) (+ (- (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) 1) 1) 0)))
(assert (= temp___1238 temp___1239))
(assert (= (mk1 (to_rep2 (first4 temp___12381)) (to_rep2 (last4 temp___12381))) temp___12391))
(assert (= (ite (<= (to_rep2 (first2 temp___12391)) (to_rep2 (last2 temp___12391))) (+ (- (to_rep2 (last2 temp___12391)) (to_rep2 (first2 temp___12391))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
(assert (= (mk___t1 o1 o2) (mk___t1 temp___1239 temp___12391)))
(assert (= o3 o1))
(assert (= o4 o2))
(assert (= result____split_discrs (mk___split_discrs temp___1242)))
(assert (= temp___12421 o3))
(assert (= temp___12422 o4))
(assert (= result (mk___split_fields__ref1 (mk___split_fields1 (mk___t1 result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___12421 temp___12422))))
(assert (= result____split_discrs (mk___split_discrs temp___1242)))
(assert (= result1 (mk_int__ref j)))
(assert (= j1 1))
(assert (<= 1 j1))
(assert (<= j1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r)))))))
(assert (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields3) false true true) (and (<= 1 j2) (<= j2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r)))))))))
(assert (= result2 (mk_t__ref1 carry2)))
(assert (= carry3 ((_ int2bv 16) 0)))
(assert (= result3 (mk_int__ref i2)))
(assert (= i3 1))
(assert (<= 1 i3))
(assert (<= i3 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))
(assert (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields4) false true true) (and (<= 1 i4) (<= i4 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
(assert (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))) i4) (<= i4 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))))))
(assert (= o5 i4))
(assert (= o6 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))) o5)))
(assert (= o7 (to_rep o6)))
(assert (= o8 ((_ zero_extend 8) o7)))
(assert (= result4 (mk_t__ref1 l_digit3)))
(assert (= l_digit4 o8))
(assert (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))))) j2) (<= j2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))))))))
(assert (= o9 j2))
(assert (= o10 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))) o9)))
(assert (= o11 (to_rep o10)))
(assert (= o12 ((_ zero_extend 8) o11)))
(assert (= result5 (mk_t__ref1 r_digit3)))
(assert (= r_digit4 o12))
(assert (and (= o13 (+ i4 j2)) (in_range2 (+ i4 j2))))
(assert (= temp___1246 (- o13 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1246) (<= temp___1246 (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))))))
(assert (= o14 temp___1246))
(assert (= o15 (select (elts1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)) o14)))
(assert (= o16 (to_rep o15)))
(assert (= o17 ((_ zero_extend 8) o16)))
(assert (= result6 (mk_t__ref1 t_digit3)))
(assert (= t_digit4 o17))
(assert (= result7 (mk_t__ref1 temp3)))
(assert (= temp4 (bvadd (bvadd (bvmul l_digit4 r_digit4) t_digit4) carry4)))
(assert (= o19 (takelsb_from16 temp4)))
(assert (= (to_rep o20) o19))
(assert (and (= o18 (+ i4 j2)) (in_range2 (+ i4 j2))))
(assert (= temp___1248 (- o18 1)))
(assert (not (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1248)))
(check-sat)
(exit)
