...
(assert (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields3) false true true true) (and (<= 1 j2) (<= j2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r)))))))))
(assert (= result2 (mk_t__ref1 carry)))
(assert (= carry1 #x0000))
(assert (= result3 (mk_int__ref i)))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))
(assert (and (dynamic_invariant4 (mk___rep1 result____split_discrs result____split_fields4) false true true true) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
(assert (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))))))
(assert (= o5 i2))
...
(assert (= result4 (mk_t__ref1 l_digit)))
(assert (= l_digit1 o8))
...
(assert (= result5 (mk_t__ref1 r_digit)))
(assert (= r_digit1 o12))
(assert (and (= o13 (+ i2 j2)) (in_range3 (+ i2 j2))))
(assert (= temp___1335 (- o13 1)))
(assert (and (<= (to_rep2 (first2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1335) (<= temp___1335 (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))))))
(assert (= o14 temp___1335))
...
(assert (= result6 (mk_t__ref1 t_digit)))
(assert (= t_digit1 o17))
(assert (= result7 (mk_t__ref1 temp)))
(assert (= temp1 (bvadd (bvadd (bvmul l_digit1 r_digit1) t_digit1) carry2)))
(assert (= o19 (takelsb_from16 temp1)))
(assert (= (to_rep1 o20) o19))
(assert (and (= o18 (+ i2 j2)) (in_range3 (+ i2 j2))))
(assert (= temp___1337 (- o18 1)))
(assert (not (<= temp___1337 (to_rep2 (last2 (rt1 (rec__aco__math__very_longs__very_long__long_digits1 result____split_fields4)))))))
(check-sat)
(exit)
