...
(assert (= o18 o16))
(assert (= o19 o17))
(assert (= temp___1238 (mk___rep result____split_discrs (mk___split_fields (mk___t o18 o19)))))
(assert (= result8 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1238)))
(assert (= result____split_discrs (us_split_discrs1 temp___1238)))
