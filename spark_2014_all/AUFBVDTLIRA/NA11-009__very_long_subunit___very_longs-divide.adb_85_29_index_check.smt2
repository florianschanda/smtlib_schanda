...
(declare-const o16 t)
(declare-const temp___1285 digit_index_type)
(declare-const temp___12851 (Array Int octet))
(declare-const temp___12852 t)
...
(assert (<= 1 i1))
(assert (<= i1 r120b))
(assert (and (and (dynamic_invariant1 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true true) (forall ((temp___1292 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1292) (<= temp___1292 (to_rep1 (last number__split_fields3)))) (=> (<= i2 temp___1292) (= (select number__split_fields2 temp___1292) (select number__split_fields temp___1292)))))) (and (<= 1 i2) (<= i2 r120b))))
...
(assert (= o15 o13))
(assert (= o16 o14))
(assert (= number__split_discrs (mk___split_discrs temp___1285)))
(assert (= temp___12851 o15))
(assert (= temp___12852 o16))
(assert (= result4 number__split_fields2))
(assert (= result5 number__split_fields3))
(assert (= number__split_fields4 (mk___split_fields (mk___t temp___12851 temp___12852))))
(assert (= number__split_discrs (mk___split_discrs temp___1285)))
