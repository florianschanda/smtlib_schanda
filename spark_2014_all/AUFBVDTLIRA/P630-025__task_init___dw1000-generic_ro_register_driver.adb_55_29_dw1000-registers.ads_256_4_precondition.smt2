...
(assert (forall ((x bits_7)) (! (in_range_int2 (to_int7 x)) :pattern ((to_int7 x)))))
(declare-sort bits_19 0)
(define-fun in_range5 ((x (_ BitVec 32))) Bool (and (bvule #x00000000 x) (bvule x #x0007FFFF)))
(define-fun in_range_int3 ((x Int)) Bool (and (<= 0 x) (<= x 524287)))
...
(declare-fun user_eq7 (bits_19 bits_19) Bool)
(declare-const dummy7 bits_19)
(declare-datatypes () ((bits_19__ref (mk_bits_19__ref (bits_19__content bits_19)))))
(define-fun bits_19__ref___projection ((a bits_19__ref)) bits_19 (bits_19__content a))
(declare-fun to_rep5 (bits_19) (_ BitVec 32))
(declare-fun of_rep5 ((_ BitVec 32)) bits_19)
(assert (forall ((x bits_19)) (! (= (of_rep5 (to_rep5 x)) x) :pattern ((to_rep5 x)))))
(assert (forall ((x bits_19)) (! (in_range5 (to_rep5 x)) :pattern ((to_rep5 x)))))
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x #x00080000))) (=> (in_range5 y) (= (to_rep5 (of_rep5 x)) y))) :pattern ((to_rep5 (of_rep5 x))))))
(define-fun to_int8 ((x bits_19)) Int (bv2nat (to_rep5 x)))
(assert (forall ((x bits_19)) (! (in_range_int3 (to_int8 x)) :pattern ((to_int8 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__rx_ttcko_type__rxtofs bits_19) (rec__dw1000__register_types__rx_ttcko_type__rsmpdel bits_8) (rec__dw1000__register_types__rx_ttcko_type__rcphase bits_7) (rec__dw1000__register_types__rx_ttcko_type__reserved_1 bits_5) (rec__dw1000__register_types__rx_ttcko_type__reserved_2 bits_1)))))
(define-fun us_split_fields_RXTOFS__projection ((a us_split_fields)) bits_19 (rec__dw1000__register_types__rx_ttcko_type__rxtofs a))
(define-fun us_split_fields_RSMPDEL__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__rx_ttcko_type__rsmpdel a))
(define-fun us_split_fields_RCPHASE__projection ((a us_split_fields)) bits_7 (rec__dw1000__register_types__rx_ttcko_type__rcphase a))
(define-fun us_split_fields_Reserved_1__5__projection ((a us_split_fields)) bits_5 (rec__dw1000__register_types__rx_ttcko_type__reserved_1 a))
(define-fun us_split_fields_Reserved_2__5__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__rx_ttcko_type__reserved_2 a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___17__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___17__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (= (to_rep5 (rec__dw1000__register_types__rx_ttcko_type__rxtofs (us_split_fields1 a))) (to_rep5 (rec__dw1000__register_types__rx_ttcko_type__rxtofs (us_split_fields1 b)))) (= (to_rep1 (rec__dw1000__register_types__rx_ttcko_type__rsmpdel (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__rx_ttcko_type__rsmpdel (us_split_fields1 b))))) (= (to_rep4 (rec__dw1000__register_types__rx_ttcko_type__rcphase (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__rx_ttcko_type__rcphase (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__rx_ttcko_type__reserved_1 (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__rx_ttcko_type__reserved_1 (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__rx_ttcko_type__reserved_2 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_ttcko_type__reserved_2 (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__rx_ttcko_type__rxtofs__first__bit Int)
(declare-const dw1000__register_types__rx_ttcko_type__rxtofs__last__bit Int)
(declare-const dw1000__register_types__rx_ttcko_type__rxtofs__position Int)
(assert (<= 0 dw1000__register_types__rx_ttcko_type__rxtofs__first__bit))
(assert (< dw1000__register_types__rx_ttcko_type__rxtofs__first__bit dw1000__register_types__rx_ttcko_type__rxtofs__last__bit))
(assert (<= 0 dw1000__register_types__rx_ttcko_type__rxtofs__position))
(declare-const dw1000__register_types__rx_ttcko_type__rsmpdel__first__bit Int)
(declare-const dw1000__register_types__rx_ttcko_type__rsmpdel__last__bit Int)
(declare-const dw1000__register_types__rx_ttcko_type__rsmpdel__position Int)
(assert (<= 0 dw1000__register_types__rx_ttcko_type__rsmpdel__first__bit))
(assert (< dw1000__register_types__rx_ttcko_type__rsmpdel__first__bit dw1000__register_types__rx_ttcko_type__rsmpdel__last__bit))
(assert (<= 0 dw1000__register_types__rx_ttcko_type__rsmpdel__position))
(declare-const dw1000__register_types__rx_ttcko_type__rcphase__first__bit Int)
(declare-const dw1000__register_types__rx_ttcko_type__rcphase__last__bit Int)
(declare-const dw1000__register_types__rx_ttcko_type__rcphase__position Int)
(assert (<= 0 dw1000__register_types__rx_ttcko_type__rcphase__first__bit))
(assert (< dw1000__register_types__rx_ttcko_type__rcphase__first__bit dw1000__register_types__rx_ttcko_type__rcphase__last__bit))
(assert (<= 0 dw1000__register_types__rx_ttcko_type__rcphase__position))
(declare-const dw1000__register_types__rx_ttcko_type__reserved_1__first__bit Int)
(declare-const dw1000__register_types__rx_ttcko_type__reserved_1__last__bit Int)
(declare-const dw1000__register_types__rx_ttcko_type__reserved_1__position Int)
(assert (<= 0 dw1000__register_types__rx_ttcko_type__reserved_1__first__bit))
(assert (< dw1000__register_types__rx_ttcko_type__reserved_1__first__bit dw1000__register_types__rx_ttcko_type__reserved_1__last__bit))
(assert (<= 0 dw1000__register_types__rx_ttcko_type__reserved_1__position))
(declare-const dw1000__register_types__rx_ttcko_type__reserved_2__first__bit Int)
(declare-const dw1000__register_types__rx_ttcko_type__reserved_2__last__bit Int)
(declare-const dw1000__register_types__rx_ttcko_type__reserved_2__position Int)
(assert (<= 0 dw1000__register_types__rx_ttcko_type__reserved_2__first__bit))
(assert (< dw1000__register_types__rx_ttcko_type__reserved_2__first__bit dw1000__register_types__rx_ttcko_type__reserved_2__last__bit))
(assert (<= 0 dw1000__register_types__rx_ttcko_type__reserved_2__position))
(declare-fun user_eq8 (us_rep us_rep) Bool)
(declare-const dummy8 us_rep)
(declare-datatypes () ((rx_ttcko_type__ref (mk_rx_ttcko_type__ref (rx_ttcko_type__content us_rep)))))
(define-fun rx_ttcko_type__ref___projection ((a rx_ttcko_type__ref)) us_rep (rx_ttcko_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___35__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___26__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___26__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3238 us_t1) (temp___is_init_3234 Bool) (temp___skip_constant_3235 Bool) (temp___do_toplevel_3236 Bool) (temp___do_typ_inv_3237 Bool)) Bool (=> (not (= temp___skip_constant_3235 true)) (and (dynamic_property2 1 5 (first3 temp___expr_3238) (last3 temp___expr_3238)) (and (= (first3 temp___expr_3238) 1) (= (last3 temp___expr_3238) 5)))))
