...
(define-fun dynamic_invariant ((temp___expr_181 (_ BitVec 8)) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool) (temp___do_typ_inv_180 Bool)) Bool true)
...
(assert (forall ((x86__xcx (Array Int unsigned_8))) (! (let ((result (ecx x86__xcx))) (and (= result (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select x86__xcx 0))) (bvmul ((_ zero_extend 24) (to_rep (select x86__xcx 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select x86__xcx 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select x86__xcx 3))) #x01000000))) (dynamic_invariant1 result true false true true))) :pattern ((ecx x86__xcx)))))
...
(assert (forall ((x86__xsi (Array Int unsigned_8))) (! (let ((result (esi x86__xsi))) (and (= result (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select x86__xsi 0))) (bvmul ((_ zero_extend 24) (to_rep (select x86__xsi 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select x86__xsi 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select x86__xsi 3))) #x01000000))) (dynamic_invariant1 result true false true true))) :pattern ((esi x86__xsi)))))
...
(assert (forall ((x86__xdi (Array Int unsigned_8))) (! (let ((result (edi x86__xdi))) (and (= result (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select x86__xdi 0))) (bvmul ((_ zero_extend 24) (to_rep (select x86__xdi 1))) #x00000100)) (bvmul ((_ zero_extend 24) (to_rep (select x86__xdi 2))) #x00010000)) (bvmul ((_ zero_extend 24) (to_rep (select x86__xdi 3))) #x01000000))) (dynamic_invariant1 result true false true true))) :pattern ((edi x86__xdi)))))
...
(define-fun dynamic_invariant2 ((temp___expr_160 (_ BitVec 64)) (temp___is_init_156 Bool) (temp___skip_constant_157 Bool) (temp___do_toplevel_158 Bool) (temp___do_typ_inv_159 Bool)) Bool true)
...
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned_8))) (! (=> (dynamic_invariant2 addr true true true true) (let ((result (readmem8 addr x86__memory))) (and (and (= result (to_rep (select x86__memory addr))) (bvuge result #x00)) (dynamic_invariant result true false true true)))) :pattern ((readmem8 addr x86__memory))))))
...
(assert (or (= (ecx (map__content1 xcx6)) #x00000000) (not (= (bool__content zeroflag6) true))))
(assert (= val28 val26))
(assert (= val18 val16))
(assert (= xdi10 xdi8))
(assert (= xsi10 xsi8))
...
(assert (not (or (= (ecx (map__content1 xcx8)) #x00000000) (not (= (bool__content zeroflag8) true)))))
(check-sat)
(exit)
