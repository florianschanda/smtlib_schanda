...
(assert (forall ((x unsigned_8)) (! (uint_in_range (to_int6 x)) :pattern ((to_int6 x)))))
...
(declare-datatypes () ((map__ref1 (mk_map__ref1 (map__content1 (Array Int unsigned_8))))))
(declare-fun slide1 ((Array Int unsigned_8) Int Int) (Array Int unsigned_8))
(assert (forall ((a (Array Int unsigned_8))) (forall ((first Int)) (! (= (slide1 a first first) a) :pattern ((slide1 a first first))))))
(assert (forall ((a (Array Int unsigned_8))) (forall ((old_first Int)) (forall ((new_first Int)) (forall ((i Int)) (! (= (select (slide1 a old_first new_first) i) (select a (- i (- new_first old_first)))) :pattern ((select (slide1 a old_first new_first) i))))))))
(declare-fun concat2 ((Array Int unsigned_8) Int Int (Array Int unsigned_8) Int Int) (Array Int unsigned_8))
...
(assert (forall ((v unsigned_8)) (forall ((i Int)) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
...
(declare-fun compare1 ((Array Int unsigned_8) Int Int (Array Int unsigned_8) Int Int) Int)
(assert (forall ((a (Array Int unsigned_8)) (b (Array Int unsigned_8))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq1 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int unsigned_8)) (b (Array Int unsigned_8))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq1 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (bvult (to_rep (select a (+ i 1))) (to_rep (select b (+ j 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int unsigned_8)) (b (Array Int unsigned_8))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq1 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (bvugt (to_rep (select a (+ j 1))) (to_rep (select b (+ i 1))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(assert (forall ((x86__xcx (Array Int unsigned_8))) (! (let ((result (ecx x86__xcx))) (and (= result (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select x86__xcx 0))) (bvmul ((_ zero_extend 24) (to_rep (select x86__xcx 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select x86__xcx 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select x86__xcx 3))) ((_ int2bv 32) 16777216)))) (dynamic_invariant1 result true false true))) :pattern ((ecx x86__xcx)))))
...
(assert (forall ((x86__xsi (Array Int unsigned_8))) (! (let ((result (esi x86__xsi))) (and (= result (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select x86__xsi 0))) (bvmul ((_ zero_extend 24) (to_rep (select x86__xsi 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select x86__xsi 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select x86__xsi 3))) ((_ int2bv 32) 16777216)))) (dynamic_invariant1 result true false true))) :pattern ((esi x86__xsi)))))
...
(assert (forall ((x86__xdi (Array Int unsigned_8))) (! (let ((result (edi x86__xdi))) (and (= result (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select x86__xdi 0))) (bvmul ((_ zero_extend 24) (to_rep (select x86__xdi 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select x86__xdi 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select x86__xdi 3))) ((_ int2bv 32) 16777216)))) (dynamic_invariant1 result true false true))) :pattern ((edi x86__xdi)))))
...
(define-fun dynamic_invariant2 ((temp___expr_137 (_ BitVec 64)) (temp___is_init_134 Bool) (temp___skip_constant_135 Bool) (temp___do_toplevel_136 Bool)) Bool true)
...
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned_8))) (! (=> (dynamic_invariant2 addr true true true) (let ((result (readmem8 addr x86__memory))) (and (and (= result (to_rep (select x86__memory addr))) (bvuge result ((_ int2bv 8) 0))) (dynamic_invariant result true false true)))) :pattern ((readmem8 addr x86__memory))))))
...
(assert (=> (= result true) (not (= (ecx xcx2) ((_ int2bv 32) 0)))))
(assert (=> (= result true) (and (= o2 (esi xsi2)) (= o2 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi2 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi2 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xsi2 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xsi2 3))) ((_ int2bv 32) 16777216)))))))
(assert (=> (= result true) (= o3 ((_ zero_extend 32) o2))))
(assert (=> (= result true) (and (= o4 (readmem8 o3 memory)) (and (= o4 (to_rep (select memory o3))) (bvuge o4 ((_ int2bv 8) 0))))))
(assert (=> (= result true) (= result1 val12)))
(assert (=> (= result true) (= val13 o4)))
(assert (=> (= result true) (and (= o5 (edi xdi2)) (= o5 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi2 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi2 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xdi2 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xdi2 3))) ((_ int2bv 32) 16777216)))))))
(assert (=> (= result true) (= o6 ((_ zero_extend 32) o5))))
(assert (=> (= result true) (and (= o7 (readmem8 o6 memory)) (and (= o7 (to_rep (select memory o6))) (bvuge o7 ((_ int2bv 8) 0))))))
(assert (=> (= result true) (= result2 val22)))
(assert (=> (= result true) (= val23 o7)))
(assert (=> (= result true) (= result3 zeroflag2)))
(assert (=> (= result true) (= zeroflag3 (ite (= (bvsub val13 val23) ((_ int2bv 8) 0)) true false))))
...
(assert (=> (= result true) (and (= o8 (ecx xcx2)) (= o8 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx2 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx2 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xcx2 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xcx2 3))) ((_ int2bv 32) 16777216)))))))
(assert (=> (= result true) (= o9 (bvsub o8 ((_ int2bv 32) 1)))))
(assert (=> (= result true) (and (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx3 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx3 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xcx3 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xcx3 3))) ((_ int2bv 32) 16777216))) o9) (forall ((i Int)) (=> (and (<= 4 i) (<= i 7)) (= (to_rep (select xcx3 i)) (to_rep (select xcx2 i))))))))
(assert (=> (= result true) (or (and (and (and (= xdi2 xdi4) (= xsi2 xsi4)) (and (= xdi5 xdi2) (= xsi5 xsi2))) (and (and (and (and (= o10 (ecx xcx3)) (= o10 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx3 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx3 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xcx3 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xcx3 3))) ((_ int2bv 32) 16777216))))) (= o11 (ite (= o10 ((_ int2bv 32) 0)) true false))) (= result5 (ite (= o11 false) (ite (not (= zeroflag3 true)) true false) true))) (= result5 true))) (and (and (and (and (and (= o10 (ecx xcx3)) (= o10 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx3 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx3 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xcx3 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xcx3 3))) ((_ int2bv 32) 16777216))))) (= o11 (ite (= o10 ((_ int2bv 32) 0)) true false))) (= result5 (ite (= o11 false) (ite (not (= zeroflag3 true)) true false) true))) (not (= result5 true))) (and (and (and (= xdi3 xdi4) (= xsi3 xsi4)) (and (= xdi5 xdi3) (= xsi5 xsi3))) (and (and (and (and (= o12 (esi xsi2)) (= o12 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi2 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi2 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xsi2 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xsi2 3))) ((_ int2bv 32) 16777216))))) (= o13 (bvadd o12 ((_ int2bv 32) 1)))) (and (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi3 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi3 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xsi3 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xsi3 3))) ((_ int2bv 32) 16777216))) o13) (forall ((i Int)) (=> (and (<= 4 i) (<= i 7)) (= (to_rep (select xsi3 i)) (to_rep (select xsi2 i))))))) (and (and (and (and (= o14 (edi xdi2)) (= o14 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi2 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi2 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xdi2 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xdi2 3))) ((_ int2bv 32) 16777216))))) (= o15 (bvadd o14 ((_ int2bv 32) 1)))) (and (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xdi3 0))) (bvmul ((_ zero_extend 24) (to_rep (select xdi3 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xdi3 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xdi3 3))) ((_ int2bv 32) 16777216))) o15) (forall ((i Int)) (=> (and (<= 4 i) (<= i 7)) (= (to_rep (select xdi3 i)) (to_rep (select xdi2 i))))))) (and (and (and (and (and (= o16 (ecx xcx3)) (= o16 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xcx3 0))) (bvmul ((_ zero_extend 24) (to_rep (select xcx3 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xcx3 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xcx3 3))) ((_ int2bv 32) 16777216))))) (= o17 (ite (= o16 ((_ int2bv 32) 0)) true false))) (= o18 (ite (not (= o17 true)) true false))) (= result6 (ite (not (= o18 true)) true false))) (= result6 true)))))))))
...
(assert (or (= (ecx (map__content1 xcx6)) ((_ int2bv 32) 0)) (not (= (bool__content zeroflag6) true))))
(assert (= val28 val26))
(assert (= val18 val16))
(assert (= xdi10 xdi8))
(assert (= xsi10 xsi8))
...
(assert (not (or (= (ecx (map__content1 xcx8)) ((_ int2bv 32) 0)) (not (= (bool__content zeroflag8) true)))))
(check-sat)
(exit)
