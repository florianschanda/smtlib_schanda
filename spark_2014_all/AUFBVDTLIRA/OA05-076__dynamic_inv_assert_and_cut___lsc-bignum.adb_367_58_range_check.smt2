...
(assert (= carry11 #x00000000))
(assert (= carry2 result3))
(assert (= carry21 #x00000000))
(assert (and (= o (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (= o1 (+ b_first o)))
(assert (and (= temp___673 o1) (in_range1 o1)))
(assert (and (<= (to_rep (first (rt b))) temp___673) (<= temp___673 (to_rep (last (rt b))))))
(assert (= o2 temp___673))
...
(assert (= (oeq (oadd (oadd (oadd (oadd (from_word32 lsc__bignum__single_add_mult_mult__a) (omultiply (from_word32 bi1) (from_word32 o19))) (omultiply (from_word32 o22) (from_word32 u1))) (from_word32 carry11)) (omultiply (base Tuple0) (from_word32 carry21))) (oadd (from_word32 lsc__bignum__single_add_mult_mult__a1) (omultiply (base Tuple0) (oadd (from_word32 carry12) (omultiply (base Tuple0) (from_word32 carry22)))))) true))
...
(assert (= (oeq (oadd (oadd (oadd (oadd (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1) (+ (- o26 a_first) 1)) (omultiply (num_of_big_int c o27 (+ (- o26 a_first) 1)) (from_word32 bi1))) (omultiply (num_of_big_int m o28 (+ (- o26 a_first) 1)) (from_word32 u1))) (from_word32 carry12)) (omultiply (base Tuple0) (from_word32 carry22))) (oadd (num_of_big_int (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- o26 a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- o26 a_first) 1)) (oadd (from_word32 carry13) (omultiply (base Tuple0) (from_word32 carry23)))))) true))
...
(assert (and (= o36 (word_of_boolean o35)) (= (oeq (from_word32 o36) (num_of_boolean o35)) true)))
(assert (= o37 (bvadd carry23 o36)))
(assert (= a_msw2 result8))
(assert (= a_msw3 o37))
(assert (= o92 (from_word32 #x00000001)))
(assert (and (= o86 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o87 (+ o86 1)))
(assert (and (= o88 o87) (in_range1 o87)))
(assert (and (= o89 o88) (in_range2 o88)))
(assert (= o90 (num_of_big_int m m_first o89)))
(assert (= o85 (from_word32 #x00000002)))
(assert (= o91 (omultiply o85 o90)))
(assert (= o93 (osubtract o91 o92)))
(assert (= o82 (from_word32 a_msw3)))
(assert (and (= o77 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o78 (+ o77 1)))
(assert (and (= o79 o78) (in_range1 o78)))
(assert (and (= o80 o79) (in_range2 o79)))
(assert (and (= o76 (base Tuple0)) (= o76 (oexpon (from_word32 #x00000002) 32))))
(assert (= o81 (oexpon o76 o80)))
(assert (= o83 (omultiply o81 o82)))
(assert (and (= o71 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o72 (+ o71 1)))
(assert (and (= o73 o72) (in_range1 o72)))
(assert (and (= o74 o73) (in_range2 o73)))
(assert (= o75 (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first o74)))
(assert (= o84 (oadd o75 o83)))
(assert (= o94 (olt o84 o93)))
(assert (and (= o65 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o66 (+ o65 1)))
(assert (and (= o67 o66) (in_range1 o66)))
(assert (and (= o68 o67) (in_range2 o67)))
(assert (= o69 (num_of_big_int m m_first o68)))
(assert (and (= o59 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o60 (- o59 a_first)))
(assert (and (= o61 o60) (in_range1 o60)))
(assert (and (= o62 o61) (in_range2 o61)))
(assert (and (= o57 (base Tuple0)) (= o57 (oexpon (from_word32 #x00000002) 32))))
(assert (and (= o52 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o53 (+ o52 1)))
(assert (and (= o54 o53) (in_range1 o53)))
(assert (and (= o55 o54) (in_range2 o54)))
(assert (= o56 (num_of_big_int m m_first o55)))
(assert (= o58 (inverse o56 o57)))
(assert (= o63 (oexpon o58 o62)))
(assert (and (= o46 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o47 (+ o46 1)))
(assert (and (= o48 o47) (in_range1 o47)))
(assert (and (= o49 o48) (in_range2 o48)))
(assert (= o50 (num_of_big_int c c_first o49)))
(assert (and (= o41 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o42 (- o41 a_first)))
(assert (and (= o43 o42) (in_range1 o42)))
(assert (and (= o44 o43) (in_range2 o43)))
(assert (= o45 (num_of_big_int b b_first o44)))
(assert (= o51 (omultiply o45 o50)))
(assert (= o64 (omultiply o51 o63)))
(assert (= o70 (omod o64 o69)))
(assert (and (= o38 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o39 (+ o38 1)))
