...
(assert (= a_msw3 o37))
(assert (= o92 (from_word32 ((_ int2bv 32) 1))))
...
(assert (= o85 (from_word32 ((_ int2bv 32) 2))))
...
(assert (and (= o76 (base Tuple0)) (= o76 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
...
(assert (and (= o57 (base Tuple0)) (= o57 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
