...
(assert (=> (< digit_count3 i2) (forall ((j Int)) (=> (and (<= (+ digit_count3 1) j) (<= j i2)) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j)) #x00)))))
(assert (and (and (=> (<= 0 65536) (in_range1 digit_count3)) (=> (<= 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))) (dynamic_property2 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i2))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
...
(assert (=> (= result6 true) (and (= o10 i3) (in_range1 i3))))
...
(assert (< digit_count4 i3))
(declare-const j Int)
(assert (<= (+ digit_count4 1) j))
(assert (<= j i3))
(assert (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j)) #x00)))
(check-sat)
(exit)
