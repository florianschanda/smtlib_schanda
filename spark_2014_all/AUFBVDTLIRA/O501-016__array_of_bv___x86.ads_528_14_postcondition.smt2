...
(declare-const x86__readmem8ghost__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const x86__readmem8ghost__result1 (_ BitVec 8))
(declare-const x86__readmem8ghost__result2 (_ BitVec 8))
(declare-const x86__readmem8ghost__result3 (_ BitVec 8))
...
(assert (= x86__readmem8ghost__result1 (to_rep (select mem addr))))
(assert (= (mk_t__ref x86__readmem8ghost__result4) (mk_t__ref x86__readmem8ghost__result2)))
(assert (= x86__readmem8ghost__result5 x86__readmem8ghost__result3))
(assert (= result1 x86__readmem8ghost__result4))
(assert (not (= x86__readmem8ghost__result4 (to_rep (select mem addr)))))
(check-sat)
(exit)
