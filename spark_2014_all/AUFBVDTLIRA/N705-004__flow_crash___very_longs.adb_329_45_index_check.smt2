...
(assert (= (= o15 true) (forall ((i11 Int)) (=> (and (<= (+ very_longs__divide__get_msd__result4 1) i11) (<= i11 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) i11)) ((_ int2bv 8) 0))))))
