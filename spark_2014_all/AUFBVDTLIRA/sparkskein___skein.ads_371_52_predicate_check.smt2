...
(define-fun dynamic_invariant5 ((temp___expr_1239 Int) (temp___is_init_1235 Bool) (temp___skip_constant_1236 Bool) (temp___do_toplevel_1237 Bool) (temp___do_typ_inv_1238 Bool)) Bool (=> (or (= temp___is_init_1235 true) (<= 2 60)) (in_range5 temp___expr_1239)))
...
(assert (forall ((temp___175 (_ BitVec 64))) (=> (dynamic_invariant1 temp___175 true true true true) (forall ((temp___176 (_ BitVec 64))) (= (to_rep2 (select (temp___173 temp___175) temp___176)) temp___175)))))
(assert (forall ((temp___179 (_ BitVec 8))) (=> (dynamic_invariant6 temp___179 true true true true) (forall ((temp___180 (_ BitVec 64))) (= (to_rep5 (select (temp___177 temp___179) temp___180)) temp___179)))))
...
(assert (not (dynamic_predicate (temp___177 #x00))))
(check-sat)
(exit)
