...
(define-fun dynamic_invariant ((temp___expr_302 (_ BitVec 32)) (temp___is_init_299 Bool) (temp___skip_constant_300 Bool) (temp___do_toplevel_301 Bool)) Bool true)
...
(assert (forall ((x hash_bit_length)) (! (in_range1 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 64))) (! (=> (in_range1 x) (= (to_rep3 (of_rep3 x)) x)) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int9 ((x hash_bit_length)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x hash_bit_length)) (! (in_range_int (to_int9 x)) :pattern ((to_int9 x)))))
...
(assert (forall ((x unsigned_64)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert true)
...
(assert (forall ((x unsigned_64)) (! (uint_in_range3 (to_int10 x)) :pattern ((to_int10 x)))))
(declare-sort byte 0)
...
(assert (forall ((x byte)) (! (uint_in_range (to_int11 x)) :pattern ((to_int11 x)))))
...
(define-fun bool_eq ((a (Array (_ BitVec 64) byte)) (a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b (Array (_ BitVec 64) byte)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep5 (select a temp___idx_132)) (to_rep5 (select b (bvadd (bvsub b__first a__first) temp___idx_132))))))) true false))
(assert (forall ((a (Array (_ BitVec 64) byte)) (b (Array (_ BitVec 64) byte))) (forall ((a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep5 (select a temp___idx_132)) (to_rep5 (select b (bvadd (bvsub b__first a__first) temp___idx_132)))))))))))
...
(assert (forall ((a (Array (_ BitVec 64) byte)) (b (Array (_ BitVec 64) byte))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (bvult (to_rep5 (select a (bvadd i #x0000000000000001))) (to_rep5 (select b (bvadd j #x0000000000000001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 64) byte)) (b (Array (_ BitVec 64) byte))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (bvugt (to_rep5 (select a (bvadd j #x0000000000000001))) (to_rep5 (select b (bvadd i #x0000000000000001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(declare-sort t 0)
(declare-fun first (t) unsigned_64)
(declare-fun last (t) unsigned_64)
(declare-fun mk ((_ BitVec 64) (_ BitVec 64)) t)
(assert (forall ((f (_ BitVec 64)) (l (_ BitVec 64))) (! (and (= (to_rep4 (first (mk f l))) f) (= (to_rep4 (last (mk f l))) l)) :pattern ((mk f l)))))
...
(define-fun bool_eq1 ((x us_t) (y us_t)) Bool (bool_eq (elts x) (to_rep4 (first (rt x))) (to_rep4 (last (rt x))) (elts y) (to_rep4 (first (rt y))) (to_rep4 (last (rt y)))))
...
(define-fun in_range2 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 63))))
...
(declare-fun user_eq7 (skein_512_block_bytes_index skein_512_block_bytes_index) Bool)
...
(define-fun dynamic_invariant3 ((temp___expr_615 (_ BitVec 8)) (temp___is_init_612 Bool) (temp___skip_constant_613 Bool) (temp___do_toplevel_614 Bool)) Bool (=> (or (= temp___is_init_612 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 63))) (in_range4 temp___expr_615)))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (and (and (= (to_rep2 (rec__skein__tweak_value__byte_count_lsb (us_split_fields1 a))) (to_rep2 (rec__skein__tweak_value__byte_count_lsb (us_split_fields1 b)))) (= (to_rep1 (rec__skein__tweak_value__byte_count_msb (us_split_fields1 a))) (to_rep1 (rec__skein__tweak_value__byte_count_msb (us_split_fields1 b))))) (= (to_rep (rec__skein__tweak_value__reserved (us_split_fields1 a))) (to_rep (rec__skein__tweak_value__reserved (us_split_fields1 b))))) (= (to_rep6 (rec__skein__tweak_value__tree_level (us_split_fields1 a))) (to_rep6 (rec__skein__tweak_value__tree_level (us_split_fields1 b))))) (= (rec__skein__tweak_value__bit_pad (us_split_fields1 a)) (rec__skein__tweak_value__bit_pad (us_split_fields1 b)))) (= (to_rep7 (rec__skein__tweak_value__field_type (us_split_fields1 a))) (to_rep7 (rec__skein__tweak_value__field_type (us_split_fields1 b))))) (= (rec__skein__tweak_value__first_block (us_split_fields1 a)) (rec__skein__tweak_value__first_block (us_split_fields1 b)))) (= (rec__skein__tweak_value__final_block (us_split_fields1 a)) (rec__skein__tweak_value__final_block (us_split_fields1 b)))) true false))
...
(define-fun bool_eq4 ((a (Array (_ BitVec 64) u64)) (a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b (Array (_ BitVec 64) u64)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_133 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_133) (bvule temp___idx_133 a__last)) (= (to_rep2 (select a temp___idx_133)) (to_rep2 (select b (bvadd (bvsub b__first a__first) temp___idx_133))))))) true false))
(assert (forall ((a (Array (_ BitVec 64) u64)) (b (Array (_ BitVec 64) u64))) (forall ((a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) (=> (= (bool_eq4 b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_133 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_133) (bvule temp___idx_133 a__last)) (= (to_rep2 (select a temp___idx_133)) (to_rep2 (select b (bvadd (bvsub b__first a__first) temp___idx_133)))))))))))
...
(assert (forall ((a (Array (_ BitVec 64) u64)) (b (Array (_ BitVec 64) u64))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq4 a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (bvult (to_rep2 (select a (bvadd i #x0000000000000001))) (to_rep2 (select b (bvadd j #x0000000000000001))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 64) u64)) (b (Array (_ BitVec 64) u64))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq4 a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (bvugt (to_rep2 (select a (bvadd j #x0000000000000001))) (to_rep2 (select b (bvadd i #x0000000000000001))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
...
(declare-fun user_eq12 ((Array (_ BitVec 64) u64) (Array (_ BitVec 64) u64)) Bool)
...
(declare-fun user_eq13 ((Array (_ BitVec 64) byte) (Array (_ BitVec 64) byte)) Bool)
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq6 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_134 Int)) (=> (and (<= a__first temp___idx_134) (<= temp___idx_134 a__last)) (= (select a temp___idx_134) (select b (+ (- b__first a__first) temp___idx_134))))))))))
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< (compare2 a a_first a_last b b_first b_last) 0) (exists ((i Int) (j Int)) (and (<= i a_last) (and (< j b_last) (and (= (bool_eq6 a a_first i b b_first j) true) (or (= i a_last) (and (< i a_last) (< (to_int5 (select a (+ i 1))) (to_int5 (select b (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a_first Int) (a_last Int) (b_first Int) (b_last Int)) (! (= (< 0 (compare2 a a_first a_last b b_first b_last)) (exists ((i Int) (j Int)) (and (<= i b_last) (and (< j a_last) (and (= (bool_eq6 a a_first j b b_first i) true) (or (= i b_last) (and (< i b_last) (< (to_int5 (select b (+ i 1))) (to_int5 (select a (+ j 1))))))))))) :pattern ((compare2 a a_first a_last b b_first b_last))))))
...
(assert (forall ((temp___136 Bool)) (forall ((temp___137 Int)) (= (select (skein__debug_none__aggregate_def temp___136) temp___137) temp___136))))
(declare-const debug_final (Array Int Bool))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-fun skein__debug_final__aggregate_def (Bool Bool) (Array Int Bool))
(assert (forall ((temp___139 Bool) (temp___140 Bool)) (let ((temp___138 (skein__debug_final__aggregate_def temp___139 temp___140))) (forall ((temp___141 Int)) (ite (= temp___141 9) (= (select temp___138 temp___141) temp___139) (= (select temp___138 temp___141) temp___140))))))
(declare-const debug_all (Array Int Bool))
(declare-const attr__ATTRIBUTE_ADDRESS2 Int)
(declare-fun skein__debug_all__aggregate_def (Bool Bool Bool) (Array Int Bool))
(assert (forall ((temp___143 Bool) (temp___144 Bool) (temp___145 Bool)) (let ((temp___142 (skein__debug_all__aggregate_def temp___143 temp___144 temp___145))) (forall ((temp___146 Int)) (ite (= temp___146 12) (= (select temp___142 temp___146) temp___144) (ite (= temp___146 11) (= (select temp___142 temp___146) temp___143) (= (select temp___142 temp___146) temp___145)))))))
(declare-const threefish_debug_all (Array Int Bool))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-fun skein__threefish_debug_all__aggregate_def (Bool Bool) (Array Int Bool))
(assert (forall ((temp___148 Bool) (temp___149 Bool)) (let ((temp___147 (skein__threefish_debug_all__aggregate_def temp___148 temp___149))) (forall ((temp___150 Int)) (ite (= temp___150 12) (= (select temp___147 temp___150) temp___148) (= (select temp___147 temp___150) temp___149))))))
...
(assert (forall ((temp___157 (_ BitVec 8))) (forall ((temp___158 (_ BitVec 64))) (= (select (temp___155 temp___157) temp___158) (of_rep5 temp___157)))))
...
(define-fun dynamic_invariant7 ((temp___expr_296 (_ BitVec 16)) (temp___is_init_293 Bool) (temp___skip_constant_294 Bool) (temp___do_toplevel_295 Bool)) Bool true)
(define-fun dynamic_invariant8 ((temp___expr_368 us_t) (temp___is_init_365 Bool) (temp___skip_constant_366 Bool) (temp___do_toplevel_367 Bool)) Bool (and (=> (not (= temp___skip_constant_366 true)) (dynamic_property ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551615) (first1 temp___expr_368) (last1 temp___expr_368))) (=> (= temp___do_toplevel_367 true) (=> (= temp___is_init_365 true) (bvult (last1 temp___expr_368) ((_ int2bv 64) 18446744073709551615))))))
(define-fun dynamic_predicate1 ((temp___371 us_t)) Bool (bvult (last1 temp___371) ((_ int2bv 64) 18446744073709551615)))
(define-fun dynamic_invariant9 ((temp___expr_520 (_ BitVec 64)) (temp___is_init_517 Bool) (temp___skip_constant_518 Bool) (temp___do_toplevel_519 Bool)) Bool (=> (or (= temp___is_init_517 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551608))) (in_range1 temp___expr_520)))
(define-fun dynamic_invariant10 ((temp___expr_553 (_ BitVec 64)) (temp___is_init_550 Bool) (temp___skip_constant_551 Bool) (temp___do_toplevel_552 Bool)) Bool (=> (or (= temp___is_init_550 true) (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 63))) (in_range2 temp___expr_553)))
(assert (= debug_none (skein__debug_none__aggregate_def (of_int 0))))
(assert (= debug_final (skein__debug_final__aggregate_def (of_int 1) (of_int 0))))
(assert (= debug_all (skein__debug_all__aggregate_def (of_int 0) (of_int 0) (of_int 1))))
(assert (= threefish_debug_all (skein__threefish_debug_all__aggregate_def (of_int 0) (of_int 1))))
(define-fun dynamic_invariant11 ((temp___expr_609 (_ BitVec 8)) (temp___is_init_606 Bool) (temp___skip_constant_607 Bool) (temp___do_toplevel_608 Bool)) Bool (=> (or (= temp___is_init_606 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 127))) (in_range3 temp___expr_609)))
...
(assert (= null_context_header (mk___rep1 (mk___split_fields1 null_tweak_value (of_rep3 ((_ int2bv 64) 0)) (of_rep2 ((_ int2bv 64) 0))))))
...
(define-fun dynamic_invariant12 ((temp___expr_266 (_ BitVec 64)) (temp___is_init_263 Bool) (temp___skip_constant_264 Bool) (temp___do_toplevel_265 Bool)) Bool true)
(declare-const o u6)
(declare-const o1 u7)
...
(assert (= (skein__debug_final__aggregate_def (of_int 1) (of_int 0)) debug_final))
(assert (= (skein__debug_all__aggregate_def (of_int 0) (of_int 0) (of_int 1)) debug_all))
(assert (= (skein__threefish_debug_all__aggregate_def (of_int 0) (of_int 1)) threefish_debug_all))
...
(assert (= (mk___rep (mk___split_fields skein__null_tweak_value__assume skein__null_tweak_value__assume1 skein__null_tweak_value__assume2 skein__null_tweak_value__assume3 skein__null_tweak_value__assume4 skein__null_tweak_value__assume5 skein__null_tweak_value__assume6 skein__null_tweak_value__assume7)) null_tweak_value))
(assert (= (to_rep2 o13) ((_ int2bv 64) 0)))
(assert (= (to_rep3 o14) ((_ int2bv 64) 0)))
(assert (= null_tweak_value (mk___rep (mk___split_fields o15 o16 o17 o18 o19 o20 o21 o22))))
(assert (= o14 o23))
(assert (= o13 o24))
...
(assert (= (mk___rep1 (mk___split_fields1 (mk___rep (mk___split_fields skein__null_context_header__assume skein__null_context_header__assume1 skein__null_context_header__assume2 skein__null_context_header__assume3 skein__null_context_header__assume4 skein__null_context_header__assume5 skein__null_context_header__assume6 skein__null_context_header__assume7)) skein__null_context_header__assume8 skein__null_context_header__assume9)) null_context_header))
(assert (not (dynamic_predicate (temp___155 ((_ int2bv 8) 0)))))
(check-sat)
(exit)
