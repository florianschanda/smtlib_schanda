...
(declare-const temp___4192 (Array Int t_uint8))
(declare-const temp___41921 t)
...
(declare-const temp___4196 crpt_packet_representation)
(declare-const temp___41961 t_uint8)
(declare-const temp___41962 crtp_channel)
(declare-const temp___41963 crtp_reserved)
(declare-const temp___41964 crtp_port)
(declare-const temp___41965 (Array Int t_uint8))
(declare-const temp___41966 t_uint8)
(declare-const temp___41967 (Array Int t_uint8))
(declare-const temp___41968 (Array Int t_uint8))
(declare-const temp___41969 Bool)
(declare-const temp___419610 positive)
(declare-const o34 t_uint8)
(declare-const o35 us_split_fields)
(declare-const o36 us_rep)
(declare-const o37 us_split_fields2)
(declare-const temp___4199 us_rep1)
...
(assert (= (ite (<= (to_rep6 (first temp___41881)) (to_rep6 (last temp___41881))) (+ (- (to_rep6 (last temp___41881)) (to_rep6 (first temp___41881))) 1) 0) (ite (<= (to_rep6 (first temp___41901)) (to_rep6 (last temp___41901))) (+ (- (to_rep6 (last temp___41901)) (to_rep6 (first temp___41901))) 1) 0)))
(assert (= (mk___t temp___4192 temp___41921) (mk___t temp___4188 temp___41881)))
(assert (forall ((temp___4193 Int)) (ite (and (<= r6b temp___4193) (<= temp___4193 r7b)) (= (select o4 temp___4193) (select temp___4192 temp___4193)) (= (select o4 temp___4193) (select handler__split_fields5 temp___4193)))))
...
(assert (= temp___4196 o23))
(assert (= temp___41961 o24))
(assert (= temp___41962 o25))
(assert (= temp___41963 o26))
(assert (= temp___41964 o27))
(assert (= temp___41965 o28))
(assert (= temp___41966 o29))
(assert (= temp___41967 o30))
(assert (= temp___41968 o31))
(assert (= temp___41969 o32))
(assert (= temp___419610 o33))
...
(assert (= handler__split_fields11 (mk___split_fields1 (mk___rep (mk___split_discrs temp___4196) (mk___split_fields temp___41961 temp___41962 temp___41963 temp___41964 temp___41965 temp___41966 temp___41967 temp___41968) temp___41969) temp___419610)))
...
(assert (= temp___4199 (mk___rep1 o37)))
(assert (= result2 (mk___split_fields__ref1 handler__split_fields11)))
(assert (= handler__split_fields12 (us_split_fields3 temp___4199)))
