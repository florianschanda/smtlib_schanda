...
(assert (= (ite (<= (to_rep6 (first temp___38401)) (to_rep6 (last temp___38401))) (+ (- (to_rep6 (last temp___38401)) (to_rep6 (first temp___38401))) 1) 0) (ite (<= (to_rep6 (first temp___38421)) (to_rep6 (last temp___38421))) (+ (- (to_rep6 (last temp___38421)) (to_rep6 (first temp___38421))) 1) 0)))
(assert (= (mk___t temp___3844 temp___38441) (mk___t temp___3840 temp___38401)))
(assert (forall ((temp___3845 Int)) (ite (and (<= r6b temp___3845) (<= temp___3845 r7b)) (= (select o4 temp___3845) (select temp___3844 temp___3845)) (= (select o4 temp___3845) (select handler__split_fields5 temp___3845)))))
...
(assert (= temp___3848 o23))
(assert (= temp___38481 o24))
(assert (= temp___38482 o25))
(assert (= temp___38483 o26))
(assert (= temp___38484 o27))
(assert (= temp___38485 o28))
(assert (= temp___38486 o29))
(assert (= temp___38487 o30))
(assert (= temp___38488 o31))
(assert (= temp___38489 o32))
(assert (= temp___384810 o33))
...
(assert (= handler__split_fields11 (mk___split_fields1 (mk___rep (mk___split_discrs temp___3848) (mk___split_fields temp___38481 temp___38482 temp___38483 temp___38484 temp___38485 temp___38486 temp___38487 temp___38488) temp___38489) temp___384810)))
(assert (= (to_rep1 o34) (bvadd (to_rep1 (rec__crtp_pack__crtp_packet__size (us_split_fields1 (rec__crtp_pack__crtp_packet_handler__packet handler__split_fields11)))) ((_ int2bv 8) 1))))
...
(assert (= temp___3851 (mk___rep1 o37)))
(assert (= result2 (mk___split_fields__ref1 handler__split_fields11)))
(assert (= handler__split_fields12 (us_split_fields3 temp___3851)))
