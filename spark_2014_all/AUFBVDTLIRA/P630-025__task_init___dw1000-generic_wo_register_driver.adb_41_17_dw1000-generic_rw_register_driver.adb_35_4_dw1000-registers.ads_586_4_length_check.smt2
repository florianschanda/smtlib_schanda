...
(define-fun dynamic_invariant ((temp___expr_6919 us_t1) (temp___is_init_6916 Bool) (temp___skip_constant_6917 Bool) (temp___do_toplevel_6918 Bool)) Bool (=> (not (= temp___skip_constant_6917 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6919) (last3 temp___expr_6919)) (and (= (first3 temp___expr_6919) 1) (= (last3 temp___expr_6919) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_6935 us_t2) (temp___is_init_6932 Bool) (temp___skip_constant_6933 Bool) (temp___do_toplevel_6934 Bool)) Bool (=> (not (= temp___skip_constant_6933 true)) (and (dynamic_property3 1 2 (first5 temp___expr_6935) (last5 temp___expr_6935)) (and (= (first5 temp___expr_6935) 1) (= (last5 temp___expr_6935) 2)))))
...
(assert (and (= (mk___t2 temp___8175 temp___81751) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8175 temp___81751) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___81751)) (to_rep (last4 temp___81751))) (+ (- (to_rep (last4 temp___81751)) (to_rep (first4 temp___81751))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8175 temp___8176))
(assert (= (mk1 (to_rep (first4 temp___81751)) (to_rep (last4 temp___81751))) temp___81761))
(assert (not (= (ite (<= (to_rep (first2 temp___81761)) (to_rep (last2 temp___81761))) (+ (- (to_rep (last2 temp___81761)) (to_rep (first2 temp___81761))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
