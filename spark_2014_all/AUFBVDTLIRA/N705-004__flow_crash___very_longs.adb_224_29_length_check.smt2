...
(assert (not (= (ite (<= (to_rep2 (first4 temp___9431)) (to_rep2 (last4 temp___9431))) (+ (- (to_rep2 (last4 temp___9431)) (to_rep2 (first4 temp___9431))) 1) 0) (ite (<= 1 (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l)))) (+ (- (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))) 1) 1) 0))))
(check-sat)
(exit)
