...
(define-fun r__split_fields21 () us_split_fields (mk___split_fields r__split_fields15 r__split_fields16 r__split_fields17))
(define-fun r__split_fields22 () us_split_fields (mk___split_fields r__split_fields12 r__split_fields13 r__split_fields14))
(define-fun r__split_fields23 () us_split_fields (mk___split_fields r__split_fields9 r__split_fields10 r__split_fields11))
(define-fun r__split_fields24 () us_split_fields (mk___split_fields r__split_fields6 r__split_fields7 r__split_fields8))
(define-fun r__split_fields25 () us_split_fields (mk___split_fields r__split_fields3 r__split_fields4 r__split_fields5))
(define-fun r__split_fields26 () us_split_fields (mk___split_fields r__split_fields r__split_fields1 r__split_fields2))
(assert (in_range x))
(assert (in_range y))
(assert (in_range z))
(assert (=> (<= (- 2147483648) 2147483647) (in_range h)))
(assert (= (let ((temp___223 (to_model (mk___rep r__split_fields26)))) (bool_eq (elts temp___223) (to_rep (first (rt temp___223))) (to_rep (last (rt temp___223))) (temp___219 0) ((_ int2bv 16) 1) ((_ int2bv 16) 0))) true))
(assert (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields26)) x))) (let ((temp___230 (to_model (mk___rep r__split_fields25)))) (bool_eq (elts temp___230) (to_rep (first (rt temp___230))) (to_rep (last (rt temp___230))) (elts temp___231) (to_rep (first (rt temp___231))) (to_rep (last (rt temp___231)))))) true))
(assert (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields25)) y))) (let ((temp___230 (to_model (mk___rep r__split_fields24)))) (bool_eq (elts temp___230) (to_rep (first (rt temp___230))) (to_rep (last (rt temp___230))) (elts temp___231) (to_rep (first (rt temp___231))) (to_rep (last (rt temp___231)))))) true))
(assert (and (and (= (let ((temp___235 (func_pop (to_model (mk___rep r__split_fields24))))) (let ((temp___234 (to_model (mk___rep r__split_fields23)))) (bool_eq (elts temp___234) (to_rep (first (rt temp___234))) (to_rep (last (rt temp___234))) (elts temp___235) (to_rep (first (rt temp___235))) (to_rep (last (rt temp___235)))))) true) (= h1 (func_head (to_model (mk___rep r__split_fields24))))) (in_range h1)))
(assert (= h1 x))
(assert (= (let ((temp___231 (func_push (to_model (mk___rep r__split_fields23)) z))) (let ((temp___230 (to_model (mk___rep r__split_fields22)))) (bool_eq (elts temp___230) (to_rep (first (rt temp___230))) (to_rep (last (rt temp___230))) (elts temp___231) (to_rep (first (rt temp___231))) (to_rep (last (rt temp___231)))))) true))
(assert (and (and (= (let ((temp___235 (func_pop (to_model (mk___rep r__split_fields22))))) (let ((temp___234 (to_model (mk___rep r__split_fields21)))) (bool_eq (elts temp___234) (to_rep (first (rt temp___234))) (to_rep (last (rt temp___234))) (elts temp___235) (to_rep (first (rt temp___235))) (to_rep (last (rt temp___235)))))) true) (= h2 (func_head (to_model (mk___rep r__split_fields22))))) (in_range h2)))
(assert (= h2 y))
(assert (and (and (= (let ((temp___235 (func_pop (to_model (mk___rep r__split_fields21))))) (let ((temp___234 (to_model (mk___rep (mk___split_fields r__split_fields18 r__split_fields19 r__split_fields20))))) (bool_eq (elts temp___234) (to_rep (first (rt temp___234))) (to_rep (last (rt temp___234))) (elts temp___235) (to_rep (first (rt temp___235))) (to_rep (last (rt temp___235)))))) true) (= h3 (func_head (to_model (mk___rep r__split_fields21))))) (in_range h3)))
(assert (not (= h3 z)))
(check-sat)
(exit)
