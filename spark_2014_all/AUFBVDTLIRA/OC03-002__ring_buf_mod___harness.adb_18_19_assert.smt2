...
(assert (= h2 y))
(assert (and (and (= (let ((temp___235 (func_pop (to_model (mk___rep (mk___split_fields r__split_fields15 r__split_fields16 r__split_fields17)))))) (let ((temp___234 (to_model (mk___rep (mk___split_fields r__split_fields18 r__split_fields19 r__split_fields20))))) (bool_eq (elts temp___234) (to_rep (first (rt temp___234))) (to_rep (last (rt temp___234))) (elts temp___235) (to_rep (first (rt temp___235))) (to_rep (last (rt temp___235)))))) true) (= h3 (func_head (to_model (mk___rep (mk___split_fields r__split_fields15 r__split_fields16 r__split_fields17)))))) (in_range h3)))
(assert (not (= h3 z)))
(check-sat)
(exit)
