...
(assert (not (= i rsp8)))
(assert (not (= i (bvadd rsp8 #x0000000000000001))))
(assert (not (= i (bvadd rsp8 #x0000000000000002))))
(assert (not (= i (bvadd rsp8 #x0000000000000003))))
(assert (not (= i (bvadd rsp8 #x0000000000000004))))
(assert (not (= i (bvadd rsp8 #x0000000000000005))))
(assert (not (= i (bvadd rsp8 #x0000000000000006))))
(assert (not (= i (bvadd rsp8 #x0000000000000007))))
