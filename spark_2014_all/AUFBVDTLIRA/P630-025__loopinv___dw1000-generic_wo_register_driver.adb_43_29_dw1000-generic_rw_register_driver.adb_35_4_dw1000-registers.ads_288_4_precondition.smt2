...
(declare-const temp___8590 (Array Int bits_8))
(declare-const temp___85901 t1)
...
(assert (= (ite (<= (to_rep (first4 temp___85891)) (to_rep (last4 temp___85891))) (+ (- (to_rep (last4 temp___85891)) (to_rep (first4 temp___85891))) 1) 0) (ite (<= 1 41) (+ (- 41 1) 1) 0)))
(assert (= temp___8589 temp___8590))
(assert (= (mk1 (to_rep (first4 temp___85891)) (to_rep (last4 temp___85891))) temp___85901))
(assert (= (ite (<= (to_rep (first2 temp___85901)) (to_rep (last2 temp___85901))) (+ (- (to_rep (last2 temp___85901)) (to_rep (first2 temp___85901))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8590 temp___85901)))
(assert (= o2 o))
