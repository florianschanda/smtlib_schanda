...
(assert (= (ite (<= (to_rep (first4 temp___78171)) (to_rep (last4 temp___78171))) (+ (- (to_rep (last4 temp___78171)) (to_rep (first4 temp___78171))) 1) 0) (ite (<= 1 41) (+ (- 41 1) 1) 0)))
(assert (= temp___7817 temp___7818))
(assert (= (mk1 (to_rep (first4 temp___78171)) (to_rep (last4 temp___78171))) temp___78181))
(assert (= (ite (<= (to_rep (first2 temp___78181)) (to_rep (last2 temp___78181))) (+ (- (to_rep (last2 temp___78181)) (to_rep (first2 temp___78181))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
