...
(assert (= o22 (+ b_first o21)))
(assert (and (= o23 o22) (in_range1 o22)))
(assert (= o24 (ite (<= o23 (to_rep (last (rt b)))) true false)))
(assert (and (= o18 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o19 (+ b_first o18)))
(assert (and (= o20 o19) (in_range1 o19)))
(assert (= o25 (ite (<= (to_rep (first (rt b))) o20) true false)))
...
(assert (= o14 (+ c_first o13)))
(assert (and (= o15 o14) (in_range1 o14)))
(assert (= o16 (ite (<= o15 (to_rep (last (rt c)))) true false)))
(assert (and (= o10 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o11 (+ c_first o10)))
(assert (and (= o12 o11) (in_range1 o11)))
(assert (= o17 (ite (<= (to_rep (first (rt c))) o12) true false)))
