...
(define-fun dynamic_invariant ((temp___expr_6750 us_t1) (temp___is_init_6747 Bool) (temp___skip_constant_6748 Bool) (temp___do_toplevel_6749 Bool)) Bool (=> (not (= temp___skip_constant_6748 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6750) (last3 temp___expr_6750)) (and (= (first3 temp___expr_6750) 1) (= (last3 temp___expr_6750) 2)))))
