...
(assert (=> (in_range9 n3) (and (= o32 (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o2)) (= (bool_eq4 o32 (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o2)) true))))
...
(assert (and (= temp___675 (get1 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields1)) o28)) (= (bool_eq4 temp___675 (get1 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields1)) o28)) true)))
