...
(define-fun dynamic_invariant ((temp___expr_5399 us_t1) (temp___is_init_5395 Bool) (temp___skip_constant_5396 Bool) (temp___do_toplevel_5397 Bool) (temp___do_typ_inv_5398 Bool)) Bool (=> (not (= temp___skip_constant_5396 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5399) (last3 temp___expr_5399)) (and (= (first3 temp___expr_5399) 1) (= (last3 temp___expr_5399) 4)))))
