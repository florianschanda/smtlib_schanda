...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__drx_tune2_type__drx_tune2 bits_32)))))
(define-fun us_split_fields_DRX_TUNE2__projection ((a us_split_fields)) bits_32 (rec__dw1000__register_types__drx_tune2_type__drx_tune2 a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___49__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___49__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__drx_tune2_type__drx_tune2 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__drx_tune2_type__drx_tune2 (us_split_fields1 b)))) true false))
...
(assert (<= 0 dw1000__register_types__drx_tune2_type__drx_tune2__first__bit))
(assert (< dw1000__register_types__drx_tune2_type__drx_tune2__first__bit dw1000__register_types__drx_tune2_type__drx_tune2__last__bit))
(assert (<= 0 dw1000__register_types__drx_tune2_type__drx_tune2__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((drx_tune2_type__ref (mk_drx_tune2_type__ref (drx_tune2_type__content us_rep)))))
(define-fun drx_tune2_type__ref___projection ((a drx_tune2_type__ref)) us_rep (drx_tune2_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___113__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___80__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___80__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_4923 us_t1) (temp___is_init_4920 Bool) (temp___skip_constant_4921 Bool) (temp___do_toplevel_4922 Bool)) Bool (=> (not (= temp___skip_constant_4921 true)) (and (dynamic_property2 1 4 (first3 temp___expr_4923) (last3 temp___expr_4923)) (and (= (first3 temp___expr_4923) 1) (= (last3 temp___expr_4923) 4)))))
