...
(assert (= (let ((subject rsp)) rsp29) (let ((subject rsp)) rsp28)))
(assert (and (not (= zeroflag11 true)) (= (= signflag11 true) (= overflowflag11 true))))
(assert (and (= o76 (readmem64 (let ((subject rbp)) rbp11) (let ((subject memory)) memory6))) (and (and (and (and (and (and (and (= (bvand o76 ((_ int2bv 64) 255)) ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory6) (let ((subject rbp)) rbp11))))) (= (bvand o76 ((_ int2bv 64) 65280)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory6) (bvadd (let ((subject rbp)) rbp11) ((_ int2bv 64) 1))))) ((_ int2bv 64) 256)))) (= (bvand o76 ((_ int2bv 64) 16711680)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory6) (bvadd (let ((subject rbp)) rbp11) ((_ int2bv 64) 2))))) ((_ int2bv 64) 65536)))) (= (bvand o76 ((_ int2bv 64) 4278190080)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory6) (bvadd (let ((subject rbp)) rbp11) ((_ int2bv 64) 3))))) ((_ int2bv 64) 16777216)))) (= (bvand o76 ((_ int2bv 64) 1095216660480)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory6) (bvadd (let ((subject rbp)) rbp11) ((_ int2bv 64) 4))))) ((_ int2bv 64) 4294967296)))) (= (bvand o76 ((_ int2bv 64) 280375465082880)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory6) (bvadd (let ((subject rbp)) rbp11) ((_ int2bv 64) 5))))) ((_ int2bv 64) 1099511627776)))) (= (bvand o76 ((_ int2bv 64) 71776119061217280)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory6) (bvadd (let ((subject rbp)) rbp11) ((_ int2bv 64) 6))))) ((_ int2bv 64) 281474976710656)))) (= (bvand o76 ((_ int2bv 64) 18374686479671623680)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory6) (bvadd (let ((subject rbp)) rbp11) ((_ int2bv 64) 7))))) ((_ int2bv 64) 72057594037927936))))))
(assert (= result59 (mk_t__ref3 xmm011)))
(assert (= xmm012 o76))
(assert (= (writereg32post (let ((subject rdi)) rdi17) ((_ int2bv 32) 4198699)) true))
(assert (= (writereg32post rax12 ((_ int2bv 32) 1)) true))
(assert (and (= o77 (ebx (let ((subject rbx)) rbx11))) (= o77 (readreg32 (let ((subject rbx)) rbx11)))))
(assert (= o78 (bvadd o77 ((_ int2bv 32) 1))))
(assert (= (writereg32post (let ((subject rbx)) rbx12) o78) true))
(assert (= result60 (let ((subject rbp)) (mk_t__ref3 rbp11))))
(assert (= (let ((subject rbp)) rbp12) (bvadd (let ((subject rbp)) rbp11) ((_ int2bv 64) 8))))
(assert (= result61 (let ((subject rsp)) (mk_t__ref3 rsp29))))
(assert (= (let ((subject rsp)) rsp30) (bvsub (let ((subject rsp)) rsp29) ((_ int2bv 64) 8))))
(assert (= (let ((subject rsp)) rsp31) (bvadd (let ((subject rsp)) rsp30) ((_ int2bv 64) 8))))
(assert (and (= o79 (ebx (let ((subject rbx)) rbx12))) (= o79 (readreg32 (let ((subject rbx)) rbx12)))))
(assert (and (= o80 (readmem32 (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) (let ((subject memory)) memory6))) (and (and (and (= (bvand o80 ((_ int2bv 32) 255)) ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)))))) (= (bvand o80 ((_ int2bv 32) 65280)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 1))))) ((_ int2bv 32) 256)))) (= (bvand o80 ((_ int2bv 32) 16711680)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 2))))) ((_ int2bv 32) 65536)))) (= (bvand o80 ((_ int2bv 32) 4278190080)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 3))))) ((_ int2bv 32) 16777216))))))
(assert (= o81 (bvsub o80 o79)))
(assert (= o82 (ite (= o81 ((_ int2bv 32) 0)) true false)))
(assert (= result62 (mk_bool__ref zeroflag11)))
(assert (= zeroflag12 o82))
(assert (and (= o83 (ebx (let ((subject rbx)) rbx12))) (= o83 (readreg32 (let ((subject rbx)) rbx12)))))
(assert (and (= o84 (readmem32 (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) (let ((subject memory)) memory6))) (and (and (and (= (bvand o84 ((_ int2bv 32) 255)) ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)))))) (= (bvand o84 ((_ int2bv 32) 65280)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 1))))) ((_ int2bv 32) 256)))) (= (bvand o84 ((_ int2bv 32) 16711680)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 2))))) ((_ int2bv 32) 65536)))) (= (bvand o84 ((_ int2bv 32) 4278190080)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 3))))) ((_ int2bv 32) 16777216))))))
(assert (= o85 (bvsub o84 o83)))
(assert (= o86 (ite (bvugt o85 ((_ int2bv 32) 2147483647)) true false)))
(assert (= result63 (mk_bool__ref signflag11)))
(assert (= signflag12 o86))
(assert (and (= o87 (ebx (let ((subject rbx)) rbx12))) (= o87 (readreg32 (let ((subject rbx)) rbx12)))))
(assert (and (= o88 (readmem32 (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) (let ((subject memory)) memory6))) (and (and (and (= (bvand o88 ((_ int2bv 32) 255)) ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)))))) (= (bvand o88 ((_ int2bv 32) 65280)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 1))))) ((_ int2bv 32) 256)))) (= (bvand o88 ((_ int2bv 32) 16711680)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 2))))) ((_ int2bv 32) 65536)))) (= (bvand o88 ((_ int2bv 32) 4278190080)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 3))))) ((_ int2bv 32) 16777216))))))
(assert (= o89 (ite (bvult o88 o87) true false)))
(assert (= result64 (mk_bool__ref carryflag11)))
(assert (= carryflag12 o89))
(assert (=> (not (= signflag12 true)) (and (= o93 (readmem32 (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) (let ((subject memory)) memory6))) (and (and (and (= (bvand o93 ((_ int2bv 32) 255)) ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)))))) (= (bvand o93 ((_ int2bv 32) 65280)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 1))))) ((_ int2bv 32) 256)))) (= (bvand o93 ((_ int2bv 32) 16711680)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 2))))) ((_ int2bv 32) 65536)))) (= (bvand o93 ((_ int2bv 32) 4278190080)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 3))))) ((_ int2bv 32) 16777216)))))))
(assert (=> (not (= signflag12 true)) (= result65 (ite (bvugt o93 ((_ int2bv 32) 2147483647)) true false))))
(assert (=> (= signflag12 true) (= result65 false)))
(assert (=> (= result65 true) (and (= o92 (ebx (let ((subject rbx)) rbx12))) (= o92 (readreg32 (let ((subject rbx)) rbx12))))))
(assert (=> (= result65 true) (= o94 (ite (bvule o92 ((_ int2bv 32) 2147483647)) true false))))
(assert (=> (not (= result65 true)) (= o94 false)))
(assert (=> (= signflag12 true) (and (= o91 (ebx (let ((subject rbx)) rbx12))) (= o91 (readreg32 (let ((subject rbx)) rbx12))))))
(assert (=> (= signflag12 true) (= result66 (ite (bvugt o91 ((_ int2bv 32) 2147483647)) true false))))
(assert (=> (not (= signflag12 true)) (= result66 false)))
(assert (=> (= result66 true) (and (= o90 (readmem32 (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) (let ((subject memory)) memory6))) (and (and (and (= (bvand o90 ((_ int2bv 32) 255)) ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)))))) (= (bvand o90 ((_ int2bv 32) 65280)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 1))))) ((_ int2bv 32) 256)))) (= (bvand o90 ((_ int2bv 32) 16711680)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 2))))) ((_ int2bv 32) 65536)))) (= (bvand o90 ((_ int2bv 32) 4278190080)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory6) (bvadd (bvsub (bvadd (let ((subject rsp)) rsp31) ((_ int2bv 64) 152)) ((_ int2bv 64) 108)) ((_ int2bv 64) 3))))) ((_ int2bv 32) 16777216)))))))
(assert (=> (= result66 true) (= o95 (ite (bvule o90 ((_ int2bv 32) 2147483647)) true false))))
(assert (=> (not (= result66 true)) (= o95 false)))
(assert (= o96 (ite (= o95 false) o94 true)))
(assert (= result67 (mk_bool__ref overflowflag11)))
(assert (= overflowflag12 o96))
(assert (not (= zeroflag12 true)))
(assert (= (to_int5 signflag12) (to_int5 overflowflag12)))
(assert (= rdi18 (let ((subject rdi)) (mk_t__ref3 rdi17))))
(assert (= rbp13 (let ((subject rbp)) (mk_t__ref3 rbp12))))
(assert (= rsp32 (let ((subject rsp)) (mk_t__ref3 rsp31))))
(assert (= rbx13 (let ((subject rbx)) (mk_t__ref3 rbx12))))
(assert (= rax13 (mk_t__ref3 rax12)))
(assert (= xmm013 (mk_t__ref3 xmm012)))
(assert (= overflowflag13 (mk_bool__ref overflowflag12)))
(assert (= signflag13 (mk_bool__ref signflag12)))
(assert (= carryflag13 (mk_bool__ref carryflag12)))
(assert (= zeroflag13 (mk_bool__ref zeroflag12)))
(assert (= rdi19 rdi17))
(assert (= rbp14 rbp12))
(assert (= rsp33 rsp31))
(assert (= rbx14 rbx12))
(assert (= rax14 rax12))
(assert (= xmm014 xmm012))
(assert (= overflowflag14 overflowflag12))
(assert (= signflag14 signflag12))
(assert (= carryflag14 carryflag12))
(assert (= zeroflag14 zeroflag12))
(assert (not (= (t__content3 rsp32) (let ((subject rsp)) rsp28))))
(check-sat)
(exit)
