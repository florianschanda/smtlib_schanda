...
(assert (= (ite signflag8 1 0) (ite overflowflag8 1 0)))
...
(assert (= xmm010 o76))
(assert (= (writereg32post (let ((subject rdi)) rdi13) #x0040112B) true))
(assert (= (writereg32post rax7 #x00000001) true))
(assert (and (= o77 (ebx (let ((subject rbx)) rbx9))) (= o77 (readreg32 (let ((subject rbx)) rbx9)))))
(assert (= o78 (bvadd o77 #x00000001)))
(assert (= (writereg32post (let ((subject rbx)) rbx10) o78) true))
(assert (= result60 (let ((subject rbp)) (mk_t__ref3 rbp9))))
(assert (= (let ((subject rbp)) rbp10) (bvadd (let ((subject rbp)) rbp9) #x0000000000000008)))
(assert (= result61 (let ((subject rsp)) (mk_t__ref3 rsp27))))
(assert (= (let ((subject rsp)) rsp28) (bvsub (let ((subject rsp)) rsp27) #x0000000000000008)))
(assert (= (let ((subject rsp)) rsp29) (bvadd (let ((subject rsp)) rsp28) #x0000000000000008)))
...
(assert (= o82 (ite (= o81 #x00000000) true false)))
...
(assert (= o86 (ite (bvugt o85 #x7FFFFFFF) true false)))
...
(assert (=> (not (= signflag10 true)) (= result65 (ite (bvugt o93 #x7FFFFFFF) true false))))
...
(assert (=> (= result65 true) (= o94 (ite (bvule o92 #x7FFFFFFF) true false))))
...
(assert (=> (= signflag10 true) (= result66 (ite (bvugt o91 #x7FFFFFFF) true false))))
...
(assert (=> (= result66 true) (= o95 (ite (bvule o90 #x7FFFFFFF) true false))))
...
(assert (= (ite signflag10 1 0) (ite overflowflag10 1 0)))
