...
(assert (= result62 (mk_bool__ref zeroflag9)))
(assert (= zeroflag10 o82))
(assert (and (= o83 (ebx (let ((subject rbx)) rbx10))) (= o83 (readreg32 (let ((subject rbx)) rbx10)))))
...
(assert (= result63 (mk_bool__ref signflag9)))
(assert (= signflag10 o86))
(assert (and (= o87 (ebx (let ((subject rbx)) rbx10))) (= o87 (readreg32 (let ((subject rbx)) rbx10)))))
...
(assert (= result67 (mk_bool__ref overflowflag9)))
(assert (= overflowflag10 o96))
(assert (not (= zeroflag10 true)))
(assert (= (to_int5 signflag10) (to_int5 overflowflag10)))
(assert (= rdi14 (let ((subject rdi)) (mk_t__ref3 rdi13))))
(assert (= rbp11 (let ((subject rbp)) (mk_t__ref3 rbp10))))
(assert (= rsp30 (let ((subject rsp)) (mk_t__ref3 rsp29))))
(assert (= rbx11 (let ((subject rbx)) (mk_t__ref3 rbx10))))
(assert (= rax8 (mk_t__ref3 rax7)))
(assert (= xmm011 (mk_t__ref3 xmm010)))
(assert (= overflowflag11 (mk_bool__ref overflowflag10)))
(assert (= signflag11 (mk_bool__ref signflag10)))
(assert (= carryflag11 (mk_bool__ref carryflag10)))
(assert (= zeroflag11 (mk_bool__ref zeroflag10)))
(assert (= rdi15 rdi13))
(assert (= rbp12 rbp10))
(assert (= rsp31 rsp29))
(assert (= rbx12 rbx10))
(assert (= rax9 rax7))
(assert (= xmm012 xmm010))
...
(assert (not (= (t__content3 rsp30) (let ((subject rsp)) rsp26))))
(check-sat)
(exit)
