...
(assert (= (ite (<= (to_rep (first4 temp___85981)) (to_rep (last4 temp___85981))) (+ (- (to_rep (last4 temp___85981)) (to_rep (first4 temp___85981))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8598 temp___8599))
(assert (= (mk1 (to_rep (first4 temp___85981)) (to_rep (last4 temp___85981))) temp___85991))
(assert (= (ite (<= (to_rep (first2 temp___85991)) (to_rep (last2 temp___85991))) (+ (- (to_rep (last2 temp___85991)) (to_rep (first2 temp___85991))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8599 temp___85991)))
(assert (= o2 o))
