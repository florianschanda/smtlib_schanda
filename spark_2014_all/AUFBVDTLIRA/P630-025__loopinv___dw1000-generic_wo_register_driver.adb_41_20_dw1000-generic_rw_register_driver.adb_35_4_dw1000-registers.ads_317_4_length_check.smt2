...
(define-fun dynamic_invariant ((temp___expr_4084 us_t1) (temp___is_init_4080 Bool) (temp___skip_constant_4081 Bool) (temp___do_toplevel_4082 Bool) (temp___do_typ_inv_4083 Bool)) Bool (=> (not (= temp___skip_constant_4081 true)) (and (dynamic_property2 1 4 (first3 temp___expr_4084) (last3 temp___expr_4084)) (and (= (first3 temp___expr_4084) 1) (= (last3 temp___expr_4084) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_4107 us_t2) (temp___is_init_4103 Bool) (temp___skip_constant_4104 Bool) (temp___do_toplevel_4105 Bool) (temp___do_typ_inv_4106 Bool)) Bool (=> (not (= temp___skip_constant_4104 true)) (and (dynamic_property3 1 4 (first5 temp___expr_4107) (last5 temp___expr_4107)) (and (= (first5 temp___expr_4107) 1) (= (last5 temp___expr_4107) 4)))))
...
(declare-const temp___86281 t2)
(define-fun temp___86282 () us_t2 (mk___t2 temp___8628 temp___86281))
...
(assert (and (= temp___86282 (register_to_bytes reg)) (dynamic_invariant1 temp___86282 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___86281)) (to_rep (last4 temp___86281))) (+ (- (to_rep (last4 temp___86281)) (to_rep (first4 temp___86281))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
