...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o75 k)) #x00000000))))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (omod (oadd (num_of_big_int (mk___t o76 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o76 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true)))
...
(assert (= o71 (omultiply o65 o70)))
(assert (= o73 (osubtract o71 o72)))
(assert (= o62 (from_word32 a_msw3)))
(assert (and (= o57 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o58 (+ o57 1)))
(assert (and (= o59 o58) (in_range1 o58)))
(assert (and (= o60 o59) (in_range2 o59)))
(assert (and (= o56 (base Tuple0)) (= o56 (oexpon (from_word32 #x00000002) 32))))
(assert (= o61 (oexpon o56 o60)))
(assert (= o63 (omultiply o61 o62)))
(assert (and (= o51 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o52 (+ o51 1)))
(assert (and (= o53 o52) (in_range1 o52)))
(assert (and (= o54 o53) (in_range2 o53)))
(assert (= o55 (num_of_big_int (mk___t o79 (mk (to_rep a__first) (to_rep a__last))) a_first o54)))
(assert (= o64 (oadd o55 o63)))
(assert (= o74 (olt o64 o73)))
