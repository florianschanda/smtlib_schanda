...
(define-fun dynamic_invariant1 ((temp___expr_271 Int) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool)) Bool (=> (or (= temp___is_init_268 true) (<= 1 2147483647)) (in_range1 temp___expr_271)))
...
(assert (and (= us (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))))
(assert (and (= us1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range1 (to_rep (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))))
