...
(assert (= newipv41 #x00000000))
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i Int)) (=> (and (<= begidx2 i) (<= i endidx1)) (and (<= 48 (to_rep (select zonefileline i))) (<= (to_rep (select zonefileline i)) 57)))))) (and (and (in_range3 begidx2) (in_range3 endidx1)) (in_range2 foundtype1))))
(assert (not (= foundtype1 4)))
(assert (< endidx1 zlength))
(assert (not (< endidx1 zlength)))
(check-sat)
(exit)
