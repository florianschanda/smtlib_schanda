...
(assert (and (= o (is_zero number)) (= (= o true) (forall ((j1 Int)) (=> (and (<= 1 j1) (<= j1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))) (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j1)) #x00))))))
...
(assert (=> (< digit_count3 index2) (forall ((j1 Int)) (=> (and (<= (+ digit_count3 1) j1) (<= j1 index2)) (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j1)) #x00)))))
(assert (and (and (=> (<= 0 65536) (in_range3 digit_count3)) (=> (<= 1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))) (dynamic_property2 1 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) index2))) (and (<= 1 index2) (<= index2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number)))))))))
(assert (< digit_count3 index2))
(assert (<= (+ digit_count3 1) j))
(assert (<= j index2))
(assert (not (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) j)))
(check-sat)
(exit)
