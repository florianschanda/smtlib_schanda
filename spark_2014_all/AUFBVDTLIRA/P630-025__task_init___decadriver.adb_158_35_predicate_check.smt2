...
(define-fun temp___45934 () us_rep (mk___rep (mk___split_fields temp___4593 temp___45931 temp___45932 temp___45933)))
...
(assert (= o25 (store (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__5)) next_idx1 o53)))
(assert (= o25 o26))
...
(assert (= o45 (store (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__6)) next_idx1 o52)))
(assert (= o45 o46))
