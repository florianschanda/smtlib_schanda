...
(define-fun register_byte_array__ref___66__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_4398 us_t1) (temp___is_init_4395 Bool) (temp___skip_constant_4396 Bool) (temp___do_toplevel_4397 Bool)) Bool (=> (not (= temp___skip_constant_4396 true)) (and (dynamic_property2 1 4 (first3 temp___expr_4398) (last3 temp___expr_4398)) (and (= (first3 temp___expr_4398) 1) (= (last3 temp___expr_4398) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___27__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_4423 us_t2) (temp___is_init_4420 Bool) (temp___skip_constant_4421 Bool) (temp___do_toplevel_4422 Bool)) Bool (=> (not (= temp___skip_constant_4421 true)) (and (dynamic_property3 1 4 (first5 temp___expr_4423) (last5 temp___expr_4423)) (and (= (first5 temp___expr_4423) 1) (= (last5 temp___expr_4423) 4)))))
...
(assert (and (= temp___79052 (register_to_bytes reg)) (dynamic_invariant1 temp___79052 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___79051)) (to_rep (last4 temp___79051))) (+ (- (to_rep (last4 temp___79051)) (to_rep (first4 temp___79051))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7905 temp___7906))
(assert (= (mk1 (to_rep (first4 temp___79051)) (to_rep (last4 temp___79051))) temp___79061))
(assert (= (ite (<= (to_rep (first2 temp___79061)) (to_rep (last2 temp___79061))) (+ (- (to_rep (last2 temp___79061)) (to_rep (first2 temp___79061))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
