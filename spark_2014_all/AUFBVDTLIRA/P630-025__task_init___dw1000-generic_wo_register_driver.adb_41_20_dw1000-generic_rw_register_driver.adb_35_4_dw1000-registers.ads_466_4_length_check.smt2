...
(assert (and (= temp___80272 (register_to_bytes reg)) (dynamic_invariant1 temp___80272 true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___80271)) (to_rep (last4 temp___80271))) (+ (- (to_rep (last4 temp___80271)) (to_rep (first4 temp___80271))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
