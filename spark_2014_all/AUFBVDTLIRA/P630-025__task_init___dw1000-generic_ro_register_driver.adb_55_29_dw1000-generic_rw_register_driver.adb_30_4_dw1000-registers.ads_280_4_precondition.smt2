...
(define-fun dynamic_invariant ((temp___expr_3196 us_t1) (temp___is_init_3193 Bool) (temp___skip_constant_3194 Bool) (temp___do_toplevel_3195 Bool)) Bool (=> (not (= temp___skip_constant_3194 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3196) (last3 temp___expr_3196)) (and (= (first3 temp___expr_3196) 1) (= (last3 temp___expr_3196) 4)))))
