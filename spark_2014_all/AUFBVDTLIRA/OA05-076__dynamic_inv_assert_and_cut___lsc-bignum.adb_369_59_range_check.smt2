...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o82 k)) #x00000000))))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (omod (oadd (num_of_big_int (mk___t o83 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o83 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true)))
...
(assert (and (= o76 o75) (in_range2 o75)))
(assert (= o77 (num_of_big_int m m_first o76)))
(assert (= o72 (from_word32 #x00000002)))
(assert (= o78 (omultiply o72 o77)))
(assert (= o80 (osubtract o78 o79)))
(assert (= o69 (from_word32 a_msw3)))
...
(assert (= o70 (omultiply o68 o69)))
(assert (and (= o58 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o59 (+ o58 1)))
(assert (and (= o60 o59) (in_range1 o59)))
(assert (and (= o61 o60) (in_range2 o60)))
(assert (= o62 (num_of_big_int (mk___t o86 (mk (to_rep a__first) (to_rep a__last))) a_first o61)))
(assert (= o71 (oadd o62 o70)))
(assert (= o81 (olt o71 o80)))
...
(assert (= o49 (- o48 a_first)))
(assert (and (= o50 o49) (in_range1 o49)))
(assert (and (= o51 o50) (in_range2 o50)))
(assert (and (= o46 (base Tuple0)) (= o46 (oexpon (from_word32 #x00000002) 32))))
