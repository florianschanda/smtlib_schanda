...
(define-fun in_range3 ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 0) x) (bvule x ((_ int2bv 32) 1073741823))))
...
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x ((_ int2bv 32) 1073741824)))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(define-fun dynamic_invariant ((temp___expr_6982 us_t1) (temp___is_init_6979 Bool) (temp___skip_constant_6980 Bool) (temp___do_toplevel_6981 Bool)) Bool (=> (not (= temp___skip_constant_6980 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6982) (last3 temp___expr_6982)) (and (= (first3 temp___expr_6982) 1) (= (last3 temp___expr_6982) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_7000 us_t2) (temp___is_init_6997 Bool) (temp___skip_constant_6998 Bool) (temp___do_toplevel_6999 Bool)) Bool (=> (not (= temp___skip_constant_6998 true)) (and (dynamic_property3 1 4 (first5 temp___expr_7000) (last5 temp___expr_7000)) (and (= (first5 temp___expr_7000) 1) (= (last5 temp___expr_7000) 4)))))
...
(assert (and (= (mk___t2 temp___8182 temp___81821) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8182 temp___81821) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___81821)) (to_rep (last4 temp___81821))) (+ (- (to_rep (last4 temp___81821)) (to_rep (first4 temp___81821))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8182 temp___8183))
(assert (= (mk1 (to_rep (first4 temp___81821)) (to_rep (last4 temp___81821))) temp___81831))
(assert (not (= (ite (<= (to_rep (first2 temp___81831)) (to_rep (last2 temp___81831))) (+ (- (to_rep (last2 temp___81831)) (to_rep (first2 temp___81831))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
