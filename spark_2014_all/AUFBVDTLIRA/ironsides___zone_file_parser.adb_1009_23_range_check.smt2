...
(assert (= o39 (+ begidx2 3)))
(assert (= o40 (select zonefileline o39)))
(assert (= o41 (to_rep o40)))
(assert (= o42 (ite (= o41 76) true false)))
(assert (and (<= 1 (+ begidx2 2)) (<= (+ begidx2 2) 256)))
(assert (= o34 (+ begidx2 2)))
(assert (= o35 (select zonefileline o34)))
(assert (= o36 (to_rep o35)))
(assert (= o37 (ite (= o36 84) true false)))
(assert (and (<= 1 (+ begidx2 1)) (<= (+ begidx2 1) 256)))
(assert (= o31 (+ begidx2 1)))
(assert (= o32 (select zonefileline o31)))
(assert (= o33 (to_rep o32)))
(assert (= o38 (ite (= o33 84) true false)))
(assert (= o43 (ite (= o38 true) o37 false)))
(assert (= result7 (ite (= o43 true) o42 false)))
(assert (= result7 true))
(assert (=> (and (< begidx2 zlength) (< endidx1 zlength)) (and (= o44 (+ endidx1 1)) (in_range4 (+ endidx1 1)))))
(assert (=> (and (< begidx2 zlength) (< endidx1 zlength)) (= begidx2 result8)))
(assert (=> (and (< begidx2 zlength) (< endidx1 zlength)) (= begidx5 o44)))
(assert (=> (and (< begidx2 zlength) (< endidx1 zlength)) (and (and (and (and (<= begidx6 endidx3) (<= begidx6 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i4 Int)) (=> (and (<= begidx6 i4) (<= i4 endidx3)) (and (<= 48 (to_rep (select zonefileline i4))) (<= (to_rep (select zonefileline i4)) 57)))))) (and (and (in_range4 begidx6) (in_range4 endidx3)) (in_range3 foundtype3)))))
(assert (=> (not (and (< begidx2 zlength) (< endidx1 zlength))) (= foundtype3 foundtype1)))
(assert (=> (not (and (< begidx2 zlength) (< endidx1 zlength))) (= endidx3 endidx1)))
(assert (=> (not (and (< begidx2 zlength) (< endidx1 zlength))) (= begidx6 begidx2)))
(assert (not (and (not (= foundtype3 0)) (not (= foundtype3 1)))))
(assert (= begidx6 r69b))
(assert (in_range4 r69b))
(assert (= endidx3 r70b))
(assert (in_range4 r70b))
(assert (<= r69b r70b))
(assert (not (<= (- 2147483648) r69b)))
(check-sat)
(exit)
