...
(assert (= (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select memory4 addr))) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr ((_ int2bv 64) 1))))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr ((_ int2bv 64) 2))))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select memory4 (bvadd addr ((_ int2bv 64) 3))))) ((_ int2bv 32) 16777216))) val__))
