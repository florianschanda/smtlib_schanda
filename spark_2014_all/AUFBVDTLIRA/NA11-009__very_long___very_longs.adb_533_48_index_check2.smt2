...
(declare-const o6 t)
(declare-const temp___1367 digit_index_type)
(declare-const temp___13671 (Array Int octet))
(declare-const temp___13672 t)
...
(declare-const temp___1371 us_rep)
...
(assert (= o5 o3))
(assert (= o6 o4))
(assert (= quotient__split_discrs (mk___split_discrs temp___1367)))
(assert (= temp___13671 o5))
(assert (= temp___13672 o6))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t quotient__split_fields quotient__split_fields1)))))
(assert (= quotient__split_fields2 (mk___split_fields (mk___t temp___13671 temp___13672))))
(assert (= quotient__split_discrs (mk___split_discrs temp___1367)))
...
(assert (= temp___1371 (mk___rep quotient__split_discrs o15)))
(assert (= result1 (mk___split_fields__ref quotient__split_fields2)))
(assert (= quotient__split_fields3 (us_split_fields1 temp___1371)))
(assert (= quotient__split_discrs (us_split_discrs1 temp___1371)))
...
(assert (and (dynamic_invariant6 (mk___rep1 u__split_discrs u__split_fields2) true true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r127b))))
(assert (and (<= (to_rep1 (first4 v__split_fields1)) divisor_index2) (<= divisor_index2 (to_rep1 (last5 v__split_fields1)))))
(assert (= o20 divisor_index2))
(assert (= o21 (select v__split_fields o20)))
(assert (= o22 (to_rep2 o21)))
(assert (= o23 ((_ zero_extend 8) o22)))
(assert (and (= o16 (+ j divisor_index2)) (in_range2 (+ j divisor_index2))))
(assert (= temp___1375 (- o16 1)))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1375) (<= temp___1375 (to_rep1 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))
(assert (= o17 temp___1375))
(assert (= o18 (select (elts1 (rec__very_longs__very_long__long_digits1 u__split_fields2)) o17)))
(assert (= o19 (to_rep2 o18)))
(assert (= o24 ((_ zero_extend 8) o19)))
(assert (= o25 (bvadd o24 o23)))
(assert (= o26 (bvadd o25 carry2)))
(assert (= result4 (mk_t__ref1 sum)))
(assert (= sum1 o26))
(assert (= o28 (takelsb_from16 sum1)))
(assert (= (to_rep2 o29) o28))
(assert (and (= o27 (+ j divisor_index2)) (in_range2 (+ j divisor_index2))))
(assert (= temp___1378 (- o27 1)))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1378)))
(check-sat)
(exit)
