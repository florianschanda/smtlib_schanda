...
(define-fun dynamic_invariant ((temp___expr_2920 us_t1) (temp___is_init_2917 Bool) (temp___skip_constant_2918 Bool) (temp___do_toplevel_2919 Bool)) Bool (=> (not (= temp___skip_constant_2918 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2920) (last3 temp___expr_2920)) (and (= (first3 temp___expr_2920) 1) (= (last3 temp___expr_2920) 4)))))
