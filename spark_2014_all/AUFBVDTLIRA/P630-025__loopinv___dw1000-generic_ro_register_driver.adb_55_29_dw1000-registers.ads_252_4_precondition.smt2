...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__rx_ttcki_type__rxttcki bits_32)))))
(define-fun us_split_fields_RXTTCKI__projection ((a us_split_fields)) bits_32 (rec__dw1000__register_types__rx_ttcki_type__rxttcki a))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__rx_ttcki_type__rxttcki (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_ttcki_type__rxttcki (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__rx_ttcki_type__rxttcki__first__bit Int)
(declare-const dw1000__register_types__rx_ttcki_type__rxttcki__last__bit Int)
(declare-const dw1000__register_types__rx_ttcki_type__rxttcki__position Int)
(assert (<= 0 dw1000__register_types__rx_ttcki_type__rxttcki__first__bit))
(assert (< dw1000__register_types__rx_ttcki_type__rxttcki__first__bit dw1000__register_types__rx_ttcki_type__rxttcki__last__bit))
(assert (<= 0 dw1000__register_types__rx_ttcki_type__rxttcki__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((rx_ttcki_type__ref (mk_rx_ttcki_type__ref (rx_ttcki_type__content us_rep)))))
(define-fun rx_ttcki_type__ref___projection ((a rx_ttcki_type__ref)) us_rep (rx_ttcki_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___34__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___25__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___25__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(define-fun dynamic_invariant ((temp___expr_3216 us_t1) (temp___is_init_3212 Bool) (temp___skip_constant_3213 Bool) (temp___do_toplevel_3214 Bool) (temp___do_typ_inv_3215 Bool)) Bool (=> (not (= temp___skip_constant_3213 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3216) (last3 temp___expr_3216)) (and (= (first3 temp___expr_3216) 1) (= (last3 temp___expr_3216) 4)))))
