...
(assert (= (ite (<= (to_rep (first4 temp___80341)) (to_rep (last4 temp___80341))) (+ (- (to_rep (last4 temp___80341)) (to_rep (first4 temp___80341))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8034 temp___8035))
(assert (= (mk1 (to_rep (first4 temp___80341)) (to_rep (last4 temp___80341))) temp___80351))
(assert (= (ite (<= (to_rep (first2 temp___80351)) (to_rep (last2 temp___80351))) (+ (- (to_rep (last2 temp___80351)) (to_rep (first2 temp___80351))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8035 temp___80351)))
(assert (= o2 o))
