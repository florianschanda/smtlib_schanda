...
(assert (and (= o53 (to_rep (select (rec__rr_type__cname_record_type__cnamerecordtype__canonicaldomainname (us_split_fields7 (select cnames 1))) i2))) (uint_in_range (to_rep (select (rec__rr_type__cname_record_type__cnamerecordtype__canonicaldomainname (us_split_fields7 (select cnames 1))) i2)))))
(assert (= o54 ((_ int2bv 8) o53)))
(assert (= (to_rep1 o55) o54))
(assert (= o56 (store (rec__dns_types__dns_packet__bytes output_packet__split_fields24) current_byte4 o55)))
(assert (= o57 (mk___split_fields1 (rec__dns_types__dns_packet__header output_packet__split_fields24) o56)))
(assert (= temp___7135 (mk___rep1 o57)))
(assert (= result14 (mk___split_fields__ref1 output_packet__split_fields24)))
(assert (= output_packet__split_fields25 (us_split_fields3 temp___7135)))
(assert (and (= o58 (+ i2 1)) (in_range8 (+ i2 1))))
(assert (= result15 (mk_int__ref i2)))
(assert (= i3 o58))
(assert (<= i3 name_length1))
(assert (< i3 129))
(assert (< (+ current_byte4 12) 8192))
(assert (not (< i3 129)))
(check-sat)
(exit)
