...
(assert (not (= (ite (<= (to_rep (first temp___33831)) (to_rep (last temp___33831))) (+ (- (to_rep (last temp___33831)) (to_rep (first temp___33831))) 1) 0) (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0))))
(check-sat)
(exit)
