...
(declare-const x86__readmem8__result (_ BitVec 8))
(declare-const result (_ BitVec 8))
(declare-const x86__readmem8__result1 (_ BitVec 8))
(declare-const x86__readmem8__result2 (_ BitVec 8))
(declare-const x86__readmem8__result3 (_ BitVec 8))
(declare-const x86__readmem8__result4 (_ BitVec 8))
(declare-const x86__readmem8__result5 (_ BitVec 8))
(declare-const result1 (_ BitVec 8))
(assert true)
(assert (= x86__readmem8__result1 x86__readmem8__result2))
(assert (= x86__readmem8__result3 x86__readmem8__result1))
(assert (= result x86__readmem8__result))
(assert (= x86__readmem8__result1 (to_rep (select memory addr))))
(assert (= (mk_t__ref x86__readmem8__result4) (mk_t__ref x86__readmem8__result2)))
(assert (= x86__readmem8__result5 x86__readmem8__result3))
(assert (= result1 x86__readmem8__result4))
(assert (not (= x86__readmem8__result4 (to_rep (select memory addr)))))
(check-sat)
(exit)
