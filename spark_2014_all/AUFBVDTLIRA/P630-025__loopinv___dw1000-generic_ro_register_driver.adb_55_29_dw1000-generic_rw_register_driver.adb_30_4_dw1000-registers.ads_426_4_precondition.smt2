...
(define-fun dynamic_invariant ((temp___expr_5177 us_t1) (temp___is_init_5174 Bool) (temp___skip_constant_5175 Bool) (temp___do_toplevel_5176 Bool)) Bool (=> (not (= temp___skip_constant_5175 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5177) (last3 temp___expr_5177)) (and (= (first3 temp___expr_5177) 1) (= (last3 temp___expr_5177) 4)))))
