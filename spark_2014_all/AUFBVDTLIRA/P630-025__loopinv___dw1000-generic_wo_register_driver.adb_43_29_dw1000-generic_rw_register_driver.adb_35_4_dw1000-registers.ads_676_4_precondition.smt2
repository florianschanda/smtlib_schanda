...
(define-fun dynamic_invariant ((temp___expr_7589 us_t1) (temp___is_init_7586 Bool) (temp___skip_constant_7587 Bool) (temp___do_toplevel_7588 Bool)) Bool (=> (not (= temp___skip_constant_7587 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7589) (last3 temp___expr_7589)) (and (= (first3 temp___expr_7589) 1) (= (last3 temp___expr_7589) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_7605 us_t2) (temp___is_init_7602 Bool) (temp___skip_constant_7603 Bool) (temp___do_toplevel_7604 Bool)) Bool (=> (not (= temp___skip_constant_7603 true)) (and (dynamic_property3 1 2 (first5 temp___expr_7605) (last5 temp___expr_7605)) (and (= (first5 temp___expr_7605) 1) (= (last5 temp___expr_7605) 2)))))
...
(declare-const temp___8241 (Array Int bits_8))
(declare-const temp___82411 t2)
(declare-const temp___8242 (Array Int bits_8))
(declare-const temp___82421 t1)
...
(define-fun temp___82412 () us_t2 (mk___t2 temp___8241 temp___82411))
...
(assert (and (= temp___82412 (register_to_bytes reg)) (dynamic_invariant1 temp___82412 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___82411)) (to_rep (last4 temp___82411))) (+ (- (to_rep (last4 temp___82411)) (to_rep (first4 temp___82411))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8241 temp___8242))
(assert (= (mk1 (to_rep (first4 temp___82411)) (to_rep (last4 temp___82411))) temp___82421))
(assert (= (ite (<= (to_rep (first2 temp___82421)) (to_rep (last2 temp___82421))) (+ (- (to_rep (last2 temp___82421)) (to_rep (first2 temp___82421))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8242 temp___82421)))
(assert (= o2 o))
