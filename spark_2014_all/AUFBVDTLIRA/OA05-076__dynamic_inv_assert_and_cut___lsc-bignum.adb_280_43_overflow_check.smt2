...
(assert (and (= o19 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o20 (ite (<= k o19) true false)))
(assert (= result1 (ite (<= i2 k) o20 false)))
(assert (= (= o21 true) (forall ((k1 Int)) (=> (and (<= i2 k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a1 k1)) (to_rep1 (select a k1)))))))
(assert (= o14 (from_word32 carry21)))
(assert (and (= o13 (base Tuple0)) (= o13 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o15 (omultiply o13 o14)))
(assert (= o12 (from_word32 carry11)))
(assert (= o16 (oadd o12 o15)))
...
(assert (= o7 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first o6)))
(assert (= o18 (oadd o7 o17)))
