...
(assert (and (= o1 (to_rep (select (rec__rr_type__ns_record_type__nsrecordtype__nameserver (us_split_fields3 ns_record)) i2))) (uint_in_range (to_rep (select (rec__rr_type__ns_record_type__nsrecordtype__nameserver (us_split_fields3 ns_record)) i2)))))
