...
(define-fun dynamic_invariant1 ((temp___expr_178 Int) (temp___is_init_175 Bool) (temp___skip_constant_176 Bool) (temp___do_toplevel_177 Bool)) Bool (=> (or (= temp___is_init_175 true) (<= 0 16)) (in_range2 temp___expr_178)))
(assert (forall ((self__ us_rep)) (! (dynamic_invariant1 (item_count self__) true false true) :pattern ((item_count self__)))))
...
(define-fun dynamic_invariant2 ((temp___expr_172 (_ BitVec 8)) (temp___is_init_169 Bool) (temp___skip_constant_170 Bool) (temp___do_toplevel_171 Bool)) Bool (=> (or (= temp___is_init_169 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 15))) (in_range1 temp___expr_172)))
...
(declare-const o20 message_count)
(declare-const o21 (Array (_ BitVec 8) integer))
(declare-const o22 message_index)
(declare-const o23 message_index)
(declare-const o24 message_count)
(declare-const o25 (Array (_ BitVec 8) integer))
...
(declare-const self__8 (Array (_ BitVec 8) integer))
...
(declare-const self__12 us_rep)
(declare-const result8 mailboxT__ref)
(declare-const self__13 us_rep)
(declare-const self__14 mailboxT__ref)
...
(assert (= (mk___rep (mk___split_fields self__8 self__9 self__10 self__11)) (mk___rep (mk___split_fields o6 o7 o8 o9))))
(assert (= (to_rep1 o10) (bvurem (bvadd (to_rep1 self__9) ((_ int2bv 8) 1)) ((_ int2bv 8) 16))))
(assert (= self__8 o11))
(assert (= o10 o12))
(assert (= self__10 o13))
(assert (= self__11 o14))
...
(assert (= o17 o13))
(assert (= o18 o14))
(assert (= result4 self__8))
(assert (= result5 self__9))
(assert (= result6 self__10))
(assert (= result7 self__11))
(assert (= self__12 (mk___rep (mk___split_fields o15 o16 o17 o18))))
(assert (not (in_range2 (+ (to_rep2 (rec__communications__mailboxT__count (us_split_fields1 self__12))) 1))))
(check-sat)
(exit)
