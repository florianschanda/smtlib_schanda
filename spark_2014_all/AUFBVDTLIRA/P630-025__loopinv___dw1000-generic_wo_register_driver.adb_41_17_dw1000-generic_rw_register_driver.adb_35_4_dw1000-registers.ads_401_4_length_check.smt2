...
(define-fun target__ref___34__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__drx_tune2_type__drx_tune2 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__drx_tune2_type__drx_tune2 (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_5435 us_t1) (temp___is_init_5431 Bool) (temp___skip_constant_5432 Bool) (temp___do_toplevel_5433 Bool) (temp___do_typ_inv_5434 Bool)) Bool (=> (not (= temp___skip_constant_5432 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5435) (last3 temp___expr_5435)) (and (= (first3 temp___expr_5435) 1) (= (last3 temp___expr_5435) 4)))))
...
(define-fun register_byte_array__ref___81__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_5417 us_t2) (temp___is_init_5413 Bool) (temp___skip_constant_5414 Bool) (temp___do_toplevel_5415 Bool) (temp___do_typ_inv_5416 Bool)) Bool (=> (not (= temp___skip_constant_5414 true)) (and (dynamic_property3 1 4 (first5 temp___expr_5417) (last5 temp___expr_5417)) (and (= (first5 temp___expr_5417) 1) (= (last5 temp___expr_5417) 4)))))
...
(declare-const temp___87281 t1)
(declare-const temp___8729 (Array Int bits_8))
(declare-const temp___87291 t2)
(define-fun temp___87282 () us_t1 (mk___t1 temp___8728 temp___87281))
...
(assert (and (= temp___87282 (register_to_bytes reg)) (dynamic_invariant temp___87282 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___87281)) (to_rep (last2 temp___87281))) (+ (- (to_rep (last2 temp___87281)) (to_rep (first2 temp___87281))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8728 temp___8729))
(assert (= (mk2 (to_rep (first2 temp___87281)) (to_rep (last2 temp___87281))) temp___87291))
(assert (not (= (ite (<= (to_rep (first4 temp___87291)) (to_rep (last4 temp___87291))) (+ (- (to_rep (last4 temp___87291)) (to_rep (first4 temp___87291))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
