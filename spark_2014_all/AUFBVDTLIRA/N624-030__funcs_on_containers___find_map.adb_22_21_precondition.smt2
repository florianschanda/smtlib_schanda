...
(assert (<= 0 e))
(assert (<= e 2147483647))
(assert (and (= result6 (has_key (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) e)) (= (= result6 true) (= (has_key (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) e) true))))
(assert (= result6 true))
(assert (not (= (has_key (model__ (mk___rep result____split_discrs (mk___split_fields result____split_fields3))) e) true)))
(check-sat)
(exit)
