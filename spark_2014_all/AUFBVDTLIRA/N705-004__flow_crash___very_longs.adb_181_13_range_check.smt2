...
(assert (and (= us (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r)))) (in_range (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 r))))))
(assert (not (in_range (to_rep (rec__very_longs__very_long__octet_length (us_split_discrs1 l))))))
(check-sat)
(exit)
