...
(define-fun dynamic_invariant ((temp___expr_2291 us_t1) (temp___is_init_2288 Bool) (temp___skip_constant_2289 Bool) (temp___do_toplevel_2290 Bool)) Bool (=> (not (= temp___skip_constant_2289 true)) (and (dynamic_property2 1 5 (first3 temp___expr_2291) (last3 temp___expr_2291)) (and (= (first3 temp___expr_2291) 1) (= (last3 temp___expr_2291) 5)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_2307 us_t2) (temp___is_init_2304 Bool) (temp___skip_constant_2305 Bool) (temp___do_toplevel_2306 Bool)) Bool (=> (not (= temp___skip_constant_2305 true)) (and (dynamic_property3 1 5 (first5 temp___expr_2307) (last5 temp___expr_2307)) (and (= (first5 temp___expr_2307) 1) (= (last5 temp___expr_2307) 5)))))
...
(assert (and (= temp___77292 (register_to_bytes reg)) (dynamic_invariant1 temp___77292 true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___77291)) (to_rep (last4 temp___77291))) (+ (- (to_rep (last4 temp___77291)) (to_rep (first4 temp___77291))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0))))
(check-sat)
(exit)
