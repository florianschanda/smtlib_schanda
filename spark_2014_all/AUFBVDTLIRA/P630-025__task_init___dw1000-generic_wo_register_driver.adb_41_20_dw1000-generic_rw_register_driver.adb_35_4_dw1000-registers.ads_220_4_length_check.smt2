...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__dx_time_type__dx_time (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__dx_time_type__dx_time (us_split_fields1 b)))) true false))
...
(define-fun register_byte_array__ref___13__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_2549 us_t1) (temp___is_init_2545 Bool) (temp___skip_constant_2546 Bool) (temp___do_toplevel_2547 Bool) (temp___do_typ_inv_2548 Bool)) Bool (=> (not (= temp___skip_constant_2546 true)) (and (dynamic_property2 1 5 (first3 temp___expr_2549) (last3 temp___expr_2549)) (and (= (first3 temp___expr_2549) 1) (= (last3 temp___expr_2549) 5)))))
(declare-sort t2 0)
...
(define-fun target__ref___6__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_2567 us_t2) (temp___is_init_2563 Bool) (temp___skip_constant_2564 Bool) (temp___do_toplevel_2565 Bool) (temp___do_typ_inv_2566 Bool)) Bool (=> (not (= temp___skip_constant_2564 true)) (and (dynamic_property3 1 5 (first5 temp___expr_2567) (last5 temp___expr_2567)) (and (= (first5 temp___expr_2567) 1) (= (last5 temp___expr_2567) 5)))))
...
(declare-const temp___85011 t2)
(define-fun temp___85012 () us_t2 (mk___t2 temp___8501 temp___85011))
...
(assert (and (= temp___85012 (register_to_bytes reg)) (dynamic_invariant1 temp___85012 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___85011)) (to_rep (last4 temp___85011))) (+ (- (to_rep (last4 temp___85011)) (to_rep (first4 temp___85011))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0))))
(check-sat)
(exit)
