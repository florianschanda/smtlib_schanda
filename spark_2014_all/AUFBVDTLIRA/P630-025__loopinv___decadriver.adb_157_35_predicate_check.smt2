...
(define-fun dynamic_invariant ((temp___expr_4413 Int) (temp___is_init_4410 Bool) (temp___skip_constant_4411 Bool) (temp___do_toplevel_4412 Bool)) Bool (=> (or (= temp___is_init_4410 true) (<= 0 5)) (in_range4 temp___expr_4413)))
...
(define-fun dynamic_invariant1 ((temp___expr_4419 us_rep) (temp___is_init_4416 Bool) (temp___skip_constant_4417 Bool) (temp___do_toplevel_4418 Bool)) Bool (=> (= temp___do_toplevel_4418 true) (=> (= temp___is_init_4416 true) (ite (= (to_rep2 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___expr_4419))) 0) (< 0 (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4419)))) (= (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4419))) 0)))))
(define-fun dynamic_predicate ((temp___4430 us_rep)) Bool (ite (= (to_rep2 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___4430))) 0) (< 0 (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4430)))) (= (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4430))) 0)))
...
(define-fun dynamic_invariant2 ((temp___expr_4437 (_ BitVec 8)) (temp___is_init_4434 Bool) (temp___skip_constant_4435 Bool) (temp___do_toplevel_4436 Bool)) Bool (=> (or (= temp___is_init_4434 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range5 temp___expr_4437)))
...
(assert (forall ((temp___4481 (_ BitVec 8))) (forall ((temp___4482 Int)) (= (select (temp___4479 temp___4481) temp___4482) (of_rep3 temp___4481)))))
(define-fun dynamic_invariant3 ((temp___expr_4469 us_rep1) (temp___is_init_4466 Bool) (temp___skip_constant_4467 Bool) (temp___do_toplevel_4468 Bool)) Bool (forall ((temp___4470 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) temp___4470) (bvule temp___4470 ((_ int2bv 8) 1))) (let ((temp___4471 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_4469)) temp___4470))) (ite (= (to_rep2 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___4471))) 0) (< 0 (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4471)))) (= (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4471))) 0))))))
(define-fun default_initial_assumption ((temp___expr_4473 us_rep1) (temp___skip_top_level_4474 Bool)) Bool (and (and (and (and (= (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_4473)) (temp___4475 (mk___rep (mk___split_fields (of_rep1 0) (temp___4479 ((_ int2bv 8) 0)) (of_rep2 0) (of_int 0))))) (= (to_rep4 (rec__decadriver__receiver_type__queue_head (us_split_fields3 temp___expr_4473))) ((_ int2bv 8) 1))) (= (to_rep (rec__decadriver__receiver_type__rx_count (us_split_fields3 temp___expr_4473))) 0)) (= (rec__decadriver__receiver_type__overrun_occurred (us_split_fields3 temp___expr_4473)) (of_int 0))) (= (rec__decadriver__receiver_type__frame_ready (us_split_fields3 temp___expr_4473)) (of_int 0))))
...
(define-fun dynamic_invariant6 ((temp___expr_4407 Int) (temp___is_init_4404 Bool) (temp___skip_constant_4405 Bool) (temp___do_toplevel_4406 Bool)) Bool (=> (or (= temp___is_init_4404 true) (<= 0 1024)) (in_range3 temp___expr_4407)))
...
(declare-const temp___4593 frame_length)
(declare-const temp___45931 (Array Int bits_8))
(declare-const temp___45932 rx_errors)
(declare-const temp___45933 Bool)
...
(define-fun o41 () us_rep (mk___rep (mk___split_fields o21 o22 o23 o24)))
(define-fun temp___45894 () us_rep (mk___rep (mk___split_fields temp___4589 temp___45891 temp___45892 temp___45893)))
...
(assert (= o41 temp___45894))
(assert (= o25 (store (rec__decadriver__receiver_type__frame_queue (us_split_fields3 self__5)) next_idx1 o41)))
(assert (= o25 o26))
...
(assert (not (dynamic_predicate (mk___rep (mk___split_fields temp___4593 temp___45931 temp___45932 temp___45933)))))
(check-sat)
(exit)
