...
(assert (= o3 frame))
(assert (= o3 temp___4543))
(assert (= (mk1 (to_rep1 frame__first) r6b) temp___45431))
(assert (not (= (ite (<= (to_rep1 (first2 temp___45411)) (to_rep1 (last2 temp___45411))) (+ (- (to_rep1 (last2 temp___45411)) (to_rep1 (first2 temp___45411))) 1) 0) (ite (<= (to_rep1 (first2 temp___45431)) (to_rep1 (last2 temp___45431))) (+ (- (to_rep1 (last2 temp___45431)) (to_rep1 (first2 temp___45431))) 1) 0))))
(check-sat)
(exit)
