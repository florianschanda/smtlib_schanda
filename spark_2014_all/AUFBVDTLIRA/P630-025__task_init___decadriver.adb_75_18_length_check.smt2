...
(assert (not (= (ite (<= (to_rep1 (first2 temp___45511)) (to_rep1 (last2 temp___45511))) (+ (- (to_rep1 (last2 temp___45511)) (to_rep1 (first2 temp___45511))) 1) 0) (ite (<= (to_rep1 (first2 temp___45531)) (to_rep1 (last2 temp___45531))) (+ (- (to_rep1 (last2 temp___45531)) (to_rep1 (first2 temp___45531))) 1) 0))))
(check-sat)
(exit)
