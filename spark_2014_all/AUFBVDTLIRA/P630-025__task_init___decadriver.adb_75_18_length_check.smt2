...
(declare-const temp___5036 (Array Int bits_8))
(declare-const temp___50361 t1)
...
(assert (=> (<= (to_rep1 frame__first) r6b) (and (and (<= (to_rep1 frame__first) (to_rep1 frame__first)) (<= (to_rep1 frame__first) (to_rep1 frame__last))) (and (<= (to_rep1 frame__first) r6b) (<= r6b (to_rep1 frame__last))))))
(assert (= o3 frame))
(assert (= o3 temp___5036))
(assert (= (mk1 (to_rep1 frame__first) r6b) temp___50361))
(assert (not (= (ite (<= (to_rep1 (first2 temp___50341)) (to_rep1 (last2 temp___50341))) (+ (- (to_rep1 (last2 temp___50341)) (to_rep1 (first2 temp___50341))) 1) 0) (ite (<= (to_rep1 (first2 temp___50361)) (to_rep1 (last2 temp___50361))) (+ (- (to_rep1 (last2 temp___50361)) (to_rep1 (first2 temp___50361))) 1) 0))))
(check-sat)
(exit)
