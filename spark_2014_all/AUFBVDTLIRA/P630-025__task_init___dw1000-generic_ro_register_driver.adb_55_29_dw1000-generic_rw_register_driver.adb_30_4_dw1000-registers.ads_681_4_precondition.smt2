...
(define-fun register_type__ref___241__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___172__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___172__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_8406 us_t1) (temp___is_init_8402 Bool) (temp___skip_constant_8403 Bool) (temp___do_toplevel_8404 Bool) (temp___do_typ_inv_8405 Bool)) Bool (=> (not (= temp___skip_constant_8403 true)) (and (dynamic_property2 1 4 (first3 temp___expr_8406) (last3 temp___expr_8406)) (and (= (first3 temp___expr_8406) 1) (= (last3 temp___expr_8406) 4)))))
