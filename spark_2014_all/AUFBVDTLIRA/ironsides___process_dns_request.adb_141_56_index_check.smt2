...
(assert (=> (and (<= 65 c3b) (<= c3b 90)) (= ans1 (bvsub ((_ int2bv 8) c3b) #x41))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (and (<= 97 c3b) (<= c3b 122)) (= result7 (mk_t__ref ans)))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (and (<= 97 c3b) (<= c3b 122)) (= ans2 (bvadd (bvsub ((_ int2bv 8) c3b) #x61) #x1A)))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (and (<= 48 c3b) (<= c3b 57)) (= result8 (mk_t__ref ans))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (and (<= 48 c3b) (<= c3b 57)) (= ans3 (bvadd (bvsub ((_ int2bv 8) c3b) #x30) #x34))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (= c3b 43) (= result9 (mk_t__ref ans)))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (= c3b 43) (= ans4 #x3E))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (not (= c3b 43)) (=> (= c3b 47) (= result10 (mk_t__ref ans))))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (not (= c3b 43)) (=> (= c3b 47) (= ans5 #x3F)))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (not (= c3b 43)) (=> (not (= c3b 47)) (= result11 (mk_t__ref ans))))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (not (= c3b 43)) (=> (not (= c3b 47)) (= ans6 #x00)))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (not (= c3b 43)) (=> (not (= c3b 47)) (= ans5 ans6)))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (=> (not (= c3b 43)) (= ans4 ans5))))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (=> (not (and (<= 48 c3b) (<= c3b 57))) (= ans3 ans4)))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (=> (not (and (<= 97 c3b) (<= c3b 122))) (= ans2 ans3))))
(assert (=> (not (and (<= 65 c3b) (<= c3b 90))) (= ans1 ans2)))
(assert (= result12 (mk_t__ref srcnum0)))
(assert (= srcnum01 ans1))
(assert (and (= temp___5846 (+ srcbyte2 1)) (in_range1 (+ srcbyte2 1))))
(assert (not (<= 1 temp___5846)))
(check-sat)
(exit)
