...
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= temp___332 result__)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= temp___330 i2)))
...
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (and (and (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i3)) (forall ((temp___333 Int)) (=> (and (<= (to_rep result____first) temp___333) (<= temp___333 (to_rep result____last))) (=> (< i3 temp___333) (= (select result__3 temp___333) (select temp___332 temp___333)))))) (and (<= (to_rep result____first) i3) (<= i3 (to_rep result____last))))))
