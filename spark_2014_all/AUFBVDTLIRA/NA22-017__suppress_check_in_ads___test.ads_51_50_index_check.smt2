...
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= temp___290 result__)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= temp___288 i2)))
...
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (and (and (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i3)) (forall ((temp___291 Int)) (=> (and (<= (to_rep result____first) temp___291) (<= temp___291 (to_rep result____last))) (=> (< i3 temp___291) (= (select result__3 temp___291) (select temp___290 temp___291)))))) (and (<= (to_rep result____first) i3) (<= i3 (to_rep result____last))))))
...
(assert (not (<= (to_rep (first (rt right))) i1)))
(check-sat)
(exit)
