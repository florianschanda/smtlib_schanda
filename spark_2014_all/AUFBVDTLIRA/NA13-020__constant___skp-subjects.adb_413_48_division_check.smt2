...
(assert (and (and (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs 0)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)) (and (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs 1)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)) (and (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs 2)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)) (and (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs 3)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)) (and (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs 4)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)) (and (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs 5)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)) (and (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs 6)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)) (and (forall ((subject1 Int)) (=> (and (<= 0 subject1) (<= subject1 6)) (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject1)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0)))) (and (and (= skp__subjects__get_pml4_address__result1 skp__subjects__get_pml4_address__result2) (= skp__subjects__get_pml4_address__result3 skp__subjects__get_pml4_address__result1)) (and (= (mk_t__ref result) (mk_t__ref skp__subjects__get_pml4_address__result)) (= skp__subjects__get_pml4_address__result1 (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject_id))))))))))))))) (and (= (mk_t__ref skp__subjects__get_pml4_address__result4) (mk_t__ref skp__subjects__get_pml4_address__result2)) (= skp__subjects__get_pml4_address__result5 skp__subjects__get_pml4_address__result3))))
