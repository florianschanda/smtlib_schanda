...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 2)))) (=> (in_range1 y) (= (to_rep1 (of_rep1 x)) y))) :pattern ((to_rep1 (of_rep1 x))))))
...
(define-fun in_range3 ((x (_ BitVec 16))) Bool (and (bvule ((_ int2bv 16) 0) x) (bvule x ((_ int2bv 16) 8191))))
...
(assert (forall ((x bits_13)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert (forall ((x bits_13)) (! (in_range3 (to_rep4 x)) :pattern ((to_rep4 x)))))
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x ((_ int2bv 16) 8192)))) (=> (in_range3 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
(define-fun to_int6 ((x bits_13)) Int (bv2nat (to_rep4 x)))
(assert (forall ((x bits_13)) (! (in_range_int2 (to_int6 x)) :pattern ((to_int6 x)))))
...
(define-fun dynamic_invariant ((temp___expr_364 (_ BitVec 16)) (temp___is_init_361 Bool) (temp___skip_constant_362 Bool) (temp___do_toplevel_363 Bool)) Bool true)
...
(define-fun dynamic_property ((range_first Int) (range_last Int) (low Int) (high Int)) Bool (and (in_range low) (and (in_range high) (=> (<= low high) (and (in_range4 low) (in_range4 high))))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep1 (rec__dw1000__register_types__aon_cfg1_type__sleep_ce (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__aon_cfg1_type__sleep_ce (us_split_fields1 b)))) (= (to_rep1 (rec__dw1000__register_types__aon_cfg1_type__smxx (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__aon_cfg1_type__smxx (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__aon_cfg1_type__lposc_c (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__aon_cfg1_type__lposc_c (us_split_fields1 b))))) (= (to_rep4 (rec__dw1000__register_types__aon_cfg1_type__reserved (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__aon_cfg1_type__reserved (us_split_fields1 b))))) true false))
...
(define-fun to_int7 ((x bits_3)) Int (bv2nat (to_rep5 x)))
(assert (forall ((x bits_3)) (! (in_range_int3 (to_int7 x)) :pattern ((to_int7 x)))))
(declare-sort bits_4 0)
(define-fun in_range6 ((x (_ BitVec 8))) Bool (and (bvule ((_ int2bv 8) 0) x) (bvule x ((_ int2bv 8) 15))))
...
(assert (forall ((x bits_4)) (! (= (of_rep6 (to_rep6 x)) x) :pattern ((to_rep6 x)))))
(assert (forall ((x bits_4)) (! (in_range6 (to_rep6 x)) :pattern ((to_rep6 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 16)))) (=> (in_range6 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
(define-fun to_int8 ((x bits_4)) Int (bv2nat (to_rep6 x)))
(assert (forall ((x bits_4)) (! (in_range_int4 (to_int8 x)) :pattern ((to_int8 x)))))
...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep2 (rec__dw1000__register_types__pmsc_ctrl0_type__sysclks (us_split_fields3 a))) (to_rep2 (rec__dw1000__register_types__pmsc_ctrl0_type__sysclks (us_split_fields3 b)))) (= (to_rep2 (rec__dw1000__register_types__pmsc_ctrl0_type__rxclks (us_split_fields3 a))) (to_rep2 (rec__dw1000__register_types__pmsc_ctrl0_type__rxclks (us_split_fields3 b))))) (= (to_rep2 (rec__dw1000__register_types__pmsc_ctrl0_type__txclks (us_split_fields3 a))) (to_rep2 (rec__dw1000__register_types__pmsc_ctrl0_type__txclks (us_split_fields3 b))))) (= (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__face (us_split_fields3 a))) (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__face (us_split_fields3 b))))) (= (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__adcce (us_split_fields3 a))) (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__adcce (us_split_fields3 b))))) (= (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__amce (us_split_fields3 a))) (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__amce (us_split_fields3 b))))) (= (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__gpce (us_split_fields3 a))) (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__gpce (us_split_fields3 b))))) (= (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__gprn (us_split_fields3 a))) (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__gprn (us_split_fields3 b))))) (= (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__gpdce (us_split_fields3 a))) (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__gpdce (us_split_fields3 b))))) (= (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__gpdrn (us_split_fields3 a))) (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__gpdrn (us_split_fields3 b))))) (= (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__khzclken (us_split_fields3 a))) (to_rep1 (rec__dw1000__register_types__pmsc_ctrl0_type__khzclken (us_split_fields3 b))))) (= (to_rep6 (rec__dw1000__register_types__pmsc_ctrl0_type__softreset (us_split_fields3 a))) (to_rep6 (rec__dw1000__register_types__pmsc_ctrl0_type__softreset (us_split_fields3 b))))) (= (to_rep5 (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_1 (us_split_fields3 a))) (to_rep5 (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_1 (us_split_fields3 b))))) (= (to_rep6 (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_2 (us_split_fields3 a))) (to_rep6 (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_2 (us_split_fields3 b))))) (= (to_rep5 (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_3 (us_split_fields3 a))) (to_rep5 (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_3 (us_split_fields3 b))))) (= (to_rep6 (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_4 (us_split_fields3 a))) (to_rep6 (rec__dw1000__register_types__pmsc_ctrl0_type__reserved_4 (us_split_fields3 b))))) true false))
...
(define-fun dynamic_invariant3 ((temp___expr_274 (_ BitVec 8)) (temp___is_init_271 Bool) (temp___skip_constant_272 Bool) (temp___do_toplevel_273 Bool)) Bool (=> (or (= temp___is_init_271 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range1 temp___expr_274)))
(define-fun dynamic_invariant4 ((temp___expr_280 (_ BitVec 8)) (temp___is_init_277 Bool) (temp___skip_constant_278 Bool) (temp___do_toplevel_279 Bool)) Bool (=> (or (= temp___is_init_277 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 3))) (in_range2 temp___expr_280)))
(define-fun dynamic_invariant5 ((temp___expr_286 (_ BitVec 8)) (temp___is_init_283 Bool) (temp___skip_constant_284 Bool) (temp___do_toplevel_285 Bool)) Bool (=> (or (= temp___is_init_283 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 7))) (in_range5 temp___expr_286)))
(define-fun dynamic_invariant6 ((temp___expr_292 (_ BitVec 8)) (temp___is_init_289 Bool) (temp___skip_constant_290 Bool) (temp___do_toplevel_291 Bool)) Bool (=> (or (= temp___is_init_289 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 15))) (in_range6 temp___expr_292)))
(define-fun dynamic_invariant7 ((temp___expr_316 (_ BitVec 8)) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool)) Bool true)
(define-fun dynamic_invariant8 ((temp___expr_346 (_ BitVec 16)) (temp___is_init_343 Bool) (temp___skip_constant_344 Bool) (temp___do_toplevel_345 Bool)) Bool (=> (or (= temp___is_init_343 true) (bvule ((_ int2bv 16) 0) ((_ int2bv 16) 8191))) (in_range3 temp___expr_346)))
(define-fun dynamic_invariant9 ((temp___expr_658 us_t) (temp___is_init_655 Bool) (temp___skip_constant_656 Bool) (temp___do_toplevel_657 Bool)) Bool (=> (not (= temp___skip_constant_656 true)) (dynamic_property 0 2147483647 (first1 temp___expr_658) (last1 temp___expr_658))))
(declare-const half_xtal_cycles_per_lp_osc_cycle (_ BitVec 16))
...
(declare-const temp___3342 bits_2)
(declare-const temp___33421 bits_2)
(declare-const temp___33422 bits_2)
(declare-const temp___33423 bits_1)
(declare-const temp___33424 bits_1)
(declare-const temp___33425 bits_1)
(declare-const temp___33426 bits_1)
(declare-const temp___33427 bits_1)
(declare-const temp___33428 bits_1)
(declare-const temp___33429 bits_1)
(declare-const temp___334210 bits_1)
(declare-const temp___334211 bits_4)
(declare-const temp___334212 bits_3)
(declare-const temp___334213 bits_4)
(declare-const temp___334214 bits_3)
(declare-const temp___334215 bits_4)
...
(declare-const temp___3344 bits_2)
(declare-const temp___33441 bits_2)
(declare-const temp___33442 bits_2)
(declare-const temp___33443 bits_1)
(declare-const temp___33444 bits_1)
(declare-const temp___33445 bits_1)
(declare-const temp___33446 bits_1)
(declare-const temp___33447 bits_1)
(declare-const temp___33448 bits_1)
(declare-const temp___33449 bits_1)
(declare-const temp___334410 bits_1)
(declare-const temp___334411 bits_4)
(declare-const temp___334412 bits_3)
(declare-const temp___334413 bits_4)
(declare-const temp___334414 bits_3)
(declare-const temp___334415 bits_4)
...
(assert (= pmsc_ctrl0_reg__split_fields32 (mk___split_fields1 temp___3342 temp___33421 temp___33422 temp___33423 temp___33424 temp___33425 temp___33426 temp___33427 temp___33428 temp___33429 temp___334210 temp___334211 temp___334212 temp___334213 temp___334214 temp___334215)))
...
(assert (= pmsc_ctrl0_reg__split_fields33 (mk___split_fields1 temp___3344 temp___33441 temp___33442 temp___33443 temp___33444 temp___33445 temp___33446 temp___33447 temp___33448 temp___33449 temp___334410 temp___334411 temp___334412 temp___334413 temp___334414 temp___334415)))
(assert (= (to_rep o59) 2))
(assert (= (to_rep o58) 1))
(assert (not (<= (ite (<= (to_rep o58) (to_rep o59)) (+ (- (to_rep o59) (to_rep o58)) 1) 0) 256)))
(check-sat)
(exit)
