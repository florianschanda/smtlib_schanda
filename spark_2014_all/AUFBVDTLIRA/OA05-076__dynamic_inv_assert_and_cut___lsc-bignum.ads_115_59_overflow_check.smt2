...
(assert (forall ((b1 Bool)) (! (let ((result (word_of_boolean b1))) (and (= (oeq (from_word32 result) (num_of_boolean b1)) true) (dynamic_invariant2 result true false true true))) :pattern ((word_of_boolean b1)))))
...
(declare-const i Int)
(declare-const temp___655 Bool)
(declare-const temp___647 (Array Int word32))
(declare-const temp___654 Int)
(declare-const temp___652 (Array Int word32))
(declare-const temp___646 (Array Int word32))
(declare-const temp___656 (Array Int word32))
(declare-const temp___657 (Array Int word32))
(declare-const temp___650 Bool)
...
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___655 new_carry)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___647 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___654 j)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___652 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___646 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___656 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___657 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___650 carry1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___649 i1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (osubtract (num_of_big_int (mk___t temp___656 (mk (to_rep a__first) (to_rep a__last))) a_first (- i2 a_first)) (num_of_big_int b b_first (- i2 a_first))) (osubtract (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first (- i2 a_first)) (omultiply (oexpon (base Tuple0) (- i2 a_first)) (num_of_boolean carry2)))) true) (forall ((k Int)) (=> (and (<= i2 k) (<= k a_last)) (= (to_rep1 (select a2 k)) (to_rep1 (select temp___657 k))))))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (forall ((temp___653 Int)) (=> (and (<= (to_rep a__first) temp___653) (<= temp___653 (to_rep a__last))) (=> (<= i2 temp___653) (= (select a2 temp___653) (select temp___652 temp___653)))))) (=> (<= 0 2147483647) (in_range2 j2))) (and (<= a_first i2) (<= i2 a_last)))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (osubtract (num_of_big_int (mk___t temp___646 (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (num_of_big_int b b_first (- (+ i2 1) a_first))) (osubtract (num_of_big_int (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (omultiply (oexpon (base Tuple0) (- (+ i2 1) a_first)) (num_of_boolean carry3)))) true) (forall ((k Int)) (=> (and (<= (+ i2 1) k) (<= k a_last)) (= (to_rep1 (select a3 k)) (to_rep1 (select temp___647 k))))))))
