...
(assert (forall ((b Bool)) (! (let ((result (word_of_boolean b))) (and (= (oeq (from_word32 result) (num_of_boolean b)) true) (dynamic_invariant2 result true false true true))) :pattern ((word_of_boolean b)))))
...
(declare-const i Int)
(declare-const temp___657 Bool)
(declare-const temp___649 (Array Int word32))
(declare-const temp___656 Int)
(declare-const temp___654 (Array Int word32))
(declare-const temp___648 (Array Int word32))
(declare-const temp___658 (Array Int word32))
(declare-const temp___659 (Array Int word32))
(declare-const temp___652 Bool)
...
(declare-const carry6 bool__ref)
(declare-const j6 int__ref)
(declare-const new_carry5 bool__ref)
...
(assert (= carry1 (distinct 0 0)))
(assert (= (mk_int__ref result1) (mk_int__ref i)))
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___657 new_carry)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___649 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___656 j)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___654 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___648 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___658 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___659 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___652 carry1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___651 i1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (osubtract (num_of_big_int (mk___t temp___658 (mk (to_rep a__first) (to_rep a__last))) a_first (- i2 a_first)) (num_of_big_int b b_first (- i2 a_first))) (osubtract (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first (- i2 a_first)) (omultiply (oexpon (base Tuple0) (- i2 a_first)) (num_of_boolean carry2)))) true) (forall ((k Int)) (=> (and (<= i2 k) (<= k a_last)) (= (to_rep1 (select a2 k)) (to_rep1 (select temp___659 k))))))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (forall ((temp___655 Int)) (=> (and (<= (to_rep a__first) temp___655) (<= temp___655 (to_rep a__last))) (=> (or (< a_last temp___655) (or (< temp___655 a_first) (<= i2 temp___655))) (= (select a2 temp___655) (select temp___654 temp___655)))))) (=> (<= 0 2147483647) (in_range2 j2))) (and (<= a_first i2) (<= i2 a_last)))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (osubtract (num_of_big_int (mk___t temp___648 (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (num_of_big_int b b_first (- (+ i2 1) a_first))) (osubtract (num_of_big_int (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (omultiply (oexpon (base Tuple0) (- (+ i2 1) a_first)) (num_of_boolean carry3)))) true) (forall ((k Int)) (=> (and (<= (+ i2 1) k) (<= k a_last)) (= (to_rep1 (select a3 k)) (to_rep1 (select temp___649 k))))))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= new_carry2 new_carry3)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= j3 j4)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry3 carry4)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a3 a4)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= i4 i2)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= new_carry4 new_carry2)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= j5 j3)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry5 carry3)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a5 a3)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= i5 i3)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= new_carry5 (mk_bool__ref new_carry3))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= j6 (mk_int__ref j4))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry6 (mk_bool__ref carry4))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a6 (mk_map__ref a4))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= i6 i4)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= new_carry6 new_carry4)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= j7 j5)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry7 carry5)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a7 a5)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= new_carry5 (mk_bool__ref new_carry))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= j6 (mk_int__ref j))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= carry6 (mk_bool__ref carry1))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a6 (mk_map__ref a))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= i6 i1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= new_carry6 new_carry1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= j7 j1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= carry7 carry1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a7 a1)))
(assert (= i7 i5))
(assert (= new_carry7 new_carry5))
(assert (= j8 j6))
(assert (= carry8 carry6))
(assert (= a8 a6))
(assert (= i8 i6))
(assert (= new_carry8 new_carry6))
(assert (= j9 j7))
(assert (= carry9 carry7))
(assert (= a9 a7))
(assert (= o18 (num_of_boolean (bool__content carry8))))
(assert (and (= o13 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o14 (+ o13 1)))
(assert (and (= o15 o14) (in_range1 o14)))
(assert (and (= o16 o15) (in_range2 o15)))
(assert (and (= o12 (base Tuple0)) (= o12 (oexpon (from_word32 #x00000002) 32))))
(assert (= o17 (oexpon o12 o16)))
(assert (= o19 (omultiply o17 o18)))
(assert (and (= o7 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o8 (+ o7 1)))
(assert (and (= o9 o8) (in_range1 o8)))
(assert (and (= o10 o9) (in_range2 o9)))
(assert (= o11 (num_of_big_int (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last))) a_first o10)))
(assert (= o20 (osubtract o11 o19)))
(assert (and (= o2 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o3 (+ o2 1)))
(assert (and (= o4 o3) (in_range1 o3)))
(assert (and (= o5 o4) (in_range2 o4)))
(assert (= o6 (num_of_big_int b b_first o5)))
