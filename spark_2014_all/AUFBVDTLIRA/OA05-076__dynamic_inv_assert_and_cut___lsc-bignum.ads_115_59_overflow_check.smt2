...
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (and (= temp___585 new_carry) (and (= temp___577 a) (and (= temp___584 j) (and (= temp___582 a) (and (= temp___576 a) (and (= temp___586 a) (and (= temp___587 a) (and (= temp___580 carry1) (and (= temp___579 i1) (and (and (= (oeq (osubtract (num_of_big_int (mk___t temp___586 (mk (to_rep a__first) (to_rep a__last))) a_first (- i2 a_first)) (num_of_big_int b b_first (- i2 a_first))) (osubtract (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first (- i2 a_first)) (omultiply (oexpon (base Tuple0) (- i2 a_first)) (num_of_boolean carry2)))) true) (forall ((k2 Int)) (=> (and (<= i2 k2) (<= k2 a_last)) (= (to_rep1 (select a2 k2)) (to_rep1 (select temp___587 k2)))))) (and (and (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (forall ((temp___583 Int)) (=> (and (<= (to_rep a__first) temp___583) (<= temp___583 (to_rep a__last))) (=> (<= i2 temp___583) (= (select a2 temp___583) (select temp___582 temp___583)))))) (=> (<= 0 2147483647) (in_range2 j2))) (and (<= a_first i2) (<= i2 a_last))) (and (and (= (oeq (osubtract (num_of_big_int (mk___t temp___576 (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (num_of_big_int b b_first (- (+ i2 1) a_first))) (osubtract (num_of_big_int (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (omultiply (oexpon (base Tuple0) (- (+ i2 1) a_first)) (num_of_boolean carry3)))) true) (forall ((k2 Int)) (=> (and (<= (+ i2 1) k2) (<= k2 a_last)) (= (to_rep1 (select a3 k2)) (to_rep1 (select temp___577 k2)))))) (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (= i2 a_last)))))))))))))) (and (and (= i6 (mk_int__ref i2)) (and (= new_carry3 new_carry6) (and (= j3 j6) (and (= carry3 carry6) (= a3 a6))))) (and (= i7 i2) (and (= new_carry7 new_carry3) (and (= j7 j3) (and (= carry7 carry3) (= a7 a3)))))))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= i8 i6)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= new_carry8 (mk_bool__ref new_carry6))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= j8 (mk_int__ref j6))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry8 (mk_bool__ref carry6))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a8 (mk_map__ref a6))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= i9 i7)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= new_carry9 new_carry7)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= j9 j7)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry9 carry7)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a9 a7)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= i8 (mk_int__ref i1))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= new_carry8 (mk_bool__ref new_carry))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= j8 (mk_int__ref j))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= carry8 (mk_bool__ref carry1))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a8 (mk_map__ref a))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= i9 i1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= new_carry9 new_carry1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= j9 j1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= carry9 carry1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a9 a1)))
(assert (= i10 i8))
(assert (= new_carry10 new_carry8))
(assert (= j10 j8))
(assert (= carry10 carry8))
(assert (= a10 a8))
(assert (= i11 i9))
(assert (= new_carry11 new_carry9))
(assert (= j11 j9))
(assert (= carry11 carry9))
(assert (= a11 a9))
(assert (= o105 (num_of_boolean (bool__content carry10))))
(assert (and (= o100 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o101 (+ o100 1)))
(assert (and (= o102 o101) (in_range1 o101)))
(assert (and (= o103 o102) (in_range2 o102)))
(assert (and (= o99 (base Tuple0)) (= o99 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o104 (oexpon o99 o103)))
(assert (= o106 (omultiply o104 o105)))
(assert (and (= o94 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o95 (+ o94 1)))
(assert (and (= o96 o95) (in_range1 o95)))
(assert (and (= o97 o96) (in_range2 o96)))
(assert (= o98 (num_of_big_int (mk___t (map__content a10) (mk (to_rep a__first) (to_rep a__last))) a_first o97)))
(assert (= o107 (osubtract o98 o106)))
(assert (and (= o89 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o90 (+ o89 1)))
(assert (and (= o91 o90) (in_range1 o90)))
(assert (and (= o92 o91) (in_range2 o91)))
(assert (= o93 (num_of_big_int b b_first o92)))
(assert (and (= o85 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o86 (+ o85 1)))
(assert (not (in_range1 o86)))
(check-sat)
(exit)
