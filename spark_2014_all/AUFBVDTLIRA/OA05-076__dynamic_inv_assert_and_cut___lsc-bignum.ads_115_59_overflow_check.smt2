...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (osubtract (num_of_big_int (mk___t temp___586 (mk (to_rep a__first) (to_rep a__last))) a_first (- i2 a_first)) (num_of_big_int b b_first (- i2 a_first))) (osubtract (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first (- i2 a_first)) (omultiply (oexpon (base Tuple0) (- i2 a_first)) (num_of_boolean carry2)))) true) (forall ((k Int)) (=> (and (<= i2 k) (<= k a_last)) (= (to_rep1 (select a2 k)) (to_rep1 (select temp___587 k))))))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (forall ((temp___583 Int)) (=> (and (<= (to_rep a__first) temp___583) (<= temp___583 (to_rep a__last))) (=> (<= i2 temp___583) (= (select a2 temp___583) (select temp___582 temp___583)))))) (=> (<= 0 2147483647) (in_range2 j2))) (and (<= a_first i2) (<= i2 a_last)))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (osubtract (num_of_big_int (mk___t temp___576 (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (num_of_big_int b b_first (- (+ i2 1) a_first))) (osubtract (num_of_big_int (mk___t a3 (mk (to_rep a__first) (to_rep a__last))) a_first (- (+ i2 1) a_first)) (omultiply (oexpon (base Tuple0) (- (+ i2 1) a_first)) (num_of_boolean carry3)))) true) (forall ((k Int)) (=> (and (<= (+ i2 1) k) (<= k a_last)) (= (to_rep1 (select a3 k)) (to_rep1 (select temp___577 k))))))))
...
(assert (and (= o12 (base Tuple0)) (= o12 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
