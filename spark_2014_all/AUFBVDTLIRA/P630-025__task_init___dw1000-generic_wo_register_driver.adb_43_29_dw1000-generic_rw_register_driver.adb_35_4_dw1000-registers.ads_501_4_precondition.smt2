...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__aon_rdat_type__aon_rdat (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__aon_rdat_type__aon_rdat (us_split_fields1 b)))) true false))
...
(define-fun register_byte_array__ref___117__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6014 us_t1) (temp___is_init_6011 Bool) (temp___skip_constant_6012 Bool) (temp___do_toplevel_6013 Bool)) Bool (=> (not (= temp___skip_constant_6012 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6014) (last3 temp___expr_6014)) (and (= (first3 temp___expr_6014) 1) (= (last3 temp___expr_6014) 1)))))
(declare-sort t2 0)
...
(define-fun target__ref___50__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_6030 us_t2) (temp___is_init_6027 Bool) (temp___skip_constant_6028 Bool) (temp___do_toplevel_6029 Bool)) Bool (=> (not (= temp___skip_constant_6028 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6030) (last5 temp___expr_6030)) (and (= (first5 temp___expr_6030) 1) (= (last5 temp___expr_6030) 1)))))
...
(declare-const temp___8076 (Array Int bits_8))
(declare-const temp___80761 t2)
(declare-const temp___8077 (Array Int bits_8))
(declare-const temp___80771 t1)
...
(define-fun temp___80762 () us_t2 (mk___t2 temp___8076 temp___80761))
...
(assert (and (= temp___80762 (register_to_bytes reg)) (dynamic_invariant1 temp___80762 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___80761)) (to_rep (last4 temp___80761))) (+ (- (to_rep (last4 temp___80761)) (to_rep (first4 temp___80761))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8076 temp___8077))
(assert (= (mk1 (to_rep (first4 temp___80761)) (to_rep (last4 temp___80761))) temp___80771))
(assert (= (ite (<= (to_rep (first2 temp___80771)) (to_rep (last2 temp___80771))) (+ (- (to_rep (last2 temp___80771)) (to_rep (first2 temp___80771))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8077 temp___80771)))
(assert (= o2 o))
