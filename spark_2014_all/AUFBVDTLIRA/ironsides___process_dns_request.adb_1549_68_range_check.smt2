...
(declare-const temp___7138 us_rep1)
(declare-const temp___7137 Int)
(declare-const temp___7136 Int)
...
(declare-const temp___7135 us_rep1)
...
(declare-const qname_location1 Int)
(declare-const result12 int__ref)
(declare-const i1 Int)
(declare-const output_packet__split_fields24 us_split_fields2)
(declare-const current_byte3 Int)
(declare-const i2 Int)
(declare-const result13 int__ref)
(declare-const current_byte4 Int)
(declare-const result14 us_split_fields__ref1)
(declare-const output_packet__split_fields25 us_split_fields2)
(declare-const result15 int__ref)
(declare-const i3 Int)
(declare-const output_packet__split_fields26 us_split_fields__ref1)
(declare-const current_byte5 int__ref)
(declare-const i4 int__ref)
(declare-const output_packet__split_fields27 us_split_fields2)
(declare-const current_byte6 Int)
(declare-const i5 Int)
(declare-const output_packet__split_fields28 us_split_fields__ref1)
(declare-const current_byte7 int__ref)
(declare-const i6 int__ref)
(declare-const output_packet__split_fields29 us_split_fields2)
(declare-const current_byte8 Int)
...
(assert (and (= o51 (+ current_byte2 12)) (in_range2 (+ current_byte2 12))))
(assert (= result11 (mk_int__ref qname_location)))
(assert (= qname_location1 o51))
(assert (= result12 (mk_int__ref i)))
(assert (= i1 1))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= temp___7138 (mk___rep1 output_packet__split_fields23))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= temp___7137 i1)))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= temp___7136 current_byte2)))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (and (and (and (and (< i2 129) (<= i2 name_length1)) (= (to_rep2 (rec__dns_types__header_type__ancount (us_split_fields1 (rec__dns_types__dns_packet__header output_packet__split_fields24)))) 0)) (<= start_byte current_byte3)) (< (+ current_byte3 12) 8192))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (and (and (and (=> (<= 1 8180) (in_range4 current_byte3)) (=> (<= 1 129) (in_range8 i2))) (= (rec__dns_types__dns_packet__header output_packet__split_fields24) (rec__dns_types__dns_packet__header (us_split_fields3 temp___7138)))) (and (and (<= i2 name_length1) (< i2 129)) (< (+ current_byte3 12) 8192)))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (and (= o52 (+ current_byte3 1)) (in_range4 (+ current_byte3 1)))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= result13 (mk_int__ref current_byte3))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= current_byte4 o52)))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (and (= o53 (to_rep (select (rec__rr_type__cname_record_type__cnamerecordtype__canonicaldomainname (us_split_fields7 (select cnames 1))) i2))) (uint_in_range (to_rep (select (rec__rr_type__cname_record_type__cnamerecordtype__canonicaldomainname (us_split_fields7 (select cnames 1))) i2))))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= o54 ((_ int2bv 8) o53))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= (to_rep1 o55) o54)))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= o56 (store (rec__dns_types__dns_packet__bytes output_packet__split_fields24) current_byte4 o55))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= o57 (mk___split_fields1 (rec__dns_types__dns_packet__header output_packet__split_fields24) o56))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= temp___7135 (mk___rep1 o57))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= result14 (mk___split_fields__ref1 output_packet__split_fields24))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= output_packet__split_fields25 (us_split_fields3 temp___7135))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (and (= o58 (+ i2 1)) (in_range8 (+ i2 1)))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= result15 (mk_int__ref i2))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= i3 o58)))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (not (and (<= i3 name_length1) (and (< i3 129) (< (+ current_byte4 12) 8192))))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= i4 (mk_int__ref i3))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= current_byte5 (mk_int__ref current_byte4))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= output_packet__split_fields26 (mk___split_fields__ref1 output_packet__split_fields25))))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= i5 i3)))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= current_byte6 current_byte4)))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= output_packet__split_fields27 output_packet__split_fields25)))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= i6 i4)))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= current_byte7 current_byte5)))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= output_packet__split_fields28 output_packet__split_fields26)))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= i7 i5)))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= current_byte8 current_byte6)))
(assert (=> (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192))) (= output_packet__split_fields29 output_packet__split_fields27)))
(assert (=> (not (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192)))) (= i6 (mk_int__ref i1))))
(assert (=> (not (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192)))) (= current_byte7 (mk_int__ref current_byte2))))
(assert (=> (not (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192)))) (= output_packet__split_fields28 (mk___split_fields__ref1 output_packet__split_fields23))))
(assert (=> (not (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192)))) (= i7 i1)))
(assert (=> (not (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192)))) (= current_byte8 current_byte2)))
(assert (=> (not (and (<= i1 name_length1) (and (< i1 129) (< (+ current_byte2 12) 8192)))) (= output_packet__split_fields29 output_packet__split_fields23)))
(assert (= result16 (mk_int__ref output_bytes)))
(assert (= output_bytes1 (+ (int__content current_byte7) 12)))
(assert (not (in_range5 (+ (to_rep2 (rec__dns_types__header_type__ancount (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28))))) 1))))
(check-sat)
(exit)
