...
(assert (= (ite (<= (to_rep2 (first4 temp___10201)) (to_rep2 (last4 temp___10201))) (+ (- (to_rep2 (last4 temp___10201)) (to_rep2 (first4 temp___10201))) 1) 0) (ite (<= 1 (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r))))) (+ (- (+ (to_rep (rec__very_longs__very_long__length (us_split_discrs1 l))) (to_rep (rec__very_longs__very_long__length (us_split_discrs1 r)))) 1) 1) 0)))
(assert (= temp___1020 temp___1021))
(assert (= (mk1 (to_rep2 (first4 temp___10201)) (to_rep2 (last4 temp___10201))) temp___10211))
(assert (= (ite (<= (to_rep2 (first2 temp___10211)) (to_rep2 (last2 temp___10211))) (+ (- (to_rep2 (last2 temp___10211)) (to_rep2 (first2 temp___10211))) 1) 0) (ite (<= (to_rep2 (first2 result____split_fields1)) (to_rep2 (last2 result____split_fields1))) (+ (- (to_rep2 (last2 result____split_fields1)) (to_rep2 (first2 result____split_fields1))) 1) 0)))
...
(assert (= result____split_fields2 (mk___split_fields1 (mk___t1 temp___10241 temp___10242))))
(assert (= result____split_discrs (mk___split_discrs temp___1024)))
