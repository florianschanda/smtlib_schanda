...
(assert (= a1 result2))
(assert (= a2 o15))
(assert (and (= o43 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o44 (ite (<= k o43) true false)))
(assert (and (= o42 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o45 (ite (<= o42 k) true false)))
(assert (= result3 (ite (= o45 true) o44 false)))
(assert (= (= o46 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
(assert (= o37 (from_word32 carry22)))
(assert (and (= o36 (base Tuple0)) (= o36 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o38 (omultiply o36 o37)))
(assert (= o35 (from_word32 carry12)))
(assert (= o39 (oadd o35 o38)))
...
(assert (= o34 (oexpon o29 o33)))
(assert (= o40 (omultiply o34 o39)))
(assert (and (= o24 (+ i2 1)) (in_range1 (+ i2 1))))
(assert (= o25 (- o24 a_first)))
(assert (and (= o26 o25) (in_range1 o25)))
(assert (and (= o27 o26) (in_range2 o26)))
(assert (= o28 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o27)))
(assert (= o41 (oadd o28 o40)))
(assert (= o22 (from_word32 carry2)))
(assert (and (= o21 (base Tuple0)) (= o21 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o23 (omultiply o21 o22)))
(assert (= o20 (from_word32 carry1)))
(assert (= o19 (from_word32 y)))
