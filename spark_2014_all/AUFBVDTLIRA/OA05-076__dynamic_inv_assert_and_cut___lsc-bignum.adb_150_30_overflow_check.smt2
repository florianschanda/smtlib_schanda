...
(assert (= o34 (ite (<= o33 k) true false)))
(assert (= result7 (ite (= o34 true) (ite (<= k a_last) true false) false)))
(assert (= (= o35 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 a_last)) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
(assert (= o32 (num_of_boolean carry3)))
