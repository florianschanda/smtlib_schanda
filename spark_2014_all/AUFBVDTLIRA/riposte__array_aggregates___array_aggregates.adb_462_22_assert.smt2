...
(declare-fun temp_____aggregate_def_740 (Bool) (Array Int Bool))
(declare-fun temp_____aggregate_def_744 (Bool) (Array Int Bool))
...
(assert (forall ((temp___742 Bool)) (forall ((temp___743 Int)) (= (select (temp_____aggregate_def_740 temp___742) temp___743) temp___742))))
(assert (forall ((temp___746 Bool)) (forall ((temp___747 Int)) (= (select (temp_____aggregate_def_744 temp___746) temp___747) temp___746))))
(declare-const x (Array Int Bool))
(declare-const result (Array Int Bool))
(declare-const x1 (Array Int Bool))
(assert (= result x))
(assert (= x1 (temp_____aggregate_def_740 (ite (= (bvxor y y) #x00) true false))))
(declare-const n Int)
(assert (<= 0 n))
(assert (<= n 255))
(assert (not (= (bool_eq x1 0 255 (temp_____aggregate_def_744 (= n n)) 0 255) true)))
(check-sat)
(exit)
