...
(define-fun dynamic_invariant ((temp___expr_198 (_ BitVec 8)) (temp___is_init_195 Bool) (temp___skip_constant_196 Bool) (temp___do_toplevel_197 Bool)) Bool true)
...
(assert (forall ((a (Array Int Bool)) (b (Array Int Bool))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_137 Int)) (=> (and (<= a__first temp___idx_137) (<= temp___idx_137 a__last)) (= (select a temp___idx_137) (select b (+ (- b__first a__first) temp___idx_137))))))))))
...
(assert (forall ((temp___693 Bool)) (forall ((temp___694 Int)) (= (select (temp___691 temp___693) temp___694) temp___693))))
(declare-fun temp___695 (Bool) (Array Int Bool))
(assert (forall ((temp___697 Bool)) (forall ((temp___698 Int)) (= (select (temp___695 temp___697) temp___698) temp___697))))
...
(assert (<= 0 n))
(assert (<= n 255))
(assert (not (= (bool_eq x1 0 255 (temp___695 (= n n)) 0 255) true)))
(check-sat)
(exit)
