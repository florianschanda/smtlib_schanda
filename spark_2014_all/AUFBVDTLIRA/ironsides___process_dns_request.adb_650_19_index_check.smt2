...
(assert (=> (and (and (<= byte2 (- input_bytes 5)) (not (= (to_rep1 (select (rec__dns_types__dns_packet__bytes (us_split_fields3 input_packet)) byte2)) #x00))) (< i1 129)) (= (mk_map__ref domainname6) (mk_map__ref domainname4))))
