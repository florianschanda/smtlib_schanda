...
(assert (< digit_count2 index2))
(declare-const j2 Int)
(assert (<= (+ digit_count2 1) j2))
(assert (<= j2 index2))
(assert (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j2)) ((_ int2bv 8) 0))))
(check-sat)
(exit)
