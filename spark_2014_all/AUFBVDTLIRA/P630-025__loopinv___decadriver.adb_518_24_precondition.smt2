...
(assert (= (to_rep (rec__dw1000__register_types__sys_status_type__rxsfdto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) ((_ int2bv 8) 1)))
(assert (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields11 (driver_type__content self__))) true))
(assert (dynamic_invariant (mk___rep2 receiver__split_fields8) true true true))
