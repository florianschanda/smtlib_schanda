...
(assert (not (= i2 (- src_length 1))))
(assert (= i2 result2))
(assert (= i3 (+ i2 1)))
(assert (and (= temp___2021 (+ src_first i3)) (in_range1 (+ src_first i3))))
(assert (and (<= (to_rep (first (rt src))) temp___2021) (<= temp___2021 (to_rep (last (rt src))))))
(assert (= o6 temp___2021))
(assert (= o7 (select (elts src) o6)))
(assert (= o8 (to_rep1 o7)))
(assert (= (to_rep1 o9) o8))
(assert (and (= temp___2031 (+ index i3)) (in_range1 (+ index i3))))
(assert (and (<= (to_rep dest__first) temp___2031) (<= temp___2031 (to_rep dest__last))))
(assert (= o10 temp___2031))
(assert (= o11 (store dest2 o10 o9)))
(assert (= result3 dest2))
(assert (= dest3 o11))
(declare-const j Int)
(assert (<= (to_rep dest__first) j))
(assert (<= j (to_rep dest__last)))
(assert (not (and (<= index j) (<= j (+ index i3)))))
(assert (not (= (to_rep1 (select dest3 j)) (to_rep1 (select dest j)))))
(check-sat)
(exit)
