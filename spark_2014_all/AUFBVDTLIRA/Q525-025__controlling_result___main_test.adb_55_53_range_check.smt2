...
(assert (=> (<= (to_rep2 (first2 (rt1 temp___314))) (to_rep2 (last2 (rt1 temp___314)))) (= o39 (+ (- (to_rep2 (last2 (rt1 temp___314))) (to_rep2 (first2 (rt1 temp___314)))) 1))))
(assert (=> (not (<= (to_rep2 (first2 (rt1 temp___314))) (to_rep2 (last2 (rt1 temp___314))))) (= o39 0)))
(assert (=> (<= (to_rep2 (first2 (rt1 temp___313))) (to_rep2 (last2 (rt1 temp___313)))) (= o40 (+ (- (to_rep2 (last2 (rt1 temp___313))) (to_rep2 (first2 (rt1 temp___313)))) 1))))
(assert (=> (not (<= (to_rep2 (first2 (rt1 temp___313))) (to_rep2 (last2 (rt1 temp___313))))) (= o40 0)))
(assert (= o41 (+ o40 o39)))
(assert (= o42 (+ (to_rep2 (first2 (rt1 temp___313))) o41)))
(assert (= o43 (- o42 1)))
