...
(assert (and (and (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i2)) (forall ((temp___291 Int)) (=> (and (<= (to_rep result____first) temp___291) (<= temp___291 (to_rep result____last))) (=> (< i2 temp___291) (= (select result__2 temp___291) (select result__ temp___291)))))) (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))))
