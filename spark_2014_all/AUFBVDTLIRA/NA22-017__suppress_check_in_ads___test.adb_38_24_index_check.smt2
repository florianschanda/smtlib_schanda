...
(assert (and (and (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i2)) (forall ((temp___333 Int)) (=> (and (<= (to_rep result____first) temp___333) (<= temp___333 (to_rep result____last))) (=> (< i2 temp___333) (= (select result__2 temp___333) (select result__ temp___333)))))) (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))))
(assert (<= (to_rep result____first) pos))
(assert (<= pos i2))
(assert (and (<= (to_rep (first (rt right))) pos) (<= pos (to_rep (last (rt right))))))
(assert (= o12 pos))
(assert (= o13 (select (elts right) o12)))
(assert (= o14 (to_rep1 o13)))
(assert (and (<= (to_rep (first (rt left))) pos) (<= pos (to_rep (last (rt left))))))
(assert (= o9 pos))
(assert (= o10 (select (elts left) o9)))
(assert (= o11 (to_rep1 o10)))
(assert (and (= o15 (xor2 o11 o14)) (= o15 (bvxor o11 o14))))
(assert (not (<= (to_rep result____first) pos)))
(check-sat)
(exit)
