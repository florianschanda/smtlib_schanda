...
(define-fun dynamic_invariant ((temp___expr_7340 us_t1) (temp___is_init_7336 Bool) (temp___skip_constant_7337 Bool) (temp___do_toplevel_7338 Bool) (temp___do_typ_inv_7339 Bool)) Bool (=> (not (= temp___skip_constant_7337 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7340) (last3 temp___expr_7340)) (and (= (first3 temp___expr_7340) 1) (= (last3 temp___expr_7340) 2)))))
