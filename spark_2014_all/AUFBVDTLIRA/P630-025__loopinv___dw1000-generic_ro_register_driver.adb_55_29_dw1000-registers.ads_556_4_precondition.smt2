...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__lde_thresh_type__lde_thresh bits_16)))))
(define-fun us_split_fields_LDE_THRESH__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__lde_thresh_type__lde_thresh a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___80__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___80__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__lde_thresh_type__lde_thresh (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__lde_thresh_type__lde_thresh (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__lde_thresh_type__lde_thresh__first__bit Int)
(declare-const dw1000__register_types__lde_thresh_type__lde_thresh__last__bit Int)
(declare-const dw1000__register_types__lde_thresh_type__lde_thresh__position Int)
(assert (<= 0 dw1000__register_types__lde_thresh_type__lde_thresh__first__bit))
(assert (< dw1000__register_types__lde_thresh_type__lde_thresh__first__bit dw1000__register_types__lde_thresh_type__lde_thresh__last__bit))
(assert (<= 0 dw1000__register_types__lde_thresh_type__lde_thresh__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((lde_thresh_type__ref (mk_lde_thresh_type__ref (lde_thresh_type__content us_rep)))))
(define-fun lde_thresh_type__ref___projection ((a lde_thresh_type__ref)) us_rep (lde_thresh_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___195__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___137__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___137__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6673 us_t1) (temp___is_init_6670 Bool) (temp___skip_constant_6671 Bool) (temp___do_toplevel_6672 Bool)) Bool (=> (not (= temp___skip_constant_6671 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6673) (last3 temp___expr_6673)) (and (= (first3 temp___expr_6673) 1) (= (last3 temp___expr_6673) 2)))))
