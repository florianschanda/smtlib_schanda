...
(declare-const temp___1274 digit_index_type)
(declare-const temp___12741 (Array Int octet))
(declare-const temp___12742 t1)
(declare-const o Int)
...
(assert (and (dynamic_invariant5 (mk___rep1 u__split_discrs u__split_fields3) true true true) (and (<= 1 divisor_index2) (<= divisor_index2 r126b))))
