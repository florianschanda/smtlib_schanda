...
(assert (and (= o (readmem16 addr memory)) (= o (bvor ((_ zero_extend 8) (to_rep (select memory addr))) (ite (< 8 16) (bvshl ((_ zero_extend 8) (to_rep (select memory (bvadd addr ((_ int2bv 64) 1))))) ((_ int2bv 16) 8)) ((_ int2bv 16) 0))))))
...
(assert (not (= x86__readmem32_v2__result4 (bvor ((_ zero_extend 16) (readmem16 addr memory)) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr ((_ int2bv 64) 2)) memory)) ((_ int2bv 32) 16))))))
(check-sat)
(exit)
