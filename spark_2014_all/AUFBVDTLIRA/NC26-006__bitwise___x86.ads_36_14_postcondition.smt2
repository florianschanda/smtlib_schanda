...
(assert (and (= o1 (readmem16 (bvadd addr #x0000000000000002) memory)) (= o1 (bvor ((_ zero_extend 8) (to_rep (select memory (bvadd addr #x0000000000000002)))) (ite (< 8 16) (bvshl ((_ zero_extend 8) (to_rep (select memory (bvadd (bvadd addr #x0000000000000002) #x0000000000000001)))) ((_ int2bv 16) 8)) #x0000)))))
(assert (= o2 ((_ zero_extend 16) o1)))
(assert (= o3 (bvshl o2 ((_ int2bv 32) 16))))
(assert (and (= o (readmem16 addr memory)) (= o (bvor ((_ zero_extend 8) (to_rep (select memory addr))) (ite (< 8 16) (bvshl ((_ zero_extend 8) (to_rep (select memory (bvadd addr #x0000000000000001)))) ((_ int2bv 16) 8)) #x0000)))))
...
(assert (= (mk_t__ref1 x86__readmem32_v2__result4) (mk_t__ref1 x86__readmem32_v2__result2)))
(assert (= x86__readmem32_v2__result5 x86__readmem32_v2__result3))
(assert (= result1 x86__readmem32_v2__result4))
(assert (not (= x86__readmem32_v2__result4 (bvor ((_ zero_extend 16) (readmem16 addr memory)) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr #x0000000000000002) memory)) ((_ int2bv 32) 16))))))
(check-sat)
(exit)
