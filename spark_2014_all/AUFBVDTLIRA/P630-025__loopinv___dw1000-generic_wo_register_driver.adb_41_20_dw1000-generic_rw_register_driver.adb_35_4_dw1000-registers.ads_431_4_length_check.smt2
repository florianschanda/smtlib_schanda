...
(define-fun target__ref___39__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__rf_rxctrlh_type__rf_rxctrlh (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__rf_rxctrlh_type__rf_rxctrlh (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_5793 us_t1) (temp___is_init_5789 Bool) (temp___skip_constant_5790 Bool) (temp___do_toplevel_5791 Bool) (temp___do_typ_inv_5792 Bool)) Bool (=> (not (= temp___skip_constant_5790 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5793) (last3 temp___expr_5793)) (and (= (first3 temp___expr_5793) 1) (= (last3 temp___expr_5793) 1)))))
...
(define-fun register_byte_array__ref___92__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_5775 us_t2) (temp___is_init_5771 Bool) (temp___skip_constant_5772 Bool) (temp___do_toplevel_5773 Bool) (temp___do_typ_inv_5774 Bool)) Bool (=> (not (= temp___skip_constant_5772 true)) (and (dynamic_property3 1 1 (first5 temp___expr_5775) (last5 temp___expr_5775)) (and (= (first5 temp___expr_5775) 1) (= (last5 temp___expr_5775) 1)))))
...
(declare-const temp___87651 t1)
(define-fun temp___87652 () us_t1 (mk___t1 temp___8765 temp___87651))
...
(assert (and (= temp___87652 (register_to_bytes reg)) (dynamic_invariant temp___87652 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___87651)) (to_rep (last2 temp___87651))) (+ (- (to_rep (last2 temp___87651)) (to_rep (first2 temp___87651))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0))))
(check-sat)
(exit)
