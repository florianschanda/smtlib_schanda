...
(declare-const temp___7994 (Array Int bits_8))
(declare-const temp___79941 t1)
...
(assert (and (= (mk___t2 temp___7993 temp___79931) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7993 temp___79931) true false true)))
