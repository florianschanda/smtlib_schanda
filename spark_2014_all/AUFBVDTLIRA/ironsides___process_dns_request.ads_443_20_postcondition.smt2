...
(declare-const temp___7142 us_rep1)
...
(declare-const output_packet__split_fields30 us_split_fields2)
(declare-const domainname2 map__ref)
(declare-const qname_location2 int__ref)
(declare-const output_packet__split_fields31 us_split_fields__ref1)
(declare-const output_bytes2 int__ref)
(declare-const current_byte9 int__ref)
(declare-const name_length2 int__ref)
(declare-const i8 int__ref)
(declare-const domainname3 (Array Int character))
(declare-const qname_location3 Int)
(declare-const output_packet__split_fields32 us_split_fields2)
(declare-const output_bytes3 Int)
(declare-const current_byte10 Int)
(declare-const name_length3 Int)
...
(assert (and (= o59 (+ (to_rep2 (rec__dns_types__header_type__ancount (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28))))) 1)) (in_range5 (+ (to_rep2 (rec__dns_types__header_type__ancount (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28))))) 1))))
(assert (= (to_rep2 o60) o59))
(assert (= o61 (mk___split_fields (rec__dns_types__header_type__messageid (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))) (rec__dns_types__header_type__qr (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))) (rec__dns_types__header_type__opcode (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))) (rec__dns_types__header_type__aa (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))) (rec__dns_types__header_type__tc (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))) (rec__dns_types__header_type__rd (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))) (rec__dns_types__header_type__ra (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))) (rec__dns_types__header_type__res1 (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))) (rec__dns_types__header_type__res2 (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))) (rec__dns_types__header_type__res3 (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))) (rec__dns_types__header_type__rcode (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))) (rec__dns_types__header_type__qdcount (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))) o60 (rec__dns_types__header_type__nscount (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))) (rec__dns_types__header_type__arcount (us_split_fields1 (rec__dns_types__dns_packet__header (us_split_fields__content1 output_packet__split_fields28)))))))
(assert (= o62 (mk___rep o61)))
(assert (= o63 (mk___split_fields1 o62 (rec__dns_types__dns_packet__bytes (us_split_fields__content1 output_packet__split_fields28)))))
(assert (= temp___7142 (mk___rep1 o63)))
(assert (= result17 output_packet__split_fields28))
(assert (= output_packet__split_fields30 (us_split_fields3 temp___7142)))
(assert (= i8 i6))
(assert (= name_length2 (mk_int__ref name_length1)))
(assert (= current_byte9 current_byte7))
(assert (= output_bytes2 (mk_int__ref output_bytes1)))
(assert (= output_packet__split_fields31 (mk___split_fields__ref1 output_packet__split_fields30)))
(assert (= qname_location2 (mk_int__ref qname_location1)))
(assert (= domainname2 (mk_map__ref domainname1)))
(assert (= i9 i7))
(assert (= name_length3 name_length1))
(assert (= current_byte10 current_byte8))
(assert (= output_bytes3 output_bytes1))
(assert (= output_packet__split_fields32 output_packet__split_fields30))
(assert (= qname_location3 qname_location1))
(assert (= domainname3 domainname1))
(assert (not (<= 13 (int__content output_bytes2))))
(check-sat)
(exit)
