...
(assert (not (= (ite (<= (to_rep1 (first4 temp___12571)) (to_rep1 (last4 temp___12571))) (+ (- (to_rep1 (last4 temp___12571)) (to_rep1 (first4 temp___12571))) 1) 0) (ite (<= 1 r117b) (+ (- r117b 1) 1) 0))))
(check-sat)
(exit)
