...
(assert (forall ((r us_rep)) (! (dynamic_invariant (to_model r) true false true true) :pattern ((to_model r)))))
...
(assert (forall ((m us_t)) (! (=> (and (dynamic_invariant m true true true true) (< 0 (length m))) (dynamic_invariant1 (func_head m) true false true true)) :pattern ((func_head m)))))
(assert (forall ((m us_t)) (! (=> (dynamic_invariant m true true true true) (= (func_head m) (to_rep (select (to_array m) (first1 m))))) :pattern ((func_head m)))))
...
(define-fun dynamic_invariant3 ((temp___expr_166 Int) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (<= 0 65536)) (in_range1 temp___expr_166)))
...
(assert (and (= o2 (to_model r)) (and (dynamic_invariant o2 true false true true) (= o2 (ite (< 65535 (- (+ (bv2nat (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r)))) 1)) (ite (= (length1 (mk___t1 (rec__ring_buf__ring_buffer__data (us_split_fields1 r)) (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) #xFFFF))) 0) (mk___t (rec__ring_buf__ring_buffer__data (us_split_fields1 r)) (mk (to_rep1 (first4 (mk2 #x0000 (bvsub (bvsub (bvadd #x0000 ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub #xFFFF (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) #x0001)))) (to_rep1 (last4 (mk2 #x0000 (bvsub (bvsub (bvadd #x0000 ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub #xFFFF (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) #x0001)))))) (mk___t (concat1 (rec__ring_buf__ring_buffer__data (us_split_fields1 r)) (to_rep1 (first2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) #xFFFF))) (to_rep1 (last2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) #xFFFF))) (rec__ring_buf__ring_buffer__data (us_split_fields1 r)) (to_rep1 (first4 (mk2 #x0000 (bvsub (bvsub (bvadd #x0000 ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub #xFFFF (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) #x0001)))) (to_rep1 (last4 (mk2 #x0000 (bvsub (bvsub (bvadd #x0000 ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub #xFFFF (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) #x0001))))) (mk (to_rep1 (first2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) #xFFFF))) ((_ int2bv 16) (- (+ (bv2nat (to_rep1 (first2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) #xFFFF)))) (+ (ite (<= (bv2nat (to_rep1 (first2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) #xFFFF)))) (bv2nat (to_rep1 (last2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) #xFFFF))))) (+ (- (bv2nat (to_rep1 (last2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) #xFFFF)))) (bv2nat (to_rep1 (first2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) #xFFFF))))) 1) 0) (ite (<= (bv2nat (to_rep1 (first4 (mk2 #x0000 (bvsub (bvsub (bvadd #x0000 ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub #xFFFF (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) #x0001))))) (bv2nat (to_rep1 (last4 (mk2 #x0000 (bvsub (bvsub (bvadd #x0000 ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub #xFFFF (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) #x0001)))))) (+ (- (bv2nat (to_rep1 (last4 (mk2 #x0000 (bvsub (bvsub (bvadd #x0000 ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub #xFFFF (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) #x0001))))) (bv2nat (to_rep1 (first4 (mk2 #x0000 (bvsub (bvsub (bvadd #x0000 ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub #xFFFF (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) #x0001)))))) 1) 0))) 1))))) (mk___t (rec__ring_buf__ring_buffer__data (us_split_fields1 r)) (mk (to_rep1 (first6 (mk3 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) (bvsub (bvadd (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) #x0001)))) (to_rep1 (last6 (mk3 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) (bvsub (bvadd (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) #x0001)))))))))))
