...
(define-fun dynamic_invariant ((temp___expr_148 us_t) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (not (= temp___skip_constant_146 true)) (dynamic_property ((_ int2bv 16) 0) ((_ int2bv 16) 65535) (first1 temp___expr_148) (last1 temp___expr_148))))
...
(assert (forall ((r us_rep)) (! (dynamic_invariant (to_model r) true false true) :pattern ((to_model r)))))
...
(assert (forall ((m us_t)) (! (=> (and (dynamic_invariant m true true true) (< 0 (length m))) (dynamic_invariant1 (func_head m) true false true)) :pattern ((func_head m)))))
(assert (forall ((m us_t)) (! (=> (dynamic_invariant m true true true) (= (func_head m) (to_rep (select (to_array m) (first1 m))))) :pattern ((func_head m)))))
...
(define-fun dynamic_invariant3 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 65536)) (in_range1 temp___expr_142)))
...
(assert (= ring_buf__head__result1 (to_rep (select (rec__ring_buf__ring_buffer__data (us_split_fields1 r)) (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))))))
(assert (= (mk_int__ref ring_buf__head__result4) (mk_int__ref ring_buf__head__result2)))
(assert (= ring_buf__head__result5 ring_buf__head__result3))
(assert (and (= (mk___t o o1) (to_model r)) (and (dynamic_invariant (mk___t o o1) true false true) (= (mk___t o o1) (ite (< 65535 (- (+ (bv2nat (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r)))) 1)) (ite (= (length1 (mk___t1 (rec__ring_buf__ring_buffer__data (us_split_fields1 r)) (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) 65535)))) 0) (mk___t (rec__ring_buf__ring_buffer__data (us_split_fields1 r)) (mk (to_rep1 (first4 (mk2 ((_ int2bv 16) 0) (bvsub (bvsub (bvadd ((_ int2bv 16) 0) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub ((_ int2bv 16) 65535) (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) ((_ int2bv 16) 1))))) (to_rep1 (last4 (mk2 ((_ int2bv 16) 0) (bvsub (bvsub (bvadd ((_ int2bv 16) 0) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub ((_ int2bv 16) 65535) (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) ((_ int2bv 16) 1))))))) (mk___t (concat1 (rec__ring_buf__ring_buffer__data (us_split_fields1 r)) (to_rep1 (first2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) 65535)))) (to_rep1 (last2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) 65535)))) (rec__ring_buf__ring_buffer__data (us_split_fields1 r)) (to_rep1 (first4 (mk2 ((_ int2bv 16) 0) (bvsub (bvsub (bvadd ((_ int2bv 16) 0) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub ((_ int2bv 16) 65535) (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) ((_ int2bv 16) 1))))) (to_rep1 (last4 (mk2 ((_ int2bv 16) 0) (bvsub (bvsub (bvadd ((_ int2bv 16) 0) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub ((_ int2bv 16) 65535) (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) ((_ int2bv 16) 1)))))) (mk (to_rep1 (first2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) 65535)))) ((_ int2bv 16) (- (+ (bv2nat (to_rep1 (first2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) 65535))))) (+ (ite (<= (bv2nat (to_rep1 (first2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) 65535))))) (bv2nat (to_rep1 (last2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) 65535)))))) (+ (- (bv2nat (to_rep1 (last2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) 65535))))) (bv2nat (to_rep1 (first2 (mk1 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) 65535)))))) 1) 0) (ite (<= (bv2nat (to_rep1 (first4 (mk2 ((_ int2bv 16) 0) (bvsub (bvsub (bvadd ((_ int2bv 16) 0) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub ((_ int2bv 16) 65535) (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) ((_ int2bv 16) 1)))))) (bv2nat (to_rep1 (last4 (mk2 ((_ int2bv 16) 0) (bvsub (bvsub (bvadd ((_ int2bv 16) 0) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub ((_ int2bv 16) 65535) (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) ((_ int2bv 16) 1))))))) (+ (- (bv2nat (to_rep1 (last4 (mk2 ((_ int2bv 16) 0) (bvsub (bvsub (bvadd ((_ int2bv 16) 0) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub ((_ int2bv 16) 65535) (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) ((_ int2bv 16) 1)))))) (bv2nat (to_rep1 (first4 (mk2 ((_ int2bv 16) 0) (bvsub (bvsub (bvadd ((_ int2bv 16) 0) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) (bvsub ((_ int2bv 16) 65535) (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))))) ((_ int2bv 16) 1))))))) 1) 0))) 1))))) (mk___t (rec__ring_buf__ring_buffer__data (us_split_fields1 r)) (mk (to_rep1 (first6 (mk3 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) (bvsub (bvadd (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) ((_ int2bv 16) 1))))) (to_rep1 (last6 (mk3 (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) (bvsub (bvadd (to_rep1 (rec__ring_buf__ring_buffer__first (us_split_fields1 r))) ((_ int2bv 16) (to_rep2 (rec__ring_buf__ring_buffer__length (us_split_fields1 r))))) ((_ int2bv 16) 1))))))))))))
(assert (not (< 0 (length (mk___t o o1)))))
(check-sat)
(exit)
