...
(assert (forall ((x bits_16)) (! (= (of_rep4 (to_rep4 x)) x) :pattern ((to_rep4 x)))))
(assert true)
...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__aon_cfg0_type__sleep_en bits_1) (rec__dw1000__register_types__aon_cfg0_type__wake_pin bits_1) (rec__dw1000__register_types__aon_cfg0_type__wake_spi bits_1) (rec__dw1000__register_types__aon_cfg0_type__wake_cnt bits_1) (rec__dw1000__register_types__aon_cfg0_type__lpdiv_en bits_1) (rec__dw1000__register_types__aon_cfg0_type__lpclkdiva bits_11) (rec__dw1000__register_types__aon_cfg0_type__sleep_tim bits_16)))))
(define-fun us_split_fields_SLEEP_EN__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__aon_cfg0_type__sleep_en a))
(define-fun us_split_fields_WAKE_PIN__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__aon_cfg0_type__wake_pin a))
(define-fun us_split_fields_WAKE_SPI__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__aon_cfg0_type__wake_spi a))
(define-fun us_split_fields_WAKE_CNT__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__aon_cfg0_type__wake_cnt a))
(define-fun us_split_fields_LPDIV_EN__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__aon_cfg0_type__lpdiv_en a))
(define-fun us_split_fields_LPCLKDIVA__projection ((a us_split_fields)) bits_11 (rec__dw1000__register_types__aon_cfg0_type__lpclkdiva a))
(define-fun us_split_fields_SLEEP_TIM__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__aon_cfg0_type__sleep_tim a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___71__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___71__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (and (and (= (to_rep2 (rec__dw1000__register_types__aon_cfg0_type__sleep_en (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_cfg0_type__sleep_en (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__aon_cfg0_type__wake_pin (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_cfg0_type__wake_pin (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__aon_cfg0_type__wake_spi (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_cfg0_type__wake_spi (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__aon_cfg0_type__wake_cnt (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_cfg0_type__wake_cnt (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__aon_cfg0_type__lpdiv_en (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__aon_cfg0_type__lpdiv_en (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__aon_cfg0_type__lpclkdiva (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__aon_cfg0_type__lpclkdiva (us_split_fields1 b))))) (= (to_rep4 (rec__dw1000__register_types__aon_cfg0_type__sleep_tim (us_split_fields1 a))) (to_rep4 (rec__dw1000__register_types__aon_cfg0_type__sleep_tim (us_split_fields1 b))))) true false))
...
(assert (< dw1000__register_types__aon_cfg0_type__sleep_en__first__bit dw1000__register_types__aon_cfg0_type__sleep_en__last__bit))
...
(assert (< dw1000__register_types__aon_cfg0_type__wake_pin__first__bit dw1000__register_types__aon_cfg0_type__wake_pin__last__bit))
...
(assert (< dw1000__register_types__aon_cfg0_type__wake_spi__first__bit dw1000__register_types__aon_cfg0_type__wake_spi__last__bit))
...
(assert (< dw1000__register_types__aon_cfg0_type__wake_cnt__first__bit dw1000__register_types__aon_cfg0_type__wake_cnt__last__bit))
...
(assert (< dw1000__register_types__aon_cfg0_type__lpdiv_en__first__bit dw1000__register_types__aon_cfg0_type__lpdiv_en__last__bit))
...
(assert (<= 0 dw1000__register_types__aon_cfg0_type__lpclkdiva__first__bit))
(assert (< dw1000__register_types__aon_cfg0_type__lpclkdiva__first__bit dw1000__register_types__aon_cfg0_type__lpclkdiva__last__bit))
...
(assert (<= 0 dw1000__register_types__aon_cfg0_type__sleep_tim__first__bit))
(assert (< dw1000__register_types__aon_cfg0_type__sleep_tim__first__bit dw1000__register_types__aon_cfg0_type__sleep_tim__last__bit))
(assert (<= 0 dw1000__register_types__aon_cfg0_type__sleep_tim__position))
(declare-fun user_eq7 (us_rep us_rep) Bool)
(declare-const dummy7 us_rep)
(declare-datatypes () ((aon_cfg0_type__ref (mk_aon_cfg0_type__ref (aon_cfg0_type__content us_rep)))))
(define-fun aon_cfg0_type__ref___projection ((a aon_cfg0_type__ref)) us_rep (aon_cfg0_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___172__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___121__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___121__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6758 us_t1) (temp___is_init_6754 Bool) (temp___skip_constant_6755 Bool) (temp___do_toplevel_6756 Bool) (temp___do_typ_inv_6757 Bool)) Bool (=> (not (= temp___skip_constant_6755 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6758) (last3 temp___expr_6758)) (and (= (first3 temp___expr_6758) 1) (= (last3 temp___expr_6758) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___52__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___52__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_6782 us_t2) (temp___is_init_6778 Bool) (temp___skip_constant_6779 Bool) (temp___do_toplevel_6780 Bool) (temp___do_typ_inv_6781 Bool)) Bool (=> (not (= temp___skip_constant_6779 true)) (and (dynamic_property3 1 4 (first5 temp___expr_6782) (last5 temp___expr_6782)) (and (= (first5 temp___expr_6782) 1) (= (last5 temp___expr_6782) 4)))))
...
(declare-const temp___8862 (Array Int bits_8))
(declare-const temp___88621 t2)
(declare-const temp___8863 (Array Int bits_8))
(declare-const temp___88631 t1)
(define-fun temp___88622 () us_t2 (mk___t2 temp___8862 temp___88621))
...
(assert (and (= temp___88622 (register_to_bytes reg)) (dynamic_invariant1 temp___88622 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___88621)) (to_rep (last4 temp___88621))) (+ (- (to_rep (last4 temp___88621)) (to_rep (first4 temp___88621))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8862 temp___8863))
(assert (= (mk1 (to_rep (first4 temp___88621)) (to_rep (last4 temp___88621))) temp___88631))
(assert (not (= (ite (<= (to_rep (first2 temp___88631)) (to_rep (last2 temp___88631))) (+ (- (to_rep (last2 temp___88631)) (to_rep (first2 temp___88631))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
