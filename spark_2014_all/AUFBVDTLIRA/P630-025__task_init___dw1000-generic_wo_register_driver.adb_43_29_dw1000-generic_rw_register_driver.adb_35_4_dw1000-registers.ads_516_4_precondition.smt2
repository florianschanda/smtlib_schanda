...
(assert (= (ite (<= (to_rep (first4 temp___80971)) (to_rep (last4 temp___80971))) (+ (- (to_rep (last4 temp___80971)) (to_rep (first4 temp___80971))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8097 temp___8098))
(assert (= (mk1 (to_rep (first4 temp___80971)) (to_rep (last4 temp___80971))) temp___80981))
(assert (= (ite (<= (to_rep (first2 temp___80981)) (to_rep (last2 temp___80981))) (+ (- (to_rep (last2 temp___80981)) (to_rep (first2 temp___80981))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
