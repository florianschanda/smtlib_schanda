...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__pmsc_snozt_type__snoz_tim bits_8)))))
(define-fun us_split_fields_SNOZ_TIM__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__pmsc_snozt_type__snoz_tim a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___103__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___103__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__pmsc_snozt_type__snoz_tim (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__pmsc_snozt_type__snoz_tim (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__pmsc_snozt_type__snoz_tim__first__bit Int)
(declare-const dw1000__register_types__pmsc_snozt_type__snoz_tim__last__bit Int)
(declare-const dw1000__register_types__pmsc_snozt_type__snoz_tim__position Int)
(assert (<= 0 dw1000__register_types__pmsc_snozt_type__snoz_tim__first__bit))
(assert (< dw1000__register_types__pmsc_snozt_type__snoz_tim__first__bit dw1000__register_types__pmsc_snozt_type__snoz_tim__last__bit))
(assert (<= 0 dw1000__register_types__pmsc_snozt_type__snoz_tim__position))
(declare-fun user_eq4 (us_rep us_rep) Bool)
(declare-const dummy4 us_rep)
(declare-datatypes () ((pmsc_snozt_type__ref (mk_pmsc_snozt_type__ref (pmsc_snozt_type__content us_rep)))))
(define-fun pmsc_snozt_type__ref___projection ((a pmsc_snozt_type__ref)) us_rep (pmsc_snozt_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___236__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___169__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___169__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_8288 us_t1) (temp___is_init_8284 Bool) (temp___skip_constant_8285 Bool) (temp___do_toplevel_8286 Bool) (temp___do_typ_inv_8287 Bool)) Bool (=> (not (= temp___skip_constant_8285 true)) (and (dynamic_property2 1 1 (first3 temp___expr_8288) (last3 temp___expr_8288)) (and (= (first3 temp___expr_8288) 1) (= (last3 temp___expr_8288) 1)))))
(declare-sort t2 0)
...
(define-fun target__ref___68__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___68__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_8306 us_t2) (temp___is_init_8302 Bool) (temp___skip_constant_8303 Bool) (temp___do_toplevel_8304 Bool) (temp___do_typ_inv_8305 Bool)) Bool (=> (not (= temp___skip_constant_8303 true)) (and (dynamic_property3 1 1 (first5 temp___expr_8306) (last5 temp___expr_8306)) (and (= (first5 temp___expr_8306) 1) (= (last5 temp___expr_8306) 1)))))
...
(declare-const temp___9006 (Array Int bits_8))
(declare-const temp___90061 t2)
(declare-const temp___9007 (Array Int bits_8))
(declare-const temp___90071 t1)
...
(define-fun temp___90062 () us_t2 (mk___t2 temp___9006 temp___90061))
...
(assert (and (= temp___90062 (register_to_bytes reg)) (dynamic_invariant1 temp___90062 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___90061)) (to_rep (last4 temp___90061))) (+ (- (to_rep (last4 temp___90061)) (to_rep (first4 temp___90061))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___9006 temp___9007))
(assert (= (mk1 (to_rep (first4 temp___90061)) (to_rep (last4 temp___90061))) temp___90071))
(assert (= (ite (<= (to_rep (first2 temp___90071)) (to_rep (last2 temp___90071))) (+ (- (to_rep (last2 temp___90071)) (to_rep (first2 temp___90071))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___9007 temp___90071)))
(assert (= o2 o))
