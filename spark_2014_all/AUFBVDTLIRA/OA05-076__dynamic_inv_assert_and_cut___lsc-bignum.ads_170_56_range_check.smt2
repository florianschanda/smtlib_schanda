...
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___684 o26)))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o29 (mk_map__ref o28))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a (mk_map__ref o28))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o30 o28)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o31 o29)))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o32 o30)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o31 (mk_map__ref o26))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a1 (mk_map__ref o26))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o32 o26)))
