...
(assert (=> (= result7 true) (and (<= (to_rep b__first) k2) (<= k2 (to_rep b__last)))))
(assert (=> (= result7 true) (= o85 k2)))
(assert (=> (= result7 true) (= o86 (select b o85))))
(assert (=> (= result7 true) (= o87 (to_rep1 o86))))
(assert (=> (= result7 true) (and (<= (to_rep b__first) k2) (<= k2 (to_rep b__last)))))
(assert (=> (= result7 true) (= o83 k2)))
(assert (=> (= result7 true) (= o84 (select b10 o83))))
(assert (=> (= result7 true) (= o88 (to_rep1 o84))))
(assert (=> (= result7 true) (= o89 (ite (= o88 o87) true false))))
(assert (=> (not (= result7 true)) (= o89 (of_int 1))))
(assert (and (= o69 (+ b_first a_last)) (in_range1 (+ b_first a_last))))
(assert (= o70 (- o69 a_first)))
(assert (and (= o71 o70) (in_range1 o70)))
(assert (= o72 (ite (<= k2 o71) true false)))
(assert (= result8 (ite (<= b_first k2) o72 false)))
(assert (= result8 true))
(assert (not (in_range1 (+ a_first k2))))
(check-sat)
(exit)
