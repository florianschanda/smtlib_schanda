...
(assert (and (= o35 (+ (to_rep (first (rt buffer))) 12)) (in_range1 (+ (to_rep (first (rt buffer))) 12))))
(assert (= o36 (+ o35 offset2)))
(assert (and (= ethernet_dissector__match__R28b__assume o36) (in_range1 o36)))
(assert (= ethernet_dissector__match__R28b__assume r28b))
(assert (in_range1 r28b))
(assert (and (= o37 (+ (to_rep (first (rt buffer))) 13)) (in_range1 (+ (to_rep (first (rt buffer))) 13))))
(assert (= o38 (+ o37 offset2)))
(assert (and (= ethernet_dissector__match__R29b__assume o38) (in_range1 o38)))
(assert (= ethernet_dissector__match__R29b__assume r29b))
(assert (in_range1 r29b))
(assert (=> (<= r28b r29b) (and (and (<= (to_rep (first (rt buffer))) r28b) (<= r28b (to_rep (last (rt buffer))))) (and (<= (to_rep (first (rt buffer))) r29b) (<= r29b (to_rep (last (rt buffer))))))))
(assert (= o39 (elts buffer)))
(assert (= o39 temp___734))
(assert (= (mk9 r28b r29b) temp___7341))
(assert (= (ite (<= (to_rep (first18 temp___7341)) (to_rep (last18 temp___7341))) (+ (- (to_rep (last18 temp___7341)) (to_rep (first18 temp___7341))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= o40 (slide temp___734 (to_rep (first18 temp___7341)) 1)))
(assert (= result11 (mk_map__ref length13)))
(assert (= length14 o40))
(assert (and (= o45 (length buffer)) (in_range1 (length buffer))))
(assert (= o41 (convert_to_two_octets (mk___t length14 (mk 1 2)))))
(assert (= o42 (bv2nat o41)))
(assert (and (= o43 (+ 15 offset2)) (in_range1 (+ 15 offset2))))
(assert (= o44 (+ o43 o42)))
