...
(assert (= (ite (<= (to_rep (first4 temp___86281)) (to_rep (last4 temp___86281))) (+ (- (to_rep (last4 temp___86281)) (to_rep (first4 temp___86281))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8628 temp___8629))
(assert (= (mk1 (to_rep (first4 temp___86281)) (to_rep (last4 temp___86281))) temp___86291))
(assert (not (= (ite (<= (to_rep (first2 temp___86291)) (to_rep (last2 temp___86291))) (+ (- (to_rep (last2 temp___86291)) (to_rep (first2 temp___86291))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
