...
(declare-const temp___1379 us_rep1)
...
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1383 sum)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1382 carry1)))
(assert (=> (and (<= 1 divisor_index1) (<= divisor_index1 r127b)) (= temp___1379 (mk___rep1 u__split_discrs (mk___split_fields1 (mk___t1 u__split_fields u__split_fields1))))))
