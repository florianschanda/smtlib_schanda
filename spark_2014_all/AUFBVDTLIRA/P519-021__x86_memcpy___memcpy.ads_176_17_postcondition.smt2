...
(assert (= zeroflag1 (ite (= (bvsub rsp1 ((_ int2bv 64) 144)) ((_ int2bv 64) 0)) true false)))
(assert (= result13 (mk_bool__ref signflag)))
(assert (= signflag1 (ite (bvugt (bvsub rsp1 ((_ int2bv 64) 144)) ((_ int2bv 64) 9223372036854775807)) true false)))
(assert (= result14 (mk_t__ref3 rsp1)))
(assert (= rsp2 (bvsub rsp1 ((_ int2bv 64) 144))))
(assert (and (= o19 (edi rdi)) (= o19 (readreg32 rdi))))
(assert (and (and (and (and (= (bvand o19 ((_ int2bv 32) 255)) ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory2) (bvsub rbp1 ((_ int2bv 64) 132)))))) (= (bvand o19 ((_ int2bv 32) 65280)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory2) (bvadd (bvsub rbp1 ((_ int2bv 64) 132)) ((_ int2bv 64) 1))))) ((_ int2bv 32) 256)))) (= (bvand o19 ((_ int2bv 32) 16711680)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory2) (bvadd (bvsub rbp1 ((_ int2bv 64) 132)) ((_ int2bv 64) 2))))) ((_ int2bv 32) 65536)))) (= (bvand o19 ((_ int2bv 32) 4278190080)) (bvmul ((_ zero_extend 24) (to_rep (select (let ((subject memory)) memory2) (bvadd (bvsub rbp1 ((_ int2bv 64) 132)) ((_ int2bv 64) 3))))) ((_ int2bv 32) 16777216)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (and (and (and (not (= i (bvsub rbp1 ((_ int2bv 64) 132)))) (not (= i (bvadd (bvsub rbp1 ((_ int2bv 64) 132)) ((_ int2bv 64) 1))))) (not (= i (bvadd (bvsub rbp1 ((_ int2bv 64) 132)) ((_ int2bv 64) 2))))) (not (= i (bvadd (bvsub rbp1 ((_ int2bv 64) 132)) ((_ int2bv 64) 3))))) (= (to_rep (select (let ((subject memory)) memory2) i)) (to_rep (select (let ((subject memory)) memory1) i))))))))
...
(assert (= rdi1 rdx1))
(assert (and (and (and (and (and (and (and (and (= (bvand rax ((_ int2bv 64) 255)) ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory5) rdi1)))) (= (bvand rax ((_ int2bv 64) 65280)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory5) (bvadd rdi1 ((_ int2bv 64) 1))))) ((_ int2bv 64) 256)))) (= (bvand rax ((_ int2bv 64) 16711680)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory5) (bvadd rdi1 ((_ int2bv 64) 2))))) ((_ int2bv 64) 65536)))) (= (bvand rax ((_ int2bv 64) 4278190080)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory5) (bvadd rdi1 ((_ int2bv 64) 3))))) ((_ int2bv 64) 16777216)))) (= (bvand rax ((_ int2bv 64) 1095216660480)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory5) (bvadd rdi1 ((_ int2bv 64) 4))))) ((_ int2bv 64) 4294967296)))) (= (bvand rax ((_ int2bv 64) 280375465082880)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory5) (bvadd rdi1 ((_ int2bv 64) 5))))) ((_ int2bv 64) 1099511627776)))) (= (bvand rax ((_ int2bv 64) 71776119061217280)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory5) (bvadd rdi1 ((_ int2bv 64) 6))))) ((_ int2bv 64) 281474976710656)))) (= (bvand rax ((_ int2bv 64) 18374686479671623680)) (bvmul ((_ zero_extend 56) (to_rep (select (let ((subject memory)) memory5) (bvadd rdi1 ((_ int2bv 64) 7))))) ((_ int2bv 64) 72057594037927936)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (and (and (and (and (and (and (and (not (= i rdi1)) (not (= i (bvadd rdi1 ((_ int2bv 64) 1))))) (not (= i (bvadd rdi1 ((_ int2bv 64) 2))))) (not (= i (bvadd rdi1 ((_ int2bv 64) 3))))) (not (= i (bvadd rdi1 ((_ int2bv 64) 4))))) (not (= i (bvadd rdi1 ((_ int2bv 64) 5))))) (not (= i (bvadd rdi1 ((_ int2bv 64) 6))))) (not (= i (bvadd rdi1 ((_ int2bv 64) 7))))) (= (to_rep (select (let ((subject memory)) memory5) i)) (to_rep (select (let ((subject memory)) memory4) i))))))))
...
(assert (= zeroflag2 (ite (= (bvadd rdx2 ((_ int2bv 64) 2)) ((_ int2bv 64) 0)) true false)))
(assert (= result19 (mk_bool__ref signflag1)))
(assert (= signflag2 (ite (bvugt (bvadd rdx2 ((_ int2bv 64) 2)) ((_ int2bv 64) 9223372036854775807)) true false)))
