...
(declare-const temp___374 (_ BitVec 32))
(declare-const result1 (_ BitVec 32))
(declare-const temp___3741 (_ BitVec 32))
...
(assert (and (= o11 (esi rsi1)) (= o11 (readreg32 rsi1))))
(assert (= o12 (bvadd o11 ((_ int2bv 32) 1))))
(assert (= (writereg32post rsi2 o12) true))
(assert (and (= o13 (edi rdi1)) (= o13 (readreg32 rdi1))))
(assert (= o14 (bvadd o13 ((_ int2bv 32) 1))))
(assert (= (writereg32post rdi2 o14) true))
...
(assert (not (bvult (ecx rcx2) temp___3741)))
(check-sat)
(exit)
