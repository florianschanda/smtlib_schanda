...
(define-fun dynamic_invariant1 ((temp___expr_4407 Int) (temp___is_init_4404 Bool) (temp___skip_constant_4405 Bool) (temp___do_toplevel_4406 Bool)) Bool (=> (or (= temp___is_init_4404 true) (<= 0 1024)) (in_range3 temp___expr_4407)))
...
(define-fun dynamic_invariant2 ((temp___expr_4413 Int) (temp___is_init_4410 Bool) (temp___skip_constant_4411 Bool) (temp___do_toplevel_4412 Bool)) Bool (=> (or (= temp___is_init_4410 true) (<= 0 5)) (in_range4 temp___expr_4413)))
...
(define-fun us_rep___138__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
...
(assert (forall ((temp___4477 us_rep)) (forall ((temp___4478 (_ BitVec 8))) (= (select (temp___4475 temp___4477) temp___4478) temp___4477))))
(declare-fun temp___4479 ((_ BitVec 8)) (Array Int bits_8))
(assert (forall ((temp___4481 (_ BitVec 8))) (forall ((temp___4482 Int)) (= (select (temp___4479 temp___4481) temp___4482) (of_rep2 temp___4481)))))
(define-fun dynamic_invariant3 ((temp___expr_4469 us_rep1) (temp___is_init_4466 Bool) (temp___skip_constant_4467 Bool) (temp___do_toplevel_4468 Bool)) Bool (forall ((temp___4470 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) temp___4470) (bvule temp___4470 ((_ int2bv 8) 1))) (let ((temp___4471 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_4469)) temp___4470))) (ite (= (to_rep4 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___4471))) 0) (< 0 (to_rep3 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4471)))) (= (to_rep3 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4471))) 0))))))
(define-fun default_initial_assumption ((temp___expr_4473 us_rep1) (temp___skip_top_level_4474 Bool)) Bool (and (and (and (and (= (rec__decadriver__receiver_type__frame_queue (us_split_fields3 temp___expr_4473)) (temp___4475 (mk___rep (mk___split_fields (of_rep3 0) (temp___4479 ((_ int2bv 8) 0)) (of_rep4 0) (of_int 0))))) (= (to_rep5 (rec__decadriver__receiver_type__queue_head (us_split_fields3 temp___expr_4473))) ((_ int2bv 8) 1))) (= (to_rep (rec__decadriver__receiver_type__rx_count (us_split_fields3 temp___expr_4473))) 0)) (= (rec__decadriver__receiver_type__overrun_occurred (us_split_fields3 temp___expr_4473)) (of_int 0))) (= (rec__decadriver__receiver_type__frame_ready (us_split_fields3 temp___expr_4473)) (of_int 0))))
...
(define-fun dynamic_invariant5 ((temp___expr_4419 us_rep) (temp___is_init_4416 Bool) (temp___skip_constant_4417 Bool) (temp___do_toplevel_4418 Bool)) Bool (=> (= temp___do_toplevel_4418 true) (=> (= temp___is_init_4416 true) (ite (= (to_rep4 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___expr_4419))) 0) (< 0 (to_rep3 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4419)))) (= (to_rep3 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4419))) 0)))))
(define-fun dynamic_predicate ((temp___4430 us_rep)) Bool (ite (= (to_rep4 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___4430))) 0) (< 0 (to_rep3 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4430)))) (= (to_rep3 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___4430))) 0)))
(define-fun dynamic_invariant6 ((temp___expr_4437 (_ BitVec 8)) (temp___is_init_4434 Bool) (temp___skip_constant_4435 Bool) (temp___do_toplevel_4436 Bool)) Bool (=> (or (= temp___is_init_4434 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range5 temp___expr_4437)))
...
(declare-const temp___4554 (Array Int bits_8))
(declare-const temp___45541 t1)
...
(declare-const temp___45441 t3)
(declare-const temp___4545 (Array Int bits_8))
(declare-const temp___45451 t)
(declare-const temp___4546 (Array Int bits_8))
(declare-const temp___45461 t)
...
(assert (=> (= error1 0) (=> (= result2 true) (= o2 temp___4550))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk2 1 r9b) temp___45501))))
(assert (=> (= error1 0) (=> (= result2 true) (= (ite (<= (to_rep1 (first4 temp___45501)) (to_rep1 (last4 temp___45501))) (+ (- (to_rep1 (last4 temp___45501)) (to_rep1 (first4 temp___45501))) 1) 0) (ite (<= (to_rep1 frame__first) r6b) (+ (- r6b (to_rep1 frame__first)) 1) 0)))))
(assert (=> (= error1 0) (=> (= result2 true) (= (slide temp___4550 (to_rep1 (first4 temp___45501)) (to_rep1 frame__first)) temp___4551))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk1 (to_rep1 frame__first) r6b) temp___45511))))
...
(assert (=> (= error1 0) (=> (= result2 true) (= o3 temp___4553))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk1 (to_rep1 frame__first) r6b) temp___45531))))
(assert (=> (= error1 0) (=> (= result2 true) (= (ite (<= (to_rep1 (first2 temp___45511)) (to_rep1 (last2 temp___45511))) (+ (- (to_rep1 (last2 temp___45511)) (to_rep1 (first2 temp___45511))) 1) 0) (ite (<= (to_rep1 (first2 temp___45531)) (to_rep1 (last2 temp___45531))) (+ (- (to_rep1 (last2 temp___45531)) (to_rep1 (first2 temp___45531))) 1) 0)))))
(assert (=> (= error1 0) (=> (= result2 true) (= (mk___t1 temp___4554 temp___45541) (mk___t1 temp___4551 temp___45511)))))
(assert (=> (= error1 0) (=> (= result2 true) (forall ((temp___4555 Int)) (ite (and (<= (to_rep1 frame__first) temp___4555) (<= temp___4555 r6b)) (= (select o4 temp___4555) (select temp___4554 temp___4555)) (= (select o4 temp___4555) (select frame temp___4555)))))))
...
(assert (=> (= error1 0) (=> (not (= result2 true)) (and (= temp___4541 o5) (in_range1 o5)))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (=> (<= 1 temp___4541) (and (and (<= 0 1) (<= 1 1024)) (and (<= 0 temp___4541) (<= temp___4541 1024)))))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= o6 (rec__decadriver__rx_frame_type__frame (us_split_fields1 (select self__ (to_rep5 self__1))))))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= o6 temp___4544))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (mk3 1 temp___4541) temp___45441))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= temp___4544 temp___4545))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (mk (to_rep1 (first6 temp___45441)) (to_rep1 (last6 temp___45441))) temp___45451))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (ite (<= (to_rep1 (first temp___45451)) (to_rep1 (last temp___45451))) (+ (- (to_rep1 (last temp___45451)) (to_rep1 (first temp___45451))) 1) 0) (ite (<= (to_rep1 frame__first) (to_rep1 frame__last)) (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1) 0)))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= (mk___t temp___4546 temp___45461) (mk___t temp___4545 temp___45451)))))
(assert (=> (= error1 0) (=> (not (= result2 true)) (= o7 (slide temp___4546 (to_rep1 (first temp___45461)) (to_rep1 frame__first))))))
...
(assert (= (to_rep5 o8) (bvurem (bvadd (to_rep5 self__1) ((_ int2bv 8) 1)) ((_ int2bv 8) 2))))
(assert (= self__ o9))
(assert (= o8 o10))
(assert (= self__2 o11))
(assert (= self__3 o12))
