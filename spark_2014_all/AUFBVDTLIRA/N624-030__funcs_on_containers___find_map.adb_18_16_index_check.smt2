...
(assert (= o4 (to_rep o3)))
(assert (and (= temp___707 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o4)) (and (in_range5 temp___707) (= temp___707 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o4)))))
(assert (not (<= (to_rep1 (first (rt a))) temp___707)))
(check-sat)
(exit)
