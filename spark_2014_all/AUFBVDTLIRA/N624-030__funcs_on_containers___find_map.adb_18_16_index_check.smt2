...
(assert (and (= result5 (has_key (model__ (mk___rep result____split_discrs result____split_fields4)) o20)) (= (= result5 true) (= (has_key (model__ (mk___rep result____split_discrs result____split_fields4)) o20) true))))
...
(assert (=> (= result5 true) (and (= o15 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o14)) (and (in_range5 o15) (= o15 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o14))))))
...
(assert (=> (= result5 true) (and (= o11 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o10)) (and (in_range5 o11) (= o11 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o10))))))
(assert (=> (= result5 true) (= o17 (ite (<= (to_rep1 (first (rt a))) o11) true false))))
...
(assert (= o4 (to_rep o3)))
(assert (and (= temp___755 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o4)) (and (in_range5 temp___755) (= temp___755 (get (model__ (mk___rep result____split_discrs result____split_fields4)) o4)))))
(assert (not (<= (to_rep1 (first (rt a))) temp___755)))
(check-sat)
(exit)
