...
(assert (and (and (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select a k)) ((_ int2bv 32) 0)))) (and (and (= (mk_t__ref result5) (mk_t__ref a_msw)) (= a_msw1 ((_ int2bv 32) 0))) (and (and (and (= (mk_int__ref result6) (mk_int__ref i)) (= i1 a_first)) (ite (and (<= a_first i1) (<= i1 a_last)) (and (and (and (= temp___612 a) (and (= temp___610 u) (and (= temp___609 bi) (and (= temp___608 a_msw1) (and (= temp___607 i1) (and (= temp___606 carry2) (and (= temp___605 carry1) (and (and (= (oeq (omod (oadd (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 ((_ int2bv 32) 2)) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 ((_ int2bv 32) 1)))) true)) (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (and (<= a_first i2) (<= i2 a_last))) (and (and (= (oeq (omod (oadd (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw3))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- (+ i2 1) a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- (+ i2 1) a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t a4 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw3))) (osubtract (omultiply (from_word32 ((_ int2bv 32) 2)) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 ((_ int2bv 32) 1)))) true)) (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (= i2 a_last)))))))))))) (and (and (= i6 (mk_int__ref i2)) (and (= u6 (mk_t__ref u3)) (and (= bi6 (mk_t__ref bi3)) (and (= a_msw6 (mk_t__ref a_msw3)) (and (= carry28 (mk_t__ref carry25)) (and (= carry18 (mk_t__ref carry15)) (= a7 (mk_map__ref a4)))))))) (and (= i7 i2) (and (= u7 u3) (and (= bi7 bi3) (and (= a_msw7 a_msw3) (and (= carry29 carry25) (and (= carry19 carry15) (= a8 a4))))))))) (and (and (= i8 i6) (and (= u8 u6) (and (= bi8 bi6) (and (= a_msw8 a_msw6) (and (= carry210 carry28) (and (= carry110 carry18) (= a9 a7))))))) (and (= i9 i7) (and (= u9 u7) (and (= bi9 bi7) (and (= a_msw9 a_msw7) (and (= carry211 carry29) (and (= carry111 carry19) (= a10 a8))))))))) (and (and (= i8 (mk_int__ref i1)) (and (= u8 (mk_t__ref u)) (and (= bi8 (mk_t__ref bi)) (and (= a_msw8 (mk_t__ref a_msw1)) (and (= carry210 (mk_t__ref carry2)) (and (= carry110 (mk_t__ref carry1)) (= a9 (mk_map__ref a)))))))) (and (= i9 i1) (and (= u9 u1) (and (= bi9 bi1) (and (= a_msw9 a_msw1) (and (= carry211 carry21) (and (= carry111 carry11) (= a10 a)))))))))) (and (ite (not (= (t__content a_msw8) ((_ int2bv 32) 0))) (= result15 true) (and (and (= o216 (less (mk___t (map__content a9) (mk (to_rep a__first) (to_rep a__last))) a_first a_last m m_first)) (= (= o216 true) (= (olt (num_of_big_int (mk___t (map__content a9) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (num_of_big_int m m_first (+ (- a_last a_first) 1))) true))) (= result15 (ite (not (= o216 true)) true false)))) (ite (= result15 true) (and (= (oeq (osubtract (num_of_big_int (mk___t (map__content a9) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (osubtract (num_of_big_int (mk___t a11 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (num_of_boolean carry4)))) true) (and (and (= carry5 (mk_bool__ref carry4)) (= a12 (mk_map__ref a11))) (and (= carry6 carry4) (= a13 a11)))) (and (and (= carry5 (mk_bool__ref carry)) (= a12 a9)) (and (= carry6 carry3) (= a13 a10)))))))) (and (and (= i10 i8) (and (= u10 u8) (and (= bi10 bi8) (and (= a_msw10 a_msw8) (and (= carry212 carry210) (and (= carry112 carry110) (and (= carry7 carry5) (= a14 a12)))))))) (and (= i11 i9) (and (= u11 u9) (and (= bi11 bi9) (and (= a_msw11 a_msw9) (and (= carry213 carry211) (and (= carry113 carry111) (and (= carry8 carry6) (= a15 a13)))))))))))
...
(assert (and (= o237 (base Tuple0)) (= o237 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (and (= o232 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o233 (+ o232 1)))
(assert (and (= o234 o233) (in_range1 o233)))
(assert (not (in_range2 o234)))
(check-sat)
(exit)
