...
(declare-const i Int)
(declare-const temp___684 (Array Int word32))
(declare-const temp___682 (_ BitVec 32))
(declare-const temp___681 (_ BitVec 32))
(declare-const temp___680 (_ BitVec 32))
(declare-const temp___679 Int)
(declare-const temp___678 (_ BitVec 32))
(declare-const temp___677 (_ BitVec 32))
...
(declare-const a map__ref)
(declare-const carry13 t__ref)
(declare-const carry23 t__ref)
(declare-const a_msw4 t__ref)
(declare-const bi3 t__ref)
(declare-const u3 t__ref)
(declare-const i3 int__ref)
(declare-const o17 map__ref)
...
(declare-const bi4 (_ BitVec 32))
(declare-const u4 (_ BitVec 32))
(declare-const i4 Int)
(declare-const a1 map__ref)
(declare-const carry15 t__ref)
(declare-const carry25 t__ref)
(declare-const a_msw6 t__ref)
(declare-const bi5 t__ref)
(declare-const u5 t__ref)
(declare-const i5 int__ref)
(declare-const o19 map__ref)
...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select o14 k)) #x00000000))))
(assert (= (mk_t__ref result) (mk_t__ref a_msw)))
(assert (= a_msw1 #x00000000))
(assert (= (mk_int__ref result1) (mk_int__ref i)))
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___684 o14)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___682 u)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___681 bi)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___680 a_msw1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___679 i1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___678 carry2)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___677 carry1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (omod (oadd (num_of_big_int (mk___t o15 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o15 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (and (<= a_first i2) (<= i2 a_last)))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (omod (oadd (num_of_big_int (mk___t o16 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw3))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- (+ i2 1) a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- (+ i2 1) a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t o16 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw3))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= i2 a_last)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o17 (mk_map__ref o16))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= i3 (mk_int__ref i2))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= u3 (mk_t__ref u2))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= bi3 (mk_t__ref bi2))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a_msw4 (mk_t__ref a_msw3))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry23 (mk_t__ref carry22))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry13 (mk_t__ref carry12))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a (mk_map__ref o16))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= i4 i2)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= u4 u2)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= bi4 bi2)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a_msw5 a_msw3)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry24 carry22)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry14 carry12)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o18 o16)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o19 o17)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= i5 i3)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= u5 u3)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= bi5 bi3)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a_msw6 a_msw4)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry25 carry23)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry15 carry13)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a1 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= i6 i4)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= u6 u4)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= bi6 bi4)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a_msw7 a_msw5)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry26 carry24)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= carry16 carry14)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= o20 o18)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o19 (mk_map__ref o14))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= i5 (mk_int__ref i1))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= u5 (mk_t__ref u))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= bi5 (mk_t__ref bi))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a_msw6 (mk_t__ref a_msw1))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= carry25 (mk_t__ref carry2))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= carry15 (mk_t__ref carry1))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a1 (mk_map__ref o14))))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= i6 i1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= u6 u1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= bi6 bi1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a_msw7 a_msw1)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= carry26 carry21)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= carry16 carry11)))
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= o20 o14)))
(assert (=> (not (= (t__content a_msw6) #x00000000)) (= result2 true)))
(assert (=> (not (not (= (t__content a_msw6) #x00000000))) (and (= o (less (mk___t (map__content a1) (mk (to_rep a__first) (to_rep a__last))) a_first a_last m m_first)) (= (= o true) (= (olt (num_of_big_int (mk___t (map__content a1) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (num_of_big_int m m_first (+ (- a_last a_first) 1))) true)))))
(assert (=> (not (not (= (t__content a_msw6) #x00000000))) (= result2 (ite (not (= o true)) true false))))
(assert (=> (= result2 true) (= (oeq (osubtract (num_of_big_int (mk___t (map__content a1) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (osubtract (num_of_big_int (mk___t (let ((subject a1)) o21) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (num_of_boolean carry4)))) true)))
(assert (=> (= result2 true) (= o22 (mk_map__ref o21))))
(assert (=> (= result2 true) (= carry5 (mk_bool__ref carry4))))
(assert (=> (= result2 true) (= a2 (mk_map__ref o21))))
(assert (=> (= result2 true) (= carry6 carry4)))
(assert (=> (= result2 true) (= o23 o21)))
(assert (=> (not (= result2 true)) (= o22 o19)))
(assert (=> (not (= result2 true)) (= carry5 (mk_bool__ref carry))))
(assert (=> (not (= result2 true)) (= a2 a1)))
(assert (=> (not (= result2 true)) (= carry6 carry3)))
(assert (=> (not (= result2 true)) (= o23 o20)))
(assert (= i7 i5))
(assert (= u7 u5))
(assert (= bi7 bi5))
(assert (= a_msw8 a_msw6))
(assert (= carry27 carry25))
(assert (= carry17 carry15))
(assert (= carry7 carry5))
(assert (= a3 a2))
(assert (= i8 i6))
(assert (= u8 u6))
(assert (= bi8 bi6))
(assert (= a_msw9 a_msw7))
(assert (= carry28 carry26))
(assert (= carry18 carry16))
(assert (= carry8 carry6))
(assert (= a4 o23))
(assert (and (= o9 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o10 (+ o9 1)))
(assert (and (= o11 o10) (in_range1 o10)))
(assert (and (= o12 o11) (in_range2 o11)))
(assert (= o13 (num_of_big_int m m_first o12)))
(assert (and (= o5 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o6 (+ o5 1)))
(assert (and (= o7 o6) (in_range1 o6)))
(assert (and (= o8 o7) (in_range2 o7)))
(assert (and (= o4 (base Tuple0)) (= o4 (oexpon (from_word32 #x00000002) 32))))
(assert (and (= o1 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o2 (+ o1 1)))
