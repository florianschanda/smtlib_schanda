...
(assert (forall ((b1 Bool)) (! (let ((result (word_of_boolean b1))) (and (= (oeq (from_word32 result) (num_of_boolean b1)) true) (dynamic_invariant1 result true false true true))) :pattern ((word_of_boolean b1)))))
...
(declare-const i Int)
(declare-const temp___682 (Array Int word32))
(declare-const temp___680 (_ BitVec 32))
(declare-const temp___679 (_ BitVec 32))
(declare-const temp___678 (_ BitVec 32))
(declare-const temp___677 Int)
(declare-const temp___676 (_ BitVec 32))
(declare-const temp___675 (_ BitVec 32))
...
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k a_last)) (= (to_rep1 (select a k)) #x00000000))))
(assert (= (mk_t__ref result) (mk_t__ref a_msw)))
(assert (= a_msw1 #x00000000))
(assert (= (mk_int__ref result1) (mk_int__ref i)))
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___682 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___680 u)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___679 bi)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___678 a_msw1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___677 i1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___676 carry2)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___675 carry1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (omod (oadd (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- i2 a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- i2 a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw2))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (and (<= a_first i2) (<= i2 a_last)))))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (and (= (oeq (omod (oadd (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw3))) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (omod (omultiply (omultiply (num_of_big_int b b_first (- (+ i2 1) a_first)) (num_of_big_int c c_first (+ (- a_last a_first) 1))) (oexpon (inverse (num_of_big_int m m_first (+ (- a_last a_first) 1)) (base Tuple0)) (- (+ i2 1) a_first))) (num_of_big_int m m_first (+ (- a_last a_first) 1)))) true) (= (olt (oadd (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (from_word32 a_msw3))) (osubtract (omultiply (from_word32 #x00000002) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (from_word32 #x00000001))) true))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a3 (mk_map__ref a2))))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a4 a2)))
...
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= a6 a4)))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a5 (mk_map__ref a))))
...
(assert (=> (not (and (<= a_first i1) (<= i1 a_last))) (= a6 a)))
(assert (=> (not (= (t__content a_msw6) #x00000000)) (= result2 true)))
(assert (=> (not (not (= (t__content a_msw6) #x00000000))) (and (= o (less (mk___t (map__content a5) (mk (to_rep a__first) (to_rep a__last))) a_first a_last m m_first)) (= (= o true) (= (olt (num_of_big_int (mk___t (map__content a5) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (num_of_big_int m m_first (+ (- a_last a_first) 1))) true)))))
(assert (=> (not (not (= (t__content a_msw6) #x00000000))) (= result2 (ite (not (= o true)) true false))))
(assert (=> (= result2 true) (= (oeq (osubtract (num_of_big_int (mk___t (map__content a5) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (num_of_big_int m m_first (+ (- a_last a_first) 1))) (osubtract (num_of_big_int (mk___t a7 (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (omultiply (oexpon (base Tuple0) (+ (- a_last a_first) 1)) (num_of_boolean carry4)))) true)))
(assert (=> (= result2 true) (= carry5 (mk_bool__ref carry4))))
(assert (=> (= result2 true) (= a8 (mk_map__ref a7))))
(assert (=> (= result2 true) (= carry6 carry4)))
(assert (=> (= result2 true) (= a9 a7)))
(assert (=> (not (= result2 true)) (= carry5 (mk_bool__ref carry))))
(assert (=> (not (= result2 true)) (= a8 a5)))
(assert (=> (not (= result2 true)) (= carry6 carry3)))
(assert (=> (not (= result2 true)) (= a9 a6)))
(assert (= i7 i5))
(assert (= u7 u5))
(assert (= bi7 bi5))
