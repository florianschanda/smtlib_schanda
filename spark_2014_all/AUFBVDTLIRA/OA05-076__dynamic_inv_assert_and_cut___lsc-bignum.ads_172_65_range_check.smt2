...
(assert (= i1 a_first))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___612 a)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___610 u)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___609 bi)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___608 a_msw1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___607 i1)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___606 carry2)))
(assert (=> (and (<= a_first i1) (<= i1 a_last)) (= temp___605 carry1)))
...
(assert (=> (not (= (t__content a_msw6) ((_ int2bv 32) 0))) (= result2 true)))
(assert (=> (not (not (= (t__content a_msw6) ((_ int2bv 32) 0)))) (and (= o (less (mk___t (map__content a5) (mk (to_rep a__first) (to_rep a__last))) a_first a_last m m_first)) (= (= o true) (= (olt (num_of_big_int (mk___t (map__content a5) (mk (to_rep a__first) (to_rep a__last))) a_first (+ (- a_last a_first) 1)) (num_of_big_int m m_first (+ (- a_last a_first) 1))) true)))))
(assert (=> (not (not (= (t__content a_msw6) ((_ int2bv 32) 0)))) (= result2 (ite (not (= o true)) true false))))
...
(assert (and (= o4 (base Tuple0)) (= o4 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
