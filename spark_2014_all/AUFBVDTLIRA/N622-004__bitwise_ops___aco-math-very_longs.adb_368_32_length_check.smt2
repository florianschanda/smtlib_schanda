...
(assert (not (= (ite (<= (to_rep2 (first4 temp___14611)) (to_rep2 (last4 temp___14611))) (+ (- (to_rep2 (last4 temp___14611)) (to_rep2 (first4 temp___14611))) 1) 0) (ite (<= 1 r122b) (+ (- r122b 1) 1) 0))))
(check-sat)
(exit)
