...
(define-fun in_range5 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x01)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x02))) (=> (in_range5 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
...
(declare-fun temp___4954 (us_rep1) (Array (_ BitVec 8) us_rep1))
(declare-fun temp___4958 ((_ BitVec 8)) (Array Int bits_8))
(define-fun dynamic_invariant ((temp___expr_4948 us_rep2) (temp___is_init_4944 Bool) (temp___skip_constant_4945 Bool) (temp___do_toplevel_4946 Bool) (temp___do_typ_inv_4947 Bool)) Bool (forall ((temp___4949 (_ BitVec 8))) (=> (and (bvule #x00 temp___4949) (bvule temp___4949 #x01)) (let ((temp___4950 (select (rec__decadriver__receiver_type__frame_queue (us_split_fields5 temp___expr_4948)) temp___4949))) (ite (= (to_rep3 (rec__decadriver__rx_frame_type__error (us_split_fields3 temp___4950))) 0) (< 0 (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4950)))) (= (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4950))) 0))))))
(define-fun default_initial_assumption ((temp___expr_4952 us_rep2) (temp___skip_top_level_4953 Bool)) Bool (and (and (and (and (= (rec__decadriver__receiver_type__frame_queue (us_split_fields5 temp___expr_4952)) (temp___4954 (mk___rep1 (mk___split_fields1 (of_rep2 0) (temp___4958 #x00) (of_rep3 0) (distinct 0 0))))) (= (to_rep6 (rec__decadriver__receiver_type__queue_head (us_split_fields5 temp___expr_4952))) #x01)) (= (to_rep5 (rec__decadriver__receiver_type__rx_count (us_split_fields5 temp___expr_4952))) 0)) (= (rec__decadriver__receiver_type__overrun_occurred (us_split_fields5 temp___expr_4952)) (distinct 0 0))) (= (rec__decadriver__receiver_type__frame_ready (us_split_fields5 temp___expr_4952)) (distinct 0 0))))
...
(define-fun default_initial_assumption1 ((temp___expr_4970 us_rep3) (temp___skip_top_level_4971 Bool)) Bool (= (rec__decadriver__transmitter_type__tx_idle (us_split_fields7 temp___expr_4970)) (distinct 1 0)))
...
(define-fun default_initial_assumption2 ((temp___expr_4979 us_rep5) (temp___skip_top_level_4980 Bool)) Bool (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep9 (rec__decadriver__driver_type__part_id (us_split_fields11 temp___expr_4979))) #x00000000) (= (to_rep9 (rec__decadriver__driver_type__lot_id (us_split_fields11 temp___expr_4979))) #x00000000)) (= (to_rep10 (rec__decadriver__driver_type__antenna_delay_prf_64 (us_split_fields11 temp___expr_4979))) #x0000)) (= (to_rep10 (rec__decadriver__driver_type__antenna_delay_prf_16 (us_split_fields11 temp___expr_4979))) #x0000)) (= (to_rep1 (rec__decadriver__driver_type__xtal_trim (us_split_fields11 temp___expr_4979))) #x10)) (= (rec__decadriver__driver_type__otp_tx_power_levels (us_split_fields11 temp___expr_4979)) (temp___4981 #x00000000))) (= (rec__decadriver__driver_type__long_frames (us_split_fields11 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__sys_cfg_reg (us_split_fields11 temp___expr_4979)) (mk___rep4 (mk___split_fields4 (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep7 #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep #x00) (of_rep8 #x00) (of_rep1 #x00))))) (= (rec__decadriver__driver_type__use_otp_xtal_trim (us_split_fields11 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__use_otp_antenna_delay (us_split_fields11 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_sfd_timeout (us_split_fields11 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_phr_error (us_split_fields11 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_rs_error (us_split_fields11 temp___expr_4979)) (distinct 0 0))) (= (rec__decadriver__driver_type__detect_fcs_error (us_split_fields11 temp___expr_4979)) (distinct 0 0))))
...
(define-fun dynamic_invariant2 ((temp___expr_4880 Int) (temp___is_init_4876 Bool) (temp___skip_constant_4877 Bool) (temp___do_toplevel_4878 Bool) (temp___do_typ_inv_4879 Bool)) Bool (=> (or (= temp___is_init_4876 true) (<= 0 1024)) (in_range6 temp___expr_4880)))
(define-fun dynamic_invariant3 ((temp___expr_4887 Int) (temp___is_init_4883 Bool) (temp___skip_constant_4884 Bool) (temp___do_toplevel_4885 Bool) (temp___do_typ_inv_4886 Bool)) Bool (=> (or (= temp___is_init_4883 true) (<= 0 5)) (in_range7 temp___expr_4887)))
(define-fun dynamic_invariant4 ((temp___expr_4894 us_rep1) (temp___is_init_4890 Bool) (temp___skip_constant_4891 Bool) (temp___do_toplevel_4892 Bool) (temp___do_typ_inv_4893 Bool)) Bool (=> (= temp___do_toplevel_4892 true) (=> (= temp___is_init_4890 true) (ite (= (to_rep3 (rec__decadriver__rx_frame_type__error (us_split_fields3 temp___expr_4894))) 0) (< 0 (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___expr_4894)))) (= (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___expr_4894))) 0)))))
(define-fun dynamic_predicate ((temp___4905 us_rep1)) Bool (ite (= (to_rep3 (rec__decadriver__rx_frame_type__error (us_split_fields3 temp___4905))) 0) (< 0 (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4905)))) (= (to_rep2 (rec__decadriver__rx_frame_type__size (us_split_fields3 temp___4905))) 0)))
(define-fun dynamic_invariant5 ((temp___expr_4913 (_ BitVec 8)) (temp___is_init_4909 Bool) (temp___skip_constant_4910 Bool) (temp___do_toplevel_4911 Bool) (temp___do_typ_inv_4912 Bool)) Bool (=> (or (= temp___is_init_4909 true) (bvule #x00 #x01)) (in_range5 temp___expr_4913)))
(assert (forall ((temp___4956 us_rep1)) (=> (dynamic_invariant4 temp___4956 true true true true) (forall ((temp___4957 (_ BitVec 8))) (= (select (temp___4954 temp___4956) temp___4957) temp___4956)))))
...
(assert (forall ((temp___4983 (_ BitVec 32))) (=> (dynamic_invariant6 temp___4983 true true true true) (forall ((temp___4984 Int)) (= (to_rep9 (select (temp___4981 temp___4983) temp___4984)) temp___4983)))))
(define-fun dynamic_invariant7 ((temp___expr_802 Int) (temp___is_init_798 Bool) (temp___skip_constant_799 Bool) (temp___do_toplevel_800 Bool) (temp___do_typ_inv_801 Bool)) Bool (=> (or (= temp___is_init_798 true) (<= 0 97)) (in_range2 temp___expr_802)))
(define-fun dynamic_invariant8 ((temp___expr_809 Int) (temp___is_init_805 Bool) (temp___skip_constant_806 Bool) (temp___do_toplevel_807 Bool) (temp___do_typ_inv_808 Bool)) Bool (=> (or (= temp___is_init_805 true) (<= 98 98)) (in_range3 temp___expr_809)))
...
(assert (forall ((temp___4960 (_ BitVec 8))) (=> (dynamic_invariant13 temp___4960 true true true true) (forall ((temp___4961 Int)) (= (to_rep4 (select (temp___4958 temp___4960) temp___4961)) temp___4960)))))
