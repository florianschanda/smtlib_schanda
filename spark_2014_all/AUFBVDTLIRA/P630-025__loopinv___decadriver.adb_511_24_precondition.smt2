...
(assert (= (to_rep (rec__dw1000__register_types__sys_status_type__rxrfto (let ((subject sys_status_reg__split_fields)) sys_status_reg__split_fields1))) ((_ int2bv 8) 1)))
(assert (= (rec__decadriver__driver_type__detect_frame_timeout (us_split_fields11 (driver_type__content self__))) true))
(assert (dynamic_invariant (mk___rep2 receiver__split_fields6) true true true))
(assert (= receiver__split_fields6 (mk___split_fields2 o37 o38 o39 o40 o41)))
(assert (= us_self__compl o37))
(assert (= us_self__compl1 o38))
(assert (= us_self__compl2 o39))
(assert (= us_self__compl3 o40))
(assert (= us_self__compl4 o41))
(assert (not (not (= 1 0))))
(check-sat)
(exit)
