...
(assert (= result8 (mk___split_fields__ref1 output_packet__split_fields20)))
(assert (= output_packet__split_fields21 (mk___split_fields1 (rec__dns_types__dns_packet__header output_packet__split_fields20) process_dns_request__set_unsigned_32__bytes)))
(assert (and (= o49 (+ current_byte1 11)) (in_range4 (+ current_byte1 11))))
(assert (= result9 (mk___split_fields__ref1 output_packet__split_fields21)))
(assert (= output_packet__split_fields22 (mk___split_fields1 (rec__dns_types__dns_packet__header output_packet__split_fields21) process_dns_request__set_unsigned_16__bytes1)))
(assert (not (in_range4 (+ current_byte1 12))))
(check-sat)
(exit)
