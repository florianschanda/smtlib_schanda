...
(assert (= o3 (bvmul o2 ((_ int2bv 64) 4294967296))))
(assert (and (= o (readmem32 addr memory)) (and (= o (bvadd ((_ zero_extend 16) (readmem16 addr memory)) (bvmul ((_ zero_extend 16) (readmem16 (bvadd addr ((_ int2bv 64) 2)) memory)) ((_ int2bv 32) 65536)))) (bvuge o ((_ int2bv 32) 0)))))
...
(assert (not (= x86__readmem64__result4 (bvadd ((_ zero_extend 32) (readmem32 addr memory)) (bvmul ((_ zero_extend 32) (readmem32 (bvadd addr ((_ int2bv 64) 4)) memory)) ((_ int2bv 64) 4294967296))))))
(check-sat)
(exit)
