...
(define-fun target__ref___7__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__rx_fwto_type__rxfwto (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_fwto_type__rxfwto (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_2631 us_t1) (temp___is_init_2627 Bool) (temp___skip_constant_2628 Bool) (temp___do_toplevel_2629 Bool) (temp___do_typ_inv_2630 Bool)) Bool (=> (not (= temp___skip_constant_2628 true)) (and (dynamic_property2 1 2 (first3 temp___expr_2631) (last3 temp___expr_2631)) (and (= (first3 temp___expr_2631) 1) (= (last3 temp___expr_2631) 2)))))
...
(define-fun register_byte_array__ref___15__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_2613 us_t2) (temp___is_init_2609 Bool) (temp___skip_constant_2610 Bool) (temp___do_toplevel_2611 Bool) (temp___do_typ_inv_2612 Bool)) Bool (=> (not (= temp___skip_constant_2610 true)) (and (dynamic_property3 1 2 (first5 temp___expr_2613) (last5 temp___expr_2613)) (and (= (first5 temp___expr_2613) 1) (= (last5 temp___expr_2613) 2)))))
...
(declare-const temp___85081 t1)
(define-fun temp___85082 () us_t1 (mk___t1 temp___8508 temp___85081))
...
(assert (and (= temp___85082 (register_to_bytes reg)) (dynamic_invariant temp___85082 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___85081)) (to_rep (last2 temp___85081))) (+ (- (to_rep (last2 temp___85081)) (to_rep (first2 temp___85081))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
