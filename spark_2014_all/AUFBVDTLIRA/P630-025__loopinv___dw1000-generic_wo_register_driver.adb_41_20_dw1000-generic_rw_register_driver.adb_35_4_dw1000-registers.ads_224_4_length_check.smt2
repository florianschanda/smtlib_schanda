...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__rx_fwto_type__rxfwto bits_16)))))
(define-fun us_split_fields_RXFWTO__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__rx_fwto_type__rxfwto a))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__rx_fwto_type__rxfwto (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rx_fwto_type__rxfwto (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__rx_fwto_type__rxfwto__first__bit Int)
(declare-const dw1000__register_types__rx_fwto_type__rxfwto__last__bit Int)
(declare-const dw1000__register_types__rx_fwto_type__rxfwto__position Int)
(assert (<= 0 dw1000__register_types__rx_fwto_type__rxfwto__first__bit))
(assert (< dw1000__register_types__rx_fwto_type__rxfwto__first__bit dw1000__register_types__rx_fwto_type__rxfwto__last__bit))
(assert (<= 0 dw1000__register_types__rx_fwto_type__rxfwto__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((rx_fwto_type__ref (mk_rx_fwto_type__ref (rx_fwto_type__content us_rep)))))
(define-fun rx_fwto_type__ref___projection ((a rx_fwto_type__ref)) us_rep (rx_fwto_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___21__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___15__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___15__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_2613 us_t1) (temp___is_init_2609 Bool) (temp___skip_constant_2610 Bool) (temp___do_toplevel_2611 Bool) (temp___do_typ_inv_2612 Bool)) Bool (=> (not (= temp___skip_constant_2610 true)) (and (dynamic_property2 1 2 (first3 temp___expr_2613) (last3 temp___expr_2613)) (and (= (first3 temp___expr_2613) 1) (= (last3 temp___expr_2613) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___7__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___7__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_2631 us_t2) (temp___is_init_2627 Bool) (temp___skip_constant_2628 Bool) (temp___do_toplevel_2629 Bool) (temp___do_typ_inv_2630 Bool)) Bool (=> (not (= temp___skip_constant_2628 true)) (and (dynamic_property3 1 2 (first5 temp___expr_2631) (last5 temp___expr_2631)) (and (= (first5 temp___expr_2631) 1) (= (last5 temp___expr_2631) 2)))))
...
(declare-const temp___8508 (Array Int bits_8))
(declare-const temp___85081 t2)
(define-fun temp___85082 () us_t2 (mk___t2 temp___8508 temp___85081))
...
(assert (and (= temp___85082 (register_to_bytes reg)) (dynamic_invariant1 temp___85082 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___85081)) (to_rep (last4 temp___85081))) (+ (- (to_rep (last4 temp___85081)) (to_rep (first4 temp___85081))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
