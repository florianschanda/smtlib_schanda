...
(define-fun dynamic_invariant ((temp___expr_2348 us_t1) (temp___is_init_2345 Bool) (temp___skip_constant_2346 Bool) (temp___do_toplevel_2347 Bool)) Bool (=> (not (= temp___skip_constant_2346 true)) (and (dynamic_property2 1 2 (first3 temp___expr_2348) (last3 temp___expr_2348)) (and (= (first3 temp___expr_2348) 1) (= (last3 temp___expr_2348) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_2364 us_t2) (temp___is_init_2361 Bool) (temp___skip_constant_2362 Bool) (temp___do_toplevel_2363 Bool)) Bool (=> (not (= temp___skip_constant_2362 true)) (and (dynamic_property3 1 2 (first5 temp___expr_2364) (last5 temp___expr_2364)) (and (= (first5 temp___expr_2364) 1) (= (last5 temp___expr_2364) 2)))))
...
(declare-const temp___7736 (Array Int bits_8))
(declare-const temp___77361 t2)
(declare-const temp___7737 (Array Int bits_8))
(declare-const temp___77371 t1)
...
(assert (and (= (mk___t2 temp___7736 temp___77361) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7736 temp___77361) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___77361)) (to_rep (last4 temp___77361))) (+ (- (to_rep (last4 temp___77361)) (to_rep (first4 temp___77361))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
