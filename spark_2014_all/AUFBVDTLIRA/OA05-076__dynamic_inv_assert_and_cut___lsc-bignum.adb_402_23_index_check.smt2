...
(assert (=> (< temp___754 4294967296) (= o11 (bvshl ((_ int2bv 32) 1) ((_ int2bv 32) temp___754)))))
...
(assert (and (= temp___753 o10) (in_range1 o10)))
(assert (not (<= (to_rep1 (first (rt a))) temp___753)))
(check-sat)
(exit)
