...
(assert (bvugt (bvadd msg_byte_count1 (to_rep1 ctx__split_fields9)) ((_ int2bv 64) 64)))
(assert (bvugt (to_rep1 ctx__split_fields9) ((_ int2bv 64) 0)))
(assert (and (= o (bvsub ((_ int2bv 64) 64) (to_rep1 ctx__split_fields9))) (in_range3 (bvsub ((_ int2bv 64) 64) (to_rep1 ctx__split_fields9)))))
(assert (= result2 (mk_t__ref1 n)))
(assert (= n2 o))
(assert (= current_msg_offset1 c237b))
(assert true)
(assert (= n2 c238b))
(assert true)
(assert true)
(assert (=> (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 63)) (in_range3 dst)))
(assert (=> (bvule ((_ int2bv 64) 0) ((_ int2bv 64) 63)) (in_range3 final_dst)))
(assert true)
(assert (bvugt c238b ((_ int2bv 64) 0)))
(assert (= result3 (mk_t__ref1 src)))
(assert (= src4 c237b))
(assert (and (= o1 (to_rep1 ctx__split_fields9)) (in_range3 (to_rep1 ctx__split_fields9))))
(assert (= result4 (mk_t__ref1 dst)))
(assert (= dst4 o1))
(assert (and (= o2 (bvadd dst4 (bvsub c238b ((_ int2bv 64) 1)))) (in_range3 (bvadd dst4 (bvsub c238b ((_ int2bv 64) 1))))))
(assert (= result5 (mk_t__ref1 final_dst)))
(assert (= final_dst4 o2))
(assert (= result6 (mk_t__ref1 final_src)))
(assert (= final_src4 (bvadd src4 (bvsub c238b ((_ int2bv 64) 1)))))
(assert (not (bvule (to_rep2 (first (rt msg))) src4)))
(check-sat)
(exit)
