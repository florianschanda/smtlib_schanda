...
(assert (bvugt (bvadd msg_byte_count1 (to_rep1 ctx__split_fields9)) #x0000000000000040))
(assert (bvugt (to_rep1 ctx__split_fields9) #x0000000000000000))
(assert (and (= o (bvsub #x0000000000000040 (to_rep1 ctx__split_fields9))) (in_range3 (bvsub #x0000000000000040 (to_rep1 ctx__split_fields9)))))
(assert (= result2 (mk_t__ref1 n)))
(assert (= n1 o))
(assert (= current_msg_offset1 c237b))
(assert (= n1 c238b))
(assert (=> (bvule #x0000000000000000 #x000000000000003F) (in_range3 dst)))
(assert (=> (bvule #x0000000000000000 #x000000000000003F) (in_range3 final_dst)))
...
(assert (= dst1 o1))
(assert (and (= o2 (bvadd dst1 (bvsub c238b #x0000000000000001))) (in_range3 (bvadd dst1 (bvsub c238b #x0000000000000001)))))
(assert (= result5 (mk_t__ref1 final_dst)))
(assert (= final_dst1 o2))
(assert (= result6 (mk_t__ref1 final_src)))
(assert (= final_src1 (bvadd src1 (bvsub c238b #x0000000000000001))))
