...
(assert (= dst1 o1))
(assert (and (= o2 (bvadd dst1 (bvsub c238b ((_ int2bv 64) 1)))) (in_range3 (bvadd dst1 (bvsub c238b ((_ int2bv 64) 1))))))
(assert (= result5 (mk_t__ref1 final_dst)))
(assert (= final_dst1 o2))
(assert (= result6 (mk_t__ref1 final_src)))
(assert (= final_src1 (bvadd src1 (bvsub c238b ((_ int2bv 64) 1)))))
(assert (not (bvule (to_rep2 (first (rt msg))) src1)))
(check-sat)
(exit)
