...
(define-fun dynamic_invariant2 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 65536)) (in_range temp___expr_142)))
...
(declare-const temp___242 (_ BitVec 16))
(declare-const o4 (Array (_ BitVec 16) integer))
(declare-const temp___245 (Array (_ BitVec 16) integer))
(declare-const temp___2451 t2)
(declare-const o5 (Array (_ BitVec 16) integer))
(declare-const temp___244 (Array (_ BitVec 16) integer))
(declare-const temp___2441 t1)
...
(declare-const temp___247 (_ BitVec 16))
...
(assert (= o2 (bvadd ((_ int2bv 16) 0) o1)))
(assert (= o3 (bvsub o2 (bvsub ((_ int2bv 16) 65535) (to_rep (rec__ring_buf__ring_buffer__first (us_split_fields1 r)))))))
(assert (= temp___242 (bvsub o3 ((_ int2bv 16) 1))))
(assert (bvule ((_ int2bv 16) 0) temp___242))
(assert (not (bvule ((_ int2bv 16) 0) ((_ int2bv 16) 0))))
(check-sat)
(exit)
