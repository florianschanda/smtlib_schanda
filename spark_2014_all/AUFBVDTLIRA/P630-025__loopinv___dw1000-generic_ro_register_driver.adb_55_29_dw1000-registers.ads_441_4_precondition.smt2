...
(declare-sort bits_28 0)
(define-fun in_range3 ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 0) x) (bvule x ((_ int2bv 32) 268435455))))
(define-fun in_range_int1 ((x Int)) Bool (and (<= 0 x) (<= x 268435455)))
...
(declare-fun user_eq5 (bits_28 bits_28) Bool)
(declare-const dummy5 bits_28)
(declare-datatypes () ((bits_28__ref (mk_bits_28__ref (bits_28__content bits_28)))))
(define-fun bits_28__ref___projection ((a bits_28__ref)) bits_28 (bits_28__content a))
(declare-fun to_rep3 (bits_28) (_ BitVec 32))
(declare-fun of_rep3 ((_ BitVec 32)) bits_28)
(assert (forall ((x bits_28)) (! (= (of_rep3 (to_rep3 x)) x) :pattern ((to_rep3 x)))))
(assert (forall ((x bits_28)) (! (in_range3 (to_rep3 x)) :pattern ((to_rep3 x)))))
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x ((_ int2bv 32) 268435456)))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
(define-fun to_int6 ((x bits_28)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x bits_28)) (! (in_range_int1 (to_int6 x)) :pattern ((to_int6 x)))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__rf_status_type__cplllock bits_1) (rec__dw1000__register_types__rf_status_type__cplllow bits_1) (rec__dw1000__register_types__rf_status_type__cpllhigh bits_1) (rec__dw1000__register_types__rf_status_type__rfplllock bits_1) (rec__dw1000__register_types__rf_status_type__reserved bits_28)))))
(define-fun us_split_fields_CPLLLOCK__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__rf_status_type__cplllock a))
(define-fun us_split_fields_CPLLLOW__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__rf_status_type__cplllow a))
(define-fun us_split_fields_CPLLHIGH__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__rf_status_type__cpllhigh a))
(define-fun us_split_fields_RFPLLLOCK__projection ((a us_split_fields)) bits_1 (rec__dw1000__register_types__rf_status_type__rfplllock a))
(define-fun us_split_fields_Reserved__14__projection ((a us_split_fields)) bits_28 (rec__dw1000__register_types__rf_status_type__reserved a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___57__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___57__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (and (= (to_rep2 (rec__dw1000__register_types__rf_status_type__cplllock (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rf_status_type__cplllock (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__rf_status_type__cplllow (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rf_status_type__cplllow (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__rf_status_type__cpllhigh (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rf_status_type__cpllhigh (us_split_fields1 b))))) (= (to_rep2 (rec__dw1000__register_types__rf_status_type__rfplllock (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rf_status_type__rfplllock (us_split_fields1 b))))) (= (to_rep3 (rec__dw1000__register_types__rf_status_type__reserved (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__rf_status_type__reserved (us_split_fields1 b))))) true false))
...
(declare-const dw1000__register_types__rf_status_type__cplllock__first__bit Int)
(declare-const dw1000__register_types__rf_status_type__cplllock__last__bit Int)
(declare-const dw1000__register_types__rf_status_type__cplllock__position Int)
(assert (<= 0 dw1000__register_types__rf_status_type__cplllock__first__bit))
(assert (< dw1000__register_types__rf_status_type__cplllock__first__bit dw1000__register_types__rf_status_type__cplllock__last__bit))
(assert (<= 0 dw1000__register_types__rf_status_type__cplllock__position))
(declare-const dw1000__register_types__rf_status_type__cplllow__first__bit Int)
(declare-const dw1000__register_types__rf_status_type__cplllow__last__bit Int)
(declare-const dw1000__register_types__rf_status_type__cplllow__position Int)
(assert (<= 0 dw1000__register_types__rf_status_type__cplllow__first__bit))
(assert (< dw1000__register_types__rf_status_type__cplllow__first__bit dw1000__register_types__rf_status_type__cplllow__last__bit))
(assert (<= 0 dw1000__register_types__rf_status_type__cplllow__position))
(declare-const dw1000__register_types__rf_status_type__cpllhigh__first__bit Int)
(declare-const dw1000__register_types__rf_status_type__cpllhigh__last__bit Int)
(declare-const dw1000__register_types__rf_status_type__cpllhigh__position Int)
(assert (<= 0 dw1000__register_types__rf_status_type__cpllhigh__first__bit))
(assert (< dw1000__register_types__rf_status_type__cpllhigh__first__bit dw1000__register_types__rf_status_type__cpllhigh__last__bit))
(assert (<= 0 dw1000__register_types__rf_status_type__cpllhigh__position))
(declare-const dw1000__register_types__rf_status_type__rfplllock__first__bit Int)
(declare-const dw1000__register_types__rf_status_type__rfplllock__last__bit Int)
(declare-const dw1000__register_types__rf_status_type__rfplllock__position Int)
(assert (<= 0 dw1000__register_types__rf_status_type__rfplllock__first__bit))
(assert (< dw1000__register_types__rf_status_type__rfplllock__first__bit dw1000__register_types__rf_status_type__rfplllock__last__bit))
(assert (<= 0 dw1000__register_types__rf_status_type__rfplllock__position))
(declare-const dw1000__register_types__rf_status_type__reserved__first__bit Int)
(declare-const dw1000__register_types__rf_status_type__reserved__last__bit Int)
(declare-const dw1000__register_types__rf_status_type__reserved__position Int)
(assert (<= 0 dw1000__register_types__rf_status_type__reserved__first__bit))
(assert (< dw1000__register_types__rf_status_type__reserved__first__bit dw1000__register_types__rf_status_type__reserved__last__bit))
(assert (<= 0 dw1000__register_types__rf_status_type__reserved__position))
(declare-fun user_eq6 (us_rep us_rep) Bool)
(declare-const dummy6 us_rep)
(declare-datatypes () ((rf_status_type__ref (mk_rf_status_type__ref (rf_status_type__content us_rep)))))
(define-fun rf_status_type__ref___projection ((a rf_status_type__ref)) us_rep (rf_status_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___134__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___95__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___95__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5355 us_t1) (temp___is_init_5352 Bool) (temp___skip_constant_5353 Bool) (temp___do_toplevel_5354 Bool)) Bool (=> (not (= temp___skip_constant_5353 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5355) (last3 temp___expr_5355)) (and (= (first3 temp___expr_5355) 1) (= (last3 temp___expr_5355) 4)))))
