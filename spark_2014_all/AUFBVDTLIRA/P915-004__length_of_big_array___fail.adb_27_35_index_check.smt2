...
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_639 us_void_param) 1)) 63) (= (to_rep (select (temp___String_Literal_639 us_void_param) 2)) 63)) (= (to_rep (select (temp___String_Literal_639 us_void_param) 3)) 63)) :pattern ((temp___String_Literal_639 us_void_param)))))
...
(assert (not (bvule (to_rep2 (first2 (rt1 c))) ((_ int2bv 64) 0))))
(check-sat)
(exit)
