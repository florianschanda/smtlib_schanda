...
(assert (forall ((us_void_param tuple0)) (! (and (and (= (to_rep (select (temp___String_Literal_645 us_void_param) 1)) 63) (= (to_rep (select (temp___String_Literal_645 us_void_param) 2)) 63)) (= (to_rep (select (temp___String_Literal_645 us_void_param) 3)) 63)) :pattern ((temp___String_Literal_645 us_void_param)))))
