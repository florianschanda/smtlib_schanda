...
(assert (=> (= result3 true) (=> (bvule (bvsub ((_ int2bv 32) 100000) complete_lines1) ((_ int2bv 32) 1)) (= o (bvsub (bvadd complete_lines1 ((_ int2bv 32) 1)) ((_ int2bv 32) 100000))))))
(assert (=> (= result3 true) (=> (not (bvule (bvsub ((_ int2bv 32) 100000) complete_lines1) ((_ int2bv 32) 1))) (= o (bvadd complete_lines1 ((_ int2bv 32) 1))))))
...
(assert (and (and (and (and (forall ((temp___2175 Int)) (=> (and (<= 1 temp___2175) (<= temp___2175 20)) (=> (< del_line2 temp___2175) (= (select cur_board3 temp___2175) (select cur_board temp___2175))))) (=> (<= 1 20) (in_range4 to_line3))) (=> (bvule ((_ int2bv 32) 0) ((_ int2bv 32) 99999)) (in_range2 complete_lines3))) (=> (<= 1 20) (in_range4 del_line2))) (and (<= 1 del_line2) (<= del_line2 20))))
(assert (not (= del_line2 20)))
(assert (= del_line2 result7))
(assert (= del_line3 (+ del_line2 1)))
(assert (and (= result8 (is_complete_line (select cur_board3 del_line3))) (= (= result8 true) (forall ((x Int)) (=> (and (<= 1 x) (<= x 10)) (not (= (to_rep (select (select cur_board3 del_line3) x)) 0)))))))
(assert (=> (= result8 true) (= cur_board3 result9)))
(assert (=> (= result8 true) (= cur_board4 (store cur_board3 del_line3 empty_line))))
(assert (=> (= result8 true) (= to_line3 result10)))
(assert (=> (= result8 true) (= to_line4 del_line3)))
(assert (=> (= result8 true) (=> (bvule (bvsub ((_ int2bv 32) 100000) complete_lines3) ((_ int2bv 32) 1)) (= o1 (bvsub (bvadd complete_lines3 ((_ int2bv 32) 1)) ((_ int2bv 32) 100000))))))
(assert (=> (= result8 true) (=> (not (bvule (bvsub ((_ int2bv 32) 100000) complete_lines3) ((_ int2bv 32) 1))) (= o1 (bvadd complete_lines3 ((_ int2bv 32) 1))))))
(assert (=> (= result8 true) (= complete_lines3 result11)))
(assert (=> (= result8 true) (= complete_lines4 o1)))
(assert (=> (= result8 true) (= (to_rep (select (select cur_board4 del_line3) 1)) 0)))
...
(assert (<= 1 y))
(assert (<= y del_line3))
(assert (not (not (= (is_complete_line (select cur_board4 y)) true))))
(check-sat)
(exit)
