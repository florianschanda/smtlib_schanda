...
(assert (and (and (and (and (forall ((temp___2426 Int)) (=> (and (<= 1 temp___2426) (<= temp___2426 20)) (=> (< del_line2 temp___2426) (= (select cur_board3 temp___2426) (select cur_board temp___2426))))) (=> (<= 1 20) (in_range4 to_line3))) (=> (bvule #x00000000 #x0001869F) (in_range2 complete_lines3))) (=> (<= 1 20) (in_range4 del_line2))) (and (<= 1 del_line2) (<= del_line2 20))))
...
(assert (=> (= result8 true) (=> (bvule (bvsub #x000186A0 complete_lines3) #x00000001) (= o1 (bvsub (bvadd complete_lines3 #x00000001) #x000186A0)))))
(assert (=> (= result8 true) (=> (not (bvule (bvsub #x000186A0 complete_lines3) #x00000001)) (= o1 (bvadd complete_lines3 #x00000001)))))
