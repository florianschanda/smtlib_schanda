...
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= (mk_map__ref result) mem11)))
...
(assert (=> (not (= rcx ((_ int2bv 64) 0))) (= memory10 (mk_map__ref memory4))))
...
(assert (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= memory10 (mk_map__ref memory))))
(assert (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= rdi10 (mk_t__ref1 rdi))))
(assert (=> (not (not (= rcx ((_ int2bv 64) 0)))) (= rcx10 (mk_t__ref1 rcx))))
...
(assert (=> (not (= rcx_start ((_ int2bv 64) 0))) (= (all_equal_rax rdi_start (bvsub rcx_start ((_ int2bv 64) 1)) memory6 rax) true)))
(assert (= mem8 mem10))
...
(assert (= rdi9 rdi7))
(assert (= rcx9 rcx7))
(assert (not (= (t__content1 rcx8) ((_ int2bv 64) 0))))
(check-sat)
(exit)
