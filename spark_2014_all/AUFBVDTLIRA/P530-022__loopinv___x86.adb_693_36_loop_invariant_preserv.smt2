...
(assert (and (forall ((i4 (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i4) (bvule i4 (bvsub rcx_start rcx))) (=> (not (= i4 (bvsub rcx_start rcx))) (= (hasmem64 mem (bvadd rdi_start (bvmul i4 ((_ int2bv 64) 8))) rax) true)))) (and (= rdi (bvadd rdi_start (bvmul (bvsub rcx_start rcx) ((_ int2bv 64) 8)))) (and (bvule rcx rcx_start) (and (bvult rcx_start ((_ int2bv 64) 2305843009213693951)) (and (= (nooverlap8equal memory mem rdi) true) (forall ((i4 (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i4) (bvule i4 (bvsub rcx_start rcx))) (=> (not (= i4 (bvsub rcx_start rcx))) (= (nooverlap8 (bvadd rdi_start (bvmul i4 ((_ int2bv 64) 8))) rdi) true))))))))))
...
(assert (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j i2)) (=> (not (= j (bvsub rcx_start rcx))) (= (hasmem64 memory (bvadd rdi_start (bvmul j ((_ int2bv 64) 8))) rax) true)))))
(assert (and (=> (bvule ((_ int2bv 64) 0) r75b) (dynamic_property ((_ int2bv 64) 0) r75b i2)) (and (bvule ((_ int2bv 64) 0) i2) (bvule i2 r75b))))
(assert (not (= i2 r75b)))
(assert (= i2 result1))
(assert (= i3 (bvadd i2 ((_ int2bv 64) 1))))
(assert (=> (not (= i3 (bvsub rcx_start rcx))) (forall ((j (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) j) (bvule j ((_ int2bv 64) 7))) (= (to_rep (select memory (bvadd (bvadd rdi_start (bvmul i3 ((_ int2bv 64) 8))) j))) (to_rep (select mem (bvadd (bvadd rdi_start (bvmul i3 ((_ int2bv 64) 8))) j))))))))
(assert (=> (not (= i3 (bvsub rcx_start rcx))) (= (hasmem64 memory (bvadd rdi_start (bvmul i3 ((_ int2bv 64) 8))) rax) true)))
