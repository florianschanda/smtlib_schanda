...
(assert (= result value))
(assert (= value1 o4))
(assert (=> (and (<= 0 (to_rep1 g__split_fields1)) (<= (to_rep1 g__split_fields1) 226)) (and (= o5 (+ (to_rep1 g__split_fields1) 397)) (in_range1 (+ (to_rep1 g__split_fields1) 397)))))
(assert (=> (not (and (<= 0 (to_rep1 g__split_fields1)) (<= (to_rep1 g__split_fields1) 226))) (=> (and (<= 227 (to_rep1 g__split_fields1)) (<= (to_rep1 g__split_fields1) 622)) (and (= o5 (+ (to_rep1 g__split_fields1) (- 227))) (in_range1 (+ (to_rep1 g__split_fields1) (- 227)))))))
(assert (=> (not (and (<= 0 (to_rep1 g__split_fields1)) (<= (to_rep1 g__split_fields1) 226))) (=> (not (and (<= 227 (to_rep1 g__split_fields1)) (<= (to_rep1 g__split_fields1) 622))) (= o5 396))))
...
(assert (not (bvule ((_ int2bv 32) 0) (bvand value1 ((_ int2bv 32) 1)))))
(check-sat)
(exit)
