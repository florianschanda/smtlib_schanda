...
(assert (not (= (ite (<= (to_rep2 (first4 temp___2931)) (to_rep2 (last4 temp___2931))) (+ (- (to_rep2 (last4 temp___2931)) (to_rep2 (first4 temp___2931))) 1) 0) (ite (<= 1 (to_rep (rec__fixed_stream__object__width (us_split_fields1 this)))) (+ (- (to_rep (rec__fixed_stream__object__width (us_split_fields1 this))) 1) 1) 0))))
(check-sat)
(exit)
