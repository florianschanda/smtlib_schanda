...
(declare-fun user_eq4 (bits_15 bits_15) Bool)
(declare-const dummy4 bits_15)
...
(assert (and (< 0 (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0)) (and (<= (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0) 1024) (and (< offset 1024) (<= (+ (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0) offset) 1024)))))
(assert (and (= o offset) (in_range_int offset)))
(assert (= o1 ((_ int2bv 16) o)))
(assert (not (< 0 (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0))))
(check-sat)
(exit)
