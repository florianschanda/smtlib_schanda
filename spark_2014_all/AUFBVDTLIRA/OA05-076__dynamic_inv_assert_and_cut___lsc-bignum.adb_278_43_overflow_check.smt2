...
(assert (= result1 (ite (<= i2 k) o25 false)))
(assert (= (= o26 true) (forall ((k1 Int)) (=> (and (<= i2 k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a1 k1)) (to_rep1 (select a k1)))))))
(assert (= o19 (from_word32 carry21)))
(assert (and (= o18 (base Tuple0)) (= o18 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o20 (omultiply o18 o19)))
(assert (= o17 (from_word32 carry11)))
(assert (= o21 (oadd o17 o20)))
