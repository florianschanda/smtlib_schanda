...
(assert (and (= o24 (bv2nat qdcount1)) (in_range3 (bv2nat qdcount1))))
(assert (= (to_rep4 o25) o24))
(assert (= o26 (mk___split_fields1 (rec__types__query_header__id header__split_fields4) (rec__types__query_header__opcode header__split_fields4) o25)))
(assert (= temp___331 (mk___rep1 o26)))
...
(assert (= o29 (extract_unsigned_16 query 6)))
...
(assert (= o32 (extract_unsigned_16 query 8)))
(assert (= result9 (mk_t__ref1 count1)))
(assert (= count2 o32))
(assert (= count2 ((_ int2bv 16) 0)))
(assert (= result____split_discrs7 result____split_discrs6))
(assert (= result____split_fields9 result____split_fields8))
(assert (= o35 (extract_unsigned_16 query 10)))
(assert (= result10 (mk_t__ref1 count2)))
(assert (= count3 o35))
(assert (not (= count3 ((_ int2bv 16) 0))))
(assert (= (to_rep2 (rec__parse__parse_result_t__return_code result____split_discrs7)) r26b))
(assert (in_range1 r26b))
(assert (= (to_rep2 o36) 1))
(assert (= o37 (mk___split_discrs o36)))
(assert (= temp___338 (mk___rep2 o37 (mk___split_fields2 dummy6) true)))
(assert (= result____attr__constrained true))
(assert (not (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___338)) (rec__parse__parse_result_t__return_code result____split_discrs7))))
(check-sat)
(exit)
