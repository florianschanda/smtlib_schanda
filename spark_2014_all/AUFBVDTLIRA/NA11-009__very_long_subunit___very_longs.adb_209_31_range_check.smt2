...
(assert (=> (< digit_count3 i2) (forall ((j Int)) (=> (and (<= (+ digit_count3 1) j) (<= j i2)) (= (to_rep2 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j)) #x00)))))
