...
(assert (forall ((x86__rcx (_ BitVec 64))) (! (=> (dynamic_invariant x86__rcx true true true) (let ((result (ecx x86__rcx))) (and (= result ((_ extract 31 0) (bvand x86__rcx ((_ int2bv 64) 4294967295)))) (dynamic_invariant2 result true false true)))) :pattern ((ecx x86__rcx)))))
(declare-const attr__ATTRIBUTE_ADDRESS3 Int)
(declare-fun esi ((_ BitVec 64)) (_ BitVec 32))
(declare-fun esi__function_guard ((_ BitVec 32) (_ BitVec 64)) Bool)
(assert (forall ((x86__rsi (_ BitVec 64))) (! (=> (dynamic_invariant x86__rsi true true true) (let ((result (esi x86__rsi))) (and (= result ((_ extract 31 0) (bvand x86__rsi ((_ int2bv 64) 4294967295)))) (dynamic_invariant2 result true false true)))) :pattern ((esi x86__rsi)))))
(declare-const attr__ATTRIBUTE_ADDRESS4 Int)
(declare-fun edi ((_ BitVec 64)) (_ BitVec 32))
(declare-fun edi__function_guard ((_ BitVec 32) (_ BitVec 64)) Bool)
(assert (forall ((x86__rdi (_ BitVec 64))) (! (=> (dynamic_invariant x86__rdi true true true) (let ((result (edi x86__rdi))) (and (= result ((_ extract 31 0) (bvand x86__rdi ((_ int2bv 64) 4294967295)))) (dynamic_invariant2 result true false true)))) :pattern ((edi x86__rdi)))))
...
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr true true true) (let ((result (readmem8 addr x86__memory))) (and (and (= result (to_rep (select x86__memory addr))) (bvuge result ((_ int2bv 8) 0))) (dynamic_invariant1 result true false true)))) :pattern ((readmem8 addr x86__memory))))))
...
(assert true)
(assert true)
(assert (and (= o (ecx rcx)) (= o ((_ extract 31 0) (bvand rcx ((_ int2bv 64) 4294967295))))))
(assert (= result (ite (bvugt o ((_ int2bv 32) 0)) true false)))
(assert (= result true))
(assert (bvugt (ecx rcx1) ((_ int2bv 32) 0)))
(assert (not (not (= (ecx rcx1) ((_ int2bv 32) 0)))))
(check-sat)
(exit)
