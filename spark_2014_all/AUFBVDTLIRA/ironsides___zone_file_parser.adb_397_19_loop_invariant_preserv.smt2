...
(assert (<= 1 i1))
(assert (<= i1 14))
(assert (and (and (<= endidx1 zlength) (= (- endidx1 begidx2) 13)) (<= i2 14)))
(assert (and (and (=> (<= 1 14) (in_range8 i2)) (forall ((temp___1534 Int)) (=> (and (<= 1 temp___1534) (<= temp___1534 14)) (=> (or (< 14 temp___1534) (or (< temp___1534 1) (<= i2 temp___1534))) (= (select timestring2 temp___1534) (select timestring1 temp___1534)))))) (and (<= 1 i2) (<= i2 14))))
(assert (and (<= 1 (- (+ begidx2 i2) 1)) (<= (- (+ begidx2 i2) 1) 256)))
(assert (= o (- (+ begidx2 i2) 1)))
(assert (= o1 (select zonefileline o)))
(assert (= o2 (to_rep o1)))
(assert (= (to_rep o3) o2))
(assert (= o4 (store timestring2 i2 o3)))
(assert (= result4 (mk_map__ref timestring2)))
(assert (= timestring3 o4))
(assert (not (= i2 14)))
(assert (= result5 (mk_int__ref i2)))
(assert (= i3 (+ i2 1)))
(assert (not (= (- endidx1 begidx2) 13)))
(check-sat)
(exit)
