...
(assert (forall ((addr (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr true true true) (let ((result (readmem16 addr x86__memory))) (and (= result (bvor ((_ zero_extend 8) (to_rep (select x86__memory addr))) (ite (< 8 16) (bvshl ((_ zero_extend 8) (to_rep (select x86__memory (bvadd addr ((_ int2bv 64) 1))))) ((_ int2bv 16) 8)) ((_ int2bv 16) 0)))) (dynamic_invariant2 result true false true)))) :pattern ((readmem16 addr x86__memory))))))
...
(assert (and (= (readmem8 addr memory1) ((_ extract 7 0) (bvand val__ ((_ int2bv 32) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i addr)) (= (to_rep (select memory1 i)) (to_rep (select memory i))))))))
(assert (and (= (readmem8 (bvadd addr ((_ int2bv 64) 1)) memory2) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 8)) ((_ int2bv 32) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 1)))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))
(assert (and (= (readmem8 (bvadd addr ((_ int2bv 64) 2)) memory3) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 16)) ((_ int2bv 32) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 2)))) (= (to_rep (select memory3 i)) (to_rep (select memory2 i))))))))
(assert (and (= (readmem8 (bvadd addr ((_ int2bv 64) 3)) memory4) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 24)) ((_ int2bv 32) 255)))) (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (not (= i (bvadd addr ((_ int2bv 64) 3)))) (= (to_rep (select memory4 i)) (to_rep (select memory3 i))))))))
(assert (= ((_ zero_extend 8) (to_rep (select memory4 (bvadd addr ((_ int2bv 64) 2))))) ((_ extract 15 0) (bvlshr (bvand val__ ((_ int2bv 32) 16711680)) ((_ int2bv 32) 16)))))
(assert (= (readmem16 addr memory4) ((_ extract 15 0) (bvand val__ ((_ int2bv 32) 65535)))))
(assert (not (= (bvor ((_ zero_extend 16) (readmem16 addr memory4)) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr ((_ int2bv 64) 2)) memory4)) ((_ int2bv 32) 16))) val__)))
(check-sat)
(exit)
