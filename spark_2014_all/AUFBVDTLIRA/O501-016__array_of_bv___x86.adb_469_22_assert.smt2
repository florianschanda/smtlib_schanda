...
(assert (and (= (readmem8 addr memory1) ((_ extract 7 0) (bvand val__ #x000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i addr)) (= (to_rep (select memory1 i)) (to_rep (select memory i))))))))
(assert (and (= (readmem8 (bvadd addr #x0000000000000001) memory2) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 8)) #x000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000001))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))
(assert (and (= (readmem8 (bvadd addr #x0000000000000002) memory3) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 16)) #x000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000002))) (= (to_rep (select memory3 i)) (to_rep (select memory2 i))))))))
(assert (and (= (readmem8 (bvadd addr #x0000000000000003) memory4) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 32) 24)) #x000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000003))) (= (to_rep (select memory4 i)) (to_rep (select memory3 i))))))))
(assert (= ((_ zero_extend 8) (to_rep (select memory4 (bvadd addr #x0000000000000002)))) ((_ extract 15 0) (bvlshr (bvand val__ #x00FF0000) ((_ int2bv 32) 16)))))
(assert (= (readmem16 addr memory4) ((_ extract 15 0) (bvand val__ #x0000FFFF))))
(assert (not (= (bvor ((_ zero_extend 16) (readmem16 addr memory4)) (bvshl ((_ zero_extend 16) (readmem16 (bvadd addr #x0000000000000002) memory4)) ((_ int2bv 32) 16))) val__)))
(check-sat)
(exit)
