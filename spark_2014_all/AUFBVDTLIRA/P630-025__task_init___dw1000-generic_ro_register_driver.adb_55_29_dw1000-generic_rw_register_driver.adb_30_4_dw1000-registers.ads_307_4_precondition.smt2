...
(define-fun register_type__ref___66__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___47__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___47__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3966 us_t1) (temp___is_init_3962 Bool) (temp___skip_constant_3963 Bool) (temp___do_toplevel_3964 Bool) (temp___do_typ_inv_3965 Bool)) Bool (=> (not (= temp___skip_constant_3963 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3966) (last3 temp___expr_3966)) (and (= (first3 temp___expr_3966) 1) (= (last3 temp___expr_3966) 2)))))
