...
(define-fun dynamic_invariant ((temp___expr_3598 us_t1) (temp___is_init_3595 Bool) (temp___skip_constant_3596 Bool) (temp___do_toplevel_3597 Bool)) Bool (=> (not (= temp___skip_constant_3596 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3598) (last3 temp___expr_3598)) (and (= (first3 temp___expr_3598) 1) (= (last3 temp___expr_3598) 2)))))
