...
(assert (= zeroflag79 true))
(assert (= memory39 (let ((subject memory)) (mk_map__ref memory36))))
(assert (= r156 (let ((subject r15)) (mk_t__ref3 r153))))
(assert (= r1413 r149))
(assert (= r1320 r1316))
(assert (= r1227 r1223))
(assert (= rdi90 rdi86))
(assert (= rsi31 rsi27))
(assert (= rbp78 rbp74))
(assert (= rsp117 rsp113))
(assert (= rbx78 rbx74))
(assert (= rax79 rax75))
(assert (= xmm723 (mk_t__ref3 xmm720)))
(assert (= xmm614 xmm610))
(assert (= xmm520 xmm516))
(assert (= xmm427 xmm423))
(assert (= xmm330 xmm326))
(assert (= xmm230 xmm226))
(assert (= xmm130 xmm126))
(assert (= xmm078 xmm074))
(assert (= overflowflag78 overflowflag74))
(assert (= signflag78 signflag74))
(assert (= carryflag78 carryflag74))
(assert (= zeroflag82 (mk_bool__ref zeroflag79)))
(assert (= memory40 memory36))
(assert (= r157 r153))
(assert (= r1414 r1410))
(assert (= r1321 r1317))
(assert (= r1228 r1224))
...
(assert (= rsi32 rsi28))
(assert (= rbp79 rbp75))
(assert (= rsp118 rsp114))
(assert (= rbx79 rbx75))
(assert (= rax80 rax76))
(assert (= xmm724 xmm720))
(assert (= xmm615 xmm611))
(assert (= xmm521 xmm517))
(assert (= xmm428 xmm424))
(assert (= xmm331 xmm327))
(assert (= xmm231 xmm227))
(assert (= xmm131 xmm127))
(assert (= xmm079 xmm075))
(assert (= overflowflag79 overflowflag75))
(assert (= signflag79 signflag75))
(assert (= carryflag79 carryflag75))
(assert (= zeroflag83 zeroflag79))
(assert (= memory41 memory39))
(assert (= r158 r156))
(assert (= r1415 r1413))
(assert (= r1322 r1320))
(assert (= r1229 r1227))
...
(assert (= rsi33 rsi31))
(assert (= rbp80 rbp78))
(assert (= rsp119 rsp117))
(assert (= rbx80 rbx78))
(assert (= rax81 rax79))
(assert (= xmm725 xmm723))
(assert (= xmm616 xmm614))
(assert (= xmm522 xmm520))
(assert (= xmm429 xmm427))
(assert (= xmm332 xmm330))
(assert (= xmm232 xmm230))
(assert (= xmm132 xmm130))
(assert (= xmm080 xmm078))
(assert (= overflowflag80 overflowflag78))
(assert (= signflag80 signflag78))
(assert (= carryflag80 carryflag78))
(assert (= zeroflag84 zeroflag82))
(assert (= memory42 memory40))
(assert (= r159 r157))
(assert (= r1416 r1414))
(assert (= r1323 r1321))
(assert (= r1230 r1228))
...
(assert (= rsi34 rsi32))
(assert (= rbp81 rbp79))
(assert (= rsp120 rsp118))
(assert (= rbx81 rbx79))
(assert (= rax82 rax80))
(assert (= xmm726 xmm724))
(assert (= xmm617 xmm615))
(assert (= xmm523 xmm521))
(assert (= xmm430 xmm428))
(assert (= xmm333 xmm331))
(assert (= xmm233 xmm231))
(assert (= xmm133 xmm131))
(assert (= xmm081 xmm079))
(assert (= overflowflag81 overflowflag79))
(assert (= signflag81 signflag79))
(assert (= carryflag81 carryflag79))
(assert (= zeroflag85 zeroflag83))
(assert (= (writereg32post (let ((subject rdi)) rdi94) ((_ int2bv 32) 4198544)) true))
(assert (= (writereg32post (let ((subject rbx)) rbx82) ((_ int2bv 32) 0)) true))
(assert (and (forall ((i (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) i) (bvule i ((_ int2bv 64) 18446744073709551615))) (=> (and (and (and (and (and (and (and (not (= i (bvsub (bvadd (let ((subject rsp)) rsp121) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)))) (not (= i (bvadd (bvsub (bvadd (let ((subject rsp)) rsp121) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 1))))) (not (= i (bvadd (bvsub (bvadd (let ((subject rsp)) rsp121) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 2))))) (not (= i (bvadd (bvsub (bvadd (let ((subject rsp)) rsp121) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 3))))) (not (= i (bvadd (bvsub (bvadd (let ((subject rsp)) rsp121) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 4))))) (not (= i (bvadd (bvsub (bvadd (let ((subject rsp)) rsp121) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 5))))) (not (= i (bvadd (bvsub (bvadd (let ((subject rsp)) rsp121) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 6))))) (not (= i (bvadd (bvsub (bvadd (let ((subject rsp)) rsp121) ((_ int2bv 64) 152)) ((_ int2bv 64) 104)) ((_ int2bv 64) 7))))) (= (to_rep (select (let ((subject memory)) memory43) i)) (to_rep (select (map__content memory41) i)))))) (= (let ((subject rsp)) rsp121) (t__content3 rsp119))))
(assert (= result162 (let ((subject rsi)) (mk_t__ref3 rsi35))))
(assert (= (let ((subject rsi)) rsi36) (bvadd (let ((subject rsp)) rsp121) ((_ int2bv 64) 48))))
(assert (= (writereg32post (let ((subject rdi)) rdi96) ((_ int2bv 32) 1072497001)) true))
(assert (= (writereg16post (let ((subject rbx)) rbx83) (let ((subject rbx)) rbx84) ((_ int2bv 16) 361)) true))
(assert (= result163 (let ((subject rsp)) (mk_t__ref3 rsp121))))
(assert (= (let ((subject rsp)) rsp122) (bvsub (let ((subject rsp)) rsp121) ((_ int2bv 64) 8))))
(assert (not (not (= (inrange64 (let ((subject rsi)) rsi36) (bvsub (let ((subject rsp)) rsp122) ((_ int2bv 64) 7)) ((_ int2bv 64) 15)) true))))
(check-sat)
(exit)
