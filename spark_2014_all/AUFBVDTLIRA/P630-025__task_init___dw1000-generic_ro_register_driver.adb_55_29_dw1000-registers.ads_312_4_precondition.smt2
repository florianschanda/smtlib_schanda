...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 64)))) (=> (in_range4 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
...
(define-fun dynamic_invariant ((temp___expr_3651 us_t1) (temp___is_init_3648 Bool) (temp___skip_constant_3649 Bool) (temp___do_toplevel_3650 Bool)) Bool (=> (not (= temp___skip_constant_3649 true)) (and (dynamic_property2 1 3 (first3 temp___expr_3651) (last3 temp___expr_3651)) (and (= (first3 temp___expr_3651) 1) (= (last3 temp___expr_3651) 3)))))
