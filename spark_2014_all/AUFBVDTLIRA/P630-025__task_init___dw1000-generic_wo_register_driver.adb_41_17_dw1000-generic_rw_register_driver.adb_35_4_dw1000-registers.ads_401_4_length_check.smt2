...
(define-fun dynamic_invariant ((temp___expr_4939 us_t1) (temp___is_init_4936 Bool) (temp___skip_constant_4937 Bool) (temp___do_toplevel_4938 Bool)) Bool (=> (not (= temp___skip_constant_4937 true)) (and (dynamic_property2 1 4 (first3 temp___expr_4939) (last3 temp___expr_4939)) (and (= (first3 temp___expr_4939) 1) (= (last3 temp___expr_4939) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_4955 us_t2) (temp___is_init_4952 Bool) (temp___skip_constant_4953 Bool) (temp___do_toplevel_4954 Bool)) Bool (=> (not (= temp___skip_constant_4953 true)) (and (dynamic_property3 1 4 (first5 temp___expr_4955) (last5 temp___expr_4955)) (and (= (first5 temp___expr_4955) 1) (= (last5 temp___expr_4955) 4)))))
...
(declare-const temp___7957 (Array Int bits_8))
(declare-const temp___79571 t1)
...
(assert (and (= (mk___t2 temp___7956 temp___79561) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7956 temp___79561) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___79561)) (to_rep (last4 temp___79561))) (+ (- (to_rep (last4 temp___79561)) (to_rep (first4 temp___79561))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7956 temp___7957))
(assert (= (mk1 (to_rep (first4 temp___79561)) (to_rep (last4 temp___79561))) temp___79571))
(assert (not (= (ite (<= (to_rep (first2 temp___79571)) (to_rep (last2 temp___79571))) (+ (- (to_rep (last2 temp___79571)) (to_rep (first2 temp___79571))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
