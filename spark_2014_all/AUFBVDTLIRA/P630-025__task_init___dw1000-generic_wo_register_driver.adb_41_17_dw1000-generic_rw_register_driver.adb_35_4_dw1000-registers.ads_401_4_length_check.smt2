...
(define-fun register_type__ref___114__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___81__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___81__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5417 us_t1) (temp___is_init_5413 Bool) (temp___skip_constant_5414 Bool) (temp___do_toplevel_5415 Bool) (temp___do_typ_inv_5416 Bool)) Bool (=> (not (= temp___skip_constant_5414 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5417) (last3 temp___expr_5417)) (and (= (first3 temp___expr_5417) 1) (= (last3 temp___expr_5417) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___34__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___34__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_5435 us_t2) (temp___is_init_5431 Bool) (temp___skip_constant_5432 Bool) (temp___do_toplevel_5433 Bool) (temp___do_typ_inv_5434 Bool)) Bool (=> (not (= temp___skip_constant_5432 true)) (and (dynamic_property3 1 4 (first5 temp___expr_5435) (last5 temp___expr_5435)) (and (= (first5 temp___expr_5435) 1) (= (last5 temp___expr_5435) 4)))))
...
(declare-const temp___8728 (Array Int bits_8))
(declare-const temp___87281 t2)
(declare-const temp___8729 (Array Int bits_8))
(declare-const temp___87291 t1)
(define-fun temp___87282 () us_t2 (mk___t2 temp___8728 temp___87281))
...
(assert (and (= temp___87282 (register_to_bytes reg)) (dynamic_invariant1 temp___87282 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___87281)) (to_rep (last4 temp___87281))) (+ (- (to_rep (last4 temp___87281)) (to_rep (first4 temp___87281))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8728 temp___8729))
(assert (= (mk1 (to_rep (first4 temp___87281)) (to_rep (last4 temp___87281))) temp___87291))
(assert (not (= (ite (<= (to_rep (first2 temp___87291)) (to_rep (last2 temp___87291))) (+ (- (to_rep (last2 temp___87291)) (to_rep (first2 temp___87291))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
