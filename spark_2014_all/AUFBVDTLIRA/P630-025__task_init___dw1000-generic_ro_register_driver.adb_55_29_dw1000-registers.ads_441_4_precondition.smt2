...
(define-fun in_range3 ((x (_ BitVec 32))) Bool (and (bvule #x00000000 x) (bvule x #x0FFFFFFF)))
...
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x #x10000000))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(define-fun dynamic_invariant ((temp___expr_5881 us_t1) (temp___is_init_5877 Bool) (temp___skip_constant_5878 Bool) (temp___do_toplevel_5879 Bool) (temp___do_typ_inv_5880 Bool)) Bool (=> (not (= temp___skip_constant_5878 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5881) (last3 temp___expr_5881)) (and (= (first3 temp___expr_5881) 1) (= (last3 temp___expr_5881) 4)))))
