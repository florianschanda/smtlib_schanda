...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 32)))) (=> (in_range2 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (= (to_rep3 (rec__dw1000__register_types__otp_addr_type__otp_addr (us_split_fields1 a))) (to_rep3 (rec__dw1000__register_types__otp_addr_type__otp_addr (us_split_fields1 b)))) (= (to_rep2 (rec__dw1000__register_types__otp_addr_type__reserved (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__otp_addr_type__reserved (us_split_fields1 b))))) true false))
...
(define-fun register_type__ref___180__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___126__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___126__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6321 us_t1) (temp___is_init_6318 Bool) (temp___skip_constant_6319 Bool) (temp___do_toplevel_6320 Bool)) Bool (=> (not (= temp___skip_constant_6319 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6321) (last3 temp___expr_6321)) (and (= (first3 temp___expr_6321) 1) (= (last3 temp___expr_6321) 2)))))
