...
(define-fun dynamic_invariant ((temp___expr_6952 us_t1) (temp___is_init_6948 Bool) (temp___skip_constant_6949 Bool) (temp___do_toplevel_6950 Bool) (temp___do_typ_inv_6951 Bool)) Bool (=> (not (= temp___skip_constant_6949 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6952) (last3 temp___expr_6952)) (and (= (first3 temp___expr_6952) 1) (= (last3 temp___expr_6952) 2)))))
