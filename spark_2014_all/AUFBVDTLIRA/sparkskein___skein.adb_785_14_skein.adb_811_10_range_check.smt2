...
(assert (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) ((_ int2bv 64) 64)))
(assert (= (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) r250b))
(assert true)
(assert (bvule r250b ((_ int2bv 64) 63)))
(assert (not (bvuge r250b ((_ int2bv 64) 0))))
(check-sat)
(exit)
