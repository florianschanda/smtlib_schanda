...
(assert (bvult (to_rep4 (rec__skein__context_header__byte_count (us_split_fields3 (rec__skein__skein_512_context__h local_ctx__split_fields13)))) #x0000000000000040))
...
(assert (bvule r250b #x000000000000003F))
(assert (not (bvuge r250b #x0000000000000000)))
(check-sat)
(exit)
