...
(define-fun in_range5 ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 0) x) (bvule x ((_ int2bv 32) 524287))))
...
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x ((_ int2bv 32) 524288)))) (=> (in_range5 y) (= (to_rep5 (of_rep5 x)) y))) :pattern ((to_rep5 (of_rep5 x))))))
...
(define-fun dynamic_invariant ((temp___expr_2940 us_t1) (temp___is_init_2937 Bool) (temp___skip_constant_2938 Bool) (temp___do_toplevel_2939 Bool)) Bool (=> (not (= temp___skip_constant_2938 true)) (and (dynamic_property2 1 5 (first3 temp___expr_2940) (last3 temp___expr_2940)) (and (= (first3 temp___expr_2940) 1) (= (last3 temp___expr_2940) 5)))))
