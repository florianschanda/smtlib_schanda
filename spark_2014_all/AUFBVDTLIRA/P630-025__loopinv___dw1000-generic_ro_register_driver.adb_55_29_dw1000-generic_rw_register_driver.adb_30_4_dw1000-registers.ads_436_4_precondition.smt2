...
(define-fun dynamic_invariant ((temp___expr_5301 us_t1) (temp___is_init_5298 Bool) (temp___skip_constant_5299 Bool) (temp___do_toplevel_5300 Bool)) Bool (=> (not (= temp___skip_constant_5299 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5301) (last3 temp___expr_5301)) (and (= (first3 temp___expr_5301) 1) (= (last3 temp___expr_5301) 4)))))
