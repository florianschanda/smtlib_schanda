...
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1318) (<= temp___1318 (to_rep2 (last3 u__split_fields1)))))
(assert (= o5 temp___1318))
(assert (= o6 (select u__split_fields o5)))
(assert (= o7 (to_rep1 o6)))
(assert (= o8 ((_ zero_extend 8) o7)))
(assert (and (= temp___1316 (+ j n)) (in_range1 (+ j n))))
...
(assert (and (<= (to_rep2 (first2 u__split_fields1)) temp___1324) (<= temp___1324 (to_rep2 (last3 u__split_fields1)))))
