...
(assert (= (ite (<= (to_rep (first4 temp___87811)) (to_rep (last4 temp___87811))) (+ (- (to_rep (last4 temp___87811)) (to_rep (first4 temp___87811))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
(assert (= temp___8781 temp___8782))
(assert (= (mk1 (to_rep (first4 temp___87811)) (to_rep (last4 temp___87811))) temp___87821))
(assert (= (ite (<= (to_rep (first2 temp___87821)) (to_rep (last2 temp___87821))) (+ (- (to_rep (last2 temp___87821)) (to_rep (first2 temp___87821))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8782 temp___87821)))
(assert (= o2 o))
