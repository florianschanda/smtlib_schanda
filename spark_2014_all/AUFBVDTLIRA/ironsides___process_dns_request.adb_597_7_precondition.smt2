...
(define-fun in_range1 ((x Int)) Bool (and (<= 1 x) (<= x 8180)))
...
(define-fun dynamic_invariant ((temp___expr_796 Int) (temp___is_init_792 Bool) (temp___skip_constant_793 Bool) (temp___do_toplevel_794 Bool) (temp___do_typ_inv_795 Bool)) Bool (=> (or (= temp___is_init_792 true) (<= 1 8180)) (in_range1 temp___expr_796)))
...
(assert (forall ((x byte)) (! (uint_in_range2 (to_int4 x)) :pattern ((to_int4 x)))))
...
(define-fun bool_eq1 ((a (Array Int unsigned16)) (a__first Int) (a__last Int) (b (Array Int unsigned16)) (b__first Int) (b__last Int)) Bool (ite (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_194 Int)) (=> (and (<= a__first temp___idx_194) (<= temp___idx_194 a__last)) (= (to_rep1 (select a temp___idx_194)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_194))))))) true false))
(assert (forall ((a (Array Int unsigned16)) (b (Array Int unsigned16))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq1 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_194 Int)) (=> (and (<= a__first temp___idx_194) (<= temp___idx_194 a__last)) (= (to_rep1 (select a temp___idx_194)) (to_rep1 (select b (+ (- b__first a__first) temp___idx_194)))))))))))
...
(assert (forall ((x classtype)) (! (in_range2 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(declare-const dummy7 (Array Int unsigned16))
(declare-const value__size1 Int)
(declare-fun object__size1 ((Array Int unsigned16)) Int)
(declare-const value__component__size Int)
(declare-fun object__component__size ((Array Int unsigned16)) Int)
(declare-const value__alignment1 Int)
(declare-fun object__alignment1 ((Array Int unsigned16)) Int)
(assert (<= 0 value__size1))
(assert (forall ((a (Array Int unsigned16))) (<= 0 (object__size1 a))))
(assert (<= 0 value__component__size))
(assert (forall ((a (Array Int unsigned16))) (<= 0 (object__component__size a))))
(assert (<= 0 value__alignment1))
(assert (forall ((a (Array Int unsigned16))) (<= 0 (object__alignment1 a))))
(declare-fun user_eq7 ((Array Int unsigned16) (Array Int unsigned16)) Bool)
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__rr_type__aaaa_record_type__aaaarecordtype__ipv6 (Array Int unsigned16)) (rec__rr_type__resourcerecordtype__ttlinseconds1 unsigned32) (rec__rr_type__resourcerecordtype__class1 classtype) (rec__ext__1 us_private)))))
(define-fun us_split_fields_IPV6__projection ((a us_split_fields2)) (Array Int unsigned16) (rec__rr_type__aaaa_record_type__aaaarecordtype__ipv6 a))
(define-fun us_split_fields_TTLInSeconds__3__projection ((a us_split_fields2)) unsigned32 (rec__rr_type__resourcerecordtype__ttlinseconds1 a))
(define-fun us_split_fields_Class__3__projection ((a us_split_fields2)) classtype (rec__rr_type__resourcerecordtype__class1 a))
...
(declare-fun hide_ext__ ((Array Int unsigned16) us_private) us_private)
(declare-fun extract__ipv6 (us_private) (Array Int unsigned16))
(assert (forall ((ipv6 (Array Int unsigned16))) (forall ((rec__ext__2 us_private)) (= (extract__ipv6 (hide_ext__ ipv6 rec__ext__2)) ipv6))))
(declare-fun extract__ext__ (us_private) us_private)
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (mk___split_fields (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 a)) (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 a)) (hide_ext__ (rec__rr_type__aaaa_record_type__aaaarecordtype__ipv6 (us_split_fields3 a)) (rec__ext__1 (us_split_fields3 a)))) (attr__tag1 a)))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (mk___split_fields1 (extract__ipv6 (rec__ext__ (us_split_fields1 r))) (rec__rr_type__resourcerecordtype__ttlinseconds (us_split_fields1 r)) (rec__rr_type__resourcerecordtype__class (us_split_fields1 r)) (extract__ext__ (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (bool_eq1 (rec__rr_type__aaaa_record_type__aaaarecordtype__ipv6 (us_split_fields3 a)) 1 8 (rec__rr_type__aaaa_record_type__aaaarecordtype__ipv6 (us_split_fields3 b)) 1 8) true) (= (to_rep2 (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 a))) (to_rep2 (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 b))))) (= (to_rep3 (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 a))) (to_rep3 (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 b))))) true false))
...
(declare-const rr_type__aaaa_record_type__aaaarecordtype__ipv6__first__bit Int)
(declare-const rr_type__aaaa_record_type__aaaarecordtype__ipv6__last__bit Int)
(declare-const rr_type__aaaa_record_type__aaaarecordtype__ipv6__position Int)
(assert (<= 0 rr_type__aaaa_record_type__aaaarecordtype__ipv6__first__bit))
(assert (< rr_type__aaaa_record_type__aaaarecordtype__ipv6__first__bit rr_type__aaaa_record_type__aaaarecordtype__ipv6__last__bit))
(assert (<= 0 rr_type__aaaa_record_type__aaaarecordtype__ipv6__position))
...
(declare-datatypes () ((aaaarecordtype__ref (mk_aaaarecordtype__ref (aaaarecordtype__content us_rep1)))))
(define-fun aaaarecordtype__ref___projection ((a aaaarecordtype__ref)) us_rep1 (aaaarecordtype__content a))
(define-fun default_initial_assumption ((temp___expr_1165 us_rep1) (temp___skip_top_level_1166 Bool)) Bool (= (attr__tag1 temp___expr_1165) us_tag1))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const start_byte Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const aaaa_record us_rep1)
...
(define-fun dynamic_invariant3 ((temp___expr_956 (_ BitVec 16)) (temp___is_init_952 Bool) (temp___skip_constant_953 Bool) (temp___do_toplevel_954 Bool) (temp___do_typ_inv_955 Bool)) Bool true)
(define-fun dynamic_invariant4 ((temp___expr_963 (_ BitVec 32)) (temp___is_init_959 Bool) (temp___skip_constant_960 Bool) (temp___do_toplevel_961 Bool) (temp___do_typ_inv_962 Bool)) Bool true)
(define-fun dynamic_invariant5 ((temp___expr_970 Int) (temp___is_init_966 Bool) (temp___skip_constant_967 Bool) (temp___do_toplevel_968 Bool) (temp___do_typ_inv_969 Bool)) Bool (=> (or (= temp___is_init_966 true) (<= 0 3)) (in_range2 temp___expr_970)))
...
(assert (in_range1 start_byte))
(assert (<= start_byte 8158))
