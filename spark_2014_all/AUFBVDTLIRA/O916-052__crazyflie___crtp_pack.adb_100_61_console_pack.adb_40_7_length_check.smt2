...
(declare-const temp___4190 (Array Int t_uint8))
(declare-const temp___41901 t)
...
(assert (= o3 temp___4190))
(assert (= (mk r6b r7b) temp___41901))
(assert (not (= (ite (<= (to_rep6 (first temp___41881)) (to_rep6 (last temp___41881))) (+ (- (to_rep6 (last temp___41881)) (to_rep6 (first temp___41881))) 1) 0) (ite (<= (to_rep6 (first temp___41901)) (to_rep6 (last temp___41901))) (+ (- (to_rep6 (last temp___41901)) (to_rep6 (first temp___41901))) 1) 0))))
(check-sat)
(exit)
