...
(assert (= o3 temp___3842))
(assert (= (mk r6b r7b) temp___38421))
(assert (not (= (ite (<= (to_rep6 (first temp___38401)) (to_rep6 (last temp___38401))) (+ (- (to_rep6 (last temp___38401)) (to_rep6 (first temp___38401))) 1) 0) (ite (<= (to_rep6 (first temp___38421)) (to_rep6 (last temp___38421))) (+ (- (to_rep6 (last temp___38421)) (to_rep6 (first temp___38421))) 1) 0))))
(check-sat)
(exit)
