...
(assert (=> (<= temp___727 temp___728) (and (and (<= (to_rep (first (rt buffer))) temp___727) (<= temp___727 (to_rep (last (rt buffer))))) (and (<= (to_rep (first (rt buffer))) temp___728) (<= temp___728 (to_rep (last (rt buffer))))))))
(assert (= o14 (elts buffer)))
(assert (= o14 temp___729))
(assert (= (mk6 temp___727 temp___728) temp___7291))
(assert (= (ite (<= (to_rep (first12 temp___7291)) (to_rep (last12 temp___7291))) (+ (- (to_rep (last12 temp___7291)) (to_rep (first12 temp___7291))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= o15 (slide temp___729 (to_rep (first12 temp___7291)) 1)))
(assert (= result5 (mk_map__ref ethertype_length_2)))
(assert (= ethertype_length_21 o15))
(assert (= o16 (convert_to_two_octets (mk___t ethertype_length_21 (mk 1 2)))))
(assert (= result6 (ite (= o16 #x8100) true false)))
(assert (= result6 true))
(assert (and (= temp___731 (+ (to_rep (first (rt buffer))) 19)) (in_range1 (+ (to_rep (first (rt buffer))) 19))))
(assert (and (= temp___730 (+ (to_rep (first (rt buffer))) 16)) (in_range1 (+ (to_rep (first (rt buffer))) 16))))
(assert (<= temp___730 temp___731))
(assert (not (<= (to_rep (first (rt buffer))) temp___730)))
(check-sat)
(exit)
