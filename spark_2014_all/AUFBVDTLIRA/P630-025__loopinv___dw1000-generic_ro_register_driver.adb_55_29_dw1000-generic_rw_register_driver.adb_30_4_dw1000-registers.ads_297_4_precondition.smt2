...
(define-fun dynamic_invariant ((temp___expr_3484 us_t1) (temp___is_init_3481 Bool) (temp___skip_constant_3482 Bool) (temp___do_toplevel_3483 Bool)) Bool (=> (not (= temp___skip_constant_3482 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3484) (last3 temp___expr_3484)) (and (= (first3 temp___expr_3484) 1) (= (last3 temp___expr_3484) 2)))))
