...
(assert (and (= o20 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o21 (ite (<= k o20) true false)))
(assert (= result1 (ite (<= i2 k) o21 false)))
(assert (= (= o22 true) (forall ((k1 Int)) (=> (and (<= i2 k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a1 k1)) (to_rep1 (select a k1)))))))
(assert (= o15 (from_word32 carry21)))
(assert (and (= o14 (base Tuple0)) (= o14 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o16 (omultiply o14 o15)))
(assert (= o13 (from_word32 carry11)))
(assert (= o17 (oadd o13 o16)))
...
(assert (= o18 (omultiply o12 o17)))
(assert (and (= o6 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o7 o6) (in_range2 o6)))
(assert (= o8 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first o7)))
(assert (= o19 (oadd o8 o18)))
(assert (= o4 (from_word32 carry2)))
(assert (and (= o3 (base Tuple0)) (= o3 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o5 (omultiply o3 o4)))
(assert (= o2 (from_word32 carry1)))
(assert (= o1 (from_word32 y)))
