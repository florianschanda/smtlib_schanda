...
(declare-const o15 t)
(declare-const temp___1234 digit_index_type)
(declare-const temp___12341 (Array Int octet))
(declare-const temp___12342 t)
...
(assert (<= 1 i1))
(assert (<= i1 r123b))
(assert (and (and (dynamic_invariant1 (mk___rep number__split_discrs (mk___split_fields (mk___t number__split_fields2 number__split_fields3))) true true true) (forall ((temp___1243 Int)) (=> (and (<= (to_rep1 (first number__split_fields3)) temp___1243) (<= temp___1243 (to_rep1 (last number__split_fields3)))) (=> (<= temp___1243 i2) (= (select number__split_fields2 temp___1243) (select number__split_fields temp___1243)))))) (and (<= 1 i2) (<= i2 r123b))))
