...
(assert (= o4 (to_rep o3)))
(assert (not (< (length1 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) (capacity (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))))))
(check-sat)
(exit)
