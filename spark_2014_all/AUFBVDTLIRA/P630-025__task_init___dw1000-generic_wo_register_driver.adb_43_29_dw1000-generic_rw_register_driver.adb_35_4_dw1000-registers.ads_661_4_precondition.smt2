...
(assert (= (ite (<= (to_rep (first4 temp___89921)) (to_rep (last4 temp___89921))) (+ (- (to_rep (last4 temp___89921)) (to_rep (first4 temp___89921))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8992 temp___8993))
(assert (= (mk1 (to_rep (first4 temp___89921)) (to_rep (last4 temp___89921))) temp___89931))
(assert (= (ite (<= (to_rep (first2 temp___89931)) (to_rep (last2 temp___89931))) (+ (- (to_rep (last2 temp___89931)) (to_rep (first2 temp___89931))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8993 temp___89931)))
(assert (= o2 o))
