...
(define-fun register_type__ref___107__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___76__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___76__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5271 us_t1) (temp___is_init_5267 Bool) (temp___skip_constant_5268 Bool) (temp___do_toplevel_5269 Bool) (temp___do_typ_inv_5270 Bool)) Bool (=> (not (= temp___skip_constant_5268 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5271) (last3 temp___expr_5271)) (and (= (first3 temp___expr_5271) 1) (= (last3 temp___expr_5271) 2)))))
