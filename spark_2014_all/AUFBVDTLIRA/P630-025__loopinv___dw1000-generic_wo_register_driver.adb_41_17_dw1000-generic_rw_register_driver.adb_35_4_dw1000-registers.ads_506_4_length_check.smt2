...
(define-fun target__ref___51__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun bool_eq3 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__aon_addr_type__aon_addr (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__aon_addr_type__aon_addr (us_split_fields1 b)))) true false))
...
(define-fun dynamic_invariant ((temp___expr_6694 us_t1) (temp___is_init_6690 Bool) (temp___skip_constant_6691 Bool) (temp___do_toplevel_6692 Bool) (temp___do_typ_inv_6693 Bool)) Bool (=> (not (= temp___skip_constant_6691 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6694) (last3 temp___expr_6694)) (and (= (first3 temp___expr_6694) 1) (= (last3 temp___expr_6694) 1)))))
...
(define-fun register_byte_array__ref___119__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_6676 us_t2) (temp___is_init_6672 Bool) (temp___skip_constant_6673 Bool) (temp___do_toplevel_6674 Bool) (temp___do_typ_inv_6675 Bool)) Bool (=> (not (= temp___skip_constant_6673 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6676) (last5 temp___expr_6676)) (and (= (first5 temp___expr_6676) 1) (= (last5 temp___expr_6676) 1)))))
...
(declare-const temp___88551 t1)
(declare-const temp___8856 (Array Int bits_8))
(declare-const temp___88561 t2)
(define-fun temp___88552 () us_t1 (mk___t1 temp___8855 temp___88551))
...
(assert (and (= temp___88552 (register_to_bytes reg)) (dynamic_invariant temp___88552 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___88551)) (to_rep (last2 temp___88551))) (+ (- (to_rep (last2 temp___88551)) (to_rep (first2 temp___88551))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8855 temp___8856))
(assert (= (mk2 (to_rep (first2 temp___88551)) (to_rep (last2 temp___88551))) temp___88561))
(assert (not (= (ite (<= (to_rep (first4 temp___88561)) (to_rep (last4 temp___88561))) (+ (- (to_rep (last4 temp___88561)) (to_rep (first4 temp___88561))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
