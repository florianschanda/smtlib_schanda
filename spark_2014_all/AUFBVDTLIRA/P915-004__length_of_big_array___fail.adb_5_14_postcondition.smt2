...
(assert (= (ite (<= (bv2nat (to_rep (first4 temp___7201))) (bv2nat (to_rep (last5 temp___7201)))) (+ (- (bv2nat (to_rep (last5 temp___7201))) (bv2nat (to_rep (first4 temp___7201)))) 1) 0) (ite (<= (bv2nat #x0000000000000000) (bv2nat last2)) (+ (- (bv2nat last2) (bv2nat #x0000000000000000)) 1) 0)))
(assert (= temp___720 fail__create__r__assume))
(assert (= (mk1 (to_rep (first4 temp___7201)) (to_rep (last5 temp___7201))) fail__create__r__assume1))
(assert (= result r))
