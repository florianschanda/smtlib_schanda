...
(assert (= (ite (<= (bv2nat (to_rep (first4 temp___6311))) (bv2nat (to_rep (last5 temp___6311)))) (+ (- (bv2nat (to_rep (last5 temp___6311))) (bv2nat (to_rep (first4 temp___6311)))) 1) 0) (ite (<= (bv2nat ((_ int2bv 64) 0)) (bv2nat last2)) (+ (- (bv2nat last2) (bv2nat ((_ int2bv 64) 0))) 1) 0)))
(assert (= temp___631 fail__create__r__assume))
(assert (= (mk1 (to_rep (first4 temp___6311)) (to_rep (last5 temp___6311))) fail__create__r__assume1))
(assert (= result r))
...
(assert (and (dynamic_property2 ((_ int2bv 64) 0) last2 (to_rep r__first) (to_rep r__last)) (and (= (to_rep r__first) ((_ int2bv 64) 0)) (= (to_rep r__last) last2))))
