...
(assert (= (ite (<= (bv2nat (to_rep (first4 temp___6371))) (bv2nat (to_rep (last5 temp___6371)))) (+ (- (bv2nat (to_rep (last5 temp___6371))) (bv2nat (to_rep (first4 temp___6371)))) 1) 0) (ite (<= (bv2nat ((_ int2bv 64) 0)) (bv2nat last2)) (+ (- (bv2nat last2) (bv2nat ((_ int2bv 64) 0))) 1) 0)))
(assert (= temp___637 fail__create__r__assume))
(assert (= (mk1 (to_rep (first4 temp___6371)) (to_rep (last5 temp___6371))) fail__create__r__assume1))
(assert (= result r))
