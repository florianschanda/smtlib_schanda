...
(define-fun dynamic_invariant ((temp___expr_2999 us_t1) (temp___is_init_2996 Bool) (temp___skip_constant_2997 Bool) (temp___do_toplevel_2998 Bool)) Bool (=> (not (= temp___skip_constant_2997 true)) (and (dynamic_property2 1 2 (first3 temp___expr_2999) (last3 temp___expr_2999)) (and (= (first3 temp___expr_2999) 1) (= (last3 temp___expr_2999) 2)))))
