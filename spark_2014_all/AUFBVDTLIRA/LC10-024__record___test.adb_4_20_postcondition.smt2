...
(define-fun in_range2 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x04)))
...
(assert (forall ((x entry_id)) (! (= (of_rep2 (to_rep2 x)) x) :pattern ((to_rep2 x)))))
(assert (forall ((x entry_id)) (! (in_range2 (to_rep2 x)) :pattern ((to_rep2 x)))))
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x05))) (=> (in_range2 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
...
(define-fun bool_eq1 ((a us_rep) (b us_rep)) Bool (ite (and (and (= (to_rep1 (rec__test__t__remaining (us_split_fields1 a))) (to_rep1 (rec__test__t__remaining (us_split_fields1 b)))) (= (to_rep2 (rec__test__t__index (us_split_fields1 a))) (to_rep2 (rec__test__t__index (us_split_fields1 b))))) (= (bool_eq (rec__test__t__cards (us_split_fields1 a)) #x00 #x04 (rec__test__t__cards (us_split_fields1 b)) #x00 #x04) true)) true false))
...
(assert (forall ((s us_rep)) (! (= (get_remaining s) (to_rep1 (rec__test__t__remaining (us_split_fields1 s)))) :pattern ((get_remaining s)))))
(define-fun dynamic_invariant1 ((temp___expr_166 (_ BitVec 8)) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (or (= temp___is_init_162 true) (bvule #x00 #x04)) (in_range2 temp___expr_166)))
...
(define-fun dynamic_invariant2 ((temp___expr_159 Int) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool (=> (or (= temp___is_init_155 true) (<= 0 5)) (in_range1 temp___expr_159)))
...
(declare-const temp___216 length_type)
(declare-const temp___2161 entry_id)
(declare-const temp___2162 (Array (_ BitVec 8) integer))
...
(declare-const temp___219 length_type)
(declare-const temp___2191 entry_id)
(declare-const temp___2192 (Array (_ BitVec 8) integer))
