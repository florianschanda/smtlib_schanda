...
(declare-datatypes () ((payload_as_string_index__ref (mk_payload_as_string_index__ref (payload_as_string_index__content integer)))))
(define-fun payload_as_string_index__ref___projection ((a payload_as_string_index__ref)) integer (payload_as_string_index__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_243 Int) (temp___is_init_240 Bool) (temp___skip_constant_241 Bool) (temp___do_toplevel_242 Bool)) Bool (=> (or (= temp___is_init_240 true) (<= 1 last)) (dynamic_property 1 last temp___expr_243)))
(assert (= last (ite (<= (to_rep payload_as_bytes__first) (to_rep payload_as_bytes__last)) (+ (- (to_rep payload_as_bytes__last) (to_rep payload_as_bytes__first)) 1) 0)))
(declare-const o Int)
