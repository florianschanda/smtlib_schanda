...
(define-fun target__ref___10__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun dynamic_invariant ((temp___expr_3127 us_t1) (temp___is_init_3123 Bool) (temp___skip_constant_3124 Bool) (temp___do_toplevel_3125 Bool) (temp___do_typ_inv_3126 Bool)) Bool (=> (not (= temp___skip_constant_3124 true)) (and (dynamic_property2 1 5 (first3 temp___expr_3127) (last3 temp___expr_3127)) (and (= (first3 temp___expr_3127) 1) (= (last3 temp___expr_3127) 5)))))
...
(define-fun register_byte_array__ref___21__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_3074 us_t2) (temp___is_init_3070 Bool) (temp___skip_constant_3071 Bool) (temp___do_toplevel_3072 Bool) (temp___do_typ_inv_3073 Bool)) Bool (=> (not (= temp___skip_constant_3071 true)) (and (dynamic_property3 1 5 (first5 temp___expr_3074) (last5 temp___expr_3074)) (and (= (first5 temp___expr_3074) 1) (= (last5 temp___expr_3074) 5)))))
...
(declare-const temp___85291 t1)
(define-fun temp___85292 () us_t1 (mk___t1 temp___8529 temp___85291))
...
(assert (and (= temp___85292 (register_to_bytes reg)) (dynamic_invariant temp___85292 true false true true)))
(assert (not (= (ite (<= (to_rep (first2 temp___85291)) (to_rep (last2 temp___85291))) (+ (- (to_rep (last2 temp___85291)) (to_rep (first2 temp___85291))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0))))
(check-sat)
(exit)
