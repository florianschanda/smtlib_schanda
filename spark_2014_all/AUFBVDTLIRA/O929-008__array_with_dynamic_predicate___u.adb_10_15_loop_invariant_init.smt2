...
(define-fun dynamic_invariant2 ((temp___expr_202 us_t) (temp___is_init_199 Bool) (temp___skip_constant_200 Bool) (temp___do_toplevel_201 Bool)) Bool (and (=> (not (= temp___skip_constant_200 true)) (dynamic_property 0 2147483647 (first1 temp___expr_202) (last1 temp___expr_202))) (=> (= temp___do_toplevel_201 true) (=> (= temp___is_init_199 true) (= (first1 temp___expr_202) 0)))))
(define-fun dynamic_predicate ((temp___205 us_t)) Bool (= (first1 temp___205) 0))
(define-fun dynamic_invariant3 ((temp___expr_160 (_ BitVec 8)) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool true)
