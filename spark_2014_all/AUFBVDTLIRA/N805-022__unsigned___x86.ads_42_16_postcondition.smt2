...
(define-fun dynamic_invariant ((temp___expr_155 (_ BitVec 8)) (temp___is_init_152 Bool) (temp___skip_constant_153 Bool) (temp___do_toplevel_154 Bool)) Bool true)
(declare-const xsi (Array Int unsigned_8))
(declare-const x86__esi__result (_ BitVec 32))
(declare-const result (_ BitVec 32))
(declare-const x86__esi__result1 (_ BitVec 32))
(declare-const x86__esi__result2 (_ BitVec 32))
...
(assert (= result x86__esi__result))
(assert (= x86__esi__result1 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xsi 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xsi 3))) ((_ int2bv 32) 16777216)))))
(assert (= (mk_t__ref1 x86__esi__result4) (mk_t__ref1 x86__esi__result2)))
(assert (= x86__esi__result5 x86__esi__result3))
(assert (= result1 x86__esi__result4))
(assert (not (= x86__esi__result4 (bvadd (bvadd (bvadd ((_ zero_extend 24) (to_rep (select xsi 0))) (bvmul ((_ zero_extend 24) (to_rep (select xsi 1))) ((_ int2bv 32) 256))) (bvmul ((_ zero_extend 24) (to_rep (select xsi 2))) ((_ int2bv 32) 65536))) (bvmul ((_ zero_extend 24) (to_rep (select xsi 3))) ((_ int2bv 32) 16777216))))))
(check-sat)
(exit)
