...
(assert (= result__1 o8))
(assert (forall ((pos Int)) (=> (and (<= (to_rep result____first) pos) (<= pos i2)) (= (to_rep1 (select result__2 pos)) (xor2 (to_rep1 (select (elts left) pos)) (to_rep1 (select (elts right) pos)))))))
(assert (and (and (forall ((temp___322 Int)) (=> (and (<= (to_rep result____first) temp___322) (<= temp___322 (to_rep result____last))) (=> (< i2 temp___322) (= (select result__2 temp___322) (select result__ temp___322))))) (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i2))) (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))))
(assert (<= (to_rep result____first) i2))
(assert (not (<= 0 (to_rep result____first))))
(check-sat)
(exit)
