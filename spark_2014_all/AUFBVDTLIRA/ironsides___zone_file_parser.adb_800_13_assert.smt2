...
(assert (=> (and (= foundtype1 3) (and (< endidx1 256) (< numberofrecordtypes2 32))) (and (and (and (and (<= begidx4 endidx3) (<= begidx4 256)) (<= endidx3 256)) (=> (= foundtype3 1) (forall ((i Int)) (=> (and (<= begidx4 i) (<= i endidx3)) (and (<= 48 (to_rep (select rrstring i))) (<= (to_rep (select rrstring i)) 57)))))) (and (and (in_range3 begidx4) (in_range3 endidx3)) (in_range2 foundtype3)))))
