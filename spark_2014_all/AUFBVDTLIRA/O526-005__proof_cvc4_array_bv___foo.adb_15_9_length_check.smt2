...
(declare-fun concat1 ((Array (_ BitVec 64) byte_t) (_ BitVec 64) (_ BitVec 64) (Array (_ BitVec 64) byte_t) (_ BitVec 64) (_ BitVec 64)) (Array (_ BitVec 64) byte_t))
(assert (forall ((a (Array (_ BitVec 64) byte_t)) (b (Array (_ BitVec 64) byte_t))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (forall ((i (_ BitVec 64))) (! (and (=> (and (bvule a_first i) (bvule i a_last)) (= (select (concat1 a a_first a_last b b_first b_last) i) (select a i))) (=> (bvugt i a_last) (= (select (concat1 a a_first a_last b b_first b_last) i) (select b (bvadd (bvsub i a_last) (bvsub b_first #x0000000000000001)))))) :pattern ((select (concat1 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton1 (byte_t (_ BitVec 64)) (Array (_ BitVec 64) byte_t))
(assert (forall ((v byte_t)) (forall ((i (_ BitVec 64))) (! (= (select (singleton1 v i) i) v) :pattern ((select (singleton1 v i) i))))))
(define-fun bool_eq ((a (Array (_ BitVec 64) byte_t)) (a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b (Array (_ BitVec 64) byte_t)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep1 (select a temp___idx_132)) (to_rep1 (select b (bvadd (bvsub b__first a__first) temp___idx_132))))))) true false))
...
(declare-fun compare ((Array (_ BitVec 64) byte_t) (_ BitVec 64) (_ BitVec 64) (Array (_ BitVec 64) byte_t) (_ BitVec 64) (_ BitVec 64)) Int)
(assert (forall ((a (Array (_ BitVec 64) byte_t)) (b (Array (_ BitVec 64) byte_t))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (= (compare a a_first a_last b b_first b_last) 0) (= (bool_eq a a_first a_last b b_first b_last) true)) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 64) byte_t)) (b (Array (_ BitVec 64) byte_t))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (bvult (to_rep1 (select a (bvadd i #x0000000000000001))) (to_rep1 (select b (bvadd j #x0000000000000001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 64) byte_t)) (b (Array (_ BitVec 64) byte_t))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (bvugt (to_rep1 (select a (bvadd j #x0000000000000001))) (to_rep1 (select b (bvadd i #x0000000000000001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(declare-sort t 0)
...
(assert (forall ((temp___162 (_ BitVec 8))) (forall ((temp___163 (_ BitVec 64)) (temp___164 (_ BitVec 64))) (let ((temp___161 (temp___160 temp___162 temp___163 temp___164))) (and (=> (dynamic_property ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551615) temp___163 temp___164) (and (= (first3 temp___161) temp___163) (= (last3 temp___161) temp___164))) (forall ((temp___165 (_ BitVec 64))) (= (select (to_array1 temp___161) temp___165) (of_rep1 temp___162))))))))
(define-fun dynamic_invariant ((temp___expr_136 (_ BitVec 64)) (temp___is_init_133 Bool) (temp___skip_constant_134 Bool) (temp___do_toplevel_135 Bool)) Bool true)
(define-fun dynamic_invariant1 ((temp___expr_142 (_ BitVec 8)) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool true)
(define-fun dynamic_invariant2 ((temp___expr_148 us_t) (temp___is_init_145 Bool) (temp___skip_constant_146 Bool) (temp___do_toplevel_147 Bool)) Bool (=> (not (= temp___skip_constant_146 true)) (dynamic_property ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551615) (first1 temp___expr_148) (last1 temp___expr_148))))
...
(assert (dynamic_property ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551615) (to_rep x__first) (to_rep x__last)))
(assert (= (to_rep (first2 (rt1 (temp___160 ((_ int2bv 8) 0) (to_rep x__first) (to_rep x__last))))) (to_rep x__first)))
(assert (= (to_rep (last2 (rt1 (temp___160 ((_ int2bv 8) 0) (to_rep x__first) (to_rep x__last))))) (to_rep x__last)))
(assert (= (mk___t1 temp___167 temp___1671) (temp___160 ((_ int2bv 8) 0) (to_rep x__first) (to_rep x__last))))
(assert (= temp___167 temp___168))
(assert (= (mk (to_rep (first2 temp___1671)) (to_rep (last2 temp___1671))) temp___1681))
(assert (not (= (ite (<= (bv2nat (to_rep (first temp___1681))) (bv2nat (to_rep (last temp___1681)))) (+ (- (bv2nat (to_rep (last temp___1681))) (bv2nat (to_rep (first temp___1681)))) 1) 0) (ite (<= (bv2nat (to_rep x__first)) (bv2nat (to_rep x__last))) (+ (- (bv2nat (to_rep x__last)) (bv2nat (to_rep x__first))) 1) 0))))
(check-sat)
(exit)
