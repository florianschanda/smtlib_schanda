...
(assert (= (to_rep1 (first4 (rt2 (temp_____aggregate_def_1250 #x00 1 r118b)))) 1))
(assert (= (to_rep1 (last4 (rt2 (temp_____aggregate_def_1250 #x00 1 r118b)))) r118b))
(assert (= (mk___t2 temp___1257 temp___12571) (temp_____aggregate_def_1250 #x00 1 r118b)))
(assert (= (ite (<= (to_rep1 (first4 temp___12571)) (to_rep1 (last4 temp___12571))) (+ (- (to_rep1 (last4 temp___12571)) (to_rep1 (first4 temp___12571))) 1) 0) (ite (<= 1 r118b) (+ (- r118b 1) 1) 0)))
...
(assert (< distance 8))
(assert (not (<= (to_rep1 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i2)))
(check-sat)
(exit)
