...
(assert (= (ite (<= (to_rep (first2 temp___87881)) (to_rep (last2 temp___87881))) (+ (- (to_rep (last2 temp___87881)) (to_rep (first2 temp___87881))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8788 temp___8789))
(assert (= (mk2 (to_rep (first2 temp___87881)) (to_rep (last2 temp___87881))) temp___87891))
(assert (= (ite (<= (to_rep (first4 temp___87891)) (to_rep (last4 temp___87891))) (+ (- (to_rep (last4 temp___87891)) (to_rep (first4 temp___87891))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t2 o o1) (mk___t2 temp___8789 temp___87891)))
(assert (= o2 o))
