...
(define-fun dynamic_invariant ((temp___expr_4752 us_t1) (temp___is_init_4749 Bool) (temp___skip_constant_4750 Bool) (temp___do_toplevel_4751 Bool)) Bool (=> (not (= temp___skip_constant_4750 true)) (and (dynamic_property2 1 2 (first3 temp___expr_4752) (last3 temp___expr_4752)) (and (= (first3 temp___expr_4752) 1) (= (last3 temp___expr_4752) 2)))))
