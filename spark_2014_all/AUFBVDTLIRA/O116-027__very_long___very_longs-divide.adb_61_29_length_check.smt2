...
(assert (not (= (ite (<= (to_rep2 (first4 temp___11881)) (to_rep2 (last4 temp___11881))) (+ (- (to_rep2 (last4 temp___11881)) (to_rep2 (first4 temp___11881))) 1) 0) (ite (<= 1 r118b) (+ (- r118b 1) 1) 0))))
(check-sat)
(exit)
