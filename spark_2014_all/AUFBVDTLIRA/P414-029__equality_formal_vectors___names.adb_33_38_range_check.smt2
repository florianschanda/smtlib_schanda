...
(define-fun dynamic_invariant ((temp___expr_570 us_rep) (temp___is_init_567 Bool) (temp___skip_constant_568 Bool) (temp___do_toplevel_569 Bool)) Bool (=> (not (= temp___skip_constant_568 true)) (in_range1 128 temp___expr_570)))
(define-fun default_initial_assumption ((temp___expr_572 us_rep) (temp___skip_top_level_573 Bool)) Bool (and (= (to_rep (rec__names__entry_tables__vector__capacity (us_split_discrs1 temp___expr_572))) 128) (=> (not (= temp___skip_top_level_573 true)) (= (is_empty temp___expr_572) true))))
...
(define-fun bool_eq ((a (Array (_ BitVec 32) name_id)) (a__first (_ BitVec 32)) (a__last (_ BitVec 32)) (b (Array (_ BitVec 32) name_id)) (b__first (_ BitVec 32)) (b__last (_ BitVec 32))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 32))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep1 (select a temp___idx_132)) (to_rep1 (select b (bvadd (bvsub b__first a__first) temp___idx_132))))))) true false))
(assert (forall ((a (Array (_ BitVec 32) name_id)) (b (Array (_ BitVec 32) name_id))) (forall ((a__first (_ BitVec 32)) (a__last (_ BitVec 32)) (b__first (_ BitVec 32)) (b__last (_ BitVec 32))) (=> (= (bool_eq b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 32))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep1 (select a temp___idx_132)) (to_rep1 (select b (bvadd (bvsub b__first a__first) temp___idx_132)))))))))))
...
(assert (forall ((a (Array (_ BitVec 32) name_id)) (b (Array (_ BitVec 32) name_id))) (forall ((a_first (_ BitVec 32)) (a_last (_ BitVec 32)) (b_first (_ BitVec 32)) (b_last (_ BitVec 32))) (! (= (< (compare a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 32)) (j (_ BitVec 32))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (< (to_rep1 (select a (bvadd i #x00000001))) (to_rep1 (select b (bvadd j #x00000001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 32) name_id)) (b (Array (_ BitVec 32) name_id))) (forall ((a_first (_ BitVec 32)) (a_last (_ BitVec 32)) (b_first (_ BitVec 32)) (b_last (_ BitVec 32))) (! (= (< 0 (compare a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 32)) (j (_ BitVec 32))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (< (to_rep1 (select b (bvadd i #x00000001))) (to_rep1 (select a (bvadd j #x00000001))))))))))) :pattern ((compare a a_first a_last b b_first b_last))))))
...
(define-fun dynamic_invariant1 ((temp___expr_404 us_rep1) (temp___is_init_401 Bool) (temp___skip_constant_402 Bool) (temp___do_toplevel_403 Bool)) Bool (=> (not (= temp___skip_constant_402 true)) (in_range4 1024 temp___expr_404)))
(define-fun default_initial_assumption1 ((temp___expr_406 us_rep1) (temp___skip_top_level_407 Bool)) Bool (and (= (to_rep2 (rec__names__char_tables__vector__capacity (us_split_discrs3 temp___expr_406))) 1024) (=> (not (= temp___skip_top_level_407 true)) (= (is_empty1 temp___expr_406) true))))
(declare-fun names__hash_table__aggregate_def (Int) (Array (_ BitVec 32) name_id))
(assert (forall ((temp___601 Int)) (forall ((temp___602 (_ BitVec 32))) (= (select (names__hash_table__aggregate_def temp___601) temp___602) (of_rep1 temp___601)))))
(define-fun dynamic_invariant2 ((temp___expr_180 Int) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (or (= temp___is_init_177 true) (<= 0 2147483647)) (in_range2 temp___expr_180)))
(define-fun dynamic_invariant3 ((temp___expr_280 Int) (temp___is_init_277 Bool) (temp___skip_constant_278 Bool) (temp___do_toplevel_279 Bool)) Bool (=> (or (= temp___is_init_277 true) (<= 0 2147483647)) (in_range3 temp___expr_280)))
...
(define-fun capacity ((container us_rep1)) Int (ite (= (of_int 0) true) (to_rep2 (rec__names__char_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
...
(define-fun dynamic_invariant4 ((temp___expr_443 Int) (temp___is_init_440 Bool) (temp___skip_constant_441 Bool) (temp___do_toplevel_442 Bool)) Bool (=> (or (= temp___is_init_440 true) (<= 0 2147483647)) (in_range temp___expr_443)))
(define-fun capacity1 ((container us_rep)) Int (ite (= (of_int 0) true) (to_rep (rec__names__entry_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(assert (forall ((container us_rep)) (! (let ((result (length1 container))) (and (<= result (capacity1 container)) (dynamic_invariant4 result true false true))) :pattern ((length1 container)))))
