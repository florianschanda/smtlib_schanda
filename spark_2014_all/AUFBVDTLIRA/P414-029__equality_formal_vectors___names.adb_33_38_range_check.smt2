...
(assert (forall ((temp___664 Int)) (=> (dynamic_invariant2 temp___664 true true true true) (forall ((temp___665 (_ BitVec 32))) (= (to_rep1 (select (names__hash_table__aggregate_def temp___664) temp___665)) temp___664)))))
