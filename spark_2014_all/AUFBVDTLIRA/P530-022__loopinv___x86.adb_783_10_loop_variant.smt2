...
(declare-const temp___4221 (_ BitVec 64))
...
(assert (bvugt rcx1 #x0000000000000000))
(assert (= result temp___422))
(assert (= temp___4221 rcx1))
...
(assert (not (not (not (= rcx2 #x0000000000000000)))))
(assert (not (not (= zeroflag1 true))))
(assert (= result6 rsi))
(assert (= rsi1 (bvadd rsi #x0000000000000001)))
(assert (= result7 rdi))
(assert (= rdi1 (bvadd rdi #x0000000000000001)))
(assert (bvugt rcx2 #x0000000000000000))
(assert (not (bvult rcx2 temp___4221)))
(check-sat)
(exit)
