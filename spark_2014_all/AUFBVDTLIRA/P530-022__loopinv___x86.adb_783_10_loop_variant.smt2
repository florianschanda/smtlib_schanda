...
(assert (and (= o (readmem8 rsi1 memory)) (= o (to_rep (select memory rsi1)))))
(assert (= result1 val11))
(assert (= val12 o))
(assert (and (= o1 (readmem8 rdi1 memory)) (= o1 (to_rep (select memory rdi1)))))
(assert (= result2 val21))
(assert (= val22 o1))
...
(assert (= result6 rsi1))
(assert (= rsi2 (bvadd rsi1 ((_ int2bv 64) 1))))
(assert (= result7 rdi1))
(assert (= rdi2 (bvadd rdi1 ((_ int2bv 64) 1))))
(assert (bvugt rcx2 ((_ int2bv 64) 0)))
(assert (not (bvult rcx2 temp___3831)))
(check-sat)
(exit)
