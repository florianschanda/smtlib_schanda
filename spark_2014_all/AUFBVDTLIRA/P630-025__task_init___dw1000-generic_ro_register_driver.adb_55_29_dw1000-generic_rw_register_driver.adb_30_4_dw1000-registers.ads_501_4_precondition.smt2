...
(define-fun dynamic_invariant ((temp___expr_5998 us_t1) (temp___is_init_5995 Bool) (temp___skip_constant_5996 Bool) (temp___do_toplevel_5997 Bool)) Bool (=> (not (= temp___skip_constant_5996 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5998) (last3 temp___expr_5998)) (and (= (first3 temp___expr_5998) 1) (= (last3 temp___expr_5998) 1)))))
