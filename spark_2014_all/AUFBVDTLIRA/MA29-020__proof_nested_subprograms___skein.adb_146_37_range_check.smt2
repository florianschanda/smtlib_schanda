...
(declare-const temp___846 (Array (_ BitVec 64) byte))
...
(assert (=> (bvuge c29b #x0000000000000001) (=> (and (bvule #x0000000000000000 n6) (bvule n6 (bvsub c29b #x0000000000000001))) (= temp___846 hash2))))
