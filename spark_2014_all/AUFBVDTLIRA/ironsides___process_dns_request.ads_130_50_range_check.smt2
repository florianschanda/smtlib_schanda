...
(define-fun dynamic_invariant ((temp___expr_789 Int) (temp___is_init_785 Bool) (temp___skip_constant_786 Bool) (temp___do_toplevel_787 Bool) (temp___do_typ_inv_788 Bool)) Bool (=> (or (= temp___is_init_785 true) (<= 1 8180)) (in_range temp___expr_789)))
...
(declare-fun keylengthvaluetypeqtint (keylengthvaluetype) Int)
(assert (forall ((i keylengthvaluetype)) (and (<= 0 (keylengthvaluetypeqtint i)) (<= (keylengthvaluetypeqtint i) 1365))))
(define-fun in_range1 ((x Int)) Bool (and (<= 0 x) (<= x 1365)))
(declare-fun attr__ATTRIBUTE_IMAGE2 (Int) us_image)
(declare-fun attr__ATTRIBUTE_VALUE__pre_check2 (us_image) Bool)
(declare-fun attr__ATTRIBUTE_VALUE2 (us_image) Int)
(declare-fun user_eq2 (keylengthvaluetype keylengthvaluetype) Bool)
(declare-const dummy2 keylengthvaluetype)
...
(define-fun dynamic_invariant1 ((temp___expr_1252 Int) (temp___is_init_1248 Bool) (temp___skip_constant_1249 Bool) (temp___do_toplevel_1250 Bool) (temp___do_typ_inv_1251 Bool)) Bool (=> (or (= temp___is_init_1248 true) (<= 0 1365)) (in_range1 temp___expr_1252)))
(define-fun to_rep1 ((x keylengthvaluetype)) Int (keylengthvaluetypeqtint x))
(declare-fun of_rep1 (Int) keylengthvaluetype)
(assert (forall ((x keylengthvaluetype)) (! (= (of_rep1 (to_rep1 x)) x) :pattern ((to_rep1 x)))))
(assert (forall ((x keylengthvaluetype)) (! (in_range1 (to_rep1 x)) :pattern ((to_rep1 x)))))
...
(assert (forall ((x classtype)) (! (in_range2 (to_rep5 x)) :pattern ((to_rep5 x)))))
...
(assert (forall ((x character)) (! (in_range3 (to_rep6 x)) :pattern ((to_rep6 x)))))
(assert (forall ((x Int)) (! (=> (in_range3 x) (= (to_rep6 (of_rep6 x)) x)) :pattern ((to_rep6 (of_rep6 x))))))
...
(assert (forall ((a (Array Int character)) (b (Array Int character))) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (forall ((temp___idx_91 Int)) (=> (and (<= a__first temp___idx_91) (<= temp___idx_91 a__last)) (= (to_rep6 (select a temp___idx_91)) (to_rep6 (select b (+ (- b__first a__first) temp___idx_91)))))))))))
...
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (and (and (and (and (= (to_rep3 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__flags (us_split_fields3 a))) (to_rep3 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__flags (us_split_fields3 b)))) (= (to_rep2 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__protocol (us_split_fields3 a))) (to_rep2 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__protocol (us_split_fields3 b))))) (= (to_rep2 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__algorithm (us_split_fields3 a))) (to_rep2 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__algorithm (us_split_fields3 b))))) (= (bool_eq2 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__key (us_split_fields3 a)) 1 1365 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__key (us_split_fields3 b)) 1 1365) true)) (= (to_rep1 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__keylength (us_split_fields3 a))) (to_rep1 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__keylength (us_split_fields3 b))))) (= (to_rep4 (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 a))) (to_rep4 (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 b))))) (= (to_rep5 (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 a))) (to_rep5 (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 b))))) true false))
...
(define-fun default_initial_assumption ((temp___expr_1278 us_rep1) (temp___skip_top_level_1279 Bool)) Bool (= (attr__tag1 temp___expr_1278) us_tag1))
...
(define-fun dynamic_invariant4 ((temp___expr_942 (_ BitVec 8)) (temp___is_init_938 Bool) (temp___skip_constant_939 Bool) (temp___do_toplevel_940 Bool) (temp___do_typ_inv_941 Bool)) Bool true)
(define-fun dynamic_invariant5 ((temp___expr_949 (_ BitVec 16)) (temp___is_init_945 Bool) (temp___skip_constant_946 Bool) (temp___do_toplevel_947 Bool) (temp___do_typ_inv_948 Bool)) Bool true)
(define-fun dynamic_invariant6 ((temp___expr_956 (_ BitVec 32)) (temp___is_init_952 Bool) (temp___skip_constant_953 Bool) (temp___do_toplevel_954 Bool) (temp___do_typ_inv_955 Bool)) Bool true)
(define-fun dynamic_invariant7 ((temp___expr_963 Int) (temp___is_init_959 Bool) (temp___skip_constant_960 Bool) (temp___do_toplevel_961 Bool) (temp___do_typ_inv_962 Bool)) Bool (=> (or (= temp___is_init_959 true) (<= 0 3)) (in_range2 temp___expr_963)))
...
(assert (=> (<= 0 1365) (in_range1 dstbytes)))
(assert (not (in_range (to_rep1 (rec__rr_type__dnskey_record_type__dnskeyrecordtype__keylength (us_split_fields3 dnskey_record))))))
(check-sat)
(exit)
