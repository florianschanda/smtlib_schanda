...
(assert (= (ite (<= (bv2nat (to_rep (first4 temp___1671))) (bv2nat (to_rep (last4 temp___1671)))) (+ (- (bv2nat (to_rep (last4 temp___1671))) (bv2nat (to_rep (first4 temp___1671)))) 1) 0) (ite (<= (bv2nat ((_ int2bv 16) 0)) (bv2nat c)) (+ (- (bv2nat c) (bv2nat ((_ int2bv 16) 0))) 1) 0)))
(assert (= temp___167 bv_arrays__create__a__assume))
(assert (= (mk1 (to_rep (first4 temp___1671)) (to_rep (last4 temp___1671))) bv_arrays__create__a__assume1))
(assert (= result a))
...
(assert (and (dynamic_property2 ((_ int2bv 16) 0) c (to_rep a__first) (to_rep a__last)) (and (= (to_rep a__first) ((_ int2bv 16) 0)) (= (to_rep a__last) c))))
...
(assert (not (= (to_rep (first bv_arrays__create__result9)) ((_ int2bv 16) 0))))
(check-sat)
(exit)
