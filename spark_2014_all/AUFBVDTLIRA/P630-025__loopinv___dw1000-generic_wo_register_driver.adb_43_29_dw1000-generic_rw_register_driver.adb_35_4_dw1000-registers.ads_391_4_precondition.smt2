...
(define-fun dynamic_invariant ((temp___expr_5289 us_t1) (temp___is_init_5285 Bool) (temp___skip_constant_5286 Bool) (temp___do_toplevel_5287 Bool) (temp___do_typ_inv_5288 Bool)) Bool (=> (not (= temp___skip_constant_5286 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5289) (last3 temp___expr_5289)) (and (= (first3 temp___expr_5289) 1) (= (last3 temp___expr_5289) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_5307 us_t2) (temp___is_init_5303 Bool) (temp___skip_constant_5304 Bool) (temp___do_toplevel_5305 Bool) (temp___do_typ_inv_5306 Bool)) Bool (=> (not (= temp___skip_constant_5304 true)) (and (dynamic_property3 1 2 (first5 temp___expr_5307) (last5 temp___expr_5307)) (and (= (first5 temp___expr_5307) 1) (= (last5 temp___expr_5307) 2)))))
...
(declare-const temp___87141 t2)
(declare-const temp___8715 (Array Int bits_8))
(declare-const temp___87151 t1)
...
(define-fun temp___87142 () us_t2 (mk___t2 temp___8714 temp___87141))
...
(assert (and (= temp___87142 (register_to_bytes reg)) (dynamic_invariant1 temp___87142 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___87141)) (to_rep (last4 temp___87141))) (+ (- (to_rep (last4 temp___87141)) (to_rep (first4 temp___87141))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8714 temp___8715))
(assert (= (mk1 (to_rep (first4 temp___87141)) (to_rep (last4 temp___87141))) temp___87151))
(assert (= (ite (<= (to_rep (first2 temp___87151)) (to_rep (last2 temp___87151))) (+ (- (to_rep (last2 temp___87151)) (to_rep (first2 temp___87151))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8715 temp___87151)))
(assert (= o2 o))
