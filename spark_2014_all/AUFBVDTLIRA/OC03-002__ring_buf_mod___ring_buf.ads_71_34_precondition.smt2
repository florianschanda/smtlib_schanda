...
(assert (and (= o9 (func_head (to_model (mk___rep (mk___split_fields r__split_fields r__split_fields1 r__split_fields2))))) (and (in_range1 o9) (= o9 (to_rep (select (elts (to_model (mk___rep (mk___split_fields r__split_fields r__split_fields1 r__split_fields2)))) (to_rep1 (first (rt (to_model (mk___rep (mk___split_fields r__split_fields r__split_fields1 r__split_fields2))))))))))))
(assert (= o10 (ite (= element2 o9) true false)))
(assert (not (< 0 (length (to_model (mk___rep (mk___split_fields r__split_fields r__split_fields1 r__split_fields2)))))))
(check-sat)
(exit)
