...
(define-fun dynamic_invariant1 ((temp___expr_331 (_ BitVec 64)) (temp___is_init_327 Bool) (temp___skip_constant_328 Bool) (temp___do_toplevel_329 Bool) (temp___do_typ_inv_330 Bool)) Bool true)
(declare-fun create ((_ BitVec 64)) us_t)
(declare-fun create__function_guard (us_t (_ BitVec 64)) Bool)
(assert (forall ((last2 (_ BitVec 64))) (! (=> (dynamic_invariant1 last2 true true true true) (let ((result (create last2))) (and (and (= (last1 result) last2) (= (first1 result) #x0000000000000000)) (dynamic_invariant result true false true true)))) :pattern ((create last2)))))
...
(define-fun fail__c__assume2 () us_t (mk___t fail__c__assume fail__c__assume1))
(assert (and (= fail__c__assume2 (create #xFFFFFFFFFFFFFFFF)) (and (dynamic_invariant fail__c__assume2 true false true true) (and (= (to_rep (last fail__c__assume1)) #xFFFFFFFFFFFFFFFF) (= (to_rep (first fail__c__assume1)) #x0000000000000000)))))
(assert (= fail__c__assume2 c))
(assert (dynamic_invariant c true false true true))
(assert (not (= (to_rep (first (rt c))) #x0000000000000000)))
(check-sat)
(exit)
