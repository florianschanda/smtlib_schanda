...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__aon_addr_type__aon_addr bits_8)))))
(define-fun us_split_fields_AON_ADDR__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__aon_addr_type__aon_addr a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___70__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___70__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep1 (rec__dw1000__register_types__aon_addr_type__aon_addr (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__aon_addr_type__aon_addr (us_split_fields1 b)))) true false))
...
(declare-datatypes () ((aon_addr_type__ref (mk_aon_addr_type__ref (aon_addr_type__content us_rep)))))
(define-fun aon_addr_type__ref___projection ((a aon_addr_type__ref)) us_rep (aon_addr_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___169__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___119__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___119__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6071 us_t1) (temp___is_init_6068 Bool) (temp___skip_constant_6069 Bool) (temp___do_toplevel_6070 Bool)) Bool (=> (not (= temp___skip_constant_6069 true)) (and (dynamic_property2 1 1 (first3 temp___expr_6071) (last3 temp___expr_6071)) (and (= (first3 temp___expr_6071) 1) (= (last3 temp___expr_6071) 1)))))
(declare-sort t2 0)
...
(define-fun target__ref___51__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___51__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_6087 us_t2) (temp___is_init_6084 Bool) (temp___skip_constant_6085 Bool) (temp___do_toplevel_6086 Bool)) Bool (=> (not (= temp___skip_constant_6085 true)) (and (dynamic_property3 1 1 (first5 temp___expr_6087) (last5 temp___expr_6087)) (and (= (first5 temp___expr_6087) 1) (= (last5 temp___expr_6087) 1)))))
...
(declare-const temp___8083 (Array Int bits_8))
(declare-const temp___80831 t2)
(declare-const temp___8084 (Array Int bits_8))
(declare-const temp___80841 t1)
(define-fun temp___80832 () us_t2 (mk___t2 temp___8083 temp___80831))
...
(assert (and (= temp___80832 (register_to_bytes reg)) (dynamic_invariant1 temp___80832 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___80831)) (to_rep (last4 temp___80831))) (+ (- (to_rep (last4 temp___80831)) (to_rep (first4 temp___80831))) 1) 0) (ite (<= 1 1) (+ (- 1 1) 1) 0)))
(assert (= temp___8083 temp___8084))
(assert (= (mk1 (to_rep (first4 temp___80831)) (to_rep (last4 temp___80831))) temp___80841))
(assert (not (= (ite (<= (to_rep (first2 temp___80841)) (to_rep (last2 temp___80841))) (+ (- (to_rep (last2 temp___80841)) (to_rep (first2 temp___80841))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
