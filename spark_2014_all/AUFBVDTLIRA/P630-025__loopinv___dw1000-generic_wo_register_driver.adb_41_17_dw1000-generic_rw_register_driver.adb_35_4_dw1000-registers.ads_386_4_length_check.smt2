...
(assert (= (ite (<= (to_rep (first4 temp___79351)) (to_rep (last4 temp___79351))) (+ (- (to_rep (last4 temp___79351)) (to_rep (first4 temp___79351))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___7935 temp___7936))
(assert (= (mk1 (to_rep (first4 temp___79351)) (to_rep (last4 temp___79351))) temp___79361))
(assert (not (= (ite (<= (to_rep (first2 temp___79361)) (to_rep (last2 temp___79361))) (+ (- (to_rep (last2 temp___79361)) (to_rep (first2 temp___79361))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
