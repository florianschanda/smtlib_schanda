...
(assert (= (ite (<= (to_rep (first4 temp___87071)) (to_rep (last4 temp___87071))) (+ (- (to_rep (last4 temp___87071)) (to_rep (first4 temp___87071))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8707 temp___8708))
(assert (= (mk1 (to_rep (first4 temp___87071)) (to_rep (last4 temp___87071))) temp___87081))
(assert (not (= (ite (<= (to_rep (first2 temp___87081)) (to_rep (last2 temp___87081))) (+ (- (to_rep (last2 temp___87081)) (to_rep (first2 temp___87081))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
