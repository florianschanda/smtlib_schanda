...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__otp_srdat_type__otp_srdat bits_32)))))
(define-fun us_split_fields_OTP_SRDAT__projection ((a us_split_fields)) bits_32 (rec__dw1000__register_types__otp_srdat_type__otp_srdat a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___78__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___78__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__otp_srdat_type__otp_srdat (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__otp_srdat_type__otp_srdat (us_split_fields1 b)))) true false))
...
(declare-const dw1000__register_types__otp_srdat_type__otp_srdat__first__bit Int)
(declare-const dw1000__register_types__otp_srdat_type__otp_srdat__last__bit Int)
(declare-const dw1000__register_types__otp_srdat_type__otp_srdat__position Int)
(assert (<= 0 dw1000__register_types__otp_srdat_type__otp_srdat__first__bit))
(assert (< dw1000__register_types__otp_srdat_type__otp_srdat__first__bit dw1000__register_types__otp_srdat_type__otp_srdat__last__bit))
(assert (<= 0 dw1000__register_types__otp_srdat_type__otp_srdat__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((otp_srdat_type__ref (mk_otp_srdat_type__ref (otp_srdat_type__content us_rep)))))
(define-fun otp_srdat_type__ref___projection ((a otp_srdat_type__ref)) us_rep (otp_srdat_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___191__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___134__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___134__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_7222 us_t1) (temp___is_init_7218 Bool) (temp___skip_constant_7219 Bool) (temp___do_toplevel_7220 Bool) (temp___do_typ_inv_7221 Bool)) Bool (=> (not (= temp___skip_constant_7219 true)) (and (dynamic_property2 1 4 (first3 temp___expr_7222) (last3 temp___expr_7222)) (and (= (first3 temp___expr_7222) 1) (= (last3 temp___expr_7222) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___58__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___58__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_7240 us_t2) (temp___is_init_7236 Bool) (temp___skip_constant_7237 Bool) (temp___do_toplevel_7238 Bool) (temp___do_typ_inv_7239 Bool)) Bool (=> (not (= temp___skip_constant_7237 true)) (and (dynamic_property3 1 4 (first5 temp___expr_7240) (last5 temp___expr_7240)) (and (= (first5 temp___expr_7240) 1) (= (last5 temp___expr_7240) 4)))))
...
(declare-const temp___8906 (Array Int bits_8))
(declare-const temp___89061 t2)
(declare-const temp___8907 (Array Int bits_8))
(declare-const temp___89071 t1)
(define-fun temp___89062 () us_t2 (mk___t2 temp___8906 temp___89061))
...
(assert (and (= temp___89062 (register_to_bytes reg)) (dynamic_invariant1 temp___89062 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___89061)) (to_rep (last4 temp___89061))) (+ (- (to_rep (last4 temp___89061)) (to_rep (first4 temp___89061))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8906 temp___8907))
(assert (= (mk1 (to_rep (first4 temp___89061)) (to_rep (last4 temp___89061))) temp___89071))
(assert (not (= (ite (<= (to_rep (first2 temp___89071)) (to_rep (last2 temp___89071))) (+ (- (to_rep (last2 temp___89071)) (to_rep (first2 temp___89071))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
