...
(define-fun dynamic_invariant ((temp___expr_6566 us_t1) (temp___is_init_6563 Bool) (temp___skip_constant_6564 Bool) (temp___do_toplevel_6565 Bool)) Bool (=> (not (= temp___skip_constant_6564 true)) (and (dynamic_property2 1 4 (first3 temp___expr_6566) (last3 temp___expr_6566)) (and (= (first3 temp___expr_6566) 1) (= (last3 temp___expr_6566) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_6582 us_t2) (temp___is_init_6579 Bool) (temp___skip_constant_6580 Bool) (temp___do_toplevel_6581 Bool)) Bool (=> (not (= temp___skip_constant_6580 true)) (and (dynamic_property3 1 4 (first5 temp___expr_6582) (last5 temp___expr_6582)) (and (= (first5 temp___expr_6582) 1) (= (last5 temp___expr_6582) 4)))))
...
(declare-const temp___8134 (Array Int bits_8))
(declare-const temp___81341 t2)
(declare-const temp___8135 (Array Int bits_8))
(declare-const temp___81351 t1)
...
(assert (and (= (mk___t2 temp___8134 temp___81341) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8134 temp___81341) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___81341)) (to_rep (last4 temp___81341))) (+ (- (to_rep (last4 temp___81341)) (to_rep (first4 temp___81341))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8134 temp___8135))
(assert (= (mk1 (to_rep (first4 temp___81341)) (to_rep (last4 temp___81341))) temp___81351))
(assert (not (= (ite (<= (to_rep (first2 temp___81351)) (to_rep (last2 temp___81351))) (+ (- (to_rep (last2 temp___81351)) (to_rep (first2 temp___81351))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
