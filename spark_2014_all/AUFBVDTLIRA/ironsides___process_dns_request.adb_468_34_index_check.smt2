...
(declare-datatypes () ((us_split_fields2 (mk___split_fields1 (rec__rr_type__ptr_record_type__ptrrecordtype__domainname (Array Int character)) (rec__rr_type__resourcerecordtype__ttlinseconds1 unsigned32) (rec__rr_type__resourcerecordtype__class1 classtype) (rec__ext__1 us_private)))))
(define-fun us_split_fields_DomainName__projection ((a us_split_fields2)) (Array Int character) (rec__rr_type__ptr_record_type__ptrrecordtype__domainname a))
(define-fun us_split_fields_TTLInSeconds__9__projection ((a us_split_fields2)) unsigned32 (rec__rr_type__resourcerecordtype__ttlinseconds1 a))
(define-fun us_split_fields_Class__9__projection ((a us_split_fields2)) classtype (rec__rr_type__resourcerecordtype__class1 a))
(define-fun us_split_fields___10__projection ((a us_split_fields2)) us_private (rec__ext__1 a))
...
(define-fun us_rep___23__projection ((a us_rep1)) us_split_fields2 (us_split_fields3 a))
(define-fun us_rep___24__projection ((a us_rep1)) Int (attr__tag1 a))
(declare-fun hide_ext__ ((Array Int character) us_private) us_private)
(declare-fun extract__domainname (us_private) (Array Int character))
(assert (forall ((domainname (Array Int character))) (forall ((rec__ext__2 us_private)) (= (extract__domainname (hide_ext__ domainname rec__ext__2)) domainname))))
(declare-fun extract__ext__ (us_private) us_private)
(define-fun to_base ((a us_rep1)) us_rep (mk___rep (mk___split_fields (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 a)) (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 a)) (hide_ext__ (rec__rr_type__ptr_record_type__ptrrecordtype__domainname (us_split_fields3 a)) (rec__ext__1 (us_split_fields3 a)))) (attr__tag1 a)))
(define-fun of_base ((r us_rep)) us_rep1 (mk___rep1 (mk___split_fields1 (extract__domainname (rec__ext__ (us_split_fields1 r))) (rec__rr_type__resourcerecordtype__ttlinseconds (us_split_fields1 r)) (rec__rr_type__resourcerecordtype__class (us_split_fields1 r)) (extract__ext__ (rec__ext__ (us_split_fields1 r)))) (attr__tag r)))
(define-fun bool_eq3 ((a us_rep1) (b us_rep1)) Bool (ite (and (and (= (bool_eq (rec__rr_type__ptr_record_type__ptrrecordtype__domainname (us_split_fields3 a)) 1 129 (rec__rr_type__ptr_record_type__ptrrecordtype__domainname (us_split_fields3 b)) 1 129) true) (= (to_rep2 (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 a))) (to_rep2 (rec__rr_type__resourcerecordtype__ttlinseconds1 (us_split_fields3 b))))) (= (to_rep3 (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 a))) (to_rep3 (rec__rr_type__resourcerecordtype__class1 (us_split_fields3 b))))) true false))
...
(declare-const rr_type__ptr_record_type__ptrrecordtype__domainname__first__bit Int)
(declare-const rr_type__ptr_record_type__ptrrecordtype__domainname__last__bit Int)
(declare-const rr_type__ptr_record_type__ptrrecordtype__domainname__position Int)
(assert (<= 0 rr_type__ptr_record_type__ptrrecordtype__domainname__first__bit))
(assert (< rr_type__ptr_record_type__ptrrecordtype__domainname__first__bit rr_type__ptr_record_type__ptrrecordtype__domainname__last__bit))
(assert (<= 0 rr_type__ptr_record_type__ptrrecordtype__domainname__position))
...
(declare-datatypes () ((ptrrecordtype__ref (mk_ptrrecordtype__ref (ptrrecordtype__content us_rep1)))))
(define-fun ptrrecordtype__ref___projection ((a ptrrecordtype__ref)) us_rep1 (ptrrecordtype__content a))
(define-fun default_initial_assumption ((temp___expr_1662 us_rep1) (temp___skip_top_level_1663 Bool)) Bool (= (attr__tag1 temp___expr_1662) us_tag1))
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const start_byte Int)
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(declare-const ptr_record us_rep1)
...
(assert (forall ((x integer)) (! (in_range5 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun dynamic_invariant5 ((temp___expr_963 (_ BitVec 32)) (temp___is_init_959 Bool) (temp___skip_constant_960 Bool) (temp___do_toplevel_961 Bool) (temp___do_typ_inv_962 Bool)) Bool true)
(define-fun dynamic_invariant6 ((temp___expr_970 Int) (temp___is_init_966 Bool) (temp___skip_constant_967 Bool) (temp___do_toplevel_968 Bool) (temp___do_typ_inv_969 Bool)) Bool (=> (or (= temp___is_init_966 true) (<= 0 3)) (in_range4 temp___expr_970)))
...
(assert (and (and (<= 0 current_name_length) (<= current_name_length 129)) (<= start_byte (- 8174 current_name_length))))
(assert (and (= o (+ start_byte 4)) (in_range2 (+ start_byte 4))))
(assert (= result i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 current_name_length))
(assert (and (and (<= start_byte (- 8174 current_name_length)) (<= 1 i2)) (<= i2 129)))
(assert (and (=> (<= 1 current_name_length) (dynamic_property 1 current_name_length i2)) (and (<= 1 i2) (<= i2 current_name_length))))
(assert (and (= o1 (to_rep (select (rec__rr_type__ptr_record_type__ptrrecordtype__domainname (us_split_fields3 ptr_record)) i2))) (uint_in_range (to_rep (select (rec__rr_type__ptr_record_type__ptrrecordtype__domainname (us_split_fields3 ptr_record)) i2)))))
(assert (= o2 ((_ int2bv 8) o1)))
(assert (= (to_rep1 o3) o2))
(assert (not (<= 1 (+ (+ start_byte 5) i2))))
(check-sat)
(exit)
