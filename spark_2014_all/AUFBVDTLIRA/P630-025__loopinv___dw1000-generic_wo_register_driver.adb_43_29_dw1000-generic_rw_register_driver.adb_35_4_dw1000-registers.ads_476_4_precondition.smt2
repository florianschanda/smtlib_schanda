...
(assert (= (ite (<= (to_rep (first4 temp___88131)) (to_rep (last4 temp___88131))) (+ (- (to_rep (last4 temp___88131)) (to_rep (first4 temp___88131))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8813 temp___8814))
(assert (= (mk1 (to_rep (first4 temp___88131)) (to_rep (last4 temp___88131))) temp___88141))
(assert (= (ite (<= (to_rep (first2 temp___88141)) (to_rep (last2 temp___88141))) (+ (- (to_rep (last2 temp___88141)) (to_rep (first2 temp___88141))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8814 temp___88141)))
(assert (= o2 o))
