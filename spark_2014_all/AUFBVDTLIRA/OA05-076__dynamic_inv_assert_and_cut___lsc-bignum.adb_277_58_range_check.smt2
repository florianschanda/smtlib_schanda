...
(assert (and (= o29 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o30 (ite (<= k o29) true false)))
(assert (= result1 (ite (<= i2 k) o30 false)))
(assert (= (= o31 true) (forall ((k1 Int)) (=> (and (<= i2 k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a1 k1)) (to_rep1 (select a k1)))))))
(assert (= o24 (from_word32 carry21)))
(assert (and (= o23 (base Tuple0)) (= o23 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o25 (omultiply o23 o24)))
(assert (= o22 (from_word32 carry11)))
(assert (= o26 (oadd o22 o25)))
(assert (and (= o19 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o20 o19) (in_range2 o19)))
(assert (and (= o18 (base Tuple0)) (= o18 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o21 (oexpon o18 o20)))
(assert (= o27 (omultiply o21 o26)))
(assert (and (= o15 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o16 o15) (in_range2 o15)))
(assert (= o17 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first o16)))
(assert (= o28 (oadd o17 o27)))
(assert (= o13 (from_word32 carry2)))
(assert (and (= o12 (base Tuple0)) (= o12 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o14 (omultiply o12 o13)))
(assert (= o11 (from_word32 carry1)))
(assert (= o9 (from_word32 y)))
(assert (and (= o6 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o7 o6) (in_range2 o6)))
(assert (= o8 (num_of_big_int c c_first o7)))
(assert (= o10 (omultiply o8 o9)))
(assert (= o4 (from_word32 x)))
(assert (and (= o1 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o2 o1) (in_range2 o1)))
(assert (= o3 (num_of_big_int b b_first o2)))
(assert (= o5 (omultiply o3 o4)))
