...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (and (= (oeq (oadd (oadd (oadd (oadd (num_of_big_int (mk___t a (mk (to_rep a__first) (to_rep a__last))) (+ a_first 1) (- i2 a_first)) (omultiply (num_of_big_int b b_first (- i2 a_first)) (from_word32 x))) (omultiply (num_of_big_int c c_first (- i2 a_first)) (from_word32 y))) (from_word32 carry1)) (omultiply (base Tuple0) (from_word32 carry2))) (oadd (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first (- i2 a_first)) (omultiply (oexpon (base Tuple0) (- i2 a_first)) (oadd (from_word32 carry12) (omultiply (base Tuple0) (from_word32 carry22)))))) true) (forall ((k2 Int)) (=> (and (<= i2 k2) (<= k2 (+ a_last 1))) (= (to_rep1 (select a2 k2)) (to_rep1 (select a k2)))))))
(assert (and (and (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2)) (forall ((temp___739 Int)) (=> (and (<= (to_rep a__first) temp___739) (<= temp___739 (to_rep a__last))) (=> (<= i2 temp___739) (= (select a2 temp___739) (select a temp___739)))))) (and (<= a_first i2) (<= i2 a_last))))
(assert (and (= o52 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o53 (ite (<= k o52) true false)))
(assert (= result1 (ite (<= i2 k) o53 false)))
(assert (= (= o57 true) (forall ((k2 Int)) (=> (and (<= i2 k2) (<= k2 (+ a_last 1))) (= (to_rep1 (select a2 k2)) (to_rep1 (select a k2)))))))
(assert (= o47 (from_word32 carry22)))
(assert (and (= o46 (base Tuple0)) (= o46 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o48 (omultiply o46 o47)))
(assert (= o45 (from_word32 carry12)))
(assert (= o49 (oadd o45 o48)))
(assert (and (= o42 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o43 o42) (in_range2 o42)))
(assert (and (= o41 (base Tuple0)) (= o41 (oexpon (from_word32 ((_ int2bv 32) 2)) 32))))
(assert (= o44 (oexpon o41 o43)))
(assert (= o50 (omultiply o44 o49)))
(assert (and (= o38 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o39 o38) (in_range2 o38)))
(assert (= o40 (num_of_big_int (mk___t a2 (mk (to_rep a__first) (to_rep a__last))) a_first o39)))
(assert (= o51 (oadd o40 o50)))
...
(assert (and (= o29 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o30 o29) (in_range2 o29)))
(assert (= o31 (num_of_big_int c c_first o30)))
(assert (= o33 (omultiply o31 o32)))
(assert (= o27 (from_word32 x)))
(assert (and (= o24 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o25 o24) (in_range2 o24)))
(assert (= o26 (num_of_big_int b b_first o25)))
(assert (= o28 (omultiply o26 o27)))
(assert (and (= o22 (- i2 a_first)) (in_range1 (- i2 a_first))))
