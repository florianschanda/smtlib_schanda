...
(define-fun dynamic_invariant ((temp___expr_3215 us_t1) (temp___is_init_3212 Bool) (temp___skip_constant_3213 Bool) (temp___do_toplevel_3214 Bool)) Bool (=> (not (= temp___skip_constant_3213 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3215) (last3 temp___expr_3215)) (and (= (first3 temp___expr_3215) 1) (= (last3 temp___expr_3215) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_3234 us_t2) (temp___is_init_3231 Bool) (temp___skip_constant_3232 Bool) (temp___do_toplevel_3233 Bool)) Bool (=> (not (= temp___skip_constant_3232 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3234) (last5 temp___expr_3234)) (and (= (first5 temp___expr_3234) 1) (= (last5 temp___expr_3234) 4)))))
...
(assert (and (= temp___78002 (register_to_bytes reg)) (dynamic_invariant1 temp___78002 true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___78001)) (to_rep (last4 temp___78001))) (+ (- (to_rep (last4 temp___78001)) (to_rep (first4 temp___78001))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
