...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__tx_power_type__boostnorm bits_8) (rec__dw1000__register_types__tx_power_type__boostp500 bits_8) (rec__dw1000__register_types__tx_power_type__boostp250 bits_8) (rec__dw1000__register_types__tx_power_type__boostp125 bits_8)))))
(define-fun us_split_fields_BOOSTNORM__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__tx_power_type__boostnorm a))
(define-fun us_split_fields_BOOSTP500__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__tx_power_type__boostp500 a))
(define-fun us_split_fields_BOOSTP250__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__tx_power_type__boostp250 a))
(define-fun us_split_fields_BOOSTP125__projection ((a us_split_fields)) bits_8 (rec__dw1000__register_types__tx_power_type__boostp125 a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___23__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___23__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (and (and (and (= (to_rep1 (rec__dw1000__register_types__tx_power_type__boostnorm (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tx_power_type__boostnorm (us_split_fields1 b)))) (= (to_rep1 (rec__dw1000__register_types__tx_power_type__boostp500 (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tx_power_type__boostp500 (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__tx_power_type__boostp250 (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tx_power_type__boostp250 (us_split_fields1 b))))) (= (to_rep1 (rec__dw1000__register_types__tx_power_type__boostp125 (us_split_fields1 a))) (to_rep1 (rec__dw1000__register_types__tx_power_type__boostp125 (us_split_fields1 b))))) true false))
...
(assert (<= 0 dw1000__register_types__tx_power_type__boostnorm__first__bit))
(assert (< dw1000__register_types__tx_power_type__boostnorm__first__bit dw1000__register_types__tx_power_type__boostnorm__last__bit))
...
(assert (<= 0 dw1000__register_types__tx_power_type__boostp500__first__bit))
(assert (< dw1000__register_types__tx_power_type__boostp500__first__bit dw1000__register_types__tx_power_type__boostp500__last__bit))
...
(assert (<= 0 dw1000__register_types__tx_power_type__boostp250__first__bit))
(assert (< dw1000__register_types__tx_power_type__boostp250__first__bit dw1000__register_types__tx_power_type__boostp250__last__bit))
...
(assert (<= 0 dw1000__register_types__tx_power_type__boostp125__first__bit))
(assert (< dw1000__register_types__tx_power_type__boostp125__first__bit dw1000__register_types__tx_power_type__boostp125__last__bit))
(assert (<= 0 dw1000__register_types__tx_power_type__boostp125__position))
(declare-fun user_eq4 (us_rep us_rep) Bool)
(declare-const dummy4 us_rep)
(declare-datatypes () ((tx_power_type__ref (mk_tx_power_type__ref (tx_power_type__content us_rep)))))
(define-fun tx_power_type__ref___projection ((a tx_power_type__ref)) us_rep (tx_power_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___49__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___36__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___36__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3543 us_t1) (temp___is_init_3539 Bool) (temp___skip_constant_3540 Bool) (temp___do_toplevel_3541 Bool) (temp___do_typ_inv_3542 Bool)) Bool (=> (not (= temp___skip_constant_3540 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3543) (last3 temp___expr_3543)) (and (= (first3 temp___expr_3543) 1) (= (last3 temp___expr_3543) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___14__projection ((a target__ref)) us_t2 (target__content a))
(declare-datatypes () ((source__ref (mk_source__ref (source__content us_rep)))))
(define-fun source__ref___14__projection ((a source__ref)) us_rep (source__content a))
(define-fun dynamic_invariant1 ((temp___expr_3564 us_t2) (temp___is_init_3560 Bool) (temp___skip_constant_3561 Bool) (temp___do_toplevel_3562 Bool) (temp___do_typ_inv_3563 Bool)) Bool (=> (not (= temp___skip_constant_3561 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3564) (last5 temp___expr_3564)) (and (= (first5 temp___expr_3564) 1) (= (last5 temp___expr_3564) 4)))))
...
(declare-const temp___8572 (Array Int bits_8))
(declare-const temp___85721 t2)
(define-fun temp___85722 () us_t2 (mk___t2 temp___8572 temp___85721))
...
(assert (and (= temp___85722 (register_to_bytes reg)) (dynamic_invariant1 temp___85722 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___85721)) (to_rep (last4 temp___85721))) (+ (- (to_rep (last4 temp___85721)) (to_rep (first4 temp___85721))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
