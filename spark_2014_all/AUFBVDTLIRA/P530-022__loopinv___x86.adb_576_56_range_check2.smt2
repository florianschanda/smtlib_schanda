...
(assert (and (= (to_rep (select memory2 (bvadd addr #x0000000000000001))) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 8)) #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000001))) (= (to_rep (select memory2 i)) (to_rep (select memory1 i))))))))
(assert (and (= (to_rep (select memory3 (bvadd addr #x0000000000000002))) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 16)) #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000002))) (= (to_rep (select memory3 i)) (to_rep (select memory2 i))))))))
(assert (and (= (to_rep (select memory4 (bvadd addr #x0000000000000003))) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 24)) #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000003))) (= (to_rep (select memory4 i)) (to_rep (select memory3 i))))))))
(assert (and (= (to_rep (select memory5 (bvadd addr #x0000000000000004))) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 32)) #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000004))) (= (to_rep (select memory5 i)) (to_rep (select memory4 i))))))))
(assert (and (= (to_rep (select memory6 (bvadd addr #x0000000000000005))) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 40)) #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000005))) (= (to_rep (select memory6 i)) (to_rep (select memory5 i))))))))
(assert (and (= (to_rep (select memory7 (bvadd addr #x0000000000000006))) ((_ extract 7 0) (bvand (bvlshr val__ ((_ int2bv 64) 48)) #x00000000000000FF))) (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (not (= i (bvadd addr #x0000000000000006))) (= (to_rep (select memory7 i)) (to_rep (select memory6 i))))))))
