...
(assert (and (=> (<= r83b r84b) (dynamic_property r83b r84b i6)) (and (<= r83b i6) (<= i6 r84b))))
(assert (= result9 (mk_t__ref digitval2)))
(assert (= digitval3 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i6))) ((_ int2bv 16) 48))))
...
(assert (not (= i6 r84b)))
(assert (= result11 (mk_int__ref i6)))
(assert (= i7 (+ i6 1)))
