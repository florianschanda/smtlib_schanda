...
(declare-const i Int)
(declare-const temp___290 (Array Int word32))
...
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= temp___290 result__)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= temp___288 i1)))
...
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (and (and (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i2)) (forall ((temp___291 Int)) (=> (and (<= (to_rep result____first) temp___291) (<= temp___291 (to_rep result____last))) (=> (< i2 temp___291) (= (select result__3 temp___291) (select temp___290 temp___291)))))) (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))))))
