...
(define-fun dynamic_invariant ((temp___expr_250 us_t) (temp___is_init_246 Bool) (temp___skip_constant_247 Bool) (temp___do_toplevel_248 Bool) (temp___do_typ_inv_249 Bool)) Bool (=> (not (= temp___skip_constant_247 true)) (dynamic_property 0 79 (first1 temp___expr_250) (last1 temp___expr_250))))
...
(assert (forall ((v0 (_ BitVec 32)) (v1 (_ BitVec 32))) (! (=> (and (dynamic_invariant1 v0 true true true true) (dynamic_invariant1 v1 true true true true)) (let ((result (xor2 v0 v1))) (and (= result (bvxor v0 v1)) (dynamic_invariant1 result true false true true)))) :pattern ((xor2 v0 v1)))))
...
(declare-const i Int)
(declare-const temp___332 (Array Int word32))
(declare-const temp___330 Int)
(declare-const o Int)
...
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= temp___332 result__)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= temp___330 i1)))
...
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (and (and (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i2)) (forall ((temp___333 Int)) (=> (and (<= (to_rep result____first) temp___333) (<= temp___333 (to_rep result____last))) (=> (< i2 temp___333) (= (select result__3 temp___333) (select temp___332 temp___333)))))) (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))))))
