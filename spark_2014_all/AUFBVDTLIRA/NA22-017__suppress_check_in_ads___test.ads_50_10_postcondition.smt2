...
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (and (and (= temp___290 result__) (and (= temp___288 i2) (and (and (and (and (and (and (and (and (and (<= (to_rep (first (rt right))) i2) (<= i2 (to_rep (last (rt right))))) (= o3 i2)) (= o4 (select (elts right) o3))) (= o5 (to_rep1 o4))) (and (and (and (and (and (<= (to_rep (first (rt left))) i2) (<= i2 (to_rep (last (rt left))))) (= o i2)) (= o1 (select (elts left) o))) (= o2 (to_rep1 o1))) (and (= o6 (xor2 o2 o5)) (= o6 (bvxor o2 o5))))) (= (to_rep1 o7) o6)) (= o8 (store result__ i2 o7))) (and (= (mk_map__ref result1) (mk_map__ref result__)) (= result__2 o8))) (and (forall ((pos1 Int)) (=> (and (<= (to_rep result____first) pos1) (<= pos1 i3)) (= (to_rep1 (select result__3 pos1)) (xor2 (to_rep1 (select (elts left) pos1)) (to_rep1 (select (elts right) pos1)))))) (and (and (and (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i3)) (forall ((temp___291 Int)) (=> (and (<= (to_rep result____first) temp___291) (<= temp___291 (to_rep result____last))) (=> (< i3 temp___291) (= (select result__3 temp___291) (select temp___290 temp___291)))))) (and (<= (to_rep result____first) i3) (<= i3 (to_rep result____last)))) (= i3 (to_rep result____last))))))) (and (and (= i3 i7) (= result__3 result__7)) (and (= i8 i3) (= result__8 result__3))))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= (mk_int__ref i9) (mk_int__ref i7))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= (mk_map__ref result__9) (mk_map__ref result__7))))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= i10 i8)))
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (= result__10 result__8)))
(assert (=> (not (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))) (= i2 i9)))
(assert (=> (not (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))) (= (mk_map__ref result__9) (mk_map__ref result__))))
(assert (=> (not (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))) (= i10 i2)))
(assert (=> (not (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last)))) (= result__10 result__1)))
(assert (= (mk_int__ref i11) (mk_int__ref i9)))
(assert (= (mk_map__ref result__11) (mk_map__ref result__9)))
(assert (= i12 i10))
(assert (= result__12 result__10))
(declare-const i13 Int)
(assert (<= (to_rep (first (rt left))) i13))
(assert (<= i13 (to_rep (last (rt left)))))
(assert (not (= (to_rep1 (select result__11 i13)) (xor2 (to_rep1 (select (elts left) i13)) (to_rep1 (select (elts right) i13))))))
(check-sat)
(exit)
