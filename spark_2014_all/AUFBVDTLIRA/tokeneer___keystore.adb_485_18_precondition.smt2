...
(define-fun dynamic_invariant ((temp___expr_259 Int) (temp___is_init_256 Bool) (temp___skip_constant_257 Bool) (temp___do_toplevel_258 Bool)) Bool (=> (or (= temp___is_init_256 true) (<= 0 4294967295)) (in_range4 temp___expr_259)))
...
(define-fun in_range7 ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 0) x) (bvule x ((_ int2bv 32) 15))))
...
(assert (forall ((x maskt)) (! (in_range7 (to_rep5 x)) :pattern ((to_rep5 x)))))
(assert (forall ((x (_ BitVec 32))) (! (let ((y (bvurem x ((_ int2bv 32) 16)))) (=> (in_range7 y) (= (to_rep5 (of_rep5 x)) y))) :pattern ((to_rep5 (of_rep5 x))))))
...
(assert (forall ((us_void_param tuple0)) (! (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (to_rep (select (temp___String_Literal_1326 us_void_param) 1)) 67) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 2)) 114)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 3)) 121)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 4)) 112)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 5)) 116)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 6)) 111)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 7)) 32)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 8)) 76)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 9)) 105)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 10)) 98)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 11)) 114)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 12)) 97)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 13)) 114)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 14)) 121)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 15)) 32)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 16)) 69)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 17)) 114)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 18)) 114)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 19)) 111)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 20)) 114)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 21)) 32)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 22)) 58)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 23)) 32)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 24)) 76)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 25)) 105)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 26)) 98)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 27)) 114)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 28)) 97)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 29)) 114)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 30)) 121)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 31)) 32)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 32)) 104)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 33)) 111)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 34)) 108)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 35)) 100)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 36)) 115)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 37)) 32)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 38)) 109)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 39)) 111)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 40)) 114)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 41)) 101)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 42)) 32)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 43)) 116)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 44)) 104)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 45)) 97)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 46)) 110)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 47)) 32)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 48)) 111)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 49)) 110)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 50)) 101)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 51)) 32)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 52)) 112)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 53)) 114)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 54)) 105)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 55)) 118)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 56)) 97)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 57)) 116)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 58)) 101)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 59)) 32)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 60)) 107)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 61)) 101)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 62)) 121)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 63)) 32)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 64)) 102)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 65)) 111)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 66)) 114)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 67)) 32)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 68)) 116)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 69)) 104)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 70)) 105)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 71)) 115)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 72)) 32)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 73)) 84)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 74)) 73)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 75)) 83)) (= (to_rep (select (temp___String_Literal_1326 us_void_param) 76)) 46)) :pattern ((temp___String_Literal_1326 us_void_param)))))
...
(define-fun dynamic_invariant5 ((temp___expr_703 Int) (temp___is_init_700 Bool) (temp___skip_constant_701 Bool) (temp___do_toplevel_702 Bool)) Bool (=> (or (= temp___is_init_700 true) (<= 0 40)) (in_range5 temp___expr_703)))
...
(define-fun dynamic_invariant6 ((temp___expr_724 Int) (temp___is_init_721 Bool) (temp___skip_constant_722 Bool) (temp___do_toplevel_723 Bool)) Bool (=> (or (= temp___is_init_721 true) (<= 0 4294967295)) (in_range6 temp___expr_724)))
(assert (= nullissuer (mk___rep (mk___split_fields (of_rep4 0) (of_rep3 0) blankname))))
(assert (= nouser (temp___String_Literal_135 Tuple0)))
(assert true)
(define-fun dynamic_invariant7 ((temp___expr_979 (_ BitVec 32)) (temp___is_init_976 Bool) (temp___skip_constant_977 Bool) (temp___do_toplevel_978 Bool)) Bool (=> (or (= temp___is_init_976 true) (bvule ((_ int2bv 32) 0) ((_ int2bv 32) 15))) (in_range7 temp___expr_979)))
...
(declare-const temp___1327 issueridt)
(declare-const temp___13271 namecountt)
(declare-const temp___13272 (Array Int character))
...
(declare-const temp___1325 maskt)
(declare-const temp___13251 issueridt)
(declare-const temp___13252 namecountt)
(declare-const temp___13253 (Array Int character))
(declare-const temp___13254 unsigned32t)
(declare-const temp___13255 unsigned32t)
(declare-const temp___13256 Bool)
...
(declare-const privatetemplate__split_fields7 us_split_fields2)
...
(assert (= (mk___rep (mk___split_fields temp___1327 temp___13271 temp___13272)) nullissuer))
...
(assert (= privatetemplate__split_fields7 (mk___split_fields1 temp___1325 (mk___rep (mk___split_fields temp___13251 temp___13252 temp___13253)) temp___13254 temp___13255 temp___13256)))
