...
(define-fun char_table__split_fields9 () us_split_fields (mk___split_fields char_table__split_fields1))
...
(define-fun o31 () us_rep3 (mk___rep2 (mk___split_fields2 o12 o13 o14)))
...
(define-fun char_table__split_fields10 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields char_table__split_fields)))
...
(assert (in_range12 h))
(assert (or (and (and (and (= ptr17 (mk_int__ref ptr1)) (and (= entry_table__split_fields8 entry_table__split_fields12) (and (= char_table__split_fields5 char_table__split_fields10) (and (= hash_table7 hash_table11) (= n18 (mk_int__ref n2)))))) (and (= ptr18 ptr1) (and (= entry_table__split_fields9 entry_table__split_fields1) (and (= char_table__split_fields6 char_table__split_fields9) (and (= hash_table8 hash_table1) (= n19 n2)))))) (and (= (length s) 0) (and (= result1 (mk_int__ref n)) (= n2 0)))) (and (and (not (= (length s) 0)) (and (= n2 n) (= n2 n1))) (and (and (and (= ptr17 ptr15) (and (= entry_table__split_fields8 entry_table__split_fields6) (and (= char_table__split_fields5 char_table__split_fields3) (and (= hash_table7 hash_table5) (= n18 n16))))) (and (= ptr18 ptr16) (and (= entry_table__split_fields9 entry_table__split_fields7) (and (= char_table__split_fields6 char_table__split_fields4) (and (= hash_table8 hash_table6) (= n19 n17)))))) (and (and (= result2 (mk_int__ref n2)) (= n3 (to_rep4 (select hash_table h)))) (or (and (and (and (= ptr15 ptr7) (and (= entry_table__split_fields6 entry_table__split_fields12) (and (= char_table__split_fields3 char_table__split_fields10) (and (= hash_table5 hash_table11) (= n16 n7))))) (and (= ptr16 ptr8) (and (= entry_table__split_fields7 entry_table__split_fields1) (and (= char_table__split_fields4 char_table__split_fields9) (and (= hash_table6 hash_table1) (= n17 n8)))))) (and (in_range11 n3) (and (and (= result3 (mk_int__ref ptr1)) (= ptr2 n3)) (and (= temp___713 n3) (and (= temp___712 ptr2) (or (and (and (and (= ptr7 (mk_int__ref ptr2)) (= n7 (mk_int__ref n4))) (and (= ptr8 ptr2) (= n8 n4))) (and (and (and (= temp___7115 (to_string1 ptr2 hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (dynamic_invariant temp___7115 true false true true)) (= result4 (bool_eq temp___711 (to_rep1 (first temp___7111)) (to_rep1 (last temp___7111)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))) (and (= result4 true) (and (= result5 (mk_int__ref n3)) (= n4 ptr2))))) (and (and (and (and (= temp___7115 (to_string1 ptr2 hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (dynamic_invariant temp___7115 true false true true)) (= result4 (bool_eq temp___711 (to_rep1 (first temp___7111)) (to_rep1 (last temp___7111)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))) (and (not (= result4 true)) (= n4 n3))) (and (and (and (= ptr7 (mk_int__ref ptr4)) (= n7 (mk_int__ref n6))) (and (= ptr8 ptr4) (= n8 n6))) (and (and (and (in_range11 ptr3) (<= ptr3 (last2 (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields)))))) (= (invariant__ hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields)) true)) (and (and (=> (<= 0 2147483647) (in_range8 ptr3)) (=> (<= 0 2147483647) (in_range8 n5))) (and (and (and (and (and (and (and (and (= o2 ptr3) (in_range13 ptr3)) (and (= o32 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) (= (bool_eq4 o32 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) true))) (and (= o3 o6) (and (= o4 o7) (= o5 o8)))) (= o9 o8)) (= o10 (to_rep4 o9))) (= result6 (ite (= o10 0) true false))) (not (= result6 true))) (and (and (and (and (and (and (and (= o11 ptr3) (in_range13 ptr3)) (and (= o31 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o11)) (= (bool_eq4 o31 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o11)) true))) (and (= o12 o15) (and (= o13 o16) (= o14 o17)))) (= o18 o17)) (= o19 (to_rep4 o18))) (and (= result7 (mk_int__ref ptr3)) (= ptr4 o19))) (and (and (and (= temp___7114 (to_string1 ptr4 hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (dynamic_invariant temp___7114 true false true true)) (= result8 (bool_eq temp___7112 (to_rep1 (first temp___7113)) (to_rep1 (last temp___7113)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))) (and (= result8 true) (and (= result9 (mk_int__ref n5)) (= n6 ptr4)))))))))))))))) (and (ite (in_range11 n3) (and (and (and (= result3 (mk_int__ref ptr1)) (= ptr2 n3)) (and (and (and (= temp___713 n3) (and (= temp___712 ptr2) (and (and (and (and (= temp___7115 (to_string1 ptr2 hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (dynamic_invariant temp___7115 true false true true)) (= result4 (bool_eq temp___711 (to_rep1 (first temp___7111)) (to_rep1 (last temp___7111)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))) (and (not (= result4 true)) (= n4 n3))) (and (and (and (in_range11 ptr3) (<= ptr3 (last2 (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields)))))) (= (invariant__ hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields)) true)) (and (and (=> (<= 0 2147483647) (in_range8 ptr3)) (=> (<= 0 2147483647) (in_range8 n5))) (and (and (= ptr5 (mk_int__ref ptr3)) (= ptr6 ptr3)) (and (and (and (and (and (and (and (= o2 ptr3) (in_range13 ptr3)) (and (= o32 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) (= (bool_eq4 o32 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) true))) (and (= o3 o6) (and (= o4 o7) (= o5 o8)))) (= o9 o8)) (= o10 (to_rep4 o9))) (= result6 (ite (= o10 0) true false))) (= result6 true)))))))) (and (and (= ptr9 ptr5) (= n9 (mk_int__ref n5))) (and (= ptr10 ptr6) (= n10 n5)))) (and (and (= ptr11 ptr9) (= n11 n9)) (and (= ptr12 ptr10) (= n12 n10))))) (and (and (= ptr13 ptr11) (= n13 n11)) (and (= ptr14 ptr12) (= n14 n12)))) (and (and (= ptr13 (mk_int__ref ptr1)) (= n13 (mk_int__ref n3))) (and (= ptr14 ptr1) (= n14 n3)))) (and (and (and (= ptr15 ptr13) (and (= entry_table__split_fields6 entry_table__split_fields4) (and (= char_table__split_fields3 (mk___split_fields__ref char_table__split_fields2)) (and (= hash_table5 hash_table3) (= n16 (mk_int__ref n15)))))) (and (= ptr16 ptr14) (and (= entry_table__split_fields7 entry_table__split_fields5) (and (= char_table__split_fields4 char_table__split_fields2) (and (= hash_table6 hash_table4) (= n17 n15)))))) (and (and (and (and (and (= (invariant__ hash_table char_table__split_fields2 entry_table__split_fields2) true) (= (length2 (mk___rep1 entry_table__split_discrs entry_table__split_fields2)) (+ (length2 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) 1))) (<= (length3 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) (length3 (mk___rep char_table__split_discrs char_table__split_fields2)))) (= n15 (last2 (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields2))))) (in_range8 n15)) (ite (in_range11 (int__content ptr13)) (and (and (and (and (and (and (= o21 (int__content ptr13)) (in_range13 (int__content ptr13))) (and (= temp___7143 (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields2)) o21)) (= (bool_eq4 temp___7143 (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields2)) o21)) true))) (and (and (= (to_rep4 o22) n15) (and (= temp___714 o23) (and (= temp___7141 o24) (= o22 o25)))) (and (= o26 o23) (and (= o27 o24) (= o28 o25))))) (and (and (= o20 (int__content ptr13)) (in_range13 (int__content ptr13))) (and (and (= (length2 (mk___rep1 entry_table__split_discrs names__data__entry_tables__replace_element__container__fields)) (length2 (mk___rep1 entry_table__split_discrs entry_table__split_fields2))) (= (bool_eq4 (get (model__ (mk___rep1 entry_table__split_discrs names__data__entry_tables__replace_element__container__fields)) o20) (mk___rep2 (mk___split_fields2 o26 o27 o28))) true)) (= (equal_except (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields2)) (model__ (mk___rep1 entry_table__split_discrs names__data__entry_tables__replace_element__container__fields)) o20) true)))) (and (= result10 (mk___split_fields__ref1 entry_table__split_fields2)) (= entry_table__split_fields3 names__data__entry_tables__replace_element__container__fields))) (and (and (= entry_table__split_fields4 (mk___split_fields__ref1 entry_table__split_fields3)) (= hash_table3 hash_table11)) (and (= entry_table__split_fields5 entry_table__split_fields3) (= hash_table4 hash_table1)))) (and (and (and (= (to_rep4 o29) n15) (= o30 (store hash_table h o29))) (and (= result11 hash_table11) (= hash_table2 o30))) (and (and (= entry_table__split_fields4 (mk___split_fields__ref1 entry_table__split_fields2)) (= hash_table3 (mk_map__ref1 hash_table2))) (and (= entry_table__split_fields5 entry_table__split_fields2) (= hash_table4 hash_table2))))))))))))))
(assert (= ptr19 ptr17))
...
(assert (= n21 n19))
(assert (not (= (invariant__ (map__content1 hash_table9) (us_split_fields__content char_table__split_fields7) (us_split_fields__content1 entry_table__split_fields10)) true)))
(check-sat)
(exit)
