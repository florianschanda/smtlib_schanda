...
(define-fun dynamic_invariant ((temp___expr_7638 us_t1) (temp___is_init_7635 Bool) (temp___skip_constant_7636 Bool) (temp___do_toplevel_7637 Bool)) Bool (=> (not (= temp___skip_constant_7636 true)) (and (dynamic_property2 1 4 (first3 temp___expr_7638) (last3 temp___expr_7638)) (and (= (first3 temp___expr_7638) 1) (= (last3 temp___expr_7638) 4)))))
