...
(assert (and (and (and (= result (mk_int__ref ptr)) (= ptr1 0)) (and (in_range4 ptr1) (and (and (and (and (= o (hash s)) (= o1 (bvurem o ((_ int2bv 32) 256)))) (and (= names__lookup__h__assume o1) (in_range10 o1))) (= names__lookup__h__assume h)) (and (in_range10 h) (or (and (and (and (= c344b10 (mk_int__ref c344b)) (and (= ptr14 (mk_int__ref ptr1)) (and (= entry_table__split_fields8 (mk___split_fields__ref (mk___split_fields entry_table__split_fields))) (and (= char_table__split_fields10 (mk___split_fields__ref1 (mk___split_fields1 char_table__split_fields))) (and (= hash_table7 (mk_map__ref1 hash_table)) (= n15 (mk_int__ref n2))))))) (and (= c344b11 c344b1) (and (= ptr15 ptr1) (and (= entry_table__split_fields9 entry_table__split_fields1) (and (= char_table__split_fields11 char_table__split_fields1) (and (= hash_table8 hash_table1) (= n16 n2))))))) (and (= (length s) 0) (and (= result1 (mk_int__ref n)) (= n2 0)))) (and (and (not (= (length s) 0)) (and (= n2 n) (= n2 n1))) (and (and (and (= c344b10 c344b8) (and (= ptr14 ptr12) (and (= entry_table__split_fields8 entry_table__split_fields6) (and (= char_table__split_fields10 char_table__split_fields8) (and (= hash_table7 hash_table5) (= n15 n13)))))) (and (= c344b11 c344b9) (and (= ptr15 ptr13) (and (= entry_table__split_fields9 entry_table__split_fields7) (and (= char_table__split_fields11 char_table__split_fields9) (and (= hash_table8 hash_table6) (= n16 n14))))))) (and (and (= result2 (mk_int__ref n2)) (= n3 (to_rep3 (select hash_table h)))) (or (and (and (and (= c344b8 (mk_int__ref c344b)) (and (= ptr12 (mk_int__ref ptr3)) (and (= entry_table__split_fields6 (mk___split_fields__ref (mk___split_fields entry_table__split_fields))) (and (= char_table__split_fields8 (mk___split_fields__ref1 (mk___split_fields1 char_table__split_fields))) (and (= hash_table5 (mk_map__ref1 hash_table)) (= n13 (mk_int__ref n5))))))) (and (= c344b9 c344b1) (and (= ptr13 ptr3) (and (= entry_table__split_fields7 entry_table__split_fields1) (and (= char_table__split_fields9 char_table__split_fields1) (and (= hash_table6 hash_table1) (= n14 n5))))))) (and (in_range9 n3) (and (and (= result3 (mk_int__ref ptr1)) (= ptr2 n3)) (and (= temp___606 n3) (and (= temp___605 ptr2) (and (and (=> (<= 0 2147483647) (in_range4 ptr3)) (=> (<= 0 2147483647) (in_range4 n4))) (and (and (and (= (mk___t temp___604 temp___6041) (to_string1 ptr3 (mk___split_fields entry_table__split_fields) (mk___split_fields1 char_table__split_fields))) (dynamic_invariant (mk___t temp___604 temp___6041) true false true)) (= result4 (bool_eq temp___604 (to_rep1 (first temp___6041)) (to_rep1 (last temp___6041)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))) (and (= result4 true) (and (= result5 (mk_int__ref n4)) (= n5 ptr3)))))))))) (and (ite (in_range9 n3) (and (and (and (= result3 (mk_int__ref ptr1)) (= ptr2 n3)) (and (and (and (= temp___606 n3) (and (= temp___605 ptr2) (and (and (=> (<= 0 2147483647) (in_range4 ptr3)) (=> (<= 0 2147483647) (in_range4 n4))) (and (and (and (and (= (mk___t temp___604 temp___6041) (to_string1 ptr3 (mk___split_fields entry_table__split_fields) (mk___split_fields1 char_table__split_fields))) (dynamic_invariant (mk___t temp___604 temp___6041) true false true)) (= result4 (bool_eq temp___604 (to_rep1 (first temp___6041)) (to_rep1 (last temp___6041)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))) (and (not (= result4 true)) (= n5 n4))) (and (and (= ptr4 (mk_int__ref ptr3)) (= ptr5 ptr3)) (and (and (and (and (and (and (and (= o2 ptr3) (in_range14 ptr3)) (and (= (mk___rep2 (mk___split_fields2 o3 o4 o5)) (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o2)) (= (bool_eq4 (mk___rep2 (mk___split_fields2 o3 o4 o5)) (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o2)) true))) (and (= o3 o6) (and (= o4 o7) (= o5 o8)))) (= o9 o8)) (= o10 (to_rep3 o9))) (= result6 (ite (= o10 0) true false))) (= result6 true))))))) (and (and (= ptr6 ptr4) (= n6 (mk_int__ref n5))) (and (= ptr7 ptr5) (= n7 n5)))) (and (and (= ptr8 ptr6) (= n8 n6)) (and (= ptr9 ptr7) (= n9 n7))))) (and (and (= ptr10 ptr8) (= n10 n8)) (and (= ptr11 ptr9) (= n11 n9)))) (and (and (= ptr10 (mk_int__ref ptr1)) (= n10 (mk_int__ref n3))) (and (= ptr11 ptr1) (= n11 n3)))) (and (and (and (= c344b8 c344b6) (and (= ptr12 ptr10) (and (= entry_table__split_fields6 entry_table__split_fields4) (and (= char_table__split_fields8 char_table__split_fields6) (and (= hash_table5 hash_table3) (= n13 (mk_int__ref n12))))))) (and (= c344b9 c344b7) (and (= ptr13 ptr11) (and (= entry_table__split_fields7 entry_table__split_fields5) (and (= char_table__split_fields9 char_table__split_fields7) (and (= hash_table6 hash_table4) (= n14 n12))))))) (and (and (and (= result7 (mk_int__ref c344b)) (= c344b2 (to_rep1 (first (rt s))))) (ite (and (<= (to_rep1 (first (rt s))) c344b2) (<= c344b2 (to_rep1 (last (rt s))))) (and (and (and (and (= char_table__split_discrs (mk___split_discrs1 temp___608)) (= char_table__split_fields temp___6081)) (and (and (<= (to_rep1 (first (rt s))) c344b3) (<= c344b3 (to_rep1 (last (rt s))))) (and (and (and (and (= (length1 (mk___rep1 char_table__split_discrs names__char_tables__append__2__container__fields)) (+ (length1 (mk___rep1 char_table__split_discrs char_table__split_fields2)) 1)) (= (olt (model__ (mk___rep1 char_table__split_discrs char_table__split_fields2)) (model__ (mk___rep1 char_table__split_discrs names__char_tables__append__2__container__fields))) true)) (= (get (model__ (mk___rep1 char_table__split_discrs names__char_tables__append__2__container__fields)) (+ (last2 (model__ (mk___rep1 char_table__split_discrs char_table__split_fields2))) 1)) (to_rep (select (elts s) c344b3)))) (and (= result8 (mk___split_fields__ref1 char_table__split_fields2)) (= char_table__split_fields3 names__char_tables__append__2__container__fields))) (= c344b3 (to_rep1 (last (rt s))))))) (and (and (= c344b4 (mk_int__ref c344b3)) (= char_table__split_fields4 (mk___split_fields__ref1 char_table__split_fields3))) (and (= c344b5 c344b3) (= char_table__split_fields5 char_table__split_fields3)))) (and (and (= c344b6 c344b4) (= char_table__split_fields6 char_table__split_fields4)) (and (= c344b7 c344b5) (= char_table__split_fields7 char_table__split_fields5)))) (and (and (= c344b6 (mk_int__ref c344b2)) (= char_table__split_fields6 (mk___split_fields__ref1 (mk___split_fields1 char_table__split_fields)))) (and (= c344b7 c344b2) (= char_table__split_fields7 char_table__split_fields1))))) (and (= (last2 (model__ (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6)))) (- (length1 (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6))) 1)) (and (<= (length1 (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6))) 2147483647) (and (<= (last2 (model__ (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6)))) 2147483646) (and (and (and (and (and (= (to_rep3 o22) 0) (and (and (and (= o21 (length s)) (in_range2 (length s))) (= (to_rep2 o23) o21)) (and (and (and (and (and (and (and (= o15 (length s)) (in_range11 (length s))) (= o16 (- o15 1))) (and (and (= o17 (last2 (model__ (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6))))) (and (in_range13 o17) (= o17 (last2 (model__ (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6))))))) (= o18 (- o17 o16)))) (and (= o19 o18) (in_range11 o18))) (and (= o20 o19) (in_range12 o19))) (= (to_rep6 o24) o20)) (and (= o24 o25) (and (= o23 o26) (= o22 o27)))))) (and (= o28 o25) (and (= o29 o26) (= o30 o27)))) (and (and (= (length4 (mk___rep entry_table__split_discrs names__entry_tables__append__2__container__fields)) (+ (length4 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) 1)) (= (olt1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) (model__1 (mk___rep entry_table__split_discrs names__entry_tables__append__2__container__fields))) true)) (= (bool_eq4 (get1 (model__1 (mk___rep entry_table__split_discrs names__entry_tables__append__2__container__fields)) (+ (last3 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields)))) 1)) (mk___rep2 (mk___split_fields2 o28 o29 o30))) true))) (and (= result9 (mk___split_fields__ref (mk___split_fields entry_table__split_fields))) (= entry_table__split_fields2 names__entry_tables__append__2__container__fields))) (and (and (and (= o31 (last3 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields2)))) (and (in_range15 o31) (= o31 (last3 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields2)))))) (and (= result10 n10) (= n12 o31))) (ite (in_range9 (int__content ptr10)) (and (and (and (and (and (and (= o33 (int__content ptr10)) (in_range14 (int__content ptr10))) (and (= temp___612 (get1 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields2)) o33)) (= (bool_eq4 temp___612 (get1 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields2)) o33)) true))) (and (and (= (to_rep3 o34) n12) (= o35 (mk___split_fields2 (rec__names__name_entry__table_index (us_split_fields5 temp___612)) (rec__names__name_entry__length (us_split_fields5 temp___612)) o34))) (= o36 (mk___rep2 o35)))) (and (and (= o32 (int__content ptr10)) (in_range14 (int__content ptr10))) (and (and (= (length4 (mk___rep entry_table__split_discrs names__entry_tables__replace_element__container__fields)) (length4 (mk___rep entry_table__split_discrs entry_table__split_fields2))) (= (bool_eq4 (get1 (model__1 (mk___rep entry_table__split_discrs names__entry_tables__replace_element__container__fields)) o32) o36) true)) (= (equal_except (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields2)) (model__1 (mk___rep entry_table__split_discrs names__entry_tables__replace_element__container__fields)) o32) true)))) (and (= result11 (mk___split_fields__ref entry_table__split_fields2)) (= entry_table__split_fields3 names__entry_tables__replace_element__container__fields))) (and (and (= entry_table__split_fields4 (mk___split_fields__ref entry_table__split_fields3)) (= hash_table3 (mk_map__ref1 hash_table))) (and (= entry_table__split_fields5 entry_table__split_fields3) (= hash_table4 hash_table1)))) (and (and (and (= (to_rep3 o37) n12) (= o38 (store hash_table h o37))) (and (= result12 (mk_map__ref1 hash_table)) (= hash_table2 o38))) (and (and (= entry_table__split_fields4 (mk___split_fields__ref entry_table__split_fields2)) (= hash_table3 (mk_map__ref1 hash_table2))) (and (= entry_table__split_fields5 entry_table__split_fields2) (= hash_table4 hash_table2)))))))))))))))))))))) (and (and (= c344b12 c344b10) (and (= ptr16 ptr14) (and (= entry_table__split_fields10 entry_table__split_fields8) (and (= char_table__split_fields12 char_table__split_fields10) (and (= hash_table9 hash_table7) (= n17 n15)))))) (and (= c344b13 c344b11) (and (= ptr17 ptr15) (and (= entry_table__split_fields11 entry_table__split_fields9) (and (= char_table__split_fields13 char_table__split_fields11) (and (= hash_table10 hash_table8) (= n18 n16)))))))))
