...
(define-fun dynamic_invariant3 ((temp___expr_631 us_rep) (temp___is_init_627 Bool) (temp___skip_constant_628 Bool) (temp___do_toplevel_629 Bool) (temp___do_typ_inv_630 Bool)) Bool (=> (not (= temp___skip_constant_628 true)) (in_range6 128 temp___expr_631)))
(define-fun default_initial_assumption ((temp___expr_633 us_rep) (temp___skip_top_level_634 Bool)) Bool (and (= (to_rep4 (rec__names__entry_tables__vector__capacity (us_split_discrs1 temp___expr_633))) 128) (=> (not (= temp___skip_top_level_634 true)) (= (is_empty temp___expr_633) true))))
...
(define-fun dynamic_invariant4 ((temp___expr_454 us_rep1) (temp___is_init_450 Bool) (temp___skip_constant_451 Bool) (temp___do_toplevel_452 Bool) (temp___do_typ_inv_453 Bool)) Bool (=> (not (= temp___skip_constant_451 true)) (in_range8 1024 temp___expr_454)))
(define-fun default_initial_assumption1 ((temp___expr_456 us_rep1) (temp___skip_top_level_457 Bool)) Bool (and (= (to_rep5 (rec__names__char_tables__vector__capacity (us_split_discrs3 temp___expr_456))) 1024) (=> (not (= temp___skip_top_level_457 true)) (= (is_empty1 temp___expr_456) true))))
...
(define-fun in_range10 ((x (_ BitVec 32))) Bool (and (bvule #x00000000 x) (bvule x #x000000FF)))
...
(define-fun dynamic_invariant5 ((temp___expr_279 (_ BitVec 32)) (temp___is_init_275 Bool) (temp___skip_constant_276 Bool) (temp___do_toplevel_277 Bool) (temp___do_typ_inv_278 Bool)) Bool (=> (or (= temp___is_init_275 true) (bvule #x00000000 #x000000FF)) (in_range10 temp___expr_279)))
...
(define-fun dynamic_invariant6 ((temp___expr_324 Int) (temp___is_init_320 Bool) (temp___skip_constant_321 Bool) (temp___do_toplevel_322 Bool) (temp___do_typ_inv_323 Bool)) Bool (=> (or (= temp___is_init_320 true) (<= 0 2147483647)) (in_range7 temp___expr_324)))
(define-fun capacity ((container us_rep1)) Int (ite (= (distinct 0 0) true) (to_rep5 (rec__names__char_tables__vector__capacity (us_split_discrs3 container))) 2147483647))
(declare-fun capacity__function_guard (Int us_rep1) Bool)
(assert (forall ((container us_rep1)) (! (let ((result (length1 container))) (and (<= result (capacity container)) (dynamic_invariant6 result true false true true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant7 ((temp___expr_317 Int) (temp___is_init_313 Bool) (temp___skip_constant_314 Bool) (temp___do_toplevel_315 Bool) (temp___do_typ_inv_316 Bool)) Bool (=> (or (= temp___is_init_313 true) (<= (- 1) 2147483647)) (in_range13 temp___expr_317)))
...
(define-fun dynamic_invariant8 ((temp___expr_491 Int) (temp___is_init_487 Bool) (temp___skip_constant_488 Bool) (temp___do_toplevel_489 Bool) (temp___do_typ_inv_490 Bool)) Bool (=> (or (= temp___is_init_487 true) (<= 0 2147483647)) (in_range15 temp___expr_491)))
...
(define-fun capacity1 ((container us_rep)) Int (ite (= (distinct 0 0) true) (to_rep4 (rec__names__entry_tables__vector__capacity (us_split_discrs1 container))) 2147483647))
...
(define-fun dynamic_invariant12 ((temp___expr_272 Int) (temp___is_init_268 Bool) (temp___skip_constant_269 Bool) (temp___do_toplevel_270 Bool) (temp___do_typ_inv_271 Bool)) Bool (=> (or (= temp___is_init_268 true) (<= 1 2147483647)) (in_range9 temp___expr_272)))
(define-fun dynamic_invariant13 ((temp___expr_296 Int) (temp___is_init_292 Bool) (temp___skip_constant_293 Bool) (temp___do_toplevel_294 Bool) (temp___do_typ_inv_295 Bool)) Bool (=> (or (= temp___is_init_292 true) (<= 0 2147483646)) (in_range12 temp___expr_296)))
...
(define-fun dynamic_invariant17 ((temp___expr_498 Int) (temp___is_init_494 Bool) (temp___skip_constant_495 Bool) (temp___do_toplevel_496 Bool) (temp___do_typ_inv_497 Bool)) Bool (=> (or (= temp___is_init_494 true) (<= 0 2147483647)) (in_range5 temp___expr_498)))
(assert (forall ((container us_rep)) (! (let ((result (length4 container))) (and (<= result (capacity1 container)) (dynamic_invariant17 result true false true true))) :pattern ((length4 container)))))
...
(define-fun default_initial_assumption3 ((temp___expr_540 us_rep4) (temp___skip_top_level_541 Bool)) Bool (=> (not (= temp___skip_top_level_541 true)) (= (length3 temp___expr_540) 0)))
...
(define-fun dynamic_invariant18 ((temp___expr_474 Int) (temp___is_init_470 Bool) (temp___skip_constant_471 Bool) (temp___do_toplevel_472 Bool) (temp___do_typ_inv_473 Bool)) Bool (=> (or (= temp___is_init_470 true) (<= 1 2147483647)) (in_range14 temp___expr_474)))
...
(assert (forall ((container us_rep4)) (! (let ((result (length3 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant14 result true false true true))) :pattern ((length3 container)))))
(assert true)
(declare-const n Int)
...
(declare-const temp___671 capacity_range1)
(declare-const temp___6711 us_main_type1)
...
(define-fun o35 () us_rep3 (mk___rep2 (mk___split_fields2 o3 o4 o5)))
(define-fun temp___6672 () us_t (mk___t temp___667 temp___6671))
(define-fun c344b14 () int__ref (mk_int__ref c344b))
(define-fun entry_table__split_fields12 () us_split_fields__ref (mk___split_fields__ref (mk___split_fields entry_table__split_fields)))
(define-fun char_table__split_fields14 () us_split_fields__ref1 (mk___split_fields__ref1 (mk___split_fields1 char_table__split_fields)))
...
(assert (in_range10 h))
(assert (or (and (and (and (= c344b10 c344b14) (and (= ptr14 (mk_int__ref ptr1)) (and (= entry_table__split_fields8 entry_table__split_fields12) (and (= char_table__split_fields10 char_table__split_fields14) (and (= hash_table7 hash_table11) (= n15 (mk_int__ref n2))))))) (and (= c344b11 c344b1) (and (= ptr15 ptr1) (and (= entry_table__split_fields9 entry_table__split_fields1) (and (= char_table__split_fields11 char_table__split_fields1) (and (= hash_table8 hash_table1) (= n16 n2))))))) (and (= (length s) 0) (and (= result1 (mk_int__ref n)) (= n2 0)))) (and (and (not (= (length s) 0)) (and (= n2 n) (= n2 n1))) (and (and (and (= c344b10 c344b8) (and (= ptr14 ptr12) (and (= entry_table__split_fields8 entry_table__split_fields6) (and (= char_table__split_fields10 char_table__split_fields8) (and (= hash_table7 hash_table5) (= n15 n13)))))) (and (= c344b11 c344b9) (and (= ptr15 ptr13) (and (= entry_table__split_fields9 entry_table__split_fields7) (and (= char_table__split_fields11 char_table__split_fields9) (and (= hash_table8 hash_table6) (= n16 n14))))))) (and (and (= result2 (mk_int__ref n2)) (= n3 (to_rep3 (select hash_table h)))) (or (and (and (and (= c344b8 c344b14) (and (= ptr12 (mk_int__ref ptr3)) (and (= entry_table__split_fields6 entry_table__split_fields12) (and (= char_table__split_fields8 char_table__split_fields14) (and (= hash_table5 hash_table11) (= n13 (mk_int__ref n5))))))) (and (= c344b9 c344b1) (and (= ptr13 ptr3) (and (= entry_table__split_fields7 entry_table__split_fields1) (and (= char_table__split_fields9 char_table__split_fields1) (and (= hash_table6 hash_table1) (= n14 n5))))))) (and (in_range9 n3) (and (and (= result3 (mk_int__ref ptr1)) (= ptr2 n3)) (and (= temp___669 n3) (and (= temp___668 ptr2) (and (and (=> (<= 0 2147483647) (in_range4 ptr3)) (=> (<= 0 2147483647) (in_range4 n4))) (and (and (and (= temp___6672 (to_string1 ptr3 (mk___split_fields entry_table__split_fields) (mk___split_fields1 char_table__split_fields))) (dynamic_invariant temp___6672 true false true true)) (= result4 (bool_eq temp___667 (to_rep1 (first temp___6671)) (to_rep1 (last temp___6671)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))) (and (= result4 true) (and (= result5 (mk_int__ref n4)) (= n5 ptr3)))))))))) (and (ite (in_range9 n3) (and (and (and (= result3 (mk_int__ref ptr1)) (= ptr2 n3)) (and (and (and (= temp___669 n3) (and (= temp___668 ptr2) (and (and (=> (<= 0 2147483647) (in_range4 ptr3)) (=> (<= 0 2147483647) (in_range4 n4))) (and (and (and (and (= temp___6672 (to_string1 ptr3 (mk___split_fields entry_table__split_fields) (mk___split_fields1 char_table__split_fields))) (dynamic_invariant temp___6672 true false true true)) (= result4 (bool_eq temp___667 (to_rep1 (first temp___6671)) (to_rep1 (last temp___6671)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))) (and (not (= result4 true)) (= n5 n4))) (and (and (= ptr4 (mk_int__ref ptr3)) (= ptr5 ptr3)) (and (and (and (and (and (and (and (= o2 ptr3) (in_range14 ptr3)) (and (= o35 (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o2)) (= (bool_eq4 o35 (get1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) o2)) true))) (and (= o3 o6) (and (= o4 o7) (= o5 o8)))) (= o9 o8)) (= o10 (to_rep3 o9))) (= result6 (ite (= o10 0) true false))) (= result6 true))))))) (and (and (= ptr6 ptr4) (= n6 (mk_int__ref n5))) (and (= ptr7 ptr5) (= n7 n5)))) (and (and (= ptr8 ptr6) (= n8 n6)) (and (= ptr9 ptr7) (= n9 n7))))) (and (and (= ptr10 ptr8) (= n10 n8)) (and (= ptr11 ptr9) (= n11 n9)))) (and (and (= ptr10 (mk_int__ref ptr1)) (= n10 (mk_int__ref n3))) (and (= ptr11 ptr1) (= n11 n3)))) (and (and (and (= c344b8 c344b6) (and (= ptr12 ptr10) (and (= entry_table__split_fields6 entry_table__split_fields4) (and (= char_table__split_fields8 char_table__split_fields6) (and (= hash_table5 hash_table3) (= n13 (mk_int__ref n12))))))) (and (= c344b9 c344b7) (and (= ptr13 ptr11) (and (= entry_table__split_fields7 entry_table__split_fields5) (and (= char_table__split_fields9 char_table__split_fields7) (and (= hash_table6 hash_table4) (= n14 n12))))))) (and (and (and (= result7 c344b14) (= c344b2 (to_rep1 (first (rt s))))) (ite (and (<= (to_rep1 (first (rt s))) c344b2) (<= c344b2 (to_rep1 (last (rt s))))) (and (and (and (and (= char_table__split_discrs (mk___split_discrs1 temp___671)) (= char_table__split_fields temp___6711)) (and (and (<= (to_rep1 (first (rt s))) c344b3) (<= c344b3 (to_rep1 (last (rt s))))) (and (and (and (and (= (length1 (mk___rep1 char_table__split_discrs names__char_tables__append__2__container__fields)) (+ (length1 (mk___rep1 char_table__split_discrs char_table__split_fields2)) 1)) (= (olt (model__ (mk___rep1 char_table__split_discrs char_table__split_fields2)) (model__ (mk___rep1 char_table__split_discrs names__char_tables__append__2__container__fields))) true)) (= (get (model__ (mk___rep1 char_table__split_discrs names__char_tables__append__2__container__fields)) (+ (last2 (model__ (mk___rep1 char_table__split_discrs char_table__split_fields2))) 1)) (to_rep (select (elts s) c344b3)))) (and (= result8 (mk___split_fields__ref1 char_table__split_fields2)) (= char_table__split_fields3 names__char_tables__append__2__container__fields))) (= c344b3 (to_rep1 (last (rt s))))))) (and (and (= c344b4 (mk_int__ref c344b3)) (= char_table__split_fields4 (mk___split_fields__ref1 char_table__split_fields3))) (and (= c344b5 c344b3) (= char_table__split_fields5 char_table__split_fields3)))) (and (and (= c344b6 c344b4) (= char_table__split_fields6 char_table__split_fields4)) (and (= c344b7 c344b5) (= char_table__split_fields7 char_table__split_fields5)))) (and (and (= c344b6 (mk_int__ref c344b2)) (= char_table__split_fields6 char_table__split_fields14)) (and (= c344b7 c344b2) (= char_table__split_fields7 char_table__split_fields1))))) (and (= (last2 (model__ (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6)))) (- (length1 (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6))) 1)) (and (<= (length1 (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6))) 2147483647) (and (<= (last2 (model__ (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6)))) 2147483646) (and (and (and (and (and (= (to_rep3 o18) 0) (and (and (and (= o17 (length s)) (in_range2 (length s))) (= (to_rep2 o19) o17)) (and (and (and (and (and (and (and (= o11 (length s)) (in_range11 (length s))) (= o12 (- o11 1))) (and (and (= o13 (last2 (model__ (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6))))) (and (in_range13 o13) (= o13 (last2 (model__ (mk___rep1 char_table__split_discrs (us_split_fields__content1 char_table__split_fields6))))))) (= o14 (- o13 o12)))) (and (= o15 o14) (in_range11 o14))) (and (= o16 o15) (in_range12 o15))) (= (to_rep6 o20) o16)) (and (= o20 o21) (and (= o19 o22) (= o18 o23)))))) (and (= o24 o21) (and (= o25 o22) (= o26 o23)))) (and (and (= (length4 (mk___rep entry_table__split_discrs names__entry_tables__append__2__container__fields)) (+ (length4 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) 1)) (= (olt1 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields))) (model__1 (mk___rep entry_table__split_discrs names__entry_tables__append__2__container__fields))) true)) (= (bool_eq4 (get1 (model__1 (mk___rep entry_table__split_discrs names__entry_tables__append__2__container__fields)) (+ (last3 (model__1 (mk___rep entry_table__split_discrs (mk___split_fields entry_table__split_fields)))) 1)) (mk___rep2 (mk___split_fields2 o24 o25 o26))) true))) (and (= result9 entry_table__split_fields12) (= entry_table__split_fields2 names__entry_tables__append__2__container__fields))) (and (and (and (= o27 (last3 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields2)))) (and (in_range15 o27) (= o27 (last3 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields2)))))) (and (= result10 n10) (= n12 o27))) (ite (in_range9 (int__content ptr10)) (and (and (and (and (and (and (= o29 (int__content ptr10)) (in_range14 (int__content ptr10))) (and (= temp___675 (get1 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields2)) o29)) (= (bool_eq4 temp___675 (get1 (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields2)) o29)) true))) (and (and (= (to_rep3 o30) n12) (= o31 (mk___split_fields2 (rec__names__name_entry__table_index (us_split_fields5 temp___675)) (rec__names__name_entry__length (us_split_fields5 temp___675)) o30))) (= o32 (mk___rep2 o31)))) (and (and (= o28 (int__content ptr10)) (in_range14 (int__content ptr10))) (and (and (= (length4 (mk___rep entry_table__split_discrs names__entry_tables__replace_element__container__fields)) (length4 (mk___rep entry_table__split_discrs entry_table__split_fields2))) (= (bool_eq4 (get1 (model__1 (mk___rep entry_table__split_discrs names__entry_tables__replace_element__container__fields)) o28) o32) true)) (= (equal_except (model__1 (mk___rep entry_table__split_discrs entry_table__split_fields2)) (model__1 (mk___rep entry_table__split_discrs names__entry_tables__replace_element__container__fields)) o28) true)))) (and (= result11 (mk___split_fields__ref entry_table__split_fields2)) (= entry_table__split_fields3 names__entry_tables__replace_element__container__fields))) (and (and (= entry_table__split_fields4 (mk___split_fields__ref entry_table__split_fields3)) (= hash_table3 hash_table11)) (and (= entry_table__split_fields5 entry_table__split_fields3) (= hash_table4 hash_table1)))) (and (and (and (= (to_rep3 o33) n12) (= o34 (store hash_table h o33))) (and (= result12 hash_table11) (= hash_table2 o34))) (and (and (= entry_table__split_fields4 (mk___split_fields__ref entry_table__split_fields2)) (= hash_table3 (mk_map__ref1 hash_table2))) (and (= entry_table__split_fields5 entry_table__split_fields2) (= hash_table4 hash_table2)))))))))))))))))))
