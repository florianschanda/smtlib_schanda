...
(declare-fun temp___1122 ((_ BitVec 8) Int Int) us_t2)
(assert (forall ((temp___1124 (_ BitVec 8))) (forall ((temp___1125 Int) (temp___1126 Int)) (let ((temp___1123 (temp___1122 temp___1124 temp___1125 temp___1126))) (and (=> (dynamic_property7 1 65536 temp___1125 temp___1126) (and (= (first5 temp___1123) temp___1125) (= (last5 temp___1123) temp___1126))) (forall ((temp___1127 Int)) (= (select (to_array2 temp___1123) temp___1127) (of_rep1 temp___1124))))))))
(define-fun dynamic_invariant5 ((temp___expr_342 us_t1) (temp___is_init_339 Bool) (temp___skip_constant_340 Bool) (temp___do_toplevel_341 Bool)) Bool (=> (not (= temp___skip_constant_340 true)) (and (dynamic_property3 1 r9b (first3 temp___expr_342) (last3 temp___expr_342)) (and (= (first3 temp___expr_342) 1) (= (last3 temp___expr_342) r9b)))))
...
(declare-const temp___1129 (Array Int octet))
(declare-const temp___11291 t2)
(declare-const temp___1130 (Array Int octet))
(declare-const temp___11301 t1)
(declare-const temp___1132 (Array Int octet))
(declare-const temp___11321 t1)
(declare-const o (Array Int octet))
(declare-const o1 t)
(declare-const o2 (Array Int octet))
(declare-const o3 t)
(declare-const temp___1134 digit_index_type)
(declare-const temp___11341 (Array Int octet))
(declare-const temp___11342 t)
...
(declare-const o20 t)
(declare-const temp___1139 us_rep)
...
(assert (dynamic_invariant1 (mk___rep result____split_discrs (mk___split_fields (mk___t result____split_fields result____split_fields1))) false false true))
(assert true)
...
(assert (= (to_rep2 (first4 (rt2 (temp___1122 ((_ int2bv 8) 0) 1 r9b)))) 1))
(assert (= (to_rep2 (last4 (rt2 (temp___1122 ((_ int2bv 8) 0) 1 r9b)))) r9b))
(assert (= (mk___t2 temp___1129 temp___11291) (temp___1122 ((_ int2bv 8) 0) 1 r9b)))
(assert (= (ite (<= (to_rep2 (first4 temp___11291)) (to_rep2 (last4 temp___11291))) (+ (- (to_rep2 (last4 temp___11291)) (to_rep2 (first4 temp___11291))) 1) 0) (ite (<= 1 r9b) (+ (- r9b 1) 1) 0)))
(assert (= temp___1129 temp___1130))
(assert (= (mk1 (to_rep2 (first4 temp___11291)) (to_rep2 (last4 temp___11291))) temp___11301))
(assert (= (ite (<= (to_rep2 (first2 temp___11301)) (to_rep2 (last2 temp___11301))) (+ (- (to_rep2 (last2 temp___11301)) (to_rep2 (first2 temp___11301))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)))
(assert (= (mk___t1 temp___1132 temp___11321) (mk___t1 temp___1130 temp___11301)))
(assert (= temp___1132 o))
(assert (= (mk (to_rep2 (first2 temp___11321)) (to_rep2 (last2 temp___11321))) o1))
(assert (= o2 o))
(assert (= o3 o1))
(assert (= result____split_discrs (mk___split_discrs temp___1134)))
(assert (= temp___11341 o2))
(assert (= temp___11342 o3))
(assert (= result (mk___split_fields__ref (mk___split_fields (mk___t result____split_fields result____split_fields1)))))
(assert (= result____split_fields2 (mk___split_fields (mk___t temp___11341 temp___11342))))
(assert (= result____split_discrs (mk___split_discrs temp___1134)))
...
(assert true)
(assert (and (= (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r)))))) (= (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))))
(assert (and (and (and (=> (<= 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))) (dynamic_property6 1 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))) i2)) (dynamic_invariant1 (mk___rep result____split_discrs result____split_fields3) false true true)) (forall ((temp___1143 Int)) (=> (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) temp___1143) (<= temp___1143 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1143) (= (select (elts (rec__very_longs__very_long__long_digits result____split_fields3)) temp___1143) (select (elts (rec__very_longs__very_long__long_digits result____split_fields2)) temp___1143)))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l)))))))))
...
(assert (= result3 (mk_t__ref1 l_digit1)))
(assert (= l_digit2 o7))
...
(assert (= result4 (mk_t__ref1 r_digit1)))
(assert (= r_digit2 o11))
(assert (= result5 (mk_t__ref1 sum1)))
(assert (= sum2 (bvadd (bvadd l_digit2 r_digit2) carry2)))
(assert (and (= o12 (shift_right sum2 8)) (= o12 (bvudiv sum2 (ite (< 8 65536) (bvshl ((_ int2bv 16) 1) ((_ int2bv 16) 8)) ((_ int2bv 16) 0))))))
(assert (= result6 (mk_t__ref1 carry2)))
(assert (= carry3 o12))
(assert (= o13 (takelsb_from16 sum2)))
(assert (= (to_rep1 o14) o13))
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits result____split_fields3)))) i2) (<= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits result____split_fields3)))))))
(assert (= o15 i2))
...
(assert (= o19 o17))
(assert (= o20 o18))
(assert (= temp___1139 (mk___rep result____split_discrs (mk___split_fields (mk___t o19 o20)))))
(assert (= result7 (mk___split_fields__ref result____split_fields3)))
(assert (= result____split_fields4 (us_split_fields1 temp___1139)))
(assert (= result____split_discrs (us_split_discrs1 temp___1139)))
(assert (not (= i2 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 l))))))))
