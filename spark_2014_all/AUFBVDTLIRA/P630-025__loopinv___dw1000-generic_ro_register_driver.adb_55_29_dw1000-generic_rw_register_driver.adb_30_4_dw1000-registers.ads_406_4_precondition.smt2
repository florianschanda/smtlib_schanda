...
(define-fun dynamic_invariant ((temp___expr_5463 us_t1) (temp___is_init_5459 Bool) (temp___skip_constant_5460 Bool) (temp___do_toplevel_5461 Bool) (temp___do_typ_inv_5462 Bool)) Bool (=> (not (= temp___skip_constant_5460 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5463) (last3 temp___expr_5463)) (and (= (first3 temp___expr_5463) 1) (= (last3 temp___expr_5463) 2)))))
