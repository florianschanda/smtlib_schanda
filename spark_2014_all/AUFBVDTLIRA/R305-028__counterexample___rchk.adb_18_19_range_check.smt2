...
(define-fun dynamic_invariant ((temp___expr_159 (_ BitVec 32)) (temp___is_init_155 Bool) (temp___skip_constant_156 Bool) (temp___do_toplevel_157 Bool) (temp___do_typ_inv_158 Bool)) Bool true)
...
(declare-datatypes () ((us_t (mk___t (elts (Array (_ BitVec 32) u32)) (rt t)))))
(define-fun to_array ((a us_t)) (Array (_ BitVec 32) u32) (elts a))
(define-fun of_array ((a (Array (_ BitVec 32) u32)) (f (_ BitVec 32)) (l (_ BitVec 32))) us_t (mk___t a (mk f l)))
...
(declare-fun object__size ((Array (_ BitVec 32) u32)) Int)
(declare-const value__component__size Int)
(declare-fun object__component__size ((Array (_ BitVec 32) u32)) Int)
(declare-const value__alignment Int)
(declare-fun object__alignment ((Array (_ BitVec 32) u32)) Int)
(assert (<= 0 value__size))
(assert (forall ((a (Array (_ BitVec 32) u32))) (<= 0 (object__size a))))
(assert (<= 0 value__component__size))
(assert (forall ((a (Array (_ BitVec 32) u32))) (<= 0 (object__component__size a))))
(assert (<= 0 value__alignment))
(assert (forall ((a (Array (_ BitVec 32) u32))) (<= 0 (object__alignment a))))
...
(define-fun dynamic_invariant1 ((temp___expr_166 us_t) (temp___is_init_162 Bool) (temp___skip_constant_163 Bool) (temp___do_toplevel_164 Bool) (temp___do_typ_inv_165 Bool)) Bool (=> (not (= temp___skip_constant_163 true)) (dynamic_property #x00000000 #xFFFFFFFF (first1 temp___expr_166) (last1 temp___expr_166))))
(declare-const buf us_t)
(declare-const attr__ATTRIBUTE_ADDRESS Int)
(declare-const size (_ BitVec 32))
(declare-const attr__ATTRIBUTE_ADDRESS1 Int)
(assert (dynamic_invariant1 buf true false true true))
(assert (bvult (to_rep (first (rt buf))) (to_rep (last (rt buf)))))
(assert (bvult (to_rep (last (rt buf))) #xFFFFFFFF))
