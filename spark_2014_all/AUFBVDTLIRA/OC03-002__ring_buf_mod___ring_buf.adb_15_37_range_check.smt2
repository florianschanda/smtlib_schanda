...
(assert (forall ((m us_t)) (forall ((x Int)) (! (=> (and (dynamic_invariant1 m true true true) (dynamic_invariant x true true true)) (dynamic_invariant1 (func_push m x) true false true)) :pattern ((func_push m x))))))
(assert (forall ((m us_t)) (forall ((x Int)) (! (=> (and (dynamic_invariant1 m true true true) (dynamic_invariant x true true true)) (= (func_push m x) (ite (= (length m) 0) (of_array (singleton1 (of_rep x) ((_ int2bv 16) 0)) ((_ int2bv 16) 0) ((_ int2bv 16) 0)) (of_array (concat1 (to_array m) (first1 m) (last1 m) (singleton1 (of_rep x) ((_ int2bv 16) 1)) ((_ int2bv 16) 1) ((_ int2bv 16) 1)) (first1 m) ((_ int2bv 16) (- (+ (bv2nat (first1 m)) (+ (ite (<= (bv2nat (first1 m)) (bv2nat (last1 m))) (+ (- (bv2nat (last1 m)) (bv2nat (first1 m))) 1) 0) 1)) 1)))))) :pattern ((func_push m x))))))
...
(declare-const temp___282 (Array (_ BitVec 16) integer))
(declare-const temp___2821 ar_index)
(declare-const temp___2822 length_type)
(declare-const o8 Int)
(declare-const o9 length_type)
(declare-const o10 (Array (_ BitVec 16) integer))
(declare-const o11 ar_index)
(declare-const o12 length_type)
(declare-const temp___284 (Array (_ BitVec 16) integer))
(declare-const temp___2841 ar_index)
(declare-const temp___2842 length_type)
...
(assert (in_range x))
(assert (not (= (is_full (mk___rep (mk___split_fields r__split_fields r__split_fields1 r__split_fields2))) true)))
(assert (= (to_rep o2) x))
(assert (not (uint_in_range (to_rep2 r__split_fields2))))
(check-sat)
(exit)
