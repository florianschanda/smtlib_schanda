...
(define-fun register_byte_array__ref___127__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_6338 us_t1) (temp___is_init_6335 Bool) (temp___skip_constant_6336 Bool) (temp___do_toplevel_6337 Bool)) Bool (=> (not (= temp___skip_constant_6336 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6338) (last3 temp___expr_6338)) (and (= (first3 temp___expr_6338) 1) (= (last3 temp___expr_6338) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___55__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_6355 us_t2) (temp___is_init_6352 Bool) (temp___skip_constant_6353 Bool) (temp___do_toplevel_6354 Bool)) Bool (=> (not (= temp___skip_constant_6353 true)) (and (dynamic_property3 1 2 (first5 temp___expr_6355) (last5 temp___expr_6355)) (and (= (first5 temp___expr_6355) 1) (= (last5 temp___expr_6355) 2)))))
...
(assert (and (= temp___81112 (register_to_bytes reg)) (dynamic_invariant1 temp___81112 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___81111)) (to_rep (last4 temp___81111))) (+ (- (to_rep (last4 temp___81111)) (to_rep (first4 temp___81111))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8111 temp___8112))
(assert (= (mk1 (to_rep (first4 temp___81111)) (to_rep (last4 temp___81111))) temp___81121))
(assert (not (= (ite (<= (to_rep (first2 temp___81121)) (to_rep (last2 temp___81121))) (+ (- (to_rep (last2 temp___81121)) (to_rep (first2 temp___81121))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
