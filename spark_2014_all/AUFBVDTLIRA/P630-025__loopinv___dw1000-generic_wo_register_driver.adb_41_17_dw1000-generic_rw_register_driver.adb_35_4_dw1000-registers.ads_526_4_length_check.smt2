...
(define-fun dynamic_invariant ((temp___expr_6971 us_t1) (temp___is_init_6967 Bool) (temp___skip_constant_6968 Bool) (temp___do_toplevel_6969 Bool) (temp___do_typ_inv_6970 Bool)) Bool (=> (not (= temp___skip_constant_6968 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6971) (last3 temp___expr_6971)) (and (= (first3 temp___expr_6971) 1) (= (last3 temp___expr_6971) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_6990 us_t2) (temp___is_init_6986 Bool) (temp___skip_constant_6987 Bool) (temp___do_toplevel_6988 Bool) (temp___do_typ_inv_6989 Bool)) Bool (=> (not (= temp___skip_constant_6987 true)) (and (dynamic_property3 1 2 (first5 temp___expr_6990) (last5 temp___expr_6990)) (and (= (first5 temp___expr_6990) 1) (= (last5 temp___expr_6990) 2)))))
...
(declare-const temp___88831 t2)
(declare-const temp___8884 (Array Int bits_8))
(declare-const temp___88841 t1)
(define-fun temp___88832 () us_t2 (mk___t2 temp___8883 temp___88831))
...
(assert (and (= temp___88832 (register_to_bytes reg)) (dynamic_invariant1 temp___88832 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___88831)) (to_rep (last4 temp___88831))) (+ (- (to_rep (last4 temp___88831)) (to_rep (first4 temp___88831))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8883 temp___8884))
(assert (= (mk1 (to_rep (first4 temp___88831)) (to_rep (last4 temp___88831))) temp___88841))
(assert (not (= (ite (<= (to_rep (first2 temp___88841)) (to_rep (last2 temp___88841))) (+ (- (to_rep (last2 temp___88841)) (to_rep (first2 temp___88841))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
