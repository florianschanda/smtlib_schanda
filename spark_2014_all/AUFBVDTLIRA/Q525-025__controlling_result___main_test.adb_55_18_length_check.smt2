...
(assert (not (= (ite (<= (to_rep2 (first2 (rt1 temp___294))) (to_rep2 (last2 (rt1 temp___294)))) (+ (- (to_rep2 (last2 (rt1 temp___294))) (to_rep2 (first2 (rt1 temp___294)))) 1) 0) (ite (<= (to_rep2 total_stream__first) (to_rep2 total_stream__last)) (+ (- (to_rep2 total_stream__last) (to_rep2 total_stream__first)) 1) 0))))
(check-sat)
(exit)
