...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__rf_txctrl_type__rf_txctrl (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__rf_txctrl_type__rf_txctrl (us_split_fields1 b)))) true false))
...
(define-fun register_byte_array__ref___94__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5317 us_t1) (temp___is_init_5314 Bool) (temp___skip_constant_5315 Bool) (temp___do_toplevel_5316 Bool)) Bool (=> (not (= temp___skip_constant_5315 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5317) (last3 temp___expr_5317)) (and (= (first3 temp___expr_5317) 1) (= (last3 temp___expr_5317) 4)))))
(declare-sort t2 0)
...
(define-fun target__ref___40__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_5333 us_t2) (temp___is_init_5330 Bool) (temp___skip_constant_5331 Bool) (temp___do_toplevel_5332 Bool)) Bool (=> (not (= temp___skip_constant_5331 true)) (and (dynamic_property3 1 4 (first5 temp___expr_5333) (last5 temp___expr_5333)) (and (= (first5 temp___expr_5333) 1) (= (last5 temp___expr_5333) 4)))))
...
(declare-const temp___8000 (Array Int bits_8))
(declare-const temp___80001 t2)
(declare-const temp___8001 (Array Int bits_8))
(declare-const temp___80011 t1)
...
(assert (and (= temp___80002 (register_to_bytes reg)) (dynamic_invariant1 temp___80002 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___80001)) (to_rep (last4 temp___80001))) (+ (- (to_rep (last4 temp___80001)) (to_rep (first4 temp___80001))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8000 temp___8001))
(assert (= (mk1 (to_rep (first4 temp___80001)) (to_rep (last4 temp___80001))) temp___80011))
(assert (not (= (ite (<= (to_rep (first2 temp___80011)) (to_rep (last2 temp___80011))) (+ (- (to_rep (last2 temp___80011)) (to_rep (first2 temp___80011))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
