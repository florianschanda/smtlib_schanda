...
(define-fun dynamic_invariant ((temp___expr_5839 us_t1) (temp___is_init_5835 Bool) (temp___skip_constant_5836 Bool) (temp___do_toplevel_5837 Bool) (temp___do_typ_inv_5838 Bool)) Bool (=> (not (= temp___skip_constant_5836 true)) (and (dynamic_property2 1 4 (first3 temp___expr_5839) (last3 temp___expr_5839)) (and (= (first3 temp___expr_5839) 1) (= (last3 temp___expr_5839) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_5857 us_t2) (temp___is_init_5853 Bool) (temp___skip_constant_5854 Bool) (temp___do_toplevel_5855 Bool) (temp___do_typ_inv_5856 Bool)) Bool (=> (not (= temp___skip_constant_5854 true)) (and (dynamic_property3 1 4 (first5 temp___expr_5857) (last5 temp___expr_5857)) (and (= (first5 temp___expr_5857) 1) (= (last5 temp___expr_5857) 4)))))
...
(declare-const temp___87721 t2)
(declare-const temp___8773 (Array Int bits_8))
(declare-const temp___87731 t1)
(define-fun temp___87722 () us_t2 (mk___t2 temp___8772 temp___87721))
...
(assert (and (= temp___87722 (register_to_bytes reg)) (dynamic_invariant1 temp___87722 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___87721)) (to_rep (last4 temp___87721))) (+ (- (to_rep (last4 temp___87721)) (to_rep (first4 temp___87721))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8772 temp___8773))
(assert (= (mk1 (to_rep (first4 temp___87721)) (to_rep (last4 temp___87721))) temp___87731))
(assert (not (= (ite (<= (to_rep (first2 temp___87731)) (to_rep (last2 temp___87731))) (+ (- (to_rep (last2 temp___87731)) (to_rep (first2 temp___87731))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
