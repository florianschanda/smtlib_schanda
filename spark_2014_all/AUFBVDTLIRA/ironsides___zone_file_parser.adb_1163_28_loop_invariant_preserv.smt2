...
(assert (<= r78b i14))
(assert (<= i14 r79b))
(assert (and (<= 1 begidx15) (<= (+ (- endidx11 begidx15) 1) 128)))
(assert (and (=> (<= r78b r79b) (dynamic_property1 r78b r79b i15)) (and (<= r78b i15) (<= i15 r79b))))
(assert (= (to_rep o6) (to_rep (select zonefileline i15))))
(assert (and (= o4 (+ i15 1)) (in_range1 (+ i15 1))))
(assert (= o5 (- o4 begidx15)))
(assert (and (= temp___1681 o5) (in_range1 o5)))
(assert (and (<= 1 temp___1681) (<= temp___1681 128)))
(assert (= o7 temp___1681))
(assert (= o8 (store newdomainname2 o7 o6)))
(assert (= result14 (mk_map__ref newdomainname2)))
(assert (= newdomainname3 o8))
(assert (not (= i15 r79b)))
(assert (= result15 (mk_int__ref i15)))
(assert (= i16 (+ i15 1)))
(assert (= i17 (mk_int__ref i16)))
