...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i13 Int)) (=> (and (<= begidx2 i13) (<= i13 endidx1)) (and (<= 48 (to_rep (select zonefileline i13))) (<= (to_rep (select zonefileline i13)) 57)))))) (and (and (in_range4 begidx2) (in_range4 endidx1)) (in_range3 foundtype1))))
...
(assert (=> (and (not (= foundtype1 3)) (< endidx1 zlength)) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i13 Int)) (=> (and (<= begidx5 i13) (<= i13 endidx3)) (and (<= 48 (to_rep (select zonefileline i13))) (<= (to_rep (select zonefileline i13)) 57)))))) (and (and (in_range4 begidx5) (in_range4 endidx3)) (in_range3 foundtype3)))))
...
(assert (= begidx10 o1))
(assert (and (and (and (and (<= begidx11 endidx8) (<= begidx11 zlength)) (<= endidx8 zlength)) (=> (= foundtype8 1) (forall ((i13 Int)) (=> (and (<= begidx11 i13) (<= i13 endidx8)) (and (<= 48 (to_rep (select zonefileline i13))) (<= (to_rep (select zonefileline i13)) 57)))))) (and (and (in_range4 begidx11) (in_range4 endidx8)) (in_range3 foundtype8))))
(assert (= foundtype8 1))
...
(assert (= i2 r75b))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= temp___1737 i2)))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= temp___1736 tmpval1)))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= temp___1735 digitval)))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (and (<= 1 begidx11) (bvule tmpval2 #x7FFF))))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (and (=> (<= r75b r76b) (dynamic_property r75b r76b i3)) (and (<= r75b i3) (<= i3 r76b)))))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= result7 (mk_t__ref digitval2))))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= digitval3 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i3))) #x0030))))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= result8 (mk_t__ref tmpval2))))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= tmpval3 (bvadd (bvmul #x000A tmpval2) digitval3))))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (or (bvugt tmpval3 #x7FFF) (and (not (bvugt tmpval3 #x7FFF)) (= i3 r76b)))))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= i4 (mk_int__ref i3))))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= tmpval4 (mk_t__ref tmpval3))))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= digitval4 (mk_t__ref digitval3))))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= i5 i3)))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= tmpval5 tmpval3)))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= digitval5 digitval3)))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= i6 i4)))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= tmpval6 tmpval4)))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= digitval6 digitval4)))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= i7 i5)))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= tmpval7 tmpval5)))
(assert (=> (and (<= r75b i2) (<= i2 r76b)) (= digitval7 digitval5)))
(assert (=> (not (and (<= r75b i2) (<= i2 r76b))) (= i6 (mk_int__ref i2))))
(assert (=> (not (and (<= r75b i2) (<= i2 r76b))) (= tmpval6 (mk_t__ref tmpval1))))
(assert (=> (not (and (<= r75b i2) (<= i2 r76b))) (= digitval6 (mk_t__ref digitval))))
(assert (=> (not (and (<= r75b i2) (<= i2 r76b))) (= i7 i2)))
(assert (=> (not (and (<= r75b i2) (<= i2 r76b))) (= tmpval7 tmpval1)))
(assert (=> (not (and (<= r75b i2) (<= i2 r76b))) (= digitval7 digitval1)))
...
(assert (= begidx12 o2))
(assert (and (and (and (and (<= begidx13 endidx9) (<= begidx13 zlength)) (<= endidx9 zlength)) (=> (= foundtype9 1) (forall ((i13 Int)) (=> (and (<= begidx13 i13) (<= i13 endidx9)) (and (<= 48 (to_rep (select zonefileline i13))) (<= (to_rep (select zonefileline i13)) 57)))))) (and (and (in_range4 begidx13) (in_range4 endidx9)) (in_range3 foundtype9))))
...
(assert (<= r78b i8))
(assert (<= i8 r79b))
(assert (and (<= 1 begidx13) (<= (+ (- endidx9 begidx13) 1) 128)))
(assert (and (=> (<= r78b r79b) (dynamic_property1 r78b r79b i9)) (and (<= r78b i9) (<= i9 r79b))))
(assert (= (to_rep o6) (to_rep (select zonefileline i9))))
(assert (and (= o4 (+ i9 1)) (in_range1 (+ i9 1))))
(assert (= o5 (- o4 begidx13)))
(assert (and (= temp___1740 o5) (in_range1 o5)))
(assert (and (<= 1 temp___1740) (<= temp___1740 128)))
(assert (= o7 temp___1740))
(assert (= o8 (store newdomainname2 o7 o6)))
(assert (= result13 (mk_map__ref newdomainname2)))
(assert (= newdomainname3 o8))
(assert (not (= i9 r79b)))
(assert (= result14 (mk_int__ref i9)))
(assert (= i10 (+ i9 1)))
(assert (= i11 (mk_int__ref i10)))
(assert (= newdomainname4 (mk_map__ref newdomainname3)))
(assert (= i12 i10))
(assert (= newdomainname5 newdomainname3))
