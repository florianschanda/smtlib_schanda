...
(assert (<= 0 subject1))
(assert (<= subject1 6))
(assert (not (= (bvurem (to_rep (rec__skp__subjects__subject_spec_type__pml4_address (us_split_fields7 (select subject_specs subject1)))) ((_ int2bv 64) 4096)) ((_ int2bv 64) 0))))
(check-sat)
(exit)
