...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k (- i2 1))) (= (to_rep1 (select a1 k)) ((_ int2bv 32) 0)))))
(assert (and (and (forall ((temp___550 Int)) (=> (and (<= (to_rep a__first) temp___550) (<= temp___550 (to_rep a__last))) (=> (<= i2 temp___550) (= (select a1 temp___550) (select a temp___550))))) (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2))) (and (<= a_first i2) (<= i2 a_last))))
(assert (= (to_rep1 o) ((_ int2bv 32) 0)))
...
(assert (<= a_first k))
(assert (<= k (- i3 1)))
(assert (not (= (to_rep1 (select a2 k)) ((_ int2bv 32) 0))))
(check-sat)
(exit)
