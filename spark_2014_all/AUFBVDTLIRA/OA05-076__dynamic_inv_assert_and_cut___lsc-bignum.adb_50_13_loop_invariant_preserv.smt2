...
(define-fun dynamic_invariant2 ((temp___expr_328 Int) (temp___is_init_324 Bool) (temp___skip_constant_325 Bool) (temp___do_toplevel_326 Bool) (temp___do_typ_inv_327 Bool)) Bool (=> (or (= temp___is_init_324 true) (<= 0 2147483646)) (in_range3 temp___expr_328)))
(define-fun dynamic_invariant3 ((temp___expr_335 us_t) (temp___is_init_331 Bool) (temp___skip_constant_332 Bool) (temp___do_toplevel_333 Bool) (temp___do_typ_inv_334 Bool)) Bool (=> (not (= temp___skip_constant_332 true)) (dynamic_property 0 2147483646 (first1 temp___expr_335) (last1 temp___expr_335))))
...
(declare-const i Int)
(declare-const o word32)
(declare-const o1 Int)
(declare-const o2 (Array Int word32))
...
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (forall ((k Int)) (=> (and (<= a_first k) (<= k (- i2 1))) (= (to_rep1 (select a1 k)) #x00000000))))
(assert (and (and (forall ((temp___620 Int)) (=> (and (<= (to_rep a__first) temp___620) (<= temp___620 (to_rep a__last))) (=> (<= i2 temp___620) (= (select a1 temp___620) (select a temp___620))))) (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2))) (and (<= a_first i2) (<= i2 a_last))))
(assert (= (to_rep1 o) #x00000000))
...
(assert (<= a_first k))
(assert (<= k (- i3 1)))
(assert (not (= (to_rep1 (select a2 k)) #x00000000)))
(check-sat)
(exit)
