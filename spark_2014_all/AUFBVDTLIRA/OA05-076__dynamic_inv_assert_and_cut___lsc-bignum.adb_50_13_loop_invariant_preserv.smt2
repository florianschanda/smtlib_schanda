...
(define-fun dynamic_invariant2 ((temp___expr_283 Int) (temp___is_init_280 Bool) (temp___skip_constant_281 Bool) (temp___do_toplevel_282 Bool)) Bool (=> (or (= temp___is_init_280 true) (<= 0 2147483646)) (in_range3 temp___expr_283)))
(define-fun dynamic_invariant3 ((temp___expr_289 us_t) (temp___is_init_286 Bool) (temp___skip_constant_287 Bool) (temp___do_toplevel_288 Bool)) Bool (=> (not (= temp___skip_constant_287 true)) (dynamic_property 0 2147483646 (first1 temp___expr_289) (last1 temp___expr_289))))
...
(declare-const temp___549 (Array Int word32))
(declare-const k Int)
(declare-const us Int)
(declare-const o Int)
(declare-const o1 Bool)
(declare-const o2 word32)
...
(assert (and (and (and (<= (to_rep a__first) a_first) (<= a_first (to_rep a__last))) (and (<= (to_rep a__first) a_last) (<= a_last (to_rep a__last)))) (<= a_first a_last)))
(assert (= (mk_int__ref result) (mk_int__ref i)))
(assert (= i1 a_first))
(assert (<= a_first i1))
(assert (<= i1 a_last))
(assert (forall ((k2 Int)) (=> (and (<= a_first k2) (<= k2 (- i2 1))) (= (to_rep1 (select a2 k2)) ((_ int2bv 32) 0)))))
(assert (and (and (forall ((temp___550 Int)) (=> (and (<= (to_rep a__first) temp___550) (<= temp___550 (to_rep a__last))) (=> (<= i2 temp___550) (= (select a2 temp___550) (select a temp___550))))) (=> (<= a_first a_last) (dynamic_property1 a_first a_last i2))) (and (<= a_first i2) (<= i2 a_last))))
(assert (= (to_rep1 o2) ((_ int2bv 32) 0)))
(assert (and (<= (to_rep a__first) i2) (<= i2 (to_rep a__last))))
(assert (= o3 i2))
(assert (= o4 (store a2 o3 o2)))
(assert (= a2 result2))
(assert (= a3 o4))
(assert (not (= i2 a_last)))
(assert (= result3 i2))
(assert (= i3 (+ i2 1)))
(declare-const k2 Int)
(assert (<= a_first k2))
(assert (<= k2 (- i3 1)))
(assert (not (= (to_rep1 (select a3 k2)) ((_ int2bv 32) 0))))
(check-sat)
(exit)
