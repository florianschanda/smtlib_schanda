...
(assert (= r_digit1 o11))
(assert (= (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) r94b))
...
(assert (= temp___1050 (- o18 1)))
(assert (and (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1050) (<= temp___1050 (to_rep1 (last2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))))))
(assert (= o19 temp___1050))
...
(assert (= (to_rep2 o25) o24))
(assert (and (= o23 (+ i2 j2)) (in_range2 (+ i2 j2))))
(assert (= temp___1052 (- o23 1)))
(assert (not (<= (to_rep1 (first2 (rt1 (rec__very_longs__very_long__long_digits1 result____split_fields4)))) temp___1052)))
(check-sat)
(exit)
