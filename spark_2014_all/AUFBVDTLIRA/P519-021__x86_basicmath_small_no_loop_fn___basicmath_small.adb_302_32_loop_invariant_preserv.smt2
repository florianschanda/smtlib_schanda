...
(assert (= (ite signflag3 1 0) (ite overflowflag3 1 0)))
(assert (not (= (let ((subject rsp)) rsp16) (let ((subject rsp)) rsp13))))
(check-sat)
(exit)
