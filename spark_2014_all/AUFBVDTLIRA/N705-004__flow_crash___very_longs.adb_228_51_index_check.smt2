...
(assert (= l_digit1 o7))
(assert (not (<= i2 (to_rep1 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 r))))))))
(check-sat)
(exit)
