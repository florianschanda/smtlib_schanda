...
(define-fun dynamic_invariant ((temp___expr_6218 us_t1) (temp___is_init_6215 Bool) (temp___skip_constant_6216 Bool) (temp___do_toplevel_6217 Bool)) Bool (=> (not (= temp___skip_constant_6216 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6218) (last3 temp___expr_6218)) (and (= (first3 temp___expr_6218) 1) (= (last3 temp___expr_6218) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_6237 us_t2) (temp___is_init_6234 Bool) (temp___skip_constant_6235 Bool) (temp___do_toplevel_6236 Bool)) Bool (=> (not (= temp___skip_constant_6235 true)) (and (dynamic_property3 1 2 (first5 temp___expr_6237) (last5 temp___expr_6237)) (and (= (first5 temp___expr_6237) 1) (= (last5 temp___expr_6237) 2)))))
...
(assert (and (= (mk___t2 temp___8097 temp___80971) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8097 temp___80971) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___80971)) (to_rep (last4 temp___80971))) (+ (- (to_rep (last4 temp___80971)) (to_rep (first4 temp___80971))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
