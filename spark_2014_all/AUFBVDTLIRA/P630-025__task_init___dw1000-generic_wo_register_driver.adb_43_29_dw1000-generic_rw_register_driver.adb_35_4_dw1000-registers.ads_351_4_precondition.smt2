...
(define-fun dynamic_invariant ((temp___expr_4212 us_t1) (temp___is_init_4209 Bool) (temp___skip_constant_4210 Bool) (temp___do_toplevel_4211 Bool)) Bool (=> (not (= temp___skip_constant_4210 true)) (and (dynamic_property2 1 4 (first3 temp___expr_4212) (last3 temp___expr_4212)) (and (= (first3 temp___expr_4212) 1) (= (last3 temp___expr_4212) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_4237 us_t2) (temp___is_init_4234 Bool) (temp___skip_constant_4235 Bool) (temp___do_toplevel_4236 Bool)) Bool (=> (not (= temp___skip_constant_4235 true)) (and (dynamic_property3 1 4 (first5 temp___expr_4237) (last5 temp___expr_4237)) (and (= (first5 temp___expr_4237) 1) (= (last5 temp___expr_4237) 4)))))
...
(assert (and (= (mk___t2 temp___7891 temp___78911) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7891 temp___78911) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___78911)) (to_rep (last4 temp___78911))) (+ (- (to_rep (last4 temp___78911)) (to_rep (first4 temp___78911))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___7891 temp___7892))
(assert (= (mk1 (to_rep (first4 temp___78911)) (to_rep (last4 temp___78911))) temp___78921))
(assert (= (ite (<= (to_rep (first2 temp___78921)) (to_rep (last2 temp___78921))) (+ (- (to_rep (last2 temp___78921)) (to_rep (first2 temp___78921))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
