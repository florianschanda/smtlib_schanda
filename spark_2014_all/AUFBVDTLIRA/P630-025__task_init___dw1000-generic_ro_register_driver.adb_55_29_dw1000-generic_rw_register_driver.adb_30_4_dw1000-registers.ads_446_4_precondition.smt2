...
(define-fun dynamic_invariant ((temp___expr_5907 us_t1) (temp___is_init_5903 Bool) (temp___skip_constant_5904 Bool) (temp___do_toplevel_5905 Bool) (temp___do_typ_inv_5906 Bool)) Bool (=> (not (= temp___skip_constant_5904 true)) (and (dynamic_property2 1 5 (first3 temp___expr_5907) (last3 temp___expr_5907)) (and (= (first3 temp___expr_5907) 1) (= (last3 temp___expr_5907) 5)))))
