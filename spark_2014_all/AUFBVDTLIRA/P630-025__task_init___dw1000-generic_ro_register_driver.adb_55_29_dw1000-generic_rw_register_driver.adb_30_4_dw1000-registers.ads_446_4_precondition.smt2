...
(define-fun in_range2 ((x (_ BitVec 64))) Bool (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 1099511627775))))
...
(assert (forall ((x (_ BitVec 64))) (! (let ((y (bvurem x ((_ int2bv 64) 1099511627776)))) (=> (in_range2 y) (= (to_rep2 (of_rep2 x)) y))) :pattern ((to_rep2 (of_rep2 x))))))
...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__ldotune_type__ldotune (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__ldotune_type__ldotune (us_split_fields1 b)))) true false))
...
(define-fun register_type__ref___136__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___96__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___96__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5378 us_t1) (temp___is_init_5375 Bool) (temp___skip_constant_5376 Bool) (temp___do_toplevel_5377 Bool)) Bool (=> (not (= temp___skip_constant_5376 true)) (and (dynamic_property2 1 5 (first3 temp___expr_5378) (last3 temp___expr_5378)) (and (= (first3 temp___expr_5378) 1) (= (last3 temp___expr_5378) 5)))))
