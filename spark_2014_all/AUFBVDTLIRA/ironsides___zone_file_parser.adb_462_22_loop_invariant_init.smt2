...
(assert (= begidx1 1))
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= foundtype1 1) (forall ((i28 Int)) (=> (and (<= begidx2 i28) (<= i28 endidx1)) (and (<= 48 (to_rep (select zonefileline i28))) (<= (to_rep (select zonefileline i28)) 57)))))) (and (and (in_range5 begidx2) (in_range5 endidx1)) (in_range4 foundtype1))))
...
(assert (=> (= success1 true) (=> (not (= (+ (- endidx1 begidx2) 1) 14)) (= i18 i26))))
(assert (=> (= success1 true) (=> (not (= (+ (- endidx1 begidx2) 1) 14)) (= i17 i27))))
...
(assert (=> (= success1 true) (=> (not (not (= (+ (- endidx1 begidx2) 1) 14))) (= result4 i27))))
...
(assert (=> (= success1 true) (=> (not (not (= (+ (- endidx1 begidx2) 1) 14))) (= result6 i26))))
...
(assert (=> (not (= success1 true)) (= i22 i26)))
(assert (=> (not (= success1 true)) (= i21 i27)))
...
(assert (=> (= success20 true) (and (and (and (and (<= begidx4 endidx2) (<= begidx4 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i28 Int)) (=> (and (<= begidx4 i28) (<= i28 endidx2)) (and (<= 48 (to_rep (select zonefileline i28))) (<= (to_rep (select zonefileline i28)) 57)))))) (and (and (in_range5 begidx4) (in_range5 endidx2)) (in_range4 foundtype2)))))
...
(assert (= begidx7 o48))
(assert (and (and (and (and (<= begidx8 endidx5) (<= begidx8 zlength)) (<= endidx5 zlength)) (=> (= foundtype5 1) (forall ((i28 Int)) (=> (and (<= begidx8 i28) (<= i28 endidx5)) (and (<= 48 (to_rep (select zonefileline i28))) (<= (to_rep (select zonefileline i28)) 57)))))) (and (and (in_range5 begidx8) (in_range5 endidx5)) (in_range4 foundtype5))))
