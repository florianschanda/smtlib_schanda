...
(assert (and (and (and (and (and (<= 0 endidx2) (< endidx2 256)) (<= 1 numberofrecordtypes3)) (< numberofrecordtypes3 32)) (= numberofblocks2 1)) (forall ((j26 (_ BitVec 8))) (=> (and (bvule ((_ int2bv 8) 0) j26) (bvule j26 ((_ int2bv 8) 255))) (and (<= 1 (to_rep3 (select blocklengthmap3 j26))) (<= (to_rep3 (select blocklengthmap3 j26)) 32))))))
(assert (and (and (and (and (and (and (=> (<= 0 32) (in_range6 numberofrecordtypes3)) (=> (<= 0 18) (in_range5 recordtype3))) (=> (<= 1 256) (in_range3 begidx3))) (=> (<= 1 256) (in_range3 endidx2))) (=> (<= 1 32) (in_range10 bytenumber3))) (=> (<= 0 10) (in_range2 foundtype2))) (and (and (= foundtype2 3) (< endidx2 256)) (< numberofrecordtypes3 32))))
(assert (and (and (and (and (<= begidx4 endidx3) (<= begidx4 256)) (<= endidx3 256)) (=> (= foundtype3 1) (forall ((i34 Int)) (=> (and (<= begidx4 i34) (<= i34 endidx3)) (and (<= 48 (to_rep (select rrstring i34))) (<= (to_rep (select rrstring i34)) 57)))))) (and (and (in_range3 begidx4) (in_range3 endidx3)) (in_range2 foundtype3))))
(assert (= foundtype3 3))
(assert (and (= o22 (getrecordtype rrstring begidx4 endidx3)) (in_range5 o22)))
(assert (= result18 (mk_int__ref recordtype3)))
(assert (= recordtype4 o22))
