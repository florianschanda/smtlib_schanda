...
(assert (not (in_range2 (+ (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))) (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))))))
(check-sat)
(exit)
