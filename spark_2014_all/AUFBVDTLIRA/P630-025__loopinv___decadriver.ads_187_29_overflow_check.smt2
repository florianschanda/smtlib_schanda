...
(define-fun dynamic_invariant1 ((temp___expr_665 us_t) (temp___is_init_662 Bool) (temp___skip_constant_663 Bool) (temp___do_toplevel_664 Bool)) Bool (=> (not (= temp___skip_constant_663 true)) (dynamic_property 0 2147483647 (first1 temp___expr_665) (last1 temp___expr_665))))
...
(define-fun us_split_fields__ref___139__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___141__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
...
(define-fun default_initial_assumption ((temp___expr_4480 us_rep) (temp___skip_top_level_4481 Bool)) Bool (= (rec__decadriver__transmitter_type__tx_idle (us_split_fields1 temp___expr_4480)) (of_int 1)))
...
(define-fun dynamic_invariant3 ((temp___expr_323 (_ BitVec 8)) (temp___is_init_320 Bool) (temp___skip_constant_321 Bool) (temp___do_toplevel_322 Bool)) Bool true)
(declare-const o Int)
(declare-const o1 Int)
(declare-const o2 Int)
(assert (dynamic_invariant1 data true false true))
