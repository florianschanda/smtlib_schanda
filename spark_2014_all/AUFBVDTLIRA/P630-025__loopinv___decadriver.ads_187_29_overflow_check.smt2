...
(define-fun dynamic_invariant1 ((temp___expr_763 us_t) (temp___is_init_759 Bool) (temp___skip_constant_760 Bool) (temp___do_toplevel_761 Bool) (temp___do_typ_inv_762 Bool)) Bool (=> (not (= temp___skip_constant_760 true)) (dynamic_property 0 2147483647 (first1 temp___expr_763) (last1 temp___expr_763))))
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__decadriver__transmitter_type__tx_idle Bool)))))
(define-fun us_split_fields_Tx_Idle__projection ((a us_split_fields)) Bool (rec__decadriver__transmitter_type__tx_idle a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___142__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___144__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
...
(declare-datatypes () ((transmitter_type__ref (mk_transmitter_type__ref (transmitter_type__content us_rep)))))
(define-fun transmitter_type__ref___projection ((a transmitter_type__ref)) us_rep (transmitter_type__content a))
(define-fun default_initial_assumption ((temp___expr_5030 us_rep) (temp___skip_top_level_5031 Bool)) Bool (= (rec__decadriver__transmitter_type__tx_idle (us_split_fields1 temp___expr_5030)) (distinct 1 0)))
...
(define-fun dynamic_invariant3 ((temp___expr_364 (_ BitVec 8)) (temp___is_init_360 Bool) (temp___skip_constant_361 Bool) (temp___do_toplevel_362 Bool) (temp___do_typ_inv_363 Bool)) Bool true)
(declare-const o Int)
(declare-const o1 Int)
(assert (dynamic_invariant1 data true false true true))
(assert (in_range2 offset))
(assert (<= 1 (length data)))
(assert (<= (length data) 1024))
(assert (< offset 1024))
(assert (and (= o (length data)) (in_range1 (length data))))
(assert (= o1 (+ o offset)))
