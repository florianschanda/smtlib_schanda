...
(define-fun target__ref___14__projection ((a target__ref)) us_t1 (target__content a))
...
(define-fun dynamic_invariant ((temp___expr_3564 us_t1) (temp___is_init_3560 Bool) (temp___skip_constant_3561 Bool) (temp___do_toplevel_3562 Bool) (temp___do_typ_inv_3563 Bool)) Bool (=> (not (= temp___skip_constant_3561 true)) (and (dynamic_property2 1 4 (first3 temp___expr_3564) (last3 temp___expr_3564)) (and (= (first3 temp___expr_3564) 1) (= (last3 temp___expr_3564) 4)))))
...
(define-fun register_byte_array__ref___36__projection ((a register_byte_array__ref)) us_t2 (register_byte_array__content a))
(define-fun dynamic_invariant1 ((temp___expr_3543 us_t2) (temp___is_init_3539 Bool) (temp___skip_constant_3540 Bool) (temp___do_toplevel_3541 Bool) (temp___do_typ_inv_3542 Bool)) Bool (=> (not (= temp___skip_constant_3540 true)) (and (dynamic_property3 1 4 (first5 temp___expr_3543) (last5 temp___expr_3543)) (and (= (first5 temp___expr_3543) 1) (= (last5 temp___expr_3543) 4)))))
...
(declare-const temp___85721 t1)
(declare-const temp___8573 (Array Int bits_8))
(declare-const temp___85731 t2)
(define-fun temp___85722 () us_t1 (mk___t1 temp___8572 temp___85721))
...
(assert (and (= temp___85722 (register_to_bytes reg)) (dynamic_invariant temp___85722 true false true true)))
(assert (= (ite (<= (to_rep (first2 temp___85721)) (to_rep (last2 temp___85721))) (+ (- (to_rep (last2 temp___85721)) (to_rep (first2 temp___85721))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0)))
(assert (= temp___8572 temp___8573))
(assert (= (mk2 (to_rep (first2 temp___85721)) (to_rep (last2 temp___85721))) temp___85731))
(assert (not (= (ite (<= (to_rep (first4 temp___85731)) (to_rep (last4 temp___85731))) (+ (- (to_rep (last4 temp___85731)) (to_rep (first4 temp___85731))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
