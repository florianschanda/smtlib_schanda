...
(assert (and (and (and (= (rec__skein__skein_512_context__h local_ctx__split_fields14) (rec__skein__skein_512_context__h local_ctx__split_fields13)) (= (rec__skein__skein_512_context__x local_ctx__split_fields14) (rec__skein__skein_512_context__x local_ctx__split_fields13))) (forall ((temp___1573 (_ BitVec 64))) (=> (and (bvule #x0000000000000000 temp___1573) (bvule temp___1573 #x000000000000003F)) (=> (or (bvult #x000000000000003F temp___1573) (or (bvult temp___1573 r250b) (bvule i2 temp___1573))) (= (select (rec__skein__skein_512_context__b local_ctx__split_fields14) temp___1573) (select (rec__skein__skein_512_context__b local_ctx__split_fields13) temp___1573)))))) (and (bvule r250b i2) (bvule i2 #x000000000000003F))))
(assert (= (to_rep1 o1) #x00))
(assert (= temp___1569 (store (rec__skein__skein_512_context__b local_ctx__split_fields14) i2 o1)))
(assert (not (dynamic_predicate temp___1569)))
(check-sat)
(exit)
