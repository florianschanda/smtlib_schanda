...
(assert (and (and (and (= (rec__skein__skein_512_context__h local_ctx__split_fields14) (rec__skein__skein_512_context__h local_ctx__split_fields13)) (= (rec__skein__skein_512_context__x local_ctx__split_fields14) (rec__skein__skein_512_context__x local_ctx__split_fields13))) (forall ((temp___1425 (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) temp___1425) (bvule temp___1425 ((_ int2bv 64) 63))) (=> (bvule i2 temp___1425) (= (select (rec__skein__skein_512_context__b local_ctx__split_fields14) temp___1425) (select (rec__skein__skein_512_context__b local_ctx__split_fields13) temp___1425)))))) (and (bvule r250b i2) (bvule i2 ((_ int2bv 64) 63)))))
(assert (= (to_rep1 o1) ((_ int2bv 8) 0)))
(assert (= temp___1421 (store (rec__skein__skein_512_context__b local_ctx__split_fields14) i2 o1)))
(assert (not (dynamic_predicate temp___1421)))
(check-sat)
(exit)
