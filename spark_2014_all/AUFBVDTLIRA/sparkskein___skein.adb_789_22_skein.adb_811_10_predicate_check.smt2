...
(assert (bvule i1 #x000000000000003F))
(assert (and (and (and (= (rec__skein__skein_512_context__h local_ctx__split_fields14) (rec__skein__skein_512_context__h local_ctx__split_fields13)) (= (rec__skein__skein_512_context__x local_ctx__split_fields14) (rec__skein__skein_512_context__x local_ctx__split_fields13))) (forall ((temp___1578 (_ BitVec 64))) (=> (and (bvule #x0000000000000000 temp___1578) (bvule temp___1578 #x000000000000003F)) (=> (bvule i2 temp___1578) (= (select (rec__skein__skein_512_context__b local_ctx__split_fields14) temp___1578) (select (rec__skein__skein_512_context__b local_ctx__split_fields13) temp___1578)))))) (and (bvule r250b i2) (bvule i2 #x000000000000003F))))
(assert (= (to_rep1 o1) #x00))
(assert (= temp___1574 (store (rec__skein__skein_512_context__b local_ctx__split_fields14) i2 o1)))
(assert (not (dynamic_predicate temp___1574)))
(check-sat)
(exit)
