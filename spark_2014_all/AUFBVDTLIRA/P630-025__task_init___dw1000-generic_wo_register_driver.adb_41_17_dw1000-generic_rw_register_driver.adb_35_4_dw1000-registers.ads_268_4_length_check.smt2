...
(assert (= (ite (<= (to_rep (first2 temp___85511)) (to_rep (last2 temp___85511))) (+ (- (to_rep (last2 temp___85511)) (to_rep (first2 temp___85511))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8551 temp___8552))
(assert (= (mk2 (to_rep (first2 temp___85511)) (to_rep (last2 temp___85511))) temp___85521))
(assert (not (= (ite (<= (to_rep (first4 temp___85521)) (to_rep (last4 temp___85521))) (+ (- (to_rep (last4 temp___85521)) (to_rep (first4 temp___85521))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
