...
(assert (= i8 r86b))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= temp___1765 i8)))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= temp___1764 tmpval8)))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= temp___1763 (t__content digitval6))))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (and (<= 1 begidx13) (bvule tmpval9 #x7FFF))))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (and (=> (<= r86b r87b) (dynamic_property1 r86b r87b i9)) (and (<= r86b i9) (<= i9 r87b)))))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= result15 (mk_t__ref digitval8))))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= digitval9 (bvsub ((_ int2bv 16) (to_rep (select zonefileline i9))) #x0030))))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= result16 (mk_t__ref tmpval9))))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= tmpval10 (bvadd (bvmul #x000A tmpval9) digitval9))))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (or (bvugt tmpval10 #x7FFF) (and (not (bvugt tmpval10 #x7FFF)) (= i9 r87b)))))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= i10 (mk_int__ref i9))))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= tmpval11 (mk_t__ref tmpval10))))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= digitval10 (mk_t__ref digitval9))))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= i11 i9)))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= tmpval12 tmpval10)))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= digitval11 digitval9)))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= i12 i10)))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= tmpval13 tmpval11)))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= digitval12 digitval10)))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= i13 i11)))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= tmpval14 tmpval12)))
(assert (=> (and (<= r86b i8) (<= i8 r87b)) (= digitval13 digitval11)))
(assert (=> (not (and (<= r86b i8) (<= i8 r87b))) (= i12 (mk_int__ref i8))))
(assert (=> (not (and (<= r86b i8) (<= i8 r87b))) (= tmpval13 (mk_t__ref tmpval8))))
(assert (=> (not (and (<= r86b i8) (<= i8 r87b))) (= digitval12 digitval6)))
(assert (=> (not (and (<= r86b i8) (<= i8 r87b))) (= i13 i8)))
(assert (=> (not (and (<= r86b i8) (<= i8 r87b))) (= tmpval14 tmpval8)))
(assert (=> (not (and (<= r86b i8) (<= i8 r87b))) (= digitval13 digitval7)))
