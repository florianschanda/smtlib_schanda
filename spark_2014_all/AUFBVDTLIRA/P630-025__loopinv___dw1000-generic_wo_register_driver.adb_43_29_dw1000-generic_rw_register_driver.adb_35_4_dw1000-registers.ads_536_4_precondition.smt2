...
(define-fun in_range3 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x3FFF)))
...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x4000))) (=> (in_range3 y) (= (to_rep3 (of_rep3 x)) y))) :pattern ((to_rep3 (of_rep3 x))))))
...
(define-fun dynamic_invariant ((temp___expr_7138 us_t1) (temp___is_init_7134 Bool) (temp___skip_constant_7135 Bool) (temp___do_toplevel_7136 Bool) (temp___do_typ_inv_7137 Bool)) Bool (=> (not (= temp___skip_constant_7135 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7138) (last3 temp___expr_7138)) (and (= (first3 temp___expr_7138) 1) (= (last3 temp___expr_7138) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_7158 us_t2) (temp___is_init_7154 Bool) (temp___skip_constant_7155 Bool) (temp___do_toplevel_7156 Bool) (temp___do_typ_inv_7157 Bool)) Bool (=> (not (= temp___skip_constant_7155 true)) (and (dynamic_property3 1 2 (first5 temp___expr_7158) (last5 temp___expr_7158)) (and (= (first5 temp___expr_7158) 1) (= (last5 temp___expr_7158) 2)))))
...
(declare-const temp___8897 (Array Int bits_8))
(declare-const temp___88971 t2)
(declare-const temp___8898 (Array Int bits_8))
(declare-const temp___88981 t1)
...
(define-fun temp___88972 () us_t2 (mk___t2 temp___8897 temp___88971))
...
(assert (and (= temp___88972 (register_to_bytes reg)) (dynamic_invariant1 temp___88972 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___88971)) (to_rep (last4 temp___88971))) (+ (- (to_rep (last4 temp___88971)) (to_rep (first4 temp___88971))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8897 temp___8898))
(assert (= (mk1 (to_rep (first4 temp___88971)) (to_rep (last4 temp___88971))) temp___88981))
(assert (= (ite (<= (to_rep (first2 temp___88981)) (to_rep (last2 temp___88981))) (+ (- (to_rep (last2 temp___88981)) (to_rep (first2 temp___88981))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8898 temp___88981)))
(assert (= o2 o))
