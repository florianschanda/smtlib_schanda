...
(assert (=> (< digit_count3 index2) (forall ((j Int)) (=> (and (<= (+ digit_count3 1) j) (<= j index2)) (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j)) ((_ int2bv 8) 0))))))
