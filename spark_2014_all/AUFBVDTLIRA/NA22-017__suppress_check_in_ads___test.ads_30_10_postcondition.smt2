...
(assert (=> (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))) (and (and (= temp___281 i2) (and (= temp___279 result__) (and (and (and (and (and (and (and (and (and (<= (to_rep (first (rt right))) i2) (<= i2 (to_rep (last (rt right))))) (= o3 i2)) (= o4 (select (elts right) o3))) (= o5 (to_rep1 o4))) (and (and (and (and (and (<= (to_rep (first (rt left))) i2) (<= i2 (to_rep (last (rt left))))) (= o i2)) (= o1 (select (elts left) o))) (= o2 (to_rep1 o1))) (and (= o6 (xor2 o2 o5)) (= o6 (bvxor o2 o5))))) (= (to_rep1 o7) o6)) (= o8 (store result__ i2 o7))) (and (= (mk_map__ref result1) (mk_map__ref result__)) (= result__2 o8))) (and (forall ((pos1 Int)) (=> (and (<= (to_rep result____first) pos1) (<= pos1 i3)) (= (to_rep1 (select result__3 pos1)) (xor2 (to_rep1 (select (elts left) pos1)) (to_rep1 (select (elts right) pos1)))))) (and (and (and (forall ((temp___280 Int)) (=> (and (<= (to_rep result____first) temp___280) (<= temp___280 (to_rep result____last))) (=> (< i3 temp___280) (= (select result__3 temp___280) (select temp___279 temp___280))))) (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i3))) (and (<= (to_rep result____first) i3) (<= i3 (to_rep result____last)))) (= i3 (to_rep result____last))))))) (and (and (= i3 i7) (= result__3 result__7)) (and (= i8 i3) (= result__8 result__3))))))
