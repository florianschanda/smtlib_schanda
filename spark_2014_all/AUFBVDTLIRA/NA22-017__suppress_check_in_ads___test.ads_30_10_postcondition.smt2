...
(declare-const temp___321 (Array Int word32))
(declare-const o Int)
...
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= temp___323 i1)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= temp___321 result__)))
...
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (and (and (forall ((temp___322 Int)) (=> (and (<= (to_rep result____first) temp___322) (<= temp___322 (to_rep result____last))) (=> (< i2 temp___322) (= (select result__3 temp___322) (select temp___321 temp___322))))) (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i2))) (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))))))
