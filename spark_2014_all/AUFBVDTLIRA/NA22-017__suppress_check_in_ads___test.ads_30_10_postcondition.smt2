...
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= temp___281 i1)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= temp___279 result__)))
...
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (and (and (forall ((temp___280 Int)) (=> (and (<= (to_rep result____first) temp___280) (<= temp___280 (to_rep result____last))) (=> (< i2 temp___280) (= (select result__3 temp___280) (select temp___279 temp___280))))) (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i2))) (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))))))
