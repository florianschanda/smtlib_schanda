...
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= temp___325 i1)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= temp___323 result__)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (and (<= (to_rep (first (rt right))) i1) (<= i1 (to_rep (last (rt right)))))))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= o3 i1)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= o4 (select (elts right) o3))))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= o5 (to_rep1 o4))))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (and (<= (to_rep (first (rt left))) i1) (<= i1 (to_rep (last (rt left)))))))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= o i1)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= o1 (select (elts left) o))))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= o2 (to_rep1 o1))))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (and (= o6 (xor2 o2 o5)) (= o6 (bvxor o2 o5)))))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= (to_rep1 o7) o6)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= o8 (store result__ i1 o7))))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= (mk_map__ref result1) result__11)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= result__2 o8)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (forall ((pos Int)) (=> (and (<= (to_rep result____first) pos) (<= pos i2)) (= (to_rep1 (select result__3 pos)) (xor2 (to_rep1 (select (elts left) pos)) (to_rep1 (select (elts right) pos))))))))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (and (and (forall ((temp___324 Int)) (=> (and (<= (to_rep result____first) temp___324) (<= temp___324 (to_rep result____last))) (=> (or (< (to_rep result____last) temp___324) (or (< temp___324 (to_rep result____first)) (< i2 temp___324))) (= (select result__3 temp___324) (select temp___323 temp___324))))) (=> (<= (to_rep result____first) (to_rep result____last)) (dynamic_property1 (to_rep result____first) (to_rep result____last) i2))) (and (<= (to_rep result____first) i2) (<= i2 (to_rep result____last))))))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= i2 (to_rep result____last))))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= i2 i3)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= result__3 result__4)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= i4 i2)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= result__5 result__3)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= i9 (mk_int__ref i3))))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= result__10 (mk_map__ref result__4))))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= i6 i4)))
(assert (=> (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last))) (= result__7 result__5)))
(assert (=> (not (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last)))) (= i1 i5)))
(assert (=> (not (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last)))) (= result__10 result__11)))
(assert (=> (not (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last)))) (= i6 i1)))
(assert (=> (not (and (<= (to_rep result____first) i1) (<= i1 (to_rep result____last)))) (= result__7 result__1)))
...
(assert (not (= (to_rep1 (select result__8 i10)) (xor2 (to_rep1 (select (elts left) i10)) (to_rep1 (select (elts right) i10))))))
(check-sat)
(exit)
