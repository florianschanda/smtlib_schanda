...
(assert (=> (in_range9 n3) (and (= temp___6042 (to_string1 ptr3 (mk___split_fields entry_table__split_fields) (mk___split_fields1 char_table__split_fields))) (dynamic_invariant temp___6042 true false true))))
(assert (=> (in_range9 n3) (= result3 (bool_eq temp___604 (to_rep1 (first temp___6041)) (to_rep1 (last temp___6041)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))))
...
(assert (=> (and (<= (to_rep1 (first (rt s))) c344b1) (<= c344b1 (to_rep1 (last (rt s))))) (and (= char_table__split_discrs (mk___split_discrs1 temp___608)) (= char_table__split_fields temp___6081))))
