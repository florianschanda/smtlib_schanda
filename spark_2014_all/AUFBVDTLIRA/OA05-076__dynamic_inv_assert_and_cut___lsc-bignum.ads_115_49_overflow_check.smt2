...
(assert (= a9 a7))
(assert (= o16 (num_of_boolean (bool__content carry8))))
...
(assert (= o9 (num_of_big_int (mk___t (map__content a8) (mk (to_rep a__first) (to_rep a__last))) a_first o8)))
(assert (= o18 (osubtract o9 o17)))
