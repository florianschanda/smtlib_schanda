...
(assert (=> (= success1 true) (=> (not (= (+ (- endidx1 begidx2) 1) 14)) (= result3 rrsig_rec__split_fields22))))
...
(assert (=> (= success1 true) (=> (not (not (= (+ (- endidx1 begidx2) 1) 14))) (=> (= (bool__content success11) true) (= result8 rrsig_rec__split_fields22)))))
...
(assert (=> (= success1 true) (=> (not (not (= (+ (- endidx1 begidx2) 1) 14))) (=> (not (= (bool__content success11) true)) (= rrsig_rec__split_fields16 rrsig_rec__split_fields22)))))
...
(assert (=> (not (= success1 true)) (= rrsig_rec__split_fields20 rrsig_rec__split_fields22)))
...
(assert (= success20 true))
(assert (and (= o33 (+ endidx1 1)) (in_range4 (+ endidx1 1))))
(assert (= result10 (mk_int__ref begidx2)))
(assert (= begidx3 o33))
(assert (and (and (and (and (<= begidx4 endidx2) (<= begidx4 zlength)) (<= endidx2 zlength)) (=> (= foundtype2 1) (forall ((i26 Int)) (=> (and (<= begidx4 i26) (<= i26 endidx2)) (and (<= 48 (to_rep (select zonefileline i26))) (<= (to_rep (select zonefileline i26)) 57)))))) (and (and (in_range4 begidx4) (in_range4 endidx2)) (in_range3 foundtype2))))
(assert (= result11 (mk_bool__ref success20)))
(assert (= success21 (ite (= foundtype2 1) true false)))
(assert (= success21 true))
(declare-const i26 Int)
(assert (<= begidx4 i26))
(assert (<= i26 endidx2))
(assert (not (<= 48 (to_rep (select zonefileline i26)))))
(check-sat)
(exit)
