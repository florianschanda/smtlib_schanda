...
(assert (and (and (and (=> (<= 1 256) (in_range3 begidx3)) (=> (<= 1 256) (in_range3 endidx2))) (=> (<= 0 10) (in_range2 foundtype2))) (and (not (= foundtype2 5)) (< endidx2 zlength))))
(assert (and (= o (+ endidx2 1)) (in_range3 (+ endidx2 1))))
(assert (= begidx3 result2))
(assert (= begidx4 o))
(assert (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i Int)) (=> (and (<= begidx5 i) (<= i endidx3)) (and (<= 48 (to_rep (select zonefileline i))) (<= (to_rep (select zonefileline i)) 57)))))) (and (and (in_range3 begidx5) (in_range3 endidx3)) (in_range2 foundtype3))))
(assert (not (= foundtype3 5)))
