...
(declare-const temp___401 (Array (_ BitVec 64) unsigned8))
(declare-const temp___404 (_ BitVec 64))
(declare-const temp___400 (_ BitVec 64))
(declare-const temp___399 (_ BitVec 64))
(declare-const temp___398 (_ BitVec 64))
(declare-const temp___405 (Array (_ BitVec 64) unsigned8))
...
(assert (= temp___403 rbx))
(assert (= temp___402 rsp))
(assert (= temp___401 memory))
(assert (= temp___404 rsp))
(assert (= temp___400 xmm2))
(assert (= temp___399 xmm1))
(assert (= temp___398 rax))
(assert (= temp___405 memory))
(assert (= temp___397 xmm0))
(assert (= temp___396 rdi))
(assert (= temp___395 zeroflag))
(assert (= rsp1 temp___404))
(assert (forall ((i (_ BitVec 64))) (=> (and (bvule #x0000000000000000 i) (bvule i #xFFFFFFFFFFFFFFFF)) (=> (and (and (and (and (and (and (and (not (= i rsp1)) (not (= i (bvadd rsp1 #x0000000000000001)))) (not (= i (bvadd rsp1 #x0000000000000002)))) (not (= i (bvadd rsp1 #x0000000000000003)))) (not (= i (bvadd rsp1 #x0000000000000004)))) (not (= i (bvadd rsp1 #x0000000000000005)))) (not (= i (bvadd rsp1 #x0000000000000006)))) (not (= i (bvadd rsp1 #x0000000000000007)))) (= (to_rep (select memory1 i)) (to_rep (select temp___405 i)))))))
...
(assert (not (= (t__content2 rsp8) rsp)))
(check-sat)
(exit)
