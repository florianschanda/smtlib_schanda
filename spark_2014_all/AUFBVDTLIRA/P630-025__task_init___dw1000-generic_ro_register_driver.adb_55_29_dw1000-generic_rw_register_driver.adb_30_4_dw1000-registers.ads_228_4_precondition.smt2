...
(define-fun dynamic_invariant ((temp___expr_2411 us_t1) (temp___is_init_2408 Bool) (temp___skip_constant_2409 Bool) (temp___do_toplevel_2410 Bool)) Bool (=> (not (= temp___skip_constant_2409 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2411) (last3 temp___expr_2411)) (and (= (first3 temp___expr_2411) 1) (= (last3 temp___expr_2411) 4)))))
