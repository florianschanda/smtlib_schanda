...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__agc_tune3_type__agc_tune3 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__agc_tune3_type__agc_tune3 (us_split_fields1 b)))) true false))
...
(define-fun register_byte_array__ref___48__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_3984 us_t1) (temp___is_init_3980 Bool) (temp___skip_constant_3981 Bool) (temp___do_toplevel_3982 Bool) (temp___do_typ_inv_3983 Bool)) Bool (=> (not (= temp___skip_constant_3981 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3984) (last3 temp___expr_3984)) (and (= (first3 temp___expr_3984) 1) (= (last3 temp___expr_3984) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___20__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_4002 us_t2) (temp___is_init_3998 Bool) (temp___skip_constant_3999 Bool) (temp___do_toplevel_4000 Bool) (temp___do_typ_inv_4001 Bool)) Bool (=> (not (= temp___skip_constant_3999 true)) (and (dynamic_property3 1 2 (first5 temp___expr_4002) (last5 temp___expr_4002)) (and (= (first5 temp___expr_4002) 1) (= (last5 temp___expr_4002) 2)))))
...
(declare-const temp___86191 t2)
(declare-const temp___8620 (Array Int bits_8))
(declare-const temp___86201 t1)
(define-fun temp___86192 () us_t2 (mk___t2 temp___8619 temp___86191))
...
(assert (and (= temp___86192 (register_to_bytes reg)) (dynamic_invariant1 temp___86192 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___86191)) (to_rep (last4 temp___86191))) (+ (- (to_rep (last4 temp___86191)) (to_rep (first4 temp___86191))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___8619 temp___8620))
(assert (= (mk1 (to_rep (first4 temp___86191)) (to_rep (last4 temp___86191))) temp___86201))
(assert (not (= (ite (<= (to_rep (first2 temp___86201)) (to_rep (last2 temp___86201))) (+ (- (to_rep (last2 temp___86201)) (to_rep (first2 temp___86201))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
