...
(define-fun dynamic_invariant ((temp___expr_3614 us_t1) (temp___is_init_3611 Bool) (temp___skip_constant_3612 Bool) (temp___do_toplevel_3613 Bool)) Bool (=> (not (= temp___skip_constant_3612 true)) (and (dynamic_property2 1 2 (first3 temp___expr_3614) (last3 temp___expr_3614)) (and (= (first3 temp___expr_3614) 1) (= (last3 temp___expr_3614) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_3630 us_t2) (temp___is_init_3627 Bool) (temp___skip_constant_3628 Bool) (temp___do_toplevel_3629 Bool)) Bool (=> (not (= temp___skip_constant_3628 true)) (and (dynamic_property3 1 2 (first5 temp___expr_3630) (last5 temp___expr_3630)) (and (= (first5 temp___expr_3630) 1) (= (last5 temp___expr_3630) 2)))))
...
(declare-const temp___7848 (Array Int bits_8))
(declare-const temp___78481 t1)
...
(assert (and (= (mk___t2 temp___7847 temp___78471) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7847 temp___78471) true false true)))
(assert (= (ite (<= (to_rep (first4 temp___78471)) (to_rep (last4 temp___78471))) (+ (- (to_rep (last4 temp___78471)) (to_rep (first4 temp___78471))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0)))
(assert (= temp___7847 temp___7848))
(assert (= (mk1 (to_rep (first4 temp___78471)) (to_rep (last4 temp___78471))) temp___78481))
(assert (not (= (ite (<= (to_rep (first2 temp___78481)) (to_rep (last2 temp___78481))) (+ (- (to_rep (last2 temp___78481)) (to_rep (first2 temp___78481))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0))))
(check-sat)
(exit)
