...
(define-fun dynamic_invariant ((temp___expr_5144 us_t1) (temp___is_init_5141 Bool) (temp___skip_constant_5142 Bool) (temp___do_toplevel_5143 Bool)) Bool (=> (not (= temp___skip_constant_5142 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5144) (last3 temp___expr_5144)) (and (= (first3 temp___expr_5144) 1) (= (last3 temp___expr_5144) 2)))))
