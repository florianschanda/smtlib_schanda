...
(assert (and (and (and (= us (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r)))) (in_range1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 r))))) (and (and (= us1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l)))) (in_range1 (to_rep1 (rec__aco__math__very_longs__very_long__octet_length (us_split_discrs1 l))))) (and (and (= (to_rep1 (rec__aco__math__very_longs__very_long__octet_length result____split_discrs)) r19b) (in_range1 r19b)) (and (and (and (and (and (and (and (and (= (to_rep2 (first4 (rt2 (temp___1406 ((_ int2bv 8) 0) 1 r19b)))) 1) (and (= (to_rep2 (last4 (rt2 (temp___1406 ((_ int2bv 8) 0) 1 r19b)))) r19b) (= (mk___t2 temp___1413 temp___14131) (temp___1406 ((_ int2bv 8) 0) 1 r19b)))) (and (= (ite (<= (to_rep2 (first4 temp___14131)) (to_rep2 (last4 temp___14131))) (+ (- (to_rep2 (last4 temp___14131)) (to_rep2 (first4 temp___14131))) 1) 0) (ite (<= 1 r19b) (+ (- r19b 1) 1) 0)) (and (= temp___1413 temp___1414) (= (mk1 (to_rep2 (first4 temp___14131)) (to_rep2 (last4 temp___14131))) temp___14141)))) (and (= (ite (<= (to_rep2 (first2 temp___14141)) (to_rep2 (last2 temp___14141))) (+ (- (to_rep2 (last2 temp___14141)) (to_rep2 (first2 temp___14141))) 1) 0) (ite (<= (to_rep2 (first result____split_fields1)) (to_rep2 (last result____split_fields1))) (+ (- (to_rep2 (last result____split_fields1)) (to_rep2 (first result____split_fields1))) 1) 0)) (= (mk___t1 temp___1416 temp___14161) (mk___t1 temp___1414 temp___14141)))) (and (= temp___1416 o) (= (mk (to_rep2 (first2 temp___14161)) (to_rep2 (last2 temp___14161))) o1))) (and (= o2 o) (= o3 o1))) (and (= result____split_discrs (mk___split_discrs temp___1418)) (and (= temp___14181 o2) (= temp___14182 o3)))) (and (and (= result (mk___split_fields__ref (mk___split_fields (mk___t result____split_fields result____split_fields1)))) (= result____split_fields2 (mk___split_fields (mk___t temp___14181 temp___14182)))) (= result____split_discrs (mk___split_discrs temp___1418)))) (and (and (= result1 (mk_t__ref1 borrow)) (= borrow1 ((_ int2bv 16) 0))) (and (and (= result2 (mk_int__ref i)) (= i1 1)) (ite (and (<= 1 i1) (<= i1 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))))) (and (and (and (= temp___1430 l_digit) (and (and (= result____split_discrs (mk___split_discrs temp___1427)) (= result____split_fields2 (mk___split_fields (mk___t temp___14271 temp___14272)))) (and (= temp___1426 difference1) (and (= temp___1425 r_digit) (and (= temp___1424 borrow1) (and (and (and (dynamic_invariant3 (mk___rep result____split_discrs result____split_fields3) false true true) (and (= (rec__aco__math__very_longs__very_long__octet_length result____split_discrs) temp___1427) (forall ((temp___1429 Int)) (=> (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) temp___1429) (<= temp___1429 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))) (=> (<= i2 temp___1429) (= (select (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) temp___1429) (select temp___14271 temp___1429))))))) (and (<= 1 i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l)))))))) (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))))) (= o4 i2)) (= o5 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))) o4))) (= o6 (to_rep o5))) (= o7 ((_ zero_extend 8) o6))) (and (= result3 (mk_t__ref1 l_digit2)) (= l_digit3 o7))) (and (and (and (and (and (and (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))))))) (= o8 i2)) (= o9 (select (elts (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 r))) o8))) (= o10 (to_rep o9))) (= o11 ((_ zero_extend 8) o10))) (and (= result4 (mk_t__ref1 r_digit2)) (= r_digit3 o11))) (and (and (= result5 (mk_t__ref1 difference3)) (= difference4 (bvsub (bvsub l_digit3 r_digit3) borrow2))) (and (ite (not (= (bvand difference4 ((_ int2bv 16) 65280)) ((_ int2bv 16) 0))) (and (= result6 (mk_t__ref1 borrow2)) (= borrow3 ((_ int2bv 16) 1))) (and (and (= result7 (mk_t__ref1 borrow2)) (= borrow4 ((_ int2bv 16) 0))) (= borrow3 borrow4))) (and (and (and (and (and (and (and (= o12 (takelsb_from16 difference4)) (= (to_rep o13) o12)) (and (and (and (<= (to_rep2 (first (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))) i2) (<= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)))))) (= o14 i2)) (= o15 (store (elts (rec__aco__math__very_longs__very_long__long_digits result____split_fields3)) o14 o13)))) (= o16 (mk___t o15 (rt (rec__aco__math__very_longs__very_long__long_digits result____split_fields3))))) (= o17 (mk___split_fields o16))) (= temp___1423 (mk___rep result____split_discrs o17))) (and (and (= result8 (mk___split_fields__ref result____split_fields3)) (= result____split_fields4 (us_split_fields1 temp___1423))) (= result____split_discrs (us_split_discrs1 temp___1423)))) (= i2 (to_rep2 (last (rt (rec__aco__math__very_longs__very_long__long_digits (us_split_fields1 l))))))))))))))))) (and (and (= i3 (mk_int__ref i2)) (and (= difference5 (mk_t__ref1 difference4)) (and (= r_digit4 (mk_t__ref1 r_digit3)) (and (= l_digit4 (mk_t__ref1 l_digit3)) (and (= borrow5 (mk_t__ref1 borrow3)) (= result____split_fields5 (mk___split_fields__ref result____split_fields4))))))) (and (= i4 i2) (and (= difference6 difference4) (and (= r_digit5 r_digit3) (and (= l_digit5 l_digit3) (and (= borrow6 borrow3) (= result____split_fields6 result____split_fields4)))))))) (and (and (= i5 i3) (and (= difference7 difference5) (and (= r_digit6 r_digit4) (and (= l_digit6 l_digit4) (and (= borrow7 borrow5) (= result____split_fields7 result____split_fields5)))))) (and (= i6 i4) (and (= difference8 difference6) (and (= r_digit7 r_digit5) (and (= l_digit7 l_digit5) (and (= borrow8 borrow6) (= result____split_fields8 result____split_fields6)))))))) (and (and (= i5 (mk_int__ref i1)) (and (= difference7 (mk_t__ref1 difference1)) (and (= r_digit6 (mk_t__ref1 r_digit)) (and (= l_digit6 (mk_t__ref1 l_digit)) (and (= borrow7 (mk_t__ref1 borrow1)) (= result____split_fields7 (mk___split_fields__ref result____split_fields2))))))) (and (= i6 i1) (and (= difference8 difference2) (and (= r_digit7 r_digit1) (and (= l_digit7 l_digit1) (and (= borrow8 borrow1) (= result____split_fields8 result____split_fields2)))))))))))))) (and (and (= i7 i5) (and (= difference9 difference7) (and (= r_digit8 r_digit6) (and (= l_digit8 l_digit6) (and (= borrow9 borrow7) (= result____split_fields9 result____split_fields7)))))) (and (= i8 i6) (and (= difference10 difference8) (and (= r_digit9 r_digit7) (and (= l_digit9 l_digit7) (and (= borrow10 borrow8) (= result____split_fields10 result____split_fields8)))))))))
