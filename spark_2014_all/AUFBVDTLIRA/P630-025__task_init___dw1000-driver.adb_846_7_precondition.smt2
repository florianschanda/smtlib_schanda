...
(define-fun in_range3 ((x (_ BitVec 16))) Bool (and (bvule #x0000 x) (bvule x #x1FFF)))
...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x #x2000))) (=> (in_range3 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
...
(define-fun in_range6 ((x (_ BitVec 8))) Bool (and (bvule #x00 x) (bvule x #x0F)))
...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x #x10))) (=> (in_range6 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
...
(define-fun dynamic_invariant4 ((temp___expr_315 (_ BitVec 8)) (temp___is_init_311 Bool) (temp___skip_constant_312 Bool) (temp___do_toplevel_313 Bool) (temp___do_typ_inv_314 Bool)) Bool (=> (or (= temp___is_init_311 true) (bvule #x00 #x03)) (in_range2 temp___expr_315)))
(define-fun dynamic_invariant5 ((temp___expr_322 (_ BitVec 8)) (temp___is_init_318 Bool) (temp___skip_constant_319 Bool) (temp___do_toplevel_320 Bool) (temp___do_typ_inv_321 Bool)) Bool (=> (or (= temp___is_init_318 true) (bvule #x00 #x07)) (in_range5 temp___expr_322)))
(define-fun dynamic_invariant6 ((temp___expr_329 (_ BitVec 8)) (temp___is_init_325 Bool) (temp___skip_constant_326 Bool) (temp___do_toplevel_327 Bool) (temp___do_typ_inv_328 Bool)) Bool (=> (or (= temp___is_init_325 true) (bvule #x00 #x0F)) (in_range6 temp___expr_329)))
...
(define-fun dynamic_invariant8 ((temp___expr_392 (_ BitVec 16)) (temp___is_init_388 Bool) (temp___skip_constant_389 Bool) (temp___do_toplevel_390 Bool) (temp___do_typ_inv_391 Bool)) Bool (=> (or (= temp___is_init_388 true) (bvule #x0000 #x1FFF)) (in_range3 temp___expr_392)))
