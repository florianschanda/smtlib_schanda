...
(declare-const temp___866 bits_6)
(declare-const temp___8661 sub_index_type)
(declare-const temp___8662 operation_type)
...
(define-fun dw1000__register_driver__read_register__B_1__header__assume3 () us_rep (mk___rep (mk___split_fields dw1000__register_driver__read_register__B_1__header__assume dw1000__register_driver__read_register__B_1__header__assume1 dw1000__register_driver__read_register__B_1__header__assume2)))
...
(assert (= o1 o4))
(assert (= o o5))
(assert (= temp___866 o3))
(assert (= temp___8661 o4))
(assert (= temp___8662 o5))
(assert (= (to_rep4 temp___8661) 0))
(assert (= dw1000__register_driver__read_register__B_1__header__assume3 (mk___rep (mk___split_fields temp___866 temp___8661 temp___8662))))
(assert (= dw1000__register_driver__read_register__B_1__header__assume3 header))
