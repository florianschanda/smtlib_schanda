...
(assert (and (= temp___5024 o2) (in_range1 o2)))
(assert (=> (<= 1 temp___5024) (and (and (<= 0 1) (<= 1 1024)) (and (<= 0 temp___5024) (<= temp___5024 1024)))))
(assert (= o3 (rec__decadriver__rx_frame_type__frame (us_split_fields1 (select self__ (to_rep5 self__1))))))
(assert (= o3 temp___5027))
(assert (= (mk3 1 temp___5024) temp___50271))
(assert (= temp___5027 temp___5028))
(assert (= (mk (to_rep1 (first6 temp___50271)) (to_rep1 (last6 temp___50271))) temp___50281))
(assert (not (= (ite (<= (to_rep1 (first temp___50281)) (to_rep1 (last temp___50281))) (+ (- (to_rep1 (last temp___50281)) (to_rep1 (first temp___50281))) 1) 0) (ite (<= (to_rep1 frame__first) (to_rep1 frame__last)) (+ (- (to_rep1 frame__last) (to_rep1 frame__first)) 1) 0))))
(check-sat)
(exit)
