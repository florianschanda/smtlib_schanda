...
(define-fun dynamic_invariant ((temp___expr_2875 us_t1) (temp___is_init_2871 Bool) (temp___skip_constant_2872 Bool) (temp___do_toplevel_2873 Bool) (temp___do_typ_inv_2874 Bool)) Bool (=> (not (= temp___skip_constant_2872 true)) (and (dynamic_property2 1 4 (first3 temp___expr_2875) (last3 temp___expr_2875)) (and (= (first3 temp___expr_2875) 1) (= (last3 temp___expr_2875) 4)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_2923 us_t2) (temp___is_init_2919 Bool) (temp___skip_constant_2920 Bool) (temp___do_toplevel_2921 Bool) (temp___do_typ_inv_2922 Bool)) Bool (=> (not (= temp___skip_constant_2920 true)) (and (dynamic_property3 1 4 (first5 temp___expr_2923) (last5 temp___expr_2923)) (and (= (first5 temp___expr_2923) 1) (= (last5 temp___expr_2923) 4)))))
...
(declare-const temp___85221 t2)
(define-fun temp___85222 () us_t2 (mk___t2 temp___8522 temp___85221))
...
(assert (and (= temp___85222 (register_to_bytes reg)) (dynamic_invariant1 temp___85222 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___85221)) (to_rep (last4 temp___85221))) (+ (- (to_rep (last4 temp___85221)) (to_rep (first4 temp___85221))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
