...
(define-fun dynamic_invariant ((temp___expr_5094 us_t1) (temp___is_init_5091 Bool) (temp___skip_constant_5092 Bool) (temp___do_toplevel_5093 Bool)) Bool (=> (not (= temp___skip_constant_5092 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5094) (last3 temp___expr_5094)) (and (= (first3 temp___expr_5094) 1) (= (last3 temp___expr_5094) 2)))))
