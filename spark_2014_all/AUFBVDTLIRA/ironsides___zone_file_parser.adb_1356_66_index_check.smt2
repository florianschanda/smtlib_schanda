...
(assert (= i4 r83b))
(assert (=> (and (<= r83b i4) (<= i4 r84b)) (= temp___1760 i4)))
(assert (=> (and (<= r83b i4) (<= i4 r84b)) (= temp___1759 tmpval1)))
(assert (=> (and (<= r83b i4) (<= i4 r84b)) (= temp___1758 digitval)))
...
(assert (= i10 r86b))
(assert (=> (and (<= r86b i10) (<= i10 r87b)) (= temp___1765 i10)))
(assert (=> (and (<= r86b i10) (<= i10 r87b)) (= temp___1764 tmpval8)))
(assert (=> (and (<= r86b i10) (<= i10 r87b)) (= temp___1763 (t__content digitval6))))
...
(assert (= begidx14 o3))
(assert (and (and (and (and (<= begidx15 endidx10) (<= begidx15 zlength)) (<= endidx10 zlength)) (=> (= foundtype10 1) (forall ((i24 Int)) (=> (and (<= begidx15 i24) (<= i24 endidx10)) (and (<= 48 (to_rep (select zonefileline i24))) (<= (to_rep (select zonefileline i24)) 57)))))) (and (and (in_range4 begidx15) (in_range4 endidx10)) (in_range3 foundtype10))))
...
(assert (= i16 r89b))
(assert (=> (and (<= r89b i16) (<= i16 r90b)) (= temp___1770 i16)))
(assert (=> (and (<= r89b i16) (<= i16 r90b)) (= temp___1769 tmpval15)))
(assert (=> (and (<= r89b i16) (<= i16 r90b)) (= temp___1768 (t__content digitval12))))
...
(assert (= begidx16 o4))
(assert (and (and (and (and (<= begidx17 endidx11) (<= begidx17 zlength)) (<= endidx11 zlength)) (=> (= foundtype11 1) (forall ((i24 Int)) (=> (and (<= begidx17 i24) (<= i24 endidx11)) (and (<= 48 (to_rep (select zonefileline i24))) (<= (to_rep (select zonefileline i24)) 57)))))) (and (and (in_range4 begidx17) (in_range4 endidx11)) (in_range3 foundtype11))))
...
(assert (<= r92b i22))
(assert (<= i22 r93b))
(assert (and (<= 1 begidx17) (<= (+ (- endidx11 begidx17) 1) 128)))
(assert (and (=> (<= r92b r93b) (dynamic_property3 r92b r93b i23)) (and (<= r92b i23) (<= i23 r93b))))
(assert (= (to_rep o8) (to_rep (select zonefileline i23))))
(assert (and (= o6 (+ i23 1)) (in_range1 (+ i23 1))))
(assert (= o7 (- o6 begidx17)))
(assert (and (= temp___1773 o7) (in_range1 o7)))
(assert (not (<= 1 temp___1773)))
(check-sat)
(exit)
