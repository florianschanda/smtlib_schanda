...
(assert (<= r92b i38))
(assert (<= i38 r93b))
(assert (and (<= 1 begidx19) (<= (+ (- endidx13 begidx19) 1) 128)))
(assert (and (=> (<= r92b r93b) (dynamic_property3 r92b r93b i39)) (and (<= r92b i39) (<= i39 r93b))))
(assert (= (to_rep o8) (to_rep (select zonefileline i39))))
(assert (and (= o6 (+ i39 1)) (in_range1 (+ i39 1))))
(assert (= o7 (- o6 begidx19)))
(assert (and (= temp___1714 o7) (in_range1 o7)))
(assert (not (<= 1 temp___1714)))
(check-sat)
(exit)
