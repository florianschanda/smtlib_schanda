...
(assert true)
(assert (= (to_rep (first2 (rt1 (temp___3353 ((_ int2bv 8) 0) (to_rep data__first) (to_rep data__last))))) (to_rep data__first)))
(assert (= (to_rep (last2 (rt1 (temp___3353 ((_ int2bv 8) 0) (to_rep data__first) (to_rep data__last))))) (to_rep data__last)))
(assert (= (mk___t1 temp___3360 temp___33601) (temp___3353 ((_ int2bv 8) 0) (to_rep data__first) (to_rep data__last))))
(assert (= temp___3360 temp___3361))
(assert (= (mk (to_rep (first2 temp___33601)) (to_rep (last2 temp___33601))) temp___33611))
(assert (not (= (ite (<= (to_rep (first temp___33611)) (to_rep (last temp___33611))) (+ (- (to_rep (last temp___33611)) (to_rep (first temp___33611))) 1) 0) (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0))))
(check-sat)
(exit)
