...
(declare-const temp___3698 (Array Int bits_8))
(declare-const temp___36981 t1)
(declare-const temp___3699 (Array Int bits_8))
(declare-const temp___36991 t)
...
(assert (and (<= (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0) 256) (<= (+ (bv2nat start_address) (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0)) 256)))
(assert (= result address))
(assert (= address1 start_address))
(assert (= (to_rep (first2 (rt1 (temp_____aggregate_def_3691 #x00 (to_rep data__first) (to_rep data__last))))) (to_rep data__first)))
(assert (= (to_rep (last2 (rt1 (temp_____aggregate_def_3691 #x00 (to_rep data__first) (to_rep data__last))))) (to_rep data__last)))
(assert (= (mk___t1 temp___3698 temp___36981) (temp_____aggregate_def_3691 #x00 (to_rep data__first) (to_rep data__last))))
(assert (= temp___3698 temp___3699))
(assert (= (mk (to_rep (first2 temp___36981)) (to_rep (last2 temp___36981))) temp___36991))
(assert (not (= (ite (<= (to_rep (first temp___36991)) (to_rep (last temp___36991))) (+ (- (to_rep (last temp___36991)) (to_rep (first temp___36991))) 1) 0) (ite (<= (to_rep data__first) (to_rep data__last)) (+ (- (to_rep data__last) (to_rep data__first)) 1) 0))))
(check-sat)
(exit)
