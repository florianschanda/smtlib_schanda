...
(assert (= (to_rep (first2 (rt1 (temp___3691 #x00 (to_rep data__first) (to_rep data__last))))) (to_rep data__first)))
(assert (= (to_rep (last2 (rt1 (temp___3691 #x00 (to_rep data__first) (to_rep data__last))))) (to_rep data__last)))
(assert (= (mk___t1 temp___3698 temp___36981) (temp___3691 #x00 (to_rep data__first) (to_rep data__last))))
