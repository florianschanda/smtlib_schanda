...
(assert (=> (in_range9 n3) (and (and (= temp___649 n3) (and (= temp___648 ptr2) (and (and (and (and (= (mk___t temp___647 temp___6471) (to_string1 ptr2 hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields))) (dynamic_invariant (mk___t temp___647 temp___6471) true false true)) (= result4 (bool_eq temp___647 (to_rep1 (first temp___6471)) (to_rep1 (last temp___6471)) (elts s) (to_rep1 (first (rt s))) (to_rep1 (last (rt s)))))) (and (not (= result4 true)) (= n4 n3))) (and (and (and (in_range9 ptr3) (<= ptr3 (last2 (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields)))))) (= (invariant__ hash_table (mk___split_fields char_table__split_fields) (mk___split_fields1 entry_table__split_fields)) true)) (and (and (=> (<= 0 2147483647) (in_range4 ptr3)) (=> (<= 0 2147483647) (in_range4 n5))) (and (and (= ptr5 (mk_int__ref ptr3)) (= ptr6 ptr3)) (and (and (and (and (and (and (and (= o2 ptr3) (in_range11 ptr3)) (and (= (mk___rep2 (mk___split_fields2 o3 o4 o5)) (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) (= (bool_eq3 (mk___rep2 (mk___split_fields2 o3 o4 o5)) (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) true))) (and (= o3 o6) (and (= o4 o7) (= o5 o8)))) (= o9 o8)) (= o10 (to_rep2 o9))) (= result6 (ite (= o10 0) true false))) (= result6 true)))))))) (and (and (= ptr11 ptr5) (= n11 (mk_int__ref n5))) (and (= ptr12 ptr6) (= n12 n5))))))
(assert (=> (in_range9 n3) (= ptr13 ptr11)))
(assert (=> (in_range9 n3) (= n13 n11)))
(assert (=> (in_range9 n3) (= ptr14 ptr12)))
(assert (=> (in_range9 n3) (= n14 n12)))
(assert (=> (in_range9 n3) (= ptr15 ptr13)))
(assert (=> (in_range9 n3) (= n15 n13)))
(assert (=> (in_range9 n3) (= ptr16 ptr14)))
(assert (=> (in_range9 n3) (= n16 n14)))
(assert (=> (not (in_range9 n3)) (= ptr15 (mk_int__ref ptr1))))
(assert (=> (not (in_range9 n3)) (= n15 (mk_int__ref n3))))
(assert (=> (not (in_range9 n3)) (= ptr16 ptr1)))
(assert (=> (not (in_range9 n3)) (= n16 n3)))
(assert (and (and (and (and (= (invariant__ hash_table char_table__split_fields2 entry_table__split_fields2) true) (= (length2 (mk___rep1 entry_table__split_discrs entry_table__split_fields2)) (+ (length2 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) 1))) (<= (length3 (mk___rep char_table__split_discrs (mk___split_fields char_table__split_fields))) (length3 (mk___rep char_table__split_discrs char_table__split_fields2)))) (= n17 (last2 (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields2))))) (in_range4 n17)))
(assert (in_range9 (int__content ptr15)))
(assert (and (= o21 (int__content ptr15)) (in_range11 (int__content ptr15))))
(assert (and (= (mk___rep2 (mk___split_fields2 temp___650 temp___6501 temp___6502)) (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields2)) o21)) (= (bool_eq3 (mk___rep2 (mk___split_fields2 temp___650 temp___6501 temp___6502)) (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields2)) o21)) true)))
(assert (= (to_rep2 o22) n17))
(assert (= temp___650 o23))
(assert (= temp___6501 o24))
(assert (= o22 o25))
(assert (= o26 o23))
(assert (= o27 o24))
(assert (= o28 o25))
(assert (and (= o20 (int__content ptr15)) (in_range11 (int__content ptr15))))
(assert (not (<= 1 o20)))
(check-sat)
(exit)
