...
(assert (and (= temp___6503 (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields1)) o12)) (= (bool_eq3 temp___6503 (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields1)) o12)) true)))
