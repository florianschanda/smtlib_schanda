...
(assert (=> (in_range9 n3) (and (= o20 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) (= (bool_eq3 o20 (get (model__ (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o2)) true))))
...
(assert (and (= o12 (int__content ptr10)) (in_range11 (int__content ptr10))))
(assert (and (= temp___7143 (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields1)) o12)) (= (bool_eq3 temp___7143 (get (model__ (mk___rep1 entry_table__split_discrs entry_table__split_fields1)) o12)) true)))
