...
(declare-const temp___380 us_rep2)
...
(assert (= count1 o21))
(assert (not (= count1 #x0000)))
(assert (= (to_rep2 (rec__parse__parse_result_t__return_code result____split_discrs5)) r18b))
(assert (in_range3 r18b))
(assert (= (to_rep2 o22) 1))
(assert (= o23 (mk___split_discrs o22)))
(assert (= temp___380 (mk___rep2 o23 (mk___split_fields2 dummy8) true)))
(assert (= result____attr__constrained true))
(assert (not (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___380)) (rec__parse__parse_result_t__return_code result____split_discrs5))))
(check-sat)
(exit)
