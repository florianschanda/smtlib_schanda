...
(assert (= (writereg32post rcx1 ((_ int2bv 32) 5)) true))
...
(assert (= rdx2 rdi1))
(assert (and (= o20 (ax rax1)) (= o20 (readreg16 rax1))))
...
(assert (= result21 (mk_t__ref3 rax1)))
(assert (= rax2 (bvadd rbp1 ((_ int2bv 64) 18446744073709551488))))
...
(assert (= result24 (mk_t__ref3 rax3)))
(assert (= rax4 (bvadd rbp1 ((_ int2bv 64) 18446744073709551552))))
...
(assert (= result27 (mk_t__ref3 rax4)))
(assert (= rax5 ((_ int2bv 64) 50)))
(assert (= result28 (mk_t__ref3 rdx3)))
(assert (= rdx4 (bvadd rax5 ((_ int2bv 64) 1))))
(assert (= result29 (mk_t__ref3 rcx1)))
(assert (= rcx2 (bvadd rbp1 ((_ int2bv 64) 18446744073709551552))))
(assert (= result30 (mk_t__ref3 rax5)))
(assert (= rax6 (bvadd rbp1 ((_ int2bv 64) 18446744073709551488))))
...
(assert (not (= (insaferegion64 i rsp7) true)))
(check-sat)
(exit)
