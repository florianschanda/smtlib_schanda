...
(assert (and (and (and (and (<= begidx2 endidx1) (<= begidx2 zlength)) (<= endidx1 zlength)) (=> (= tokentype1 1) (forall ((i Int)) (=> (and (<= begidx2 i) (<= i endidx1)) (and (<= 48 (to_rep (select zonefileline i))) (<= (to_rep (select zonefileline i)) 57)))))) (and (and (in_range5 begidx2) (in_range5 endidx1)) (in_range4 tokentype1))))
(assert (not (in_range5 (+ (- endidx1 begidx2) 1))))
(check-sat)
(exit)
