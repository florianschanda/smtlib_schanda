...
(assert (and (bvule (to_rep2 (first2 (rt1 c))) ((_ int2bv 64) 0)) (bvule ((_ int2bv 64) 0) (to_rep2 (last2 (rt1 c))))))
(assert (= o ((_ int2bv 64) 0)))
(assert (= o1 (select (elts1 c) o)))
(assert (not (bvule (to_rep2 (first2 (rt1 c))) ((_ int2bv 64) 18446744073709551615))))
(check-sat)
(exit)
