...
(assert (and (= o23 (+ numberofrecordtypes3 1)) (in_range6 (+ numberofrecordtypes3 1))))
(assert (= result19 (mk_int__ref numberofrecordtypes3)))
(assert (= numberofrecordtypes4 o23))
(assert (= (to_rep2 o24) recordtype4))
...
(assert (= result20 (mk_map__ref2 recordtypes3)))
(assert (= recordtypes4 o26))
(assert (= o27 (from_query_type recordtype4)))
(assert (= o28 (bvudiv o27 ((_ int2bv 16) 256))))
(assert (= o29 (bvurem o28 ((_ int2bv 16) 256))))
(assert (not (bvule ((_ zero_extend 8) ((_ int2bv 8) 0)) o29)))
(check-sat)
(exit)
