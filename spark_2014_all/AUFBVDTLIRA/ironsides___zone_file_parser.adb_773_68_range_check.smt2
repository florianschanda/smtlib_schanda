...
(assert (and (and (and (and (and (and (=> (<= 0 32) (in_range7 numberofrecordtypes3)) (=> (<= 0 18) (in_range5 recordtype2))) (=> (<= 1 256) (in_range4 begidx3))) (=> (<= 1 256) (in_range4 endidx2))) (=> (<= 1 32) (in_range11 bytenumber2))) (=> (<= 0 10) (in_range3 foundtype2))) (and (and (= foundtype2 3) (< endidx2 256)) (< numberofrecordtypes3 32))))
(assert (and (and (and (and (<= begidx4 endidx3) (<= begidx4 256)) (<= endidx3 256)) (=> (= foundtype3 1) (forall ((i Int)) (=> (and (<= begidx4 i) (<= i endidx3)) (and (<= 48 (to_rep (select rrstring i))) (<= (to_rep (select rrstring i)) 57)))))) (and (and (in_range4 begidx4) (in_range4 endidx3)) (in_range3 foundtype3))))
(assert (= foundtype3 3))
...
(assert (and (= o23 (+ numberofrecordtypes3 1)) (in_range7 (+ numberofrecordtypes3 1))))
(assert (= result18 (mk_int__ref numberofrecordtypes3)))
(assert (= numberofrecordtypes4 o23))
(assert (= (to_rep2 o24) recordtype3))
(assert (and (<= 1 numberofrecordtypes4) (<= numberofrecordtypes4 32)))
(assert (= o25 numberofrecordtypes4))
(assert (= o26 (store recordtypes3 o25 o24)))
(assert (= result19 (mk_map__ref2 recordtypes3)))
(assert (= recordtypes4 o26))
(assert (= o27 (from_query_type recordtype3)))
(assert (= o28 (bvudiv o27 #x0100)))
(assert (= o29 (bvurem o28 #x0100)))
(assert (not (bvule o29 ((_ zero_extend 8) #xFF))))
(check-sat)
(exit)
