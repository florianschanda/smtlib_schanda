...
(declare-datatypes () ((us_split_fields (mk___split_fields (rec__dw1000__register_types__drx_tune1b_type__drx_tune1b bits_16)))))
(define-fun us_split_fields_DRX_TUNE1b__projection ((a us_split_fields)) bits_16 (rec__dw1000__register_types__drx_tune1b_type__drx_tune1b a))
(declare-datatypes () ((us_split_fields__ref (mk___split_fields__ref (us_split_fields__content us_split_fields)))))
(define-fun us_split_fields__ref___48__projection ((a us_split_fields__ref)) us_split_fields (us_split_fields__content a))
(declare-datatypes () ((us_rep (mk___rep (us_split_fields1 us_split_fields)))))
(define-fun us_rep___48__projection ((a us_rep)) us_split_fields (us_split_fields1 a))
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__drx_tune1b_type__drx_tune1b (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__drx_tune1b_type__drx_tune1b (us_split_fields1 b)))) true false))
...
(assert (<= 0 dw1000__register_types__drx_tune1b_type__drx_tune1b__first__bit))
(assert (< dw1000__register_types__drx_tune1b_type__drx_tune1b__first__bit dw1000__register_types__drx_tune1b_type__drx_tune1b__last__bit))
(assert (<= 0 dw1000__register_types__drx_tune1b_type__drx_tune1b__position))
(declare-fun user_eq5 (us_rep us_rep) Bool)
(declare-const dummy5 us_rep)
(declare-datatypes () ((drx_tune1b_type__ref (mk_drx_tune1b_type__ref (drx_tune1b_type__content us_rep)))))
(define-fun drx_tune1b_type__ref___projection ((a drx_tune1b_type__ref)) us_rep (drx_tune1b_type__content a))
(declare-datatypes () ((register_type__ref (mk_register_type__ref (register_type__content us_rep)))))
(define-fun register_type__ref___110__projection ((a register_type__ref)) us_rep (register_type__content a))
...
(define-fun tregister_byte_arrayP1__ref___78__projection ((a tregister_byte_arrayP1__ref)) integer (tregister_byte_arrayP1__content a))
(declare-sort t1 0)
...
(define-fun register_byte_array__ref___78__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_5335 us_t1) (temp___is_init_5331 Bool) (temp___skip_constant_5332 Bool) (temp___do_toplevel_5333 Bool) (temp___do_typ_inv_5334 Bool)) Bool (=> (not (= temp___skip_constant_5332 true)) (and (dynamic_property2 1 2 (first3 temp___expr_5335) (last3 temp___expr_5335)) (and (= (first3 temp___expr_5335) 1) (= (last3 temp___expr_5335) 2)))))
