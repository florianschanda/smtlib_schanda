...
(define-fun dynamic_invariant ((temp___expr_4866 us_t1) (temp___is_init_4863 Bool) (temp___skip_constant_4864 Bool) (temp___do_toplevel_4865 Bool)) Bool (=> (not (= temp___skip_constant_4864 true)) (and (dynamic_property2 1 2 (first3 temp___expr_4866) (last3 temp___expr_4866)) (and (= (first3 temp___expr_4866) 1) (= (last3 temp___expr_4866) 2)))))
