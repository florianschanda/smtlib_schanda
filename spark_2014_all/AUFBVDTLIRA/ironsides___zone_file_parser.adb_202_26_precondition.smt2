...
(assert (=> (= success3 true) (and (= o16 (+ endidx2 1)) (in_range2 (+ endidx2 1)))))
(assert (=> (= success3 true) (= begidx3 result17)))
(assert (=> (= success3 true) (= begidx4 o16)))
(assert (=> (= success3 true) (and (and (and (and (<= begidx5 endidx3) (<= begidx5 zlength)) (<= endidx3 zlength)) (=> (= foundtype3 1) (forall ((i Int)) (=> (and (<= begidx5 i) (<= i endidx3)) (and (<= 48 (to_rep1 (select zonefileline i))) (<= (to_rep1 (select zonefileline i)) 57)))))) (and (and (in_range2 begidx5) (in_range2 endidx3)) (in_range1 foundtype3)))))
(assert (=> (= success3 true) (= result18 (mk_bool__ref success3))))
(assert (=> (= success3 true) (= success4 (ite (= foundtype3 1) true false))))
(assert true)
(assert (=> (= success3 true) (=> (= success4 true) (= (to_rep o17) parser_utilities__convert8bitunsigned__value))))
...
(assert (=> (= success3 true) (=> (= success4 true) (= temp___1807 o18))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18071 o19))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18072 o20))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18073 o21))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18074 o22))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18075 o23))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18076 o24))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18077 o25))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18078 o26))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___18079 o27))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___180710 o28))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___180711 o29))))
(assert (=> (= success3 true) (=> (= success4 true) (= temp___180712 o30))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__attr__tag temp___180713))))
(assert (=> (= success3 true) (=> (= success4 true) (= result19 (mk___split_fields__ref1 (mk___split_fields1 rrsig_rec__split_fields26 rrsig_rec__split_fields27 rrsig_rec__split_fields28 rrsig_rec__split_fields29 rrsig_rec__split_fields30 rrsig_rec__split_fields31 rrsig_rec__split_fields32 rrsig_rec__split_fields33 rrsig_rec__split_fields34 rrsig_rec__split_fields35 rrsig_rec__split_fields36 rrsig_rec__split_fields37 rrsig_rec__split_fields38))))))
(assert (=> (= success3 true) (=> (= success4 true) (= rrsig_rec__split_fields39 (mk___split_fields1 temp___1807 temp___18071 temp___18072 temp___18073 temp___18074 temp___18075 temp___18076 temp___18077 temp___18078 temp___18079 temp___180710 temp___180711 temp___180712)))))
(assert (=> (= success3 true) (=> (not (= success4 true)) (= success5 success4))))
(assert (=> (= success3 true) (=> (not (= success4 true)) (= rrsig_rec__split_fields39 (mk___split_fields1 rrsig_rec__split_fields26 rrsig_rec__split_fields27 rrsig_rec__split_fields28 rrsig_rec__split_fields29 rrsig_rec__split_fields30 rrsig_rec__split_fields31 rrsig_rec__split_fields32 rrsig_rec__split_fields33 rrsig_rec__split_fields34 rrsig_rec__split_fields35 rrsig_rec__split_fields36 rrsig_rec__split_fields37 rrsig_rec__split_fields38)))))
...
(assert (=> (not (= success3 true)) (= rrsig_rec__split_fields39 (mk___split_fields1 rrsig_rec__split_fields26 rrsig_rec__split_fields27 rrsig_rec__split_fields28 rrsig_rec__split_fields29 rrsig_rec__split_fields30 rrsig_rec__split_fields31 rrsig_rec__split_fields32 rrsig_rec__split_fields33 rrsig_rec__split_fields34 rrsig_rec__split_fields35 rrsig_rec__split_fields36 rrsig_rec__split_fields37 rrsig_rec__split_fields38))))
...
(assert (and (= o31 (+ endidx3 1)) (in_range2 (+ endidx3 1))))
(assert (= result21 (mk_int__ref begidx5)))
(assert (= begidx6 o31))
(assert (not (<= begidx6 zlength)))
(check-sat)
(exit)
