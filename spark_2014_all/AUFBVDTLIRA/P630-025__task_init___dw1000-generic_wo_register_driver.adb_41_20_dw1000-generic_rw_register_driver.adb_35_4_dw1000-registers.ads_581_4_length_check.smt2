...
(define-fun dynamic_invariant ((temp___expr_6862 us_t1) (temp___is_init_6859 Bool) (temp___skip_constant_6860 Bool) (temp___do_toplevel_6861 Bool)) Bool (=> (not (= temp___skip_constant_6860 true)) (and (dynamic_property2 1 2 (first3 temp___expr_6862) (last3 temp___expr_6862)) (and (= (first3 temp___expr_6862) 1) (= (last3 temp___expr_6862) 2)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_6878 us_t2) (temp___is_init_6875 Bool) (temp___skip_constant_6876 Bool) (temp___do_toplevel_6877 Bool)) Bool (=> (not (= temp___skip_constant_6876 true)) (and (dynamic_property3 1 2 (first5 temp___expr_6878) (last5 temp___expr_6878)) (and (= (first5 temp___expr_6878) 1) (= (last5 temp___expr_6878) 2)))))
...
(assert (and (= (mk___t2 temp___8168 temp___81681) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___8168 temp___81681) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___81681)) (to_rep (last4 temp___81681))) (+ (- (to_rep (last4 temp___81681)) (to_rep (first4 temp___81681))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
