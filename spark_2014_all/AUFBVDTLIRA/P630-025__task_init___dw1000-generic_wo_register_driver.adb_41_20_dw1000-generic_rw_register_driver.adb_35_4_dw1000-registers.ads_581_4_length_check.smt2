...
(define-fun bool_eq2 ((a us_rep) (b us_rep)) Bool (ite (= (to_rep2 (rec__dw1000__register_types__lde_cfg2_type__lde_cfg2 (us_split_fields1 a))) (to_rep2 (rec__dw1000__register_types__lde_cfg2_type__lde_cfg2 (us_split_fields1 b)))) true false))
...
(define-fun register_byte_array__ref___145__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_7552 us_t1) (temp___is_init_7548 Bool) (temp___skip_constant_7549 Bool) (temp___do_toplevel_7550 Bool) (temp___do_typ_inv_7551 Bool)) Bool (=> (not (= temp___skip_constant_7549 true)) (and (dynamic_property2 1 2 (first3 temp___expr_7552) (last3 temp___expr_7552)) (and (= (first3 temp___expr_7552) 1) (= (last3 temp___expr_7552) 2)))))
(declare-sort t2 0)
...
(define-fun target__ref___62__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_7570 us_t2) (temp___is_init_7566 Bool) (temp___skip_constant_7567 Bool) (temp___do_toplevel_7568 Bool) (temp___do_typ_inv_7569 Bool)) Bool (=> (not (= temp___skip_constant_7567 true)) (and (dynamic_property3 1 2 (first5 temp___expr_7570) (last5 temp___expr_7570)) (and (= (first5 temp___expr_7570) 1) (= (last5 temp___expr_7570) 2)))))
...
(declare-const temp___89401 t2)
(define-fun temp___89402 () us_t2 (mk___t2 temp___8940 temp___89401))
...
(assert (and (= temp___89402 (register_to_bytes reg)) (dynamic_invariant1 temp___89402 true false true true)))
(assert (not (= (ite (<= (to_rep (first4 temp___89401)) (to_rep (last4 temp___89401))) (+ (- (to_rep (last4 temp___89401)) (to_rep (first4 temp___89401))) 1) 0) (ite (<= 1 2) (+ (- 2 1) 1) 0))))
(check-sat)
(exit)
