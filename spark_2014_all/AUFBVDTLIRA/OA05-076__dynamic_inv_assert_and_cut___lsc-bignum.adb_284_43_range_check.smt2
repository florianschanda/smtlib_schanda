...
(assert (and (= o11 (+ a_last 1)) (in_range1 (+ a_last 1))))
(assert (= o12 (ite (<= k o11) true false)))
(assert (= result1 (ite (<= i2 k) o12 false)))
(assert (= (= o13 true) (forall ((k1 Int)) (=> (and (<= i2 k1) (<= k1 (+ a_last 1))) (= (to_rep1 (select a1 k1)) (to_rep1 (select a k1)))))))
(assert (= o7 (from_word32 carry21)))
(assert (and (= o6 (base Tuple0)) (= o6 (oexpon (from_word32 #x00000002) 32))))
(assert (= o8 (omultiply o6 o7)))
(assert (= o5 (from_word32 carry11)))
(assert (= o9 (oadd o5 o8)))
