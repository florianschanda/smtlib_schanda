...
(assert (= (= o14 true) (forall ((k Int)) (=> (and (<= i2 k) (<= k a_last)) (= (to_rep1 (select a1 k)) (to_rep1 (select a k)))))))
(assert (= o11 (num_of_boolean carry2)))
...
(assert (= o10 (oexpon o7 o9)))
(assert (= o12 (omultiply o10 o11)))
(assert (and (= o4 (- i2 a_first)) (in_range1 (- i2 a_first))))
(assert (and (= o5 o4) (in_range2 o4)))
(assert (= o6 (num_of_big_int (mk___t a1 (mk (to_rep a__first) (to_rep a__last))) a_first o5)))
(assert (= o13 (osubtract o6 o12)))
