...
(assert (and (= o15 (readmem64ghost (map__content memory11) (bvsub rbp #x0000000000000048) (map__content memory11))) (= o15 (bvor (bvor (bvor (bvor (bvor (bvor (bvor ((_ zero_extend 56) (to_rep (select (map__content memory11) (bvsub rbp #x0000000000000048)))) (bvshl ((_ zero_extend 56) (to_rep (select (map__content memory11) (bvadd (bvsub rbp #x0000000000000048) #x0000000000000001)))) ((_ int2bv 64) 8))) (bvshl ((_ zero_extend 56) (to_rep (select (map__content memory11) (bvadd (bvsub rbp #x0000000000000048) #x0000000000000002)))) ((_ int2bv 64) 16))) (bvshl ((_ zero_extend 56) (to_rep (select (map__content memory11) (bvadd (bvsub rbp #x0000000000000048) #x0000000000000003)))) ((_ int2bv 64) 24))) (bvshl ((_ zero_extend 56) (to_rep (select (map__content memory11) (bvadd (bvsub rbp #x0000000000000048) #x0000000000000004)))) ((_ int2bv 64) 32))) (bvshl ((_ zero_extend 56) (to_rep (select (map__content memory11) (bvadd (bvsub rbp #x0000000000000048) #x0000000000000005)))) ((_ int2bv 64) 40))) (bvshl ((_ zero_extend 56) (to_rep (select (map__content memory11) (bvadd (bvsub rbp #x0000000000000048) #x0000000000000006)))) ((_ int2bv 64) 48))) (bvshl ((_ zero_extend 56) (to_rep (select (map__content memory11) (bvadd (bvsub rbp #x0000000000000048) #x0000000000000007)))) ((_ int2bv 64) 56))))))
