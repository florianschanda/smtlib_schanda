...
(assert (not (= (ite (<= (to_rep2 (first4 temp___12951)) (to_rep2 (last4 temp___12951))) (+ (- (to_rep2 (last4 temp___12951)) (to_rep2 (first4 temp___12951))) 1) 0) (ite (<= 1 r124b) (+ (- r124b 1) 1) 0))))
(check-sat)
(exit)
