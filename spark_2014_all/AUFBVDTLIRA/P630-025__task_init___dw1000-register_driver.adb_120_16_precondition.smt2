...
(assert (= dw1000__register_driver__write_register__B_5__header__assume5 (mk___rep1 (mk___split_fields1 temp___757 temp___7571 temp___7572 temp___7573 temp___7574))))
...
(assert (let ((temp___696 header1)) (and (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___696))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___696))) 0))))
(assert (= o18 header1))
