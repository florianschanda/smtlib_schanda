...
(assert (let ((temp___806 header1)) (and (= (to_rep5 (rec__dw1000__register_driver__short_indexed_header__sub_index (us_split_fields3 temp___806))) 1) (= (to_rep6 (rec__dw1000__register_driver__short_indexed_header__extended_address (us_split_fields3 temp___806))) 0))))
(assert (= o18 header1))
