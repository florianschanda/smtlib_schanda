...
(define-fun names__to_string__B_3__e__assume3 () us_rep3 (mk___rep2 (mk___split_fields2 names__to_string__B_3__e__assume names__to_string__B_3__e__assume1 names__to_string__B_3__e__assume2)))
...
(assert (and (= names__to_string__B_3__e__assume3 (get1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o)) (= (bool_eq4 names__to_string__B_3__e__assume3 (get1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o)) true)))
(assert (= names__to_string__B_3__e__assume3 e))
