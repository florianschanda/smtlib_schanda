...
(define-fun dynamic_invariant1 ((temp___expr_210 Int) (temp___is_init_206 Bool) (temp___skip_constant_207 Bool) (temp___do_toplevel_208 Bool) (temp___do_typ_inv_209 Bool)) Bool (=> (or (= temp___is_init_206 true) (<= 0 2147483647)) (in_range4 temp___expr_210)))
...
(define-fun dynamic_invariant2 ((temp___expr_629 us_rep) (temp___is_init_625 Bool) (temp___skip_constant_626 Bool) (temp___do_toplevel_627 Bool) (temp___do_typ_inv_628 Bool)) Bool (=> (not (= temp___skip_constant_626 true)) (in_range6 1024 temp___expr_629)))
...
(define-fun dynamic_invariant3 ((temp___expr_639 us_rep1) (temp___is_init_635 Bool) (temp___skip_constant_636 Bool) (temp___do_toplevel_637 Bool) (temp___do_typ_inv_638 Bool)) Bool (=> (not (= temp___skip_constant_636 true)) (in_range8 256 temp___expr_639)))
...
(define-fun dynamic_invariant4 ((temp___expr_318 Int) (temp___is_init_314 Bool) (temp___skip_constant_315 Bool) (temp___do_toplevel_316 Bool) (temp___do_typ_inv_317 Bool)) Bool (=> (or (= temp___is_init_314 true) (<= 0 255)) (in_range12 temp___expr_318)))
...
(define-fun dynamic_invariant5 ((temp___expr_489 Int) (temp___is_init_485 Bool) (temp___skip_constant_486 Bool) (temp___do_toplevel_487 Bool) (temp___do_typ_inv_488 Bool)) Bool (=> (or (= temp___is_init_485 true) (<= 0 2147483647)) (in_range14 temp___expr_489)))
...
(define-fun dynamic_invariant11 ((temp___expr_304 Int) (temp___is_init_300 Bool) (temp___skip_constant_301 Bool) (temp___do_toplevel_302 Bool) (temp___do_typ_inv_303 Bool)) Bool (=> (or (= temp___is_init_300 true) (<= 0 2147483646)) (in_range10 temp___expr_304)))
...
(define-fun dynamic_invariant13 ((temp___expr_332 Int) (temp___is_init_328 Bool) (temp___skip_constant_329 Bool) (temp___do_toplevel_330 Bool) (temp___do_typ_inv_331 Bool)) Bool (=> (or (= temp___is_init_328 true) (<= 0 2147483647)) (in_range5 temp___expr_332)))
...
(define-fun dynamic_invariant14 ((temp___expr_311 Int) (temp___is_init_307 Bool) (temp___skip_constant_308 Bool) (temp___do_toplevel_309 Bool) (temp___do_typ_inv_310 Bool)) Bool (=> (or (= temp___is_init_307 true) (<= 0 2147483646)) (in_range11 temp___expr_311)))
...
(define-fun dynamic_invariant17 ((temp___expr_496 Int) (temp___is_init_492 Bool) (temp___skip_constant_493 Bool) (temp___do_toplevel_494 Bool) (temp___do_typ_inv_495 Bool)) Bool (=> (or (= temp___is_init_492 true) (<= 0 2147483647)) (in_range7 temp___expr_496)))
...
(define-fun default_initial_assumption3 ((temp___expr_538 us_rep4) (temp___skip_top_level_539 Bool)) Bool (=> (not (= temp___skip_top_level_539 true)) (= (length2 temp___expr_538) 0)))
...
(assert (forall ((container us_rep4)) (! (let ((result (length2 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant10 result true false true true))) :pattern ((length2 container)))))
(assert true)
