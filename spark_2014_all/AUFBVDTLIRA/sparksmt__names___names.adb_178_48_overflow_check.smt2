...
(define-fun dynamic_invariant1 ((temp___expr_180 Int) (temp___is_init_177 Bool) (temp___skip_constant_178 Bool) (temp___do_toplevel_179 Bool)) Bool (=> (or (= temp___is_init_177 true) (<= 0 2147483647)) (in_range4 temp___expr_180)))
...
(define-fun in_range6 ((rec__names__data__char_tables__vector__capacity1 Int) (a us_rep)) Bool (= rec__names__data__char_tables__vector__capacity1 (to_rep4 (rec__names__data__char_tables__vector__capacity (us_split_discrs1 a)))))
...
(define-fun dynamic_invariant2 ((temp___expr_569 us_rep) (temp___is_init_566 Bool) (temp___skip_constant_567 Bool) (temp___do_toplevel_568 Bool)) Bool (=> (not (= temp___skip_constant_567 true)) (in_range6 1024 temp___expr_569)))
...
(define-fun in_range8 ((rec__names__data__entry_tables__vector__capacity1 Int) (a us_rep1)) Bool (= rec__names__data__entry_tables__vector__capacity1 (to_rep5 (rec__names__data__entry_tables__vector__capacity (us_split_discrs3 a)))))
...
(define-fun dynamic_invariant3 ((temp___expr_578 us_rep1) (temp___is_init_575 Bool) (temp___skip_constant_576 Bool) (temp___do_toplevel_577 Bool)) Bool (=> (not (= temp___skip_constant_576 true)) (in_range8 256 temp___expr_578)))
...
(declare-const dummy11 tchar_table_indexB)
...
(declare-const dummy12 char_table_index)
...
(define-fun dynamic_invariant4 ((temp___expr_276 Int) (temp___is_init_273 Bool) (temp___skip_constant_274 Bool) (temp___do_toplevel_275 Bool)) Bool (=> (or (= temp___is_init_273 true) (<= 0 255)) (in_range12 temp___expr_276)))
...
(declare-const dummy17 index_type1)
...
(define-fun element_type__ref___3__projection ((a element_type__ref1)) us_rep3 (element_type__content1 a))
...
(define-fun dynamic_invariant5 ((temp___expr_436 Int) (temp___is_init_433 Bool) (temp___skip_constant_434 Bool) (temp___do_toplevel_435 Bool)) Bool (=> (or (= temp___is_init_433 true) (<= 0 2147483647)) (in_range14 temp___expr_436)))
(declare-datatypes () ((element_type__ref2 (mk_element_type__ref2 (element_type__content2 us_rep3)))))
(define-fun element_type__ref___4__projection ((a element_type__ref2)) us_rep3 (element_type__content2 a))
...
(define-fun element1 ((container us_rep1) (index Int)) us_rep3 (get1 (model__1 container) index))
(declare-fun element__function_guard1 (us_rep3 us_rep1 Int) Bool)
...
(define-fun dynamic_invariant6 ((temp___expr_626 us_t1) (temp___is_init_623 Bool) (temp___skip_constant_624 Bool) (temp___do_toplevel_625 Bool)) Bool (=> (not (= temp___skip_constant_624 true)) (and (dynamic_property2 1 l (first3 temp___expr_626) (last5 temp___expr_626)) (and (= (first3 temp___expr_626) 1) (= (last5 temp___expr_626) l)))))
...
(assert true)
(assert (forall ((e1 us_rep3)) (forall ((names__char_table__fields us_split_fields)) (forall ((names__entry_table__fields us_split_fields2)) (! (= (= (valid_entry e1 names__char_table__fields names__entry_table__fields) true) (and (<= (to_rep3 (rec__names__data__name_entry__next_hash (us_split_fields5 e1))) (last_index1 (mk___rep1 entry_table__split_discrs names__entry_table__fields))) (<= (- (to_rep2 (rec__names__data__name_entry__length (us_split_fields5 e1))) 1) (- (last_index (mk___rep char_table__split_discrs names__char_table__fields)) (to_rep6 (rec__names__data__name_entry__table_index (us_split_fields5 e1))))))) :pattern ((valid_entry e1 names__char_table__fields names__entry_table__fields)))))))
(assert true)
...
(define-fun dynamic_invariant10 ((temp___expr_142 Int) (temp___is_init_139 Bool) (temp___skip_constant_140 Bool) (temp___do_toplevel_141 Bool)) Bool (=> (or (= temp___is_init_139 true) (<= 0 2147483647)) (in_range15 temp___expr_142)))
(define-fun dynamic_invariant11 ((temp___expr_264 Int) (temp___is_init_261 Bool) (temp___skip_constant_262 Bool) (temp___do_toplevel_263 Bool)) Bool (=> (or (= temp___is_init_261 true) (<= 0 2147483646)) (in_range10 temp___expr_264)))
...
(define-fun dynamic_invariant12 ((temp___expr_282 Int) (temp___is_init_279 Bool) (temp___skip_constant_280 Bool) (temp___do_toplevel_281 Bool)) Bool (=> (or (= temp___is_init_279 true) (<= (- 1) 2147483647)) (in_range16 temp___expr_282)))
(define-fun dynamic_invariant13 ((temp___expr_288 Int) (temp___is_init_285 Bool) (temp___skip_constant_286 Bool) (temp___do_toplevel_287 Bool)) Bool (=> (or (= temp___is_init_285 true) (<= 0 2147483647)) (in_range5 temp___expr_288)))
...
(assert (forall ((container us_rep)) (! (let ((result (length4 container))) (and (<= result (capacity container)) (dynamic_invariant13 result true false true))) :pattern ((length4 container)))))
...
(assert (forall ((a us_rep2) (b us_rep2)) (! (= (user_eq15 a b) (oeq a b)) :pattern ((user_eq15 a b)))))
...
(define-fun dynamic_invariant14 ((temp___expr_270 Int) (temp___is_init_267 Bool) (temp___skip_constant_268 Bool) (temp___do_toplevel_269 Bool)) Bool (=> (or (= temp___is_init_267 true) (<= 0 2147483646)) (in_range11 temp___expr_270)))
...
(define-fun dynamic_invariant15 ((temp___expr_315 Int) (temp___is_init_312 Bool) (temp___skip_constant_313 Bool) (temp___do_toplevel_314 Bool)) Bool (=> (or (= temp___is_init_312 true) (<= (- 1) 2147483646)) (in_range17 temp___expr_315)))
(assert (forall ((container us_rep2)) (! (let ((result (length1 container))) (and (<= (+ (- 1) result) 2147483646) (dynamic_invariant10 result true false true))) :pattern ((length1 container)))))
...
(define-fun dynamic_invariant16 ((temp___expr_309 Int) (temp___is_init_306 Bool) (temp___skip_constant_307 Bool) (temp___do_toplevel_308 Bool)) Bool (=> (or (= temp___is_init_306 true) (<= 0 255)) (in_range18 temp___expr_309)))
...
(assert (forall ((container us_rep1)) (! (let ((result (length5 container))) (and (<= result (capacity1 container)) (dynamic_invariant17 result true false true))) :pattern ((length5 container)))))
(define-fun oeq1 ((left us_rep4) (right us_rep4)) Bool (and (= (length2 left) (length2 right)) (ite (forall ((n1 Int)) (=> (and (<= 1 n1) (<= n1 (last3 left))) (= (bool_eq4 (get1 left n1) (get1 right n1)) true))) true false)))
(declare-fun oeq__function_guard1 (Bool us_rep4 us_rep4) Bool)
(assert (forall ((a us_rep4) (b us_rep4)) (! (= (user_eq18 a b) (oeq1 a b)) :pattern ((user_eq18 a b)))))
(define-fun default_initial_assumption3 ((temp___expr_479 us_rep4) (temp___skip_top_level_480 Bool)) Bool (=> (not (= temp___skip_top_level_480 true)) (= (length2 temp___expr_479) 0)))
...
(define-fun dynamic_invariant18 ((temp___expr_421 Int) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool)) Bool (=> (or (= temp___is_init_418 true) (<= 1 2147483647)) (in_range13 temp___expr_421)))
...
(define-fun dynamic_invariant19 ((temp___expr_472 Int) (temp___is_init_469 Bool) (temp___skip_constant_470 Bool) (temp___do_toplevel_471 Bool)) Bool (=> (or (= temp___is_init_469 true) (<= 0 2147483647)) (in_range19 temp___expr_472)))
(assert (forall ((container us_rep4)) (! (let ((result (length2 container))) (and (<= (+ 0 result) 2147483647) (dynamic_invariant10 result true false true))) :pattern ((length2 container)))))
(assert true)
...
(declare-const o Int)
(declare-const names__to_string__B_3__e__assume char_table_index)
(declare-const names__to_string__B_3__e__assume1 positive)
(declare-const names__to_string__B_3__e__assume2 name_id)
...
(assert (and (= (mk___rep2 (mk___split_fields2 names__to_string__B_3__e__assume names__to_string__B_3__e__assume1 names__to_string__B_3__e__assume2)) (get1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o)) (= (bool_eq4 (mk___rep2 (mk___split_fields2 names__to_string__B_3__e__assume names__to_string__B_3__e__assume1 names__to_string__B_3__e__assume2)) (get1 (model__1 (mk___rep1 entry_table__split_discrs (mk___split_fields1 entry_table__split_fields))) o)) true)))
(assert (= (mk___rep2 (mk___split_fields2 names__to_string__B_3__e__assume names__to_string__B_3__e__assume1 names__to_string__B_3__e__assume2)) e))
(assert (= (to_rep2 (rec__names__data__name_entry__length (us_split_fields5 e))) l))
(assert (in_range2 l))
(assert (and (dynamic_property2 1 l (to_rep1 s__first) (to_rep1 s__last)) (and (= (to_rep1 s__first) 1) (= (to_rep1 s__last) l))))
(assert (= result i))
(assert (= i1 1))
(assert (<= 1 i1))
(assert (<= i1 l))
(assert (not (in_range9 (+ (to_rep6 (rec__names__data__name_entry__table_index (us_split_fields5 e))) (- i1 1)))))
(check-sat)
(exit)
