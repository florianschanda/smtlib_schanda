...
(assert (= (to_rep2 o38) 0))
(assert (= o39 (mk___split_discrs o38)))
(assert (= temp___341 (mk___rep2 o39 (mk___split_fields2 (mk___rep1 header__split_fields6)) true)))
(assert (= result____attr__constrained true))
(assert (not (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___341)) (rec__parse__parse_result_t__return_code result____split_discrs8))))
(check-sat)
(exit)
