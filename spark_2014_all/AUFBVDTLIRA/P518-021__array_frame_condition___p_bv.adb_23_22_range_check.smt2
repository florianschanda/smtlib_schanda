...
(define-fun in_range1 ((x (_ BitVec 32))) Bool (and (bvule ((_ int2bv 32) 1) x) (bvule x ((_ int2bv 32) 3))))
...
(define-fun bool_eq1 ((a map1) (a__first Int) (a__last Int) (a__first_2 (_ BitVec 16)) (a__last_2 (_ BitVec 16)) (b map1) (b__first Int) (b__last Int) (b__first_2 (_ BitVec 16)) (b__last_2 (_ BitVec 16))) Bool (ite (and (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (ite (bvule a__first_2 a__last_2) (and (bvule b__first_2 b__last_2) (= (bvsub a__last_2 a__first_2) (bvsub b__last_2 b__first_2))) (bvugt b__first_2 b__last_2))) (forall ((temp___idx_133 Int)) (forall ((temp___idx_134 (_ BitVec 16))) (=> (and (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (and (bvule a__first_2 temp___idx_134) (bvule temp___idx_134 a__last_2))) (= (bool_eq (get a temp___idx_133 temp___idx_134) 1 3 (get b (+ (- b__first a__first) temp___idx_133) (bvadd (bvsub b__first_2 a__first_2) temp___idx_134)) 1 3) true))))) true false))
(assert (forall ((a map1) (b map1)) (forall ((a__first Int) (a__last Int) (b__first Int) (b__last Int)) (forall ((a__first_2 (_ BitVec 16)) (a__last_2 (_ BitVec 16)) (b__first_2 (_ BitVec 16)) (b__last_2 (_ BitVec 16))) (=> (= (bool_eq1 b b__first b__last b__first_2 b__last_2 a a__first a__last a__first_2 a__last_2) true) (and (and (ite (<= a__first a__last) (and (<= b__first b__last) (= (- a__last a__first) (- b__last b__first))) (< b__last b__first)) (ite (bvule a__first_2 a__last_2) (and (bvule b__first_2 b__last_2) (= (bvsub a__last_2 a__first_2) (bvsub b__last_2 b__first_2))) (bvugt b__first_2 b__last_2))) (forall ((temp___idx_133 Int)) (forall ((temp___idx_134 (_ BitVec 16))) (=> (and (and (<= a__first temp___idx_133) (<= temp___idx_133 a__last)) (and (bvule a__first_2 temp___idx_134) (bvule temp___idx_134 a__last_2))) (= (bool_eq (get a temp___idx_133 temp___idx_134) 1 3 (get b (+ (- b__first a__first) temp___idx_133) (bvadd (bvsub b__first_2 a__first_2) temp___idx_134)) 1 3) true))))))))))
...
(declare-fun concat2 ((Array (_ BitVec 32) map1) (_ BitVec 32) (_ BitVec 32) (Array (_ BitVec 32) map1) (_ BitVec 32) (_ BitVec 32)) (Array (_ BitVec 32) map1))
(assert (forall ((a (Array (_ BitVec 32) map1)) (b (Array (_ BitVec 32) map1))) (forall ((a_first (_ BitVec 32)) (a_last (_ BitVec 32)) (b_first (_ BitVec 32)) (b_last (_ BitVec 32))) (forall ((i (_ BitVec 32))) (! (and (=> (and (bvule a_first i) (bvule i a_last)) (= (select (concat2 a a_first a_last b b_first b_last) i) (select a i))) (=> (bvugt i a_last) (= (select (concat2 a a_first a_last b b_first b_last) i) (select b (bvadd (bvsub i a_last) (bvsub b_first #x00000001)))))) :pattern ((select (concat2 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton2 (map1 (_ BitVec 32)) (Array (_ BitVec 32) map1))
(assert (forall ((v map1)) (forall ((i (_ BitVec 32))) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
(define-fun bool_eq2 ((a (Array (_ BitVec 32) map1)) (a__first (_ BitVec 32)) (a__last (_ BitVec 32)) (b (Array (_ BitVec 32) map1)) (b__first (_ BitVec 32)) (b__last (_ BitVec 32))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_135 (_ BitVec 32))) (=> (and (bvule a__first temp___idx_135) (bvule temp___idx_135 a__last)) (= (bool_eq1 (select a temp___idx_135) 1 3 ((_ int2bv 16) 1) ((_ int2bv 16) 3) (select b (bvadd (bvsub b__first a__first) temp___idx_135)) 1 3 ((_ int2bv 16) 1) ((_ int2bv 16) 3)) true)))) true false))
(assert (forall ((a (Array (_ BitVec 32) map1)) (b (Array (_ BitVec 32) map1))) (forall ((a__first (_ BitVec 32)) (a__last (_ BitVec 32)) (b__first (_ BitVec 32)) (b__last (_ BitVec 32))) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_135 (_ BitVec 32))) (=> (and (bvule a__first temp___idx_135) (bvule temp___idx_135 a__last)) (= (bool_eq1 (select a temp___idx_135) 1 3 ((_ int2bv 16) 1) ((_ int2bv 16) 3) (select b (bvadd (bvsub b__first a__first) temp___idx_135)) 1 3 ((_ int2bv 16) 1) ((_ int2bv 16) 3)) true))))))))
...
(assert (forall ((temp___243 map1)) (forall ((temp___244 (_ BitVec 32))) (= (select (p_bv__x__aggregate_def temp___243) temp___244) temp___243))))
(declare-fun temp___245 ((Array Int integer)) map1)
(assert (forall ((temp___247 (Array Int integer))) (forall ((temp___248 Int)) (forall ((temp___249 (_ BitVec 16))) (= (get (temp___245 temp___247) temp___248 temp___249) temp___247)))))
(declare-fun temp___250 (Int) (Array Int integer))
(assert (forall ((temp___252 Int)) (forall ((temp___253 Int)) (= (select (temp___250 temp___252) temp___253) (of_rep temp___252)))))
...
(define-fun dynamic_invariant1 ((temp___expr_187 (_ BitVec 32)) (temp___is_init_184 Bool) (temp___skip_constant_185 Bool) (temp___do_toplevel_186 Bool)) Bool true)
(define-fun dynamic_invariant2 ((temp___expr_199 (_ BitVec 32)) (temp___is_init_196 Bool) (temp___skip_constant_197 Bool) (temp___do_toplevel_198 Bool)) Bool (=> (or (= temp___is_init_196 true) (bvule ((_ int2bv 32) 1) ((_ int2bv 32) 3))) (in_range1 temp___expr_199)))
...
(assert (= x28 o107))
(assert (=> (bvule (bvadd i31 ((_ int2bv 32) 1)) ((_ int2bv 32) 3)) (and (and (bvule ((_ int2bv 32) 1) (bvadd i31 ((_ int2bv 32) 1))) (bvule (bvadd i31 ((_ int2bv 32) 1)) ((_ int2bv 32) 3))) (and (bvule ((_ int2bv 32) 1) ((_ int2bv 32) 3)) (bvule ((_ int2bv 32) 3) ((_ int2bv 32) 3))))))
(assert (= o108 y))
(assert (= temp___283 o108))
(assert (= temp___2831 (mk1 (bvadd i31 ((_ int2bv 32) 1)) ((_ int2bv 32) 3))))
(assert (bvule (bvadd i31 ((_ int2bv 32) 1)) ((_ int2bv 32) 3)))
(assert (not (bvule ((_ int2bv 32) 1) (bvadd i31 ((_ int2bv 32) 1)))))
(check-sat)
(exit)
