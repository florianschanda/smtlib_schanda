...
(declare-const temp___319 (Array (_ BitVec 32) map1))
(declare-const temp___3191 t1)
...
(assert (= x28 o107))
(assert (=> (bvule (bvadd i31 #x00000001) #x00000003) (and (and (bvule #x00000001 (bvadd i31 #x00000001)) (bvule (bvadd i31 #x00000001) #x00000003)) (and (bvule #x00000001 #x00000003) (bvule #x00000003 #x00000003)))))
(assert (= o108 y))
(assert (= temp___319 o108))
(assert (= temp___3191 (mk1 (bvadd i31 #x00000001) #x00000003)))
(assert (bvule (bvadd i31 #x00000001) #x00000003))
(assert (not (bvule #x00000001 (bvadd i31 #x00000001))))
(check-sat)
(exit)
