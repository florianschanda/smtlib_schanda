...
(declare-fun user_eq6 (u64 u64) Bool)
(declare-const dummy6 u64)
...
(assert (forall ((x byte)) (! (uint_in_range1 (to_int4 x)) :pattern ((to_int4 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_422 us_t1) (temp___is_init_418 Bool) (temp___skip_constant_419 Bool) (temp___do_toplevel_420 Bool) (temp___do_typ_inv_421 Bool)) Bool (and (=> (not (= temp___skip_constant_419 true)) (dynamic_property1 #x0000000000000000 #xFFFFFFFFFFFFFFFF (first3 temp___expr_422) (last3 temp___expr_422))) (=> (= temp___do_toplevel_420 true) (=> (= temp___is_init_418 true) (bvult (last3 temp___expr_422) #xFFFFFFFFFFFFFFFF)))))
(define-fun dynamic_predicate ((temp___425 us_t1)) Bool (bvult (last3 temp___425) #xFFFFFFFFFFFFFFFF))
...
(define-fun dynamic_invariant6 ((temp___expr_331 (_ BitVec 8)) (temp___is_init_327 Bool) (temp___skip_constant_328 Bool) (temp___do_toplevel_329 Bool) (temp___do_typ_inv_330 Bool)) Bool true)
...
(assert (and (= (to_rep2 (first2 (rt1 s))) #x0000000000000000) (bvule count (ite (bvule (to_rep2 (first2 (rt1 s))) (to_rep2 (last2 (rt1 s)))) (bvadd (bvsub (to_rep2 (last2 (rt1 s))) (to_rep2 (first2 (rt1 s)))) #x0000000000000001) #x0000000000000000))))
(assert (not (bvule count (ite (bvule (to_rep2 (first2 (rt1 s))) (to_rep2 (last2 (rt1 s)))) (bvadd (bvsub (to_rep2 (last2 (rt1 s))) (to_rep2 (first2 (rt1 s)))) #x0000000000000001) #x0000000000000000))))
(check-sat)
(exit)
