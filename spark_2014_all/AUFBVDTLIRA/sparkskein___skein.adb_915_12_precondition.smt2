...
(define-fun to_int3 ((x unsigned_64)) Int (bv2nat (to_rep2 x)))
...
(define-fun to_int5 ((x byte)) Int (bv2nat (to_rep3 x)))
(assert (forall ((x byte)) (! (uint_in_range1 (to_int5 x)) :pattern ((to_int5 x)))))
...
(assert (forall ((a (Array (_ BitVec 64) byte))) (forall ((first2 (_ BitVec 64))) (! (= (slide1 a first2 first2) a) :pattern ((slide1 a first2 first2))))))
...
(declare-fun concat2 ((Array (_ BitVec 64) byte) (_ BitVec 64) (_ BitVec 64) (Array (_ BitVec 64) byte) (_ BitVec 64) (_ BitVec 64)) (Array (_ BitVec 64) byte))
(assert (forall ((a (Array (_ BitVec 64) byte)) (b (Array (_ BitVec 64) byte))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (forall ((i (_ BitVec 64))) (! (and (=> (and (bvule a_first i) (bvule i a_last)) (= (select (concat2 a a_first a_last b b_first b_last) i) (select a i))) (=> (bvugt i a_last) (= (select (concat2 a a_first a_last b b_first b_last) i) (select b (bvadd (bvsub i a_last) (bvsub b_first #x0000000000000001)))))) :pattern ((select (concat2 a a_first a_last b b_first b_last) i)))))))
(declare-fun singleton2 (byte (_ BitVec 64)) (Array (_ BitVec 64) byte))
(assert (forall ((v byte)) (forall ((i (_ BitVec 64))) (! (= (select (singleton2 v i) i) v) :pattern ((select (singleton2 v i) i))))))
(define-fun bool_eq2 ((a (Array (_ BitVec 64) byte)) (a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b (Array (_ BitVec 64) byte)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) Bool (ite (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep3 (select a temp___idx_132)) (to_rep3 (select b (bvadd (bvsub b__first a__first) temp___idx_132))))))) true false))
(assert (forall ((a (Array (_ BitVec 64) byte)) (b (Array (_ BitVec 64) byte))) (forall ((a__first (_ BitVec 64)) (a__last (_ BitVec 64)) (b__first (_ BitVec 64)) (b__last (_ BitVec 64))) (=> (= (bool_eq2 b b__first b__last a a__first a__last) true) (and (ite (bvule a__first a__last) (and (bvule b__first b__last) (= (bvsub a__last a__first) (bvsub b__last b__first))) (bvugt b__first b__last)) (forall ((temp___idx_132 (_ BitVec 64))) (=> (and (bvule a__first temp___idx_132) (bvule temp___idx_132 a__last)) (= (to_rep3 (select a temp___idx_132)) (to_rep3 (select b (bvadd (bvsub b__first a__first) temp___idx_132)))))))))))
(declare-fun compare1 ((Array (_ BitVec 64) byte) (_ BitVec 64) (_ BitVec 64) (Array (_ BitVec 64) byte) (_ BitVec 64) (_ BitVec 64)) Int)
(assert (forall ((a (Array (_ BitVec 64) byte)) (b (Array (_ BitVec 64) byte))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (= (compare1 a a_first a_last b b_first b_last) 0) (= (bool_eq2 a a_first a_last b b_first b_last) true)) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 64) byte)) (b (Array (_ BitVec 64) byte))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< (compare1 a a_first a_last b b_first b_last) 0) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i a_last) (and (bvult j b_last) (and (= (bool_eq2 a a_first i b b_first j) true) (or (= i a_last) (and (bvult i a_last) (bvult (to_rep3 (select a (bvadd i #x0000000000000001))) (to_rep3 (select b (bvadd j #x0000000000000001))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(assert (forall ((a (Array (_ BitVec 64) byte)) (b (Array (_ BitVec 64) byte))) (forall ((a_first (_ BitVec 64)) (a_last (_ BitVec 64)) (b_first (_ BitVec 64)) (b_last (_ BitVec 64))) (! (= (< 0 (compare1 a a_first a_last b b_first b_last)) (exists ((i (_ BitVec 64)) (j (_ BitVec 64))) (and (bvule i b_last) (and (bvult j a_last) (and (= (bool_eq2 a a_first j b b_first i) true) (or (= i b_last) (and (bvult i b_last) (bvugt (to_rep3 (select a (bvadd j #x0000000000000001))) (to_rep3 (select b (bvadd i #x0000000000000001))))))))))) :pattern ((compare1 a a_first a_last b b_first b_last))))))
(declare-sort t1 0)
...
(declare-datatypes () ((byte_seq__ref (mk_byte_seq__ref (byte_seq__content us_t1)))))
(define-fun byte_seq__ref___projection ((a byte_seq__ref)) us_t1 (byte_seq__content a))
(define-fun dynamic_invariant2 ((temp___expr_368 us_t1) (temp___is_init_365 Bool) (temp___skip_constant_366 Bool) (temp___do_toplevel_367 Bool)) Bool (and (=> (not (= temp___skip_constant_366 true)) (dynamic_property1 ((_ int2bv 64) 0) ((_ int2bv 64) 18446744073709551615) (first3 temp___expr_368) (last3 temp___expr_368))) (=> (= temp___do_toplevel_367 true) (=> (= temp___is_init_365 true) (bvult (last3 temp___expr_368) ((_ int2bv 64) 18446744073709551615))))))
(define-fun dynamic_predicate ((temp___371 us_t1)) Bool (bvult (last3 temp___371) ((_ int2bv 64) 18446744073709551615)))
...
(define-fun dynamic_invariant6 ((temp___expr_290 (_ BitVec 8)) (temp___is_init_287 Bool) (temp___skip_constant_288 Bool) (temp___do_toplevel_289 Bool)) Bool true)
...
(assert (and (= (to_rep2 (first2 (rt1 s))) ((_ int2bv 64) 0)) (bvule count (ite (bvule (to_rep2 (first2 (rt1 s))) (to_rep2 (last2 (rt1 s)))) (bvadd (bvsub (to_rep2 (last2 (rt1 s))) (to_rep2 (first2 (rt1 s)))) ((_ int2bv 64) 1)) ((_ int2bv 64) 0)))))
(assert (not (bvule count (ite (bvule (to_rep2 (first2 (rt1 s))) (to_rep2 (last2 (rt1 s)))) (bvadd (bvsub (to_rep2 (last2 (rt1 s))) (to_rep2 (first2 (rt1 s)))) ((_ int2bv 64) 1)) ((_ int2bv 64) 0)))))
(check-sat)
(exit)
