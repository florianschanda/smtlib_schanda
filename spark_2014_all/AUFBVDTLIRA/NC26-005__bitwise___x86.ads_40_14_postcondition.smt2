...
(assert (and (= (readmem8 (bvadd addr ((_ int2bv 64) 1)) memory2) o3) (forall ((x (_ BitVec 64))) (=> (and (bvule ((_ int2bv 64) 0) x) (bvule x ((_ int2bv 64) 18446744073709551615))) (or (= x (bvadd addr ((_ int2bv 64) 1))) (= (to_rep (select memory2 x)) (to_rep (select memory1 x))))))))
(assert (= memory2 memory3))
(assert (= memory4 memory2))
(assert (not (= (bvor ((_ zero_extend 8) (readmem8 addr memory3)) (ite (< 8 16) (bvshl ((_ zero_extend 8) (readmem8 (bvadd addr ((_ int2bv 64) 1)) memory3)) ((_ int2bv 16) 8)) ((_ int2bv 16) 0))) val__)))
(check-sat)
(exit)
