...
(assert (= o10 (num_of_big_int c c_first o9)))
(assert (= result3 (olt o10 o15)))
(assert (= result3 true))
(assert (and (= o1 (- a_last a_first)) (in_range1 (- a_last a_first))))
(assert (= o2 (+ o1 1)))
(assert (and (= o3 o2) (in_range1 o2)))
(assert (and (= o4 o3) (in_range2 o3)))
(assert (= o5 (num_of_big_int m m_first o4)))
(assert (= o (from_word32 #x00000001)))
(assert (= result4 (olt o o5)))
(assert (= result4 true))
(assert (not (<= (to_rep (first (rt m))) m_first)))
(check-sat)
(exit)
