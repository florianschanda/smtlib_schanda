...
(assert (= result7 (ite (= o53 true) (ite (<= k a_last) true false) false)))
(assert (= (= o54 true) (forall ((k1 Int)) (=> (and (<= (+ i2 1) k1) (<= k1 a_last)) (= (to_rep1 (select a2 k1)) (to_rep1 (select a k1)))))))
(assert (= o49 (num_of_boolean carry3)))
