...
(declare-fun temp___337 ((_ BitVec 8) Int Int) us_t2)
...
(assert (forall ((temp___339 (_ BitVec 8))) (forall ((temp___340 Int) (temp___341 Int)) (let ((temp___338 (temp___337 temp___339 temp___340 temp___341))) (=> (dynamic_invariant5 temp___339 true true true true) (and (=> (dynamic_property1 0 2147483647 temp___340 temp___341) (and (= (first5 temp___338) temp___340) (= (last5 temp___338) temp___341))) (forall ((temp___342 Int)) (= (to_rep2 (select (to_array2 temp___338) temp___342)) temp___339))))))))
...
(assert (= (to_rep1 (first4 (rt2 (temp___337 #x00 (to_rep1 data__first) (to_rep1 data__last))))) (to_rep1 data__first)))
(assert (= (to_rep1 (last4 (rt2 (temp___337 #x00 (to_rep1 data__first) (to_rep1 data__last))))) (to_rep1 data__last)))
(assert (= (mk___t2 temp___344 temp___3441) (temp___337 #x00 (to_rep1 data__first) (to_rep1 data__last))))
(assert (= temp___344 temp___345))
(assert (= (mk1 (to_rep1 (first4 temp___3441)) (to_rep1 (last4 temp___3441))) temp___3451))
(assert (not (= (ite (<= (to_rep1 (first2 temp___3451)) (to_rep1 (last2 temp___3451))) (+ (- (to_rep1 (last2 temp___3451)) (to_rep1 (first2 temp___3451))) 1) 0) (ite (<= (to_rep1 data__first) (to_rep1 data__last)) (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1) 0))))
(check-sat)
(exit)
