...
(assert (forall ((temp___304 (_ BitVec 8))) (forall ((temp___305 Int) (temp___306 Int)) (let ((temp___303 (temp___302 temp___304 temp___305 temp___306))) (and (=> (dynamic_property1 0 2147483647 temp___305 temp___306) (and (= (first5 temp___303) temp___305) (= (last5 temp___303) temp___306))) (forall ((temp___307 Int)) (= (select (to_array2 temp___303) temp___307) (of_rep2 temp___304))))))))
...
(define-fun dynamic_invariant5 ((temp___expr_219 (_ BitVec 8)) (temp___is_init_216 Bool) (temp___skip_constant_217 Bool) (temp___do_toplevel_218 Bool)) Bool true)
(define-fun dynamic_invariant6 ((temp___expr_225 us_t1) (temp___is_init_222 Bool) (temp___skip_constant_223 Bool) (temp___do_toplevel_224 Bool)) Bool (=> (not (= temp___skip_constant_223 true)) (dynamic_property1 0 2147483647 (first3 temp___expr_225) (last3 temp___expr_225))))
(declare-const data (Array Int octet))
(declare-const octet_count Int)
(declare-const i Int)
(declare-const temp___309 (Array Int octet))
(declare-const temp___3091 t2)
(declare-const temp___310 (Array Int octet))
(declare-const temp___3101 t1)
(declare-const temp___311 (Array Int octet))
(declare-const temp___3111 t1)
...
(assert (= (to_rep1 (first4 (rt2 (temp___302 ((_ int2bv 8) 0) (to_rep1 data__first) (to_rep1 data__last))))) (to_rep1 data__first)))
(assert (= (to_rep1 (last4 (rt2 (temp___302 ((_ int2bv 8) 0) (to_rep1 data__first) (to_rep1 data__last))))) (to_rep1 data__last)))
(assert (= (mk___t2 temp___309 temp___3091) (temp___302 ((_ int2bv 8) 0) (to_rep1 data__first) (to_rep1 data__last))))
(assert (= temp___309 temp___310))
(assert (= (mk1 (to_rep1 (first4 temp___3091)) (to_rep1 (last4 temp___3091))) temp___3101))
(assert (not (= (ite (<= (to_rep1 (first2 temp___3101)) (to_rep1 (last2 temp___3101))) (+ (- (to_rep1 (last2 temp___3101)) (to_rep1 (first2 temp___3101))) 1) 0) (ite (<= (to_rep1 data__first) (to_rep1 data__last)) (+ (- (to_rep1 data__last) (to_rep1 data__first)) 1) 0))))
(check-sat)
(exit)
