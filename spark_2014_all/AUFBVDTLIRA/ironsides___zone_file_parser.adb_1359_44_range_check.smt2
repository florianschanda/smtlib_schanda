...
(assert (= i22 r92b))
(assert (=> (and (<= r92b i22) (<= i22 r93b)) (= temp___1777 endidx11)))
(assert (=> (and (<= r92b i22) (<= i22 r93b)) (= temp___1775 newdomainname1)))
(assert (=> (and (<= r92b i22) (<= i22 r93b)) (= temp___1774 i22)))
(assert (=> (and (<= r92b i22) (<= i22 r93b)) (and (and (<= 1 begidx17) (<= (+ (- endidx11 begidx17) 1) 128)) (= endidx11 temp___1777))))
...
(assert (=> (and (<= r92b i22) (<= i22 r93b)) (and (= temp___1773 o7) (in_range1 o7))))
(assert (=> (and (<= r92b i22) (<= i22 r93b)) (and (<= 1 temp___1773) (<= temp___1773 128))))
(assert (=> (and (<= r92b i22) (<= i22 r93b)) (= o9 temp___1773)))
