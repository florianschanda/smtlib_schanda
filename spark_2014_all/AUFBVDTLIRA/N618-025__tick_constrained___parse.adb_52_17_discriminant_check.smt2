...
(declare-const temp___375 us_rep2)
...
(assert (= qdcount1 o17))
(assert (not (and (bvuge qdcount1 #x0001) (bvule qdcount1 #x0010))))
...
(assert (= temp___375 (mk___rep2 o19 (mk___split_fields2 dummy6) true)))
(assert (= result____attr__constrained true))
(assert (not (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___375)) (rec__parse__parse_result_t__return_code result____split_discrs4))))
(check-sat)
(exit)
