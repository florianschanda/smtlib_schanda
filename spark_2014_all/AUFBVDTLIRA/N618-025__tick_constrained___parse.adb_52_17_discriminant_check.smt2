...
(define-fun dynamic_invariant ((temp___expr_160 (_ BitVec 8)) (temp___is_init_157 Bool) (temp___skip_constant_158 Bool) (temp___do_toplevel_159 Bool)) Bool true)
...
(define-fun dynamic_invariant1 ((temp___expr_166 (_ BitVec 16)) (temp___is_init_163 Bool) (temp___skip_constant_164 Bool) (temp___do_toplevel_165 Bool)) Bool true)
...
(assert (forall ((x unsigned_16)) (! (uint_in_range1 (to_int5 x)) :pattern ((to_int5 x)))))
...
(define-fun dynamic_invariant2 ((temp___expr_238 Int) (temp___is_init_235 Bool) (temp___skip_constant_236 Bool) (temp___do_toplevel_237 Bool)) Bool (=> (or (= temp___is_init_235 true) (<= 0 1)) (in_range1 temp___expr_238)))
...
(assert (forall ((x return_code_t)) (! (in_range1 (to_rep2 x)) :pattern ((to_rep2 x)))))
...
(assert (forall ((x query_opcode)) (! (in_range2 (to_rep3 x)) :pattern ((to_rep3 x)))))
...
(assert (forall ((x qdcount_range)) (! (in_range3 (to_rep4 x)) :pattern ((to_rep4 x)))))
...
(define-fun dynamic_invariant3 ((temp___expr_257 Int) (temp___is_init_254 Bool) (temp___skip_constant_255 Bool) (temp___do_toplevel_256 Bool)) Bool (=> (or (= temp___is_init_254 true) (<= 0 512)) (in_range4 temp___expr_257)))
...
(assert (forall ((query (Array Int us_rep))) (forall ((offset Int)) (! (=> (and (dynamic_invariant3 offset true true true) (<= offset 511)) (dynamic_invariant1 (extract_unsigned_16 query offset) true false true)) :pattern ((extract_unsigned_16 query offset))))))
...
(define-fun dynamic_invariant4 ((temp___expr_251 Int) (temp___is_init_248 Bool) (temp___skip_constant_249 Bool) (temp___do_toplevel_250 Bool)) Bool (=> (or (= temp___is_init_248 true) (<= 0 7)) (in_range5 temp___expr_251)))
...
(assert (forall ((query (Array Int us_rep))) (forall ((offset Int) (bit_shift_right Int)) (forall ((bit_mask (_ BitVec 8))) (! (=> (and (and (dynamic_invariant3 offset true true true) (dynamic_invariant4 bit_shift_right true true true)) (dynamic_invariant bit_mask true true true)) (dynamic_invariant (extract_bits_of_octet query offset bit_shift_right bit_mask) true false true)) :pattern ((extract_bits_of_octet query offset bit_shift_right bit_mask)))))))
...
(define-fun default_initial_assumption ((temp___expr_300 us_rep2) (temp___skip_top_level_301 Bool)) Bool (and (= (attr__constrained temp___expr_300) false) (= (to_rep2 (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___expr_300))) 1)))
...
(define-fun dynamic_invariant5 ((temp___expr_273 Int) (temp___is_init_270 Bool) (temp___skip_constant_271 Bool) (temp___do_toplevel_272 Bool)) Bool (=> (or (= temp___is_init_270 true) (<= 0 1)) (in_range2 temp___expr_273)))
(define-fun dynamic_invariant6 ((temp___expr_279 Int) (temp___is_init_276 Bool) (temp___skip_constant_277 Bool) (temp___do_toplevel_278 Bool)) Bool (=> (or (= temp___is_init_276 true) (<= 1 16)) (in_range3 temp___expr_279)))
...
(declare-const o7 return_code_t)
(declare-const o8 return_code_t)
(declare-const temp___314 return_code_t)
(declare-const temp___3141 unsigned_16)
(declare-const temp___3142 query_opcode)
(declare-const temp___3143 qdcount_range)
(declare-const temp___3144 Bool)
(declare-const o9 (_ BitVec 8))
(declare-const o10 query_opcode)
(declare-const o11 unsigned_16)
(declare-const o12 query_opcode)
(declare-const o13 qdcount_range)
(declare-const temp___318 us_rep1)
(declare-const o14 query_opcode)
(declare-const o15 us_split_fields2)
(declare-const temp___320 us_rep1)
(declare-const o16 return_code_t)
(declare-const o17 us_split_discrs)
(declare-const temp___321 us_rep2)
(declare-const o18 (_ BitVec 8))
(declare-const o19 Bool)
(declare-const o20 Bool)
(declare-const o21 return_code_t)
(declare-const o22 us_split_discrs)
(declare-const temp___324 us_rep2)
(declare-const o23 (_ BitVec 16))
(declare-const o24 Int)
(declare-const o25 qdcount_range)
(declare-const o26 us_split_fields2)
(declare-const temp___331 us_rep1)
(declare-const o27 return_code_t)
(declare-const o28 us_split_discrs)
(declare-const temp___327 us_rep2)
(declare-const o29 (_ BitVec 16))
(declare-const o30 return_code_t)
(declare-const o31 us_split_discrs)
(declare-const temp___332 us_rep2)
(declare-const o32 (_ BitVec 16))
(declare-const o33 return_code_t)
(declare-const o34 us_split_discrs)
(declare-const temp___335 us_rep2)
(declare-const o35 (_ BitVec 16))
(declare-const o36 return_code_t)
(declare-const o37 us_split_discrs)
(declare-const temp___338 us_rep2)
(declare-const o38 return_code_t)
(declare-const o39 us_split_discrs)
(declare-const temp___341 us_rep2)
...
(assert (= header__split_fields3 (mk___split_fields1 temp___313 temp___3131 temp___3132)))
...
(assert (= o9 (extract_bits_of_octet query 2 3 ((_ int2bv 8) 15))))
(assert (= result2 (mk_t__ref opcode)))
(assert (= opcode1 o9))
(assert (=> (= opcode1 ((_ int2bv 8) 0)) (= (to_rep3 o10) 0)))
(assert (=> (= opcode1 ((_ int2bv 8) 0)) (= (rec__types__query_header__id header__split_fields3) o11)))
(assert (=> (= opcode1 ((_ int2bv 8) 0)) (= o10 o12)))
(assert (=> (= opcode1 ((_ int2bv 8) 0)) (= (rec__types__query_header__qdcount header__split_fields3) o13)))
(assert (=> (= opcode1 ((_ int2bv 8) 0)) (= temp___318 (mk___rep1 (mk___split_fields1 o11 o12 o13)))))
(assert (=> (= opcode1 ((_ int2bv 8) 0)) (= result3 (mk___split_fields__ref1 header__split_fields3))))
(assert (=> (= opcode1 ((_ int2bv 8) 0)) (= header__split_fields4 (us_split_fields3 temp___318))))
(assert (=> (= opcode1 ((_ int2bv 8) 0)) (= result____split_discrs3 result____split_discrs2)))
(assert (=> (= opcode1 ((_ int2bv 8) 0)) (= result____split_fields5 result____split_fields4)))
(assert (=> (not (= opcode1 ((_ int2bv 8) 0))) (= opcode1 ((_ int2bv 8) 1))))
(assert (=> (not (= opcode1 ((_ int2bv 8) 0))) (= (to_rep3 o14) 1)))
(assert (=> (not (= opcode1 ((_ int2bv 8) 0))) (= o15 (mk___split_fields1 (rec__types__query_header__id header__split_fields3) o14 (rec__types__query_header__qdcount header__split_fields3)))))
(assert (=> (not (= opcode1 ((_ int2bv 8) 0))) (= temp___320 (mk___rep1 o15))))
(assert (=> (not (= opcode1 ((_ int2bv 8) 0))) (= result4 (mk___split_fields__ref1 header__split_fields3))))
(assert (=> (not (= opcode1 ((_ int2bv 8) 0))) (= header__split_fields5 (us_split_fields3 temp___320))))
(assert (=> (not (= opcode1 ((_ int2bv 8) 0))) (= result____split_discrs3 result____split_discrs2)))
(assert (=> (not (= opcode1 ((_ int2bv 8) 0))) (= result____split_fields5 result____split_fields4)))
(assert (=> (not (= opcode1 ((_ int2bv 8) 0))) (= header__split_fields4 header__split_fields5)))
(assert (= o18 (extract_bits_of_octet query 2 0 ((_ int2bv 8) 6))))
(assert (= o19 (ite (= o18 ((_ int2bv 8) 0)) true false)))
(assert (= o20 (ite (not (= o19 true)) true false)))
(assert (= result5 (ite (= o20 false) (ite (not (= (to_rep (rec__types__octet__data (us_split_fields1 (select query 3)))) ((_ int2bv 8) 0))) true false) true)))
...
(assert (= o23 (extract_unsigned_16 query 4)))
(assert (= result6 (mk_t__ref1 qdcount)))
(assert (= qdcount1 o23))
(assert (not (and (bvuge qdcount1 ((_ int2bv 16) 1)) (bvule qdcount1 ((_ int2bv 16) 16)))))
(assert (= (to_rep2 (rec__parse__parse_result_t__return_code result____split_discrs4)) r14b))
(assert (in_range1 r14b))
(assert (= (to_rep2 o27) 1))
(assert (= o28 (mk___split_discrs o27)))
(assert (= temp___327 (mk___rep2 o28 (mk___split_fields2 dummy6) true)))
(assert (= result____attr__constrained true))
(assert (not (= (rec__parse__parse_result_t__return_code (us_split_discrs1 temp___327)) (rec__parse__parse_result_t__return_code result____split_discrs4))))
(check-sat)
(exit)
