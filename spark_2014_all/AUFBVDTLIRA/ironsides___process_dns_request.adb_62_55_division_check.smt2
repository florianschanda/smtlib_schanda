...
(define-fun dynamic_invariant1 ((temp___expr_956 (_ BitVec 16)) (temp___is_init_952 Bool) (temp___skip_constant_953 Bool) (temp___do_toplevel_954 Bool) (temp___do_typ_inv_955 Bool)) Bool true)
...
(assert (<= start_byte 8179))
(assert (= (to_rep o) ((_ extract 7 0) (bvurem (bvudiv value #x0100) #x0100))))
