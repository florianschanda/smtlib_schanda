...
(define-fun dynamic_invariant ((temp___expr_2429 us_t1) (temp___is_init_2425 Bool) (temp___skip_constant_2426 Bool) (temp___do_toplevel_2427 Bool) (temp___do_typ_inv_2428 Bool)) Bool (=> (not (= temp___skip_constant_2426 true)) (and (dynamic_property2 1 5 (first3 temp___expr_2429) (last3 temp___expr_2429)) (and (= (first3 temp___expr_2429) 1) (= (last3 temp___expr_2429) 5)))))
(declare-sort t2 0)
...
(define-fun dynamic_invariant1 ((temp___expr_2456 us_t2) (temp___is_init_2452 Bool) (temp___skip_constant_2453 Bool) (temp___do_toplevel_2454 Bool) (temp___do_typ_inv_2455 Bool)) Bool (=> (not (= temp___skip_constant_2453 true)) (and (dynamic_property3 1 5 (first5 temp___expr_2456) (last5 temp___expr_2456)) (and (= (first5 temp___expr_2456) 1) (= (last5 temp___expr_2456) 5)))))
...
(declare-const temp___84881 t2)
(declare-const temp___8489 (Array Int bits_8))
(declare-const temp___84891 t1)
...
(define-fun temp___84882 () us_t2 (mk___t2 temp___8488 temp___84881))
...
(assert (and (= temp___84882 (register_to_bytes reg)) (dynamic_invariant1 temp___84882 true false true true)))
(assert (= (ite (<= (to_rep (first4 temp___84881)) (to_rep (last4 temp___84881))) (+ (- (to_rep (last4 temp___84881)) (to_rep (first4 temp___84881))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
(assert (= temp___8488 temp___8489))
(assert (= (mk1 (to_rep (first4 temp___84881)) (to_rep (last4 temp___84881))) temp___84891))
(assert (= (ite (<= (to_rep (first2 temp___84891)) (to_rep (last2 temp___84891))) (+ (- (to_rep (last2 temp___84891)) (to_rep (first2 temp___84891))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___8489 temp___84891)))
(assert (= o2 o))
