...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 128)))) (=> (in_range5 y) (= (to_rep5 (of_rep5 x)) y))) :pattern ((to_rep5 (of_rep5 x))))))
...
(define-fun in_range6 ((x (_ BitVec 16))) Bool (and (bvule ((_ int2bv 16) 0) x) (bvule x ((_ int2bv 16) 1023))))
...
(assert (forall ((x (_ BitVec 16))) (! (let ((y (bvurem x ((_ int2bv 16) 1024)))) (=> (in_range6 y) (= (to_rep6 (of_rep6 x)) y))) :pattern ((to_rep6 (of_rep6 x))))))
...
(define-fun register_byte_array__ref___10__projection ((a register_byte_array__ref)) us_t1 (register_byte_array__content a))
(define-fun dynamic_invariant ((temp___expr_2182 us_t1) (temp___is_init_2179 Bool) (temp___skip_constant_2180 Bool) (temp___do_toplevel_2181 Bool)) Bool (=> (not (= temp___skip_constant_2180 true)) (and (dynamic_property2 1 5 (first3 temp___expr_2182) (last3 temp___expr_2182)) (and (= (first3 temp___expr_2182) 1) (= (last3 temp___expr_2182) 5)))))
(declare-sort t2 0)
...
(define-fun target__ref___4__projection ((a target__ref)) us_t2 (target__content a))
...
(define-fun dynamic_invariant1 ((temp___expr_2207 us_t2) (temp___is_init_2204 Bool) (temp___skip_constant_2205 Bool) (temp___do_toplevel_2206 Bool)) Bool (=> (not (= temp___skip_constant_2205 true)) (and (dynamic_property3 1 5 (first5 temp___expr_2207) (last5 temp___expr_2207)) (and (= (first5 temp___expr_2207) 1) (= (last5 temp___expr_2207) 5)))))
...
(declare-const temp___7716 (Array Int bits_8))
(declare-const temp___77161 t2)
(declare-const temp___7717 (Array Int bits_8))
(declare-const temp___77171 t1)
...
(define-fun temp___77162 () us_t2 (mk___t2 temp___7716 temp___77161))
...
(assert (and (= temp___77162 (register_to_bytes reg)) (dynamic_invariant1 temp___77162 true false true)))
(assert (= (ite (<= (to_rep (first4 temp___77161)) (to_rep (last4 temp___77161))) (+ (- (to_rep (last4 temp___77161)) (to_rep (first4 temp___77161))) 1) 0) (ite (<= 1 5) (+ (- 5 1) 1) 0)))
(assert (= temp___7716 temp___7717))
(assert (= (mk1 (to_rep (first4 temp___77161)) (to_rep (last4 temp___77161))) temp___77171))
(assert (= (ite (<= (to_rep (first2 temp___77171)) (to_rep (last2 temp___77171))) (+ (- (to_rep (last2 temp___77171)) (to_rep (first2 temp___77171))) 1) 0) (ite (<= (to_rep reg_bytes__first) (to_rep reg_bytes__last)) (+ (- (to_rep reg_bytes__last) (to_rep reg_bytes__first)) 1) 0)))
(assert (= (mk___t1 o o1) (mk___t1 temp___7717 temp___77171)))
(assert (= o2 o))
