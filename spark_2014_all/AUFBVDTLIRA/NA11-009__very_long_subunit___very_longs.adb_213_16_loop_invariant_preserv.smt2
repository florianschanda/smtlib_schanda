...
(assert (not (= i4 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= i4 result5))
(assert (= i5 (+ i4 1)))
(assert (and (<= (to_rep2 (first (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))) i5) (<= i5 (to_rep2 (last (rt (rec__very_longs__very_long__long_digits (us_split_fields1 number))))))))
(assert (= o6 i5))
...
(assert (=> (= result6 true) (and (= o10 i5) (in_range1 i5))))
...
(assert (< digit_count4 i5))
(declare-const j1 Int)
(assert (<= (+ digit_count4 1) j1))
(assert (<= j1 i5))
(assert (not (= (to_rep1 (select (elts (rec__very_longs__very_long__long_digits (us_split_fields1 number))) j1)) ((_ int2bv 8) 0))))
(check-sat)
(exit)
