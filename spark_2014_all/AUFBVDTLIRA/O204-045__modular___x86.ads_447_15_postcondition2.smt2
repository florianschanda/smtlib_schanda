...
(assert (forall ((addr1 (_ BitVec 64))) (forall ((x86__memory (Array (_ BitVec 64) unsigned8))) (! (=> (dynamic_invariant addr1 true true true true) (let ((result (readmem16 addr1 x86__memory))) (and (and (= result (bvadd ((_ zero_extend 8) (to_rep (select x86__memory addr1))) (bvmul ((_ zero_extend 8) (to_rep (select x86__memory (bvadd addr1 #x0000000000000001)))) #x0100))) (bvuge result #x0000)) (dynamic_invariant2 result true false true true)))) :pattern ((readmem16 addr1 x86__memory))))))
...
(assert (and (= o1 (readmem32 (bvadd addr #x0000000000000004) memory)) (and (= o1 (bvadd ((_ zero_extend 16) (readmem16 (bvadd addr #x0000000000000004) memory)) (bvmul ((_ zero_extend 16) (readmem16 (bvadd (bvadd addr #x0000000000000004) #x0000000000000002) memory)) #x00010000))) (bvuge o1 #x00000000))))
(assert (= o2 ((_ zero_extend 32) o1)))
(assert (= o3 (bvmul o2 #x0000000100000000)))
(assert (and (= o (readmem32 addr memory)) (and (= o (bvadd ((_ zero_extend 16) (readmem16 addr memory)) (bvmul ((_ zero_extend 16) (readmem16 (bvadd addr #x0000000000000002) memory)) #x00010000))) (bvuge o #x00000000))))
(assert (= o4 ((_ zero_extend 32) o)))
(assert (= o5 (bvadd o4 o3)))
(assert (= result x86__readmem64__result))
(assert (= x86__readmem64__result1 o5))
...
(assert (= result1 x86__readmem64__result4))
(assert (not (= x86__readmem64__result4 (bvadd ((_ zero_extend 32) (readmem32 addr memory)) (bvmul ((_ zero_extend 32) (readmem32 (bvadd addr #x0000000000000004) memory)) #x0000000100000000)))))
(check-sat)
(exit)
