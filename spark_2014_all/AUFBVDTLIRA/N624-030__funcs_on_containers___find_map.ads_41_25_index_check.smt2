...
(assert (=> (= result true) (and (= o (find_map_bad m)) (and (in_range1 o) (and (= o (ite (<= (get (model__ m) e) last2) (get (model__ m) e) 0)) (=> (= o 0) (forall ((i1 Int)) (=> (and (<= (to_rep1 (first (rt a))) i1) (<= i1 last2)) (not (= (to_rep (select (elts a) i1)) e))))))))))
