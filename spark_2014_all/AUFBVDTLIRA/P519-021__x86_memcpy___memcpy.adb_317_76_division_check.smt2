...
(assert (and (= o15 (readmem64 (bvsub rbp #x0000000000000048) memory10)) (and (and (and (and (and (and (and (= (bvand o15 #x00000000000000FF) ((_ zero_extend 56) (to_rep (select memory10 (bvsub rbp #x0000000000000048))))) (= (bvand o15 #x000000000000FF00) (bvmul ((_ zero_extend 56) (to_rep (select memory10 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000001)))) #x0000000000000100))) (= (bvand o15 #x0000000000FF0000) (bvmul ((_ zero_extend 56) (to_rep (select memory10 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000002)))) #x0000000000010000))) (= (bvand o15 #x00000000FF000000) (bvmul ((_ zero_extend 56) (to_rep (select memory10 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000003)))) #x0000000001000000))) (= (bvand o15 #x000000FF00000000) (bvmul ((_ zero_extend 56) (to_rep (select memory10 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000004)))) #x0000000100000000))) (= (bvand o15 #x0000FF0000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory10 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000005)))) #x0000010000000000))) (= (bvand o15 #x00FF000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory10 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000006)))) #x0001000000000000))) (= (bvand o15 #xFF00000000000000) (bvmul ((_ zero_extend 56) (to_rep (select memory10 (bvadd (bvsub rbp #x0000000000000048) #x0000000000000007)))) #x0100000000000000)))))
