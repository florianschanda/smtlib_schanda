...
(define-fun dynamic_invariant ((temp___expr_5531 us_t1) (temp___is_init_5528 Bool) (temp___skip_constant_5529 Bool) (temp___do_toplevel_5530 Bool)) Bool (=> (not (= temp___skip_constant_5529 true)) (and (dynamic_property2 1 1 (first3 temp___expr_5531) (last3 temp___expr_5531)) (and (= (first3 temp___expr_5531) 1) (= (last3 temp___expr_5531) 1)))))
