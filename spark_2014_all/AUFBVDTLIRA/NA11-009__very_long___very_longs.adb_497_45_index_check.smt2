...
(assert (and (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1265) (<= temp___1265 (to_rep2 (last3 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))))))
...
(assert (not (<= (to_rep2 (first2 (rt1 (rec__very_longs__very_long__long_digits1 u__split_fields2)))) temp___1269)))
(check-sat)
(exit)
