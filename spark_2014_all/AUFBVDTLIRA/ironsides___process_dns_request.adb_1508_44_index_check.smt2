...
(assert (< current_byte1 8168))
(assert (and (= o1 (+ current_byte1 1)) (in_range4 (+ current_byte1 1))))
(assert (= result3 (mk___split_fields__ref1 (mk___split_fields1 (mk___rep (mk___split_fields output_packet__split_fields output_packet__split_fields1 output_packet__split_fields2 output_packet__split_fields3 output_packet__split_fields4 output_packet__split_fields5 output_packet__split_fields6 output_packet__split_fields7 output_packet__split_fields8 output_packet__split_fields9 output_packet__split_fields10 output_packet__split_fields11 output_packet__split_fields12 output_packet__split_fields13 output_packet__split_fields14)) output_packet__split_fields15))))
...
(assert (and (<= 1 (+ current_byte1 3)) (<= (+ current_byte1 3) 8180)))
(assert (= o3 (+ current_byte1 3)))
(assert (= o4 (store (rec__dns_types__dns_packet__bytes output_packet__split_fields16) o3 o2)))
(assert (= (rec__dns_types__dns_packet__header output_packet__split_fields16) (mk___rep (mk___split_fields o5 o6 o7 o8 o9 o10 o11 o12 o13 o14 o15 o16 o17 o18 o19))))
(assert (= o4 o20))
(assert (= temp___7115 o5))
(assert (= temp___71151 o6))
(assert (= temp___71152 o7))
(assert (= temp___71153 o8))
(assert (= temp___71154 o9))
(assert (= temp___71155 o10))
(assert (= temp___71156 o11))
(assert (= temp___71157 o12))
(assert (= temp___71158 o13))
(assert (= temp___71159 o14))
(assert (= temp___711510 o15))
(assert (= temp___711511 o16))
(assert (= temp___711512 o17))
(assert (= temp___711513 o18))
(assert (= temp___711514 o19))
(assert (= temp___711515 o20))
(assert (= result4 (mk___split_fields__ref1 output_packet__split_fields16)))
(assert (= output_packet__split_fields17 (mk___split_fields1 (mk___rep (mk___split_fields temp___7115 temp___71151 temp___71152 temp___71153 temp___71154 temp___71155 temp___71156 temp___71157 temp___71158 temp___71159 temp___711510 temp___711511 temp___711512 temp___711513 temp___711514)) temp___711515)))
(assert (= (to_rep1 o21) #x05))
(assert (not (<= 1 (+ current_byte1 4))))
(check-sat)
(exit)
