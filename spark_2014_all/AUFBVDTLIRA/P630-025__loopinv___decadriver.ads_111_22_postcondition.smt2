...
(assert (forall ((x (_ BitVec 8))) (! (let ((y (bvurem x ((_ int2bv 8) 2)))) (=> (in_range1 y) (= (to_rep4 (of_rep4 x)) y))) :pattern ((to_rep4 (of_rep4 x))))))
...
(define-fun dynamic_invariant2 ((temp___expr_4407 Int) (temp___is_init_4404 Bool) (temp___skip_constant_4405 Bool) (temp___do_toplevel_4406 Bool)) Bool (=> (or (= temp___is_init_4404 true) (<= 0 1024)) (in_range2 temp___expr_4407)))
(define-fun dynamic_invariant3 ((temp___expr_4413 Int) (temp___is_init_4410 Bool) (temp___skip_constant_4411 Bool) (temp___do_toplevel_4412 Bool)) Bool (=> (or (= temp___is_init_4410 true) (<= 0 5)) (in_range3 temp___expr_4413)))
(define-fun dynamic_invariant4 ((temp___expr_4419 us_rep) (temp___is_init_4416 Bool) (temp___skip_constant_4417 Bool) (temp___do_toplevel_4418 Bool)) Bool (=> (= temp___do_toplevel_4418 true) (=> (= temp___is_init_4416 true) (ite (= (to_rep2 (rec__decadriver__rx_frame_type__error (us_split_fields1 temp___expr_4419))) 0) (< 0 (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4419)))) (= (to_rep1 (rec__decadriver__rx_frame_type__size (us_split_fields1 temp___expr_4419))) 0)))))
...
(define-fun dynamic_invariant5 ((temp___expr_4437 (_ BitVec 8)) (temp___is_init_4434 Bool) (temp___skip_constant_4435 Bool) (temp___do_toplevel_4436 Bool)) Bool (=> (or (= temp___is_init_4434 true) (bvule ((_ int2bv 8) 0) ((_ int2bv 8) 1))) (in_range1 temp___expr_4437)))
...
(assert (dynamic_invariant (mk___rep1 (mk___split_fields1 self__ self__1 self__2 self__3 self__4)) true false true))
