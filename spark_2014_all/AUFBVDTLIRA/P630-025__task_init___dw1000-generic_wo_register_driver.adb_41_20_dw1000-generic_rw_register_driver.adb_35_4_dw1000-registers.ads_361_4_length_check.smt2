...
(assert (and (= (mk___t2 temp___7905 temp___79051) (register_to_bytes reg)) (dynamic_invariant1 (mk___t2 temp___7905 temp___79051) true false true)))
(assert (not (= (ite (<= (to_rep (first4 temp___79051)) (to_rep (last4 temp___79051))) (+ (- (to_rep (last4 temp___79051)) (to_rep (first4 temp___79051))) 1) 0) (ite (<= 1 4) (+ (- 4 1) 1) 0))))
(check-sat)
(exit)
